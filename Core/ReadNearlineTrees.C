...
int main(int argc, char *argv[]) {
  ...
  string input = "../Plots/Data/RadialFieldEstimation/BeamYPosMonitoring/Input/Run5/gm2nearline_hists_run"+subrun+".root"; 

  string output = "../Plots/Data/RadialFieldEstimation/BeamYPosMonitoring/Results/Run5/caloBeamPositionPlots_"+subrun+".root";
