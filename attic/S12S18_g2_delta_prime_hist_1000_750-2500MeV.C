void S12S18_g2_delta_prime_hist_1000_750-2500MeV()
{
...
//=========  (Fri Dec  3 18:25:54 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","",51,-0.4677505,0.5575144);
   h__9->SetBinContent(23,1);
   h__9->SetBinContent(24,76);
   h__9->SetBinContent(25,606);
   h__9->SetBinContent(26,302);
   h__9->SetBinContent(27,15);
   h__9->SetEntries(1000);
   h__9->SetStats(0);
   h__9->SetLineWidth(3);
   h__9->GetXaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
