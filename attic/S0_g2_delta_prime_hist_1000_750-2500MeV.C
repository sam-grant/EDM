void S0_g2_delta_prime_hist_1000_750-2500MeV()
{
...
//=========  (Fri Dec  3 18:25:53 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","",50,-0.4941874,0.516153);
   h__6->SetBinContent(23,20);
   h__6->SetBinContent(24,442);
   h__6->SetBinContent(25,511);
   h__6->SetBinContent(26,27);
