...
configs_=(MainNtuple AllDecaysNtuple Plus1mmNtuple Minus1mmNtuple Plus0.1degNtuple Minus0.1degNtuple)
...
for i in ${!configs_[*]}; do
  ...
  # Run submission
  ./gridSetupAndSubmitGM2Data.sh --mc --full --fcl ${fclFiles_[$i]} --input-dir /pnfs/GM2/scratch/users/ghesketh/EDMSim/30xBNL/GasGun/${datetime} --output-dir /pnfs/GM2/scratch/users/${USER}/EDMSim/30xBNL/${configs_[$i]} --njobs=$nJobs --grace >> $printouts   
