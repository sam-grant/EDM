...
//=========  (Wed Nov  4 21:43:58 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_Graph01002 = new TH1F("Graph_Graph01002","",100,0,4.771751);
   Graph_Graph01002->SetMinimum(-0.3057179);
   Graph_Graph01002->SetMaximum(0.3887901);
   ...
   Graph_Graph01002->GetXaxis()->SetTitle("t_{g#minus2}^{mod} [#mus]");
   ...
   Graph_Graph01002->GetYaxis()->SetTitle("#LT#theta_{y}#GT [mrad]");
