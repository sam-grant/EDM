...
//=========  (Fri Oct 22 00:43:04 2021) by ROOT version 6.24/04
   ...
   Graph_Graph1009->SetMinimum(0.9557781);
   Graph_Graph1009->SetMaximum(2.604544);
   ...
   pol01010->SetChisquare(0.9498624);
   pol01010->SetNDF(6);
   ...
   pol01010->SetParameter(0,1.699306);
   pol01010->SetParError(0,0.08282862);
