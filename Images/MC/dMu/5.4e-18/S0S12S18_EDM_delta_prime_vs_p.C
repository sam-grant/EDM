...
//=========  (Fri Dec  3 18:46:54 2021) by ROOT version 6.24/04
   ...
   c->Range(446.8204,0.5499975,3047.464,2.787788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","",100,706.8848,2787.4);
   Graph_Graph1009->SetMinimum(0.7737766);
   Graph_Graph1009->SetMaximum(2.564009);
   ...
   pol01010->SetChisquare(7.175183);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,1.680699);
   pol01010->SetParError(0,0.07965628);
