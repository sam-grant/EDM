...
//=========  (Tue May  3 23:59:54 2022) by ROOT version 6.24/06
   ...
   c->Range(502.358,-2.034393,2739.84,1.433125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,726.1063,2516.092);
   Graph_Graph1011->SetMinimum(-1.687641);
   Graph_Graph1011->SetMaximum(1.086373);
   ...
   pol01012->SetParameter(0,-0.1351562);
   pol01012->SetParError(0,0.07265763);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.135
#pm0.07
 mrad","lpf");
