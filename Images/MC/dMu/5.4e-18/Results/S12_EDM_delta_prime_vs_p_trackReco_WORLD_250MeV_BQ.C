void S12_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 16:36:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(813.3064,0.8658754,2672.501,2.686761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(1.047964);
   Graph_Graph1001->SetMaximum(2.504673);
   ...
   pol01002->SetChisquare(1.346928);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,1.666458);
   pol01002->SetParError(0,0.09651916);
