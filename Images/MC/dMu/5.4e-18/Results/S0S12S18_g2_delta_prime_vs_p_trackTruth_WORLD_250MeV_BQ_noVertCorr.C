void S0S12S18_g2_delta_prime_vs_p_trackTruth_WORLD_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 16:21:49 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,732.0585,2511.316);
   Graph_Graph1019->SetMinimum(-inf);
   Graph_Graph1019->SetMaximum(1.422713);
   ...
   pol01020->SetChisquare(1.54088e+308);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,nan);
   pol01020->SetParError(0,0);
