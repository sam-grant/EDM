void S0_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 15:33:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(509.1112,-0.4395167,2733.985,3.61734);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","",100,731.5986,2511.498);
   Graph_Graph1021->SetMinimum(-0.03383101);
   Graph_Graph1021->SetMaximum(3.211654);
   ...
   pol01022->SetChisquare(8.233927);
   pol01022->SetNDF(6);
   ...
   pol01022->SetParameter(0,1.675055);
   pol01022->SetParError(0,0.1256113);
