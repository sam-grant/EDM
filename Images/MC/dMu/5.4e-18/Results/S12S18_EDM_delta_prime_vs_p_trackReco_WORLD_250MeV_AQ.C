...
//=========  (Tue May  3 23:59:54 2022) by ROOT version 6.24/06
   ...
   c->Range(502.2799,0.3103466,2739.695,3.995367);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,726.0215,2515.954);
   Graph_Graph1007->SetMinimum(0.6788486);
   Graph_Graph1007->SetMaximum(3.626865);
   ...
   pol01008->SetChisquare(48.79145);
   pol01008->SetNDF(6);
   ...
   pol01008->SetParameter(0,1.89027);
   pol01008->SetParError(0,0.05125006);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 1.89
#pm0.05
 mrad","lpf");
