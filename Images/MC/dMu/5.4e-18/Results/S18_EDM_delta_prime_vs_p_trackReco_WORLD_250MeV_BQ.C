...
//=========  (Tue Dec  7 01:01:44 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","",100,707.4753,2785.435);
   Graph_Graph1013->SetMinimum(-0.4413019);
   Graph_Graph1013->SetMaximum(3.045121);
   ...
   Graph_Graph1013->GetYaxis()->SetTitle("#delta'_{EDM} [mrad] / 250 MeV");
   ...
   pol01014->SetChisquare(11.14013);
   pol01014->SetNDF(7);
   ...
   pol01014->SetParameter(0,1.699256);
   pol01014->SetParError(0,0.1575841);
