void S18_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 16:36:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(812.9889,0.7345281,2673.284,2.564255);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,999.0184,2487.255);
   Graph_Graph1003->SetMinimum(0.9175008);
   Graph_Graph1003->SetMaximum(2.381283);
   ...
   pol01004->SetChisquare(1.253985);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,1.678785);
   pol01004->SetParError(0,0.1119126);
