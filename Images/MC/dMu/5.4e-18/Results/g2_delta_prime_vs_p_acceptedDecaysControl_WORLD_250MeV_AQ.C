void g2_delta_prime_vs_p_acceptedDecaysControl_WORLD_250MeV_AQ()
{
...
//=========  (Mon Dec  6 11:40:23 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","",100,702.6337,2787.237);
   Graph_Graph1023->SetMinimum(-0.1366751);
   Graph_Graph1023->SetMaximum(0.2842466);
   ...
   pol01024->SetChisquare(16.46729);
   pol01024->SetNDF(7);
   ...
   pol01024->SetParameter(0,-0.01456421);
   pol01024->SetParError(0,0.01755019);
