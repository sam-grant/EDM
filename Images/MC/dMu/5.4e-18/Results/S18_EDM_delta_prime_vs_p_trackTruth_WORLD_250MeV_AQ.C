...
//=========  (Wed May  4 00:11:37 2022) by ROOT version 6.24/06
   ...
   c->Range(502.6094,0.5278408,2740.699,4.143623);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,726.4184,2516.89);
   Graph_Graph1005->SetMinimum(0.889419);
   Graph_Graph1005->SetMaximum(3.782044);
   ...
   pol01006->SetChisquare(8.865672);
   pol01006->SetNDF(6);
   ...
   pol01006->SetParameter(0,2.182202);
   pol01006->SetParError(0,0.07201861);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.18
#pm0.07
 mrad","lpf");
