void g2_delta_prime_hist_1000_750-2750MeV_acceptedDecays_WORLD_250MeV_AQ()
{
...
//=========  (Mon Dec  6 11:40:21 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","",50,-0.5236142,0.4779083);
   h__10->SetBinContent(25,380);
   h__10->SetBinContent(26,620);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.02274
#pm1e-05
");
   pt_LaTex = pt->AddText("0.00036
#pm8e-06
");
   pt->Draw();
   c->Modified();
