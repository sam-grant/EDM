...
//=========  (Tue May  3 23:59:54 2022) by ROOT version 6.24/06
   ...
   c->Range(502.3061,0.4325013,2739.745,4.033689);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","",100,726.05,2516.001);
   Graph_Graph1009->SetMinimum(0.79262);
   Graph_Graph1009->SetMaximum(3.67357);
   ...
   pol01010->SetChisquare(68.67936);
   pol01010->SetNDF(6);
   ...
   pol01010->SetParameter(0,1.953297);
   pol01010->SetParError(0,0.041725);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 1.95
#pm0.04
 mrad","lpf");
