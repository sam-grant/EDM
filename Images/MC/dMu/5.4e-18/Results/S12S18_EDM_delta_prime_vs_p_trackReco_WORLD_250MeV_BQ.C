...
//=========  (Tue Dec  7 01:01:45 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","",100,707.1447,2786.549);
   Graph_Graph1015->SetMinimum(0.5513463);
   Graph_Graph1015->SetMaximum(2.747304);
   ...
   Graph_Graph1015->GetYaxis()->SetTitle("#delta'_{EDM} [mrad] / 250 MeV");
   ...
   pol01016->SetChisquare(11.22938);
   pol01016->SetNDF(7);
   ...
   pol01016->SetParameter(0,1.699266);
   pol01016->SetParError(0,0.1047178);
