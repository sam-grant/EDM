void S12S18_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 16:36:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(813.1496,0.93297,2672.882,2.395056);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,999.1229,2486.909);
   Graph_Graph1005->SetMinimum(1.079179);
   Graph_Graph1005->SetMaximum(2.248847);
   ...
   Graph_Graph1005->GetYaxis()->SetTitle("#delta [mrad] / 250 MeV");
   ...
   pol01006->SetChisquare(1.749377);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,1.673813);
   pol01006->SetParError(0,0.0736614);
