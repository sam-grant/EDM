void S0_EDM_delta_prime_vs_p_trackRecoControl_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Dec  6 11:40:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(444.9563,1.597183,3079.54,2.548608);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","",100,708.4147,2816.082);
   Graph_Graph1025->SetMinimum(1.692325);
   Graph_Graph1025->SetMaximum(2.453466);
   ...
   Graph_Graph1025->GetYaxis()->SetTitle("#delta'_{EDM} [mrad] / 250 MeV");
   ...
   pol01026->SetChisquare(32.46814);
   pol01026->SetNDF(7);
   ...
   pol01026->SetParameter(0,1.453484);
   pol01026->SetParError(0,0.7614382);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 1.5
#pm0.8
 mrad","lpf");
