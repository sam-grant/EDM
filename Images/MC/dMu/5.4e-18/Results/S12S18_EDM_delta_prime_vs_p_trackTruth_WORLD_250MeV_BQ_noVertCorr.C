...
//=========  (Wed May  4 17:22:08 2022) by ROOT version 6.24/06
   ...
   c->Range(813.104,0.220634,2672.985,2.99172);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(0.4977426);
   Graph_Graph1005->SetMaximum(2.714611);
   ...
   pol01006->SetChisquare(1.799662);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,1.669814);
   pol01006->SetParError(0,0.073382);
