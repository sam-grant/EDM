...
//=========  (Wed May  4 17:21:15 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(813.3064,0.1845152,2672.501,3.316965);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,999.2259,2486.581);
   Graph_Graph1011->SetMinimum(0.4977602);
   Graph_Graph1011->SetMaximum(3.00372);
   ...
   pol01012->SetChisquare(1.345106);
   pol01012->SetNDF(5);
   ...
   pol01012->SetParameter(0,1.666417);
   pol01012->SetParError(0,0.09651877);
