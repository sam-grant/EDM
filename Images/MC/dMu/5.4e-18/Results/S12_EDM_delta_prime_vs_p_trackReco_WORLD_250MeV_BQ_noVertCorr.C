...
//=========  (Wed May  4 19:31:07 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,999.2259,2486.581);
   Graph_Graph1001->SetMinimum(1.04776);
   Graph_Graph1001->SetMaximum(2.50372);
   ...
   pol01002->SetChisquare(1.345106);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,1.666417);
   pol01002->SetParError(0,0.09651877);
