void S0S12S18_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
...
//=========  (Tue Dec  7 01:01:46 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","",100,706.8848,2787.4);
   Graph_Graph1017->SetMinimum(0.79535);
   Graph_Graph1017->SetMaximum(2.730636);
   ...
   pol01018->SetChisquare(7.065486);
   pol01018->SetNDF(7);
   ...
   pol01018->SetParameter(0,1.699288);
   pol01018->SetParError(0,0.08052252);
