void S12S18_g2_delta_prime_vs_p_trackTruth_WORLD_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 16:39:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(813.104,-1.31396,2672.985,1.624628);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,999.0921,2486.997);
   Graph_Graph1019->SetMinimum(-1.020101);
   Graph_Graph1019->SetMaximum(1.330769);
   ...
   Graph_Graph1019->GetYaxis()->SetTitle("#delta [mrad] / 250 MeV");
   ...
   pol01020->SetChisquare(1.865354);
   pol01020->SetNDF(5);
   ...
   pol01020->SetParameter(0,0.07464867);
   pol01020->SetParError(0,0.07413616);
