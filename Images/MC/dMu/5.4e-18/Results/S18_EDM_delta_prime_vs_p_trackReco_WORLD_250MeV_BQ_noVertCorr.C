...
//=========  (Tue May 24 20:46:05 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1009->SetMinimum(0.9158401);
   Graph_Graph1009->SetMaximum(2.381352);
   ...
   pol01010->SetParameter(0,1.68001);
   pol01010->SetParError(0,0.1119126);
