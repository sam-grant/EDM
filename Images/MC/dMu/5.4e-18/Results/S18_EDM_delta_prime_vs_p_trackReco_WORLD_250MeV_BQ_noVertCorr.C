...
//=========  (Wed May  4 19:31:07 2022) by ROOT version 6.24/06
   ...
   c->Range(812.9889,0.7326511,2673.284,2.56454);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(0.9158401);
   Graph_Graph1003->SetMaximum(2.381352);
   ...
   pol01004->SetParameter(0,1.68001);
