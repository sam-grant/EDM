...
//=========  (Wed May  4 17:21:16 2022) by ROOT version 6.24/06
   ...
   c->Range(812.9889,0.05140111,2673.284,3.19579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","",100,999.0184,2487.255);
   Graph_Graph1013->SetMinimum(0.3658401);
   Graph_Graph1013->SetMaximum(2.881352);
   ...
   Graph_Graph1013->GetYaxis()->SetTitle("#delta [mrad] / 250 MeV");
   ...
   pol01014->SetParameter(0,1.68001);
   pol01014->SetParError(0,0.1119126);
