void S18_EDM_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun  3 03:45:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(812.9889,0.7334708,2673.284,2.565118);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","",100,999.0184,2487.255);
   Graph_Graph1009->SetMinimum(0.9166355);
   Graph_Graph1009->SetMaximum(2.381953);
   ...
   Graph_Graph1009->GetYaxis()->SetTitle("#delta [mrad] / 250 MeV");
   ...
   pol01010->SetParameter(0,1.679156);
   pol01010->SetParError(0,0.1119176);
