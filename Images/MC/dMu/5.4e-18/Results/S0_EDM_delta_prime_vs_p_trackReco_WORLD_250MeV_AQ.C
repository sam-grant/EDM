...
//=========  (Tue May  3 23:59:54 2022) by ROOT version 6.24/06
   ...
   c->Range(502.358,0.387928,2739.84,4.333987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,726.1063,2516.092);
   Graph_Graph1001->SetMinimum(0.7825339);
   Graph_Graph1001->SetMaximum(3.939381);
   ...
   pol01002->SetChisquare(24.78706);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,2.0758);
   pol01002->SetParError(0,0.07185479);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.08
#pm0.07
 mrad","lpf");
