...
//=========  (Wed May  4 00:11:37 2022) by ROOT version 6.24/06
   ...
   c->Range(502.6033,0.3847875,2740.977,3.713313);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,726.4406,2517.139);
   Graph_Graph1003->SetMinimum(0.7176401);
   Graph_Graph1003->SetMaximum(3.38046);
   ...
   pol01004->SetChisquare(11.77837);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,2.036307);
   pol01004->SetParError(0,0.07153995);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.04
#pm0.07
 mrad","lpf");
