...
//=========  (Wed May  4 00:11:37 2022) by ROOT version 6.24/06
   ...
   c->Range(502.68,-1.58416,2740.83,1.51614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,726.495,2517.015);
   Graph_Graph1011->SetMinimum(-1.27413);
   Graph_Graph1011->SetMaximum(1.20611);
   ...
   pol01012->SetChisquare(5.051947);
   pol01012->SetNDF(6);
   ...
   pol01012->SetParameter(0,0.05496253);
   pol01012->SetParError(0,0.07209406);
