void g2_delta_prime_hist_1000_750-2750MeV_acceptedDecaysControl_WORLD_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Dec  6 11:40:27 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","",50,-0.5156105,0.4858328);
   h__12->SetBinContent(25,178);
   h__12->SetBinContent(26,822);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.01455
#pm1e-05
");
   pt_LaTex = pt->AddText("0.00037
#pm8e-06
");
   pt->Draw();
   c->Modified();
