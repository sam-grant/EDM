void S18_g2_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Dec  7 01:01:54 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","",100,707.4753,2785.435);
   Graph_Graph1023->SetMinimum(-2.911734);
   Graph_Graph1023->SetMaximum(1.968797);
   ...
   pol01024->SetParameter(0,0.2783998);
   pol01024->SetParError(0,0.1606465);
