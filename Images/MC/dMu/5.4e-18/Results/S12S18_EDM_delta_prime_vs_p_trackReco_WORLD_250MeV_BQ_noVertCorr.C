...
//=========  (Wed May  4 19:31:08 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1005->SetMinimum(1.078093);
   Graph_Graph1005->SetMaximum(2.24743);
   ...
   pol01006->SetChisquare(1.746675);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,1.673926);
   pol01006->SetParError(0,0.07366158);
