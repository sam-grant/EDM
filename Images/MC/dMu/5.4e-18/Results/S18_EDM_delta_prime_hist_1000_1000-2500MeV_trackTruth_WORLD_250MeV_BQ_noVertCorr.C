...
//=========  (Fri Jun  3 03:45:40 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","",54,1.12866,2.217366);
   ...
   h__2->SetBinContent(21,45);
   h__2->SetBinContent(22,59);
   ...
   h__2->SetBinContent(31,41);
   h__2->SetBinContent(32,40);
   h__2->SetBinContent(33,33);
   h__2->SetBinContent(34,26);
   h__2->SetBinContent(35,16);
