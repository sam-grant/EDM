void S12_EDM_delta_prime_vs_p_trackRecoControl_WORLD_250MeV_CQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Dec  6 11:41:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(451.3751,1.176558,3045.793,1.77783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","",100,710.817,2786.351);
   Graph_Graph1047->SetMinimum(1.236686);
   Graph_Graph1047->SetMaximum(1.717703);
   ...
   Graph_Graph1047->GetYaxis()->SetTitle("#delta'_{EDM} [mrad] / 250 MeV");
   ...
   pol01048->SetChisquare(1.066076);
   pol01048->SetNDF(7);
   ...
   pol01048->SetParameter(0,1.695878);
   pol01048->SetParError(0,0.1379749);
