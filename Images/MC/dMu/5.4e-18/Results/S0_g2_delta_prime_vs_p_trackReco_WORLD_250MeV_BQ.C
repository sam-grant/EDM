void S0_g2_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Dec  7 01:01:49 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,706.3904,2788.83);
   Graph_Graph1019->SetMinimum(-2.455047);
   Graph_Graph1019->SetMaximum(1.481331);
   ...
   pol01020->SetChisquare(9.537868);
   pol01020->SetNDF(7);
   ...
   pol01020->SetParameter(0,-0.02545533);
   pol01020->SetParError(0,0.1245335);
