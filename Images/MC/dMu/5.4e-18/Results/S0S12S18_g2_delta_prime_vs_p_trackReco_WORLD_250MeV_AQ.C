...
//=========  (Tue May  3 23:59:55 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(502.3061,-1.644921,2739.745,1.197057);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,726.05,2516.001);
   Graph_Graph1019->SetMinimum(-1.360723);
   Graph_Graph1019->SetMaximum(0.9128592);
   ...
   pol01020->SetChisquare(10.58362);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,-0.1559087);
   pol01020->SetParError(0,0.04220271);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.156
#pm0.04
 mrad","lpf");
