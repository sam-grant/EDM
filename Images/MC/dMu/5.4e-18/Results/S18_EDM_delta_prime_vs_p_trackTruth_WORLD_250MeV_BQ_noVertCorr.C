...
//=========  (Fri Jun  3 03:45:40 2022) by ROOT version 6.24/06
   ...
   c->Range(812.9191,0.7037483,2673.475,2.518988);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(0.8852723);
   Graph_Graph1003->SetMaximum(2.337464);
   ...
   pol01004->SetChisquare(0.5398373);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,1.681539);
   pol01004->SetParError(0,0.1114877);
