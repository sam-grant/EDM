void EDM_delta_prime_vs_p_acceptedDecays_WORLD_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Dec  6 11:40:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(442.0406,1.453256,3047.804,1.899853);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","",100,702.6169,2787.227);
   Graph_Graph1017->SetMinimum(1.497916);
   Graph_Graph1017->SetMaximum(1.855194);
   ...
   pol01018->SetChisquare(1.379941);
   pol01018->SetNDF(7);
   ...
   pol01018->SetParameter(0,1.699271);
   pol01018->SetParError(0,0.01924084);
