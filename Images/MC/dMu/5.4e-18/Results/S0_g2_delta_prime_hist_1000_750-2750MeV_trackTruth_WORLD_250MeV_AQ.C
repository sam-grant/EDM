void S0_g2_delta_prime_hist_1000_750-2750MeV_trackTruth_WORLD_250MeV_AQ()
{
...
//=========  (Mon Dec  6 11:45:23 2021) by ROOT version 6.24/04
   ...
   TH1D *h__38 = new TH1D("h__38","",50,-0.4600047,0.5447531);
   h__38->SetBinContent(25,889);
   h__38->SetBinContent(26,111);
   h__38->SetEntries(1000);
   h__38->SetStats(0);
   h__38->SetLineWidth(3);
   h__38->GetXaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
   ...
   h__38->GetYaxis()->SetTitle("Trials");
