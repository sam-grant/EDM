void S0S12S18_g2_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 15:33:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(509.6572,-1.662504,2733.647,1.570622);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1039 = new TH1F("Graph_Graph1039","",100,732.0562,2511.248);
   Graph_Graph1039->SetMinimum(-1.339191);
   Graph_Graph1039->SetMaximum(1.247309);
   ...
   Graph_Graph1039->GetYaxis()->SetTitle("#delta'_{g#minus2} [mrad] / 250 MeV");
   ...
   pol01040->SetChisquare(11.32039);
   pol01040->SetNDF(6);
   ...
   pol01040->SetParameter(0,0.002823642);
   pol01040->SetParError(0,0.05626191);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00282
#pm0.06
 mrad","lpf");
