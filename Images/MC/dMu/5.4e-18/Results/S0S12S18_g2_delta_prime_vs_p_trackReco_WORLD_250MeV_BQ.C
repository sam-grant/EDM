void S0S12S18_g2_delta_prime_vs_p_trackReco_WORLD_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Dec  7 01:01:59 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1027 = new TH1F("Graph_Graph1027","",100,706.8848,2787.4);
   Graph_Graph1027->SetMinimum(-1.106373);
   Graph_Graph1027->SetMaximum(0.9350736);
   ...
   Graph_Graph1027->GetYaxis()->SetTitle("#delta'_{g#minus2} [mrad] / 250 MeV");
   ...
   pol01028->SetParameter(0,0.03190446);
   pol01028->SetParError(0,0.08150156);
