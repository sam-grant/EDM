void S12_g2_delta_prime_hist_1000_750-2500MeV()
{
...
//=========  (Fri Dec  3 18:25:53 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","",50,-0.5611224,0.4509442);
   h__7->SetBinContent(24,6);
   h__7->SetBinContent(25,949);
   h__7->SetBinContent(26,45);
   h__7->SetEntries(1000);
   h__7->SetStats(0);
   h__7->SetLineWidth(3);
   h__7->GetXaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
