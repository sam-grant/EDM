...
//=========  (Fri Dec  3 18:46:56 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","",50,-0.4230391,0.5805149);
   h__9->SetBinContent(23,44);
   h__9->SetBinContent(24,494);
   h__9->SetBinContent(25,425);
   h__9->SetBinContent(26,37);
