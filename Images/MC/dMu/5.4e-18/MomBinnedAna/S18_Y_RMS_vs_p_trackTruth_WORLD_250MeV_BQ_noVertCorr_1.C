void S18_Y_RMS_vs_p_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6404,-1.763915,3398.763,15.87523);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01140 = new TH1F("Graph_Graph01140","S18_",100,0,3051.639);
   Graph_Graph01140->SetMinimum(0);
   Graph_Graph01140->SetMaximum(14.11132);
   ...
   Graph_Graph01140->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01140->GetYaxis()->SetTitle("#sigma_{y} [mm] / 250 MeV");
