void S0S12S18_thetaYMaxDiff_vs_p_trackReco_WORLD_250MeV_BQ_acceptanceUncorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:31:28 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.8481,-10.99975,3375.839,217.5811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01217 = new TH1F("Graph_Graph01217","S0S12S18_",100,218.1577,3021.87);
   Graph_Graph01217->SetMinimum(11.85834);
   Graph_Graph01217->SetMaximum(194.7231);
