...
//=========  (Wed Dec  8 12:36:28 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.5781,-0.03932536,3407.915,0.02390858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01219 = new TH1F("Graph_Graph01219","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01219->SetMinimum(-0.03300196);
   Graph_Graph01219->SetMaximum(0.01758519);
