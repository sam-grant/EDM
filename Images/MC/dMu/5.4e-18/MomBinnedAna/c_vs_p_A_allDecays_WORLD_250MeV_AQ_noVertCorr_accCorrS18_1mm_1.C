void c_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS18_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 15:09:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-1.064497e-06,3407.936,2.125654e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01038->SetMinimum(-9.367908e-07);
   Graph_Graph01038->SetMaximum(8.485916e-08);
