...
//=========  (Tue Dec 14 16:27:36 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9078,-0.4680581,3509.17,4.368213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01108 = new TH1F("Graph_Graph01108","S12_",100,0,3088.378);
   Graph_Graph01108->SetMinimum(0.01556908);
   Graph_Graph01108->SetMaximum(3.884586);
