...
//=========  (Tue Dec  7 00:19:37 2021) by ROOT version 6.24/04
   ...
   c->Range(-394.2727,-0.007641047,3548.454,0.1483137);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","",100,0,3122.952);
   Graph_Graph01045->SetMinimum(0.007954429);
   Graph_Graph01045->SetMaximum(0.1327182);
