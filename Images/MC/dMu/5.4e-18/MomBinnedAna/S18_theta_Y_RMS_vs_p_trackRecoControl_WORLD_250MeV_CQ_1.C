...
//=========  (Tue Dec 14 16:27:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.784,-3.001531,3508.056,63.49958);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01143 = new TH1F("Graph_Graph01143","S18_",100,0,3087.398);
   Graph_Graph01143->SetMinimum(3.648581);
   Graph_Graph01143->SetMaximum(56.84947);
   ...
   Graph_Graph01143->GetXaxis()->SetRange(1,101);
