...
//=========  (Tue Dec 14 16:27:49 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.8815,-1181624,3508.933,4362349);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01224 = new TH1F("Graph_Graph01224","S0S12S18_",100,0,3088.17);
   Graph_Graph01224->SetMinimum(-627226.3);
   Graph_Graph01224->SetMaximum(3807951);
   ...
   Graph_Graph01224->GetXaxis()->SetRange(1,101);
