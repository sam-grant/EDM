...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-0.1709468,3511.253,1.639113);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S0_",100,0,3090.211);
   Graph_Graph01069->SetMinimum(0.0100592);
   Graph_Graph01069->SetMaximum(1.458107);
