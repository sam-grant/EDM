...
//=========  (Mon May 30 11:51:21 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-165.3503,-85637.59,3382.087,913361.3);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S0_",100,217.492,3027.343);
   Graph_Graph01066->SetMinimum(14262.3);
   Graph_Graph01066->SetMaximum(813461.4);
