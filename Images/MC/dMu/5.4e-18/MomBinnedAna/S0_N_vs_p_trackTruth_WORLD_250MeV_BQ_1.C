...
//=========  (Sun Dec  5 19:11:59 2021) by ROOT version 6.24/04
   ...
   c->Range(466.8585,-117108.1,3030.853,986476);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S0_",100,217.4837,3027.341);
   Graph_Graph01044->SetMinimum(-6749.711);
   Graph_Graph01044->SetMaximum(876117.6);
