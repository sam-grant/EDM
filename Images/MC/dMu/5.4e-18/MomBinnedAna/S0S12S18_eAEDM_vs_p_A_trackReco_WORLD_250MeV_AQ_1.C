...
//=========  (Wed Jan 19 10:50:40 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0221,-2.380758e-06,3510.199,2.144173e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01226 = new TH1F("Graph_Graph01226","S0S12S18_",100,0,3089.284);
   Graph_Graph01226->SetMinimum(1.491744e-09);
   Graph_Graph01226->SetMaximum(1.905949e-05);
