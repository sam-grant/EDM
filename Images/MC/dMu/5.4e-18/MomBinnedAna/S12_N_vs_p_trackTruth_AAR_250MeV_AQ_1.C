...
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   ...
   c->Range(521.862,-174383.1,2725.279,1572526);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S12_",100,0,3092.516);
   Graph_Graph01041->SetMinimum(307.8);
   Graph_Graph01041->SetMaximum(1397835);
