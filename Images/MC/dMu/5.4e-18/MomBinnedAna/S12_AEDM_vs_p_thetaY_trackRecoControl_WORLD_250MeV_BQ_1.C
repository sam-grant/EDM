...
//=========  (Fri Dec  3 15:28:07 2021) by ROOT version 6.24/04
   ...
   c->Range(467.8037,-0.7227357,3028.657,0.07041579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S12_",100,218.7344,3025.149);
   Graph_Graph01051->SetMinimum(-0.6434205);
   Graph_Graph01051->SetMaximum(-0.00889936);
