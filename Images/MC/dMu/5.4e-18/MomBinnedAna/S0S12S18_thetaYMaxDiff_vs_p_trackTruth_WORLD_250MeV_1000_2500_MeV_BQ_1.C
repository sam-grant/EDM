void S0S12S18_thetaYMaxDiff_vs_p_trackTruth_WORLD_250MeV_1000_2500_MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 11:05:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.7815,-13.3933,3380.88,216.2923);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01217 = new TH1F("Graph_Graph01217","S0S12S18_",100,217.869,3026.313);
   Graph_Graph01217->SetMinimum(9.575266);
   Graph_Graph01217->SetMaximum(193.3238);
