...
//=========  (Thu Oct 21 14:34:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-10.89571,2744.438,283.0443);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01043->SetMinimum(18.49829);
   Graph_Graph01043->SetMaximum(253.6503);
