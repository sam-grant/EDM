void S18_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_BQ_noVertCorr_0mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr  5 17:19:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.859,-0.01460441,3376.397,0.2365312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01141 = new TH1F("Graph_Graph01141","S18_",100,218.2083,3022.372);
   Graph_Graph01141->SetMinimum(0.01050916);
   Graph_Graph01141->SetMaximum(0.2114177);
