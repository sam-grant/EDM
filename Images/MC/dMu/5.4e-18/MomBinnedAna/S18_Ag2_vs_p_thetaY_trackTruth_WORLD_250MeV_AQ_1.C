void S18_Ag2_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:29:09 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.4784,-0.04534028,3019.155,0.040528);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S18_",100,0,3108.525);
   Graph_Graph01067->SetMinimum(-0.03675346);
   Graph_Graph01067->SetMaximum(0.03194117);
   ...
   Graph_Graph01067->GetXaxis()->SetRange(25,89);
