...
//=========  (Tue Dec 14 16:33:19 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-6.362152,3411.031,49.93346);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01094 = new TH1F("Graph_Graph01094","S12_",100,218.7344,3025.149);
   Graph_Graph01094->SetMinimum(-0.7325899);
   Graph_Graph01094->SetMaximum(44.3039);
