...
//=========  (Tue Jun  7 11:37:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.9303,-3.372157e-05,3375.567,1.584998e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01099->SetMinimum(-2.876442e-05);
   Graph_Graph01099->SetMaximum(1.089283e-05);
