void S0S12S18_theta_Y_RMS_vs_p_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-2.275202,2750,40.70494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0S12S18_",100,125,3125);
   Graph_Graph01058->SetMinimum(2.022812);
   Graph_Graph01058->SetMaximum(36.40692);
   ...
   Graph_Graph01058->GetXaxis()->SetRange(21,80);
