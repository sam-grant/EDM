...
//=========  (Wed Jan 19 10:50:40 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0221,-8.822154,3510.199,23.41374);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18_",100,0,3089.284);
   Graph_Graph01215->SetMinimum(-5.598565);
   Graph_Graph01215->SetMaximum(20.19015);
   ...
   Graph_Graph01215->GetXaxis()->SetRange(1,101);
