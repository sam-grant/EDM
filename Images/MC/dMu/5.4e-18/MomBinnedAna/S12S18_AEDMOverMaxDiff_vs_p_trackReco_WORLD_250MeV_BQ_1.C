...
//=========  (Wed Jan 19 11:03:19 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3154,-0.004522688,3406.964,0.004213744);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,218.1461,3021.502);
   Graph_Graph01181->SetMinimum(-0.003649044);
   Graph_Graph01181->SetMaximum(0.003340101);
