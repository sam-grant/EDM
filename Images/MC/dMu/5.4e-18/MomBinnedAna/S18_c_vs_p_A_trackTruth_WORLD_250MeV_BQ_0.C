void S18_c_vs_p_A_trackTruth_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:38:11 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.50122,-0.0005392183,3236.776,0.0004269402);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S18_",100,218.1061,3026.171);
   Graph_Graph01066->SetMinimum(-0.0004426024);
   Graph_Graph01066->SetMaximum(0.0003303244);
