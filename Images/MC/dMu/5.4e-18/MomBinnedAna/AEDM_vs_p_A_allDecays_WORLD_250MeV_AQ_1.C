...
//=========  (Tue Dec  7 00:19:37 2021) by ROOT version 6.24/04
   ...
   c->Range(-394.2727,-1.006546e-07,3548.454,8.316354e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","",100,0,3122.952);
   Graph_Graph01039->SetMinimum(-7.425556e-09);
   Graph_Graph01039->SetMaximum(7.384064e-07);
