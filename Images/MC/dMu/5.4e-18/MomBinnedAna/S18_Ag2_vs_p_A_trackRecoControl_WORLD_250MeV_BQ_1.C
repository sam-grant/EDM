...
//=========  (Tue Dec 14 16:33:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,-0.0005815664,3410.59,0.002758163);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01136 = new TH1F("Graph_Graph01136","S18_",100,218.8378,3024.773);
   Graph_Graph01136->SetMinimum(-0.0002475935);
   Graph_Graph01136->SetMaximum(0.00242419);
