void S0_eAEDM_vs_p_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:36:21 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.8164,-0.04367218,2745.291,0.4961827);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S0_",100,219.1321,3025.975);
   Graph_Graph01032->SetMinimum(0.01031331);
   Graph_Graph01032->SetMaximum(0.4421972);
   ...
   Graph_Graph01032->GetXaxis()->SetRange(19,82);
   ...
   Graph_Graph01032->GetYaxis()->SetTitle("#deltaA_{EDM} / 250 MeV");
