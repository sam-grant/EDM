...
//=========  (Mon Nov 22 14:13:03 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.5493,-24.32364,3332.506,423.1933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","S0S12S18_",100,0,3092.813);
   Graph_Graph01103->SetMinimum(20.42806);
   Graph_Graph01103->SetMaximum(378.4416);
   ...
   Graph_Graph01103->GetXaxis()->SetRange(3,96);
