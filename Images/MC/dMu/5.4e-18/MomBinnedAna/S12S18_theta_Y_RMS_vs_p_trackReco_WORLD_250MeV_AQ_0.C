...
//=========  (Thu Nov 18 11:35:13 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6759,-5.851228,2724.308,58.80831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12S18_",100,0,3091.413);
   Graph_Graph01058->SetMinimum(0.614726);
   Graph_Graph01058->SetMaximum(52.34236);
