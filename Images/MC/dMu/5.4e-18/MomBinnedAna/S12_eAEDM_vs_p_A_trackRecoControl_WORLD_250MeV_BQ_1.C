...
//=========  (Tue Dec 14 16:33:20 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-0.0001499245,3411.031,0.001351307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,218.7344,3025.149);
   Graph_Graph01105->SetMinimum(1.98657e-07);
   Graph_Graph01105->SetMaximum(0.001201184);
