...
//=========  (Thu Nov 18 11:29:27 2021) by ROOT version 6.24/04
   ...
   c->Range(526.691,-1370057,2750.498,2.025332e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","",100,0,3121.132);
   Graph_Graph01015->SetMinimum(792280.8);
   Graph_Graph01015->SetMaximum(1.809098e+07);
