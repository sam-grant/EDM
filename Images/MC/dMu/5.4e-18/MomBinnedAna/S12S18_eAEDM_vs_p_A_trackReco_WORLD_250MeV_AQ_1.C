...
//=========  (Wed Jan 19 10:50:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,-4.22181e-06,3509.674,3.802393e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01187 = new TH1F("Graph_Graph01187","S12S18_",100,0,3088.822);
   Graph_Graph01187->SetMinimum(2.763535e-09);
   Graph_Graph01187->SetMaximum(3.379935e-05);
