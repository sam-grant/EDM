void S12_Y_RMS_vs_p_trackTruth_AAR_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:37:58 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.862,11.78058,2725.279,14.91719);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12_",100,0,3092.516);
   Graph_Graph01039->SetMinimum(12.09424);
   Graph_Graph01039->SetMaximum(14.60353);
