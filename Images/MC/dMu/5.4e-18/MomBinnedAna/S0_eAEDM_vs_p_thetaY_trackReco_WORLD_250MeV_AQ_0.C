void S0_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:15:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.4822,-0.1112772,3337.749,1.197885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S0_",100,0,3094.089);
   Graph_Graph01045->SetMinimum(0.019639);
   Graph_Graph01045->SetMaximum(1.066968);
   ...
   Graph_Graph01045->GetXaxis()->SetRange(2,96);
