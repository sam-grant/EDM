...
//=========  (Fri Mar 25 02:59:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.655,-10.53945,3375.214,199.8137);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18_",100,218.2625,3021.327);
   Graph_Graph01180->SetMinimum(10.49586);
   Graph_Graph01180->SetMaximum(178.7784);
