void S18_AEDM_vs_p_A_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:37:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.4644,-0.01084845,3331.568,0.05413658);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S18_",100,0,3091.942);
   Graph_Graph01068->SetMinimum(-0.004349946);
   Graph_Graph01068->SetMaximum(0.04763807);
   ...
   Graph_Graph01068->GetXaxis()->SetRange(3,96);
