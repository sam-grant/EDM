void S0S12S18_Ag2_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9276,-0.7026306,3392.348,1.341727);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01217 = new TH1F("Graph_Graph01217","S0S12S18_",100,0,3108.681);
   Graph_Graph01217->SetMinimum(-0.4981948);
   Graph_Graph01217->SetMaximum(1.137291);
   ...
   Graph_Graph01217->GetXaxis()->SetRange(1,97);
