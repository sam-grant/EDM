void S12_eAEDM_vs_p_trackRecoControl_AAR_250MeV_CQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.2448994,2744.438,2.402177);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01032->SetMinimum(0.0198082);
   Graph_Graph01032->SetMaximum(2.137469);
