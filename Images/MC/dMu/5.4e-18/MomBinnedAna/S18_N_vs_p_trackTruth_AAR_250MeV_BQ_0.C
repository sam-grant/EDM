...
//=========  (Thu Nov 18 11:38:17 2021) by ROOT version 6.24/04
   ...
   c->Range(498.9126,-90451.01,2745.365,907506);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S18_",100,218.1061,3026.171);
   Graph_Graph01051->SetMinimum(9344.7);
   Graph_Graph01051->SetMaximum(807710.3);
