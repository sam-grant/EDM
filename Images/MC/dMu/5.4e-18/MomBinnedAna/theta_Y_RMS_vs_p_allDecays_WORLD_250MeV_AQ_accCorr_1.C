void theta_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_accCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 18:17:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-12.35284,3407.936,153.009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(4.183339);
   Graph_Graph01041->SetMaximum(136.4728);
