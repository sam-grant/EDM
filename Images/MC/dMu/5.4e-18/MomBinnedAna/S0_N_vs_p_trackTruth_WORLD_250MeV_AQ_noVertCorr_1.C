void S0_N_vs_p_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9161,-351509.8,3392.245,3178501);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0_",100,0,3108.587);
   Graph_Graph01068->SetMinimum(1491.3);
   Graph_Graph01068->SetMaximum(2825500);
   ...
   Graph_Graph01068->GetXaxis()->SetRange(1,97);
