...
//=========  (Thu Nov 18 11:28:49 2021) by ROOT version 6.24/04
   ...
   c->Range(526.998,7.019562,2752.101,29.99647);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01014 = new TH1F("Graph_Graph01014","",100,0,3122.951);
   Graph_Graph01014->SetMinimum(9.317253);
   Graph_Graph01014->SetMaximum(27.69878);
