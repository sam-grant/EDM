...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-0.0001272903,3511.253,1.94749e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S0_",100,0,3090.211);
   Graph_Graph01064->SetMinimum(-0.0001126138);
   Graph_Graph01064->SetMaximum(4.798371e-06);
