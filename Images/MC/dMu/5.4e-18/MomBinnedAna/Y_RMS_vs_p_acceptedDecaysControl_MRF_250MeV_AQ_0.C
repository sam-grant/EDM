void Y_RMS_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,13.01352,12,13.20517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1011[3] = {
   2,
   6,
   10};
   Double_t Graph0_fy1011[3] = {
   13.15285,
   13.05665,
   13.06668};
   Double_t Graph0_fex1011[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1011[3] = {
   0.02037999,
   0.01119251,
   0.007267457};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1011,Graph0_fy1011,Graph0_fex1011,Graph0_fey1011);
   gre->SetName("Graph0");
   gre->SetTitle(";p [MeV]: in range p #minus 125 < p < p #plus 125 MeV;#sigma_{y} [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01011 = new TH1F("Graph_Graph01011","",100,1.2,10.8);
   Graph_Graph01011->SetMinimum(13.03268);
   Graph_Graph01011->SetMaximum(13.18601);
