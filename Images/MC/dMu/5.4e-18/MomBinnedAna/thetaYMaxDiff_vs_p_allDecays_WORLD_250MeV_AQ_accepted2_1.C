void thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_accepted2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb 24 02:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-39.61294,3548.544,338.8936);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-1.762279);
   Graph_Graph01047->SetMaximum(301.043);
