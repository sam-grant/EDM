...
//=========  (Thu Nov 18 11:35:32 2021) by ROOT version 6.24/04
   ...
   c->Range(498.445,-1.642648,2741.892,37.8286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0S12S18_",100,218.0141,3022.323);
   Graph_Graph01068->SetMinimum(2.304477);
   Graph_Graph01068->SetMaximum(33.88147);
