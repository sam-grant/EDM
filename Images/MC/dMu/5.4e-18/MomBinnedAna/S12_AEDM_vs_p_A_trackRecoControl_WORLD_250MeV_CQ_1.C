...
//=========  (Tue Dec 14 16:27:35 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9078,-0.0009848411,3509.17,0.008858784);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S12_",100,0,3088.378);
   Graph_Graph01102->SetMinimum(-4.785539e-07);
   Graph_Graph01102->SetMaximum(0.007874421);
