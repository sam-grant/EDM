...
//=========  (Thu Nov 18 11:32:41 2021) by ROOT version 6.24/04
   ...
   c->Range(521.9122,-3.173367,2725.542,44.0589);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0S12S18_",100,0,3092.813);
   Graph_Graph01068->SetMinimum(1.54986);
   Graph_Graph01068->SetMaximum(39.33567);
