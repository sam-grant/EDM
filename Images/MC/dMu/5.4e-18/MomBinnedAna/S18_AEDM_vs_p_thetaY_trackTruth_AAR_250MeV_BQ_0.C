void S18_AEDM_vs_p_thetaY_trackTruth_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:18:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.50122,-0.7772311,3236.776,0.5090017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01064->SetMinimum(-0.6486079);
   Graph_Graph01064->SetMaximum(0.3803784);
