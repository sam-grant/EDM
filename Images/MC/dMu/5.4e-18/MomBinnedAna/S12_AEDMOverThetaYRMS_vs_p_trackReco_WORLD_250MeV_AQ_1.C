...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,-0.003461372,3510.154,0.03337706);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01064->SetMinimum(0.0002224719);
   Graph_Graph01064->SetMaximum(0.02969322);
   ...
   Graph_Graph01064->GetXaxis()->SetRange(1,101);
