void thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_acceptedInterpolatedMomBins_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Mar 18 14:19:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-226.8833,3548.544,2454.075);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(41.21262);
   Graph_Graph01047->SetMaximum(2185.979);
   ...
   Graph_Graph01047->GetXaxis()->SetRange(1,101);
