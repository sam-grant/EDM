...
//=========  (Mon Nov 22 14:11:20 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1912,-5.851228,3334.862,58.80831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01083 = new TH1F("Graph_Graph01083","S12S18_",100,0,3091.413);
   Graph_Graph01083->SetMinimum(0.614726);
   Graph_Graph01083->SetMaximum(52.34236);
