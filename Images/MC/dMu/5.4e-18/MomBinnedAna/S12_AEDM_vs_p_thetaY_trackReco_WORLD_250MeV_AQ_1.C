...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,-0.1409357,3510.154,1.359129);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01051->SetMinimum(0.009070807);
   Graph_Graph01051->SetMaximum(1.209122);
   ...
   Graph_Graph01051->GetXaxis()->SetRange(1,101);
