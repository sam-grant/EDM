...
//=========  (Mon Nov 22 14:17:00 2021) by ROOT version 6.24/04
   ...
   c->Range(8.41028,-33.49494,3235.149,303.6617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,218.8498,3024.71);
   Graph_Graph01075->SetMinimum(0.2207299);
   Graph_Graph01075->SetMaximum(269.946);
