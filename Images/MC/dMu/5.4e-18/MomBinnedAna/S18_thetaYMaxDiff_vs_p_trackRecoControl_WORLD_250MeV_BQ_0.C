...
//=========  (Thu Nov 18 11:36:37 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.4358,-33.49494,2744.124,303.6617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01053 = new TH1F("Graph_Graph01053","S18_",100,218.8498,3024.71);
   Graph_Graph01053->SetMinimum(0.2207299);
   Graph_Graph01053->SetMaximum(269.946);
   ...
   Graph_Graph01053->GetXaxis()->SetRange(19,82);
