...
//=========  (Mon Mar 21 12:27:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0109,2.936409,3406.551,28.17846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01139 = new TH1F("Graph_Graph01139","S18_",100,218.3733,3021.167);
   Graph_Graph01139->SetMinimum(5.460614);
   Graph_Graph01139->SetMaximum(25.65425);
