...
//=========  (Thu Nov 18 15:57:50 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4451,-2.127222e-06,2741.892,1.948304e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01072->SetMinimum(3.380497e-08);
   Graph_Graph01072->SetMaximum(1.732202e-05);
