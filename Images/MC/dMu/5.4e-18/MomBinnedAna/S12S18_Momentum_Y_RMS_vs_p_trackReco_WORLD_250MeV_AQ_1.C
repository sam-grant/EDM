...
//=========  (Wed Jan 19 10:50:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,6.087051,3509.674,29.55856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01184 = new TH1F("Graph_Graph01184","S12S18_",100,0,3088.822);
   Graph_Graph01184->SetMinimum(8.434202);
   Graph_Graph01184->SetMaximum(27.21141);
