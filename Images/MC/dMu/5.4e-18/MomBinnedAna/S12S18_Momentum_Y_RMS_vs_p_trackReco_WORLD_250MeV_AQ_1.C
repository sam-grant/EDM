...
//=========  (Thu Nov 18 11:29:50 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6759,3.693717,2724.308,26.5092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S12S18_",100,0,3091.413);
   Graph_Graph01060->SetMinimum(5.975265);
   Graph_Graph01060->SetMaximum(24.22765);
