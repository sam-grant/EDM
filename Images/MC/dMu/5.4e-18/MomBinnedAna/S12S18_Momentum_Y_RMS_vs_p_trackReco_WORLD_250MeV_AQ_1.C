void S12S18_Momentum_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,3.693717,2744.438,26.5092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S12S18_",100,0,3150);
   Graph_Graph01050->SetMinimum(5.975265);
   Graph_Graph01050->SetMaximum(24.22765);
   ...
   Graph_Graph01050->GetXaxis()->SetRange(24,80);
