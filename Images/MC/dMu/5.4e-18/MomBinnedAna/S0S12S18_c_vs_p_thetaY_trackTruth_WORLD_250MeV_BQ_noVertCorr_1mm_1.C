...
//=========  (Mon Apr 25 18:52:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.3211,-1.856775,3381.851,6.843555);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01205 = new TH1F("Graph_Graph01205","S0S12S18_",100,217.4926,3027.134);
   Graph_Graph01205->SetMinimum(-0.9867417);
   Graph_Graph01205->SetMaximum(5.973522);
