...
//=========  (Tue Feb 22 00:12:26 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3944,-3.736471e-06,3407.426,1.200136e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01209 = new TH1F("Graph_Graph01209","S0S12S18_",100,218.1255,3021.906);
   Graph_Graph01209->SetMinimum(-2.162688e-06);
   Graph_Graph01209->SetMaximum(1.042758e-05);
