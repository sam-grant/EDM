...
//=========  (Fri Dec  3 15:29:08 2021) by ROOT version 6.24/04
   ...
   c->Range(493.4803,0.9455479,3019.167,202.2323);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S0_",100,0,3108.538);
   Graph_Graph01047->SetMinimum(21.07423);
   Graph_Graph01047->SetMaximum(182.1036);
