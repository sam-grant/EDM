...
//=========  (Mon Mar 21 12:27:20 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3594,-1382955,3407.009,1949901);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","S12_",100,218.1118,3021.538);
   Graph_Graph01103->SetMinimum(-1049669);
   Graph_Graph01103->SetMaximum(1616615);
