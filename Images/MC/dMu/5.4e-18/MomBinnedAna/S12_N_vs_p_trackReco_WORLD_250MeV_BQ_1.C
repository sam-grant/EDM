...
//=========  (Sun Dec  5 19:01:37 2021) by ROOT version 6.24/04
   ...
   c->Range(466.6541,-121754,3025.214,991005.6);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S12_",100,217.8079,3021.709);
   Graph_Graph01059->SetMinimum(-10478.02);
   Graph_Graph01059->SetMaximum(879729.7);
   ...
   Graph_Graph01059->GetXaxis()->SetRange(19,91);
