...
//=========  (Fri Nov 19 17:35:24 2021) by ROOT version 6.24/04
   ...
   c->Range(7.515281,-2.158619,3232.002,6.756938);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12_",100,217.8079,3021.709);
   Graph_Graph01049->SetMinimum(-1.267063);
   Graph_Graph01049->SetMaximum(5.865382);
