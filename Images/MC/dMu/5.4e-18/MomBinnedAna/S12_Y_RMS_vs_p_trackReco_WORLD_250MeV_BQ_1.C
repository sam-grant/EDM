...
//=========  (Mon Mar 21 12:27:20 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3594,9.38729,3407.009,16.77986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S12_",100,218.1118,3021.538);
   Graph_Graph01101->SetMinimum(10.12655);
   Graph_Graph01101->SetMaximum(16.0406);
