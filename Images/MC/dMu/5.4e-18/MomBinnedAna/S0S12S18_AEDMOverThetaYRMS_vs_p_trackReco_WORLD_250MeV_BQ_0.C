...
//=========  (Wed Dec  8 12:48:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.5781,-0.03266343,3407.915,0.0294376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01219->SetMinimum(-0.02645333);
   Graph_Graph01219->SetMaximum(0.0232275);
