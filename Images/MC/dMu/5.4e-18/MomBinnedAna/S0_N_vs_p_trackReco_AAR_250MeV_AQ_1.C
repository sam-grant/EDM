...
//=========  (Thu Oct 21 14:33:29 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-171929.1,2744.438,1579762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(3240);
   Graph_Graph01021->SetMaximum(1404593);
