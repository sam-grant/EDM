...
//=========  (Thu Nov 18 15:57:49 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6918,-0.00035384,2741.169,0.0002171331);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S18_",100,218.3822,3021.478);
   Graph_Graph01047->SetMinimum(-0.0002967427);
   Graph_Graph01047->SetMaximum(0.0001600358);
