void S12S18_c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1c_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:17:28 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.5984041,3407.936,1.023651);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-0.4361986);
   Graph_Graph01125->SetMaximum(0.8614455);
