...
//=========  (Wed Dec  8 12:48:43 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.0435,-1.83988e-05,3406.904,0.0001661082);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,218.3822,3021.478);
   Graph_Graph01142->SetMinimum(5.189958e-08);
   Graph_Graph01142->SetMaximum(0.0001476575);
