void S12S18_Ag2_vs_p_A_trackReco_WORLD_250MeV_BQ_noVertCorr_0()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jun  7 22:41:33 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.6875,-1.962944e-05,3375.235,4.023944e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01173->SetMinimum(-1.72641e-05);
   Graph_Graph01173->SetMaximum(1.658606e-06);
