...
//=========  (Tue Dec 14 16:33:20 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-6.554848,3411.031,68.41216);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01100 = new TH1F("Graph_Graph01100","S12_",100,218.7344,3025.149);
   Graph_Graph01100->SetMinimum(0.941853);
   Graph_Graph01100->SetMaximum(60.91546);
