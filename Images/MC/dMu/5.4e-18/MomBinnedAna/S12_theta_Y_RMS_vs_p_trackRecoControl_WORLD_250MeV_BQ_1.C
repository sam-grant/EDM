void S12_theta_Y_RMS_vs_p_trackRecoControl_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-2.294541,2750,40.47294);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01028 = new TH1F("Graph_Graph01028","S12_",100,125,3125);
   Graph_Graph01028->SetMinimum(1.982207);
   Graph_Graph01028->SetMaximum(36.19619);
   ...
   Graph_Graph01028->GetXaxis()->SetRange(21,80);
   ...
   Graph_Graph01028->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad]");
