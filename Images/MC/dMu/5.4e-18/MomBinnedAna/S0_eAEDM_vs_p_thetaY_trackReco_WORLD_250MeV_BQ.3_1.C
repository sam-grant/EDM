void S0_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_BQ.3_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:34:58 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.1412,-0.05656992,3409.454,0.7129073);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0_",100,217.6779,3023.635);
   Graph_Graph01067->SetMinimum(0.02037781);
   Graph_Graph01067->SetMaximum(0.6359596);
