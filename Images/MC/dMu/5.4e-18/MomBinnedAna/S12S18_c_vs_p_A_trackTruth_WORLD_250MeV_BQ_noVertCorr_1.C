...
//=========  (Wed Apr 13 12:27:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-377.626,-21.86611,3398.634,22.86568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   1.759719e-07,
   4.434484e-06};
   TGraphErrors *gre = new TGraphErrors(12,Graph0_fx1175,Graph0_fy1175,Graph0_fex1175,Graph0_fey1175);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01175 = new TH1F("Graph_Graph01175","S12S18_",100,0,3051.523);
   Graph_Graph01175->SetMinimum(-17.39294);
   Graph_Graph01175->SetMaximum(18.3925);
   ...
   Graph_Graph01175->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01175->GetYaxis()->SetTitle("c / 250 MeV");
