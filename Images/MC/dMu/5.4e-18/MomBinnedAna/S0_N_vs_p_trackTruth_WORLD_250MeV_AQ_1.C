...
//=========  (Fri Dec  3 15:29:08 2021) by ROOT version 6.24/04
   ...
   c->Range(493.4803,-136571.3,3019.167,3392114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S0_",100,0,3108.538);
   Graph_Graph01044->SetMinimum(216297.2);
   Graph_Graph01044->SetMaximum(3039245);
