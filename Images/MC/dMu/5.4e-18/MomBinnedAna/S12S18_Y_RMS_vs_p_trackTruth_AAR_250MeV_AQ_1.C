void S12S18_Y_RMS_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:13:37 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.4795,12.00131,3331.735,13.81441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01084 = new TH1F("Graph_Graph01084","S12S18_",100,0,3092.097);
   Graph_Graph01084->SetMinimum(12.18262);
   Graph_Graph01084->SetMaximum(13.6331);
   ...
   Graph_Graph01084->GetXaxis()->SetRange(3,96);
