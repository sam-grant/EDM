void S0S12S18_c_vs_p_thetaY_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:32:10 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.5493,-3.500302,3332.506,2.429852);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01091 = new TH1F("Graph_Graph01091","S0S12S18_",100,0,3092.813);
   Graph_Graph01091->SetMinimum(-2.907286);
   Graph_Graph01091->SetMaximum(1.836837);
   ...
   Graph_Graph01091->GetXaxis()->SetRange(3,96);
