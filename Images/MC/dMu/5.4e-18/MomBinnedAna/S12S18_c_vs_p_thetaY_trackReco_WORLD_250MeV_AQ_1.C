...
//=========  (Mon Dec  6 08:42:17 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9638,-9.878245,3509.674,6.523739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01080->SetMinimum(-8.238047);
   Graph_Graph01080->SetMaximum(4.883541);
   ...
   Graph_Graph01080->GetXaxis()->SetRange(1,101);
