...
//=========  (Wed Jan 19 10:50:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,-8.891843,3509.674,23.47328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01176 = new TH1F("Graph_Graph01176","S12S18_",100,0,3088.822);
   Graph_Graph01176->SetMinimum(-5.65533);
   Graph_Graph01176->SetMaximum(20.23677);
