void S0S12S18_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 18:56:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.5622,0.004429518,3035.222,0.01896208);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S0S12S18_",100,0,3089.284);
   Graph_Graph01105->SetMinimum(0.005882774);
   Graph_Graph01105->SetMaximum(0.01750883);
   ...
   Graph_Graph01105->GetXaxis()->SetRange(25,90);
   ...
   Graph_Graph01105->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
