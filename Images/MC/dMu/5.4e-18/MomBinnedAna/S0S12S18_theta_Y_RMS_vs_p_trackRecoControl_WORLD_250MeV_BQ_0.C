...
//=========  (Thu Nov 18 11:36:37 2021) by ROOT version 6.24/04
   ...
   c->Range(499.6469,-2.275202,2744.532,40.70494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01068->SetMinimum(2.022812);
   Graph_Graph01068->SetMaximum(36.40692);
