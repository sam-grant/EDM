void eAEDM_vs_p_acceptedDecaysControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:29:21 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(526.691,-0.005324909,2750.498,0.05427248);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","",100,0,3121.132);
   Graph_Graph01016->SetMinimum(0.0006348298);
   Graph_Graph01016->SetMaximum(0.04831274);
   ...
   Graph_Graph01016->GetXaxis()->SetRange(25,81);
   ...
   Graph_Graph01016->GetYaxis()->SetTitle("#deltaA_{EDM} / 250 MeV");
