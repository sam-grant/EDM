...
//=========  (Mon Nov 22 14:17:45 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.6902,-175192,3334.064,1579824);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S0_",100,0,3094.258);
   Graph_Graph01044->SetMinimum(309.6);
   Graph_Graph01044->SetMaximum(1404322);
   ...
   Graph_Graph01044->GetXaxis()->SetRange(3,96);
