void S0S12S18_Ag2_vs_p_trackReco_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:29:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.8401,-0.8637041,2725.165,0.9700009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0S12S18_",100,0,3092.386);
   Graph_Graph01067->SetMinimum(-0.6803336);
   Graph_Graph01067->SetMaximum(0.7866304);
