void S12S18_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,10.05771,2744.438,27.05847);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12S18_",100,0,3150);
   Graph_Graph01049->SetMinimum(11.75779);
   Graph_Graph01049->SetMaximum(25.35839);
   ...
   Graph_Graph01049->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01049->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01049->GetYaxis()->SetTitle("#sigma_{y} [mm]");
