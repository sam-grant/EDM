...
//=========  (Sun Dec  5 19:11:59 2021) by ROOT version 6.24/04
   ...
   c->Range(466.8109,-118729.2,3029.776,989756.6);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S12_",100,217.5362,3026.265);
   Graph_Graph01059->SetMinimum(-7880.596);
   Graph_Graph01059->SetMaximum(878908);
