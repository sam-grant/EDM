void S0_eAEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:03 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.5089,0.007301865,3034.889,0.0884185);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S0_",100,0,3088.946);
   Graph_Graph01045->SetMinimum(0.01541353);
   Graph_Graph01045->SetMaximum(0.08030684);
   ...
   Graph_Graph01045->GetXaxis()->SetRange(25,90);
