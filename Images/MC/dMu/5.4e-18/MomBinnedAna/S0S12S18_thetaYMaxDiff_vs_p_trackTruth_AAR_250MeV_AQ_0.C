...
//=========  (Thu Nov 18 11:38:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.9122,-24.32364,2725.542,423.1933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01073 = new TH1F("Graph_Graph01073","S0S12S18_",100,0,3092.813);
   Graph_Graph01073->SetMinimum(20.42806);
   Graph_Graph01073->SetMaximum(378.4416);
   ...
   Graph_Graph01073->GetXaxis()->SetRange(25,81);
