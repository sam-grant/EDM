...
//=========  (Fri Nov 19 17:38:11 2021) by ROOT version 6.24/04
   ...
   c->Range(7.50122,-1.323616e-05,3236.776,0.0001208746);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S18_",100,218.1061,3026.171);
   Graph_Graph01074->SetMinimum(1.749145e-07);
   Graph_Graph01074->SetMaximum(0.0001074635);
