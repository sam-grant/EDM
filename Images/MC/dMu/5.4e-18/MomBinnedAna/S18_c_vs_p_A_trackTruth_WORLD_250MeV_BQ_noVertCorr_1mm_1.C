...
//=========  (Mon Apr 25 18:52:07 2022) by ROOT version 6.24/06
   ...
   c->Range(-161.878,-7.643325e-05,3351.747,0.0002376364);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01134 = new TH1F("Graph_Graph01134","S18_",100,217.5936,3028.494);
   Graph_Graph01134->SetMinimum(-4.502628e-05);
   Graph_Graph01134->SetMaximum(0.0002062295);
   ...
   Graph_Graph01134->GetXaxis()->SetRange(0,99);
