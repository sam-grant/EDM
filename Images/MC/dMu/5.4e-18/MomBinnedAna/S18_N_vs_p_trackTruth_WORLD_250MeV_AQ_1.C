...
//=========  (Mon Nov 22 14:13:02 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.4644,-173831.3,3331.568,1567721);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S18_",100,0,3091.942);
   Graph_Graph01072->SetMinimum(324);
   Graph_Graph01072->SetMaximum(1393566);
   ...
   Graph_Graph01072->GetXaxis()->SetRange(3,96);
