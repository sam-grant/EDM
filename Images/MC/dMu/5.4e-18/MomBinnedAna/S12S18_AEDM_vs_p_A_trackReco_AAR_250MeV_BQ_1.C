...
//=========  (Wed Dec  1 13:32:14 2021) by ROOT version 6.24/04
   ...
   c->Range(7.865666,-2.94509e-05,3231.802,7.881723e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S12S18_",100,218.1224,3021.545);
   Graph_Graph01081->SetMinimum(-1.862408e-05);
   Graph_Graph01081->SetMaximum(6.799042e-05);
   ...
   Graph_Graph01081->GetXaxis()->SetRange(5,96);
   ...
   Graph_Graph01081->GetYaxis()->SetTitle("A_{EDM} / 250 MeV");
