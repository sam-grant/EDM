...
//=========  (Fri Nov 19 17:36:47 2021) by ROOT version 6.24/04
   ...
   c->Range(8.41028,11.97158,3235.149,14.2303);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S18_",100,218.8498,3024.71);
   Graph_Graph01070->SetMinimum(12.19746);
   Graph_Graph01070->SetMaximum(14.00443);
