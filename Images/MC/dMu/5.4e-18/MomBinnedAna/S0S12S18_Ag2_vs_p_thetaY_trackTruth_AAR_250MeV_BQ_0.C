void S0S12S18_Ag2_vs_p_thetaY_trackTruth_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:38:56 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.121727,-0.2051818,3237.191,0.5565741);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.1290062);
   Graph_Graph01093->SetMaximum(0.4803985);
