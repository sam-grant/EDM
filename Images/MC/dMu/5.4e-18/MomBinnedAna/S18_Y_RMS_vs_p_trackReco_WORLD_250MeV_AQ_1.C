...
//=========  (Mon Nov 22 14:10:41 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1968,10.1503,3334.918,26.56484);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S18_",100,0,3091.465);
   Graph_Graph01070->SetMinimum(11.79175);
   Graph_Graph01070->SetMaximum(24.92338);
