...
//=========  (Tue Dec 14 16:33:19 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-0.001475758,3411.031,0.002501228);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S12_",100,218.7344,3025.149);
   Graph_Graph01097->SetMinimum(-0.00107806);
   Graph_Graph01097->SetMaximum(0.002103529);
