void S0S12S18_AEDM_vs_p_thetaY_trackReco_WORLD_250MeV_pValQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:49:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.5489,-0.3429779,3406.94,0.5537762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,0,3090.195);
   Graph_Graph01216->SetMinimum(-0.2533025);
   Graph_Graph01216->SetMaximum(0.4641008);
   ...
   Graph_Graph01216->GetXaxis()->SetRange(1,98);
