...
//=========  (Mon Nov 22 14:15:53 2021) by ROOT version 6.24/04
   ...
   c->Range(7.894367,-0.01027806,3231.754,0.1613052);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","S12S18_",100,218.1461,3021.502);
   Graph_Graph01087->SetMinimum(0.006880263);
   Graph_Graph01087->SetMaximum(0.1441469);
