...
//=========  (Mon Dec  6 08:42:18 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9638,-683619.9,3509.674,6432226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01089->SetMinimum(27964.8);
   Graph_Graph01089->SetMaximum(5720642);
   ...
   Graph_Graph01089->GetXaxis()->SetRange(1,101);
