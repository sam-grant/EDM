...
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7653,2.383869,2724.774,26.63563);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S18_",100,0,3091.942);
   Graph_Graph01050->SetMinimum(4.809045);
   Graph_Graph01050->SetMaximum(24.21045);
