void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_accepted2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb 24 02:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-1.572581e-08,3548.544,1.356183e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01046->SetMinimum(-5.914008e-10);
   Graph_Graph01046->SetMaximum(1.204838e-07);
