...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,-2.279792,3510.154,49.65008);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01056->SetMinimum(2.913196);
   Graph_Graph01056->SetMaximum(44.4571);
   ...
   Graph_Graph01056->GetXaxis()->SetRange(1,101);
