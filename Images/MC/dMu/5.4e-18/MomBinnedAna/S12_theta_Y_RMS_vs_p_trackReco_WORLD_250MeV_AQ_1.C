...
//=========  (Wed Jan 19 10:50:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0171,-3.744872,3510.154,66.7471);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01104 = new TH1F("Graph_Graph01104","S12_",100,0,3089.244);
   Graph_Graph01104->SetMinimum(3.304326);
   Graph_Graph01104->SetMaximum(59.6979);
