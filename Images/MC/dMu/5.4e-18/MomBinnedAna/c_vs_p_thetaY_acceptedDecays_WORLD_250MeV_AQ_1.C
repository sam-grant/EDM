...
//=========  (Fri Dec  3 15:24:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(495.4746,-0.09624688,3031.369,0.0176114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-0.08486105);
   Graph_Graph01011->SetMaximum(0.006225569);
