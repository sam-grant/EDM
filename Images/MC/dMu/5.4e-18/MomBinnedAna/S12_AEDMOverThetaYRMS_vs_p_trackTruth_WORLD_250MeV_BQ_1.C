...
//=========  (Mon May 30 11:51:25 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.8407,-0.005837603,3380.646,0.02177415);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01108 = new TH1F("Graph_Graph01108","S12_",100,217.791,3026.097);
   Graph_Graph01108->SetMinimum(-0.003076427);
   Graph_Graph01108->SetMaximum(0.01901297);
