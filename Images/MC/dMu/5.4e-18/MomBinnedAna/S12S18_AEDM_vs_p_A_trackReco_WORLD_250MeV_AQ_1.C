...
//=========  (Fri Nov 19 17:28:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1912,-0.0001627985,3334.862,0.000698819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01082 = new TH1F("Graph_Graph01082","S12S18_",100,0,3091.413);
   Graph_Graph01082->SetMinimum(-7.663674e-05);
   Graph_Graph01082->SetMaximum(0.0006126572);
