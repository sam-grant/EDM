void S0_Ag2_vs_p_thetaY_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:16:58 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.618866,-0.7629095,3236.488,1.304917);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S0_",100,219.1321,3025.975);
   Graph_Graph01037->SetMinimum(-0.5561269);
   Graph_Graph01037->SetMaximum(1.098134);
   ...
   Graph_Graph01037->GetXaxis()->SetRange(5,96);
