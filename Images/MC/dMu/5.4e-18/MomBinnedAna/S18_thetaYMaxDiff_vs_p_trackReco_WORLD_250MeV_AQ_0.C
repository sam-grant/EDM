void S18_thetaYMaxDiff_vs_p_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:35:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1968,-60.18507,3334.918,1228.387);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,0,3091.465);
   Graph_Graph01075->SetMinimum(68.67212);
   Graph_Graph01075->SetMaximum(1099.53);
   ...
   Graph_Graph01075->GetXaxis()->SetRange(2,96);
