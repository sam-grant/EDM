void S12S18_c_vs_p_thetaY_trackReco_WORLD_250MeV_BQ_acceptanceCorrected.reweight_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Feb 22 00:44:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.1673,-1.261732,3406.642,7.552582);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01168 = new TH1F("Graph_Graph01168","S12S18_",100,218.2436,3021.231);
   Graph_Graph01168->SetMinimum(-0.3803003);
   Graph_Graph01168->SetMaximum(6.671151);
