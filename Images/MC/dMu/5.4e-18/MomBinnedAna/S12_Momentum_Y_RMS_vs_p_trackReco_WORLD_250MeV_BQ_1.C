...
//=========  (Fri Mar 25 02:59:07 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.9079,11.83163,3375.532,23.33813);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S12_",100,218.0713,3021.588);
   Graph_Graph01102->SetMinimum(12.98228);
   Graph_Graph01102->SetMaximum(22.18748);
