void S0_AEDM_vs_p_A_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:33:09 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.6296,-9.176638e-07,3035.642,-9.937775e-09);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S0_",100,0,3089.712);
   Graph_Graph01039->SetMinimum(-8.268912e-07);
   Graph_Graph01039->SetMaximum(-1.007104e-07);
