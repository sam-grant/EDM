void S12_AEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.4195,-0.1359674,3034.332,-0.05851667);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01051->SetMinimum(-0.1282223);
   Graph_Graph01051->SetMaximum(-0.06626174);
