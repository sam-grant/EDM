void S0_AEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:37:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.6902,-2.617394,3334.064,13.08092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","S0_",100,0,3094.258);
   Graph_Graph01036->SetMinimum(-1.047563);
   Graph_Graph01036->SetMaximum(11.51109);
   ...
   Graph_Graph01036->GetXaxis()->SetRange(3,96);
