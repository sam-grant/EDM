void theta_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS18_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 15:09:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-13.02178,3407.936,153.1554);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(3.595931);
   Graph_Graph01041->SetMaximum(136.5376);
