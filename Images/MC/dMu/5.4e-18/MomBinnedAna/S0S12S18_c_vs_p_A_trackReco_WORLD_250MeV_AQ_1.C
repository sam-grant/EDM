...
//=========  (Wed Jan 19 10:50:40 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0221,-1.925331e-05,3510.199,0.000157105);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01218 = new TH1F("Graph_Graph01218","S0S12S18_",100,0,3089.284);
   Graph_Graph01218->SetMinimum(-1.617475e-06);
   Graph_Graph01218->SetMaximum(0.0001394692);
