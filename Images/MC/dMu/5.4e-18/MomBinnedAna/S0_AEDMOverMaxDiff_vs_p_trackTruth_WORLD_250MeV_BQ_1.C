void S0_AEDMOverMaxDiff_vs_p_trackTruth_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:31:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(6.745611,-0.004894257,3238.085,0.004740838);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S0_",100,217.4851,3027.345);
   Graph_Graph01048->SetMinimum(-0.003930747);
   Graph_Graph01048->SetMaximum(0.003777328);
