...
//=========  (Tue Dec 14 16:33:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,-0.1379665,3410.59,1.608997);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01141 = new TH1F("Graph_Graph01141","S18_",100,218.8378,3024.773);
   Graph_Graph01141->SetMinimum(0.03672985);
   Graph_Graph01141->SetMaximum(1.434301);
