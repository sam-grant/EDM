...
//=========  (Sun Dec  5 19:39:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(467.8646,-0.02611654,3028.281,0.6023475);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01075->SetMinimum(0.03672987);
   Graph_Graph01075->SetMaximum(0.5395011);
