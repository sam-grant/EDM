void S18_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
...
//=========  (Fri Apr  8 13:12:11 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01093 = new TH1F("Graph_Graph01093","S18_",100,0,3122.965);
   Graph_Graph01093->SetMinimum(13.18953);
   Graph_Graph01093->SetMaximum(13.2478);
   ...
   Graph_Graph01093->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01093->GetYaxis()->SetTitle("#sigma_{y} [mm] / 250 MeV");
