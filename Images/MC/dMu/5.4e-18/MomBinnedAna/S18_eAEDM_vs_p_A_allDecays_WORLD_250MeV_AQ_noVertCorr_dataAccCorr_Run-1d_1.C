void S18_eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1d_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:19:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-1.065701e-08,3407.936,1.220937e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S18_",100,0,3122.965);
   Graph_Graph01097->SetMinimum(2.618057e-09);
   Graph_Graph01097->SetMaximum(1.088186e-07);
   ...
   Graph_Graph01097->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01097->GetYaxis()->SetTitle("#deltaA_{EDM} / 250 MeV");
