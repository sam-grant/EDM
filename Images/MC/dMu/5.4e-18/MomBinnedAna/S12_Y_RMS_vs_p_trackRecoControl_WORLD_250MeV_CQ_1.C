...
//=========  (Tue Dec 14 16:27:36 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9078,6.751134,3509.17,57.0839);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,0,3088.378);
   Graph_Graph01105->SetMinimum(11.78441);
   Graph_Graph01105->SetMaximum(52.05062);
