...
//=========  (Fri Mar 25 02:59:04 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.6244,-0.01373726,3377.861,0.2079114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0_",100,217.6834,3023.612);
   Graph_Graph01067->SetMinimum(0.008427612);
   Graph_Graph01067->SetMaximum(0.1857466);
