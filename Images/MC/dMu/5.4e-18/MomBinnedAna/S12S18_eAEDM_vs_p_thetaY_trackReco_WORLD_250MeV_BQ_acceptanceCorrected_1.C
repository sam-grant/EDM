...
//=========  (Tue Feb 22 00:12:22 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1692,-0.0446632,3406.642,0.5410002);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01178 = new TH1F("Graph_Graph01178","S12S18_",100,218.2418,3021.231);
   Graph_Graph01178->SetMinimum(0.01390315);
   Graph_Graph01178->SetMaximum(0.4824338);
