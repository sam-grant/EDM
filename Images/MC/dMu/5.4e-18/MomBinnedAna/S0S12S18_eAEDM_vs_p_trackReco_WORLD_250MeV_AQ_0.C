...
//=========  (Thu Nov 18 11:35:14 2021) by ROOT version 6.24/04
   ...
   c->Range(521.8401,-0.06959146,2725.165,0.7416936);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S0S12S18_",100,0,3092.386);
   Graph_Graph01072->SetMinimum(0.01153705);
   Graph_Graph01072->SetMaximum(0.6605651);
