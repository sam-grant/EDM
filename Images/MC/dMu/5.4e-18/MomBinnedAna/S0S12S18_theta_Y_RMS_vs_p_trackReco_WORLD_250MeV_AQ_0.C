void S0S12S18_theta_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-5.957938,2744.438,59.10871);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0S12S18_",100,0,3150);
   Graph_Graph01058->SetMinimum(0.5487272);
   Graph_Graph01058->SetMaximum(52.60205);
   ...
   Graph_Graph01058->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01058->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad]");
