...
//=========  (Thu Nov 18 11:35:14 2021) by ROOT version 6.24/04
   ...
   c->Range(521.8401,-5.957938,2725.165,59.10871);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0S12S18_",100,0,3092.386);
   Graph_Graph01068->SetMinimum(0.5487272);
   Graph_Graph01068->SetMaximum(52.60205);
