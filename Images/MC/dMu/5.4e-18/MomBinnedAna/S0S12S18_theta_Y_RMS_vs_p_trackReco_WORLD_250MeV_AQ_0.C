...
//=========  (Fri Nov 19 17:35:04 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.297,-5.957938,3335.911,59.10871);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,0,3092.386);
   Graph_Graph01097->SetMinimum(0.5487272);
   Graph_Graph01097->SetMaximum(52.60205);
   ...
   Graph_Graph01097->GetXaxis()->SetRange(2,96);
