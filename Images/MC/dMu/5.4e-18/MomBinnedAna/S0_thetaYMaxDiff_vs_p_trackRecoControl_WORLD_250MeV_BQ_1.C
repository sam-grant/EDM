void S0_thetaYMaxDiff_vs_p_trackRecoControl_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-36.71121,2750,332.6081);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","S0_",100,125,3125);
   Graph_Graph01023->SetMinimum(0.2207299);
   Graph_Graph01023->SetMaximum(295.6762);
