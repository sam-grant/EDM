void S18_theta_Y_RMS_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-13.0732,2744.438,212.5745);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S18_",100,0,3150);
   Graph_Graph01038->SetMinimum(9.491571);
   Graph_Graph01038->SetMaximum(190.0097);
   ...
   Graph_Graph01038->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01038->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad]");
