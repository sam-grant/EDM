...
//=========  (Mon Apr 25 18:52:03 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.3732,-0.002957298,3381.354,0.0140832);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S12_",100,217.3924,3026.681);
   Graph_Graph01107->SetMinimum(-0.001253248);
   Graph_Graph01107->SetMaximum(0.01237915);
