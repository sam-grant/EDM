...
//=========  (Fri Dec  3 15:27:30 2021) by ROOT version 6.24/04
   ...
   c->Range(486.3887,-0.08964336,3034.139,0.2696297);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S18_",100,0,3088.183);
   Graph_Graph01065->SetMinimum(-0.05371605);
   Graph_Graph01065->SetMaximum(0.2337024);
