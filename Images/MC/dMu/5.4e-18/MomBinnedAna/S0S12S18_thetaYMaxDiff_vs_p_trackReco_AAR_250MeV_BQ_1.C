void S0S12S18_thetaYMaxDiff_vs_p_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Dec  1 13:32:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.685561,-15.80544,3232.676,228.0793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","S0S12S18_",100,218.0111,3022.351);
   Graph_Graph01103->SetMinimum(8.583035);
   Graph_Graph01103->SetMaximum(203.6909);
