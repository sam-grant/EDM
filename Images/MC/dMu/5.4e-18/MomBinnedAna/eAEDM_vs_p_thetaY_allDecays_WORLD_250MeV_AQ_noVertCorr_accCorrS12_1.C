void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:43:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,0.003264908,3407.936,0.01029969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(0.003968386);
   Graph_Graph01045->SetMaximum(0.00959621);
