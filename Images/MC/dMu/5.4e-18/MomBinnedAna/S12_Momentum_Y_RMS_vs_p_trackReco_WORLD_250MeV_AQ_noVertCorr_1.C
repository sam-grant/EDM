void S12_Momentum_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:20:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.4225,12.84699,3405.802,24.66955);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01106 = new TH1F("Graph_Graph01106","S12_",100,0,3089.163);
   Graph_Graph01106->SetMinimum(14.02925);
   Graph_Graph01106->SetMaximum(23.4873);
