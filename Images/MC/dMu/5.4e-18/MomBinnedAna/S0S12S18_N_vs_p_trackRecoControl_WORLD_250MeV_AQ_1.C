void S0S12S18_N_vs_p_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-121484,2750,1122021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0S12S18_",100,125,3125);
   Graph_Graph01061->SetMinimum(2866.5);
   Graph_Graph01061->SetMaximum(997670.8);
   ...
   Graph_Graph01061->GetXaxis()->SetRange(21,80);
