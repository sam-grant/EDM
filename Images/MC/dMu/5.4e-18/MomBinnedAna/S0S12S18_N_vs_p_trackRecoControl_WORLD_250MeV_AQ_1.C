...
//=========  (Thu Nov 18 11:31:00 2021) by ROOT version 6.24/04
   ...
   c->Range(499.6469,-121484,2744.532,1122021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01071->SetMinimum(2866.5);
   Graph_Graph01071->SetMaximum(997670.8);
