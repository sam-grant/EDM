void S0S12S18_AEDM_vs_p_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:31:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.6469,-0.6568232,2744.532,0.8783758);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01066->SetMinimum(-0.5033033);
   Graph_Graph01066->SetMaximum(0.7248559);
