...
//=========  (Tue Dec 14 16:33:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,8.962294,3411.922,19.63635);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S0_",100,219.0854,3025.975);
   Graph_Graph01064->SetMinimum(10.0297);
   Graph_Graph01064->SetMaximum(18.56894);
