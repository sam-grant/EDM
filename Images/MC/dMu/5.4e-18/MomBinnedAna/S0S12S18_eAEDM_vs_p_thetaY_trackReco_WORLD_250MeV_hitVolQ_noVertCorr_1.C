void S0S12S18_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_hitVolQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:38:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.4284,-0.03048884,3405.856,0.3419959);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01225 = new TH1F("Graph_Graph01225","S0S12S18_",100,0,3089.212);
   Graph_Graph01225->SetMinimum(0.006759631);
   Graph_Graph01225->SetMaximum(0.3047474);
