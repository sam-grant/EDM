...
//=========  (Tue Dec 14 16:33:23 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,-6.217401,3410.59,51.76778);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S18_",100,218.8378,3024.773);
   Graph_Graph01131->SetMinimum(-0.4188823);
   Graph_Graph01131->SetMaximum(45.96926);
