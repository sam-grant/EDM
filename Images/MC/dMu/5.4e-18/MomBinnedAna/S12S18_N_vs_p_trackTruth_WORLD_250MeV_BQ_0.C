...
//=========  (Fri Dec  3 15:36:11 2021) by ROOT version 6.24/04
   ...
   c->Range(467.1062,-238406.4,3029.613,1982452);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01089 = new TH1F("Graph_Graph01089","S12S18_",100,217.876,3026.103);
   Graph_Graph01089->SetMinimum(-16320.62);
   Graph_Graph01089->SetMaximum(1760366);
