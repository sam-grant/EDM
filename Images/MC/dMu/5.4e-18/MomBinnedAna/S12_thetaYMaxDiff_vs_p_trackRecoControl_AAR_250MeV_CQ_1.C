void S12_thetaYMaxDiff_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,926.0259,2744.438,1102.369);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S12_",100,0,3150);
   Graph_Graph01033->SetMinimum(943.6602);
   Graph_Graph01033->SetMaximum(1084.735);
   ...
   Graph_Graph01033->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01033->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
