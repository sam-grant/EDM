...
//=========  (Tue Dec 14 16:33:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,-0.0002154818,3411.922,0.00124479);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0_",100,219.0854,3025.975);
   Graph_Graph01061->SetMinimum(-6.945456e-05);
   Graph_Graph01061->SetMaximum(0.001098763);
