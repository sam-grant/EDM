void S18_eAEDM_vs_p_A_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:06 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.2651,-1.575145e-07,3033.368,1.724675e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01076 = new TH1F("Graph_Graph01076","S18_",100,0,3087.398);
   Graph_Graph01076->SetMinimum(3.070442e-08);
   Graph_Graph01076->SetMaximum(1.536456e-06);
   ...
   Graph_Graph01076->GetXaxis()->SetRange(25,90);
