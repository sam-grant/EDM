void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 18:13:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.008884377,3407.936,0.08743034);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(0.0007470951);
   Graph_Graph01045->SetMaximum(0.07779887);
