...
//=========  (Mon Nov 22 14:15:54 2021) by ROOT version 6.24/04
   ...
   c->Range(7.69113,11.82672,3232.646,23.37783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01099 = new TH1F("Graph_Graph01099","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01099->SetMinimum(12.98183);
   Graph_Graph01099->SetMaximum(22.22272);
