...
//=========  (Fri Dec  3 15:33:09 2021) by ROOT version 6.24/04
   ...
   c->Range(486.6296,0.01202126,3035.642,0.05506504);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S0_",100,0,3089.712);
   Graph_Graph01045->SetMinimum(0.01632564);
   Graph_Graph01045->SetMaximum(0.05076067);
