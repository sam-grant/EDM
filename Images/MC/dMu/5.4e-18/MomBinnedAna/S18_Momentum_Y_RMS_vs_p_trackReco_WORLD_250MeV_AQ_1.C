...
//=========  (Wed Jan 19 10:50:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9195,6.203283,3509.275,29.53447);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01145 = new TH1F("Graph_Graph01145","S18_",100,0,3088.471);
   Graph_Graph01145->SetMinimum(8.536402);
   Graph_Graph01145->SetMaximum(27.20136);
   ...
   Graph_Graph01145->GetXaxis()->SetRange(1,101);
