void thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:43:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,1.884047,3407.936,139.6319);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(15.65883);
   Graph_Graph01047->SetMaximum(125.8571);
