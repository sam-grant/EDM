void S18_c_vs_p_A_trackReco_WORLD_250MeV_BQ_acceptanceUncorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:31:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.5026,-2.572423e-05,3375.03,2.213827e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01134 = new TH1F("Graph_Graph01134","S18_",100,218.3787,3021.177);
   Graph_Graph01134->SetMinimum(-2.093798e-05);
   Graph_Graph01134->SetMaximum(1.735202e-05);
