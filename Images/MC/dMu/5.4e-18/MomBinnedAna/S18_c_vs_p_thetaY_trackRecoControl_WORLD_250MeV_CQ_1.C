...
//=========  (Tue Dec 14 16:27:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.784,-6.910213,3508.056,13.59623);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01137 = new TH1F("Graph_Graph01137","S18_",100,0,3087.398);
   Graph_Graph01137->SetMinimum(-4.859569);
   Graph_Graph01137->SetMaximum(11.54558);
   ...
   Graph_Graph01137->GetXaxis()->SetRange(1,101);
