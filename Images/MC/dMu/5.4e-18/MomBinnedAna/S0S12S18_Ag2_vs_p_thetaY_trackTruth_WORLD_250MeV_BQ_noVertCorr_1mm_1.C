...
//=========  (Wed Apr  6 12:55:09 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0369,-0.1973905,3380.183,0.550555);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01207 = new TH1F("Graph_Graph01207","S0S12S18_",100,217.5661,3025.661);
   Graph_Graph01207->SetMinimum(-0.1225959);
   Graph_Graph01207->SetMaximum(0.4757604);
