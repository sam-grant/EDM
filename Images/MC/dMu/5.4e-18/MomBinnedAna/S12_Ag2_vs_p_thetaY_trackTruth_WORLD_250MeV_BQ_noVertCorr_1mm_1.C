...
//=========  (Wed Apr  6 12:54:47 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0708,-0.4396566,3379.415,1.178925);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S12_",100,217.4529,3024.967);
   Graph_Graph01096->SetMinimum(-0.2777984);
   Graph_Graph01096->SetMaximum(1.017067);
