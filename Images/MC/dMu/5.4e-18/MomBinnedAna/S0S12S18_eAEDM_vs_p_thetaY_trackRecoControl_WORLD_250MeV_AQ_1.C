void S0S12S18_eAEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:27:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.5144,0.007004403,3034.923,0.03196597);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S0S12S18_",100,0,3088.981);
   Graph_Graph01105->SetMinimum(0.00950056);
   Graph_Graph01105->SetMaximum(0.02946981);
