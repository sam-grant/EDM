...
//=========  (Fri Dec  3 15:33:11 2021) by ROOT version 6.24/04
   ...
   c->Range(486.5144,0.009223532,3034.923,0.1207668);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,0,3088.981);
   Graph_Graph01097->SetMinimum(0.02037786);
   Graph_Graph01097->SetMaximum(0.1096125);
