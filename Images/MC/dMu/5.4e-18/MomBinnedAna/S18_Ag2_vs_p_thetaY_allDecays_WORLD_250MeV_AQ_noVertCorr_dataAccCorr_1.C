void S18_Ag2_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:12:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.08618161,3407.936,0.05351922);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01088 = new TH1F("Graph_Graph01088","S18_",100,0,3122.965);
   Graph_Graph01088->SetMinimum(-0.07221152);
   Graph_Graph01088->SetMaximum(0.03954913);
   ...
   Graph_Graph01088->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01088->GetYaxis()->SetTitle("A_{g#minus2} [mrad] / 250 MeV");
