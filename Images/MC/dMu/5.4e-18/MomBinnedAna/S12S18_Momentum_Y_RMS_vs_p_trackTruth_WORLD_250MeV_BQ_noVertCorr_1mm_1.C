...
//=========  (Wed Apr  6 12:55:02 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.8606,11.69586,3379.773,23.32782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01176 = new TH1F("Graph_Graph01176","S12S18_",100,217.6791,3025.309);
   Graph_Graph01176->SetMinimum(12.85906);
   Graph_Graph01176->SetMaximum(22.16463);
