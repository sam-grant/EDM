...
//=========  (Thu Nov 18 11:32:41 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7914,-2.763863,2724.911,42.01831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12S18_",100,0,3092.097);
   Graph_Graph01058->SetMinimum(1.714355);
   Graph_Graph01058->SetMaximum(37.54009);
   ...
   Graph_Graph01058->GetXaxis()->SetRange(25,81);
