void S0S12S18_AEDMOverThetaYRMS_vs_p_trackTruth_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 19:12:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(467.0549,-0.01021373,3030.042,0.02176534);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01109 = new TH1F("Graph_Graph01109","S0S12S18_",100,217.7781,3026.531);
   Graph_Graph01109->SetMinimum(-0.007015827);
   Graph_Graph01109->SetMaximum(0.01856743);
