void S12_AEDMOverThetaYRMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1a_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:34:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.004458954,3407.936,0.01952415);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12_",100,0,3122.965);
   Graph_Graph01061->SetMinimum(-0.002060644);
   Graph_Graph01061->SetMaximum(0.01712584);
   ...
   Graph_Graph01061->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01061->GetYaxis()->SetTitle("A_{EDM}/#sigma#theta_{y} / 250 MeV");
