void S18_AEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:12:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-1.352189e-07,3407.936,6.001514e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01090 = new TH1F("Graph_Graph01090","S18_",100,0,3122.965);
   Graph_Graph01090->SetMinimum(-6.168189e-08);
   Graph_Graph01090->SetMaximum(5.266144e-07);
   ...
   Graph_Graph01090->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01090->GetYaxis()->SetTitle("A_{EDM} / 250 MeV");
