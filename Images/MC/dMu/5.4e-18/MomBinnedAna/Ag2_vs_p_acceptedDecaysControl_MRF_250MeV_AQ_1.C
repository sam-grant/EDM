void Ag2_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,-7.090905,12,2.986887);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01009 = new TH1F("Graph_Graph01009","",100,1.2,10.8);
   Graph_Graph01009->SetMinimum(-6.083126);
   Graph_Graph01009->SetMaximum(1.979108);
   ...
   Graph_Graph01009->GetXaxis()->SetRange(1,100);
