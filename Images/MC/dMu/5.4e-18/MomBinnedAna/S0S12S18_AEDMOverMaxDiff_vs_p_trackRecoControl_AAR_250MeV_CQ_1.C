void S0S12S18_AEDMOverMaxDiff_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.0002774016,2744.438,0.002698667);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S0S12S18_",100,0,3150);
   Graph_Graph01064->SetMinimum(2.020528e-05);
   Graph_Graph01064->SetMaximum(0.00240106);
   ...
   Graph_Graph01064->GetXaxis()->SetRange(24,80);
