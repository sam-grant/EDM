...
//=========  (Fri Nov 19 18:50:19 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.267965,-1.778241,3234.092,7.322549);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S0_",100,217.713,3023.647);
   Graph_Graph01035->SetMinimum(-0.8681623);
   Graph_Graph01035->SetMaximum(6.41247);
