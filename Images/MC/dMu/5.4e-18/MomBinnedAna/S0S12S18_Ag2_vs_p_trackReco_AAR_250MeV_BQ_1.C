...
//=========  (Thu Nov 18 15:57:50 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4451,-7.419818e-05,2741.892,1.49093e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01067->SetMinimum(-6.528743e-05);
   Graph_Graph01067->SetMaximum(5.998548e-06);
