void S18_thetaYMaxDiff_vs_p_trackReco_WORLD_250MeV_BQ.1_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:33:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.3688,-36.03388,3407.305,318.5256);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01143 = new TH1F("Graph_Graph01143","S18_",100,218.1353,3021.801);
   Graph_Graph01143->SetMinimum(-0.5779306);
   Graph_Graph01143->SetMaximum(283.0696);
