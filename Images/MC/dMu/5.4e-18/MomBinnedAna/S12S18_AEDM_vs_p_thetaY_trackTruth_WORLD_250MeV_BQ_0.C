...
//=========  (Fri Dec  3 15:36:11 2021) by ROOT version 6.24/04
   ...
   c->Range(467.1062,0.009707632,3029.613,0.259326);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S12S18_",100,217.876,3026.103);
   Graph_Graph01081->SetMinimum(0.03466947);
   Graph_Graph01081->SetMaximum(0.2343641);
