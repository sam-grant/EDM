void S18_AEDM_vs_p_A_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:35:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1968,-0.0004892677,3334.918,0.002262131);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S18_",100,0,3091.465);
   Graph_Graph01068->SetMinimum(-0.0002141277);
   Graph_Graph01068->SetMaximum(0.001986991);
   ...
   Graph_Graph01068->GetXaxis()->SetRange(2,96);
   ...
   Graph_Graph01068->GetYaxis()->SetTitle("A_{EDM}");
