void S12S18_Momentum_Y_RMS_vs_p_trackRecoControl_AAR_250MeV_CQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:37 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,16.02795,2744.438,24.89887);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01050->SetMinimum(16.91505);
   Graph_Graph01050->SetMaximum(24.01178);
