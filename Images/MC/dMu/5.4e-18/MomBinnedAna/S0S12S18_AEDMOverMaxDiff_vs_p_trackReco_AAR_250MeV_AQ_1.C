...
//=========  (Thu Nov 18 11:30:26 2021) by ROOT version 6.24/04
   ...
   c->Range(521.8401,-0.0008571669,2725.165,0.001365757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S0S12S18_",100,0,3092.386);
   Graph_Graph01074->SetMinimum(-0.0006348745);
   Graph_Graph01074->SetMaximum(0.001143465);
