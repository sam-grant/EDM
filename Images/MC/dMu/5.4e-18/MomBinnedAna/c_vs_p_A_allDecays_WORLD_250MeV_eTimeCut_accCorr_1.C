void c_vs_p_A_allDecays_WORLD_250MeV_eTimeCut_accCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Mar 24 11:26:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-6.325814e-07,3407.936,1.261823e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01038->SetMinimum(-5.56705e-07);
   Graph_Graph01038->SetMaximum(5.030591e-08);
