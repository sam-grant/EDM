void Ag2_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 11:51:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-0.06089764,3372.878,0.05025718);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","",100,126.3702,3098.002);
   Graph_Graph01035->SetMinimum(-0.04978216);
   Graph_Graph01035->SetMaximum(0.03914169);
   ...
   Graph_Graph01035->GetXaxis()->SetRange(0,97);
   ...
   Graph_Graph01035->GetYaxis()->SetTitle("A_{g#minus2} [mrad] / 250 MeV");
