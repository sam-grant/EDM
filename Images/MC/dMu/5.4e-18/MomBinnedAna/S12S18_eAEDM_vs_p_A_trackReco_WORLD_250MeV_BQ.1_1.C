void S12S18_eAEDM_vs_p_A_trackReco_WORLD_250MeV_BQ.1_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:33:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.4313,-1.463079e-05,3406.974,0.000132121);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18_",100,218.0438,3021.499);
   Graph_Graph01179->SetMinimum(4.439122e-08);
   Graph_Graph01179->SetMaximum(0.0001174458);
