void S18_AEDMOverThetaYRMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:12:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.00440211,3407.936,0.01923993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01100 = new TH1F("Graph_Graph01100","S18_",100,0,3122.965);
   Graph_Graph01100->SetMinimum(-0.002037906);
   Graph_Graph01100->SetMaximum(0.01687572);
   ...
   Graph_Graph01100->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01100->GetYaxis()->SetTitle("A_{EDM}/#sigma#theta_{y} / 250 MeV");
