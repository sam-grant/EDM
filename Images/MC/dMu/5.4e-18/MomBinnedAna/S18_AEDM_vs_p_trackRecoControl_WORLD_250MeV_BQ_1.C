void S18_AEDM_vs_p_trackRecoControl_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:31:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.4358,-2.056052,2744.124,3.037344);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S18_",100,218.8498,3024.71);
   Graph_Graph01046->SetMinimum(-1.546712);
   Graph_Graph01046->SetMaximum(2.528005);
