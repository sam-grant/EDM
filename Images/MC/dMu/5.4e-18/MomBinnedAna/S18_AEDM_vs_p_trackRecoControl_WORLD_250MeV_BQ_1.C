...
//=========  (Thu Oct 21 14:33:56 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-2.056052,2750,3.037344);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","S18_",100,125,3125);
   Graph_Graph01036->SetMinimum(-1.546712);
   Graph_Graph01036->SetMaximum(2.528005);
