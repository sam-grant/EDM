...
//=========  (Mon Nov 22 14:18:40 2021) by ROOT version 6.24/04
   ...
   c->Range(6.88508,12.22367,3236.917,13.06912);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S12_",100,217.5394,3026.263);
   Graph_Graph01056->SetMinimum(12.30821);
   Graph_Graph01056->SetMaximum(12.98457);
