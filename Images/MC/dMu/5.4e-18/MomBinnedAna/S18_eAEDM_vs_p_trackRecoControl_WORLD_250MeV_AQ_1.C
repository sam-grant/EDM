void S18_eAEDM_vs_p_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.04401259,2750,0.4953397);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S18_",100,125,3125);
   Graph_Graph01042->SetMinimum(0.009922639);
   Graph_Graph01042->SetMaximum(0.4414044);
   ...
   Graph_Graph01042->GetXaxis()->SetRange(21,80);
