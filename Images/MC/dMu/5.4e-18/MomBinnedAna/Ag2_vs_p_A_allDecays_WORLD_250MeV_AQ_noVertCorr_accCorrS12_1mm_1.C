void Ag2_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 12:17:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-5.56052e-07,3407.936,1.325582e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(-4.87191e-07);
   Graph_Graph01040->SetMaximum(6.369721e-08);
