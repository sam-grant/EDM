void N_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12S18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 12:01:36 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-306841.8,3372.878,7173726);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","",100,126.3702,3098.002);
   Graph_Graph01042->SetMinimum(441215.1);
   Graph_Graph01042->SetMaximum(6425670);
   ...
   Graph_Graph01042->GetYaxis()->SetTitle("Positrons / 250 MeV");
