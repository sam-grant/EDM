void S0_Y_RMS_vs_p_trackReco_WORLD_250MeV_BQ.2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:33:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.118,9.332213,3409.577,16.66542);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S0_",100,217.7119,3023.747);
   Graph_Graph01064->SetMinimum(10.06553);
   Graph_Graph01064->SetMaximum(15.9321);
