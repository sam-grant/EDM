...
//=========  (Thu Nov 18 11:31:15 2021) by ROOT version 6.24/04
   ...
   c->Range(499.4358,-40602.39,2744.124,374547.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S18_",100,218.8498,3024.71);
   Graph_Graph01051->SetMinimum(912.6);
   Graph_Graph01051->SetMaximum(333032.5);
