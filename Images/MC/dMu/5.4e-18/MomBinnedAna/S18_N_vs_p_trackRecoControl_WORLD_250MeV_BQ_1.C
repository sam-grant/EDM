...
//=========  (Fri Dec  3 15:28:08 2021) by ROOT version 6.24/04
   ...
   c->Range(467.8646,-44725.14,3028.281,404651.3);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S18_",100,218.8378,3024.773);
   Graph_Graph01074->SetMinimum(212.5122);
   Graph_Graph01074->SetMaximum(359713.7);
