...
//=========  (Tue Dec 14 16:33:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,-249169,3410.59,427367.3);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01140 = new TH1F("Graph_Graph01140","S18_",100,218.8378,3024.773);
   Graph_Graph01140->SetMinimum(-181515.4);
   Graph_Graph01140->SetMaximum(359713.7);
