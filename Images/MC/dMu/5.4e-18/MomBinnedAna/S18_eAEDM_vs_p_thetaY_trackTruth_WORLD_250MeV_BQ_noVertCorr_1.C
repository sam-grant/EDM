void S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6404,-5.231553,3398.763,47.24329);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01143 = new TH1F("Graph_Graph01143","S18_",100,0,3051.639);
   Graph_Graph01143->SetMinimum(0.01593105);
   Graph_Graph01143->SetMaximum(41.9958);
   ...
   Graph_Graph01143->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01143->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
