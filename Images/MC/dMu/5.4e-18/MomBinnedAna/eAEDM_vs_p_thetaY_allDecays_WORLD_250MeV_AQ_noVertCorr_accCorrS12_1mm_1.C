void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 12:17:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.009669801,3407.936,0.08758743);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(5.592283e-05);
   Graph_Graph01045->SetMaximum(0.0778617);
   ...
   Graph_Graph01045->GetXaxis()->SetRange(1,97);
