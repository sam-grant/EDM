void S12_eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1b_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:15:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.002453471,3407.936,0.04865205);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12_",100,0,3122.965);
   Graph_Graph01057->SetMinimum(0.002657081);
   Graph_Graph01057->SetMaximum(0.04354149);
   ...
   Graph_Graph01057->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01057->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
