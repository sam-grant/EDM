...
//=========  (Thu Nov 18 11:36:21 2021) by ROOT version 6.24/04
   ...
   c->Range(499.8164,12.08544,2745.291,14.39132);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","S0_",100,219.1321,3025.975);
   Graph_Graph01029->SetMinimum(12.31603);
   Graph_Graph01029->SetMaximum(14.16073);
