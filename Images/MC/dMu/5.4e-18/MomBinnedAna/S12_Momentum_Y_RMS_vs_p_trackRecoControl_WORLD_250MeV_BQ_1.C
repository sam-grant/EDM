...
//=========  (Thu Nov 18 11:31:15 2021) by ROOT version 6.24/04
   ...
   c->Range(499.337,11.32337,2744.492,24.22571);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12_",100,218.6927,3025.136);
   Graph_Graph01040->SetMinimum(12.61361);
   Graph_Graph01040->SetMaximum(22.93547);
