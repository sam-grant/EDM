...
//=========  (Mon Mar 21 12:27:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3442,2.962349,3407.403,28.23357);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01213 = new TH1F("Graph_Graph01213","S0S12S18_",100,218.1678,3021.891);
   Graph_Graph01213->SetMinimum(5.489471);
   Graph_Graph01213->SetMaximum(25.70645);
