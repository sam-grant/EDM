...
//=========  (Fri Mar 25 02:59:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.8426,11.86823,3375.838,23.33875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01213 = new TH1F("Graph_Graph01213","S0S12S18_",100,218.1625,3021.87);
   Graph_Graph01213->SetMinimum(13.01528);
   Graph_Graph01213->SetMaximum(22.1917);
