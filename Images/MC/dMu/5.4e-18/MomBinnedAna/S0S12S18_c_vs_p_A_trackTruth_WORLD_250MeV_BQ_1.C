...
//=========  (Sun Dec  5 19:12:02 2021) by ROOT version 6.24/04
   ...
   c->Range(467.0549,-6.551719e-06,3030.042,8.433739e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01098 = new TH1F("Graph_Graph01098","S0S12S18_",100,217.7781,3026.531);
   Graph_Graph01098->SetMinimum(-5.812209e-06);
   Graph_Graph01098->SetMaximum(1.038645e-07);
