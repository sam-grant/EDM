...
//=========  (Mon Mar 21 12:27:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3442,-0.02387056,3407.403,0.3026457);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18_",100,218.1678,3021.891);
   Graph_Graph01215->SetMinimum(0.008781066);
   Graph_Graph01215->SetMaximum(0.2699941);
