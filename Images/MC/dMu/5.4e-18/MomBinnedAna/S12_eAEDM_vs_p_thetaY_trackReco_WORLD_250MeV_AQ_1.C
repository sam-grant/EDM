void S12_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:10:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.2053,-0.1060709,3335.002,1.15435);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S12_",100,0,3091.543);
   Graph_Graph01059->SetMinimum(0.01997119);
   Graph_Graph01059->SetMaximum(1.028308);
   ...
   Graph_Graph01059->GetXaxis()->SetRange(2,96);
