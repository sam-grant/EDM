...
//=========  (Wed Jan 19 10:50:29 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0171,-0.1632911,3510.154,1.571473);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01108 = new TH1F("Graph_Graph01108","S12_",100,0,3089.244);
   Graph_Graph01108->SetMinimum(0.01018534);
   Graph_Graph01108->SetMaximum(1.397997);
