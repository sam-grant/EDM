...
//=========  (Tue Dec 14 16:27:31 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9794,-0.001851355,3509.814,0.01662872);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S0_",100,0,3088.946);
   Graph_Graph01062->SetMinimum(-3.346762e-06);
   Graph_Graph01062->SetMaximum(0.01478071);
