...
//=========  (Tue Feb 22 00:12:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3944,-1.640467e-06,3407.426,1.482523e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,218.1255,3021.906);
   Graph_Graph01216->SetMinimum(6.102533e-09);
   Graph_Graph01216->SetMaximum(1.317866e-05);
