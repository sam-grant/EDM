...
//=========  (Wed Jan 19 10:50:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,6.178539,3509.674,55.40403);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01183 = new TH1F("Graph_Graph01183","S12S18_",100,0,3088.822);
   Graph_Graph01183->SetMinimum(11.10109);
   Graph_Graph01183->SetMaximum(50.48148);
