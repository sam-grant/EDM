...
//=========  (Sun Dec  5 19:01:37 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(466.6541,-5.97223e-06,3025.214,5.427109e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(5.210233e-08);
   Graph_Graph01061->SetMaximum(4.824675e-05);
