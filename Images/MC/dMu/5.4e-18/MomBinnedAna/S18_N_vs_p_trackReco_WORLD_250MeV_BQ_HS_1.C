void S18_N_vs_p_trackReco_WORLD_250MeV_BQ_HS_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Feb  1 16:31:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.0172,-1049945,3406.604,1489130);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01140 = new TH1F("Graph_Graph01140","S18_",100,218.3733,3021.213);
   Graph_Graph01140->SetMinimum(-796037.5);
   Graph_Graph01140->SetMaximum(1235222);
