...
//=========  (Tue Feb 22 00:12:13 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.4075,-1.295954,3406.812,0.4610679);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","S12_",100,218.0475,3021.357);
   Graph_Graph01095->SetMinimum(-1.120252);
   Graph_Graph01095->SetMaximum(0.2853657);
