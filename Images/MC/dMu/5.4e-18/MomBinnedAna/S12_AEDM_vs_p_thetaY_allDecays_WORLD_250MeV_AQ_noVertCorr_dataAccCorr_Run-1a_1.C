void S12_AEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1a_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:34:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.1161188,3407.936,0.1916697);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S12_",100,0,3122.965);
   Graph_Graph01048->SetMinimum(-0.08533994);
   Graph_Graph01048->SetMaximum(0.1608909);
   ...
   Graph_Graph01048->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
