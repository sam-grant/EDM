void S18_eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1d_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:19:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.003737886,3407.936,0.04890893);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S18_",100,0,3122.965);
   Graph_Graph01096->SetMinimum(0.001526796);
   Graph_Graph01096->SetMaximum(0.04364425);
   ...
   Graph_Graph01096->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01096->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
