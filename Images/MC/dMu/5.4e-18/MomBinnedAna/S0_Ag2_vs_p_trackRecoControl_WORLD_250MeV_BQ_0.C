void S0_Ag2_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:36:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.8164,-0.7643308,2745.291,1.288478);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S0_",100,219.1321,3025.975);
   Graph_Graph01027->SetMinimum(-0.5590499);
   Graph_Graph01027->SetMaximum(1.083197);
