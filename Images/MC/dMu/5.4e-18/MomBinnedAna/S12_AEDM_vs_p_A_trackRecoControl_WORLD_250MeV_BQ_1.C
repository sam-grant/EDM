...
//=========  (Tue Dec 14 16:33:19 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-0.0004557338,3411.031,0.002326518);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01098 = new TH1F("Graph_Graph01098","S12_",100,218.7344,3025.149);
   Graph_Graph01098->SetMinimum(-0.0001775087);
   Graph_Graph01098->SetMaximum(0.002048292);
