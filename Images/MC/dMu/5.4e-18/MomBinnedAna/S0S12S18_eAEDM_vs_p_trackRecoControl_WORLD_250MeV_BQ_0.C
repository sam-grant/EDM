void S0S12S18_eAEDM_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.03048878,2750,0.3119783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S0S12S18_",100,125,3125);
   Graph_Graph01062->SetMinimum(0.003757932);
   Graph_Graph01062->SetMaximum(0.2777316);
   ...
   Graph_Graph01062->GetXaxis()->SetRange(21,80);
   ...
   Graph_Graph01062->GetYaxis()->SetTitle("#deltaA_{EDM}");
