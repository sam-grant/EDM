void S18_eAEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:33:10 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.3887,0.01223746,3034.139,0.05564666);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,0,3088.183);
   Graph_Graph01075->SetMinimum(0.01657838);
   Graph_Graph01075->SetMaximum(0.05130574);
