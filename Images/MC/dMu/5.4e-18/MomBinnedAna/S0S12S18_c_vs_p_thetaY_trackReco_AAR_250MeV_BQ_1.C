void S0S12S18_c_vs_p_thetaY_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:11:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.685561,-1.927887,3232.676,6.976552);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01091 = new TH1F("Graph_Graph01091","S0S12S18_",100,218.0111,3022.351);
   Graph_Graph01091->SetMinimum(-1.037443);
   Graph_Graph01091->SetMaximum(6.086108);
