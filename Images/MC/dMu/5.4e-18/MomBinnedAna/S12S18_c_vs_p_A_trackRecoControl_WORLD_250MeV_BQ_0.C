void S12S18_c_vs_p_A_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:17:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.435734,-0.001326874,3235.201,0.00336812);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01080 = new TH1F("Graph_Graph01080","S12S18_",100,218.877,3024.76);
   Graph_Graph01080->SetMinimum(-0.0008573742);
   Graph_Graph01080->SetMaximum(0.002898621);
