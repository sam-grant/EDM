void S12S18_Y_RMS_vs_p_trackReco_WORLD_250MeV_BQ.0_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:32:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.314,9.371727,3406.951,16.27462);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01175 = new TH1F("Graph_Graph01175","S12S18_",100,218.146,3021.491);
   Graph_Graph01175->SetMinimum(10.06202);
   Graph_Graph01175->SetMaximum(15.58433);
