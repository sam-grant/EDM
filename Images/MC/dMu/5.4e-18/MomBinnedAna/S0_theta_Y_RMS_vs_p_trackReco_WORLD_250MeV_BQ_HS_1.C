void S0_theta_Y_RMS_vs_p_trackReco_WORLD_250MeV_BQ_HS_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Feb  1 16:30:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.1412,-5.325301,3409.454,62.40683);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S0_",100,217.6779,3023.635);
   Graph_Graph01063->SetMinimum(1.447912);
   Graph_Graph01063->SetMaximum(55.63361);
