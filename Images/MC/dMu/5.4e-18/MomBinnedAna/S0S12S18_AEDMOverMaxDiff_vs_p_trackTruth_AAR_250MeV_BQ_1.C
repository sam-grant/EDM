void S0S12S18_AEDMOverMaxDiff_vs_p_trackTruth_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:13:57 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.121727,-0.001515528,3237.191,0.004137376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01104 = new TH1F("Graph_Graph01104","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01104->SetMinimum(-0.0009502378);
   Graph_Graph01104->SetMaximum(0.003572085);
