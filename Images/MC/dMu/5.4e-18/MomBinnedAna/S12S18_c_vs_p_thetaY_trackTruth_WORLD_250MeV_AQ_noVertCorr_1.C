void S12S18_c_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9369,-3.25956,3392.432,0.6160131);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01176 = new TH1F("Graph_Graph01176","S12S18_",100,0,3108.757);
   Graph_Graph01176->SetMinimum(-2.872003);
   Graph_Graph01176->SetMaximum(0.2284558);
   ...
   Graph_Graph01176->GetXaxis()->SetRange(1,97);
