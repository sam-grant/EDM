void S0S12S18_Ag2_vs_p_thetaY_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:30:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.578306,-0.2844424,3235.6,0.5927221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01093 = new TH1F("Graph_Graph01093","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01093->SetMinimum(-0.1967259);
   Graph_Graph01093->SetMaximum(0.5050057);
