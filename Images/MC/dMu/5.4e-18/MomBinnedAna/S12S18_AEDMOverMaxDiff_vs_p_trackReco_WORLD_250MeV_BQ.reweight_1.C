void S12S18_AEDMOverMaxDiff_vs_p_trackReco_WORLD_250MeV_BQ.reweight_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb  3 10:51:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.1427,-0.003093348,3406.662,0.003814914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,218.2676,3021.252);
   Graph_Graph01181->SetMinimum(-0.002402522);
   Graph_Graph01181->SetMaximum(0.003124087);
