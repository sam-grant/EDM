...
//=========  (Mon Nov 22 14:13:20 2021) by ROOT version 6.24/04
   ...
   c->Range(7.121727,-1.676024,3237.191,37.76053);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01097->SetMinimum(2.267631);
   Graph_Graph01097->SetMaximum(33.81687);
