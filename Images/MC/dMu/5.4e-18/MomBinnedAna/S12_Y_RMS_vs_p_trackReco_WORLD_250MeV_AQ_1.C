...
//=========  (Fri Dec  3 18:46:40 2021) by ROOT version 6.24/04
   ...
   c->Range(486.556,9.952647,3035.183,21.42265);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12_",100,0,3089.244);
   Graph_Graph01057->SetMinimum(11.09965);
   Graph_Graph01057->SetMaximum(20.27565);
   ...
   Graph_Graph01057->GetXaxis()->SetRange(25,90);
