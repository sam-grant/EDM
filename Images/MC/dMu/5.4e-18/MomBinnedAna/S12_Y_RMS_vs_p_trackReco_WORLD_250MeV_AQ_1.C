...
//=========  (Wed Jan 19 10:50:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0171,6.117487,3510.154,55.93909);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,0,3089.244);
   Graph_Graph01105->SetMinimum(11.09965);
   Graph_Graph01105->SetMaximum(50.95693);
   ...
   Graph_Graph01105->GetXaxis()->SetRange(1,101);
