...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,10.48481,3510.154,30.78166);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(12.51449);
   Graph_Graph01057->SetMaximum(28.75198);
   ...
   Graph_Graph01057->GetXaxis()->SetRange(1,101);
