void S18_AEDM_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.7653,-8.419898,2724.774,1.931824);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S18_",100,0,3091.942);
   Graph_Graph01046->SetMinimum(-7.384725);
   Graph_Graph01046->SetMaximum(0.8966514);
   ...
   Graph_Graph01046->GetXaxis()->SetRange(25,81);
