void S0S12S18_theta_Y_RMS_vs_p_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9276,-4.621325,3392.348,51.39688);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01221 = new TH1F("Graph_Graph01221","S0S12S18_",100,0,3108.681);
   Graph_Graph01221->SetMinimum(0.9804963);
   Graph_Graph01221->SetMaximum(45.79506);
   ...
   Graph_Graph01221->GetXaxis()->SetRange(1,97);
