...
//=========  (Wed Jan 19 10:50:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,-3.7873,3509.674,67.4509);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01182 = new TH1F("Graph_Graph01182","S12S18_",100,0,3088.822);
   Graph_Graph01182->SetMinimum(3.33652);
   Graph_Graph01182->SetMaximum(60.32708);
