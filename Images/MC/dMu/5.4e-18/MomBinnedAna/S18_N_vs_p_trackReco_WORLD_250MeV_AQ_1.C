...
//=========  (Fri Nov 19 17:28:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1968,-170534.6,3334.918,1567886);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S18_",100,0,3091.465);
   Graph_Graph01072->SetMinimum(3307.5);
   Graph_Graph01072->SetMaximum(1394044);
   ...
   Graph_Graph01072->GetXaxis()->SetRange(2,96);
