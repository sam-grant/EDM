...
//=========  (Tue Feb 22 00:12:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0438,-0.6829348,3406.65,0.3361129);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01132 = new TH1F("Graph_Graph01132","S18_",100,218.3546,3021.252);
   Graph_Graph01132->SetMinimum(-0.58103);
   Graph_Graph01132->SetMaximum(0.2342082);
