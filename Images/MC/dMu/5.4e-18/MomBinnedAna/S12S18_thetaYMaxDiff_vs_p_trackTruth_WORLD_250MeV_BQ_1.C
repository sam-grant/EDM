...
//=========  (Thu Nov 18 11:32:25 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6987,-19.02172,2745.282,218.4305);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S12S18_",100,217.8758,3026.104);
   Graph_Graph01063->SetMinimum(4.723509);
   Graph_Graph01063->SetMaximum(194.6853);
