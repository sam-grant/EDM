...
//=========  (Mon May 30 11:51:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.6101,-1.408193e-06,3380.686,1.285981e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,218.0011,3026.156);
   Graph_Graph01142->SetMinimum(1.860765e-08);
   Graph_Graph01142->SetMaximum(1.143301e-05);
