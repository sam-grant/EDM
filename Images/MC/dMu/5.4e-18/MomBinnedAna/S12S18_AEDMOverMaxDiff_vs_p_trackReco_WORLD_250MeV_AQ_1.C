...
//=========  (Wed Jan 19 10:50:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9638,-0.0015146,3509.674,0.01323637);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01189 = new TH1F("Graph_Graph01189","S12S18_",100,0,3088.822);
   Graph_Graph01189->SetMinimum(-3.950305e-05);
   Graph_Graph01189->SetMaximum(0.01176127);
