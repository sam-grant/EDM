void S12_Ag2_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.862,-12.84546,2725.279,2.642346);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S12_",100,0,3092.516);
   Graph_Graph01037->SetMinimum(-11.29668);
   Graph_Graph01037->SetMaximum(1.093565);
   ...
   Graph_Graph01037->GetXaxis()->SetRange(25,81);
