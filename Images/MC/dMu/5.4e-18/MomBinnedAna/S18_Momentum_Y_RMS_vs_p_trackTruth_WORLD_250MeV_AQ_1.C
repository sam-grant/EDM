void S18_Momentum_Y_RMS_vs_p_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:31:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.4644,2.383869,3331.568,26.63563);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S18_",100,0,3091.942);
   Graph_Graph01071->SetMinimum(4.809045);
   Graph_Graph01071->SetMaximum(24.21045);
   ...
   Graph_Graph01071->GetXaxis()->SetRange(3,96);
