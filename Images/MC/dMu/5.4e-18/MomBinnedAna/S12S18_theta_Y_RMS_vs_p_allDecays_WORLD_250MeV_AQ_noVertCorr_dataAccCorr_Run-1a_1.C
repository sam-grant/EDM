void S12S18_theta_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1a_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:34:50 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-2.979092,3407.936,65.22136);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.002920052,
   0.004482036};
   TGraphErrors *gre = new TGraphErrors(12,Graph0_fx1131,Graph0_fy1131,Graph0_fex1131,Graph0_fey1131);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S12S18_",100,0,3122.965);
   Graph_Graph01131->SetMinimum(3.840953);
   Graph_Graph01131->SetMaximum(58.40131);
   ...
   Graph_Graph01131->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01131->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad] / 250 MeV");
