void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 12:01:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,0.005196718,3372.878,0.02928146);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01043->SetMinimum(0.007605192);
   Graph_Graph01043->SetMaximum(0.02687298);
