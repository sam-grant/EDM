...
//=========  (Fri Nov 19 17:36:29 2021) by ROOT version 6.24/04
   ...
   c->Range(8.578306,-2.275202,3235.6,40.70494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01097->SetMinimum(2.022812);
   Graph_Graph01097->SetMaximum(36.40692);
