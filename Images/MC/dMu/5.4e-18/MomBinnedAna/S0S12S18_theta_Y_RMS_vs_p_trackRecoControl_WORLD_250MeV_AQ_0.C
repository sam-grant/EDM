...
//=========  (Fri Dec  3 15:33:11 2021) by ROOT version 6.24/04
   ...
   c->Range(486.5144,2.852997,3034.923,44.02543);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S0S12S18_",100,0,3088.981);
   Graph_Graph01101->SetMinimum(6.970241);
   Graph_Graph01101->SetMaximum(39.90819);
