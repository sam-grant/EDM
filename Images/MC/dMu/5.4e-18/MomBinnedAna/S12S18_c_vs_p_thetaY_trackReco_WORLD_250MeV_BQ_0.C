...
//=========  (Fri Nov 19 17:35:25 2021) by ROOT version 6.24/04
   ...
   c->Range(7.894367,-2.026718,3231.754,6.869161);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S12S18_",100,218.1461,3021.502);
   Graph_Graph01077->SetMinimum(-1.13713);
   Graph_Graph01077->SetMaximum(5.979573);
