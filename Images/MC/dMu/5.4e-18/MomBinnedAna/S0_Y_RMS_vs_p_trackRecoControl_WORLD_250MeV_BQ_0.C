...
//=========  (Thu Oct 21 14:36:42 2021) by ROOT version 6.24/04
   ...
   c->Range(500,12.08544,2750,14.39132);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01019 = new TH1F("Graph_Graph01019","S0_",100,125,3125);
   Graph_Graph01019->SetMinimum(12.31603);
   Graph_Graph01019->SetMaximum(14.16073);
