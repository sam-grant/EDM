void S12_Momentum_Y_RMS_vs_p_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:05 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.4195,11.05595,3034.332,28.52017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12_",100,0,3088.378);
   Graph_Graph01058->SetMinimum(12.80238);
   Graph_Graph01058->SetMaximum(26.77375);
