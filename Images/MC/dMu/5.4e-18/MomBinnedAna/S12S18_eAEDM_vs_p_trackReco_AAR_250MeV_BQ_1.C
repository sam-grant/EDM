...
//=========  (Thu Nov 18 15:57:49 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4817,-4.858822e-06,2741.167,4.435153e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S12S18_",100,218.1461,3021.502);
   Graph_Graph01062->SetMinimum(6.221347e-08);
   Graph_Graph01062->SetMaximum(3.943049e-05);
