void S0S12S18_Ag2_vs_p_A_trackReco_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Dec  8 12:48:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.5781,-4.656431e-06,3407.915,2.478443e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01210 = new TH1F("Graph_Graph01210","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01210->SetMinimum(-3.942944e-06);
   Graph_Graph01210->SetMaximum(1.764955e-06);
