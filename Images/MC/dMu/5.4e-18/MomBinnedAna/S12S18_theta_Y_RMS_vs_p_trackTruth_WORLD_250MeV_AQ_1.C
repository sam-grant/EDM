...
//=========  (Fri Dec  3 15:29:09 2021) by ROOT version 6.24/04
   ...
   c->Range(493.531,0.1446613,3019.477,36.16534);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01086 = new TH1F("Graph_Graph01086","S12S18_",100,0,3108.857);
   Graph_Graph01086->SetMinimum(3.746729);
   Graph_Graph01086->SetMaximum(32.56327);
   ...
   Graph_Graph01086->GetXaxis()->SetRange(25,89);
