void S18_Ag2_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6404,-10.78695,3398.763,53.44281);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01135 = new TH1F("Graph_Graph01135","S18_",100,0,3051.639);
   Graph_Graph01135->SetMinimum(-4.363976);
   Graph_Graph01135->SetMaximum(47.01984);
   ...
   Graph_Graph01135->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01135->GetYaxis()->SetTitle("A_{g#minus2} [mrad] / 250 MeV");
