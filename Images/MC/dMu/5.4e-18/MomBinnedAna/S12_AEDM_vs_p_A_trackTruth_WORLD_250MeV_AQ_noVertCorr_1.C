void S12_AEDM_vs_p_A_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9979,-0.0006490062,3392.981,0.0001304627);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S12_",100,0,3109.261);
   Graph_Graph01102->SetMinimum(-0.0005710593);
   Graph_Graph01102->SetMaximum(5.251579e-05);
   ...
   Graph_Graph01102->GetXaxis()->SetRange(1,97);
