...
//=========  (Sun Dec  5 19:12:01 2021) by ROOT version 6.24/04
   ...
   c->Range(467.1062,9.243379,3029.613,16.00389);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","S12S18_",100,217.876,3026.103);
   Graph_Graph01087->SetMinimum(9.919429);
   Graph_Graph01087->SetMaximum(15.32784);
