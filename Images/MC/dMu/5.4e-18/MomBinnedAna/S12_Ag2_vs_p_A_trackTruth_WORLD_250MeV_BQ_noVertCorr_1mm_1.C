...
//=========  (Wed Apr  6 12:54:47 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0708,-0.0002252521,3379.415,4.986671e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01099 = new TH1F("Graph_Graph01099","S12_",100,217.4529,3024.967);
   Graph_Graph01099->SetMinimum(-0.0001977402);
   Graph_Graph01099->SetMaximum(2.235482e-05);
