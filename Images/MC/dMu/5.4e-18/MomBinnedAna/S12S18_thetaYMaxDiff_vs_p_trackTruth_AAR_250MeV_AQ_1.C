...
//=========  (Mon Nov 22 14:13:37 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.4795,-12.66466,3331.735,298.9648);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01089 = new TH1F("Graph_Graph01089","S12S18_",100,0,3092.097);
   Graph_Graph01089->SetMinimum(18.49829);
   Graph_Graph01089->SetMaximum(267.8019);
   ...
   Graph_Graph01089->GetXaxis()->SetRange(3,96);
