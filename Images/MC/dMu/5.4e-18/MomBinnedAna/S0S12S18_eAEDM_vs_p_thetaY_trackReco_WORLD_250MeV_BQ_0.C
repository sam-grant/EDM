...
//=========  (Mon Nov 22 14:15:54 2021) by ROOT version 6.24/04
   ...
   c->Range(7.69113,-0.008411634,3232.646,0.1317597);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01101->SetMinimum(0.005605501);
   Graph_Graph01101->SetMaximum(0.1177426);
