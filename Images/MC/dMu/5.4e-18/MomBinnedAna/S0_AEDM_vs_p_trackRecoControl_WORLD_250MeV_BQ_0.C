void S0_AEDM_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.3322206,2750,1.249263);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","S0_",100,125,3125);
   Graph_Graph01016->SetMinimum(-0.1740722);
   Graph_Graph01016->SetMaximum(1.091115);
   ...
   Graph_Graph01016->GetXaxis()->SetRange(21,80);
