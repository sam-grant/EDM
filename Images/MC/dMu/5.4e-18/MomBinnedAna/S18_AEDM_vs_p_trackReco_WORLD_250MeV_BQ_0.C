...
//=========  (Thu Nov 18 11:35:31 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6871,-0.6430974,2741.172,0.4526582);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S18_",100,218.3765,3021.483);
   Graph_Graph01046->SetMinimum(-0.5335218);
   Graph_Graph01046->SetMaximum(0.3430826);
