...
//=========  (Mon Mar 21 12:27:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0109,-7.277105e-06,3406.551,6.570218e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,218.3733,3021.167);
   Graph_Graph01142->SetMinimum(2.082396e-08);
   Graph_Graph01142->SetMaximum(5.840425e-05);
