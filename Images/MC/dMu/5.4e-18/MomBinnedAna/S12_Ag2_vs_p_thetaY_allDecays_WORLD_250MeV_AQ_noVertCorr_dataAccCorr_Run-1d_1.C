void S12_Ag2_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1d_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:18:54 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.07057241,3407.936,0.05039738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12_",100,0,3122.965);
   Graph_Graph01049->SetMinimum(-0.05847543);
   Graph_Graph01049->SetMaximum(0.0383004);
   ...
   Graph_Graph01049->GetYaxis()->SetTitle("A_{g#minus2} [mrad] / 250 MeV");
