...
//=========  (Fri Dec  3 15:33:10 2021) by ROOT version 6.24/04
   ...
   c->Range(486.3887,-135270.9,3034.139,1938935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S18_",100,0,3088.183);
   Graph_Graph01074->SetMinimum(72149.65);
   Graph_Graph01074->SetMaximum(1731514);
