void S12_N_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-184273.9,2744.438,1801268);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","S12_",100,0,3150);
   Graph_Graph01031->SetMinimum(14280.3);
   Graph_Graph01031->SetMaximum(1602714);
   ...
   Graph_Graph01031->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01031->GetYaxis()->SetTitle("Positrons");
