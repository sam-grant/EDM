...
//=========  (Wed Apr  6 12:55:02 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.8606,-0.001628942,3379.773,0.008060721);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,217.6791,3025.309);
   Graph_Graph01181->SetMinimum(-0.0006599754);
   Graph_Graph01181->SetMaximum(0.007091755);
