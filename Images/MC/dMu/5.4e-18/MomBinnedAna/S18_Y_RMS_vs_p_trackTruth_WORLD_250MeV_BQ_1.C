...
//=========  (Fri Dec  3 15:29:55 2021) by ROOT version 6.24/04
   ...
   c->Range(467.3247,9.21491,3029.676,15.98906);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S18_",100,218.1098,3026.166);
   Graph_Graph01072->SetMinimum(9.892325);
   Graph_Graph01072->SetMaximum(15.31165);
