void S12_thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1b_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:15:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,8.977149,3407.936,219.3303);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S12_",100,0,3122.965);
   Graph_Graph01059->SetMinimum(30.01246);
   Graph_Graph01059->SetMaximum(198.295);
   ...
   Graph_Graph01059->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01059->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad] / 250 MeV");
