void c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12S18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 12:01:36 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-1.932351,3372.878,6.453676);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","",100,126.3702,3098.002);
   Graph_Graph01033->SetMinimum(-1.093748);
   Graph_Graph01033->SetMaximum(5.615073);
   ...
   Graph_Graph01033->GetXaxis()->SetRange(0,97);
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("c [mrad] / 250 MeV");
