...
//=========  (Fri Nov 19 17:35:04 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.297,-0.06958871,3335.911,0.74167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S0S12S18_",100,0,3092.386);
   Graph_Graph01101->SetMinimum(0.01153717);
   Graph_Graph01101->SetMaximum(0.6605441);
   ...
   Graph_Graph01101->GetXaxis()->SetRange(2,96);
