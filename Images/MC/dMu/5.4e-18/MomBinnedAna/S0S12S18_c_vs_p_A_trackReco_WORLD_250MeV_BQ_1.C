...
//=========  (Fri Mar 25 02:59:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.8426,-2.292518e-05,3375.838,2.385175e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01208 = new TH1F("Graph_Graph01208","S0S12S18_",100,218.1625,3021.87);
   Graph_Graph01208->SetMinimum(-1.824748e-05);
   Graph_Graph01208->SetMaximum(1.917406e-05);
