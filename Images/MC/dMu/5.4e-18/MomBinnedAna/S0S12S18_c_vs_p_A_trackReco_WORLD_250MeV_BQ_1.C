...
//=========  (Fri Nov 19 17:29:02 2021) by ROOT version 6.24/04
   ...
   c->Range(7.69113,-4.278039e-05,3232.646,4.229964e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01094 = new TH1F("Graph_Graph01094","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01094->SetMinimum(-3.427239e-05);
   Graph_Graph01094->SetMaximum(3.379163e-05);
