void S18_Ag2_vs_p_A_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:34:56 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.4784,-8.04563e-08,3019.155,6.287546e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S18_",100,0,3108.525);
   Graph_Graph01070->SetMinimum(-9.535205e-09);
   Graph_Graph01070->SetMaximum(5.578335e-07);
   ...
   Graph_Graph01070->GetXaxis()->SetRange(25,89);
