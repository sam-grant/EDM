void S12_Y_RMS_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,12.54252,2744.438,33.19437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","S12_",100,0,3150);
   Graph_Graph01029->SetMinimum(14.6077);
   Graph_Graph01029->SetMaximum(31.12919);
   ...
   Graph_Graph01029->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01029->GetYaxis()->SetTitle("#sigma_{y} [mm]");
