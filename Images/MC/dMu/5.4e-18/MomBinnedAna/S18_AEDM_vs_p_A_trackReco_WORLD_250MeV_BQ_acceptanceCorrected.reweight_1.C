void S18_AEDM_vs_p_A_trackReco_WORLD_250MeV_BQ_acceptanceCorrected.reweight_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Feb 22 00:44:54 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.0465,-1.412102e-05,3406.654,3.636744e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01135 = new TH1F("Graph_Graph01135","S18_",100,218.3526,3021.255);
   Graph_Graph01135->SetMinimum(-9.07217e-06);
   Graph_Graph01135->SetMaximum(3.13186e-05);
