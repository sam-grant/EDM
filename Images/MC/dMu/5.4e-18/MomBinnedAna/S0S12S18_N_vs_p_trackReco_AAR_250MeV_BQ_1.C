...
//=========  (Thu Nov 18 11:30:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.445,-266279,2741.892,2714643);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S0S12S18_",100,218.0141,3022.323);
   Graph_Graph01071->SetMinimum(31813.2);
   Graph_Graph01071->SetMaximum(2416551);
