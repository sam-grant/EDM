...
//=========  (Fri Dec  3 15:28:06 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(468.1968,-0.4722898,3029.484,0.260984);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.3989624);
   Graph_Graph01035->SetMaximum(0.1876566);
