...
//=========  (Tue Dec 14 16:33:15 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,-5.766477,3411.922,50.27549);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,219.0854,3025.975);
   Graph_Graph01057->SetMinimum(-0.1622796);
   Graph_Graph01057->SetMaximum(44.6713);
