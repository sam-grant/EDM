...
//=========  (Fri Dec  3 15:33:56 2021) by ROOT version 6.24/04
   ...
   c->Range(468.0756,-0.3166749,3028.671,-0.006284036);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S0S12S18_",100,219.0314,3025.163);
   Graph_Graph01096->SetMinimum(-0.2856359);
   Graph_Graph01096->SetMaximum(-0.03732313);
   ...
   Graph_Graph01096->GetXaxis()->SetRange(19,91);
