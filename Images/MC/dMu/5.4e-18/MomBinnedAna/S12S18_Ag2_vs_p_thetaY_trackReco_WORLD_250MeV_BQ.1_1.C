void S12S18_Ag2_vs_p_thetaY_trackReco_WORLD_250MeV_BQ.1_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:33:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.4313,-0.6497626,3406.974,1.044327);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,218.0438,3021.499);
   Graph_Graph01170->SetMinimum(-0.4803537);
   Graph_Graph01170->SetMaximum(0.8749176);
