...
//=========  (Tue Dec 14 16:33:32 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.8117,-751415.9,3411.006,1281178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01214 = new TH1F("Graph_Graph01214","S0S12S18_",100,219.0314,3025.163);
   Graph_Graph01214->SetMinimum(-548156.5);
   Graph_Graph01214->SetMaximum(1077918);
