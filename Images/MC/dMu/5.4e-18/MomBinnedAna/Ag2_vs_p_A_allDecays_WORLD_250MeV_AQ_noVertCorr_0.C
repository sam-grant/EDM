void Ag2_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_0()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May 29 17:08:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-3.61147e-07,3407.936,1.609391e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(-3.089384e-07);
   Graph_Graph01040->SetMaximum(1.087305e-07);
