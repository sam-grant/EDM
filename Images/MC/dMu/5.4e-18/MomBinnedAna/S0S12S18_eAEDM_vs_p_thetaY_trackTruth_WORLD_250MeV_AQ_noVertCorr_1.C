void S0S12S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9276,-0.08739269,3392.348,0.8289844);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01225 = new TH1F("Graph_Graph01225","S0S12S18_",100,0,3108.681);
   Graph_Graph01225->SetMinimum(0.004245025);
   Graph_Graph01225->SetMaximum(0.7373467);
   ...
   Graph_Graph01225->GetXaxis()->SetRange(1,97);
