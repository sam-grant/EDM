...
//=========  (Fri Nov 19 17:35:48 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1912,-341395.6,3334.862,3139799);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01086 = new TH1F("Graph_Graph01086","S12S18_",100,0,3091.413);
   Graph_Graph01086->SetMinimum(6723.9);
   Graph_Graph01086->SetMaximum(2791680);
   ...
   Graph_Graph01086->GetXaxis()->SetRange(2,96);
