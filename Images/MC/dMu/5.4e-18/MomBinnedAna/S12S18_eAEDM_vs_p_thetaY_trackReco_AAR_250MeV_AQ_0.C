void S12S18_eAEDM_vs_p_thetaY_trackReco_AAR_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:35:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1912,-0.08184253,3334.862,0.8788292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","S12S18_",100,0,3091.413);
   Graph_Graph01087->SetMinimum(0.01422465);
   Graph_Graph01087->SetMaximum(0.782762);
   ...
   Graph_Graph01087->GetXaxis()->SetRange(2,96);
