...
//=========  (Thu Nov 18 11:31:15 2021) by ROOT version 6.24/04
   ...
   c->Range(499.4358,11.04661,2744.124,25.59766);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S18_",100,218.8498,3024.71);
   Graph_Graph01050->SetMinimum(12.50172);
   Graph_Graph01050->SetMaximum(24.14256);
