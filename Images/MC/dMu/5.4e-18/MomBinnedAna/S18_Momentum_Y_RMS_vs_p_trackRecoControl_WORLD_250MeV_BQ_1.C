...
//=========  (Tue Dec 14 16:33:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,2.236578,3410.59,29.85749);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01139 = new TH1F("Graph_Graph01139","S18_",100,218.8378,3024.773);
   Graph_Graph01139->SetMinimum(4.998669);
   Graph_Graph01139->SetMaximum(27.09539);
