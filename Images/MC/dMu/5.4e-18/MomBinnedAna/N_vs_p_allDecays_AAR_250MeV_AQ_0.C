...
//=========  (Fri Nov 19 17:33:46 2021) by ROOT version 6.24/04
   ...
   c->Range(-409.8874,-334919.3,3376.692,7365252);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","",100,0,3122.952);
   Graph_Graph01020->SetMinimum(435097.8);
   Graph_Graph01020->SetMaximum(6595234);
