...
//=========  (Wed Apr  6 12:54:47 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0708,-0.0641545,3379.415,0.5815035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","S12_",100,217.4529,3024.967);
   Graph_Graph01095->SetMinimum(0.0004113087);
   Graph_Graph01095->SetMaximum(0.5169377);
