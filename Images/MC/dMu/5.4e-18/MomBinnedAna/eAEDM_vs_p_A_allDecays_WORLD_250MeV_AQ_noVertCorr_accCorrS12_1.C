void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:43:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-1.322665e-08,3407.936,1.226424e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01046->SetMinimum(3.602574e-10);
   Graph_Graph01046->SetMaximum(1.090555e-07);
