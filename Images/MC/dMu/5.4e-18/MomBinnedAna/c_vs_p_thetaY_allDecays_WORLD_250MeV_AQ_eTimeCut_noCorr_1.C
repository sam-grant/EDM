void c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_eTimeCut_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Mar 24 11:31:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.1807389,3407.936,0.0670353);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.1559615);
   Graph_Graph01035->SetMaximum(0.04225788);
