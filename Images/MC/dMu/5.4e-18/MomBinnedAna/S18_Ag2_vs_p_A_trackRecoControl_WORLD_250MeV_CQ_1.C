...
//=========  (Tue Dec 14 16:27:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.784,-0.0002685207,3508.056,0.002232538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,0,3087.398);
   Graph_Graph01142->SetMinimum(-1.841476e-05);
   Graph_Graph01142->SetMaximum(0.001982432);
   ...
   Graph_Graph01142->GetXaxis()->SetRange(1,101);
