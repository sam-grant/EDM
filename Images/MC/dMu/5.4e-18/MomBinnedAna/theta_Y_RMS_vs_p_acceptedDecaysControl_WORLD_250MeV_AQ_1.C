void theta_Y_RMS_vs_p_acceptedDecaysControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:10:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-374.5359,-7.113643,3370.823,108.982);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01017 = new TH1F("Graph_Graph01017","",100,0,3121.132);
   Graph_Graph01017->SetMinimum(4.495925);
   Graph_Graph01017->SetMaximum(97.37246);
   ...
   Graph_Graph01017->GetXaxis()->SetRange(1,96);
