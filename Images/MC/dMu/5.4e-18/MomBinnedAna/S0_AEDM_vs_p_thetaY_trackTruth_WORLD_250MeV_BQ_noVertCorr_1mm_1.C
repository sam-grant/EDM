...
//=========  (Mon Apr 25 18:51:59 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.688,-0.175699,3381.841,0.5820013);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0_",100,217.1641,3027.088);
   Graph_Graph01058->SetMinimum(-0.09992897);
   Graph_Graph01058->SetMaximum(0.5062313);
