...
//=========  (Tue Feb 22 00:12:22 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1692,-2457311,3406.642,3476132);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18_",100,218.2418,3021.231);
   Graph_Graph01177->SetMinimum(-1863967);
   Graph_Graph01177->SetMaximum(2882787);
