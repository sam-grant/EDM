...
//=========  (Mon Apr 25 18:52:10 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.2628,-3.756047e-06,3382.111,3.435719e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18_",100,217.5726,3027.374);
   Graph_Graph01179->SetMinimum(5.527715e-08);
   Graph_Graph01179->SetMaximum(3.054586e-05);
