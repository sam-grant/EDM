void S0_c_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-2.773439,2750,7.044487);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.05122204,
   0.0745555};
   TGraphErrors *gre = new TGraphErrors(11,Graph0_fx1015,Graph0_fy1015,Graph0_fex1015,Graph0_fey1015);
   gre->SetName("Graph0");
   gre->SetTitle("S0_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","S0_",100,125,3125);
   Graph_Graph01015->SetMinimum(-1.791646);
   Graph_Graph01015->SetMaximum(6.062694);
   ...
   Graph_Graph01015->GetXaxis()->SetRange(21,80);
