void S18_AEDMOverMaxDiff_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.001252693,2744.438,0.005868496);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S18_",100,0,3150);
   Graph_Graph01044->SetMinimum(-0.000540574);
   Graph_Graph01044->SetMaximum(0.005156377);
   ...
   Graph_Graph01044->GetXaxis()->SetRange(24,80);
