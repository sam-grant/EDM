void S0_N_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:23 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-189207.3,2744.438,1820405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","S0_",100,0,3150);
   Graph_Graph01021->SetMinimum(11754);
   Graph_Graph01021->SetMaximum(1619444);
   ...
   Graph_Graph01021->GetXaxis()->SetRange(24,80);
