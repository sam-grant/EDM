...
//=========  (Thu Nov 18 11:30:59 2021) by ROOT version 6.24/04
   ...
   c->Range(499.4652,-1.844192,2744.171,6.540058);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12S18_",100,218.877,3024.76);
   Graph_Graph01055->SetMinimum(-1.005767);
   Graph_Graph01055->SetMaximum(5.701633);
