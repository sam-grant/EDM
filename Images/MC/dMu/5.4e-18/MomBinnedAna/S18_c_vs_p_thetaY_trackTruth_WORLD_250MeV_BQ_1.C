...
//=========  (Mon May 30 11:51:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.6101,-0.2593796,3380.686,0.1550045);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S18_",100,218.0011,3026.156);
   Graph_Graph01131->SetMinimum(-0.2179412);
   Graph_Graph01131->SetMaximum(0.1135661);
