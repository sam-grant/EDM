...
//=========  (Tue Dec 14 16:27:32 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9794,-0.01691963,3509.814,0.02131183);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01073 = new TH1F("Graph_Graph01073","S0_",100,0,3088.946);
   Graph_Graph01073->SetMinimum(-0.01309648);
   Graph_Graph01073->SetMaximum(0.01748869);
