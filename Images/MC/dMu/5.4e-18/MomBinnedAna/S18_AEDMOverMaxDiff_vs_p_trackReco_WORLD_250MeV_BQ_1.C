...
//=========  (Fri Mar 25 02:59:10 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.4976,-0.002453179,3375.031,0.005398793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,218.3832,3021.178);
   Graph_Graph01144->SetMinimum(-0.001667982);
   Graph_Graph01144->SetMaximum(0.004613596);
