...
//=========  (Mon Apr 25 18:52:07 2022) by ROOT version 6.24/06
   ...
   c->Range(-161.878,-14.03771,3351.747,212.8861);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01143 = new TH1F("Graph_Graph01143","S18_",100,217.5936,3028.494);
   Graph_Graph01143->SetMinimum(8.654672);
   Graph_Graph01143->SetMaximum(190.1937);
   ...
   Graph_Graph01143->GetXaxis()->SetRange(0,99);
