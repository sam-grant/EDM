...
//=========  (Tue Dec  7 00:19:38 2021) by ROOT version 6.24/04
   ...
   c->Range(-394.2727,-2.879119e-08,3548.454,2.80344e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","",100,0,3122.952);
   Graph_Graph01046->SetMinimum(2.12233e-09);
   Graph_Graph01046->SetMaximum(2.494304e-07);
