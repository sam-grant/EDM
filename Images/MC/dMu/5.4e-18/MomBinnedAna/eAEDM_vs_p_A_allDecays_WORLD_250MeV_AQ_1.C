...
//=========  (Mon Nov 22 14:09:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-409.8874,-3.317153e-08,3376.691,3.732491e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","",100,0,3122.951);
   Graph_Graph01022->SetMinimum(7.470537e-09);
   Graph_Graph01022->SetMaximum(3.326071e-07);
