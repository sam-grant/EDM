...
//=========  (Thu Feb 24 01:37:54 2022) by ROOT version 6.24/06
   ...
   c->Range(-394.3025,-1.40263e-08,3548.722,1.363824e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","",100,0,3123.188);
   Graph_Graph01046->SetMinimum(1.014572e-09);
   Graph_Graph01046->SetMaximum(1.213415e-07);
