void S12S18_Ag2_vs_p_thetaY_trackReco_WORLD_250MeV_BQ.4_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:36:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.1445,-0.2108901,3406.661,1.593144);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,218.2659,3021.25);
   Graph_Graph01170->SetMinimum(-0.03048669);
   Graph_Graph01170->SetMaximum(1.412741);
