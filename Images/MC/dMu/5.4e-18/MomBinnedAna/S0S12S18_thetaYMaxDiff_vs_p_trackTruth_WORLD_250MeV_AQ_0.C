void S0S12S18_thetaYMaxDiff_vs_p_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:35:01 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.5032,1.727008,3019.307,204.0587);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S0S12S18_",100,0,3108.682);
   Graph_Graph01107->SetMinimum(21.96018);
   Graph_Graph01107->SetMaximum(183.8255);
   ...
   Graph_Graph01107->GetXaxis()->SetRange(25,89);
