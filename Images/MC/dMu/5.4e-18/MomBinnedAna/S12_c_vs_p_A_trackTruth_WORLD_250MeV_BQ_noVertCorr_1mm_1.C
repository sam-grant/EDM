...
//=========  (Mon Apr 25 18:52:03 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.3732,-0.0005518296,3381.354,0.000285547);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S12_",100,217.3924,3026.681);
   Graph_Graph01097->SetMinimum(-0.000468092);
   Graph_Graph01097->SetMaximum(0.0002018093);
