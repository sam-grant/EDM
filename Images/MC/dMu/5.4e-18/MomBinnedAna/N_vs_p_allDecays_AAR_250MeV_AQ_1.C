...
//=========  (Thu Nov 18 11:28:49 2021) by ROOT version 6.24/04
   ...
   c->Range(526.998,-334906.7,2752.101,7365057);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","",100,0,3122.951);
   Graph_Graph01015->SetMinimum(435089.7);
   Graph_Graph01015->SetMaximum(6595060);
