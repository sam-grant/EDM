void thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 11:51:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-9.908947,3372.878,198.5968);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(10.94163);
   Graph_Graph01045->SetMaximum(177.7463);
