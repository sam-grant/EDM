void AEDM_vs_p_A_acceptedDecaysControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:15:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-374.5359,-6.335697e-08,3370.823,9.789553e-08);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01016->SetMinimum(-4.723172e-08);
   Graph_Graph01016->SetMaximum(8.177028e-08);
   ...
   Graph_Graph01016->GetXaxis()->SetRange(1,96);
