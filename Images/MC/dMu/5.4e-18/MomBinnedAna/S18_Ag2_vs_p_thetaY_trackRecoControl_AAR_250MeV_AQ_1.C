void S18_Ag2_vs_p_thetaY_trackRecoControl_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:30:45 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.41028,-0.9177993,3235.149,0.5465068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01065->SetMinimum(-0.7713687);
   Graph_Graph01065->SetMaximum(0.4000762);
