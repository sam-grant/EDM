...
//=========  (Sun Dec  5 19:39:16 2021) by ROOT version 6.24/04
   ...
   c->Range(467.8037,9.364098,3028.657,16.80332);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12_",100,218.7344,3025.149);
   Graph_Graph01057->SetMinimum(10.10802);
   Graph_Graph01057->SetMaximum(16.0594);
