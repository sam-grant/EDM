void S0_Ag2_vs_p_trackReco_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:35:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.2748,-0.3726352,2743.039,0.2819767);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S0_",100,217.6794,3023.634);
   Graph_Graph01027->SetMinimum(-0.307174);
   Graph_Graph01027->SetMaximum(0.2165155);
