void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 12:01:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-8.110045e-08,3372.878,8.471597e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","",100,126.3702,3098.002);
   Graph_Graph01044->SetMinimum(1.172558e-08);
   Graph_Graph01044->SetMaximum(7.543337e-07);
   ...
   Graph_Graph01044->GetYaxis()->SetTitle("#deltaA_{EDM} / 250 MeV");
