...
//=========  (Thu Nov 18 11:37:42 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6539,-0.008462605,2745.658,0.1316869);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01072->SetMinimum(0.005552342);
   Graph_Graph01072->SetMaximum(0.1176719);
