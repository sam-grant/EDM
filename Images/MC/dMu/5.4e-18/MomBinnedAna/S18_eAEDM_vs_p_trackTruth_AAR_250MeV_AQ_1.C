...
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7653,-0.1455764,2724.774,1.510157);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01052 = new TH1F("Graph_Graph01052","S18_",100,0,3091.942);
   Graph_Graph01052->SetMinimum(0.01999691);
   Graph_Graph01052->SetMaximum(1.344584);
