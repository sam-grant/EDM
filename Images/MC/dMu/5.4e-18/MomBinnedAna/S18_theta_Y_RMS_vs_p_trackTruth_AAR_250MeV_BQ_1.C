...
//=========  (Mon Nov 22 14:13:55 2021) by ROOT version 6.24/04
   ...
   c->Range(7.50122,-1.687776,3236.776,37.65168);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S18_",100,218.1061,3026.171);
   Graph_Graph01069->SetMinimum(2.246169);
   Graph_Graph01069->SetMaximum(33.71773);
