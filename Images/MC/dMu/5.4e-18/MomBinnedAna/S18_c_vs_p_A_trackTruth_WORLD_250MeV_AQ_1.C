void S18_c_vs_p_A_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:31:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.4644,-0.003953649,3331.568,0.01961759);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S18_",100,0,3091.942);
   Graph_Graph01066->SetMinimum(-0.001596524);
   Graph_Graph01066->SetMaximum(0.01726047);
   ...
   Graph_Graph01066->GetXaxis()->SetRange(3,96);
