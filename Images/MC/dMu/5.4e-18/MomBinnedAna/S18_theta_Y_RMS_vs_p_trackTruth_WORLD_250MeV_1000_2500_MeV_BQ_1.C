void S18_theta_Y_RMS_vs_p_trackTruth_WORLD_250MeV_1000_2500_MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 11:05:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.6101,-1.639239,3380.686,37.61557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01137 = new TH1F("Graph_Graph01137","S18_",100,218.0011,3026.156);
   Graph_Graph01137->SetMinimum(2.286242);
   Graph_Graph01137->SetMaximum(33.69009);
