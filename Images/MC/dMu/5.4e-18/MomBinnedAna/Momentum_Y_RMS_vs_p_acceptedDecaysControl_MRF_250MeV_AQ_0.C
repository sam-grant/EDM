void Momentum_Y_RMS_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,0.5586562,12,6.892127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1012[3] = {
   2,
   6,
   10};
   Double_t Graph0_fy1012[3] = {
   1.61674,
   3.697782,
   5.833304};
   Double_t Graph0_fex1012[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1012[3] = {
   0.002505095,
   0.003169836,
   0.00324438};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1012,Graph0_fy1012,Graph0_fex1012,Graph0_fey1012);
   gre->SetName("Graph0");
   gre->SetTitle(";p [MeV]: in range p #minus 125 < p < p #plus 125 MeV;#sigma_{p_{y}} [MeV]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01012 = new TH1F("Graph_Graph01012","",100,1.2,10.8);
   Graph_Graph01012->SetMinimum(1.192003);
   Graph_Graph01012->SetMaximum(6.25878);
   ...
   Graph_Graph01012->GetXaxis()->SetRange(1,100);
   ...
   Graph_Graph01012->GetYaxis()->SetTitle("#sigma_{p_{y}} [MeV]");
