void S0S12S18_AEDMOverMaxDiff_vs_p_trackReco_WORLD_250MeV_1000_2500_MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 11:12:50 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.8644,-0.0008821498,3375.839,0.00300009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01218->SetMinimum(-0.0004939258);
   Graph_Graph01218->SetMaximum(0.002611866);
