void S12_AEDM_vs_p_thetaY_trackReco_WORLD_250MeV_BQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 19:04:22 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(466.6541,-0.02190687,3025.214,0.2145071);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S12_",100,217.8079,3021.709);
   Graph_Graph01051->SetMinimum(0.001734527);
   Graph_Graph01051->SetMaximum(0.1908657);
   ...
   Graph_Graph01051->GetXaxis()->SetRange(19,91);
