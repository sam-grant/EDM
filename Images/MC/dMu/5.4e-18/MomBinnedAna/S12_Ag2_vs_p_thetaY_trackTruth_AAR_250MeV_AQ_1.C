void S12_Ag2_vs_p_thetaY_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:32:08 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.5203,-4.225672,3332.186,20.10101);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S12_",100,0,3092.516);
   Graph_Graph01051->SetMinimum(-1.793004);
   Graph_Graph01051->SetMaximum(17.66834);
   ...
   Graph_Graph01051->GetXaxis()->SetRange(3,96);
