void S18_c_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:31:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.4342,-0.5733149,3034.423,0.04421702);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S18_",100,0,3088.471);
   Graph_Graph01065->SetMinimum(-0.5115617);
   Graph_Graph01065->SetMaximum(-0.01753618);
