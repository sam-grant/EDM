...
//=========  (Thu Oct 21 14:36:07 2021) by ROOT version 6.24/04
   ...
   c->Range(500.0625,-123.5505,2744.438,1281.408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S0S12S18_",100,0,3150);
   Graph_Graph01063->SetMinimum(16.94534);
   Graph_Graph01063->SetMaximum(1140.912);
   ...
   Graph_Graph01063->GetXaxis()->SetRange(24,80);
