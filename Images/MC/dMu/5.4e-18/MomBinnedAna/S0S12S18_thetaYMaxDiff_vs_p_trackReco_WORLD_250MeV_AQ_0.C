...
//=========  (Thu Nov 18 11:35:14 2021) by ROOT version 6.24/04
   ...
   c->Range(521.8401,-123.5505,2725.165,1281.408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01073 = new TH1F("Graph_Graph01073","S0S12S18_",100,0,3092.386);
   Graph_Graph01073->SetMinimum(16.94534);
   Graph_Graph01073->SetMaximum(1140.912);
