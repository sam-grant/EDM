void S18_Y_RMS_vs_p_trackReco_WORLD_250MeV_BQ_noVertCorr_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr  5 16:33:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.8806,12.32239,3375.928,13.16427);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01138 = new TH1F("Graph_Graph01138","S18_",100,218.1384,3021.947);
   Graph_Graph01138->SetMinimum(12.40657);
   Graph_Graph01138->SetMaximum(13.08008);
