...
//=========  (Thu Nov 18 11:32:24 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6987,-1.658916,2745.282,37.65651);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12S18_",100,217.8758,3026.104);
   Graph_Graph01058->SetMinimum(2.272627);
   Graph_Graph01058->SetMaximum(33.72496);
