...
//=========  (Fri Nov 19 17:36:10 2021) by ROOT version 6.24/04
   ...
   c->Range(7.685561,-1.638801,3232.676,37.81662);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,218.0111,3022.351);
   Graph_Graph01097->SetMinimum(2.306742);
   Graph_Graph01097->SetMaximum(33.87108);
