void S0_Ag2_vs_p_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 15:57:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.2736,-0.0001905021,2743.039,0.0001056176);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S0_",100,217.6779,3023.635);
   Graph_Graph01027->SetMinimum(-0.0001608902);
   Graph_Graph01027->SetMaximum(7.600566e-05);
