void S0S12S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_0mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 26 12:13:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.9312,-0.009043654,3380.604,0.1431778);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18_",100,217.7058,3026.051);
   Graph_Graph01215->SetMinimum(0.006178489);
   Graph_Graph01215->SetMaximum(0.1279556);
