void S12S18_c_vs_p_thetaY_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:32:10 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.4795,-3.665983,3331.735,2.00194);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S12S18_",100,0,3092.097);
   Graph_Graph01077->SetMinimum(-3.099191);
   Graph_Graph01077->SetMaximum(1.435147);
   ...
   Graph_Graph01077->GetXaxis()->SetRange(3,96);
