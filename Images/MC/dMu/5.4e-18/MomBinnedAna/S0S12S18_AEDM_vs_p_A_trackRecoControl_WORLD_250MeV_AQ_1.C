void S0S12S18_AEDM_vs_p_A_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:11:56 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.578306,-0.0008534982,3235.6,0.001273507);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S0S12S18_",100,219.0363,3025.142);
   Graph_Graph01096->SetMinimum(-0.0006407977);
   Graph_Graph01096->SetMaximum(0.001060806);
