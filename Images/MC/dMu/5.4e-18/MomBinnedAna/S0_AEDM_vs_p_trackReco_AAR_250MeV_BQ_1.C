...
//=========  (Thu Nov 18 15:57:48 2021) by ROOT version 6.24/04
   ...
   c->Range(498.2736,-6.662924e-05,2743.039,0.0001027807);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S0_",100,217.6779,3023.635);
   Graph_Graph01026->SetMinimum(-4.968825e-05);
   Graph_Graph01026->SetMaximum(8.583966e-05);
   ...
   Graph_Graph01026->GetYaxis()->SetTitle("A_{EDM}");
