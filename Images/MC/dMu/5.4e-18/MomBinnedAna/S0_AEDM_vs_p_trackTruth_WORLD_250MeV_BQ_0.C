...
//=========  (Thu Nov 18 11:37:40 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4711,-0.2359244,2746.359,0.5542827);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S0_",100,217.4851,3027.345);
   Graph_Graph01026->SetMinimum(-0.1569037);
   Graph_Graph01026->SetMaximum(0.475262);
