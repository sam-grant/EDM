void AEDM_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,-9.095755,12,4.608739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01008 = new TH1F("Graph_Graph01008","",100,1.2,10.8);
   Graph_Graph01008->SetMinimum(-7.725306);
   Graph_Graph01008->SetMaximum(3.238289);
   ...
   Graph_Graph01008->GetXaxis()->SetRange(1,100);
