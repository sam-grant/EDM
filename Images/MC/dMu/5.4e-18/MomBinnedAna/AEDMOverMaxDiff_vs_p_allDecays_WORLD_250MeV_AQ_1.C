...
//=========  (Thu Nov 18 11:28:43 2021) by ROOT version 6.24/04
   ...
   c->Range(526.998,-0.0003573014,2752.101,0.004925309);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01018 = new TH1F("Graph_Graph01018","",100,0,3122.951);
   Graph_Graph01018->SetMinimum(0.0001709596);
   Graph_Graph01018->SetMaximum(0.004397048);
