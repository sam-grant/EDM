void S0S12S18_AEDMOverMaxDiff_vs_p_trackReco_WORLD_250MeV_BQ.2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:34:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.6095,-0.005755191,3407.957,0.003463518);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01218 = new TH1F("Graph_Graph01218","S0S12S18_",100,217.9908,3022.357);
   Graph_Graph01218->SetMinimum(-0.00483332);
   Graph_Graph01218->SetMaximum(0.002541647);
