...
//=========  (Tue Dec  7 00:19:37 2021) by ROOT version 6.24/04
   ...
   c->Range(-394.2727,-0.0330379,3548.454,0.05069847);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","",100,0,3122.952);
   Graph_Graph01037->SetMinimum(-0.02466426);
   Graph_Graph01037->SetMaximum(0.04232483);
