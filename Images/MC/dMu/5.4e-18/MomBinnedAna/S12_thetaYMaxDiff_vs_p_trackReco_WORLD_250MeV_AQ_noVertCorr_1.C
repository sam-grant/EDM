void S12_thetaYMaxDiff_vs_p_trackReco_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:20:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.4225,182.0489,3405.802,184.7159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S12_",100,0,3089.163);
   Graph_Graph01110->SetMinimum(182.3156);
   Graph_Graph01110->SetMaximum(184.4492);
