...
//=========  (Fri Nov 19 18:50:20 2021) by ROOT version 6.24/04
   ...
   c->Range(7.498198,-2.159225,3232.04,6.768188);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12_",100,217.7944,3021.744);
   Graph_Graph01049->SetMinimum(-1.266483);
   Graph_Graph01049->SetMaximum(5.875446);
