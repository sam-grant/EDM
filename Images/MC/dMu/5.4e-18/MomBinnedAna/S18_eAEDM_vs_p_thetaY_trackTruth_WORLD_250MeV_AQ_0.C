void S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:34:57 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.4784,0.006016648,3019.155,0.03376076);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,0,3108.525);
   Graph_Graph01075->SetMinimum(0.008791059);
   Graph_Graph01075->SetMaximum(0.03098635);
   ...
   Graph_Graph01075->GetXaxis()->SetRange(25,89);
