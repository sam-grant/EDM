...
//=========  (Mon Nov 22 14:15:14 2021) by ROOT version 6.24/04
   ...
   c->Range(-374.5359,6.903973,3370.823,29.00124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01019 = new TH1F("Graph_Graph01019","",100,0,3121.132);
   Graph_Graph01019->SetMinimum(9.1137);
   Graph_Graph01019->SetMaximum(26.79151);
