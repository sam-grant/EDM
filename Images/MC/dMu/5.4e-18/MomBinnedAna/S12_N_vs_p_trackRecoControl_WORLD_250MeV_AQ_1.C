...
//=========  (Thu Nov 18 11:30:58 2021) by ROOT version 6.24/04
   ...
   c->Range(499.337,-40522.53,2744.492,374359.7);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S12_",100,218.6927,3025.136);
   Graph_Graph01041->SetMinimum(965.7);
   Graph_Graph01041->SetMaximum(332871.5);
