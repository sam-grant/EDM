void S18_AEDM_vs_p_A_trackReco_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:35:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(8.150025,-0.0001262791,3231.71,6.117367e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01068->SetMinimum(-0.0001075339);
   Graph_Graph01068->SetMaximum(4.242839e-05);
