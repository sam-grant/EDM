...
//=========  (Fri Nov 19 17:29:02 2021) by ROOT version 6.24/04
   ...
   c->Range(7.69113,-1.926249,3232.646,6.965032);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01091 = new TH1F("Graph_Graph01091","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01091->SetMinimum(-1.037121);
   Graph_Graph01091->SetMaximum(6.075904);
