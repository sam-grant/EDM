...
//=========  (Fri Nov 19 17:34:07 2021) by ROOT version 6.24/04
   ...
   c->Range(-374.5321,-1096804,3370.788,1.621559e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","",100,0,3121.1);
   Graph_Graph01020->SetMinimum(634435.5);
   Graph_Graph01020->SetMaximum(1.448435e+07);
