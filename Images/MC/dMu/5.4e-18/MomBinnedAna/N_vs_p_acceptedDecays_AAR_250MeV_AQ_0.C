void N_vs_p_acceptedDecays_AAR_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:35:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-1096804,2744.438,1.621559e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01013 = new TH1F("Graph_Graph01013","",100,0,3150);
   Graph_Graph01013->SetMinimum(634435.5);
   Graph_Graph01013->SetMaximum(1.448435e+07);
   ...
   Graph_Graph01013->GetXaxis()->SetRange(24,80);
