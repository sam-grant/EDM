void S0S12S18_c_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:35:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.297,-2.924029,3335.911,0.8010823);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01091 = new TH1F("Graph_Graph01091","S0S12S18_",100,0,3092.386);
   Graph_Graph01091->SetMinimum(-2.551518);
   Graph_Graph01091->SetMaximum(0.4285711);
