...
//=========  (Thu Nov 18 11:32:24 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6987,-0.4251212,2745.282,0.3480543);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S12S18_",100,217.8758,3026.104);
   Graph_Graph01056->SetMinimum(-0.3478037);
   Graph_Graph01056->SetMaximum(0.2707367);
