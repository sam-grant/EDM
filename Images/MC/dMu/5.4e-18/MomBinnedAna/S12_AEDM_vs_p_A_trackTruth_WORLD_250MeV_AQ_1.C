void S12_AEDM_vs_p_A_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:13:01 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.5203,-0.02057972,3332.186,0.1025668);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S12_",100,0,3092.516);
   Graph_Graph01054->SetMinimum(-0.008265069);
   Graph_Graph01054->SetMaximum(0.09025214);
   ...
   Graph_Graph01054->GetXaxis()->SetRange(3,96);
