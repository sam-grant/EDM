...
//=========  (Wed Jan 19 10:50:32 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9195,-5.70889e-05,3509.275,0.0004634609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01140 = new TH1F("Graph_Graph01140","S18_",100,0,3088.471);
   Graph_Graph01140->SetMinimum(-5.03392e-06);
   Graph_Graph01140->SetMaximum(0.0004114059);
