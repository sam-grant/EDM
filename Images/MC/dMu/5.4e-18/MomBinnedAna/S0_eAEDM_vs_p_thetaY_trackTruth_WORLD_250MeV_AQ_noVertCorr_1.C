void S0_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9161,-0.2001109,3392.245,1.896293);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S0_",100,0,3108.587);
   Graph_Graph01069->SetMinimum(0.009529466);
   Graph_Graph01069->SetMaximum(1.686652);
   ...
   Graph_Graph01069->GetXaxis()->SetRange(1,97);
