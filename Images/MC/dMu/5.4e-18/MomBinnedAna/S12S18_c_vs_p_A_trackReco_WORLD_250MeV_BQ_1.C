...
//=========  (Mon Mar 21 12:27:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1338,-2.142036e-05,3406.706,2.517303e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01171 = new TH1F("Graph_Graph01171","S12S18_",100,218.2803,3021.292);
   Graph_Graph01171->SetMinimum(-1.676102e-05);
   Graph_Graph01171->SetMaximum(2.051369e-05);
