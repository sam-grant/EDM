...
//=========  (Wed Jan 19 11:03:15 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0435,9.358993,3406.904,16.27653);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01138 = new TH1F("Graph_Graph01138","S18_",100,218.3822,3021.478);
   Graph_Graph01138->SetMinimum(10.05075);
   Graph_Graph01138->SetMaximum(15.58477);
