void S12S18_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_hitVolQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:38:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.3528,-0.03359503,3405.175,0.3779699);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01186 = new TH1F("Graph_Graph01186","S12S18_",100,0,3088.594);
   Graph_Graph01186->SetMinimum(0.007561459);
   Graph_Graph01186->SetMaximum(0.3368134);
   ...
   Graph_Graph01186->GetXaxis()->SetRange(1,98);
