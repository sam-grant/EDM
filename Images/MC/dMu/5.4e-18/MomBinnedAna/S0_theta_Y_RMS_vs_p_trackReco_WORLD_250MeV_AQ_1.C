...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-3.916906,3511.253,67.22929);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S0_",100,0,3090.211);
   Graph_Graph01065->SetMinimum(3.197715);
   Graph_Graph01065->SetMaximum(60.11467);
