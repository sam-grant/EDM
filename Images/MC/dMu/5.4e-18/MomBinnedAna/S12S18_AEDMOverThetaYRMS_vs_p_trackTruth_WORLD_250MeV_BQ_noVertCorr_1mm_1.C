...
//=========  (Mon Apr 25 18:52:11 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.2628,-0.01443446,3382.111,0.03627094);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01182 = new TH1F("Graph_Graph01182","S12S18_",100,217.5726,3027.374);
   Graph_Graph01182->SetMinimum(-0.009363922);
   Graph_Graph01182->SetMaximum(0.0312004);
