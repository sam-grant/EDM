void S12_Ag2_vs_p_thetaY_trackReco_WORLD_250MeV_hitVolQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:38:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.4108,-0.6560666,3405.697,2.229989);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01100 = new TH1F("Graph_Graph01100","S12_",100,0,3089.067);
   Graph_Graph01100->SetMinimum(-0.3674611);
   Graph_Graph01100->SetMaximum(1.941383);
