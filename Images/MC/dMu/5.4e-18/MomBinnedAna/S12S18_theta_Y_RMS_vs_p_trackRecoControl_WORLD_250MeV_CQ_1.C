...
//=========  (Tue Dec 14 16:27:44 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.8371,-3.358663,3508.534,66.56185);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01182 = new TH1F("Graph_Graph01182","S12S18_",100,0,3087.819);
   Graph_Graph01182->SetMinimum(3.633389);
   Graph_Graph01182->SetMaximum(59.5698);
   ...
   Graph_Graph01182->GetXaxis()->SetRange(1,101);
