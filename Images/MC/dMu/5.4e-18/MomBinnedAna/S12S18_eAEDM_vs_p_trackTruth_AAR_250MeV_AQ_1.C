void S12S18_eAEDM_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:32:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.7914,-0.1552827,2724.911,1.537894);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S12S18_",100,0,3092.097);
   Graph_Graph01062->SetMinimum(0.01403504);
   Graph_Graph01062->SetMaximum(1.368577);
   ...
   Graph_Graph01062->GetXaxis()->SetRange(25,81);
