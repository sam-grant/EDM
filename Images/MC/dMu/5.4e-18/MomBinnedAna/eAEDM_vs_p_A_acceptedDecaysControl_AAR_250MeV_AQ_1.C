void eAEDM_vs_p_A_acceptedDecaysControl_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:10:22 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-374.5359,-2.347459e-09,3370.823,3.737922e-08);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","",100,0,3121.132);
   Graph_Graph01022->SetMinimum(1.62521e-09);
   Graph_Graph01022->SetMaximum(3.340655e-08);
   ...
   Graph_Graph01022->GetXaxis()->SetRange(1,96);
