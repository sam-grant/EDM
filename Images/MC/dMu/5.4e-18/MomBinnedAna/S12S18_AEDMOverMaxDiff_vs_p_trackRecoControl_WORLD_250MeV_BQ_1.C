...
//=========  (Tue Dec 14 16:33:28 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9196,-0.01361034,3410.609,0.03183937);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,218.8923,3024.797);
   Graph_Graph01181->SetMinimum(-0.009065368);
   Graph_Graph01181->SetMaximum(0.0272944);
