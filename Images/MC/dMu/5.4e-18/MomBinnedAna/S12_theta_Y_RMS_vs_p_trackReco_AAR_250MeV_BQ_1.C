...
//=========  (Wed Dec  1 13:32:12 2021) by ROOT version 6.24/04
   ...
   c->Range(7.498198,-1.657563,3232.04,37.7678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12_",100,217.7944,3021.744);
   Graph_Graph01055->SetMinimum(2.284974);
   Graph_Graph01055->SetMaximum(33.82526);
