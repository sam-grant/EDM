void S18_AEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6404,-123.8514,3398.763,25.012);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01134 = new TH1F("Graph_Graph01134","S18_",100,0,3051.639);
   Graph_Graph01134->SetMinimum(-108.965);
   Graph_Graph01134->SetMaximum(10.12566);
   ...
   Graph_Graph01134->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01134->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
