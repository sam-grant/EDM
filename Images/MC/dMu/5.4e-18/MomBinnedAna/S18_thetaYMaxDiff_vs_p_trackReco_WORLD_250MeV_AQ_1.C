...
//=========  (Mon Dec  6 08:42:17 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9195,176.9856,3509.275,185.7286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S18_",100,0,3088.471);
   Graph_Graph01077->SetMinimum(177.8599);
   Graph_Graph01077->SetMaximum(184.8543);
   ...
   Graph_Graph01077->GetXaxis()->SetRange(1,101);
