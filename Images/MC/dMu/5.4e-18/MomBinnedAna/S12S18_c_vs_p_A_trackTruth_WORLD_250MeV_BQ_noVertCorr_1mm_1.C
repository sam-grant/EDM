...
//=========  (Wed Apr  6 12:55:02 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.8606,-7.14551e-05,3379.773,6.838694e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01171 = new TH1F("Graph_Graph01171","S12S18_",100,217.6791,3025.309);
   Graph_Graph01171->SetMinimum(-5.74709e-05);
   Graph_Graph01171->SetMaximum(5.440273e-05);
