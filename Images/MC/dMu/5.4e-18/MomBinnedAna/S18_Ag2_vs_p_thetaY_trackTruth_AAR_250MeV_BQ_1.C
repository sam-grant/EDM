void S18_Ag2_vs_p_thetaY_trackTruth_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:13:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.50122,-0.3285051,3236.776,0.9295779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S18_",100,218.1061,3026.171);
   Graph_Graph01065->SetMinimum(-0.2026968);
   Graph_Graph01065->SetMaximum(0.8037696);
