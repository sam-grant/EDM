...
//=========  (Thu Nov 18 11:37:41 2021) by ROOT version 6.24/04
   ...
   c->Range(498.6987,11.72204,2745.282,23.2614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S12S18_",100,217.8758,3026.104);
   Graph_Graph01060->SetMinimum(12.87597);
   Graph_Graph01060->SetMaximum(22.10747);
