void S18_c_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:05 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.2651,-0.02533191,3033.368,0.3128752);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S18_",100,0,3087.398);
   Graph_Graph01065->SetMinimum(0.008488804);
   Graph_Graph01065->SetMaximum(0.2790545);
   ...
   Graph_Graph01065->GetXaxis()->SetRange(25,90);
