...
//=========  (Fri Nov 19 17:31:49 2021) by ROOT version 6.24/04
   ...
   c->Range(7.258654,-179370,3236.722,1811970);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01086 = new TH1F("Graph_Graph01086","S12S18_",100,217.8758,3026.104);
   Graph_Graph01086->SetMinimum(19764);
   Graph_Graph01086->SetMaximum(1612836);
