...
//=========  (Tue Dec 14 16:27:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.784,6.763305,3508.056,28.95517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01145 = new TH1F("Graph_Graph01145","S18_",100,0,3087.398);
   Graph_Graph01145->SetMinimum(8.982491);
   Graph_Graph01145->SetMaximum(26.73598);
