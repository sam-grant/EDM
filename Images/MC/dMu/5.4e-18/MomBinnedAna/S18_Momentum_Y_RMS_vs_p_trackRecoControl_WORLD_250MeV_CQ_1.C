void S18_Momentum_Y_RMS_vs_p_trackRecoControl_WORLD_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 18:16:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.2651,11.14777,3033.368,28.468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01073 = new TH1F("Graph_Graph01073","S18_",100,0,3087.398);
   Graph_Graph01073->SetMinimum(12.87979);
   Graph_Graph01073->SetMaximum(26.73598);
