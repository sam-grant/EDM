void S12S18_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1a_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:34:50 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,13.18225,3407.936,13.25508);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.00895872,
   0.01333856};
   TGraphErrors *gre = new TGraphErrors(12,Graph0_fx1132,Graph0_fy1132,Graph0_fex1132,Graph0_fey1132);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01132 = new TH1F("Graph_Graph01132","S12S18_",100,0,3122.965);
   Graph_Graph01132->SetMinimum(13.18953);
   Graph_Graph01132->SetMaximum(13.2478);
   ...
   Graph_Graph01132->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01132->GetYaxis()->SetTitle("#sigma_{y} [mm] / 250 MeV");
