void S18_eAEDM_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:20:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.3085,-0.04330189,3404.776,0.468653);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01147 = new TH1F("Graph_Graph01147","S18_",100,0,3088.232);
   Graph_Graph01147->SetMinimum(0.007893604);
   Graph_Graph01147->SetMaximum(0.4174575);
