...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-0.0001810708,3511.253,2.062207e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S0_",100,0,3090.211);
   Graph_Graph01063->SetMinimum(-0.0001609015);
   Graph_Graph01063->SetMaximum(4.527864e-07);
