void S12S18_AEDM_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-1.065301,2750,1.387574);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S12S18_",100,125,3125);
   Graph_Graph01046->SetMinimum(-0.8200139);
   Graph_Graph01046->SetMaximum(1.142287);
   ...
   Graph_Graph01046->GetXaxis()->SetRange(21,80);
