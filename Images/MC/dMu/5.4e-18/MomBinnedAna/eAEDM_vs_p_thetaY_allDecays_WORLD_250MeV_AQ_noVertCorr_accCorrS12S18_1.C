void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12S18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:47:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,0.003346258,3407.936,0.0104405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(0.004055683);
   Graph_Graph01045->SetMaximum(0.009731079);
