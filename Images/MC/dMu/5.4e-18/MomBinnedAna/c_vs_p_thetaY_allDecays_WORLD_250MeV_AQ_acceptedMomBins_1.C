void c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_acceptedMomBins_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb 24 16:19:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-0.918439,3548.544,2.979867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.5286084);
   Graph_Graph01035->SetMaximum(2.590036);
