void S0S12S18_c_vs_p_A_trackReco_WORLD_250MeV_BQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 19:04:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(466.8966,-2.486714e-05,3025.828,3.188903e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01098 = new TH1F("Graph_Graph01098","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01098->SetMinimum(-2.206153e-05);
   Graph_Graph01098->SetMaximum(3.832987e-07);
