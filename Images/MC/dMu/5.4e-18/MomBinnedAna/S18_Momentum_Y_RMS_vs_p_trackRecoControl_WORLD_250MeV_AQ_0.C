...
//=========  (Mon Nov 22 14:16:44 2021) by ROOT version 6.24/04
   ...
   c->Range(8.41028,11.04661,3235.149,25.59766);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S18_",100,218.8498,3024.71);
   Graph_Graph01071->SetMinimum(12.50172);
   Graph_Graph01071->SetMaximum(24.14256);
