void AEDMOverMaxDiff_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,-0.002448903,12,0.001370441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1016[3] = {
   2,
   6,
   10};
   Double_t Graph0_fy1016[3] = {
   3.998019e-05,
   -0.001812345,
   -0.001237544};
   Double_t Graph0_fex1016[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1016[3] = {
   0.0006939038,
   -0.0003737772,
   -0.0002373723};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1016,Graph0_fy1016,Graph0_fex1016,Graph0_fey1016);
   gre->SetName("Graph0");
   gre->SetTitle(";e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV;A_{EDM}/(#Delta#theta_{y})_{MAX}");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","",100,1.2,10.8);
   Graph_Graph01016->SetMinimum(-0.002066968);
   Graph_Graph01016->SetMaximum(0.0009885069);
   ...
   Graph_Graph01016->GetXaxis()->SetRange(1,100);
