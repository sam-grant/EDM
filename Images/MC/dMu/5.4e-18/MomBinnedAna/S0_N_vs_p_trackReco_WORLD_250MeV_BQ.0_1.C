void S0_N_vs_p_trackReco_WORLD_250MeV_BQ.0_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:31:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.7171,-225546.1,3409.979,314573.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S0_",100,217.2208,3024.042);
   Graph_Graph01066->SetMinimum(-171534.2);
   Graph_Graph01066->SetMaximum(260561.2);
