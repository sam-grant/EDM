void S12S18_N_vs_p_trackReco_WORLD_250MeV_BQ_acceptanceUncorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:31:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.6611,-375066.3,3375.214,3758691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18_",100,218.2572,3021.327);
   Graph_Graph01177->SetMinimum(38309.4);
   Graph_Graph01177->SetMaximum(3345315);
