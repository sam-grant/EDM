void S0S12S18_eAEDM_vs_p_A_trackReco_WORLD_250MeV_BQ.0_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:32:15 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.7269,-1.659631e-05,3408.028,0.0001499865);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,217.8937,3022.407);
   Graph_Graph01216->SetMinimum(6.197025e-08);
   Graph_Graph01216->SetMaximum(0.0001333282);
