void S12S18_AEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:29:09 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.531,0.02855558,3019.477,0.2297529);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S12S18_",100,0,3108.857);
   Graph_Graph01081->SetMinimum(0.04867532);
   Graph_Graph01081->SetMaximum(0.2096332);
   ...
   Graph_Graph01081->GetXaxis()->SetRange(25,89);
