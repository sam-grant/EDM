...
//=========  (Mon Mar 21 12:27:29 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1338,-2763136,3406.706,3904977);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18_",100,218.2803,3021.292);
   Graph_Graph01177->SetMinimum(-2096325);
   Graph_Graph01177->SetMaximum(3238165);
