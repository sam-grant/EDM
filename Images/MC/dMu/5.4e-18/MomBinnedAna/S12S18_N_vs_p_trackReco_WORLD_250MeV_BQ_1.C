...
//=========  (Fri Mar 25 02:59:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.655,-375071.9,3375.214,3758714);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18_",100,218.2625,3021.327);
   Graph_Graph01177->SetMinimum(38306.7);
   Graph_Graph01177->SetMaximum(3345335);
