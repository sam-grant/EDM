void S12S18_AEDM_vs_p_A_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9369,-0.0001492075,3392.432,0.0001018935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18_",100,0,3108.757);
   Graph_Graph01180->SetMinimum(-0.0001240974);
   Graph_Graph01180->SetMaximum(7.678336e-05);
   ...
   Graph_Graph01180->GetXaxis()->SetRange(1,97);
