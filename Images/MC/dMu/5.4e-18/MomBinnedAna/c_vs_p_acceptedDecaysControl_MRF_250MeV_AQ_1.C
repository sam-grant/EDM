void c_vs_p_acceptedDecaysControl_MRF_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-8.940697e-08,-2.194238,12,6.640115);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-1.310803);
   Graph_Graph01007->SetMaximum(5.75668);
