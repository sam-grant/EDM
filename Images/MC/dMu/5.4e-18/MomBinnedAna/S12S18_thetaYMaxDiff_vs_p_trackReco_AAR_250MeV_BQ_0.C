void S12S18_thetaYMaxDiff_vs_p_trackReco_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:16:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.865666,-14.19731,3231.802,220.0387);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01089 = new TH1F("Graph_Graph01089","S12S18_",100,218.1224,3021.545);
   Graph_Graph01089->SetMinimum(9.226289);
   Graph_Graph01089->SetMaximum(196.6151);
