void S18_c_vs_p_thetaY_trackReco_WORLD_250MeV_BQ.2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:34:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.195,-0.1339811,3407.047,0.05643947);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S18_",100,218.2625,3021.59);
   Graph_Graph01131->SetMinimum(-0.1149391);
   Graph_Graph01131->SetMaximum(0.03739741);
