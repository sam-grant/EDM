...
//=========  (Thu Nov 18 15:57:48 2021) by ROOT version 6.24/04
   ...
   c->Range(498.198,-1.25018e-05,2741.319,0.0001142878);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12_",100,217.8079,3021.709);
   Graph_Graph01042->SetMinimum(1.771585e-07);
   Graph_Graph01042->SetMaximum(0.0001016088);
