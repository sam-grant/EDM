void S18_AEDMOverMaxDiff_vs_p_trackReco_WORLD_250MeV_BQ.3_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:35:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.0435,-0.009722562,3406.904,0.006400669);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,218.3822,3021.478);
   Graph_Graph01144->SetMinimum(-0.008110239);
   Graph_Graph01144->SetMaximum(0.004788345);
