...
//=========  (Thu Nov 18 11:38:17 2021) by ROOT version 6.24/04
   ...
   c->Range(498.9126,-1.687776,2745.365,37.65168);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S18_",100,218.1061,3026.171);
   Graph_Graph01048->SetMinimum(2.246169);
   Graph_Graph01048->SetMaximum(33.71773);
