...
//=========  (Thu Nov 18 11:36:37 2021) by ROOT version 6.24/04
   ...
   c->Range(499.4652,-81124.92,2744.171,748907.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12S18_",100,218.877,3024.76);
   Graph_Graph01061->SetMinimum(1878.3);
   Graph_Graph01061->SetMaximum(665904);
   ...
   Graph_Graph01061->GetXaxis()->SetRange(19,82);
