void S0S12S18_Y_RMS_vs_p_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:18 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6585,-1.769379,3398.926,15.92441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01218 = new TH1F("Graph_Graph01218","S0S12S18_",100,0,3051.786);
   Graph_Graph01218->SetMinimum(0);
   Graph_Graph01218->SetMaximum(14.15503);
   ...
   Graph_Graph01218->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01218->GetYaxis()->SetTitle("#sigma_{y} [mm] / 250 MeV");
