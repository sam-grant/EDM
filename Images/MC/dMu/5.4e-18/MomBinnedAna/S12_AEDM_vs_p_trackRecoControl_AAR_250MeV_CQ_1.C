void S12_AEDM_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-1.05467,2744.438,4.780794);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S12_",100,0,3150);
   Graph_Graph01026->SetMinimum(-0.4711238);
   Graph_Graph01026->SetMaximum(4.197247);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(24,80);
