...
//=========  (Wed Jan 19 10:50:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9195,-0.002088092,3509.275,0.01966729);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01150 = new TH1F("Graph_Graph01150","S18_",100,0,3088.471);
   Graph_Graph01150->SetMinimum(8.744647e-05);
   Graph_Graph01150->SetMaximum(0.01749175);
