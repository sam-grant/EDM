void Ag2_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr.BK_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 25 17:21:43 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-3.614538e-07,3407.936,1.606372e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(-3.092447e-07);
   Graph_Graph01040->SetMaximum(1.084281e-07);
