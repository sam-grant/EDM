void S0_N_vs_p_trackReco_WORLD_250MeV_BQ_acceptanceUncorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:31:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.6275,-86467.22,3377.862,913924.9);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S0_",100,217.6808,3023.613);
   Graph_Graph01066->SetMinimum(13572);
   Graph_Graph01066->SetMaximum(813885.7);
   ...
   Graph_Graph01066->GetXaxis()->SetRange(0,100);
