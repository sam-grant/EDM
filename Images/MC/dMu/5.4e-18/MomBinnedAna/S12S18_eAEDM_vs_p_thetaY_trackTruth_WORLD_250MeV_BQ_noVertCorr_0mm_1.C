void S12S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_0mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr  6 12:52:39 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.8066,-0.01040404,3380.294,0.1662933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01178 = new TH1F("Graph_Graph01178","S12S18_",100,217.7835,3025.784);
   Graph_Graph01178->SetMinimum(0.007265693);
   Graph_Graph01178->SetMaximum(0.1486235);
