void S0S12S18_c_vs_p_A_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Dec  1 13:32:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.685561,-0.0001249584,3232.676,0.0001280393);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01094 = new TH1F("Graph_Graph01094","S0S12S18_",100,218.0111,3022.351);
   Graph_Graph01094->SetMinimum(-9.96586e-05);
   Graph_Graph01094->SetMaximum(0.0001027395);
