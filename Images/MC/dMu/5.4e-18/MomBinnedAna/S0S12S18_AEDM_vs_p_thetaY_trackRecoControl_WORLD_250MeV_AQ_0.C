...
//=========  (Fri Dec  3 15:33:11 2021) by ROOT version 6.24/04
   ...
   c->Range(486.5144,-0.1408216,3034.923,0.005908077);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S0S12S18_",100,0,3088.981);
   Graph_Graph01096->SetMinimum(-0.1261486);
   Graph_Graph01096->SetMaximum(-0.008764891);
