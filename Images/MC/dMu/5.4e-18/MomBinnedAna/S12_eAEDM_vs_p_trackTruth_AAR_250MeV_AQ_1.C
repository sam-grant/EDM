void S12_eAEDM_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:32:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.862,-0.009523729,2725.279,0.08574684);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12_",100,0,3092.516);
   Graph_Graph01042->SetMinimum(3.328256e-06);
   Graph_Graph01042->SetMaximum(0.07621978);
   ...
   Graph_Graph01042->GetXaxis()->SetRange(25,81);
