...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-6.113548e-05,3511.253,0.0005029627);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S0_",100,0,3090.211);
   Graph_Graph01062->SetMinimum(-4.72566e-06);
   Graph_Graph01062->SetMaximum(0.0004465529);
