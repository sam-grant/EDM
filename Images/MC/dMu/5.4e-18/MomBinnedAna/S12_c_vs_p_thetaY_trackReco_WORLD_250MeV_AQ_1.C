...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,-9.804107,3510.154,6.469136);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S12_",100,0,3089.244);
   Graph_Graph01050->SetMinimum(-8.176782);
   Graph_Graph01050->SetMaximum(4.841812);
   ...
   Graph_Graph01050->GetXaxis()->SetRange(1,101);
