void AEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 12:17:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.01706323,3407.936,0.4175875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","",100,0,3122.965);
   Graph_Graph01036->SetMinimum(0.02640184);
   Graph_Graph01036->SetMaximum(0.3741224);
   ...
   Graph_Graph01036->GetXaxis()->SetRange(1,97);
