...
//=========  (Fri Dec  3 15:29:09 2021) by ROOT version 6.24/04
   ...
   c->Range(493.4784,-8.03019e-08,3019.155,1.111538e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S18_",100,0,3108.525);
   Graph_Graph01069->SetMinimum(3.888214e-08);
   Graph_Graph01069->SetMaximum(9.923544e-07);
   ...
   Graph_Graph01069->GetXaxis()->SetRange(25,89);
