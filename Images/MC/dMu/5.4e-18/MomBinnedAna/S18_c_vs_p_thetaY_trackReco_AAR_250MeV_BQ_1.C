...
//=========  (Wed Dec  1 13:32:13 2021) by ROOT version 6.24/04
   ...
   c->Range(8.109012,-1.938094,3231.77,7.097838);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S18_",100,218.3478,3021.531);
   Graph_Graph01063->SetMinimum(-1.034501);
   Graph_Graph01063->SetMaximum(6.194245);
