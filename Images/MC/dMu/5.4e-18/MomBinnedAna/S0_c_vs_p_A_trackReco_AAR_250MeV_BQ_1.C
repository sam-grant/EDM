...
//=========  (Mon Nov 22 14:11:37 2021) by ROOT version 6.24/04
   ...
   c->Range(7.267965,-0.0003171348,3234.092,0.0003860068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S0_",100,217.713,3023.647);
   Graph_Graph01038->SetMinimum(-0.0002468206);
   Graph_Graph01038->SetMaximum(0.0003156927);
