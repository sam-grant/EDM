...
//=========  (Fri Mar 25 02:59:04 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.6244,-2.57263e-06,3377.861,2.372937e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0_",100,217.6834,3023.612);
   Graph_Graph01068->SetMinimum(5.75695e-08);
   Graph_Graph01068->SetMaximum(2.109917e-05);
