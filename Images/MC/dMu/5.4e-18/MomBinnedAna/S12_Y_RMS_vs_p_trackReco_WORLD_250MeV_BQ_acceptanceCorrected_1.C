...
//=========  (Sun Mar 27 14:47:02 2022) by ROOT version 6.24/06
   ...
   c->Range(-163.9151,12.495,3375.534,13.26443);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S12_",100,218.0651,3021.589);
   Graph_Graph01101->SetMinimum(12.57195);
   Graph_Graph01101->SetMaximum(13.18749);
