...
//=========  (Tue Dec 14 16:33:28 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9196,-29.07798,3410.609,245.7768);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18_",100,218.8923,3024.797);
   Graph_Graph01180->SetMinimum(-1.592493);
   Graph_Graph01180->SetMaximum(218.2914);
