void S12S18_c_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_0mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 26 12:13:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.8066,-1.989033,3380.294,6.880358);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01168 = new TH1F("Graph_Graph01168","S12S18_",100,217.7835,3025.784);
   Graph_Graph01168->SetMinimum(-1.102094);
   Graph_Graph01168->SetMaximum(5.993419);
