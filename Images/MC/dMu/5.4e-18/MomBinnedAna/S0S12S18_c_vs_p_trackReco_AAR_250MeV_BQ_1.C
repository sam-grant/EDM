...
//=========  (Thu Nov 18 15:57:50 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4451,-0.0001284877,2741.892,0.0001270411);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01065->SetMinimum(-0.0001029349);
   Graph_Graph01065->SetMaximum(0.0001014882);
