...
//=========  (Wed Apr 13 12:27:15 2022) by ROOT version 6.24/06
   ...
   c->Range(-377.626,-1.770319,3398.634,15.93287);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18_",100,0,3051.523);
   Graph_Graph01179->SetMinimum(0);
   Graph_Graph01179->SetMaximum(14.16255);
   ...
   Graph_Graph01179->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01179->GetYaxis()->SetTitle("#sigma_{y} [mm] / 250 MeV");
