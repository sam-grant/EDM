void S0_c_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:17:45 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.6902,-3.134407,3334.064,0.6897293);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S0_",100,0,3094.258);
   Graph_Graph01035->SetMinimum(-2.751993);
   Graph_Graph01035->SetMaximum(0.3073157);
   ...
   Graph_Graph01035->GetXaxis()->SetRange(3,96);
