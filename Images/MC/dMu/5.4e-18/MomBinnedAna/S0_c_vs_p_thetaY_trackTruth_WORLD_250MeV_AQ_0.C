...
//=========  (Fri Dec  3 15:34:52 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.4803,-0.4286426,3019.167,0.08051147);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.3777272);
   Graph_Graph01035->SetMaximum(0.02959606);
