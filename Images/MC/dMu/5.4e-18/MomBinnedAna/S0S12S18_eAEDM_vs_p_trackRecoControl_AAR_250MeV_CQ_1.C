void S0S12S18_eAEDM_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.1441346,2744.438,1.41248);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S0S12S18_",100,0,3150);
   Graph_Graph01062->SetMinimum(0.01152687);
   Graph_Graph01062->SetMaximum(1.256818);
   ...
   Graph_Graph01062->GetXaxis()->SetRange(24,80);
