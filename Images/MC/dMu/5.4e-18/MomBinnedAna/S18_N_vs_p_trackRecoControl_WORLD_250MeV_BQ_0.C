void S18_N_vs_p_trackRecoControl_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-40602.39,2750,374547.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S18_",100,125,3125);
   Graph_Graph01041->SetMinimum(912.6);
   Graph_Graph01041->SetMaximum(333032.5);
   ...
   Graph_Graph01041->GetXaxis()->SetRange(21,80);
