...
//=========  (Mon Mar 21 12:27:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0109,-0.04034944,3406.551,0.03418134);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01145 = new TH1F("Graph_Graph01145","S18_",100,218.3733,3021.167);
   Graph_Graph01145->SetMinimum(-0.03289636);
   Graph_Graph01145->SetMaximum(0.02672826);
