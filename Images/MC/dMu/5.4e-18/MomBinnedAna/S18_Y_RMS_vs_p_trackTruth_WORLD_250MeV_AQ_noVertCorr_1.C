void S18_Y_RMS_vs_p_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.8896,11.53511,3392.006,13.09194);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,0,3108.367);
   Graph_Graph01144->SetMinimum(11.6908);
   Graph_Graph01144->SetMaximum(12.93626);
   ...
   Graph_Graph01144->GetXaxis()->SetRange(1,97);
