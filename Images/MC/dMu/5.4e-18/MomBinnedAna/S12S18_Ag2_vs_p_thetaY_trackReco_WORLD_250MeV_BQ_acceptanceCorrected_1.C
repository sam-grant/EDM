...
//=========  (Tue Feb 22 00:12:21 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1692,-0.1262316,3406.642,0.3265402);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,218.2418,3021.231);
   Graph_Graph01170->SetMinimum(-0.08095443);
   Graph_Graph01170->SetMaximum(0.281263);
