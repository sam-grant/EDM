void S18_eAEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:06 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.2651,0.007552497,3033.368,0.08977313);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,0,3087.398);
   Graph_Graph01075->SetMinimum(0.01577456);
   Graph_Graph01075->SetMaximum(0.08155106);
   ...
   Graph_Graph01075->GetXaxis()->SetRange(25,90);
