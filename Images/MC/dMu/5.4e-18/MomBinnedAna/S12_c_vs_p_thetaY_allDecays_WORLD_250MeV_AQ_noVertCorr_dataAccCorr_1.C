void S12_c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:12:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.4026409,3407.936,0.8138435);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12_",100,0,3122.965);
   Graph_Graph01047->SetMinimum(-0.2809924);
   Graph_Graph01047->SetMaximum(0.692195);
   ...
   Graph_Graph01047->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01047->GetYaxis()->SetTitle("c [mrad] / 250 MeV");
