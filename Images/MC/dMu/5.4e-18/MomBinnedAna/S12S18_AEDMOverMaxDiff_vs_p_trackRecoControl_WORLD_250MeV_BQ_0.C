...
//=========  (Fri Dec  3 15:33:56 2021) by ROOT version 6.24/04
   ...
   c->Range(467.9164,-0.008963041,3028.305,0.002031835);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01093 = new TH1F("Graph_Graph01093","S12S18_",100,218.8923,3024.797);
   Graph_Graph01093->SetMinimum(-0.007863553);
   Graph_Graph01093->SetMaximum(0.0009323472);
   ...
   Graph_Graph01093->GetXaxis()->SetRange(19,91);
