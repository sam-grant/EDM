void S0S12S18_Ag2_vs_p_A_trackTruth_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:35:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(493.5032,-1.357343e-08,3019.307,1.313467e-08);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01100 = new TH1F("Graph_Graph01100","S0S12S18_",100,0,3108.682);
   Graph_Graph01100->SetMinimum(-1.090262e-08);
   Graph_Graph01100->SetMaximum(1.046386e-08);
   ...
   Graph_Graph01100->GetXaxis()->SetRange(25,89);
