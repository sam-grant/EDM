void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 18:13:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-1.08597e-08,3407.936,1.221224e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01046->SetMaximum(1.088241e-07);
