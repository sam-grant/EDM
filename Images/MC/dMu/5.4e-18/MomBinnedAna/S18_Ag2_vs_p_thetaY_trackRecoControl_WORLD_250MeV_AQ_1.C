void S18_Ag2_vs_p_thetaY_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:27:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.3887,-0.001263801,3034.139,0.1601185);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S18_",100,0,3088.183);
   Graph_Graph01067->SetMinimum(0.01487443);
   Graph_Graph01067->SetMaximum(0.1439803);
