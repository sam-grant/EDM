...
//=========  (Tue Dec 14 16:33:20 2021) by ROOT version 6.24/04
   ...
   c->Range(-167.1476,-26.77226,3411.031,245.5207);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01106 = new TH1F("Graph_Graph01106","S12_",100,218.7344,3025.149);
   Graph_Graph01106->SetMinimum(0.4570302);
   Graph_Graph01106->SetMaximum(218.2914);
