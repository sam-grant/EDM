void S12_thetaYMaxDiff_vs_p_trackRecoControl_WORLD_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-11.94099,2750,311.7495);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S12_",100,125,3125);
   Graph_Graph01033->SetMinimum(20.42806);
   Graph_Graph01033->SetMaximum(279.3804);
   ...
   Graph_Graph01033->GetXaxis()->SetRange(21,80);
