...
//=========  (Thu Nov 18 15:57:49 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4817,-2.884865e-05,2741.167,7.87079e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S12S18_",100,218.1461,3021.502);
   Graph_Graph01056->SetMinimum(-1.8093e-05);
   Graph_Graph01056->SetMaximum(6.795225e-05);
   ...
   Graph_Graph01056->GetYaxis()->SetTitle("A_{EDM}");
