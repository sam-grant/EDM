void S18_Ag2_vs_p_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.9713264,2750,0.5536784);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S18_",100,125,3125);
   Graph_Graph01037->SetMinimum(-0.8188259);
   Graph_Graph01037->SetMaximum(0.4011779);
