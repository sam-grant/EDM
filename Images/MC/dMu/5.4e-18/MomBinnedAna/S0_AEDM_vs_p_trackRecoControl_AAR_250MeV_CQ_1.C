void S0_AEDM_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:23 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-4.505242,2744.438,1.333813);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01016->SetMinimum(-3.921336);
   Graph_Graph01016->SetMaximum(0.7499075);
