...
//=========  (Thu Nov 18 11:35:49 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6846,-0.0008682725,2724.353,0.004218056);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S18_",100,0,3091.465);
   Graph_Graph01054->SetMinimum(-0.0003596396);
   Graph_Graph01054->SetMaximum(0.003709423);
