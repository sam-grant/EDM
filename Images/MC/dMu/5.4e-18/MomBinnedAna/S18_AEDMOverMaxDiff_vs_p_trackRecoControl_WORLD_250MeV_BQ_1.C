...
//=========  (Tue Dec 14 16:33:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9784,-0.01777584,3410.59,0.01653106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,218.8378,3024.773);
   Graph_Graph01144->SetMinimum(-0.01434515);
   Graph_Graph01144->SetMaximum(0.01310037);
