...
//=========  (Fri Nov 19 17:30:27 2021) by ROOT version 6.24/04
   ...
   c->Range(8.41028,-0.0119257,3235.149,0.03862591);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01076 = new TH1F("Graph_Graph01076","S18_",100,218.8498,3024.71);
   Graph_Graph01076->SetMinimum(-0.006870543);
   Graph_Graph01076->SetMaximum(0.03357074);
