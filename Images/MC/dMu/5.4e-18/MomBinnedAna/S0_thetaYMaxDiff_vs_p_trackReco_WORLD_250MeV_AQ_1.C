...
//=========  (Thu Nov 18 11:29:49 2021) by ROOT version 6.24/04
   ...
   c->Range(522.1276,-130.5191,2726.666,1264.791);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S0_",100,0,3094.089);
   Graph_Graph01033->SetMinimum(9.011871);
   Graph_Graph01033->SetMaximum(1125.26);
