...
//=========  (Wed Apr  6 12:55:10 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0369,-0.01061798,3380.183,0.03720987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01219 = new TH1F("Graph_Graph01219","S0S12S18_",100,217.5661,3025.661);
   Graph_Graph01219->SetMinimum(-0.005835194);
   Graph_Graph01219->SetMaximum(0.03242708);
