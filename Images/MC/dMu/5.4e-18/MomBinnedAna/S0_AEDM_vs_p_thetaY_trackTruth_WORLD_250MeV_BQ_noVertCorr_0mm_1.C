void S0_AEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_0mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 26 12:13:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-165.4461,-0.1688356,3381.552,0.5248907);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0_",100,217.3487,3026.852);
   Graph_Graph01058->SetMinimum(-0.09946296);
   Graph_Graph01058->SetMaximum(0.455518);
