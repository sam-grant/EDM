...
//=========  (Tue Feb 22 00:12:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3944,-0.03931334,3407.426,0.4726254);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18_",100,218.1255,3021.906);
   Graph_Graph01215->SetMinimum(0.01188054);
   Graph_Graph01215->SetMaximum(0.4214315);
