void S0S12S18_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 18:56:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.5622,9.954147,3035.222,21.34659);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S0S12S18_",100,0,3089.284);
   Graph_Graph01102->SetMinimum(11.09339);
   Graph_Graph01102->SetMaximum(20.20735);
   ...
   Graph_Graph01102->GetXaxis()->SetRange(25,90);
