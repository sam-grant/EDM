...
//=========  (Tue Feb 22 00:12:22 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1692,-2.862543e-06,3406.642,2.585376e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18_",100,218.2418,3021.231);
   Graph_Graph01179->SetMinimum(9.087946e-09);
   Graph_Graph01179->SetMaximum(2.298213e-05);
