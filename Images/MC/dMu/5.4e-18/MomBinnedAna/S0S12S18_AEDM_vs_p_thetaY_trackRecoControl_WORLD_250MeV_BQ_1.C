...
//=========  (Tue Dec 14 16:33:32 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.8117,-1.07288,3411.006,0.6331077);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01206 = new TH1F("Graph_Graph01206","S0S12S18_",100,219.0314,3025.163);
   Graph_Graph01206->SetMinimum(-0.9022812);
   Graph_Graph01206->SetMaximum(0.4625089);
