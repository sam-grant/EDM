...
//=========  (Wed Jan 19 10:50:40 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0221,-0.09629477,3510.199,0.9254799);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01225 = new TH1F("Graph_Graph01225","S0S12S18_",100,0,3089.284);
   Graph_Graph01225->SetMinimum(0.005882706);
   Graph_Graph01225->SetMaximum(0.8233025);
