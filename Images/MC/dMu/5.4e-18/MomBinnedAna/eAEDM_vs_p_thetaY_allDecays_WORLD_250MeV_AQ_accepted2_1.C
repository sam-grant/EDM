void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_accepted2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb 24 02:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,0.001400819,3548.544,0.01064847);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(0.002325584);
   Graph_Graph01045->SetMaximum(0.009723704);
