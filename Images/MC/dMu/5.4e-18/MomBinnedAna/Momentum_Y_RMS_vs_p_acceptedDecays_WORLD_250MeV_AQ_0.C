void Momentum_Y_RMS_vs_p_acceptedDecays_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:35:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,6.905714,2744.438,28.99769);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01012 = new TH1F("Graph_Graph01012","",100,0,3150);
   Graph_Graph01012->SetMinimum(9.114912);
   Graph_Graph01012->SetMaximum(26.78849);
   ...
   Graph_Graph01012->GetXaxis()->SetRange(24,80);
