void c_vs_p_allDecays_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 16:02:19 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(526.9981,-8.586962e-07,2752.101,4.063708e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01009 = new TH1F("Graph_Graph01009","",100,0,3122.952);
   Graph_Graph01009->SetMinimum(-7.321895e-07);
   Graph_Graph01009->SetMaximum(2.798641e-07);
