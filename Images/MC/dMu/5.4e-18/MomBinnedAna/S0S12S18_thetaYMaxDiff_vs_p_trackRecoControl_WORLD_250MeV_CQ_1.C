...
//=========  (Tue Dec 14 16:27:49 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.8815,136.4873,3508.933,229.8356);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01227 = new TH1F("Graph_Graph01227","S0S12S18_",100,0,3088.17);
   Graph_Graph01227->SetMinimum(145.8222);
