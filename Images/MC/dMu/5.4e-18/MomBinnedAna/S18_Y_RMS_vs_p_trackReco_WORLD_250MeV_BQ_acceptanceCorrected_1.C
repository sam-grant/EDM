void S18_Y_RMS_vs_p_trackReco_WORLD_250MeV_BQ_acceptanceCorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:47:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.5026,12.45785,3375.03,13.16512);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01138 = new TH1F("Graph_Graph01138","S18_",100,218.3787,3021.177);
   Graph_Graph01138->SetMinimum(12.52858);
   Graph_Graph01138->SetMaximum(13.09439);
