void S0_Ag2_vs_p_thetaY_trackReco_WORLD_250MeV_BQ_acceptanceCorrected.reweight_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Feb 22 00:44:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.1328,-0.3922571,3409.443,1.336432);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S0_",100,217.6843,3023.626);
   Graph_Graph01059->SetMinimum(-0.2193882);
   Graph_Graph01059->SetMaximum(1.163563);
