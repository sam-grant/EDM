void AEDMOverThetaYRMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12S18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:47:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.00471494,3407.936,0.02267745);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(-0.001975701);
   Graph_Graph01049->SetMaximum(0.01993821);
