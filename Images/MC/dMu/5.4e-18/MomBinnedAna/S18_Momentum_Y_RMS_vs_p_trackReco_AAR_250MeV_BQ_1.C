...
//=========  (Wed Dec  1 13:32:13 2021) by ROOT version 6.24/04
   ...
   c->Range(8.109012,11.75986,3231.77,23.33513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S18_",100,218.3478,3021.531);
   Graph_Graph01071->SetMinimum(12.91738);
   Graph_Graph01071->SetMaximum(22.1776);
