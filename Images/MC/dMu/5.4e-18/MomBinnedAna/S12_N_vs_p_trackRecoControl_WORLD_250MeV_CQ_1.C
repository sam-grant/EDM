void S12_N_vs_p_trackRecoControl_WORLD_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Dec 14 16:27:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-389.9078,-392712.8,3509.17,1454330);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S12_",100,0,3088.378);
   Graph_Graph01107->SetMinimum(-208008.5);
   Graph_Graph01107->SetMaximum(1269626);
   ...
   Graph_Graph01107->GetXaxis()->SetRange(1,101);
   ...
   Graph_Graph01107->GetYaxis()->SetTitle("Positrons / 250 MeV");
