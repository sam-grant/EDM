void S0_AEDM_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(490.571,0.03180072,3001.368,0.3039259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","S0_",100,0,3090.211);
   Graph_Graph01036->SetMinimum(0.05901325);
   Graph_Graph01036->SetMaximum(0.2767134);
   ...
   Graph_Graph01036->GetXaxis()->SetRange(25,89);
