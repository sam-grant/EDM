void S0_eAEDM_vs_p_trackTruth_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:32:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522.1561,-0.1297843,2726.815,1.361091);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S0_",100,0,3094.258);
   Graph_Graph01032->SetMinimum(0.01930329);
   Graph_Graph01032->SetMaximum(1.212004);
   ...
   Graph_Graph01032->GetXaxis()->SetRange(25,81);
