void c_vs_p_A_allDecays_WORLD_250MeV_AQ_accCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 18:17:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-6.335841e-07,3407.936,1.298049e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01038->SetMinimum(-5.572452e-07);
   Graph_Graph01038->SetMaximum(5.346603e-08);
