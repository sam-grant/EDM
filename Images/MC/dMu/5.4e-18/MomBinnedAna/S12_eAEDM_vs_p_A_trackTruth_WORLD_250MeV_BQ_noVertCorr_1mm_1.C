...
//=========  (Wed Apr  6 12:54:47 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0708,-4.452599e-06,3379.415,4.073098e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,217.4529,3024.967);
   Graph_Graph01105->SetMinimum(6.575881e-08);
   Graph_Graph01105->SetMaximum(3.621262e-05);
