void AEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_0()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May 29 17:08:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.03329062,3407.936,0.5004492);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01036->SetMinimum(0.02008336);
   Graph_Graph01036->SetMaximum(0.4470752);
