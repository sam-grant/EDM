void S18_Ag2_vs_p_trackTruth_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:38:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.9126,-0.3277341,2745.365,0.9274808);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S18_",100,218.1061,3026.171);
   Graph_Graph01047->SetMinimum(-0.2022126);
   Graph_Graph01047->SetMaximum(0.8019593);
