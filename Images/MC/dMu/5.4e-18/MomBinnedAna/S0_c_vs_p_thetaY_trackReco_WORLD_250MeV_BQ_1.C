...
//=========  (Mon Mar 21 12:27:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.1328,-1.548902,3409.443,0.2466521);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,217.6843,3023.626);
   Graph_Graph01057->SetMinimum(-1.369347);
   Graph_Graph01057->SetMaximum(0.06709663);
