...
//=========  (Fri Mar 25 02:59:04 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.6244,-1.631119,3377.861,6.700618);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,217.6834,3023.612);
   Graph_Graph01057->SetMinimum(-0.797945);
   Graph_Graph01057->SetMaximum(5.867445);
