void S12_thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 13:12:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,6.215366,3407.936,219.8826);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(27.58209);
   Graph_Graph01059->SetMaximum(198.5159);
