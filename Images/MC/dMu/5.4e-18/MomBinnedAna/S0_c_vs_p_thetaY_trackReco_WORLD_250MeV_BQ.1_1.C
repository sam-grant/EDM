void S0_c_vs_p_thetaY_trackReco_WORLD_250MeV_BQ.1_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:32:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.4604,-0.6420387,3409.867,0.4220327);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,217.4377,3023.969);
   Graph_Graph01057->SetMinimum(-0.5356316);
   Graph_Graph01057->SetMaximum(0.3156255);
