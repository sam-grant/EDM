...
//=========  (Wed Apr  6 12:54:55 2022) by ROOT version 6.24/06
   ...
   c->Range(-164.8222,-5.367729e-06,3380.472,4.899127e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,217.7887,3025.942);
   Graph_Graph01142->SetMinimum(6.817104e-08);
   Graph_Graph01142->SetMaximum(4.355537e-05);
