void S18_eAEDM_vs_p_A_trackTruth_WORLD_250MeV_BQ_noVertCorr_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 18:52:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-161.878,-1.130677e-05,3351.747,0.0001033728);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,217.5936,3028.494);
   Graph_Graph01142->SetMinimum(1.611866e-07);
   Graph_Graph01142->SetMaximum(9.19048e-05);
   ...
   Graph_Graph01142->GetXaxis()->SetRange(0,99);
