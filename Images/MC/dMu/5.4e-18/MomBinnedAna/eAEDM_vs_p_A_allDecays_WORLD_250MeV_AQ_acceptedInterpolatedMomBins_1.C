void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_acceptedInterpolatedMomBins_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Mar 18 14:19:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-1.390225e-08,3548.544,1.354161e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","",100,0,3123.031);
   Graph_Graph01046->SetMinimum(1.029583e-09);
   Graph_Graph01046->SetMaximum(1.204842e-07);
   ...
   Graph_Graph01046->GetXaxis()->SetRange(1,101);
