void theta_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 12:17:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-12.93462,3407.936,153.1362);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","",100,0,3122.965);
   Graph_Graph01041->SetMinimum(3.672467);
   Graph_Graph01041->SetMaximum(136.5291);
   ...
   Graph_Graph01041->GetXaxis()->SetRange(1,97);
