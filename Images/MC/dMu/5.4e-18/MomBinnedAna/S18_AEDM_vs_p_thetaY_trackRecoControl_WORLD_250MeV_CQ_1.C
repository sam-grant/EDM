...
//=========  (Tue Dec 14 16:27:40 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.784,-0.3028024,3508.056,0.2711419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01138 = new TH1F("Graph_Graph01138","S18_",100,0,3087.398);
   Graph_Graph01138->SetMinimum(-0.245408);
   Graph_Graph01138->SetMaximum(0.2137475);
