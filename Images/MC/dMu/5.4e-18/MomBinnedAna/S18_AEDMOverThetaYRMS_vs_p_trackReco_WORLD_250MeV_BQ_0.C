...
//=========  (Mon May  9 12:58:54 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.5383,-0.01058124,3375.034,0.0356806);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01145->SetMinimum(-0.00595506);
   Graph_Graph01145->SetMaximum(0.03105442);
