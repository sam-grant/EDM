...
//=========  (Thu Nov 18 11:36:07 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4809,-181024.6,2741.168,1813478);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12S18_",100,218.1451,3021.503);
   Graph_Graph01061->SetMinimum(18425.7);
   Graph_Graph01061->SetMaximum(1614028);
