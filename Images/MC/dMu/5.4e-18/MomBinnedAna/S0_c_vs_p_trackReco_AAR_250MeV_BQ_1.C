...
//=========  (Thu Nov 18 15:57:48 2021) by ROOT version 6.24/04
   ...
   c->Range(498.2736,-0.00031528,2743.039,0.00037993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S0_",100,217.6779,3023.635);
   Graph_Graph01025->SetMinimum(-0.000245759);
   Graph_Graph01025->SetMaximum(0.0003104089);
