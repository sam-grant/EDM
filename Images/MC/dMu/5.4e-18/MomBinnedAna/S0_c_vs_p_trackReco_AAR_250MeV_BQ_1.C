...
//=========  (Thu Nov 18 11:30:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.2748,-1.772175,2743.039,7.281861);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S0_",100,217.6794,3023.634);
   Graph_Graph01025->SetMinimum(-0.8667717);
   Graph_Graph01025->SetMaximum(6.376457);
