void S12_c_vs_p_thetaY_trackReco_WORLD_250MeV_BQ_noVertCorr_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr  5 16:33:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.1786,-2.133074,3375.742,6.549306);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01094 = new TH1F("Graph_Graph01094","S12_",100,217.8525,3021.75);
   Graph_Graph01094->SetMinimum(-1.264836);
   Graph_Graph01094->SetMaximum(5.681068);
