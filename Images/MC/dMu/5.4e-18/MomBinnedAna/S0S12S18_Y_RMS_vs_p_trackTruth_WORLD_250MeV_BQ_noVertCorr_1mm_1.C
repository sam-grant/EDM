...
//=========  (Wed Apr  6 12:55:10 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.0369,12.29809,3380.183,13.02274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01212 = new TH1F("Graph_Graph01212","S0S12S18_",100,217.5661,3025.661);
   Graph_Graph01212->SetMinimum(12.37055);
   Graph_Graph01212->SetMaximum(12.95027);
