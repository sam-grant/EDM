...
//=========  (Tue Dec 14 16:33:15 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,-0.422844,3411.922,1.448061);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S0_",100,219.0854,3025.975);
   Graph_Graph01059->SetMinimum(-0.2357536);
   Graph_Graph01059->SetMaximum(1.26097);
