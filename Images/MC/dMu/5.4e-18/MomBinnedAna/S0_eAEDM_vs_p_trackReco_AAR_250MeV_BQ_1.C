void S0_eAEDM_vs_p_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 15:57:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.2736,-7.563678e-06,2743.039,6.983747e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S0_",100,217.6779,3023.635);
   Graph_Graph01032->SetMinimum(1.764375e-07);
   Graph_Graph01032->SetMaximum(6.209735e-05);
