void S0S12S18_c_vs_p_A_trackTruth_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:38:56 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.121727,-0.0001476635,3237.191,0.0001307888);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01094 = new TH1F("Graph_Graph01094","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01094->SetMinimum(-0.0001198183);
   Graph_Graph01094->SetMaximum(0.0001029435);
