void S12S18_AEDMOverMaxDiff_vs_p_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
...
//=========  (Wed Apr 13 12:27:15 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01185 = new TH1F("Graph_Graph01185","S12S18_",100,0,3051.523);
   Graph_Graph01185->SetMinimum(-inf);
   Graph_Graph01185->SetMaximum(inf);
   ...
   Graph_Graph01185->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01185->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX} / 250 MeV");
