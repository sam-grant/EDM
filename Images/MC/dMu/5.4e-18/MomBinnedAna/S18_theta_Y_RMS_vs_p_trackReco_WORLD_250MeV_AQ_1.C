...
//=========  (Thu Nov 18 11:29:49 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6846,-5.881581,2724.353,59.67374);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S18_",100,0,3091.465);
   Graph_Graph01048->SetMinimum(0.6739509);
   Graph_Graph01048->SetMaximum(53.1182);
