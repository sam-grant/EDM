void S0_Y_RMS_vs_p_trackReco_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:15:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.4822,9.896036,3337.749,27.80903);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S0_",100,0,3094.089);
   Graph_Graph01042->SetMinimum(11.68734);
   Graph_Graph01042->SetMaximum(26.01773);
   ...
   Graph_Graph01042->GetXaxis()->SetRange(2,96);
