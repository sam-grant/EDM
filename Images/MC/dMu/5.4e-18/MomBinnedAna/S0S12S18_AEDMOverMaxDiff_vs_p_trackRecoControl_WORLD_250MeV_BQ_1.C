...
//=========  (Tue Dec 14 16:33:33 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.8117,-0.006856287,3411.006,0.01183898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01218 = new TH1F("Graph_Graph01218","S0S12S18_",100,219.0314,3025.163);
   Graph_Graph01218->SetMinimum(-0.00498676);
   Graph_Graph01218->SetMaximum(0.009969453);
