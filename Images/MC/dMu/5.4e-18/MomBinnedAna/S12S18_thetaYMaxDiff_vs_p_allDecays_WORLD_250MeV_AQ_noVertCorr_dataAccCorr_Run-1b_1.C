void S12S18_thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1b_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:15:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-11.27593,3407.936,223.3809);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01137 = new TH1F("Graph_Graph01137","S12S18_",100,0,3122.965);
   Graph_Graph01137->SetMinimum(12.18975);
   Graph_Graph01137->SetMaximum(199.9152);
   ...
   Graph_Graph01137->GetXaxis()->SetRange(1,97);
   ...
   Graph_Graph01137->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad] / 250 MeV");
