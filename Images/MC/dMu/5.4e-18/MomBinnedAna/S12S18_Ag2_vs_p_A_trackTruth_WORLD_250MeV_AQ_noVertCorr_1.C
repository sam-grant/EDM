void S12S18_Ag2_vs_p_A_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9369,-4.25198e-05,3392.432,0.0002107923);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,0,3108.757);
   Graph_Graph01181->SetMinimum(-1.718858e-05);
   Graph_Graph01181->SetMaximum(0.0001854611);
   ...
   Graph_Graph01181->GetXaxis()->SetRange(1,97);
