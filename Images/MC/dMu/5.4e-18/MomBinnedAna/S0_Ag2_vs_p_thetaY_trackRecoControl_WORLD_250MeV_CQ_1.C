...
//=========  (Tue Dec 14 16:27:31 2021) by ROOT version 6.24/04
   ...
   c->Range(-389.9794,-1.936531,3509.814,0.6919393);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0_",100,0,3088.946);
   Graph_Graph01061->SetMinimum(-1.673684);
   Graph_Graph01061->SetMaximum(0.4290922);
