...
//=========  (Thu Nov 18 11:32:24 2021) by ROOT version 6.24/04
   ...
   c->Range(498.9126,11.63792,2745.365,23.25691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S18_",100,218.1061,3026.171);
   Graph_Graph01050->SetMinimum(12.79982);
   Graph_Graph01050->SetMaximum(22.09501);
