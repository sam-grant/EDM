...
//=========  (Thu Nov 18 11:29:50 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6759,-0.08184544,2724.308,0.8788538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S12S18_",100,0,3091.413);
   Graph_Graph01062->SetMinimum(0.01422449);
   Graph_Graph01062->SetMaximum(0.7827839);
