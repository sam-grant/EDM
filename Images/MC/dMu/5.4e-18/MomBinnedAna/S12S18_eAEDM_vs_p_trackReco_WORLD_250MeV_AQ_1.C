void S12S18_eAEDM_vs_p_trackReco_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.08184544,2744.438,0.8788538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01052 = new TH1F("Graph_Graph01052","S12S18_",100,0,3150);
   Graph_Graph01052->SetMinimum(0.01422449);
   Graph_Graph01052->SetMaximum(0.7827839);
   ...
   Graph_Graph01052->GetXaxis()->SetRange(24,80);
