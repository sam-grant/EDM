void S12S18_c_vs_p_A_trackReco_WORLD_250MeV_BQ.0_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:32:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.314,-0.0005773088,3406.951,0.0002556514);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01171 = new TH1F("Graph_Graph01171","S12S18_",100,218.146,3021.491);
   Graph_Graph01171->SetMinimum(-0.0004940127);
   Graph_Graph01171->SetMaximum(0.0001723554);
