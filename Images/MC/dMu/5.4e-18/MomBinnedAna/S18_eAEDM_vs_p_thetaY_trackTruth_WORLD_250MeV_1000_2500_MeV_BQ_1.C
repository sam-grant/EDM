void S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_1000_2500_MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 11:05:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-164.6101,-0.01002913,3380.686,0.1563532);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01141 = new TH1F("Graph_Graph01141","S18_",100,218.0011,3026.156);
   Graph_Graph01141->SetMinimum(0.006609102);
   Graph_Graph01141->SetMaximum(0.1397149);
