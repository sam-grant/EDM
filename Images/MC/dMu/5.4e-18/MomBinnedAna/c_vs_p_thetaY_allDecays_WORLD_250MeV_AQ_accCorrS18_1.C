void c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_accCorrS18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 19 21:07:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.522911,3407.936,0.7135946);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.3992604);
   Graph_Graph01035->SetMaximum(0.589944);
