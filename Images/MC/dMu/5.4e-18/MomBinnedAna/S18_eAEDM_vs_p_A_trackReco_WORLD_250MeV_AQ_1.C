...
//=========  (Wed Jan 19 10:50:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-389.9195,-1.251675e-05,3509.275,0.0001127296);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01148 = new TH1F("Graph_Graph01148","S18_",100,0,3088.471);
   Graph_Graph01148->SetMinimum(7.885402e-09);
   Graph_Graph01148->SetMaximum(0.000100205);
   ...
   Graph_Graph01148->GetXaxis()->SetRange(1,101);
