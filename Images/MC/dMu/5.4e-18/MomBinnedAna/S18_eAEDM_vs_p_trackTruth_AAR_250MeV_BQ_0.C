...
//=========  (Thu Nov 18 11:38:17 2021) by ROOT version 6.24/04
   ...
   c->Range(498.9126,-0.01458359,2745.365,0.2283616);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01052 = new TH1F("Graph_Graph01052","S18_",100,218.1061,3026.171);
   Graph_Graph01052->SetMinimum(0.009710931);
   Graph_Graph01052->SetMaximum(0.2040671);
