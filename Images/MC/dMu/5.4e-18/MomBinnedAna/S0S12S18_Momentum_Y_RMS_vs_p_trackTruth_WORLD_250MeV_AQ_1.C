...
//=========  (Thu Oct 21 14:34:23 2021) by ROOT version 6.24/04
   ...
   c->Range(500.0625,2.442267,2744.438,26.65615);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S0S12S18_",100,0,3150);
   Graph_Graph01060->SetMinimum(4.863655);
   Graph_Graph01060->SetMaximum(24.23476);
   ...
   Graph_Graph01060->GetXaxis()->SetRange(24,80);
