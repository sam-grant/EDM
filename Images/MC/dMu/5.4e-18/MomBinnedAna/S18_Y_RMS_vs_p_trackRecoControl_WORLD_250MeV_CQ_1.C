...
//=========  (Sun Dec  5 20:08:58 2021) by ROOT version 6.24/04
   ...
   c->Range(486.2651,10.51795,3033.368,23.05061);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S18_",100,0,3087.398);
   Graph_Graph01072->SetMinimum(11.77122);
   Graph_Graph01072->SetMaximum(21.79734);
