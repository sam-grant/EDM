...
//=========  (Thu Oct 21 14:35:44 2021) by ROOT version 6.24/04
   ...
   c->Range(500.0625,-122.0715,2744.438,1322.221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","",100,0,3150);
   Graph_Graph01015->SetMinimum(22.35782);
   Graph_Graph01015->SetMaximum(1177.792);
