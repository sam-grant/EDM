...
//=========  (Fri Nov 19 17:31:49 2021) by ROOT version 6.24/04
   ...
   c->Range(7.258654,-2.033385,3236.722,6.864348);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S12S18_",100,217.8758,3026.104);
   Graph_Graph01077->SetMinimum(-1.143612);
   Graph_Graph01077->SetMaximum(5.974575);
