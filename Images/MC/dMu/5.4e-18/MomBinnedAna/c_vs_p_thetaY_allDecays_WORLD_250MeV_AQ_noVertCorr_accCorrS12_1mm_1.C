void c_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12_1mm_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Apr 25 12:17:39 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.5286912,3407.936,0.6560198);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-0.4102201);
   Graph_Graph01035->SetMaximum(0.5375487);
