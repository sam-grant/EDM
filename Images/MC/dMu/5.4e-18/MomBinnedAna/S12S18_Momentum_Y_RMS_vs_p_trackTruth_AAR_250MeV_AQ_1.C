...
//=========  (Mon Nov 22 14:13:37 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.4795,2.333655,3331.735,26.6399);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01085 = new TH1F("Graph_Graph01085","S12S18_",100,0,3092.097);
   Graph_Graph01085->SetMinimum(4.764279);
   Graph_Graph01085->SetMaximum(24.20928);
   ...
   Graph_Graph01085->GetXaxis()->SetRange(3,96);
