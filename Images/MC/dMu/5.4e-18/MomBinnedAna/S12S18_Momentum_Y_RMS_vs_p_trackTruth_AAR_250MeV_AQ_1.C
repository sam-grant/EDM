...
//=========  (Thu Nov 18 11:32:41 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7914,2.333655,2724.911,26.6399);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S12S18_",100,0,3092.097);
   Graph_Graph01060->SetMinimum(4.764279);
   Graph_Graph01060->SetMaximum(24.20928);
   ...
   Graph_Graph01060->GetXaxis()->SetRange(25,81);
