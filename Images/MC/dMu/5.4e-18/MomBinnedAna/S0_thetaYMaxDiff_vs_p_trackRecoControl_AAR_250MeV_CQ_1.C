void S0_thetaYMaxDiff_vs_p_trackRecoControl_AAR_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 16:02:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,923.3457,2744.438,1102.905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","S0_",100,0,3150);
   Graph_Graph01023->SetMinimum(941.3016);
   Graph_Graph01023->SetMaximum(1084.949);
   ...
   Graph_Graph01023->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01023->GetXaxis()->SetRange(24,80);
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
