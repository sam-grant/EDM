...
//=========  (Fri Dec  3 15:29:55 2021) by ROOT version 6.24/04
   ...
   c->Range(466.8109,-3.02042,3029.776,203.017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S12_",100,217.5362,3026.265);
   Graph_Graph01062->SetMinimum(17.58332);
   Graph_Graph01062->SetMaximum(182.4133);
