...
//=========  (Thu Nov 18 11:32:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.4117,-17.41358,2745.391,210.3898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","S12_",100,217.5394,3026.263);
   Graph_Graph01043->SetMinimum(5.366764);
   Graph_Graph01043->SetMaximum(187.6095);
