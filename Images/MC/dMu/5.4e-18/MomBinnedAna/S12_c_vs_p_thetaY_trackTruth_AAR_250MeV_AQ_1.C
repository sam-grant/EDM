void S12_c_vs_p_thetaY_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:32:08 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.5203,-6.030419,3332.186,13.10488);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12_",100,0,3092.516);
   Graph_Graph01049->SetMinimum(-4.116889);
   Graph_Graph01049->SetMaximum(11.19135);
   ...
   Graph_Graph01049->GetXaxis()->SetRange(3,96);
