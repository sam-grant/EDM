...
//=========  (Wed Dec  1 13:32:14 2021) by ROOT version 6.24/04
   ...
   c->Range(7.685561,-1.355854e-05,3232.676,3.363322e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","S0S12S18_",100,218.0111,3022.351);
   Graph_Graph01095->SetMinimum(-8.839366e-06);
   Graph_Graph01095->SetMaximum(2.891404e-05);
   ...
   Graph_Graph01095->GetYaxis()->SetTitle("A_{EDM} / 250 MeV");
