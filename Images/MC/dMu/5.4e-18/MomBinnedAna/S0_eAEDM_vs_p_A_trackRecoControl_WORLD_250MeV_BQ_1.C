...
//=========  (Tue Dec 14 16:33:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,-0.0001675468,3411.922,0.001509924);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0_",100,219.0854,3025.975);
   Graph_Graph01068->SetMinimum(2.003757e-07);
   Graph_Graph01068->SetMaximum(0.001342177);
