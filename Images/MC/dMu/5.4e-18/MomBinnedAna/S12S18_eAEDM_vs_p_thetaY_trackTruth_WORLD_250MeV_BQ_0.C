void S12S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:36:11 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(467.1062,0.008305975,3029.613,0.07128292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01090 = new TH1F("Graph_Graph01090","S12S18_",100,217.876,3026.103);
   Graph_Graph01090->SetMinimum(0.01460367);
   Graph_Graph01090->SetMaximum(0.06498522);
