...
//=========  (Sun Dec  5 19:39:16 2021) by ROOT version 6.24/04
   ...
   c->Range(467.8037,-44456.73,3028.657,404702.1);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S12_",100,218.7344,3025.149);
   Graph_Graph01059->SetMinimum(459.1602);
   Graph_Graph01059->SetMaximum(359786.2);
