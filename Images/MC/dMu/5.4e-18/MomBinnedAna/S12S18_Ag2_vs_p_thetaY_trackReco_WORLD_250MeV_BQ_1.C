...
//=========  (Mon Mar 21 12:27:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.1338,-0.2283254,3406.706,1.101686);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,218.2803,3021.292);
   Graph_Graph01170->SetMinimum(-0.09532425);
   Graph_Graph01170->SetMaximum(0.9686852);
