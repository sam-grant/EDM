void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 11:51:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,-1.002731e-07,3372.878,1.007384e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01044->SetMinimum(1.049266e-08);
   Graph_Graph01044->SetMaximum(8.966187e-07);
