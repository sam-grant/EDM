void S18_AEDMOverMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1c_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:17:21 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-0.000845247,3407.936,0.003420156);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01099->SetMinimum(-0.0004187067);
   Graph_Graph01099->SetMaximum(0.002993616);
