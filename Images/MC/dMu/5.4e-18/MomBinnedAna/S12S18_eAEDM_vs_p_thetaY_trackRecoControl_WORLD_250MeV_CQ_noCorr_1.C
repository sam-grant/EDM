void S12S18_eAEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_noCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 20:26:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.3314,0.005298013,3033.782,0.06313442);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01090 = new TH1F("Graph_Graph01090","S12S18_",100,0,3087.819);
   Graph_Graph01090->SetMinimum(0.01108165);
   Graph_Graph01090->SetMaximum(0.05735078);
