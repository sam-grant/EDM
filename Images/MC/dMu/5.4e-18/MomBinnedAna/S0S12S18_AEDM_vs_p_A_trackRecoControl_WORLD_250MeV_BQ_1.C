...
//=========  (Tue Dec 14 16:33:32 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.8117,-0.0001063971,3411.006,0.0005552788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01209 = new TH1F("Graph_Graph01209","S0S12S18_",100,219.0314,3025.163);
   Graph_Graph01209->SetMinimum(-4.022952e-05);
   Graph_Graph01209->SetMaximum(0.0004891112);
