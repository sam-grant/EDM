void S12_theta_Y_RMS_vs_p_trackTruth_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:34:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-2.691764,2744.438,41.62849);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01028 = new TH1F("Graph_Graph01028","S12_",100,0,3150);
   Graph_Graph01028->SetMinimum(1.740262);
   Graph_Graph01028->SetMaximum(37.19647);
   ...
   Graph_Graph01028->GetXaxis()->SetRange(24,80);
