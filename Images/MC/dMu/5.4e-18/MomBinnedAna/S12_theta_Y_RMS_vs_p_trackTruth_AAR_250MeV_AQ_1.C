...
//=========  (Fri Nov 19 17:32:08 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.5203,-2.691764,3332.186,41.62849);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12_",100,0,3092.516);
   Graph_Graph01055->SetMinimum(1.740262);
   Graph_Graph01055->SetMaximum(37.19647);
   ...
   Graph_Graph01055->GetXaxis()->SetRange(3,96);
