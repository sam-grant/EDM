void AEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_accepted2_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Feb 24 02:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-394.2827,-0.06171755,3548.544,0.2522867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","",100,0,3123.031);
   Graph_Graph01036->SetMinimum(-0.03031713);
   Graph_Graph01036->SetMaximum(0.2208862);
   ...
   Graph_Graph01036->GetXaxis()->SetRange(1,101);
