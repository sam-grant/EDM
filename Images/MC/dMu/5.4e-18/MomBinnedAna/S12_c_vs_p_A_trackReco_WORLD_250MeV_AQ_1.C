...
//=========  (Mon Dec  6 08:42:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-390.0171,-5.306391e-05,3510.154,0.0002287463);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01053 = new TH1F("Graph_Graph01053","S12_",100,0,3089.244);
   Graph_Graph01053->SetMinimum(-2.488288e-05);
   Graph_Graph01053->SetMaximum(0.0002005653);
   ...
   Graph_Graph01053->GetXaxis()->SetRange(1,101);
