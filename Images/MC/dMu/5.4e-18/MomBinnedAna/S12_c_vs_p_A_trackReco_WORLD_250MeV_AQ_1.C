...
//=========  (Wed Jan 19 10:50:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0171,-5.97546e-05,3510.154,0.0004897578);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S12_",100,0,3089.244);
   Graph_Graph01101->SetMinimum(-4.803353e-06);
   Graph_Graph01101->SetMaximum(0.0004348066);
