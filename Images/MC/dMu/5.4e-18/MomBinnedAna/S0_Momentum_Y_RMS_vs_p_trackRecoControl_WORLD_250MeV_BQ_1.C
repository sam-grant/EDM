...
//=========  (Tue Dec 14 16:33:16 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.862,3.114506,3411.922,29.44031);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S0_",100,219.0854,3025.975);
   Graph_Graph01065->SetMinimum(5.747086);
   Graph_Graph01065->SetMaximum(26.80773);
