void S18_thetaYMaxDiff_vs_p_trackRecoControl_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-33.49494,2750,303.6617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","S18_",100,125,3125);
   Graph_Graph01043->SetMinimum(0.2207299);
   Graph_Graph01043->SetMaximum(269.946);
   ...
   Graph_Graph01043->GetXaxis()->SetRange(21,80);
