...
//=========  (Wed Dec  8 12:36:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.5781,-2.625736e-06,3407.915,2.373193e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01216->SetMinimum(1.003017e-08);
   Graph_Graph01216->SetMaximum(2.109616e-05);
