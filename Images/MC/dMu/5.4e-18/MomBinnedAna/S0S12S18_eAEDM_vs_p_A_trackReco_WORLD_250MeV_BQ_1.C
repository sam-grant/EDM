...
//=========  (Mon Nov 22 14:11:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(7.69113,-7.069238e-07,3232.646,6.474992e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S0S12S18_",100,218.0143,3022.323);
   Graph_Graph01102->SetMinimum(1.126782e-08);
   Graph_Graph01102->SetMaximum(5.7568e-06);
