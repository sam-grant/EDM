...
//=========  (Wed Jan 19 10:50:29 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.0171,-1254842,3510.154,3626251);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S12_",100,0,3089.244);
   Graph_Graph01107->SetMinimum(-766732.6);
   Graph_Graph01107->SetMaximum(3138142);
