void thetaYMaxDiff_vs_p_allDecays_WORLD_250MeV_AQ_accCorrS18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 19 21:07:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-117.6759,3407.936,1321.257);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(26.21734);
   Graph_Graph01047->SetMaximum(1177.363);
