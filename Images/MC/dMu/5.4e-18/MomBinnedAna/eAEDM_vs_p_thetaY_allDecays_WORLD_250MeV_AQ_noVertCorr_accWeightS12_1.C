void eAEDM_vs_p_thetaY_allDecays_WORLD_250MeV_AQ_noVertCorr_accWeightS12_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 11:51:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-267.371,0.005414938,3372.878,0.02846511);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","",100,126.3702,3098.002);
   Graph_Graph01043->SetMinimum(0.007719955);
   Graph_Graph01043->SetMaximum(0.02616009);
   ...
   Graph_Graph01043->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
