void S12_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_AQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:26:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-376.9979,-0.1375857,3392.981,1.304889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01108 = new TH1F("Graph_Graph01108","S12_",100,0,3109.261);
   Graph_Graph01108->SetMinimum(0.006661777);
   Graph_Graph01108->SetMaximum(1.160641);
   ...
   Graph_Graph01108->GetXaxis()->SetRange(1,97);
