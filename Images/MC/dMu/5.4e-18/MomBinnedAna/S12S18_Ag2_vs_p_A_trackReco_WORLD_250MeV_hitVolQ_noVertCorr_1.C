void S12S18_Ag2_vs_p_A_trackReco_WORLD_250MeV_hitVolQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon May 30 19:38:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.3528,-1.098412e-05,3405.175,7.836396e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18_",100,0,3088.594);
   Graph_Graph01181->SetMinimum(-9.102066e-06);
   Graph_Graph01181->SetMaximum(5.954345e-06);
