...
//=========  (Tue Feb 22 00:12:18 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.0438,-8.710969e-06,3406.65,7.865488e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,218.3546,3021.252);
   Graph_Graph01142->SetMinimum(2.561668e-08);
   Graph_Graph01142->SetMaximum(6.99183e-05);
