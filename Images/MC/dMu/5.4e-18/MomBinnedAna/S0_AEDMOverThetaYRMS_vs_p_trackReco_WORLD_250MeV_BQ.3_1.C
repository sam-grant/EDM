void S0_AEDMOverThetaYRMS_vs_p_trackReco_WORLD_250MeV_BQ.3_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:34:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-168.1412,-0.05580267,3409.454,0.02446497);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S0_",100,217.6779,3023.635);
   Graph_Graph01071->SetMinimum(-0.04777591);
   Graph_Graph01071->SetMaximum(0.01643821);
