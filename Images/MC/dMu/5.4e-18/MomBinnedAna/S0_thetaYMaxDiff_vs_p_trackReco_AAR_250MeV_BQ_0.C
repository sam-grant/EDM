...
//=========  (Fri Nov 19 17:36:07 2021) by ROOT version 6.24/04
   ...
   c->Range(7.267965,-18.48567,3234.092,228.6154);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S0_",100,217.713,3023.647);
   Graph_Graph01047->SetMinimum(6.224436);
   Graph_Graph01047->SetMaximum(203.9053);
