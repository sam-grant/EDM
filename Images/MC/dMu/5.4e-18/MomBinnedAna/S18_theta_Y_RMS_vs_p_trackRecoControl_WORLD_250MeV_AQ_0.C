void S18_theta_Y_RMS_vs_p_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:36:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-2.319901,2750,40.59786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S18_",100,125,3125);
   Graph_Graph01038->SetMinimum(1.971875);
   Graph_Graph01038->SetMaximum(36.30608);
   ...
   Graph_Graph01038->GetXaxis()->SetRange(21,80);
