void S12S18_Ag2_vs_p_thetaY_trackReco_WORLD_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:28:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1912,-0.5393198,3334.862,2.02863);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01079 = new TH1F("Graph_Graph01079","S12S18_",100,0,3091.413);
   Graph_Graph01079->SetMinimum(-0.2825248);
   Graph_Graph01079->SetMaximum(1.771835);
   ...
   Graph_Graph01079->GetXaxis()->SetRange(2,96);
