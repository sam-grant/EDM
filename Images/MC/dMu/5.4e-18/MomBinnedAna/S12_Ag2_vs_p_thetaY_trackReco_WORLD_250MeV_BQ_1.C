...
//=========  (Mon Mar 21 12:27:19 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3594,-0.1342748,3407.009,0.8492576);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S12_",100,218.1118,3021.538);
   Graph_Graph01096->SetMinimum(-0.03592154);
   Graph_Graph01096->SetMaximum(0.7509043);
