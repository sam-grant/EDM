void S0S12S18_eAEDM_vs_p_thetaY_trackTruth_WORLD_250MeV_BQ_noVertCorr_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 13 12:27:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-377.6585,-5.238213,3398.926,47.24475);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01221 = new TH1F("Graph_Graph01221","S0S12S18_",100,0,3051.786);
   Graph_Graph01221->SetMinimum(0.01008362);
   Graph_Graph01221->SetMaximum(41.99645);
   ...
   Graph_Graph01221->GetXaxis()->SetRange(1,99);
   ...
   Graph_Graph01221->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 250 MeV");
