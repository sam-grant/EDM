...
//=========  (Fri Nov 19 17:31:26 2021) by ROOT version 6.24/04
   ...
   c->Range(-301.4644,11.7573,3331.568,13.14964);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S18_",100,0,3091.942);
   Graph_Graph01070->SetMinimum(11.89654);
   Graph_Graph01070->SetMaximum(13.01041);
   ...
   Graph_Graph01070->GetXaxis()->SetRange(3,96);
