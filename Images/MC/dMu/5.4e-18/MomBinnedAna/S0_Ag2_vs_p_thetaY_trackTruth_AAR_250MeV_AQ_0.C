void S0_Ag2_vs_p_thetaY_trackTruth_AAR_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:18:20 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-301.6902,-11.11225,3334.064,2.348921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S0_",100,0,3094.258);
   Graph_Graph01037->SetMinimum(-9.766135);
   Graph_Graph01037->SetMaximum(1.002803);
   ...
   Graph_Graph01037->GetXaxis()->SetRange(3,96);
