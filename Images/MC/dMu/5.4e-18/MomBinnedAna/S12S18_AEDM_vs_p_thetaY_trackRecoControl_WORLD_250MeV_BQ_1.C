...
//=========  (Tue Dec 14 16:33:27 2021) by ROOT version 6.24/04
   ...
   c->Range(-166.9196,-1.944849,3410.609,1.220864);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01169 = new TH1F("Graph_Graph01169","S12S18_",100,218.8923,3024.797);
   Graph_Graph01169->SetMinimum(-1.628278);
   Graph_Graph01169->SetMaximum(0.904293);
