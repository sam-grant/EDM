void S12S18_AEDMOverMaxDiff_vs_p_trackReco_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct 21 14:33:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500.0625,-0.0002265677,2744.438,0.002592349);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S12S18_",100,0,3150);
   Graph_Graph01054->SetMinimum(5.532404e-05);
   Graph_Graph01054->SetMaximum(0.002310458);
   ...
   Graph_Graph01054->GetXaxis()->SetRange(24,80);
