void S12S18_Momentum_Y_RMS_vs_p_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1a_1()
{
...
//=========  (Fri Apr  8 13:34:50 2022) by ROOT version 6.24/06
   ...
   0.01283297,
   0.01435845};
   TGraphErrors *gre = new TGraphErrors(12,Graph0_fx1133,Graph0_fy1133,Graph0_fex1133,Graph0_fey1133);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01133 = new TH1F("Graph_Graph01133","S12S18_",100,0,3122.965);
   Graph_Graph01133->SetMinimum(9.317305);
   Graph_Graph01133->SetMaximum(27.69893);
   ...
   Graph_Graph01133->GetXaxis()->SetTitle("Decay vertex momentum [MeV]#sigma_{p_{y}} [MeV] / 250 MeV");
