void eAEDM_vs_p_A_acceptedDecays_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:33:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-374.5321,-3.280583e-09,3370.788,5.221507e-08);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01022->SetMinimum(2.268983e-09);
   Graph_Graph01022->SetMaximum(4.666551e-08);
