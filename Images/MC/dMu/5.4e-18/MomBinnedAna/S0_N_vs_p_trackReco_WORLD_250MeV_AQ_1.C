...
//=========  (Thu Nov 18 11:29:49 2021) by ROOT version 6.24/04
   ...
   c->Range(522.1276,-171929.1,2726.666,1579762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","S0_",100,0,3094.089);
   Graph_Graph01031->SetMinimum(3240);
   Graph_Graph01031->SetMaximum(1404593);
