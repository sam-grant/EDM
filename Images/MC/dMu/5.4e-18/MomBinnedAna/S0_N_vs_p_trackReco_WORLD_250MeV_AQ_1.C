...
//=========  (Wed Jan 19 10:50:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-390.1392,-1258324,3511.253,3666790);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0_",100,0,3090.211);
   Graph_Graph01068->SetMinimum(-765812.4);
   Graph_Graph01068->SetMaximum(3174278);
