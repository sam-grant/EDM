...
//=========  (Thu Nov 18 11:37:40 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4117,-0.002228534,2745.391,0.008366103);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S12_",100,217.5394,3026.263);
   Graph_Graph01044->SetMinimum(-0.00116907);
   Graph_Graph01044->SetMaximum(0.007306639);
