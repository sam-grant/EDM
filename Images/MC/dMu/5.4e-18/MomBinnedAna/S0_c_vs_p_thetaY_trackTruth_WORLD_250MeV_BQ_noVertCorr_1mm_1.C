...
//=========  (Mon Apr 25 18:51:59 2022) by ROOT version 6.24/06
   ...
   c->Range(-165.688,-1.722072,3381.841,7.150095);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,217.1641,3027.088);
   Graph_Graph01057->SetMinimum(-0.8348555);
   Graph_Graph01057->SetMaximum(6.262878);
