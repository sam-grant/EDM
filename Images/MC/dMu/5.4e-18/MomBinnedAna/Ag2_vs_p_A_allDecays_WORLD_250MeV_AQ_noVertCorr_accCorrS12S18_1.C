void Ag2_vs_p_A_allDecays_WORLD_250MeV_AQ_noVertCorr_accCorrS12S18_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Apr 28 14:47:55 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-378.6596,-5.034246e-07,3407.936,7.140767e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(-3.816744e-07);
   Graph_Graph01040->SetMaximum(5.923265e-07);
