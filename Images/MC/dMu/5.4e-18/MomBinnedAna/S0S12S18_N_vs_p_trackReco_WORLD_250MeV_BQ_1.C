...
//=========  (Mon Mar 21 12:27:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.3442,-3525281,3407.403,4963516);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01214 = new TH1F("Graph_Graph01214","S0S12S18_",100,218.1678,3021.891);
   Graph_Graph01214->SetMinimum(-2676401);
   Graph_Graph01214->SetMaximum(4114636);
