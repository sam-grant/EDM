void S12_Ag2_vs_p_A_trackRecoControl_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 15:33:10 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(486.542,-8.177332e-07,3035.096,7.231177e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12_",100,0,3089.156);
   Graph_Graph01055->SetMinimum(-1.284217e-08);
   Graph_Graph01055->SetMaximum(6.426286e-06);
