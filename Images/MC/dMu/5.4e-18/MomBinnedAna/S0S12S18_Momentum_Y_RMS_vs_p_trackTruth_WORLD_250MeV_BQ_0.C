...
//=========  (Fri Nov 19 17:38:13 2021) by ROOT version 6.24/04
   ...
   c->Range(7.121727,11.72461,3237.191,23.31019);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01099 = new TH1F("Graph_Graph01099","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01099->SetMinimum(12.88317);
   Graph_Graph01099->SetMaximum(22.15163);
