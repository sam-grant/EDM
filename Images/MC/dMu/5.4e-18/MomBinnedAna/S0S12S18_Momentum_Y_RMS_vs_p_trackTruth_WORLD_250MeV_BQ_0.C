void S0S12S18_Momentum_Y_RMS_vs_p_trackTruth_WORLD_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:37:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.6539,11.72461,2745.658,23.31019);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S0S12S18_",100,217.7784,3026.534);
   Graph_Graph01070->SetMinimum(12.88317);
   Graph_Graph01070->SetMaximum(22.15163);
