void S18_Ag2_vs_p_A_trackReco_WORLD_250MeV_BQ_acceptanceUncorrected_1()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 14:31:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-163.5026,-3.29159e-05,3375.03,2.84473e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01136 = new TH1F("Graph_Graph01136","S18_",100,218.3787,3021.177);
   Graph_Graph01136->SetMinimum(-2.677958e-05);
   Graph_Graph01136->SetMaximum(2.231098e-05);
