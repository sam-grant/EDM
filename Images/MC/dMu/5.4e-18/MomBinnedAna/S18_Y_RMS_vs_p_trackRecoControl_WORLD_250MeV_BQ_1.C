...
//=========  (Thu Nov 18 11:31:15 2021) by ROOT version 6.24/04
   ...
   c->Range(499.4358,11.97158,2744.124,14.2303);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S18_",100,218.8498,3024.71);
   Graph_Graph01049->SetMinimum(12.19746);
   Graph_Graph01049->SetMaximum(14.00443);
