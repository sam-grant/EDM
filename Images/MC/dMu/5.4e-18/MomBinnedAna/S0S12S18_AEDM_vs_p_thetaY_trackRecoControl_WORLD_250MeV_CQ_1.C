void S0S12S18_AEDM_vs_p_thetaY_trackRecoControl_WORLD_250MeV_CQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Dec 14 16:27:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-389.8815,-0.3922999,3508.933,3.832351);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,0,3088.17);
   Graph_Graph01216->SetMinimum(0.03016516);
   Graph_Graph01216->SetMaximum(3.409885);
   ...
   Graph_Graph01216->GetXaxis()->SetRange(1,101);
