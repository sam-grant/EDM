void S18_eAEDM_vs_p_A_trackReco_WORLD_250MeV_BQ.0_1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Feb  2 11:32:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-167.4911,-0.0001192067,3407.421,0.001076081);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S18_",100,218.0387,3021.891);
   Graph_Graph01142->SetMinimum(3.220637e-07);
   Graph_Graph01142->SetMaximum(0.0009565524);
