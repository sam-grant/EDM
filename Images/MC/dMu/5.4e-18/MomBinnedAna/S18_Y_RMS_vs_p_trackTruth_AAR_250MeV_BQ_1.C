...
//=========  (Mon Nov 22 14:13:55 2021) by ROOT version 6.24/04
   ...
   c->Range(7.50122,12.21861,3236.776,12.91992);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S18_",100,218.1061,3026.171);
   Graph_Graph01070->SetMinimum(12.28874);
   Graph_Graph01070->SetMaximum(12.84979);
