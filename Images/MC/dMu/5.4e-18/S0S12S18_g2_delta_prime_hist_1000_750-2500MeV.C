void S0S12S18_g2_delta_prime_hist_1000_750-2500MeV()
{
...
//=========  (Fri Dec  3 18:25:54 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","",51,-0.4805357,0.540157);
   h__10->SetBinContent(23,1);
   h__10->SetBinContent(24,43);
   h__10->SetBinContent(25,562);
   h__10->SetBinContent(26,378);
   h__10->SetBinContent(27,16);
