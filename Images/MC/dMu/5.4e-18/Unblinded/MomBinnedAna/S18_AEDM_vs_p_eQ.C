...
//=========  (Tue Mar 23 00:56:35 2021) by ROOT version 6.22/06
   ...
   c->Range(475,-0.02676554,1825,0.3506632);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03943691,
   0.0382655};
   TGraphErrors *gre = new TGraphErrors(9,Graph0_fx1006,Graph0_fy1006,Graph0_fex1006,Graph0_fey1006);
   gre->SetName("Graph0");
   gre->SetTitle("S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01006 = new TH1F("Graph_Graph01006","S18",100,610,1690);
   Graph_Graph01006->SetMinimum(0.01097734);
   Graph_Graph01006->SetMaximum(0.3129204);
