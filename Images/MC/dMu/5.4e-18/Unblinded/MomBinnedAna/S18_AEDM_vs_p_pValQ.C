...
//=========  (Tue Mar 23 14:07:10 2021) by ROOT version 6.22/06
   ...
   0.0405376,
   0.08226475};
   TGraphErrors *gre = new TGraphErrors(30,Graph0_fx1016,Graph0_fy1016,Graph0_fex1016,Graph0_fey1016);
   gre->SetName("Graph0");
   gre->SetTitle("S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","S18",100,0,3300);
   Graph_Graph01016->SetMinimum(-3.066221);
   Graph_Graph01016->SetMaximum(1.352874);
