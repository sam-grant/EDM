...
//=========  (Tue Mar 23 12:42:25 2021) by ROOT version 6.22/06
   ...
   0.02350508,
   0.0543949};
   TGraphErrors *gre = new TGraphErrors(30,Graph0_fx1003,Graph0_fy1003,Graph0_fex1003,Graph0_fey1003);
   gre->SetName("Graph0");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01003 = new TH1F("Graph_Graph01003","S12",100,0,3300);
   Graph_Graph01003->SetMinimum(-10.16574);
   Graph_Graph01003->SetMaximum(2.97161);
