...
//=========  (Fri Oct 22 00:43:02 2021) by ROOT version 6.24/04
   ...
   Graph_Graph1001->SetMinimum(0.6340921);
   Graph_Graph1001->SetMaximum(3.503346);
   ...
   Graph_Graph1001->GetYaxis()->SetTitle("#delta'_{EDM} [mrad]");
   ...
   pol01002->SetChisquare(4.210366);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,1.938716);
   pol01002->SetParError(0,0.1421075);
