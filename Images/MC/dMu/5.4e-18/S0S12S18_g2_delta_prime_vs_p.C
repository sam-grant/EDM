...
//=========  (Fri Oct 22 00:43:05 2021) by ROOT version 6.24/04
   ...
   Graph_Graph1019->SetMinimum(-1.330843);
   Graph_Graph1019->SetMaximum(1.091569);
   ...
   Graph_Graph1019->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125");
   ...
   pol01020->SetChisquare(8.761961);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,-0.04835224);
   pol01020->SetParError(0,0.08346675);
