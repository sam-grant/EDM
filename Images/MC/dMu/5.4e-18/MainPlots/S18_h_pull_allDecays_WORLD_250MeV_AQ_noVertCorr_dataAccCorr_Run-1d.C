void S18_h_pull_allDecays_WORLD_250MeV_AQ_noVertCorr_dataAccCorr_Run-1d()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:17:37 2022) by ROOT version 6.24/06
   ...
   TH1D *S18_edmFit_pull__2 = new TH1D("S18_edmFit_pull__2","S18_",40,-5,5);
   S18_edmFit_pull__2->SetBinContent(9,1);
   S18_edmFit_pull__2->SetBinContent(11,1);
   S18_edmFit_pull__2->SetBinContent(16,2);
   S18_edmFit_pull__2->SetBinContent(17,3);
   S18_edmFit_pull__2->SetBinContent(18,1);
   S18_edmFit_pull__2->SetBinContent(19,5);
   S18_edmFit_pull__2->SetBinContent(20,2);
   S18_edmFit_pull__2->SetBinContent(21,3);
   S18_edmFit_pull__2->SetBinContent(22,3);
   S18_edmFit_pull__2->SetBinContent(23,1);
   S18_edmFit_pull__2->SetBinContent(25,4);
   S18_edmFit_pull__2->SetBinContent(27,1);
   S18_edmFit_pull__2->SetBinContent(29,1);
   S18_edmFit_pull__2->SetBinContent(31,1);
