void h_pull_allDecays_WORLD_250MeV_AQ_accCorrS18()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 19 21:07:14 2022) by ROOT version 6.24/06
   ...
   edmFit_pull__1->SetBinContent(11,1);
   edmFit_pull__1->SetBinContent(15,1);
   edmFit_pull__1->SetBinContent(17,2);
   edmFit_pull__1->SetBinContent(18,4);
   edmFit_pull__1->SetBinContent(19,2);
   edmFit_pull__1->SetBinContent(20,3);
   edmFit_pull__1->SetBinContent(21,2);
   edmFit_pull__1->SetBinContent(22,6);
   edmFit_pull__1->SetBinContent(23,2);
   edmFit_pull__1->SetBinContent(24,2);
   edmFit_pull__1->SetBinContent(28,1);
   edmFit_pull__1->SetBinContent(29,2);
