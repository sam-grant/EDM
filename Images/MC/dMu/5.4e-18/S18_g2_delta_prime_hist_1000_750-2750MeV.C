...
//=========  (Fri Dec  3 18:46:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__8 = new TH1D("h__8","",51,-0.306842,0.7261413);
   h__8->SetBinContent(22,11);
   h__8->SetBinContent(23,57);
   h__8->SetBinContent(24,256);
   h__8->SetBinContent(25,341);
   h__8->SetBinContent(26,240);
   h__8->SetBinContent(27,77);
   h__8->SetBinContent(28,18);
