...
//=========  (Fri Dec  3 18:46:55 2021) by ROOT version 6.24/04
   ...
   c->Range(447.7303,-2.835762,3045.18,3.466759);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","",100,707.4753,2785.435);
   Graph_Graph1015->SetMinimum(-2.20551);
   Graph_Graph1015->SetMaximum(2.836507);
   ...
   pol01016->SetChisquare(13.71371);
   pol01016->SetNDF(7);
   ...
   pol01016->SetParameter(0,0.1910017);
   pol01016->SetParError(0,0.141141);
