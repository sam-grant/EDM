...
//=========  (Fri Oct 22 15:45:55 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1127 = new TH1F("Graph_Graph1127","",100,725,2525);
   Graph_Graph1127->SetMinimum(-2.630588);
   Graph_Graph1127->SetMaximum(1.268141);
   ...
   Graph_Graph1127->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125");
   ...
   Graph_Graph1127->GetYaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
   ...
   pol01128->SetChisquare(8.017225);
   pol01128->SetNDF(6);
   ...
   pol01128->SetParameter(0,0.07811478);
   pol01128->SetParError(0,0.1456825);
