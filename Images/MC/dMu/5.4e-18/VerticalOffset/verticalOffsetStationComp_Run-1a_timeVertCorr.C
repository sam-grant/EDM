...
//=========  (Sun Jun 12 17:26:22 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","Run-1a",100,1004.41,2483.226);
   Graph_Graph1031->SetMinimum(-1);
   Graph_Graph1031->SetMaximum(1);
   ...
   Graph_Graph1031->GetXaxis()->SetTitle("Momentum [MeV]");
   ...
   Graph_Graph1031->GetYaxis()->SetTitle("#LT#theta_{y}#GT [mrad] / 250 MeV");
   ...
   Graph_Graph1031->GetYaxis()->SetTitleOffset(1.15);
   ...
   0.01490272,
   0.01673893};
   gre = new TGraphErrors(6,_fx1032,_fy1032,_fex1032,_fey1032);
   gre->SetName("");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph1032 = new TH1F("Graph_Graph1032","",100,1004.106,2482.917);
   Graph_Graph1032->SetMinimum(-0.5117695);
   Graph_Graph1032->SetMaximum(0.07210992);
