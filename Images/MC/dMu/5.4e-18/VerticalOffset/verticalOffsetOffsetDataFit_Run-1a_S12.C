void verticalOffsetOffsetDataFit_Run-1a_S12()
{
...
//=========  (Wed Apr  6 16:18:25 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,979.6514,2755.567);
   ...
   TH1F *Graph_Graph_Graph10011003 = new TH1F("Graph_Graph_Graph10011003","S12",100,979.6514,2755.567);
   Graph_Graph_Graph10011003->SetMinimum(-0.55);
   Graph_Graph_Graph10011003->SetMaximum(0);
   Graph_Graph_Graph10011003->SetDirectory(0);
   Graph_Graph_Graph10011003->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph_Graph10011003->SetLineColor(ci);
   Graph_Graph_Graph10011003->GetXaxis()->SetTitle("Decay vertex momentum [MeV]");
   Graph_Graph_Graph10011003->GetXaxis()->CenterTitle(true);
   Graph_Graph_Graph10011003->GetXaxis()->SetLabelFont(42);
   Graph_Graph_Graph10011003->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph_Graph10011003->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph_Graph10011003->GetXaxis()->SetTitleFont(42);
   Graph_Graph_Graph10011003->GetYaxis()->SetTitle("#LT#theta_{y}#GT [mrad] / 250 MeV");
   Graph_Graph_Graph10011003->GetYaxis()->CenterTitle(true);
   Graph_Graph_Graph10011003->GetYaxis()->SetNdivisions(4000510);
   Graph_Graph_Graph10011003->GetYaxis()->SetLabelFont(42);
   Graph_Graph_Graph10011003->GetYaxis()->SetTitleSize(0.04);
   Graph_Graph_Graph10011003->GetYaxis()->SetTitleOffset(1.15);
   ...
   fit1004->SetParameter(0,-0.7633339);
   fit1004->SetParError(0,0.02237659);
   fit1004->SetParLimits(0,0,0);
   fit1004->SetParameter(1,0.0003514854);
   fit1004->SetParError(1,1.19508e-05);
   ...
   fit1006->SetParameter(0,-0.7633339);
   fit1006->SetParError(0,0.02237659);
   fit1006->SetParLimits(0,0,0);
   fit1006->SetParameter(1,0.0003514854);
   fit1006->SetParError(1,1.19508e-05);
