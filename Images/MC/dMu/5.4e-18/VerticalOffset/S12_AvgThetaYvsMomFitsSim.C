void S12_AvgThetaYvsMomFitsSim()
{
//=========Macro generated from canvas: c/
//=========  (Thu Apr  7 12:12:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "",0,0,800,600);
   c->Range(750.1979,-0.6125,2987.57,0.0125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TF1 *fit1002 = new TF1("fit","[0]+[1]*x",1123.093,2614.683, TF1::EAddToList::kNo);
   ...
   TF1 *fit1004 = new TF1("fit","[0]+[1]*x",1123.093,2614.683, TF1::EAddToList::kNo);
   ...
   TF1 *fit1005 = new TF1("fit","[0]+[1]*x",1123.093,2614.683, TF1::EAddToList::kNo);
   ...
   TF1 *fit1006 = new TF1("fit","[0]+[1]*x",1123.093,2614.683, TF1::EAddToList::kNo);
