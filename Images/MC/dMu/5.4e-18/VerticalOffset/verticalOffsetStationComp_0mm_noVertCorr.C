...
//=========  (Wed Apr  6 15:51:50 2022) by ROOT version 6.24/06
   ...
   c->Range(446.464,-1.25,3048.056,1.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","0 mm",100,706.6233,2787.897);
   ...
   TH1F *Graph_Graph1020 = new TH1F("Graph_Graph1020","",100,707.359,2785.856);
   Graph_Graph1020->SetMinimum(-0.4007586);
   Graph_Graph1020->SetMaximum(-0.01188905);
