...
//=========  (Wed Apr  6 16:10:38 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1009->SetMinimum(0.0002093146);
   Graph_Graph1009->SetMaximum(0.0002907618);
   ...
   fit1010->SetChisquare(5.054987e-17);
   fit1010->SetNDF(0);
   ...
   fit1010->SetParameter(1,3.029378e-05);
   fit1010->SetParError(1,2.673536e-05);
