void verticalOffsetSlope_S18()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr  6 16:10:38 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(-1.625,3.25e-05,0.625,0.0002075);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph2 = new TH1F("Graph_Graph2","",100,-1.4,0.4);
   Graph_Graph2->SetMinimum(5e-05);
   ...
   Graph_Graph1011->SetMinimum(7.833451e-05);
   Graph_Graph1011->SetMaximum(0.0001603005);
   Graph_Graph1011->SetDirectory(0);
   Graph_Graph1011->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_Graph1011->SetLineColor(ci);
   Graph_Graph1011->GetXaxis()->SetRange(0,101);
   ...
   fit1012->SetChisquare(1.834978e-23);
   fit1012->SetNDF(0);
   ...
   fit1012->SetParameter(0,0.0001324632);
   fit1012->SetParError(0,2.100683e-05);
   fit1012->SetParLimits(0,0,0);
   fit1012->SetParameter(1,2.595936e-05);
   fit1012->SetParError(1,2.994379e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   pt_LaTex = pt->AddText("0.00013
#pm2e-05
");
   pt_LaTex = pt->AddText("2.6e-05
#pm2.99e-05
");
   pt->Draw();
   c->Modified();
