void verticalOffsetSlopeSim_S18()
{
...
//=========  (Wed Apr  6 21:29:24 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1011->SetMinimum(0.0001083478);
   Graph_Graph1011->SetMaximum(0.0001731723);
   ...
   fit1012->SetChisquare(3.728419e-24);
   fit1012->SetNDF(0);
   ...
   fit1012->SetParError(0,1.700837e-05);
