void verticalOffsetOffsetSimFit_S12()
{
...
//=========  (Wed Apr  6 16:10:37 2022) by ROOT version 6.24/06
   ...
   TF1 *fit1002 = new TF1("fit","[0]+[1]*x",1123.093,2614.675, TF1::EAddToList::kNo);
   ...
   TF1 *fit1004 = new TF1("fit","[0]+[1]*x",1123.093,2614.675, TF1::EAddToList::kNo);
   ...
   fit1004->SetParameter(0,-0.7519975);
   fit1004->SetParError(0,0.03708332);
   fit1004->SetParLimits(0,0,0);
   fit1004->SetParameter(1,0.0002631003);
   fit1004->SetParError(1,2.087423e-05);
   fit1004->SetParLimits(1,0,0);
   fit1004->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1004);
   gre->Draw("p ");
   
   TF1 *fit1005 = new TF1("fit","[0]+[1]*x",1123.093,2614.675, TF1::EAddToList::kNo);
   ...
   fit1006->SetParameter(0,-0.7519975);
   fit1006->SetParError(0,0.03708332);
   fit1006->SetParLimits(0,0,0);
   fit1006->SetParameter(1,0.0002631003);
   fit1006->SetParError(1,2.087423e-05);
