void verticalOffsetOffsetFitsSim_S18()
{
...
//=========  (Wed Apr  6 21:29:24 2022) by ROOT version 6.24/06
   ...
   TF1 *fit1006 = new TF1("fit","[0]+[1]*x",973.9221,2762.277, TF1::EAddToList::kNo);
   fit1006->SetFillColor(19);
   fit1006->SetFillStyle(0);
   fit1006->SetLineWidth(2);
   fit1006->SetChisquare(9.720452);
   fit1006->SetNDF(5);
   ...
   fit1006->SetParameter(0,-0.4909103);
   fit1006->SetParError(0,0.03199435);
   fit1006->SetParLimits(0,0,0);
   fit1006->SetParameter(1,0.0001507619);
   fit1006->SetParError(1,1.700837e-05);
   ...
   TF1 *fit1008 = new TF1("fit","[0]+[1]*x",973.9224,2762.364, TF1::EAddToList::kNo);
   ...
   fit1008->SetParameter(0,-0.4513216);
   fit1008->SetParError(0,0.03240857);
   fit1008->SetParLimits(0,0,0);
   fit1008->SetParameter(1,0.0001310163);
   fit1008->SetParError(1,1.726649e-05);
   fit1008->SetParLimits(1,0,0);
   fit1008->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1008);
   gre->Draw("p ");
   
   TF1 *fit1009 = new TF1("fit","[0]+[1]*x",973.9221,2762.277, TF1::EAddToList::kNo);
   fit1009->SetFillColor(19);
   fit1009->SetFillStyle(0);
   fit1009->SetLineWidth(2);
   fit1009->SetChisquare(9.720452);
   fit1009->SetNDF(5);
   ...
   fit1009->SetParameter(0,-0.4909103);
   fit1009->SetParError(0,0.03199435);
   fit1009->SetParLimits(0,0,0);
   fit1009->SetParameter(1,0.0001507619);
   fit1009->SetParError(1,1.700837e-05);
   fit1009->SetParLimits(1,0,0);
   fit1009->Draw("SAME");
   
   TF1 *fit1010 = new TF1("fit","[0]+[1]*x",973.9224,2762.364, TF1::EAddToList::kNo);
   ...
   fit1010->SetParError(1,1.726649e-05);
