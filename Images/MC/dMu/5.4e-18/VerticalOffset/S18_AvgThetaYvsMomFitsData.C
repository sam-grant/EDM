...
//=========  (Thu Apr  7 12:12:08 2022) by ROOT version 6.24/06
   ...
   TF1 *fit1022 = new TF1("fit","[0]+[1]*x",1127.34,2607.205, TF1::EAddToList::kNo);
   fit1022->SetFillColor(19);
   fit1022->SetFillStyle(0);
   fit1022->SetLineColor(4);
   fit1022->SetLineWidth(2);
   fit1022->SetChisquare(112.9027);
   fit1022->SetNDF(5);
   ...
   fit1022->SetParameter(0,-0.8497731);
   fit1022->SetParError(0,0.02333782);
   fit1022->SetParLimits(0,0,0);
   fit1022->SetParameter(1,0.000372277);
   fit1022->SetParError(1,1.261655e-05);
   fit1022->SetParLimits(1,0,0);
   fit1022->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1022);
   gre->Draw("ap");
   
   TF1 *fit1023 = new TF1("fit","[0]+[1]*x",1127.34,2607.205, TF1::EAddToList::kNo);
   fit1023->SetFillColor(19);
   fit1023->SetFillStyle(0);
   fit1023->SetLineColor(4);
   fit1023->SetLineWidth(2);
   fit1023->SetChisquare(112.9027);
   fit1023->SetNDF(5);
   ...
   fit1023->SetParameter(0,-0.8497731);
   fit1023->SetParError(0,0.02333782);
   fit1023->SetParLimits(0,0,0);
   fit1023->SetParameter(1,0.000372277);
   fit1023->SetParError(1,1.261655e-05);
   ...
   TF1 *fit1024 = new TF1("fit","[0]+[1]*x",1127.172,2607.239, TF1::EAddToList::kNo);
   ...
   fit1024->SetParameter(0,-0.7239812);
   fit1024->SetParError(0,0.01995439);
   fit1024->SetParLimits(0,0,0);
   fit1024->SetParameter(1,0.0003182685);
   fit1024->SetParError(1,1.079064e-05);
   fit1024->SetParLimits(1,0,0);
   fit1024->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1024);
   gre->Draw("p ");
   
   TF1 *fit1025 = new TF1("fit","[0]+[1]*x",1127.172,2607.239, TF1::EAddToList::kNo);
   ...
   fit1025->SetParameter(0,-0.7239812);
   fit1025->SetParError(0,0.01995439);
   fit1025->SetParLimits(0,0,0);
   fit1025->SetParameter(1,0.0003182685);
   fit1025->SetParError(1,1.079064e-05);
   ...
   TF1 *fit1026 = new TF1("fit","[0]+[1]*x",1127.304,2606.429, TF1::EAddToList::kNo);
   ...
   fit1026->SetParameter(0,-0.9497155);
   fit1026->SetParError(0,0.01653863);
   fit1026->SetParLimits(0,0,0);
   fit1026->SetParameter(1,0.0004110203);
   fit1026->SetParError(1,8.966936e-06);
   fit1026->SetParLimits(1,0,0);
   fit1026->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1026);
   gre->Draw("p ");
   
   TF1 *fit1027 = new TF1("fit","[0]+[1]*x",1127.304,2606.429, TF1::EAddToList::kNo);
   ...
   fit1027->SetParameter(0,-0.9497155);
   fit1027->SetParError(0,0.01653863);
   fit1027->SetParLimits(0,0,0);
   fit1027->SetParameter(1,0.0004110203);
   fit1027->SetParError(1,8.966936e-06);
   ...
   TF1 *fit1028 = new TF1("fit","[0]+[1]*x",1127.239,2606.768, TF1::EAddToList::kNo);
   ...
   fit1028->SetParameter(0,-1.304493);
   fit1028->SetParError(0,0.01217974);
   fit1028->SetParLimits(0,0,0);
   fit1028->SetParameter(1,0.0005499501);
   fit1028->SetParError(1,6.609242e-06);
   fit1028->SetParLimits(1,0,0);
   fit1028->SetParent(gre);
   gre->GetListOfFunctions()->Add(fit1028);
   gre->Draw("p ");
   
   TF1 *fit1029 = new TF1("fit","[0]+[1]*x",1127.239,2606.768, TF1::EAddToList::kNo);
   ...
   fit1029->SetParameter(0,-1.304493);
   fit1029->SetParError(0,0.01217974);
   fit1029->SetParLimits(0,0,0);
   fit1029->SetParameter(1,0.0005499501);
   fit1029->SetParError(1,6.609242e-06);
