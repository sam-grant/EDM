void S12S18_full_c_vs_p_trackReco_WORLD_500MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Aug 24 13:17:25 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-375.375,-2.614318,3378.375,0.4238617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01065->SetMinimum(-2.3105);
   Graph_Graph01065->SetMaximum(0.1200437);
