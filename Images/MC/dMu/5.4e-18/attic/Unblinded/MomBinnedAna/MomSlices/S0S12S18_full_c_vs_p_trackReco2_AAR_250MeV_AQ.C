void S0S12S18_full_c_vs_p_trackReco2_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Sep 30 11:44:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-2.69884,3419.625,1.831503);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01139->SetMinimum(-2.245806);
   Graph_Graph01139->SetMaximum(1.378468);
