void full_theta_Y_vs_p_truthAllDecays_AAR_200MeV_pxpz_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul  7 17:48:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.1973582,3456.75,0.07993875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(-0.1696285);
   Graph_Graph01041->SetMaximum(0.05220905);
