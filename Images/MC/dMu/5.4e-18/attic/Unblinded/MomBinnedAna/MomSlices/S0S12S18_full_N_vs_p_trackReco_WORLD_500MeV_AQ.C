void S0S12S18_full_N_vs_p_trackReco_WORLD_500MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Aug 24 13:17:31 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-375.375,-139200.6,3378.375,3235190);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01084->SetMinimum(198238.5);
   Graph_Graph01084->SetMaximum(2897751);
