void S12_full_A_vs_p_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Sep 13 15:26:38 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-1.495576,3254.625,1.314187);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01062->SetMinimum(-1.214599);
   Graph_Graph01062->SetMaximum(1.033211);
   ...
   Graph_Graph01062->GetXaxis()->SetRange(4,88);
