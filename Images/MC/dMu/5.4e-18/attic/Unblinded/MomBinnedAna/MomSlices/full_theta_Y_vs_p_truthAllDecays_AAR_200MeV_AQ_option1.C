void full_theta_Y_vs_p_truthAllDecays_AAR_200MeV_AQ_option1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 14 23:31:01 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-5.435977,3456.75,5.619678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(-4.330411);
   Graph_Graph01041->SetMaximum(4.514113);
