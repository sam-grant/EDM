void S0S12S18_full_eA_vs_p_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Sep 13 15:26:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-0.06959714,3254.625,0.7417121);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01145 = new TH1F("Graph_Graph01145","",100,0,3300);
   Graph_Graph01145->SetMinimum(0.01153379);
   Graph_Graph01145->SetMaximum(0.6605811);
   ...
   Graph_Graph01145->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01145->GetXaxis()->SetRange(4,88);
   ...
   Graph_Graph01145->GetYaxis()->SetTitle("#deltaA_{EDM}");
