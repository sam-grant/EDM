void S0S12S18_full_N_vs_p_trackReco_WORLD_200MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Aug 24 13:16:07 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-437.25,-148291.6,3605.25,1358879);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01174->SetMinimum(2425.5);
   Graph_Graph01174->SetMaximum(1208162);
   ...
   Graph_Graph01174->GetXaxis()->SetRange(0,97);
