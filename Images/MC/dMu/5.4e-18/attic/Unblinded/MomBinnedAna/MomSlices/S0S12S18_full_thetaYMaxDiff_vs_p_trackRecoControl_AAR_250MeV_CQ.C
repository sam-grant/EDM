void S0S12S18_full_thetaYMaxDiff_vs_p_trackRecoControl_AAR_250MeV_CQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 11:59:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,530.4246,3419.625,1176.343);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01146->SetMinimum(595.0165);
   Graph_Graph01146->SetMaximum(1111.751);
   ...
   Graph_Graph01146->GetXaxis()->SetRange(0,92);
