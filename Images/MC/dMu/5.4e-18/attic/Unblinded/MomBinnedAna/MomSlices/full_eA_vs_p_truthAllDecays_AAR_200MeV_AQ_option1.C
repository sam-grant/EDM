void full_eA_vs_p_truthAllDecays_AAR_200MeV_AQ_option1()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 14 23:31:01 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.291804,3456.75,3.959713);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01048->SetMinimum(0.6585949);
   Graph_Graph01048->SetMaximum(3.592922);
