...
//=========  (Wed Jul 14 15:43:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-404.25,0.003209571,3330.25,0.007736586);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01099->SetMinimum(0.003662272);
   Graph_Graph01099->SetMaximum(0.007283885);
