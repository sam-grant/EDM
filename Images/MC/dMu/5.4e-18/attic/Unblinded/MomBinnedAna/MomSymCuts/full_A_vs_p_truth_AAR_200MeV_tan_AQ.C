...
//=========  (Tue Jun 29 12:15:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2125819,8.14,0.2385862);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2151823);
   Graph_Graph01067->SetMaximum(0.2359858);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2151823,7.312,0.2151823,0.688,7.312,8,"");
