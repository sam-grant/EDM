...
//=========  (Wed Jul 14 16:34:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,-0.04768558,8.14,0.001262389);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.04279078);
   Graph_Graph01066->SetMaximum(-0.003632408);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.04279078,7.312,-0.04279078,0.688,7.312,8,"");
