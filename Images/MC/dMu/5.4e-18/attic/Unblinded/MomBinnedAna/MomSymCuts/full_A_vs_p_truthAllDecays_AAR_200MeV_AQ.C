...
//=========  (Tue Jun 22 13:08:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2333301,8.14,0.2970275);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2396998);
   Graph_Graph01067->SetMaximum(0.2906578);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2396998,7.312,0.2396998,0.688,7.312,8,"");
