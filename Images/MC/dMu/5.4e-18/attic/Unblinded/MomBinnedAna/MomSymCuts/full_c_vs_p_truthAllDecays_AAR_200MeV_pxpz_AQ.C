void full_c_vs_p_truthAllDecays_AAR_200MeV_pxpz_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul  7 17:48:15 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,-0.01167144,8.14,0.01652585);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.008851715);
   Graph_Graph01066->SetMaximum(0.01370612);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.008851715,7.312,-0.008851715,0.688,7.312,8,"");
