...
//=========  (Wed May 19 01:17:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.05136521,8.14,0.2297456);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0",100,0.4,7.6);
   Graph_Graph01058->SetMinimum(0.06920325);
   Graph_Graph01058->SetMaximum(0.2119075);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.688,0.06920325,7.312,0.06920325,0.688,7.312,8,"");
