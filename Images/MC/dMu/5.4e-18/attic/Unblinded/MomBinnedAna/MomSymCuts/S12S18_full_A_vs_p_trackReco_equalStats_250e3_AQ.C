...
//=========  (Wed May 19 01:13:20 2021) by ROOT version 6.22/08
   ...
   0.01793814,
   0.03014398};
   TGraphErrors *gre = new TGraphErrors(7,Graph0_fx1186,Graph0_fy1186,Graph0_fex1186,Graph0_fey1186);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01186 = new TH1F("Graph_Graph01186","S12S18",100,0.4,7.6);
   Graph_Graph01186->SetMinimum(0.117129);
   Graph_Graph01186->SetMaximum(0.2016391);
   ...
   Graph_Graph01186->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01186->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01186->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_Graph01186->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_Graph01186->GetXaxis()->SetBinLabel(51,"1000-2400");
   Graph_Graph01186->GetXaxis()->SetBinLabel(64,"1200-2200");
   Graph_Graph01186->GetXaxis()->SetBinLabel(78,"1400-2000");
   Graph_Graph01186->GetXaxis()->SetBinLabel(92,"1600-1800");
   Graph_Graph01186->GetXaxis()->SetRange(5,96);
   Graph_Graph01186->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph01186->GetXaxis()->SetTickLength(0);
   Graph_Graph01186->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph01186->GetXaxis()->SetTitleFont(42);
   Graph_Graph01186->GetYaxis()->SetTitle("A_{EDM} [mrad]");
