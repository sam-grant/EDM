...
//=========  (Tue Jun 22 10:12:51 2021) by ROOT version 6.22/08
   ...
   c->Range(0.62,-0.008256248,3.38,0.009436271);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(-0.006486996);
   Graph_Graph01040->SetMaximum(0.007667019);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.896,-0.006486996,3.104,-0.006486996,0.896,3.104,8,"");
