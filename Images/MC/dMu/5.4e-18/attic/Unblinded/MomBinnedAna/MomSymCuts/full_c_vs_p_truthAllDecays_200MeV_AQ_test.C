...
//=========  (Wed Jul 14 15:43:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,-0.0003615608,8.14,0.0006174167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.0002636631);
   Graph_Graph01066->SetMaximum(0.000519519);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.0002636631,7.312,-0.0002636631,0.688,7.312,8,"");
