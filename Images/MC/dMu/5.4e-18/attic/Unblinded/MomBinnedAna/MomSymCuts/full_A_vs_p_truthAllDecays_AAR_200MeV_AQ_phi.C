...
//=========  (Wed Jul 14 18:07:03 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.189054,8.14,0.327327);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2028813);
   Graph_Graph01067->SetMaximum(0.3134997);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2028813,7.312,0.2028813,0.688,7.312,8,"");
