...
//=========  (Mon Jun 21 17:01:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(250,0.004368631,3550,0.01022915);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01124->SetMinimum(0.004954683);
   Graph_Graph01124->SetMaximum(0.009643099);
