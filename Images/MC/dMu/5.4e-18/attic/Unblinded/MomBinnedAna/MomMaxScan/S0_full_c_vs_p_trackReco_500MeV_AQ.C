...
//=========  (Tue Jun 15 13:08:11 2021) by ROOT version 6.22/08
   ...
   c->Range(500,-9.607857e-12,3500,9.603603e-12);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1057[5] = {
   3000,
   2500,
   2000,
   1500,
   1000};
   Double_t Graph0_fy1057[5] = {
   -2.126864e-15,
   -2.126864e-15,
   -2.126864e-15,
   -2.126864e-15,
   -2.126864e-15};
   Double_t Graph0_fex1057[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1057[5] = {
   6.40382e-12,
   6.40382e-12,
   6.40382e-12,
   6.40382e-12,
   6.40382e-12};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1057,Graph0_fy1057,Graph0_fex1057,Graph0_fey1057);
   gre->SetName("Graph0");
   gre->SetTitle("S0");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0",100,800,3200);
   ...
   Graph_Graph01057->GetXaxis()->SetTitle("p_{max} [MeV]");
