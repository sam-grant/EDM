...
//=========  (Tue Jun 22 01:04:55 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(250,-1.33571,3550,0.3434659);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01124->SetMinimum(-1.167792);
   Graph_Graph01124->SetMaximum(0.1755484);
