...
//=========  (Fri Dec  3 18:46:56 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","",50,-0.4505908,0.5528015);
   h__10->SetBinContent(23,31);
   h__10->SetBinContent(24,483);
   h__10->SetBinContent(25,461);
   h__10->SetBinContent(26,25);
