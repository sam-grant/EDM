...
//=========  (Fri Dec  3 18:46:54 2021) by ROOT version 6.24/04
   ...
   c->Range(447.2191,0.2232509,3046.475,3.619049);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,707.1447,2786.549);
   Graph_Graph1007->SetMinimum(0.5628307);
   Graph_Graph1007->SetMaximum(3.279469);
   ...
   pol01008->SetChisquare(12.52298);
   pol01008->SetNDF(7);
   ...
   pol01008->SetParameter(0,1.590335);
   pol01008->SetParError(0,0.09825556);
