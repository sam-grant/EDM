...
//=========  (Fri Dec  3 18:22:24 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","",50,-0.5332247,0.4797762);
   h__6->SetBinContent(25,186);
   h__6->SetBinContent(26,814);
