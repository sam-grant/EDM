...
//=========  (Mon Sep 27 11:12:22 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-3.568512,3254.625,2.568787);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-2.954782);
   Graph_Graph01061->SetMaximum(1.955057);
