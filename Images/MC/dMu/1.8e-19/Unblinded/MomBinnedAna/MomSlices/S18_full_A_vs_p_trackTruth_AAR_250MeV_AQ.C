...
//=========  (Mon Sep 27 11:33:13 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-4.927187,3254.625,1.300021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01088->SetMinimum(-4.304466);
   Graph_Graph01088->SetMaximum(0.6772998);
