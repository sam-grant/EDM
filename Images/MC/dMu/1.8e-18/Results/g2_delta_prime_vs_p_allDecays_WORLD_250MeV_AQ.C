...
//=========  (Wed May  4 16:39:21 2022) by ROOT version 6.24/06
   ...
   c->Range(811.6735,-1.079227,2678.41,1.101141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,998.3471,2491.736);
   Graph_Graph1007->SetMinimum(-0.8611903);
   Graph_Graph1007->SetMaximum(0.8831042);
   ...
   Graph_Graph1007->GetYaxis()->SetTitle("#delta [mrad] / 250 MeV");
   ...
   pol01008->SetChisquare(1.568449);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,-0.008012224);
   pol01008->SetParError(0,0.02558221);
