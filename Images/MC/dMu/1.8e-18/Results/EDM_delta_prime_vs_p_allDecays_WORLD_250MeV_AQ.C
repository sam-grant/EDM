...
//=========  (Wed May  4 19:29:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(811.6735,0.05316954,2678.41,1.027819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,998.3471,2491.736);
   Graph_Graph1001->SetMinimum(0.1506345);
   Graph_Graph1001->SetMaximum(0.9303541);
   ...
   pol01002->SetChisquare(5.955261);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.5572558);
   pol01002->SetParError(0,0.02530622);
