...
//=========  (Thu Nov 18 11:33:15 2021) by ROOT version 6.24/04
   ...
   c->Range(527.0038,-0.1304318,2752.131,0.05837484);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01011 = new TH1F("Graph_Graph01011","",100,0,3122.986);
   Graph_Graph01011->SetMinimum(-0.1115511);
   Graph_Graph01011->SetMaximum(0.03949418);
