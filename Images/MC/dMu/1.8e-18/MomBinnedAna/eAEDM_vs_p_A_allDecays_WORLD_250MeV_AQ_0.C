void eAEDM_vs_p_A_allDecays_WORLD_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 19 17:39:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-409.8919,-1.206444e-08,3376.728,1.355029e-07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","",100,0,3122.986);
   Graph_Graph01022->SetMinimum(2.692297e-09);
   Graph_Graph01022->SetMaximum(1.207462e-07);
   ...
   Graph_Graph01022->GetXaxis()->SetRange(0,96);
