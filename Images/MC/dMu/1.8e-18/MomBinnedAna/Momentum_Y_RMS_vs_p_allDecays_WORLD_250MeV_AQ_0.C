...
//=========  (Fri Nov 19 17:39:04 2021) by ROOT version 6.24/04
   ...
   c->Range(-409.8919,7.023013,3376.728,29.98788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01019 = new TH1F("Graph_Graph01019","",100,0,3122.986);
   Graph_Graph01019->SetMinimum(9.3195);
   Graph_Graph01019->SetMaximum(27.69139);
