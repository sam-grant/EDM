...
//=========  (Sun Dec  5 23:23:02 2021) by ROOT version 6.24/04
   ...
   c->Range(495.7742,-0.5673189,3033.201,46.03223);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01017 = new TH1F("Graph_Graph01017","",100,0,3122.987);
   Graph_Graph01017->SetMinimum(4.092636);
   Graph_Graph01017->SetMaximum(41.37227);
