...
//=========  (Sun Dec  5 23:23:02 2021) by ROOT version 6.24/04
   ...
   c->Range(495.7742,9.90514,3033.201,16.54442);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01018 = new TH1F("Graph_Graph01018","",100,0,3122.987);
   Graph_Graph01018->SetMinimum(10.56907);
   Graph_Graph01018->SetMaximum(15.88049);
