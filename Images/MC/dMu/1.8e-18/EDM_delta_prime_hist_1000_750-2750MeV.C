...
//=========  (Sun Dec  5 23:23:32 2021) by ROOT version 6.24/04
   ...
   TH1D *h__1 = new TH1D("h__1","",51,0.05569249,1.086242);
   h__1->SetBinContent(24,2);
   h__1->SetBinContent(25,186);
   h__1->SetBinContent(26,650);
   h__1->SetBinContent(27,158);
   h__1->SetBinContent(28,4);
