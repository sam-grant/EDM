...
//=========  (Mon Nov  8 08:59:54 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","",51,-0.4015292,0.6249992);
   h__2->SetBinContent(24,1);
   h__2->SetBinContent(25,32);
   h__2->SetBinContent(26,295);
   h__2->SetBinContent(27,498);
   h__2->SetBinContent(28,159);
   h__2->SetBinContent(29,15);
