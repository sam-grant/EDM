...
//=========  (Mon Nov  8 08:59:56 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","",51,-0.3122168,0.7139124);
   h__9->SetBinContent(24,100);
   h__9->SetBinContent(25,426);
   h__9->SetBinContent(26,376);
   h__9->SetBinContent(27,92);
   h__9->SetBinContent(28,6);
