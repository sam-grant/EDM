...
//=========  (Mon Nov  8 08:59:54 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-4.818661,2843.25,4.478455);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","",100,649.5,2599.5);
   Graph_Graph1009->SetMinimum(-3.88895);
   Graph_Graph1009->SetMaximum(3.548743);
   ...
   Graph_Graph1009->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   pol01010->SetChisquare(12.48767);
   pol01010->SetNDF(13);
   ...
   pol01010->SetParameter(0,0.1198903);
   pol01010->SetParError(0,0.2116043);
