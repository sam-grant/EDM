...
//=========  (Mon Nov  8 08:59:55 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-8.574534,2843.25,7.669577);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","",100,649.5,2599.5);
   Graph_Graph1015->SetMinimum(-6.950123);
   Graph_Graph1015->SetMaximum(6.045166);
   ...
   Graph_Graph1015->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   pol01016->SetChisquare(11.97074);
   pol01016->SetNDF(13);
   ...
   pol01016->SetParameter(0,0.388403);
   pol01016->SetParError(0,0.3277256);
