void S0_eAEDM_vs_p_trackReco_AAR_125MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 08:59:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522,-0.1119367,2727,1.835266);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01018 = new TH1F("Graph_Graph01018","S0_",100,49.5,3199.5);
   Graph_Graph01018->SetMinimum(0.08278363);
   Graph_Graph01018->SetMaximum(1.640546);
   ...
   Graph_Graph01018->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62 MeV");
