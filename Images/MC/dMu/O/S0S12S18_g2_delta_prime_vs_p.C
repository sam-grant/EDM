...
//=========  (Mon Nov  8 08:59:56 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-3.371028,2843.25,5.159733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,649.5,2599.5);
   Graph_Graph1019->SetMinimum(-2.517952);
   Graph_Graph1019->SetMaximum(4.306657);
   ...
   Graph_Graph1019->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   Graph_Graph1019->GetYaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
   ...
   pol01020->SetChisquare(17.25108);
   pol01020->SetNDF(13);
   ...
   pol01020->SetParameter(0,0.1219216);
   pol01020->SetParError(0,0.1880448);
