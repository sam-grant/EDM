...
//=========  (Mon Nov  8 08:59:54 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-8.676556,2843.25,7.44014);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,649.5,2599.5);
   Graph_Graph1003->SetMinimum(-7.064886);
   Graph_Graph1003->SetMaximum(5.828471);
   ...
   Graph_Graph1003->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   pol01004->SetChisquare(10.27276);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,0.1284422);
   pol01004->SetParError(0,0.366159);
