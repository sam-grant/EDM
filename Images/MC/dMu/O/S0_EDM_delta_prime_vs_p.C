...
//=========  (Mon Nov  8 08:59:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-9.943421,2843.25,5.224291);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,649.5,2599.5);
   Graph_Graph1001->SetMinimum(-8.42665);
   Graph_Graph1001->SetMaximum(3.70752);
   ...
   Graph_Graph1001->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   pol01002->SetChisquare(8.546881);
   pol01002->SetNDF(13);
   ...
   pol01002->SetParameter(0,0.08351983);
   pol01002->SetParError(0,0.3629606);
