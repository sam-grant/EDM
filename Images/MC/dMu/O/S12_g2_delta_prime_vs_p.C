...
//=========  (Mon Nov  8 08:59:55 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-8.69691,2843.25,9.262531);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","",100,649.5,2599.5);
   Graph_Graph1013->SetMinimum(-6.900966);
   Graph_Graph1013->SetMaximum(7.466587);
   ...
   Graph_Graph1013->GetXaxis()->SetTitle("p [MeV]: in range p #minus 62 < p < p #plus 62");
   ...
   Graph_Graph1013->GetYaxis()->SetTitle("#delta'_{g#minus2} [mrad]");
   ...
   pol01014->SetChisquare(22.62618);
   pol01014->SetNDF(13);
   ...
   pol01014->SetParameter(0,-0.03527496);
   pol01014->SetParError(0,0.325655);
