...
//=========  (Mon Nov  8 08:59:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__5 = new TH1D("h__5","",51,-0.3971472,0.634601);
   h__5->SetBinContent(25,87);
   h__5->SetBinContent(26,797);
   h__5->SetBinContent(27,115);
   h__5->SetBinContent(28,1);
