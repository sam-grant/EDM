...
//=========  (Mon Nov  8 08:59:56 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","",50,-0.3848065,0.6178827);
   h__10->SetBinContent(24,1);
   h__10->SetBinContent(25,244);
   h__10->SetBinContent(26,728);
   h__10->SetBinContent(27,27);
