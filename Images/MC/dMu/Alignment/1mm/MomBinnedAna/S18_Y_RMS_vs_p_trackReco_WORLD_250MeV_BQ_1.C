...
//=========  (Mon Jan 31 18:51:52 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.7144,9.239883,3408.481,16.28984);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01138 = new TH1F("Graph_Graph01138","S18_",100,217.9537,3022.812);
   Graph_Graph01138->SetMinimum(9.944878);
   Graph_Graph01138->SetMaximum(15.58484);
