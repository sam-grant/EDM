...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-4.823804,3216.762,59.56351);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01053 = new TH1F("Graph_Graph01053","S0_",100,232.5205,2856.03);
   Graph_Graph01053->SetMinimum(1.614927);
   Graph_Graph01053->SetMaximum(53.12478);
