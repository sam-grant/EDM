...
//=========  (Mon Jan 31 18:51:56 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6841,-1.726097e-05,3407.769,0.0001558491);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18_",100,217.904,3022.181);
   Graph_Graph01179->SetMinimum(5.00452e-08);
   Graph_Graph01179->SetMaximum(0.0001385381);
