...
//=========  (Mon Jan 31 18:51:45 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4953,-5.31137,3409.331,62.31951);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S0_",100,217.3487,3023.487);
   Graph_Graph01063->SetMinimum(1.451718);
   Graph_Graph01063->SetMaximum(55.55642);
