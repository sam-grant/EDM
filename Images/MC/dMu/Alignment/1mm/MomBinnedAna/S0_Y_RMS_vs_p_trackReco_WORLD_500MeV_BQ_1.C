...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,9.289336,3216.762,16.26935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S0_",100,232.5205,2856.03);
   Graph_Graph01054->SetMinimum(9.987337);
   Graph_Graph01054->SetMaximum(15.57135);
