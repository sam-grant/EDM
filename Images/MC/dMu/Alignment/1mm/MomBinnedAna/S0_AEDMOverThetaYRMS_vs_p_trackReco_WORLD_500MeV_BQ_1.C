...
//=========  (Mon Feb  7 15:00:09 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-0.01601175,3216.762,0.02142547);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0_",100,232.5205,2856.03);
   Graph_Graph01061->SetMinimum(-0.01226802);
   Graph_Graph01061->SetMaximum(0.01768175);
