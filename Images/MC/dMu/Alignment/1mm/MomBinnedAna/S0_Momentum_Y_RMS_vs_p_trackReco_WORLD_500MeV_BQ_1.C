...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,3.898711,3216.762,28.08806);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S0_",100,232.5205,2856.03);
   Graph_Graph01055->SetMinimum(6.317646);
   Graph_Graph01055->SetMaximum(25.66913);
