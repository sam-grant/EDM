...
//=========  (Tue Feb  8 12:52:15 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8975,-35.02764,3408.879,312.0033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01143 = new TH1F("Graph_Graph01143","S18_",100,217.8334,3023.148);
   Graph_Graph01143->SetMinimum(-0.3245378);
   Graph_Graph01143->SetMaximum(277.3002);
