...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-0.1666219,3216.762,0.2760778);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S0_",100,232.5205,2856.03);
   Graph_Graph01048->SetMinimum(-0.1223519);
   Graph_Graph01048->SetMaximum(0.2318078);
