...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,-0.003674638,3407.747,0.03783775);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S12_",100,217.622,3022.128);
   Graph_Graph01107->SetMinimum(0.0004766005);
   Graph_Graph01107->SetMaximum(0.03368651);
