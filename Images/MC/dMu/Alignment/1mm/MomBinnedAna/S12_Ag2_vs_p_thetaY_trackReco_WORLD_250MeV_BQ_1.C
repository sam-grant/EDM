...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,-1.381146,3407.747,2.739684);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S12_",100,217.622,3022.128);
   Graph_Graph01096->SetMinimum(-0.9690629);
   Graph_Graph01096->SetMaximum(2.327601);
