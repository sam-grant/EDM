...
//=========  (Tue Feb  8 12:52:19 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8434,-953409.9,3408.106,1333019);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18_",100,217.7983,3022.464);
   Graph_Graph01177->SetMinimum(-724767);
   Graph_Graph01177->SetMaximum(1104376);
