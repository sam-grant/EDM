...
//=========  (Mon Feb  7 15:00:20 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.9879,-4.740931,3212.571,59.22813);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01161 = new TH1F("Graph_Graph01161","S0S12S18_",100,233.1606,2852.423);
   Graph_Graph01161->SetMinimum(1.655976);
   Graph_Graph01161->SetMaximum(52.83122);
