...
//=========  (Mon Jan 31 18:51:49 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8782,-0.04476814,3407.489,0.8720972);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","S12_",100,217.7007,3021.911);
   Graph_Graph01095->SetMinimum(0.04691839);
   Graph_Graph01095->SetMaximum(0.7804106);
