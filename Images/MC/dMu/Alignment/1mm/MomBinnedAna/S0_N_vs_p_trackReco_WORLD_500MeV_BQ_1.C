...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-1009542,3216.762,1327610);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S0_",100,232.5205,2856.03);
   Graph_Graph01056->SetMinimum(-775826.7);
   Graph_Graph01056->SetMaximum(1093895);
