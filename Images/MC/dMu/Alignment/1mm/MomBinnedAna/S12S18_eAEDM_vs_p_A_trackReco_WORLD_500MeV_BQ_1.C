...
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.3365,-7.821082e-07,3209.969,7.184033e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01139 = new TH1F("Graph_Graph01139","S12S18_",100,233.4612,2850.172);
   Graph_Graph01139->SetMinimum(1.450594e-08);
   Graph_Graph01139->SetMaximum(6.387419e-06);
