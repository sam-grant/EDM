void S12_eAEDM_vs_p_A_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8771,-2.199541e-06,3211.455,2.019314e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01085 = new TH1F("Graph_Graph01085","S12_",100,233.1391,2851.439);
   Graph_Graph01085->SetMinimum(3.972714e-08);
   Graph_Graph01085->SetMaximum(1.795387e-05);
   ...
   Graph_Graph01085->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01085->GetYaxis()->SetTitle("#deltaA_{EDM} / 500 MeV");
