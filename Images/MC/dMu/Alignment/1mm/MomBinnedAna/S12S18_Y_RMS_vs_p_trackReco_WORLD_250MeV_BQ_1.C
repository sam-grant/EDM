...
//=========  (Mon Jan 31 18:51:56 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6841,9.35096,3407.769,16.50931);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01175 = new TH1F("Graph_Graph01175","S12S18_",100,217.904,3022.181);
   Graph_Graph01175->SetMinimum(10.06679);
   Graph_Graph01175->SetMaximum(15.79347);
