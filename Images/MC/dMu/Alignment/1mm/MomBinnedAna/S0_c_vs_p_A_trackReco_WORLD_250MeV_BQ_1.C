...
//=========  (Tue Feb  8 12:52:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.5898,-7.456624e-05,3409.509,0.0006124664);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S0_",100,217.2836,3023.636);
   Graph_Graph01060->SetMinimum(-5.862974e-06);
   Graph_Graph01060->SetMaximum(0.0005437631);
