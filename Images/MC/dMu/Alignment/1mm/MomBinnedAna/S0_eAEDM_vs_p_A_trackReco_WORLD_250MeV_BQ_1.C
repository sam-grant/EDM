...
//=========  (Tue Feb  8 12:52:09 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.5898,-1.794174e-05,3409.509,0.0001624425);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0_",100,217.2836,3023.636);
   Graph_Graph01068->SetMinimum(9.668208e-08);
   Graph_Graph01068->SetMaximum(0.000144404);
