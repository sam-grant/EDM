...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,-3.196754e-05,3407.747,0.0002887297);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,217.622,3022.128);
   Graph_Graph01105->SetMinimum(1.021828e-07);
   Graph_Graph01105->SetMaximum(0.0002566599);
