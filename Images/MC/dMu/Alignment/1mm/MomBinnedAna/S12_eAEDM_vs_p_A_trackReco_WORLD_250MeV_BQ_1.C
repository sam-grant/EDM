...
//=========  (Mon Jan 31 18:51:49 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8782,-4.484608e-05,3407.489,0.0004049919);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,217.7007,3021.911);
   Graph_Graph01105->SetMinimum(1.377236e-07);
   Graph_Graph01105->SetMaximum(0.0003600081);
