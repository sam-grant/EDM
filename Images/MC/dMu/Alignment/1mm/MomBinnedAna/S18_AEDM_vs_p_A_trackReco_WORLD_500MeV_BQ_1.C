...
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,-3.716314e-05,3208.607,2.578832e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S18_",100,233.6651,2848.999);
   Graph_Graph01105->SetMinimum(-3.0868e-05);
   Graph_Graph01105->SetMaximum(1.949317e-05);
