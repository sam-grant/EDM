...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-0.05870764,3216.762,0.7092329);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,232.5205,2856.03);
   Graph_Graph01057->SetMinimum(0.01808641);
   Graph_Graph01057->SetMaximum(0.6324388);
