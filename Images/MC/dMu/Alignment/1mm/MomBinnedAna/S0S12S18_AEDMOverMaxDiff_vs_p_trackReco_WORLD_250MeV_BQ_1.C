...
//=========  (Mon Jan 31 18:52:00 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9133,-0.003212458,3408.324,0.00688781);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01218 = new TH1F("Graph_Graph01218","S0S12S18_",100,217.7594,3022.651);
   Graph_Graph01218->SetMinimum(-0.002202431);
   Graph_Graph01218->SetMaximum(0.005877783);
