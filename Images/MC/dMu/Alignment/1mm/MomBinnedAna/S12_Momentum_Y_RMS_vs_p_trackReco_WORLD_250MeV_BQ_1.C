...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,2.547677,3407.747,28.27292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S12_",100,217.622,3022.128);
   Graph_Graph01102->SetMinimum(5.120201);
   Graph_Graph01102->SetMaximum(25.70039);
