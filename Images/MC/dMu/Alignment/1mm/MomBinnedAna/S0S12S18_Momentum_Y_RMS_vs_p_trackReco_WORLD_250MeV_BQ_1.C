...
//=========  (Tue Feb  8 12:52:22 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.053,2.869489,3408.599,28.28384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01213 = new TH1F("Graph_Graph01213","S0S12S18_",100,217.6644,3022.882);
   Graph_Graph01213->SetMinimum(5.410924);
   Graph_Graph01213->SetMaximum(25.7424);
