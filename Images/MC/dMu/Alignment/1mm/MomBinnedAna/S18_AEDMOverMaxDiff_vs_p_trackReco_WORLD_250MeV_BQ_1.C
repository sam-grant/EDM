...
//=========  (Tue Feb  8 12:52:16 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8975,-0.0172876,3408.879,0.0081116);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,217.8334,3023.148);
   Graph_Graph01144->SetMinimum(-0.01474768);
   Graph_Graph01144->SetMaximum(0.00557168);
