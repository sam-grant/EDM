...
//=========  (Mon Jan 31 18:51:45 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4953,-0.4402044,3409.331,0.7672472);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,217.3487,3023.487);
   Graph_Graph01057->SetMinimum(-0.3194592);
   Graph_Graph01057->SetMaximum(0.6465021);
