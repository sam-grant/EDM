void S12S18_c_vs_p_A_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.3365,-3.249157e-05,3209.969,0.0002181393);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   1.08458e-07,
   1.009807e-06};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1131,Graph0_fy1131,Graph0_fex1131,Graph0_fey1131);
   gre->SetName("Graph0");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S12S18_",100,233.4612,2850.172);
   Graph_Graph01131->SetMinimum(-7.42848e-06);
   Graph_Graph01131->SetMaximum(0.0001930762);
   ...
   Graph_Graph01131->GetYaxis()->SetTitle("c / 500 MeV");
