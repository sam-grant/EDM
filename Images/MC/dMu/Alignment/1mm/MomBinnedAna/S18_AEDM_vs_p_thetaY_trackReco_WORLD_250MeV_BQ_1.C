...
//=========  (Tue Feb  8 12:52:15 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8975,-2.346389,3408.879,0.4864408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01132 = new TH1F("Graph_Graph01132","S18_",100,217.8334,3023.148);
   Graph_Graph01132->SetMinimum(-2.063106);
   Graph_Graph01132->SetMaximum(0.2031578);
