...
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,-2.473411,3208.607,19.86482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S18_",100,233.6651,2848.999);
   Graph_Graph01101->SetMinimum(-0.2395884);
   Graph_Graph01101->SetMaximum(17.63099);
