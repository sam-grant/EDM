...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,9.114076,3407.747,17.08718);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S12_",100,217.622,3022.128);
   Graph_Graph01101->SetMinimum(9.911386);
   Graph_Graph01101->SetMaximum(16.28987);
