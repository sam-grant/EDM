...
//=========  (Mon Jan 31 18:51:56 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6841,-0.7892856,3407.769,2.030178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,217.904,3022.181);
   Graph_Graph01170->SetMinimum(-0.5073392);
   Graph_Graph01170->SetMaximum(1.748231);
