void S18_theta_Y_RMS_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-125.9434,-4.779066,3208.607,59.80894);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01363664,
   0.01816406};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1107,Graph0_fy1107,Graph0_fex1107,Graph0_fey1107);
   gre->SetName("Graph0");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S18_",100,233.6651,2848.999);
   Graph_Graph01107->SetMinimum(1.679735);
   Graph_Graph01107->SetMaximum(53.35014);
   ...
   Graph_Graph01107->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad] / 500 MeV");
