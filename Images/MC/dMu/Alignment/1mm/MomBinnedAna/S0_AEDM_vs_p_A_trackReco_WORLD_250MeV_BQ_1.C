...
//=========  (Mon Jan 31 18:51:45 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4953,-2.120398e-05,3409.331,0.000184991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0_",100,217.3487,3023.487);
   Graph_Graph01061->SetMinimum(-5.844847e-07);
   Graph_Graph01061->SetMaximum(0.0001643715);
