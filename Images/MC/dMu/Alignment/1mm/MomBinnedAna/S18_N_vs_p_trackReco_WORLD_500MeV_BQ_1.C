...
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,-946794,3208.607,1228307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S18_",100,233.6651,2848.999);
   Graph_Graph01110->SetMinimum(-729283.8);
   Graph_Graph01110->SetMaximum(1010797);
