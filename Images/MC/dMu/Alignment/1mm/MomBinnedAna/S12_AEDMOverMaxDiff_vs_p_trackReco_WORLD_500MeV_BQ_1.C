...
//=========  (Mon Feb  7 15:00:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8771,-0.0001574772,3211.455,0.008454551);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","S12_",100,233.1391,2851.439);
   Graph_Graph01087->SetMinimum(0.0007037257);
   Graph_Graph01087->SetMaximum(0.007593348);
