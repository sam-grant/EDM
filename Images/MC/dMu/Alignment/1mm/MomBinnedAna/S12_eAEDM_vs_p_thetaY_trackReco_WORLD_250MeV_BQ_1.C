...
//=========  (Tue Feb  8 12:52:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9976,-0.06729347,3407.747,0.8654029);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01104 = new TH1F("Graph_Graph01104","S12_",100,217.622,3022.128);
   Graph_Graph01104->SetMinimum(0.02597617);
   Graph_Graph01104->SetMaximum(0.7721332);
