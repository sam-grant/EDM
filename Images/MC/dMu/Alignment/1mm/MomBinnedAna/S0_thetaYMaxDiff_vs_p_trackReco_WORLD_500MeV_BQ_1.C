void S0_thetaYMaxDiff_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.212,-37.5955,3216.762,280.4309);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5207669,
   0.5207669};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1059,Graph0_fy1059,Graph0_fex1059,Graph0_fey1059);
   gre->SetName("Graph0");
   gre->SetTitle("S0_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01059 = new TH1F("Graph_Graph01059","S0_",100,232.5205,2856.03);
   Graph_Graph01059->SetMinimum(-5.792856);
   Graph_Graph01059->SetMaximum(248.6283);
   ...
   Graph_Graph01059->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad] / 500 MeV");
