void S0_Ag2_vs_p_thetaY_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.212,-0.178159,3216.762,0.3098213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S0_",100,232.5205,2856.03);
   Graph_Graph01049->SetMinimum(-0.129361);
   Graph_Graph01049->SetMaximum(0.2610232);
   ...
   Graph_Graph01049->GetYaxis()->SetTitle("A_{g#minus2} [mrad] / 500 MeV");
