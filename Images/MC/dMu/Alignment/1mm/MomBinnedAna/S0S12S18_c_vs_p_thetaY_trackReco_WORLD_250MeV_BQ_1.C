...
//=========  (Mon Jan 31 18:52:00 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9133,-0.3470632,3408.324,0.3560797);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01205 = new TH1F("Graph_Graph01205","S0S12S18_",100,217.7594,3022.651);
   Graph_Graph01205->SetMinimum(-0.2767489);
   Graph_Graph01205->SetMaximum(0.2857654);
