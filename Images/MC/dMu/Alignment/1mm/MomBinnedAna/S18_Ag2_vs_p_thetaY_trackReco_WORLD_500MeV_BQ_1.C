...
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,-0.1663642,3208.607,1.388274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","S18_",100,233.6651,2848.999);
   Graph_Graph01103->SetMinimum(-0.01090037);
   Graph_Graph01103->SetMaximum(1.23281);
