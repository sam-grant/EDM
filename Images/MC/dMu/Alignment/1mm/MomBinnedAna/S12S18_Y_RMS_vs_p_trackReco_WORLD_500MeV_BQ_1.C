...
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.3365,9.11303,3209.969,16.62411);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01135 = new TH1F("Graph_Graph01135","S12S18_",100,233.4612,2850.172);
   Graph_Graph01135->SetMinimum(9.864138);
   Graph_Graph01135->SetMaximum(15.873);
