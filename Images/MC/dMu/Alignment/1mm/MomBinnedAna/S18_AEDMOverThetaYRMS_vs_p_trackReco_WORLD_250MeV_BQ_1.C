...
//=========  (Mon Jan 31 18:51:53 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.7144,-0.09629304,3408.481,0.04448437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01145 = new TH1F("Graph_Graph01145","S18_",100,217.9537,3022.812);
   Graph_Graph01145->SetMinimum(-0.0822153);
   Graph_Graph01145->SetMaximum(0.03040663);
