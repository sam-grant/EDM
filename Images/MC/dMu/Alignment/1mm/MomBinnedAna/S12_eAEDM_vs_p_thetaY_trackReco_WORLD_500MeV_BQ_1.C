...
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8771,-0.05779884,3211.455,0.7061753);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01084 = new TH1F("Graph_Graph01084","S12_",100,233.1391,2851.439);
   Graph_Graph01084->SetMinimum(0.01859858);
   Graph_Graph01084->SetMaximum(0.6297779);
