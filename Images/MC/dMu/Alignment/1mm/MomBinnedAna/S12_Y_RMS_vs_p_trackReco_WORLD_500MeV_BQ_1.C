void S12_Y_RMS_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8771,9.212984,3211.455,16.85726);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S12_",100,233.1391,2851.439);
   Graph_Graph01081->SetMinimum(9.977411);
   Graph_Graph01081->SetMaximum(16.09283);
   ...
   Graph_Graph01081->GetYaxis()->SetTitle("#sigma_{y} [mm] / 500 MeV");
