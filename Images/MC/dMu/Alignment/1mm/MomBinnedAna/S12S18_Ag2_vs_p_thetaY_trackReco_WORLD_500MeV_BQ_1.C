...
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.3365,-0.2353341,3209.969,1.855312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01130 = new TH1F("Graph_Graph01130","S12S18_",100,233.4612,2850.172);
   Graph_Graph01130->SetMinimum(-0.0262695);
   Graph_Graph01130->SetMaximum(1.646247);
