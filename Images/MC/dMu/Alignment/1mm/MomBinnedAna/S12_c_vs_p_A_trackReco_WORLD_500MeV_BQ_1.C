...
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8771,-6.855449e-05,3211.455,0.0003996996);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S12_",100,233.1391,2851.439);
   Graph_Graph01077->SetMinimum(-2.172908e-05);
   Graph_Graph01077->SetMaximum(0.0003528742);
