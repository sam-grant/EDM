...
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8771,-971889.1,3211.455,1277408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01083 = new TH1F("Graph_Graph01083","S12_",100,233.1391,2851.439);
   Graph_Graph01083->SetMinimum(-746959.4);
   Graph_Graph01083->SetMaximum(1052478);
