...
//=========  (Mon Feb  7 15:00:14 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,4.090018,3208.607,27.95616);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01109 = new TH1F("Graph_Graph01109","S18_",100,233.6651,2848.999);
   Graph_Graph01109->SetMinimum(6.476633);
   Graph_Graph01109->SetMaximum(25.56955);
