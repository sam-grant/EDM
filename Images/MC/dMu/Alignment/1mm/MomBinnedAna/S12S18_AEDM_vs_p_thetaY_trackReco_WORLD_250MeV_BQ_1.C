...
//=========  (Mon Jan 31 18:51:56 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6841,-0.7628264,3407.769,0.3498613);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01169 = new TH1F("Graph_Graph01169","S12S18_",100,217.904,3022.181);
   Graph_Graph01169->SetMinimum(-0.6515576);
   Graph_Graph01169->SetMaximum(0.2385925);
