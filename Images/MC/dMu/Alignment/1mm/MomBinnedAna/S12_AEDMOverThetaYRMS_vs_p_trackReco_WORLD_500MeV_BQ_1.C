void S12_AEDMOverThetaYRMS_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:12 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8771,0.0001120194,3211.455,0.04543874);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01088 = new TH1F("Graph_Graph01088","S12_",100,233.1391,2851.439);
   Graph_Graph01088->SetMinimum(0.004644691);
   Graph_Graph01088->SetMaximum(0.04090606);
   ...
   Graph_Graph01088->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01088->GetYaxis()->SetTitle("A_{EDM}/#sigma#theta_{y} / 500 MeV");
