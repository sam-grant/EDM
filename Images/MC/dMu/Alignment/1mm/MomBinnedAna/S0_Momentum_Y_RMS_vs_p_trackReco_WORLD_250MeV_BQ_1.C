...
//=========  (Tue Feb  8 12:52:09 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.5898,2.869702,3409.509,28.35289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S0_",100,217.2836,3023.636);
   Graph_Graph01065->SetMinimum(5.418021);
   Graph_Graph01065->SetMaximum(25.80457);
