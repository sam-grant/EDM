...
//=========  (Mon Feb  7 15:00:15 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.9434,-2.2196e-06,3208.607,2.040044e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01112 = new TH1F("Graph_Graph01112","S18_",100,233.6651,2848.999);
   Graph_Graph01112->SetMinimum(4.240391e-08);
   Graph_Graph01112->SetMaximum(1.813844e-05);
