...
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.3365,-0.01428329,3209.969,0.04832651);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01142 = new TH1F("Graph_Graph01142","S12S18_",100,233.4612,2850.172);
   Graph_Graph01142->SetMinimum(-0.008022311);
   Graph_Graph01142->SetMaximum(0.04206553);
