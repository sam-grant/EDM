void S0S12S18_AEDM_vs_p_A_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.9879,-2.920927e-06,3212.571,3.050776e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01159 = new TH1F("Graph_Graph01159","S0S12S18_",100,233.1606,2852.423);
   Graph_Graph01159->SetMinimum(-2.323757e-06);
   Graph_Graph01159->SetMaximum(2.453606e-06);
   ...
   Graph_Graph01159->GetXaxis()->SetTitle("Decay vertex momentum [MeV]");
   Graph_Graph01159->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01159->GetYaxis()->SetTitle("A_{EDM} / 500 MeV");
