void S0S12S18_AEDMOverThetaYRMS_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 15:00:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.9879,-0.009135907,3212.571,0.02123061);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.001625967,
   0.003150161};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1169,Graph0_fy1169,Graph0_fex1169,Graph0_fey1169);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01169 = new TH1F("Graph_Graph01169","S0S12S18_",100,233.1606,2852.423);
   Graph_Graph01169->SetMinimum(-0.006099255);
   Graph_Graph01169->SetMaximum(0.01819396);
   ...
   Graph_Graph01169->GetYaxis()->SetTitle("A_{EDM}/#sigma#theta_{y} / 500 MeV");
