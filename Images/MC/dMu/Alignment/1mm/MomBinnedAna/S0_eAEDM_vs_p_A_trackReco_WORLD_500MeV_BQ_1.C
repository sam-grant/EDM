...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-2.08151e-06,3216.762,1.910945e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0_",100,232.5205,2856.03);
   Graph_Graph01058->SetMinimum(3.758674e-08);
   Graph_Graph01058->SetMaximum(1.699036e-05);
