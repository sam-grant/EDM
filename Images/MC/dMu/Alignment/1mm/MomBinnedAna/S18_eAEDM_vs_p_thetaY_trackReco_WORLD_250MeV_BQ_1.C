...
//=========  (Mon Jan 31 18:51:53 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.7144,-0.07630816,3408.481,0.9840353);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01141 = new TH1F("Graph_Graph01141","S18_",100,217.9537,3022.812);
   Graph_Graph01141->SetMinimum(0.02972619);
   Graph_Graph01141->SetMaximum(0.8780009);
