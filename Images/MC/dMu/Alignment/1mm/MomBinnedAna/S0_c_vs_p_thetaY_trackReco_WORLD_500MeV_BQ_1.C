...
//=========  (Mon Feb  7 15:00:08 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.212,-2.232375,3216.762,18.92289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S0_",100,232.5205,2856.03);
   Graph_Graph01047->SetMinimum(-0.1168491);
   Graph_Graph01047->SetMaximum(16.80736);
