...
//=========  (Tue Feb  8 12:52:18 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8434,-0.0004245442,3408.106,0.000361599);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01171 = new TH1F("Graph_Graph01171","S12S18_",100,217.7983,3022.464);
   Graph_Graph01171->SetMinimum(-0.0003459299);
   Graph_Graph01171->SetMaximum(0.0002829847);
