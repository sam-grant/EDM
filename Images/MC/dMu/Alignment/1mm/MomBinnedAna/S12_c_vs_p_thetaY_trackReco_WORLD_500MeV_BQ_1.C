...
//=========  (Mon Feb  7 15:00:11 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8771,-2.526262,3211.455,17.76224);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S12_",100,233.1391,2851.439);
   Graph_Graph01074->SetMinimum(-0.4974118);
   Graph_Graph01074->SetMaximum(15.73339);
