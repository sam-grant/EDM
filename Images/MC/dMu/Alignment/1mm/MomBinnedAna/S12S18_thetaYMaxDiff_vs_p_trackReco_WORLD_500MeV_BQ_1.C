...
//=========  (Mon Feb  7 15:00:17 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.3365,-35.7964,3209.969,276.4885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01140 = new TH1F("Graph_Graph01140","S12S18_",100,233.4612,2850.172);
   Graph_Graph01140->SetMinimum(-4.567905);
   Graph_Graph01140->SetMaximum(245.26);
