...
//=========  (Tue Feb  8 12:52:09 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.5898,-0.06882603,3409.509,0.8705287);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0_",100,217.2836,3023.636);
   Graph_Graph01067->SetMinimum(0.02510945);
   Graph_Graph01067->SetMaximum(0.7765933);
