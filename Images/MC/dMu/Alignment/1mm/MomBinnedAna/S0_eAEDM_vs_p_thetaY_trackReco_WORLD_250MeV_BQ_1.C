...
//=========  (Mon Jan 31 18:51:45 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4953,-0.07606814,3409.331,0.9609494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0_",100,217.3487,3023.487);
   Graph_Graph01067->SetMinimum(0.02763361);
   Graph_Graph01067->SetMaximum(0.8572476);
