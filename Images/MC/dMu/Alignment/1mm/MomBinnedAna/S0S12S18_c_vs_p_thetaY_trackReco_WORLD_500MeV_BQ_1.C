...
//=========  (Mon Feb  7 15:00:20 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.9879,-2.332506,3212.571,18.82123);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01155 = new TH1F("Graph_Graph01155","S0S12S18_",100,233.1606,2852.423);
   Graph_Graph01155->SetMinimum(-0.2171328);
   Graph_Graph01155->SetMaximum(16.70586);
