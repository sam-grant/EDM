...
//=========  (Mon Jan 31 18:51:49 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.8782,-8.925817e-05,3407.489,0.000806088);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01098 = new TH1F("Graph_Graph01098","S12_",100,217.7007,3021.911);
   Graph_Graph01098->SetMinimum(2.764533e-07);
   Graph_Graph01098->SetMaximum(0.0007165534);
