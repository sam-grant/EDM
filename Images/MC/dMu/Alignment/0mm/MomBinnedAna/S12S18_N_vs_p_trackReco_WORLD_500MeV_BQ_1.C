...
//=========  (Mon Feb  7 14:58:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.134,-1709569,3209.718,2243235);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01137 = new TH1F("Graph_Graph01137","S12S18_",100,233.6148,2849.969);
   Graph_Graph01137->SetMinimum(-1314288);
   Graph_Graph01137->SetMaximum(1847955);
