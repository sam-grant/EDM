...
//=========  (Tue Feb  8 12:40:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9236,-27.51067,3407.563,282.0777);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01106 = new TH1F("Graph_Graph01106","S12_",100,217.6681,3021.971);
   Graph_Graph01106->SetMinimum(3.448167);
   Graph_Graph01106->SetMaximum(251.1188);
