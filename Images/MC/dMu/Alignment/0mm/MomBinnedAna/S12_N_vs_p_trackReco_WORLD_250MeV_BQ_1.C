...
//=========  (Tue Feb  8 12:40:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9236,-426383.1,3407.563,601397.8);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","S12_",100,217.6681,3021.971);
   Graph_Graph01103->SetMinimum(-323605);
   Graph_Graph01103->SetMaximum(498619.7);
