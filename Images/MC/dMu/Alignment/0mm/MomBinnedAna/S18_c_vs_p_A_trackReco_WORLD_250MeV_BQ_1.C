...
//=========  (Tue Feb  8 12:40:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6413,-9.025015e-05,3408.885,0.0007571949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01134 = new TH1F("Graph_Graph01134","S18_",100,218.0625,3023.181);
   Graph_Graph01134->SetMinimum(-5.50564e-06);
   Graph_Graph01134->SetMaximum(0.0006724504);
