...
//=========  (Tue Feb  8 12:40:28 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9236,-3.67348e-05,3407.563,0.0003318308);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01105 = new TH1F("Graph_Graph01105","S12_",100,217.6681,3021.971);
   Graph_Graph01105->SetMinimum(1.217587e-07);
   Graph_Graph01105->SetMaximum(0.0002949742);
