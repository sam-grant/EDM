...
//=========  (Tue Feb  8 12:40:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6413,-0.01955486,3408.885,0.008050793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01144 = new TH1F("Graph_Graph01144","S18_",100,218.0625,3023.181);
   Graph_Graph01144->SetMinimum(-0.0167943);
   Graph_Graph01144->SetMaximum(0.005290227);
