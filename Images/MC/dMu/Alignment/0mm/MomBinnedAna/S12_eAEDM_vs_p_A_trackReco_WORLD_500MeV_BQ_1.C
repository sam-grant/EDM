...
//=========  (Mon Feb  7 14:58:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8341,-2.69682e-06,3211.419,2.474531e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01085 = new TH1F("Graph_Graph01085","S12_",100,233.1736,2851.411);
   Graph_Graph01085->SetMinimum(4.739308e-08);
   Graph_Graph01085->SetMaximum(2.20011e-05);
