...
//=========  (Tue Feb  8 12:40:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6744,-0.892603,3408.015,2.187637);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01170 = new TH1F("Graph_Graph01170","S12S18_",100,217.9392,3022.401);
   Graph_Graph01170->SetMinimum(-0.584579);
   Graph_Graph01170->SetMaximum(1.879613);
