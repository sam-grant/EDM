...
//=========  (Mon Feb  7 14:58:39 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.7881,-44.38186,3212.301,276.1776);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01167 = new TH1F("Graph_Graph01167","S0S12S18_",100,233.3097,2852.203);
   Graph_Graph01167->SetMinimum(-12.32591);
   Graph_Graph01167->SetMaximum(244.1217);
