void S12_c_vs_p_thetaY_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:29 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8341,-2.4217,3211.419,17.98779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0199087,
   0.02814752};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1074,Graph0_fy1074,Graph0_fex1074,Graph0_fey1074);
   gre->SetName("Graph0");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S12_",100,233.1736,2851.411);
   Graph_Graph01074->SetMinimum(-0.3807513);
   Graph_Graph01074->SetMaximum(15.94684);
   ...
   Graph_Graph01074->GetYaxis()->SetTitle("c [mrad] / 500 MeV");
