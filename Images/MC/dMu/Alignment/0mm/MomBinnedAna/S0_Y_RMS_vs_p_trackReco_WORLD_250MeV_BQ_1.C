...
//=========  (Tue Feb  8 12:40:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4118,9.377492,3409.209,16.30561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S0_",100,217.4102,3023.388);
   Graph_Graph01064->SetMinimum(10.0703);
   Graph_Graph01064->SetMaximum(15.6128);
