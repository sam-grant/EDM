...
//=========  (Tue Feb  8 12:40:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6744,-3.359472,3408.015,26.67165);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01168 = new TH1F("Graph_Graph01168","S12S18_",100,217.9392,3022.401);
   Graph_Graph01168->SetMinimum(-0.3563595);
   Graph_Graph01168->SetMaximum(23.66854);
