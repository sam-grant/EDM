...
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.0953,-4.397623e-05,3216.756,4.865493e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01052 = new TH1F("Graph_Graph01052","S0_",100,232.6239,2856.036);
   Graph_Graph01052->SetMinimum(-3.909206e-05);
   Graph_Graph01052->SetMaximum(-1.867959e-08);
