...
//=========  (Tue Feb  8 12:40:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.866,-0.04267221,3408.39,0.5435065);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18_",100,217.8086,3022.715);
   Graph_Graph01215->SetMinimum(0.01594567);
   Graph_Graph01215->SetMaximum(0.4848887);
