...
//=========  (Tue Feb  8 12:40:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4118,-5.331336,3409.209,62.3763);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S0_",100,217.4102,3023.388);
   Graph_Graph01063->SetMinimum(1.439428);
   Graph_Graph01063->SetMaximum(55.60554);
