...
//=========  (Mon Feb  7 14:58:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8341,0.001686769,3211.419,0.03402822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01088 = new TH1F("Graph_Graph01088","S12_",100,233.1736,2851.411);
   Graph_Graph01088->SetMinimum(0.004920915);
   Graph_Graph01088->SetMaximum(0.03079408);
