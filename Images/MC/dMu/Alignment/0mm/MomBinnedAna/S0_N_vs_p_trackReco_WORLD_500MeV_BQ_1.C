void S0_N_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.0953,-867156.9,3216.756,1139424);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1056,Graph0_fy1056,Graph0_fex1056,Graph0_fey1056);
   gre->SetName("Graph0");
   gre->SetTitle("S0_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S0_",100,232.6239,2856.036);
   Graph_Graph01056->SetMinimum(-666498.8);
   Graph_Graph01056->SetMaximum(938766.2);
   ...
   Graph_Graph01056->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01056->GetYaxis()->SetTitle("Positrons / 500 MeV");
