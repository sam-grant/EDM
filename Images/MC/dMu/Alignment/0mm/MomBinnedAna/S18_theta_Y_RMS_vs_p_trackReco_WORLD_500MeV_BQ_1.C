...
//=========  (Mon Feb  7 14:58:32 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.5982,-4.780853,3208.188,59.77931);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01107 = new TH1F("Graph_Graph01107","S18_",100,233.9278,2848.662);
   Graph_Graph01107->SetMinimum(1.675163);
   Graph_Graph01107->SetMaximum(53.32329);
