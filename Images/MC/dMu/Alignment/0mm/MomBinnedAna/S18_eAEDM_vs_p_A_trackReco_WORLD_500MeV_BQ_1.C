void S18_eAEDM_vs_p_A_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:33 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-125.5982,-2.700638e-06,3208.188,2.480072e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01112 = new TH1F("Graph_Graph01112","S18_",100,233.9278,2848.662);
   Graph_Graph01112->SetMinimum(4.949793e-08);
   Graph_Graph01112->SetMaximum(2.205058e-05);
   ...
   Graph_Graph01112->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01112->GetYaxis()->SetTitle("#deltaA_{EDM} / 500 MeV");
