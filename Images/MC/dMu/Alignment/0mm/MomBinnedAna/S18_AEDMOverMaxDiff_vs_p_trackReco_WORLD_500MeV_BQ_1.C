...
//=========  (Mon Feb  7 14:58:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.5982,-0.008970705,3208.188,0.01167951);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01114 = new TH1F("Graph_Graph01114","S18_",100,233.9278,2848.662);
   Graph_Graph01114->SetMinimum(-0.006905683);
   Graph_Graph01114->SetMaximum(0.009614487);
