...
//=========  (Mon Feb  7 14:58:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.5982,-0.06356097,3208.188,0.7743385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01111 = new TH1F("Graph_Graph01111","S18_",100,233.9278,2848.662);
   Graph_Graph01111->SetMinimum(0.02022898);
   Graph_Graph01111->SetMaximum(0.6905486);
