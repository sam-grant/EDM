...
//=========  (Tue Feb  8 12:40:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.866,-1279201,3408.39,1793885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01214 = new TH1F("Graph_Graph01214","S0S12S18_",100,217.8086,3022.715);
   Graph_Graph01214->SetMinimum(-971892.2);
   Graph_Graph01214->SetMaximum(1486576);
