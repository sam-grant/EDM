...
//=========  (Tue Feb  8 12:40:24 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4118,-3.381424e-05,3409.209,0.0002179704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S0_",100,217.4102,3023.388);
   Graph_Graph01061->SetMinimum(-8.635779e-06);
   Graph_Graph01061->SetMaximum(0.0001927919);
