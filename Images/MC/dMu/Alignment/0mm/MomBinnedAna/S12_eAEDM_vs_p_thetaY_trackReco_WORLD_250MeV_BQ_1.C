...
//=========  (Tue Feb  8 12:40:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9236,-0.07266073,3407.563,0.9280759);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01104 = new TH1F("Graph_Graph01104","S12_",100,217.6681,3021.971);
   Graph_Graph01104->SetMinimum(0.02741293);
   Graph_Graph01104->SetMaximum(0.8280022);
