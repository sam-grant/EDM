void S0_eAEDM_vs_p_A_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.0953,-2.603036e-06,3216.756,2.390052e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S0_",100,232.6239,2856.036);
   Graph_Graph01058->SetMinimum(4.73196e-08);
   Graph_Graph01058->SetMaximum(2.125017e-05);
   ...
   Graph_Graph01058->GetYaxis()->SetTitle("#deltaA_{EDM} / 500 MeV");
