...
//=========  (Mon Feb  7 14:58:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.8341,9.320078,3211.419,16.56981);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S12_",100,233.1736,2851.411);
   Graph_Graph01081->SetMinimum(10.04505);
   Graph_Graph01081->SetMaximum(15.84484);
