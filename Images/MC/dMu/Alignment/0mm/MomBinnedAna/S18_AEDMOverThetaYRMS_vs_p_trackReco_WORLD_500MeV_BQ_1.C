...
//=========  (Mon Feb  7 14:58:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.5982,-0.05265605,3208.188,0.06806799);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01115 = new TH1F("Graph_Graph01115","S18_",100,233.9278,2848.662);
   Graph_Graph01115->SetMinimum(-0.04058364);
   Graph_Graph01115->SetMaximum(0.05599559);
