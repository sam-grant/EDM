...
//=========  (Mon Feb  7 14:58:32 2022) by ROOT version 6.24/06
   ...
   c->Range(-125.5982,-1.40903,3208.188,0.506601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01102 = new TH1F("Graph_Graph01102","S18_",100,233.9278,2848.662);
   Graph_Graph01102->SetMinimum(-1.217467);
   Graph_Graph01102->SetMaximum(0.3150379);
