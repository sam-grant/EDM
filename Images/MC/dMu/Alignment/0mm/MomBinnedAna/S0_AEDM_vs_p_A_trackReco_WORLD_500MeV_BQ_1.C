...
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-128.0953,-4.643486e-06,3216.756,2.045685e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S0_",100,232.6239,2856.036);
   Graph_Graph01051->SetMinimum(-3.974569e-06);
   Graph_Graph01051->SetMaximum(1.376768e-06);
