...
//=========  (Tue Feb  8 12:40:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.866,-35.79836,3408.39,299.5121);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01217 = new TH1F("Graph_Graph01217","S0S12S18_",100,217.8086,3022.715);
   Graph_Graph01217->SetMinimum(-2.267317);
   Graph_Graph01217->SetMaximum(265.981);
