...
//=========  (Tue Feb  8 12:40:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6744,2.886917,3408.015,28.2223);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01176 = new TH1F("Graph_Graph01176","S12S18_",100,217.9392,3022.401);
   Graph_Graph01176->SetMinimum(5.420455);
   Graph_Graph01176->SetMaximum(25.68876);
