void S12_N_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8341,-860608,3211.419,1135693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01083 = new TH1F("Graph_Graph01083","S12_",100,233.1736,2851.411);
   Graph_Graph01083->SetMinimum(-660977.9);
   Graph_Graph01083->SetMaximum(936063.3);
   ...
   Graph_Graph01083->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01083->GetYaxis()->SetTitle("Positrons / 500 MeV");
