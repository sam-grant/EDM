void S0_AEDM_vs_p_thetaY_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.0953,-0.118258,3216.756,0.3814862);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02551444,
   0.03252225};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1048,Graph0_fy1048,Graph0_fex1048,Graph0_fey1048);
   gre->SetName("Graph0");
   gre->SetTitle("S0_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S0_",100,232.6239,2856.036);
   Graph_Graph01048->SetMinimum(-0.06828356);
   Graph_Graph01048->SetMaximum(0.3315118);
   ...
   Graph_Graph01048->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01048->GetYaxis()->SetTitle("A_{EDM} [mrad] / 500 MeV");
