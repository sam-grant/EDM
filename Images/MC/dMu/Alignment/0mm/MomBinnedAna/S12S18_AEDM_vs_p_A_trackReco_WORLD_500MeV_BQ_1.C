...
//=========  (Mon Feb  7 14:58:35 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.134,-9.948684e-06,3209.718,1.386534e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01132 = new TH1F("Graph_Graph01132","S12S18_",100,233.6148,2849.969);
   Graph_Graph01132->SetMinimum(-7.567281e-06);
   Graph_Graph01132->SetMaximum(1.148394e-05);
