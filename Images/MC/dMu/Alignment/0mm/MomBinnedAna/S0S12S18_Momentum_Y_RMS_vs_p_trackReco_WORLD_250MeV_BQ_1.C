...
//=========  (Tue Feb  8 12:40:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.866,2.939174,3408.39,28.26248);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01213 = new TH1F("Graph_Graph01213","S0S12S18_",100,217.8086,3022.715);
   Graph_Graph01213->SetMinimum(5.471505);
   Graph_Graph01213->SetMaximum(25.73015);
