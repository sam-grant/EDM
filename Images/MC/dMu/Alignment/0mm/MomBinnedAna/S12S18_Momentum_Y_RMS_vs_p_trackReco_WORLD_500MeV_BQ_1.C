...
//=========  (Mon Feb  7 14:58:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.134,3.867423,3209.718,27.95993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01136 = new TH1F("Graph_Graph01136","S12S18_",100,233.6148,2849.969);
   Graph_Graph01136->SetMinimum(6.276673);
   Graph_Graph01136->SetMaximum(25.55068);
