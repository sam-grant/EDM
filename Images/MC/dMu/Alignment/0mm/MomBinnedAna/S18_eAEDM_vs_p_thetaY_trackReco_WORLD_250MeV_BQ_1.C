...
//=========  (Tue Feb  8 12:40:30 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6413,-0.07469376,3408.885,0.9530372);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01141 = new TH1F("Graph_Graph01141","S18_",100,218.0625,3023.181);
   Graph_Graph01141->SetMinimum(0.02807934);
   Graph_Graph01141->SetMaximum(0.8502641);
