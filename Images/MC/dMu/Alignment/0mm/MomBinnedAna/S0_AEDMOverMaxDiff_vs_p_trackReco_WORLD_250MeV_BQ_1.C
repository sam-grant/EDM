...
//=========  (Tue Feb  8 12:40:25 2022) by ROOT version 6.24/06
   ...
   c->Range(-168.4118,-0.001278663,3409.209,0.01362817);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S0_",100,217.4102,3023.388);
   Graph_Graph01070->SetMinimum(0.0002120206);
   Graph_Graph01070->SetMaximum(0.01213749);
