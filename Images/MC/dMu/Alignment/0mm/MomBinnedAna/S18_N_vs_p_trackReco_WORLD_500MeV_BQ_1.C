void S18_N_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:33 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-125.5982,-848959,3208.188,1107516);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1110,Graph0_fy1110,Graph0_fex1110,Graph0_fey1110);
   gre->SetName("Graph0");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S18_",100,233.9278,2848.662);
   Graph_Graph01110->SetMinimum(-653311.5);
   Graph_Graph01110->SetMaximum(911868.6);
   ...
   Graph_Graph01110->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01110->GetYaxis()->SetTitle("Positrons / 500 MeV");
