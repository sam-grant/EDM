...
//=========  (Tue Feb  8 12:40:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6744,-0.9219377,3408.015,0.3321212);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01169 = new TH1F("Graph_Graph01169","S12S18_",100,217.9392,3022.401);
   Graph_Graph01169->SetMinimum(-0.7965318);
   Graph_Graph01169->SetMaximum(0.2067153);
