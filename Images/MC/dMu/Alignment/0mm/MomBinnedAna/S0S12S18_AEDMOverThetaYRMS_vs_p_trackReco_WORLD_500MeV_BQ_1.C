...
//=========  (Mon Feb  7 14:58:39 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.7881,-0.01328668,3212.301,0.02692382);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01169 = new TH1F("Graph_Graph01169","S0S12S18_",100,233.3097,2852.203);
   Graph_Graph01169->SetMinimum(-0.009265632);
   Graph_Graph01169->SetMaximum(0.02290277);
