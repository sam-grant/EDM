...
//=========  (Tue Feb  8 12:40:33 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.6744,9.24283,3408.015,16.33116);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01175 = new TH1F("Graph_Graph01175","S12S18_",100,217.9392,3022.401);
   Graph_Graph01175->SetMinimum(9.951663);
   Graph_Graph01175->SetMaximum(15.62232);
