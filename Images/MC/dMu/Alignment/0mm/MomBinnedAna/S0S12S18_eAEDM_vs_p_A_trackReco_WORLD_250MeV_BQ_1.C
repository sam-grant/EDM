...
//=========  (Tue Feb  8 12:40:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.866,-6.452063e-06,3408.39,5.83052e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01216 = new TH1F("Graph_Graph01216","S0S12S18_",100,217.8086,3022.715);
   Graph_Graph01216->SetMinimum(2.36639e-08);
   Graph_Graph01216->SetMaximum(5.182947e-05);
