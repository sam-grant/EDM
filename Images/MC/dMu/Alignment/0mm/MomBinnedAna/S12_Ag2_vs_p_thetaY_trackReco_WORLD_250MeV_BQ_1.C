...
//=========  (Tue Feb  8 12:40:27 2022) by ROOT version 6.24/06
   ...
   c->Range(-167.9236,-1.356595,3407.563,2.704804);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01096 = new TH1F("Graph_Graph01096","S12_",100,217.6681,3021.971);
   Graph_Graph01096->SetMinimum(-0.9504553);
   Graph_Graph01096->SetMaximum(2.298664);
