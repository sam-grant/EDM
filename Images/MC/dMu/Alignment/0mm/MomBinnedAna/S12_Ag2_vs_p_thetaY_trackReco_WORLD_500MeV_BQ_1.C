...
//=========  (Mon Feb  7 14:58:29 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-126.8341,-0.2743818,3211.419,2.108255);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01076 = new TH1F("Graph_Graph01076","S12_",100,233.1736,2851.411);
   Graph_Graph01076->SetMinimum(-0.03611812);
   Graph_Graph01076->SetMaximum(1.869991);
