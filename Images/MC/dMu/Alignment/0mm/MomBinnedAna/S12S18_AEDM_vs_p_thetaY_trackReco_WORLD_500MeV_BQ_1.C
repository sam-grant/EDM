...
//=========  (Mon Feb  7 14:58:35 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.134,-0.5581773,3209.718,0.3098075);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01129 = new TH1F("Graph_Graph01129","S12S18_",100,233.6148,2849.969);
   Graph_Graph01129->SetMinimum(-0.4713788);
   Graph_Graph01129->SetMaximum(0.223009);
