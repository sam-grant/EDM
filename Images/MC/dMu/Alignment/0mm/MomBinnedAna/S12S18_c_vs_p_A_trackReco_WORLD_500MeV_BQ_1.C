...
//=========  (Mon Feb  7 14:58:35 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.134,-3.502183e-05,3209.718,0.0002451129);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01131 = new TH1F("Graph_Graph01131","S12S18_",100,233.6148,2849.969);
   Graph_Graph01131->SetMinimum(-7.008356e-06);
   Graph_Graph01131->SetMaximum(0.0002170994);
