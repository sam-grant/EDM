void S18_c_vs_p_thetaY_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-125.5982,-2.388104,3208.188,19.29916);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02062989,
   0.02905749};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1101,Graph0_fy1101,Graph0_fex1101,Graph0_fey1101);
   gre->SetName("Graph0");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01101 = new TH1F("Graph_Graph01101","S18_",100,233.9278,2848.662);
   Graph_Graph01101->SetMinimum(-0.2193771);
   Graph_Graph01101->SetMaximum(17.13043);
   ...
   Graph_Graph01101->GetYaxis()->SetTitle("c [mrad] / 500 MeV");
