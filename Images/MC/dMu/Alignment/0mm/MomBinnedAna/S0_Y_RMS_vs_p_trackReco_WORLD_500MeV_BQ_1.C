void S0_Y_RMS_vs_p_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.0953,9.286614,3216.756,16.40958);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S0_",100,232.6239,2856.036);
   Graph_Graph01054->SetMinimum(9.998911);
   Graph_Graph01054->SetMaximum(15.69728);
   ...
   Graph_Graph01054->GetYaxis()->SetTitle("#sigma_{y} [mm] / 500 MeV");
