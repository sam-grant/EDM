void S0_eAEDM_vs_p_thetaY_trackReco_WORLD_500MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Feb  7 14:58:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-128.0953,-0.06348115,3216.756,0.7662594);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S0_",100,232.6239,2856.036);
   Graph_Graph01057->SetMinimum(0.01949291);
   Graph_Graph01057->SetMaximum(0.6832853);
   ...
   Graph_Graph01057->GetYaxis()->SetTitle("#deltaA_{EDM} [mrad] / 500 MeV");
