...
//=========  (Mon Feb  7 14:58:38 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.7881,-4.724646e-06,3212.301,5.053672e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01159 = new TH1F("Graph_Graph01159","S0S12S18_",100,233.3097,2852.203);
   Graph_Graph01159->SetMinimum(-3.746814e-06);
   Graph_Graph01159->SetMaximum(4.07584e-06);
