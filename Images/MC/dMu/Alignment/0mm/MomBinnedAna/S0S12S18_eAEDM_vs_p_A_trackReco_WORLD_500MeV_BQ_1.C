...
//=========  (Mon Feb  7 14:58:39 2022) by ROOT version 6.24/06
   ...
   c->Range(-126.7881,-5.139545e-07,3212.301,4.718068e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01166 = new TH1F("Graph_Graph01166","S0S12S18_",100,233.3097,2852.203);
   Graph_Graph01166->SetMinimum(9.247763e-09);
   Graph_Graph01166->SetMaximum(4.194865e-06);
