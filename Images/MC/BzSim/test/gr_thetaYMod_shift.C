...
//=========  (Fri Jan 29 09:52:28 2021) by ROOT version 6.22/06
   ...
   gre->SetName("Graph0");
   gre->SetTitle("gr_thetaYMod_shift");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01004 = new TH1F("Graph_Graph01004","gr_thetaYMod_shift",100,0,4.771751);
   Graph_Graph01004->SetMinimum(-0.2816145);
   Graph_Graph01004->SetMaximum(0.5242966);
   ...
   TPaveText *pt = new TPaveText(0.320402,0.9341608,0.679598,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("gr_thetaYMod_shift");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
