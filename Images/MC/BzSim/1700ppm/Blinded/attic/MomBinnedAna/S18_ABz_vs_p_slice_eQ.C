...
//=========  (Thu May  6 16:53:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-375.375,-2.12673,3378.375,1.109908);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01100->SetMinimum(-1.803066);
   Graph_Graph01100->SetMaximum(0.7862439);
   ...
   Graph_Graph01100->GetXaxis()->SetTitle("p [MeV]: in range p #minus 50 < p < p #plus 50 MeV");
   ...
   Graph_Graph01100->GetYaxis()->SetTitle("A_{Bz} [mrad]");
