void S18_ABz_vs_p_bQ_2()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  4 14:33:26 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(123,0.01382293,2877,0.2921879);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01103->SetMinimum(0.04165943);
   Graph_Graph01103->SetMaximum(0.2643514);
