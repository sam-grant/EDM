...
//=========  (Mon May  3 23:15:29 2021) by ROOT version 6.22/08
   ...
   c->Range(848.75,-0.03573455,2353.25,0.3606472);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01175->SetMinimum(0.003903625);
   Graph_Graph01175->SetMaximum(0.321009);
   ...
   Graph_Graph01175->GetXaxis()->SetRange(24,82);
