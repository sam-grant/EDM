void S12_ABz_vs_p_bQ_2()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  4 14:33:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(123,-0.008231942,2877,0.3692585);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01074->SetMinimum(0.02951711);
   Graph_Graph01074->SetMaximum(0.3315095);
