void S0_ABz_vs_p_eQ_2()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  4 16:16:49 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(123,0.05576092,2877,0.3197049);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02470924,
   0.02482369};
   TGraphErrors *gre = new TGraphErrors(9,Graph0_fx1045,Graph0_fy1045,Graph0_fex1045,Graph0_fey1045);
   gre->SetName("Graph0");
   gre->SetTitle("S0");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S0",100,420,2580);
   Graph_Graph01045->SetMinimum(0.08215532);
   Graph_Graph01045->SetMaximum(0.2933105);
   ...
   Graph_Graph01045->GetYaxis()->SetTitle("A_{Bz} [mrad]");
