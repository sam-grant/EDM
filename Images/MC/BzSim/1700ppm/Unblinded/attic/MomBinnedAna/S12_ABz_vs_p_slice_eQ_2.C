...
//=========  (Thu May  6 12:22:29 2021) by ROOT version 6.22/08
   ...
   c->Range(-410,-0.6648895,3690,0.4597601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01076->SetMinimum(-0.5524245);
   Graph_Graph01076->SetMaximum(0.3472951);
   ...
   Graph_Graph01076->GetYaxis()->SetTitle("A_{Bz} [mrad]");
