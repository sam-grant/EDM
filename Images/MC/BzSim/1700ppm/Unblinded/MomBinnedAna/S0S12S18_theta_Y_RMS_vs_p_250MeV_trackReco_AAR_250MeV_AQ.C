void S0S12S18_theta_Y_RMS_vs_p_250MeV_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 13:43:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-6.443466,3419.625,61.0827);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01022->SetMinimum(0.3091508);
   Graph_Graph01022->SetMaximum(54.33008);
   ...
   Graph_Graph01022->GetXaxis()->SetRange(0,92);
