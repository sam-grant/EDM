void S12_AEDM_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.9711788,3456.75,0.3177702);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01011 = new TH1F("Graph_Graph01011","S12",100,0,3300);
   Graph_Graph01011->SetMinimum(-0.8422839);
   Graph_Graph01011->SetMaximum(0.1888753);
   ...
   Graph_Graph01011->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
   Graph_Graph01011->GetXaxis()->SetRange(0,93);
   ...
   Graph_Graph01011->GetYaxis()->SetTitle("A_{EDM} [mrad]");
