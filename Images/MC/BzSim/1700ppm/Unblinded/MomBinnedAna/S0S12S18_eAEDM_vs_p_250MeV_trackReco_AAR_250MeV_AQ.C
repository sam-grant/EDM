void S0S12S18_eAEDM_vs_p_250MeV_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 13:43:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-0.1126935,3419.625,1.211983);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01026->SetMinimum(0.01977414);
   Graph_Graph01026->SetMaximum(1.079515);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(0,92);
