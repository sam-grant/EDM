void S0S12S18_eAEDM_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.01451045,3360.969,0.2267835);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S0S12S18",100,0,3275);
   Graph_Graph01034->SetMinimum(0.009618942);
   Graph_Graph01034->SetMaximum(0.2026541);
