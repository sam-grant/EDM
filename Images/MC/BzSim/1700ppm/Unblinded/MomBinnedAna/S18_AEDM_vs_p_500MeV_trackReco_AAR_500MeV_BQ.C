void S18_AEDM_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.3430576,3456.75,1.022624);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01014 = new TH1F("Graph_Graph01014","S18",100,0,3300);
   Graph_Graph01014->SetMinimum(-0.2064895);
   Graph_Graph01014->SetMaximum(0.8860556);
   ...
   Graph_Graph01014->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
   Graph_Graph01014->GetXaxis()->SetRange(0,93);
