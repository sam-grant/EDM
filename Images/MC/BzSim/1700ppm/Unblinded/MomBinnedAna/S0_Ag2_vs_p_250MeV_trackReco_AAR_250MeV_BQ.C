void S0_Ag2_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.9819619,3360.969,0.7590116);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01017 = new TH1F("Graph_Graph01017","S0",100,0,3275);
   Graph_Graph01017->SetMinimum(-0.8078645);
   Graph_Graph01017->SetMaximum(0.5849142);
