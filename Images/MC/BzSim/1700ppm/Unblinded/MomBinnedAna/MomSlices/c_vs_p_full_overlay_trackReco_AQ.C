...
//=========  (Tue May 18 00:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_S0_c_vs_p1407->SetMinimum(-4);
   Graph_S0_c_vs_p1407->SetMaximum(6);
   ...
   Graph_S0_c_vs_p1407->GetXaxis()->SetRange(0,93);
   ...
   Graph_S12_c_vs_p1408->SetMinimum(-3.670943);
   Graph_S12_c_vs_p1408->SetMaximum(0.3338139);
   ...
   Graph_S18_c_vs_p1409->SetMinimum(-3.972075);
   Graph_S18_c_vs_p1409->SetMaximum(0.4202901);
