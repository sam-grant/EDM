...
//=========  (Wed Mar 24 17:43:51 2021) by ROOT version 6.22/06
   ...
   0.03509464,
   0.03484546};
   TGraphErrors *gre = new TGraphErrors(17,Graph0_fx1072,Graph0_fy1072,Graph0_fex1072,Graph0_fey1072);
   gre->SetName("Graph0");
   gre->SetTitle("S0");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S0",100,530,2570);
   Graph_Graph01072->SetMinimum(0.05675643);
   Graph_Graph01072->SetMaximum(0.2990271);
   ...
   Graph_Graph01072->GetXaxis()->SetRange(0,101);
   ...
   Graph_Graph01072->GetYaxis()->SetTitle("A_{Bz} [mrad]");
