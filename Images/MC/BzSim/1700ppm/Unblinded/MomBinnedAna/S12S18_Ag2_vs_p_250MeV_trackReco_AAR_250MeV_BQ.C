void S12S18_Ag2_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.3385264,3360.969,0.684373);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S12S18",100,0,3275);
   Graph_Graph01026->SetMinimum(-0.2362365);
   Graph_Graph01026->SetMaximum(0.582083);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01026->GetYaxis()->SetTitle("A_{g#minus2} [mrad]");
