void S12S18_c_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-2.04506,3360.969,6.623101);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01024 = new TH1F("Graph_Graph01024","S12S18",100,0,3275);
   Graph_Graph01024->SetMinimum(-1.178244);
   Graph_Graph01024->SetMaximum(5.756285);
   ...
   Graph_Graph01024->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01024->GetYaxis()->SetTitle("c [mrad]");
