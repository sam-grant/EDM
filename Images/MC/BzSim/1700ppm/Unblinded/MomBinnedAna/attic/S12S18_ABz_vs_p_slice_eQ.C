...
//=========  (Thu May  6 19:12:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-412.5,-1.8521,3712.5,0.6467816);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01142->SetMinimum(-1.602211);
   Graph_Graph01142->SetMaximum(0.3968935);
   ...
   Graph_Graph01142->GetXaxis()->SetTitle("p [MeV]: in range p #minus 100 < p < p #plus 100 MeV");
