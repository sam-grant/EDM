...
//=========  (Thu May  6 19:12:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-412.5,-4.763868,3712.5,1.279556);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01078->SetMinimum(-4.159526);
   Graph_Graph01078->SetMaximum(0.6752134);
   ...
   Graph_Graph01078->GetXaxis()->SetTitle("p [MeV]: in range p #minus 100 < p < p #plus 100 MeV");
