void S0_c_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-1.565963,3456.75,6.697139);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01007 = new TH1F("Graph_Graph01007","S0",100,0,3300);
   Graph_Graph01007->SetMinimum(-0.7396532);
   Graph_Graph01007->SetMaximum(5.870828);
   ...
   Graph_Graph01007->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
