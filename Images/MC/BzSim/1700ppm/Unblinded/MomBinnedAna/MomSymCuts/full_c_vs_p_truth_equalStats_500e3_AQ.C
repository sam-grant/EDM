...
//=========  (Wed May 19 17:11:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,-0.0857879,8.14,0.07738261);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.06947084);
   Graph_Graph01053->SetMaximum(0.06106556);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.06947084,7.312,-0.06947084,0.688,7.312,8,"");
