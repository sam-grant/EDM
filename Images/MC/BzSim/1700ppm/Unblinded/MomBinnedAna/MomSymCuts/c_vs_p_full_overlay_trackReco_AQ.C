...
//=========  (Tue May 18 00:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_S0_c_vs_p1413->SetMinimum(-0.6);
   ...
   Graph_S0_c_vs_p1413->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(51,"1000-2400");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(64,"1200-2200");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(78,"1400-2000");
   Graph_S0_c_vs_p1413->GetXaxis()->SetBinLabel(92,"1600-1800");
   Graph_S0_c_vs_p1413->GetXaxis()->SetRange(5,96);
   Graph_S0_c_vs_p1413->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_S0_c_vs_p1413->GetXaxis()->SetTickLength(0);
   ...
   Graph_S12_c_vs_p1414->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_S12_c_vs_p1414->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_S12_c_vs_p1414->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_S12_c_vs_p1414->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_S12_c_vs_p1414->GetXaxis()->SetBinLabel(51,"1000-2400");
   ...
   Graph_S12_c_vs_p1414->GetXaxis()->SetTickLength(0);
   ...
   Graph_S18_c_vs_p1415->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_S18_c_vs_p1415->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_S18_c_vs_p1415->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_S18_c_vs_p1415->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_S18_c_vs_p1415->GetXaxis()->SetBinLabel(51,"1000-2400");
   ...
   Graph_S18_c_vs_p1415->GetXaxis()->SetTickLength(0);
