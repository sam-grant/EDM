...
//=========  (Wed May 19 17:11:58 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5000001,0.08712944,8.5,0.3001488);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01054 = new TH1F("Graph_Graph01054","S0",100,0.4,7.6);
   Graph_Graph01054->SetMinimum(0.1084314);
   Graph_Graph01054->SetMaximum(0.2788469);
   ...
   Graph_Graph01054->GetXaxis()->SetRange(1,100);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,0.1084314,7.6,0.1084314,0.4,7.6,8,"");
