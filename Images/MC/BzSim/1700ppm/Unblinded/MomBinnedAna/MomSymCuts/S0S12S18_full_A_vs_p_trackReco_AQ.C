...
//=========  (Thu May 13 14:54:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.08583453,8.14,0.2234841);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01374->SetMinimum(0.09959949);
   Graph_Graph01374->SetMaximum(0.2097191);
   ...
   Graph_Graph01374->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01374->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01374->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_Graph01374->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_Graph01374->GetXaxis()->SetBinLabel(51,"1000-2400");
   Graph_Graph01374->GetXaxis()->SetBinLabel(64,"1200-2200");
   Graph_Graph01374->GetXaxis()->SetBinLabel(78,"1400-2000");
   Graph_Graph01374->GetXaxis()->SetBinLabel(92,"1600-1800");
   Graph_Graph01374->GetXaxis()->SetRange(5,96);
   Graph_Graph01374->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph01374->GetXaxis()->SetTickLength(0);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.688,0.09959949,7.312,0.09959949,0.688,7.312,8,"");
