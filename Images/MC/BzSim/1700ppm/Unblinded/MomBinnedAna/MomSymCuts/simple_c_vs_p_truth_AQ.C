...
//=========  (Fri May 14 14:19:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,-0.02699266,8.14,0.01885158);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.02240823);
   Graph_Graph01053->SetMaximum(0.01426716);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.02240823,7.312,-0.02240823,0.688,7.312,8,"");
