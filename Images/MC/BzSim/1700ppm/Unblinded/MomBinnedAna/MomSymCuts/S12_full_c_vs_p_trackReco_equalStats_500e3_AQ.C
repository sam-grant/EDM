...
//=========  (Wed May 19 17:12:04 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptStat(0);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,-0.5534958,8.5,-0.03118639);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01133->SetMinimum(-0.5012648);
   Graph_Graph01133->SetMaximum(-0.08341734);
   ...
   Graph_Graph01133->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01133->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01133->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_Graph01133->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_Graph01133->GetXaxis()->SetBinLabel(51,"1000-2400");
   Graph_Graph01133->GetXaxis()->SetBinLabel(64,"1200-2200");
   Graph_Graph01133->GetXaxis()->SetBinLabel(78,"1400-2000");
   Graph_Graph01133->GetXaxis()->SetBinLabel(92,"1600-1800");
   Graph_Graph01133->GetXaxis()->SetRange(1,100);
   Graph_Graph01133->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph01133->GetXaxis()->SetTickLength(0);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,-0.5012648,7.6,-0.5012648,0.4,7.6,8,"");
