...
//=========  (Thu May 13 01:11:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5000001,-0.241231,8.5,0.06266963);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.2108409);
   Graph_Graph01053->SetMaximum(0.03227956);
   ...
   Graph_Graph01053->GetXaxis()->SetTitle("Symmetric cut");
