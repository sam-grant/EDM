...
//=========  (Thu May 13 01:11:54 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptStat(0);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,0.0872058,8.5,0.2998007);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01054->SetMinimum(0.1084653);
   Graph_Graph01054->SetMaximum(0.2785412);
