...
//=========  (Tue May 18 00:07:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,-0.5534958,8.14,-0.03118639);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01133->GetXaxis()->SetRange(5,96);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.688,-0.5012648,7.312,-0.5012648,0.688,7.312,8,"");
