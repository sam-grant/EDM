...
//=========  (Thu May 13 14:54:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptStat(0);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,0.08712944,8.14,0.3001488);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.688,0.1084314,7.312,0.1084314,0.688,7.312,8,"");
