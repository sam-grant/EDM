...
//=========  (Mon May  3 23:15:34 2021) by ROOT version 6.22/08
   ...
   c->Range(848.75,0.03877677,2353.25,0.3011094);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02039192,
   0.02045476};
   TGraphErrors *gre = new TGraphErrors(17,Graph0_fx1228,Graph0_fy1228,Graph0_fex1228,Graph0_fey1228);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01228 = new TH1F("Graph_Graph01228","S0S12S18",100,530,2570);
   Graph_Graph01228->SetMinimum(0.06501004);
   Graph_Graph01228->SetMaximum(0.2748762);
   ...
   Graph_Graph01228->GetXaxis()->SetTitle("p [MeV]: in range p #minus 50 < p < p #plus 50 MeV");
   Graph_Graph01228->GetXaxis()->SetRange(24,82);
   ...
   Graph_Graph01228->GetYaxis()->SetTitle("A_{Bz} [mrad]");
