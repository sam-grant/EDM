void MCSampleOverlay()
{
//=========Macro generated from canvas: c/
//=========  (Mon May 30 20:09:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "",0,0,800,600);
   c->Range(183.4742,-0.575,3345.477,0.175);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_c_vs_p_thetaY1001->SetMinimum(-0.5);
   ...
   TLegend *leg = new TLegend(0.66,0.18,0.85,0.35,NULL,"brNDC");
   leg->SetBorderSize(0);
   leg->SetTextFont(44);
   leg->SetTextSize(24);
   leg->SetLineColor(1);
