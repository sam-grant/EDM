void S12_AcceptanceWeightingVsMomentum_Run-1a()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","Run-1a: S12",100,0,3122.856);
   Graph_Graph1004->SetMinimum(-0.2497322);
   Graph_Graph1004->SetMaximum(0.7990161);
   ...
   Graph_Graph1004->GetYaxis()->SetTitle("Acceptance weighting / 250 MeV");
