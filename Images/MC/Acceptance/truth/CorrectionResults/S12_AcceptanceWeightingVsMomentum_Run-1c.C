void S12_AcceptanceWeightingVsMomentum_Run-1c()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:23:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(-390.357,-0.3814151,3513.213,0.9330567);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.009871124,
   0.01015001};
   TGraphErrors *gre = new TGraphErrors(12,_fx1028,_fy1028,_fex1028,_fey1028);
   gre->SetName("");
   gre->SetTitle("Run-1c: S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1028 = new TH1F("Graph_Graph1028","Run-1c: S12",100,0,3122.856);
   Graph_Graph1028->SetMinimum(-0.2499679);
   Graph_Graph1028->SetMaximum(0.8016095);
   ...
   Graph_Graph1028->GetXaxis()->SetTitle("Decay vertex momentum [MeV]");
   ...
   Graph_Graph1028->GetYaxis()->SetTitle("Acceptance weighting / 250 MeV");
