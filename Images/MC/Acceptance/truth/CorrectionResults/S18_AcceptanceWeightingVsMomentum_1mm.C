void S18_AcceptanceWeightingVsMomentum_1mm()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Apr 26 12:47:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(499.748,0.165135,2740.76,0.7021921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1008->SetMinimum(0.2188407);
   Graph_Graph1008->SetMaximum(0.6484864);
   ...
   Graph_Graph1008->GetYaxis()->SetTitle("Acceptance fraction / 250 MeV");
