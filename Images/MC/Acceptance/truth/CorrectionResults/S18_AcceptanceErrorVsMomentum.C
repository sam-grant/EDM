...
//=========  (Fri May  6 20:33:51 2022) by ROOT version 6.24/06
   ...
   c->Range(811.7217,-0.2792951,2678.365,0.134986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1008->SetMinimum(-0.237867);
   Graph_Graph1008->SetMaximum(0.09355787);
   ...
   Graph_Graph1008->GetYaxis()->SetTitle("Acceptance fraction per mm misalignment / 250 MeV");
