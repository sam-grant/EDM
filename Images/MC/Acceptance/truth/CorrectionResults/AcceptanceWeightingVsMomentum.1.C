void AcceptanceWeightingVsMomentum.1()
{
...
//=========  (Tue Mar 29 09:03:07 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1008 = new TH1F("Graph_Graph1008","",100,0,3122.856);
   Graph_Graph1008->SetMinimum(0.05630726);
   Graph_Graph1008->SetMaximum(1.16365);
