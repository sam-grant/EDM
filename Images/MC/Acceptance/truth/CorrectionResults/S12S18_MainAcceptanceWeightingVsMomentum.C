...
//=========  (Wed May  4 16:40:18 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1014 = new TH1F("Graph_Graph1014","S12S18",100,999.0921,2486.997);
   Graph_Graph1014->SetMinimum(0.3098338);
   Graph_Graph1014->SetMaximum(0.7257416);
   ...
   Graph_Graph1014->GetYaxis()->SetTitle("Vertical angle acceptance fraction / 250 MeV");
