void S12_AllDecaysAndTrackReco_AEDM_vs_p_overlay_dataAccCorr_Run-1a()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   gre->SetName("");
   gre->SetTitle("Run-1a: S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","Run-1a: S12",100,699.253,2787.217);
   ...
   TH1F *Graph_Graph1002 = new TH1F("Graph_Graph1002","",100,699.253,2787.217);
   Graph_Graph1002->SetMinimum(0.04968121);
   Graph_Graph1002->SetMaximum(0.1114391);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,706.8735,2787.769);
   Graph_Graph1003->SetMinimum(0.05084208);
   Graph_Graph1003->SetMaximum(0.1779208);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Run-1a: S12");
   pt->Draw();
