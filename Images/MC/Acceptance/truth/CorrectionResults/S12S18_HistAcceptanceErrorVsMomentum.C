...
//=========  (Fri May  6 14:27:22 2022) by ROOT version 6.24/06
   ...
   TH1D *S12S18_diff__3 = new TH1D("S12S18_diff__3","S12S18",6,1000,2500);
   S12S18_diff__3->SetBinContent(1,0.02481251);
   S12S18_diff__3->SetBinContent(2,0.0110802);
   S12S18_diff__3->SetBinContent(3,0.02113442);
   S12S18_diff__3->SetBinContent(4,0.02616322);
   S12S18_diff__3->SetBinContent(5,0.07602786);
   S12S18_diff__3->SetBinContent(6,0.04948536);
   S12S18_diff__3->SetEntries(6);
