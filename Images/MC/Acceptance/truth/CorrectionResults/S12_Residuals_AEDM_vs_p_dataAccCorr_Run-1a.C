void S12_Residuals_AEDM_vs_p_dataAccCorr_Run-1a()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   TH1D *h_res__1 = new TH1D("h_res__1","",20,-0.05,0.05);
   h_res__1->SetBinContent(0,2);
   h_res__1->SetBinContent(1,2);
   h_res__1->SetBinContent(2,1);
   h_res__1->SetBinContent(4,1);
   h_res__1->SetBinContent(7,1);
   h_res__1->SetBinContent(10,1);
