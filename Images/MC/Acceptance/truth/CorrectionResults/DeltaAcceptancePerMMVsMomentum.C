...
//=========  (Wed May 11 13:03:56 2022) by ROOT version 6.24/06
   ...
   h_delta__3->SetBinContent(2,0.0272514);
   h_delta__3->SetBinContent(3,-0.01166473);
   h_delta__3->SetBinContent(4,0.02246708);
   h_delta__3->SetBinContent(5,0.03000563);
