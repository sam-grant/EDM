...
//=========  (Wed May  4 16:40:18 2022) by ROOT version 6.24/06
   ...
   S12S18_ratio_alt__2006->SetBinContent(1,0.5522859);
   S12S18_ratio_alt__2006->SetBinContent(2,0.5550667);
   S12S18_ratio_alt__2006->SetBinContent(3,0.6035574);
   S12S18_ratio_alt__2006->SetBinContent(4,0.6257032);
   S12S18_ratio_alt__2006->SetBinContent(5,0.5866217);
   S12S18_ratio_alt__2006->SetBinContent(6,0.7226908);
   S12S18_ratio_alt__2006->SetBinError(1,0.0309951);
   S12S18_ratio_alt__2006->SetBinError(2,0.03520584);
   S12S18_ratio_alt__2006->SetBinError(3,0.03932188);
   S12S18_ratio_alt__2006->SetBinError(4,0.04208302);
   S12S18_ratio_alt__2006->SetBinError(5,0.05937941);
   S12S18_ratio_alt__2006->SetBinError(6,0.04729398);
   S12S18_ratio_alt__2006->SetEntries(6);
   S12S18_ratio_alt__2006->SetStats(0);
   S12S18_ratio_alt__2006->SetLineWidth(3);
