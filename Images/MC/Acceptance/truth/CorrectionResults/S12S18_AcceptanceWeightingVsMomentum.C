...
//=========  (Wed May  4 12:58:04 2022) by ROOT version 6.24/06
   ...
   c->Range(499.748,0.2806149,2740.76,0.8477489);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S12S18",100,723.8492,2516.659);
   Graph_Graph1015->SetMinimum(0.3373283);
   Graph_Graph1015->SetMaximum(0.7910355);
   ...
   Graph_Graph1015->GetYaxis()->SetTitle("Vertical angle acceptance weighting / 250 MeV");
