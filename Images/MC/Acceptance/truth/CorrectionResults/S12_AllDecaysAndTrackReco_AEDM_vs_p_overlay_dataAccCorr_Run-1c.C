void S12_AllDecaysAndTrackReco_AEDM_vs_p_overlay_dataAccCorr_Run-1c()
{
...
//=========  (Fri Apr  8 16:23:17 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","Run-1c: S12",100,699.253,2787.217);
   Graph_Graph1025->SetMinimum(0);
   Graph_Graph1025->SetMaximum(0.35);
   ...
   Graph_Graph1025->GetXaxis()->SetRange(4,97);
   ...
   Graph_Graph1025->GetYaxis()->SetTitleOffset(1.2);
   ...
   0.005991447,
   0.006886005};
   gre = new TGraphErrors(8,_fx1026,_fy1026,_fex1026,_fey1026);
   gre->SetName("");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(24);
   
   TH1F *Graph_Graph1026 = new TH1F("Graph_Graph1026","",100,699.253,2787.217);
   Graph_Graph1026->SetMinimum(0.04953775);
   Graph_Graph1026->SetMaximum(0.1094778);
   ...
   0.02016337,
   0.02006182};
   gre = new TGraphErrors(8,_fx1027,_fy1027,_fex1027,_fey1027);
   gre->SetName("");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph1027 = new TH1F("Graph_Graph1027","",100,706.8735,2787.769);
   Graph_Graph1027->SetMinimum(0.05084208);
   Graph_Graph1027->SetMaximum(0.1779208);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Run-1c: S12");
   pt->Draw();
