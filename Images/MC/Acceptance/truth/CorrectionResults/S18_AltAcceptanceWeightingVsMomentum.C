...
//=========  (Fri Jun  3 03:41:26 2022) by ROOT version 6.24/06
   ...
   c->Range(811.7217,0.456944,2678.365,0.8276608);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1014 = new TH1F("Graph_Graph1014","S18",100,998.3861,2491.701);
   Graph_Graph1014->SetMinimum(0.4940157);
   Graph_Graph1014->SetMaximum(0.7905891);
   ...
   Graph_Graph1014->GetYaxis()->SetTitle("A_{EDM} acceptance factor / 250 MeV");
