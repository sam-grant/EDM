...
//=========  (Tue Apr 26 13:21:09 2022) by ROOT version 6.24/06
   ...
   TH1D *S12_diff__1 = new TH1D("S12_diff__1","S12",7,750,2500);
   S12_diff__1->SetBinContent(1,0.15126);
   S12_diff__1->SetBinContent(2,0.06340091);
   S12_diff__1->SetBinContent(3,0.06879605);
   S12_diff__1->SetBinContent(4,0.06115826);
   S12_diff__1->SetBinContent(5,0.1053778);
   S12_diff__1->SetBinContent(6,0.1054312);
   S12_diff__1->SetBinContent(7,0.08722801);
   S12_diff__1->SetEntries(7);
   S12_diff__1->SetStats(0);
   S12_diff__1->SetLineWidth(3);
   ...
   S12_diff__1->GetYaxis()->SetTitle("Acceptance fractional uncertainty / 250 MeV");
   ...
   S12_diff__1->GetYaxis()->SetTitleOffset(1.1);
