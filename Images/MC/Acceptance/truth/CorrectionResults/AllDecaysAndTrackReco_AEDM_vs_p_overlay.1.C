...
//=========  (Sun Mar 27 18:40:51 2022) by ROOT version 6.24/06
   ...
   gre->SetName("");
   gre->SetTitle("Vertical offset correction on 'reco vertices'");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","Vertical offset correction on 'reco vertices'",100,699.253,2787.217);
   ...
   Graph_Graph1006->SetMinimum(0.05969326);
   Graph_Graph1006->SetMaximum(0.1442272);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Vertical offset correction on 'reco vertices'");
   pt->Draw();
