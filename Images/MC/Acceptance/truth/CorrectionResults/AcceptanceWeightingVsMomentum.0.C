void AcceptanceWeightingVsMomentum.0()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Mar 27 18:40:51 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(-390.357,-0.08211064,3513.213,1.302068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,0,3122.856);
   Graph_Graph1004->SetMinimum(0.05630726);
   Graph_Graph1004->SetMaximum(1.16365);
