void S12S18_AllDecaysAndTrackReco_AEDM_vs_p_overlay_dataAccCorr_Run-1a()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   gre->SetName("");
   gre->SetTitle("Run-1a: S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","Run-1a: S12S18",100,699.253,2787.217);
   ...
   Graph_Graph1010->SetMinimum(0.03242334);
   Graph_Graph1010->SetMaximum(0.08855548);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,707.132,2786.55);
   Graph_Graph1011->SetMinimum(0.07043122);
   Graph_Graph1011->SetMaximum(0.1601212);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Run-1a: S12S18");
   pt->Draw();
