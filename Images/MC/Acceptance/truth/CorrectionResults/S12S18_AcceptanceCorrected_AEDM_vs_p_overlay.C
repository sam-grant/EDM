...
//=========  (Sat May  7 22:38:27 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12S18",100,998.3861,2491.701);
   ...
   TH1F *Graph_Graph1002 = new TH1F("Graph_Graph1002","",100,998.3861,2491.701);
   Graph_Graph1002->SetMinimum(0.07902126);
   Graph_Graph1002->SetMaximum(0.1912363);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,999.0921,2486.997);
   Graph_Graph1003->SetMinimum(0.07336393);
   Graph_Graph1003->SetMaximum(0.1603309);
