...
//=========  (Wed May  4 16:40:18 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,998.3861,2491.701);
   Graph_Graph1011->SetMinimum(0);
   Graph_Graph1011->SetMaximum(0.35);
   ...
   Graph_Graph1011->GetXaxis()->SetRange(2,99);
   ...
   Graph_Graph1011->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
   ...
   TH1F *Graph_Graph1012 = new TH1F("Graph_Graph1012","",100,998.3861,2491.701);
   Graph_Graph1012->SetMinimum(0.07902126);
   Graph_Graph1012->SetMaximum(0.1912363);
   ...
   0.01331907,
   0.01437902};
   gre = new TGraphErrors(6,_fx1013,_fy1013,_fex1013,_fey1013);
   gre->SetName("");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","",100,999.0921,2486.997);
   Graph_Graph1013->SetMinimum(0.07336393);
   Graph_Graph1013->SetMaximum(0.1603309);
