...
//=========  (Fri Jun  3 03:41:31 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1015->SetMaximum(0.35);
   ...
   Graph_Graph1015->GetXaxis()->SetRange(2,99);
   ...
   Graph_Graph1015->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
   ...
   TH1F *Graph_Graph1016 = new TH1F("Graph_Graph1016","",100,998.3861,2491.701);
   Graph_Graph1016->SetMinimum(0.07902126);
   Graph_Graph1016->SetMaximum(0.1912363);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","",100,999.0921,2486.997);
   Graph_Graph1017->SetMinimum(0.07323566);
   Graph_Graph1017->SetMaximum(0.1603427);
