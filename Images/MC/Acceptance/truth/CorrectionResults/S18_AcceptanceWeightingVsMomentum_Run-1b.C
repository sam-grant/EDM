void S18_AcceptanceWeightingVsMomentum_Run-1b()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(-390.357,-0.3577544,3513.213,0.8147529);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.009871124,
   0.01015001};
   TGraphErrors *gre = new TGraphErrors(12,_fx1020,_fy1020,_fex1020,_fey1020);
   gre->SetName("");
   gre->SetTitle("Run-1b: S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1020 = new TH1F("Graph_Graph1020","Run-1b: S18",100,0,3122.856);
   Graph_Graph1020->SetMinimum(-0.2405036);
   Graph_Graph1020->SetMaximum(0.6975022);
   ...
   Graph_Graph1020->GetYaxis()->SetTitle("Acceptance weighting / 250 MeV");
