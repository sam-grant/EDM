void S12_Residuals_AEDM_vs_p_dataAccCorr_Run-1b()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   TH1D *h_res__4 = new TH1D("h_res__4","",20,-0.05,0.05);
   h_res__4->SetBinContent(0,2);
   h_res__4->SetBinContent(1,2);
   h_res__4->SetBinContent(2,1);
   h_res__4->SetBinContent(4,1);
   h_res__4->SetBinContent(7,1);
   h_res__4->SetBinContent(10,1);
   h_res__4->SetEntries(8);
   h_res__4->SetStats(0);
   h_res__4->GetXaxis()->SetTitle("Decay vertex momentum [MeV]");
   ...
   h_res__4->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
