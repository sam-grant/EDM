...
//=========  (Wed May  4 19:19:33 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1006 = new TH1F("Graph_Graph1006","S18",100,998.3861,2491.701);
   Graph_Graph1006->SetMinimum(0);
   Graph_Graph1006->SetMaximum(0.35);
   ...
   Graph_Graph1006->GetXaxis()->SetRange(2,99);
   ...
   Graph_Graph1006->GetYaxis()->SetTitle("A_{EDM} [mrad] / 250 MeV");
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,998.3861,2491.701);
   Graph_Graph1007->SetMinimum(0.07842333);
   Graph_Graph1007->SetMaximum(0.1888442);
   ...
   TH1F *Graph_Graph1008 = new TH1F("Graph_Graph1008","",100,998.9747,2487.42);
   Graph_Graph1008->SetMinimum(0.04897001);
   Graph_Graph1008->SetMaximum(0.1604518);
