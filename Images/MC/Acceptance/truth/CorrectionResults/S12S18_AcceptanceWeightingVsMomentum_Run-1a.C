void S12S18_AcceptanceWeightingVsMomentum_Run-1a()
{
...
//=========  (Fri Apr  8 16:23:16 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1012 = new TH1F("Graph_Graph1012","Run-1a: S12S18",100,0,3122.856);
   Graph_Graph1012->SetMinimum(-0.2466176);
   Graph_Graph1012->SetMaximum(0.7647559);
