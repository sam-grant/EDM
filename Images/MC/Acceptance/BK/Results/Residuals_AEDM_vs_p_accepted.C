void Residuals_AEDM_vs_p_accepted()
{
...
//=========  (Tue Mar  1 12:16:18 2022) by ROOT version 6.24/06
   ...
   h_res__1->SetBinContent(5,1);
   h_res__1->SetBinContent(6,1);
   h_res__1->SetBinContent(7,1);
   h_res__1->SetBinContent(8,1);
   h_res__1->SetBinContent(10,2);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.05
#pm0.01
");
   pt->Draw();
