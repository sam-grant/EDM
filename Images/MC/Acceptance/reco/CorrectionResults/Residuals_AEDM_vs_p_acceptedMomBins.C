void Residuals_AEDM_vs_p_acceptedMomBins()
{
...
//=========  (Thu Mar 17 02:57:08 2022) by ROOT version 6.24/06
   ...
   TH1D *h_res__2 = new TH1D("h_res__2","Momentum binned acceptance weighting",25,-0.15,0.15);
   h_res__2->SetBinContent(9,1);
   h_res__2->SetBinContent(11,1);
   h_res__2->SetBinContent(12,1);
   h_res__2->SetBinContent(13,1);
   h_res__2->SetBinContent(15,2);
   h_res__2->SetBinContent(16,1);
   h_res__2->SetBinContent(21,1);
