...
//=========  (Thu Jul  1 11:10:46 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-404.25,-0.026891,3330.25,0.3480712);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01099->SetMinimum(0.01060522);
   Graph_Graph01099->SetMaximum(0.3105749);
