...
//=========  (Fri May 21 13:25:17 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-419.65,-0.599176,3468.85,0.1271052);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01195->SetMinimum(-0.5265478);
   Graph_Graph01195->SetMaximum(0.05447712);
