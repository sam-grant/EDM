...
//=========  (Fri May 21 09:49:43 2021) by ROOT version 6.22/08
   ...
   0.004176715,
   0.005416875};
   TGraphErrors *gre = new TGraphErrors(15,Graph0_fx1095,Graph0_fy1095,Graph0_fex1095,Graph0_fey1095);
   gre->SetName("Graph0");
   gre->SetTitle(";p_{min} [MeV];A_{EDM} [mrad]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","",100,0,3080);
   Graph_Graph01095->SetMinimum(0.0157285);
   Graph_Graph01095->SetMaximum(0.2439752);
   ...
   Graph_Graph01095->GetXaxis()->SetTitle("p_{min} [MeV]");
   Graph_Graph01095->GetXaxis()->SetRange(0,96);
   ...
   Graph_Graph01095->GetYaxis()->SetTitle("A_{EDM} [mrad]");
