...
//=========  (Mon May 17 13:47:22 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-535,-0.4764348,3335,0.151484);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03099256,
   0.05193116};
   TGraphErrors *gre = new TGraphErrors(15,Graph0_fx1249,Graph0_fy1249,Graph0_fex1249,Graph0_fey1249);
   gre->SetName("Graph0");
   gre->SetTitle("S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01249 = new TH1F("Graph_Graph01249","S18",100,-400,3200);
   Graph_Graph01249->SetMinimum(-0.4136429);
   Graph_Graph01249->SetMaximum(0.08869209);
   ...
   Graph_Graph01249->GetXaxis()->SetTitle("p_{min} [MeV]");
   Graph_Graph01249->GetXaxis()->SetRange(8,93);
