...
//=========  (Mon May 17 13:44:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2054143,8.14,0.239831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01058->SetMinimum(0.208856);
   Graph_Graph01058->SetMaximum(0.2363893);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.208856,7.312,0.208856,0.688,7.312,8,"");
