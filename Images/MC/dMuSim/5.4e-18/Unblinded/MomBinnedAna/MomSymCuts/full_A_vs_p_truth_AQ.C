...
//=========  (Tue Jun 15 11:13:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.211436,8.14,0.2691822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(0.2172106);
   Graph_Graph01066->SetMaximum(0.2634076);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2172106,7.312,0.2172106,0.688,7.312,8,"");
