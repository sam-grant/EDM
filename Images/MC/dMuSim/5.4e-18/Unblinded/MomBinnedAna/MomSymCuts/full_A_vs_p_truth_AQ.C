...
//=========  (Fri May 21 09:49:37 2021) by ROOT version 6.22/08
   ...
   0.004139548,
   0.006999138};
   TGraphErrors *gre = new TGraphErrors(7,Graph0_fx1063,Graph0_fy1063,Graph0_fex1063,Graph0_fey1063);
   gre->SetName("Graph0");
   gre->SetTitle(";p_{min} #minus p_{max} [MeV];A_{EDM} [mrad]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","",100,0.4,7.6);
   Graph_Graph01063->SetMinimum(0.2088549);
   Graph_Graph01063->SetMaximum(0.23639);
   ...
   Graph_Graph01063->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01063->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01063->GetXaxis()->SetBinLabel(23,"600-2800");
   Graph_Graph01063->GetXaxis()->SetBinLabel(37,"800-2600");
   Graph_Graph01063->GetXaxis()->SetBinLabel(51,"1000-2400");
   Graph_Graph01063->GetXaxis()->SetBinLabel(64,"1200-2200");
   Graph_Graph01063->GetXaxis()->SetBinLabel(78,"1400-2000");
   Graph_Graph01063->GetXaxis()->SetBinLabel(92,"1600-1800");
   Graph_Graph01063->GetXaxis()->SetRange(5,96);
   Graph_Graph01063->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph01063->GetXaxis()->SetTickLength(0);
   Graph_Graph01063->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph01063->GetXaxis()->SetTitleFont(42);
   Graph_Graph01063->GetYaxis()->SetTitle("A_{EDM} [mrad]");
