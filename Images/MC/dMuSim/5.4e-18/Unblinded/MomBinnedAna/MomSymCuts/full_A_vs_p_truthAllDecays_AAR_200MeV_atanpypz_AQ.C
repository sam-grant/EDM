...
//=========  (Thu Jul  1 11:20:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2333747,8.14,0.2970804);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2397453);
   Graph_Graph01067->SetMaximum(0.2907099);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2397453,7.312,0.2397453,0.688,7.312,8,"");
