...
//=========  (Mon Jun 21 17:01:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5900001,0.006995927,8.59,0.01326863);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(0.007623197);
   Graph_Graph01066->SetMaximum(0.01264136);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.328,0.007623197,7.672,0.007623197,0.328,7.672,8,"");
