...
//=========  (Tue Jun 15 12:30:53 2021) by ROOT version 6.22/08
   ...
   c->Range(0.62,0.2124479,3.38,0.2641226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01040->SetMinimum(0.2176154);
   Graph_Graph01040->SetMaximum(0.2589551);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.896,0.2176154,3.104,0.2176154,0.896,3.104,8,"");
