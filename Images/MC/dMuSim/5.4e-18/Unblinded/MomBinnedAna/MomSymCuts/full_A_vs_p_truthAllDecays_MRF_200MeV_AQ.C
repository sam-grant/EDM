...
//=========  (Tue Jun 22 01:04:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,6.64563,8.14,14.0773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(7.388796);
   Graph_Graph01067->SetMaximum(13.33413);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,7.388796,7.312,7.388796,0.688,7.312,8,"");
