...
//=========  (Fri Jun 18 13:58:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5900001,0.01023292,8.59,0.01885814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(0.01109544);
   Graph_Graph01066->SetMaximum(0.01799562);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.328,0.01109544,7.672,0.01109544,0.328,7.672,8,"");
