void full_A_vs_p_truthAllDecays_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jun 15 10:53:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,0.1931518,8.14,0.4393866);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(0.2177752);
   Graph_Graph01066->SetMaximum(0.4147631);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2177752,7.312,0.2177752,0.688,7.312,8,"");
