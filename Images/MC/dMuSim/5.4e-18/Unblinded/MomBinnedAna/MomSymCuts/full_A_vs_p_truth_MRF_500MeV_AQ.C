...
//=========  (Tue Jun 22 12:35:01 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.62,6.864435,3.38,10.93773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(7.271765);
   Graph_Graph01041->SetMaximum(10.5304);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.896,7.271765,3.104,7.271765,0.896,3.104,8,"");
