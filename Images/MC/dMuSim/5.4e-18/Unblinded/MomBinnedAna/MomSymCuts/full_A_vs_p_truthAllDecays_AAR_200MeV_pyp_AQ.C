...
//=========  (Wed Jun 30 18:51:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2333086,8.14,0.2970145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2396792);
   Graph_Graph01067->SetMaximum(0.2906439);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2396792,7.312,0.2396792,0.688,7.312,8,"");
