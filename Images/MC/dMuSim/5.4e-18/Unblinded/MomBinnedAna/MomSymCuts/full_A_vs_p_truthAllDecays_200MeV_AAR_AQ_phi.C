...
//=========  (Wed Jul 14 16:17:03 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2334675,8.14,0.2971848);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(0.2398393);
   Graph_Graph01067->SetMaximum(0.2908131);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2398393,7.312,0.2398393,0.688,7.312,8,"");
