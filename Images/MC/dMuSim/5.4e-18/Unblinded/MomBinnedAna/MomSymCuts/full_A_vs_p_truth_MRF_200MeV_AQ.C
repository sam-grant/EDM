...
//=========  (Tue Jun 22 12:36:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,6.858787,8.14,10.96597);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(7.269505);
   Graph_Graph01067->SetMaximum(10.55525);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,7.269505,7.312,7.269505,0.688,7.312,8,"");
