...
//=========  (Tue Jun 15 13:08:14 2021) by ROOT version 6.22/08
   ...
   c->Range(0.5,0.1053287,3.5,0.2303366);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1080[3] = {
   1,
   2,
   3};
   Double_t Graph0_fy1080[3] = {
   0.1815746,
   0.1444762,
   0.1840817};
   Double_t Graph0_fex1080[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1080[3] = {
   0.01802286,
   0.01831291,
   0.02542022};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1080,Graph0_fy1080,Graph0_fex1080,Graph0_fey1080);
   gre->SetName("Graph0");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01080 = new TH1F("Graph_Graph01080","S12",100,0.8,3.2);
   Graph_Graph01080->SetMinimum(0.1178295);
   Graph_Graph01080->SetMaximum(0.2178358);
   ...
   Graph_Graph01080->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01080->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01080->GetXaxis()->SetBinLabel(50,"900-2500");
   Graph_Graph01080->GetXaxis()->SetBinLabel(92,"1400-2000");
   Graph_Graph01080->GetXaxis()->SetRange(1,100);
   Graph_Graph01080->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph01080->GetXaxis()->SetTickLength(0);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.8,0.1178295,3.2,0.1178295,0.8,3.2,8,"");
