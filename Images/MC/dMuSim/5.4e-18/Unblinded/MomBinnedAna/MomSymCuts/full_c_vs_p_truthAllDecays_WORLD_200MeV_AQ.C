...
//=========  (Tue Jun 22 01:02:14 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,-0.01167223,8.14,0.01652836);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.008852168);
   Graph_Graph01066->SetMaximum(0.0137083);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.008852168,7.312,-0.008852168,0.688,7.312,8,"");
