...
//=========  (Tue Jun 22 01:04:49 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,-0.4757383,8.14,0.8206898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.3460954);
   Graph_Graph01066->SetMaximum(0.691047);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.3460954,7.312,-0.3460954,0.688,7.312,8,"");
