...
//=========  (Tue Jun 15 13:08:32 2021) by ROOT version 6.22/08
   ...
   Double_t Graph0_fx1228[3] = {
   1,
   2,
   3};
   Double_t Graph0_fy1228[3] = {
   -0.3805751,
   -0.2068932,
   -0.1573766};
   Double_t Graph0_fex1228[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1228[3] = {
   0.01308076,
   0.01490519,
   0.02337545};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1228,Graph0_fy1228,Graph0_fex1228,Graph0_fey1228);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01228 = new TH1F("Graph_Graph01228","S0S12S18",100,0.8,3.2);
   Graph_Graph01228->SetMinimum(-0.4196213);
   Graph_Graph01228->SetMaximum(-0.1080357);
   ...
   Graph_Graph01228->GetXaxis()->SetTitle("p_{min} #minus p_{max} [MeV]");
   Graph_Graph01228->GetXaxis()->SetBinLabel(9,"400-3000");
   Graph_Graph01228->GetXaxis()->SetBinLabel(50,"900-2500");
   Graph_Graph01228->GetXaxis()->SetBinLabel(92,"1400-2000");
   Graph_Graph01228->GetXaxis()->SetRange(1,100);
   Graph_Graph01228->GetXaxis()->SetBit(TAxis::kLabelsHori);
