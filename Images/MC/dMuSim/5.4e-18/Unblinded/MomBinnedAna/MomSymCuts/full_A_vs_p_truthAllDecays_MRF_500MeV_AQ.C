...
//=========  (Tue Jun 22 11:42:06 2021) by ROOT version 6.22/08
   ...
   c->Range(0.62,6.995466,3.38,12.32812);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(7.528731);
   Graph_Graph01041->SetMaximum(11.79485);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.896,7.528731,3.104,7.528731,0.896,3.104,8,"");
