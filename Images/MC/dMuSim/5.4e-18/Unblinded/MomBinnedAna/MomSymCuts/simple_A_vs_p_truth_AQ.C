...
//=========  (Fri May 14 14:38:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.2042106,8.14,0.2376515);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01058->SetMinimum(0.2075547);
   Graph_Graph01058->SetMaximum(0.2343074);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.2075547,7.312,0.2075547,0.688,7.312,8,"");
