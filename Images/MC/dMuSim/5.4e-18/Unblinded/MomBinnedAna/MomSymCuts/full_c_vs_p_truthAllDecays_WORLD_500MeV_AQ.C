...
//=========  (Thu Jun 17 13:03:35 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.62,-0.03073953,3.38,0.01719321);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.02594625);
   Graph_Graph01039->SetMaximum(0.01239994);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.896,-0.02594625,3.104,-0.02594625,0.896,3.104,8,"");
