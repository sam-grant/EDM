...
//=========  (Wed Jul 14 18:07:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.1400001,-0.02120784,8.14,0.07281296);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01066->SetMinimum(-0.01180576);
   Graph_Graph01066->SetMaximum(0.06341088);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,-0.01180576,7.312,-0.01180576,0.688,7.312,8,"");
