...
//=========  (Fri May 21 13:25:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(250,-0.2595221,3550,0.03142976);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01115->SetMinimum(-0.2304269);
   Graph_Graph01115->SetMaximum(0.002334571);
