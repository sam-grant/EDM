...
//=========  (Thu Jul  1 11:20:17 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(250,-0.04319472,3550,0.009965691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01124->SetMinimum(-0.03787868);
   Graph_Graph01124->SetMaximum(0.00464965);
