...
//=========  (Tue Jun 15 11:13:16 2021) by ROOT version 6.22/08
   ...
   c->Range(250,0.2204726,3550,0.3132855);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01124->SetMinimum(0.2297539);
   Graph_Graph01124->SetMaximum(0.3040042);
   ...
   Graph_Graph01124->GetYaxis()->SetTitle("A_{EDM} [mrad]");
