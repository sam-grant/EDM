void S0_full_c_vs_p_trackTruth_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Sep 14 11:48:52 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(45.03123,-1.789554,3197.219,7.262063);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S0",100,0,3275);
   Graph_Graph01033->SetMinimum(-0.8843926);
   Graph_Graph01033->SetMaximum(6.356901);
   ...
   Graph_Graph01033->GetXaxis()->SetRange(12,88);
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("c [mrad]");
