void full_chiSqrNDF_vs_p_truthAllDecays_AAR_200MeV_AQ_option0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 14 23:36:45 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.6103652,3456.75,1.468007);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(0.6961294);
   Graph_Graph01049->SetMaximum(1.382243);
