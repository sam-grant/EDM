void S12S18_full_A_vs_p_trackTruth_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Sep 14 11:49:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(45.03123,-0.4371118,3197.219,0.3528217);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01106 = new TH1F("Graph_Graph01106","S12S18",100,0,3275);
   Graph_Graph01106->SetMinimum(-0.3581185);
   Graph_Graph01106->SetMaximum(0.2738284);
   ...
   Graph_Graph01106->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01106->GetXaxis()->SetRange(12,88);
