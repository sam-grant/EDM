void S0S12S18_full_eA_vs_p_trackReco2_AAR_250MeV_CQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Sep 30 11:51:20 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-0.1738162,3419.625,1.760421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01145->SetMinimum(0.01960746);
   Graph_Graph01145->SetMaximum(1.566997);
