void S12S18_full_c_vs_p_trackReco_WORLD_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Aug 24 13:24:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-375.375,-1.809163,3378.375,6.669489);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01065->SetMinimum(-0.9612977);
   Graph_Graph01065->SetMaximum(5.821624);
   ...
   Graph_Graph01065->GetXaxis()->SetRange(1,91);
