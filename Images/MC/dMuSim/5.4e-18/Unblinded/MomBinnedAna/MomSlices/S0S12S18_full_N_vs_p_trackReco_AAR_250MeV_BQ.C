void S0S12S18_full_N_vs_p_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Oct  6 16:03:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-268522.3,3360.969,2735480);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01134->SetMinimum(31878);
   Graph_Graph01134->SetMaximum(2435080);
   ...
   Graph_Graph01134->GetXaxis()->SetRange(8,92);
