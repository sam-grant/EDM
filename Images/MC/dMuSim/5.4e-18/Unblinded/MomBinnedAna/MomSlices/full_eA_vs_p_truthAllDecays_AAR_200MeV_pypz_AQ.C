void full_eA_vs_p_truthAllDecays_AAR_200MeV_pypz_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul  1 11:10:40 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.008257252,3456.75,0.1074559);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01048->SetMinimum(0.003314069);
   Graph_Graph01048->SetMaximum(0.09588463);
