void full_chiSqrNDF_vs_p_truthAllDecays_AAR_200MeV_pypz_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul  1 11:10:40 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.7526233,3456.75,1.586283);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(0.8359893);
   Graph_Graph01049->SetMaximum(1.502917);
