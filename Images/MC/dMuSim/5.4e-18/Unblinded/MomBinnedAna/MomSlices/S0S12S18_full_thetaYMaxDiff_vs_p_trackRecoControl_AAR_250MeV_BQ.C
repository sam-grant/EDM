void S0S12S18_full_thetaYMaxDiff_vs_p_trackRecoControl_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 12:01:34 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-34.03098,3360.969,332.0721);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01136 = new TH1F("Graph_Graph01136","",100,0,3275);
   Graph_Graph01136->SetMinimum(2.579329);
   Graph_Graph01136->SetMaximum(295.4618);
   ...
   Graph_Graph01136->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
