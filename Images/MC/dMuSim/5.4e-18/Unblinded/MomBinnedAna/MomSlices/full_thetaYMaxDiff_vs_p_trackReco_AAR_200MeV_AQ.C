void full_thetaYMaxDiff_vs_p_trackReco_AAR_200MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul 29 10:11:57 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-437.25,-23.3,3605.25,596.7);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01176->SetMinimum(38.7);
   Graph_Graph01176->SetMaximum(534.7);
   ...
   Graph_Graph01176->GetXaxis()->SetRange(0,97);
