void S12S18_full_A_vs_p_trackReco2_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Sep 30 11:45:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.4425193,3360.969,0.3684316);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01106->SetMinimum(-0.3614242);
   Graph_Graph01106->SetMaximum(0.2873365);
   ...
   Graph_Graph01106->GetXaxis()->SetRange(8,92);
