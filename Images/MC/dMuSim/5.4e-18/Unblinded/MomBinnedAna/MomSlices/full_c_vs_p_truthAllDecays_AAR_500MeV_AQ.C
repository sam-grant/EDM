...
//=========  (Thu Jun 17 13:39:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-420.75,-0.03195286,3456.75,0.01922564);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-0.02683501);
   Graph_Graph01031->SetMaximum(0.01410779);
   ...
   Graph_Graph01031->GetXaxis()->SetRange(0,93);
