void full_theta_Y_RMS_vs_p_truthAllDecays_MRF_200MeV_AQ_option0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul 15 00:14:48 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,168.1015,3456.75,634.9695);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01042->SetMinimum(214.7883);
   Graph_Graph01042->SetMaximum(588.2827);
