void full_eA_vs_p_truthAllDecays_AAR_200MeV_pxpz_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul  7 17:48:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.008049877,3456.75,0.1064161);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01048->SetMinimum(0.003396717);
   Graph_Graph01048->SetMaximum(0.09496947);
