void S0S12S18_full_Y_RMS_vs_p_trackReco2_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Sep 30 11:45:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,12.43632,3360.969,13.17895);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01132->SetMinimum(12.51059);
   Graph_Graph01132->SetMaximum(13.10469);
