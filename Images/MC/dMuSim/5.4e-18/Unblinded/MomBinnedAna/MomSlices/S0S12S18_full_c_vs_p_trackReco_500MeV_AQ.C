...
//=========  (Tue Jun 15 13:08:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-375.375,-2.609151,3378.375,0.3787025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03536099,
   0.0409902};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1215,Graph0_fy1215,Graph0_fex1215,Graph0_fey1215);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01215 = new TH1F("Graph_Graph01215","S0S12S18",100,0,3300);
   Graph_Graph01215->SetMinimum(-2.310366);
   Graph_Graph01215->SetMaximum(0.07991714);
   ...
   Graph_Graph01215->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
   Graph_Graph01215->GetXaxis()->SetRange(1,91);
   ...
   Graph_Graph01215->GetYaxis()->SetTitle("c [mrad]");
