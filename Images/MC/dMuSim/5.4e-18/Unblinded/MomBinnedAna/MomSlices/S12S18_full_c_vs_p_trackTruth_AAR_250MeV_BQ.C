void S12S18_full_c_vs_p_trackTruth_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Sep 14 11:49:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(45.03123,-2.037306,3197.219,6.871991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-1.146376);
   Graph_Graph01105->SetMaximum(5.981062);
   ...
   Graph_Graph01105->GetXaxis()->SetRange(12,88);
