void full_Y_vs_p_truth_AAR_200MeV_tan_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jun 29 12:15:02 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.06235794,3456.75,0.01885531);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01043->SetMinimum(-0.05423662);
   Graph_Graph01043->SetMaximum(0.01073399);
