...
//=========  (Thu Jun 17 13:39:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-420.75,-0.02178594,3456.75,0.3713854);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01032->SetMinimum(0.0175312);
   Graph_Graph01032->SetMaximum(0.3320682);
   ...
   Graph_Graph01032->GetXaxis()->SetRange(0,93);
