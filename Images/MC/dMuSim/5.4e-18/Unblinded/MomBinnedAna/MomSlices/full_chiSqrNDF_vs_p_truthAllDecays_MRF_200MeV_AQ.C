void full_chiSqrNDF_vs_p_truthAllDecays_MRF_200MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jul 16 17:58:47 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.6062007,3456.75,1.578982);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01051->SetMinimum(0.7034789);
   Graph_Graph01051->SetMaximum(1.481704);
   ...
   Graph_Graph01051->GetYaxis()->SetTitle("#chi^{2}/NDF");
