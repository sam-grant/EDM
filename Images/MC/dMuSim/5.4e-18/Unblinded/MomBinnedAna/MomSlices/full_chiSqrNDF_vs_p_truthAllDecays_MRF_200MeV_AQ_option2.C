void full_chiSqrNDF_vs_p_truthAllDecays_MRF_200MeV_AQ_option2()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul 15 00:54:04 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.4741575,3456.75,1.634441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(0.5901859);
   Graph_Graph01049->SetMaximum(1.518413);
