void full_eA_vs_p_truthAllDecays_MRF_200MeV_AQ_option0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul 15 00:14:48 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.1150374,3456.75,0.6918601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01048->SetMinimum(0.1727197);
   Graph_Graph01048->SetMaximum(0.6341778);
