...
//=========  (Fri May 21 09:49:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-420.75,-0.001146833,3456.75,0.0399168);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(0.00295953);
   Graph_Graph01045->SetMaximum(0.03581043);
   ...
   Graph_Graph01045->GetYaxis()->SetTitle("#deltaA_{EDM}");
