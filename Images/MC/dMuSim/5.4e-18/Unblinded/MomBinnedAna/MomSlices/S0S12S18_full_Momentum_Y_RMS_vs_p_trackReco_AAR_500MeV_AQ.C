void S0S12S18_full_Momentum_Y_RMS_vs_p_trackReco_AAR_500MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Aug 25 18:02:27 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-375.375,12.5424,3378.375,24.91025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01083->SetMinimum(13.77918);
   Graph_Graph01083->SetMaximum(23.67346);
   ...
   Graph_Graph01083->GetXaxis()->SetRange(1,91);
