void full_theta_Y_vs_p_truthAllDecays_MRF_200MeV_AQ_option2()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Jul 15 00:54:04 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-5.192042,3456.75,10.48373);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(-3.624465);
   Graph_Graph01041->SetMaximum(8.916151);
