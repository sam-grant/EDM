void S12_full_c_vs_p_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Sep 28 07:56:10 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-2.172935,3360.969,6.804509);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(-1.27519);
   Graph_Graph01057->SetMaximum(5.906765);
   ...
   Graph_Graph01057->GetXaxis()->SetRange(8,92);
