...
//=========  (Thu Aug 26 12:14:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-437.25,-22.30882,3605.25,10.51326);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01178->SetMinimum(-19.02661);
   Graph_Graph01178->SetMaximum(7.231053);
   ...
   Graph_Graph01178->GetXaxis()->SetRange(0,97);
