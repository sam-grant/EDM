void S0S12S18_full_eA_vs_p_trackReco_WORLD_200MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Aug 24 13:23:56 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-437.25,-0.08702212,3605.25,0.783199);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(15,Graph0_fx1175,Graph0_fy1175,Graph0_fex1175,Graph0_fey1175);
   gre->SetName("Graph0");
   ...
   Graph_Graph01175->SetMinimum(2.440441e-12);
   Graph_Graph01175->SetMaximum(0.6961769);
   ...
   Graph_Graph01175->GetYaxis()->SetTitle("#deltaA_{EDM}");
