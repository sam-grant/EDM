void S0S12S18_full_eA_vs_p_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Oct  6 16:03:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.008389057,3360.969,0.1315991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01135 = new TH1F("Graph_Graph01135","",100,0,3275);
   Graph_Graph01135->SetMinimum(0.005609758);
   Graph_Graph01135->SetMaximum(0.1176003);
   ...
   Graph_Graph01135->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01135->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01135->GetYaxis()->SetTitle("#deltaA_{EDM}");
