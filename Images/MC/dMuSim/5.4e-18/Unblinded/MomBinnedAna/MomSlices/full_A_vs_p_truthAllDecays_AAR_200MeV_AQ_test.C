void full_A_vs_p_truthAllDecays_AAR_200MeV_AQ_test()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 28 13:49:12 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.04954749,3456.75,0.4819345);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01042->SetMinimum(0.003600708);
   Graph_Graph01042->SetMaximum(0.4287863);
