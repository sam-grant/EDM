void full_chiSqrNDF_vs_p_truth_AAR_200MeV_tan_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jun 29 12:15:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,0.7848617,3456.75,2.334443);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(0.9398198);
   Graph_Graph01049->SetMaximum(2.179485);
