void full_AOverMaxDiff_vs_p_truthAllDecays_AAR_200MeV_AQ_test()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 28 13:49:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.0005703535,3456.75,0.01012031);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(15,Graph0_fx1055,Graph0_fy1055,Graph0_fex1055,Graph0_fey1055);
   gre->SetName("Graph0");
   gre->SetTitle(";e^{+}_{LAB} p [MeV] in range: p #minus 100 < p < p #plus 100 MeV;A_{EDM}/(#Delta#theta_{y})_{MAX} [mrad]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","",100,0,3300);
   Graph_Graph01055->SetMinimum(0.0004987129);
   Graph_Graph01055->SetMaximum(0.009051244);
   ...
   Graph_Graph01055->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 100 < p < p #plus 100 MeV");
   Graph_Graph01055->GetXaxis()->SetRange(0,93);
   ...
   Graph_Graph01055->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX} [mrad]");
