void S18_full_A_vs_p_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Sep 14 11:50:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(45.03123,-0.6991162,3197.219,0.4339494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01082 = new TH1F("Graph_Graph01082","S18",100,0,3275);
   Graph_Graph01082->SetMinimum(-0.5858097);
   Graph_Graph01082->SetMaximum(0.3206428);
   ...
   Graph_Graph01082->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01082->GetXaxis()->SetRange(12,88);
