void full_theta_Y_RMS_vs_p_truth_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 21 09:49:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-2.711153,3456.75,41.40545);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(1.700507);
   Graph_Graph01041->SetMaximum(36.99379);
   ...
   Graph_Graph01041->GetYaxis()->SetTitle("#sigma#theta_{y} [mrad]");
