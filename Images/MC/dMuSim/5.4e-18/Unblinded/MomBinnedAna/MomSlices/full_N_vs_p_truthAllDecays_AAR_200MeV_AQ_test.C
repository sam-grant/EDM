void full_N_vs_p_truthAllDecays_AAR_200MeV_AQ_test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jul 23 11:04:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-323487.8,3456.75,5977906);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle(";e^{+} p [MeV] in range: p #minus 100 < p < p #plus 100 MeV;Positrons");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","",100,0,3300);
   Graph_Graph01049->SetMinimum(306651.6);
   Graph_Graph01049->SetMaximum(5347767);
   ...
   Graph_Graph01049->GetXaxis()->SetTitle("e^{+} p [MeV] in range: p #minus 100 < p < p #plus 100 MeV");
   ...
   Graph_Graph01049->GetYaxis()->SetTitle("Positrons");
