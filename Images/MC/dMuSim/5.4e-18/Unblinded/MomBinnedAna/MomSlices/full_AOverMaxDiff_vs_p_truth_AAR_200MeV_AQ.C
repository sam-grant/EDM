void full_AOverMaxDiff_vs_p_truth_AAR_200MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jul 28 15:26:42 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.0005344939,3456.75,0.009220813);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01055->SetMinimum(0.0004410368);
   Graph_Graph01055->SetMaximum(0.008245282);
   ...
   Graph_Graph01055->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX}");
