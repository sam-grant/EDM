void S12_full_c_vs_p_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Sep 13 15:26:38 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-3.259327,3254.625,0.5941122);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-2.873983);
   Graph_Graph01061->SetMaximum(0.2087683);
   ...
   Graph_Graph01061->GetXaxis()->SetRange(4,88);
