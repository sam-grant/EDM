...
//=========  (Mon Sep 27 11:33:09 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-251.625,-10.95154,3254.625,2.174038);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-9.63898);
   Graph_Graph01061->SetMaximum(0.8614801);
