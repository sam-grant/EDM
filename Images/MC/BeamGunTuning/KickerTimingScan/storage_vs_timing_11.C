...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1012[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1012[5] = {
   0.26,
   1.1,
   1.42,
   1.26,
   0.46};
   Double_t Graph0_fex1012[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1012[5] = {
   0.5547002,
   0.2696799,
   0.2373563,
   0.2519763,
   0.4170288};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1012,Graph0_fy1012,Graph0_fex1012,Graph0_fey1012);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 11");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01012 = new TH1F("Graph_Graph01012","Plane 11",100,-725,-485);
   Graph_Graph01012->SetMinimum(0);
   Graph_Graph01012->SetMaximum(3);
   ...
   Graph_Graph01012->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01012->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 11");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
