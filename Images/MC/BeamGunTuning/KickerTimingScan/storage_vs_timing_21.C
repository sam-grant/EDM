...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1022[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1022[5] = {
   0.16,
   0.88,
   1.22,
   0.96,
   0.32};
   Double_t Graph0_fex1022[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1022[5] = {
   0.7071068,
   0.3015113,
   0.2560738,
   0.2886751,
   0.5};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1022,Graph0_fy1022,Graph0_fex1022,Graph0_fey1022);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 21");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","Plane 21",100,-725,-485);
   Graph_Graph01022->SetMinimum(0);
   Graph_Graph01022->SetMaximum(3);
   ...
   Graph_Graph01022->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01022->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 21");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
