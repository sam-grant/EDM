...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1023[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1023[5] = {
   0.16,
   0.88,
   1.16,
   0.96,
   0.32};
   Double_t Graph0_fex1023[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1023[5] = {
   0.7071068,
   0.3015113,
   0.2626129,
   0.2886751,
   0.5};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1023,Graph0_fy1023,Graph0_fex1023,Graph0_fey1023);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 22");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","Plane 22",100,-725,-485);
   Graph_Graph01023->SetMinimum(0);
   Graph_Graph01023->SetMaximum(3);
   ...
   Graph_Graph01023->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 22");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
