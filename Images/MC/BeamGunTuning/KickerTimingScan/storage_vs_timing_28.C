...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Plane 28");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","Plane 28",100,-725,-485);
   Graph_Graph01029->SetMinimum(0);
   Graph_Graph01029->SetMaximum(3);
   ...
   Graph_Graph01029->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01029->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 28");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
