...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1017[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1017[5] = {
   0.18,
   1.02,
   1.32,
   1.02,
   0.4};
   Double_t Graph0_fex1017[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1017[5] = {
   0.6666667,
   0.280056,
   0.246183,
   0.280056,
   0.4472136};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1017,Graph0_fy1017,Graph0_fex1017,Graph0_fey1017);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 16");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01017 = new TH1F("Graph_Graph01017","Plane 16",100,-725,-485);
   Graph_Graph01017->SetMinimum(0);
   Graph_Graph01017->SetMaximum(3);
   ...
   Graph_Graph01017->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01017->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 16");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
