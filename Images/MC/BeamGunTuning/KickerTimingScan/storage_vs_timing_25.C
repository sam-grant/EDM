...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1026[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1026[5] = {
   0.14,
   0.88,
   1.08,
   0.94,
   0.32};
   Double_t Graph0_fex1026[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1026[5] = {
   0.7559289,
   0.3015113,
   0.2721655,
   0.29173,
   0.5};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1026,Graph0_fy1026,Graph0_fex1026,Graph0_fey1026);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 25");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","Plane 25",100,-725,-485);
   Graph_Graph01026->SetMinimum(0);
   Graph_Graph01026->SetMaximum(3);
   ...
   Graph_Graph01026->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01026->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 25");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
