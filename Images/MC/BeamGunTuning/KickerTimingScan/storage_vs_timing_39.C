...
//=========  (Mon Nov 30 13:23:09 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Plane 39");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","Plane 39",100,-725,-485);
   Graph_Graph01040->SetMinimum(0);
   Graph_Graph01040->SetMaximum(3);
   ...
   Graph_Graph01040->GetXaxis()->SetTitle("Timing [ns]");
   Graph_Graph01040->GetXaxis()->CenterTitle(true);
   Graph_Graph01040->GetXaxis()->SetLabelFont(42);
   Graph_Graph01040->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph01040->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph01040->GetXaxis()->SetTitleFont(42);
   Graph_Graph01040->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 39");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
