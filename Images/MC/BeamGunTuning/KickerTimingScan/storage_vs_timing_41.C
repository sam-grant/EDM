...
//=========  (Mon Nov 30 13:23:09 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1042[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1042[5] = {
   0.14,
   0.78,
   1.02,
   0.92,
   0.32};
   Double_t Graph0_fex1042[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1042[5] = {
   0.7559289,
   0.3202563,
   0.280056,
   0.2948839,
   0.5};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1042,Graph0_fy1042,Graph0_fex1042,Graph0_fey1042);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 41");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","Plane 41",100,-725,-485);
   Graph_Graph01042->SetMinimum(0);
   Graph_Graph01042->SetMaximum(3);
   ...
   Graph_Graph01042->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01042->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 41");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
