...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Plane 14");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","Plane 14",100,-725,-485);
   Graph_Graph01015->SetMinimum(0);
   Graph_Graph01015->SetMaximum(3);
   ...
   Graph_Graph01015->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01015->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 14");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
