...
//=========  (Mon Nov 30 13:23:09 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Plane 32");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","Plane 32",100,-725,-485);
   Graph_Graph01033->SetMinimum(0);
   Graph_Graph01033->SetMaximum(3);
   ...
   Graph_Graph01033->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 32");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
