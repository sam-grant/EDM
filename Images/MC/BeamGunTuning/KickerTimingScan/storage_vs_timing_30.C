...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Plane 30");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","Plane 30",100,-725,-485);
   Graph_Graph01031->SetMinimum(0);
   Graph_Graph01031->SetMaximum(3);
   ...
   Graph_Graph01031->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01031->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 30");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
