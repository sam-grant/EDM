...
//=========  (Mon Nov 30 13:23:08 2020) by ROOT version 6.22/02
   ...
   Double_t Graph0_fx1019[5] = {
   -505,
   -555,
   -605,
   -655,
   -705};
   Double_t Graph0_fy1019[5] = {
   0.16,
   0.9,
   1.3,
   0.98,
   0.36};
   Double_t Graph0_fex1019[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1019[5] = {
   0.7071068,
   0.2981424,
   0.2480695,
   0.2857143,
   0.4714045};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1019,Graph0_fy1019,Graph0_fex1019,Graph0_fey1019);
   gre->SetName("Graph0");
   gre->SetTitle("Plane 18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01019 = new TH1F("Graph_Graph01019","Plane 18",100,-725,-485);
   Graph_Graph01019->SetMinimum(0);
   Graph_Graph01019->SetMaximum(3);
   ...
   Graph_Graph01019->GetXaxis()->SetTitle("Timing [ns]");
   ...
   Graph_Graph01019->GetYaxis()->SetTitle("#mu^{+} storage [%]");
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Plane 18");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
