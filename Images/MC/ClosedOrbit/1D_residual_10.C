...
//=========  (Fri Jan 15 20:04:10 2021) by ROOT version 6.22/06
   TCanvas *c = new TCanvas("c", "c",0,45,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-0.4375,-26.25,0.4375,236.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   h_res__10->SetBinContent(50,200);
   h_res__10->SetBinContent(51,160);
   ...
   ptstats_LaTex = ptstats->AddText("Mean  = -1.701e-10");
   ptstats_LaTex = ptstats->AddText("Std Dev   = 0.001036");
