...
//=========  (Tue Dec  8 12:25:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.54984,45,53.35837);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","325 sub-runs",100,-36,36);
   Graph_Graph01103->SetMinimum(-27.55902);
   Graph_Graph01103->SetMaximum(44.36754);
   ...
   Graph_Graph01103->GetXaxis()->SetTitle("#LTB_{r}^{App}#GT [ppm]");
   ...
   checkFit1104->SetChisquare(7.416962e-16);
   ...
   checkFit1104->SetParameter(1,0.9788031);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.0143");
   pt_LaTex = pt->AddText("  8.4#pm0.428");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.586267,-27.55902,-8.586267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1105->SetChisquare(7.416962e-16);
   ...
   checkFit1105->SetParameter(1,0.9788031);
