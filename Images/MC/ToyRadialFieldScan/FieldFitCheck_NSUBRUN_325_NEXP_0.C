...
//=========  (Wed Jan  5 17:07:05 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-38.45756,45,55.26609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","",100,-36,36);
   Graph_Graph01103->SetMinimum(-29.08519);
   Graph_Graph01103->SetMaximum(45.89372);
   ...
   Graph_Graph01103->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01103->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *checkFit1104 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1104->SetChisquare(8.242094e-17);
   ...
   checkFit1104->SetParameter(0,8.404265);
   checkFit1104->SetParError(0,0.4280174);
   checkFit1104->SetParLimits(0,0,0);
   checkFit1104->SetParameter(1,1.021197);
   checkFit1104->SetParError(1,0.01426725);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.229818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.229818,-29.08519,-8.229818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1105 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1105->SetChisquare(8.242094e-17);
   ...
   checkFit1105->SetParameter(0,8.404265);
   checkFit1105->SetParError(0,0.4280174);
   checkFit1105->SetParLimits(0,0,0);
   checkFit1105->SetParameter(1,1.021197);
   checkFit1105->SetParError(1,0.01426725);
