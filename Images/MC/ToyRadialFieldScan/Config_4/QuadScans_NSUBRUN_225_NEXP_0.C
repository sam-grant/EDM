...
//=========  (Fri Oct 16 07:51:04 2020) by ROOT version 6.22/02
   ...
   quadLineFit1114->SetChisquare(1.689168e-20);
   ...
   quadLineFit1114->SetParameter(0,-5.705311);
   quadLineFit1114->SetParError(0,0.06293588);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.1583924);
   quadLineFit1114->SetParError(1,0.003475053);
   ...
   quadLineFit1115->SetChisquare(1.689168e-20);
   ...
   quadLineFit1115->SetParameter(0,-5.705311);
   quadLineFit1115->SetParError(0,0.06293588);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.1583924);
   quadLineFit1115->SetParError(1,0.003475053);
   ...
   Graph_mI25dO000000sPppm1115->SetMinimum(-1.321815);
   Graph_mI25dO000000sPppm1115->SetMaximum(-0.9872104);
   ...
   quadLineFit1116->SetChisquare(5.457756e-18);
   ...
   quadLineFit1116->SetParameter(0,-2.32082);
   quadLineFit1116->SetParError(0,0.06293588);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,0.06479485);
   quadLineFit1116->SetParError(1,0.003475053);
   ...
   quadLineFit1117->SetChisquare(5.457756e-18);
   ...
   quadLineFit1117->SetParameter(0,-2.32082);
   quadLineFit1117->SetParError(0,0.06293588);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,0.06479485);
   quadLineFit1117->SetParError(1,0.003475053);
   ...
   Graph_0dO000000sPppm1117->SetMinimum(0.4537439);
   Graph_0dO000000sPppm1117->SetMaximum(0.6228679);
   ...
   quadLineFit1118->SetChisquare(5.316821e-24);
   ...
   quadLineFit1118->SetParameter(0,1.084061);
   quadLineFit1118->SetParError(0,0.06293588);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.0303197);
   quadLineFit1118->SetParError(1,0.003475053);
   ...
   quadLineFit1119->SetChisquare(5.316821e-24);
   ...
   quadLineFit1119->SetParameter(0,1.084061);
   quadLineFit1119->SetParError(0,0.06293588);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.0303197);
   quadLineFit1119->SetParError(1,0.003475053);
   ...
   Graph_25dO000000sPppm1119->SetMinimum(1.915657);
   Graph_25dO000000sPppm1119->SetMaximum(2.539387);
   ...
   quadLineFit1120->SetChisquare(5.368801e-19);
   ...
   quadLineFit1120->SetParameter(0,4.478052);
   quadLineFit1120->SetParError(0,0.06293588);
   quadLineFit1120->SetParLimits(0,0,0);
   quadLineFit1120->SetParameter(1,-0.1250294);
   quadLineFit1120->SetParError(1,0.003475053);
   ...
   quadLineFit1121->SetChisquare(5.368801e-19);
   ...
   quadLineFit1121->SetParameter(0,4.478052);
   quadLineFit1121->SetParError(0,0.06293588);
   quadLineFit1121->SetParLimits(0,0,0);
   quadLineFit1121->SetParameter(1,-0.1250294);
   quadLineFit1121->SetParError(1,0.003475053);
   ...
   Graph_50dO000000sPppm1121->SetMinimum(3.401453);
   Graph_50dO000000sPppm1121->SetMaximum(4.466068);
   ...
   quadLineFit1122->SetChisquare(3.081001e-17);
   ...
   quadLineFit1122->SetParameter(0,7.837605);
   quadLineFit1122->SetParError(0,0.06293588);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,-0.2168802);
   quadLineFit1122->SetParError(1,0.003475053);
   ...
   quadLineFit1123->SetChisquare(3.081001e-17);
   ...
   quadLineFit1123->SetParameter(0,7.837605);
   quadLineFit1123->SetParError(0,0.06293588);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,-0.2168802);
   quadLineFit1123->SetParError(1,0.003475053);
