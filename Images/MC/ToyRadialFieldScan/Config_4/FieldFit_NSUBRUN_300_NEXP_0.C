...
//=========  (Thu Oct 15 00:39:58 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-0.3223241,75,0.2665905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01309->SetMinimum(-0.2634326);
   Graph_Graph01309->SetMaximum(0.207699);
   ...
   mainFit1310->SetChisquare(9.715636);
   ...
   mainFit1310->SetParameter(0,-0.02907054);
   mainFit1310->SetParError(0,0.0009070252);
   mainFit1310->SetParLimits(0,0,0);
   mainFit1310->SetParameter(1,-0.003806466);
   mainFit1310->SetParError(1,2.868266e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00381#pm2.87e-05");
   pt_LaTex = pt->AddText("#minus0.0291#pm0.000907");
   pt_LaTex = pt->AddText("#minus7.64#pm0.245");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.637147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.637147,-0.2634326,-7.637147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1311->SetChisquare(9.715636);
   ...
   mainFit1311->SetParameter(0,-0.02907054);
   mainFit1311->SetParError(0,0.0009070252);
   mainFit1311->SetParLimits(0,0,0);
   mainFit1311->SetParameter(1,-0.003806466);
   mainFit1311->SetParError(1,2.868266e-05);
