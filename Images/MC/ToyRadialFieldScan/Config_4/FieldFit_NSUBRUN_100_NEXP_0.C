...
//=========  (Fri Oct 16 07:50:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3185646,75,0.2615781);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.2605504);
   Graph_Graph01053->SetMaximum(0.2035638);
   ...
   mainFit1054->SetParameter(0,-0.03003137);
   mainFit1054->SetParError(0,0.002335925);
   mainFit1054->SetParLimits(0,0,0);
   mainFit1054->SetParameter(1,-0.003761028);
   mainFit1054->SetParError(1,6.606994e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm6.61e-05");
   pt_LaTex = pt->AddText("#minus0.03#pm0.00234");
   pt_LaTex = pt->AddText("#minus7.98#pm0.637");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.984885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.984885,-0.2605504,-7.984885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1055->SetParameter(0,-0.03003137);
   mainFit1055->SetParError(0,0.002335925);
   mainFit1055->SetParLimits(0,0,0);
   mainFit1055->SetParameter(1,-0.003761028);
   mainFit1055->SetParError(1,6.606994e-05);
