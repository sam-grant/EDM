...
//=========  (Fri Oct 16 07:51:08 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3188793,75,0.2521043);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01179->SetMinimum(-0.2617809);
   Graph_Graph01179->SetMaximum(0.1950059);
   ...
   mainFit1180->SetParameter(0,-0.02952546);
   mainFit1180->SetParError(0,0.001292566);
   mainFit1180->SetParLimits(0,0,0);
   mainFit1180->SetParameter(1,-0.003748045);
   mainFit1180->SetParError(1,3.655929e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm3.66e-05");
   pt_LaTex = pt->AddText("#minus0.0295#pm0.00129");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.877561,-0.2617809,-7.877561,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1181->SetParameter(0,-0.02952546);
   mainFit1181->SetParError(0,0.001292566);
   mainFit1181->SetParLimits(0,0,0);
   mainFit1181->SetParameter(1,-0.003748045);
   mainFit1181->SetParError(1,3.655929e-05);
