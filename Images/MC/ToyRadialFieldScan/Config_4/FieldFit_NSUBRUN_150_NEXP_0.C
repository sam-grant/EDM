...
//=========  (Fri Oct 16 07:51:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3167109,75,0.2498154);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01081->SetMinimum(-0.2600583);
   Graph_Graph01081->SetMaximum(0.1931628);
   ...
   mainFit1082->SetParameter(0,-0.03116124);
   mainFit1082->SetParError(0,0.001904924);
   mainFit1082->SetParLimits(0,0,0);
   mainFit1082->SetParameter(1,-0.003698021);
   mainFit1082->SetParError(1,5.387938e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0037#pm5.39e-05");
   pt_LaTex = pt->AddText("#minus0.0312#pm0.0019");
   pt_LaTex = pt->AddText("#minus8.43#pm 0.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.426463,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.426463,-0.2600583,-8.426463,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1083->SetParameter(0,-0.03116124);
   mainFit1083->SetParError(0,0.001904924);
   mainFit1083->SetParLimits(0,0,0);
   mainFit1083->SetParameter(1,-0.003698021);
   mainFit1083->SetParError(1,5.387938e-05);
