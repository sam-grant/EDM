...
//=========  (Thu Oct 15 00:39:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3231147,75,0.2612969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01179->SetMinimum(-0.2646735);
   Graph_Graph01179->SetMaximum(0.2028557);
   ...
   mainFit1180->SetParameter(0,-0.0324414);
   mainFit1180->SetParError(0,0.001188785);
   mainFit1180->SetParLimits(0,0,0);
   mainFit1180->SetParameter(1,-0.003722392);
   mainFit1180->SetParError(1,3.759267e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00372#pm3.76e-05");
   pt_LaTex = pt->AddText("#minus0.0324#pm0.00119");
   pt_LaTex = pt->AddText("#minus8.72#pm0.331");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.715203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.715203,-0.2646735,-8.715203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1181->SetParameter(0,-0.0324414);
   mainFit1181->SetParError(0,0.001188785);
   mainFit1181->SetParLimits(0,0,0);
   mainFit1181->SetParameter(1,-0.003722392);
   mainFit1181->SetParError(1,3.759267e-05);
