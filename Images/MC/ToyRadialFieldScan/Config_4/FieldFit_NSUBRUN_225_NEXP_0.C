...
//=========  (Thu Oct 15 00:39:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3132037,75,0.2565397);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01231->SetMinimum(-0.2562294);
   Graph_Graph01231->SetMaximum(0.1995654);
   ...
   mainFit1232->SetChisquare(8.876895);
   ...
   mainFit1232->SetParameter(0,-0.02925199);
   mainFit1232->SetParError(0,0.001047768);
   mainFit1232->SetParLimits(0,0,0);
   mainFit1232->SetParameter(1,-0.003756735);
   mainFit1232->SetParError(1,3.313333e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm3.31e-05");
   pt_LaTex = pt->AddText("#minus0.0293#pm0.00105");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.786547,-0.2562294,-7.786547,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1233->SetChisquare(8.876895);
   ...
   mainFit1233->SetParameter(0,-0.02925199);
   mainFit1233->SetParError(0,0.001047768);
   mainFit1233->SetParLimits(0,0,0);
   mainFit1233->SetParameter(1,-0.003756735);
   mainFit1233->SetParError(1,3.313333e-05);
