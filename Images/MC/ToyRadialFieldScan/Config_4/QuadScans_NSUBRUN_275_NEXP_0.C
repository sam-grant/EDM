...
//=========  (Fri Oct 16 07:51:06 2020) by ROOT version 6.22/02
   ...
   quadLineFit1142->SetChisquare(9.185775e-19);
   ...
   quadLineFit1142->SetParameter(0,-5.625356);
   quadLineFit1142->SetParError(0,0.05691197);
   quadLineFit1142->SetParLimits(0,0,0);
   quadLineFit1142->SetParameter(1,0.1542839);
   quadLineFit1142->SetParError(1,0.003142438);
   ...
   quadLineFit1143->SetChisquare(9.185775e-19);
   ...
   quadLineFit1143->SetParameter(0,-5.625356);
   quadLineFit1143->SetParError(0,0.05691197);
   quadLineFit1143->SetParLimits(0,0,0);
   quadLineFit1143->SetParameter(1,0.1542839);
   quadLineFit1143->SetParError(1,0.003142438);
   ...
   Graph_mI25dO000000sPppm1143->SetMinimum(-1.315862);
   Graph_mI25dO000000sPppm1143->SetMaximum(-0.9961735);
   ...
   quadLineFit1144->SetChisquare(1.726435e-18);
   ...
   quadLineFit1144->SetParameter(0,-2.274856);
   quadLineFit1144->SetParError(0,0.05691197);
   quadLineFit1144->SetParLimits(0,0,0);
   quadLineFit1144->SetParameter(1,0.06215767);
   quadLineFit1144->SetParError(1,0.003142438);
   ...
   quadLineFit1145->SetChisquare(1.726435e-18);
   ...
   quadLineFit1145->SetParameter(0,-2.274856);
   quadLineFit1145->SetParError(0,0.05691197);
   quadLineFit1145->SetParLimits(0,0,0);
   quadLineFit1145->SetParameter(1,0.06215767);
   quadLineFit1145->SetParError(1,0.003142438);
   ...
   Graph_0dO000000sPppm1145->SetMinimum(0.4577364);
   Graph_0dO000000sPppm1145->SetMaximum(0.6312996);
   ...
   quadLineFit1146->SetChisquare(1.059124e-21);
   ...
   quadLineFit1146->SetParameter(0,1.115386);
   quadLineFit1146->SetParError(0,0.05691197);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,-0.03171491);
   quadLineFit1146->SetParError(1,0.003142438);
   ...
   quadLineFit1147->SetChisquare(1.059124e-21);
   ...
   quadLineFit1147->SetParameter(0,1.115386);
   quadLineFit1147->SetParError(0,0.05691197);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,-0.03171491);
   quadLineFit1147->SetParError(1,0.003142438);
   ...
   Graph_25dO000000sPppm1147->SetMinimum(1.919519);
   Graph_25dO000000sPppm1147->SetMaximum(2.528101);
   ...
   quadLineFit1148->SetChisquare(2.946197e-19);
   ...
   quadLineFit1148->SetParameter(0,4.426);
   quadLineFit1148->SetParError(0,0.05691197);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,-0.1223439);
   quadLineFit1148->SetParError(1,0.003142438);
   ...
   quadLineFit1149->SetChisquare(2.946197e-19);
   ...
   quadLineFit1149->SetParameter(0,4.426);
   quadLineFit1149->SetParError(0,0.05691197);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,-0.1223439);
   quadLineFit1149->SetParError(1,0.003142438);
   ...
   Graph_50dO000000sPppm1149->SetMinimum(3.403426);
   Graph_50dO000000sPppm1149->SetMaximum(4.473163);
   ...
   quadLineFit1150->SetChisquare(6.465029e-18);
   ...
   quadLineFit1150->SetParameter(0,7.869813);
   quadLineFit1150->SetParError(0,0.05691197);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-0.2184177);
   quadLineFit1150->SetParError(1,0.003142438);
   ...
   quadLineFit1151->SetChisquare(6.465029e-18);
   ...
   quadLineFit1151->SetParameter(0,7.869813);
   quadLineFit1151->SetParError(0,0.05691197);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-0.2184177);
   quadLineFit1151->SetParError(1,0.003142438);
