...
//=========  (Fri Oct 16 07:50:56 2020) by ROOT version 6.22/02
   ...
   quadLineFit1030->SetChisquare(1.223462e-18);
   ...
   quadLineFit1030->SetParameter(0,-5.536217);
   quadLineFit1030->SetParError(0,0.1086052);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,0.1486983);
   ...
   quadLineFit1031->SetChisquare(1.223462e-18);
   ...
   quadLineFit1031->SetParameter(0,-5.536217);
   quadLineFit1031->SetParError(0,0.1086052);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,0.1486983);
   ...
   Graph_mI25dO000000sPppm1031->SetMinimum(-1.345048);
   Graph_mI25dO000000sPppm1031->SetMaximum(-0.9801808);
   ...
   quadLineFit1032->SetChisquare(1.677199e-20);
   ...
   quadLineFit1032->SetParameter(0,-2.378215);
   quadLineFit1032->SetParError(0,0.1086052);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.06753336);
   quadLineFit1032->SetParError(1,0.005996719);
   ...
   quadLineFit1033->SetChisquare(1.677199e-20);
   ...
   quadLineFit1033->SetParameter(0,-2.378215);
   quadLineFit1033->SetParError(0,0.1086052);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.06753336);
   quadLineFit1033->SetParError(1,0.005996719);
   ...
   Graph_0dO000000sPppm1033->SetMinimum(0.426468);
   Graph_0dO000000sPppm1033->SetMaximum(0.6331849);
   ...
   quadLineFit1034->SetChisquare(3.149913e-21);
   ...
   quadLineFit1034->SetParameter(0,1.152363);
   quadLineFit1034->SetParError(0,0.1086052);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,-0.03458538);
   ...
   quadLineFit1035->SetChisquare(3.149913e-21);
   ...
   quadLineFit1035->SetParameter(0,1.152363);
   quadLineFit1035->SetParError(0,0.1086052);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,-0.03458538);
   ...
   Graph_25dO000000sPppm1035->SetMinimum(1.936302);
   Graph_25dO000000sPppm1035->SetMaximum(2.536786);
   ...
   quadLineFit1036->SetChisquare(3.399217e-20);
   ...
   quadLineFit1036->SetParameter(0,4.335706);
   quadLineFit1036->SetParError(0,0.1086052);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.1166201);
   quadLineFit1036->SetParError(1,0.00599672);
   ...
   quadLineFit1037->SetChisquare(3.399217e-20);
   ...
   quadLineFit1037->SetParameter(0,4.335706);
   quadLineFit1037->SetParError(0,0.1086052);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.1166201);
   quadLineFit1037->SetParError(1,0.00599672);
   ...
   Graph_50dO000000sPppm1037->SetMinimum(3.410766);
   Graph_50dO000000sPppm1037->SetMaximum(4.442924);
   ...
   quadLineFit1038->SetChisquare(3.711016e-20);
   ...
   quadLineFit1038->SetParameter(0,7.644784);
   quadLineFit1038->SetParError(0,0.1086052);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.2065522);
   quadLineFit1038->SetParError(1,0.005996719);
   ...
   quadLineFit1039->SetChisquare(3.711016e-20);
   ...
   quadLineFit1039->SetParameter(0,7.644784);
   quadLineFit1039->SetParError(0,0.1086052);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.2065522);
   quadLineFit1039->SetParError(1,0.005996719);
