...
//=========  (Thu Oct 15 00:39:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.38492,75,85.80007);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01181->SetMinimum(-53.86642);
   Graph_Graph01181->SetMaximum(70.28157);
   ...
   checkFit1182->SetParameter(0,8.614508);
   checkFit1182->SetParError(0,0.3156705);
   checkFit1182->SetParLimits(0,0,0);
   checkFit1182->SetParameter(1,0.988446);
   checkFit1182->SetParError(1,0.009982379);
   ...
   pt_LaTex = pt->AddText("0.988#pm0.00998");
   pt_LaTex = pt->AddText(" 8.61#pm0.316");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.715203,-53.86642,-8.715203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1183->SetParameter(0,8.614508);
   checkFit1183->SetParError(0,0.3156705);
   checkFit1183->SetParLimits(0,0,0);
   checkFit1183->SetParameter(1,0.988446);
   checkFit1183->SetParError(1,0.009982379);
