...
//=========  (Fri Oct 16 07:51:01 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.8895,75,86.83755);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01097->SetMinimum(-51.51679);
   Graph_Graph01097->SetMaximum(71.46485);
   ...
   checkFit1098->SetParameter(0,8.305459);
   checkFit1098->SetParError(0,0.4682151);
   checkFit1098->SetParLimits(0,0,0);
   checkFit1098->SetParameter(1,1.000767);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0132");
   pt_LaTex = pt->AddText(" 8.31#pm0.468");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.29909,-51.51679,-8.29909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1099->SetParameter(0,8.305459);
   checkFit1099->SetParError(0,0.4682151);
   checkFit1099->SetParLimits(0,0,0);
   checkFit1099->SetParameter(1,1.000767);
