...
//=========  (Fri Oct 16 07:51:07 2020) by ROOT version 6.22/02
   ...
   quadLineFit1156->SetChisquare(9.491706e-18);
   ...
   quadLineFit1156->SetParameter(0,-5.690477);
   quadLineFit1156->SetParError(0,0.05448195);
   quadLineFit1156->SetParLimits(0,0,0);
   quadLineFit1156->SetParameter(1,0.1584422);
   quadLineFit1156->SetParError(1,0.003008262);
   ...
   quadLineFit1157->SetChisquare(9.491706e-18);
   ...
   quadLineFit1157->SetParameter(0,-5.690477);
   quadLineFit1157->SetParError(0,0.05448195);
   quadLineFit1157->SetParLimits(0,0,0);
   quadLineFit1157->SetParameter(1,0.1584422);
   quadLineFit1157->SetParError(1,0.003008262);
   ...
   Graph_mI25dO000000sPppm1157->SetMinimum(-1.318546);
   Graph_mI25dO000000sPppm1157->SetMaximum(-0.9952638);
   ...
   quadLineFit1158->SetChisquare(1.772106e-19);
   ...
   quadLineFit1158->SetParameter(0,-2.292637);
   quadLineFit1158->SetParError(0,0.05448195);
   quadLineFit1158->SetParLimits(0,0,0);
   quadLineFit1158->SetParameter(1,0.0630962);
   quadLineFit1158->SetParError(1,0.003008262);
   ...
   quadLineFit1159->SetChisquare(1.772106e-19);
   ...
   quadLineFit1159->SetParameter(0,-2.292637);
   quadLineFit1159->SetParError(0,0.05448195);
   quadLineFit1159->SetParLimits(0,0,0);
   quadLineFit1159->SetParameter(1,0.0630962);
   quadLineFit1159->SetParError(1,0.003008262);
   ...
   Graph_0dO000000sPppm1159->SetMinimum(0.4503658);
   Graph_0dO000000sPppm1159->SetMaximum(0.6207662);
   ...
   quadLineFit1160->SetChisquare(1.098585e-18);
   ...
   quadLineFit1160->SetParameter(0,1.097989);
   quadLineFit1160->SetParError(0,0.05448195);
   quadLineFit1160->SetParLimits(0,0,0);
   quadLineFit1160->SetParameter(1,-0.03124575);
   quadLineFit1160->SetParError(1,0.003008262);
   ...
   quadLineFit1161->SetChisquare(1.098585e-18);
   ...
   quadLineFit1161->SetParameter(0,1.097989);
   quadLineFit1161->SetParError(0,0.05448195);
   quadLineFit1161->SetParLimits(0,0,0);
   quadLineFit1161->SetParameter(1,-0.03124575);
   quadLineFit1161->SetParError(1,0.003008262);
   ...
   Graph_25dO000000sPppm1161->SetMinimum(1.934731);
   Graph_25dO000000sPppm1161->SetMaximum(2.536875);
   ...
   quadLineFit1162->SetChisquare(1.374342e-19);
   ...
   quadLineFit1162->SetParameter(0,4.417264);
   quadLineFit1162->SetParError(0,0.05448195);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,-0.1211923);
   quadLineFit1162->SetParError(1,0.003008262);
   ...
   quadLineFit1163->SetChisquare(1.374342e-19);
   ...
   quadLineFit1163->SetParameter(0,4.417264);
   quadLineFit1163->SetParError(0,0.05448195);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,-0.1211923);
   quadLineFit1163->SetParError(1,0.003008262);
   ...
   Graph_50dO000000sPppm1163->SetMinimum(3.392235);
   Graph_50dO000000sPppm1163->SetMaximum(4.479153);
   ...
   quadLineFit1164->SetChisquare(1.945482e-18);
   ...
   quadLineFit1164->SetParameter(0,7.935058);
   quadLineFit1164->SetParError(0,0.05448195);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,-0.2221869);
   quadLineFit1164->SetParError(1,0.003008262);
   ...
   quadLineFit1165->SetChisquare(1.945482e-18);
   ...
   quadLineFit1165->SetParameter(0,7.935058);
   quadLineFit1165->SetParError(0,0.05448195);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,-0.2221869);
   quadLineFit1165->SetParError(1,0.003008262);
