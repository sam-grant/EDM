...
//=========  (Fri Oct 16 07:51:05 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3194393,75,0.2636739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01137->SetMinimum(-0.261128);
   Graph_Graph01137->SetMaximum(0.2053626);
   ...
   mainFit1138->SetParameter(0,-0.0309427);
   mainFit1138->SetParError(0,0.00147406);
   mainFit1138->SetParLimits(0,0,0);
   mainFit1138->SetParameter(1,-0.003800484);
   mainFit1138->SetParError(1,4.169273e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0038#pm4.17e-05");
   pt_LaTex = pt->AddText("#minus0.0309#pm0.00147");
   pt_LaTex = pt->AddText("#minus8.14#pm0.398");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.141778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.141778,-0.261128,-8.141778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1139->SetParameter(0,-0.0309427);
   mainFit1139->SetParError(0,0.00147406);
   mainFit1139->SetParLimits(0,0,0);
   mainFit1139->SetParameter(1,-0.003800484);
   mainFit1139->SetParError(1,4.169273e-05);
