...
//=========  (Fri Oct 16 07:51:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.70276,75,86.40073);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1111[5] = {
   -50,
   -25,
   0,
   25,
   50};
   Double_t Graph0_fy1111[5] = {
   -42.70655,
   -17.48478,
   9.110171,
   33.2913,
   59.40452};
   Double_t Graph0_fex1111[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1111[5] = {
   0.9789638,
   0.9789638,
   0.9789638,
   0.9789638,
   0.9789638};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1111,Graph0_fy1111,Graph0_fex1111,Graph0_fey1111);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 200");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01111 = new TH1F("Graph_Graph01111","Sub-runs 200",100,-60,60);
   Graph_Graph01111->SetMinimum(-54.09241);
   Graph_Graph01111->SetMaximum(70.79038);
   ...
   Graph_Graph01111->GetXaxis()->SetTitle("Applied B_{r} [ppm]");
   ...
   checkFit1112->SetChisquare(1.048223);
   ...
   checkFit1112->SetParameter(0,8.322932);
   checkFit1112->SetParError(0,0.4378059);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,1.019993);
   checkFit1112->SetParError(1,0.01238302);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0124");
   pt_LaTex = pt->AddText(" 8.32#pm0.438");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.159795,-54.09241,-8.159795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetChisquare(1.048223);
   ...
   checkFit1113->SetParameter(0,8.322932);
   checkFit1113->SetParError(0,0.4378059);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,1.019993);
   checkFit1113->SetParError(1,0.01238302);
