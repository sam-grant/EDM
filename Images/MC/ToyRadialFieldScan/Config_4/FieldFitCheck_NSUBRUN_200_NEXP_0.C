...
//=========  (Thu Oct 15 00:39:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.34874,75,86.77228);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01207->SetMinimum(-52.83664);
   Graph_Graph01207->SetMaximum(71.26018);
   ...
   checkFit1208->SetParameter(0,8.377011);
   checkFit1208->SetParError(0,0.2951687);
   checkFit1208->SetParLimits(0,0,0);
   checkFit1208->SetParameter(1,1.001234);
   checkFit1208->SetParError(1,0.009334053);
   ...
   pt_LaTex = pt->AddText("    1#pm0.00933");
   pt_LaTex = pt->AddText(" 8.38#pm0.295");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.366685,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.366685,-52.83664,-8.366685,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1209->SetParameter(0,8.377011);
   checkFit1209->SetParError(0,0.2951687);
   checkFit1209->SetParLimits(0,0,0);
   checkFit1209->SetParameter(1,1.001234);
   checkFit1209->SetParError(1,0.009334053);
