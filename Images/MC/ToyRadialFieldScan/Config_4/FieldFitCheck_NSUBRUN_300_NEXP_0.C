...
//=========  (Thu Oct 15 00:39:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.7906,75,85.59013);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01311->SetMinimum(-55.15252);
   Graph_Graph01311->SetMaximum(69.95205);
   ...
   checkFit1312->SetParameter(0,7.719407);
   checkFit1312->SetParError(0,0.240852);
   checkFit1312->SetParLimits(0,0,0);
   checkFit1312->SetParameter(1,1.010771);
   checkFit1312->SetParError(1,0.00761641);
   ...
   pt_LaTex = pt->AddText(" 7.72#pm0.241");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.637147,-55.15252,-7.637147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1313->SetParameter(0,7.719407);
   checkFit1313->SetParError(0,0.240852);
   checkFit1313->SetParLimits(0,0,0);
   checkFit1313->SetParameter(1,1.010771);
   checkFit1313->SetParError(1,0.00761641);
