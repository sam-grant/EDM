...
//=========  (Thu Oct 15 00:39:36 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.84653,75,82.66887);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.59499);
   Graph_Graph01025->SetMaximum(67.41733);
   ...
   checkFit1026->SetParameter(0,8.289219);
   checkFit1026->SetParError(0,0.8272543);
   checkFit1026->SetParLimits(0,0,0);
   checkFit1026->SetParameter(1,0.9844586);
   ...
   pt_LaTex = pt->AddText("0.984#pm0.0262");
   pt_LaTex = pt->AddText(" 8.29#pm0.827");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.420078,-54.59499,-8.420078,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1027->SetParameter(0,8.289219);
   checkFit1027->SetParError(0,0.8272543);
   checkFit1027->SetParLimits(0,0,0);
   checkFit1027->SetParameter(1,0.9844586);
