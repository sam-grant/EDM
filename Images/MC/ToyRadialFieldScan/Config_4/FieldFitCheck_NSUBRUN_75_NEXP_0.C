...
//=========  (Fri Oct 16 07:50:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.45735,75,80.81989);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(-50.82963);
   Graph_Graph01041->SetMaximum(66.19217);
   ...
   checkFit1042->SetParameter(0,7.516175);
   checkFit1042->SetParError(0,0.7121306);
   checkFit1042->SetParLimits(0,0,0);
   checkFit1042->SetParameter(1,0.9502682);
   checkFit1042->SetParError(1,0.02014209);
   ...
   pt_LaTex = pt->AddText(" 0.95#pm0.0201");
   pt_LaTex = pt->AddText(" 7.52#pm0.712");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.90953,-50.82963,-7.90953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1043->SetParameter(0,7.516175);
   checkFit1043->SetParError(0,0.7121306);
   checkFit1043->SetParLimits(0,0,0);
   checkFit1043->SetParameter(1,0.9502682);
   checkFit1043->SetParError(1,0.02014209);
