...
//=========  (Thu Oct 15 00:39:40 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.17112,75,85.2213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-50.13188);
   Graph_Graph01077->SetMaximum(70.18205);
   ...
   checkFit1078->SetParameter(0,8.59031);
   checkFit1078->SetParError(0,0.4801183);
   checkFit1078->SetParLimits(0,0,0);
   checkFit1078->SetParameter(1,1.00015);
   checkFit1078->SetParError(1,0.01518268);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0152");
   pt_LaTex = pt->AddText(" 8.59#pm 0.48");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.589018,-50.13188,-8.589018,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1079->SetParameter(0,8.59031);
   checkFit1079->SetParError(0,0.4801183);
   checkFit1079->SetParLimits(0,0,0);
   checkFit1079->SetParameter(1,1.00015);
   checkFit1079->SetParError(1,0.01518268);
