...
//=========  (Fri Oct 16 07:50:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3274611,75,0.2662629);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-0.2680887);
   Graph_Graph01011->SetMaximum(0.2068905);
   ...
   mainFit1012->SetParameter(0,-0.03177014);
   mainFit1012->SetParError(0,0.004620825);
   mainFit1012->SetParLimits(0,0,0);
   mainFit1012->SetParameter(1,-0.003752039);
   mainFit1012->SetParError(1,0.0001306967);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm0.000131");
   pt_LaTex = pt->AddText("#minus0.0318#pm0.00462");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.467433,-0.2680887,-8.467433,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1013->SetParameter(0,-0.03177014);
   mainFit1013->SetParError(0,0.004620825);
   mainFit1013->SetParLimits(0,0,0);
   mainFit1013->SetParameter(1,-0.003752039);
   mainFit1013->SetParError(1,0.0001306967);
