...
//=========  (Fri Oct 16 07:51:05 2020) by ROOT version 6.22/02
   ...
   quadLineFit1128->SetChisquare(2.678724e-17);
   ...
   quadLineFit1128->SetParameter(0,-5.783256);
   quadLineFit1128->SetParError(0,0.0596949);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,0.1631923);
   ...
   quadLineFit1129->SetChisquare(2.678724e-17);
   ...
   quadLineFit1129->SetParameter(0,-5.783256);
   quadLineFit1129->SetParError(0,0.0596949);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,0.1631923);
   ...
   Graph_mI25dO000000sPppm1129->SetMinimum(-1.29897);
   Graph_mI25dO000000sPppm1129->SetMaximum(-0.9782892);
   ...
   quadLineFit1130->SetChisquare(1.404629e-18);
   ...
   quadLineFit1130->SetParameter(0,-2.257277);
   quadLineFit1130->SetParError(0,0.0596949);
   quadLineFit1130->SetParLimits(0,0,0);
   quadLineFit1130->SetParameter(1,0.0621471);
   quadLineFit1130->SetParError(1,0.003296099);
   ...
   quadLineFit1131->SetChisquare(1.404629e-18);
   ...
   quadLineFit1131->SetParameter(0,-2.257277);
   quadLineFit1131->SetParError(0,0.0596949);
   quadLineFit1131->SetParLimits(0,0,0);
   quadLineFit1131->SetParameter(1,0.0621471);
   quadLineFit1131->SetParError(1,0.003296099);
   ...
   Graph_0dO000000sPppm1131->SetMinimum(0.4420272);
   Graph_0dO000000sPppm1131->SetMaximum(0.6440237);
   ...
   quadLineFit1132->SetChisquare(1.257844e-20);
   ...
   quadLineFit1132->SetParameter(0,1.216607);
   quadLineFit1132->SetParError(0,0.0596949);
   quadLineFit1132->SetParLimits(0,0,0);
   quadLineFit1132->SetParameter(1,-0.0374212);
   quadLineFit1132->SetParError(1,0.003296099);
   ...
   quadLineFit1133->SetChisquare(1.257844e-20);
   ...
   quadLineFit1133->SetParameter(0,1.216607);
   quadLineFit1133->SetParError(0,0.0596949);
   quadLineFit1133->SetParLimits(0,0,0);
   quadLineFit1133->SetParameter(1,-0.0374212);
   quadLineFit1133->SetParError(1,0.003296099);
   ...
   Graph_25dO000000sPppm1133->SetMinimum(1.93089);
   Graph_25dO000000sPppm1133->SetMaximum(2.5469);
   ...
   quadLineFit1134->SetChisquare(4.882462e-20);
   ...
   quadLineFit1134->SetParameter(0,4.465027);
   quadLineFit1134->SetParError(0,0.0596949);
   quadLineFit1134->SetParLimits(0,0,0);
   quadLineFit1134->SetParameter(1,-0.123674);
   quadLineFit1134->SetParError(1,0.003296099);
   ...
   quadLineFit1135->SetChisquare(4.882462e-20);
   ...
   quadLineFit1135->SetParameter(0,4.465027);
   quadLineFit1135->SetParError(0,0.0596949);
   quadLineFit1135->SetParLimits(0,0,0);
   quadLineFit1135->SetParameter(1,-0.123674);
   quadLineFit1135->SetParError(1,0.003296099);
   ...
   Graph_50dO000000sPppm1135->SetMinimum(3.390336);
   Graph_50dO000000sPppm1135->SetMaximum(4.463708);
   ...
   quadLineFit1136->SetChisquare(6.167534e-19);
   ...
   quadLineFit1136->SetParameter(0,7.86826);
   quadLineFit1136->SetParError(0,0.0596949);
   quadLineFit1136->SetParLimits(0,0,0);
   quadLineFit1136->SetParameter(1,-0.2189577);
   quadLineFit1136->SetParError(1,0.003296099);
   ...
   quadLineFit1137->SetChisquare(6.167534e-19);
   ...
   quadLineFit1137->SetParameter(0,7.86826);
   quadLineFit1137->SetParError(0,0.0596949);
   quadLineFit1137->SetParLimits(0,0,0);
   quadLineFit1137->SetParameter(1,-0.2189577);
   quadLineFit1137->SetParError(1,0.003296099);
