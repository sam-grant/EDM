...
//=========  (Fri Oct 16 07:51:08 2020) by ROOT version 6.22/02
   ...
   quadLineFit1170->SetChisquare(6.123982e-20);
   ...
   quadLineFit1170->SetParameter(0,-5.617227);
   quadLineFit1170->SetParError(0,0.05234493);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,0.1540501);
   quadLineFit1170->SetParError(1,0.002890265);
   ...
   quadLineFit1171->SetChisquare(6.123982e-20);
   ...
   quadLineFit1171->SetParameter(0,-5.617227);
   quadLineFit1171->SetParError(0,0.05234493);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,0.1540501);
   quadLineFit1171->SetParError(1,0.002890265);
   ...
   Graph_mI25dO000000sPppm1171->SetMinimum(-1.315217);
   Graph_mI25dO000000sPppm1171->SetMaximum(-0.974536);
   ...
   quadLineFit1172->SetChisquare(1.673739e-21);
   ...
   quadLineFit1172->SetParameter(0,-2.348856);
   quadLineFit1172->SetParError(0,0.05234493);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,0.06688774);
   quadLineFit1172->SetParError(1,0.002890265);
   ...
   quadLineFit1173->SetChisquare(1.673739e-21);
   ...
   quadLineFit1173->SetParameter(0,-2.348856);
   quadLineFit1173->SetParError(0,0.05234493);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,0.06688774);
   quadLineFit1173->SetParError(1,0.002890265);
   ...
   Graph_0dO000000sPppm1173->SetMinimum(0.4617646);
   Graph_0dO000000sPppm1173->SetMaximum(0.6127451);
   ...
   quadLineFit1174->SetChisquare(4.929061e-19);
   ...
   quadLineFit1174->SetParameter(0,1.029858);
   quadLineFit1174->SetParError(0,0.05234493);
   quadLineFit1174->SetParLimits(0,0,0);
   quadLineFit1174->SetParameter(1,-0.02736683);
   quadLineFit1174->SetParError(1,0.002890265);
   ...
   quadLineFit1175->SetChisquare(4.929061e-19);
   ...
   quadLineFit1175->SetParameter(0,1.029858);
   quadLineFit1175->SetParError(0,0.05234493);
   quadLineFit1175->SetParLimits(0,0,0);
   quadLineFit1175->SetParameter(1,-0.02736683);
   quadLineFit1175->SetParError(1,0.002890265);
   ...
   Graph_25dO000000sPppm1175->SetMinimum(1.923585);
   Graph_25dO000000sPppm1175->SetMaximum(2.520996);
   ...
   quadLineFit1176->SetChisquare(2.120418e-19);
   ...
   quadLineFit1176->SetParameter(0,4.389008);
   quadLineFit1176->SetParError(0,0.05234493);
   quadLineFit1176->SetParLimits(0,0,0);
   quadLineFit1176->SetParameter(1,-0.1203732);
   quadLineFit1176->SetParError(1,0.002890265);
   ...
   quadLineFit1177->SetChisquare(2.120418e-19);
   ...
   quadLineFit1177->SetParameter(0,4.389008);
   quadLineFit1177->SetParError(0,0.05234493);
   quadLineFit1177->SetParLimits(0,0,0);
   quadLineFit1177->SetParameter(1,-0.1203732);
   quadLineFit1177->SetParError(1,0.002890265);
   ...
   Graph_50dO000000sPppm1177->SetMinimum(3.391997);
   Graph_50dO000000sPppm1177->SetMaximum(4.471578);
   ...
   quadLineFit1178->SetChisquare(5.191366e-21);
   ...
   quadLineFit1178->SetParameter(0,7.906639);
   quadLineFit1178->SetParError(0,0.05234493);
   quadLineFit1178->SetParLimits(0,0,0);
   quadLineFit1178->SetParameter(1,-0.2208251);
   quadLineFit1178->SetParError(1,0.002890265);
   ...
   quadLineFit1179->SetChisquare(5.191366e-21);
   ...
   quadLineFit1179->SetParameter(0,7.906639);
   quadLineFit1179->SetParError(0,0.05234493);
   quadLineFit1179->SetParLimits(0,0,0);
   quadLineFit1179->SetParameter(1,-0.2208251);
   quadLineFit1179->SetParError(1,0.002890265);
