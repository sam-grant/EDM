...
//=========  (Thu Oct 15 00:39:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3163393,75,0.2614829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01127->SetMinimum(-0.2585571);
   Graph_Graph01127->SetMaximum(0.2037006);
   ...
   mainFit1128->SetParameter(0,-0.02889526);
   mainFit1128->SetParError(0,0.001407496);
   mainFit1128->SetParLimits(0,0,0);
   mainFit1128->SetParameter(1,-0.00372886);
   mainFit1128->SetParError(1,4.450895e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00373#pm4.45e-05");
   pt_LaTex = pt->AddText("#minus0.0289#pm0.00141");
   pt_LaTex = pt->AddText("#minus7.75#pm0.389");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.749087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.749087,-0.2585571,-7.749087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1129->SetParameter(0,-0.02889526);
   mainFit1129->SetParError(0,0.001407496);
   mainFit1129->SetParLimits(0,0,0);
   mainFit1129->SetParameter(1,-0.00372886);
   mainFit1129->SetParError(1,4.450895e-05);
