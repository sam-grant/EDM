...
//=========  (Fri Oct 16 07:50:59 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3167352,75,0.2582476);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01067->SetMinimum(-0.2592369);
   Graph_Graph01067->SetMaximum(0.2007493);
   ...
   mainFit1068->SetParameter(0,-0.03286306);
   mainFit1068->SetParError(0,0.002087655);
   mainFit1068->SetParLimits(0,0,0);
   mainFit1068->SetParameter(1,-0.003718127);
   mainFit1068->SetParError(1,5.904779e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00372#pm5.9e-05");
   pt_LaTex = pt->AddText("#minus0.0329#pm0.00209");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.838606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.838606,-0.2592369,-8.838606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1069->SetParameter(0,-0.03286306);
   mainFit1069->SetParError(0,0.002087655);
   mainFit1069->SetParLimits(0,0,0);
   mainFit1069->SetParameter(1,-0.003718127);
   mainFit1069->SetParError(1,5.904779e-05);
