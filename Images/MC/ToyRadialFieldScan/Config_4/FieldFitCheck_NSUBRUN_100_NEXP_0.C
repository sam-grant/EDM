...
//=========  (Thu Oct 15 00:39:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.32509,75,84.6661);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01103->SetMinimum(-54.82597);
   Graph_Graph01103->SetMaximum(69.16698);
   ...
   checkFit1104->SetParameter(0,7.530674);
   checkFit1104->SetParError(0,0.4181946);
   checkFit1104->SetParLimits(0,0,0);
   checkFit1104->SetParameter(1,1.006151);
   ...
   pt_LaTex = pt->AddText(" 7.53#pm0.418");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.484639,-54.82597,-7.484639,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1105->SetParameter(0,7.530674);
   checkFit1105->SetParError(0,0.4181946);
   checkFit1105->SetParLimits(0,0,0);
   checkFit1105->SetParameter(1,1.006151);
