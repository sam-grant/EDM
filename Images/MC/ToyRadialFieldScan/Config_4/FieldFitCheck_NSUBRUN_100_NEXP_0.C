...
//=========  (Fri Oct 16 07:50:58 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.4596,75,84.59184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01055->SetMinimum(-54.05445);
   Graph_Graph01055->SetMaximum(69.1867);
   ...
   checkFit1056->SetParameter(0,7.974549);
   checkFit1056->SetParError(0,0.620283);
   checkFit1056->SetParLimits(0,0,0);
   checkFit1056->SetParameter(1,0.9987054);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.0175");
   pt_LaTex = pt->AddText(" 7.97#pm 0.62");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.984886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.984886,-54.05445,-7.984886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1057->SetParameter(0,7.974549);
   checkFit1057->SetParError(0,0.620283);
   checkFit1057->SetParLimits(0,0,0);
   checkFit1057->SetParameter(1,0.9987054);
