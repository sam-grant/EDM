...
//=========  (Fri Oct 16 07:51:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3253767,75,0.2624938);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1109[5] = {
   -50,
   -25,
   0,
   25,
   50};
   Double_t Graph0_fy1109[5] = {
   0.1608287,
   0.06584598,
   -0.03430802,
   -0.1253718,
   -0.2237116};
   Double_t Graph0_fex1109[5] = {
   0,
   0,
   0,
   0,
   0};
   Double_t Graph0_fey1109[5] = {
   0.003686683,
   0.003686683,
   0.003686683,
   0.003686683,
   0.003686682};
   TGraphErrors *gre = new TGraphErrors(5,Graph0_fx1109,Graph0_fy1109,Graph0_fex1109,Graph0_fey1109);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 200");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01109 = new TH1F("Graph_Graph01109","Sub-runs 200",100,-60,60);
   Graph_Graph01109->SetMinimum(-0.2665897);
   Graph_Graph01109->SetMaximum(0.2037068);
   ...
   mainFit1110->SetChisquare(1.048223);
   mainFit1110->SetNDF(3);
   ...
   mainFit1110->SetParameter(0,-0.03134335);
   mainFit1110->SetParError(0,0.001648735);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,-0.003841194);
   mainFit1110->SetParError(1,4.663326e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.349");
   pt_LaTex = pt->AddText("#minus0.00384#pm4.66e-05");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00165");
   pt_LaTex = pt->AddText("#minus8.16#pm0.441");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.159795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.159795,-0.2665897,-8.159795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetChisquare(1.048223);
   mainFit1111->SetNDF(3);
   ...
   mainFit1111->SetParameter(0,-0.03134335);
   mainFit1111->SetParError(0,0.001648735);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,-0.003841194);
   mainFit1111->SetParError(1,4.663326e-05);
