...
//=========  (Thu Oct 15 00:39:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.326776,75,0.2573947);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01205->SetMinimum(-0.2683589);
   Graph_Graph01205->SetMaximum(0.1989776);
   ...
   mainFit1206->SetChisquare(5.203278);
   ...
   mainFit1206->SetParameter(0,-0.03154701);
   mainFit1206->SetParError(0,0.001111577);
   mainFit1206->SetParLimits(0,0,0);
   mainFit1206->SetParameter(1,-0.003770551);
   mainFit1206->SetParError(1,3.515114e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00377#pm3.52e-05");
   pt_LaTex = pt->AddText("#minus0.0315#pm0.00111");
   pt_LaTex = pt->AddText("#minus8.37#pm0.305");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.366686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.366686,-0.2683589,-8.366686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1207->SetChisquare(5.203278);
   ...
   mainFit1207->SetParameter(0,-0.03154701);
   mainFit1207->SetParError(0,0.001111577);
   mainFit1207->SetParLimits(0,0,0);
   mainFit1207->SetParameter(1,-0.003770551);
   mainFit1207->SetParError(1,3.515114e-05);
