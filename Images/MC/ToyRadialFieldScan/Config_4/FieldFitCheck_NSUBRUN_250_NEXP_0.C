...
//=========  (Fri Oct 16 07:51:05 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.01612,75,84.82409);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01139->SetMinimum(-54.5321);
   Graph_Graph01139->SetMaximum(69.34007);
   ...
   checkFit1140->SetParameter(0,8.216541);
   checkFit1140->SetParError(0,0.3914229);
   checkFit1140->SetParLimits(0,0,0);
   checkFit1140->SetParameter(1,1.009183);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0111");
   pt_LaTex = pt->AddText(" 8.22#pm0.391");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.141778,-54.5321,-8.141778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1141->SetParameter(0,8.216541);
   checkFit1141->SetParError(0,0.3914229);
   checkFit1141->SetParLimits(0,0,0);
   checkFit1141->SetParameter(1,1.009183);
