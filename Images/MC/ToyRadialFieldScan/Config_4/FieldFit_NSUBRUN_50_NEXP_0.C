...
//=========  (Fri Oct 16 07:50:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3341368,75,0.263317);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","Sub-runs 50",100,-60,60);
   Graph_Graph01025->SetMinimum(-0.2743914);
   Graph_Graph01025->SetMaximum(0.2035716);
   ...
   Graph_Graph01025->GetYaxis()->SetTitle("#LTy#GT / QHV [mm/kV]");
   ...
   TF1 *mainFit1026 = new TF1("mainFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   mainFit1026->SetChisquare(1.547522);
   ...
   mainFit1026->SetParameter(0,-0.03510587);
   mainFit1026->SetParError(0,0.003279328);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,-0.003882595);
   mainFit1026->SetParError(1,9.275341e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00388#pm9.28e-05");
   pt_LaTex = pt->AddText("#minus0.0351#pm0.00328");
   pt_LaTex = pt->AddText("#minus9.04#pm0.872");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.041858,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.041858,-0.2743914,-9.041858,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.547522);
   ...
   mainFit1027->SetParameter(0,-0.03510587);
   mainFit1027->SetParError(0,0.003279328);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,-0.003882595);
   mainFit1027->SetParError(1,9.275341e-05);
