void QuadScans_NSUBRUN_528_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:40 2022) by ROOT version 6.24/06
   ...
   Graph_30dO000000sPppm1057->SetMinimum(-2.367139);
   Graph_30dO000000sPppm1057->SetMaximum(3.180096);
   ...
   quadLineFit1058->SetChisquare(4.927576e-25);
   ...
   quadLineFit1058->SetParameter(0,-3.530509e-13);
   quadLineFit1058->SetParError(0,5.700877);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,45.79338);
   quadLineFit1058->SetParError(1,89.09545);
   ...
   quadLineFit1059->SetChisquare(4.927576e-25);
   ...
   quadLineFit1059->SetParameter(0,-3.530509e-13);
   quadLineFit1059->SetParError(0,5.700877);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,45.79338);
   quadLineFit1059->SetParError(1,89.09545);
   ...
   Graph_mI30dO000000sPppm1059->SetMinimum(-1.935794);
   Graph_mI30dO000000sPppm1059->SetMaximum(-1.430804);
   ...
   quadLineFit1060->SetChisquare(1.296134e-25);
   ...
   quadLineFit1060->SetParameter(0,1.341149e-13);
   quadLineFit1060->SetParError(0,5.700877);
   quadLineFit1060->SetParLimits(0,0,0);
   quadLineFit1060->SetParameter(1,-26.51196);
   quadLineFit1060->SetParError(1,89.09545);
   ...
   quadLineFit1061->SetChisquare(1.296134e-25);
   ...
   quadLineFit1061->SetParameter(0,1.341149e-13);
   quadLineFit1061->SetParError(0,5.700877);
   quadLineFit1061->SetParLimits(0,0,0);
   quadLineFit1061->SetParameter(1,-26.51196);
   quadLineFit1061->SetParError(1,89.09545);
