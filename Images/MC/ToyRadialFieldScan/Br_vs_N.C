...
//=========  (Sat Jun 25 13:30:55 2022) by ROOT version 6.24/06
   ...
   c->Range(-1669544,5.639402,1.502589e+07,10.36448);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","",100,0,1.362893e+07);
   Graph_Graph01001->SetMinimum(6.11191);
   Graph_Graph01001->SetMaximum(9.89197);
   ...
   Graph_Graph01001->GetXaxis()->SetTitle("CTAGs / setting");
   Graph_Graph01001->GetXaxis()->SetRange(1,98);
   Graph_Graph01001->GetXaxis()->CenterTitle(true);
   Graph_Graph01001->GetXaxis()->SetLabelFont(42);
   Graph_Graph01001->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph01001->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph01001->GetXaxis()->SetTitleFont(42);
   Graph_Graph01001->GetYaxis()->SetTitle("#LTB_{r}^{b}#GT [ppm]");
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,9.89197,1.335635e+07,9.89197,0,344.5,510,"-");
