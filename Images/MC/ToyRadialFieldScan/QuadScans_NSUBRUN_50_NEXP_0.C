...
//=========  (Tue Oct  6 23:07:50 2020) by ROOT version 6.22/02
   ...
   quadLineFit1012->SetChisquare(6.974276e-19);
   ...
   quadLineFit1012->SetParameter(0,-4.418025);
   quadLineFit1012->SetParError(0,0.1341256);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,0.1274863);
   quadLineFit1012->SetParError(1,0.007405848);
   ...
   quadLineFit1013->SetChisquare(6.974276e-19);
   ...
   quadLineFit1013->SetParameter(0,-4.418025);
   quadLineFit1013->SetParError(0,0.1341256);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,0.1274863);
   quadLineFit1013->SetParError(1,0.007405848);
   ...
   Graph_mI10dO000000sPppm1013->SetMinimum(-1.16416);
   Graph_mI10dO000000sPppm1013->SetMaximum(-0.8138049);
   ...
   quadLineFit1014->SetChisquare(1.218652e-19);
   ...
   quadLineFit1014->SetParameter(0,-2.114293);
   quadLineFit1014->SetParError(0,0.1341256);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.06251724);
   ...
   quadLineFit1015->SetChisquare(1.218652e-19);
   ...
   quadLineFit1015->SetParameter(0,-2.114293);
   quadLineFit1015->SetParError(0,0.1341256);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.06251724);
   ...
   Graph_10dO000000sPppm1015->SetMinimum(0.09409272);
   Graph_10dO000000sPppm1015->SetMaximum(0.1721822);
   ...
   quadLineFit1016->SetChisquare(1.120435e-23);
   ...
   quadLineFit1016->SetParameter(0,0.2374508);
   quadLineFit1016->SetParError(0,0.1341256);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,-0.005795184);
   ...
   quadLineFit1017->SetChisquare(1.120435e-23);
   ...
   quadLineFit1017->SetParameter(0,0.2374508);
   quadLineFit1017->SetParError(0,0.1341256);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,-0.005795184);
   ...
   Graph_30dO000000sPppm1017->SetMinimum(1.027179);
   Graph_30dO000000sPppm1017->SetMaximum(1.449771);
   ...
   quadLineFit1018->SetChisquare(1.17783e-18);
   ...
   quadLineFit1018->SetParameter(0,2.634671);
   quadLineFit1018->SetParError(0,0.1341256);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.07756642);
   quadLineFit1018->SetParError(1,0.007405847);
   ...
   quadLineFit1019->SetChisquare(1.17783e-18);
   ...
   quadLineFit1019->SetParameter(0,2.634671);
   quadLineFit1019->SetParError(0,0.1341256);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.07756642);
   quadLineFit1019->SetParError(1,0.007405847);
