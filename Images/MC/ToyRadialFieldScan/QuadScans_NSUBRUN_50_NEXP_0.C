...
//=========  (Mon Oct 12 16:23:45 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(2.558159e-20);
   ...
   quadLineFit1002->SetParameter(0,-2.967888);
   quadLineFit1002->SetParError(0,0.1328027);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.08284986);
   quadLineFit1002->SetParError(1,0.007332801);
   ...
   quadLineFit1003->SetChisquare(2.558159e-20);
   ...
   quadLineFit1003->SetParameter(0,-2.967888);
   quadLineFit1003->SetParError(0,0.1328027);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.08284986);
   quadLineFit1003->SetParError(1,0.007332801);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.1638298);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.07790041);
   ...
   quadLineFit1004->SetChisquare(2.917332e-22);
   ...
   quadLineFit1004->SetParameter(0,-0.2564376);
   quadLineFit1004->SetParError(0,0.1328027);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.007531806);
   quadLineFit1004->SetParError(1,0.007332801);
   ...
   quadLineFit1005->SetChisquare(2.917332e-22);
   ...
   quadLineFit1005->SetParameter(0,-0.2564376);
   quadLineFit1005->SetParError(0,0.1328027);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.007531806);
   quadLineFit1005->SetParError(1,0.007332801);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(1.047285);
   Graph_10dO000000sPppm1005->SetMaximum(1.422435);
   ...
   quadLineFit1006->SetChisquare(1.43032e-20);
   ...
   quadLineFit1006->SetParameter(0,2.455012);
   quadLineFit1006->SetParError(0,0.1328027);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.06778625);
   quadLineFit1006->SetParError(1,0.007332801);
   ...
   quadLineFit1007->SetChisquare(1.43032e-20);
   ...
   quadLineFit1007->SetParameter(0,2.455012);
   quadLineFit1007->SetParError(0,0.1328027);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.06778625);
   quadLineFit1007->SetParError(1,0.007332801);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(2.222246);
   Graph_30dO000000sPppm1007->SetMaximum(2.958924);
   ...
   quadLineFit1008->SetChisquare(2.010411e-19);
   ...
   quadLineFit1008->SetParameter(0,5.166462);
   quadLineFit1008->SetParError(0,0.1328027);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1431043);
   quadLineFit1008->SetParError(1,0.007332801);
   ...
   quadLineFit1009->SetChisquare(2.010411e-19);
   ...
   quadLineFit1009->SetParameter(0,5.166462);
   quadLineFit1009->SetParError(0,0.1328027);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1431043);
   quadLineFit1009->SetParError(1,0.007332801);
