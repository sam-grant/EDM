...
//=========  (Wed Dec  2 23:07:54 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1013 = new TH1F("Graph_mI30dO000000sPppm1013","",100,0.05396825,0.07301587);
   ...
   Graph_mI30dO000000sPppm1013->GetXaxis()->SetTitle("1/QHV [kV^{-1}]");
   ...
   TF1 *quadLineFit1014 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1014->SetFillColor(19);
   quadLineFit1014->SetFillStyle(0);
   quadLineFit1014->SetLineWidth(2);
   quadLineFit1014->SetChisquare(0.726737);
   ...
   quadLineFit1014->SetParameter(0,-0.1074603);
   quadLineFit1014->SetParError(0,0.1181934);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,-24.50174);
   quadLineFit1014->SetParError(1,1.861471);
   quadLineFit1014->SetParLimits(1,0,0);
   quadLineFit1014->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1014);
   gre->Draw("ap");
   
   TF1 *quadLineFit1015 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1015->SetFillColor(19);
   quadLineFit1015->SetFillStyle(0);
   quadLineFit1015->SetLineWidth(2);
   quadLineFit1015->SetChisquare(0.726737);
   ...
   quadLineFit1015->SetParameter(0,-0.1074603);
   quadLineFit1015->SetParError(0,0.1181934);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,-24.50174);
   quadLineFit1015->SetParError(1,1.861471);
   ...
   TH1F *Graph_mI10dO000000sPppm1015 = new TH1F("Graph_mI10dO000000sPppm1015","Graph",100,0.05396825,0.07301587);
   Graph_mI10dO000000sPppm1015->SetMinimum(-0.2013744);
   Graph_mI10dO000000sPppm1015->SetMaximum(-0.09025131);
   ...
   TF1 *quadLineFit1016 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1016->SetChisquare(0.7543042);
   ...
   quadLineFit1016->SetParameter(0,0.07060609);
   quadLineFit1016->SetParError(0,0.1181909);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,-3.294082);
   quadLineFit1016->SetParError(1,1.86143);
   quadLineFit1016->SetParLimits(1,0,0);
   quadLineFit1016->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1016);
   gre->Draw("p ");
   
   TF1 *quadLineFit1017 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1017->SetChisquare(0.7543042);
   ...
   quadLineFit1017->SetParameter(0,0.07060609);
   quadLineFit1017->SetParError(0,0.1181909);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,-3.294082);
   quadLineFit1017->SetParError(1,1.86143);
   ...
   TH1F *Graph_10dO000000sPppm1017 = new TH1F("Graph_10dO000000sPppm1017","Graph",100,0.05396825,0.07301587);
   Graph_10dO000000sPppm1017->SetMinimum(1.123286);
   Graph_10dO000000sPppm1017->SetMaximum(1.623754);
   ...
   quadLineFit1018->SetChisquare(0.03001079);
   ...
   quadLineFit1018->SetParameter(0,-0.1241789);
   quadLineFit1018->SetParError(0,0.1181904);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,23.61203);
   quadLineFit1018->SetParError(1,1.861423);
   ...
   quadLineFit1019->SetChisquare(0.03001079);
   ...
   quadLineFit1019->SetParameter(0,-0.1241789);
   quadLineFit1019->SetParError(0,0.1181904);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,23.61203);
   quadLineFit1019->SetParError(1,1.861423);
   ...
   Graph_30dO000000sPppm1019->SetMinimum(2.432496);
   Graph_30dO000000sPppm1019->SetMaximum(3.35252);
   ...
   quadLineFit1020->SetChisquare(0.0002242966);
   ...
   quadLineFit1020->SetParameter(0,-0.006407416);
   quadLineFit1020->SetParError(0,0.11819);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,45.65993);
   quadLineFit1020->SetParError(1,1.861417);
   ...
   quadLineFit1021->SetChisquare(0.0002242966);
   ...
   quadLineFit1021->SetParameter(0,-0.006407416);
   quadLineFit1021->SetParError(0,0.11819);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,45.65993);
   quadLineFit1021->SetParError(1,1.861417);
