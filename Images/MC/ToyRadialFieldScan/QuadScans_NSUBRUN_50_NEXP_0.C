...
//=========  (Mon Oct 12 20:04:17 2020) by ROOT version 6.22/02
   ...
   quadLineFit1012->SetChisquare(4.672875e-20);
   ...
   quadLineFit1012->SetParameter(0,-3.01395);
   quadLineFit1012->SetParError(0,0.1328027);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,0.08468384);
   ...
   quadLineFit1013->SetChisquare(4.672875e-20);
   ...
   quadLineFit1013->SetParameter(0,-3.01395);
   quadLineFit1013->SetParError(0,0.1328027);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,0.08468384);
   ...
   Graph_mI10dO000000sPppm1013->SetMinimum(-0.1745232);
   Graph_mI10dO000000sPppm1013->SetMaximum(-0.1107012);
   ...
   quadLineFit1014->SetChisquare(1.448102e-22);
   ...
   quadLineFit1014->SetParameter(0,-0.195282);
   quadLineFit1014->SetParError(0,0.1328027);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.002926098);
   ...
   quadLineFit1015->SetChisquare(1.448102e-22);
   ...
   quadLineFit1015->SetParameter(0,-0.195282);
   quadLineFit1015->SetParError(0,0.1328027);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.002926098);
   ...
   Graph_10dO000000sPppm1015->SetMinimum(1.088479);
   Graph_10dO000000sPppm1015->SetMaximum(1.410306);
   ...
   quadLineFit1016->SetChisquare(1.856133e-18);
   ...
   quadLineFit1016->SetParameter(0,2.26958);
   quadLineFit1016->SetParError(0,0.1328027);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,-0.05667708);
   ...
   quadLineFit1017->SetChisquare(1.856133e-18);
   ...
   quadLineFit1017->SetParameter(0,2.26958);
   quadLineFit1017->SetParError(0,0.1328027);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,-0.05667708);
   ...
   Graph_30dO000000sPppm1017->SetMinimum(2.199239);
   Graph_30dO000000sPppm1017->SetMaximum(2.972779);
   ...
   quadLineFit1018->SetChisquare(6.096274e-19);
   ...
   quadLineFit1018->SetParameter(0,5.300123);
   quadLineFit1018->SetParError(0,0.1328027);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.1507841);
   ...
   quadLineFit1019->SetChisquare(6.096274e-19);
   ...
   quadLineFit1019->SetParameter(0,5.300123);
   quadLineFit1019->SetParError(0,0.1328027);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.1507841);
