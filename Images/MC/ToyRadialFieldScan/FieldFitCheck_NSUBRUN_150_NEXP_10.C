void FieldFitCheck_NSUBRUN_150_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.8208,75,395.5);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-56.58867);
   Graph_Graph01095->SetMaximum(345.268);
   ...
   checkFit1096->SetChisquare(119391.1);
   ...
   checkFit1096->SetParameter(0,66.28915);
   checkFit1096->SetParError(0,0.2874528);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,-1.538027);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.98e+04");
   pt_LaTex = pt->AddText("-1.54
#pm0.008
");
   pt_LaTex = pt->AddText("66.3
#pm0.3
");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.10011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.10011,-56.58867,43.10011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(119391.1);
   ...
   checkFit1097->SetParameter(0,66.28915);
   checkFit1097->SetParError(0,0.2874528);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,-1.538027);
