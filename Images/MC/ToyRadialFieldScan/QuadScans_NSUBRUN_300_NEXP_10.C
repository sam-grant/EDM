void QuadScans_NSUBRUN_300_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.213329,0.0663141,7.511702);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1177->SetMinimum(-3.940826);
   Graph_mI50dO000000sPppm1177->SetMaximum(6.239199);
   ...
   TF1 *quadLineFit1178 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1178->SetFillColor(19);
   quadLineFit1178->SetFillStyle(0);
   quadLineFit1178->SetLineWidth(2);
   quadLineFit1178->SetChisquare(0.1092139);
   ...
   quadLineFit1178->SetParameter(0,-0.1476987);
   quadLineFit1178->SetParError(0,0.06028351);
   quadLineFit1178->SetParLimits(0,0,0);
   quadLineFit1178->SetParameter(1,-48.09328);
   quadLineFit1178->SetParError(1,1.064424);
   quadLineFit1178->SetParLimits(1,0,0);
   quadLineFit1178->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1178);
   gre->Draw("ap");
   
   TF1 *quadLineFit1179 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1179->SetFillColor(19);
   quadLineFit1179->SetFillStyle(0);
   quadLineFit1179->SetLineWidth(2);
   quadLineFit1179->SetChisquare(0.1092139);
   ...
   quadLineFit1179->SetParameter(0,-0.1476987);
   quadLineFit1179->SetParError(0,0.06028351);
   quadLineFit1179->SetParLimits(0,0,0);
   quadLineFit1179->SetParameter(1,-48.09328);
   quadLineFit1179->SetParError(1,1.064424);
   ...
   Graph_mI30dO000000sPppm1179->SetMinimum(-1.95017);
   Graph_mI30dO000000sPppm1179->SetMaximum(-1.312449);
   ...
   TF1 *quadLineFit1180 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1180->SetChisquare(0.5357827);
   ...
   quadLineFit1180->SetParameter(0,-0.0539085);
   quadLineFit1180->SetParError(0,0.0339145);
   quadLineFit1180->SetParLimits(0,0,0);
   quadLineFit1180->SetParameter(1,-25.68845);
   quadLineFit1180->SetParError(1,0.5589774);
   quadLineFit1180->SetParLimits(1,0,0);
   quadLineFit1180->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1180);
   gre->Draw("p ");
   
   TF1 *quadLineFit1181 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1181->SetChisquare(0.5357827);
   ...
   quadLineFit1181->SetParameter(0,-0.0539085);
   quadLineFit1181->SetParError(0,0.0339145);
   quadLineFit1181->SetParLimits(0,0,0);
   quadLineFit1181->SetParameter(1,-25.68845);
   quadLineFit1181->SetParError(1,0.5589774);
   ...
   Graph_mI10dO000000sPppm1181->SetMinimum(-0.1889844);
   Graph_mI10dO000000sPppm1181->SetMaximum(-0.1018739);
   ...
   TF1 *quadLineFit1182 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1182->SetChisquare(1.497234);
   ...
   quadLineFit1182->SetParameter(0,0.03741888);
   quadLineFit1182->SetParError(0,0.03391349);
   quadLineFit1182->SetParLimits(0,0,0);
   quadLineFit1182->SetParameter(1,-2.897096);
   quadLineFit1182->SetParError(1,0.5589606);
   quadLineFit1182->SetParLimits(1,0,0);
   quadLineFit1182->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1182);
   gre->Draw("p ");
   
   TF1 *quadLineFit1183 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1183->SetChisquare(1.497234);
   ...
   quadLineFit1183->SetParameter(0,0.03741888);
   quadLineFit1183->SetParError(0,0.03391349);
   quadLineFit1183->SetParLimits(0,0,0);
   quadLineFit1183->SetParameter(1,-2.897096);
   quadLineFit1183->SetParError(1,0.5589606);
   ...
   Graph_10dO000000sPppm1183->SetMinimum(1.046678);
   Graph_10dO000000sPppm1183->SetMaximum(1.608485);
   ...
   TF1 *quadLineFit1184 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1184->SetChisquare(0.6509026);
   ...
   quadLineFit1184->SetParameter(0,-0.04716777);
   quadLineFit1184->SetParError(0,0.0371816);
   quadLineFit1184->SetParLimits(0,0,0);
   quadLineFit1184->SetParameter(1,22.3607);
   quadLineFit1184->SetParError(1,0.5969619);
   quadLineFit1184->SetParLimits(1,0,0);
   quadLineFit1184->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1184);
   gre->Draw("p ");
   
   TF1 *quadLineFit1185 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1185->SetChisquare(0.6509026);
   ...
   quadLineFit1185->SetParameter(0,-0.04716777);
   quadLineFit1185->SetParError(0,0.0371816);
   quadLineFit1185->SetParLimits(0,0,0);
   quadLineFit1185->SetParameter(1,22.3607);
   quadLineFit1185->SetParError(1,0.5969619);
   ...
   Graph_30dO000000sPppm1185->SetMinimum(2.248173);
   Graph_30dO000000sPppm1185->SetMaximum(3.356766);
   ...
   TF1 *quadLineFit1186 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1186->SetChisquare(2.585102);
   ...
   quadLineFit1186->SetParameter(0,0.0239432);
   quadLineFit1186->SetParError(0,0.03391276);
   quadLineFit1186->SetParLimits(0,0,0);
   quadLineFit1186->SetParameter(1,45.30092);
   quadLineFit1186->SetParError(1,0.5589496);
   quadLineFit1186->SetParLimits(1,0,0);
   quadLineFit1186->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1186);
   gre->Draw("p ");
   
   TF1 *quadLineFit1187 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1187->SetChisquare(2.585102);
   ...
   quadLineFit1187->SetParameter(0,0.0239432);
   quadLineFit1187->SetParError(0,0.03391276);
   quadLineFit1187->SetParLimits(0,0,0);
   quadLineFit1187->SetParameter(1,45.30092);
   quadLineFit1187->SetParError(1,0.5589496);
   ...
   Graph_50dO000000sPppm1187->SetMinimum(3.445717);
   Graph_50dO000000sPppm1187->SetMaximum(5.141169);
   ...
   TF1 *quadLineFit1188 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1188->SetChisquare(0.9223879);
   ...
   quadLineFit1188->SetParameter(0,0.02782879);
   quadLineFit1188->SetParError(0,0.03391712);
   quadLineFit1188->SetParLimits(0,0,0);
   quadLineFit1188->SetParameter(1,69.48337);
   quadLineFit1188->SetParError(1,0.5590204);
   quadLineFit1188->SetParLimits(1,0,0);
   quadLineFit1188->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1188);
   gre->Draw("p ");
   
   TF1 *quadLineFit1189 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1189->SetChisquare(0.9223879);
   ...
   quadLineFit1189->SetParameter(0,0.02782879);
   quadLineFit1189->SetParError(0,0.03391712);
   quadLineFit1189->SetParLimits(0,0,0);
   quadLineFit1189->SetParameter(1,69.48337);
   quadLineFit1189->SetParError(1,0.5590204);
