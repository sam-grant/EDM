...
//=========  (Wed Jan  5 17:38:05 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01021->SetMinimum(-34.19557);
   Graph_Graph01021->SetMaximum(53.83078);
   ...
   mainFit1022->SetChisquare(1.297635e-12);
   ...
   mainFit1022->SetParameter(0,9.817605);
   mainFit1022->SetParError(0,0.6618263);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.191389);
   mainFit1022->SetParError(1,0.02206088);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.240466,-34.19557,-8.240466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(1.297635e-12);
   ...
   mainFit1023->SetParameter(0,9.817605);
   mainFit1023->SetParError(0,0.6618263);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,1.191389);
   mainFit1023->SetParError(1,0.02206088);
