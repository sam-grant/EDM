...
//=========  (Wed Jan  5 17:10:34 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01005->SetMinimum(-35.95531);
   Graph_Graph01005->SetMaximum(55.21498);
   ...
   mainFit1006->SetChisquare(1.049686e-14);
   ...
   mainFit1006->SetParameter(0,9.629833);
   mainFit1006->SetParError(0,1.156459);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,1.211738);
   mainFit1006->SetParError(1,0.03854862);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.947124,-35.95531,-7.947124,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(1.049686e-14);
   ...
   mainFit1007->SetParameter(0,9.629833);
   mainFit1007->SetParError(0,1.156459);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,1.211738);
   mainFit1007->SetParError(1,0.03854862);
