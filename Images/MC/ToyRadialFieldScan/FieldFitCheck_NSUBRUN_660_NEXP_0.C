void FieldFitCheck_NSUBRUN_660_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:42 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01079->SetMinimum(-28);
   Graph_Graph01079->SetMaximum(44);
   ...
   checkFit1080->SetChisquare(3.048279e-18);
   ...
   checkFit1080->SetParameter(0,8);
   checkFit1080->SetParError(0,0.7071068);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,1);
   checkFit1080->SetParError(1,0.02357023);
...
");
   ...
   checkFit1081->SetChisquare(3.048279e-18);
   ...
   checkFit1081->SetParameter(0,8);
   checkFit1081->SetParError(0,0.7071068);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,1);
   checkFit1081->SetParError(1,0.02357023);
