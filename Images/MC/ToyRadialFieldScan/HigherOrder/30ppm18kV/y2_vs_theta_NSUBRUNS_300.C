void y2_vs_theta_NSUBRUNS_300()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 27 09:19:56 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-49.3125,0.3633381,443.8125,0.7006513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04067438,
   0.04205097};
   TGraphErrors *gre = new TGraphErrors(24,Graph0_fx1035,Graph0_fy1035,Graph0_fex1035,Graph0_fey1035);
   gre->SetName("Graph0");
   gre->SetTitle("300 sub-runs");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","300 sub-runs",100,0,394.5);
   Graph_Graph01035->SetMinimum(0.3970694);
   Graph_Graph01035->SetMaximum(0.66692);
   ...
   Graph_Graph01035->GetXaxis()->SetTitle("#theta [deg]");
   ...
   Graph_Graph01035->GetYaxis()->SetTitle("#LTy_{2}#GT [mm]");
