...
//=========  (Fri Nov 27 09:19:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-49.3125,0.04557763,443.8125,0.2622673);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","300 sub-runs",100,0,394.5);
   Graph_Graph01036->SetMinimum(0.0672466);
   Graph_Graph01036->SetMaximum(0.2405983);
   ...
   Graph_Graph01036->GetYaxis()->SetTitle("#LTy_{1}#GT - #LTy_{2}#GT [mm]");
