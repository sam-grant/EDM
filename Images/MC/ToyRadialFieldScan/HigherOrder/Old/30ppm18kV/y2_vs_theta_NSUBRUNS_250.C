void y2_vs_theta_NSUBRUNS_250()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Nov 27 09:19:56 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-49.3125,0.3567525,443.8125,0.7066808);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04456516,
   0.04606199};
   TGraphErrors *gre = new TGraphErrors(24,Graph0_fx1029,Graph0_fy1029,Graph0_fex1029,Graph0_fey1029);
   gre->SetName("Graph0");
   gre->SetTitle("250 sub-runs");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","250 sub-runs",100,0,394.5);
   Graph_Graph01029->SetMinimum(0.3917453);
   Graph_Graph01029->SetMaximum(0.671688);
   ...
   Graph_Graph01029->GetXaxis()->SetTitle("#theta [deg]");
   ...
   Graph_Graph01029->GetYaxis()->SetTitle("#LTy_{2}#GT [mm]");
