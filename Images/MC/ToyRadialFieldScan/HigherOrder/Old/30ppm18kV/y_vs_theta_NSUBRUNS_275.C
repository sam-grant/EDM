...
//=========  (Fri Nov 27 09:19:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-49.3125,0.04074355,443.8125,0.2671014);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","275 sub-runs",100,0,394.5);
   Graph_Graph01033->SetMinimum(0.06337934);
   Graph_Graph01033->SetMaximum(0.2444656);
   ...
   Graph_Graph01033->GetXaxis()->SetTitle("#theta [deg]");
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("#LTy_{1}#GT - #LTy_{2}#GT [mm]");
