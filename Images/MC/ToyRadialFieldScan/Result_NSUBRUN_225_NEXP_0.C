...
//=========  (Fri Oct  9 09:35:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1171931,45,0.1655915);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01089->SetMinimum(-0.08891466);
   Graph_Graph01089->SetMaximum(0.1373131);
   ...
   fieldLineFit1090->SetChisquare(1.767001);
   ...
   fieldLineFit1090->SetParameter(0,0.02439847);
   fieldLineFit1090->SetParError(0,0.001737526);
   fieldLineFit1090->SetParLimits(0,0,0);
   fieldLineFit1090->SetParameter(1,-0.002991914);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.884");
   pt_LaTex = pt->AddText("#minus0.00299#pm7.77e-05");
   pt_LaTex = pt->AddText("0.0244#pm0.00174");
   pt_LaTex = pt->AddText(" 8.15#pm0.581");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,8.154802,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8.154802,-0.08891466,8.154802,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1091->SetChisquare(1.767001);
   ...
   fieldLineFit1091->SetParameter(0,0.02439847);
   fieldLineFit1091->SetParError(0,0.001737526);
   fieldLineFit1091->SetParLimits(0,0,0);
   fieldLineFit1091->SetParameter(1,-0.002991914);
