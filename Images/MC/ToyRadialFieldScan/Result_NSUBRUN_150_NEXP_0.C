...
//=========  (Tue Oct  6 23:07:53 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1214352,45,0.1850382);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(-0.09078786);
   Graph_Graph01059->SetMaximum(0.1543909);
   ...
   fieldLineFit1060->SetChisquare(5.15499);
   ...
   fieldLineFit1060->SetParameter(0,0.02697301);
   fieldLineFit1060->SetParError(0,0.002136841);
   fieldLineFit1060->SetParLimits(0,0,0);
   fieldLineFit1060->SetParameter(1,-0.003269857);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.58");
   pt_LaTex = pt->AddText("#minus0.00327#pm9.56e-05");
   pt_LaTex = pt->AddText("0.027#pm0.00214");
   pt_LaTex = pt->AddText(" 8.25#pm0.697");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,8.248988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8.248988,-0.09078786,8.248988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1061->SetChisquare(5.15499);
   ...
   fieldLineFit1061->SetParameter(0,0.02697301);
   fieldLineFit1061->SetParError(0,0.002136841);
   fieldLineFit1061->SetParLimits(0,0,0);
   fieldLineFit1061->SetParameter(1,-0.003269857);
