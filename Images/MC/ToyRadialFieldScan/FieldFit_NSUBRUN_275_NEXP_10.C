void FieldFit_NSUBRUN_275_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:38 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-81.22379,75,101.2467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01173->SetMinimum(-62.97674);
   Graph_Graph01173->SetMaximum(82.99961);
   ...
   mainFit1174->SetChisquare(4.801601);
   ...
   mainFit1174->SetParameter(0,9.536543);
   mainFit1174->SetParError(0,0.2633866);
   mainFit1174->SetParLimits(0,0,0);
   mainFit1174->SetParameter(1,1.214168);
   mainFit1174->SetParError(1,0.008309682);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.854385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.854385,-62.97674,-7.854385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1175->SetChisquare(4.801601);
   ...
   mainFit1175->SetParameter(0,9.536543);
   mainFit1175->SetParError(0,0.2633866);
   mainFit1175->SetParLimits(0,0,0);
   mainFit1175->SetParameter(1,1.214168);
   mainFit1175->SetParError(1,0.008309682);
