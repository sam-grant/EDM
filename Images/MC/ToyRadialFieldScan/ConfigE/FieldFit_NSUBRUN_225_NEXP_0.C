...
//=========  (Tue Oct 20 15:08:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.255656,45,0.1784785);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.2122426);
   Graph_Graph01105->SetMaximum(0.1350651);
   ...
   mainFit1106->SetChisquare(4.130796);
   ...
   mainFit1106->SetParameter(0,-0.03692201);
   mainFit1106->SetParError(0,0.001737526);
   mainFit1106->SetParLimits(0,0,0);
   mainFit1106->SetParameter(1,-0.004754294);
   mainFit1106->SetParError(1,7.770452e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00475#pm7.77e-05");
   pt_LaTex = pt->AddText("#minus0.0369#pm0.00174");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.766034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.766034,-0.2122426,-7.766034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1107->SetChisquare(4.130796);
   ...
   mainFit1107->SetParameter(0,-0.03692201);
   mainFit1107->SetParError(0,0.001737526);
   mainFit1107->SetParLimits(0,0,0);
   mainFit1107->SetParameter(1,-0.004754294);
   mainFit1107->SetParError(1,7.770452e-05);
