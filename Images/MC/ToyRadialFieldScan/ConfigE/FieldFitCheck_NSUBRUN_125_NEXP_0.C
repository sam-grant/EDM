...
//=========  (Tue Oct 20 15:08:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.11179,45,52.34976);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(-27.26563);
   Graph_Graph01059->SetMaximum(43.5036);
   ...
   checkFit1060->SetParameter(0,7.448497);
   checkFit1060->SetParError(0,0.4880846);
   checkFit1060->SetParLimits(0,0,0);
   checkFit1060->SetParameter(1,0.9493718);
   ...
   pt_LaTex = pt->AddText("0.949#pm0.0218");
   pt_LaTex = pt->AddText(" 7.45#pm0.488");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.845711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.845711,-27.26563,-7.845711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1061->SetParameter(0,7.448497);
   checkFit1061->SetParError(0,0.4880846);
   checkFit1061->SetParLimits(0,0,0);
   checkFit1061->SetParameter(1,0.9493718);
