...
//=========  (Tue Oct 20 15:08:46 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1049 = new TH1F("Graph_mI30dO000000sPppm1049","",100,13.6,18.4);
   ...
   quadLineFit1050->SetChisquare(0.351937);
   ...
   quadLineFit1050->SetParameter(0,-3.238251);
   quadLineFit1050->SetParError(0,0.07507818);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.09751668);
   quadLineFit1050->SetParError(1,0.004668136);
   ...
   quadLineFit1051->SetChisquare(0.351937);
   ...
   quadLineFit1051->SetParameter(0,-3.238251);
   quadLineFit1051->SetParError(0,0.07507818);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.09751668);
   quadLineFit1051->SetParError(1,0.004668136);
   ...
   TH1F *Graph_mI10dO000000sPppm1051 = new TH1F("Graph_mI10dO000000sPppm1051","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1051->SetMinimum(-0.1991397);
   Graph_mI10dO000000sPppm1051->SetMaximum(-0.1071707);
   ...
   quadLineFit1052->SetChisquare(0.3294898);
   ...
   quadLineFit1052->SetParameter(0,-0.3571849);
   quadLineFit1052->SetParError(0,0.07507822);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.01255847);
   quadLineFit1052->SetParError(1,0.004668139);
   ...
   quadLineFit1053->SetChisquare(0.3294898);
   ...
   quadLineFit1053->SetParameter(0,-0.3571849);
   quadLineFit1053->SetParError(0,0.07507822);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.01255847);
   quadLineFit1053->SetParError(1,0.004668139);
   ...
   TH1F *Graph_10dO000000sPppm1053 = new TH1F("Graph_10dO000000sPppm1053","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1053->SetMinimum(1.1806);
   ...
   quadLineFit1054->SetChisquare(1.707749);
   ...
   quadLineFit1054->SetParameter(0,2.613278);
   quadLineFit1054->SetParError(0,0.07507837);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,-0.07738469);
   quadLineFit1054->SetParError(1,0.004668148);
   ...
   quadLineFit1055->SetChisquare(1.707749);
   ...
   quadLineFit1055->SetParameter(0,2.613278);
   quadLineFit1055->SetParError(0,0.07507837);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,-0.07738469);
   quadLineFit1055->SetParError(1,0.004668148);
   ...
   TH1F *Graph_30dO000000sPppm1055 = new TH1F("Graph_30dO000000sPppm1055","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1055->SetMinimum(2.467608);
   Graph_30dO000000sPppm1055->SetMaximum(3.340104);
   ...
   quadLineFit1056->SetChisquare(4.093895);
   ...
   quadLineFit1056->SetParameter(0,5.695641);
   quadLineFit1056->SetParError(0,0.07507801);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.1751683);
   quadLineFit1056->SetParError(1,0.004668126);
   ...
   quadLineFit1057->SetChisquare(4.093895);
   ...
   quadLineFit1057->SetParameter(0,5.695641);
   quadLineFit1057->SetParError(0,0.07507801);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.1751683);
   quadLineFit1057->SetParError(1,0.004668126);
