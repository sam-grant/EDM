...
//=========  (Tue Oct 20 15:08:52 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1121 = new TH1F("Graph_mI30dO000000sPppm1121","",100,13.6,18.4);
   ...
   quadLineFit1122->SetChisquare(1.511377);
   ...
   quadLineFit1122->SetParameter(0,-3.315323);
   quadLineFit1122->SetParError(0,0.05054017);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,0.1027114);
   quadLineFit1122->SetParError(1,0.003142436);
   ...
   quadLineFit1123->SetChisquare(1.511377);
   ...
   quadLineFit1123->SetParameter(0,-3.315323);
   quadLineFit1123->SetParError(0,0.05054017);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,0.1027114);
   quadLineFit1123->SetParError(1,0.003142436);
   ...
   TH1F *Graph_mI10dO000000sPppm1123 = new TH1F("Graph_mI10dO000000sPppm1123","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1123->SetMinimum(-0.1756531);
   Graph_mI10dO000000sPppm1123->SetMaximum(-0.1198308);
   ...
   quadLineFit1124->SetChisquare(2.308392);
   ...
   quadLineFit1124->SetParameter(0,-0.2487125);
   quadLineFit1124->SetParError(0,0.05054032);
   quadLineFit1124->SetParLimits(0,0,0);
   quadLineFit1124->SetParameter(1,0.006101592);
   quadLineFit1124->SetParError(1,0.003142445);
   ...
   quadLineFit1125->SetChisquare(2.308392);
   ...
   quadLineFit1125->SetParameter(0,-0.2487125);
   quadLineFit1125->SetParError(0,0.05054032);
   quadLineFit1125->SetParLimits(0,0,0);
   quadLineFit1125->SetParameter(1,0.006101592);
   quadLineFit1125->SetParError(1,0.003142445);
   ...
   TH1F *Graph_10dO000000sPppm1125 = new TH1F("Graph_10dO000000sPppm1125","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1125->SetMinimum(1.168402);
   Graph_10dO000000sPppm1125->SetMaximum(1.567094);
   ...
   TF1 *quadLineFit1126 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1126->SetChisquare(3.200276);
   ...
   quadLineFit1126->SetParameter(0,2.619123);
   quadLineFit1126->SetParError(0,0.05054017);
   quadLineFit1126->SetParLimits(0,0,0);
   quadLineFit1126->SetParameter(1,-0.07861661);
   quadLineFit1126->SetParError(1,0.003142436);
   quadLineFit1126->SetParLimits(1,0,0);
   quadLineFit1126->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1126);
   gre->Draw("p ");
   
   TF1 *quadLineFit1127 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1127->SetChisquare(3.200276);
   ...
   quadLineFit1127->SetParameter(0,2.619123);
   quadLineFit1127->SetParError(0,0.05054017);
   quadLineFit1127->SetParLimits(0,0,0);
   quadLineFit1127->SetParameter(1,-0.07861661);
   quadLineFit1127->SetParError(1,0.003142436);
   ...
   TH1F *Graph_30dO000000sPppm1127 = new TH1F("Graph_30dO000000sPppm1127","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1127->SetMinimum(2.464547);
   Graph_30dO000000sPppm1127->SetMaximum(3.348481);
   ...
   TF1 *quadLineFit1128 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1128->SetChisquare(24.70214);
   ...
   quadLineFit1128->SetParameter(0,5.763821);
   quadLineFit1128->SetParError(0,0.05054022);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,-0.1797088);
   quadLineFit1128->SetParError(1,0.003142439);
   quadLineFit1128->SetParLimits(1,0,0);
   quadLineFit1128->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1128);
   gre->Draw("p ");
   
   TF1 *quadLineFit1129 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1129->SetChisquare(24.70214);
   ...
   quadLineFit1129->SetParameter(0,5.763821);
   quadLineFit1129->SetParError(0,0.05054022);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,-0.1797088);
   quadLineFit1129->SetParError(1,0.003142439);
