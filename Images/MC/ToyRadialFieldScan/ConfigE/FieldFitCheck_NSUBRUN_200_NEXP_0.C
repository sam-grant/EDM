...
//=========  (Tue Oct 20 15:08:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.90423,45,52.78733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-27.93508);
   Graph_Graph01095->SetMaximum(43.81817);
   ...
   checkFit1096->SetParameter(0,7.933283);
   checkFit1096->SetParError(0,0.385467);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.964585);
   checkFit1096->SetParError(1,0.01723861);
   ...
   pt_LaTex = pt->AddText("0.965#pm0.0172");
   pt_LaTex = pt->AddText(" 7.93#pm0.385");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.224556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.224556,-27.93508,-8.224556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetParameter(0,7.933283);
   checkFit1097->SetParError(0,0.385467);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.964585);
   checkFit1097->SetParError(1,0.01723861);
