...
//=========  (Tue Oct 20 15:08:42 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1001 = new TH1F("Graph_mI30dO000000sPppm1001","",100,13.6,18.4);
   ...
   quadLineFit1002->SetChisquare(1.97723);
   ...
   quadLineFit1002->SetParameter(0,-3.127538);
   quadLineFit1002->SetParError(0,0.1661785);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.09080911);
   ...
   quadLineFit1003->SetChisquare(1.97723);
   ...
   quadLineFit1003->SetParameter(0,-3.127538);
   quadLineFit1003->SetParError(0,0.1661785);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.09080911);
   ...
   TH1F *Graph_mI10dO000000sPppm1003 = new TH1F("Graph_mI10dO000000sPppm1003","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.2459885);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.08927175);
   ...
   quadLineFit1004->SetChisquare(1.854118);
   ...
   quadLineFit1004->SetParameter(0,-0.3513313);
   quadLineFit1004->SetParError(0,0.1661783);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.01170522);
   quadLineFit1004->SetParError(1,0.01033247);
   ...
   quadLineFit1005->SetChisquare(1.854118);
   ...
   quadLineFit1005->SetParameter(0,-0.3513313);
   quadLineFit1005->SetParError(0,0.1661783);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.01170522);
   quadLineFit1005->SetParError(1,0.01033247);
   ...
   TH1F *Graph_10dO000000sPppm1005 = new TH1F("Graph_10dO000000sPppm1005","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1005->SetMinimum(1.16466);
   Graph_10dO000000sPppm1005->SetMaximum(1.586487);
   ...
   quadLineFit1006->SetChisquare(1.216211);
   ...
   quadLineFit1006->SetParameter(0,2.534709);
   quadLineFit1006->SetParError(0,0.1661784);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.07326834);
   ...
   quadLineFit1007->SetChisquare(1.216211);
   ...
   quadLineFit1007->SetParameter(0,2.534709);
   quadLineFit1007->SetParError(0,0.1661784);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.07326834);
   ...
   TH1F *Graph_30dO000000sPppm1007 = new TH1F("Graph_30dO000000sPppm1007","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1007->SetMinimum(2.45584);
   Graph_30dO000000sPppm1007->SetMaximum(3.404144);
   ...
   quadLineFit1008->SetChisquare(0.2645583);
   ...
   quadLineFit1008->SetParameter(0,5.851071);
   quadLineFit1008->SetParError(0,0.1661784);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.182951);
   ...
   quadLineFit1009->SetChisquare(0.2645583);
   ...
   quadLineFit1009->SetParameter(0,5.851071);
   quadLineFit1009->SetParError(0,0.1661784);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.182951);
