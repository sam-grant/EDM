...
//=========  (Tue Oct 20 15:08:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2524342,45,0.1764797);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2095428);
   Graph_Graph01093->SetMaximum(0.1335883);
   ...
   mainFit1094->SetChisquare(1.198589);
   ...
   mainFit1094->SetParameter(0,-0.0379376);
   mainFit1094->SetParError(0,0.001843393);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004612744);
   mainFit1094->SetParError(1,8.243725e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00461#pm8.24e-05");
   pt_LaTex = pt->AddText("#minus0.0379#pm0.00184");
   pt_LaTex = pt->AddText(" 8.22#pm0.426");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.22452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.22452,-0.2095428,-8.22452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(1.198589);
   ...
   mainFit1095->SetParameter(0,-0.0379376);
   mainFit1095->SetParError(0,0.001843393);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004612744);
   mainFit1095->SetParError(1,8.243725e-05);
