...
//=========  (Tue Oct 20 15:08:45 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1037 = new TH1F("Graph_mI30dO000000sPppm1037","",100,13.6,18.4);
   ...
   quadLineFit1038->SetChisquare(2.152713);
   ...
   quadLineFit1038->SetParameter(0,-3.255088);
   quadLineFit1038->SetParError(0,0.08400653);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.09894203);
   quadLineFit1038->SetParError(1,0.005223274);
   ...
   quadLineFit1039->SetChisquare(2.152713);
   ...
   quadLineFit1039->SetParameter(0,-3.255088);
   quadLineFit1039->SetParError(0,0.08400653);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.09894203);
   quadLineFit1039->SetParError(1,0.005223274);
   ...
   TH1F *Graph_mI10dO000000sPppm1039 = new TH1F("Graph_mI10dO000000sPppm1039","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1039->SetMinimum(-0.2114025);
   Graph_mI10dO000000sPppm1039->SetMaximum(-0.1031553);
   ...
   quadLineFit1040->SetChisquare(1.332368);
   ...
   quadLineFit1040->SetParameter(0,-0.4068752);
   quadLineFit1040->SetParError(0,0.08400704);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,0.01516465);
   quadLineFit1040->SetParError(1,0.005223306);
   ...
   quadLineFit1041->SetChisquare(1.332368);
   ...
   quadLineFit1041->SetParameter(0,-0.4068752);
   quadLineFit1041->SetParError(0,0.08400704);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,0.01516465);
   quadLineFit1041->SetParError(1,0.005223306);
   ...
   TH1F *Graph_10dO000000sPppm1041 = new TH1F("Graph_10dO000000sPppm1041","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1041->SetMinimum(1.16987);
   Graph_10dO000000sPppm1041->SetMaximum(1.58555);
   ...
   quadLineFit1042->SetChisquare(3.765561);
   ...
   quadLineFit1042->SetParameter(0,2.633417);
   quadLineFit1042->SetParError(0,0.08400684);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.07921319);
   quadLineFit1042->SetParError(1,0.005223293);
   ...
   quadLineFit1043->SetChisquare(3.765561);
   ...
   quadLineFit1043->SetParameter(0,2.633417);
   quadLineFit1043->SetParError(0,0.08400684);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.07921319);
   quadLineFit1043->SetParError(1,0.005223293);
   ...
   TH1F *Graph_30dO000000sPppm1043 = new TH1F("Graph_30dO000000sPppm1043","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1043->SetMinimum(2.465447);
   Graph_30dO000000sPppm1043->SetMaximum(3.340847);
   ...
   quadLineFit1044->SetChisquare(7.462792);
   ...
   quadLineFit1044->SetParameter(0,5.68648);
   quadLineFit1044->SetParError(0,0.08400665);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1749881);
   quadLineFit1044->SetParError(1,0.005223282);
   ...
   quadLineFit1045->SetChisquare(7.462792);
   ...
   quadLineFit1045->SetParameter(0,5.68648);
   quadLineFit1045->SetParError(0,0.08400665);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1749881);
   quadLineFit1045->SetParError(1,0.005223282);
