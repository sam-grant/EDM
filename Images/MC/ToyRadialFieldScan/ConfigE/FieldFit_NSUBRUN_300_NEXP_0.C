...
//=========  (Tue Oct 20 15:08:53 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.263563,45,0.1891994);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-0.2182867);
   Graph_Graph01141->SetMaximum(0.1439232);
   ...
   mainFit1142->SetChisquare(1.659098);
   ...
   mainFit1142->SetParameter(0,-0.03911794);
   mainFit1142->SetParError(0,0.001504131);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,-0.004929432);
   mainFit1142->SetParError(1,6.726678e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00493#pm6.73e-05");
   pt_LaTex = pt->AddText("#minus0.0391#pm0.0015");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.935588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.935588,-0.2182867,-7.935588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(1.659098);
   ...
   mainFit1143->SetParameter(0,-0.03911794);
   mainFit1143->SetParError(0,0.001504131);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,-0.004929432);
   mainFit1143->SetParError(1,6.726678e-05);
