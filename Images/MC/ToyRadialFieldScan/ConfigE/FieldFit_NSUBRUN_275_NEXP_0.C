...
//=========  (Tue Oct 20 15:08:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2550276,45,0.1780301);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-0.2117218);
   Graph_Graph01129->SetMaximum(0.1347244);
   ...
   mainFit1130->SetChisquare(4.553994);
   ...
   mainFit1130->SetParameter(0,-0.0373781);
   mainFit1130->SetParError(0,0.00157122);
   mainFit1130->SetParLimits(0,0,0);
   mainFit1130->SetParameter(1,-0.004659895);
   mainFit1130->SetParError(1,7.026705e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00466#pm7.03e-05");
   pt_LaTex = pt->AddText("#minus0.0374#pm0.00157");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.021233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.021233,-0.2117218,-8.021233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1131->SetChisquare(4.553994);
   ...
   mainFit1131->SetParameter(0,-0.0373781);
   mainFit1131->SetParError(0,0.00157122);
   mainFit1131->SetParLimits(0,0,0);
   mainFit1131->SetParameter(1,-0.004659895);
   mainFit1131->SetParError(1,7.026705e-05);
