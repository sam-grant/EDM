...
//=========  (Tue Oct 20 15:08:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2585937,45,0.195275);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-0.2132068);
   Graph_Graph01033->SetMaximum(0.1498881);
   ...
   mainFit1034->SetChisquare(1.810537);
   ...
   mainFit1034->SetParameter(0,-0.03317313);
   mainFit1034->SetParError(0,0.002998359);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,-0.004898837);
   ...
   pt_LaTex = pt->AddText("#minus0.0049#pm0.000134");
   pt_LaTex = pt->AddText("#minus0.0332#pm0.003");
   pt_LaTex = pt->AddText(" 6.77#pm 0.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.771635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.771635,-0.2132068,-6.771635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.810537);
   ...
   mainFit1035->SetParameter(0,-0.03317313);
   mainFit1035->SetParError(0,0.002998359);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,-0.004898837);
