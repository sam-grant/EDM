...
//=========  (Tue Oct 20 15:08:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.59233,45,54.13001);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01083->SetMinimum(-29.32009);
   Graph_Graph01083->SetMaximum(44.85778);
   ...
   checkFit1084->SetParameter(0,7.677995);
   checkFit1084->SetParError(0,0.4122408);
   checkFit1084->SetParLimits(0,0,0);
   checkFit1084->SetParameter(1,0.998594);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.0184");
   pt_LaTex = pt->AddText(" 7.68#pm0.412");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.688806,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.688806,-29.32009,-7.688806,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1085->SetParameter(0,7.677995);
   checkFit1085->SetParError(0,0.4122408);
   checkFit1085->SetParLimits(0,0,0);
   checkFit1085->SetParameter(1,0.998594);
