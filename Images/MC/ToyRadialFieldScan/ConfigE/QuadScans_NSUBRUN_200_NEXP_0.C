...
//=========  (Tue Oct 20 15:08:49 2020) by ROOT version 6.22/02
   ...
   quadLineFit1086->SetChisquare(1.390437);
   ...
   quadLineFit1086->SetParameter(0,-3.28582);
   quadLineFit1086->SetParError(0,0.05929338);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.1013074);
   quadLineFit1086->SetParError(1,0.003686685);
   ...
   quadLineFit1087->SetChisquare(1.390437);
   ...
   quadLineFit1087->SetParameter(0,-3.28582);
   quadLineFit1087->SetParError(0,0.05929338);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.1013074);
   quadLineFit1087->SetParError(1,0.003686685);
   ...
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.1897016);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.1381699);
   ...
   quadLineFit1088->SetChisquare(0.3251614);
   ...
   quadLineFit1088->SetParameter(0,-0.2498604);
   quadLineFit1088->SetParError(0,0.0592997);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,0.005522012);
   quadLineFit1088->SetParError(1,0.00368708);
   ...
   quadLineFit1089->SetChisquare(0.3251614);
   ...
   quadLineFit1089->SetParameter(0,-0.2498604);
   quadLineFit1089->SetParError(0,0.0592997);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,0.005522012);
   quadLineFit1089->SetParError(1,0.00368708);
   ...
   Graph_10dO000000sPppm1089->SetMinimum(1.173296);
   Graph_10dO000000sPppm1089->SetMaximum(1.58865);
   ...
   quadLineFit1090->SetChisquare(5.37513);
   ...
   quadLineFit1090->SetParameter(0,2.672199);
   quadLineFit1090->SetParError(0,0.05929349);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.08131847);
   quadLineFit1090->SetParError(1,0.003686691);
   ...
   quadLineFit1091->SetChisquare(5.37513);
   ...
   quadLineFit1091->SetParameter(0,2.672199);
   quadLineFit1091->SetParError(0,0.05929349);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.08131847);
   quadLineFit1091->SetParError(1,0.003686691);
   ...
   Graph_30dO000000sPppm1091->SetMinimum(2.455452);
   Graph_30dO000000sPppm1091->SetMaximum(3.331335);
   ...
   quadLineFit1092->SetChisquare(2.361536);
   ...
   quadLineFit1092->SetParameter(0,5.723041);
   quadLineFit1092->SetParError(0,0.05929342);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1772619);
   quadLineFit1092->SetParError(1,0.003686687);
   ...
   quadLineFit1093->SetChisquare(2.361536);
   ...
   quadLineFit1093->SetParameter(0,5.723041);
   quadLineFit1093->SetParError(0,0.05929342);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1772619);
   quadLineFit1093->SetParError(1,0.003686687);
