...
//=========  (Tue Oct 20 15:08:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2668897,45,0.1747479);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.222726);
   Graph_Graph01009->SetMaximum(0.1305841);
   ...
   mainFit1010->SetChisquare(2.355853);
   ...
   mainFit1010->SetParameter(0,-0.03842627);
   mainFit1010->SetParError(0,0.005166238);
   mainFit1010->SetParLimits(0,0,0);
   mainFit1010->SetParameter(1,-0.004531269);
   mainFit1010->SetParError(1,0.0002310413);
   ...
   pt_LaTex = pt->AddText("#minus0.00453#pm0.000231");
   pt_LaTex = pt->AddText("#minus0.0384#pm0.00517");
   pt_LaTex = pt->AddText(" 8.48#pm 1.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.480243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.480243,-0.222726,-8.480243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1011->SetChisquare(2.355853);
   ...
   mainFit1011->SetParameter(0,-0.03842627);
   mainFit1011->SetParError(0,0.005166238);
   mainFit1011->SetParLimits(0,0,0);
   mainFit1011->SetParameter(1,-0.004531269);
   mainFit1011->SetParError(1,0.0002310413);
