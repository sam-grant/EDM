...
//=========  (Tue Oct 20 15:08:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.38111,45,51.46199);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-28.4968);
   Graph_Graph01071->SetMaximum(42.57768);
   ...
   checkFit1072->SetParameter(0,7.362832);
   checkFit1072->SetParError(0,0.4453629);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,0.9600161);
   ...
   pt_LaTex = pt->AddText(" 0.96#pm0.0199");
   pt_LaTex = pt->AddText(" 7.36#pm0.445");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.669488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.669488,-28.4968,-7.669488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetParameter(0,7.362832);
   checkFit1073->SetParError(0,0.4453629);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,0.9600161);
