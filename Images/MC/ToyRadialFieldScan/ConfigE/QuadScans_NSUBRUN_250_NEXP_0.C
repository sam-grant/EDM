...
//=========  (Tue Oct 20 15:08:51 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1109 = new TH1F("Graph_mI30dO000000sPppm1109","",100,13.6,18.4);
   ...
   TF1 *quadLineFit1110 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1110->SetFillColor(19);
   quadLineFit1110->SetFillStyle(0);
   quadLineFit1110->SetLineWidth(2);
   quadLineFit1110->SetChisquare(6.859411);
   ...
   quadLineFit1110->SetParameter(0,-3.22898);
   quadLineFit1110->SetParError(0,0.05301136);
   quadLineFit1110->SetParLimits(0,0,0);
   quadLineFit1110->SetParameter(1,0.09734248);
   quadLineFit1110->SetParError(1,0.003296087);
   quadLineFit1110->SetParLimits(1,0,0);
   quadLineFit1110->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1110);
   gre->Draw("ap");
   
   TF1 *quadLineFit1111 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1111->SetFillColor(19);
   quadLineFit1111->SetFillStyle(0);
   quadLineFit1111->SetLineWidth(2);
   quadLineFit1111->SetChisquare(6.859411);
   ...
   quadLineFit1111->SetParameter(0,-3.22898);
   quadLineFit1111->SetParError(0,0.05301136);
   quadLineFit1111->SetParLimits(0,0,0);
   quadLineFit1111->SetParameter(1,0.09734248);
   quadLineFit1111->SetParError(1,0.003296087);
   ...
   TH1F *Graph_mI10dO000000sPppm1111 = new TH1F("Graph_mI10dO000000sPppm1111","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1111->SetMinimum(-0.1756081);
   Graph_mI10dO000000sPppm1111->SetMaximum(-0.1223416);
   ...
   TF1 *quadLineFit1112 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1112->SetChisquare(0.2166418);
   ...
   quadLineFit1112->SetParameter(0,-0.2501761);
   quadLineFit1112->SetParError(0,0.05301133);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.006435799);
   quadLineFit1112->SetParError(1,0.003296085);
   quadLineFit1112->SetParLimits(1,0,0);
   quadLineFit1112->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1112);
   gre->Draw("p ");
   
   TF1 *quadLineFit1113 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1113->SetChisquare(0.2166418);
   ...
   quadLineFit1113->SetParameter(0,-0.2501761);
   quadLineFit1113->SetParError(0,0.05301133);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.006435799);
   quadLineFit1113->SetParError(1,0.003296085);
   ...
   TH1F *Graph_10dO000000sPppm1113 = new TH1F("Graph_10dO000000sPppm1113","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1113->SetMinimum(1.157717);
   Graph_10dO000000sPppm1113->SetMaximum(1.568084);
   ...
   quadLineFit1114->SetChisquare(0.09605514);
   ...
   quadLineFit1114->SetParameter(0,2.657387);
   quadLineFit1114->SetParError(0,0.05301155);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,-0.08083165);
   ...
   quadLineFit1115->SetChisquare(0.09605514);
   ...
   quadLineFit1115->SetParameter(0,2.657387);
   quadLineFit1115->SetParError(0,0.05301155);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,-0.08083165);
   ...
   TH1F *Graph_30dO000000sPppm1115 = new TH1F("Graph_30dO000000sPppm1115","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1115->SetMinimum(2.471411);
   Graph_30dO000000sPppm1115->SetMaximum(3.360361);
   ...
   quadLineFit1116->SetChisquare(21.32463);
   ...
   quadLineFit1116->SetParameter(0,5.786895);
   quadLineFit1116->SetParError(0,0.05301157);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.1805366);
   quadLineFit1116->SetParError(1,0.0032961);
   ...
   quadLineFit1117->SetChisquare(21.32463);
   ...
   quadLineFit1117->SetParameter(0,5.786895);
   quadLineFit1117->SetParError(0,0.05301157);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.1805366);
   quadLineFit1117->SetParError(1,0.0032961);
