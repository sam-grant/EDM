...
//=========  (Tue Oct 20 15:08:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.32613,45,54.7757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-28.11595);
   Graph_Graph01023->SetMaximum(45.56552);
   ...
   checkFit1024->SetParameter(0,8.60405);
   checkFit1024->SetParError(0,0.7666928);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9861537);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0343");
   pt_LaTex = pt->AddText("  8.6#pm0.767");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.724857,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.724857,-28.11595,-8.724857,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetParameter(0,8.60405);
   checkFit1025->SetParError(0,0.7666928);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9861537);
