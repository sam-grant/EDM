...
//=========  (Tue Oct 20 15:08:43 2020) by ROOT version 6.22/02
   ...
   quadLineFit1014->SetChisquare(0.01153851);
   ...
   quadLineFit1014->SetParameter(0,-3.219341);
   quadLineFit1014->SetParError(0,0.1179343);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.09775777);
   ...
   quadLineFit1015->SetChisquare(0.01153851);
   ...
   quadLineFit1015->SetParameter(0,-3.219341);
   quadLineFit1015->SetParError(0,0.1179343);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.09775777);
   ...
   Graph_mI10dO000000sPppm1015->SetMinimum(-0.2011075);
   Graph_mI10dO000000sPppm1015->SetMaximum(-0.09082558);
   ...
   quadLineFit1016->SetChisquare(0.9891587);
   ...
   quadLineFit1016->SetParameter(0,-0.3388582);
   quadLineFit1016->SetParError(0,0.1179343);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,0.01257874);
   quadLineFit1016->SetParError(1,0.007332802);
   ...
   quadLineFit1017->SetChisquare(0.9891587);
   ...
   quadLineFit1017->SetParameter(0,-0.3388582);
   quadLineFit1017->SetParError(0,0.1179343);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,0.01257874);
   quadLineFit1017->SetParError(1,0.007332802);
   ...
   Graph_10dO000000sPppm1017->SetMinimum(1.123753);
   Graph_10dO000000sPppm1017->SetMaximum(1.623361);
   ...
   quadLineFit1018->SetChisquare(0.5604713);
   ...
   quadLineFit1018->SetParameter(0,2.866655);
   quadLineFit1018->SetParError(0,0.1179343);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.09371483);
   quadLineFit1018->SetParError(1,0.0073328);
   ...
   quadLineFit1019->SetChisquare(0.5604713);
   ...
   quadLineFit1019->SetParameter(0,2.866655);
   quadLineFit1019->SetParError(0,0.1179343);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.09371483);
   quadLineFit1019->SetParError(1,0.0073328);
   ...
   Graph_30dO000000sPppm1019->SetMinimum(2.43288);
   Graph_30dO000000sPppm1019->SetMaximum(3.352433);
   ...
   quadLineFit1020->SetChisquare(3.127139);
   ...
   quadLineFit1020->SetParameter(0,5.776937);
   quadLineFit1020->SetParError(0,0.1179345);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.1812033);
   quadLineFit1020->SetParError(1,0.007332816);
   ...
   quadLineFit1021->SetChisquare(3.127139);
   ...
   quadLineFit1021->SetParameter(0,5.776937);
   quadLineFit1021->SetParError(0,0.1179345);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.1812033);
   quadLineFit1021->SetParError(1,0.007332816);
