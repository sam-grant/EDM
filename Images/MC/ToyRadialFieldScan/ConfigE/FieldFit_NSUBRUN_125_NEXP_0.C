...
//=========  (Tue Oct 20 15:08:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2503417,45,0.1726901);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(-0.2080385);
   Graph_Graph01057->SetMaximum(0.1303869);
   ...
   mainFit1058->SetChisquare(1.905798);
   ...
   mainFit1058->SetParameter(0,-0.03561956);
   mainFit1058->SetParError(0,0.002334069);
   mainFit1058->SetParLimits(0,0,0);
   mainFit1058->SetParameter(1,-0.004539992);
   mainFit1058->SetParError(1,0.0001043826);
   ...
   pt_LaTex = pt->AddText("#minus0.00454#pm0.000104");
   pt_LaTex = pt->AddText("#minus0.0356#pm0.00233");
   pt_LaTex = pt->AddText(" 7.85#pm0.545");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.845732,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.845732,-0.2080385,-7.845732,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1059->SetChisquare(1.905798);
   ...
   mainFit1059->SetParameter(0,-0.03561956);
   mainFit1059->SetParError(0,0.002334069);
   mainFit1059->SetParLimits(0,0,0);
   mainFit1059->SetParameter(1,-0.004539992);
   mainFit1059->SetParError(1,0.0001043826);
