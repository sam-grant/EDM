...
//=========  (Tue Oct 20 15:08:53 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.5641,45,55.11449);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-30.09624);
   Graph_Graph01143->SetMaximum(45.64663);
   ...
   checkFit1144->SetParameter(0,8.1801);
   checkFit1144->SetParError(0,0.3145337);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,1.03081);
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.935607,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.935607,-30.09624,-7.935607,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetParameter(0,8.1801);
   checkFit1145->SetParError(0,0.3145337);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,1.03081);
