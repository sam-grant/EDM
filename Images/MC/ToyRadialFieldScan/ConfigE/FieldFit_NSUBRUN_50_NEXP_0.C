...
//=========  (Tue Oct 20 15:08:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2619428,45,0.1784973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.2178988);
   Graph_Graph01021->SetMaximum(0.1344532);
   ...
   mainFit1022->SetChisquare(1.506643);
   ...
   mainFit1022->SetParameter(0,-0.04114528);
   mainFit1022->SetParError(0,0.003666402);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.004715882);
   mainFit1022->SetParError(1,0.0001639666);
   ...
   pt_LaTex = pt->AddText("#minus0.00472#pm0.000164");
   pt_LaTex = pt->AddText("#minus0.0411#pm0.00367");
   pt_LaTex = pt->AddText(" 8.72#pm0.835");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.724832,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.724832,-0.2178988,-8.724832,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(1.506643);
   ...
   mainFit1023->SetParameter(0,-0.04114528);
   mainFit1023->SetParError(0,0.003666402);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.004715882);
   mainFit1023->SetParError(1,0.0001639666);
