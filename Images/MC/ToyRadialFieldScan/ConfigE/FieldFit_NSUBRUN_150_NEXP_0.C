...
//=========  (Tue Oct 20 15:08:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2460963,45,0.1787601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.2036107);
   Graph_Graph01069->SetMaximum(0.1362745);
   ...
   mainFit1070->SetChisquare(0.6728545);
   ...
   mainFit1070->SetParameter(0,-0.03520992);
   mainFit1070->SetParError(0,0.002129769);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.004590894);
   mainFit1070->SetParError(1,9.52461e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00459#pm9.52e-05");
   pt_LaTex = pt->AddText("#minus0.0352#pm0.00213");
   pt_LaTex = pt->AddText(" 7.67#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.669513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.669513,-0.2036107,-7.669513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(0.6728545);
   ...
   mainFit1071->SetParameter(0,-0.03520992);
   mainFit1071->SetParError(0,0.002129769);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.004590894);
   mainFit1071->SetParError(1,9.52461e-05);
