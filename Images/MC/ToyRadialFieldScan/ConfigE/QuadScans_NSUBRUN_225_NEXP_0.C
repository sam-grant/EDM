...
//=========  (Tue Oct 20 15:08:50 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1097 = new TH1F("Graph_mI30dO000000sPppm1097","",100,13.6,18.4);
   ...
   quadLineFit1098->SetChisquare(2.206774);
   ...
   quadLineFit1098->SetParameter(0,-3.312816);
   quadLineFit1098->SetParError(0,0.0558897);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.1026477);
   quadLineFit1098->SetParError(1,0.003475054);
   ...
   quadLineFit1099->SetChisquare(2.206774);
   ...
   quadLineFit1099->SetParameter(0,-3.312816);
   quadLineFit1099->SetParError(0,0.0558897);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.1026477);
   quadLineFit1099->SetParError(1,0.003475054);
   ...
   TH1F *Graph_mI10dO000000sPppm1099 = new TH1F("Graph_mI10dO000000sPppm1099","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1099->SetMinimum(-0.1985813);
   Graph_mI10dO000000sPppm1099->SetMaximum(-0.09596111);
   ...
   quadLineFit1100->SetChisquare(0.127639);
   ...
   quadLineFit1100->SetParameter(0,-0.4092733);
   quadLineFit1100->SetParError(0,0.05588968);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.01646473);
   ...
   quadLineFit1101->SetChisquare(0.127639);
   ...
   quadLineFit1101->SetParameter(0,-0.4092733);
   quadLineFit1101->SetParError(0,0.05588968);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.01646473);
   ...
   TH1F *Graph_10dO000000sPppm1101 = new TH1F("Graph_10dO000000sPppm1101","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1101->SetMinimum(1.156271);
   Graph_10dO000000sPppm1101->SetMaximum(1.59734);
   ...
   quadLineFit1102->SetChisquare(1.664295);
   ...
   quadLineFit1102->SetParameter(0,2.763227);
   quadLineFit1102->SetParError(0,0.05588967);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-0.08697492);
   quadLineFit1102->SetParError(1,0.003475052);
   ...
   quadLineFit1103->SetChisquare(1.664295);
   ...
   quadLineFit1103->SetParameter(0,2.763227);
   quadLineFit1103->SetParError(0,0.05588967);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-0.08697492);
   quadLineFit1103->SetParError(1,0.003475052);
   ...
   TH1F *Graph_30dO000000sPppm1103 = new TH1F("Graph_30dO000000sPppm1103","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1103->SetMinimum(2.469442);
   Graph_30dO000000sPppm1103->SetMaximum(3.356192);
   ...
   quadLineFit1104->SetChisquare(12.6538);
   ...
   quadLineFit1104->SetParameter(0,5.775747);
   quadLineFit1104->SetParError(0,0.05588964);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.1798252);
   quadLineFit1104->SetParError(1,0.00347505);
   ...
   quadLineFit1105->SetChisquare(12.6538);
   ...
   quadLineFit1105->SetParameter(0,5.775747);
   quadLineFit1105->SetParError(0,0.05588964);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.1798252);
   quadLineFit1105->SetParError(1,0.00347505);
