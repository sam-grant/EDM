...
//=========  (Tue Oct 20 15:08:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.32221,45,53.46106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-28.24389);
   Graph_Graph01107->SetMaximum(44.38273);
   ...
   checkFit1108->SetParameter(0,7.720863);
   checkFit1108->SetParError(0,0.3633397);
   checkFit1108->SetParLimits(0,0,0);
   checkFit1108->SetParameter(1,0.9941853);
   ...
   pt_LaTex = pt->AddText("0.994#pm0.0162");
   pt_LaTex = pt->AddText(" 7.72#pm0.363");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.76602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.76602,-28.24389,-7.76602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1109->SetParameter(0,7.720863);
   checkFit1109->SetParError(0,0.3633397);
   checkFit1109->SetParLimits(0,0,0);
   checkFit1109->SetParameter(1,0.9941853);
