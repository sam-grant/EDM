...
//=========  (Tue Oct 20 15:08:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.83458,45,54.07535);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.34359);
   Graph_Graph01035->SetMaximum(44.58436);
   ...
   checkFit1036->SetParameter(0,6.937006);
   checkFit1036->SetParError(0,0.6269966);
   checkFit1036->SetParLimits(0,0,0);
   checkFit1036->SetParameter(1,1.024412);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.028");
   pt_LaTex = pt->AddText(" 6.94#pm0.627");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.771693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.771693,-31.34359,-6.771693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1037->SetParameter(0,6.937006);
   checkFit1037->SetParError(0,0.6269966);
   checkFit1037->SetParLimits(0,0,0);
   checkFit1037->SetParameter(1,1.024412);
