...
//=========  (Tue Oct 20 15:08:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2549505,45,0.1717564);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01117->SetMinimum(-0.2122798);
   Graph_Graph01117->SetMaximum(0.1290857);
   ...
   mainFit1118->SetChisquare(2.970763);
   ...
   mainFit1118->SetParameter(0,-0.03939711);
   mainFit1118->SetParError(0,0.001648047);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.004604516);
   mainFit1118->SetParError(1,7.37029e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0046#pm7.37e-05");
   pt_LaTex = pt->AddText("#minus0.0394#pm0.00165");
   pt_LaTex = pt->AddText(" 8.56#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.556189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.556189,-0.2122798,-8.556189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetChisquare(2.970763);
   ...
   mainFit1119->SetParameter(0,-0.03939711);
   mainFit1119->SetParError(0,0.001648047);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.004604516);
   mainFit1119->SetParError(1,7.37029e-05);
