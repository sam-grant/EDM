...
//=========  (Tue Oct 20 15:08:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.54208,45,55.81016);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-27.30686);
   Graph_Graph01011->SetMaximum(46.57494);
   ...
   checkFit1012->SetParameter(0,8.035436);
   checkFit1012->SetParError(0,1.080329);
   checkFit1012->SetParLimits(0,0,0);
   checkFit1012->SetParameter(1,0.9475482);
   checkFit1012->SetParError(1,0.04831377);
   ...
   pt_LaTex = pt->AddText("0.948#pm0.0483");
   pt_LaTex = pt->AddText(" 8.04#pm 1.08");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.48024,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.48024,-27.30686,-8.48024,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1013->SetParameter(0,8.035436);
   checkFit1013->SetParError(0,1.080329);
   checkFit1013->SetParLimits(0,0,0);
   checkFit1013->SetParameter(1,0.9475482);
   checkFit1013->SetParError(1,0.04831377);
