...
//=========  (Tue Oct 20 15:08:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-35.91653,45,53.31351);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01119->SetMinimum(-26.99352);
   Graph_Graph01119->SetMaximum(44.3905);
   ...
   checkFit1120->SetParameter(0,8.238533);
   checkFit1120->SetParError(0,0.344629);
   checkFit1120->SetParLimits(0,0,0);
   checkFit1120->SetParameter(1,0.9628665);
   checkFit1120->SetParError(1,0.01541228);
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.556257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.556257,-26.99352,-8.556257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1121->SetParameter(0,8.238533);
   checkFit1121->SetParError(0,0.344629);
   checkFit1121->SetParLimits(0,0,0);
   checkFit1121->SetParameter(1,0.9628665);
   checkFit1121->SetParError(1,0.01541228);
