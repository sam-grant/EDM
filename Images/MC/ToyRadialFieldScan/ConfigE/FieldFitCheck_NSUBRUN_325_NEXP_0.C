...
//=========  (Tue Oct 20 15:08:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.54693,45,53.1923);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-29.373);
   Graph_Graph01155->SetMaximum(44.01837);
   ...
   checkFit1156->SetParameter(0,8.046293);
   checkFit1156->SetParError(0,0.3021963);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,1.005163);
   checkFit1156->SetParError(1,0.01351463);
   ...
   pt_LaTex = pt->AddText(" 8.05#pm0.302");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.004965,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.004965,-29.373,-8.004965,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetParameter(0,8.046293);
   checkFit1157->SetParError(0,0.3021963);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,1.005163);
   checkFit1157->SetParError(1,0.01351463);
