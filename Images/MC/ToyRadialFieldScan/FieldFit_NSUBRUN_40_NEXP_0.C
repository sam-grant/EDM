...
//=========  (Wed Jan  5 17:09:11 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","",100,-36,36);
   Graph_Graph01029->SetMinimum(-35.63706);
   Graph_Graph01029->SetMaximum(58.46085);
   ...
   Graph_Graph01029->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *mainFit1030 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1030->SetChisquare(3.03899e-14);
   ...
   mainFit1030->SetParameter(0,11.4119);
   mainFit1030->SetParError(0,1.476266);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.237324);
   mainFit1030->SetParError(1,0.04920888);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-9.223048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.223048,-35.63706,-9.223048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *mainFit1031 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1031->SetChisquare(3.03899e-14);
   ...
   mainFit1031->SetParameter(0,11.4119);
   mainFit1031->SetParError(0,1.476266);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.237324);
   mainFit1031->SetParError(1,0.04920888);
