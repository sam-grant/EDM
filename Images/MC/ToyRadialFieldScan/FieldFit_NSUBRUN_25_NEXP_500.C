...
//=========  (Tue May 31 19:16:21 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01013->SetMinimum(-67.96268);
   Graph_Graph01013->SetMaximum(86.02332);
   ...
   mainFit1014->SetChisquare(1.504674);
   ...
   mainFit1014->SetParameter(0,8.816436);
   mainFit1014->SetParError(0,0.8821618);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,1.258689);
   mainFit1014->SetParError(1,0.02783029);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.376");
   pt_LaTex = pt->AddText("1.26
#pm0.03
");
   pt_LaTex = pt->AddText("8.82
#pm0.9
");
   pt_LaTex = pt->AddText("7
#pm0.7
");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.004462,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.004462,-67.96268,-7.004462,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(1.504674);
   ...
   mainFit1015->SetParameter(0,8.816436);
   mainFit1015->SetParError(0,0.8821618);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,1.258689);
   mainFit1015->SetParError(1,0.02783029);
