...
//=========  (Fri Oct  9 19:09:34 2020) by ROOT version 6.22/02
   ...
   quadLineFit1032->SetChisquare(4.859257e-22);
   ...
   quadLineFit1032->SetParameter(0,-3.220545);
   quadLineFit1032->SetParError(0,0.09459775);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.09609683);
   ...
   quadLineFit1033->SetChisquare(4.859257e-22);
   ...
   quadLineFit1033->SetParameter(0,-3.220545);
   quadLineFit1033->SetParError(0,0.09459775);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.09609683);
   ...
   Graph_mI10dO000000sPppm1033->SetMinimum(-0.1681293);
   Graph_mI10dO000000sPppm1033->SetMaximum(-0.1003391);
   ...
   quadLineFit1034->SetChisquare(5.11487e-22);
   ...
   quadLineFit1034->SetParameter(0,-0.2554844);
   quadLineFit1034->SetParError(0,0.09459776);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.006736122);
   ...
   quadLineFit1035->SetChisquare(5.11487e-22);
   ...
   quadLineFit1035->SetParameter(0,-0.2554844);
   quadLineFit1035->SetParError(0,0.09459776);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.006736122);
   ...
   Graph_10dO000000sPppm1035->SetMinimum(1.067025);
   Graph_10dO000000sPppm1035->SetMaximum(1.405509);
   ...
   quadLineFit1036->SetChisquare(2.445202e-18);
   ...
   quadLineFit1036->SetParameter(0,2.372619);
   quadLineFit1036->SetParError(0,0.09459776);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.06313066);
   ...
   quadLineFit1037->SetChisquare(2.445202e-18);
   ...
   quadLineFit1037->SetParameter(0,2.372619);
   quadLineFit1037->SetParError(0,0.09459776);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.06313066);
   ...
   Graph_30dO000000sPppm1037->SetMinimum(2.238425);
   Graph_30dO000000sPppm1037->SetMaximum(2.929465);
   ...
   quadLineFit1038->SetChisquare(3.687455e-20);
   ...
   quadLineFit1038->SetParameter(0,5.042383);
   quadLineFit1038->SetParError(0,0.09459776);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.1365799);
   ...
   quadLineFit1039->SetChisquare(3.687455e-20);
   ...
   quadLineFit1039->SetParameter(0,5.042383);
   quadLineFit1039->SetParError(0,0.09459776);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.1365799);
