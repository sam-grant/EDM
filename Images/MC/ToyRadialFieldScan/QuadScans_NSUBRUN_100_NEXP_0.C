...
//=========  (Tue Oct  6 23:07:51 2020) by ROOT version 6.22/02
   ...
   0.0148505,
   0.0148505};
   TGraphErrors *gre = new TGraphErrors(2,-30.000000 ppm_fx1031,-30.000000 ppm_fy1031,-30.000000 ppm_fex1031,-30.000000 ppm_fey1031);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1031 = new TH1F("Graph_mI30dO000000sPppm1031","",100,15.6,20.4);
   Graph_mI30dO000000sPppm1031->SetMinimum(-3);
   Graph_mI30dO000000sPppm1031->SetMaximum(2);
   ...
   TF1 *quadLineFit1032 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1032->SetFillColor(19);
   quadLineFit1032->SetFillStyle(0);
   quadLineFit1032->SetLineWidth(2);
   quadLineFit1032->SetChisquare(3.121846e-19);
   ...
   quadLineFit1032->SetParameter(0,-4.274417);
   quadLineFit1032->SetParError(0,0.0950896);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.1193702);
   quadLineFit1032->SetParError(1,0.005250445);
   quadLineFit1032->SetParLimits(1,0,0);
   quadLineFit1032->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1032);
   gre->Draw("ap");
   
   TF1 *quadLineFit1033 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1033->SetFillColor(19);
   quadLineFit1033->SetFillStyle(0);
   quadLineFit1033->SetLineWidth(2);
   quadLineFit1033->SetChisquare(3.121846e-19);
   ...
   quadLineFit1033->SetParameter(0,-4.274417);
   quadLineFit1033->SetParError(0,0.0950896);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.1193702);
   quadLineFit1033->SetParError(1,0.005250445);
   ...
   TH1F *Graph_mI10dO000000sPppm1033 = new TH1F("Graph_mI10dO000000sPppm1033","Graph",100,15.6,20.4);
   Graph_mI10dO000000sPppm1033->SetMinimum(-1.176188);
   Graph_mI10dO000000sPppm1033->SetMaximum(-0.8662336);
   Graph_mI10dO000000sPppm1033->SetDirectory(0);
   Graph_mI10dO000000sPppm1033->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_mI10dO000000sPppm1033->SetLineColor(ci);
   Graph_mI10dO000000sPppm1033->GetXaxis()->SetLabelFont(42);
   Graph_mI10dO000000sPppm1033->GetXaxis()->SetTitleOffset(1);
   Graph_mI10dO000000sPppm1033->GetXaxis()->SetTitleFont(42);
   Graph_mI10dO000000sPppm1033->GetYaxis()->SetLabelFont(42);
   Graph_mI10dO000000sPppm1033->GetYaxis()->SetTitleFont(42);
   Graph_mI10dO000000sPppm1033->GetZaxis()->SetLabelFont(42);
   Graph_mI10dO000000sPppm1033->GetZaxis()->SetTitleOffset(1);
   Graph_mI10dO000000sPppm1033->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_-10.000000 ppm1033);
   
   
   TF1 *quadLineFit1034 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1034->SetChisquare(4.543944e-20);
   ...
   quadLineFit1034->SetParameter(0,-2.049885);
   quadLineFit1034->SetParError(0,0.0950896);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.05714857);
   quadLineFit1034->SetParError(1,0.005250445);
   quadLineFit1034->SetParLimits(1,0,0);
   quadLineFit1034->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1034);
   gre->Draw("p ");
   
   TF1 *quadLineFit1035 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1035->SetChisquare(4.543944e-20);
   ...
   quadLineFit1035->SetParameter(0,-2.049885);
   quadLineFit1035->SetParError(0,0.0950896);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.05714857);
   quadLineFit1035->SetParError(1,0.005250445);
   ...
   TH1F *Graph_10dO000000sPppm1035 = new TH1F("Graph_10dO000000sPppm1035","Graph",100,15.6,20.4);
   Graph_10dO000000sPppm1035->SetMinimum(0.1052073);
   Graph_10dO000000sPppm1035->SetMaximum(0.1502242);
   Graph_10dO000000sPppm1035->SetDirectory(0);
   Graph_10dO000000sPppm1035->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_10dO000000sPppm1035->SetLineColor(ci);
   Graph_10dO000000sPppm1035->GetXaxis()->SetLabelFont(42);
   Graph_10dO000000sPppm1035->GetXaxis()->SetTitleOffset(1);
   Graph_10dO000000sPppm1035->GetXaxis()->SetTitleFont(42);
   Graph_10dO000000sPppm1035->GetYaxis()->SetLabelFont(42);
   Graph_10dO000000sPppm1035->GetYaxis()->SetTitleFont(42);
   Graph_10dO000000sPppm1035->GetZaxis()->SetLabelFont(42);
   Graph_10dO000000sPppm1035->GetZaxis()->SetTitleOffset(1);
   Graph_10dO000000sPppm1035->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_10.000000 ppm1035);
   
   
   TF1 *quadLineFit1036 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1036->SetChisquare(7.767029e-22);
   ...
   quadLineFit1036->SetParameter(0,0.09255694);
   quadLineFit1036->SetParError(0,0.0950896);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,0.001953266);
   quadLineFit1036->SetParError(1,0.005250445);
   quadLineFit1036->SetParLimits(1,0,0);
   quadLineFit1036->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1036);
   gre->Draw("p ");
   
   TF1 *quadLineFit1037 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1037->SetChisquare(7.767029e-22);
   ...
   quadLineFit1037->SetParameter(0,0.09255694);
   quadLineFit1037->SetParError(0,0.0950896);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,0.001953266);
   quadLineFit1037->SetParError(1,0.005250445);
   ...
   TH1F *Graph_30dO000000sPppm1037 = new TH1F("Graph_30dO000000sPppm1037","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1037->SetMinimum(1.050611);
   Graph_30dO000000sPppm1037->SetMaximum(1.40888);
   Graph_30dO000000sPppm1037->SetDirectory(0);
   Graph_30dO000000sPppm1037->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_30dO000000sPppm1037->SetLineColor(ci);
   Graph_30dO000000sPppm1037->GetXaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1037->GetXaxis()->SetTitleOffset(1);
   Graph_30dO000000sPppm1037->GetXaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1037->GetYaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1037->GetYaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1037->GetZaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1037->GetZaxis()->SetTitleOffset(1);
   Graph_30dO000000sPppm1037->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_30.000000 ppm1037);
   
   
   TF1 *quadLineFit1038 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1038->SetFillColor(19);
   quadLineFit1038->SetFillStyle(0);
   quadLineFit1038->SetLineColor(4);
   quadLineFit1038->SetLineWidth(2);
   quadLineFit1038->SetChisquare(1.458376e-20);
   ...
   quadLineFit1038->SetParameter(0,2.439598);
   quadLineFit1038->SetParError(0,0.0950896);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.06721402);
   quadLineFit1038->SetParError(1,0.005250445);
   quadLineFit1038->SetParLimits(1,0,0);
   quadLineFit1038->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1038);
   gre->Draw("p ");
   
   TF1 *quadLineFit1039 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1039->SetFillColor(19);
   quadLineFit1039->SetFillStyle(0);
   quadLineFit1039->SetLineColor(4);
   quadLineFit1039->SetLineWidth(2);
   quadLineFit1039->SetChisquare(1.458376e-20);
   ...
   quadLineFit1039->SetParameter(0,2.439598);
   quadLineFit1039->SetParError(0,0.0950896);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.06721402);
   quadLineFit1039->SetParError(1,0.005250445);
