...
//=========  (Mon Oct 12 12:24:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.201627,45,0.1357328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01089->SetMinimum(-0.167891);
   Graph_Graph01089->SetMaximum(0.1019968);
   ...
   fieldLineFit1090->SetChisquare(3.535743);
   ...
   fieldLineFit1090->SetParameter(0,-0.02968181);
   fieldLineFit1090->SetParError(0,0.001737526);
   fieldLineFit1090->SetParLimits(0,0,0);
   fieldLineFit1090->SetParameter(1,-0.003634252);
   ...
   pt_LaTex = pt->AddText("#minus0.00363#pm7.77e-05");
   pt_LaTex = pt->AddText("#minus0.0297#pm0.00174");
   pt_LaTex = pt->AddText("#minus8.17#pm0.478");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.167239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.167239,-0.167891,-8.167239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1091->SetChisquare(3.535743);
   ...
   fieldLineFit1091->SetParameter(0,-0.02968181);
   fieldLineFit1091->SetParError(0,0.001737526);
   fieldLineFit1091->SetParLimits(0,0,0);
   fieldLineFit1091->SetParameter(1,-0.003634252);
