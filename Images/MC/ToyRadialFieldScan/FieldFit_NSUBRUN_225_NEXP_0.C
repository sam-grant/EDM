...
//=========  (Mon Oct 12 20:04:24 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01089->SetMinimum(-0.1776064);
   Graph_Graph01089->SetMaximum(0.1073758);
   ...
   TF1 *mainFit1090 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   mainFit1090->SetFillColor(19);
   mainFit1090->SetFillStyle(0);

   ci = TColor::GetColor("#ff0000");
   mainFit1090->SetLineColor(ci);
   mainFit1090->SetLineWidth(2);
   mainFit1090->SetChisquare(4.03272);
   mainFit1090->SetNDF(2);
   mainFit1090->GetXaxis()->SetLabelFont(42);
   mainFit1090->GetXaxis()->SetTitleOffset(1);
   mainFit1090->GetXaxis()->SetTitleFont(42);
   mainFit1090->GetYaxis()->SetLabelFont(42);
   mainFit1090->GetYaxis()->SetTitleFont(42);
   mainFit1090->SetParameter(0,-0.03313365);
   mainFit1090->SetParError(0,0.001737526);
   mainFit1090->SetParLimits(0,0,0);
   mainFit1090->SetParameter(1,-0.003885063);
   mainFit1090->SetParError(1,7.770454e-05);
   mainFit1090->SetParLimits(1,0,0);
   mainFit1090->SetParent(gre);
   gre->GetListOfFunctions()->Add(mainFit1090);
   gre->Draw("ap");
   ...
   TF1 *mainFit1091 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   mainFit1091->SetFillColor(19);
   mainFit1091->SetFillStyle(0);

   ci = TColor::GetColor("#ff0000");
   mainFit1091->SetLineColor(ci);
   mainFit1091->SetLineWidth(2);
   mainFit1091->SetChisquare(4.03272);
   mainFit1091->SetNDF(2);
   mainFit1091->GetXaxis()->SetLabelFont(42);
   mainFit1091->GetXaxis()->SetTitleOffset(1);
   mainFit1091->GetXaxis()->SetTitleFont(42);
   mainFit1091->GetYaxis()->SetLabelFont(42);
   mainFit1091->GetYaxis()->SetTitleFont(42);
   mainFit1091->SetParameter(0,-0.03313365);
   mainFit1091->SetParError(0,0.001737526);
   mainFit1091->SetParLimits(0,0,0);
   mainFit1091->SetParameter(1,-0.003885063);
   mainFit1091->SetParError(1,7.770454e-05);
   mainFit1091->SetParLimits(1,0,0);
   mainFit1091->Draw("same");
