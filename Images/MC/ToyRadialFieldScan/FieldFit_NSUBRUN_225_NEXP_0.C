...
//=========  (Tue Nov 10 15:16:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-81.55505,75,101.4842);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-63.25113);
   Graph_Graph01141->SetMaximum(83.18027);
   ...
   mainFit1142->SetChisquare(3.129428);
   ...
   mainFit1142->SetParameter(0,9.876557);
   mainFit1142->SetParError(0,0.2505408);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,1.207477);
   mainFit1142->SetParError(1,0.007335485);
   ...
   pt_LaTex = pt->AddText(" 1.21#pm0.00734");
   pt_LaTex = pt->AddText(" 9.88#pm0.251");
   pt_LaTex = pt->AddText(" 8.18#pm0.213");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.179497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.179497,-63.25113,-8.179497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(3.129428);
   ...
   mainFit1143->SetParameter(0,9.876557);
   mainFit1143->SetParError(0,0.2505408);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,1.207477);
   mainFit1143->SetParError(1,0.007335485);
