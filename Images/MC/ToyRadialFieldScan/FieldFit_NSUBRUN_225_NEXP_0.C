...
//=========  (Tue Dec  8 12:25:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-46.87697,45,64.43235);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","225 sub-runs",100,-36,36);
   Graph_Graph01069->SetMinimum(-35.74604);
   Graph_Graph01069->SetMaximum(53.30142);
   ...
   mainFit1070->SetChisquare(1.680224e-12);
   ...
   mainFit1070->SetParameter(0,8.777692);
   mainFit1070->SetParError(0,0.6206082);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,1.207514);
   mainFit1070->SetParError(1,0.02068694);
   ...
   pt_LaTex = pt->AddText(" 1.21#pm0.0207");
   pt_LaTex = pt->AddText(" 8.78#pm0.621");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.269223,-35.74604,-7.269223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(1.680224e-12);
   ...
   mainFit1071->SetParameter(0,8.777692);
   mainFit1071->SetParError(0,0.6206082);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,1.207514);
   mainFit1071->SetParError(1,0.02068694);
