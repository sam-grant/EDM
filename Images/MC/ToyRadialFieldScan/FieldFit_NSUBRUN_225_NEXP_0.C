...
//=========  (Wed Jan  5 17:06:59 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-46.65866,45,64.21405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-35.57139);
   Graph_Graph01069->SetMaximum(53.12678);
   ...
   mainFit1070->SetChisquare(2.845078e-13);
   ...
   mainFit1070->SetParError(0,0.6206081);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,1.202663);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.298545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.298545,-35.57139,-7.298545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(2.845078e-13);
   ...
   mainFit1071->SetParError(0,0.6206081);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,1.202663);
