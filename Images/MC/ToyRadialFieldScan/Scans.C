...
//=========  (Fri Oct  2 13:10:09 2020) by ROOT version 6.22/02
   ...
   lineFit1002->SetChisquare(6.626936e-25);
   ...
   lineFit1002->SetParError(0,0.1583862);
   lineFit1002->SetParLimits(0,0,0);
   lineFit1002->SetParameter(1,0.11875);
   lineFit1002->SetParError(1,0.008745414);
   ...
   lineFit1003->SetChisquare(6.626936e-25);
   ...
   lineFit1003->SetParError(0,0.1583862);
   lineFit1003->SetParLimits(0,0,0);
   lineFit1003->SetParameter(1,0.11875);
   lineFit1003->SetParError(1,0.008745414);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-1.177183);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.8478171);
   ...
   lineFit1004->SetChisquare(2.921041e-27);
   ...
   lineFit1004->SetParError(0,0.1583862);
   lineFit1004->SetParLimits(0,0,0);
   lineFit1004->SetParameter(1,0.05625);
   lineFit1004->SetParError(1,0.008745414);
   ...
   lineFit1005->SetChisquare(2.921041e-27);
   ...
   lineFit1005->SetParError(0,0.1583862);
   lineFit1005->SetParLimits(0,0,0);
   lineFit1005->SetParameter(1,0.05625);
   lineFit1005->SetParError(1,0.008745414);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(0.06781708);
   Graph_10dO000000sPppm1005->SetMaximum(0.1571829);
   ...
   lineFit1006->SetChisquare(1.25907e-29);
   ...
   lineFit1006->SetParError(0,0.1583862);
   lineFit1006->SetParLimits(0,0,0);
   lineFit1006->SetParameter(1,-0.00625);
   lineFit1006->SetParError(1,0.008745414);
   ...
   lineFit1007->SetChisquare(1.25907e-29);
   ...
   lineFit1007->SetParError(0,0.1583862);
   lineFit1007->SetParLimits(0,0,0);
   lineFit1007->SetParameter(1,-0.00625);
   lineFit1007->SetParError(1,0.008745414);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(1.042817);
   Graph_30dO000000sPppm1007->SetMaximum(1.432183);
   ...
   lineFit1008->SetChisquare(8.058045e-28);
   ...
   lineFit1008->SetParError(0,0.1583862);
   lineFit1008->SetParLimits(0,0,0);
   lineFit1008->SetParameter(1,-0.06875);
   lineFit1008->SetParError(1,0.008745414);
   ...
   lineFit1009->SetChisquare(8.058045e-28);
   ...
   lineFit1009->SetParError(0,0.1583862);
   lineFit1009->SetParLimits(0,0,0);
   lineFit1009->SetParameter(1,-0.06875);
   lineFit1009->SetParError(1,0.008745414);
