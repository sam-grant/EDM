...
//=========  (Tue Oct 20 14:17:02 2020) by ROOT version 6.22/02
   ...
   quadLineFit1098->SetChisquare(0.6889911);
   ...
   quadLineFit1098->SetParameter(0,-2.926327);
   quadLineFit1098->SetParError(0,0.06280787);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.08029139);
   quadLineFit1098->SetParError(1,0.003475055);
   ...
   quadLineFit1099->SetChisquare(0.6889911);
   ...
   quadLineFit1099->SetParameter(0,-2.926327);
   quadLineFit1099->SetParError(0,0.06280787);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.08029139);
   quadLineFit1099->SetParError(1,0.003475055);
   ...
   Graph_mI10dO000000sPppm1099->SetMinimum(-0.1762489);
   Graph_mI10dO000000sPppm1099->SetMaximum(-0.08338419);
   ...
   quadLineFit1100->SetChisquare(0.08861226);
   ...
   quadLineFit1100->SetParameter(0,-0.3884042);
   quadLineFit1100->SetParError(0,0.06280708);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.01443234);
   quadLineFit1100->SetParError(1,0.00347501);
   ...
   quadLineFit1101->SetChisquare(0.08861226);
   ...
   quadLineFit1101->SetParameter(0,-0.3884042);
   quadLineFit1101->SetParError(0,0.06280708);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.01443234);
   quadLineFit1101->SetParError(1,0.00347501);
   ...
   Graph_10dO000000sPppm1101->SetMinimum(1.043078);
   Graph_10dO000000sPppm1101->SetMaximum(1.396348);
   ...
   quadLineFit1102->SetChisquare(0.5681918);
   ...
   quadLineFit1102->SetParameter(0,2.45299);
   quadLineFit1102->SetParError(0,0.0628084);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-0.0686834);
   quadLineFit1102->SetParError(1,0.003475084);
   ...
   quadLineFit1103->SetChisquare(0.5681918);
   ...
   quadLineFit1103->SetParameter(0,2.45299);
   quadLineFit1103->SetParError(0,0.0628084);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-0.0686834);
   quadLineFit1103->SetParError(1,0.003475084);
   ...
   Graph_30dO000000sPppm1103->SetMinimum(2.23048);
   Graph_30dO000000sPppm1103->SetMaximum(2.931877);
   ...
   quadLineFit1104->SetChisquare(5.880863);
   ...
   quadLineFit1104->SetParameter(0,5.113224);
   quadLineFit1104->SetParError(0,0.0628097);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.1412098);
   quadLineFit1104->SetParError(1,0.003475157);
   ...
   quadLineFit1105->SetChisquare(5.880863);
   ...
   quadLineFit1105->SetParameter(0,5.113224);
   quadLineFit1105->SetParError(0,0.0628097);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.1412098);
   quadLineFit1105->SetParError(1,0.003475157);
