...
//=========  (Tue Oct 20 14:17:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2010921,45,0.1341571);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01117->SetMinimum(-0.1675672);
   Graph_Graph01117->SetMaximum(0.1006322);
   ...
   mainFit1118->SetChisquare(2.970588);
   ...
   mainFit1118->SetParameter(0,-0.031268);
   mainFit1118->SetParError(0,0.00164807);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.003588328);
   mainFit1118->SetParError(1,7.370336e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00359#pm7.37e-05");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00165");
   pt_LaTex = pt->AddText("#minus8.71#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.713808,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.713808,-0.1675672,-8.713808,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetChisquare(2.970588);
   ...
   mainFit1119->SetParameter(0,-0.031268);
   mainFit1119->SetParError(0,0.00164807);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.003588328);
   mainFit1119->SetParError(1,7.370336e-05);
