...
//=========  (Tue Oct 20 14:16:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1922378,45,0.1411608);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.1588979);
   Graph_Graph01069->SetMaximum(0.107821);
   ...
   mainFit1070->SetChisquare(0.6728722);
   ...
   mainFit1070->SetParameter(0,-0.0270802);
   mainFit1070->SetParError(0,0.002129747);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.003574695);
   mainFit1070->SetParError(1,9.524458e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00357#pm9.52e-05");
   pt_LaTex = pt->AddText("#minus0.0271#pm0.00213");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.575527,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.575527,-0.1588979,-7.575527,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(0.6728722);
   ...
   mainFit1071->SetParameter(0,-0.0270802);
   mainFit1071->SetParError(0,0.002129747);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.003574695);
   mainFit1071->SetParError(1,9.524458e-05);
