...
//=========  (Tue Oct 20 14:17:07 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-40.256,45,55.68507);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-30.66189);
   Graph_Graph01143->SetMaximum(46.09096);
   ...
   checkFit1144->SetParameter(0,8.228699);
   checkFit1144->SetParError(0,0.3994078);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,1.039123);
   checkFit1144->SetParError(1,0.01786206);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0179");
   pt_LaTex = pt->AddText(" 8.23#pm0.399");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.918885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.918885,-30.66189,-7.918885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetParameter(0,8.228699);
   checkFit1145->SetParError(0,0.3994078);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,1.039123);
   checkFit1145->SetParError(1,0.01786206);
