...
//=========  (Tue Oct 20 14:17:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.40916,45,53.58547);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-28.3097);
   Graph_Graph01107->SetMaximum(44.486);
   ...
   checkFit1108->SetParameter(0,7.645541);
   checkFit1108->SetParError(0,0.4613837);
   checkFit1108->SetParLimits(0,0,0);
   checkFit1108->SetParameter(1,0.9926163);
   checkFit1108->SetParError(1,0.02063371);
   ...
   pt_LaTex = pt->AddText("0.993#pm0.0206");
   pt_LaTex = pt->AddText(" 7.65#pm0.461");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.702413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.702413,-28.3097,-7.702413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1109->SetParameter(0,7.645541);
   checkFit1109->SetParError(0,0.4613837);
   checkFit1109->SetParLimits(0,0,0);
   checkFit1109->SetParameter(1,0.9926163);
   checkFit1109->SetParError(1,0.02063371);
