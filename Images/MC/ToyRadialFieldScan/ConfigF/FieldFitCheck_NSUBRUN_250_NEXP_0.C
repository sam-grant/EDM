...
//=========  (Tue Oct 20 14:17:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-35.62416,45,53.39811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01119->SetMinimum(-26.72194);
   Graph_Graph01119->SetMaximum(44.49588);
   ...
   checkFit1120->SetParameter(0,8.3029);
   checkFit1120->SetParError(0,0.437624);
   checkFit1120->SetParLimits(0,0,0);
   checkFit1120->SetParameter(1,0.9528463);
   ...
   pt_LaTex = pt->AddText("0.953#pm0.0196");
   pt_LaTex = pt->AddText("  8.3#pm0.438");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.713786,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.713786,-26.72194,-8.713786,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1121->SetParameter(0,8.3029);
   checkFit1121->SetParError(0,0.437624);
   checkFit1121->SetParLimits(0,0,0);
   checkFit1121->SetParameter(1,0.9528463);
