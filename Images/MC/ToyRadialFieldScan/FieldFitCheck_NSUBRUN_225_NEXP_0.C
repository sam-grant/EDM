...
//=========  (Wed Jan  5 17:06:59 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-38.71803,45,53.28574);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-29.51765);
   Graph_Graph01071->SetMaximum(44.08536);
   ...
   checkFit1072->SetChisquare(6.514631e-17);
   ...
   checkFit1072->SetParameter(1,0.9979872);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.298545,-29.51765,-7.298545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetChisquare(6.514631e-17);
   ...
   checkFit1073->SetParameter(1,0.9979872);
