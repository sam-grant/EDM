...
//=========  (Mon Jan 10 15:42:30 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01143->SetMinimum(-30.78048);
   Graph_Graph01143->SetMaximum(66.74878);
   ...
   checkFit1144->SetChisquare(0.3262356);
   checkFit1144->SetNDF(3);
   ...
   checkFit1144->SetParameter(0,8.024398);
   checkFit1144->SetParError(0,0.2721848);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,1.003819);
   checkFit1144->SetParError(1,0.009072827);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.99387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.99387,-30.78048,-7.99387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetChisquare(0.3262356);
   checkFit1145->SetNDF(3);
   ...
   checkFit1145->SetParameter(0,8.024398);
   checkFit1145->SetParError(0,0.2721848);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,1.003819);
   checkFit1145->SetParError(1,0.009072827);
