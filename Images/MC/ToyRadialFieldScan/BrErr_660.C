...
//=========  (Wed Jan  5 17:35:43 2022) by ROOT version 6.24/06
   ...
   TH1D *__29 = new TH1D("__29","Number of sub-runs: 660",2400,0.4,1.6);
   __29->SetBinContent(2401,1000);
   __29->SetEntries(1000);
   __29->SetStats(0);
   __29->GetXaxis()->SetTitle("Fitted #delta#LTB_{r}^{b}#GT [ppm]");
   __29->GetXaxis()->SetRange(1,2400);
   ...
   __29->GetYaxis()->SetTitle("Trials / 0.000500 ppm");
