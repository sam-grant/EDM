void FieldFitCheck_NSUBRUN_175_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.2327,75,396.2255);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-55.98684);
   Graph_Graph01111->SetMaximum(345.9797);
   ...
   checkFit1112->SetChisquare(140227.1);
   ...
   checkFit1112->SetParameter(0,67.1368);
   checkFit1112->SetParError(0,0.265953);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,-1.527107);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("3.51e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.96339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.96339,-55.98684,43.96339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetChisquare(140227.1);
   ...
   checkFit1113->SetParameter(0,67.1368);
   checkFit1113->SetParError(0,0.265953);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,-1.527107);
