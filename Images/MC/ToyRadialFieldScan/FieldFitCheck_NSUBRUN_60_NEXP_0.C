void FieldFitCheck_NSUBRUN_60_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-40.71264,45,58.11641);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","",100,-36,36);
   Graph_Graph01047->SetMinimum(-30.82974);
   Graph_Graph01047->SetMaximum(48.23351);
   ...
   Graph_Graph01047->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *checkFit1048 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1048->SetChisquare(4.233066e-16);
   ...
   checkFit1048->SetParameter(0,8.701885);
   checkFit1048->SetParError(0,0.9993054);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,1.050993);
   checkFit1048->SetParError(1,0.03331018);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.27968,-30.82974,-8.27968,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1049 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1049->SetChisquare(4.233066e-16);
   ...
   checkFit1049->SetParameter(0,8.701885);
   checkFit1049->SetParError(0,0.9993054);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,1.050993);
   checkFit1049->SetParError(1,0.03331018);
