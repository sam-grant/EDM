...
//=========  (Wed Jan  5 17:09:07 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01005->SetMinimum(-39.53666);
   Graph_Graph01005->SetMaximum(58.76112);
   ...
   mainFit1006->SetChisquare(6.094101e-16);
   ...
   mainFit1006->SetParameter(0,9.612228);
   mainFit1006->SetParError(0,3.028129);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,1.2225);
   mainFit1006->SetParError(1,0.1009376);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.862766,-39.53666,-7.862766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(6.094101e-16);
   ...
   mainFit1007->SetParameter(0,9.612228);
   mainFit1007->SetParError(0,3.028129);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,1.2225);
   mainFit1007->SetParError(1,0.1009376);
