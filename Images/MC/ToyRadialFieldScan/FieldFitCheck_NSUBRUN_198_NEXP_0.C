void FieldFitCheck_NSUBRUN_198_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:38:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-37.50667,45,53.80024);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","",100,-36,36);
   Graph_Graph01023->SetMinimum(-28.37598);
   Graph_Graph01023->SetMaximum(44.66955);
   ...
   Graph_Graph01023->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *checkFit1024 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1024->SetChisquare(3.632984e-17);
   ...
   checkFit1024->SetParameter(0,8.146788);
   checkFit1024->SetParError(0,0.549193);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.988632);
   checkFit1024->SetParError(1,0.01830643);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.989
#pm0.0183
");
   pt_LaTex = pt->AddText("8.15
#pm0.549
");
   pt_LaTex = pt->AddText("8.24
#pm0.576
");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.240466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.240466,-28.37598,-8.240466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1025 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1025->SetChisquare(3.632984e-17);
   ...
   checkFit1025->SetParameter(0,8.146788);
   checkFit1025->SetParError(0,0.549193);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.988632);
   checkFit1025->SetParError(1,0.01830643);
