void FieldFitCheck_NSUBRUN_10_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-43.0042,45,58.95693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-32.80809);
   Graph_Graph01007->SetMaximum(48.76082);
   ...
   checkFit1008->SetChisquare(1.324555e-16);
   ...
   checkFit1008->SetParameter(0,7.976364);
   checkFit1008->SetParError(0,2.512785);
   checkFit1008->SetParLimits(0,0,0);
   checkFit1008->SetParameter(1,1.014448);
   checkFit1008->SetParError(1,0.08375949);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.862766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.862766,-32.80809,-7.862766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(1.324555e-16);
   ...
   checkFit1009->SetParameter(0,7.976364);
   checkFit1009->SetParError(0,2.512785);
   checkFit1009->SetParLimits(0,0,0);
   checkFit1009->SetParameter(1,1.014448);
   checkFit1009->SetParError(1,0.08375949);
