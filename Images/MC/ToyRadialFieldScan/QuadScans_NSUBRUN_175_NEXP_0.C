...
//=========  (Tue Oct  6 23:07:54 2020) by ROOT version 6.22/02
   ...
   quadLineFit1062->SetChisquare(3.796863e-19);
   ...
   quadLineFit1062->SetParameter(0,-4.182709);
   quadLineFit1062->SetParError(0,0.07161062);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.1139533);
   quadLineFit1062->SetParError(1,0.003954035);
   ...
   quadLineFit1063->SetChisquare(3.796863e-19);
   ...
   quadLineFit1063->SetParameter(0,-4.182709);
   quadLineFit1063->SetParError(0,0.07161062);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.1139533);
   quadLineFit1063->SetParError(1,0.003954035);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-1.175763);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.856142);
   ...
   quadLineFit1064->SetChisquare(1.582525e-19);
   ...
   quadLineFit1064->SetParameter(0,-2.113878);
   quadLineFit1064->SetParError(0,0.07161062);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.06099585);
   quadLineFit1064->SetParError(1,0.003954035);
   ...
   quadLineFit1065->SetChisquare(1.582525e-19);
   ...
   quadLineFit1065->SetParameter(0,-2.113878);
   quadLineFit1065->SetParError(0,0.07161062);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.06099585);
   quadLineFit1065->SetParError(1,0.003954035);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(0.06996499);
   Graph_10dO000000sPppm1065->SetMaximum(0.1397164);
   ...
   quadLineFit1066->SetChisquare(4.142281e-22);
   ...
   quadLineFit1066->SetParameter(0,0.2657554);
   quadLineFit1066->SetParError(0,0.07161062);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.008939704);
   quadLineFit1066->SetParError(1,0.003954035);
   ...
   quadLineFit1067->SetChisquare(4.142281e-22);
   ...
   quadLineFit1067->SetParameter(0,0.2657554);
   quadLineFit1067->SetParError(0,0.07161062);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.008939704);
   quadLineFit1067->SetParError(1,0.003954035);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(1.063888);
   Graph_30dO000000sPppm1067->SetMaximum(1.420199);
   ...
   quadLineFit1068->SetChisquare(6.372542e-18);
   ...
   quadLineFit1068->SetParameter(0,2.477556);
   quadLineFit1068->SetParError(0,0.07161062);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.06863958);
   quadLineFit1068->SetParError(1,0.003954035);
   ...
   quadLineFit1069->SetChisquare(6.372542e-18);
   ...
   quadLineFit1069->SetParameter(0,2.477556);
   quadLineFit1069->SetParError(0,0.07161062);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.06863958);
   quadLineFit1069->SetParError(1,0.003954035);
