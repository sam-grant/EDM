...
//=========  (Fri Oct  9 18:33:00 2020) by ROOT version 6.22/02
   ...
   quadLineFit1062->SetChisquare(8.680572e-20);
   ...
   quadLineFit1062->SetParameter(0,-2.945797);
   quadLineFit1062->SetParError(0,0.07140628);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.0808771);
   ...
   quadLineFit1063->SetChisquare(8.680572e-20);
   ...
   quadLineFit1063->SetParameter(0,-2.945797);
   quadLineFit1063->SetParError(0,0.07140628);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.0808771);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-0.1781366);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.1183902);
   ...
   quadLineFit1064->SetChisquare(1.93621e-21);
   ...
   quadLineFit1064->SetParameter(0,-0.2719462);
   quadLineFit1064->SetParError(0,0.07140628);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.006871268);
   ...
   quadLineFit1065->SetChisquare(1.93621e-21);
   ...
   quadLineFit1065->SetParameter(0,-0.2719462);
   quadLineFit1065->SetParError(0,0.07140628);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.006871268);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(1.037073);
   Graph_10dO000000sPppm1065->SetMaximum(1.378299);
   ...
   quadLineFit1066->SetChisquare(1.017631e-19);
   ...
   quadLineFit1066->SetParameter(0,2.38692);
   quadLineFit1066->SetParError(0,0.07140628);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.06551302);
   ...
   quadLineFit1067->SetChisquare(1.017631e-19);
   ...
   quadLineFit1067->SetParameter(0,2.38692);
   quadLineFit1067->SetParError(0,0.07140628);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.06551302);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(2.211536);
   Graph_30dO000000sPppm1067->SetMaximum(2.920913);
   ...
   quadLineFit1068->SetChisquare(4.642088e-20);
   ...
   quadLineFit1068->SetParameter(0,5.126023);
   quadLineFit1068->SetParError(0,0.07140628);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.142211);
   ...
   quadLineFit1069->SetChisquare(4.642088e-20);
   ...
   quadLineFit1069->SetParameter(0,5.126023);
   quadLineFit1069->SetParError(0,0.07140628);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.142211);
