...
//=========  (Fri Oct  9 09:35:39 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1061->SetMaximum(2.5);
   ...
   quadLineFit1062->SetChisquare(4.577463e-22);
   ...
   quadLineFit1062->SetParameter(0,-4.289972);
   quadLineFit1062->SetParError(0,0.07140628);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.1195138);
   ...
   quadLineFit1063->SetChisquare(4.577463e-22);
   ...
   quadLineFit1063->SetParameter(0,-4.289972);
   quadLineFit1063->SetParError(0,0.07140628);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.1195138);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-1.159197);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.8843484);
   ...
   quadLineFit1064->SetChisquare(6.514974e-20);
   ...
   quadLineFit1064->SetParameter(0,-1.952087);
   quadLineFit1064->SetParError(0,0.07140629);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.05168413);
   ...
   quadLineFit1065->SetChisquare(6.514974e-20);
   ...
   quadLineFit1065->SetParameter(0,-1.952087);
   quadLineFit1065->SetParError(0,0.07140629);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.05168413);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(0.05784877);
   Graph_10dO000000sPppm1065->SetMaximum(0.1182772);
   ...
   quadLineFit1066->SetChisquare(2.625123e-22);
   ...
   quadLineFit1066->SetParameter(0,0.2143037);
   quadLineFit1066->SetParError(0,0.07140628);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.007013372);
   ...
   quadLineFit1067->SetChisquare(2.625123e-22);
   ...
   quadLineFit1067->SetParameter(0,0.2143037);
   quadLineFit1067->SetParError(0,0.07140628);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.007013372);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(1.055603);
   Graph_30dO000000sPppm1067->SetMaximum(1.409599);
   ...
   quadLineFit1068->SetChisquare(3.3648e-20);
   ...
   quadLineFit1068->SetParameter(0,2.459718);
   quadLineFit1068->SetParError(0,0.07140628);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.06817316);
   ...
   quadLineFit1069->SetChisquare(3.3648e-20);
   ...
   quadLineFit1069->SetParameter(0,2.459718);
   quadLineFit1069->SetParError(0,0.07140628);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.06817316);
