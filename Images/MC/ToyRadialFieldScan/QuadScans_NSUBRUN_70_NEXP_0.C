void QuadScans_NSUBRUN_70_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:10:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.093402,0.0768254,3.890555);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1001->SetMinimum(-2.395006);
   Graph_30dO000000sPppm1001->SetMaximum(3.192159);
   ...
   quadLineFit1002->SetChisquare(1.376617e-18);
   ...
   quadLineFit1002->SetParameter(0,-0.0004374706);
   quadLineFit1002->SetParError(0,0.1007563);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.97496);
   quadLineFit1002->SetParError(1,1.574657);
   ...
   quadLineFit1003->SetChisquare(1.376617e-18);
   ...
   quadLineFit1003->SetParameter(0,-0.0004374706);
   quadLineFit1003->SetParError(0,0.1007563);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.97496);
   quadLineFit1003->SetParError(1,1.574657);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-1.979618);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.428353);
   ...
   quadLineFit1004->SetChisquare(9.29468e-19);
   ...
   quadLineFit1004->SetParameter(0,-0.007827461);
   quadLineFit1004->SetParError(0,0.1007563);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-26.71449);
   quadLineFit1004->SetParError(1,1.574657);
   ...
   quadLineFit1005->SetChisquare(9.29468e-19);
   ...
   quadLineFit1005->SetParameter(0,-0.007827461);
   quadLineFit1005->SetParError(0,0.1007563);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-26.71449);
   quadLineFit1005->SetParError(1,1.574657);
