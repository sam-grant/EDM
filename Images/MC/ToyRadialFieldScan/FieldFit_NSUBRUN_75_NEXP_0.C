...
//=========  (Wed Dec  2 23:07:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-49.19435,45,65.06019);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","75 sub-runs",100,-36,36);
   Graph_Graph01033->SetMinimum(-37.76889);
   Graph_Graph01033->SetMaximum(53.63474);
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("#LTy#GT QHV [mm#upointkV]");
   ...
   mainFit1034->SetChisquare(1.726573);
   ...
   mainFit1034->SetParameter(0,8.336376);
   mainFit1034->SetParError(0,0.7586784);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.232512);
   mainFit1034->SetParError(1,0.03392864);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.863");
   pt_LaTex = pt->AddText(" 1.23#pm0.0339");
   pt_LaTex = pt->AddText(" 8.34#pm0.759");
   pt_LaTex = pt->AddText(" 6.76#pm0.643");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.763726,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.763726,-37.76889,-6.763726,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.726573);
   ...
   mainFit1035->SetParameter(0,8.336376);
   mainFit1035->SetParError(0,0.7586784);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.232512);
   mainFit1035->SetParError(1,0.03392864);
