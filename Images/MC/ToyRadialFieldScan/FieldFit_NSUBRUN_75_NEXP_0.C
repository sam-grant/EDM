...
//=========  (Tue Nov 10 15:16:14 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-80.84857,75,102.6628);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-62.49744);
   Graph_Graph01045->SetMaximum(84.31166);
   ...
   mainFit1046->SetChisquare(3.612086);
   ...
   mainFit1046->SetParameter(0,9.961389);
   mainFit1046->SetParError(0,0.4323136);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,1.201945);
   mainFit1046->SetParError(1,0.01265687);
   ...
   pt_LaTex = pt->AddText(" 9.96#pm0.432");
   pt_LaTex = pt->AddText(" 8.29#pm 0.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.287723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.287723,-62.49744,-8.287723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(3.612086);
   ...
   mainFit1047->SetParameter(0,9.961389);
   mainFit1047->SetParError(0,0.4323136);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,1.201945);
   mainFit1047->SetParError(1,0.01265687);
