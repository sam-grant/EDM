...
//=========  (Tue Dec  8 12:25:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-47.58477,45,67.44124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","75 sub-runs",100,-36,36);
   Graph_Graph01021->SetMinimum(-36.08217);
   Graph_Graph01021->SetMaximum(55.93863);
   ...
   mainFit1022->SetChisquare(2.808868e-15);
   ...
   mainFit1022->SetParameter(1,1.227356);
   ...
   pt_LaTex = pt->AddText(" 1.23#pm0.0359");
   pt_LaTex = pt->AddText(" 9.93#pm 1.08");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.089123,-36.08217,-8.089123,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(2.808868e-15);
   ...
   mainFit1023->SetParameter(1,1.227356);
