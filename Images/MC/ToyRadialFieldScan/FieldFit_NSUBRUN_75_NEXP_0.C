...
//=========  (Thu May  5 12:48:37 2022) by ROOT version 6.24/06
   ...
   c->Range(-75,-78.83828,75,102.0704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-60.74741);
   Graph_Graph01045->SetMaximum(83.97952);
   ...
   mainFit1046->SetChisquare(3.491631);
   ...
   mainFit1046->SetParameter(0,10.62493);
   mainFit1046->SetParError(0,0.5050634);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,1.206208);
   mainFit1046->SetParError(1,0.01593207);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.873");
   pt_LaTex = pt->AddText("1.21
#pm0.02
");
   pt_LaTex = pt->AddText("10.6
#pm0.5
");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.808538,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.808538,-60.74741,-8.808538,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(3.491631);
   ...
   mainFit1047->SetParameter(0,10.62493);
   mainFit1047->SetParError(0,0.5050634);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,1.206208);
   mainFit1047->SetParError(1,0.01593207);
