...
//=========  (Mon Oct 12 20:04:23 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01079->SetMinimum(-0.1716874);
   Graph_Graph01079->SetMaximum(0.1067929);
   ...
   TF1 *mainFit1080 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   mainFit1080->SetFillColor(19);
   mainFit1080->SetFillStyle(0);

   ci = TColor::GetColor("#ff0000");
   mainFit1080->SetLineColor(ci);
   mainFit1080->SetLineWidth(2);
   mainFit1080->SetChisquare(1.067531);
   mainFit1080->SetNDF(2);
   mainFit1080->GetXaxis()->SetLabelFont(42);
   mainFit1080->GetXaxis()->SetTitleOffset(1);
   mainFit1080->GetXaxis()->SetTitleFont(42);
   mainFit1080->GetYaxis()->SetLabelFont(42);
   mainFit1080->GetYaxis()->SetTitleFont(42);
   mainFit1080->SetParameter(0,-0.03187908);
   mainFit1080->SetParError(0,0.001843341);
   mainFit1080->SetParLimits(0,0,0);
   mainFit1080->SetParameter(1,-0.003771991);
   mainFit1080->SetParError(1,8.243673e-05);
   mainFit1080->SetParLimits(1,0,0);
   mainFit1080->SetParent(gre);
   gre->GetListOfFunctions()->Add(mainFit1080);
   gre->Draw("ap");
   ...
   TF1 *mainFit1081 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   mainFit1081->SetFillColor(19);
   mainFit1081->SetFillStyle(0);

   ci = TColor::GetColor("#ff0000");
   mainFit1081->SetLineColor(ci);
   mainFit1081->SetLineWidth(2);
   mainFit1081->SetChisquare(1.067531);
   mainFit1081->SetNDF(2);
   mainFit1081->GetXaxis()->SetLabelFont(42);
   mainFit1081->GetXaxis()->SetTitleOffset(1);
   mainFit1081->GetXaxis()->SetTitleFont(42);
   mainFit1081->GetYaxis()->SetLabelFont(42);
   mainFit1081->GetYaxis()->SetTitleFont(42);
   mainFit1081->SetParameter(0,-0.03187908);
   mainFit1081->SetParError(0,0.001843341);
   mainFit1081->SetParLimits(0,0,0);
   mainFit1081->SetParameter(1,-0.003771991);
   mainFit1081->SetParError(1,8.243673e-05);
   mainFit1081->SetParLimits(1,0,0);
   mainFit1081->Draw("same");
