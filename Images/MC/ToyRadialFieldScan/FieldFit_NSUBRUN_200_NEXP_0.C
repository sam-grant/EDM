...
//=========  (Fri Oct  9 19:09:38 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.205416,45,0.1452157);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-0.1703529);
   Graph_Graph01079->SetMaximum(0.1101525);
   ...
   fieldLineFit1080->SetChisquare(0.1924697);
   ...
   fieldLineFit1080->SetParameter(0,-0.03088988);
   fieldLineFit1080->SetParError(0,0.001843341);
   fieldLineFit1080->SetParLimits(0,0,0);
   fieldLineFit1080->SetParameter(1,-0.003775615);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0962");
   pt_LaTex = pt->AddText("#minus0.00378#pm8.24e-05");
   pt_LaTex = pt->AddText("#minus0.0309#pm0.00184");
   pt_LaTex = pt->AddText("#minus8.18#pm0.488");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.181418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.181418,-0.1703529,-8.181418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1081->SetChisquare(0.1924697);
   ...
   fieldLineFit1081->SetParameter(0,-0.03088988);
   fieldLineFit1081->SetParError(0,0.001843341);
   fieldLineFit1081->SetParLimits(0,0,0);
   fieldLineFit1081->SetParameter(1,-0.003775615);
