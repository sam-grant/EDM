...
//=========  (Thu May  5 12:48:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-83.49227,75,102.6491);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-64.87814);
   Graph_Graph01125->SetMaximum(84.03495);
   ...
   mainFit1126->SetChisquare(1.739631);
   ...
   mainFit1126->SetParameter(0,10.10808);
   mainFit1126->SetParError(0,0.3092126);
   mainFit1126->SetParLimits(0,0,0);
   mainFit1126->SetParameter(1,1.218334);
   mainFit1126->SetParError(1,0.00975429);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.296646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.296646,-64.87814,-8.296646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1127->SetChisquare(1.739631);
   ...
   mainFit1127->SetParameter(0,10.10808);
   mainFit1127->SetParError(0,0.3092126);
   mainFit1127->SetParLimits(0,0,0);
   mainFit1127->SetParameter(1,1.218334);
   mainFit1127->SetParError(1,0.00975429);
