void FieldFitCheck_NSUBRUN_858_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:45 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01103->SetMinimum(-28);
   Graph_Graph01103->SetMaximum(44);
   ...
   checkFit1104->SetChisquare(3.048279e-18);
   ...
   checkFit1104->SetParameter(0,8);
   checkFit1104->SetParError(0,0.7071068);
   checkFit1104->SetParLimits(0,0,0);
   checkFit1104->SetParameter(1,1);
   checkFit1104->SetParError(1,0.02357023);
...
");
   ...
   checkFit1105->SetChisquare(3.048279e-18);
   ...
   checkFit1105->SetParameter(0,8);
   checkFit1105->SetParError(0,0.7071068);
   checkFit1105->SetParLimits(0,0,0);
   checkFit1105->SetParameter(1,1);
   checkFit1105->SetParError(1,0.02357023);
