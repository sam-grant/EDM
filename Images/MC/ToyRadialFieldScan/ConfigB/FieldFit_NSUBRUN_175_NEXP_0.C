...
//=========  (Tue Oct 20 14:20:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.4072725,75,0.3159159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-0.3349537);
   Graph_Graph01109->SetMaximum(0.243597);
   ...
   mainFit1110->SetChisquare(9.754667);
   ...
   mainFit1110->SetParameter(0,-0.03965791);
   mainFit1110->SetParError(0,0.001609614);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,-0.004733988);
   mainFit1110->SetParError(1,4.712442e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00473#pm4.71e-05");
   pt_LaTex = pt->AddText("#minus0.0397#pm0.00161");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.377273,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.377273,-0.3349537,-8.377273,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetChisquare(9.754667);
   ...
   mainFit1111->SetParameter(0,-0.03965791);
   mainFit1111->SetParError(0,0.001609614);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,-0.004733988);
   mainFit1111->SetParError(1,4.712442e-05);
