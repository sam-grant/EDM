...
//=========  (Tue Oct 20 14:20:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.4034001,75,0.330371);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-0.330023);
   Graph_Graph01141->SetMaximum(0.2569939);
   ...
   mainFit1142->SetChisquare(12.07414);
   ...
   mainFit1142->SetParameter(0,-0.04004389);
   mainFit1142->SetParError(0,0.001418682);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,-0.004829692);
   mainFit1142->SetParError(1,4.153478e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00483#pm4.15e-05");
   pt_LaTex = pt->AddText("#minus0.04#pm0.00142");
   pt_LaTex = pt->AddText("#minus8.29#pm0.302");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.291188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.291188,-0.330023,-8.291188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(12.07414);
   ...
   mainFit1143->SetParameter(0,-0.04004389);
   mainFit1143->SetParError(0,0.001418682);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,-0.004829692);
   mainFit1143->SetParError(1,4.153478e-05);
