...
//=========  (Tue Oct 20 14:20:39 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.403037,75,0.3201912);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.3307142);
   Graph_Graph01045->SetMaximum(0.2478684);
   ...
   mainFit1046->SetChisquare(8.568184);
   ...
   mainFit1046->SetParameter(0,-0.03729888);
   mainFit1046->SetParError(0,0.002448151);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.004795043);
   mainFit1046->SetParError(1,7.167455e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0048#pm7.17e-05");
   pt_LaTex = pt->AddText("#minus0.0373#pm0.00245");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.778632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.778632,-0.3307142,-7.778632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(8.568184);
   ...
   mainFit1047->SetParameter(0,-0.03729888);
   mainFit1047->SetParError(0,0.002448151);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.004795043);
   mainFit1047->SetParError(1,7.167455e-05);
