...
//=========  (Tue Oct 20 14:20:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.410112,75,0.3333855);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-0.3357623);
   Graph_Graph01061->SetMaximum(0.2590357);
   ...
   mainFit1062->SetChisquare(2.271845);
   ...
   mainFit1062->SetParameter(0,-0.04026777);
   mainFit1062->SetParError(0,0.002132397);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,-0.004800742);
   mainFit1062->SetParError(1,6.24297e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0048#pm6.24e-05");
   pt_LaTex = pt->AddText("#minus0.0403#pm0.00213");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.387822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.387822,-0.3357623,-8.387822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(2.271845);
   ...
   mainFit1063->SetParameter(0,-0.04026777);
   mainFit1063->SetParError(0,0.002132397);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,-0.004800742);
   mainFit1063->SetParError(1,6.24297e-05);
