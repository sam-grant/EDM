...
//=========  (Tue Oct 20 14:20:38 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.79936,75,83.67113);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-53.55231);
   Graph_Graph01031->SetMaximum(68.42408);
   ...
   checkFit1032->SetParameter(0,7.018322);
   checkFit1032->SetParError(0,0.626002);
   checkFit1032->SetParLimits(0,0,0);
   checkFit1032->SetParameter(1,0.9951389);
   checkFit1032->SetParError(1,0.01832746);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.0183");
   pt_LaTex = pt->AddText(" 7.02#pm0.626");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.052605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.052605,-53.55231,-7.052605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetParameter(0,7.018322);
   checkFit1033->SetParError(0,0.626002);
   checkFit1033->SetParLimits(0,0,0);
   checkFit1033->SetParameter(1,0.9951389);
   checkFit1033->SetParError(1,0.01832746);
