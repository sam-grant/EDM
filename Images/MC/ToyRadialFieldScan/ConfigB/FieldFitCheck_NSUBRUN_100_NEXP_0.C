...
//=========  (Tue Oct 20 14:20:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.71531,75,85.75987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","Sub-runs 100",100,-60,60);
   Graph_Graph01063->SetMinimum(-54.16779);
   Graph_Graph01063->SetMaximum(70.21235);
   ...
   checkFit1064->SetChisquare(2.271849);
   ...
   checkFit1064->SetParameter(0,8.420523);
   checkFit1064->SetParError(0,0.4459126);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,1.003898);
   checkFit1064->SetParError(1,0.01305498);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0131");
   pt_LaTex = pt->AddText(" 8.42#pm0.446");
   pt_LaTex = pt->AddText("#minus8.39#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.387824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.387824,-54.16779,-8.387824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(2.271849);
   ...
   checkFit1065->SetParameter(0,8.420523);
   checkFit1065->SetParError(0,0.4459126);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,1.003898);
   checkFit1065->SetParError(1,0.01305498);
