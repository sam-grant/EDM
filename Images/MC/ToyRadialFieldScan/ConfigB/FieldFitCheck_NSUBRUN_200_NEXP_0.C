...
//=========  (Tue Oct 20 14:20:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.83688,75,84.75987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01127 = new TH1F("Graph_Graph01127","Sub-runs 200",100,-60,60);
   Graph_Graph01127->SetMinimum(-53.4772);
   Graph_Graph01127->SetMaximum(69.40019);
   ...
   checkFit1128->SetChisquare(4.904829);
   ...
   checkFit1128->SetParameter(0,7.890839);
   checkFit1128->SetParError(0,0.3147325);
   checkFit1128->SetParLimits(0,0,0);
   checkFit1128->SetParameter(1,0.9988993);
   checkFit1128->SetParError(1,0.009214424);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.00921");
   pt_LaTex = pt->AddText(" 7.89#pm0.315");
   pt_LaTex = pt->AddText(" #minus7.9#pm0.323");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.899534,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.899534,-53.4772,-7.899534,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1129->SetChisquare(4.904829);
   ...
   checkFit1129->SetParameter(0,7.890839);
   checkFit1129->SetParError(0,0.3147325);
   checkFit1129->SetParLimits(0,0,0);
   checkFit1129->SetParameter(1,0.9988993);
   checkFit1129->SetParError(1,0.009214424);
