...
//=========  (Tue Oct 20 14:20:39 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1033 = new TH1F("Graph_mI50dO000000sPppm1033","",100,13.6,18.4);
   ...
   TF1 *quadLineFit1034 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1034->SetFillColor(19);
   quadLineFit1034->SetFillStyle(0);
   quadLineFit1034->SetLineWidth(2);
   quadLineFit1034->SetChisquare(5.908574);
   ...
   quadLineFit1034->SetParameter(0,-6.292448);
   quadLineFit1034->SetParError(0,0.0964462);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.1936565);
   quadLineFit1034->SetParError(1,0.005996735);
   quadLineFit1034->SetParLimits(1,0,0);
   quadLineFit1034->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1034);
   gre->Draw("ap");
   
   TF1 *quadLineFit1035 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1035->SetFillColor(19);
   quadLineFit1035->SetFillStyle(0);
   quadLineFit1035->SetLineWidth(2);
   quadLineFit1035->SetChisquare(5.908574);
   ...
   quadLineFit1035->SetParameter(0,-6.292448);
   quadLineFit1035->SetParError(0,0.0964462);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.1936565);
   quadLineFit1035->SetParError(1,0.005996735);
   ...
   TH1F *Graph_mI30dO000000sPppm1035 = new TH1F("Graph_mI30dO000000sPppm1035","Graph",100,13.6,18.4);
   Graph_mI30dO000000sPppm1035->SetMinimum(-1.97646);
   Graph_mI30dO000000sPppm1035->SetMaximum(-1.3999);
   ...
   TF1 *quadLineFit1036 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1036->SetChisquare(0.0004121885);
   ...
   quadLineFit1036->SetParameter(0,-3.474495);
   quadLineFit1036->SetParError(0,0.09644594);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,0.1116359);
   quadLineFit1036->SetParError(1,0.005996719);
   quadLineFit1036->SetParLimits(1,0,0);
   quadLineFit1036->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1036);
   gre->Draw("p ");
   
   TF1 *quadLineFit1037 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1037->SetChisquare(0.0004121885);
   ...
   quadLineFit1037->SetParameter(0,-3.474495);
   quadLineFit1037->SetParError(0,0.09644594);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,0.1116359);
   quadLineFit1037->SetParError(1,0.005996719);
   ...
   TH1F *Graph_mI10dO000000sPppm1037 = new TH1F("Graph_mI10dO000000sPppm1037","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1037->SetMinimum(-0.2147147);
   Graph_mI10dO000000sPppm1037->SetMaximum(-0.09027042);
   ...
   TF1 *quadLineFit1038 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1038->SetChisquare(0.4046093);
   ...
   quadLineFit1038->SetParameter(0,-0.4360211);
   quadLineFit1038->SetParError(0,0.09644597);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.01744525);
   quadLineFit1038->SetParError(1,0.005996721);
   quadLineFit1038->SetParLimits(1,0,0);
   quadLineFit1038->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1038);
   gre->Draw("p ");
   
   TF1 *quadLineFit1039 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1039->SetChisquare(0.4046093);
   ...
   quadLineFit1039->SetParameter(0,-0.4360211);
   quadLineFit1039->SetParError(0,0.09644597);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.01744525);
   quadLineFit1039->SetParError(1,0.005996721);
   ...
   TH1F *Graph_10dO000000sPppm1039 = new TH1F("Graph_10dO000000sPppm1039","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1039->SetMinimum(1.163836);
   Graph_10dO000000sPppm1039->SetMaximum(1.58062);
   ...
   TF1 *quadLineFit1040 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1040->SetChisquare(1.579944);
   ...
   quadLineFit1040->SetParameter(0,2.617114);
   quadLineFit1040->SetParError(0,0.09644595);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,-0.07834937);
   quadLineFit1040->SetParError(1,0.00599672);
   quadLineFit1040->SetParLimits(1,0,0);
   quadLineFit1040->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1040);
   gre->Draw("p ");
   
   TF1 *quadLineFit1041 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1041->SetChisquare(1.579944);
   ...
   quadLineFit1041->SetParameter(0,2.617114);
   quadLineFit1041->SetParError(0,0.09644595);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,-0.07834937);
   quadLineFit1041->SetParError(1,0.00599672);
   ...
   TH1F *Graph_30dO000000sPppm1041 = new TH1F("Graph_30dO000000sPppm1041","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1041->SetMinimum(2.432953);
   Graph_30dO000000sPppm1041->SetMaximum(3.393712);
   ...
   TF1 *quadLineFit1042 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1042->SetChisquare(1.931138);
   ...
   quadLineFit1042->SetParameter(0,5.970552);
   quadLineFit1042->SetParError(0,0.09644598);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.1916776);
   quadLineFit1042->SetParError(1,0.005996722);
   quadLineFit1042->SetParLimits(1,0,0);
   quadLineFit1042->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1042);
   gre->Draw("p ");
   
   TF1 *quadLineFit1043 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1043->SetChisquare(1.931138);
   ...
   quadLineFit1043->SetParameter(0,5.970552);
   quadLineFit1043->SetParError(0,0.09644598);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.1916776);
   quadLineFit1043->SetParError(1,0.005996722);
   ...
   TH1F *Graph_50dO000000sPppm1043 = new TH1F("Graph_50dO000000sPppm1043","Graph",100,13.6,18.4);
   Graph_50dO000000sPppm1043->SetMinimum(3.745614);
   Graph_50dO000000sPppm1043->SetMaximum(5.113532);
   ...
   TF1 *quadLineFit1044 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1044->SetChisquare(5.173936);
   ...
   quadLineFit1044->SetParameter(0,8.837859);
   quadLineFit1044->SetParError(0,0.09644584);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.2765022);
   quadLineFit1044->SetParError(1,0.005996713);
   quadLineFit1044->SetParLimits(1,0,0);
   quadLineFit1044->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1044);
   gre->Draw("p ");
   
   TF1 *quadLineFit1045 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1045->SetChisquare(5.173936);
   ...
   quadLineFit1045->SetParameter(0,8.837859);
   quadLineFit1045->SetParError(0,0.09644584);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.2765022);
   quadLineFit1045->SetParError(1,0.005996713);
