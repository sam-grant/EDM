...
//=========  (Tue Oct 20 14:20:48 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1145 = new TH1F("Graph_mI50dO000000sPppm1145","",100,13.6,18.4);
   ...
   quadLineFit1146->SetChisquare(25.31542);
   ...
   quadLineFit1146->SetParameter(0,-6.432916);
   quadLineFit1146->SetParError(0,0.05301155);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,0.2023551);
   quadLineFit1146->SetParError(1,0.003296099);
   ...
   quadLineFit1147->SetChisquare(25.31542);
   ...
   quadLineFit1147->SetParameter(0,-6.432916);
   quadLineFit1147->SetParError(0,0.05301155);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,0.2023551);
   quadLineFit1147->SetParError(1,0.003296099);
   ...
   TH1F *Graph_mI30dO000000sPppm1147 = new TH1F("Graph_mI30dO000000sPppm1147","Graph",100,13.6,18.4);
   Graph_mI30dO000000sPppm1147->SetMinimum(-1.947778);
   Graph_mI30dO000000sPppm1147->SetMaximum(-1.425364);
   ...
   quadLineFit1148->SetChisquare(6.244588);
   ...
   quadLineFit1148->SetParameter(0,-3.343859);
   quadLineFit1148->SetParError(0,0.05301135);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,0.1041749);
   quadLineFit1148->SetParError(1,0.003296086);
   ...
   quadLineFit1149->SetChisquare(6.244588);
   ...
   quadLineFit1149->SetParameter(0,-3.343859);
   quadLineFit1149->SetParError(0,0.05301135);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,0.1041749);
   quadLineFit1149->SetParError(1,0.003296086);
   ...
   TH1F *Graph_mI10dO000000sPppm1149 = new TH1F("Graph_mI10dO000000sPppm1149","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1149->SetMinimum(-0.1744998);
   Graph_mI10dO000000sPppm1149->SetMaximum(-0.1171471);
   ...
   quadLineFit1150->SetChisquare(0.8781077);
   ...
   quadLineFit1150->SetParameter(0,-0.2659836);
   quadLineFit1150->SetParError(0,0.05301183);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,0.007287101);
   quadLineFit1150->SetParError(1,0.003296117);
   ...
   quadLineFit1151->SetChisquare(0.8781077);
   ...
   quadLineFit1151->SetParameter(0,-0.2659836);
   quadLineFit1151->SetParError(0,0.05301183);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,0.007287101);
   quadLineFit1151->SetParError(1,0.003296117);
   ...
   TH1F *Graph_10dO000000sPppm1151 = new TH1F("Graph_10dO000000sPppm1151","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1151->SetMinimum(1.171039);
   Graph_10dO000000sPppm1151->SetMaximum(1.579498);
   ...
   quadLineFit1152->SetChisquare(8.338858);
   ...
   quadLineFit1152->SetParameter(0,2.651223);
   quadLineFit1152->SetParError(0,0.05301152);
   quadLineFit1152->SetParLimits(0,0,0);
   quadLineFit1152->SetParameter(1,-0.08043411);
   quadLineFit1152->SetParError(1,0.003296098);
   ...
   quadLineFit1153->SetChisquare(8.338858);
   ...
   quadLineFit1153->SetParameter(0,2.651223);
   quadLineFit1153->SetParError(0,0.05301152);
   quadLineFit1153->SetParLimits(0,0,0);
   quadLineFit1153->SetParameter(1,-0.08043411);
   quadLineFit1153->SetParError(1,0.003296098);
   ...
   TH1F *Graph_30dO000000sPppm1153 = new TH1F("Graph_30dO000000sPppm1153","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1153->SetMinimum(2.469204);
   Graph_30dO000000sPppm1153->SetMaximum(3.349151);
   ...
   TF1 *quadLineFit1154 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1154->SetChisquare(10.64025);
   ...
   quadLineFit1154->SetParameter(0,5.755337);
   quadLineFit1154->SetParError(0,0.05301154);
   quadLineFit1154->SetParLimits(0,0,0);
   quadLineFit1154->SetParameter(1,-0.1786609);
   quadLineFit1154->SetParError(1,0.003296099);
   quadLineFit1154->SetParLimits(1,0,0);
   quadLineFit1154->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1154);
   gre->Draw("p ");
   
   TF1 *quadLineFit1155 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1155->SetChisquare(10.64025);
   ...
   quadLineFit1155->SetParameter(0,5.755337);
   quadLineFit1155->SetParError(0,0.05301154);
   quadLineFit1155->SetParLimits(0,0,0);
   quadLineFit1155->SetParameter(1,-0.1786609);
   quadLineFit1155->SetParError(1,0.003296099);
   ...
   TH1F *Graph_50dO000000sPppm1155 = new TH1F("Graph_50dO000000sPppm1155","Graph",100,13.6,18.4);
   Graph_50dO000000sPppm1155->SetMinimum(3.76916);
   Graph_50dO000000sPppm1155->SetMaximum(5.10914);
   ...
   TF1 *quadLineFit1156 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1156->SetChisquare(46.10916);
   ...
   quadLineFit1156->SetParameter(0,8.805324);
   quadLineFit1156->SetParError(0,0.05301275);
   quadLineFit1156->SetParLimits(0,0,0);
   quadLineFit1156->SetParameter(1,-0.2745012);
   quadLineFit1156->SetParError(1,0.003296175);
   quadLineFit1156->SetParLimits(1,0,0);
   quadLineFit1156->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1156);
   gre->Draw("p ");
   
   TF1 *quadLineFit1157 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1157->SetChisquare(46.10916);
   ...
   quadLineFit1157->SetParameter(0,8.805324);
   quadLineFit1157->SetParError(0,0.05301275);
   quadLineFit1157->SetParLimits(0,0,0);
   quadLineFit1157->SetParameter(1,-0.2745012);
   quadLineFit1157->SetParError(1,0.003296175);
