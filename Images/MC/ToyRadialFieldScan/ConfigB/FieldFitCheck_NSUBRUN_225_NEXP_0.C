...
//=========  (Tue Oct 20 14:20:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.08493,75,84.35629);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-53.74081);
   Graph_Graph01143->SetMaximum(69.01216);
   ...
   checkFit1144->SetChisquare(12.0741);
   ...
   checkFit1144->SetParameter(0,8.373679);
   checkFit1144->SetParError(0,0.2966656);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,1.009952);
   checkFit1144->SetParError(1,0.00868548);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.00869");
   pt_LaTex = pt->AddText(" 8.37#pm0.297");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.291163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.291163,-53.74081,-8.291163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetChisquare(12.0741);
   ...
   checkFit1145->SetParameter(0,8.373679);
   checkFit1145->SetParError(0,0.2966656);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,1.009952);
   checkFit1145->SetParError(1,0.00868548);
