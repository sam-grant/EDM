...
//=========  (Tue Oct 20 14:20:43 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1081 = new TH1F("Graph_mI50dO000000sPppm1081","",100,13.6,18.4);
   ...
   TF1 *quadLineFit1082 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1082->SetFillColor(19);
   quadLineFit1082->SetFillStyle(0);
   quadLineFit1082->SetLineWidth(2);
   quadLineFit1082->SetChisquare(16.08984);
   ...
   quadLineFit1082->SetParameter(0,-6.537787);
   quadLineFit1082->SetParError(0,0.0685067);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.2093464);
   quadLineFit1082->SetParError(1,0.004259541);
   quadLineFit1082->SetParLimits(1,0,0);
   quadLineFit1082->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1082);
   gre->Draw("ap");
   
   TF1 *quadLineFit1083 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   quadLineFit1083->SetFillColor(19);
   quadLineFit1083->SetFillStyle(0);
   quadLineFit1083->SetLineWidth(2);
   quadLineFit1083->SetChisquare(16.08984);
   ...
   quadLineFit1083->SetParameter(0,-6.537787);
   quadLineFit1083->SetParError(0,0.0685067);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.2093464);
   quadLineFit1083->SetParError(1,0.004259541);
   ...
   TH1F *Graph_mI30dO000000sPppm1083 = new TH1F("Graph_mI30dO000000sPppm1083","Graph",100,13.6,18.4);
   Graph_mI30dO000000sPppm1083->SetMinimum(-1.934259);
   Graph_mI30dO000000sPppm1083->SetMaximum(-1.437329);
   ...
   TF1 *quadLineFit1084 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1084->SetChisquare(10.84821);
   ...
   quadLineFit1084->SetParameter(0,-3.229646);
   quadLineFit1084->SetParError(0,0.06850683);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.0975032);
   quadLineFit1084->SetParError(1,0.004259549);
   quadLineFit1084->SetParLimits(1,0,0);
   quadLineFit1084->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1084);
   gre->Draw("p ");
   
   TF1 *quadLineFit1085 = new TF1("quadLineFit","[0]+[1]*x",13.6,18.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1085->SetChisquare(10.84821);
   ...
   quadLineFit1085->SetParameter(0,-3.229646);
   quadLineFit1085->SetParError(0,0.06850683);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.0975032);
   quadLineFit1085->SetParError(1,0.004259549);
   ...
   TH1F *Graph_mI10dO000000sPppm1085 = new TH1F("Graph_mI10dO000000sPppm1085","Graph",100,13.6,18.4);
   Graph_mI10dO000000sPppm1085->SetMinimum(-0.1889228);
   Graph_mI10dO000000sPppm1085->SetMaximum(-0.1207019);
   ...
   quadLineFit1086->SetChisquare(0.3124232);
   ...
   quadLineFit1086->SetParameter(0,-0.2830839);
   quadLineFit1086->SetParError(0,0.06850636);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.008188795);
   quadLineFit1086->SetParError(1,0.00425952);
   ...
   quadLineFit1087->SetChisquare(0.3124232);
   ...
   quadLineFit1087->SetParameter(0,-0.2830839);
   quadLineFit1087->SetParError(0,0.06850636);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.008188795);
   quadLineFit1087->SetParError(1,0.00425952);
   ...
   TH1F *Graph_10dO000000sPppm1087 = new TH1F("Graph_10dO000000sPppm1087","Graph",100,13.6,18.4);
   Graph_10dO000000sPppm1087->SetMinimum(1.14905);
   Graph_10dO000000sPppm1087->SetMaximum(1.590972);
   ...
   quadLineFit1088->SetChisquare(1.600877);
   ...
   quadLineFit1088->SetParameter(0,2.740476);
   quadLineFit1088->SetParError(0,0.06850679);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.086043);
   quadLineFit1088->SetParError(1,0.004259546);
   ...
   quadLineFit1089->SetChisquare(1.600877);
   ...
   quadLineFit1089->SetParameter(0,2.740476);
   quadLineFit1089->SetParError(0,0.06850679);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.086043);
   quadLineFit1089->SetParError(1,0.004259546);
   ...
   TH1F *Graph_30dO000000sPppm1089 = new TH1F("Graph_30dO000000sPppm1089","Graph",100,13.6,18.4);
   Graph_30dO000000sPppm1089->SetMinimum(2.473394);
   Graph_30dO000000sPppm1089->SetMaximum(3.371503);
   ...
   quadLineFit1090->SetChisquare(18.41591);
   ...
   quadLineFit1090->SetParameter(0,5.798657);
   quadLineFit1090->SetParError(0,0.06850668);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.1810822);
   quadLineFit1090->SetParError(1,0.00425954);
   ...
   quadLineFit1091->SetChisquare(18.41591);
   ...
   quadLineFit1091->SetParameter(0,5.798657);
   quadLineFit1091->SetParError(0,0.06850668);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.1810822);
   quadLineFit1091->SetParError(1,0.00425954);
   ...
   TH1F *Graph_50dO000000sPppm1091 = new TH1F("Graph_50dO000000sPppm1091","Graph",100,13.6,18.4);
   Graph_50dO000000sPppm1091->SetMinimum(3.760221);
   Graph_50dO000000sPppm1091->SetMaximum(5.119486);
   ...
   quadLineFit1092->SetChisquare(48.88309);
   ...
   quadLineFit1092->SetParameter(0,8.839965);
   quadLineFit1092->SetParError(0,0.06850669);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.2771562);
   quadLineFit1092->SetParError(1,0.00425954);
   ...
   quadLineFit1093->SetChisquare(48.88309);
   ...
   quadLineFit1093->SetParameter(0,8.839965);
   quadLineFit1093->SetParError(0,0.06850669);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.2771562);
   quadLineFit1093->SetParError(1,0.00425954);
