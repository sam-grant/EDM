...
//=========  (Tue Oct 20 14:20:37 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.26412,75,89.42035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-51.59567);
   Graph_Graph01015->SetMaximum(73.7519);
   ...
   checkFit1016->SetParameter(0,8.412139);
   checkFit1016->SetParError(0,0.8820848);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,1.003587);
   checkFit1016->SetParError(1,0.0258248);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0258");
   pt_LaTex = pt->AddText(" 8.41#pm0.882");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.382075,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.382075,-51.59567,-8.382075,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetParameter(0,8.412139);
   checkFit1017->SetParError(0,0.8820848);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,1.003587);
   checkFit1017->SetParError(1,0.0258248);
