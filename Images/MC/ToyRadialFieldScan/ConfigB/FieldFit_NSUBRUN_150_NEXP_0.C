...
//=========  (Tue Oct 20 14:20:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.4051712,75,0.3373614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.330918);
   Graph_Graph01093->SetMaximum(0.2631081);
   ...
   mainFit1094->SetChisquare(7.201107);
   ...
   mainFit1094->SetParameter(0,-0.03820719);
   mainFit1094->SetParError(0,0.00173895);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004803573);
   mainFit1094->SetParError(1,5.091126e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0048#pm5.09e-05");
   pt_LaTex = pt->AddText("#minus0.0382#pm0.00174");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.95391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.95391,-0.330918,-7.95391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(7.201107);
   ...
   mainFit1095->SetParameter(0,-0.03820719);
   mainFit1095->SetParError(0,0.00173895);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004803573);
   mainFit1095->SetParError(1,5.091126e-05);
