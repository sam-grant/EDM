...
//=========  (Tue Oct 20 14:20:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.27824,75,83.36494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01159 = new TH1F("Graph_Graph01159","Sub-runs 250",100,-60,60);
   Graph_Graph01159->SetMinimum(-53.11392);
   Graph_Graph01159->SetMaximum(68.20062);
   ...
   Graph_Graph01159->GetXaxis()->SetTitle("Applied B_{r} [ppm]");
   ...
   checkFit1160->SetChisquare(2.91278);
   ...
   checkFit1160->SetParameter(0,7.659785);
   checkFit1160->SetParError(0,0.2813883);
   checkFit1160->SetParLimits(0,0,0);
   checkFit1160->SetParameter(1,0.9919464);
   checkFit1160->SetParError(1,0.008238208);
   ...
   pt_LaTex = pt->AddText("0.992#pm0.00824");
   pt_LaTex = pt->AddText(" 7.66#pm0.281");
   pt_LaTex = pt->AddText("#minus7.72#pm0.291");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.721974,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.721974,-53.11392,-7.721974,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1161->SetChisquare(2.91278);
   ...
   checkFit1161->SetParameter(0,7.659785);
   checkFit1161->SetParError(0,0.2813883);
   checkFit1161->SetParLimits(0,0,0);
   checkFit1161->SetParameter(1,0.9919464);
   checkFit1161->SetParError(1,0.008238208);
