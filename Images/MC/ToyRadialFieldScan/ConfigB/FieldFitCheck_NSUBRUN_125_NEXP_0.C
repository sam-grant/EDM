...
//=========  (Tue Oct 20 14:20:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.1987,75,85.90501);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-53.68833);
   Graph_Graph01079->SetMaximum(70.39464);
   ...
   checkFit1080->SetParameter(0,8.054723);
   checkFit1080->SetParError(0,0.3985194);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,1.014905);
   checkFit1080->SetParError(1,0.01166745);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0117");
   pt_LaTex = pt->AddText(" 8.05#pm0.399");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.936431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.936431,-53.68833,-7.936431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetParameter(0,8.054723);
   checkFit1081->SetParError(0,0.3985194);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,1.014905);
   checkFit1081->SetParError(1,0.01166745);
