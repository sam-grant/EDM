...
//=========  (Tue Oct 20 14:20:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.4053301,75,0.3291848);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-0.3318786);
   Graph_Graph01125->SetMaximum(0.2557333);
   ...
   mainFit1126->SetChisquare(4.90484);
   ...
   mainFit1126->SetParameter(0,-0.03773442);
   mainFit1126->SetParError(0,0.001505081);
   mainFit1126->SetParLimits(0,0,0);
   mainFit1126->SetParameter(1,-0.004776833);
   mainFit1126->SetParError(1,4.406425e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00478#pm4.41e-05");
   pt_LaTex = pt->AddText("#minus0.0377#pm0.00151");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.899465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.899465,-0.3318786,-7.899465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1127->SetChisquare(4.90484);
   ...
   mainFit1127->SetParameter(0,-0.03773442);
   mainFit1127->SetParError(0,0.001505081);
   mainFit1127->SetParLimits(0,0,0);
   mainFit1127->SetParameter(1,-0.004776833);
   mainFit1127->SetParError(1,4.406425e-05);
