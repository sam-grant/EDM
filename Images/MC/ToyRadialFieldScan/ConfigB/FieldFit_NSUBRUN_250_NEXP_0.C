...
//=========  (Tue Oct 20 14:20:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3986595,75,0.3265133);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01157->SetMinimum(-0.3261422);
   Graph_Graph01157->SetMaximum(0.253996);
   ...
   mainFit1158->SetChisquare(2.912769);
   ...
   mainFit1158->SetParameter(0,-0.03662984);
   mainFit1158->SetParError(0,0.001345632);
   mainFit1158->SetParLimits(0,0,0);
   mainFit1158->SetParameter(1,-0.004743585);
   mainFit1158->SetParError(1,3.939622e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00474#pm3.94e-05");
   pt_LaTex = pt->AddText("#minus0.0366#pm0.00135");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.721972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.721972,-0.3261422,-7.721972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1159->SetChisquare(2.912769);
   ...
   mainFit1159->SetParameter(0,-0.03662984);
   mainFit1159->SetParError(0,0.001345632);
   mainFit1159->SetParLimits(0,0,0);
   mainFit1159->SetParameter(1,-0.004743585);
   mainFit1159->SetParError(1,3.939622e-05);
