...
//=========  (Tue Oct 20 14:20:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.06218,75,85.1661);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-50.93935);
   Graph_Graph01111->SetMaximum(70.04327);
   ...
   checkFit1112->SetParameter(0,8.292981);
   checkFit1112->SetParError(0,0.3365932);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,0.9899387);
   checkFit1112->SetParError(1,0.00985444);
   ...
   pt_LaTex = pt->AddText(" 0.99#pm0.00985");
   pt_LaTex = pt->AddText(" 8.29#pm0.337");
   pt_LaTex = pt->AddText("#minus8.38#pm 0.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.377266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.377266,-50.93935,-8.377266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetParameter(0,8.292981);
   checkFit1113->SetParError(0,0.3365932);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,0.9899387);
   checkFit1113->SetParError(1,0.00985444);
