...
//=========  (Tue Oct 20 14:20:38 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.400124,75,0.3290054);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.327211);
   Graph_Graph01029->SetMaximum(0.2560925);
   ...
   mainFit1030->SetChisquare(7.079156);
   ...
   mainFit1030->SetParameter(0,-0.03356231);
   mainFit1030->SetParError(0,0.002993626);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,-0.004758853);
   mainFit1030->SetParError(1,8.764508e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00476#pm8.76e-05");
   pt_LaTex = pt->AddText("#minus0.0336#pm0.00299");
   pt_LaTex = pt->AddText("#minus7.05#pm0.642");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.052606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.052606,-0.327211,-7.052606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.079156);
   ...
   mainFit1031->SetParameter(0,-0.03356231);
   mainFit1031->SetParError(0,0.002993626);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,-0.004758853);
   mainFit1031->SetParError(1,8.764508e-05);
