...
//=========  (Wed Jan  5 17:35:43 2022) by ROOT version 6.24/06
   ...
   TH1D *__30 = new TH1D("__30","Number of sub-runs: 660",240,-11,11);
   __30->SetBinContent(120,1000);
   __30->SetEntries(1000);
   __30->SetStats(0);
   __30->GetXaxis()->SetTitle("#LTB_{r}^{b}#GT truth residual [ppm]");
   __30->GetXaxis()->SetRange(120,120);
   ...
   __30->GetYaxis()->SetTitle("Trials / 0.091667 ppm");
