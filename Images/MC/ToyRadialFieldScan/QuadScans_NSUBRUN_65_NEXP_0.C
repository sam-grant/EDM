void QuadScans_NSUBRUN_65_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:10:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.094671,0.0768254,3.891213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_30dO000000sPppm1001 = new TH1F("Graph_30dO000000sPppm1001","",100,0.05396825,0.07301587);
   Graph_30dO000000sPppm1001->SetMinimum(-2.396083);
   Graph_30dO000000sPppm1001->SetMaximum(3.192625);
   Graph_30dO000000sPppm1001->SetDirectory(0);
   Graph_30dO000000sPppm1001->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   Graph_30dO000000sPppm1001->SetLineColor(ci);
   Graph_30dO000000sPppm1001->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   Graph_30dO000000sPppm1001->GetXaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1001->GetXaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1001->GetXaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1001->GetXaxis()->SetTitleOffset(1.1);
   Graph_30dO000000sPppm1001->GetXaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1001->GetYaxis()->SetTitle("#LTy#GT [mm]");
   Graph_30dO000000sPppm1001->GetYaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1001->GetYaxis()->SetNdivisions(4000510);
   Graph_30dO000000sPppm1001->GetYaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1001->GetYaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1001->GetYaxis()->SetTitleOffset(1.1);
   Graph_30dO000000sPppm1001->GetYaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1001->GetZaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1001->GetZaxis()->SetTitleOffset(1);
   Graph_30dO000000sPppm1001->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_30.000000 ppm1001);
   ...
   quadLineFit1002->SetChisquare(3.022955e-23);
   ...
   quadLineFit1002->SetParameter(0,-0.0004543681);
   quadLineFit1002->SetParError(0,0.1046481);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.98198);
   quadLineFit1002->SetParError(1,1.635479);
   ...
   quadLineFit1003->SetChisquare(3.022955e-23);
   ...
   quadLineFit1003->SetParameter(0,-0.0004543681);
   quadLineFit1003->SetParError(0,0.1046481);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.98198);
   quadLineFit1003->SetParError(1,1.635479);
   quadLineFit1003->SetParLimits(1,0,0);
   quadLineFit1003->Draw("same");
   
   Double_t -30.000000 ppm_fx1003[2] = {
   0.07142857,
   0.05555556};
   Double_t -30.000000 ppm_fy1003[2] = {
   -1.916866,
   -1.492703};
   Double_t -30.000000 ppm_fex1003[2] = {
   0,
   0};
   Double_t -30.000000 ppm_fey1003[2] = {
   0.01835648,
   0.01835648};
   gre = new TGraphErrors(2,-30.000000 ppm_fx1003,-30.000000 ppm_fy1003,-30.000000 ppm_fex1003,-30.000000 ppm_fey1003);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_mI30dO000000sPppm1003 = new TH1F("Graph_mI30dO000000sPppm1003","Graph",100,0.05396825,0.07301587);
   Graph_mI30dO000000sPppm1003->SetMinimum(-1.98131);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.428258);
   ...
   quadLineFit1004->SetChisquare(2.036702e-20);
   ...
   quadLineFit1004->SetParameter(0,-0.008129801);
   quadLineFit1004->SetParError(0,0.1046481);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-26.72231);
   quadLineFit1004->SetParError(1,1.635479);
   ...
   quadLineFit1005->SetChisquare(2.036702e-20);
   ...
   quadLineFit1005->SetParameter(0,-0.008129801);
   quadLineFit1005->SetParError(0,0.1046481);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-26.72231);
   quadLineFit1005->SetParError(1,1.635479);
