void QuadScans_NSUBRUN_20_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.00093,0.0768254,3.828788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1009->SetMinimum(-2.317958);
   Graph_30dO000000sPppm1009->SetMaximum(3.145816);
   ...
   quadLineFit1010->SetChisquare(1.095384e-18);
   ...
   quadLineFit1010->SetParameter(0,-0.2062808);
   quadLineFit1010->SetParError(0,0.1906752);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,49.0128);
   quadLineFit1010->SetParError(1,2.979944);
   ...
   quadLineFit1011->SetChisquare(1.095384e-18);
   ...
   quadLineFit1011->SetParameter(0,-0.2062808);
   quadLineFit1011->SetParError(0,0.1906752);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,49.0128);
   quadLineFit1011->SetParError(1,2.979944);
   ...
   Graph_mI30dO000000sPppm1011->SetMinimum(-1.939225);
   Graph_mI30dO000000sPppm1011->SetMaximum(-1.322283);
   ...
   quadLineFit1012->SetChisquare(1.088141e-19);
   ...
   quadLineFit1012->SetParameter(0,0.1581462);
   quadLineFit1012->SetParError(0,0.1906752);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-28.17518);
   quadLineFit1012->SetParError(1,2.979944);
   ...
   quadLineFit1013->SetChisquare(1.088141e-19);
   ...
   quadLineFit1013->SetParameter(0,0.1581462);
   quadLineFit1013->SetParError(0,0.1906752);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-28.17518);
   quadLineFit1013->SetParError(1,2.979944);
