...
//=========  (Tue Oct 20 14:19:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2362367,45,0.1644169);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01117->SetMinimum(-0.1961714);
   Graph_Graph01117->SetMaximum(0.1243516);
   ...
   mainFit1118->SetChisquare(5.46485);
   ...
   mainFit1118->SetParameter(0,-0.03420326);
   mainFit1118->SetParError(0,0.001042326);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.004356296);
   mainFit1118->SetParError(1,4.661452e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.73");
   pt_LaTex = pt->AddText("#minus0.00436#pm4.66e-05");
   pt_LaTex = pt->AddText("#minus0.0342#pm0.00104");
   pt_LaTex = pt->AddText("#minus7.85#pm0.254");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.851454,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.851454,-0.1961714,-7.851454,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetChisquare(5.46485);
   ...
   mainFit1119->SetParameter(0,-0.03420326);
   mainFit1119->SetParError(0,0.001042326);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.004356296);
   mainFit1119->SetParError(1,4.661452e-05);
