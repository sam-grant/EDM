...
//=========  (Tue Oct 20 14:19:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.04287,45,54.49859);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-27.88873);
   Graph_Graph01047->SetMaximum(45.34444);
   ...
   checkFit1048->SetChisquare(2.564792);
   ...
   checkFit1048->SetParameter(0,8.317944);
   checkFit1048->SetParError(0,0.4045401);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,0.9976369);
   checkFit1048->SetParError(1,0.01809158);
   ...
   pt_LaTex = pt->AddText("0.998#pm0.0181");
   pt_LaTex = pt->AddText(" 8.32#pm0.405");
   pt_LaTex = pt->AddText("#minus8.34#pm0.433");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.337646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.337646,-27.88873,-8.337646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(2.564792);
   ...
   checkFit1049->SetParameter(0,8.317944);
   checkFit1049->SetParError(0,0.4045401);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,0.9976369);
   checkFit1049->SetParError(1,0.01809158);
