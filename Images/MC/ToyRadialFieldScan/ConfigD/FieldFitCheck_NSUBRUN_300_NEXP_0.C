...
//=========  (Tue Oct 20 14:19:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.37816,45,53.55816);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-28.28453);
   Graph_Graph01143->SetMaximum(44.46453);
   ...
   checkFit1144->SetChisquare(0.5600073);
   ...
   checkFit1144->SetParameter(0,8.056434);
   checkFit1144->SetParError(0,0.2329879);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,0.9974215);
   checkFit1144->SetParError(1,0.01041954);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.28");
   pt_LaTex = pt->AddText("0.997#pm0.0104");
   pt_LaTex = pt->AddText(" 8.06#pm0.233");
   pt_LaTex = pt->AddText("#minus8.08#pm0.248");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.077262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.077262,-28.28453,-8.077262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetChisquare(0.5600073);
   ...
   checkFit1145->SetParameter(0,8.056434);
   checkFit1145->SetParError(0,0.2329879);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,0.9974215);
   checkFit1145->SetParError(1,0.01041954);
