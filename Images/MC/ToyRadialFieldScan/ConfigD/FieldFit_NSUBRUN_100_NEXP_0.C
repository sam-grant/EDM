...
//=========  (Tue Oct 20 14:19:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2341217,45,0.1594292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.1947666);
   Graph_Graph01045->SetMaximum(0.1200741);
   ...
   mainFit1046->SetChisquare(1.58062);
   ...
   mainFit1046->SetParameter(0,-0.03555797);
   mainFit1046->SetParError(0,0.001651757);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.004278407);
   mainFit1046->SetParError(1,7.386897e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.79");
   pt_LaTex = pt->AddText("#minus0.00428#pm7.39e-05");
   pt_LaTex = pt->AddText("#minus0.0356#pm0.00165");
   pt_LaTex = pt->AddText("#minus8.31#pm0.412");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.31103,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.31103,-0.1947666,-8.31103,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(1.58062);
   ...
   mainFit1047->SetParameter(0,-0.03555797);
   mainFit1047->SetParError(0,0.001651757);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.004278407);
   mainFit1047->SetParError(1,7.386897e-05);
