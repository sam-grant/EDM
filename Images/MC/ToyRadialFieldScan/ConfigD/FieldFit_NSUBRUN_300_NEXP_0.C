...
//=========  (Tue Oct 20 14:19:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2296618,45,0.1606644);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-0.1906292);
   Graph_Graph01141->SetMaximum(0.1216318);
   ...
   mainFit1142->SetChisquare(0.1641);
   ...
   mainFit1142->SetParameter(0,-0.03482526);
   mainFit1142->SetParError(0,0.0009512815);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,-0.004276589);
   mainFit1142->SetParError(1,4.254249e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0821");
   pt_LaTex = pt->AddText("#minus0.00428#pm4.25e-05");
   pt_LaTex = pt->AddText("#minus0.0348#pm0.000951");
   pt_LaTex = pt->AddText("#minus8.14#pm0.237");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.143233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.143233,-0.1906292,-8.143233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(0.1641);
   ...
   mainFit1143->SetParameter(0,-0.03482526);
   mainFit1143->SetParError(0,0.0009512815);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,-0.004276589);
   mainFit1143->SetParError(1,4.254249e-05);
