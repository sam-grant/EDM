...
//=========  (Tue Oct 20 14:19:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2313595,45,0.1619897);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.1920246);
   Graph_Graph01093->SetMaximum(0.1226548);
   ...
   mainFit1094->SetChisquare(0.803716);
   ...
   mainFit1094->SetParameter(0,-0.03531622);
   mainFit1094->SetParError(0,0.001165835);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004280407);
   mainFit1094->SetParError(1,5.213783e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.402");
   pt_LaTex = pt->AddText("#minus0.00428#pm5.21e-05");
   pt_LaTex = pt->AddText("#minus0.0353#pm0.00117");
   pt_LaTex = pt->AddText("#minus8.25#pm 0.29");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.250668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.250668,-0.1920246,-8.250668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(0.803716);
   ...
   mainFit1095->SetParameter(0,-0.03531622);
   mainFit1095->SetParError(0,0.001165835);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004280407);
   mainFit1095->SetParError(1,5.213783e-05);
