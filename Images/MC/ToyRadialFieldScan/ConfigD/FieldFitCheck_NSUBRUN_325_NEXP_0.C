...
//=========  (Tue Oct 20 14:19:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.56068,45,53.08244);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-28.49637);
   Graph_Graph01155->SetMaximum(44.01813);
   ...
   checkFit1156->SetChisquare(1.003003);
   ...
   checkFit1156->SetParameter(0,7.983266);
   checkFit1156->SetParError(0,0.2238491);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,0.9926451);
   checkFit1156->SetParError(1,0.01001084);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.502");
   pt_LaTex = pt->AddText("0.993#pm 0.01");
   pt_LaTex = pt->AddText(" 7.98#pm0.224");
   pt_LaTex = pt->AddText("#minus8.04#pm 0.24");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.042417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.042417,-28.49637,-8.042417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetChisquare(1.003003);
   ...
   checkFit1157->SetParameter(0,7.983266);
   checkFit1157->SetParError(0,0.2238491);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,0.9926451);
   checkFit1157->SetParError(1,0.01001084);
