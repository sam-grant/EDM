...
//=========  (Tue Oct 20 14:19:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2306561,45,0.1722773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-0.1903627);
   Graph_Graph01033->SetMaximum(0.1319839);
   ...
   mainFit1034->SetChisquare(1.736829);
   ...
   mainFit1034->SetParameter(0,-0.03168801);
   mainFit1034->SetParError(0,0.001896317);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,-0.004349848);
   mainFit1034->SetParError(1,8.480536e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00435#pm8.48e-05");
   pt_LaTex = pt->AddText("#minus0.0317#pm0.0019");
   pt_LaTex = pt->AddText("#minus7.28#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.284855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.284855,-0.1903627,-7.284855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.736829);
   ...
   mainFit1035->SetParameter(0,-0.03168801);
   mainFit1035->SetParError(0,0.001896317);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,-0.004349848);
   mainFit1035->SetParError(1,8.480536e-05);
