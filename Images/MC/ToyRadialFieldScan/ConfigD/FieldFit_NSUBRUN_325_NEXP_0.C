...
//=========  (Tue Oct 20 14:19:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2279216,45,0.1608431);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01153->SetMinimum(-0.1890451);
   Graph_Graph01153->SetMaximum(0.1219666);
   ...
   mainFit1154->SetChisquare(1.93029);
   ...
   mainFit1154->SetParameter(0,-0.03454193);
   mainFit1154->SetParError(0,0.0009139742);
   mainFit1154->SetParLimits(0,0,0);
   mainFit1154->SetParameter(1,-0.004270291);
   mainFit1154->SetParError(1,4.087422e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.965");
   pt_LaTex = pt->AddText("#minus0.00427#pm4.09e-05");
   pt_LaTex = pt->AddText("#minus0.0345#pm0.000914");
   pt_LaTex = pt->AddText("#minus8.09#pm0.228");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.088893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.088893,-0.1890451,-8.088893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1155->SetChisquare(1.93029);
   ...
   mainFit1155->SetParameter(0,-0.03454193);
   mainFit1155->SetParError(0,0.0009139742);
   mainFit1155->SetParLimits(0,0,0);
   mainFit1155->SetParameter(1,-0.004270291);
   mainFit1155->SetParError(1,4.087422e-05);
