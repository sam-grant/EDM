...
//=========  (Tue Oct 20 14:19:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.9615,45,53.90838);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-28.77451);
   Graph_Graph01107->SetMaximum(44.72139);
   ...
   checkFit1108->SetChisquare(2.623208);
   ...
   checkFit1108->SetParameter(0,8.396785);
   checkFit1108->SetParError(0,0.2691406);
   checkFit1108->SetParLimits(0,0,0);
   checkFit1108->SetParameter(1,1.001285);
   checkFit1108->SetParError(1,0.01203633);
   ...
   pt_LaTex = pt->AddText("    1#pm0.012");
   pt_LaTex = pt->AddText("  8.4#pm0.269");
   pt_LaTex = pt->AddText("#minus8.39#pm0.287");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.386009,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.386009,-28.77451,-8.386009,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1109->SetChisquare(2.623208);
   ...
   checkFit1109->SetParameter(0,8.396785);
   checkFit1109->SetParError(0,0.2691406);
   checkFit1109->SetParLimits(0,0,0);
   checkFit1109->SetParameter(1,1.001285);
   checkFit1109->SetParError(1,0.01203633);
