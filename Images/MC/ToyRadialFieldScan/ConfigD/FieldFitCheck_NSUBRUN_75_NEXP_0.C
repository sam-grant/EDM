...
//=========  (Tue Oct 20 14:19:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.49026,45,54.11426);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.0298);
   Graph_Graph01035->SetMaximum(44.65381);
   ...
   checkFit1036->SetChisquare(2.184157);
   ...
   checkFit1036->SetParameter(0,7.484058);
   checkFit1036->SetParError(0,0.464442);
   checkFit1036->SetParLimits(0,0,0);
   checkFit1036->SetParameter(1,1.018118);
   checkFit1036->SetParError(1,0.02077048);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0208");
   pt_LaTex = pt->AddText(" 7.48#pm0.464");
   pt_LaTex = pt->AddText("#minus7.35#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.350875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.350875,-31.0298,-7.350875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1037->SetChisquare(2.184157);
   ...
   checkFit1037->SetParameter(0,7.484058);
   checkFit1037->SetParError(0,0.464442);
   checkFit1037->SetParLimits(0,0,0);
   checkFit1037->SetParameter(1,1.018118);
   checkFit1037->SetParError(1,0.02077048);
