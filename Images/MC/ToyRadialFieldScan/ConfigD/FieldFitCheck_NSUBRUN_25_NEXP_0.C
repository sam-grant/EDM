...
//=========  (Tue Oct 20 14:19:16 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.70272,45,54.05609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-27.62684);
   Graph_Graph01011->SetMaximum(44.98021);
   ...
   checkFit1012->SetChisquare(0.04393093);
   ...
   checkFit1012->SetParameter(0,8.751131);
   checkFit1012->SetParError(0,0.8002436);
   checkFit1012->SetParLimits(0,0,0);
   checkFit1012->SetParameter(1,0.9528411);
   checkFit1012->SetParError(1,0.03578798);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.022");
   pt_LaTex = pt->AddText("0.953#pm0.0358");
   pt_LaTex = pt->AddText(" 8.75#pm  0.8");
   pt_LaTex = pt->AddText("#minus9.18#pm0.908");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-9.18425,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.18425,-27.62684,-9.18425,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1013->SetChisquare(0.04393093);
   ...
   checkFit1013->SetParameter(0,8.751131);
   checkFit1013->SetParError(0,0.8002436);
   checkFit1013->SetParLimits(0,0,0);
   checkFit1013->SetParameter(1,0.9528411);
   checkFit1013->SetParError(1,0.03578798);
