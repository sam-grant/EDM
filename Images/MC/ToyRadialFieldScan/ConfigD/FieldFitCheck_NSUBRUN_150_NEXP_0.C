...
//=========  (Tue Oct 20 14:19:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.41896,45,54.12068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-29.165);
   Graph_Graph01071->SetMaximum(44.86671);
   ...
   checkFit1072->SetChisquare(0.4862277);
   ...
   checkFit1072->SetParameter(0,8.000223);
   checkFit1072->SetParError(0,0.3298985);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,1.003617);
   checkFit1072->SetParError(1,0.01475351);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.243");
   pt_LaTex = pt->AddText("    1#pm0.0148");
   pt_LaTex = pt->AddText("    8#pm 0.33");
   pt_LaTex = pt->AddText("#minus7.97#pm0.349");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.971391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.971391,-29.165,-7.971391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetChisquare(0.4862277);
   ...
   checkFit1073->SetParameter(0,8.000223);
   checkFit1073->SetParError(0,0.3298985);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,1.003617);
   checkFit1073->SetParError(1,0.01475351);
