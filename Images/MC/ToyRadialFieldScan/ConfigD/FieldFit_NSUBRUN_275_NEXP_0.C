...
//=========  (Tue Oct 20 14:19:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2309732,45,0.1628178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-0.1915941);
   Graph_Graph01129->SetMaximum(0.1234387);
   ...
   mainFit1130->SetChisquare(0.2168211);
   ...
   mainFit1130->SetParameter(0,-0.03444343);
   mainFit1130->SetParError(0,0.0009937308);
   mainFit1130->SetParLimits(0,0,0);
   mainFit1130->SetParameter(1,-0.004313433);
   mainFit1130->SetParError(1,4.444107e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.108");
   pt_LaTex = pt->AddText("#minus0.00431#pm4.44e-05");
   pt_LaTex = pt->AddText("#minus0.0344#pm0.000994");
   pt_LaTex = pt->AddText("#minus7.99#pm0.245");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.985154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.985154,-0.1915941,-7.985154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1131->SetChisquare(0.2168211);
   ...
   mainFit1131->SetParameter(0,-0.03444343);
   mainFit1131->SetParError(0,0.0009937308);
   mainFit1131->SetParLimits(0,0,0);
   mainFit1131->SetParameter(1,-0.004313433);
   mainFit1131->SetParError(1,4.444107e-05);
