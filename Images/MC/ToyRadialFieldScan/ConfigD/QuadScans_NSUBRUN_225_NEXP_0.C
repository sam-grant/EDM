...
//=========  (Tue Oct 20 14:19:24 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1097[4] = {
   14,
   16,
   18,
   20};
   Double_t -30.000000 ppm_fy1097[4] = {
   -1.90534,
   -1.644277,
   -1.48317,
   -1.334346};
   Double_t -30.000000 ppm_fex1097[4] = {
   0,
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1097[4] = {
   0.009828933,
   0.009828933,
   0.009828933,
   0.009828933};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1097,-30.000000 ppm_fy1097,-30.000000 ppm_fex1097,-30.000000 ppm_fey1097);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1097 = new TH1F("Graph_mI30dO000000sPppm1097","",100,13.4,20.6);
   ...
   quadLineFit1098->SetChisquare(36.57823);
   ...
   quadLineFit1098->SetParameter(0,-3.18476);
   quadLineFit1098->SetParError(0,0.03768446);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.09370451);
   quadLineFit1098->SetParError(1,0.002197802);
   ...
   quadLineFit1099->SetChisquare(36.57823);
   ...
   quadLineFit1099->SetParameter(0,-3.18476);
   quadLineFit1099->SetParError(0,0.03768446);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.09370451);
   quadLineFit1099->SetParError(1,0.002197802);
   quadLineFit1099->SetParLimits(1,0,0);
   quadLineFit1099->Draw("same");
   
   Double_t -10.000000 ppm_fx1099[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1099[4] = {
   -0.1644133,
   -0.165903,
   -0.1278297,
   -0.1372129};
   Double_t -10.000000 ppm_fex1099[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1099[4] = {
   0.009828933,
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1099,-10.000000 ppm_fy1099,-10.000000 ppm_fex1099,-10.000000 ppm_fey1099);
   ...
   TH1F *Graph_mI10dO000000sPppm1099 = new TH1F("Graph_mI10dO000000sPppm1099","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1099->SetMinimum(-0.181505);
   Graph_mI10dO000000sPppm1099->SetMaximum(-0.1122276);
   ...
   quadLineFit1100->SetChisquare(4.080373);
   ...
   quadLineFit1100->SetParameter(0,-0.2505631);
   quadLineFit1100->SetParError(0,0.03768448);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.005983729);
   quadLineFit1100->SetParError(1,0.002197803);
   ...
   quadLineFit1101->SetChisquare(4.080373);
   ...
   quadLineFit1101->SetParameter(0,-0.2505631);
   quadLineFit1101->SetParError(0,0.03768448);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.005983729);
   quadLineFit1101->SetParError(1,0.002197803);
   ...
   TH1F *Graph_10dO000000sPppm1101 = new TH1F("Graph_10dO000000sPppm1101","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1101->SetMinimum(1.019506);
   Graph_10dO000000sPppm1101->SetMaximum(1.622372);
   ...
   quadLineFit1102->SetChisquare(21.76722);
   ...
   quadLineFit1102->SetParameter(0,2.648542);
   quadLineFit1102->SetParError(0,0.03768428);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-0.07937373);
   quadLineFit1102->SetParError(1,0.002197791);
   ...
   quadLineFit1103->SetChisquare(21.76722);
   ...
   quadLineFit1103->SetParameter(0,2.648542);
   quadLineFit1103->SetParError(0,0.03768428);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-0.07937373);
   quadLineFit1103->SetParError(1,0.002197791);
   quadLineFit1103->SetParLimits(1,0,0);
   quadLineFit1103->Draw("same");
   
   Double_t 30.000000 ppm_fx1103[4] = {
   14,
   16,
   18,
   20};
   Double_t 30.000000 ppm_fy1103[4] = {
   3.273791,
   2.866865,
   2.546672,
   2.290995};
   Double_t 30.000000 ppm_fex1103[4] = {
   0,
   0,
   0,
   0};
   Double_t 30.000000 ppm_fey1103[4] = {
   0.009828933,
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(4,30.000000 ppm_fx1103,30.000000 ppm_fy1103,30.000000 ppm_fex1103,30.000000 ppm_fey1103);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1103 = new TH1F("Graph_30dO000000sPppm1103","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1103->SetMinimum(2.180921);
   Graph_30dO000000sPppm1103->SetMaximum(3.383866);
   ...
   quadLineFit1104->SetChisquare(59.45441);
   ...
   quadLineFit1104->SetParameter(0,5.522875);
   quadLineFit1104->SetParError(0,0.03768477);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.1634291);
   quadLineFit1104->SetParError(1,0.002197821);
   ...
   quadLineFit1105->SetChisquare(59.45441);
   ...
   quadLineFit1105->SetParameter(0,5.522875);
   quadLineFit1105->SetParError(0,0.03768477);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.1634291);
   quadLineFit1105->SetParError(1,0.002197821);
