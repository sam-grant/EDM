...
//=========  (Tue Oct 20 14:19:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.85585,45,53.9973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-28.67053);
   Graph_Graph01095->SetMaximum(44.81199);
   ...
   checkFit1096->SetChisquare(1.345926);
   ...
   checkFit1096->SetParameter(0,8.237029);
   checkFit1096->SetParError(0,0.2855311);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9972844);
   checkFit1096->SetParError(1,0.01276934);
   ...
   pt_LaTex = pt->AddText("0.997#pm0.0128");
   pt_LaTex = pt->AddText(" 8.24#pm0.286");
   pt_LaTex = pt->AddText("#minus8.26#pm0.305");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.259458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.259458,-28.67053,-8.259458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(1.345926);
   ...
   checkFit1097->SetParameter(0,8.237029);
   checkFit1097->SetParError(0,0.2855311);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9972844);
   checkFit1097->SetParError(1,0.01276934);
