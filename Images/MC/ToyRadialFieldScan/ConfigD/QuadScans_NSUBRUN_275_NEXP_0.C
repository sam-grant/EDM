...
//=========  (Tue Oct 20 14:19:26 2020) by ROOT version 6.22/02
   ...
   0.008888156,
   0.008888156};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1121,-30.000000 ppm_fy1121,-30.000000 ppm_fex1121,-30.000000 ppm_fey1121);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1121 = new TH1F("Graph_mI30dO000000sPppm1121","",100,13.4,20.6);
   ...
   quadLineFit1122->SetChisquare(30.18903);
   ...
   quadLineFit1122->SetParameter(0,-3.200223);
   quadLineFit1122->SetParError(0,0.03407768);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,0.09519851);
   quadLineFit1122->SetParError(1,0.00198745);
   ...
   quadLineFit1123->SetChisquare(30.18903);
   ...
   quadLineFit1123->SetParameter(0,-3.200223);
   quadLineFit1123->SetParError(0,0.03407768);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,0.09519851);
   quadLineFit1123->SetParError(1,0.00198745);
   quadLineFit1123->SetParLimits(1,0,0);
   quadLineFit1123->Draw("same");
   
   Double_t -10.000000 ppm_fx1123[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1123[4] = {
   -0.1680553,
   -0.1506588,
   -0.1326556,
   -0.1160197};
   Double_t -10.000000 ppm_fex1123[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1123[4] = {
   0.008888156,
   0.008888156,
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1123,-10.000000 ppm_fy1123,-10.000000 ppm_fex1123,-10.000000 ppm_fey1123);
   ...
   TH1F *Graph_mI10dO000000sPppm1123 = new TH1F("Graph_mI10dO000000sPppm1123","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1123->SetMinimum(-0.1839246);
   Graph_mI10dO000000sPppm1123->SetMaximum(-0.1001503);
   ...
   quadLineFit1124->SetChisquare(0.004296846);
   ...
   quadLineFit1124->SetParameter(0,-0.2898408);
   quadLineFit1124->SetParError(0,0.03407761);
   quadLineFit1124->SetParLimits(0,0,0);
   quadLineFit1124->SetParameter(1,0.008705499);
   quadLineFit1124->SetParError(1,0.001987446);
   ...
   quadLineFit1125->SetChisquare(0.004296846);
   ...
   quadLineFit1125->SetParameter(0,-0.2898408);
   quadLineFit1125->SetParError(0,0.03407761);
   quadLineFit1125->SetParLimits(0,0,0);
   quadLineFit1125->SetParameter(1,0.008705499);
   quadLineFit1125->SetParError(1,0.001987446);
   quadLineFit1125->SetParLimits(1,0,0);
   quadLineFit1125->Draw("same");
   
   Double_t 10.000000 ppm_fx1125[4] = {
   14,
   16,
   18,
   20};
   Double_t 10.000000 ppm_fy1125[4] = {
   1.549355,
   1.365751,
   1.209372,
   1.079322};
   Double_t 10.000000 ppm_fex1125[4] = {
   0,
   0,
   0,
   0};
   Double_t 10.000000 ppm_fey1125[4] = {
   0.008888156,
   0.008888156,
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(4,10.000000 ppm_fx1125,10.000000 ppm_fy1125,10.000000 ppm_fex1125,10.000000 ppm_fey1125);
   gre->SetName("10.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10dO000000sPppm1125 = new TH1F("Graph_10dO000000sPppm1125","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1125->SetMinimum(1.021653);
   Graph_10dO000000sPppm1125->SetMaximum(1.607024);
   ...
   TF1 *quadLineFit1126 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1126->SetChisquare(9.076519);
   quadLineFit1126->SetNDF(2);
   ...
   quadLineFit1126->SetParameter(0,2.632455);
   quadLineFit1126->SetParError(0,0.03407801);
   quadLineFit1126->SetParLimits(0,0,0);
   quadLineFit1126->SetParameter(1,-0.07832381);
   quadLineFit1126->SetParError(1,0.00198747);
   quadLineFit1126->SetParLimits(1,0,0);
   quadLineFit1126->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1126);
   gre->Draw("p ");
   
   TF1 *quadLineFit1127 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1127->SetChisquare(9.076519);
   quadLineFit1127->SetNDF(2);
   ...
   quadLineFit1127->SetParameter(0,2.632455);
   quadLineFit1127->SetParError(0,0.03407801);
   quadLineFit1127->SetParLimits(0,0,0);
   quadLineFit1127->SetParameter(1,-0.07832381);
   quadLineFit1127->SetParError(1,0.00198747);
   quadLineFit1127->SetParLimits(1,0,0);
   quadLineFit1127->Draw("same");
   
   Double_t 30.000000 ppm_fx1127[4] = {
   14,
   16,
   18,
   20};
   Double_t 30.000000 ppm_fy1127[4] = {
   3.266226,
   2.842687,
   2.554916,
   2.273124};
   Double_t 30.000000 ppm_fex1127[4] = {
   0,
   0,
   0,
   0};
   Double_t 30.000000 ppm_fey1127[4] = {
   0.008888156,
   0.008888156,
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(4,30.000000 ppm_fx1127,30.000000 ppm_fy1127,30.000000 ppm_fex1127,30.000000 ppm_fey1127);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1127 = new TH1F("Graph_30dO000000sPppm1127","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1127->SetMinimum(2.163147);
   Graph_30dO000000sPppm1127->SetMaximum(3.376202);
   ...
   TF1 *quadLineFit1128 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1128->SetChisquare(74.24475);
   quadLineFit1128->SetNDF(2);
   ...
   quadLineFit1128->SetParameter(0,5.511255);
   quadLineFit1128->SetParError(0,0.0340782);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,-0.1633539);
   quadLineFit1128->SetParError(1,0.001987481);
   quadLineFit1128->SetParLimits(1,0,0);
   quadLineFit1128->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1128);
   gre->Draw("p ");
   
   TF1 *quadLineFit1129 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1129->SetChisquare(74.24475);
   quadLineFit1129->SetNDF(2);
   ...
   quadLineFit1129->SetParameter(0,5.511255);
   quadLineFit1129->SetParError(0,0.0340782);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,-0.1633539);
   quadLineFit1129->SetParError(1,0.001987481);
