...
//=========  (Tue Oct 20 14:19:21 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1061[4] = {
   14,
   16,
   18,
   20};
   Double_t -30.000000 ppm_fy1061[4] = {
   -1.903117,
   -1.665303,
   -1.477416,
   -1.32633};
   Double_t -30.000000 ppm_fex1061[4] = {
   0,
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1061[4] = {
   0.0120478,
   0.0120478,
   0.0120478,
   0.0120478};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1061,-30.000000 ppm_fy1061,-30.000000 ppm_fex1061,-30.000000 ppm_fey1061);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1061 = new TH1F("Graph_mI30dO000000sPppm1061","",100,13.4,20.6);
   ...
   TF1 *quadLineFit1062 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1062->SetFillColor(19);
   quadLineFit1062->SetFillStyle(0);
   quadLineFit1062->SetLineWidth(2);
   quadLineFit1062->SetChisquare(13.01475);
   quadLineFit1062->SetNDF(2);
   ...
   quadLineFit1062->SetParameter(0,-3.223552);
   quadLineFit1062->SetParError(0,0.04619225);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.0959124);
   quadLineFit1062->SetParError(1,0.002693987);
   quadLineFit1062->SetParLimits(1,0,0);
   quadLineFit1062->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1062);
   gre->Draw("ap");
   
   TF1 *quadLineFit1063 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1063->SetFillColor(19);
   quadLineFit1063->SetFillStyle(0);
   quadLineFit1063->SetLineWidth(2);
   quadLineFit1063->SetChisquare(13.01475);
   quadLineFit1063->SetNDF(2);
   ...
   quadLineFit1063->SetParameter(0,-3.223552);
   quadLineFit1063->SetParError(0,0.04619225);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.0959124);
   quadLineFit1063->SetParError(1,0.002693987);
   quadLineFit1063->SetParLimits(1,0,0);
   quadLineFit1063->Draw("same");
   
   Double_t -10.000000 ppm_fx1063[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1063[4] = {
   -0.1765672,
   -0.1559915,
   -0.1436005,
   -0.1339107};
   Double_t -10.000000 ppm_fex1063[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1063[4] = {
   0.0120478,
   0.0120478,
   0.0120478,
   0.0120478};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1063,-10.000000 ppm_fy1063,-10.000000 ppm_fex1063,-10.000000 ppm_fey1063);
   ...
   TH1F *Graph_mI10dO000000sPppm1063 = new TH1F("Graph_mI10dO000000sPppm1063","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1063->SetMinimum(-0.1952902);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.1151876);
   ...
   TF1 *quadLineFit1064 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1064->SetChisquare(0.2144614);
   quadLineFit1064->SetNDF(2);
   ...
   quadLineFit1064->SetParameter(0,-0.271824);
   quadLineFit1064->SetParError(0,0.04619211);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.00701803);
   quadLineFit1064->SetParError(1,0.002693979);
   quadLineFit1064->SetParLimits(1,0,0);
   quadLineFit1064->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1064);
   gre->Draw("p ");
   
   TF1 *quadLineFit1065 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1065->SetChisquare(0.2144614);
   quadLineFit1065->SetNDF(2);
   ...
   quadLineFit1065->SetParameter(0,-0.271824);
   quadLineFit1065->SetParError(0,0.04619211);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.00701803);
   quadLineFit1065->SetParError(1,0.002693979);
   quadLineFit1065->SetParLimits(1,0,0);
   quadLineFit1065->Draw("same");
   
   Double_t 10.000000 ppm_fx1065[4] = {
   14,
   16,
   18,
   20};
   Double_t 10.000000 ppm_fy1065[4] = {
   1.548265,
   1.362151,
   1.20829,
   1.084709};
   Double_t 10.000000 ppm_fex1065[4] = {
   0,
   0,
   0,
   0};
   Double_t 10.000000 ppm_fey1065[4] = {
   0.0120478,
   0.0120478,
   0.0120478,
   0.0120478};
   gre = new TGraphErrors(4,10.000000 ppm_fx1065,10.000000 ppm_fy1065,10.000000 ppm_fex1065,10.000000 ppm_fey1065);
   gre->SetName("10.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10dO000000sPppm1065 = new TH1F("Graph_10dO000000sPppm1065","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1065->SetMinimum(1.023896);
   Graph_10dO000000sPppm1065->SetMaximum(1.609078);
   ...
   TF1 *quadLineFit1066 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1066->SetChisquare(6.736479);
   ...
   quadLineFit1066->SetParameter(0,2.613702);
   quadLineFit1066->SetParError(0,0.04619115);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.07722639);
   quadLineFit1066->SetParError(1,0.002693921);
   quadLineFit1066->SetParLimits(1,0,0);
   quadLineFit1066->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1066);
   gre->Draw("p ");
   
   TF1 *quadLineFit1067 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1067->SetChisquare(6.736479);
   ...
   quadLineFit1067->SetParameter(0,2.613702);
   quadLineFit1067->SetParError(0,0.04619115);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.07722639);
   quadLineFit1067->SetParError(1,0.002693921);
   ...
   TH1F *Graph_30dO000000sPppm1067 = new TH1F("Graph_30dO000000sPppm1067","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1067->SetMinimum(2.170343);
   Graph_30dO000000sPppm1067->SetMaximum(3.377967);
   ...
   TF1 *quadLineFit1068 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1068->SetChisquare(34.86091);
   ...
   quadLineFit1068->SetParameter(0,5.519183);
   quadLineFit1068->SetParError(0,0.0461924);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.1635636);
   quadLineFit1068->SetParError(1,0.002693996);
   quadLineFit1068->SetParLimits(1,0,0);
   quadLineFit1068->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1068);
   gre->Draw("p ");
   
   TF1 *quadLineFit1069 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1069->SetChisquare(34.86091);
   ...
   quadLineFit1069->SetParameter(0,5.519183);
   quadLineFit1069->SetParError(0,0.0461924);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.1635636);
   quadLineFit1069->SetParError(1,0.002693996);
