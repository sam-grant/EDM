...
//=========  (Tue Oct 20 14:19:27 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1133[4] = {
   14,
   16,
   18,
   20};
   Double_t -30.000000 ppm_fy1133[4] = {
   -1.892572,
   -1.656068,
   -1.467366,
   -1.330757};
   Double_t -30.000000 ppm_fex1133[4] = {
   0,
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1133[4] = {
   0.008508651,
   0.008508651,
   0.008508651,
   0.008508651};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1133,-30.000000 ppm_fy1133,-30.000000 ppm_fex1133,-30.000000 ppm_fey1133);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1133 = new TH1F("Graph_mI30dO000000sPppm1133","",100,13.4,20.6);
   ...
   quadLineFit1134->SetChisquare(34.47194);
   ...
   quadLineFit1134->SetParameter(0,-3.179718);
   quadLineFit1134->SetParError(0,0.0326221);
   quadLineFit1134->SetParLimits(0,0,0);
   quadLineFit1134->SetParameter(1,0.09370746);
   quadLineFit1134->SetParError(1,0.001902559);
   ...
   quadLineFit1135->SetChisquare(34.47194);
   ...
   quadLineFit1135->SetParameter(0,-3.179718);
   quadLineFit1135->SetParError(0,0.0326221);
   quadLineFit1135->SetParLimits(0,0,0);
   quadLineFit1135->SetParameter(1,0.09370746);
   quadLineFit1135->SetParError(1,0.001902559);
   ...
   TH1F *Graph_mI10dO000000sPppm1135 = new TH1F("Graph_mI10dO000000sPppm1135","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1135->SetMinimum(-0.1894847);
   Graph_mI10dO000000sPppm1135->SetMaximum(-0.1014825);
   ...
   quadLineFit1136->SetChisquare(8.161572);
   ...
   quadLineFit1136->SetParameter(0,-0.2727503);
   quadLineFit1136->SetParError(0,0.03262271);
   quadLineFit1136->SetParLimits(0,0,0);
   quadLineFit1136->SetParameter(1,0.007888582);
   quadLineFit1136->SetParError(1,0.001902595);
   ...
   quadLineFit1137->SetChisquare(8.161572);
   ...
   quadLineFit1137->SetParameter(0,-0.2727503);
   quadLineFit1137->SetParError(0,0.03262271);
   quadLineFit1137->SetParLimits(0,0,0);
   quadLineFit1137->SetParameter(1,0.007888582);
   quadLineFit1137->SetParError(1,0.001902595);
   quadLineFit1137->SetParLimits(1,0,0);
   quadLineFit1137->Draw("same");
   
   Double_t 10.000000 ppm_fx1137[4] = {
   14,
   16,
   18,
   20};
   Double_t 10.000000 ppm_fy1137[4] = {
   1.558369,
   1.362325,
   1.210498,
   1.087697};
   Double_t 10.000000 ppm_fex1137[4] = {
   0,
   0,
   0,
   0};
   Double_t 10.000000 ppm_fey1137[4] = {
   0.008508651,
   0.008508651,
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(4,10.000000 ppm_fx1137,10.000000 ppm_fy1137,10.000000 ppm_fex1137,10.000000 ppm_fey1137);
   gre->SetName("10.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10dO000000sPppm1137 = new TH1F("Graph_10dO000000sPppm1137","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1137->SetMinimum(1.030419);
   Graph_10dO000000sPppm1137->SetMaximum(1.615647);
   ...
   quadLineFit1138->SetChisquare(18.68382);
   ...
   quadLineFit1138->SetParameter(0,2.63399);
   quadLineFit1138->SetParError(0,0.03262184);
   quadLineFit1138->SetParLimits(0,0,0);
   quadLineFit1138->SetParameter(1,-0.0781922);
   quadLineFit1138->SetParError(1,0.001902543);
   ...
   quadLineFit1139->SetChisquare(18.68382);
   ...
   quadLineFit1139->SetParameter(0,2.63399);
   quadLineFit1139->SetParError(0,0.03262184);
   quadLineFit1139->SetParLimits(0,0,0);
   quadLineFit1139->SetParameter(1,-0.0781922);
   quadLineFit1139->SetParError(1,0.001902543);
   quadLineFit1139->SetParLimits(1,0,0);
   quadLineFit1139->Draw("same");
   
   Double_t 30.000000 ppm_fx1139[4] = {
   14,
   16,
   18,
   20};
   Double_t 30.000000 ppm_fy1139[4] = {
   3.264675,
   2.864227,
   2.549042,
   2.285037};
   Double_t 30.000000 ppm_fex1139[4] = {
   0,
   0,
   0,
   0};
   Double_t 30.000000 ppm_fey1139[4] = {
   0.008508651,
   0.008508651,
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(4,30.000000 ppm_fx1139,30.000000 ppm_fy1139,30.000000 ppm_fex1139,30.000000 ppm_fey1139);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1139 = new TH1F("Graph_30dO000000sPppm1139","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1139->SetMinimum(2.176863);
   Graph_30dO000000sPppm1139->SetMaximum(3.372849);
   ...
   quadLineFit1140->SetChisquare(65.08841);
   ...
   quadLineFit1140->SetParameter(0,5.506728);
   quadLineFit1140->SetParError(0,0.03262203);
   quadLineFit1140->SetParLimits(0,0,0);
   quadLineFit1140->SetParameter(1,-0.1627049);
   quadLineFit1140->SetParError(1,0.001902555);
   ...
   quadLineFit1141->SetChisquare(65.08841);
   ...
   quadLineFit1141->SetParameter(0,5.506728);
   quadLineFit1141->SetParError(0,0.03262203);
   quadLineFit1141->SetParLimits(0,0,0);
   quadLineFit1141->SetParameter(1,-0.1627049);
   quadLineFit1141->SetParError(1,0.001902555);
