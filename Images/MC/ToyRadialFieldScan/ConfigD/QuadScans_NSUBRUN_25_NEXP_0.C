...
//=========  (Tue Oct 20 14:19:16 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1001[4] = {
   14,
   16,
   18,
   20};
   Double_t -30.000000 ppm_fy1001[4] = {
   -1.872987,
   -1.641039,
   -1.509751,
   -1.357146};
   Double_t -30.000000 ppm_fex1001[4] = {
   0,
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1001[4] = {
   0.02922466,
   0.02922466,
   0.02922466,
   0.02922466};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1001,-30.000000 ppm_fy1001,-30.000000 ppm_fex1001,-30.000000 ppm_fey1001);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1001 = new TH1F("Graph_mI30dO000000sPppm1001","",100,13.4,20.6);
   ...
   quadLineFit1002->SetChisquare(2.713723);
   ...
   quadLineFit1002->SetParameter(0,-3.022221);
   quadLineFit1002->SetParError(0,0.1120488);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.08394056);
   quadLineFit1002->SetParError(1,0.006534818);
   ...
   quadLineFit1003->SetChisquare(2.713723);
   ...
   quadLineFit1003->SetParameter(0,-3.022221);
   quadLineFit1003->SetParError(0,0.1120488);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.08394056);
   quadLineFit1003->SetParError(1,0.006534818);
   quadLineFit1003->SetParLimits(1,0,0);
   quadLineFit1003->Draw("same");
   
   Double_t -10.000000 ppm_fx1003[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1003[4] = {
   -0.1530756,
   -0.1736206,
   -0.1611886,
   -0.1401334};
   Double_t -10.000000 ppm_fex1003[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1003[4] = {
   0.02922466,
   0.02922466,
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1003,-10.000000 ppm_fy1003,-10.000000 ppm_fex1003,-10.000000 ppm_fey1003);
   ...
   TH1F *Graph_mI10dO000000sPppm1003 = new TH1F("Graph_mI10dO000000sPppm1003","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.2120389);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.1017151);
   ...
   quadLineFit1004->SetChisquare(0.5412848);
   ...
   quadLineFit1004->SetParameter(0,-0.2005743);
   quadLineFit1004->SetParError(0,0.112049);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.002562927);
   quadLineFit1004->SetParError(1,0.006534829);
   ...
   quadLineFit1005->SetChisquare(0.5412848);
   ...
   quadLineFit1005->SetParameter(0,-0.2005743);
   quadLineFit1005->SetParError(0,0.112049);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.002562927);
   quadLineFit1005->SetParError(1,0.006534829);
   ...
   TH1F *Graph_10dO000000sPppm1005 = new TH1F("Graph_10dO000000sPppm1005","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1005->SetMinimum(1.022649);
   Graph_10dO000000sPppm1005->SetMaximum(1.655293);
   ...
   quadLineFit1006->SetChisquare(1.013189);
   ...
   quadLineFit1006->SetParameter(0,2.630787);
   quadLineFit1006->SetParError(0,0.1120494);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.07661703);
   quadLineFit1006->SetParError(1,0.006534852);
   ...
   quadLineFit1007->SetChisquare(1.013189);
   ...
   quadLineFit1007->SetParameter(0,2.630787);
   quadLineFit1007->SetParError(0,0.1120494);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.07661703);
   quadLineFit1007->SetParError(1,0.006534852);
   quadLineFit1007->SetParLimits(1,0,0);
   quadLineFit1007->Draw("same");
   
   Double_t 30.000000 ppm_fx1007[4] = {
   14,
   16,
   18,
   20};
   Double_t 30.000000 ppm_fy1007[4] = {
   3.269854,
   2.871062,
   2.558555,
   2.305891};
   Double_t 30.000000 ppm_fex1007[4] = {
   0,
   0,
   0,
   0};
   Double_t 30.000000 ppm_fey1007[4] = {
   0.02922466,
   0.02922466,
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(4,30.000000 ppm_fx1007,30.000000 ppm_fy1007,30.000000 ppm_fex1007,30.000000 ppm_fey1007);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1007 = new TH1F("Graph_30dO000000sPppm1007","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1007->SetMinimum(2.174425);
   Graph_30dO000000sPppm1007->SetMaximum(3.40132);
   ...
   quadLineFit1008->SetChisquare(6.291278);
   ...
   quadLineFit1008->SetParameter(0,5.475076);
   quadLineFit1008->SetParError(0,0.112049);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1602197);
   quadLineFit1008->SetParError(1,0.006534832);
   ...
   quadLineFit1009->SetChisquare(6.291278);
   ...
   quadLineFit1009->SetParameter(0,5.475076);
   quadLineFit1009->SetParError(0,0.112049);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1602197);
   quadLineFit1009->SetParError(1,0.006534832);
