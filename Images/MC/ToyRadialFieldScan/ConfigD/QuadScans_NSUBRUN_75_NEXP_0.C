...
//=========  (Tue Oct 20 14:19:18 2020) by ROOT version 6.22/02
   ...
   0.01696128,
   0.01696128};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1025,-30.000000 ppm_fy1025,-30.000000 ppm_fex1025,-30.000000 ppm_fey1025);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1025 = new TH1F("Graph_mI30dO000000sPppm1025","",100,13.4,20.6);
   ...
   quadLineFit1026->SetChisquare(8.307643);
   ...
   quadLineFit1026->SetParameter(0,-3.324197);
   quadLineFit1026->SetParError(0,0.06503048);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.1013291);
   quadLineFit1026->SetParError(1,0.003792654);
   ...
   quadLineFit1027->SetChisquare(8.307643);
   ...
   quadLineFit1027->SetParameter(0,-3.324197);
   quadLineFit1027->SetParError(0,0.06503048);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.1013291);
   quadLineFit1027->SetParError(1,0.003792654);
   quadLineFit1027->SetParLimits(1,0,0);
   quadLineFit1027->Draw("same");
   
   Double_t -10.000000 ppm_fx1027[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1027[4] = {
   -0.1440294,
   -0.1809783,
   -0.1384988,
   -0.09657069};
   Double_t -10.000000 ppm_fex1027[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1027[4] = {
   0.01696128,
   0.01696128,
   0.01696128,
   0.01696128};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1027,-10.000000 ppm_fy1027,-10.000000 ppm_fex1027,-10.000000 ppm_fey1027);
   ...
   TH1F *Graph_mI10dO000000sPppm1027 = new TH1F("Graph_mI10dO000000sPppm1027","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1027->SetMinimum(-0.2097726);
   Graph_mI10dO000000sPppm1027->SetMaximum(-0.06777639);
   ...
   quadLineFit1028->SetChisquare(6.518355);
   ...
   quadLineFit1028->SetParameter(0,-0.2971467);
   quadLineFit1028->SetParError(0,0.06503061);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,0.009242787);
   quadLineFit1028->SetParError(1,0.003792662);
   ...
   quadLineFit1029->SetChisquare(6.518355);
   ...
   quadLineFit1029->SetParameter(0,-0.2971467);
   quadLineFit1029->SetParError(0,0.06503061);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,0.009242787);
   quadLineFit1029->SetParError(1,0.003792662);
   ...
   TH1F *Graph_10dO000000sPppm1029 = new TH1F("Graph_10dO000000sPppm1029","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1029->SetMinimum(0.9953999);
   Graph_10dO000000sPppm1029->SetMaximum(1.598541);
   ...
   quadLineFit1030->SetChisquare(0.176004);
   ...
   quadLineFit1030->SetParameter(0,2.615252);
   quadLineFit1030->SetParError(0,0.06503057);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,-0.07761609);
   quadLineFit1030->SetParError(1,0.00379266);
   ...
   quadLineFit1031->SetChisquare(0.176004);
   ...
   quadLineFit1031->SetParameter(0,2.615252);
   quadLineFit1031->SetParError(0,0.06503057);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,-0.07761609);
   quadLineFit1031->SetParError(1,0.00379266);
   quadLineFit1031->SetParLimits(1,0,0);
   quadLineFit1031->Draw("same");
   
   Double_t 30.000000 ppm_fx1031[4] = {
   14,
   16,
   18,
   20};
   Double_t 30.000000 ppm_fy1031[4] = {
   3.271446,
   2.84961,
   2.55422,
   2.30519};
   Double_t 30.000000 ppm_fex1031[4] = {
   0,
   0,
   0,
   0};
   Double_t 30.000000 ppm_fey1031[4] = {
   0.01696128,
   0.01696128,
   0.01696128,
   0.01696128};
   gre = new TGraphErrors(4,30.000000 ppm_fx1031,30.000000 ppm_fy1031,30.000000 ppm_fex1031,30.000000 ppm_fey1031);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1031 = new TH1F("Graph_30dO000000sPppm1031","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1031->SetMinimum(2.188211);
   Graph_30dO000000sPppm1031->SetMaximum(3.388426);
   ...
   quadLineFit1032->SetChisquare(27.06498);
   ...
   quadLineFit1032->SetParameter(0,5.460152);
   quadLineFit1032->SetParError(0,0.0650288);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,-0.159708);
   quadLineFit1032->SetParError(1,0.003792555);
   ...
   quadLineFit1033->SetChisquare(27.06498);
   ...
   quadLineFit1033->SetParameter(0,5.460152);
   quadLineFit1033->SetParError(0,0.0650288);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,-0.159708);
   quadLineFit1033->SetParError(1,0.003792555);
