...
//=========  (Tue Oct 20 14:19:25 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1109[4] = {
   14,
   16,
   18,
   20};
   Double_t -30.000000 ppm_fy1109[4] = {
   -1.903977,
   -1.658911,
   -1.468914,
   -1.330264};
   Double_t -30.000000 ppm_fex1109[4] = {
   0,
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1109[4] = {
   0.009322777,
   0.009322777,
   0.009322777,
   0.009322777};
   TGraphErrors *gre = new TGraphErrors(4,-30.000000 ppm_fx1109,-30.000000 ppm_fy1109,-30.000000 ppm_fex1109,-30.000000 ppm_fey1109);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1109 = new TH1F("Graph_mI30dO000000sPppm1109","",100,13.4,20.6);
   ...
   TF1 *quadLineFit1110 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1110->SetFillColor(19);
   quadLineFit1110->SetFillStyle(0);
   quadLineFit1110->SetLineWidth(2);
   quadLineFit1110->SetChisquare(32.58114);
   quadLineFit1110->SetNDF(2);
   ...
   quadLineFit1110->SetParameter(0,-3.21498);
   quadLineFit1110->SetParError(0,0.03574463);
   quadLineFit1110->SetParLimits(0,0,0);
   quadLineFit1110->SetParameter(1,0.09555664);
   quadLineFit1110->SetParError(1,0.00208467);
   quadLineFit1110->SetParLimits(1,0,0);
   quadLineFit1110->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1110);
   gre->Draw("ap");
   
   TF1 *quadLineFit1111 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1111->SetFillColor(19);
   quadLineFit1111->SetFillStyle(0);
   quadLineFit1111->SetLineWidth(2);
   quadLineFit1111->SetChisquare(32.58114);
   quadLineFit1111->SetNDF(2);
   ...
   quadLineFit1111->SetParameter(0,-3.21498);
   quadLineFit1111->SetParError(0,0.03574463);
   quadLineFit1111->SetParLimits(0,0,0);
   quadLineFit1111->SetParameter(1,0.09555664);
   quadLineFit1111->SetParError(1,0.00208467);
   quadLineFit1111->SetParLimits(1,0,0);
   quadLineFit1111->Draw("same");
   
   Double_t -10.000000 ppm_fx1111[4] = {
   14,
   16,
   18,
   20};
   Double_t -10.000000 ppm_fy1111[4] = {
   -0.1727702,
   -0.159222,
   -0.1178695,
   -0.1283316};
   Double_t -10.000000 ppm_fex1111[4] = {
   0,
   0,
   0,
   0};
   Double_t -10.000000 ppm_fey1111[4] = {
   0.009322777,
   0.009322777,
   0.009322777,
   0.009322777};
   gre = new TGraphErrors(4,-10.000000 ppm_fx1111,-10.000000 ppm_fy1111,-10.000000 ppm_fex1111,-10.000000 ppm_fey1111);
   ...
   TH1F *Graph_mI10dO000000sPppm1111 = new TH1F("Graph_mI10dO000000sPppm1111","Graph",100,13.4,20.6);
   Graph_mI10dO000000sPppm1111->SetMinimum(-0.1894476);
   Graph_mI10dO000000sPppm1111->SetMaximum(-0.1011921);
   ...
   TF1 *quadLineFit1112 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1112->SetChisquare(5.305011);
   quadLineFit1112->SetNDF(2);
   ...
   quadLineFit1112->SetParameter(0,-0.2930165);
   quadLineFit1112->SetParError(0,0.0357441);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.008733419);
   quadLineFit1112->SetParError(1,0.002084638);
   quadLineFit1112->SetParLimits(1,0,0);
   quadLineFit1112->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1112);
   gre->Draw("p ");
   
   TF1 *quadLineFit1113 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1113->SetChisquare(5.305011);
   quadLineFit1113->SetNDF(2);
   ...
   quadLineFit1113->SetParameter(0,-0.2930165);
   quadLineFit1113->SetParError(0,0.0357441);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.008733419);
   quadLineFit1113->SetParError(1,0.002084638);
   quadLineFit1113->SetParLimits(1,0,0);
   quadLineFit1113->Draw("same");
   
   Double_t 10.000000 ppm_fx1113[4] = {
   14,
   16,
   18,
   20};
   Double_t 10.000000 ppm_fy1113[4] = {
   1.535759,
   1.347294,
   1.205661,
   1.091462};
   Double_t 10.000000 ppm_fex1113[4] = {
   0,
   0,
   0,
   0};
   Double_t 10.000000 ppm_fey1113[4] = {
   0.009322777,
   0.009322777,
   0.009322777,
   0.009322777};
   gre = new TGraphErrors(4,10.000000 ppm_fx1113,10.000000 ppm_fy1113,10.000000 ppm_fex1113,10.000000 ppm_fey1113);
   gre->SetName("10.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10dO000000sPppm1113 = new TH1F("Graph_10dO000000sPppm1113","Graph",100,13.4,20.6);
   Graph_10dO000000sPppm1113->SetMinimum(1.035845);
   Graph_10dO000000sPppm1113->SetMaximum(1.591376);
   ...
   quadLineFit1114->SetChisquare(16.08093);
   ...
   quadLineFit1114->SetParameter(0,2.548389);
   quadLineFit1114->SetParError(0,0.03574407);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,-0.0737262);
   quadLineFit1114->SetParError(1,0.002084637);
   ...
   quadLineFit1115->SetChisquare(16.08093);
   ...
   quadLineFit1115->SetParameter(0,2.548389);
   quadLineFit1115->SetParError(0,0.03574407);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,-0.0737262);
   quadLineFit1115->SetParError(1,0.002084637);
   ...
   TH1F *Graph_30dO000000sPppm1115 = new TH1F("Graph_30dO000000sPppm1115","Graph",100,13.4,20.6);
   Graph_30dO000000sPppm1115->SetMinimum(2.172187);
   Graph_30dO000000sPppm1115->SetMaximum(3.400919);
   ...
   quadLineFit1116->SetChisquare(101.8006);
   ...
   quadLineFit1116->SetParameter(0,5.584936);
   quadLineFit1116->SetParError(0,0.03574457);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.1673765);
   quadLineFit1116->SetParError(1,0.002084666);
   ...
   quadLineFit1117->SetChisquare(101.8006);
   ...
   quadLineFit1117->SetParameter(0,5.584936);
   quadLineFit1117->SetParError(0,0.03574457);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.1673765);
   quadLineFit1117->SetParError(1,0.002084666);
