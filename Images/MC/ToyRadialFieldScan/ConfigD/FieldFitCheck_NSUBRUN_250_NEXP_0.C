...
//=========  (Tue Oct 20 14:19:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.26932,45,54.98235);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01119->SetMinimum(-28.94415);
   Graph_Graph01119->SetMaximum(45.65718);
   ...
   checkFit1120->SetChisquare(5.107841);
   ...
   checkFit1120->SetParameter(0,8.049354);
   checkFit1120->SetParError(0,0.2552807);
   checkFit1120->SetParLimits(0,0,0);
   checkFit1120->SetParameter(1,1.01183);
   checkFit1120->SetParError(1,0.0114165);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0114");
   pt_LaTex = pt->AddText(" 8.05#pm0.255");
   pt_LaTex = pt->AddText("#minus7.96#pm0.268");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.95524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.95524,-28.94415,-7.95524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1121->SetChisquare(5.107841);
   ...
   checkFit1121->SetParameter(0,8.049354);
   checkFit1121->SetParError(0,0.2552807);
   checkFit1121->SetParLimits(0,0,0);
   checkFit1121->SetParameter(1,1.01183);
   checkFit1121->SetParError(1,0.0114165);
