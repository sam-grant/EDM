...
//=========  (Tue Oct 20 14:19:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.2291,45,54.93375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-28.91281);
   Graph_Graph01023->SetMaximum(45.61746);
   ...
   checkFit1024->SetChisquare(1.627024);
   ...
   checkFit1024->SetParameter(0,7.641726);
   checkFit1024->SetParError(0,0.5679206);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9951826);
   checkFit1024->SetParError(1,0.02539818);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.0254");
   pt_LaTex = pt->AddText(" 7.64#pm0.568");
   pt_LaTex = pt->AddText("#minus7.68#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.678718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.678718,-28.91281,-7.678718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(1.627024);
   ...
   checkFit1025->SetParameter(0,7.641726);
   checkFit1025->SetParError(0,0.5679206);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9951826);
   checkFit1025->SetParError(1,0.02539818);
