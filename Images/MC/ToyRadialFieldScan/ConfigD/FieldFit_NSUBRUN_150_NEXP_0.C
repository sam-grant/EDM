...
//=========  (Tue Oct 20 14:19:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2324736,45,0.1648224);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.192744);
   Graph_Graph01069->SetMaximum(0.1250928);
   ...
   mainFit1070->SetChisquare(0.5384761);
   ...
   mainFit1070->SetParameter(0,-0.03446513);
   mainFit1070->SetParError(0,0.001346985);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.004313366);
   mainFit1070->SetParError(1,6.023939e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.269");
   pt_LaTex = pt->AddText("#minus0.00431#pm6.02e-05");
   pt_LaTex = pt->AddText("#minus0.0345#pm0.00135");
   pt_LaTex = pt->AddText("#minus7.99#pm0.332");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.99031,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.99031,-0.192744,-7.99031,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(0.5384761);
   ...
   mainFit1071->SetParameter(0,-0.03446513);
   mainFit1071->SetParError(0,0.001346985);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.004313366);
   mainFit1071->SetParError(1,6.023939e-05);
