...
//=========  (Tue Oct 20 14:19:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2348572,45,0.163147);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.1950568);
   Graph_Graph01021->SetMaximum(0.1233465);
   ...
   mainFit1022->SetChisquare(2.104759);
   ...
   mainFit1022->SetParameter(0,-0.03250461);
   mainFit1022->SetParError(0,0.002318834);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.004263218);
   mainFit1022->SetParError(1,0.0001037012);
   ...
   pt_LaTex = pt->AddText("#minus0.00426#pm0.000104");
   pt_LaTex = pt->AddText("#minus0.0325#pm0.00232");
   pt_LaTex = pt->AddText("#minus7.62#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.624432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.624432,-0.1950568,-7.624432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(2.104759);
   ...
   mainFit1023->SetParameter(0,-0.03250461);
   mainFit1023->SetParError(0,0.002318834);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.004263218);
   mainFit1023->SetParError(1,0.0001037012);
