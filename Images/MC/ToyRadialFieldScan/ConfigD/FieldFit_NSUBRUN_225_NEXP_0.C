...
//=========  (Tue Oct 20 14:19:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2310092,45,0.1612846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.1917798);
   Graph_Graph01105->SetMaximum(0.1220552);
   ...
   mainFit1106->SetChisquare(0.7070142);
   ...
   mainFit1106->SetParameter(0,-0.03577822);
   mainFit1106->SetParError(0,0.001098902);
   mainFit1106->SetParLimits(0,0,0);
   mainFit1106->SetParameter(1,-0.004283784);
   mainFit1106->SetParError(1,4.914452e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.354");
   pt_LaTex = pt->AddText("#minus0.00428#pm4.91e-05");
   pt_LaTex = pt->AddText("#minus0.0358#pm0.0011");
   pt_LaTex = pt->AddText("#minus8.35#pm0.274");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.352013,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.352013,-0.1917798,-8.352013,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1107->SetChisquare(0.7070142);
   ...
   mainFit1107->SetParameter(0,-0.03577822);
   mainFit1107->SetParError(0,0.001098902);
   mainFit1107->SetParLimits(0,0,0);
   mainFit1107->SetParameter(1,-0.004283784);
   mainFit1107->SetParError(1,4.914452e-05);
