...
//=========  (Tue Oct 20 14:19:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.22533,45,54.37826);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01131->SetMinimum(-28.96497);
   Graph_Graph01131->SetMaximum(45.1179);
   ...
   checkFit1132->SetChisquare(0.003831937);
   ...
   checkFit1132->SetParameter(0,8.08493);
   checkFit1132->SetParError(0,0.2433797);
   checkFit1132->SetParLimits(0,0,0);
   checkFit1132->SetParameter(1,1.012518);
   checkFit1132->SetParError(1,0.01088427);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.00192");
   pt_LaTex = pt->AddText(" 1.01#pm0.0109");
   pt_LaTex = pt->AddText(" 8.08#pm0.243");
   pt_LaTex = pt->AddText("#minus7.98#pm0.255");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.984977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.984977,-28.96497,-7.984977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1133->SetChisquare(0.003831937);
   ...
   checkFit1133->SetParameter(0,8.08493);
   checkFit1133->SetParError(0,0.2433797);
   checkFit1133->SetParLimits(0,0,0);
   checkFit1133->SetParameter(1,1.012518);
   checkFit1133->SetParError(1,0.01088427);
