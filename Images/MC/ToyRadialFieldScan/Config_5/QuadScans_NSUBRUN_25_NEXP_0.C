...
//=========  (Fri Oct 16 07:51:42 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_30dO000000sPppm1003 = new TH1F("Graph_30dO000000sPppm1003","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1003->SetMinimum(2.400312);
   Graph_30dO000000sPppm1003->SetMaximum(2.895731);
   ...
   quadLineFit1004->SetChisquare(2.013646e-18);
   ...
   quadLineFit1004->SetParameter(0,5.290612);
   quadLineFit1004->SetParError(0,0.3088695);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-0.1540869);
   ...
   quadLineFit1005->SetChisquare(2.013646e-18);
   ...
   quadLineFit1005->SetParameter(0,5.290612);
   quadLineFit1005->SetParError(0,0.3088695);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-0.1540869);
