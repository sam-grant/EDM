...
//=========  (Fri Oct 16 07:51:43 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1017 = new TH1F("Graph_mI30dO000000sPppm1017","",100,15.77,18.53);
   ...
   quadLineFit1018->SetChisquare(1.49974e-19);
   ...
   quadLineFit1018->SetParameter(0,-3.149117);
   quadLineFit1018->SetParError(0,0.1792603);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.09315467);
   ...
   quadLineFit1019->SetChisquare(1.49974e-19);
   ...
   quadLineFit1019->SetParameter(0,-3.149117);
   quadLineFit1019->SetParError(0,0.1792603);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.09315467);
   ...
   Graph_30dO000000sPppm1019->SetMinimum(2.431249);
   Graph_30dO000000sPppm1019->SetMaximum(2.921694);
   ...
   quadLineFit1020->SetChisquare(2.8241e-20);
   ...
   quadLineFit1020->SetParameter(0,5.47104);
   quadLineFit1020->SetParError(0,0.1792603);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.1629486);
   ...
   quadLineFit1021->SetChisquare(2.8241e-20);
   ...
   quadLineFit1021->SetParameter(0,5.47104);
   quadLineFit1021->SetParError(0,0.1792603);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.1629486);
