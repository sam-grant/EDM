...
//=========  (Fri Oct 16 07:51:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2331759,45,0.1612603);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01085->SetMinimum(-0.1937323);
   Graph_Graph01085->SetMaximum(0.1218167);
   ...
   mainFit1086->SetChisquare(5.586912e-13);
   ...
   mainFit1086->SetParameter(0,-0.03595778);
   mainFit1086->SetParError(0,0.003864416);
   mainFit1086->SetParLimits(0,0,0);
   mainFit1086->SetParameter(1,-0.004200455);
   mainFit1086->SetParError(1,0.0001288139);
   ...
   pt_LaTex = pt->AddText("#minus0.0042#pm0.000129");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.56045,-0.1937323,-8.56045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1087->SetChisquare(5.586912e-13);
   ...
   mainFit1087->SetParameter(0,-0.03595778);
   mainFit1087->SetParError(0,0.003864416);
   mainFit1087->SetParLimits(0,0,0);
   mainFit1087->SetParameter(1,-0.004200455);
   mainFit1087->SetParError(1,0.0001288139);
