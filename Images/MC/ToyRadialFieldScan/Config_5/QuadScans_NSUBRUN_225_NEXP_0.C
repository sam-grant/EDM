...
//=========  (Fri Oct 16 07:51:48 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1065 = new TH1F("Graph_mI30dO000000sPppm1065","",100,15.77,18.53);
   ...
   quadLineFit1066->SetChisquare(1.469211e-19);
   ...
   quadLineFit1066->SetParameter(0,-3.231126);
   quadLineFit1066->SetParError(0,0.10388);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,0.09699004);
   ...
   quadLineFit1067->SetChisquare(1.469211e-19);
   ...
   quadLineFit1067->SetParameter(0,-3.231126);
   quadLineFit1067->SetParError(0,0.10388);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,0.09699004);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(2.460413);
   Graph_30dO000000sPppm1067->SetMaximum(2.900642);
   ...
   quadLineFit1068->SetChisquare(6.719171e-19);
   ...
   quadLineFit1068->SetParameter(0,5.269432);
   quadLineFit1068->SetParError(0,0.10388);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.1509566);
   ...
   quadLineFit1069->SetChisquare(6.719171e-19);
   ...
   quadLineFit1069->SetParameter(0,5.269432);
   quadLineFit1069->SetParError(0,0.10388);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.1509566);
