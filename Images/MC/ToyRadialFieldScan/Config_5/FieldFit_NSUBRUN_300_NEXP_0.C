...
//=========  (Thu Oct 15 00:41:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3585702,75,0.3005807);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01309->SetMinimum(-0.2926551);
   Graph_Graph01309->SetMaximum(0.2346656);
   ...
   mainFit1310->SetParameter(0,-0.03108821);
   mainFit1310->SetParError(0,0.001577435);
   mainFit1310->SetParLimits(0,0,0);
   mainFit1310->SetParameter(1,-0.004186285);
   mainFit1310->SetParError(1,4.988288e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00419#pm4.99e-05");
   pt_LaTex = pt->AddText("#minus0.0311#pm0.00158");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.426206,-0.2926551,-7.426206,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1311->SetParameter(0,-0.03108821);
   mainFit1311->SetParError(0,0.001577435);
   mainFit1311->SetParLimits(0,0,0);
   mainFit1311->SetParameter(1,-0.004186285);
   mainFit1311->SetParError(1,4.988288e-05);
