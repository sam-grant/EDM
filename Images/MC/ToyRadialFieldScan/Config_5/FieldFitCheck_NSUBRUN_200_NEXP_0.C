...
//=========  (Thu Oct 15 00:41:44 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.14625,75,89.00285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01207->SetMinimum(-53.33134);
   Graph_Graph01207->SetMaximum(73.18794);
   ...
   checkFit1208->SetChisquare(5.203278);
   ...
   checkFit1208->SetParameter(0,8.59994);
   checkFit1208->SetParError(0,0.4697032);
   checkFit1208->SetParLimits(0,0,0);
   checkFit1208->SetParameter(1,1.001964);
   checkFit1208->SetParError(1,0.01485332);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0149");
   pt_LaTex = pt->AddText("  8.6#pm 0.47");
   pt_LaTex = pt->AddText("#minus8.58#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.583083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.583083,-53.33134,-8.583083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1209->SetChisquare(5.203278);
   ...
   checkFit1209->SetParameter(0,8.59994);
   checkFit1209->SetParError(0,0.4697032);
   checkFit1209->SetParLimits(0,0,0);
   checkFit1209->SetParameter(1,1.001964);
   checkFit1209->SetParError(1,0.01485332);
