...
//=========  (Fri Oct 16 07:51:44 2020) by ROOT version 6.22/02
   ...
   quadLineFit1026->SetChisquare(1.019183e-20);
   ...
   quadLineFit1026->SetParameter(0,-2.885143);
   quadLineFit1026->SetParError(0,0.1561401);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.07863207);
   quadLineFit1026->SetParError(1,0.009083978);
   ...
   quadLineFit1027->SetChisquare(1.019183e-20);
   ...
   quadLineFit1027->SetParameter(0,-2.885143);
   quadLineFit1027->SetParError(0,0.1561401);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.07863207);
   quadLineFit1027->SetParError(1,0.009083978);
   ...
   TH1F *Graph_30dO000000sPppm1027 = new TH1F("Graph_30dO000000sPppm1027","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1027->SetMinimum(2.448563);
   Graph_30dO000000sPppm1027->SetMaximum(2.925335);
   ...
   quadLineFit1028->SetChisquare(1.832571e-17);
   ...
   quadLineFit1028->SetParameter(0,5.429183);
   quadLineFit1028->SetParError(0,0.1561401);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.159897);
   quadLineFit1028->SetParError(1,0.009083978);
   ...
   quadLineFit1029->SetChisquare(1.832571e-17);
   ...
   quadLineFit1029->SetParameter(0,5.429183);
   quadLineFit1029->SetParError(0,0.1561401);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.159897);
   quadLineFit1029->SetParError(1,0.009083978);
