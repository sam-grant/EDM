...
//=========  (Thu Oct 15 00:41:36 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3525184,75,0.2975319);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01101->SetMinimum(-0.2875134);
   Graph_Graph01101->SetMaximum(0.2325269);
   ...
   mainFit1102->SetParameter(0,-0.02985212);
   mainFit1102->SetParError(0,0.002738922);
   mainFit1102->SetParLimits(0,0,0);
   mainFit1102->SetParameter(1,-0.004156023);
   mainFit1102->SetParError(1,8.661233e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00416#pm8.66e-05");
   pt_LaTex = pt->AddText("#minus0.0299#pm0.00274");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.182858,-0.2875134,-7.182858,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1103->SetParameter(0,-0.02985212);
   mainFit1103->SetParError(0,0.002738922);
   mainFit1103->SetParLimits(0,0,0);
   mainFit1103->SetParameter(1,-0.004156023);
   mainFit1103->SetParError(1,8.661233e-05);
