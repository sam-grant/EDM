...
//=========  (Fri Oct 16 07:51:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2331553,45,0.1518903);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.1946507);
   Graph_Graph01029->SetMaximum(0.1133858);
   ...
   mainFit1030->SetChisquare(1.648561e-14);
   ...
   mainFit1030->SetParameter(0,-0.04063248);
   mainFit1030->SetParError(0,0.006423342);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,-0.003975485);
   mainFit1030->SetParError(1,0.0002141114);
   ...
   pt_LaTex = pt->AddText("#minus0.00398#pm0.000214");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.22076,-0.1946507,-10.22076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.648561e-14);
   ...
   mainFit1031->SetParameter(0,-0.04063248);
   mainFit1031->SetParError(0,0.006423342);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,-0.003975485);
   mainFit1031->SetParError(1,0.0002141114);
