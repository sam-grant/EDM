...
//=========  (Fri Oct 16 07:51:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.18137,45,56.65467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","Sub-runs 275",100,-36,36);
   Graph_Graph01087->SetMinimum(-29.59776);
   Graph_Graph01087->SetMaximum(47.07106);
   ...
   checkFit1088->SetChisquare(6.802258e-17);
   ...
   checkFit1088->SetParameter(0,8.73665);
   checkFit1088->SetParError(0,0.9389356);
   checkFit1088->SetParLimits(0,0,0);
   checkFit1088->SetParameter(1,1.020583);
   checkFit1088->SetParError(1,0.03129785);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0313");
   pt_LaTex = pt->AddText(" 8.74#pm0.939");
   pt_LaTex = pt->AddText("#minus8.56#pm0.957");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.56045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.56045,-29.59776,-8.56045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1089->SetChisquare(6.802258e-17);
   ...
   checkFit1089->SetParameter(0,8.73665);
   checkFit1089->SetParError(0,0.9389356);
   checkFit1089->SetParLimits(0,0,0);
   checkFit1089->SetParameter(1,1.020583);
   checkFit1089->SetParError(1,0.03129785);
