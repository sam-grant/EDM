...
//=========  (Fri Oct 16 07:51:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2249217,45,0.1524101);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-0.1871885);
   Graph_Graph01013->SetMaximum(0.1146769);
   ...
   mainFit1014->SetChisquare(1.112625e-13);
   ...
   mainFit1014->SetParameter(1,-0.003767485);
   mainFit1014->SetParError(1,0.000300584);
   ...
   pt_LaTex = pt->AddText("#minus0.00377#pm0.000301");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.623344,-0.1871885,-9.623344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(1.112625e-13);
   ...
   mainFit1015->SetParameter(1,-0.003767485);
   mainFit1015->SetParError(1,0.000300584);
