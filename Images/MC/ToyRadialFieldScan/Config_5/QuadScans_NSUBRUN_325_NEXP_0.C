...
//=========  (Thu Oct 15 00:41:53 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1313 = new TH1F("Graph_mI50dO000000sPppm1313","",100,15.77,18.53);
   ...
   TF1 *quadLineFit1314 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1314->SetFillColor(19);
   quadLineFit1314->SetFillStyle(0);
   quadLineFit1314->SetLineWidth(2);
   quadLineFit1314->SetChisquare(7.051407e-17);
   ...
   quadLineFit1314->SetParameter(0,-5.943036);
   quadLineFit1314->SetParError(0,0.08639889);
   quadLineFit1314->SetParLimits(0,0,0);
   quadLineFit1314->SetParameter(1,0.1734235);
   quadLineFit1314->SetParError(1,0.005026548);
   quadLineFit1314->SetParLimits(1,0,0);
   quadLineFit1314->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1314);
   gre->Draw("ap");
   
   TF1 *quadLineFit1315 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1315->SetFillColor(19);
   quadLineFit1315->SetFillStyle(0);
   quadLineFit1315->SetLineWidth(2);
   quadLineFit1315->SetChisquare(7.051407e-17);
   ...
   quadLineFit1315->SetParameter(0,-5.943036);
   quadLineFit1315->SetParError(0,0.08639889);
   quadLineFit1315->SetParLimits(0,0,0);
   quadLineFit1315->SetParameter(1,0.1734235);
   quadLineFit1315->SetParError(1,0.005026548);
   ...
   TH1F *Graph_mI40dO000000sPppm1315 = new TH1F("Graph_mI40dO000000sPppm1315","Graph",100,15.77,18.53);
   Graph_mI40dO000000sPppm1315->SetMinimum(-2.462086);
   Graph_mI40dO000000sPppm1315->SetMaximum(-2.067479);
   ...
   TF1 *quadLineFit1316 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1316->SetChisquare(8.267072e-17);
   ...
   quadLineFit1316->SetParameter(0,-4.594867);
   quadLineFit1316->SetParError(0,0.0863989);
   quadLineFit1316->SetParLimits(0,0,0);
   quadLineFit1316->SetParameter(1,0.135865);
   quadLineFit1316->SetParError(1,0.005026548);
   quadLineFit1316->SetParLimits(1,0,0);
   quadLineFit1316->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1316);
   gre->Draw("p ");
   
   TF1 *quadLineFit1317 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1317->SetChisquare(8.267072e-17);
   ...
   quadLineFit1317->SetParameter(0,-4.594867);
   quadLineFit1317->SetParError(0,0.0863989);
   quadLineFit1317->SetParLimits(0,0,0);
   quadLineFit1317->SetParameter(1,0.135865);
   quadLineFit1317->SetParError(1,0.005026548);
   ...
   TH1F *Graph_mI30dO000000sPppm1317 = new TH1F("Graph_mI30dO000000sPppm1317","Graph",100,15.77,18.53);
   Graph_mI30dO000000sPppm1317->SetMinimum(-1.690039);
   Graph_mI30dO000000sPppm1317->SetMaximum(-1.406082);
   ...
   TF1 *quadLineFit1318 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1318->SetChisquare(3.380019e-20);
   ...
   quadLineFit1318->SetParameter(0,-3.190587);
   quadLineFit1318->SetParError(0,0.0863989);
   quadLineFit1318->SetParLimits(0,0,0);
   quadLineFit1318->SetParameter(1,0.09577412);
   quadLineFit1318->SetParError(1,0.005026548);
   quadLineFit1318->SetParLimits(1,0,0);
   quadLineFit1318->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1318);
   gre->Draw("p ");
   
   TF1 *quadLineFit1319 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1319->SetChisquare(3.380019e-20);
   ...
   quadLineFit1319->SetParameter(0,-3.190587);
   quadLineFit1319->SetParError(0,0.0863989);
   quadLineFit1319->SetParLimits(0,0,0);
   quadLineFit1319->SetParameter(1,0.09577412);
   quadLineFit1319->SetParError(1,0.005026548);
   ...
   TH1F *Graph_mI20dO000000sPppm1319 = new TH1F("Graph_mI20dO000000sPppm1319","Graph",100,15.77,18.53);
   Graph_mI20dO000000sPppm1319->SetMinimum(-0.9254626);
   Graph_mI20dO000000sPppm1319->SetMaximum(-0.7690947);
   ...
   TF1 *quadLineFit1320 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1320->SetChisquare(3.69871e-18);
   ...
   quadLineFit1320->SetParameter(0,-1.696999);
   quadLineFit1320->SetParError(0,0.0863989);
   quadLineFit1320->SetParLimits(0,0,0);
   quadLineFit1320->SetParameter(1,0.0495464);
   quadLineFit1320->SetParError(1,0.005026548);
   quadLineFit1320->SetParLimits(1,0,0);
   quadLineFit1320->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1320);
   gre->Draw("p ");
   
   TF1 *quadLineFit1321 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1321->SetChisquare(3.69871e-18);
   ...
   quadLineFit1321->SetParameter(0,-1.696999);
   quadLineFit1321->SetParError(0,0.0863989);
   quadLineFit1321->SetParLimits(0,0,0);
   quadLineFit1321->SetParameter(1,0.0495464);
   quadLineFit1321->SetParError(1,0.005026548);
   ...
   TH1F *Graph_mI10dO000000sPppm1321 = new TH1F("Graph_mI10dO000000sPppm1321","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1321->SetMinimum(-0.1534585);
   Graph_mI10dO000000sPppm1321->SetMaximum(-0.1105923);
   ...
   TF1 *quadLineFit1322 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1322->SetChisquare(2.671889e-21);
   ...
   quadLineFit1322->SetParameter(0,-0.2764737);
   quadLineFit1322->SetParError(0,0.08639889);
   quadLineFit1322->SetParLimits(0,0,0);
   quadLineFit1322->SetParameter(1,0.008422641);
   quadLineFit1322->SetParError(1,0.005026548);
   quadLineFit1322->SetParLimits(1,0,0);
   quadLineFit1322->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1322);
   gre->Draw("p ");
   
   TF1 *quadLineFit1323 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1323->SetChisquare(2.671889e-21);
   ...
   quadLineFit1323->SetParameter(0,-0.2764737);
   quadLineFit1323->SetParError(0,0.08639889);
   quadLineFit1323->SetParLimits(0,0,0);
   quadLineFit1323->SetParameter(1,0.008422641);
   quadLineFit1323->SetParError(1,0.005026548);
   ...
   TH1F *Graph_0dO000000sPppm1323 = new TH1F("Graph_0dO000000sPppm1323","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1323->SetMinimum(0.506759);
   Graph_0dO000000sPppm1323->SetMaximum(0.6070443);
   ...
   TF1 *quadLineFit1324 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1324->SetChisquare(2.679454e-20);
   ...
   quadLineFit1324->SetParameter(0,1.058138);
   quadLineFit1324->SetParError(0,0.0863989);
   quadLineFit1324->SetParLimits(0,0,0);
   quadLineFit1324->SetParameter(1,-0.02922663);
   quadLineFit1324->SetParError(1,0.005026548);
   quadLineFit1324->SetParLimits(1,0,0);
   quadLineFit1324->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1324);
   gre->Draw("p ");
   
   TF1 *quadLineFit1325 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1325->SetChisquare(2.679454e-20);
   ...
   quadLineFit1325->SetParameter(0,1.058138);
   quadLineFit1325->SetParError(0,0.0863989);
   quadLineFit1325->SetParLimits(0,0,0);
   quadLineFit1325->SetParameter(1,-0.02922663);
   quadLineFit1325->SetParError(1,0.005026548);
   ...
   TH1F *Graph_10dO000000sPppm1325 = new TH1F("Graph_10dO000000sPppm1325","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1325->SetMinimum(1.168332);
   Graph_10dO000000sPppm1325->SetMaximum(1.396087);
   ...
   TF1 *quadLineFit1326 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1326->SetChisquare(5.788715e-22);
   ...
   quadLineFit1326->SetParameter(0,2.575512);
   quadLineFit1326->SetParError(0,0.08639889);
   quadLineFit1326->SetParLimits(0,0,0);
   quadLineFit1326->SetParameter(1,-0.07541121);
   quadLineFit1326->SetParError(1,0.005026548);
   quadLineFit1326->SetParLimits(1,0,0);
   quadLineFit1326->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1326);
   gre->Draw("p ");
   
   TF1 *quadLineFit1327 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1327->SetChisquare(5.788715e-22);
   ...
   quadLineFit1327->SetParameter(0,2.575512);
   quadLineFit1327->SetParError(0,0.08639889);
   quadLineFit1327->SetParLimits(0,0,0);
   quadLineFit1327->SetParameter(1,-0.07541121);
   quadLineFit1327->SetParError(1,0.005026548);
   ...
   TH1F *Graph_20dO000000sPppm1327 = new TH1F("Graph_20dO000000sPppm1327","Graph",100,15.77,18.53);
   Graph_20dO000000sPppm1327->SetMinimum(1.80193);
   Graph_20dO000000sPppm1327->SetMaximum(2.143978);
   ...
   TF1 *quadLineFit1328 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1328->SetChisquare(4.360054e-19);
   ...
   quadLineFit1328->SetParameter(0,3.976454);
   quadLineFit1328->SetParError(0,0.08639889);
   quadLineFit1328->SetParLimits(0,0,0);
   quadLineFit1328->SetParameter(1,-0.1168222);
   quadLineFit1328->SetParError(1,0.005026548);
   quadLineFit1328->SetParLimits(1,0,0);
   quadLineFit1328->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1328);
   gre->Draw("p ");
   
   TF1 *quadLineFit1329 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1329->SetChisquare(4.360054e-19);
   ...
   quadLineFit1329->SetParameter(0,3.976454);
   quadLineFit1329->SetParError(0,0.08639889);
   quadLineFit1329->SetParLimits(0,0,0);
   quadLineFit1329->SetParameter(1,-0.1168222);
   quadLineFit1329->SetParError(1,0.005026548);
   ...
   TH1F *Graph_30dO000000sPppm1329 = new TH1F("Graph_30dO000000sPppm1329","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1329->SetMinimum(2.449987);
   Graph_30dO000000sPppm1329->SetMaximum(2.912448);
   ...
   TF1 *quadLineFit1330 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1330->SetChisquare(5.677907e-17);
   ...
   quadLineFit1330->SetParameter(0,5.43293);
   quadLineFit1330->SetParError(0,0.0863989);
   quadLineFit1330->SetParLimits(0,0,0);
   quadLineFit1330->SetParameter(1,-0.1604497);
   quadLineFit1330->SetParError(1,0.005026548);
   quadLineFit1330->SetParLimits(1,0,0);
   quadLineFit1330->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1330);
   gre->Draw("p ");
   
   TF1 *quadLineFit1331 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1331->SetChisquare(5.677907e-17);
   ...
   quadLineFit1331->SetParameter(0,5.43293);
   quadLineFit1331->SetParError(0,0.0863989);
   quadLineFit1331->SetParLimits(0,0,0);
   quadLineFit1331->SetParameter(1,-0.1604497);
   quadLineFit1331->SetParError(1,0.005026548);
   ...
   TH1F *Graph_40dO000000sPppm1331 = new TH1F("Graph_40dO000000sPppm1331","Graph",100,15.77,18.53);
   Graph_40dO000000sPppm1331->SetMinimum(3.118579);
   Graph_40dO000000sPppm1331->SetMaximum(3.678631);
   ...
   TF1 *quadLineFit1332 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1332->SetChisquare(2.814256e-19);
   ...
   quadLineFit1332->SetParameter(0,6.756725);
   quadLineFit1332->SetParError(0,0.08639889);
   quadLineFit1332->SetParLimits(0,0,0);
   quadLineFit1332->SetParameter(1,-0.1958088);
   quadLineFit1332->SetParError(1,0.005026548);
   quadLineFit1332->SetParLimits(1,0,0);
   quadLineFit1332->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1332);
   gre->Draw("p ");
   
   TF1 *quadLineFit1333 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1333->SetChisquare(2.814256e-19);
   ...
   quadLineFit1333->SetParameter(0,6.756725);
   quadLineFit1333->SetParError(0,0.08639889);
   quadLineFit1333->SetParLimits(0,0,0);
   quadLineFit1333->SetParameter(1,-0.1958088);
   quadLineFit1333->SetParError(1,0.005026548);
   ...
   TH1F *Graph_50dO000000sPppm1333 = new TH1F("Graph_50dO000000sPppm1333","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1333->SetMinimum(3.748107);
   Graph_50dO000000sPppm1333->SetMaximum(4.437389);
   ...
   TF1 *quadLineFit1334 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1334->SetChisquare(2.49172e-18);
   ...
   quadLineFit1334->SetParameter(0,8.253871);
   quadLineFit1334->SetParError(0,0.08639889);
   quadLineFit1334->SetParLimits(0,0,0);
   quadLineFit1334->SetParameter(1,-0.2426311);
   quadLineFit1334->SetParError(1,0.005026548);
   quadLineFit1334->SetParLimits(1,0,0);
   quadLineFit1334->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1334);
   gre->Draw("p ");
   
   TF1 *quadLineFit1335 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1335->SetChisquare(2.49172e-18);
   ...
   quadLineFit1335->SetParameter(0,8.253871);
   quadLineFit1335->SetParError(0,0.08639889);
   quadLineFit1335->SetParLimits(0,0,0);
   quadLineFit1335->SetParameter(1,-0.2426311);
   quadLineFit1335->SetParError(1,0.005026548);
