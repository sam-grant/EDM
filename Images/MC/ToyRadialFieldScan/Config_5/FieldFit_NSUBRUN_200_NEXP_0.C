...
//=========  (Thu Oct 15 00:41:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3663126,75,0.2845881);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01205->SetMinimum(-0.3012226);
   Graph_Graph01205->SetMaximum(0.219498);
   ...
   mainFit1206->SetParameter(0,-0.03539512);
   mainFit1206->SetParError(0,0.001933177);
   mainFit1206->SetParLimits(0,0,0);
   mainFit1206->SetParameter(1,-0.004123824);
   mainFit1206->SetParError(1,6.113241e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00412#pm6.11e-05");
   pt_LaTex = pt->AddText("#minus0.0354#pm0.00193");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.583083,-0.3012226,-8.583083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1207->SetParameter(0,-0.03539512);
   mainFit1207->SetParError(0,0.001933177);
   mainFit1207->SetParLimits(0,0,0);
   mainFit1207->SetParameter(1,-0.004123824);
   mainFit1207->SetParError(1,6.113241e-05);
