...
//=========  (Fri Oct 16 07:51:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.09173,45,53.72305);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01103->SetMinimum(-27.11025);
   Graph_Graph01103->SetMaximum(44.74158);
   ...
   checkFit1104->SetChisquare(2.67825e-17);
   ...
   checkFit1104->SetParameter(1,0.957232);
   checkFit1104->SetParError(1,0.02878628);
   ...
   pt_LaTex = pt->AddText("0.957#pm0.0288");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.209537,-27.11025,-9.209537,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1105->SetChisquare(2.67825e-17);
   ...
   checkFit1105->SetParameter(1,0.957232);
   checkFit1105->SetParError(1,0.02878628);
