...
//=========  (Fri Oct 16 07:51:50 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1089 = new TH1F("Graph_mI30dO000000sPppm1089","",100,15.77,18.53);
   ...
   Graph_mI30dO000000sPppm1089->GetXaxis()->SetTitle("QHV [kV]");
   ...
   quadLineFit1090->SetChisquare(4.080562e-21);
   ...
   quadLineFit1090->SetParameter(0,-2.91124);
   quadLineFit1090->SetParError(0,0.08992619);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,0.07909085);
   quadLineFit1090->SetParError(1,0.005231761);
   ...
   quadLineFit1091->SetChisquare(4.080562e-21);
   ...
   quadLineFit1091->SetParameter(0,-2.91124);
   quadLineFit1091->SetParError(0,0.08992619);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,0.07909085);
   quadLineFit1091->SetParError(1,0.005231761);
   ...
   Graph_30dO000000sPppm1091->SetMinimum(2.452259);
   Graph_30dO000000sPppm1091->SetMaximum(2.898421);
   ...
   quadLineFit1092->SetChisquare(4.772342e-20);
   ...
   quadLineFit1092->SetParameter(0,5.320793);
   quadLineFit1092->SetParError(0,0.08992619);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1542538);
   quadLineFit1092->SetParError(1,0.005231761);
   ...
   quadLineFit1093->SetChisquare(4.772342e-20);
   ...
   quadLineFit1093->SetParameter(0,5.320793);
   quadLineFit1093->SetParError(0,0.08992619);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1542538);
   quadLineFit1093->SetParError(1,0.005231761);
