...
//=========  (Fri Oct 16 07:51:45 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.31395,45,53.30533);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-28.25202);
   Graph_Graph01039->SetMaximum(44.2434);
   ...
   checkFit1040->SetChisquare(2.278695e-16);
   ...
   checkFit1040->SetParameter(1,0.9411292);
   checkFit1040->SetParError(1,0.04649343);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0465");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.495843,-28.25202,-8.495843,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(2.278695e-16);
   ...
   checkFit1041->SetParameter(1,0.9411292);
   checkFit1041->SetParError(1,0.04649343);
