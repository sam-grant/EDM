...
//=========  (Fri Oct 16 07:51:45 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2193909,45,0.1535746);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","Sub-runs 125",100,-36,36);
   Graph_Graph01037->SetMinimum(-0.1820944);
   Graph_Graph01037->SetMaximum(0.116278);
   ...
   mainFit1038->SetChisquare(6.670544e-15);
   ...
   mainFit1038->SetParameter(0,-0.03290817);
   mainFit1038->SetParError(0,0.005740646);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,-0.003873444);
   mainFit1038->SetParError(1,0.0001913549);
   ...
   pt_LaTex = pt->AddText("#minus0.00387#pm0.000191");
   pt_LaTex = pt->AddText("#minus0.0329#pm0.00574");
   pt_LaTex = pt->AddText(" #minus8.5#pm 1.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.495843,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.495843,-0.1820944,-8.495843,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1039->SetChisquare(6.670544e-15);
   ...
   mainFit1039->SetParameter(0,-0.03290817);
   mainFit1039->SetParError(0,0.005740646);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,-0.003873444);
   mainFit1039->SetParError(1,0.0001913549);
