...
//=========  (Fri Oct 16 07:51:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-35.29733,45,53.55965);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-26.41163);
   Graph_Graph01095->SetMaximum(44.67395);
   ...
   checkFit1096->SetChisquare(3.560703e-16);
   ...
   checkFit1096->SetParameter(1,0.9449278);
   checkFit1096->SetParError(1,0.0299615);
   ...
   pt_LaTex = pt->AddText("0.945#pm 0.03");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.663342,-26.41163,-9.663342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(3.560703e-16);
   ...
   checkFit1097->SetParameter(1,0.9449278);
   checkFit1097->SetParError(1,0.0299615);
