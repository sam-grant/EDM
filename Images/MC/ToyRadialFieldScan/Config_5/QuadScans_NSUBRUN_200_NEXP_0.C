...
//=========  (Fri Oct 16 07:51:47 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1057 = new TH1F("Graph_mI30dO000000sPppm1057","",100,15.77,18.53);
   ...
   quadLineFit1058->SetChisquare(3.934497e-19);
   ...
   quadLineFit1058->SetParameter(0,-3.109853);
   quadLineFit1058->SetParError(0,0.1102062);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,0.091244);
   ...
   quadLineFit1059->SetChisquare(3.934497e-19);
   ...
   quadLineFit1059->SetParameter(0,-3.109853);
   quadLineFit1059->SetParError(0,0.1102062);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,0.091244);
   ...
   TH1F *Graph_30dO000000sPppm1059 = new TH1F("Graph_30dO000000sPppm1059","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1059->SetMinimum(2.455544);
   Graph_30dO000000sPppm1059->SetMaximum(2.907009);
   ...
   quadLineFit1060->SetChisquare(4.753909e-17);
   ...
   quadLineFit1060->SetParameter(0,5.331072);
   quadLineFit1060->SetParError(0,0.1102062);
   quadLineFit1060->SetParLimits(0,0,0);
   quadLineFit1060->SetParameter(1,-0.154507);
   ...
   quadLineFit1061->SetChisquare(4.753909e-17);
   ...
   quadLineFit1061->SetParameter(0,5.331072);
   quadLineFit1061->SetParError(0,0.1102062);
   quadLineFit1061->SetParLimits(0,0,0);
   quadLineFit1061->SetParameter(1,-0.154507);
