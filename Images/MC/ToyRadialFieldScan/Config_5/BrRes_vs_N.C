...
//=========  (Thu Oct 15 00:41:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.1455981,1.491396e+07,0.08671344);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01341->SetMinimum(-0.122367);
   Graph_Graph01341->SetMaximum(0.06348229);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.06348229,1.325685e+07,0.06348229,0,344.5,510,"-");
