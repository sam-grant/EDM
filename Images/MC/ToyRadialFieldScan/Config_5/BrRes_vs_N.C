...
//=========  (Fri Oct 16 07:51:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.1860223,1.491396e+07,0.2073238);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-0.1466877);
   Graph_Graph01107->SetMaximum(0.1679892);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.1679892,1.325685e+07,0.1679892,0,344.5,510,"-");
