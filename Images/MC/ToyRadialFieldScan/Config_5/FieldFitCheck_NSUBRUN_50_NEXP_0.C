...
//=========  (Fri Oct 16 07:51:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.03102,45,54.64914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","Sub-runs 50",100,-36,36);
   Graph_Graph01015->SetMinimum(-27.863);
   Graph_Graph01015->SetMaximum(45.48112);
   ...
   checkFit1016->SetChisquare(9.364444e-18);
   ...
   checkFit1016->SetParameter(0,8.80906);
   checkFit1016->SetParError(0,2.190983);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,0.9153844);
   checkFit1016->SetParError(1,0.07303278);
   ...
   pt_LaTex = pt->AddText("0.915#pm0.073");
   pt_LaTex = pt->AddText(" 8.81#pm 2.19");
   pt_LaTex = pt->AddText("#minus9.62#pm 2.51");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-9.623344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.623344,-27.863,-9.623344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(9.364444e-18);
   ...
   checkFit1017->SetParameter(0,8.80906);
   checkFit1017->SetParError(0,2.190983);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,0.9153844);
   checkFit1017->SetParError(1,0.07303278);
