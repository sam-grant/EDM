...
//=========  (Thu Oct 15 00:41:32 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1027 = new TH1F("Graph_mI50dO000000sPppm1027","",100,15.77,18.53);
   ...
   TF1 *quadLineFit1028 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1028->SetFillColor(19);
   quadLineFit1028->SetFillStyle(0);
   quadLineFit1028->SetLineWidth(2);
   quadLineFit1028->SetChisquare(4.422501e-18);
   ...
   quadLineFit1028->SetParameter(0,-6.049932);
   quadLineFit1028->SetParError(0,0.2191999);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,0.1802917);
   quadLineFit1028->SetParError(1,0.0127527);
   quadLineFit1028->SetParLimits(1,0,0);
   quadLineFit1028->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1028);
   gre->Draw("ap");
   
   TF1 *quadLineFit1029 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1029->SetFillColor(19);
   quadLineFit1029->SetFillStyle(0);
   quadLineFit1029->SetLineWidth(2);
   quadLineFit1029->SetChisquare(4.422501e-18);
   ...
   quadLineFit1029->SetParameter(0,-6.049932);
   quadLineFit1029->SetParError(0,0.2191999);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,0.1802917);
   quadLineFit1029->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI40dO000000sPppm1029 = new TH1F("Graph_mI40dO000000sPppm1029","Graph",100,15.77,18.53);
   Graph_mI40dO000000sPppm1029->SetMinimum(-2.467111);
   Graph_mI40dO000000sPppm1029->SetMaximum(-2.076053);
   ...
   quadLineFit1030->SetChisquare(2.458138e-19);
   ...
   quadLineFit1030->SetParameter(0,-4.392225);
   quadLineFit1030->SetParError(0,0.2191999);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,0.1236526);
   quadLineFit1030->SetParError(1,0.0127527);
   ...
   quadLineFit1031->SetChisquare(2.458138e-19);
   ...
   quadLineFit1031->SetParameter(0,-4.392225);
   quadLineFit1031->SetParError(0,0.2191999);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,0.1236526);
   quadLineFit1031->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI30dO000000sPppm1031 = new TH1F("Graph_mI30dO000000sPppm1031","Graph",100,15.77,18.53);
   Graph_mI30dO000000sPppm1031->SetMinimum(-1.68715);
   Graph_mI30dO000000sPppm1031->SetMaximum(-1.433285);
   ...
   quadLineFit1032->SetChisquare(1.917257e-19);
   ...
   quadLineFit1032->SetParameter(0,-2.828374);
   quadLineFit1032->SetParError(0,0.2191999);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.073945);
   quadLineFit1032->SetParError(1,0.0127527);
   ...
   quadLineFit1033->SetChisquare(1.917257e-19);
   ...
   quadLineFit1033->SetParameter(0,-2.828374);
   quadLineFit1033->SetParError(0,0.2191999);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.073945);
   quadLineFit1033->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI20dO000000sPppm1033 = new TH1F("Graph_mI20dO000000sPppm1033","Graph",100,15.77,18.53);
   Graph_mI20dO000000sPppm1033->SetMinimum(-0.9453869);
   Graph_mI20dO000000sPppm1033->SetMaximum(-0.7333073);
   ...
   quadLineFit1034->SetChisquare(1.892185e-20);
   ...
   quadLineFit1034->SetParameter(0,-1.84786);
   quadLineFit1034->SetParError(0,0.2191999);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.0588054);
   quadLineFit1034->SetParError(1,0.0127527);
   ...
   quadLineFit1035->SetChisquare(1.892185e-20);
   ...
   quadLineFit1035->SetParameter(0,-1.84786);
   quadLineFit1035->SetParError(0,0.2191999);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.0588054);
   quadLineFit1035->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI10dO000000sPppm1035 = new TH1F("Graph_mI10dO000000sPppm1035","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1035->SetMinimum(-0.1977296);
   Graph_mI10dO000000sPppm1035->SetMaximum(-0.09335155);
   ...
   quadLineFit1036->SetChisquare(1.245893e-20);
   ...
   quadLineFit1036->SetParameter(0,-0.4848208);
   quadLineFit1036->SetParError(0,0.2191999);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,0.01978311);
   quadLineFit1036->SetParError(1,0.0127527);
   ...
   quadLineFit1037->SetChisquare(1.245893e-20);
   ...
   quadLineFit1037->SetParameter(0,-0.4848208);
   quadLineFit1037->SetParError(0,0.2191999);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,0.01978311);
   quadLineFit1037->SetParError(1,0.0127527);
   ...
   TH1F *Graph_0dO000000sPppm1037 = new TH1F("Graph_0dO000000sPppm1037","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1037->SetMinimum(0.4998391);
   Graph_0dO000000sPppm1037->SetMaximum(0.6329261);
   ...
   quadLineFit1038->SetChisquare(1.552035e-20);
   ...
   quadLineFit1038->SetParameter(0,1.084053);
   quadLineFit1038->SetParError(0,0.2191999);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.03018489);
   quadLineFit1038->SetParError(1,0.0127527);
   ...
   quadLineFit1039->SetChisquare(1.552035e-20);
   ...
   quadLineFit1039->SetParameter(0,1.084053);
   quadLineFit1039->SetParError(0,0.2191999);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.03018489);
   quadLineFit1039->SetParError(1,0.0127527);
   ...
   TH1F *Graph_10dO000000sPppm1039 = new TH1F("Graph_10dO000000sPppm1039","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1039->SetMinimum(1.188392);
   Graph_10dO000000sPppm1039->SetMaximum(1.365238);
   ...
   TF1 *quadLineFit1040 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1040->SetChisquare(4.260717e-18);
   ...
   quadLineFit1040->SetParameter(0,2.066391);
   quadLineFit1040->SetParError(0,0.2191999);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,-0.04603941);
   quadLineFit1040->SetParError(1,0.0127527);
   quadLineFit1040->SetParLimits(1,0,0);
   quadLineFit1040->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1040);
   gre->Draw("p ");
   
   TF1 *quadLineFit1041 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1041->SetChisquare(4.260717e-18);
   ...
   quadLineFit1041->SetParameter(0,2.066391);
   quadLineFit1041->SetParError(0,0.2191999);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,-0.04603941);
   quadLineFit1041->SetParError(1,0.0127527);
   ...
   TH1F *Graph_20dO000000sPppm1041 = new TH1F("Graph_20dO000000sPppm1041","Graph",100,15.77,18.53);
   Graph_20dO000000sPppm1041->SetMinimum(1.767808);
   Graph_20dO000000sPppm1041->SetMaximum(2.129157);
   ...
   TF1 *quadLineFit1042 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1042->SetChisquare(1.302581e-18);
   ...
   quadLineFit1042->SetParameter(0,3.884519);
   quadLineFit1042->SetParError(0,0.2191999);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.1128884);
   quadLineFit1042->SetParError(1,0.0127527);
   quadLineFit1042->SetParLimits(1,0,0);
   quadLineFit1042->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1042);
   gre->Draw("p ");
   
   TF1 *quadLineFit1043 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1043->SetChisquare(1.302581e-18);
   ...
   quadLineFit1043->SetParameter(0,3.884519);
   quadLineFit1043->SetParError(0,0.2191999);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.1128884);
   quadLineFit1043->SetParError(1,0.0127527);
   ...
   TH1F *Graph_30dO000000sPppm1043 = new TH1F("Graph_30dO000000sPppm1043","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1043->SetMinimum(2.427643);
   Graph_30dO000000sPppm1043->SetMaximum(2.937591);
   ...
   quadLineFit1044->SetChisquare(2.114447e-19);
   ...
   quadLineFit1044->SetParameter(0,5.542017);
   quadLineFit1044->SetParError(0,0.2191999);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1667289);
   quadLineFit1044->SetParError(1,0.0127527);
   ...
   quadLineFit1045->SetChisquare(2.114447e-19);
   ...
   quadLineFit1045->SetParameter(0,5.542017);
   quadLineFit1045->SetParError(0,0.2191999);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1667289);
   quadLineFit1045->SetParError(1,0.0127527);
   ...
   TH1F *Graph_40dO000000sPppm1045 = new TH1F("Graph_40dO000000sPppm1045","Graph",100,15.77,18.53);
   Graph_40dO000000sPppm1045->SetMinimum(3.079347);
   Graph_40dO000000sPppm1045->SetMaximum(3.698023);
   ...
   quadLineFit1046->SetChisquare(1.782559e-17);
   ...
   quadLineFit1046->SetParameter(0,6.923695);
   quadLineFit1046->SetParError(0,0.2191999);
   quadLineFit1046->SetParLimits(0,0,0);
   quadLineFit1046->SetParameter(1,-0.206123);
   quadLineFit1046->SetParError(1,0.0127527);
   ...
   quadLineFit1047->SetChisquare(1.782559e-17);
   ...
   quadLineFit1047->SetParameter(0,6.923695);
   quadLineFit1047->SetParError(0,0.2191999);
   quadLineFit1047->SetParLimits(0,0,0);
   quadLineFit1047->SetParameter(1,-0.206123);
   quadLineFit1047->SetParError(1,0.0127527);
   ...
   TH1F *Graph_50dO000000sPppm1047 = new TH1F("Graph_50dO000000sPppm1047","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1047->SetMinimum(3.770533);
   Graph_50dO000000sPppm1047->SetMaximum(4.483638);
   ...
   quadLineFit1048->SetChisquare(3.043365e-18);
   ...
   quadLineFit1048->SetParameter(0,8.248857);
   quadLineFit1048->SetParError(0,0.2191999);
   quadLineFit1048->SetParLimits(0,0,0);
   quadLineFit1048->SetParameter(1,-0.2403365);
   quadLineFit1048->SetParError(1,0.0127527);
   ...
   quadLineFit1049->SetChisquare(3.043365e-18);
   ...
   quadLineFit1049->SetParameter(0,8.248857);
   quadLineFit1049->SetParError(0,0.2191999);
   quadLineFit1049->SetParLimits(0,0,0);
   quadLineFit1049->SetParameter(1,-0.2403365);
   quadLineFit1049->SetParError(1,0.0127527);
