...
//=========  (Fri Oct 16 07:51:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2426181,45,0.1728241);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","Sub-runs 75",100,-36,36);
   Graph_Graph01021->SetMinimum(-0.2010738);
   Graph_Graph01021->SetMaximum(0.1312799);
   ...
   mainFit1022->SetChisquare(7.167827e-21);
   ...
   mainFit1022->SetParError(0,0.007374471);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.004268388);
   mainFit1022->SetParError(1,0.0002458157);
   ...
   pt_LaTex = pt->AddText("#minus0.00427#pm0.000246");
   pt_LaTex = pt->AddText("#minus0.0349#pm0.00737");
   pt_LaTex = pt->AddText("#minus8.18#pm 1.79");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.175679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.175679,-0.2010738,-8.175679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(7.167827e-21);
   ...
   mainFit1023->SetParError(0,0.007374471);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.004268388);
   mainFit1023->SetParError(1,0.0002458157);
