...
//=========  (Fri Oct 16 07:51:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-41.99101,45,58.94882);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","Sub-runs 75",100,-36,36);
   Graph_Graph01023->SetMinimum(-31.89703);
   Graph_Graph01023->SetMaximum(48.85484);
   ...
   checkFit1024->SetChisquare(2.398599e-17);
   ...
   checkFit1024->SetParameter(0,8.478904);
   checkFit1024->SetParError(0,1.791773);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,1.037089);
   checkFit1024->SetParError(1,0.05972575);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0597");
   pt_LaTex = pt->AddText(" 8.48#pm 1.79");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.175679,-31.89703,-8.175679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(2.398599e-17);
   ...
   checkFit1025->SetParameter(0,8.478904);
   checkFit1025->SetParError(0,1.791773);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,1.037089);
   checkFit1025->SetParError(1,0.05972575);
