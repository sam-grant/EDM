...
//=========  (Fri Oct 16 07:51:46 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1041 = new TH1F("Graph_mI30dO000000sPppm1041","",100,15.77,18.53);
   ...
   quadLineFit1042->SetChisquare(1.002533e-17);
   ...
   quadLineFit1042->SetParameter(0,-2.914085);
   quadLineFit1042->SetParError(0,0.1273307);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.07884828);
   ...
   quadLineFit1043->SetChisquare(1.002533e-17);
   ...
   quadLineFit1043->SetParameter(0,-2.914085);
   quadLineFit1043->SetParError(0,0.1273307);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.07884828);
   ...
   Graph_30dO000000sPppm1043->SetMinimum(2.450651);
   Graph_30dO000000sPppm1043->SetMaximum(2.899247);
   ...
   quadLineFit1044->SetChisquare(3.521973e-18);
   ...
   quadLineFit1044->SetParameter(0,5.282751);
   quadLineFit1044->SetParError(0,0.1273307);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1520584);
   ...
   quadLineFit1045->SetChisquare(3.521973e-18);
   ...
   quadLineFit1045->SetParameter(0,5.282751);
   quadLineFit1045->SetParError(0,0.1273307);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1520584);
