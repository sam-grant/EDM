...
//=========  (Thu Oct 15 00:41:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.6458,75,86.72835);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01259->SetMinimum(-53.10839);
   Graph_Graph01259->SetMaximum(71.19094);
   ...
   checkFit1260->SetParameter(0,8.185622);
   checkFit1260->SetParError(0,0.4199408);
   checkFit1260->SetParLimits(0,0,0);
   checkFit1260->SetParameter(1,1.00745);
   checkFit1260->SetParError(1,0.01327969);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0133");
   pt_LaTex = pt->AddText(" 8.19#pm 0.42");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.125087,-53.10839,-8.125087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1261->SetParameter(0,8.185622);
   checkFit1261->SetParError(0,0.4199408);
   checkFit1261->SetParLimits(0,0,0);
   checkFit1261->SetParameter(1,1.00745);
   checkFit1261->SetParError(1,0.01327969);
