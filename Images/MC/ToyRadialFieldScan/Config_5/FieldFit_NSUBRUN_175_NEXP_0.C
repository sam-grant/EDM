...
//=========  (Thu Oct 15 00:41:42 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-0.3599452,75,0.2913744);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","Sub-runs 175",100,-60,60);
   Graph_Graph01179->SetMinimum(-0.2948133);
   Graph_Graph01179->SetMaximum(0.2262424);
   ...
   mainFit1180->SetChisquare(16.77918);
   mainFit1180->SetNDF(9);
   ...
   mainFit1180->SetParameter(0,-0.03695058);
   mainFit1180->SetParError(0,0.002067451);
   mainFit1180->SetParLimits(0,0,0);
   mainFit1180->SetParameter(1,-0.004040069);
   mainFit1180->SetParError(1,6.537856e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.86");
   pt_LaTex = pt->AddText("#minus0.00404#pm6.54e-05");
   pt_LaTex = pt->AddText("#minus0.037#pm0.00207");
   pt_LaTex = pt->AddText("#minus9.15#pm0.533");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.146027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.146027,-0.2948133,-9.146027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1181->SetChisquare(16.77918);
   mainFit1181->SetNDF(9);
   ...
   mainFit1181->SetParameter(0,-0.03695058);
   mainFit1181->SetParError(0,0.002067451);
   mainFit1181->SetParLimits(0,0,0);
   mainFit1181->SetParameter(1,-0.004040069);
   mainFit1181->SetParError(1,6.537856e-05);
