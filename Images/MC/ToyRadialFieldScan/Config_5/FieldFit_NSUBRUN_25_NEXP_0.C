...
//=========  (Thu Oct 15 00:41:30 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3394378,75,0.2943977);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-0.2760542);
   Graph_Graph01023->SetMaximum(0.2310141);
   ...
   mainFit1024->SetParameter(0,-0.03482013);
   mainFit1024->SetParError(0,0.005418016);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,-0.004013954);
   mainFit1024->SetParError(1,0.0001713327);
   ...
   pt_LaTex = pt->AddText("#minus0.00401#pm0.000171");
   pt_LaTex = pt->AddText("#minus0.0348#pm0.00542");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.674771,-0.2760542,-8.674771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetParameter(0,-0.03482013);
   mainFit1025->SetParError(0,0.005418016);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,-0.004013954);
   mainFit1025->SetParError(1,0.0001713327);
