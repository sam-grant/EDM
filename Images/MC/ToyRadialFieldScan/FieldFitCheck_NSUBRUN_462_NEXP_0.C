void FieldFitCheck_NSUBRUN_462_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:39 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01055->SetMinimum(-28);
   Graph_Graph01055->SetMaximum(44);
   ...
   checkFit1056->SetChisquare(3.048279e-18);
   ...
   checkFit1056->SetParameter(0,8);
   checkFit1056->SetParError(0,0.7071068);
   checkFit1056->SetParLimits(0,0,0);
   checkFit1056->SetParameter(1,1);
   checkFit1056->SetParError(1,0.02357023);
...
");
   ...
   checkFit1057->SetChisquare(3.048279e-18);
   ...
   checkFit1057->SetParameter(0,8);
   checkFit1057->SetParError(0,0.7071068);
   checkFit1057->SetParLimits(0,0,0);
   checkFit1057->SetParameter(1,1);
   checkFit1057->SetParError(1,0.02357023);
