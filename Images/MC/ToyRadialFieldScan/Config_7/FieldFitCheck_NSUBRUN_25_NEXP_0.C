...
//=========  (Fri Oct 16 07:53:03 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-72.77933,75,88.72126);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-56.62927);
   Graph_Graph01007->SetMaximum(72.5712);
   ...
   checkFit1008->SetChisquare(7.589816e-19);
   ...
   checkFit1008->SetParameter(0,7.970961);
   checkFit1008->SetParError(0,3.087263);
   checkFit1008->SetParLimits(0,0,0);
   checkFit1008->SetParameter(1,0.9893496);
   checkFit1008->SetParError(1,0.06174526);
   ...
   pt_LaTex = pt->AddText("0.989#pm0.0617");
   pt_LaTex = pt->AddText(" 7.97#pm 3.09");
   pt_LaTex = pt->AddText("#minus8.06#pm 3.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.056769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.056769,-56.62927,-8.056769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(7.589816e-19);
   ...
   checkFit1009->SetParameter(0,7.970961);
   checkFit1009->SetParError(0,3.087263);
   checkFit1009->SetParLimits(0,0,0);
   checkFit1009->SetParameter(1,0.9893496);
   checkFit1009->SetParError(1,0.06174526);
