...
//=========  (Fri Oct 16 07:53:09 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.82911,75,83.94134);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","Sub-runs 225",100,-60,60);
   Graph_Graph01071->SetMinimum(-55.35207);
   Graph_Graph01071->SetMaximum(68.46429);
   ...
   TF1 *checkFit1072 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1072->SetChisquare(5.415931e-17);
   ...
   checkFit1072->SetParameter(0,6.556113);
   checkFit1072->SetParError(0,1.038318);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,1.002435);
   checkFit1072->SetParError(1,0.02076637);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0208");
   pt_LaTex = pt->AddText(" 6.56#pm 1.04");
   pt_LaTex = pt->AddText("#minus6.54#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.540188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.540188,-55.35207,-6.540188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1073 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1073->SetChisquare(5.415931e-17);
   ...
   checkFit1073->SetParameter(0,6.556113);
   checkFit1073->SetParError(0,1.038318);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,1.002435);
   checkFit1073->SetParError(1,0.02076637);
