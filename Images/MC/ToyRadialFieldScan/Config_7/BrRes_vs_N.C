...
//=========  (Fri Oct 16 07:53:13 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.2196154,1.491396e+07,0.1762087);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-0.180033);
   Graph_Graph01107->SetMaximum(0.1366263);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.1366263,1.325685e+07,0.1366263,0,344.5,510,"-");
