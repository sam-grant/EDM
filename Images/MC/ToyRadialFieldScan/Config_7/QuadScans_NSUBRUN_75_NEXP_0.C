...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1017[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1017[2] = {
   -3.165003,
   -2.761423};
   Double_t -50.000000 ppm_fex1017[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1017[2] = {
   0.01696128,
   0.01696128};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1017,-50.000000 ppm_fy1017,-50.000000 ppm_fex1017,-50.000000 ppm_fey1017);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1017 = new TH1F("Graph_mI50dO000000sPppm1017","",100,15.77,18.53);
   ...
   quadLineFit1018->SetChisquare(2.33771e-19);
   ...
   quadLineFit1018->SetParameter(0,-5.972515);
   quadLineFit1018->SetParError(0,0.1792603);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.1754695);
   quadLineFit1018->SetParError(1,0.01042908);
   ...
   quadLineFit1019->SetChisquare(2.33771e-19);
   ...
   quadLineFit1019->SetParameter(0,-5.972515);
   quadLineFit1019->SetParError(0,0.1792603);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.1754695);
   quadLineFit1019->SetParError(1,0.01042908);
   quadLineFit1019->SetParLimits(1,0,0);
   quadLineFit1019->Draw("same");
   
   Double_t 50.000000 ppm_fx1019[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1019[2] = {
   4.370223,
   3.806117};
   Double_t 50.000000 ppm_fex1019[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1019[2] = {
   0.01696128,
   0.01696128};
   gre = new TGraphErrors(2,50.000000 ppm_fx1019,50.000000 ppm_fy1019,50.000000 ppm_fex1019,50.000000 ppm_fey1019);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1019 = new TH1F("Graph_50dO000000sPppm1019","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1019->SetMinimum(3.729353);
   Graph_50dO000000sPppm1019->SetMaximum(4.446987);
   ...
   quadLineFit1020->SetChisquare(2.331436e-18);
   ...
   quadLineFit1020->SetParameter(0,8.294438);
   quadLineFit1020->SetParError(0,0.1792603);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.2452634);
   quadLineFit1020->SetParError(1,0.01042908);
   ...
   quadLineFit1021->SetChisquare(2.331436e-18);
   ...
   quadLineFit1021->SetParameter(0,8.294438);
   quadLineFit1021->SetParError(0,0.1792603);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.2452634);
   quadLineFit1021->SetParError(1,0.01042908);
