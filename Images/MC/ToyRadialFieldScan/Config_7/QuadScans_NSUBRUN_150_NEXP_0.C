...
//=========  (Fri Oct 16 07:53:07 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1041[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1041[2] = {
   -3.158873,
   -2.788198};
   Double_t -50.000000 ppm_fex1041[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1041[2] = {
   0.0120478,
   0.0120478};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1041,-50.000000 ppm_fy1041,-50.000000 ppm_fex1041,-50.000000 ppm_fey1041);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1041 = new TH1F("Graph_mI50dO000000sPppm1041","",100,15.77,18.53);
   ...
   quadLineFit1042->SetChisquare(1.150127e-18);
   ...
   quadLineFit1042->SetParameter(0,-5.737483);
   quadLineFit1042->SetParError(0,0.1273307);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.1611631);
   quadLineFit1042->SetParError(1,0.007407894);
   ...
   quadLineFit1043->SetChisquare(1.150127e-18);
   ...
   quadLineFit1043->SetParameter(0,-5.737483);
   quadLineFit1043->SetParError(0,0.1273307);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.1611631);
   quadLineFit1043->SetParError(1,0.007407894);
   ...
   0.0120478,
   0.0120478};
   gre = new TGraphErrors(2,50.000000 ppm_fx1043,50.000000 ppm_fy1043,50.000000 ppm_fex1043,50.000000 ppm_fey1043);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1043 = new TH1F("Graph_50dO000000sPppm1043","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1043->SetMinimum(3.748755);
   Graph_50dO000000sPppm1043->SetMaximum(4.42454);
   ...
   quadLineFit1044->SetChisquare(8.908304e-17);
   ...
   quadLineFit1044->SetParameter(0,8.106149);
   quadLineFit1044->SetParError(0,0.1273307);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.2343733);
   quadLineFit1044->SetParError(1,0.007407894);
   ...
   quadLineFit1045->SetChisquare(8.908304e-17);
   ...
   quadLineFit1045->SetParameter(0,8.106149);
   quadLineFit1045->SetParError(0,0.1273307);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.2343733);
   quadLineFit1045->SetParError(1,0.007407894);
