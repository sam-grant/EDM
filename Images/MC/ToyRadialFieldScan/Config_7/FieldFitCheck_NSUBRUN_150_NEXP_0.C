...
//=========  (Fri Oct 16 07:53:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.88341,75,83.67125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","Sub-runs 150",100,-60,60);
   Graph_Graph01047->SetMinimum(-50.92794);
   Graph_Graph01047->SetMaximum(68.71579);
   ...
   checkFit1048->SetChisquare(3.300233e-16);
   ...
   checkFit1048->SetParameter(1,0.9610332);
   checkFit1048->SetParError(1,0.02545434);
   ...
   pt_LaTex = pt->AddText("0.961#pm0.0255");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.254542,-50.92794,-9.254542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(3.300233e-16);
   ...
   checkFit1049->SetParameter(1,0.9610332);
   checkFit1049->SetParError(1,0.02545434);
