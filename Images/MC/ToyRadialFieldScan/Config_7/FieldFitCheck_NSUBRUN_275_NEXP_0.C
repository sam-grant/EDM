...
//=========  (Fri Oct 16 07:53:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.18137,75,86.65467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01087->SetMinimum(-53.59776);
   Graph_Graph01087->SetMaximum(71.07106);
   ...
   checkFit1088->SetChisquare(2.250119e-16);
   ...
   checkFit1088->SetParameter(1,1.01235);
   checkFit1088->SetParError(1,0.01877871);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0188");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.63007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.63007,-53.59776,-8.63007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1089->SetChisquare(2.250119e-16);
   ...
   checkFit1089->SetParameter(1,1.01235);
   checkFit1089->SetParError(1,0.01877871);
