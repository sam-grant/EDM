...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3483939,75,0.2758823);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-0.2859663);
   Graph_Graph01013->SetMaximum(0.2134547);
   ...
   mainFit1014->SetChisquare(1.646581e-13);
   ...
   mainFit1014->SetParameter(0,-0.0362558);
   mainFit1014->SetParError(0,0.009017519);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,-0.003906787);
   mainFit1014->SetParError(1,0.0001803504);
   ...
   pt_LaTex = pt->AddText("#minus0.00391#pm0.00018");
   pt_LaTex = pt->AddText("#minus0.0363#pm0.00902");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.280209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.280209,-0.2859663,-9.280209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(1.646581e-13);
   ...
   mainFit1015->SetParameter(0,-0.0362558);
   mainFit1015->SetParError(0,0.009017519);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,-0.003906787);
   mainFit1015->SetParError(1,0.0001803504);
