...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.03102,75,84.64914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","Sub-runs 50",100,-60,60);
   Graph_Graph01015->SetMinimum(-51.863);
   Graph_Graph01015->SetMaximum(69.48112);
   ...
   checkFit1016->SetChisquare(3.176276e-18);
   ...
   checkFit1016->SetParameter(1,0.9492307);
   checkFit1016->SetParError(1,0.04381967);
   ...
   pt_LaTex = pt->AddText("0.949#pm0.0438");
   pt_LaTex = pt->AddText(" 8.81#pm 2.19");
   pt_LaTex = pt->AddText("#minus9.28#pm 2.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.28021,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.28021,-51.863,-9.28021,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(3.176276e-18);
   ...
   checkFit1017->SetParameter(1,0.9492307);
   checkFit1017->SetParError(1,0.04381967);
