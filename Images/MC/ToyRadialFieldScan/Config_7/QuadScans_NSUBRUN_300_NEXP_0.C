...
//=========  (Fri Oct 16 07:53:12 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1089 = new TH1F("Graph_mI50dO000000sPppm1089","",100,15.77,18.53);
   ...
   quadLineFit1090->SetChisquare(2.123842e-18);
   ...
   quadLineFit1090->SetParameter(0,-5.734638);
   quadLineFit1090->SetParError(0,0.08992619);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,0.1614057);
   ...
   quadLineFit1091->SetChisquare(2.123842e-18);
   ...
   quadLineFit1091->SetParameter(0,-5.734638);
   quadLineFit1091->SetParError(0,0.08992619);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,0.1614057);
   ...
   TH1F *Graph_50dO000000sPppm1091 = new TH1F("Graph_50dO000000sPppm1091","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1091->SetMinimum(3.750364);
   Graph_50dO000000sPppm1091->SetMaximum(4.423714);
   ...
   quadLineFit1092->SetChisquare(4.962953e-19);
   ...
   quadLineFit1092->SetParameter(0,8.144191);
   quadLineFit1092->SetParError(0,0.08992619);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.2365686);
   ...
   quadLineFit1093->SetChisquare(4.962953e-19);
   ...
   quadLineFit1093->SetParameter(0,8.144191);
   quadLineFit1093->SetParError(0,0.08992619);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.2365686);
