...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1009 = new TH1F("Graph_mI50dO000000sPppm1009","",100,15.77,18.53);
   ...
   quadLineFit1010->SetChisquare(9.854247e-18);
   ...
   quadLineFit1010->SetParameter(0,-5.694013);
   quadLineFit1010->SetParError(0,0.2191999);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,0.1590836);
   ...
   quadLineFit1011->SetChisquare(9.854247e-18);
   ...
   quadLineFit1011->SetParameter(0,-5.694013);
   quadLineFit1011->SetParError(0,0.2191999);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,0.1590836);
   ...
   TH1F *Graph_50dO000000sPppm1011 = new TH1F("Graph_50dO000000sPppm1011","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1011->SetMinimum(3.782021);
   Graph_50dO000000sPppm1011->SetMaximum(4.471);
   ...
   quadLineFit1012->SetChisquare(5.962068e-18);
   ...
   quadLineFit1012->SetParameter(0,8.098367);
   quadLineFit1012->SetParError(0,0.2191999);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-0.2315952);
   ...
   quadLineFit1013->SetChisquare(5.962068e-18);
   ...
   quadLineFit1013->SetParameter(0,8.098367);
   quadLineFit1013->SetParError(0,0.2191999);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-0.2315952);
