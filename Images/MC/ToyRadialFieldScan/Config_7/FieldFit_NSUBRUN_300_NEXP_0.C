...
//=========  (Fri Oct 16 07:53:12 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3439099,75,0.2687469);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2826442);
   Graph_Graph01093->SetMaximum(0.2074812);
   ...
   mainFit1094->SetChisquare(1.482184e-12);
   ...
   mainFit1094->SetParameter(0,-0.03758148);
   mainFit1094->SetParError(0,0.003699414);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.003979743);
   mainFit1094->SetParError(1,7.398827e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00398#pm7.4e-05");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.443194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.443194,-0.2826442,-9.443194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(1.482184e-12);
   ...
   mainFit1095->SetParameter(0,-0.03758148);
   mainFit1095->SetParError(0,0.003699414);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.003979743);
   mainFit1095->SetParError(1,7.398827e-05);
