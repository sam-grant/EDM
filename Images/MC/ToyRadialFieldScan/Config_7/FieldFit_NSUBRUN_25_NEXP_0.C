...
//=========  (Fri Oct 16 07:53:03 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3651537,75,0.2995409);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01005->SetMinimum(-0.2986842);
   Graph_Graph01005->SetMaximum(0.2330714);
   ...
   mainFit1006->SetChisquare(2.516549e-14);
   ...
   mainFit1006->SetParameter(1,-0.004071906);
   mainFit1006->SetParError(1,0.0002541275);
   ...
   pt_LaTex = pt->AddText("#minus0.00407#pm0.000254");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.056768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.056768,-0.2986842,-8.056768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(2.516549e-14);
   ...
   mainFit1007->SetParameter(1,-0.004071906);
   mainFit1007->SetParError(1,0.0002541275);
