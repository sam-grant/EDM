...
//=========  (Fri Oct 16 07:53:09 2020) by ROOT version 6.22/02
   ...
   0.009828933,
   0.009828933};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1065,-50.000000 ppm_fy1065,-50.000000 ppm_fex1065,-50.000000 ppm_fey1065);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1065 = new TH1F("Graph_mI50dO000000sPppm1065","",100,15.77,18.53);
   ...
   quadLineFit1066->SetChisquare(8.207921e-17);
   ...
   quadLineFit1066->SetParameter(0,-6.054524);
   quadLineFit1066->SetParError(0,0.10388);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,0.1793049);
   quadLineFit1066->SetParError(1,0.00604357);
   ...
   quadLineFit1067->SetChisquare(8.207921e-17);
   ...
   quadLineFit1067->SetParameter(0,-6.054524);
   quadLineFit1067->SetParError(0,0.10388);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,0.1793049);
   quadLineFit1067->SetParError(1,0.00604357);
   quadLineFit1067->SetParLimits(1,0,0);
   quadLineFit1067->Draw("same");
   
   Double_t 50.000000 ppm_fx1067[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1067[2] = {
   4.360489,
   3.823964};
   Double_t 50.000000 ppm_fex1067[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1067[2] = {
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(2,50.000000 ppm_fx1067,50.000000 ppm_fy1067,50.000000 ppm_fex1067,50.000000 ppm_fey1067);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1067 = new TH1F("Graph_50dO000000sPppm1067","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1067->SetMinimum(3.758517);
   Graph_50dO000000sPppm1067->SetMaximum(4.425936);
   ...
   quadLineFit1068->SetChisquare(2.9489e-16);
   ...
   quadLineFit1068->SetParameter(0,8.092831);
   quadLineFit1068->SetParError(0,0.10388);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.2332714);
   quadLineFit1068->SetParError(1,0.00604357);
   ...
   quadLineFit1069->SetChisquare(2.9489e-16);
   ...
   quadLineFit1069->SetParameter(0,8.092831);
   quadLineFit1069->SetParError(0,0.10388);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.2332714);
   quadLineFit1069->SetParError(1,0.00604357);
