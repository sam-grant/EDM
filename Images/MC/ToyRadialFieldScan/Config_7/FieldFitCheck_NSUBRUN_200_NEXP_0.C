...
//=========  (Fri Oct 16 07:53:08 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.43378,75,84.80477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-54.00992);
   Graph_Graph01063->SetMaximum(69.38092);
   ...
   checkFit1064->SetChisquare(1.760799e-17);
   ...
   checkFit1064->SetParameter(1,0.9971004);
   checkFit1064->SetParError(1,0.02203103);
   ...
   pt_LaTex = pt->AddText("0.997#pm0.022");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.707849,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.707849,-54.00992,-7.707849,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(1.760799e-17);
   ...
   checkFit1065->SetParameter(1,0.9971004);
   checkFit1065->SetParError(1,0.02203103);
