...
//=========  (Fri Oct 16 07:53:09 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3454808,75,0.2915143);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.2817813);
   Graph_Graph01069->SetMaximum(0.2278148);
   ...
   mainFit1070->SetChisquare(3.847604e-13);
   ...
   mainFit1070->SetParameter(1,-0.004125762);
   mainFit1070->SetParError(1,8.546898e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00413#pm8.55e-05");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.540189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.540189,-0.2817813,-6.540189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(3.847604e-13);
   ...
   mainFit1071->SetParameter(1,-0.004125762);
   mainFit1071->SetParError(1,8.546898e-05);
