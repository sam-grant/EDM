...
//=========  (Fri Oct 16 07:53:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3566481,75,0.2847326);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01085->SetMinimum(-0.2925101);
   Graph_Graph01085->SetMaximum(0.2205945);
   ...
   mainFit1086->SetChisquare(5.64989e-13);
   ...
   mainFit1086->SetParameter(0,-0.03595779);
   mainFit1086->SetParError(0,0.003864416);
   mainFit1086->SetParLimits(0,0,0);
   mainFit1086->SetParameter(1,-0.004166569);
   mainFit1086->SetParError(1,7.728831e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00417#pm7.73e-05");
   pt_LaTex = pt->AddText("#minus0.036#pm0.00386");
   pt_LaTex = pt->AddText("#minus8.63#pm0.941");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.630071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.630071,-0.2925101,-8.630071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1087->SetChisquare(5.64989e-13);
   ...
   mainFit1087->SetParameter(0,-0.03595779);
   mainFit1087->SetParError(0,0.003864416);
   mainFit1087->SetParLimits(0,0,0);
   mainFit1087->SetParameter(1,-0.004166569);
   mainFit1087->SetParError(1,7.728831e-05);
