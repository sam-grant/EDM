...
//=========  (Fri Oct 16 07:53:05 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1025 = new TH1F("Graph_mI50dO000000sPppm1025","",100,15.77,18.53);
   ...
   quadLineFit1026->SetChisquare(3.737881e-20);
   ...
   quadLineFit1026->SetParameter(0,-5.708541);
   quadLineFit1026->SetParError(0,0.1561401);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.1609469);
   ...
   quadLineFit1027->SetChisquare(3.737881e-20);
   ...
   quadLineFit1027->SetParameter(0,-5.708541);
   quadLineFit1027->SetParError(0,0.1561401);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.1609469);
   ...
   TH1F *Graph_50dO000000sPppm1027 = new TH1F("Graph_50dO000000sPppm1027","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1027->SetMinimum(3.746667);
   Graph_50dO000000sPppm1027->SetMaximum(4.450629);
   ...
   quadLineFit1028->SetChisquare(2.750674e-18);
   ...
   quadLineFit1028->SetParameter(0,8.252581);
   quadLineFit1028->SetParError(0,0.1561401);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.2422118);
   ...
   quadLineFit1029->SetChisquare(2.750674e-18);
   ...
   quadLineFit1029->SetParameter(0,8.252581);
   quadLineFit1029->SetParError(0,0.1561401);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.2422118);
