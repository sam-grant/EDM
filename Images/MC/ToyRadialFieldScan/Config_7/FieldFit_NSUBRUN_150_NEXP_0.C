...
//=========  (Fri Oct 16 07:53:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3443692,75,0.271159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.2828164);
   Graph_Graph01045->SetMaximum(0.2096062);
   ...
   mainFit1046->SetChisquare(2.120471e-15);
   ...
   mainFit1046->SetParameter(1,-0.003955363);
   mainFit1046->SetParError(1,0.0001047634);
   ...
   pt_LaTex = pt->AddText("#minus0.00396#pm0.000105");
   pt_LaTex = pt->AddText("#minus0.0366#pm0.00524");
   pt_LaTex = pt->AddText("#minus9.25#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.254542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.254542,-0.2828164,-9.254542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(2.120471e-15);
   ...
   mainFit1047->SetParameter(1,-0.003955363);
   mainFit1047->SetParError(1,0.0001047634);
