...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.99101,75,88.94882);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-55.89703);
   Graph_Graph01023->SetMaximum(72.85484);
   ...
   checkFit1024->SetChisquare(1.193923e-16);
   ...
   checkFit1024->SetParameter(1,1.022253);
   checkFit1024->SetParError(1,0.03583545);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0358");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.294329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.294329,-55.89703,-8.294329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(1.193923e-16);
   ...
   checkFit1025->SetParameter(1,1.022253);
   checkFit1025->SetParError(1,0.03583545);
