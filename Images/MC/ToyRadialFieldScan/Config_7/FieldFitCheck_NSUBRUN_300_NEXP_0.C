...
//=========  (Fri Oct 16 07:53:12 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.29733,75,83.55965);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-50.41163);
   Graph_Graph01095->SetMaximum(68.67395);
   ...
   checkFit1096->SetChisquare(1.311175e-16);
   ...
   checkFit1096->SetParameter(0,9.13116);
   checkFit1096->SetParError(0,0.8988451);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9669567);
   checkFit1096->SetParError(1,0.0179769);
   ...
   pt_LaTex = pt->AddText("0.967#pm0.018");
   pt_LaTex = pt->AddText(" 9.13#pm0.899");
   pt_LaTex = pt->AddText("#minus9.44#pm0.946");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.443195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.443195,-50.41163,-9.443195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(1.311175e-16);
   ...
   checkFit1097->SetParameter(0,9.13116);
   checkFit1097->SetParError(0,0.8988451);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9669567);
   checkFit1097->SetParError(1,0.0179769);
