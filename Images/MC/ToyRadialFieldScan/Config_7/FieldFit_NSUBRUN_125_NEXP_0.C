...
//=========  (Fri Oct 16 07:53:06 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3428631,75,0.2770468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(-0.2808721);
   Graph_Graph01037->SetMaximum(0.2150558);
   ...
   mainFit1038->SetChisquare(5.562031e-14);
   ...
   mainFit1038->SetParError(0,0.005740647);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,-0.003970363);
   mainFit1038->SetParError(1,0.0001148129);
   ...
   pt_LaTex = pt->AddText("#minus0.00397#pm0.000115");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.288454,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.288454,-0.2808721,-8.288454,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1039->SetChisquare(5.562031e-14);
   ...
   mainFit1039->SetParError(0,0.005740647);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,-0.003970363);
   mainFit1039->SetParError(1,0.0001148129);
