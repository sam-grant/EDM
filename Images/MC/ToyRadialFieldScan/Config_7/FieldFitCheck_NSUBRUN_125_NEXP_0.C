...
//=========  (Fri Oct 16 07:53:06 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.31395,75,83.30533);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","Sub-runs 125",100,-60,60);
   Graph_Graph01039->SetMinimum(-52.25202);
   Graph_Graph01039->SetMaximum(68.2434);
   ...
   TF1 *checkFit1040 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1040->SetChisquare(1.225181e-17);
   ...
   checkFit1040->SetParameter(0,7.995686);
   checkFit1040->SetParError(0,1.394803);
   checkFit1040->SetParLimits(0,0,0);
   checkFit1040->SetParameter(1,0.9646775);
   checkFit1040->SetParError(1,0.02789606);
   ...
   pt_LaTex = pt->AddText("0.965#pm0.0279");
   pt_LaTex = pt->AddText("    8#pm 1.39");
   pt_LaTex = pt->AddText("#minus8.29#pm 1.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.288455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.288455,-52.25202,-8.288455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1041 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1041->SetChisquare(1.225181e-17);
   ...
   checkFit1041->SetParameter(0,7.995686);
   checkFit1041->SetParError(0,1.394803);
   checkFit1041->SetParLimits(0,0,0);
   checkFit1041->SetParameter(1,0.9646775);
   checkFit1041->SetParError(1,0.02789606);
