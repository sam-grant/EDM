...
//=========  (Fri Oct 16 07:53:10 2020) by ROOT version 6.22/02
   ...
   0.009322777,
   0.009322777};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1073,-50.000000 ppm_fy1073,-50.000000 ppm_fex1073,-50.000000 ppm_fey1073);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1073 = new TH1F("Graph_mI50dO000000sPppm1073","",100,15.77,18.53);
   Graph_mI50dO000000sPppm1073->SetMinimum(-2.5);
   Graph_mI50dO000000sPppm1073->SetMaximum(3.5);
   Graph_mI50dO000000sPppm1073->SetDirectory(0);
   Graph_mI50dO000000sPppm1073->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   Graph_mI50dO000000sPppm1073->SetLineColor(ci);
   Graph_mI50dO000000sPppm1073->GetXaxis()->SetTitle("QHV [kV]");
   Graph_mI50dO000000sPppm1073->GetXaxis()->CenterTitle(true);
   Graph_mI50dO000000sPppm1073->GetXaxis()->SetLabelFont(42);
   Graph_mI50dO000000sPppm1073->GetXaxis()->SetTitleSize(0.04);
   Graph_mI50dO000000sPppm1073->GetXaxis()->SetTitleOffset(1.1);
   Graph_mI50dO000000sPppm1073->GetXaxis()->SetTitleFont(42);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetTitle("#LTy#GT [mm]");
   Graph_mI50dO000000sPppm1073->GetYaxis()->CenterTitle(true);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetNdivisions(4000510);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetLabelFont(42);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetTitleSize(0.04);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetTitleOffset(1.1);
   Graph_mI50dO000000sPppm1073->GetYaxis()->SetTitleFont(42);
   Graph_mI50dO000000sPppm1073->GetZaxis()->SetLabelFont(42);
   Graph_mI50dO000000sPppm1073->GetZaxis()->SetTitleOffset(1);
   Graph_mI50dO000000sPppm1073->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_-50.000000 ppm1073);
   ...
   quadLineFit1074->SetChisquare(6.119258e-21);
   ...
   quadLineFit1074->SetParameter(0,-5.865778);
   quadLineFit1074->SetParError(0,0.09853052);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.1694913);
   ...
   quadLineFit1075->SetChisquare(6.119258e-21);
   ...
   quadLineFit1075->SetParameter(0,-5.865778);
   quadLineFit1075->SetParError(0,0.09853052);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.1694913);
   quadLineFit1075->SetParError(1,0.005732347);
   quadLineFit1075->SetParLimits(1,0,0);
   quadLineFit1075->Draw("same");
   
   Double_t 50.000000 ppm_fx1075[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1075[2] = {
   4.362077,
   3.809656};
   Double_t 50.000000 ppm_fex1075[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1075[2] = {
   0.009322777,
   0.009322777};
   gre = new TGraphErrors(2,50.000000 ppm_fx1075,50.000000 ppm_fy1075,50.000000 ppm_fex1075,50.000000 ppm_fey1075);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1075 = new TH1F("Graph_50dO000000sPppm1075","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1075->SetMinimum(3.743227);
   Graph_50dO000000sPppm1075->SetMaximum(4.428507);
   ...
   quadLineFit1076->SetChisquare(1.873973e-19);
   ...
   quadLineFit1076->SetParameter(0,8.205006);
   quadLineFit1076->SetParError(0,0.09853052);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.2401831);
   ...
   quadLineFit1077->SetChisquare(1.873973e-19);
   ...
   quadLineFit1077->SetParameter(0,8.205006);
   quadLineFit1077->SetParError(0,0.09853052);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.2401831);
