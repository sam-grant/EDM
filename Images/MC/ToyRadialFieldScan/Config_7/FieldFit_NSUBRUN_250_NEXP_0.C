...
//=========  (Fri Oct 16 07:53:10 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3512002,75,0.2805085);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-0.2880293);
   Graph_Graph01077->SetMaximum(0.2173376);
   ...
   mainFit1078->SetChisquare(6.213122e-15);
   ...
   mainFit1078->SetParameter(0,-0.03534587);
   mainFit1078->SetParError(0,0.004053381);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,-0.004096744);
   mainFit1078->SetParError(1,8.106763e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0041#pm8.11e-05");
   pt_LaTex = pt->AddText("#minus0.0353#pm0.00405");
   pt_LaTex = pt->AddText("#minus8.63#pm    1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.627795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.627795,-0.2880293,-8.627795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(6.213122e-15);
   ...
   mainFit1079->SetParameter(0,-0.03534587);
   mainFit1079->SetParError(0,0.004053381);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,-0.004096744);
   mainFit1079->SetParError(1,8.106763e-05);
