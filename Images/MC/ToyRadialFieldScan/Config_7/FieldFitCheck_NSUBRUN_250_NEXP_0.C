...
//=========  (Fri Oct 16 07:53:10 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.15504,75,85.33098);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-52.80644);
   Graph_Graph01079->SetMaximum(69.98238);
   ...
   checkFit1080->SetChisquare(2.214876e-16);
   ...
   checkFit1080->SetParameter(1,0.9953844);
   checkFit1080->SetParError(1,0.01969697);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.0197");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.627795,-52.80644,-8.627795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(2.214876e-16);
   ...
   checkFit1081->SetParameter(1,0.9953844);
   checkFit1081->SetParError(1,0.01969697);
