...
//=========  (Fri Oct 16 07:53:08 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3490345,75,0.2857714);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-0.2855539);
   Graph_Graph01061->SetMaximum(0.2222908);
   ...
   mainFit1062->SetChisquare(3.26415e-12);
   ...
   mainFit1062->SetParameter(0,-0.03163153);
   mainFit1062->SetParError(0,0.004533701);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,-0.004103807);
   mainFit1062->SetParError(1,9.067402e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0041#pm9.07e-05");
   pt_LaTex = pt->AddText("#minus0.0316#pm0.00453");
   pt_LaTex = pt->AddText("#minus7.71#pm 1.12");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.707851,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.707851,-0.2855539,-7.707851,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(3.26415e-12);
   ...
   mainFit1063->SetParameter(0,-0.03163153);
   mainFit1063->SetParError(0,0.004533701);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,-0.004103807);
   mainFit1063->SetParError(1,9.067402e-05);
