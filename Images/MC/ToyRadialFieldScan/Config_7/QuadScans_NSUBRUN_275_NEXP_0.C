...
//=========  (Fri Oct 16 07:53:11 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1081 = new TH1F("Graph_mI50dO000000sPppm1081","",100,15.77,18.53);
   ...
   quadLineFit1082->SetChisquare(1.131246e-18);
   ...
   quadLineFit1082->SetParameter(0,-5.917846);
   quadLineFit1082->SetParError(0,0.0939371);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.1723707);
   ...
   quadLineFit1083->SetChisquare(1.131246e-18);
   ...
   quadLineFit1083->SetParameter(0,-5.917846);
   quadLineFit1083->SetParError(0,0.0939371);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.1723707);
   ...
   TH1F *Graph_50dO000000sPppm1083 = new TH1F("Graph_50dO000000sPppm1083","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1083->SetMinimum(3.744566);
   Graph_50dO000000sPppm1083->SetMaximum(4.440128);
   ...
   quadLineFit1084->SetChisquare(3.044775e-18);
   ...
   quadLineFit1084->SetParameter(0,8.281856);
   quadLineFit1084->SetParError(0,0.0939371);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,-0.2442862);
   ...
   quadLineFit1085->SetChisquare(3.044775e-18);
   ...
   quadLineFit1085->SetParameter(0,8.281856);
   quadLineFit1085->SetParError(0,0.0939371);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,-0.2442862);
