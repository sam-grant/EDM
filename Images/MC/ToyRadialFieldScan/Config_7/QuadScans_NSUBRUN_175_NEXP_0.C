...
//=========  (Fri Oct 16 07:53:07 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1049 = new TH1F("Graph_mI50dO000000sPppm1049","",100,15.77,18.53);
   ...
   quadLineFit1050->SetChisquare(2.734722e-19);
   ...
   quadLineFit1050->SetParameter(0,-6.013753);
   quadLineFit1050->SetParError(0,0.117861);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.1774482);
   ...
   quadLineFit1051->SetChisquare(2.734722e-19);
   ...
   quadLineFit1051->SetParameter(0,-6.013753);
   quadLineFit1051->SetParError(0,0.117861);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.1774482);
   ...
   Graph_50dO000000sPppm1051->SetMinimum(3.725132);
   Graph_50dO000000sPppm1051->SetMaximum(4.451031);
   ...
   quadLineFit1052->SetChisquare(7.06098e-18);
   ...
   quadLineFit1052->SetParameter(0,8.432341);
   quadLineFit1052->SetParError(0,0.117861);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,-0.2533096);
   ...
   quadLineFit1053->SetChisquare(7.06098e-18);
   ...
   quadLineFit1053->SetParameter(0,8.432341);
   quadLineFit1053->SetParError(0,0.117861);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,-0.2533096);
