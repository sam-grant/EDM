...
//=========  (Fri Oct 16 07:53:06 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1033[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1033[2] = {
   -3.141937,
   -2.761034};
   Double_t -50.000000 ppm_fex1033[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1033[2] = {
   0.01320349,
   0.01320349};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1033,-50.000000 ppm_fy1033,-50.000000 ppm_fex1033,-50.000000 ppm_fey1033);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1033 = new TH1F("Graph_mI50dO000000sPppm1033","",100,15.77,18.53);
   ...
   quadLineFit1034->SetChisquare(8.171929e-20);
   ...
   quadLineFit1034->SetParameter(0,-5.791696);
   quadLineFit1034->SetParError(0,0.139545);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.16561);
   ...
   quadLineFit1035->SetChisquare(8.171929e-20);
   ...
   quadLineFit1035->SetParameter(0,-5.791696);
   quadLineFit1035->SetParError(0,0.139545);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.16561);
   quadLineFit1035->SetParError(1,0.0081185);
   quadLineFit1035->SetParLimits(1,0,0);
   quadLineFit1035->Draw("same");
   
   Double_t 50.000000 ppm_fx1035[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1035[2] = {
   4.365977,
   3.833696};
   Double_t 50.000000 ppm_fex1035[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1035[2] = {
   0.01320349,
   0.01320349};
   gre = new TGraphErrors(2,50.000000 ppm_fx1035,50.000000 ppm_fy1035,50.000000 ppm_fex1035,50.000000 ppm_fey1035);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1035 = new TH1F("Graph_50dO000000sPppm1035","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1035->SetMinimum(3.764624);
   Graph_50dO000000sPppm1035->SetMaximum(4.435049);
   ...
   quadLineFit1036->SetChisquare(8.576915e-20);
   ...
   quadLineFit1036->SetParameter(0,8.068797);
   quadLineFit1036->SetParError(0,0.139545);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.2314263);
   ...
   quadLineFit1037->SetChisquare(8.576915e-20);
   ...
   quadLineFit1037->SetParameter(0,8.068797);
   quadLineFit1037->SetParError(0,0.139545);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.2314263);
