...
//=========  (Fri Oct 16 07:53:05 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.90473,75,86.64965);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.54929);
   Graph_Graph01031->SetMaximum(71.29421);
   ...
   checkFit1032->SetChisquare(3.427187e-17);
   ...
   checkFit1032->SetParameter(1,0.9795533);
   checkFit1032->SetParError(1,0.03121354);
   ...
   pt_LaTex = pt->AddText(" 0.98#pm0.0312");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.07853,-51.54929,-10.07853,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(3.427187e-17);
   ...
   checkFit1033->SetParameter(1,0.9795533);
   checkFit1033->SetParError(1,0.03121354);
