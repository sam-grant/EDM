...
//=========  (Fri Oct 16 07:53:04 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3660903,75,0.2962963);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","Sub-runs 75",100,-60,60);
   Graph_Graph01021->SetMinimum(-0.2998516);
   Graph_Graph01021->SetMaximum(0.2300577);
   ...
   mainFit1022->SetChisquare(7.789124e-14);
   ...
   mainFit1022->SetParameter(0,-0.03489697);
   mainFit1022->SetParError(0,0.007374472);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.004207329);
   mainFit1022->SetParError(1,0.0001474894);
   ...
   pt_LaTex = pt->AddText("#minus0.00421#pm0.000147");
   pt_LaTex = pt->AddText("#minus0.0349#pm0.00737");
   pt_LaTex = pt->AddText("#minus8.29#pm 1.78");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.294328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.294328,-0.2998516,-8.294328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *mainFit1023 = new TF1("mainFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   mainFit1023->SetChisquare(7.789124e-14);
   ...
   mainFit1023->SetParameter(0,-0.03489697);
   mainFit1023->SetParError(0,0.007374472);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.004207329);
   mainFit1023->SetParError(1,0.0001474894);
