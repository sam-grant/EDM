...
//=========  (Fri Oct 16 07:53:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3712845,75,0.2954231);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.3046137);
   Graph_Graph01053->SetMaximum(0.2287523);
   ...
   mainFit1054->SetChisquare(9.13535e-14);
   ...
   mainFit1054->SetParError(0,0.004848604);
   mainFit1054->SetParLimits(0,0,0);
   mainFit1054->SetParameter(1,-0.004307578);
   mainFit1054->SetParError(1,9.697207e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00431#pm9.7e-05");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.805573,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.805573,-0.3046137,-8.805573,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1055->SetChisquare(9.13535e-14);
   ...
   mainFit1055->SetParError(0,0.004848604);
   mainFit1055->SetParLimits(0,0,0);
   mainFit1055->SetParameter(1,-0.004307578);
   mainFit1055->SetParError(1,9.697207e-05);
