...
//=========  (Wed Jan  5 17:06:49 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-49.07768,45,68.32376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01005->SetMinimum(-37.33754);
   Graph_Graph01005->SetMaximum(56.58361);
   ...
   mainFit1006->SetChisquare(5.745151e-15);
   ...
   mainFit1006->SetParameter(1,1.215892);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.914389,-37.33754,-7.914389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(5.745151e-15);
   ...
   mainFit1007->SetParameter(1,1.215892);
