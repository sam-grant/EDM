...
//=========  (Thu May  5 12:48:32 2022) by ROOT version 6.24/06
   ...
   c->Range(-75,-79.30928,75,99.32201);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-61.44615);
   Graph_Graph01013->SetMaximum(81.45888);
   ...
   mainFit1014->SetChisquare(6.459965);
   ...
   mainFit1014->SetParameter(0,9.468006);
   mainFit1014->SetParError(0,0.8821594);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,1.189366);
   mainFit1014->SetParError(1,0.02782985);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.960546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.960546,-61.44615,-7.960546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(6.459965);
   ...
   mainFit1015->SetParameter(0,9.468006);
   mainFit1015->SetParError(0,0.8821594);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,1.189366);
   mainFit1015->SetParError(1,0.02782985);
