...
//=========  (Fri Oct  9 18:32:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2095781,45,0.1386322);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.1747571);
   Graph_Graph01009->SetMaximum(0.1038112);
   ...
   fieldLineFit1010->SetChisquare(8.064521);
   ...
   fieldLineFit1010->SetParameter(0,-0.03130841);
   fieldLineFit1010->SetParError(0,0.005166239);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.003734296);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.03");
   pt_LaTex = pt->AddText("#minus0.00373#pm0.000231");
   pt_LaTex = pt->AddText("-0.0313#pm0.00517");
   pt_LaTex = pt->AddText("-8.38#pm 1.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.38402,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.38402,-0.1747571,-8.38402,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1011->SetChisquare(8.064521);
   ...
   fieldLineFit1011->SetParameter(0,-0.03130841);
   fieldLineFit1011->SetParError(0,0.005166239);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.003734296);
