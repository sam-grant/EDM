void FieldFitCheck_NSUBRUN_80_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:16 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-39.25012,45,54.75676);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-29.84944);
   Graph_Graph01063->SetMaximum(45.35607);
   ...
   checkFit1064->SetChisquare(8.559258e-17);
   ...
   checkFit1064->SetParameter(0,7.753316);
   checkFit1064->SetParError(0,0.8640201);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,1.003791);
   checkFit1064->SetParError(1,0.02880067);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.724038,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.724038,-29.84944,-7.724038,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(8.559258e-17);
   ...
   checkFit1065->SetParameter(0,7.753316);
   checkFit1065->SetParError(0,0.8640201);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,1.003791);
   checkFit1065->SetParError(1,0.02880067);
