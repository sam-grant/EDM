...
//=========  (Thu May  5 12:48:59 2022) by ROOT version 6.24/06
   ...
   c->Range(0.04836538,-5.23677,0.0663141,7.517273);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1161->SetMinimum(-3.961365);
   Graph_mI50dO000000sPppm1161->SetMaximum(6.241869);
   ...
   quadLineFit1162->SetChisquare(0.0004135612);
   ...
   quadLineFit1162->SetParameter(0,0.09659614);
   quadLineFit1162->SetParError(0,0.06298007);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,-52.25191);
   quadLineFit1162->SetParError(1,1.112037);
   ...
   quadLineFit1163->SetChisquare(0.0004135612);
   ...
   quadLineFit1163->SetParameter(0,0.09659614);
   quadLineFit1163->SetParError(0,0.06298007);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,-52.25191);
   quadLineFit1163->SetParError(1,1.112037);
   ...
   Graph_mI30dO000000sPppm1163->SetMinimum(-1.956765);
   Graph_mI30dO000000sPppm1163->SetMaximum(-1.278621);
   ...
   quadLineFit1164->SetChisquare(0.4064702);
   ...
   quadLineFit1164->SetParameter(0,0.03966283);
   quadLineFit1164->SetParError(0,0.03543243);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,-27.02561);
   quadLineFit1164->SetParError(1,0.5839958);
   ...
   quadLineFit1165->SetChisquare(0.4064702);
   ...
   quadLineFit1165->SetParameter(0,0.03966283);
   quadLineFit1165->SetParError(0,0.03543243);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,-27.02561);
   quadLineFit1165->SetParError(1,0.5839958);
   ...
   Graph_mI10dO000000sPppm1165->SetMinimum(-0.1782103);
   Graph_mI10dO000000sPppm1165->SetMaximum(-0.1095578);
   ...
   quadLineFit1166->SetChisquare(1.34984);
   ...
   quadLineFit1166->SetParameter(0,-0.01668952);
   quadLineFit1166->SetParError(0,0.03542711);
   quadLineFit1166->SetParLimits(0,0,0);
   quadLineFit1166->SetParameter(1,-2.075812);
   quadLineFit1166->SetParError(1,0.5839091);
   ...
   quadLineFit1167->SetChisquare(1.34984);
   ...
   quadLineFit1167->SetParameter(0,-0.01668952);
   quadLineFit1167->SetParError(0,0.03542711);
   quadLineFit1167->SetParLimits(0,0,0);
   quadLineFit1167->SetParameter(1,-2.075812);
   quadLineFit1167->SetParError(1,0.5839091);
   ...
   Graph_10dO000000sPppm1167->SetMinimum(1.067834);
   Graph_10dO000000sPppm1167->SetMaximum(1.608912);
   ...
   quadLineFit1168->SetChisquare(1.471705);
   ...
   quadLineFit1168->SetParameter(0,0.01806221);
   quadLineFit1168->SetParError(0,0.03884701);
   quadLineFit1168->SetParLimits(0,0,0);
   quadLineFit1168->SetParameter(1,21.44737);
   quadLineFit1168->SetParError(1,0.6237011);
   ...
   quadLineFit1169->SetChisquare(1.471705);
   ...
   quadLineFit1169->SetParameter(0,0.01806221);
   quadLineFit1169->SetParError(0,0.03884701);
   quadLineFit1169->SetParLimits(0,0,0);
   quadLineFit1169->SetParameter(1,21.44737);
   quadLineFit1169->SetParError(1,0.6237011);
   ...
   Graph_30dO000000sPppm1169->SetMinimum(2.245107);
   Graph_30dO000000sPppm1169->SetMaximum(3.376072);
   ...
   quadLineFit1170->SetChisquare(0.4129238);
   ...
   quadLineFit1170->SetParameter(0,-0.009810034);
   quadLineFit1170->SetParError(0,0.03542249);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,45.98867);
   quadLineFit1170->SetParError(1,0.5838325);
   ...
   quadLineFit1171->SetChisquare(0.4129238);
   ...
   quadLineFit1171->SetParameter(0,-0.009810034);
   quadLineFit1171->SetParError(0,0.03542249);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,45.98867);
   quadLineFit1171->SetParError(1,0.5838325);
   ...
   Graph_50dO000000sPppm1171->SetMinimum(3.421839);
   Graph_50dO000000sPppm1171->SetMaximum(5.146087);
   ...
   quadLineFit1172->SetChisquare(0.9850208);
   ...
   quadLineFit1172->SetParameter(0,-0.04597022);
   quadLineFit1172->SetParError(0,0.03543269);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,70.59602);
   quadLineFit1172->SetParError(1,0.5840003);
   ...
   quadLineFit1173->SetChisquare(0.9850208);
   ...
   quadLineFit1173->SetParameter(0,-0.04597022);
   quadLineFit1173->SetParError(0,0.03543269);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,70.59602);
   quadLineFit1173->SetParError(1,0.5840003);
