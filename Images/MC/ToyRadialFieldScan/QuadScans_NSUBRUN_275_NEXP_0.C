...
//=========  (Fri Oct  9 19:09:42 2020) by ROOT version 6.22/02
   ...
   quadLineFit1102->SetChisquare(1.893275e-19);
   ...
   quadLineFit1102->SetParameter(0,-3.070977);
   quadLineFit1102->SetParError(0,0.05691197);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,0.08747581);
   ...
   quadLineFit1103->SetChisquare(1.893275e-19);
   ...
   quadLineFit1103->SetParameter(0,-3.070977);
   quadLineFit1103->SetParError(0,0.05691197);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,0.08747581);
   ...
   Graph_mI10dO000000sPppm1103->SetMinimum(-0.175754);
   Graph_mI10dO000000sPppm1103->SetMaximum(-0.1009492);
   ...
   quadLineFit1104->SetChisquare(3.80635e-20);
   ...
   quadLineFit1104->SetParameter(0,-0.338876);
   quadLineFit1104->SetParError(0,0.05691197);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,0.01114024);
   ...
   quadLineFit1105->SetChisquare(3.80635e-20);
   ...
   quadLineFit1105->SetParameter(0,-0.338876);
   quadLineFit1105->SetParError(0,0.05691197);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,0.01114024);
   ...
   Graph_10dO000000sPppm1105->SetMinimum(1.027301);
   Graph_10dO000000sPppm1105->SetMaximum(1.393603);
   ...
   quadLineFit1106->SetChisquare(4.575678e-20);
   ...
   quadLineFit1106->SetParameter(0,2.504093);
   quadLineFit1106->SetParError(0,0.05691197);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,-0.07186896);
   ...
   quadLineFit1107->SetChisquare(4.575678e-20);
   ...
   quadLineFit1107->SetParameter(0,2.504093);
   quadLineFit1107->SetParError(0,0.05691197);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,-0.07186896);
   ...
   Graph_30dO000000sPppm1107->SetMinimum(2.227211);
   Graph_30dO000000sPppm1107->SetMaximum(2.919617);
   ...
   quadLineFit1108->SetChisquare(1.030246e-22);
   ...
   quadLineFit1108->SetParameter(0,5.089944);
   quadLineFit1108->SetParError(0,0.05691197);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,-0.1398072);
   ...
   quadLineFit1109->SetChisquare(1.030246e-22);
   ...
   quadLineFit1109->SetParameter(0,5.089944);
   quadLineFit1109->SetParError(0,0.05691197);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,-0.1398072);
