...
//=========  (Mon Oct 12 12:24:48 2020) by ROOT version 6.22/02
   ...
   quadLineFit1102->SetChisquare(1.156817e-18);
   ...
   quadLineFit1102->SetParameter(0,-3.006767);
   quadLineFit1102->SetParError(0,0.05691197);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,0.08421157);
   ...
   quadLineFit1103->SetChisquare(1.156817e-18);
   ...
   quadLineFit1103->SetParameter(0,-3.006767);
   quadLineFit1103->SetParError(0,0.05691197);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,0.08421157);
   ...
   Graph_mI10dO000000sPppm1103->SetMinimum(-0.1667068);
   Graph_mI10dO000000sPppm1103->SetMaximum(-0.1145134);
   ...
   quadLineFit1104->SetChisquare(1.215812e-19);
   ...
   quadLineFit1104->SetParameter(0,-0.2563423);
   quadLineFit1104->SetParError(0,0.05691197);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,0.006429565);
   ...
   quadLineFit1105->SetChisquare(1.215812e-19);
   ...
   quadLineFit1105->SetParameter(0,-0.2563423);
   quadLineFit1105->SetParError(0,0.05691197);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,0.006429565);
   ...
   Graph_10dO000000sPppm1105->SetMinimum(1.04936);
   Graph_10dO000000sPppm1105->SetMaximum(1.384074);
   ...
   quadLineFit1106->SetChisquare(3.388791e-20);
   ...
   quadLineFit1106->SetParameter(0,2.391903);
   quadLineFit1106->SetParError(0,0.05691197);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,-0.06528814);
   ...
   quadLineFit1107->SetChisquare(3.388791e-20);
   ...
   quadLineFit1107->SetParameter(0,2.391903);
   quadLineFit1107->SetParError(0,0.05691197);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,-0.06528814);
   ...
   Graph_30dO000000sPppm1107->SetMinimum(2.218573);
   Graph_30dO000000sPppm1107->SetMaximum(2.94062);
   ...
   quadLineFit1108->SetChisquare(8.789446e-20);
   ...
   quadLineFit1108->SetParameter(0,5.207277);
   quadLineFit1108->SetParError(0,0.05691197);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,-0.1459822);
   ...
   quadLineFit1109->SetChisquare(8.789446e-20);
   ...
   quadLineFit1109->SetParameter(0,5.207277);
   quadLineFit1109->SetParError(0,0.05691197);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,-0.1459822);
