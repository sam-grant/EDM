...
//=========  (Tue Dec  8 12:25:47 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1081 = new TH1F("Graph_mI30dO000000sPppm1081","",100,0.05396825,0.07301587);
   ...
   Graph_mI30dO000000sPppm1081->GetXaxis()->SetTitle("1/QHV [kV^{-1}]");
   ...
   TF1 *quadLineFit1082 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1082->SetFillColor(19);
   quadLineFit1082->SetFillStyle(0);
   quadLineFit1082->SetLineWidth(2);
   quadLineFit1082->SetChisquare(9.143022e-19);
   ...
   quadLineFit1082->SetParameter(0,-0.001635673);
   quadLineFit1082->SetParError(0,0.0507617);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,-26.44076);
   quadLineFit1082->SetParError(1,0.793323);
   quadLineFit1082->SetParLimits(1,0,0);
   quadLineFit1082->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1082);
   gre->Draw("ap");
   
   TF1 *quadLineFit1083 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1083->SetFillColor(19);
   quadLineFit1083->SetFillStyle(0);
   quadLineFit1083->SetLineWidth(2);
   quadLineFit1083->SetChisquare(9.143022e-19);
   ...
   quadLineFit1083->SetParameter(0,-0.001635673);
   quadLineFit1083->SetParError(0,0.0507617);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,-26.44076);
   quadLineFit1083->SetParError(1,0.793323);
   ...
   TH1F *Graph_30dO000000sPppm1083 = new TH1F("Graph_30dO000000sPppm1083","Graph",100,0.05396825,0.07301587);
   Graph_30dO000000sPppm1083->SetMinimum(2.451416);
   Graph_30dO000000sPppm1083->SetMaximum(3.360451);
   ...
   TF1 *quadLineFit1084 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1084->SetChisquare(1.006812e-17);
   ...
   quadLineFit1084->SetParameter(0,-0.05294964);
   quadLineFit1084->SetParError(0,0.0507617);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,46.6024);
   quadLineFit1084->SetParError(1,0.793323);
   quadLineFit1084->SetParLimits(1,0,0);
   quadLineFit1084->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1084);
   gre->Draw("p ");
   
   TF1 *quadLineFit1085 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1085->SetChisquare(1.006812e-17);
   ...
   quadLineFit1085->SetParameter(0,-0.05294964);
   quadLineFit1085->SetParError(0,0.0507617);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,46.6024);
   quadLineFit1085->SetParError(1,0.793323);
