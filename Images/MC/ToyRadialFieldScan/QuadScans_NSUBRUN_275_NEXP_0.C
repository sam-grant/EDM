...
//=========  (Thu Oct  8 17:32:50 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1101->SetMinimum(-3);
   Graph_mI30dO000000sPppm1101->SetMaximum(2);
   ...
   TF1 *quadLineFit1102 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1102->SetFillColor(19);
   quadLineFit1102->SetFillStyle(0);
   quadLineFit1102->SetLineWidth(2);
   quadLineFit1102->SetChisquare(7.785755e-19);
   ...
   quadLineFit1102->SetParameter(0,-3.358109);
   quadLineFit1102->SetParError(0,0.05691197);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,0.09292685);
   ...
   TF1 *quadLineFit1103 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1103->SetFillColor(19);
   quadLineFit1103->SetFillStyle(0);
   quadLineFit1103->SetLineWidth(2);
   quadLineFit1103->SetChisquare(7.785755e-19);
   ...
   quadLineFit1103->SetParameter(0,-3.358109);
   quadLineFit1103->SetParError(0,0.05691197);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,0.09292685);
   ...
   Graph_mI10dO000000sPppm1103->SetMinimum(-0.635);
   Graph_mI10dO000000sPppm1103->SetMaximum(-0.4830564);
   ...
   TF1 *quadLineFit1104 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1104->SetChisquare(1.883203e-21);
   ...
   quadLineFit1104->SetParameter(0,-1.048823);
   quadLineFit1104->SetParError(0,0.05691197);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,0.02721083);
   ...
   TF1 *quadLineFit1105 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1105->SetChisquare(1.883203e-21);
   ...
   quadLineFit1105->SetParameter(0,-1.048823);
   quadLineFit1105->SetParError(0,0.05691197);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,0.02721083);
   ...
   Graph_10dO000000sPppm1105->SetMinimum(0.4750379);
   Graph_10dO000000sPppm1105->SetMaximum(0.6566357);
   ...
   TF1 *quadLineFit1106 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1106->SetChisquare(5.229813e-19);
   ...
   quadLineFit1106->SetParameter(0,1.166835);
   quadLineFit1106->SetParError(0,0.05691197);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,-0.0333888);
   ...
   TF1 *quadLineFit1107 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1107->SetChisquare(5.229813e-19);
   ...
   quadLineFit1107->SetParameter(0,1.166835);
   quadLineFit1107->SetParError(0,0.05691197);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,-0.0333888);
   ...
   Graph_30dO000000sPppm1107->SetMinimum(1.46258);
   Graph_30dO000000sPppm1107->SetMaximum(1.919401);
   ...
   TF1 *quadLineFit1108 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1108->SetChisquare(1.17164e-18);
   ...
   quadLineFit1108->SetParameter(0,3.324074);
   quadLineFit1108->SetParError(0,0.05691197);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,-0.09072686);
   ...
   TF1 *quadLineFit1109 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1109->SetChisquare(1.17164e-18);
   ...
   quadLineFit1109->SetParameter(0,3.324074);
   quadLineFit1109->SetParError(0,0.05691197);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,-0.09072686);
