...
//=========  (Wed Jan  5 17:07:02 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.054102,0.0768254,3.876006);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1081->SetMinimum(-2.361092);
   Graph_30dO000000sPppm1081->SetMaximum(3.182995);
   ...
   quadLineFit1082->SetChisquare(2.799995e-18);
   ...
   quadLineFit1082->SetParameter(1,45.86457);
   ...
   quadLineFit1083->SetChisquare(2.799995e-18);
   ...
   quadLineFit1083->SetParameter(1,45.86457);
   ...
   Graph_mI30dO000000sPppm1083->SetMinimum(-1.940357);
   Graph_mI30dO000000sPppm1083->SetMaximum(-1.429407);
   ...
   quadLineFit1084->SetChisquare(1.688857e-18);
   ...
   quadLineFit1084->SetParameter(1,-25.70293);
   ...
   quadLineFit1085->SetChisquare(1.688857e-18);
   ...
   quadLineFit1085->SetParameter(1,-25.70293);
