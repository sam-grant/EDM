void FieldFitCheck_NSUBRUN_125_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-108.2306,75,397.6412);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-57.64343);
   Graph_Graph01079->SetMaximum(347.0541);
   ...
   Graph_Graph01079->GetYaxis()->SetTitle("#Delta#LTy#GT#upoint#DeltaV [mm#upointkV]");
   ...
   checkFit1080->SetChisquare(101057.4);
   ...
   checkFit1080->SetParameter(0,67.13004);
   checkFit1080->SetParError(0,0.3152524);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,-1.520681);
   checkFit1080->SetParError(1,0.009229646);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.53e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.14473,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.14473,-57.64343,44.14473,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(101057.4);
   ...
   checkFit1081->SetParameter(0,67.13004);
   checkFit1081->SetParError(0,0.3152524);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,-1.520681);
   checkFit1081->SetParError(1,0.009229646);
