...
//=========  (Wed Jan  5 17:35:39 2022) by ROOT version 6.24/06
   ...
   TH1D *__17 = new TH1D("__17","Number of sub-runs: 396",2400,0.4,1.6);
   __17->SetBinContent(2401,1000);
   __17->SetEntries(1000);
   __17->SetStats(0);
   __17->GetXaxis()->SetTitle("Fitted #delta#LTB_{r}^{b}#GT [ppm]");
   __17->GetXaxis()->SetRange(1,2400);
   ...
   __17->GetYaxis()->SetTitle("Trials / 0.000500 ppm");
