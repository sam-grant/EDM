...
//=========  (Tue Dec  8 12:25:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.15599,45,53.27742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","300 sub-runs",100,-36,36);
   Graph_Graph01095->SetMinimum(-27.21265);
   Graph_Graph01095->SetMaximum(44.33407);
   ...
   checkFit1096->SetChisquare(5.913029e-17);
   ...
   checkFit1096->SetParameter(1,0.972701);
   ...
   pt_LaTex = pt->AddText("0.973#pm0.0149");
   pt_LaTex = pt->AddText(" 8.56#pm0.446");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.800969,-27.21265,-8.800969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(5.913029e-17);
   ...
   checkFit1097->SetParameter(1,0.972701);
