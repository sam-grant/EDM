...
//=========  (Fri Oct  9 18:33:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2038972,45,0.1425633);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.1692511);
   Graph_Graph01069->SetMaximum(0.1079172);
   ...
   fieldLineFit1070->SetChisquare(0.2298641);
   ...
   fieldLineFit1070->SetParameter(0,-0.02999392);
   fieldLineFit1070->SetParError(0,0.001971376);
   fieldLineFit1070->SetParLimits(0,0,0);
   fieldLineFit1070->SetParameter(1,-0.003708243);
   ...
   pt_LaTex = pt->AddText("#minus0.00371#pm8.82e-05");
   pt_LaTex = pt->AddText("-0.03#pm0.00197");
   pt_LaTex = pt->AddText("-8.09#pm0.532");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.088444,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.088444,-0.1692511,-8.088444,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1071->SetChisquare(0.2298641);
   ...
   fieldLineFit1071->SetParameter(0,-0.02999392);
   fieldLineFit1071->SetParError(0,0.001971376);
   fieldLineFit1071->SetParLimits(0,0,0);
   fieldLineFit1071->SetParameter(1,-0.003708243);
