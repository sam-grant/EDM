...
//=========  (Thu May  5 12:48:47 2022) by ROOT version 6.24/06
   ...
   c->Range(-75,-85.59623,75,101.2853);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-66.90808);
   Graph_Graph01109->SetMaximum(82.59713);
   ...
   mainFit1110->SetChisquare(3.383804);
   ...
   mainFit1110->SetParameter(0,8.696543);
   mainFit1110->SetParError(0,0.3307975);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,1.217115);
   mainFit1110->SetParError(1,0.01043441);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.846");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.145211,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.145211,-66.90808,-7.145211,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetChisquare(3.383804);
   ...
   mainFit1111->SetParameter(0,8.696543);
   mainFit1111->SetParError(0,0.3307975);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,1.217115);
   mainFit1111->SetParError(1,0.01043441);
