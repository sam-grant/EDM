void QuadScans_NSUBRUN_60_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.082362,0.0768254,3.826519);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1041->SetMinimum(-2.391474);
   Graph_30dO000000sPppm1041->SetMaximum(3.13563);
   ...
   quadLineFit1042->SetChisquare(1.361969e-19);
   ...
   quadLineFit1042->SetParameter(0,-0.1849813);
   quadLineFit1042->SetParError(0,0.1089729);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,48.48274);
   quadLineFit1042->SetParError(1,1.703069);
   ...
   quadLineFit1043->SetChisquare(1.361969e-19);
   ...
   quadLineFit1043->SetParameter(0,-0.1849813);
   quadLineFit1043->SetParError(0,0.1089729);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,48.48274);
   quadLineFit1043->SetParError(1,1.703069);
   ...
   Graph_mI30dO000000sPppm1043->SetMinimum(-1.979783);
   Graph_mI30dO000000sPppm1043->SetMaximum(-1.409914);
   ...
   quadLineFit1044->SetChisquare(6.474735e-19);
   ...
   quadLineFit1044->SetParameter(0,0.05179623);
   quadLineFit1044->SetParError(0,0.1089729);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-27.50965);
   quadLineFit1044->SetParError(1,1.703069);
   ...
   quadLineFit1045->SetChisquare(6.474735e-19);
   ...
   quadLineFit1045->SetParameter(0,0.05179623);
   quadLineFit1045->SetParError(0,0.1089729);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-27.50965);
   quadLineFit1045->SetParError(1,1.703069);
