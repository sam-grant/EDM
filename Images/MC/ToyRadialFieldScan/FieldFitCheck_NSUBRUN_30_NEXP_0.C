void FieldFitCheck_NSUBRUN_30_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-38.31028,45,55.06949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-28.9723);
   Graph_Graph01023->SetMaximum(45.73152);
   ...
   checkFit1024->SetChisquare(8.993323e-17);
   ...
   checkFit1024->SetParameter(0,8.379606);
   checkFit1024->SetParError(0,1.420258);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9706015);
   checkFit1024->SetParError(1,0.04734193);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.633416,-28.9723,-8.633416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(8.993323e-17);
   ...
   checkFit1025->SetParameter(0,8.379606);
   checkFit1025->SetParError(0,1.420258);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9706015);
   checkFit1025->SetParError(1,0.04734193);
