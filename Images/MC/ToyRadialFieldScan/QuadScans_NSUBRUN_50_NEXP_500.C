void QuadScans_NSUBRUN_50_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 31 19:16:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.229874,0.0663141,7.543966);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1017->SetMinimum(-3.95249);
   Graph_mI50dO000000sPppm1017->SetMaximum(6.266582);
   ...
   quadLineFit1018->SetChisquare(0.4634132);
   ...
   quadLineFit1018->SetParameter(0,-0.06878882);
   quadLineFit1018->SetParError(0,0.1481721);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-49.42095);
   quadLineFit1018->SetParError(1,2.616272);
   ...
   quadLineFit1019->SetChisquare(0.4634132);
   ...
   quadLineFit1019->SetParameter(0,-0.06878882);
   quadLineFit1019->SetParError(0,0.1481721);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-49.42095);
   quadLineFit1019->SetParError(1,2.616272);
   ...
   Graph_mI30dO000000sPppm1019->SetMinimum(-1.975202);
   Graph_mI30dO000000sPppm1019->SetMaximum(-1.281763);
   ...
   quadLineFit1020->SetChisquare(3.025176);
   ...
   quadLineFit1020->SetParameter(0,0.01827903);
   quadLineFit1020->SetParError(0,0.08335381);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-26.5753);
   quadLineFit1020->SetParError(1,1.373834);
   ...
   quadLineFit1021->SetChisquare(3.025176);
   ...
   quadLineFit1021->SetParameter(0,0.01827903);
   quadLineFit1021->SetParError(0,0.08335381);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-26.5753);
   quadLineFit1021->SetParError(1,1.373834);
   ...
   Graph_mI10dO000000sPppm1021->SetMinimum(-0.2017255);
   Graph_mI10dO000000sPppm1021->SetMaximum(-0.07378512);
   ...
   quadLineFit1022->SetChisquare(4.530813);
   ...
   quadLineFit1022->SetParameter(0,-0.2119469);
   quadLineFit1022->SetParError(0,0.08335393);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,1.125595);
   quadLineFit1022->SetParError(1,1.373836);
   ...
   quadLineFit1023->SetChisquare(4.530813);
   ...
   quadLineFit1023->SetParameter(0,-0.2119469);
   quadLineFit1023->SetParError(0,0.08335393);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,1.125595);
   quadLineFit1023->SetParError(1,1.373836);
   ...
   Graph_10dO000000sPppm1023->SetMinimum(1.014779);
   Graph_10dO000000sPppm1023->SetMaximum(1.63327);
   ...
   quadLineFit1024->SetChisquare(0.02304193);
   ...
   quadLineFit1024->SetParameter(0,-0.1176477);
   quadLineFit1024->SetParError(0,0.09138591);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,23.51822);
   quadLineFit1024->SetParError(1,1.46723);
   ...
   quadLineFit1025->SetChisquare(0.02304193);
   ...
   quadLineFit1025->SetParameter(0,-0.1176477);
   quadLineFit1025->SetParError(0,0.09138591);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,23.51822);
   quadLineFit1025->SetParError(1,1.46723);
   ...
   Graph_30dO000000sPppm1025->SetMinimum(2.245288);
   Graph_30dO000000sPppm1025->SetMaximum(3.381236);
   ...
   quadLineFit1026->SetChisquare(8.600841);
   ...
   quadLineFit1026->SetParameter(0,-0.02245864);
   quadLineFit1026->SetParError(0,0.08335331);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,46.25796);
   quadLineFit1026->SetParError(1,1.373826);
   ...
   quadLineFit1027->SetChisquare(8.600841);
   ...
   quadLineFit1027->SetParameter(0,-0.02245864);
   quadLineFit1027->SetParError(0,0.08335331);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,46.25796);
   quadLineFit1027->SetParError(1,1.373826);
   ...
   Graph_50dO000000sPppm1027->SetMinimum(3.409979);
   Graph_50dO000000sPppm1027->SetMaximum(5.18187);
   ...
   quadLineFit1028->SetChisquare(0.6839698);
   ...
   quadLineFit1028->SetParameter(0,-0.05013935);
   quadLineFit1028->SetParError(0,0.08335596);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,70.82655);
   quadLineFit1028->SetParError(1,1.37387);
   ...
   quadLineFit1029->SetChisquare(0.6839698);
   ...
   quadLineFit1029->SetParameter(0,-0.05013935);
   quadLineFit1029->SetParError(0,0.08335596);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,70.82655);
   quadLineFit1029->SetParError(1,1.37387);
