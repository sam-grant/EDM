void QuadScans_NSUBRUN_128005673_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct  5 20:30:52 2020) by ROOT version 6.22/02
   ...
   TF1 *quadLineFit1002 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1002->SetFillColor(19);
   quadLineFit1002->SetFillStyle(0);
   quadLineFit1002->SetLineWidth(2);
   quadLineFit1002->SetChisquare(5.223167e+123);
   ...
   quadLineFit1002->SetParameter(0,-4.275);
   quadLineFit1002->SetParError(0,1.244214e-76);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.11875);
   quadLineFit1002->SetParError(1,6.870024e-78);
   quadLineFit1002->SetParLimits(1,0,0);
   quadLineFit1002->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1002);
   gre->Draw("ap");
   
   TF1 *quadLineFit1003 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   quadLineFit1003->SetFillColor(19);
   quadLineFit1003->SetFillStyle(0);
   quadLineFit1003->SetLineWidth(2);
   quadLineFit1003->SetChisquare(5.223167e+123);
   ...
   quadLineFit1003->SetParameter(0,-4.275);
   quadLineFit1003->SetParError(0,1.244214e-76);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.11875);
   quadLineFit1003->SetParError(1,6.870024e-78);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-1.1475);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.8775);
   ...
   TF1 *quadLineFit1004 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1004->SetChisquare(4.243823e+122);
   ...
   quadLineFit1004->SetParameter(0,-2.025);
   quadLineFit1004->SetParError(0,1.244214e-76);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.05625);
   quadLineFit1004->SetParError(1,6.870024e-78);
   quadLineFit1004->SetParLimits(1,0,0);
   quadLineFit1004->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1004);
   gre->Draw("p ");
   
   TF1 *quadLineFit1005 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1005->SetChisquare(4.243823e+122);
   ...
   quadLineFit1005->SetParameter(0,-2.025);
   quadLineFit1005->SetParError(0,1.244214e-76);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.05625);
   quadLineFit1005->SetParError(1,6.870024e-78);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(0.0975);
   Graph_10dO000000sPppm1005->SetMaximum(0.1275);
   ...
   TF1 *quadLineFit1006 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1006->SetChisquare(2.65239e+122);
   ...
   quadLineFit1006->SetParameter(0,0.225);
   quadLineFit1006->SetParError(0,1.244214e-76);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.00625);
   quadLineFit1006->SetParError(1,6.870024e-78);
   quadLineFit1006->SetParLimits(1,0,0);
   quadLineFit1006->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1006);
   gre->Draw("p ");
   
   TF1 *quadLineFit1007 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1007->SetChisquare(2.65239e+122);
   ...
   quadLineFit1007->SetParameter(0,0.225);
   quadLineFit1007->SetParError(0,1.244214e-76);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.00625);
   quadLineFit1007->SetParError(1,6.870024e-78);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(1.0725);
   Graph_30dO000000sPppm1007->SetMaximum(1.4025);
   ...
   TF1 *quadLineFit1008 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1008->SetChisquare(4.178534e+123);
   ...
   quadLineFit1008->SetParameter(0,2.475);
   quadLineFit1008->SetParError(0,1.244214e-76);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.06875);
   quadLineFit1008->SetParError(1,6.870024e-78);
   quadLineFit1008->SetParLimits(1,0,0);
   quadLineFit1008->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1008);
   gre->Draw("p ");
   
   TF1 *quadLineFit1009 = new TF1("quadLineFit","pol 1",15.6,20.4, TF1::EAddToList::kNo);
   ...
   quadLineFit1009->SetChisquare(4.178534e+123);
   ...
   quadLineFit1009->SetParameter(0,2.475);
   quadLineFit1009->SetParError(0,1.244214e-76);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.06875);
   quadLineFit1009->SetParError(1,6.870024e-78);
