void QuadScans_NSUBRUN_125_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.219202,0.0663141,7.517404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1065->SetMinimum(-3.945541);
   Graph_mI50dO000000sPppm1065->SetMaximum(6.243743);
   ...
   quadLineFit1066->SetChisquare(0.2909);
   ...
   quadLineFit1066->SetParameter(0,-0.1231724);
   quadLineFit1066->SetParError(0,0.09376546);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-48.56742);
   quadLineFit1066->SetParError(1,1.655614);
   ...
   quadLineFit1067->SetChisquare(0.2909);
   ...
   quadLineFit1067->SetParameter(0,-0.1231724);
   quadLineFit1067->SetParError(0,0.09376546);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-48.56742);
   quadLineFit1067->SetParError(1,1.655614);
   ...
   Graph_mI30dO000000sPppm1067->SetMinimum(-1.96632);
   Graph_mI30dO000000sPppm1067->SetMaximum(-1.260156);
   ...
   quadLineFit1068->SetChisquare(2.437126);
   ...
   quadLineFit1068->SetParameter(0,0.1170216);
   quadLineFit1068->SetParError(0,0.0527536);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-28.26037);
   quadLineFit1068->SetParError(1,0.869483);
   ...
   quadLineFit1069->SetChisquare(2.437126);
   ...
   quadLineFit1069->SetParameter(0,0.1170216);
   quadLineFit1069->SetParError(0,0.0527536);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-28.26037);
   quadLineFit1069->SetParError(1,0.869483);
   ...
   Graph_mI10dO000000sPppm1069->SetMinimum(-0.2063282);
   Graph_mI10dO000000sPppm1069->SetMaximum(-0.08812214);
   ...
   quadLineFit1070->SetChisquare(3.110898);
   ...
   quadLineFit1070->SetParameter(0,0.07745883);
   quadLineFit1070->SetParError(0,0.052753);
   quadLineFit1070->SetParLimits(0,0,0);
   quadLineFit1070->SetParameter(1,-3.792982);
   quadLineFit1070->SetParError(1,0.8694728);
   ...
   quadLineFit1071->SetChisquare(3.110898);
   ...
   quadLineFit1071->SetParameter(0,0.07745883);
   quadLineFit1071->SetParError(0,0.052753);
   quadLineFit1071->SetParLimits(0,0,0);
   quadLineFit1071->SetParameter(1,-3.792982);
   quadLineFit1071->SetParError(1,0.8694728);
   ...
   Graph_10dO000000sPppm1071->SetMinimum(1.036953);
   Graph_10dO000000sPppm1071->SetMaximum(1.638466);
   ...
   quadLineFit1072->SetChisquare(5.325438);
   ...
   quadLineFit1072->SetParameter(0,-0.1119487);
   quadLineFit1072->SetParError(0,0.05784356);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,23.42414);
   quadLineFit1072->SetParError(1,0.9286968);
   ...
   quadLineFit1073->SetChisquare(5.325438);
   ...
   quadLineFit1073->SetParameter(0,-0.1119487);
   quadLineFit1073->SetParError(0,0.05784356);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,23.42414);
   quadLineFit1073->SetParError(1,0.9286968);
   ...
   Graph_30dO000000sPppm1073->SetMinimum(2.232722);
   Graph_30dO000000sPppm1073->SetMaximum(3.39425);
   ...
   quadLineFit1074->SetChisquare(2.50406);
   ...
   quadLineFit1074->SetParameter(0,-0.040525);
   quadLineFit1074->SetParError(0,0.05275129);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,46.4286);
   quadLineFit1074->SetParError(1,0.8694442);
   ...
   quadLineFit1075->SetChisquare(2.50406);
   ...
   quadLineFit1075->SetParameter(0,-0.040525);
   quadLineFit1075->SetParError(0,0.05275129);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,46.4286);
   quadLineFit1075->SetParError(1,0.8694442);
   ...
   Graph_50dO000000sPppm1075->SetMinimum(3.430017);
   Graph_50dO000000sPppm1075->SetMaximum(5.151727);
   ...
   quadLineFit1076->SetChisquare(0.314993);
   ...
   quadLineFit1076->SetParameter(0,0.01514334);
   quadLineFit1076->SetParError(0,0.05274682);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,69.71413);
   quadLineFit1076->SetParError(1,0.8693709);
   ...
   quadLineFit1077->SetChisquare(0.314993);
   ...
   quadLineFit1077->SetParameter(0,0.01514334);
   quadLineFit1077->SetParError(0,0.05274682);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,69.71413);
   quadLineFit1077->SetParError(1,0.8693709);
