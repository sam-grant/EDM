...
//=========  (Fri Oct 16 07:57:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3135394,75,0.2525628);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-0.2569291);
   Graph_Graph01109->SetMaximum(0.1959525);
   ...
   mainFit1110->SetChisquare(2.970967);
   ...
   mainFit1110->SetParameter(0,-0.02799772);
   mainFit1110->SetParError(0,0.00164872);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,-0.003725446);
   mainFit1110->SetParError(1,4.663338e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00373#pm4.66e-05");
   pt_LaTex = pt->AddText("#minus0.028#pm0.00165");
   pt_LaTex = pt->AddText("#minus7.52#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.515264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.515264,-0.2569291,-7.515264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetChisquare(2.970967);
   ...
   mainFit1111->SetParameter(0,-0.02799772);
   mainFit1111->SetParError(0,0.00164872);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,-0.003725446);
   mainFit1111->SetParError(1,4.663338e-05);
