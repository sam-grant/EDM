...
//=========  (Fri Oct 16 07:57:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3131793,75,0.2532969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01123->SetMinimum(-0.2565317);
   Graph_Graph01123->SetMaximum(0.1966493);
   ...
   mainFit1124->SetChisquare(5.254125);
   ...
   mainFit1124->SetParameter(0,-0.02872373);
   mainFit1124->SetParError(0,0.001554094);
   mainFit1124->SetParLimits(0,0,0);
   mainFit1124->SetParameter(1,-0.003694575);
   mainFit1124->SetParError(1,4.395653e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00369#pm4.4e-05");
   pt_LaTex = pt->AddText("#minus0.0287#pm0.00155");
   pt_LaTex = pt->AddText("#minus7.77#pm0.431");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.774571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.774571,-0.2565317,-7.774571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1125->SetChisquare(5.254125);
   ...
   mainFit1125->SetParameter(0,-0.02872373);
   mainFit1125->SetParError(0,0.001554094);
   mainFit1125->SetParLimits(0,0,0);
   mainFit1125->SetParameter(1,-0.003694575);
   mainFit1125->SetParError(1,4.395653e-05);
