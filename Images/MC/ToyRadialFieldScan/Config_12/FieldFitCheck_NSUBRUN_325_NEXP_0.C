...
//=========  (Fri Oct 16 07:57:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.36886,75,82.66082);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01181->SetMinimum(-53.26589);
   Graph_Graph01181->SetMaximum(67.55785);
   ...
   checkFit1182->SetChisquare(0.8436487);
   ...
   checkFit1182->SetParameter(0,7.505958);
   checkFit1182->SetParError(0,0.3432287);
   checkFit1182->SetParLimits(0,0,0);
   checkFit1182->SetParameter(1,0.9930173);
   checkFit1182->SetParError(1,0.009707974);
   ...
   pt_LaTex = pt->AddText("0.993#pm0.00971");
   pt_LaTex = pt->AddText(" 7.51#pm0.343");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.558739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.558739,-53.26589,-7.558739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1183->SetChisquare(0.8436487);
   ...
   checkFit1183->SetParameter(0,7.505958);
   checkFit1183->SetParError(0,0.3432287);
   checkFit1183->SetParLimits(0,0,0);
   checkFit1183->SetParameter(1,0.9930173);
   checkFit1183->SetParError(1,0.009707974);
