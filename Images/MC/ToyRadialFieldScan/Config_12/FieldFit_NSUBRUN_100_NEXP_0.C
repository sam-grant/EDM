...
//=========  (Fri Oct 16 07:57:13 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3159645,75,0.2491897);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.2594491);
   Graph_Graph01053->SetMaximum(0.1926743);
   ...
   mainFit1054->SetChisquare(2.781096);
   ...
   mainFit1054->SetParameter(0,-0.03052152);
   mainFit1054->SetParError(0,0.002335937);
   mainFit1054->SetParLimits(0,0,0);
   mainFit1054->SetParameter(1,-0.003704501);
   mainFit1054->SetParError(1,6.607063e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0037#pm6.61e-05");
   pt_LaTex = pt->AddText("#minus0.0305#pm0.00234");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.239037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.239037,-0.2594491,-8.239037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1055->SetChisquare(2.781096);
   ...
   mainFit1055->SetParameter(0,-0.03052152);
   mainFit1055->SetParError(0,0.002335937);
   mainFit1055->SetParLimits(0,0,0);
   mainFit1055->SetParameter(1,-0.003704501);
   mainFit1055->SetParError(1,6.607063e-05);
