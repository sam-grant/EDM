...
//=========  (Fri Oct 16 07:57:11 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1015[3] = {
   16,
   18,
   20};
   Double_t -50.000000 ppm_fy1015[3] = {
   -3.171253,
   -2.793193,
   -2.500817};
   Double_t -50.000000 ppm_fex1015[3] = {
   0,
   0,
   0};
   Double_t -50.000000 ppm_fey1015[3] = {
   0.02074029,
   0.02074029,
   0.02074029};
   TGraphErrors *gre = new TGraphErrors(3,-50.000000 ppm_fx1015,-50.000000 ppm_fy1015,-50.000000 ppm_fex1015,-50.000000 ppm_fey1015);
   ...
   quadLineFit1016->SetChisquare(2.844599);
   ...
   quadLineFit1016->SetParameter(0,-5.838716);
   quadLineFit1016->SetParError(0,0.1325312);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,0.167609);
   quadLineFit1016->SetParError(1,0.00733273);
   ...
   quadLineFit1017->SetChisquare(2.844599);
   ...
   quadLineFit1017->SetParameter(0,-5.838716);
   quadLineFit1017->SetParError(0,0.1325312);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,0.167609);
   quadLineFit1017->SetParError(1,0.00733273);
   quadLineFit1017->SetParLimits(1,0,0);
   quadLineFit1017->Draw("same");
   
   Double_t -25.000000 ppm_fx1017[3] = {
   16,
   18,
   20};
   Double_t -25.000000 ppm_fy1017[3] = {
   -1.306244,
   -1.167102,
   -1.048537};
   Double_t -25.000000 ppm_fex1017[3] = {
   0,
   0,
   0};
   Double_t -25.000000 ppm_fey1017[3] = {
   0.02074029,
   0.02074029,
   0.02074029};
   gre = new TGraphErrors(3,-25.000000 ppm_fx1017,-25.000000 ppm_fy1017,-25.000000 ppm_fex1017,-25.000000 ppm_fey1017);
   ...
   Graph_mI25dO000000sPppm1017->SetMinimum(-1.356903);
   Graph_mI25dO000000sPppm1017->SetMaximum(-0.9978783);
   ...
   quadLineFit1018->SetChisquare(0.1640628);
   ...
   quadLineFit1018->SetParameter(0,-2.333641);
   quadLineFit1018->SetParError(0,0.1325352);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.06442668);
   quadLineFit1018->SetParError(1,0.007332951);
   ...
   quadLineFit1019->SetChisquare(0.1640628);
   ...
   quadLineFit1019->SetParameter(0,-2.333641);
   quadLineFit1019->SetParError(0,0.1325352);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.06442668);
   quadLineFit1019->SetParError(1,0.007332951);
   quadLineFit1019->SetParLimits(1,0,0);
   quadLineFit1019->Draw("same");
   
   Double_t 0.000000 ppm_fx1019[3] = {
   16,
   18,
   20};
   Double_t 0.000000 ppm_fy1019[3] = {
   0.586249,
   0.5835455,
   0.4429463};
   Double_t 0.000000 ppm_fex1019[3] = {
   0,
   0,
   0};
   Double_t 0.000000 ppm_fey1019[3] = {
   0.02074029,
   0.02074029,
   0.02074029};
   gre = new TGraphErrors(3,0.000000 ppm_fx1019,0.000000 ppm_fy1019,0.000000 ppm_fex1019,0.000000 ppm_fey1019);
   ...
   Graph_0dO000000sPppm1019->SetMinimum(0.4037277);
   Graph_0dO000000sPppm1019->SetMaximum(0.6254676);
   ...
   quadLineFit1020->SetChisquare(7.367498);
   ...
   quadLineFit1020->SetParameter(0,1.182442);
   quadLineFit1020->SetParError(0,0.1325321);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.03582567);
   quadLineFit1020->SetParError(1,0.007332782);
   ...
   quadLineFit1021->SetChisquare(7.367498);
   ...
   quadLineFit1021->SetParameter(0,1.182442);
   quadLineFit1021->SetParError(0,0.1325321);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.03582567);
   quadLineFit1021->SetParError(1,0.007332782);
   quadLineFit1021->SetParLimits(1,0,0);
   quadLineFit1021->Draw("same");
   
   Double_t 25.000000 ppm_fx1021[3] = {
   16,
   18,
   20};
   Double_t 25.000000 ppm_fy1021[3] = {
   2.467568,
   2.202752,
   1.971576};
   Double_t 25.000000 ppm_fex1021[3] = {
   0,
   0,
   0};
   Double_t 25.000000 ppm_fey1021[3] = {
   0.02074029,
   0.02074029,
   0.02074029};
   gre = new TGraphErrors(3,25.000000 ppm_fx1021,25.000000 ppm_fy1021,25.000000 ppm_fex1021,25.000000 ppm_fey1021);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   Graph_25dO000000sPppm1021->SetMinimum(1.897088);
   Graph_25dO000000sPppm1021->SetMaximum(2.542056);
   ...
   quadLineFit1022->SetChisquare(0.4384788);
   ...
   quadLineFit1022->SetParameter(0,4.445931);
   quadLineFit1022->SetParError(0,0.1325361);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,-0.1239981);
   quadLineFit1022->SetParError(1,0.007333002);
   ...
   quadLineFit1023->SetChisquare(0.4384788);
   ...
   quadLineFit1023->SetParameter(0,4.445931);
   quadLineFit1023->SetParError(0,0.1325361);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,-0.1239981);
   quadLineFit1023->SetParError(1,0.007333002);
   quadLineFit1023->SetParLimits(1,0,0);
   quadLineFit1023->Draw("same");
   
   Double_t 50.000000 ppm_fx1023[3] = {
   16,
   18,
   20};
   Double_t 50.000000 ppm_fy1023[3] = {
   4.384128,
   3.908828,
   3.459718};
   Double_t 50.000000 ppm_fex1023[3] = {
   0,
   0,
   0};
   Double_t 50.000000 ppm_fey1023[3] = {
   0.02074029,
   0.02074029,
   0.02074029};
   gre = new TGraphErrors(3,50.000000 ppm_fx1023,50.000000 ppm_fy1023,50.000000 ppm_fex1023,50.000000 ppm_fey1023);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(5);
   ...
   Graph_50dO000000sPppm1023->SetMinimum(3.342388);
   Graph_50dO000000sPppm1023->SetMaximum(4.501457);
   ...
   quadLineFit1024->SetChisquare(0.2657654);
   ...
   quadLineFit1024->SetParameter(0,8.077403);
   quadLineFit1024->SetParError(0,0.1325257);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,-0.2311025);
   quadLineFit1024->SetParError(1,0.00733242);
   ...
   quadLineFit1025->SetChisquare(0.2657654);
   ...
   quadLineFit1025->SetParameter(0,8.077403);
   quadLineFit1025->SetParError(0,0.1325257);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,-0.2311025);
   quadLineFit1025->SetParError(1,0.00733242);
