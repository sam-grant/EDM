...
//=========  (Fri Oct 16 07:57:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.26059,75,83.16181);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-52.21835);
   Graph_Graph01125->SetMaximum(68.11957);
   ...
   checkFit1126->SetChisquare(5.254219);
   ...
   checkFit1126->SetParameter(0,7.627312);
   checkFit1126->SetParError(0,0.4126741);
   checkFit1126->SetParLimits(0,0,0);
   checkFit1126->SetParameter(1,0.9810594);
   ...
   pt_LaTex = pt->AddText("0.981#pm0.0117");
   pt_LaTex = pt->AddText(" 7.63#pm0.413");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.774567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.774567,-52.21835,-7.774567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1127->SetChisquare(5.254219);
   ...
   checkFit1127->SetParameter(0,7.627312);
   checkFit1127->SetParError(0,0.4126741);
   checkFit1127->SetParLimits(0,0,0);
   checkFit1127->SetParameter(1,0.9810594);
