...
//=========  (Fri Oct 16 07:57:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.91872,75,85.53198);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01167->SetMinimum(-54.37365);
   Graph_Graph01167->SetMaximum(69.98691);
   ...
   checkFit1168->SetChisquare(5.869855);
   ...
   checkFit1168->SetParameter(0,8.095926);
   checkFit1168->SetParError(0,0.3572413);
   checkFit1168->SetParLimits(0,0,0);
   checkFit1168->SetParameter(1,1.030291);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0101");
   pt_LaTex = pt->AddText("  8.1#pm0.357");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.8579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.8579,-54.37365,-7.8579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1169->SetChisquare(5.869855);
   ...
   checkFit1169->SetParameter(0,8.095926);
   checkFit1169->SetParError(0,0.3572413);
   checkFit1169->SetParLimits(0,0,0);
   checkFit1169->SetParameter(1,1.030291);
