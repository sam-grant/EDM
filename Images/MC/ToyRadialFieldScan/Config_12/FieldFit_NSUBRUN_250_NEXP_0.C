...
//=========  (Fri Oct 16 07:57:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3254995,75,0.2617406);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01137->SetMinimum(-0.2667755);
   Graph_Graph01137->SetMaximum(0.2030166);
   ...
   mainFit1138->SetChisquare(1.510259);
   ...
   mainFit1138->SetParameter(0,-0.03054474);
   mainFit1138->SetParError(0,0.001474075);
   mainFit1138->SetParLimits(0,0,0);
   mainFit1138->SetParameter(1,-0.003842746);
   mainFit1138->SetParError(1,4.169257e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00384#pm4.17e-05");
   pt_LaTex = pt->AddText("#minus0.0305#pm0.00147");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.948677,-0.2667755,-7.948677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1139->SetChisquare(1.510259);
   ...
   mainFit1139->SetParameter(0,-0.03054474);
   mainFit1139->SetParError(0,0.001474075);
   mainFit1139->SetParLimits(0,0,0);
   mainFit1139->SetParameter(1,-0.003842746);
   mainFit1139->SetParError(1,4.169257e-05);
