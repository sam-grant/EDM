...
//=========  (Fri Oct 16 07:57:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.06567,75,83.25739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-52.03336);
   Graph_Graph01111->SetMaximum(68.22509);
   ...
   checkFit1112->SetChisquare(2.970946);
   ...
   checkFit1112->SetParameter(0,7.434529);
   checkFit1112->SetParError(0,0.4378059);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,0.9892575);
   ...
   pt_LaTex = pt->AddText("0.989#pm0.0124");
   pt_LaTex = pt->AddText(" 7.43#pm0.438");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.515262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.515262,-52.03336,-7.515262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetChisquare(2.970946);
   ...
   checkFit1113->SetParameter(0,7.434529);
   checkFit1113->SetParError(0,0.4378059);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,0.9892575);
