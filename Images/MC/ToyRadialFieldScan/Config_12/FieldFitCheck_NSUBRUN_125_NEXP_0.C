...
//=========  (Fri Oct 16 07:57:14 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.51143,75,85.76495);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-53.08379);
   Graph_Graph01069->SetMaximum(70.33731);
   ...
   checkFit1070->SetChisquare(5.901205);
   ...
   checkFit1070->SetParameter(0,7.453154);
   checkFit1070->SetParError(0,0.554357);
   checkFit1070->SetParLimits(0,0,0);
   checkFit1070->SetParameter(1,0.9913374);
   ...
   pt_LaTex = pt->AddText("0.991#pm0.0157");
   pt_LaTex = pt->AddText(" 7.45#pm0.554");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.518283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.518283,-53.08379,-7.518283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1071->SetChisquare(5.901205);
   ...
   checkFit1071->SetParameter(0,7.453154);
   checkFit1071->SetParError(0,0.554357);
   checkFit1071->SetParLimits(0,0,0);
   checkFit1071->SetParameter(1,0.9913374);
