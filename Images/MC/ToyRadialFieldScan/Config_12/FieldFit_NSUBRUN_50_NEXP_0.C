...
//=========  (Fri Oct 16 07:57:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3417791,75,0.2782859);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-0.2797726);
   Graph_Graph01025->SetMaximum(0.2162794);
   ...
   mainFit1026->SetChisquare(1.341203);
   ...
   mainFit1026->SetParameter(0,-0.03177822);
   mainFit1026->SetParError(0,0.003279317);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,-0.003943395);
   mainFit1026->SetParError(1,9.275156e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00394#pm9.28e-05");
   pt_LaTex = pt->AddText("#minus0.0318#pm0.00328");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.058595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.058595,-0.2797726,-8.058595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.341203);
   ...
   mainFit1027->SetParameter(0,-0.03177822);
   mainFit1027->SetParError(0,0.003279317);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,-0.003943395);
   mainFit1027->SetParError(1,9.275156e-05);
