...
//=========  (Fri Oct 16 07:57:19 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1113 = new TH1F("Graph_mI50dO000000sPppm1113","",100,15.6,20.4);
   ...
   quadLineFit1114->SetChisquare(3.003413);
   ...
   quadLineFit1114->SetParameter(0,-5.629805);
   quadLineFit1114->SetParError(0,0.06280837);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.1554091);
   quadLineFit1114->SetParError(1,0.003475083);
   ...
   quadLineFit1115->SetChisquare(3.003413);
   ...
   quadLineFit1115->SetParameter(0,-5.629805);
   quadLineFit1115->SetParError(0,0.06280837);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.1554091);
   quadLineFit1115->SetParError(1,0.003475083);
   quadLineFit1115->SetParLimits(1,0,0);
   quadLineFit1115->Draw("same");
   
   Double_t -25.000000 ppm_fx1115[3] = {
   16,
   18,
   20};
   Double_t -25.000000 ppm_fy1115[3] = {
   -1.264507,
   -1.150831,
   -1.023742};
   Double_t -25.000000 ppm_fex1115[3] = {
   0,
   0,
   0};
   Double_t -25.000000 ppm_fey1115[3] = {
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(3,-25.000000 ppm_fx1115,-25.000000 ppm_fy1115,-25.000000 ppm_fex1115,-25.000000 ppm_fey1115);
   ...
   TH1F *Graph_mI25dO000000sPppm1115 = new TH1F("Graph_mI25dO000000sPppm1115","Graph",100,15.6,20.4);
   Graph_mI25dO000000sPppm1115->SetMinimum(-1.300378);
   Graph_mI25dO000000sPppm1115->SetMaximum(-0.9878705);
   ...
   quadLineFit1116->SetChisquare(0.3104309);
   ...
   quadLineFit1116->SetParameter(0,-2.229802);
   quadLineFit1116->SetParError(0,0.06280837);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,0.06019124);
   quadLineFit1116->SetParError(1,0.003475083);
   ...
   quadLineFit1117->SetChisquare(0.3104309);
   ...
   quadLineFit1117->SetParameter(0,-2.229802);
   quadLineFit1117->SetParError(0,0.06280837);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,0.06019124);
   quadLineFit1117->SetParError(1,0.003475083);
   quadLineFit1117->SetParLimits(1,0,0);
   quadLineFit1117->Draw("same");
   
   Double_t 0.000000 ppm_fx1117[3] = {
   16,
   18,
   20};
   Double_t 0.000000 ppm_fy1117[3] = {
   0.575541,
   0.5273555,
   0.4880357};
   Double_t 0.000000 ppm_fex1117[3] = {
   0,
   0,
   0};
   Double_t 0.000000 ppm_fey1117[3] = {
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(3,0.000000 ppm_fx1117,0.000000 ppm_fy1117,0.000000 ppm_fex1117,0.000000 ppm_fey1117);
   ...
   TH1F *Graph_0dO000000sPppm1117 = new TH1F("Graph_0dO000000sPppm1117","Graph",100,15.6,20.4);
   Graph_0dO000000sPppm1117->SetMinimum(0.4674904);
   Graph_0dO000000sPppm1117->SetMaximum(0.5960862);
   ...
   quadLineFit1118->SetChisquare(0.1355967);
   ...
   quadLineFit1118->SetParameter(0,0.9240846);
   quadLineFit1118->SetParError(0,0.06280844);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.02187632);
   quadLineFit1118->SetParError(1,0.003475087);
   ...
   quadLineFit1119->SetChisquare(0.1355967);
   ...
   quadLineFit1119->SetParameter(0,0.9240846);
   quadLineFit1119->SetParError(0,0.06280844);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.02187632);
   quadLineFit1119->SetParError(1,0.003475087);
   quadLineFit1119->SetParLimits(1,0,0);
   quadLineFit1119->Draw("same");
   
   Double_t 25.000000 ppm_fx1119[3] = {
   16,
   18,
   20};
   Double_t 25.000000 ppm_fy1119[3] = {
   2.479941,
   2.19863,
   1.991736};
   Double_t 25.000000 ppm_fex1119[3] = {
   0,
   0,
   0};
   Double_t 25.000000 ppm_fey1119[3] = {
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(3,25.000000 ppm_fx1119,25.000000 ppm_fy1119,25.000000 ppm_fex1119,25.000000 ppm_fey1119);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_25dO000000sPppm1119 = new TH1F("Graph_25dO000000sPppm1119","Graph",100,15.6,20.4);
   Graph_25dO000000sPppm1119->SetMinimum(1.931121);
   Graph_25dO000000sPppm1119->SetMaximum(2.540556);
   ...
   quadLineFit1120->SetChisquare(9.553705);
   ...
   quadLineFit1120->SetParameter(0,4.420354);
   quadLineFit1120->SetParError(0,0.06280626);
   quadLineFit1120->SetParLimits(0,0,0);
   quadLineFit1120->SetParameter(1,-0.122051);
   quadLineFit1120->SetParError(1,0.003474965);
   ...
   quadLineFit1121->SetChisquare(9.553705);
   ...
   quadLineFit1121->SetParameter(0,4.420354);
   quadLineFit1121->SetParError(0,0.06280626);
   quadLineFit1121->SetParLimits(0,0,0);
   quadLineFit1121->SetParameter(1,-0.122051);
   quadLineFit1121->SetParError(1,0.003474965);
   quadLineFit1121->SetParLimits(1,0,0);
   quadLineFit1121->Draw("same");
   
   Double_t 50.000000 ppm_fx1121[3] = {
   16,
   18,
   20};
   Double_t 50.000000 ppm_fy1121[3] = {
   4.358163,
   3.885884,
   3.496997};
   Double_t 50.000000 ppm_fex1121[3] = {
   0,
   0,
   0};
   Double_t 50.000000 ppm_fey1121[3] = {
   0.009828933,
   0.009828933,
   0.009828933};
   gre = new TGraphErrors(3,50.000000 ppm_fx1121,50.000000 ppm_fy1121,50.000000 ppm_fex1121,50.000000 ppm_fey1121);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(5);
   ...
   TH1F *Graph_50dO000000sPppm1121 = new TH1F("Graph_50dO000000sPppm1121","Graph",100,15.6,20.4);
   Graph_50dO000000sPppm1121->SetMinimum(3.399086);
   Graph_50dO000000sPppm1121->SetMaximum(4.456075);
   ...
   quadLineFit1122->SetChisquare(11.99769);
   ...
   quadLineFit1122->SetParameter(0,7.788929);
   quadLineFit1122->SetParError(0,0.06280827);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,-0.2152915);
   quadLineFit1122->SetParError(1,0.003475077);
   ...
   quadLineFit1123->SetChisquare(11.99769);
   ...
   quadLineFit1123->SetParameter(0,7.788929);
   quadLineFit1123->SetParError(0,0.06280827);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,-0.2152915);
   quadLineFit1123->SetParError(1,0.003475077);
