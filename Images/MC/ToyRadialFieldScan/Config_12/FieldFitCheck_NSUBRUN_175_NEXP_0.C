...
//=========  (Fri Oct 16 07:57:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.14227,75,84.89677);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01097->SetMinimum(-55.53837);
   Graph_Graph01097->SetMaximum(69.29286);
   ...
   checkFit1098->SetChisquare(7.026134);
   ...
   checkFit1098->SetParameter(0,7.995468);
   checkFit1098->SetParError(0,0.468215);
   checkFit1098->SetParLimits(0,0,0);
   checkFit1098->SetParameter(1,1.007849);
   checkFit1098->SetParError(1,0.01324312);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0132");
   pt_LaTex = pt->AddText("    8#pm0.468");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.933198,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.933198,-55.53837,-7.933198,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1099->SetChisquare(7.026134);
   ...
   checkFit1099->SetParameter(0,7.995468);
   checkFit1099->SetParError(0,0.468215);
   checkFit1099->SetParLimits(0,0,0);
   checkFit1099->SetParameter(1,1.007849);
   checkFit1099->SetParError(1,0.01324312);
