...
//=========  (Fri Oct 16 07:57:12 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3305401,75,0.2659435);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.2708917);
   Graph_Graph01039->SetMaximum(0.2062951);
   ...
   mainFit1040->SetChisquare(0.1301358);
   ...
   mainFit1040->SetParameter(0,-0.03128896);
   mainFit1040->SetParError(0,0.002681786);
   mainFit1040->SetParLimits(0,0,0);
   mainFit1040->SetParameter(1,-0.003858837);
   mainFit1040->SetParError(1,7.585269e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00386#pm7.59e-05");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00268");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.108391,-0.2708917,-8.108391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1041->SetChisquare(0.1301358);
   ...
   mainFit1041->SetParameter(0,-0.03128896);
   mainFit1041->SetParError(0,0.002681786);
   mainFit1041->SetParLimits(0,0,0);
   mainFit1041->SetParameter(1,-0.003858837);
   mainFit1041->SetParError(1,7.585269e-05);
