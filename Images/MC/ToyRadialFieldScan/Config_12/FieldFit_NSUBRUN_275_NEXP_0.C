...
//=========  (Fri Oct 16 07:57:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3201505,75,0.2564814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01151->SetMinimum(-0.2624873);
   Graph_Graph01151->SetMaximum(0.1988182);
   ...
   mainFit1152->SetChisquare(1.684982);
   ...
   mainFit1152->SetParameter(0,-0.03281543);
   mainFit1152->SetParError(0,0.001405288);
   mainFit1152->SetParLimits(0,0,0);
   mainFit1152->SetParameter(1,-0.0037835);
   mainFit1152->SetParError(1,3.974626e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00378#pm3.97e-05");
   pt_LaTex = pt->AddText("#minus0.0328#pm0.00141");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.673299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.673299,-0.2624873,-8.673299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1153->SetChisquare(1.684982);
   ...
   mainFit1153->SetParameter(0,-0.03281543);
   mainFit1153->SetParError(0,0.001405288);
   mainFit1153->SetParLimits(0,0,0);
   mainFit1153->SetParameter(1,-0.0037835);
   mainFit1153->SetParError(1,3.974626e-05);
