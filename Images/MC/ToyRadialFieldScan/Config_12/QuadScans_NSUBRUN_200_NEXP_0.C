...
//=========  (Fri Oct 16 07:57:18 2020) by ROOT version 6.22/02
   ...
   0.01042751,
   0.01042751};
   TGraphErrors *gre = new TGraphErrors(3,-50.000000 ppm_fx1099,-50.000000 ppm_fy1099,-50.000000 ppm_fex1099,-50.000000 ppm_fey1099);
   ...
   quadLineFit1100->SetChisquare(3.850796);
   ...
   quadLineFit1100->SetParameter(0,-5.616204);
   quadLineFit1100->SetParError(0,0.0666321);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.1545258);
   quadLineFit1100->SetParError(1,0.003686643);
   ...
   quadLineFit1101->SetChisquare(3.850796);
   ...
   quadLineFit1101->SetParameter(0,-5.616204);
   quadLineFit1101->SetParError(0,0.0666321);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.1545258);
   quadLineFit1101->SetParError(1,0.003686643);
   quadLineFit1101->SetParLimits(1,0,0);
   quadLineFit1101->Draw("same");
   
   Double_t -25.000000 ppm_fx1101[3] = {
   16,
   18,
   20};
   Double_t -25.000000 ppm_fy1101[3] = {
   -1.295848,
   -1.150545,
   -1.015374};
   Double_t -25.000000 ppm_fex1101[3] = {
   0,
   0,
   0};
   Double_t -25.000000 ppm_fey1101[3] = {
   0.01042751,
   0.01042751,
   0.01042751};
   gre = new TGraphErrors(3,-25.000000 ppm_fx1101,-25.000000 ppm_fy1101,-25.000000 ppm_fex1101,-25.000000 ppm_fey1101);
   ...
   Graph_mI25dO000000sPppm1101->SetMinimum(-1.336409);
   Graph_mI25dO000000sPppm1101->SetMaximum(-0.9748135);
   ...
   quadLineFit1102->SetChisquare(0.1573552);
   ...
   quadLineFit1102->SetParameter(0,-2.416057);
   quadLineFit1102->SetParError(0,0.06663275);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,0.07011861);
   quadLineFit1102->SetParError(1,0.003686679);
   ...
   quadLineFit1103->SetChisquare(0.1573552);
   ...
   quadLineFit1103->SetParameter(0,-2.416057);
   quadLineFit1103->SetParError(0,0.06663275);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,0.07011861);
   quadLineFit1103->SetParError(1,0.003686679);
   quadLineFit1103->SetParLimits(1,0,0);
   quadLineFit1103->Draw("same");
   
   Double_t 0.000000 ppm_fx1103[3] = {
   16,
   18,
   20};
   Double_t 0.000000 ppm_fy1103[3] = {
   0.5899593,
   0.5469236,
   0.4781858};
   Double_t 0.000000 ppm_fex1103[3] = {
   0,
   0,
   0};
   Double_t 0.000000 ppm_fey1103[3] = {
   0.01042751,
   0.01042751,
   0.01042751};
   gre = new TGraphErrors(3,0.000000 ppm_fx1103,0.000000 ppm_fy1103,0.000000 ppm_fex1103,0.000000 ppm_fey1103);
   ...
   Graph_0dO000000sPppm1103->SetMinimum(0.4544954);
   Graph_0dO000000sPppm1103->SetMaximum(0.6136497);
   ...
   quadLineFit1104->SetChisquare(1.01257);
   ...
   quadLineFit1104->SetParameter(0,1.041337);
   quadLineFit1104->SetParError(0,0.0666309);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.02794338);
   quadLineFit1104->SetParError(1,0.003686576);
   ...
   quadLineFit1105->SetChisquare(1.01257);
   ...
   quadLineFit1105->SetParameter(0,1.041337);
   quadLineFit1105->SetParError(0,0.0666309);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.02794338);
   quadLineFit1105->SetParError(1,0.003686576);
   quadLineFit1105->SetParLimits(1,0,0);
   quadLineFit1105->Draw("same");
   
   Double_t 25.000000 ppm_fx1105[3] = {
   16,
   18,
   20};
   Double_t 25.000000 ppm_fy1105[3] = {
   2.485295,
   2.19459,
   2.000545};
   Double_t 25.000000 ppm_fex1105[3] = {
   0,
   0,
   0};
   Double_t 25.000000 ppm_fey1105[3] = {
   0.01042751,
   0.01042751,
   0.01042751};
   gre = new TGraphErrors(3,25.000000 ppm_fx1105,25.000000 ppm_fy1105,25.000000 ppm_fex1105,25.000000 ppm_fey1105);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   Graph_25dO000000sPppm1105->SetMinimum(1.939558);
   Graph_25dO000000sPppm1105->SetMaximum(2.546283);
   ...
   quadLineFit1106->SetChisquare(14.32137);
   ...
   quadLineFit1106->SetParameter(0,4.408182);
   quadLineFit1106->SetParError(0,0.06663083);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,-0.1211873);
   quadLineFit1106->SetParError(1,0.003686572);
   ...
   quadLineFit1107->SetChisquare(14.32137);
   ...
   quadLineFit1107->SetParameter(0,4.408182);
   quadLineFit1107->SetParError(0,0.06663083);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,-0.1211873);
   quadLineFit1107->SetParError(1,0.003686572);
   ...
   Graph_50dO000000sPppm1107->SetMinimum(3.401566);
   Graph_50dO000000sPppm1107->SetMaximum(4.461002);
   ...
   quadLineFit1108->SetChisquare(17.6474);
   ...
   quadLineFit1108->SetParameter(0,7.792441);
   quadLineFit1108->SetParError(0,0.06663449);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,-0.2155022);
   quadLineFit1108->SetParError(1,0.003686776);
   ...
   quadLineFit1109->SetChisquare(17.6474);
   ...
   quadLineFit1109->SetParameter(0,7.792441);
   quadLineFit1109->SetParError(0,0.06663449);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,-0.2155022);
   quadLineFit1109->SetParError(1,0.003686776);
