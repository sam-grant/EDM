...
//=========  (Fri Oct 16 07:57:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3226943,75,0.2571693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01081->SetMinimum(-0.2647079);
   Graph_Graph01081->SetMaximum(0.1991829);
   ...
   mainFit1082->SetChisquare(0.5619796);
   ...
   mainFit1082->SetParameter(0,-0.0313677);
   mainFit1082->SetParError(0,0.001904936);
   mainFit1082->SetParLimits(0,0,0);
   mainFit1082->SetParameter(1,-0.003781911);
   mainFit1082->SetParError(1,5.387953e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00378#pm5.39e-05");
   pt_LaTex = pt->AddText("#minus0.0314#pm0.0019");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.294141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.294141,-0.2647079,-8.294141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1083->SetChisquare(0.5619796);
   ...
   mainFit1083->SetParameter(0,-0.0313677);
   mainFit1083->SetParError(0,0.001904936);
   mainFit1083->SetParLimits(0,0,0);
   mainFit1083->SetParameter(1,-0.003781911);
   mainFit1083->SetParError(1,5.387953e-05);
