...
//=========  (Wed Jan  5 17:09:16 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01061->SetMinimum(-35.97122);
   Graph_Graph01061->SetMaximum(54.65809);
   ...
   mainFit1062->SetChisquare(1.54214e-13);
   ...
   mainFit1062->SetParameter(0,9.343435);
   mainFit1062->SetParError(0,1.041221);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,1.209657);
   mainFit1062->SetParError(1,0.03470737);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.724038,-35.97122,-7.724038,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(1.54214e-13);
   ...
   mainFit1063->SetParameter(0,9.343435);
   mainFit1063->SetParError(0,1.041221);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,1.209657);
   mainFit1063->SetParError(1,0.03470737);
