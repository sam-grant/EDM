void FieldFitCheck_NSUBRUN_100_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-107.8514,75,398.0067);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-57.2656);
   Graph_Graph01063->SetMaximum(347.4209);
   ...
   checkFit1064->SetChisquare(80563.15);
   ...
   checkFit1064->SetParameter(0,67.20198);
   checkFit1064->SetParError(0,0.3531508);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,-1.524059);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.01e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.09409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.09409,-57.2656,44.09409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(80563.15);
   ...
   checkFit1065->SetParameter(0,67.20198);
   checkFit1065->SetParError(0,0.3531508);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,-1.524059);
