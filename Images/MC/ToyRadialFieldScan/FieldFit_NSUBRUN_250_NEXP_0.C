...
//=========  (Wed Dec  2 23:08:06 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-43.32309,45,64.30199);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01117 = new TH1F("Graph_Graph01117","250 sub-runs",100,-36,36);
   Graph_Graph01117->SetMinimum(-32.56058);
   Graph_Graph01117->SetMaximum(53.53948);
   ...
   Graph_Graph01117->GetXaxis()->SetTitle("#LTB_{r}^{App}#GT [ppm]");
   ...
   Graph_Graph01117->GetYaxis()->SetTitle("#LTy#GT QHV [mm#upointkV]");
   ...
   mainFit1118->SetChisquare(3.480064);
   ...
   mainFit1118->SetParameter(0,9.895292);
   mainFit1118->SetParError(0,0.4150669);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,1.160755);
   mainFit1118->SetParError(1,0.01856222);
   ...
   pt_LaTex = pt->AddText(" 1.16#pm0.0186");
   pt_LaTex = pt->AddText("  9.9#pm0.415");
   pt_LaTex = pt->AddText(" 8.52#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.524875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.524875,-32.56058,-8.524875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetChisquare(3.480064);
   ...
   mainFit1119->SetParameter(0,9.895292);
   mainFit1119->SetParError(0,0.4150669);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,1.160755);
   mainFit1119->SetParError(1,0.01856222);
