void QuadScans_NSUBRUN_132_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:39:43 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.037556,0.0768254,3.856259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_30dO000000sPppm1009 = new TH1F("Graph_30dO000000sPppm1009","",100,0.05396825,0.07301587);
   Graph_30dO000000sPppm1009->SetMinimum(-2.348175);
   Graph_30dO000000sPppm1009->SetMaximum(3.166877);
   ...
   Graph_30dO000000sPppm1009->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   Graph_30dO000000sPppm1009->GetXaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1009->GetXaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1009->GetXaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1009->GetXaxis()->SetTitleOffset(1.1);
   Graph_30dO000000sPppm1009->GetXaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1009->GetYaxis()->SetTitle("#LTy#GT [mm]");
   Graph_30dO000000sPppm1009->GetYaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1009->GetYaxis()->SetNdivisions(4000510);
   Graph_30dO000000sPppm1009->GetYaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1009->GetYaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1009->GetYaxis()->SetTitleOffset(1.1);
   ...
   TF1 *quadLineFit1010 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1010->SetFillColor(19);
   quadLineFit1010->SetFillStyle(0);
   quadLineFit1010->SetLineWidth(2);
   quadLineFit1010->SetChisquare(1.068674e-18);
   ...
   quadLineFit1010->SetParameter(0,-0.07954337);
   quadLineFit1010->SetParError(0,0.07352574);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,47.03481);
   quadLineFit1010->SetParError(1,1.149088);
   quadLineFit1010->SetParLimits(1,0,0);
   quadLineFit1010->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1010);
   gre->Draw("ap");
   
   TF1 *quadLineFit1011 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1011->SetFillColor(19);
   quadLineFit1011->SetFillStyle(0);
   quadLineFit1011->SetLineWidth(2);
   quadLineFit1011->SetChisquare(1.068674e-18);
   ...
   quadLineFit1011->SetParameter(0,-0.07954337);
   quadLineFit1011->SetParError(0,0.07352574);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,47.03481);
   quadLineFit1011->SetParError(1,1.149088);
   ...
   TH1F *Graph_mI30dO000000sPppm1011 = new TH1F("Graph_mI30dO000000sPppm1011","Graph",100,0.05396825,0.07301587);
   Graph_mI30dO000000sPppm1011->SetMinimum(-1.937117);
   Graph_mI30dO000000sPppm1011->SetMaximum(-1.388958);
   ...
   Graph_mI30dO000000sPppm1011->GetXaxis()->SetTitleOffset(1);
   ...
   TF1 *quadLineFit1012 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1012->SetChisquare(3.083687e-19);
   ...
   quadLineFit1012->SetParameter(0,0.06098234);
   quadLineFit1012->SetParError(0,0.07352573);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-27.15331);
   quadLineFit1012->SetParError(1,1.149088);
   quadLineFit1012->SetParLimits(1,0,0);
   quadLineFit1012->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1012);
   gre->Draw("p ");
   
   TF1 *quadLineFit1013 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1013->SetChisquare(3.083687e-19);
   ...
   quadLineFit1013->SetParameter(0,0.06098234);
   quadLineFit1013->SetParError(0,0.07352573);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-27.15331);
   quadLineFit1013->SetParError(1,1.149088);
