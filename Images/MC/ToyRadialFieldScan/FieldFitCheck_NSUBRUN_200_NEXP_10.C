void FieldFitCheck_NSUBRUN_200_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:28 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.9305,75,397.1974);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01127->SetMinimum(-56.5177);
   Graph_Graph01127->SetMaximum(346.7846);
   ...
   checkFit1128->SetChisquare(161757.9);
   ...
   checkFit1128->SetParameter(0,67.09504);
   checkFit1128->SetParError(0,0.2485932);
   checkFit1128->SetParLimits(0,0,0);
   checkFit1128->SetParameter(1,-1.529444);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("4.04e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.86892,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.86892,-56.5177,43.86892,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1129->SetChisquare(161757.9);
   ...
   checkFit1129->SetParameter(0,67.09504);
   checkFit1129->SetParError(0,0.2485932);
   checkFit1129->SetParLimits(0,0,0);
   checkFit1129->SetParameter(1,-1.529444);
