...
//=========  (Thu May  5 12:48:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-44.20052,75,77.50557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-32.02991);
   Graph_Graph01015->SetMaximum(65.33496);
   ...
   checkFit1016->SetChisquare(6.483151);
   checkFit1016->SetNDF(3);
   ...
   checkFit1016->SetParameter(0,7.429545);
   checkFit1016->SetParError(0,0.8240133);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,1.003436);
   checkFit1016->SetParError(1,0.02746711);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.404106,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.404106,-32.02991,-7.404106,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(6.483151);
   checkFit1017->SetNDF(3);
   ...
   checkFit1017->SetParameter(0,7.429545);
   checkFit1017->SetParError(0,0.8240133);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,1.003436);
   checkFit1017->SetParError(1,0.02746711);
