...
//=========  (Wed Jan  5 17:06:49 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-40.72536,45,56.69603);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-30.98322);
   Graph_Graph01007->SetMaximum(46.95389);
   ...
   checkFit1008->SetChisquare(2.140725e-18);
   ...
   checkFit1008->SetParameter(1,1.008964);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.914389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.914389,-30.98322,-7.914389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(2.140725e-18);
   ...
   checkFit1009->SetParameter(1,1.008964);
