...
//=========  (Wed Jan  5 17:35:45 2022) by ROOT version 6.24/06
   ...
   TH1D *__35 = new TH1D("__35","Number of sub-runs: 792",2400,0.4,1.6);
   __35->SetBinContent(2401,1000);
   __35->SetEntries(1000);
   __35->SetStats(0);
   __35->GetXaxis()->SetTitle("Fitted #delta#LTB_{r}^{b}#GT [ppm]");
   __35->GetXaxis()->SetRange(1,2400);
   ...
   __35->GetYaxis()->SetTitle("Trials / 0.000500 ppm");
