void FieldFitCheck_NSUBRUN_100_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-104.2474,75,396.9832);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-54.12429);
   Graph_Graph01063->SetMaximum(346.8602);
   ...
   checkFit1064->SetChisquare(79420.03);
   ...
   checkFit1064->SetParameter(0,67.70094);
   checkFit1064->SetParError(0,0.3531508);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,-1.533216);
   checkFit1064->SetParError(1,0.0103392);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("1.99e+04");
   pt_LaTex = pt->AddText("-1.53
#pm0.01
");
   pt_LaTex = pt->AddText("67.7
#pm0.4
");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.15615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.15615,-54.12429,44.15615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(79420.03);
   ...
   checkFit1065->SetParameter(0,67.70094);
   checkFit1065->SetParError(0,0.3531508);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,-1.533216);
   checkFit1065->SetParError(1,0.0103392);
