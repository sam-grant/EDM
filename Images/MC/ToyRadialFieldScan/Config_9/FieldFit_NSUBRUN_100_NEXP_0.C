...
//=========  (Fri Oct 16 07:54:39 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2056527,45,0.132643);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.005223539,
   0.005223273};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1037,Graph0_fy1037,Graph0_fex1037,Graph0_fey1037);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 100");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","Sub-runs 100",100,-36,36);
   Graph_Graph01037->SetMinimum(-0.1718231);
   Graph_Graph01037->SetMaximum(0.09881339);
   ...
   TF1 *mainFit1038 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   mainFit1038->SetChisquare(5.930103);
   mainFit1038->SetNDF(1);
   ...
   mainFit1038->SetParameter(0,-0.03131176);
   mainFit1038->SetParError(0,0.003015712);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,-0.003584718);
   mainFit1038->SetParError(1,0.000123117);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 5.93");
   pt_LaTex = pt->AddText("#minus0.00358#pm0.000123");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00302");
   pt_LaTex = pt->AddText("#minus8.73#pm0.893");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.734788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.734788,-0.1718231,-8.734788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *mainFit1039 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   mainFit1039->SetChisquare(5.930103);
   mainFit1039->SetNDF(1);
   ...
   mainFit1039->SetParameter(0,-0.03131176);
   mainFit1039->SetParError(0,0.003015712);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,-0.003584718);
   mainFit1039->SetParError(1,0.000123117);
