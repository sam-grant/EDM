...
//=========  (Fri Oct 16 07:54:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.04455,45,54.60401);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1129[3] = {
   -30,
   30,
   0};
   Double_t Graph0_fy1129[3] = {
   -20.16897,
   38.72843,
   6.778461};
   Double_t Graph0_fex1129[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1129[3] = {
   0.7674827,
   0.7674827,
   0.7674827};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1129,Graph0_fy1129,Graph0_fex1129,Graph0_fey1129);
   gre->SetName("Graph0");
   ...
   Graph_Graph01129->SetMinimum(-26.97969);
   Graph_Graph01129->SetMaximum(45.53915);
   ...
   TF1 *checkFit1130 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1130->SetChisquare(7.080968);
   checkFit1130->SetNDF(1);
   ...
   checkFit1130->SetParameter(0,8.445974);
   checkFit1130->SetParError(0,0.4431064);
   checkFit1130->SetParLimits(0,0,0);
   checkFit1130->SetParameter(1,0.9816234);
   checkFit1130->SetParError(1,0.01808974);
   ...
   pt_LaTex = pt->AddText("0.982#pm0.0181");
   pt_LaTex = pt->AddText(" 8.45#pm0.443");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.604088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.604088,-26.97969,-8.604088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1131 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1131->SetChisquare(7.080968);
   checkFit1131->SetNDF(1);
   ...
   checkFit1131->SetParameter(0,8.445974);
   checkFit1131->SetParError(0,0.4431064);
   checkFit1131->SetParLimits(0,0,0);
   checkFit1131->SetParameter(1,0.9816234);
   checkFit1131->SetParError(1,0.01808974);
