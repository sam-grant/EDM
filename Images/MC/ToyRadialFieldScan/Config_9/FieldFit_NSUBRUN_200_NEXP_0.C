...
//=========  (Fri Oct 16 07:54:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2129696,45,0.1456649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1077[3] = {
   -30,
   30,
   0};
   Double_t Graph0_fy1077[3] = {
   0.08220581,
   -0.1495106,
   -0.03205526};
   Double_t Graph0_fex1077[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1077[3] = {
   0.003686686,
   0.00368658,
   0.003686683};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1077,Graph0_fy1077,Graph0_fex1077,Graph0_fey1077);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 200");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","Sub-runs 200",100,-36,36);
   Graph_Graph01077->SetMinimum(-0.1771061);
   Graph_Graph01077->SetMaximum(0.1098015);
   ...
   mainFit1078->SetChisquare(0.1251182);
   mainFit1078->SetNDF(1);
   ...
   mainFit1078->SetParameter(0,-0.03312002);
   mainFit1078->SetParError(0,0.002128489);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,-0.003861941);
   mainFit1078->SetParError(1,8.689478e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.125");
   pt_LaTex = pt->AddText("#minus0.00386#pm8.69e-05");
   pt_LaTex = pt->AddText("#minus0.0331#pm0.00213");
   pt_LaTex = pt->AddText("#minus8.58#pm0.584");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.576005,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.576005,-0.1771061,-8.576005,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(0.1251182);
   mainFit1079->SetNDF(1);
   ...
   mainFit1079->SetParameter(0,-0.03312002);
   mainFit1079->SetParError(0,0.002128489);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,-0.003861941);
   mainFit1079->SetParError(1,8.689478e-05);
