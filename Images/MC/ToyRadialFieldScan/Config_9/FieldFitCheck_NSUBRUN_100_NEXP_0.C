...
//=========  (Fri Oct 16 07:54:39 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-35.22207,45,54.60905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-26.23896);
   Graph_Graph01039->SetMaximum(45.62594);
   ...
   checkFit1040->SetChisquare(5.930178);
   checkFit1040->SetNDF(1);
   ...
   checkFit1040->SetParameter(0,8.314591);
   checkFit1040->SetParError(0,0.8007817);
   checkFit1040->SetParLimits(0,0,0);
   checkFit1040->SetParameter(1,0.9518904);
   checkFit1040->SetParError(1,0.03269178);
   ...
   pt_LaTex = pt->AddText("0.952#pm0.0327");
   pt_LaTex = pt->AddText(" 8.31#pm0.801");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.73482,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.73482,-26.23896,-8.73482,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(5.930178);
   checkFit1041->SetNDF(1);
   ...
   checkFit1041->SetParameter(0,8.314591);
   checkFit1041->SetParError(0,0.8007817);
   checkFit1041->SetParLimits(0,0,0);
   checkFit1041->SetParameter(1,0.9518904);
   checkFit1041->SetParError(1,0.03269178);
