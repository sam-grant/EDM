...
//=========  (Fri Oct 16 07:54:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,5.51373,1.491396e+07,10.54122);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01131->SetMinimum(6.016479);
   Graph_Graph01131->SetMaximum(10.03847);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,10.03847,1.325685e+07,10.03847,0,344.5,510,"-");
