...
//=========  (Fri Oct 16 07:54:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.67995,45,56.5521);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-29.15675);
   Graph_Graph01079->SetMaximum(47.0289);
   ...
   checkFit1080->SetChisquare(0.1251171);
   checkFit1080->SetNDF(1);
   ...
   checkFit1080->SetParameter(0,8.794707);
   checkFit1080->SetParError(0,0.565205);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,1.025502);
   checkFit1080->SetParError(1,0.0230744);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0231");
   pt_LaTex = pt->AddText(" 8.79#pm0.565");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.576004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.576004,-29.15675,-8.576004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(0.1251171);
   checkFit1081->SetNDF(1);
   ...
   checkFit1081->SetParameter(0,8.794707);
   checkFit1081->SetParError(0,0.565205);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,1.025502);
   checkFit1081->SetParError(1,0.0230744);
