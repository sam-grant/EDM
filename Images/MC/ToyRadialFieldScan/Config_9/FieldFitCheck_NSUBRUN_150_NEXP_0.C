...
//=========  (Fri Oct 16 07:54:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.14835,45,52.86138);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1059[3] = {
   -30,
   30,
   0};
   Double_t Graph0_fy1059[3] = {
   -20.18231,
   36.89534,
   8.101715};
   Double_t Graph0_fex1059[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1059[3] = {
   1.13108,
   1.13108,
   1.13108};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1059,Graph0_fy1059,Graph0_fex1059,Graph0_fey1059);
   gre->SetName("Graph0");
   ...
   Graph_Graph01059->SetMinimum(-27.24737);
   Graph_Graph01059->SetMaximum(43.9604);
   ...
   checkFit1060->SetChisquare(0.03383156);
   checkFit1060->SetNDF(1);
   ...
   checkFit1060->SetParameter(0,8.271582);
   checkFit1060->SetParError(0,0.6530296);
   checkFit1060->SetParLimits(0,0,0);
   checkFit1060->SetParameter(1,0.9512942);
   checkFit1060->SetParError(1,0.02665982);
   ...
   pt_LaTex = pt->AddText("0.951#pm0.0267");
   pt_LaTex = pt->AddText(" 8.27#pm0.653");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.695083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.695083,-27.24737,-8.695083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1061->SetChisquare(0.03383156);
   checkFit1061->SetNDF(1);
   ...
   checkFit1061->SetParameter(0,8.271582);
   checkFit1061->SetParError(0,0.6530296);
   checkFit1061->SetParLimits(0,0,0);
   checkFit1061->SetParameter(1,0.9512942);
   checkFit1061->SetParError(1,0.02665982);
