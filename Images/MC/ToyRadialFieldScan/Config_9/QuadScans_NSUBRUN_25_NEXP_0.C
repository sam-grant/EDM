...
//=========  (Fri Oct 16 07:54:37 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_30dO000000sPppm1003 = new TH1F("Graph_30dO000000sPppm1003","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1003->SetMinimum(2.175229);
   Graph_30dO000000sPppm1003->SetMaximum(2.921992);
   ...
   quadLineFit1004->SetChisquare(0.1651469);
   ...
   quadLineFit1004->SetParameter(0,5.090799);
   quadLineFit1004->SetParError(0,0.186751);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-0.1409633);
   quadLineFit1004->SetParError(1,0.01033262);
   ...
   quadLineFit1005->SetChisquare(0.1651469);
   ...
   quadLineFit1005->SetParameter(0,5.090799);
   quadLineFit1005->SetParError(0,0.186751);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-0.1409633);
   quadLineFit1005->SetParError(1,0.01033262);
