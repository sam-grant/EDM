...
//=========  (Fri Oct 16 07:54:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1990706,45,0.1361312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1057[3] = {
   -30,
   30,
   0};
   Double_t Graph0_fy1057[3] = {
   0.07600462,
   -0.1389443,
   -0.03051027};
   Double_t Graph0_fex1057[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1057[3] = {
   0.004259599,
   0.004259393,
   0.004259487};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1057,Graph0_fy1057,Graph0_fex1057,Graph0_fey1057);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 150");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","Sub-runs 150",100,-36,36);
   Graph_Graph01057->SetMinimum(-0.1655505);
   Graph_Graph01057->SetMaximum(0.102611);
   ...
   mainFit1058->SetChisquare(0.03383235);
   mainFit1058->SetNDF(1);
   ...
   mainFit1058->SetParameter(0,-0.03114997);
   mainFit1058->SetParError(0,0.002459219);
   mainFit1058->SetParLimits(0,0,0);
   mainFit1058->SetParameter(1,-0.003582482);
   mainFit1058->SetParError(1,0.0001003973);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0338");
   pt_LaTex = pt->AddText("#minus0.00358#pm0.0001");
   pt_LaTex = pt->AddText("#minus0.0311#pm0.00246");
   pt_LaTex = pt->AddText(" #minus8.7#pm0.728");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.695081,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.695081,-0.1655505,-8.695081,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1059->SetChisquare(0.03383235);
   mainFit1059->SetNDF(1);
   ...
   mainFit1059->SetParameter(0,-0.03114997);
   mainFit1059->SetParError(0,0.002459219);
   mainFit1059->SetParLimits(0,0,0);
   mainFit1059->SetParameter(1,-0.003582482);
   mainFit1059->SetParError(1,0.0001003973);
