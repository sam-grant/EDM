...
//=========  (Fri Oct 16 07:54:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1972413,45,0.1383231);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t Graph0_fx1117[3] = {
   -30,
   30,
   0};
   Double_t Graph0_fy1117[3] = {
   0.07938743,
   -0.1383056,
   -0.03913433};
   Double_t Graph0_fex1117[3] = {
   0,
   0,
   0};
   Double_t Graph0_fey1117[3] = {
   0.003008262,
   0.003008269,
   0.003008218};
   TGraphErrors *gre = new TGraphErrors(3,Graph0_fx1117,Graph0_fy1117,Graph0_fex1117,Graph0_fey1117);
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 300");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01117 = new TH1F("Graph_Graph01117","Sub-runs 300",100,-36,36);
   Graph_Graph01117->SetMinimum(-0.1636849);
   Graph_Graph01117->SetMaximum(0.1047667);
   ...
   mainFit1118->SetChisquare(6.89617);
   mainFit1118->SetNDF(1);
   ...
   mainFit1118->SetParameter(0,-0.03268409);
   mainFit1118->SetParError(0,0.001736814);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.003628216);
   mainFit1118->SetParError(1,7.09055e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00363#pm7.09e-05");
   pt_LaTex = pt->AddText("#minus0.0327#pm0.00174");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-9.00831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.00831,-0.1636849,-9.00831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetChisquare(6.89617);
   mainFit1119->SetNDF(1);
   ...
   mainFit1119->SetParameter(0,-0.03268409);
   mainFit1119->SetParError(0,0.001736814);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.003628216);
   mainFit1119->SetParError(1,7.09055e-05);
