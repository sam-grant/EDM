void FieldFitCheck_NSUBRUN_25_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.6029,75,400.0995);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-55.93261);
   Graph_Graph01015->SetMaximum(349.4293);
   ...
   checkFit1016->SetChisquare(19984.82);
   ...
   checkFit1016->SetParameter(0,68.44479);
   checkFit1016->SetParError(0,0.7091977);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,-1.520128);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("5e+03");
   pt_LaTex = pt->AddText("-1.52
#pm0.02
");
   pt_LaTex = pt->AddText("68.4
#pm0.7
");
   pt_LaTex = pt->AddText("-45
#pm0.8
");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,45.02567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(45.02567,-55.93261,45.02567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(19984.82);
   ...
   checkFit1017->SetParameter(0,68.44479);
   checkFit1017->SetParError(0,0.7091977);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,-1.520128);
