...
//=========  (Wed Jan  5 17:06:59 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.070591,0.0768254,3.864221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1065->SetMinimum(-2.377109);
   Graph_30dO000000sPppm1065->SetMaximum(3.17074);
   ...
   quadLineFit1066->SetChisquare(5.907863e-19);
   ...
   quadLineFit1066->SetParameter(1,44.85759);
   quadLineFit1066->SetParError(1,0.8776724);
   ...
   quadLineFit1067->SetChisquare(5.907863e-19);
   ...
   quadLineFit1067->SetParameter(1,44.85759);
   quadLineFit1067->SetParError(1,0.8776724);
   ...
   Graph_mI30dO000000sPppm1067->SetMinimum(-1.956846);
   Graph_mI30dO000000sPppm1067->SetMaximum(-1.413161);
   ...
   quadLineFit1068->SetChisquare(3.397643e-18);
   ...
   quadLineFit1068->SetParameter(1,-27.30221);
   quadLineFit1068->SetParError(1,0.8776724);
   ...
   quadLineFit1069->SetChisquare(3.397643e-18);
   ...
   quadLineFit1069->SetParameter(1,-27.30221);
   quadLineFit1069->SetParError(1,0.8776724);
