...
//=========  (Fri Oct  9 09:35:41 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1081->SetMaximum(2.5);
   ...
   quadLineFit1082->SetChisquare(7.724928e-18);
   ...
   quadLineFit1082->SetParameter(0,-4.202181);
   quadLineFit1082->SetParError(0,0.06293588);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.1149857);
   ...
   quadLineFit1083->SetChisquare(7.724928e-18);
   ...
   quadLineFit1083->SetParameter(0,-4.202181);
   quadLineFit1083->SetParError(0,0.06293588);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.1149857);
   ...
   Graph_mI10dO000000sPppm1083->SetMinimum(-1.147704);
   Graph_mI10dO000000sPppm1083->SetMaximum(-0.877252);
   ...
   quadLineFit1084->SetChisquare(7.009715e-23);
   ...
   quadLineFit1084->SetParameter(0,-1.938212);
   quadLineFit1084->SetParError(0,0.06293588);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.05142969);
   quadLineFit1084->SetParError(1,0.003475052);
   ...
   quadLineFit1085->SetChisquare(7.009715e-23);
   ...
   quadLineFit1085->SetParameter(0,-1.938212);
   quadLineFit1085->SetParError(0,0.06293588);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.05142969);
   quadLineFit1085->SetParError(1,0.003475052);
   ...
   Graph_10dO000000sPppm1085->SetMinimum(0.0968089);
   Graph_10dO000000sPppm1085->SetMaximum(0.1311226);
   ...
   quadLineFit1086->SetChisquare(1.095808e-22);
   ...
   quadLineFit1086->SetParameter(0,0.1541816);
   quadLineFit1086->SetParError(0,0.06293588);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-0.002234215);
   ...
   quadLineFit1087->SetChisquare(1.095808e-22);
   ...
   quadLineFit1087->SetParameter(0,0.1541816);
   quadLineFit1087->SetParError(0,0.06293588);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-0.002234215);
   ...
   Graph_30dO000000sPppm1087->SetMinimum(1.060104);
   Graph_30dO000000sPppm1087->SetMaximum(1.403312);
   ...
   quadLineFit1088->SetChisquare(8.333242e-23);
   ...
   quadLineFit1088->SetParameter(0,2.430279);
   quadLineFit1088->SetParError(0,0.06293588);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.06658729);
   ...
   quadLineFit1089->SetChisquare(8.333242e-23);
   ...
   quadLineFit1089->SetParameter(0,2.430279);
   quadLineFit1089->SetParError(0,0.06293588);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.06658729);
