...
//=========  (Mon Oct 12 20:04:24 2020) by ROOT version 6.22/02
   ...
   quadLineFit1082->SetChisquare(2.548262e-19);
   ...
   quadLineFit1082->SetParameter(0,-2.934408);
   quadLineFit1082->SetParError(0,0.06293588);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.08015226);
   ...
   quadLineFit1083->SetChisquare(2.548262e-19);
   ...
   quadLineFit1083->SetParameter(0,-2.934408);
   quadLineFit1083->SetParError(0,0.06293588);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.08015226);
   ...
   Graph_mI10dO000000sPppm1083->SetMinimum(-0.1737438);
   Graph_mI10dO000000sPppm1083->SetMaximum(-0.0947062);
   ...
   quadLineFit1084->SetChisquare(6.709833e-20);
   ...
   quadLineFit1084->SetParameter(0,-0.3421556);
   quadLineFit1084->SetParError(0,0.06293588);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.0115517);
   ...
   quadLineFit1085->SetChisquare(6.709833e-20);
   ...
   quadLineFit1085->SetParameter(0,-0.3421556);
   quadLineFit1085->SetParError(0,0.06293588);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.0115517);
   ...
   Graph_10dO000000sPppm1085->SetMinimum(1.022269);
   Graph_10dO000000sPppm1085->SetMaximum(1.400366);
   ...
   quadLineFit1086->SetChisquare(1.651202e-18);
   ...
   quadLineFit1086->SetParameter(0,2.540721);
   quadLineFit1086->SetParError(0,0.06293588);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-0.07385574);
   ...
   quadLineFit1087->SetChisquare(1.651202e-18);
   ...
   quadLineFit1087->SetParameter(0,2.540721);
   quadLineFit1087->SetParError(0,0.06293588);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-0.07385574);
   ...
   Graph_30dO000000sPppm1087->SetMinimum(2.205661);
   Graph_30dO000000sPppm1087->SetMaximum(2.951088);
   ...
   quadLineFit1088->SetChisquare(1.008633e-17);
   ...
   quadLineFit1088->SetParameter(0,5.285265);
   quadLineFit1088->SetParError(0,0.06293588);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.1503828);
   ...
   quadLineFit1089->SetChisquare(1.008633e-17);
   ...
   quadLineFit1089->SetParameter(0,5.285265);
   quadLineFit1089->SetParError(0,0.06293588);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.1503828);
