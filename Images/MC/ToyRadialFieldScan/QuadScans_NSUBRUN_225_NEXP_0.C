...
//=========  (Fri Oct  9 18:33:03 2020) by ROOT version 6.22/02
   ...
   quadLineFit1082->SetChisquare(4.330991e-20);
   ...
   quadLineFit1082->SetParameter(0,-3.028375);
   quadLineFit1082->SetParError(0,0.06293588);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.08491886);
   ...
   quadLineFit1083->SetChisquare(4.330991e-20);
   ...
   quadLineFit1083->SetParameter(0,-3.028375);
   quadLineFit1083->SetParError(0,0.06293588);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.08491886);
   ...
   Graph_mI10dO000000sPppm1083->SetMinimum(-0.1702862);
   Graph_mI10dO000000sPppm1083->SetMaximum(-0.09043602);
   ...
   quadLineFit1084->SetChisquare(5.541893e-23);
   ...
   quadLineFit1084->SetParameter(0,-0.341339);
   quadLineFit1084->SetParError(0,0.06293588);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.01172099);
   ...
   quadLineFit1085->SetChisquare(5.541893e-23);
   ...
   quadLineFit1085->SetParameter(0,-0.341339);
   quadLineFit1085->SetParError(0,0.06293588);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.01172099);
   ...
   Graph_10dO000000sPppm1085->SetMinimum(1.043421);
   Graph_10dO000000sPppm1085->SetMaximum(1.412439);
   ...
   quadLineFit1086->SetChisquare(6.623451e-21);
   ...
   quadLineFit1086->SetParameter(0,2.523286);
   quadLineFit1086->SetParError(0,0.06293588);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-0.07196422);
   ...
   quadLineFit1087->SetChisquare(6.623451e-21);
   ...
   quadLineFit1087->SetParameter(0,2.523286);
   quadLineFit1087->SetParError(0,0.06293588);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-0.07196422);
   ...
   Graph_30dO000000sPppm1087->SetMinimum(2.227125);
   Graph_30dO000000sPppm1087->SetMaximum(2.939519);
   ...
   quadLineFit1088->SetChisquare(1.443186e-19);
   ...
   quadLineFit1088->SetParameter(0,5.166341);
   quadLineFit1088->SetParError(0,0.06293588);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.1435011);
   ...
   quadLineFit1089->SetChisquare(1.443186e-19);
   ...
   quadLineFit1089->SetParameter(0,5.166341);
   quadLineFit1089->SetParError(0,0.06293588);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.1435011);
