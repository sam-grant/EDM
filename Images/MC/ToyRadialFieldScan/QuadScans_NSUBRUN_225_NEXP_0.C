...
//=========  (Thu Oct  8 17:32:48 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1081->SetMinimum(-3);
   Graph_mI30dO000000sPppm1081->SetMaximum(2);
   ...
   quadLineFit1082->SetChisquare(2.849957e-19);
   ...
   quadLineFit1082->SetParameter(0,-3.362774);
   quadLineFit1082->SetParError(0,0.06293588);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.09356676);
   ...
   quadLineFit1083->SetChisquare(2.849957e-19);
   ...
   quadLineFit1083->SetParameter(0,-3.362774);
   quadLineFit1083->SetParError(0,0.06293588);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.09356676);
   ...
   Graph_mI10dO000000sPppm1083->SetMinimum(-0.6633107);
   Graph_mI10dO000000sPppm1083->SetMaximum(-0.4860688);
   ...
   quadLineFit1084->SetChisquare(9.509943e-21);
   ...
   quadLineFit1084->SetParameter(0,-1.150887);
   quadLineFit1084->SetParError(0,0.06293588);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.03201094);
   ...
   quadLineFit1085->SetChisquare(9.509943e-21);
   ...
   quadLineFit1085->SetParameter(0,-1.150887);
   quadLineFit1085->SetParError(0,0.06293588);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.03201094);
   ...
   Graph_10dO000000sPppm1085->SetMinimum(0.4956114);
   Graph_10dO000000sPppm1085->SetMaximum(0.6430681);
   ...
   quadLineFit1086->SetChisquare(2.644336e-19);
   ...
   quadLineFit1086->SetParameter(0,1.033842);
   quadLineFit1086->SetParError(0,0.06293588);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-0.02580568);
   ...
   quadLineFit1087->SetChisquare(2.644336e-19);
   ...
   quadLineFit1087->SetParameter(0,1.033842);
   quadLineFit1087->SetParError(0,0.06293588);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-0.02580568);
   ...
   Graph_30dO000000sPppm1087->SetMinimum(1.446986);
   Graph_30dO000000sPppm1087->SetMaximum(1.947371);
   ...
   quadLineFit1088->SetChisquare(5.86424e-20);
   ...
   quadLineFit1088->SetParameter(0,3.485164);
   quadLineFit1088->SetParError(0,0.06293588);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.0993325);
   ...
   quadLineFit1089->SetChisquare(5.86424e-20);
   ...
   quadLineFit1089->SetParameter(0,3.485164);
   quadLineFit1089->SetParError(0,0.06293588);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.0993325);
