void QuadScans_NSUBRUN_80_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:16 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.069655,0.0768254,3.89356);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_30dO000000sPppm1057 = new TH1F("Graph_30dO000000sPppm1057","",100,0.05396825,0.07301587);
   Graph_30dO000000sPppm1057->SetMinimum(-2.373333);
   Graph_30dO000000sPppm1057->SetMaximum(3.197238);
   ...
   Graph_30dO000000sPppm1057->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   Graph_30dO000000sPppm1057->GetXaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1057->GetXaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1057->GetXaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1057->GetXaxis()->SetTitleOffset(1.1);
   Graph_30dO000000sPppm1057->GetXaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1057->GetYaxis()->SetTitle("#LTy#GT [mm]");
   Graph_30dO000000sPppm1057->GetYaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1057->GetYaxis()->SetNdivisions(4000510);
   Graph_30dO000000sPppm1057->GetYaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1057->GetYaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1057->GetYaxis()->SetTitleOffset(1.1);
   ...
   TF1 *quadLineFit1058 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1058->SetFillColor(19);
   quadLineFit1058->SetFillStyle(0);
   quadLineFit1058->SetLineWidth(2);
   quadLineFit1058->SetChisquare(1.483491e-18);
   ...
   quadLineFit1058->SetParameter(0,0.02261607);
   quadLineFit1058->SetParError(0,0.09422021);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,45.63314);
   quadLineFit1058->SetParError(1,1.472509);
   quadLineFit1058->SetParLimits(1,0,0);
   quadLineFit1058->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1058);
   gre->Draw("ap");
   
   TF1 *quadLineFit1059 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1059->SetFillColor(19);
   quadLineFit1059->SetFillStyle(0);
   quadLineFit1059->SetLineWidth(2);
   quadLineFit1059->SetChisquare(1.483491e-18);
   ...
   quadLineFit1059->SetParameter(0,0.02261607);
   quadLineFit1059->SetParError(0,0.09422021);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,45.63314);
   quadLineFit1059->SetParError(1,1.472509);
   ...
   TH1F *Graph_mI30dO000000sPppm1059 = new TH1F("Graph_mI30dO000000sPppm1059","Graph",100,0.05396825,0.07301587);
   Graph_mI30dO000000sPppm1059->SetMinimum(-1.961271);
   Graph_mI30dO000000sPppm1059->SetMaximum(-1.408343);
   Graph_mI30dO000000sPppm1059->SetDirectory(0);
   Graph_mI30dO000000sPppm1059->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_mI30dO000000sPppm1059->SetLineColor(ci);
   Graph_mI30dO000000sPppm1059->GetXaxis()->SetLabelFont(42);
   Graph_mI30dO000000sPppm1059->GetXaxis()->SetTitleOffset(1);
   Graph_mI30dO000000sPppm1059->GetXaxis()->SetTitleFont(42);
   Graph_mI30dO000000sPppm1059->GetYaxis()->SetLabelFont(42);
   Graph_mI30dO000000sPppm1059->GetYaxis()->SetTitleFont(42);
   Graph_mI30dO000000sPppm1059->GetZaxis()->SetLabelFont(42);
   Graph_mI30dO000000sPppm1059->GetZaxis()->SetTitleOffset(1);
   Graph_mI30dO000000sPppm1059->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_-30.000000 ppm1059);
   
   
   TF1 *quadLineFit1060 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1060->SetChisquare(7.83257e-20);
   ...
   quadLineFit1060->SetParameter(0,0.02606712);
   quadLineFit1060->SetParError(0,0.09422021);
   quadLineFit1060->SetParLimits(0,0,0);
   quadLineFit1060->SetParameter(1,-26.94627);
   quadLineFit1060->SetParError(1,1.472509);
   quadLineFit1060->SetParLimits(1,0,0);
   quadLineFit1060->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1060);
   gre->Draw("p ");
   
   TF1 *quadLineFit1061 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1061->SetChisquare(7.83257e-20);
   ...
   quadLineFit1061->SetParameter(0,0.02606712);
   quadLineFit1061->SetParError(0,0.09422021);
   quadLineFit1061->SetParLimits(0,0,0);
   quadLineFit1061->SetParameter(1,-26.94627);
   quadLineFit1061->SetParError(1,1.472509);
