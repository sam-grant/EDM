void QuadScans_NSUBRUN_150_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:39 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.252126,0.0663141,7.528845);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1081->SetMinimum(-3.974029);
   Graph_mI50dO000000sPppm1081->SetMaximum(6.250748);
   ...
   quadLineFit1082->SetChisquare(0.5600666);
   ...
   quadLineFit1082->SetParameter(0,0.09414449);
   quadLineFit1082->SetParError(0,0.08550023);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,-52.41849);
   quadLineFit1082->SetParError(1,1.509675);
   ...
   quadLineFit1083->SetChisquare(0.5600666);
   ...
   quadLineFit1083->SetParameter(0,0.09414449);
   quadLineFit1083->SetParError(0,0.08550023);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,-52.41849);
   quadLineFit1083->SetParError(1,1.509675);
   ...
   Graph_mI30dO000000sPppm1083->SetMinimum(-1.960483);
   Graph_mI30dO000000sPppm1083->SetMaximum(-1.284793);
   ...
   quadLineFit1084->SetChisquare(0.4913555);
   ...
   quadLineFit1084->SetParameter(0,0.005740256);
   quadLineFit1084->SetParError(0,0.04810256);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,-26.60465);
   quadLineFit1084->SetParError(1,0.7928242);
   ...
   quadLineFit1085->SetChisquare(0.4913555);
   ...
   quadLineFit1085->SetParameter(0,0.005740256);
   quadLineFit1085->SetParError(0,0.04810256);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,-26.60465);
   quadLineFit1085->SetParError(1,0.7928242);
   ...
   Graph_mI10dO000000sPppm1085->SetMinimum(-0.1785376);
   Graph_mI10dO000000sPppm1085->SetMaximum(-0.0843562);
   ...
   quadLineFit1086->SetChisquare(3.925277);
   ...
   quadLineFit1086->SetParameter(0,0.006200011);
   quadLineFit1086->SetParError(0,0.04810059);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-2.432302);
   quadLineFit1086->SetParError(1,0.7927919);
   ...
   quadLineFit1087->SetChisquare(3.925277);
   ...
   quadLineFit1087->SetParameter(0,0.006200011);
   quadLineFit1087->SetParError(0,0.04810059);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-2.432302);
   quadLineFit1087->SetParError(1,0.7927919);
   ...
   Graph_10dO000000sPppm1087->SetMinimum(1.059691);
   Graph_10dO000000sPppm1087->SetMaximum(1.598771);
   ...
   quadLineFit1088->SetChisquare(0.006248602);
   ...
   quadLineFit1088->SetParameter(0,0.03485613);
   quadLineFit1088->SetParError(0,0.05273636);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,21.10272);
   quadLineFit1088->SetParError(1,0.8466989);
   ...
   quadLineFit1089->SetChisquare(0.006248602);
   ...
   quadLineFit1089->SetParameter(0,0.03485613);
   quadLineFit1089->SetParError(0,0.05273636);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,21.10272);
   quadLineFit1089->SetParError(1,0.8466989);
   ...
   Graph_30dO000000sPppm1089->SetMinimum(2.245528);
   Graph_30dO000000sPppm1089->SetMaximum(3.375055);
   ...
   quadLineFit1090->SetChisquare(0.1422552);
   ...
   quadLineFit1090->SetParameter(0,0.01228228);
   quadLineFit1090->SetParError(0,0.04809992);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,45.56666);
   quadLineFit1090->SetParError(1,0.7927807);
   ...
   quadLineFit1091->SetChisquare(0.1422552);
   ...
   quadLineFit1091->SetParameter(0,0.01228228);
   quadLineFit1091->SetParError(0,0.04809992);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,45.56666);
   quadLineFit1091->SetParError(1,0.7927807);
   ...
   Graph_50dO000000sPppm1091->SetMinimum(3.441484);
   Graph_50dO000000sPppm1091->SetMaximum(5.155523);
   ...
   quadLineFit1092->SetChisquare(2.872527);
   ...
   quadLineFit1092->SetParameter(0,0.04495429);
   quadLineFit1092->SetParError(0,0.04810107);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,69.28923);
   quadLineFit1092->SetParError(1,0.7927999);
   ...
   quadLineFit1093->SetChisquare(2.872527);
   ...
   quadLineFit1093->SetParameter(0,0.04495429);
   quadLineFit1093->SetParError(0,0.04810107);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,69.28923);
   quadLineFit1093->SetParError(1,0.7927999);
