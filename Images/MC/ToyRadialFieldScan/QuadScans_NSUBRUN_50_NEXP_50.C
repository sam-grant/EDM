void QuadScans_NSUBRUN_50_NEXP_50()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:01:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.247135,0.0663141,7.536755);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1017->SetMinimum(-3.968746);
   Graph_mI50dO000000sPppm1017->SetMaximum(6.258366);
   ...
   quadLineFit1018->SetChisquare(0.9194564);
   ...
   quadLineFit1018->SetParameter(0,0.1225399);
   quadLineFit1018->SetParError(0,0.1481704);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-52.66155);
   quadLineFit1018->SetParError(1,2.61624);
   ...
   quadLineFit1019->SetChisquare(0.9194564);
   ...
   quadLineFit1019->SetParameter(0,0.1225399);
   quadLineFit1019->SetParError(0,0.1481704);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-52.66155);
   quadLineFit1019->SetParError(1,2.61624);
   ...
   Graph_mI30dO000000sPppm1019->SetMinimum(-1.993589);
   Graph_mI30dO000000sPppm1019->SetMaximum(-1.282291);
   ...
   quadLineFit1020->SetChisquare(0.4548682);
   ...
   quadLineFit1020->SetParameter(0,0.01491765);
   quadLineFit1020->SetParError(0,0.08335384);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-26.98925);
   quadLineFit1020->SetParError(1,1.373835);
   ...
   quadLineFit1021->SetChisquare(0.4548682);
   ...
   quadLineFit1021->SetParameter(0,0.01491765);
   quadLineFit1021->SetParError(0,0.08335384);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-26.98925);
   quadLineFit1021->SetParError(1,1.373835);
   ...
   Graph_mI10dO000000sPppm1021->SetMinimum(-0.1742317);
   Graph_mI10dO000000sPppm1021->SetMaximum(-0.08399472);
   ...
   quadLineFit1022->SetChisquare(0.08571064);
   ...
   quadLineFit1022->SetParameter(0,-0.02127302);
   quadLineFit1022->SetParError(0,0.08335579);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,-1.771103);
   quadLineFit1022->SetParError(1,1.373866);
   ...
   quadLineFit1023->SetChisquare(0.08571064);
   ...
   quadLineFit1023->SetParameter(0,-0.02127302);
   quadLineFit1023->SetParError(0,0.08335579);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,-1.771103);
   quadLineFit1023->SetParError(1,1.373866);
   ...
   Graph_10dO000000sPppm1023->SetMinimum(1.047456);
   Graph_10dO000000sPppm1023->SetMaximum(1.608984);
   ...
   quadLineFit1024->SetChisquare(0.2151237);
   ...
   quadLineFit1024->SetParameter(0,0.02949786);
   quadLineFit1024->SetParError(0,0.09138708);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,21.10272);
   quadLineFit1024->SetParError(1,1.467249);
   ...
   quadLineFit1025->SetChisquare(0.2151237);
   ...
   quadLineFit1025->SetParameter(0,0.02949786);
   quadLineFit1025->SetParError(0,0.09138708);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,21.10272);
   quadLineFit1025->SetParError(1,1.467249);
   ...
   Graph_30dO000000sPppm1025->SetMinimum(2.22656);
   Graph_30dO000000sPppm1025->SetMaximum(3.352046);
   ...
   quadLineFit1026->SetChisquare(1.72707);
   ...
   quadLineFit1026->SetParameter(0,0.01210117);
   quadLineFit1026->SetParError(0,0.08335172);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,45.16216);
   quadLineFit1026->SetParError(1,1.373799);
   ...
   quadLineFit1027->SetChisquare(1.72707);
   ...
   quadLineFit1027->SetParameter(0,0.01210117);
   quadLineFit1027->SetParError(0,0.08335172);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,45.16216);
   quadLineFit1027->SetParError(1,1.373799);
   ...
   Graph_50dO000000sPppm1027->SetMinimum(3.431906);
   Graph_50dO000000sPppm1027->SetMaximum(5.172706);
   ...
   quadLineFit1028->SetChisquare(2.333338);
   ...
   quadLineFit1028->SetParameter(0,-0.03092975);
   quadLineFit1028->SetParError(0,0.0833574);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,70.63943);
   quadLineFit1028->SetParError(1,1.373894);
   ...
   quadLineFit1029->SetChisquare(2.333338);
   ...
   quadLineFit1029->SetParameter(0,-0.03092975);
   quadLineFit1029->SetParError(0,0.0833574);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,70.63943);
   quadLineFit1029->SetParError(1,1.373894);
