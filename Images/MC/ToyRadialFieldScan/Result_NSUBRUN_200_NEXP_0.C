...
//=========  (Tue Oct  6 23:07:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1249215,45,0.1755384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-0.09487552);
   Graph_Graph01079->SetMaximum(0.1454924);
   ...
   fieldLineFit1080->SetChisquare(0.2551325);
   ...
   fieldLineFit1080->SetParameter(0,0.02570784);
   fieldLineFit1080->SetParError(0,0.001847971);
   fieldLineFit1080->SetParLimits(0,0,0);
   fieldLineFit1080->SetParameter(1,-0.003227822);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.128");
   pt_LaTex = pt->AddText("#minus0.00323#pm8.26e-05");
   pt_LaTex = pt->AddText("0.0257#pm0.00185");
   pt_LaTex = pt->AddText(" 7.96#pm0.608");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.964455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.964455,-0.09487552,7.964455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1081->SetChisquare(0.2551325);
   ...
   fieldLineFit1081->SetParameter(0,0.02570784);
   fieldLineFit1081->SetParError(0,0.001847971);
   fieldLineFit1081->SetParLimits(0,0,0);
   fieldLineFit1081->SetParameter(1,-0.003227822);
