...
//=========  (Thu Oct  8 17:32:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1412608,45,0.1454484);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-0.1125898);
   Graph_Graph01079->SetMaximum(0.1167775);
   ...
   fieldLineFit1080->SetChisquare(2.266386);
   ...
   fieldLineFit1080->SetParameter(0,-0.0006002291);
   fieldLineFit1080->SetParError(0,0.001843341);
   fieldLineFit1080->SetParLimits(0,0,0);
   fieldLineFit1080->SetParameter(1,-0.003072691);
   ...
   pt_LaTex = pt->AddText("#minus0.00307#pm8.24e-05");
   pt_LaTex = pt->AddText("-0.0006#pm0.00184");
   pt_LaTex = pt->AddText("-0.195#pm -0.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-0.195343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.195343,-0.1125898,-0.195343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1081->SetChisquare(2.266386);
   ...
   fieldLineFit1081->SetParameter(0,-0.0006002291);
   fieldLineFit1081->SetParError(0,0.001843341);
   fieldLineFit1081->SetParLimits(0,0,0);
   fieldLineFit1081->SetParameter(1,-0.003072691);
