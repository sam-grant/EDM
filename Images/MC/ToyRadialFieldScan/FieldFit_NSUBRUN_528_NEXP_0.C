void FieldFit_NSUBRUN_528_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:40 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01061->SetMinimum(-140.657);
   Graph_Graph01061->SetMaximum(159.9385);
   ...
   mainFit1062->SetChisquare(7.82679e-22);
   ...
   mainFit1062->SetParameter(0,9.640711);
   mainFit1062->SetParError(0,63);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,1.205089);
   mainFit1062->SetParError(1,2.1);
...
");
   ...
   mainFit1063->SetChisquare(7.82679e-22);
   ...
   mainFit1063->SetParameter(0,9.640711);
   mainFit1063->SetParError(0,63);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,1.205089);
   mainFit1063->SetParError(1,2.1);
