void FieldFitCheck_NSUBRUN_300_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-105.6236,75,398.0163);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01191->SetMinimum(-55.25958);
   Graph_Graph01191->SetMaximum(347.6523);
   ...
   checkFit1192->SetChisquare(243072.1);
   ...
   checkFit1192->SetParameter(0,67.25477);
   checkFit1192->SetParError(0,0.2026742);
   checkFit1192->SetParLimits(0,0,0);
   checkFit1192->SetParameter(1,-1.548509);
   checkFit1192->SetParError(1,0.005933692);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("6.08e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.43196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.43196,-55.25958,43.43196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1193->SetChisquare(243072.1);
   ...
   checkFit1193->SetParameter(0,67.25477);
   checkFit1193->SetParError(0,0.2026742);
   checkFit1193->SetParLimits(0,0,0);
   checkFit1193->SetParameter(1,-1.548509);
   checkFit1193->SetParError(1,0.005933692);
