void FieldFit_NSUBRUN_300_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-78.95773,75,99.84242);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01189->SetMinimum(-61.07772);
   Graph_Graph01189->SetMaximum(81.9624);
   ...
   mainFit1190->SetChisquare(5.670232);
   ...
   mainFit1190->SetParameter(0,9.901505);
   mainFit1190->SetParError(0,0.2521013);
   mainFit1190->SetParLimits(0,0,0);
   mainFit1190->SetParameter(1,1.187085);
   mainFit1190->SetParError(1,0.007953441);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.341027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.341027,-61.07772,-8.341027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1191->SetChisquare(5.670232);
   ...
   mainFit1191->SetParameter(0,9.901505);
   mainFit1191->SetParError(0,0.2521013);
   mainFit1191->SetParLimits(0,0,0);
   mainFit1191->SetParameter(1,1.187085);
   mainFit1191->SetParError(1,0.007953441);
