void FieldFitCheck_NSUBRUN_50_NEXP_50()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:01:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-108.4395,75,398.742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-57.72139);
   Graph_Graph01031->SetMaximum(348.0238);
   ...
   checkFit1032->SetChisquare(40360.69);
   ...
   checkFit1032->SetParameter(0,66.9018);
   checkFit1032->SetParError(0,0.498126);
   checkFit1032->SetParLimits(0,0,0);
   checkFit1032->SetParameter(1,-1.538748);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.47808,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.47808,-57.72139,43.47808,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(40360.69);
   ...
   checkFit1033->SetParameter(0,66.9018);
   checkFit1033->SetParError(0,0.498126);
   checkFit1033->SetParLimits(0,0,0);
   checkFit1033->SetParameter(1,-1.538748);
