void QuadScans_NSUBRUN_66_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:39:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.094403,0.0768254,3.891074);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1001->SetMinimum(-2.395855);
   Graph_30dO000000sPppm1001->SetMaximum(3.192526);
   ...
   quadLineFit1002->SetChisquare(2.684132e-19);
   ...
   quadLineFit1002->SetParameter(0,-0.0004507959);
   quadLineFit1002->SetParError(0,0.1038253);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.98049);
   quadLineFit1002->SetParError(1,1.622621);
   ...
   quadLineFit1003->SetChisquare(2.684132e-19);
   ...
   quadLineFit1003->SetParameter(0,-0.0004507959);
   quadLineFit1003->SetParError(0,0.1038253);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.98049);
   quadLineFit1003->SetParError(1,1.622621);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-1.980953);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.428278);
   ...
   quadLineFit1004->SetChisquare(4.572802e-19);
   ...
   quadLineFit1004->SetParameter(0,-0.008065886);
   quadLineFit1004->SetParError(0,0.1038253);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-26.72066);
   quadLineFit1004->SetParError(1,1.622621);
   ...
   quadLineFit1005->SetChisquare(4.572802e-19);
   ...
   quadLineFit1005->SetParameter(0,-0.008065886);
   quadLineFit1005->SetParError(0,0.1038253);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-26.72066);
   quadLineFit1005->SetParError(1,1.622621);
