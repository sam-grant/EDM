void QuadScans_NSUBRUN_275_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 31 19:16:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.222936,0.0663141,7.526368);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1161->SetMinimum(-3.948006);
   Graph_mI50dO000000sPppm1161->SetMaximum(6.251438);
   ...
   TF1 *quadLineFit1162 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   quadLineFit1162->SetFillColor(19);
   quadLineFit1162->SetFillStyle(0);
   quadLineFit1162->SetLineWidth(2);
   quadLineFit1162->SetChisquare(0.03194548);
   ...
   quadLineFit1162->SetParameter(0,-0.01855385);
   quadLineFit1162->SetParError(0,0.06299166);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,-50.24546);
   quadLineFit1162->SetParError(1,1.112242);
   quadLineFit1162->SetParLimits(1,0,0);
   quadLineFit1162->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1162);
   gre->Draw("ap");
   
   TF1 *quadLineFit1163 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   quadLineFit1163->SetFillColor(19);
   quadLineFit1163->SetFillStyle(0);
   quadLineFit1163->SetLineWidth(2);
   quadLineFit1163->SetChisquare(0.03194548);
   ...
   quadLineFit1163->SetParameter(0,-0.01855385);
   quadLineFit1163->SetParError(0,0.06299166);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,-50.24546);
   quadLineFit1163->SetParError(1,1.112242);
   ...
   Graph_mI30dO000000sPppm1163->SetMinimum(-1.965717);
   Graph_mI30dO000000sPppm1163->SetMaximum(-1.29932);
   ...
   TF1 *quadLineFit1164 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1164->SetChisquare(3.739347);
   ...
   quadLineFit1164->SetParameter(0,0.0347903);
   quadLineFit1164->SetParError(0,0.03543172);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,-27.06925);
   quadLineFit1164->SetParError(1,0.583984);
   quadLineFit1164->SetParLimits(1,0,0);
   quadLineFit1164->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1164);
   gre->Draw("p ");
   
   TF1 *quadLineFit1165 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1165->SetChisquare(3.739347);
   ...
   quadLineFit1165->SetParameter(0,0.0347903);
   quadLineFit1165->SetParError(0,0.03543172);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,-27.06925);
   quadLineFit1165->SetParError(1,0.583984);
   ...
   Graph_mI10dO000000sPppm1165->SetMinimum(-0.178767);
   Graph_mI10dO000000sPppm1165->SetMaximum(-0.1252996);
   ...
   TF1 *quadLineFit1166 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1166->SetChisquare(0.01326602);
   ...
   quadLineFit1166->SetParameter(0,-0.06895423);
   quadLineFit1166->SetParError(0,0.03543229);
   quadLineFit1166->SetParLimits(0,0,0);
   quadLineFit1166->SetParameter(1,-1.352597);
   quadLineFit1166->SetParError(1,0.5839936);
   quadLineFit1166->SetParLimits(1,0,0);
   quadLineFit1166->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1166);
   gre->Draw("p ");
   
   TF1 *quadLineFit1167 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1167->SetChisquare(0.01326602);
   ...
   quadLineFit1167->SetParameter(0,-0.06895423);
   quadLineFit1167->SetParError(0,0.03543229);
   quadLineFit1167->SetParLimits(0,0,0);
   quadLineFit1167->SetParameter(1,-1.352597);
   quadLineFit1167->SetParError(1,0.5839936);
   ...
   Graph_10dO000000sPppm1167->SetMinimum(1.042089);
   Graph_10dO000000sPppm1167->SetMaximum(1.5954);
   ...
   TF1 *quadLineFit1168 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1168->SetChisquare(0.9649952);
   ...
   quadLineFit1168->SetParameter(0,-0.03235311);
   quadLineFit1168->SetParError(0,0.03884711);
   quadLineFit1168->SetParLimits(0,0,0);
   quadLineFit1168->SetParameter(1,21.9628);
   quadLineFit1168->SetParError(1,0.6237027);
   quadLineFit1168->SetParLimits(1,0,0);
   quadLineFit1168->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1168);
   gre->Draw("p ");
   
   TF1 *quadLineFit1169 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1169->SetChisquare(0.9649952);
   ...
   quadLineFit1169->SetParameter(0,-0.03235311);
   quadLineFit1169->SetParError(0,0.03884711);
   quadLineFit1169->SetParLimits(0,0,0);
   quadLineFit1169->SetParameter(1,21.9628);
   quadLineFit1169->SetParError(1,0.6237027);
   ...
   Graph_30dO000000sPppm1169->SetMinimum(2.244226);
   Graph_30dO000000sPppm1169->SetMaximum(3.368242);
   ...
   TF1 *quadLineFit1170 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1170->SetChisquare(0.3871884);
   ...
   quadLineFit1170->SetParameter(0,0.007260963);
   quadLineFit1170->SetParError(0,0.03543951);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,45.6523);
   quadLineFit1170->SetParError(1,0.5841119);
   quadLineFit1170->SetParLimits(1,0,0);
   quadLineFit1170->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1170);
   gre->Draw("p ");
   
   TF1 *quadLineFit1171 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1171->SetChisquare(0.3871884);
   ...
   quadLineFit1171->SetParameter(0,0.007260963);
   quadLineFit1171->SetParError(0,0.03543951);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,45.6523);
   quadLineFit1171->SetParError(1,0.5841119);
   ...
   Graph_50dO000000sPppm1171->SetMinimum(3.422686);
   Graph_50dO000000sPppm1171->SetMaximum(5.154361);
   ...
   TF1 *quadLineFit1172 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1172->SetChisquare(1.841436);
   ...
   quadLineFit1172->SetParameter(0,-0.04141353);
   quadLineFit1172->SetParError(0,0.03541869);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,70.53475);
   quadLineFit1172->SetParError(1,0.5837688);
   quadLineFit1172->SetParLimits(1,0,0);
   quadLineFit1172->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1172);
   gre->Draw("p ");
   
   TF1 *quadLineFit1173 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1173->SetChisquare(1.841436);
   ...
   quadLineFit1173->SetParameter(0,-0.04141353);
   quadLineFit1173->SetParError(0,0.03541869);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,70.53475);
   quadLineFit1173->SetParError(1,0.5837688);
