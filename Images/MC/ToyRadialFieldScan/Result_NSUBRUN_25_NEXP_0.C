...
//=========  (Thu Oct  8 17:32:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.125324,45,0.1524618);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.09754541);
   Graph_Graph01009->SetMaximum(0.1246832);
   ...
   fieldLineFit1010->SetChisquare(0.6924784);
   ...
   fieldLineFit1010->SetParameter(0,0.01088281);
   fieldLineFit1010->SetParError(0,0.005166239);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.002692054);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.346");
   pt_LaTex = pt->AddText("#minus0.00269#pm0.000231");
   pt_LaTex = pt->AddText("0.0109#pm0.00517");
   pt_LaTex = pt->AddText(" 4.04#pm 1.92");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,4.042567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.042567,-0.09754541,4.042567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1011->SetChisquare(0.6924784);
   ...
   fieldLineFit1011->SetParameter(0,0.01088281);
   fieldLineFit1011->SetParError(0,0.005166239);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.002692054);
