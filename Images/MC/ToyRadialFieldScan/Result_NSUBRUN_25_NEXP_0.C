...
//=========  (Tue Oct  6 23:07:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1288457,45,0.2040086);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.09556029);
   Graph_Graph01009->SetMaximum(0.1707231);
   ...
   fieldLineFit1010->SetChisquare(9.421538);
   ...
   fieldLineFit1010->SetParameter(0,0.02841919);
   fieldLineFit1010->SetParError(0,0.005271958);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.003148081);
   fieldLineFit1010->SetParError(1,0.0002357691);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.71");
   pt_LaTex = pt->AddText("#minus0.00315#pm0.000236");
   pt_LaTex = pt->AddText("0.0284#pm0.00527");
   pt_LaTex = pt->AddText(" 9.03#pm 1.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,9.027466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(9.027466,-0.09556029,9.027466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1011->SetChisquare(9.421538);
   ...
   fieldLineFit1011->SetParameter(0,0.02841919);
   fieldLineFit1011->SetParError(0,0.005271958);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.003148081);
   fieldLineFit1011->SetParError(1,0.0002357691);
