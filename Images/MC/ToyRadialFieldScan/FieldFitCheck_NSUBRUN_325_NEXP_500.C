void FieldFitCheck_NSUBRUN_325_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 31 19:16:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-105.4953,75,397.3615);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01207->SetMinimum(-55.20961);
   Graph_Graph01207->SetMaximum(347.0759);
   ...
   checkFit1208->SetChisquare(262629.6);
   ...
   checkFit1208->SetParameter(0,67.17148);
   checkFit1208->SetParError(0,0.1946974);
   checkFit1208->SetParLimits(0,0,0);
   checkFit1208->SetParameter(1,-1.544986);
   checkFit1208->SetParError(1,0.005700158);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("6.57e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.4771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.4771,-55.20961,43.4771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1209->SetChisquare(262629.6);
   ...
   checkFit1209->SetParameter(0,67.17148);
   checkFit1209->SetParError(0,0.1946974);
   checkFit1209->SetParLimits(0,0,0);
   checkFit1209->SetParameter(1,-1.544986);
   checkFit1209->SetParError(1,0.005700158);
