...
//=========  (Wed Jan  5 17:06:54 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.064776,0.0768254,3.880585);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1033->SetMinimum(-2.37024);
   Graph_30dO000000sPppm1033->SetMaximum(3.186049);
   ...
   quadLineFit1034->SetChisquare(1.503032e-18);
   ...
   quadLineFit1034->SetParameter(1,46.84831);
   ...
   quadLineFit1035->SetChisquare(1.503032e-18);
   ...
   quadLineFit1035->SetParameter(1,46.84831);
   ...
   Graph_mI30dO000000sPppm1035->SetMinimum(-1.955865);
   Graph_mI30dO000000sPppm1035->SetMaximum(-1.398867);
   ...
   quadLineFit1036->SetChisquare(2.042714e-20);
   ...
   quadLineFit1036->SetParameter(1,-27.57205);
   ...
   quadLineFit1037->SetChisquare(2.042714e-20);
   ...
   quadLineFit1037->SetParameter(1,-27.57205);
