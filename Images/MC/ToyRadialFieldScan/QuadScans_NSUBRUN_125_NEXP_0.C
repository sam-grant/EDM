...
//=========  (Wed Oct 14 23:19:51 2020) by ROOT version 6.22/02
   ...
   quadLineFit1050->SetChisquare(1.191656e-18);
   ...
   quadLineFit1050->SetParameter(0,-3.092172);
   quadLineFit1050->SetParError(0,0.08454357);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.0878271);
   ...
   quadLineFit1051->SetChisquare(1.191656e-18);
   ...
   quadLineFit1051->SetParameter(0,-3.092172);
   quadLineFit1051->SetParError(0,0.08454357);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.0878271);
   ...
   Graph_mI10dO000000sPppm1051->SetMinimum(-0.1818654);
   Graph_mI10dO000000sPppm1051->SetMaximum(-0.09384918);
   ...
   quadLineFit1052->SetChisquare(1.652474e-20);
   ...
   quadLineFit1052->SetParameter(0,-0.3490866);
   quadLineFit1052->SetParError(0,0.08454357);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.01173497);
   ...
   quadLineFit1053->SetChisquare(1.652474e-20);
   ...
   quadLineFit1053->SetParameter(0,-0.3490866);
   quadLineFit1053->SetParError(0,0.08454357);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.01173497);
   ...
   Graph_10dO000000sPppm1053->SetMinimum(1.01345);
   Graph_10dO000000sPppm1053->SetMaximum(1.42513);
   ...
   quadLineFit1054->SetChisquare(2.825095e-20);
   ...
   quadLineFit1054->SetParameter(0,2.644258);
   quadLineFit1054->SetParError(0,0.08454357);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,-0.0791649);
   ...
   quadLineFit1055->SetChisquare(2.825095e-20);
   ...
   quadLineFit1055->SetParameter(0,2.644258);
   quadLineFit1055->SetParError(0,0.08454357);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,-0.0791649);
   ...
   Graph_30dO000000sPppm1055->SetMinimum(2.237439);
   Graph_30dO000000sPppm1055->SetMaximum(2.92937);
   ...
   quadLineFit1056->SetChisquare(4.083808e-20);
   ...
   quadLineFit1056->SetParameter(0,5.059312);
   quadLineFit1056->SetParError(0,0.08454357);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.1375504);
   ...
   quadLineFit1057->SetChisquare(4.083808e-20);
   ...
   quadLineFit1057->SetParameter(0,5.059312);
   quadLineFit1057->SetParError(0,0.08454357);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.1375504);
