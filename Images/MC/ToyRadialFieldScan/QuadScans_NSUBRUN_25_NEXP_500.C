void QuadScans_NSUBRUN_25_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.246794,0.0663141,7.590707);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1001->SetMinimum(-3.963044);
   Graph_mI50dO000000sPppm1001->SetMaximum(6.306957);
   ...
   quadLineFit1002->SetChisquare(1.454888);
   ...
   quadLineFit1002->SetParameter(0,0.05352404);
   quadLineFit1002->SetParError(0,0.2109375);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,-51.40599);
   quadLineFit1002->SetParError(1,3.724517);
   ...
   quadLineFit1003->SetChisquare(1.454888);
   ...
   quadLineFit1003->SetParameter(0,0.05352404);
   quadLineFit1003->SetParError(0,0.2109375);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,-51.40599);
   quadLineFit1003->SetParError(1,3.724517);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-2.020122);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.215174);
   ...
   quadLineFit1004->SetChisquare(0.2684985);
   ...
   quadLineFit1004->SetParameter(0,0.2489367);
   quadLineFit1004->SetParError(0,0.1186725);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-30.50311);
   quadLineFit1004->SetParError(1,1.955955);
   ...
   quadLineFit1005->SetChisquare(0.2684985);
   ...
   quadLineFit1005->SetParameter(0,0.2489367);
   quadLineFit1005->SetParError(0,0.1186725);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-30.50311);
   quadLineFit1005->SetParError(1,1.955955);
   ...
   Graph_mI10dO000000sPppm1005->SetMinimum(-0.2489429);
   Graph_mI10dO000000sPppm1005->SetMaximum(-0.05233223);
   ...
   quadLineFit1006->SetChisquare(3.979455);
   ...
   quadLineFit1006->SetParameter(0,0.02829231);
   quadLineFit1006->SetParError(0,0.1186735);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-3.138738);
   quadLineFit1006->SetParError(1,1.955972);
   ...
   quadLineFit1007->SetChisquare(3.979455);
   ...
   quadLineFit1007->SetParameter(0,0.02829231);
   quadLineFit1007->SetParError(0,0.1186735);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-3.138738);
   quadLineFit1007->SetParError(1,1.955972);
   ...
   Graph_10dO000000sPppm1007->SetMinimum(1.037779);
   Graph_10dO000000sPppm1007->SetMaximum(1.61964);
   ...
   quadLineFit1008->SetChisquare(1.89297);
   ...
   quadLineFit1008->SetParameter(0,0.0388103);
   quadLineFit1008->SetParError(0,0.1301093);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,21.29586);
   quadLineFit1008->SetParError(1,2.088946);
   ...
   quadLineFit1009->SetChisquare(1.89297);
   ...
   quadLineFit1009->SetParameter(0,0.0388103);
   quadLineFit1009->SetParError(0,0.1301093);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,21.29586);
   quadLineFit1009->SetParError(1,2.088946);
   ...
   Graph_30dO000000sPppm1009->SetMinimum(2.177177);
   Graph_30dO000000sPppm1009->SetMaximum(3.404737);
   ...
   quadLineFit1010->SetChisquare(0.3631526);
   ...
   quadLineFit1010->SetParameter(0,-0.1114114);
   quadLineFit1010->SetParError(0,0.1186752);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,47.3663);
   quadLineFit1010->SetParError(1,1.956);
   ...
   quadLineFit1011->SetChisquare(0.3631526);
   ...
   quadLineFit1011->SetParameter(0,-0.1114114);
   quadLineFit1011->SetParError(0,0.1186752);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,47.3663);
   quadLineFit1011->SetParError(1,1.956);
   ...
   Graph_50dO000000sPppm1011->SetMinimum(3.445568);
   Graph_50dO000000sPppm1011->SetMaximum(5.223554);
   ...
   quadLineFit1012->SetChisquare(2.749513);
   ...
   quadLineFit1012->SetParameter(0,-0.06029475);
   quadLineFit1012->SetParError(0,0.1186781);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,71.2351);
   quadLineFit1012->SetParError(1,1.956048);
   ...
   quadLineFit1013->SetChisquare(2.749513);
   ...
   quadLineFit1013->SetParameter(0,-0.06029475);
   quadLineFit1013->SetParError(0,0.1186781);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,71.2351);
   quadLineFit1013->SetParError(1,1.956048);
