...
//=========  (Fri Oct 16 07:53:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3638792,75,0.2934561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-0.2981457);
   Graph_Graph01109->SetMaximum(0.2277225);
   ...
   mainFit1110->SetParameter(0,-0.03504094);
   mainFit1110->SetParError(0,0.002867364);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,-0.004246682);
   mainFit1110->SetParError(1,8.110131e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00425#pm8.11e-05");
   pt_LaTex = pt->AddText("#minus0.035#pm0.00287");
   pt_LaTex = pt->AddText("#minus8.25#pm0.693");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.25137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.25137,-0.2981457,-8.25137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetParameter(0,-0.03504094);
   mainFit1111->SetParError(0,0.002867364);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,-0.004246682);
   mainFit1111->SetParError(1,8.110131e-05);
