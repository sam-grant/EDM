...
//=========  (Fri Oct 16 07:53:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-64.54518,75,79.53079);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(-50.13758);
   Graph_Graph01041->SetMaximum(65.12319);
   ...
   checkFit1042->SetChisquare(2.379366);
   ...
   checkFit1042->SetParameter(0,7.230087);
   checkFit1042->SetParError(0,1.133217);
   checkFit1042->SetParLimits(0,0,0);
   checkFit1042->SetParameter(1,0.9208616);
   checkFit1042->SetParError(1,0.0320522);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0321");
   pt_LaTex = pt->AddText(" 7.23#pm 1.13");
   pt_LaTex = pt->AddText("#minus7.85#pm 1.26");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.851438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.851438,-50.13758,-7.851438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1043->SetChisquare(2.379366);
   ...
   checkFit1043->SetParameter(0,7.230087);
   checkFit1043->SetParError(0,1.133217);
   checkFit1043->SetParLimits(0,0,0);
   checkFit1043->SetParameter(1,0.9208616);
   checkFit1043->SetParError(1,0.0320522);
