...
//=========  (Fri Oct 16 07:53:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-72.89355,75,89.29235);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-56.67496);
   Graph_Graph01013->SetMaximum(73.07376);
   ...
   checkFit1014->SetParameter(0,8.694225);
   checkFit1014->SetParError(0,1.952557);
   checkFit1014->SetParLimits(0,0,0);
   checkFit1014->SetParameter(1,0.9941419);
   checkFit1014->SetParError(1,0.05522664);
   ...
   pt_LaTex = pt->AddText("0.994#pm0.0552");
   pt_LaTex = pt->AddText(" 8.69#pm 1.95");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.745457,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.745457,-56.67496,-8.745457,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1015->SetParameter(0,8.694225);
   checkFit1015->SetParError(0,1.952557);
   checkFit1015->SetParLimits(0,0,0);
   checkFit1015->SetParameter(1,0.9941419);
   checkFit1015->SetParError(1,0.05522664);
