...
//=========  (Fri Oct 16 07:53:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3273281,75,0.2656512);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.2680302);
   Graph_Graph01039->SetMaximum(0.2063533);
   ...
   mainFit1040->SetParameter(0,-0.02975717);
   mainFit1040->SetParError(0,0.004664025);
   mainFit1040->SetParLimits(0,0,0);
   mainFit1040->SetParameter(1,-0.003790028);
   mainFit1040->SetParError(1,0.0001319185);
   ...
   pt_LaTex = pt->AddText("#minus0.00379#pm0.000132");
   pt_LaTex = pt->AddText("#minus0.0298#pm0.00466");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.85144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.85144,-0.2680302,-7.85144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1041->SetParameter(0,-0.02975717);
   mainFit1041->SetParError(0,0.004664025);
   mainFit1041->SetParLimits(0,0,0);
   mainFit1041->SetParameter(1,-0.003790028);
   mainFit1041->SetParError(1,0.0001319185);
