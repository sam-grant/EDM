...
//=========  (Fri Oct 16 07:54:01 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1155[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1155[2] = {
   -3.155401,
   -2.756723};
   Double_t -50.000000 ppm_fex1155[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1155[2] = {
   0.008508651,
   0.008508651};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1155,-50.000000 ppm_fy1155,-50.000000 ppm_fex1155,-50.000000 ppm_fey1155);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1155 = new TH1F("Graph_mI50dO000000sPppm1155","",100,15.77,18.53);
   ...
   TF1 *quadLineFit1156 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1156->SetFillColor(19);
   quadLineFit1156->SetFillStyle(0);
   quadLineFit1156->SetLineWidth(2);
   quadLineFit1156->SetChisquare(1.393588e-18);
   quadLineFit1156->SetNDF(0);
   ...
   quadLineFit1156->SetParameter(0,-5.928812);
   quadLineFit1156->SetParError(0,0.08992619);
   quadLineFit1156->SetParLimits(0,0,0);
   quadLineFit1156->SetParameter(1,0.1733382);
   quadLineFit1156->SetParError(1,0.005231761);
   quadLineFit1156->SetParLimits(1,0,0);
   quadLineFit1156->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1156);
   gre->Draw("ap");
   
   TF1 *quadLineFit1157 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1157->SetFillColor(19);
   quadLineFit1157->SetFillStyle(0);
   quadLineFit1157->SetLineWidth(2);
   quadLineFit1157->SetChisquare(1.393588e-18);
   quadLineFit1157->SetNDF(0);
   ...
   quadLineFit1157->SetParameter(0,-5.928812);
   quadLineFit1157->SetParError(0,0.08992619);
   quadLineFit1157->SetParLimits(0,0,0);
   quadLineFit1157->SetParameter(1,0.1733382);
   quadLineFit1157->SetParError(1,0.005231761);
   quadLineFit1157->SetParLimits(1,0,0);
   quadLineFit1157->Draw("same");
   
   Double_t -25.000000 ppm_fx1157[2] = {
   16,
   18.3};
   Double_t -25.000000 ppm_fy1157[2] = {
   -1.283097,
   -1.125869};
   Double_t -25.000000 ppm_fex1157[2] = {
   0,
   0};
   Double_t -25.000000 ppm_fey1157[2] = {
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(2,-25.000000 ppm_fx1157,-25.000000 ppm_fy1157,-25.000000 ppm_fex1157,-25.000000 ppm_fey1157);
   ...
   TH1F *Graph_mI25dO000000sPppm1157 = new TH1F("Graph_mI25dO000000sPppm1157","Graph",100,15.77,18.53);
   Graph_mI25dO000000sPppm1157->SetMinimum(-1.309031);
   Graph_mI25dO000000sPppm1157->SetMaximum(-1.099935);
   ...
   quadLineFit1158->SetChisquare(3.521586e-20);
   ...
   quadLineFit1158->SetParameter(0,-2.376863);
   quadLineFit1158->SetParError(0,0.08992619);
   quadLineFit1158->SetParLimits(0,0,0);
   quadLineFit1158->SetParameter(1,0.06836038);
   quadLineFit1158->SetParError(1,0.005231761);
   ...
   quadLineFit1159->SetChisquare(3.521586e-20);
   ...
   quadLineFit1159->SetParameter(0,-2.376863);
   quadLineFit1159->SetParError(0,0.08992619);
   quadLineFit1159->SetParLimits(0,0,0);
   quadLineFit1159->SetParameter(1,0.06836038);
   quadLineFit1159->SetParError(1,0.005231761);
   quadLineFit1159->SetParLimits(1,0,0);
   quadLineFit1159->Draw("same");
   
   Double_t 0.000000 ppm_fx1159[2] = {
   16,
   18.3};
   Double_t 0.000000 ppm_fy1159[2] = {
   0.5980575,
   0.5178538};
   Double_t 0.000000 ppm_fex1159[2] = {
   0,
   0};
   Double_t 0.000000 ppm_fey1159[2] = {
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(2,0.000000 ppm_fx1159,0.000000 ppm_fy1159,0.000000 ppm_fex1159,0.000000 ppm_fey1159);
   ...
   TH1F *Graph_0dO000000sPppm1159 = new TH1F("Graph_0dO000000sPppm1159","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1159->SetMinimum(0.499623);
   Graph_0dO000000sPppm1159->SetMaximum(0.6162883);
   ...
   quadLineFit1160->SetChisquare(2.711433e-20);
   ...
   quadLineFit1160->SetParameter(0,1.155997);
   quadLineFit1160->SetParError(0,0.08992619);
   quadLineFit1160->SetParLimits(0,0,0);
   quadLineFit1160->SetParameter(1,-0.03487119);
   quadLineFit1160->SetParError(1,0.005231761);
   ...
   quadLineFit1161->SetChisquare(2.711433e-20);
   ...
   quadLineFit1161->SetParameter(0,1.155997);
   quadLineFit1161->SetParError(0,0.08992619);
   quadLineFit1161->SetParLimits(0,0,0);
   quadLineFit1161->SetParameter(1,-0.03487119);
   quadLineFit1161->SetParError(1,0.005231761);
   quadLineFit1161->SetParLimits(1,0,0);
   quadLineFit1161->Draw("same");
   
   Double_t 25.000000 ppm_fx1161[2] = {
   16,
   18.3};
   Double_t 25.000000 ppm_fy1161[2] = {
   2.478188,
   2.178133};
   Double_t 25.000000 ppm_fex1161[2] = {
   0,
   0};
   Double_t 25.000000 ppm_fey1161[2] = {
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(2,25.000000 ppm_fx1161,25.000000 ppm_fy1161,25.000000 ppm_fex1161,25.000000 ppm_fey1161);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_25dO000000sPppm1161 = new TH1F("Graph_25dO000000sPppm1161","Graph",100,15.77,18.53);
   Graph_25dO000000sPppm1161->SetMinimum(2.137917);
   Graph_25dO000000sPppm1161->SetMaximum(2.518403);
   ...
   quadLineFit1162->SetChisquare(3.177636e-16);
   ...
   quadLineFit1162->SetParameter(0,4.565525);
   quadLineFit1162->SetParError(0,0.08992619);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,-0.1304586);
   quadLineFit1162->SetParError(1,0.005231761);
   ...
   quadLineFit1163->SetChisquare(3.177636e-16);
   ...
   quadLineFit1163->SetParameter(0,4.565525);
   quadLineFit1163->SetParError(0,0.08992619);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,-0.1304586);
   quadLineFit1163->SetParError(1,0.005231761);
   quadLineFit1163->SetParLimits(1,0,0);
   quadLineFit1163->Draw("same");
   
   Double_t 50.000000 ppm_fx1163[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1163[2] = {
   4.380068,
   3.81597};
   Double_t 50.000000 ppm_fex1163[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1163[2] = {
   0.008508651,
   0.008508651};
   gre = new TGraphErrors(2,50.000000 ppm_fx1163,50.000000 ppm_fy1163,50.000000 ppm_fex1163,50.000000 ppm_fey1163);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(5);
   ...
   TH1F *Graph_50dO000000sPppm1163 = new TH1F("Graph_50dO000000sPppm1163","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1163->SetMinimum(3.74935);
   Graph_50dO000000sPppm1163->SetMaximum(4.446688);
   ...
   quadLineFit1164->SetChisquare(9.362781e-19);
   ...
   quadLineFit1164->SetParameter(0,8.304228);
   quadLineFit1164->SetParError(0,0.08992619);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,-0.24526);
   quadLineFit1164->SetParError(1,0.005231761);
   ...
   quadLineFit1165->SetChisquare(9.362781e-19);
   ...
   quadLineFit1165->SetParameter(0,8.304228);
   quadLineFit1165->SetParError(0,0.08992619);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,-0.24526);
   quadLineFit1165->SetParError(1,0.005231761);
