...
//=========  (Fri Oct 16 07:53:59 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1141[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1141[2] = {
   -3.156814,
   -2.77477};
   Double_t -50.000000 ppm_fex1141[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1141[2] = {
   0.008888156,
   0.008888156};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1141,-50.000000 ppm_fy1141,-50.000000 ppm_fex1141,-50.000000 ppm_fey1141);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1141 = new TH1F("Graph_mI50dO000000sPppm1141","",100,15.77,18.53);
   ...
   quadLineFit1142->SetChisquare(4.063076e-18);
   ...
   quadLineFit1142->SetParameter(0,-5.814515);
   quadLineFit1142->SetParError(0,0.0939371);
   quadLineFit1142->SetParLimits(0,0,0);
   quadLineFit1142->SetParameter(1,0.1661063);
   quadLineFit1142->SetParError(1,0.005465109);
   ...
   quadLineFit1143->SetChisquare(4.063076e-18);
   ...
   quadLineFit1143->SetParameter(0,-5.814515);
   quadLineFit1143->SetParError(0,0.0939371);
   quadLineFit1143->SetParLimits(0,0,0);
   quadLineFit1143->SetParameter(1,0.1661063);
   quadLineFit1143->SetParError(1,0.005465109);
   quadLineFit1143->SetParLimits(1,0,0);
   quadLineFit1143->Draw("same");
   
   Double_t -25.000000 ppm_fx1143[2] = {
   16,
   18.3};
   Double_t -25.000000 ppm_fy1143[2] = {
   -1.280333,
   -1.126858};
   Double_t -25.000000 ppm_fex1143[2] = {
   0,
   0};
   Double_t -25.000000 ppm_fey1143[2] = {
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(2,-25.000000 ppm_fx1143,-25.000000 ppm_fy1143,-25.000000 ppm_fex1143,-25.000000 ppm_fey1143);
   ...
   TH1F *Graph_mI25dO000000sPppm1143 = new TH1F("Graph_mI25dO000000sPppm1143","Graph",100,15.77,18.53);
   Graph_mI25dO000000sPppm1143->SetMinimum(-1.306346);
   Graph_mI25dO000000sPppm1143->SetMaximum(-1.100845);
   ...
   quadLineFit1144->SetChisquare(2.920964e-22);
   ...
   quadLineFit1144->SetParameter(0,-2.347983);
   quadLineFit1144->SetParError(0,0.0939371);
   quadLineFit1144->SetParLimits(0,0,0);
   quadLineFit1144->SetParameter(1,0.06672815);
   quadLineFit1144->SetParError(1,0.005465109);
   ...
   quadLineFit1145->SetChisquare(2.920964e-22);
   ...
   quadLineFit1145->SetParameter(0,-2.347983);
   quadLineFit1145->SetParError(0,0.0939371);
   quadLineFit1145->SetParLimits(0,0,0);
   quadLineFit1145->SetParameter(1,0.06672815);
   quadLineFit1145->SetParError(1,0.005465109);
   quadLineFit1145->SetParLimits(1,0,0);
   quadLineFit1145->Draw("same");
   
   Double_t 0.000000 ppm_fx1145[2] = {
   16,
   18.3};
   Double_t 0.000000 ppm_fy1145[2] = {
   0.6079478,
   0.5258674};
   Double_t 0.000000 ppm_fex1145[2] = {
   0,
   0};
   Double_t 0.000000 ppm_fey1145[2] = {
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(2,0.000000 ppm_fx1145,0.000000 ppm_fy1145,0.000000 ppm_fex1145,0.000000 ppm_fey1145);
   ...
   TH1F *Graph_0dO000000sPppm1145 = new TH1F("Graph_0dO000000sPppm1145","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1145->SetMinimum(0.5069936);
   Graph_0dO000000sPppm1145->SetMaximum(0.6268216);
   ...
   quadLineFit1146->SetChisquare(3.431125e-20);
   ...
   quadLineFit1146->SetParameter(0,1.178942);
   quadLineFit1146->SetParError(0,0.0939371);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,-0.03568712);
   quadLineFit1146->SetParError(1,0.005465109);
   ...
   quadLineFit1147->SetChisquare(3.431125e-20);
   ...
   quadLineFit1147->SetParameter(0,1.178942);
   quadLineFit1147->SetParError(0,0.0939371);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,-0.03568712);
   quadLineFit1147->SetParError(1,0.005465109);
   quadLineFit1147->SetParLimits(1,0,0);
   quadLineFit1147->Draw("same");
   
   Double_t 25.000000 ppm_fx1147[2] = {
   16,
   18.3};
   Double_t 25.000000 ppm_fy1147[2] = {
   2.468498,
   2.163837};
   Double_t 25.000000 ppm_fex1147[2] = {
   0,
   0};
   Double_t 25.000000 ppm_fey1147[2] = {
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(2,25.000000 ppm_fx1147,25.000000 ppm_fy1147,25.000000 ppm_fex1147,25.000000 ppm_fey1147);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_25dO000000sPppm1147 = new TH1F("Graph_25dO000000sPppm1147","Graph",100,15.77,18.53);
   Graph_25dO000000sPppm1147->SetMinimum(2.122705);
   Graph_25dO000000sPppm1147->SetMaximum(2.50963);
   ...
   quadLineFit1148->SetChisquare(3.951692e-19);
   ...
   quadLineFit1148->SetParameter(0,4.587879);
   quadLineFit1148->SetParError(0,0.0939371);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,-0.1324613);
   quadLineFit1148->SetParError(1,0.005465109);
   ...
   quadLineFit1149->SetChisquare(3.951692e-19);
   ...
   quadLineFit1149->SetParameter(0,4.587879);
   quadLineFit1149->SetParError(0,0.0939371);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,-0.1324613);
   quadLineFit1149->SetParError(1,0.005465109);
   quadLineFit1149->SetParLimits(1,0,0);
   quadLineFit1149->Draw("same");
   
   Double_t 50.000000 ppm_fx1149[2] = {
   16,
   18.3};
   Double_t 50.000000 ppm_fy1149[2] = {
   4.37513,
   3.826109};
   Double_t 50.000000 ppm_fex1149[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1149[2] = {
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(2,50.000000 ppm_fx1149,50.000000 ppm_fy1149,50.000000 ppm_fex1149,50.000000 ppm_fey1149);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(5);
   ...
   TH1F *Graph_50dO000000sPppm1149 = new TH1F("Graph_50dO000000sPppm1149","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1149->SetMinimum(3.760541);
   Graph_50dO000000sPppm1149->SetMaximum(4.440698);
   ...
   quadLineFit1150->SetChisquare(1.689569e-20);
   ...
   quadLineFit1150->SetParameter(0,8.194407);
   quadLineFit1150->SetParError(0,0.0939371);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-0.2387048);
   quadLineFit1150->SetParError(1,0.005465109);
   ...
   quadLineFit1151->SetChisquare(1.689569e-20);
   ...
   quadLineFit1151->SetParameter(0,8.194407);
   quadLineFit1151->SetParError(0,0.0939371);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-0.2387048);
   quadLineFit1151->SetParError(1,0.005465109);
