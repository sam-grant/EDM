...
//=========  (Fri Oct 16 07:53:49 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1015 = new TH1F("Graph_mI50dO000000sPppm1015","",100,15.77,18.53);
   ...
   quadLineFit1016->SetChisquare(3.251142e-21);
   ...
   quadLineFit1016->SetParameter(0,-5.832569);
   quadLineFit1016->SetParError(0,0.2191999);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,0.1698014);
   quadLineFit1016->SetParError(1,0.0127527);
   ...
   quadLineFit1017->SetChisquare(3.251142e-21);
   ...
   quadLineFit1017->SetParameter(0,-5.832569);
   quadLineFit1017->SetParError(0,0.2191999);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,0.1698014);
   quadLineFit1017->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI25dO000000sPppm1017 = new TH1F("Graph_mI25dO000000sPppm1017","Graph",100,15.77,18.53);
   Graph_mI25dO000000sPppm1017->SetMinimum(-1.308021);
   Graph_mI25dO000000sPppm1017->SetMaximum(-1.062508);
   ...
   quadLineFit1018->SetChisquare(1.067479e-18);
   ...
   quadLineFit1018->SetParameter(0,-2.401526);
   quadLineFit1018->SetParError(0,0.2191999);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.07091906);
   quadLineFit1018->SetParError(1,0.0127527);
   ...
   quadLineFit1019->SetChisquare(1.067479e-18);
   ...
   quadLineFit1019->SetParameter(0,-2.401526);
   quadLineFit1019->SetParError(0,0.2191999);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.07091906);
   quadLineFit1019->SetParError(1,0.0127527);
   ...
   TH1F *Graph_0dO000000sPppm1019 = new TH1F("Graph_0dO000000sPppm1019","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1019->SetMinimum(0.4989439);
   Graph_0dO000000sPppm1019->SetMaximum(0.6412402);
   ...
   quadLineFit1020->SetChisquare(3.87361e-20);
   ...
   quadLineFit1020->SetParameter(0,1.144987);
   quadLineFit1020->SetParError(0,0.2191999);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.0335216);
   quadLineFit1020->SetParError(1,0.0127527);
   ...
   quadLineFit1021->SetChisquare(3.87361e-20);
   ...
   quadLineFit1021->SetParameter(0,1.144987);
   quadLineFit1021->SetParError(0,0.2191999);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.0335216);
   quadLineFit1021->SetParError(1,0.0127527);
   ...
   TH1F *Graph_25dO000000sPppm1021 = new TH1F("Graph_25dO000000sPppm1021","Graph",100,15.77,18.53);
   Graph_25dO000000sPppm1021->SetMinimum(2.064134);
   Graph_25dO000000sPppm1021->SetMaximum(2.558529);
   ...
   quadLineFit1022->SetChisquare(2.112365e-19);
   ...
   quadLineFit1022->SetParameter(0,5.074083);
   quadLineFit1022->SetParError(0,0.2191999);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,-0.1610934);
   quadLineFit1022->SetParError(1,0.0127527);
   ...
   quadLineFit1023->SetChisquare(2.112365e-19);
   ...
   quadLineFit1023->SetParameter(0,5.074083);
   quadLineFit1023->SetParError(0,0.2191999);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,-0.1610934);
   quadLineFit1023->SetParError(1,0.0127527);
   ...
   TH1F *Graph_50dO000000sPppm1023 = new TH1F("Graph_50dO000000sPppm1023","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1023->SetMinimum(3.724938);
   Graph_50dO000000sPppm1023->SetMaximum(4.475832);
   ...
   TF1 *quadLineFit1024 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1024->SetChisquare(4.643544e-17);
   ...
   quadLineFit1024->SetParameter(0,8.456961);
   quadLineFit1024->SetParError(0,0.2191999);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,-0.2540277);
   quadLineFit1024->SetParError(1,0.0127527);
   quadLineFit1024->SetParLimits(1,0,0);
   quadLineFit1024->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1024);
   gre->Draw("p ");
   
   TF1 *quadLineFit1025 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   ...
   quadLineFit1025->SetChisquare(4.643544e-17);
   ...
   quadLineFit1025->SetParameter(0,8.456961);
   quadLineFit1025->SetParError(0,0.2191999);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,-0.2540277);
   quadLineFit1025->SetParError(1,0.0127527);
