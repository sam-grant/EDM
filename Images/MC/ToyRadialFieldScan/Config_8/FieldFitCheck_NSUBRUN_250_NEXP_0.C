...
//=========  (Fri Oct 16 07:53:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.79957,75,85.90269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01139->SetMinimum(-56.02934);
   Graph_Graph01139->SetMaximum(70.13246);
   ...
   checkFit1140->SetChisquare(6.609176);
   ...
   checkFit1140->SetParameter(0,8.344582);
   checkFit1140->SetParError(0,0.622873);
   checkFit1140->SetParLimits(0,0,0);
   checkFit1140->SetParameter(1,1.014612);
   checkFit1140->SetParError(1,0.01761751);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0176");
   pt_LaTex = pt->AddText(" 8.34#pm0.623");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.224404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.224404,-56.02934,-8.224404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1141->SetChisquare(6.609176);
   ...
   checkFit1141->SetParameter(0,8.344582);
   checkFit1141->SetParError(0,0.622873);
   checkFit1141->SetParLimits(0,0,0);
   checkFit1141->SetParameter(1,1.014612);
   checkFit1141->SetParError(1,0.01761751);
