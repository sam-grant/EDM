...
//=========  (Fri Oct 16 07:53:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.15829,75,84.41178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-53.80128);
   Graph_Graph01125->SetMaximum(69.05477);
   ...
   checkFit1126->SetParameter(0,7.865286);
   checkFit1126->SetParError(0,0.6566902);
   checkFit1126->SetParLimits(0,0,0);
   checkFit1126->SetParameter(1,0.9981305);
   checkFit1126->SetParError(1,0.018574);
   ...
   pt_LaTex = pt->AddText("0.998#pm0.0186");
   pt_LaTex = pt->AddText(" 7.87#pm0.657");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.880018,-53.80128,-7.880018,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1127->SetParameter(0,7.865286);
   checkFit1127->SetParError(0,0.6566902);
   checkFit1127->SetParLimits(0,0,0);
   checkFit1127->SetParameter(1,0.9981305);
   checkFit1127->SetParError(1,0.018574);
