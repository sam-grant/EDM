...
//=========  (Fri Oct 16 07:53:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3667401,75,0.2750309);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-0.302563);
   Graph_Graph01095->SetMaximum(0.2108538);
   ...
   mainFit1096->SetParameter(0,-0.03492649);
   mainFit1096->SetParError(0,0.003066526);
   mainFit1096->SetParLimits(0,0,0);
   mainFit1096->SetParameter(1,-0.004120766);
   mainFit1096->SetParError(1,8.673446e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00412#pm8.67e-05");
   pt_LaTex = pt->AddText("#minus0.0349#pm0.00307");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.475728,-0.302563,-8.475728,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1097->SetParameter(0,-0.03492649);
   mainFit1097->SetParError(0,0.003066526);
   mainFit1097->SetParLimits(0,0,0);
   mainFit1097->SetParameter(1,-0.004120766);
   mainFit1097->SetParError(1,8.673446e-05);
