...
//=========  (Fri Oct 16 07:53:48 2020) by ROOT version 6.22/02
   ...
   Double_t -25.000000 ppm_fx1003[2] = {
   16,
   18.3};
   Double_t -25.000000 ppm_fy1003[2] = {
   -1.317271,
   -1.15103};
   Double_t -25.000000 ppm_fex1003[2] = {
   0,
   0};
   Double_t -25.000000 ppm_fey1003[2] = {
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(2,-25.000000 ppm_fx1003,-25.000000 ppm_fy1003,-25.000000 ppm_fex1003,-25.000000 ppm_fey1003);
   ...
   TH1F *Graph_mI25dO000000sPppm1003 = new TH1F("Graph_mI25dO000000sPppm1003","Graph",100,15.77,18.53);
   Graph_mI25dO000000sPppm1003->SetMinimum(-1.368965);
   Graph_mI25dO000000sPppm1003->SetMaximum(-1.099336);
   ...
   quadLineFit1004->SetChisquare(1.68822e-19);
   ...
   quadLineFit1004->SetParameter(0,-2.473733);
   quadLineFit1004->SetParError(0,0.3088695);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.07227883);
   ...
   quadLineFit1005->SetChisquare(1.68822e-19);
   ...
   quadLineFit1005->SetParameter(0,-2.473733);
   quadLineFit1005->SetParError(0,0.3088695);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.07227883);
   quadLineFit1005->SetParError(1,0.01796953);
   quadLineFit1005->SetParLimits(1,0,0);
   quadLineFit1005->Draw("same");
   
   Double_t 0.000000 ppm_fx1005[2] = {
   16,
   18.3};
   Double_t 0.000000 ppm_fy1005[2] = {
   0.6216244,
   0.5038303};
   Double_t 0.000000 ppm_fex1005[2] = {
   0,
   0};
   Double_t 0.000000 ppm_fey1005[2] = {
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(2,0.000000 ppm_fx1005,0.000000 ppm_fy1005,0.000000 ppm_fex1005,0.000000 ppm_fey1005);
   ...
   TH1F *Graph_0dO000000sPppm1005 = new TH1F("Graph_0dO000000sPppm1005","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1005->SetMinimum(0.4569813);
   Graph_0dO000000sPppm1005->SetMaximum(0.6684734);
   ...
   quadLineFit1006->SetChisquare(4.468084e-19);
   ...
   quadLineFit1006->SetParameter(0,1.441062);
   quadLineFit1006->SetParError(0,0.3088695);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.05121483);
   ...
   quadLineFit1007->SetChisquare(4.468084e-19);
   ...
   quadLineFit1007->SetParameter(0,1.441062);
   quadLineFit1007->SetParError(0,0.3088695);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.05121483);
   quadLineFit1007->SetParError(1,0.01796953);
   quadLineFit1007->SetParLimits(1,0,0);
   quadLineFit1007->Draw("same");
   
   Double_t 25.000000 ppm_fx1007[2] = {
   16,
   18.3};
   Double_t 25.000000 ppm_fy1007[2] = {
   2.458206,
   2.153487};
   Double_t 25.000000 ppm_fex1007[2] = {
   0,
   0};
   Double_t 25.000000 ppm_fey1007[2] = {
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(2,25.000000 ppm_fx1007,25.000000 ppm_fy1007,25.000000 ppm_fex1007,25.000000 ppm_fey1007);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_25dO000000sPppm1007 = new TH1F("Graph_25dO000000sPppm1007","Graph",100,15.77,18.53);
   Graph_25dO000000sPppm1007->SetMinimum(2.087945);
   Graph_25dO000000sPppm1007->SetMaximum(2.523747);
   ...
   quadLineFit1008->SetChisquare(2.078059e-21);
   ...
   quadLineFit1008->SetParameter(0,4.577993);
   quadLineFit1008->SetParError(0,0.3088695);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1324867);
   ...
   quadLineFit1009->SetChisquare(2.078059e-21);
   ...
   quadLineFit1009->SetParameter(0,4.577993);
   quadLineFit1009->SetParError(0,0.3088695);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1324867);
   ...
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(2,50.000000 ppm_fx1009,50.000000 ppm_fy1009,50.000000 ppm_fex1009,50.000000 ppm_fey1009);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(5);
   ...
   TH1F *Graph_50dO000000sPppm1009 = new TH1F("Graph_50dO000000sPppm1009","Graph",100,15.77,18.53);
   Graph_50dO000000sPppm1009->SetMinimum(3.754472);
   Graph_50dO000000sPppm1009->SetMaximum(4.48227);
   ...
   quadLineFit1010->SetChisquare(7.307751e-19);
   ...
   quadLineFit1010->SetParameter(0,8.204909);
   quadLineFit1010->SetParError(0,0.3088695);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-0.2382821);
   ...
   quadLineFit1011->SetChisquare(7.307751e-19);
   ...
   quadLineFit1011->SetParameter(0,8.204909);
   quadLineFit1011->SetParError(0,0.3088695);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-0.2382821);
