...
//=========  (Fri Oct 16 07:53:53 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.94358,75,84.74978);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01083->SetMinimum(-50.87425);
   Graph_Graph01083->SetMaximum(69.68045);
   ...
   checkFit1084->SetParameter(0,8.43693);
   checkFit1084->SetParError(0,0.8049368);
   checkFit1084->SetParLimits(0,0,0);
   checkFit1084->SetParameter(1,0.9713162);
   checkFit1084->SetParError(1,0.02276705);
   ...
   pt_LaTex = pt->AddText("0.971#pm0.0228");
   pt_LaTex = pt->AddText(" 8.44#pm0.805");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.686079,-50.87425,-8.686079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1085->SetParameter(0,8.43693);
   checkFit1085->SetParError(0,0.8049368);
   checkFit1085->SetParLimits(0,0,0);
   checkFit1085->SetParameter(1,0.9713162);
   checkFit1085->SetParError(1,0.02276705);
