...
//=========  (Fri Oct 16 07:53:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.347417,75,0.2846376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01123->SetMinimum(-0.2842115);
   Graph_Graph01123->SetMaximum(0.2214321);
   ...
   mainFit1124->SetParameter(0,-0.03237148);
   mainFit1124->SetParError(0,0.002702766);
   mainFit1124->SetParLimits(0,0,0);
   mainFit1124->SetParameter(1,-0.004108046);
   mainFit1124->SetParError(1,7.644578e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00411#pm7.64e-05");
   pt_LaTex = pt->AddText("#minus0.0324#pm0.0027");
   pt_LaTex = pt->AddText("#minus7.88#pm0.674");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.880018,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.880018,-0.2842115,-7.880018,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1125->SetParameter(0,-0.03237148);
   mainFit1125->SetParError(0,0.002702766);
   mainFit1125->SetParLimits(0,0,0);
   mainFit1125->SetParameter(1,-0.004108046);
   mainFit1125->SetParError(1,7.644578e-05);
