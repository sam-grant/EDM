...
//=========  (Fri Oct 16 07:53:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3675042,75,0.300011);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-0.3007527);
   Graph_Graph01011->SetMaximum(0.2332595);
   ...
   mainFit1012->SetChisquare(0.9630112);
   ...
   mainFit1012->SetParameter(0,-0.03578318);
   mainFit1012->SetParError(0,0.008036217);
   mainFit1012->SetParLimits(0,0,0);
   mainFit1012->SetParameter(1,-0.00409163);
   mainFit1012->SetParError(1,0.0002272985);
   ...
   pt_LaTex = pt->AddText("#minus0.00409#pm0.000227");
   pt_LaTex = pt->AddText("#minus0.0358#pm0.00804");
   pt_LaTex = pt->AddText("#minus8.75#pm 2.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.745458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.745458,-0.3007527,-8.745458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1013->SetChisquare(0.9630112);
   ...
   mainFit1013->SetParameter(0,-0.03578318);
   mainFit1013->SetParError(0,0.008036217);
   mainFit1013->SetParLimits(0,0,0);
   mainFit1013->SetParameter(1,-0.00409163);
   mainFit1013->SetParError(1,0.0002272985);
