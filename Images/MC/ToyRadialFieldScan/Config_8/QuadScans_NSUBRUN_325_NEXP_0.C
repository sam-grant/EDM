...
//=========  (Fri Oct 16 07:54:02 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1169[2] = {
   16,
   18.3};
   Double_t -50.000000 ppm_fy1169[2] = {
   -3.152425,
   -2.771316};
   Double_t -50.000000 ppm_fex1169[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1169[2] = {
   0.008174905,
   0.008174905};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1169,-50.000000 ppm_fy1169,-50.000000 ppm_fex1169,-50.000000 ppm_fey1169);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1169 = new TH1F("Graph_mI50dO000000sPppm1169","",100,15.77,18.53);
   ...
   quadLineFit1170->SetChisquare(1.020798e-18);
   ...
   quadLineFit1170->SetParameter(0,-5.80362);
   quadLineFit1170->SetParError(0,0.08639889);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,0.1656997);
   quadLineFit1170->SetParError(1,0.005026548);
   ...
   quadLineFit1171->SetChisquare(1.020798e-18);
   ...
   quadLineFit1171->SetParameter(0,-5.80362);
   quadLineFit1171->SetParError(0,0.08639889);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,0.1656997);
   quadLineFit1171->SetParError(1,0.005026548);
   quadLineFit1171->SetParLimits(1,0,0);
   quadLineFit1171->Draw("same");
   
   Double_t -25.000000 ppm_fx1171[2] = {
   16,
   18.3};
   Double_t -25.000000 ppm_fy1171[2] = {
   -1.278652,
   -1.106257};
   Double_t -25.000000 ppm_fex1171[2] = {
   0,
   0};
   Double_t -25.000000 ppm_fey1171[2] = {
   0.008174905,
   0.008174905};
   gre = new TGraphErrors(2,-25.000000 ppm_fx1171,-25.000000 ppm_fy1171,-25.000000 ppm_fex1171,-25.000000 ppm_fey1171);
   ...
   TH1F *Graph_mI25dO000000sPppm1171 = new TH1F("Graph_mI25dO000000sPppm1171","Graph",100,15.77,18.53);
   Graph_mI25dO000000sPppm1171->SetMinimum(-1.305701);
   Graph_mI25dO000000sPppm1171->SetMaximum(-1.079208);
   ...
   quadLineFit1172->SetChisquare(8.150197e-17);
   ...
   quadLineFit1172->SetParameter(0,-2.477922);
   quadLineFit1172->SetParError(0,0.08639889);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,0.07495436);
   quadLineFit1172->SetParError(1,0.005026548);
   ...
   quadLineFit1173->SetChisquare(8.150197e-17);
   ...
   quadLineFit1173->SetParameter(0,-2.477922);
   quadLineFit1173->SetParError(0,0.08639889);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,0.07495436);
   quadLineFit1173->SetParError(1,0.005026548);
   quadLineFit1173->SetParLimits(1,0,0);
   quadLineFit1173->Draw("same");
   
   Double_t 0.000000 ppm_fx1173[2] = {
   16,
   18.3};
   Double_t 0.000000 ppm_fy1173[2] = {
   0.5919885,
   0.5273004};
   Double_t 0.000000 ppm_fex1173[2] = {
   0,
   0};
   Double_t 0.000000 ppm_fey1173[2] = {
   0.008174905,
   0.008174905};
   gre = new TGraphErrors(2,0.000000 ppm_fx1173,0.000000 ppm_fy1173,0.000000 ppm_fex1173,0.000000 ppm_fey1173);
   ...
   TH1F *Graph_0dO000000sPppm1173 = new TH1F("Graph_0dO000000sPppm1173","Graph",100,15.77,18.53);
   Graph_0dO000000sPppm1173->SetMinimum(0.5110217);
   Graph_0dO000000sPppm1173->SetMaximum(0.6082672);
   ...
   quadLineFit1174->SetChisquare(6.34308e-21);
   ...
   quadLineFit1174->SetParameter(0,1.041992);
   quadLineFit1174->SetParError(0,0.08639889);
   quadLineFit1174->SetParLimits(0,0,0);
   quadLineFit1174->SetParameter(1,-0.02812524);
   quadLineFit1174->SetParError(1,0.005026548);
   ...
   quadLineFit1175->SetChisquare(6.34308e-21);
   ...
   quadLineFit1175->SetParameter(0,1.041992);
   quadLineFit1175->SetParError(0,0.08639889);
   quadLineFit1175->SetParLimits(0,0,0);
   quadLineFit1175->SetParameter(1,-0.02812524);
   quadLineFit1175->SetParError(1,0.005026548);
   quadLineFit1175->SetParLimits(1,0,0);
   quadLineFit1175->Draw("same");
   
   Double_t 25.000000 ppm_fx1175[2] = {
   16,
   18.3};
   Double_t 25.000000 ppm_fy1175[2] = {
   2.463037,
   2.166258};
   Double_t 25.000000 ppm_fex1175[2] = {
   0,
   0};
   Double_t 25.000000 ppm_fey1175[2] = {
   0.008174905,
   0.008174905};
   gre = new TGraphErrors(2,25.000000 ppm_fx1175,25.000000 ppm_fy1175,25.000000 ppm_fex1175,25.000000 ppm_fey1175);
   gre->SetName("25.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_25dO000000sPppm1175 = new TH1F("Graph_25dO000000sPppm1175","Graph",100,15.77,18.53);
   Graph_25dO000000sPppm1175->SetMinimum(2.12677);
   Graph_25dO000000sPppm1175->SetMaximum(2.502524);
   ...
   quadLineFit1176->SetChisquare(2.735147e-20);
   ...
   quadLineFit1176->SetParameter(0,4.527582);
   quadLineFit1176->SetParError(0,0.0863989);
   quadLineFit1176->SetParLimits(0,0,0);
   quadLineFit1176->SetParameter(1,-0.1290341);
   quadLineFit1176->SetParError(1,0.005026548);
   ...
   quadLineFit1177->SetChisquare(2.735147e-20);
   ...
   quadLineFit1177->SetParameter(0,4.527582);
   quadLineFit1177->SetParError(0,0.0863989);
   quadLineFit1177->SetParLimits(0,0,0);
   quadLineFit1177->SetParameter(1,-0.1290341);
   quadLineFit1177->SetParError(1,0.005026548);
   ...
   Graph_50dO000000sPppm1177->SetMinimum(3.749112);
   Graph_50dO000000sPppm1177->SetMaximum(4.439113);
   ...
   quadLineFit1178->SetChisquare(6.531624e-20);
   ...
   quadLineFit1178->SetParameter(0,8.259703);
   quadLineFit1178->SetParError(0,0.08639889);
   quadLineFit1178->SetParLimits(0,0,0);
   quadLineFit1178->SetParameter(1,-0.2428916);
   quadLineFit1178->SetParError(1,0.005026548);
   ...
   quadLineFit1179->SetChisquare(6.531624e-20);
   ...
   quadLineFit1179->SetParameter(0,8.259703);
   quadLineFit1179->SetParError(0,0.08639889);
   quadLineFit1179->SetParLimits(0,0,0);
   quadLineFit1179->SetParameter(1,-0.2428916);
   quadLineFit1179->SetParError(1,0.005026548);
