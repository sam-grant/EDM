...
//=========  (Fri Oct 16 07:53:59 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01153->SetMinimum(-51.78789);
   Graph_Graph01153->SetMaximum(69.42713);
   ...
   checkFit1154->SetParameter(0,8.456255);
   checkFit1154->SetParError(0,0.5938351);
   checkFit1154->SetParLimits(0,0,0);
   checkFit1154->SetParameter(1,0.9804424);
   checkFit1154->SetParError(1,0.01679619);
   ...
   pt_LaTex = pt->AddText(" 0.98#pm0.0168");
   pt_LaTex = pt->AddText(" 8.46#pm0.594");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.624939,-51.78789,-8.624939,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1155->SetParameter(0,8.456255);
   checkFit1155->SetParError(0,0.5938351);
   checkFit1155->SetParLimits(0,0,0);
   checkFit1155->SetParameter(1,0.9804424);
   checkFit1155->SetParError(1,0.01679619);
