...
//=========  (Fri Oct 16 07:53:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.30091,75,88.41159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-55.32966);
   Graph_Graph01111->SetMaximum(72.44034);
   ...
   checkFit1112->SetParameter(0,8.513883);
   checkFit1112->SetParError(0,0.6966825);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,1.031815);
   checkFit1112->SetParError(1,0.01970516);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0197");
   pt_LaTex = pt->AddText(" 8.51#pm0.697");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.251369,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.251369,-55.32966,-8.251369,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetParameter(0,8.513883);
   checkFit1113->SetParError(0,0.6966825);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,1.031815);
   checkFit1113->SetParError(1,0.01970516);
