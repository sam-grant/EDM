...
//=========  (Fri Oct 16 07:53:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.50665,75,84.76006);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-54.07998);
   Graph_Graph01069->SetMaximum(69.33339);
   ...
   checkFit1070->SetParameter(0,9.156046);
   checkFit1070->SetParError(0,0.8821507);
   checkFit1070->SetParLimits(0,0,0);
   checkFit1070->SetParameter(1,0.9798122);
   checkFit1070->SetParError(1,0.02495099);
   ...
   pt_LaTex = pt->AddText(" 0.98#pm0.025");
   pt_LaTex = pt->AddText(" 9.16#pm0.882");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.344695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.344695,-54.07998,-9.344695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1071->SetParameter(0,9.156046);
   checkFit1071->SetParError(0,0.8821507);
   checkFit1071->SetParLimits(0,0,0);
   checkFit1071->SetParameter(1,0.9798122);
   checkFit1071->SetParError(1,0.02495099);
