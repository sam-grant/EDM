void FieldFitCheck_NSUBRUN_75_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:15 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-105.9185,75,395.9702);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-55.72961);
   Graph_Graph01047->SetMaximum(345.7813);
   ...
   checkFit1048->SetChisquare(59933.92);
   ...
   checkFit1048->SetParameter(0,67.20852);
   checkFit1048->SetParError(0,0.4060555);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,-1.521942);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.15972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.15972,-55.72961,44.15972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(59933.92);
   ...
   checkFit1049->SetParameter(0,67.20852);
   checkFit1049->SetParError(0,0.4060555);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,-1.521942);
