void FieldFit_NSUBRUN_792_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:44 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01093 = new TH1F("Graph_Graph01093","",100,-36,36);
   Graph_Graph01093->SetMinimum(-140.657);
   Graph_Graph01093->SetMaximum(159.9385);
   ...
   Graph_Graph01093->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *mainFit1094 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1094->SetChisquare(7.82679e-22);
   ...
   mainFit1094->SetParameter(0,9.640711);
   mainFit1094->SetParError(0,63);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,1.205089);
   mainFit1094->SetParError(1,2.1);
...
");
   ...
   TF1 *mainFit1095 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1095->SetChisquare(7.82679e-22);
   ...
   mainFit1095->SetParameter(0,9.640711);
   mainFit1095->SetParError(0,63);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,1.205089);
   mainFit1095->SetParError(1,2.1);
