void QuadScans_NSUBRUN_175_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:43 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.204601,0.0663141,7.526263);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1097->SetMinimum(-3.931515);
   Graph_mI50dO000000sPppm1097->SetMaximum(6.253177);
   ...
   TF1 *quadLineFit1098 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   quadLineFit1098->SetFillColor(19);
   quadLineFit1098->SetFillStyle(0);
   quadLineFit1098->SetLineWidth(2);
   quadLineFit1098->SetChisquare(1.291649);
   ...
   quadLineFit1098->SetParameter(0,-0.08271292);
   quadLineFit1098->SetParError(0,0.07910988);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,-49.06265);
   quadLineFit1098->SetParError(1,1.396842);
   quadLineFit1098->SetParLimits(1,0,0);
   quadLineFit1098->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1098);
   gre->Draw("ap");
   
   TF1 *quadLineFit1099 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   quadLineFit1099->SetFillColor(19);
   quadLineFit1099->SetFillStyle(0);
   quadLineFit1099->SetLineWidth(2);
   quadLineFit1099->SetChisquare(1.291649);
   ...
   quadLineFit1099->SetParameter(0,-0.08271292);
   quadLineFit1099->SetParError(0,0.07910988);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,-49.06265);
   quadLineFit1099->SetParError(1,1.396842);
   ...
   Graph_mI30dO000000sPppm1099->SetMinimum(-1.966374);
   Graph_mI30dO000000sPppm1099->SetMaximum(-1.284369);
   ...
   TF1 *quadLineFit1100 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1100->SetChisquare(2.869113);
   ...
   quadLineFit1100->SetParameter(0,0.05620766);
   quadLineFit1100->SetParError(0,0.04450149);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,-27.45388);
   quadLineFit1100->SetParError(1,0.733472);
   quadLineFit1100->SetParLimits(1,0,0);
   quadLineFit1100->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1100);
   gre->Draw("p ");
   
   TF1 *quadLineFit1101 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1101->SetChisquare(2.869113);
   ...
   quadLineFit1101->SetParameter(0,0.05620766);
   quadLineFit1101->SetParError(0,0.04450149);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,-27.45388);
   quadLineFit1101->SetParError(1,0.733472);
   ...
   Graph_mI10dO000000sPppm1101->SetMinimum(-0.2061581);
   Graph_mI10dO000000sPppm1101->SetMaximum(-0.1042479);
   ...
   TF1 *quadLineFit1102 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1102->SetChisquare(3.781259);
   ...
   quadLineFit1102->SetParameter(0,0.0291505);
   quadLineFit1102->SetParError(0,0.0445035);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-2.889576);
   quadLineFit1102->SetParError(1,0.7335049);
   quadLineFit1102->SetParLimits(1,0,0);
   quadLineFit1102->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1102);
   gre->Draw("p ");
   
   TF1 *quadLineFit1103 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1103->SetChisquare(3.781259);
   ...
   quadLineFit1103->SetParameter(0,0.0291505);
   quadLineFit1103->SetParError(0,0.0445035);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-2.889576);
   quadLineFit1103->SetParError(1,0.7335049);
   ...
   Graph_10dO000000sPppm1103->SetMinimum(1.072747);
   Graph_10dO000000sPppm1103->SetMaximum(1.595506);
   ...
   TF1 *quadLineFit1104 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1104->SetChisquare(0.001379404);
   ...
   quadLineFit1104->SetParameter(0,0.07549511);
   quadLineFit1104->SetParError(0,0.0487919);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,20.51105);
   quadLineFit1104->SetParError(1,0.7833693);
   quadLineFit1104->SetParLimits(1,0,0);
   quadLineFit1104->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1104);
   gre->Draw("p ");
   
   TF1 *quadLineFit1105 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1105->SetChisquare(0.001379404);
   ...
   quadLineFit1105->SetParameter(0,0.07549511);
   quadLineFit1105->SetParError(0,0.0487919);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,20.51105);
   quadLineFit1105->SetParError(1,0.7833693);
   ...
   Graph_30dO000000sPppm1105->SetMinimum(2.243475);
   Graph_30dO000000sPppm1105->SetMaximum(3.385573);
   ...
   TF1 *quadLineFit1106 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1106->SetChisquare(5.258754);
   ...
   quadLineFit1106->SetParameter(0,-0.06054695);
   quadLineFit1106->SetParError(0,0.04450218);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,46.77264);
   quadLineFit1106->SetParError(1,0.7334829);
   quadLineFit1106->SetParLimits(1,0,0);
   quadLineFit1106->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1106);
   gre->Draw("p ");
   
   TF1 *quadLineFit1107 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1107->SetChisquare(5.258754);
   ...
   quadLineFit1107->SetParameter(0,-0.06054695);
   quadLineFit1107->SetParError(0,0.04450218);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,46.77264);
   quadLineFit1107->SetParError(1,0.7334829);
   ...
   Graph_50dO000000sPppm1107->SetMinimum(3.447289);
   Graph_50dO000000sPppm1107->SetMaximum(5.156128);
   ...
   TF1 *quadLineFit1108 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1108->SetChisquare(6.982364);
   ...
   quadLineFit1108->SetParameter(0,-0.001126448);
   quadLineFit1108->SetParError(0,0.04449943);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,69.89188);
   quadLineFit1108->SetParError(1,0.7334386);
   quadLineFit1108->SetParLimits(1,0,0);
   quadLineFit1108->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1108);
   gre->Draw("p ");
   
   TF1 *quadLineFit1109 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1109->SetChisquare(6.982364);
   ...
   quadLineFit1109->SetParameter(0,-0.001126448);
   quadLineFit1109->SetParError(0,0.04449943);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,69.89188);
   quadLineFit1109->SetParError(1,0.7334386);
