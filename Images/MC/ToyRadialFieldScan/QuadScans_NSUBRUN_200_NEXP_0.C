...
//=========  (Fri Oct  9 19:09:38 2020) by ROOT version 6.22/02
   ...
   quadLineFit1072->SetChisquare(4.115795e-19);
   ...
   quadLineFit1072->SetParameter(0,-2.981868);
   quadLineFit1072->SetParError(0,0.06676866);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,0.0830904);
   ...
   quadLineFit1073->SetChisquare(4.115795e-19);
   ...
   quadLineFit1073->SetParameter(0,-2.981868);
   quadLineFit1073->SetParError(0,0.06676866);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,0.0830904);
   ...
   Graph_mI10dO000000sPppm1073->SetMinimum(-0.1548414);
   Graph_mI10dO000000sPppm1073->SetMaximum(-0.09952633);
   ...
   quadLineFit1074->SetChisquare(5.796044e-23);
   ...
   quadLineFit1074->SetParameter(0,-0.2407678);
   quadLineFit1074->SetParError(0,0.06676866);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.006310219);
   ...
   quadLineFit1075->SetChisquare(5.796044e-23);
   ...
   quadLineFit1075->SetParameter(0,-0.2407678);
   quadLineFit1075->SetParError(0,0.06676866);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.006310219);
   ...
   Graph_10dO000000sPppm1075->SetMinimum(1.037895);
   Graph_10dO000000sPppm1075->SetMaximum(1.397334);
   ...
   quadLineFit1076->SetChisquare(6.391927e-18);
   ...
   quadLineFit1076->SetParameter(0,2.471664);
   quadLineFit1076->SetParError(0,0.06676866);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.06966943);
   ...
   quadLineFit1077->SetChisquare(6.391927e-18);
   ...
   quadLineFit1077->SetParameter(0,2.471664);
   quadLineFit1077->SetParError(0,0.06676866);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.06966943);
   ...
   Graph_30dO000000sPppm1077->SetMinimum(2.219903);
   Graph_30dO000000sPppm1077->SetMaximum(2.932724);
   ...
   quadLineFit1078->SetChisquare(5.68229e-19);
   ...
   quadLineFit1078->SetParameter(0,5.155546);
   quadLineFit1078->SetParError(0,0.06676866);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.1432907);
   ...
   quadLineFit1079->SetChisquare(5.68229e-19);
   ...
   quadLineFit1079->SetParameter(0,5.155546);
   quadLineFit1079->SetParError(0,0.06676866);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.1432907);
