...
//=========  (Wed Dec  2 23:08:03 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1085 = new TH1F("Graph_mI30dO000000sPppm1085","",100,0.05396825,0.07301587);
   ...
   Graph_mI30dO000000sPppm1085->GetXaxis()->SetTitle("1/QHV [kV^{-1}]");
   ...
   TF1 *quadLineFit1086 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1086->SetFillColor(19);
   quadLineFit1086->SetFillStyle(0);
   quadLineFit1086->SetLineWidth(2);
   quadLineFit1086->SetChisquare(0.6430311);
   ...
   quadLineFit1086->SetParameter(0,-0.05595393);
   quadLineFit1086->SetParError(0,0.05896898);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-25.47323);
   quadLineFit1086->SetParError(1,0.9287228);
   quadLineFit1086->SetParLimits(1,0,0);
   quadLineFit1086->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1086);
   gre->Draw("ap");
   
   TF1 *quadLineFit1087 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   quadLineFit1087->SetFillColor(19);
   quadLineFit1087->SetFillStyle(0);
   quadLineFit1087->SetLineWidth(2);
   quadLineFit1087->SetChisquare(0.6430311);
   ...
   quadLineFit1087->SetParameter(0,-0.05595393);
   quadLineFit1087->SetParError(0,0.05896898);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-25.47323);
   quadLineFit1087->SetParError(1,0.9287228);
   ...
   TH1F *Graph_mI10dO000000sPppm1087 = new TH1F("Graph_mI10dO000000sPppm1087","Graph",100,0.05396825,0.07301587);
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.189736);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.1381902);
   ...
   TF1 *quadLineFit1088 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1088->SetChisquare(0.2124603);
   ...
   quadLineFit1088->SetParameter(0,-0.07184913);
   quadLineFit1088->SetParError(0,0.0589837);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-1.419893);
   quadLineFit1088->SetParError(1,0.9289554);
   quadLineFit1088->SetParLimits(1,0,0);
   quadLineFit1088->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1088);
   gre->Draw("p ");
   
   TF1 *quadLineFit1089 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301587, TF1::EAddToList::kNo);
   ...
   quadLineFit1089->SetChisquare(0.2124603);
   ...
   quadLineFit1089->SetParameter(0,-0.07184913);
   quadLineFit1089->SetParError(0,0.0589837);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-1.419893);
   quadLineFit1089->SetParError(1,0.9289554);
   ...
   TH1F *Graph_10dO000000sPppm1089 = new TH1F("Graph_10dO000000sPppm1089","Graph",100,0.05396825,0.07301587);
   Graph_10dO000000sPppm1089->SetMinimum(1.173302);
   Graph_10dO000000sPppm1089->SetMaximum(1.588662);
   ...
   quadLineFit1090->SetChisquare(0.5251831);
   ...
   quadLineFit1090->SetParameter(0,0.07390829);
   quadLineFit1090->SetParError(0,0.05896613);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,20.53783);
   quadLineFit1090->SetParError(1,0.928678);
   ...
   quadLineFit1091->SetChisquare(0.5251831);
   ...
   quadLineFit1091->SetParameter(0,0.07390829);
   quadLineFit1091->SetParError(0,0.05896613);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,20.53783);
   quadLineFit1091->SetParError(1,0.928678);
   ...
   Graph_30dO000000sPppm1091->SetMinimum(2.455412);
   Graph_30dO000000sPppm1091->SetMaximum(3.331304);
   ...
   quadLineFit1092->SetChisquare(3.718155);
   ...
   quadLineFit1092->SetParameter(0,0.07376258);
   quadLineFit1092->SetParError(0,0.05898485);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,44.5379);
   quadLineFit1092->SetParError(1,0.928974);
   ...
   quadLineFit1093->SetChisquare(3.718155);
   ...
   quadLineFit1093->SetParameter(0,0.07376258);
   quadLineFit1093->SetParError(0,0.05898485);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,44.5379);
   quadLineFit1093->SetParError(1,0.928974);
