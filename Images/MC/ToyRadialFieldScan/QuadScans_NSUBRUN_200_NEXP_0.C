...
//=========  (Tue Oct  6 23:07:54 2020) by ROOT version 6.22/02
   ...
   quadLineFit1072->SetChisquare(1.120903e-20);
   ...
   quadLineFit1072->SetParameter(0,-4.319024);
   quadLineFit1072->SetParError(0,0.06693634);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,0.1217658);
   ...
   quadLineFit1073->SetChisquare(1.120903e-20);
   ...
   quadLineFit1073->SetParameter(0,-4.319024);
   quadLineFit1073->SetParError(0,0.06693634);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,0.1217658);
   ...
   Graph_mI10dO000000sPppm1073->SetMinimum(-1.174764);
   Graph_mI10dO000000sPppm1073->SetMaximum(-0.8639917);
   ...
   quadLineFit1074->SetChisquare(1.68844e-18);
   ...
   quadLineFit1074->SetParameter(0,-2.09069);
   quadLineFit1074->SetParError(0,0.06693634);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.05951735);
   ...
   quadLineFit1075->SetChisquare(1.68844e-18);
   ...
   quadLineFit1075->SetParameter(0,-2.09069);
   quadLineFit1075->SetParError(0,0.06693634);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.05951735);
   ...
   Graph_10dO000000sPppm1075->SetMinimum(0.08102318);
   Graph_10dO000000sPppm1075->SetMaximum(0.1411658);
   ...
   quadLineFit1076->SetChisquare(1.568935e-21);
   ...
   quadLineFit1076->SetParameter(0,0.2425462);
   quadLineFit1076->SetParError(0,0.06693634);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.007302871);
   ...
   quadLineFit1077->SetChisquare(1.568935e-21);
   ...
   quadLineFit1077->SetParameter(0,0.2425462);
   quadLineFit1077->SetParError(0,0.06693634);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.007302871);
   ...
   Graph_30dO000000sPppm1077->SetMinimum(1.059067);
   Graph_30dO000000sPppm1077->SetMaximum(1.425671);
   ...
   quadLineFit1078->SetChisquare(2.296516e-20);
   ...
   quadLineFit1078->SetParameter(0,2.523049);
   quadLineFit1078->SetParError(0,0.06693634);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.07114892);
   ...
   quadLineFit1079->SetChisquare(2.296516e-20);
   ...
   quadLineFit1079->SetParameter(0,2.523049);
   quadLineFit1079->SetParError(0,0.06693634);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.07114892);
