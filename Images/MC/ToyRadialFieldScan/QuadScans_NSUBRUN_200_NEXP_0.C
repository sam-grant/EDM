...
//=========  (Thu Oct  8 17:32:47 2020) by ROOT version 6.22/02
   ...
   quadLineFit1072->SetChisquare(4.83675e-20);
   ...
   quadLineFit1072->SetParameter(0,-3.373866);
   quadLineFit1072->SetParError(0,0.06676866);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,0.09397683);
   ...
   quadLineFit1073->SetChisquare(4.83675e-20);
   ...
   quadLineFit1073->SetParameter(0,-3.373866);
   quadLineFit1073->SetParError(0,0.06676866);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,0.09397683);
   ...
   Graph_mI10dO000000sPppm1073->SetMinimum(-0.6293376);
   Graph_mI10dO000000sPppm1073->SetMaximum(-0.4683479);
   ...
   quadLineFit1074->SetChisquare(3.446149e-21);
   ...
   quadLineFit1074->SetParameter(0,-1.058707);
   quadLineFit1074->SetParError(0,0.06676866);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.02832577);
   ...
   quadLineFit1075->SetChisquare(3.446149e-21);
   ...
   quadLineFit1075->SetParameter(0,-1.058707);
   quadLineFit1075->SetParError(0,0.06676866);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.02832577);
   ...
   Graph_10dO000000sPppm1075->SetMinimum(0.4616502);
   Graph_10dO000000sPppm1075->SetMaximum(0.6542649);
   ...
   quadLineFit1076->SetChisquare(2.348846e-21);
   ...
   quadLineFit1076->SetParameter(0,1.186415);
   quadLineFit1076->SetParError(0,0.06676866);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.0349143);
   ...
   quadLineFit1077->SetChisquare(2.348846e-21);
   ...
   quadLineFit1077->SetParameter(0,1.186415);
   quadLineFit1077->SetParError(0,0.06676866);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.0349143);
   ...
   Graph_30dO000000sPppm1077->SetMinimum(1.451008);
   Graph_30dO000000sPppm1077->SetMaximum(1.907022);
   ...
   quadLineFit1078->SetChisquare(1.486767e-19);
   ...
   quadLineFit1078->SetParameter(0,3.295221);
   quadLineFit1078->SetParError(0,0.06676866);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.08978922);
   ...
   quadLineFit1079->SetChisquare(1.486767e-19);
   ...
   quadLineFit1079->SetParameter(0,3.295221);
   quadLineFit1079->SetParError(0,0.06676866);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.08978922);
