...
//=========  (Mon Oct 12 20:04:23 2020) by ROOT version 6.22/02
   ...
   quadLineFit1072->SetChisquare(1.003237e-20);
   ...
   quadLineFit1072->SetParameter(0,-2.9354);
   quadLineFit1072->SetParError(0,0.06676866);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,0.07989951);
   ...
   quadLineFit1073->SetChisquare(1.003237e-20);
   ...
   quadLineFit1073->SetParameter(0,-2.9354);
   quadLineFit1073->SetParError(0,0.06676866);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,0.07989951);
   ...
   Graph_mI10dO000000sPppm1073->SetMinimum(-0.1641715);
   Graph_mI10dO000000sPppm1073->SetMaximum(-0.09667553);
   ...
   quadLineFit1074->SetChisquare(1.620349e-21);
   ...
   quadLineFit1074->SetParameter(0,-0.2896856);
   quadLineFit1074->SetParError(0,0.06676866);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.008847895);
   ...
   quadLineFit1075->SetChisquare(1.620349e-21);
   ...
   quadLineFit1075->SetParameter(0,-0.2896856);
   quadLineFit1075->SetParError(0,0.06676866);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.008847895);
   ...
   Graph_10dO000000sPppm1075->SetMinimum(1.028913);
   Graph_10dO000000sPppm1075->SetMaximum(1.396993);
   ...
   quadLineFit1076->SetChisquare(5.552159e-21);
   ...
   quadLineFit1076->SetParameter(0,2.499408);
   quadLineFit1076->SetParError(0,0.06676866);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.07146971);
   ...
   quadLineFit1077->SetChisquare(5.552159e-21);
   ...
   quadLineFit1077->SetParameter(0,2.499408);
   quadLineFit1077->SetParError(0,0.06676866);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.07146971);
   ...
   Graph_30dO000000sPppm1077->SetMinimum(2.217928);
   Graph_30dO000000sPppm1077->SetMaximum(2.937965);
   ...
   quadLineFit1078->SetChisquare(3.032504e-20);
   ...
   quadLineFit1078->SetParameter(0,5.184239);
   quadLineFit1078->SetParError(0,0.06676866);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.144794);
   ...
   quadLineFit1079->SetChisquare(3.032504e-20);
   ...
   quadLineFit1079->SetParameter(0,5.184239);
   quadLineFit1079->SetParError(0,0.06676866);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.144794);
