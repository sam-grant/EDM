...
//=========  (Wed Jan  5 17:06:58 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.066306,0.0768254,3.886188);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(-2.371057);
   Graph_30dO000000sPppm1057->SetMaximum(3.190938);
   ...
   quadLineFit1058->SetChisquare(7.571747e-20);
   ...
   quadLineFit1058->SetParameter(1,45.69203);
   ...
   quadLineFit1059->SetChisquare(7.571747e-20);
   ...
   quadLineFit1059->SetParameter(1,45.69203);
   ...
   Graph_mI30dO000000sPppm1059->SetMinimum(-1.951908);
   Graph_mI30dO000000sPppm1059->SetMaximum(-1.416597);
   ...
   quadLineFit1060->SetChisquare(5.461997e-18);
   ...
   quadLineFit1060->SetParameter(1,-26.78666);
   ...
   quadLineFit1061->SetChisquare(5.461997e-18);
   ...
   quadLineFit1061->SetParameter(1,-26.78666);
