...
//=========  (Wed Jan  5 17:09:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-41.40626,45,57.39949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-31.52569);
   Graph_Graph01039->SetMaximum(47.51891);
   ...
   checkFit1040->SetChisquare(4.368461e-17);
   ...
   checkFit1040->SetParameter(0,7.996613);
   checkFit1040->SetParError(0,1.095066);
   checkFit1040->SetParLimits(0,0,0);
   checkFit1040->SetParameter(1,1.04622);
   checkFit1040->SetParError(1,0.03650221);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.64334,-31.52569,-7.64334,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(4.368461e-17);
   ...
   checkFit1041->SetParameter(0,7.996613);
   checkFit1041->SetParError(0,1.095066);
   checkFit1041->SetParLimits(0,0,0);
   checkFit1041->SetParameter(1,1.04622);
   checkFit1041->SetParError(1,0.03650221);
