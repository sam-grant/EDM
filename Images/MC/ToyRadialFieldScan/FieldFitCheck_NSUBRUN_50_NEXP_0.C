...
//=========  (Wed Oct 14 22:34:40 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-41.03931,45,58.59162);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-31.07621);
   Graph_Graph01023->SetMaximum(48.62852);
   ...
   checkFit1024->SetParameter(0,7.956345);
   checkFit1024->SetParError(0,0.9735781);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,1.01703);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0435");
   pt_LaTex = pt->AddText(" 7.96#pm0.974");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.823118,-31.07621,-7.823118,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetParameter(0,7.956345);
   checkFit1025->SetParError(0,0.9735781);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,1.01703);
