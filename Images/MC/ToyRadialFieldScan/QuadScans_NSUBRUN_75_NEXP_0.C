...
//=========  (Tue Oct  6 23:07:51 2020) by ROOT version 6.22/02
   ...
   quadLineFit1022->SetChisquare(2.421064e-19);
   ...
   quadLineFit1022->SetParameter(0,-4.334031);
   quadLineFit1022->SetParError(0,0.1093346);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.1230672);
   ...
   quadLineFit1023->SetChisquare(2.421064e-19);
   ...
   quadLineFit1023->SetParameter(0,-4.334031);
   quadLineFit1023->SetParError(0,0.1093346);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.1230672);
   ...
   Graph_mI10dO000000sPppm1023->SetMinimum(-1.182339);
   Graph_mI10dO000000sPppm1023->SetMaximum(-0.8737385);
   ...
   quadLineFit1024->SetChisquare(1.31038e-22);
   ...
   quadLineFit1024->SetParameter(0,-2.031612);
   quadLineFit1024->SetParError(0,0.1093346);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,0.05575407);
   ...
   quadLineFit1025->SetChisquare(1.31038e-22);
   ...
   quadLineFit1025->SetParameter(0,-2.031612);
   quadLineFit1025->SetParError(0,0.1093346);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,0.05575407);
   ...
   Graph_10dO000000sPppm1025->SetMinimum(0.08484637);
   Graph_10dO000000sPppm1025->SetMaximum(0.1328846);
   ...
   quadLineFit1026->SetChisquare(3.73803e-24);
   ...
   quadLineFit1026->SetParameter(0,0.135332);
   quadLineFit1026->SetParError(0,0.1093346);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.001470361);
   ...
   quadLineFit1027->SetChisquare(3.73803e-24);
   ...
   quadLineFit1027->SetParameter(0,0.135332);
   quadLineFit1027->SetParError(0,0.1093346);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.001470361);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(1.00868);
   Graph_30dO000000sPppm1027->SetMaximum(1.43649);
   ...
   quadLineFit1028->SetChisquare(1.893326e-21);
   ...
   quadLineFit1028->SetParameter(0,2.673195);
   quadLineFit1028->SetParError(0,0.1093346);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.08058948);
   ...
   quadLineFit1029->SetChisquare(1.893326e-21);
   ...
   quadLineFit1029->SetParameter(0,2.673195);
   quadLineFit1029->SetParError(0,0.1093346);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.08058948);
