...
//=========  (Mon Oct 12 12:24:40 2020) by ROOT version 6.22/02
   ...
   quadLineFit1022->SetChisquare(2.808295e-21);
   ...
   quadLineFit1022->SetParameter(0,-2.973538);
   quadLineFit1022->SetParError(0,0.1086052);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.0830288);
   ...
   quadLineFit1023->SetChisquare(2.808295e-21);
   ...
   quadLineFit1023->SetParameter(0,-2.973538);
   quadLineFit1023->SetParError(0,0.1086052);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.0830288);
   ...
   Graph_mI10dO000000sPppm1023->SetMinimum(-0.1754788);
   Graph_mI10dO000000sPppm1023->SetMaximum(-0.1050639);
   ...
   quadLineFit1024->SetChisquare(3.089053e-23);
   ...
   quadLineFit1024->SetParameter(0,-0.2516756);
   quadLineFit1024->SetParError(0,0.1086052);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,0.006189129);
   ...
   quadLineFit1025->SetChisquare(3.089053e-23);
   ...
   quadLineFit1025->SetParameter(0,-0.2516756);
   quadLineFit1025->SetParError(0,0.1086052);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,0.006189129);
   ...
   Graph_10dO000000sPppm1025->SetMinimum(1.018196);
   Graph_10dO000000sPppm1025->SetMaximum(1.401768);
   ...
   quadLineFit1026->SetChisquare(1.52359e-20);
   ...
   quadLineFit1026->SetParameter(0,2.495723);
   quadLineFit1026->SetParError(0,0.1086052);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.07143006);
   ...
   quadLineFit1027->SetChisquare(1.52359e-20);
   ...
   quadLineFit1027->SetParameter(0,2.495723);
   quadLineFit1027->SetParError(0,0.1086052);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.07143006);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(2.210741);
   Graph_30dO000000sPppm1027->SetMaximum(2.956963);
   ...
   quadLineFit1028->SetChisquare(1.010426e-19);
   ...
   quadLineFit1028->SetParameter(0,5.229533);
   quadLineFit1028->SetParError(0,0.1086052);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.1469823);
   ...
   quadLineFit1029->SetChisquare(1.010426e-19);
   ...
   quadLineFit1029->SetParameter(0,5.229533);
   quadLineFit1029->SetParError(0,0.1086052);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.1469823);
