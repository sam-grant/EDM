...
//=========  (Mon Jan 10 15:42:21 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.198658,0.0663141,7.527171);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1033->SetMinimum(-3.926075);
   Graph_mI50dO000000sPppm1033->SetMaximum(6.254588);
   ...
   quadLineFit1034->SetChisquare(1.675741);
   ...
   quadLineFit1034->SetParameter(0,-0.2379635);
   quadLineFit1034->SetParError(0,0.1207178);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,-46.55533);
   quadLineFit1034->SetParError(1,2.131509);
   ...
   quadLineFit1035->SetChisquare(1.675741);
   ...
   quadLineFit1035->SetParameter(0,-0.2379635);
   quadLineFit1035->SetParError(0,0.1207178);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,-46.55533);
   quadLineFit1035->SetParError(1,2.131509);
   ...
   Graph_mI30dO000000sPppm1035->SetMinimum(-1.977604);
   Graph_mI30dO000000sPppm1035->SetMaximum(-1.282288);
   ...
   quadLineFit1036->SetChisquare(3.03842);
   ...
   quadLineFit1036->SetParameter(0,0.003405255);
   quadLineFit1036->SetParError(0,0.06794674);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-26.53612);
   quadLineFit1036->SetParError(1,1.119895);
   ...
   quadLineFit1037->SetChisquare(3.03842);
   ...
   quadLineFit1037->SetParameter(0,0.003405255);
   quadLineFit1037->SetParError(0,0.06794674);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-26.53612);
   quadLineFit1037->SetParError(1,1.119895);
   ...
   Graph_mI10dO000000sPppm1037->SetMinimum(-0.1885145);
   Graph_mI10dO000000sPppm1037->SetMaximum(-0.09228561);
   ...
   quadLineFit1038->SetChisquare(2.42019);
   ...
   quadLineFit1038->SetParameter(0,-0.04740381);
   quadLineFit1038->SetParError(0,0.0679475);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-1.607469);
   quadLineFit1038->SetParError(1,1.119908);
   ...
   quadLineFit1039->SetChisquare(2.42019);
   ...
   quadLineFit1039->SetParameter(0,-0.04740381);
   quadLineFit1039->SetParError(0,0.0679475);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-1.607469);
   quadLineFit1039->SetParError(1,1.119908);
   ...
   Graph_10dO000000sPppm1039->SetMinimum(1.043302);
   Graph_10dO000000sPppm1039->SetMaximum(1.625254);
   ...
   quadLineFit1040->SetChisquare(0.6417898);
   ...
   quadLineFit1040->SetParameter(0,-0.04035726);
   quadLineFit1040->SetParError(0,0.07449478);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,22.31368);
   quadLineFit1040->SetParError(1,1.196037);
   ...
   quadLineFit1041->SetChisquare(0.6417898);
   ...
   quadLineFit1041->SetParameter(0,-0.04035726);
   quadLineFit1041->SetParError(0,0.07449478);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,22.31368);
   quadLineFit1041->SetParError(1,1.196037);
   ...
   Graph_30dO000000sPppm1041->SetMinimum(2.204813);
   Graph_30dO000000sPppm1041->SetMaximum(3.407691);
   ...
   quadLineFit1042->SetChisquare(1.403594);
   ...
   quadLineFit1042->SetParameter(0,-0.1082709);
   quadLineFit1042->SetParError(0,0.06795703);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,47.5559);
   quadLineFit1042->SetParError(1,1.120066);
   ...
   quadLineFit1043->SetChisquare(1.403594);
   ...
   quadLineFit1043->SetParameter(0,-0.1082709);
   quadLineFit1043->SetParError(0,0.06795703);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,47.5559);
   quadLineFit1043->SetParError(1,1.120066);
   ...
   Graph_50dO000000sPppm1043->SetMinimum(3.409037);
   Graph_50dO000000sPppm1043->SetMaximum(5.167265);
   ...
   quadLineFit1044->SetChisquare(0.7508103);
   ...
   quadLineFit1044->SetParameter(0,-0.0591029);
   quadLineFit1044->SetParError(0,0.06793585);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,70.79922);
   quadLineFit1044->SetParError(1,1.119718);
   ...
   quadLineFit1045->SetChisquare(0.7508103);
   ...
   quadLineFit1045->SetParameter(0,-0.0591029);
   quadLineFit1045->SetParError(0,0.06793585);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,70.79922);
   quadLineFit1045->SetParError(1,1.119718);
