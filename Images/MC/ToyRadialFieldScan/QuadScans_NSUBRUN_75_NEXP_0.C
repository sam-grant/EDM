...
//=========  (Fri Oct  9 19:09:33 2020) by ROOT version 6.22/02
   ...
   quadLineFit1022->SetChisquare(7.82916e-22);
   ...
   quadLineFit1022->SetParameter(0,-2.862467);
   quadLineFit1022->SetParError(0,0.1086052);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.07700819);
   ...
   quadLineFit1023->SetChisquare(7.82916e-22);
   ...
   quadLineFit1023->SetParameter(0,-2.862467);
   quadLineFit1023->SetParError(0,0.1086052);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.07700819);
   ...
   Graph_mI10dO000000sPppm1023->SetMinimum(-0.193172);
   Graph_mI10dO000000sPppm1023->SetMaximum(-0.0882412);
   ...
   quadLineFit1024->SetChisquare(3.439978e-22);
   ...
   quadLineFit1024->SetParameter(0,-0.3815456);
   quadLineFit1024->SetParError(0,0.1086052);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,0.01337994);
   ...
   quadLineFit1025->SetChisquare(3.439978e-22);
   ...
   quadLineFit1025->SetParameter(0,-0.3815456);
   quadLineFit1025->SetParError(0,0.1086052);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,0.01337994);
   ...
   Graph_10dO000000sPppm1025->SetMinimum(0.975596);
   Graph_10dO000000sPppm1025->SetMaximum(1.421668);
   ...
   quadLineFit1026->SetChisquare(9.664559e-20);
   ...
   quadLineFit1026->SetParameter(0,2.718753);
   quadLineFit1026->SetParError(0,0.1086052);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.08445113);
   ...
   quadLineFit1027->SetChisquare(9.664559e-20);
   ...
   quadLineFit1027->SetParameter(0,2.718753);
   quadLineFit1027->SetParError(0,0.1086052);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.08445113);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(2.228999);
   Graph_30dO000000sPppm1027->SetMaximum(2.949635);
   ...
   quadLineFit1028->SetChisquare(1.637402e-19);
   ...
   quadLineFit1028->SetParameter(0,5.139052);
   quadLineFit1028->SetParError(0,0.1086052);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.141652);
   ...
   quadLineFit1029->SetChisquare(1.637402e-19);
   ...
   quadLineFit1029->SetParameter(0,5.139052);
   quadLineFit1029->SetParError(0,0.1086052);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.141652);
