...
//=========  (Wed Jan  5 17:06:52 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.058714,0.0768254,3.879385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1017->SetMinimum(-2.364904);
   Graph_30dO000000sPppm1017->SetMaximum(3.185575);
   ...
   quadLineFit1018->SetChisquare(7.720972e-19);
   ...
   quadLineFit1018->SetParameter(1,45.41289);
   ...
   quadLineFit1019->SetChisquare(7.720972e-19);
   ...
   quadLineFit1019->SetParameter(1,45.41289);
   ...
   Graph_mI30dO000000sPppm1019->SetMinimum(-1.952979);
   Graph_mI30dO000000sPppm1019->SetMaximum(-1.42521);
   ...
   quadLineFit1020->SetChisquare(3.896708e-21);
   ...
   quadLineFit1020->SetParameter(1,-25.55642);
   ...
   quadLineFit1021->SetChisquare(3.896708e-21);
   ...
   quadLineFit1021->SetParameter(1,-25.55642);
