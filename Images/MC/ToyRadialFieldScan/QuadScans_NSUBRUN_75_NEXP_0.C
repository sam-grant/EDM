...
//=========  (Thu Oct  8 17:32:43 2020) by ROOT version 6.22/02
   ...
   quadLineFit1022->SetChisquare(1.776542e-20);
   ...
   quadLineFit1022->SetParameter(0,-3.27641);
   quadLineFit1022->SetParError(0,0.1086052);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.0887923);
   ...
   quadLineFit1023->SetChisquare(1.776542e-20);
   ...
   quadLineFit1023->SetParameter(0,-3.27641);
   quadLineFit1023->SetParError(0,0.1086052);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.0887923);
   ...
   Graph_mI10dO000000sPppm1023->SetMinimum(-0.6290931);
   Graph_mI10dO000000sPppm1023->SetMaximum(-0.4920117);
   ...
   quadLineFit1024->SetChisquare(3.156483e-21);
   ...
   quadLineFit1024->SetParameter(0,-0.9219559);
   quadLineFit1024->SetParError(0,0.1086052);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,0.02007797);
   ...
   quadLineFit1025->SetChisquare(3.156483e-21);
   ...
   quadLineFit1025->SetParameter(0,-0.9219559);
   quadLineFit1025->SetParError(0,0.1086052);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,0.02007797);
   ...
   Graph_10dO000000sPppm1025->SetMinimum(0.4801276);
   Graph_10dO000000sPppm1025->SetMaximum(0.6573976);
   ...
   quadLineFit1026->SetChisquare(2.340178e-22);
   ...
   quadLineFit1026->SetParameter(0,1.080874);
   quadLineFit1026->SetParError(0,0.1086052);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.02845061);
   ...
   quadLineFit1027->SetChisquare(2.340178e-22);
   ...
   quadLineFit1027->SetParameter(0,1.080874);
   quadLineFit1027->SetParError(0,0.1086052);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.02845061);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(1.434328);
   Graph_30dO000000sPppm1027->SetMaximum(1.931626);
   ...
   quadLineFit1028->SetChisquare(1.837254e-20);
   ...
   quadLineFit1028->SetParameter(0,3.395193);
   quadLineFit1028->SetParError(0,0.1086052);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.09512311);
   ...
   quadLineFit1029->SetChisquare(1.837254e-20);
   ...
   quadLineFit1029->SetParameter(0,3.395193);
   quadLineFit1029->SetParError(0,0.1086052);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.09512311);
