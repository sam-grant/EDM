...
//=========  (Tue Oct  6 23:07:49 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(2.738739e-18);
   ...
   quadLineFit1002->SetParameter(0,-4.648411);
   quadLineFit1002->SetParError(0,0.1909585);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.1379889);
   quadLineFit1002->SetParError(1,0.01054392);
   ...
   quadLineFit1003->SetChisquare(2.738739e-18);
   ...
   quadLineFit1003->SetParameter(0,-4.648411);
   quadLineFit1003->SetParError(0,0.1909585);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.1379889);
   quadLineFit1003->SetParError(1,0.01054392);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-1.142387);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.9131689);
   ...
   quadLineFit1004->SetChisquare(1.273303e-20);
   ...
   quadLineFit1004->SetParameter(0,-1.618943);
   quadLineFit1004->SetParError(0,0.1909585);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.0328425);
   quadLineFit1004->SetParError(1,0.01054392);
   ...
   quadLineFit1005->SetChisquare(1.273303e-20);
   ...
   quadLineFit1005->SetParameter(0,-1.618943);
   quadLineFit1005->SetParError(0,0.1909585);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.0328425);
   quadLineFit1005->SetParError(1,0.01054392);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(0.06948628);
   Graph_10dO000000sPppm1005->SetMaximum(0.1682836);
   ...
   quadLineFit1006->SetChisquare(2.049264e-25);
   ...
   quadLineFit1006->SetParameter(0,0.0167993);
   quadLineFit1006->SetParError(0,0.1909585);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,0.005671425);
   quadLineFit1006->SetParError(1,0.01054392);
   ...
   quadLineFit1007->SetChisquare(2.049264e-25);
   ...
   quadLineFit1007->SetParameter(0,0.0167993);
   quadLineFit1007->SetParError(0,0.1909585);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,0.005671425);
   quadLineFit1007->SetParError(1,0.01054392);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(1.063449);
   Graph_30dO000000sPppm1007->SetMaximum(1.436589);
   ...
   quadLineFit1008->SetChisquare(7.804784e-19);
   ...
   quadLineFit1008->SetParameter(0,2.380889);
   quadLineFit1008->SetParError(0,0.1909585);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.06282609);
   quadLineFit1008->SetParError(1,0.01054392);
   ...
   quadLineFit1009->SetChisquare(7.804784e-19);
   ...
   quadLineFit1009->SetParameter(0,2.380889);
   quadLineFit1009->SetParError(0,0.1909585);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.06282609);
   quadLineFit1009->SetParError(1,0.01054392);
