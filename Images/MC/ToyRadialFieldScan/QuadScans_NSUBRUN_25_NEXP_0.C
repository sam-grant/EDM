...
//=========  (Thu Oct  8 17:32:41 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(1.633179e-19);
   ...
   quadLineFit1002->SetParameter(0,-3.41224);
   quadLineFit1002->SetParError(0,0.1871291);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.09583167);
   ...
   quadLineFit1003->SetChisquare(1.633179e-19);
   ...
   quadLineFit1003->SetParameter(0,-3.41224);
   quadLineFit1003->SetParError(0,0.1871291);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.09583167);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.7068504);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.4897649);
   ...
   quadLineFit1004->SetChisquare(4.269657e-22);
   ...
   quadLineFit1004->SetParameter(0,-1.149357);
   quadLineFit1004->SetParError(0,0.1871291);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.03061383);
   ...
   quadLineFit1005->SetChisquare(4.269657e-22);
   ...
   quadLineFit1005->SetParameter(0,-1.149357);
   quadLineFit1005->SetParError(0,0.1871291);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.03061383);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(0.5278288);
   Graph_10dO000000sPppm1005->SetMaximum(0.6662258);
   ...
   quadLineFit1006->SetChisquare(6.16452e-23);
   ...
   quadLineFit1006->SetParameter(0,0.8529941);
   quadLineFit1006->SetParError(0,0.1871291);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.01422038);
   ...
   quadLineFit1007->SetChisquare(6.16452e-23);
   ...
   quadLineFit1007->SetParameter(0,0.8529941);
   quadLineFit1007->SetParError(0,0.1871291);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.01422038);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(1.543906);
   Graph_30dO000000sPppm1007->SetMaximum(1.943776);
   ...
   quadLineFit1008->SetChisquare(5.365539e-19);
   ...
   quadLineFit1008->SetParameter(0,2.98033);
   quadLineFit1008->SetParError(0,0.1871291);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.06869388);
   ...
   quadLineFit1009->SetChisquare(5.365539e-19);
   ...
   quadLineFit1009->SetParameter(0,2.98033);
   quadLineFit1009->SetParError(0,0.1871291);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.06869388);
