...
//=========  (Wed Jan  5 17:06:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.115989,0.0768254,3.902278);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1001->SetMinimum(-2.414162);
   Graph_30dO000000sPppm1001->SetMaximum(3.200451);
   ...
   quadLineFit1002->SetChisquare(1.580082e-19);
   ...
   quadLineFit1002->SetParameter(0,-0.0007381852);
   quadLineFit1002->SetParError(0,0.1700156);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.09978);
   quadLineFit1002->SetParError(1,2.657067);
   ...
   quadLineFit1003->SetChisquare(1.580082e-19);
   ...
   quadLineFit1003->SetParameter(0,-0.0007381852);
   quadLineFit1003->SetParError(0,0.1700156);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.09978);
   quadLineFit1003->SetParError(1,2.657067);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-2.009742);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.426668);
   ...
   quadLineFit1004->SetChisquare(3.7297e-20);
   ...
   quadLineFit1004->SetParameter(0,-0.01320801);
   quadLineFit1004->SetParError(0,0.1700156);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-26.85371);
   quadLineFit1004->SetParError(1,2.657068);
   ...
   quadLineFit1005->SetChisquare(3.7297e-20);
   ...
   quadLineFit1005->SetParameter(0,-0.01320801);
   quadLineFit1005->SetParError(0,0.1700156);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-26.85371);
   quadLineFit1005->SetParError(1,2.657068);
