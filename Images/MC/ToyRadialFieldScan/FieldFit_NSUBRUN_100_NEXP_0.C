...
//=========  (Tue Dec  8 12:25:41 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-44.53118,45,66.05757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","100 sub-runs",100,-36,36);
   Graph_Graph01029->SetMinimum(-33.4723);
   Graph_Graph01029->SetMaximum(54.99869);
   ...
   mainFit1030->SetChisquare(4.816157e-13);
   ...
   mainFit1030->SetParError(0,0.9355792);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.18466);
   ...
   pt_LaTex = pt->AddText(" 1.18#pm0.0312");
   pt_LaTex = pt->AddText(" 10.8#pm0.936");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.085469,-33.4723,-9.085469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.816157e-13);
   ...
   mainFit1031->SetParError(0,0.9355792);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.18466);
