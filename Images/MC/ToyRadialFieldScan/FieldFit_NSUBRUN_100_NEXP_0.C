...
//=========  (Wed Jan  5 17:06:53 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-46.36976,45,67.89615);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-34.94317);
   Graph_Graph01029->SetMaximum(56.46956);
   ...
   mainFit1030->SetChisquare(8.430515e-15);
   ...
   mainFit1030->SetParameter(0,10.76319);
   mainFit1030->SetParError(0,0.9355791);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.225518);
   mainFit1030->SetParError(1,0.03118597);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.78257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.78257,-34.94317,-8.78257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(8.430515e-15);
   ...
   mainFit1031->SetParameter(0,10.76319);
   mainFit1031->SetParError(0,0.9355791);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.225518);
   mainFit1031->SetParError(1,0.03118597);
