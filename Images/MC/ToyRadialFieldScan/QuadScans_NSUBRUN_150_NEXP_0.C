...
//=========  (Fri Oct  9 18:32:59 2020) by ROOT version 6.22/02
   ...
   quadLineFit1052->SetChisquare(5.953461e-20);
   ...
   quadLineFit1052->SetParameter(0,-2.902449);
   quadLineFit1052->SetParError(0,0.07714354);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.07835938);
   ...
   quadLineFit1053->SetChisquare(5.953461e-20);
   ...
   quadLineFit1053->SetParameter(0,-2.902449);
   quadLineFit1053->SetParError(0,0.07714354);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.07835938);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-0.161716);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.09897338);
   ...
   quadLineFit1054->SetChisquare(2.9152e-22);
   ...
   quadLineFit1054->SetParameter(0,-0.2571994);
   quadLineFit1054->SetParError(0,0.07714354);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,0.007047482);
   ...
   quadLineFit1055->SetChisquare(2.9152e-22);
   ...
   quadLineFit1055->SetParameter(0,-0.2571994);
   quadLineFit1055->SetParError(0,0.07714354);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,0.007047482);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(1.030453);
   Graph_10dO000000sPppm1055->SetMaximum(1.415109);
   ...
   quadLineFit1056->SetChisquare(5.158036e-20);
   ...
   quadLineFit1056->SetParameter(0,2.55681);
   quadLineFit1056->SetParError(0,0.07714354);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.07411272);
   ...
   quadLineFit1057->SetChisquare(5.158036e-20);
   ...
   quadLineFit1057->SetParameter(0,2.55681);
   quadLineFit1057->SetParError(0,0.07714354);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.07411272);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(2.207748);
   Graph_30dO000000sPppm1057->SetMaximum(2.934625);
   ...
   quadLineFit1058->SetChisquare(3.965644e-20);
   ...
   quadLineFit1058->SetParameter(0,5.188543);
   quadLineFit1058->SetParError(0,0.07714354);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,-0.1454087);
   ...
   quadLineFit1059->SetChisquare(3.965644e-20);
   ...
   quadLineFit1059->SetParameter(0,5.188543);
   quadLineFit1059->SetParError(0,0.07714354);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,-0.1454087);
