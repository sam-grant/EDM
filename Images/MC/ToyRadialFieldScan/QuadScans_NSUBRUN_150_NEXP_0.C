...
//=========  (Tue Oct  6 23:07:53 2020) by ROOT version 6.22/02
   ...
   quadLineFit1052->SetChisquare(4.619426e-19);
   ...
   quadLineFit1052->SetParameter(0,-4.477609);
   quadLineFit1052->SetParError(0,0.07739968);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.1296856);
   ...
   quadLineFit1053->SetChisquare(4.619426e-19);
   ...
   quadLineFit1053->SetParameter(0,-4.477609);
   quadLineFit1053->SetParError(0,0.07739968);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.1296856);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-1.172746);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.8774408);
   ...
   quadLineFit1054->SetChisquare(7.324557e-21);
   ...
   quadLineFit1054->SetParameter(0,-2.023696);
   quadLineFit1054->SetParError(0,0.07739969);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,0.05547792);
   ...
   quadLineFit1055->SetChisquare(7.324557e-21);
   ...
   quadLineFit1055->SetParameter(0,-2.023696);
   quadLineFit1055->SetParError(0,0.07739969);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,0.05547792);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(0.06095986);
   Graph_10dO000000sPppm1055->SetMaximum(0.1436771);
   ...
   quadLineFit1056->SetChisquare(8.456936e-21);
   ...
   quadLineFit1056->SetParameter(0,0.3037179);
   quadLineFit1056->SetParError(0,0.07739969);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.01118886);
   ...
   quadLineFit1057->SetChisquare(8.456936e-21);
   ...
   quadLineFit1057->SetParameter(0,0.3037179);
   quadLineFit1057->SetParError(0,0.07739969);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.01118886);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(1.066);
   Graph_30dO000000sPppm1057->SetMaximum(1.412207);
   ...
   quadLineFit1058->SetChisquare(4.117948e-18);
   ...
   quadLineFit1058->SetParameter(0,2.428591);
   quadLineFit1058->SetParError(0,0.07739968);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,-0.06608262);
   ...
   quadLineFit1059->SetChisquare(4.117948e-18);
   ...
   quadLineFit1059->SetParameter(0,2.428591);
   quadLineFit1059->SetParError(0,0.07739968);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,-0.06608262);
