...
//=========  (Mon Oct 12 20:04:21 2020) by ROOT version 6.22/02
   ...
   quadLineFit1052->SetChisquare(6.903972e-20);
   ...
   quadLineFit1052->SetParameter(0,-2.971812);
   quadLineFit1052->SetParError(0,0.07714354);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.08246761);
   ...
   quadLineFit1053->SetChisquare(6.903972e-20);
   ...
   quadLineFit1053->SetParameter(0,-2.971812);
   quadLineFit1053->SetParError(0,0.07714354);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.08246761);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-0.1598227);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.1156058);
   ...
   quadLineFit1054->SetChisquare(1.780151e-23);
   ...
   quadLineFit1054->SetParameter(0,-0.1950975);
   quadLineFit1054->SetParError(0,0.07714353);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,0.003187956);
   ...
   quadLineFit1055->SetChisquare(1.780151e-23);
   ...
   quadLineFit1055->SetParameter(0,-0.1950975);
   quadLineFit1055->SetParError(0,0.07714353);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,0.003187956);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(1.008351);
   Graph_10dO000000sPppm1055->SetMaximum(1.418087);
   ...
   quadLineFit1056->SetChisquare(9.511049e-20);
   ...
   quadLineFit1056->SetParameter(0,2.641297);
   quadLineFit1056->SetParError(0,0.07714353);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.07933766);
   ...
   quadLineFit1057->SetChisquare(9.511049e-20);
   ...
   quadLineFit1057->SetParameter(0,2.641297);
   quadLineFit1057->SetParError(0,0.07714353);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.07933766);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(2.220679);
   Graph_30dO000000sPppm1057->SetMaximum(2.927849);
   ...
   quadLineFit1058->SetChisquare(2.395926e-19);
   ...
   quadLineFit1058->SetParameter(0,5.11772);
   quadLineFit1058->SetParError(0,0.07714353);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,-0.1413031);
   ...
   quadLineFit1059->SetChisquare(2.395926e-19);
   ...
   quadLineFit1059->SetParameter(0,5.11772);
   quadLineFit1059->SetParError(0,0.07714353);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,-0.1413031);
