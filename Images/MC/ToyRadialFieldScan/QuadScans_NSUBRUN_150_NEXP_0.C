...
//=========  (Wed Jan  5 17:06:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.074341,0.0768254,3.84379);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1041->SetMinimum(-2.382527);
   Graph_30dO000000sPppm1041->SetMaximum(3.151977);
   ...
   quadLineFit1042->SetChisquare(5.028765e-19);
   ...
   quadLineFit1042->SetParError(0,0.0689109);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,47.49404);
   ...
   quadLineFit1043->SetChisquare(5.028765e-19);
   ...
   quadLineFit1043->SetParError(0,0.0689109);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,47.49404);
   ...
   Graph_mI30dO000000sPppm1043->SetMinimum(-1.963611);
   Graph_mI30dO000000sPppm1043->SetMaximum(-1.417594);
   ...
   quadLineFit1044->SetChisquare(8.599273e-18);
   ...
   quadLineFit1044->SetParameter(1,-27.14287);
   ...
   quadLineFit1045->SetChisquare(8.599273e-18);
   ...
   quadLineFit1045->SetParameter(1,-27.14287);
