...
//=========  (Tue Nov 10 15:16:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.03933373,1.491396e+07,0.06504406);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01211->SetMinimum(-0.02889595);
   Graph_Graph01211->SetMaximum(0.05460628);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.05460628,1.325685e+07,0.05460628,0,344.5,510,"-");
