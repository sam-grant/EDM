...
//=========  (Thu Oct  8 17:32:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1565331,45,0.1605142);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01019->SetMinimum(-0.1248284);
   Graph_Graph01019->SetMaximum(0.1288095);
   ...
   fieldLineFit1020->SetChisquare(0.1761881);
   ...
   fieldLineFit1020->SetParameter(0,0.002597201);
   fieldLineFit1020->SetParError(0,0.003666401);
   fieldLineFit1020->SetParLimits(0,0,0);
   fieldLineFit1020->SetParameter(1,-0.003299405);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0881}");
   pt_LaTex = pt->AddText("#minus0.0033#pm0.000164");
   pt_LaTex = pt->AddText("0.0026#pm0.00367");
   pt_LaTex = pt->AddText("0.787#pm 1.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,0.7871723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7871723,-0.1248284,0.7871723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1021->SetChisquare(0.1761881);
   ...
   fieldLineFit1021->SetParameter(0,0.002597201);
   fieldLineFit1021->SetParError(0,0.003666401);
   fieldLineFit1021->SetParLimits(0,0,0);
   fieldLineFit1021->SetParameter(1,-0.003299405);
