...
//=========  (Tue Oct  6 23:07:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1399384,45,0.1898582);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01019->SetMinimum(-0.1069587);
   Graph_Graph01019->SetMaximum(0.1568785);
   ...
   fieldLineFit1020->SetChisquare(0.210919);
   ...
   fieldLineFit1020->SetParameter(0,0.02666047);
   fieldLineFit1020->SetParError(0,0.003702924);
   fieldLineFit1020->SetParLimits(0,0,0);
   fieldLineFit1020->SetParameter(1,-0.003417352);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.105");
   pt_LaTex = pt->AddText("#minus0.00342#pm0.000166");
   pt_LaTex = pt->AddText("0.0267#pm0.0037");
   pt_LaTex = pt->AddText("  7.8#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.8015,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.8015,-0.1069587,7.8015,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1021->SetChisquare(0.210919);
   ...
   fieldLineFit1021->SetParameter(0,0.02666047);
   fieldLineFit1021->SetParError(0,0.003702924);
   fieldLineFit1021->SetParLimits(0,0,0);
   fieldLineFit1021->SetParameter(1,-0.003417352);
