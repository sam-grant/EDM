...
//=========  (Thu Oct  8 15:41:36 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","Sub-runs 0",100,-36,36);
   Graph_Graph01039->SetMinimum(-0.5117641);
   Graph_Graph01039->SetMaximum(0.5617641);
   ...
   fieldLineFit1040->SetChisquare(9.556277e-25);
   ...
   fieldLineFit1040->SetParameter(0,0.025);
   fieldLineFit1040->SetParError(0,0.1767767);
   fieldLineFit1040->SetParLimits(0,0,0);
   fieldLineFit1040->SetParameter(1,-0.003125);
   fieldLineFit1040->SetParError(1,0.007905694);
   ...
   fieldLineFit1041->SetChisquare(9.556277e-25);
   ...
   fieldLineFit1041->SetParameter(0,0.025);
   fieldLineFit1041->SetParError(0,0.1767767);
   fieldLineFit1041->SetParLimits(0,0,0);
   fieldLineFit1041->SetParameter(1,-0.003125);
   fieldLineFit1041->SetParError(1,0.007905694);
