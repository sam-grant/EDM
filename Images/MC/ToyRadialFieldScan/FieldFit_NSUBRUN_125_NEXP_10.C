void FieldFit_NSUBRUN_125_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-86.62551,75,102.4704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-67.71592);
   Graph_Graph01077->SetMaximum(83.56085);
   ...
   mainFit1078->SetChisquare(4.110719);
   ...
   mainFit1078->SetParameter(0,9.983967);
   mainFit1078->SetParError(0,0.3921082);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,1.210609);
   mainFit1078->SetParError(1,0.01237017);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.247061,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.247061,-67.71592,-8.247061,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(4.110719);
   ...
   mainFit1079->SetParameter(0,9.983967);
   mainFit1079->SetParError(0,0.3921082);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,1.210609);
   mainFit1079->SetParError(1,0.01237017);
