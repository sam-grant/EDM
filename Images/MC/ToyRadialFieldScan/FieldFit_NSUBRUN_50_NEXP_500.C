...
//=========  (Tue May 31 19:16:23 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01029->SetMinimum(-64.46099);
   Graph_Graph01029->SetMaximum(84.62418);
   ...
   mainFit1030->SetChisquare(4.163488);
   ...
   mainFit1030->SetParameter(0,10.98708);
   mainFit1030->SetParError(0,0.6196172);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.201134);
   mainFit1030->SetParError(1,0.01954766);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.147256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.147256,-64.46099,-9.147256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.163488);
   ...
   mainFit1031->SetParameter(0,10.98708);
   mainFit1031->SetParError(0,0.6196172);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.201134);
   mainFit1031->SetParError(1,0.01954766);
