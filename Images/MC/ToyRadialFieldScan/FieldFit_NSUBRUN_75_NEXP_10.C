...
//=========  (Thu May  5 13:00:15 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01045->SetMinimum(-70.74767);
   Graph_Graph01045->SetMaximum(82.31062);
   ...
   mainFit1046->SetChisquare(14.96409);
   ...
   mainFit1046->SetParameter(0,9.554573);
   mainFit1046->SetParError(0,0.505078);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,1.219868);
   mainFit1046->SetParError(1,0.01593419);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.74");
   pt_LaTex = pt->AddText("1.22
#pm0.02
");
   pt_LaTex = pt->AddText("9.55
#pm0.5
");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.832468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.832468,-70.74767,-7.832468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(14.96409);
   ...
   mainFit1047->SetParameter(0,9.554573);
   mainFit1047->SetParError(0,0.505078);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,1.219868);
   mainFit1047->SetParError(1,0.01593419);
