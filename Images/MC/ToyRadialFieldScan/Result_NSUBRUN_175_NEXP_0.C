...
//=========  (Tue Oct  6 23:07:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1202189,45,0.1655325);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.09164371);
   Graph_Graph01069->SetMaximum(0.1369574);
   ...
   fieldLineFit1070->SetChisquare(3.095398);
   ...
   fieldLineFit1070->SetParameter(0,0.02434246);
   fieldLineFit1070->SetParError(0,0.001977018);
   fieldLineFit1070->SetParLimits(0,0,0);
   fieldLineFit1070->SetParameter(1,-0.003088571);
   ...
   pt_LaTex = pt->AddText("#minus0.00309#pm8.84e-05");
   pt_LaTex = pt->AddText("0.0243#pm0.00198");
   pt_LaTex = pt->AddText(" 7.88#pm0.679");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.881465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.881465,-0.09164371,7.881465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1071->SetChisquare(3.095398);
   ...
   fieldLineFit1071->SetParameter(0,0.02434246);
   fieldLineFit1071->SetParError(0,0.001977018);
   fieldLineFit1071->SetParLimits(0,0,0);
   fieldLineFit1071->SetParameter(1,-0.003088571);
