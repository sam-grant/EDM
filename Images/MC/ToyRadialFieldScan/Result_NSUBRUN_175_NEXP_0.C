...
//=========  (Thu Oct  8 17:32:47 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1424635,45,0.1396709);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.11425);
   Graph_Graph01069->SetMaximum(0.1114575);
   ...
   fieldLineFit1070->SetChisquare(1.599642);
   ...
   fieldLineFit1070->SetParameter(0,-0.002165092);
   fieldLineFit1070->SetParError(0,0.001971376);
   fieldLineFit1070->SetParLimits(0,0,0);
   fieldLineFit1070->SetParameter(1,-0.003038759);
   fieldLineFit1070->SetParError(1,8.816263e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00304#pm8.82e-05");
   pt_LaTex = pt->AddText("-0.00217#pm0.00197");
   pt_LaTex = pt->AddText("-0.712#pm-0.649");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-0.7124922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7124922,-0.11425,-0.7124922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1071->SetChisquare(1.599642);
   ...
   fieldLineFit1071->SetParameter(0,-0.002165092);
   fieldLineFit1071->SetParError(0,0.001971376);
   fieldLineFit1071->SetParLimits(0,0,0);
   fieldLineFit1071->SetParameter(1,-0.003038759);
   fieldLineFit1071->SetParError(1,8.816263e-05);
