...
//=========  (Thu Oct  8 17:32:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.150097,45,0.1437662);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.1207107);
   Graph_Graph01029->SetMaximum(0.1143799);
   ...
   fieldLineFit1030->SetChisquare(2.071721);
   ...
   fieldLineFit1030->SetParameter(0,-0.00367586);
   fieldLineFit1030->SetParError(0,0.00299836);
   fieldLineFit1030->SetParLimits(0,0,0);
   fieldLineFit1030->SetParameter(1,-0.003001374);
   ...
   pt_LaTex = pt->AddText("#minus0.003#pm0.000134");
   pt_LaTex = pt->AddText("-0.00368#pm0.003");
   pt_LaTex = pt->AddText("-1.22#pm-0.999");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-1.224726,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.224726,-0.1207107,-1.224726,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1031->SetChisquare(2.071721);
   ...
   fieldLineFit1031->SetParameter(0,-0.00367586);
   fieldLineFit1031->SetParError(0,0.00299836);
   fieldLineFit1031->SetParLimits(0,0,0);
   fieldLineFit1031->SetParameter(1,-0.003001374);
