...
//=========  (Tue Oct  6 23:07:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1405591,45,0.1830369);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.1081995);
   Graph_Graph01029->SetMaximum(0.1506773);
   ...
   fieldLineFit1030->SetChisquare(2.359483);
   ...
   fieldLineFit1030->SetParameter(0,0.02419036);
   fieldLineFit1030->SetParError(0,0.003018497);
   fieldLineFit1030->SetParLimits(0,0,0);
   fieldLineFit1030->SetParameter(1,-0.003340973);
   ...
   pt_LaTex = pt->AddText("#minus0.00334#pm0.000135");
   pt_LaTex = pt->AddText("0.0242#pm0.00302");
   pt_LaTex = pt->AddText(" 7.24#pm 0.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.240516,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.240516,-0.1081995,7.240516,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1031->SetChisquare(2.359483);
   ...
   fieldLineFit1031->SetParameter(0,0.02419036);
   fieldLineFit1031->SetParError(0,0.003018497);
   fieldLineFit1031->SetParLimits(0,0,0);
   fieldLineFit1031->SetParameter(1,-0.003340973);
