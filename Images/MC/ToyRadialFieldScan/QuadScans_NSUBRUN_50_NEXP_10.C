void QuadScans_NSUBRUN_50_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.277039,0.0663141,7.524071);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1017->SetMinimum(-3.996928);
   Graph_mI50dO000000sPppm1017->SetMaximum(6.24396);
   ...
   TF1 *quadLineFit1018 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1018->SetFillColor(19);
   quadLineFit1018->SetFillStyle(0);
   quadLineFit1018->SetLineWidth(2);
   quadLineFit1018->SetChisquare(0.0006464594);
   ...
   quadLineFit1018->SetParameter(0,0.07674151);
   quadLineFit1018->SetParError(0,0.1481628);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-52.38592);
   quadLineFit1018->SetParError(1,2.616107);
   quadLineFit1018->SetParLimits(1,0,0);
   quadLineFit1018->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1018);
   gre->Draw("ap");
   
   TF1 *quadLineFit1019 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1019->SetFillColor(19);
   quadLineFit1019->SetFillStyle(0);
   quadLineFit1019->SetLineWidth(2);
   quadLineFit1019->SetChisquare(0.0006464594);
   ...
   quadLineFit1019->SetParameter(0,0.07674151);
   quadLineFit1019->SetParError(0,0.1481628);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-52.38592);
   quadLineFit1019->SetParError(1,2.616107);
   ...
   Graph_mI30dO000000sPppm1019->SetMinimum(-1.952849);
   Graph_mI30dO000000sPppm1019->SetMaximum(-1.272977);
   ...
   TF1 *quadLineFit1020 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1020->SetChisquare(1.582788);
   ...
   quadLineFit1020->SetParameter(0,0.008864905);
   quadLineFit1020->SetParError(0,0.08335469);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-26.50893);
   quadLineFit1020->SetParError(1,1.373849);
   quadLineFit1020->SetParLimits(1,0,0);
   quadLineFit1020->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1020);
   gre->Draw("p ");
   
   TF1 *quadLineFit1021 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1021->SetChisquare(1.582788);
   ...
   quadLineFit1021->SetParameter(0,0.008864905);
   quadLineFit1021->SetParError(0,0.08335469);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-26.50893);
   quadLineFit1021->SetParError(1,1.373849);
   ...
   Graph_mI10dO000000sPppm1021->SetMinimum(-0.238245);
   Graph_mI10dO000000sPppm1021->SetMaximum(-0.09526686);
   ...
   TF1 *quadLineFit1022 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1022->SetChisquare(2.48194);
   ...
   quadLineFit1022->SetParameter(0,0.03991522);
   quadLineFit1022->SetParError(0,0.083355);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,-3.240092);
   quadLineFit1022->SetParError(1,1.373854);
   quadLineFit1022->SetParLimits(1,0,0);
   quadLineFit1022->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1022);
   gre->Draw("p ");
   
   TF1 *quadLineFit1023 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1023->SetChisquare(2.48194);
   ...
   quadLineFit1023->SetParameter(0,0.03991522);
   quadLineFit1023->SetParError(0,0.083355);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,-3.240092);
   quadLineFit1023->SetParError(1,1.373854);
   ...
   Graph_10dO000000sPppm1023->SetMinimum(1.050222);
   Graph_10dO000000sPppm1023->SetMaximum(1.610726);
   ...
   TF1 *quadLineFit1024 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1024->SetChisquare(0.07999855);
   ...
   quadLineFit1024->SetParameter(0,0.03482562);
   quadLineFit1024->SetParError(0,0.09138359);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,21.0778);
   quadLineFit1024->SetParError(1,1.467193);
   quadLineFit1024->SetParLimits(1,0,0);
   quadLineFit1024->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1024);
   gre->Draw("p ");
   
   TF1 *quadLineFit1025 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1025->SetChisquare(0.07999855);
   ...
   quadLineFit1025->SetParameter(0,0.03482562);
   quadLineFit1025->SetParError(0,0.09138359);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,21.0778);
   quadLineFit1025->SetParError(1,1.467193);
   ...
   Graph_30dO000000sPppm1025->SetMinimum(2.222402);
   Graph_30dO000000sPppm1025->SetMaximum(3.397655);
   ...
   TF1 *quadLineFit1026 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1026->SetChisquare(0.0308317);
   ...
   quadLineFit1026->SetParameter(0,-0.04534454);
   quadLineFit1026->SetParError(0,0.08334913);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,46.51429);
   quadLineFit1026->SetParError(1,1.373757);
   quadLineFit1026->SetParLimits(1,0,0);
   quadLineFit1026->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1026);
   gre->Draw("p ");
   
   TF1 *quadLineFit1027 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1027->SetChisquare(0.0308317);
   ...
   quadLineFit1027->SetParameter(0,-0.04534454);
   quadLineFit1027->SetParError(0,0.08334913);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,46.51429);
   quadLineFit1027->SetParError(1,1.373757);
   ...
   Graph_50dO000000sPppm1027->SetMinimum(3.443931);
   Graph_50dO000000sPppm1027->SetMaximum(5.159041);
   ...
   TF1 *quadLineFit1028 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1028->SetChisquare(2.094614);
   ...
   quadLineFit1028->SetParameter(0,0.1144053);
   quadLineFit1028->SetParError(0,0.08346281);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,68.21318);
   quadLineFit1028->SetParError(1,1.375617);
   quadLineFit1028->SetParLimits(1,0,0);
   quadLineFit1028->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1028);
   gre->Draw("p ");
   
   TF1 *quadLineFit1029 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1029->SetChisquare(2.094614);
   ...
   quadLineFit1029->SetParameter(0,0.1144053);
   quadLineFit1029->SetParError(0,0.08346281);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,68.21318);
   quadLineFit1029->SetParError(1,1.375617);
