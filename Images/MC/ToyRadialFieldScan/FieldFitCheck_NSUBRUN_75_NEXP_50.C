void FieldFitCheck_NSUBRUN_75_NEXP_50()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:01:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.9279,75,396.8691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-56.54823);
   Graph_Graph01047->SetMaximum(346.4894);
   ...
   checkFit1048->SetChisquare(60158.22);
   ...
   checkFit1048->SetParameter(0,67.70928);
   checkFit1048->SetParError(0,0.4060555);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,-1.517142);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("1.5e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.62949,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.62949,-56.54823,44.62949,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(60158.22);
   ...
   checkFit1049->SetParameter(0,67.70928);
   checkFit1049->SetParError(0,0.4060555);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,-1.517142);
