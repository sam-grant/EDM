void FieldFit_NSUBRUN_726_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:43 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01085 = new TH1F("Graph_Graph01085","",100,-36,36);
   Graph_Graph01085->SetMinimum(-140.657);
   Graph_Graph01085->SetMaximum(159.9385);
   ...
   Graph_Graph01085->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01085->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *mainFit1086 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1086->SetChisquare(7.82679e-22);
   ...
   mainFit1086->SetParameter(0,9.640711);
   mainFit1086->SetParError(0,63);
   mainFit1086->SetParLimits(0,0,0);
   mainFit1086->SetParameter(1,1.205089);
   mainFit1086->SetParError(1,2.1);
...
");
   ...
   TF1 *mainFit1087 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1087->SetChisquare(7.82679e-22);
   ...
   mainFit1087->SetParameter(0,9.640711);
   mainFit1087->SetParError(0,63);
   mainFit1087->SetParLimits(0,0,0);
   mainFit1087->SetParameter(1,1.205089);
   mainFit1087->SetParError(1,2.1);
