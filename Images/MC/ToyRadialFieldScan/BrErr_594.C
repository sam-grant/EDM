...
//=========  (Wed Jan  5 17:35:42 2022) by ROOT version 6.24/06
   ...
   TH1D *__26 = new TH1D("__26","Number of sub-runs: 594",2400,0.4,1.6);
   __26->SetBinContent(2401,1000);
   __26->SetEntries(1000);
   __26->SetStats(0);
   __26->GetXaxis()->SetTitle("Fitted #delta#LTB_{r}^{b}#GT [ppm]");
   __26->GetXaxis()->SetRange(1,2400);
   ...
   __26->GetYaxis()->SetTitle("Trials / 0.000500 ppm");
