...
//=========  (Tue Oct 20 14:20:09 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3128423,75,0.2547218);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01189->SetMinimum(-0.2560859);
   Graph_Graph01189->SetMaximum(0.1979654);
   ...
   mainFit1190->SetChisquare(0.4866535);
   ...
   mainFit1190->SetParameter(0,-0.02842466);
   mainFit1190->SetParError(0,0.001228114);
   mainFit1190->SetParLimits(0,0,0);
   mainFit1190->SetParameter(1,-0.003726403);
   mainFit1190->SetParError(1,3.595534e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00373#pm3.6e-05");
   pt_LaTex = pt->AddText("#minus0.0284#pm0.00123");
   pt_LaTex = pt->AddText("#minus7.63#pm0.338");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.627908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.627908,-0.2560859,-7.627908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1191->SetChisquare(0.4866535);
   ...
   mainFit1191->SetParameter(0,-0.02842466);
   mainFit1191->SetParError(0,0.001228114);
   mainFit1191->SetParLimits(0,0,0);
   mainFit1191->SetParameter(1,-0.003726403);
   mainFit1191->SetParError(1,3.595534e-05);
