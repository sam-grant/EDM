...
//=========  (Tue Oct 20 14:20:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.71356,75,83.75755);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01175->SetMinimum(-53.46645);
   Graph_Graph01175->SetMaximum(68.51044);
   ...
   checkFit1176->SetParameter(0,7.47092);
   checkFit1176->SetParError(0,0.3406606);
   checkFit1176->SetParLimits(0,0,0);
   checkFit1176->SetParameter(1,0.9949229);
   checkFit1176->SetParError(1,0.009973522);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.00997");
   pt_LaTex = pt->AddText(" 7.47#pm0.341");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.509045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.509045,-53.46645,-7.509045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1177->SetParameter(0,7.47092);
   checkFit1177->SetParError(0,0.3406606);
   checkFit1177->SetParLimits(0,0,0);
   checkFit1177->SetParameter(1,0.9949229);
   checkFit1177->SetParError(1,0.009973522);
