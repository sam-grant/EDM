...
//=========  (Tue Oct 20 14:19:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3157794,75,0.2609207);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","Sub-runs 50",100,-60,60);
   Graph_Graph01029->SetMinimum(-0.2581094);
   Graph_Graph01029->SetMaximum(0.2032507);
   ...
   mainFit1030->SetChisquare(7.078842);
   ...
   mainFit1030->SetParameter(0,-0.02543242);
   mainFit1030->SetParError(0,0.002993657);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,-0.003742653);
   mainFit1030->SetParError(1,8.764599e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00374#pm8.76e-05");
   pt_LaTex = pt->AddText("#minus0.0254#pm0.00299");
   pt_LaTex = pt->AddText(" #minus6.8#pm0.816");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.79529,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.79529,-0.2581094,-6.79529,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.078842);
   ...
   mainFit1031->SetParameter(0,-0.02543242);
   mainFit1031->SetParError(0,0.002993657);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,-0.003742653);
   mainFit1031->SetParError(1,8.764599e-05);
