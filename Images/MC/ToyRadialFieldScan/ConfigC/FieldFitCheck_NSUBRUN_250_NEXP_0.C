...
//=========  (Tue Oct 20 14:20:06 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.62316,75,83.46342);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01159->SetMinimum(-53.4145);
   Graph_Graph01159->SetMaximum(68.25476);
   ...
   checkFit1160->SetParameter(0,7.56798);
   checkFit1160->SetParError(0,0.3573186);
   checkFit1160->SetParLimits(0,0,0);
   checkFit1160->SetParameter(1,0.9897732);
   checkFit1160->SetParError(1,0.01046122);
   ...
   pt_LaTex = pt->AddText(" 0.99#pm0.0105");
   pt_LaTex = pt->AddText(" 7.57#pm0.357");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.646176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.646176,-53.4145,-7.646176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1161->SetParameter(0,7.56798);
   checkFit1161->SetParError(0,0.3573186);
   checkFit1161->SetParLimits(0,0,0);
   checkFit1161->SetParameter(1,0.9897732);
   checkFit1161->SetParError(1,0.01046122);
