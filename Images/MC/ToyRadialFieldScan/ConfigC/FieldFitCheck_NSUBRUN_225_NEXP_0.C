...
//=========  (Tue Oct 20 14:20:05 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.64753,75,84.72227);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-54.21055);
   Graph_Graph01143->SetMaximum(69.28529);
   ...
   checkFit1144->SetParameter(0,8.474513);
   checkFit1144->SetParError(0,0.3767182);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,1.012638);
   checkFit1144->SetParError(1,0.01102918);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.011");
   pt_LaTex = pt->AddText(" 8.47#pm0.377");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.36875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.36875,-54.21055,-8.36875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetParameter(0,8.474513);
   checkFit1145->SetParError(0,0.3767182);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,1.012638);
   checkFit1145->SetParError(1,0.01102918);
