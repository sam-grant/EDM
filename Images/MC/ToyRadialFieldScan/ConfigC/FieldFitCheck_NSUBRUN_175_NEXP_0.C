...
//=========  (Tue Oct 20 14:20:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.80912,75,85.7506);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01111 = new TH1F("Graph_Graph01111","Sub-runs 175",100,-60,60);
   Graph_Graph01111->SetMinimum(-50.65315);
   Graph_Graph01111->SetMaximum(70.59463);
   ...
   checkFit1112->SetChisquare(9.754467);
   ...
   checkFit1112->SetParameter(0,8.372039);
   checkFit1112->SetParError(0,0.4274199);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,0.9872238);
   checkFit1112->SetParError(1,0.01251357);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.44");
   pt_LaTex = pt->AddText("0.987#pm0.0125");
   pt_LaTex = pt->AddText(" 8.37#pm0.427");
   pt_LaTex = pt->AddText("#minus8.48#pm0.446");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.480386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.480386,-50.65315,-8.480386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetChisquare(9.754467);
   ...
   checkFit1113->SetParameter(0,8.372039);
   checkFit1113->SetParError(0,0.4274199);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,0.9872238);
   checkFit1113->SetParError(1,0.01251357);
