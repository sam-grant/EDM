...
//=========  (Tue Oct 20 14:19:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.94439,75,84.62585);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-51.78737);
   Graph_Graph01047->SetMaximum(69.46882);
   ...
   checkFit1048->SetParameter(0,7.745562);
   checkFit1048->SetParError(0,0.6500833);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,1.003437);
   checkFit1048->SetParError(1,0.01903249);
   ...
   pt_LaTex = pt->AddText("    1#pm0.019");
   pt_LaTex = pt->AddText(" 7.75#pm 0.65");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.719035,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.719035,-51.78737,-7.719035,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetParameter(0,7.745562);
   checkFit1049->SetParError(0,0.6500833);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,1.003437);
   checkFit1049->SetParError(1,0.01903249);
