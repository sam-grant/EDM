...
//=========  (Tue Oct 20 14:20:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3154228,75,0.2587686);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01173->SetMinimum(-0.2580036);
   Graph_Graph01173->SetMaximum(0.2013494);
   ...
   mainFit1174->SetChisquare(1.104672);
   ...
   mainFit1174->SetParameter(0,-0.0281348);
   mainFit1174->SetParError(0,0.001282891);
   mainFit1174->SetParLimits(0,0,0);
   mainFit1174->SetParameter(1,-0.003746783);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm3.76e-05");
   pt_LaTex = pt->AddText("#minus0.0281#pm0.00128");
   pt_LaTex = pt->AddText("#minus7.51#pm0.351");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.509055,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.509055,-0.2580036,-7.509055,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1175->SetChisquare(1.104672);
   ...
   mainFit1175->SetParameter(0,-0.0281348);
   mainFit1175->SetParError(0,0.001282891);
   mainFit1175->SetParLimits(0,0,0);
   mainFit1175->SetParameter(1,-0.003746783);
