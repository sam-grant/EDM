...
//=========  (Tue Oct 20 14:20:00 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01079->SetMinimum(-54.14391);
   Graph_Graph01079->SetMaximum(71.04082);
   ...
   checkFit1080->SetChisquare(1.324971);
   ...
   checkFit1080->SetParameter(0,8.069489);
   checkFit1080->SetParError(0,0.5060564);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,1.018927);
   checkFit1080->SetParError(1,0.01481582);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0148");
   pt_LaTex = pt->AddText(" 8.07#pm0.506");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.919596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.919596,-54.14391,-7.919596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(1.324971);
   ...
   checkFit1081->SetParameter(0,8.069489);
   checkFit1081->SetParError(0,0.5060564);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,1.018927);
   checkFit1081->SetParError(1,0.01481582);
