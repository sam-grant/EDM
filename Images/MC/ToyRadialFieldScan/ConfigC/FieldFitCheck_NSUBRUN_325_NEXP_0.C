...
//=========  (Tue Oct 20 14:20:10 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.76972,75,83.29742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01207->SetMinimum(-52.66301);
   Graph_Graph01207->SetMaximum(68.19071);
   ...
   checkFit1208->SetParameter(0,7.944958);
   checkFit1208->SetParError(0,0.3133236);
   checkFit1208->SetParLimits(0,0,0);
   checkFit1208->SetParameter(1,1.001044);
   checkFit1208->SetParError(1,0.009173173);
   ...
   pt_LaTex = pt->AddText("    1#pm0.00917");
   pt_LaTex = pt->AddText(" 7.94#pm0.313");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.936671,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.936671,-52.66301,-7.936671,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1209->SetParameter(0,7.944958);
   checkFit1209->SetParError(0,0.3133236);
   checkFit1209->SetParLimits(0,0,0);
   checkFit1209->SetParameter(1,1.001044);
   checkFit1209->SetParError(1,0.009173173);
