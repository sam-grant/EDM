...
//=========  (Tue Oct 20 14:20:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3229284,75,0.2478308);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-0.2658525);
   Graph_Graph01109->SetMaximum(0.1907548);
   ...
   mainFit1110->SetChisquare(9.754462);
   ...
   mainFit1110->SetParameter(0,-0.03152833);
   mainFit1110->SetParError(0,0.001609637);
   mainFit1110->SetParLimits(0,0,0);
   mainFit1110->SetParameter(1,-0.00371779);
   mainFit1110->SetParError(1,4.712512e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00372#pm4.71e-05");
   pt_LaTex = pt->AddText("#minus0.0315#pm0.00161");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.480394,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.480394,-0.2658525,-8.480394,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1111->SetChisquare(9.754462);
   ...
   mainFit1111->SetParameter(0,-0.03152833);
   mainFit1111->SetParError(0,0.001609637);
   mainFit1111->SetParLimits(0,0,0);
   mainFit1111->SetParameter(1,-0.00371779);
   mainFit1111->SetParError(1,4.712512e-05);
