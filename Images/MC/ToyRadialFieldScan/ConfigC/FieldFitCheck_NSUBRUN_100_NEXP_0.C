...
//=========  (Tue Oct 20 14:19:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.44802,75,86.5046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-54.75276);
   Graph_Graph01063->SetMaximum(70.80934);
   ...
   checkFit1064->SetParameter(0,8.533998);
   checkFit1064->SetParError(0,0.5662382);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,1.00495);
   checkFit1064->SetParError(1,0.01657776);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0166");
   pt_LaTex = pt->AddText(" 8.53#pm0.566");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.491959,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.491959,-54.75276,-8.491959,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetParameter(0,8.533998);
   checkFit1065->SetParError(0,0.5662382);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,1.00495);
   checkFit1065->SetParError(1,0.01657776);
