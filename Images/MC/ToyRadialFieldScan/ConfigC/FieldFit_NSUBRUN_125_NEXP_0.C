...
//=========  (Tue Oct 20 14:20:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.326462,75,0.2628299);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-0.2675328);
   Graph_Graph01077->SetMaximum(0.2039007);
   ...
   mainFit1078->SetChisquare(1.324985);
   ...
   mainFit1078->SetParameter(0,-0.03038885);
   mainFit1078->SetParError(0,0.001905738);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,-0.003837179);
   mainFit1078->SetParError(1,5.57945e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00384#pm5.58e-05");
   pt_LaTex = pt->AddText("#minus0.0304#pm0.00191");
   pt_LaTex = pt->AddText("#minus7.92#pm 0.51");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.919582,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.919582,-0.2675328,-7.919582,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(1.324985);
   ...
   mainFit1079->SetParameter(0,-0.03038885);
   mainFit1079->SetParError(0,0.001905738);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,-0.003837179);
   mainFit1079->SetParError(1,5.57945e-05);
