...
//=========  (Tue Oct 20 14:20:09 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.63899,75,83.07234);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01191->SetMinimum(-52.56786);
   Graph_Graph01191->SetMaximum(68.0012);
   ...
   checkFit1192->SetParameter(0,7.547899);
   checkFit1192->SetParError(0,0.3261152);
   checkFit1192->SetParLimits(0,0,0);
   checkFit1192->SetParameter(1,0.9895113);
   checkFit1192->SetParError(1,0.009547674);
   ...
   pt_LaTex = pt->AddText(" 0.99#pm0.00955");
   pt_LaTex = pt->AddText(" 7.55#pm0.326");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.627906,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.627906,-52.56786,-7.627906,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1193->SetParameter(0,7.547899);
   checkFit1193->SetParError(0,0.3261152);
   checkFit1193->SetParLimits(0,0,0);
   checkFit1193->SetParameter(1,0.9895113);
   checkFit1193->SetParError(1,0.009547674);
