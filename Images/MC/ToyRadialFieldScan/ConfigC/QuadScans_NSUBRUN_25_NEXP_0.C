...
//=========  (Tue Oct 20 14:19:54 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1003 = new TH1F("Graph_mI30dO000000sPppm1003","Graph",100,15.6,20.4);
   Graph_mI30dO000000sPppm1003->SetMinimum(-1.757612);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.279516);
   ...
   quadLineFit1004->SetChisquare(3.27334);
   ...
   quadLineFit1004->SetParameter(0,-3.026814);
   quadLineFit1004->SetParError(0,0.1867488);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.08499088);
   quadLineFit1004->SetParError(1,0.0103325);
   ...
   quadLineFit1005->SetChisquare(3.27334);
   ...
   quadLineFit1005->SetParameter(0,-3.026814);
   quadLineFit1005->SetParError(0,0.1867488);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.08499088);
   quadLineFit1005->SetParError(1,0.0103325);
   ...
   TH1F *Graph_mI10dO000000sPppm1005 = new TH1F("Graph_mI10dO000000sPppm1005","Graph",100,15.6,20.4);
   Graph_mI10dO000000sPppm1005->SetMinimum(-0.2211321);
   Graph_mI10dO000000sPppm1005->SetMaximum(-0.05335492);
   ...
   quadLineFit1006->SetChisquare(0.2068743);
   ...
   quadLineFit1006->SetParameter(0,-0.5088125);
   quadLineFit1006->SetParError(0,0.1867478);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,0.02034125);
   quadLineFit1006->SetParError(1,0.01033244);
   ...
   quadLineFit1007->SetChisquare(0.2068743);
   ...
   quadLineFit1007->SetParameter(0,-0.5088125);
   quadLineFit1007->SetParError(0,0.1867478);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,0.02034125);
   quadLineFit1007->SetParError(1,0.01033244);
   ...
   TH1F *Graph_10dO000000sPppm1007 = new TH1F("Graph_10dO000000sPppm1007","Graph",100,15.6,20.4);
   Graph_10dO000000sPppm1007->SetMinimum(1.041917);
   Graph_10dO000000sPppm1007->SetMaximum(1.44334);
   ...
   quadLineFit1008->SetChisquare(0.1115833);
   ...
   quadLineFit1008->SetParameter(0,2.488929);
   quadLineFit1008->SetParError(0,0.1867485);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.06901747);
   ...
   quadLineFit1009->SetChisquare(0.1115833);
   ...
   quadLineFit1009->SetParameter(0,2.488929);
   quadLineFit1009->SetParError(0,0.1867485);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.06901747);
   ...
   TH1F *Graph_30dO000000sPppm1009 = new TH1F("Graph_30dO000000sPppm1009","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1009->SetMinimum(2.213394);
   Graph_30dO000000sPppm1009->SetMaximum(2.951738);
   ...
   quadLineFit1010->SetChisquare(0.679904);
   ...
   quadLineFit1010->SetParameter(0,5.078493);
   quadLineFit1010->SetParError(0,0.186752);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-0.1392092);
   quadLineFit1010->SetParError(1,0.01033268);
   ...
   quadLineFit1011->SetChisquare(0.679904);
   ...
   quadLineFit1011->SetParameter(0,5.078493);
   quadLineFit1011->SetParError(0,0.186752);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-0.1392092);
   quadLineFit1011->SetParError(1,0.01033268);
   ...
   Graph_50dO000000sPppm1011->SetMinimum(3.322354);
   Graph_50dO000000sPppm1011->SetMaximum(4.513125);
   ...
   quadLineFit1012->SetChisquare(0.08000182);
   ...
   quadLineFit1012->SetParameter(0,8.116735);
   quadLineFit1012->SetParError(0,0.1867561);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-0.233465);
   quadLineFit1012->SetParError(1,0.01033291);
   ...
   quadLineFit1013->SetChisquare(0.08000182);
   ...
   quadLineFit1013->SetParameter(0,8.116735);
   quadLineFit1013->SetParError(0,0.1867561);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-0.233465);
   quadLineFit1013->SetParError(1,0.01033291);
