...
//=========  (Tue Oct 20 14:20:01 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.50377,75,85.19257);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-55.83413);
   Graph_Graph01095->SetMaximum(69.52294);
   ...
   checkFit1096->SetParameter(0,7.986826);
   checkFit1096->SetParError(0,0.4617616);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,1.005702);
   checkFit1096->SetParError(1,0.013519);
   ...
   pt_LaTex = pt->AddText(" 7.99#pm0.462");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.94154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.94154,-55.83413,-7.94154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetParameter(0,7.986826);
   checkFit1097->SetParError(0,0.4617616);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,1.005702);
   checkFit1097->SetParError(1,0.013519);
