...
//=========  (Tue Oct 20 14:20:04 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.33255,75,85.23476);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01127->SetMinimum(-53.87582);
   Graph_Graph01127->SetMaximum(69.77802);
   ...
   checkFit1128->SetParameter(0,7.861383);
   checkFit1128->SetParError(0,0.3996603);
   checkFit1128->SetParLimits(0,0,0);
   checkFit1128->SetParameter(1,0.9986023);
   checkFit1128->SetParError(1,0.01170086);
   ...
   pt_LaTex = pt->AddText(" 7.86#pm  0.4");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.872387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.872387,-53.87582,-7.872387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1129->SetParameter(0,7.861383);
   checkFit1129->SetParError(0,0.3996603);
   checkFit1129->SetParLimits(0,0,0);
   checkFit1129->SetParameter(1,0.9986023);
   checkFit1129->SetParError(1,0.01170086);
