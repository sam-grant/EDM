...
//=========  (Tue Oct 20 14:19:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.2849,75,83.85222);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-53.97118);
   Graph_Graph01031->SetMaximum(68.53851);
   ...
   checkFit1032->SetChisquare(7.079164);
   ...
   checkFit1032->SetParameter(0,6.753424);
   checkFit1032->SetParError(0,0.7949233);
   checkFit1032->SetParLimits(0,0,0);
   checkFit1032->SetParameter(1,0.9938272);
   checkFit1032->SetParError(1,0.02327297);
   ...
   pt_LaTex = pt->AddText("0.994#pm0.0233");
   pt_LaTex = pt->AddText(" 6.75#pm0.795");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.795371,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.795371,-53.97118,-6.795371,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(7.079164);
   ...
   checkFit1033->SetParameter(0,6.753424);
   checkFit1033->SetParError(0,0.7949233);
   checkFit1033->SetParLimits(0,0,0);
   checkFit1033->SetParameter(1,0.9938272);
   checkFit1033->SetParError(1,0.02327297);
