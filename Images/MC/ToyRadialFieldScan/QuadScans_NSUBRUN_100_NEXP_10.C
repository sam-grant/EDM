void QuadScans_NSUBRUN_100_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.223579,0.0663141,7.500071);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1049->SetMinimum(-3.951214);
   Graph_mI50dO000000sPppm1049->SetMaximum(6.227706);
   ...
   TF1 *quadLineFit1050 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1050->SetFillColor(19);
   quadLineFit1050->SetFillStyle(0);
   quadLineFit1050->SetLineWidth(2);
   quadLineFit1050->SetChisquare(1.58675);
   ...
   quadLineFit1050->SetParameter(0,-0.112977);
   quadLineFit1050->SetParError(0,0.1050412);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,-48.67568);
   quadLineFit1050->SetParError(1,1.854709);
   quadLineFit1050->SetParLimits(1,0,0);
   quadLineFit1050->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1050);
   gre->Draw("ap");
   
   TF1 *quadLineFit1051 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1051->SetFillColor(19);
   quadLineFit1051->SetFillStyle(0);
   quadLineFit1051->SetLineWidth(2);
   quadLineFit1051->SetChisquare(1.58675);
   ...
   quadLineFit1051->SetParameter(0,-0.112977);
   quadLineFit1051->SetParError(0,0.1050412);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,-48.67568);
   quadLineFit1051->SetParError(1,1.854709);
   ...
   Graph_mI30dO000000sPppm1051->SetMinimum(-1.928605);
   Graph_mI30dO000000sPppm1051->SetMaximum(-1.314832);
   ...
   TF1 *quadLineFit1052 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1052->SetChisquare(2.099713);
   ...
   quadLineFit1052->SetParameter(0,-0.1159252);
   quadLineFit1052->SetParError(0,0.05911469);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,-24.43854);
   quadLineFit1052->SetParError(1,0.9743313);
   quadLineFit1052->SetParLimits(1,0,0);
   quadLineFit1052->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1052);
   gre->Draw("p ");
   
   TF1 *quadLineFit1053 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1053->SetChisquare(2.099713);
   ...
   quadLineFit1053->SetParameter(0,-0.1159252);
   quadLineFit1053->SetParError(0,0.05911469);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,-24.43854);
   quadLineFit1053->SetParError(1,0.9743313);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-0.2111614);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.09387605);
   ...
   TF1 *quadLineFit1054 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1054->SetChisquare(0.1656764);
   ...
   quadLineFit1054->SetParameter(0,0.06167596);
   quadLineFit1054->SetParError(0,0.05909428);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,-3.442393);
   quadLineFit1054->SetParError(1,0.9739894);
   quadLineFit1054->SetParLimits(1,0,0);
   quadLineFit1054->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1054);
   gre->Draw("p ");
   
   TF1 *quadLineFit1055 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1055->SetChisquare(0.1656764);
   ...
   quadLineFit1055->SetParameter(0,0.06167596);
   quadLineFit1055->SetParError(0,0.05909428);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,-3.442393);
   quadLineFit1055->SetParError(1,0.9739894);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(1.027585);
   Graph_10dO000000sPppm1055->SetMaximum(1.609556);
   ...
   TF1 *quadLineFit1056 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1056->SetChisquare(5.09805);
   ...
   quadLineFit1056->SetParameter(0,-0.06374312);
   quadLineFit1056->SetParError(0,0.06478899);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,22.75228);
   quadLineFit1056->SetParError(1,1.040208);
   quadLineFit1056->SetParLimits(1,0,0);
   quadLineFit1056->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1056);
   gre->Draw("p ");
   
   TF1 *quadLineFit1057 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1057->SetChisquare(5.09805);
   ...
   quadLineFit1057->SetParameter(0,-0.06374312);
   quadLineFit1057->SetParError(0,0.06478899);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,22.75228);
   quadLineFit1057->SetParError(1,1.040208);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(2.213332);
   Graph_30dO000000sPppm1057->SetMaximum(3.400323);
   ...
   TF1 *quadLineFit1058 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1058->SetChisquare(3.313293);
   ...
   quadLineFit1058->SetParameter(0,-0.06995044);
   quadLineFit1058->SetParError(0,0.05908381);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,46.95214);
   quadLineFit1058->SetParError(1,0.9738167);
   quadLineFit1058->SetParLimits(1,0,0);
   quadLineFit1058->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1058);
   gre->Draw("p ");
   
   TF1 *quadLineFit1059 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1059->SetChisquare(3.313293);
   ...
   quadLineFit1059->SetParameter(0,-0.06995044);
   quadLineFit1059->SetParError(0,0.05908381);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,46.95214);
   quadLineFit1059->SetParError(1,0.9738167);
   ...
   Graph_50dO000000sPppm1059->SetMinimum(3.415366);
   Graph_50dO000000sPppm1059->SetMaximum(5.140801);
   ...
   TF1 *quadLineFit1060 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1060->SetChisquare(3.046303);
   ...
   quadLineFit1060->SetParameter(0,0.003414006);
   quadLineFit1060->SetParError(0,0.05909326);
   quadLineFit1060->SetParLimits(0,0,0);
   quadLineFit1060->SetParameter(1,69.86539);
   quadLineFit1060->SetParError(1,0.9739725);
   quadLineFit1060->SetParLimits(1,0,0);
   quadLineFit1060->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1060);
   gre->Draw("p ");
   
   TF1 *quadLineFit1061 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1061->SetChisquare(3.046303);
   ...
   quadLineFit1061->SetParameter(0,0.003414006);
   quadLineFit1061->SetParError(0,0.05909326);
   quadLineFit1061->SetParLimits(0,0,0);
   quadLineFit1061->SetParameter(1,69.86539);
   quadLineFit1061->SetParError(1,0.9739725);
