void QuadScans_NSUBRUN_125_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.24864,0.0663141,7.518842);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1065->SetMinimum(-3.971892);
   Graph_mI50dO000000sPppm1065->SetMaximum(6.242094);
   ...
   TF1 *quadLineFit1066 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1066->SetFillColor(19);
   quadLineFit1066->SetFillStyle(0);
   quadLineFit1066->SetLineWidth(2);
   quadLineFit1066->SetChisquare(0.03970658);
   ...
   quadLineFit1066->SetParameter(0,0.1641631);
   quadLineFit1066->SetParError(0,0.09377117);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-53.45381);
   quadLineFit1066->SetParError(1,1.655715);
   quadLineFit1066->SetParLimits(1,0,0);
   quadLineFit1066->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1066);
   gre->Draw("ap");
   
   TF1 *quadLineFit1067 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1067->SetFillColor(19);
   quadLineFit1067->SetFillStyle(0);
   quadLineFit1067->SetLineWidth(2);
   quadLineFit1067->SetChisquare(0.03970658);
   ...
   quadLineFit1067->SetParameter(0,0.1641631);
   quadLineFit1067->SetParError(0,0.09377117);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-53.45381);
   quadLineFit1067->SetParError(1,1.655715);
   ...
   Graph_mI30dO000000sPppm1067->SetMinimum(-1.968868);
   Graph_mI30dO000000sPppm1067->SetMaximum(-1.316657);
   ...
   TF1 *quadLineFit1068 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1068->SetChisquare(7.343617);
   ...
   quadLineFit1068->SetParameter(0,-0.04436418);
   quadLineFit1068->SetParError(0,0.05274379);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-25.77437);
   quadLineFit1068->SetParError(1,0.8693206);
   quadLineFit1068->SetParLimits(1,0,0);
   quadLineFit1068->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1068);
   gre->Draw("p ");
   
   TF1 *quadLineFit1069 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1069->SetChisquare(7.343617);
   ...
   quadLineFit1069->SetParameter(0,-0.04436418);
   quadLineFit1069->SetParError(0,0.05274379);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-25.77437);
   quadLineFit1069->SetParError(1,0.8693206);
   ...
   Graph_mI10dO000000sPppm1069->SetMinimum(-0.1818511);
   Graph_mI10dO000000sPppm1069->SetMaximum(-0.09827727);
   ...
   TF1 *quadLineFit1070 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1070->SetChisquare(3.126132);
   ...
   quadLineFit1070->SetParameter(0,-0.04796077);
   quadLineFit1070->SetParError(0,0.05275285);
   quadLineFit1070->SetParLimits(0,0,0);
   quadLineFit1070->SetParameter(1,-1.606685);
   quadLineFit1070->SetParError(1,0.8694703);
   quadLineFit1070->SetParLimits(1,0,0);
   quadLineFit1070->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1070);
   gre->Draw("p ");
   
   TF1 *quadLineFit1071 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1071->SetChisquare(3.126132);
   ...
   quadLineFit1071->SetParameter(0,-0.04796077);
   quadLineFit1071->SetParError(0,0.05275285);
   quadLineFit1071->SetParLimits(0,0,0);
   quadLineFit1071->SetParameter(1,-1.606685);
   quadLineFit1071->SetParError(1,0.8694703);
   ...
   Graph_10dO000000sPppm1071->SetMinimum(1.039408);
   Graph_10dO000000sPppm1071->SetMaximum(1.607867);
   ...
   TF1 *quadLineFit1072 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1072->SetChisquare(0.2739236);
   ...
   quadLineFit1072->SetParameter(0,-0.03916703);
   quadLineFit1072->SetParError(0,0.05783646);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,22.16561);
   quadLineFit1072->SetParError(1,0.9285826);
   quadLineFit1072->SetParLimits(1,0,0);
   quadLineFit1072->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1072);
   gre->Draw("p ");
   
   TF1 *quadLineFit1073 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1073->SetChisquare(0.2739236);
   ...
   quadLineFit1073->SetParameter(0,-0.03916703);
   quadLineFit1073->SetParError(0,0.05783646);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,22.16561);
   quadLineFit1073->SetParError(1,0.9285826);
   ...
   Graph_30dO000000sPppm1073->SetMinimum(2.244808);
   Graph_30dO000000sPppm1073->SetMaximum(3.393394);
   ...
   TF1 *quadLineFit1074 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1074->SetChisquare(1.281197);
   ...
   quadLineFit1074->SetParameter(0,-0.03461218);
   quadLineFit1074->SetParError(0,0.05274021);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,46.39158);
   quadLineFit1074->SetParError(1,0.8692605);
   quadLineFit1074->SetParLimits(1,0,0);
   quadLineFit1074->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1074);
   gre->Draw("p ");
   
   TF1 *quadLineFit1075 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1075->SetChisquare(1.281197);
   ...
   quadLineFit1075->SetParameter(0,-0.03461218);
   quadLineFit1075->SetParError(0,0.05274021);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,46.39158);
   quadLineFit1075->SetParError(1,0.8692605);
   ...
   Graph_50dO000000sPppm1075->SetMinimum(3.416045);
   Graph_50dO000000sPppm1075->SetMaximum(5.151558);
   ...
   TF1 *quadLineFit1076 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1076->SetChisquare(1.565991);
   ...
   quadLineFit1076->SetParameter(0,-0.01044772);
   quadLineFit1076->SetParError(0,0.05275272);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,70.08498);
   quadLineFit1076->SetParError(1,0.8694682);
   quadLineFit1076->SetParLimits(1,0,0);
   quadLineFit1076->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1076);
   gre->Draw("p ");
   
   TF1 *quadLineFit1077 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1077->SetChisquare(1.565991);
   ...
   quadLineFit1077->SetParameter(0,-0.01044772);
   quadLineFit1077->SetParError(0,0.05275272);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,70.08498);
   quadLineFit1077->SetParError(1,0.8694682);
