void QuadScans_NSUBRUN_75_NEXP_50()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:01:56 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.227425,0.0663141,7.546165);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1033->SetMinimum(-3.950066);
   Graph_mI50dO000000sPppm1033->SetMaximum(6.268806);
   ...
   quadLineFit1034->SetChisquare(0.2250389);
   ...
   quadLineFit1034->SetParameter(0,0.006173285);
   quadLineFit1034->SetParError(0,0.1207426);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,-50.61968);
   quadLineFit1034->SetParError(1,2.131949);
   ...
   quadLineFit1035->SetChisquare(0.2250389);
   ...
   quadLineFit1035->SetParameter(0,0.006173285);
   quadLineFit1035->SetParError(0,0.1207426);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,-50.61968);
   quadLineFit1035->SetParError(1,2.131949);
   ...
   Graph_mI30dO000000sPppm1035->SetMinimum(-1.983105);
   Graph_mI30dO000000sPppm1035->SetMaximum(-1.302134);
   ...
   quadLineFit1036->SetChisquare(1.277261);
   ...
   quadLineFit1036->SetParameter(0,-0.02127555);
   quadLineFit1036->SetParError(0,0.06792782);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-26.31229);
   quadLineFit1036->SetParError(1,1.119579);
   ...
   quadLineFit1037->SetChisquare(1.277261);
   ...
   quadLineFit1037->SetParameter(0,-0.02127555);
   quadLineFit1037->SetParError(0,0.06792782);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-26.31229);
   quadLineFit1037->SetParError(1,1.119579);
   ...
   Graph_mI10dO000000sPppm1037->SetMinimum(-0.2060111);
   Graph_mI10dO000000sPppm1037->SetMaximum(-0.1322311);
   ...
   quadLineFit1038->SetChisquare(1.489479);
   ...
   quadLineFit1038->SetParameter(0,-0.179094);
   quadLineFit1038->SetParError(0,0.06794704);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.2369471);
   quadLineFit1038->SetParError(1,1.1199);
   ...
   quadLineFit1039->SetChisquare(1.489479);
   ...
   quadLineFit1039->SetParameter(0,-0.179094);
   quadLineFit1039->SetParError(0,0.06794704);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.2369471);
   quadLineFit1039->SetParError(1,1.1199);
   ...
   Graph_10dO000000sPppm1039->SetMinimum(1.0149);
   Graph_10dO000000sPppm1039->SetMaximum(1.59587);
   ...
   quadLineFit1040->SetChisquare(2.692725);
   ...
   quadLineFit1040->SetParameter(0,-0.06152924);
   quadLineFit1040->SetParError(0,0.07449577);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,22.46469);
   quadLineFit1040->SetParError(1,1.196053);
   ...
   quadLineFit1041->SetChisquare(2.692725);
   ...
   quadLineFit1041->SetParameter(0,-0.06152924);
   quadLineFit1041->SetParError(0,0.07449577);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,22.46469);
   quadLineFit1041->SetParError(1,1.196053);
   ...
   Graph_30dO000000sPppm1041->SetMinimum(2.210126);
   Graph_30dO000000sPppm1041->SetMaximum(3.374599);
   ...
   quadLineFit1042->SetChisquare(0.6520366);
   ...
   quadLineFit1042->SetParameter(0,-0.03421891);
   quadLineFit1042->SetParError(0,0.06795087);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,46.13502);
   quadLineFit1042->SetParError(1,1.119964);
   ...
   quadLineFit1043->SetChisquare(0.6520366);
   ...
   quadLineFit1043->SetParameter(0,-0.03421891);
   quadLineFit1043->SetParError(0,0.06795087);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,46.13502);
   quadLineFit1043->SetParError(1,1.119964);
   ...
   Graph_50dO000000sPppm1043->SetMinimum(3.407165);
   Graph_50dO000000sPppm1043->SetMaximum(5.179843);
   ...
   quadLineFit1044->SetChisquare(0.847638);
   ...
   quadLineFit1044->SetParameter(0,-0.1063191);
   quadLineFit1044->SetParError(0,0.06770861);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,71.59907);
   quadLineFit1044->SetParError(1,1.116014);
   ...
   quadLineFit1045->SetChisquare(0.847638);
   ...
   quadLineFit1045->SetParameter(0,-0.1063191);
   quadLineFit1045->SetParError(0,0.06770861);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,71.59907);
   quadLineFit1045->SetParError(1,1.116014);
