void FieldFitCheck_NSUBRUN_125_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-105.7322,75,396.2605);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-55.53291);
   Graph_Graph01079->SetMaximum(346.0612);
   ...
   checkFit1080->SetChisquare(99409.14);
   ...
   checkFit1080->SetParameter(0,67.48525);
   checkFit1080->SetParError(0,0.3152524);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,-1.52654);
   checkFit1080->SetParError(1,0.009229647);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.49e+04");
   pt_LaTex = pt->AddText("-1.53
#pm0.009
");
   pt_LaTex = pt->AddText("67.5
#pm0.3
");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,44.20798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(44.20798,-55.53291,44.20798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(99409.14);
   ...
   checkFit1081->SetParameter(0,67.48525);
   checkFit1081->SetParError(0,0.3152524);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,-1.52654);
   checkFit1081->SetParError(1,0.009229647);
