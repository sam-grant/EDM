void FieldFitCheck_NSUBRUN_70_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:10:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-39.20776,45,55.19038);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-29.76795);
   Graph_Graph01007->SetMaximum(45.75056);
   ...
   checkFit1008->SetChisquare(1.233685e-17);
   ...
   checkFit1008->SetParameter(0,7.991309);
   checkFit1008->SetParError(0,0.9239575);
   checkFit1008->SetParLimits(0,0,0);
   checkFit1008->SetParameter(1,1.005312);
   checkFit1008->SetParError(1,0.03079858);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.94908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.94908,-29.76795,-7.94908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(1.233685e-17);
   ...
   checkFit1009->SetParameter(0,7.991309);
   checkFit1009->SetParError(0,0.9239575);
   checkFit1009->SetParLimits(0,0,0);
   checkFit1009->SetParameter(1,1.005312);
   checkFit1009->SetParError(1,0.03079858);
