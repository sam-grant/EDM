...
//=========  (Fri Oct  2 13:49:32 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01027->SetMinimum(-0.09800002);
   Graph_Graph01027->SetMaximum(0.148);
   ...
   lineFit21028->SetChisquare(2.160327e-26);
   ...
   lineFit21028->SetParError(0,0.004375009);
   lineFit21028->SetParLimits(0,0,0);
   lineFit21028->SetParameter(1,-0.003125);
   lineFit21028->SetParError(1,0.0001956564);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("1.08#times10^{#minus26}");
   pt_LaTex = pt->AddText("#minus0.00313#pm0.000196");
   pt_LaTex = pt->AddText("0.025#pm0.00438");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8,-0.09800002,8,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   lineFit21029->SetChisquare(2.160327e-26);
   ...
   lineFit21029->SetParError(0,0.004375009);
   lineFit21029->SetParLimits(0,0,0);
   lineFit21029->SetParameter(1,-0.003125);
   lineFit21029->SetParError(1,0.0001956564);
