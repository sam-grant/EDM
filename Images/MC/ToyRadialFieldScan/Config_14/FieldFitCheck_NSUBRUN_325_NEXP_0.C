...
//=========  (Fri Oct 16 10:31:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.60641,45,53.19969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-29.4258);
   Graph_Graph01155->SetMaximum(44.01908);
   ...
   checkFit1156->SetParameter(0,8.048074);
   checkFit1156->SetParError(0,0.3138165);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,1.005361);
   checkFit1156->SetParError(1,0.0140343);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.014");
   pt_LaTex = pt->AddText(" 8.05#pm0.314");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.005155,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.005155,-29.4258,-8.005155,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetParameter(0,8.048074);
   checkFit1157->SetParError(0,0.3138165);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,1.005361);
   checkFit1157->SetParError(1,0.0140343);
