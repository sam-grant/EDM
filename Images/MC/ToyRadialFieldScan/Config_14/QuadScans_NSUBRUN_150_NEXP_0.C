...
//=========  (Fri Oct 16 10:31:20 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1061 = new TH1F("Graph_mI30dO000000sPppm1061","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1062 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1062->SetFillColor(19);
   quadLineFit1062->SetFillStyle(0);
   quadLineFit1062->SetLineWidth(2);
   quadLineFit1062->SetChisquare(0.005102256);
   ...
   quadLineFit1062->SetParameter(0,-3.272433);
   quadLineFit1062->SetParError(0,0.06977826);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.09979556);
   quadLineFit1062->SetParError(1,0.004259552);
   quadLineFit1062->SetParLimits(1,0,0);
   quadLineFit1062->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1062);
   gre->Draw("ap");
   
   TF1 *quadLineFit1063 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1063->SetFillColor(19);
   quadLineFit1063->SetFillStyle(0);
   quadLineFit1063->SetLineWidth(2);
   quadLineFit1063->SetChisquare(0.005102256);
   ...
   quadLineFit1063->SetParameter(0,-3.272433);
   quadLineFit1063->SetParError(0,0.06977826);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.09979556);
   quadLineFit1063->SetParError(1,0.004259552);
   ...
   TH1F *Graph_mI10dO000000sPppm1063 = new TH1F("Graph_mI10dO000000sPppm1063","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1063->SetMinimum(-0.1778706);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.1014085);
   ...
   TF1 *quadLineFit1064 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1064->SetChisquare(0.8742021);
   ...
   quadLineFit1064->SetParameter(0,-0.3057011);
   quadLineFit1064->SetParError(0,0.069778);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.009905697);
   quadLineFit1064->SetParError(1,0.004259536);
   quadLineFit1064->SetParLimits(1,0,0);
   quadLineFit1064->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1064);
   gre->Draw("p ");
   
   TF1 *quadLineFit1065 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1065->SetChisquare(0.8742021);
   ...
   quadLineFit1065->SetParameter(0,-0.3057011);
   quadLineFit1065->SetParError(0,0.069778);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.009905697);
   quadLineFit1065->SetParError(1,0.004259536);
   ...
   TH1F *Graph_10dO000000sPppm1065 = new TH1F("Graph_10dO000000sPppm1065","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1065->SetMinimum(1.148861);
   Graph_10dO000000sPppm1065->SetMaximum(1.564538);
   ...
   TF1 *quadLineFit1066 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1066->SetChisquare(0.3886445);
   ...
   quadLineFit1066->SetParameter(0,2.667014);
   quadLineFit1066->SetParError(0,0.06977626);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.08057548);
   quadLineFit1066->SetParError(1,0.004259429);
   quadLineFit1066->SetParLimits(1,0,0);
   quadLineFit1066->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1066);
   gre->Draw("p ");
   
   TF1 *quadLineFit1067 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1067->SetChisquare(0.3886445);
   ...
   quadLineFit1067->SetParameter(0,2.667014);
   quadLineFit1067->SetParError(0,0.06977626);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.08057548);
   quadLineFit1067->SetParError(1,0.004259429);
   ...
   TH1F *Graph_30dO000000sPppm1067 = new TH1F("Graph_30dO000000sPppm1067","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1067->SetMinimum(2.439873);
   Graph_30dO000000sPppm1067->SetMaximum(3.257421);
   ...
   TF1 *quadLineFit1068 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1068->SetChisquare(10.81935);
   ...
   quadLineFit1068->SetParameter(0,5.510535);
   quadLineFit1068->SetParError(0,0.06970294);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.1642986);
   quadLineFit1068->SetParError(1,0.004254908);
   quadLineFit1068->SetParLimits(1,0,0);
   quadLineFit1068->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1068);
   gre->Draw("p ");
   
   TF1 *quadLineFit1069 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1069->SetChisquare(10.81935);
   ...
   quadLineFit1069->SetParameter(0,5.510535);
   quadLineFit1069->SetParError(0,0.06970294);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.1642986);
   quadLineFit1069->SetParError(1,0.004254908);
