...
//=========  (Fri Oct 16 10:31:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.3346,45,53.47878);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-28.25326);
   Graph_Graph01107->SetMaximum(44.39745);
   ...
   checkFit1108->SetParameter(0,7.71013);
   checkFit1108->SetParError(0,0.377311);
   checkFit1108->SetParLimits(0,0,0);
   checkFit1108->SetParameter(1,0.9939617);
   checkFit1108->SetParError(1,0.01687386);
   ...
   pt_LaTex = pt->AddText("0.994#pm0.0169");
   pt_LaTex = pt->AddText(" 7.71#pm0.377");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.756969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.756969,-28.25326,-7.756969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1109->SetParameter(0,7.71013);
   checkFit1109->SetParError(0,0.377311);
   checkFit1109->SetParLimits(0,0,0);
   checkFit1109->SetParameter(1,0.9939617);
   checkFit1109->SetParError(1,0.01687386);
