...
//=========  (Fri Oct 16 10:31:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.65356,45,54.17347);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01083->SetMinimum(-29.37085);
   Graph_Graph01083->SetMaximum(44.89076);
   ...
   checkFit1084->SetParameter(0,7.665614);
   checkFit1084->SetParError(0,0.4280924);
   checkFit1084->SetParLimits(0,0,0);
   checkFit1084->SetParameter(1,0.9985399);
   checkFit1084->SetParError(1,0.01914488);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.0191");
   pt_LaTex = pt->AddText(" 7.67#pm0.428");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.676822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.676822,-29.37085,-7.676822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1085->SetParameter(0,7.665614);
   checkFit1085->SetParError(0,0.4280924);
   checkFit1085->SetParLimits(0,0,0);
   checkFit1085->SetParameter(1,0.9985399);
   checkFit1085->SetParError(1,0.01914488);
