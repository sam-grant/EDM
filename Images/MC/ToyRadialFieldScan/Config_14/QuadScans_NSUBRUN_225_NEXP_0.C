...
//=========  (Fri Oct 16 10:31:24 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1097 = new TH1F("Graph_mI30dO000000sPppm1097","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1098 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1098->SetFillColor(19);
   quadLineFit1098->SetFillStyle(0);
   quadLineFit1098->SetLineWidth(2);
   quadLineFit1098->SetChisquare(1.865668);
   ...
   quadLineFit1098->SetParameter(0,-3.248655);
   quadLineFit1098->SetParError(0,0.05692863);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.09875207);
   quadLineFit1098->SetParError(1,0.003475159);
   quadLineFit1098->SetParLimits(1,0,0);
   quadLineFit1098->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1098);
   gre->Draw("ap");
   
   TF1 *quadLineFit1099 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1099->SetFillColor(19);
   quadLineFit1099->SetFillStyle(0);
   quadLineFit1099->SetLineWidth(2);
   quadLineFit1099->SetChisquare(1.865668);
   ...
   quadLineFit1099->SetParameter(0,-3.248655);
   quadLineFit1099->SetParError(0,0.05692863);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.09875207);
   quadLineFit1099->SetParError(1,0.003475159);
   ...
   TH1F *Graph_mI10dO000000sPppm1099 = new TH1F("Graph_mI10dO000000sPppm1099","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1099->SetMinimum(-0.194828);
   Graph_mI10dO000000sPppm1099->SetMaximum(-0.09390771);
   ...
   TF1 *quadLineFit1100 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1100->SetChisquare(0.1199866);
   ...
   quadLineFit1100->SetParameter(0,-0.4055804);
   quadLineFit1100->SetParError(0,0.05692711);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.01611058);
   quadLineFit1100->SetParError(1,0.003475065);
   quadLineFit1100->SetParLimits(1,0,0);
   quadLineFit1100->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1100);
   gre->Draw("p ");
   
   TF1 *quadLineFit1101 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1101->SetChisquare(0.1199866);
   ...
   quadLineFit1101->SetParameter(0,-0.4055804);
   quadLineFit1101->SetParError(0,0.05692711);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.01611058);
   quadLineFit1101->SetParError(1,0.003475065);
   ...
   TH1F *Graph_10dO000000sPppm1101 = new TH1F("Graph_10dO000000sPppm1101","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1101->SetMinimum(1.13779);
   Graph_10dO000000sPppm1101->SetMaximum(1.56356);
   ...
   TF1 *quadLineFit1102 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1102->SetChisquare(1.421339);
   ...
   quadLineFit1102->SetParameter(0,2.711629);
   quadLineFit1102->SetParError(0,0.0568892);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-0.08378759);
   quadLineFit1102->SetParError(1,0.003472727);
   quadLineFit1102->SetParLimits(1,0,0);
   quadLineFit1102->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1102);
   gre->Draw("p ");
   
   TF1 *quadLineFit1103 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1103->SetChisquare(1.421339);
   ...
   quadLineFit1103->SetParameter(0,2.711629);
   quadLineFit1103->SetParError(0,0.0568892);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-0.08378759);
   quadLineFit1103->SetParError(1,0.003472727);
   ...
   TH1F *Graph_30dO000000sPppm1103 = new TH1F("Graph_30dO000000sPppm1103","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1103->SetMinimum(2.430427);
   Graph_30dO000000sPppm1103->SetMaximum(3.284879);
   ...
   TF1 *quadLineFit1104 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1104->SetChisquare(11.22645);
   ...
   quadLineFit1104->SetParameter(0,5.66568);
   quadLineFit1104->SetParError(0,0.05692386);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.1730964);
   quadLineFit1104->SetParError(1,0.003474865);
   quadLineFit1104->SetParLimits(1,0,0);
   quadLineFit1104->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1104);
   gre->Draw("p ");
   
   TF1 *quadLineFit1105 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1105->SetChisquare(11.22645);
   ...
   quadLineFit1105->SetParameter(0,5.66568);
   quadLineFit1105->SetParError(0,0.05692386);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.1730964);
   quadLineFit1105->SetParError(1,0.003474865);
