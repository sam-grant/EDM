...
//=========  (Fri Oct 16 10:31:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2462709,45,0.1719269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.2044511);
   Graph_Graph01105->SetMaximum(0.1301071);
   ...
   mainFit1106->SetChisquare(4.131427);
   ...
   mainFit1106->SetParameter(0,-0.03550615);
   mainFit1106->SetParError(0,0.001737227);
   mainFit1106->SetParLimits(0,0,0);
   mainFit1106->SetParameter(1,-0.004577238);
   mainFit1106->SetParError(1,7.770113e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00458#pm7.77e-05");
   pt_LaTex = pt->AddText("#minus0.0355#pm0.00174");
   pt_LaTex = pt->AddText("#minus7.76#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.757113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.757113,-0.2044511,-7.757113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1107->SetChisquare(4.131427);
   ...
   mainFit1107->SetParameter(0,-0.03550615);
   mainFit1107->SetParError(0,0.001737227);
   mainFit1107->SetParLimits(0,0,0);
   mainFit1107->SetParameter(1,-0.004577238);
   mainFit1107->SetParError(1,7.770113e-05);
