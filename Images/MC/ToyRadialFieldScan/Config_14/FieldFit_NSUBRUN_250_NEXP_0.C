...
//=========  (Fri Oct 16 10:31:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2455655,45,0.1652046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01117->SetMinimum(-0.2044885);
   Graph_Graph01117->SetMaximum(0.1241276);
   ...
   mainFit1118->SetParameter(0,-0.03798105);
   mainFit1118->SetParError(0,0.001648053);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.004427451);
   mainFit1118->SetParError(1,7.370305e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00443#pm7.37e-05");
   pt_LaTex = pt->AddText("#minus0.038#pm0.00165");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.578535,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.578535,-0.2044885,-8.578535,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetParameter(0,-0.03798105);
   mainFit1119->SetParError(0,0.001648053);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.004427451);
   mainFit1119->SetParError(1,7.370305e-05);
