...
//=========  (Fri Oct 16 10:31:21 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1073 = new TH1F("Graph_mI30dO000000sPppm1073","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1074 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1074->SetFillColor(19);
   quadLineFit1074->SetFillStyle(0);
   quadLineFit1074->SetLineWidth(2);
   quadLineFit1074->SetChisquare(2.073579);
   ...
   quadLineFit1074->SetParameter(0,-3.320977);
   quadLineFit1074->SetParError(0,0.064639);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.1028127);
   quadLineFit1074->SetParError(1,0.003945862);
   quadLineFit1074->SetParLimits(1,0,0);
   quadLineFit1074->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1074);
   gre->Draw("ap");
   
   TF1 *quadLineFit1075 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1075->SetFillColor(19);
   quadLineFit1075->SetFillStyle(0);
   quadLineFit1075->SetLineWidth(2);
   quadLineFit1075->SetChisquare(2.073579);
   ...
   quadLineFit1075->SetParameter(0,-3.320977);
   quadLineFit1075->SetParError(0,0.064639);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.1028127);
   quadLineFit1075->SetParError(1,0.003945862);
   ...
   TH1F *Graph_mI10dO000000sPppm1075 = new TH1F("Graph_mI10dO000000sPppm1075","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1075->SetMinimum(-0.1985727);
   Graph_mI10dO000000sPppm1075->SetMaximum(-0.1164733);
   ...
   TF1 *quadLineFit1076 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1076->SetChisquare(4.044898);
   ...
   quadLineFit1076->SetParameter(0,-0.304724);
   quadLineFit1076->SetParError(0,0.0645883);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,0.009321758);
   quadLineFit1076->SetParError(1,0.003942736);
   quadLineFit1076->SetParLimits(1,0,0);
   quadLineFit1076->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1076);
   gre->Draw("p ");
   
   TF1 *quadLineFit1077 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1077->SetChisquare(4.044898);
   ...
   quadLineFit1077->SetParameter(0,-0.304724);
   quadLineFit1077->SetParError(0,0.0645883);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,0.009321758);
   quadLineFit1077->SetParError(1,0.003942736);
   ...
   TH1F *Graph_10dO000000sPppm1077 = new TH1F("Graph_10dO000000sPppm1077","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1077->SetMinimum(1.142045);
   Graph_10dO000000sPppm1077->SetMaximum(1.548267);
   ...
   TF1 *quadLineFit1078 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1078->SetChisquare(0.2039371);
   ...
   quadLineFit1078->SetParameter(0,2.631673);
   quadLineFit1078->SetParError(0,0.06458859);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.07905354);
   quadLineFit1078->SetParError(1,0.003942754);
   quadLineFit1078->SetParLimits(1,0,0);
   quadLineFit1078->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1078);
   gre->Draw("p ");
   
   TF1 *quadLineFit1079 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1079->SetChisquare(0.2039371);
   ...
   quadLineFit1079->SetParameter(0,2.631673);
   quadLineFit1079->SetParError(0,0.06458859);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.07905354);
   quadLineFit1079->SetParError(1,0.003942754);
   ...
   TH1F *Graph_30dO000000sPppm1079 = new TH1F("Graph_30dO000000sPppm1079","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1079->SetMinimum(2.422933);
   Graph_30dO000000sPppm1079->SetMaximum(3.286252);
   ...
   TF1 *quadLineFit1080 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1080->SetChisquare(7.645975);
   ...
   quadLineFit1080->SetParameter(0,5.682804);
   quadLineFit1080->SetParError(0,0.06458844);
   quadLineFit1080->SetParLimits(0,0,0);
   quadLineFit1080->SetParameter(1,-0.1742823);
   quadLineFit1080->SetParError(1,0.003942744);
   quadLineFit1080->SetParLimits(1,0,0);
   quadLineFit1080->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1080);
   gre->Draw("p ");
   
   TF1 *quadLineFit1081 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1081->SetChisquare(7.645975);
   ...
   quadLineFit1081->SetParameter(0,5.682804);
   quadLineFit1081->SetParError(0,0.06458844);
   quadLineFit1081->SetParLimits(0,0,0);
   quadLineFit1081->SetParameter(1,-0.1742823);
   quadLineFit1081->SetParError(1,0.003942744);
