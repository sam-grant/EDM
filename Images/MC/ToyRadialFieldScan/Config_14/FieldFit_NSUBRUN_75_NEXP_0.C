...
//=========  (Fri Oct 16 10:31:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2492083,45,0.1887232);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-0.2054152);
   Graph_Graph01033->SetMaximum(0.14493);
   ...
   mainFit1034->SetParameter(0,-0.03175674);
   mainFit1034->SetParError(0,0.002998325);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,-0.004721761);
   mainFit1034->SetParError(1,0.0001340873);
   ...
   pt_LaTex = pt->AddText("#minus0.00472#pm0.000134");
   pt_LaTex = pt->AddText("#minus0.0318#pm0.003");
   pt_LaTex = pt->AddText("#minus6.73#pm0.663");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.725613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.725613,-0.2054152,-6.725613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetParameter(0,-0.03175674);
   mainFit1035->SetParError(0,0.002998325);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,-0.004721761);
   mainFit1035->SetParError(1,0.0001340873);
