...
//=========  (Fri Oct 16 10:31:19 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1049 = new TH1F("Graph_mI30dO000000sPppm1049","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1050 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1050->SetFillColor(19);
   quadLineFit1050->SetFillStyle(0);
   quadLineFit1050->SetLineWidth(2);
   quadLineFit1050->SetChisquare(0.2542078);
   ...
   quadLineFit1050->SetParameter(0,-3.172551);
   quadLineFit1050->SetParError(0,0.07643643);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.09362105);
   quadLineFit1050->SetParError(1,0.004665973);
   quadLineFit1050->SetParLimits(1,0,0);
   quadLineFit1050->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1050);
   gre->Draw("ap");
   
   TF1 *quadLineFit1051 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1051->SetFillColor(19);
   quadLineFit1051->SetFillStyle(0);
   quadLineFit1051->SetLineWidth(2);
   quadLineFit1051->SetChisquare(0.2542078);
   ...
   quadLineFit1051->SetParameter(0,-3.172551);
   quadLineFit1051->SetParError(0,0.07643643);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.09362105);
   quadLineFit1051->SetParError(1,0.004665973);
   ...
   TH1F *Graph_mI10dO000000sPppm1051 = new TH1F("Graph_mI10dO000000sPppm1051","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1051->SetMinimum(-0.1953864);
   Graph_mI10dO000000sPppm1051->SetMaximum(-0.1051173);
   ...
   TF1 *quadLineFit1052 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1052->SetChisquare(0.3388494);
   ...
   quadLineFit1052->SetParameter(0,-0.3523201);
   quadLineFit1052->SetParError(0,0.07647162);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.01220433);
   quadLineFit1052->SetParError(1,0.004668143);
   quadLineFit1052->SetParLimits(1,0,0);
   quadLineFit1052->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1052);
   gre->Draw("p ");
   
   TF1 *quadLineFit1053 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1053->SetChisquare(0.3388494);
   ...
   quadLineFit1053->SetParameter(0,-0.3523201);
   quadLineFit1053->SetParError(0,0.07647162);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.01220433);
   quadLineFit1053->SetParError(1,0.004668143);
   ...
   TH1F *Graph_10dO000000sPppm1053 = new TH1F("Graph_10dO000000sPppm1053","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1053->SetMinimum(1.162119);
   Graph_10dO000000sPppm1053->SetMaximum(1.549955);
   ...
   TF1 *quadLineFit1054 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1054->SetChisquare(1.522626);
   ...
   quadLineFit1054->SetParameter(0,2.558803);
   quadLineFit1054->SetParError(0,0.076473);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,-0.07419735);
   quadLineFit1054->SetParError(1,0.004668227);
   quadLineFit1054->SetParLimits(1,0,0);
   quadLineFit1054->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1054);
   gre->Draw("p ");
   
   TF1 *quadLineFit1055 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1055->SetChisquare(1.522626);
   ...
   quadLineFit1055->SetParameter(0,2.558803);
   quadLineFit1055->SetParError(0,0.076473);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,-0.07419735);
   quadLineFit1055->SetParError(1,0.004668227);
   ...
   TH1F *Graph_30dO000000sPppm1055 = new TH1F("Graph_30dO000000sPppm1055","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1055->SetMinimum(2.428593);
   Graph_30dO000000sPppm1055->SetMaximum(3.268791);
   ...
   TF1 *quadLineFit1056 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1056->SetChisquare(3.495103);
   ...
   quadLineFit1056->SetParameter(0,5.584178);
   quadLineFit1056->SetParError(0,0.07647157);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.1684394);
   quadLineFit1056->SetParError(1,0.00466814);
   quadLineFit1056->SetParLimits(1,0,0);
   quadLineFit1056->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1056);
   gre->Draw("p ");
   
   TF1 *quadLineFit1057 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1057->SetChisquare(3.495103);
   ...
   quadLineFit1057->SetParameter(0,5.584178);
   quadLineFit1057->SetParError(0,0.07647157);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.1684394);
   quadLineFit1057->SetParError(1,0.00466814);
