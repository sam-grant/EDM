...
//=========  (Fri Oct 16 10:31:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.07763,45,52.32475);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(-27.23739);
   Graph_Graph01059->SetMaximum(43.48451);
   ...
   checkFit1060->SetParameter(0,7.42729);
   checkFit1060->SetParError(0,0.5068526);
   checkFit1060->SetParLimits(0,0,0);
   checkFit1060->SetParameter(1,0.9474251);
   checkFit1060->SetParError(1,0.02266714);
   ...
   pt_LaTex = pt->AddText("0.947#pm0.0227");
   pt_LaTex = pt->AddText(" 7.43#pm0.507");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.839449,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.839449,-27.23739,-7.839449,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1061->SetParameter(0,7.42729);
   checkFit1061->SetParError(0,0.5068526);
   checkFit1061->SetParLimits(0,0,0);
   checkFit1061->SetParameter(1,0.9474251);
   checkFit1061->SetParError(1,0.02266714);
