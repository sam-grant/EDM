...
//=========  (Fri Oct 16 10:31:16 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.33867,45,54.84398);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-28.12041);
   Graph_Graph01023->SetMaximum(45.62572);
   ...
   checkFit1024->SetParameter(0,8.627277);
   checkFit1024->SetParError(0,0.7961739);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9856213);
   checkFit1024->SetParError(1,0.03560598);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0356");
   pt_LaTex = pt->AddText(" 8.63#pm0.796");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.753136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.753136,-28.12041,-8.753136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetParameter(0,8.627277);
   checkFit1025->SetParError(0,0.7961739);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9856213);
   checkFit1025->SetParError(1,0.03560598);
