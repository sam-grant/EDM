...
//=========  (Fri Oct 16 10:31:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2456426,45,0.1714783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-0.2039305);
   Graph_Graph01129->SetMaximum(0.1297662);
   ...
   mainFit1130->SetChisquare(4.554087);
   ...
   mainFit1130->SetParameter(0,-0.03596158);
   mainFit1130->SetParError(0,0.001571195);
   mainFit1130->SetParLimits(0,0,0);
   mainFit1130->SetParameter(1,-0.004482819);
   mainFit1130->SetParError(1,7.026634e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00448#pm7.03e-05");
   pt_LaTex = pt->AddText("#minus0.036#pm0.00157");
   pt_LaTex = pt->AddText("#minus8.02#pm0.372");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.022089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.022089,-0.2039305,-8.022089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1131->SetChisquare(4.554087);
   ...
   mainFit1131->SetParameter(0,-0.03596158);
   mainFit1131->SetParError(0,0.001571195);
   mainFit1131->SetParLimits(0,0,0);
   mainFit1131->SetParameter(1,-0.004482819);
   mainFit1131->SetParError(1,7.026634e-05);
