...
//=========  (Fri Oct 16 10:31:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.98203,45,54.1167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.47216);
   Graph_Graph01035->SetMaximum(44.60683);
   ...
   checkFit1036->SetParameter(0,6.896131);
   checkFit1036->SetParError(0,0.6511061);
   checkFit1036->SetParLimits(0,0,0);
   checkFit1036->SetParameter(1,1.025351);
   checkFit1036->SetParError(1,0.02911835);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0291");
   pt_LaTex = pt->AddText("  6.9#pm0.651");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.725629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.725629,-31.47216,-6.725629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1037->SetParameter(0,6.896131);
   checkFit1037->SetParError(0,0.6511061);
   checkFit1037->SetParLimits(0,0,0);
   checkFit1037->SetParameter(1,1.025351);
   checkFit1037->SetParError(1,0.02911835);
