...
//=========  (Fri Oct 16 10:31:27 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1133 = new TH1F("Graph_mI30dO000000sPppm1133","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1134 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1134->SetFillColor(19);
   quadLineFit1134->SetFillStyle(0);
   quadLineFit1134->SetLineWidth(2);
   quadLineFit1134->SetChisquare(3.415058);
   ...
   quadLineFit1134->SetParameter(0,-3.379094);
   quadLineFit1134->SetParError(0,0.04928062);
   quadLineFit1134->SetParLimits(0,0,0);
   quadLineFit1134->SetParameter(1,0.1068351);
   quadLineFit1134->SetParError(1,0.003008292);
   quadLineFit1134->SetParLimits(1,0,0);
   quadLineFit1134->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1134);
   gre->Draw("ap");
   
   TF1 *quadLineFit1135 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1135->SetFillColor(19);
   quadLineFit1135->SetFillStyle(0);
   quadLineFit1135->SetLineWidth(2);
   quadLineFit1135->SetChisquare(3.415058);
   ...
   quadLineFit1135->SetParameter(0,-3.379094);
   quadLineFit1135->SetParError(0,0.04928062);
   quadLineFit1135->SetParLimits(0,0,0);
   quadLineFit1135->SetParameter(1,0.1068351);
   quadLineFit1135->SetParError(1,0.003008292);
   ...
   TH1F *Graph_mI10dO000000sPppm1135 = new TH1F("Graph_mI10dO000000sPppm1135","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1135->SetMinimum(-0.1952441);
   Graph_mI10dO000000sPppm1135->SetMaximum(-0.1223372);
   ...
   TF1 *quadLineFit1136 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1136->SetChisquare(7.293816);
   ...
   quadLineFit1136->SetParameter(0,-0.2827798);
   quadLineFit1136->SetParError(0,0.0492802);
   quadLineFit1136->SetParLimits(0,0,0);
   quadLineFit1136->SetParameter(1,0.007797285);
   quadLineFit1136->SetParError(1,0.003008266);
   quadLineFit1136->SetParLimits(1,0,0);
   quadLineFit1136->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1136);
   gre->Draw("p ");
   
   TF1 *quadLineFit1137 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1137->SetChisquare(7.293816);
   ...
   quadLineFit1137->SetParameter(0,-0.2827798);
   quadLineFit1137->SetParError(0,0.0492802);
   quadLineFit1137->SetParLimits(0,0,0);
   quadLineFit1137->SetParameter(1,0.007797285);
   quadLineFit1137->SetParError(1,0.003008266);
   ...
   TH1F *Graph_10dO000000sPppm1137 = new TH1F("Graph_10dO000000sPppm1137","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1137->SetMinimum(1.132822);
   Graph_10dO000000sPppm1137->SetMaximum(1.571192);
   ...
   TF1 *quadLineFit1138 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1138->SetChisquare(12.27387);
   ...
   quadLineFit1138->SetParameter(0,2.759123);
   quadLineFit1138->SetParError(0,0.0492815);
   quadLineFit1138->SetParLimits(0,0,0);
   quadLineFit1138->SetParameter(1,-0.08707277);
   quadLineFit1138->SetParError(1,0.003008346);
   quadLineFit1138->SetParLimits(1,0,0);
   quadLineFit1138->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1138);
   gre->Draw("p ");
   
   TF1 *quadLineFit1139 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1139->SetChisquare(12.27387);
   ...
   quadLineFit1139->SetParameter(0,2.759123);
   quadLineFit1139->SetParError(0,0.0492815);
   quadLineFit1139->SetParLimits(0,0,0);
   quadLineFit1139->SetParameter(1,-0.08707277);
   quadLineFit1139->SetParError(1,0.003008346);
   ...
   TH1F *Graph_30dO000000sPppm1139 = new TH1F("Graph_30dO000000sPppm1139","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1139->SetMinimum(2.414796);
   Graph_30dO000000sPppm1139->SetMaximum(3.291372);
   ...
   TF1 *quadLineFit1140 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1140->SetChisquare(17.04976);
   ...
   quadLineFit1140->SetParameter(0,5.746098);
   quadLineFit1140->SetParError(0,0.0492808);
   quadLineFit1140->SetParLimits(0,0,0);
   quadLineFit1140->SetParameter(1,-0.1783655);
   quadLineFit1140->SetParError(1,0.003008304);
   quadLineFit1140->SetParLimits(1,0,0);
   quadLineFit1140->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1140);
   gre->Draw("p ");
   
   TF1 *quadLineFit1141 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1141->SetChisquare(17.04976);
   ...
   quadLineFit1141->SetParameter(0,5.746098);
   quadLineFit1141->SetParError(0,0.0492808);
   quadLineFit1141->SetParLimits(0,0,0);
   quadLineFit1141->SetParameter(1,-0.1783655);
   quadLineFit1141->SetParError(1,0.003008304);
