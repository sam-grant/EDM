...
//=========  (Fri Oct 16 10:31:15 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1001 = new TH1F("Graph_mI30dO000000sPppm1001","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1002 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1002->SetFillColor(19);
   quadLineFit1002->SetFillStyle(0);
   quadLineFit1002->SetLineWidth(2);
   quadLineFit1002->SetChisquare(1.865701);
   ...
   quadLineFit1002->SetParameter(0,-3.059825);
   quadLineFit1002->SetParError(0,0.1692653);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.08691347);
   quadLineFit1002->SetParError(1,0.01033265);
   quadLineFit1002->SetParLimits(1,0,0);
   quadLineFit1002->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1002);
   gre->Draw("ap");
   
   TF1 *quadLineFit1003 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1003->SetFillColor(19);
   quadLineFit1003->SetFillStyle(0);
   quadLineFit1003->SetLineWidth(2);
   quadLineFit1003->SetChisquare(1.865701);
   ...
   quadLineFit1003->SetParameter(0,-3.059825);
   quadLineFit1003->SetParError(0,0.1692653);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.08691347);
   quadLineFit1003->SetParError(1,0.01033265);
   ...
   TH1F *Graph_mI10dO000000sPppm1003 = new TH1F("Graph_mI10dO000000sPppm1003","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.2422929);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.08658323);
   ...
   TF1 *quadLineFit1004 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1004->SetChisquare(1.844171);
   ...
   quadLineFit1004->SetParameter(0,-0.3462105);
   quadLineFit1004->SetParError(0,0.1692627);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.01135107);
   ...
   TF1 *quadLineFit1005 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1005->SetChisquare(1.844171);
   ...
   quadLineFit1005->SetParameter(0,-0.3462105);
   quadLineFit1005->SetParError(0,0.1692627);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.01135107);
   ...
   TH1F *Graph_10dO000000sPppm1005 = new TH1F("Graph_10dO000000sPppm1005","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1005->SetMinimum(1.146179);
   Graph_10dO000000sPppm1005->SetMaximum(1.552707);
   ...
   TF1 *quadLineFit1006 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1006->SetChisquare(1.144689);
   ...
   quadLineFit1006->SetParameter(0,2.478999);
   quadLineFit1006->SetParError(0,0.1692613);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.070081);
   quadLineFit1006->SetParError(1,0.01033241);
   quadLineFit1006->SetParLimits(1,0,0);
   quadLineFit1006->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1006);
   gre->Draw("p ");
   
   TF1 *quadLineFit1007 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1007->SetChisquare(1.144689);
   ...
   quadLineFit1007->SetParameter(0,2.478999);
   quadLineFit1007->SetParError(0,0.1692613);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.070081);
   quadLineFit1007->SetParError(1,0.01033241);
   ...
   TH1F *Graph_30dO000000sPppm1007 = new TH1F("Graph_30dO000000sPppm1007","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1007->SetMinimum(2.416826);
   Graph_30dO000000sPppm1007->SetMaximum(3.332831);
   ...
   TF1 *quadLineFit1008 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1008->SetChisquare(0.197899);
   ...
   quadLineFit1008->SetParameter(0,5.741942);
   quadLineFit1008->SetParError(0,0.1692625);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1762222);
   ...
   TF1 *quadLineFit1009 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1009->SetChisquare(0.197899);
   ...
   quadLineFit1009->SetParameter(0,5.741942);
   quadLineFit1009->SetParError(0,0.1692625);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1762222);
