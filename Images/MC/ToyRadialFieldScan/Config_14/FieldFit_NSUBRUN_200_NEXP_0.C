...
//=========  (Fri Oct 16 10:31:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2430493,45,0.1699278);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2017516);
   Graph_Graph01093->SetMaximum(0.1286301);
   ...
   mainFit1094->SetChisquare(1.198686);
   ...
   mainFit1094->SetParameter(0,-0.0365211);
   mainFit1094->SetParError(0,0.00184334);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004435668);
   mainFit1094->SetParError(1,8.243597e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00444#pm8.24e-05");
   pt_LaTex = pt->AddText("#minus0.0365#pm0.00184");
   pt_LaTex = pt->AddText("#minus8.23#pm0.443");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.233507,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.233507,-0.2017516,-8.233507,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(1.198686);
   ...
   mainFit1095->SetParameter(0,-0.0365211);
   mainFit1095->SetParError(0,0.00184334);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004435668);
   mainFit1095->SetParError(1,8.243597e-05);
