...
//=========  (Fri Oct 16 10:31:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2409562,45,0.1661357);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(-0.200247);
   Graph_Graph01057->SetMaximum(0.1254265);
   ...
   mainFit1058->SetChisquare(1.906173);
   ...
   mainFit1058->SetParameter(0,-0.03420361);
   mainFit1058->SetParError(0,0.002333811);
   mainFit1058->SetParLimits(0,0,0);
   mainFit1058->SetParameter(1,-0.004362874);
   mainFit1058->SetParError(1,0.0001043611);
   ...
   pt_LaTex = pt->AddText("#minus0.00436#pm0.000104");
   pt_LaTex = pt->AddText("#minus0.0342#pm0.00233");
   pt_LaTex = pt->AddText("#minus7.84#pm0.567");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.839697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.839697,-0.200247,-7.839697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1059->SetChisquare(1.906173);
   ...
   mainFit1059->SetParameter(0,-0.03420361);
   mainFit1059->SetParError(0,0.002333811);
   mainFit1059->SetParLimits(0,0,0);
   mainFit1059->SetParameter(1,-0.004362874);
   mainFit1059->SetParError(1,0.0001043611);
