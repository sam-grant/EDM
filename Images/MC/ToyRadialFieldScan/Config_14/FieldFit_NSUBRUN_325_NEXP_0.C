...
//=========  (Fri Oct 16 10:31:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.244986,45,0.1777835);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01153->SetMinimum(-0.202709);
   Graph_Graph01153->SetMaximum(0.1355066);
   ...
   mainFit1154->SetChisquare(7.497854);
   ...
   mainFit1154->SetParameter(0,-0.03706147);
   mainFit1154->SetParError(0,0.00144516);
   mainFit1154->SetParLimits(0,0,0);
   mainFit1154->SetParameter(1,-0.004629711);
   mainFit1154->SetParError(1,6.46293e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00463#pm6.46e-05");
   pt_LaTex = pt->AddText("#minus0.0371#pm0.00145");
   pt_LaTex = pt->AddText("#minus8.01#pm0.332");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.005135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.005135,-0.202709,-8.005135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1155->SetChisquare(7.497854);
   ...
   mainFit1155->SetParameter(0,-0.03706147);
   mainFit1155->SetParError(0,0.00144516);
   mainFit1155->SetParLimits(0,0,0);
   mainFit1155->SetParameter(1,-0.004629711);
   mainFit1155->SetParError(1,6.46293e-05);
