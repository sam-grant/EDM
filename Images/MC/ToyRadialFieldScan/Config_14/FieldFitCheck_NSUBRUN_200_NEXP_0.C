...
//=========  (Fri Oct 16 10:31:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.90055,45,52.77915);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-27.93258);
   Graph_Graph01095->SetMaximum(43.81118);
   ...
   checkFit1096->SetParameter(0,7.930718);
   checkFit1096->SetParError(0,0.4002891);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9632232);
   checkFit1096->SetParError(1,0.01790147);
   ...
   pt_LaTex = pt->AddText("0.963#pm0.0179");
   pt_LaTex = pt->AddText(" 7.93#pm  0.4");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.23352,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.23352,-27.93258,-8.23352,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetParameter(0,7.930718);
   checkFit1097->SetParError(0,0.4002891);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9632232);
   checkFit1097->SetParError(1,0.01790147);
