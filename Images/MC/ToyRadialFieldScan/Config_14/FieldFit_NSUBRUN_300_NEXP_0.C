...
//=========  (Fri Oct 16 10:31:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2541781,45,0.1826477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-0.2104955);
   Graph_Graph01141->SetMaximum(0.1389651);
   ...
   mainFit1142->SetChisquare(1.659056);
   ...
   mainFit1142->SetParameter(0,-0.03770145);
   mainFit1142->SetParError(0,0.001504151);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,-0.004752359);
   mainFit1142->SetParError(1,6.72676e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00475#pm6.73e-05");
   pt_LaTex = pt->AddText("#minus0.0377#pm0.0015");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.933207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.933207,-0.2104955,-7.933207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(1.659056);
   ...
   mainFit1143->SetParameter(0,-0.03770145);
   mainFit1143->SetParError(0,0.001504151);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,-0.004752359);
   mainFit1143->SetParError(1,6.72676e-05);
