...
//=========  (Fri Oct 16 10:31:16 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1013 = new TH1F("Graph_mI30dO000000sPppm1013","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1014 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1014->SetFillColor(19);
   quadLineFit1014->SetFillStyle(0);
   quadLineFit1014->SetLineWidth(2);
   quadLineFit1014->SetChisquare(0.002573094);
   ...
   quadLineFit1014->SetParameter(0,-3.153712);
   quadLineFit1014->SetParError(0,0.1201234);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.09386213);
   quadLineFit1014->SetParError(1,0.007332827);
   quadLineFit1014->SetParLimits(1,0,0);
   quadLineFit1014->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1014);
   gre->Draw("ap");
   
   TF1 *quadLineFit1015 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1015->SetFillColor(19);
   quadLineFit1015->SetFillStyle(0);
   quadLineFit1015->SetLineWidth(2);
   quadLineFit1015->SetChisquare(0.002573094);
   ...
   quadLineFit1015->SetParameter(0,-3.153712);
   quadLineFit1015->SetParError(0,0.1201234);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.09386213);
   quadLineFit1015->SetParError(1,0.007332827);
   ...
   TH1F *Graph_mI10dO000000sPppm1015 = new TH1F("Graph_mI10dO000000sPppm1015","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1015->SetMinimum(-0.1974119);
   Graph_mI10dO000000sPppm1015->SetMaximum(-0.08813706);
   ...
   TF1 *quadLineFit1016 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1016->SetChisquare(0.9789337);
   ...
   quadLineFit1016->SetParameter(0,-0.3339995);
   quadLineFit1016->SetParError(0,0.1201231);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,0.01222459);
   quadLineFit1016->SetParError(1,0.007332808);
   quadLineFit1016->SetParLimits(1,0,0);
   quadLineFit1016->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1016);
   gre->Draw("p ");
   
   TF1 *quadLineFit1017 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1017->SetChisquare(0.9789337);
   ...
   quadLineFit1017->SetParameter(0,-0.3339995);
   quadLineFit1017->SetParError(0,0.1201231);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,0.01222459);
   quadLineFit1017->SetParError(1,0.007332808);
   ...
   TH1F *Graph_10dO000000sPppm1017 = new TH1F("Graph_10dO000000sPppm1017","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1017->SetMinimum(1.105272);
   Graph_10dO000000sPppm1017->SetMaximum(1.589581);
   ...
   TF1 *quadLineFit1018 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1018->SetChisquare(0.4931721);
   ...
   quadLineFit1018->SetParameter(0,2.817079);
   quadLineFit1018->SetParError(0,0.1201269);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.09052749);
   quadLineFit1018->SetParError(1,0.007333042);
   quadLineFit1018->SetParLimits(1,0,0);
   quadLineFit1018->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1018);
   gre->Draw("p ");
   
   TF1 *quadLineFit1019 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1019->SetChisquare(0.4931721);
   ...
   quadLineFit1019->SetParameter(0,2.817079);
   quadLineFit1019->SetParError(0,0.1201269);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.09052749);
   quadLineFit1019->SetParError(1,0.007333042);
   ...
   TH1F *Graph_30dO000000sPppm1019 = new TH1F("Graph_30dO000000sPppm1019","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1019->SetMinimum(2.393865);
   Graph_30dO000000sPppm1019->SetMaximum(3.28112);
   ...
   TF1 *quadLineFit1020 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1020->SetChisquare(2.790402);
   ...
   quadLineFit1020->SetParameter(0,5.667283);
   quadLineFit1020->SetParError(0,0.1201253);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.1744745);
   quadLineFit1020->SetParError(1,0.007332942);
   quadLineFit1020->SetParLimits(1,0,0);
   quadLineFit1020->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1020);
   gre->Draw("p ");
   
   TF1 *quadLineFit1021 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1021->SetChisquare(2.790402);
   ...
   quadLineFit1021->SetParameter(0,5.667283);
   quadLineFit1021->SetParError(0,0.1201253);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.1744745);
   quadLineFit1021->SetParError(1,0.007332942);
