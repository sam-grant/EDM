...
//=========  (Fri Oct 16 10:31:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.52447,45,55.91822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-27.2802);
   Graph_Graph01011->SetMaximum(46.67395);
   ...
   checkFit1012->SetParameter(0,8.036798);
   checkFit1012->SetParError(0,1.12187);
   checkFit1012->SetParLimits(0,0,0);
   checkFit1012->SetParameter(1,0.9455313);
   checkFit1012->SetParError(1,0.05017155);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.0502");
   pt_LaTex = pt->AddText(" 8.04#pm 1.12");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.49977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.49977,-27.2802,-8.49977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1013->SetParameter(0,8.036798);
   checkFit1013->SetParError(0,1.12187);
   checkFit1013->SetParLimits(0,0,0);
   checkFit1013->SetParameter(1,0.9455313);
   checkFit1013->SetParError(1,0.05017155);
