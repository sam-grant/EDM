...
//=========  (Fri Oct 16 10:31:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2367056,45,0.1722073);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.1958143);
   Graph_Graph01069->SetMaximum(0.131316);
   ...
   mainFit1070->SetChisquare(0.6733105);
   ...
   mainFit1070->SetParameter(0,-0.03379222);
   mainFit1070->SetParError(0,0.002129178);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.004413756);
   mainFit1070->SetParError(1,9.519958e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.337");
   pt_LaTex = pt->AddText("#minus0.00441#pm9.52e-05");
   pt_LaTex = pt->AddText("#minus0.0338#pm0.00213");
   pt_LaTex = pt->AddText("#minus7.66#pm 0.51");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.656115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.656115,-0.1958143,-7.656115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(0.6733105);
   ...
   mainFit1071->SetParameter(0,-0.03379222);
   mainFit1071->SetParError(0,0.002129178);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.004413756);
   mainFit1071->SetParError(1,9.519958e-05);
