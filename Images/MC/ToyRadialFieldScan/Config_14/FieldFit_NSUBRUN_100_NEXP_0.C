...
//=========  (Fri Oct 16 10:31:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2419208,45,0.1687078);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.2008579);
   Graph_Graph01045->SetMaximum(0.1276449);
   ...
   mainFit1046->SetChisquare(1.474199);
   ...
   mainFit1046->SetParameter(0,-0.03360704);
   mainFit1046->SetParError(0,0.002611658);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.004403766);
   mainFit1046->SetParError(1,0.0001167973);
   ...
   pt_LaTex = pt->AddText("#minus0.0044#pm0.000117");
   pt_LaTex = pt->AddText("#minus0.0336#pm0.00261");
   pt_LaTex = pt->AddText("#minus7.63#pm0.627");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.631433,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.631433,-0.2008579,-7.631433,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(1.474199);
   ...
   mainFit1047->SetParameter(0,-0.03360704);
   mainFit1047->SetParError(0,0.002611658);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.004403766);
   mainFit1047->SetParError(1,0.0001167973);
