...
//=========  (Fri Oct 16 10:31:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.63558,45,52.53407);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-27.71862);
   Graph_Graph01047->SetMaximum(43.6171);
   ...
   checkFit1048->SetParameter(0,7.297912);
   checkFit1048->SetParError(0,0.5671291);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,0.9562962);
   checkFit1048->SetParError(1,0.02536279);
   ...
   pt_LaTex = pt->AddText("0.956#pm0.0254");
   pt_LaTex = pt->AddText("  7.3#pm0.567");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.631435,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.631435,-27.71862,-7.631435,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetParameter(0,7.297912);
   checkFit1049->SetParError(0,0.5671291);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,0.9562962);
   checkFit1049->SetParError(1,0.02536279);
