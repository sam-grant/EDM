...
//=========  (Fri Oct 16 10:31:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.23724,45,53.34231);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01131->SetMinimum(-28.17928);
   Graph_Graph01131->SetMaximum(44.28435);
   ...
   checkFit1132->SetParameter(0,7.809192);
   checkFit1132->SetParError(0,0.3411966);
   checkFit1132->SetParLimits(0,0,0);
   checkFit1132->SetParameter(1,0.973463);
   checkFit1132->SetParError(1,0.01525878);
   ...
   pt_LaTex = pt->AddText("0.973#pm0.0153");
   pt_LaTex = pt->AddText(" 7.81#pm0.341");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.022074,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.022074,-28.17928,-8.022074,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1133->SetParameter(0,7.809192);
   checkFit1133->SetParError(0,0.3411966);
   checkFit1133->SetParLimits(0,0,0);
   checkFit1133->SetParameter(1,0.973463);
   checkFit1133->SetParError(1,0.01525878);
