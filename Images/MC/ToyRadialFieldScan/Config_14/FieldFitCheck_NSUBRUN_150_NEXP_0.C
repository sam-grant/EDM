...
//=========  (Fri Oct 16 10:31:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.39576,45,51.40285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-28.5159);
   Graph_Graph01071->SetMaximum(42.52299);
   ...
   checkFit1072->SetParameter(0,7.338331);
   checkFit1072->SetParError(0,0.4624883);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,0.9584786);
   checkFit1072->SetParError(1,0.0206831);
   ...
   pt_LaTex = pt->AddText("0.958#pm0.0207");
   pt_LaTex = pt->AddText(" 7.34#pm0.462");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.656228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.656228,-28.5159,-7.656228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetParameter(0,7.338331);
   checkFit1073->SetParError(0,0.4624883);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,0.9584786);
   checkFit1073->SetParError(1,0.0206831);
