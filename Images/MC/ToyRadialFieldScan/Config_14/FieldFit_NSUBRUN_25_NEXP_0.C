...
//=========  (Fri Oct 16 10:31:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2575048,45,0.1681963);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.2149347);
   Graph_Graph01009->SetMaximum(0.1256262);
   ...
   mainFit1010->SetChisquare(2.355852);
   ...
   mainFit1010->SetParameter(0,-0.03701082);
   mainFit1010->SetParError(0,0.005166253);
   mainFit1010->SetParLimits(0,0,0);
   mainFit1010->SetParameter(1,-0.004354219);
   mainFit1010->SetParError(1,0.0002310429);
   ...
   pt_LaTex = pt->AddText("#minus0.00435#pm0.000231");
   pt_LaTex = pt->AddText("#minus0.037#pm0.00517");
   pt_LaTex = pt->AddText(" #minus8.5#pm 1.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.499992,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.499992,-0.2149347,-8.499992,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1011->SetChisquare(2.355852);
   ...
   mainFit1011->SetParameter(0,-0.03701082);
   mainFit1011->SetParError(0,0.005166253);
   mainFit1011->SetParLimits(0,0,0);
   mainFit1011->SetParameter(1,-0.004354219);
   mainFit1011->SetParError(1,0.0002310429);
