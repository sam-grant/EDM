...
//=========  (Fri Oct 16 10:31:23 2020) by ROOT version 6.22/02
   ...
   Double_t -30.000000 ppm_fx1085[3] = {
   14.3,
   16.3,
   18.3};
   Double_t -30.000000 ppm_fy1085[3] = {
   -1.832808,
   -1.624366,
   -1.443162};
   Double_t -30.000000 ppm_fex1085[3] = {
   0,
   0,
   0};
   Double_t -30.000000 ppm_fey1085[3] = {
   0.01042751,
   0.01042751,
   0.01042751};
   TGraphErrors *gre = new TGraphErrors(3,-30.000000 ppm_fx1085,-30.000000 ppm_fy1085,-30.000000 ppm_fex1085,-30.000000 ppm_fey1085);
   gre->SetName("-30.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI30dO000000sPppm1085 = new TH1F("Graph_mI30dO000000sPppm1085","",100,13.9,18.7);
   ...
   TF1 *quadLineFit1086 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1086->SetFillColor(19);
   quadLineFit1086->SetFillStyle(0);
   quadLineFit1086->SetLineWidth(2);
   quadLineFit1086->SetChisquare(1.137226);
   ...
   quadLineFit1086->SetParameter(0,-3.221256);
   quadLineFit1086->SetParError(0,0.06039142);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.09741172);
   quadLineFit1086->SetParError(1,0.00368654);
   quadLineFit1086->SetParLimits(1,0,0);
   quadLineFit1086->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1086);
   gre->Draw("ap");
   
   TF1 *quadLineFit1087 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   quadLineFit1087->SetFillColor(19);
   quadLineFit1087->SetFillStyle(0);
   quadLineFit1087->SetLineWidth(2);
   quadLineFit1087->SetChisquare(1.137226);
   ...
   quadLineFit1087->SetParameter(0,-3.221256);
   quadLineFit1087->SetParError(0,0.06039142);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.09741172);
   quadLineFit1087->SetParError(1,0.00368654);
   ...
   TH1F *Graph_mI10dO000000sPppm1087 = new TH1F("Graph_mI10dO000000sPppm1087","Graph",100,13.9,18.7);
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.1859483);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.1361165);
   ...
   TF1 *quadLineFit1088 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1088->SetChisquare(0.3135758);
   ...
   quadLineFit1088->SetParameter(0,-0.2428847);
   quadLineFit1088->SetParError(0,0.06039494);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,0.005167864);
   quadLineFit1088->SetParError(1,0.003686755);
   quadLineFit1088->SetParLimits(1,0,0);
   quadLineFit1088->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1088);
   gre->Draw("p ");
   
   TF1 *quadLineFit1089 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1089->SetChisquare(0.3135758);
   ...
   quadLineFit1089->SetParameter(0,-0.2428847);
   quadLineFit1089->SetParError(0,0.06039494);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,0.005167864);
   quadLineFit1089->SetParError(1,0.003686755);
   quadLineFit1089->SetParLimits(1,0,0);
   quadLineFit1089->Draw("same");
   
   Double_t 10.000000 ppm_fx1089[3] = {
   14.3,
   16.3,
   18.3};
   Double_t 10.000000 ppm_fy1089[3] = {
   1.511105,
   1.326412,
   1.19858};
   Double_t 10.000000 ppm_fex1089[3] = {
   0,
   0,
   0};
   Double_t 10.000000 ppm_fey1089[3] = {
   0.01042751,
   0.01042751,
   0.01042751};
   gre = new TGraphErrors(3,10.000000 ppm_fx1089,10.000000 ppm_fy1089,10.000000 ppm_fex1089,10.000000 ppm_fey1089);
   gre->SetName("10.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10dO000000sPppm1089 = new TH1F("Graph_10dO000000sPppm1089","Graph",100,13.9,18.7);
   Graph_10dO000000sPppm1089->SetMinimum(1.154815);
   Graph_10dO000000sPppm1089->SetMaximum(1.55487);
   ...
   TF1 *quadLineFit1090 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1090->SetChisquare(4.955853);
   ...
   quadLineFit1090->SetParameter(0,2.618903);
   quadLineFit1090->SetParError(0,0.06039375);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.07813114);
   ...
   TF1 *quadLineFit1091 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1091->SetChisquare(4.955853);
   ...
   quadLineFit1091->SetParameter(0,2.618903);
   quadLineFit1091->SetParError(0,0.06039375);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.07813114);
   ...
   0.01042751,
   0.01042751};
   gre = new TGraphErrors(3,30.000000 ppm_fx1091,30.000000 ppm_fy1091,30.000000 ppm_fex1091,30.000000 ppm_fey1091);
   gre->SetName("30.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_30dO000000sPppm1091 = new TH1F("Graph_30dO000000sPppm1091","Graph",100,13.9,18.7);
   Graph_30dO000000sPppm1091->SetMinimum(2.416437);
   Graph_30dO000000sPppm1091->SetMaximum(3.260022);
   ...
   TF1 *quadLineFit1092 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1092->SetChisquare(1.800862);
   ...
   quadLineFit1092->SetParameter(0,5.612205);
   quadLineFit1092->SetParError(0,0.06039472);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1705331);
   quadLineFit1092->SetParError(1,0.003686743);
   quadLineFit1092->SetParLimits(1,0,0);
   quadLineFit1092->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1092);
   gre->Draw("p ");
   
   TF1 *quadLineFit1093 = new TF1("quadLineFit","[0]+[1]*x",13.9,18.7, TF1::EAddToList::kNo);
   ...
   quadLineFit1093->SetChisquare(1.800862);
   ...
   quadLineFit1093->SetParameter(0,5.612205);
   quadLineFit1093->SetParError(0,0.06039472);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1705331);
   quadLineFit1093->SetParError(1,0.003686743);
