...
//=========  (Tue Oct  6 23:07:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1303707,45,0.1767947);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(-0.09965412);
   Graph_Graph01049->SetMaximum(0.1460782);
   ...
   fieldLineFit1050->SetChisquare(0.003130821);
   ...
   fieldLineFit1050->SetParameter(0,0.02330729);
   fieldLineFit1050->SetParError(0,0.002343493);
   fieldLineFit1050->SetParLimits(0,0,0);
   fieldLineFit1050->SetParameter(1,-0.003258059);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.00157}");
   pt_LaTex = pt->AddText("#minus0.00326#pm0.000105");
   pt_LaTex = pt->AddText("0.0233#pm0.00234");
   pt_LaTex = pt->AddText(" 7.15#pm0.755");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.153735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.153735,-0.09965412,7.153735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1051->SetChisquare(0.003130821);
   ...
   fieldLineFit1051->SetParameter(0,0.02330729);
   fieldLineFit1051->SetParError(0,0.002343493);
   fieldLineFit1051->SetParLimits(0,0,0);
   fieldLineFit1051->SetParameter(1,-0.003258059);
