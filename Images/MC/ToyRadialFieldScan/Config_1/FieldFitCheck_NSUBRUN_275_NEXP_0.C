...
//=========  (Fri Oct 16 07:48:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.3708,45,55.29665);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01087->SetMinimum(-29.00406);
   Graph_Graph01087->SetMaximum(45.9299);
   ...
   checkFit1088->SetChisquare(4.272361e-16);
   ...
   checkFit1088->SetParameter(0,8.462922);
   checkFit1088->SetParError(0,0.5900415);
   checkFit1088->SetParLimits(0,0,0);
   checkFit1088->SetParameter(1,1.012935);
   checkFit1088->SetParError(1,0.01966805);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0197");
   pt_LaTex = pt->AddText(" 8.46#pm 0.59");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.354855,-29.00406,-8.354855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1089->SetChisquare(4.272361e-16);
   ...
   checkFit1089->SetParameter(0,8.462922);
   checkFit1089->SetParError(0,0.5900415);
   checkFit1089->SetParLimits(0,0,0);
   checkFit1089->SetParameter(1,1.012935);
   checkFit1089->SetParError(1,0.01966805);
