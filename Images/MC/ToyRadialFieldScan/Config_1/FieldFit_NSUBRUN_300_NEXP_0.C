...
//=========  (Fri Oct 16 07:48:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2009173,45,0.1353089);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.1672947);
   Graph_Graph01093->SetMaximum(0.1016863);
   ...
   mainFit1094->SetChisquare(1.873547e-13);
   ...
   mainFit1094->SetParameter(1,-0.003635572);
   mainFit1094->SetParError(1,7.090542e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00364#pm7.09e-05");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.023112,-0.1672947,-9.023112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(1.873547e-13);
   ...
   mainFit1095->SetParameter(1,-0.003635572);
   mainFit1095->SetParError(1,7.090542e-05);
