...
//=========  (Fri Oct 16 07:48:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2038639,45,0.1450981);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-0.1689677);
   Graph_Graph01061->SetMaximum(0.1102019);
   ...
   mainFit1062->SetChisquare(5.454386e-14);
   ...
   mainFit1062->SetParameter(0,-0.02938294);
   mainFit1062->SetParError(0,0.002606878);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,-0.003754466);
   mainFit1062->SetParError(1,8.689594e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm8.69e-05");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.82613,-0.1689677,-7.82613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(5.454386e-14);
   ...
   mainFit1063->SetParameter(0,-0.02938294);
   mainFit1063->SetParError(0,0.002606878);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,-0.003754466);
   mainFit1063->SetParError(1,8.689594e-05);
