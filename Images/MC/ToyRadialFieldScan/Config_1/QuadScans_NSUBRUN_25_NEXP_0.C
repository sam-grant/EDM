...
//=========  (Fri Oct 16 07:48:15 2020) by ROOT version 6.22/02
   ...
   Graph_30dO000000sPppm1003->SetMinimum(2.166341);
   Graph_30dO000000sPppm1003->SetMaximum(2.917001);
   ...
   quadLineFit1004->SetChisquare(1.218995e-19);
   ...
   quadLineFit1004->SetParameter(0,5.093627);
   quadLineFit1004->SetParError(0,0.1871291);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-0.1417753);
   ...
   quadLineFit1005->SetChisquare(1.218995e-19);
   ...
   quadLineFit1005->SetParameter(0,5.093627);
   quadLineFit1005->SetParError(0,0.1871291);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-0.1417753);
