...
//=========  (Fri Oct 16 07:48:25 2020) by ROOT version 6.22/02
   ...
   quadLineFit1098->SetChisquare(4.427672e-20);
   ...
   quadLineFit1098->SetParameter(0,-2.892296);
   quadLineFit1098->SetParError(0,0.05234493);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.07788318);
   ...
   quadLineFit1099->SetChisquare(4.427672e-20);
   ...
   quadLineFit1099->SetParameter(0,-2.892296);
   quadLineFit1099->SetParError(0,0.05234493);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.07788318);
   ...
   TH1F *Graph_30dO000000sPppm1099 = new TH1F("Graph_30dO000000sPppm1099","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1099->SetMinimum(2.219273);
   Graph_30dO000000sPppm1099->SetMaximum(2.920484);
   ...
   quadLineFit1100->SetChisquare(1.75936e-19);
   ...
   quadLineFit1100->SetParameter(0,5.125847);
   quadLineFit1100->SetParError(0,0.05234493);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,-0.1419982);
   ...
   quadLineFit1101->SetChisquare(1.75936e-19);
   ...
   quadLineFit1101->SetParameter(0,5.125847);
   quadLineFit1101->SetParError(0,0.05234493);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,-0.1419982);
