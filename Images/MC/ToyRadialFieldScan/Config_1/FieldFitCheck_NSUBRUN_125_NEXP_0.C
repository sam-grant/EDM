...
//=========  (Fri Oct 16 07:48:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.19729,45,53.19187);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","Sub-runs 125",100,-36,36);
   Graph_Graph01039->SetMinimum(-28.15838);
   Graph_Graph01039->SetMaximum(44.15295);
   ...
   checkFit1040->SetChisquare(8.715097e-17);
   ...
   checkFit1040->SetParameter(1,0.9630047);
   checkFit1040->SetParError(1,0.02921718);
   ...
   pt_LaTex = pt->AddText("0.963#pm0.0292");
   pt_LaTex = pt->AddText("    8#pm0.877");
   pt_LaTex = pt->AddText(" #minus8.3#pm0.944");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.304517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.304517,-28.15838,-8.304517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(8.715097e-17);
   ...
   checkFit1041->SetParameter(1,0.9630047);
   checkFit1041->SetParError(1,0.02921718);
