...
//=========  (Fri Oct 16 07:48:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2166577,45,0.1506478);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.1799271);
   Graph_Graph01053->SetMaximum(0.1139172);
   ...
   mainFit1054->SetChisquare(4.546414e-16);
   ...
   mainFit1054->SetParameter(0,-0.03300496);
   mainFit1054->SetParError(0,0.002787947);
   mainFit1054->SetParLimits(0,0,0);
   mainFit1054->SetParameter(1,-0.003949747);
   mainFit1054->SetParError(1,9.293157e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00395#pm9.29e-05");
   pt_LaTex = pt->AddText("#minus0.033#pm0.00279");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.356223,-0.1799271,-8.356223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1055->SetChisquare(4.546414e-16);
   ...
   mainFit1055->SetParameter(0,-0.03300496);
   mainFit1055->SetParError(0,0.002787947);
   mainFit1055->SetParLimits(0,0,0);
   mainFit1055->SetParameter(1,-0.003949747);
   mainFit1055->SetParError(1,9.293157e-05);
