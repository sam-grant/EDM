...
//=========  (Fri Oct 16 07:48:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.0031,45,57.53141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","Sub-runs 175",100,-36,36);
   Graph_Graph01055->SetMinimum(-30.24964);
   Graph_Graph01055->SetMaximum(47.77796);
   ...
   TF1 *checkFit1056 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1056->SetChisquare(2.131139e-16);
   ...
   checkFit1056->SetParameter(0,8.764157);
   checkFit1056->SetParError(0,0.7403131);
   checkFit1056->SetParLimits(0,0,0);
   checkFit1056->SetParameter(1,1.048818);
   checkFit1056->SetParError(1,0.0246771);
   ...
   pt_LaTex = pt->AddText(" 1.05#pm0.0247");
   pt_LaTex = pt->AddText(" 8.76#pm 0.74");
   pt_LaTex = pt->AddText("#minus8.36#pm0.733");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.356223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.356223,-30.24964,-8.356223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1057 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1057->SetChisquare(2.131139e-16);
   ...
   checkFit1057->SetParameter(0,8.764157);
   checkFit1057->SetParError(0,0.7403131);
   checkFit1057->SetParLimits(0,0,0);
   checkFit1057->SetParameter(1,1.048818);
   checkFit1057->SetParError(1,0.0246771);
