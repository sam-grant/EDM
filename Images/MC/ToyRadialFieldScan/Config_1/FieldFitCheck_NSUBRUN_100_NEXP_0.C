...
//=========  (Fri Oct 16 07:48:18 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.94013,45,55.2935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-27.71677);
   Graph_Graph01031->SetMaximum(46.07013);
   ...
   checkFit1032->SetChisquare(2.293606e-17);
   ...
   checkFit1032->SetParameter(0,9.176681);
   checkFit1032->SetParError(0,0.9807534);
   checkFit1032->SetParLimits(0,0,0);
   checkFit1032->SetParameter(1,0.9785849);
   checkFit1032->SetParError(1,0.03269178);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.0327");
   pt_LaTex = pt->AddText(" 9.18#pm0.981");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.377501,-27.71677,-9.377501,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(2.293606e-17);
   ...
   checkFit1033->SetParameter(0,9.176681);
   checkFit1033->SetParError(0,0.9807534);
   checkFit1033->SetParLimits(0,0,0);
   checkFit1033->SetParameter(1,0.9785849);
   checkFit1033->SetParError(1,0.03269178);
