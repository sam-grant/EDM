...
//=========  (Fri Oct 16 07:48:19 2020) by ROOT version 6.22/02
   ...
   quadLineFit1042->SetChisquare(1.399127e-19);
   ...
   quadLineFit1042->SetParameter(0,-2.870488);
   quadLineFit1042->SetParError(0,0.07714354);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.0761235);
   ...
   quadLineFit1043->SetChisquare(1.399127e-19);
   ...
   quadLineFit1043->SetParameter(0,-2.870488);
   quadLineFit1043->SetParError(0,0.07714354);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.0761235);
   ...
   Graph_30dO000000sPppm1043->SetMinimum(2.216679);
   Graph_30dO000000sPppm1043->SetMaximum(2.920517);
   ...
   quadLineFit1044->SetChisquare(5.704084e-18);
   ...
   quadLineFit1044->SetParameter(0,5.09956);
   quadLineFit1044->SetParError(0,0.07714354);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.140609);
   ...
   quadLineFit1045->SetChisquare(5.704084e-18);
   ...
   quadLineFit1045->SetParameter(0,5.09956);
   quadLineFit1045->SetParError(0,0.07714354);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.140609);
