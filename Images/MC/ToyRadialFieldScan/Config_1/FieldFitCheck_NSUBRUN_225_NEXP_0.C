...
//=========  (Fri Oct 16 07:48:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.40627,45,53.59155);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-30.10649);
   Graph_Graph01071->SetMaximum(44.29177);
   ...
   checkFit1072->SetChisquare(3.764848e-16);
   ...
   checkFit1072->SetParameter(1,1.00255);
   checkFit1072->SetParError(1,0.02174984);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0217");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.074597,-30.10649,-7.074597,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetChisquare(3.764848e-16);
   ...
   checkFit1073->SetParameter(1,1.00255);
   checkFit1073->SetParError(1,0.02174984);
