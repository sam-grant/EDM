...
//=========  (Fri Oct 16 07:48:24 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1089 = new TH1F("Graph_mI30dO000000sPppm1089","",100,15.6,20.4);
   ...
   quadLineFit1090->SetChisquare(6.042086e-21);
   ...
   quadLineFit1090->SetParameter(0,-2.865994);
   quadLineFit1090->SetParError(0,0.05448195);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,0.07626298);
   ...
   quadLineFit1091->SetChisquare(6.042086e-21);
   ...
   quadLineFit1091->SetParameter(0,-2.865994);
   quadLineFit1091->SetParError(0,0.05448195);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,0.07626298);
   ...
   Graph_30dO000000sPppm1091->SetMinimum(2.218288);
   Graph_30dO000000sPppm1091->SetMaximum(2.919691);
   ...
   quadLineFit1092->SetChisquare(1.476864e-19);
   ...
   quadLineFit1092->SetParameter(0,5.122673);
   quadLineFit1092->SetParError(0,0.05448195);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1418713);
   ...
   quadLineFit1093->SetChisquare(1.476864e-19);
   ...
   quadLineFit1093->SetParameter(0,5.122673);
   quadLineFit1093->SetParError(0,0.05448195);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1418713);
