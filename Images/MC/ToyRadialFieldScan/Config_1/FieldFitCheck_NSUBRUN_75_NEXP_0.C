...
//=========  (Fri Oct 16 07:48:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.13643,45,56.73833);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-30.44895);
   Graph_Graph01023->SetMaximum(47.05085);
   ...
   checkFit1024->SetChisquare(2.511717e-17);
   ...
   checkFit1024->SetParameter(1,1.023307);
   checkFit1024->SetParError(1,0.03753258);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0375");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.111886,-30.44895,-8.111886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(2.511717e-17);
   ...
   checkFit1025->SetParameter(1,1.023307);
   checkFit1025->SetParError(1,0.03753258);
