...
//=========  (Fri Oct 16 07:48:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2011814,45,0.1366959);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.1673937);
   Graph_Graph01045->SetMaximum(0.1029082);
   ...
   mainFit1046->SetChisquare(3.578021e-14);
   ...
   mainFit1046->SetParameter(0,-0.03224273);
   mainFit1046->SetParError(0,0.003011949);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.003612208);
   mainFit1046->SetParError(1,0.0001003983);
   ...
   pt_LaTex = pt->AddText("#minus0.00361#pm0.0001");
   pt_LaTex = pt->AddText("#minus0.0322#pm0.00301");
   pt_LaTex = pt->AddText("#minus8.93#pm 0.87");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.926046,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.926046,-0.1673937,-8.926046,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(3.578021e-14);
   ...
   mainFit1047->SetParameter(0,-0.03224273);
   mainFit1047->SetParError(0,0.003011949);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.003612208);
   mainFit1047->SetParError(1,0.0001003983);
