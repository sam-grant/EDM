...
//=========  (Fri Oct 16 07:48:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.72584,45,54.46483);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-28.50678);
   Graph_Graph01079->SetMaximum(45.24576);
   ...
   checkFit1080->SetChisquare(8.651325e-17);
   ...
   checkFit1080->SetParameter(1,0.9951658);
   checkFit1080->SetParError(1,0.0206298);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.0206");
   pt_LaTex = pt->AddText(" 8.37#pm0.619");
   pt_LaTex = pt->AddText("#minus8.41#pm0.646");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.410147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.410147,-28.50678,-8.410147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(8.651325e-17);
   ...
   checkFit1081->SetParameter(1,0.9951658);
   checkFit1081->SetParError(1,0.0206298);
