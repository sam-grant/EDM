...
//=========  (Fri Oct 16 07:48:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2131325,45,0.1530155);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01005->SetMinimum(-0.1765177);
   Graph_Graph01005->SetMaximum(0.1164007);
   ...
   mainFit1006->SetChisquare(7.315667e-20);
   ...
   mainFit1006->SetParameter(0,-0.0300585);
   mainFit1006->SetParError(0,0.007306165);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,-0.003723895);
   mainFit1006->SetParError(1,0.0002435388);
   ...
   pt_LaTex = pt->AddText("#minus0.00372#pm0.000244");
   pt_LaTex = pt->AddText("#minus0.0301#pm0.00731");
   pt_LaTex = pt->AddText("#minus8.07#pm 2.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.07179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.07179,-0.1765177,-8.07179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(7.315667e-20);
   ...
   mainFit1007->SetParameter(0,-0.0300585);
   mainFit1007->SetParError(0,0.007306165);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,-0.003723895);
   mainFit1007->SetParError(1,0.0002435388);
