...
//=========  (Fri Oct 16 07:48:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-35.93002,45,53.35169);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","Sub-runs 300",100,-36,36);
   Graph_Graph01095->SetMinimum(-27.00185);
   Graph_Graph01095->SetMaximum(44.42352);
   ...
   checkFit1096->SetChisquare(3.357283e-16);
   ...
   checkFit1096->SetParameter(0,8.710838);
   checkFit1096->SetParError(0,0.564848);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9653918);
   checkFit1096->SetParError(1,0.01882827);
   ...
   pt_LaTex = pt->AddText("0.965#pm0.0188");
   pt_LaTex = pt->AddText(" 8.71#pm0.565");
   pt_LaTex = pt->AddText("#minus9.02#pm0.611");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-9.023112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.023112,-27.00185,-9.023112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(3.357283e-16);
   ...
   checkFit1097->SetParameter(0,8.710838);
   checkFit1097->SetParError(0,0.564848);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9653918);
   checkFit1097->SetParError(1,0.01882827);
