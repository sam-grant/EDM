...
//=========  (Fri Oct 16 07:48:19 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2003154,45,0.1400814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(-0.1662757);
   Graph_Graph01037->SetMaximum(0.1060417);
   ...
   mainFit1038->SetChisquare(2.929251e-14);
   ...
   mainFit1038->SetParameter(1,-0.003626582);
   mainFit1038->SetParError(1,0.0001100291);
   ...
   pt_LaTex = pt->AddText("#minus0.00363#pm0.00011");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.304517,-0.1662757,-8.304517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1039->SetChisquare(2.929251e-14);
   ...
   mainFit1039->SetParameter(1,-0.003626582);
   mainFit1039->SetParError(1,0.0001100291);
