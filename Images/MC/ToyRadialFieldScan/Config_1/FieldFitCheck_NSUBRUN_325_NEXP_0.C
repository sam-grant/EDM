...
//=========  (Fri Oct 16 07:48:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.42923,45,53.45438);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01103 = new TH1F("Graph_Graph01103","Sub-runs 325",100,-36,36);
   Graph_Graph01103->SetMinimum(-27.44087);
   Graph_Graph01103->SetMaximum(44.46602);
   ...
   TF1 *checkFit1104 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1104->SetChisquare(1.17001e-17);
   ...
   checkFit1104->SetParameter(0,8.512576);
   checkFit1104->SetParError(0,0.5426922);
   checkFit1104->SetParLimits(0,0,0);
   checkFit1104->SetParameter(1,0.973124);
   checkFit1104->SetParError(1,0.01808974);
   ...
   pt_LaTex = pt->AddText("0.973#pm0.0181");
   pt_LaTex = pt->AddText(" 8.51#pm0.543");
   pt_LaTex = pt->AddText("#minus8.75#pm0.581");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.747679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.747679,-27.44087,-8.747679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1105 = new TF1("checkFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   checkFit1105->SetChisquare(1.17001e-17);
   ...
   checkFit1105->SetParameter(0,8.512576);
   checkFit1105->SetParError(0,0.5426922);
   checkFit1105->SetParLimits(0,0,0);
   checkFit1105->SetParameter(1,0.973124);
   checkFit1105->SetParError(1,0.01808974);
