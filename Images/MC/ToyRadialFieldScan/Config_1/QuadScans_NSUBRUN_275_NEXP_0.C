...
//=========  (Thu Oct 15 00:28:26 2020) by ROOT version 6.22/02
   ...
   quadLineFit1122->SetChisquare(2.249524e-20);
   ...
   quadLineFit1122->SetParameter(0,-2.992783);
   quadLineFit1122->SetParError(0,0.05691197);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,0.08305289);
   ...
   quadLineFit1123->SetChisquare(2.249524e-20);
   ...
   quadLineFit1123->SetParameter(0,-2.992783);
   quadLineFit1123->SetParError(0,0.05691197);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,0.08305289);
   ...
   Graph_mI10dO000000sPppm1123->SetMinimum(-0.1679366);
   Graph_mI10dO000000sPppm1123->SetMaximum(-0.1070905);
   ...
   quadLineFit1124->SetChisquare(1.598651e-21);
   ...
   quadLineFit1124->SetParameter(0,-0.2856928);
   quadLineFit1124->SetParError(0,0.05691197);
   quadLineFit1124->SetParLimits(0,0,0);
   quadLineFit1124->SetParameter(1,0.00823218);
   ...
   quadLineFit1125->SetChisquare(1.598651e-21);
   ...
   quadLineFit1125->SetParameter(0,-0.2856928);
   quadLineFit1125->SetParError(0,0.05691197);
   quadLineFit1125->SetParLimits(0,0,0);
   quadLineFit1125->SetParameter(1,0.00823218);
   ...
   Graph_10dO000000sPppm1125->SetMinimum(1.042779);
   Graph_10dO000000sPppm1125->SetMaximum(1.39032);
   ...
   quadLineFit1126->SetChisquare(8.979867e-20);
   ...
   quadLineFit1126->SetParameter(0,2.439835);
   quadLineFit1126->SetParError(0,0.05691197);
   quadLineFit1126->SetParLimits(0,0,0);
   quadLineFit1126->SetParameter(1,-0.06796031);
   ...
   quadLineFit1127->SetChisquare(8.979867e-20);
   ...
   quadLineFit1127->SetParameter(0,2.439835);
   quadLineFit1127->SetParError(0,0.05691197);
   quadLineFit1127->SetParLimits(0,0,0);
   quadLineFit1127->SetParameter(1,-0.06796031);
   ...
   Graph_30dO000000sPppm1127->SetMinimum(2.211601);
   Graph_30dO000000sPppm1127->SetMaximum(2.923109);
   ...
   quadLineFit1128->SetChisquare(3.038875e-19);
   ...
   quadLineFit1128->SetParameter(0,5.155516);
   quadLineFit1128->SetParError(0,0.05691197);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,-0.1437867);
   ...
   quadLineFit1129->SetChisquare(3.038875e-19);
   ...
   quadLineFit1129->SetParameter(0,5.155516);
   quadLineFit1129->SetParError(0,0.05691197);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,-0.1437867);
