...
//=========  (Fri Oct 16 07:48:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2051092,45,0.1420719);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-0.1703911);
   Graph_Graph01077->SetMaximum(0.1073537);
   ...
   mainFit1078->SetChisquare(3.972194e-13);
   ...
   mainFit1078->SetParameter(1,-0.003747698);
   mainFit1078->SetParError(1,7.768981e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm7.77e-05");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.410147,-0.1703911,-8.410147,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(3.972194e-13);
   ...
   mainFit1079->SetParameter(1,-0.003747698);
   mainFit1079->SetParError(1,7.768981e-05);
