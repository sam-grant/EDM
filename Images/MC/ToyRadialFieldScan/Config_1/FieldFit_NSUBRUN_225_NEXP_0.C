...
//=========  (Fri Oct 16 07:48:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2018206,45,0.1484002);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.1667985);
   Graph_Graph01069->SetMaximum(0.1133781);
   ...
   mainFit1070->SetChisquare(3.677142e-14);
   ...
   mainFit1070->SetParameter(0,-0.02671019);
   mainFit1070->SetParError(0,0.002457233);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.003775507);
   mainFit1070->SetParError(1,8.190777e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00378#pm8.19e-05");
   pt_LaTex = pt->AddText("#minus0.0267#pm0.00246");
   pt_LaTex = pt->AddText("#minus7.07#pm0.669");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.074597,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.074597,-0.1667985,-7.074597,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(3.677142e-14);
   ...
   mainFit1071->SetParameter(0,-0.02671019);
   mainFit1071->SetParError(0,0.002457233);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.003775507);
   mainFit1071->SetParError(1,8.190777e-05);
