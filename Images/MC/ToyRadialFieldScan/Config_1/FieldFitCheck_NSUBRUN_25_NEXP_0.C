...
//=========  (Fri Oct 16 07:48:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-40.63182,45,56.59532);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-30.90911);
   Graph_Graph01007->SetMaximum(46.87261);
   ...
   checkFit1008->SetChisquare(1.443716e-16);
   ...
   checkFit1008->SetParameter(1,0.9888452);
   checkFit1008->SetParError(1,0.06466944);
   ...
   pt_LaTex = pt->AddText("0.989#pm0.0647");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.07179,-30.90911,-8.07179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(1.443716e-16);
   ...
   checkFit1009->SetParameter(1,0.9888452);
   checkFit1009->SetParError(1,0.06466944);
