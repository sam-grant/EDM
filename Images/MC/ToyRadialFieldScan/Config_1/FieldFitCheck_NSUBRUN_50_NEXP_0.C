...
//=========  (Fri Oct 16 07:48:16 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.01949,45,54.03634);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-27.91391);
   Graph_Graph01015->SetMaximum(44.93076);
   ...
   checkFit1016->SetChisquare(6.816099e-17);
   ...
   checkFit1016->SetParameter(1,0.9468263);
   checkFit1016->SetParError(1,0.04589491);
   ...
   pt_LaTex = pt->AddText("0.947#pm0.0459");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.986258,-27.91391,-8.986258,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(6.816099e-17);
   ...
   checkFit1017->SetParameter(1,0.9468263);
   checkFit1017->SetParError(1,0.04589491);
