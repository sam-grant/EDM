...
//=========  (Fri Oct 16 07:48:18 2020) by ROOT version 6.22/02
   ...
   quadLineFit1026->SetChisquare(2.299139e-20);
   ...
   quadLineFit1026->SetParameter(0,-2.843017);
   quadLineFit1026->SetParError(0,0.09459776);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.07599918);
   ...
   quadLineFit1027->SetChisquare(2.299139e-20);
   ...
   quadLineFit1027->SetParameter(0,-2.843017);
   quadLineFit1027->SetParError(0,0.09459776);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.07599918);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(2.214591);
   Graph_30dO000000sPppm1027->SetMaximum(2.946605);
   ...
   quadLineFit1028->SetChisquare(1.034088e-20);
   ...
   quadLineFit1028->SetParameter(0,5.192689);
   quadLineFit1028->SetParError(0,0.09459776);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.1451162);
   ...
   quadLineFit1029->SetChisquare(1.034088e-20);
   ...
   quadLineFit1029->SetParameter(0,5.192689);
   quadLineFit1029->SetParError(0,0.09459776);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.1451162);
