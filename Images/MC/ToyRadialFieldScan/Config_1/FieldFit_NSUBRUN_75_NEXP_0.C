...
//=========  (Fri Oct 16 07:48:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.213671,45,0.1511499);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.1771889);
   Graph_Graph01021->SetMaximum(0.1146678);
   ...
   mainFit1022->SetChisquare(1.737005e-19);
   ...
   mainFit1022->SetParameter(0,-0.03126057);
   mainFit1022->SetParError(0,0.004240321);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.003853675);
   mainFit1022->SetParError(1,0.000141344);
   ...
   pt_LaTex = pt->AddText("#minus0.00385#pm0.000141");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00424");
   pt_LaTex = pt->AddText("#minus8.11#pm 1.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.111886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.111886,-0.1771889,-8.111886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(1.737005e-19);
   ...
   mainFit1023->SetParameter(0,-0.03126057);
   mainFit1023->SetParError(0,0.004240321);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.003853675);
   mainFit1023->SetParError(1,0.000141344);
