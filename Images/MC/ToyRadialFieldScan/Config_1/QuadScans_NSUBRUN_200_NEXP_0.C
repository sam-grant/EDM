...
//=========  (Thu Oct 15 00:28:23 2020) by ROOT version 6.22/02
   ...
   quadLineFit1086->SetChisquare(1.003237e-20);
   ...
   quadLineFit1086->SetParameter(0,-2.9354);
   quadLineFit1086->SetParError(0,0.06676866);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.07989951);
   ...
   quadLineFit1087->SetChisquare(1.003237e-20);
   ...
   quadLineFit1087->SetParameter(0,-2.9354);
   quadLineFit1087->SetParError(0,0.06676866);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.07989951);
   ...
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.1641715);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.09667553);
   ...
   quadLineFit1088->SetChisquare(1.620349e-21);
   ...
   quadLineFit1088->SetParameter(0,-0.2896856);
   quadLineFit1088->SetParError(0,0.06676866);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,0.008847895);
   ...
   quadLineFit1089->SetChisquare(1.620349e-21);
   ...
   quadLineFit1089->SetParameter(0,-0.2896856);
   quadLineFit1089->SetParError(0,0.06676866);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,0.008847895);
   ...
   Graph_10dO000000sPppm1089->SetMinimum(1.028913);
   Graph_10dO000000sPppm1089->SetMaximum(1.396993);
   ...
   quadLineFit1090->SetChisquare(5.552159e-21);
   ...
   quadLineFit1090->SetParameter(0,2.499408);
   quadLineFit1090->SetParError(0,0.06676866);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.07146971);
   ...
   quadLineFit1091->SetChisquare(5.552159e-21);
   ...
   quadLineFit1091->SetParameter(0,2.499408);
   quadLineFit1091->SetParError(0,0.06676866);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.07146971);
   ...
   Graph_30dO000000sPppm1091->SetMinimum(2.217928);
   Graph_30dO000000sPppm1091->SetMaximum(2.937965);
   ...
   quadLineFit1092->SetChisquare(3.032504e-20);
   ...
   quadLineFit1092->SetParameter(0,5.184239);
   quadLineFit1092->SetParError(0,0.06676866);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.144794);
   ...
   quadLineFit1093->SetChisquare(3.032504e-20);
   ...
   quadLineFit1093->SetParameter(0,5.184239);
   quadLineFit1093->SetParError(0,0.06676866);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.144794);
