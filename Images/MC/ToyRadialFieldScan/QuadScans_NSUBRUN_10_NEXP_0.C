void QuadScans_NSUBRUN_10_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.149906,0.0768254,3.919882);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1001->SetMinimum(-2.442927);
   Graph_30dO000000sPppm1001->SetMaximum(3.212903);
   ...
   quadLineFit1002->SetChisquare(7.761775e-20);
   ...
   quadLineFit1002->SetParameter(0,-0.00118974);
   quadLineFit1002->SetParError(0,0.2740157);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.28721);
   quadLineFit1002->SetParError(1,4.282421);
   ...
   quadLineFit1003->SetChisquare(7.761775e-20);
   ...
   quadLineFit1003->SetParameter(0,-0.00118974);
   quadLineFit1003->SetParError(0,0.2740157);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.28721);
   quadLineFit1003->SetParError(1,4.282421);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-2.054977);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.424139);
   ...
   quadLineFit1004->SetChisquare(2.470889e-22);
   ...
   quadLineFit1004->SetParameter(0,-0.02128748);
   quadLineFit1004->SetParError(0,0.2740157);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-27.06276);
   quadLineFit1004->SetParError(1,4.282421);
   ...
   quadLineFit1005->SetChisquare(2.470889e-22);
   ...
   quadLineFit1005->SetParameter(0,-0.02128748);
   quadLineFit1005->SetParError(0,0.2740157);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-27.06276);
   quadLineFit1005->SetParError(1,4.282421);
