...
//=========  (Mon Oct 12 20:04:27 2020) by ROOT version 6.22/02
   ...
   quadLineFit1112->SetChisquare(2.251197e-20);
   ...
   quadLineFit1112->SetParameter(0,-3.001745);
   quadLineFit1112->SetParError(0,0.05448195);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.08435982);
   ...
   quadLineFit1113->SetChisquare(2.251197e-20);
   ...
   quadLineFit1113->SetParameter(0,-3.001745);
   quadLineFit1113->SetParError(0,0.05448195);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.08435982);
   ...
   Graph_mI10dO000000sPppm1113->SetMinimum(-0.1680891);
   Graph_mI10dO000000sPppm1113->SetMaximum(-0.1231142);
   ...
   quadLineFit1114->SetChisquare(3.289136e-22);
   ...
   quadLineFit1114->SetParameter(0,-0.2376796);
   quadLineFit1114->SetParError(0,0.05448195);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.005115445);
   ...
   quadLineFit1115->SetChisquare(3.289136e-22);
   ...
   quadLineFit1115->SetParameter(0,-0.2376796);
   quadLineFit1115->SetParError(0,0.05448195);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.005115445);
   ...
   Graph_10dO000000sPppm1115->SetMinimum(1.04576);
   Graph_10dO000000sPppm1115->SetMaximum(1.394279);
   ...
   quadLineFit1116->SetChisquare(1.688371e-21);
   ...
   quadLineFit1116->SetParameter(0,2.450388);
   quadLineFit1116->SetParError(0,0.05448195);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.06835381);
   ...
   quadLineFit1117->SetChisquare(1.688371e-21);
   ...
   quadLineFit1117->SetParameter(0,2.450388);
   quadLineFit1117->SetParError(0,0.05448195);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.06835381);
   ...
   Graph_30dO000000sPppm1117->SetMinimum(2.230864);
   Graph_30dO000000sPppm1117->SetMaximum(2.930139);
   ...
   quadLineFit1118->SetChisquare(4.71131e-19);
   ...
   quadLineFit1118->SetParameter(0,5.126206);
   quadLineFit1118->SetParError(0,0.05448195);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.141428);
   ...
   quadLineFit1119->SetChisquare(4.71131e-19);
   ...
   quadLineFit1119->SetParameter(0,5.126206);
   quadLineFit1119->SetParError(0,0.05448195);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.141428);
