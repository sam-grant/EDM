...
//=========  (Thu Oct  8 17:32:51 2020) by ROOT version 6.22/02
   ...
   quadLineFit1112->SetChisquare(3.448552e-19);
   ...
   quadLineFit1112->SetParameter(0,-3.461489);
   quadLineFit1112->SetParError(0,0.05448195);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.09860975);
   ...
   quadLineFit1113->SetChisquare(3.448552e-19);
   ...
   quadLineFit1113->SetParameter(0,-3.461489);
   quadLineFit1113->SetParError(0,0.05448195);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.09860975);
   ...
   Graph_mI10dO000000sPppm1113->SetMinimum(-0.6452059);
   Graph_mI10dO000000sPppm1113->SetMaximum(-0.472021);
   ...
   quadLineFit1114->SetChisquare(3.401354e-20);
   ...
   quadLineFit1114->SetParameter(0,-1.131479);
   quadLineFit1114->SetParError(0,0.05448195);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.03182587);
   ...
   quadLineFit1115->SetChisquare(3.401354e-20);
   ...
   quadLineFit1115->SetParameter(0,-1.131479);
   quadLineFit1115->SetParError(0,0.05448195);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.03182587);
   ...
   Graph_10dO000000sPppm1115->SetMinimum(0.4836525);
   Graph_10dO000000sPppm1115->SetMaximum(0.6656072);
   ...
   quadLineFit1116->SetChisquare(8.313086e-21);
   ...
   quadLineFit1116->SetParameter(0,1.180382);
   quadLineFit1116->SetParError(0,0.05448195);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.0336529);
   ...
   quadLineFit1117->SetChisquare(8.313086e-21);
   ...
   quadLineFit1117->SetParameter(0,1.180382);
   quadLineFit1117->SetParError(0,0.05448195);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.0336529);
   ...
   Graph_30dO000000sPppm1117->SetMinimum(1.438329);
   Graph_30dO000000sPppm1117->SetMaximum(1.926129);
   ...
   quadLineFit1118->SetChisquare(1.01293e-19);
   ...
   quadLineFit1118->SetParameter(0,3.4349);
   quadLineFit1118->SetParError(0,0.05448195);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.09737064);
   ...
   quadLineFit1119->SetChisquare(1.01293e-19);
   ...
   quadLineFit1119->SetParameter(0,3.4349);
   quadLineFit1119->SetParError(0,0.05448195);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.09737064);
