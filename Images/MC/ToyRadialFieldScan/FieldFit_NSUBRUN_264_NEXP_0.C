...
//=========  (Wed Jan  5 17:36:10 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01029->SetMinimum(-34.4774);
   Graph_Graph01029->SetMaximum(55.13292);
   ...
   mainFit1030->SetChisquare(2.403882e-12);
   ...
   mainFit1030->SetParameter(0,10.32776);
   mainFit1030->SetParError(0,0.5726479);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.217593);
   mainFit1030->SetParError(1,0.01908826);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.482112,-34.4774,-8.482112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.403882e-12);
   ...
   mainFit1031->SetParameter(0,10.32776);
   mainFit1031->SetParError(0,0.5726479);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.217593);
   mainFit1031->SetParError(1,0.01908826);
