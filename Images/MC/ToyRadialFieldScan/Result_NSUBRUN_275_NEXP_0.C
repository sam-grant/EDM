...
//=========  (Thu Oct  8 17:32:50 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01109->SetMinimum(-0.1128632);
   Graph_Graph01109->SetMaximum(0.1150631);
   ...
   fieldLineFit1110->SetChisquare(1.794401);
   ...
   fieldLineFit1110->SetParameter(0,-0.0009944939);
   fieldLineFit1110->SetParError(0,0.001571219);
   fieldLineFit1110->SetParLimits(0,0,0);
   fieldLineFit1110->SetParameter(1,-0.003057804);
   fieldLineFit1110->SetParError(1,7.026704e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00306#pm7.03e-05");
   pt_LaTex = pt->AddText("-0.000994#pm0.00157");
   pt_LaTex = pt->AddText("-0.325#pm-0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-0.3252315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3252315,-0.1128632,-0.3252315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1111->SetChisquare(1.794401);
   ...
   fieldLineFit1111->SetParameter(0,-0.0009944939);
   fieldLineFit1111->SetParError(0,0.001571219);
   fieldLineFit1111->SetParLimits(0,0,0);
   fieldLineFit1111->SetParameter(1,-0.003057804);
   fieldLineFit1111->SetParError(1,7.026704e-05);
