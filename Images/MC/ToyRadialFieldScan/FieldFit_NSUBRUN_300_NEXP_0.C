...
//=========  (Mon Oct 12 12:24:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.20035,45,0.1405018);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01119->SetMinimum(-0.1662649);
   Graph_Graph01119->SetMaximum(0.1064166);
   ...
   fieldLineFit1120->SetChisquare(0.2511934);
   ...
   fieldLineFit1120->SetParameter(0,-0.02943324);
   fieldLineFit1120->SetParError(0,0.001504131);
   fieldLineFit1120->SetParLimits(0,0,0);
   fieldLineFit1120->SetParameter(1,-0.003695496);
   ...
   pt_LaTex = pt->AddText("#minus0.0037#pm6.73e-05");
   pt_LaTex = pt->AddText("#minus0.0294#pm0.0015");
   pt_LaTex = pt->AddText("#minus7.96#pm0.407");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.964625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.964625,-0.1662649,-7.964625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1121->SetChisquare(0.2511934);
   ...
   fieldLineFit1121->SetParameter(0,-0.02943324);
   fieldLineFit1121->SetParError(0,0.001504131);
   fieldLineFit1121->SetParLimits(0,0,0);
   fieldLineFit1121->SetParameter(1,-0.003695496);
