...
//=========  (Mon Jan 10 15:42:36 2022) by ROOT version 6.24/06
   ...
   c->Range(-75,-83.71425,75,101.7314);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01189->SetMinimum(-65.16968);
   Graph_Graph01189->SetMaximum(83.18685);
   ...
   Graph_Graph01189->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   mainFit1190->SetChisquare(4.117653);
   ...
   mainFit1190->SetParameter(0,9.374015);
   mainFit1190->SetParError(0,0.25211);
   mainFit1190->SetParLimits(0,0,0);
   mainFit1190->SetParameter(1,1.207412);
   mainFit1190->SetParError(1,0.007953432);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.763728,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.763728,-65.16968,-7.763728,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1191->SetChisquare(4.117653);
   ...
   mainFit1191->SetParameter(0,9.374015);
   mainFit1191->SetParError(0,0.25211);
   mainFit1191->SetParLimits(0,0,0);
   mainFit1191->SetParameter(1,1.207412);
   mainFit1191->SetParError(1,0.007953432);
