...
//=========  (Tue Nov 10 15:16:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-81.70726,75,101.5035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01189->SetMinimum(-63.38618);
   Graph_Graph01189->SetMaximum(83.18242);
   ...
   mainFit1190->SetChisquare(5.935673);
   ...
   mainFit1190->SetParameter(0,9.953952);
   mainFit1190->SetParError(0,0.2168631);
   mainFit1190->SetParLimits(0,0,0);
   mainFit1190->SetParameter(1,1.206673);
   mainFit1190->SetParError(1,0.006349173);
   ...
   pt_LaTex = pt->AddText(" 1.21#pm0.00635");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.249089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.249089,-63.38618,-8.249089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1191->SetChisquare(5.935673);
   ...
   mainFit1191->SetParameter(0,9.953952);
   mainFit1191->SetParError(0,0.2168631);
   mainFit1191->SetParLimits(0,0,0);
   mainFit1191->SetParameter(1,1.206673);
   mainFit1191->SetParError(1,0.006349173);
