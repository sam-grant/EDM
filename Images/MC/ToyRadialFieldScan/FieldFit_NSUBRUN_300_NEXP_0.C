...
//=========  (Wed Jan  5 17:07:03 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-46.53199,45,67.16482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-35.1623);
   Graph_Graph01093->SetMaximum(55.79514);
   ...
   mainFit1094->SetChisquare(2.58087e-14);
   ...
   mainFit1094->SetParameter(1,1.237987);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.333222,-35.1623,-8.333222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(2.58087e-14);
   ...
   mainFit1095->SetParameter(1,1.237987);
