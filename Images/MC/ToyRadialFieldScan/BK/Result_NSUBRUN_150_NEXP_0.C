...
//=========  (Wed Oct  7 18:21:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.114499,45,0.165652);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(-0.08648393);
   Graph_Graph01059->SetMaximum(0.1376369);
   ...
   fieldLineFit1060->SetChisquare(0.0002971401);
   ...
   fieldLineFit1060->SetParameter(0,0.02561179);
   fieldLineFit1060->SetParError(0,0.002136841);
   fieldLineFit1060->SetParLimits(0,0,0);
   fieldLineFit1060->SetParameter(1,-0.002970488);
   fieldLineFit1060->SetParError(1,9.556245e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.000149}");
   pt_LaTex = pt->AddText("#minus0.00297#pm9.56e-05");
   pt_LaTex = pt->AddText("0.0256#pm0.00214");
   pt_LaTex = pt->AddText(" 8.62#pm0.771");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,8.622081,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8.622081,-0.08648393,8.622081,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1061->SetChisquare(0.0002971401);
   ...
   fieldLineFit1061->SetParameter(0,0.02561179);
   fieldLineFit1061->SetParError(0,0.002136841);
   fieldLineFit1061->SetParLimits(0,0,0);
   fieldLineFit1061->SetParameter(1,-0.002970488);
   fieldLineFit1061->SetParError(1,9.556245e-05);
