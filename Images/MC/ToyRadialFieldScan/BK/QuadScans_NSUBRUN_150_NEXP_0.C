...
//=========  (Wed Oct  7 18:21:00 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1051->SetMinimum(-3);
   Graph_mI30dO000000sPppm1051->SetMaximum(2);
   ...
   quadLineFit1052->SetChisquare(2.473151e-19);
   ...
   quadLineFit1052->SetParameter(0,-4.214334);
   quadLineFit1052->SetParError(0,0.07739969);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.1146865);
   quadLineFit1052->SetParError(1,0.004273683);
   ...
   quadLineFit1053->SetChisquare(2.473151e-19);
   ...
   quadLineFit1053->SetParameter(0,-4.214334);
   quadLineFit1053->SetParError(0,0.07739969);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.1146865);
   quadLineFit1053->SetParError(1,0.004273683);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-1.155498);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.86073);
   ...
   quadLineFit1054->SetChisquare(1.241729e-20);
   ...
   quadLineFit1054->SetParameter(0,-2.004702);
   quadLineFit1054->SetParError(0,0.07739968);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,0.05536601);
   quadLineFit1054->SetParError(1,0.004273683);
   ...
   quadLineFit1055->SetChisquare(1.241729e-20);
   ...
   quadLineFit1055->SetParameter(0,-2.004702);
   quadLineFit1055->SetParError(0,0.07739968);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,0.05536601);
   quadLineFit1055->SetParError(1,0.004273683);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(0.08753747);
   Graph_10dO000000sPppm1055->SetMaximum(0.1360927);
   ...
   quadLineFit1056->SetChisquare(1.454973e-22);
   ...
   quadLineFit1056->SetParameter(0,0.1851072);
   quadLineFit1056->SetParError(0,0.07739969);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.004071781);
   quadLineFit1056->SetParError(1,0.004273683);
   ...
   quadLineFit1057->SetChisquare(1.454973e-22);
   ...
   quadLineFit1057->SetParameter(0,0.1851072);
   quadLineFit1057->SetParError(0,0.07739969);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.004071781);
   quadLineFit1057->SetParError(1,0.004273683);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(1.069643);
   Graph_30dO000000sPppm1057->SetMaximum(1.403614);
   ...
   quadLineFit1058->SetChisquare(2.364985e-18);
   ...
   quadLineFit1058->SetParameter(0,2.380232);
   quadLineFit1058->SetParError(0,0.07739969);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,-0.06353351);
   quadLineFit1058->SetParError(1,0.004273683);
   ...
   quadLineFit1059->SetChisquare(2.364985e-18);
   ...
   quadLineFit1059->SetParameter(0,2.380232);
   quadLineFit1059->SetParError(0,0.07739969);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,-0.06353351);
   quadLineFit1059->SetParError(1,0.004273683);
