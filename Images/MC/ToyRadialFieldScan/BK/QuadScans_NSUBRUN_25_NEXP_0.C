...
//=========  (Wed Oct  7 18:20:55 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(7.365893e-20);
   ...
   quadLineFit1002->SetParameter(0,-3.86409);
   quadLineFit1002->SetParError(0,0.1909585);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.0948304);
   ...
   quadLineFit1003->SetChisquare(7.365893e-20);
   ...
   quadLineFit1003->SetParameter(0,-3.86409);
   quadLineFit1003->SetParError(0,0.1909585);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.0948304);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-1.225833);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.8165185);
   ...
   quadLineFit1004->SetChisquare(8.931488e-21);
   ...
   quadLineFit1004->SetParameter(0,-2.287702);
   quadLineFit1004->SetParError(0,0.1909585);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.07036254);
   ...
   quadLineFit1005->SetChisquare(8.931488e-21);
   ...
   quadLineFit1005->SetParameter(0,-2.287702);
   quadLineFit1005->SetParError(0,0.1909585);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.07036254);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(0.04957123);
   Graph_10dO000000sPppm1005->SetMaximum(0.2010573);
   ...
   quadLineFit1006->SetChisquare(2.075041e-23);
   ...
   quadLineFit1006->SetParameter(0,0.4249826);
   quadLineFit1006->SetParError(0,0.1909585);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.01664824);
   ...
   quadLineFit1007->SetChisquare(2.075041e-23);
   ...
   quadLineFit1007->SetParameter(0,0.4249826);
   quadLineFit1007->SetParError(0,0.1909585);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.01664824);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(1.023302);
   Graph_30dO000000sPppm1007->SetMaximum(1.49077);
   ...
   quadLineFit1008->SetChisquare(2.63743e-20);
   ...
   quadLineFit1008->SetParameter(0,2.741636);
   quadLineFit1008->SetParError(0,0.1909585);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.08247777);
   ...
   quadLineFit1009->SetChisquare(2.63743e-20);
   ...
   quadLineFit1009->SetParameter(0,2.741636);
   quadLineFit1009->SetParError(0,0.1909585);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.08247777);
