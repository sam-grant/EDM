...
//=========  (Wed Oct  7 18:20:59 2020) by ROOT version 6.22/02
   ...
   quadLineFit1042->SetChisquare(5.433809e-18);
   ...
   quadLineFit1042->SetParameter(0,-4.36666);
   quadLineFit1042->SetParError(0,0.08488494);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.1239986);
   ...
   quadLineFit1043->SetChisquare(5.433809e-18);
   ...
   quadLineFit1043->SetParameter(0,-4.36666);
   quadLineFit1043->SetParError(0,0.08488494);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.1239986);
   ...
   Graph_mI10dO000000sPppm1043->SetMinimum(-1.164171);
   Graph_mI10dO000000sPppm1043->SetMaximum(-0.8692802);
   ...
   quadLineFit1044->SetChisquare(8.761248e-19);
   ...
   quadLineFit1044->SetParameter(0,-2.003257);
   quadLineFit1044->SetParError(0,0.08488494);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,0.05480727);
   ...
   quadLineFit1045->SetChisquare(8.761248e-19);
   ...
   quadLineFit1045->SetParameter(0,-2.003257);
   quadLineFit1045->SetParError(0,0.08488494);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,0.05480727);
   ...
   Graph_10dO000000sPppm1045->SetMinimum(0.06439707);
   Graph_10dO000000sPppm1045->SetMaximum(0.1366683);
   ...
   quadLineFit1046->SetChisquare(1.416307e-22);
   ...
   quadLineFit1046->SetParameter(0,0.2522386);
   quadLineFit1046->SetParError(0,0.08488494);
   quadLineFit1046->SetParLimits(0,0,0);
   quadLineFit1046->SetParameter(1,-0.008428108);
   ...
   quadLineFit1047->SetChisquare(1.416307e-22);
   ...
   quadLineFit1047->SetParameter(0,0.2522386);
   quadLineFit1047->SetParError(0,0.08488494);
   quadLineFit1047->SetParLimits(0,0,0);
   quadLineFit1047->SetParameter(1,-0.008428108);
   ...
   Graph_30dO000000sPppm1047->SetMinimum(1.051219);
   Graph_30dO000000sPppm1047->SetMaximum(1.445967);
   ...
   quadLineFit1048->SetChisquare(6.883793e-19);
   ...
   quadLineFit1048->SetParameter(0,2.609585);
   quadLineFit1048->SetParError(0,0.08488494);
   quadLineFit1048->SetParLimits(0,0,0);
   quadLineFit1048->SetParameter(1,-0.07561066);
   ...
   quadLineFit1049->SetChisquare(6.883793e-19);
   ...
   quadLineFit1049->SetParameter(0,2.609585);
   quadLineFit1049->SetParError(0,0.08488494);
   quadLineFit1049->SetParLimits(0,0,0);
   quadLineFit1049->SetParameter(1,-0.07561066);
