...
//=========  (Wed Oct  7 18:20:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1233601,45,0.1778319);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.09324094);
   Graph_Graph01039->SetMaximum(0.1477127);
   ...
   fieldLineFit1040->SetChisquare(0.1171951);
   ...
   fieldLineFit1040->SetParameter(0,0.02653566);
   fieldLineFit1040->SetParError(0,0.002625222);
   fieldLineFit1040->SetParLimits(0,0,0);
   fieldLineFit1040->SetParameter(1,-0.003163166);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0586}");
   pt_LaTex = pt->AddText("#minus0.00316#pm0.000117");
   pt_LaTex = pt->AddText("0.0265#pm0.00263");
   pt_LaTex = pt->AddText(" 8.39#pm0.886");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,8.388955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8.388955,-0.09324094,8.388955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1041->SetChisquare(0.1171951);
   ...
   fieldLineFit1041->SetParameter(0,0.02653566);
   fieldLineFit1041->SetParError(0,0.002625222);
   fieldLineFit1041->SetParLimits(0,0,0);
   fieldLineFit1041->SetParameter(1,-0.003163166);
