...
//=========  (Wed Oct  7 18:21:04 2020) by ROOT version 6.22/02
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 0");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","Sub-runs 0",100,-36,36);
   Graph_Graph01119->SetMinimum(-0.5117641);
   Graph_Graph01119->SetMaximum(0.5617641);
   ...
   fieldLineFit1120->SetChisquare(3.214814e-21);
   ...
   fieldLineFit1120->SetParameter(0,0.025);
   fieldLineFit1120->SetParError(0,0.1767767);
   fieldLineFit1120->SetParLimits(0,0,0);
   fieldLineFit1120->SetParameter(1,-0.003125);
   fieldLineFit1120->SetParError(1,0.007905694);
   ...
   fieldLineFit1121->SetChisquare(3.214814e-21);
   ...
   fieldLineFit1121->SetParameter(0,0.025);
   fieldLineFit1121->SetParError(0,0.1767767);
   fieldLineFit1121->SetParLimits(0,0,0);
   fieldLineFit1121->SetParameter(1,-0.003125);
   fieldLineFit1121->SetParError(1,0.007905694);
   fieldLineFit1121->SetParLimits(1,0,0);
   fieldLineFit1121->Draw("same");
   
   pt = new TPaveText(0.3951508,0.94,0.6048492,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   pt_LaTex = pt->AddText("Sub-runs 0");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
