...
//=========  (Wed Oct  7 18:20:58 2020) by ROOT version 6.22/02
   ...
   quadLineFit1032->SetChisquare(1.256037e-19);
   ...
   quadLineFit1032->SetParameter(0,-4.332535);
   quadLineFit1032->SetParError(0,0.0950896);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.1223828);
   ...
   quadLineFit1033->SetChisquare(1.256037e-19);
   ...
   quadLineFit1033->SetParameter(0,-4.332535);
   quadLineFit1033->SetParError(0,0.0950896);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.1223828);
   ...
   Graph_mI10dO000000sPppm1033->SetMinimum(-1.15875);
   Graph_mI10dO000000sPppm1033->SetMaximum(-0.850895);
   ...
   quadLineFit1034->SetChisquare(3.936176e-19);
   ...
   quadLineFit1034->SetParameter(0,-2.025626);
   quadLineFit1034->SetParError(0,0.0950896);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.05671127);
   ...
   quadLineFit1035->SetChisquare(3.936176e-19);
   ...
   quadLineFit1035->SetParameter(0,-2.025626);
   quadLineFit1035->SetParError(0,0.0950896);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.05671127);
   ...
   Graph_10dO000000sPppm1035->SetMinimum(0.07869972);
   Graph_10dO000000sPppm1035->SetMaximum(0.1385349);
   ...
   quadLineFit1036->SetChisquare(1.435606e-22);
   ...
   quadLineFit1036->SetParameter(0,0.1993449);
   quadLineFit1036->SetParError(0,0.0950896);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.005040422);
   ...
   quadLineFit1037->SetChisquare(1.435606e-22);
   ...
   quadLineFit1037->SetParameter(0,0.1993449);
   quadLineFit1037->SetParError(0,0.0950896);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.005040422);
   ...
   Graph_30dO000000sPppm1037->SetMinimum(1.037921);
   Graph_30dO000000sPppm1037->SetMaximum(1.399535);
   ...
   quadLineFit1038->SetChisquare(1.684972e-18);
   ...
   quadLineFit1038->SetParameter(0,2.441127);
   quadLineFit1038->SetParError(0,0.0950896);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.06791102);
   ...
   quadLineFit1039->SetChisquare(1.684972e-18);
   ...
   quadLineFit1039->SetParameter(0,2.441127);
   quadLineFit1039->SetParError(0,0.0950896);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.06791102);
