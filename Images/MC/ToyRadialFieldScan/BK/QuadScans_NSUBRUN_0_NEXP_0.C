...
//=========  (Wed Oct  7 18:21:04 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1111->SetMinimum(-3);
   Graph_mI30dO000000sPppm1111->SetMaximum(2);
   ...
   quadLineFit1112->SetChisquare(9.803988e-22);
   ...
   quadLineFit1112->SetParameter(0,-4.275);
   quadLineFit1112->SetParError(0,6.403124);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.11875);
   quadLineFit1112->SetParError(1,0.3535534);
   ...
   quadLineFit1113->SetChisquare(9.803988e-22);
   ...
   quadLineFit1113->SetParameter(0,-4.275);
   quadLineFit1113->SetParError(0,6.403124);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.11875);
   quadLineFit1113->SetParError(1,0.3535534);
   ...
   Graph_mI10dO000000sPppm1113->SetMinimum(-1.1475);
   Graph_mI10dO000000sPppm1113->SetMaximum(-0.8775);
   ...
   quadLineFit1114->SetChisquare(1.272639e-24);
   ...
   quadLineFit1114->SetParameter(0,-2.025);
   quadLineFit1114->SetParError(0,6.403124);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.05625);
   quadLineFit1114->SetParError(1,0.3535534);
   ...
   quadLineFit1115->SetChisquare(1.272639e-24);
   ...
   quadLineFit1115->SetParameter(0,-2.025);
   quadLineFit1115->SetParError(0,6.403124);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.05625);
   quadLineFit1115->SetParError(1,0.3535534);
   ...
   Graph_10dO000000sPppm1115->SetMinimum(0.0975);
   Graph_10dO000000sPppm1115->SetMaximum(0.1275);
   ...
   quadLineFit1116->SetChisquare(2.831271e-28);
   ...
   quadLineFit1116->SetParameter(0,0.225);
   quadLineFit1116->SetParError(0,6.403124);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.00625);
   quadLineFit1116->SetParError(1,0.3535534);
   ...
   quadLineFit1117->SetChisquare(2.831271e-28);
   ...
   quadLineFit1117->SetParameter(0,0.225);
   quadLineFit1117->SetParError(0,6.403124);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.00625);
   quadLineFit1117->SetParError(1,0.3535534);
   ...
   Graph_30dO000000sPppm1117->SetMinimum(1.0725);
   Graph_30dO000000sPppm1117->SetMaximum(1.4025);
   ...
   quadLineFit1118->SetChisquare(1.249575e-25);
   ...
   quadLineFit1118->SetParameter(0,2.475);
   quadLineFit1118->SetParError(0,6.403124);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.06875);
   quadLineFit1118->SetParError(1,0.3535534);
   ...
   quadLineFit1119->SetChisquare(1.249575e-25);
   ...
   quadLineFit1119->SetParameter(0,2.475);
   quadLineFit1119->SetParError(0,6.403124);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.06875);
   quadLineFit1119->SetParError(1,0.3535534);
