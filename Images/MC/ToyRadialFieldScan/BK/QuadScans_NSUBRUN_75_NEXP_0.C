...
//=========  (Wed Oct  7 18:20:57 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1021->SetMinimum(-3);
   Graph_mI30dO000000sPppm1021->SetMaximum(2);
   ...
   quadLineFit1022->SetChisquare(2.100727e-19);
   ...
   quadLineFit1022->SetParameter(0,-4.382863);
   quadLineFit1022->SetParError(0,0.1093346);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.1246077);
   quadLineFit1022->SetParError(1,0.006036995);
   ...
   quadLineFit1023->SetChisquare(2.100727e-19);
   ...
   quadLineFit1023->SetParameter(0,-4.382863);
   quadLineFit1023->SetParError(0,0.1093346);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.1246077);
   quadLineFit1023->SetParError(1,0.006036995);
   ...
   Graph_mI10dO000000sPppm1023->SetMinimum(-1.131488);
   Graph_mI10dO000000sPppm1023->SetMaximum(-0.8576941);
   ...
   quadLineFit1024->SetChisquare(1.612639e-19);
   ...
   quadLineFit1024->SetParameter(0,-1.867642);
   quadLineFit1024->SetParError(0,0.1093346);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,0.04850281);
   quadLineFit1024->SetParError(1,0.006036995);
   ...
   quadLineFit1025->SetChisquare(1.612639e-19);
   ...
   quadLineFit1025->SetParameter(0,-1.867642);
   quadLineFit1025->SetParError(0,0.1093346);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,0.04850281);
   quadLineFit1025->SetParError(1,0.006036995);
   ...
   Graph_10dO000000sPppm1025->SetMinimum(0.09347814);
   Graph_10dO000000sPppm1025->SetMaximum(0.1603635);
   ...
   quadLineFit1026->SetChisquare(7.868629e-21);
   ...
   quadLineFit1026->SetParameter(0,0.2240641);
   quadLineFit1026->SetParError(0,0.1093346);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.00539685);
   quadLineFit1026->SetParError(1,0.006036995);
   ...
   quadLineFit1027->SetChisquare(7.868629e-21);
   ...
   quadLineFit1027->SetParameter(0,0.2240641);
   quadLineFit1027->SetParError(0,0.1093346);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.00539685);
   quadLineFit1027->SetParError(1,0.006036995);
   ...
   Graph_30dO000000sPppm1027->SetMinimum(1.01373);
   Graph_30dO000000sPppm1027->SetMaximum(1.424487);
   ...
   quadLineFit1028->SetChisquare(2.275329e-20);
   ...
   quadLineFit1028->SetParameter(0,2.605774);
   quadLineFit1028->SetParError(0,0.1093346);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.07703696);
   quadLineFit1028->SetParError(1,0.006036995);
   ...
   quadLineFit1029->SetChisquare(2.275329e-20);
   ...
   quadLineFit1029->SetParameter(0,2.605774);
   quadLineFit1029->SetParError(0,0.1093346);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.07703696);
   quadLineFit1029->SetParError(1,0.006036995);
