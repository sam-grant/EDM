...
//=========  (Wed Oct  7 18:20:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1426207,45,0.1549733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.1128613);
   Graph_Graph01009->SetMaximum(0.1252139);
   ...
   fieldLineFit1010->SetChisquare(6.999682);
   ...
   fieldLineFit1010->SetParameter(0,0.01651673);
   fieldLineFit1010->SetParError(0,0.005271958);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.003094676);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  3.5");
   pt_LaTex = pt->AddText("#minus0.00309#pm0.000236");
   pt_LaTex = pt->AddText("0.0165#pm0.00527");
   pt_LaTex = pt->AddText(" 5.34#pm 1.75");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,5.337143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.337143,-0.1128613,5.337143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1011->SetChisquare(6.999682);
   ...
   fieldLineFit1011->SetParameter(0,0.01651673);
   fieldLineFit1011->SetParError(0,0.005271958);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.003094676);
