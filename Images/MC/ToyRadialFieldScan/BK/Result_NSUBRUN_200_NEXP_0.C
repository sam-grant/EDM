...
//=========  (Wed Oct  7 18:21:01 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01079->SetMinimum(-0.08816135);
   Graph_Graph01079->SetMaximum(0.1335925);
   ...
   fieldLineFit1080->SetChisquare(0.1145783);
   ...
   fieldLineFit1080->SetParameter(0,0.02287062);
   fieldLineFit1080->SetParError(0,0.001847971);
   fieldLineFit1080->SetParLimits(0,0,0);
   fieldLineFit1080->SetParameter(1,-0.002947683);
   fieldLineFit1080->SetParError(1,8.264375e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0573}");
   pt_LaTex = pt->AddText("#minus0.00295#pm8.26e-05");
   pt_LaTex = pt->AddText("0.0229#pm0.00185");
   pt_LaTex = pt->AddText(" 7.76#pm0.664");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,7.758846,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(7.758846,-0.08816135,7.758846,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1081->SetChisquare(0.1145783);
   ...
   fieldLineFit1081->SetParameter(0,0.02287062);
   fieldLineFit1081->SetParError(0,0.001847971);
   fieldLineFit1081->SetParLimits(0,0,0);
   fieldLineFit1081->SetParameter(1,-0.002947683);
   fieldLineFit1081->SetParError(1,8.264375e-05);
