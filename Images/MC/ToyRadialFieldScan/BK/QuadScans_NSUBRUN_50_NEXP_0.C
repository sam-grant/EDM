...
//=========  (Wed Oct  7 18:20:56 2020) by ROOT version 6.22/02
   ...
   Graph_mI30dO000000sPppm1011->SetMinimum(-3);
   Graph_mI30dO000000sPppm1011->SetMaximum(2);
   ...
   quadLineFit1012->SetChisquare(1.227536e-20);
   ...
   quadLineFit1012->SetParameter(0,-4.136374);
   quadLineFit1012->SetParError(0,0.1341256);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,0.1126618);
   quadLineFit1012->SetParError(1,0.007405847);
   ...
   quadLineFit1013->SetChisquare(1.227536e-20);
   ...
   quadLineFit1013->SetParameter(0,-4.136374);
   quadLineFit1013->SetParError(0,0.1341256);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,0.1126618);
   quadLineFit1013->SetParError(1,0.007405847);
   ...
   Graph_mI10dO000000sPppm1013->SetMinimum(-1.14701);
   Graph_mI10dO000000sPppm1013->SetMaximum(-0.8201428);
   ...
   quadLineFit1014->SetChisquare(1.468681e-20);
   ...
   quadLineFit1014->SetParameter(0,-2.020806);
   quadLineFit1014->SetParError(0,0.1341256);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.05762389);
   quadLineFit1014->SetParError(1,0.007405848);
   ...
   quadLineFit1015->SetChisquare(1.468681e-20);
   ...
   quadLineFit1015->SetParameter(0,-2.020806);
   quadLineFit1015->SetParError(0,0.1341256);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.05762389);
   quadLineFit1015->SetParError(1,0.007405848);
   ...
   Graph_10dO000000sPppm1015->SetMinimum(0.05318938);
   Graph_10dO000000sPppm1015->SetMaximum(0.1631534);
   ...
   quadLineFit1016->SetChisquare(6.846501e-22);
   ...
   quadLineFit1016->SetParameter(0,0.3320144);
   quadLineFit1016->SetParError(0,0.1341256);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,-0.01243572);
   quadLineFit1016->SetParError(1,0.007405848);
   ...
   quadLineFit1017->SetChisquare(6.846501e-22);
   ...
   quadLineFit1017->SetParameter(0,0.3320144);
   quadLineFit1017->SetParError(0,0.1341256);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,-0.01243572);
   quadLineFit1017->SetParError(1,0.007405848);
   ...
   Graph_30dO000000sPppm1017->SetMinimum(1.022706);
   Graph_30dO000000sPppm1017->SetMaximum(1.433143);
   ...
   quadLineFit1018->SetChisquare(5.077242e-21);
   ...
   quadLineFit1018->SetParameter(0,2.578543);
   quadLineFit1018->SetParError(0,0.1341256);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.07503433);
   quadLineFit1018->SetParError(1,0.007405848);
   ...
   quadLineFit1019->SetChisquare(5.077242e-21);
   ...
   quadLineFit1019->SetParameter(0,2.578543);
   quadLineFit1019->SetParError(0,0.1341256);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.07503433);
   quadLineFit1019->SetParError(1,0.007405848);
