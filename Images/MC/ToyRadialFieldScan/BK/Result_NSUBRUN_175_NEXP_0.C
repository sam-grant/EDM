...
//=========  (Wed Oct  7 18:21:01 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1213502,45,0.1758996);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.0916252);
   Graph_Graph01069->SetMaximum(0.1461747);
   ...
   fieldLineFit1070->SetChisquare(0.743186);
   ...
   fieldLineFit1070->SetParameter(0,0.02648055);
   fieldLineFit1070->SetParError(0,0.001977018);
   fieldLineFit1070->SetParLimits(0,0,0);
   fieldLineFit1070->SetParameter(1,-0.003148495);
   fieldLineFit1070->SetParError(1,8.841491e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.372");
   pt_LaTex = pt->AddText("#minus0.00315#pm8.84e-05");
   pt_LaTex = pt->AddText("0.0265#pm0.00198");
   pt_LaTex = pt->AddText(" 8.41#pm0.671");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,8.410542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(8.410542,-0.0916252,8.410542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1071->SetChisquare(0.743186);
   ...
   fieldLineFit1071->SetParameter(0,0.02648055);
   fieldLineFit1071->SetParError(0,0.001977018);
   fieldLineFit1071->SetParLimits(0,0,0);
   fieldLineFit1071->SetParameter(1,-0.003148495);
   fieldLineFit1071->SetParError(1,8.841491e-05);
