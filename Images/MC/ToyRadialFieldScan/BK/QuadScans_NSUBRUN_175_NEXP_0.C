...
//=========  (Wed Oct  7 18:21:00 2020) by ROOT version 6.22/02
   ...
   quadLineFit1062->SetChisquare(1.105463e-18);
   ...
   quadLineFit1062->SetParameter(0,-4.346546);
   quadLineFit1062->SetParError(0,0.07161062);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.122404);
   ...
   quadLineFit1063->SetChisquare(1.105463e-18);
   ...
   quadLineFit1063->SetParameter(0,-4.346546);
   quadLineFit1063->SetParError(0,0.07161062);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.122404);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-1.151886);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.8603346);
   ...
   quadLineFit1064->SetChisquare(4.070966e-20);
   ...
   quadLineFit1064->SetParameter(0,-1.998776);
   quadLineFit1064->SetParError(0,0.07161062);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.05514811);
   ...
   quadLineFit1065->SetChisquare(4.070966e-20);
   ...
   quadLineFit1065->SetParameter(0,-1.998776);
   quadLineFit1065->SetParError(0,0.07161062);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.05514811);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(0.09959323);
   Graph_10dO000000sPppm1065->SetMaximum(0.1445559);
   ...
   quadLineFit1066->SetChisquare(7.586968e-23);
   ...
   quadLineFit1066->SetParameter(0,0.1900314);
   quadLineFit1066->SetParError(0,0.07161062);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.003775378);
   ...
   quadLineFit1067->SetChisquare(7.586968e-23);
   ...
   quadLineFit1067->SetParameter(0,0.1900314);
   quadLineFit1067->SetParError(0,0.07161062);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.003775378);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(1.061568);
   Graph_30dO000000sPppm1067->SetMaximum(1.41411);
   ...
   quadLineFit1068->SetChisquare(1.425681e-18);
   ...
   quadLineFit1068->SetParameter(0,2.45922);
   quadLineFit1068->SetParError(0,0.07161062);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.06785451);
   ...
   quadLineFit1069->SetChisquare(1.425681e-18);
   ...
   quadLineFit1069->SetParameter(0,2.45922);
   quadLineFit1069->SetParError(0,0.07161062);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.06785451);
