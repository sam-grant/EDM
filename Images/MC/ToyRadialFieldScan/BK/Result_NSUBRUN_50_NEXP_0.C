...
//=========  (Wed Oct  7 18:20:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1330671,45,0.1706947);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01019->SetMinimum(-0.102691);
   Graph_Graph01019->SetMaximum(0.1403185);
   ...
   fieldLineFit1020->SetChisquare(0.7213648);
   ...
   fieldLineFit1020->SetParameter(0,0.02070392);
   fieldLineFit1020->SetParError(0,0.003702924);
   fieldLineFit1020->SetParLimits(0,0,0);
   fieldLineFit1020->SetParameter(1,-0.003165741);
   fieldLineFit1020->SetParError(1,0.0001655998);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.361");
   pt_LaTex = pt->AddText("#minus0.00317#pm0.000166");
   pt_LaTex = pt->AddText("0.0207#pm0.0037");
   pt_LaTex = pt->AddText(" 6.54#pm 1.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,6.539993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(6.539993,-0.102691,6.539993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1021->SetChisquare(0.7213648);
   ...
   fieldLineFit1021->SetParameter(0,0.02070392);
   fieldLineFit1021->SetParError(0,0.003702924);
   fieldLineFit1021->SetParLimits(0,0,0);
   fieldLineFit1021->SetParameter(1,-0.003165741);
   fieldLineFit1021->SetParError(1,0.0001655998);
