...
//=========  (Fri Oct 16 07:52:21 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1013 = new TH1F("Graph_mI30dO000000sPppm1013","",100,15.77,18.53);
   ...
   quadLineFit1014->SetChisquare(9.534903e-20);
   ...
   quadLineFit1014->SetParameter(0,-3.158782);
   quadLineFit1014->SetParError(0,0.2191999);
   quadLineFit1014->SetParLimits(0,0,0);
   quadLineFit1014->SetParameter(1,0.09373583);
   quadLineFit1014->SetParError(1,0.0127527);
   ...
   quadLineFit1015->SetChisquare(9.534903e-20);
   ...
   quadLineFit1015->SetParameter(0,-3.158782);
   quadLineFit1015->SetParError(0,0.2191999);
   quadLineFit1015->SetParLimits(0,0,0);
   quadLineFit1015->SetParameter(1,0.09373583);
   quadLineFit1015->SetParError(1,0.0127527);
   ...
   TH1F *Graph_mI10dO000000sPppm1015 = new TH1F("Graph_mI10dO000000sPppm1015","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1015->SetMinimum(-0.1734037);
   Graph_mI10dO000000sPppm1015->SetMaximum(-0.1230155);
   ...
   quadLineFit1016->SetChisquare(1.022284e-23);
   ...
   quadLineFit1016->SetParameter(0,-0.1520093);
   quadLineFit1016->SetParError(0,0.2191999);
   quadLineFit1016->SetParLimits(0,0,0);
   quadLineFit1016->SetParameter(1,0.0002215549);
   ...
   quadLineFit1017->SetChisquare(1.022284e-23);
   ...
   quadLineFit1017->SetParameter(0,-0.1520093);
   quadLineFit1017->SetParError(0,0.2191999);
   quadLineFit1017->SetParLimits(0,0,0);
   quadLineFit1017->SetParameter(1,0.0002215549);
   ...
   TH1F *Graph_10dO000000sPppm1017 = new TH1F("Graph_10dO000000sPppm1017","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1017->SetMinimum(1.199308);
   Graph_10dO000000sPppm1017->SetMaximum(1.40023);
   ...
   quadLineFit1018->SetChisquare(8.22572e-21);
   ...
   quadLineFit1018->SetParameter(0,2.238955);
   quadLineFit1018->SetParError(0,0.2191999);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,-0.05476304);
   ...
   quadLineFit1019->SetChisquare(8.22572e-21);
   ...
   quadLineFit1019->SetParameter(0,2.238955);
   quadLineFit1019->SetParError(0,0.2191999);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,-0.05476304);
   ...
   TH1F *Graph_30dO000000sPppm1019 = new TH1F("Graph_30dO000000sPppm1019","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1019->SetMinimum(2.43321);
   Graph_30dO000000sPppm1019->SetMaximum(2.951509);
   ...
   quadLineFit1020->SetChisquare(2.877589e-18);
   ...
   quadLineFit1020->SetParameter(0,5.603647);
   quadLineFit1020->SetParError(0,0.2191999);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.1697544);
   ...
   quadLineFit1021->SetChisquare(2.877589e-18);
   ...
   quadLineFit1021->SetParameter(0,5.603647);
   quadLineFit1021->SetParError(0,0.2191999);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.1697544);
