...
//=========  (Fri Oct 16 07:52:23 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1037 = new TH1F("Graph_mI30dO000000sPppm1037","",100,15.77,18.53);
   ...
   quadLineFit1038->SetChisquare(1.231513e-18);
   ...
   quadLineFit1038->SetParameter(0,-3.217837);
   quadLineFit1038->SetParError(0,0.1561401);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.09662319);
   quadLineFit1038->SetParError(1,0.009083978);
   ...
   quadLineFit1039->SetChisquare(1.231513e-18);
   ...
   quadLineFit1039->SetParameter(0,-3.217837);
   quadLineFit1039->SetParError(0,0.1561401);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.09662319);
   quadLineFit1039->SetParError(1,0.009083978);
   ...
   TH1F *Graph_mI10dO000000sPppm1039 = new TH1F("Graph_mI10dO000000sPppm1039","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1039->SetMinimum(-0.1819693);
   Graph_mI10dO000000sPppm1039->SetMaximum(-0.1158603);
   ...
   quadLineFit1040->SetChisquare(4.504413e-20);
   ...
   quadLineFit1040->SetParameter(0,0.04155079);
   quadLineFit1040->SetParError(0,0.1561401);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,-0.01110587);
   quadLineFit1040->SetParError(1,0.009083978);
   ...
   quadLineFit1041->SetChisquare(4.504413e-20);
   ...
   quadLineFit1041->SetParameter(0,0.04155079);
   quadLineFit1041->SetParError(0,0.1561401);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,-0.01110587);
   quadLineFit1041->SetParError(1,0.009083978);
   ...
   TH1F *Graph_10dO000000sPppm1041 = new TH1F("Graph_10dO000000sPppm1041","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1041->SetMinimum(1.157304);
   Graph_10dO000000sPppm1041->SetMaximum(1.364381);
   ...
   quadLineFit1042->SetChisquare(6.207654e-18);
   ...
   quadLineFit1042->SetParameter(0,2.327253);
   quadLineFit1042->SetParError(0,0.1561401);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.0621814);
   quadLineFit1042->SetParError(1,0.009083978);
   ...
   quadLineFit1043->SetChisquare(6.207654e-18);
   ...
   quadLineFit1043->SetParameter(0,2.327253);
   quadLineFit1043->SetParError(0,0.1561401);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.0621814);
   quadLineFit1043->SetParError(1,0.009083978);
   ...
   Graph_30dO000000sPppm1043->SetMinimum(2.465764);
   Graph_30dO000000sPppm1043->SetMaximum(2.925603);
   ...
   quadLineFit1044->SetChisquare(4.585475e-19);
   ...
   quadLineFit1044->SetParameter(0,5.332693);
   quadLineFit1044->SetParError(0,0.1561401);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1537615);
   ...
   quadLineFit1045->SetChisquare(4.585475e-19);
   ...
   quadLineFit1045->SetParameter(0,5.332693);
   quadLineFit1045->SetParError(0,0.1561401);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1537615);
