...
//=========  (Thu Oct 15 00:42:33 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-71.49505,75,84.37902);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-55.90764);
   Graph_Graph01129->SetMaximum(68.79161);
   ...
   checkFit1130->SetChisquare(13.10899);
   ...
   checkFit1130->SetParameter(0,8.164972);
   checkFit1130->SetParError(0,0.3737474);
   checkFit1130->SetParLimits(0,0,0);
   checkFit1130->SetParameter(1,1.002413);
   checkFit1130->SetParError(1,0.01181893);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0118");
   pt_LaTex = pt->AddText(" 8.16#pm0.374");
   pt_LaTex = pt->AddText("#minus8.15#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.145315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.145315,-55.90764,-8.145315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1131->SetChisquare(13.10899);
   ...
   checkFit1131->SetParameter(0,8.164972);
   checkFit1131->SetParError(0,0.3737474);
   checkFit1131->SetParLimits(0,0,0);
   checkFit1131->SetParameter(1,1.002413);
   checkFit1131->SetParError(1,0.01181893);
