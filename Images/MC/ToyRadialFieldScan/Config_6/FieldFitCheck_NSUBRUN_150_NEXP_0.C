...
//=========  (Thu Oct 15 00:42:35 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.80426,75,84.94268);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-55.22956);
   Graph_Graph01155->SetMaximum(69.36799);
   ...
   checkFit1156->SetChisquare(22.55141);
   ...
   checkFit1156->SetParameter(0,7.995942);
   checkFit1156->SetParError(0,0.3410336);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,1.007599);
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.935639,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.935639,-55.22956,-7.935639,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetChisquare(22.55141);
   ...
   checkFit1157->SetParameter(0,7.995942);
   checkFit1157->SetParError(0,0.3410336);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,1.007599);
