...
//=========  (Fri Oct 16 07:52:27 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1085 = new TH1F("Graph_mI30dO000000sPppm1085","",100,15.77,18.53);
   ...
   quadLineFit1086->SetChisquare(2.565568e-21);
   ...
   quadLineFit1086->SetParameter(0,-3.023652);
   quadLineFit1086->SetParError(0,0.1102062);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.08541525);
   quadLineFit1086->SetParError(1,0.006411622);
   ...
   quadLineFit1087->SetChisquare(2.565568e-21);
   ...
   quadLineFit1087->SetParameter(0,-3.023652);
   quadLineFit1087->SetParError(0,0.1102062);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.08541525);
   quadLineFit1087->SetParError(1,0.006411622);
   ...
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.163052);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.1089898);
   ...
   quadLineFit1088->SetChisquare(1.474563e-20);
   ...
   quadLineFit1088->SetParameter(0,-0.3164446);
   quadLineFit1088->SetParError(0,0.1102062);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,0.01052033);
   quadLineFit1088->SetParError(1,0.006411622);
   ...
   quadLineFit1089->SetChisquare(1.474563e-20);
   ...
   quadLineFit1089->SetParameter(0,-0.3164446);
   quadLineFit1089->SetParError(0,0.1102062);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,0.01052033);
   quadLineFit1089->SetParError(1,0.006411622);
   ...
   TH1F *Graph_10dO000000sPppm1089 = new TH1F("Graph_10dO000000sPppm1089","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1089->SetMinimum(1.139741);
   Graph_10dO000000sPppm1089->SetMaximum(1.386918);
   ...
   quadLineFit1090->SetChisquare(8.690082e-20);
   ...
   quadLineFit1090->SetParameter(0,2.643722);
   quadLineFit1090->SetParError(0,0.1102062);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.08048935);
   quadLineFit1090->SetParError(1,0.006411622);
   ...
   quadLineFit1091->SetChisquare(8.690082e-20);
   ...
   quadLineFit1091->SetParameter(0,2.643722);
   quadLineFit1091->SetParError(0,0.1102062);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.08048935);
   quadLineFit1091->SetParError(1,0.006411622);
   ...
   TH1F *Graph_30dO000000sPppm1091 = new TH1F("Graph_30dO000000sPppm1091","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1091->SetMinimum(2.4519);
   Graph_30dO000000sPppm1091->SetMaximum(2.916695);
   ...
   quadLineFit1092->SetChisquare(6.25588e-17);
   ...
   quadLineFit1092->SetParameter(0,5.416923);
   quadLineFit1092->SetParError(0,0.1102062);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1593368);
   quadLineFit1092->SetParError(1,0.006411622);
   ...
   quadLineFit1093->SetChisquare(6.25588e-17);
   ...
   quadLineFit1093->SetParameter(0,5.416923);
   quadLineFit1093->SetParError(0,0.1102062);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1593368);
   quadLineFit1093->SetParError(1,0.006411622);
