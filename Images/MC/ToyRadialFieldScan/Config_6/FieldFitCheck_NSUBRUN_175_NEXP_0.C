...
//=========  (Thu Oct 15 00:42:37 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.27279,75,85.2713);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01181->SetMinimum(-52.91838);
   Graph_Graph01181->SetMaximum(69.91689);
   ...
   checkFit1182->SetChisquare(3.461745);
   ...
   checkFit1182->SetParameter(0,7.60917);
   checkFit1182->SetParError(0,0.3156706);
   checkFit1182->SetParLimits(0,0,0);
   checkFit1182->SetParameter(1,1.004581);
   ...
   pt_LaTex = pt->AddText("    1#pm0.00998");
   pt_LaTex = pt->AddText(" 7.61#pm0.316");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.57447,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.57447,-52.91838,-7.57447,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1183->SetChisquare(3.461745);
   ...
   checkFit1183->SetParameter(0,7.60917);
   checkFit1183->SetParError(0,0.3156706);
   checkFit1183->SetParLimits(0,0,0);
   checkFit1183->SetParameter(1,1.004581);
