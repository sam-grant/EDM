...
//=========  (Thu Oct 15 00:42:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3275346,75,0.2504313);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-0.269738);
   Graph_Graph01023->SetMaximum(0.1926347);
   ...
   mainFit1024->SetChisquare(6.68244);
   ...
   mainFit1024->SetParameter(0,-0.03080611);
   mainFit1024->SetParError(0,0.00311537);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,-0.003727618);
   mainFit1024->SetParError(1,9.851724e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.742");
   pt_LaTex = pt->AddText("#minus0.00373#pm9.85e-05");
   pt_LaTex = pt->AddText("#minus0.0308#pm0.00312");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.264288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.264288,-0.269738,-8.264288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.68244);
   ...
   mainFit1025->SetParameter(0,-0.03080611);
   mainFit1025->SetParError(0,0.00311537);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,-0.003727618);
   mainFit1025->SetParError(1,9.851724e-05);
