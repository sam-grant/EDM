...
//=========  (Fri Oct 16 07:52:33 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.1932218,1.491396e+07,0.2643926);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01159->SetMinimum(-0.1474603);
   Graph_Graph01159->SetMaximum(0.2186311);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.2186311,1.325685e+07,0.2186311,0,344.5,510,"-");
