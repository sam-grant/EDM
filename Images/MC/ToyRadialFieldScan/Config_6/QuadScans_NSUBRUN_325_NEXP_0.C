...
//=========  (Fri Oct 16 07:52:32 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1145 = new TH1F("Graph_mI30dO000000sPppm1145","",100,15.77,18.53);
   ...
   quadLineFit1146->SetChisquare(1.894707e-20);
   ...
   quadLineFit1146->SetParameter(0,-3.017439);
   quadLineFit1146->SetParError(0,0.08639889);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,0.0856515);
   quadLineFit1146->SetParError(1,0.005026548);
   ...
   quadLineFit1147->SetChisquare(1.894707e-20);
   ...
   quadLineFit1147->SetParameter(0,-3.017439);
   quadLineFit1147->SetParError(0,0.08639889);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,0.0856515);
   quadLineFit1147->SetParError(1,0.005026548);
   ...
   TH1F *Graph_mI10dO000000sPppm1147 = new TH1F("Graph_mI10dO000000sPppm1147","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1147->SetMinimum(-0.1600524);
   Graph_mI10dO000000sPppm1147->SetMaximum(-0.127508);
   ...
   quadLineFit1148->SetChisquare(3.115248e-19);
   ...
   quadLineFit1148->SetParameter(0,-0.224091);
   quadLineFit1148->SetParError(0,0.08639889);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,0.004682844);
   quadLineFit1148->SetParError(1,0.005026548);
   ...
   quadLineFit1149->SetChisquare(3.115248e-19);
   ...
   quadLineFit1149->SetParameter(0,-0.224091);
   quadLineFit1149->SetParError(0,0.08639889);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,0.004682844);
   quadLineFit1149->SetParError(1,0.005026548);
   ...
   TH1F *Graph_10dO000000sPppm1149 = new TH1F("Graph_10dO000000sPppm1149","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1149->SetMinimum(1.175739);
   Graph_10dO000000sPppm1149->SetMaximum(1.387961);
   ...
   quadLineFit1150->SetChisquare(1.557249e-17);
   ...
   quadLineFit1150->SetParameter(0,2.478632);
   quadLineFit1150->SetParError(0,0.0863989);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-0.06978321);
   quadLineFit1150->SetParError(1,0.005026548);
   ...
   quadLineFit1151->SetChisquare(1.557249e-17);
   ...
   quadLineFit1151->SetParameter(0,2.478632);
   quadLineFit1151->SetParError(0,0.0863989);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-0.06978321);
   quadLineFit1151->SetParError(1,0.005026548);
   ...
   TH1F *Graph_30dO000000sPppm1151 = new TH1F("Graph_30dO000000sPppm1151","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1151->SetMinimum(2.461554);
   Graph_30dO000000sPppm1151->SetMaximum(2.908646);
   ...
   quadLineFit1152->SetChisquare(6.612552e-17);
   ...
   quadLineFit1152->SetParameter(0,5.34131);
   quadLineFit1152->SetParError(0,0.08639889);
   quadLineFit1152->SetParLimits(0,0,0);
   quadLineFit1152->SetParameter(1,-0.1548811);
   quadLineFit1152->SetParError(1,0.005026548);
   ...
   quadLineFit1153->SetChisquare(6.612552e-17);
   ...
   quadLineFit1153->SetParameter(0,5.34131);
   quadLineFit1153->SetParError(0,0.08639889);
   quadLineFit1153->SetParLimits(0,0,0);
   quadLineFit1153->SetParameter(1,-0.1548811);
   quadLineFit1153->SetParError(1,0.005026548);
