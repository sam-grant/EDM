...
//=========  (Thu Oct 15 00:42:37 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3211231,75,0.2571047);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01179->SetMinimum(-0.2633003);
   Graph_Graph01179->SetMaximum(0.1992819);
   ...
   mainFit1180->SetChisquare(3.463159);
   ...
   mainFit1180->SetParameter(0,-0.0286559);
   mainFit1180->SetParError(0,0.001188693);
   mainFit1180->SetParLimits(0,0,0);
   mainFit1180->SetParameter(1,-0.003783124);
   mainFit1180->SetParError(1,3.758608e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.385");
   pt_LaTex = pt->AddText("#minus0.00378#pm3.76e-05");
   pt_LaTex = pt->AddText("#minus0.0287#pm0.00119");
   pt_LaTex = pt->AddText("#minus7.57#pm0.323");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.574665,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.574665,-0.2633003,-7.574665,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1181->SetChisquare(3.463159);
   ...
   mainFit1181->SetParameter(0,-0.0286559);
   mainFit1181->SetParError(0,0.001188693);
   mainFit1181->SetParLimits(0,0,0);
   mainFit1181->SetParameter(1,-0.003783124);
   mainFit1181->SetParError(1,3.758608e-05);
