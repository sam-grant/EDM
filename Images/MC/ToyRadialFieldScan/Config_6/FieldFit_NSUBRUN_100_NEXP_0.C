...
//=========  (Thu Oct 15 00:42:31 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3194476,75,0.2527447);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01101->SetMinimum(-0.2622284);
   Graph_Graph01101->SetMaximum(0.1955255);
   ...
   mainFit1102->SetChisquare(20.0594);
   ...
   mainFit1102->SetParameter(0,-0.02812964);
   mainFit1102->SetParError(0,0.001574878);
   mainFit1102->SetParLimits(0,0,0);
   mainFit1102->SetParameter(1,-0.003710823);
   mainFit1102->SetParError(1,4.980104e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00371#pm4.98e-05");
   pt_LaTex = pt->AddText("#minus0.0281#pm0.00157");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.580432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.580432,-0.2622284,-7.580432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1103->SetChisquare(20.0594);
   ...
   mainFit1103->SetParameter(0,-0.02812964);
   mainFit1103->SetParError(0,0.001574878);
   mainFit1103->SetParLimits(0,0,0);
   mainFit1103->SetParameter(1,-0.003710823);
   mainFit1103->SetParError(1,4.980104e-05);
