...
//=========  (Fri Oct 16 10:19:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.07443,45,54.17468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01131->SetMinimum(-28.84952);
   Graph_Graph01131->SetMaximum(44.94977);
   ...
   checkFit1132->SetParameter(0,7.997546);
   checkFit1132->SetParError(0,0.3285626);
   checkFit1132->SetParLimits(0,0,0);
   checkFit1132->SetParameter(1,1.003692);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0147");
   pt_LaTex = pt->AddText("    8#pm0.329");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.968131,-28.84952,-7.968131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1133->SetParameter(0,7.997546);
   checkFit1133->SetParError(0,0.3285626);
   checkFit1133->SetParLimits(0,0,0);
   checkFit1133->SetParameter(1,1.003692);
