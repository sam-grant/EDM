...
//=========  (Fri Oct 16 10:18:55 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2529804,45,0.1734444);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01081->SetMinimum(-0.2103379);
   Graph_Graph01081->SetMaximum(0.130802);
   ...
   mainFit1082->SetParameter(0,-0.03770285);
   mainFit1082->SetParError(0,0.001971376);
   mainFit1082->SetParLimits(0,0,0);
   mainFit1082->SetParameter(1,-0.004613073);
   ...
   pt_LaTex = pt->AddText("#minus0.00461#pm8.82e-05");
   pt_LaTex = pt->AddText("#minus0.0377#pm0.00197");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.173043,-0.2103379,-8.173043,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1083->SetParameter(0,-0.03770285);
   mainFit1083->SetParError(0,0.001971376);
   mainFit1083->SetParLimits(0,0,0);
   mainFit1083->SetParameter(1,-0.004613073);
