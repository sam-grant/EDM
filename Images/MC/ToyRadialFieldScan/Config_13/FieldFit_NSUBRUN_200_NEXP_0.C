...
//=========  (Fri Oct 16 10:18:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2603558,45,0.1792022);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2164);
   Graph_Graph01093->SetMaximum(0.1352464);
   ...
   mainFit1094->SetParameter(0,-0.04000865);
   mainFit1094->SetParError(0,0.001843341);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004788187);
   ...
   pt_LaTex = pt->AddText("#minus0.00479#pm8.24e-05");
   pt_LaTex = pt->AddText("#minus0.04#pm0.00184");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.355699,-0.2164,-8.355699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetParameter(0,-0.04000865);
   mainFit1095->SetParError(0,0.001843341);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004788187);
