...
//=========  (Fri Oct 16 10:18:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.47249,45,54.42477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-30.08276);
   Graph_Graph01047->SetMaximum(45.03504);
   ...
   checkFit1048->SetParameter(0,7.961579);
   checkFit1048->SetParError(0,0.5461292);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,0.9874238);
   ...
   pt_LaTex = pt->AddText("0.987#pm0.0244");
   pt_LaTex = pt->AddText(" 7.96#pm0.546");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.062981,-30.08276,-8.062981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetParameter(0,7.961579);
   checkFit1049->SetParError(0,0.5461292);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,0.9874238);
