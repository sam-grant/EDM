...
//=========  (Fri Oct 16 10:18:54 2020) by ROOT version 6.22/02
   ...
   quadLineFit1062->SetChisquare(3.526381e-21);
   ...
   quadLineFit1062->SetParameter(0,-3.356579);
   quadLineFit1062->SetParError(0,0.06868301);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.1048239);
   ...
   quadLineFit1063->SetChisquare(3.526381e-21);
   ...
   quadLineFit1063->SetParameter(0,-3.356579);
   quadLineFit1063->SetParError(0,0.06868301);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.1048239);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-0.1821551);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.1281828);
   ...
   quadLineFit1064->SetChisquare(1.243442e-21);
   ...
   quadLineFit1064->SetParameter(0,-0.2386945);
   quadLineFit1064->SetParError(0,0.06868301);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.005220348);
   ...
   quadLineFit1065->SetChisquare(1.243442e-21);
   ...
   quadLineFit1065->SetParameter(0,-0.2386945);
   quadLineFit1065->SetParError(0,0.06868301);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.005220348);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(1.121544);
   Graph_10dO000000sPppm1065->SetMaximum(1.619079);
   ...
   quadLineFit1066->SetChisquare(1.92513e-19);
   ...
   quadLineFit1066->SetParameter(0,2.932378);
   quadLineFit1066->SetParError(0,0.06868301);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.09762919);
   ...
   quadLineFit1067->SetChisquare(1.92513e-19);
   ...
   quadLineFit1067->SetParameter(0,2.932378);
   quadLineFit1067->SetParError(0,0.06868301);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.09762919);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(2.45964);
   Graph_30dO000000sPppm1067->SetMaximum(3.352164);
   ...
   quadLineFit1068->SetChisquare(1.267574e-19);
   ...
   quadLineFit1068->SetParameter(0,5.7846);
   quadLineFit1068->SetParError(0,0.06868301);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.1799186);
   ...
   quadLineFit1069->SetChisquare(1.267574e-19);
   ...
   quadLineFit1069->SetParameter(0,5.7846);
   quadLineFit1069->SetParError(0,0.06868301);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.1799186);
