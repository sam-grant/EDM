...
//=========  (Fri Oct 16 10:18:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.67557,45,52.81645);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01119->SetMinimum(-28.62636);
   Graph_Graph01119->SetMaximum(43.76725);
   ...
   checkFit1120->SetParameter(0,8.219);
   checkFit1120->SetParError(0,0.3446289);
   checkFit1120->SetParLimits(0,0,0);
   checkFit1120->SetParameter(1,0.9864866);
   checkFit1120->SetParError(1,0.01541227);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0154");
   pt_LaTex = pt->AddText(" 8.22#pm0.345");
   pt_LaTex = pt->AddText("#minus8.33#pm0.373");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.331588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.331588,-28.62636,-8.331588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1121->SetParameter(0,8.219);
   checkFit1121->SetParError(0,0.3446289);
   checkFit1121->SetParLimits(0,0,0);
   checkFit1121->SetParameter(1,0.9864866);
   checkFit1121->SetParError(1,0.01541227);
