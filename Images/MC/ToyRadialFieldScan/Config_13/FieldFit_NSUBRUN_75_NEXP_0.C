...
//=========  (Fri Oct 16 10:18:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2553097,45,0.1780782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-0.2119709);
   Graph_Graph01033->SetMaximum(0.1347394);
   ...
   mainFit1034->SetParameter(0,-0.03845126);
   mainFit1034->SetParError(0,0.00299836);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,-0.004686309);
   ...
   pt_LaTex = pt->AddText("#minus0.00469#pm0.000134");
   pt_LaTex = pt->AddText("#minus0.0385#pm0.003");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.20502,-0.2119709,-8.20502,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetParameter(0,-0.03845126);
   mainFit1035->SetParError(0,0.00299836);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,-0.004686309);
