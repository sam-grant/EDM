...
//=========  (Fri Oct 16 10:18:49 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(6.376884e-21);
   ...
   quadLineFit1002->SetParameter(0,-3.329192);
   quadLineFit1002->SetParError(0,0.1666062);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.1040147);
   ...
   quadLineFit1003->SetChisquare(6.376884e-21);
   ...
   quadLineFit1003->SetParameter(0,-3.329192);
   quadLineFit1003->SetParError(0,0.1666062);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.1040147);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.2484468);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.1260205);
   ...
   quadLineFit1004->SetChisquare(1.996953e-23);
   ...
   quadLineFit1004->SetParameter(0,-0.3615242);
   quadLineFit1004->SetParError(0,0.1666062);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.01089316);
   ...
   quadLineFit1005->SetChisquare(1.996953e-23);
   ...
   quadLineFit1005->SetParameter(0,-0.3615242);
   quadLineFit1005->SetParError(0,0.1666062);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.01089316);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(1.108397);
   Graph_10dO000000sPppm1005->SetMaximum(1.642187);
   ...
   quadLineFit1006->SetChisquare(2.785083e-20);
   ...
   quadLineFit1006->SetParameter(0,2.920795);
   quadLineFit1006->SetParError(0,0.1666062);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.0965939);
   ...
   quadLineFit1007->SetChisquare(2.785083e-20);
   ...
   quadLineFit1007->SetParameter(0,2.920795);
   quadLineFit1007->SetParError(0,0.1666062);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.0965939);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(2.417461);
   Graph_30dO000000sPppm1007->SetMaximum(3.350657);
   ...
   quadLineFit1008->SetChisquare(7.985859e-21);
   ...
   quadLineFit1008->SetParameter(0,5.760913);
   quadLineFit1008->SetParError(0,0.1666062);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1798034);
   ...
   quadLineFit1009->SetChisquare(7.985859e-21);
   ...
   quadLineFit1009->SetParameter(0,5.760913);
   quadLineFit1009->SetParError(0,0.1666062);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1798034);
