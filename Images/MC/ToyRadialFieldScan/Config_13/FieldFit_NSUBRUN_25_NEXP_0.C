...
//=========  (Fri Oct 16 10:18:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2662566,45,0.1904679);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.2205842);
   Graph_Graph01009->SetMaximum(0.1447954);
   ...
   mainFit1010->SetParameter(0,-0.04037237);
   mainFit1010->SetParError(0,0.005166239);
   mainFit1010->SetParLimits(0,0,0);
   mainFit1010->SetParameter(1,-0.004794706);
   ...
   pt_LaTex = pt->AddText("#minus0.00479#pm0.000231");
   pt_LaTex = pt->AddText("#minus0.0404#pm0.00517");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.420197,-0.2205842,-8.420197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1011->SetParameter(0,-0.04037237);
   mainFit1011->SetParError(0,0.005166239);
   mainFit1011->SetParLimits(0,0,0);
   mainFit1011->SetParameter(1,-0.004794706);
