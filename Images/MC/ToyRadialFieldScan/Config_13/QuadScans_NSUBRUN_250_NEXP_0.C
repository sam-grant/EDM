...
//=========  (Fri Oct 16 10:18:58 2020) by ROOT version 6.22/02
   ...
   quadLineFit1110->SetChisquare(1.661382e-20);
   ...
   quadLineFit1110->SetParameter(0,-3.362973);
   quadLineFit1110->SetParError(0,0.05314801);
   quadLineFit1110->SetParLimits(0,0,0);
   quadLineFit1110->SetParameter(1,0.1047486);
   ...
   quadLineFit1111->SetChisquare(1.661382e-20);
   ...
   quadLineFit1111->SetParameter(0,-3.362973);
   quadLineFit1111->SetParError(0,0.05314801);
   quadLineFit1111->SetParLimits(0,0,0);
   quadLineFit1111->SetParameter(1,0.1047486);
   ...
   Graph_mI10dO000000sPppm1111->SetMinimum(-0.1836975);
   Graph_mI10dO000000sPppm1111->SetMaximum(-0.1301774);
   ...
   quadLineFit1112->SetChisquare(2.762976e-23);
   ...
   quadLineFit1112->SetParameter(0,-0.2607555);
   quadLineFit1112->SetParError(0,0.05314801);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.006488626);
   ...
   quadLineFit1113->SetChisquare(2.762976e-23);
   ...
   quadLineFit1113->SetParameter(0,-0.2607555);
   quadLineFit1113->SetParError(0,0.05314801);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.006488626);
   ...
   Graph_10dO000000sPppm1113->SetMinimum(1.147694);
   Graph_10dO000000sPppm1113->SetMaximum(1.608307);
   ...
   quadLineFit1114->SetChisquare(2.862637e-20);
   ...
   quadLineFit1114->SetParameter(0,2.838795);
   quadLineFit1114->SetParError(0,0.05314801);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,-0.09129968);
   ...
   quadLineFit1115->SetChisquare(2.862637e-20);
   ...
   quadLineFit1115->SetParameter(0,2.838795);
   quadLineFit1115->SetParError(0,0.05314801);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,-0.09129968);
   ...
   Graph_30dO000000sPppm1115->SetMinimum(2.468895);
   Graph_30dO000000sPppm1115->SetMaximum(3.341608);
   ...
   quadLineFit1116->SetChisquare(1.514136e-19);
   ...
   quadLineFit1116->SetParameter(0,5.739712);
   quadLineFit1116->SetParError(0,0.05314801);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.1771538);
   ...
   quadLineFit1117->SetChisquare(1.514136e-19);
   ...
   quadLineFit1117->SetParameter(0,5.739712);
   quadLineFit1117->SetParError(0,0.05314801);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.1771538);
