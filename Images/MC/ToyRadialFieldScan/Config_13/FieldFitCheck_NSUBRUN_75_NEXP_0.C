...
//=========  (Fri Oct 16 10:18:51 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.23849,45,53.38863);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-28.17578);
   Graph_Graph01035->SetMaximum(44.32592);
   ...
   checkFit1036->SetParameter(0,8.040666);
   checkFit1036->SetParError(0,0.6269966);
   checkFit1036->SetParLimits(0,0,0);
   checkFit1036->SetParameter(1,0.9799691);
   checkFit1036->SetParError(1,0.02804014);
   ...
   pt_LaTex = pt->AddText(" 0.98#pm0.028");
   pt_LaTex = pt->AddText(" 8.04#pm0.627");
   pt_LaTex = pt->AddText("#minus8.21#pm0.682");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.20502,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.20502,-28.17578,-8.20502,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1037->SetParameter(0,8.040666);
   checkFit1037->SetParError(0,0.6269966);
   checkFit1037->SetParLimits(0,0,0);
   checkFit1037->SetParameter(1,0.9799691);
   checkFit1037->SetParError(1,0.02804014);
