...
//=========  (Fri Oct 16 10:19:00 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2590687,45,0.1820757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-0.2149542);
   Graph_Graph01129->SetMaximum(0.1379613);
   ...
   mainFit1130->SetParameter(0,-0.03824505);
   mainFit1130->SetParError(0,0.001571219);
   mainFit1130->SetParLimits(0,0,0);
   mainFit1130->SetParameter(1,-0.004799753);
   ...
   pt_LaTex = pt->AddText("#minus0.0048#pm7.03e-05");
   pt_LaTex = pt->AddText("#minus0.0382#pm0.00157");
   pt_LaTex = pt->AddText("#minus7.97#pm0.348");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.968131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.968131,-0.2149542,-7.968131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1131->SetParameter(0,-0.03824505);
   mainFit1131->SetParError(0,0.001571219);
   mainFit1131->SetParLimits(0,0,0);
   mainFit1131->SetParameter(1,-0.004799753);
