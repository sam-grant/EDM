...
//=========  (Fri Oct 16 10:19:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.1253,45,53.53143);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-28.05962);
   Graph_Graph01155->SetMaximum(44.46576);
   ...
   checkFit1156->SetParameter(0,8.078944);
   checkFit1156->SetParError(0,0.3021963);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,0.9837168);
   ...
   pt_LaTex = pt->AddText("0.984#pm0.0135");
   pt_LaTex = pt->AddText(" 8.08#pm0.302");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.212673,-28.05962,-8.212673,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetParameter(0,8.078944);
   checkFit1157->SetParError(0,0.3021963);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,0.9837168);
