...
//=========  (Fri Oct 16 10:18:52 2020) by ROOT version 6.22/02
   ...
   quadLineFit1038->SetChisquare(5.327551e-21);
   ...
   quadLineFit1038->SetParameter(0,-3.430385);
   quadLineFit1038->SetParError(0,0.08422298);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.1087004);
   ...
   quadLineFit1039->SetChisquare(5.327551e-21);
   ...
   quadLineFit1039->SetParameter(0,-3.430385);
   quadLineFit1039->SetParError(0,0.08422298);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.1087004);
   ...
   Graph_mI10dO000000sPppm1039->SetMinimum(-0.182232);
   Graph_mI10dO000000sPppm1039->SetMaximum(-0.1393122);
   ...
   quadLineFit1040->SetChisquare(5.344475e-23);
   ...
   quadLineFit1040->SetParameter(0,-0.1358956);
   quadLineFit1040->SetParError(0,0.08422298);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,-0.001554777);
   ...
   quadLineFit1041->SetChisquare(5.344475e-23);
   ...
   quadLineFit1041->SetParameter(0,-0.1358956);
   quadLineFit1041->SetParError(0,0.08422298);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,-0.001554777);
   ...
   Graph_10dO000000sPppm1041->SetMinimum(1.159667);
   Graph_10dO000000sPppm1041->SetMaximum(1.575448);
   ...
   quadLineFit1042->SetChisquare(5.835831e-21);
   ...
   quadLineFit1042->SetParameter(0,2.635304);
   quadLineFit1042->SetParError(0,0.08422298);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.07923416);
   ...
   quadLineFit1043->SetChisquare(5.835831e-21);
   ...
   quadLineFit1043->SetParameter(0,2.635304);
   quadLineFit1043->SetParError(0,0.08422298);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.07923416);
   ...
   Graph_30dO000000sPppm1043->SetMinimum(2.470754);
   Graph_30dO000000sPppm1043->SetMaximum(3.371189);
   ...
   quadLineFit1044->SetChisquare(7.085831e-21);
   ...
   quadLineFit1044->SetParameter(0,5.80423);
   quadLineFit1044->SetParError(0,0.08422298);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1802037);
   ...
   quadLineFit1045->SetChisquare(7.085831e-21);
   ...
   quadLineFit1045->SetParameter(0,5.80423);
   quadLineFit1045->SetParError(0,0.08422298);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1802037);
