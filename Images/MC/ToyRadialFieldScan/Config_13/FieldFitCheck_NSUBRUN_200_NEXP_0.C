...
//=========  (Fri Oct 16 10:18:56 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.47354,45,54.44384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-28.2818);
   Graph_Graph01095->SetMaximum(45.2521);
   ...
   checkFit1096->SetParameter(0,8.366337);
   checkFit1096->SetParError(0,0.385467);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,1.001273);
   ...
   pt_LaTex = pt->AddText(" 8.37#pm0.385");
   pt_LaTex = pt->AddText("#minus8.36#pm0.411");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.355699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.355699,-28.2818,-8.355699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetParameter(0,8.366337);
   checkFit1097->SetParError(0,0.385467);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,1.001273);
