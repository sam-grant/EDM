...
//=========  (Fri Oct 16 10:18:58 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2525735,45,0.1801683);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01117->SetMinimum(-0.2092993);
   Graph_Graph01117->SetMaximum(0.1368941);
   ...
   mainFit1118->SetParameter(0,-0.03930407);
   mainFit1118->SetParError(0,0.00164805);
   mainFit1118->SetParLimits(0,0,0);
   mainFit1118->SetParameter(1,-0.004717476);
   ...
   pt_LaTex = pt->AddText("#minus0.00472#pm7.37e-05");
   pt_LaTex = pt->AddText("#minus0.0393#pm0.00165");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.331588,-0.2092993,-8.331588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1119->SetParameter(0,-0.03930407);
   mainFit1119->SetParError(0,0.00164805);
   mainFit1119->SetParLimits(0,0,0);
   mainFit1119->SetParameter(1,-0.004717476);
