...
//=========  (Fri Oct 16 10:18:51 2020) by ROOT version 6.22/02
   ...
   quadLineFit1026->SetChisquare(2.127499e-21);
   ...
   quadLineFit1026->SetParameter(0,-3.264095);
   quadLineFit1026->SetParError(0,0.0966942);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.09985012);
   ...
   quadLineFit1027->SetChisquare(2.127499e-21);
   ...
   quadLineFit1027->SetParameter(0,-3.264095);
   quadLineFit1027->SetParError(0,0.0966942);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.09985012);
   ...
   Graph_mI10dO000000sPppm1027->SetMinimum(-0.2016616);
   Graph_mI10dO000000sPppm1027->SetMaximum(-0.0892114);
   ...
   quadLineFit1028->SetChisquare(2.925816e-23);
   ...
   quadLineFit1028->SetParameter(0,-0.3845802);
   quadLineFit1028->SetParError(0,0.0966942);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,0.01494648);
   ...
   quadLineFit1029->SetChisquare(2.925816e-23);
   ...
   quadLineFit1029->SetParameter(0,-0.3845802);
   quadLineFit1029->SetParError(0,0.0966942);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,0.01494648);
   ...
   Graph_10dO000000sPppm1029->SetMinimum(1.130224);
   Graph_10dO000000sPppm1029->SetMaximum(1.610227);
   ...
   quadLineFit1030->SetChisquare(4.388833e-20);
   ...
   quadLineFit1030->SetParameter(0,2.834545);
   quadLineFit1030->SetParError(0,0.0966942);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,-0.09151996);
   ...
   quadLineFit1031->SetChisquare(4.388833e-20);
   ...
   quadLineFit1031->SetParameter(0,2.834545);
   quadLineFit1031->SetParError(0,0.0966942);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,-0.09151996);
   ...
   Graph_30dO000000sPppm1031->SetMinimum(2.474322);
   Graph_30dO000000sPppm1031->SetMaximum(3.365021);
   ...
   quadLineFit1032->SetChisquare(5.700138e-19);
   ...
   quadLineFit1032->SetParameter(0,5.752978);
   quadLineFit1032->SetParError(0,0.0966942);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,-0.1770817);
   ...
   quadLineFit1033->SetChisquare(5.700138e-19);
   ...
   quadLineFit1033->SetParameter(0,5.752978);
   quadLineFit1033->SetParError(0,0.0966942);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,-0.1770817);
