...
//=========  (Fri Oct 16 10:19:02 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2559926,45,0.1775368);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01153->SetMinimum(-0.2126397);
   Graph_Graph01153->SetMaximum(0.1341839);
   ...
   mainFit1154->SetChisquare(0.7496938);
   ...
   mainFit1154->SetParameter(0,-0.03863431);
   mainFit1154->SetParError(0,0.001445133);
   mainFit1154->SetParLimits(0,0,0);
   mainFit1154->SetParameter(1,-0.004704231);
   mainFit1154->SetParError(1,6.46283e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0047#pm6.46e-05");
   pt_LaTex = pt->AddText("#minus0.0386#pm0.00145");
   pt_LaTex = pt->AddText("#minus8.21#pm0.327");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.212673,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.212673,-0.2126397,-8.212673,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1155->SetChisquare(0.7496938);
   ...
   mainFit1155->SetParameter(0,-0.03863431);
   mainFit1155->SetParError(0,0.001445133);
   mainFit1155->SetParLimits(0,0,0);
   mainFit1155->SetParameter(1,-0.004704231);
   mainFit1155->SetParError(1,6.46283e-05);
