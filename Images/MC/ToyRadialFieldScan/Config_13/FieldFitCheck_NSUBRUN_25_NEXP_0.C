...
//=========  (Fri Oct 16 10:18:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.82935,45,55.67778);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-30.27864);
   Graph_Graph01011->SetMaximum(46.12707);
   ...
   checkFit1012->SetParameter(0,8.442396);
   checkFit1012->SetParError(0,1.080329);
   checkFit1012->SetParLimits(0,0,0);
   checkFit1012->SetParameter(1,1.002636);
   checkFit1012->SetParError(1,0.04831378);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0483");
   pt_LaTex = pt->AddText(" 8.44#pm 1.08");
   pt_LaTex = pt->AddText("#minus8.42#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.420197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.420197,-30.27864,-8.420197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1013->SetParameter(0,8.442396);
   checkFit1013->SetParError(0,1.080329);
   checkFit1013->SetParLimits(0,0,0);
   checkFit1013->SetParameter(1,1.002636);
   checkFit1013->SetParError(1,0.04831378);
