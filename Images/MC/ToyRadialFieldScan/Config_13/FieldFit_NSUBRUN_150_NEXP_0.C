...
//=========  (Fri Oct 16 10:18:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2574935,45,0.1823989);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.2135043);
   Graph_Graph01069->SetMaximum(0.1384096);
   ...
   mainFit1070->SetParameter(0,-0.04187587);
   mainFit1070->SetParError(0,0.00212977);
   mainFit1070->SetParLimits(0,0,0);
   mainFit1070->SetParameter(1,-0.004785385);
   ...
   pt_LaTex = pt->AddText("#minus0.00479#pm9.52e-05");
   pt_LaTex = pt->AddText("#minus0.0419#pm0.00213");
   pt_LaTex = pt->AddText("#minus8.75#pm0.478");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.750784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.750784,-0.2135043,-8.750784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetParameter(0,-0.04187587);
   mainFit1071->SetParError(0,0.00212977);
   mainFit1071->SetParLimits(0,0,0);
   mainFit1071->SetParameter(1,-0.004785385);
