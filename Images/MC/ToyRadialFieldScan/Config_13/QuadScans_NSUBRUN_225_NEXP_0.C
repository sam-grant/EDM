...
//=========  (Fri Oct 16 10:18:57 2020) by ROOT version 6.22/02
   ...
   quadLineFit1098->SetChisquare(5.170861e-23);
   ...
   quadLineFit1098->SetParameter(0,-3.323805);
   quadLineFit1098->SetParError(0,0.05603354);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,0.1025086);
   ...
   quadLineFit1099->SetChisquare(5.170861e-23);
   ...
   quadLineFit1099->SetParameter(0,-3.323805);
   quadLineFit1099->SetParError(0,0.05603354);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,0.1025086);
   ...
   Graph_mI10dO000000sPppm1099->SetMinimum(-0.1960762);
   Graph_mI10dO000000sPppm1099->SetMaximum(-0.1072831);
   ...
   quadLineFit1100->SetChisquare(1.746846e-21);
   ...
   quadLineFit1100->SetParameter(0,-0.3690251);
   quadLineFit1100->SetParError(0,0.05603354);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,0.01358409);
   ...
   quadLineFit1101->SetChisquare(1.746846e-21);
   ...
   quadLineFit1101->SetParameter(0,-0.3690251);
   quadLineFit1101->SetParError(0,0.05603354);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,0.01358409);
   ...
   Graph_10dO000000sPppm1101->SetMinimum(1.135461);
   Graph_10dO000000sPppm1101->SetMaximum(1.601357);
   ...
   quadLineFit1102->SetChisquare(1.411007e-19);
   ...
   quadLineFit1102->SetParameter(0,2.842766);
   quadLineFit1102->SetParError(0,0.05603354);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,-0.09214727);
   ...
   quadLineFit1103->SetChisquare(1.411007e-19);
   ...
   quadLineFit1103->SetParameter(0,2.842766);
   quadLineFit1103->SetParError(0,0.05603354);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,-0.09214727);
   ...
   Graph_30dO000000sPppm1103->SetMinimum(2.444623);
   Graph_30dO000000sPppm1103->SetMaximum(3.375404);
   ...
   quadLineFit1104->SetChisquare(4.389153e-19);
   ...
   quadLineFit1104->SetParameter(0,5.933985);
   quadLineFit1104->SetParError(0,0.05603354);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,-0.1889983);
   ...
   quadLineFit1105->SetChisquare(4.389153e-19);
   ...
   quadLineFit1105->SetParameter(0,5.933985);
   quadLineFit1105->SetParError(0,0.05603354);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,-0.1889983);
