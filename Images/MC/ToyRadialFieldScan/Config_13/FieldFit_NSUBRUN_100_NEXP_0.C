...
//=========  (Fri Oct 16 10:18:52 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2602646,45,0.1887613);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.215362);
   Graph_Graph01045->SetMaximum(0.1438587);
   ...
   mainFit1046->SetParameter(0,-0.03807306);
   mainFit1046->SetParError(0,0.002611644);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.004721958);
   ...
   pt_LaTex = pt->AddText("#minus0.00472#pm0.000117");
   pt_LaTex = pt->AddText("#minus0.0381#pm0.00261");
   pt_LaTex = pt->AddText("#minus8.06#pm0.588");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.062981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.062981,-0.215362,-8.062981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetParameter(0,-0.03807306);
   mainFit1047->SetParError(0,0.002611644);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.004721958);
