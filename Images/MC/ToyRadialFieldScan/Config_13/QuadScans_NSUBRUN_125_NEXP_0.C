...
//=========  (Fri Oct 16 10:18:53 2020) by ROOT version 6.22/02
   ...
   quadLineFit1050->SetChisquare(6.582604e-21);
   ...
   quadLineFit1050->SetParameter(0,-3.46622);
   quadLineFit1050->SetParError(0,0.07527146);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.1101834);
   ...
   quadLineFit1051->SetChisquare(6.582604e-21);
   ...
   quadLineFit1051->SetParameter(0,-3.46622);
   quadLineFit1051->SetParError(0,0.07527146);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.1101834);
   ...
   Graph_mI10dO000000sPppm1051->SetMinimum(-0.2041978);
   Graph_mI10dO000000sPppm1051->SetMaximum(-0.1064261);
   ...
   quadLineFit1052->SetChisquare(1.030423e-21);
   ...
   quadLineFit1052->SetParameter(0,-0.3755897);
   quadLineFit1052->SetParError(0,0.07527146);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.01376736);
   quadLineFit1052->SetParError(1,0.004668138);
   ...
   quadLineFit1053->SetChisquare(1.030423e-21);
   ...
   quadLineFit1053->SetParameter(0,-0.3755897);
   quadLineFit1053->SetParError(0,0.07527146);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.01376736);
   quadLineFit1053->SetParError(1,0.004668138);
   ...
   Graph_10dO000000sPppm1053->SetMinimum(1.126642);
   Graph_10dO000000sPppm1053->SetMaximum(1.626122);
   ...
   quadLineFit1054->SetChisquare(1.018692e-19);
   ...
   quadLineFit1054->SetParameter(0,2.935685);
   quadLineFit1054->SetParError(0,0.07527146);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,-0.09745643);
   quadLineFit1054->SetParError(1,0.004668138);
   ...
   quadLineFit1055->SetChisquare(1.018692e-19);
   ...
   quadLineFit1055->SetParameter(0,2.935685);
   quadLineFit1055->SetParError(0,0.07527146);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,-0.09745643);
   quadLineFit1055->SetParError(1,0.004668138);
   ...
   Graph_30dO000000sPppm1055->SetMinimum(2.476401);
   Graph_30dO000000sPppm1055->SetMaximum(3.353685);
   ...
   quadLineFit1056->SetChisquare(7.239069e-20);
   ...
   quadLineFit1056->SetParameter(0,5.733697);
   quadLineFit1056->SetParError(0,0.07527146);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.1761659);
   quadLineFit1056->SetParError(1,0.004668138);
   ...
   quadLineFit1057->SetChisquare(7.239069e-20);
   ...
   quadLineFit1057->SetParameter(0,5.733697);
   quadLineFit1057->SetParError(0,0.07527146);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.1761659);
   quadLineFit1057->SetParError(1,0.004668138);
