...
//=========  (Fri Oct 16 10:18:54 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.14201,45,53.84529);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-28.94328);
   Graph_Graph01071->SetMaximum(44.64656);
   ...
   checkFit1072->SetParameter(0,8.756798);
   checkFit1072->SetParError(0,0.4453629);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,1.000687);
   checkFit1072->SetParError(1,0.01991724);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0199");
   pt_LaTex = pt->AddText(" 8.76#pm0.445");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.750784,-28.94328,-8.750784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetParameter(0,8.756798);
   checkFit1073->SetParError(0,0.4453629);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,1.000687);
   checkFit1073->SetParError(1,0.01991724);
