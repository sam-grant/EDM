...
//=========  (Fri Oct 16 10:19:00 2020) by ROOT version 6.22/02
   ...
   quadLineFit1122->SetChisquare(6.758602e-21);
   ...
   quadLineFit1122->SetParameter(0,-3.376379);
   quadLineFit1122->SetParError(0,0.05067029);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,0.1054092);
   ...
   quadLineFit1123->SetChisquare(6.758602e-21);
   ...
   quadLineFit1123->SetParameter(0,-3.376379);
   quadLineFit1123->SetParError(0,0.05067029);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,0.1054092);
   ...
   Graph_mI10dO000000sPppm1123->SetMinimum(-0.190269);
   Graph_mI10dO000000sPppm1123->SetMaximum(-0.1196675);
   ...
   quadLineFit1124->SetChisquare(3.454025e-22);
   ...
   quadLineFit1124->SetParameter(0,-0.3192014);
   quadLineFit1124->SetParError(0,0.05067029);
   quadLineFit1124->SetParLimits(0,0,0);
   quadLineFit1124->SetParameter(1,0.01026457);
   quadLineFit1124->SetParError(1,0.003142438);
   ...
   quadLineFit1125->SetChisquare(3.454025e-22);
   ...
   quadLineFit1125->SetParameter(0,-0.3192014);
   quadLineFit1125->SetParError(0,0.05067029);
   quadLineFit1125->SetParLimits(0,0,0);
   quadLineFit1125->SetParameter(1,0.01026457);
   quadLineFit1125->SetParError(1,0.003142438);
   ...
   Graph_10dO000000sPppm1125->SetMinimum(1.155971);
   Graph_10dO000000sPppm1125->SetMaximum(1.591312);
   ...
   quadLineFit1126->SetChisquare(5.15622e-20);
   ...
   quadLineFit1126->SetParameter(0,2.753671);
   quadLineFit1126->SetParError(0,0.05067029);
   quadLineFit1126->SetParLimits(0,0,0);
   quadLineFit1126->SetParameter(1,-0.08625183);
   quadLineFit1126->SetParError(1,0.003142438);
   ...
   quadLineFit1127->SetChisquare(5.15622e-20);
   ...
   quadLineFit1127->SetParameter(0,2.753671);
   quadLineFit1127->SetParError(0,0.05067029);
   quadLineFit1127->SetParLimits(0,0,0);
   quadLineFit1127->SetParameter(1,-0.08625183);
   quadLineFit1127->SetParError(1,0.003142438);
   ...
   Graph_30dO000000sPppm1127->SetMinimum(2.450563);
   Graph_30dO000000sPppm1127->SetMaximum(3.347425);
   ...
   quadLineFit1128->SetChisquare(3.375094e-20);
   ...
   quadLineFit1128->SetParameter(0,5.817428);
   quadLineFit1128->SetParError(0,0.05067029);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,-0.1824022);
   quadLineFit1128->SetParError(1,0.003142438);
   ...
   quadLineFit1129->SetChisquare(3.375094e-20);
   ...
   quadLineFit1129->SetParameter(0,5.817428);
   quadLineFit1129->SetParError(0,0.05067029);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,-0.1824022);
   quadLineFit1129->SetParError(1,0.003142438);
