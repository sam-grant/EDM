...
//=========  (Fri Oct 16 10:18:53 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2547554,45,0.1887729);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(-0.2104026);
   Graph_Graph01057->SetMaximum(0.1444201);
   ...
   mainFit1058->SetParameter(0,-0.03741788);
   mainFit1058->SetParError(0,0.002334069);
   mainFit1058->SetParLimits(0,0,0);
   mainFit1058->SetParameter(1,-0.004851358);
   ...
   pt_LaTex = pt->AddText("#minus0.00485#pm0.000104");
   pt_LaTex = pt->AddText("#minus0.0374#pm0.00233");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.712868,-0.2104026,-7.712868,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1059->SetParameter(0,-0.03741788);
   mainFit1059->SetParError(0,0.002334069);
   mainFit1059->SetParLimits(0,0,0);
   mainFit1059->SetParameter(1,-0.004851358);
