...
//=========  (Fri Oct 16 10:18:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.7654,45,55.85153);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-28.4037);
   Graph_Graph01107->SetMaximum(46.48984);
   ...
   checkFit1108->SetParameter(0,8.628683);
   checkFit1108->SetParError(0,0.3633397);
   checkFit1108->SetParLimits(0,0,0);
   checkFit1108->SetParameter(1,1.024918);
   checkFit1108->SetParError(1,0.01624905);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0162");
   pt_LaTex = pt->AddText(" 8.63#pm0.363");
   pt_LaTex = pt->AddText("#minus8.42#pm0.379");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.418901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.418901,-28.4037,-8.418901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1109->SetParameter(0,8.628683);
   checkFit1109->SetParError(0,0.3633397);
   checkFit1109->SetParLimits(0,0,0);
   checkFit1109->SetParameter(1,1.024918);
   checkFit1109->SetParError(1,0.01624905);
