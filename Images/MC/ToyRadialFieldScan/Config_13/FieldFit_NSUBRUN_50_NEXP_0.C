...
//=========  (Fri Oct 16 10:18:50 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2745087,45,0.1921493);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.2278429);
   Graph_Graph01021->SetMaximum(0.1454835);
   ...
   mainFit1022->SetParameter(0,-0.03809239);
   mainFit1022->SetParError(0,0.003666401);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.004846232);
   ...
   pt_LaTex = pt->AddText("#minus0.00485#pm0.000164");
   pt_LaTex = pt->AddText("#minus0.0381#pm0.00367");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.860208,-0.2278429,-7.860208,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetParameter(0,-0.03809239);
   mainFit1023->SetParError(0,0.003666401);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.004846232);
