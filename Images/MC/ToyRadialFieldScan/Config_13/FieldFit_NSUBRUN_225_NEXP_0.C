...
//=========  (Fri Oct 16 10:18:57 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2670876,45,0.1805979);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.222319);
   Graph_Graph01105->SetMaximum(0.1358293);
   ...
   mainFit1106->SetParameter(0,-0.04126322);
   mainFit1106->SetParError(0,0.001737526);
   mainFit1106->SetParLimits(0,0,0);
   mainFit1106->SetParameter(1,-0.004901259);
   ...
   pt_LaTex = pt->AddText("#minus0.0049#pm7.77e-05");
   pt_LaTex = pt->AddText("#minus0.0413#pm0.00174");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.418901,-0.222319,-8.418901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1107->SetParameter(0,-0.04126322);
   mainFit1107->SetParError(0,0.001737526);
   mainFit1107->SetParLimits(0,0,0);
   mainFit1107->SetParameter(1,-0.004901259);
