...
//=========  (Fri Oct 16 10:18:55 2020) by ROOT version 6.22/02
   ...
   quadLineFit1074->SetChisquare(5.65032e-21);
   ...
   quadLineFit1074->SetParameter(0,-3.256966);
   quadLineFit1074->SetParError(0,0.06357497);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.09843087);
   ...
   quadLineFit1075->SetChisquare(5.65032e-21);
   ...
   quadLineFit1075->SetParameter(0,-3.256966);
   quadLineFit1075->SetParError(0,0.06357497);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.09843087);
   ...
   Graph_mI10dO000000sPppm1075->SetMinimum(-0.2011684);
   Graph_mI10dO000000sPppm1075->SetMaximum(-0.1212535);
   ...
   quadLineFit1076->SetChisquare(9.262134e-24);
   ...
   quadLineFit1076->SetParameter(0,-0.3383796);
   quadLineFit1076->SetParError(0,0.06357497);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,0.01107304);
   ...
   quadLineFit1077->SetChisquare(9.262134e-24);
   ...
   quadLineFit1077->SetParameter(0,-0.3383796);
   quadLineFit1077->SetParError(0,0.06357497);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,0.01107304);
   ...
   Graph_10dO000000sPppm1077->SetMinimum(1.163717);
   Graph_10dO000000sPppm1077->SetMaximum(1.585754);
   ...
   quadLineFit1078->SetChisquare(4.712825e-20);
   ...
   quadLineFit1078->SetParameter(0,2.69231);
   quadLineFit1078->SetParError(0,0.06357497);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.08234843);
   ...
   quadLineFit1079->SetChisquare(4.712825e-20);
   ...
   quadLineFit1079->SetParameter(0,2.69231);
   quadLineFit1079->SetParError(0,0.06357497);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.08234843);
   ...
   Graph_30dO000000sPppm1079->SetMinimum(2.463993);
   Graph_30dO000000sPppm1079->SetMaximum(3.344998);
   ...
   quadLineFit1080->SetChisquare(4.694809e-19);
   ...
   quadLineFit1080->SetParameter(0,5.751965);
   quadLineFit1080->SetParError(0,0.06357497);
   quadLineFit1080->SetParLimits(0,0,0);
   quadLineFit1080->SetParameter(1,-0.1779669);
   ...
   quadLineFit1081->SetChisquare(4.694809e-19);
   ...
   quadLineFit1081->SetParameter(0,5.751965);
   quadLineFit1081->SetParError(0,0.06357497);
   quadLineFit1081->SetParLimits(0,0,0);
   quadLineFit1081->SetParameter(1,-0.1779669);
