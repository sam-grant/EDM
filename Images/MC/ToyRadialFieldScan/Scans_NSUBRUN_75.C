...
//=========  (Fri Oct  2 13:49:33 2020) by ROOT version 6.22/02
   ...
   lineFit1030->SetChisquare(5.175768e-26);
   ...
   lineFit1030->SetParameter(0,-4.275);
   lineFit1030->SetParError(0,0.26749);
   lineFit1030->SetParLimits(0,0,0);
   lineFit1030->SetParameter(1,0.11875);
   lineFit1030->SetParError(1,0.01476966);
   ...
   lineFit1031->SetChisquare(5.175768e-26);
   ...
   lineFit1031->SetParameter(0,-4.275);
   lineFit1031->SetParError(0,0.26749);
   lineFit1031->SetParLimits(0,0,0);
   lineFit1031->SetParameter(1,0.11875);
   lineFit1031->SetParError(1,0.01476966);
   ...
   Graph_Graph_Graph_mI10dO000000sPppm100310131031->SetMinimum(-1.19763);
   Graph_Graph_Graph_mI10dO000000sPppm100310131031->SetMaximum(-0.8273701);
   ...
   lineFit1032->SetChisquare(5.155992e-28);
   ...
   lineFit1032->SetParameter(0,-2.025);
   lineFit1032->SetParError(0,0.26749);
   lineFit1032->SetParLimits(0,0,0);
   lineFit1032->SetParameter(1,0.05625);
   lineFit1032->SetParError(1,0.01476966);
   ...
   lineFit1033->SetChisquare(5.155992e-28);
   ...
   lineFit1033->SetParameter(0,-2.025);
   lineFit1033->SetParError(0,0.26749);
   lineFit1033->SetParLimits(0,0,0);
   lineFit1033->SetParameter(1,0.05625);
   lineFit1033->SetParError(1,0.01476966);
   ...
   Graph_Graph_Graph_10dO000000sPppm100510151033->SetMinimum(0.0473701);
   Graph_Graph_Graph_10dO000000sPppm100510151033->SetMaximum(0.1776299);
   ...
   lineFit1034->SetChisquare(6.731924e-30);
   ...
   lineFit1034->SetParameter(0,0.225);
   lineFit1034->SetParError(0,0.26749);
   lineFit1034->SetParLimits(0,0,0);
   lineFit1034->SetParameter(1,-0.00625);
   lineFit1034->SetParError(1,0.01476966);
   ...
   lineFit1035->SetChisquare(6.731924e-30);
   ...
   lineFit1035->SetParameter(0,0.225);
   lineFit1035->SetParError(0,0.26749);
   lineFit1035->SetParLimits(0,0,0);
   lineFit1035->SetParameter(1,-0.00625);
   lineFit1035->SetParError(1,0.01476966);
   ...
   Graph_Graph_Graph_30dO000000sPppm100710171035->SetMinimum(1.02237);
   Graph_Graph_Graph_30dO000000sPppm100710171035->SetMaximum(1.45263);
   ...
   lineFit1036->SetChisquare(1.358922e-26);
   ...
   lineFit1036->SetParameter(0,2.475);
   lineFit1036->SetParError(0,0.26749);
   lineFit1036->SetParLimits(0,0,0);
   lineFit1036->SetParameter(1,-0.06875);
   lineFit1036->SetParError(1,0.01476966);
   ...
   lineFit1037->SetChisquare(1.358922e-26);
   ...
   lineFit1037->SetParameter(0,2.475);
   lineFit1037->SetParError(0,0.26749);
   lineFit1037->SetParLimits(0,0,0);
   lineFit1037->SetParameter(1,-0.06875);
   lineFit1037->SetParError(1,0.01476966);
   ...
   Graph_Graph_mI30dO000000sPppm10191037->SetMinimum(-2.452199);
   Graph_Graph_mI30dO000000sPppm10191037->SetMaximum(-1.822801);
   ...
   lineFit1038->SetChisquare(1.355547e-25);
   ...
   lineFit1038->SetParameter(0,-4.275);
   lineFit1038->SetParError(0,0.1584696);
   lineFit1038->SetParLimits(0,0,0);
   lineFit1038->SetParameter(1,0.11875);
   lineFit1038->SetParError(1,0.008750018);
   ...
   lineFit1039->SetChisquare(1.355547e-25);
   ...
   lineFit1039->SetParameter(0,-4.275);
   lineFit1039->SetParError(0,0.1584696);
   lineFit1039->SetParLimits(0,0,0);
   lineFit1039->SetParameter(1,0.11875);
   lineFit1039->SetParError(1,0.008750018);
   ...
   Graph_Graph_mI10dO000000sPppm10211039->SetMinimum(-1.177199);
   Graph_Graph_mI10dO000000sPppm10211039->SetMaximum(-0.8478015);
   ...
   lineFit1040->SetChisquare(1.791029e-27);
   ...
   lineFit1040->SetParameter(0,-2.025);
   lineFit1040->SetParError(0,0.1584696);
   lineFit1040->SetParLimits(0,0,0);
   lineFit1040->SetParameter(1,0.05625);
   lineFit1040->SetParError(1,0.008750018);
   ...
   lineFit1041->SetChisquare(1.791029e-27);
   ...
   lineFit1041->SetParameter(0,-2.025);
   lineFit1041->SetParError(0,0.1584696);
   lineFit1041->SetParLimits(0,0,0);
   lineFit1041->SetParameter(1,0.05625);
   lineFit1041->SetParError(1,0.008750018);
   ...
   Graph_Graph_10dO000000sPppm10231041->SetMinimum(0.06780145);
   Graph_Graph_10dO000000sPppm10231041->SetMaximum(0.1571985);
   ...
   lineFit1042->SetChisquare(1.336354e-27);
   ...
   lineFit1042->SetParameter(0,0.225);
   lineFit1042->SetParError(0,0.1584696);
   lineFit1042->SetParLimits(0,0,0);
   lineFit1042->SetParameter(1,-0.00625);
   lineFit1042->SetParError(1,0.008750018);
   ...
   lineFit1043->SetChisquare(1.336354e-27);
   ...
   lineFit1043->SetParameter(0,0.225);
   lineFit1043->SetParError(0,0.1584696);
   lineFit1043->SetParLimits(0,0,0);
   lineFit1043->SetParameter(1,-0.00625);
   lineFit1043->SetParError(1,0.008750018);
   ...
   Graph_Graph_30dO000000sPppm10251043->SetMinimum(1.042801);
   Graph_Graph_30dO000000sPppm10251043->SetMaximum(1.432199);
   ...
   lineFit1044->SetChisquare(6.439654e-27);
   ...
   lineFit1044->SetParameter(0,2.475);
   lineFit1044->SetParError(0,0.1584696);
   lineFit1044->SetParLimits(0,0,0);
   lineFit1044->SetParameter(1,-0.06875);
   lineFit1044->SetParError(1,0.008750018);
   ...
   lineFit1045->SetChisquare(6.439654e-27);
   ...
   lineFit1045->SetParameter(0,2.475);
   lineFit1045->SetParError(0,0.1584696);
   lineFit1045->SetParLimits(0,0,0);
   lineFit1045->SetParameter(1,-0.06875);
   lineFit1045->SetParError(1,0.008750018);
   ...
   Graph_mI30dO000000sPppm1045->SetMinimum(-2.445254);
   Graph_mI30dO000000sPppm1045->SetMaximum(-1.829746);
   ...
   lineFit1046->SetChisquare(2.819372e-25);
   ...
   lineFit1046->SetParameter(0,-4.275);
   lineFit1046->SetParError(0,0.1214136);
   lineFit1046->SetParLimits(0,0,0);
   lineFit1046->SetParameter(1,0.11875);
   lineFit1046->SetParError(1,0.006703947);
   ...
   lineFit1047->SetChisquare(2.819372e-25);
   ...
   lineFit1047->SetParameter(0,-4.275);
   lineFit1047->SetParError(0,0.1214136);
   lineFit1047->SetParLimits(0,0,0);
   lineFit1047->SetParameter(1,0.11875);
   lineFit1047->SetParError(1,0.006703947);
   ...
   Graph_mI10dO000000sPppm1047->SetMinimum(-1.170254);
   Graph_mI10dO000000sPppm1047->SetMaximum(-0.854746);
   ...
   lineFit1048->SetChisquare(1.265015e-26);
   ...
   lineFit1048->SetParameter(0,-2.025);
   lineFit1048->SetParError(0,0.1214136);
   lineFit1048->SetParLimits(0,0,0);
   lineFit1048->SetParameter(1,0.05625);
   lineFit1048->SetParError(1,0.006703947);
   ...
   lineFit1049->SetChisquare(1.265015e-26);
   ...
   lineFit1049->SetParameter(0,-2.025);
   lineFit1049->SetParError(0,0.1214136);
   lineFit1049->SetParLimits(0,0,0);
   lineFit1049->SetParameter(1,0.05625);
   lineFit1049->SetParError(1,0.006703947);
   ...
   Graph_10dO000000sPppm1049->SetMinimum(0.07474605);
   Graph_10dO000000sPppm1049->SetMaximum(0.150254);
   ...
   lineFit1050->SetChisquare(4.724522e-28);
   ...
   lineFit1050->SetParameter(0,0.225);
   lineFit1050->SetParError(0,0.1214136);
   lineFit1050->SetParLimits(0,0,0);
   lineFit1050->SetParameter(1,-0.00625);
   lineFit1050->SetParError(1,0.006703947);
   ...
   lineFit1051->SetChisquare(4.724522e-28);
   ...
   lineFit1051->SetParameter(0,0.225);
   lineFit1051->SetParError(0,0.1214136);
   lineFit1051->SetParLimits(0,0,0);
   lineFit1051->SetParameter(1,-0.00625);
   lineFit1051->SetParError(1,0.006703947);
   ...
   Graph_30dO000000sPppm1051->SetMinimum(1.049746);
   Graph_30dO000000sPppm1051->SetMaximum(1.425254);
   ...
   lineFit1052->SetChisquare(1.220448e-25);
   ...
   lineFit1052->SetParameter(0,2.475);
   lineFit1052->SetParError(0,0.1214136);
   lineFit1052->SetParLimits(0,0,0);
   lineFit1052->SetParameter(1,-0.06875);
   lineFit1052->SetParError(1,0.006703947);
   ...
   lineFit1053->SetChisquare(1.220448e-25);
   ...
   lineFit1053->SetParameter(0,2.475);
   lineFit1053->SetParError(0,0.1214136);
   lineFit1053->SetParLimits(0,0,0);
   lineFit1053->SetParameter(1,-0.06875);
   lineFit1053->SetParError(1,0.006703947);
