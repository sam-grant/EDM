...
//=========  (Wed Jan  5 17:09:12 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-49.89823,45,69.17149);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(-37.99125);
   Graph_Graph01037->SetMaximum(57.26451);
   ...
   mainFit1038->SetChisquare(3.14719e-13);
   ...
   mainFit1038->SetParameter(0,9.63663);
   mainFit1038->SetParError(0,1.319652);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,1.260788);
   mainFit1038->SetParError(1,0.04398841);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.64334,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.64334,-37.99125,-7.64334,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1039->SetChisquare(3.14719e-13);
   ...
   mainFit1039->SetParameter(0,9.63663);
   mainFit1039->SetParError(0,1.319652);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,1.260788);
   mainFit1039->SetParError(1,0.04398841);
