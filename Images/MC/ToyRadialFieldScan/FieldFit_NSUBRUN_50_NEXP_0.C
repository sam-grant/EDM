...
//=========  (Tue Dec  8 12:25:40 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_Graph01013 = new TH1F("Graph_Graph01013","50 sub-runs",100,-36,36);
   Graph_Graph01013->SetMinimum(-33.65997);
   Graph_Graph01013->SetMaximum(53.91601);
   ...
   mainFit1014->SetChisquare(5.628458e-14);
   ...
   mainFit1014->SetParameter(0,10.12802);
   mainFit1014->SetParError(0,1.319652);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,1.154124);
   mainFit1014->SetParError(1,0.04398841);
   ...
   pt_LaTex = pt->AddText(" 1.15#pm0.044");
   pt_LaTex = pt->AddText(" 10.1#pm 1.32");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.7755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.7755,-33.65997,-8.7755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(5.628458e-14);
   ...
   mainFit1015->SetParameter(0,10.12802);
   mainFit1015->SetParError(0,1.319652);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,1.154124);
   mainFit1015->SetParError(1,0.04398841);
