...
//=========  (Mon Oct 12 20:04:17 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01019->SetMinimum(-0.1831303);
   Graph_Graph01019->SetMaximum(0.11703);
   ...
   TF1 *mainFit1020 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   mainFit1020->SetFillColor(19);
   mainFit1020->SetFillStyle(0);

   ci = TColor::GetColor("#ff0000");
   mainFit1020->SetLineColor(ci);
   mainFit1020->SetLineWidth(2);
   mainFit1020->SetChisquare(3.694168);
   mainFit1020->SetNDF(2);
   mainFit1020->GetXaxis()->SetLabelFont(42);
   mainFit1020->GetXaxis()->SetTitleOffset(1);
   mainFit1020->GetXaxis()->SetTitleFont(42);
   mainFit1020->GetYaxis()->SetLabelFont(42);
   mainFit1020->GetYaxis()->SetTitleFont(42);
   mainFit1020->SetParameter(0,-0.02996282);
   mainFit1020->SetParError(0,0.003666401);
   mainFit1020->SetParLimits(0,0,0);
   mainFit1020->SetParameter(1,-0.003830036);
   mainFit1020->SetParError(1,0.0001639664);
   mainFit1020->SetParLimits(1,0,0);
   mainFit1020->SetParent(gre);
   gre->GetListOfFunctions()->Add(mainFit1020);
   gre->Draw("ap");
   ...
   TF1 *mainFit1021 = new TF1("mainFit","[0]+[1]*x",-36,36, TF1::EAddToList::kNo);
   ...
   mainFit1021->SetChisquare(3.694168);
   mainFit1021->SetNDF(2);
   ...
   mainFit1021->SetParameter(0,-0.02996282);
   mainFit1021->SetParError(0,0.003666401);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,-0.003830036);
   mainFit1021->SetParError(1,0.0001639664);
   mainFit1021->SetParLimits(1,0,0);
   mainFit1021->Draw("same");
