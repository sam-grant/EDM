...
//=========  (Mon Jan 10 15:42:19 2022) by ROOT version 6.24/06
   ...
   c->Range(-75,-84.10703,75,100.5455);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-65.64178);
   Graph_Graph01029->SetMaximum(82.08023);
   ...
   mainFit1030->SetChisquare(1.171112);
   ...
   mainFit1030->SetParameter(0,8.92615);
   mainFit1030->SetParError(0,0.6196036);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.184203);
   mainFit1030->SetParError(1,0.01954644);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.537687,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.537687,-65.64178,-7.537687,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.171112);
   ...
   mainFit1031->SetParameter(0,8.92615);
   mainFit1031->SetParError(0,0.6196036);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.184203);
   mainFit1031->SetParError(1,0.01954644);
