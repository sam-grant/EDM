void FieldFit_NSUBRUN_325_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-82.38394,75,100.7933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01205->SetMinimum(-64.06621);
   Graph_Graph01205->SetMaximum(82.4756);
   ...
   mainFit1206->SetChisquare(5.973613);
   ...
   mainFit1206->SetParameter(0,9.34524);
   mainFit1206->SetParError(0,0.2421887);
   mainFit1206->SetParLimits(0,0,0);
   mainFit1206->SetParameter(1,1.214397);
   mainFit1206->SetParError(1,0.007640435);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.695377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.695377,-64.06621,-7.695377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1207->SetChisquare(5.973613);
   ...
   mainFit1207->SetParameter(0,9.34524);
   mainFit1207->SetParError(0,0.2421887);
   mainFit1207->SetParLimits(0,0,0);
   mainFit1207->SetParameter(1,1.214397);
   mainFit1207->SetParError(1,0.007640435);
