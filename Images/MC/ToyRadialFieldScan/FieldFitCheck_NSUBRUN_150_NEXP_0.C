...
//=========  (Wed Jan  5 17:06:56 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-39.34776,45,56.23545);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-29.78943);
   Graph_Graph01047->SetMaximum(46.67713);
   ...
   checkFit1048->SetChisquare(3.096285e-16);
   ...
   checkFit1048->SetParameter(1,1.032246);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.180073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.180073,-29.78943,-8.180073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(3.096285e-16);
   ...
   checkFit1049->SetParameter(1,1.032246);
