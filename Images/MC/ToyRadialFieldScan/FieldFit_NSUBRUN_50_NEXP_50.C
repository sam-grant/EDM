...
//=========  (Thu May  5 13:01:53 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01029->SetMinimum(-68.00691);
   Graph_Graph01029->SetMaximum(84.74244);
   ...
   mainFit1030->SetChisquare(1.227082);
   ...
   mainFit1030->SetParameter(0,9.408989);
   mainFit1030->SetParError(0,0.6196204);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.216172);
   mainFit1030->SetParError(1,0.01954773);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.736559,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.736559,-68.00691,-7.736559,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.227082);
   ...
   mainFit1031->SetParameter(0,9.408989);
   mainFit1031->SetParError(0,0.6196204);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.216172);
   mainFit1031->SetParError(1,0.01954773);
