...
//=========  (Thu May  5 13:01:56 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01045->SetMinimum(-65.2983);
   Graph_Graph01045->SetMaximum(85.26175);
   ...
   mainFit1046->SetChisquare(3.481406);
   ...
   mainFit1046->SetParameter(0,10.67763);
   mainFit1046->SetParError(0,0.5048768);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,1.211601);
   mainFit1046->SetParError(1,0.01591131);
...
#pm0.02
");
   pt_LaTex = pt->AddText("10.7
#pm0.5
");
   pt_LaTex = pt->AddText("8.8
#pm0.5
");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.812831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.812831,-65.2983,-8.812831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(3.481406);
   ...
   mainFit1047->SetParameter(0,10.67763);
   mainFit1047->SetParError(0,0.5048768);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,1.211601);
   mainFit1047->SetParError(1,0.01591131);
