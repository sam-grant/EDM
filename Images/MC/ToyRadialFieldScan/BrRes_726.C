...
//=========  (Wed Jan  5 17:35:44 2022) by ROOT version 6.24/06
   ...
   TH1D *__33 = new TH1D("__33","Number of sub-runs: 726",240,-11,11);
   __33->SetBinContent(120,1000);
   __33->SetEntries(1000);
   __33->SetStats(0);
   __33->GetXaxis()->SetTitle("#LTB_{r}^{b}#GT truth residual [ppm]");
   __33->GetXaxis()->SetRange(120,120);
   ...
   __33->GetYaxis()->SetTitle("Trials / 0.091667 ppm");
