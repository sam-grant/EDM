...
//=========  (Tue Oct 20 14:21:18 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1017 = new TH1F("Graph_mI50dO000000sPppm1017","",100,13.4,20.6);
   ...
   quadLineFit1018->SetChisquare(37.49931);
   ...
   quadLineFit1018->SetParameter(0,-6.069957);
   quadLineFit1018->SetParError(0,0.07951946);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.1781584);
   quadLineFit1018->SetParError(1,0.004637669);
   ...
   quadLineFit1019->SetChisquare(37.49931);
   ...
   quadLineFit1019->SetParameter(0,-6.069957);
   quadLineFit1019->SetParError(0,0.07951946);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.1781584);
   quadLineFit1019->SetParError(1,0.004637669);
   ...
   TH1F *Graph_mI30dO000000sPppm1019 = new TH1F("Graph_mI30dO000000sPppm1019","Graph",100,13.4,20.6);
   ...
   quadLineFit1020->SetChisquare(8.509597);
   ...
   quadLineFit1020->SetParameter(0,-3.340199);
   quadLineFit1020->SetParError(0,0.0795193);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,0.1032674);
   quadLineFit1020->SetParError(1,0.00463766);
   ...
   quadLineFit1021->SetChisquare(8.509597);
   ...
   quadLineFit1021->SetParameter(0,-3.340199);
   quadLineFit1021->SetParError(0,0.0795193);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,0.1032674);
   quadLineFit1021->SetParError(1,0.00463766);
   ...
   TH1F *Graph_mI10dO000000sPppm1021 = new TH1F("Graph_mI10dO000000sPppm1021","Graph",100,13.4,20.6);
   ...
   quadLineFit1022->SetChisquare(0.7893819);
   ...
   quadLineFit1022->SetParameter(0,-0.3607983);
   quadLineFit1022->SetParError(0,0.07951978);
   quadLineFit1022->SetParLimits(0,0,0);
   quadLineFit1022->SetParameter(1,0.01364665);
   quadLineFit1022->SetParError(1,0.004637688);
   ...
   quadLineFit1023->SetChisquare(0.7893819);
   ...
   quadLineFit1023->SetParameter(0,-0.3607983);
   quadLineFit1023->SetParError(0,0.07951978);
   quadLineFit1023->SetParLimits(0,0,0);
   quadLineFit1023->SetParameter(1,0.01364665);
   quadLineFit1023->SetParError(1,0.004637688);
   ...
   TH1F *Graph_10dO000000sPppm1023 = new TH1F("Graph_10dO000000sPppm1023","Graph",100,13.4,20.6);
   ...
   quadLineFit1024->SetChisquare(4.282921);
   ...
   quadLineFit1024->SetParameter(0,2.636964);
   quadLineFit1024->SetParError(0,0.07951917);
   quadLineFit1024->SetParLimits(0,0,0);
   quadLineFit1024->SetParameter(1,-0.07874917);
   quadLineFit1024->SetParError(1,0.004637652);
   ...
   quadLineFit1025->SetChisquare(4.282921);
   ...
   quadLineFit1025->SetParameter(0,2.636964);
   quadLineFit1025->SetParError(0,0.07951917);
   quadLineFit1025->SetParLimits(0,0,0);
   quadLineFit1025->SetParameter(1,-0.07874917);
   quadLineFit1025->SetParError(1,0.004637652);
   ...
   TH1F *Graph_30dO000000sPppm1025 = new TH1F("Graph_30dO000000sPppm1025","Graph",100,13.4,20.6);
   ...
   quadLineFit1026->SetChisquare(24.36668);
   ...
   quadLineFit1026->SetParameter(0,5.507765);
   quadLineFit1026->SetParError(0,0.07951997);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,-0.1621346);
   quadLineFit1026->SetParError(1,0.0046377);
   ...
   quadLineFit1027->SetChisquare(24.36668);
   ...
   quadLineFit1027->SetParameter(0,5.507765);
   quadLineFit1027->SetParError(0,0.07951997);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,-0.1621346);
   quadLineFit1027->SetParError(1,0.0046377);
   ...
   TH1F *Graph_50dO000000sPppm1027 = new TH1F("Graph_50dO000000sPppm1027","Graph",100,13.4,20.6);
   ...
   quadLineFit1028->SetChisquare(50.62243);
   ...
   quadLineFit1028->SetParameter(0,8.437134);
   quadLineFit1028->SetParError(0,0.07951806);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.2498838);
   quadLineFit1028->SetParError(1,0.004637586);
   ...
   quadLineFit1029->SetChisquare(50.62243);
   ...
   quadLineFit1029->SetParameter(0,8.437134);
   quadLineFit1029->SetParError(0,0.07951806);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.2498838);
   quadLineFit1029->SetParError(1,0.004637586);
