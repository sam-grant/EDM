...
//=========  (Tue Oct 20 14:21:22 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1065 = new TH1F("Graph_mI50dO000000sPppm1065","",100,13.4,20.6);
   ...
   quadLineFit1066->SetChisquare(39.41276);
   ...
   quadLineFit1066->SetParameter(0,-6.028429);
   quadLineFit1066->SetParError(0,0.05060205);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,0.1764435);
   quadLineFit1066->SetParError(1,0.002951151);
   ...
   quadLineFit1067->SetChisquare(39.41276);
   ...
   quadLineFit1067->SetParameter(0,-6.028429);
   quadLineFit1067->SetParError(0,0.05060205);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,0.1764435);
   quadLineFit1067->SetParError(1,0.002951151);
   ...
   TH1F *Graph_mI30dO000000sPppm1067 = new TH1F("Graph_mI30dO000000sPppm1067","Graph",100,13.4,20.6);
   ...
   quadLineFit1068->SetChisquare(16.40844);
   ...
   quadLineFit1068->SetParameter(0,-3.152991);
   quadLineFit1068->SetParError(0,0.05062332);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,0.09277377);
   quadLineFit1068->SetParError(1,0.002952412);
   ...
   quadLineFit1069->SetChisquare(16.40844);
   ...
   quadLineFit1069->SetParameter(0,-3.152991);
   quadLineFit1069->SetParError(0,0.05062332);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,0.09277377);
   quadLineFit1069->SetParError(1,0.002952412);
   ...
   TH1F *Graph_mI10dO000000sPppm1069 = new TH1F("Graph_mI10dO000000sPppm1069","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1070 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1070->SetChisquare(0.216071);
   ...
   quadLineFit1070->SetParameter(0,-0.3308524);
   quadLineFit1070->SetParError(0,0.050623);
   quadLineFit1070->SetParLimits(0,0,0);
   quadLineFit1070->SetParameter(1,0.01129526);
   quadLineFit1070->SetParError(1,0.002952393);
   quadLineFit1070->SetParLimits(1,0,0);
   quadLineFit1070->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1070);
   gre->Draw("p ");
   
   TF1 *quadLineFit1071 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1071->SetChisquare(0.216071);
   ...
   quadLineFit1071->SetParameter(0,-0.3308524);
   quadLineFit1071->SetParError(0,0.050623);
   quadLineFit1071->SetParLimits(0,0,0);
   quadLineFit1071->SetParameter(1,0.01129526);
   quadLineFit1071->SetParError(1,0.002952393);
   ...
   TH1F *Graph_10dO000000sPppm1071 = new TH1F("Graph_10dO000000sPppm1071","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1072 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1072->SetChisquare(11.7375);
   ...
   quadLineFit1072->SetParameter(0,2.588496);
   quadLineFit1072->SetParError(0,0.05062268);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,-0.07621894);
   quadLineFit1072->SetParError(1,0.002952374);
   quadLineFit1072->SetParLimits(1,0,0);
   quadLineFit1072->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1072);
   gre->Draw("p ");
   
   TF1 *quadLineFit1073 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1073->SetChisquare(11.7375);
   ...
   quadLineFit1073->SetParameter(0,2.588496);
   quadLineFit1073->SetParError(0,0.05062268);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,-0.07621894);
   quadLineFit1073->SetParError(1,0.002952374);
   ...
   TH1F *Graph_30dO000000sPppm1073 = new TH1F("Graph_30dO000000sPppm1073","Graph",100,13.4,20.6);
   ...
   quadLineFit1074->SetChisquare(62.49157);
   ...
   quadLineFit1074->SetParameter(0,5.581881);
   quadLineFit1074->SetParError(0,0.05062356);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,-0.1676411);
   quadLineFit1074->SetParError(1,0.002952427);
   ...
   quadLineFit1075->SetChisquare(62.49157);
   ...
   quadLineFit1075->SetParameter(0,5.581881);
   quadLineFit1075->SetParError(0,0.05062356);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,-0.1676411);
   quadLineFit1075->SetParError(1,0.002952427);
   ...
   TH1F *Graph_50dO000000sPppm1075 = new TH1F("Graph_50dO000000sPppm1075","Graph",100,13.4,20.6);
   ...
   quadLineFit1076->SetChisquare(73.01602);
   ...
   quadLineFit1076->SetParameter(0,8.415199);
   quadLineFit1076->SetParError(0,0.05062181);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.2486454);
   quadLineFit1076->SetParError(1,0.002952323);
   ...
   quadLineFit1077->SetChisquare(73.01602);
   ...
   quadLineFit1077->SetParameter(0,8.415199);
   quadLineFit1077->SetParError(0,0.05062181);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.2486454);
   quadLineFit1077->SetParError(1,0.002952323);
