...
//=========  (Tue Oct 20 14:21:23 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1081 = new TH1F("Graph_mI50dO000000sPppm1081","",100,13.4,20.6);
   ...
   TF1 *quadLineFit1082 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1082->SetFillColor(19);
   quadLineFit1082->SetFillStyle(0);
   quadLineFit1082->SetLineWidth(2);
   quadLineFit1082->SetChisquare(28.90422);
   ...
   quadLineFit1082->SetParameter(0,-6.104977);
   quadLineFit1082->SetParError(0,0.04619245);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.1813051);
   quadLineFit1082->SetParError(1,0.002693999);
   quadLineFit1082->SetParLimits(1,0,0);
   quadLineFit1082->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1082);
   gre->Draw("ap");
   
   TF1 *quadLineFit1083 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1083->SetFillColor(19);
   quadLineFit1083->SetFillStyle(0);
   quadLineFit1083->SetLineWidth(2);
   quadLineFit1083->SetChisquare(28.90422);
   ...
   quadLineFit1083->SetParameter(0,-6.104977);
   quadLineFit1083->SetParError(0,0.04619245);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.1813051);
   quadLineFit1083->SetParError(1,0.002693999);
   ...
   TH1F *Graph_mI30dO000000sPppm1083 = new TH1F("Graph_mI30dO000000sPppm1083","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1084 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1084->SetChisquare(16.96391);
   ...
   quadLineFit1084->SetParameter(0,-3.192165);
   quadLineFit1084->SetParError(0,0.04619197);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.09355038);
   quadLineFit1084->SetParError(1,0.002693971);
   quadLineFit1084->SetParLimits(1,0,0);
   quadLineFit1084->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1084);
   gre->Draw("p ");
   
   TF1 *quadLineFit1085 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1085->SetChisquare(16.96391);
   ...
   quadLineFit1085->SetParameter(0,-3.192165);
   quadLineFit1085->SetParError(0,0.04619197);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.09355038);
   quadLineFit1085->SetParError(1,0.002693971);
   ...
   TH1F *Graph_mI10dO000000sPppm1085 = new TH1F("Graph_mI10dO000000sPppm1085","Graph",100,13.4,20.6);
   ...
   quadLineFit1086->SetChisquare(1.031067);
   ...
   quadLineFit1086->SetParameter(0,-0.2786695);
   quadLineFit1086->SetParError(0,0.04619168);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.007779458);
   quadLineFit1086->SetParError(1,0.002693953);
   ...
   quadLineFit1087->SetChisquare(1.031067);
   ...
   quadLineFit1087->SetParameter(0,-0.2786695);
   quadLineFit1087->SetParError(0,0.04619168);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.007779458);
   quadLineFit1087->SetParError(1,0.002693953);
   ...
   TH1F *Graph_10dO000000sPppm1087 = new TH1F("Graph_10dO000000sPppm1087","Graph",100,13.4,20.6);
   ...
   quadLineFit1088->SetChisquare(5.071754);
   ...
   quadLineFit1088->SetParameter(0,2.579121);
   quadLineFit1088->SetParError(0,0.04619247);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.07541464);
   quadLineFit1088->SetParError(1,0.002694);
   ...
   quadLineFit1089->SetChisquare(5.071754);
   ...
   quadLineFit1089->SetParameter(0,2.579121);
   quadLineFit1089->SetParError(0,0.04619247);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.07541464);
   quadLineFit1089->SetParError(1,0.002694);
   ...
   TH1F *Graph_30dO000000sPppm1089 = new TH1F("Graph_30dO000000sPppm1089","Graph",100,13.4,20.6);
   ...
   quadLineFit1090->SetChisquare(18.27908);
   ...
   quadLineFit1090->SetParameter(0,5.489796);
   quadLineFit1090->SetParError(0,0.04619196);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.1616805);
   quadLineFit1090->SetParError(1,0.00269397);
   ...
   quadLineFit1091->SetChisquare(18.27908);
   ...
   quadLineFit1091->SetParameter(0,5.489796);
   quadLineFit1091->SetParError(0,0.04619196);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.1616805);
   quadLineFit1091->SetParError(1,0.00269397);
   ...
   TH1F *Graph_50dO000000sPppm1091 = new TH1F("Graph_50dO000000sPppm1091","Graph",100,13.4,20.6);
   ...
   quadLineFit1092->SetChisquare(89.89848);
   ...
   quadLineFit1092->SetParameter(0,8.424252);
   quadLineFit1092->SetParError(0,0.04619255);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.2491403);
   quadLineFit1092->SetParError(1,0.002694005);
   ...
   quadLineFit1093->SetChisquare(89.89848);
   ...
   quadLineFit1093->SetParameter(0,8.424252);
   quadLineFit1093->SetParError(0,0.04619255);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.2491403);
   quadLineFit1093->SetParError(1,0.002694005);
