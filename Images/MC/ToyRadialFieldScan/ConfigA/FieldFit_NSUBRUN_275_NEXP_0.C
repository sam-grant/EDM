...
//=========  (Tue Oct 20 14:21:29 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3549744,75,0.2866814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01173->SetMinimum(-0.2908088);
   Graph_Graph01173->SetMaximum(0.2225158);
   ...
   mainFit1174->SetChisquare(2.002659);
   ...
   mainFit1174->SetParameter(0,-0.03465275);
   mainFit1174->SetParError(0,0.0008113748);
   mainFit1174->SetParLimits(0,0,0);
   mainFit1174->SetParameter(1,-0.004254355);
   mainFit1174->SetParError(1,2.375462e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00425#pm2.38e-05");
   pt_LaTex = pt->AddText("#minus0.0347#pm0.000811");
   pt_LaTex = pt->AddText("#minus8.15#pm0.196");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.145241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.145241,-0.2908088,-8.145241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1175->SetChisquare(2.002659);
   ...
   mainFit1175->SetParameter(0,-0.03465275);
   mainFit1175->SetParError(0,0.0008113748);
   mainFit1175->SetParLimits(0,0,0);
   mainFit1175->SetParameter(1,-0.004254355);
   mainFit1175->SetParError(1,2.375462e-05);
