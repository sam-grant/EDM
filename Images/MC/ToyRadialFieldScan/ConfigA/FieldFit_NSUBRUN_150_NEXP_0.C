...
//=========  (Tue Oct 20 14:21:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3607926,75,0.2929575);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2954176);
   Graph_Graph01093->SetMaximum(0.2275825);
   ...
   mainFit1094->SetChisquare(0.9374587);
   ...
   mainFit1094->SetParameter(0,-0.03393302);
   mainFit1094->SetParError(0,0.001099814);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.004287303);
   mainFit1094->SetParError(1,3.219938e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.234");
   pt_LaTex = pt->AddText("#minus0.00429#pm3.22e-05");
   pt_LaTex = pt->AddText("#minus0.0339#pm0.0011");
   pt_LaTex = pt->AddText("#minus7.91#pm0.263");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.914772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.914772,-0.2954176,-7.914772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(0.9374587);
   ...
   mainFit1095->SetParameter(0,-0.03393302);
   mainFit1095->SetParError(0,0.001099814);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.004287303);
   mainFit1095->SetParError(1,3.219938e-05);
