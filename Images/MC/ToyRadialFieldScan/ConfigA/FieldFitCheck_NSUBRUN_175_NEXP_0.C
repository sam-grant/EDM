...
//=========  (Tue Oct 20 14:21:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.44522,75,85.00564);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-53.10013);
   Graph_Graph01111->SetMaximum(69.66056);
   ...
   checkFit1112->SetParameter(0,8.16655);
   checkFit1112->SetParError(0,0.2493283);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,1.008981);
   checkFit1112->SetParError(1,0.007299585);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0073");
   pt_LaTex = pt->AddText(" 8.17#pm0.249");
   pt_LaTex = pt->AddText("#minus8.09#pm0.254");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.093856,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.093856,-53.10013,-8.093856,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetParameter(0,8.16655);
   checkFit1113->SetParError(0,0.2493283);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,1.008981);
   checkFit1113->SetParError(1,0.007299585);
