...
//=========  (Tue Oct 20 14:21:32 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3572645,75,0.2902822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01205->SetMinimum(-0.2925098);
   Graph_Graph01205->SetMaximum(0.2255275);
   ...
   mainFit1206->SetChisquare(2.992658);
   ...
   mainFit1206->SetParameter(0,-0.03430025);
   mainFit1206->SetParError(0,0.0007462602);
   mainFit1206->SetParLimits(0,0,0);
   mainFit1206->SetParameter(1,-0.004294402);
   mainFit1206->SetParError(1,2.184825e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.748");
   pt_LaTex = pt->AddText("#minus0.00429#pm2.18e-05");
   pt_LaTex = pt->AddText("#minus0.0343#pm0.000746");
   pt_LaTex = pt->AddText("#minus7.99#pm0.178");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.987199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.987199,-0.2925098,-7.987199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1207->SetChisquare(2.992658);
   ...
   mainFit1207->SetParameter(0,-0.03430025);
   mainFit1207->SetParError(0,0.0007462602);
   mainFit1207->SetParLimits(0,0,0);
   mainFit1207->SetParameter(1,-0.004294402);
   mainFit1207->SetParError(1,2.184825e-05);
