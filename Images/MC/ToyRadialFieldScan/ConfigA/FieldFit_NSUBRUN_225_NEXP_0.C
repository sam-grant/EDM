...
//=========  (Tue Oct 20 14:21:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3618246,75,0.291025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01141->SetMinimum(-0.2965397);
   Graph_Graph01141->SetMaximum(0.22574);
   ...
   mainFit1142->SetChisquare(2.922349);
   ...
   mainFit1142->SetParameter(0,-0.03519922);
   mainFit1142->SetParError(0,0.0008972482);
   mainFit1142->SetParLimits(0,0,0);
   mainFit1142->SetParameter(1,-0.004305008);
   mainFit1142->SetParError(1,2.626896e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00431#pm2.63e-05");
   pt_LaTex = pt->AddText("#minus0.0352#pm0.000897");
   pt_LaTex = pt->AddText("#minus8.18#pm0.214");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.176341,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.176341,-0.2965397,-8.176341,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1143->SetChisquare(2.922349);
   ...
   mainFit1143->SetParameter(0,-0.03519922);
   mainFit1143->SetParError(0,0.0008972482);
   mainFit1143->SetParLimits(0,0,0);
   mainFit1143->SetParameter(1,-0.004305008);
   mainFit1143->SetParError(1,2.626896e-05);
