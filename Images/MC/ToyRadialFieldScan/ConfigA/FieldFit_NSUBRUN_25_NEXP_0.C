...
//=========  (Tue Oct 20 14:21:17 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3587631,75,0.2833296);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-0.2945538);
   Graph_Graph01013->SetMaximum(0.2191203);
   ...
   mainFit1014->SetChisquare(3.366183);
   ...
   mainFit1014->SetParameter(0,-0.03746491);
   mainFit1014->SetParError(0,0.00266783);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,-0.004202211);
   mainFit1014->SetParError(1,7.81062e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0042#pm7.81e-05");
   pt_LaTex = pt->AddText("#minus0.0375#pm0.00267");
   pt_LaTex = pt->AddText("#minus8.92#pm0.656");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.915522,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.915522,-0.2945538,-8.915522,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(3.366183);
   ...
   mainFit1015->SetParameter(0,-0.03746491);
   mainFit1015->SetParError(0,0.00266783);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,-0.004202211);
   mainFit1015->SetParError(1,7.81062e-05);
