...
//=========  (Tue Oct 20 14:21:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3567589,75,0.2902048);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-0.2920625);
   Graph_Graph01061->SetMaximum(0.2255084);
   ...
   mainFit1062->SetChisquare(0.9033381);
   ...
   mainFit1062->SetParameter(0,-0.03433987);
   mainFit1062->SetParError(0,0.001348636);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,-0.004261981);
   mainFit1062->SetParError(1,3.948388e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.226");
   pt_LaTex = pt->AddText("#minus0.00426#pm3.95e-05");
   pt_LaTex = pt->AddText("#minus0.0343#pm0.00135");
   pt_LaTex = pt->AddText("#minus8.06#pm0.325");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.057256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.057256,-0.2920625,-8.057256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(0.9033381);
   ...
   mainFit1063->SetParameter(0,-0.03433987);
   mainFit1063->SetParError(0,0.001348636);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,-0.004261981);
   mainFit1063->SetParError(1,3.948388e-05);
