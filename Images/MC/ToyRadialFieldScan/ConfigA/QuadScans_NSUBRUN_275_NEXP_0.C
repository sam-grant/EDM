...
//=========  (Tue Oct 20 14:21:29 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI50dO000000sPppm1161 = new TH1F("Graph_mI50dO000000sPppm1161","",100,13.4,20.6);
   ...
   TF1 *quadLineFit1162 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1162->SetFillColor(19);
   quadLineFit1162->SetFillStyle(0);
   quadLineFit1162->SetLineWidth(2);
   quadLineFit1162->SetChisquare(101.5437);
   ...
   quadLineFit1162->SetParameter(0,-6.05099);
   quadLineFit1162->SetParError(0,0.03407723);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,0.1777513);
   quadLineFit1162->SetParError(1,0.001987424);
   quadLineFit1162->SetParLimits(1,0,0);
   quadLineFit1162->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1162);
   gre->Draw("ap");
   
   TF1 *quadLineFit1163 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   quadLineFit1163->SetFillColor(19);
   quadLineFit1163->SetFillStyle(0);
   quadLineFit1163->SetLineWidth(2);
   quadLineFit1163->SetChisquare(101.5437);
   ...
   quadLineFit1163->SetParameter(0,-6.05099);
   quadLineFit1163->SetParError(0,0.03407723);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,0.1777513);
   quadLineFit1163->SetParError(1,0.001987424);
   ...
   TH1F *Graph_mI30dO000000sPppm1163 = new TH1F("Graph_mI30dO000000sPppm1163","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1164 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1164->SetChisquare(13.40878);
   ...
   quadLineFit1164->SetParameter(0,-3.195533);
   quadLineFit1164->SetParError(0,0.03407789);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,0.09473484);
   quadLineFit1164->SetParError(1,0.001987463);
   quadLineFit1164->SetParLimits(1,0,0);
   quadLineFit1164->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1164);
   gre->Draw("p ");
   
   TF1 *quadLineFit1165 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1165->SetChisquare(13.40878);
   ...
   quadLineFit1165->SetParameter(0,-3.195533);
   quadLineFit1165->SetParError(0,0.03407789);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,0.09473484);
   quadLineFit1165->SetParError(1,0.001987463);
   ...
   TH1F *Graph_mI10dO000000sPppm1165 = new TH1F("Graph_mI10dO000000sPppm1165","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1166 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1166->SetChisquare(0.4034332);
   ...
   quadLineFit1166->SetParameter(0,-0.2751353);
   quadLineFit1166->SetParError(0,0.03407766);
   quadLineFit1166->SetParLimits(0,0,0);
   quadLineFit1166->SetParameter(1,0.007267807);
   quadLineFit1166->SetParError(1,0.001987449);
   quadLineFit1166->SetParLimits(1,0,0);
   quadLineFit1166->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1166);
   gre->Draw("p ");
   
   TF1 *quadLineFit1167 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1167->SetChisquare(0.4034332);
   ...
   quadLineFit1167->SetParameter(0,-0.2751353);
   quadLineFit1167->SetParError(0,0.03407766);
   quadLineFit1167->SetParLimits(0,0,0);
   quadLineFit1167->SetParameter(1,0.007267807);
   quadLineFit1167->SetParError(1,0.001987449);
   ...
   TH1F *Graph_10dO000000sPppm1167 = new TH1F("Graph_10dO000000sPppm1167","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1168 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1168->SetChisquare(21.61112);
   ...
   quadLineFit1168->SetParameter(0,2.624953);
   quadLineFit1168->SetParError(0,0.03407743);
   quadLineFit1168->SetParLimits(0,0,0);
   quadLineFit1168->SetParameter(1,-0.07864009);
   quadLineFit1168->SetParError(1,0.001987436);
   quadLineFit1168->SetParLimits(1,0,0);
   quadLineFit1168->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1168);
   gre->Draw("p ");
   
   TF1 *quadLineFit1169 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1169->SetChisquare(21.61112);
   ...
   quadLineFit1169->SetParameter(0,2.624953);
   quadLineFit1169->SetParError(0,0.03407743);
   quadLineFit1169->SetParLimits(0,0,0);
   quadLineFit1169->SetParameter(1,-0.07864009);
   quadLineFit1169->SetParError(1,0.001987436);
   ...
   TH1F *Graph_30dO000000sPppm1169 = new TH1F("Graph_30dO000000sPppm1169","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1170 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1170->SetChisquare(76.78048);
   ...
   quadLineFit1170->SetParameter(0,5.516227);
   quadLineFit1170->SetParError(0,0.03407827);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,-0.1629861);
   quadLineFit1170->SetParError(1,0.001987486);
   quadLineFit1170->SetParLimits(1,0,0);
   quadLineFit1170->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1170);
   gre->Draw("p ");
   
   TF1 *quadLineFit1171 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1171->SetChisquare(76.78048);
   ...
   quadLineFit1171->SetParameter(0,5.516227);
   quadLineFit1171->SetParError(0,0.03407827);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,-0.1629861);
   quadLineFit1171->SetParError(1,0.001987486);
   ...
   TH1F *Graph_50dO000000sPppm1171 = new TH1F("Graph_50dO000000sPppm1171","Graph",100,13.4,20.6);
   ...
   TF1 *quadLineFit1172 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1172->SetChisquare(190.3579);
   ...
   quadLineFit1172->SetParameter(0,8.367677);
   quadLineFit1172->SetParError(0,0.034078);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,-0.2460443);
   quadLineFit1172->SetParError(1,0.00198747);
   quadLineFit1172->SetParLimits(1,0,0);
   quadLineFit1172->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1172);
   gre->Draw("p ");
   
   TF1 *quadLineFit1173 = new TF1("quadLineFit","[0]+[1]*x",13.4,20.6, TF1::EAddToList::kNo);
   ...
   quadLineFit1173->SetChisquare(190.3579);
   ...
   quadLineFit1173->SetParameter(0,8.367677);
   quadLineFit1173->SetParError(0,0.034078);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,-0.2460443);
   quadLineFit1173->SetParError(1,0.00198747);
