void QuadScans_NSUBRUN_25_NEXP_50()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:01:50 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.184042,0.0663141,7.453738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1001->SetMinimum(-3.920264);
   Graph_mI50dO000000sPppm1001->SetMaximum(6.18996);
   ...
   quadLineFit1002->SetChisquare(0.052657);
   ...
   quadLineFit1002->SetParameter(0,-0.1434786);
   quadLineFit1002->SetParError(0,0.2109441);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,-47.91746);
   quadLineFit1002->SetParError(1,3.724634);
   ...
   quadLineFit1003->SetChisquare(0.052657);
   ...
   quadLineFit1003->SetParameter(0,-0.1434786);
   quadLineFit1003->SetParError(0,0.2109441);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,-47.91746);
   quadLineFit1003->SetParError(1,3.724634);
   ...
   Graph_mI30dO000000sPppm1003->SetMinimum(-1.969901);
   Graph_mI30dO000000sPppm1003->SetMaximum(-1.30341);
   ...
   quadLineFit1004->SetChisquare(0.2436059);
   ...
   quadLineFit1004->SetParameter(0,-0.1530159);
   quadLineFit1004->SetParError(0,0.1186692);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-24.26587);
   quadLineFit1004->SetParError(1,1.955901);
   ...
   quadLineFit1005->SetChisquare(0.2436059);
   ...
   quadLineFit1005->SetParameter(0,-0.1530159);
   quadLineFit1005->SetParError(0,0.1186692);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-24.26587);
   quadLineFit1005->SetParError(1,1.955901);
   ...
   Graph_mI10dO000000sPppm1005->SetMinimum(-0.2638479);
   Graph_mI10dO000000sPppm1005->SetMaximum(-0.06342366);
   ...
   quadLineFit1006->SetChisquare(1.109268);
   ...
   quadLineFit1006->SetParameter(0,0.1629406);
   quadLineFit1006->SetParError(0,0.1186732);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-5.12589);
   quadLineFit1006->SetParError(1,1.955967);
   ...
   quadLineFit1007->SetChisquare(1.109268);
   ...
   quadLineFit1007->SetParameter(0,0.1629406);
   quadLineFit1007->SetParError(0,0.1186732);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-5.12589);
   quadLineFit1007->SetParError(1,1.955967);
   ...
   Graph_10dO000000sPppm1007->SetMinimum(1.085284);
   Graph_10dO000000sPppm1007->SetMaximum(1.63723);
   ...
   quadLineFit1008->SetChisquare(1.702876);
   ...
   quadLineFit1008->SetParameter(0,0.1372523);
   quadLineFit1008->SetParError(0,0.1301099);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,19.69105);
   quadLineFit1008->SetParError(1,2.088955);
   ...
   quadLineFit1009->SetChisquare(1.702876);
   ...
   quadLineFit1009->SetParameter(0,0.1372523);
   quadLineFit1009->SetParError(0,0.1301099);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,19.69105);
   quadLineFit1009->SetParError(1,2.088955);
   ...
   Graph_30dO000000sPppm1009->SetMinimum(2.242849);
   Graph_30dO000000sPppm1009->SetMaximum(3.458172);
   ...
   quadLineFit1010->SetChisquare(1.805238);
   ...
   quadLineFit1010->SetParameter(0,-0.0547679);
   quadLineFit1010->SetParError(0,0.118673);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,47.09202);
   quadLineFit1010->SetParError(1,1.955963);
   ...
   quadLineFit1011->SetChisquare(1.805238);
   ...
   quadLineFit1011->SetParameter(0,-0.0547679);
   quadLineFit1011->SetParError(0,0.118673);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,47.09202);
   quadLineFit1011->SetParError(1,1.955963);
   ...
   Graph_50dO000000sPppm1011->SetMinimum(3.439043);
   Graph_50dO000000sPppm1011->SetMaximum(5.122041);
   ...
   quadLineFit1012->SetChisquare(0.6986356);
   ...
   quadLineFit1012->SetParameter(0,0.2166222);
   quadLineFit1012->SetParError(0,0.1185604);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,66.43623);
   quadLineFit1012->SetParError(1,1.954084);
   ...
   quadLineFit1013->SetChisquare(0.6986356);
   ...
   quadLineFit1013->SetParameter(0,0.2166222);
   quadLineFit1013->SetParError(0,0.1185604);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,66.43623);
   quadLineFit1013->SetParError(1,1.954084);
