void FieldFit_NSUBRUN_200_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-85.24913,75,103.1191);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01125->SetMinimum(-66.41231);
   Graph_Graph01125->SetMaximum(84.28226);
   ...
   mainFit1126->SetChisquare(8.199398);
   ...
   mainFit1126->SetParameter(0,8.745023);
   mainFit1126->SetParError(0,0.309238);
   mainFit1126->SetParLimits(0,0,0);
   mainFit1126->SetParameter(1,1.223439);
   mainFit1126->SetParError(1,0.009755652);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.1479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.1479,-66.41231,-7.1479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1127->SetChisquare(8.199398);
   ...
   mainFit1127->SetParameter(0,8.745023);
   mainFit1127->SetParError(0,0.309238);
   mainFit1127->SetParLimits(0,0,0);
   mainFit1127->SetParameter(1,1.223439);
   mainFit1127->SetParError(1,0.009755652);
