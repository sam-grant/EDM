void FieldFitCheck_NSUBRUN_175_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-107.2649,75,397.488);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01111->SetMinimum(-56.78959);
   Graph_Graph01111->SetMaximum(347.0127);
   ...
   Graph_Graph01111->GetYaxis()->SetTitle("#Delta#LTy#GT#upoint#DeltaV [mm#upointkV]");
   ...
   checkFit1112->SetChisquare(141698.2);
   ...
   checkFit1112->SetParameter(0,66.82886);
   checkFit1112->SetParError(0,0.265953);
   checkFit1112->SetParLimits(0,0,0);
   checkFit1112->SetParameter(1,-1.533254);
   checkFit1112->SetParError(1,0.007786305);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("3.54e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.58629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.58629,-56.78959,43.58629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1113->SetChisquare(141698.2);
   ...
   checkFit1113->SetParameter(0,66.82886);
   checkFit1113->SetParError(0,0.265953);
   checkFit1113->SetParLimits(0,0,0);
   checkFit1113->SetParameter(1,-1.533254);
   checkFit1113->SetParError(1,0.007786305);
