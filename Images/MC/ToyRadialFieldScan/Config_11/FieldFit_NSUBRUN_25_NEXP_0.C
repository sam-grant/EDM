...
//=========  (Fri Oct 16 07:56:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3217932,75,0.249283);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01005->SetMinimum(-0.2646855);
   Graph_Graph01005->SetMaximum(0.1921754);
   ...
   mainFit1006->SetChisquare(1.25598e-16);
   ...
   mainFit1006->SetParameter(0,-0.03625525);
   mainFit1006->SetParError(0,0.007306279);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,-0.003600522);
   mainFit1006->SetParError(1,0.0001461256);
   ...
   pt_LaTex = pt->AddText("#minus0.0036#pm0.000146");
   pt_LaTex = pt->AddText("#minus0.0363#pm0.00731");
   pt_LaTex = pt->AddText("#minus10.1#pm 2.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-10.06944,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.06944,-0.2646855,-10.06944,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(1.25598e-16);
   ...
   mainFit1007->SetParameter(0,-0.03625525);
   mainFit1007->SetParError(0,0.007306279);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,-0.003600522);
   mainFit1007->SetParError(1,0.0001461256);
