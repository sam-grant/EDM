...
//=========  (Fri Oct 16 07:56:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3245664,75,0.2557355);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01061->SetMinimum(-0.2665362);
   Graph_Graph01061->SetMaximum(0.1977053);
   ...
   mainFit1062->SetChisquare(1.78452e-09);
   ...
   mainFit1062->SetParameter(0,-0.03441309);
   mainFit1062->SetParError(0,0.002605914);
   mainFit1062->SetParLimits(0,0,0);
   mainFit1062->SetParameter(1,-0.003794973);
   mainFit1062->SetParError(1,5.211829e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00379#pm5.21e-05");
   pt_LaTex = pt->AddText("#minus0.0344#pm0.00261");
   pt_LaTex = pt->AddText("#minus9.07#pm0.698");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.068073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.068073,-0.2665362,-9.068073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1063->SetChisquare(1.78452e-09);
   ...
   mainFit1063->SetParameter(0,-0.03441309);
   mainFit1063->SetParError(0,0.002605914);
   mainFit1063->SetParLimits(0,0,0);
   mainFit1063->SetParameter(1,-0.003794973);
   mainFit1063->SetParError(1,5.211829e-05);
