...
//=========  (Fri Oct 16 07:56:20 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.19465,75,85.44913);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01007->SetMinimum(-51.03027);
   Graph_Graph01007->SetMaximum(70.28475);
   ...
   checkFit1008->SetChisquare(1.487086e-17);
   ...
   checkFit1008->SetParameter(0,9.627239);
   checkFit1008->SetParError(0,1.940083);
   checkFit1008->SetParLimits(0,0,0);
   checkFit1008->SetParameter(1,0.9560847);
   ...
   pt_LaTex = pt->AddText("0.956#pm0.0388");
   pt_LaTex = pt->AddText(" 9.63#pm 1.94");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.06944,-51.03027,-10.06944,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1009->SetChisquare(1.487086e-17);
   ...
   checkFit1009->SetParameter(0,9.627239);
   checkFit1009->SetParError(0,1.940083);
   checkFit1009->SetParLimits(0,0,0);
   checkFit1009->SetParameter(1,0.9560847);
