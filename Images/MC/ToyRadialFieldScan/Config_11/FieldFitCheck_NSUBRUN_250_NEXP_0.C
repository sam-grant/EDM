...
//=========  (Fri Oct 16 07:56:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.32137,75,85.93921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01079 = new TH1F("Graph_Graph01079","Sub-runs 250",100,-60,60);
   Graph_Graph01079->SetMinimum(-53.79531);
   Graph_Graph01079->SetMaximum(70.41315);
   ...
   checkFit1080->SetChisquare(2.514795e-17);
   ...
   checkFit1080->SetParameter(0,8.308921);
   checkFit1080->SetParError(0,0.6188939);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,1.017566);
   checkFit1080->SetParError(1,0.01237788);
   ...
   pt_LaTex = pt->AddText(" 8.31#pm0.619");
   pt_LaTex = pt->AddText("#minus8.17#pm0.616");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.165489,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.165489,-53.79531,-8.165489,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(2.514795e-17);
   ...
   checkFit1081->SetParameter(0,8.308921);
   checkFit1081->SetParError(0,0.6188939);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,1.017566);
   checkFit1081->SetParError(1,0.01237788);
