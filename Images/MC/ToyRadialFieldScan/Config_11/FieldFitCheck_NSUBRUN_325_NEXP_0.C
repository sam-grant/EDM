...
//=========  (Fri Oct 16 07:56:29 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.51129,75,84.19715);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01103->SetMinimum(-53.24045);
   Graph_Graph01103->SetMaximum(68.9263);
   ...
   checkFit1104->SetChisquare(3.479686e-16);
   ...
   checkFit1104->SetParameter(0,7.842925);
   checkFit1104->SetParError(0,0.5426922);
   checkFit1104->SetParLimits(0,0,0);
   checkFit1104->SetParameter(1,1.002707);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0109");
   pt_LaTex = pt->AddText(" 7.84#pm0.543");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.821755,-53.24045,-7.821755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1105->SetChisquare(3.479686e-16);
   ...
   checkFit1105->SetParameter(0,7.842925);
   checkFit1105->SetParError(0,0.5426922);
   checkFit1105->SetParLimits(0,0,0);
   checkFit1105->SetParameter(1,1.002707);
