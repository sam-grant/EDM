...
//=========  (Fri Oct 16 07:56:24 2020) by ROOT version 6.22/02
   ...
   quadLineFit1050->SetChisquare(6.692862);
   ...
   quadLineFit1050->SetParameter(0,-5.595318);
   quadLineFit1050->SetParError(0,0.07125939);
   quadLineFit1050->SetParLimits(0,0,0);
   quadLineFit1050->SetParameter(1,0.1534395);
   quadLineFit1050->SetParError(1,0.003942662);
   ...
   quadLineFit1051->SetChisquare(6.692862);
   ...
   quadLineFit1051->SetParameter(0,-5.595318);
   quadLineFit1051->SetParError(0,0.07125939);
   quadLineFit1051->SetParLimits(0,0,0);
   quadLineFit1051->SetParameter(1,0.1534395);
   quadLineFit1051->SetParError(1,0.003942662);
   ...
   Graph_50dO000000sPppm1051->SetMinimum(3.400943);
   Graph_50dO000000sPppm1051->SetMaximum(4.455843);
   ...
   quadLineFit1052->SetChisquare(23.42793);
   ...
   quadLineFit1052->SetParameter(0,7.761865);
   quadLineFit1052->SetParError(0,0.07125802);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,-0.2141949);
   quadLineFit1052->SetParError(1,0.003942589);
   ...
   quadLineFit1053->SetChisquare(23.42793);
   ...
   quadLineFit1053->SetParameter(0,7.761865);
   quadLineFit1053->SetParError(0,0.07125802);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,-0.2141949);
   quadLineFit1053->SetParError(1,0.003942589);
