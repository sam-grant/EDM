...
//=========  (Fri Oct 16 07:56:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.20306,75,84.1659);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-52.06616);
   Graph_Graph01023->SetMaximum(69.02901);
   ...
   checkFit1024->SetChisquare(5.950068e-16);
   ...
   checkFit1024->SetParameter(0,8.481423);
   checkFit1024->SetParError(0,1.125977);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9772789);
   ...
   pt_LaTex = pt->AddText("0.977#pm0.0225");
   pt_LaTex = pt->AddText(" 8.48#pm 1.13");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.678611,-52.06616,-8.678611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetChisquare(5.950068e-16);
   ...
   checkFit1025->SetParameter(0,8.481423);
   checkFit1025->SetParError(0,1.125977);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9772789);
