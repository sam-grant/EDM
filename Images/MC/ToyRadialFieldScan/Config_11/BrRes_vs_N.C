...
//=========  (Fri Oct 16 07:56:30 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,-0.1401285,1.491396e+07,0.1485718);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01107->SetMinimum(-0.1112585);
   Graph_Graph01107->SetMaximum(0.1197018);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.1197018,1.325685e+07,0.1197018,0,344.5,510,"-");
