...
//=========  (Fri Oct 16 07:56:26 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.33617,75,83.26429);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-51.37612);
   Graph_Graph01071->SetMaximum(68.30424);
   ...
   checkFit1072->SetChisquare(7.655001e-17);
   ...
   checkFit1072->SetParameter(0,8.46406);
   checkFit1072->SetParError(0,0.6524951);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,0.978881);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.013");
   pt_LaTex = pt->AddText(" 8.46#pm0.652");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.646669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.646669,-51.37612,-8.646669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetChisquare(7.655001e-17);
   ...
   checkFit1073->SetParameter(0,8.46406);
   checkFit1073->SetParError(0,0.6524951);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,0.978881);
