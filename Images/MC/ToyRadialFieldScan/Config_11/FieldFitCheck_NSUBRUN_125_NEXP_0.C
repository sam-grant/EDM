...
//=========  (Fri Oct 16 07:56:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.53284,75,82.77461);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-55.20209);
   Graph_Graph01039->SetMaximum(67.44387);
   ...
   checkFit1040->SetChisquare(8.384361e-17);
   ...
   checkFit1040->SetParameter(0,6.120889);
   checkFit1040->SetParError(0,0.8765154);
   checkFit1040->SetParLimits(0,0,0);
   checkFit1040->SetParameter(1,0.997258);
   checkFit1040->SetParError(1,0.01753031);
   ...
   pt_LaTex = pt->AddText("0.997#pm0.0175");
   pt_LaTex = pt->AddText(" 6.12#pm0.877");
   pt_LaTex = pt->AddText("#minus6.14#pm0.886");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.137718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.137718,-55.20209,-6.137718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(8.384361e-17);
   ...
   checkFit1041->SetParameter(0,6.120889);
   checkFit1041->SetParError(0,0.8765154);
   checkFit1041->SetParLimits(0,0,0);
   checkFit1041->SetParameter(1,0.997258);
   checkFit1041->SetParError(1,0.01753031);
