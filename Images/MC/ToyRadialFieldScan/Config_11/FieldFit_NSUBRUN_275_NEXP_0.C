...
//=========  (Fri Oct 16 07:56:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3163627,75,0.2555038);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01085->SetMinimum(-0.259176);
   Graph_Graph01085->SetMaximum(0.1983171);
   ...
   mainFit1086->SetChisquare(5.039457e-08);
   ...
   mainFit1086->SetParameter(0,-0.03042896);
   mainFit1086->SetParError(0,0.002222041);
   mainFit1086->SetParLimits(0,0,0);
   mainFit1086->SetParameter(1,-0.003749592);
   mainFit1086->SetParError(1,4.444081e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00375#pm4.44e-05");
   pt_LaTex = pt->AddText("#minus0.0304#pm0.00222");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.11527,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.11527,-0.259176,-8.11527,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1087->SetChisquare(5.039457e-08);
   ...
   mainFit1087->SetParameter(0,-0.03042896);
   mainFit1087->SetParError(0,0.002222041);
   mainFit1087->SetParLimits(0,0,0);
   mainFit1087->SetParameter(1,-0.003749592);
   mainFit1087->SetParError(1,4.444081e-05);
