...
//=========  (Fri Oct 16 07:56:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3158233,75,0.2381794);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(-0.260423);
   Graph_Graph01013->SetMaximum(0.1827792);
   ...
   mainFit1014->SetChisquare(1.084743e-14);
   ...
   mainFit1014->SetParameter(0,-0.03882225);
   mainFit1014->SetParError(0,0.005185271);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,-0.00354669);
   mainFit1014->SetParError(1,0.0001037054);
   ...
   pt_LaTex = pt->AddText("#minus0.00355#pm0.000104");
   pt_LaTex = pt->AddText("#minus0.0388#pm0.00519");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.94605,-0.260423,-10.94605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(1.084743e-14);
   ...
   mainFit1015->SetParameter(0,-0.03882225);
   mainFit1015->SetParError(0,0.005185271);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,-0.00354669);
   mainFit1015->SetParError(1,0.0001037054);
