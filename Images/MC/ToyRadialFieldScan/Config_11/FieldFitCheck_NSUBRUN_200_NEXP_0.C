...
//=========  (Fri Oct 16 07:56:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.90935,75,86.18544);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","Sub-runs 200",100,-60,60);
   Graph_Graph01063->SetMinimum(-52.49987);
   Graph_Graph01063->SetMaximum(70.77596);
   ...
   checkFit1064->SetChisquare(3.285821e-17);
   ...
   checkFit1064->SetParameter(0,9.138043);
   checkFit1064->SetParError(0,0.692232);
   checkFit1064->SetParLimits(0,0,0);
   checkFit1064->SetParameter(1,1.007719);
   checkFit1064->SetParError(1,0.01384464);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0138");
   pt_LaTex = pt->AddText(" 9.14#pm0.692");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.068044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.068044,-52.49987,-9.068044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(3.285821e-17);
   ...
   checkFit1065->SetParameter(0,9.138043);
   checkFit1065->SetParError(0,0.692232);
   checkFit1065->SetParLimits(0,0,0);
   checkFit1065->SetParameter(1,1.007719);
   checkFit1065->SetParError(1,0.01384464);
