...
//=========  (Fri Oct 16 07:56:30 2020) by ROOT version 6.22/02
   ...
   c->Range(-1657106,0.1976062,1.491396e+07,2.314847);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Truth1108->SetMinimum(0.4093303);
   Graph_Truth1108->SetMaximum(2.103123);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,2.103123,1.325685e+07,2.103123,0,344.5,510,"-");
