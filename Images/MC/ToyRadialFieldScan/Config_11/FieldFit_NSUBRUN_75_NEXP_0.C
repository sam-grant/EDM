...
//=========  (Fri Oct 16 07:56:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3169591,75,0.2530796);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.2599552);
   Graph_Graph01021->SetMaximum(0.1960757);
   ...
   mainFit1022->SetChisquare(1.072069e-13);
   ...
   mainFit1022->SetParameter(0,-0.03194022);
   mainFit1022->SetParError(0,0.004239826);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.003680337);
   mainFit1022->SetParError(1,8.479652e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00368#pm8.48e-05");
   pt_LaTex = pt->AddText("#minus0.0319#pm0.00424");
   pt_LaTex = pt->AddText("#minus8.68#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.678611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.678611,-0.2599552,-8.678611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(1.072069e-13);
   ...
   mainFit1023->SetParameter(0,-0.03194022);
   mainFit1023->SetParError(0,0.004239826);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.003680337);
   mainFit1023->SetParError(1,8.479652e-05);
