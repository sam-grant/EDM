...
//=========  (Fri Oct 16 07:56:27 2020) by ROOT version 6.22/02
   ...
   0.009322777,
   0.009322777};
   TGraphErrors *gre = new TGraphErrors(3,-50.000000 ppm_fx1073,-50.000000 ppm_fy1073,-50.000000 ppm_fex1073,-50.000000 ppm_fey1073);
   gre->SetName("-50.000000 ppm");
   gre->SetTitle(";QHV [kV];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   
   TH1F *Graph_mI50dO000000sPppm1073 = new TH1F("Graph_mI50dO000000sPppm1073","",100,15.6,20.4);
   ...
   quadLineFit1074->SetChisquare(18.52904);
   ...
   quadLineFit1074->SetParameter(0,-5.730488);
   quadLineFit1074->SetParError(0,0.05957249);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.1603121);
   quadLineFit1074->SetParError(1,0.003296046);
   ...
   quadLineFit1075->SetChisquare(18.52904);
   ...
   quadLineFit1075->SetParameter(0,-5.730488);
   quadLineFit1075->SetParError(0,0.05957249);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.1603121);
   quadLineFit1075->SetParError(1,0.003296046);
   ...
   Graph_50dO000000sPppm1075->SetMinimum(3.382001);
   Graph_50dO000000sPppm1075->SetMaximum(4.474264);
   ...
   quadLineFit1076->SetChisquare(27.94774);
   ...
   quadLineFit1076->SetParameter(0,7.92009);
   quadLineFit1076->SetParError(0,0.05957648);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.2228932);
   quadLineFit1076->SetParError(1,0.003296269);
   ...
   quadLineFit1077->SetChisquare(27.94774);
   ...
   quadLineFit1077->SetParameter(0,7.92009);
   quadLineFit1077->SetParError(0,0.05957648);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.2228932);
   quadLineFit1077->SetParError(1,0.003296269);
