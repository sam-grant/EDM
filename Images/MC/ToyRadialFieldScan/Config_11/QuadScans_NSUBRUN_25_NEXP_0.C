...
//=========  (Fri Oct 16 07:56:20 2020) by ROOT version 6.22/02
   ...
   Double_t 50.000000 ppm_fx1003[3] = {
   16,
   18,
   20};
   Double_t 50.000000 ppm_fy1003[3] = {
   4.336899,
   3.902144,
   3.471773};
   Double_t 50.000000 ppm_fex1003[3] = {
   0,
   0,
   0};
   Double_t 50.000000 ppm_fey1003[3] = {
   0.02922466,
   0.02922466,
   0.02922466};
   gre = new TGraphErrors(3,50.000000 ppm_fx1003,50.000000 ppm_fy1003,50.000000 ppm_fex1003,50.000000 ppm_fey1003);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_50dO000000sPppm1003 = new TH1F("Graph_50dO000000sPppm1003","Graph",100,15.6,20.4);
   Graph_50dO000000sPppm1003->SetMinimum(3.350191);
   Graph_50dO000000sPppm1003->SetMaximum(4.458481);
   ...
   quadLineFit1004->SetChisquare(0.003749801);
   ...
   quadLineFit1004->SetParameter(0,7.79667);
   quadLineFit1004->SetParError(0,0.186748);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-0.2162813);
   quadLineFit1004->SetParError(1,0.01033246);
   ...
   quadLineFit1005->SetChisquare(0.003749801);
   ...
   quadLineFit1005->SetParameter(0,7.79667);
   quadLineFit1005->SetParError(0,0.186748);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-0.2162813);
   quadLineFit1005->SetParError(1,0.01033246);
