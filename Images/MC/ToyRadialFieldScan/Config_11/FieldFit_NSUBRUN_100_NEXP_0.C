...
//=========  (Fri Oct 16 07:56:22 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3203457,75,0.2595425);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.2623569);
   Graph_Graph01029->SetMaximum(0.2015537);
   ...
   mainFit1030->SetChisquare(5.153849e-15);
   ...
   mainFit1030->SetParameter(0,-0.0304014);
   mainFit1030->SetParError(0,0.003693445);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,-0.003761455);
   mainFit1030->SetParError(1,7.38689e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm7.39e-05");
   pt_LaTex = pt->AddText("#minus0.0304#pm0.00369");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.08235,-0.2623569,-8.08235,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.153849e-15);
   ...
   mainFit1031->SetParameter(0,-0.0304014);
   mainFit1031->SetParError(0,0.003693445);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,-0.003761455);
   mainFit1031->SetParError(1,7.38689e-05);
