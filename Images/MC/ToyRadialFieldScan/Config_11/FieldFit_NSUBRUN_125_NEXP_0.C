...
//=========  (Fri Oct 16 07:56:23 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3117212,75,0.2656198);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(-0.2539871);
   Graph_Graph01037->SetMaximum(0.2078857);
   ...
   mainFit1038->SetChisquare(3.825137e-09);
   ...
   mainFit1038->SetParameter(0,-0.02305047);
   mainFit1038->SetParError(0,0.003300877);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,-0.003755576);
   mainFit1038->SetParError(1,6.601755e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm6.6e-05");
   pt_LaTex = pt->AddText("#minus0.0231#pm0.0033");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.137665,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.137665,-0.2539871,-6.137665,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1039->SetChisquare(3.825137e-09);
   ...
   mainFit1039->SetParameter(0,-0.02305047);
   mainFit1039->SetParError(0,0.003300877);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,-0.003755576);
   mainFit1039->SetParError(1,6.601755e-05);
