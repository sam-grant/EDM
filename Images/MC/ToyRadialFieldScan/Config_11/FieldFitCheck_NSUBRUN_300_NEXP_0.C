...
//=========  (Fri Oct 16 07:56:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.07761,75,84.10885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01095 = new TH1F("Graph_Graph01095","Sub-runs 300",100,-60,60);
   Graph_Graph01095->SetMinimum(-52.85896);
   Graph_Graph01095->SetMaximum(68.89021);
   ...
   checkFit1096->SetChisquare(6.211132e-17);
   ...
   checkFit1096->SetParameter(0,8.015625);
   checkFit1096->SetParError(0,0.564848);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9986001);
   checkFit1096->SetParError(1,0.01129696);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.0113");
   pt_LaTex = pt->AddText(" 8.02#pm0.565");
   pt_LaTex = pt->AddText("#minus8.03#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.026862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.026862,-52.85896,-8.026862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(6.211132e-17);
   ...
   checkFit1097->SetParameter(0,8.015625);
   checkFit1097->SetParError(0,0.564848);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9986001);
   checkFit1097->SetParError(1,0.01129696);
