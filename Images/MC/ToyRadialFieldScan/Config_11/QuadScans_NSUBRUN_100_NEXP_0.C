...
//=========  (Fri Oct 16 07:56:22 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1025[3] = {
   16,
   18,
   20};
   Double_t -50.000000 ppm_fy1025[3] = {
   -3.168888,
   -2.824241,
   -2.538202};
   Double_t -50.000000 ppm_fex1025[3] = {
   0,
   0,
   0};
   Double_t -50.000000 ppm_fey1025[3] = {
   0.01477369,
   0.01477369,
   0.01477369};
   TGraphErrors *gre = new TGraphErrors(3,-50.000000 ppm_fx1025,-50.000000 ppm_fy1025,-50.000000 ppm_fex1025,-50.000000 ppm_fey1025);
   ...
   quadLineFit1026->SetChisquare(2.622986);
   ...
   quadLineFit1026->SetParameter(0,-5.681861);
   quadLineFit1026->SetParError(0,0.09440268);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.1576713);
   quadLineFit1026->SetParError(1,0.005223142);
   ...
   quadLineFit1027->SetChisquare(2.622986);
   ...
   quadLineFit1027->SetParameter(0,-5.681861);
   quadLineFit1027->SetParError(0,0.09440268);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.1576713);
   quadLineFit1027->SetParError(1,0.005223142);
   ...
   Graph_50dO000000sPppm1027->SetMinimum(3.376186);
   Graph_50dO000000sPppm1027->SetMaximum(4.460319);
   ...
   quadLineFit1028->SetChisquare(4.439735);
   ...
   quadLineFit1028->SetParameter(0,7.838078);
   quadLineFit1028->SetParError(0,0.09440907);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-0.2184741);
   quadLineFit1028->SetParError(1,0.005223498);
   ...
   quadLineFit1029->SetChisquare(4.439735);
   ...
   quadLineFit1029->SetParameter(0,7.838078);
   quadLineFit1029->SetParError(0,0.09440907);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-0.2184741);
   quadLineFit1029->SetParError(1,0.005223498);
