...
//=========  (Fri Oct 16 07:56:24 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.317944,75,0.2605175);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.2600978);
   Graph_Graph01045->SetMaximum(0.2026714);
   ...
   mainFit1046->SetChisquare(1.125903e-14);
   ...
   mainFit1046->SetParameter(0,-0.02871338);
   mainFit1046->SetParError(0,0.003011827);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.003771223);
   mainFit1046->SetParError(1,6.023654e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00377#pm6.02e-05");
   pt_LaTex = pt->AddText("#minus0.0287#pm0.00301");
   pt_LaTex = pt->AddText("#minus7.61#pm0.808");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.613811,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.613811,-0.2600978,-7.613811,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(1.125903e-14);
   ...
   mainFit1047->SetParameter(0,-0.02871338);
   mainFit1047->SetParError(0,0.003011827);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.003771223);
   mainFit1047->SetParError(1,6.023654e-05);
