...
//=========  (Fri Oct 16 07:56:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3167455,75,0.2563736);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.2594336);
   Graph_Graph01093->SetMaximum(0.1990617);
   ...
   mainFit1094->SetChisquare(2.404022e-14);
   ...
   mainFit1094->SetParameter(0,-0.03018606);
   mainFit1094->SetParError(0,0.00212708);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.003760631);
   mainFit1094->SetParError(1,4.25416e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm4.25e-05");
   pt_LaTex = pt->AddText("#minus0.0302#pm0.00213");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.026862,-0.2594336,-8.026862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(2.404022e-14);
   ...
   mainFit1095->SetParameter(0,-0.03018606);
   mainFit1095->SetParError(0,0.00212708);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.003760631);
   mainFit1095->SetParError(1,4.25416e-05);
