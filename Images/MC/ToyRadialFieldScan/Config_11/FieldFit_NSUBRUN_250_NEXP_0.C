...
//=========  (Fri Oct 16 07:56:27 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3236389,75,0.2610575);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01077->SetMinimum(-0.2651693);
   Graph_Graph01077->SetMaximum(0.2025879);
   ...
   mainFit1078->SetChisquare(1.305061e-14);
   ...
   mainFit1078->SetParameter(0,-0.03129059);
   mainFit1078->SetParError(0,0.002330735);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,-0.003832053);
   mainFit1078->SetParError(1,4.661471e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00383#pm4.66e-05");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00233");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.165489,-0.2651693,-8.165489,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1079->SetChisquare(1.305061e-14);
   ...
   mainFit1079->SetParameter(0,-0.03129059);
   mainFit1079->SetParError(0,0.002330735);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,-0.003832053);
   mainFit1079->SetParError(1,4.661471e-05);
