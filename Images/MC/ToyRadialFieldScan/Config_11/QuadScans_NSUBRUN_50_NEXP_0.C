...
//=========  (Fri Oct 16 07:56:21 2020) by ROOT version 6.22/02
   ...
   0.02074029,
   0.02074029};
   TGraphErrors *gre = new TGraphErrors(3,-50.000000 ppm_fx1009,-50.000000 ppm_fy1009,-50.000000 ppm_fex1009,-50.000000 ppm_fey1009);
   ...
   quadLineFit1010->SetChisquare(1.550893);
   ...
   quadLineFit1010->SetParameter(0,-5.321348);
   quadLineFit1010->SetParError(0,0.1325433);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,0.1385122);
   quadLineFit1010->SetParError(1,0.007333405);
   ...
   quadLineFit1011->SetChisquare(1.550893);
   ...
   quadLineFit1011->SetParameter(0,-5.321348);
   quadLineFit1011->SetParError(0,0.1325433);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,0.1385122);
   quadLineFit1011->SetParError(1,0.007333405);
   ...
   Graph_50dO000000sPppm1011->SetMinimum(3.40259);
   Graph_50dO000000sPppm1011->SetMaximum(4.489919);
   ...
   quadLineFit1012->SetChisquare(6.445588);
   ...
   quadLineFit1012->SetParameter(0,7.815579);
   quadLineFit1012->SetParError(0,0.1325317);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-0.2161567);
   quadLineFit1012->SetParError(1,0.007332756);
   ...
   quadLineFit1013->SetChisquare(6.445588);
   ...
   quadLineFit1013->SetParameter(0,7.815579);
   quadLineFit1013->SetParError(0,0.1325317);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-0.2161567);
   quadLineFit1013->SetParError(1,0.007332756);
