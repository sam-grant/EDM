...
//=========  (Fri Oct 16 07:56:25 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.72031,75,82.85334);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01055->SetMinimum(-51.76295);
   Graph_Graph01055->SetMaximum(67.89598);
   ...
   checkFit1056->SetChisquare(2.404649e-16);
   ...
   checkFit1056->SetParameter(0,8.066515);
   checkFit1056->SetParError(0,0.7403131);
   checkFit1056->SetParLimits(0,0,0);
   checkFit1056->SetParameter(1,0.9762185);
   ...
   pt_LaTex = pt->AddText("0.976#pm0.0148");
   pt_LaTex = pt->AddText(" 8.07#pm 0.74");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.263022,-51.76295,-8.263022,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1057->SetChisquare(2.404649e-16);
   ...
   checkFit1057->SetParameter(0,8.066515);
   checkFit1057->SetParError(0,0.7403131);
   checkFit1057->SetParLimits(0,0,0);
   checkFit1057->SetParameter(1,0.9762185);
