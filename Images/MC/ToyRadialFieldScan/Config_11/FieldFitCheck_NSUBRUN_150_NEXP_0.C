...
//=========  (Fri Oct 16 07:56:24 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01047->SetMinimum(-53.81749);
   Graph_Graph01047->SetMaximum(69.06662);
   ...
   checkFit1048->SetChisquare(2.935421e-17);
   ...
   checkFit1048->SetParameter(0,7.624567);
   checkFit1048->SetParError(0,0.7997947);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,1.001413);
   ...
   pt_LaTex = pt->AddText("    1#pm0.016");
   pt_LaTex = pt->AddText(" 7.62#pm  0.8");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.613811,-53.81749,-7.613811,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(2.935421e-17);
   ...
   checkFit1049->SetParameter(0,7.624567);
   checkFit1049->SetParError(0,0.7997947);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,1.001413);
