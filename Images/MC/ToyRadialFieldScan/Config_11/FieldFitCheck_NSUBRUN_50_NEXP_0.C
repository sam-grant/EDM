...
//=========  (Fri Oct 16 07:56:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-63.2461,75,83.86387);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-48.53511);
   Graph_Graph01015->SetMaximum(69.15287);
   ...
   checkFit1016->SetChisquare(7.103285e-16);
   ...
   checkFit1016->SetParameter(0,10.30888);
   checkFit1016->SetParError(0,1.376847);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,0.94179);
   checkFit1016->SetParError(1,0.02753695);
   ...
   pt_LaTex = pt->AddText("0.942#pm0.0275");
   pt_LaTex = pt->AddText(" 10.3#pm 1.38");
   pt_LaTex = pt->AddText("#minus10.9#pm  1.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-10.94605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.94605,-48.53511,-10.94605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(7.103285e-16);
   ...
   checkFit1017->SetParameter(0,10.30888);
   checkFit1017->SetParError(0,1.376847);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,0.94179);
   checkFit1017->SetParError(1,0.02753695);
