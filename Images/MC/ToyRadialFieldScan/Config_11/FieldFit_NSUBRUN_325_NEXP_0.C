...
//=========  (Fri Oct 16 07:56:29 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3170783,75,0.2580069);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01101->SetMinimum(-0.2595697);
   Graph_Graph01101->SetMaximum(0.2004984);
   ...
   mainFit1102->SetChisquare(6.825515e-18);
   ...
   mainFit1102->SetParameter(0,-0.02953569);
   mainFit1102->SetParError(0,0.002043737);
   mainFit1102->SetParLimits(0,0,0);
   mainFit1102->SetParameter(1,-0.003776096);
   mainFit1102->SetParError(1,4.087473e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00378#pm4.09e-05");
   pt_LaTex = pt->AddText("#minus0.0295#pm0.00204");
   pt_LaTex = pt->AddText("#minus7.82#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.821755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.821755,-0.2595697,-7.821755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1103->SetChisquare(6.825515e-18);
   ...
   mainFit1103->SetParameter(0,-0.02953569);
   mainFit1103->SetParError(0,0.002043737);
   mainFit1103->SetParLimits(0,0,0);
   mainFit1103->SetParameter(1,-0.003776096);
   mainFit1103->SetParError(1,4.087473e-05);
