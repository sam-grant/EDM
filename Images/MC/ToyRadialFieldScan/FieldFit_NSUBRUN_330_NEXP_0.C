...
//=========  (Wed Jan  5 17:36:11 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","",100,-36,36);
   Graph_Graph01037->SetMinimum(-35.39043);
   Graph_Graph01037->SetMaximum(54.66868);
   ...
   Graph_Graph01037->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01037->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *mainFit1038 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1038->SetChisquare(4.085243e-13);
   ...
   mainFit1038->SetParameter(0,9.639128);
   mainFit1038->SetParError(0,0.5118441);
   mainFit1038->SetParLimits(0,0,0);
   mainFit1038->SetParameter(1,1.226692);
   mainFit1038->SetParError(1,0.01706147);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.85782,-35.39043,-7.85782,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *mainFit1039 = new TF1("mainFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   mainFit1039->SetChisquare(4.085243e-13);
   ...
   mainFit1039->SetParameter(0,9.639128);
   mainFit1039->SetParError(0,0.5118441);
   mainFit1039->SetParLimits(0,0,0);
   mainFit1039->SetParameter(1,1.226692);
   mainFit1039->SetParError(1,0.01706147);
