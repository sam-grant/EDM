void QuadScans_NSUBRUN_225_NEXP_500()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 24 16:05:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.191074,0.0663141,7.499546);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1129->SetMinimum(-3.922012);
   Graph_mI50dO000000sPppm1129->SetMaximum(6.230484);
   ...
   quadLineFit1130->SetChisquare(0.02696089);
   ...
   quadLineFit1130->SetParameter(0,-0.1262878);
   quadLineFit1130->SetParError(0,0.06968209);
   quadLineFit1130->SetParLimits(0,0,0);
   quadLineFit1130->SetParameter(1,-48.17317);
   quadLineFit1130->SetParError(1,1.230375);
   ...
   quadLineFit1131->SetChisquare(0.02696089);
   ...
   quadLineFit1131->SetParameter(0,-0.1262878);
   quadLineFit1131->SetParError(0,0.06968209);
   quadLineFit1131->SetParLimits(0,0,0);
   quadLineFit1131->SetParameter(1,-48.17317);
   quadLineFit1131->SetParError(1,1.230375);
   ...
   Graph_mI30dO000000sPppm1131->SetMinimum(-1.953417);
   Graph_mI30dO000000sPppm1131->SetMaximum(-1.299187);
   ...
   quadLineFit1132->SetChisquare(0.7199553);
   ...
   quadLineFit1132->SetParameter(0,-0.01700134);
   quadLineFit1132->SetParError(0,0.03920878);
   quadLineFit1132->SetParLimits(0,0,0);
   quadLineFit1132->SetParameter(1,-26.24648);
   quadLineFit1132->SetParError(1,0.6462381);
   ...
   quadLineFit1133->SetChisquare(0.7199553);
   ...
   quadLineFit1133->SetParameter(0,-0.01700134);
   quadLineFit1133->SetParError(0,0.03920878);
   quadLineFit1133->SetParLimits(0,0,0);
   quadLineFit1133->SetParameter(1,-26.24648);
   quadLineFit1133->SetParError(1,0.6462381);
   ...
   Graph_mI10dO000000sPppm1133->SetMinimum(-0.1761952);
   Graph_mI10dO000000sPppm1133->SetMaximum(-0.1092995);
   ...
   quadLineFit1134->SetChisquare(1.916568);
   ...
   quadLineFit1134->SetParameter(0,-0.05732616);
   quadLineFit1134->SetParError(0,0.03919978);
   quadLineFit1134->SetParLimits(0,0,0);
   quadLineFit1134->SetParameter(1,-1.468112);
   quadLineFit1134->SetParError(1,0.6460892);
   ...
   quadLineFit1135->SetChisquare(1.916568);
   ...
   quadLineFit1135->SetParameter(0,-0.05732616);
   quadLineFit1135->SetParError(0,0.03919978);
   quadLineFit1135->SetParLimits(0,0,0);
   quadLineFit1135->SetParameter(1,-1.468112);
   quadLineFit1135->SetParError(1,0.6460892);
   ...
   Graph_10dO000000sPppm1135->SetMinimum(1.067281);
   Graph_10dO000000sPppm1135->SetMaximum(1.615037);
   ...
   quadLineFit1136->SetChisquare(0.6294123);
   ...
   quadLineFit1136->SetParameter(0,0.01004387);
   quadLineFit1136->SetParError(0,0.04297674);
   quadLineFit1136->SetParLimits(0,0,0);
   quadLineFit1136->SetParameter(1,21.6433);
   quadLineFit1136->SetParError(1,0.6900053);
   ...
   quadLineFit1137->SetChisquare(0.6294123);
   ...
   quadLineFit1137->SetParameter(0,0.01004387);
   quadLineFit1137->SetParError(0,0.04297674);
   quadLineFit1137->SetParLimits(0,0,0);
   quadLineFit1137->SetParameter(1,21.6433);
   quadLineFit1137->SetParError(1,0.6900053);
   ...
   Graph_30dO000000sPppm1137->SetMinimum(2.239424);
   Graph_30dO000000sPppm1137->SetMaximum(3.396323);
   ...
   quadLineFit1138->SetChisquare(0.248141);
   ...
   quadLineFit1138->SetParameter(0,-0.06603072);
   quadLineFit1138->SetParError(0,0.03920069);
   quadLineFit1138->SetParLimits(0,0,0);
   quadLineFit1138->SetParameter(1,46.96736);
   quadLineFit1138->SetParError(1,0.6461044);
   ...
   quadLineFit1139->SetChisquare(0.248141);
   ...
   quadLineFit1139->SetParameter(0,-0.06603072);
   quadLineFit1139->SetParError(0,0.03920069);
   quadLineFit1139->SetParLimits(0,0,0);
   quadLineFit1139->SetParameter(1,46.96736);
   quadLineFit1139->SetParError(1,0.6461044);
   ...
   Graph_50dO000000sPppm1139->SetMinimum(3.432635);
   Graph_50dO000000sPppm1139->SetMaximum(5.136202);
   ...
   quadLineFit1140->SetChisquare(1.20895);
   ...
   quadLineFit1140->SetParameter(0,0.002952778);
   quadLineFit1140->SetParError(0,0.03919975);
   quadLineFit1140->SetParLimits(0,0,0);
   quadLineFit1140->SetParameter(1,69.75659);
   quadLineFit1140->SetParError(1,0.6460888);
   ...
   quadLineFit1141->SetChisquare(1.20895);
   ...
   quadLineFit1141->SetParameter(0,0.002952778);
   quadLineFit1141->SetParError(0,0.03919975);
   quadLineFit1141->SetParLimits(0,0,0);
   quadLineFit1141->SetParameter(1,69.75659);
   quadLineFit1141->SetParError(1,0.6460888);
