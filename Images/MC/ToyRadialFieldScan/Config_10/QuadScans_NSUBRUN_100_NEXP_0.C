...
//=========  (Fri Oct 16 07:55:28 2020) by ROOT version 6.22/02
   ...
   quadLineFit1038->SetChisquare(1.063231);
   ...
   quadLineFit1038->SetParameter(0,-2.861188);
   quadLineFit1038->SetParError(0,0.09440883);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,0.07658572);
   quadLineFit1038->SetParError(1,0.005223485);
   ...
   quadLineFit1039->SetChisquare(1.063231);
   ...
   quadLineFit1039->SetParameter(0,-2.861188);
   quadLineFit1039->SetParError(0,0.09440883);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,0.07658572);
   quadLineFit1039->SetParError(1,0.005223485);
   ...
   Graph_mI10dO000000sPppm1039->SetMinimum(-0.1890701);
   Graph_mI10dO000000sPppm1039->SetMaximum(-0.09057838);
   ...
   quadLineFit1040->SetChisquare(1.425459);
   ...
   quadLineFit1040->SetParameter(0,-0.3834059);
   quadLineFit1040->SetParError(0,0.09440534);
   quadLineFit1040->SetParLimits(0,0,0);
   quadLineFit1040->SetParameter(1,0.01313226);
   quadLineFit1040->SetParError(1,0.00522329);
   ...
   quadLineFit1041->SetChisquare(1.425459);
   ...
   quadLineFit1041->SetParameter(0,-0.3834059);
   quadLineFit1041->SetParError(0,0.09440534);
   quadLineFit1041->SetParLimits(0,0,0);
   quadLineFit1041->SetParameter(1,0.01313226);
   quadLineFit1041->SetParError(1,0.00522329);
   ...
   Graph_10dO000000sPppm1041->SetMinimum(1.056678);
   Graph_10dO000000sPppm1041->SetMaximum(1.384559);
   ...
   quadLineFit1042->SetChisquare(2.508141);
   ...
   quadLineFit1042->SetParameter(0,2.307656);
   quadLineFit1042->SetParError(0,0.09440522);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,-0.06092166);
   quadLineFit1042->SetParError(1,0.005223284);
   ...
   quadLineFit1043->SetChisquare(2.508141);
   ...
   quadLineFit1043->SetParameter(0,2.307656);
   quadLineFit1043->SetParError(0,0.09440522);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,-0.06092166);
   quadLineFit1043->SetParError(1,0.005223284);
   ...
   Graph_30dO000000sPppm1043->SetMinimum(2.226485);
   Graph_30dO000000sPppm1043->SetMaximum(2.916531);
   ...
   quadLineFit1044->SetChisquare(3.914775);
   ...
   quadLineFit1044->SetParameter(0,5.014283);
   quadLineFit1044->SetParError(0,0.09440839);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.1363727);
   quadLineFit1044->SetParError(1,0.00522346);
   ...
   quadLineFit1045->SetChisquare(3.914775);
   ...
   quadLineFit1045->SetParameter(0,5.014283);
   quadLineFit1045->SetParError(0,0.09440839);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.1363727);
   quadLineFit1045->SetParError(1,0.00522346);
