...
//=========  (Fri Oct 16 07:55:32 2020) by ROOT version 6.22/02
   ...
   quadLineFit1074->SetChisquare(0.9364741);
   ...
   quadLineFit1074->SetParameter(0,-3.005552);
   quadLineFit1074->SetParError(0,0.07126199);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.08435202);
   quadLineFit1074->SetParError(1,0.003942807);
   ...
   quadLineFit1075->SetChisquare(0.9364741);
   ...
   quadLineFit1075->SetParameter(0,-3.005552);
   quadLineFit1075->SetParError(0,0.07126199);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.08435202);
   quadLineFit1075->SetParError(1,0.003942807);
   ...
   Graph_mI10dO000000sPppm1075->SetMinimum(-0.1802706);
   Graph_mI10dO000000sPppm1075->SetMaximum(-0.1029027);
   ...
   quadLineFit1076->SetChisquare(3.874043);
   ...
   quadLineFit1076->SetParameter(0,-0.2760068);
   quadLineFit1076->SetParError(0,0.07126038);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,0.007643514);
   quadLineFit1076->SetParError(1,0.003942718);
   ...
   quadLineFit1077->SetChisquare(3.874043);
   ...
   quadLineFit1077->SetParameter(0,-0.2760068);
   quadLineFit1077->SetParError(0,0.07126038);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,0.007643514);
   quadLineFit1077->SetParError(1,0.003942718);
   ...
   Graph_10dO000000sPppm1077->SetMinimum(1.047334);
   Graph_10dO000000sPppm1077->SetMaximum(1.381055);
   ...
   quadLineFit1078->SetChisquare(0.004249172);
   ...
   quadLineFit1078->SetParameter(0,2.364986);
   quadLineFit1078->SetParError(0,0.0712611);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.06394935);
   quadLineFit1078->SetParError(1,0.003942758);
   ...
   quadLineFit1079->SetChisquare(0.004249172);
   ...
   quadLineFit1079->SetParameter(0,2.364986);
   quadLineFit1079->SetParError(0,0.0712611);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.06394935);
   quadLineFit1079->SetParError(1,0.003942758);
   ...
   Graph_30dO000000sPppm1079->SetMinimum(2.222986);
   Graph_30dO000000sPppm1079->SetMaximum(2.933249);
   ...
   quadLineFit1080->SetChisquare(3.8001);
   ...
   quadLineFit1080->SetParameter(0,5.132364);
   quadLineFit1080->SetParError(0,0.07126213);
   quadLineFit1080->SetParLimits(0,0,0);
   quadLineFit1080->SetParameter(1,-0.1423956);
   quadLineFit1080->SetParError(1,0.003942816);
   ...
   quadLineFit1081->SetChisquare(3.8001);
   ...
   quadLineFit1081->SetParameter(0,5.132364);
   quadLineFit1081->SetParError(0,0.07126213);
   quadLineFit1081->SetParLimits(0,0,0);
   quadLineFit1081->SetParameter(1,-0.1423956);
   quadLineFit1081->SetParError(1,0.003942816);
