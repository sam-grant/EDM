...
//=========  (Fri Oct 16 07:55:32 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2049968,45,0.1469531);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01081->SetMinimum(-0.1698018);
   Graph_Graph01081->SetMaximum(0.1117582);
   ...
   mainFit1082->SetChisquare(0.5093424);
   ...
   mainFit1082->SetParameter(0,-0.02858706);
   mainFit1082->SetParError(0,0.001971387);
   mainFit1082->SetParLimits(0,0,0);
   mainFit1082->SetParameter(1,-0.003759174);
   mainFit1082->SetParError(1,8.816378e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm8.82e-05");
   pt_LaTex = pt->AddText("#minus0.0286#pm0.00197");
   pt_LaTex = pt->AddText(" #minus7.6#pm0.554");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.604611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.604611,-0.1698018,-7.604611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1083->SetChisquare(0.5093424);
   ...
   mainFit1083->SetParameter(0,-0.02858706);
   mainFit1083->SetParError(0,0.001971387);
   mainFit1083->SetParLimits(0,0,0);
   mainFit1083->SetParameter(1,-0.003759174);
   mainFit1083->SetParError(1,8.816378e-05);
