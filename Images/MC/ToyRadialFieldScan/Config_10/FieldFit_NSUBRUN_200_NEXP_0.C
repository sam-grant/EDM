...
//=========  (Fri Oct 16 07:55:33 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1985758,45,0.1388804);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-0.1648302);
   Graph_Graph01093->SetMaximum(0.1051348);
   ...
   mainFit1094->SetChisquare(1.199992);
   ...
   mainFit1094->SetParameter(0,-0.02980657);
   mainFit1094->SetParError(0,0.001842807);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,-0.003596513);
   mainFit1094->SetParError(1,8.243193e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.6");
   pt_LaTex = pt->AddText("#minus0.0036#pm8.24e-05");
   pt_LaTex = pt->AddText("#minus0.0298#pm0.00184");
   pt_LaTex = pt->AddText("#minus8.29#pm0.547");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.287631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.287631,-0.1648302,-8.287631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(1.199992);
   ...
   mainFit1095->SetParameter(0,-0.02980657);
   mainFit1095->SetParError(0,0.001842807);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,-0.003596513);
   mainFit1095->SetParError(1,8.243193e-05);
