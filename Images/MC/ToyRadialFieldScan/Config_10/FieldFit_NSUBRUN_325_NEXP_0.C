...
//=========  (Fri Oct 16 07:55:38 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2005124,45,0.146736);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01153->SetMinimum(-0.1657876);
   Graph_Graph01153->SetMaximum(0.1120112);
   ...
   mainFit1154->SetChisquare(7.49448);
   ...
   mainFit1154->SetParameter(0,-0.03034727);
   mainFit1154->SetParError(0,0.001445301);
   mainFit1154->SetParLimits(0,0,0);
   mainFit1154->SetParameter(1,-0.003790563);
   mainFit1154->SetParError(1,6.463028e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00379#pm6.46e-05");
   pt_LaTex = pt->AddText("#minus0.0303#pm0.00145");
   pt_LaTex = pt->AddText("#minus8.01#pm0.405");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.006006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.006006,-0.1657876,-8.006006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1155->SetChisquare(7.49448);
   ...
   mainFit1155->SetParameter(0,-0.03034727);
   mainFit1155->SetParError(0,0.001445301);
   mainFit1155->SetParLimits(0,0,0);
   mainFit1155->SetParameter(1,-0.003790563);
   mainFit1155->SetParError(1,6.463028e-05);
