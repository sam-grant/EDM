...
//=========  (Fri Oct 16 07:55:33 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1085 = new TH1F("Graph_mI30dO000000sPppm1085","",100,15.6,20.4);
   ...
   quadLineFit1086->SetChisquare(0.3150889);
   ...
   quadLineFit1086->SetParameter(0,-2.89665);
   quadLineFit1086->SetParError(0,0.06663279);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,0.07895104);
   quadLineFit1086->SetParError(1,0.003686681);
   ...
   quadLineFit1087->SetChisquare(0.3150889);
   ...
   quadLineFit1087->SetParameter(0,-2.89665);
   quadLineFit1087->SetParError(0,0.06663279);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,0.07895104);
   quadLineFit1087->SetParError(1,0.003686681);
   ...
   Graph_mI10dO000000sPppm1087->SetMinimum(-0.1673692);
   Graph_mI10dO000000sPppm1087->SetMaximum(-0.125593);
   ...
   quadLineFit1088->SetChisquare(0.2642597);
   ...
   quadLineFit1088->SetParameter(0,-0.2071059);
   quadLineFit1088->SetParError(0,0.06663316);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,0.00348962);
   quadLineFit1088->SetParError(1,0.003686702);
   ...
   quadLineFit1089->SetChisquare(0.2642597);
   ...
   quadLineFit1089->SetParameter(0,-0.2071059);
   quadLineFit1089->SetParError(0,0.06663316);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,0.00348962);
   quadLineFit1089->SetParError(1,0.003686702);
   ...
   TH1F *Graph_10dO000000sPppm1089 = new TH1F("Graph_10dO000000sPppm1089","Graph",100,15.6,20.4);
   Graph_10dO000000sPppm1089->SetMinimum(1.060103);
   Graph_10dO000000sPppm1089->SetMaximum(1.387659);
   ...
   quadLineFit1090->SetChisquare(3.286704);
   ...
   quadLineFit1090->SetParameter(0,2.350648);
   quadLineFit1090->SetParError(0,0.06655595);
   quadLineFit1090->SetParLimits(0,0,0);
   quadLineFit1090->SetParameter(1,-0.06302694);
   quadLineFit1090->SetParError(1,0.003682395);
   ...
   quadLineFit1091->SetChisquare(3.286704);
   ...
   quadLineFit1091->SetParameter(0,2.350648);
   quadLineFit1091->SetParError(0,0.06655595);
   quadLineFit1091->SetParLimits(0,0,0);
   quadLineFit1091->SetParameter(1,-0.06302694);
   quadLineFit1091->SetParError(1,0.003682395);
   ...
   TH1F *Graph_30dO000000sPppm1091 = new TH1F("Graph_30dO000000sPppm1091","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1091->SetMinimum(2.21649);
   Graph_30dO000000sPppm1091->SetMaximum(2.907019);
   ...
   quadLineFit1092->SetChisquare(0.2204778);
   ...
   quadLineFit1092->SetParameter(0,5.055391);
   quadLineFit1092->SetParError(0,0.06663282);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,-0.1386464);
   ...
   quadLineFit1093->SetChisquare(0.2204778);
   ...
   quadLineFit1093->SetParameter(0,5.055391);
   quadLineFit1093->SetParError(0,0.06663282);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,-0.1386464);
