...
//=========  (Fri Oct 16 07:55:38 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-38.96435,45,53.24419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01155->SetMinimum(-29.7435);
   Graph_Graph01155->SetMaximum(44.02333);
   ...
   checkFit1156->SetParameter(0,8.058785);
   checkFit1156->SetParError(0,0.3837414);
   checkFit1156->SetParLimits(0,0,0);
   checkFit1156->SetParameter(1,1.006556);
   checkFit1156->SetParError(1,0.01716143);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0172");
   pt_LaTex = pt->AddText(" 8.06#pm0.384");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.006296,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.006296,-29.7435,-8.006296,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1157->SetParameter(0,8.058785);
   checkFit1157->SetParError(0,0.3837414);
   checkFit1157->SetParLimits(0,0,0);
   checkFit1157->SetParameter(1,1.006556);
   checkFit1157->SetParError(1,0.01716143);
