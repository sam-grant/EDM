...
//=========  (Fri Oct 16 07:55:28 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.1974475,45,0.1376605);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(-0.1639367);
   Graph_Graph01045->SetMaximum(0.1041497);
   ...
   mainFit1046->SetChisquare(1.474159);
   ...
   mainFit1046->SetParameter(0,-0.02689426);
   mainFit1046->SetParError(0,0.00261169);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,-0.003564651);
   mainFit1046->SetParError(1,0.0001168);
   ...
   pt_LaTex = pt->AddText("#minus0.00356#pm0.000117");
   pt_LaTex = pt->AddText("#minus0.0269#pm0.00261");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.54471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.54471,-0.1639367,-7.54471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(1.474159);
   ...
   mainFit1047->SetParameter(0,-0.02689426);
   mainFit1047->SetParError(0,0.00261169);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,-0.003564651);
   mainFit1047->SetParError(1,0.0001168);
