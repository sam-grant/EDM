...
//=========  (Fri Oct 16 07:55:33 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.87839,45,52.72994);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-27.91756);
   Graph_Graph01095->SetMaximum(43.7691);
   ...
   checkFit1096->SetParameter(0,7.91528);
   checkFit1096->SetParError(0,0.4894819);
   checkFit1096->SetParLimits(0,0,0);
   checkFit1096->SetParameter(1,0.9550286);
   checkFit1096->SetParError(1,0.0218903);
   ...
   pt_LaTex = pt->AddText("0.955#pm0.0219");
   pt_LaTex = pt->AddText(" 7.92#pm0.489");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.288004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.288004,-27.91756,-8.288004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetParameter(0,7.91528);
   checkFit1097->SetParError(0,0.4894819);
   checkFit1097->SetParLimits(0,0,0);
   checkFit1097->SetParameter(1,0.9550286);
   checkFit1097->SetParError(1,0.0218903);
