...
//=========  (Fri Oct 16 07:55:32 2020) by ROOT version 6.22/02
   ...
   Graph_Graph01083->SetMinimum(-29.67631);
   Graph_Graph01083->SetMaximum(45.08924);
   ...
   checkFit1084->SetParameter(0,7.591105);
   checkFit1084->SetParError(0,0.5234804);
   checkFit1084->SetParLimits(0,0,0);
   checkFit1084->SetParameter(1,0.9982146);
   checkFit1084->SetParError(1,0.02341075);
   ...
   pt_LaTex = pt->AddText("0.998#pm0.0234");
   pt_LaTex = pt->AddText(" 7.59#pm0.523");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.604683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.604683,-29.67631,-7.604683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1085->SetParameter(0,7.591105);
   checkFit1085->SetParError(0,0.5234804);
   checkFit1085->SetParLimits(0,0,0);
   checkFit1085->SetParameter(1,0.9982146);
   checkFit1085->SetParError(1,0.02341075);
