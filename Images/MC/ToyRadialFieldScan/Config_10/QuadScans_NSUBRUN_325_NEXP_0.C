...
//=========  (Fri Oct 16 07:55:38 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1145 = new TH1F("Graph_mI30dO000000sPppm1145","",100,15.6,20.4);
   ...
   quadLineFit1146->SetChisquare(3.790284);
   ...
   quadLineFit1146->SetParameter(0,-3.035037);
   quadLineFit1146->SetParError(0,0.05223951);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,0.08597096);
   quadLineFit1146->SetParError(1,0.002890326);
   ...
   quadLineFit1147->SetChisquare(3.790284);
   ...
   quadLineFit1147->SetParameter(0,-3.035037);
   quadLineFit1147->SetParError(0,0.05223951);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,0.08597096);
   quadLineFit1147->SetParError(1,0.002890326);
   ...
   TH1F *Graph_mI10dO000000sPppm1147 = new TH1F("Graph_mI10dO000000sPppm1147","Graph",100,15.6,20.4);
   Graph_mI10dO000000sPppm1147->SetMinimum(-0.1672071);
   Graph_mI10dO000000sPppm1147->SetMaximum(-0.1155587);
   ...
   quadLineFit1148->SetChisquare(0.4811794);
   ...
   quadLineFit1148->SetParameter(0,-0.2591752);
   quadLineFit1148->SetParError(0,0.05223827);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,0.006672634);
   quadLineFit1148->SetParError(1,0.002890256);
   ...
   quadLineFit1149->SetChisquare(0.4811794);
   ...
   quadLineFit1149->SetParameter(0,-0.2591752);
   quadLineFit1149->SetParError(0,0.05223827);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,0.006672634);
   quadLineFit1149->SetParError(1,0.002890256);
   ...
   TH1F *Graph_10dO000000sPppm1149 = new TH1F("Graph_10dO000000sPppm1149","Graph",100,15.6,20.4);
   Graph_10dO000000sPppm1149->SetMinimum(1.033092);
   Graph_10dO000000sPppm1149->SetMaximum(1.409307);
   ...
   quadLineFit1150->SetChisquare(5.263438);
   ...
   quadLineFit1150->SetParameter(0,2.550773);
   quadLineFit1150->SetParError(0,0.05226175);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-0.07429057);
   quadLineFit1150->SetParError(1,0.002891566);
   ...
   quadLineFit1151->SetChisquare(5.263438);
   ...
   quadLineFit1151->SetParameter(0,2.550773);
   quadLineFit1151->SetParError(0,0.05226175);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-0.07429057);
   quadLineFit1151->SetParError(1,0.002891566);
   ...
   TH1F *Graph_30dO000000sPppm1151 = new TH1F("Graph_30dO000000sPppm1151","Graph",100,15.6,20.4);
   Graph_30dO000000sPppm1151->SetMinimum(2.229994);
   Graph_30dO000000sPppm1151->SetMaximum(2.920402);
   ...
   quadLineFit1152->SetChisquare(9.352928);
   ...
   quadLineFit1152->SetParameter(0,5.080445);
   quadLineFit1152->SetParError(0,0.05223834);
   quadLineFit1152->SetParLimits(0,0,0);
   quadLineFit1152->SetParameter(1,-0.1397474);
   quadLineFit1152->SetParError(1,0.00289026);
   ...
   quadLineFit1153->SetChisquare(9.352928);
   ...
   quadLineFit1153->SetParameter(0,5.080445);
   quadLineFit1153->SetParError(0,0.05223834);
   quadLineFit1153->SetParLimits(0,0,0);
   quadLineFit1153->SetParameter(1,-0.1397474);
   quadLineFit1153->SetParError(1,0.00289026);
