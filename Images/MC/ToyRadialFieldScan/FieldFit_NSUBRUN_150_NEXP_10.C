void FieldFit_NSUBRUN_150_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-84.90804,75,99.95512);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01093->SetMinimum(-66.42172);
   Graph_Graph01093->SetMaximum(81.4688);
   ...
   mainFit1094->SetChisquare(3.501312);
   ...
   mainFit1094->SetParameter(0,8.929319);
   mainFit1094->SetParError(0,0.3575608);
   mainFit1094->SetParLimits(0,0,0);
   mainFit1094->SetParameter(1,1.196887);
   mainFit1094->SetParError(1,0.01128022);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.460453,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.460453,-66.42172,-7.460453,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1095->SetChisquare(3.501312);
   ...
   mainFit1095->SetParameter(0,8.929319);
   mainFit1095->SetParError(0,0.3575608);
   mainFit1095->SetParLimits(0,0,0);
   mainFit1095->SetParameter(1,1.196887);
   mainFit1095->SetParError(1,0.01128022);
