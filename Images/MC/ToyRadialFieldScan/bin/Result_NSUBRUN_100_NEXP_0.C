...
//=========  (Fri Oct  9 18:18:39 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2036418,45,0.1437086);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.1689067);
   Graph_Graph01039->SetMaximum(0.1089736);
   ...
   fieldLineFit1040->SetChisquare(1.261989);
   ...
   fieldLineFit1040->SetParameter(0,-0.03117013);
   fieldLineFit1040->SetParError(0,0.002611643);
   fieldLineFit1040->SetParLimits(0,0,0);
   fieldLineFit1040->SetParameter(1,-0.003725226);
   fieldLineFit1040->SetParError(1,0.0001167961);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.631");
   pt_LaTex = pt->AddText("#minus0.00373#pm0.000117");
   pt_LaTex = pt->AddText("-0.0312#pm0.00261");
   pt_LaTex = pt->AddText("-8.37#pm0.701");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.367313,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.367313,-0.1689067,-8.367313,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1041->SetChisquare(1.261989);
   ...
   fieldLineFit1041->SetParameter(0,-0.03117013);
   fieldLineFit1041->SetParError(0,0.002611643);
   fieldLineFit1041->SetParLimits(0,0,0);
   fieldLineFit1041->SetParameter(1,-0.003725226);
   fieldLineFit1041->SetParError(1,0.0001167961);
