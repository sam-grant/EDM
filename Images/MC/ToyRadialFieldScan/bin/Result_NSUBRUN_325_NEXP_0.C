...
//=========  (Fri Oct  9 18:18:48 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2014491,45,0.1451518);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01129->SetMinimum(-0.166789);
   Graph_Graph01129->SetMaximum(0.1104917);
   ...
   fieldLineFit1130->SetChisquare(1.75037);
   ...
   fieldLineFit1130->SetParameter(0,-0.0299515);
   fieldLineFit1130->SetParError(0,0.001445132);
   fieldLineFit1130->SetParLimits(0,0,0);
   fieldLineFit1130->SetParameter(1,-0.003764269);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm6.46e-05");
   pt_LaTex = pt->AddText("-0.03#pm0.00145");
   pt_LaTex = pt->AddText("-7.96#pm0.384");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.956789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.956789,-0.166789,-7.956789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1131->SetChisquare(1.75037);
   ...
   fieldLineFit1131->SetParameter(0,-0.0299515);
   fieldLineFit1131->SetParError(0,0.001445132);
   fieldLineFit1131->SetParLimits(0,0,0);
   fieldLineFit1131->SetParameter(1,-0.003764269);
