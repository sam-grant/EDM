...
//=========  (Fri Oct  9 18:18:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.213474,45,0.1501584);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-0.1771108);
   Graph_Graph01079->SetMaximum(0.1137951);
   ...
   fieldLineFit1080->SetChisquare(6.075611);
   ...
   fieldLineFit1080->SetParameter(0,-0.02962349);
   fieldLineFit1080->SetParError(0,0.001843341);
   fieldLineFit1080->SetParLimits(0,0,0);
   fieldLineFit1080->SetParameter(1,-0.003856907);
   fieldLineFit1080->SetParError(1,8.243672e-05);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.04");
   pt_LaTex = pt->AddText("#minus0.00386#pm8.24e-05");
   pt_LaTex = pt->AddText("-0.0296#pm0.00184");
   pt_LaTex = pt->AddText("-7.68#pm0.478");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.680635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.680635,-0.1771108,-7.680635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1081->SetChisquare(6.075611);
   ...
   fieldLineFit1081->SetParameter(0,-0.02962349);
   fieldLineFit1081->SetParError(0,0.001843341);
   fieldLineFit1081->SetParLimits(0,0,0);
   fieldLineFit1081->SetParameter(1,-0.003856907);
   fieldLineFit1081->SetParError(1,8.243672e-05);
