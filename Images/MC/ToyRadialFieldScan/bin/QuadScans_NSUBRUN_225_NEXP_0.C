...
//=========  (Fri Oct  9 18:18:44 2020) by ROOT version 6.22/02
   ...
   quadLineFit1082->SetChisquare(1.636206e-22);
   ...
   quadLineFit1082->SetParameter(0,-2.862156);
   quadLineFit1082->SetParError(0,0.06293588);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.07667462);
   ...
   quadLineFit1083->SetChisquare(1.636206e-22);
   ...
   quadLineFit1083->SetParameter(0,-2.862156);
   quadLineFit1083->SetParError(0,0.06293588);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.07667462);
   ...
   Graph_mI10dO000000sPppm1083->SetMinimum(-0.1526616);
   Graph_mI10dO000000sPppm1083->SetMaximum(-0.1071877);
   ...
   quadLineFit1084->SetChisquare(2.450903e-20);
   ...
   quadLineFit1084->SetParameter(0,-0.2119915);
   quadLineFit1084->SetParError(0,0.06293588);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,0.004559272);
   ...
   quadLineFit1085->SetChisquare(2.450903e-20);
   ...
   quadLineFit1085->SetParameter(0,-0.2119915);
   quadLineFit1085->SetParError(0,0.06293588);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,0.004559272);
   ...
   Graph_10dO000000sPppm1085->SetMinimum(1.06218);
   Graph_10dO000000sPppm1085->SetMaximum(1.391335);
   ...
   quadLineFit1086->SetChisquare(1.419933e-19);
   ...
   quadLineFit1086->SetParameter(0,2.372631);
   quadLineFit1086->SetParError(0,0.06293588);
   quadLineFit1086->SetParLimits(0,0,0);
   quadLineFit1086->SetParameter(1,-0.06365967);
   ...
   quadLineFit1087->SetChisquare(1.419933e-19);
   ...
   quadLineFit1087->SetParameter(0,2.372631);
   quadLineFit1087->SetParError(0,0.06293588);
   quadLineFit1087->SetParLimits(0,0,0);
   quadLineFit1087->SetParameter(1,-0.06365967);
   ...
   Graph_30dO000000sPppm1087->SetMinimum(2.227835);
   Graph_30dO000000sPppm1087->SetMaximum(2.946435);
   ...
   quadLineFit1088->SetChisquare(1.559605e-18);
   ...
   quadLineFit1088->SetParameter(0,5.193424);
   quadLineFit1088->SetParError(0,0.06293588);
   quadLineFit1088->SetParLimits(0,0,0);
   quadLineFit1088->SetParameter(1,-0.1447939);
   ...
   quadLineFit1089->SetChisquare(1.559605e-18);
   ...
   quadLineFit1089->SetParameter(0,5.193424);
   quadLineFit1089->SetParError(0,0.06293588);
   quadLineFit1089->SetParLimits(0,0,0);
   quadLineFit1089->SetParameter(1,-0.1447939);
