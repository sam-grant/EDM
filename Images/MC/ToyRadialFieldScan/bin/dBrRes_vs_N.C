...
//=========  (Fri Oct  9 18:18:49 2020) by ROOT version 6.22/02
   ...
   c->Range(-1708357,-0.06740834,1.537521e+07,0.08870002);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01134->SetMinimum(-0.05179751);
   Graph_Graph01134->SetMaximum(0.07308918);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.07308918,1.366686e+07,0.07308918,14,345,510,"-");
