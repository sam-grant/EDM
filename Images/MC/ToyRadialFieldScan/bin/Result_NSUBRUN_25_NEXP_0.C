...
//=========  (Fri Oct  9 18:18:36 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2038023,45,0.1702871);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01009->SetMinimum(-0.1663933);
   Graph_Graph01009->SetMaximum(0.1328781);
   ...
   fieldLineFit1010->SetChisquare(2.746885);
   ...
   fieldLineFit1010->SetParameter(0,-0.02473527);
   fieldLineFit1010->SetParError(0,0.005166239);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.003858492);
   ...
   pt_LaTex = pt->AddText("#minus0.00386#pm0.000231");
   pt_LaTex = pt->AddText("-0.0247#pm0.00517");
   pt_LaTex = pt->AddText("-6.41#pm 1.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.410606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.410606,-0.1663933,-6.410606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1011->SetChisquare(2.746885);
   ...
   fieldLineFit1011->SetParameter(0,-0.02473527);
   fieldLineFit1011->SetParError(0,0.005166239);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.003858492);
