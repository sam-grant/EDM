...
//=========  (Fri Oct  9 18:18:39 2020) by ROOT version 6.22/02
   ...
   quadLineFit1032->SetChisquare(5.873056e-22);
   ...
   quadLineFit1032->SetParameter(0,-2.933286);
   quadLineFit1032->SetParError(0,0.09459775);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.0805936);
   ...
   quadLineFit1033->SetChisquare(5.873056e-22);
   ...
   quadLineFit1033->SetParameter(0,-2.933286);
   quadLineFit1033->SetParError(0,0.09459775);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.0805936);
   ...
   Graph_mI10dO000000sPppm1033->SetMinimum(-0.1750084);
   Graph_mI10dO000000sPppm1033->SetMaximum(-0.09890346);
   ...
   quadLineFit1034->SetChisquare(5.929379e-20);
   ...
   quadLineFit1034->SetParameter(0,-0.2893861);
   quadLineFit1034->SetParError(0,0.09459776);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.008468346);
   ...
   quadLineFit1035->SetChisquare(5.929379e-20);
   ...
   quadLineFit1035->SetParameter(0,-0.2893861);
   quadLineFit1035->SetParError(0,0.09459776);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.008468346);
   ...
   Graph_10dO000000sPppm1035->SetMinimum(1.027242);
   Graph_10dO000000sPppm1035->SetMaximum(1.414134);
   ...
   quadLineFit1036->SetChisquare(1.72963e-18);
   ...
   quadLineFit1036->SetParameter(0,2.538571);
   quadLineFit1036->SetParError(0,0.09459776);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.07321569);
   ...
   quadLineFit1037->SetChisquare(1.72963e-18);
   ...
   quadLineFit1037->SetParameter(0,2.538571);
   quadLineFit1037->SetParError(0,0.09459776);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.07321569);
   ...
   Graph_30dO000000sPppm1037->SetMinimum(2.19572);
   Graph_30dO000000sPppm1037->SetMaximum(2.905705);
   ...
   quadLineFit1038->SetChisquare(3.287263e-18);
   ...
   quadLineFit1038->SetParameter(0,5.080194);
   quadLineFit1038->SetParError(0,0.09459776);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.1405268);
   ...
   quadLineFit1039->SetChisquare(3.287263e-18);
   ...
   quadLineFit1039->SetParameter(0,5.080194);
   quadLineFit1039->SetParError(0,0.09459776);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.1405268);
