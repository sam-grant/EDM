...
//=========  (Fri Oct  9 18:18:46 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.202438,45,0.1477041);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(-0.1674238);
   Graph_Graph01109->SetMaximum(0.1126899);
   ...
   fieldLineFit1110->SetChisquare(3.424043);
   ...
   fieldLineFit1110->SetParameter(0,-0.02948662);
   fieldLineFit1110->SetParError(0,0.001571219);
   fieldLineFit1110->SetParLimits(0,0,0);
   fieldLineFit1110->SetParameter(1,-0.003756056);
   ...
   pt_LaTex = pt->AddText("#minus0.00376#pm7.03e-05");
   pt_LaTex = pt->AddText("-0.0295#pm0.00157");
   pt_LaTex = pt->AddText("-7.85#pm0.418");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.850422,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.850422,-0.1674238,-7.850422,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1111->SetChisquare(3.424043);
   ...
   fieldLineFit1111->SetParameter(0,-0.02948662);
   fieldLineFit1111->SetParError(0,0.001571219);
   fieldLineFit1111->SetParLimits(0,0,0);
   fieldLineFit1111->SetParameter(1,-0.003756056);
