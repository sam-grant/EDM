...
//=========  (Fri Oct  9 18:18:45 2020) by ROOT version 6.22/02
   ...
   quadLineFit1092->SetChisquare(3.793071e-18);
   ...
   quadLineFit1092->SetParameter(0,-3.12022);
   quadLineFit1092->SetParError(0,0.0596949);
   quadLineFit1092->SetParLimits(0,0,0);
   quadLineFit1092->SetParameter(1,0.09060821);
   ...
   quadLineFit1093->SetChisquare(3.793071e-18);
   ...
   quadLineFit1093->SetParameter(0,-3.12022);
   quadLineFit1093->SetParError(0,0.0596949);
   quadLineFit1093->SetParLimits(0,0,0);
   quadLineFit1093->SetParameter(1,0.09060821);
   ...
   Graph_mI10dO000000sPppm1093->SetMinimum(-0.1675547);
   Graph_mI10dO000000sPppm1093->SetMaximum(-0.09035107);
   ...
   quadLineFit1094->SetChisquare(4.977602e-22);
   ...
   quadLineFit1094->SetParameter(0,-0.3345613);
   quadLineFit1094->SetParError(0,0.0596949);
   quadLineFit1094->SetParLimits(0,0,0);
   quadLineFit1094->SetParameter(1,0.01142269);
   ...
   quadLineFit1095->SetChisquare(4.977602e-22);
   ...
   quadLineFit1095->SetParameter(0,-0.3345613);
   quadLineFit1095->SetParError(0,0.0596949);
   quadLineFit1095->SetParLimits(0,0,0);
   quadLineFit1095->SetParameter(1,0.01142269);
   ...
   Graph_10dO000000sPppm1095->SetMinimum(1.029388);
   Graph_10dO000000sPppm1095->SetMaximum(1.397091);
   ...
   quadLineFit1096->SetChisquare(3.232021e-18);
   ...
   quadLineFit1096->SetParameter(0,2.508223);
   quadLineFit1096->SetParError(0,0.0596949);
   quadLineFit1096->SetParLimits(0,0,0);
   quadLineFit1096->SetParameter(1,-0.07194354);
   ...
   quadLineFit1097->SetChisquare(3.232021e-18);
   ...
   quadLineFit1097->SetParameter(0,2.508223);
   quadLineFit1097->SetParError(0,0.0596949);
   quadLineFit1097->SetParLimits(0,0,0);
   quadLineFit1097->SetParameter(1,-0.07194354);
   ...
   Graph_30dO000000sPppm1097->SetMinimum(2.216168);
   Graph_30dO000000sPppm1097->SetMaximum(2.927843);
   ...
   quadLineFit1098->SetChisquare(4.324745e-19);
   ...
   quadLineFit1098->SetParameter(0,5.156882);
   quadLineFit1098->SetParError(0,0.0596949);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,-0.1436043);
   ...
   quadLineFit1099->SetChisquare(4.324745e-19);
   ...
   quadLineFit1099->SetParameter(0,5.156882);
   quadLineFit1099->SetParError(0,0.0596949);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,-0.1436043);
