...
//=========  (Fri Oct  9 18:18:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2053736,45,0.1372543);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01089->SetMinimum(-0.1711108);
   Graph_Graph01089->SetMaximum(0.1029915);
   ...
   fieldLineFit1090->SetChisquare(2.854135);
   ...
   fieldLineFit1090->SetParameter(0,-0.03180491);
   fieldLineFit1090->SetParError(0,0.001737526);
   fieldLineFit1090->SetParLimits(0,0,0);
   fieldLineFit1090->SetParameter(1,-0.003663122);
   ...
   pt_LaTex = pt->AddText("#minus0.00366#pm7.77e-05");
   pt_LaTex = pt->AddText("-0.0318#pm0.00174");
   pt_LaTex = pt->AddText("-8.68#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.68246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.68246,-0.1711108,-8.68246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1091->SetChisquare(2.854135);
   ...
   fieldLineFit1091->SetParameter(0,-0.03180491);
   fieldLineFit1091->SetParError(0,0.001737526);
   fieldLineFit1091->SetParLimits(0,0,0);
   fieldLineFit1091->SetParameter(1,-0.003663122);
