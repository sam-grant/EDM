...
//=========  (Fri Oct  9 18:18:40 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2005542,45,0.1585482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01049->SetMinimum(-0.1646439);
   Graph_Graph01049->SetMaximum(0.122638);
   ...
   fieldLineFit1050->SetChisquare(1.571862);
   ...
   fieldLineFit1050->SetParameter(0,-0.02348745);
   fieldLineFit1050->SetParError(0,0.002334069);
   fieldLineFit1050->SetParLimits(0,0,0);
   fieldLineFit1050->SetParameter(1,-0.003811372);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.786");
   pt_LaTex = pt->AddText("#minus0.00381#pm0.000104");
   pt_LaTex = pt->AddText("-0.0235#pm0.00233");
   pt_LaTex = pt->AddText("-6.16#pm0.612");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.162465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.162465,-0.1646439,-6.162465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1051->SetChisquare(1.571862);
   ...
   fieldLineFit1051->SetParameter(0,-0.02348745);
   fieldLineFit1051->SetParError(0,0.002334069);
   fieldLineFit1051->SetParLimits(0,0,0);
   fieldLineFit1051->SetParameter(1,-0.003811372);
