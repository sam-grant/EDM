...
//=========  (Fri Oct  9 18:18:47 2020) by ROOT version 6.22/02
   ...
   quadLineFit1112->SetChisquare(7.595352e-20);
   ...
   quadLineFit1112->SetParameter(0,-3.059592);
   quadLineFit1112->SetParError(0,0.05448195);
   quadLineFit1112->SetParLimits(0,0,0);
   quadLineFit1112->SetParameter(1,0.08695659);
   ...
   quadLineFit1113->SetChisquare(7.595352e-20);
   ...
   quadLineFit1113->SetParameter(0,-3.059592);
   quadLineFit1113->SetParError(0,0.05448195);
   quadLineFit1113->SetParLimits(0,0,0);
   quadLineFit1113->SetParameter(1,0.08695659);
   ...
   Graph_mI10dO000000sPppm1113->SetMinimum(-0.1716173);
   Graph_mI10dO000000sPppm1113->SetMaximum(-0.0964899);
   ...
   quadLineFit1114->SetChisquare(9.815451e-22);
   ...
   quadLineFit1114->SetParameter(0,-0.3392036);
   quadLineFit1114->SetParError(0,0.05448195);
   quadLineFit1114->SetParLimits(0,0,0);
   quadLineFit1114->SetParameter(1,0.01139722);
   ...
   quadLineFit1115->SetChisquare(9.815451e-22);
   ...
   quadLineFit1115->SetParameter(0,-0.3392036);
   quadLineFit1115->SetParError(0,0.05448195);
   quadLineFit1115->SetParLimits(0,0,0);
   quadLineFit1115->SetParameter(1,0.01139722);
   ...
   Graph_10dO000000sPppm1115->SetMinimum(1.041737);
   Graph_10dO000000sPppm1115->SetMaximum(1.384119);
   ...
   quadLineFit1116->SetChisquare(1.852849e-19);
   ...
   quadLineFit1116->SetParameter(0,2.420284);
   quadLineFit1116->SetParError(0,0.05448195);
   quadLineFit1116->SetParLimits(0,0,0);
   quadLineFit1116->SetParameter(1,-0.06707531);
   ...
   quadLineFit1117->SetChisquare(1.852849e-19);
   ...
   quadLineFit1117->SetParameter(0,2.420284);
   quadLineFit1117->SetParError(0,0.05448195);
   quadLineFit1117->SetParLimits(0,0,0);
   quadLineFit1117->SetParameter(1,-0.06707531);
   ...
   Graph_30dO000000sPppm1117->SetMinimum(2.235513);
   Graph_30dO000000sPppm1117->SetMaximum(2.931528);
   ...
   quadLineFit1118->SetChisquare(2.050484e-20);
   ...
   quadLineFit1118->SetParameter(0,5.117);
   quadLineFit1118->SetParError(0,0.05448195);
   quadLineFit1118->SetParLimits(0,0,0);
   quadLineFit1118->SetParameter(1,-0.1407488);
   ...
   quadLineFit1119->SetChisquare(2.050484e-20);
   ...
   quadLineFit1119->SetParameter(0,5.117);
   quadLineFit1119->SetParError(0,0.05448195);
   quadLineFit1119->SetParLimits(0,0,0);
   quadLineFit1119->SetParameter(1,-0.1407488);
