...
//=========  (Fri Oct  9 18:18:43 2020) by ROOT version 6.22/02
   ...
   quadLineFit1072->SetChisquare(3.179725e-19);
   ...
   quadLineFit1072->SetParameter(0,-3.032122);
   quadLineFit1072->SetParError(0,0.06676866);
   quadLineFit1072->SetParLimits(0,0,0);
   quadLineFit1072->SetParameter(1,0.08586629);
   ...
   quadLineFit1073->SetChisquare(3.179725e-19);
   ...
   quadLineFit1073->SetParameter(0,-3.032122);
   quadLineFit1073->SetParError(0,0.06676866);
   quadLineFit1073->SetParLimits(0,0,0);
   quadLineFit1073->SetParameter(1,0.08586629);
   ...
   Graph_mI10dO000000sPppm1073->SetMinimum(-0.1684599);
   Graph_mI10dO000000sPppm1073->SetMaximum(-0.1168938);
   ...
   quadLineFit1074->SetChisquare(8.87675e-20);
   ...
   quadLineFit1074->SetParameter(0,-0.2422019);
   quadLineFit1074->SetParError(0,0.06676866);
   quadLineFit1074->SetParLimits(0,0,0);
   quadLineFit1074->SetParameter(1,0.005529172);
   ...
   quadLineFit1075->SetChisquare(8.87675e-20);
   ...
   quadLineFit1075->SetParameter(0,-0.2422019);
   quadLineFit1075->SetParError(0,0.06676866);
   quadLineFit1075->SetParLimits(0,0,0);
   quadLineFit1075->SetParameter(1,0.005529172);
   ...
   Graph_10dO000000sPppm1075->SetMinimum(1.048257);
   Graph_10dO000000sPppm1075->SetMaximum(1.364679);
   ...
   quadLineFit1076->SetChisquare(1.104247e-19);
   ...
   quadLineFit1076->SetParameter(0,2.299203);
   quadLineFit1076->SetParError(0,0.06676866);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-0.06070749);
   ...
   quadLineFit1077->SetChisquare(1.104247e-19);
   ...
   quadLineFit1077->SetParameter(0,2.299203);
   quadLineFit1077->SetParError(0,0.06676866);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-0.06070749);
   ...
   Graph_30dO000000sPppm1077->SetMinimum(2.192348);
   Graph_30dO000000sPppm1077->SetMaximum(2.933448);
   ...
   quadLineFit1078->SetChisquare(8.534064e-20);
   ...
   quadLineFit1078->SetParameter(0,5.248173);
   quadLineFit1078->SetParError(0,0.06676866);
   quadLineFit1078->SetParLimits(0,0,0);
   quadLineFit1078->SetParameter(1,-0.1491819);
   ...
   quadLineFit1079->SetChisquare(8.534064e-20);
   ...
   quadLineFit1079->SetParameter(0,5.248173);
   quadLineFit1079->SetParError(0,0.06676866);
   quadLineFit1079->SetParLimits(0,0,0);
   quadLineFit1079->SetParameter(1,-0.1491819);
