...
//=========  (Fri Oct  9 18:18:36 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(2.036047e-20);
   ...
   quadLineFit1002->SetParameter(0,-3.22212);
   quadLineFit1002->SetParError(0,0.1871291);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.09760637);
   ...
   quadLineFit1003->SetChisquare(2.036047e-20);
   ...
   quadLineFit1003->SetParameter(0,-3.22212);
   quadLineFit1003->SetParError(0,0.1871291);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.09760637);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.1823363);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.06398451);
   ...
   quadLineFit1004->SetChisquare(2.521022e-22);
   ...
   quadLineFit1004->SetParameter(0,-0.3039577);
   quadLineFit1004->SetParError(0,0.1871291);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.01004429);
   ...
   quadLineFit1005->SetChisquare(2.521022e-22);
   ...
   quadLineFit1005->SetParameter(0,-0.3039577);
   quadLineFit1005->SetParError(0,0.1871291);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.01004429);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(1.077527);
   Graph_10dO000000sPppm1005->SetMaximum(1.509923);
   ...
   quadLineFit1006->SetChisquare(6.121367e-19);
   ...
   quadLineFit1006->SetParameter(0,2.652188);
   quadLineFit1006->SetParError(0,0.1871291);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.07547017);
   ...
   quadLineFit1007->SetChisquare(6.121367e-19);
   ...
   quadLineFit1007->SetParameter(0,2.652188);
   quadLineFit1007->SetParError(0,0.1871291);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.07547017);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(2.28337);
   Graph_30dO000000sPppm1007->SetMaximum(2.982893);
   ...
   quadLineFit1008->SetChisquare(1.367084e-18);
   ...
   quadLineFit1008->SetParameter(0,4.99332);
   quadLineFit1008->SetParError(0,0.1871291);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1311216);
   ...
   quadLineFit1009->SetChisquare(1.367084e-18);
   ...
   quadLineFit1009->SetParameter(0,4.99332);
   quadLineFit1009->SetParError(0,0.1871291);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1311216);
