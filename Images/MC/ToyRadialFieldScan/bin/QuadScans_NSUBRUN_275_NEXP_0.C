...
//=========  (Fri Oct  9 18:18:46 2020) by ROOT version 6.22/02
   ...
   quadLineFit1102->SetChisquare(2.516521e-20);
   ...
   quadLineFit1102->SetParameter(0,-3.041801);
   quadLineFit1102->SetParError(0,0.05691197);
   quadLineFit1102->SetParLimits(0,0,0);
   quadLineFit1102->SetParameter(1,0.08620468);
   ...
   quadLineFit1103->SetChisquare(2.516521e-20);
   ...
   quadLineFit1103->SetParameter(0,-3.041801);
   quadLineFit1103->SetParError(0,0.05691197);
   quadLineFit1103->SetParLimits(0,0,0);
   quadLineFit1103->SetParameter(1,0.08620468);
   ...
   Graph_mI10dO000000sPppm1103->SetMinimum(-0.1473567);
   Graph_mI10dO000000sPppm1103->SetMaximum(-0.1102598);
   ...
   quadLineFit1104->SetChisquare(2.290779e-25);
   ...
   quadLineFit1104->SetParameter(0,-0.1879281);
   quadLineFit1104->SetParError(0,0.05691197);
   quadLineFit1104->SetParLimits(0,0,0);
   quadLineFit1104->SetParameter(1,0.003284434);
   ...
   quadLineFit1105->SetChisquare(2.290779e-25);
   ...
   quadLineFit1105->SetParameter(0,-0.1879281);
   quadLineFit1105->SetParError(0,0.05691197);
   quadLineFit1105->SetParLimits(0,0,0);
   quadLineFit1105->SetParameter(1,0.003284434);
   ...
   Graph_10dO000000sPppm1105->SetMinimum(1.046159);
   Graph_10dO000000sPppm1105->SetMaximum(1.386677);
   ...
   quadLineFit1106->SetChisquare(2.412271e-18);
   ...
   quadLineFit1106->SetParameter(0,2.413366);
   quadLineFit1106->SetParError(0,0.05691197);
   quadLineFit1106->SetParLimits(0,0,0);
   quadLineFit1106->SetParameter(1,-0.06649709);
   ...
   quadLineFit1107->SetChisquare(2.412271e-18);
   ...
   quadLineFit1107->SetParameter(0,2.413366);
   quadLineFit1107->SetParError(0,0.05691197);
   quadLineFit1107->SetParLimits(0,0,0);
   quadLineFit1107->SetParameter(1,-0.06649709);
   ...
   Graph_30dO000000sPppm1107->SetMinimum(2.223472);
   Graph_30dO000000sPppm1107->SetMaximum(2.921309);
   ...
   quadLineFit1108->SetChisquare(2.731262e-17);
   ...
   quadLineFit1108->SetParameter(0,5.109284);
   quadLineFit1108->SetParError(0,0.05691197);
   quadLineFit1108->SetParLimits(0,0,0);
   quadLineFit1108->SetParameter(1,-0.1409385);
   ...
   quadLineFit1109->SetChisquare(2.731262e-17);
   ...
   quadLineFit1109->SetParameter(0,5.109284);
   quadLineFit1109->SetParError(0,0.05691197);
   quadLineFit1109->SetParLimits(0,0,0);
   quadLineFit1109->SetParameter(1,-0.1409385);
