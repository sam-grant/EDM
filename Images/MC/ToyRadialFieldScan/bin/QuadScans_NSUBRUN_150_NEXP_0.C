...
//=========  (Fri Oct  9 18:18:41 2020) by ROOT version 6.22/02
   ...
   quadLineFit1052->SetChisquare(1.558537e-19);
   ...
   quadLineFit1052->SetParameter(0,-2.999877);
   quadLineFit1052->SetParError(0,0.07714354);
   quadLineFit1052->SetParLimits(0,0,0);
   quadLineFit1052->SetParameter(1,0.08367184);
   ...
   quadLineFit1053->SetChisquare(1.558537e-19);
   ...
   quadLineFit1053->SetParameter(0,-2.999877);
   quadLineFit1053->SetParError(0,0.07714354);
   quadLineFit1053->SetParLimits(0,0,0);
   quadLineFit1053->SetParameter(1,0.08367184);
   ...
   Graph_mI10dO000000sPppm1053->SetMinimum(-0.1616528);
   Graph_mI10dO000000sPppm1053->SetMaximum(-0.1087452);
   ...
   quadLineFit1054->SetChisquare(3.966809e-24);
   ...
   quadLineFit1054->SetParameter(0,-0.2251726);
   quadLineFit1054->SetParError(0,0.07714354);
   quadLineFit1054->SetParLimits(0,0,0);
   quadLineFit1054->SetParameter(1,0.004998532);
   ...
   quadLineFit1055->SetChisquare(3.966809e-24);
   ...
   quadLineFit1055->SetParameter(0,-0.2251726);
   quadLineFit1055->SetParError(0,0.07714354);
   quadLineFit1055->SetParLimits(0,0,0);
   quadLineFit1055->SetParameter(1,0.004998532);
   ...
   Graph_10dO000000sPppm1055->SetMinimum(1.050665);
   Graph_10dO000000sPppm1055->SetMaximum(1.415513);
   ...
   quadLineFit1056->SetChisquare(1.461887e-18);
   ...
   quadLineFit1056->SetParameter(0,2.49284);
   quadLineFit1056->SetParError(0,0.07714354);
   quadLineFit1056->SetParLimits(0,0,0);
   quadLineFit1056->SetParameter(1,-0.06998616);
   ...
   quadLineFit1057->SetChisquare(1.461887e-18);
   ...
   quadLineFit1057->SetParameter(0,2.49284);
   quadLineFit1057->SetParError(0,0.07714354);
   quadLineFit1057->SetParLimits(0,0,0);
   quadLineFit1057->SetParameter(1,-0.06998616);
   ...
   Graph_30dO000000sPppm1057->SetMinimum(2.241095);
   Graph_30dO000000sPppm1057->SetMaximum(2.929602);
   ...
   quadLineFit1058->SetChisquare(2.319452e-17);
   ...
   quadLineFit1058->SetParameter(0,5.058821);
   quadLineFit1058->SetParError(0,0.07714354);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,-0.1374151);
   ...
   quadLineFit1059->SetChisquare(2.319452e-17);
   ...
   quadLineFit1059->SetParameter(0,5.058821);
   quadLineFit1059->SetParError(0,0.07714354);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,-0.1374151);
