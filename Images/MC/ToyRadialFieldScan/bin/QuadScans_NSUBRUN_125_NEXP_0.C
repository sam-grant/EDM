...
//=========  (Fri Oct  9 18:18:40 2020) by ROOT version 6.22/02
   ...
   quadLineFit1042->SetChisquare(2.929443e-18);
   ...
   quadLineFit1042->SetParameter(0,-3.180828);
   quadLineFit1042->SetParError(0,0.08454357);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.09402966);
   ...
   quadLineFit1043->SetChisquare(2.929443e-18);
   ...
   quadLineFit1043->SetParameter(0,-3.180828);
   quadLineFit1043->SetParError(0,0.08454357);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.09402966);
   ...
   Graph_mI10dO000000sPppm1043->SetMinimum(-0.1760687);
   Graph_mI10dO000000sPppm1043->SetMaximum(-0.09605706);
   ...
   quadLineFit1044->SetChisquare(9.204519e-22);
   ...
   quadLineFit1044->SetParameter(0,-0.3172751);
   quadLineFit1044->SetParError(0,0.08454357);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,0.01006735);
   ...
   quadLineFit1045->SetChisquare(9.204519e-22);
   ...
   quadLineFit1045->SetParameter(0,-0.3172751);
   quadLineFit1045->SetParError(0,0.08454357);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,0.01006735);
   ...
   Graph_10dO000000sPppm1045->SetMinimum(1.046868);
   Graph_10dO000000sPppm1045->SetMaximum(1.37621);
   ...
   quadLineFit1046->SetChisquare(4.008869e-20);
   ...
   quadLineFit1046->SetParameter(0,2.32774);
   quadLineFit1046->SetParError(0,0.08454357);
   quadLineFit1046->SetParLimits(0,0,0);
   quadLineFit1046->SetParameter(1,-0.06201116);
   ...
   quadLineFit1047->SetChisquare(4.008869e-20);
   ...
   quadLineFit1047->SetParameter(0,2.32774);
   quadLineFit1047->SetParError(0,0.08454357);
   quadLineFit1047->SetParLimits(0,0,0);
   quadLineFit1047->SetParameter(1,-0.06201116);
   ...
   Graph_30dO000000sPppm1047->SetMinimum(2.225187);
   Graph_30dO000000sPppm1047->SetMaximum(2.909847);
   ...
   quadLineFit1048->SetChisquare(2.451745e-18);
   ...
   quadLineFit1048->SetParameter(0,5.016159);
   quadLineFit1048->SetParError(0,0.08454357);
   quadLineFit1048->SetParLimits(0,0,0);
   quadLineFit1048->SetParameter(1,-0.1360356);
   ...
   quadLineFit1049->SetChisquare(2.451745e-18);
   ...
   quadLineFit1049->SetParameter(0,5.016159);
   quadLineFit1049->SetParError(0,0.08454357);
   quadLineFit1049->SetParLimits(0,0,0);
   quadLineFit1049->SetParameter(1,-0.1360356);
