...
//=========  (Fri Oct  9 18:18:42 2020) by ROOT version 6.22/02
   ...
   quadLineFit1062->SetChisquare(6.623686e-20);
   ...
   quadLineFit1062->SetParameter(0,-3.08616);
   quadLineFit1062->SetParError(0,0.07140628);
   quadLineFit1062->SetParLimits(0,0,0);
   quadLineFit1062->SetParameter(1,0.08798843);
   ...
   quadLineFit1063->SetChisquare(6.623686e-20);
   ...
   quadLineFit1063->SetParameter(0,-3.08616);
   quadLineFit1063->SetParError(0,0.07140628);
   quadLineFit1063->SetParLimits(0,0,0);
   quadLineFit1063->SetParameter(1,0.08798843);
   ...
   Graph_mI10dO000000sPppm1063->SetMinimum(-0.1817111);
   Graph_mI10dO000000sPppm1063->SetMaximum(-0.1140623);
   ...
   quadLineFit1064->SetChisquare(3.825481e-21);
   ...
   quadLineFit1064->SetParameter(0,-0.3012037);
   quadLineFit1064->SetParError(0,0.07140628);
   quadLineFit1064->SetParLimits(0,0,0);
   quadLineFit1064->SetParameter(1,0.008517606);
   ...
   quadLineFit1065->SetChisquare(3.825481e-21);
   ...
   quadLineFit1065->SetParameter(0,-0.3012037);
   quadLineFit1065->SetParError(0,0.07140628);
   quadLineFit1065->SetParLimits(0,0,0);
   quadLineFit1065->SetParameter(1,0.008517606);
   ...
   Graph_10dO000000sPppm1065->SetMinimum(1.040534);
   Graph_10dO000000sPppm1065->SetMaximum(1.4187);
   ...
   quadLineFit1066->SetChisquare(9.543543e-20);
   ...
   quadLineFit1066->SetParameter(0,2.547373);
   quadLineFit1066->SetParError(0,0.07140628);
   quadLineFit1066->SetParLimits(0,0,0);
   quadLineFit1066->SetParameter(1,-0.07320864);
   ...
   quadLineFit1067->SetChisquare(9.543543e-20);
   ...
   quadLineFit1067->SetParameter(0,2.547373);
   quadLineFit1067->SetParError(0,0.07140628);
   quadLineFit1067->SetParLimits(0,0,0);
   quadLineFit1067->SetParameter(1,-0.07320864);
   ...
   Graph_30dO000000sPppm1067->SetMinimum(2.212053);
   Graph_30dO000000sPppm1067->SetMaximum(2.92168);
   ...
   quadLineFit1068->SetChisquare(3.879843e-19);
   ...
   quadLineFit1068->SetParameter(0,5.127602);
   quadLineFit1068->SetParError(0,0.07140628);
   quadLineFit1068->SetParLimits(0,0,0);
   quadLineFit1068->SetParameter(1,-0.142263);
   ...
   quadLineFit1069->SetChisquare(3.879843e-19);
   ...
   quadLineFit1069->SetParameter(0,5.127602);
   quadLineFit1069->SetParError(0,0.07140628);
   quadLineFit1069->SetParLimits(0,0,0);
   quadLineFit1069->SetParameter(1,-0.142263);
