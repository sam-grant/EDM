...
//=========  (Fri Oct  9 18:18:37 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2107537,45,0.1568414);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01019->SetMinimum(-0.1739942);
   Graph_Graph01019->SetMaximum(0.1200818);
   ...
   fieldLineFit1020->SetChisquare(0.7816946);
   ...
   fieldLineFit1020->SetParameter(0,-0.02554814);
   fieldLineFit1020->SetParError(0,0.003666401);
   fieldLineFit1020->SetParLimits(0,0,0);
   fieldLineFit1020->SetParameter(1,-0.003883489);
   ...
   pt_LaTex = pt->AddText("#minus0.00388#pm0.000164");
   pt_LaTex = pt->AddText("-0.0255#pm0.00367");
   pt_LaTex = pt->AddText("-6.58#pm0.944");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-6.578657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.578657,-0.1739942,-6.578657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1021->SetChisquare(0.7816946);
   ...
   fieldLineFit1021->SetParameter(0,-0.02554814);
   fieldLineFit1021->SetParError(0,0.003666401);
   fieldLineFit1021->SetParLimits(0,0,0);
   fieldLineFit1021->SetParameter(1,-0.003883489);
