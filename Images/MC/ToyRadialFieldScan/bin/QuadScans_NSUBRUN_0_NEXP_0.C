...
//=========  (Thu Oct  8 15:41:36 2020) by ROOT version 6.22/02
   ...
   quadLineFit1032->SetChisquare(9.803988e-22);
   ...
   quadLineFit1032->SetParameter(0,-4.275);
   quadLineFit1032->SetParError(0,6.403124);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,0.11875);
   quadLineFit1032->SetParError(1,0.3535534);
   ...
   quadLineFit1033->SetChisquare(9.803988e-22);
   ...
   quadLineFit1033->SetParameter(0,-4.275);
   quadLineFit1033->SetParError(0,6.403124);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,0.11875);
   quadLineFit1033->SetParError(1,0.3535534);
   ...
   Graph_mI10dO000000sPppm1033->SetMinimum(-1.1475);
   Graph_mI10dO000000sPppm1033->SetMaximum(-0.8775);
   ...
   quadLineFit1034->SetChisquare(1.272639e-24);
   ...
   quadLineFit1034->SetParameter(0,-2.025);
   quadLineFit1034->SetParError(0,6.403124);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.05625);
   quadLineFit1034->SetParError(1,0.3535534);
   ...
   quadLineFit1035->SetChisquare(1.272639e-24);
   ...
   quadLineFit1035->SetParameter(0,-2.025);
   quadLineFit1035->SetParError(0,6.403124);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.05625);
   quadLineFit1035->SetParError(1,0.3535534);
   ...
   Graph_10dO000000sPppm1035->SetMinimum(0.0975);
   Graph_10dO000000sPppm1035->SetMaximum(0.1275);
   ...
   quadLineFit1036->SetChisquare(2.831271e-28);
   ...
   quadLineFit1036->SetParameter(0,0.225);
   quadLineFit1036->SetParError(0,6.403124);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.00625);
   quadLineFit1036->SetParError(1,0.3535534);
   ...
   quadLineFit1037->SetChisquare(2.831271e-28);
   ...
   quadLineFit1037->SetParameter(0,0.225);
   quadLineFit1037->SetParError(0,6.403124);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.00625);
   quadLineFit1037->SetParError(1,0.3535534);
   ...
   Graph_30dO000000sPppm1037->SetMinimum(1.0725);
   Graph_30dO000000sPppm1037->SetMaximum(1.4025);
   ...
   quadLineFit1038->SetChisquare(1.249575e-25);
   ...
   quadLineFit1038->SetParameter(0,2.475);
   quadLineFit1038->SetParError(0,6.403124);
   quadLineFit1038->SetParLimits(0,0,0);
   quadLineFit1038->SetParameter(1,-0.06875);
   quadLineFit1038->SetParError(1,0.3535534);
   ...
   quadLineFit1039->SetChisquare(1.249575e-25);
   ...
   quadLineFit1039->SetParameter(0,2.475);
   quadLineFit1039->SetParError(0,6.403124);
   quadLineFit1039->SetParLimits(0,0,0);
   quadLineFit1039->SetParameter(1,-0.06875);
   quadLineFit1039->SetParError(1,0.3535534);
