...
//=========  (Fri Oct  9 18:18:45 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2071015,45,0.1541055);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01099->SetMinimum(-0.1709808);
   Graph_Graph01099->SetMaximum(0.1179848);
   ...
   fieldLineFit1100->SetChisquare(2.464431);
   ...
   fieldLineFit1100->SetParameter(0,-0.02837922);
   fieldLineFit1100->SetParError(0,0.00164805);
   fieldLineFit1100->SetParLimits(0,0,0);
   fieldLineFit1100->SetParameter(1,-0.003930018);
   ...
   pt_LaTex = pt->AddText("#minus0.00393#pm7.37e-05");
   pt_LaTex = pt->AddText("-0.0284#pm0.00165");
   pt_LaTex = pt->AddText("-7.22#pm0.419");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.221143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.221143,-0.1709808,-7.221143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1101->SetChisquare(2.464431);
   ...
   fieldLineFit1101->SetParameter(0,-0.02837922);
   fieldLineFit1101->SetParError(0,0.00164805);
   fieldLineFit1101->SetParLimits(0,0,0);
   fieldLineFit1101->SetParameter(1,-0.003930018);
