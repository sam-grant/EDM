...
//=========  (Fri Oct  9 18:18:48 2020) by ROOT version 6.22/02
   ...
   quadLineFit1122->SetChisquare(2.64181e-18);
   ...
   quadLineFit1122->SetParameter(0,-3.011971);
   quadLineFit1122->SetParError(0,0.05234493);
   quadLineFit1122->SetParLimits(0,0,0);
   quadLineFit1122->SetParameter(1,0.0844947);
   ...
   quadLineFit1123->SetChisquare(2.64181e-18);
   ...
   quadLineFit1123->SetParameter(0,-3.011971);
   quadLineFit1123->SetParError(0,0.05234493);
   quadLineFit1123->SetParLimits(0,0,0);
   quadLineFit1123->SetParameter(1,0.0844947);
   ...
   Graph_mI10dO000000sPppm1123->SetMinimum(-0.1510604);
   Graph_mI10dO000000sPppm1123->SetMaximum(-0.09907666);
   ...
   quadLineFit1124->SetChisquare(3.134107e-22);
   ...
   quadLineFit1124->SetParameter(0,-0.2464336);
   quadLineFit1124->SetParError(0,0.05234493);
   quadLineFit1124->SetParLimits(0,0,0);
   quadLineFit1124->SetParameter(1,0.006742503);
   ...
   quadLineFit1125->SetChisquare(3.134107e-22);
   ...
   quadLineFit1125->SetParameter(0,-0.2464336);
   quadLineFit1125->SetParError(0,0.05234493);
   quadLineFit1125->SetParLimits(0,0,0);
   quadLineFit1125->SetParameter(1,0.006742503);
   ...
   Graph_10dO000000sPppm1125->SetMinimum(1.033688);
   Graph_10dO000000sPppm1125->SetMaximum(1.390513);
   ...
   quadLineFit1126->SetChisquare(1.425497e-21);
   ...
   quadLineFit1126->SetParameter(0,2.476621);
   quadLineFit1126->SetParError(0,0.05234493);
   quadLineFit1126->SetParLimits(0,0,0);
   quadLineFit1126->SetParameter(1,-0.07025115);
   ...
   quadLineFit1127->SetChisquare(1.425497e-21);
   ...
   quadLineFit1127->SetParameter(0,2.476621);
   quadLineFit1127->SetParError(0,0.05234493);
   quadLineFit1127->SetParLimits(0,0,0);
   quadLineFit1127->SetParameter(1,-0.07025115);
   ...
   Graph_30dO000000sPppm1127->SetMinimum(2.232764);
   Graph_30dO000000sPppm1127->SetMaximum(2.928185);
   ...
   quadLineFit1128->SetChisquare(2.089852e-18);
   ...
   quadLineFit1128->SetParameter(0,5.114731);
   quadLineFit1128->SetParError(0,0.05234493);
   quadLineFit1128->SetParLimits(0,0,0);
   quadLineFit1128->SetParameter(1,-0.140792);
   ...
   quadLineFit1129->SetChisquare(2.089852e-18);
   ...
   quadLineFit1129->SetParameter(0,5.114731);
   quadLineFit1129->SetParError(0,0.05234493);
   quadLineFit1129->SetParLimits(0,0,0);
   quadLineFit1129->SetParameter(1,-0.140792);
