...
//=========  (Fri Oct  9 18:18:42 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.20574,45,0.1514654);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.1700195);
   Graph_Graph01069->SetMaximum(0.1157449);
   ...
   fieldLineFit1070->SetChisquare(2.461624);
   ...
   fieldLineFit1070->SetParameter(0,-0.02974141);
   fieldLineFit1070->SetParError(0,0.001971376);
   fieldLineFit1070->SetParLimits(0,0,0);
   fieldLineFit1070->SetParameter(1,-0.003862403);
   ...
   pt_LaTex = pt->AddText("-0.0297#pm0.00197");
   pt_LaTex = pt->AddText(" -7.7#pm 0.51");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.700235,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.700235,-0.1700195,-7.700235,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   fieldLineFit1071->SetChisquare(2.461624);
   ...
   fieldLineFit1071->SetParameter(0,-0.02974141);
   fieldLineFit1071->SetParError(0,0.001971376);
   fieldLineFit1071->SetParLimits(0,0,0);
   fieldLineFit1071->SetParameter(1,-0.003862403);
