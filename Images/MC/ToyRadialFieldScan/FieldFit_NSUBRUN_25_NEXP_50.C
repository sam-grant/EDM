...
//=========  (Thu May  5 13:01:50 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01013->SetMinimum(-63.64534);
   Graph_Graph01013->SetMaximum(80.39355);
   ...
   mainFit1014->SetChisquare(5.377057);
   ...
   mainFit1014->SetParameter(0,9.214639);
   mainFit1014->SetParError(0,0.8820762);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,1.163729);
   mainFit1014->SetParError(1,0.02781961);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.918197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.918197,-63.64534,-7.918197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1015->SetChisquare(5.377057);
   ...
   mainFit1015->SetParameter(0,9.214639);
   mainFit1015->SetParError(0,0.8820762);
   mainFit1015->SetParLimits(0,0,0);
   mainFit1015->SetParameter(1,1.163729);
   mainFit1015->SetParError(1,0.02781961);
