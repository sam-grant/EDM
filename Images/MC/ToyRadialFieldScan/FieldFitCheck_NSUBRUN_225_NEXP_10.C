void FieldFitCheck_NSUBRUN_225_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-106.4781,75,397.8241);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01143->SetMinimum(-56.04785);
   Graph_Graph01143->SetMaximum(347.3939);
   ...
   checkFit1144->SetChisquare(181744.4);
   ...
   checkFit1144->SetParameter(0,67.07048);
   checkFit1144->SetParError(0,0.2342595);
   checkFit1144->SetParLimits(0,0,0);
   checkFit1144->SetParameter(1,-1.546444);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("4.54e+04");
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,43.37077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(43.37077,-56.04785,43.37077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1145->SetChisquare(181744.4);
   ...
   checkFit1145->SetParameter(0,67.07048);
   checkFit1145->SetParError(0,0.2342595);
   checkFit1145->SetParLimits(0,0,0);
   checkFit1145->SetParameter(1,-1.546444);
