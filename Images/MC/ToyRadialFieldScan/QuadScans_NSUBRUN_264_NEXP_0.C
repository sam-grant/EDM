void QuadScans_NSUBRUN_264_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:36:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.053224,0.0768254,3.874878);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1025->SetMinimum(-2.360414);
   Graph_30dO000000sPppm1025->SetMaximum(3.182068);
   ...
   quadLineFit1026->SetChisquare(1.850789e-21);
   ...
   quadLineFit1026->SetParameter(0,-0.05743155);
   quadLineFit1026->SetParError(0,0.05181897);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,46.85554);
   quadLineFit1026->SetParError(1,0.8098464);
   ...
   quadLineFit1027->SetChisquare(1.850789e-21);
   ...
   quadLineFit1027->SetParameter(0,-0.05743155);
   quadLineFit1027->SetParError(0,0.05181897);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,46.85554);
   quadLineFit1027->SetParError(1,0.8098464);
   ...
   Graph_mI30dO000000sPppm1027->SetMinimum(-1.940826);
   Graph_mI30dO000000sPppm1027->SetMaximum(-1.419963);
   ...
   quadLineFit1028->SetChisquare(3.655701e-18);
   ...
   quadLineFit1028->SetParameter(0,-0.01690052);
   quadLineFit1028->SetParError(0,0.05181898);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,-26.20003);
   quadLineFit1028->SetParError(1,0.8098465);
   ...
   quadLineFit1029->SetChisquare(3.655701e-18);
   ...
   quadLineFit1029->SetParameter(0,-0.01690052);
   quadLineFit1029->SetParError(0,0.05181898);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,-26.20003);
   quadLineFit1029->SetParError(1,0.8098465);
