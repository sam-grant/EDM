...
//=========  (Wed Jan  5 17:07:01 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-37.91607,45,54.49919);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01079 = new TH1F("Graph_Graph01079","",100,-36,36);
   Graph_Graph01079->SetMinimum(-28.67454);
   Graph_Graph01079->SetMaximum(45.25766);
   ...
   TF1 *checkFit1080 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1080->SetChisquare(4.317307e-17);
   ...
   checkFit1080->SetParameter(1,1.003815);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.260051,-28.67454,-8.260051,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1081 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1081->SetChisquare(4.317307e-17);
   ...
   checkFit1081->SetParameter(1,1.003815);
