void Result_NSUBRUN_128005673_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct  5 20:30:52 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-0.115625,45,0.165625);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle("Sub-runs 128005673");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01009 = new TH1F("Graph_Graph01009","Sub-runs 128005673",100,-36,36);
   Graph_Graph01009->SetMinimum(-0.0875);
   Graph_Graph01009->SetMaximum(0.1375);
   ...
   fieldLineFit1010->SetChisquare(6.823017e+123);
   ...
   fieldLineFit1010->SetParameter(0,0.025);
   fieldLineFit1010->SetParError(0,3.435012e-78);
   fieldLineFit1010->SetParLimits(0,0,0);
   fieldLineFit1010->SetParameter(1,-0.003125);
   fieldLineFit1010->SetParError(1,1.536184e-79);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("3.41#times10^{123}");
   pt_LaTex = pt->AddText("#minus0.00313#pm1.54e-79");
   pt_LaTex = pt->AddText("0.025#pm3.44e-78");
   pt_LaTex = pt->AddText("    8#pm1.17e-75");
   pt->Draw();
   ...
   fieldLineFit1011->SetChisquare(6.823017e+123);
   ...
   fieldLineFit1011->SetParameter(0,0.025);
   fieldLineFit1011->SetParError(0,3.435012e-78);
   fieldLineFit1011->SetParLimits(0,0,0);
   fieldLineFit1011->SetParameter(1,-0.003125);
   fieldLineFit1011->SetParError(1,1.536184e-79);
   fieldLineFit1011->SetParLimits(1,0,0);
   fieldLineFit1011->Draw("same");
   
   pt = new TPaveText(0.3141206,0.94,0.6858794,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   pt_LaTex = pt->AddText("Sub-runs 128005673");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
