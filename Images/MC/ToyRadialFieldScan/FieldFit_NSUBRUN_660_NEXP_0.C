void FieldFit_NSUBRUN_660_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:42 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01077->SetMinimum(-140.657);
   Graph_Graph01077->SetMaximum(159.9385);
   ...
   mainFit1078->SetChisquare(7.82679e-22);
   ...
   mainFit1078->SetParameter(0,9.640711);
   mainFit1078->SetParError(0,63);
   mainFit1078->SetParLimits(0,0,0);
   mainFit1078->SetParameter(1,1.205089);
   mainFit1078->SetParError(1,2.1);
...
");
   ...
   mainFit1079->SetChisquare(7.82679e-22);
   ...
   mainFit1079->SetParameter(0,9.640711);
   mainFit1079->SetParError(0,63);
   mainFit1079->SetParLimits(0,0,0);
   mainFit1079->SetParameter(1,1.205089);
   mainFit1079->SetParError(1,2.1);
