void FieldFitCheck_NSUBRUN_40_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:09:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-39.33262,45,58.27213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-29.57214);
   Graph_Graph01031->SetMaximum(48.51165);
   ...
   checkFit1032->SetChisquare(1.288556e-16);
   ...
   checkFit1032->SetParameter(0,9.469754);
   checkFit1032->SetParError(0,1.225027);
   checkFit1032->SetParLimits(0,0,0);
   checkFit1032->SetParameter(1,1.026749);
   checkFit1032->SetParError(1,0.04083423);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.223048,-29.57214,-9.223048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(1.288556e-16);
   ...
   checkFit1033->SetParameter(0,9.469754);
   checkFit1033->SetParError(0,1.225027);
   checkFit1033->SetParLimits(0,0,0);
   checkFit1033->SetParameter(1,1.026749);
   checkFit1033->SetParError(1,0.04083423);
