...
//=========  (Wed Jan  5 17:07:01 2022) by ROOT version 6.24/06
   ...
   c->Range(0.05142857,-3.069784,0.0768254,3.87688);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30dO000000sPppm1073->SetMinimum(-2.375117);
   Graph_30dO000000sPppm1073->SetMaximum(3.182214);
   ...
   quadLineFit1074->SetChisquare(9.667953e-18);
   ...
   quadLineFit1074->SetParameter(1,46.28264);
   ...
   quadLineFit1075->SetChisquare(9.667953e-18);
   ...
   quadLineFit1075->SetParameter(1,46.28264);
   ...
   Graph_mI30dO000000sPppm1075->SetMinimum(-1.953047);
   Graph_mI30dO000000sPppm1075->SetMaximum(-1.429704);
   ...
   quadLineFit1076->SetChisquare(5.748181e-19);
   ...
   quadLineFit1076->SetParError(0,0.05325501);
   quadLineFit1076->SetParLimits(0,0,0);
   quadLineFit1076->SetParameter(1,-26.29851);
   ...
   quadLineFit1077->SetChisquare(5.748181e-19);
   ...
   quadLineFit1077->SetParError(0,0.05325501);
   quadLineFit1077->SetParLimits(0,0,0);
   quadLineFit1077->SetParameter(1,-26.29851);
