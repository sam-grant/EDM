...
//=========  (Mon Jan 10 15:42:32 2022) by ROOT version 6.24/06
   ...
   c->Range(0.04836538,-5.223367,0.0663141,7.524141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1145->SetMinimum(-3.948616);
   Graph_mI50dO000000sPppm1145->SetMaximum(6.24939);
   ...
   quadLineFit1146->SetChisquare(0.07899828);
   ...
   quadLineFit1146->SetParameter(0,-0.02481109);
   quadLineFit1146->SetParError(0,0.06607529);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,-50.15825);
   quadLineFit1146->SetParError(1,1.16669);
   ...
   quadLineFit1147->SetChisquare(0.07899828);
   ...
   quadLineFit1147->SetParameter(0,-0.02481109);
   quadLineFit1147->SetParError(0,0.06607529);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,-50.15825);
   quadLineFit1147->SetParError(1,1.16669);
   ...
   Graph_mI30dO000000sPppm1147->SetMinimum(-1.959275);
   Graph_mI30dO000000sPppm1147->SetMaximum(-1.296007);
   ...
   quadLineFit1148->SetChisquare(0.1397931);
   ...
   quadLineFit1148->SetParameter(0,0.003327896);
   quadLineFit1148->SetParError(0,0.0371729);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,-26.55453);
   quadLineFit1148->SetParError(1,0.612682);
   ...
   quadLineFit1149->SetChisquare(0.1397931);
   ...
   quadLineFit1149->SetParameter(0,0.003327896);
   quadLineFit1149->SetParError(0,0.0371729);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,-26.55453);
   quadLineFit1149->SetParError(1,0.612682);
   ...
   Graph_mI10dO000000sPppm1149->SetMinimum(-0.1820514);
   Graph_mI10dO000000sPppm1149->SetMaximum(-0.1103176);
   ...
   quadLineFit1150->SetChisquare(0.6580718);
   ...
   quadLineFit1150->SetParameter(0,-0.03396792);
   quadLineFit1150->SetParError(0,0.03717267);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-1.850516);
   quadLineFit1150->SetParError(1,0.6126784);
   ...
   quadLineFit1151->SetChisquare(0.6580718);
   ...
   quadLineFit1151->SetParameter(0,-0.03396792);
   quadLineFit1151->SetParError(0,0.03717267);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-1.850516);
   quadLineFit1151->SetParError(1,0.6126784);
   ...
   Graph_10dO000000sPppm1151->SetMinimum(1.069578);
   Graph_10dO000000sPppm1151->SetMaximum(1.611798);
   ...
   quadLineFit1152->SetChisquare(1.975857);
   ...
   quadLineFit1152->SetParameter(0,0.01985044);
   quadLineFit1152->SetParError(0,0.04075467);
   quadLineFit1152->SetParLimits(0,0,0);
   quadLineFit1152->SetParameter(1,21.4405);
   quadLineFit1152->SetParError(1,0.6543295);
   ...
   quadLineFit1153->SetChisquare(1.975857);
   ...
   quadLineFit1153->SetParameter(0,0.01985044);
   quadLineFit1153->SetParError(0,0.04075467);
   quadLineFit1153->SetParLimits(0,0,0);
   quadLineFit1153->SetParameter(1,21.4405);
   quadLineFit1153->SetParError(1,0.6543295);
   ...
   Graph_30dO000000sPppm1153->SetMinimum(2.252);
   Graph_30dO000000sPppm1153->SetMaximum(3.377079);
   ...
   quadLineFit1154->SetChisquare(1.608457);
   ...
   quadLineFit1154->SetParameter(0,0.02704512);
   quadLineFit1154->SetParError(0,0.03717187);
   quadLineFit1154->SetParLimits(0,0,0);
   quadLineFit1154->SetParameter(1,45.39846);
   quadLineFit1154->SetParError(1,0.612665);
   ...
   quadLineFit1155->SetChisquare(1.608457);
   ...
   quadLineFit1155->SetParameter(0,0.02704512);
   quadLineFit1155->SetParError(0,0.03717187);
   quadLineFit1155->SetParLimits(0,0,0);
   quadLineFit1155->SetParameter(1,45.39846);
   quadLineFit1155->SetParError(1,0.612665);
   ...
   Graph_50dO000000sPppm1155->SetMinimum(3.428652);
   Graph_50dO000000sPppm1155->SetMaximum(5.152509);
   ...
   quadLineFit1156->SetChisquare(1.2013);
   ...
   quadLineFit1156->SetParameter(0,-0.009772257);
   quadLineFit1156->SetParError(0,0.03717264);
   quadLineFit1156->SetParLimits(0,0,0);
   quadLineFit1156->SetParameter(1,70.12151);
   quadLineFit1156->SetParError(1,0.6126779);
   ...
   quadLineFit1157->SetChisquare(1.2013);
   ...
   quadLineFit1157->SetParameter(0,-0.009772257);
   quadLineFit1157->SetParError(0,0.03717264);
   quadLineFit1157->SetParLimits(0,0,0);
   quadLineFit1157->SetParameter(1,70.12151);
   quadLineFit1157->SetParError(1,0.6126779);
