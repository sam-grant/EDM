void QuadScans_NSUBRUN_198_NEXP_0()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Jan  5 17:38:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.05142857,-3.059418,0.0768254,3.877121);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_30dO000000sPppm1017 = new TH1F("Graph_30dO000000sPppm1017","",100,0.05396825,0.07301587);
   Graph_30dO000000sPppm1017->SetMinimum(-2.365764);
   Graph_30dO000000sPppm1017->SetMaximum(3.183467);
   ...
   Graph_30dO000000sPppm1017->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   Graph_30dO000000sPppm1017->GetXaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1017->GetXaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1017->GetXaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1017->GetXaxis()->SetTitleOffset(1.1);
   Graph_30dO000000sPppm1017->GetXaxis()->SetTitleFont(42);
   Graph_30dO000000sPppm1017->GetYaxis()->SetTitle("#LTy#GT [mm]");
   Graph_30dO000000sPppm1017->GetYaxis()->CenterTitle(true);
   Graph_30dO000000sPppm1017->GetYaxis()->SetNdivisions(4000510);
   Graph_30dO000000sPppm1017->GetYaxis()->SetLabelFont(42);
   Graph_30dO000000sPppm1017->GetYaxis()->SetTitleSize(0.04);
   Graph_30dO000000sPppm1017->GetYaxis()->SetTitleOffset(1.1);
   ...
   TF1 *quadLineFit1018 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1018->SetFillColor(19);
   quadLineFit1018->SetFillStyle(0);
   quadLineFit1018->SetLineWidth(2);
   quadLineFit1018->SetChisquare(4.302584e-19);
   ...
   quadLineFit1018->SetParameter(0,0.0157021);
   quadLineFit1018->SetParError(0,0.05988874);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,45.55929);
   quadLineFit1018->SetParError(1,0.9359638);
   quadLineFit1018->SetParLimits(1,0,0);
   quadLineFit1018->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1018);
   gre->Draw("ap");
   
   TF1 *quadLineFit1019 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1019->SetFillColor(19);
   quadLineFit1019->SetFillStyle(0);
   quadLineFit1019->SetLineWidth(2);
   quadLineFit1019->SetChisquare(4.302584e-19);
   ...
   quadLineFit1019->SetParameter(0,0.0157021);
   quadLineFit1019->SetParError(0,0.05988874);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,45.55929);
   quadLineFit1019->SetParError(1,0.9359638);
   ...
   TH1F *Graph_mI30dO000000sPppm1019 = new TH1F("Graph_mI30dO000000sPppm1019","Graph",100,0.05396825,0.07301587);
   Graph_mI30dO000000sPppm1019->SetMinimum(-1.946367);
   Graph_mI30dO000000sPppm1019->SetMaximum(-1.427362);
   ...
   TF1 *quadLineFit1020 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1020->SetChisquare(9.191808e-20);
   ...
   quadLineFit1020->SetParameter(0,-0.04089113);
   quadLineFit1020->SetParError(0,0.05988874);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-25.92408);
   quadLineFit1020->SetParError(1,0.9359638);
   quadLineFit1020->SetParLimits(1,0,0);
   quadLineFit1020->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1020);
   gre->Draw("p ");
   
   TF1 *quadLineFit1021 = new TF1("quadLineFit","[0]+[1]*x",0.05555556,0.07142857, TF1::EAddToList::kNo);
   ...
   quadLineFit1021->SetChisquare(9.191808e-20);
   ...
   quadLineFit1021->SetParameter(0,-0.04089113);
   quadLineFit1021->SetParError(0,0.05988874);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-25.92408);
   quadLineFit1021->SetParError(1,0.9359638);
