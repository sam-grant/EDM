...
//=========  (Thu Oct 15 00:32:49 2020) by ROOT version 6.22/02
   ...
   TH1F *Graph_mI30dO000000sPppm1025 = new TH1F("Graph_mI30dO000000sPppm1025","",100,15.77,18.53);
   ...
   TF1 *quadLineFit1026 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1026->SetFillColor(19);
   quadLineFit1026->SetFillStyle(0);
   quadLineFit1026->SetLineWidth(2);
   quadLineFit1026->SetChisquare(4.804746e-18);
   ...
   quadLineFit1026->SetParameter(0,-2.929182);
   quadLineFit1026->SetParError(0,0.1792603);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.08123142);
   quadLineFit1026->SetParError(1,0.01042908);
   quadLineFit1026->SetParLimits(1,0,0);
   quadLineFit1026->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1026);
   gre->Draw("ap");
   
   TF1 *quadLineFit1027 = new TF1("quadLineFit","[0]+[1]*x",15.77,18.53, TF1::EAddToList::kNo);
   quadLineFit1027->SetFillColor(19);
   quadLineFit1027->SetFillStyle(0);
   quadLineFit1027->SetLineWidth(2);
   quadLineFit1027->SetChisquare(4.804746e-18);
   ...
   quadLineFit1027->SetParameter(0,-2.929182);
   quadLineFit1027->SetParError(0,0.1792603);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.08123142);
   quadLineFit1027->SetParError(1,0.01042908);
   ...
   TH1F *Graph_mI10dO000000sPppm1027 = new TH1F("Graph_mI10dO000000sPppm1027","Graph",100,15.77,18.53);
   Graph_mI10dO000000sPppm1027->SetMinimum(-0.1782097);
   Graph_mI10dO000000sPppm1027->SetMaximum(-0.08894878);
   ...
   quadLineFit1028->SetChisquare(4.464378e-21);
   ...
   quadLineFit1028->SetParameter(0,-0.4352816);
   quadLineFit1028->SetParError(0,0.1792603);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,0.01759197);
   quadLineFit1028->SetParError(1,0.01042908);
   ...
   quadLineFit1029->SetChisquare(4.464378e-21);
   ...
   quadLineFit1029->SetParameter(0,-0.4352816);
   quadLineFit1029->SetParError(0,0.1792603);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,0.01759197);
   quadLineFit1029->SetParError(1,0.01042908);
   ...
   TH1F *Graph_10dO000000sPppm1029 = new TH1F("Graph_10dO000000sPppm1029","Graph",100,15.77,18.53);
   Graph_10dO000000sPppm1029->SetMinimum(1.12786);
   Graph_10dO000000sPppm1029->SetMaximum(1.39916);
   ...
   quadLineFit1030->SetChisquare(4.122265e-22);
   ...
   quadLineFit1030->SetParameter(0,2.696358);
   quadLineFit1030->SetParError(0,0.1792603);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,-0.08354801);
   ...
   quadLineFit1031->SetChisquare(4.122265e-22);
   ...
   quadLineFit1031->SetParameter(0,2.696358);
   quadLineFit1031->SetParError(0,0.1792603);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,-0.08354801);
   ...
   TH1F *Graph_30dO000000sPppm1031 = new TH1F("Graph_30dO000000sPppm1031","Graph",100,15.77,18.53);
   Graph_30dO000000sPppm1031->SetMinimum(2.469332);
   Graph_30dO000000sPppm1031->SetMaximum(2.919435);
   ...
   quadLineFit1032->SetChisquare(1.643142e-18);
   ...
   quadLineFit1032->SetParameter(0,5.238276);
   quadLineFit1032->SetParError(0,0.1792603);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,-0.1483319);
   ...
   quadLineFit1033->SetChisquare(1.643142e-18);
   ...
   quadLineFit1033->SetParameter(0,5.238276);
   quadLineFit1033->SetParError(0,0.1792603);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,-0.1483319);
