...
//=========  (Fri Oct 16 07:49:34 2020) by ROOT version 6.22/02
   ...
   quadLineFit1146->SetChisquare(3.293831e-20);
   ...
   quadLineFit1146->SetParameter(0,-2.927581);
   quadLineFit1146->SetParError(0,0.05234493);
   quadLineFit1146->SetParLimits(0,0,0);
   quadLineFit1146->SetParameter(1,0.08003535);
   ...
   quadLineFit1147->SetChisquare(3.293831e-20);
   ...
   quadLineFit1147->SetParameter(0,-2.927581);
   quadLineFit1147->SetParError(0,0.05234493);
   quadLineFit1147->SetParLimits(0,0,0);
   quadLineFit1147->SetParameter(1,0.08003535);
   ...
   Graph_mI10dO000000sPppm1147->SetMinimum(-0.1611719);
   Graph_mI10dO000000sPppm1147->SetMaximum(-0.1151937);
   ...
   quadLineFit1148->SetChisquare(1.363984e-21);
   ...
   quadLineFit1148->SetParameter(0,-0.2370269);
   quadLineFit1148->SetParError(0,0.05234493);
   quadLineFit1148->SetParLimits(0,0,0);
   quadLineFit1148->SetParameter(1,0.005491339);
   ...
   quadLineFit1149->SetChisquare(1.363984e-21);
   ...
   quadLineFit1149->SetParameter(0,-0.2370269);
   quadLineFit1149->SetParError(0,0.05234493);
   quadLineFit1149->SetParLimits(0,0,0);
   quadLineFit1149->SetParameter(1,0.005491339);
   ...
   Graph_10dO000000sPppm1149->SetMinimum(1.064911);
   Graph_10dO000000sPppm1149->SetMaximum(1.398036);
   ...
   quadLineFit1150->SetChisquare(5.213577e-19);
   ...
   quadLineFit1150->SetParameter(0,2.40712);
   quadLineFit1150->SetParError(0,0.05234493);
   quadLineFit1150->SetParLimits(0,0,0);
   quadLineFit1150->SetParameter(1,-0.06531368);
   ...
   quadLineFit1151->SetChisquare(5.213577e-19);
   ...
   quadLineFit1151->SetParameter(0,2.40712);
   quadLineFit1151->SetParError(0,0.05234493);
   quadLineFit1151->SetParLimits(0,0,0);
   quadLineFit1151->SetParameter(1,-0.06531368);
   ...
   Graph_30dO000000sPppm1151->SetMinimum(2.227583);
   Graph_30dO000000sPppm1151->SetMaximum(2.929916);
   ...
   quadLineFit1152->SetChisquare(7.576338e-20);
   ...
   quadLineFit1152->SetParameter(0,5.138925);
   quadLineFit1152->SetParError(0,0.05234493);
   quadLineFit1152->SetParLimits(0,0,0);
   quadLineFit1152->SetParameter(1,-0.142232);
   ...
   quadLineFit1153->SetChisquare(7.576338e-20);
   ...
   quadLineFit1153->SetParameter(0,5.138925);
   quadLineFit1153->SetParError(0,0.05234493);
   quadLineFit1153->SetParLimits(0,0,0);
   quadLineFit1153->SetParameter(1,-0.142232);
