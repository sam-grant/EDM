...
//=========  (Wed Dec 16 20:33:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.91343,75,82.90531);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01175->SetMinimum(-51.93155);
   Graph_Graph01175->SetMaximum(67.92343);
   ...
   Graph_Graph01175->GetXaxis()->SetTitle("#LTB_{r}^{App}#GT [ppm]");
   ...
   checkFit1176->SetParameter(0,8.081231);
   checkFit1176->SetParError(0,0.1990772);
   checkFit1176->SetParLimits(0,0,0);
   checkFit1176->SetParameter(1,0.9923359);
   checkFit1176->SetParError(1,0.005828384);
   ...
   pt_LaTex = pt->AddText("0.992#pm0.00583");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.143644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.143644,-51.93155,-8.143644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1177->SetParameter(0,8.081231);
   checkFit1177->SetParError(0,0.1990772);
   checkFit1177->SetParLimits(0,0,0);
   checkFit1177->SetParameter(1,0.9923359);
   checkFit1177->SetParError(1,0.005828384);
