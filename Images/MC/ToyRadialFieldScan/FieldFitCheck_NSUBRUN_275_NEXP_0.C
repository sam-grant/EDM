...
//=========  (Wed Jan  5 17:07:02 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-37.16306,45,53.89348);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01087->SetMinimum(-28.05741);
   Graph_Graph01087->SetMaximum(44.78782);
   ...
   checkFit1088->SetChisquare(7.408186e-17);
   ...
   checkFit1088->SetParameter(1,0.9897956);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.451451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.451451,-28.05741,-8.451451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1089->SetChisquare(7.408186e-17);
   ...
   checkFit1089->SetParameter(1,0.9897956);
