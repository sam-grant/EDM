...
//=========  (Tue Dec  8 12:25:43 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-43.92018,45,64.27136);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","150 sub-runs",100,-36,36);
   Graph_Graph01045->SetMinimum(-33.10102);
   Graph_Graph01045->SetMaximum(53.4522);
   ...
   mainFit1046->SetChisquare(1.400217e-12);
   ...
   mainFit1046->SetParameter(0,10.17559);
   mainFit1046->SetParError(0,0.7615297);
   mainFit1046->SetParLimits(0,0,0);
   mainFit1046->SetParameter(1,1.166229);
   mainFit1046->SetParError(1,0.02538432);
   ...
   pt_LaTex = pt->AddText(" 1.17#pm0.0254");
   pt_LaTex = pt->AddText(" 10.2#pm0.762");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.725205,-33.10102,-8.725205,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(1.400217e-12);
   ...
   mainFit1047->SetParameter(0,10.17559);
   mainFit1047->SetParError(0,0.7615297);
   mainFit1047->SetParLimits(0,0,0);
   mainFit1047->SetParameter(1,1.166229);
   mainFit1047->SetParError(1,0.02538432);
