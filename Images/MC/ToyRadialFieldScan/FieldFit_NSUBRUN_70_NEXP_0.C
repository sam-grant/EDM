...
//=========  (Wed Jan  5 17:10:03 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01005->SetMinimum(-35.87302);
   Graph_Graph01005->SetMaximum(55.1335);
   ...
   mainFit1006->SetChisquare(4.5327e-14);
   ...
   mainFit1006->SetParameter(0,9.630238);
   mainFit1006->SetParError(0,1.113451);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,1.211491);
   mainFit1006->SetParError(1,0.03711503);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.94908,-35.87302,-7.94908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1007->SetChisquare(4.5327e-14);
   ...
   mainFit1007->SetParameter(0,9.630238);
   mainFit1007->SetParError(0,1.113451);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,1.211491);
   mainFit1007->SetParError(1,0.03711503);
