void FieldFitCheck_NSUBRUN_726_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:43 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph01087 = new TH1F("Graph_Graph01087","",100,-36,36);
   Graph_Graph01087->SetMinimum(-28);
   Graph_Graph01087->SetMaximum(44);
   ...
   Graph_Graph01087->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01087->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *checkFit1088 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1088->SetChisquare(3.048279e-18);
   ...
   checkFit1088->SetParameter(0,8);
   checkFit1088->SetParError(0,0.7071068);
   checkFit1088->SetParLimits(0,0,0);
   checkFit1088->SetParameter(1,1);
   checkFit1088->SetParError(1,0.02357023);
...
");
   ...
   TF1 *checkFit1089 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1089->SetChisquare(3.048279e-18);
   ...
   checkFit1089->SetParameter(0,8);
   checkFit1089->SetParError(0,0.7071068);
   checkFit1089->SetParLimits(0,0,0);
   checkFit1089->SetParameter(1,1);
   checkFit1089->SetParError(1,0.02357023);
