void FieldFitCheck_NSUBRUN_396_NEXP_0()
{
...
//=========  (Wed Jan  5 17:36:12 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01047->SetMinimum(-28);
   Graph_Graph01047->SetMaximum(44);
   ...
   checkFit1048->SetChisquare(3.048279e-18);
   ...
   checkFit1048->SetParameter(0,8);
   checkFit1048->SetParError(0,0.7071068);
   checkFit1048->SetParLimits(0,0,0);
   checkFit1048->SetParameter(1,1);
   checkFit1048->SetParError(1,0.02357023);
...
");
   ...
   checkFit1049->SetChisquare(3.048279e-18);
   ...
   checkFit1049->SetParameter(0,8);
   checkFit1049->SetParError(0,0.7071068);
   checkFit1049->SetParLimits(0,0,0);
   checkFit1049->SetParameter(1,1);
   checkFit1049->SetParError(1,0.02357023);
