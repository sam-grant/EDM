void QuadScans_NSUBRUN_275_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.221765,0.0663141,7.523129);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_mI50dO000000sPppm1161 = new TH1F("Graph_mI50dO000000sPppm1161","",100,0.05016026,0.06362179);
   Graph_mI50dO000000sPppm1161->SetMinimum(-3.947276);
   Graph_mI50dO000000sPppm1161->SetMaximum(6.24864);
   ...
   Graph_mI50dO000000sPppm1161->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   ...
   TF1 *quadLineFit1162 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1162->SetFillColor(19);
   quadLineFit1162->SetFillStyle(0);
   quadLineFit1162->SetLineWidth(2);
   quadLineFit1162->SetChisquare(0.216352);
   ...
   quadLineFit1162->SetParameter(0,-0.05029907);
   quadLineFit1162->SetParError(0,0.06298496);
   quadLineFit1162->SetParLimits(0,0,0);
   quadLineFit1162->SetParameter(1,-49.69992);
   quadLineFit1162->SetParError(1,1.112124);
   quadLineFit1162->SetParLimits(1,0,0);
   quadLineFit1162->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1162);
   gre->Draw("ap");
   
   TF1 *quadLineFit1163 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1163->SetFillColor(19);
   quadLineFit1163->SetFillStyle(0);
   quadLineFit1163->SetLineWidth(2);
   quadLineFit1163->SetChisquare(0.216352);
   ...
   quadLineFit1163->SetParameter(0,-0.05029907);
   quadLineFit1163->SetParError(0,0.06298496);
   quadLineFit1163->SetParLimits(0,0,0);
   quadLineFit1163->SetParameter(1,-49.69992);
   quadLineFit1163->SetParError(1,1.112124);
   ...
   TH1F *Graph_mI30dO000000sPppm1163 = new TH1F("Graph_mI30dO000000sPppm1163","",100,0.0492674,0.07344322);
   Graph_mI30dO000000sPppm1163->SetMinimum(-1.969125);
   Graph_mI30dO000000sPppm1163->SetMaximum(-1.287274);
   ...
   TF1 *quadLineFit1164 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1164->SetChisquare(2.979115);
   ...
   quadLineFit1164->SetParameter(0,0.07205569);
   quadLineFit1164->SetParError(0,0.03543285);
   quadLineFit1164->SetParLimits(0,0,0);
   quadLineFit1164->SetParameter(1,-27.69184);
   quadLineFit1164->SetParError(1,0.5840028);
   quadLineFit1164->SetParLimits(1,0,0);
   quadLineFit1164->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1164);
   gre->Draw("p ");
   
   TF1 *quadLineFit1165 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1165->SetChisquare(2.979115);
   ...
   quadLineFit1165->SetParameter(0,0.07205569);
   quadLineFit1165->SetParError(0,0.03543285);
   quadLineFit1165->SetParLimits(0,0,0);
   quadLineFit1165->SetParameter(1,-27.69184);
   quadLineFit1165->SetParError(1,0.5840028);
   ...
   TH1F *Graph_mI10dO000000sPppm1165 = new TH1F("Graph_mI10dO000000sPppm1165","",100,0.0492674,0.07344322);
   Graph_mI10dO000000sPppm1165->SetMinimum(-0.1999837);
   Graph_mI10dO000000sPppm1165->SetMaximum(-0.1224394);
   ...
   TF1 *quadLineFit1166 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1166->SetChisquare(5.940758);
   ...
   quadLineFit1166->SetParameter(0,-0.02763234);
   quadLineFit1166->SetParError(0,0.03543247);
   quadLineFit1166->SetParLimits(0,0,0);
   quadLineFit1166->SetParameter(1,-2.069127);
   quadLineFit1166->SetParError(1,0.5839965);
   quadLineFit1166->SetParLimits(1,0,0);
   quadLineFit1166->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1166);
   gre->Draw("p ");
   
   TF1 *quadLineFit1167 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1167->SetChisquare(5.940758);
   ...
   quadLineFit1167->SetParameter(0,-0.02763234);
   quadLineFit1167->SetParError(0,0.03543247);
   quadLineFit1167->SetParLimits(0,0,0);
   quadLineFit1167->SetParameter(1,-2.069127);
   quadLineFit1167->SetParError(1,0.5839965);
   ...
   TH1F *Graph_10dO000000sPppm1167 = new TH1F("Graph_10dO000000sPppm1167","",100,0.0492674,0.07344322);
   Graph_10dO000000sPppm1167->SetMinimum(1.065587);
   Graph_10dO000000sPppm1167->SetMaximum(1.604693);
   ...
   TF1 *quadLineFit1168 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1168->SetChisquare(1.880794);
   ...
   quadLineFit1168->SetParameter(0,0.01965708);
   quadLineFit1168->SetParError(0,0.03884128);
   quadLineFit1168->SetParLimits(0,0,0);
   quadLineFit1168->SetParameter(1,21.35932);
   quadLineFit1168->SetParError(1,0.6236093);
   quadLineFit1168->SetParLimits(1,0,0);
   quadLineFit1168->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1168);
   gre->Draw("p ");
   
   TF1 *quadLineFit1169 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1169->SetChisquare(1.880794);
   ...
   quadLineFit1169->SetParameter(0,0.01965708);
   quadLineFit1169->SetParError(0,0.03884128);
   quadLineFit1169->SetParLimits(0,0,0);
   quadLineFit1169->SetParameter(1,21.35932);
   quadLineFit1169->SetParError(1,0.6236093);
   ...
   TH1F *Graph_30dO000000sPppm1169 = new TH1F("Graph_30dO000000sPppm1169","",100,0.0492674,0.07344322);
   Graph_30dO000000sPppm1169->SetMinimum(2.233109);
   Graph_30dO000000sPppm1169->SetMaximum(3.376289);
   ...
   TF1 *quadLineFit1170 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   quadLineFit1170->SetFillColor(19);
   quadLineFit1170->SetFillStyle(0);

   ci = TColor::GetColor("#ff9900");
   quadLineFit1170->SetLineColor(ci);
   quadLineFit1170->SetLineWidth(2);
   quadLineFit1170->SetChisquare(1.958777);
   ...
   quadLineFit1170->SetParameter(0,-0.02000486);
   quadLineFit1170->SetParError(0,0.03543232);
   quadLineFit1170->SetParLimits(0,0,0);
   quadLineFit1170->SetParameter(1,46.09678);
   quadLineFit1170->SetParError(1,0.5839941);
   quadLineFit1170->SetParLimits(1,0,0);
   quadLineFit1170->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1170);
   gre->Draw("p ");
   
   TF1 *quadLineFit1171 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   quadLineFit1171->SetFillColor(19);
   quadLineFit1171->SetFillStyle(0);

   ci = TColor::GetColor("#ff9900");
   quadLineFit1171->SetLineColor(ci);
   quadLineFit1171->SetLineWidth(2);
   quadLineFit1171->SetChisquare(1.958777);
   ...
   quadLineFit1171->SetParameter(0,-0.02000486);
   quadLineFit1171->SetParError(0,0.03543232);
   quadLineFit1171->SetParLimits(0,0,0);
   quadLineFit1171->SetParameter(1,46.09678);
   quadLineFit1171->SetParError(1,0.5839941);
   ...
   TH1F *Graph_50dO000000sPppm1171 = new TH1F("Graph_50dO000000sPppm1171","",100,0.0492674,0.07344322);
   Graph_50dO000000sPppm1171->SetMinimum(3.436206);
   Graph_50dO000000sPppm1171->SetMaximum(5.15069);
   ...
   TF1 *quadLineFit1172 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1172->SetChisquare(1.197855);
   ...
   quadLineFit1172->SetParameter(0,-0.02054451);
   quadLineFit1172->SetParError(0,0.0354361);
   quadLineFit1172->SetParLimits(0,0,0);
   quadLineFit1172->SetParameter(1,70.25086);
   quadLineFit1172->SetParError(1,0.5840565);
   quadLineFit1172->SetParLimits(1,0,0);
   quadLineFit1172->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1172);
   gre->Draw("p ");
   
   TF1 *quadLineFit1173 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1173->SetChisquare(1.197855);
   ...
   quadLineFit1173->SetParameter(0,-0.02054451);
   quadLineFit1173->SetParError(0,0.0354361);
   quadLineFit1173->SetParLimits(0,0,0);
   quadLineFit1173->SetParameter(1,70.25086);
   quadLineFit1173->SetParError(1,0.5840565);
