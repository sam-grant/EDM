...
//=========  (Thu Oct  1 15:56:18 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(15,-2.530868,21,-1.744132);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","Scan 1",100,15.6,20.4);
   Graph_Graph01001->SetMinimum(-2.452194);
   Graph_Graph01001->SetMaximum(-1.822805);
   ...
   Graph_Graph01001->GetXaxis()->SetTitle("QHV [kV]");
   ...
   TPaveText *pt = new TPaveText(0.4340955,0.94,0.5659045,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Scan 1");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
