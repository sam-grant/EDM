void QuadScans_NSUBRUN_858_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:45 2022) by ROOT version 6.24/06
   ...
   Graph_30dO000000sPppm1097->SetMinimum(-2.367139);
   Graph_30dO000000sPppm1097->SetMaximum(3.180096);
   ...
   quadLineFit1098->SetChisquare(4.927576e-25);
   ...
   quadLineFit1098->SetParameter(0,-3.530509e-13);
   quadLineFit1098->SetParError(0,5.700877);
   quadLineFit1098->SetParLimits(0,0,0);
   quadLineFit1098->SetParameter(1,45.79338);
   quadLineFit1098->SetParError(1,89.09545);
   ...
   quadLineFit1099->SetChisquare(4.927576e-25);
   ...
   quadLineFit1099->SetParameter(0,-3.530509e-13);
   quadLineFit1099->SetParError(0,5.700877);
   quadLineFit1099->SetParLimits(0,0,0);
   quadLineFit1099->SetParameter(1,45.79338);
   quadLineFit1099->SetParError(1,89.09545);
   ...
   Graph_mI30dO000000sPppm1099->SetMinimum(-1.935794);
   Graph_mI30dO000000sPppm1099->SetMaximum(-1.430804);
   ...
   quadLineFit1100->SetChisquare(1.296134e-25);
   ...
   quadLineFit1100->SetParameter(0,1.341149e-13);
   quadLineFit1100->SetParError(0,5.700877);
   quadLineFit1100->SetParLimits(0,0,0);
   quadLineFit1100->SetParameter(1,-26.51196);
   quadLineFit1100->SetParError(1,89.09545);
   ...
   quadLineFit1101->SetChisquare(1.296134e-25);
   ...
   quadLineFit1101->SetParameter(0,1.341149e-13);
   quadLineFit1101->SetParError(0,5.700877);
   quadLineFit1101->SetParLimits(0,0,0);
   quadLineFit1101->SetParameter(1,-26.51196);
   quadLineFit1101->SetParError(1,89.09545);
