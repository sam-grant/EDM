void QuadScans_NSUBRUN_225_NEXP_10()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May  5 13:00:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04836538,-5.243286,0.0663141,7.50236);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_mI50dO000000sPppm1129->SetMinimum(-3.968721);
   Graph_mI50dO000000sPppm1129->SetMaximum(6.227795);
   ...
   TF1 *quadLineFit1130 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1130->SetFillColor(19);
   quadLineFit1130->SetFillStyle(0);
   quadLineFit1130->SetLineWidth(2);
   quadLineFit1130->SetChisquare(0.5159275);
   ...
   quadLineFit1130->SetParameter(0,-0.01968625);
   quadLineFit1130->SetParError(0,0.06967808);
   quadLineFit1130->SetParLimits(0,0,0);
   quadLineFit1130->SetParameter(1,-50.44976);
   quadLineFit1130->SetParError(1,1.230304);
   quadLineFit1130->SetParLimits(1,0,0);
   quadLineFit1130->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1130);
   gre->Draw("ap");
   
   TF1 *quadLineFit1131 = new TF1("quadLineFit","[0]+[1]*x",0.05016026,0.06362179, TF1::EAddToList::kNo);
   quadLineFit1131->SetFillColor(19);
   quadLineFit1131->SetFillStyle(0);
   quadLineFit1131->SetLineWidth(2);
   quadLineFit1131->SetChisquare(0.5159275);
   ...
   quadLineFit1131->SetParameter(0,-0.01968625);
   quadLineFit1131->SetParError(0,0.06967808);
   quadLineFit1131->SetParLimits(0,0,0);
   quadLineFit1131->SetParameter(1,-50.44976);
   quadLineFit1131->SetParError(1,1.230304);
   ...
   Graph_mI30dO000000sPppm1131->SetMinimum(-1.958397);
   Graph_mI30dO000000sPppm1131->SetMaximum(-1.298063);
   ...
   TF1 *quadLineFit1132 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1132->SetChisquare(0.3911404);
   ...
   quadLineFit1132->SetParameter(0,-0.02331588);
   quadLineFit1132->SetParError(0,0.03920441);
   quadLineFit1132->SetParLimits(0,0,0);
   quadLineFit1132->SetParameter(1,-26.19385);
   quadLineFit1132->SetParError(1,0.6461655);
   quadLineFit1132->SetParLimits(1,0,0);
   quadLineFit1132->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1132);
   gre->Draw("p ");
   
   TF1 *quadLineFit1133 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1133->SetChisquare(0.3911404);
   ...
   quadLineFit1133->SetParameter(0,-0.02331588);
   quadLineFit1133->SetParError(0,0.03920441);
   quadLineFit1133->SetParLimits(0,0,0);
   quadLineFit1133->SetParameter(1,-26.19385);
   quadLineFit1133->SetParError(1,0.6461655);
   ...
   Graph_mI10dO000000sPppm1133->SetMinimum(-0.1706007);
   Graph_mI10dO000000sPppm1133->SetMaximum(-0.0951444);
   ...
   TF1 *quadLineFit1134 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1134->SetChisquare(2.181881);
   ...
   quadLineFit1134->SetParameter(0,9.839929e-07);
   quadLineFit1134->SetParError(0,0.03919889);
   quadLineFit1134->SetParLimits(0,0,0);
   quadLineFit1134->SetParameter(1,-2.253403);
   quadLineFit1134->SetParError(1,0.6460746);
   quadLineFit1134->SetParLimits(1,0,0);
   quadLineFit1134->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1134);
   gre->Draw("p ");
   
   TF1 *quadLineFit1135 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1135->SetChisquare(2.181881);
   ...
   quadLineFit1135->SetParameter(0,9.839929e-07);
   quadLineFit1135->SetParError(0,0.03919889);
   quadLineFit1135->SetParLimits(0,0,0);
   quadLineFit1135->SetParameter(1,-2.253403);
   quadLineFit1135->SetParError(1,0.6460746);
   ...
   Graph_10dO000000sPppm1135->SetMinimum(1.053968);
   Graph_10dO000000sPppm1135->SetMaximum(1.600884);
   ...
   TF1 *quadLineFit1136 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1136->SetChisquare(0.6321897);
   ...
   quadLineFit1136->SetParameter(0,0.0004017782);
   quadLineFit1136->SetParError(0,0.04297845);
   quadLineFit1136->SetParLimits(0,0,0);
   quadLineFit1136->SetParameter(1,21.68052);
   quadLineFit1136->SetParError(1,0.6900321);
   quadLineFit1136->SetParLimits(1,0,0);
   quadLineFit1136->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1136);
   gre->Draw("p ");
   
   TF1 *quadLineFit1137 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1137->SetChisquare(0.6321897);
   ...
   quadLineFit1137->SetParameter(0,0.0004017782);
   quadLineFit1137->SetParError(0,0.04297845);
   quadLineFit1137->SetParLimits(0,0,0);
   quadLineFit1137->SetParameter(1,21.68052);
   quadLineFit1137->SetParError(1,0.6900321);
   ...
   Graph_30dO000000sPppm1137->SetMinimum(2.243721);
   Graph_30dO000000sPppm1137->SetMaximum(3.378596);
   ...
   TF1 *quadLineFit1138 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1138->SetChisquare(0.4477925);
   ...
   quadLineFit1138->SetParameter(0,0.002802606);
   quadLineFit1138->SetParError(0,0.03920255);
   quadLineFit1138->SetParLimits(0,0,0);
   quadLineFit1138->SetParameter(1,45.80517);
   quadLineFit1138->SetParError(1,0.6461356);
   quadLineFit1138->SetParLimits(1,0,0);
   quadLineFit1138->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1138);
   gre->Draw("p ");
   
   TF1 *quadLineFit1139 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1139->SetChisquare(0.4477925);
   ...
   quadLineFit1139->SetParameter(0,0.002802606);
   quadLineFit1139->SetParError(0,0.03920255);
   quadLineFit1139->SetParLimits(0,0,0);
   quadLineFit1139->SetParameter(1,45.80517);
   quadLineFit1139->SetParError(1,0.6461356);
   ...
   Graph_50dO000000sPppm1139->SetMinimum(3.454779);
   Graph_50dO000000sPppm1139->SetMaximum(5.131842);
   ...
   TF1 *quadLineFit1140 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1140->SetChisquare(6.333851);
   ...
   quadLineFit1140->SetParameter(0,0.08051901);
   quadLineFit1140->SetParError(0,0.03919999);
   quadLineFit1140->SetParLimits(0,0,0);
   quadLineFit1140->SetParameter(1,68.47081);
   quadLineFit1140->SetParError(1,0.6460927);
   quadLineFit1140->SetParLimits(1,0,0);
   quadLineFit1140->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1140);
   gre->Draw("p ");
   
   TF1 *quadLineFit1141 = new TF1("quadLineFit","[0]+[1]*x",0.0492674,0.07344322, TF1::EAddToList::kNo);
   ...
   quadLineFit1141->SetChisquare(6.333851);
   ...
   quadLineFit1141->SetParameter(0,0.08051901);
   quadLineFit1141->SetParError(0,0.03919999);
   quadLineFit1141->SetParLimits(0,0,0);
   quadLineFit1141->SetParameter(1,68.47081);
   quadLineFit1141->SetParError(1,0.6460927);
