...
//=========  (Fri Oct 16 07:50:08 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.94013,75,85.2935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.71677);
   Graph_Graph01031->SetMaximum(70.07013);
   ...
   checkFit1032->SetChisquare(4.266375e-18);
   ...
   checkFit1032->SetParameter(1,0.987151);
   ...
   pt_LaTex = pt->AddText("0.987#pm0.0196");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.296128,-51.71677,-9.296128,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1033->SetChisquare(4.266375e-18);
   ...
   checkFit1033->SetParameter(1,0.987151);
