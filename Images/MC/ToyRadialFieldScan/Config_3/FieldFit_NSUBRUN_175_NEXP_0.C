...
//=========  (Fri Oct 16 07:50:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3296348,75,0.2636249);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01053->SetMinimum(-0.2703088);
   Graph_Graph01053->SetMaximum(0.2042989);
   ...
   mainFit1054->SetChisquare(1.518593e-13);
   ...
   mainFit1054->SetParameter(1,-0.003876209);
   mainFit1054->SetParError(1,5.575894e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00388#pm5.58e-05");
   pt_LaTex = pt->AddText("#minus0.033#pm0.00279");
   pt_LaTex = pt->AddText("#minus8.51#pm 0.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.514753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.514753,-0.2703088,-8.514753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1055->SetChisquare(1.518593e-13);
   ...
   mainFit1055->SetParameter(1,-0.003876209);
   mainFit1055->SetParError(1,5.575894e-05);
