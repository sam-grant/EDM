...
//=========  (Thu Oct 15 00:49:29 2020) by ROOT version 6.22/02
   ...
   quadLineFit1002->SetChisquare(1.405864);
   ...
   quadLineFit1002->SetParameter(0,-2.717372);
   quadLineFit1002->SetParError(0,0.1866592);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,0.06845279);
   quadLineFit1002->SetParError(1,0.0103275);
   ...
   quadLineFit1003->SetChisquare(1.405864);
   ...
   quadLineFit1003->SetParameter(0,-2.717372);
   quadLineFit1003->SetParError(0,0.1866592);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,0.06845279);
   quadLineFit1003->SetParError(1,0.0103275);
   ...
   Graph_mI10dO000000sPppm1003->SetMinimum(-0.2239909);
   Graph_mI10dO000000sPppm1003->SetMaximum(-0.07301261);
   ...
   quadLineFit1004->SetChisquare(1.799942);
   ...
   quadLineFit1004->SetParameter(0,-0.3209431);
   quadLineFit1004->SetParError(0,0.1867484);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,0.009672824);
   ...
   quadLineFit1005->SetChisquare(1.799942);
   ...
   quadLineFit1005->SetParameter(0,-0.3209431);
   quadLineFit1005->SetParError(0,0.1867484);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,0.009672824);
   ...
   Graph_10dO000000sPppm1005->SetMinimum(1.051468);
   Graph_10dO000000sPppm1005->SetMaximum(1.385495);
   ...
   quadLineFit1006->SetChisquare(0.8509189);
   ...
   quadLineFit1006->SetParameter(0,2.197058);
   quadLineFit1006->SetParError(0,0.1867502);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-0.05497681);
   quadLineFit1006->SetParError(1,0.01033258);
   ...
   quadLineFit1007->SetChisquare(0.8509189);
   ...
   quadLineFit1007->SetParameter(0,2.197058);
   quadLineFit1007->SetParError(0,0.1867502);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-0.05497681);
   quadLineFit1007->SetParError(1,0.01033258);
   ...
   Graph_30dO000000sPppm1007->SetMinimum(2.216879);
   Graph_30dO000000sPppm1007->SetMaximum(2.979829);
   ...
   quadLineFit1008->SetChisquare(0.01784292);
   ...
   quadLineFit1008->SetParameter(0,5.1948);
   quadLineFit1008->SetParError(0,0.1867465);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.1443355);
   quadLineFit1008->SetParError(1,0.01033237);
   ...
   quadLineFit1009->SetChisquare(0.01784292);
   ...
   quadLineFit1009->SetParameter(0,5.1948);
   quadLineFit1009->SetParError(0,0.1867465);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.1443355);
   quadLineFit1009->SetParError(1,0.01033237);
