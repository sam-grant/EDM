...
//=========  (Thu Oct 15 00:49:30 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-0.2080849,45,0.140898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.1731866);
   Graph_Graph01021->SetMaximum(0.1059997);
   ...
   mainFit1022->SetChisquare(1.506635);
   ...
   mainFit1022->SetParameter(0,-0.03301585);
   mainFit1022->SetParError(0,0.003666447);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.00369969);
   mainFit1022->SetParError(1,0.0001639697);
   ...
   pt_LaTex = pt->AddText("#minus0.0037#pm0.000164");
   pt_LaTex = pt->AddText("#minus0.033#pm0.00367");
   pt_LaTex = pt->AddText("#minus8.92#pm 1.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.92395,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.92395,-0.1731866,-8.92395,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(1.506635);
   ...
   mainFit1023->SetParameter(0,-0.03301585);
   mainFit1023->SetParError(0,0.003666447);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.00369969);
   mainFit1023->SetParError(1,0.0001639697);
