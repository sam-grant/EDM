...
//=========  (Fri Oct 16 07:50:06 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.63182,75,86.59532);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01007 = new TH1F("Graph_Graph01007","Sub-runs 25",100,-60,60);
   Graph_Graph01007->SetMinimum(-54.90911);
   Graph_Graph01007->SetMaximum(70.87261);
   ...
   TF1 *checkFit1008 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1008->SetChisquare(5.119532e-17);
   ...
   checkFit1008->SetParameter(0,7.981751);
   checkFit1008->SetParError(0,1.940083);
   checkFit1008->SetParLimits(0,0,0);
   checkFit1008->SetParameter(1,0.9933071);
   checkFit1008->SetParError(1,0.03880167);
   ...
   pt_LaTex = pt->AddText("0.993#pm0.0388");
   pt_LaTex = pt->AddText(" 7.98#pm 1.94");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.035532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.035532,-54.90911,-8.035532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1009 = new TF1("checkFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   checkFit1009->SetChisquare(5.119532e-17);
   ...
   checkFit1009->SetParameter(0,7.981751);
   checkFit1009->SetParError(0,1.940083);
   checkFit1009->SetParLimits(0,0,0);
   checkFit1009->SetParameter(1,0.9933071);
   checkFit1009->SetParError(1,0.03880167);
