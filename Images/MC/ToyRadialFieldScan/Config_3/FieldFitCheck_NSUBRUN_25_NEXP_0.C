...
//=========  (Thu Oct 15 00:49:29 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-36.41852,45,56.56846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01011->SetMinimum(-27.11982);
   Graph_Graph01011->SetMaximum(47.26976);
   ...
   checkFit1012->SetParameter(0,8.044998);
   checkFit1012->SetParError(0,1.371846);
   checkFit1012->SetParLimits(0,0,0);
   checkFit1012->SetParameter(1,0.9333945);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0614");
   pt_LaTex = pt->AddText(" 8.04#pm 1.37");
   pt_LaTex = pt->AddText("#minus8.62#pm 1.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.619076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.619076,-27.11982,-8.619076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1013->SetParameter(0,8.044998);
   checkFit1013->SetParError(0,1.371846);
   checkFit1013->SetParLimits(0,0,0);
   checkFit1013->SetParameter(1,0.9333945);
