...
//=========  (Thu Oct 15 00:49:43 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-1657106,0.143292,1.491396e+07,1.727077);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Fits1161->SetMinimum(0.3016705);
   Graph_Fits1161->SetMaximum(1.568698);
   ...
   Graph_Truth1162->SetMinimum(0.2818195);
   Graph_Truth1162->SetMaximum(1.622395);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   TGaxis *gaxis = new TGaxis(0,1.568698,1.325685e+07,1.568698,0,344.5,510,"-");
