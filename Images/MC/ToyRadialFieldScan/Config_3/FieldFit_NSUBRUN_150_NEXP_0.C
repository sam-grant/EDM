...
//=========  (Fri Oct 16 07:50:10 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3141585,75,0.249673);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","Sub-runs 150",100,-60,60);
   Graph_Graph01045->SetMinimum(-0.2577753);
   Graph_Graph01045->SetMaximum(0.1932899);
   ...
   mainFit1046->SetChisquare(2.588092e-14);
   ...
   mainFit1046->SetParameter(1,-0.003673686);
   mainFit1046->SetParError(1,6.023898e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00367#pm6.02e-05");
   pt_LaTex = pt->AddText("#minus0.0322#pm0.00301");
   pt_LaTex = pt->AddText("#minus8.78#pm0.832");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.776672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.776672,-0.2577753,-8.776672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1047->SetChisquare(2.588092e-14);
   ...
   mainFit1047->SetParameter(1,-0.003673686);
   mainFit1047->SetParError(1,6.023898e-05);
