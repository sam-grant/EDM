...
//=========  (Fri Oct 16 07:50:14 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.37081,75,85.29665);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01087->SetMinimum(-53.00406);
   Graph_Graph01087->SetMaximum(69.9299);
   ...
   checkFit1088->SetChisquare(4.297495e-17);
   ...
   checkFit1088->SetParameter(1,1.007761);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0118");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.397749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.397749,-53.00406,-8.397749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1089->SetChisquare(4.297495e-17);
   ...
   checkFit1089->SetParameter(1,1.007761);
