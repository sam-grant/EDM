...
//=========  (Fri Oct 16 07:50:06 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-0.3261096,75,0.2659926);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01005 = new TH1F("Graph_Graph01005","Sub-runs 25",100,-60,60);
   Graph_Graph01005->SetMinimum(-0.2668994);
   Graph_Graph01005->SetMaximum(0.2067824);
   ...
   TF1 *mainFit1006 = new TF1("mainFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   mainFit1006->SetChisquare(7.218334e-13);
   ...
   mainFit1006->SetParameter(0,-0.03005849);
   mainFit1006->SetParError(0,0.007306165);
   mainFit1006->SetParLimits(0,0,0);
   mainFit1006->SetParameter(1,-0.003740698);
   mainFit1006->SetParError(1,0.0001461233);
   ...
   pt_LaTex = pt->AddText("#minus0.00374#pm0.000146");
   pt_LaTex = pt->AddText("#minus0.0301#pm0.00731");
   pt_LaTex = pt->AddText("#minus8.04#pm 1.98");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.03553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.03553,-0.2668994,-8.03553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *mainFit1007 = new TF1("mainFit","[0]+[1]*x",-60,60, TF1::EAddToList::kNo);
   ...
   mainFit1007->SetChisquare(7.218334e-13);
   ...
   mainFit1007->SetParameter(0,-0.03005849);
   mainFit1007->SetParError(0,0.007306165);
   mainFit1007->SetParLimits(0,0,0);
   mainFit1007->SetParameter(1,-0.003740698);
   mainFit1007->SetParError(1,0.0001461233);
