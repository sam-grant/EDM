...
//=========  (Fri Oct 16 07:50:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-68.52942,75,84.13415);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01063->SetMinimum(-53.26306);
   Graph_Graph01063->SetMaximum(68.86779);
   ...
   checkFit1064->SetChisquare(7.573562e-17);
   ...
   checkFit1064->SetParameter(1,0.9981779);
   ...
   pt_LaTex = pt->AddText("0.998#pm0.0138");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.816606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.816606,-53.26306,-7.816606,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1065->SetChisquare(7.573562e-17);
   ...
   checkFit1065->SetParameter(1,0.9981779);
