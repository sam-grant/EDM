...
//=========  (Fri Oct 16 07:50:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3142811,75,0.250166);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01101->SetMinimum(-0.2578364);
   Graph_Graph01101->SetMaximum(0.1937213);
   ...
   mainFit1102->SetChisquare(5.804067e-12);
   ...
   mainFit1102->SetParameter(0,-0.03205753);
   mainFit1102->SetParError(0,0.002043726);
   mainFit1102->SetParLimits(0,0,0);
   mainFit1102->SetParameter(1,-0.003705175);
   mainFit1102->SetParError(1,4.087452e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00371#pm4.09e-05");
   pt_LaTex = pt->AddText("#minus0.0321#pm0.00204");
   pt_LaTex = pt->AddText("#minus8.65#pm 0.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.652095,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.652095,-0.2578364,-8.652095,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1103->SetChisquare(5.804067e-12);
   ...
   mainFit1103->SetParameter(0,-0.03205753);
   mainFit1103->SetParError(0,0.002043726);
   mainFit1103->SetParLimits(0,0,0);
   mainFit1103->SetParameter(1,-0.003705175);
   mainFit1103->SetParError(1,4.087452e-05);
