...
//=========  (Fri Oct 16 07:50:15 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.42923,75,83.45438);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01103->SetMinimum(-51.44087);
   Graph_Graph01103->SetMaximum(68.46602);
   ...
   checkFit1104->SetChisquare(7.831432e-17);
   ...
   checkFit1104->SetParameter(1,0.9838744);
   checkFit1104->SetParError(1,0.01085384);
   ...
   pt_LaTex = pt->AddText("0.984#pm0.0109");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.652096,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.652096,-51.44087,-8.652096,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1105->SetChisquare(7.831432e-17);
   ...
   checkFit1105->SetParameter(1,0.9838744);
   checkFit1105->SetParError(1,0.01085384);
