...
//=========  (Fri Oct 16 07:50:13 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.72584,75,84.46483);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01079->SetMinimum(-52.50678);
   Graph_Graph01079->SetMaximum(69.24576);
   ...
   checkFit1080->SetChisquare(1.404228e-16);
   ...
   checkFit1080->SetParameter(0,8.369491);
   checkFit1080->SetParError(0,0.6188939);
   checkFit1080->SetParLimits(0,0,0);
   checkFit1080->SetParameter(1,0.9970995);
   ...
   pt_LaTex = pt->AddText("0.997#pm0.0124");
   pt_LaTex = pt->AddText(" 8.37#pm0.619");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.393837,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.393837,-52.50678,-8.393837,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1081->SetChisquare(1.404228e-16);
   ...
   checkFit1081->SetParameter(0,8.369491);
   checkFit1081->SetParError(0,0.6188939);
   checkFit1081->SetParLimits(0,0,0);
   checkFit1081->SetParameter(1,0.9970995);
