...
//=========  (Thu Oct 15 00:49:33 2020) by ROOT version 6.22/02
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-45,-35.87211,45,52.17429);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01059->SetMinimum(-27.06747);
   Graph_Graph01059->SetMaximum(43.36965);
   ...
   checkFit1060->SetParameter(0,7.299679);
   checkFit1060->SetParError(0,0.6197899);
   checkFit1060->SetParLimits(0,0,0);
   checkFit1060->SetParameter(1,0.9357103);
   checkFit1060->SetParError(1,0.02771785);
   ...
   pt_LaTex = pt->AddText("0.936#pm0.0277");
   pt_LaTex = pt->AddText("  7.3#pm 0.62");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.801217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.801217,-27.06747,-7.801217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1061->SetParameter(0,7.299679);
   checkFit1061->SetParError(0,0.6197899);
   checkFit1061->SetParLimits(0,0,0);
   checkFit1061->SetParameter(1,0.9357103);
   checkFit1061->SetParError(1,0.02771785);
