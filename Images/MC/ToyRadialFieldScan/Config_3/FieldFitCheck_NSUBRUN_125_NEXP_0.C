...
//=========  (Fri Oct 16 07:50:09 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.19729,75,83.19187);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-52.15838);
   Graph_Graph01039->SetMaximum(68.15295);
   ...
   checkFit1040->SetChisquare(1.474343e-16);
   ...
   checkFit1040->SetParameter(0,7.997289);
   checkFit1040->SetParError(0,0.8765154);
   checkFit1040->SetParLimits(0,0,0);
   checkFit1040->SetParameter(1,0.9778028);
   ...
   pt_LaTex = pt->AddText("0.978#pm0.0175");
   pt_LaTex = pt->AddText("    8#pm0.877");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.178836,-52.15838,-8.178836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1041->SetChisquare(1.474343e-16);
   ...
   checkFit1041->SetParameter(0,7.997289);
   checkFit1041->SetParError(0,0.8765154);
   checkFit1041->SetParLimits(0,0,0);
   checkFit1041->SetParameter(1,0.9778028);
