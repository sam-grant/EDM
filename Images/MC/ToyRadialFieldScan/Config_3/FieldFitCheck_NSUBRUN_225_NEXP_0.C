...
//=========  (Fri Oct 16 07:50:12 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-69.40627,75,83.59155);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01071->SetMinimum(-54.10649);
   Graph_Graph01071->SetMaximum(68.29177);
   ...
   checkFit1072->SetChisquare(2.136396e-17);
   ...
   checkFit1072->SetParameter(0,7.092639);
   checkFit1072->SetParError(0,0.6524951);
   checkFit1072->SetParLimits(0,0,0);
   checkFit1072->SetParameter(1,1.00153);
   checkFit1072->SetParError(1,0.0130499);
   ...
   pt_LaTex = pt->AddText("    1#pm0.013");
   pt_LaTex = pt->AddText(" 7.09#pm0.652");
   pt_LaTex = pt->AddText("#minus7.08#pm0.658");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.081803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.081803,-54.10649,-7.081803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1073->SetChisquare(2.136396e-17);
   ...
   checkFit1073->SetParameter(0,7.092639);
   checkFit1073->SetParError(0,0.6524951);
   checkFit1073->SetParLimits(0,0,0);
   checkFit1073->SetParameter(1,1.00153);
   checkFit1073->SetParError(1,0.0130499);
