...
//=========  (Fri Oct 16 07:50:10 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-66.29832,75,83.42183);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01047->SetMinimum(-51.3263);
   Graph_Graph01047->SetMaximum(68.44981);
   ...
   checkFit1048->SetChisquare(8.459109e-18);
   ...
   checkFit1048->SetParameter(1,0.9755127);
   checkFit1048->SetParError(1,0.01599589);
   ...
   pt_LaTex = pt->AddText("0.976#pm0.016");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.776671,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.776671,-51.3263,-8.776671,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1049->SetChisquare(8.459109e-18);
   ...
   checkFit1049->SetParameter(1,0.9755127);
   checkFit1049->SetParError(1,0.01599589);
