...
//=========  (Fri Oct 16 07:50:07 2020) by ROOT version 6.22/02
   ...
   quadLineFit1018->SetChisquare(9.402478e-18);
   ...
   quadLineFit1018->SetParameter(0,-5.719687);
   quadLineFit1018->SetParError(0,0.1086052);
   quadLineFit1018->SetParLimits(0,0,0);
   quadLineFit1018->SetParameter(1,0.1596677);
   ...
   quadLineFit1019->SetChisquare(9.402478e-18);
   ...
   quadLineFit1019->SetParameter(0,-5.719687);
   quadLineFit1019->SetParError(0,0.1086052);
   quadLineFit1019->SetParLimits(0,0,0);
   quadLineFit1019->SetParameter(1,0.1596677);
   ...
   Graph_50dO000000sPppm1019->SetMinimum(3.372239);
   Graph_50dO000000sPppm1019->SetMaximum(4.479452);
   ...
   quadLineFit1020->SetChisquare(2.437534e-18);
   ...
   quadLineFit1020->SetParameter(0,7.925245);
   quadLineFit1020->SetParError(0,0.1086052);
   quadLineFit1020->SetParLimits(0,0,0);
   quadLineFit1020->SetParameter(1,-0.2221889);
   ...
   quadLineFit1021->SetChisquare(2.437534e-18);
   ...
   quadLineFit1021->SetParameter(0,7.925245);
   quadLineFit1021->SetParError(0,0.1086052);
   quadLineFit1021->SetParLimits(0,0,0);
   quadLineFit1021->SetParameter(1,-0.2221889);
