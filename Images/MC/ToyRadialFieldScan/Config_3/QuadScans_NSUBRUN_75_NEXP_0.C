...
//=========  (Thu Oct 15 00:49:31 2020) by ROOT version 6.22/02
   ...
   quadLineFit1026->SetChisquare(0.7180547);
   ...
   quadLineFit1026->SetParameter(0,-3.128635);
   quadLineFit1026->SetParError(0,0.1083844);
   quadLineFit1026->SetParLimits(0,0,0);
   quadLineFit1026->SetParameter(1,0.0912772);
   quadLineFit1026->SetParError(1,0.005996728);
   ...
   quadLineFit1027->SetChisquare(0.7180547);
   ...
   quadLineFit1027->SetParameter(0,-3.128635);
   quadLineFit1027->SetParError(0,0.1083844);
   quadLineFit1027->SetParLimits(0,0,0);
   quadLineFit1027->SetParameter(1,0.0912772);
   quadLineFit1027->SetParError(1,0.005996728);
   ...
   Graph_mI10dO000000sPppm1027->SetMinimum(-0.2123264);
   Graph_mI10dO000000sPppm1027->SetMaximum(-0.08864834);
   ...
   quadLineFit1028->SetChisquare(0.2433009);
   ...
   quadLineFit1028->SetParameter(0,-0.4650442);
   quadLineFit1028->SetParError(0,0.1083832);
   quadLineFit1028->SetParLimits(0,0,0);
   quadLineFit1028->SetParameter(1,0.01728563);
   quadLineFit1028->SetParError(1,0.005996662);
   ...
   quadLineFit1029->SetChisquare(0.2433009);
   ...
   quadLineFit1029->SetParameter(0,-0.4650442);
   quadLineFit1029->SetParError(0,0.1083832);
   quadLineFit1029->SetParLimits(0,0,0);
   quadLineFit1029->SetParameter(1,0.01728563);
   quadLineFit1029->SetParError(1,0.005996662);
   ...
   Graph_10dO000000sPppm1029->SetMinimum(1.037571);
   Graph_10dO000000sPppm1029->SetMaximum(1.416206);
   ...
   quadLineFit1030->SetChisquare(0.01909566);
   ...
   quadLineFit1030->SetParameter(0,2.493161);
   quadLineFit1030->SetParError(0,0.1083842);
   quadLineFit1030->SetParLimits(0,0,0);
   quadLineFit1030->SetParameter(1,-0.07040163);
   ...
   quadLineFit1031->SetChisquare(0.01909566);
   ...
   quadLineFit1031->SetParameter(0,2.493161);
   quadLineFit1031->SetParError(0,0.1083842);
   quadLineFit1031->SetParLimits(0,0,0);
   quadLineFit1031->SetParameter(1,-0.07040163);
   ...
   Graph_30dO000000sPppm1031->SetMinimum(2.234223);
   Graph_30dO000000sPppm1031->SetMaximum(2.938947);
   ...
   quadLineFit1032->SetChisquare(0.5036725);
   ...
   quadLineFit1032->SetParameter(0,5.071732);
   quadLineFit1032->SetParError(0,0.1083841);
   quadLineFit1032->SetParLimits(0,0,0);
   quadLineFit1032->SetParameter(1,-0.1383367);
   quadLineFit1032->SetParError(1,0.005996713);
   ...
   quadLineFit1033->SetChisquare(0.5036725);
   ...
   quadLineFit1033->SetParameter(0,5.071732);
   quadLineFit1033->SetParError(0,0.1083841);
   quadLineFit1033->SetParLimits(0,0,0);
   quadLineFit1033->SetParameter(1,-0.1383367);
   quadLineFit1033->SetParError(1,0.005996713);
