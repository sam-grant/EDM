...
//=========  (Fri Oct 16 07:50:14 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-65.93002,75,83.35169);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01095->SetMinimum(-51.00185);
   Graph_Graph01095->SetMaximum(68.42352);
   ...
   checkFit1096->SetChisquare(2.064871e-17);
   ...
   checkFit1096->SetParameter(1,0.9792351);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.0113");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.895554,-51.00185,-8.895554,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1097->SetChisquare(2.064871e-17);
   ...
   checkFit1097->SetParameter(1,0.9792351);
