...
//=========  (Fri Oct 16 07:50:14 2020) by ROOT version 6.22/02
   ...
   Double_t -50.000000 ppm_fx1081[2] = {
   16,
   20};
   Double_t -50.000000 ppm_fy1081[2] = {
   -3.159915,
   -2.528371};
   Double_t -50.000000 ppm_fex1081[2] = {
   0,
   0};
   Double_t -50.000000 ppm_fey1081[2] = {
   0.008888156,
   0.008888156};
   TGraphErrors *gre = new TGraphErrors(2,-50.000000 ppm_fx1081,-50.000000 ppm_fy1081,-50.000000 ppm_fex1081,-50.000000 ppm_fey1081);
   ...
   quadLineFit1082->SetChisquare(3.919654e-19);
   ...
   quadLineFit1082->SetParameter(0,-5.68609);
   quadLineFit1082->SetParError(0,0.05691197);
   quadLineFit1082->SetParLimits(0,0,0);
   quadLineFit1082->SetParameter(1,0.1578859);
   quadLineFit1082->SetParError(1,0.003142438);
   ...
   quadLineFit1083->SetChisquare(3.919654e-19);
   ...
   quadLineFit1083->SetParameter(0,-5.68609);
   quadLineFit1083->SetParError(0,0.05691197);
   quadLineFit1083->SetParLimits(0,0,0);
   quadLineFit1083->SetParameter(1,0.1578859);
   quadLineFit1083->SetParError(1,0.003142438);
   quadLineFit1083->SetParLimits(1,0,0);
   quadLineFit1083->Draw("same");
   
   Double_t 50.000000 ppm_fx1083[2] = {
   16,
   20};
   Double_t 50.000000 ppm_fy1083[2] = {
   4.373276,
   3.486768};
   Double_t 50.000000 ppm_fex1083[2] = {
   0,
   0};
   Double_t 50.000000 ppm_fey1083[2] = {
   0.008888156,
   0.008888156};
   gre = new TGraphErrors(2,50.000000 ppm_fx1083,50.000000 ppm_fy1083,50.000000 ppm_fex1083,50.000000 ppm_fey1083);
   gre->SetName("50.000000 ppm");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   Graph_50dO000000sPppm1083->SetMinimum(3.387452);
   Graph_50dO000000sPppm1083->SetMaximum(4.472593);
   ...
   quadLineFit1084->SetChisquare(5.551351e-17);
   ...
   quadLineFit1084->SetParameter(0,7.919308);
   quadLineFit1084->SetParError(0,0.05691197);
   quadLineFit1084->SetParLimits(0,0,0);
   quadLineFit1084->SetParameter(1,-0.221627);
   quadLineFit1084->SetParError(1,0.003142438);
   ...
   quadLineFit1085->SetChisquare(5.551351e-17);
   ...
   quadLineFit1085->SetParameter(0,7.919308);
   quadLineFit1085->SetParError(0,0.05691197);
   quadLineFit1085->SetParLimits(0,0,0);
   quadLineFit1085->SetParameter(1,-0.221627);
   quadLineFit1085->SetParError(1,0.003142438);
