...
//=========  (Thu Oct 15 00:49:37 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-0.2017978,45,0.1408793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.1675301);
   Graph_Graph01105->SetMaximum(0.1066116);
   ...
   mainFit1106->SetChisquare(4.130854);
   ...
   mainFit1106->SetParameter(0,-0.02879231);
   mainFit1106->SetParError(0,0.001737538);
   mainFit1106->SetParLimits(0,0,0);
   mainFit1106->SetParameter(1,-0.003738097);
   mainFit1106->SetParError(1,7.77056e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.0288#pm0.00174");
   pt_LaTex = pt->AddText(" #minus7.7#pm0.492");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-7.702399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.702399,-0.1675301,-7.702399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1107->SetChisquare(4.130854);
   ...
   mainFit1107->SetParameter(0,-0.02879231);
   mainFit1107->SetParError(0,0.001737538);
   mainFit1107->SetParLimits(0,0,0);
   mainFit1107->SetParameter(1,-0.003738097);
   mainFit1107->SetParError(1,7.77056e-05);
