...
//=========  (Fri Oct 16 07:50:12 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3147977,75,0.2613773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01069->SetMinimum(-0.2571802);
   Graph_Graph01069->SetMaximum(0.2037598);
   ...
   mainFit1070->SetChisquare(1.247175e-13);
   ...
   mainFit1070->SetParameter(1,-0.003771665);
   mainFit1070->SetParError(1,4.914466e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00377#pm4.91e-05");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.081803,-0.2571802,-7.081803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1071->SetChisquare(1.247175e-13);
   ...
   mainFit1071->SetParameter(1,-0.003771665);
   mainFit1071->SetParError(1,4.914466e-05);
