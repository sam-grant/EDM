...
//=========  (Fri Oct 16 07:50:10 2020) by ROOT version 6.22/02
   ...
   quadLineFit1042->SetChisquare(1.421349e-18);
   ...
   quadLineFit1042->SetParameter(0,-5.581938);
   quadLineFit1042->SetParError(0,0.07714353);
   quadLineFit1042->SetParLimits(0,0,0);
   quadLineFit1042->SetParameter(1,0.1514416);
   quadLineFit1042->SetParError(1,0.004259539);
   ...
   quadLineFit1043->SetChisquare(1.421349e-18);
   ...
   quadLineFit1043->SetParameter(0,-5.581938);
   quadLineFit1043->SetParError(0,0.07714353);
   quadLineFit1043->SetParLimits(0,0,0);
   quadLineFit1043->SetParameter(1,0.1514416);
   quadLineFit1043->SetParError(1,0.004259539);
   ...
   Graph_50dO000000sPppm1043->SetMinimum(3.391641);
   Graph_50dO000000sPppm1043->SetMaximum(4.457005);
   ...
   quadLineFit1044->SetChisquare(1.513115e-18);
   ...
   quadLineFit1044->SetParameter(0,7.81101);
   quadLineFit1044->SetParError(0,0.07714353);
   quadLineFit1044->SetParLimits(0,0,0);
   quadLineFit1044->SetParameter(1,-0.215927);
   quadLineFit1044->SetParError(1,0.004259539);
   ...
   quadLineFit1045->SetChisquare(1.513115e-18);
   ...
   quadLineFit1045->SetParameter(0,7.81101);
   quadLineFit1045->SetParError(0,0.07714353);
   quadLineFit1045->SetParLimits(0,0,0);
   quadLineFit1045->SetParameter(1,-0.215927);
   quadLineFit1045->SetParError(1,0.004259539);
