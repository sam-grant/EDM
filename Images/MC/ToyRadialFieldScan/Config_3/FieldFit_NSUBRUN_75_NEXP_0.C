...
//=========  (Fri Oct 16 07:50:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.3266481,75,0.264127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(-0.2675706);
   Graph_Graph01021->SetMaximum(0.2050495);
   ...
   mainFit1022->SetChisquare(2.356204e-13);
   ...
   mainFit1022->SetParameter(0,-0.03126058);
   mainFit1022->SetParError(0,0.004240321);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,-0.003818566);
   mainFit1022->SetParError(1,8.480642e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00382#pm8.48e-05");
   pt_LaTex = pt->AddText("#minus0.0313#pm0.00424");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.18647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.18647,-0.2675706,-8.18647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1023->SetChisquare(2.356204e-13);
   ...
   mainFit1023->SetParameter(0,-0.03126058);
   mainFit1023->SetParError(0,0.004240321);
   mainFit1023->SetParLimits(0,0,0);
   mainFit1023->SetParameter(1,-0.003818566);
   mainFit1023->SetParError(1,8.480642e-05);
