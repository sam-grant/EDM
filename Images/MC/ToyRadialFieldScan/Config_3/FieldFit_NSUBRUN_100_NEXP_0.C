...
//=========  (Fri Oct 16 07:50:08 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-0.321207,75,0.25209);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-0.2638773);
   Graph_Graph01029->SetMaximum(0.1947603);
   ...
   mainFit1030->SetChisquare(1.952795e-13);
   ...
   mainFit1030->SetParameter(1,-0.003717515);
   mainFit1030->SetParError(1,7.386844e-05);
   ...
   pt_LaTex = pt->AddText("#minus0.00372#pm7.39e-05");
   pt_LaTex = pt->AddText("#minus0.0346#pm0.00369");
   pt_LaTex = pt->AddText(" #minus9.3#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.296128,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.296128,-0.2638773,-9.296128,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.952795e-13);
   ...
   mainFit1031->SetParameter(1,-0.003717515);
   mainFit1031->SetParError(1,7.386844e-05);
