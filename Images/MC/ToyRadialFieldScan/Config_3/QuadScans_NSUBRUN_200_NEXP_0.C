...
//=========  (Fri Oct 16 07:50:11 2020) by ROOT version 6.22/02
   ...
   quadLineFit1058->SetChisquare(6.035249e-18);
   ...
   quadLineFit1058->SetParameter(0,-5.693416);
   quadLineFit1058->SetParError(0,0.06676866);
   quadLineFit1058->SetParLimits(0,0,0);
   quadLineFit1058->SetParameter(1,0.1585691);
   ...
   quadLineFit1059->SetChisquare(6.035249e-18);
   ...
   quadLineFit1059->SetParameter(0,-5.693416);
   quadLineFit1059->SetParError(0,0.06676866);
   quadLineFit1059->SetParLimits(0,0,0);
   quadLineFit1059->SetParameter(1,0.1585691);
   ...
   Graph_50dO000000sPppm1059->SetMinimum(3.396534);
   Graph_50dO000000sPppm1059->SetMaximum(4.464768);
   ...
   quadLineFit1060->SetChisquare(3.125713e-20);
   ...
   quadLineFit1060->SetParameter(0,7.84268);
   quadLineFit1060->SetParError(0,0.06676866);
   quadLineFit1060->SetParLimits(0,0,0);
   quadLineFit1060->SetParameter(1,-0.217335);
   quadLineFit1060->SetParError(1,0.003686682);
   ...
   quadLineFit1061->SetChisquare(3.125713e-20);
   ...
   quadLineFit1061->SetParameter(0,7.84268);
   quadLineFit1061->SetParError(0,0.06676866);
   quadLineFit1061->SetParLimits(0,0,0);
   quadLineFit1061->SetParameter(1,-0.217335);
   quadLineFit1061->SetParError(1,0.003686682);
