...
//=========  (Fri Oct 16 07:50:07 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-67.01949,75,84.03634);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(-51.91391);
   Graph_Graph01015->SetMaximum(68.93076);
   ...
   checkFit1016->SetChisquare(2.94593e-16);
   ...
   checkFit1016->SetParameter(0,8.508425);
   checkFit1016->SetParError(0,1.376847);
   checkFit1016->SetParLimits(0,0,0);
   checkFit1016->SetParameter(1,0.9680958);
   ...
   pt_LaTex = pt->AddText("0.968#pm0.0275");
   pt_LaTex = pt->AddText(" 8.51#pm 1.38");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-8.788826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.788826,-51.91391,-8.788826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1017->SetChisquare(2.94593e-16);
   ...
   checkFit1017->SetParameter(0,8.508425);
   checkFit1017->SetParError(0,1.376847);
   checkFit1017->SetParLimits(0,0,0);
   checkFit1017->SetParameter(1,0.9680958);
