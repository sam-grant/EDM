...
//=========  (Thu Oct 15 00:49:30 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-37.41414,45,55.25486);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-28.14723);
   Graph_Graph01023->SetMaximum(45.98796);
   ...
   checkFit1024->SetParameter(0,8.767047);
   checkFit1024->SetParError(0,0.9735781);
   checkFit1024->SetParLimits(0,0,0);
   checkFit1024->SetParameter(1,0.9824174);
   checkFit1024->SetParError(1,0.04353974);
   ...
   pt_LaTex = pt->AddText("0.982#pm0.0435");
   pt_LaTex = pt->AddText(" 8.77#pm0.974");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.923953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.923953,-28.14723,-8.923953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1025->SetParameter(0,8.767047);
   checkFit1025->SetParError(0,0.9735781);
   checkFit1025->SetParLimits(0,0,0);
   checkFit1025->SetParameter(1,0.9824174);
   checkFit1025->SetParError(1,0.04353974);
