...
//=========  (Fri Oct 16 07:50:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-75,-70.0031,75,87.53141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01055->SetMinimum(-54.24964);
   Graph_Graph01055->SetMaximum(71.77796);
   ...
   checkFit1056->SetChisquare(1.180912e-16);
   ...
   checkFit1056->SetParameter(1,1.029291);
   checkFit1056->SetParError(1,0.01480626);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0148");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.514753,-54.24964,-8.514753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1057->SetChisquare(1.180912e-16);
   ...
   checkFit1057->SetParameter(1,1.029291);
   checkFit1057->SetParError(1,0.01480626);
