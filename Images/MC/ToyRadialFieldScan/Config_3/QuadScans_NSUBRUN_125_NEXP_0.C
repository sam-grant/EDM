...
//=========  (Fri Oct 16 07:50:09 2020) by ROOT version 6.22/02
   ...
   quadLineFit1034->SetChisquare(1.03235e-21);
   ...
   quadLineFit1034->SetParameter(0,-5.605913);
   quadLineFit1034->SetParError(0,0.08454357);
   quadLineFit1034->SetParLimits(0,0,0);
   quadLineFit1034->SetParameter(1,0.1539985);
   ...
   quadLineFit1035->SetChisquare(1.03235e-21);
   ...
   quadLineFit1035->SetParameter(0,-5.605913);
   quadLineFit1035->SetParError(0,0.08454357);
   quadLineFit1035->SetParLimits(0,0,0);
   quadLineFit1035->SetParameter(1,0.1539985);
   ...
   Graph_50dO000000sPppm1035->SetMinimum(3.407509);
   Graph_50dO000000sPppm1035->SetMaximum(4.467514);
   ...
   quadLineFit1036->SetChisquare(1.65737e-19);
   ...
   quadLineFit1036->SetParameter(0,7.793697);
   quadLineFit1036->SetParError(0,0.08454357);
   quadLineFit1036->SetParLimits(0,0,0);
   quadLineFit1036->SetParameter(1,-0.2142325);
   ...
   quadLineFit1037->SetChisquare(1.65737e-19);
   ...
   quadLineFit1037->SetParameter(0,7.793697);
   quadLineFit1037->SetParError(0,0.08454357);
   quadLineFit1037->SetParLimits(0,0,0);
   quadLineFit1037->SetParameter(1,-0.2142325);
