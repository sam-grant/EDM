void FieldFit_NSUBRUN_858_NEXP_0()
{
...
//=========  (Wed Jan  5 17:35:45 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01101->SetMinimum(-140.657);
   Graph_Graph01101->SetMaximum(159.9385);
   ...
   mainFit1102->SetChisquare(7.82679e-22);
   ...
   mainFit1102->SetParameter(0,9.640711);
   mainFit1102->SetParError(0,63);
   mainFit1102->SetParLimits(0,0,0);
   mainFit1102->SetParameter(1,1.205089);
   mainFit1102->SetParError(1,2.1);
...
");
   ...
   mainFit1103->SetChisquare(7.82679e-22);
   ...
   mainFit1103->SetParameter(0,9.640711);
   mainFit1103->SetParError(0,63);
   mainFit1103->SetParLimits(0,0,0);
   mainFit1103->SetParameter(1,1.205089);
   mainFit1103->SetParError(1,2.1);
