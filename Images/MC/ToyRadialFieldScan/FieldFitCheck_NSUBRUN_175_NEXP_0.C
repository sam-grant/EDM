...
//=========  (Wed Jan  5 17:06:57 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-35.90183,45,53.10882);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","",100,-36,36);
   Graph_Graph01055->SetMinimum(-27.00076);
   Graph_Graph01055->SetMaximum(44.20775);
   ...
   Graph_Graph01055->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01055->GetYaxis()->SetTitle("#LTy#GT#upointV [mm#upointkV]");
   ...
   TF1 *checkFit1056 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1056->SetChisquare(5.072795e-16);
   ...
   checkFit1056->SetParameter(1,0.9614459);
...
");
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.948496,-27.00076,-8.948496,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   
   TF1 *checkFit1057 = new TF1("checkFit","[0]+[1]*x",-30,30, TF1::EAddToList::kNo);
   ...
   checkFit1057->SetChisquare(5.072795e-16);
   ...
   checkFit1057->SetParameter(1,0.9614459);
