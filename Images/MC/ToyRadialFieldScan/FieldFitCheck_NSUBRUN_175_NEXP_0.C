...
//=========  (Tue Dec  8 12:25:44 2020) by ROOT version 6.22/02
   ...
   c->Range(-45,-39.3717,45,56.57869);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","175 sub-runs",100,-36,36);
   Graph_Graph01055->SetMinimum(-29.77666);
   Graph_Graph01055->SetMaximum(46.98365);
   ...
   Graph_Graph01055->GetXaxis()->SetTitle("#LTB_{r}^{App}#GT [ppm]");
   ...
   checkFit1056->SetChisquare(9.455048e-17);
   ...
   checkFit1056->SetParameter(0,8.603495);
   checkFit1056->SetParError(0,0.5846636);
   checkFit1056->SetParLimits(0,0,0);
   checkFit1056->SetParameter(1,1.038554);
   checkFit1056->SetParError(1,0.01948879);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0195");
   pt_LaTex = pt->AddText("  8.6#pm0.585");
   ...
   pt->Draw();
   TLine *line = new TLine(-36,0,-8.284108,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-8.284108,-29.77666,-8.284108,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   checkFit1057->SetChisquare(9.455048e-17);
   ...
   checkFit1057->SetParameter(0,8.603495);
   checkFit1057->SetParError(0,0.5846636);
   checkFit1057->SetParLimits(0,0,0);
   checkFit1057->SetParameter(1,1.038554);
   checkFit1057->SetParError(1,0.01948879);
