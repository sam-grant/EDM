...
//=========  (Wed Jan  5 17:35:41 2022) by ROOT version 6.24/06
   ...
   TH1D *__23 = new TH1D("__23","Number of sub-runs: 528",2400,0.4,1.6);
   __23->SetBinContent(2401,1000);
   __23->SetEntries(1000);
   __23->SetStats(0);
   __23->GetXaxis()->SetTitle("Fitted #delta#LTB_{r}^{b}#GT [ppm]");
   __23->GetXaxis()->SetRange(1,2400);
   ...
   __23->GetYaxis()->SetTitle("Trials / 0.000500 ppm");
