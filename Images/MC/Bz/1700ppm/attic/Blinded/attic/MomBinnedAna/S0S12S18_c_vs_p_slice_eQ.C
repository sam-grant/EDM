...
//=========  (Thu May  6 16:53:25 2021) by ROOT version 6.22/08
   ...
   c->Range(-375.375,-3.156792,3378.375,0.6299789);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01163->SetMinimum(-2.778115);
   Graph_Graph01163->SetMaximum(0.2513017);
   ...
   Graph_Graph01163->GetXaxis()->SetTitle("p [MeV]: in range p #minus 50 < p < p #plus 50 MeV");
