void S12S18_AEDM_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.3275454,3360.969,0.3569028);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S12S18",100,0,3275);
   Graph_Graph01025->SetMinimum(-0.2591006);
   Graph_Graph01025->SetMaximum(0.288458);
   ...
   Graph_Graph01025->GetYaxis()->SetTitle("A_{EDM} [mrad]");
