void S12_AEDM_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-1.026623,3360.969,0.3758857);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01019->SetMinimum(-0.8863721);
   Graph_Graph01019->SetMaximum(0.2356348);
   ...
   Graph_Graph01019->GetYaxis()->SetTitle("A_{EDM} [mrad]");
