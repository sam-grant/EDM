void S0_c_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-1.63738,3360.969,6.709782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","S0",100,0,3275);
   Graph_Graph01015->SetMinimum(-0.8026636);
   Graph_Graph01015->SetMaximum(5.875065);
