void S0S12S18_Momentum_Y_RMS_vs_p_250MeV_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 13:43:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,3.710718,3419.625,26.54421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01024->SetMinimum(5.994068);
   Graph_Graph01024->SetMaximum(24.26086);
   ...
   Graph_Graph01024->GetXaxis()->SetRange(0,92);
