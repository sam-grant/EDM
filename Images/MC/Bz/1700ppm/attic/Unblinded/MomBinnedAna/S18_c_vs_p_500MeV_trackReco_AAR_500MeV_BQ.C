void S18_c_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-1.852645,3456.75,6.789784);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01013 = new TH1F("Graph_Graph01013","S18",100,0,3300);
   Graph_Graph01013->SetMinimum(-0.9884023);
   Graph_Graph01013->SetMaximum(5.925541);
   ...
   Graph_Graph01013->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
   Graph_Graph01013->GetXaxis()->SetRange(0,93);
