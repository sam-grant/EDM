void S0S12S18_N_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-135320.1,3456.75,1725894);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S0S12S18",100,0,3300);
   Graph_Graph01025->SetMinimum(50801.4);
   Graph_Graph01025->SetMaximum(1539773);
   ...
   Graph_Graph01025->GetXaxis()->SetRange(0,93);
