...
//=========  (Wed May 19 17:11:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.1400001,0.1784926,8.14,0.3402604);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01054->SetMinimum(0.1946694);
   Graph_Graph01054->SetMaximum(0.3240836);
   ...
   gre->Draw("0ap");
   TGaxis *gaxis = new TGaxis(0.688,0.1946694,7.312,0.1946694,0.688,7.312,8,"");
