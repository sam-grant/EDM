void S0S12S18_thetaYMaxDiff_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-12.58917,3360.969,211.998);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S0S12S18",100,0,3275);
   Graph_Graph01035->SetMinimum(9.869543);
   Graph_Graph01035->SetMaximum(189.5393);
   ...
   Graph_Graph01035->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01035->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01035->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
