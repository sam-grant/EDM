void S0S12S18_theta_Y_RMS_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-1.667414,3360.969,37.91062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01030 = new TH1F("Graph_Graph01030","S0S12S18",100,0,3275);
   Graph_Graph01030->SetMinimum(2.290389);
   Graph_Graph01030->SetMaximum(33.95282);
