void S12_c_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-2.167545,3360.969,6.715062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01018->SetMinimum(-1.279284);
   Graph_Graph01018->SetMaximum(5.826802);
   ...
   Graph_Graph01018->GetYaxis()->SetTitle("c [mrad]");
