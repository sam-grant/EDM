void S0S12S18_thetaYMaxDiff_vs_p_250MeV_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 13:43:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-68.78859,3419.625,1170.735);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S0S12S18",100,0,3300);
   Graph_Graph01027->SetMinimum(55.16378);
   Graph_Graph01027->SetMaximum(1046.783);
   ...
   Graph_Graph01027->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   ...
   Graph_Graph01027->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
