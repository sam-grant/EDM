void S0S12S18_Ag2_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.1998934,3456.75,0.3548741);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02050644,
   0.0289032};
   TGraphErrors *gre = new TGraphErrors(6,Graph0_fx1021,Graph0_fy1021,Graph0_fex1021,Graph0_fey1021);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","S0S12S18",100,0,3300);
   Graph_Graph01021->SetMinimum(-0.1444166);
   Graph_Graph01021->SetMaximum(0.2993974);
   ...
   Graph_Graph01021->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250 MeV");
   Graph_Graph01021->GetXaxis()->SetRange(0,93);
   ...
   Graph_Graph01021->GetYaxis()->SetTitle("A_{g#minus2} [mrad]");
