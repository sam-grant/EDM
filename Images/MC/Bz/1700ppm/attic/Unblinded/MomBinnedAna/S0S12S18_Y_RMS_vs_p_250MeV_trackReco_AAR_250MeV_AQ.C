void S0S12S18_Y_RMS_vs_p_250MeV_trackReco_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 13:43:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,10.0376,3419.625,27.041);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","S0S12S18",100,0,3300);
   Graph_Graph01023->SetMinimum(11.73794);
   Graph_Graph01023->SetMaximum(25.34066);
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("#sigma_{y} [mm]");
