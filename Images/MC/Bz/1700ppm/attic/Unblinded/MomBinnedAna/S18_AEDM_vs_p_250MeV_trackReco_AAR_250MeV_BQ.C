void S18_AEDM_vs_p_250MeV_trackReco_AAR_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 00:54:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.3791708,3360.969,1.085226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","S18",100,0,3275);
   Graph_Graph01022->SetMinimum(-0.2327311);
   Graph_Graph01022->SetMaximum(0.9387867);
   ...
   Graph_Graph01022->GetXaxis()->SetRange(8,92);
