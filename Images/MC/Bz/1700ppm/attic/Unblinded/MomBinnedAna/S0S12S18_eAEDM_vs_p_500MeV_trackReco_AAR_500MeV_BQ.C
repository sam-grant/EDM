void S0S12S18_eAEDM_vs_p_500MeV_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-420.75,-0.02357694,3456.75,0.2283145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S0S12S18",100,0,3300);
   Graph_Graph01026->SetMinimum(0.001612201);
   Graph_Graph01026->SetMaximum(0.2031254);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(0,93);
   ...
   Graph_Graph01026->GetYaxis()->SetTitle("#deltaA_{EDM}");
