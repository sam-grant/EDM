...
//=========  (Thu May  6 11:49:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-377.2,-0.219085,3394.8,0.4182024);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02502227,
   0.03618933};
   TGraphErrors *gre = new TGraphErrors(14,Graph0_fx1076,Graph0_fy1076,Graph0_fex1076,Graph0_fey1076);
   gre->SetName("Graph0");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01076 = new TH1F("Graph_Graph01076","S12",100,0,3280);
   Graph_Graph01076->SetMinimum(-0.1553563);
   Graph_Graph01076->SetMaximum(0.3544736);
   ...
   Graph_Graph01076->GetXaxis()->SetTitle("p [MeV]: in range p #minus 100 < p < p #plus 100 MeV");
   Graph_Graph01076->GetXaxis()->SetRange(1,92);
   ...
   Graph_Graph01076->GetYaxis()->SetTitle("c [mrad]");
