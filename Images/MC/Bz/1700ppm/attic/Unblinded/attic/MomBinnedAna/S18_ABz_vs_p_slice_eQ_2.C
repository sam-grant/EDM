...
//=========  (Thu May  6 12:22:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-410,-0.3545967,3690,0.3330105);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01106->SetMinimum(-0.285836);
   Graph_Graph01106->SetMaximum(0.2642498);
   ...
   Graph_Graph01106->GetYaxis()->SetTitle("A_{Bz} [mrad]");
