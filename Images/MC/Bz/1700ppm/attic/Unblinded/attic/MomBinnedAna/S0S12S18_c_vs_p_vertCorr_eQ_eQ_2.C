void S0S12S18_c_vs_p_vertCorr_eQ_eQ_2()
{
...
//=========  (Tue May  4 00:10:14 2021) by ROOT version 6.22/08
   ...
   c->Range(488,-0.0468275,1712,0.03171241);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01672207,
   0.0161346};
   TGraphErrors *gre = new TGraphErrors(8,Graph0_fx1119,Graph0_fy1119,Graph0_fex1119,Graph0_fey1119);
   gre->SetName("Graph0");
   gre->SetTitle("S0S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","S0S12S18",100,620,1580);
   Graph_Graph01119->SetMinimum(-0.03897351);
   Graph_Graph01119->SetMaximum(0.02385842);
   ...
   Graph_Graph01119->GetXaxis()->SetTitle("p [MeV]: in range p #minus 50 < p < p #plus 50 MeV");
   Graph_Graph01119->GetXaxis()->SetRange(0,101);
