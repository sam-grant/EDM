...
//=========  (Fri Nov 19 17:39:46 2021) by ROOT version 6.24/04
   ...
   c->Range(7.613195,11.59433,3233.408,23.52829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12_",100,217.9911,3023.03);
   Graph_Graph01057->SetMinimum(12.78772);
   Graph_Graph01057->SetMaximum(22.33489);
