...
//=========  (Thu Nov 18 11:39:14 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5093,-0.003379875,2742.058,0.01241515);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S0_",100,218.0657,3022.502);
   Graph_Graph01034->SetMinimum(-0.001800373);
   Graph_Graph01034->SetMaximum(0.01083565);
