...
//=========  (Thu Nov 18 11:33:39 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7918,-2.461734,2724.913,0.570536);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S0S12S18_",100,0,3092.099);
   Graph_Graph01066->SetMinimum(-2.158507);
   Graph_Graph01066->SetMaximum(0.267309);
