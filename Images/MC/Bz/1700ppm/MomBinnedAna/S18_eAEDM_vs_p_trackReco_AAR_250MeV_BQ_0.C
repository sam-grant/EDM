...
//=========  (Thu Nov 18 11:39:15 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,-0.02464925,2741.036,0.3924814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01052 = new TH1F("Graph_Graph01052","S18_",100,218.1089,3021.361);
   Graph_Graph01052->SetMinimum(0.01706382);
   Graph_Graph01052->SetMaximum(0.3507683);
