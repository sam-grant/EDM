void S0_Ag2_vs_p_trackReco_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:39:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.5093,-0.9776843,2742.058,0.7556771);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S0_",100,218.0657,3022.502);
   Graph_Graph01027->SetMinimum(-0.8043481);
   Graph_Graph01027->SetMaximum(0.582341);
