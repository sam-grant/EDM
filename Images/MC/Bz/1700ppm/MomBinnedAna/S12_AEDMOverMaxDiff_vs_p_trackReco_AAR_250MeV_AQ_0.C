...
//=========  (Thu Nov 18 11:38:55 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6126,-0.001411851,2723.977,0.0009153645);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S12_",100,0,3091.037);
   Graph_Graph01044->SetMinimum(-0.00117913);
   Graph_Graph01044->SetMaximum(0.0006826429);
