...
//=========  (Thu Nov 18 11:38:57 2021) by ROOT version 6.24/04
   ...
   c->Range(521.7918,-6.443466,2724.913,61.0827);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S0S12S18_",100,0,3092.099);
   Graph_Graph01068->SetMinimum(0.3091508);
   Graph_Graph01068->SetMaximum(54.33008);
   ...
   Graph_Graph01068->GetXaxis()->SetRange(25,81);
