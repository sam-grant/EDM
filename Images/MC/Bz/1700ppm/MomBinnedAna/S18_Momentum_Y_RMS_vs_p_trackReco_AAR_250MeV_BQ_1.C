...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,11.80623,2741.036,23.36768);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S18_",100,218.1089,3021.361);
   Graph_Graph01050->SetMinimum(12.96238);
   Graph_Graph01050->SetMaximum(22.21154);
