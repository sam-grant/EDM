...
//=========  (Thu Nov 18 11:39:15 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,-31053.98,2741.036,307817.8);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01051 = new TH1F("Graph_Graph01051","S18_",100,218.1089,3021.361);
   Graph_Graph01051->SetMinimum(2833.2);
   Graph_Graph01051->SetMaximum(273930.6);
