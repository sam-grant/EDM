...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,-2.001769,2741.036,6.776169);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S18_",100,218.1089,3021.361);
   Graph_Graph01045->SetMinimum(-1.123975);
   Graph_Graph01045->SetMaximum(5.898375);
