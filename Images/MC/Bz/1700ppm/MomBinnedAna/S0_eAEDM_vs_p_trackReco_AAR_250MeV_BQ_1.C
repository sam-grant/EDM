...
//=========  (Thu Nov 18 11:33:53 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5093,-0.02562808,2742.058,0.3905466);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S0_",100,218.0657,3022.502);
   Graph_Graph01032->SetMinimum(0.01598939);
   Graph_Graph01032->SetMaximum(0.3489291);
