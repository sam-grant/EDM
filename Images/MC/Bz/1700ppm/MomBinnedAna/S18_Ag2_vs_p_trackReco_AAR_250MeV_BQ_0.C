...
//=========  (Thu Nov 18 11:39:15 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,-0.4362736,2741.036,0.7050336);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S18_",100,218.1089,3021.361);
   Graph_Graph01047->SetMinimum(-0.3221428);
   Graph_Graph01047->SetMaximum(0.5909029);
