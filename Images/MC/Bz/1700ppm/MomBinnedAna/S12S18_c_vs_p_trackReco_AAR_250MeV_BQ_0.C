...
//=========  (Thu Nov 18 11:39:15 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5325,-2.04507,2741.694,6.623151);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12S18_",100,218.1372,3022.09);
   Graph_Graph01055->SetMinimum(-1.178248);
   Graph_Graph01055->SetMaximum(5.756328);
