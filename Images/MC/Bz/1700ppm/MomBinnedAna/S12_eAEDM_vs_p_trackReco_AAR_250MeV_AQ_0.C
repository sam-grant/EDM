...
//=========  (Thu Nov 18 11:38:55 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6126,-0.1661708,2723.977,1.837148);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12_",100,0,3091.037);
   Graph_Graph01042->SetMinimum(0.03416106);
   Graph_Graph01042->SetMaximum(1.636816);
