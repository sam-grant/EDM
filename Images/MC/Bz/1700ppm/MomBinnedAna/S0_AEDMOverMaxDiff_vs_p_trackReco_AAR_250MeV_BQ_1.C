...
//=========  (Fri Nov 19 17:33:27 2021) by ROOT version 6.24/04
   ...
   c->Range(7.732923,-0.003577989,3232.835,0.01058555);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01048 = new TH1F("Graph_Graph01048","S0_",100,218.0657,3022.502);
   Graph_Graph01048->SetMinimum(-0.002161635);
   Graph_Graph01048->SetMaximum(0.009169197);
