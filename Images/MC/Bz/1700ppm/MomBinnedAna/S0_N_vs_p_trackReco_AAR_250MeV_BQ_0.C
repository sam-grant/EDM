...
//=========  (Thu Nov 18 11:39:14 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5093,-28780.69,2742.058,304584.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","S0_",100,218.0657,3022.502);
   Graph_Graph01031->SetMinimum(4555.8);
   Graph_Graph01031->SetMaximum(271247.7);
