...
//=========  (Thu Oct 21 14:37:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-28780.69,2750,304584.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01021->SetMinimum(4555.8);
   Graph_Graph01021->SetMaximum(271247.7);
