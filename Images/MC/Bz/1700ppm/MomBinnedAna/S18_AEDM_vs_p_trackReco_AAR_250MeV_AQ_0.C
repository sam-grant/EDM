...
//=========  (Thu Nov 18 11:38:55 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6156,-2.259944,2723.993,2.20537);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S18_",100,0,3091.056);
   Graph_Graph01046->SetMinimum(-1.813412);
   Graph_Graph01046->SetMaximum(1.758838);
