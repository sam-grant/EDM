...
//=========  (Mon Nov 22 14:14:41 2021) by ROOT version 6.24/04
   ...
   c->Range(7.864962,-1.659525,3231.605,37.89032);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S18_",100,218.1089,3021.361);
   Graph_Graph01069->SetMinimum(2.29546);
   Graph_Graph01069->SetMaximum(33.93534);
