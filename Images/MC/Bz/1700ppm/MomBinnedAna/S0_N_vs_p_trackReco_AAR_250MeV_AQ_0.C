...
//=========  (Fri Nov 19 17:39:27 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.5052,-58813.95,3337.977,540377.6);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S0_",100,0,3094.301);
   Graph_Graph01044->SetMinimum(1105.2);
   Graph_Graph01044->SetMaximum(480458.4);
