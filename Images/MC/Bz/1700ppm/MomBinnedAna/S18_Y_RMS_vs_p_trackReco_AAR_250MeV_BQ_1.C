...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,12.05394,2741.036,13.50439);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S18_",100,218.1089,3021.361);
   Graph_Graph01049->SetMinimum(12.19899);
   Graph_Graph01049->SetMaximum(13.35934);
