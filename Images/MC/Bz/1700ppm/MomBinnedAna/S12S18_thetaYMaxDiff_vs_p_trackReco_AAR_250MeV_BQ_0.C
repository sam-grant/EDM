...
//=========  (Mon Nov 22 14:19:29 2021) by ROOT version 6.24/04
   ...
   c->Range(7.840778,-12.58917,3232.386,211.998);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01089 = new TH1F("Graph_Graph01089","S12S18_",100,218.1372,3022.09);
   Graph_Graph01089->SetMinimum(9.869543);
   Graph_Graph01089->SetMaximum(189.5393);
