void S12S18_eAEDM_vs_p_A_trackReco_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:14:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1341,-0.0001206996,3334.296,0.001087676);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01088 = new TH1F("Graph_Graph01088","S12S18_",100,0,3090.888);
   Graph_Graph01088->SetMinimum(1.379151e-07);
   Graph_Graph01088->SetMaximum(0.0009668383);
