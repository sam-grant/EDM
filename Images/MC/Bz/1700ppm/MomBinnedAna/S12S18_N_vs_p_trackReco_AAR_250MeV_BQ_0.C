...
//=========  (Mon Nov 22 14:19:29 2021) by ROOT version 6.24/04
   ...
   c->Range(7.840778,-61276.47,3232.386,612670.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01086 = new TH1F("Graph_Graph01086","S12S18_",100,218.1372,3022.09);
   Graph_Graph01086->SetMinimum(6118.2);
   Graph_Graph01086->SetMaximum(545275.5);
