...
//=========  (Mon Nov 22 14:14:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1523,-2.294481,3334.476,2.176394);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01064 = new TH1F("Graph_Graph01064","S18_",100,0,3091.056);
   Graph_Graph01064->SetMinimum(-1.847394);
   Graph_Graph01064->SetMaximum(1.729306);
