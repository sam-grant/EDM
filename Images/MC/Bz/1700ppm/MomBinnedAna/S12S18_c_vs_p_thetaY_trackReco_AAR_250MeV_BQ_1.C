...
//=========  (Mon Nov 22 14:14:41 2021) by ROOT version 6.24/04
   ...
   c->Range(7.840778,-2.04507,3232.386,6.623152);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S12S18_",100,218.1372,3022.09);
   Graph_Graph01077->SetMinimum(-1.178248);
   Graph_Graph01077->SetMaximum(5.75633);
