...
//=========  (Mon Nov 22 14:14:25 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1523,-0.1653761,3334.476,1.835556);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01073 = new TH1F("Graph_Graph01073","S18_",100,0,3091.056);
   Graph_Graph01073->SetMinimum(0.03471719);
   Graph_Graph01073->SetMaximum(1.635463);
