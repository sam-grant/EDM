...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.495,-0.02444051,2742.526,0.3888066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12_",100,217.9911,3023.03);
   Graph_Graph01042->SetMinimum(0.0168842);
   Graph_Graph01042->SetMaximum(0.3474819);
