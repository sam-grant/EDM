...
//=========  (Thu Nov 18 11:39:16 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5325,-0.0174576,2741.694,0.2772001);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01062 = new TH1F("Graph_Graph01062","S12S18_",100,218.1372,3022.09);
   Graph_Graph01062->SetMinimum(0.01200817);
   Graph_Graph01062->SetMaximum(0.2477343);
