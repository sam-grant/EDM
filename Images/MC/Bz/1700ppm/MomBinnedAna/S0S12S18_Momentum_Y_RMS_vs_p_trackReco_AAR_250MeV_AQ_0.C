...
//=========  (Fri Nov 19 17:39:29 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.2658,3.710718,3335.602,26.54421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01099 = new TH1F("Graph_Graph01099","S0S12S18_",100,0,3092.099);
   Graph_Graph01099->SetMinimum(5.994068);
   Graph_Graph01099->SetMaximum(24.26086);
