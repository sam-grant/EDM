...
//=========  (Mon Nov 22 14:14:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1523,-0.002753242,3334.476,0.01218569);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S18_",100,0,3091.056);
   Graph_Graph01068->SetMinimum(-0.001259348);
   Graph_Graph01068->SetMaximum(0.0106918);
