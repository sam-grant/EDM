...
//=========  (Thu Nov 18 11:33:38 2021) by ROOT version 6.24/04
   ...
   c->Range(522.1632,-83.101,2726.852,1106.57);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S0_",100,0,3094.301);
   Graph_Graph01033->SetMinimum(35.86616);
   Graph_Graph01033->SetMaximum(987.6033);
