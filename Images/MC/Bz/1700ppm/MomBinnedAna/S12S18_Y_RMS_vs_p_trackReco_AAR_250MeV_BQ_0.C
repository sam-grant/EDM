...
//=========  (Mon Nov 22 14:19:29 2021) by ROOT version 6.24/04
   ...
   c->Range(7.840778,12.07906,3232.386,13.41184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01084 = new TH1F("Graph_Graph01084","S12S18_",100,218.1372,3022.09);
   Graph_Graph01084->SetMinimum(12.21234);
   Graph_Graph01084->SetMaximum(13.27856);
