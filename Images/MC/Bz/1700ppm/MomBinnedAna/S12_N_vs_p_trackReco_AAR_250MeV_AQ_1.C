void S12_N_vs_p_trackReco_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 14:14:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.1504,-58367.87,3334.457,536605.8);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12_",100,0,3091.037);
   Graph_Graph01058->SetMinimum(1129.5);
   Graph_Graph01058->SetMaximum(477108.4);
   ...
   Graph_Graph01058->GetXaxis()->SetRange(2,96);
