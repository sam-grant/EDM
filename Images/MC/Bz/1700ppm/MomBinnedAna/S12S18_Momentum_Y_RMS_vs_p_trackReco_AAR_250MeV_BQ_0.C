...
//=========  (Thu Nov 18 11:39:16 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5325,11.75748,2741.694,23.42453);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01060 = new TH1F("Graph_Graph01060","S12S18_",100,218.1372,3022.09);
   Graph_Graph01060->SetMinimum(12.92419);
   Graph_Graph01060->SetMaximum(22.25783);
