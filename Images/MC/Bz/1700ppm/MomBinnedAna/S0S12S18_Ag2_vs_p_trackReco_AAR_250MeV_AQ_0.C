void S0S12S18_Ag2_vs_p_trackReco_AAR_250MeV_AQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:38:57 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(521.7918,-2.221376,2724.913,0.7507589);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0S12S18_",100,0,3092.099);
   Graph_Graph01067->SetMinimum(-1.924163);
   Graph_Graph01067->SetMaximum(0.4535454);
