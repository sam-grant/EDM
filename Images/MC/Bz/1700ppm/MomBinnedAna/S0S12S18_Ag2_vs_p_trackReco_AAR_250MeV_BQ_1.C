void S0S12S18_Ag2_vs_p_trackReco_AAR_250MeV_BQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:33:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.5769,-0.2204617,2741.742,0.380932);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S0S12S18_",100,218.1813,3022.138);
   Graph_Graph01067->SetMinimum(-0.1603223);
   Graph_Graph01067->SetMaximum(0.3207926);
