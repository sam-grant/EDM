...
//=========  (Thu Nov 18 11:38:56 2021) by ROOT version 6.24/04
   ...
   c->Range(521.5874,-5.669449,2723.845,57.15465);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12S18_",100,0,3090.888);
   Graph_Graph01058->SetMinimum(0.6129606);
   Graph_Graph01058->SetMaximum(50.87224);
