...
//=========  (Mon Nov 22 14:19:09 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.5052,-83.101,3337.977,1106.57);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S0_",100,0,3094.301);
   Graph_Graph01047->SetMinimum(35.86616);
   Graph_Graph01047->SetMaximum(987.6033);
