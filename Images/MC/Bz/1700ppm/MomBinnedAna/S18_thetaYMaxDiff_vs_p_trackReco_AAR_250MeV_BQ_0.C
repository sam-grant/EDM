...
//=========  (Fri Nov 19 17:39:47 2021) by ROOT version 6.24/04
   ...
   c->Range(7.864962,-14.73335,3231.605,209.8538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18_",100,218.1089,3021.361);
   Graph_Graph01075->SetMinimum(7.725362);
   Graph_Graph01075->SetMaximum(187.3951);
