...
//=========  (Thu Nov 18 11:39:15 2021) by ROOT version 6.24/04
   ...
   c->Range(498.4342,-14.73335,2741.036,209.8538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01053 = new TH1F("Graph_Graph01053","S18_",100,218.1089,3021.361);
   Graph_Graph01053->SetMinimum(7.725362);
   Graph_Graph01053->SetMaximum(187.3951);
