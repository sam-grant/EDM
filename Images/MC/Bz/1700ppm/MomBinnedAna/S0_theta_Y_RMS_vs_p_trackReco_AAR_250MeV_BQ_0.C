...
//=========  (Mon Nov 22 14:19:27 2021) by ROOT version 6.24/04
   ...
   c->Range(7.732923,-1.749274,3232.835,38.21026);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S0_",100,218.0657,3022.502);
   Graph_Graph01041->SetMinimum(2.24668);
   Graph_Graph01041->SetMaximum(34.21431);
