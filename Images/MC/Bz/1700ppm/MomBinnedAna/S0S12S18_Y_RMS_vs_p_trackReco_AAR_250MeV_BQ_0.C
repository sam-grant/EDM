...
//=========  (Mon Nov 22 14:19:30 2021) by ROOT version 6.24/04
   ...
   c->Range(7.88461,12.19196,3232.434,13.35046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01098 = new TH1F("Graph_Graph01098","S0S12S18_",100,218.1813,3022.138);
   Graph_Graph01098->SetMinimum(12.30781);
   Graph_Graph01098->SetMaximum(13.23461);
