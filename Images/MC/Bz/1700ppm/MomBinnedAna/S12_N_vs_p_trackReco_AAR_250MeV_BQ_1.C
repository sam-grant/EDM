...
//=========  (Mon Nov 22 14:14:40 2021) by ROOT version 6.24/04
   ...
   c->Range(7.613195,-30222.49,3233.408,304852.4);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12_",100,217.9911,3023.03);
   Graph_Graph01058->SetMinimum(3285);
   Graph_Graph01058->SetMaximum(271344.9);
