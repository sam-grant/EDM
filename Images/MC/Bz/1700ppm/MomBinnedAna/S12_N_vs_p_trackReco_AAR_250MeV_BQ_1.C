...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.495,-30222.49,2742.526,304852.4);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S12_",100,217.9911,3023.03);
   Graph_Graph01041->SetMinimum(3285);
   Graph_Graph01041->SetMaximum(271344.9);
