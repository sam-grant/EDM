...
//=========  (Thu Nov 18 11:38:56 2021) by ROOT version 6.24/04
   ...
   c->Range(521.5874,-116634.2,2723.845,1072424);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12S18_",100,0,3090.888);
   Graph_Graph01061->SetMinimum(2271.6);
   Graph_Graph01061->SetMaximum(953518);
