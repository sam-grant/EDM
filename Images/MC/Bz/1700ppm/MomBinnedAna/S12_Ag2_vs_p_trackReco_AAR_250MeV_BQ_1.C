...
//=========  (Thu Nov 18 11:33:54 2021) by ROOT version 6.24/04
   ...
   c->Range(498.495,-0.3587468,2742.526,0.9124914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S12_",100,217.9911,3023.03);
   Graph_Graph01037->SetMinimum(-0.231623);
   Graph_Graph01037->SetMaximum(0.7853676);
