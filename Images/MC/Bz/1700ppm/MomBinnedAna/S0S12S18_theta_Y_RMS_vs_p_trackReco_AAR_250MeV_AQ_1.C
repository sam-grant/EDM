...
//=========  (Mon Nov 22 14:14:26 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.2658,-6.443466,3335.602,61.0827);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01097 = new TH1F("Graph_Graph01097","S0S12S18_",100,0,3092.099);
   Graph_Graph01097->SetMinimum(0.3091508);
   Graph_Graph01097->SetMaximum(54.33008);
