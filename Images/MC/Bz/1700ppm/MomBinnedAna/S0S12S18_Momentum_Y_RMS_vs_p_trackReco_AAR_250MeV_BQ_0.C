...
//=========  (Mon Nov 22 14:19:30 2021) by ROOT version 6.24/04
   ...
   c->Range(7.88461,11.7844,3232.434,23.45253);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01099 = new TH1F("Graph_Graph01099","S0S12S18_",100,218.1813,3022.138);
   Graph_Graph01099->SetMinimum(12.95121);
   Graph_Graph01099->SetMaximum(22.28571);
