...
//=========  (Fri Nov 19 17:39:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-336.5052,-0.01326973,3337.977,0.002706239);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S0_",100,0,3094.301);
   Graph_Graph01038->SetMinimum(-0.01167214);
   Graph_Graph01038->SetMaximum(0.001108641);
