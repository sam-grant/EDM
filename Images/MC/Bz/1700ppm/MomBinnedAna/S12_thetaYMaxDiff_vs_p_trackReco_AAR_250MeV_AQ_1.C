...
//=========  (Thu Nov 18 11:33:38 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6126,-66.10837,2723.977,1108.018);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","S12_",100,0,3091.037);
   Graph_Graph01043->SetMinimum(51.30426);
   Graph_Graph01043->SetMaximum(990.6052);
