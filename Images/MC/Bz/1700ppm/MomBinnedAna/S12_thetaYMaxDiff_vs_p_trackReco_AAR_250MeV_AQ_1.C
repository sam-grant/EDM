...
//=========  (Mon Nov 22 14:14:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1504,-66.10837,3334.457,1108.018);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12_",100,0,3091.037);
   Graph_Graph01061->SetMinimum(51.30426);
   Graph_Graph01061->SetMaximum(990.6052);
