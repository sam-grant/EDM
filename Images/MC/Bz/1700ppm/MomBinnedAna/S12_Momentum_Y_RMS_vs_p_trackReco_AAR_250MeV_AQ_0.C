...
//=========  (Fri Nov 19 17:39:27 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1504,3.42128,3334.457,26.62561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12_",100,0,3091.037);
   Graph_Graph01057->SetMinimum(5.741713);
   Graph_Graph01057->SetMaximum(24.30518);
