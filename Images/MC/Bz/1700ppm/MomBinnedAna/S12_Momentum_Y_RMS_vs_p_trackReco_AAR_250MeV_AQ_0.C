...
//=========  (Thu Nov 18 11:38:55 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6126,3.42128,2723.977,26.62561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12_",100,0,3091.037);
   Graph_Graph01040->SetMinimum(5.741713);
   Graph_Graph01040->SetMaximum(24.30518);
