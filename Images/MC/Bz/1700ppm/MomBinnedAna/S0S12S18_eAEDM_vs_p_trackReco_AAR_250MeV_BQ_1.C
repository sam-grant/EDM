...
//=========  (Thu Nov 18 11:33:55 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5769,-0.01450321,2741.742,0.226728);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S0S12S18_",100,218.1813,3022.138);
   Graph_Graph01072->SetMinimum(0.009619915);
   Graph_Graph01072->SetMaximum(0.2026049);
