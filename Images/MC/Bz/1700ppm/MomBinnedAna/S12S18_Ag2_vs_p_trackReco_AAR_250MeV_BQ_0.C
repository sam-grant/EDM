void S12S18_Ag2_vs_p_trackReco_AAR_250MeV_BQ_0()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 11:39:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(498.5325,-0.3387075,2741.694,0.6840482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01057 = new TH1F("Graph_Graph01057","S12S18_",100,218.1372,3022.09);
   Graph_Graph01057->SetMinimum(-0.236432);
   Graph_Graph01057->SetMaximum(0.5817727);
