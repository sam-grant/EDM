...
//=========  (Thu Nov 18 11:33:53 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5093,-1.637387,2742.058,6.7098);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S0_",100,218.0657,3022.502);
   Graph_Graph01025->SetMinimum(-0.802668);
   Graph_Graph01025->SetMaximum(5.875081);
