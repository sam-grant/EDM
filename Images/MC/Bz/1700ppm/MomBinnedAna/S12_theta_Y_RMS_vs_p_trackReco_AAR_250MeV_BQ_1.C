...
//=========  (Mon Nov 22 14:14:40 2021) by ROOT version 6.24/04
   ...
   c->Range(7.613195,-1.729235,3233.408,37.89909);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01055 = new TH1F("Graph_Graph01055","S12_",100,217.9911,3023.03);
   Graph_Graph01055->SetMinimum(2.233597);
   Graph_Graph01055->SetMaximum(33.93625);
