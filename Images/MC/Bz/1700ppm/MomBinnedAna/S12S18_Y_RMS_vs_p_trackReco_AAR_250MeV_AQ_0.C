...
//=========  (Fri Nov 19 17:39:29 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1341,9.947838,3334.296,27.57247);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01084 = new TH1F("Graph_Graph01084","S12S18_",100,0,3090.888);
   Graph_Graph01084->SetMinimum(11.7103);
   Graph_Graph01084->SetMaximum(25.81001);
