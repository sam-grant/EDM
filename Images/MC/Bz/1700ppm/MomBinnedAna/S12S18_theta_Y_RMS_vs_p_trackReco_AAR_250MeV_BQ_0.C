...
//=========  (Thu Nov 18 11:39:16 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5325,-1.663024,2741.694,37.83162);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01058 = new TH1F("Graph_Graph01058","S12S18_",100,218.1372,3022.09);
   Graph_Graph01058->SetMinimum(2.28644);
   Graph_Graph01058->SetMaximum(33.88216);
