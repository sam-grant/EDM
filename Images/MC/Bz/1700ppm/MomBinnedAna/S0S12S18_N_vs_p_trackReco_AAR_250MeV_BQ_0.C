...
//=========  (Mon Nov 22 14:19:30 2021) by ROOT version 6.24/04
   ...
   c->Range(7.88461,-90057.16,3232.434,917254.4);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01100 = new TH1F("Graph_Graph01100","S0S12S18_",100,218.1813,3022.138);
   Graph_Graph01100->SetMinimum(10674);
   Graph_Graph01100->SetMaximum(816523.2);
