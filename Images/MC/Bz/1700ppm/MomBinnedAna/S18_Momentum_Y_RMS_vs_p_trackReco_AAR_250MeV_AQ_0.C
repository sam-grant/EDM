...
//=========  (Thu Nov 18 11:38:56 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6156,3.420745,2723.993,26.54556);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01050 = new TH1F("Graph_Graph01050","S18_",100,0,3091.056);
   Graph_Graph01050->SetMinimum(5.733227);
   Graph_Graph01050->SetMaximum(24.23308);
