...
//=========  (Mon Nov 22 14:19:28 2021) by ROOT version 6.24/04
   ...
   c->Range(7.613195,-12.05313,3233.408,209.3178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12_",100,217.9911,3023.03);
   Graph_Graph01061->SetMinimum(10.08396);
   Graph_Graph01061->SetMaximum(187.1807);
