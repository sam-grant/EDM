...
//=========  (Thu Nov 18 11:39:14 2021) by ROOT version 6.24/04
   ...
   c->Range(498.495,-12.05313,2742.526,209.3178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","S12_",100,217.9911,3023.03);
   Graph_Graph01043->SetMinimum(10.08396);
   Graph_Graph01043->SetMaximum(187.1807);
