...
//=========  (Thu Nov 18 11:33:55 2021) by ROOT version 6.24/04
   ...
   c->Range(498.5325,-61276.47,2741.694,612670.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12S18_",100,218.1372,3022.09);
   Graph_Graph01061->SetMinimum(6118.2);
   Graph_Graph01061->SetMaximum(545275.5);
