...
//=========  (Thu Oct 21 14:35:22 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-61276.47,2750,612670.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01051->SetMinimum(6118.2);
   Graph_Graph01051->SetMaximum(545275.5);
