...
//=========  (Fri Nov 19 17:39:26 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.5052,10.08974,3337.977,26.55539);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S0_",100,0,3094.301);
   Graph_Graph01042->SetMinimum(11.7363);
   Graph_Graph01042->SetMaximum(24.90883);
