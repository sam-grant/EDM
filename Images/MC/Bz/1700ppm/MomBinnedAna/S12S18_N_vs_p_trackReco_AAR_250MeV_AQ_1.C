...
//=========  (Mon Nov 22 14:14:25 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1341,-116634.2,3334.296,1072424);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01086 = new TH1F("Graph_Graph01086","S12S18_",100,0,3090.888);
   Graph_Graph01086->SetMinimum(2271.6);
   Graph_Graph01086->SetMaximum(953518);
