...
//=========  (Mon Nov 22 14:14:24 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1523,-2.149245,3334.476,2.305861);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01065 = new TH1F("Graph_Graph01065","S18_",100,0,3091.056);
   Graph_Graph01065->SetMinimum(-1.703734);
   Graph_Graph01065->SetMaximum(1.86035);
