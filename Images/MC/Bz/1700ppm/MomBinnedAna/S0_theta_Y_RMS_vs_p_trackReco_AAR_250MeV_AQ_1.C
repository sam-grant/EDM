...
//=========  (Thu Nov 18 11:33:37 2021) by ROOT version 6.24/04
   ...
   c->Range(522.1632,-2.822658,2726.852,68.70557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01028 = new TH1F("Graph_Graph01028","S0_",100,0,3094.301);
   Graph_Graph01028->SetMinimum(4.330166);
   Graph_Graph01028->SetMaximum(61.55275);
