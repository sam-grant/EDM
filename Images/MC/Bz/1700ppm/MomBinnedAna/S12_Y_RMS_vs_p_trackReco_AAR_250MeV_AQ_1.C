...
//=========  (Thu Nov 18 11:33:38 2021) by ROOT version 6.24/04
   ...
   c->Range(521.6126,10.04336,2723.977,27.00421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12_",100,0,3091.037);
   Graph_Graph01039->SetMinimum(11.73944);
   Graph_Graph01039->SetMaximum(25.30813);
