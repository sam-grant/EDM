...
//=========  (Mon Nov 22 14:14:23 2021) by ROOT version 6.24/04
   ...
   c->Range(-336.1504,10.04336,3334.457,27.00421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01056 = new TH1F("Graph_Graph01056","S12_",100,0,3091.037);
   Graph_Graph01056->SetMinimum(11.73944);
   Graph_Graph01056->SetMaximum(25.30813);
