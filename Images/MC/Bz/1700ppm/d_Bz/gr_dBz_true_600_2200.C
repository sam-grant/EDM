...
//=========  (Fri May  7 08:53:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph_Graph010021004->SetMinimum(0.1);
   Graph_Graph_Graph010021004->SetMaximum(0.17);
   ...
   Graph_Graph_Graph010021004->GetXaxis()->SetRange(19,70);
