...
//=========  (Tue Oct 12 11:53:47 2021) by ROOT version 6.24/04
   ...
   Graph_S18_delta_prime_vs_p1003->SetMinimum(0.5);
   Graph_S18_delta_prime_vs_p1003->SetMaximum(4.25);
   ...
   pol01004->SetChisquare(1.048922);
   pol01004->SetNDF(4);
   ...
   pol01004->SetParameter(0,1.716427);
   pol01004->SetParError(0,0.2638632);
