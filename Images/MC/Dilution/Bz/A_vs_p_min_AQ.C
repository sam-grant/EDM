...
//=========  (Sat May 15 17:54:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-292,-0.09875,3308,0.28875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Double_t S0S12S18_A_vs_p_fx1011[15] = {
   0,
   200,
   400,
   600,
   ...
   2600,
   2800};
   Double_t S0S12S18_A_vs_p_fy1011[15] = {
   0.1099219,
   0.1101382,
   0.1192519,
   0.1428939,
   ...
   0.06176508,
   -0.007979628};
   Double_t S0S12S18_A_vs_p_fex1011[15] = {
   100,
   100,
   100,
   100,
   ...
   100,
   100};
   Double_t S0S12S18_A_vs_p_fey1011[15] = {
   0.01051336,
   0.01051336,
   0.01048494,
   0.01033172,
   ...
   0.02449034,
   0.04021262};
   TGraphErrors *gre = new TGraphErrors(15,S0S12S18_A_vs_p_fx1011,S0S12S18_A_vs_p_fy1011,S0S12S18_A_vs_p_fex1011,S0S12S18_A_vs_p_fey1011);
   gre->SetName("S0S12S18_A_vs_p");
   gre->SetTitle("");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_S0S12S18_A_vs_p1011 = new TH1F("Graph_S0S12S18_A_vs_p1011","",100,-400,3200);
   Graph_S0S12S18_A_vs_p1011->SetMinimum(-0.06);
   Graph_S0S12S18_A_vs_p1011->SetMaximum(0.25);
   ...
   Graph_S0S12S18_A_vs_p1011->GetXaxis()->SetTitle("p_{min} [MeV]");
   Graph_S0S12S18_A_vs_p1011->GetXaxis()->SetRange(14,93);
   ...
   Graph_S0S12S18_A_vs_p1011->GetYaxis()->SetTitle("A_{Bz} [mrad]");
   ...
   Graph_S0S12S18_A_vs_p1011->GetYaxis()->SetTitleOffset(1.1);
   ...
   0.00485674,
   0.006651421};
   gre = new TGraphErrors(15,A_vs_p_fx1012,A_vs_p_fy1012,A_vs_p_fex1012,A_vs_p_fey1012);
   gre->SetName("A_vs_p");
   gre->SetTitle(";p_{min} [MeV];A_{Bz} [mrad]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(24);
   
   TH1F *Graph_A_vs_p1012 = new TH1F("Graph_A_vs_p1012","",100,-400,3200);
   Graph_A_vs_p1012->SetMinimum(0.03568956);
   Graph_A_vs_p1012->SetMaximum(0.2381327);
   Graph_A_vs_p1012->SetDirectory(0);
   Graph_A_vs_p1012->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_A_vs_p1012->SetLineColor(ci);
   Graph_A_vs_p1012->GetXaxis()->SetTitle("p_{min} [MeV]");
   Graph_A_vs_p1012->GetXaxis()->SetRange(8,93);
   ...
   Graph_A_vs_p1012->GetYaxis()->SetTitle("A_{Bz} [mrad]");
