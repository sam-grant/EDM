...
//=========  (Mon Oct 11 15:29:25 2021) by ROOT version 6.24/04
   ...
   pol01002->SetChisquare(25.42973);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,2.10101);
   pol01002->SetParError(0,0.1415715);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.1
#pm0.1
 mrad","lpf");
