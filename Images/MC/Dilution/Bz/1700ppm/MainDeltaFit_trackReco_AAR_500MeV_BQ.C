void MainDeltaFit_trackReco_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Oct 11 15:35:47 2021) by ROOT version 6.24/04
   ...
   pol01002->SetChisquare(11.34636);
   pol01002->SetNDF(3);
   ...
   pol01002->SetParameter(0,2.014205);
   pol01002->SetParError(0,0.1394382);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.01
#pm0.1
 mrad","lpf");
