void Graphs_AOverMaxDiff_vs_p_AAR_500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Sep  9 11:51:07 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-416.625,-0.0002321429,3419.625,0.002089286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_trackReco1001->SetMaximum(0.001857143);
