void MahalanobisSphere3D_truthAllDecays_AAR_500MeV_AQ()
{
...
//=========  (Mon Oct 11 15:33:25 2021) by ROOT version 6.24/04
   ...
   sphere3D__3->GetXaxis()->SetTitle("#sigma_{i}");
   ...
   sphere3D__3->GetYaxis()->SetTitle("#sigma_{j}");
   ...
   sphere3D__3->GetZaxis()->SetTitle("#sigma_{k}");
