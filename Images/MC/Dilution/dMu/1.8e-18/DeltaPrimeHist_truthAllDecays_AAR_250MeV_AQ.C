void DeltaPrimeHist_truthAllDecays_AAR_250MeV_AQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Oct  6 11:24:51 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","",51,0.05396858,1.088909);
   h__6->SetBinContent(24,3);
   h__6->SetBinContent(25,183);
   h__6->SetBinContent(26,651);
   h__6->SetBinContent(27,159);
   h__6->SetBinContent(28,4);
