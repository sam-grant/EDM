...
//=========  (Thu Sep 16 18:55:44 2021) by ROOT version 6.24/04
   ...
   c->Range(375,0.4587623,2625,0.6556275);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("");
   gre->SetTitle(";p [MeV]: in range p #minus 250 < p < p #plus 250;#delta' [mrad];#delta' [mrad]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,600,2400);
   Graph_Graph1001->SetMinimum(0.4784488);
   Graph_Graph1001->SetMaximum(0.635941);
   ...
   Graph_Graph1001->GetXaxis()->SetTitle("p [MeV]: in range p #minus 250 < p < p #plus 250");
   Graph_Graph1001->GetXaxis()->CenterTitle(true);
   Graph_Graph1001->GetXaxis()->SetLabelFont(42);
   Graph_Graph1001->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph1001->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph1001->GetXaxis()->SetTitleFont(42);
   Graph_Graph1001->GetYaxis()->SetTitle("#delta' [mrad]");
   ...
   Graph_Graph1001->GetZaxis()->SetTitle("#delta' [mrad]");
   ...
   pol01002->SetChisquare(0.3442931);
   pol01002->SetNDF(3);
   ...
   pol01002->SetParameter(0,0.5667282);
   pol01002->SetParError(0,0.02316643);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.567
#pm0.02
 mrad","lpf");
