void gr_dEDM_vs_n_FNAL()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Jan 18 14:23:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(-1.36875e+07,2.722902e-07,1.231875e+08,1.101857e-05);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle("#sigma#theta_{y} = 14.59 mrad");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","#sigma#theta_{y} = 14.59 mrad",100,0,1.095e+08);
   Graph_Graph01001->SetMinimum(1.346919e-06);
   Graph_Graph01001->SetMaximum(9.943945e-06);
   ...
   f11002->SetChisquare(3.228414e-25);
   f11002->SetNDF(19);
   ...
   f11002->SetParameter(0,0.02063338);
   f11002->SetParError(0,1.536696e-10);
   ...
   TPaveText *pt = new TPaveText(0.3474121,0.9236713,0.6525879,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("#sigma#theta_{y} = 14.59 mrad");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
