...
//=========  (Mon Jan 25 09:07:38 2021) by ROOT version 6.22/06
   ...
   c->Range(38616.31,74.45,38743.31,74.95);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01433433,
   0.01834539};
   TGraphErrors *gre = new TGraphErrors(549,Graph0_fx1002,Graph0_fy1002,Graph0_fex1002,Graph0_fey1002);
   gre->SetName("Graph0");
   gre->SetTitle(";Run number;#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph_Graph010011002 = new TH1F("Graph_Graph_Graph010011002","",549,37887,38883);
   Graph_Graph_Graph010011002->SetMinimum(74.5);
   Graph_Graph_Graph010011002->SetMaximum(74.9);
   ...
   Graph_Graph_Graph010011002->GetXaxis()->SetTitle("Run number");
   Graph_Graph_Graph010011002->GetXaxis()->SetRange(410,465);
   ...
   Graph_Graph_Graph010011002->GetYaxis()->SetTitleOffset(1.25);
