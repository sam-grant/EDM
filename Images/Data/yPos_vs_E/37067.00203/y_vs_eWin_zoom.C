...
//=========  (Fri Apr 23 16:10:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-130,68.9375,2630,79.5625);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","",100,50,2450);
   Graph_Graph01016->SetMinimum(70);
   Graph_Graph01016->SetMaximum(78.5);
   ...
   Double_t Graph1_fx1017[2] = {
   250,
   750};
   Double_t Graph1_fy1017[2] = {
   69.67348,
   83.79388};
   Double_t Graph1_fex1017[2] = {
   0,
   0};
   Double_t Graph1_fey1017[2] = {
   2.221526,
   6.442227};
   gre = new TGraphErrors(2,Graph1_fx1017,Graph1_fy1017,Graph1_fex1017,Graph1_fey1017);
   gre->SetName("Graph1");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph11017 = new TH1F("Graph_Graph11017","Graph",100,200,800);
   Graph_Graph11017->SetMinimum(65.17354);
   Graph_Graph11017->SetMaximum(92.51452);
   ...
   Double_t Graph2_fx1018[2] = {
   250,
   750};
   Double_t Graph2_fy1018[2] = {
   71.04046,
   77.52876};
   Double_t Graph2_fex1018[2] = {
   0,
   0};
   Double_t Graph2_fey1018[2] = {
   2.5825,
   7.483125};
   gre = new TGraphErrors(2,Graph2_fx1018,Graph2_fy1018,Graph2_fex1018,Graph2_fey1018);
   gre->SetName("Graph2");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph21018 = new TH1F("Graph_Graph21018","Graph",100,200,800);
   Graph_Graph21018->SetMinimum(66.80257);
   Graph_Graph21018->SetMaximum(86.66728);
