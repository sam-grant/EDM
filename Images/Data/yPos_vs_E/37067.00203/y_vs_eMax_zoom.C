...
//=========  (Fri Apr 23 16:10:22 2021) by ROOT version 6.22/08
   ...
   c->Range(24.99997,73.975,3475,76.225);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01010 = new TH1F("Graph_Graph01010","",100,250,3250);
   Graph_Graph01010->SetMinimum(74.2);
   Graph_Graph01010->SetMaximum(76);
   ...
   TH1F *Graph_Graph11011 = new TH1F("Graph_Graph11011","Graph",100,250,3250);
   Graph_Graph11011->SetMinimum(66.98311);
   Graph_Graph11011->SetMaximum(72.60921);
   ...
   TH1F *Graph_Graph21012 = new TH1F("Graph_Graph21012","Graph",100,250,3250);
   Graph_Graph21012->SetMinimum(67.93519);
   Graph_Graph21012->SetMaximum(74.20839);
