...
//=========  (Fri Apr 23 16:10:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-288.75,71.8125,2378.75,78.6875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01004 = new TH1F("Graph_Graph01004","",100,0,2200);
   ...
   Graph_Graph11005->SetMinimum(65.52493);
   Graph_Graph11005->SetMaximum(92.48257);
   ...
   Graph_Graph21006->SetMinimum(66.95102);
   Graph_Graph21006->SetMaximum(86.65378);
