...
//=========  (Fri Apr 23 15:56:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-346.125,68.9375,3825.125,79.5625);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","",100,0,3550);
   ...
   Graph_Graph01016->GetXaxis()->SetRange(3,96);
   ...
   0.4071049,
   2.127763};
   gre = new TGraphErrors(7,Graph1_fx1017,Graph1_fy1017,Graph1_fex1017,Graph1_fey1017);
   gre->SetName("Graph1");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph11017 = new TH1F("Graph_Graph11017","Graph",100,0,3550);
   Graph_Graph11017->SetMinimum(69.81969);
   Graph_Graph11017->SetMaximum(77.6076);
   ...
   0.4302773,
   2.310137};
   gre = new TGraphErrors(7,Graph2_fx1018,Graph2_fy1018,Graph2_fex1018,Graph2_fey1018);
   gre->SetName("Graph2");
   gre->SetTitle("Graph");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_Graph21018 = new TH1F("Graph_Graph21018","Graph",100,0,3550);
   Graph_Graph21018->SetMinimum(69.87912);
   Graph_Graph21018->SetMaximum(77.57808);
