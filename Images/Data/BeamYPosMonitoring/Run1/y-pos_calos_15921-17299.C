...
//=========  (Fri Feb 12 11:08:30 2021) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph01002 = new TH1F("Graph_Graph01002","Run 1 (partial)",217,15783.2,17436.8);
   Graph_Graph01002->SetMinimum(73);
   ...
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("Run 1 (partial)");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
