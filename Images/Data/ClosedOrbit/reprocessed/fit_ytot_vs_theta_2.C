...
//=========  (Wed Jan 20 18:34:14 2021) by ROOT version 6.22/06
   ...
   Graph_Graph_Graph_Graph_Graph01003100410071010->SetMinimum(-0.25);
   Graph_Graph_Graph_Graph_Graph01003100410071010->SetMaximum(0.25);
   ...
   Graph_Graph_Graph_Graph_Graph01003100410071010->GetXaxis()->SetRange(1,92);
   ...
   Graph_Graph_Graph_Graph_Graph01003100410071010->GetYaxis()->SetTitle("#LTy_{18 kV}#GT #minus #LTy_{14 kV}#GT [mm]");
   ...
   Graph_Graph_Graph_Graph_Graph01003100410071010->GetYaxis()->SetTitleOffset(1.25);
