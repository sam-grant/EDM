...
//=========  (Mon Jan 25 05:55:06 2021) by ROOT version 6.22/06
   ...
   Double_t ytot_vs_theta_fx1007[24] = {
   0.5192355,
   0.7810348,
   1.042834,
   1.304634,
   ...
   6.278822,
   0.2574361};
   Double_t ytot_vs_theta_fy1007[24] = {
   0.006562985,
   0.06206024,
   0.0127903,
   -0.02058143,
   ...
   -0.0446683,
   0.06959394};
   Double_t ytot_vs_theta_fex1007[24] = {
   0,
   0,
   0,
   0,
   ...
   0,
   0};
   Double_t ytot_vs_theta_fey1007[24] = {
   0.03941483,
   0.04179225,
   0.04482726,
   0.04455844,
   ...
   0.04035714,
   0.03898679};
   TGraphErrors *gre = new TGraphErrors(24,ytot_vs_theta_fx1007,ytot_vs_theta_fy1007,ytot_vs_theta_fex1007,ytot_vs_theta_fey1007);
   gre->SetName("ytot_vs_theta");
   gre->SetTitle(";#theta [rad];#LTy_{18 kV}#GT #minus #LTy_{14 kV}#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph_ytot_vs_theta10041007 = new TH1F("Graph_Graph_ytot_vs_theta10041007","",100,0,6.880961);
   Graph_Graph_ytot_vs_theta10041007->SetMinimum(-0.25);
   Graph_Graph_ytot_vs_theta10041007->SetMaximum(0.25);
   Graph_Graph_ytot_vs_theta10041007->SetDirectory(0);
   Graph_Graph_ytot_vs_theta10041007->SetStats(0);

   Int_t ci;      // for color index setting
   TColor *color; // for color definition with alpha
   ci = TColor::GetColor("#000099");
   Graph_Graph_ytot_vs_theta10041007->SetLineColor(ci);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetTitle("#theta [rad]");
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetRange(1,92);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->CenterTitle(true);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetLabelFont(42);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph_ytot_vs_theta10041007->GetXaxis()->SetTitleFont(42);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetTitle("#LTy_{18 kV}#GT #minus #LTy_{14 kV}#GT [mm]");
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->CenterTitle(true);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetNdivisions(4000510);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetLabelFont(42);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetTitleSize(0.04);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetTitleOffset(1.25);
   Graph_Graph_ytot_vs_theta10041007->GetYaxis()->SetTitleFont(42);
   Graph_Graph_ytot_vs_theta10041007->GetZaxis()->SetLabelFont(42);
   Graph_Graph_ytot_vs_theta10041007->GetZaxis()->SetTitleOffset(1);
   Graph_Graph_ytot_vs_theta10041007->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_Graph_ytot_vs_theta10041007);
