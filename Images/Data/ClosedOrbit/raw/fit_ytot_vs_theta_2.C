...
//=========  (Mon Jan 18 18:41:46 2021) by ROOT version 6.22/06
   ...
   ptstats_LaTex = ptstats->AddText("p1       = 0.03433 #pm 0.01785 ");
   ptstats_LaTex = ptstats->AddText("p2       = -0.03253 #pm 0.01774 ");
   ...
   fCOD_21009->SetChisquare(17.86735);
   ...
   fCOD_21009->SetParameter(0,0.00462817);
   fCOD_21009->SetParError(0,0.001522738);
   fCOD_21009->SetParLimits(0,0,0);
   fCOD_21009->SetParameter(1,0.03432788);
   fCOD_21009->SetParError(1,0.01785121);
   fCOD_21009->SetParLimits(1,0,0);
   fCOD_21009->SetParameter(2,-0.03252832);
   fCOD_21009->SetParError(2,0.01773843);
