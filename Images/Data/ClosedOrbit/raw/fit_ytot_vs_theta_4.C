...
//=========  (Mon Jan 18 18:41:46 2021) by ROOT version 6.22/06
   ...
   ptstats_LaTex = ptstats->AddText("p1       = 0.03564 #pm 0.0179 ");
   ptstats_LaTex = ptstats->AddText("p2       = -0.03335 #pm 0.01777 ");
   ptstats_LaTex = ptstats->AddText("p3       = -0.02367 #pm 0.07721 ");
   ptstats_LaTex = ptstats->AddText("p4       = 0.03623 #pm 0.07833 ");
   ptstats_LaTex = ptstats->AddText("p5       = -0.01567 #pm 0.178 ");
   ptstats_LaTex = ptstats->AddText("p6       = -0.2108 #pm 0.1775 ");
   ...
   fCOD_41015->SetChisquare(16.14301);
   ...
   fCOD_41015->SetParameter(0,0.004458911);
   fCOD_41015->SetParError(0,0.001528501);
   fCOD_41015->SetParLimits(0,0,0);
   fCOD_41015->SetParameter(1,0.03563931);
   fCOD_41015->SetParError(1,0.01789698);
   fCOD_41015->SetParLimits(1,0,0);
   fCOD_41015->SetParameter(2,-0.0333457);
   fCOD_41015->SetParError(2,0.01776708);
   fCOD_41015->SetParLimits(2,0,0);
   fCOD_41015->SetParameter(3,-0.02367193);
   fCOD_41015->SetParError(3,0.07720523);
   fCOD_41015->SetParLimits(3,0,0);
   fCOD_41015->SetParameter(4,0.03623302);
   fCOD_41015->SetParError(4,0.07832852);
   fCOD_41015->SetParLimits(4,0,0);
   fCOD_41015->SetParameter(5,-0.01566899);
   fCOD_41015->SetParError(5,0.1779553);
   fCOD_41015->SetParLimits(5,0,0);
   fCOD_41015->SetParameter(6,-0.2108269);
   fCOD_41015->SetParError(6,0.1774585);
