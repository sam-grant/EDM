...
//=========  (Mon Jan 18 20:20:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01012->SetMinimum(-20.13592);
   Graph_Graph01012->SetMaximum(45.71064);
   ...
   mainFit1014->SetChisquare(4.973813e-07);
   ...
   mainFit1014->SetParameter(0,12.82389);
   mainFit1014->SetParError(0,1.077831);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,0.8637178);
   mainFit1014->SetParError(1,0.03592769);
