...
//=========  (Mon Mar 14 14:20:10 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01013->SetMinimum(-46.48287);
   Graph_Graph01013->SetMaximum(46.48287);
   ...
   mainFit1014->SetChisquare(1.630587e-10);
   mainFit1014->SetNDF(3);
   ...
   mainFit1014->SetParameter(0,-0.0004540327);
   mainFit1014->SetParError(0,40.8869);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,0.4362743);
   mainFit1014->SetParError(1,1.363888);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.44
#pm1
");
   pt_LaTex = pt->AddText("-0.00045
#pm4e+01
");
