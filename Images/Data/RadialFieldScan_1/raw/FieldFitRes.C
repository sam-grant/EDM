...
//=========  (Thu May  5 12:42:07 2022) by ROOT version 6.24/06
   ...
   c->Range(-45,-0.001392457,45,0.0006416889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01010->SetMinimum(-0.001189042);
   Graph_Graph01010->SetMaximum(0.0004382743);
   ...
   Graph_Graph01010->GetYaxis()->SetTitle("Fit residual [mm#upointkV]");
