...
//=========  (Thu May  5 12:42:07 2022) by ROOT version 6.24/06
   ...
   Double_t Graph0_fx1011[2] = {
   30,
   -30};
   Double_t Graph0_fy1011[2] = {
   38.73573,
   -13.08869};
   Double_t Graph0_fex1011[2] = {
   0,
   0};
   Double_t Graph0_fey1011[2] = {
   1.487694,
   1.560014};
   ...
   TH1F *Graph_Graph01011 = new TH1F("Graph_Graph01011","",100,-36,36);
   Graph_Graph01011->SetMinimum(-20.13592);
   Graph_Graph01011->SetMaximum(45.71064);
   ...
   Graph_Graph01011->GetYaxis()->SetTitle("#Delta#LTy#GT#upoint#DeltaV [mm#upointkV]");
...
");
   ...
   mainFit1013->SetChisquare(4.973813e-07);
   ...
   mainFit1013->SetParameter(0,12.82389);
   mainFit1013->SetParError(0,1.077831);
   mainFit1013->SetParLimits(0,0,0);
   mainFit1013->SetParameter(1,0.8637178);
   mainFit1013->SetParError(1,0.03592769);
