...
//=========  (Tue Feb 16 21:37:23 2021) by ROOT version 6.22/06
   ...
   c->Range(0.05124717,70.625,0.07845805,79.375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_30_ppm1001->SetMinimum(71.5);
   ...
   Graph_30_ppm1001->GetXaxis()->SetTitle("1/QHV [kV^{-1}]");
   ...
   quadLineFit1002->SetChisquare(1.297088e-14);
   ...
   quadLineFit1002->SetParameter(0,74.78747);
   quadLineFit1002->SetParError(0,0.06437843);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,35.76673);
   quadLineFit1002->SetParError(1,1.017277);
   ...
   quadLineFit1003->SetChisquare(1.297088e-14);
   ...
   quadLineFit1003->SetParameter(0,74.78747);
   quadLineFit1003->SetParError(0,0.06437843);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,35.76673);
   quadLineFit1003->SetParError(1,1.017277);
   ...
   Graph_mI30_ppm1003->SetMinimum(73.64224);
   Graph_mI30_ppm1003->SetMaximum(73.91353);
   ...
   quadLineFit1004->SetChisquare(5.40212e-16);
   ...
   quadLineFit1004->SetParameter(0,74.5884);
   quadLineFit1004->SetParError(0,0.06686792);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,-12.76624);
   quadLineFit1004->SetParError(1,1.044039);
   ...
   quadLineFit1005->SetChisquare(5.40212e-16);
   ...
   quadLineFit1005->SetParameter(0,74.5884);
   quadLineFit1005->SetParError(0,0.06686792);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,-12.76624);
   quadLineFit1005->SetParError(1,1.044039);
