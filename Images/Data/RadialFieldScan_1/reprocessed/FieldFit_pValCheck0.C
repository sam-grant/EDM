...
//=========  (Wed Jan  5 15:30:06 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01013->SetMinimum(-42.92007);
   Graph_Graph01013->SetMaximum(42.92007);
   ...
   mainFit1014->SetChisquare(5.941155e-10);
   ...
   mainFit1014->SetParameter(0,-0.0009171368);
   mainFit1014->SetParError(0,37.97589);
   mainFit1014->SetParLimits(0,0,0);
   mainFit1014->SetParameter(1,0.4255108);
   mainFit1014->SetParError(1,1.266341);
