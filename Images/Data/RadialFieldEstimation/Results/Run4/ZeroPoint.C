...
//=========  (Thu Mar 25 16:45:52 2021) by ROOT version 6.22/06
   ...
   Graph_gr1001->SetMinimum(74.45);
   Graph_gr1001->SetMaximum(75);
   ...
   Graph_gr1001->GetXaxis()->SetTitle("Sub-run");
   Graph_gr1001->GetXaxis()->SetRange(30,128);
   ...
   zeroLine1002->SetChisquare(339.9223);
   ...
   zeroLine1002->SetParameter(0,74.709);
   zeroLine1002->SetParError(0,0.0009087711);
