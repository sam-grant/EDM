...
//=========  (Fri Feb 26 09:03:23 2021) by ROOT version 6.22/06
   ...
   0.9588767,
   0.9580114};
   TGraphErrors *gre = new TGraphErrors(217,Graph0_fx1005,Graph0_fy1005,Graph0_fex1005,Graph0_fey1005);
   gre->SetName("Graph0");
   gre->SetTitle(";Sub-run;#Delta#LTB_{r}#GT [ppm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01005 = new TH1F("Graph_Graph01005","",217,15783.2,17436.8);
   Graph_Graph01005->SetMinimum(11.43567);
   Graph_Graph01005->SetMaximum(43.4503);
