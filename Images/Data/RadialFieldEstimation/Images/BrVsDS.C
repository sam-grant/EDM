...
//=========  (Mon May 10 21:42:24 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-1.775,-9.61667,15.975,30.64607);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-5.590396);
   Graph_Graph1001->SetMaximum(26.6198);
