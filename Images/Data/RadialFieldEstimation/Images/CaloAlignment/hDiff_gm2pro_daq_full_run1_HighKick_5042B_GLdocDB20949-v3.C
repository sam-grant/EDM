void hDiff_gm2pro_daq_full_run1_HighKick_5042B_GLdocDB20949-v3()
{
...
//=========  (Fri May 28 14:06:23 2021) by ROOT version 6.12/04
   ...
   hist__1->SetBinContent(3,2);
   hist__1->SetBinContent(7,2);
   ...
   hist__1->SetBinContent(13,2);
   hist__1->SetBinContent(15,1);
   hist__1->SetEntries(23);
   hist__1->SetStats(0);
   hist__1->SetFillColor(1);
   hist__1->SetFillStyle(3001);
   hist__1->GetXaxis()->SetTitle("(#LTy_{n}#GT #minus #LTy_{1}#GT)_{Run-4} #minus (#LTy_{n}#GT #minus #LTy_{1}#GT)_{Run-1c} [mm]");
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(20);
   TText *pt_LaTex = pt->AddText("-0.09
#pm0.06
");
