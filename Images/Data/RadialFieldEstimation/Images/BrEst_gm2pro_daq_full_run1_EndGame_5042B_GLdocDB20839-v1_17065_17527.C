void BrEst_gm2pro_daq_full_run1_EndGame_5042B_GLdocDB20839-v1_17065_17527()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 25 06:38:10 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(1.25,18.49197,2.75,38.84352);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle(";gm2pro_daq_full_run1_EndGame_5042B_GLdocDB20839-v1;B_{r} [ppm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,1.4,2.6);
   Graph_Graph1004->SetMinimum(20.52713);
   Graph_Graph1004->SetMaximum(36.80836);
   ...
   Graph_Graph1004->GetXaxis()->SetTitle("gm2pro_daq_full_run1_EndGame_5042B_GLdocDB20839-v1");
