void BrEst_gm2pro_daq_offline_dqc_run2D_25894_26383()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 25 06:38:44 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(1.25,2.041623,2.75,22.34987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle(";gm2pro_daq_offline_dqc_run2D;B_{r} [ppm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,1.4,2.6);
   Graph_Graph1004->SetMinimum(4.072448);
   Graph_Graph1004->SetMaximum(20.31905);
   ...
   Graph_Graph1004->GetXaxis()->SetTitle("gm2pro_daq_offline_dqc_run2D");
