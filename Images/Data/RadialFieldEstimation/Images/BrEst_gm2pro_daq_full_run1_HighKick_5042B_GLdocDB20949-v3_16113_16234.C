void BrEst_gm2pro_daq_full_run1_HighKick_5042B_GLdocDB20949-v3_16113_16234()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 25 06:38:16 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(1.25,5.073573,2.75,25.35306);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle(";gm2pro_daq_full_run1_HighKick_5042B_GLdocDB20949-v3;B_{r} [ppm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1004 = new TH1F("Graph_Graph1004","",100,1.4,2.6);
   Graph_Graph1004->SetMinimum(7.101521);
   Graph_Graph1004->SetMaximum(23.32511);
   ...
   Graph_Graph1004->GetXaxis()->SetTitle("gm2pro_daq_full_run1_HighKick_5042B_GLdocDB20949-v3");
