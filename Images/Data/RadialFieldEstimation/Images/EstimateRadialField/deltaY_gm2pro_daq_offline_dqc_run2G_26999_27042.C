...
//=========  (Fri Jan 14 06:17:42 2022) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(26988.25,0.6382621,27052.75,1.042165);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(0.6786524);
   Graph_Graph1002->SetMaximum(1.001775);
