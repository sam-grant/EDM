...
//=========  (Thu May 27 23:12:37 2021) by ROOT version 6.12/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(1.25,16.87725,2.75,17.1634);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1004->SetMinimum(16.90586);
   Graph_Graph1004->SetMaximum(17.13478);
   ...
   Graph_Graph1004->GetXaxis()->SetTitle("gm2pro_daq_full_run1_60h_5039A_GLdocDB16021-v2");
