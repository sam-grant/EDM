...
//=========  (Thu Nov 18 11:58:38 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7656,-29.7377,2726.81,414.0269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S12S18",100,115.0123,3138.801);
   Graph_Graph01041->SetMinimum(14.63877);
   Graph_Graph01041->SetMaximum(369.6504);
