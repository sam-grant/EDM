...
//=========  (Tue Nov 30 19:14:01 2021) by ROOT version 6.24/04
   ...
   c->Range(530.0919,-134186.7,2722.725,1207969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12S18",100,114.2477,3138.569);
   Graph_Graph01039->SetMinimum(28.8);
   Graph_Graph01039->SetMaximum(1073753);
