...
//=========  (Thu Nov 18 11:59:58 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8227,-0.1812148,2722.442,1.766042);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12S18",100,115.1707,3138.094);
   Graph_Graph01040->SetMinimum(0.01351094);
   Graph_Graph01040->SetMaximum(1.571317);
