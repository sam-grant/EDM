...
//=========  (Tue Nov 30 18:01:46 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8227,-508132.1,2722.442,4574179);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12S18",100,115.1707,3138.094);
   Graph_Graph01039->SetMinimum(99);
   Graph_Graph01039->SetMaximum(4065948);
