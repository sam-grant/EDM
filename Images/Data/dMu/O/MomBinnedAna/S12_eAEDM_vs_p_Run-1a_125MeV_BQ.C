...
//=========  (Thu Nov 18 11:58:16 2021) by ROOT version 6.24/04
   ...
   c->Range(530.1083,-0.4492396,2725.349,4.405412);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","S12",100,113.7696,3141.687);
   Graph_Graph01020->SetMinimum(0.03622553);
   Graph_Graph01020->SetMaximum(3.919947);
   ...
   Graph_Graph01020->GetXaxis()->SetRange(22,79);
   ...
   Graph_Graph01020->GetYaxis()->SetTitle("#deltaA_{EDM} / 125 MeV");
