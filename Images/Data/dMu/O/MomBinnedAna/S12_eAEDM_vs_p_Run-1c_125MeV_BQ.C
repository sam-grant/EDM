...
//=========  (Thu Nov 18 11:59:44 2021) by ROOT version 6.24/04
   ...
   c->Range(496.9382,-2.230065,2731.455,20.32458);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","S12",100,114.4192,3144.273);
   Graph_Graph01020->SetMinimum(0.02539901);
   Graph_Graph01020->SetMaximum(18.06911);
