...
//=========  (Thu Nov 18 11:58:38 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7656,-7.251343,2726.81,13.16833);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S12S18",100,115.0123,3138.801);
   Graph_Graph01034->SetMinimum(-5.209375);
   Graph_Graph01034->SetMaximum(11.12637);
