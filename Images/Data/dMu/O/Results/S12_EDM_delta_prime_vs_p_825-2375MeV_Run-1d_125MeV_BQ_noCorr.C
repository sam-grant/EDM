...
//=========  (Mon Nov  8 21:04:13 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1244919,2655.75,0.08366449);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1181 = new TH1F("Graph_Graph1181","S12_",100,799.5,2449.5);
   ...
   pol01182->SetParameter(0,-0.01785104);
   pol01182->SetParError(0,0.006589252);
