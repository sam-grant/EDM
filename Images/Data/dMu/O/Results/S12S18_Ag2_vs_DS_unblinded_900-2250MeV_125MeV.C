void S12S18_Ag2_vs_DS_unblinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-158.7061,4.75,401.8512);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-102.6503);
   Graph_Graph1021->SetMaximum(345.7955);
   ...
   pol01022->SetChisquare(3.038955);
   pol01022->SetNDF(3);
   ...
   pol01022->SetParameter(0,45.9351);
   pol01022->SetParError(0,38.12627);
