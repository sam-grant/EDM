void S12S18_AEDM_vs_DS_unblinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-1.133835e-19,4.75,5.209743e-20);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1066->SetMinimum(-9.683542e-20);
   Graph_Graph1066->SetMaximum(3.554934e-20);
   ...
   pol01067->SetChisquare(3.324339);
   pol01067->SetNDF(3);
   ...
   pol01067->SetParameter(0,-3.279159e-20);
   pol01067->SetParError(0,1.03935e-20);
