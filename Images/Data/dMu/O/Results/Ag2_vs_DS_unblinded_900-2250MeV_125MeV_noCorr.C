void Ag2_vs_DS_unblinded_900-2250MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-27.44268,4.75,44.49686);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10551059->SetMinimum(-20.24872);
   Graph_Graph_Graph10551059->SetMaximum(37.30291);
   ...
   fit1059->SetParameter(0,3.569217);
   fit1059->SetParError(0,3.010088);
   ...
   shift_-11060->SetParameter(0,0.5591289);
   ...
   shift_11061->SetParameter(0,6.579305);
   ...
   Graph_Graph_Graph_Graph105510591060->SetMinimum(-20.24872);
   Graph_Graph_Graph_Graph105510591060->SetMaximum(37.30291);
   ...
   Graph_Graph_Graph10561061->SetMinimum(-16.77023);
   Graph_Graph_Graph10561061->SetMaximum(28.61581);
   ...
   Graph_Graph_Graph10571062->SetMinimum(-8.547182);
   Graph_Graph_Graph10571062->SetMaximum(27.72625);
   ...
   pol01063->SetChisquare(3.315898);
   pol01063->SetNDF(3);
   ...
   pol01063->SetParameter(0,3.569217);
   pol01063->SetParError(0,3.010088);
