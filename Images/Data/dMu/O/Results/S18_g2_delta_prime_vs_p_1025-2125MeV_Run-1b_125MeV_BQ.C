...
//=========  (Tue Nov  9 13:39:33 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.380278,2312,2.31328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-1.010922);
   Graph_Graph1021->SetMaximum(1.943924);
   ...
   Graph_Graph1021->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01022->SetChisquare(2.411255);
   pol01022->SetNDF(8);
   ...
   pol01022->SetParameter(0,0.02761844);
   pol01022->SetParError(0,0.1404489);
