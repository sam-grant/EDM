void S12_g2_delta_prime_vs_p_900-2250MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:54 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-2.026377,2499.5,3.60892);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5747763,
   0.6735577};
   TGraphErrors *gre = new TGraphErrors(11,_fx1103,_fy1103,_fex1103,_fey1103);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1103 = new TH1F("Graph_Graph1103","S12_",100,812,2312);
   ...
   pol01104->SetParameter(0,0.2421557);
   pol01104->SetParError(0,0.1504589);
