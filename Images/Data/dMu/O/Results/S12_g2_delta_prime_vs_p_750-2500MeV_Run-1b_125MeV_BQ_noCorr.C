...
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.2095861,2843.25,0.168515);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1067->SetMinimum(-0.171776);
   Graph_Graph1067->SetMaximum(0.1307049);
   ...
   Graph_Graph1067->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01068->SetChisquare(13.98227);
   pol01068->SetNDF(13);
   ...
   pol01068->SetParameter(0,-0.00541853);
   pol01068->SetParError(0,0.009285889);
