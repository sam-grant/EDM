void S12S18_Ag2_vs_DS_unblinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-180.4282,4.75,392.0844);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-123.1769);
   Graph_Graph1021->SetMaximum(334.8332);
   ...
   pol01022->SetChisquare(1.738099);
   pol01022->SetNDF(3);
   ...
   pol01022->SetParameter(0,53.38855);
   pol01022->SetParError(0,39.99716);
