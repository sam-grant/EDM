...
//=========  (Tue Nov  9 13:39:29 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-2.588095,2312,1.987763);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-2.130509);
   Graph_Graph1001->SetMaximum(1.530177);
   ...
   Graph_Graph1001->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01002->SetChisquare(10.10451);
   pol01002->SetNDF(8);
   ...
   pol01002->SetParameter(0,-0.4055449);
   pol01002->SetParError(0,0.177914);
