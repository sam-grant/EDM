void S12_EDM_delta_prime_vs_p_900-2250MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.1405787,2499.5,0.1499479);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03050803,
   0.03102217};
   TGraphErrors *gre = new TGraphErrors(11,_fx1169,_fy1169,_fex1169,_fey1169);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1169 = new TH1F("Graph_Graph1169","S12_",100,812,2312);
   ...
   pol01170->SetParameter(0,-0.005707172);
   pol01170->SetParError(0,0.009379443);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0057
#pm0.009
 mrad","lpf");
