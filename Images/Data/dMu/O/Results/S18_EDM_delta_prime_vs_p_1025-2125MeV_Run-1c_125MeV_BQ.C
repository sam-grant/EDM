...
//=========  (Tue Nov  9 13:39:34 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.498216,2312,1.732651);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1027->SetMinimum(-1.175129);
   Graph_Graph1027->SetMaximum(1.409564);
   ...
   Graph_Graph1027->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01028->SetChisquare(4.314239);
   pol01028->SetNDF(8);
   ...
   pol01028->SetParameter(0,-0.1458027);
   pol01028->SetParError(0,0.1305889);
