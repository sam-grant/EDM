...
//=========  (Thu Nov 18 12:00:15 2021) by ROOT version 6.24/04
   ...
   c->Range(411.6611,-3.204552,2837.301,2.576579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12_",100,654.2251,2594.737);
   Graph_Graph1019->SetMinimum(-2.626439);
   Graph_Graph1019->SetMaximum(1.998466);
   ...
   pol01020->SetChisquare(14.13822);
   pol01020->SetNDF(13);
   ...
   pol01020->SetParameter(0,-0.05354551);
   pol01020->SetParError(0,0.1246414);
