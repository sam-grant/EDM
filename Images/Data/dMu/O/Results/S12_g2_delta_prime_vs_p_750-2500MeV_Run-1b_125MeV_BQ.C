...
//=========  (Tue Nov  9 13:49:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-3.201405,2843.25,2.574049);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-2.62386);
   Graph_Graph1019->SetMaximum(1.996504);
   ...
   Graph_Graph1019->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01020->SetChisquare(14.13516);
   pol01020->SetNDF(13);
   ...
   pol01020->SetParameter(0,-0.05384735);
   pol01020->SetParError(0,0.1243174);
