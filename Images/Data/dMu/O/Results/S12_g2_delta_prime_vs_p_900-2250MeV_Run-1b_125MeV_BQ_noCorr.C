...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.1578076,2499.5,0.1517816);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03293368,
   0.03330977};
   TGraphErrors *gre = new TGraphErrors(11,_fx1163,_fy1163,_fex1163,_fey1163);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1163 = new TH1F("Graph_Graph1163","S12_",100,812,2312);
   ...
   pol01164->SetParameter(0,-0.005035344);
   pol01164->SetParError(0,0.01014225);
