void S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.415915,2312,1.456253);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3771789,
   0.4411419};
   TGraphErrors *gre = new TGraphErrors(9,_fx1033,_fy1033,_fex1033,_fey1033);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1033 = new TH1F("Graph_Graph1033","S18_",100,962,2162);
   Graph_Graph1033->SetMinimum(-1.128698);
   Graph_Graph1033->SetMaximum(1.169036);
   ...
   Graph_Graph1033->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01034->SetParameter(0,-0.03180902);
   pol01034->SetParError(0,0.1161698);
