...
//=========  (Tue Nov  9 13:49:14 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.1112988,2843.25,0.2174311);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1065->SetMinimum(-0.07842584);
   Graph_Graph1065->SetMaximum(0.1845581);
   ...
   Graph_Graph1065->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01066->SetChisquare(10.06278);
   pol01066->SetNDF(13);
   ...
   pol01066->SetParameter(0,0.0018277);
   pol01066->SetParError(0,0.007554835);
