void S12S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.413756,2312,1.174755);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2563667,
   0.298488};
   TGraphErrors *gre = new TGraphErrors(9,_fx1035,_fy1035,_fex1035,_fey1035);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1035 = new TH1F("Graph_Graph1035","S12S18_",100,962,2162);
   Graph_Graph1035->SetMinimum(-1.154905);
   Graph_Graph1035->SetMaximum(0.9159042);
   ...
   Graph_Graph1035->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01036->SetParameter(0,0.07078193);
   pol01036->SetParError(0,0.08020538);
