...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.2535867,2499.5,0.1852451);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03694479,
   0.03751123};
   TGraphErrors *gre = new TGraphErrors(11,_fx1157,_fy1157,_fex1157,_fey1157);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1157 = new TH1F("Graph_Graph1157","S12_",100,812,2312);
   ...
   pol01158->SetParameter(0,0.004474054);
   pol01158->SetParError(0,0.01140774);
