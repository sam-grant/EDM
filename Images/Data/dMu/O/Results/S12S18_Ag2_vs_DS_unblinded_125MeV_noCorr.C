void S12S18_Ag2_vs_DS_unblinded_125MeV_noCorr()
{
...
//=========  (Mon Nov  8 20:41:14 2021) by ROOT version 6.24/04
   ...
   Graph_Graph1057->SetMinimum(-9.394198);
   Graph_Graph1057->SetMaximum(23.6148);
   ...
   pol01058->SetChisquare(2.701904);
   pol01058->SetNDF(3);
   ...
   pol01058->SetParameter(0,2.529851);
   pol01058->SetParError(0,2.764132);
