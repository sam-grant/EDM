...
//=========  (Mon Nov  8 21:04:07 2021) by ROOT version 6.24/04
   ...
   TH1D *h__45 = new TH1D("h__45","S12S18_",20,-0.3803458,0.03599659);
   h__45->SetBinContent(9,47);
   h__45->SetBinContent(10,686);
   h__45->SetBinContent(11,266);
