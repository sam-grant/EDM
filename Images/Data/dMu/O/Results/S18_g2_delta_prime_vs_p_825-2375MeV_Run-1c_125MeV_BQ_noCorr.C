...
//=========  (Mon Nov  8 21:04:13 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1536634,2655.75,0.1042715);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03013722,
   0.03162236};
   TGraphErrors *gre = new TGraphErrors(12,_fx1177,_fy1177,_fex1177,_fey1177);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1177 = new TH1F("Graph_Graph1177","S18_",100,799.5,2449.5);
   ...
   pol01178->SetParameter(0,-0.003008528);
   pol01178->SetParError(0,0.008456009);
