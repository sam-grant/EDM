void S18_EDM_delta_prime_hist_1000_1025-2125MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:29 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18_",22,-0.5193865,-0.07088859);
   h__2->SetBinContent(8,22);
   h__2->SetBinContent(9,111);
   h__2->SetBinContent(10,350);
   h__2->SetBinContent(11,398);
   h__2->SetBinContent(12,112);
   h__2->SetBinContent(13,7);
   h__2->SetEntries(1000);
   h__2->SetStats(0);
   h__2->SetLineWidth(3);
   h__2->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
