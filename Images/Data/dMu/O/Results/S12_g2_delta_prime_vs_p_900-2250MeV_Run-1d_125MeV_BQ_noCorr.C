...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.09657262,2499.5,0.1024379);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01986792,
   0.0201423};
   TGraphErrors *gre = new TGraphErrors(11,_fx1187,_fy1187,_fex1187,_fey1187);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1187 = new TH1F("Graph_Graph1187","S12_",100,812,2312);
   ...
   pol01188->SetParameter(0,0.001326686);
   pol01188->SetParError(0,0.006093245);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0013
#pm0.006
 mrad","lpf");
