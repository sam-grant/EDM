void S12S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.06542659,2312,0.08930968);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01402005,
   0.01469114};
   TGraphErrors *gre = new TGraphErrors(9,_fx1095,_fy1095,_fex1095,_fey1095);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1095 = new TH1F("Graph_Graph1095","S12S18_",100,962,2162);
   Graph_Graph1095->SetMinimum(-0.04995296);
   Graph_Graph1095->SetMaximum(0.07383605);
   ...
   Graph_Graph1095->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01096->SetParameter(0,0.002786399);
   pol01096->SetParError(0,0.004788787);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0028
#pm0.005
 mrad","lpf");
