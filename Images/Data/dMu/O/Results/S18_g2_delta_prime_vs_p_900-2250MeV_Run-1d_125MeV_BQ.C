...
//=========  (Mon Nov  8 21:08:20 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-2.037109,2499.5,1.641079);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3261792,
   0.385336};
   TGraphErrors *gre = new TGraphErrors(11,_fx1141,_fy1141,_fex1141,_fey1141);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1141 = new TH1F("Graph_Graph1141","S18_",100,812,2312);
   ...
   pol01142->SetParameter(0,-0.036141);
   pol01142->SetParError(0,0.08168507);
