...
//=========  (Mon Nov  8 21:08:18 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.309054,2499.5,1.303385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2969998,
   0.3485264};
   TGraphErrors *gre = new TGraphErrors(11,_fx1139,_fy1139,_fex1139,_fey1139);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1139 = new TH1F("Graph_Graph1139","S12_",100,812,2312);
   ...
   pol01140->SetParameter(0,0.02196306);
   pol01140->SetParError(0,0.07713191);
