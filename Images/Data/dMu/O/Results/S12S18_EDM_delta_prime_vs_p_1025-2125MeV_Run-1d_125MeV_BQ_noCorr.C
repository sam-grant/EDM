void S12S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.09358691,2312,0.03780593);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01575548,
   0.01652578};
   TGraphErrors *gre = new TGraphErrors(9,_fx1089,_fy1089,_fex1089,_fey1089);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1089 = new TH1F("Graph_Graph1089","S12S18_",100,962,2162);
   Graph_Graph1089->SetMinimum(-0.08044763);
   Graph_Graph1089->SetMaximum(0.02466665);
   ...
   Graph_Graph1089->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01090->SetParameter(0,-0.01436683);
   pol01090->SetParError(0,0.005389088);
