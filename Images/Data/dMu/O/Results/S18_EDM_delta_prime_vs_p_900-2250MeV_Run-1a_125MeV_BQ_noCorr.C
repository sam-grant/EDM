...
//=========  (Mon Nov  8 21:08:23 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.2447428,2499.5,0.1946991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04671563,
   0.0476395};
   TGraphErrors *gre = new TGraphErrors(11,_fx1147,_fy1147,_fex1147,_fey1147);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1147 = new TH1F("Graph_Graph1147","S18_",100,812,2312);
   Graph_Graph1147->SetMinimum(-0.2007987);
   Graph_Graph1147->SetMaximum(0.1507549);
   ...
   pol01148->SetParameter(0,-0.02196742);
   pol01148->SetParError(0,0.01392325);
