...
//=========  (Mon Nov  8 21:07:53 2021) by ROOT version 6.24/04
   ...
   TH1D *h__26 = new TH1D("h__26","S18_",22,-0.5167389,-0.06362258);
   h__26->SetBinContent(8,16);
   h__26->SetBinContent(9,95);
   h__26->SetBinContent(10,333);
   h__26->SetBinContent(11,421);
   h__26->SetBinContent(12,127);
   h__26->SetBinContent(13,8);
