...
//=========  (Mon Nov  8 21:03:48 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-1.50409,2655.75,2.025817);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4934461,
   0.6391677};
   TGraphErrors *gre = new TGraphErrors(12,_fx1107,_fy1107,_fex1107,_fey1107);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1107 = new TH1F("Graph_Graph1107","S12S18_",100,799.5,2449.5);
   ...
   pol01108->SetParameter(0,0.1993444);
   pol01108->SetParError(0,0.1069001);
