void S18_Ag2_vs_DS_unblinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-276.3019,4.75,426.6516);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1020->SetMinimum(-206.0066);
   Graph_Graph1020->SetMaximum(356.3562);
