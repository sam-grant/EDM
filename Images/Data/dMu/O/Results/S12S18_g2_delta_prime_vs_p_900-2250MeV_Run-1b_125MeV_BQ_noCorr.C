void S12S18_g2_delta_prime_vs_p_900-2250MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.07869852,2499.5,0.1487569);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0241903,
   0.02449871};
   TGraphErrors *gre = new TGraphErrors(11,_fx1167,_fy1167,_fex1167,_fey1167);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1167 = new TH1F("Graph_Graph1167","S12S18_",100,812,2312);
   ...
   pol01168->SetParameter(0,0.001806185);
   pol01168->SetParError(0,0.007330581);
