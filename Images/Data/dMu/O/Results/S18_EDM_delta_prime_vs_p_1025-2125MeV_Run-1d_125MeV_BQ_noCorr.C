void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.08794572,2312,0.1016645);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02328545,
   0.0244794};
   TGraphErrors *gre = new TGraphErrors(9,_fx1087,_fy1087,_fex1087,_fey1087);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1087 = new TH1F("Graph_Graph1087","S18_",100,962,2162);
   Graph_Graph1087->SetMinimum(-0.06898469);
   Graph_Graph1087->SetMaximum(0.0827035);
   ...
   Graph_Graph1087->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01088->SetParameter(0,-0.003354247);
   pol01088->SetParError(0,0.007847901);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0034
#pm0.008
 mrad","lpf");
