...
//=========  (Tue Nov  9 13:39:30 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-2.805735,2312,2.201617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-2.304999);
   Graph_Graph1009->SetMaximum(1.700882);
   ...
   Graph_Graph1009->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01010->SetChisquare(8.867402);
   pol01010->SetNDF(8);
   ...
   pol01010->SetParameter(0,0.1751816);
   pol01010->SetParError(0,0.1641406);
