void Ag2_vs_DS_unblinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-325.7754,4.75,557.2384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10191023->SetMinimum(-237.474);
   Graph_Graph_Graph10191023->SetMaximum(468.937);
   ...
   fit1023->SetParameter(0,45.9351);
   fit1023->SetParError(0,38.12627);
   ...
   shift_-11024->SetParameter(0,7.80883);
   ...
   shift_11025->SetParameter(0,84.06138);
   ...
   Graph_Graph_Graph_Graph101910231024->SetMinimum(-237.474);
   Graph_Graph_Graph_Graph101910231024->SetMaximum(468.937);
   ...
   Graph_Graph_Graph10201025->SetMinimum(-206.0066);
   Graph_Graph_Graph10201025->SetMaximum(356.3562);
   ...
   Graph_Graph_Graph10211026->SetMinimum(-102.6503);
   Graph_Graph_Graph10211026->SetMaximum(345.7955);
   ...
   pol01027->SetChisquare(3.038955);
   pol01027->SetNDF(3);
   ...
   pol01027->SetParameter(0,45.9351);
   pol01027->SetParError(0,38.12627);
