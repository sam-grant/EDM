void S12_EDM_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.954874,2312,0.6246074);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2879199,
   0.334832};
   TGraphErrors *gre = new TGraphErrors(9,_fx1037,_fy1037,_fex1037,_fey1037);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1037 = new TH1F("Graph_Graph1037","S12_",100,962,2162);
   Graph_Graph1037->SetMinimum(-1.696926);
   Graph_Graph1037->SetMaximum(0.3666593);
   ...
   Graph_Graph1037->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01038->SetParameter(0,-0.2957562);
   pol01038->SetParError(0,0.09121993);
