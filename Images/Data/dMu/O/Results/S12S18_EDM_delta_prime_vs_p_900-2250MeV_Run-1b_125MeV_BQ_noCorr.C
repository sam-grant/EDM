...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.1603801,2499.5,0.1188813);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02712786,
   0.02755635};
   TGraphErrors *gre = new TGraphErrors(11,_fx1161,_fy1161,_fex1161,_fey1161);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1161 = new TH1F("Graph_Graph1161","S12S18_",100,812,2312);
   ...
   pol01162->SetParameter(0,0.0004128226);
   pol01162->SetParError(0,0.008237122);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00041
#pm0.008
 mrad","lpf");
