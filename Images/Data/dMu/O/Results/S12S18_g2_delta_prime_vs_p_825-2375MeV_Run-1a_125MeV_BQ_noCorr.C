void S12S18_g2_delta_prime_vs_p_825-2375MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:04:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.11688,2655.75,0.1489933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02851761,
   0.03004673};
   TGraphErrors *gre = new TGraphErrors(12,_fx1155,_fy1155,_fex1155,_fey1155);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1155 = new TH1F("Graph_Graph1155","S12S18_",100,799.5,2449.5);
   ...
   pol01156->SetParameter(0,0.01559739);
   pol01156->SetParError(0,0.008242466);
