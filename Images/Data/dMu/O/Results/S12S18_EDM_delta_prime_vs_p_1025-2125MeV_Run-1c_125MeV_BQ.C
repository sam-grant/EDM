void S12S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:34 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.156587,2312,1.739405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2882137,
   0.3350372};
   TGraphErrors *gre = new TGraphErrors(9,_fx1029,_fy1029,_fex1029,_fey1029);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18_",100,962,2162);
   Graph_Graph1029->SetMinimum(-0.866988);
   Graph_Graph1029->SetMaximum(1.449806);
   ...
   Graph_Graph1029->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01030->SetParameter(0,-0.09679317);
   pol01030->SetParError(0,0.09017555);
