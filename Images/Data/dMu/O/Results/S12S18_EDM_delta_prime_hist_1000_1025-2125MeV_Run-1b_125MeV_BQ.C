...
//=========  (Tue Nov  9 13:39:32 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","S12S18_",20,-0.1768736,0.2279596);
   h__9->SetBinContent(10,21);
   h__9->SetBinContent(11,979);
   h__9->SetEntries(1000);
   h__9->SetStats(0);
   h__9->SetLineWidth(3);
   h__9->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
