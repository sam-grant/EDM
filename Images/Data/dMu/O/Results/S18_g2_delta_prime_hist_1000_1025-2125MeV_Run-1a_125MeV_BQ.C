void S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:30 2021) by ROOT version 6.24/04
   ...
   TH1D *h__5 = new TH1D("h__5","S18_",20,-0.03471152,0.3824755);
   h__5->SetBinContent(9,5);
   h__5->SetBinContent(10,438);
   h__5->SetBinContent(11,527);
   h__5->SetBinContent(12,30);
   h__5->SetEntries(1000);
   h__5->SetStats(0);
   h__5->SetLineWidth(3);
   h__5->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
