void S12_EDM_delta_prime_vs_p_750-2500MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:49:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.1824651,2843.25,0.305167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03899965,
   0.04189929};
   TGraphErrors *gre = new TGraphErrors(14,_fx1061,_fy1061,_fex1061,_fey1061);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1061 = new TH1F("Graph_Graph1061","S12_",100,649.5,2599.5);
   Graph_Graph1061->SetMinimum(-0.1337019);
   Graph_Graph1061->SetMaximum(0.2564037);
   ...
   Graph_Graph1061->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01062->SetChisquare(15.92446);
   pol01062->SetNDF(13);
   ...
   pol01062->SetParameter(0,0.005608435);
   pol01062->SetParError(0,0.01044119);
