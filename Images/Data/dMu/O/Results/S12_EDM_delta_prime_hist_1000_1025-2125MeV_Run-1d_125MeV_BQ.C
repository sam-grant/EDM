...
//=========  (Tue Nov  9 13:39:37 2021) by ROOT version 6.24/04
   ...
   TH1D *h__19 = new TH1D("h__19","S12_",21,-0.4991586,-0.07145201);
   h__19->SetBinContent(8,8);
   h__19->SetBinContent(9,77);
   h__19->SetBinContent(10,406);
   h__19->SetBinContent(11,441);
   h__19->SetBinContent(12,66);
   h__19->SetBinContent(13,2);
   h__19->SetEntries(1000);
   h__19->SetStats(0);
   h__19->SetLineWidth(3);
   h__19->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
