void S12_g2_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-2.216386,2312,1.649831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.349463,
   0.4053351};
   TGraphErrors *gre = new TGraphErrors(9,_fx1031,_fy1031,_fex1031,_fey1031);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","S12_",100,962,2162);
   Graph_Graph1031->SetMinimum(-1.829764);
   Graph_Graph1031->SetMaximum(1.263209);
   ...
   Graph_Graph1031->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01032->SetParameter(0,0.1634641);
   pol01032->SetParError(0,0.1108607);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.16
#pm0.1
 mrad","lpf");
