void S12_g2_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.94422,2312,2.869504);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4954599,
   0.5747763};
   TGraphErrors *gre = new TGraphErrors(9,_fx1007,_fy1007,_fex1007,_fey1007);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12_",100,962,2162);
   Graph_Graph1007->SetMinimum(-1.462847);
   Graph_Graph1007->SetMaximum(2.388132);
   ...
   Graph_Graph1007->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01008->SetParameter(0,0.1879516);
   pol01008->SetParError(0,0.1580039);
