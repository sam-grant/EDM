void S12S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:33 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18_",20,-0.1927545,0.2113488);
   h__12->SetBinContent(10,56);
   h__12->SetBinContent(11,944);
   h__12->SetEntries(1000);
   h__12->SetStats(0);
   h__12->SetLineWidth(3);
   h__12->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
