...
//=========  (Mon Nov  8 21:04:04 2021) by ROOT version 6.24/04
   ...
   TH1D *h__43 = new TH1D("h__43","S12_",22,-0.4627697,-0.02259694);
   h__43->SetBinContent(9,11);
   h__43->SetBinContent(10,151);
   h__43->SetBinContent(11,567);
   h__43->SetBinContent(12,263);
   h__43->SetBinContent(13,8);
