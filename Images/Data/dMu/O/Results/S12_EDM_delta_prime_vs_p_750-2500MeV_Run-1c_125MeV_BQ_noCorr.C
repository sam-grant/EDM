void S12_EDM_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.1271602,2843.25,0.2368404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03234425,
   0.03483337};
   TGraphErrors *gre = new TGraphErrors(14,_fx1073,_fy1073,_fex1073,_fey1073);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1073 = new TH1F("Graph_Graph1073","S12_",100,649.5,2599.5);
   Graph_Graph1073->SetMinimum(-0.09076014);
   Graph_Graph1073->SetMaximum(0.2004404);
   ...
   Graph_Graph1073->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01074->SetChisquare(16.20194);
   pol01074->SetNDF(13);
   ...
   pol01074->SetParameter(0,-0.00255282);
   pol01074->SetParError(0,0.008595793);
