void S12_EDM_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.2070215,2312,0.1576568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04162108,
   0.04336358};
   TGraphErrors *gre = new TGraphErrors(9,_fx1049,_fy1049,_fex1049,_fey1049);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1049 = new TH1F("Graph_Graph1049","S12_",100,962,2162);
   Graph_Graph1049->SetMinimum(-0.1705536);
   Graph_Graph1049->SetMaximum(0.1211889);
   ...
   Graph_Graph1049->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01050->SetParameter(0,-0.03288341);
   pol01050->SetParError(0,0.01445132);
