...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.1106311,2499.5,0.09375999);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01996747,
   0.02030326};
   TGraphErrors *gre = new TGraphErrors(11,_fx1179,_fy1179,_fex1179,_fey1179);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1179 = new TH1F("Graph_Graph1179","S12S18_",100,812,2312);
   ...
   pol01180->SetParameter(0,0.006333402);
   pol01180->SetParError(0,0.006044533);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0063
#pm0.006
 mrad","lpf");
