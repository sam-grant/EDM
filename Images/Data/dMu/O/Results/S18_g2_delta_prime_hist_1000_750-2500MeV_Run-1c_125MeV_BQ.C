void S18_g2_delta_prime_hist_1000_750-2500MeV_Run-1c_125MeV_BQ()
{
...
//=========  (Thu Nov 18 12:00:19 2021) by ROOT version 6.24/04
   ...
   TH1D *h__17 = new TH1D("h__17","S18_",20,-0.2366732,0.1661874);
   h__17->SetBinContent(8,1);
   h__17->SetBinContent(9,210);
   h__17->SetBinContent(10,772);
   h__17->SetBinContent(11,17);
   h__17->SetEntries(1000);
   h__17->SetStats(0);
   h__17->SetLineWidth(3);
   h__17->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
