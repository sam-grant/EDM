void S12S18_g2_delta_prime_hist_1000_825-2375MeV_Run-1c_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:04:03 2021) by ROOT version 6.24/04
   ...
   TH1D *h__42 = new TH1D("h__42","S12S18_",20,-0.1185228,0.293901);
   h__42->SetBinContent(9,22);
   h__42->SetBinContent(10,780);
   h__42->SetBinContent(11,198);
   ...
   h__42->GetYaxis()->SetTitle("Trials  / 0.02 [mrad]");
