void S12S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:31 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",20,-0.03565718,0.3821692);
   h__6->SetBinContent(9,1);
   h__6->SetBinContent(10,147);
   h__6->SetBinContent(11,754);
   h__6->SetBinContent(12,97);
   h__6->SetBinContent(13,1);
   h__6->SetEntries(1000);
   h__6->SetStats(0);
   h__6->SetLineWidth(3);
   h__6->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
