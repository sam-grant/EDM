void S18_g2_delta_prime_vs_p_900-2250MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-3.087311,2499.5,2.232903);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.6191658,
   0.7247868};
   TGraphErrors *gre = new TGraphErrors(11,_fx1105,_fy1105,_fex1105,_fey1105);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1105 = new TH1F("Graph_Graph1105","S18_",100,812,2312);
   Graph_Graph1105->SetMinimum(-2.55529);
   Graph_Graph1105->SetMaximum(1.700882);
   ...
   Graph_Graph1105->GetYaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad] / 125 MeV");
   ...
   pol01106->SetParameter(0,0.1528028);
   pol01106->SetParError(0,0.1563635);
