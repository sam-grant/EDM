void S12S18_g2_delta_prime_vs_p_900-2250MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:02 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.9902247,2499.5,2.023468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3616139,
   0.4239063};
   TGraphErrors *gre = new TGraphErrors(11,_fx1119,_fy1119,_fex1119,_fey1119);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1119 = new TH1F("Graph_Graph1119","S12S18_",100,812,2312);
   Graph_Graph1119->SetMinimum(-0.6888554);
   ...
   pol01120->SetParameter(0,0.02750616);
   pol01120->SetParError(0,0.09268698);
