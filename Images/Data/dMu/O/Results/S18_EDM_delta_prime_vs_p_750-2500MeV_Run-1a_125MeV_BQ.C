...
//=========  (Thu Nov 18 12:00:12 2021) by ROOT version 6.24/04
   ...
   c->Range(411.1592,-2.408947,2837.932,5.70131);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18_",100,653.8365,2595.255);
   Graph_Graph1003->SetMinimum(-1.597921);
   Graph_Graph1003->SetMaximum(4.890284);
   ...
   pol01004->SetChisquare(26.43508);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,-0.1705878);
   pol01004->SetParError(0,0.170688);
