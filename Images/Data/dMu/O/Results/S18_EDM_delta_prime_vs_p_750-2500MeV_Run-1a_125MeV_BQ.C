...
//=========  (Tue Nov  9 13:48:58 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-2.408399,2843.25,5.694101);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.598149);
   Graph_Graph1003->SetMaximum(4.883851);
   ...
   Graph_Graph1003->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01004->SetChisquare(26.46423);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,-0.1676745);
   pol01004->SetParError(0,0.1702755);
