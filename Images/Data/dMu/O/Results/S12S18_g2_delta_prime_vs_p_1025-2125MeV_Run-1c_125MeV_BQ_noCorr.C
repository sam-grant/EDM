void S12S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1120662,2312,0.09391945);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01905169,
   0.01996747};
   TGraphErrors *gre = new TGraphErrors(9,_fx1083,_fy1083,_fex1083,_fey1083);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1083 = new TH1F("Graph_Graph1083","S12S18_",100,962,2162);
   Graph_Graph1083->SetMinimum(-0.09146768);
   Graph_Graph1083->SetMaximum(0.07332088);
   ...
   Graph_Graph1083->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01084->SetParameter(0,0.005341455);
   pol01084->SetParError(0,0.006523267);
