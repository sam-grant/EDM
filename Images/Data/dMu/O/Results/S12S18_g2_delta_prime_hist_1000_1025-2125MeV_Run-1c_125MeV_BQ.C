void S12S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1c_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:36 2021) by ROOT version 6.24/04
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18_",20,-0.1310223,0.2819036);
   h__18->SetBinContent(10,821);
   h__18->SetBinContent(11,179);
   h__18->SetEntries(1000);
   h__18->SetStats(0);
   h__18->SetLineWidth(3);
   h__18->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
