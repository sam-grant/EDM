...
//=========  (Tue Nov  9 13:39:38 2021) by ROOT version 6.24/04
   ...
   TH1D *h__20 = new TH1D("h__20","S18_",20,-0.2374971,0.1683827);
   h__20->SetBinContent(10,160);
   h__20->SetBinContent(11,839);
   h__20->SetBinContent(12,1);
   h__20->SetEntries(1000);
   h__20->SetStats(0);
   h__20->SetLineWidth(3);
   h__20->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
