void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:29 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-2.484381,2312,2.368474);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5920717,
   0.6983386};
   TGraphErrors *gre = new TGraphErrors(9,_fx1003,_fy1003,_fex1003,_fey1003);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18_",100,962,2162);
   Graph_Graph1003->SetMinimum(-1.999096);
   Graph_Graph1003->SetMaximum(1.883188);
   ...
   Graph_Graph1003->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01004->SetParameter(0,-0.3155114);
   pol01004->SetParError(0,0.1843925);
