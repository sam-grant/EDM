void S12S18_g2_delta_prime_hist_1000_825-2375MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:03:49 2021) by ROOT version 6.24/04
   ...
   TH1D *h__30 = new TH1D("h__30","S12S18_",21,-0.01919723,0.4016235);
   h__30->SetBinContent(10,22);
   h__30->SetBinContent(11,596);
   h__30->SetBinContent(12,363);
   h__30->SetBinContent(13,19);
   ...
   h__30->GetYaxis()->SetTitle("Trials  / 0.02 [mrad]");
