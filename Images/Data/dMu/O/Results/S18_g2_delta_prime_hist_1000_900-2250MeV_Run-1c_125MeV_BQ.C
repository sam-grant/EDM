...
//=========  (Mon Nov  8 21:08:11 2021) by ROOT version 6.24/04
   ...
   TH1D *h__41 = new TH1D("h__41","S18_",20,-0.2406869,0.1628412);
   h__41->SetBinContent(9,17);
   h__41->SetBinContent(10,966);
   h__41->SetBinContent(11,17);
