...
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.08122607,2843.25,0.07954462);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1095->SetMinimum(-0.065149);
   Graph_Graph1095->SetMaximum(0.06346755);
   ...
   Graph_Graph1095->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01096->SetChisquare(17.24491);
   pol01096->SetNDF(13);
   ...
   pol01096->SetParameter(0,-0.0006679506);
   pol01096->SetParError(0,0.004076496);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00067
#pm0.004
 mrad","lpf");
