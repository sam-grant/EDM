...
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.1562153,2843.25,0.2221046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1069->SetMinimum(-0.1183833);
   Graph_Graph1069->SetMaximum(0.1842726);
   ...
   Graph_Graph1069->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01070->SetChisquare(7.068759);
   pol01070->SetNDF(13);
   ...
   pol01070->SetParameter(0,0.006118636);
   pol01070->SetParError(0,0.009753346);
