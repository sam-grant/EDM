void S12_EDM_delta_prime_vs_p_1025-2125MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.668608,2312,2.206141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4777774,
   0.5522771};
   TGraphErrors *gre = new TGraphErrors(9,_fx1013,_fy1013,_fex1013,_fey1013);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","S12_",100,962,2162);
   Graph_Graph1013->SetMinimum(-1.281133);
   Graph_Graph1013->SetMaximum(1.818666);
   ...
   Graph_Graph1013->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01014->SetParameter(0,0.08985006);
   pol01014->SetParError(0,0.151725);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.09
#pm0.2
 mrad","lpf");
