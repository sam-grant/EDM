...
//=========  (Thu Nov 18 12:00:22 2021) by ROOT version 6.24/04
   ...
   TH1D *h__22 = new TH1D("h__22","S12_",20,-0.183505,0.2202701);
   h__22->SetBinContent(10,18);
   h__22->SetBinContent(11,890);
   h__22->SetBinContent(12,92);
