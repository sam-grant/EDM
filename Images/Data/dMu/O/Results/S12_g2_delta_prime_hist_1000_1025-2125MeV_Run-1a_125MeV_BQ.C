void S12_g2_delta_prime_hist_1000_1025-2125MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:30 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",21,-0.04173888,0.3807174);
   h__4->SetBinContent(10,7);
   h__4->SetBinContent(11,230);
   h__4->SetBinContent(12,611);
   h__4->SetBinContent(13,145);
   h__4->SetBinContent(14,7);
   h__4->SetEntries(1000);
   h__4->SetStats(0);
   h__4->SetLineWidth(3);
   h__4->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
