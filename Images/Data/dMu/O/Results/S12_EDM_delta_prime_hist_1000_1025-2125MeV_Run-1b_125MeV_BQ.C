void S12_EDM_delta_prime_hist_1000_1025-2125MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:31 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12_",20,-0.1228871,0.2840642);
   h__7->SetBinContent(10,36);
   h__7->SetBinContent(11,918);
   h__7->SetBinContent(12,46);
   h__7->SetEntries(1000);
   h__7->SetStats(0);
   h__7->SetLineWidth(3);
   h__7->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.08996
#pm0.0002
");
   pt_LaTex = pt->AddText("0.0057
#pm0.0001
");
   pt->Draw();
   c->Modified();
