void S12_g2_delta_prime_vs_p_900-2250MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:08 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.926929,2499.5,2.002879);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4053351,
   0.4753016};
   TGraphErrors *gre = new TGraphErrors(11,_fx1127,_fy1127,_fex1127,_fey1127);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1127 = new TH1F("Graph_Graph1127","S12_",100,812,2312);
   Graph_Graph1127->SetMinimum(-1.533948);
   Graph_Graph1127->SetMaximum(1.609899);
   ...
   Graph_Graph1127->GetYaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad] / 125 MeV");
   ...
   pol01128->SetParameter(0,0.1919415);
   pol01128->SetParError(0,0.1055728);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.19
#pm0.1
 mrad","lpf");
