...
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1121394,2312,0.1153342);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1081->SetMinimum(-0.08939208);
   Graph_Graph1081->SetMaximum(0.09258686);
   ...
   Graph_Graph1081->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01082->SetParameter(0,-0.002857213);
   pol01082->SetParError(0,0.009460211);
