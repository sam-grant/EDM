...
//=========  (Mon Nov  8 21:04:12 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.09011276,2655.75,0.1169649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02279987,
   0.02388733};
   TGraphErrors *gre = new TGraphErrors(12,_fx1173,_fy1173,_fex1173,_fey1173);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1173 = new TH1F("Graph_Graph1173","S12S18_",100,799.5,2449.5);
   ...
   pol01174->SetParameter(0,-0.006105734);
   pol01174->SetParError(0,0.006535963);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0061
#pm0.007
 mrad","lpf");
