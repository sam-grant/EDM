...
//=========  (Tue Nov  9 13:39:38 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.181663,2312,0.4773519);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1041->SetMinimum(-1.015762);
   Graph_Graph1041->SetMaximum(0.3114503);
   ...
   Graph_Graph1041->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01042->SetChisquare(4.556979);
   pol01042->SetNDF(8);
   ...
   pol01042->SetParameter(0,-0.1703062);
   pol01042->SetParError(0,0.06624978);
