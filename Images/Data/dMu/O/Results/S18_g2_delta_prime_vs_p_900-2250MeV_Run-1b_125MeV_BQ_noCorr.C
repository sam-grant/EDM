void S18_g2_delta_prime_vs_p_900-2250MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.1018071,2499.5,0.2400038);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03563801,
   0.03615037};
   TGraphErrors *gre = new TGraphErrors(11,_fx1165,_fy1165,_fex1165,_fey1165);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1165 = new TH1F("Graph_Graph1165","S18_",100,812,2312);
   Graph_Graph1165->SetMinimum(-0.067626);
   ...
   pol01166->SetParameter(0,0.009131194);
   pol01166->SetParError(0,0.01060579);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0091
#pm0.01
 mrad","lpf");
