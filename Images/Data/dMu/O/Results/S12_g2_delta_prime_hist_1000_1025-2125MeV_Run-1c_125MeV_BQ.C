...
//=========  (Tue Nov  9 13:39:35 2021) by ROOT version 6.24/04
   ...
   TH1D *h__16 = new TH1D("h__16","S12_",21,-0.04479482,0.3790326);
   h__16->SetBinContent(10,251);
   h__16->SetBinContent(11,676);
   h__16->SetBinContent(12,71);
   h__16->SetBinContent(13,2);
   h__16->SetEntries(1000);
   h__16->SetStats(0);
   h__16->SetLineWidth(3);
   h__16->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
