void S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1d_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   ...
   TH1D *h__23 = new TH1D("h__23","S18_",20,-0.1862959,0.2264743);
   h__23->SetBinContent(9,15);
   h__23->SetBinContent(10,784);
   h__23->SetBinContent(11,201);
   h__23->SetEntries(1000);
   h__23->SetStats(0);
   h__23->SetLineWidth(3);
   h__23->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
