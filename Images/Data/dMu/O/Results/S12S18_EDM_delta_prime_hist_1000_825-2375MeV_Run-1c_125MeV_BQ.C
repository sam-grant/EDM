...
//=========  (Mon Nov  8 21:03:59 2021) by ROOT version 6.24/04
   ...
   TH1D *h__39 = new TH1D("h__39","S12S18_",20,-0.3029955,0.1159291);
   h__39->SetBinContent(10,146);
   h__39->SetBinContent(11,849);
   h__39->SetBinContent(12,5);
   h__39->SetEntries(1000);
   h__39->SetStats(0);
   h__39->SetLineWidth(3);
   h__39->GetXaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad]");
   ...
   h__39->GetYaxis()->SetTitle("Trials  / 0.02 [mrad]");
