void S12S18_Ag2_vs_DS_unblinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-15.09077,4.75,31.91564);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1057->SetMinimum(-10.39013);
   Graph_Graph1057->SetMaximum(27.21499);
   ...
   pol01058->SetChisquare(1.625067);
   pol01058->SetNDF(3);
   ...
   pol01058->SetParameter(0,4.544373);
   pol01058->SetParError(0,3.248693);
