void S18_EDM_delta_prime_vs_p_900-2250MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.171057,2499.5,0.181004);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03995599,
   0.0406045};
   TGraphErrors *gre = new TGraphErrors(11,_fx1159,_fy1159,_fex1159,_fey1159);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1159 = new TH1F("Graph_Graph1159","S18_",100,812,2312);
   ...
   pol01160->SetParameter(0,-0.004260761);
   pol01160->SetParError(0,0.01190475);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0043
#pm0.01
 mrad","lpf");
