...
//=========  (Mon Nov  8 21:04:13 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.06799441,2655.75,0.06877742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01493908,
   0.01568401};
   TGraphErrors *gre = new TGraphErrors(12,_fx1191,_fy1191,_fex1191,_fey1191);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1191 = new TH1F("Graph_Graph1191","S12S18_",100,799.5,2449.5);
   ...
   pol01192->SetParameter(0,-5.538315e-05);
   pol01192->SetParError(0,0.004270142);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -5.5e-05
#pm0.004
 mrad","lpf");
