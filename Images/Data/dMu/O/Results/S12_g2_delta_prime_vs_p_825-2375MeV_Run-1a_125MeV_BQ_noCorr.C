...
//=========  (Mon Nov  8 21:04:12 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1701927,2655.75,0.2665111);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03892675,
   0.04090705};
   TGraphErrors *gre = new TGraphErrors(12,_fx1151,_fy1151,_fex1151,_fey1151);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1151 = new TH1F("Graph_Graph1151","S12_",100,799.5,2449.5);
   ...
   pol01152->SetParameter(0,0.02180207);
   pol01152->SetParError(0,0.01140461);
