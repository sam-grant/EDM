...
//=========  (Mon Nov  8 21:04:13 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1579408,2655.75,0.07891033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02501238,
   0.02633441};
   TGraphErrors *gre = new TGraphErrors(12,_fx1183,_fy1183,_fex1183,_fey1183);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1183 = new TH1F("Graph_Graph1183","S18_",100,799.5,2449.5);
   ...
   pol01184->SetParameter(0,-0.01009585);
   pol01184->SetParError(0,0.007016719);
