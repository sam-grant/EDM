void S12S18_AEDM_vs_DS_unblinded_750-2500MeV_125MeV_noCorr()
{
...
//=========  (Thu Nov 18 12:02:18 2021) by ROOT version 6.24/04
   ...
   Graph_Graph1030->SetMinimum(-7.49864e-20);
   Graph_Graph1030->SetMaximum(3.949092e-20);
   ...
   pol01031->SetChisquare(4.354559);
   pol01031->SetNDF(3);
   ...
   pol01031->SetParameter(0,-3.141065e-20);
   pol01031->SetParError(0,9.921067e-21);
