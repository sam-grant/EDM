...
//=========  (Mon Nov  8 21:08:24 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.1177129,2499.5,0.1727114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03302665,
   0.03361586};
   TGraphErrors *gre = new TGraphErrors(11,_fx1171,_fy1171,_fex1171,_fey1171);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1171 = new TH1F("Graph_Graph1171","S18_",100,812,2312);
   ...
   pol01172->SetParameter(0,-0.01053373);
   pol01172->SetParError(0,0.009857219);
