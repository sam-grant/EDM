void S12_g2_delta_prime_hist_1000_900-2250MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:07:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__28 = new TH1D("h__28","S12_",21,0.005308834,0.4309185);
   h__28->SetBinContent(9,1);
   h__28->SetBinContent(10,10);
   h__28->SetBinContent(11,146);
   h__28->SetBinContent(12,534);
   h__28->SetBinContent(13,256);
   h__28->SetBinContent(14,49);
   h__28->SetBinContent(15,4);
