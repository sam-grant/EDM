...
//=========  (Thu Nov 18 12:02:18 2021) by ROOT version 6.24/04
   ...
   Graph_Graph_Graph10191023->SetMinimum(-19.34736);
   Graph_Graph_Graph10191023->SetMaximum(33.01719);
   ...
   fit1023->SetParameter(0,2.529851);
   fit1023->SetParError(0,2.764132);
   ...
   shift_-11024->SetParameter(0,-0.2342815);
   ...
   shift_11025->SetParameter(0,5.293983);
   ...
   Graph_Graph_Graph_Graph101910231024->SetMinimum(-19.34736);
   Graph_Graph_Graph_Graph101910231024->SetMaximum(33.01719);
   ...
   Graph_Graph_Graph10201025->SetMinimum(-15.17676);
   Graph_Graph_Graph10201025->SetMaximum(23.4893);
   ...
   Graph_Graph_Graph10211026->SetMinimum(-9.394198);
   Graph_Graph_Graph10211026->SetMaximum(23.6148);
   ...
   pol01027->SetChisquare(2.701904);
   pol01027->SetNDF(3);
   ...
   pol01027->SetParameter(0,2.529851);
   pol01027->SetParError(0,2.764132);
