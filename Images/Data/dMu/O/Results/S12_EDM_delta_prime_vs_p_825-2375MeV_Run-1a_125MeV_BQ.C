void S12_EDM_delta_prime_vs_p_825-2375MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.705964,2655.75,3.048584);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.7585935,
   0.970623};
   TGraphErrors *gre = new TGraphErrors(12,_fx1097,_fy1097,_fex1097,_fey1097);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1097 = new TH1F("Graph_Graph1097","S12_",100,799.5,2449.5);
   Graph_Graph1097->SetMinimum(-2.130509);
   Graph_Graph1097->SetMaximum(2.473129);
   ...
   Graph_Graph1097->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 125 MeV");
   ...
   pol01098->SetParameter(0,-0.3099152);
   pol01098->SetParError(0,0.1668794);
