void S12S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1d_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   ...
   TH1D *h__24 = new TH1D("h__24","S12S18_",20,-0.1781616,0.224862);
   h__24->SetBinContent(10,287);
   h__24->SetBinContent(11,713);
   h__24->SetEntries(1000);
   h__24->SetStats(0);
   h__24->SetLineWidth(3);
   h__24->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
