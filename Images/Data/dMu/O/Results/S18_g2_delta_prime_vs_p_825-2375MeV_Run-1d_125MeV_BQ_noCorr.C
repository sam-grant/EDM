...
//=========  (Mon Nov  8 21:04:13 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1191789,2655.75,0.1078812);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02226963,
   0.02338193};
   TGraphErrors *gre = new TGraphErrors(12,_fx1189,_fy1189,_fex1189,_fey1189);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1189 = new TH1F("Graph_Graph1189","S18_",100,799.5,2449.5);
   ...
   pol01190->SetParameter(0,-0.001043445);
   pol01190->SetParError(0,0.006240786);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.001
#pm0.006
 mrad","lpf");
