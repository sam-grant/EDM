void S12_g2_delta_prime_vs_p_900-2250MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-2.156633,2499.5,2.074281);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4923163,
   0.5763658};
   TGraphErrors *gre = new TGraphErrors(11,_fx1115,_fy1115,_fex1115,_fey1115);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1115 = new TH1F("Graph_Graph1115","S12_",100,812,2312);
   ...
   pol01116->SetParameter(0,-0.04466426);
   pol01116->SetParError(0,0.1284545);
