void S12_g2_delta_prime_hist_1000_900-2250MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:08:01 2021) by ROOT version 6.24/04
   ...
   TH1D *h__34 = new TH1D("h__34","S12_",20,-0.2453767,0.1611591);
   h__34->SetBinContent(9,1);
   h__34->SetBinContent(10,697);
   h__34->SetBinContent(11,302);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.04478
#pm0.0001
");
   pt_LaTex = pt->AddText("0.0047
#pm0.0001
");
   pt->Draw();
   c->Modified();
