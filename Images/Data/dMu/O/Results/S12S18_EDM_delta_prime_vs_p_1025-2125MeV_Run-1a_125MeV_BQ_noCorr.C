...
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1548758,2312,0.1109068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1053->SetMaximum(0.08432852);
   ...
   Graph_Graph1053->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01054->SetChisquare(6.642758);
   pol01054->SetNDF(8);
   ...
   pol01054->SetParameter(0,-0.02833063);
   pol01054->SetParError(0,0.01041186);
