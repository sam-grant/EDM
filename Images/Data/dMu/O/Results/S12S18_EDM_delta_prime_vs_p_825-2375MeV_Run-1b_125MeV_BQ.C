...
//=========  (Mon Nov  8 21:03:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.172499,2655.75,1.451045);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4768132,
   0.6098786};
   TGraphErrors *gre = new TGraphErrors(12,_fx1113,_fy1113,_fex1113,_fey1113);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1113 = new TH1F("Graph_Graph1113","S12S18_",100,799.5,2449.5);
   ...
   pol01114->SetParameter(0,0.00366244);
   pol01114->SetParError(0,0.1026718);
