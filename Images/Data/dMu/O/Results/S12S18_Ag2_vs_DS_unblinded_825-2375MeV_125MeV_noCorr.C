void S12S18_Ag2_vs_DS_unblinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-14.07092,4.75,31.422);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1057->SetMinimum(-9.521623);
   Graph_Graph1057->SetMaximum(26.87271);
   ...
   pol01058->SetChisquare(3.298657);
   pol01058->SetNDF(3);
   ...
   pol01058->SetParameter(0,3.623463);
   pol01058->SetParError(0,2.89549);
