...
//=========  (Mon Nov  8 21:08:14 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-2.143288,2499.5,0.9419159);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3659355,
   0.4327945};
   TGraphErrors *gre = new TGraphErrors(11,_fx1135,_fy1135,_fex1135,_fey1135);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1135 = new TH1F("Graph_Graph1135","S18_",100,812,2312);
   Graph_Graph1135->SetMinimum(-1.834768);
   ...
   pol01136->SetParameter(0,-0.05738124);
   pol01136->SetParError(0,0.09184118);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.057
#pm0.09
 mrad","lpf");
