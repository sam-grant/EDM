...
//=========  (Mon Nov  8 21:08:00 2021) by ROOT version 6.24/04
   ...
   TH1D *h__33 = new TH1D("h__33","S12S18_",20,-0.1935833,0.2095772);
   h__33->SetBinContent(10,236);
   h__33->SetBinContent(11,764);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.008766
#pm3e-05
");
   pt_LaTex = pt->AddText("0.00099
#pm2e-05
");
   pt->Draw();
   c->Modified();
