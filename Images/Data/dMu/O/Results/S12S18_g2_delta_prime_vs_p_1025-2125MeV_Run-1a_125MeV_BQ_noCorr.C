void S12S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1147884,2312,0.130169);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02689129,
   0.02818432};
   TGraphErrors *gre = new TGraphErrors(9,_fx1059,_fy1059,_fex1059,_fey1059);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1059 = new TH1F("Graph_Graph1059","S12S18_",100,962,2162);
   Graph_Graph1059->SetMinimum(-0.09029267);
   Graph_Graph1059->SetMaximum(0.1056732);
   ...
   Graph_Graph1059->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01060->SetParameter(0,0.01482575);
   pol01060->SetParError(0,0.009255489);
