...
//=========  (Tue Nov  9 13:39:39 2021) by ROOT version 6.24/04
   ...
   TH1D *h__22 = new TH1D("h__22","S12_",20,-0.1770525,0.2285451);
   h__22->SetBinContent(10,23);
   h__22->SetBinContent(11,970);
   h__22->SetBinContent(12,7);
   h__22->SetEntries(1000);
   h__22->SetStats(0);
   h__22->SetLineWidth(3);
   h__22->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
