...
//=========  (Mon Nov  8 21:08:03 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.914802,2499.5,1.991822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4560559,
   0.5367831};
   TGraphErrors *gre = new TGraphErrors(11,_fx1121,_fy1121,_fex1121,_fey1121);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1121 = new TH1F("Graph_Graph1121","S12_",100,812,2312);
   ...
   pol01122->SetParameter(0,-0.06508598);
   pol01122->SetParError(0,0.1187475);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.065
#pm0.1
 mrad","lpf");
