...
//=========  (Mon Nov  8 21:04:03 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.714369,2655.75,1.260695);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3909945,
   0.503661};
   TGraphErrors *gre = new TGraphErrors(12,_fx1133,_fy1133,_fex1133,_fey1133);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1133 = new TH1F("Graph_Graph1133","S12_",100,799.5,2449.5);
   ...
   pol01134->SetParameter(0,-0.2510417);
   pol01134->SetParError(0,0.08559185);
