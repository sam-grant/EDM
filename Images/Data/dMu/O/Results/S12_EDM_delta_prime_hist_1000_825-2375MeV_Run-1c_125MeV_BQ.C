...
//=========  (Mon Nov  8 21:03:57 2021) by ROOT version 6.24/04
   ...
   TH1D *h__37 = new TH1D("h__37","S12_",20,-0.2661627,0.1460396);
   h__37->SetBinContent(10,131);
   h__37->SetBinContent(11,854);
   h__37->SetBinContent(12,15);
