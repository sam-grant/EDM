void S18_g2_delta_prime_hist_1000_900-2250MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:08:02 2021) by ROOT version 6.24/04
   ...
   TH1D *h__35 = new TH1D("h__35","S18_",20,-0.1178578,0.2887074);
   h__35->SetBinContent(10,19);
   h__35->SetBinContent(11,578);
   h__35->SetBinContent(12,391);
   h__35->SetBinContent(13,12);
   h__35->SetEntries(1000);
   h__35->SetStats(0);
   h__35->SetLineWidth(3);
   h__35->GetXaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad]");
   ...
   h__35->GetYaxis()->SetTitle("Trials  / 0.02 [mrad]");
