...
//=========  (Mon Nov  8 21:03:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-3.435591,2655.75,2.261773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1109 = new TH1F("Graph_Graph1109","S12_",100,799.5,2449.5);
   ...
   pol01110->SetParameter(0,0.04463794);
   pol01110->SetParError(0,0.142347);
