void S12S18_EDM_delta_prime_hist_1000_1025-2125MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:30 2021) by ROOT version 6.24/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18_",22,-0.5735597,-0.1313799);
   h__3->SetBinContent(8,4);
   h__3->SetBinContent(9,46);
   h__3->SetBinContent(10,219);
   h__3->SetBinContent(11,461);
   h__3->SetBinContent(12,241);
   h__3->SetBinContent(13,27);
   h__3->SetBinContent(14,2);
   h__3->SetEntries(1000);
   h__3->SetStats(0);
   h__3->SetLineWidth(3);
   h__3->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
