...
//=========  (Mon Nov  8 17:46:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__22 = new TH1D("h__22","S12_",20,-0.1822815,0.2239943);
   h__22->SetBinContent(10,24);
   h__22->SetBinContent(11,957);
   h__22->SetBinContent(12,19);
