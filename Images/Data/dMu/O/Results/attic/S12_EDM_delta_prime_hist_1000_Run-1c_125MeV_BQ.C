...
//=========  (Mon Nov  8 17:46:48 2021) by ROOT version 6.24/04
   ...
   TH1D *h__13 = new TH1D("h__13","S12_",20,-0.2530716,0.1634734);
   h__13->SetBinContent(10,137);
   h__13->SetBinContent(11,751);
   h__13->SetBinContent(12,111);
