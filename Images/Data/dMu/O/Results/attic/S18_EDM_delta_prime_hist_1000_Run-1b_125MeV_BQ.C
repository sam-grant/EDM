...
//=========  (Mon Nov  8 17:46:44 2021) by ROOT version 6.24/04
   ...
   TH1D *h__8 = new TH1D("h__8","S18_",20,-0.2377886,0.1653795);
   h__8->SetBinContent(10,72);
   h__8->SetBinContent(11,904);
   h__8->SetBinContent(12,24);
