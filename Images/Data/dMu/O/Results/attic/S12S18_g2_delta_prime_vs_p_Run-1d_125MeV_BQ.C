void S12S18_g2_delta_prime_vs_p_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 17:46:56 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-1.24072,2843.25,1.215036);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","S12S18_",100,649.5,2599.5);
   Graph_Graph1047->SetMinimum(-0.9951441);
   Graph_Graph1047->SetMaximum(0.9694601);
   ...
   pol01048->SetChisquare(17.26404);
   pol01048->SetNDF(13);
   ...
   pol01048->SetParameter(0,-0.004773594);
   pol01048->SetParError(0,0.05431747);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0048
#pm0.05
 mrad","lpf");
