void S12_EDM_delta_prime_vs_p_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 17:46:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-3.284183,2843.25,1.435119);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1037 = new TH1F("Graph_Graph1037","S12_",100,649.5,2599.5);
   Graph_Graph1037->SetMinimum(-2.812252);
   Graph_Graph1037->SetMaximum(0.9631888);
   ...
   pol01038->SetChisquare(13.02263);
   pol01038->SetNDF(13);
   ...
   pol01038->SetParameter(0,-0.2765292);
   pol01038->SetParError(0,0.08406886);
