...
//=========  (Tue Nov  9 13:49:02 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","S12S18_",20,-0.1836826,0.2216994);
   h__9->SetBinContent(10,25);
   h__9->SetBinContent(11,974);
   h__9->SetBinContent(12,1);
