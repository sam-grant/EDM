...
//=========  (Tue Nov  9 13:39:29 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.835694,2312,1.387037);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-1.513421);
   Graph_Graph1005->SetMaximum(1.064763);
   ...
   Graph_Graph1005->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01006->SetChisquare(6.016344);
   pol01006->SetNDF(8);
   ...
   pol01006->SetParameter(0,-0.3628658);
   pol01006->SetParError(0,0.1280506);
