...
//=========  (Thu Nov 18 12:00:15 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","S12_",20,-0.2537276,0.1573597);
   h__10->SetBinContent(9,5);
   h__10->SetBinContent(10,821);
   h__10->SetBinContent(11,174);
   h__10->SetEntries(1000);
   h__10->SetStats(0);
   h__10->SetLineWidth(3);
   h__10->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
