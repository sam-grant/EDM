...
//=========  (Mon Nov  8 21:08:23 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.2281135,2499.5,0.1832359);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04141934,
   0.04188742};
   TGraphErrors *gre = new TGraphErrors(11,_fx1153,_fy1153,_fex1153,_fey1153);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1153 = new TH1F("Graph_Graph1153","S18_",100,812,2312);
   ...
   pol01154->SetParameter(0,0.0124523);
   pol01154->SetParError(0,0.01238134);
