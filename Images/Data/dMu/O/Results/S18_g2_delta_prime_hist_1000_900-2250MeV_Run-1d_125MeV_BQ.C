...
//=========  (Mon Nov  8 21:08:21 2021) by ROOT version 6.24/04
   ...
   TH1D *h__47 = new TH1D("h__47","S18_",20,-0.2341673,0.1699228);
   h__47->SetBinContent(10,968);
   h__47->SetBinContent(11,32);
