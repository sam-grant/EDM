void S12S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.09243357,2312,0.1378522);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02141838,
   0.02241245};
   TGraphErrors *gre = new TGraphErrors(9,_fx1077,_fy1077,_fex1077,_fey1077);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1077 = new TH1F("Graph_Graph1077","S12S18_",100,962,2162);
   Graph_Graph1077->SetMinimum(-0.069405);
   Graph_Graph1077->SetMaximum(0.1148236);
   ...
   Graph_Graph1077->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01078->SetParameter(0,-0.0074961);
   pol01078->SetParError(0,0.007333534);
