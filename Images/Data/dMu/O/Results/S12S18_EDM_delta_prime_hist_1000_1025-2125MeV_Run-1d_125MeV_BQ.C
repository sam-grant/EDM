...
//=========  (Tue Nov  9 13:39:38 2021) by ROOT version 6.24/04
   ...
   TH1D *h__21 = new TH1D("h__21","S12S18_",20,-0.3736145,0.04073888);
   h__21->SetBinContent(9,36);
   h__21->SetBinContent(10,647);
   h__21->SetBinContent(11,316);
   h__21->SetBinContent(12,1);
   h__21->SetEntries(1000);
   h__21->SetStats(0);
   h__21->SetLineWidth(3);
   h__21->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
