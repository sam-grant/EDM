...
//=========  (Mon Nov  8 21:04:12 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1576886,2655.75,0.136222);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03226296,
   0.03367309};
   TGraphErrors *gre = new TGraphErrors(12,_fx1149,_fy1149,_fex1149,_fey1149);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1149 = new TH1F("Graph_Graph1149","S12S18_",100,799.5,2449.5);
   ...
   pol01150->SetParameter(0,-0.01760589);
   pol01150->SetParError(0,0.009272988);
