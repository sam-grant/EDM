void S12_g2_delta_prime_hist_1000_1025-2125MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:32 2021) by ROOT version 6.24/04
   ...
   TH1D *h__10 = new TH1D("h__10","S12_",20,-0.2035155,0.2003317);
   h__10->SetBinContent(10,935);
   h__10->SetBinContent(11,65);
   h__10->SetEntries(1000);
   h__10->SetStats(0);
   h__10->SetLineWidth(3);
   h__10->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
