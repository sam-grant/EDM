void S18_EDM_delta_prime_vs_p_825-2375MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.337703,2655.75,2.473641);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.7025881,
   0.8993665};
   TGraphErrors *gre = new TGraphErrors(12,_fx1111,_fy1111,_fex1111,_fey1111);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1111 = new TH1F("Graph_Graph1111","S18_",100,799.5,2449.5);
   ...
   pol01112->SetParameter(0,-0.04355057);
   pol01112->SetParError(0,0.1482116);
