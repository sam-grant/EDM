...
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.1421151,2843.25,0.1055328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1077->SetMinimum(-0.1173503);
   Graph_Graph1077->SetMaximum(0.08076804);
   ...
   Graph_Graph1077->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01078->SetChisquare(11.85952);
   pol01078->SetNDF(13);
   ...
   pol01078->SetParameter(0,-0.007045542);
   pol01078->SetParError(0,0.006239968);
