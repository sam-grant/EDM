...
//=========  (Mon Nov  8 21:04:12 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1389147,2655.75,0.1277946);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02746899,
   0.02869934};
   TGraphErrors *gre = new TGraphErrors(12,_fx1175,_fy1175,_fex1175,_fey1175);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1175 = new TH1F("Graph_Graph1175","S12_",100,799.5,2449.5);
   ...
   pol01176->SetParameter(0,0.01509546);
   pol01176->SetParError(0,0.008005955);
