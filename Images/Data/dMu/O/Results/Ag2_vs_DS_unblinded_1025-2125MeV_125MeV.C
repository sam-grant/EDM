void Ag2_vs_DS_unblinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-285.1124,4.75,504.5848);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10191023->SetMinimum(-206.1427);
   Graph_Graph_Graph10191023->SetMaximum(425.6151);
   ...
   fit1023->SetParameter(0,53.38855);
   fit1023->SetParError(0,39.99716);
   ...
   shift_-11024->SetParameter(0,13.39139);
   ...
   shift_11025->SetParameter(0,93.38571);
   ...
   Graph_Graph_Graph_Graph101910231024->SetMinimum(-206.1427);
   Graph_Graph_Graph_Graph101910231024->SetMaximum(425.6151);
   ...
   Graph_Graph_Graph10201025->SetMinimum(-196.7932);
   Graph_Graph_Graph10201025->SetMaximum(388.3474);
   ...
   Graph_Graph_Graph10211026->SetMinimum(-123.1769);
   Graph_Graph_Graph10211026->SetMaximum(334.8332);
   ...
   pol01027->SetChisquare(1.738099);
   pol01027->SetNDF(3);
   ...
   pol01027->SetParameter(0,53.38855);
   pol01027->SetParError(0,39.99716);
