void S18_g2_delta_prime_vs_p_825-2375MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:04:00 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.104611,2655.75,1.466525);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5214706,
   0.6726852};
   TGraphErrors *gre = new TGraphErrors(12,_fx1129,_fy1129,_fex1129,_fey1129);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1129 = new TH1F("Graph_Graph1129","S18_",100,799.5,2449.5);
   Graph_Graph1129->SetMinimum(-1.747498);
   Graph_Graph1129->SetMaximum(1.109411);
   ...
   pol01130->SetParameter(0,-0.03997545);
   pol01130->SetParError(0,0.1092453);
