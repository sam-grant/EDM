void S18_EDM_delta_prime_vs_p_825-2375MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:45 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-3.524275,2655.75,4.276886);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.8243162,
   1.06094};
   TGraphErrors *gre = new TGraphErrors(12,_fx1099,_fy1099,_fex1099,_fey1099);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1099 = new TH1F("Graph_Graph1099","S18_",100,799.5,2449.5);
   Graph_Graph1099->SetMinimum(-2.744159);
   Graph_Graph1099->SetMaximum(3.49677);
   ...
   pol01100->SetParameter(0,-0.2430937);
   pol01100->SetParError(0,0.1733809);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.24
#pm0.2
 mrad","lpf");
