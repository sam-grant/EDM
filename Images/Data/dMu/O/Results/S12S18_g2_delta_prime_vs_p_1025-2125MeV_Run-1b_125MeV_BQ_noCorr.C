void S12S18_g2_delta_prime_vs_p_1025-2125MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.09246453,2312,0.101538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0230902,
   0.0241903};
   TGraphErrors *gre = new TGraphErrors(9,_fx1071,_fy1071,_fex1071,_fey1071);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1071 = new TH1F("Graph_Graph1071","S12S18_",100,962,2162);
   Graph_Graph1071->SetMinimum(-0.07306428);
   Graph_Graph1071->SetMaximum(0.08213772);
   ...
   Graph_Graph1071->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01072->SetParameter(0,0.0006565244);
   pol01072->SetParError(0,0.007912891);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00066
#pm0.008
 mrad","lpf");
