void S18_g2_delta_prime_vs_p_825-2375MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.022587,2655.75,3.350086);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.6255173,
   0.805871};
   TGraphErrors *gre = new TGraphErrors(12,_fx1117,_fy1117,_fex1117,_fey1117);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1117 = new TH1F("Graph_Graph1117","S18_",100,799.5,2449.5);
   Graph_Graph1117->SetMinimum(-1.48532);
   ...
   pol01118->SetParameter(0,0.08814375);
   pol01118->SetParError(0,0.1320432);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.088
#pm0.1
 mrad","lpf");
