...
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.1504693,2843.25,0.1113579);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1093->SetMinimum(-0.1242866);
   ...
   Graph_Graph1093->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01094->SetChisquare(32.72115);
   pol01094->SetNDF(13);
   ...
   pol01094->SetParameter(0,-0.003857876);
   pol01094->SetParError(0,0.005961831);
