...
//=========  (Mon Nov  8 21:08:23 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.2144937,2499.5,0.2249066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04336358,
   0.04384121};
   TGraphErrors *gre = new TGraphErrors(11,_fx1145,_fy1145,_fex1145,_fey1145);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1145 = new TH1F("Graph_Graph1145","S12_",100,812,2312);
   ...
   pol01146->SetParameter(0,-0.02084899);
   pol01146->SetParError(0,0.0133727);
