void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:49:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.140639,2843.25,0.0970942);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1083->SetMinimum(-0.1168657);
   ...
   Graph_Graph1083->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01084->SetParameter(0,0.004918239);
   pol01084->SetParError(0,0.005551322);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0049
#pm0.006
 mrad","lpf");
