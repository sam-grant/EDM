...
//=========  (Mon Nov  8 21:08:05 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.662019,2499.5,2.366237);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.493706,
   0.5816621};
   TGraphErrors *gre = new TGraphErrors(11,_fx1123,_fy1123,_fex1123,_fey1123);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1123 = new TH1F("Graph_Graph1123","S18_",100,812,2312);
   ...
   pol01124->SetParameter(0,-0.1392504);
   pol01124->SetParError(0,0.1244228);
