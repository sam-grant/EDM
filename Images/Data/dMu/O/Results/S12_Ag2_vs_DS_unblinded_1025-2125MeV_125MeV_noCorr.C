void S12_Ag2_vs_DS_unblinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-21.53932,4.75,37.63363);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   9.006218,
   6.581318};
   TGraphErrors *gre = new TGraphErrors(4,_fx1055,_fy1055,_fex1055,_fey1055);
   gre->SetName("");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1055 = new TH1F("Graph_Graph1055","S12",100,0.7,4.3);
   Graph_Graph1055->SetMinimum(-15.62202);
   Graph_Graph1055->SetMaximum(31.71634);
   ...
   Graph_Graph1055->GetXaxis()->SetBinLabel(9,"Run-1a");
   Graph_Graph1055->GetXaxis()->SetBinLabel(37,"Run-1b");
   Graph_Graph1055->GetXaxis()->SetBinLabel(64,"Run-1c");
   Graph_Graph1055->GetXaxis()->SetBinLabel(92,"Run-1d");
   Graph_Graph1055->GetXaxis()->SetBit(TAxis::kLabelsHori);
   ...
   Graph_Graph1055->GetYaxis()->SetTitle("#Omega_{c} [ppm]");
   ...
   Graph_Graph1055->GetYaxis()->SetTitleOffset(1.2);
