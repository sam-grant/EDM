void S12S18_g2_delta_prime_hist_1000_750-2500MeV_Run-1a_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:49:00 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",21,-0.03346129,0.3995504);
   h__6->SetBinContent(10,32);
   h__6->SetBinContent(11,621);
   h__6->SetBinContent(12,332);
   h__6->SetBinContent(13,15);
   h__6->SetEntries(1000);
   h__6->SetStats(0);
   h__6->SetLineWidth(3);
   h__6->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
