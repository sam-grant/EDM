...
//=========  (Thu Nov 18 12:00:13 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",21,-0.03401685,0.3961471);
   h__6->SetBinContent(10,18);
   h__6->SetBinContent(11,515);
   h__6->SetBinContent(12,442);
   h__6->SetBinContent(13,25);
