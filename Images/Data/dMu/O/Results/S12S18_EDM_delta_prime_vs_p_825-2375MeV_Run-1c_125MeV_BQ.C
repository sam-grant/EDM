...
//=========  (Mon Nov  8 21:03:58 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-1.243136,2655.75,1.599761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3945109,
   0.5081423};
   TGraphErrors *gre = new TGraphErrors(12,_fx1125,_fy1125,_fex1125,_fey1125);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1125 = new TH1F("Graph_Graph1125","S12S18_",100,799.5,2449.5);
   ...
   pol01126->SetParameter(0,-0.08745384);
   pol01126->SetParError(0,0.08470586);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.087
#pm0.08
 mrad","lpf");
