...
//=========  (Thu Nov 18 12:00:16 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18_",20,-0.197481,0.2135048);
   h__12->SetBinContent(10,83);
   h__12->SetBinContent(11,902);
   h__12->SetBinContent(12,15);
   h__12->SetEntries(1000);
   h__12->SetStats(0);
   h__12->SetLineWidth(3);
   h__12->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
