void S18_g2_delta_prime_hist_1000_1025-2125MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Tue Nov  9 13:39:33 2021) by ROOT version 6.24/04
   ...
   TH1D *h__11 = new TH1D("h__11","S18_",20,-0.1846666,0.2212357);
   h__11->SetBinContent(10,24);
   h__11->SetBinContent(11,961);
   h__11->SetBinContent(12,15);
   h__11->SetEntries(1000);
   h__11->SetStats(0);
   h__11->SetLineWidth(3);
   h__11->GetXaxis()->SetTitle("#delta'_{s}^{} [mrad]");
