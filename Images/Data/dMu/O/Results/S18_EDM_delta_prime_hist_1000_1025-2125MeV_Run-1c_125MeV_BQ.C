...
//=========  (Tue Nov  9 13:39:34 2021) by ROOT version 6.24/04
   ...
   TH1D *h__14 = new TH1D("h__14","S18_",21,-0.3563877,0.06530026);
   h__14->SetBinContent(9,1);
   h__14->SetBinContent(10,85);
   h__14->SetBinContent(11,852);
   h__14->SetBinContent(12,62);
   h__14->SetEntries(1000);
   h__14->SetStats(0);
   h__14->SetLineWidth(3);
   h__14->GetXaxis()->SetTitle("#delta'_{c}^{} [mrad]");
