void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:37 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.17485,2312,1.290811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3133378,
   0.3659355};
   TGraphErrors *gre = new TGraphErrors(9,_fx1039,_fy1039,_fex1039,_fey1039);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1039 = new TH1F("Graph_Graph1039","S18_",100,962,2162);
   Graph_Graph1039->SetMinimum(-0.928284);
   Graph_Graph1039->SetMaximum(1.044245);
   ...
   Graph_Graph1039->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01040->SetParameter(0,-0.02869125);
   pol01040->SetParError(0,0.09636763);
