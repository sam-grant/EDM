...
//=========  (Thu Nov 18 12:00:19 2021) by ROOT version 6.24/04
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18_",21,-0.1312456,0.2892571);
   h__18->SetBinContent(9,24);
   h__18->SetBinContent(10,576);
   h__18->SetBinContent(11,387);
   h__18->SetBinContent(12,13);
