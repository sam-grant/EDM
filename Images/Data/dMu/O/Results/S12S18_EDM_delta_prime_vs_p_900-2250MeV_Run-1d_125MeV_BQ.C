void S12S18_EDM_delta_prime_vs_p_900-2250MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:08:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.51802,2499.5,0.8580539);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2470392,
   0.2901394};
   TGraphErrors *gre = new TGraphErrors(11,_fx1137,_fy1137,_fex1137,_fey1137);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1137 = new TH1F("Graph_Graph1137","S12S18_",100,812,2312);
   ...
   pol01138->SetParameter(0,-0.163412);
   pol01138->SetParError(0,0.06310725);
