...
//=========  (Tue Nov  9 13:49:01 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.558146,2843.25,3.305467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S12S18_",100,649.5,2599.5);
   Graph_Graph1017->SetMinimum(-1.071785);
   Graph_Graph1017->SetMaximum(2.819105);
   ...
   pol01018->SetChisquare(10.05161);
   pol01018->SetNDF(13);
   ...
   pol01018->SetParameter(0,0.0266222);
   pol01018->SetParError(0,0.1008383);
