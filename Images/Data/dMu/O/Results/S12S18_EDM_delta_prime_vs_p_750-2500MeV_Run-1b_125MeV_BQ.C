void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov 18 12:00:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.4445,-1.57414,2837.507,3.310811);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S12S18_",100,654.0508,2594.901);
   Graph_Graph1017->SetMinimum(-1.085645);
   Graph_Graph1017->SetMaximum(2.822316);
   ...
   Graph_Graph1017->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01018->SetChisquare(10.05064);
   pol01018->SetNDF(13);
   ...
   pol01018->SetParameter(0,0.02687427);
   pol01018->SetParError(0,0.1010924);
