void S12_g2_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1659799,2312,0.228596);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03681972,
   0.03844988};
   TGraphErrors *gre = new TGraphErrors(9,_fx1055,_fy1055,_fex1055,_fey1055);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1055 = new TH1F("Graph_Graph1055","S12_",100,962,2162);
   Graph_Graph1055->SetMinimum(-0.1265223);
   Graph_Graph1055->SetMaximum(0.1891384);
   ...
   Graph_Graph1055->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01056->SetParameter(0,0.01493987);
   pol01056->SetParError(0,0.01283161);
