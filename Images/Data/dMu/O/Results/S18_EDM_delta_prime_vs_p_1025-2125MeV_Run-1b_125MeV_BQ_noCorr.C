void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1b_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.162351,2312,0.1483685);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0378324,
   0.03995599};
   TGraphErrors *gre = new TGraphErrors(9,_fx1063,_fy1063,_fex1063,_fey1063);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1063 = new TH1F("Graph_Graph1063","S18_",100,962,2162);
   Graph_Graph1063->SetMinimum(-0.131279);
   Graph_Graph1063->SetMaximum(0.1172965);
   ...
   Graph_Graph1063->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01064->SetParameter(0,-0.003572063);
   pol01064->SetParError(0,0.01283725);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0036
#pm0.01
 mrad","lpf");
