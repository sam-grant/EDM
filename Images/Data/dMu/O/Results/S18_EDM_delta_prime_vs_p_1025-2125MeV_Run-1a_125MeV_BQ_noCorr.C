void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 13:39:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1969622,2312,0.1893901);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04399934,
   0.04671563};
   TGraphErrors *gre = new TGraphErrors(9,_fx1051,_fy1051,_fex1051,_fey1051);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1051 = new TH1F("Graph_Graph1051","S18_",100,962,2162);
   Graph_Graph1051->SetMinimum(-0.158327);
   Graph_Graph1051->SetMaximum(0.1507549);
   ...
   Graph_Graph1051->GetYaxis()->SetTitle("#delta'_{c}^{} [mrad] / 125 MeV");
   ...
   pol01052->SetParameter(0,-0.02326778);
   pol01052->SetParError(0,0.01500967);
