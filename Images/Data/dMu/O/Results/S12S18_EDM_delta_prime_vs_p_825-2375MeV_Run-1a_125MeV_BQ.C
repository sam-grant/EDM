...
//=========  (Mon Nov  8 21:03:46 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-2.112709,2655.75,1.917367);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5582527,
   0.7163093};
   TGraphErrors *gre = new TGraphErrors(12,_fx1101,_fy1101,_fex1101,_fey1101);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1101 = new TH1F("Graph_Graph1101","S12S18_",100,799.5,2449.5);
   Graph_Graph1101->SetMinimum(-1.709701);
   Graph_Graph1101->SetMaximum(1.514359);
   ...
   pol01102->SetParameter(0,-0.2778575);
   pol01102->SetParError(0,0.1202504);
