void S12S18_AEDM_vs_DS_unblinded_825-2375MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-1.677648e-18,4.75,7.4291e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1030->SetMinimum(-1.435592e-18);
   Graph_Graph1030->SetMaximum(5.008542e-19);
   ...
   pol01031->SetChisquare(3.985562);
   pol01031->SetNDF(3);
   ...
   pol01031->SetParameter(0,-4.355339e-19);
   pol01031->SetParError(0,1.355369e-19);
