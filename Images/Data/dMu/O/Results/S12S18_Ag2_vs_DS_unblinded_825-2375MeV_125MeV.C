void S12S18_Ag2_vs_DS_unblinded_825-2375MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-168.6133,4.75,401.7375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-111.5782);
   Graph_Graph1021->SetMaximum(344.7024);
   ...
   pol01022->SetChisquare(3.072167);
   pol01022->SetNDF(3);
   ...
   pol01022->SetParameter(0,47.18255);
   pol01022->SetParError(0,37.59562);
