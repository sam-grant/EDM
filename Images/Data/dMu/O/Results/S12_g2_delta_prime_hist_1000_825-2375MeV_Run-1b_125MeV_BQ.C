void S12_g2_delta_prime_hist_1000_825-2375MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Mon Nov  8 21:03:53 2021) by ROOT version 6.24/04
   ...
   TH1D *h__34 = new TH1D("h__34","S12_",20,-0.2493535,0.1574919);
   h__34->SetBinContent(9,1);
   h__34->SetBinContent(10,695);
   h__34->SetBinContent(11,304);
   h__34->SetEntries(1000);
   h__34->SetStats(0);
   h__34->SetLineWidth(3);
   h__34->GetXaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad]");
   ...
   h__34->GetYaxis()->SetTitle("Trials  / 0.02 [mrad]");
