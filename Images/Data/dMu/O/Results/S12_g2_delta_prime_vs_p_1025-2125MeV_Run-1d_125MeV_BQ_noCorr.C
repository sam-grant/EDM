...
//=========  (Tue Nov  9 13:39:41 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.06278526,2312,0.1381049);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1091->SetMinimum(-0.04269624);
   Graph_Graph1091->SetMaximum(0.1180159);
   ...
   Graph_Graph1091->GetYaxis()->SetTitle("#delta'_{s}^{} [mrad] / 125 MeV");
   ...
   pol01092->SetChisquare(6.926538);
   pol01092->SetNDF(8);
   ...
   pol01092->SetParameter(0,0.002628559);
   pol01092->SetParError(0,0.006581318);
