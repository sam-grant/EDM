...
//=========  (Mon Nov  8 21:04:10 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-1.151472,2655.75,0.9646212);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2584939,
   0.3336373};
   TGraphErrors *gre = new TGraphErrors(12,_fx1143,_fy1143,_fex1143,_fey1143);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1143 = new TH1F("Graph_Graph1143","S12S18_",100,799.5,2449.5);
   ...
   pol01144->SetParameter(0,-0.0008772606);
   pol01144->SetParError(0,0.05530708);
