...
//=========  (Tue Oct 19 15:52:12 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.1341792,2750,0.5364649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","S18",100,125,3125);
   Graph_Graph01022->SetMinimum(-0.06711481);
   Graph_Graph01022->SetMaximum(0.4694004);
