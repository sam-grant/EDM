void S12S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:39:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.5096,-1.547935,2976.945,1.375769);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,979.4532,2755.001);
   Graph_Graph1011->SetMinimum(-1.255565);
   Graph_Graph1011->SetMaximum(1.083398);
   ...
   pol01012->SetParameter(0,-0.04013954);
   pol01012->SetParError(0,0.05824906);
