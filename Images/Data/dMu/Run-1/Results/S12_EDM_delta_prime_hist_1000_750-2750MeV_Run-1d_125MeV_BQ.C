...
//=========  (Tue Mar 22 09:59:10 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",20,0.3928228,0.799808);
   h__1->SetBinContent(9,8);
   h__1->SetBinContent(10,457);
   h__1->SetBinContent(11,507);
   h__1->SetBinContent(12,27);
