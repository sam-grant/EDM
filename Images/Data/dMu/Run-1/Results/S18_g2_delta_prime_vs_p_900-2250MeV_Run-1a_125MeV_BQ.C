...
//=========  (Mon Nov  8 21:07:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.328449,2499.5,3.00833);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4400632,
   0.5249716};
   TGraphErrors *gre = new TGraphErrors(11,_fx1009,_fy1009,_fex1009,_fey1009);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18_",100,812,2312);
   Graph_Graph1009->SetMinimum(-0.8947713);
   Graph_Graph1009->SetMaximum(2.574652);
   ...
   pol01010->SetParameter(0,0.101761);
   pol01010->SetParError(0,0.1102668);
