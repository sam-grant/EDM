void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:01:51 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3752,-0.3325148,2667.554,1.392126);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.193,2482.736);
   Graph_Graph1005->SetMinimum(-0.1600508);
   Graph_Graph1005->SetMaximum(1.219662);
   ...
   pol01006->SetParameter(0,0.3575901);
   pol01006->SetParError(0,0.0661558);
