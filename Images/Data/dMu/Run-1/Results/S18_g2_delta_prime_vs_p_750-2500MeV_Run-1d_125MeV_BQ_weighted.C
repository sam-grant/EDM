void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1d_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.3346,-1.134163,2837.572,1.582896);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1045 = new TH1F("Graph_Graph1045","S18_",100,653.9584,2594.949);
   Graph_Graph1045->SetMinimum(-0.8624573);
   Graph_Graph1045->SetMaximum(1.31119);
   ...
   pol01046->SetChisquare(15.23189);
   pol01046->SetNDF(13);
   ...
   pol01046->SetParameter(0,-0.02710344);
   pol01046->SetParError(0,0.05581675);
