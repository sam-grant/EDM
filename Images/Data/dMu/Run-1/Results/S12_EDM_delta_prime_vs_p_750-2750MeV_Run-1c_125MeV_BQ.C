...
//=========  (Mon Mar 21 21:45:14 2022) by ROOT version 6.24/06
   ...
   c->Range(350.3598,-1.177443,3144.417,2.572557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.8024427);
   Graph_Graph1001->SetMaximum(2.197557);
   ...
   pol01002->SetChisquare(10.69962);
   pol01002->SetNDF(15);
   ...
   pol01002->SetParameter(0,0.6975573);
   pol01002->SetParError(0,0.07937772);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.7
#pm0.08
 mrad","lpf");
