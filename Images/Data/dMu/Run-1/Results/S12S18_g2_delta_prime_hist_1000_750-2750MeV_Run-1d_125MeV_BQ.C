...
//=========  (Tue Mar 22 09:59:13 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.1971038,0.2040471);
   h__6->SetBinContent(10,652);
   h__6->SetBinContent(11,348);
