...
//=========  (Thu Feb  3 14:54:42 2022) by ROOT version 6.24/06
   ...
   TH1D *h__24 = new TH1D("h__24","S12S18",20,-0.1893925,0.216438);
   h__24->SetBinContent(10,671);
   h__24->SetBinContent(11,312);
   h__24->SetBinContent(12,16);
