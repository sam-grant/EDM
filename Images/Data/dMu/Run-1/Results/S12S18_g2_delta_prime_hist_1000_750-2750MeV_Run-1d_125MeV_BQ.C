...
//=========  (Thu Dec  2 14:47:09 2021) by ROOT version 6.24/04
   ...
   TH1D *h__24 = new TH1D("h__24","S12S18",20,-0.1796024,0.2273741);
   h__24->SetBinContent(10,20);
   h__24->SetBinContent(11,936);
   h__24->SetBinContent(12,44);
