void S12_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(820.0058,-0.2542304,2667.777,2.288073);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,1004.783,2483);
   Graph_Graph1001->SetMinimum(0);
   Graph_Graph1001->SetMaximum(2.033843);
   ...
   pol01002->SetChisquare(0.5821307);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,1.033843);
   pol01002->SetParError(0,0.1392995);
