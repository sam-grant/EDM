...
//=========  (Mon Nov  8 21:07:41 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12_",21,0.03452383,0.4574853);
   h__7->SetBinContent(9,1);
   h__7->SetBinContent(10,101);
   h__7->SetBinContent(11,555);
   h__7->SetBinContent(12,306);
   h__7->SetBinContent(13,36);
