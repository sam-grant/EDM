void S12_g2_delta_prime_vs_p_900-2250MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.06998529,2499.5,0.06975307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0140232,
   0.01424834};
   TGraphErrors *gre = new TGraphErrors(11,_fx1091,_fy1091,_fex1091,_fey1091);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1091 = new TH1F("Graph_Graph1091","S12_",100,812,2312);
   Graph_Graph1091->SetMinimum(-0.05601146);
   Graph_Graph1091->SetMaximum(0.05577923);
   ...
   pol01092->SetParameter(0,0.006936933);
   pol01092->SetParError(0,0.004268661);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0069
#pm0.004
 mrad","lpf");
