void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.6106,-1.053582,3038.124,1.259039);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-0.8223203);
   Graph_Graph1009->SetMaximum(1.027777);
   ...
   pol01010->SetChisquare(8.935762);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,-0.006262494);
   pol01010->SetParError(0,0.01534746);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00626
#pm0.02
 mrad","lpf");
