void S12S18_AEDM_vs_DS_blinded_825-2375MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,5.164799e-19,4.75,2.474646e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1012->SetMinimum(7.122965e-19);
   Graph_Graph1012->SetMaximum(2.278829e-18);
   ...
   pol01013->SetChisquare(11.54951);
   pol01013->SetNDF(3);
   ...
   pol01013->SetParameter(0,1.528944e-18);
   pol01013->SetParError(0,9.455952e-20);
