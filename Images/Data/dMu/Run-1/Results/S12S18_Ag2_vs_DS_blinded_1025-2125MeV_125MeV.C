void S12S18_Ag2_vs_DS_blinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-173.2922,4.75,131.9648);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-142.7665);
   Graph_Graph1003->SetMaximum(101.4391);
   ...
   pol01004->SetChisquare(1.503023);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,7.052513);
   pol01004->SetParError(0,28.07647);
