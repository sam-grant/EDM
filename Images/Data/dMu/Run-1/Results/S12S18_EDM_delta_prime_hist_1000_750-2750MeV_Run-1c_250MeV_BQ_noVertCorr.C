...
//=========  (Tue Mar 29 10:45:26 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",20,0.4787448,0.8866399);
   h__3->SetBinContent(9,13);
   h__3->SetBinContent(10,448);
   h__3->SetBinContent(11,495);
   h__3->SetBinContent(12,43);
