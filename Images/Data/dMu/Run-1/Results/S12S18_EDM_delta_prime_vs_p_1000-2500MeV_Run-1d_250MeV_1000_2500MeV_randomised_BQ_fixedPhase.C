void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:03:20 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3456,-0.0421923,2667.468,1.203309);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(0.08235788);
   Graph_Graph1005->SetMaximum(1.078759);
   ...
   pol01006->SetChisquare(6.658598);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.5100397);
   pol01006->SetParError(0,0.04000909);
