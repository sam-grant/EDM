void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:29:57 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.476,-0.1926262,2667.731,1.311408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.04222272);
   Graph_Graph1001->SetMaximum(1.161005);
   ...
   pol01002->SetChisquare(3.353124);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.5197258);
   pol01002->SetParError(0,0.06981778);
