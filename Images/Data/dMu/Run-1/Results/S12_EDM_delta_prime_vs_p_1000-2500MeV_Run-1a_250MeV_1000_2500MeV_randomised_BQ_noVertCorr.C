void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:09:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5479,-0.4581755,2668.079,1.533641);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.401,2483.226);
   Graph_Graph1001->SetMinimum(-0.2589939);
   Graph_Graph1001->SetMaximum(1.334459);
   ...
   Graph_Graph1001->GetYaxis()->SetTitle("#delta^{BLIND} [mrad] / 250 MeV");
   ...
   pol01002->SetChisquare(5.124097);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4302839);
   pol01002->SetParError(0,0.09963801);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.43
#pm0.1
 mrad","lpf");
