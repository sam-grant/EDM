void S12S18_Ag2_vs_DS_blinded_825-2375MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-142.7307,4.75,125.885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-115.8692);
   Graph_Graph1003->SetMaximum(99.0234);
   ...
   pol01004->SetParameter(0,14.32407);
   pol01004->SetParError(0,26.47583);
