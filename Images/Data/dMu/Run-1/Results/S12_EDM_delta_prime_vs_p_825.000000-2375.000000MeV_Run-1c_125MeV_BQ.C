void S12_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.045062,2655.75,2.339467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","S12_",100,799.5,2449.5);
   Graph_Graph1025->SetMinimum(-0.7066089);
   Graph_Graph1025->SetMaximum(2.001014);
   ...
   pol01026->SetParameter(0,0.616785);
   pol01026->SetParError(0,0.07297889);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.62
#pm0.07
 mrad","lpf");
