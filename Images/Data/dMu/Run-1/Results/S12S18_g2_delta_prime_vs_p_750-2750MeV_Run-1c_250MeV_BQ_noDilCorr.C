void S12S18_g2_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.2245,-1.017596,3037.802,1.09649);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1035->SetMinimum(-0.8061872);
   Graph_Graph1035->SetMaximum(0.8850817);
   ...
   pol01036->SetChisquare(13.46913);
   pol01036->SetNDF(7);
   ...
   pol01036->SetParameter(0,-0.002638731);
   pol01036->SetParError(0,0.007362534);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00264
#pm0.007
 mrad","lpf");
