...
//=========  (Tue Mar 29 10:44:10 2022) by ROOT version 6.24/06
   ...
   c->Range(453.4607,-1.3825,3038.641,2.336063);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-1.010644);
   Graph_Graph1001->SetMaximum(1.964206);
   ...
   pol01002->SetChisquare(4.153776);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.3890487);
   pol01002->SetParError(0,0.09447292);
