...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.04028475,2655.75,0.1152734);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01719614,
   0.01798014};
   TGraphErrors *gre = new TGraphErrors(12,_fx1065,_fy1065,_fex1065,_fey1065);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1065 = new TH1F("Graph_Graph1065","S12S18_",100,799.5,2449.5);
   ...
   pol01066->SetParameter(0,0.02698806);
   pol01066->SetParError(0,0.004959989);
