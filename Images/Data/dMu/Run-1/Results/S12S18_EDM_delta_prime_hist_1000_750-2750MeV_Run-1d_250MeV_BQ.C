...
//=========  (Tue Mar 29 11:55:52 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",20,0.3651034,0.7716944);
   h__3->SetBinContent(9,5);
   h__3->SetBinContent(10,457);
   h__3->SetBinContent(11,516);
   h__3->SetBinContent(12,21);
