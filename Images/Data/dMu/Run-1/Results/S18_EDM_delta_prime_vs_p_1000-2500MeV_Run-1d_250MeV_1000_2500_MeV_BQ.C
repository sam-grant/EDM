void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ()
{
...
//=========  (Fri May 13 12:30:37 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","S18",100,1004.044,2482.392);
   Graph_Graph1021->SetMinimum(-0.02187137);
   Graph_Graph1021->SetMaximum(1.467731);
   ...
   pol01022->SetChisquare(11.06765);
   pol01022->SetNDF(5);
   ...
   pol01022->SetParameter(0,0.5768072);
   pol01022->SetParError(0,0.06254959);
