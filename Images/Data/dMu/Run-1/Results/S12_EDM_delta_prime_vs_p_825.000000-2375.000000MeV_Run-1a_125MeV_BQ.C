void S12_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.8026504,2655.75,3.142678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12_",100,799.5,2449.5);
   Graph_Graph1001->SetMinimum(-0.4081175);
   Graph_Graph1001->SetMaximum(2.748145);
   ...
   pol01002->SetParameter(0,0.5440876);
   pol01002->SetParError(0,0.1042515);
