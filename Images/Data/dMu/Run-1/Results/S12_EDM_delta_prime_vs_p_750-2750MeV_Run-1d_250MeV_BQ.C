...
//=========  (Tue Mar 29 11:55:51 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.1429,-0.7935253,3039.225,2.086599);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.5055128);
   Graph_Graph1001->SetMaximum(1.798586);
   ...
   pol01002->SetChisquare(1.367456);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.5671836);
   pol01002->SetParError(0,0.05655648);
