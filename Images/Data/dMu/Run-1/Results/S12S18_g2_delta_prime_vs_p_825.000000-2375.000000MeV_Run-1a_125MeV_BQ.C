void S12S18_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.78596,2655.75,2.197049);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.354133,
   0.4603118};
   TGraphErrors *gre = new TGraphErrors(12,_fx1011,_fy1011,_fex1011,_fey1011);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18_",100,799.5,2449.5);
   Graph_Graph1011->SetMinimum(-1.387659);
   Graph_Graph1011->SetMaximum(1.798748);
   ...
   pol01012->SetParameter(0,-0.001811607);
   pol01012->SetParError(0,0.07532927);
