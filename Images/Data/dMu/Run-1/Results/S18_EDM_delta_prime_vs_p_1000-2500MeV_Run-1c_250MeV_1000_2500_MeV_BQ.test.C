void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.2582,-0.6834259,2667.531,1.506898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1015->SetMinimum(-0.4643934);
   Graph_Graph1015->SetMaximum(1.287866);
   ...
   pol01016->SetChisquare(7.748544);
   pol01016->SetNDF(5);
   ...
   pol01016->SetParameter(0,0.2033228);
