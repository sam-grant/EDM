void S18_g2_delta_prime_vs_p_825-2375MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.08371975,2655.75,0.1609779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02148839,
   0.02281829};
   TGraphErrors *gre = new TGraphErrors(12,_fx1081,_fy1081,_fex1081,_fey1081);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1081 = new TH1F("Graph_Graph1081","S18_",100,799.5,2449.5);
   Graph_Graph1081->SetMinimum(-0.05924998);
   Graph_Graph1081->SetMaximum(0.1365081);
   ...
   pol01082->SetParameter(0,-0.001057839);
   pol01082->SetParError(0,0.005967846);
