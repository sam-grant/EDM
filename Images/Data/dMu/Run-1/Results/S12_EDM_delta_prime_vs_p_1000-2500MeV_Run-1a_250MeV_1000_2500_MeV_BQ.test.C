void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.5576,-0.8202953,2668.079,1.277914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.6104744);
   Graph_Graph1001->SetMaximum(1.068093);
   ...
   pol01002->SetChisquare(4.871785);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.1354179);
