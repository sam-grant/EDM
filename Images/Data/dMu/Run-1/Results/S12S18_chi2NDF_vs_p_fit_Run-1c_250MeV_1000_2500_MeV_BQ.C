void S12S18_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3701,-0.2700262,2667.643,2.430236);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","",100,1004.197,2482.815);
   Graph_Graph1017->SetMinimum(0);
   Graph_Graph1017->SetMaximum(2.160209);
