void S12S18_g2_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.059,-1.037872,3038.275,1.113602);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-0.8227244);
   Graph_Graph1011->SetMaximum(0.8984543);
   ...
   pol01012->SetChisquare(10.26786);
   pol01012->SetNDF(7);
   ...
   pol01012->SetParameter(0,-0.006428513);
   pol01012->SetParError(0,0.01044128);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00643
#pm0.01
 mrad","lpf");
