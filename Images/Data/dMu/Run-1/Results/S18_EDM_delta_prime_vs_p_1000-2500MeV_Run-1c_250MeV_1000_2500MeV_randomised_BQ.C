...
//=========  (Tue May 24 20:12:13 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2636,-0.4860386,2667.528,1.766221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.2608127);
   Graph_Graph1003->SetMaximum(1.540995);
   ...
   pol01004->SetChisquare(8.366638);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.4625735);
