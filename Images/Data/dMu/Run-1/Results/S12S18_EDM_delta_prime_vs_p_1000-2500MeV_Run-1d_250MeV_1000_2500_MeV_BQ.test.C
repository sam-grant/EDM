void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.3444,-0.3989565,2667.468,0.6770425);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1023->SetMinimum(-0.2913566);
   Graph_Graph1023->SetMaximum(0.5694426);
   ...
   pol01024->SetChisquare(2.938451);
   pol01024->SetNDF(5);
   ...
   pol01024->SetParameter(0,0.1392416);
