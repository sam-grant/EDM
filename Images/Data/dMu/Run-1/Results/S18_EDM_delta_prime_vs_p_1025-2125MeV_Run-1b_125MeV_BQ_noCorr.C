...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.04375961,2312,0.1512561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1063->SetMinimum(-0.02425805);
   Graph_Graph1063->SetMaximum(0.1317545);
   ...
   pol01064->SetChisquare(8.256244);
   pol01064->SetNDF(8);
   ...
   pol01064->SetParameter(0,0.03032988);
   pol01064->SetParError(0,0.008058583);
