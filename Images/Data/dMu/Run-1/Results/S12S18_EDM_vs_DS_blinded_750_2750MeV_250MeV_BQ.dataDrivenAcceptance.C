void S12S18_EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ.dataDrivenAcceptance()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 20:45:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.35,1.138465e-18,4.85,5.198882e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(1.544507e-18);
   Graph_Graph1003->SetMaximum(4.79284e-18);
   ...
   pol01004->SetChisquare(16.53469);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,3.175994e-18);
   pol01004->SetParError(0,1.726443e-19);
