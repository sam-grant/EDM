void S12S18_AEDM_vs_DS_blinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,4.399924e-19,4.75,2.409147e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1012->SetMinimum(6.369079e-19);
   Graph_Graph1012->SetMaximum(2.212231e-18);
   ...
   pol01013->SetChisquare(11.06285);
   pol01013->SetNDF(3);
   ...
   pol01013->SetParameter(0,1.485783e-18);
   pol01013->SetParError(0,9.516423e-20);
