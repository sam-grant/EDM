void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:30:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.149,-0.5204833,2667.287,1.65708);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,1003.963,2482.473);
   Graph_Graph1009->SetMinimum(-0.3027269);
   Graph_Graph1009->SetMaximum(1.439324);
   ...
   pol01010->SetChisquare(6.589036);
   pol01010->SetNDF(5);
   ...
   pol01010->SetParameter(0,0.3942282);
   pol01010->SetParError(0,0.1024702);
