void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5532,-1.421349,3038.337,1.764412);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1031->SetMinimum(-1.102773);
   Graph_Graph1031->SetMaximum(1.445836);
   ...
   pol01032->SetChisquare(10.08238);
   pol01032->SetNDF(7);
   ...
   pol01032->SetParameter(0,0.01832461);
   pol01032->SetParError(0,0.03674774);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0183
#pm0.04
 mrad","lpf");
