void S12_g2_delta_prime_plus_vs_p_750-2500MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 12:58:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.3999,-2.20831,2728.91,1.527635);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1061 = new TH1F("Graph_Graph1061","S12",100,736.7509,2507.559);
   Graph_Graph1061->SetMinimum(-1.834716);
   Graph_Graph1061->SetMaximum(1.154041);
   ...
   pol01062->SetChisquare(6.553313);
   pol01062->SetNDF(6);
   ...
   pol01062->SetParameter(0,-0.04556034);
   pol01062->SetParError(0,0.09004996);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0456
#pm0.09
 mrad","lpf");
