void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:20:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2626,-0.2110363,2667.66,1.237822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.102,2482.82);
   Graph_Graph1001->SetMinimum(-0.06615045);
   Graph_Graph1001->SetMaximum(1.092937);
   ...
   pol01002->SetChisquare(2.143582);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3744385);
   pol01002->SetParError(0,0.06128672);
