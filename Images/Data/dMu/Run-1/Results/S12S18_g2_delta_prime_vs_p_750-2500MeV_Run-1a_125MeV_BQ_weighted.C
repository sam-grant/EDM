void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.5072,-1.789098,2837.475,1.809935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18_",100,654.104,2594.878);
   Graph_Graph1011->SetMinimum(-1.429195);
   Graph_Graph1011->SetMaximum(1.450031);
   ...
   pol01012->SetChisquare(17.46882);
   pol01012->SetNDF(13);
   ...
   pol01012->SetParameter(0,-0.01789319);
   pol01012->SetParError(0,0.07414056);
