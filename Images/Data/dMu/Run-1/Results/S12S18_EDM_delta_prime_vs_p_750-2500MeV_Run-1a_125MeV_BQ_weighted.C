void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.5072,-0.6905345,2837.475,2.779657);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.3435154);
   Graph_Graph1005->SetMaximum(2.432638);
   ...
   pol01006->SetChisquare(13.08177);
   pol01006->SetNDF(13);
   ...
   pol01006->SetParameter(0,0.4330132);
   pol01006->SetParError(0,0.07406961);
