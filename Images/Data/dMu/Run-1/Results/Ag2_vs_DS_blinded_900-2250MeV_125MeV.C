void Ag2_vs_DS_blinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-272.1617,4.75,327.3568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(-212.2099);
   Graph_Graph_Graph10011005->SetMaximum(267.405);
   ...
   fit1005->SetParameter(0,20.59204);
   fit1005->SetParError(0,26.8163);
   ...
   shift_-11006->SetParameter(0,-6.224265);
   ...
   shift_11007->SetParameter(0,47.40834);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-212.2099);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(267.405);
   ...
   Graph_Graph_Graph10021007->SetMinimum(-194.287);
   Graph_Graph_Graph10021007->SetMaximum(249.1428);
   ...
   Graph_Graph_Graph10031008->SetMinimum(-119.9599);
   Graph_Graph_Graph10031008->SetMaximum(116.7773);
   ...
   pol01009->SetParameter(0,20.59204);
   pol01009->SetParError(0,26.8163);
