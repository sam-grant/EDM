void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 13:08:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.4911,-1.668046,2728.721,1.561269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S18",100,735.9141,2507.298);
   Graph_Graph1017->SetMinimum(-1.345115);
   Graph_Graph1017->SetMaximum(1.238337);
   ...
   Graph_Graph1017->GetYaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad] / 250 MeV");
   ...
   pol01018->SetParameter(0,0.03257172);
   pol01018->SetParError(0,0.05466048);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0326
#pm0.05
 mrad","lpf");
