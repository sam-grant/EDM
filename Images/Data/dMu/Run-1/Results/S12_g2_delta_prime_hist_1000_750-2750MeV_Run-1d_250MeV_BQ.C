...
//=========  (Tue Mar 29 11:55:53 2022) by ROOT version 6.24/06
   ...
   TH1D *h__4 = new TH1D("h__4","S12",20,-0.1581238,0.24431);
   h__4->SetBinContent(10,636);
   h__4->SetBinContent(11,364);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.04226
#pm9e-05
");
   pt_LaTex = pt->AddText("0.0028
#pm6e-05
");
   pt->Draw();
   c->Modified();
