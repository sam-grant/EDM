...
//=========  (Fri Apr  8 20:43:33 2022) by ROOT version 6.24/06
   ...
   TH1D *h__22 = new TH1D("h__22","S12",20,-0.1596531,0.2439455);
   h__22->SetBinContent(10,647);
   h__22->SetBinContent(11,353);
