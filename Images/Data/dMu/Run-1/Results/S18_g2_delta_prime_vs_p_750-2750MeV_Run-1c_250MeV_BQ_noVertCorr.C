void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:45:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9039,-1.985212,3037.134,2.380078);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,711.3269,2778.711);
   Graph_Graph1009->SetMinimum(-1.548683);
   Graph_Graph1009->SetMaximum(1.943549);
   ...
   pol01010->SetChisquare(10.10178);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,-0.02158537);
   pol01010->SetParError(0,0.08268562);
