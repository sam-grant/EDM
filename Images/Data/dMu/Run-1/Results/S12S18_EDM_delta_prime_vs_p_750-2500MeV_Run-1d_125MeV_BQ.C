...
//=========  (Thu Dec  2 14:43:45 2021) by ROOT version 6.24/04
   ...
   c->Range(411.5527,-0.391102,2837.367,1.169912);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S12S18",100,654.1341,2594.785);
   Graph_Graph1041->SetMinimum(-0.2350006);
   Graph_Graph1041->SetMaximum(1.01381);
   ...
   pol01042->SetChisquare(9.958412);
   pol01042->SetNDF(13);
   ...
   pol01042->SetParameter(0,0.538249);
   pol01042->SetParError(0,0.03783829);
