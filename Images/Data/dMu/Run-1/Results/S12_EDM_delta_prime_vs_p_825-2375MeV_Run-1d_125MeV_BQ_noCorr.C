void S12_EDM_delta_prime_vs_p_825-2375MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.03697394,2655.75,0.09288761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01404083,
   0.01468001};
   TGraphErrors *gre = new TGraphErrors(12,_fx1085,_fy1085,_fex1085,_fey1085);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1085 = new TH1F("Graph_Graph1085","S12_",100,799.5,2449.5);
   Graph_Graph1085->SetMinimum(-0.02398778);
   Graph_Graph1085->SetMaximum(0.07990146);
   ...
   pol01086->SetParameter(0,0.03890718);
   pol01086->SetParError(0,0.004096942);
