...
//=========  (Thu Feb  3 11:00:04 2022) by ROOT version 6.24/06
   ...
   TH1D *h__11 = new TH1D("h__11","S18",21,-0.327083,0.1040747);
   h__11->SetBinContent(9,1);
   h__11->SetBinContent(10,70);
   h__11->SetBinContent(11,757);
   h__11->SetBinContent(12,172);
