...
//=========  (Thu Nov 18 09:29:39 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-296.7593,4.75,262.3674);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(-240.8467);
   Graph_Graph1002->SetMaximum(206.4547);
