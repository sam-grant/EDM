...
//=========  (Thu Nov 18 12:02:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-296.9912,4.75,263.6068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(-240.9314);
   Graph_Graph1002->SetMaximum(207.5469);
