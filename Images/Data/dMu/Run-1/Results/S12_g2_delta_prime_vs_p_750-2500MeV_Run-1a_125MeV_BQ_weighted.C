void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.8032,-2.734802,2837.119,2.296581);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-2.231664);
   Graph_Graph1007->SetMaximum(1.793442);
   ...
   pol01008->SetParameter(0,-0.09153256);
   pol01008->SetParError(0,0.102724);
