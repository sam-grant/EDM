...
//=========  (Mon Nov  8 21:07:39 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.5671897,2499.5,2.175324);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18_",100,812,2312);
   ...
   pol01006->SetParameter(0,0.3924682);
   pol01006->SetParError(0,0.07637253);
