...
//=========  (Thu Dec  2 14:46:58 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.1824,-1.376118,3144.099,1.506867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,629.5741,2864.708);
   Graph_Graph1011->SetMinimum(-1.08782);
   Graph_Graph1011->SetMaximum(1.218569);
   ...
   pol01012->SetChisquare(17.88484);
   pol01012->SetNDF(15);
   ...
   pol01012->SetParameter(0,-0.0002783855);
   pol01012->SetParError(0,0.07229474);
