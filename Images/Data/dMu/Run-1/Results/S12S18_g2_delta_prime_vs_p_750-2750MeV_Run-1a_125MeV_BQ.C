...
//=========  (Mon Mar 21 21:37:09 2022) by ROOT version 6.24/06
   ...
   c->Range(350.182,-1.912161,3144.09,1.83784);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-1.537161);
   Graph_Graph1011->SetMaximum(1.462839);
   ...
   pol01012->SetChisquare(18.11616);
   pol01012->SetNDF(15);
   ...
   pol01012->SetParameter(0,-0.03716052);
   pol01012->SetParError(0,0.08108467);
