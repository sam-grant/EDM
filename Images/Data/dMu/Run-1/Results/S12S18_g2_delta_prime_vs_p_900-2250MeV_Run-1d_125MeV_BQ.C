...
//=========  (Mon Nov  8 21:07:50 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.5649953,2499.5,0.7845773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.1552173,
   0.1836175};
   TGraphErrors *gre = new TGraphErrors(11,_fx1047,_fy1047,_fex1047,_fey1047);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","S12S18_",100,812,2312);
   Graph_Graph1047->SetMinimum(-0.430038);
   ...
   pol01048->SetParameter(0,0.04782404);
   pol01048->SetParError(0,0.03932819);
