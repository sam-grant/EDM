void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:38 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5042,-1.707203,3038.389,1.970939);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.339389);
   Graph_Graph1007->SetMaximum(1.603124);
   ...
   pol01008->SetChisquare(7.484854);
   pol01008->SetNDF(7);
   ...
   pol01008->SetParameter(0,-0.024787);
   pol01008->SetParError(0,0.05254636);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0248
#pm0.05
 mrad","lpf");
