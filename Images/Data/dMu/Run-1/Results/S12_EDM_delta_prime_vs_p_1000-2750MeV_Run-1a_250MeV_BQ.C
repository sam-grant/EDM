void S12_EDM_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.6619,-1.655402,2977.557,2.393293);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-1.250532);
   Graph_Graph1001->SetMaximum(1.988423);
   ...
   pol01002->SetChisquare(5.572007);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,0.5609146);
   pol01002->SetParError(0,0.1132894);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.56
#pm0.1
 mrad","lpf");
