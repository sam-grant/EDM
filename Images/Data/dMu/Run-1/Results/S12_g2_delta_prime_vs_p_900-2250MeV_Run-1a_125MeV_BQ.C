...
//=========  (Mon Nov  8 21:07:39 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.416477,2499.5,2.227201);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12_",100,812,2312);
   Graph_Graph1007->SetMinimum(-1.052109);
   ...
   pol01008->SetParameter(0,-0.05305544);
   pol01008->SetParError(0,0.1058303);
