void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:30:36 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3701,0.07778804,2667.643,1.323507);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1017->SetMinimum(0.2023599);
   Graph_Graph1017->SetMaximum(1.198935);
   ...
   pol01018->SetChisquare(2.455852);
   pol01018->SetNDF(5);
   ...
   pol01018->SetParameter(0,0.6067237);
   pol01018->SetParError(0,0.05451406);
