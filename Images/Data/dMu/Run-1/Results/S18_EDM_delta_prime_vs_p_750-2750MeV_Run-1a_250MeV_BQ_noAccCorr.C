void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.6106,-1.466284,3038.124,1.658613);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.153794);
   Graph_Graph1003->SetMaximum(1.346123);
   ...
   pol01004->SetChisquare(5.538073);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.1110972);
   pol01004->SetParError(0,0.05448086);
