...
//=========  (Mon Nov  8 21:07:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.5148314,2499.5,1.355259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2075648,
   0.2429514};
   TGraphErrors *gre = new TGraphErrors(11,_fx1037,_fy1037,_fex1037,_fey1037);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1037 = new TH1F("Graph_Graph1037","S12_",100,812,2312);
   Graph_Graph1037->SetMinimum(-0.3278223);
   Graph_Graph1037->SetMaximum(1.16825);
   ...
   pol01038->SetParameter(0,0.4957336);
   pol01038->SetParError(0,0.05402528);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.5
#pm0.05
 mrad","lpf");
