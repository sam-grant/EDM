...
//=========  (Mon Nov  8 21:07:42 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.496864,2499.5,1.481404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3476094,
   0.4116511};
   TGraphErrors *gre = new TGraphErrors(11,_fx1019,_fy1019,_fex1019,_fey1019);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12_",100,812,2312);
   ...
   pol01020->SetParameter(0,-0.00904186);
   pol01020->SetParError(0,0.09025881);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.009
#pm0.09
 mrad","lpf");
