...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.02668208,2312,0.1263727);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1065->SetMaximum(0.1110672);
   ...
   pol01066->SetChisquare(8.492867);
   pol01066->SetNDF(8);
   ...
   pol01066->SetParameter(0,0.02544001);
   pol01066->SetParError(0,0.005571077);
