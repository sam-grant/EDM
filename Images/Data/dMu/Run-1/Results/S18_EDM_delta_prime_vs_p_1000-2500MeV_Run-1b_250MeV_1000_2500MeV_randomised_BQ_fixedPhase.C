void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:01:50 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1514,-0.5472863,2667.292,1.82337);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1003.966,2482.478);
   Graph_Graph1003->SetMinimum(-0.3102206);
   Graph_Graph1003->SetMaximum(1.586304);
   ...
   pol01004->SetChisquare(8.132152);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.3726423);
   pol01004->SetParError(0,0.1024768);
