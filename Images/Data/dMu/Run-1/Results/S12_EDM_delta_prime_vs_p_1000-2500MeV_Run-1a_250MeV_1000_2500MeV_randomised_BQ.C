...
//=========  (Tue Oct 11 15:36:04 2022) by ROOT version 6.26/04
   ...
   c->Range(819.5479,-0.4986142,2668.079,1.487936);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.2999592);
   Graph_Graph1001->SetMaximum(1.289281);
   ...
   pol01002->SetParameter(0,0.4600543);
   pol01002->SetParError(0,0.1111629);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.46
#pm0.1
 mrad","lpf");
