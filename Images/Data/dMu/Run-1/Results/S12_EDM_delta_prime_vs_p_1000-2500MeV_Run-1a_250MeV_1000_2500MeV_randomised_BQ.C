...
//=========  (Thu Oct  6 23:12:08 2022) by ROOT version 6.26/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(819.5479,-0.4704671,2668.079,1.397862);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.2836342);
   Graph_Graph1001->SetMaximum(1.21103);
   ...
   pol01002->SetChisquare(3.495563);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4584666);
   pol01002->SetParError(0,0.1040134);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.458
#pm0.1
 mrad","lpf");
