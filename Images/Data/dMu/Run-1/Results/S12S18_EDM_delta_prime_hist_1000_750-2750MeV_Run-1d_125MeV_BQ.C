...
//=========  (Tue Mar 22 09:59:11 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",20,0.3920608,0.7989544);
   h__3->SetBinContent(9,8);
   h__3->SetBinContent(10,454);
   h__3->SetBinContent(11,509);
   h__3->SetBinContent(12,28);
