...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.02364284,2499.5,0.1039883);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01398119,
   0.01425231};
   TGraphErrors *gre = new TGraphErrors(11,_fx1077,_fy1077,_fex1077,_fey1077);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1077 = new TH1F("Graph_Graph1077","S12S18_",100,812,2312);
   ...
   pol01078->SetParameter(0,0.04664303);
   pol01078->SetParError(0,0.004248399);
