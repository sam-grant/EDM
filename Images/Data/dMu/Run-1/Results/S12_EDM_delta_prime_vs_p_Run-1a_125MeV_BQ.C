void S12_EDM_delta_prime_vs_p_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 11:21:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.9224682,2843.25,4.061273);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12_",100,649.5,2599.5);
   Graph_Graph1001->SetMinimum(-0.424094);
   Graph_Graph1001->SetMaximum(3.562899);
   ...
   pol01002->SetChisquare(10.35737);
   pol01002->SetNDF(13);
   ...
   pol01002->SetParameter(0,0.5790408);
   pol01002->SetParError(0,0.102417);
