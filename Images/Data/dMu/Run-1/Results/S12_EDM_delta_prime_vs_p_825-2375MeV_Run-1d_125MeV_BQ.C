void S12_EDM_delta_prime_vs_p_825-2375MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:38 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.5148314,2655.75,1.355259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1037 = new TH1F("Graph_Graph1037","S12_",100,799.5,2449.5);
   ...
   pol01038->SetParameter(0,0.5026327);
   pol01038->SetParError(0,0.0532345);
