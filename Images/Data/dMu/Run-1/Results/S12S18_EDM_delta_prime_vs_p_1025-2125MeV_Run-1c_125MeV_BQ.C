...
//=========  (Mon Nov  8 21:10:10 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1150176,2312,1.300701);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1029->SetMinimum(0.02655427);
   Graph_Graph1029->SetMaximum(1.159129);
   ...
   pol01030->SetChisquare(5.623609);
   pol01030->SetNDF(8);
   ...
   pol01030->SetParameter(0,0.6050904);
   pol01030->SetParError(0,0.05637746);
