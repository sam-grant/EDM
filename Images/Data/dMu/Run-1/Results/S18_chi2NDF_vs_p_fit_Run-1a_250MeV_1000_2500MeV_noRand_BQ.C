void S18_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.446,-0.2650354,2667.844,2.385318);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1004.286,2483.004);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(2.120283);
   ...
   pol01004->SetChisquare(0.4065062);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,1.120283);
   pol01004->SetParError(0,0.1164054);
