void S18_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 17:50:13 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",51,0.05212239,1.082555);
   h__2->SetBinContent(20,1);
   h__2->SetBinContent(21,6);
   h__2->SetBinContent(22,19);
   h__2->SetBinContent(23,92);
   h__2->SetBinContent(24,125);
   h__2->SetBinContent(25,198);
   h__2->SetBinContent(26,208);
   h__2->SetBinContent(27,153);
   h__2->SetBinContent(28,98);
   h__2->SetBinContent(29,67);
   h__2->SetBinContent(30,20);
   h__2->SetBinContent(31,7);
