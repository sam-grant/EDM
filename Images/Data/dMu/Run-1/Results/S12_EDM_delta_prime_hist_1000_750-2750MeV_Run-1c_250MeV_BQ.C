...
//=========  (Fri Apr  8 20:43:22 2022) by ROOT version 6.24/06
   ...
   TH1D *h__13 = new TH1D("h__13","S12",20,0.7787676,1.190636);
   h__13->SetBinContent(8,2);
   h__13->SetBinContent(9,73);
   h__13->SetBinContent(10,379);
   h__13->SetBinContent(11,424);
   h__13->SetBinContent(12,113);
   h__13->SetBinContent(13,7);
   h__13->SetBinContent(14,2);
