void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.7194,-1.812301,2728.173,1.466285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1061 = new TH1F("Graph_Graph1061","S18",100,736.0648,2506.828);
   Graph_Graph1061->SetMinimum(-1.484442);
   Graph_Graph1061->SetMaximum(1.138426);
   ...
   pol01062->SetChisquare(4.874347);
   pol01062->SetNDF(6);
   ...
   pol01062->SetParameter(0,-0.1111141);
   pol01062->SetParError(0,0.09856894);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.111
#pm0.1
 mrad","lpf");
