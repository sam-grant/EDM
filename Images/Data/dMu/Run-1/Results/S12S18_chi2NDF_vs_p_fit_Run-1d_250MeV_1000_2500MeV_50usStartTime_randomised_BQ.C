void S12S18_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:48:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2245,-0.2376622,2667.425,2.138959);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.045,2482.605);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(1.901297);
   ...
   Graph_Graph1005->GetYaxis()->SetTitle("#chi^{2}/NDF / 250 MeV");
   ...
   pol01006->SetChisquare(0.8956177);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.9012972);
   pol01006->SetParError(0,0.1727829);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.9
#pm0.2
","lpf");
