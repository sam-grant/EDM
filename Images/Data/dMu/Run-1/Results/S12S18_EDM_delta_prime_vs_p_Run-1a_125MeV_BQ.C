...
//=========  (Mon Nov  8 11:21:54 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.6565759,2843.25,2.774887);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.3134296);
   Graph_Graph1005->SetMaximum(2.431741);
   ...
   pol01006->SetChisquare(12.69275);
   pol01006->SetNDF(13);
   ...
   pol01006->SetParameter(0,0.411836);
