...
//=========  (Tue Mar 29 11:55:52 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",20,0.3626526,0.7692658);
   h__1->SetBinContent(9,6);
   h__1->SetBinContent(10,458);
   h__1->SetBinContent(11,515);
   h__1->SetBinContent(12,20);
