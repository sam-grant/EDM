void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 13:08:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.3999,-1.572818,2728.91,1.267292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S12",100,736.7509,2507.559);
   Graph_Graph1015->SetMinimum(-1.288807);
   Graph_Graph1015->SetMaximum(0.9832805);
   ...
   pol01016->SetChisquare(6.400415);
   pol01016->SetNDF(6);
   ...
   pol01016->SetParameter(0,-0.03363729);
   pol01016->SetParError(0,0.05260461);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0336
#pm0.05
 mrad","lpf");
