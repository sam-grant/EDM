...
//=========  (Mon Nov  8 21:10:14 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.5255024,2312,1.643626);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1039->SetMinimum(-0.3085895);
   ...
   pol01040->SetChisquare(18.89146);
   pol01040->SetNDF(8);
   ...
   pol01040->SetParameter(0,0.4947661);
   pol01040->SetParError(0,0.06026588);
