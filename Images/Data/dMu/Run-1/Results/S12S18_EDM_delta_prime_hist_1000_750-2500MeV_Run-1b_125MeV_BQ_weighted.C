...
//=========  (Tue Nov 23 11:03:18 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","S12S18_",20,0.150173,0.5657968);
   h__9->SetBinContent(7,1);
   h__9->SetBinContent(9,16);
   h__9->SetBinContent(10,103);
   h__9->SetBinContent(11,320);
   h__9->SetBinContent(12,370);
   h__9->SetBinContent(13,145);
   h__9->SetBinContent(14,39);
