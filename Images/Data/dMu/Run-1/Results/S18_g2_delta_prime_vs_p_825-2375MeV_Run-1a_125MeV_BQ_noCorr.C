...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1285126,2655.75,0.2236073);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03033956,
   0.0320471};
   TGraphErrors *gre = new TGraphErrors(12,_fx1057,_fy1057,_fex1057,_fey1057);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1057 = new TH1F("Graph_Graph1057","S18_",100,799.5,2449.5);
   Graph_Graph1057->SetMinimum(-0.09330057);
   ...
   pol01058->SetParameter(0,0.00378117);
   pol01058->SetParError(0,0.00843663);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0038
#pm0.008
 mrad","lpf");
