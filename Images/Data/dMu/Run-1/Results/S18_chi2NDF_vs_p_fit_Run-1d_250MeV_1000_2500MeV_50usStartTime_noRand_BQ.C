void S18_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500MeV_50usStartTime_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:47:58 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1932,-0.2377679,2667.129,2.139911);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1003.987,2482.336);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(1.902143);
   ...
   Graph_Graph1003->GetYaxis()->SetTitle("#chi^{2}/NDF / 250 MeV");
   ...
   pol01004->SetChisquare(0.2841249);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.9021432);
   pol01004->SetParError(0,0.09731819);
