...
//=========  (Thu Dec  2 14:46:57 2021) by ROOT version 6.24/04
   ...
   c->Range(350.3299,-2.094959,3144.485,2.184205);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,629.7454,2865.069);
   Graph_Graph1007->SetMinimum(-1.667043);
   Graph_Graph1007->SetMaximum(1.756289);
   ...
   pol01008->SetChisquare(12.77669);
   pol01008->SetNDF(15);
   ...
   pol01008->SetParameter(0,-0.06472379);
   pol01008->SetParError(0,0.1000312);
