...
//=========  (Thu Feb  3 10:59:54 2022) by ROOT version 6.24/06
   ...
   c->Range(350.3282,-1.983174,3144.479,1.766826);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.608174);
   Graph_Graph1007->SetMaximum(1.391826);
   ...
   pol01008->SetChisquare(12.84819);
   pol01008->SetNDF(15);
   ...
   pol01008->SetParameter(0,-0.1081741);
   pol01008->SetParError(0,0.1098511);
