...
//=========  (Mon Mar 21 21:45:16 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.1055,-1.937126,3143.568,1.812874);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,629.4518,2864.222);
   Graph_Graph1009->SetMinimum(-1.562126);
   Graph_Graph1009->SetMaximum(1.437874);
   ...
   pol01010->SetChisquare(17.05193);
   pol01010->SetNDF(15);
   ...
   pol01010->SetParameter(0,-0.06212584);
   pol01010->SetParError(0,0.08465011);
