...
//=========  (Mon Nov  8 11:21:55 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-2.517783,2843.25,2.693322);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-1.996672);
   Graph_Graph1009->SetMaximum(2.172212);
   ...
   pol01010->SetChisquare(15.19217);
   pol01010->SetNDF(13);
   ...
   pol01010->SetParameter(0,0.07360335);
   pol01010->SetParError(0,0.1069428);
