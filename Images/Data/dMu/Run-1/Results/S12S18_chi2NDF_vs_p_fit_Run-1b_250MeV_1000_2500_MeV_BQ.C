void S12S18_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3734,-0.2513542,2667.556,2.262188);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,1004.192,2482.737);
   Graph_Graph1011->SetMinimum(0);
   Graph_Graph1011->SetMaximum(2.010834);
