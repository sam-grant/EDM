void S12S18_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:29 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.5794053,2655.75,1.835137);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S12S18_",100,799.5,2449.5);
   Graph_Graph1017->SetMinimum(-0.337951);
   Graph_Graph1017->SetMaximum(1.593683);
   ...
   pol01018->SetParameter(0,0.3304527);
   pol01018->SetParError(0,0.06433127);
