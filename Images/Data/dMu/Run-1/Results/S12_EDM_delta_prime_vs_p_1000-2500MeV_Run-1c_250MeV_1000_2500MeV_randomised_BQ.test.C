void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:39:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.476,-0.4834971,2667.731,1.004429);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.3347045);
   Graph_Graph1001->SetMaximum(0.8556365);
   ...
   pol01002->SetChisquare(3.264705);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.2245177);
