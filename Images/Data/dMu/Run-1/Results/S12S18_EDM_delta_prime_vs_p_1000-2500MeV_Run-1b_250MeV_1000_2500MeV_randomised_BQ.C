...
//=========  (Mon Jun 13 18:32:18 2022) by ROOT version 6.24/06
   ...
   c->Range(819.3752,-0.3763425,2667.554,1.148831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-0.2238252);
   Graph_Graph1011->SetMaximum(0.9963133);
   ...
   pol01012->SetChisquare(3.992417);
   pol01012->SetNDF(5);
   ...
   pol01012->SetParameter(0,0.2609465);
   pol01012->SetParError(0,0.06615487);
