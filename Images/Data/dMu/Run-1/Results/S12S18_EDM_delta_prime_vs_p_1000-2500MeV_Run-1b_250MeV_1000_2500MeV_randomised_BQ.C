...
//=========  (Tue Aug 23 11:13:42 2022) by ROOT version 6.26/04
   ...
   c->Range(819.3752,-0.3620975,2667.554,1.031375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,1004.193,2482.736);
   Graph_Graph1011->SetMinimum(-0.2227502);
   Graph_Graph1011->SetMaximum(0.8920279);
   ...
   pol01012->SetChisquare(3.314654);
   pol01012->SetNDF(5);
   ...
   pol01012->SetParameter(0,0.240901);
   pol01012->SetParError(0,0.0597847);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.24
#pm0.06
 mrad","lpf");
