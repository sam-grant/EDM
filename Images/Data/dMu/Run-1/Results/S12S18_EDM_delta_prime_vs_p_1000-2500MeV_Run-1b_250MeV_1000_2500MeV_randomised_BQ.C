...
//=========  (Tue May 24 20:06:46 2022) by ROOT version 6.24/06
   ...
   c->Range(819.3752,-0.3760167,2667.554,1.149109);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.2235042);
   Graph_Graph1005->SetMaximum(0.9965961);
   ...
   pol01006->SetChisquare(3.996563);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.2610477);
