void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9039,-0.9458616,3037.134,1.186053);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1027->SetMinimum(-0.7326701);
   Graph_Graph1027->SetMaximum(0.9728618);
   ...
   pol01028->SetChisquare(14.61415);
   pol01028->SetNDF(7);
   ...
   pol01028->SetParameter(0,0.08553887);
   pol01028->SetParError(0,0.010728);
