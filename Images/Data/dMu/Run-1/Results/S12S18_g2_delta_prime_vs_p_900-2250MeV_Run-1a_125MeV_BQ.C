...
//=========  (Mon Nov  8 21:07:40 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.088455,2499.5,2.119548);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2993538,
   0.354133};
   TGraphErrors *gre = new TGraphErrors(11,_fx1011,_fy1011,_fex1011,_fey1011);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18_",100,812,2312);
   Graph_Graph1011->SetMinimum(-0.7676548);
   ...
   pol01012->SetParameter(0,0.02049036);
   pol01012->SetParError(0,0.07635869);
