...
//=========  (Thu Oct  6 23:18:03 2022) by ROOT version 6.26/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18",30,0.1192127,0.4249985);
   h__2->SetBinContent(8,1);
   h__2->SetBinContent(9,8);
   h__2->SetBinContent(10,30);
   h__2->SetBinContent(11,63);
   h__2->SetBinContent(12,159);
   h__2->SetBinContent(13,217);
   h__2->SetBinContent(14,230);
   h__2->SetBinContent(15,155);
   h__2->SetBinContent(16,84);
   h__2->SetBinContent(17,34);
   h__2->SetBinContent(18,13);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2531
#pm0.0006
");
   pt_LaTex = pt->AddText("0.0179
#pm0.0004
");
   pt->Draw();
   c->Modified();
