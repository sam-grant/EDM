...
//=========  (Wed May 11 17:50:13 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",51,-0.0486966,0.9801476);
   h__1->SetBinContent(22,1);
   h__1->SetBinContent(23,27);
   h__1->SetBinContent(24,129);
   h__1->SetBinContent(25,231);
   h__1->SetBinContent(26,278);
   h__1->SetBinContent(27,199);
   h__1->SetBinContent(28,96);
   h__1->SetBinContent(29,31);
   h__1->SetBinContent(30,6);
