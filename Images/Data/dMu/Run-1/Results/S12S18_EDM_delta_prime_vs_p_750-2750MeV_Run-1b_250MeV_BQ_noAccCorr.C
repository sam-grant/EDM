void S12S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.0928,-1.252201,3038.419,1.737014);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1017->SetMinimum(-0.9532792);
   Graph_Graph1017->SetMaximum(1.438093);
   ...
   pol01018->SetChisquare(9.788957);
   pol01018->SetNDF(7);
   ...
   pol01018->SetParameter(0,0.1952879);
   pol01018->SetParError(0,0.0322705);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.195
#pm0.03
 mrad","lpf");
