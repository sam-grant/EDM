void S12S18_EDM_vs_DS_blinded_1000_2500MeV_250MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:40:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.35,-7.110394e-19,4.85,1.071257e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-5.328097e-19);
   Graph_Graph1003->SetMaximum(8.930278e-19);
   ...
   pol01004->SetChisquare(7.926717);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,2.590753e-19);
   pol01004->SetParError(0,9.300959e-20);
