...
//=========  (Mon Nov  8 21:07:39 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.324373,2499.5,2.217178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18_",100,812,2312);
   ...
   pol01004->SetParameter(0,0.2220485);
   pol01004->SetParError(0,0.110304);
