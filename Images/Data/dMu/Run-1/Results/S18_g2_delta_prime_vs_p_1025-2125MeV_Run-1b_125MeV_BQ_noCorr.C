...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1141753,2312,0.08007401);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1069->SetMinimum(-0.09475036);
   Graph_Graph1069->SetMaximum(0.06064908);
   ...
   pol01070->SetChisquare(4.202242);
   pol01070->SetNDF(8);
   ...
   pol01070->SetParameter(0,-0.009684278);
   pol01070->SetParError(0,0.008056575);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0097
#pm0.008
 mrad","lpf");
