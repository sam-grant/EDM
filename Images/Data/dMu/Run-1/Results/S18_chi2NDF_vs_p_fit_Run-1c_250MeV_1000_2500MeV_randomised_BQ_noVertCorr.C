void S18_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:14:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2636,-0.2843869,2667.528,2.559482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1004.09,2482.702);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(2.275095);
   ...
   pol01004->SetChisquare(0.7619048);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,1.275095);
   pol01004->SetParError(0,0.1593638);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 1.3
#pm0.2
","lpf");
