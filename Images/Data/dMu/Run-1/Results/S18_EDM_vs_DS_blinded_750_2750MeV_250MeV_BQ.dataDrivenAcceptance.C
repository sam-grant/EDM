void S18_EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ.dataDrivenAcceptance()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 20:45:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-5.361766e-19,4.75,5.052283e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(2.266938e-20);
   Graph_Graph1002->SetMaximum(4.493437e-18);
