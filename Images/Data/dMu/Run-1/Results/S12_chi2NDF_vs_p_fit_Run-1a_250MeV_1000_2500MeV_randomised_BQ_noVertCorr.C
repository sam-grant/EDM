void S12_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:11:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5479,-0.2548451,2668.079,2.293606);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMaximum(2.03876);
   ...
   pol01002->SetChisquare(0.5033543);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,1.03876);
   pol01002->SetParError(0,0.1295318);
