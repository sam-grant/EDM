...
//=========  (Mon Nov  8 11:21:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.2930837,0.1183135);
   h__4->SetBinContent(9,4);
   h__4->SetBinContent(10,241);
   h__4->SetBinContent(11,644);
   h__4->SetBinContent(12,111);
