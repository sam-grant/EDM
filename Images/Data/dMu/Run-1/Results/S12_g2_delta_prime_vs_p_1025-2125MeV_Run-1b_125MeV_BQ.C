...
//=========  (Mon Nov  8 21:10:08 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.241079,2312,1.181462);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-0.9988248);
   Graph_Graph1019->SetMaximum(0.939208);
   ...
   pol01020->SetChisquare(4.769302);
   pol01020->SetNDF(8);
   ...
   pol01020->SetParameter(0,-0.004500633);
   pol01020->SetParError(0,0.09469428);
