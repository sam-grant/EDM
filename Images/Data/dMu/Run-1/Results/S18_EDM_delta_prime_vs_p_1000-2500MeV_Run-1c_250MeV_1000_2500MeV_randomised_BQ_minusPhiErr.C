void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_minusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:20:28 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2636,-0.4855277,2667.528,1.766058);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.2603691);
   Graph_Graph1003->SetMaximum(1.540899);
   ...
   pol01004->SetChisquare(8.355623);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.4627066);
   pol01004->SetParError(0,0.08485611);
