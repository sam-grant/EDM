void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:27:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4016,-0.8850535,2667.941,0.7775108);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.256,2483.087);
   Graph_Graph1005->SetMinimum(-0.718797);
   Graph_Graph1005->SetMaximum(0.6112544);
   ...
   pol01006->SetChisquare(4.017007);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,-0.004001525);
   pol01006->SetParError(0,0.07741228);
