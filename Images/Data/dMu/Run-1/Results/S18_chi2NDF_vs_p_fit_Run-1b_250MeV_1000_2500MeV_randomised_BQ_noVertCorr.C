void S18_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:12:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1514,-0.2383649,2667.292,2.145284);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1003.966,2482.478);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(1.906919);
   ...
   pol01004->SetChisquare(0.2567933);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.9069188);
   pol01004->SetParError(0,0.09251906);
