void S12S18_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:07:52 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",50,-0.2119805,0.7921645);
   h__3->SetBinContent(23,25);
   h__3->SetBinContent(24,231);
   h__3->SetBinContent(25,498);
   h__3->SetBinContent(26,222);
