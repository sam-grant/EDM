...
//=========  (Mon Nov  8 21:07:44 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.3231083,2499.5,1.421127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2090009,
   0.2466107};
   TGraphErrors *gre = new TGraphErrors(11,_fx1029,_fy1029,_fex1029,_fey1029);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18_",100,812,2312);
   Graph_Graph1029->SetMinimum(-0.1486848);
   Graph_Graph1029->SetMaximum(1.246703);
   ...
   pol01030->SetParameter(0,0.5911868);
   pol01030->SetParError(0,0.05371374);
