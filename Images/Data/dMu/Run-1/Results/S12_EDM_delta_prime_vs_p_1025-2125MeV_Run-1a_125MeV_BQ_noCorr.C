...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.08276073,2312,0.1428819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1049->SetMinimum(-0.06019647);
   Graph_Graph1049->SetMaximum(0.1203176);
   ...
   pol01050->SetChisquare(4.459331);
   pol01050->SetNDF(8);
   ...
   pol01050->SetParameter(0,0.04232209);
   pol01050->SetParError(0,0.009025146);
