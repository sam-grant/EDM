void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:29:33 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2626,-0.2261257,2667.66,1.214545);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.08205861);
   Graph_Graph1001->SetMaximum(1.070478);
   ...
   pol01002->SetChisquare(2.054234);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3571728);
   pol01002->SetParError(0,0.06128568);
