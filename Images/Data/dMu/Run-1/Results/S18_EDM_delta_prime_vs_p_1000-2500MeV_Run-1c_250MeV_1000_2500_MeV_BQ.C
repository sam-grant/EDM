void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:30:36 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2582,-0.3279358,2667.531,2.019328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S18",100,1004.085,2482.703);
   Graph_Graph1015->SetMinimum(-0.09320942);
   Graph_Graph1015->SetMaximum(1.784601);
   ...
   Graph_Graph1015->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 250 MeV");
   ...
   pol01016->SetChisquare(10.68693);
   pol01016->SetNDF(5);
   ...
   pol01016->SetParameter(0,0.6129486);
   pol01016->SetParError(0,0.08486528);
