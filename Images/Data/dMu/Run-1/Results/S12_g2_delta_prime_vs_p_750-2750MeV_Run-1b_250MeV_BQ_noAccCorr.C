void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.4607,-1.708783,3038.641,1.287285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-1.409176);
   Graph_Graph1019->SetMaximum(0.987678);
   ...
   pol01020->SetChisquare(6.927389);
   pol01020->SetNDF(7);
   ...
   pol01020->SetParameter(0,-0.01133462);
   pol01020->SetParError(0,0.04479392);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0113
#pm0.04
 mrad","lpf");
