...
//=========  (Tue Aug 30 13:18:20 2022) by ROOT version 6.26/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12",30,0.3498514,0.6506674);
   h__7->SetBinContent(15,510);
   h__7->SetBinContent(16,490);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.5002
#pm2e-05
");
   pt_LaTex = pt->AddText("0.000725
#pm2e-05
");
   pt->Draw();
   c->Modified();
