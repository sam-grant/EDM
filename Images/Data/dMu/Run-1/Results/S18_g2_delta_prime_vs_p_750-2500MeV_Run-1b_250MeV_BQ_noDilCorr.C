void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.7194,-1.090061,2728.173,1.023935);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","S18",100,736.0648,2506.828);
   Graph_Graph1021->SetMinimum(-0.8786614);
   Graph_Graph1021->SetMaximum(0.8125353);
   ...
   pol01022->SetParameter(0,-0.0176923);
   pol01022->SetParError(0,0.01368637);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0177
#pm0.01
 mrad","lpf");
