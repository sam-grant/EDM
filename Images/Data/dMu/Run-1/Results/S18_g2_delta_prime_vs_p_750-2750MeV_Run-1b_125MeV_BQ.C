...
//=========  (Mon Mar 21 21:43:21 2022) by ROOT version 6.24/06
   ...
   c->Range(350.0628,-1.979172,3143.649,1.770828);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,629.4215,2864.291);
   Graph_Graph1009->SetMinimum(-1.604172);
   Graph_Graph1009->SetMaximum(1.395828);
   ...
   pol01010->SetChisquare(16.77231);
   pol01010->SetNDF(15);
   ...
   pol01010->SetParameter(0,-0.1041723);
   pol01010->SetParError(0,0.1005051);
