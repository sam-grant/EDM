...
//=========  (Mon Mar 21 21:45:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.226,-1.902584,3144.042,1.847416);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-1.527584);
   Graph_Graph1011->SetMaximum(1.472416);
   ...
   pol01012->SetChisquare(18.24918);
   pol01012->SetNDF(15);
   ...
   pol01012->SetParameter(0,-0.02758376);
   pol01012->SetParError(0,0.05809272);
