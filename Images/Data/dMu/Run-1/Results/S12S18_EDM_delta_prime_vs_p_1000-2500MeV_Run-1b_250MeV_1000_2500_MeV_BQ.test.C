void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.3734,-0.655689,2667.556,0.9653508);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,1004.192,2482.737);
   Graph_Graph1011->SetMinimum(-0.493585);
   Graph_Graph1011->SetMaximum(0.8032468);
   ...
   Graph_Graph1011->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 250 MeV");
   ...
   pol01012->SetParameter(0,-0.03283129);
   pol01012->SetParError(0,0.0661546);
