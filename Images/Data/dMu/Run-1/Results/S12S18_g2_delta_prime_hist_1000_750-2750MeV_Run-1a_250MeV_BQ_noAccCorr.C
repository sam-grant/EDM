void S12S18_g2_delta_prime_hist_1000_750-2750MeV_Run-1a_250MeV_BQ_noAccCorr()
{
...
//=========  (Wed Apr 20 00:10:39 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.1962347,0.2044868);
   h__6->SetBinContent(10,646);
   h__6->SetBinContent(11,354);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.003828
#pm3e-05
");
   pt_LaTex = pt->AddText("0.00085
#pm2e-05
");
   pt->Draw();
   c->Modified();
