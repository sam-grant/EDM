...
//=========  (Mon Nov  8 21:06:08 2021) by ROOT version 6.24/04
   ...
   TH1D *h__16 = new TH1D("h__16","S12_",20,-0.1955409,0.2068796);
   h__16->SetBinContent(10,19);
   h__16->SetBinContent(11,835);
   h__16->SetBinContent(12,146);
