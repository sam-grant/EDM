...
//=========  (Thu Dec  2 14:43:42 2021) by ROOT version 6.24/04
   ...
   TH1D *h__16 = new TH1D("h__16","S12",20,-0.1932435,0.2223911);
   h__16->SetBinContent(10,92);
   h__16->SetBinContent(11,849);
   h__16->SetBinContent(12,59);
