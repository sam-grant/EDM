void S18_EDM_delta_prime_vs_p_900-2250MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.5740411,2499.5,1.649019);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2288503,
   0.2696057};
   TGraphErrors *gre = new TGraphErrors(11,_fx1039,_fy1039,_fex1039,_fey1039);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1039 = new TH1F("Graph_Graph1039","S18_",100,812,2312);
   Graph_Graph1039->SetMinimum(-0.351735);
   Graph_Graph1039->SetMaximum(1.426713);
   ...
   pol01040->SetParameter(0,0.4899131);
   pol01040->SetParError(0,0.05742872);
