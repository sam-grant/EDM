...
//=========  (Thu Nov 18 09:29:18 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.9951231,2843.25,1.413789);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1035->SetMinimum(-0.7542319);
   Graph_Graph1035->SetMaximum(1.172898);
   ...
   pol01036->SetChisquare(20.36803);
   pol01036->SetNDF(13);
   ...
   pol01036->SetParameter(0,-0.005710509);
   pol01036->SetParError(0,0.05204942);
