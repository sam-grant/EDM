...
//=========  (Mon Mar 21 21:45:15 2022) by ROOT version 6.24/06
   ...
   c->Range(350.3598,-1.871439,3144.417,1.878561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.496439);
   Graph_Graph1007->SetMaximum(1.503561);
   ...
   pol01008->SetChisquare(15.16456);
   pol01008->SetNDF(15);
   ...
   pol01008->SetParameter(0,0.003560843);
   pol01008->SetParError(0,0.07986148);
