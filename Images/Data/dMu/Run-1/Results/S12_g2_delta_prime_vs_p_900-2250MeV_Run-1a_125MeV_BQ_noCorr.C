...
//=========  (Mon Nov  8 21:07:50 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.1117912,2499.5,0.1638761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02731647,
   0.02771823};
   TGraphErrors *gre = new TGraphErrors(11,_fx1055,_fy1055,_fex1055,_fey1055);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1055 = new TH1F("Graph_Graph1055","S12_",100,812,2312);
   Graph_Graph1055->SetMinimum(-0.08422451);
   Graph_Graph1055->SetMaximum(0.1363093);
   ...
   pol01056->SetParameter(0,-0.005042364);
   pol01056->SetParError(0,0.008362835);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.005
#pm0.008
 mrad","lpf");
