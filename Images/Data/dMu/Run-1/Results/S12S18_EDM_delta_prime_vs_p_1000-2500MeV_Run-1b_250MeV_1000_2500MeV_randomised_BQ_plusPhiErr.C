void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:11:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3752,-0.376931,2667.554,1.148317);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.2244062);
   Graph_Graph1005->SetMaximum(0.995792);
   ...
   pol01006->SetChisquare(3.985189);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.260763);
   pol01006->SetParError(0,0.06615505);
