void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:38:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(820.0058,-0.4907089,2667.777,1.30285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.783,2483);
   Graph_Graph1001->SetMinimum(-0.311353);
   Graph_Graph1001->SetMaximum(1.123494);
   ...
   pol01002->SetParameter(0,0.4627436);
   pol01002->SetParError(0,0.08129897);
