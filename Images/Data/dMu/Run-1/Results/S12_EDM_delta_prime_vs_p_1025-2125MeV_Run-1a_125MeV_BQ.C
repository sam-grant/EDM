void S12_EDM_delta_prime_vs_p_1025-2125MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:10:05 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-1.044968,2312,1.80408);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12_",100,962,2162);
   Graph_Graph1001->SetMinimum(-0.7600631);
   Graph_Graph1001->SetMaximum(1.519175);
   ...
   pol01002->SetParameter(0,0.5292161);
   pol01002->SetParError(0,0.1111373);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.53
#pm0.1
 mrad","lpf");
