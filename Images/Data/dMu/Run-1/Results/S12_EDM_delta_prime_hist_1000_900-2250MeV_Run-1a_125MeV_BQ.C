...
//=========  (Mon Nov  8 21:07:39 2021) by ROOT version 6.24/04
   ...
   TH1D *h__1 = new TH1D("h__1","S12_",23,0.2969257,0.762569);
   h__1->SetBinContent(9,2);
   h__1->SetBinContent(10,24);
   h__1->SetBinContent(11,125);
   h__1->SetBinContent(12,265);
   h__1->SetBinContent(13,303);
   h__1->SetBinContent(14,187);
   h__1->SetBinContent(15,65);
   h__1->SetBinContent(16,23);
