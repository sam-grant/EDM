void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:41:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3977,-0.2615652,2667.765,1.391352);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.234,2482.928);
   Graph_Graph1003->SetMinimum(-0.09627351);
   Graph_Graph1003->SetMaximum(1.22606);
   ...
   pol01004->SetChisquare(5.857522);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.4251655);
   pol01004->SetParError(0,0.06798747);
