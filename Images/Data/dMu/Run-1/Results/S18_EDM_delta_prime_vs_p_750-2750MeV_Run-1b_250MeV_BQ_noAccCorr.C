void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.7258,-1.48862,3038.141,1.825725);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1015->SetMinimum(-1.157185);
   Graph_Graph1015->SetMaximum(1.494291);
   ...
   pol01016->SetChisquare(7.443989);
   pol01016->SetNDF(7);
   ...
   pol01016->SetParameter(0,0.2162378);
   pol01016->SetParError(0,0.0465648);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.216
#pm0.05
 mrad","lpf");
