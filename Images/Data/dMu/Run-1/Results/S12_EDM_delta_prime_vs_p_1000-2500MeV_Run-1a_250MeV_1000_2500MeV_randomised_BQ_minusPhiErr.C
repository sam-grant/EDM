void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_minusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:19:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5479,-0.4854187,2668.079,1.525437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.2843332);
   Graph_Graph1001->SetMaximum(1.324351);
   ...
   pol01002->SetChisquare(5.143348);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4201392);
   pol01002->SetParError(0,0.0996356);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.42
#pm0.1
 mrad","lpf");
