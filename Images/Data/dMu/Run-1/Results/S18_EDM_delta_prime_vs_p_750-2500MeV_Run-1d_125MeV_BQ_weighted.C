void S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1d_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.3346,-1.009135,2837.572,1.96957);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1039 = new TH1F("Graph_Graph1039","S18_",100,653.9584,2594.949);
   Graph_Graph1039->SetMinimum(-0.7112645);
   Graph_Graph1039->SetMaximum(1.671699);
   ...
   pol01040->SetChisquare(23.92761);
   pol01040->SetNDF(13);
   ...
   pol01040->SetParameter(0,0.5228873);
   pol01040->SetParError(0,0.05578011);
