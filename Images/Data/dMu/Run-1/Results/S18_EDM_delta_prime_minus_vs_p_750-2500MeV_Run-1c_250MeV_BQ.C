void S18_EDM_delta_prime_minus_vs_p_750-2500MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.6398,-1.013057,2728.454,2.738184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1083 = new TH1F("Graph_Graph1083","S18",100,736.0212,2507.073);
   Graph_Graph1083->SetMinimum(-0.6379332);
   Graph_Graph1083->SetMaximum(2.36306);
   ...
   Graph_Graph1083->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01084->SetChisquare(10.91057);
   pol01084->SetNDF(6);
   ...
   pol01084->SetParameter(0,0.6549691);
   pol01084->SetParError(0,0.08568102);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.655
#pm0.09
 mrad","lpf");
