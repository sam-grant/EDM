...
//=========  (Fri Apr  8 20:43:36 2022) by ROOT version 6.24/06
   ...
   TH1D *h__24 = new TH1D("h__24","S12S18",20,-0.1892615,0.2132072);
   h__24->SetBinContent(10,653);
   h__24->SetBinContent(11,347);
