...
//=========  (Tue Mar 29 11:55:54 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.1823258,0.2190475);
   h__6->SetBinContent(10,645);
   h__6->SetBinContent(11,355);
