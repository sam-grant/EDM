...
//=========  (Thu Dec  2 14:43:37 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12",20,-0.2969872,0.1163262);
   h__4->SetBinContent(9,1);
   h__4->SetBinContent(10,207);
   h__4->SetBinContent(11,715);
   h__4->SetBinContent(12,77);
