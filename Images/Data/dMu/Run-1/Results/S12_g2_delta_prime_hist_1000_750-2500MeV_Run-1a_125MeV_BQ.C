...
//=========  (Mon Nov  8 21:06:02 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.2926928,0.1191568);
   h__4->SetBinContent(9,4);
   h__4->SetBinContent(10,244);
   h__4->SetBinContent(11,639);
   h__4->SetBinContent(12,113);
