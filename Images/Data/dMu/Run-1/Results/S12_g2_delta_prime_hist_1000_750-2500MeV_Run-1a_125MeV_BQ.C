...
//=========  (Thu Nov 18 11:46:26 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.3080359,0.1031575);
   h__4->SetBinContent(9,9);
   h__4->SetBinContent(10,266);
   h__4->SetBinContent(11,599);
   h__4->SetBinContent(12,126);
