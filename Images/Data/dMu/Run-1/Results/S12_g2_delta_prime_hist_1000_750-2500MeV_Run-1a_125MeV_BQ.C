...
//=========  (Thu Nov 18 09:29:12 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.3085679,0.1015571);
   h__4->SetBinContent(9,8);
   h__4->SetBinContent(10,249);
   h__4->SetBinContent(11,615);
   h__4->SetBinContent(12,128);
