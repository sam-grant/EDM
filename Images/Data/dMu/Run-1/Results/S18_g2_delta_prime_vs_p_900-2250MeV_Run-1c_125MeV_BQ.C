...
//=========  (Mon Nov  8 21:07:45 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.089106,2499.5,2.193845);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.312385,
   0.371818};
   TGraphErrors *gre = new TGraphErrors(11,_fx1033,_fy1033,_fex1033,_fey1033);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1033 = new TH1F("Graph_Graph1033","S18_",100,812,2312);
   Graph_Graph1033->SetMinimum(-0.7608108);
   Graph_Graph1033->SetMaximum(1.86555);
   ...
   pol01034->SetParameter(0,0.0101219);
   pol01034->SetParError(0,0.07793858);
