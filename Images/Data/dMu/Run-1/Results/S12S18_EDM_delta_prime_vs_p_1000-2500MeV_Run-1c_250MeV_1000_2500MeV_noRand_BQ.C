void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:41:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.6266,-0.02044146,2667.726,1.034253);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.437,2482.916);
   Graph_Graph1005->SetMinimum(0.08502795);
   Graph_Graph1005->SetMaximum(0.9287831);
   ...
   pol01006->SetParameter(0,0.4862152);
   pol01006->SetParError(0,0.0438357);
