...
//=========  (Tue Mar 29 11:41:03 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.020789,0.4234601);
   h__2->SetBinContent(10,452);
   h__2->SetBinContent(11,548);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2226
#pm0.0001
");
   pt_LaTex = pt->AddText("0.0036
#pm8e-05
");
   pt->Draw();
   c->Modified();
