void S18_AEDM_vs_DS_blinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-5.742831e-21,4.75,2.089612e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1047->SetMinimum(1.572758e-20);
   Graph_Graph1047->SetMaximum(1.874908e-19);
