void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.149,-0.8903807,2667.287,1.146269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-0.6867157);
   Graph_Graph1009->SetMaximum(0.9426041);
   ...
   pol01010->SetChisquare(4.395215);
   pol01010->SetNDF(5);
   ...
   pol01010->SetParameter(0,-0.01535637);
