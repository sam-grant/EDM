void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:30:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3444,0.006259641,2667.468,1.184592);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18",100,1004.157,2482.655);
   Graph_Graph1023->SetMinimum(0.1240929);
   Graph_Graph1023->SetMaximum(1.066759);
   ...
   pol01024->SetChisquare(4.964745);
   pol01024->SetNDF(5);
   ...
   pol01024->SetParameter(0,0.524486);
   pol01024->SetParError(0,0.03996682);
