void S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.4911,-1.015378,2728.721,1.144376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,735.9141,2507.298);
   Graph_Graph1003->SetMinimum(-0.7994021);
   Graph_Graph1003->SetMaximum(0.9284007);
   ...
   pol01004->SetChisquare(6.671126);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.02756832);
   pol01004->SetParError(0,0.01586736);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0276
#pm0.02
 mrad","lpf");
