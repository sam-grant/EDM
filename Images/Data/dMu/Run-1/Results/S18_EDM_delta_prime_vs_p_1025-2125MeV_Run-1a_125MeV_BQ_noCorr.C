...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1056196,2312,0.200703);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1051->SetMaximum(0.1700707);
   ...
   pol01052->SetParameter(0,0.01618306);
   pol01052->SetParError(0,0.009423022);
