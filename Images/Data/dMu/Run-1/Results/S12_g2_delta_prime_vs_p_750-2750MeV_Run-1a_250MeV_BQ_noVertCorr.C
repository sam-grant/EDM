...
//=========  (Tue Mar 29 10:43:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5042,-2.04698,3038.389,2.234036);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.618879);
   Graph_Graph1007->SetMaximum(1.805935);
   ...
   pol01008->SetChisquare(7.021846);
   pol01008->SetNDF(7);
   ...
   pol01008->SetParameter(0,-0.05473591);
   pol01008->SetParError(0,0.1113731);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.055
#pm0.1
 mrad","lpf");
