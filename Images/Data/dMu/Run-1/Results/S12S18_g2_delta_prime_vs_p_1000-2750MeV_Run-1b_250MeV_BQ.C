void S12S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:37:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.3719,-1.588747,2977.563,1.511585);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,979.3911,2755.544);
   Graph_Graph1011->SetMinimum(-1.278714);
   Graph_Graph1011->SetMaximum(1.201552);
   ...
   pol01012->SetChisquare(9.918159);
   pol01012->SetNDF(6);
   ...
   pol01012->SetParameter(0,-0.08231338);
   pol01012->SetParError(0,0.07064241);
