...
//=========  (Tue Mar 29 10:47:27 2022) by ROOT version 6.24/06
   ...
   c->Range(452.8467,-1.605057,3037.552,1.809986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-1.263553);
   Graph_Graph1009->SetMaximum(1.468482);
   ...
   pol01010->SetChisquare(14.93896);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,0.0137019);
   pol01010->SetParError(0,0.06093649);
