...
//=========  (Mon Nov  8 21:10:15 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.632392,2312,1.201742);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1043->SetMinimum(-0.4489786);
   Graph_Graph1043->SetMaximum(1.018329);
   ...
   pol01044->SetParameter(0,0.1097499);
   pol01044->SetParError(0,0.05664927);
