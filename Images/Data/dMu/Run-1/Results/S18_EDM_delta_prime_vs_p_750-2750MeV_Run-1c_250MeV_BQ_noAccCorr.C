void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9039,-1.03836,3037.134,2.34529);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1027->SetMinimum(-0.699995);
   Graph_Graph1027->SetMaximum(2.006925);
   ...
   pol01028->SetChisquare(11.75973);
   pol01028->SetNDF(7);
   ...
   pol01028->SetParameter(0,0.3138007);
   pol01028->SetParError(0,0.03850101);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.314
#pm0.04
 mrad","lpf");
