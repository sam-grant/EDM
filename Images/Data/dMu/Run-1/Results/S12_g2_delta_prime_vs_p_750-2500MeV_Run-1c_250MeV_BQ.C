void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:54 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.5161,-1.802246,2728.522,1.717678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1091 = new TH1F("Graph_Graph1091","S12",100,736.8167,2507.221);
   Graph_Graph1091->SetMinimum(-1.450254);
   Graph_Graph1091->SetMaximum(1.365686);
   ...
   pol01092->SetChisquare(8.781648);
   pol01092->SetNDF(6);
   ...
   pol01092->SetParameter(0,0.01030189);
   pol01092->SetParError(0,0.07244474);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0103
#pm0.07
 mrad","lpf");
