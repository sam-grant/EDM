void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:44:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.7258,-1.675463,3038.141,2.838786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,711.2674,2779.6);
   Graph_Graph1003->SetMinimum(-1.224038);
   Graph_Graph1003->SetMaximum(2.387361);
   ...
   pol01004->SetChisquare(9.758295);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.4415786);
   pol01004->SetParError(0,0.09923487);
