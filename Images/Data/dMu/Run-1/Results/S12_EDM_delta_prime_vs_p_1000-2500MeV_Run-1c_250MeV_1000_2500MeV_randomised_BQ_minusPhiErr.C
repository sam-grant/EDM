void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_minusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:20:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.476,-0.1950611,2667.731,1.291112);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.302,2482.906);
   Graph_Graph1001->SetMinimum(-0.04644376);
   Graph_Graph1001->SetMaximum(1.142494);
   ...
   pol01002->SetChisquare(3.250888);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.5120587);
   pol01002->SetParError(0,0.06981643);
