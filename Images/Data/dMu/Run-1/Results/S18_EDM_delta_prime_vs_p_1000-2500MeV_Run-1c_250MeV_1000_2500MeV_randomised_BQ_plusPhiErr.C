void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:12:28 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2636,-0.4865328,2667.528,1.766377);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.2612418);
   Graph_Graph1003->SetMaximum(1.541086);
   ...
   pol01004->SetChisquare(8.377036);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.4624495);
   pol01004->SetParError(0,0.08485688);
