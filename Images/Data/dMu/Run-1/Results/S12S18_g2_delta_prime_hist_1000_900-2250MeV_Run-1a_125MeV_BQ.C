...
//=========  (Mon Nov  8 21:07:40 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",20,-0.1929656,0.2144523);
   h__6->SetBinContent(10,38);
   h__6->SetBinContent(11,935);
   h__6->SetBinContent(12,27);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.02048
#pm0.0002
");
   pt_LaTex = pt->AddText("0.0055
#pm0.0001
");
   pt->Draw();
   c->Modified();
