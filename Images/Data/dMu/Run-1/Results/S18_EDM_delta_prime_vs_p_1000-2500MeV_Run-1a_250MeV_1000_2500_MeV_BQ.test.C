void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:01 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.2545,-1.139324,2667.768,1.177595);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.106,2482.917);
   Graph_Graph1003->SetMinimum(-0.9076319);
   Graph_Graph1003->SetMaximum(0.945903);
   ...
   pol01004->SetChisquare(4.132474);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,-0.2293682);
   pol01004->SetParError(0,0.1198686);
