void S12_g2_delta_prime_vs_p_1000-2750MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:39:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.517,-1.757969,2977.544,1.9501);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,979.5197,2755.541);
   Graph_Graph1007->SetMinimum(-1.387162);
   Graph_Graph1007->SetMaximum(1.579293);
   ...
   pol01008->SetParameter(0,-0.002943321);
   pol01008->SetParError(0,0.08000436);
