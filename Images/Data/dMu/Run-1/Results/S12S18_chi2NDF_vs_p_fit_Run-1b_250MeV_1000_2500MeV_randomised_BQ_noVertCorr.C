void S12S18_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:12:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3752,-0.2349191,2667.554,2.114272);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.193,2482.736);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(1.879353);
   ...
   pol01006->SetChisquare(0.2101464);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.8793527);
   pol01006->SetParError(0,0.08369516);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.88
#pm0.08
","lpf");
