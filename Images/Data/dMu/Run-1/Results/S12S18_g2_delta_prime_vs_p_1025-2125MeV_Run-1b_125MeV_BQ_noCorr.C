...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.07776658,2312,0.05874219);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1071->SetMinimum(-0.0641157);
   Graph_Graph1071->SetMaximum(0.04509131);
   ...
   pol01072->SetChisquare(8.237491);
   pol01072->SetNDF(8);
   ...
   pol01072->SetParameter(0,-0.005174209);
   pol01072->SetParError(0,0.005565079);
