...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.009109317,2312,0.1030146);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1077->SetMinimum(0.002103079);
   Graph_Graph1077->SetMaximum(0.09180224);
   ...
   pol01078->SetChisquare(3.379172);
   pol01078->SetNDF(8);
   ...
   pol01078->SetParameter(0,0.04968102);
   pol01078->SetParError(0,0.004584432);
