void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.7258,-1.086115,3038.141,1.104493);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-0.8670543);
   Graph_Graph1021->SetMaximum(0.8854318);
   ...
   pol01022->SetChisquare(7.132958);
   pol01022->SetNDF(7);
   ...
   pol01022->SetParameter(0,-0.01290794);
   pol01022->SetParError(0,0.01313327);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0129
#pm0.01
 mrad","lpf");
