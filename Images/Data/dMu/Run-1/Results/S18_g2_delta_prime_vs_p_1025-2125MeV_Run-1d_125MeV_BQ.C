...
//=========  (Mon Nov  8 21:10:16 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.864162,2312,0.7871957);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1045->SetMaximum(0.6220599);
   ...
   pol01046->SetChisquare(10.60844);
   pol01046->SetNDF(8);
   ...
   pol01046->SetParameter(0,-0.04008761);
   pol01046->SetParError(0,0.06018717);
