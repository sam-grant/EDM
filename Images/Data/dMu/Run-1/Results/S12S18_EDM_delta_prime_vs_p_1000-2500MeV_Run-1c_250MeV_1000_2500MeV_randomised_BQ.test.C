void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:39:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3707,-0.3815422,2667.643,0.9161435);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.2517736);
   Graph_Graph1005->SetMaximum(0.7863749);
   ...
   pol01006->SetChisquare(2.845967);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.2153165);
   pol01006->SetParError(0,0.0545111);
