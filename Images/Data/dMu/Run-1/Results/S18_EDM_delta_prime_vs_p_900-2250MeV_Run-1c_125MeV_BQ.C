void S18_EDM_delta_prime_vs_p_900-2250MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.5354768,2499.5,2.105401);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3096521,
   0.3666304};
   TGraphErrors *gre = new TGraphErrors(11,_fx1027,_fy1027,_fex1027,_fey1027);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1027 = new TH1F("Graph_Graph1027","S18_",100,812,2312);
   Graph_Graph1027->SetMinimum(-0.271389);
   Graph_Graph1027->SetMaximum(1.841313);
   ...
   pol01028->SetParameter(0,0.5916051);
   pol01028->SetParError(0,0.07800608);
