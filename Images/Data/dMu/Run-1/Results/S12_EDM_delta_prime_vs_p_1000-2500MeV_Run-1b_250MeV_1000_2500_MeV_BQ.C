void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500_MeV_BQ()
{
...
//=========  (Fri May 13 12:30:35 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1007->SetMinimum(-0.1992838);
   Graph_Graph1007->SetMaximum(1.637836);
   ...
   pol01008->SetChisquare(4.128769);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,0.3033743);
