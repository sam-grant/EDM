...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.07602083,2312,0.09414268);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1079->SetMaximum(0.07712633);
   ...
   pol01080->SetChisquare(7.681788);
   pol01080->SetNDF(8);
   ...
   pol01080->SetParameter(0,-7.452353e-05);
   pol01080->SetParError(0,0.006314766);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -7.5e-05
#pm0.006
 mrad","lpf");
