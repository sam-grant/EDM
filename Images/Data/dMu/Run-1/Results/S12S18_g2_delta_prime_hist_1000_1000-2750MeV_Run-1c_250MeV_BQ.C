void S12S18_g2_delta_prime_hist_1000_1000-2750MeV_Run-1c_250MeV_BQ()
{
...
//=========  (Tue Mar 29 11:39:32 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2402495,0.1601788);
   h__6->SetBinContent(10,543);
   h__6->SetBinContent(11,457);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.04013
#pm2e-05
");
   pt_LaTex = pt->AddText("0.00072
#pm2e-05
");
   pt->Draw();
   c->Modified();
