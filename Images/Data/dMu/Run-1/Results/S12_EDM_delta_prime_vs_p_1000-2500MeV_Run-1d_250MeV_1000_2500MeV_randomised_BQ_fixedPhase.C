void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:03:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4447,-0.09050442,2667.685,1.252928);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.269,2482.861);
   Graph_Graph1001->SetMinimum(0.04383887);
   Graph_Graph1001->SetMaximum(1.118585);
   ...
   pol01002->SetChisquare(2.139324);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4479744);
   pol01002->SetParError(0,0.05101293);
