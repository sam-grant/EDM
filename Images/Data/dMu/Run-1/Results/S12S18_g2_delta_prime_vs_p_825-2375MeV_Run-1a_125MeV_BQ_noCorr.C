...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.08983926,2655.75,0.1562266);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02046632,
   0.02163886};
   TGraphErrors *gre = new TGraphErrors(12,_fx1059,_fy1059,_fex1059,_fey1059);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1059 = new TH1F("Graph_Graph1059","S12S18_",100,799.5,2449.5);
   Graph_Graph1059->SetMinimum(-0.06523268);
   ...
   pol01060->SetParameter(0,-0.001711177);
   pol01060->SetParError(0,0.005821612);
