void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.6106,-1.033908,3038.124,1.167957);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,711.1619,2779.572);
   Graph_Graph1003->SetMinimum(-0.8137215);
   Graph_Graph1003->SetMaximum(0.9477702);
   ...
   pol01004->SetChisquare(5.663082);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.03038301);
   pol01004->SetParError(0,0.01512863);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0304
#pm0.02
 mrad","lpf");
