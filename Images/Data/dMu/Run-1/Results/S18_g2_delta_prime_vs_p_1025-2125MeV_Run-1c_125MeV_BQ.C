...
//=========  (Mon Nov  8 21:10:11 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.265225,2312,0.7527448);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1033->SetMinimum(-1.063428);
   Graph_Graph1033->SetMaximum(0.5509478);
   ...
   pol01034->SetChisquare(7.570279);
   pol01034->SetNDF(8);
   ...
   pol01034->SetParameter(0,-0.01904723);
   pol01034->SetParError(0,0.08171906);
