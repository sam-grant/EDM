void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:30:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3752,-0.3711785,2667.554,1.166806);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.21738);
   Graph_Graph1005->SetMaximum(1.013007);
   ...
   pol01006->SetChisquare(4.094978);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.2695633);
   pol01006->SetParError(0,0.06615545);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.27
#pm0.07
 mrad","lpf");
