...
//=========  (Tue Mar 29 11:42:37 2022) by ROOT version 6.24/06
   ...
   c->Range(452.7258,-1.688711,3038.141,2.844783);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMaximum(2.391434);
   ...
   pol01004->SetChisquare(9.801728);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.4349059);
   pol01004->SetParError(0,0.09923472);
