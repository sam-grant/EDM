...
//=========  (Thu Dec  2 14:46:58 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12",21,0.126248,0.558254);
   h__7->SetBinContent(8,1);
   h__7->SetBinContent(9,4);
   h__7->SetBinContent(10,136);
   h__7->SetBinContent(11,409);
   h__7->SetBinContent(12,350);
   h__7->SetBinContent(13,88);
   h__7->SetBinContent(14,11);
