...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.04365659,2312,0.1589509);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1075->SetMaximum(0.1386902);
   ...
   pol01076->SetChisquare(12.70078);
   pol01076->SetNDF(8);
   ...
   pol01076->SetParameter(0,0.04881817);
   pol01076->SetParError(0,0.006663989);
