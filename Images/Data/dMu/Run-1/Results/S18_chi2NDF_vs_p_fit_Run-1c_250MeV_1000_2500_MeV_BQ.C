void S18_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2582,-0.2795619,2667.531,2.516057);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","",100,1004.085,2482.703);
   Graph_Graph1015->SetMinimum(0);
   Graph_Graph1015->SetMaximum(2.236495);
