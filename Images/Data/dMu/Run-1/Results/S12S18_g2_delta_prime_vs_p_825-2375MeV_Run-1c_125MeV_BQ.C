...
//=========  (Mon Nov  8 21:03:38 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.990247,2655.75,1.729083);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2504522,
   0.3252768};
   TGraphErrors *gre = new TGraphErrors(12,_fx1035,_fy1035,_fex1035,_fey1035);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1035 = new TH1F("Graph_Graph1035","S12S18_",100,799.5,2449.5);
   ...
   pol01036->SetParameter(0,0.003009356);
   pol01036->SetParError(0,0.0529686);
