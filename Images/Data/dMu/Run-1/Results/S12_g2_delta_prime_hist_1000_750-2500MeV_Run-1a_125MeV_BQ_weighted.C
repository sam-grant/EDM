void S12_g2_delta_prime_hist_1000_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
...
//=========  (Tue Nov 23 11:03:16 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.3041375,0.1072502);
   h__4->SetBinContent(9,8);
   h__4->SetBinContent(10,262);
   h__4->SetBinContent(11,609);
   h__4->SetBinContent(12,121);
