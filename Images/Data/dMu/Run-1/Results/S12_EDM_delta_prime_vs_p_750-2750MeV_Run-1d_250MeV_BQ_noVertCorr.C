...
//=========  (Tue Mar 29 10:47:26 2022) by ROOT version 6.24/06
   ...
   c->Range(453.1429,-0.7721033,3039.225,2.123723);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,711.7512,2780.617);
   Graph_Graph1001->SetMinimum(-0.4825206);
   Graph_Graph1001->SetMaximum(1.834141);
   ...
   pol01002->SetChisquare(1.509654);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.5907643);
   pol01002->SetParError(0,0.05655844);
