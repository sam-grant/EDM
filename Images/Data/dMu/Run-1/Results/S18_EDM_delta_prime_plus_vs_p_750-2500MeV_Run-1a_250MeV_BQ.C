void S18_EDM_delta_prime_plus_vs_p_750-2500MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 12:58:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.4911,-1.461712,2728.721,1.849888);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1049 = new TH1F("Graph_Graph1049","S18",100,735.9141,2507.298);
   Graph_Graph1049->SetMinimum(-1.130552);
   Graph_Graph1049->SetMaximum(1.518728);
   ...
   pol01050->SetParameter(0,0.2103864);
   pol01050->SetParError(0,0.0948041);
