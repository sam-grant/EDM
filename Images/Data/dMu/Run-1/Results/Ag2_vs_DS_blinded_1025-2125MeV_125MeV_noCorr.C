void Ag2_vs_DS_blinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-26.88424,4.75,24.26679);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10371041->SetMinimum(-21.76914);
   Graph_Graph_Graph10371041->SetMaximum(19.15169);
   ...
   fit1041->SetParameter(0,0.2423966);
   fit1041->SetParError(0,2.280985);
   ...
   shift_-11042->SetParameter(0,-2.038589);
   ...
   shift_11043->SetParameter(0,2.523382);
   ...
   Graph_Graph_Graph_Graph103710411042->SetMinimum(-21.76914);
   Graph_Graph_Graph_Graph103710411042->SetMaximum(19.15169);
   ...
   Graph_Graph_Graph10381043->SetMinimum(-20.95942);
   Graph_Graph_Graph10381043->SetMaximum(17.66338);
   ...
   Graph_Graph_Graph10391044->SetMinimum(-12.44717);
   Graph_Graph_Graph10391044->SetMaximum(8.047396);
   ...
   pol01045->SetChisquare(1.683672);
   pol01045->SetNDF(3);
   ...
   pol01045->SetParameter(0,0.2423966);
   pol01045->SetParError(0,2.280985);
