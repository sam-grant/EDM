...
//=========  (Mon Nov  8 21:07:46 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.990247,2499.5,1.729083);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2112518,
   0.2504522};
   TGraphErrors *gre = new TGraphErrors(11,_fx1035,_fy1035,_fex1035,_fey1035);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1035 = new TH1F("Graph_Graph1035","S12S18_",100,812,2312);
   Graph_Graph1035->SetMinimum(-0.718314);
   Graph_Graph1035->SetMaximum(1.45715);
   ...
   pol01036->SetParameter(0,0.007638064);
   pol01036->SetParError(0,0.05368518);
