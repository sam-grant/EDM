void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:55:52 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.8467,-0.9242123,3037.552,2.119334);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.6198576);
   Graph_Graph1003->SetMaximum(1.81498);
   ...
   pol01004->SetChisquare(11.76089);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.5719994);
   pol01004->SetParError(0,0.06056659);
