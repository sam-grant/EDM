...
//=========  (Mon Nov  8 21:10:06 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18_",20,-0.0304622,0.3805394);
   h__2->SetBinContent(9,1);
   h__2->SetBinContent(10,126);
   h__2->SetBinContent(11,711);
   h__2->SetBinContent(12,157);
   h__2->SetBinContent(13,5);
