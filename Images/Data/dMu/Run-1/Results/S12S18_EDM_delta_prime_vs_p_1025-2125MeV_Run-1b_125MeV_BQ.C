...
//=========  (Mon Nov  8 21:10:08 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.3351746,2312,1.595437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1017->SetMinimum(-0.1421134);
   Graph_Graph1017->SetMaximum(1.402376);
   ...
   pol01018->SetChisquare(9.852167);
   pol01018->SetNDF(8);
   ...
   pol01018->SetParameter(0,0.3024865);
   pol01018->SetParError(0,0.06851182);
