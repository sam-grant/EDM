void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:52 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.5473,-1.004987,2837.436,1.416273);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1035->SetMinimum(-0.762861);
   Graph_Graph1035->SetMaximum(1.174147);
   ...
   pol01036->SetChisquare(20.36868);
   pol01036->SetNDF(13);
   ...
   pol01036->SetParameter(0,-0.005424243);
