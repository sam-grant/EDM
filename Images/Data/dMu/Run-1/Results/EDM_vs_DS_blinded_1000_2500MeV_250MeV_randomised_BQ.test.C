void EDM_vs_DS_blinded_1000_2500MeV_250MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:40:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,-5.198466e-18,4.65,3.626605e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(-4.315958e-18);
   Graph_Graph_Graph10011005->SetMaximum(2.744097e-18);
   ...
   fit1005->SetParameter(0,2.590753e-19);
   fit1005->SetParError(0,9.300959e-20);
   ...
   minusSigma1006->SetParameter(0,1.660657e-19);
   ...
   plusSigma1007->SetParameter(0,3.520849e-19);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-4.315958e-18);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(2.744097e-18);
   ...
   Graph_Graph_Graph10021007->SetMinimum(-2.492157e-18);
   Graph_Graph_Graph10021007->SetMaximum(1.038424e-18);
   ...
   Graph_Graph_Graph10031008->SetMinimum(-5.328097e-19);
   Graph_Graph_Graph10031008->SetMaximum(8.930278e-19);
   ...
   pol01009->SetChisquare(7.926717);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,2.590753e-19);
   pol01009->SetParError(0,9.300959e-20);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("#delta#LTd_{#mu}#GT = 9.3#times10^{#minus20} e#upointcm");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
