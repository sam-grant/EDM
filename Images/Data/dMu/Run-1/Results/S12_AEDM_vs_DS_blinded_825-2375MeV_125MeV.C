void S12_AEDM_vs_DS_blinded_825-2375MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,1.927801e-19,4.75,2.625568e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1010->SetMinimum(4.360589e-19);
   Graph_Graph1010->SetMaximum(2.382289e-18);
