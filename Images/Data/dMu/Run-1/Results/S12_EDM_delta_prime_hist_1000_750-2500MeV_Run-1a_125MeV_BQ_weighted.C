void S12_EDM_delta_prime_hist_1000_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:16 2021) by ROOT version 6.24/04
   ...
   TH1D *h__1 = new TH1D("h__1","S12_",23,0.3367319,0.799307);
   h__1->SetBinContent(8,1);
   h__1->SetBinContent(9,1);
   h__1->SetBinContent(10,13);
   h__1->SetBinContent(11,55);
   h__1->SetBinContent(12,149);
   h__1->SetBinContent(13,260);
   h__1->SetBinContent(14,252);
   h__1->SetBinContent(15,160);
   h__1->SetBinContent(16,66);
   h__1->SetBinContent(17,29);
   h__1->SetBinContent(18,11);
   h__1->SetBinContent(19,3);
