...
//=========  (Thu Dec  2 14:47:07 2021) by ROOT version 6.24/04
   ...
   TH1D *h__22 = new TH1D("h__22","S12",20,-0.1540856,0.2628694);
   h__22->SetBinContent(10,39);
   h__22->SetBinContent(11,798);
   h__22->SetBinContent(12,163);
