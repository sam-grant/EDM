...
//=========  (Thu Feb  3 11:00:57 2022) by ROOT version 6.24/06
   ...
   TH1D *h__22 = new TH1D("h__22","S12",20,-0.1979735,0.2207066);
   h__22->SetBinContent(10,46);
   h__22->SetBinContent(11,469);
   h__22->SetBinContent(12,427);
   h__22->SetBinContent(13,58);
