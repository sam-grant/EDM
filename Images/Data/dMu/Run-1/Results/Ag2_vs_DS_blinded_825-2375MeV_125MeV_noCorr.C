void Ag2_vs_DS_blinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-23.10616,4.75,20.8297);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10371041->SetMinimum(-18.71258);
   Graph_Graph_Graph10371041->SetMaximum(16.43612);
   ...
   fit1041->SetParameter(0,0.501778);
   fit1041->SetParError(0,2.038965);
   ...
   shift_-11042->SetParameter(0,-1.537187);
   ...
   shift_11043->SetParameter(0,2.540743);
   ...
   Graph_Graph_Graph_Graph103710411042->SetMinimum(-18.71258);
   Graph_Graph_Graph_Graph103710411042->SetMaximum(16.43612);
   ...
   Graph_Graph_Graph10381043->SetMinimum(-14.07956);
   Graph_Graph_Graph10381043->SetMaximum(14.60847);
   ...
   Graph_Graph_Graph10391044->SetMinimum(-9.349798);
   Graph_Graph_Graph10391044->SetMaximum(7.255398);
   ...
   pol01045->SetParameter(0,0.501778);
   pol01045->SetParError(0,2.038965);
