...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.08956179,2499.5,0.1668793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02531924,
   0.02591798};
   TGraphErrors *gre = new TGraphErrors(11,_fx1069,_fy1069,_fex1069,_fey1069);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1069 = new TH1F("Graph_Graph1069","S18_",100,812,2312);
   ...
   pol01070->SetParameter(0,-0.00527646);
   pol01070->SetParError(0,0.007480724);
