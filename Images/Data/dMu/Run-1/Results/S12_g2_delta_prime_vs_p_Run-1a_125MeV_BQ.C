...
//=========  (Mon Nov  8 11:21:55 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-2.630785,2843.25,2.296139);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-2.138093);
   Graph_Graph1007->SetMaximum(1.803447);
   ...
   pol01008->SetChisquare(11.61315);
   pol01008->SetNDF(13);
   ...
   pol01008->SetParameter(0,-0.08001493);
   pol01008->SetParError(0,0.1025509);
