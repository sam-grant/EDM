void EDM_vs_DS_blinded_750_2500MeV_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 14:17:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,-7.972931e-19,4.65,3.613315e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(-3.562323e-19);
   Graph_Graph_Graph10011005->SetMaximum(3.172254e-18);
   ...
   fit1005->SetParameter(0,1.421585e-18);
   fit1005->SetParError(0,1.373317e-19);
   ...
   minusSigma1006->SetParameter(0,1.284253e-18);
   ...
   plusSigma1007->SetParameter(0,1.558917e-18);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-3.562323e-19);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(3.172254e-18);
   ...
   Graph_Graph_Graph10021007->SetMinimum(1.907546e-19);
   Graph_Graph_Graph10021007->SetMaximum(2.570227e-18);
   ...
   Graph_Graph_Graph10031008->SetMinimum(7.759746e-19);
   Graph_Graph_Graph10031008->SetMaximum(2.252686e-18);
   ...
   pol01009->SetChisquare(3.313746);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,1.421585e-18);
   pol01009->SetParError(0,1.373317e-19);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("#delta#LTd_{#mu}^{BLIND}#GT = 1.37#times10^{#minus19} e#upointcm");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
