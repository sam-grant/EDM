void S18_g2_delta_prime_vs_p_900-2250MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.0908875,2499.5,0.2194268);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.0294382,
   0.03033956};
   TGraphErrors *gre = new TGraphErrors(11,_fx1057,_fy1057,_fex1057,_fey1057);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1057 = new TH1F("Graph_Graph1057","S18_",100,812,2312);
   Graph_Graph1057->SetMinimum(-0.05985607);
   Graph_Graph1057->SetMaximum(0.1883953);
   ...
   pol01058->SetParameter(0,0.008027384);
   pol01058->SetParError(0,0.008745108);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.008
#pm0.009
 mrad","lpf");
