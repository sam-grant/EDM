void S18_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1a_250MeV_1000_2500_MeV_BQ()
{
...
//=========  (Fri May 13 12:30:34 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",50,-0.2995831,0.7109271);
   h__2->SetBinContent(20,2);
   h__2->SetBinContent(21,14);
   h__2->SetBinContent(22,77);
   h__2->SetBinContent(23,236);
   h__2->SetBinContent(24,314);
   h__2->SetBinContent(25,241);
   h__2->SetBinContent(26,93);
   h__2->SetBinContent(27,17);
   h__2->SetBinContent(28,6);
