...
//=========  (Thu Dec  2 14:43:40 2021) by ROOT version 6.24/04
   ...
   c->Range(411.4874,-1.34602,2837.47,1.085082);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18",100,654.0857,2594.872);
   Graph_Graph1023->SetMinimum(-1.102909);
   Graph_Graph1023->SetMaximum(0.8419717);
   ...
   pol01024->SetParameter(0,-0.05580395);
   pol01024->SetParError(0,0.06263283);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.056
#pm0.06
 mrad","lpf");
