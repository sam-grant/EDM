...
//=========  (Thu Nov 18 11:46:29 2021) by ROOT version 6.24/04
   ...
   c->Range(411.4872,-2.132456,2837.473,1.355686);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1023->SetMinimum(-1.783642);
   Graph_Graph1023->SetMaximum(1.006872);
   ...
   pol01024->SetChisquare(12.87433);
   pol01024->SetNDF(13);
   ...
   pol01024->SetParameter(0,-0.06547703);
