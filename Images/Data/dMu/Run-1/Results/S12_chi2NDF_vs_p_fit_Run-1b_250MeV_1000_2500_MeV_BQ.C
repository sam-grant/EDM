void S12_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5982,-0.2542196,2667.768,2.287976);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,1004.415,2482.951);
   Graph_Graph1007->SetMinimum(0);
   Graph_Graph1007->SetMaximum(2.033756);
