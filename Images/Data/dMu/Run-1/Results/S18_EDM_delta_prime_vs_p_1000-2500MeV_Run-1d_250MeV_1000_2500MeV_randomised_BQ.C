...
//=========  (Tue May 24 20:13:15 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2486,-0.4250062,2667.186,1.486419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.2338637);
   Graph_Graph1003->SetMaximum(1.295276);
   ...
   pol01004->SetChisquare(11.37021);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.452231);
   pol01004->SetParError(0,0.06261985);
