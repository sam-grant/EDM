...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1174545,2312,0.107558);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1055->SetMinimum(-0.09495327);
   Graph_Graph1055->SetMaximum(0.08505671);
   ...
   pol01056->SetChisquare(8.340607);
   pol01056->SetNDF(8);
   ...
   pol01056->SetParameter(0,-0.0051758);
   pol01056->SetParError(0,0.009025075);
