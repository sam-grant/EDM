...
//=========  (Tue Mar 29 11:44:09 2022) by ROOT version 6.24/06
   ...
   c->Range(453.2245,-1.62235,3037.802,2.045497);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMaximum(1.678712);
   ...
   pol01012->SetParameter(0,-0.003755416);
   pol01012->SetParError(0,0.05675176);
