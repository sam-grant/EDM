void Ag2_vs_DS_blinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-318.1863,4.75,297.3334);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(-256.6343);
   Graph_Graph_Graph10011005->SetMaximum(235.7814);
   ...
   fit1005->SetParameter(0,7.052513);
   fit1005->SetParError(0,28.07647);
   ...
   shift_-11006->SetParameter(0,-21.02396);
   ...
   shift_11007->SetParameter(0,35.12898);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-256.6343);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(235.7814);
   ...
   Graph_Graph_Graph10021007->SetMinimum(-245.5941);
   Graph_Graph_Graph10021007->SetMaximum(216.4659);
   ...
   Graph_Graph_Graph10031008->SetMinimum(-142.7665);
   Graph_Graph_Graph10031008->SetMaximum(101.4391);
   ...
   pol01009->SetChisquare(1.503023);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,7.052513);
   pol01009->SetParError(0,28.07647);
