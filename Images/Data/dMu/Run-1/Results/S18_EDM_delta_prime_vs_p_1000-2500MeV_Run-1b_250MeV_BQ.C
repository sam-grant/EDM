void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_BQ()
{
...
//=========  (Fri May  6 16:24:04 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1003.963,2482.473);
   Graph_Graph1003->SetMinimum(-0.3027269);
   Graph_Graph1003->SetMaximum(1.439324);
   ...
   pol01004->SetChisquare(6.589036);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.3942282);
   pol01004->SetParError(0,0.1024702);
