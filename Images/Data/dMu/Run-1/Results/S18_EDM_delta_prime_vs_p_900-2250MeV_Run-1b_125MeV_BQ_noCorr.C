...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.05232615,2499.5,0.1690596);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02507117,
   0.02541383};
   TGraphErrors *gre = new TGraphErrors(11,_fx1063,_fy1063,_fex1063,_fey1063);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1063 = new TH1F("Graph_Graph1063","S18_",100,812,2312);
   ...
   pol01064->SetParameter(0,0.02953086);
   pol01064->SetParError(0,0.007471984);
