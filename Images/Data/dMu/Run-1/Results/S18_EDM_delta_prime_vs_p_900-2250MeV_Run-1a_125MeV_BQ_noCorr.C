void S18_EDM_delta_prime_vs_p_900-2250MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:50 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.1014011,2499.5,0.162737);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02924723,
   0.02964325};
   TGraphErrors *gre = new TGraphErrors(11,_fx1051,_fy1051,_fex1051,_fey1051);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1051 = new TH1F("Graph_Graph1051","S18_",100,812,2312);
   Graph_Graph1051->SetMinimum(-0.07498733);
   Graph_Graph1051->SetMaximum(0.1363232);
   ...
   pol01052->SetParameter(0,0.01920802);
   pol01052->SetParError(0,0.00873573);
