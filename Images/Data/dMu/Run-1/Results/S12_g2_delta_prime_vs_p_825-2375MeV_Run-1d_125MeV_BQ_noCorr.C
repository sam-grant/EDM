...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.06998529,2655.75,0.06975307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1091 = new TH1F("Graph_Graph1091","S12_",100,799.5,2449.5);
   ...
   pol01092->SetParameter(0,0.005307498);
   pol01092->SetParError(0,0.004107129);
