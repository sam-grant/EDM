void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:41:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5929,-0.1173608,2667.557,0.9466899);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.389,2482.761);
   Graph_Graph1005->SetMinimum(-0.01095571);
   Graph_Graph1005->SetMaximum(0.8402848);
   ...
   pol01006->SetChisquare(3.660305);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.4072687);
   pol01006->SetParError(0,0.03206349);
