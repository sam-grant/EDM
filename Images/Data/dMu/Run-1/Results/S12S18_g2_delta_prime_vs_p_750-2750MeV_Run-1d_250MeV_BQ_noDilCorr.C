void S12S18_g2_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9846,-1.002281,3038.491,1.036546);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1047->SetMinimum(-0.7983983);
   Graph_Graph1047->SetMaximum(0.8326633);
   ...
   pol01048->SetChisquare(17.68123);
   pol01048->SetNDF(7);
   ...
   pol01048->SetParameter(0,0.0006050131);
   pol01048->SetParError(0,0.005397233);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.000605
#pm0.005
 mrad","lpf");
