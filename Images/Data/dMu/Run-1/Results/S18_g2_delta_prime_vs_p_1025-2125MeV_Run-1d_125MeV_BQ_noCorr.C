...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.06459937,2312,0.0619185);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1093->SetMaximum(0.04926671);
   ...
   pol01094->SetChisquare(10.60806);
   pol01094->SetNDF(8);
   ...
   pol01094->SetParameter(0,-0.003267787);
   pol01094->SetParError(0,0.00490414);
