void S12_EDM_delta_prime_plus_vs_p_750-2500MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.5161,-1.180439,2728.522,2.117204);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1075 = new TH1F("Graph_Graph1075","S12",100,736.8167,2507.221);
   Graph_Graph1075->SetMinimum(-0.8506744);
   Graph_Graph1075->SetMaximum(1.78744);
   ...
   pol01076->SetChisquare(5.039377);
   pol01076->SetNDF(6);
   ...
   pol01076->SetParameter(0,0.5584594);
   pol01076->SetParError(0,0.06890745);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.558
#pm0.07
 mrad","lpf");
