...
//=========  (Sun Jun 12 15:46:12 2022) by ROOT version 6.24/06
   ...
   TH1D *h__10 = new TH1D("h__10","S12",51,-0.1396396,0.8822989);
   h__10->SetBinContent(23,7);
   h__10->SetBinContent(24,79);
   h__10->SetBinContent(25,250);
   h__10->SetBinContent(26,341);
   h__10->SetBinContent(27,216);
   h__10->SetBinContent(28,88);
   h__10->SetBinContent(29,16);
   h__10->SetBinContent(30,3);
