...
//=========  (Mon Nov  8 21:07:38 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.8026504,2499.5,3.142678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4033437,
   0.4726057};
   TGraphErrors *gre = new TGraphErrors(11,_fx1001,_fy1001,_fex1001,_fey1001);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12_",100,812,2312);
   ...
   pol01002->SetParameter(0,0.5469135);
   pol01002->SetParError(0,0.1058341);
