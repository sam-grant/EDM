...
//=========  (Tue Mar 29 11:41:04 2022) by ROOT version 6.24/06
   ...
   c->Range(452.6106,-2.268211,3038.124,2.852535);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMaximum(2.34046);
   ...
   pol01010->SetChisquare(9.042423);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,0.02857426);
   pol01010->SetParError(0,0.116808);
