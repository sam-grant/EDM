...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.04088481,2499.5,0.1105878);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01530903,
   0.01558126};
   TGraphErrors *gre = new TGraphErrors(11,_fx1087,_fy1087,_fex1087,_fey1087);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1087 = new TH1F("Graph_Graph1087","S18_",100,812,2312);
   ...
   pol01088->SetParameter(0,0.03953701);
   pol01088->SetParError(0,0.004551294);
