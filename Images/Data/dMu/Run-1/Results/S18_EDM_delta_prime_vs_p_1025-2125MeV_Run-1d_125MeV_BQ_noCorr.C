...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.03942515,2312,0.1104256);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1087->SetMinimum(-0.02444008);
   ...
   pol01088->SetChisquare(15.45106);
   pol01088->SetNDF(8);
   ...
   pol01088->SetParameter(0,0.04130578);
   pol01088->SetParError(0,0.00490763);
