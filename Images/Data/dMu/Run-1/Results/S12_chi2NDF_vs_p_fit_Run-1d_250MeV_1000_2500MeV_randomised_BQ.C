...
//=========  (Fri Jun 10 20:30:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4447,-0.2321944,2667.685,2.089749);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,1004.269,2482.861);
   Graph_Graph1001->SetMinimum(0);
   Graph_Graph1001->SetMaximum(1.857555);
   ...
   pol01002->SetChisquare(0.2571702);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.8575549);
   pol01002->SetParError(0,0.09258692);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.86
#pm0.09
","lpf");
