...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.08646656,2312,0.07348572);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1059->SetMinimum(-0.07047133);
   Graph_Graph1059->SetMaximum(0.05749049);
   ...
   pol01060->SetChisquare(7.916247);
   pol01060->SetNDF(8);
   ...
   pol01060->SetParameter(0,-0.000332605);
   pol01060->SetParError(0,0.006515197);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00033
#pm0.007
 mrad","lpf");
