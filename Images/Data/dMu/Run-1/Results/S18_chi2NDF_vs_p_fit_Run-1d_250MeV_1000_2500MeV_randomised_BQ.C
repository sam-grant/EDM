void S18_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 24 20:16:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2486,-0.2310256,2667.186,2.07923);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","",100,1004.042,2482.392);
   Graph_Graph1021->SetMinimum(0);
   Graph_Graph1021->SetMaximum(1.848204);
   ...
   pol01022->SetChisquare(0.2610032);
   pol01022->SetNDF(5);
   ...
   pol01022->SetParameter(0,0.8482043);
   pol01022->SetParError(0,0.09327436);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.848
#pm0.093
","lpf");
