...
//=========  (Fri Jun 10 20:30:25 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2486,-0.2310257,2667.186,2.079231);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1004.042,2482.392);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(1.848206);
   ...
   pol01004->SetChisquare(0.2610073);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.8482056);
   pol01004->SetParError(0,0.0932751);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.85
#pm0.09
","lpf");
