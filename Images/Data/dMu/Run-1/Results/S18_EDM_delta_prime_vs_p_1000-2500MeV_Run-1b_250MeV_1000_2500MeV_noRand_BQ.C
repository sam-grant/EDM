void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:40:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2718,-0.3876511,2667.392,1.50691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.084,2482.58);
   Graph_Graph1003->SetMinimum(-0.198195);
   Graph_Graph1003->SetMaximum(1.317454);
   ...
   pol01004->SetChisquare(5.080111);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.395387);
   pol01004->SetParError(0,0.08251959);
