void S12S18_g2_delta_prime_vs_p_900-2250MeV_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.06003054,2499.5,0.1251414);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01413177,
   0.01447432};
   TGraphErrors *gre = new TGraphErrors(11,_fx1083,_fy1083,_fex1083,_fey1083);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1083 = new TH1F("Graph_Graph1083","S12S18_",100,812,2312);
   ...
   pol01084->SetParameter(0,0.0001331408);
   pol01084->SetParError(0,0.0042515);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00013
#pm0.004
 mrad","lpf");
