void S18_g2_delta_prime_vs_p_900-2250MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.9216234,2499.5,1.304348);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2309258,
   0.2751332};
   TGraphErrors *gre = new TGraphErrors(11,_fx1045,_fy1045,_fex1045,_fey1045);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1045 = new TH1F("Graph_Graph1045","S18_",100,812,2312);
   Graph_Graph1045->SetMinimum(-0.6990263);
   Graph_Graph1045->SetMaximum(1.081751);
   ...
   pol01046->SetParameter(0,-0.007714684);
   pol01046->SetParError(0,0.05740684);
