void S12_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
...
//=========  (Fri Jun 10 19:38:13 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",50,-0.04982927,0.9690366);
   h__1->SetBinContent(21,3);
   h__1->SetBinContent(22,25);
   h__1->SetBinContent(23,93);
   h__1->SetBinContent(24,209);
   h__1->SetBinContent(25,242);
   h__1->SetBinContent(26,234);
   h__1->SetBinContent(27,124);
   h__1->SetBinContent(28,49);
   h__1->SetBinContent(29,16);
   h__1->SetBinContent(30,2);
