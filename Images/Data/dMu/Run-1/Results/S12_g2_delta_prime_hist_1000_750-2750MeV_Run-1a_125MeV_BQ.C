...
//=========  (Thu Dec  2 14:46:57 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12",20,-0.2833375,0.1340016);
   h__4->SetBinContent(10,92);
   h__4->SetBinContent(11,829);
   h__4->SetBinContent(12,79);
