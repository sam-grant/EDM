...
//=========  (Wed May 11 17:49:54 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.085,2482.703);
   Graph_Graph1003->SetMinimum(-0.09320942);
   Graph_Graph1003->SetMaximum(1.784601);
   ...
   pol01004->SetChisquare(10.68693);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.6129486);
   pol01004->SetParError(0,0.08486528);
