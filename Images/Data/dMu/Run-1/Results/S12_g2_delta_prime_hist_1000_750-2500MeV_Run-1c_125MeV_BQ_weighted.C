void S12_g2_delta_prime_hist_1000_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
...
//=========  (Mon Nov 22 17:32:51 2021) by ROOT version 6.24/04
   ...
   TH1D *h__16 = new TH1D("h__16","S12_",20,-0.2146724,0.2019569);
   h__16->SetBinContent(10,105);
   h__16->SetBinContent(11,806);
   h__16->SetBinContent(12,88);
