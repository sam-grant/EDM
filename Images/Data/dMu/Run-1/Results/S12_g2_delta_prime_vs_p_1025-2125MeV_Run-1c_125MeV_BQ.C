...
//=========  (Mon Nov  8 21:10:11 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.9109169,2312,1.183242);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1031->SetMinimum(-0.701501);
   Graph_Graph1031->SetMaximum(0.9738259);
   ...
   pol01032->SetChisquare(7.681343);
   pol01032->SetNDF(8);
   ...
   pol01032->SetParameter(0,0.001877841);
   pol01032->SetParError(0,0.07768396);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0019
#pm0.08
 mrad","lpf");
