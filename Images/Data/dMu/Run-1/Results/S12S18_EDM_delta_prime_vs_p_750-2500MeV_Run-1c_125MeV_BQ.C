...
//=========  (Thu Dec  2 14:43:41 2021) by ROOT version 6.24/04
   ...
   c->Range(411.5463,-0.6818651,2837.436,1.614306);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18",100,654.1352,2594.847);
   Graph_Graph1029->SetMinimum(-0.452248);
   Graph_Graph1029->SetMaximum(1.384688);
   ...
   pol01030->SetChisquare(14.40378);
   pol01030->SetNDF(13);
   ...
   pol01030->SetParameter(0,0.6224454);
   pol01030->SetParError(0,0.05147629);
