...
//=========  (Mon Nov  8 21:07:43 2021) by ROOT version 6.24/04
   ...
   TH1D *h__13 = new TH1D("h__13","S12_",23,0.3469884,0.8215713);
   h__13->SetBinContent(8,2);
   h__13->SetBinContent(9,11);
   h__13->SetBinContent(10,76);
   h__13->SetBinContent(11,190);
   h__13->SetBinContent(12,299);
   h__13->SetBinContent(13,251);
   h__13->SetBinContent(14,107);
   h__13->SetBinContent(15,48);
   h__13->SetBinContent(16,12);
