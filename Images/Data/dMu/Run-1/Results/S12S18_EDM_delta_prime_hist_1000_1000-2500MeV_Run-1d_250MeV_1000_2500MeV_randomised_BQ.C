...
//=========  (Sun Jun 12 15:46:12 2022) by ROOT version 6.24/06
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18",50,-0.09599738,0.9153182);
   h__12->SetBinContent(23,14);
   h__12->SetBinContent(24,158);
   h__12->SetBinContent(25,368);
   h__12->SetBinContent(26,330);
   h__12->SetBinContent(27,114);
   h__12->SetBinContent(28,12);
