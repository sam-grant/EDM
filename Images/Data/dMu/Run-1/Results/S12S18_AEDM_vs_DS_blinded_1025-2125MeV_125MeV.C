void S12S18_AEDM_vs_DS_blinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,3.93094e-19,4.75,2.483557e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1012->SetMinimum(6.021403e-19);
   Graph_Graph1012->SetMaximum(2.274511e-18);
   ...
   pol01013->SetChisquare(11.85329);
   pol01013->SetNDF(3);
   ...
   pol01013->SetParameter(0,1.473678e-18);
   pol01013->SetParError(0,9.924831e-20);
