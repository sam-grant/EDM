void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:14:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1932,-0.5283755,2667.129,1.389352);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1003.987,2482.336);
   Graph_Graph1003->SetMinimum(-0.3366028);
   Graph_Graph1003->SetMaximum(1.197579);
   ...
   pol01004->SetChisquare(10.51422);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.3354106);
   pol01004->SetParError(0,0.07451803);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.34
#pm0.07
 mrad","lpf");
