void S18_EDM_delta_prime_hist_1000_750-2750MeV_Run-1a_250MeV_BQ_noVertCorr()
{
...
//=========  (Tue Mar 29 10:43:22 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.03036524,0.4331345);
   h__2->SetBinContent(10,450);
   h__2->SetBinContent(11,550);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2322
#pm0.0001
");
   pt_LaTex = pt->AddText("0.0038
#pm8e-05
");
   pt->Draw();
   c->Modified();
