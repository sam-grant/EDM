void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 12:58:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.9475,-1.137992,2728.833,1.976482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1053 = new TH1F("Graph_Graph1053","S12S18",100,736.336,2507.445);
   Graph_Graph1053->SetMinimum(-0.8265441);
   Graph_Graph1053->SetMaximum(1.665035);
   ...
   pol01054->SetChisquare(3.287772);
   pol01054->SetNDF(6);
   ...
   pol01054->SetParameter(0,0.419003);
   pol01054->SetParError(0,0.0703927);
