void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 11:59:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4016,-0.4026289,2667.941,1.186196);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.2437464);
   Graph_Graph1005->SetMaximum(1.027313);
   ...
   pol01006->SetChisquare(4.095593);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3810759);
   pol01006->SetParError(0,0.07741283);
