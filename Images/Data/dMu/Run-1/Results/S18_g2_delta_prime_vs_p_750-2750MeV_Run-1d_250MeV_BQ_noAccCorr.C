void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:52 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.8467,-1.294816,3037.552,1.271405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1045->SetMinimum(-1.038194);
   Graph_Graph1045->SetMaximum(1.014783);
   ...
   pol01046->SetChisquare(14.97717);
   pol01046->SetNDF(7);
   ...
   pol01046->SetParameter(0,0.003298605);
   pol01046->SetParError(0,0.02839176);
