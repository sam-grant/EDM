void AEDM_vs_DS_blinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-1.655921e-20,4.75,2.144264e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10461050->SetMinimum(6.539358e-21);
   Graph_Graph_Graph10461050->SetMaximum(1.913279e-19);
   ...
   fit1050->SetParameter(0,1.235341e-19);
   fit1050->SetParError(0,7.286888e-21);
   ...
   shift_-11051->SetParameter(0,1.162472e-19);
   ...
   shift_11052->SetParameter(0,1.30821e-19);
   ...
   Graph_Graph_Graph_Graph104610501051->SetMinimum(6.539358e-21);
   Graph_Graph_Graph_Graph104610501051->SetMaximum(1.913279e-19);
   ...
   Graph_Graph_Graph10471052->SetMinimum(6.026366e-21);
   Graph_Graph_Graph10471052->SetMaximum(1.926646e-19);
   ...
   Graph_Graph_Graph10481053->SetMinimum(5.244591e-20);
   Graph_Graph_Graph10481053->SetMaximum(1.842075e-19);
   ...
   pol01054->SetChisquare(13.36743);
   pol01054->SetNDF(3);
   ...
   pol01054->SetParameter(0,1.235341e-19);
   pol01054->SetParError(0,7.286888e-21);
