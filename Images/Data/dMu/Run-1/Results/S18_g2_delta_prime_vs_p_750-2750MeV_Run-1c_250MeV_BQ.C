...
//=========  (Tue Mar 29 11:44:09 2022) by ROOT version 6.24/06
   ...
   c->Range(452.9039,-2.03567,3037.134,2.381115);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMaximum(1.939437);
   ...
   pol01010->SetChisquare(10.33401);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,-0.03447744);
   pol01010->SetParError(0,0.08268511);
