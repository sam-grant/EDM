...
//=========  (Fri May 13 18:02:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2626,-0.2118629,2667.66,1.572354);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.03344121);
   Graph_Graph1001->SetMaximum(1.393932);
   ...
   pol01002->SetChisquare(4.118456);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4264206);
   pol01002->SetParError(0,0.0612847);
