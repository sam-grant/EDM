...
//=========  (Mon Jun 13 18:32:19 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2626,-0.2262204,2667.66,1.217934);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-0.08180493);
   Graph_Graph1019->SetMaximum(1.073518);
   ...
   pol01020->SetChisquare(2.057946);
   pol01020->SetNDF(5);
   ...
   pol01020->SetParameter(0,0.3570493);
   pol01020->SetParError(0,0.06128507);
