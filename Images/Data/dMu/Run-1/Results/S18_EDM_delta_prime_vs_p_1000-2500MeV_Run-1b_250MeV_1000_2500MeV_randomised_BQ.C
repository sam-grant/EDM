...
//=========  (Tue May 24 20:06:46 2022) by ROOT version 6.24/06
   ...
   c->Range(819.1514,-0.624485,2667.292,1.606105);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.4014259);
   Graph_Graph1003->SetMaximum(1.383046);
   ...
   pol01004->SetChisquare(5.644277);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.2526957);
