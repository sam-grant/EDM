void S12_g2_delta_prime_vs_p_900-2250MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:48 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.9491842,2499.5,0.8880087);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2096288,
   0.246542};
   TGraphErrors *gre = new TGraphErrors(11,_fx1043,_fy1043,_fex1043,_fey1043);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1043 = new TH1F("Graph_Graph1043","S12_",100,812,2312);
   Graph_Graph1043->SetMinimum(-0.7654649);
   Graph_Graph1043->SetMaximum(0.7042894);
   ...
   pol01044->SetParameter(0,0.09624341);
   pol01044->SetParError(0,0.05398492);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.096
#pm0.05
 mrad","lpf");
