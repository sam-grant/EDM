void S12S18_Ag2_vs_DS_blinded_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:41:13 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-159.3521,4.75,134.1784);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-129.9991);
   Graph_Graph1003->SetMaximum(104.8254);
   ...
   pol01004->SetChisquare(1.713387);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,15.6498);
   pol01004->SetParError(0,26.11965);
