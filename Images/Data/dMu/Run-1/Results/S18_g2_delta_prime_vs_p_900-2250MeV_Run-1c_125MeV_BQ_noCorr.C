...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.08371975,2499.5,0.1609779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02089712,
   0.02148839};
   TGraphErrors *gre = new TGraphErrors(11,_fx1081,_fy1081,_fex1081,_fey1081);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1081 = new TH1F("Graph_Graph1081","S18_",100,812,2312);
   ...
   pol01082->SetParameter(0,0.0005939806);
   pol01082->SetParError(0,0.006183058);
