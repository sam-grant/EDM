void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.4702,-1.043327,2728.594,1.061226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12",100,736.7826,2507.282);
   Graph_Graph1019->SetMinimum(-0.8328719);
   Graph_Graph1019->SetMaximum(0.8507708);
   ...
   pol01020->SetChisquare(6.327788);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,-0.003829736);
   pol01020->SetParError(0,0.01275462);
