...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.08135948,2499.5,0.1421905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01918185,
   0.01958153};
   TGraphErrors *gre = new TGraphErrors(11,_fx1079,_fy1079,_fex1079,_fey1079);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1079 = new TH1F("Graph_Graph1079","S12_",100,812,2312);
   ...
   pol01080->SetParameter(0,-0.0001528611);
   pol01080->SetParError(0,0.00585492);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00015
#pm0.006
 mrad","lpf");
