...
//=========  (Mon Nov 22 17:24:17 2021) by ROOT version 6.24/04
   ...
   c->Range(411.1944,-0.1354658,2837.902,0.1775944);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-0.1041597);
   Graph_Graph1009->SetMaximum(0.1462884);
   ...
   pol01010->SetChisquare(15.58077);
   pol01010->SetNDF(13);
   ...
   pol01010->SetParameter(0,0.003272811);
   pol01010->SetParError(0,0.008064713);
