...
//=========  (Fri Oct  7 16:07:31 2022) by ROOT version 6.26/04
   ...
   c->Range(819.476,-0.2708427,2667.731,1.32786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2331905,
   0.3240761};
   TGraphErrors *gre = new TGraphErrors(6,_fx1025,_fy1025,_fex1025,_fey1025);
   gre->SetName("");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","S12",100,1004.302,2482.906);
   Graph_Graph1025->SetMinimum(-0.1109724);
   Graph_Graph1025->SetMaximum(1.16799);
   ...
   Graph_Graph1025->GetYaxis()->SetTitle("#delta^{BLIND} [mrad] / 250 MeV");
   ...
   pol01026->SetParameter(0,0.5519115);
   pol01026->SetParError(0,0.07786416);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.55
#pm0.08
 mrad","lpf");
