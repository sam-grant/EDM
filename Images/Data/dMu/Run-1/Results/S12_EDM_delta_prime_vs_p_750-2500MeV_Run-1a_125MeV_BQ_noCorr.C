...
//=========  (Mon Nov 22 17:24:17 2021) by ROOT version 6.24/04
   ...
   c->Range(411.8032,-0.05612741,2837.119,0.2645008);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.02406458);
   Graph_Graph1001->SetMaximum(0.232438);
   ...
   pol01002->SetChisquare(11.10897);
   pol01002->SetNDF(13);
   ...
   pol01002->SetParameter(0,0.04445092);
   pol01002->SetParError(0,0.007637678);
