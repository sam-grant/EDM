void S12S18_g2_delta_prime_hist_1000_825.000000-2375.000000MeV_Run-1b_125MeV_BQ()
{
...
//=========  (Mon Nov  8 20:56:31 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18_",20,-0.2358696,0.1666087);
   h__12->SetBinContent(10,331);
   h__12->SetBinContent(11,669);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.03353
#pm9e-05
");
   pt_LaTex = pt->AddText("0.0029
#pm6e-05
");
   pt->Draw();
   c->Modified();
