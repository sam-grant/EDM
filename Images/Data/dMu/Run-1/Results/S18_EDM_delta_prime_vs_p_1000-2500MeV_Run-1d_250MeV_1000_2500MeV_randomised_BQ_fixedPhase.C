void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:03:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2486,-0.2447544,2667.186,1.742772);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.042,2482.392);
   Graph_Graph1003->SetMinimum(-0.04600181);
   Graph_Graph1003->SetMaximum(1.544019);
   ...
   pol01004->SetChisquare(14.24193);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.5741634);
   pol01004->SetParError(0,0.06262021);
