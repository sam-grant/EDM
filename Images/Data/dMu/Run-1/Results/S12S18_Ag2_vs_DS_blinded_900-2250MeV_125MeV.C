void S12S18_Ag2_vs_DS_blinded_900-2250MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-149.552,4.75,146.3694);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-119.9599);
   Graph_Graph1003->SetMaximum(116.7773);
   ...
   pol01004->SetParameter(0,20.59204);
   pol01004->SetParError(0,26.8163);
