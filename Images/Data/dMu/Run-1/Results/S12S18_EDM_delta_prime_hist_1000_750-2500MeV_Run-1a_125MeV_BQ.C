...
//=========  (Thu Dec  2 14:43:36 2021) by ROOT version 6.24/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",21,0.2058187,0.6446632);
   h__3->SetBinContent(8,1);
   h__3->SetBinContent(9,5);
   h__3->SetBinContent(10,81);
   h__3->SetBinContent(11,255);
   h__3->SetBinContent(12,383);
   h__3->SetBinContent(13,200);
   h__3->SetBinContent(14,58);
   h__3->SetBinContent(15,15);
