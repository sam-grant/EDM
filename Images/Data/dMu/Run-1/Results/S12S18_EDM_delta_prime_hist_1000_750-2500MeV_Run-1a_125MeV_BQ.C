...
//=========  (Mon Nov 22 17:27:56 2021) by ROOT version 6.24/04
   ...
   TH1D *h__9 = new TH1D("h__9","S12S18_",21,0.1605454,0.5950567);
   h__9->SetBinContent(8,1);
   h__9->SetBinContent(9,1);
   h__9->SetBinContent(10,37);
   h__9->SetBinContent(11,198);
   h__9->SetBinContent(12,404);
   h__9->SetBinContent(13,260);
   h__9->SetBinContent(14,77);
   h__9->SetBinContent(15,21);
