...
//=========  (Thu Nov 18 11:46:25 2021) by ROOT version 6.24/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18_",21,0.161263,0.595578);
   h__3->SetBinContent(8,1);
   h__3->SetBinContent(9,1);
   h__3->SetBinContent(10,40);
   h__3->SetBinContent(11,198);
   h__3->SetBinContent(12,405);
   h__3->SetBinContent(13,258);
   h__3->SetBinContent(14,76);
   h__3->SetBinContent(15,20);
