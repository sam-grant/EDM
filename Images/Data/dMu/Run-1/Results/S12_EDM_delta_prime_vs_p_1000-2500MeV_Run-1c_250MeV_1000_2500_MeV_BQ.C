void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ()
{
...
//=========  (Fri May 13 12:30:36 2022) by ROOT version 6.24/06
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","S12",100,1004.305,2482.904);
   Graph_Graph1013->SetMinimum(0.01444788);
   Graph_Graph1013->SetMaximum(1.364665);
   ...
   pol01014->SetChisquare(3.862389);
   pol01014->SetNDF(5);
   ...
   pol01014->SetParameter(0,0.569473);
   pol01014->SetParError(0,0.06981577);
