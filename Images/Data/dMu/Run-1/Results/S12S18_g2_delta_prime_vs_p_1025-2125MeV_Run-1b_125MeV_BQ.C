...
//=========  (Mon Nov  8 21:10:09 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.9819099,2312,0.7417009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1023->SetMinimum(-0.8095488);
   Graph_Graph1023->SetMaximum(0.5693398);
   ...
   pol01024->SetChisquare(8.480539);
   pol01024->SetNDF(8);
   ...
   pol01024->SetParameter(0,-0.05392015);
   pol01024->SetParError(0,0.06840077);
