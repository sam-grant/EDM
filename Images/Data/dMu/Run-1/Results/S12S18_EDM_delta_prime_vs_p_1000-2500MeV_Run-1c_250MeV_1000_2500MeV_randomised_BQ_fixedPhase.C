void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:02:52 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3707,0.02237041,2667.643,1.343104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.198,2482.815);
   Graph_Graph1005->SetMinimum(0.1544437);
   Graph_Graph1005->SetMaximum(1.21103);
   ...
   Graph_Graph1005->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 500 MeV");
   ...
   pol01006->SetChisquare(3.781158);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.6000717);
   pol01006->SetParError(0,0.05451252);
