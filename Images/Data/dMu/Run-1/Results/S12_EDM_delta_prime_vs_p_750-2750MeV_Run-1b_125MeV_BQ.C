...
//=========  (Mon Dec 20 16:05:04 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.1731,-1.53883,3144.974,2.211171);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-1.163829);
   Graph_Graph1013->SetMaximum(1.836171);
   ...
   pol01014->SetChisquare(16.78385);
   pol01014->SetNDF(15);
   ...
   pol01014->SetParameter(0,0.3361705);
   pol01014->SetParError(0,0.08526106);
