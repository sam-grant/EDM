void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:38:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.446,-0.7242442,2667.844,1.556039);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.286,2483.004);
   Graph_Graph1003->SetMinimum(-0.4962158);
   Graph_Graph1003->SetMaximum(1.328011);
   ...
   pol01004->SetChisquare(5.743274);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.2005434);
   pol01004->SetParError(0,0.09649004);
