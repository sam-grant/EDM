void S12S18_EDM_delta_prime_hist_1000_750-2500MeV_Run-1d_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__21 = new TH1D("h__21","S12S18_",22,0.2864763,0.7392581);
   h__21->SetBinContent(8,3);
   h__21->SetBinContent(9,16);
   h__21->SetBinContent(10,116);
   h__21->SetBinContent(11,232);
   h__21->SetBinContent(12,342);
   h__21->SetBinContent(13,191);
   h__21->SetBinContent(14,73);
   h__21->SetBinContent(15,23);
   h__21->SetBinContent(16,1);
