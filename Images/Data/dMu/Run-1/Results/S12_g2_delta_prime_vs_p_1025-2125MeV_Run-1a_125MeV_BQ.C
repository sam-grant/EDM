...
//=========  (Mon Nov  8 21:10:06 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.483025,2312,1.358067);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.198916);
   Graph_Graph1007->SetMaximum(1.073958);
   ...
   pol01008->SetParameter(0,-0.05694134);
   pol01008->SetParError(0,0.1110537);
