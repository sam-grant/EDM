void S18_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-2.554655,2655.75,3.144575);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18_",100,799.5,2449.5);
   Graph_Graph1009->SetMinimum(-1.984732);
   ...
   pol01010->SetParameter(0,0.070291);
   pol01010->SetParError(0,0.1088521);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.07
#pm0.1
 mrad","lpf");
