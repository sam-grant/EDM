void S12_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:15 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.8032,-0.9181114,2837.119,4.050481);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12_",100,654.3347,2594.587);
   Graph_Graph1001->SetMinimum(-0.4212522);
   Graph_Graph1001->SetMaximum(3.553622);
   ...
   pol01002->SetChisquare(10.40347);
   pol01002->SetNDF(13);
   ...
   pol01002->SetParameter(0,0.6032875);
   pol01002->SetParError(0,0.1025955);
