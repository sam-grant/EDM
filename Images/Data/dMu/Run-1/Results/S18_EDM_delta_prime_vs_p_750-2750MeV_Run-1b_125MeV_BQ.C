...
//=========  (Mon Mar 21 21:43:20 2022) by ROOT version 6.24/06
   ...
   c->Range(350.0628,-1.406007,3143.649,2.343993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,629.4215,2864.291);
   Graph_Graph1003->SetMinimum(-1.031007);
   Graph_Graph1003->SetMaximum(1.968993);
   ...
   pol01004->SetChisquare(18.37902);
   pol01004->SetNDF(15);
   ...
   pol01004->SetParameter(0,0.4689933);
   pol01004->SetParError(0,0.09985228);
