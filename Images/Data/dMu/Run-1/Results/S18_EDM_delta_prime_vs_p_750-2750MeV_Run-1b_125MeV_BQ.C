...
//=========  (Thu Dec  2 14:46:58 2021) by ROOT version 6.24/04
   ...
   c->Range(350.0629,-2.678488,3143.651,2.965991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S18",100,629.4217,2864.292);
   Graph_Graph1015->SetMinimum(-2.11404);
   ...
   pol01016->SetChisquare(17.67467);
   pol01016->SetNDF(15);
   ...
   pol01016->SetParameter(0,0.4444481);
   pol01016->SetParError(0,0.08902409);
