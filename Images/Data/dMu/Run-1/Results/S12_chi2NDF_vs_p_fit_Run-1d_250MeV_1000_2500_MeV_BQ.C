void S12_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.441,-0.2464491,2667.684,2.218041);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","",100,1004.265,2482.86);
   Graph_Graph1019->SetMinimum(0);
   Graph_Graph1019->SetMaximum(1.971592);
