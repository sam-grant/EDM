void S12_EDM_delta_prime_minus_vs_p_750-2500MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 12:58:24 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.3999,-1.105466,2728.91,2.548279);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1045 = new TH1F("Graph_Graph1045","S12",100,736.7509,2507.559);
   Graph_Graph1045->SetMinimum(-0.7400913);
   Graph_Graph1045->SetMaximum(2.182904);
   ...
   pol01046->SetChisquare(5.336336);
   pol01046->SetNDF(6);
   ...
   pol01046->SetParameter(0,0.6417492);
   pol01046->SetParError(0,0.1052116);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.642
#pm0.1
 mrad","lpf");
