void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:11:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5991,-0.4047295,2667.761,1.439195);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.220337);
   Graph_Graph1001->SetMaximum(1.254803);
   ...
   pol01002->SetChisquare(1.230554);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.2539347);
   pol01002->SetParError(0,0.08510586);
