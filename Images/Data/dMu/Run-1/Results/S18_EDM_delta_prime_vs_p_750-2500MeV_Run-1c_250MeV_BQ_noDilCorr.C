void S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1c_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.6398,-0.9514013,2728.454,1.237741);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1027 = new TH1F("Graph_Graph1027","S18",100,736.0212,2507.073);
   Graph_Graph1027->SetMinimum(-0.732487);
   Graph_Graph1027->SetMaximum(1.018827);
   ...
   pol01028->SetChisquare(13.14779);
   pol01028->SetNDF(6);
   ...
   pol01028->SetParameter(0,0.08428115);
   pol01028->SetParError(0,0.01124272);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0843
#pm0.01
 mrad","lpf");
