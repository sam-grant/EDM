void S12_g2_delta_prime_hist_1000_750-2750MeV_Run-1b_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:42 2022) by ROOT version 6.24/06
   ...
   TH1D *h__10 = new TH1D("h__10","S12",20,-0.2112546,0.1893681);
   h__10->SetBinContent(10,679);
   h__10->SetBinContent(11,321);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.01134
#pm3e-05
");
   pt_LaTex = pt->AddText("0.00087
#pm2e-05
");
   pt->Draw();
   c->Modified();
