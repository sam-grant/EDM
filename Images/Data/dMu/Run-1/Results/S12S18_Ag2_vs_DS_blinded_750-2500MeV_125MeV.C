...
//=========  (Thu Dec  2 14:45:36 2021) by ROOT version 6.24/04
   ...
   c->Range(0.35,-167.3642,4.85,125.2363);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-138.1042);
   Graph_Graph1003->SetMaximum(95.97623);
   ...
   pol01004->SetChisquare(1.702933);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,9.06958);
   pol01004->SetParError(0,25.91415);
