void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.0943,-1.03654,2728.411,1.030438);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02024306,
   0.02309333};
   TGraphErrors *gre = new TGraphErrors(7,_fx1023,_fy1023,_fex1023,_fey1023);
   gre->SetName("");
   gre->SetTitle("S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18",100,736.426,2507.08);
   Graph_Graph1023->SetMinimum(-0.8298425);
   Graph_Graph1023->SetMaximum(0.82374);
   ...
   pol01024->SetChisquare(9.783643);
   pol01024->SetNDF(6);
   ...
   pol01024->SetParameter(0,-0.01158123);
   pol01024->SetParError(0,0.008931029);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0116
#pm0.009
 mrad","lpf");
