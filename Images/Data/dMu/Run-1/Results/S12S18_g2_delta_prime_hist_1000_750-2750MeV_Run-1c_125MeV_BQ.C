...
//=========  (Thu Feb  3 11:00:30 2022) by ROOT version 6.24/06
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18",20,-0.2471333,0.1728195);
   h__18->SetBinContent(10,74);
   h__18->SetBinContent(11,815);
   h__18->SetBinContent(12,110);
