...
//=========  (Thu Feb  3 14:53:55 2022) by ROOT version 6.24/06
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18",20,-0.2143008,0.1889527);
   h__18->SetBinContent(10,692);
   h__18->SetBinContent(11,307);
   h__18->SetBinContent(12,1);
