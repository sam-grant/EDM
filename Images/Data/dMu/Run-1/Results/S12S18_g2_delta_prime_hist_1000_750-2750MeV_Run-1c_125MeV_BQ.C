...
//=========  (Mon Dec 20 16:07:19 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",21,-0.241476,0.1800342);
   h__6->SetBinContent(10,10);
   h__6->SetBinContent(11,370);
   h__6->SetBinContent(12,597);
   h__6->SetBinContent(13,23);
