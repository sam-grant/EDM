...
//=========  (Thu Dec  2 14:47:04 2021) by ROOT version 6.24/04
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18",20,-0.2054638,0.2074767);
   h__18->SetBinContent(10,103);
   h__18->SetBinContent(11,877);
   h__18->SetBinContent(12,20);
