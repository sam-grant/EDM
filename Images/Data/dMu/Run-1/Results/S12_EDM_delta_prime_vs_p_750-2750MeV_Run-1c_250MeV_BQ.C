...
//=========  (Tue Mar 29 11:44:08 2022) by ROOT version 6.24/06
   ...
   c->Range(453.5532,-1.277416,3038.337,2.474949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,712.0316,2779.858);
   Graph_Graph1001->SetMinimum(-0.9021798);
   ...
   pol01002->SetChisquare(4.208673);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.6711492);
   pol01002->SetParError(0,0.07755206);
