...
//=========  (Mon Nov  8 21:10:13 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1746572,2312,1.269918);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1037->SetMinimum(-0.03019966);
   Graph_Graph1037->SetMaximum(1.12546);
   ...
   pol01038->SetChisquare(2.919109);
   pol01038->SetNDF(8);
   ...
   pol01038->SetParameter(0,0.4811108);
   pol01038->SetParError(0,0.05673527);
