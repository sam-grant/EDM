void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1c_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.5161,-1.043156,2728.522,1.075285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","S12",100,736.8167,2507.221);
   Graph_Graph1031->SetMinimum(-0.8313124);
   Graph_Graph1031->SetMaximum(0.8634405);
   ...
   pol01032->SetChisquare(8.798004);
   pol01032->SetNDF(6);
   ...
   pol01032->SetParameter(0,-0.0006515783);
   pol01032->SetParError(0,0.01048009);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.000652
#pm0.01
 mrad","lpf");
