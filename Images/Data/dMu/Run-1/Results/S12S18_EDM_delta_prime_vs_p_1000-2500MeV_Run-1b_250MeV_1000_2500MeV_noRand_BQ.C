void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:40:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.585,-0.2275796,2667.576,1.13092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.384,2482.777);
   Graph_Graph1005->SetMinimum(-0.09172966);
   Graph_Graph1005->SetMaximum(0.9950697);
   ...
   pol01006->SetChisquare(6.964546);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3791587);
   pol01006->SetParError(0,0.05357817);
