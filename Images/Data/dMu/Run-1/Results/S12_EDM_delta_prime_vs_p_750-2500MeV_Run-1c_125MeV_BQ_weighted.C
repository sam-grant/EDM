void S12_EDM_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:49 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.8384,-1.654346,2837.08,2.477607);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","S12_",100,654.3626,2594.556);
   Graph_Graph1025->SetMinimum(-1.24115);
   Graph_Graph1025->SetMaximum(2.064412);
   ...
   pol01026->SetChisquare(12.01614);
   pol01026->SetNDF(13);
   ...
   pol01026->SetParameter(0,0.6199594);
   pol01026->SetParError(0,0.07188208);
