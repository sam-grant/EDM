void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_minusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:20:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2626,-0.2262596,2667.66,1.219354);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.08169827);
   Graph_Graph1001->SetMaximum(1.074792);
   ...
   pol01002->SetChisquare(2.059652);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3569968);
   pol01002->SetParError(0,0.06128482);
