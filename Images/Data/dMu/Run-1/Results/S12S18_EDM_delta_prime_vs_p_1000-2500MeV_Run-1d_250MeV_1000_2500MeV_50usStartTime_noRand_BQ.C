void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:29:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2245,-0.1943977,2667.425,0.9676304);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.07819488);
   Graph_Graph1005->SetMaximum(0.8514276);
   ...
   pol01006->SetChisquare(2.324525);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3510297);
   pol01006->SetParError(0,0.0478537);
