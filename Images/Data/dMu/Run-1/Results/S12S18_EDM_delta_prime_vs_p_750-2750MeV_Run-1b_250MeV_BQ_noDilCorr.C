void S12S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.0928,-0.9872394,3038.419,1.152757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1017->SetMinimum(-0.7732397);
   Graph_Graph1017->SetMaximum(0.9387577);
   ...
   pol01018->SetChisquare(9.860306);
   pol01018->SetNDF(7);
   ...
   pol01018->SetParameter(0,0.05321898);
   pol01018->SetParError(0,0.008802793);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0532
#pm0.009
 mrad","lpf");
