...
//=========  (Tue May 24 20:13:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,-1.223852e-18,4.65,2.57409e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(-8.440582e-19);
   Graph_Graph_Graph10011005->SetMaximum(2.194296e-18);
   ...
   fit1005->SetParameter(0,1.125219e-18);
   fit1005->SetParError(0,1.01854e-19);
   ...
   minusSigma1006->SetParameter(0,1.023365e-18);
   ...
   plusSigma1007->SetParameter(0,1.227073e-18);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-8.440582e-19);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(2.194296e-18);
   ...
   Graph_Graph_Graph10021007->SetMinimum(-4.524277e-19);
   Graph_Graph_Graph10021007->SetMaximum(1.872652e-18);
   ...
   Graph_Graph_Graph10031008->SetMinimum(4.247071e-19);
   Graph_Graph_Graph10031008->SetMaximum(1.834062e-18);
   ...
   pol01009->SetChisquare(7.800935);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,1.125219e-18);
   pol01009->SetParError(0,1.01854e-19);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("#delta#LTd_{#mu}#GT = 1.02#times10^{#minus19} e#upointcm");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
