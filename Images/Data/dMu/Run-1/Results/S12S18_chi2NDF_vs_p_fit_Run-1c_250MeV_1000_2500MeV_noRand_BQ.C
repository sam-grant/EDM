void S12S18_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.6266,-0.3118021,2667.726,2.806218);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","",100,1004.437,2482.916);
   Graph_Graph1017->SetMinimum(0);
   Graph_Graph1017->SetMaximum(2.494416);
   ...
   pol01018->SetChisquare(0.6632307);
   pol01018->SetNDF(5);
   ...
   pol01018->SetParameter(0,1.494416);
   pol01018->SetParError(0,0.1486865);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 1.5
#pm0.1
","lpf");
