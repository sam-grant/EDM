...
//=========  (Tue Mar 29 11:41:03 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",20,0.2279429,0.6332989);
   h__3->SetBinContent(9,1);
   h__3->SetBinContent(10,446);
   h__3->SetBinContent(11,550);
   h__3->SetBinContent(12,3);
