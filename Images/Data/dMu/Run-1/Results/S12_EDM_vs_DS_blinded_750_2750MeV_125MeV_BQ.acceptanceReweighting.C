void S12_EDM_vs_DS_blinded_750_2750MeV_125MeV_BQ.acceptanceReweighting()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 21 21:53:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,4.426994e-19,4.65,2.787206e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(6.771501e-19);
   Graph_Graph1001->SetMaximum(2.552756e-18);
