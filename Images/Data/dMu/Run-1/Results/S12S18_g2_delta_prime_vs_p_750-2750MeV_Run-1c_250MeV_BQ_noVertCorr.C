void S12S18_g2_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:45:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.2245,-1.597884,3037.802,2.051006);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,711.6823,2779.344);
   Graph_Graph1011->SetMinimum(-1.232995);
   Graph_Graph1011->SetMaximum(1.686117);
   ...
   pol01012->SetChisquare(13.17169);
   pol01012->SetNDF(7);
   ...
   pol01012->SetParameter(0,0.01566263);
   pol01012->SetParError(0,0.05675261);
