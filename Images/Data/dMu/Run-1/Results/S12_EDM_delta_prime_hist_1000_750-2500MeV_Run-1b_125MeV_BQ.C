...
//=========  (Thu Dec  2 14:43:38 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12",21,0.1343645,0.5606093);
   h__7->SetBinContent(8,1);
   h__7->SetBinContent(9,8);
   h__7->SetBinContent(10,139);
   h__7->SetBinContent(11,362);
   h__7->SetBinContent(12,361);
   h__7->SetBinContent(13,106);
   h__7->SetBinContent(14,21);
