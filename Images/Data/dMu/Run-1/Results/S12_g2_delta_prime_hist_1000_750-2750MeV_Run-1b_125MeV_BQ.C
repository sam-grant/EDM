...
//=========  (Thu Feb  3 11:00:02 2022) by ROOT version 6.24/06
   ...
   TH1D *h__10 = new TH1D("h__10","S12",20,-0.2587193,0.1483113);
   h__10->SetBinContent(10,226);
   h__10->SetBinContent(11,726);
   h__10->SetBinContent(12,48);
