...
//=========  (Thu Dec  2 14:43:38 2021) by ROOT version 6.24/04
   ...
   TH1D *h__8 = new TH1D("h__8","S18",21,0.2231497,0.6564151);
   h__8->SetBinContent(7,1);
   h__8->SetBinContent(9,11);
   h__8->SetBinContent(10,100);
   h__8->SetBinContent(11,238);
   h__8->SetBinContent(12,372);
   h__8->SetBinContent(13,186);
   h__8->SetBinContent(14,69);
   h__8->SetBinContent(15,21);
