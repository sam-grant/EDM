void S18_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.316192,2655.75,2.290856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.4484642,
   0.58324};
   TGraphErrors *gre = new TGraphErrors(12,_fx1021,_fy1021,_fex1021,_fey1021);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","S18_",100,799.5,2449.5);
   ...
   pol01022->SetParameter(0,-0.05786116);
   pol01022->SetParError(0,0.09310259);
