void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.441,-0.5002488,2667.684,0.6696762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-0.3832563);
   Graph_Graph1019->SetMaximum(0.5526837);
   ...
   pol01020->SetChisquare(0.9706239);
   pol01020->SetNDF(5);
   ...
   pol01020->SetParameter(0,0.1160163);
   pol01020->SetParError(0,0.05096264);
