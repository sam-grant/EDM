void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 13:08:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.9475,-1.53025,2728.833,1.351563);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12S18",100,736.336,2507.445);
   Graph_Graph1019->SetMinimum(-1.242069);
   Graph_Graph1019->SetMaximum(1.063382);
   ...
   pol01020->SetChisquare(10.17524);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,-0.001744465);
   pol01020->SetParError(0,0.03790465);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00174
#pm0.04
 mrad","lpf");
