void S12S18_EDM_delta_prime_vs_p_Run-1b_250MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.01373227,2750,0.1160089);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1065 = new TH1F("Graph_Graph1065","S12S18_",100,725,2525);
   Graph_Graph1065->SetMinimum(-0.0007581496);
   Graph_Graph1065->SetMaximum(0.1030348);
   ...
   Graph_Graph1065->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01066->SetChisquare(7.470831);
   pol01066->SetNDF(6);
   ...
   pol01066->SetParameter(0,0.02920983);
   pol01066->SetParError(0,0.004750961);
