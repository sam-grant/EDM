void S12_EDM_delta_prime_vs_p_Run-1b_250MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.0394243,2750,0.1304913);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01648235,
   0.01794318};
   TGraphErrors *gre = new TGraphErrors(7,_fx1061,_fy1061,_fex1061,_fey1061);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1061 = new TH1F("Graph_Graph1061","S12_",100,725,2525);
   Graph_Graph1061->SetMinimum(-0.02243274);
   Graph_Graph1061->SetMaximum(0.1134997);
   ...
   Graph_Graph1061->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01062->SetChisquare(2.865737);
   pol01062->SetNDF(6);
   ...
   pol01062->SetParameter(0,0.02606701);
   pol01062->SetParError(0,0.00655474);
