void S18_EDM_delta_prime_vs_p_Run-1b_250MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.03063494,2750,0.1502329);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1063 = new TH1F("Graph_Graph1063","S18_",100,725,2525);
   Graph_Graph1063->SetMinimum(-0.01254815);
   Graph_Graph1063->SetMaximum(0.1321462);
   ...
   Graph_Graph1063->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01064->SetChisquare(6.790796);
   pol01064->SetNDF(6);
   ...
   pol01064->SetParameter(0,0.03275776);
   pol01064->SetParError(0,0.006894751);
