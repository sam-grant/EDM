void S12S18_g2_delta_prime_vs_p_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:37 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18_",100,725,2525);
   Graph_Graph1023->SetMinimum(-0.7592672);
   Graph_Graph1023->SetMaximum(0.8934329);
   ...
   pol01024->SetChisquare(9.339797);
   pol01024->SetNDF(6);
   ...
   pol01024->SetParameter(0,-0.0375807);
   pol01024->SetParError(0,0.06343241);
