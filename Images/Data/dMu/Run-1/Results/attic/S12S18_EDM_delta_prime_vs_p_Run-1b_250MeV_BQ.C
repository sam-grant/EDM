void S12S18_EDM_delta_prime_vs_p_Run-1b_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:36 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S12S18_",100,725,2525);
   Graph_Graph1017->SetMinimum(-0.009798974);
   Graph_Graph1017->SetMaximum(1.485502);
   ...
   pol01018->SetChisquare(13.23021);
   pol01018->SetNDF(6);
   ...
   pol01018->SetParameter(0,0.3589111);
   pol01018->SetParError(0,0.0634066);
