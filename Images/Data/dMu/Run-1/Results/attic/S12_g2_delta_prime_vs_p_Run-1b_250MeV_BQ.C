void S12_g2_delta_prime_vs_p_Run-1b_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:37 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12_",100,725,2525);
   Graph_Graph1019->SetMinimum(-0.768311);
   Graph_Graph1019->SetMaximum(1.236749);
   ...
   pol01020->SetChisquare(5.178889);
   pol01020->SetNDF(6);
   ...
   pol01020->SetParameter(0,0.01172717);
   pol01020->SetParError(0,0.08775765);
