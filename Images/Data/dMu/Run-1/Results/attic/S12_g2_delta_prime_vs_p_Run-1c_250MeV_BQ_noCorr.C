void S12_g2_delta_prime_vs_p_Run-1c_250MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.05528224,2750,0.1066559);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1079 = new TH1F("Graph_Graph1079","S12_",100,725,2525);
   Graph_Graph1079->SetMinimum(-0.03908842);
   Graph_Graph1079->SetMaximum(0.09046212);
   ...
   pol01080->SetChisquare(8.539427);
   pol01080->SetNDF(6);
   ...
   pol01080->SetParameter(0,0.002891785);
   pol01080->SetParError(0,0.005405);
