...
//=========  (Mon Nov  8 20:00:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.9574949,2843.25,1.434314);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1035->SetMaximum(1.195133);
   ...
   pol01036->SetChisquare(19.83859);
   pol01036->SetNDF(13);
   ...
   pol01036->SetParameter(0,0.01154607);
   pol01036->SetParError(0,0.05205012);
