void S18_g2_delta_prime_vs_p_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:23 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-3.163726,2843.25,1.766509);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-2.670703);
   Graph_Graph1021->SetMaximum(1.273485);
   ...
   pol01022->SetChisquare(12.79889);
   pol01022->SetNDF(13);
   ...
   pol01022->SetParameter(0,-0.09364037);
   pol01022->SetParError(0,0.09146684);
