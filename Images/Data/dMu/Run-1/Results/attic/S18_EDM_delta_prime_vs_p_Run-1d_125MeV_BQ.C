...
//=========  (Mon Nov  8 20:00:29 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.022107,2843.25,1.908745);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1039->SetMinimum(-0.7290216);
   ...
   pol01040->SetParameter(0,0.5068813);
   pol01040->SetParError(0,0.05564896);
