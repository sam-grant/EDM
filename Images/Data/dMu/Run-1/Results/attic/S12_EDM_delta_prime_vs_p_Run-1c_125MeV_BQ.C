...
//=========  (Mon Nov  8 20:00:24 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.697707,2843.25,2.411983);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1025->SetMinimum(-1.286738);
   ...
   pol01026->SetParameter(0,0.5957534);
   pol01026->SetParError(0,0.0716977);
