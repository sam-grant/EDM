void S12S18_EDM_delta_prime_vs_p_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:43 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S12S18_",100,725,2525);
   Graph_Graph1041->SetMinimum(-0.01511138);
   Graph_Graph1041->SetMaximum(1.214115);
   ...
   pol01042->SetChisquare(12.31335);
   pol01042->SetNDF(6);
   ...
   pol01042->SetParameter(0,0.5097511);
   pol01042->SetParError(0,0.03824311);
