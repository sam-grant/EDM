void S18_EDM_delta_prime_vs_p_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:22 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.9015592,2843.25,3.244293);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1015->SetMaximum(2.829708);
   ...
   pol01016->SetParameter(0,0.4171051);
   pol01016->SetParError(0,0.09136695);
