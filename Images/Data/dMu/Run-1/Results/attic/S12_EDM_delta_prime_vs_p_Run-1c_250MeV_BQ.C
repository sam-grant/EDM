void S12_EDM_delta_prime_vs_p_Run-1c_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:38 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","S12_",100,725,2525);
   Graph_Graph1025->SetMinimum(-0.5976907);
   Graph_Graph1025->SetMaximum(1.486241);
   ...
   pol01026->SetChisquare(4.751367);
   pol01026->SetNDF(6);
   ...
   pol01026->SetParameter(0,0.6097193);
   pol01026->SetParError(0,0.07195016);
