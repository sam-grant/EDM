void S12S18_EDM_delta_prime_vs_p_Run-1c_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:39 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18_",100,725,2525);
   Graph_Graph1029->SetMinimum(-0.0707354);
   Graph_Graph1029->SetMaximum(1.322424);
   ...
   pol01030->SetChisquare(4.294915);
   pol01030->SetNDF(6);
   ...
   pol01030->SetParameter(0,0.5991144);
   pol01030->SetParError(0,0.05219711);
