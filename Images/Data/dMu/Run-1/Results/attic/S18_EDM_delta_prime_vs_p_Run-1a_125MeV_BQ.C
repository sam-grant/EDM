...
//=========  (Mon Nov  8 20:00:20 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.917922,2843.25,2.879995);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.43813);
   Graph_Graph1003->SetMaximum(2.400203);
   ...
   pol01004->SetChisquare(14.25436);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,0.2262072);
   pol01004->SetParError(0,0.1068663);
