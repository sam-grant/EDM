void S12_g2_delta_prime_vs_p_Run-1d_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:44 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1043 = new TH1F("Graph_Graph1043","S12_",100,725,2525);
   Graph_Graph1043->SetMinimum(-0.8896352);
   Graph_Graph1043->SetMaximum(0.8990229);
   ...
   pol01044->SetChisquare(14.55622);
   pol01044->SetNDF(6);
   ...
   pol01044->SetParameter(0,0.1024099);
   pol01044->SetParError(0,0.05250211);
