void S18_g2_delta_prime_vs_p_Run-1c_250MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.05571441,2750,0.1181146);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1081 = new TH1F("Graph_Graph1081","S18_",100,725,2525);
   Graph_Graph1081->SetMinimum(-0.03833151);
   Graph_Graph1081->SetMaximum(0.1007317);
   ...
   pol01082->SetChisquare(8.140579);
   pol01082->SetNDF(6);
   ...
   pol01082->SetParameter(0,0.0005068641);
   pol01082->SetParError(0,0.005732104);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00051
#pm0.006
 mrad","lpf");
