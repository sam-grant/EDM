void S12_EDM_delta_prime_vs_p_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.05559526,2843.25,0.2644949);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1049->SetMaximum(0.2324859);
   ...
   pol01050->SetChisquare(10.65624);
   pol01050->SetNDF(13);
   ...
   pol01050->SetParameter(0,0.042892);
   pol01050->SetParError(0,0.007644404);
