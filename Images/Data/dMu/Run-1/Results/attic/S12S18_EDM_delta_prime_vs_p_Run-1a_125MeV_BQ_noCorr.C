void S12S18_EDM_delta_prime_vs_p_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.04428335,2843.25,0.1808553);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1053->SetMaximum(0.1583415);
   ...
   pol01054->SetChisquare(11.77738);
   pol01054->SetNDF(13);
   ...
   pol01054->SetParameter(0,0.03128809);
   pol01054->SetParError(0,0.005538455);
