void S12_g2_delta_prime_vs_p_Run-1c_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:39 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","S12_",100,725,2525);
   Graph_Graph1031->SetMinimum(-0.625267);
   Graph_Graph1031->SetMaximum(1.30044);
   ...
   pol01032->SetChisquare(8.548149);
   pol01032->SetNDF(6);
   ...
   pol01032->SetParameter(0,0.03793846);
   pol01032->SetParError(0,0.07201603);
