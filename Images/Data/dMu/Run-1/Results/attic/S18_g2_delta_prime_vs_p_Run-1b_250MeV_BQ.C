void S18_g2_delta_prime_vs_p_Run-1b_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:37 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","S18_",100,725,2525);
   Graph_Graph1021->SetMinimum(-1.127478);
   Graph_Graph1021->SetMaximum(1.113347);
   ...
   pol01022->SetParameter(0,-0.09163358);
   pol01022->SetParError(0,0.09177907);
