void S12S18_g2_delta_prime_vs_p_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 19:06:45 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","S12S18_",100,725,2525);
   Graph_Graph1047->SetMinimum(-0.5927683);
   Graph_Graph1047->SetMaximum(0.7475875);
   ...
   pol01048->SetChisquare(16.01118);
   pol01048->SetNDF(6);
   ...
   pol01048->SetParameter(0,0.05878277);
   pol01048->SetParError(0,0.03826742);
