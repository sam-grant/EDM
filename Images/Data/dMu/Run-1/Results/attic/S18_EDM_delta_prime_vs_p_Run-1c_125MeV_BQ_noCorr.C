void S18_EDM_delta_prime_vs_p_Run-1c_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:33 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.06466692,2843.25,0.155923);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1075->SetMinimum(-0.04260793);
   Graph_Graph1075->SetMaximum(0.133864);
   ...
   pol01076->SetChisquare(16.72075);
   pol01076->SetNDF(13);
   ...
   pol01076->SetParameter(0,0.04597559);
   pol01076->SetParError(0,0.005686215);
