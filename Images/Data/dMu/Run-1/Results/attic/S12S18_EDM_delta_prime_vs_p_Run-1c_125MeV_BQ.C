void S12S18_EDM_delta_prime_vs_p_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:00:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-0.8700041,2843.25,2.037326);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18_",100,649.5,2599.5);
   Graph_Graph1029->SetMinimum(-0.5792711);
   ...
   pol01030->SetChisquare(13.85547);
   pol01030->SetNDF(13);
   ...
   pol01030->SetParameter(0,0.6003494);
   pol01030->SetParError(0,0.05201614);
