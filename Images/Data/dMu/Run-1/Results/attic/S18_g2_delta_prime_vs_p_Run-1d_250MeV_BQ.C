void S18_g2_delta_prime_vs_p_Run-1d_250MeV_BQ()
{
...
//=========  (Mon Nov  8 19:06:44 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph1045 = new TH1F("Graph_Graph1045","S18_",100,725,2525);
   Graph_Graph1045->SetMinimum(-0.5100898);
   Graph_Graph1045->SetMaximum(0.9424528);
   ...
   pol01046->SetChisquare(14.44233);
   pol01046->SetNDF(6);
   ...
   pol01046->SetParameter(0,0.009538233);
   pol01046->SetParError(0,0.05588965);
