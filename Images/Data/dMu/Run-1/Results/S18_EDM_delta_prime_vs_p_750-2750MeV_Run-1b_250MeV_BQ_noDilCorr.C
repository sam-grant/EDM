void S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.7258,-1.03705,3038.141,1.267089);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1015->SetMinimum(-0.806636);
   Graph_Graph1015->SetMaximum(1.036675);
   ...
   pol01016->SetChisquare(7.871199);
   pol01016->SetNDF(7);
   ...
   pol01016->SetParameter(0,0.0594663);
   pol01016->SetParError(0,0.01293428);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0595
#pm0.01
 mrad","lpf");
