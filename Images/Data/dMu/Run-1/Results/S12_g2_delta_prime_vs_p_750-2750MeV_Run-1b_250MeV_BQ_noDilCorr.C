void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.4607,-1.041117,3038.641,1.057467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1019->SetMinimum(-0.8312586);
   Graph_Graph1019->SetMaximum(0.847609);
   ...
   pol01020->SetChisquare(6.698706);
   pol01020->SetNDF(7);
   ...
   pol01020->SetParameter(0,-0.006450139);
   pol01020->SetParError(0,0.01192198);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00645
#pm0.01
 mrad","lpf");
