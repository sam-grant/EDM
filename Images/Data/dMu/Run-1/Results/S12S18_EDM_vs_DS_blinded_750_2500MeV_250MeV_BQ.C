void S12S18_EDM_vs_DS_blinded_750_2500MeV_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 14:17:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.35,5.913856e-19,4.85,2.437275e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(7.759746e-19);
   Graph_Graph1003->SetMaximum(2.252686e-18);
   ...
   pol01004->SetChisquare(3.313746);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,1.421585e-18);
   pol01004->SetParError(0,1.373317e-19);
