...
//=========  (Thu Dec  2 14:43:36 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.0437903,0.4613016);
   h__2->SetBinContent(8,1);
   h__2->SetBinContent(9,4);
   h__2->SetBinContent(10,191);
   h__2->SetBinContent(11,576);
   h__2->SetBinContent(12,201);
   h__2->SetBinContent(13,26);
