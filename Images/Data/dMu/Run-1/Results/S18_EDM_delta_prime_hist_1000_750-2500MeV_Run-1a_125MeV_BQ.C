...
//=========  (Mon Nov 22 17:27:55 2021) by ROOT version 6.24/04
   ...
   TH1D *h__8 = new TH1D("h__8","S18_",20,-0.006301742,0.4022642);
   h__8->SetBinContent(9,1);
   h__8->SetBinContent(10,77);
   h__8->SetBinContent(11,518);
   h__8->SetBinContent(12,360);
   h__8->SetBinContent(13,43);
   h__8->SetBinContent(14,1);
