void S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:47 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.374,-2.13856,2977.171,1.685674);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,979.3537,2755.191);
   Graph_Graph1009->SetMinimum(-1.756137);
   Graph_Graph1009->SetMaximum(1.303251);
   ...
   pol01010->SetChisquare(4.580278);
   pol01010->SetNDF(6);
   ...
   pol01010->SetParameter(0,-0.02936044);
   pol01010->SetParError(0,0.1199847);
