...
//=========  (Wed May  4 17:33:52 2022) by ROOT version 6.24/06
   ...
   c->Range(819.441,-0.8287495,2667.684,1.412548);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12",100,1004.265,2482.86);
   Graph_Graph1019->SetMinimum(-0.6046197);
   Graph_Graph1019->SetMaximum(1.188418);
   ...
   pol01020->SetParameter(0,0.2648661);
   pol01020->SetParError(0,0.02848729);
