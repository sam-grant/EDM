void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.4911,-1.058692,2728.721,1.207601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,735.9141,2507.298);
   Graph_Graph1009->SetMinimum(-0.8320625);
   Graph_Graph1009->SetMaximum(0.9809713);
   ...
   pol01010->SetChisquare(9.098708);
   pol01010->SetNDF(6);
   ...
   pol01010->SetParameter(0,-0.000181966);
   pol01010->SetParError(0,0.01599412);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.000182
#pm0.02
 mrad","lpf");
