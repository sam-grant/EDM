void S12S18_EDM_vs_DS_blinded_750_2750MeV_125MeV_BQ.acceptanceReweighting()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 21 21:53:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.35,7.22399e-19,4.85,2.715662e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(9.217253e-19);
   Graph_Graph1003->SetMaximum(2.516335e-18);
   ...
   pol01004->SetChisquare(12.04578);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,1.753003e-18);
   pol01004->SetParError(0,9.322907e-20);
