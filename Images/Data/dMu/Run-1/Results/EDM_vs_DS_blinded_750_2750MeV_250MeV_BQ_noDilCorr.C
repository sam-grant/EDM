void EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 14:17:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,-1.489767e-19,4.65,3.420596e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10101014->SetMinimum(-9.98731e-20);
   Graph_Graph_Graph10101014->SetMaximum(2.92956e-19);
   ...
   Graph_Graph_Graph10101014->GetXaxis()->SetLabelSize(0.055);
   ...
   fit1014->SetParameter(0,1.357123e-19);
   fit1014->SetParError(0,1.725305e-20);
   ...
   minusSigma1015->SetParameter(0,1.184593e-19);
   ...
   plusSigma1016->SetParameter(0,1.529654e-19);
   ...
   Graph_Graph_Graph_Graph101010141015->SetMinimum(-9.98731e-20);
   Graph_Graph_Graph_Graph101010141015->SetMaximum(2.92956e-19);
   ...
   Graph_Graph_Graph_Graph101010141015->GetXaxis()->SetLabelSize(0.055);
   ...
   TH1F *Graph_Graph_Graph10111016 = new TH1F("Graph_Graph_Graph10111016","",100,0.7,4.3);
   Graph_Graph_Graph10111016->SetMinimum(-4.553223e-20);
   Graph_Graph_Graph10111016->SetMaximum(2.524346e-19);
   ...
   TH1F *Graph_Graph_Graph10121017 = new TH1F("Graph_Graph_Graph10121017","",100,0.8,4.4);
   Graph_Graph_Graph10121017->SetMinimum(5.040662e-20);
   Graph_Graph_Graph10121017->SetMaximum(2.356463e-19);
   ...
   pol01018->SetChisquare(3.667066);
   pol01018->SetNDF(3);
   ...
   pol01018->SetParameter(0,1.357123e-19);
   pol01018->SetParError(0,1.725305e-20);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("#delta#LTd_{#mu}^{BLIND}#GT = 1.73#times10^{#minus20} e#upointcm");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
