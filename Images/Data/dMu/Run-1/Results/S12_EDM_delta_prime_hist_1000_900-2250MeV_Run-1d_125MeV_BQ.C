...
//=========  (Mon Nov  8 21:07:47 2021) by ROOT version 6.24/04
   ...
   TH1D *h__19 = new TH1D("h__19","S12_",22,0.2592815,0.7148497);
   h__19->SetBinContent(8,1);
   h__19->SetBinContent(9,9);
   h__19->SetBinContent(10,103);
   h__19->SetBinContent(11,254);
   h__19->SetBinContent(12,354);
   h__19->SetBinContent(13,189);
   h__19->SetBinContent(14,69);
   h__19->SetBinContent(15,17);
