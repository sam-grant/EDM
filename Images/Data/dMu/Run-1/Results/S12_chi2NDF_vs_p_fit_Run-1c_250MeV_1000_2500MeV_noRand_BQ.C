void S12_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.8476,-0.2777659,2667.686,2.499893);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","",100,1004.631,2482.903);
   Graph_Graph1013->SetMinimum(0);
   Graph_Graph1013->SetMaximum(2.222127);
   ...
   pol01014->SetChisquare(0.4600808);
   pol01014->SetNDF(5);
   ...
   pol01014->SetParameter(0,1.222127);
   pol01014->SetParError(0,0.1238387);
