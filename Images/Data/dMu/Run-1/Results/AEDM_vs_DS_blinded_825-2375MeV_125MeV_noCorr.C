void AEDM_vs_DS_blinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-4.146305e-21,4.75,2.034399e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10461050->SetMinimum(1.661232e-20);
   Graph_Graph_Graph10461050->SetMaximum(1.826813e-19);
   ...
   fit1050->SetParameter(0,1.225446e-19);
   fit1050->SetParError(0,6.491544e-21);
   ...
   shift_-11051->SetParameter(0,1.16053e-19);
   ...
   shift_11052->SetParameter(0,1.290361e-19);
   ...
   Graph_Graph_Graph_Graph104610501051->SetMinimum(1.661232e-20);
   Graph_Graph_Graph_Graph104610501051->SetMaximum(1.826813e-19);
   ...
   Graph_Graph_Graph10471052->SetMinimum(1.572758e-20);
   Graph_Graph_Graph10471052->SetMaximum(1.874908e-19);
   ...
   Graph_Graph_Graph10481053->SetMinimum(6.075171e-20);
   Graph_Graph_Graph10481053->SetMaximum(1.755533e-19);
   ...
   pol01054->SetChisquare(13.11644);
   pol01054->SetNDF(3);
   ...
   pol01054->SetParameter(0,1.225446e-19);
   pol01054->SetParError(0,6.491544e-21);
