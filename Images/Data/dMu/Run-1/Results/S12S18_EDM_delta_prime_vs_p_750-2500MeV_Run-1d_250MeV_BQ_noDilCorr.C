void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.0162,-0.9027792,2728.333,1.059255);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S12S18",100,736.348,2507.002);
   Graph_Graph1041->SetMinimum(-0.7065758);
   Graph_Graph1041->SetMaximum(0.8630512);
   ...
   pol01042->SetChisquare(3.996856);
   pol01042->SetNDF(6);
   ...
   pol01042->SetParameter(0,0.07192896);
   pol01042->SetParError(0,0.005366588);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0719
#pm0.005
 mrad","lpf");
