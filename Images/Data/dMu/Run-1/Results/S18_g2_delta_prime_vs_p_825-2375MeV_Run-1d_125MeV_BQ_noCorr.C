void S18_g2_delta_prime_vs_p_825-2375MeV_Run-1d_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:44 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.06833542,2655.75,0.09554294);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01590071,
   0.01685485};
   TGraphErrors *gre = new TGraphErrors(12,_fx1093,_fy1093,_fex1093,_fey1093);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1093 = new TH1F("Graph_Graph1093","S18_",100,799.5,2449.5);
   ...
   pol01094->SetParameter(0,2.92581e-05);
   pol01094->SetParError(0,0.004397909);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 2.9e-05
#pm0.004
 mrad","lpf");
