void S12S18_g2_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:54 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9846,-1.286108,3038.491,1.167598);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1047->SetMinimum(-1.040737);
   Graph_Graph1047->SetMaximum(0.9222276);
   ...
   pol01048->SetChisquare(16.47595);
   pol01048->SetNDF(7);
   ...
   pol01048->SetParameter(0,0.02150168);
   pol01048->SetParError(0,0.01948389);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0215
#pm0.02
 mrad","lpf");
