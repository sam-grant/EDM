void S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:39:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.5223,-1.92757,2976.21,1.408213);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,979.3911,2754.341);
   Graph_Graph1009->SetMinimum(-1.593991);
   Graph_Graph1009->SetMaximum(1.074634);
   ...
   pol01010->SetParameter(0,-0.08287552);
   pol01010->SetParError(0,0.08496745);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.083
#pm0.08
 mrad","lpf");
