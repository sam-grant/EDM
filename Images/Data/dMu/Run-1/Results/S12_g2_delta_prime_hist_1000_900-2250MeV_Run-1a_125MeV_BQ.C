...
//=========  (Mon Nov  8 21:07:40 2021) by ROOT version 6.24/04
   ...
   TH1D *h__4 = new TH1D("h__4","S12_",20,-0.2643189,0.1385074);
   h__4->SetBinContent(10,104);
   h__4->SetBinContent(11,813);
   h__4->SetBinContent(12,83);
