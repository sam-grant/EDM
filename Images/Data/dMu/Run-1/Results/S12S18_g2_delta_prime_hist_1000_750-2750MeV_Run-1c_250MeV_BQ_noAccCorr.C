void S12S18_g2_delta_prime_hist_1000_750-2750MeV_Run-1c_250MeV_BQ_noAccCorr()
{
...
//=========  (Wed Apr 20 00:10:48 2022) by ROOT version 6.24/06
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18",20,-0.1899734,0.2104913);
   h__18->SetBinContent(10,610);
   h__18->SetBinContent(11,390);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.01014
#pm2e-05
");
   pt_LaTex = pt->AddText("0.00052
#pm1e-05
");
   pt->Draw();
   c->Modified();
