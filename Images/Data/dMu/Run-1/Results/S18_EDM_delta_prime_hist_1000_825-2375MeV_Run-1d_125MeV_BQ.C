...
//=========  (Mon Nov  8 21:03:40 2021) by ROOT version 6.24/04
   ...
   TH1D *h__20 = new TH1D("h__20","S18_",22,0.2759964,0.7295242);
   h__20->SetBinContent(8,3);
   h__20->SetBinContent(9,24);
   h__20->SetBinContent(10,142);
   h__20->SetBinContent(11,263);
   h__20->SetBinContent(12,325);
   h__20->SetBinContent(13,164);
   h__20->SetBinContent(14,60);
   h__20->SetBinContent(15,15);
   h__20->SetBinContent(16,3);
