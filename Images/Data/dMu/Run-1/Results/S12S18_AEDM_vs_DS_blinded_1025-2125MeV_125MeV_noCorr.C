void S12S18_AEDM_vs_DS_blinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,3.59757e-20,4.75,2.006777e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1048->SetMinimum(5.244591e-20);
   Graph_Graph1048->SetMaximum(1.842075e-19);
   ...
   pol01049->SetChisquare(13.36743);
   pol01049->SetNDF(3);
   ...
   pol01049->SetParameter(0,1.235341e-19);
   pol01049->SetParError(0,7.286888e-21);
