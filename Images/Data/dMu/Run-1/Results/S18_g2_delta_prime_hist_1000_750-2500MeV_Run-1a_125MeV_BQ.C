...
//=========  (Thu Dec  2 14:43:37 2021) by ROOT version 6.24/04
   ...
   TH1D *h__5 = new TH1D("h__5","S18",20,-0.1458121,0.2656486);
   h__5->SetBinContent(10,22);
   h__5->SetBinContent(11,805);
   h__5->SetBinContent(12,173);
