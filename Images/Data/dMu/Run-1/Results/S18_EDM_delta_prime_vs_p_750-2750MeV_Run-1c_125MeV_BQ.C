...
//=========  (Mon Mar 21 21:45:15 2022) by ROOT version 6.24/06
   ...
   c->Range(350.1055,-1.14153,3143.568,2.60847);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.7665304);
   Graph_Graph1003->SetMaximum(2.23347);
   ...
   pol01004->SetChisquare(20.05257);
   pol01004->SetNDF(15);
   ...
   pol01004->SetParameter(0,0.7334696);
   pol01004->SetParError(0,0.08416669);
