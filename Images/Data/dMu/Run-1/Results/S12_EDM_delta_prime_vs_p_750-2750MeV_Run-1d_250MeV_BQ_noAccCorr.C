void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.1429,-0.9641675,3039.225,1.918424);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1037->SetMinimum(-0.6759084);
   Graph_Graph1037->SetMaximum(1.630165);
   ...
   pol01038->SetChisquare(7.838553);
   pol01038->SetNDF(7);
   ...
   pol01038->SetParameter(0,0.2594784);
   pol01038->SetParError(0,0.02674862);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.259
#pm0.03
 mrad","lpf");
