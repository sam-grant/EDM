...
//=========  (Mon Nov  8 21:07:45 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.238354,2499.5,1.957259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.286744,
   0.3388233};
   TGraphErrors *gre = new TGraphErrors(11,_fx1031,_fy1031,_fex1031,_fey1031);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","S12_",100,812,2312);
   Graph_Graph1031->SetMinimum(-0.9187926);
   Graph_Graph1031->SetMaximum(1.637698);
   ...
   pol01032->SetParameter(0,0.006962335);
   pol01032->SetParError(0,0.07404925);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.007
#pm0.07
 mrad","lpf");
