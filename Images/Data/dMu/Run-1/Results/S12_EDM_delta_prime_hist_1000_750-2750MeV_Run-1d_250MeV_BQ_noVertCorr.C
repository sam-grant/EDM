...
//=========  (Tue Mar 29 10:47:26 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",20,0.3860451,0.7929304);
   h__1->SetBinContent(9,8);
   h__1->SetBinContent(10,456);
   h__1->SetBinContent(11,510);
   h__1->SetBinContent(12,25);
   h__1->SetBinContent(13,1);
