void S12S18_Ag2_vs_DS_blinded_1025-2125MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-15.00899,4.75,10.60922);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1039->SetMinimum(-12.44717);
   Graph_Graph1039->SetMaximum(8.047396);
   ...
   pol01040->SetChisquare(1.683672);
   pol01040->SetNDF(3);
   ...
   pol01040->SetParameter(0,0.2423966);
   pol01040->SetParError(0,2.280985);
