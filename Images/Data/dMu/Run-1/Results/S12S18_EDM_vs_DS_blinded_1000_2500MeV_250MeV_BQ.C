...
//=========  (Wed May  4 17:41:26 2022) by ROOT version 6.24/06
   ...
   c->Range(0.35,2.292137e-19,4.85,1.210113e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(3.273036e-19);
   Graph_Graph1003->SetMaximum(1.112023e-18);
   ...
   pol01004->SetChisquare(5.795407);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,7.007327e-19);
   pol01004->SetParError(0,6.213546e-20);
