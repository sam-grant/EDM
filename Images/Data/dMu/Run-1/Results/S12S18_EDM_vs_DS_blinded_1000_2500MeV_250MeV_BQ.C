...
//=========  (Sun May  8 19:50:03 2022) by ROOT version 6.24/06
   ...
   c->Range(0.35,5.075251e-19,4.85,2.393194e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(6.96092e-19);
   Graph_Graph1003->SetMaximum(2.204627e-18);
   ...
   pol01004->SetChisquare(7.458676);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,1.429803e-18);
   pol01004->SetParError(0,1.129577e-19);
