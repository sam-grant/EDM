void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:27:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2554,-1.337856,2667.767,1.31404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.072666);
   Graph_Graph1003->SetMaximum(1.048851);
   ...
   pol01004->SetChisquare(6.493792);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,-0.2240061);
   pol01004->SetParError(0,0.1198648);
