void S12_Ag2_vs_DS_blinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:17 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-20.71795,4.75,15.44114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1037->SetMinimum(-17.10204);
   Graph_Graph1037->SetMaximum(11.82523);
