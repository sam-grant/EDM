void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.9475,-1.046055,2728.833,1.122843);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,736.336,2507.445);
   Graph_Graph1011->SetMinimum(-0.8291656);
   Graph_Graph1011->SetMaximum(0.9059527);
   ...
   pol01012->SetChisquare(9.332673);
   pol01012->SetNDF(6);
   ...
   pol01012->SetParameter(0,-0.009609131);
   pol01012->SetParError(0,0.0104553);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00961
#pm0.01
 mrad","lpf");
