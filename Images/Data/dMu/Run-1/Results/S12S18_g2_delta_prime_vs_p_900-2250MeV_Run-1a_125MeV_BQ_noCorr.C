...
//=========  (Mon Nov  8 21:07:50 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.07661398,2499.5,0.1547571);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02002539,
   0.02046632};
   TGraphErrors *gre = new TGraphErrors(11,_fx1059,_fy1059,_fex1059,_fey1059);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1059 = new TH1F("Graph_Graph1059","S12S18_",100,812,2312);
   Graph_Graph1059->SetMinimum(-0.05347687);
   Graph_Graph1059->SetMaximum(0.13162);
   ...
   pol01060->SetParameter(0,0.001134712);
   pol01060->SetParError(0,0.006044469);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0011
#pm0.006
 mrad","lpf");
