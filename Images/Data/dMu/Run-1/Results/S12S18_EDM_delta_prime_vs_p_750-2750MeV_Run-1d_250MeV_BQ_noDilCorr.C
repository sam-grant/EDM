void S12S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.9846,-0.9045076,3038.491,1.053931);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1041->SetMinimum(-0.7086637);
   Graph_Graph1041->SetMaximum(0.8580876);
   ...
   pol01042->SetChisquare(5.604896);
   pol01042->SetNDF(7);
   ...
   pol01042->SetParameter(0,0.07330353);
   pol01042->SetParError(0,0.005327517);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0733
#pm0.005
 mrad","lpf");
