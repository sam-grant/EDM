void S18_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_minusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:20:07 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",50,-0.2338145,0.7836193);
   h__2->SetBinContent(21,10);
   h__2->SetBinContent(22,53);
   h__2->SetBinContent(23,221);
   h__2->SetBinContent(24,342);
   h__2->SetBinContent(25,252);
   h__2->SetBinContent(26,94);
   h__2->SetBinContent(27,22);
   h__2->SetBinContent(28,5);
   h__2->SetBinContent(29,1);
