void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:41:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.7777,-0.1350538,2667.608,0.8859068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.561,2482.825);
   Graph_Graph1001->SetMinimum(-0.03295772);
   Graph_Graph1001->SetMaximum(0.7838107);
   ...
   pol01002->SetChisquare(1.552705);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3839099);
   pol01002->SetParError(0,0.0411462);
