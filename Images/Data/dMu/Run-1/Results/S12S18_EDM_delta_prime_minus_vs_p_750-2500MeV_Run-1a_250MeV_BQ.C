void S12S18_EDM_delta_prime_minus_vs_p_750-2500MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May  4 12:58:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.9475,-1.157142,2728.833,2.065191);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1057 = new TH1F("Graph_Graph1057","S12S18",100,736.336,2507.445);
   Graph_Graph1057->SetMinimum(-0.8349084);
   Graph_Graph1057->SetMaximum(1.742958);
   ...
   Graph_Graph1057->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01058->SetChisquare(3.245262);
   pol01058->SetNDF(6);
   ...
   pol01058->SetParameter(0,0.4550395);
   pol01058->SetParError(0,0.07640104);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.455
#pm0.08
 mrad","lpf");
