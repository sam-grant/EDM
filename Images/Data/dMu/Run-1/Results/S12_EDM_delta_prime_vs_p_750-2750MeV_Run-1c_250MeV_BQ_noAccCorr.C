void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:43 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5532,-1.130946,3038.337,2.217332);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1025->SetMinimum(-0.7961181);
   Graph_Graph1025->SetMaximum(1.882504);
   ...
   pol01026->SetParameter(0,0.3006467);
   pol01026->SetParError(0,0.03669668);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.301
#pm0.04
 mrad","lpf");
