void S12_EDM_delta_prime_hist_1000_750-2750MeV_Run-1c_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:45:25 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",20,0.4753441,0.8832384);
   h__1->SetBinContent(9,12);
   h__1->SetBinContent(10,453);
   h__1->SetBinContent(11,494);
   h__1->SetBinContent(12,40);
