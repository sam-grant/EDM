void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:39:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3456,-0.4460274,2667.468,0.6776792);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,1004.158,2482.656);
   Graph_Graph1011->SetMinimum(-0.3336567);
   Graph_Graph1011->SetMaximum(0.5653085);
   ...
   Graph_Graph1011->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 500 MeV");
   ...
   pol01012->SetChisquare(4.362997);
   pol01012->SetNDF(5);
   ...
   pol01012->SetParameter(0,0.1248133);
   pol01012->SetParError(0,0.04000886);
