void S12S18_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:11:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4016,-0.2436777,2667.941,2.193099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.256,2483.087);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(1.949421);
   ...
   pol01006->SetChisquare(0.4131021);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.9494212);
   pol01006->SetParError(0,0.1173459);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 0.95
#pm0.1
","lpf");
