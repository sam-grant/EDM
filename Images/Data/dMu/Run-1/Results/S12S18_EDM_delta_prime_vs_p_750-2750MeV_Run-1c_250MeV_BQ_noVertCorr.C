...
//=========  (Tue Mar 29 10:45:26 2022) by ROOT version 6.24/06
   ...
   c->Range(453.2245,-0.7572791,3037.802,2.388601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.4426912);
   Graph_Graph1005->SetMaximum(2.074013);
   ...
   pol01006->SetChisquare(4.431585);
   pol01006->SetNDF(7);
   ...
   pol01006->SetParameter(0,0.6842058);
   pol01006->SetParError(0,0.05641047);
