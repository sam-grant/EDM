void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:30:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2545,-0.7490613,2667.768,1.728967);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.5012585);
   Graph_Graph1003->SetMaximum(1.481164);
   ...
   pol01004->SetChisquare(5.956582);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.1803441);
