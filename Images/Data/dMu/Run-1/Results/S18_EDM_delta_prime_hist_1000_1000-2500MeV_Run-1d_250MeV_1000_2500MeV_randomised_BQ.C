...
//=========  (Sun Jun 12 15:46:12 2022) by ROOT version 6.24/06
   ...
   TH1D *h__11 = new TH1D("h__11","S18",51,-0.06934736,0.9530696);
   h__11->SetBinContent(21,1);
   h__11->SetBinContent(22,5);
   h__11->SetBinContent(23,31);
   h__11->SetBinContent(24,133);
   h__11->SetBinContent(25,213);
   h__11->SetBinContent(26,246);
   h__11->SetBinContent(27,188);
   h__11->SetBinContent(28,117);
   h__11->SetBinContent(29,50);
   h__11->SetBinContent(30,10);
   h__11->SetBinContent(31,5);
   h__11->SetBinContent(34,1);
