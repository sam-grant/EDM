void S18_EDM_delta_prime_hist_1000_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
...
//=========  (Tue May 24 20:13:15 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",51,-0.06931482,0.9531216);
   h__2->SetBinContent(21,1);
   h__2->SetBinContent(22,5);
   h__2->SetBinContent(23,31);
   h__2->SetBinContent(24,133);
   h__2->SetBinContent(25,213);
   h__2->SetBinContent(26,246);
   h__2->SetBinContent(27,188);
   h__2->SetBinContent(28,117);
   h__2->SetBinContent(29,50);
   h__2->SetBinContent(30,10);
   h__2->SetBinContent(31,5);
   h__2->SetBinContent(34,1);
