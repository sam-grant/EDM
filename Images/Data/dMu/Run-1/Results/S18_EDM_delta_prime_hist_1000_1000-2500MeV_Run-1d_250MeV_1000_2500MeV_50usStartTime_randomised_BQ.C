...
//=========  (Fri May 13 18:02:12 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",51,-0.05055209,0.9795354);
   h__2->SetBinContent(20,1);
   h__2->SetBinContent(21,11);
   h__2->SetBinContent(22,35);
   h__2->SetBinContent(23,107);
   h__2->SetBinContent(24,205);
   h__2->SetBinContent(25,234);
   h__2->SetBinContent(26,195);
   h__2->SetBinContent(27,123);
   h__2->SetBinContent(28,61);
   h__2->SetBinContent(29,19);
