...
//=========  (Tue Aug 30 13:18:21 2022) by ROOT version 6.26/04
   ...
   TH1D *h__11 = new TH1D("h__11","S18",30,0.1377503,0.4380312);
   h__11->SetBinContent(15,517);
   h__11->SetBinContent(16,483);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2879
#pm2e-05
");
   pt_LaTex = pt->AddText("0.000576
#pm1e-05
");
   pt->Draw();
   c->Modified();
