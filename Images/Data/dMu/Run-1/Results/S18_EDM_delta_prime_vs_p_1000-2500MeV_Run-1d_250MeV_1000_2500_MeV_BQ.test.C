void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:05 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.2502,-0.6605461,2667.186,1.10966);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-0.4835255);
   Graph_Graph1021->SetMaximum(0.9326392);
   ...
   pol01022->SetChisquare(8.754558);
   pol01022->SetNDF(5);
   ...
   pol01022->SetParameter(0,0.1672417);
