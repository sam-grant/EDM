...
//=========  (Tue Mar 29 10:45:26 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.4829285,0.8908293);
   h__2->SetBinContent(9,16);
   h__2->SetBinContent(10,446);
   h__2->SetBinContent(11,493);
   h__2->SetBinContent(12,44);
