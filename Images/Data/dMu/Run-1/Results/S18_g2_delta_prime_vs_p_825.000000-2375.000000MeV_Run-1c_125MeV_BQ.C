void S18_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:34 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.479489,2655.75,2.237221);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1033 = new TH1F("Graph_Graph1033","S18_",100,799.5,2449.5);
   ...
   pol01034->SetParameter(0,-0.002725932);
   pol01034->SetParError(0,0.07695293);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0027
#pm0.08
 mrad","lpf");
