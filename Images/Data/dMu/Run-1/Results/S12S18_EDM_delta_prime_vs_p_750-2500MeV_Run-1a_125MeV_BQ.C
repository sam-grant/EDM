...
//=========  (Mon Nov 22 17:27:55 2021) by ROOT version 6.24/04
   ...
   c->Range(411.5072,-0.7192925,2837.475,2.750915);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1017 = new TH1F("Graph_Graph1017","S12S18_",100,654.104,2594.878);
   Graph_Graph1017->SetMinimum(-0.3722718);
   Graph_Graph1017->SetMaximum(2.403894);
   ...
   pol01018->SetChisquare(13.08168);
   pol01018->SetNDF(13);
   ...
   pol01018->SetParameter(0,0.4042682);
   pol01018->SetParError(0,0.07406961);
