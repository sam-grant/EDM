...
//=========  (Mon Nov 22 17:27:57 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18_",20,-0.2349347,0.1804946);
   h__12->SetBinContent(10,167);
   h__12->SetBinContent(11,731);
   h__12->SetBinContent(12,102);
