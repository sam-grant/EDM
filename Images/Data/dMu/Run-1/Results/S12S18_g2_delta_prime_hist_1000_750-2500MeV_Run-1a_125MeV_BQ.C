...
//=========  (Thu Nov 18 09:29:12 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",20,-0.2375071,0.1780134);
   h__6->SetBinContent(10,192);
   h__6->SetBinContent(11,725);
   h__6->SetBinContent(12,83);
