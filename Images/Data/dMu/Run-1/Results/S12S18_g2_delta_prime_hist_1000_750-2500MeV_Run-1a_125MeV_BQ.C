...
//=========  (Thu Dec  2 14:43:38 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2259973,0.1796304);
   h__6->SetBinContent(10,31);
   h__6->SetBinContent(11,745);
   h__6->SetBinContent(12,223);
