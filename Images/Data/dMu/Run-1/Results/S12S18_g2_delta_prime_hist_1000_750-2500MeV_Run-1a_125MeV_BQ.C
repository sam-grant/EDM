...
//=========  (Thu Nov 18 11:46:27 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18_",20,-0.2374505,0.1777874);
   h__6->SetBinContent(10,170);
   h__6->SetBinContent(11,723);
   h__6->SetBinContent(12,107);
