void S12S18_g2_delta_prime_hist_1000_750-2750MeV_Run-1b_250MeV_BQ_noVertCorr()
{
...
//=========  (Tue Mar 29 10:44:12 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2477184,0.152288);
   h__6->SetBinContent(10,659);
   h__6->SetBinContent(11,341);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.04809
#pm3e-05
");
   pt_LaTex = pt->AddText("0.00086
#pm2e-05
");
   pt->Draw();
   c->Modified();
