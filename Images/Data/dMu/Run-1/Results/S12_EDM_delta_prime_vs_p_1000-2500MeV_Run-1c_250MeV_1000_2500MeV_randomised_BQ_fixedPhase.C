void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:02:51 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.476,-0.1872913,2667.731,1.650373);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.00352487);
   Graph_Graph1001->SetMaximum(1.466606);
   ...
   pol01002->SetChisquare(5.011103);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.5808536);
   pol01002->SetParError(0,0.06981797);
