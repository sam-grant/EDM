...
//=========  (Mon Nov  8 21:10:07 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.9463755,2312,2.00289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-0.651449);
   Graph_Graph1013->SetMaximum(1.707963);
   ...
   pol01014->SetChisquare(12.24881);
   pol01014->SetNDF(8);
   ...
   pol01014->SetParameter(0,0.2482224);
   pol01014->SetParError(0,0.09491641);
