void S12S18_g2_delta_prime_vs_p_825-2375MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.6051504,2655.75,0.789039);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.1836175,
   0.2390183};
   TGraphErrors *gre = new TGraphErrors(12,_fx1047,_fy1047,_fex1047,_fey1047);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","S12S18_",100,799.5,2449.5);
   Graph_Graph1047->SetMinimum(-0.4657315);
   Graph_Graph1047->SetMaximum(0.6496201);
   ...
   pol01048->SetParameter(0,0.04216239);
   pol01048->SetParError(0,0.03880638);
