void S12S18_EDM_delta_prime_hist_1000_1000-2750MeV_Run-1c_250MeV_BQ()
{
...
//=========  (Tue Mar 29 11:39:31 2022) by ROOT version 6.24/06
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",20,0.4776861,0.885651);
   h__3->SetBinContent(9,13);
   h__3->SetBinContent(10,451);
   h__3->SetBinContent(11,495);
   h__3->SetBinContent(12,40);
