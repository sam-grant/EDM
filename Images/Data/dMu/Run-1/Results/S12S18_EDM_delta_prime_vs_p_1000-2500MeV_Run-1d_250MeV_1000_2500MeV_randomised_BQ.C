void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 24 20:13:15 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3456,-0.1585831,2667.468,0.9650959);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.158,2482.656);
   Graph_Graph1005->SetMinimum(-0.04621521);
   Graph_Graph1005->SetMaximum(0.852728);
   ...
   pol01006->SetChisquare(4.363456);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.4122579);
   pol01006->SetParError(0,0.04000886);
