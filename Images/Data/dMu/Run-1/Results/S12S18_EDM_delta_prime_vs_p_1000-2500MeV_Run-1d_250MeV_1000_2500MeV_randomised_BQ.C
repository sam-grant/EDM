...
//=========  (Sun Jun 12 15:46:12 2022) by ROOT version 6.24/06
   ...
   c->Range(819.3456,-0.1582911,2667.468,0.9646278);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18",100,1004.158,2482.656);
   Graph_Graph1023->SetMinimum(-0.04599923);
   Graph_Graph1023->SetMaximum(0.8523359);
   ...
   Graph_Graph1023->GetYaxis()->SetTitle("#delta^{BLIND} [mrad] / 250 MeV");
   ...
   pol01024->SetChisquare(4.355301);
   pol01024->SetNDF(5);
   ...
   pol01024->SetParameter(0,0.4122521);
   pol01024->SetParError(0,0.04000919);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.41
#pm0.04
 mrad","lpf");
