void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:29:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1932,-0.5278042,2667.129,1.389953);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.3360285);
   Graph_Graph1003->SetMaximum(1.198177);
   ...
   pol01004->SetChisquare(10.48109);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.3352418);
   pol01004->SetParError(0,0.07451844);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.34
#pm0.07
 mrad","lpf");
