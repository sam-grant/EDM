...
//=========  (Tue Mar 29 10:47:28 2022) by ROOT version 6.24/06
   ...
   TH1D *h__5 = new TH1D("h__5","S18",20,-0.1864098,0.213891);
   h__5->SetBinContent(10,557);
   h__5->SetBinContent(11,443);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.0137
#pm1e-05
");
   pt_LaTex = pt->AddText("0.00035
#pm8e-06
");
   pt->Draw();
   c->Modified();
