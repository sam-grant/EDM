void S18_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:26 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.324373,2655.75,2.217178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5129233,
   0.6650872};
   TGraphErrors *gre = new TGraphErrors(12,_fx1003,_fy1003,_fex1003,_fey1003);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18_",100,799.5,2449.5);
   Graph_Graph1003->SetMinimum(-0.9702177);
   Graph_Graph1003->SetMaximum(1.863023);
   ...
   pol01004->SetParameter(0,0.2161606);
   pol01004->SetParError(0,0.1088176);
