void S18_AEDM_vs_DS_blinded_1025-2125MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov  9 14:14:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-2.57658e-19,4.75,2.625956e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S18",100,0.7,4.3);
   Graph_Graph1011->SetMinimum(3.070341e-20);
   Graph_Graph1011->SetMaximum(2.337594e-18);
   ...
   Graph_Graph1011->GetYaxis()->SetTitle("d_{#mu}^{BLIND} [e#upointcm]");
