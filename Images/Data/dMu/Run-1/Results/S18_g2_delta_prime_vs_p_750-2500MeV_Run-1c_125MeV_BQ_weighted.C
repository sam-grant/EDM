void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.2335,-1.535354,2837.87,2.068761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1033 = new TH1F("Graph_Graph1033","S18_",100,653.8971,2595.206);
   Graph_Graph1033->SetMinimum(-1.174943);
   Graph_Graph1033->SetMaximum(1.708349);
   ...
   pol01034->SetChisquare(15.83143);
   pol01034->SetNDF(13);
   ...
   pol01034->SetParameter(0,-0.01399064);
   pol01034->SetParError(0,0.07577564);
