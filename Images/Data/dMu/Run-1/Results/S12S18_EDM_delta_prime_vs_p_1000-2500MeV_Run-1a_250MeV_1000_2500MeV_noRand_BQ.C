void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:38:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.7269,-0.4644891,2667.812,1.191396);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.535,2483.004);
   Graph_Graph1005->SetMinimum(-0.2989007);
   Graph_Graph1005->SetMaximum(1.025807);
   ...
   pol01006->SetChisquare(7.343036);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3569882);
   pol01006->SetParError(0,0.06275731);
