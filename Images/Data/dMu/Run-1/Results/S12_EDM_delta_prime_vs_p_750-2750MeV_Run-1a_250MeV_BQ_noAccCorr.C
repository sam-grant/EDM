void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5042,-1.497337,3038.389,1.776127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,711.9927,2779.9);
   Graph_Graph1001->SetMinimum(-1.16999);
   Graph_Graph1001->SetMaximum(1.448781);
   ...
   pol01002->SetChisquare(6.225143);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.3159339);
   pol01002->SetParError(0,0.05242509);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.316
#pm0.05
 mrad","lpf");
