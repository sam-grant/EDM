...
//=========  (Mon Nov  8 21:07:48 2021) by ROOT version 6.24/04
   ...
   TH1D *h__21 = new TH1D("h__21","S12S18_",22,0.2590207,0.7134441);
   h__21->SetBinContent(8,1);
   h__21->SetBinContent(9,12);
   h__21->SetBinContent(10,121);
   h__21->SetBinContent(11,269);
   h__21->SetBinContent(12,350);
   h__21->SetBinContent(13,169);
   h__21->SetBinContent(14,60);
   h__21->SetBinContent(15,14);
