void S12S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.059,-1.003428,3038.275,1.199547);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.7831309);
   Graph_Graph1005->SetMaximum(0.9792491);
   ...
   pol01006->SetChisquare(11.57191);
   pol01006->SetNDF(7);
   ...
   pol01006->SetParameter(0,0.05365446);
   pol01006->SetParError(0,0.01029773);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0537
#pm0.01
 mrad","lpf");
