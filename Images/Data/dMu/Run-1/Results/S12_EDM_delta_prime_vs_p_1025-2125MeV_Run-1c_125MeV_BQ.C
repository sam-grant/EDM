...
//=========  (Mon Nov  8 21:10:09 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.7452068,2312,1.387641);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1025->SetMinimum(-0.531922);
   Graph_Graph1025->SetMaximum(1.174356);
   ...
   pol01026->SetChisquare(3.942236);
   pol01026->SetNDF(8);
   ...
   pol01026->SetParameter(0,0.6231441);
   pol01026->SetParError(0,0.07776229);
