void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.2849,-1.029189,2728.515,1.033537);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1043 = new TH1F("Graph_Graph1043","S12",100,736.608,2507.192);
   Graph_Graph1043->SetMinimum(-0.8229165);
   Graph_Graph1043->SetMaximum(0.8272647);
   ...
   pol01044->SetParameter(0,0.00518077);
   pol01044->SetParError(0,0.00764329);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.00518
#pm0.008
 mrad","lpf");
