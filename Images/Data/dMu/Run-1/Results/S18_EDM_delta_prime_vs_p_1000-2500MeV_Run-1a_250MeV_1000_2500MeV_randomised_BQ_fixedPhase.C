void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 11:59:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2554,-0.9111924,2667.767,1.858807);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.6341924);
   Graph_Graph1003->SetMaximum(1.581807);
   ...
   pol01004->SetChisquare(8.566817);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.1858423);
   pol01004->SetParError(0,0.1198658);
