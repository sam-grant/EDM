void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:39 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.4607,-1.286546,3038.641,1.817553);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-0.9761359);
   Graph_Graph1013->SetMaximum(1.507143);
   ...
   pol01014->SetChisquare(4.637649);
   pol01014->SetNDF(7);
   ...
   pol01014->SetParameter(0,0.1762347);
   pol01014->SetParError(0,0.04476081);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.176
#pm0.04
 mrad","lpf");
