void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:27:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5479,-0.7748928,2668.079,1.239076);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.5734959);
   Graph_Graph1001->SetMaximum(1.037679);
   ...
   pol01002->SetChisquare(5.172105);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.1323524);
