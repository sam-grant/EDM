void S12_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:33 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.238354,2655.75,1.957259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3388233,
   0.4381754};
   TGraphErrors *gre = new TGraphErrors(12,_fx1031,_fy1031,_fex1031,_fey1031);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1031 = new TH1F("Graph_Graph1031","S12_",100,799.5,2449.5);
   ...
   pol01032->SetParameter(0,0.009618678);
   pol01032->SetParError(0,0.07301398);
