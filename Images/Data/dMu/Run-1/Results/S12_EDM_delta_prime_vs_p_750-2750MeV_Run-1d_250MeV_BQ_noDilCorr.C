void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.1429,-0.9179307,3039.225,1.065663);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1037->SetMinimum(-0.7195714);
   Graph_Graph1037->SetMaximum(0.8673032);
   ...
   pol01038->SetChisquare(1.322341);
   pol01038->SetNDF(7);
   ...
   pol01038->SetParameter(0,0.0708636);
   pol01038->SetParError(0,0.00706455);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0709
#pm0.007
 mrad","lpf");
