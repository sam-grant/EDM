...
//=========  (Sun Jun 12 15:46:12 2022) by ROOT version 6.24/06
   ...
   c->Range(819.4447,-0.2228003,2667.685,0.9495611);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12",100,1004.269,2482.861);
   Graph_Graph1019->SetMinimum(-0.1055642);
   Graph_Graph1019->SetMaximum(0.832325);
   ...
   pol01020->SetChisquare(0.9730695);
   pol01020->SetNDF(5);
   ...
   pol01020->SetParameter(0,0.3784295);
   pol01020->SetParError(0,0.05101305);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.38
#pm0.05
 mrad","lpf");
