void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 24 20:13:14 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4447,-0.2220219,2667.685,0.9491385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.1049058);
   Graph_Graph1001->SetMaximum(0.8320225);
   ...
   pol01002->SetChisquare(0.9688275);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3784003);
   pol01002->SetParError(0,0.05101263);
