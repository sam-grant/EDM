void S18_g2_delta_prime_hist_1000_750-2750MeV_Run-1d_250MeV_BQ()
{
...
//=========  (Tue Mar 29 11:55:53 2022) by ROOT version 6.24/06
   ...
   TH1D *h__5 = new TH1D("h__5","S18",20,-0.2105287,0.1896488);
   h__5->SetBinContent(10,688);
   h__5->SetBinContent(11,312);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("-0.01061
#pm1e-05
");
   pt_LaTex = pt->AddText("0.00034
#pm8e-06
");
   pt->Draw();
   c->Modified();
