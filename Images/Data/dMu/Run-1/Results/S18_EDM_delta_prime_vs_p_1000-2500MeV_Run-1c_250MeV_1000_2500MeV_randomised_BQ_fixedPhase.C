void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:02:52 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2636,-0.4207682,2667.528,1.992017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.09,2482.702);
   Graph_Graph1003->SetMinimum(-0.1794896);
   Graph_Graph1003->SetMaximum(1.750739);
   ...
   Graph_Graph1003->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 500 MeV");
   ...
   pol01004->SetChisquare(11.13307);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.5840254);
   pol01004->SetParError(0,0.08485822);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.58
#pm0.08
 mrad","lpf");
