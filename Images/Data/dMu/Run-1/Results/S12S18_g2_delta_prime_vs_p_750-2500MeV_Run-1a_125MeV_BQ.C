...
//=========  (Thu Dec  2 14:43:37 2021) by ROOT version 6.24/04
   ...
   c->Range(411.5072,-1.376118,2837.475,1.506867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,654.104,2594.878);
   ...
   pol01012->SetChisquare(17.28473);
   pol01012->SetNDF(13);
   ...
   pol01012->SetParameter(0,-0.008756561);
   pol01012->SetParError(0,0.07335419);
