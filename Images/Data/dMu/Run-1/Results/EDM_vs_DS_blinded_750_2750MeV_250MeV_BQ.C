void EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ()
{
...
//=========  (Wed Apr 20 00:23:55 2022) by ROOT version 6.24/06
   ...
   Graph_Graph_Graph10011005->SetMinimum(-2.090964e-19);
   Graph_Graph_Graph10011005->SetMaximum(2.710577e-18);
   ...
   fit1005->SetParameter(0,1.592793e-18);
   fit1005->SetParError(0,8.974692e-20);
   ...
   minusSigma1006->SetParameter(0,1.503047e-18);
   ...
   plusSigma1007->SetParameter(0,1.68254e-18);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(-2.090964e-19);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(2.710577e-18);
   ...
   Graph_Graph_Graph10021007->SetMinimum(1.54085e-19);
   Graph_Graph_Graph10021007->SetMaximum(2.475948e-18);
   ...
   Graph_Graph_Graph10031008->SetMinimum(8.934464e-19);
   Graph_Graph_Graph10031008->SetMaximum(2.226726e-18);
   ...
   pol01009->SetChisquare(7.688619);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,1.592793e-18);
   pol01009->SetParError(0,8.974692e-20);
