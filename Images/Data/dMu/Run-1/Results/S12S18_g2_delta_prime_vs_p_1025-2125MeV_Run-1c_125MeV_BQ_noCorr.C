...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.05841691,2312,0.05331336);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1083->SetMinimum(-0.04724389);
   Graph_Graph1083->SetMaximum(0.04214033);
   ...
   pol01084->SetChisquare(7.133661);
   pol01084->SetNDF(8);
   ...
   pol01084->SetParameter(0,-0.0009040564);
   pol01084->SetParError(0,0.004581686);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0009
#pm0.005
 mrad","lpf");
