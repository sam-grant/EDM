...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1095302,2655.75,0.108399);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02379045,
   0.0249422};
   TGraphErrors *gre = new TGraphErrors(12,_fx1067,_fy1067,_fex1067,_fey1067);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1067 = new TH1F("Graph_Graph1067","S12_",100,799.5,2449.5);
   ...
   pol01068->SetParameter(0,-0.001638987);
   pol01068->SetParError(0,0.006859085);
