void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.3999,-1.063616,2728.91,1.059978);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,736.7509,2507.559);
   Graph_Graph1007->SetMinimum(-0.8512563);
   Graph_Graph1007->SetMaximum(0.8476189);
   ...
   pol01008->SetChisquare(5.821323);
   pol01008->SetNDF(6);
   ...
   pol01008->SetParameter(0,-0.01486829);
   pol01008->SetParError(0,0.01495853);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0149
#pm0.01
 mrad","lpf");
