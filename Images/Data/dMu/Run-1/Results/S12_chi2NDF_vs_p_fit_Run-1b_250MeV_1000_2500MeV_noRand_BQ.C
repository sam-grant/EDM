void S12_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.901,-0.2466706,2667.721,2.220035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","",100,1004.683,2482.939);
   Graph_Graph1007->SetMinimum(0);
   Graph_Graph1007->SetMaximum(1.973364);
   ...
   pol01008->SetChisquare(0.2832905);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,0.9733644);
   pol01008->SetParError(0,0.09717518);
