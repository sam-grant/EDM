...
//=========  (Mon Mar 21 21:37:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.0501,-1.60003,3143.614,2.14997);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.22503);
   Graph_Graph1003->SetMaximum(1.77497);
   ...
   pol01004->SetChisquare(14.21494);
   pol01004->SetNDF(15);
   ...
   pol01004->SetParameter(0,0.2749702);
   pol01004->SetParError(0,0.1167785);
