...
//=========  (Thu Nov 18 09:29:22 2021) by ROOT version 6.24/04
   ...
   TH1D *h__24 = new TH1D("h__24","S12S18_",20,-0.1951861,0.2160035);
   h__24->SetBinContent(10,95);
   h__24->SetBinContent(11,899);
   h__24->SetBinContent(12,6);
