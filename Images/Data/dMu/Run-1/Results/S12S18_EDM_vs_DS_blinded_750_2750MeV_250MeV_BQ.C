void S12S18_EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ()
{
...
//=========  (Fri Apr 29 14:16:59 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1003->SetMinimum(8.934464e-19);
   Graph_Graph1003->SetMaximum(2.226726e-18);
   ...
   pol01004->SetChisquare(7.688619);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,1.592793e-18);
   pol01004->SetParError(0,8.974692e-20);
