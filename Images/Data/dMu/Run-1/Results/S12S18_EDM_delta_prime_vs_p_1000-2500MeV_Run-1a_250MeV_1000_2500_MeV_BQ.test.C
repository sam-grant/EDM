void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:01 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.4061,-0.8054572,2667.941,0.7464002);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.26,2483.088);
   Graph_Graph1005->SetMinimum(-0.6502714);
   Graph_Graph1005->SetMaximum(0.5912144);
   ...
   pol01006->SetChisquare(3.489736);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,-0.01007116);
   pol01006->SetParError(0,0.07740951);
