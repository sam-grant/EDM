...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.1014011,2655.75,0.162737);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.02964325,
   0.03126518};
   TGraphErrors *gre = new TGraphErrors(12,_fx1051,_fy1051,_fex1051,_fey1051);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1051 = new TH1F("Graph_Graph1051","S18_",100,799.5,2449.5);
   ...
   pol01052->SetParameter(0,0.01782423);
   pol01052->SetParError(0,0.008413486);
