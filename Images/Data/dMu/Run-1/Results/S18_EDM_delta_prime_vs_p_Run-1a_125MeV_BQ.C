...
//=========  (Mon Nov  8 11:21:53 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.902829,2843.25,2.894287);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.423118);
   Graph_Graph1003->SetMaximum(2.414576);
   ...
   pol01004->SetChisquare(14.20393);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,0.2272251);
