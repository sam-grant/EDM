...
//=========  (Tue Mar 29 11:41:05 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2265637,0.1744102);
   h__6->SetBinContent(10,683);
   h__6->SetBinContent(11,317);
