void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1c_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:45:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5532,-1.265087,3038.337,2.485463);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.8900324);
   Graph_Graph1001->SetMaximum(2.110408);
   ...
   pol01002->SetChisquare(4.227755);
   pol01002->SetNDF(7);
   ...
   pol01002->SetParameter(0,0.68078);
   pol01002->SetParError(0,0.07755351);
