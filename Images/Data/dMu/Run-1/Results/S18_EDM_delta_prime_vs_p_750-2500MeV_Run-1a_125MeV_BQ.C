...
//=========  (Thu Dec  2 14:43:36 2021) by ROOT version 6.24/04
   ...
   c->Range(411.1944,-1.539282,2837.902,2.45476);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,653.8651,2595.231);
   Graph_Graph1003->SetMinimum(-1.139878);
   ...
   pol01004->SetParameter(0,0.2648782);
   pol01004->SetParError(0,0.105827);
