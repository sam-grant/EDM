void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 17:49:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3734,-0.3202711,2667.556,1.499795);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,1004.192,2482.737);
   Graph_Graph1005->SetMinimum(-0.1382645);
   Graph_Graph1005->SetMaximum(1.317788);
   ...
   pol01006->SetChisquare(7.616704);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3525433);
   pol01006->SetParError(0,0.0661546);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.35
#pm0.07
 mrad","lpf");
