void EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ.dataDrivenAcceptance()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 20:45:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,-4.865789e-19,4.65,5.279072e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph_Graph10011005->SetMinimum(8.998618e-20);
   Graph_Graph_Graph10011005->SetMaximum(4.702507e-18);
   ...
   fit1005->SetParameter(0,3.175994e-18);
   fit1005->SetParError(0,1.726443e-19);
   ...
   minusSigma1006->SetParameter(0,3.00335e-18);
   ...
   plusSigma1007->SetParameter(0,3.348638e-18);
   ...
   Graph_Graph_Graph_Graph100110051006->SetMinimum(8.998618e-20);
   Graph_Graph_Graph_Graph100110051006->SetMaximum(4.702507e-18);
   ...
   Graph_Graph_Graph10021007->SetMinimum(2.266938e-20);
   Graph_Graph_Graph10021007->SetMaximum(4.493437e-18);
   ...
   Graph_Graph_Graph10031008->SetMinimum(1.544507e-18);
   Graph_Graph_Graph10031008->SetMaximum(4.79284e-18);
   ...
   pol01009->SetChisquare(16.53469);
   pol01009->SetNDF(3);
   ...
   pol01009->SetParameter(0,3.175994e-18);
   pol01009->SetParError(0,1.726443e-19);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("#delta#LTd_{#mu}^{BLIND}#GT = 1.73#times10^{#minus19} e#upointcm");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
