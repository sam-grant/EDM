...
//=========  (Mon Nov 22 17:32:49 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18_",20,-0.2675619,0.1385555);
   h__12->SetBinContent(9,1);
   h__12->SetBinContent(10,567);
   h__12->SetBinContent(11,432);
