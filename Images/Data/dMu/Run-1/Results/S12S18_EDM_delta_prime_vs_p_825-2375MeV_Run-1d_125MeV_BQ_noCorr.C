...
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   ...
   c->Range(593.25,-0.01876934,2655.75,0.07444876);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01043091,
   0.01093995};
   TGraphErrors *gre = new TGraphErrors(12,_fx1089,_fy1089,_fex1089,_fey1089);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1089 = new TH1F("Graph_Graph1089","S12S18_",100,799.5,2449.5);
   ...
   pol01090->SetParameter(0,0.03971949);
   pol01090->SetParError(0,0.002993938);
