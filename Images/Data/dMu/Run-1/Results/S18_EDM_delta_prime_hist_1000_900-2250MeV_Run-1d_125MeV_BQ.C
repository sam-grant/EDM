...
//=========  (Mon Nov  8 21:07:47 2021) by ROOT version 6.24/04
   ...
   TH1D *h__20 = new TH1D("h__20","S18_",22,0.2590225,0.7122059);
   h__20->SetBinContent(8,3);
   h__20->SetBinContent(9,20);
   h__20->SetBinContent(10,143);
   h__20->SetBinContent(11,281);
   h__20->SetBinContent(12,327);
   h__20->SetBinContent(13,155);
   h__20->SetBinContent(14,54);
