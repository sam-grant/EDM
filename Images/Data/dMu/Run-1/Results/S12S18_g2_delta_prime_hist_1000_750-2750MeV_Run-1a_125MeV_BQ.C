...
//=========  (Thu Dec  2 14:46:58 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.21584,0.1861522);
   h__6->SetBinContent(10,19);
   h__6->SetBinContent(11,779);
   h__6->SetBinContent(12,201);
