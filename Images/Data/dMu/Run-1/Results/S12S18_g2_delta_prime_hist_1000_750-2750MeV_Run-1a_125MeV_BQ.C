...
//=========  (Mon Mar 21 21:37:10 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2368759,0.1641422);
   h__6->SetBinContent(10,693);
   h__6->SetBinContent(11,307);
