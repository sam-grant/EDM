...
//=========  (Thu Feb  3 10:59:56 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2562855,0.1614508);
   h__6->SetBinContent(10,133);
   h__6->SetBinContent(11,709);
   h__6->SetBinContent(12,157);
