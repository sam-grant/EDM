...
//=========  (Mon Dec 20 16:05:33 2021) by ROOT version 6.24/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.2484462,0.1705557);
   h__6->SetBinContent(10,134);
   h__6->SetBinContent(11,668);
   h__6->SetBinContent(12,196);
   h__6->SetBinContent(13,2);
