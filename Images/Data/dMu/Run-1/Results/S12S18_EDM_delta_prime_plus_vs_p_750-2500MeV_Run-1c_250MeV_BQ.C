void S12S18_EDM_delta_prime_plus_vs_p_750-2500MeV_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(515.085,-0.7851245,2728.5,1.926036);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.1336394,
   0.1836417};
   TGraphErrors *gre = new TGraphErrors(7,_fx1087,_fy1087,_fex1087,_fey1087);
   gre->SetName("");
   gre->SetTitle("S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1087 = new TH1F("Graph_Graph1087","S12S18",100,736.4265,2507.158);
   Graph_Graph1087->SetMinimum(-0.5140084);
   Graph_Graph1087->SetMaximum(1.65492);
   ...
   Graph_Graph1087->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01088->SetChisquare(2.940606);
   pol01088->SetNDF(6);
   ...
   pol01088->SetParameter(0,0.5680866);
   pol01088->SetParError(0,0.05017897);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.568
#pm0.05
 mrad","lpf");
