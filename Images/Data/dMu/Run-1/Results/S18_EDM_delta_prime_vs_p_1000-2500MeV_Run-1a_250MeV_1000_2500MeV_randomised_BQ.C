...
//=========  (Mon Jun 13 18:32:17 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2554,-1.050147,2667.767,1.601417);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.7849908);
   Graph_Graph1003->SetMaximum(1.336261);
   ...
   pol01004->SetChisquare(6.493166);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.06340648);
   pol01004->SetParError(0,0.1198654);
