...
//=========  (Tue May 24 19:58:23 2022) by ROOT version 6.24/06
   ...
   c->Range(819.2554,-1.050408,2667.767,1.601215);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.7852459);
   Graph_Graph1003->SetMaximum(1.336052);
   ...
   pol01004->SetChisquare(6.491317);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.06341674);
