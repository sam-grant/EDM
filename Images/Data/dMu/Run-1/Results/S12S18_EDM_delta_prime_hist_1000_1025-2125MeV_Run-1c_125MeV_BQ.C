...
//=========  (Mon Nov  8 21:10:11 2021) by ROOT version 6.24/04
   ...
   TH1D *h__15 = new TH1D("h__15","S12S18_",22,0.3619061,0.8204431);
   h__15->SetBinContent(7,1);
   h__15->SetBinContent(8,3);
   h__15->SetBinContent(9,16);
   h__15->SetBinContent(10,107);
   h__15->SetBinContent(11,178);
   h__15->SetBinContent(12,305);
   h__15->SetBinContent(13,229);
   h__15->SetBinContent(14,101);
   h__15->SetBinContent(15,40);
   h__15->SetBinContent(16,16);
