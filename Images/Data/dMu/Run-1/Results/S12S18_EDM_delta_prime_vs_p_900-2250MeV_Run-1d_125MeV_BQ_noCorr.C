...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.01876934,2499.5,0.07444876);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01028517,
   0.01043091};
   TGraphErrors *gre = new TGraphErrors(11,_fx1089,_fy1089,_fex1089,_fey1089);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1089 = new TH1F("Graph_Graph1089","S12S18_",100,812,2312);
   Graph_Graph1089->SetMinimum(-0.009447532);
   Graph_Graph1089->SetMaximum(0.06512695);
   ...
   pol01090->SetParameter(0,0.03939072);
   pol01090->SetParError(0,0.003112772);
