void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.5042,-1.062975,3038.389,1.056504);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.04273525,
   0.04268581};
   TGraphErrors *gre = new TGraphErrors(8,_fx1007,_fy1007,_fex1007,_fey1007);
   gre->SetName("");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,711.9927,2779.9);
   Graph_Graph1007->SetMinimum(-0.8510272);
   Graph_Graph1007->SetMaximum(0.844556);
   ...
   Graph_Graph1007->GetYaxis()->SetTitle("#delta'_{g#minus2}^{} [mrad] / 250 MeV");
   ...
   pol01008->SetChisquare(7.280647);
   pol01008->SetNDF(7);
   ...
   pol01008->SetParameter(0,-0.009129451);
   pol01008->SetParError(0,0.01397563);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00913
#pm0.01
 mrad","lpf");
