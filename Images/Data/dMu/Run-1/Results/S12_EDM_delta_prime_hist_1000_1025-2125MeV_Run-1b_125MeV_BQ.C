...
//=========  (Mon Nov  8 21:10:07 2021) by ROOT version 6.24/04
   ...
   TH1D *h__7 = new TH1D("h__7","S12_",20,0.03099394,0.4503236);
   h__7->SetBinContent(9,5);
   h__7->SetBinContent(10,264);
   h__7->SetBinContent(11,592);
   h__7->SetBinContent(12,132);
   h__7->SetBinContent(13,7);
