...
//=========  (Mon Nov  8 21:07:40 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-1.266078,2499.5,1.721441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3453292,
   0.4040669};
   TGraphErrors *gre = new TGraphErrors(11,_fx1013,_fy1013,_fex1013,_fey1013);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","S12_",100,812,2312);
   Graph_Graph1013->SetMinimum(-0.9673262);
   Graph_Graph1013->SetMaximum(1.422689);
   ...
   pol01014->SetParameter(0,0.2520644);
   pol01014->SetParError(0,0.09038064);
