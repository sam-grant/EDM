void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.5982,-0.7545765,2667.768,1.228184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,1004.415,2482.951);
   Graph_Graph1007->SetMinimum(-0.5563004);
   Graph_Graph1007->SetMaximum(1.029908);
   ...
   Graph_Graph1007->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 250 MeV");
   ...
   pol01008->SetChisquare(1.807441);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,-0.05368844);
   pol01008->SetParError(0,0.08511061);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = -0.054
#pm0.09
 mrad","lpf");
