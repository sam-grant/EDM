void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:09:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2554,-1.033536,2667.767,1.620202);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.768162);
   Graph_Graph1003->SetMaximum(1.354829);
   ...
   pol01004->SetChisquare(6.471213);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.07228807);
   pol01004->SetParError(0,0.1198652);
   ...
   entry=leg->AddEntry("pol0","#LT#delta^{BLIND}#GT = 0.072
#pm0.1
 mrad","lpf");
