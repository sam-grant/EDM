...
//=========  (Mon Dec 20 16:07:18 2021) by ROOT version 6.24/04
   ...
   TH1D *h__5 = new TH1D("h__5","S18",21,-0.2991243,0.1275106);
   h__5->SetBinContent(9,9);
   h__5->SetBinContent(10,81);
   h__5->SetBinContent(11,279);
   h__5->SetBinContent(12,413);
   h__5->SetBinContent(13,200);
   h__5->SetBinContent(14,18);
