void S12_g2_delta_prime_vs_p_825-2375MeV_Run-1a_125MeV_BQ_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:03:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.1117912,2655.75,0.1638761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1055 = new TH1F("Graph_Graph1055","S12_",100,799.5,2449.5);
   ...
   pol01056->SetParameter(0,-0.006649161);
   pol01056->SetParError(0,0.008042276);
