...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.03697394,2499.5,0.09288761);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01388513,
   0.01404083};
   TGraphErrors *gre = new TGraphErrors(11,_fx1085,_fy1085,_fex1085,_fey1085);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1085 = new TH1F("Graph_Graph1085","S12_",100,812,2312);
   ...
   pol01086->SetParameter(0,0.03928244);
   pol01086->SetParError(0,0.004266462);
