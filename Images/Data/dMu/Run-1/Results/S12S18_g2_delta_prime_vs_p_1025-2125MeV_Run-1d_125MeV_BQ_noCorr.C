...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.04244166,2312,0.06239557);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1095->SetMaximum(0.05191184);
   ...
   pol01096->SetChisquare(13.49687);
   pol01096->SetNDF(8);
   ...
   pol01096->SetParameter(0,0.002982141);
   pol01096->SetParError(0,0.003357375);
