...
//=========  (Tue Mar 29 11:44:10 2022) by ROOT version 6.24/06
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",20,-0.203732,0.1969116);
   h__6->SetBinContent(10,667);
   h__6->SetBinContent(11,333);
