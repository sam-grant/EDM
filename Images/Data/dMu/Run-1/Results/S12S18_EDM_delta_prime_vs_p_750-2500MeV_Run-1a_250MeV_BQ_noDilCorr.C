void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:06 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.9475,-0.9757882,2728.833,1.209341);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,736.336,2507.445);
   Graph_Graph1005->SetMinimum(-0.7572752);
   Graph_Graph1005->SetMaximum(0.9908285);
   ...
   pol01006->SetChisquare(11.15134);
   pol01006->SetNDF(6);
   ...
   pol01006->SetParameter(0,0.05450329);
   pol01006->SetParError(0,0.01038072);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0545
#pm0.01
 mrad","lpf");
