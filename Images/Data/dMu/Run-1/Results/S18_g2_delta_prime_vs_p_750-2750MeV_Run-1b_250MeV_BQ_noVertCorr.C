void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 10:44:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.7258,-1.832847,3038.141,2.376354);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,711.2674,2779.6);
   Graph_Graph1009->SetMinimum(-1.411927);
   Graph_Graph1009->SetMaximum(1.955434);
   ...
   pol01010->SetChisquare(7.373322);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,-0.07658287);
   pol01010->SetParError(0,0.09990239);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.077
#pm0.1
 mrad","lpf");
