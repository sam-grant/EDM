void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:15:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2626,-0.2261808,2667.66,1.216513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.08191146);
   Graph_Graph1001->SetMaximum(1.072244);
   ...
   pol01002->SetChisquare(2.056328);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3571013);
   pol01002->SetParError(0,0.06128533);
