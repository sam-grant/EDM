...
//=========  (Fri May 13 18:02:11 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",52,-0.1023248,0.9395146);
   h__1->SetBinContent(23,7);
   h__1->SetBinContent(24,42);
   h__1->SetBinContent(25,188);
   h__1->SetBinContent(26,280);
   h__1->SetBinContent(27,261);
   h__1->SetBinContent(28,135);
   h__1->SetBinContent(29,71);
   h__1->SetBinContent(30,12);
