...
//=========  (Tue Aug 23 11:13:43 2022) by ROOT version 6.26/04
   ...
   TH1D *h__10 = new TH1D("h__10","S12",30,0.1950287,0.4959777);
   h__10->SetBinContent(15,559);
   h__10->SetBinContent(16,441);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.3454
#pm2e-05
");
   pt_LaTex = pt->AddText("0.000536
#pm1e-05
");
   pt->Draw();
   c->Modified();
