void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:00:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5991,-0.6919288,2667.761,1.152592);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.5074767);
   Graph_Graph1001->SetMaximum(0.9681402);
   ...
   pol01002->SetParameter(0,-0.03337424);
   pol01002->SetParError(0,0.08510487);
