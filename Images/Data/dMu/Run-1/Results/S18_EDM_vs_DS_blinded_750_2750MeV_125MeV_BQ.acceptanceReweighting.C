void S18_EDM_vs_DS_blinded_750_2750MeV_125MeV_BQ.acceptanceReweighting()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 21 21:53:27 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-8.26207e-20,4.75,3.048247e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(2.30466e-19);
   Graph_Graph1002->SetMaximum(2.73516e-18);
