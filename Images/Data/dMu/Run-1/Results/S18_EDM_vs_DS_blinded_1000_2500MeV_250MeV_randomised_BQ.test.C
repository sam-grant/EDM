void S18_EDM_vs_DS_blinded_1000_2500MeV_250MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:40:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-2.933479e-18,4.75,1.479746e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(-2.492157e-18);
   Graph_Graph1002->SetMaximum(1.038424e-18);
