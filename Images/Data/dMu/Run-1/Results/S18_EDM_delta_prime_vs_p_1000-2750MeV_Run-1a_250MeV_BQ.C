void S18_EDM_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.374,-1.613586,2977.171,2.208987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,979.3537,2755.191);
   Graph_Graph1003->SetMinimum(-1.231328);
   Graph_Graph1003->SetMaximum(1.826729);
   ...
   pol01004->SetChisquare(5.382231);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.2009991);
   pol01004->SetParError(0,0.1191756);
