void S12S18_AEDM_vs_DS_blinded_825-2375MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:18 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,4.640151e-20,4.75,1.899035e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1048->SetMinimum(6.075171e-20);
   Graph_Graph1048->SetMaximum(1.755533e-19);
   ...
   pol01049->SetChisquare(13.11644);
   pol01049->SetNDF(3);
   ...
   pol01049->SetParameter(0,1.225446e-19);
   pol01049->SetParError(0,6.491544e-21);
