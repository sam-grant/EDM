void S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:10:07 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.5525252,2312,1.909815);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3200906,
   0.3747818};
   TGraphErrors *gre = new TGraphErrors(9,_fx1015,_fy1015,_fex1015,_fey1015);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S18_",100,962,2162);
   Graph_Graph1015->SetMinimum(-0.3062912);
   Graph_Graph1015->SetMaximum(1.663581);
   ...
   pol01016->SetParameter(0,0.3624503);
   pol01016->SetParError(0,0.09898422);
