void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500_MeV_BQ()
{
...
//=========  (Fri May 13 12:30:37 2022) by ROOT version 6.24/06
   ...
   Graph_Graph1019->SetMinimum(0.09399089);
   Graph_Graph1019->SetMaximum(1.129006);
   ...
   pol01020->SetChisquare(1.897734);
   pol01020->SetNDF(5);
   ...
   pol01020->SetParameter(0,0.4729505);
