void S18_AEDM_vs_DS_blinded_750-2750MeV_125MeV()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Dec  2 14:46:13 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,3.825119e-20,4.75,2.807835e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(3.152096e-19);
   Graph_Graph1011->SetMaximum(2.530877e-18);
