...
//=========  (Tue May 24 20:13:34 2022) by ROOT version 6.24/06
   ...
   c->Range(0.35,2.485377e-19,4.85,2.010231e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(4.247071e-19);
   Graph_Graph1003->SetMaximum(1.834062e-18);
   ...
   pol01004->SetChisquare(7.800935);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,1.125219e-18);
   pol01004->SetParError(0,1.01854e-19);
