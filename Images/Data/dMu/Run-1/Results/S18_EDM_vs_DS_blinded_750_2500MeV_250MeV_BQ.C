void S18_EDM_vs_DS_blinded_750_2500MeV_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 14:17:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,-1.066795e-19,4.75,2.867661e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1002->SetMinimum(1.907546e-19);
   Graph_Graph1002->SetMaximum(2.570227e-18);
