...
//=========  (Mon Nov  8 21:10:07 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.091759,2312,0.9278582);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-0.8897974);
   Graph_Graph1011->SetMaximum(0.7258964);
   ...
   pol01012->SetChisquare(7.918851);
   pol01012->SetNDF(8);
   ...
   pol01012->SetParameter(0,-0.0001369163);
   pol01012->SetParError(0,0.08008856);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00014
#pm0.08
 mrad","lpf");
