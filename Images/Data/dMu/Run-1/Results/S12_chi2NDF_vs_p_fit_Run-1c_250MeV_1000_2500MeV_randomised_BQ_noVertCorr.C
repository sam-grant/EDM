void S12_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:14:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.476,-0.267794,2667.731,2.410145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","",100,1004.302,2482.906);
   Graph_Graph1001->SetMinimum(0);
   Graph_Graph1001->SetMaximum(2.142351);
   ...
   pol01002->SetChisquare(0.2437925);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,1.142351);
   pol01002->SetParError(0,0.09014663);
