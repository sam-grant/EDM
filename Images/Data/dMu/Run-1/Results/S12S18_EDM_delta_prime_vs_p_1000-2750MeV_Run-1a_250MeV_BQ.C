void S12S18_EDM_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.5177,-1.42934,2977.384,1.910888);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,979.5043,2755.397);
   Graph_Graph1005->SetMinimum(-1.095317);
   Graph_Graph1005->SetMaximum(1.576865);
   ...
   Graph_Graph1005->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad] / 250 MeV");
   ...
   pol01006->SetParameter(0,0.3908501);
   pol01006->SetParError(0,0.08211455);
