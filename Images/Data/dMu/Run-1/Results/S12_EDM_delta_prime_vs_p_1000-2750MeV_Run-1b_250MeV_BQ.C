void S12_EDM_delta_prime_vs_p_1000-2750MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:37:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.5888,-1.386942,2977.816,2.287754);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,979.6115,2755.793);
   Graph_Graph1001->SetMinimum(-1.019472);
   Graph_Graph1001->SetMaximum(1.920285);
   ...
   pol01002->SetChisquare(3.262862);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,0.3582243);
   pol01002->SetParError(0,0.09679713);
