void S12_EDM_vs_DS_blinded_750_2750MeV_250MeV_BQ.dataDrivenAcceptance()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr  8 20:45:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.15,6.514715e-19,4.65,3.981214e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(9.844458e-19);
   Graph_Graph1001->SetMaximum(3.64824e-18);
