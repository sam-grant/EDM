void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:55:53 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(452.8467,-1.629085,3037.552,1.781083);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,711.3173,2779.082);
   Graph_Graph1009->SetMinimum(-1.288068);
   Graph_Graph1009->SetMaximum(1.440067);
   ...
   pol01010->SetChisquare(14.96035);
   pol01010->SetNDF(7);
   ...
   pol01010->SetParameter(0,-0.01061104);
   pol01010->SetParError(0,0.06093591);
