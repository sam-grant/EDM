...
//=========  (Thu Dec  2 14:43:36 2021) by ROOT version 6.24/04
   ...
   TH1D *h__1 = new TH1D("h__1","S12",22,0.3504917,0.8092192);
   h__1->SetBinContent(7,1);
   h__1->SetBinContent(8,1);
   h__1->SetBinContent(9,4);
   h__1->SetBinContent(10,45);
   h__1->SetBinContent(11,132);
   h__1->SetBinContent(12,240);
   h__1->SetBinContent(13,289);
   h__1->SetBinContent(14,171);
   h__1->SetBinContent(15,74);
   h__1->SetBinContent(16,29);
   h__1->SetBinContent(17,11);
