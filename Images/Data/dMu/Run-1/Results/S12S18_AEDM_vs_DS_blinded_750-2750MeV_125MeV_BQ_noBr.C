...
//=========  (Mon Dec 20 16:10:21 2021) by ROOT version 6.24/04
   ...
   c->Range(0.35,6.844068e-19,4.85,2.619655e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1012->SetMinimum(8.779316e-19);
   Graph_Graph1012->SetMaximum(2.42613e-18);
   ...
   pol01013->SetChisquare(8.489465);
   pol01013->SetNDF(3);
   ...
   pol01013->SetParameter(0,1.630812e-18);
   pol01013->SetParError(0,1.060207e-19);
