...
//=========  (Fri Dec 10 11:08:37 2021) by ROOT version 6.24/04
   ...
   c->Range(0.35,6.865852e-19,4.85,2.61744e-18);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1012->SetMinimum(8.796706e-19);
   Graph_Graph1012->SetMaximum(2.424354e-18);
   ...
   pol01013->SetChisquare(8.598784);
   pol01013->SetNDF(3);
   ...
   pol01013->SetParameter(0,1.631603e-18);
   pol01013->SetParError(0,1.050568e-19);
