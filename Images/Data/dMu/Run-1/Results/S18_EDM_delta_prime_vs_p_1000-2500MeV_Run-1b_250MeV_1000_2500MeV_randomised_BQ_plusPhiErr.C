void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:11:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.1514,-0.6255754,2667.292,1.604854);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.4025324);
   Graph_Graph1003->SetMaximum(1.381811);
   ...
   pol01004->SetChisquare(5.630178);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.2522354);
   pol01004->SetParError(0,0.1024762);
