...
//=========  (Fri Oct  7 16:07:31 2022) by ROOT version 6.26/04
   ...
   TH1D *h__6 = new TH1D("h__6","S12S18",30,0.1177942,0.4187047);
   h__6->SetBinContent(12,16);
   h__6->SetBinContent(13,123);
   h__6->SetBinContent(14,304);
   h__6->SetBinContent(15,349);
   h__6->SetBinContent(16,158);
   h__6->SetBinContent(17,42);
   h__6->SetBinContent(18,6);
