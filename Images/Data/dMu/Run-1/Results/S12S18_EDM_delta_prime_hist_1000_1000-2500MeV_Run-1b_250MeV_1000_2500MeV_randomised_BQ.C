...
//=========  (Thu Oct  6 23:18:03 2022) by ROOT version 6.26/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",30,0.1174573,0.4194398);
   h__3->SetBinContent(12,11);
   h__3->SetBinContent(13,119);
   h__3->SetBinContent(14,304);
   h__3->SetBinContent(15,361);
   h__3->SetBinContent(16,152);
   h__3->SetBinContent(17,45);
   h__3->SetBinContent(18,6);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2603
#pm0.0003
");
   pt_LaTex = pt->AddText("0.0107
#pm0.0002
");
   pt->Draw();
   c->Modified();
