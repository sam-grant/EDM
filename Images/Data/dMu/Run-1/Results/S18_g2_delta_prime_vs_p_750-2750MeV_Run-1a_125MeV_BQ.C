...
//=========  (Thu Feb  3 10:59:55 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.0501,-1.829733,3143.614,1.920267);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMinimum(-1.454733);
   Graph_Graph1009->SetMaximum(1.545267);
   ...
   pol01010->SetChisquare(15.74392);
   pol01010->SetNDF(15);
   ...
   pol01010->SetParameter(0,0.04526676);
   pol01010->SetParError(0,0.1290408);
