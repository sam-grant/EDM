void S18_g2_delta_prime_vs_p_750-2750MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Dec 20 16:05:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(350.0501,-1.831959,3143.614,1.918041);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5904991,
   0.6616952};
   TGraphErrors *gre = new TGraphErrors(16,_fx1009,_fy1009,_fex1009,_fey1009);
   gre->SetName("");
   gre->SetTitle("S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,629.4066,2864.258);
   Graph_Graph1009->SetMinimum(-1.456959);
   Graph_Graph1009->SetMaximum(1.543041);
   ...
   pol01010->SetChisquare(15.73802);
   pol01010->SetNDF(15);
   ...
   pol01010->SetParameter(0,0.0430409);
   pol01010->SetParError(0,0.1198548);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.043
#pm0.1
 mrad","lpf");
