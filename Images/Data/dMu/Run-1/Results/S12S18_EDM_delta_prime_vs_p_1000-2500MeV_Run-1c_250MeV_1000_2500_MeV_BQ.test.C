void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.3701,-0.3640018,2667.643,0.910979);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1017->SetMinimum(-0.2365037);
   Graph_Graph1017->SetMaximum(0.7834809);
   ...
   pol01018->SetChisquare(2.140749);
   pol01018->SetNDF(5);
   ...
   pol01018->SetParameter(0,0.2214056);
