void S12S18_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:31 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.796569,2655.75,1.420948);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3032816,
   0.3925232};
   TGraphErrors *gre = new TGraphErrors(12,_fx1023,_fy1023,_fex1023,_fey1023);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","S12S18_",100,799.5,2449.5);
   Graph_Graph1023->SetMinimum(-0.5748173);
   Graph_Graph1023->SetMaximum(1.199196);
   ...
   pol01024->SetParameter(0,-0.0335678);
   pol01024->SetParError(0,0.06432974);
