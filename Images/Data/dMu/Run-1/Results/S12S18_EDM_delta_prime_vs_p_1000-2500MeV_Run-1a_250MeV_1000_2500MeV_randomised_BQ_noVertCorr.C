void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:09:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4016,-0.5734436,2667.941,1.065204);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.4095788);
   Graph_Graph1005->SetMaximum(0.9013396);
   ...
   pol01006->SetChisquare(3.868979);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.2933949);
   pol01006->SetParError(0,0.07741374);
