void S12S18_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1a_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.5957213,2655.75,2.178494);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3475888,
   0.4476214};
   TGraphErrors *gre = new TGraphErrors(12,_fx1005,_fy1005,_fex1005,_fey1005);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18_",100,799.5,2449.5);
   Graph_Graph1005->SetMinimum(-0.3182997);
   Graph_Graph1005->SetMaximum(1.901072);
   ...
   pol01006->SetParameter(0,0.38819);
   pol01006->SetParError(0,0.07528459);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.39
#pm0.08
 mrad","lpf");
