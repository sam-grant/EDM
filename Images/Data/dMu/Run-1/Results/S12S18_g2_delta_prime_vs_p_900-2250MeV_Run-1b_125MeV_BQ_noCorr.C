...
//=========  (Mon Nov  8 21:07:51 2021) by ROOT version 6.24/04
   ...
   c->Range(624.5,-0.06196072,2499.5,0.1043833);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01712712,
   0.01752748};
   TGraphErrors *gre = new TGraphErrors(11,_fx1071,_fy1071,_fex1071,_fey1071);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1071 = new TH1F("Graph_Graph1071","S12S18_",100,812,2312);
   ...
   pol01072->SetParameter(0,-0.003288018);
   pol01072->SetParError(0,0.005163024);
