...
//=========  (Mon Nov  8 11:21:54 2021) by ROOT version 6.24/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18_",22,0.1721213,0.6160421);
   h__3->SetBinContent(9,2);
   h__3->SetBinContent(10,21);
   h__3->SetBinContent(11,173);
   h__3->SetBinContent(12,401);
   h__3->SetBinContent(13,295);
   h__3->SetBinContent(14,86);
