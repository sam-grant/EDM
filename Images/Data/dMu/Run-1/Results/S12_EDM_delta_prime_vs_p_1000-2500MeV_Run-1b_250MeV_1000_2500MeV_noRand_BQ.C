void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:40:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.901,-0.3449417,2667.721,1.43802);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.683,2482.939);
   Graph_Graph1001->SetMinimum(-0.1666455);
   Graph_Graph1001->SetMaximum(1.259724);
   ...
   pol01002->SetChisquare(4.338963);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.3598027);
   pol01002->SetParError(0,0.06929124);
