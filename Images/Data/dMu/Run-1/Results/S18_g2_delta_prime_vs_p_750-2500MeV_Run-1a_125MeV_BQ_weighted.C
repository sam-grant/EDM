void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:46 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.1944,-2.574387,2837.902,2.772072);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18_",100,653.8651,2595.231);
   Graph_Graph1009->SetMinimum(-2.039741);
   Graph_Graph1009->SetMaximum(2.237426);
   ...
   pol01010->SetChisquare(15.39058);
   pol01010->SetNDF(13);
   ...
   pol01010->SetParameter(0,0.06380042);
   pol01010->SetParError(0,0.1070991);
