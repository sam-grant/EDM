...
//=========  (Wed May  4 17:33:52 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2502,-0.9350163,2667.186,1.619589);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1021->SetMinimum(-0.6795557);
   Graph_Graph1021->SetMaximum(1.364129);
   ...
   pol01022->SetChisquare(16.28998);
   pol01022->SetNDF(5);
   ...
   pol01022->SetParameter(0,0.2710368);
   pol01022->SetParError(0,0.03033784);
