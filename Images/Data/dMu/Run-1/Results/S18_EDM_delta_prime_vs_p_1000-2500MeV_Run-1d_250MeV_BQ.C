void S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Wed May 11 17:50:13 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2502,-0.2080716,2667.186,1.653931);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,1004.044,2482.392);
   Graph_Graph1003->SetMinimum(-0.02187137);
   Graph_Graph1003->SetMaximum(1.467731);
   ...
   pol01004->SetChisquare(11.06765);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.5768072);
   pol01004->SetParError(0,0.06254959);
