...
//=========  (Mon Mar 21 21:45:15 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.5276129,0.9361189);
   h__2->SetBinContent(9,21);
   h__2->SetBinContent(10,444);
   h__2->SetBinContent(11,481);
   h__2->SetBinContent(12,52);
   h__2->SetBinContent(13,2);
