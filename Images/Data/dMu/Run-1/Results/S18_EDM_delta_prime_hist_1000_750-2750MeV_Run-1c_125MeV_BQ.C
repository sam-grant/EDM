...
//=========  (Mon Dec 20 16:07:16 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18",28,0.4224902,0.9896915);
   h__2->SetBinContent(6,1);
   h__2->SetBinContent(8,1);
   h__2->SetBinContent(9,5);
   h__2->SetBinContent(10,16);
   h__2->SetBinContent(11,31);
   h__2->SetBinContent(12,62);
   h__2->SetBinContent(13,91);
   h__2->SetBinContent(14,117);
   h__2->SetBinContent(15,117);
   h__2->SetBinContent(16,118);
   h__2->SetBinContent(17,118);
   h__2->SetBinContent(18,99);
   h__2->SetBinContent(19,69);
   h__2->SetBinContent(20,54);
   h__2->SetBinContent(21,38);
   h__2->SetBinContent(22,24);
   h__2->SetBinContent(23,17);
   h__2->SetBinContent(24,8);
   h__2->SetBinContent(25,6);
   h__2->SetBinContent(26,1);
   h__2->SetBinContent(27,2);
