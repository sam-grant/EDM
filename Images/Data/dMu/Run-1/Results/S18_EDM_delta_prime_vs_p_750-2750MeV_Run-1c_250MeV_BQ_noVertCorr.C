...
//=========  (Tue Mar 29 10:45:25 2022) by ROOT version 6.24/06
   ...
   c->Range(452.9039,-0.9920121,3037.134,2.622204);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.6305904);
   Graph_Graph1003->SetMaximum(2.260782);
   ...
   pol01004->SetChisquare(9.165695);
   pol01004->SetNDF(7);
   ...
   pol01004->SetParameter(0,0.6884207);
   pol01004->SetParError(0,0.08219657);
