...
//=========  (Thu Dec  2 14:43:37 2021) by ROOT version 6.24/04
   ...
   c->Range(411.8032,-2.065272,2837.119,1.917025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,654.3347,2594.587);
   Graph_Graph1007->SetMinimum(-1.667043);
   Graph_Graph1007->SetMaximum(1.518795);
   ...
   pol01008->SetChisquare(11.19113);
   pol01008->SetNDF(13);
   ...
   pol01008->SetParameter(0,-0.08291674);
   pol01008->SetParError(0,0.1015552);
