void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500_MeV_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:12:03 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,53,800,600);
   c->Range(819.4799,-0.4621072,2667.729,0.9453452);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-0.321362);
   Graph_Graph1013->SetMaximum(0.8046);
   ...
   pol01014->SetChisquare(2.804359);
   pol01014->SetNDF(5);
   ...
   pol01014->SetParameter(0,0.212565);
