...
//=========  (Wed May 11 17:49:02 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",50,-0.08742671,0.9188611);
   h__2->SetBinContent(19,1);
   h__2->SetBinContent(20,7);
   h__2->SetBinContent(21,42);
   h__2->SetBinContent(22,115);
   h__2->SetBinContent(23,224);
   h__2->SetBinContent(24,251);
   h__2->SetBinContent(25,203);
   h__2->SetBinContent(26,90);
   h__2->SetBinContent(27,53);
