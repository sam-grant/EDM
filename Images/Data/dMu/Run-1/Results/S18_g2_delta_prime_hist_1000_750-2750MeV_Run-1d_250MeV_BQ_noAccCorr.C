void S18_g2_delta_prime_hist_1000_750-2750MeV_Run-1d_250MeV_BQ_noAccCorr()
{
...
//=========  (Wed Apr 20 00:10:54 2022) by ROOT version 6.24/06
   ...
   TH1D *h__23 = new TH1D("h__23","S18",20,-0.1967389,0.2034476);
   h__23->SetBinContent(10,623);
   h__23->SetBinContent(11,377);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.003298
#pm7e-06
");
   pt_LaTex = pt->AddText("0.00021
#pm5e-06
");
   pt->Draw();
   c->Modified();
