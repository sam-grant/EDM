void S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:37:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.1554,-1.846664,2977.255,2.328104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","S18",100,979.1654,2755.245);
   Graph_Graph1009->SetMinimum(-1.429187);
   Graph_Graph1009->SetMaximum(1.910628);
   ...
   pol01010->SetChisquare(7.204335);
   pol01010->SetNDF(6);
   ...
   pol01010->SetParameter(0,-0.09707768);
   pol01010->SetParError(0,0.1026433);
