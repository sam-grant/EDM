void S12S18_chi2NDF_vs_p_fit_Run-1c_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:14:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3707,-0.2618686,2667.643,2.356817);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.198,2482.815);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(2.094949);
   ...
   pol01006->SetChisquare(0.1317981);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,1.094949);
   pol01006->SetParError(0,0.06628175);
   ...
   entry=leg->AddEntry("pol0","#LT#chi^{2}/NDF#GT = 1.1
#pm0.07
","lpf");
