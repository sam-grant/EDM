void S12S18_EDM_delta_prime_vs_p_750-2750MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.059,-1.323144,3038.275,1.511059);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-1.039724);
   Graph_Graph1005->SetMaximum(1.227638);
   ...
   pol01006->SetParameter(0,0.2179222);
   pol01006->SetParError(0,0.03777783);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.218
#pm0.04
 mrad","lpf");
