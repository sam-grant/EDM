void S12S18_EDM_delta_prime_vs_p_1000-2750MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:37:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.3719,-1.343003,2977.563,2.164346);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","S12S18",100,979.3911,2755.544);
   Graph_Graph1005->SetMinimum(-0.9922682);
   Graph_Graph1005->SetMaximum(1.813611);
   ...
   pol01006->SetChisquare(7.637576);
   pol01006->SetNDF(6);
   ...
   pol01006->SetParameter(0,0.374155);
   pol01006->SetParError(0,0.07018321);
