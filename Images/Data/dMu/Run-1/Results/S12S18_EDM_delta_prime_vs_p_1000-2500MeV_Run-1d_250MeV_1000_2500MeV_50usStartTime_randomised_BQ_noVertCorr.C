void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:20:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2245,-0.1807245,2667.425,0.9860502);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.06404698);
   Graph_Graph1005->SetMaximum(0.8693727);
   ...
   pol01006->SetChisquare(2.301373);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.3658888);
   pol01006->SetParError(0,0.04785455);
