void S18_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:11:02 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2554,-0.2272816,2667.767,2.045534);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,1004.107,2482.916);
   Graph_Graph1003->SetMinimum(0);
   Graph_Graph1003->SetMaximum(1.818253);
   ...
   pol01004->SetChisquare(0.1841074);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.8182528);
   pol01004->SetParError(0,0.07833846);
