...
//=========  (Mon Nov  8 21:10:18 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.007626216,2312,0.07446929);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1089->SetMinimum(0.000583335);
   Graph_Graph1089->SetMaximum(0.06625974);
   ...
   pol01090->SetChisquare(4.434681);
   pol01090->SetNDF(8);
   ...
   pol01090->SetParameter(0,0.03996061);
   pol01090->SetParError(0,0.003360023);
