...
//=========  (Tue Aug 23 11:13:41 2022) by ROOT version 6.26/04
   ...
   TH1D *h__3 = new TH1D("h__3","S12S18",30,0.1076315,0.4078555);
   h__3->SetBinContent(15,703);
   h__3->SetBinContent(16,297);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(24);
   pt_LaTex = pt->AddText("0.2575
#pm1e-05
");
   pt_LaTex = pt->AddText("0.000392
#pm9e-06
");
   pt->Draw();
   c->Modified();
