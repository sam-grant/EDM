...
//=========  (Tue Mar 29 11:44:08 2022) by ROOT version 6.24/06
   ...
   c->Range(453.5532,-1.76467,3038.337,2.010405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMaximum(1.632897);
   ...
   pol01008->SetChisquare(10.24409);
   pol01008->SetNDF(7);
   ...
   pol01008->SetParameter(0,0.02300885);
   pol01008->SetParError(0,0.07803012);
