...
//=========  (Tue Mar 29 10:47:28 2022) by ROOT version 6.24/06
   ...
   c->Range(452.9846,-1.476902,3038.491,1.666172);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-1.162594);
   Graph_Graph1011->SetMaximum(1.351865);
   ...
   pol01012->SetChisquare(17.25862);
   pol01012->SetNDF(7);
   ...
   pol01012->SetParameter(0,0.05101272);
   pol01012->SetParError(0,0.04159317);
