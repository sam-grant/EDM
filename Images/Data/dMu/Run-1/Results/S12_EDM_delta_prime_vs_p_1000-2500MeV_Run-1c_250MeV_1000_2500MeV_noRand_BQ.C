void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 19:41:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.8476,-0.1034574,2667.686,1.213917);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1001 = new TH1F("Graph_Graph1001","S12",100,1004.631,2482.903);
   Graph_Graph1001->SetMinimum(0.02828);
   Graph_Graph1001->SetMaximum(1.082179);
   ...
   pol01002->SetChisquare(4.621272);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.5176424);
   pol01002->SetParError(0,0.05632924);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.52
#pm0.06
 mrad","lpf");
