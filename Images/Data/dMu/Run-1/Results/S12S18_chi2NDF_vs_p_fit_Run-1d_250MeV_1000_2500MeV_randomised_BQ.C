...
//=========  (Fri Jun 10 20:30:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3456,-0.2378717,2667.468,2.140845);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.158,2482.656);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(1.902973);
   ...
   pol01006->SetChisquare(0.3069799);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.9029734);
   pol01006->SetParError(0,0.1011566);
