...
//=========  (Mon Mar 21 21:45:14 2022) by ROOT version 6.24/06
   ...
   TH1D *h__1 = new TH1D("h__1","S12",20,0.4919818,0.9001674);
   h__1->SetBinContent(9,15);
   h__1->SetBinContent(10,444);
   h__1->SetBinContent(11,498);
