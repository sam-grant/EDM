void S12_EDM_delta_prime_vs_p_900-2250MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:07:43 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.9511138,2499.5,1.493936);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.283235,
   0.3332412};
   TGraphErrors *gre = new TGraphErrors(11,_fx1025,_fy1025,_fex1025,_fey1025);
   gre->SetName("");
   gre->SetTitle("S12_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1025 = new TH1F("Graph_Graph1025","S12_",100,812,2312);
   Graph_Graph1025->SetMinimum(-0.7066089);
   Graph_Graph1025->SetMaximum(1.249431);
   ...
   pol01026->SetParameter(0,0.5912368);
   pol01026->SetParError(0,0.07406733);
