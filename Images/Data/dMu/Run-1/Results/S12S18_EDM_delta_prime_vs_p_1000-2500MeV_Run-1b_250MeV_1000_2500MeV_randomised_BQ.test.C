void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1b_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:00:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3752,-0.6634773,2667.554,0.861693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(-0.5109602);
   Graph_Graph1005->SetMaximum(0.709176);
   ...
   pol01006->SetChisquare(3.997042);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,-0.02639091);
   pol01006->SetParError(0,0.06615437);
