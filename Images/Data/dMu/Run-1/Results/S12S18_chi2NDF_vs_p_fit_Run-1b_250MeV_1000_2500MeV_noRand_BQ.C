void S12S18_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.585,-0.2707566,2667.576,2.43681);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","",100,1004.384,2482.777);
   Graph_Graph1011->SetMinimum(0);
   Graph_Graph1011->SetMaximum(2.166053);
   ...
   pol01012->SetChisquare(0.5254216);
   pol01012->SetNDF(5);
   ...
   pol01012->SetParameter(0,1.166053);
   pol01012->SetParError(0,0.1323407);
