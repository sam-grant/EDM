...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.09829259,2312,0.09357098);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1067->SetMinimum(-0.07910623);
   Graph_Graph1067->SetMaximum(0.07438462);
   ...
   pol01068->SetChisquare(4.752118);
   pol01068->SetNDF(8);
   ...
   pol01068->SetParameter(0,-0.001073029);
   pol01068->SetParError(0,0.00769553);
