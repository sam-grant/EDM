void S12_g2_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.6619,-2.089397,2977.557,2.195188);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,979.6514,2755.567);
   ...
   pol01008->SetChisquare(6.768846);
   pol01008->SetNDF(6);
   ...
   pol01008->SetParameter(0,-0.09499957);
   pol01008->SetParError(0,0.1141489);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.095
#pm0.1
 mrad","lpf");
