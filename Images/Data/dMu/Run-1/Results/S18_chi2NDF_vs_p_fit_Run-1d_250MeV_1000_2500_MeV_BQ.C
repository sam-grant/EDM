void S18_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May  6 12:25:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2502,-0.2504038,2667.186,2.253634);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","",100,1004.044,2482.392);
   Graph_Graph1021->SetMinimum(0);
   Graph_Graph1021->SetMaximum(2.00323);
