void S12_g2_delta_prime_vs_p_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:21 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.8384,-1.571618,2837.08,1.759259);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1031->SetMinimum(-1.23853);
   Graph_Graph1031->SetMaximum(1.426171);
   ...
   pol01032->SetChisquare(14.71234);
   pol01032->SetNDF(13);
   ...
   pol01032->SetParameter(0,0.003523324);
