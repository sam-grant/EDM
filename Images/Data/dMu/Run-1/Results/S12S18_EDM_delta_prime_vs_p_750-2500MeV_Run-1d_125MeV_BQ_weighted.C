void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1d_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 11:03:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.5518,-0.4889287,2837.366,1.600617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S12S18_",100,654.1332,2594.784);
   Graph_Graph1041->SetMinimum(-0.2799741);
   Graph_Graph1041->SetMaximum(1.391662);
   ...
   pol01042->SetChisquare(13.39699);
   pol01042->SetNDF(13);
   ...
   pol01042->SetParameter(0,0.5232169);
   pol01042->SetParError(0,0.03820188);
