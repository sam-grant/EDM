void S18_EDM_delta_prime_hist_1000_750-2500MeV_Run-1a_125MeV_BQ_weighted()
{
...
//=========  (Tue Nov 23 11:03:16 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18_",20,0.02032039,0.4321101);
   h__2->SetBinContent(8,1);
   h__2->SetBinContent(9,1);
   h__2->SetBinContent(10,91);
   h__2->SetBinContent(11,497);
   h__2->SetBinContent(12,350);
   h__2->SetBinContent(13,59);
   h__2->SetBinContent(14,1);
