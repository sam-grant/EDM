...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.1234426,2312,0.1186659);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1057->SetMinimum(-0.0992317);
   Graph_Graph1057->SetMaximum(0.09445509);
   ...
   pol01058->SetParameter(0,0.005031071);
   pol01058->SetParError(0,0.009413745);
