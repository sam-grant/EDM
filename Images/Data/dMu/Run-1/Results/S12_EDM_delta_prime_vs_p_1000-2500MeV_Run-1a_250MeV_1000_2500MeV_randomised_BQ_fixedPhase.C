void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1a_250MeV_1000_2500MeV_randomised_BQ_fixedPhase()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 11:59:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5479,-0.3992804,2668.079,1.632965);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.1960559);
   Graph_Graph1001->SetMaximum(1.42974);
   ...
   pol01002->SetChisquare(5.985463);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.4887924);
   pol01002->SetParError(0,0.09963576);
