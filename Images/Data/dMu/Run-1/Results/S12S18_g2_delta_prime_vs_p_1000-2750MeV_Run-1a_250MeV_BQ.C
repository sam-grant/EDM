void S12S18_g2_delta_prime_vs_p_1000-2750MeV_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:35:47 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.5177,-1.954352,2977.384,1.769964);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1011 = new TH1F("Graph_Graph1011","S12S18",100,979.5043,2755.397);
   Graph_Graph1011->SetMinimum(-1.58192);
   Graph_Graph1011->SetMaximum(1.397532);
   ...
   pol01012->SetParameter(0,-0.06298621);
   pol01012->SetParError(0,0.08270657);
