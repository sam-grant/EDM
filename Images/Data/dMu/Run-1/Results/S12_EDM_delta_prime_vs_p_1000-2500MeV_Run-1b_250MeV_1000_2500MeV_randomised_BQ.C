...
//=========  (Mon Jun 13 18:32:17 2022) by ROOT version 6.24/06
   ...
   c->Range(819.5991,-0.4045326,2667.761,1.439729);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-0.2201065);
   Graph_Graph1007->SetMaximum(1.255303);
   ...
   pol01008->SetChisquare(1.231628);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,0.2540195);
   pol01008->SetParError(0,0.08510556);
