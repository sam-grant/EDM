...
//=========  (Tue May 24 20:06:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5991,-0.4044161,2667.761,1.440021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.2199724);
   Graph_Graph1001->SetMaximum(1.255577);
   ...
   pol01002->SetChisquare(1.232242);
   pol01002->SetNDF(5);
   ...
   pol01002->SetParameter(0,0.2540645);
