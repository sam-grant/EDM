...
//=========  (Mon Nov  8 21:03:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.9216234,2655.75,1.304348);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2751332,
   0.358544};
   TGraphErrors *gre = new TGraphErrors(12,_fx1045,_fy1045,_fex1045,_fey1045);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1045 = new TH1F("Graph_Graph1045","S18_",100,799.5,2449.5);
   ...
   pol01046->SetParameter(0,-0.006838383);
   pol01046->SetParError(0,0.05668486);
