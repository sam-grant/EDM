...
//=========  (Mon Nov  8 21:10:05 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-1.235982,2312,2.523305);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.8600535);
   Graph_Graph1003->SetMaximum(2.147376);
   ...
   pol01004->SetChisquare(12.72831);
   pol01004->SetNDF(8);
   ...
   pol01004->SetParameter(0,0.1860495);
   pol01004->SetParError(0,0.1157634);
