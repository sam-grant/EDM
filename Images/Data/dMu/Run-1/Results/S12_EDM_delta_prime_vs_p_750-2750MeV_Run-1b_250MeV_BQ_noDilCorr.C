void S12_EDM_delta_prime_vs_p_750-2750MeV_Run-1b_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:16:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.4607,-0.9810597,3038.641,1.109258);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-0.7720279);
   Graph_Graph1013->SetMaximum(0.9002262);
   ...
   pol01014->SetChisquare(4.256474);
   pol01014->SetNDF(7);
   ...
   pol01014->SetParameter(0,0.04698262);
   pol01014->SetParError(0,0.01178878);
