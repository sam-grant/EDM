void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 16:29:58 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3707,-0.08841808,2667.643,1.208405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(0.04126422);
   Graph_Graph1005->SetMaximum(1.078723);
   ...
   pol01006->SetChisquare(2.834002);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.5095363);
   pol01006->SetParError(0,0.05451223);
