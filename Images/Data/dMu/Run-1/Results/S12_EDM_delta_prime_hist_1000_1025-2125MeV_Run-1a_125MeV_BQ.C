...
//=========  (Mon Nov  8 21:10:05 2021) by ROOT version 6.24/04
   ...
   TH1D *h__1 = new TH1D("h__1","S12_",22,0.2869406,0.7434382);
   h__1->SetBinContent(8,1);
   h__1->SetBinContent(9,8);
   h__1->SetBinContent(10,69);
   h__1->SetBinContent(11,212);
   h__1->SetBinContent(12,343);
   h__1->SetBinContent(13,234);
   h__1->SetBinContent(14,95);
   h__1->SetBinContent(15,31);
