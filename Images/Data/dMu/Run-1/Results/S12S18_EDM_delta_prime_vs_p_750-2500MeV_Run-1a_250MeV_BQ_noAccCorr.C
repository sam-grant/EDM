void S12S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1a_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Apr 29 13:08:45 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(514.9475,-1.034434,2728.833,1.485979);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","S12S18",100,736.336,2507.445);
   Graph_Graph1013->SetMinimum(-0.7823924);
   Graph_Graph1013->SetMaximum(1.233937);
   ...
   pol01014->SetChisquare(5.008564);
   pol01014->SetNDF(6);
   ...
   pol01014->SetParameter(0,0.219787);
   pol01014->SetParError(0,0.03785503);
