void S18_chi2NDF_vs_p_fit_Run-1b_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.2718,-0.2601822,2667.392,2.34164);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1009 = new TH1F("Graph_Graph1009","",100,1004.084,2482.58);
   Graph_Graph1009->SetMinimum(0);
   Graph_Graph1009->SetMaximum(2.081457);
   ...
   pol01010->SetChisquare(0.5955961);
   pol01010->SetNDF(5);
   ...
   pol01010->SetParameter(0,1.081457);
   pol01010->SetParError(0,0.1409014);
