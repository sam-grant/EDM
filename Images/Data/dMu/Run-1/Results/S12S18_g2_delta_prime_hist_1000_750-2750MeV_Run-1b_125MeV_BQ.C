...
//=========  (Mon Dec 20 16:05:13 2021) by ROOT version 6.24/04
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18",20,-0.2833015,0.1287102);
   h__12->SetBinContent(10,306);
   h__12->SetBinContent(11,694);
