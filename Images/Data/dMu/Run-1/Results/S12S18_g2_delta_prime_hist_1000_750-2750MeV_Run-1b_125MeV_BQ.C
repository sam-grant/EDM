...
//=========  (Thu Feb  3 11:00:06 2022) by ROOT version 6.24/06
   ...
   TH1D *h__12 = new TH1D("h__12","S12S18",20,-0.2913245,0.1200849);
   h__12->SetBinContent(10,348);
   h__12->SetBinContent(11,652);
