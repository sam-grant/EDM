void S12_g2_delta_prime_vs_p_750-2750MeV_Run-1d_250MeV_BQ_noAccCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Apr 20 00:10:51 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(453.1429,-1.439891,3039.225,1.216533);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1043->SetMinimum(-1.174249);
   Graph_Graph1043->SetMaximum(0.9508908);
   ...
   pol01044->SetParameter(0,0.03747212);
   pol01044->SetParError(0,0.02678609);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.0375
#pm0.03
 mrad","lpf");
