void S18_EDM_delta_prime_vs_p_750-2500MeV_Run-1b_125MeV_BQ_weighted()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov 22 17:32:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(411.2427,-0.8873417,2837.75,3.273642);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1015->SetMinimum(-0.4712433);
   Graph_Graph1015->SetMaximum(2.857544);
   ...
   pol01016->SetChisquare(14.89604);
   pol01016->SetNDF(13);
   ...
   pol01016->SetParameter(0,0.4357641);
