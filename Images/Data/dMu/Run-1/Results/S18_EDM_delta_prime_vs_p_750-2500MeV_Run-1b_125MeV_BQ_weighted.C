...
//=========  (Tue Nov 23 11:03:18 2021) by ROOT version 6.24/04
   ...
   c->Range(411.2438,-0.9048633,2837.746,3.293403);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S18_",100,653.894,2595.096);
   Graph_Graph1015->SetMinimum(-0.4850366);
   Graph_Graph1015->SetMaximum(2.873576);
   ...
   pol01016->SetChisquare(15.77244);
   pol01016->SetNDF(13);
   ...
   pol01016->SetParameter(0,0.4382921);
   pol01016->SetParError(0,0.09150326);
