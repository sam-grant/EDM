void S12S18_EDM_delta_prime_vs_p_1000-2500MeV_Run-1c_250MeV_1000_2500MeV_randomised_BQ_plusPhiErr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:12:29 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.3707,-0.09501825,2667.643,1.204037);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1005->SetMinimum(0.03488726);
   Graph_Graph1005->SetMaximum(1.074131);
   ...
   pol01006->SetChisquare(2.865288);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,0.502663);
   pol01006->SetParError(0,0.05451168);
