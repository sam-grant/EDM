void S12S18_EDM_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-0.3855944,2655.75,1.983502);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2466107,
   0.3167184};
   TGraphErrors *gre = new TGraphErrors(12,_fx1029,_fy1029,_fex1029,_fey1029);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1029 = new TH1F("Graph_Graph1029","S12S18_",100,799.5,2449.5);
   Graph_Graph1029->SetMinimum(-0.1486848);
   Graph_Graph1029->SetMaximum(1.746593);
   ...
   pol01030->SetParameter(0,0.6124213);
   pol01030->SetParError(0,0.05295754);
