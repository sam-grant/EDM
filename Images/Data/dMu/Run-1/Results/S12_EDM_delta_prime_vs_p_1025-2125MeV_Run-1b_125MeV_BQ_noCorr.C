...
//=========  (Mon Nov  8 21:10:17 2021) by ROOT version 6.24/04
   ...
   c->Range(812,-0.07813748,2312,0.1589814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1061->SetMaximum(0.1352695);
   ...
   pol01062->SetChisquare(11.64555);
   pol01062->SetNDF(8);
   ...
   pol01062->SetParameter(0,0.02103268);
   pol01062->SetParError(0,0.007709727);
