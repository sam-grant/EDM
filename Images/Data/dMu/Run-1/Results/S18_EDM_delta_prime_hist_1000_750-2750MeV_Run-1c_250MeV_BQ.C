...
//=========  (Tue Mar 29 11:44:08 2022) by ROOT version 6.24/06
   ...
   TH1D *h__2 = new TH1D("h__2","S18",20,0.4775046,0.8853448);
   h__2->SetBinContent(9,14);
   h__2->SetBinContent(10,448);
   h__2->SetBinContent(11,495);
   h__2->SetBinContent(12,42);
