void S12S18_chi2NDF_vs_p_fit_Run-1a_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.7269,-0.2755434,2667.812,2.479891);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","",100,1004.535,2483.004);
   Graph_Graph1005->SetMinimum(0);
   Graph_Graph1005->SetMaximum(2.204347);
   ...
   pol01006->SetChisquare(0.08965582);
   pol01006->SetNDF(5);
   ...
   pol01006->SetParameter(0,1.204347);
   pol01006->SetParError(0,0.05466743);
