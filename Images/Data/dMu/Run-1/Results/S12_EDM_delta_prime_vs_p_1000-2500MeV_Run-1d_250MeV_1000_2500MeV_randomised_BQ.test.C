void S12_EDM_delta_prime_vs_p_1000-2500MeV_Run-1d_250MeV_1000_2500MeV_randomised_BQ.test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 15:39:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.4447,-0.5094403,2667.685,0.6617065);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","S12",100,1004.269,2482.861);
   Graph_Graph1007->SetMinimum(-0.3923256);
   Graph_Graph1007->SetMaximum(0.5445918);
   ...
   Graph_Graph1007->GetYaxis()->SetTitle("#delta (BLIND) [mrad] / 500 MeV");
   ...
   pol01008->SetChisquare(0.9688932);
   pol01008->SetNDF(5);
   ...
   pol01008->SetParameter(0,0.09096263);
   pol01008->SetParError(0,0.05101263);
