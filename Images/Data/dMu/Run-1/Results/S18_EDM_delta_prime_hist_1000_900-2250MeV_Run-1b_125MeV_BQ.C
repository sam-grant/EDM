...
//=========  (Mon Nov  8 21:07:41 2021) by ROOT version 6.24/04
   ...
   TH1D *h__8 = new TH1D("h__8","S18_",21,0.1370122,0.5732883);
   h__8->SetBinContent(9,3);
   h__8->SetBinContent(10,81);
   h__8->SetBinContent(11,361);
   h__8->SetBinContent(12,407);
   h__8->SetBinContent(13,124);
   h__8->SetBinContent(14,21);
   h__8->SetBinContent(15,3);
