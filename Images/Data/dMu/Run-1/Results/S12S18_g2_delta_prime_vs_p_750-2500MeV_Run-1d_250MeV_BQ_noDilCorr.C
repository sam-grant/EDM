void S12S18_g2_delta_prime_vs_p_750-2500MeV_Run-1d_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:08 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(515.0162,-0.996486,2728.333,1.040541);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.01227385,
   0.01406329};
   TGraphErrors *gre = new TGraphErrors(7,_fx1047,_fy1047,_fex1047,_fey1047);
   gre->SetName("");
   gre->SetTitle("S12S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1047 = new TH1F("Graph_Graph1047","S12S18",100,736.348,2507.002);
   Graph_Graph1047->SetMinimum(-0.7927832);
   Graph_Graph1047->SetMaximum(0.8368387);
   ...
   pol01048->SetChisquare(17.26481);
   pol01048->SetNDF(6);
   ...
   pol01048->SetParameter(0,0.0002947354);
   pol01048->SetParError(0,0.005402283);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.000295
#pm0.005
 mrad","lpf");
