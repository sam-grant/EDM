void S12S18_g2_delta_prime_hist_1000_750-2500MeV_Run-1c_125MeV_BQ_weighted()
{
...
//=========  (Tue Nov 23 11:03:22 2021) by ROOT version 6.24/04
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18_",20,-0.2203388,0.1814402);
   h__18->SetBinContent(10,23);
   h__18->SetBinContent(11,779);
   h__18->SetBinContent(12,197);
   h__18->SetBinContent(13,1);
