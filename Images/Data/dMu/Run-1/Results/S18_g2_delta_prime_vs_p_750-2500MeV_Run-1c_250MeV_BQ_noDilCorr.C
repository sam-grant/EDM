void S18_g2_delta_prime_vs_p_750-2500MeV_Run-1c_250MeV_BQ_noDilCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May  3 11:57:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(514.6398,-1.033248,2728.454,1.140062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1033 = new TH1F("Graph_Graph1033","S18",100,736.0212,2507.073);
   Graph_Graph1033->SetMinimum(-0.8159169);
   Graph_Graph1033->SetMaximum(0.9227313);
   ...
   pol01034->SetParameter(0,-0.004318152);
   pol01034->SetParError(0,0.01133381);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.00432
#pm0.01
 mrad","lpf");
