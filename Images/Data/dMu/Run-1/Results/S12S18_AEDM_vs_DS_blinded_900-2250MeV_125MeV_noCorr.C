void S12S18_AEDM_vs_DS_blinded_900-2250MeV_125MeV_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:31:28 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(0.25,3.811902e-20,4.75,1.873243e-19);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1048->SetMinimum(5.303955e-20);
   Graph_Graph1048->SetMaximum(1.724038e-19);
   ...
   pol01049->SetChisquare(12.01196);
   pol01049->SetNDF(3);
   ...
   pol01049->SetParameter(0,1.205359e-19);
   pol01049->SetParError(0,6.750822e-21);
