...
//=========  (Mon Nov 22 17:51:24 2021) by ROOT version 6.24/04
   ...
   c->Range(0.25,-175.652,4.75,103.4426);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-147.7425);
   Graph_Graph1003->SetMaximum(75.5331);
   ...
   pol01004->SetChisquare(1.292648);
   pol01004->SetNDF(3);
   ...
   pol01004->SetParameter(0,-6.246473);
