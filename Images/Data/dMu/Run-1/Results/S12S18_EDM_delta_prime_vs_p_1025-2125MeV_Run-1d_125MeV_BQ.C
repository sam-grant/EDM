void S12S18_EDM_delta_prime_vs_p_1025-2125MeV_Run-1d_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 21:10:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(812,-0.1052063,2312,1.020511);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.1320766,
   0.1537501};
   TGraphErrors *gre = new TGraphErrors(9,_fx1041,_fy1041,_fex1041,_fey1041);
   gre->SetName("");
   gre->SetTitle("S12S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S12S18_",100,962,2162);
   Graph_Graph1041->SetMinimum(0.007365406);
   Graph_Graph1041->SetMaximum(0.9079391);
   ...
   pol01042->SetParameter(0,0.4873351);
   pol01042->SetParError(0,0.04131104);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = 0.49
#pm0.04
 mrad","lpf");
