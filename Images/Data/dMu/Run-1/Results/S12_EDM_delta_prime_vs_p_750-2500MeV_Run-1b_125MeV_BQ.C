...
//=========  (Thu Nov 18 11:46:27 2021) by ROOT version 6.24/04
   ...
   c->Range(411.7199,-1.097196,2837.24,3.179356);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1013->SetMinimum(-0.6695412);
   Graph_Graph1013->SetMaximum(2.751701);
   ...
   pol01014->SetParameter(0,0.2967354);
