...
//=========  (Fri May 13 18:02:12 2022) by ROOT version 6.24/06
   ...
   c->Range(819.1932,-0.4678624,2667.129,1.657241);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.255352);
   Graph_Graph1003->SetMaximum(1.444731);
   ...
   pol01004->SetChisquare(12.25312);
   pol01004->SetNDF(5);
   ...
   pol01004->SetParameter(0,0.4575421);
   pol01004->SetParError(0,0.07451728);
