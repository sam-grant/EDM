...
//=========  (Fri Oct  7 13:29:17 2022) by ROOT version 6.26/04
   ...
   c->Range(819.1932,-0.6031756,2667.129,1.320335);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.2168277,
   0.2155234};
   TGraphErrors *gre = new TGraphErrors(6,_fx1041,_fy1041,_fex1041,_fey1041);
   gre->SetName("");
   gre->SetTitle("S18");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1041 = new TH1F("Graph_Graph1041","S18",100,1003.987,2482.336);
   Graph_Graph1041->SetMinimum(-0.4108245);
   Graph_Graph1041->SetMaximum(1.127984);
   ...
   Graph_Graph1041->GetYaxis()->SetTitle("#delta^{BLIND} [mrad] / 250 MeV");
   ...
   pol01042->SetParameter(0,0.3507935);
   pol01042->SetParError(0,0.07604016);
   ...
   entry=leg->AddEntry("pol0","#LT#delta#GT = 0.351
#pm0.08
 mrad","lpf");
