void S12S18_chi2NDF_vs_p_fit_Run-1d_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 20:15:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->Range(819.5929,-0.2708423,2667.557,2.437581);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1023 = new TH1F("Graph_Graph1023","",100,1004.389,2482.761);
   Graph_Graph1023->SetMinimum(0);
   Graph_Graph1023->SetMaximum(2.166738);
   ...
   pol01024->SetChisquare(0.3855509);
   pol01024->SetNDF(5);
   ...
   pol01024->SetParameter(0,1.166738);
   pol01024->SetParError(0,0.1133653);
