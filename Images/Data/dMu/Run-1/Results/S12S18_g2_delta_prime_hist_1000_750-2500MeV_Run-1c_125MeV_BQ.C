...
//=========  (Thu Dec  2 14:43:43 2021) by ROOT version 6.24/04
   ...
   TH1D *h__18 = new TH1D("h__18","S12S18",20,-0.2057971,0.2075536);
   h__18->SetBinContent(10,104);
   h__18->SetBinContent(11,872);
   h__18->SetBinContent(12,24);
