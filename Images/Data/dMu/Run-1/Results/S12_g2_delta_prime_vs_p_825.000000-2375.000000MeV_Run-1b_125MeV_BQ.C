void S12_g2_delta_prime_vs_p_825.000000-2375.000000MeV_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Nov  8 20:56:30 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(593.25,-1.496864,2655.75,1.481404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","S12_",100,799.5,2449.5);
   Graph_Graph1019->SetMinimum(-1.199037);
   Graph_Graph1019->SetMaximum(1.183577);
   ...
   pol01020->SetParameter(0,-0.01115028);
   pol01020->SetParError(0,0.08898051);
