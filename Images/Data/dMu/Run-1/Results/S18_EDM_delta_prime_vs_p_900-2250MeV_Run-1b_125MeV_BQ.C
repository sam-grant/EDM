...
//=========  (Mon Nov  8 21:07:41 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-0.7988275,2499.5,2.319708);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.3747818,
   0.4397407};
   TGraphErrors *gre = new TGraphErrors(11,_fx1015,_fy1015,_fex1015,_fey1015);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1015 = new TH1F("Graph_Graph1015","S18_",100,812,2312);
   ...
   pol01016->SetParameter(0,0.3686522);
   pol01016->SetParError(0,0.09432372);
