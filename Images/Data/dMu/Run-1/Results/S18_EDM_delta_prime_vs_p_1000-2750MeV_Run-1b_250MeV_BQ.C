void S18_EDM_delta_prime_vs_p_1000-2750MeV_Run-1b_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:37:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(757.1554,-1.627351,2977.255,2.292541);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","S18",100,979.1654,2755.245);
   Graph_Graph1003->SetMinimum(-1.235361);
   Graph_Graph1003->SetMaximum(1.900551);
   ...
   pol01004->SetChisquare(6.524238);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.3929823);
   pol01004->SetParError(0,0.1019009);
