...
//=========  (Mon Nov  8 21:07:42 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(624.5,-1.316192,2499.5,2.290856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.37849,
   0.4484642};
   TGraphErrors *gre = new TGraphErrors(11,_fx1021,_fy1021,_fex1021,_fey1021);
   gre->SetName("");
   gre->SetTitle("S18_");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph1021 = new TH1F("Graph_Graph1021","S18_",100,812,2312);
   Graph_Graph1021->SetMinimum(-0.9554872);
   Graph_Graph1021->SetMaximum(1.930151);
   ...
   pol01022->SetParameter(0,-0.06289764);
   pol01022->SetParError(0,0.09431196);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.063
#pm0.09
 mrad","lpf");
