...
//=========  (Fri Dec 17 14:47:25 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8422,9.45073,3033.559,26.37774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S12",100,115.0394,3139.412);
   Graph_Graph01067->SetMinimum(11.14343);
   Graph_Graph01067->SetMaximum(24.68504);
