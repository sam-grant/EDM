...
//=========  (Fri Dec 17 14:47:25 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8422,-338264.7,3033.559,3137307);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S12",100,115.0394,3139.412);
   Graph_Graph01068->SetMinimum(9292.511);
   Graph_Graph01068->SetMaximum(2789750);
