...
//=========  (Sun Dec  5 23:47:15 2021) by ROOT version 6.24/04
   ...
   c->Range(462.7061,-0.02864591,3034.515,0.3619775);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12S18",100,114.7555,3140.413);
   Graph_Graph01047->SetMinimum(0.01041643);
   Graph_Graph01047->SetMaximum(0.3229151);
