...
//=========  (Mon Nov 22 17:30:31 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7189,-0.1653807,2728.306,1.603456);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","S12S18",100,114.7014,3140.583);
   Graph_Graph01044->SetMinimum(0.01150295);
   Graph_Graph01044->SetMaximum(1.426572);
   ...
   Graph_Graph01044->GetXaxis()->SetRange(21,79);
   ...
   Graph_Graph01044->GetYaxis()->SetTitle("#deltaA_{EDM} / 125 MeV");
