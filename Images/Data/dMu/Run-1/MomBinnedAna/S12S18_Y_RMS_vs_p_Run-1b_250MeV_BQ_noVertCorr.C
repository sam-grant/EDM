void S12S18_Y_RMS_vs_p_Run-1b_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 19:07:40 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(470.8201,9.308533,3017.493,16.90277);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S12S18",100,223.13,3014.004);
   Graph_Graph01110->SetMinimum(10.06796);
   Graph_Graph01110->SetMaximum(16.14334);
