void S18_Ag2_vs_p_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May  8 18:11:17 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.4735,-0.02800783,2703.986,0.03359092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01074 = new TH1F("Graph_Graph01074","S18",100,223.8725,3014.437);
   Graph_Graph01074->SetMinimum(-0.02184795);
   Graph_Graph01074->SetMaximum(0.02743104);
