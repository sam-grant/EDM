...
//=========  (Wed Dec  1 15:15:24 2021) by ROOT version 6.24/04
   ...
   c->Range(496.8818,0.006279701,2726.488,0.02799286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12S18",100,115.2034,3138.398);
   Graph_Graph01047->SetMinimum(0.008451017);
   Graph_Graph01047->SetMaximum(0.02582154);
