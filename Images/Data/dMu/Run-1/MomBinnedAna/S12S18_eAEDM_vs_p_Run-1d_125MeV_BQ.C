...
//=========  (Fri Mar 25 10:51:36 2022) by ROOT version 6.24/06
   ...
   c->Range(462.8762,-0.02386862,3032.589,0.2892499);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18",100,115.2092,3138.4);
   Graph_Graph01179->SetMinimum(0.007443238);
   Graph_Graph01179->SetMaximum(0.2579381);
