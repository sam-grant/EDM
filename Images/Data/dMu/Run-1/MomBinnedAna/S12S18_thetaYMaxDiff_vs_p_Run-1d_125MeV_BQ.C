...
//=========  (Fri Dec 17 14:47:40 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8618,8.581567,3032.519,244.0415);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18",100,115.2023,3138.328);
   Graph_Graph01180->SetMinimum(32.12756);
   Graph_Graph01180->SetMaximum(220.4955);
