void S12S18_Y_RMS_vs_p_Run-1b_250MeV_1000_2500MeV_earlyTimes_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:31:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.0812,9.429598,2704.187,16.04858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S12S18",100,223.3065,3014.734);
   Graph_Graph01110->SetMinimum(10.0915);
   Graph_Graph01110->SetMaximum(15.38668);
