void S12_Momentum_Y_RMS_vs_p_Run-1a_250MeV_1000_2500MeV_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 15:36:43 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.9134,10.91888,2704.094,26.00197);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S12",100,223.1169,3014.653);
   Graph_Graph01045->SetMinimum(12.42719);
   Graph_Graph01045->SetMaximum(24.49366);
