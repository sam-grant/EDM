void S18_Momentum_Y_RMS_vs_p_Run-1c_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 12:29:30 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2907,10.79641,2704.38,25.84069);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01078 = new TH1F("Graph_Graph01078","S18",100,223.5209,3014.924);
   Graph_Graph01078->SetMinimum(12.30083);
   Graph_Graph01078->SetMaximum(24.33626);
