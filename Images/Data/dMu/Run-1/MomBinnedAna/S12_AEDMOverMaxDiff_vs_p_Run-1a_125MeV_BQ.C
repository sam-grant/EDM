...
//=========  (Fri Mar 25 03:46:38 2022) by ROOT version 6.24/06
   ...
   c->Range(462.3119,-0.5767198,3036.371,0.07343691);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01071 = new TH1F("Graph_Graph01071","S12",100,114.0569,3142.362);
   Graph_Graph01071->SetMinimum(-0.5117041);
   Graph_Graph01071->SetMaximum(0.008421241);
