void S12S18_theta_Y_RMS_vs_p_Run-1b_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 21:17:09 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.7944,2.509678,2703.518,25.5044);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01109 = new TH1F("Graph_Graph01109","S12S18",100,223.1319,3014.002);
   Graph_Graph01109->SetMinimum(4.80915);
   Graph_Graph01109->SetMaximum(23.20492);
