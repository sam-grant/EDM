...
//=========  (Thu Dec  9 22:16:31 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01120 = new TH1F("Graph_Graph01120","S18",100,115.2378,3138.654);
   Graph_Graph01120->SetMinimum(3.873341);
   Graph_Graph01120->SetMaximum(29.43014);
   ...
   Graph_Graph01120->GetXaxis()->SetRange(21,88);
