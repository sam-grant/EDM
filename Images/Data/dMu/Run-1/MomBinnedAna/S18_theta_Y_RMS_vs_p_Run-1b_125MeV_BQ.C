...
//=========  (Sun Dec  5 23:46:41 2021) by ROOT version 6.24/04
   ...
   c->Range(462.9306,0.678741,3032.834,32.62473);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S18",100,115.2378,3138.654);
   Graph_Graph01032->SetMinimum(3.873341);
   Graph_Graph01032->SetMaximum(29.43014);
   ...
   Graph_Graph01032->GetXaxis()->SetRange(21,88);
