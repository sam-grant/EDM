...
//=========  (Sun Dec  5 23:47:13 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","S12",100,114.3965,3143.964);
   Graph_Graph01020->SetMinimum(0.5143571);
   Graph_Graph01020->SetMaximum(2.428468);
   ...
   Graph_Graph01020->GetXaxis()->SetRange(21,87);
