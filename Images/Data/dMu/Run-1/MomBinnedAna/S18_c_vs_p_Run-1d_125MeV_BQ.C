...
//=========  (Fri Dec  3 17:55:53 2021) by ROOT version 6.24/04
   ...
   c->Range(496.8012,-0.1404427,3027.932,1.234778);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01028 = new TH1F("Graph_Graph01028","S18",100,115.2427,3137.489);
   Graph_Graph01028->SetMinimum(-0.002920571);
   Graph_Graph01028->SetMaximum(1.097256);
