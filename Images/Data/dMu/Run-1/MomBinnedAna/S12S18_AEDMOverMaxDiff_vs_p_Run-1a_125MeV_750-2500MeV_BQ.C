void S12S18_AEDMOverMaxDiff_vs_p_Run-1a_125MeV_750-2500MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 13:18:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(496.2707,-0.0004033415,3029.518,0.007502663);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12S18",100,114.3931,3139.166);
   Graph_Graph01049->SetMinimum(0.000387259);
   Graph_Graph01049->SetMaximum(0.006712062);
