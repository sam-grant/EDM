void S12S18_AEDMOverMaxDiff_vs_p_Run-1b_250MeV_1000_2500MeV_earlyTimes_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:31:42 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.0812,-5.169164e-05,2704.187,0.006535954);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01115 = new TH1F("Graph_Graph01115","S12S18",100,223.3065,3014.734);
   Graph_Graph01115->SetMinimum(0.0006070729);
   Graph_Graph01115->SetMaximum(0.005877189);
