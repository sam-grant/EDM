...
//=========  (Fri Mar 25 03:46:43 2022) by ROOT version 6.24/06
   ...
   c->Range(496.0181,-0.08646728,3028.101,0.987065);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01124 = new TH1F("Graph_Graph01124","S18",100,114.316,3137.699);
   Graph_Graph01124->SetMinimum(0.02088595);
   Graph_Graph01124->SetMaximum(0.8797118);
