...
//=========  (Sun Dec  5 23:47:47 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(462.8422,8.326128,3033.559,23.53271);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","S12",100,115.0394,3139.412);
   Graph_Graph01022->SetMinimum(9.846786);
   Graph_Graph01022->SetMaximum(22.01206);
   ...
   Graph_Graph01022->GetXaxis()->SetRange(21,88);
