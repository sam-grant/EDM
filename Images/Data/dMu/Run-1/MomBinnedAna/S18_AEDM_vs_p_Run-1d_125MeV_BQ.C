...
//=========  (Sun Dec  5 23:47:48 2021) by ROOT version 6.24/04
   ...
   c->Range(496.8012,-0.1102027,3027.932,1.057739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01029 = new TH1F("Graph_Graph01029","S18",100,115.2427,3137.489);
   Graph_Graph01029->SetMinimum(0.006591414);
   Graph_Graph01029->SetMaximum(0.9409445);
