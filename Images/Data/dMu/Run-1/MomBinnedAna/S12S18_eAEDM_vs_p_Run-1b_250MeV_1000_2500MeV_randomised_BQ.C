...
//=========  (Fri Oct  7 12:34:15 2022) by ROOT version 6.26/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.7944,0.007412172,2703.518,0.02202544);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01113->SetMinimum(0.008873498);
   Graph_Graph01113->SetMaximum(0.02056411);
