void S18_thetaYMaxDiff_vs_p_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue May 24 20:12:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.4727,33.1941,2703.942,239.2497);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01081 = new TH1F("Graph_Graph01081","S18",100,223.8844,3014.385);
   Graph_Graph01081->SetMinimum(53.79967);
   Graph_Graph01081->SetMaximum(218.6442);
