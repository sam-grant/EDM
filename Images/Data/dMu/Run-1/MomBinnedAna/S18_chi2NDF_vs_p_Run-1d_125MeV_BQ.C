...
//=========  (Fri Mar 25 10:51:31 2022) by ROOT version 6.24/06
   ...
   c->Range(496.8372,0.05689661,3028.15,4.709414);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","S18",100,115.2511,3137.715);
   Graph_Graph01119->SetMinimum(0.5221484);
   Graph_Graph01119->SetMaximum(4.244162);
