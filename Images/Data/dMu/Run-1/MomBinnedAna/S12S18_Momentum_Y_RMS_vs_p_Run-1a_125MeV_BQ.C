...
//=========  (Mon Nov 22 17:30:10 2021) by ROOT version 6.24/04
   ...
   c->Range(530.2994,10.51538,2723.26,22.47301);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01042->SetMinimum(11.71114);
   Graph_Graph01042->SetMaximum(21.27724);
   ...
   Graph_Graph01042->GetXaxis()->SetRange(22,79);
