...
//=========  (Wed Dec  1 15:22:25 2021) by ROOT version 6.24/04
   ...
   c->Range(530.2994,13.31952,2723.26,23.52712);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01045->SetMinimum(14.34028);
   Graph_Graph01045->SetMaximum(22.50636);
   ...
   Graph_Graph01045->GetXaxis()->SetRange(22,79);
