...
//=========  (Wed Dec  1 15:15:23 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8077,10.68533,2722.058,14.10154);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S18",100,115.2258,3137.64);
   Graph_Graph01033->SetMinimum(11.02695);
   Graph_Graph01033->SetMaximum(13.75992);
