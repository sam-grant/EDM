...
//=========  (Wed Dec  1 15:22:25 2021) by ROOT version 6.24/04
   ...
   c->Range(530.2994,32.68662,2723.26,220.4411);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01048->SetMinimum(51.46207);
   Graph_Graph01048->SetMaximum(201.6657);
   ...
   Graph_Graph01048->GetXaxis()->SetRange(22,79);
