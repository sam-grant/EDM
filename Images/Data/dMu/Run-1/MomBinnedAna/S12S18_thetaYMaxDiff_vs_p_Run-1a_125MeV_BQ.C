...
//=========  (Fri Dec 17 14:44:27 2021) by ROOT version 6.24/04
   ...
   c->Range(496.2707,7.982371,3029.518,243.5563);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18",100,114.3931,3139.166);
   Graph_Graph01180->SetMinimum(31.53976);
   Graph_Graph01180->SetMaximum(219.9989);
