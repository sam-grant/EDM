...
//=========  (Fri Dec 17 14:45:19 2021) by ROOT version 6.24/04
   ...
   c->Range(462.631,-0.1643335,3036.691,1.650422);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.3759,3142.681);
   Graph_Graph01069->SetMinimum(0.0171421);
   Graph_Graph01069->SetMaximum(1.468947);
