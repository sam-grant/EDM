...
//=========  (Fri Mar 25 03:47:35 2022) by ROOT version 6.24/06
   ...
   c->Range(462.6562,-0.1346686,3036.689,1.382234);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.4047,3142.679);
   Graph_Graph01069->SetMinimum(0.01702173);
   Graph_Graph01069->SetMaximum(1.230544);
