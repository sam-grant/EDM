...
//=========  (Fri Mar 25 03:48:40 2022) by ROOT version 6.24/06
   ...
   c->Range(496.5135,-0.04421759,3027.918,4.521158);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","S18",100,114.9137,3137.486);
   Graph_Graph01119->SetMinimum(0.41232);
   Graph_Graph01119->SetMaximum(4.064621);
