...
//=========  (Fri Dec 17 14:46:22 2021) by ROOT version 6.24/04
   ...
   c->Range(466.5837,8.870806,3003.847,19.43051);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01066 = new TH1F("Graph_Graph01066","S12",100,114.3965,3143.964);
   Graph_Graph01066->SetMinimum(9.926777);
   Graph_Graph01066->SetMaximum(18.37454);
   ...
   Graph_Graph01066->GetXaxis()->SetRange(21,87);
