void S12S18_N_vs_p_Run-1d_250MeV_BQ_timeVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 22:27:23 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.2007,-1519043,3017.767,1.191767e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01112 = new TH1F("Graph_Graph01112","S12S18",100,223.521,3014.278);
   Graph_Graph01112->SetMinimum(-175371.4);
   Graph_Graph01112->SetMaximum(1.0574e+07);
