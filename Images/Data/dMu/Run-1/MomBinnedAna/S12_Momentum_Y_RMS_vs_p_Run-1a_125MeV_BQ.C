...
//=========  (Thu Dec  9 22:15:36 2021) by ROOT version 6.24/04
   ...
   c->Range(462.3259,9.446197,3036.37,26.34602);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01067 = new TH1F("Graph_Graph01067","S12",100,114.0729,3142.36);
   Graph_Graph01067->SetMinimum(11.13618);
   Graph_Graph01067->SetMaximum(24.65604);
