...
//=========  (Wed Dec  1 15:15:23 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8077,13.24493,2722.058,23.48551);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S18",100,115.2258,3137.64);
   Graph_Graph01034->SetMinimum(14.26899);
   Graph_Graph01034->SetMaximum(22.46145);
