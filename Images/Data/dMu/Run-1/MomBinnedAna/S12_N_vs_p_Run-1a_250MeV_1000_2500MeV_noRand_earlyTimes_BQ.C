void S12_N_vs_p_Run-1a_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:32:26 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.8754,-23866.5,2704.488,683288.9);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S12",100,222.9524,3015.116);
   Graph_Graph01046->SetMinimum(46849.04);
   Graph_Graph01046->SetMaximum(612573.3);
