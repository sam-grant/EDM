...
//=========  (Thu Nov 18 10:58:55 2021) by ROOT version 6.24/04
   ...
   c->Range(496.944,9.953141,2726.713,25.34633);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(11.49246);
   Graph_Graph01031->SetMaximum(23.80701);
   ...
   Graph_Graph01031->GetXaxis()->SetRange(21,79);
