...
//=========  (Tue Nov 23 11:24:03 2021) by ROOT version 6.24/04
   ...
   c->Range(496.9393,9.95213,2726.713,25.34653);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","S18",100,115.2323,3138.654);
   Graph_Graph01031->SetMinimum(11.49157);
   Graph_Graph01031->SetMaximum(23.80709);
