...
//=========  (Wed Dec  1 16:15:31 2021) by ROOT version 6.24/04
   ...
   c->Range(496.9393,10.93929,2726.713,14.44181);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S18",100,115.2323,3138.654);
   Graph_Graph01033->SetMinimum(11.28954);
   Graph_Graph01033->SetMaximum(14.09155);
