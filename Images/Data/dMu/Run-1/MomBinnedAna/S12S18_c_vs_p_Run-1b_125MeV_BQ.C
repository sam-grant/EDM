...
//=========  (Thu Nov 18 10:58:56 2021) by ROOT version 6.24/04
   ...
   c->Range(496.8865,-10.14369,2728.021,2.673365);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S12S18",100,114.9465,3140.214);
   Graph_Graph01037->SetMinimum(-8.861989);
   Graph_Graph01037->SetMaximum(1.391659);
