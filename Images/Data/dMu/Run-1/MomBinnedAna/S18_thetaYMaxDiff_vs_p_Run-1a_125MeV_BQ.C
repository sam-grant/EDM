...
//=========  (Fri Dec 17 14:44:18 2021) by ROOT version 6.24/04
   ...
   c->Range(496.0523,-1.931583,3028.099,244.4958);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01125 = new TH1F("Graph_Graph01125","S18",100,114.3557,3137.695);
   Graph_Graph01125->SetMinimum(22.71115);
   Graph_Graph01125->SetMaximum(219.853);
