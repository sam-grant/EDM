...
//=========  (Sun Dec  5 23:47:14 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12S18",100,114.7555,3140.413);
   Graph_Graph01040->SetMinimum(-0.3185202);
   Graph_Graph01040->SetMaximum(0.08917293);
