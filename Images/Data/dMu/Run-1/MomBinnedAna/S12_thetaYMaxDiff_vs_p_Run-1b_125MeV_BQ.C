...
//=========  (Sun Dec  5 23:46:41 2021) by ROOT version 6.24/04
   ...
   c->Range(462.631,4.035423,3036.691,242.443);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S12",100,114.3759,3142.681);
   Graph_Graph01026->SetMinimum(27.87619);
   Graph_Graph01026->SetMaximum(218.6023);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(21,88);
