void S12S18_Y_RMS_vs_p_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May  8 18:11:22 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.1608,9.198331,2703.806,15.59529);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01110 = new TH1F("Graph_Graph01110","S12S18",100,223.521,3014.278);
   Graph_Graph01110->SetMinimum(9.838027);
   Graph_Graph01110->SetMaximum(14.95559);
