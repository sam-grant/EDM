void S18_chi2NDF_vs_p_Run-1b_250MeV_BQ_accCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Mar 25 12:01:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(470.7315,0.3776953,3017.857,1.949626);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01075->SetMinimum(0.5348883);
   Graph_Graph01075->SetMaximum(1.792433);
