void S12S18_N_vs_p_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:40:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.1581,-513547,2703.793,1.178086e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01112 = new TH1F("Graph_Graph01112","S12S18",100,223.5213,3014.263);
   Graph_Graph01112->SetMinimum(715893.6);
   Graph_Graph01112->SetMaximum(1.055142e+07);
