void S18_eAEDM_vs_p_Run-1d_250MeV_1000_2500MeV_50usStartTime_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sat Jun 11 00:28:07 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.3487,0.007853157,2703.496,0.02239032);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01080->SetMinimum(0.009306874);
   Graph_Graph01080->SetMaximum(0.02093661);
