void S18_c_vs_p_Run-1d_250MeV_1000_2500_MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May  8 18:11:16 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.4735,-0.00421475,2703.986,0.01032237);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01072 = new TH1F("Graph_Graph01072","S18",100,223.8725,3014.437);
   Graph_Graph01072->SetMinimum(-0.002761039);
   Graph_Graph01072->SetMaximum(0.008868653);
