void S18_chi2NDF_vs_p_Run-1b_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Mar 25 03:47:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(462.9538,0.1822455,3032.833,2.805203);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","S18",100,115.2643,3138.651);
   Graph_Graph01119->SetMinimum(0.4445412);
   Graph_Graph01119->SetMaximum(2.542907);
   ...
   Graph_Graph01119->GetXaxis()->SetRange(21,88);
