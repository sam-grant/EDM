void S12S18_c_vs_p_Run-1c_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:32:37 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.2072,-0.04918413,3017.714,0.02797285);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01105->SetMinimum(-0.04146843);
   Graph_Graph01105->SetMaximum(0.02025715);
