void S18_eAEDM_vs_p_Run-1a_125MeV_BQ_BK()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 17 22:14:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522,-0.2719825,2727,2.684308);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S18",100,49.5,3199.5);
   Graph_Graph01034->SetMinimum(0.02364655);
   Graph_Graph01034->SetMaximum(2.388679);
