...
//=========  (Fri Dec 17 14:46:40 2021) by ROOT version 6.24/04
   ...
   c->Range(462.7061,9.21161,3034.515,26.27152);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01177 = new TH1F("Graph_Graph01177","S12S18",100,114.7555,3140.413);
   Graph_Graph01177->SetMinimum(10.9176);
   Graph_Graph01177->SetMaximum(24.56553);
