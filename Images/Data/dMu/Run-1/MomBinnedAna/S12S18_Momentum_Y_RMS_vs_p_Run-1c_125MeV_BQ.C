...
//=========  (Mon Nov 22 17:30:31 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7189,10.50626,2728.306,22.4852);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12S18",100,114.7014,3140.583);
   Graph_Graph01042->SetMinimum(11.70415);
   Graph_Graph01042->SetMaximum(21.28731);
