void S18_theta_Y_RMS_vs_p_Run-1b_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May 29 20:30:32 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.7571,2.494157,2703.823,25.43937);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01076 = new TH1F("Graph_Graph01076","S18",100,222.9942,3014.363);
   Graph_Graph01076->SetMinimum(4.788679);
   Graph_Graph01076->SetMaximum(23.14485);
