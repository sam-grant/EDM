...
//=========  (Fri Dec 17 14:44:18 2021) by ROOT version 6.24/04
   ...
   c->Range(496.0523,9.256008,3028.099,26.12477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01122 = new TH1F("Graph_Graph01122","S18",100,114.3557,3137.695);
   Graph_Graph01122->SetMinimum(10.94288);
   Graph_Graph01122->SetMaximum(24.43789);
