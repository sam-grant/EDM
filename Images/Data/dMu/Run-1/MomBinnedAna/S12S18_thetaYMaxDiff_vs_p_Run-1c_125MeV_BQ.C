...
//=========  (Mon Nov 22 17:30:31 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7189,-23.73399,2728.306,417.8864);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S12S18",100,114.7014,3140.583);
   Graph_Graph01045->SetMinimum(20.42806);
   Graph_Graph01045->SetMaximum(373.7244);
