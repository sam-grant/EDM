...
//=========  (Wed Dec  1 15:14:39 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7271,-0.6943202,2728.307,0.3013573);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12S18",100,114.711,3140.582);
   Graph_Graph01039->SetMinimum(-0.5947524);
   Graph_Graph01039->SetMaximum(0.2017895);
