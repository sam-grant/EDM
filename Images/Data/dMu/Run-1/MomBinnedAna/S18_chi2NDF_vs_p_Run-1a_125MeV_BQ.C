...
//=========  (Fri Mar 25 03:46:43 2022) by ROOT version 6.24/06
   ...
   c->Range(496.0181,0.03076259,3028.101,3.934327);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01119 = new TH1F("Graph_Graph01119","S18",100,114.316,3137.699);
   Graph_Graph01119->SetMinimum(0.4211191);
   Graph_Graph01119->SetMaximum(3.543971);
