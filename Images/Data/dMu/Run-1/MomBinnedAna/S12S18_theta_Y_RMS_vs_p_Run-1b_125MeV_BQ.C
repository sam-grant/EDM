...
//=========  (Fri Dec 17 14:45:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(462.8522,0.777692,3034.329,32.70034);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01175 = new TH1F("Graph_Graph01175","S12S18",100,114.9465,3140.214);
   Graph_Graph01175->SetMinimum(3.969957);
   Graph_Graph01175->SetMaximum(29.50808);
