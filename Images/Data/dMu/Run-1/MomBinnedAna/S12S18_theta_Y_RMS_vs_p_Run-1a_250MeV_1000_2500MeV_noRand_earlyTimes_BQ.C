void S12S18_theta_Y_RMS_vs_p_Run-1a_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:32:34 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.1119,2.512853,2704.645,25.47454);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01109 = new TH1F("Graph_Graph01109","S12S18",100,223.2124,3015.26);
   Graph_Graph01109->SetMinimum(4.809023);
   Graph_Graph01109->SetMaximum(23.17837);
