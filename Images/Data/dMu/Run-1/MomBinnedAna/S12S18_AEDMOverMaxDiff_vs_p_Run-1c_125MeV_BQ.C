...
//=========  (Fri Mar 25 03:48:47 2022) by ROOT version 6.24/06
   ...
   c->Range(462.6813,-0.002668214,3034.593,0.02655167);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01181 = new TH1F("Graph_Graph01181","S12S18",100,114.7168,3140.495);
   Graph_Graph01181->SetMinimum(0.0002537744);
   Graph_Graph01181->SetMaximum(0.02362968);
