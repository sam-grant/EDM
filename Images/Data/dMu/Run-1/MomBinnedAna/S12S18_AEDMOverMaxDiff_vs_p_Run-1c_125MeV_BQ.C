...
//=========  (Wed Dec  1 15:14:40 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(496.7271,-0.0006333103,2728.307,0.01188568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01049 = new TH1F("Graph_Graph01049","S12S18",100,114.711,3140.582);
   Graph_Graph01049->SetMinimum(0.0006185887);
   Graph_Graph01049->SetMaximum(0.01063378);
