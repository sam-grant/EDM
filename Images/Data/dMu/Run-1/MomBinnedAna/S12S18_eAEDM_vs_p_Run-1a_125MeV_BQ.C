...
//=========  (Tue Nov 23 11:24:32 2021) by ROOT version 6.24/04
   ...
   c->Range(530.2994,-0.2161412,2723.26,2.108419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01044->SetMinimum(0.01631485);
   Graph_Graph01044->SetMaximum(1.875963);
   ...
   Graph_Graph01044->GetXaxis()->SetRange(22,79);
