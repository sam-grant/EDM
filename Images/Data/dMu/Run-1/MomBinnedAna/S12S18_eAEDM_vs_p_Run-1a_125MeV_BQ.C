...
//=========  (Wed Dec  1 15:22:25 2021) by ROOT version 6.24/04
   ...
   c->Range(530.2994,0.01205532,2723.26,0.05482081);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12S18",100,114.3931,3139.166);
   Graph_Graph01047->SetMinimum(0.01633187);
   Graph_Graph01047->SetMaximum(0.05054426);
   ...
   Graph_Graph01047->GetXaxis()->SetRange(22,79);
