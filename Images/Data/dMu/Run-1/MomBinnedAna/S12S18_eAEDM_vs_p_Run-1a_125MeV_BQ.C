...
//=========  (Fri Dec 17 14:44:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(496.2707,-0.02694582,3029.518,0.3878072);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01179 = new TH1F("Graph_Graph01179","S12S18",100,114.3931,3139.166);
   Graph_Graph01179->SetMinimum(0.01452948);
   Graph_Graph01179->SetMaximum(0.3463319);
