...
//=========  (Mon Nov 22 17:30:20 2021) by ROOT version 6.24/04
   ...
   c->Range(496.6994,10.17757,2730.075,22.68945);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","S12",100,114.3759,3142.681);
   Graph_Graph01022->SetMinimum(11.42876);
   Graph_Graph01022->SetMaximum(21.43827);
