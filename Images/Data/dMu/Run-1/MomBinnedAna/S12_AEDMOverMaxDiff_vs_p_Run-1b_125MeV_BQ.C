...
//=========  (Wed Dec  1 16:15:30 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7114,-0.001984015,2730.075,0.008401035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S12",100,114.3897,3142.68);
   Graph_Graph01027->SetMinimum(-0.0009455099);
   Graph_Graph01027->SetMaximum(0.00736253);
