void S12_thetaYMaxDiff_vs_p_Run-1a_125MeV_BQ_test_noCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Dec  3 13:52:05 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(485.1431,4.8052,3016.181,199.9707);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.5207669,
   0.5207669};
   TGraphErrors *gre = new TGraphErrors(21,Graph0_fx1026,Graph0_fy1026,Graph0_fex1026,Graph0_fey1026);
   gre->SetName("Graph0");
   gre->SetTitle("S12");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S12",100,130.7977,3023.413);
   Graph_Graph01026->SetMinimum(24.32175);
   Graph_Graph01026->SetMaximum(180.4542);
   ...
   Graph_Graph01026->GetXaxis()->SetRange(22,91);
