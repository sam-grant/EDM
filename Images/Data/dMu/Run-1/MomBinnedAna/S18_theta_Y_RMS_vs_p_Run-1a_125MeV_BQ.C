...
//=========  (Thu Dec  9 22:15:41 2021) by ROOT version 6.24/04
   ...
   c->Range(496.0523,0.7602567,3028.099,32.51893);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01120 = new TH1F("Graph_Graph01120","S18",100,114.3557,3137.695);
   Graph_Graph01120->SetMinimum(3.936124);
   Graph_Graph01120->SetMaximum(29.34306);
