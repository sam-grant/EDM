void S18_N_vs_p_Run-1a_125MeV_BQ_test()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 17 16:50:51 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522,-74759.81,2727,673063.2);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S18",100,49.5,3199.5);
   Graph_Graph01033->SetMinimum(22.5);
   Graph_Graph01033->SetMaximum(598280.9);
