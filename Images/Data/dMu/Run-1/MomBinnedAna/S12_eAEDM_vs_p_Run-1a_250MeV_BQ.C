void S12_eAEDM_vs_p_Run-1a_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:19:31 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(470.8546,0.000536764,3018.168,0.1393362);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12",100,223.1022,3014.678);
   Graph_Graph01047->SetMinimum(0.01441671);
   Graph_Graph01047->SetMaximum(0.1254563);
