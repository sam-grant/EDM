void S12_Ag2_vs_p_Run-1a_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 19:08:41 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(470.8546,-0.03900373,3018.168,0.08695986);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01041 = new TH1F("Graph_Graph01041","S12",100,223.1022,3014.678);
   Graph_Graph01041->SetMinimum(-0.02640737);
   Graph_Graph01041->SetMaximum(0.0743635);
