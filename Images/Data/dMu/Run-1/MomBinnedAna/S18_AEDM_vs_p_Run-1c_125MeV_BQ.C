...
//=========  (Fri Mar 25 03:48:40 2022) by ROOT version 6.24/06
   ...
   c->Range(496.5135,-0.03643814,3027.918,0.3568539);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01117 = new TH1F("Graph_Graph01117","S18",100,114.9137,3137.486);
   Graph_Graph01117->SetMinimum(0.002891067);
   Graph_Graph01117->SetMaximum(0.3175247);
