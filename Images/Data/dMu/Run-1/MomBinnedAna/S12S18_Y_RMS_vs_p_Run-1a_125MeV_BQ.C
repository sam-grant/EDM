...
//=========  (Fri Dec 17 14:44:27 2021) by ROOT version 6.24/04
   ...
   c->Range(496.2707,8.55972,3029.518,23.32293);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01176 = new TH1F("Graph_Graph01176","S12S18",100,114.3931,3139.166);
   Graph_Graph01176->SetMinimum(10.03604);
   Graph_Graph01176->SetMaximum(21.84661);
