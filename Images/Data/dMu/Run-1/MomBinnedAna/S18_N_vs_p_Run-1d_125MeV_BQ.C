...
//=========  (Wed Dec  1 15:15:23 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8077,-60573.09,2722.058,2622537);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S18",100,115.2258,3137.64);
   Graph_Graph01035->SetMinimum(207737.9);
   Graph_Graph01035->SetMaximum(2354226);
