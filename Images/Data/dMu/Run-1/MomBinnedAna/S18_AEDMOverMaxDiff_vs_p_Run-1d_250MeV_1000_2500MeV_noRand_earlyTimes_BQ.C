void S18_AEDMOverMaxDiff_vs_p_Run-1d_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:33:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.6017,-0.0003135541,2704.746,0.009714664);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01082 = new TH1F("Graph_Graph01082","S18",100,223.816,3015.298);
   Graph_Graph01082->SetMinimum(0.0006892678);
   Graph_Graph01082->SetMaximum(0.008711842);
