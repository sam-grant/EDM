...
//=========  (Sun Dec  5 23:46:41 2021) by ROOT version 6.24/04
   ...
   c->Range(462.631,0.06186644,3036.691,3.200907);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","S12",100,114.3759,3142.681);
   Graph_Graph01020->SetMinimum(0.3757705);
   Graph_Graph01020->SetMaximum(2.887003);
   ...
   Graph_Graph01020->GetXaxis()->SetRange(21,88);
