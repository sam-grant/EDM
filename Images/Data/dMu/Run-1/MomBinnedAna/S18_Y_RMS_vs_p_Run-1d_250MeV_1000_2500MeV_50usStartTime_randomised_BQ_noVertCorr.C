void S18_Y_RMS_vs_p_Run-1d_250MeV_1000_2500MeV_50usStartTime_randomised_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 15:15:39 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.3487,9.139226,2703.496,15.56184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S18",100,223.8545,3013.888);
   Graph_Graph01077->SetMinimum(9.781487);
   Graph_Graph01077->SetMaximum(14.91958);
