void S12_AEDM_vs_p_Run-1b_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:32:44 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(784.919,-0.03029117,2703.906,0.0719591);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12",100,223.1793,3014.433);
   Graph_Graph01040->SetMinimum(-0.02006614);
   Graph_Graph01040->SetMaximum(0.06173407);
