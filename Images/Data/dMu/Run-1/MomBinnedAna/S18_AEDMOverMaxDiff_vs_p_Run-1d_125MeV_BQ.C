...
//=========  (Fri Mar 25 10:51:31 2022) by ROOT version 6.24/06
   ...
   c->Range(496.8372,-0.0282765,3028.15,0.2546124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01126 = new TH1F("Graph_Graph01126","S18",100,115.2511,3137.715);
   Graph_Graph01126->SetMinimum(1.239158e-05);
   Graph_Graph01126->SetMaximum(0.2263235);
