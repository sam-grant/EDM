void S18_Momentum_Y_RMS_vs_p_Run-1c_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun May 29 20:30:00 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2984,10.79638,2704.375,25.84108);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01078 = new TH1F("Graph_Graph01078","S18",100,223.5324,3014.916);
   Graph_Graph01078->SetMinimum(12.30085);
   Graph_Graph01078->SetMaximum(24.33661);
