void S12S18_thetaYMaxDiff_vs_p_Run-1a_250MeV_BQ_noVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 19:08:49 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.0388,22.53399,3018.072,241.9724);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01114->SetMinimum(44.47784);
   Graph_Graph01114->SetMaximum(220.0286);
