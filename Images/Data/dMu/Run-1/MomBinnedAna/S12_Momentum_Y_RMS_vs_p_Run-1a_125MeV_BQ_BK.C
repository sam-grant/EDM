void S12_Momentum_Y_RMS_vs_p_Run-1a_125MeV_BQ_BK()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 17 22:14:39 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522,9.913215,2727,22.704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01022->SetMinimum(11.19229);
   Graph_Graph01022->SetMaximum(21.42492);
