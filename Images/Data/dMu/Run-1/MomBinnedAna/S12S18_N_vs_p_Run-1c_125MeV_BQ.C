...
//=========  (Fri Dec 17 14:46:40 2021) by ROOT version 6.24/04
   ...
   c->Range(462.7061,-336785.2,3034.515,3110774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01178 = new TH1F("Graph_Graph01178","S12S18",100,114.7555,3140.413);
   Graph_Graph01178->SetMinimum(7970.679);
   Graph_Graph01178->SetMaximum(2766018);
