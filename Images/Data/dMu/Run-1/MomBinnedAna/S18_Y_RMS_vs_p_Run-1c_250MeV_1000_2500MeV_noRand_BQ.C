void S18_Y_RMS_vs_p_Run-1c_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 16:19:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(791.6217,9.297065,2691.139,16.62708);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01077 = new TH1F("Graph_Graph01077","S18",100,221.7665,3035.866);
   Graph_Graph01077->SetMinimum(10.03007);
   Graph_Graph01077->SetMaximum(15.89408);
   ...
   Graph_Graph01077->GetXaxis()->SetRange(28,81);
