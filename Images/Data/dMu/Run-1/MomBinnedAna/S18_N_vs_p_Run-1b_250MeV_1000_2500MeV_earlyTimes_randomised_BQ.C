void S18_N_vs_p_Run-1b_250MeV_1000_2500MeV_earlyTimes_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:31:38 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.189,-38253.55,2704.825,863932.4);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01079 = new TH1F("Graph_Graph01079","S18",100,223.2592,3015.457);
   Graph_Graph01079->SetMinimum(51965.05);
   Graph_Graph01079->SetMaximum(773713.8);
