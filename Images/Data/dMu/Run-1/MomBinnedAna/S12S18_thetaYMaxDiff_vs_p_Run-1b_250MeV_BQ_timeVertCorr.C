void S12S18_thetaYMaxDiff_vs_p_Run-1b_250MeV_BQ_timeVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 21:30:04 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(470.8201,15.59068,3017.493,242.2984);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01114 = new TH1F("Graph_Graph01114","S12S18",100,223.13,3014.004);
   Graph_Graph01114->SetMinimum(38.26145);
   Graph_Graph01114->SetMaximum(219.6276);
