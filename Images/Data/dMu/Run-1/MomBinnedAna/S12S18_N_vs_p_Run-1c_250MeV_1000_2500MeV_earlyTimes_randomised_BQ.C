void S12S18_N_vs_p_Run-1c_250MeV_1000_2500MeV_earlyTimes_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:31:59 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2687,-111363,2704.427,2679697);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01112 = new TH1F("Graph_Graph01112","S12S18",100,223.4789,3014.981);
   Graph_Graph01112->SetMinimum(167742.9);
   Graph_Graph01112->SetMaximum(2400591);
