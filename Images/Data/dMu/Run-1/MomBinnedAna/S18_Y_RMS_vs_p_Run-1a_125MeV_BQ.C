...
//=========  (Fri Dec 17 14:44:18 2021) by ROOT version 6.24/04
   ...
   c->Range(496.0523,8.573099,3028.099,23.08232);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01121 = new TH1F("Graph_Graph01121","S18",100,114.3557,3137.695);
   Graph_Graph01121->SetMinimum(10.02402);
   Graph_Graph01121->SetMaximum(21.6314);
