void S12S18_eAEDM_vs_p_Run-1c_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:33:10 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2535,0.00930503,2704.441,0.02794682);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01113 = new TH1F("Graph_Graph01113","S12S18",100,223.455,3015);
   Graph_Graph01113->SetMinimum(0.01116921);
   Graph_Graph01113->SetMaximum(0.02608264);
