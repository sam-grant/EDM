...
#endif
void S12S18_thetaYMaxDiff_vs_p_Run-1d_250MeV_1000_2500MeV_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Oct  7 11:56:35 2022) by ROOT version 6.26/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.1581,36.82419,2703.793,240.4035);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01114 = new TH1F("Graph_Graph01114","S12S18",100,223.5213,3014.263);
   Graph_Graph01114->SetMinimum(57.18212);
   Graph_Graph01114->SetMaximum(220.0455);
