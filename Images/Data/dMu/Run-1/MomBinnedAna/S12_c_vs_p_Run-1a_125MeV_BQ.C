...
//=========  (Thu Dec  9 22:15:36 2021) by ROOT version 6.24/04
   ...
   c->Range(462.3259,-0.3684789,3036.37,3.218779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01061 = new TH1F("Graph_Graph01061","S12",100,114.0729,3142.36);
   Graph_Graph01061->SetMinimum(-0.009753126);
   Graph_Graph01061->SetMaximum(2.860053);
