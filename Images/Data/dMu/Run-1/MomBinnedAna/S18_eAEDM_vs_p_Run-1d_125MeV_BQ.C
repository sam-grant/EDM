...
//=========  (Thu Nov 18 10:59:22 2021) by ROOT version 6.24/04
   ...
   c->Range(530.8015,-0.1535876,2721.93,1.505521);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S18",100,115.2427,3137.489);
   Graph_Graph01034->SetMinimum(0.01232334);
   Graph_Graph01034->SetMaximum(1.339611);
