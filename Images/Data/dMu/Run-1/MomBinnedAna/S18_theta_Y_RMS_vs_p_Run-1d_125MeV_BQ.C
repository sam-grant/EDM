...
//=========  (Fri Mar 25 10:51:31 2022) by ROOT version 6.24/06
   ...
   c->Range(496.8372,0.8498551,3028.15,32.45806);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01120 = new TH1F("Graph_Graph01120","S18",100,115.2511,3137.715);
   Graph_Graph01120->SetMinimum(4.010675);
   Graph_Graph01120->SetMaximum(29.29724);
