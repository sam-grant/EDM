...
//=========  (Fri Dec  3 17:55:07 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","S18",100,115.2378,3138.654);
   Graph_Graph01036->SetMinimum(0.01797822);
   Graph_Graph01036->SetMaximum(1.05619);
   ...
   Graph_Graph01036->GetXaxis()->SetRange(21,88);
