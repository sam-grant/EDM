void S12_thetaYMaxDiff_vs_p_Run-1a_125MeV_BQ_BK()
{
//=========Macro generated from canvas: c/c
//=========  (Wed Nov 17 22:14:39 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(522,-26.78945,2727,387.4927);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S12",100,49.5,3199.5);
   Graph_Graph01025->SetMinimum(14.63877);
   Graph_Graph01025->SetMaximum(346.0645);
   ...
   Graph_Graph01025->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad] / 125 MeV");
