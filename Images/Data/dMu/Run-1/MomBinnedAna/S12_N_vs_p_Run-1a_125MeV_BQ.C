...
//=========  (Thu Dec  9 22:15:36 2021) by ROOT version 6.24/04
   ...
   c->Range(462.3259,-87213.93,3036.37,809500);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S12",100,114.0729,3142.36);
   Graph_Graph01068->SetMinimum(2457.474);
   Graph_Graph01068->SetMaximum(719828.6);
