...
//=========  (Fri Mar 25 03:48:34 2022) by ROOT version 6.24/06
   ...
   c->Range(466.5321,1.47101,3003.766,243.3448);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01070 = new TH1F("Graph_Graph01070","S12",100,114.349,3143.882);
   Graph_Graph01070->SetMinimum(25.65839);
   Graph_Graph01070->SetMaximum(219.1574);
