...
//=========  (Fri Dec 17 14:45:26 2021) by ROOT version 6.24/04
   ...
   c->Range(462.9306,-115651.7,3032.834,1066512);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01123 = new TH1F("Graph_Graph01123","S18",100,115.2378,3138.654);
   Graph_Graph01123->SetMinimum(2564.656);
   Graph_Graph01123->SetMaximum(948295.7);
   ...
   Graph_Graph01123->GetXaxis()->SetRange(21,88);
