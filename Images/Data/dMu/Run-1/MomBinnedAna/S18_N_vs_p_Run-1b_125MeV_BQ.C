...
//=========  (Fri Mar 25 03:47:41 2022) by ROOT version 6.24/06
   ...
   c->Range(462.9538,-117343.3,3032.833,1082067);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01123 = new TH1F("Graph_Graph01123","S18",100,115.2643,3138.651);
   Graph_Graph01123->SetMinimum(2597.698);
   Graph_Graph01123->SetMaximum(962125.8);
