void S18_Ag2_vs_p_Run-1d_250MeV_BQ_timeVertCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Mon Mar 28 22:27:19 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.535,-0.03801589,3017.925,0.1216283);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01074->SetMinimum(-0.02205146);
   Graph_Graph01074->SetMaximum(0.1056639);
