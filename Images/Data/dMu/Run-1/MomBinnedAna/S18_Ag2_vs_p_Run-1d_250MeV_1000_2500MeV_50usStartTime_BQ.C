void S18_Ag2_vs_p_Run-1d_250MeV_1000_2500MeV_50usStartTime_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri May 13 17:52:25 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.3487,-0.03664876,2703.496,0.04356618);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01074->SetMinimum(-0.02862726);
   Graph_Graph01074->SetMaximum(0.03554469);
