...
//=========  (Fri Dec 17 14:46:29 2021) by ROOT version 6.24/04
   ...
   c->Range(496.5205,-164184.8,3027.918,1510744);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01123 = new TH1F("Graph_Graph01123","S18",100,114.9218,3137.486);
   Graph_Graph01123->SetMinimum(3308.065);
   Graph_Graph01123->SetMaximum(1343251);
