...
//=========  (Fri Dec 17 14:46:22 2021) by ROOT version 6.24/04
   ...
   c->Range(466.5837,-0.04227226,3003.847,0.5236508);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.3965,3143.964);
   Graph_Graph01069->SetMinimum(0.01432005);
   Graph_Graph01069->SetMaximum(0.4670585);
   ...
   Graph_Graph01069->GetXaxis()->SetRange(21,87);
