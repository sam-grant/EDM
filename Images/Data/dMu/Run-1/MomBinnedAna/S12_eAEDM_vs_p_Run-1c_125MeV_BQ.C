...
//=========  (Sun Dec  5 23:47:14 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S12",100,114.3965,3143.964);
   Graph_Graph01025->SetMinimum(0.01432005);
   Graph_Graph01025->SetMaximum(0.4670585);
   ...
   Graph_Graph01025->GetXaxis()->SetRange(21,87);
