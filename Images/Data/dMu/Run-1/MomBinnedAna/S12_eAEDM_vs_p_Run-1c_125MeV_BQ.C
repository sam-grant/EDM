...
//=========  (Fri Mar 25 03:48:34 2022) by ROOT version 6.24/06
   ...
   c->Range(466.5321,-0.02805805,3003.766,0.3922961);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.349,3143.882);
   Graph_Graph01069->SetMinimum(0.01397737);
   Graph_Graph01069->SetMaximum(0.3502607);
