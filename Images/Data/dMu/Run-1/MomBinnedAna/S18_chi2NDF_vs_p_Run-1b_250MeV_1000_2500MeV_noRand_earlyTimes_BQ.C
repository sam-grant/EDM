void S18_chi2NDF_vs_p_Run-1b_250MeV_1000_2500MeV_noRand_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:32:48 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.1745,0.3110772,2704.816,2.805535);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01075 = new TH1F("Graph_Graph01075","S18",100,223.2431,3015.449);
   Graph_Graph01075->SetMinimum(0.560523);
   Graph_Graph01075->SetMaximum(2.556089);
