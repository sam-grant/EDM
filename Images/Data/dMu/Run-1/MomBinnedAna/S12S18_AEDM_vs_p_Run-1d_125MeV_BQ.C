...
//=========  (Thu Nov 18 10:59:23 2021) by ROOT version 6.24/04
   ...
   c->Range(496.872,-0.7940657,2726.427,1.850722);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S12S18",100,115.2023,3138.328);
   Graph_Graph01038->SetMinimum(-0.5295869);
   Graph_Graph01038->SetMaximum(1.586243);
