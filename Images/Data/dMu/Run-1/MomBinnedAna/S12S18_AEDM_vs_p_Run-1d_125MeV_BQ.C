...
//=========  (Sun Dec  5 23:47:48 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8618,0.007793924,3032.519,0.1073999);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01040 = new TH1F("Graph_Graph01040","S12S18",100,115.2023,3138.328);
   Graph_Graph01040->SetMinimum(0.01775452);
   Graph_Graph01040->SetMaximum(0.09743929);
