...
//=========  (Fri Mar 25 03:48:46 2022) by ROOT version 6.24/06
   ...
   c->Range(462.6813,0.2295179,3034.593,2.780531);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01174 = new TH1F("Graph_Graph01174","S12S18",100,114.7168,3140.495);
   Graph_Graph01174->SetMinimum(0.4846193);
   Graph_Graph01174->SetMaximum(2.52543);
