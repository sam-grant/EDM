...
//=========  (Wed Dec  1 15:14:39 2021) by ROOT version 6.24/04
   ...
   c->Range(496.7271,0.3315362,2728.307,2.511067);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12S18",100,114.711,3140.582);
   Graph_Graph01042->SetMinimum(0.5494892);
   Graph_Graph01042->SetMaximum(2.293114);
