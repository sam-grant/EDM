void S12S18_chi2NDF_vs_p_Run-1c_125MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Dec  5 23:47:14 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(462.7061,0.2387151,3034.515,2.717798);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01042 = new TH1F("Graph_Graph01042","S12S18",100,114.7555,3140.413);
   Graph_Graph01042->SetMinimum(0.4866235);
   Graph_Graph01042->SetMaximum(2.46989);
   ...
   Graph_Graph01042->GetXaxis()->SetRange(21,88);
