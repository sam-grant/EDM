void S12S18_theta_Y_RMS_vs_p_Run-1d_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Mar 29 11:54:46 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.2007,0.55508,3017.767,32.7497);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01109->SetMinimum(3.774542);
   Graph_Graph01109->SetMaximum(29.53023);
