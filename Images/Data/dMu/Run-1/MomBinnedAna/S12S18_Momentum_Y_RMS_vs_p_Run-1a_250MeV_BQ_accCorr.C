void S12S18_Momentum_Y_RMS_vs_p_Run-1a_250MeV_BQ_accCorr()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Mar 25 11:39:35 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(471.0388,8.923613,3018.072,26.11117);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01111 = new TH1F("Graph_Graph01111","S12S18",100,223.3137,3014.583);
   Graph_Graph01111->SetMinimum(10.64237);
   Graph_Graph01111->SetMaximum(24.39241);
   ...
   Graph_Graph01111->GetXaxis()->SetRange(19,91);
