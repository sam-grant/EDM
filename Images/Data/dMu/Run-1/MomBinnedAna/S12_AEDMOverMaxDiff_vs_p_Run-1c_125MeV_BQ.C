...
//=========  (Sun Dec  5 23:47:14 2021) by ROOT version 6.24/04
   ...
   c->Range(466.5837,-0.003099738,3003.847,0.02765969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S12",100,114.3965,3143.964);
   Graph_Graph01027->SetMinimum(-2.379544e-05);
   Graph_Graph01027->SetMaximum(0.02458374);
   ...
   Graph_Graph01027->GetXaxis()->SetRange(21,87);
