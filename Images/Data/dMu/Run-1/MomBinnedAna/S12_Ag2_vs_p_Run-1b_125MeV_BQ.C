...
//=========  (Fri Mar 25 03:47:35 2022) by ROOT version 6.24/06
   ...
   c->Range(462.6562,-0.234841,3036.689,1.887009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01063 = new TH1F("Graph_Graph01063","S12",100,114.4047,3142.679);
   Graph_Graph01063->SetMinimum(-0.02265596);
   Graph_Graph01063->SetMaximum(1.674824);
