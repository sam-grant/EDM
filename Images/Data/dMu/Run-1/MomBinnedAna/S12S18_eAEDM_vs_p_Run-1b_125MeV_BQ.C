...
//=========  (Mon Nov 22 17:30:21 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(496.8865,-0.1982875,2728.021,1.92406);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01044->SetMinimum(0.0139472);
   Graph_Graph01044->SetMaximum(1.711825);
