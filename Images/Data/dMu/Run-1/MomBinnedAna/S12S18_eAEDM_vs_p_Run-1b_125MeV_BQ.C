...
//=========  (Fri Dec  3 17:55:08 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8522,-0.01963735,3034.329,0.3008296);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01047 = new TH1F("Graph_Graph01047","S12S18",100,114.9465,3140.214);
   Graph_Graph01047->SetMinimum(0.01240935);
   Graph_Graph01047->SetMaximum(0.2687829);
