...
//=========  (Fri Mar 25 10:51:36 2022) by ROOT version 6.24/06
   ...
   c->Range(462.8762,-0.4015258,3032.589,0.8578149);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01171 = new TH1F("Graph_Graph01171","S12S18",100,115.2092,3138.4);
   Graph_Graph01171->SetMinimum(-0.2755917);
   Graph_Graph01171->SetMaximum(0.7318808);
