...
//=========  (Fri Mar 25 03:48:34 2022) by ROOT version 6.24/06
   ...
   c->Range(466.5321,-181231.2,3003.766,1680290);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01068 = new TH1F("Graph_Graph01068","S12",100,114.349,3143.882);
   Graph_Graph01068->SetMinimum(4920.97);
   Graph_Graph01068->SetMaximum(1494138);
