void S18_eAEDM_vs_p_Run-1a_250MeV_1000_2500MeV_earlyTimes_randomised_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Sun Jun 12 11:31:18 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2298,0.0194354,2705.153,0.0570046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01080 = new TH1F("Graph_Graph01080","S18",100,223.216,3015.831);
   Graph_Graph01080->SetMinimum(0.02319232);
   Graph_Graph01080->SetMaximum(0.05324768);
