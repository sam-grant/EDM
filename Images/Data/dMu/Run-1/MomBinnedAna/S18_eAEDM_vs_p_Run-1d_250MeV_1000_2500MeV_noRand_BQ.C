void S18_eAEDM_vs_p_Run-1d_250MeV_1000_2500MeV_noRand_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Fri Jun 10 16:20:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(787.921,0.005237907,2720.357,0.01523027);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01080 = new TH1F("Graph_Graph01080","S18",100,222.2444,3033.06);
   Graph_Graph01080->SetMinimum(0.006237144);
   Graph_Graph01080->SetMaximum(0.01423104);
