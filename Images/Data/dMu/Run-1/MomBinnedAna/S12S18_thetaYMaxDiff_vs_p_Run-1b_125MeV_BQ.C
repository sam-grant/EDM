...
//=========  (Thu Dec  9 22:16:37 2021) by ROOT version 6.24/04
   ...
   c->Range(462.8522,7.917229,3034.329,243.6066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01180 = new TH1F("Graph_Graph01180","S12S18",100,114.9465,3140.214);
   Graph_Graph01180->SetMinimum(31.48617);
   Graph_Graph01180->SetMaximum(220.0377);
