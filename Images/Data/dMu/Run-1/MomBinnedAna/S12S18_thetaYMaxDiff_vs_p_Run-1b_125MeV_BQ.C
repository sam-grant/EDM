...
//=========  (Mon Nov 22 17:30:21 2021) by ROOT version 6.24/04
   ...
   c->Range(496.8865,-25.34212,2728.021,413.062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S12S18",100,114.9465,3140.214);
   Graph_Graph01045->SetMinimum(18.49829);
   Graph_Graph01045->SetMaximum(369.2216);
