void S12S18_thetaYMaxDiff_vs_p_Run-1c_250MeV_1000_2500MeV_earlyTimes_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu May 12 13:19:11 2022) by ROOT version 6.24/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(785.2432,35.56912,2704.44,239.3198);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01114 = new TH1F("Graph_Graph01114","S12S18",100,223.442,3015.001);
   Graph_Graph01114->SetMinimum(55.94418);
