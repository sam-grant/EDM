...
//=========  (Fri Mar 25 03:46:38 2022) by ROOT version 6.24/06
   ...
   c->Range(462.3119,-0.1501077,3036.371,1.550421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.0569,3142.362);
   Graph_Graph01069->SetMinimum(0.01994521);
   Graph_Graph01069->SetMaximum(1.380368);
