...
//=========  (Thu Dec  9 22:15:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(462.3259,-0.03765723,3036.37,0.5397314);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01069 = new TH1F("Graph_Graph01069","S12",100,114.0729,3142.36);
   Graph_Graph01069->SetMinimum(0.02008164);
   Graph_Graph01069->SetMaximum(0.4819925);
