...
//=========  (Sun Dec  5 17:23:37 2021) by ROOT version 6.24/04
   ...
   c->Range(30.74998,-70.41617,3218.25,100.4884);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01024->SetMinimum(-53.32572);
   Graph_Graph01024->SetMaximum(83.3979);
   ...
   Graph_Graph11025->SetMinimum(-21.82732);
   Graph_Graph11025->SetMaximum(74.76792);
   ...
   Graph_Graph21026->SetMinimum(-0.7730357);
   Graph_Graph21026->SetMaximum(2.975095);
