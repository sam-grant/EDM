...
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   ...
   c->Range(-118.7188,-1158411,3360.969,1.083138e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S12S18",100,0,3275);
   Graph_Graph01034->SetMinimum(40568.4);
   Graph_Graph01034->SetMaximum(9632404);
   ...
   Graph_Graph01034->GetYaxis()->SetTitle("Positrons");
