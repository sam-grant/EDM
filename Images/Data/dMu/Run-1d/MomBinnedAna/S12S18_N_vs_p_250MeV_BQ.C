...
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01043 = new TH1F("Graph_Graph01043","S12S18",100,125,3125);
   Graph_Graph01043->SetMinimum(40131.9);
   Graph_Graph01043->SetMaximum(9554335);
   ...
   Graph_Graph01043->GetYaxis()->SetTitle("Positrons");
