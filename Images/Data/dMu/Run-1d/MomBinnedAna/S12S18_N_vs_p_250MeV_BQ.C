void S12S18_N_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 19 15:52:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-1149144,2750,1.074361e+07);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S12S18",100,125,3125);
   Graph_Graph01037->SetMinimum(40131.9);
   Graph_Graph01037->SetMaximum(9554335);
   ...
   Graph_Graph01037->GetXaxis()->SetRange(21,80);
   ...
   Graph_Graph01037->GetYaxis()->SetTitle("Positrons");
