void S12_eA_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.006223685,3360.969,0.1386675);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01017 = new TH1F("Graph_Graph01017","S12",100,0,3275);
   Graph_Graph01017->SetMinimum(0.008265432);
   Graph_Graph01017->SetMaximum(0.1241784);
   ...
   Graph_Graph01017->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01017->GetYaxis()->SetTitle("#deltaA_{EDM}");
