...
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   ...
   c->Range(-118.7188,12.04687,3360.969,13.65988);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01014 = new TH1F("Graph_Graph01014","S12",100,0,3275);
   Graph_Graph01014->SetMinimum(12.20817);
   Graph_Graph01014->SetMaximum(13.49858);
   ...
   Graph_Graph01014->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01014->GetYaxis()->SetTitle("#sigma_{y} [mm]");
