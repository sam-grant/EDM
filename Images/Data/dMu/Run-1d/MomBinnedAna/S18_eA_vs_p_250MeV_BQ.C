void S18_eA_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.005382569,3360.969,0.1363581);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S18",100,0,3275);
   Graph_Graph01026->SetMinimum(0.008791495);
   Graph_Graph01026->SetMaximum(0.122184);
