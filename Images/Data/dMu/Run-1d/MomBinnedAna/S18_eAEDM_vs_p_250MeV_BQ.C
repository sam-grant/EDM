void S18_eAEDM_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.005472154,2750,0.1378443);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01034 = new TH1F("Graph_Graph01034","S18",100,125,3125);
   Graph_Graph01034->SetMinimum(0.008859498);
   Graph_Graph01034->SetMaximum(0.1235127);
   ...
   Graph_Graph01034->GetYaxis()->SetTitle("#deltaA_{EDM}");
