...
//=========  (Tue Oct 19 15:52:24 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01028 = new TH1F("Graph_Graph01028","S18",100,125,3125);
   Graph_Graph01028->SetMinimum(0.008859498);
   Graph_Graph01028->SetMaximum(0.1235127);
   ...
   Graph_Graph01028->GetYaxis()->SetTitle("#deltaA_{EDM}");
