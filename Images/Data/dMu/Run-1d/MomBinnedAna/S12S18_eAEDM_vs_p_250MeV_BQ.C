...
//=========  (Tue Oct 19 15:52:25 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.004161464,2750,0.09817058);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01038 = new TH1F("Graph_Graph01038","S12S18",100,125,3125);
   Graph_Graph01038->SetMinimum(0.006071741);
   Graph_Graph01038->SetMaximum(0.08793738);
   ...
   Graph_Graph01038->GetYaxis()->SetTitle("#deltaA_{EDM}");
