...
//=========  (Thu Nov  4 12:08:31 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-601956.7,2750,5654391);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01023 = new TH1F("Graph_Graph01023","S12",100,125,3125);
   Graph_Graph01023->SetMinimum(23678.1);
   Graph_Graph01023->SetMaximum(5028756);
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("Positrons");
