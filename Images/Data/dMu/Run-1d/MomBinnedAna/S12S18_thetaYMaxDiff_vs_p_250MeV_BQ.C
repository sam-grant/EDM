...
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   ...
   c->Range(-118.7188,-27.06239,3360.969,413.0149);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01036 = new TH1F("Graph_Graph01036","S12S18",100,0,3275);
   Graph_Graph01036->SetMinimum(16.94534);
   Graph_Graph01036->SetMaximum(369.0072);
   ...
   Graph_Graph01036->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
