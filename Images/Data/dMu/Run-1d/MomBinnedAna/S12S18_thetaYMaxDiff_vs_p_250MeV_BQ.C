...
//=========  (Tue Oct 19 15:52:25 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-27.06239,2750,413.0149);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(16.94534);
   Graph_Graph01039->SetMaximum(369.0072);
