...
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01045 = new TH1F("Graph_Graph01045","S12S18",100,125,3125);
   Graph_Graph01045->SetMinimum(16.94534);
   Graph_Graph01045->SetMaximum(369.0072);
   ...
   Graph_Graph01045->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01045->GetXaxis()->SetRange(21,80);
   ...
   Graph_Graph01045->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
