...
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01046 = new TH1F("Graph_Graph01046","S12S18",100,125,3125);
   Graph_Graph01046->SetMinimum(-0.0002560593);
   Graph_Graph01046->SetMaximum(0.001463735);
   ...
   Graph_Graph01046->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   ...
   Graph_Graph01046->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX}");
