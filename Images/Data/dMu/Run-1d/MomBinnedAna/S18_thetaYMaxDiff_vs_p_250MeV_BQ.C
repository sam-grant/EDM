void S18_thetaYMaxDiff_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-32.42285,2750,414.087);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S18",100,125,3125);
   Graph_Graph01035->SetMinimum(12.22814);
   Graph_Graph01035->SetMaximum(369.436);
