...
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   ...
   c->Range(-118.7188,-32.42285,3360.969,414.087);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01027 = new TH1F("Graph_Graph01027","S18",100,0,3275);
   Graph_Graph01027->SetMinimum(12.22814);
   Graph_Graph01027->SetMaximum(369.436);
   ...
   Graph_Graph01027->GetXaxis()->SetRange(8,92);
