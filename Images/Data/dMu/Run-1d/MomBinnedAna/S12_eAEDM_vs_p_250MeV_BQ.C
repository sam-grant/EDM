...
//=========  (Thu Nov  4 12:08:31 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.006262949,2750,0.1397368);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01024 = new TH1F("Graph_Graph01024","S12",100,125,3125);
   Graph_Graph01024->SetMinimum(0.008337032);
   Graph_Graph01024->SetMaximum(0.1251369);
   ...
   Graph_Graph01024->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125 MeV");
   ...
   Graph_Graph01024->GetYaxis()->SetTitle("#deltaA_{EDM}");
