...
//=========  (Thu Nov  4 12:08:32 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.08646863,2750,0.2237822);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(-0.05544355);
   Graph_Graph01039->SetMaximum(0.1927571);
   ...
   Graph_Graph01039->GetYaxis()->SetTitle("A_{g#minus2} [mrad]");
