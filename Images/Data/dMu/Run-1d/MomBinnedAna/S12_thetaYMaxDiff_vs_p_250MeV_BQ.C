void S12_thetaYMaxDiff_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:26:12 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-23.31008,3360.969,394.2533);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01018 = new TH1F("Graph_Graph01018","S12",100,0,3275);
   Graph_Graph01018->SetMinimum(18.44627);
   Graph_Graph01018->SetMaximum(352.497);
   ...
   Graph_Graph01018->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01018->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01018->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
