...
//=========  (Thu Nov  4 12:08:31 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01022 = new TH1F("Graph_Graph01022","S12",100,125,3125);
   Graph_Graph01022->SetMinimum(13.20011);
   Graph_Graph01022->SetMaximum(21.11367);
   ...
   Graph_Graph01022->GetYaxis()->SetTitle("#sigma_{p_{y}} [MeV]");
