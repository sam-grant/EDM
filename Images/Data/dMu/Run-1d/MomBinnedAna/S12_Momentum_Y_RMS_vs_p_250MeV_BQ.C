void S12_Momentum_Y_RMS_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 19 15:52:24 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,12.21091,2750,22.10287);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","S12",100,125,3125);
   Graph_Graph01016->SetMinimum(13.20011);
   Graph_Graph01016->SetMaximum(21.11367);
   ...
   Graph_Graph01016->GetYaxis()->SetTitle("#sigma_{p_{y}} [MeV]");
