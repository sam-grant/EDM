...
//=========  (Tue Oct 26 00:47:48 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-1.683699,2750,1.742114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1007->SetMinimum(-1.341117);
   Graph_Graph1007->SetMaximum(1.399533);
   ...
   pol01008->SetParameter(0,-0.06362626);
   pol01008->SetParError(0,0.1029195);
