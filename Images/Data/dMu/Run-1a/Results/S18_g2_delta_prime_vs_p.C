...
//=========  (Wed Nov  3 10:58:27 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-2.517778,2843.25,2.693277);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1009->SetMaximum(2.172172);
   ...
   pol01010->SetChisquare(15.19163);
   pol01010->SetNDF(13);
   ...
   pol01010->SetParameter(0,0.07361051);
   pol01010->SetParError(0,0.1069429);
