...
//=========  (Wed Nov  3 10:58:27 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(405.75,-1.746307,2843.25,1.775127);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1011->SetMinimum(-1.394164);
   Graph_Graph1011->SetMaximum(1.422984);
   ...
   pol01012->SetChisquare(17.29775);
   pol01012->SetNDF(13);
   ...
   pol01012->SetParameter(0,-0.007171607);
   pol01012->SetParError(0,0.07402372);
   ...
   entry=leg->AddEntry("pol0","#LT#delta'#GT = -0.0072
#pm0.07
 mrad","lpf");
