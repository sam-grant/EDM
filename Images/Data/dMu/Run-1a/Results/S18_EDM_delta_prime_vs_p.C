...
//=========  (Wed Nov  3 10:58:26 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-1.902845,2843.25,2.894272);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-1.423133);
   Graph_Graph1003->SetMaximum(2.414561);
   ...
   pol01004->SetChisquare(14.20452);
   pol01004->SetNDF(13);
   ...
   pol01004->SetParameter(0,0.2272182);
   pol01004->SetParError(0,0.1068636);
