...
//=========  (Wed Nov  3 10:58:26 2021) by ROOT version 6.24/04
   ...
   c->Range(405.75,-0.922465,2843.25,4.061256);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1001->SetMinimum(-0.4240928);
   Graph_Graph1001->SetMaximum(3.562884);
   ...
   pol01002->SetChisquare(10.35727);
   pol01002->SetNDF(13);
   ...
   pol01002->SetParameter(0,0.5790399);
