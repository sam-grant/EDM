...
//=========  (Wed Nov  3 10:58:26 2021) by ROOT version 6.24/04
   ...
   TH1D *h__2 = new TH1D("h__2","S18_",20,0.006761535,0.4225515);
   h__2->SetBinContent(9,2);
   h__2->SetBinContent(10,141);
   h__2->SetBinContent(11,650);
   h__2->SetBinContent(12,193);
