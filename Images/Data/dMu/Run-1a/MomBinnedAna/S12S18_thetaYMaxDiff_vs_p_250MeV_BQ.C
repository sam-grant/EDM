void S12S18_thetaYMaxDiff_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 12 10:58:16 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-18.48567,2750,421.5916);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","S12S18",100,125,3125);
   Graph_Graph01039->SetMinimum(25.52206);
   Graph_Graph01039->SetMaximum(377.5839);
   ...
   Graph_Graph01039->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01039->GetXaxis()->SetRange(21,80);
   ...
   Graph_Graph01039->GetYaxis()->SetTitle("(#Delta#theta_{y})_{MAX} [mrad]");
