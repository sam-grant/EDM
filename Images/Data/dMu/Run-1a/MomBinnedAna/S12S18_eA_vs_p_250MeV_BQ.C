void S12S18_eA_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:45:36 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.008365369,3360.969,0.1921734);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01035 = new TH1F("Graph_Graph01035","S12S18",100,0,3275);
   Graph_Graph01035->SetMinimum(0.01168851);
   Graph_Graph01035->SetMaximum(0.1721195);
   ...
   Graph_Graph01035->GetYaxis()->SetTitle("#deltaA_{EDM}");
