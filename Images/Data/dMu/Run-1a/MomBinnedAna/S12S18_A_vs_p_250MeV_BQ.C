void S12S18_A_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:45:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.2611828,3360.969,0.211776);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01030 = new TH1F("Graph_Graph01030","S12S18",100,0,3275);
   Graph_Graph01030->SetMinimum(-0.2138869);
   Graph_Graph01030->SetMaximum(0.1644802);
   ...
   Graph_Graph01030->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01030->GetYaxis()->SetTitle("A_{EDM} [mrad]");
