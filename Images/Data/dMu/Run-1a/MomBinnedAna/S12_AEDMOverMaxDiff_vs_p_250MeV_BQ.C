...
//=========  (Thu Nov  4 12:04:03 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.000937162,2750,0.002494988);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01026 = new TH1F("Graph_Graph01026","S12",100,125,3125);
   Graph_Graph01026->SetMinimum(-0.000593947);
   Graph_Graph01026->SetMaximum(0.002151773);
   ...
   Graph_Graph01026->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   ...
   Graph_Graph01026->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX}");
