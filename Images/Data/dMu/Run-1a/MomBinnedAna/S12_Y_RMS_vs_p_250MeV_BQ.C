...
//=========  (Thu Nov  4 12:04:03 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","S12",100,125,3125);
   Graph_Graph01021->SetMinimum(12.44141);
   Graph_Graph01021->SetMaximum(13.7535);
   ...
   Graph_Graph01021->GetYaxis()->SetTitle("#sigma_{y} [mm]");
