...
//=========  (Tue Oct 12 10:58:15 2021) by ROOT version 6.24/04
   ...
   c->Range(500,12.27722,2750,13.91858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","S12",100,125,3125);
   Graph_Graph01015->SetMinimum(12.44135);
   Graph_Graph01015->SetMaximum(13.75445);
