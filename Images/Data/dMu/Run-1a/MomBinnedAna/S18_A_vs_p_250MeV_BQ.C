void S18_A_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 13:45:35 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.2432526,3360.969,0.5937944);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01021 = new TH1F("Graph_Graph01021","S18",100,0,3275);
   Graph_Graph01021->SetMinimum(-0.1595479);
   Graph_Graph01021->SetMaximum(0.5100897);
   ...
   Graph_Graph01021->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01021->GetYaxis()->SetTitle("A_{EDM} [mrad]");
