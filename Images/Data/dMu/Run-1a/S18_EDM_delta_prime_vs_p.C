...
//=========  (Tue Oct 26 00:47:47 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.9730608,2750,1.911386);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph1003->SetMinimum(-0.6846161);
   Graph_Graph1003->SetMaximum(1.622941);
   ...
   pol01004->SetChisquare(7.035027);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.2401796);
   pol01004->SetParError(0,0.1072473);
