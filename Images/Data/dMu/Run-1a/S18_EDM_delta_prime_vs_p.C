...
//=========  (Fri Oct 22 00:55:00 2021) by ROOT version 6.24/04
   ...
   c->Range(500,-0.9944945,2750,1.88994);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","",100,725,2525);
   Graph_Graph1003->SetMinimum(-0.706051);
   Graph_Graph1003->SetMaximum(1.601497);
   ...
   Graph_Graph1003->GetXaxis()->SetTitle("p [MeV]: in range p #minus 125 < p < p #plus 125");
   Graph_Graph1003->GetXaxis()->CenterTitle(true);
   Graph_Graph1003->GetXaxis()->SetLabelFont(42);
   Graph_Graph1003->GetXaxis()->SetTitleSize(0.04);
   Graph_Graph1003->GetXaxis()->SetTitleOffset(1.1);
   Graph_Graph1003->GetXaxis()->SetTitleFont(42);
   Graph_Graph1003->GetYaxis()->SetTitle("#delta'_{EDM}^{BLIND} [mrad]");
   ...
   pol01004->SetChisquare(7.388734);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.2430977);
   pol01004->SetParError(0,0.1072363);
