void S12S18_Momentum_Y_RMS_vs_p_test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 12:19:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,12.36483,3360.969,22.15286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01033 = new TH1F("Graph_Graph01033","S12S18",100,0,3275);
   Graph_Graph01033->SetMinimum(13.34363);
   Graph_Graph01033->SetMaximum(21.17405);
   ...
   Graph_Graph01033->GetYaxis()->SetTitle("#sigma_{p_{y}} [MeV]");
