void S12S18_AOverMaxDiff_vs_p_test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 12:19:53 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,-0.008914236,3360.969,0.03452775);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","S12S18",100,0,3275);
   Graph_Graph01037->SetMinimum(-0.004570038);
   Graph_Graph01037->SetMaximum(0.03018355);
   ...
   Graph_Graph01037->GetXaxis()->SetTitle("e^{+}_{LAB} p [MeV] in range: p #minus 125 < p < p #plus 125 MeV");
   Graph_Graph01037->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01037->GetYaxis()->SetTitle("A_{EDM}/(#Delta#theta_{y})_{MAX}");
