...
//=========  (Thu Oct  7 12:19:53 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01020 = new TH1F("Graph_Graph01020","S18",100,0,3275);
   Graph_Graph01020->SetMinimum(-7.319364);
   Graph_Graph01020->SetMaximum(1.279245);
   ...
   Graph_Graph01020->GetYaxis()->SetTitle("c [mrad]");
