void S12_Momentum_Y_RMS_vs_p_test()
{
//=========Macro generated from canvas: c/c
//=========  (Thu Oct  7 12:19:52 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-118.7188,12.16824,3360.969,22.25515);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01015 = new TH1F("Graph_Graph01015","S12",100,0,3275);
   Graph_Graph01015->SetMinimum(13.17693);
   Graph_Graph01015->SetMaximum(21.24646);
   ...
   Graph_Graph01015->GetXaxis()->SetRange(8,92);
   ...
   Graph_Graph01015->GetYaxis()->SetTitle("#sigma_{p_{y}} [MeV]");
