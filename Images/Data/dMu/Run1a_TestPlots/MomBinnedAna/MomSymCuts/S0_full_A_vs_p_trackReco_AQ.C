...
//=========  (Mon Jun  7 14:57:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5000001,0.02382906,8.5,0.0238299);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01058->SetMinimum(0.02382914);
   Graph_Graph01058->SetMaximum(0.02382982);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,0.02382914,7.6,0.02382914,0.4,7.6,8,"");
