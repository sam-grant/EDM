...
//=========  (Mon Jun  7 14:57:53 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5000001,-0.4125944,8.5,0.03961774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01163->SetMinimum(-0.3673731);
   Graph_Graph01163->SetMaximum(-0.005603472);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,-0.3673731,7.6,-0.3673731,0.4,7.6,8,"");
