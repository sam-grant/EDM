...
//=========  (Mon Jun  7 14:57:53 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,-0.007126051,8.5,0.06854546);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01164->SetMinimum(0.0004411004);
   Graph_Graph01164->SetMaximum(0.0609783);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,0.0004411004,7.6,0.0004411004,0.4,7.6,8,"");
