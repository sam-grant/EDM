...
//=========  (Mon Jun  7 14:58:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,-0.01753648,8.5,0.06704704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01270->SetMinimum(-0.009078125);
   Graph_Graph01270->SetMaximum(0.05858869);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,-0.009078125,7.6,-0.009078125,0.4,7.6,8,"");
