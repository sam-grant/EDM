...
//=========  (Mon Jun  7 14:57:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,1.680511e-06,8.5,2.277709e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01057->SetMinimum(1.740231e-06);
   Graph_Graph01057->SetMaximum(2.217989e-06);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,1.740231e-06,7.6,1.740231e-06,0.4,7.6,8,"");
