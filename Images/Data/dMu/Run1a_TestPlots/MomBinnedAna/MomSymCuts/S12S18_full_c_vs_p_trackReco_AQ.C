...
//=========  (Mon Jun  7 14:58:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,-0.3199931,8.5,0.0953445);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01375->SetMinimum(-0.2784594);
   Graph_Graph01375->SetMaximum(0.05381074);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,-0.2784594,7.6,-0.2784594,0.4,7.6,8,"");
