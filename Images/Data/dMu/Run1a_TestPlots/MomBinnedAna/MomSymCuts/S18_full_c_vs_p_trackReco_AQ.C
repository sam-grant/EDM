...
//=========  (Mon Jun  7 14:58:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-0.5000001,-0.2264,8.5,0.1592133);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01269->SetMinimum(-0.1878387);
   Graph_Graph01269->SetMaximum(0.1206519);
   ...
   pt->Draw();
   TGaxis *gaxis = new TGaxis(0.4,-0.1878387,7.6,-0.1878387,0.4,7.6,8,"");
