...
//=========  (Mon Jun  7 14:57:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-437.25,1.680511e-06,3605.25,2.277709e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01041->SetMinimum(1.740231e-06);
   Graph_Graph01041->SetMaximum(2.217989e-06);
