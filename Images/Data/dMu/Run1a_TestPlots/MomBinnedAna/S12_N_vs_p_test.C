...
//=========  (Thu Oct  7 12:19:52 2021) by ROOT version 6.24/04
   ...
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","S12",100,0,3275);
   Graph_Graph01016->SetMinimum(89.1);
   Graph_Graph01016->SetMaximum(18433.8);
   ...
   Graph_Graph01016->GetYaxis()->SetTitle("Positrons");
