...
//=========  (Tue Oct 19 15:52:18 2021) by ROOT version 6.24/04
   ...
   c->Range(500,12.00521,2750,14.01241);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01025 = new TH1F("Graph_Graph01025","S18",100,125,3125);
   Graph_Graph01025->SetMinimum(12.20593);
   Graph_Graph01025->SetMaximum(13.81169);
