void S12S18_AEDM_vs_p_250MeV_BQ()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Oct 19 15:52:19 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-0.09425985,2750,0.3249371);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","S12S18",100,125,3125);
   Graph_Graph01032->SetMinimum(-0.05234016);
   Graph_Graph01032->SetMaximum(0.2830174);
