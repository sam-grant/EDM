...
//=========  (Tue Oct 19 15:52:19 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(500,-30.81471,2750,418.9114);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01039->SetMinimum(14.1579);
   Graph_Graph01039->SetMaximum(373.9388);
