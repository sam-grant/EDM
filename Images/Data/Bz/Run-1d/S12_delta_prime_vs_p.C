...
//=========  (Thu Oct 14 13:05:29 2021) by ROOT version 6.24/04
   ...
   pol01002->SetChisquare(14.48794);
   pol01002->SetNDF(6);
   ...
   pol01002->SetParameter(0,0.102741);
   pol01002->SetParError(0,0.05219763);
   ...
   TLegendEntry *entry=leg->AddEntry("S12_delta_prime_vs_p","Data: Run-1d","lpf");
