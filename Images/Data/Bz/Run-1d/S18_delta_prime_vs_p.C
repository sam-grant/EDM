...
//=========  (Thu Oct 14 13:05:29 2021) by ROOT version 6.24/04
   ...
   pol01004->SetChisquare(14.44421);
   pol01004->SetNDF(6);
   ...
   pol01004->SetParameter(0,0.009211651);
   pol01004->SetParError(0,0.05555581);
   ...
   TLegendEntry *entry=leg->AddEntry("S18_delta_prime_vs_p","Data: Run-1d","lpf");
