...
//=========  (Thu Oct 14 13:05:29 2021) by ROOT version 6.24/04
   ...
   pol01006->SetChisquare(15.98288);
   pol01006->SetNDF(6);
   ...
   pol01006->SetParameter(0,0.05880362);
   pol01006->SetParError(0,0.03804237);
   ...
   TLegendEntry *entry=leg->AddEntry("S12S18_delta_prime_vs_p","Data: Run-1d","lpf");
