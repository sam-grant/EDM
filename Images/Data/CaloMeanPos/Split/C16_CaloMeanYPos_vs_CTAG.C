...
//=========  (Fri Nov  6 17:25:11 2020) by ROOT version 6.22/02
   ...
   c->Range(-72816.98,68.75,655352.8,81.25);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03564218,
   6.953128e-310};
   TGraphErrors *gre = new TGraphErrors(349,Graph0_fx1031,Graph0_fy1031,Graph0_fex1031,Graph0_fey1031);
   gre->SetName("Graph0");
   gre->SetTitle(";CTAGs;#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","",349,0,582535.8);
   Graph_Graph01031->SetMinimum(70);
   Graph_Graph01031->SetMaximum(80);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,80,582535.8,80,0,347,510,"-");
