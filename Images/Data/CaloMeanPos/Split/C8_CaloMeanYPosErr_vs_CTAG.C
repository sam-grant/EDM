...
//=========  (Fri Nov  6 17:24:59 2020) by ROOT version 6.22/02
   ...
   c->Range(-74201.74,-0.03125,667815.6,0.28125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   1.482197e-323};
   TGraphErrors *gre = new TGraphErrors(349,Graph0_fx1016,Graph0_fy1016,Graph0_fex1016,Graph0_fey1016);
   gre->SetName("Graph0");
   gre->SetTitle(";CTAGs;#delta#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01016 = new TH1F("Graph_Graph01016","",349,0,593613.9);
   Graph_Graph01016->SetMinimum(0);
   Graph_Graph01016->SetMaximum(0.25);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.25,593613.9,0.25,0,347,510,"-");
