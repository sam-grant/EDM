...
//=========  (Wed Nov 11 19:02:14 2020) by ROOT version 6.22/02
   ...
   c->Range(-72597.06,74.42501,653373.5,76.57666);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0.03828568,
   0.03822641};
   TGraphErrors *gre = new TGraphErrors(346,Graph0_fx1039,Graph0_fy1039,Graph0_fex1039,Graph0_fey1039);
   gre->SetName("Graph0");
   gre->SetTitle(";CTAGs;#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01039 = new TH1F("Graph_Graph01039","",346,0,637932.2);
   Graph_Graph01039->SetMinimum(74.64018);
   Graph_Graph01039->SetMaximum(76.3615);
   ...
   Graph_Graph01039->GetXaxis()->SetRange(1,315);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,76.3615,580776.4,76.3615,0,347,510,"-");
