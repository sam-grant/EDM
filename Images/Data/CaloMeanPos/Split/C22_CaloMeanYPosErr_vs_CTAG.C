...
//=========  (Fri Nov  6 17:25:21 2020) by ROOT version 6.22/02
   ...
   c->Range(-70327.54,-0.03125,632947.8,0.28125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   1.482197e-323};
   TGraphErrors *gre = new TGraphErrors(349,Graph0_fx1044,Graph0_fy1044,Graph0_fex1044,Graph0_fey1044);
   gre->SetName("Graph0");
   gre->SetTitle(";CTAGs;#delta#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01044 = new TH1F("Graph_Graph01044","",349,0,562620.3);
   Graph_Graph01044->SetMinimum(0);
   Graph_Graph01044->SetMaximum(0.25);
   ...
   gre->Draw("ap");
   TGaxis *gaxis = new TGaxis(0,0.25,562620.3,0.25,0,347,510,"-");
