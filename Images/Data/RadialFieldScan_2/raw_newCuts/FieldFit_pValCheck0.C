...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.50998,50,41.5092);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.00806);
   Graph_Graph01025->SetMaximum(31.00728);
   ...
   mainFit1026->SetChisquare(3.43886);
   ...
   mainFit1026->SetParameter(0,-0.680198);
   mainFit1026->SetParError(0,0.5238553);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8222358);
   mainFit1026->SetParError(1,0.0207462);
   ...
   pt_LaTex = pt->AddText("0.822#pm0.0207");
   pt_LaTex = pt->AddText("#minus0.68#pm0.524");
   pt_LaTex = pt->AddText("#minus0.827#pm 0.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8272541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8272541,-53.00806,0.8272541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.43886);
   ...
   mainFit1027->SetParameter(0,-0.680198);
   mainFit1027->SetParError(0,0.5238553);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8222358);
   mainFit1027->SetParError(1,0.0207462);
