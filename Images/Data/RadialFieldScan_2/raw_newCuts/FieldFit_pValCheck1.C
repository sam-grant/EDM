...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.97881);
   Graph_Graph01027->SetMaximum(52.68545);
   ...
   mainFit1028->SetChisquare(0.4324932);
   ...
   mainFit1028->SetParameter(0,0.06205438);
   mainFit1028->SetParError(0,0.5429032);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.854435);
   mainFit1028->SetParError(1,0.01783682);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.144");
   pt_LaTex = pt->AddText("0.854#pm0.0178");
   pt_LaTex = pt->AddText("0.0621#pm0.543");
   pt_LaTex = pt->AddText("0.0726#pm0.635");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.07262621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.07262621,-54.97881,-0.07262621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4324932);
   ...
   mainFit1029->SetParameter(0,0.06205438);
   mainFit1029->SetParError(0,0.5429032);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.854435);
   mainFit1029->SetParError(1,0.01783682);
