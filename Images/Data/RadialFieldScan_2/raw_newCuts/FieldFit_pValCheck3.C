...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.97881);
   Graph_Graph01031->SetMaximum(52.68545);
   ...
   mainFit1032->SetChisquare(4.424046);
   ...
   mainFit1032->SetParameter(0,-0.6283658);
   mainFit1032->SetParError(0,0.5596215);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8407162);
   mainFit1032->SetParError(1,0.01657904);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.47");
   pt_LaTex = pt->AddText("0.841#pm0.0166");
   pt_LaTex = pt->AddText("#minus0.628#pm 0.56");
   pt_LaTex = pt->AddText("#minus0.747#pm0.662");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7474172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7474172,-54.97881,0.7474172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.424046);
   ...
   mainFit1033->SetParameter(0,-0.6283658);
   mainFit1033->SetParError(0,0.5596215);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8407162);
   mainFit1033->SetParError(1,0.01657904);
