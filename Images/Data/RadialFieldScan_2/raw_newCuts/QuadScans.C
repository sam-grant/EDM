...
//=========  (Wed Apr 21 00:32:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4778426);
   ...
   quadLineFit1002->SetParameter(0,74.67152);
   quadLineFit1002->SetParError(0,0.07325753);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.48479);
   quadLineFit1002->SetParError(1,1.228644);
   ...
   quadLineFit1003->SetChisquare(0.4778426);
   ...
   quadLineFit1003->SetParameter(0,74.67152);
   quadLineFit1003->SetParError(0,0.07325753);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.48479);
   quadLineFit1003->SetParError(1,1.228644);
   ...
   Graph_30_ppm1003->SetMinimum(75.85274);
   Graph_30_ppm1003->SetMaximum(76.43608);
   ...
   quadLineFit1004->SetChisquare(2.806237);
   ...
   quadLineFit1004->SetParameter(0,74.73704);
   quadLineFit1004->SetParError(0,0.06234335);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.98127);
   quadLineFit1004->SetParError(1,1.024733);
   ...
   quadLineFit1005->SetChisquare(2.806237);
   ...
   quadLineFit1005->SetParameter(0,74.73704);
   quadLineFit1005->SetParError(0,0.06234335);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.98127);
   quadLineFit1005->SetParError(1,1.024733);
   ...
   Graph_10_ppm1005->SetMinimum(74.92276);
   Graph_10_ppm1005->SetMaximum(75.18485);
   ...
   quadLineFit1006->SetChisquare(2.180675);
   ...
   quadLineFit1006->SetParameter(0,74.49773);
   quadLineFit1006->SetParError(0,0.07306718);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.839259);
   quadLineFit1006->SetParError(1,1.185119);
   ...
   quadLineFit1007->SetChisquare(2.180675);
   ...
   quadLineFit1007->SetParameter(0,74.49773);
   quadLineFit1007->SetParError(0,0.07306718);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.839259);
   quadLineFit1007->SetParError(1,1.185119);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80292);
   Graph_mI10_ppm1007->SetMaximum(74.07325);
   ...
   quadLineFit1008->SetChisquare(8.975694);
   ...
   quadLineFit1008->SetParameter(0,74.43522);
   quadLineFit1008->SetParError(0,0.06414446);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.242804);
   quadLineFit1008->SetParError(1,1.044144);
   ...
   quadLineFit1009->SetChisquare(8.975694);
   ...
   quadLineFit1009->SetParameter(0,74.43522);
   quadLineFit1009->SetParError(0,0.06414446);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.242804);
   quadLineFit1009->SetParError(1,1.044144);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.47536);
   Graph_mI30_ppm1009->SetMaximum(73.13775);
   ...
   quadLineFit1010->SetChisquare(2.048702);
   ...
   quadLineFit1010->SetParameter(0,74.38508);
   quadLineFit1010->SetParError(0,0.06069326);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.51173);
   quadLineFit1010->SetParError(1,1.050465);
   ...
   quadLineFit1011->SetChisquare(2.048702);
   ...
   quadLineFit1011->SetParameter(0,74.38508);
   quadLineFit1011->SetParError(0,0.06069326);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.51173);
   quadLineFit1011->SetParError(1,1.050465);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.5806);
   Graph_mI50_ppm1011->SetMaximum(72.21138);
   ...
   quadLineFit1012->SetChisquare(0.3894681);
   ...
   quadLineFit1012->SetParameter(0,74.39512);
   quadLineFit1012->SetParError(0,0.1224212);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.81639);
   quadLineFit1012->SetParError(1,2.190394);
   ...
   quadLineFit1013->SetChisquare(0.3894681);
   ...
   quadLineFit1013->SetParameter(0,74.39512);
   quadLineFit1013->SetParError(0,0.1224212);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.81639);
   quadLineFit1013->SetParError(1,2.190394);
