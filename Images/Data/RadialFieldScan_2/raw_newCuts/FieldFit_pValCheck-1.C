...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.97881);
   Graph_Graph01023->SetMaximum(52.68545);
   ...
   mainFit1024->SetChisquare(4.848435);
   ...
   mainFit1024->SetParameter(0,-0.4473632);
   mainFit1024->SetParError(0,0.4857758);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8379105);
   mainFit1024->SetParError(1,0.01600989);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.016");
   pt_LaTex = pt->AddText("#minus0.447#pm0.486");
   pt_LaTex = pt->AddText("#minus0.534#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5339033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5339033,-54.97881,0.5339033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.848435);
   ...
   mainFit1025->SetParameter(0,-0.4473632);
   mainFit1025->SetParError(0,0.4857758);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8379105);
   mainFit1025->SetParError(1,0.01600989);
