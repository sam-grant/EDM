...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.97881);
   Graph_Graph01033->SetMaximum(52.68545);
   ...
   mainFit1034->SetChisquare(4.838916);
   ...
   mainFit1034->SetParameter(0,-0.4832252);
   mainFit1034->SetParError(0,0.6091737);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8390828);
   mainFit1034->SetParError(1,0.02001791);
   ...
   pt_LaTex = pt->AddText("0.839#pm 0.02");
   pt_LaTex = pt->AddText("#minus0.483#pm0.609");
   pt_LaTex = pt->AddText("#minus0.576#pm 0.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5758969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5758969,-54.97881,0.5758969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.838916);
   ...
   mainFit1035->SetParameter(0,-0.4832252);
   mainFit1035->SetParError(0,0.6091737);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8390828);
   mainFit1035->SetParError(1,0.02001791);
