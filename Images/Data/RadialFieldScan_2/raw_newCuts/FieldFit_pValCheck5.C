...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.1311,70,61.28234);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.58975);
   Graph_Graph01035->SetMaximum(50.74099);
   ...
   mainFit1036->SetChisquare(4.27578);
   ...
   mainFit1036->SetParameter(0,-0.3304791);
   mainFit1036->SetParError(0,0.5097405);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8324263);
   mainFit1036->SetParError(1,0.01757375);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.0176");
   pt_LaTex = pt->AddText("#minus0.33#pm 0.51");
   pt_LaTex = pt->AddText("#minus0.397#pm 0.61");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.397007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.397007,-33.58975,0.397007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.27578);
   ...
   mainFit1037->SetParameter(0,-0.3304791);
   mainFit1037->SetParError(0,0.5097405);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8324263);
   mainFit1037->SetParError(1,0.01757375);
