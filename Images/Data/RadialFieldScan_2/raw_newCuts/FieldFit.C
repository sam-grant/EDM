...
//=========  (Wed Apr 21 00:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.97881);
   Graph_Graph01020->SetMaximum(52.68545);
   ...
   mainFit1021->SetChisquare(4.848435);
   ...
   mainFit1021->SetParameter(0,-0.4473632);
   mainFit1021->SetParError(0,0.4857758);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8379105);
   mainFit1021->SetParError(1,0.01600989);
   ...
   mainFit1022->SetChisquare(4.848435);
   ...
   mainFit1022->SetParameter(0,-0.4473632);
   mainFit1022->SetParError(0,0.4857758);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8379105);
   mainFit1022->SetParError(1,0.01600989);
