...
//=========  (Wed Apr 21 00:41:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.16185);
   Graph_Graph01020->SetMaximum(49.41067);
   ...
   mainFit1021->SetChisquare(57.65529);
   ...
   mainFit1021->SetParameter(0,-1.326695);
   mainFit1021->SetParError(0,0.2908324);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8669144);
   mainFit1021->SetParError(1,0.009589607);
   ...
   mainFit1022->SetChisquare(57.65529);
   ...
   mainFit1022->SetParameter(0,-1.326695);
   mainFit1022->SetParError(0,0.2908324);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8669144);
   mainFit1022->SetParError(1,0.009589607);
