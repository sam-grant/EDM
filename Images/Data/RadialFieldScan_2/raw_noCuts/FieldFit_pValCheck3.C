...
//=========  (Wed Apr 21 00:41:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.48342,75,61.73223);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-49.16185);
   Graph_Graph01031->SetMaximum(49.41067);
   ...
   mainFit1032->SetChisquare(27.08357);
   ...
   mainFit1032->SetParameter(0,-0.4140639);
   mainFit1032->SetParError(0,0.3344062);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8529353);
   mainFit1032->SetParError(1,0.00991729);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 9.03");
   pt_LaTex = pt->AddText("0.853#pm0.00992");
   pt_LaTex = pt->AddText("#minus0.414#pm0.334");
   pt_LaTex = pt->AddText("#minus0.485#pm0.391");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4854576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4854576,-49.16185,0.4854576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(27.08357);
   ...
   mainFit1033->SetParameter(0,-0.4140639);
   mainFit1033->SetParError(0,0.3344062);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8529353);
   mainFit1033->SetParError(1,0.00991729);
