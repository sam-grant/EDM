...
//=========  (Wed Apr 21 00:41:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.16185);
   Graph_Graph01033->SetMaximum(49.41067);
   ...
   mainFit1034->SetChisquare(56.94497);
   ...
   mainFit1034->SetParameter(0,-1.140376);
   mainFit1034->SetParError(0,0.3653151);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8608192);
   mainFit1034->SetParError(1,0.01201097);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   19");
   pt_LaTex = pt->AddText("0.861#pm0.012");
   pt_LaTex = pt->AddText("#minus1.14#pm0.365");
   pt_LaTex = pt->AddText("#minus1.32#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.324757,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.324757,-49.16185,1.324757,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(56.94497);
   ...
   mainFit1035->SetParameter(0,-1.140376);
   mainFit1035->SetParError(0,0.3653151);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8608192);
   mainFit1035->SetParError(1,0.01201097);
