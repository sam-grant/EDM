...
//=========  (Wed Apr 21 00:41:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.16185);
   Graph_Graph01027->SetMaximum(49.41067);
   ...
   mainFit1028->SetChisquare(42.34067);
   ...
   mainFit1028->SetParameter(0,-1.90049);
   mainFit1028->SetParError(0,0.3257014);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.848275);
   mainFit1028->SetParError(1,0.01070716);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 14.1");
   pt_LaTex = pt->AddText("0.848#pm0.0107");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.326");
   pt_LaTex = pt->AddText("#minus2.24#pm0.387");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.240417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.240417,-49.16185,2.240417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(42.34067);
   ...
   mainFit1029->SetParameter(0,-1.90049);
   mainFit1029->SetParError(0,0.3257014);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.848275);
   mainFit1029->SetParError(1,0.01070716);
