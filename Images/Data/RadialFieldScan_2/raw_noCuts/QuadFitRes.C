...
//=========  (Wed Apr 21 00:41:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03497882);
   Graph_Graph11015->SetMaximum(0.01673873);
   ...
   Graph_Graph21016->SetMinimum(-0.02104948);
   Graph_Graph21016->SetMaximum(0.02424694);
   ...
   Graph_Graph31017->SetMinimum(-0.009958516);
   Graph_Graph31017->SetMaximum(0.01987323);
   ...
   Graph_Graph41018->SetMinimum(-0.01947534);
   Graph_Graph41018->SetMaximum(0.03880087);
   ...
   Graph_Graph51019->SetMinimum(-0.01843475);
   Graph_Graph51019->SetMaximum(0.01383533);
