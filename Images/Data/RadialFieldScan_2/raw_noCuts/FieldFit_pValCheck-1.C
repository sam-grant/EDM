...
//=========  (Wed Apr 21 00:41:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.16185);
   Graph_Graph01023->SetMaximum(49.41067);
   ...
   mainFit1024->SetChisquare(57.65529);
   ...
   mainFit1024->SetParameter(0,-1.326695);
   mainFit1024->SetParError(0,0.2908324);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8669144);
   mainFit1024->SetParError(1,0.009589607);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 14.4");
   pt_LaTex = pt->AddText("0.867#pm0.00959");
   pt_LaTex = pt->AddText("#minus1.33#pm0.291");
   pt_LaTex = pt->AddText("#minus1.53#pm0.333");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.530365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.530365,-49.16185,1.530365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(57.65529);
   ...
   mainFit1025->SetParameter(0,-1.326695);
   mainFit1025->SetParError(0,0.2908324);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8669144);
   mainFit1025->SetParError(1,0.009589607);
