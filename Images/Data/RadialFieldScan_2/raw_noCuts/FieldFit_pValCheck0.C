...
//=========  (Wed Apr 21 00:41:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-57.98353,50,44.23279);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.7619);
   Graph_Graph01025->SetMaximum(34.01116);
   ...
   mainFit1026->SetChisquare(48.91158);
   ...
   mainFit1026->SetParameter(0,-0.9780081);
   mainFit1026->SetParError(0,0.313829);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8901331);
   mainFit1026->SetParError(1,0.01239424);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.3");
   pt_LaTex = pt->AddText(" 0.89#pm0.0124");
   pt_LaTex = pt->AddText("#minus0.978#pm0.314");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.355");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.098721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.098721,-47.7619,1.098721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(48.91158);
   ...
   mainFit1027->SetParameter(0,-0.9780081);
   mainFit1027->SetParError(0,0.313829);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8901331);
   mainFit1027->SetParError(1,0.01239424);
