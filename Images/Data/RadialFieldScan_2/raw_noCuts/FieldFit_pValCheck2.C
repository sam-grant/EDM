...
//=========  (Wed Apr 21 00:41:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.16185);
   Graph_Graph01029->SetMaximum(49.41067);
   ...
   mainFit1030->SetChisquare(50.67313);
   ...
   mainFit1030->SetParameter(0,-1.652241);
   mainFit1030->SetParError(0,0.3158515);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8649823);
   mainFit1030->SetParError(1,0.009617437);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.9");
   pt_LaTex = pt->AddText("0.865#pm0.00962");
   pt_LaTex = pt->AddText("#minus1.65#pm0.316");
   pt_LaTex = pt->AddText("#minus1.91#pm0.363");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.910144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.910144,-49.16185,1.910144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(50.67313);
   ...
   mainFit1031->SetParameter(0,-1.652241);
   mainFit1031->SetParError(0,0.3158515);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8649823);
   mainFit1031->SetParError(1,0.009617437);
