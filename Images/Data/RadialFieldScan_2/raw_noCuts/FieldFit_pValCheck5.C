...
//=========  (Wed Apr 21 00:41:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.71404,70,58.57836);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.2848);
   Graph_Graph01035->SetMaximum(48.14912);
   ...
   mainFit1036->SetChisquare(38.86335);
   ...
   mainFit1036->SetParameter(0,-1.725558);
   mainFit1036->SetParError(0,0.30504);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8857476);
   mainFit1036->SetParError(1,0.01052782);
   ...
   pt_LaTex = pt->AddText("0.886#pm0.0105");
   pt_LaTex = pt->AddText("#minus1.73#pm0.305");
   pt_LaTex = pt->AddText("#minus1.95#pm0.339");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.948137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.948137,-35.2848,1.948137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(38.86335);
   ...
   mainFit1037->SetParameter(0,-1.725558);
   mainFit1037->SetParError(0,0.30504);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8857476);
   mainFit1037->SetParError(1,0.01052782);
