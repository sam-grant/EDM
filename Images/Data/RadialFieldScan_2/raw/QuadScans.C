...
//=========  (Thu May  5 12:39:13 2022) by ROOT version 6.24/06
   ...
   Graph_50_ppm1001->GetXaxis()->SetTitle("1/V [kV^{-1}]");
   ...
   TF1 *quadLineFit1002 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1002->SetFillColor(19);
   quadLineFit1002->SetFillStyle(0);
   quadLineFit1002->SetLineWidth(2);
   quadLineFit1002->SetChisquare(2.034526);
   ...
   quadLineFit1002->SetParameter(0,74.62228);
   quadLineFit1002->SetParError(0,0.07674028);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.39209);
   quadLineFit1002->SetParError(1,1.288349);
   quadLineFit1002->SetParLimits(1,0,0);
   quadLineFit1002->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1002);
   gre->Draw("ap");
   
   TF1 *quadLineFit1003 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.07142857, TF1::EAddToList::kNo);
   quadLineFit1003->SetFillColor(19);
   quadLineFit1003->SetFillStyle(0);
   quadLineFit1003->SetLineWidth(2);
   quadLineFit1003->SetChisquare(2.034526);
   ...
   quadLineFit1003->SetParameter(0,74.62228);
   quadLineFit1003->SetParError(0,0.07674028);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.39209);
   quadLineFit1003->SetParError(1,1.288349);
   ...
   Graph_30_ppm1003->SetMinimum(75.78228);
   Graph_30_ppm1003->SetMaximum(76.37255);
   ...
   quadLineFit1004->SetChisquare(2.441556);
   ...
   quadLineFit1004->SetParameter(0,74.66654);
   quadLineFit1004->SetParError(0,0.06060549);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.08834);
   quadLineFit1004->SetParError(1,0.9960653);
   ...
   quadLineFit1005->SetChisquare(2.441556);
   ...
   quadLineFit1005->SetParameter(0,74.66654);
   quadLineFit1005->SetParError(0,0.06060549);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.08834);
   quadLineFit1005->SetParError(1,0.9960653);
   ...
   Graph_10_ppm1005->SetMinimum(74.84648);
   Graph_10_ppm1005->SetMaximum(75.11128);
   ...
   quadLineFit1006->SetChisquare(0.9915501);
   ...
   quadLineFit1006->SetParameter(0,74.41083);
   quadLineFit1006->SetParError(0,0.07099174);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.1059);
   quadLineFit1006->SetParError(1,1.151366);
   ...
   quadLineFit1007->SetChisquare(0.9915501);
   ...
   quadLineFit1007->SetParameter(0,74.41083);
   quadLineFit1007->SetParError(0,0.07099174);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.1059);
   quadLineFit1007->SetParError(1,1.151366);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.71626);
   Graph_mI10_ppm1007->SetMaximum(73.98396);
   ...
   quadLineFit1008->SetChisquare(3.603104);
   ...
   quadLineFit1008->SetParameter(0,74.37976);
   quadLineFit1008->SetParError(0,0.06234015);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.711124);
   quadLineFit1008->SetParError(1,1.014695);
   ...
   quadLineFit1009->SetChisquare(3.603104);
   ...
   quadLineFit1009->SetParameter(0,74.37976);
   quadLineFit1009->SetParError(0,0.06234015);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.711124);
   quadLineFit1009->SetParError(1,1.014695);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40626);
   Graph_mI30_ppm1009->SetMaximum(73.05618);
   ...
   quadLineFit1010->SetChisquare(2.679947);
   ...
   quadLineFit1010->SetParameter(0,74.29069);
   quadLineFit1010->SetParError(0,0.05896626);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.17625);
   quadLineFit1010->SetParError(1,1.020517);
   ...
   quadLineFit1011->SetChisquare(2.679947);
   ...
   quadLineFit1011->SetParameter(0,74.29069);
   quadLineFit1011->SetParError(0,0.05896626);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.17625);
   quadLineFit1011->SetParError(1,1.020517);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51602);
   Graph_mI50_ppm1011->SetMaximum(72.12909);
   ...
   TF1 *quadLineFit1012 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   ...
   quadLineFit1012->SetChisquare(0.8254824);
   ...
   quadLineFit1012->SetParameter(0,74.25476);
   quadLineFit1012->SetParError(0,0.1189497);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.60637);
   quadLineFit1012->SetParError(1,2.128334);
   quadLineFit1012->SetParLimits(1,0,0);
   quadLineFit1012->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1012);
   gre->Draw("p ");
   
   TF1 *quadLineFit1013 = new TF1("quadLineFit","[0]+[1]*x",0.05128205,0.0625, TF1::EAddToList::kNo);
   ...
   quadLineFit1013->SetChisquare(0.8254824);
   ...
   quadLineFit1013->SetParameter(0,74.25476);
   quadLineFit1013->SetParError(0,0.1189497);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.60637);
   quadLineFit1013->SetParError(1,2.128334);
   ...
   entry=leg->AddEntry("-50_ppm","  #minus50","lpf");
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("-10_ppm","  #minus10","lpf");
   entry->SetFillStyle(1000);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("10_ppm","   10","lpf");
   entry->SetFillStyle(1000);
   ...
   entry->SetMarkerSize(1);
   entry->SetTextFont(42);
   entry=leg->AddEntry("50_ppm","   50","lpf");
   entry->SetFillStyle(1000);
   entry->SetLineColor(1);
   entry->SetLineStyle(1);
   entry->SetLineWidth(1);
