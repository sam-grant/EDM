...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.99142);
   Graph_Graph01031->SetMaximum(56.12802);
   ...
   mainFit1032->SetChisquare(4.830594);
   ...
   mainFit1032->SetParameter(0,-2.047334);
   mainFit1032->SetParError(0,0.4639831);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9269899);
   mainFit1032->SetParError(1,0.01378454);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0138");
   pt_LaTex = pt->AddText("#minus2.05#pm0.464");
   pt_LaTex = pt->AddText("#minus2.21#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.208583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.208583,-60.99142,2.208583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.830594);
   ...
   mainFit1033->SetParameter(0,-2.047334);
   mainFit1033->SetParError(0,0.4639831);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9269899);
   mainFit1033->SetParError(1,0.01378454);
