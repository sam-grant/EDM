...
//=========  (Fri Apr 23 12:31:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.99142);
   Graph_Graph01023->SetMaximum(56.12802);
   ...
   mainFit1024->SetChisquare(5.064152);
   ...
   mainFit1024->SetParameter(0,-2.158517);
   mainFit1024->SetParError(0,0.4029134);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9287013);
   mainFit1024->SetParError(1,0.01331928);
   ...
   mainFit1025->SetChisquare(5.064152);
   ...
   mainFit1025->SetParameter(0,-2.158517);
   mainFit1025->SetParError(0,0.4029134);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9287013);
   mainFit1025->SetParError(1,0.01331928);
