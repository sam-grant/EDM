...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.63135,75,70.76796);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.99142);
   Graph_Graph01027->SetMaximum(56.12802);
   ...
   mainFit1028->SetChisquare(1.086642);
   ...
   mainFit1028->SetParameter(0,-1.753839);
   mainFit1028->SetParError(0,0.451127);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9419303);
   mainFit1028->SetParError(1,0.01487874);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.362");
   pt_LaTex = pt->AddText("0.942#pm0.0149");
   pt_LaTex = pt->AddText("#minus1.75#pm0.451");
   pt_LaTex = pt->AddText("#minus1.86#pm0.482");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.861962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.861962,-60.99142,1.861962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.086642);
   ...
   mainFit1029->SetParameter(0,-1.753839);
   mainFit1029->SetParError(0,0.451127);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9419303);
   mainFit1029->SetParError(1,0.01487874);
