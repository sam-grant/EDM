...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.99142);
   Graph_Graph01029->SetMaximum(56.12802);
   ...
   mainFit1030->SetChisquare(4.120432);
   ...
   mainFit1030->SetParameter(0,-2.32529);
   mainFit1030->SetParError(0,0.437957);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9277195);
   mainFit1030->SetParError(1,0.01335793);
   ...
   pt_LaTex = pt->AddText("#minus2.33#pm0.438");
   pt_LaTex = pt->AddText("#minus2.51#pm0.469");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.506458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.506458,-60.99142,2.506458,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.120432);
   ...
   mainFit1031->SetParameter(0,-2.32529);
   mainFit1031->SetParError(0,0.437957);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9277195);
   mainFit1031->SetParError(1,0.01335793);
