...
//=========  (Fri Apr 23 12:31:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009095989);
   Graph_Graph11015->SetMaximum(0.008543568);
   ...
   Graph_Graph21016->SetMinimum(-0.007687374);
   Graph_Graph21016->SetMaximum(0.009032912);
   ...
   Graph_Graph31017->SetMinimum(-0.02465402);
   Graph_Graph31017->SetMaximum(0.02005833);
   ...
   Graph_Graph41018->SetMinimum(-0.007820625);
   Graph_Graph41018->SetMaximum(0.01444809);
   ...
   Graph_Graph51019->SetMinimum(-0.002719564);
   Graph_Graph51019->SetMaximum(0.003633013);
