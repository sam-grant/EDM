...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-70.34228,50,44.3226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.87579);
   Graph_Graph01025->SetMaximum(32.85611);
   ...
   mainFit1026->SetChisquare(2.988801);
   ...
   mainFit1026->SetParameter(0,-2.391498);
   mainFit1026->SetParError(0,0.4341551);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9130463);
   mainFit1026->SetParError(1,0.01719199);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.996");
   pt_LaTex = pt->AddText("0.913#pm0.0172");
   pt_LaTex = pt->AddText("#minus2.39#pm0.434");
   pt_LaTex = pt->AddText("#minus2.62#pm0.484");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.619251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.619251,-58.87579,2.619251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.988801);
   ...
   mainFit1027->SetParameter(0,-2.391498);
   mainFit1027->SetParError(0,0.4341551);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9130463);
   mainFit1027->SetParError(1,0.01719199);
