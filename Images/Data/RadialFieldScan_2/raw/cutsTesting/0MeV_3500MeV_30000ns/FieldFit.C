...
//=========  (Fri Apr 23 12:31:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.99142);
   Graph_Graph01020->SetMaximum(56.12802);
   ...
   mainFit1021->SetChisquare(5.064152);
   ...
   mainFit1021->SetParameter(0,-2.158517);
   mainFit1021->SetParError(0,0.4029134);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9287013);
   mainFit1021->SetParError(1,0.01331928);
   ...
   pt_LaTex = pt->AddText("#minus2.16#pm0.403");
   pt_LaTex = pt->AddText("#minus2.32#pm 0.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.324232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.324232,-60.99142,2.324232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.064152);
   ...
   mainFit1022->SetParameter(0,-2.158517);
   mainFit1022->SetParError(0,0.4029134);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9287013);
   mainFit1022->SetParError(1,0.01331928);
