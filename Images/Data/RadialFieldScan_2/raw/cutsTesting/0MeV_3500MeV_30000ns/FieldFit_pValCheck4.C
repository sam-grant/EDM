...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.99142);
   Graph_Graph01033->SetMaximum(56.12802);
   ...
   mainFit1034->SetChisquare(4.364389);
   ...
   mainFit1034->SetParameter(0,-2.413371);
   mainFit1034->SetParError(0,0.5051208);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.93708);
   mainFit1034->SetParError(1,0.0166617);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.0167");
   pt_LaTex = pt->AddText("#minus2.41#pm0.505");
   pt_LaTex = pt->AddText("#minus2.58#pm0.519");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.575417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.575417,-60.99142,2.575417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.364389);
   ...
   mainFit1035->SetParameter(0,-2.413371);
   mainFit1035->SetParError(0,0.5051208);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.93708);
   mainFit1035->SetParError(1,0.0166617);
