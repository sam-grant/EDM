...
//=========  (Fri Apr 23 12:31:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.55717,70,65.55312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.04614);
   Graph_Graph01035->SetMaximum(54.04209);
   ...
   mainFit1036->SetChisquare(4.805135);
   ...
   mainFit1036->SetParameter(0,-2.093714);
   mainFit1036->SetParError(0,0.4225625);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9256368);
   mainFit1036->SetParError(1,0.01462097);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0146");
   pt_LaTex = pt->AddText("#minus2.09#pm0.423");
   pt_LaTex = pt->AddText("#minus2.26#pm0.448");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.261918,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.261918,-38.04614,2.261918,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.805135);
   ...
   mainFit1037->SetParameter(0,-2.093714);
   mainFit1037->SetParError(0,0.4225625);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9256368);
   mainFit1037->SetParError(1,0.01462097);
