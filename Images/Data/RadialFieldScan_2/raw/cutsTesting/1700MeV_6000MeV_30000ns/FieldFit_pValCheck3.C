...
//=========  (Wed Apr 21 12:27:40 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-63.19475,75,61.30586);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-50.74469);
   Graph_Graph01031->SetMaximum(48.8558);
   ...
   mainFit1032->SetChisquare(3.185544);
   ...
   mainFit1032->SetParameter(0,-0.2820355);
   mainFit1032->SetParError(0,0.7063486);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7678508);
   mainFit1032->SetParError(1,0.02094034);
   ...
   pt_LaTex = pt->AddText("0.768#pm0.0209");
   pt_LaTex = pt->AddText("#minus0.282#pm0.706");
   pt_LaTex = pt->AddText("#minus0.367#pm0.917");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.367305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.367305,-50.74469,0.367305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.185544);
   ...
   mainFit1033->SetParameter(0,-0.2820355);
   mainFit1033->SetParError(0,0.7063486);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7678508);
   mainFit1033->SetParError(1,0.02094034);
