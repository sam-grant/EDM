...
//=========  (Wed Apr 21 12:27:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.74469);
   Graph_Graph01033->SetMaximum(48.8558);
   ...
   mainFit1034->SetChisquare(3.912751);
   ...
   mainFit1034->SetParameter(0,0.2232581);
   mainFit1034->SetParError(0,0.7687238);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.756961);
   mainFit1034->SetParError(1,0.02528709);
   ...
   pt_LaTex = pt->AddText("0.757#pm0.0253");
   pt_LaTex = pt->AddText("0.223#pm0.769");
   pt_LaTex = pt->AddText("0.295#pm 1.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.29494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.29494,-50.74469,-0.29494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.912751);
   ...
   mainFit1035->SetParameter(0,0.2232581);
   mainFit1035->SetParError(0,0.7687238);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.756961);
   mainFit1035->SetParError(1,0.02528709);
