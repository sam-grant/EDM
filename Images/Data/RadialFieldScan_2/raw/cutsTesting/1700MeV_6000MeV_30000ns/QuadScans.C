...
//=========  (Wed Apr 21 12:27:39 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.6127996);
   ...
   quadLineFit1002->SetParameter(0,75.00155);
   quadLineFit1002->SetParError(0,0.0926845);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.00134);
   quadLineFit1002->SetParError(1,1.55442);
   ...
   quadLineFit1003->SetChisquare(0.6127996);
   ...
   quadLineFit1003->SetParameter(0,75.00155);
   quadLineFit1003->SetParError(0,0.0926845);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.00134);
   quadLineFit1003->SetParError(1,1.55442);
   ...
   Graph_30_ppm1003->SetMinimum(76.05275);
   Graph_30_ppm1003->SetMaximum(76.60472);
   ...
   quadLineFit1004->SetChisquare(0.2197057);
   ...
   quadLineFit1004->SetParameter(0,75.03356);
   quadLineFit1004->SetParError(0,0.07864804);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.0906);
   quadLineFit1004->SetParError(1,1.292808);
   ...
   quadLineFit1005->SetChisquare(0.2197057);
   ...
   quadLineFit1005->SetParameter(0,75.03356);
   quadLineFit1005->SetParError(0,0.07864804);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.0906);
   quadLineFit1005->SetParError(1,1.292808);
   ...
   Graph_10_ppm1005->SetMinimum(75.1318);
   Graph_10_ppm1005->SetMaximum(75.40653);
   ...
   quadLineFit1006->SetChisquare(1.204983);
   ...
   quadLineFit1006->SetParameter(0,74.70752);
   quadLineFit1006->SetParError(0,0.092199);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.938067);
   quadLineFit1006->SetParError(1,1.495318);
   ...
   quadLineFit1007->SetChisquare(1.204983);
   ...
   quadLineFit1007->SetParameter(0,74.70752);
   quadLineFit1007->SetParError(0,0.092199);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.938067);
   quadLineFit1007->SetParError(1,1.495318);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.09974);
   Graph_mI10_ppm1007->SetMaximum(74.34413);
   ...
   quadLineFit1008->SetChisquare(9.642844);
   ...
   quadLineFit1008->SetParameter(0,74.61743);
   quadLineFit1008->SetParError(0,0.08091086);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.525702);
   quadLineFit1008->SetParError(1,1.317098);
   ...
   quadLineFit1009->SetChisquare(9.642844);
   ...
   quadLineFit1009->SetParameter(0,74.61743);
   quadLineFit1009->SetParError(0,0.08091086);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.525702);
   quadLineFit1009->SetParError(1,1.317098);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.8485);
   Graph_mI30_ppm1009->SetMaximum(73.45644);
   ...
   quadLineFit1010->SetChisquare(0.006658966);
   ...
   quadLineFit1010->SetParameter(0,74.58113);
   quadLineFit1010->SetParError(0,0.07658682);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.19813);
   quadLineFit1010->SetParError(1,1.32557);
   ...
   quadLineFit1011->SetChisquare(0.006658966);
   ...
   quadLineFit1011->SetParameter(0,74.58113);
   quadLineFit1011->SetParError(0,0.07658682);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.19813);
   quadLineFit1011->SetParError(1,1.32557);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.98827);
   Graph_mI50_ppm1011->SetMaximum(72.57536);
   ...
   quadLineFit1012->SetChisquare(0.1719197);
   ...
   quadLineFit1012->SetParameter(0,74.53724);
   quadLineFit1012->SetParError(0,0.1546123);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.67833);
   quadLineFit1012->SetParError(1,2.766319);
   ...
   quadLineFit1013->SetChisquare(0.1719197);
   ...
   quadLineFit1013->SetParameter(0,74.53724);
   quadLineFit1013->SetParError(0,0.1546123);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.67833);
   quadLineFit1013->SetParError(1,2.766319);
