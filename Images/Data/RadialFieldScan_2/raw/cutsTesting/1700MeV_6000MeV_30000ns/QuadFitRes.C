...
//=========  (Wed Apr 21 12:27:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007179097);
   Graph_Graph11015->SetMaximum(0.007047162);
   ...
   Graph_Graph21016->SetMinimum(-0.01473553);
   Graph_Graph21016->SetMaximum(0.01734694);
   ...
   Graph_Graph31017->SetMinimum(-0.04907182);
   Graph_Graph31017->SetMaximum(0.04966301);
   ...
   Graph_Graph41018->SetMinimum(-0.001200769);
   Graph_Graph41018->SetMaximum(0.001774798);
   ...
   Graph_Graph51019->SetMinimum(-0.006948167);
   Graph_Graph51019->SetMaximum(0.005199868);
