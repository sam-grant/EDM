...
//=========  (Wed Apr 21 12:27:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.74469);
   Graph_Graph01029->SetMaximum(48.8558);
   ...
   mainFit1030->SetChisquare(3.199545);
   ...
   mainFit1030->SetParameter(0,-0.1956685);
   mainFit1030->SetParError(0,0.6661312);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7613821);
   mainFit1030->SetParError(1,0.02027714);
   ...
   pt_LaTex = pt->AddText("0.761#pm0.0203");
   pt_LaTex = pt->AddText("#minus0.196#pm0.666");
   pt_LaTex = pt->AddText("#minus0.257#pm0.874");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2569912,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2569912,-50.74469,0.2569912,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.199545);
   ...
   mainFit1031->SetParameter(0,-0.1956685);
   mainFit1031->SetParError(0,0.6661312);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7613821);
   mainFit1031->SetParError(1,0.02027714);
