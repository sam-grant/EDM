...
//=========  (Wed Apr 21 12:27:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.74469);
   Graph_Graph01020->SetMaximum(48.8558);
   ...
   mainFit1021->SetChisquare(4.059104);
   ...
   mainFit1021->SetParameter(0,0.04584202);
   mainFit1021->SetParError(0,0.6130779);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7627691);
   mainFit1021->SetParError(1,0.02022218);
   ...
   mainFit1022->SetChisquare(4.059104);
   ...
   mainFit1022->SetParameter(0,0.04584202);
   mainFit1022->SetParError(0,0.6130779);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7627691);
   mainFit1022->SetParError(1,0.02022218);
