...
//=========  (Wed Apr 21 12:27:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.79357,70,56.82562);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.03165);
   Graph_Graph01035->SetMaximum(47.0637);
   ...
   mainFit1036->SetChisquare(3.643408);
   ...
   mainFit1036->SetParameter(0,0.1713042);
   mainFit1036->SetParError(0,0.6432188);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7568704);
   mainFit1036->SetParError(1,0.02219548);
   ...
   pt_LaTex = pt->AddText("0.757#pm0.0222");
   pt_LaTex = pt->AddText("0.171#pm0.643");
   pt_LaTex = pt->AddText("0.226#pm0.852");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.2263323,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2263323,-31.03165,-0.2263323,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.643408);
   ...
   mainFit1037->SetParameter(0,0.1713042);
   mainFit1037->SetParError(0,0.6432188);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7568704);
   mainFit1037->SetParError(1,0.02219548);
