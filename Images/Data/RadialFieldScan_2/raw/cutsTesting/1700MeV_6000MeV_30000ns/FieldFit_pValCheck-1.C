...
//=========  (Wed Apr 21 12:27:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.74469);
   Graph_Graph01023->SetMaximum(48.8558);
   ...
   mainFit1024->SetChisquare(4.059104);
   ...
   mainFit1024->SetParameter(0,0.04584202);
   mainFit1024->SetParError(0,0.6130779);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7627691);
   mainFit1024->SetParError(1,0.02022218);
   ...
   pt_LaTex = pt->AddText("0.763#pm0.0202");
   pt_LaTex = pt->AddText("0.0458#pm0.613");
   pt_LaTex = pt->AddText("0.0601#pm0.804");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.06009947,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.06009947,-50.74469,-0.06009947,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.059104);
   ...
   mainFit1025->SetParameter(0,0.04584202);
   mainFit1025->SetParError(0,0.6130779);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7627691);
   mainFit1025->SetParError(1,0.02022218);
