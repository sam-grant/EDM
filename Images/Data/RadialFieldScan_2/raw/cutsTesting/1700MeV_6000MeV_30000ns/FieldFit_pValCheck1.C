...
//=========  (Wed Apr 21 12:27:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.74469);
   Graph_Graph01027->SetMaximum(48.8558);
   ...
   mainFit1028->SetChisquare(0.8427896);
   ...
   mainFit1028->SetParameter(0,0.5956177);
   mainFit1028->SetParError(0,0.6854484);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7806388);
   mainFit1028->SetParError(1,0.02254373);
   ...
   pt_LaTex = pt->AddText("0.781#pm0.0225");
   pt_LaTex = pt->AddText("0.596#pm0.685");
   pt_LaTex = pt->AddText("0.763#pm0.877");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.7629875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7629875,-50.74469,-0.7629875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8427896);
   ...
   mainFit1029->SetParameter(0,0.5956177);
   mainFit1029->SetParError(0,0.6854484);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7806388);
   mainFit1029->SetParError(1,0.02254373);
