...
//=========  (Wed Apr 21 12:27:39 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.65166,50,38.59042);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.92745);
   Graph_Graph01025->SetMaximum(28.86621);
   ...
   mainFit1026->SetChisquare(3.513479);
   ...
   mainFit1026->SetParameter(0,-0.1365791);
   mainFit1026->SetParError(0,0.6609417);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7504822);
   mainFit1026->SetParError(1,0.0261807);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.0262");
   pt_LaTex = pt->AddText("#minus0.137#pm0.661");
   pt_LaTex = pt->AddText("#minus0.182#pm0.881");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1819884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1819884,-48.92745,0.1819884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.513479);
   ...
   mainFit1027->SetParameter(0,-0.1365791);
   mainFit1027->SetParError(0,0.6609417);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7504822);
   mainFit1027->SetParError(1,0.0261807);
