...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-62.01998,75,63.78042);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-49.43994);
   Graph_Graph01020->SetMaximum(51.20038);
   ...
   mainFit1021->SetChisquare(62.46569);
   ...
   mainFit1021->SetParameter(0,-1.050468);
   mainFit1021->SetParError(0,0.3503535);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8903361);
   mainFit1021->SetParError(1,0.01157162);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 15.6");
   pt_LaTex = pt->AddText(" 0.89#pm0.0116");
   pt_LaTex = pt->AddText("#minus1.05#pm 0.35");
   pt_LaTex = pt->AddText("#minus1.18#pm0.391");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.179855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.179855,-49.43994,1.179855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(62.46569);
   ...
   mainFit1022->SetParameter(0,-1.050468);
   mainFit1022->SetParError(0,0.3503535);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8903361);
   mainFit1022->SetParError(1,0.01157162);
