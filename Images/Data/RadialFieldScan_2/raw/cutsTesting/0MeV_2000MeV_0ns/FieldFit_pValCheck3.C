...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-49.43994);
   Graph_Graph01031->SetMaximum(51.20038);
   ...
   mainFit1032->SetChisquare(21.37522);
   ...
   mainFit1032->SetParameter(0,0.2214955);
   mainFit1032->SetParError(0,0.402643);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8710379);
   mainFit1032->SetParError(1,0.01195683);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 7.13");
   pt_LaTex = pt->AddText("0.871#pm0.012");
   pt_LaTex = pt->AddText("0.221#pm0.403");
   pt_LaTex = pt->AddText("0.254#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2542891,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2542891,-49.43994,-0.2542891,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(21.37522);
   ...
   mainFit1033->SetParameter(0,0.2214955);
   mainFit1033->SetParError(0,0.402643);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8710379);
   mainFit1033->SetParError(1,0.01195683);
