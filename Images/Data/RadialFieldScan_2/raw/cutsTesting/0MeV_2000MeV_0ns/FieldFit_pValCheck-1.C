...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.43994);
   Graph_Graph01023->SetMaximum(51.20038);
   ...
   mainFit1024->SetChisquare(62.46569);
   ...
   mainFit1024->SetParameter(0,-1.050468);
   mainFit1024->SetParError(0,0.3503535);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8903361);
   mainFit1024->SetParError(1,0.01157162);
   ...
   mainFit1025->SetChisquare(62.46569);
   ...
   mainFit1025->SetParameter(0,-1.050468);
   mainFit1025->SetParError(0,0.3503535);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8903361);
   mainFit1025->SetParError(1,0.01157162);
