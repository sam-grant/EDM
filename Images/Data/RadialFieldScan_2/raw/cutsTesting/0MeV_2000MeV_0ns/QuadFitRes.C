...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02826337);
   Graph_Graph11015->SetMaximum(0.02342497);
   ...
   Graph_Graph21016->SetMinimum(-0.01582997);
   Graph_Graph21016->SetMaximum(0.01830962);
   ...
   Graph_Graph31017->SetMinimum(-0.01775578);
   Graph_Graph31017->SetMaximum(0.02531816);
   ...
   Graph_Graph41018->SetMinimum(-0.03460103);
   Graph_Graph41018->SetMaximum(0.06071286);
   ...
   Graph_Graph51019->SetMinimum(-0.03080863);
   Graph_Graph51019->SetMaximum(0.02309219);
