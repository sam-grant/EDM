...
//=========  (Fri Apr 23 10:47:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.43994);
   Graph_Graph01033->SetMaximum(51.20038);
   ...
   mainFit1034->SetChisquare(62.38481);
   ...
   mainFit1034->SetParameter(0,-1.126001);
   mainFit1034->SetParError(0,0.4396393);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.892814);
   mainFit1034->SetParError(1,0.01448495);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 20.8");
   pt_LaTex = pt->AddText("0.893#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.13#pm 0.44");
   pt_LaTex = pt->AddText("#minus1.26#pm0.483");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.261182,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.261182,-49.43994,1.261182,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(62.38481);
   ...
   mainFit1035->SetParameter(0,-1.126001);
   mainFit1035->SetParError(0,0.4396393);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.892814);
   mainFit1035->SetParError(1,0.01448495);
