...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.43994);
   Graph_Graph01027->SetMaximum(51.20038);
   ...
   mainFit1028->SetChisquare(44.54571);
   ...
   mainFit1028->SetParameter(0,-1.806365);
   mainFit1028->SetParError(0,0.3932322);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8656777);
   mainFit1028->SetParError(1,0.01295476);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 14.8");
   pt_LaTex = pt->AddText("0.866#pm0.013");
   pt_LaTex = pt->AddText("#minus1.81#pm0.393");
   pt_LaTex = pt->AddText("#minus2.09#pm0.458");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.086648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.086648,-49.43994,2.086648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(44.54571);
   ...
   mainFit1029->SetParameter(0,-1.806365);
   mainFit1029->SetParError(0,0.3932322);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8656777);
   mainFit1029->SetParError(1,0.01295476);
