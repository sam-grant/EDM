...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.53419,50,46.35145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.04562);
   Graph_Graph01025->SetMaximum(35.86289);
   ...
   mainFit1026->SetChisquare(56.69096);
   ...
   mainFit1026->SetParameter(0,-0.7092237);
   mainFit1026->SetParError(0,0.3780377);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.912905);
   mainFit1026->SetParError(1,0.01490325);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 18.9");
   pt_LaTex = pt->AddText("0.913#pm0.0149");
   pt_LaTex = pt->AddText("#minus0.709#pm0.378");
   pt_LaTex = pt->AddText("#minus0.777#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.7768866,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7768866,-48.04562,0.7768866,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(56.69096);
   ...
   mainFit1027->SetParameter(0,-0.7092237);
   mainFit1027->SetParError(0,0.3780377);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.912905);
   mainFit1027->SetParError(1,0.01490325);
