...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(57.9595);
   ...
   quadLineFit1002->SetParameter(0,74.53282);
   quadLineFit1002->SetParError(0,0.05390118);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.9111);
   quadLineFit1002->SetParError(1,0.9025898);
   ...
   quadLineFit1003->SetChisquare(57.9595);
   ...
   quadLineFit1003->SetParameter(0,74.53282);
   quadLineFit1003->SetParError(0,0.05390118);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.9111);
   quadLineFit1003->SetParError(1,0.9025898);
   ...
   Graph_30_ppm1003->SetMinimum(75.59544);
   Graph_30_ppm1003->SetMaximum(76.32416);
   ...
   quadLineFit1004->SetChisquare(7.365698);
   ...
   quadLineFit1004->SetParameter(0,74.24123);
   quadLineFit1004->SetParError(0,0.04510649);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,28.13088);
   quadLineFit1004->SetParError(1,0.7396274);
   ...
   quadLineFit1005->SetChisquare(7.365698);
   ...
   quadLineFit1005->SetParameter(0,74.24123);
   quadLineFit1005->SetParError(0,0.04510649);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,28.13088);
   quadLineFit1005->SetParError(1,0.7396274);
   ...
   Graph_10_ppm1005->SetMinimum(74.57704);
   Graph_10_ppm1005->SetMaximum(74.83819);
   ...
   quadLineFit1006->SetChisquare(4.190321);
   ...
   quadLineFit1006->SetParameter(0,74.12431);
   quadLineFit1006->SetParError(0,0.0532127);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.289603);
   quadLineFit1006->SetParError(1,0.861683);
   ...
   quadLineFit1007->SetChisquare(4.190321);
   ...
   quadLineFit1007->SetParameter(0,74.12431);
   quadLineFit1007->SetParError(0,0.0532127);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.289603);
   quadLineFit1007->SetParError(1,0.861683);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.21854);
   Graph_mI10_ppm1007->SetMaximum(73.58423);
   ...
   quadLineFit1008->SetChisquare(5.775296);
   ...
   quadLineFit1008->SetParameter(0,74.27901);
   quadLineFit1008->SetParError(0,0.04649177);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-14.11844);
   quadLineFit1008->SetParError(1,0.7553603);
   ...
   quadLineFit1009->SetChisquare(5.775296);
   ...
   quadLineFit1009->SetParameter(0,74.27901);
   quadLineFit1009->SetParError(0,0.04649177);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-14.11844);
   quadLineFit1009->SetParError(1,0.7553603);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.93575);
   Graph_mI30_ppm1009->SetMaximum(72.65382);
   ...
   quadLineFit1010->SetChisquare(19.37152);
   ...
   quadLineFit1010->SetParameter(0,74.00784);
   quadLineFit1010->SetParError(0,0.04342906);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.60929);
   quadLineFit1010->SetParError(1,0.7504331);
   ...
   quadLineFit1011->SetChisquare(19.37152);
   ...
   quadLineFit1011->SetParameter(0,74.00784);
   quadLineFit1011->SetParError(0,0.04342906);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.60929);
   quadLineFit1011->SetParError(1,0.7504331);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19648);
   Graph_mI50_ppm1011->SetMaximum(71.7603);
   ...
   quadLineFit1012->SetChisquare(10.49175);
   ...
   quadLineFit1012->SetParameter(0,73.70861);
   quadLineFit1012->SetParError(0,0.08740416);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.49007);
   quadLineFit1012->SetParError(1,1.563175);
   ...
   quadLineFit1013->SetChisquare(10.49175);
   ...
   quadLineFit1013->SetParameter(0,73.70861);
   quadLineFit1013->SetParError(0,0.08740416);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.49007);
   quadLineFit1013->SetParError(1,1.563175);
