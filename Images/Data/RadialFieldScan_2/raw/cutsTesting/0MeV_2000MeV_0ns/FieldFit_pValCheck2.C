...
//=========  (Fri Apr 23 10:47:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.43994);
   Graph_Graph01029->SetMaximum(51.20038);
   ...
   mainFit1030->SetChisquare(59.12944);
   ...
   mainFit1030->SetParameter(0,-1.32118);
   mainFit1030->SetParError(0,0.3804129);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8886589);
   mainFit1030->SetParError(1,0.01160798);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 19.7");
   pt_LaTex = pt->AddText("0.889#pm0.0116");
   pt_LaTex = pt->AddText("#minus1.32#pm 0.38");
   pt_LaTex = pt->AddText("#minus1.49#pm0.426");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.486712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.486712,-49.43994,1.486712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(59.12944);
   ...
   mainFit1031->SetParameter(0,-1.32118);
   mainFit1031->SetParError(0,0.3804129);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8886589);
   mainFit1031->SetParError(1,0.01160798);
