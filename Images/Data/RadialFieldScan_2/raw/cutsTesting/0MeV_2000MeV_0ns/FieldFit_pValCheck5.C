...
//=========  (Fri Apr 23 10:47:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.15307,70,60.60704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.47706);
   Graph_Graph01035->SetMaximum(49.93103);
   ...
   mainFit1036->SetChisquare(43.27331);
   ...
   mainFit1036->SetParameter(0,-1.535526);
   mainFit1036->SetParError(0,0.3674325);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9134281);
   mainFit1036->SetParError(1,0.0127156);
   ...
   pt_LaTex = pt->AddText("0.913#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.54#pm0.367");
   pt_LaTex = pt->AddText("#minus1.68#pm0.397");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.681058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.681058,-35.47706,1.681058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(43.27331);
   ...
   mainFit1037->SetParameter(0,-1.535526);
   mainFit1037->SetParError(0,0.3674325);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9134281);
   mainFit1037->SetParError(1,0.0127156);
