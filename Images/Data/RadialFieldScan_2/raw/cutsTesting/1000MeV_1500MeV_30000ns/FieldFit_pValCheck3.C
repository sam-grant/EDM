...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-64.40231);
   Graph_Graph01031->SetMaximum(63.25295);
   ...
   mainFit1032->SetChisquare(3.154298);
   ...
   mainFit1032->SetParameter(0,-0.9584624);
   mainFit1032->SetParError(0,1.082615);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9857019);
   mainFit1032->SetParError(1,0.03216832);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0322");
   pt_LaTex = pt->AddText("#minus0.958#pm 1.08");
   pt_LaTex = pt->AddText("#minus0.972#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9723654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9723654,-64.40231,0.9723654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.154298);
   ...
   mainFit1033->SetParameter(0,-0.9584624);
   mainFit1033->SetParError(0,1.082615);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9857019);
   mainFit1033->SetParError(1,0.03216832);
