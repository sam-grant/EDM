...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-64.40231);
   Graph_Graph01023->SetMaximum(63.25295);
   ...
   mainFit1024->SetChisquare(3.207473);
   ...
   mainFit1024->SetParameter(0,-0.834596);
   mainFit1024->SetParError(0,0.9399584);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9837895);
   mainFit1024->SetParError(1,0.03108093);
   ...
   mainFit1025->SetChisquare(3.207473);
   ...
   mainFit1025->SetParameter(0,-0.834596);
   mainFit1025->SetParError(0,0.9399584);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9837895);
   mainFit1025->SetParError(1,0.03108093);
