...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.20866,70,73.97974);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.38982);
   Graph_Graph01035->SetMaximum(61.1609);
   ...
   mainFit1036->SetChisquare(3.19018);
   ...
   mainFit1036->SetParameter(0,-0.873686);
   mainFit1036->SetParError(0,0.9858404);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9856415);
   mainFit1036->SetParError(1,0.03412252);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0341");
   pt_LaTex = pt->AddText("#minus0.874#pm0.986");
   pt_LaTex = pt->AddText("#minus0.886#pm0.993");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8864136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8864136,-41.38982,0.8864136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.19018);
   ...
   mainFit1037->SetParameter(0,-0.873686);
   mainFit1037->SetParError(0,0.9858404);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9856415);
   mainFit1037->SetParError(1,0.03412252);
