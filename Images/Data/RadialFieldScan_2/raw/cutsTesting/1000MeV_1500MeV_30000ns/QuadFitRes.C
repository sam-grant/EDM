...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02552026);
   Graph_Graph11015->SetMaximum(0.07627486);
   ...
   Graph_Graph21016->SetMinimum(-0.02363318);
   Graph_Graph21016->SetMaximum(0.02791293);
   ...
   Graph_Graph31017->SetMinimum(-0.007560401);
   Graph_Graph31017->SetMaximum(0.006628795);
   ...
   Graph_Graph41018->SetMinimum(-0.03847191);
   Graph_Graph41018->SetMaximum(0.0510077);
   ...
   Graph_Graph51019->SetMinimum(-0.01404571);
   Graph_Graph51019->SetMaximum(0.0188044);
