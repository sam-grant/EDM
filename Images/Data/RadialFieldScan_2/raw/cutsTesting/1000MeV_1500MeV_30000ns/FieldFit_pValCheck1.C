...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-80.35922,75,79.20985);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-64.40231);
   Graph_Graph01027->SetMaximum(63.25295);
   ...
   mainFit1028->SetChisquare(0.2480904);
   ...
   mainFit1028->SetParameter(0,-0.01971026);
   mainFit1028->SetParError(0,1.052571);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.010436);
   mainFit1028->SetParError(1,0.03472691);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0827");
   pt_LaTex = pt->AddText(" 1.01#pm0.0347");
   pt_LaTex = pt->AddText("#minus0.0197#pm 1.05");
   pt_LaTex = pt->AddText("#minus0.0195#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.01950668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.01950668,-64.40231,0.01950668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2480904);
   ...
   mainFit1029->SetParameter(0,-0.01971026);
   mainFit1029->SetParError(0,1.052571);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.010436);
   mainFit1029->SetParError(1,0.03472691);
