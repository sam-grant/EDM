...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-64.40231);
   Graph_Graph01020->SetMaximum(63.25295);
   ...
   mainFit1021->SetChisquare(3.207473);
   ...
   mainFit1021->SetParameter(0,-0.834596);
   mainFit1021->SetParError(0,0.9399584);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9837895);
   mainFit1021->SetParError(1,0.03108093);
   ...
   pt_LaTex = pt->AddText("0.984#pm0.0311");
   pt_LaTex = pt->AddText("#minus0.835#pm 0.94");
   pt_LaTex = pt->AddText("#minus0.848#pm0.951");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8483481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8483481,-64.40231,0.8483481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.207473);
   ...
   mainFit1022->SetParameter(0,-0.834596);
   mainFit1022->SetParError(0,0.9399584);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9837895);
   mainFit1022->SetParError(1,0.03108093);
