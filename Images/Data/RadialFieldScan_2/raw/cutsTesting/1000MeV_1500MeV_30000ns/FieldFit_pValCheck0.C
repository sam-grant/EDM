...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-74.19666,50,48.39705);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.93728);
   Graph_Graph01025->SetMaximum(36.13768);
   ...
   mainFit1026->SetChisquare(2.044918);
   ...
   mainFit1026->SetParameter(0,-1.240973);
   mainFit1026->SetParError(0,1.012676);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9564452);
   mainFit1026->SetParError(1,0.04010427);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.682");
   pt_LaTex = pt->AddText("0.956#pm0.0401");
   pt_LaTex = pt->AddText("#minus1.24#pm 1.01");
   pt_LaTex = pt->AddText(" #minus1.3#pm 1.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.297485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.297485,-61.93728,1.297485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.044918);
   ...
   mainFit1027->SetParameter(0,-1.240973);
   mainFit1027->SetParError(0,1.012676);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9564452);
   mainFit1027->SetParError(1,0.04010427);
