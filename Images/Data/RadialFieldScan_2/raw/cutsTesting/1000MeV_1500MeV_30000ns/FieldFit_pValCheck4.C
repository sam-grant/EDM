...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-64.40231);
   Graph_Graph01033->SetMaximum(63.25295);
   ...
   mainFit1034->SetChisquare(3.103121);
   ...
   mainFit1034->SetParameter(0,-0.6052397);
   mainFit1034->SetParError(0,1.177974);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9762495);
   mainFit1034->SetParError(1,0.03886939);
   ...
   pt_LaTex = pt->AddText("0.976#pm0.0389");
   pt_LaTex = pt->AddText("#minus0.605#pm 1.18");
   pt_LaTex = pt->AddText("#minus0.62#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6199642,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6199642,-64.40231,0.6199642,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.103121);
   ...
   mainFit1035->SetParameter(0,-0.6052397);
   mainFit1035->SetParError(0,1.177974);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9762495);
   mainFit1035->SetParError(1,0.03886939);
