...
//=========  (Thu Apr 22 00:36:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-64.40231);
   Graph_Graph01029->SetMaximum(63.25295);
   ...
   mainFit1030->SetChisquare(2.417636);
   ...
   mainFit1030->SetParameter(0,-1.190547);
   mainFit1030->SetParError(0,1.021733);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9816807);
   mainFit1030->SetParError(1,0.03117128);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.806");
   pt_LaTex = pt->AddText("0.982#pm0.0312");
   pt_LaTex = pt->AddText("#minus1.19#pm 1.02");
   pt_LaTex = pt->AddText("#minus1.21#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.212763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.212763,-64.40231,1.212763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.417636);
   ...
   mainFit1031->SetParameter(0,-1.190547);
   mainFit1031->SetParError(0,1.021733);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9816807);
   mainFit1031->SetParError(1,0.03117128);
