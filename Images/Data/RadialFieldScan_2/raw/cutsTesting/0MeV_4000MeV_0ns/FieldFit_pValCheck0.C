...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.02457,50,44.77055);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.64506);
   Graph_Graph01025->SetMaximum(34.39104);
   ...
   mainFit1026->SetChisquare(49.66524);
   ...
   mainFit1026->SetParameter(0,-1.32422);
   mainFit1026->SetParError(0,0.3204033);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9017966);
   mainFit1026->SetParError(1,0.01264893);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.6");
   pt_LaTex = pt->AddText("0.902#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.32#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.47#pm0.358");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.468424,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.468424,-48.64506,1.468424,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(49.66524);
   ...
   mainFit1027->SetParameter(0,-1.32422);
   mainFit1027->SetParError(0,0.3204033);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9017966);
   mainFit1027->SetParError(1,0.01264893);
