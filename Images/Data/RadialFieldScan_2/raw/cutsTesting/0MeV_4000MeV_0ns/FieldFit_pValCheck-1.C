...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.1389);
   Graph_Graph01023->SetMaximum(50.82332);
   ...
   mainFit1024->SetChisquare(53.63538);
   ...
   mainFit1024->SetParameter(0,-1.564941);
   mainFit1024->SetParError(0,0.2967536);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8857875);
   mainFit1024->SetParError(1,0.009769367);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 13.4");
   pt_LaTex = pt->AddText("0.886#pm0.00977");
   pt_LaTex = pt->AddText("#minus1.56#pm0.297");
   pt_LaTex = pt->AddText("#minus1.77#pm0.332");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.766723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.766723,-50.1389,1.766723,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(53.63538);
   ...
   mainFit1025->SetParameter(0,-1.564941);
   mainFit1025->SetParError(0,0.2967536);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8857875);
   mainFit1025->SetParError(1,0.009769367);
