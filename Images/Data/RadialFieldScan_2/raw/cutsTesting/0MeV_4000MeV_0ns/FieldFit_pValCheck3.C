...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-62.75918,75,63.44359);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-50.1389);
   Graph_Graph01031->SetMaximum(50.82332);
   ...
   mainFit1032->SetChisquare(21.45834);
   ...
   mainFit1032->SetParameter(0,-0.6084632);
   mainFit1032->SetParError(0,0.3413128);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8711315);
   mainFit1032->SetParError(1,0.01010525);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 7.15");
   pt_LaTex = pt->AddText("0.871#pm0.0101");
   pt_LaTex = pt->AddText("#minus0.608#pm0.341");
   pt_LaTex = pt->AddText("#minus0.698#pm 0.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6984746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6984746,-50.1389,0.6984746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(21.45834);
   ...
   mainFit1033->SetParameter(0,-0.6084632);
   mainFit1033->SetParError(0,0.3413128);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8711315);
   mainFit1033->SetParError(1,0.01010525);
