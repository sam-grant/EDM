...
//=========  (Fri Apr 23 11:02:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.76069,70,60.2439);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.06023);
   Graph_Graph01035->SetMaximum(49.54344);
   ...
   mainFit1036->SetChisquare(32.26395);
   ...
   mainFit1036->SetParameter(0,-2.00105);
   mainFit1036->SetParError(0,0.3113872);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9062979);
   mainFit1036->SetParError(1,0.01072961);
   ...
   pt_LaTex = pt->AddText("0.906#pm0.0107");
   pt_LaTex = pt->AddText("   #minus2#pm0.311");
   pt_LaTex = pt->AddText("#minus2.21#pm0.338");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.207939,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.207939,-36.06023,2.207939,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(32.26395);
   ...
   mainFit1037->SetParameter(0,-2.00105);
   mainFit1037->SetParError(0,0.3113872);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9062979);
   mainFit1037->SetParError(1,0.01072961);
