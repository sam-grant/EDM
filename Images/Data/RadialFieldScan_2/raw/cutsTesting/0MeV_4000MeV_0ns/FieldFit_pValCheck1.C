...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.1389);
   Graph_Graph01027->SetMaximum(50.82332);
   ...
   mainFit1028->SetChisquare(39.98168);
   ...
   mainFit1028->SetParameter(0,-2.115803);
   mainFit1028->SetParError(0,0.3320947);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8679613);
   mainFit1028->SetParError(1,0.01089545);
   ...
   pt_LaTex = pt->AddText("#minus2.12#pm0.332");
   pt_LaTex = pt->AddText("#minus2.44#pm0.386");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.43767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.43767,-50.1389,2.43767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(39.98168);
   ...
   mainFit1029->SetParameter(0,-2.115803);
   mainFit1029->SetParError(0,0.3320947);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8679613);
   mainFit1029->SetParError(1,0.01089545);
