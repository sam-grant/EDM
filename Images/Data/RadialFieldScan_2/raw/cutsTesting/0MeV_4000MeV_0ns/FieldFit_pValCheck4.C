...
//=========  (Fri Apr 23 11:02:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.1389);
   Graph_Graph01033->SetMaximum(50.82332);
   ...
   mainFit1034->SetChisquare(53.52591);
   ...
   mainFit1034->SetParameter(0,-1.490409);
   mainFit1034->SetParError(0,0.3725666);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8833558);
   mainFit1034->SetParError(1,0.01222513);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 17.8");
   pt_LaTex = pt->AddText("0.883#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.49#pm0.373");
   pt_LaTex = pt->AddText("#minus1.69#pm0.411");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.687213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.687213,-50.1389,1.687213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(53.52591);
   ...
   mainFit1035->SetParameter(0,-1.490409);
   mainFit1035->SetParError(0,0.3725666);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8833558);
   mainFit1035->SetParError(1,0.01222513);
