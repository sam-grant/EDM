...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03308708);
   Graph_Graph11015->SetMaximum(0.01774117);
   ...
   Graph_Graph21016->SetMinimum(-0.01448473);
   Graph_Graph21016->SetMaximum(0.01684189);
   ...
   Graph_Graph31017->SetMinimum(-0.009464132);
   Graph_Graph31017->SetMaximum(0.01923792);
   ...
   Graph_Graph41018->SetMinimum(-0.02431523);
   Graph_Graph41018->SetMaximum(0.04150906);
   ...
   Graph_Graph51019->SetMinimum(-0.01987319);
   Graph_Graph51019->SetMaximum(0.01490445);
