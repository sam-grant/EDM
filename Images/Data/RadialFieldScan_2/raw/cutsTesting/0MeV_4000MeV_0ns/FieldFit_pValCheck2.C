...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.1389);
   Graph_Graph01029->SetMaximum(50.82332);
   ...
   mainFit1030->SetChisquare(50.80317);
   ...
   mainFit1030->SetParameter(0,-1.77594);
   mainFit1030->SetParError(0,0.3221525);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8845526);
   mainFit1030->SetParError(1,0.009796871);
   ...
   pt_LaTex = pt->AddText("0.885#pm0.0098");
   pt_LaTex = pt->AddText("#minus1.78#pm0.322");
   pt_LaTex = pt->AddText("#minus2.01#pm0.362");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.007727,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.007727,-50.1389,2.007727,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(50.80317);
   ...
   mainFit1031->SetParameter(0,-1.77594);
   mainFit1031->SetParError(0,0.3221525);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8845526);
   mainFit1031->SetParError(1,0.009796871);
