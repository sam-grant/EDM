...
//=========  (Fri Apr 23 11:02:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.1389);
   Graph_Graph01020->SetMaximum(50.82332);
   ...
   mainFit1021->SetChisquare(53.63538);
   ...
   mainFit1021->SetParameter(0,-1.564941);
   mainFit1021->SetParError(0,0.2967536);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8857875);
   mainFit1021->SetParError(1,0.009769367);
   ...
   mainFit1022->SetChisquare(53.63538);
   ...
   mainFit1022->SetParameter(0,-1.564941);
   mainFit1022->SetParError(0,0.2967536);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8857875);
   mainFit1022->SetParError(1,0.009769367);
