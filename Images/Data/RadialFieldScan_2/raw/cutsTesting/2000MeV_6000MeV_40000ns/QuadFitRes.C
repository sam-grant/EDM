...
//=========  (Thu Apr 22 10:20:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03754097);
   Graph_Graph11015->SetMaximum(0.02272886);
   ...
   Graph_Graph21016->SetMinimum(-0.009589251);
   Graph_Graph21016->SetMaximum(0.008143962);
   ...
   Graph_Graph31017->SetMinimum(-0.05562457);
   Graph_Graph31017->SetMaximum(0.04400095);
   ...
   Graph_Graph41018->SetMinimum(-0.007321484);
   Graph_Graph41018->SetMaximum(0.01040626);
   ...
   Graph_Graph51019->SetMinimum(-0.00698297);
   Graph_Graph51019->SetMaximum(0.009331214);
