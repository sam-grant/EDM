...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-54.68041,50,37.59176);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-45.4532);
   Graph_Graph01025->SetMaximum(28.36454);
   ...
   mainFit1026->SetChisquare(1.933192);
   ...
   mainFit1026->SetParameter(0,0.03474465);
   mainFit1026->SetParError(0,0.8435343);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7208477);
   mainFit1026->SetParError(1,0.03339788);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.644");
   pt_LaTex = pt->AddText("0.721#pm0.0334");
   pt_LaTex = pt->AddText("0.0347#pm0.844");
   pt_LaTex = pt->AddText("0.0482#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.04819972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.04819972,-45.4532,-0.04819972,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.933192);
   ...
   mainFit1027->SetParameter(0,0.03474465);
   mainFit1027->SetParError(0,0.8435343);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7208477);
   mainFit1027->SetParError(1,0.03339788);
