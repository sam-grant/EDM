...
//=========  (Thu Apr 22 10:20:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.138015);
   ...
   quadLineFit1002->SetParameter(0,75.0924);
   quadLineFit1002->SetParError(0,0.1202477);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.54889);
   quadLineFit1002->SetParError(1,2.01697);
   ...
   quadLineFit1003->SetChisquare(4.138015);
   ...
   quadLineFit1003->SetParameter(0,75.0924);
   quadLineFit1003->SetParError(0,0.1202477);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.54889);
   quadLineFit1003->SetParError(1,2.01697);
   ...
   Graph_30_ppm1003->SetMinimum(76.20063);
   Graph_30_ppm1003->SetMaximum(76.75135);
   ...
   quadLineFit1004->SetChisquare(1.604472);
   ...
   quadLineFit1004->SetParameter(0,75.20192);
   quadLineFit1004->SetParError(0,0.1003564);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.56343);
   quadLineFit1004->SetParError(1,1.649633);
   ...
   quadLineFit1005->SetChisquare(1.604472);
   ...
   quadLineFit1005->SetParameter(0,75.20192);
   quadLineFit1005->SetParError(0,0.1003564);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.56343);
   quadLineFit1005->SetParError(1,1.649633);
   ...
   Graph_10_ppm1005->SetMinimum(75.25218);
   Graph_10_ppm1005->SetMaximum(75.5291);
   ...
   quadLineFit1006->SetChisquare(0.2258902);
   ...
   quadLineFit1006->SetParameter(0,74.8506);
   quadLineFit1006->SetParError(0,0.1176687);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.878288);
   quadLineFit1006->SetParError(1,1.908504);
   ...
   quadLineFit1007->SetChisquare(0.2258902);
   ...
   quadLineFit1007->SetParameter(0,74.8506);
   quadLineFit1007->SetParError(0,0.1176687);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.878288);
   quadLineFit1007->SetParError(1,1.908504);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.26966);
   Graph_mI10_ppm1007->SetMaximum(74.5285);
   ...
   quadLineFit1008->SetChisquare(5.836914);
   ...
   quadLineFit1008->SetParameter(0,74.76271);
   quadLineFit1008->SetParError(0,0.1033361);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.240318);
   quadLineFit1008->SetParError(1,1.681978);
   ...
   quadLineFit1009->SetChisquare(5.836914);
   ...
   quadLineFit1009->SetParameter(0,74.76271);
   quadLineFit1009->SetParError(0,0.1033361);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.240318);
   quadLineFit1009->SetParError(1,1.681978);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.9813);
   Graph_mI30_ppm1009->SetMaximum(73.59042);
   ...
   quadLineFit1010->SetChisquare(0.2886886);
   ...
   quadLineFit1010->SetParameter(0,74.69132);
   quadLineFit1010->SetParError(0,0.09773598);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.71908);
   quadLineFit1010->SetParError(1,1.691593);
   ...
   quadLineFit1011->SetChisquare(0.2886886);
   ...
   quadLineFit1011->SetParameter(0,74.69132);
   quadLineFit1011->SetParError(0,0.09773598);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.71908);
   quadLineFit1011->SetParError(1,1.691593);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.16097);
   Graph_mI50_ppm1011->SetMaximum(72.70879);
   ...
   quadLineFit1012->SetChisquare(0.1903646);
   ...
   quadLineFit1012->SetParameter(0,74.47825);
   quadLineFit1012->SetParError(0,0.1969751);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.77759);
   quadLineFit1012->SetParError(1,3.524131);
   ...
   quadLineFit1013->SetChisquare(0.1903646);
   ...
   quadLineFit1013->SetParameter(0,74.47825);
   quadLineFit1013->SetParError(0,0.1969751);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.77759);
   quadLineFit1013->SetParError(1,3.524131);
