...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-59.51861,75,61.78275);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-47.38847);
   Graph_Graph01023->SetMaximum(49.65262);
   ...
   mainFit1024->SetChisquare(3.458216);
   ...
   mainFit1024->SetParameter(0,0.4208052);
   mainFit1024->SetParError(0,0.7834693);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7468198);
   mainFit1024->SetParError(1,0.0259462);
   ...
   pt_LaTex = pt->AddText("0.747#pm0.0259");
   pt_LaTex = pt->AddText("0.421#pm0.783");
   pt_LaTex = pt->AddText("0.563#pm 1.05");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.5634628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.5634628,-47.38847,-0.5634628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.458216);
   ...
   mainFit1025->SetParameter(0,0.4208052);
   mainFit1025->SetParError(0,0.7834693);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7468198);
   mainFit1025->SetParError(1,0.0259462);
