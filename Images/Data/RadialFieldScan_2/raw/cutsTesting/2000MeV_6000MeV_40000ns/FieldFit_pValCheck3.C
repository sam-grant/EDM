...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-47.38847);
   Graph_Graph01031->SetMaximum(49.65262);
   ...
   mainFit1032->SetChisquare(3.145558);
   ...
   mainFit1032->SetParameter(0,0.1705042);
   mainFit1032->SetParError(0,0.9023329);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7506786);
   mainFit1032->SetParError(1,0.02684825);
   ...
   pt_LaTex = pt->AddText("0.171#pm0.902");
   pt_LaTex = pt->AddText("0.227#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2271335,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2271335,-47.38847,-0.2271335,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.145558);
   ...
   mainFit1033->SetParameter(0,0.1705042);
   mainFit1033->SetParError(0,0.9023329);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7506786);
   mainFit1033->SetParError(1,0.02684825);
