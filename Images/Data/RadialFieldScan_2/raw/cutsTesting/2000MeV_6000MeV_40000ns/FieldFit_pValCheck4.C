...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-47.38847);
   Graph_Graph01033->SetMaximum(49.65262);
   ...
   mainFit1034->SetChisquare(3.084854);
   ...
   mainFit1034->SetParameter(0,0.7816734);
   mainFit1034->SetParError(0,0.9811304);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7349253);
   mainFit1034->SetParError(1,0.03243673);
   ...
   pt_LaTex = pt->AddText("0.735#pm0.0324");
   pt_LaTex = pt->AddText("0.782#pm0.981");
   pt_LaTex = pt->AddText(" 1.06#pm 1.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.063609,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.063609,-47.38847,-1.063609,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.084854);
   ...
   mainFit1035->SetParameter(0,0.7816734);
   mainFit1035->SetParError(0,0.9811304);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7349253);
   mainFit1035->SetParError(1,0.03243673);
