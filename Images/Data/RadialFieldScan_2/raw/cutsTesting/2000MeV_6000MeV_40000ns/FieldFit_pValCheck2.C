...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-47.38847);
   Graph_Graph01029->SetMaximum(49.65262);
   ...
   mainFit1030->SetChisquare(3.134772);
   ...
   mainFit1030->SetParameter(0,0.2306898);
   mainFit1030->SetParError(0,0.8518162);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7456707);
   mainFit1030->SetParError(1,0.02602425);
   ...
   pt_LaTex = pt->AddText("0.746#pm0.026");
   pt_LaTex = pt->AddText("0.231#pm0.852");
   pt_LaTex = pt->AddText("0.309#pm 1.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3093722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3093722,-47.38847,-0.3093722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.134772);
   ...
   mainFit1031->SetParameter(0,0.2306898);
   mainFit1031->SetParError(0,0.8518162);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7456707);
   mainFit1031->SetParError(1,0.02602425);
