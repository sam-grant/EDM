...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.90481,70,58.05999);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.00833);
   Graph_Graph01035->SetMaximum(48.16351);
   ...
   mainFit1036->SetChisquare(3.324995);
   ...
   mainFit1036->SetParameter(0,0.3304146);
   mainFit1036->SetParError(0,0.8216778);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7511209);
   mainFit1036->SetParError(1,0.02849674);
   ...
   pt_LaTex = pt->AddText("0.751#pm0.0285");
   pt_LaTex = pt->AddText(" 0.33#pm0.822");
   pt_LaTex = pt->AddText(" 0.44#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4398953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4398953,-31.00833,-0.4398953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.324995);
   ...
   mainFit1037->SetParameter(0,0.3304146);
   mainFit1037->SetParError(0,0.8216778);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7511209);
   mainFit1037->SetParError(1,0.02849674);
