...
//=========  (Thu Apr 22 10:20:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-47.38847);
   Graph_Graph01020->SetMaximum(49.65262);
   ...
   mainFit1021->SetChisquare(3.458216);
   ...
   mainFit1021->SetParameter(0,0.4208052);
   mainFit1021->SetParError(0,0.7834693);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7468198);
   mainFit1021->SetParError(1,0.0259462);
   ...
   mainFit1022->SetChisquare(3.458216);
   ...
   mainFit1022->SetParameter(0,0.4208052);
   mainFit1022->SetParError(0,0.7834693);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7468198);
   mainFit1022->SetParError(1,0.0259462);
