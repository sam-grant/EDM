...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.51754);
   Graph_Graph01020->SetMaximum(55.12437);
   ...
   mainFit1021->SetChisquare(7.922261);
   ...
   mainFit1021->SetParameter(0,-1.195445);
   mainFit1021->SetParError(0,0.4169572);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8810137);
   mainFit1021->SetParError(1,0.01378894);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0138");
   pt_LaTex = pt->AddText(" #minus1.2#pm0.417");
   pt_LaTex = pt->AddText("#minus1.36#pm 0.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.356897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.356897,-55.51754,1.356897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.922261);
   ...
   mainFit1022->SetParameter(0,-1.195445);
   mainFit1022->SetParError(0,0.4169572);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8810137);
   mainFit1022->SetParError(1,0.01378894);
