...
//=========  (Thu Apr 22 14:40:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.51754);
   Graph_Graph01033->SetMaximum(55.12437);
   ...
   mainFit1034->SetChisquare(7.796732);
   ...
   mainFit1034->SetParameter(0,-1.307078);
   mainFit1034->SetParError(0,0.5226178);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8846844);
   mainFit1034->SetParError(1,0.01724741);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  2.6");
   pt_LaTex = pt->AddText("0.885#pm0.0172");
   pt_LaTex = pt->AddText("#minus1.31#pm0.523");
   pt_LaTex = pt->AddText("#minus1.48#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.477452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.477452,-55.51754,1.477452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.796732);
   ...
   mainFit1035->SetParameter(0,-1.307078);
   mainFit1035->SetParError(0,0.5226178);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8846844);
   mainFit1035->SetParError(1,0.01724741);
