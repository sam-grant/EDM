...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.95126,50,41.97202);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.35893);
   Graph_Graph01025->SetMaximum(31.37969);
   ...
   mainFit1026->SetChisquare(1.176043);
   ...
   mainFit1026->SetParameter(0,-1.629485);
   mainFit1026->SetParError(0,0.4491978);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8518079);
   mainFit1026->SetParError(1,0.01779248);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.392");
   pt_LaTex = pt->AddText("0.852#pm0.0178");
   pt_LaTex = pt->AddText("#minus1.63#pm0.449");
   pt_LaTex = pt->AddText("#minus1.91#pm0.534");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.912973,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.912973,-53.35893,1.912973,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.176043);
   ...
   mainFit1027->SetParameter(0,-1.629485);
   mainFit1027->SetParError(0,0.4491978);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8518079);
   mainFit1027->SetParError(1,0.01779248);
