...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.51754);
   Graph_Graph01029->SetMaximum(55.12437);
   ...
   mainFit1030->SetChisquare(7.883747);
   ...
   mainFit1030->SetParameter(0,-1.230319);
   mainFit1030->SetParError(0,0.4532502);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8808064);
   mainFit1030->SetParError(1,0.01382903);
   ...
   pt_LaTex = pt->AddText("#minus1.23#pm0.453");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.39681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.39681,-55.51754,1.39681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.883747);
   ...
   mainFit1031->SetParameter(0,-1.230319);
   mainFit1031->SetParError(0,0.4532502);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8808064);
   mainFit1031->SetParError(1,0.01382903);
