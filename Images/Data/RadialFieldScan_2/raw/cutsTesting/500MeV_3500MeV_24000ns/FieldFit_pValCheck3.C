...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.51754);
   Graph_Graph01031->SetMaximum(55.12437);
   ...
   mainFit1032->SetChisquare(7.909876);
   ...
   mainFit1032->SetParameter(0,-1.168926);
   mainFit1032->SetParError(0,0.4802487);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8806041);
   mainFit1032->SetParError(1,0.01427165);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.64");
   pt_LaTex = pt->AddText("0.881#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.17#pm 0.48");
   pt_LaTex = pt->AddText("#minus1.33#pm 0.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.327414,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.327414,-55.51754,1.327414,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.909876);
   ...
   mainFit1033->SetParameter(0,-1.168926);
   mainFit1033->SetParError(0,0.4802487);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8806041);
   mainFit1033->SetParError(1,0.01427165);
