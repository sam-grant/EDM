...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.51754);
   Graph_Graph01023->SetMaximum(55.12437);
   ...
   mainFit1024->SetChisquare(7.922261);
   ...
   mainFit1024->SetParameter(0,-1.195445);
   mainFit1024->SetParError(0,0.4169572);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8810137);
   mainFit1024->SetParError(1,0.01378894);
   ...
   mainFit1025->SetChisquare(7.922261);
   ...
   mainFit1025->SetParameter(0,-1.195445);
   mainFit1025->SetParError(0,0.4169572);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8810137);
   mainFit1025->SetParError(1,0.01378894);
