...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.34778,75,68.95461);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.51754);
   Graph_Graph01027->SetMaximum(55.12437);
   ...
   mainFit1028->SetChisquare(1.249139);
   ...
   mainFit1028->SetParameter(0,-0.6527476);
   mainFit1028->SetParError(0,0.4668927);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.898765);
   mainFit1028->SetParError(1,0.01540639);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.416");
   pt_LaTex = pt->AddText("0.899#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.653#pm0.467");
   pt_LaTex = pt->AddText("#minus0.726#pm0.521");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7262717,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7262717,-55.51754,0.7262717,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.249139);
   ...
   mainFit1029->SetParameter(0,-0.6527476);
   mainFit1029->SetParError(0,0.4668927);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.898765);
   mainFit1029->SetParError(1,0.01540639);
