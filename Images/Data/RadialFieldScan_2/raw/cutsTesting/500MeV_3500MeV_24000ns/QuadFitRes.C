...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01087288);
   Graph_Graph11015->SetMaximum(0.01016093);
   ...
   Graph_Graph21016->SetMinimum(-0.01330204);
   Graph_Graph21016->SetMaximum(0.01566381);
   ...
   Graph_Graph31017->SetMinimum(-0.03765395);
   Graph_Graph31017->SetMaximum(0.02700923);
   ...
   Graph_Graph41018->SetMinimum(-0.01116717);
   Graph_Graph41018->SetMaximum(0.01915237);
   ...
   Graph_Graph51019->SetMinimum(-0.006004564);
   Graph_Graph51019->SetMaximum(0.00802602);
