...
//=========  (Thu Apr 22 14:40:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.85007,70,64.45507);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.71956);
   Graph_Graph01035->SetMaximum(53.32455);
   ...
   mainFit1036->SetChisquare(7.67622);
   ...
   mainFit1036->SetParameter(0,-1.26079);
   mainFit1036->SetParError(0,0.4372736);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8841099);
   mainFit1036->SetParError(1,0.01513604);
   ...
   pt_LaTex = pt->AddText("0.884#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.26#pm0.437");
   pt_LaTex = pt->AddText("#minus1.43#pm0.489");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.426056,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.426056,-35.71956,1.426056,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.67622);
   ...
   mainFit1037->SetParameter(0,-1.26079);
   mainFit1037->SetParError(0,0.4372736);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8841099);
   mainFit1037->SetParError(1,0.01513604);
