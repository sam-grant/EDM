...
//=========  (Thu Apr 22 14:40:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4956126);
   ...
   quadLineFit1002->SetParameter(0,74.55738);
   quadLineFit1002->SetParError(0,0.06361611);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.8371);
   quadLineFit1002->SetParError(1,1.067109);
   ...
   quadLineFit1003->SetChisquare(0.4956126);
   ...
   quadLineFit1003->SetParameter(0,74.55738);
   quadLineFit1003->SetParError(0,0.06361611);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.8371);
   quadLineFit1003->SetParError(1,1.067109);
   ...
   Graph_30_ppm1003->SetMinimum(75.82239);
   Graph_30_ppm1003->SetMaximum(76.41214);
   ...
   quadLineFit1004->SetChisquare(1.059937);
   ...
   quadLineFit1004->SetParameter(0,74.67584);
   quadLineFit1004->SetParError(0,0.05347939);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.43914);
   quadLineFit1004->SetParError(1,0.8790005);
   ...
   quadLineFit1005->SetChisquare(1.059937);
   ...
   quadLineFit1005->SetParameter(0,74.67584);
   quadLineFit1005->SetParError(0,0.05347939);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.43914);
   quadLineFit1005->SetParError(1,0.8790005);
   ...
   Graph_10_ppm1005->SetMinimum(74.85094);
   Graph_10_ppm1005->SetMaximum(75.0808);
   ...
   quadLineFit1006->SetChisquare(2.129234);
   ...
   quadLineFit1006->SetParameter(0,74.47588);
   quadLineFit1006->SetParError(0,0.06263805);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.796442);
   quadLineFit1006->SetParError(1,1.015886);
   ...
   quadLineFit1007->SetChisquare(2.129234);
   ...
   quadLineFit1007->SetParameter(0,74.47588);
   quadLineFit1007->SetParError(0,0.06263805);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.796442);
   quadLineFit1007->SetParError(1,1.015886);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.64268);
   Graph_mI10_ppm1007->SetMaximum(73.95048);
   ...
   quadLineFit1008->SetChisquare(10.02617);
   ...
   quadLineFit1008->SetParameter(0,74.40551);
   quadLineFit1008->SetParError(0,0.05501699);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.0911);
   quadLineFit1008->SetParError(1,0.8955086);
   ...
   quadLineFit1009->SetChisquare(10.02617);
   ...
   quadLineFit1009->SetParameter(0,74.40551);
   quadLineFit1009->SetParError(0,0.05501699);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.0911);
   quadLineFit1009->SetParError(1,0.8955086);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.28324);
   Graph_mI30_ppm1009->SetMaximum(72.9745);
   ...
   quadLineFit1010->SetChisquare(2.707618);
   ...
   quadLineFit1010->SetParError(0,0.05200989);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.39909);
   quadLineFit1010->SetParError(1,0.900121);
   ...
   quadLineFit1011->SetChisquare(2.707618);
   ...
   quadLineFit1011->SetParError(0,0.05200989);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.39909);
   quadLineFit1011->SetParError(1,0.900121);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.36387);
   Graph_mI50_ppm1011->SetMaximum(71.99684);
   ...
   quadLineFit1012->SetChisquare(0.4972366);
   ...
   quadLineFit1012->SetParameter(0,74.21328);
   quadLineFit1012->SetParError(0,0.1050874);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.41703);
   quadLineFit1012->SetParError(1,1.880346);
   ...
   quadLineFit1013->SetChisquare(0.4972366);
   ...
   quadLineFit1013->SetParameter(0,74.21328);
   quadLineFit1013->SetParError(0,0.1050874);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.41703);
   quadLineFit1013->SetParError(1,1.880346);
