...
//=========  (Thu Apr 22 00:21:53 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4729985);
   ...
   quadLineFit1002->SetParameter(0,75.33856);
   quadLineFit1002->SetParError(0,0.2488858);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.21784);
   quadLineFit1002->SetParError(1,4.173154);
   ...
   quadLineFit1003->SetChisquare(0.4729985);
   ...
   quadLineFit1003->SetParameter(0,75.33856);
   quadLineFit1003->SetParError(0,0.2488858);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.21784);
   quadLineFit1003->SetParError(1,4.173154);
   ...
   Graph_30_ppm1003->SetMinimum(76.63261);
   Graph_30_ppm1003->SetMaximum(77.29634);
   ...
   quadLineFit1004->SetChisquare(0.001959913);
   ...
   quadLineFit1004->SetParameter(0,75.61599);
   quadLineFit1004->SetParError(0,0.2089586);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.04539);
   quadLineFit1004->SetParError(1,3.436211);
   ...
   quadLineFit1005->SetChisquare(0.001959913);
   ...
   quadLineFit1005->SetParameter(0,75.61599);
   quadLineFit1005->SetParError(0,0.2089586);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.04539);
   quadLineFit1005->SetParError(1,3.436211);
   ...
   Graph_10_ppm1005->SetMinimum(75.71708);
   Graph_10_ppm1005->SetMaximum(75.9065);
   ...
   quadLineFit1006->SetChisquare(0.447918);
   ...
   quadLineFit1006->SetParameter(0,75.66966);
   quadLineFit1006->SetParError(0,0.2451523);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,2.558849);
   quadLineFit1006->SetParError(1,3.976468);
   ...
   quadLineFit1007->SetChisquare(0.447918);
   ...
   quadLineFit1007->SetParameter(0,75.66966);
   quadLineFit1007->SetParError(0,0.2451523);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,2.558849);
   quadLineFit1007->SetParError(1,3.976468);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.54743);
   Graph_mI10_ppm1007->SetMaximum(74.98941);
   ...
   quadLineFit1008->SetChisquare(13.65508);
   ...
   quadLineFit1008->SetParameter(0,74.94521);
   quadLineFit1008->SetParError(0,0.2162882);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-2.905033);
   quadLineFit1008->SetParError(1,3.521354);
   ...
   quadLineFit1009->SetChisquare(13.65508);
   ...
   quadLineFit1009->SetParameter(0,74.94521);
   quadLineFit1009->SetParError(0,0.2162882);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-2.905033);
   quadLineFit1009->SetParError(1,3.521354);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.18006);
   Graph_mI30_ppm1009->SetMaximum(73.94802);
   ...
   quadLineFit1010->SetChisquare(1.43255);
   ...
   quadLineFit1010->SetParameter(0,75.2852);
   quadLineFit1010->SetParError(0,0.2038199);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.77949);
   quadLineFit1010->SetParError(1,3.527684);
   ...
   quadLineFit1011->SetChisquare(1.43255);
   ...
   quadLineFit1011->SetParameter(0,75.2852);
   quadLineFit1011->SetParError(0,0.2038199);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.77949);
   quadLineFit1011->SetParError(1,3.527684);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.40525);
   Graph_mI50_ppm1011->SetMaximum(73.0265);
   ...
   quadLineFit1012->SetChisquare(0.05339418);
   ...
   quadLineFit1012->SetParameter(0,74.76671);
   quadLineFit1012->SetParError(0,0.4112946);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.8494);
   quadLineFit1012->SetParError(1,7.358513);
   ...
   quadLineFit1013->SetChisquare(0.05339418);
   ...
   quadLineFit1013->SetParameter(0,74.76671);
   quadLineFit1013->SetParError(0,0.4112946);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.8494);
   quadLineFit1013->SetParError(1,7.358513);
