...
//=========  (Thu Apr 22 00:21:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.3678);
   Graph_Graph01020->SetMaximum(57.55089);
   ...
   mainFit1021->SetChisquare(6.67734);
   ...
   mainFit1021->SetParameter(0,-0.2932812);
   mainFit1021->SetParError(0,1.633977);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.815364);
   mainFit1021->SetParError(1,0.05397624);
   ...
   pt_LaTex = pt->AddText("0.815#pm0.054");
   pt_LaTex = pt->AddText("#minus0.293#pm 1.63");
   pt_LaTex = pt->AddText("#minus0.36#pm    2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3596936,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3596936,-52.3678,0.3596936,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.67734);
   ...
   mainFit1022->SetParameter(0,-0.2932812);
   mainFit1022->SetParError(0,1.633977);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.815364);
   mainFit1022->SetParError(1,0.05397624);
