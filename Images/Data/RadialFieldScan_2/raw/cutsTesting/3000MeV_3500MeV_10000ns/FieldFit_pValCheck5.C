...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-51.23171,70,68.31554);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.27699);
   Graph_Graph01035->SetMaximum(56.36081);
   ...
   mainFit1036->SetChisquare(6.041446);
   ...
   mainFit1036->SetParameter(0,-0.7069718);
   mainFit1036->SetParError(0,1.714282);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.834923);
   mainFit1036->SetParError(1,0.05926932);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0593");
   pt_LaTex = pt->AddText("#minus0.707#pm 1.71");
   pt_LaTex = pt->AddText("#minus0.847#pm 2.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8467509,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8467509,-39.27699,0.8467509,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.041446);
   ...
   mainFit1037->SetParameter(0,-0.7069718);
   mainFit1037->SetParError(0,1.714282);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.834923);
   mainFit1037->SetParError(1,0.05926932);
