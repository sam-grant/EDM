...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.3678);
   Graph_Graph01023->SetMaximum(57.55089);
   ...
   mainFit1024->SetChisquare(6.67734);
   ...
   mainFit1024->SetParameter(0,-0.2932812);
   mainFit1024->SetParError(0,1.633977);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.815364);
   mainFit1024->SetParError(1,0.05397624);
   ...
   mainFit1025->SetChisquare(6.67734);
   ...
   mainFit1025->SetParameter(0,-0.2932812);
   mainFit1025->SetParError(0,1.633977);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.815364);
   mainFit1025->SetParError(1,0.05397624);
