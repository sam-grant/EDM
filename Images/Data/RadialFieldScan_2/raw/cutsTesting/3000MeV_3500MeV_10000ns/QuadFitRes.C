...
//=========  (Thu Apr 22 00:21:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.001956093);
   Graph_Graph11015->SetMaximum(0.001783519);
   ...
   Graph_Graph21016->SetMinimum(-0.02812345);
   Graph_Graph21016->SetMaximum(0.02397445);
   ...
   Graph_Graph31017->SetMinimum(-0.1713304);
   Graph_Graph31017->SetMaximum(0.1212542);
   ...
   Graph_Graph41018->SetMinimum(-0.05123453);
   Graph_Graph41018->SetMaximum(0.05245906);
   ...
   Graph_Graph51019->SetMinimum(-0.007712718);
   Graph_Graph51019->SetMaximum(0.0102903);
