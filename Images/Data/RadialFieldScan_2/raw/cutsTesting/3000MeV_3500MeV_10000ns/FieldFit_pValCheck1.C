...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.3678);
   Graph_Graph01027->SetMaximum(57.55089);
   ...
   mainFit1028->SetChisquare(6.066574);
   ...
   mainFit1028->SetParameter(0,0.3501982);
   mainFit1028->SetParError(0,1.829818);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.836397);
   mainFit1028->SetParError(1,0.06029351);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0603");
   pt_LaTex = pt->AddText(" 0.35#pm 1.83");
   pt_LaTex = pt->AddText("0.419#pm 2.19");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4186985,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4186985,-52.3678,-0.4186985,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(6.066574);
   ...
   mainFit1029->SetParameter(0,0.3501982);
   mainFit1029->SetParError(0,1.829818);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.836397);
   mainFit1029->SetParError(1,0.06029351);
