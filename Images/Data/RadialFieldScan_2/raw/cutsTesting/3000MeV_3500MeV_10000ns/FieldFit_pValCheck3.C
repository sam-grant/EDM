...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.3678);
   Graph_Graph01031->SetMaximum(57.55089);
   ...
   mainFit1032->SetChisquare(3.320284);
   ...
   mainFit1032->SetParameter(0,-1.997919);
   mainFit1032->SetParError(0,1.880229);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8417758);
   mainFit1032->SetParError(1,0.05586297);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0559");
   pt_LaTex = pt->AddText("   #minus2#pm 1.88");
   pt_LaTex = pt->AddText("#minus2.37#pm  2.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.373457,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.373457,-52.3678,2.373457,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.320284);
   ...
   mainFit1033->SetParameter(0,-1.997919);
   mainFit1033->SetParError(0,1.880229);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8417758);
   mainFit1033->SetParError(1,0.05586297);
