...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.3678);
   Graph_Graph01029->SetMaximum(57.55089);
   ...
   mainFit1030->SetChisquare(4.538133);
   ...
   mainFit1030->SetParameter(0,0.7257103);
   mainFit1030->SetParError(0,1.776346);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8213306);
   mainFit1030->SetParError(1,0.05412883);
   ...
   pt_LaTex = pt->AddText("0.821#pm0.0541");
   pt_LaTex = pt->AddText("0.726#pm 1.78");
   pt_LaTex = pt->AddText("0.884#pm 2.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8835789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8835789,-52.3678,-0.8835789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.538133);
   ...
   mainFit1031->SetParameter(0,0.7257103);
   mainFit1031->SetParError(0,1.776346);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8213306);
   mainFit1031->SetParError(1,0.05412883);
