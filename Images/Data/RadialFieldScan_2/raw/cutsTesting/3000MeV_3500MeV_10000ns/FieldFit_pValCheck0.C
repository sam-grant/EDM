...
//=========  (Thu Apr 22 00:21:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.38029,50,42.65398);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.07686);
   Graph_Graph01025->SetMaximum(32.35055);
   ...
   mainFit1026->SetChisquare(5.105098);
   ...
   mainFit1026->SetParameter(0,-1.112694);
   mainFit1026->SetParError(0,1.759734);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7602255);
   mainFit1026->SetParError(1,0.06963213);
   ...
   pt_LaTex = pt->AddText(" 0.76#pm0.0696");
   pt_LaTex = pt->AddText("#minus1.11#pm 1.76");
   pt_LaTex = pt->AddText("#minus1.46#pm 2.33");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.463637,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.463637,-50.07686,1.463637,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.105098);
   ...
   mainFit1027->SetParameter(0,-1.112694);
   mainFit1027->SetParError(0,1.759734);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7602255);
   mainFit1027->SetParError(1,0.06963213);
