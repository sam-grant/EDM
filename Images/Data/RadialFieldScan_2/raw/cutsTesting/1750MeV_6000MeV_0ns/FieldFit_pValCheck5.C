...
//=========  (Wed Apr 21 14:56:11 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.90022,70,60.78948);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.03125);
   Graph_Graph01035->SetMaximum(49.92051);
   ...
   mainFit1036->SetChisquare(2.448642);
   ...
   mainFit1036->SetParameter(0,-1.827851);
   mainFit1036->SetParError(0,0.4946961);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8688508);
   mainFit1036->SetParError(1,0.0172488);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.0172");
   pt_LaTex = pt->AddText("#minus1.83#pm0.495");
   pt_LaTex = pt->AddText(" #minus2.1#pm 0.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.103757,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.103757,-37.03125,2.103757,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.448642);
   ...
   mainFit1037->SetParameter(0,-1.827851);
   mainFit1037->SetParError(0,0.4946961);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8688508);
   mainFit1037->SetParError(1,0.0172488);
