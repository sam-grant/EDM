...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02103753);
   Graph_Graph11015->SetMaximum(0.02058262);
   ...
   Graph_Graph21016->SetMinimum(-0.02014271);
   Graph_Graph21016->SetMaximum(0.02364049);
   ...
   Graph_Graph31017->SetMinimum(-0.04542433);
   Graph_Graph31017->SetMaximum(0.04068956);
   ...
   Graph_Graph41018->SetMinimum(-0.01526445);
   Graph_Graph41018->SetMaximum(0.007854455);
   ...
   Graph_Graph51019->SetMinimum(-0.004708207);
   Graph_Graph51019->SetMaximum(0.003539973);
