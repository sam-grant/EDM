...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.06096);
   Graph_Graph01020->SetMaximum(51.65048);
   ...
   mainFit1021->SetChisquare(2.465458);
   ...
   mainFit1021->SetParameter(0,-1.80868);
   mainFit1021->SetParError(0,0.4721105);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8679234);
   mainFit1021->SetParError(1,0.01570678);
   ...
   mainFit1022->SetChisquare(2.465458);
   ...
   mainFit1022->SetParameter(0,-1.80868);
   mainFit1022->SetParError(0,0.4721105);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8679234);
   mainFit1022->SetParError(1,0.01570678);
