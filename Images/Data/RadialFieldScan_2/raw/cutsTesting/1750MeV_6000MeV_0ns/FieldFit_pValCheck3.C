...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.06096);
   Graph_Graph01031->SetMaximum(51.65048);
   ...
   mainFit1032->SetChisquare(1.427805);
   ...
   mainFit1032->SetParameter(0,-2.083264);
   mainFit1032->SetParError(0,0.5436398);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8721345);
   mainFit1032->SetParError(1,0.01624096);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.476");
   pt_LaTex = pt->AddText("0.872#pm0.0162");
   pt_LaTex = pt->AddText("#minus2.08#pm0.544");
   pt_LaTex = pt->AddText("#minus2.39#pm0.614");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.388695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.388695,-56.06096,2.388695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.427805);
   ...
   mainFit1033->SetParameter(0,-2.083264);
   mainFit1033->SetParError(0,0.5436398);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8721345);
   mainFit1033->SetParError(1,0.01624096);
