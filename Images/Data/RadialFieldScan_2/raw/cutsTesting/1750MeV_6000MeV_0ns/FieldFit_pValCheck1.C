...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.06096);
   Graph_Graph01027->SetMaximum(51.65048);
   ...
   mainFit1028->SetChisquare(1.956491);
   ...
   mainFit1028->SetParameter(0,-1.63556);
   mainFit1028->SetParError(0,0.5308395);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8736685);
   mainFit1028->SetParError(1,0.01765104);
   ...
   pt_LaTex = pt->AddText("0.874#pm0.0177");
   pt_LaTex = pt->AddText("#minus1.64#pm0.531");
   pt_LaTex = pt->AddText("#minus1.87#pm0.612");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.87206,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.87206,-56.06096,1.87206,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.956491);
   ...
   mainFit1029->SetParameter(0,-1.63556);
   mainFit1029->SetParError(0,0.5308395);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8736685);
   mainFit1029->SetParError(1,0.01765104);
