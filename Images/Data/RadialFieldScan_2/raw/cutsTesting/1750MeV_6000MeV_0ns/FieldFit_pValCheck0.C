...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.02266,50,42.6033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.26007);
   Graph_Graph01025->SetMaximum(31.8407);
   ...
   mainFit1026->SetChisquare(2.437739);
   ...
   mainFit1026->SetParameter(0,-1.777622);
   mainFit1026->SetParError(0,0.5076491);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8700145);
   mainFit1026->SetParError(1,0.02009963);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0201");
   pt_LaTex = pt->AddText("#minus1.78#pm0.508");
   pt_LaTex = pt->AddText("#minus2.04#pm0.591");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.043209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.043209,-54.26007,2.043209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.437739);
   ...
   mainFit1027->SetParameter(0,-1.777622);
   mainFit1027->SetParError(0,0.5076491);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8700145);
   mainFit1027->SetParError(1,0.02009963);
