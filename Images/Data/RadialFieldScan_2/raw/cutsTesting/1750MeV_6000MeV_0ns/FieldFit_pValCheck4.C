...
//=========  (Wed Apr 21 14:56:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.06096);
   Graph_Graph01033->SetMaximum(51.65048);
   ...
   mainFit1034->SetChisquare(0.8321496);
   ...
   mainFit1034->SetParameter(0,-1.354476);
   mainFit1034->SetParError(0,0.590933);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8528365);
   mainFit1034->SetParError(1,0.01964984);
   ...
   pt_LaTex = pt->AddText("0.853#pm0.0196");
   pt_LaTex = pt->AddText("#minus1.35#pm0.591");
   pt_LaTex = pt->AddText("#minus1.59#pm0.677");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.588202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.588202,-56.06096,1.588202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.8321496);
   ...
   mainFit1035->SetParameter(0,-1.354476);
   mainFit1035->SetParError(0,0.590933);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8528365);
   mainFit1035->SetParError(1,0.01964984);
