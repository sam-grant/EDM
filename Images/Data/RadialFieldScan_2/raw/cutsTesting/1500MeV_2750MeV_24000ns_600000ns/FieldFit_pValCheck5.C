...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.03583,70,56.78869);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.35338);
   Graph_Graph01035->SetMaximum(47.10624);
   ...
   mainFit1036->SetChisquare(1.537644);
   ...
   mainFit1036->SetParameter(0,-0.02176405);
   mainFit1036->SetParError(0,0.6270073);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.760939);
   mainFit1036->SetParError(1,0.02166537);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.513");
   pt_LaTex = pt->AddText("0.761#pm0.0217");
   pt_LaTex = pt->AddText("#minus0.0218#pm0.627");
   pt_LaTex = pt->AddText("#minus0.0286#pm0.824");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.02860157,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.02860157,-30.35338,0.02860157,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.537644);
   ...
   mainFit1037->SetParameter(0,-0.02176405);
   mainFit1037->SetParError(0,0.6270073);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.760939);
   mainFit1037->SetParError(1,0.02166537);
