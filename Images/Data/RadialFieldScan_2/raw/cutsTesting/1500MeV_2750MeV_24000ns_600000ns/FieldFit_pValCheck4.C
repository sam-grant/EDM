...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.06282);
   Graph_Graph01033->SetMaximum(48.98892);
   ...
   mainFit1034->SetChisquare(1.614753);
   ...
   mainFit1034->SetParameter(0,-0.4116209);
   mainFit1034->SetParError(0,0.7499235);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7754969);
   mainFit1034->SetParError(1,0.0246954);
   ...
   pt_LaTex = pt->AddText("0.775#pm0.0247");
   pt_LaTex = pt->AddText("#minus0.412#pm 0.75");
   pt_LaTex = pt->AddText("#minus0.531#pm0.959");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5307835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5307835,-51.06282,0.5307835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.614753);
   ...
   mainFit1035->SetParameter(0,-0.4116209);
   mainFit1035->SetParError(0,0.7499235);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7754969);
   mainFit1035->SetParError(1,0.0246954);
