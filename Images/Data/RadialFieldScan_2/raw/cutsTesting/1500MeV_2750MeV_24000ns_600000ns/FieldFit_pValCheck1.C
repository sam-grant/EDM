...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.06282);
   Graph_Graph01027->SetMaximum(48.98892);
   ...
   mainFit1028->SetChisquare(0.4379248);
   ...
   mainFit1028->SetParameter(0,0.2262206);
   mainFit1028->SetParError(0,0.6691138);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7788596);
   mainFit1028->SetParError(1,0.02203074);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.146");
   pt_LaTex = pt->AddText("0.779#pm0.022");
   pt_LaTex = pt->AddText("0.226#pm0.669");
   pt_LaTex = pt->AddText(" 0.29#pm0.859");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2904511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2904511,-51.06282,-0.2904511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4379248);
   ...
   mainFit1029->SetParameter(0,0.2262206);
   mainFit1029->SetParError(0,0.6691138);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7788596);
   mainFit1029->SetParError(1,0.02203074);
