...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.06282);
   Graph_Graph01031->SetMaximum(48.98892);
   ...
   mainFit1032->SetChisquare(1.959363);
   ...
   mainFit1032->SetParameter(0,-0.1571721);
   mainFit1032->SetParError(0,0.6872905);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7669468);
   mainFit1032->SetParError(1,0.02041433);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.653");
   pt_LaTex = pt->AddText("0.767#pm0.0204");
   pt_LaTex = pt->AddText("#minus0.157#pm0.687");
   pt_LaTex = pt->AddText("#minus0.205#pm0.895");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2049322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2049322,-51.06282,0.2049322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.959363);
   ...
   mainFit1033->SetParameter(0,-0.1571721);
   mainFit1033->SetParError(0,0.6872905);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7669468);
   mainFit1033->SetParError(1,0.02041433);
