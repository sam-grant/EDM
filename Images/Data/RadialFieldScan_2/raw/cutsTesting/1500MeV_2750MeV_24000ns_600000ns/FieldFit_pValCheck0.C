...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.1284,50,39.29095);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.28646);
   Graph_Graph01025->SetMaximum(29.44902);
   ...
   mainFit1026->SetChisquare(1.226241);
   ...
   mainFit1026->SetParameter(0,-0.3504799);
   mainFit1026->SetParError(0,0.6438214);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7529602);
   mainFit1026->SetParError(1,0.02546335);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.409");
   pt_LaTex = pt->AddText("0.753#pm0.0255");
   pt_LaTex = pt->AddText("#minus0.35#pm0.644");
   pt_LaTex = pt->AddText("#minus0.465#pm0.857");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.4654693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4654693,-49.28646,0.4654693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.226241);
   ...
   mainFit1027->SetParameter(0,-0.3504799);
   mainFit1027->SetParError(0,0.6438214);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7529602);
   mainFit1027->SetParError(1,0.02546335);
