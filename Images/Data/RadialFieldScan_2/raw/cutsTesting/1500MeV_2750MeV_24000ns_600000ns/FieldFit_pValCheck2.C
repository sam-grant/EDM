...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-63.56929,75,61.49538);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-51.06282);
   Graph_Graph01029->SetMaximum(48.98892);
   ...
   mainFit1030->SetChisquare(1.811886);
   ...
   mainFit1030->SetParameter(0,-0.2434724);
   mainFit1030->SetParError(0,0.6496938);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7661856);
   mainFit1030->SetParError(1,0.01978478);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.604");
   pt_LaTex = pt->AddText("0.766#pm0.0198");
   pt_LaTex = pt->AddText("#minus0.243#pm 0.65");
   pt_LaTex = pt->AddText("#minus0.318#pm0.847");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3177721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3177721,-51.06282,0.3177721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.811886);
   ...
   mainFit1031->SetParameter(0,-0.2434724);
   mainFit1031->SetParError(0,0.6496938);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7661856);
   mainFit1031->SetParError(1,0.01978478);
