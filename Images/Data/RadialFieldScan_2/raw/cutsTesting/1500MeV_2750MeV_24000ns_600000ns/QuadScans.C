...
//=========  (Tue Apr 27 00:34:41 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.849588);
   ...
   quadLineFit1002->SetParameter(0,74.84754);
   quadLineFit1002->SetParError(0,0.09090612);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.12652);
   quadLineFit1002->SetParError(1,1.524749);
   ...
   quadLineFit1003->SetChisquare(1.849588);
   ...
   quadLineFit1003->SetParameter(0,74.84754);
   quadLineFit1003->SetParError(0,0.09090612);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.12652);
   quadLineFit1003->SetParError(1,1.524749);
   ...
   Graph_30_ppm1003->SetMinimum(75.88771);
   Graph_30_ppm1003->SetMaximum(76.44166);
   ...
   quadLineFit1004->SetChisquare(2.339135);
   ...
   quadLineFit1004->SetParameter(0,74.83686);
   quadLineFit1004->SetParError(0,0.07652159);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.63002);
   quadLineFit1004->SetParError(1,1.257706);
   ...
   quadLineFit1005->SetChisquare(2.339135);
   ...
   quadLineFit1005->SetParameter(0,74.83686);
   quadLineFit1005->SetParError(0,0.07652159);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.63002);
   quadLineFit1005->SetParError(1,1.257706);
   ...
   Graph_10_ppm1005->SetMinimum(74.97145);
   Graph_10_ppm1005->SetMaximum(75.21577);
   ...
   quadLineFit1006->SetChisquare(0.001531999);
   ...
   quadLineFit1006->SetParameter(0,74.59973);
   quadLineFit1006->SetParError(0,0.08966745);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.033638);
   quadLineFit1006->SetParError(1,1.454204);
   ...
   quadLineFit1007->SetChisquare(0.001531999);
   ...
   quadLineFit1007->SetParameter(0,74.59973);
   quadLineFit1007->SetParError(0,0.08966745);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.033638);
   quadLineFit1007->SetParError(1,1.454204);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.91273);
   Graph_mI10_ppm1007->SetMaximum(74.18511);
   ...
   quadLineFit1008->SetChisquare(6.964423);
   ...
   quadLineFit1008->SetParameter(0,74.5128);
   quadLineFit1008->SetParError(0,0.07923798);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.77363);
   quadLineFit1008->SetParError(1,1.289797);
   ...
   quadLineFit1009->SetChisquare(6.964423);
   ...
   quadLineFit1009->SetParameter(0,74.5128);
   quadLineFit1009->SetParError(0,0.07923798);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.77363);
   quadLineFit1009->SetParError(1,1.289797);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.68561);
   Graph_mI30_ppm1009->SetMaximum(73.27971);
   ...
   quadLineFit1010->SetChisquare(0.165825);
   ...
   quadLineFit1010->SetParameter(0,74.3779);
   quadLineFit1010->SetParError(0,0.07446993);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.60957);
   quadLineFit1010->SetParError(1,1.288841);
   ...
   quadLineFit1011->SetChisquare(0.165825);
   ...
   quadLineFit1011->SetParameter(0,74.3779);
   quadLineFit1011->SetParError(0,0.07446993);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.60957);
   quadLineFit1011->SetParError(1,1.288841);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.80975);
   Graph_mI50_ppm1011->SetMaximum(72.39918);
   ...
   quadLineFit1012->SetChisquare(0.186515);
   ...
   quadLineFit1012->SetParameter(0,74.38822);
   quadLineFit1012->SetParError(0,0.1502548);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.0367);
   quadLineFit1012->SetParError(1,2.688474);
   ...
   quadLineFit1013->SetChisquare(0.186515);
   ...
   quadLineFit1013->SetParameter(0,74.38822);
   quadLineFit1013->SetParError(0,0.1502548);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.0367);
   quadLineFit1013->SetParError(1,2.688474);
