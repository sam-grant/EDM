...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.06282);
   Graph_Graph01020->SetMaximum(48.98892);
   ...
   mainFit1021->SetChisquare(1.960611);
   ...
   mainFit1021->SetParameter(0,-0.1451796);
   mainFit1021->SetParError(0,0.5975991);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7667615);
   mainFit1021->SetParError(1,0.01972896);
   ...
   pt_LaTex = pt->AddText("0.767#pm0.0197");
   pt_LaTex = pt->AddText("#minus0.145#pm0.598");
   pt_LaTex = pt->AddText("#minus0.189#pm0.779");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1893413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1893413,-51.06282,0.1893413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.960611);
   ...
   mainFit1022->SetParameter(0,-0.1451796);
   mainFit1022->SetParError(0,0.5975991);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7667615);
   mainFit1022->SetParError(1,0.01972896);
