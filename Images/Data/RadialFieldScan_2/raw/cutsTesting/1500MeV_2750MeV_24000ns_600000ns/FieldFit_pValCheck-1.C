...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.06282);
   Graph_Graph01023->SetMaximum(48.98892);
   ...
   mainFit1024->SetChisquare(1.960611);
   ...
   mainFit1024->SetParameter(0,-0.1451796);
   mainFit1024->SetParError(0,0.5975991);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7667615);
   mainFit1024->SetParError(1,0.01972896);
   ...
   mainFit1025->SetChisquare(1.960611);
   ...
   mainFit1025->SetParameter(0,-0.1451796);
   mainFit1025->SetParError(0,0.5975991);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7667615);
   mainFit1025->SetParError(1,0.01972896);
