...
//=========  (Tue Apr 27 00:34:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01967691);
   Graph_Graph11015->SetMaximum(0.03474681);
   ...
   Graph_Graph21016->SetMinimum(-0.0006012978);
   Graph_Graph21016->SetMaximum(0.000510588);
   ...
   Graph_Graph31017->SetMinimum(-0.04515085);
   Graph_Graph31017->SetMaximum(0.03302007);
   ...
   Graph_Graph41018->SetMinimum(-0.005545388);
   Graph_Graph41018->SetMaximum(0.007257327);
   ...
   Graph_Graph51019->SetMinimum(-0.005263762);
   Graph_Graph51019->SetMaximum(0.007033328);
