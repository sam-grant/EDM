...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.10368);
   Graph_Graph01020->SetMaximum(53.99498);
   ...
   mainFit1021->SetChisquare(1.872814);
   ...
   mainFit1021->SetParameter(0,-1.425529);
   mainFit1021->SetParError(0,0.3973743);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.901656);
   mainFit1021->SetParError(1,0.01318329);
   ...
   mainFit1022->SetChisquare(1.872814);
   ...
   mainFit1022->SetParameter(0,-1.425529);
   mainFit1022->SetParError(0,0.3973743);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.901656);
   mainFit1022->SetParError(1,0.01318329);
