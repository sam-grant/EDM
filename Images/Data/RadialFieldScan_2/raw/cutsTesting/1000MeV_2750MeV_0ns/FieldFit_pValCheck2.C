...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.10368);
   Graph_Graph01029->SetMaximum(53.99498);
   ...
   mainFit1030->SetChisquare(0.4303553);
   ...
   mainFit1030->SetParameter(0,-1.629428);
   mainFit1030->SetParError(0,0.4321117);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9004077);
   mainFit1030->SetParError(1,0.01322471);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.143");
   pt_LaTex = pt->AddText("  0.9#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.63#pm0.432");
   pt_LaTex = pt->AddText("#minus1.81#pm0.478");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.809656,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.809656,-58.10368,1.809656,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.4303553);
   ...
   mainFit1031->SetParameter(0,-1.629428);
   mainFit1031->SetParError(0,0.4321117);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9004077);
   mainFit1031->SetParError(1,0.01322471);
