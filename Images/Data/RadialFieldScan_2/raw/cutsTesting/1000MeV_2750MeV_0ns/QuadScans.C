...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(6.201517);
   ...
   quadLineFit1002->SetParameter(0,74.59446);
   quadLineFit1002->SetParError(0,0.06138255);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.62403);
   quadLineFit1002->SetParError(1,1.029396);
   ...
   quadLineFit1003->SetChisquare(6.201517);
   ...
   quadLineFit1003->SetParameter(0,74.59446);
   quadLineFit1003->SetParError(0,0.06138255);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.62403);
   quadLineFit1003->SetParError(1,1.029396);
   ...
   Graph_30_ppm1003->SetMinimum(75.79028);
   Graph_30_ppm1003->SetMaximum(76.4214);
   ...
   quadLineFit1004->SetChisquare(0.3934851);
   ...
   quadLineFit1004->SetParameter(0,74.568);
   quadLineFit1004->SetParError(0,0.05093698);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.04111);
   quadLineFit1004->SetParError(1,0.8366993);
   ...
   quadLineFit1005->SetChisquare(0.3934851);
   ...
   quadLineFit1005->SetParameter(0,74.568);
   quadLineFit1005->SetParError(0,0.05093698);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.04111);
   quadLineFit1005->SetParError(1,0.8366993);
   ...
   Graph_10_ppm1005->SetMinimum(74.84418);
   Graph_10_ppm1005->SetMaximum(75.09236);
   ...
   quadLineFit1006->SetChisquare(1.951591);
   ...
   quadLineFit1006->SetParameter(0,74.42689);
   quadLineFit1006->SetParError(0,0.05972193);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.650644);
   quadLineFit1006->SetParError(1,0.9681347);
   ...
   quadLineFit1007->SetChisquare(1.951591);
   ...
   quadLineFit1007->SetParameter(0,74.42689);
   quadLineFit1007->SetParError(0,0.05972193);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.650644);
   quadLineFit1007->SetParError(1,0.9681347);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.66855);
   Graph_mI10_ppm1007->SetMaximum(73.96087);
   ...
   quadLineFit1008->SetChisquare(1.546479);
   ...
   quadLineFit1008->SetParameter(0,74.43761);
   quadLineFit1008->SetParError(0,0.05241168);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.28184);
   quadLineFit1008->SetParError(1,0.8526243);
   ...
   quadLineFit1009->SetChisquare(1.546479);
   ...
   quadLineFit1009->SetParameter(0,74.43761);
   quadLineFit1009->SetParError(0,0.05241168);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.28184);
   quadLineFit1009->SetParError(1,0.8526243);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.30789);
   Graph_mI30_ppm1009->SetMaximum(73.03886);
   ...
   quadLineFit1010->SetChisquare(2.712881);
   ...
   quadLineFit1010->SetParameter(0,74.44821);
   quadLineFit1010->SetParError(0,0.04951858);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.7259);
   quadLineFit1010->SetParError(1,0.8564948);
   ...
   quadLineFit1011->SetChisquare(2.712881);
   ...
   quadLineFit1011->SetParameter(0,74.44821);
   quadLineFit1011->SetParError(0,0.04951858);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.7259);
   quadLineFit1011->SetParError(1,0.8564948);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.41682);
   Graph_mI50_ppm1011->SetMaximum(72.08232);
   ...
   quadLineFit1012->SetChisquare(0.803789);
   ...
   quadLineFit1012->SetParameter(0,74.42876);
   quadLineFit1012->SetParError(0,0.1000373);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.97255);
   quadLineFit1012->SetParError(1,1.789569);
   ...
   quadLineFit1013->SetChisquare(0.803789);
   ...
   quadLineFit1013->SetParameter(0,74.42876);
   quadLineFit1013->SetParError(0,0.1000373);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.97255);
   quadLineFit1013->SetParError(1,1.789569);
