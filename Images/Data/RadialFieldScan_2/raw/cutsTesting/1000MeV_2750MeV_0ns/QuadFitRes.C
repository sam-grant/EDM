...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006276718);
   Graph_Graph11015->SetMaximum(0.005784929);
   ...
   Graph_Graph21016->SetMinimum(-0.01211913);
   Graph_Graph21016->SetMaximum(0.01423082);
   ...
   Graph_Graph31017->SetMinimum(-0.01432118);
   Graph_Graph31017->SetMaximum(0.01402478);
   ...
   Graph_Graph41018->SetMinimum(-0.01501402);
   Graph_Graph41018->SetMaximum(0.02017066);
   ...
   Graph_Graph51019->SetMinimum(-0.007294225);
   Graph_Graph51019->SetMaximum(0.009731792);
