...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.10368);
   Graph_Graph01033->SetMaximum(53.99498);
   ...
   mainFit1034->SetChisquare(1.703487);
   ...
   mainFit1034->SetParameter(0,-1.302247);
   mainFit1034->SetParError(0,0.4977022);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8975872);
   mainFit1034->SetParError(1,0.01649111);
   ...
   pt_LaTex = pt->AddText("0.898#pm0.0165");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.498");
   pt_LaTex = pt->AddText("#minus1.45#pm0.543");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.450831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.450831,-58.10368,1.450831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.703487);
   ...
   mainFit1035->SetParameter(0,-1.302247);
   mainFit1035->SetParError(0,0.4977022);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8975872);
   mainFit1035->SetParError(1,0.01649111);
