...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.10368);
   Graph_Graph01023->SetMaximum(53.99498);
   ...
   mainFit1024->SetChisquare(1.872814);
   ...
   mainFit1024->SetParameter(0,-1.425529);
   mainFit1024->SetParError(0,0.3973743);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.901656);
   mainFit1024->SetParError(1,0.01318329);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.468");
   pt_LaTex = pt->AddText("0.902#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.43#pm0.397");
   pt_LaTex = pt->AddText("#minus1.58#pm0.438");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.581012,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.581012,-58.10368,1.581012,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.872814);
   ...
   mainFit1025->SetParameter(0,-1.425529);
   mainFit1025->SetParError(0,0.3973743);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.901656);
   mainFit1025->SetParError(1,0.01318329);
