...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.4221,50,44.53779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.22611);
   Graph_Graph01025->SetMaximum(33.3418);
   ...
   mainFit1026->SetChisquare(1.870754);
   ...
   mainFit1026->SetParameter(0,-1.418382);
   mainFit1026->SetParError(0,0.4276819);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9021465);
   mainFit1026->SetParError(1,0.01693507);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.624");
   pt_LaTex = pt->AddText("0.902#pm0.0169");
   pt_LaTex = pt->AddText("#minus1.42#pm0.428");
   pt_LaTex = pt->AddText("#minus1.57#pm0.478");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.57223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.57223,-56.22611,1.57223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.870754);
   ...
   mainFit1027->SetParameter(0,-1.418382);
   mainFit1027->SetParError(0,0.4276819);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9021465);
   mainFit1027->SetParError(1,0.01693507);
