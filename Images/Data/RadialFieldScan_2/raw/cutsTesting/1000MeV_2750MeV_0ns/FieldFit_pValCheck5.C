...
//=========  (Mon Apr 26 21:28:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-48.14135,70,63.21238);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.00597);
   Graph_Graph01035->SetMaximum(52.07701);
   ...
   mainFit1036->SetChisquare(1.787747);
   ...
   mainFit1036->SetParameter(0,-1.389119);
   mainFit1036->SetParError(0,0.4165519);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8999207);
   mainFit1036->SetParError(1,0.01447514);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.596");
   pt_LaTex = pt->AddText("  0.9#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.39#pm0.417");
   pt_LaTex = pt->AddText("#minus1.54#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.543601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.543601,-37.00597,1.543601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.787747);
   ...
   mainFit1037->SetParameter(0,-1.389119);
   mainFit1037->SetParError(0,0.4165519);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8999207);
   mainFit1037->SetParError(1,0.01447514);
