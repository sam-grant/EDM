...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.10368);
   Graph_Graph01031->SetMaximum(53.99498);
   ...
   mainFit1032->SetChisquare(1.824781);
   ...
   mainFit1032->SetParameter(0,-1.475297);
   mainFit1032->SetParError(0,0.457617);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9024289);
   mainFit1032->SetParError(1,0.0136373);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.608");
   pt_LaTex = pt->AddText("0.902#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.48#pm0.458");
   pt_LaTex = pt->AddText("#minus1.63#pm0.501");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.634807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.634807,-58.10368,1.634807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.824781);
   ...
   mainFit1033->SetParameter(0,-1.475297);
   mainFit1033->SetParError(0,0.457617);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9024289);
   mainFit1033->SetParError(1,0.0136373);
