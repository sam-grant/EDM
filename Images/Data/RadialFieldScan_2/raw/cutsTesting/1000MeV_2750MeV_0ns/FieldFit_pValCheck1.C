...
//=========  (Mon Apr 26 21:28:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.11601,75,68.00731);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-58.10368);
   Graph_Graph01027->SetMaximum(53.99498);
   ...
   mainFit1028->SetChisquare(1.090158);
   ...
   mainFit1028->SetParameter(0,-1.246492);
   mainFit1028->SetParError(0,0.4459571);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9075654);
   mainFit1028->SetParError(1,0.01477545);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.363");
   pt_LaTex = pt->AddText("0.908#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.25#pm0.446");
   pt_LaTex = pt->AddText("#minus1.37#pm0.494");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.373446,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.373446,-58.10368,1.373446,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.090158);
   ...
   mainFit1029->SetParameter(0,-1.246492);
   mainFit1029->SetParError(0,0.4459571);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9075654);
   mainFit1029->SetParError(1,0.01477545);
