...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.30751);
   Graph_Graph01027->SetMaximum(63.48211);
   ...
   mainFit1028->SetChisquare(2.927914);
   ...
   mainFit1028->SetParameter(0,-1.380658);
   mainFit1028->SetParError(0,0.7191703);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.030952);
   mainFit1028->SetParError(1,0.02377333);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0238");
   pt_LaTex = pt->AddText("#minus1.38#pm0.719");
   pt_LaTex = pt->AddText("#minus1.34#pm0.701");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.339208,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.339208,-63.30751,1.339208,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.927914);
   ...
   mainFit1029->SetParameter(0,-1.380658);
   mainFit1029->SetParError(0,0.7191703);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.030952);
   mainFit1029->SetParError(1,0.02377333);
