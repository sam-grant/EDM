...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.30751);
   Graph_Graph01020->SetMaximum(63.48211);
   ...
   mainFit1021->SetChisquare(7.737448);
   ...
   mainFit1021->SetParameter(0,-2.093501);
   mainFit1021->SetParError(0,0.6415189);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.00755);
   mainFit1021->SetParError(1,0.02124493);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0212");
   pt_LaTex = pt->AddText("#minus2.09#pm0.642");
   pt_LaTex = pt->AddText("#minus2.08#pm0.631");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.077813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.077813,-63.30751,2.077813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.737448);
   ...
   mainFit1022->SetParameter(0,-2.093501);
   mainFit1022->SetParError(0,0.6415189);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.00755);
   mainFit1022->SetParError(1,0.02124493);
