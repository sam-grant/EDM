...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7524958);
   ...
   quadLineFit1002->SetParameter(0,74.11146);
   quadLineFit1002->SetParError(0,0.09851926);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,51.26353);
   quadLineFit1002->SetParError(1,1.652777);
   ...
   quadLineFit1003->SetChisquare(0.7524958);
   ...
   quadLineFit1003->SetParameter(0,74.11146);
   quadLineFit1003->SetParError(0,0.09851926);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,51.26353);
   quadLineFit1003->SetParError(1,1.652777);
   ...
   Graph_30_ppm1003->SetMinimum(75.61101);
   Graph_30_ppm1003->SetMaximum(76.27838);
   ...
   quadLineFit1004->SetChisquare(0.5160191);
   ...
   quadLineFit1004->SetParameter(0,74.35656);
   quadLineFit1004->SetParError(0,0.08239675);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.78767);
   quadLineFit1004->SetParError(1,1.354166);
   ...
   quadLineFit1005->SetChisquare(0.5160191);
   ...
   quadLineFit1005->SetParameter(0,74.35656);
   quadLineFit1005->SetParError(0,0.08239675);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.78767);
   quadLineFit1005->SetParError(1,1.354166);
   ...
   Graph_10_ppm1005->SetMinimum(74.56845);
   Graph_10_ppm1005->SetMaximum(74.83611);
   ...
   quadLineFit1006->SetChisquare(3.173783);
   ...
   quadLineFit1006->SetParameter(0,74.16831);
   quadLineFit1006->SetParError(0,0.09647016);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.351992);
   quadLineFit1006->SetParError(1,1.564521);
   ...
   quadLineFit1007->SetChisquare(3.173783);
   ...
   quadLineFit1007->SetParameter(0,74.16831);
   quadLineFit1007->SetParError(0,0.09647016);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.351992);
   quadLineFit1007->SetParError(1,1.564521);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.18938);
   Graph_mI10_ppm1007->SetMaximum(73.57554);
   ...
   quadLineFit1008->SetChisquare(1.287429);
   ...
   quadLineFit1008->SetParameter(0,74.18246);
   quadLineFit1008->SetParError(0,0.08470861);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-13.1466);
   quadLineFit1008->SetParError(1,1.378748);
   ...
   quadLineFit1009->SetChisquare(1.287429);
   ...
   quadLineFit1009->SetParameter(0,74.18246);
   quadLineFit1009->SetParError(0,0.08470861);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-13.1466);
   quadLineFit1009->SetParError(1,1.378748);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.70262);
   Graph_mI30_ppm1009->SetMaximum(72.51791);
   ...
   quadLineFit1010->SetChisquare(4.099566);
   ...
   quadLineFit1010->SetParameter(0,74.08531);
   quadLineFit1010->SetParError(0,0.07974886);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-31.86696);
   quadLineFit1010->SetParError(1,1.380019);
   ...
   quadLineFit1011->SetChisquare(4.099566);
   ...
   quadLineFit1011->SetParameter(0,74.08531);
   quadLineFit1011->SetParError(0,0.07974886);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-31.86696);
   quadLineFit1011->SetParError(1,1.380019);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.72446);
   Graph_mI50_ppm1011->SetMaximum(71.44956);
   ...
   quadLineFit1012->SetChisquare(0.4180851);
   ...
   quadLineFit1012->SetParameter(0,73.93169);
   quadLineFit1012->SetParError(0,0.1615879);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.85037);
   quadLineFit1012->SetParError(1,2.891344);
   ...
   quadLineFit1013->SetChisquare(0.4180851);
   ...
   quadLineFit1013->SetParameter(0,73.93169);
   quadLineFit1013->SetParError(0,0.1615879);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.85037);
   quadLineFit1013->SetParError(1,2.891344);
