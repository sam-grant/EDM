...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01299168);
   Graph_Graph11015->SetMaximum(0.01242797);
   ...
   Graph_Graph21016->SetMinimum(-0.024999);
   Graph_Graph21016->SetMaximum(0.02941724);
   ...
   Graph_Graph31017->SetMinimum(-0.02069355);
   Graph_Graph31017->SetMaximum(0.01463494);
   ...
   Graph_Graph41018->SetMinimum(-0.0212795);
   Graph_Graph41018->SetMaximum(0.0356583);
   ...
   Graph_Graph51019->SetMinimum(-0.008473596);
   Graph_Graph51019->SetMaximum(0.01132803);
