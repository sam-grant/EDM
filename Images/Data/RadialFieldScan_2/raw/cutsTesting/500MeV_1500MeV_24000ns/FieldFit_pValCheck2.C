...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-79.15622,75,79.33082);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-63.30751);
   Graph_Graph01029->SetMaximum(63.48211);
   ...
   mainFit1030->SetChisquare(7.670146);
   ...
   mainFit1030->SetParameter(0,-2.164508);
   mainFit1030->SetParError(0,0.6974469);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.007122);
   mainFit1030->SetParError(1,0.02131057);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.56");
   pt_LaTex = pt->AddText(" 1.01#pm0.0213");
   pt_LaTex = pt->AddText("#minus2.16#pm0.697");
   pt_LaTex = pt->AddText("#minus2.15#pm0.689");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.149203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.149203,-63.30751,2.149203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.670146);
   ...
   mainFit1031->SetParameter(0,-2.164508);
   mainFit1031->SetParError(0,0.6974469);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.007122);
   mainFit1031->SetParError(1,0.02131057);
