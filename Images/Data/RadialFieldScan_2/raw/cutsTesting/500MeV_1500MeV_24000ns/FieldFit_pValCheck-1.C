...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.30751);
   Graph_Graph01023->SetMaximum(63.48211);
   ...
   mainFit1024->SetChisquare(7.737448);
   ...
   mainFit1024->SetParameter(0,-2.093501);
   mainFit1024->SetParError(0,0.6415189);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.00755);
   mainFit1024->SetParError(1,0.02124493);
   ...
   mainFit1025->SetChisquare(7.737448);
   ...
   mainFit1025->SetParameter(0,-2.093501);
   mainFit1025->SetParError(0,0.6415189);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.00755);
   mainFit1025->SetParError(1,0.02124493);
