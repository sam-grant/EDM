...
//=========  (Wed Apr 21 19:53:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.7126,50,47.11272);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.73006);
   Graph_Graph01025->SetMaximum(35.13019);
   ...
   mainFit1026->SetChisquare(1.418859);
   ...
   mainFit1026->SetParameter(0,-2.740454);
   mainFit1026->SetParError(0,0.6912193);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9642112);
   mainFit1026->SetParError(1,0.02736195);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.473");
   pt_LaTex = pt->AddText("0.964#pm0.0274");
   pt_LaTex = pt->AddText("#minus2.74#pm0.691");
   pt_LaTex = pt->AddText("#minus2.84#pm0.731");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.842172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.842172,-60.73006,2.842172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.418859);
   ...
   mainFit1027->SetParameter(0,-2.740454);
   mainFit1027->SetParError(0,0.6912193);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9642112);
   mainFit1027->SetParError(1,0.02736195);
