...
//=========  (Wed Apr 21 19:53:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.7878,70,74.45714);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.86331);
   Graph_Graph01035->SetMaximum(61.53264);
   ...
   mainFit1036->SetChisquare(6.697757);
   ...
   mainFit1036->SetParameter(0,-2.299023);
   mainFit1036->SetParError(0,0.6724339);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.017352);
   mainFit1036->SetParError(1,0.02331671);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0233");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.672");
   pt_LaTex = pt->AddText("#minus2.26#pm0.649");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.25981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.25981,-41.86331,2.25981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.697757);
   ...
   mainFit1037->SetParameter(0,-2.299023);
   mainFit1037->SetParError(0,0.6724339);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.017352);
   mainFit1037->SetParError(1,0.02331671);
