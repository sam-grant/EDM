...
//=========  (Wed Apr 21 19:53:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.30751);
   Graph_Graph01033->SetMaximum(63.48211);
   ...
   mainFit1034->SetChisquare(7.523238);
   ...
   mainFit1034->SetParameter(0,-2.318236);
   mainFit1034->SetParError(0,0.804545);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.014962);
   mainFit1034->SetParError(1,0.0265978);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0266");
   pt_LaTex = pt->AddText("#minus2.32#pm0.805");
   pt_LaTex = pt->AddText("#minus2.28#pm0.767");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.284062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.284062,-63.30751,2.284062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.523238);
   ...
   mainFit1035->SetParameter(0,-2.318236);
   mainFit1035->SetParError(0,0.804545);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.014962);
   mainFit1035->SetParError(1,0.0265978);
