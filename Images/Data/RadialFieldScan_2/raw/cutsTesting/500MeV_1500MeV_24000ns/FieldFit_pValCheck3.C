...
//=========  (Wed Apr 21 19:53:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.30751);
   Graph_Graph01031->SetMaximum(63.48211);
   ...
   mainFit1032->SetChisquare(7.055713);
   ...
   mainFit1032->SetParameter(0,-1.791645);
   mainFit1032->SetParError(0,0.7383864);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.002922);
   mainFit1032->SetParError(1,0.02197355);
   ...
   pt_LaTex = pt->AddText("#minus1.79#pm0.738");
   pt_LaTex = pt->AddText("#minus1.79#pm0.727");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.786425,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.786425,-63.30751,1.786425,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.055713);
   ...
   mainFit1033->SetParameter(0,-1.791645);
   mainFit1033->SetParError(0,0.7383864);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.002922);
   mainFit1033->SetParError(1,0.02197355);
