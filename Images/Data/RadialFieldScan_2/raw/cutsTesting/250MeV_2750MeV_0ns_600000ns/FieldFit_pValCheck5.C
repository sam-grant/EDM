...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.99957,70,64.77272);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.52234);
   Graph_Graph01035->SetMaximum(53.29549);
   ...
   mainFit1036->SetChisquare(6.856795);
   ...
   mainFit1036->SetParameter(0,-1.923504);
   mainFit1036->SetParError(0,0.3475423);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.948274);
   mainFit1036->SetParError(1,0.01201033);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.29");
   pt_LaTex = pt->AddText("0.948#pm0.012");
   pt_LaTex = pt->AddText("#minus1.92#pm0.348");
   pt_LaTex = pt->AddText("#minus2.03#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.028427,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.028427,-38.52234,2.028427,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.856795);
   ...
   mainFit1037->SetParameter(0,-1.923504);
   mainFit1037->SetParError(0,0.3475423);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.948274);
   mainFit1037->SetParError(1,0.01201033);
