...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.07039);
   Graph_Graph01027->SetMaximum(54.98168);
   ...
   mainFit1028->SetChisquare(9.888926);
   ...
   mainFit1028->SetParameter(0,-1.831882);
   mainFit1028->SetParError(0,0.3710293);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9358039);
   mainFit1028->SetParError(1,0.01221752);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  3.3");
   pt_LaTex = pt->AddText("0.936#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.83#pm0.371");
   pt_LaTex = pt->AddText("#minus1.96#pm0.399");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.957549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.957549,-57.07039,1.957549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(9.888926);
   ...
   mainFit1029->SetParameter(0,-1.831882);
   mainFit1029->SetParError(0,0.3710293);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9358039);
   mainFit1029->SetParError(1,0.01221752);
