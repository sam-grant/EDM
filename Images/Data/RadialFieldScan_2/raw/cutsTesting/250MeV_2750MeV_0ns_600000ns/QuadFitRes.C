...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01485118);
   Graph_Graph11015->SetMaximum(0.01312129);
   ...
   Graph_Graph21016->SetMinimum(-0.01070354);
   Graph_Graph21016->SetMaximum(0.01252856);
   ...
   Graph_Graph31017->SetMinimum(-0.01412819);
   Graph_Graph31017->SetMaximum(0.01908496);
   ...
   Graph_Graph41018->SetMinimum(-0.01430643);
   Graph_Graph41018->SetMaximum(0.02724531);
   ...
   Graph_Graph51019->SetMinimum(-0.004383628);
   Graph_Graph51019->SetMaximum(0.003291654);
