...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-66.53585,50,46.2829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.25397);
   Graph_Graph01025->SetMaximum(35.00103);
   ...
   mainFit1026->SetChisquare(9.758986);
   ...
   mainFit1026->SetParameter(0,-1.635325);
   mainFit1026->SetParError(0,0.3572066);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9454641);
   mainFit1026->SetParError(1,0.01412785);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.64#pm0.357");
   pt_LaTex = pt->AddText("#minus1.73#pm0.382");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.729654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.729654,-55.25397,1.729654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.758986);
   ...
   mainFit1027->SetParameter(0,-1.635325);
   mainFit1027->SetParError(0,0.3572066);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9454641);
   mainFit1027->SetParError(1,0.01412785);
