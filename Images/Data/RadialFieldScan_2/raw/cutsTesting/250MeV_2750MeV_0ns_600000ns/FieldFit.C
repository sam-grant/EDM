...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.07039);
   Graph_Graph01020->SetMaximum(54.98168);
   ...
   mainFit1021->SetChisquare(10.26158);
   ...
   mainFit1021->SetParameter(0,-1.729948);
   mainFit1021->SetParError(0,0.331334);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9391261);
   mainFit1021->SetParError(1,0.01093937);
   ...
   mainFit1022->SetChisquare(10.26158);
   ...
   mainFit1022->SetParameter(0,-1.729948);
   mainFit1022->SetParError(0,0.331334);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9391261);
   mainFit1022->SetParError(1,0.01093937);
