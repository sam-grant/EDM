...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-71.0769,75,68.98819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-57.07039);
   Graph_Graph01031->SetMaximum(54.98168);
   ...
   mainFit1032->SetChisquare(4.810327);
   ...
   mainFit1032->SetParameter(0,-1.289019);
   mainFit1032->SetParError(0,0.3813751);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9323379);
   mainFit1032->SetParError(1,0.01131913);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.0113");
   pt_LaTex = pt->AddText("#minus1.29#pm0.381");
   pt_LaTex = pt->AddText("#minus1.38#pm0.405");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.382567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.382567,-57.07039,1.382567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.810327);
   ...
   mainFit1033->SetParameter(0,-1.289019);
   mainFit1033->SetParError(0,0.3813751);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9323379);
   mainFit1033->SetParError(1,0.01131913);
