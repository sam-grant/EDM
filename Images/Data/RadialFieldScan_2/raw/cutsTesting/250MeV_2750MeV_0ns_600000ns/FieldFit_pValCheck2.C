...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.07039);
   Graph_Graph01029->SetMaximum(54.98168);
   ...
   mainFit1030->SetChisquare(6.731744);
   ...
   mainFit1030->SetParameter(0,-1.994291);
   mainFit1030->SetParError(0,0.3599701);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9375657);
   mainFit1030->SetParError(1,0.01097084);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.011");
   pt_LaTex = pt->AddText("#minus1.99#pm 0.36");
   pt_LaTex = pt->AddText("#minus2.13#pm0.382");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.127094,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.127094,-57.07039,2.127094,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.731744);
   ...
   mainFit1031->SetParameter(0,-1.994291);
   mainFit1031->SetParError(0,0.3599701);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9375657);
   mainFit1031->SetParError(1,0.01097084);
