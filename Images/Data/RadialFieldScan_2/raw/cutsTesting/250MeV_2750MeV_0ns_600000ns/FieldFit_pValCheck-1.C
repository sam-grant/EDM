...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.07039);
   Graph_Graph01023->SetMaximum(54.98168);
   ...
   mainFit1024->SetChisquare(10.26158);
   ...
   mainFit1024->SetParameter(0,-1.729948);
   mainFit1024->SetParError(0,0.331334);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9391261);
   mainFit1024->SetParError(1,0.01093937);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.57");
   pt_LaTex = pt->AddText("0.939#pm0.0109");
   pt_LaTex = pt->AddText("#minus1.73#pm0.331");
   pt_LaTex = pt->AddText("#minus1.84#pm 0.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.842082,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.842082,-57.07039,1.842082,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(10.26158);
   ...
   mainFit1025->SetParameter(0,-1.729948);
   mainFit1025->SetParError(0,0.331334);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9391261);
   mainFit1025->SetParError(1,0.01093937);
