...
//=========  (Tue Apr 27 00:04:11 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(13.02707);
   ...
   quadLineFit1002->SetParameter(0,74.56947);
   quadLineFit1002->SetParError(0,0.05046559);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.79812);
   quadLineFit1002->SetParError(1,0.8458801);
   ...
   quadLineFit1003->SetChisquare(13.02707);
   ...
   quadLineFit1003->SetParameter(0,74.56947);
   quadLineFit1003->SetParError(0,0.05046559);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.79812);
   quadLineFit1003->SetParError(1,0.8458801);
   ...
   Graph_30_ppm1003->SetMinimum(75.78645);
   Graph_30_ppm1003->SetMaximum(76.4531);
   ...
   quadLineFit1004->SetChisquare(2.218064);
   ...
   quadLineFit1004->SetParameter(0,74.46958);
   quadLineFit1004->SetParError(0,0.04254075);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.78123);
   quadLineFit1004->SetParError(1,0.6985476);
   ...
   quadLineFit1005->SetChisquare(2.218064);
   ...
   quadLineFit1005->SetParameter(0,74.46958);
   quadLineFit1005->SetParError(0,0.04254075);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.78123);
   quadLineFit1005->SetParError(1,0.6985476);
   ...
   Graph_10_ppm1005->SetMinimum(74.77174);
   Graph_10_ppm1005->SetMaximum(75.02339);
   ...
   quadLineFit1006->SetChisquare(2.170956);
   ...
   quadLineFit1006->SetParameter(0,74.33303);
   quadLineFit1006->SetParError(0,0.04996843);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.049383);
   quadLineFit1006->SetParError(1,0.8098944);
   ...
   quadLineFit1007->SetChisquare(2.170956);
   ...
   quadLineFit1007->SetParameter(0,74.33303);
   quadLineFit1007->SetParError(0,0.04996843);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.049383);
   quadLineFit1007->SetParError(1,0.8098944);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.47797);
   Graph_mI10_ppm1007->SetMaximum(73.8181);
   ...
   quadLineFit1008->SetChisquare(3.729751);
   ...
   quadLineFit1008->SetParameter(0,74.41871);
   quadLineFit1008->SetParError(0,0.0438289);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.55056);
   quadLineFit1008->SetParError(1,0.71288);
   ...
   quadLineFit1009->SetChisquare(3.729751);
   ...
   quadLineFit1009->SetParameter(0,74.41871);
   quadLineFit1009->SetParError(0,0.0438289);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.55056);
   quadLineFit1009->SetParError(1,0.71288);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.07582);
   Graph_mI30_ppm1009->SetMaximum(72.84169);
   ...
   quadLineFit1010->SetChisquare(4.362673);
   ...
   quadLineFit1010->SetParameter(0,74.31743);
   quadLineFit1010->SetParError(0,0.04128428);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.15688);
   quadLineFit1010->SetParError(1,0.7139724);
   ...
   quadLineFit1011->SetChisquare(4.362673);
   ...
   quadLineFit1011->SetParameter(0,74.31743);
   quadLineFit1011->SetParError(0,0.04128428);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.15688);
   quadLineFit1011->SetParError(1,0.7139724);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19923);
   Graph_mI50_ppm1011->SetMaximum(71.85034);
   ...
   quadLineFit1012->SetChisquare(0.2356492);
   ...
   quadLineFit1012->SetParameter(0,74.15413);
   quadLineFit1012->SetParError(0,0.08332463);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.24218);
   quadLineFit1012->SetParError(1,1.490541);
   ...
   quadLineFit1013->SetChisquare(0.2356492);
   ...
   quadLineFit1013->SetParameter(0,74.15413);
   quadLineFit1013->SetParError(0,0.08332463);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.24218);
   quadLineFit1013->SetParError(1,1.490541);
