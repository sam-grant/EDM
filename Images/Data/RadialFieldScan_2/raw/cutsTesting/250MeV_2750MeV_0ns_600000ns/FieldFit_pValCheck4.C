...
//=========  (Tue Apr 27 00:04:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.07039);
   Graph_Graph01033->SetMaximum(54.98168);
   ...
   mainFit1034->SetChisquare(10.01249);
   ...
   mainFit1034->SetParameter(0,-1.604712);
   mainFit1034->SetParError(0,0.4156288);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9350197);
   mainFit1034->SetParError(1,0.01368808);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.34");
   pt_LaTex = pt->AddText("0.935#pm0.0137");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.416");
   pt_LaTex = pt->AddText("#minus1.72#pm0.433");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.716233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.716233,-57.07039,1.716233,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(10.01249);
   ...
   mainFit1035->SetParameter(0,-1.604712);
   mainFit1035->SetParError(0,0.4156288);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9350197);
   mainFit1035->SetParError(1,0.01368808);
