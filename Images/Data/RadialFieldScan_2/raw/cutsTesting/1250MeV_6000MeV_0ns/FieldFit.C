...
//=========  (Wed Apr 21 14:48:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.87457);
   Graph_Graph01020->SetMaximum(53.24901);
   ...
   mainFit1021->SetChisquare(2.403586);
   ...
   mainFit1021->SetParameter(0,-1.395859);
   mainFit1021->SetParError(0,0.392482);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8931794);
   mainFit1021->SetParError(1,0.01298259);
   ...
   mainFit1022->SetChisquare(2.403586);
   ...
   mainFit1022->SetParameter(0,-1.395859);
   mainFit1022->SetParError(0,0.392482);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8931794);
   mainFit1022->SetParError(1,0.01298259);
