...
//=========  (Wed Apr 21 14:48:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.87457);
   Graph_Graph01023->SetMaximum(53.24901);
   ...
   mainFit1024->SetChisquare(2.403586);
   ...
   mainFit1024->SetParameter(0,-1.395859);
   mainFit1024->SetParError(0,0.392482);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8931794);
   mainFit1024->SetParError(1,0.01298259);
   ...
   pt_LaTex = pt->AddText(" #minus1.4#pm0.392");
   pt_LaTex = pt->AddText("#minus1.56#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.562798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.562798,-57.87457,1.562798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.403586);
   ...
   mainFit1025->SetParameter(0,-1.395859);
   mainFit1025->SetParError(0,0.392482);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8931794);
   mainFit1025->SetParError(1,0.01298259);
