...
//=========  (Wed Apr 21 14:48:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.87457);
   Graph_Graph01031->SetMaximum(53.24901);
   ...
   mainFit1032->SetChisquare(0.4849617);
   ...
   mainFit1032->SetParameter(0,-1.706474);
   mainFit1032->SetParError(0,0.4520272);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8979722);
   mainFit1032->SetParError(1,0.01343577);
   ...
   pt_LaTex = pt->AddText("0.898#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.71#pm0.452");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.497");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.900364,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.900364,-57.87457,1.900364,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.4849617);
   ...
   mainFit1033->SetParameter(0,-1.706474);
   mainFit1033->SetParError(0,0.4520272);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8979722);
   mainFit1033->SetParError(1,0.01343577);
