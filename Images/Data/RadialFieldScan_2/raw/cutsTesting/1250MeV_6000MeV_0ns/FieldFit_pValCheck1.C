...
//=========  (Wed Apr 21 14:48:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.87457);
   Graph_Graph01027->SetMaximum(53.24901);
   ...
   mainFit1028->SetChisquare(2.208901);
   ...
   mainFit1028->SetParameter(0,-1.308437);
   mainFit1028->SetParError(0,0.43966);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.89604);
   mainFit1028->SetParError(1,0.01451207);
   ...
   pt_LaTex = pt->AddText("0.896#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.31#pm 0.44");
   pt_LaTex = pt->AddText("#minus1.46#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.460244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.460244,-57.87457,1.460244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.208901);
   ...
   mainFit1029->SetParameter(0,-1.308437);
   mainFit1029->SetParError(0,0.43966);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.89604);
   mainFit1029->SetParError(1,0.01451207);
