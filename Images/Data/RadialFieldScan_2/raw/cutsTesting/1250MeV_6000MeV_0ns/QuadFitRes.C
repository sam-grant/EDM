...
//=========  (Wed Apr 21 14:48:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01704367);
   Graph_Graph11015->SetMaximum(0.01841405);
   ...
   Graph_Graph21016->SetMinimum(-0.01223859);
   Graph_Graph21016->SetMaximum(0.01436346);
   ...
   Graph_Graph31017->SetMinimum(-0.03751369);
   Graph_Graph31017->SetMaximum(0.03439562);
   ...
   Graph_Graph41018->SetMinimum(-0.006998698);
   Graph_Graph41018->SetMaximum(0.005135439);
   ...
   Graph_Graph51019->SetMinimum(-0.01252948);
   Graph_Graph51019->SetMaximum(0.01668088);
