...
//=========  (Wed Apr 21 14:48:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.696477);
   ...
   quadLineFit1002->SetParameter(0,74.72295);
   quadLineFit1002->SetParError(0,0.05999145);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.98295);
   quadLineFit1002->SetParError(1,1.005766);
   ...
   quadLineFit1003->SetChisquare(3.696477);
   ...
   quadLineFit1003->SetParameter(0,74.72295);
   quadLineFit1003->SetParError(0,0.05999145);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.98295);
   quadLineFit1003->SetParError(1,1.005766);
   ...
   Graph_30_ppm1003->SetMinimum(75.91064);
   Graph_30_ppm1003->SetMaximum(76.53325);
   ...
   quadLineFit1004->SetChisquare(2.826314);
   ...
   quadLineFit1004->SetParameter(0,74.67321);
   quadLineFit1004->SetParError(0,0.05034573);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.11111);
   quadLineFit1004->SetParError(1,0.8270189);
   ...
   quadLineFit1005->SetChisquare(2.826314);
   ...
   quadLineFit1005->SetParameter(0,74.67321);
   quadLineFit1005->SetParError(0,0.05034573);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.11111);
   quadLineFit1005->SetParError(1,0.8270189);
   ...
   Graph_10_ppm1005->SetMinimum(74.97256);
   Graph_10_ppm1005->SetMaximum(75.20134);
   ...
   quadLineFit1006->SetChisquare(2.035937);
   ...
   quadLineFit1006->SetParameter(0,74.59386);
   quadLineFit1006->SetParError(0,0.05906895);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.862187);
   quadLineFit1006->SetParError(1,0.9574768);
   ...
   quadLineFit1007->SetChisquare(2.035937);
   ...
   quadLineFit1007->SetParameter(0,74.59386);
   quadLineFit1007->SetParError(0,0.05906895);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.862187);
   quadLineFit1007->SetParError(1,0.9574768);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.82782);
   Graph_mI10_ppm1007->SetMaximum(74.11553);
   ...
   quadLineFit1008->SetChisquare(10.43257);
   ...
   quadLineFit1008->SetParameter(0,74.52704);
   quadLineFit1008->SetParError(0,0.05181675);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.325659);
   quadLineFit1008->SetParError(1,0.8429325);
   ...
   quadLineFit1009->SetChisquare(10.43257);
   ...
   quadLineFit1009->SetParameter(0,74.52704);
   quadLineFit1009->SetParError(0,0.05181675);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.325659);
   quadLineFit1009->SetParError(1,0.8429325);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.46963);
   Graph_mI30_ppm1009->SetMaximum(73.19152);
   ...
   quadLineFit1010->SetChisquare(0.302529);
   ...
   quadLineFit1010->SetParameter(0,74.59876);
   quadLineFit1010->SetParError(0,0.0489396);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.77617);
   quadLineFit1010->SetParError(1,0.8464065);
   ...
   quadLineFit1011->SetChisquare(0.302529);
   ...
   quadLineFit1011->SetParameter(0,74.59876);
   quadLineFit1011->SetParError(0,0.0489396);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.77617);
   quadLineFit1011->SetParError(1,0.8464065);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.58108);
   Graph_mI50_ppm1011->SetMaximum(72.24387);
   ...
   quadLineFit1012->SetChisquare(2.420457);
   ...
   quadLineFit1012->SetParameter(0,74.58822);
   quadLineFit1012->SetParError(0,0.09904631);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.84256);
   quadLineFit1012->SetParError(1,1.771717);
   ...
   quadLineFit1013->SetChisquare(2.420457);
   ...
   quadLineFit1013->SetParameter(0,74.58822);
   quadLineFit1013->SetParError(0,0.09904631);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.84256);
   quadLineFit1013->SetParError(1,1.771717);
