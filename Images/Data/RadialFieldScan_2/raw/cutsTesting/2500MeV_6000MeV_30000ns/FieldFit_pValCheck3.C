...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.38829);
   Graph_Graph01031->SetMaximum(52.53019);
   ...
   mainFit1032->SetChisquare(1.352194);
   ...
   mainFit1032->SetParameter(0,-0.577321);
   mainFit1032->SetParError(0,1.155233);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7977644);
   mainFit1032->SetParError(1,0.03431997);
   ...
   pt_LaTex = pt->AddText("0.798#pm0.0343");
   pt_LaTex = pt->AddText("#minus0.577#pm 1.16");
   pt_LaTex = pt->AddText("#minus0.724#pm 1.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7236736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7236736,-55.38829,0.7236736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.352194);
   ...
   mainFit1033->SetParameter(0,-0.577321);
   mainFit1033->SetParError(0,1.155233);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7977644);
   mainFit1033->SetParError(1,0.03431997);
