...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.30206,70,60.90479);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.88138);
   Graph_Graph01035->SetMaximum(50.4841);
   ...
   mainFit1036->SetChisquare(1.91665);
   ...
   mainFit1036->SetParameter(0,0.160206);
   mainFit1036->SetParError(0,1.052126);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7803518);
   mainFit1036->SetParError(1,0.0364041);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.639");
   pt_LaTex = pt->AddText(" 0.78#pm0.0364");
   pt_LaTex = pt->AddText(" 0.16#pm 1.05");
   pt_LaTex = pt->AddText("0.205#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.2052997,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2052997,-32.88138,-0.2052997,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.91665);
   ...
   mainFit1037->SetParameter(0,0.160206);
   mainFit1037->SetParError(0,1.052126);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7803518);
   mainFit1037->SetParError(1,0.0364041);
