...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-68.8781,75,66.02);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-55.38829);
   Graph_Graph01033->SetMaximum(52.53019);
   ...
   mainFit1034->SetChisquare(2.267598);
   ...
   mainFit1034->SetParameter(0,0.001228823);
   mainFit1034->SetParError(0,1.256929);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7883015);
   mainFit1034->SetParError(1,0.04145933);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.756");
   pt_LaTex = pt->AddText("0.788#pm0.0415");
   pt_LaTex = pt->AddText("0.00123#pm 1.26");
   pt_LaTex = pt->AddText("0.00156#pm 1.59");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.001558824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.001558824,-55.38829,-0.001558824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.267598);
   ...
   mainFit1035->SetParameter(0,0.001228823);
   mainFit1035->SetParError(0,1.256929);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7883015);
   mainFit1035->SetParError(1,0.04145933);
