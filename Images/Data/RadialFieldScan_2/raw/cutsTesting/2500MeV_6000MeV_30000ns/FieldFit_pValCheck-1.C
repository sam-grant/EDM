...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.38829);
   Graph_Graph01023->SetMaximum(52.53019);
   ...
   mainFit1024->SetChisquare(2.269132);
   ...
   mainFit1024->SetParameter(0,-0.02844228);
   mainFit1024->SetParError(0,1.002998);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7892765);
   mainFit1024->SetParError(1,0.03315554);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.567");
   pt_LaTex = pt->AddText("0.789#pm0.0332");
   pt_LaTex = pt->AddText("#minus0.0284#pm    1");
   pt_LaTex = pt->AddText("#minus0.036#pm 1.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.03603589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.03603589,-55.38829,0.03603589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.269132);
   ...
   mainFit1025->SetParameter(0,-0.02844228);
   mainFit1025->SetParError(0,1.002998);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7892765);
   mainFit1025->SetParError(1,0.03315554);
