...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.38829);
   Graph_Graph01029->SetMaximum(52.53019);
   ...
   mainFit1030->SetChisquare(2.265216);
   ...
   mainFit1030->SetParameter(0,-0.001690628);
   mainFit1030->SetParError(0,1.090185);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7894297);
   mainFit1030->SetParError(1,0.03325042);
   ...
   pt_LaTex = pt->AddText("0.789#pm0.0333");
   pt_LaTex = pt->AddText("#minus0.00169#pm 1.09");
   pt_LaTex = pt->AddText("#minus0.00214#pm 1.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.002141582,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.002141582,-55.38829,0.002141582,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.265216);
   ...
   mainFit1031->SetParameter(0,-0.001690628);
   mainFit1031->SetParError(0,1.090185);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7894297);
   mainFit1031->SetParError(1,0.03325042);
