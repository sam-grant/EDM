...
//=========  (Wed Apr 21 21:55:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.38829);
   Graph_Graph01020->SetMaximum(52.53019);
   ...
   mainFit1021->SetChisquare(2.269132);
   ...
   mainFit1021->SetParameter(0,-0.02844228);
   mainFit1021->SetParError(0,1.002998);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7892765);
   mainFit1021->SetParError(1,0.03315554);
   ...
   mainFit1022->SetChisquare(2.269132);
   ...
   mainFit1022->SetParameter(0,-0.02844228);
   mainFit1022->SetParError(0,1.002998);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7892765);
   mainFit1022->SetParError(1,0.03315554);
