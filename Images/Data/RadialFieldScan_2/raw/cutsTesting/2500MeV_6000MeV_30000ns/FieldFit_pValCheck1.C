...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.38829);
   Graph_Graph01027->SetMaximum(52.53019);
   ...
   mainFit1028->SetChisquare(0.7460187);
   ...
   mainFit1028->SetParameter(0,0.5954249);
   mainFit1028->SetParError(0,1.123183);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.809662);
   mainFit1028->SetParError(1,0.03704229);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.249");
   pt_LaTex = pt->AddText(" 0.81#pm0.037");
   pt_LaTex = pt->AddText("0.595#pm 1.12");
   pt_LaTex = pt->AddText("0.735#pm 1.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.7353993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7353993,-55.38829,-0.7353993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7460187);
   ...
   mainFit1029->SetParameter(0,0.5954249);
   mainFit1029->SetParError(0,1.123183);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.809662);
   mainFit1029->SetParError(1,0.03704229);
