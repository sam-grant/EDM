...
//=========  (Wed Apr 21 21:55:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04989762);
   Graph_Graph11015->SetMaximum(0.01563543);
   ...
   Graph_Graph21016->SetMinimum(-0.01311635);
   Graph_Graph21016->SetMaximum(0.01541819);
   ...
   Graph_Graph31017->SetMinimum(-0.06658909);
   Graph_Graph31017->SetMaximum(0.05226122);
   ...
   Graph_Graph41018->SetMinimum(-0.05913868);
   Graph_Graph41018->SetMaximum(0.03453661);
   ...
   Graph_Graph51019->SetMinimum(-0.006892843);
   Graph_Graph51019->SetMaximum(0.00922131);
