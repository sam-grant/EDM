...
//=========  (Wed Apr 21 21:55:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.91908,50,41.22492);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.40468);
   Graph_Graph01025->SetMaximum(30.71052);
   ...
   mainFit1026->SetChisquare(1.566418);
   ...
   mainFit1026->SetParameter(0,-0.3649657);
   mainFit1026->SetParError(0,1.080343);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7666108);
   mainFit1026->SetParError(1,0.04277817);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.522");
   pt_LaTex = pt->AddText("0.767#pm0.0428");
   pt_LaTex = pt->AddText("#minus0.365#pm 1.08");
   pt_LaTex = pt->AddText("#minus0.476#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.4760769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4760769,-53.40468,0.4760769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.566418);
   ...
   mainFit1027->SetParameter(0,-0.3649657);
   mainFit1027->SetParError(0,1.080343);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7666108);
   mainFit1027->SetParError(1,0.04277817);
