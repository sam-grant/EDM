...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-58.6991,70,77.21202);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-45.10799);
   Graph_Graph01035->SetMaximum(63.62091);
   ...
   mainFit1036->SetChisquare(3.963933);
   ...
   mainFit1036->SetParameter(0,-3.954963);
   mainFit1036->SetParError(0,0.9730742);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.063982);
   mainFit1036->SetParError(1,0.033687);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0337");
   pt_LaTex = pt->AddText("#minus3.95#pm0.973");
   pt_LaTex = pt->AddText("#minus3.72#pm0.891");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.717133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.717133,-45.10799,3.717133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.963933);
   ...
   mainFit1037->SetParameter(0,-3.954963);
   mainFit1037->SetParError(0,0.9730742);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.063982);
   mainFit1037->SetParError(1,0.033687);
