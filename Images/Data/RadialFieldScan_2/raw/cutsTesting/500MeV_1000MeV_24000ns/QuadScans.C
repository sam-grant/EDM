...
//=========  (Wed Apr 21 20:31:49 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.085647);
   ...
   quadLineFit1002->SetParameter(0,74.1605);
   quadLineFit1002->SetParError(0,0.1416197);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,52.18488);
   quadLineFit1002->SetParError(1,2.375286);
   ...
   quadLineFit1003->SetChisquare(1.085647);
   ...
   quadLineFit1003->SetParameter(0,74.1605);
   quadLineFit1003->SetParError(0,0.1416197);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,52.18488);
   quadLineFit1003->SetParError(1,2.375286);
   ...
   Graph_30_ppm1003->SetMinimum(75.65956);
   Graph_30_ppm1003->SetMaximum(76.35325);
   ...
   quadLineFit1004->SetChisquare(6.846214);
   ...
   quadLineFit1004->SetParameter(0,74.38204);
   quadLineFit1004->SetParError(0,0.1192009);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.01909);
   quadLineFit1004->SetParError(1,1.959064);
   ...
   quadLineFit1005->SetChisquare(6.846214);
   ...
   quadLineFit1005->SetParameter(0,74.38204);
   quadLineFit1005->SetParError(0,0.1192009);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.01909);
   quadLineFit1005->SetParError(1,1.959064);
   ...
   Graph_10_ppm1005->SetMinimum(74.54448);
   Graph_10_ppm1005->SetMaximum(74.78286);
   ...
   quadLineFit1006->SetChisquare(1.168574);
   ...
   quadLineFit1006->SetParameter(0,74.26312);
   quadLineFit1006->SetParError(0,0.1393141);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.207773);
   quadLineFit1006->SetParError(1,2.258904);
   ...
   quadLineFit1007->SetChisquare(1.168574);
   ...
   quadLineFit1007->SetParameter(0,74.26312);
   quadLineFit1007->SetParError(0,0.1393141);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.207773);
   quadLineFit1007->SetParError(1,2.258904);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.03529);
   Graph_mI10_ppm1007->SetMaximum(73.53935);
   ...
   quadLineFit1008->SetChisquare(3.964593);
   ...
   quadLineFit1008->SetParameter(0,74.26358);
   quadLineFit1008->SetParError(0,0.1225042);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-16.0942);
   quadLineFit1008->SetParError(1,1.993676);
   ...
   quadLineFit1009->SetChisquare(3.964593);
   ...
   quadLineFit1009->SetParameter(0,74.26358);
   quadLineFit1009->SetParError(0,0.1225042);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-16.0942);
   quadLineFit1009->SetParError(1,1.993676);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.54656);
   Graph_mI30_ppm1009->SetMaximum(72.41296);
   ...
   quadLineFit1010->SetChisquare(3.875212);
   ...
   quadLineFit1010->SetParameter(0,74.07763);
   quadLineFit1010->SetParError(0,0.1156911);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-34.04533);
   quadLineFit1010->SetParError(1,2.001915);
   ...
   quadLineFit1011->SetChisquare(3.875212);
   ...
   quadLineFit1011->SetParameter(0,74.07763);
   quadLineFit1011->SetParError(0,0.1156911);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-34.04533);
   quadLineFit1011->SetParError(1,2.001915);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.5217);
   Graph_mI50_ppm1011->SetMaximum(71.2857);
   ...
   quadLineFit1012->SetChisquare(0.1975239);
   ...
   quadLineFit1012->SetParameter(0,73.81004);
   quadLineFit1012->SetParError(0,0.2339025);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.91744);
   quadLineFit1012->SetParError(1,4.1856);
   ...
   quadLineFit1013->SetChisquare(0.1975239);
   ...
   quadLineFit1013->SetParameter(0,73.81004);
   quadLineFit1013->SetParError(0,0.2339025);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.91744);
   quadLineFit1013->SetParError(1,4.1856);
