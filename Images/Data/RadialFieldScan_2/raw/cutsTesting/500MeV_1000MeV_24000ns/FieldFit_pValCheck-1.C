...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-66.06936);
   Graph_Graph01023->SetMaximum(65.52649);
   ...
   mainFit1024->SetChisquare(5.718605);
   ...
   mainFit1024->SetParameter(0,-3.567065);
   mainFit1024->SetParError(0,0.9279672);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.045587);
   mainFit1024->SetParError(1,0.03069194);
   ...
   mainFit1025->SetChisquare(5.718605);
   ...
   mainFit1025->SetParameter(0,-3.567065);
   mainFit1025->SetParError(0,0.9279672);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.045587);
   mainFit1025->SetParError(1,0.03069194);
