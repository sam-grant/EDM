...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1020365);
   Graph_Graph11015->SetMaximum(0.04619811);
   ...
   Graph_Graph21016->SetMinimum(-0.0219459);
   Graph_Graph21016->SetMaximum(0.02573389);
   ...
   Graph_Graph31017->SetMinimum(-0.05105573);
   Graph_Graph31017->SetMaximum(0.04137654);
   ...
   Graph_Graph41018->SetMinimum(-0.05166657);
   Graph_Graph41018->SetMaximum(0.04777491);
   ...
   Graph_Graph51019->SetMinimum(-0.008421896);
   Graph_Graph51019->SetMaximum(0.0112478);
