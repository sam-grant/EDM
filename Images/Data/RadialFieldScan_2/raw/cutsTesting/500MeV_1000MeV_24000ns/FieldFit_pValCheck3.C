...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-66.06936);
   Graph_Graph01031->SetMaximum(65.52649);
   ...
   mainFit1032->SetChisquare(4.253414);
   ...
   mainFit1032->SetParameter(0,-2.925585);
   mainFit1032->SetParError(0,1.068631);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.035692);
   mainFit1032->SetParError(1,0.03176226);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0318");
   pt_LaTex = pt->AddText("#minus2.93#pm 1.07");
   pt_LaTex = pt->AddText("#minus2.82#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.824764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.824764,-66.06936,2.824764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.253414);
   ...
   mainFit1033->SetParameter(0,-2.925585);
   mainFit1033->SetParError(0,1.068631);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.035692);
   mainFit1033->SetParError(1,0.03176226);
