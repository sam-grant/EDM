...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-66.06936);
   Graph_Graph01029->SetMaximum(65.52649);
   ...
   mainFit1030->SetChisquare(5.60918);
   ...
   mainFit1030->SetParameter(0,-3.436052);
   mainFit1030->SetParError(0,1.008954);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.046367);
   mainFit1030->SetParError(1,0.0307822);
   ...
   pt_LaTex = pt->AddText(" 1.05#pm0.0308");
   pt_LaTex = pt->AddText("#minus3.44#pm 1.01");
   pt_LaTex = pt->AddText("#minus3.28#pm0.958");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.283791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.283791,-66.06936,3.283791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.60918);
   ...
   mainFit1031->SetParameter(0,-3.436052);
   mainFit1031->SetParError(0,1.008954);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.046367);
   mainFit1031->SetParError(1,0.0307822);
