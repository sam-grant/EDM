...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-66.06936);
   Graph_Graph01027->SetMaximum(65.52649);
   ...
   mainFit1028->SetChisquare(4.398009);
   ...
   mainFit1028->SetParameter(0,-3.030377);
   mainFit1028->SetParError(0,1.038867);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.063146);
   mainFit1028->SetParError(1,0.03428575);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0343");
   pt_LaTex = pt->AddText("#minus3.03#pm 1.04");
   pt_LaTex = pt->AddText("#minus2.85#pm0.988");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.850386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.850386,-66.06936,2.850386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.398009);
   ...
   mainFit1029->SetParameter(0,-3.030377);
   mainFit1029->SetParError(0,1.038867);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.063146);
   mainFit1029->SetParError(1,0.03428575);
