...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-66.06936);
   Graph_Graph01033->SetMaximum(65.52649);
   ...
   mainFit1034->SetChisquare(5.327897);
   ...
   mainFit1034->SetParameter(0,-4.005592);
   mainFit1034->SetParError(0,1.163323);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.060011);
   mainFit1034->SetParError(1,0.03839758);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0384");
   pt_LaTex = pt->AddText("#minus4.01#pm 1.16");
   pt_LaTex = pt->AddText("#minus3.78#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.778823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.778823,-66.06936,3.778823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.327897);
   ...
   mainFit1035->SetParameter(0,-4.005592);
   mainFit1035->SetParError(0,1.163323);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.060011);
   mainFit1035->SetParError(1,0.03839758);
