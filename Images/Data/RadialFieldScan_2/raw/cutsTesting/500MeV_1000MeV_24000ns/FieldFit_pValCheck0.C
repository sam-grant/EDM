...
//=========  (Wed Apr 21 20:31:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-75.87334,50,48.74846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-63.41116);
   Graph_Graph01025->SetMaximum(36.28628);
   ...
   mainFit1026->SetChisquare(1.535829);
   ...
   mainFit1026->SetParameter(0,-4.329063);
   mainFit1026->SetParError(0,0.9999698);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9943602);
   mainFit1026->SetParError(1,0.0396157);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.512");
   pt_LaTex = pt->AddText("0.994#pm0.0396");
   pt_LaTex = pt->AddText("#minus4.33#pm    1");
   pt_LaTex = pt->AddText("#minus4.35#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,4.353617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.353617,-63.41116,4.353617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.535829);
   ...
   mainFit1027->SetParameter(0,-4.329063);
   mainFit1027->SetParError(0,0.9999698);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9943602);
   mainFit1027->SetParError(1,0.0396157);
