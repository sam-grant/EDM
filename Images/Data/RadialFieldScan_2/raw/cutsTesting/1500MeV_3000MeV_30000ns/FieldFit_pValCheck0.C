...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.44704,50,38.69848);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.63249);
   Graph_Graph01025->SetMaximum(28.88392);
   ...
   mainFit1026->SetChisquare(1.708906);
   ...
   mainFit1026->SetParameter(0,-0.6675016);
   mainFit1026->SetParError(0,0.6478292);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7493332);
   mainFit1026->SetParError(1,0.0256361);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.57");
   pt_LaTex = pt->AddText("0.749#pm0.0256");
   pt_LaTex = pt->AddText("#minus0.668#pm0.648");
   pt_LaTex = pt->AddText("#minus0.891#pm0.869");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8907942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8907942,-49.63249,0.8907942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.708906);
   ...
   mainFit1027->SetParameter(0,-0.6675016);
   mainFit1027->SetParError(0,0.6478292);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7493332);
   mainFit1027->SetParError(1,0.0256361);
