...
//=========  (Fri Apr 23 19:08:59 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.19306,70,56.51994);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.52176);
   Graph_Graph01035->SetMaximum(46.84864);
   ...
   mainFit1036->SetChisquare(2.13264);
   ...
   mainFit1036->SetParameter(0,-0.3012126);
   mainFit1036->SetParError(0,0.6309023);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.758541);
   mainFit1036->SetParError(1,0.02181553);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.711");
   pt_LaTex = pt->AddText("0.759#pm0.0218");
   pt_LaTex = pt->AddText("#minus0.301#pm0.631");
   pt_LaTex = pt->AddText("#minus0.397#pm0.829");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3970946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3970946,-30.52176,0.3970946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.13264);
   ...
   mainFit1037->SetParameter(0,-0.3012126);
   mainFit1037->SetParError(0,0.6309023);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.758541);
   mainFit1037->SetParError(1,0.02181553);
