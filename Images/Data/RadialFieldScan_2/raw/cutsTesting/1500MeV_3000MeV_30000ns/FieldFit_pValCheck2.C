...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.43851);
   Graph_Graph01029->SetMaximum(48.75016);
   ...
   mainFit1030->SetChisquare(2.320889);
   ...
   mainFit1030->SetParameter(0,-0.5791105);
   mainFit1030->SetParError(0,0.6537874);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7640706);
   mainFit1030->SetParError(1,0.01992416);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.774");
   pt_LaTex = pt->AddText("0.764#pm0.0199");
   pt_LaTex = pt->AddText("#minus0.579#pm0.654");
   pt_LaTex = pt->AddText("#minus0.758#pm0.854");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.757928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.757928,-51.43851,0.757928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.320889);
   ...
   mainFit1031->SetParameter(0,-0.5791105);
   mainFit1031->SetParError(0,0.6537874);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7640706);
   mainFit1031->SetParError(1,0.01992416);
