...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-63.9621,75,61.27374);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-51.43851);
   Graph_Graph01027->SetMaximum(48.75016);
   ...
   mainFit1028->SetChisquare(0.5740077);
   ...
   mainFit1028->SetParameter(0,-0.001305292);
   mainFit1028->SetParError(0,0.6734082);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7790939);
   mainFit1028->SetParError(1,0.02219138);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.191");
   pt_LaTex = pt->AddText("0.779#pm0.0222");
   pt_LaTex = pt->AddText("#minus0.00131#pm0.673");
   pt_LaTex = pt->AddText("#minus0.00168#pm0.864");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.001675398,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.001675398,-51.43851,0.001675398,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5740077);
   ...
   mainFit1029->SetParameter(0,-0.001305292);
   mainFit1029->SetParError(0,0.6734082);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7790939);
   mainFit1029->SetParError(1,0.02219138);
