...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.43851);
   Graph_Graph01023->SetMaximum(48.75016);
   ...
   mainFit1024->SetChisquare(2.632244);
   ...
   mainFit1024->SetParameter(0,-0.4360138);
   mainFit1024->SetParError(0,0.6013869);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7649104);
   mainFit1024->SetParError(1,0.01986747);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.658");
   pt_LaTex = pt->AddText("0.765#pm0.0199");
   pt_LaTex = pt->AddText("#minus0.436#pm0.601");
   pt_LaTex = pt->AddText("#minus0.57#pm0.784");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5700194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5700194,-51.43851,0.5700194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.632244);
   ...
   mainFit1025->SetParameter(0,-0.4360138);
   mainFit1025->SetParError(0,0.6013869);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7649104);
   mainFit1025->SetParError(1,0.01986747);
