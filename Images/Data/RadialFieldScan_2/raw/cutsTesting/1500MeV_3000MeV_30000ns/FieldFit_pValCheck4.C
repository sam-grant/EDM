...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.43851);
   Graph_Graph01033->SetMaximum(48.75016);
   ...
   mainFit1034->SetChisquare(2.199321);
   ...
   mainFit1034->SetParameter(0,-0.7355309);
   mainFit1034->SetParError(0,0.7542456);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7747416);
   mainFit1034->SetParError(1,0.02485907);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.733");
   pt_LaTex = pt->AddText("0.775#pm0.0249");
   pt_LaTex = pt->AddText("#minus0.736#pm0.754");
   pt_LaTex = pt->AddText("#minus0.949#pm 0.96");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9493887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9493887,-51.43851,0.9493887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.199321);
   ...
   mainFit1035->SetParameter(0,-0.7355309);
   mainFit1035->SetParError(0,0.7542456);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7747416);
   mainFit1035->SetParError(1,0.02485907);
