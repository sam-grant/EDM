...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.43851);
   Graph_Graph01031->SetMaximum(48.75016);
   ...
   mainFit1032->SetChisquare(2.630619);
   ...
   mainFit1032->SetParameter(0,-0.4222089);
   mainFit1032->SetParError(0,0.6920598);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.764697);
   mainFit1032->SetParError(1,0.02056044);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.877");
   pt_LaTex = pt->AddText("0.765#pm0.0206");
   pt_LaTex = pt->AddText("#minus0.422#pm0.692");
   pt_LaTex = pt->AddText("#minus0.552#pm0.901");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5521257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5521257,-51.43851,0.5521257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.630619);
   ...
   mainFit1033->SetParameter(0,-0.4222089);
   mainFit1033->SetParError(0,0.6920598);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.764697);
   mainFit1033->SetParError(1,0.02056044);
