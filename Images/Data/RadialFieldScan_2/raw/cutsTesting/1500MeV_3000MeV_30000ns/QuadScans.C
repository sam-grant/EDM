...
//=========  (Fri Apr 23 19:08:57 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.03955841);
   ...
   quadLineFit1002->SetParameter(0,74.91519);
   quadLineFit1002->SetParError(0,0.09159331);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.86479);
   quadLineFit1002->SetParError(1,1.536313);
   ...
   quadLineFit1003->SetChisquare(0.03955841);
   ...
   quadLineFit1003->SetParameter(0,74.91519);
   quadLineFit1003->SetParError(0,0.09159331);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.86479);
   quadLineFit1003->SetParError(1,1.536313);
   ...
   Graph_30_ppm1003->SetMinimum(75.95042);
   Graph_30_ppm1003->SetMaximum(76.49046);
   ...
   quadLineFit1004->SetChisquare(2.269289);
   ...
   quadLineFit1004->SetParameter(0,74.92569);
   quadLineFit1004->SetParError(0,0.07702723);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.07487);
   quadLineFit1004->SetParError(1,1.266024);
   ...
   quadLineFit1005->SetChisquare(2.269289);
   ...
   quadLineFit1005->SetParameter(0,74.92569);
   quadLineFit1005->SetParError(0,0.07702723);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.07487);
   quadLineFit1005->SetParError(1,1.266024);
   ...
   Graph_10_ppm1005->SetMinimum(75.03331);
   Graph_10_ppm1005->SetMaximum(75.28078);
   ...
   quadLineFit1006->SetChisquare(0.5181989);
   ...
   quadLineFit1006->SetParameter(0,74.65982);
   quadLineFit1006->SetParError(0,0.09026734);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.957713);
   quadLineFit1006->SetParError(1,1.463928);
   ...
   quadLineFit1007->SetChisquare(0.5181989);
   ...
   quadLineFit1007->SetParameter(0,74.65982);
   quadLineFit1007->SetParError(0,0.09026734);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.957713);
   quadLineFit1007->SetParError(1,1.463928);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.96384);
   Graph_mI10_ppm1007->SetMaximum(74.24504);
   ...
   quadLineFit1008->SetChisquare(8.07242);
   ...
   quadLineFit1008->SetParameter(0,74.59484);
   quadLineFit1008->SetParError(0,0.07958843);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.129976);
   quadLineFit1008->SetParError(1,1.295505);
   ...
   quadLineFit1009->SetChisquare(8.07242);
   ...
   quadLineFit1009->SetParameter(0,74.59484);
   quadLineFit1009->SetParError(0,0.07958843);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.129976);
   quadLineFit1009->SetParError(1,1.295505);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.73465);
   Graph_mI30_ppm1009->SetMaximum(73.33381);
   ...
   quadLineFit1010->SetChisquare(0.2006867);
   ...
   quadLineFit1010->SetParameter(0,74.44003);
   quadLineFit1010->SetParError(0,0.07499352);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.77632);
   quadLineFit1010->SetParError(1,1.297904);
   ...
   quadLineFit1011->SetChisquare(0.2006867);
   ...
   quadLineFit1011->SetParameter(0,74.44003);
   quadLineFit1011->SetParError(0,0.07499352);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.77632);
   quadLineFit1011->SetParError(1,1.297904);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.85967);
   Graph_mI50_ppm1011->SetMaximum(72.45444);
   ...
   quadLineFit1012->SetChisquare(0.02122285);
   ...
   quadLineFit1012->SetParameter(0,74.45781);
   quadLineFit1012->SetParError(0,0.1513181);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.38199);
   quadLineFit1012->SetParError(1,2.707471);
   ...
   quadLineFit1013->SetChisquare(0.02122285);
   ...
   quadLineFit1013->SetParameter(0,74.45781);
   quadLineFit1013->SetParError(0,0.1513181);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.38199);
   quadLineFit1013->SetParError(1,2.707471);
