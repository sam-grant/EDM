...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.43851);
   Graph_Graph01020->SetMaximum(48.75016);
   ...
   mainFit1021->SetChisquare(2.632244);
   ...
   mainFit1021->SetParameter(0,-0.4360138);
   mainFit1021->SetParError(0,0.6013869);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7649104);
   mainFit1021->SetParError(1,0.01986747);
   ...
   mainFit1022->SetChisquare(2.632244);
   ...
   mainFit1022->SetParameter(0,-0.4360138);
   mainFit1022->SetParError(0,0.6013869);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7649104);
   mainFit1022->SetParError(1,0.01986747);
