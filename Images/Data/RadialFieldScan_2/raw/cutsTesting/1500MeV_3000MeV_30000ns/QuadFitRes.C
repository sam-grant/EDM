...
//=========  (Fri Apr 23 19:08:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02027795);
   Graph_Graph11015->SetMaximum(0.03287039);
   ...
   Graph_Graph21016->SetMinimum(-0.009452951);
   Graph_Graph21016->SetMaximum(0.01113446);
   ...
   Graph_Graph31017->SetMinimum(-0.04643162);
   Graph_Graph31017->SetMaximum(0.03989374);
   ...
   Graph_Graph41018->SetMinimum(-0.006348289);
   Graph_Graph41018->SetMaximum(0.008858929);
   ...
   Graph_Graph51019->SetMinimum(-0.001787716);
   Graph_Graph51019->SetMaximum(0.002389762);
