...
//=========  (Thu Apr 22 15:34:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4899152);
   ...
   quadLineFit1002->SetParameter(0,74.52922);
   quadLineFit1002->SetParError(0,0.06659401);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.05071);
   quadLineFit1002->SetParError(1,1.117047);
   ...
   quadLineFit1003->SetChisquare(0.4899152);
   ...
   quadLineFit1003->SetParameter(0,74.52922);
   quadLineFit1003->SetParError(0,0.06659401);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.05071);
   quadLineFit1003->SetParError(1,1.117047);
   ...
   Graph_30_ppm1003->SetMinimum(75.81995);
   Graph_30_ppm1003->SetMaximum(76.40896);
   ...
   quadLineFit1004->SetChisquare(1.15859);
   ...
   quadLineFit1004->SetParameter(0,74.67418);
   quadLineFit1004->SetParError(0,0.05609637);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.38355);
   quadLineFit1004->SetParError(1,0.9220435);
   ...
   quadLineFit1005->SetChisquare(1.15859);
   ...
   quadLineFit1005->SetParameter(0,74.67418);
   quadLineFit1005->SetParError(0,0.05609637);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.38355);
   quadLineFit1005->SetParError(1,0.9220435);
   ...
   Graph_10_ppm1005->SetMinimum(74.83972);
   Graph_10_ppm1005->SetMaximum(75.08533);
   ...
   quadLineFit1006->SetChisquare(3.228396);
   ...
   quadLineFit1006->SetParameter(0,74.43839);
   quadLineFit1006->SetParError(0,0.06572005);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.301272);
   quadLineFit1006->SetParError(1,1.065898);
   ...
   quadLineFit1007->SetChisquare(3.228396);
   ...
   quadLineFit1007->SetParameter(0,74.43839);
   quadLineFit1007->SetParError(0,0.06572005);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.301272);
   quadLineFit1007->SetParError(1,1.065898);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.62751);
   Graph_mI10_ppm1007->SetMaximum(73.94457);
   ...
   quadLineFit1008->SetChisquare(12.79268);
   ...
   quadLineFit1008->SetParameter(0,74.40306);
   quadLineFit1008->SetParError(0,0.0577104);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.21814);
   quadLineFit1008->SetParError(1,0.939367);
   ...
   quadLineFit1009->SetChisquare(12.79268);
   ...
   quadLineFit1009->SetParameter(0,74.40306);
   quadLineFit1009->SetParError(0,0.0577104);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.21814);
   quadLineFit1009->SetParError(1,0.939367);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.26417);
   Graph_mI30_ppm1009->SetMaximum(72.96741);
   ...
   quadLineFit1010->SetChisquare(2.160329);
   ...
   quadLineFit1010->SetParameter(0,74.33035);
   quadLineFit1010->SetParError(0,0.0545933);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.7641);
   quadLineFit1010->SetParError(1,0.9448495);
   ...
   quadLineFit1011->SetChisquare(2.160329);
   ...
   quadLineFit1011->SetParameter(0,74.33035);
   quadLineFit1011->SetParError(0,0.0545933);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.7641);
   quadLineFit1011->SetParError(1,0.9448495);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.33684);
   Graph_mI50_ppm1011->SetMaximum(71.99642);
   ...
   quadLineFit1012->SetChisquare(0.3791124);
   ...
   quadLineFit1012->SetParameter(0,74.30407);
   quadLineFit1012->SetParError(0,0.1102074);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.25978);
   quadLineFit1012->SetParError(1,1.971941);
   ...
   quadLineFit1013->SetChisquare(0.3791124);
   ...
   quadLineFit1013->SetParameter(0,74.30407);
   quadLineFit1013->SetParError(0,0.1102074);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.25978);
   quadLineFit1013->SetParError(1,1.971941);
