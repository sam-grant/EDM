...
//=========  (Thu Apr 22 15:34:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.67167);
   Graph_Graph01031->SetMaximum(55.60771);
   ...
   mainFit1032->SetChisquare(8.058156);
   ...
   mainFit1032->SetParameter(0,-1.34611);
   mainFit1032->SetParError(0,0.5038463);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8918536);
   mainFit1032->SetParError(1,0.0149643);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.69");
   pt_LaTex = pt->AddText("0.892#pm0.015");
   pt_LaTex = pt->AddText("#minus1.35#pm0.504");
   pt_LaTex = pt->AddText("#minus1.51#pm0.559");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.509339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.509339,-57.67167,1.509339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(8.058156);
   ...
   mainFit1033->SetParameter(0,-1.34611);
   mainFit1033->SetParError(0,0.5038463);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8918536);
   mainFit1033->SetParError(1,0.0149643);
