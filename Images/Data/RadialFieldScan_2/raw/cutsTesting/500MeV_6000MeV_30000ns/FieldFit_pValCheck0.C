...
//=========  (Thu Apr 22 15:34:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.36605,50,42.43992);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.48545);
   Graph_Graph01025->SetMaximum(31.55932);
   ...
   mainFit1026->SetChisquare(2.961051);
   ...
   mainFit1026->SetParameter(0,-1.731685);
   mainFit1026->SetParError(0,0.471276);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8650226);
   mainFit1026->SetParError(1,0.01866675);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.987");
   pt_LaTex = pt->AddText("0.865#pm0.0187");
   pt_LaTex = pt->AddText("#minus1.73#pm0.471");
   pt_LaTex = pt->AddText("   #minus2#pm0.552");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.001896,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.001896,-55.48545,2.001896,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.961051);
   ...
   mainFit1027->SetParameter(0,-1.731685);
   mainFit1027->SetParError(0,0.471276);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8650226);
   mainFit1027->SetParError(1,0.01866675);
