...
//=========  (Thu Apr 22 15:34:07 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.42813,70,64.88694);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.19662);
   Graph_Graph01035->SetMaximum(53.65543);
   ...
   mainFit1036->SetChisquare(8.02237);
   ...
   mainFit1036->SetParameter(0,-1.308648);
   mainFit1036->SetParError(0,0.4587789);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.89042);
   mainFit1036->SetParError(1,0.01586973);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.67");
   pt_LaTex = pt->AddText(" 0.89#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.31#pm0.459");
   pt_LaTex = pt->AddText("#minus1.47#pm0.509");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.469698,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.469698,-36.19662,1.469698,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(8.02237);
   ...
   mainFit1037->SetParameter(0,-1.308648);
   mainFit1037->SetParError(0,0.4587789);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.89042);
   mainFit1037->SetParError(1,0.01586973);
