...
//=========  (Thu Apr 22 15:34:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.67167);
   Graph_Graph01029->SetMaximum(55.60771);
   ...
   mainFit1030->SetChisquare(7.511275);
   ...
   mainFit1030->SetParameter(0,-1.473484);
   mainFit1030->SetParError(0,0.4754191);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8908782);
   mainFit1030->SetParError(1,0.01449763);
   ...
   pt_LaTex = pt->AddText("0.891#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.47#pm0.475");
   pt_LaTex = pt->AddText("#minus1.65#pm0.531");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.653968,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.653968,-57.67167,1.653968,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.511275);
   ...
   mainFit1031->SetParameter(0,-1.473484);
   mainFit1031->SetParError(0,0.4754191);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8908782);
   mainFit1031->SetParError(1,0.01449763);
