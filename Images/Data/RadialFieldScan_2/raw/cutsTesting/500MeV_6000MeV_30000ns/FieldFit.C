...
//=========  (Thu Apr 22 15:34:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.67167);
   Graph_Graph01020->SetMaximum(55.60771);
   ...
   mainFit1021->SetChisquare(8.05996);
   ...
   mainFit1021->SetParameter(0,-1.335487);
   mainFit1021->SetParError(0,0.4373963);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8916894);
   mainFit1021->SetParError(1,0.01445626);
   ...
   mainFit1022->SetChisquare(8.05996);
   ...
   mainFit1022->SetParameter(0,-1.335487);
   mainFit1022->SetParError(0,0.4373963);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8916894);
   mainFit1022->SetParError(1,0.01445626);
