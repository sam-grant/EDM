...
//=========  (Thu Apr 22 15:34:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.67167);
   Graph_Graph01033->SetMaximum(55.60771);
   ...
   mainFit1034->SetChisquare(7.83035);
   ...
   mainFit1034->SetParameter(0,-1.493831);
   mainFit1034->SetParError(0,0.5481902);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8968907);
   mainFit1034->SetParError(1,0.01807789);
   ...
   pt_LaTex = pt->AddText("0.897#pm0.0181");
   pt_LaTex = pt->AddText("#minus1.49#pm0.548");
   pt_LaTex = pt->AddText("#minus1.67#pm0.596");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.665566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.665566,-57.67167,1.665566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.83035);
   ...
   mainFit1035->SetParameter(0,-1.493831);
   mainFit1035->SetParError(0,0.5481902);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8968907);
   mainFit1035->SetParError(1,0.01807789);
