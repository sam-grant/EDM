...
//=========  (Thu Apr 22 15:34:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.67167);
   Graph_Graph01027->SetMaximum(55.60771);
   ...
   mainFit1028->SetChisquare(0.3063319);
   ...
   mainFit1028->SetParameter(0,-0.7228541);
   mainFit1028->SetParError(0,0.4896134);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9116993);
   mainFit1028->SetParError(1,0.01614388);
   ...
   pt_LaTex = pt->AddText("0.912#pm0.0161");
   pt_LaTex = pt->AddText("#minus0.723#pm 0.49");
   pt_LaTex = pt->AddText("#minus0.793#pm0.538");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7928646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7928646,-57.67167,0.7928646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3063319);
   ...
   mainFit1029->SetParameter(0,-0.7228541);
   mainFit1029->SetParError(0,0.4896134);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9116993);
   mainFit1029->SetParError(1,0.01614388);
