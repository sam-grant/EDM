...
//=========  (Thu Apr 22 15:34:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01206411);
   Graph_Graph11015->SetMaximum(0.01325266);
   ...
   Graph_Graph21016->SetMinimum(-0.01718833);
   Graph_Graph21016->SetMaximum(0.02024154);
   ...
   Graph_Graph31017->SetMinimum(-0.04378402);
   Graph_Graph31017->SetMaximum(0.03306114);
   ...
   Graph_Graph41018->SetMinimum(-0.01054923);
   Graph_Graph41018->SetMaximum(0.01724258);
   ...
   Graph_Graph51019->SetMinimum(-0.005501401);
   Graph_Graph51019->SetMaximum(0.00735279);
