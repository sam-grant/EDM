...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.46002);
   Graph_Graph01020->SetMaximum(50.89337);
   ...
   mainFit1021->SetChisquare(3.525396);
   ...
   mainFit1021->SetParameter(0,0.1310332);
   mainFit1021->SetParError(0,0.8291135);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7805357);
   mainFit1021->SetParError(1,0.02741456);
   ...
   mainFit1022->SetChisquare(3.525396);
   ...
   mainFit1022->SetParameter(0,0.1310332);
   mainFit1022->SetParError(0,0.8291135);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7805357);
   mainFit1022->SetParError(1,0.02741456);
