...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.46002);
   Graph_Graph01029->SetMaximum(50.89337);
   ...
   mainFit1030->SetChisquare(2.748143);
   ...
   mainFit1030->SetParameter(0,-0.180269);
   mainFit1030->SetParError(0,0.9011772);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7786994);
   mainFit1030->SetParError(1,0.02749332);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.916");
   pt_LaTex = pt->AddText("0.779#pm0.0275");
   pt_LaTex = pt->AddText("#minus0.18#pm0.901");
   pt_LaTex = pt->AddText("#minus0.232#pm 1.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2315001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2315001,-51.46002,0.2315001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.748143);
   ...
   mainFit1031->SetParameter(0,-0.180269);
   mainFit1031->SetParError(0,0.9011772);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7786994);
   mainFit1031->SetParError(1,0.02749332);
