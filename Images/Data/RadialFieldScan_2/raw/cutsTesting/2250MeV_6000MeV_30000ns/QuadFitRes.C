...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04283004);
   Graph_Graph11015->SetMaximum(0.03535539);
   ...
   Graph_Graph21016->SetMinimum(-0.01220069);
   Graph_Graph21016->SetMaximum(0.01435213);
   ...
   Graph_Graph31017->SetMinimum(-0.04730176);
   Graph_Graph31017->SetMaximum(0.04774136);
   ...
   Graph_Graph41018->SetMinimum(-0.02418972);
   Graph_Graph41018->SetMaximum(0.01573865);
   ...
   Graph_Graph51019->SetMinimum(-0.008923582);
   Graph_Graph51019->SetMaximum(0.01193292);
