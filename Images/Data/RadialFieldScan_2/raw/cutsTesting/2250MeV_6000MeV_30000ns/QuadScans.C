...
//=========  (Wed Apr 21 21:52:16 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.9827);
   ...
   quadLineFit1002->SetParameter(0,75.18104);
   quadLineFit1002->SetParError(0,0.1264487);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.2432);
   quadLineFit1002->SetParError(1,2.120722);
   ...
   quadLineFit1003->SetChisquare(2.9827);
   ...
   quadLineFit1003->SetParameter(0,75.18104);
   quadLineFit1003->SetParError(0,0.1264487);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.2432);
   quadLineFit1003->SetParError(1,2.120722);
   ...
   Graph_30_ppm1003->SetMinimum(76.31005);
   Graph_30_ppm1003->SetMaximum(76.87229);
   ...
   quadLineFit1004->SetChisquare(2.703673);
   ...
   quadLineFit1004->SetParameter(0,75.26555);
   quadLineFit1004->SetParError(0,0.106208);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.28845);
   quadLineFit1004->SetParError(1,1.746103);
   ...
   quadLineFit1005->SetChisquare(2.703673);
   ...
   quadLineFit1005->SetParameter(0,75.26555);
   quadLineFit1005->SetParError(0,0.106208);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.28845);
   quadLineFit1005->SetParError(1,1.746103);
   ...
   Graph_10_ppm1005->SetMinimum(75.35969);
   Graph_10_ppm1005->SetMaximum(75.66647);
   ...
   quadLineFit1006->SetChisquare(0.4518936);
   ...
   quadLineFit1006->SetParameter(0,74.91477);
   quadLineFit1006->SetParError(0,0.1245942);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.560696);
   quadLineFit1006->SetParError(1,2.020736);
   ...
   quadLineFit1007->SetChisquare(0.4518936);
   ...
   quadLineFit1007->SetParameter(0,74.91477);
   quadLineFit1007->SetParError(0,0.1245942);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.560696);
   quadLineFit1007->SetParError(1,2.020736);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.38403);
   Graph_mI10_ppm1007->SetMaximum(74.63844);
   ...
   quadLineFit1008->SetChisquare(4.887759);
   ...
   quadLineFit1008->SetParameter(0,74.89107);
   quadLineFit1008->SetParError(0,0.1093491);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.278757);
   quadLineFit1008->SetParError(1,1.780272);
   ...
   quadLineFit1009->SetChisquare(4.887759);
   ...
   quadLineFit1009->SetParameter(0,74.89107);
   quadLineFit1009->SetParError(0,0.1093491);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.278757);
   quadLineFit1009->SetParError(1,1.780272);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.09199);
   Graph_mI30_ppm1009->SetMaximum(73.73323);
   ...
   quadLineFit1010->SetChisquare(0.6238992);
   ...
   quadLineFit1010->SetParameter(0,74.90141);
   quadLineFit1010->SetParError(0,0.1034963);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.30356);
   quadLineFit1010->SetParError(1,1.791334);
   ...
   quadLineFit1011->SetChisquare(0.6238992);
   ...
   quadLineFit1011->SetParameter(0,74.90141);
   quadLineFit1011->SetParError(0,0.1034963);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.30356);
   quadLineFit1011->SetParError(1,1.791334);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.2125);
   Graph_mI50_ppm1011->SetMaximum(72.81005);
   ...
   quadLineFit1012->SetChisquare(0.2772255);
   ...
   quadLineFit1012->SetParameter(0,74.75054);
   quadLineFit1012->SetParError(0,0.2089413);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.19233);
   quadLineFit1012->SetParError(1,3.738235);
   ...
   quadLineFit1013->SetChisquare(0.2772255);
   ...
   quadLineFit1013->SetParameter(0,74.75054);
   quadLineFit1013->SetParError(0,0.2089413);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.19233);
   quadLineFit1013->SetParError(1,3.738235);
