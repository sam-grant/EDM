...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.42185,50,39.52583);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.52708);
   Graph_Graph01025->SetMaximum(29.63106);
   ...
   mainFit1026->SetChisquare(3.013108);
   ...
   mainFit1026->SetParameter(0,-0.1064921);
   mainFit1026->SetParError(0,0.8930541);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7645341);
   mainFit1026->SetParError(1,0.03537114);
   ...
   pt_LaTex = pt->AddText("0.765#pm0.0354");
   pt_LaTex = pt->AddText("#minus0.106#pm0.893");
   pt_LaTex = pt->AddText("#minus0.139#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1392901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1392901,-49.52708,0.1392901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.013108);
   ...
   mainFit1027->SetParameter(0,-0.1064921);
   mainFit1027->SetParError(0,0.8930541);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7645341);
   mainFit1027->SetParError(1,0.03537114);
