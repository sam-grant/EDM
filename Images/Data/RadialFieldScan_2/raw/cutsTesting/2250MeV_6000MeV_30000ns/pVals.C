...
//=========  (Wed Apr 21 21:52:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,0.1887063,8.5,0.9675206);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(0.2665878);
   Graph_Graph01037->SetMaximum(0.8896392);
