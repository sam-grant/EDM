...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.46002);
   Graph_Graph01027->SetMaximum(50.89337);
   ...
   mainFit1028->SetChisquare(0.8489845);
   ...
   mainFit1028->SetParameter(0,0.8146332);
   mainFit1028->SetParError(0,0.9284568);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8028868);
   mainFit1028->SetParError(1,0.03063031);
   ...
   pt_LaTex = pt->AddText("0.803#pm0.0306");
   pt_LaTex = pt->AddText("0.815#pm0.928");
   pt_LaTex = pt->AddText(" 1.01#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.01463,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.01463,-51.46002,-1.01463,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8489845);
   ...
   mainFit1029->SetParameter(0,0.8146332);
   mainFit1029->SetParError(0,0.9284568);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8028868);
   mainFit1029->SetParError(1,0.03063031);
