...
//=========  (Wed Apr 21 21:52:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.46002);
   Graph_Graph01031->SetMaximum(50.89337);
   ...
   mainFit1032->SetChisquare(2.690623);
   ...
   mainFit1032->SetParameter(0,-0.3021984);
   mainFit1032->SetParError(0,0.9551273);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7872351);
   mainFit1032->SetParError(1,0.02837822);
   ...
   pt_LaTex = pt->AddText("0.787#pm0.0284");
   pt_LaTex = pt->AddText("#minus0.302#pm0.955");
   pt_LaTex = pt->AddText("#minus0.384#pm 1.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3838732,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3838732,-51.46002,0.3838732,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.690623);
   ...
   mainFit1033->SetParameter(0,-0.3021984);
   mainFit1033->SetParError(0,0.9551273);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7872351);
   mainFit1033->SetParError(1,0.02837822);
