...
//=========  (Fri Apr 23 19:05:14 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8179513);
   ...
   quadLineFit1002->SetParameter(0,74.76258);
   quadLineFit1002->SetParError(0,0.08505799);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.70501);
   quadLineFit1002->SetParError(1,1.427093);
   ...
   quadLineFit1003->SetChisquare(0.8179513);
   ...
   quadLineFit1003->SetParameter(0,74.76258);
   quadLineFit1003->SetParError(0,0.08505799);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.70501);
   quadLineFit1003->SetParError(1,1.427093);
   ...
   Graph_30_ppm1003->SetMinimum(75.87921);
   Graph_30_ppm1003->SetMaximum(76.43643);
   ...
   quadLineFit1004->SetChisquare(6.969198);
   ...
   quadLineFit1004->SetParameter(0,74.77828);
   quadLineFit1004->SetParError(0,0.07013452);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.4121);
   quadLineFit1004->SetParError(1,1.152779);
   ...
   quadLineFit1005->SetChisquare(6.969198);
   ...
   quadLineFit1005->SetParameter(0,74.77828);
   quadLineFit1005->SetParError(0,0.07013452);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.4121);
   quadLineFit1005->SetParError(1,1.152779);
   ...
   Graph_10_ppm1005->SetMinimum(74.94994);
   Graph_10_ppm1005->SetMaximum(75.20967);
   ...
   quadLineFit1006->SetChisquare(0.2750186);
   ...
   quadLineFit1006->SetParameter(0,74.5389);
   quadLineFit1006->SetParError(0,0.08220351);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.713199);
   quadLineFit1006->SetParError(1,1.333196);
   ...
   quadLineFit1007->SetChisquare(0.2750186);
   ...
   quadLineFit1007->SetParameter(0,74.5389);
   quadLineFit1007->SetParError(0,0.08220351);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.713199);
   quadLineFit1007->SetParError(1,1.333196);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.85911);
   Graph_mI10_ppm1007->SetMaximum(74.14);
   ...
   quadLineFit1008->SetChisquare(8.139682);
   ...
   quadLineFit1008->SetParameter(0,74.49619);
   quadLineFit1008->SetParError(0,0.0721706);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.304382);
   quadLineFit1008->SetParError(1,1.174744);
   ...
   quadLineFit1009->SetChisquare(8.139682);
   ...
   quadLineFit1009->SetParameter(0,74.49619);
   quadLineFit1009->SetParError(0,0.0721706);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.304382);
   quadLineFit1009->SetParError(1,1.174744);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.58339);
   Graph_mI30_ppm1009->SetMaximum(73.21221);
   ...
   quadLineFit1010->SetChisquare(0.3793674);
   ...
   quadLineFit1010->SetParameter(0,74.39414);
   quadLineFit1010->SetParError(0,0.06827449);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.24379);
   quadLineFit1010->SetParError(1,1.181625);
   ...
   quadLineFit1011->SetChisquare(0.3793674);
   ...
   quadLineFit1011->SetParameter(0,74.39414);
   quadLineFit1011->SetParError(0,0.06827449);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.24379);
   quadLineFit1011->SetParError(1,1.181625);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.70252);
   Graph_mI50_ppm1011->SetMaximum(72.30219);
   ...
   quadLineFit1012->SetChisquare(1.147979);
   ...
   quadLineFit1012->SetParameter(0,74.35504);
   quadLineFit1012->SetParError(0,0.1377915);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.16115);
   quadLineFit1012->SetParError(1,2.465414);
   ...
   quadLineFit1013->SetChisquare(1.147979);
   ...
   quadLineFit1013->SetParameter(0,74.35504);
   quadLineFit1013->SetParError(0,0.1377915);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.16115);
   quadLineFit1013->SetParError(1,2.465414);
