...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.20243);
   Graph_Graph01029->SetMaximum(50.70796);
   ...
   mainFit1030->SetChisquare(1.745925);
   ...
   mainFit1030->SetParameter(0,-0.5079398);
   mainFit1030->SetParError(0,0.5960418);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.801193);
   mainFit1030->SetParError(1,0.01826698);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.582");
   pt_LaTex = pt->AddText("0.801#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.508#pm0.596");
   pt_LaTex = pt->AddText("#minus0.634#pm0.743");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6339793,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6339793,-52.20243,0.6339793,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.745925);
   ...
   mainFit1031->SetParameter(0,-0.5079398);
   mainFit1031->SetParError(0,0.5960418);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.801193);
   mainFit1031->SetParError(1,0.01826698);
