...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03292071);
   Graph_Graph11015->SetMaximum(0.05105971);
   ...
   Graph_Graph21016->SetMinimum(-0.006273613);
   Graph_Graph21016->SetMaximum(0.007388136);
   ...
   Graph_Graph31017->SetMinimum(-0.04481198);
   Graph_Graph31017->SetMaximum(0.03279399);
   ...
   Graph_Graph41018->SetMinimum(-0.006434823);
   Graph_Graph41018->SetMaximum(0.007598717);
   ...
   Graph_Graph51019->SetMinimum(-0.01197707);
   Graph_Graph51019->SetMaximum(0.01600177);
