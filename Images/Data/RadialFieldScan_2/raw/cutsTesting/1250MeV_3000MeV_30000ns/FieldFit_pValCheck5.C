...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.31479,70,59.02148);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.18116);
   Graph_Graph01035->SetMaximum(48.88785);
   ...
   mainFit1036->SetChisquare(2.318337);
   ...
   mainFit1036->SetParameter(0,-0.2570036);
   mainFit1036->SetParError(0,0.5743397);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7996606);
   mainFit1036->SetParError(1,0.0199983);
   ...
   pt_LaTex = pt->AddText("  0.8#pm 0.02");
   pt_LaTex = pt->AddText("#minus0.257#pm0.574");
   pt_LaTex = pt->AddText("#minus0.321#pm0.716");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3213908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3213908,-32.18116,0.3213908,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.318337);
   ...
   mainFit1037->SetParameter(0,-0.2570036);
   mainFit1037->SetParError(0,0.5743397);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7996606);
   mainFit1037->SetParError(1,0.0199983);
