...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.20243);
   Graph_Graph01033->SetMaximum(50.70796);
   ...
   mainFit1034->SetChisquare(2.39969);
   ...
   mainFit1034->SetParameter(0,-0.3840707);
   mainFit1034->SetParError(0,0.6857009);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8047241);
   mainFit1034->SetParError(1,0.02276743);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.8");
   pt_LaTex = pt->AddText("0.805#pm0.0228");
   pt_LaTex = pt->AddText("#minus0.384#pm0.686");
   pt_LaTex = pt->AddText("#minus0.477#pm0.846");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4772701,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4772701,-52.20243,0.4772701,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.39969);
   ...
   mainFit1035->SetParameter(0,-0.3840707);
   mainFit1035->SetParError(0,0.6857009);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8047241);
   mainFit1035->SetParError(1,0.02276743);
