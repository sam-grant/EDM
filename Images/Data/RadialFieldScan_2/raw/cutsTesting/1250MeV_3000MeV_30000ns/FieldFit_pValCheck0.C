...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.42443,50,40.36274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.34571);
   Graph_Graph01025->SetMaximum(30.28403);
   ...
   mainFit1026->SetChisquare(1.666956);
   ...
   mainFit1026->SetParameter(0,-0.5035014);
   mainFit1026->SetParError(0,0.589329);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7896543);
   mainFit1026->SetParError(1,0.0233405);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.556");
   pt_LaTex = pt->AddText(" 0.79#pm0.0233");
   pt_LaTex = pt->AddText("#minus0.504#pm0.589");
   pt_LaTex = pt->AddText("#minus0.638#pm0.749");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6376226,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6376226,-50.34571,0.6376226,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.666956);
   ...
   mainFit1027->SetParameter(0,-0.5035014);
   mainFit1027->SetParError(0,0.589329);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7896543);
   mainFit1027->SetParError(1,0.0233405);
