...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-65.06623,75,63.57177);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-52.20243);
   Graph_Graph01031->SetMaximum(50.70796);
   ...
   mainFit1032->SetChisquare(2.427347);
   ...
   mainFit1032->SetParameter(0,-0.3246312);
   mainFit1032->SetParError(0,0.6310791);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8025666);
   mainFit1032->SetParError(1,0.01883316);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.809");
   pt_LaTex = pt->AddText("0.803#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.325#pm0.631");
   pt_LaTex = pt->AddText("#minus0.404#pm0.784");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4044913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4044913,-52.20243,0.4044913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.427347);
   ...
   mainFit1033->SetParameter(0,-0.3246312);
   mainFit1033->SetParError(0,0.6310791);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8025666);
   mainFit1033->SetParError(1,0.01883316);
