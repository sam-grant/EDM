...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.20243);
   Graph_Graph01027->SetMaximum(50.70796);
   ...
   mainFit1028->SetChisquare(0.2257013);
   ...
   mainFit1028->SetParameter(0,0.101878);
   mainFit1028->SetParError(0,0.6154666);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8161709);
   mainFit1028->SetParError(1,0.02043431);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0752");
   pt_LaTex = pt->AddText("0.816#pm0.0204");
   pt_LaTex = pt->AddText("0.102#pm0.615");
   pt_LaTex = pt->AddText("0.125#pm0.754");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1248244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1248244,-52.20243,-0.1248244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2257013);
   ...
   mainFit1029->SetParameter(0,0.101878);
   mainFit1029->SetParError(0,0.6154666);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8161709);
   mainFit1029->SetParError(1,0.02043431);
