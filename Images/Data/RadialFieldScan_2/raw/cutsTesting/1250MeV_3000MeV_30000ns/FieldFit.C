...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.20243);
   Graph_Graph01020->SetMaximum(50.70796);
   ...
   mainFit1021->SetChisquare(2.428472);
   ...
   mainFit1021->SetParameter(0,-0.3141313);
   mainFit1021->SetParError(0,0.5479348);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8024052);
   mainFit1021->SetParError(1,0.01820807);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.607");
   pt_LaTex = pt->AddText("0.802#pm0.0182");
   pt_LaTex = pt->AddText("#minus0.314#pm0.548");
   pt_LaTex = pt->AddText("#minus0.391#pm0.682");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3914872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3914872,-52.20243,0.3914872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.428472);
   ...
   mainFit1022->SetParameter(0,-0.3141313);
   mainFit1022->SetParError(0,0.5479348);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8024052);
   mainFit1022->SetParError(1,0.01820807);
