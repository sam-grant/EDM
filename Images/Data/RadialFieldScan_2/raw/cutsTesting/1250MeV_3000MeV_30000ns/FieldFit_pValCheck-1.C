...
//=========  (Fri Apr 23 19:05:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.20243);
   Graph_Graph01023->SetMaximum(50.70796);
   ...
   mainFit1024->SetChisquare(2.428472);
   ...
   mainFit1024->SetParameter(0,-0.3141313);
   mainFit1024->SetParError(0,0.5479348);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8024052);
   mainFit1024->SetParError(1,0.01820807);
   ...
   mainFit1025->SetChisquare(2.428472);
   ...
   mainFit1025->SetParameter(0,-0.3141313);
   mainFit1025->SetParError(0,0.5479348);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8024052);
   mainFit1025->SetParError(1,0.01820807);
