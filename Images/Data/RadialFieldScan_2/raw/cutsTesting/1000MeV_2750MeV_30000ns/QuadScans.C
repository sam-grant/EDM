...
//=========  (Mon Apr 26 21:52:27 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.070472);
   ...
   quadLineFit1002->SetParameter(0,74.59322);
   quadLineFit1002->SetParError(0,0.0843482);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.74171);
   quadLineFit1002->SetParError(1,1.415944);
   ...
   quadLineFit1003->SetChisquare(1.070472);
   ...
   quadLineFit1003->SetParameter(0,74.59322);
   quadLineFit1003->SetParError(0,0.0843482);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.74171);
   quadLineFit1003->SetParError(1,1.415944);
   ...
   Graph_30_ppm1003->SetMinimum(75.78582);
   Graph_30_ppm1003->SetMaximum(76.36521);
   ...
   quadLineFit1004->SetChisquare(4.465579);
   ...
   quadLineFit1004->SetParameter(0,74.68003);
   quadLineFit1004->SetParError(0,0.06733453);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.81119);
   quadLineFit1004->SetParError(1,1.106686);
   ...
   quadLineFit1005->SetChisquare(4.465579);
   ...
   quadLineFit1005->SetParameter(0,74.68003);
   quadLineFit1005->SetParError(0,0.06733453);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.81119);
   quadLineFit1005->SetParError(1,1.106686);
   ...
   Graph_10_ppm1005->SetMinimum(74.84431);
   Graph_10_ppm1005->SetMaximum(75.11577);
   ...
   quadLineFit1006->SetChisquare(0.9681344);
   ...
   quadLineFit1006->SetParameter(0,74.40667);
   quadLineFit1006->SetParError(0,0.07888656);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.177271);
   quadLineFit1006->SetParError(1,1.27947);
   ...
   quadLineFit1007->SetChisquare(0.9681344);
   ...
   quadLineFit1007->SetParameter(0,74.40667);
   quadLineFit1007->SetParError(0,0.07888656);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.177271);
   quadLineFit1007->SetParError(1,1.27947);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.7136);
   Graph_mI10_ppm1007->SetMaximum(73.99406);
   ...
   quadLineFit1008->SetChisquare(4.847871);
   ...
   quadLineFit1008->SetParameter(0,74.3882);
   quadLineFit1008->SetParError(0,0.06927223);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.818108);
   quadLineFit1008->SetParError(1,1.127551);
   ...
   quadLineFit1009->SetChisquare(4.847871);
   ...
   quadLineFit1009->SetParameter(0,74.3882);
   quadLineFit1009->SetParError(0,0.06927223);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.818108);
   quadLineFit1009->SetParError(1,1.127551);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.39409);
   Graph_mI30_ppm1009->SetMaximum(73.05735);
   ...
   quadLineFit1010->SetChisquare(2.580476);
   ...
   quadLineFit1010->SetParameter(0,74.29908);
   quadLineFit1010->SetParError(0,0.06553156);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.38514);
   quadLineFit1010->SetParError(1,1.134161);
   ...
   quadLineFit1011->SetChisquare(2.580476);
   ...
   quadLineFit1011->SetParameter(0,74.29908);
   quadLineFit1011->SetParError(0,0.06553156);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.38514);
   quadLineFit1011->SetParError(1,1.134161);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.50137);
   Graph_mI50_ppm1011->SetMaximum(72.13019);
   ...
   quadLineFit1012->SetChisquare(0.4110864);
   ...
   quadLineFit1012->SetParameter(0,74.29353);
   quadLineFit1012->SetParError(0,0.132361);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.42932);
   quadLineFit1012->SetParError(1,2.368297);
   ...
   quadLineFit1013->SetChisquare(0.4110864);
   ...
   quadLineFit1013->SetParameter(0,74.29353);
   quadLineFit1013->SetParError(0,0.132361);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.42932);
   quadLineFit1013->SetParError(1,2.368297);
