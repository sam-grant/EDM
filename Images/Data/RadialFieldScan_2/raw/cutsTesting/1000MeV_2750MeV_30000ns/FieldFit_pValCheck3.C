...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.79314);
   Graph_Graph01031->SetMaximum(53.15319);
   ...
   mainFit1032->SetChisquare(4.896009);
   ...
   mainFit1032->SetParameter(0,-0.5057606);
   mainFit1032->SetParError(0,0.6072918);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.837986);
   mainFit1032->SetParError(1,0.01825803);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.506#pm0.607");
   pt_LaTex = pt->AddText("#minus0.604#pm0.722");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.603543,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.603543,-54.79314,0.603543,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.896009);
   ...
   mainFit1033->SetParameter(0,-0.5057606);
   mainFit1033->SetParError(0,0.6072918);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.837986);
   mainFit1033->SetParError(1,0.01825803);
