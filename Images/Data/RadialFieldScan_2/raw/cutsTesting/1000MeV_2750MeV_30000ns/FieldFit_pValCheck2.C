...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.79314);
   Graph_Graph01029->SetMaximum(53.15319);
   ...
   mainFit1030->SetChisquare(3.669478);
   ...
   mainFit1030->SetParameter(0,-0.7427728);
   mainFit1030->SetParError(0,0.5744508);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.836027);
   mainFit1030->SetParError(1,0.01774054);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.743#pm0.574");
   pt_LaTex = pt->AddText("#minus0.888#pm0.686");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8884555,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8884555,-54.79314,0.8884555,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.669478);
   ...
   mainFit1031->SetParameter(0,-0.7427728);
   mainFit1031->SetParError(0,0.5744508);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.836027);
   mainFit1031->SetParError(1,0.01774054);
