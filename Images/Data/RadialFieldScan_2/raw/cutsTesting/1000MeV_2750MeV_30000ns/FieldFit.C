...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.79314);
   Graph_Graph01020->SetMaximum(53.15319);
   ...
   mainFit1021->SetChisquare(4.898648);
   ...
   mainFit1021->SetParameter(0,-0.4902566);
   mainFit1021->SetParError(0,0.5273827);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8377415);
   mainFit1021->SetParError(1,0.01767231);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.49#pm0.527");
   pt_LaTex = pt->AddText("#minus0.585#pm0.628");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5852122,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5852122,-54.79314,0.5852122,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.898648);
   ...
   mainFit1022->SetParameter(0,-0.4902566);
   mainFit1022->SetParError(0,0.5273827);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8377415);
   mainFit1022->SetParError(1,0.01767231);
