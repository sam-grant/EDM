...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.79314);
   Graph_Graph01027->SetMaximum(53.15319);
   ...
   mainFit1028->SetChisquare(0.3948611);
   ...
   mainFit1028->SetParameter(0,0.09682724);
   mainFit1028->SetParError(0,0.5955432);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8575614);
   mainFit1028->SetParError(1,0.01998668);
   ...
   pt_LaTex = pt->AddText("0.858#pm 0.02");
   pt_LaTex = pt->AddText("0.0968#pm0.596");
   pt_LaTex = pt->AddText("0.113#pm0.694");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.11291,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.11291,-54.79314,-0.11291,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3948611);
   ...
   mainFit1029->SetParameter(0,0.09682724);
   mainFit1029->SetParError(0,0.5955432);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8575614);
   mainFit1029->SetParError(1,0.01998668);
