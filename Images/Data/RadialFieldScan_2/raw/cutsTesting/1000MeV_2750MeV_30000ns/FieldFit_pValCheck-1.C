...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.79314);
   Graph_Graph01023->SetMaximum(53.15319);
   ...
   mainFit1024->SetChisquare(4.898648);
   ...
   mainFit1024->SetParameter(0,-0.4902566);
   mainFit1024->SetParError(0,0.5273827);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8377415);
   mainFit1024->SetParError(1,0.01767231);
   ...
   mainFit1025->SetChisquare(4.898648);
   ...
   mainFit1025->SetParameter(0,-0.4902566);
   mainFit1025->SetParError(0,0.5273827);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8377415);
   mainFit1025->SetParError(1,0.01767231);
