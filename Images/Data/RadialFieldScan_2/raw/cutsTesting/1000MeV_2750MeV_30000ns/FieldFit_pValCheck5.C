...
//=========  (Mon Apr 26 21:52:29 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-44.18854,70,61.8269);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.587);
   Graph_Graph01035->SetMaximum(51.22535);
   ...
   mainFit1036->SetChisquare(4.648411);
   ...
   mainFit1036->SetParameter(0,-0.4084622);
   mainFit1036->SetParError(0,0.5521706);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8337214);
   mainFit1036->SetParError(1,0.01942114);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0194");
   pt_LaTex = pt->AddText("#minus0.408#pm0.552");
   pt_LaTex = pt->AddText("#minus0.49#pm 0.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4899266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4899266,-33.587,0.4899266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.648411);
   ...
   mainFit1037->SetParameter(0,-0.4084622);
   mainFit1037->SetParError(0,0.5521706);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8337214);
   mainFit1037->SetParError(1,0.01942114);
