...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.22649,50,41.34675);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.76916);
   Graph_Graph01025->SetMaximum(30.88942);
   ...
   mainFit1026->SetChisquare(3.220914);
   ...
   mainFit1026->SetParameter(0,-0.7553946);
   mainFit1026->SetParError(0,0.5656916);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8198941);
   mainFit1026->SetParError(1,0.0224083);
   ...
   pt_LaTex = pt->AddText(" 0.82#pm0.0224");
   pt_LaTex = pt->AddText("#minus0.755#pm0.566");
   pt_LaTex = pt->AddText("#minus0.921#pm0.693");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.9213319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9213319,-52.76916,0.9213319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.220914);
   ...
   mainFit1027->SetParameter(0,-0.7553946);
   mainFit1027->SetParError(0,0.5656916);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8198941);
   mainFit1027->SetParError(1,0.0224083);
