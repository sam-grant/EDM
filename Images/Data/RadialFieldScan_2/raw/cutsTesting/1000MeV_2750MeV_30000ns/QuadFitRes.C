...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01858999);
   Graph_Graph11015->SetMaximum(0.04813228);
   ...
   Graph_Graph21016->SetMinimum(-0.01129274);
   Graph_Graph21016->SetMaximum(0.01331578);
   ...
   Graph_Graph31017->SetMinimum(-0.0317994);
   Graph_Graph31017->SetMaximum(0.02617482);
   ...
   Graph_Graph41018->SetMinimum(-0.01998238);
   Graph_Graph41018->SetMaximum(0.02823277);
   ...
   Graph_Graph51019->SetMinimum(-0.006875404);
   Graph_Graph51019->SetMaximum(0.009194378);
