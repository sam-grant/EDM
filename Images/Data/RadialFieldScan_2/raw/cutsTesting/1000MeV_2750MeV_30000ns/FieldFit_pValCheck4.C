...
//=========  (Mon Apr 26 21:52:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.28643,75,66.64648);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-54.79314);
   Graph_Graph01033->SetMaximum(53.15319);
   ...
   mainFit1034->SetChisquare(4.811513);
   ...
   mainFit1034->SetParameter(0,-0.6067225);
   mainFit1034->SetParError(0,0.6585635);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8416674);
   mainFit1034->SetParError(1,0.02209962);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0221");
   pt_LaTex = pt->AddText("#minus0.607#pm0.659");
   pt_LaTex = pt->AddText("#minus0.721#pm0.774");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7208578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7208578,-54.79314,0.7208578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.811513);
   ...
   mainFit1035->SetParameter(0,-0.6067225);
   mainFit1035->SetParError(0,0.6585635);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8416674);
   mainFit1035->SetParError(1,0.02209962);
