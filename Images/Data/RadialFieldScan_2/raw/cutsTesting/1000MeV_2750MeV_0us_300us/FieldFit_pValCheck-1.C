...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.90228);
   Graph_Graph01023->SetMaximum(53.7179);
   ...
   mainFit1024->SetChisquare(2.336378);
   ...
   mainFit1024->SetParameter(0,-1.39996);
   mainFit1024->SetParError(0,0.3982156);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9003459);
   mainFit1024->SetParError(1,0.01308473);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.584");
   pt_LaTex = pt->AddText("  0.9#pm0.0131");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.398");
   pt_LaTex = pt->AddText("#minus1.55#pm0.439");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.554914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.554914,-57.90228,1.554914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.336378);
   ...
   mainFit1025->SetParameter(0,-1.39996);
   mainFit1025->SetParError(0,0.3982156);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9003459);
   mainFit1025->SetParError(1,0.01308473);
