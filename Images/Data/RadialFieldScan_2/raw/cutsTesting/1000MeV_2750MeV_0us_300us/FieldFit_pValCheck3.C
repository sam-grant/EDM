...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.90228);
   Graph_Graph01031->SetMaximum(53.7179);
   ...
   mainFit1032->SetChisquare(2.230473);
   ...
   mainFit1032->SetParameter(0,-1.474071);
   mainFit1032->SetParError(0,0.4587349);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.901497);
   mainFit1032->SetParError(1,0.01355445);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.47#pm0.459");
   pt_LaTex = pt->AddText("#minus1.64#pm0.503");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.635137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.635137,-57.90228,1.635137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.230473);
   ...
   mainFit1033->SetParameter(0,-1.474071);
   mainFit1033->SetParError(0,0.4587349);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.901497);
   mainFit1033->SetParError(1,0.01355445);
