...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004766152);
   Graph_Graph11015->SetMaximum(0.007328003);
   ...
   Graph_Graph21016->SetMinimum(-0.01188151);
   Graph_Graph21016->SetMaximum(0.0139455);
   ...
   Graph_Graph31017->SetMinimum(-0.01445083);
   Graph_Graph31017->SetMaximum(0.01507539);
   ...
   Graph_Graph41018->SetMinimum(-0.01444337);
   Graph_Graph41018->SetMaximum(0.01964922);
   ...
   Graph_Graph51019->SetMinimum(-0.007206894);
   Graph_Graph51019->SetMaximum(0.009615879);
