...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.23309,50,44.56188);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.0536);
   Graph_Graph01025->SetMaximum(33.38238);
   ...
   mainFit1026->SetChisquare(2.25733);
   ...
   mainFit1026->SetParameter(0,-1.354411);
   mainFit1026->SetParError(0,0.4299094);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9034078);
   mainFit1026->SetParError(1,0.017024);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.752");
   pt_LaTex = pt->AddText("0.903#pm0.017");
   pt_LaTex = pt->AddText("#minus1.35#pm 0.43");
   pt_LaTex = pt->AddText(" #minus1.5#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.499224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.499224,-56.0536,1.499224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.25733);
   ...
   mainFit1027->SetParameter(0,-1.354411);
   mainFit1027->SetParError(0,0.4299094);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9034078);
   mainFit1027->SetParError(1,0.017024);
