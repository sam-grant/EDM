...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.20579,70,62.94062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.09114);
   Graph_Graph01035->SetMaximum(51.82597);
   ...
   mainFit1036->SetChisquare(2.278933);
   ...
   mainFit1036->SetParameter(0,-1.369564);
   mainFit1036->SetParError(0,0.4179218);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8989312);
   mainFit1036->SetParError(1,0.0143544);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.76");
   pt_LaTex = pt->AddText("0.899#pm0.0144");
   pt_LaTex = pt->AddText("#minus1.37#pm0.418");
   pt_LaTex = pt->AddText("#minus1.52#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.523548,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.523548,-37.09114,1.523548,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.278933);
   ...
   mainFit1037->SetParameter(0,-1.369564);
   mainFit1037->SetParError(0,0.4179218);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8989312);
   mainFit1037->SetParError(1,0.0143544);
