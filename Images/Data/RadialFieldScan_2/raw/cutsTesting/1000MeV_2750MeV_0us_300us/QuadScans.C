...
//=========  (Wed Apr 28 14:16:45 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(6.257759);
   ...
   quadLineFit1002->SetParameter(0,74.61088);
   quadLineFit1002->SetParError(0,0.05947932);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.41929);
   quadLineFit1002->SetParError(1,0.996925);
   ...
   quadLineFit1003->SetChisquare(6.257759);
   ...
   quadLineFit1003->SetParameter(0,74.61088);
   quadLineFit1003->SetParError(0,0.05947932);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.41929);
   quadLineFit1003->SetParError(1,0.996925);
   ...
   Graph_30_ppm1003->SetMinimum(75.79099);
   Graph_30_ppm1003->SetMaximum(76.42513);
   ...
   quadLineFit1004->SetChisquare(0.2720022);
   ...
   quadLineFit1004->SetParameter(0,74.56886);
   quadLineFit1004->SetParError(0,0.05120108);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.08835);
   quadLineFit1004->SetParError(1,0.8410322);
   ...
   quadLineFit1005->SetChisquare(0.2720022);
   ...
   quadLineFit1005->SetParameter(0,74.56886);
   quadLineFit1005->SetParError(0,0.05120108);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.08835);
   quadLineFit1005->SetParError(1,0.8410322);
   ...
   Graph_10_ppm1005->SetMinimum(74.84535);
   Graph_10_ppm1005->SetMaximum(75.09767);
   ...
   quadLineFit1006->SetChisquare(1.856368);
   ...
   quadLineFit1006->SetParameter(0,74.41994);
   quadLineFit1006->SetParError(0,0.06005329);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.819805);
   quadLineFit1006->SetParError(1,0.9734936);
   ...
   quadLineFit1007->SetChisquare(1.856368);
   ...
   quadLineFit1007->SetParameter(0,74.41994);
   quadLineFit1007->SetParError(0,0.06005329);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.819805);
   quadLineFit1007->SetParError(1,0.9734936);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.67258);
   Graph_mI10_ppm1007->SetMaximum(73.96238);
   ...
   quadLineFit1008->SetChisquare(1.669342);
   ...
   quadLineFit1008->SetParameter(0,74.43226);
   quadLineFit1008->SetParError(0,0.05267381);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.16411);
   quadLineFit1008->SetParError(1,0.8568818);
   ...
   quadLineFit1009->SetChisquare(1.669342);
   ...
   quadLineFit1009->SetParameter(0,74.43226);
   quadLineFit1009->SetParError(0,0.05267381);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.16411);
   quadLineFit1009->SetParError(1,0.8568818);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.30878);
   Graph_mI30_ppm1009->SetMaximum(73.04211);
   ...
   quadLineFit1010->SetChisquare(2.452529);
   ...
   quadLineFit1010->SetParameter(0,74.45565);
   quadLineFit1010->SetParError(0,0.04977017);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.82054);
   quadLineFit1010->SetParError(1,0.8608422);
   ...
   quadLineFit1011->SetChisquare(2.452529);
   ...
   quadLineFit1011->SetParameter(0,74.45565);
   quadLineFit1011->SetParError(0,0.04977017);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.82054);
   quadLineFit1011->SetParError(1,0.8608422);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.41891);
   Graph_mI50_ppm1011->SetMaximum(72.08229);
   ...
   quadLineFit1012->SetChisquare(0.7766154);
   ...
   quadLineFit1012->SetParameter(0,74.41997);
   quadLineFit1012->SetParError(0,0.1005996);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.80097);
   quadLineFit1012->SetParError(1,1.799625);
   ...
   quadLineFit1013->SetChisquare(0.7766154);
   ...
   quadLineFit1013->SetParameter(0,74.41997);
   quadLineFit1013->SetParError(0,0.1005996);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.80097);
   quadLineFit1013->SetParError(1,1.799625);
