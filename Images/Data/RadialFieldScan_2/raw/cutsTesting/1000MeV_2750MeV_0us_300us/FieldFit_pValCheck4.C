...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.90228);
   Graph_Graph01033->SetMaximum(53.7179);
   ...
   mainFit1034->SetChisquare(1.887702);
   ...
   mainFit1034->SetParameter(0,-1.197336);
   mainFit1034->SetParError(0,0.5000812);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8937553);
   mainFit1034->SetParError(1,0.01637125);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.629");
   pt_LaTex = pt->AddText("0.894#pm0.0164");
   pt_LaTex = pt->AddText(" #minus1.2#pm  0.5");
   pt_LaTex = pt->AddText("#minus1.34#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.339669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.339669,-57.90228,1.339669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.887702);
   ...
   mainFit1035->SetParameter(0,-1.197336);
   mainFit1035->SetParError(0,0.5000812);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8937553);
   mainFit1035->SetParError(1,0.01637125);
