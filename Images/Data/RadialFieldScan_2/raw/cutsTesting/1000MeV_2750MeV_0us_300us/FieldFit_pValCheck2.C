...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.8548,75,67.67042);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-57.90228);
   Graph_Graph01029->SetMaximum(53.7179);
   ...
   mainFit1030->SetChisquare(0.4631896);
   ...
   mainFit1030->SetParameter(0,-1.63048);
   mainFit1030->SetParError(0,0.4323712);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8990774);
   mainFit1030->SetParError(1,0.01311746);
   ...
   pt_LaTex = pt->AddText("0.899#pm0.0131");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.813504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.813504,-57.90228,1.813504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.4631896);
   ...
   mainFit1031->SetParameter(0,-1.63048);
   mainFit1031->SetParError(0,0.4323712);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8990774);
   mainFit1031->SetParError(1,0.01311746);
