...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.90228);
   Graph_Graph01027->SetMaximum(53.7179);
   ...
   mainFit1028->SetChisquare(1.728028);
   ...
   mainFit1028->SetParameter(0,-1.24626);
   mainFit1028->SetParError(0,0.4443067);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9052948);
   mainFit1028->SetParError(1,0.01454209);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.576");
   pt_LaTex = pt->AddText("0.905#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.25#pm0.444");
   pt_LaTex = pt->AddText("#minus1.38#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.376634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.376634,-57.90228,1.376634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.728028);
   ...
   mainFit1029->SetParameter(0,-1.24626);
   mainFit1029->SetParError(0,0.4443067);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9052948);
   mainFit1029->SetParError(1,0.01454209);
