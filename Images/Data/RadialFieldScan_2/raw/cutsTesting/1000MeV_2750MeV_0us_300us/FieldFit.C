...
//=========  (Wed Apr 28 14:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.90228);
   Graph_Graph01020->SetMaximum(53.7179);
   ...
   mainFit1021->SetChisquare(2.336378);
   ...
   mainFit1021->SetParameter(0,-1.39996);
   mainFit1021->SetParError(0,0.3982156);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9003459);
   mainFit1021->SetParError(1,0.01308473);
   ...
   mainFit1022->SetChisquare(2.336378);
   ...
   mainFit1022->SetParameter(0,-1.39996);
   mainFit1022->SetParError(0,0.3982156);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9003459);
   mainFit1022->SetParError(1,0.01308473);
