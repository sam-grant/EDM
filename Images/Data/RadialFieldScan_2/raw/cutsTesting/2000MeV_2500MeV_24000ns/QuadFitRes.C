...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02582185);
   Graph_Graph11015->SetMaximum(0.0313409);
   ...
   Graph_Graph21016->SetMinimum(-0.002153917);
   Graph_Graph21016->SetMaximum(0.001831442);
   ...
   Graph_Graph31017->SetMinimum(-0.03822879);
   Graph_Graph31017->SetMaximum(0.03509491);
   ...
   Graph_Graph41018->SetMinimum(-0.01511543);
   Graph_Graph41018->SetMaximum(0.02086633);
   ...
   Graph_Graph51019->SetMinimum(-0.0099775);
   Graph_Graph51019->SetMaximum(0.01331528);
