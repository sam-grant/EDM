...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-41.53404);
   Graph_Graph01033->SetMaximum(48.98144);
   ...
   mainFit1034->SetChisquare(3.089295);
   ...
   mainFit1034->SetParameter(0,1.554);
   mainFit1034->SetParError(0,1.189385);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7253099);
   mainFit1034->SetParError(1,0.03923131);
   ...
   pt_LaTex = pt->AddText("0.725#pm0.0392");
   pt_LaTex = pt->AddText(" 1.55#pm 1.19");
   pt_LaTex = pt->AddText(" 2.14#pm  1.7");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.142532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.142532,-41.53404,-2.142532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.089295);
   ...
   mainFit1035->SetParameter(0,1.554);
   mainFit1035->SetParError(0,1.189385);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7253099);
   mainFit1035->SetParError(1,0.03923131);
