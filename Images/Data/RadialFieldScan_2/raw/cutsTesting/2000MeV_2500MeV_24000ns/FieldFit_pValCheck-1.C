...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-41.53404);
   Graph_Graph01023->SetMaximum(48.98144);
   ...
   mainFit1024->SetChisquare(3.369657);
   ...
   mainFit1024->SetParameter(0,1.174564);
   mainFit1024->SetParError(0,0.9492708);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7377775);
   mainFit1024->SetParError(1,0.03137948);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.842");
   pt_LaTex = pt->AddText("0.738#pm0.0314");
   pt_LaTex = pt->AddText(" 1.17#pm0.949");
   pt_LaTex = pt->AddText(" 1.59#pm  1.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.59203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.59203,-41.53404,-1.59203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.369657);
   ...
   mainFit1025->SetParameter(0,1.174564);
   mainFit1025->SetParError(0,0.9492708);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7377775);
   mainFit1025->SetParError(1,0.03137948);
