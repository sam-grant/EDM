...
//=========  (Wed Apr 21 23:39:35 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8275419);
   ...
   quadLineFit1002->SetParameter(0,74.92956);
   quadLineFit1002->SetParError(0,0.1446693);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.01211);
   quadLineFit1002->SetParError(1,2.426369);
   ...
   quadLineFit1003->SetChisquare(0.8275419);
   ...
   quadLineFit1003->SetParameter(0,74.92956);
   quadLineFit1003->SetParError(0,0.1446693);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.01211);
   quadLineFit1003->SetParError(1,2.426369);
   ...
   Graph_30_ppm1003->SetMinimum(75.98182);
   Graph_30_ppm1003->SetMaximum(76.58549);
   ...
   quadLineFit1004->SetChisquare(1.246701);
   ...
   quadLineFit1004->SetParameter(0,74.8794);
   quadLineFit1004->SetParError(0,0.1217416);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.80432);
   quadLineFit1004->SetParError(1,2.000794);
   ...
   quadLineFit1005->SetChisquare(1.246701);
   ...
   quadLineFit1005->SetParameter(0,74.8794);
   quadLineFit1005->SetParError(0,0.1217416);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.80432);
   quadLineFit1005->SetParError(1,2.000794);
   ...
   Graph_10_ppm1005->SetMinimum(75.05449);
   Graph_10_ppm1005->SetMaximum(75.37168);
   ...
   quadLineFit1006->SetChisquare(0.007767725);
   ...
   quadLineFit1006->SetParameter(0,74.60855);
   quadLineFit1006->SetParError(0,0.1427205);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.841014);
   quadLineFit1006->SetParError(1,2.31457);
   ...
   quadLineFit1007->SetChisquare(0.007767725);
   ...
   quadLineFit1007->SetParameter(0,74.60855);
   quadLineFit1007->SetParError(0,0.1427205);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.841014);
   quadLineFit1007->SetParError(1,2.31457);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.06831);
   Graph_mI10_ppm1007->SetMaximum(74.36821);
   ...
   quadLineFit1008->SetChisquare(1.860479);
   ...
   quadLineFit1008->SetParameter(0,74.68718);
   quadLineFit1008->SetParError(0,0.1252176);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.948134);
   quadLineFit1008->SetParError(1,2.037711);
   ...
   quadLineFit1009->SetChisquare(1.860479);
   ...
   quadLineFit1009->SetParameter(0,74.68718);
   quadLineFit1009->SetParError(0,0.1252176);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.948134);
   quadLineFit1009->SetParError(1,2.037711);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.84526);
   Graph_mI30_ppm1009->SetMaximum(73.44956);
   ...
   quadLineFit1010->SetChisquare(0.4612724);
   ...
   quadLineFit1010->SetParameter(0,74.4971);
   quadLineFit1010->SetParError(0,0.118503);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-21.73144);
   quadLineFit1010->SetParError(1,2.050873);
   ...
   quadLineFit1011->SetChisquare(0.4612724);
   ...
   quadLineFit1011->SetParameter(0,74.4971);
   quadLineFit1011->SetParError(0,0.118503);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-21.73144);
   quadLineFit1011->SetParError(1,2.050873);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.07016);
   Graph_mI50_ppm1011->SetMaximum(72.55035);
   ...
   quadLineFit1012->SetChisquare(0.263633);
   ...
   quadLineFit1012->SetParameter(0,74.01153);
   quadLineFit1012->SetParError(0,0.239038);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-29.71441);
   quadLineFit1012->SetParError(1,4.276669);
   ...
   quadLineFit1013->SetChisquare(0.263633);
   ...
   quadLineFit1013->SetParameter(0,74.01153);
   quadLineFit1013->SetParError(0,0.239038);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-29.71441);
   quadLineFit1013->SetParError(1,4.276669);
