...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-41.53404);
   Graph_Graph01029->SetMaximum(48.98144);
   ...
   mainFit1030->SetChisquare(2.99681);
   ...
   mainFit1030->SetParameter(0,0.9278526);
   mainFit1030->SetParError(0,1.031716);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7363133);
   mainFit1030->SetParError(1,0.03146972);
   ...
   pt_LaTex = pt->AddText("0.736#pm0.0315");
   pt_LaTex = pt->AddText("0.928#pm 1.03");
   pt_LaTex = pt->AddText(" 1.26#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.260133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.260133,-41.53404,-1.260133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.99681);
   ...
   mainFit1031->SetParameter(0,0.9278526);
   mainFit1031->SetParError(0,1.031716);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7363133);
   mainFit1031->SetParError(1,0.03146972);
