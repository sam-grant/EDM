...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-41.53404);
   Graph_Graph01027->SetMaximum(48.98144);
   ...
   mainFit1028->SetChisquare(3.268429);
   ...
   mainFit1028->SetParameter(0,1.326634);
   mainFit1028->SetParError(0,1.06281);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7427466);
   mainFit1028->SetParError(1,0.03505135);
   ...
   pt_LaTex = pt->AddText("0.743#pm0.0351");
   pt_LaTex = pt->AddText(" 1.33#pm 1.06");
   pt_LaTex = pt->AddText(" 1.79#pm 1.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.78612,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.78612,-41.53404,-1.78612,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.268429);
   ...
   mainFit1029->SetParameter(0,1.326634);
   mainFit1029->SetParError(0,1.06281);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7427466);
   mainFit1029->SetParError(1,0.03505135);
