...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.08751,70,57.74368);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.30439);
   Graph_Graph01035->SetMaximum(47.96056);
   ...
   mainFit1036->SetChisquare(0.8775402);
   ...
   mainFit1036->SetParameter(0,0.7001625);
   mainFit1036->SetParError(0,0.9957019);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7602294);
   mainFit1036->SetParError(1,0.03445207);
   ...
   pt_LaTex = pt->AddText(" 0.76#pm0.0345");
   pt_LaTex = pt->AddText("  0.7#pm0.996");
   pt_LaTex = pt->AddText("0.921#pm 1.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.9209885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9209885,-30.30439,-0.9209885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.8775402);
   ...
   mainFit1037->SetParameter(0,0.7001625);
   mainFit1037->SetParError(0,0.9957019);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7602294);
   mainFit1037->SetParError(1,0.03445207);
