...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-52.84848,75,60.29587);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-41.53404);
   Graph_Graph01031->SetMaximum(48.98144);
   ...
   mainFit1032->SetChisquare(2.373424);
   ...
   mainFit1032->SetParameter(0,1.716562);
   mainFit1032->SetParError(0,1.093612);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7294034);
   mainFit1032->SetParError(1,0.03248171);
   ...
   pt_LaTex = pt->AddText("0.729#pm0.0325");
   pt_LaTex = pt->AddText(" 1.72#pm 1.09");
   pt_LaTex = pt->AddText(" 2.35#pm 1.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.353378,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.353378,-41.53404,-2.353378,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.373424);
   ...
   mainFit1033->SetParameter(0,1.716562);
   mainFit1033->SetParError(0,1.093612);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7294034);
   mainFit1033->SetParError(1,0.03248171);
