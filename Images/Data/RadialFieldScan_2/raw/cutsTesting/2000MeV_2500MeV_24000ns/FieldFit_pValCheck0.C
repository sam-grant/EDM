...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-48.69013,50,39.50416);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-39.8707);
   Graph_Graph01025->SetMaximum(30.68473);
   ...
   mainFit1026->SetChisquare(3.070315);
   ...
   mainFit1026->SetParameter(0,0.9662819);
   mainFit1026->SetParError(0,1.022759);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7237631);
   mainFit1026->SetParError(1,0.04050614);
   ...
   pt_LaTex = pt->AddText("0.724#pm0.0405");
   pt_LaTex = pt->AddText("0.966#pm 1.02");
   pt_LaTex = pt->AddText(" 1.34#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-1.33508,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.33508,-39.8707,-1.33508,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.070315);
   ...
   mainFit1027->SetParameter(0,0.9662819);
   mainFit1027->SetParError(0,1.022759);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7237631);
   mainFit1027->SetParError(1,0.04050614);
