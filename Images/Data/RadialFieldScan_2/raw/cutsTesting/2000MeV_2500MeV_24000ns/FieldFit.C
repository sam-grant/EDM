...
//=========  (Wed Apr 21 23:39:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-41.53404);
   Graph_Graph01020->SetMaximum(48.98144);
   ...
   mainFit1021->SetChisquare(3.369657);
   ...
   mainFit1021->SetParameter(0,1.174564);
   mainFit1021->SetParError(0,0.9492708);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7377775);
   mainFit1021->SetParError(1,0.03137948);
   ...
   mainFit1022->SetChisquare(3.369657);
   ...
   mainFit1022->SetParameter(0,1.174564);
   mainFit1022->SetParError(0,0.9492708);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7377775);
   mainFit1022->SetParError(1,0.03137948);
