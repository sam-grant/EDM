...
//=========  (Wed Apr 21 22:54:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.86701);
   Graph_Graph01020->SetMaximum(51.09176);
   ...
   mainFit1021->SetChisquare(5.49145);
   ...
   mainFit1021->SetParameter(0,-1.167686);
   mainFit1021->SetParError(0,0.9317836);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.807974);
   mainFit1021->SetParError(1,0.03081844);
   ...
   mainFit1022->SetChisquare(5.49145);
   ...
   mainFit1022->SetParameter(0,-1.167686);
   mainFit1022->SetParError(0,0.9317836);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.807974);
   mainFit1022->SetParError(1,0.03081844);
