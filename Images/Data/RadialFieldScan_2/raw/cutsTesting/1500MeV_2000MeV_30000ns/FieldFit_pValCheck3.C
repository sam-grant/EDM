...
//=========  (Wed Apr 21 22:54:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.86701);
   Graph_Graph01031->SetMaximum(51.09176);
   ...
   mainFit1032->SetChisquare(4.98447);
   ...
   mainFit1032->SetParameter(0,-1.547148);
   mainFit1032->SetParError(0,1.07339);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8138445);
   mainFit1032->SetParError(1,0.03189801);
   ...
   pt_LaTex = pt->AddText("0.814#pm0.0319");
   pt_LaTex = pt->AddText("#minus1.55#pm 1.07");
   pt_LaTex = pt->AddText(" #minus1.9#pm  1.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.901036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.901036,-63.86701,1.901036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.98447);
   ...
   mainFit1033->SetParameter(0,-1.547148);
   mainFit1033->SetParError(0,1.07339);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8138445);
   mainFit1033->SetParError(1,0.03189801);
