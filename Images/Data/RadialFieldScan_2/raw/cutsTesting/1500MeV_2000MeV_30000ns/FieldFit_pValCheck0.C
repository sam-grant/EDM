...
//=========  (Wed Apr 21 22:54:58 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.86609,50,43.60781);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.1187);
   Graph_Graph01025->SetMaximum(31.86042);
   ...
   mainFit1026->SetChisquare(5.48759);
   ...
   mainFit1026->SetParameter(0,-1.144627);
   mainFit1026->SetParError(0,1.003732);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8095295);
   mainFit1026->SetParError(1,0.03975229);
   ...
   pt_LaTex = pt->AddText(" 0.81#pm0.0398");
   pt_LaTex = pt->AddText("#minus1.14#pm    1");
   pt_LaTex = pt->AddText("#minus1.41#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.413941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.413941,-62.1187,1.413941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.48759);
   ...
   mainFit1027->SetParameter(0,-1.144627);
   mainFit1027->SetParError(0,1.003732);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8095295);
   mainFit1027->SetParError(1,0.03975229);
