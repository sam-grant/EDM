...
//=========  (Wed Apr 21 22:54:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.86701);
   Graph_Graph01033->SetMaximum(51.09176);
   ...
   mainFit1034->SetChisquare(4.056222);
   ...
   mainFit1034->SetParameter(0,-2.010321);
   mainFit1034->SetParError(0,1.167426);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8356976);
   mainFit1034->SetParError(1,0.03853371);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0385");
   pt_LaTex = pt->AddText("#minus2.01#pm 1.17");
   pt_LaTex = pt->AddText("#minus2.41#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.405561,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.405561,-63.86701,2.405561,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.056222);
   ...
   mainFit1035->SetParameter(0,-2.010321);
   mainFit1035->SetParError(0,1.167426);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8356976);
   mainFit1035->SetParError(1,0.03853371);
