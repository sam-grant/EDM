...
//=========  (Wed Apr 21 22:54:59 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-42.50877,70,58.31599);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.42629);
   Graph_Graph01035->SetMaximum(48.23351);
   ...
   mainFit1036->SetChisquare(0.273365);
   ...
   mainFit1036->SetParameter(0,-0.4945897);
   mainFit1036->SetParError(0,0.9772705);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7760776);
   mainFit1036->SetParError(1,0.03383624);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0911");
   pt_LaTex = pt->AddText("0.776#pm0.0338");
   pt_LaTex = pt->AddText("#minus0.495#pm0.977");
   pt_LaTex = pt->AddText("#minus0.637#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6372941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6372941,-32.42629,0.6372941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.273365);
   ...
   mainFit1037->SetParameter(0,-0.4945897);
   mainFit1037->SetParError(0,0.9772705);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7760776);
   mainFit1037->SetParError(1,0.03383624);
