...
//=========  (Wed Apr 21 22:54:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-78.23685,75,65.46161);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-63.86701);
   Graph_Graph01027->SetMaximum(51.09176);
   ...
   mainFit1028->SetChisquare(5.071034);
   ...
   mainFit1028->SetParameter(0,-0.8630173);
   mainFit1028->SetParError(0,1.04359);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8179557);
   mainFit1028->SetParError(1,0.03444167);
   ...
   pt_LaTex = pt->AddText("0.818#pm0.0344");
   pt_LaTex = pt->AddText("#minus0.863#pm 1.04");
   pt_LaTex = pt->AddText("#minus1.06#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.055091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.055091,-63.86701,1.055091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(5.071034);
   ...
   mainFit1029->SetParameter(0,-0.8630173);
   mainFit1029->SetParError(0,1.04359);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8179557);
   mainFit1029->SetParError(1,0.03444167);
