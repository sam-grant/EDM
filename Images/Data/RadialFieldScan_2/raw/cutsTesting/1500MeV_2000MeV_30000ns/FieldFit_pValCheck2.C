...
//=========  (Wed Apr 21 22:54:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.86701);
   Graph_Graph01029->SetMaximum(51.09176);
   ...
   mainFit1030->SetChisquare(5.484124);
   ...
   mainFit1030->SetParameter(0,-1.201708);
   mainFit1030->SetParError(0,1.01281);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8077836);
   mainFit1030->SetParError(1,0.03090822);
   ...
   pt_LaTex = pt->AddText("0.808#pm0.0309");
   pt_LaTex = pt->AddText(" #minus1.2#pm 1.01");
   pt_LaTex = pt->AddText("#minus1.49#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.48766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.48766,-63.86701,1.48766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.484124);
   ...
   mainFit1031->SetParameter(0,-1.201708);
   mainFit1031->SetParError(0,1.01281);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8077836);
   mainFit1031->SetParError(1,0.03090822);
