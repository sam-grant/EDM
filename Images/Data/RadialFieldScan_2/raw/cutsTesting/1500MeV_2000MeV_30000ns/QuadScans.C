...
//=========  (Wed Apr 21 22:54:58 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.598189);
   ...
   quadLineFit1002->SetParameter(0,74.64148);
   quadLineFit1002->SetParError(0,0.1422585);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.12548);
   quadLineFit1002->SetParError(1,2.386387);
   ...
   quadLineFit1003->SetChisquare(1.598189);
   ...
   quadLineFit1003->SetParameter(0,74.64148);
   quadLineFit1003->SetParError(0,0.1422585);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.12548);
   quadLineFit1003->SetParError(1,2.386387);
   ...
   Graph_30_ppm1003->SetMinimum(75.63289);
   Graph_30_ppm1003->SetMaximum(76.22137);
   ...
   quadLineFit1004->SetChisquare(2.755312);
   ...
   quadLineFit1004->SetParameter(0,74.57972);
   quadLineFit1004->SetParError(0,0.1194722);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.06531);
   quadLineFit1004->SetParError(1,1.963518);
   ...
   quadLineFit1005->SetChisquare(2.755312);
   ...
   quadLineFit1005->SetParameter(0,74.57972);
   quadLineFit1005->SetParError(0,0.1194722);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.06531);
   quadLineFit1005->SetParError(1,1.963518);
   ...
   Graph_10_ppm1005->SetMinimum(74.7359);
   Graph_10_ppm1005->SetMaximum(74.99327);
   ...
   quadLineFit1006->SetChisquare(0.5976917);
   ...
   quadLineFit1006->SetParameter(0,74.4148);
   quadLineFit1006->SetParError(0,0.1400512);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.089372);
   quadLineFit1006->SetParError(1,2.271344);
   ...
   quadLineFit1007->SetChisquare(0.5976917);
   ...
   quadLineFit1007->SetParameter(0,74.4148);
   quadLineFit1007->SetParError(0,0.1400512);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.089372);
   quadLineFit1007->SetParError(1,2.271344);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.59144);
   Graph_mI10_ppm1007->SetMaximum(73.90349);
   ...
   quadLineFit1008->SetChisquare(5.254651);
   ...
   quadLineFit1008->SetParameter(0,74.23222);
   quadLineFit1008->SetParError(0,0.1228762);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.025684);
   quadLineFit1008->SetParError(1,2.000162);
   ...
   quadLineFit1009->SetChisquare(5.254651);
   ...
   quadLineFit1009->SetParameter(0,74.23222);
   quadLineFit1009->SetParError(0,0.1228762);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.025684);
   quadLineFit1009->SetParError(1,2.000162);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.33251);
   Graph_mI30_ppm1009->SetMaximum(72.99786);
   ...
   quadLineFit1010->SetChisquare(1.996152);
   ...
   quadLineFit1010->SetParameter(0,74.13901);
   quadLineFit1010->SetParError(0,0.1162804);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.69218);
   quadLineFit1010->SetParError(1,2.012463);
   ...
   quadLineFit1011->SetChisquare(1.996152);
   ...
   quadLineFit1011->SetParameter(0,74.13901);
   quadLineFit1011->SetParError(0,0.1162804);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.69218);
   quadLineFit1011->SetParError(1,2.012463);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38872);
   Graph_mI50_ppm1011->SetMaximum(72.1435);
   ...
   quadLineFit1012->SetChisquare(0.24784);
   ...
   quadLineFit1012->SetParameter(0,74.61164);
   quadLineFit1012->SetParError(0,0.2345981);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.08912);
   quadLineFit1012->SetParError(1,4.197991);
   ...
   quadLineFit1013->SetChisquare(0.24784);
   ...
   quadLineFit1013->SetParameter(0,74.61164);
   quadLineFit1013->SetParError(0,0.2345981);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.08912);
   quadLineFit1013->SetParError(1,4.197991);
