...
//=========  (Wed Apr 21 22:54:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02564923);
   Graph_Graph11015->SetMaximum(0.06719353);
   ...
   Graph_Graph21016->SetMinimum(-0.01573706);
   Graph_Graph21016->SetMaximum(0.01855951);
   ...
   Graph_Graph31017->SetMinimum(-0.05595985);
   Graph_Graph31017->SetMaximum(0.05399276);
   ...
   Graph_Graph41018->SetMinimum(-0.0291198);
   Graph_Graph41018->SetMaximum(0.05223643);
   ...
   Graph_Graph51019->SetMinimum(-0.01264444);
   Graph_Graph51019->SetMaximum(0.00946184);
