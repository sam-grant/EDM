...
//=========  (Wed Apr 21 22:54:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.86701);
   Graph_Graph01023->SetMaximum(51.09176);
   ...
   mainFit1024->SetChisquare(5.49145);
   ...
   mainFit1024->SetParameter(0,-1.167686);
   mainFit1024->SetParError(0,0.9317836);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.807974);
   mainFit1024->SetParError(1,0.03081844);
   ...
   pt_LaTex = pt->AddText("0.808#pm0.0308");
   pt_LaTex = pt->AddText("#minus1.17#pm0.932");
   pt_LaTex = pt->AddText("#minus1.45#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.445203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.445203,-63.86701,1.445203,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.49145);
   ...
   mainFit1025->SetParameter(0,-1.167686);
   mainFit1025->SetParError(0,0.9317836);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.807974);
   mainFit1025->SetParError(1,0.03081844);
