...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.02204);
   Graph_Graph01033->SetMaximum(56.89901);
   ...
   mainFit1034->SetChisquare(8.882478);
   ...
   mainFit1034->SetParameter(0,-1.271337);
   mainFit1034->SetParError(0,0.5828929);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9121241);
   mainFit1034->SetParError(1,0.01914444);
   ...
   pt_LaTex = pt->AddText("0.912#pm0.0191");
   pt_LaTex = pt->AddText("#minus1.27#pm0.583");
   pt_LaTex = pt->AddText("#minus1.39#pm0.626");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.39382,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.39382,-58.02204,1.39382,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.882478);
   ...
   mainFit1035->SetParameter(0,-1.271337);
   mainFit1035->SetParError(0,0.5828929);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9121241);
   mainFit1035->SetParError(1,0.01914444);
