...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.58791,70,66.30429);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.19869);
   Graph_Graph01035->SetMaximum(54.91507);
   ...
   mainFit1036->SetChisquare(9.412238);
   ...
   mainFit1036->SetParameter(0,-1.001758);
   mainFit1036->SetParError(0,0.4875511);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9031491);
   mainFit1036->SetParError(1,0.01679925);
   ...
   pt_LaTex = pt->AddText("0.903#pm0.0168");
   pt_LaTex = pt->AddText("   #minus1#pm0.488");
   pt_LaTex = pt->AddText("#minus1.11#pm0.535");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.109184,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.109184,-36.19869,1.109184,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.412238);
   ...
   mainFit1037->SetParameter(0,-1.001758);
   mainFit1037->SetParError(0,0.4875511);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9031491);
   mainFit1037->SetParError(1,0.01679925);
