...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.02204);
   Graph_Graph01023->SetMaximum(56.89901);
   ...
   mainFit1024->SetChisquare(9.418677);
   ...
   mainFit1024->SetParameter(0,-1.013612);
   mainFit1024->SetParError(0,0.4646377);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9037046);
   mainFit1024->SetParError(1,0.01530696);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.35");
   pt_LaTex = pt->AddText("0.904#pm0.0153");
   pt_LaTex = pt->AddText("#minus1.01#pm0.465");
   pt_LaTex = pt->AddText("#minus1.12#pm0.511");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.121618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.121618,-58.02204,1.121618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(9.418677);
   ...
   mainFit1025->SetParameter(0,-1.013612);
   mainFit1025->SetParError(0,0.4646377);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9037046);
   mainFit1025->SetParError(1,0.01530696);
