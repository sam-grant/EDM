...
//=========  (Mon Apr 26 23:01:59 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.05555924);
   ...
   quadLineFit1002->SetParameter(0,74.43411);
   quadLineFit1002->SetParError(0,0.0699512);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.14903);
   quadLineFit1002->SetParError(1,1.173233);
   ...
   quadLineFit1003->SetChisquare(0.05555924);
   ...
   quadLineFit1003->SetParameter(0,74.43411);
   quadLineFit1003->SetParError(0,0.0699512);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.14903);
   quadLineFit1003->SetParError(1,1.173233);
   ...
   Graph_30_ppm1003->SetMinimum(75.77457);
   Graph_30_ppm1003->SetMaximum(76.3739);
   ...
   quadLineFit1004->SetChisquare(1.670745);
   ...
   quadLineFit1004->SetParameter(0,74.60589);
   quadLineFit1004->SetParError(0,0.05965125);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.84689);
   quadLineFit1004->SetParError(1,0.980483);
   ...
   quadLineFit1005->SetChisquare(1.670745);
   ...
   quadLineFit1005->SetParameter(0,74.60589);
   quadLineFit1005->SetParError(0,0.05965125);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.84689);
   quadLineFit1005->SetParError(1,0.980483);
   ...
   Graph_10_ppm1005->SetMinimum(74.7799);
   Graph_10_ppm1005->SetMaximum(75.04526);
   ...
   quadLineFit1006->SetChisquare(1.937674);
   ...
   quadLineFit1006->SetParameter(0,74.34301);
   quadLineFit1006->SetParError(0,0.06986088);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.080309);
   quadLineFit1006->SetParError(1,1.133099);
   ...
   quadLineFit1007->SetChisquare(1.937674);
   ...
   quadLineFit1007->SetParameter(0,74.34301);
   quadLineFit1007->SetParError(0,0.06986088);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.080309);
   quadLineFit1007->SetParError(1,1.133099);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.55832);
   Graph_mI10_ppm1007->SetMaximum(73.8798);
   ...
   quadLineFit1008->SetChisquare(9.309956);
   ...
   quadLineFit1008->SetParameter(0,74.35169);
   quadLineFit1008->SetParError(0,0.06138829);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.45334);
   quadLineFit1008->SetParError(1,0.9992559);
   ...
   quadLineFit1009->SetChisquare(9.309956);
   ...
   quadLineFit1009->SetParameter(0,74.35169);
   quadLineFit1009->SetParError(0,0.06138829);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.45334);
   quadLineFit1009->SetParError(1,0.9992559);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.19581);
   Graph_mI30_ppm1009->SetMaximum(72.89701);
   ...
   quadLineFit1010->SetChisquare(2.43078);
   ...
   quadLineFit1010->SetParameter(0,74.25216);
   quadLineFit1010->SetParError(0,0.05804213);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.60131);
   quadLineFit1010->SetParError(1,1.004558);
   ...
   quadLineFit1011->SetChisquare(2.43078);
   ...
   quadLineFit1011->SetParameter(0,74.25216);
   quadLineFit1011->SetParError(0,0.05804213);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.60131);
   quadLineFit1011->SetParError(1,1.004558);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.25809);
   Graph_mI50_ppm1011->SetMaximum(71.92114);
   ...
   quadLineFit1012->SetChisquare(0.4551396);
   ...
   quadLineFit1012->SetParameter(0,74.23289);
   quadLineFit1012->SetParError(0,0.1171853);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.34845);
   quadLineFit1012->SetParError(1,2.096829);
   ...
   quadLineFit1013->SetChisquare(0.4551396);
   ...
   quadLineFit1013->SetParameter(0,74.23289);
   quadLineFit1013->SetParError(0,0.1171853);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.34845);
   quadLineFit1013->SetParError(1,2.096829);
