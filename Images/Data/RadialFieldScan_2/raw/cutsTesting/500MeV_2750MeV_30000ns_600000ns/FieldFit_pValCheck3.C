...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.02204);
   Graph_Graph01031->SetMaximum(56.89901);
   ...
   mainFit1032->SetChisquare(9.198179);
   ...
   mainFit1032->SetParameter(0,-0.8888806);
   mainFit1032->SetParError(0,0.5352064);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9017699);
   mainFit1032->SetParError(1,0.01585172);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.07");
   pt_LaTex = pt->AddText("0.902#pm0.0159");
   pt_LaTex = pt->AddText("#minus0.889#pm0.535");
   pt_LaTex = pt->AddText("#minus0.986#pm0.589");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9857066,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9857066,-58.02204,0.9857066,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(9.198179);
   ...
   mainFit1033->SetParameter(0,-0.8888806);
   mainFit1033->SetParError(0,0.5352064);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9017699);
   mainFit1033->SetParError(1,0.01585172);
