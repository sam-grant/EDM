...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.02204);
   Graph_Graph01029->SetMaximum(56.89901);
   ...
   mainFit1030->SetChisquare(8.373198);
   ...
   mainFit1030->SetParameter(0,-1.215395);
   mainFit1030->SetParError(0,0.5048123);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9025625);
   mainFit1030->SetParError(1,0.01534755);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.79");
   pt_LaTex = pt->AddText("0.903#pm0.0153");
   pt_LaTex = pt->AddText("#minus1.22#pm0.505");
   pt_LaTex = pt->AddText("#minus1.35#pm0.557");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.346605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.346605,-58.02204,1.346605,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(8.373198);
   ...
   mainFit1031->SetParameter(0,-1.215395);
   mainFit1031->SetParError(0,0.5048123);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9025625);
   mainFit1031->SetParError(1,0.01534755);
