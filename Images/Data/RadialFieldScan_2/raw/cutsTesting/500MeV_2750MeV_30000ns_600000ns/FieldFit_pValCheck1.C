...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.38717,75,71.26415);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-58.02204);
   Graph_Graph01027->SetMaximum(56.89901);
   ...
   mainFit1028->SetChisquare(1.059862);
   ...
   mainFit1028->SetParameter(0,-0.3444004);
   mainFit1028->SetParError(0,0.5191008);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9253906);
   mainFit1028->SetParError(1,0.01704598);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.353");
   pt_LaTex = pt->AddText("0.925#pm0.017");
   pt_LaTex = pt->AddText("#minus0.344#pm0.519");
   pt_LaTex = pt->AddText("#minus0.372#pm0.561");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3721675,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3721675,-58.02204,0.3721675,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.059862);
   ...
   mainFit1029->SetParameter(0,-0.3444004);
   mainFit1029->SetParError(0,0.5191008);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9253906);
   mainFit1029->SetParError(1,0.01704598);
