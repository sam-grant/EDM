...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.76345,50,43.14554);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.77255);
   Graph_Graph01025->SetMaximum(32.15464);
   ...
   mainFit1026->SetChisquare(3.783123);
   ...
   mainFit1026->SetParameter(0,-1.459307);
   mainFit1026->SetParError(0,0.5011353);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8737084);
   mainFit1026->SetParError(1,0.0198485);
   ...
   pt_LaTex = pt->AddText("0.874#pm0.0198");
   pt_LaTex = pt->AddText("#minus1.46#pm0.501");
   pt_LaTex = pt->AddText("#minus1.67#pm0.579");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.670245,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.670245,-55.77255,1.670245,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.783123);
   ...
   mainFit1027->SetParameter(0,-1.459307);
   mainFit1027->SetParError(0,0.5011353);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8737084);
   mainFit1027->SetParError(1,0.0198485);
