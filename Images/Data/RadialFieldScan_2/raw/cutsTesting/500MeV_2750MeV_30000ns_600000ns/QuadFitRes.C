...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01535213);
   Graph_Graph11015->SetMaximum(0.01462648);
   ...
   Graph_Graph21016->SetMinimum(-0.01415411);
   Graph_Graph21016->SetMaximum(0.01667617);
   ...
   Graph_Graph31017->SetMinimum(-0.03951463);
   Graph_Graph31017->SetMaximum(0.03063078);
   ...
   Graph_Graph41018->SetMinimum(-0.01189463);
   Graph_Graph41018->SetMaximum(0.0194841);
   ...
   Graph_Graph51019->SetMinimum(-0.006406452);
   Graph_Graph51019->SetMaximum(0.008563025);
