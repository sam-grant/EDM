...
//=========  (Mon Apr 26 23:02:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.02204);
   Graph_Graph01020->SetMaximum(56.89901);
   ...
   mainFit1021->SetChisquare(9.418677);
   ...
   mainFit1021->SetParameter(0,-1.013612);
   mainFit1021->SetParError(0,0.4646377);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9037046);
   mainFit1021->SetParError(1,0.01530696);
   ...
   mainFit1022->SetChisquare(9.418677);
   ...
   mainFit1022->SetParameter(0,-1.013612);
   mainFit1022->SetParError(0,0.4646377);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9037046);
   mainFit1022->SetParError(1,0.01530696);
