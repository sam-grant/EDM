...
//=========  (Tue Apr 27 00:48:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.5839);
   Graph_Graph01023->SetMaximum(57.17724);
   ...
   mainFit1024->SetChisquare(9.415966);
   ...
   mainFit1024->SetParameter(0,-1.344902);
   mainFit1024->SetParError(0,0.4415677);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9233066);
   mainFit1024->SetParError(1,0.01463797);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.34#pm0.442");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.456614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.456614,-59.5839,1.456614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(9.415966);
   ...
   mainFit1025->SetParameter(0,-1.344902);
   mainFit1025->SetParError(0,0.4415677);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9233066);
   mainFit1025->SetParError(1,0.01463797);
