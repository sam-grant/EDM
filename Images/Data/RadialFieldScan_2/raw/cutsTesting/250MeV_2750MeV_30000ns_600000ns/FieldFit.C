...
//=========  (Tue Apr 27 00:48:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.5839);
   Graph_Graph01020->SetMaximum(57.17724);
   ...
   mainFit1021->SetChisquare(9.415966);
   ...
   mainFit1021->SetParameter(0,-1.344902);
   mainFit1021->SetParError(0,0.4415677);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9233066);
   mainFit1021->SetParError(1,0.01463797);
   ...
   mainFit1022->SetChisquare(9.415966);
   ...
   mainFit1022->SetParameter(0,-1.344902);
   mainFit1022->SetParError(0,0.4415677);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9233066);
   mainFit1022->SetParError(1,0.01463797);
