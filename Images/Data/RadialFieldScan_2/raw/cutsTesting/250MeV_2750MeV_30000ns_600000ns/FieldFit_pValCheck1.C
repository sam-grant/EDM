...
//=========  (Tue Apr 27 00:48:55 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-74.17905,75,71.77239);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.5839);
   Graph_Graph01027->SetMaximum(57.17724);
   ...
   mainFit1028->SetChisquare(2.080359);
   ...
   mainFit1028->SetParameter(0,-0.7376809);
   mainFit1028->SetParError(0,0.4952305);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9432957);
   mainFit1028->SetParError(1,0.01639156);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.693");
   pt_LaTex = pt->AddText("0.943#pm0.0164");
   pt_LaTex = pt->AddText("#minus0.738#pm0.495");
   pt_LaTex = pt->AddText("#minus0.782#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7820251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7820251,-59.5839,0.7820251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.080359);
   ...
   mainFit1029->SetParameter(0,-0.7376809);
   mainFit1029->SetParError(0,0.4952305);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9432957);
   mainFit1029->SetParError(1,0.01639156);
