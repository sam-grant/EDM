...
//=========  (Tue Apr 27 00:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.5839);
   Graph_Graph01029->SetMaximum(57.17724);
   ...
   mainFit1030->SetChisquare(6.433616);
   ...
   mainFit1030->SetParameter(0,-1.670816);
   mainFit1030->SetParError(0,0.4801973);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9213341);
   mainFit1030->SetParError(1,0.01468294);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0147");
   pt_LaTex = pt->AddText("#minus1.67#pm 0.48");
   pt_LaTex = pt->AddText("#minus1.81#pm0.519");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.813475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.813475,-59.5839,1.813475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.433616);
   ...
   mainFit1031->SetParameter(0,-1.670816);
   mainFit1031->SetParError(0,0.4801973);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9213341);
   mainFit1031->SetParError(1,0.01468294);
