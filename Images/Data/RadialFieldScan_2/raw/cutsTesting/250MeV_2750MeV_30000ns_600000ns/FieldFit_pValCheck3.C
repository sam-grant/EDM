...
//=========  (Tue Apr 27 00:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.5839);
   Graph_Graph01031->SetMaximum(57.17724);
   ...
   mainFit1032->SetChisquare(8.821069);
   ...
   mainFit1032->SetParameter(0,-1.150404);
   mainFit1032->SetParError(0,0.5085262);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9203202);
   mainFit1032->SetParError(1,0.01514497);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.15#pm0.509");
   pt_LaTex = pt->AddText("#minus1.25#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.250004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.250004,-59.5839,1.250004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(8.821069);
   ...
   mainFit1033->SetParameter(0,-1.150404);
   mainFit1033->SetParError(0,0.5085262);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9203202);
   mainFit1033->SetParError(1,0.01514497);
