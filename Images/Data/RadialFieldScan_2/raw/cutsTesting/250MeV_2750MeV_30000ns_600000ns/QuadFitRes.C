...
//=========  (Tue Apr 27 00:48:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02139093);
   Graph_Graph11015->SetMaximum(0.02042206);
   ...
   Graph_Graph21016->SetMinimum(-0.008192268);
   Graph_Graph21016->SetMaximum(0.0096446);
   ...
   Graph_Graph31017->SetMinimum(-0.02943284);
   Graph_Graph31017->SetMaximum(0.02921243);
   ...
   Graph_Graph41018->SetMinimum(-0.007277631);
   Graph_Graph41018->SetMaximum(0.01017831);
   ...
   Graph_Graph51019->SetMinimum(-0.004446883);
   Graph_Graph51019->SetMaximum(0.005943266);
