...
//=========  (Tue Apr 27 00:48:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.81575,70,66.69973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.2642);
   Graph_Graph01035->SetMaximum(55.14818);
   ...
   mainFit1036->SetChisquare(9.375668);
   ...
   mainFit1036->SetParameter(0,-1.317003);
   mainFit1036->SetParError(0,0.462984);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9219843);
   mainFit1036->SetParError(1,0.01607382);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0161");
   pt_LaTex = pt->AddText("#minus1.32#pm0.463");
   pt_LaTex = pt->AddText("#minus1.43#pm0.496");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.428444,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.428444,-37.2642,1.428444,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.375668);
   ...
   mainFit1037->SetParameter(0,-1.317003);
   mainFit1037->SetParError(0,0.462984);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9219843);
   mainFit1037->SetParError(1,0.01607382);
