...
//=========  (Tue Apr 27 00:48:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.64177,50,44.08602);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.36899);
   Graph_Graph01025->SetMaximum(32.81324);
   ...
   mainFit1026->SetChisquare(6.125401);
   ...
   mainFit1026->SetParameter(0,-1.663965);
   mainFit1026->SetParError(0,0.4753014);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9018491);
   mainFit1026->SetParError(1,0.01882374);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.04");
   pt_LaTex = pt->AddText("0.902#pm0.0188");
   pt_LaTex = pt->AddText("#minus1.66#pm0.475");
   pt_LaTex = pt->AddText("#minus1.85#pm0.533");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.845059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.845059,-57.36899,1.845059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(6.125401);
   ...
   mainFit1027->SetParameter(0,-1.663965);
   mainFit1027->SetParError(0,0.4753014);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9018491);
   mainFit1027->SetParError(1,0.01882374);
