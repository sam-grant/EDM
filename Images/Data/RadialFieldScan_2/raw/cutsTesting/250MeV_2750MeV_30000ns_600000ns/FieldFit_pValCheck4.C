...
//=========  (Tue Apr 27 00:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.5839);
   Graph_Graph01033->SetMaximum(57.17724);
   ...
   mainFit1034->SetChisquare(9.005355);
   ...
   mainFit1034->SetParameter(0,-1.558293);
   mainFit1034->SetParError(0,0.5530254);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9303616);
   mainFit1034->SetParError(1,0.0183062);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("    3");
   pt_LaTex = pt->AddText(" 0.93#pm0.0183");
   pt_LaTex = pt->AddText("#minus1.56#pm0.553");
   pt_LaTex = pt->AddText("#minus1.67#pm 0.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.674933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.674933,-59.5839,1.674933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.005355);
   ...
   mainFit1035->SetParameter(0,-1.558293);
   mainFit1035->SetParError(0,0.5530254);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9303616);
   mainFit1035->SetParError(1,0.0183062);
