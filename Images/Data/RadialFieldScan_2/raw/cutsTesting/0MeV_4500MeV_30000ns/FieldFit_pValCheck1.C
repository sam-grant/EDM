...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.19803);
   Graph_Graph01027->SetMaximum(56.13136);
   ...
   mainFit1028->SetChisquare(1.2319);
   ...
   mainFit1028->SetParameter(0,-1.685572);
   mainFit1028->SetParError(0,0.4484696);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9416206);
   mainFit1028->SetParError(1,0.0147889);
   ...
   pt_LaTex = pt->AddText("#minus1.69#pm0.448");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.790076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.790076,-61.19803,1.790076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.2319);
   ...
   mainFit1029->SetParameter(0,-1.685572);
   mainFit1029->SetParError(0,0.4484696);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9416206);
   mainFit1029->SetParError(1,0.0147889);
