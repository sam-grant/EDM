...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.19803);
   Graph_Graph01031->SetMaximum(56.13136);
   ...
   mainFit1032->SetChisquare(5.222962);
   ...
   mainFit1032->SetParameter(0,-2.000883);
   mainFit1032->SetParError(0,0.4613264);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.92668);
   mainFit1032->SetParError(1,0.01370349);
   ...
   pt_LaTex = pt->AddText("   #minus2#pm0.461");
   pt_LaTex = pt->AddText("#minus2.16#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.159196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.159196,-61.19803,2.159196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.222962);
   ...
   mainFit1033->SetParameter(0,-2.000883);
   mainFit1033->SetParError(0,0.4613264);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.92668);
   mainFit1033->SetParError(1,0.01370349);
