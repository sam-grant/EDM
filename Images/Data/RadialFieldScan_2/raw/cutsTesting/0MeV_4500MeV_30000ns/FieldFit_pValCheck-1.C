...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.19803);
   Graph_Graph01023->SetMaximum(56.13136);
   ...
   mainFit1024->SetChisquare(5.40059);
   ...
   mainFit1024->SetParameter(0,-2.097315);
   mainFit1024->SetParError(0,0.400566);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9281639);
   mainFit1024->SetParError(1,0.01324014);
   ...
   mainFit1025->SetChisquare(5.40059);
   ...
   mainFit1025->SetParameter(0,-2.097315);
   mainFit1025->SetParError(0,0.400566);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9281639);
   mainFit1025->SetParError(1,0.01324014);
