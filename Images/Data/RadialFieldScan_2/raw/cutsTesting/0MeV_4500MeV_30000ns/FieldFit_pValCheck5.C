...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.40952,70,65.5066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.91791);
   Graph_Graph01035->SetMaximum(54.01499);
   ...
   mainFit1036->SetChisquare(4.923244);
   ...
   mainFit1036->SetParameter(0,-2.009832);
   mainFit1036->SetParError(0,0.4201097);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9240277);
   mainFit1036->SetParError(1,0.01453385);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.0145");
   pt_LaTex = pt->AddText("#minus2.01#pm 0.42");
   pt_LaTex = pt->AddText("#minus2.18#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.175077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.175077,-37.91791,2.175077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.923244);
   ...
   mainFit1037->SetParameter(0,-2.009832);
   mainFit1037->SetParError(0,0.4201097);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9240277);
   mainFit1037->SetParError(1,0.01453385);
