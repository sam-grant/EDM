...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.58274,50,44.39022);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.08544);
   Graph_Graph01025->SetMaximum(32.89292);
   ...
   mainFit1026->SetChisquare(3.460795);
   ...
   mainFit1026->SetParameter(0,-2.321254);
   mainFit1026->SetParError(0,0.431627);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9131135);
   mainFit1026->SetParError(1,0.01709257);
   ...
   pt_LaTex = pt->AddText("#minus2.32#pm0.432");
   pt_LaTex = pt->AddText("#minus2.54#pm0.481");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.542131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.542131,-59.08544,2.542131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.460795);
   ...
   mainFit1027->SetParameter(0,-2.321254);
   mainFit1027->SetParError(0,0.431627);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9131135);
   mainFit1027->SetParError(1,0.01709257);
