...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.19803);
   Graph_Graph01033->SetMaximum(56.13136);
   ...
   mainFit1034->SetChisquare(4.599596);
   ...
   mainFit1034->SetParameter(0,-2.36837);
   mainFit1034->SetParError(0,0.5021619);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9370737);
   mainFit1034->SetParError(1,0.01656171);
   ...
   pt_LaTex = pt->AddText("#minus2.37#pm0.502");
   pt_LaTex = pt->AddText("#minus2.53#pm0.517");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.527411,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.527411,-61.19803,2.527411,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.599596);
   ...
   mainFit1035->SetParameter(0,-2.36837);
   mainFit1035->SetParError(0,0.5021619);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9370737);
   mainFit1035->SetParError(1,0.01656171);
