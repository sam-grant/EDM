...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.00731381);
   Graph_Graph11015->SetMaximum(0.007522221);
   ...
   Graph_Graph21016->SetMinimum(-0.009132147);
   Graph_Graph21016->SetMaximum(0.01073193);
   ...
   Graph_Graph31017->SetMinimum(-0.0253789);
   Graph_Graph31017->SetMaximum(0.02084256);
   ...
   Graph_Graph41018->SetMinimum(-0.006949859);
   Graph_Graph41018->SetMaximum(0.01257962);
   ...
   Graph_Graph51019->SetMinimum(-0.002948535);
   Graph_Graph51019->SetMaximum(0.003938902);
