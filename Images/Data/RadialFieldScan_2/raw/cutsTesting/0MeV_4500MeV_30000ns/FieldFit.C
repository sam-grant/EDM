...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.19803);
   Graph_Graph01020->SetMaximum(56.13136);
   ...
   mainFit1021->SetChisquare(5.40059);
   ...
   mainFit1021->SetParameter(0,-2.097315);
   mainFit1021->SetParError(0,0.400566);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9281639);
   mainFit1021->SetParError(1,0.01324014);
   ...
   pt_LaTex = pt->AddText(" #minus2.1#pm0.401");
   pt_LaTex = pt->AddText("#minus2.26#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.259639,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.259639,-61.19803,2.259639,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.40059);
   ...
   mainFit1022->SetParameter(0,-2.097315);
   mainFit1022->SetParError(0,0.400566);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9281639);
   mainFit1022->SetParError(1,0.01324014);
