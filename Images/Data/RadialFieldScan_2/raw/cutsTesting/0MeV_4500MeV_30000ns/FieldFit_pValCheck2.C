...
//=========  (Fri Apr 23 12:39:16 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.8642,75,70.79754);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-61.19803);
   Graph_Graph01029->SetMaximum(56.13136);
   ...
   mainFit1030->SetChisquare(4.332425);
   ...
   mainFit1030->SetParameter(0,-2.273638);
   mainFit1030->SetParError(0,0.4353775);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9271286);
   mainFit1030->SetParError(1,0.01327837);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0133");
   pt_LaTex = pt->AddText("#minus2.27#pm0.435");
   pt_LaTex = pt->AddText("#minus2.45#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.452344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.452344,-61.19803,2.452344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.332425);
   ...
   mainFit1031->SetParameter(0,-2.273638);
   mainFit1031->SetParError(0,0.4353775);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9271286);
   mainFit1031->SetParError(1,0.01327837);
