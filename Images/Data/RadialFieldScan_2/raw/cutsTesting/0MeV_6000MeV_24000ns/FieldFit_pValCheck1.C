...
//=========  (Fri Apr 23 12:14:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.96621,75,70.11867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.55772);
   Graph_Graph01027->SetMaximum(55.71018);
   ...
   mainFit1028->SetChisquare(0.6542426);
   ...
   mainFit1028->SetParameter(0,-1.462865);
   mainFit1028->SetParError(0,0.4223615);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9298934);
   mainFit1028->SetParError(1,0.01393233);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.218");
   pt_LaTex = pt->AddText(" 0.93#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.46#pm0.422");
   pt_LaTex = pt->AddText("#minus1.57#pm0.456");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.573154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.573154,-59.55772,1.573154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6542426);
   ...
   mainFit1029->SetParameter(0,-1.462865);
   mainFit1029->SetParError(0,0.4223615);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9298934);
   mainFit1029->SetParError(1,0.01393233);
