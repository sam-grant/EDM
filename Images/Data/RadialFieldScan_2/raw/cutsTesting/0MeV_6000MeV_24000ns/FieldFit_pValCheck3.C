...
//=========  (Fri Apr 23 12:14:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.55772);
   Graph_Graph01031->SetMaximum(55.71018);
   ...
   mainFit1032->SetChisquare(3.543649);
   ...
   mainFit1032->SetParameter(0,-1.713938);
   mainFit1032->SetParError(0,0.434572);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9179035);
   mainFit1032->SetParError(1,0.01291409);
   ...
   pt_LaTex = pt->AddText("#minus1.71#pm0.435");
   pt_LaTex = pt->AddText("#minus1.87#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.867232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.867232,-59.55772,1.867232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.543649);
   ...
   mainFit1033->SetParameter(0,-1.713938);
   mainFit1033->SetParError(0,0.434572);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9179035);
   mainFit1033->SetParError(1,0.01291409);
