...
//=========  (Fri Apr 23 12:14:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.55772);
   Graph_Graph01029->SetMaximum(55.71018);
   ...
   mainFit1030->SetChisquare(3.31448);
   ...
   mainFit1030->SetParameter(0,-1.889556);
   mainFit1030->SetParError(0,0.4103992);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9185454);
   mainFit1030->SetParError(1,0.01251371);
   ...
   pt_LaTex = pt->AddText("#minus1.89#pm 0.41");
   pt_LaTex = pt->AddText("#minus2.06#pm0.444");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.057118,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.057118,-59.55772,2.057118,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.31448);
   ...
   mainFit1031->SetParameter(0,-1.889556);
   mainFit1031->SetParError(0,0.4103992);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9185454);
   mainFit1031->SetParError(1,0.01251371);
