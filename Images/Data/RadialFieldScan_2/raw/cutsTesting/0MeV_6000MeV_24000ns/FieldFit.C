...
//=========  (Fri Apr 23 12:14:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.55772);
   Graph_Graph01020->SetMaximum(55.71018);
   ...
   mainFit1021->SetChisquare(3.676688);
   ...
   mainFit1021->SetParameter(0,-1.792496);
   mainFit1021->SetParError(0,0.3774027);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9191099);
   mainFit1021->SetParError(1,0.01247753);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.919");
   pt_LaTex = pt->AddText("0.919#pm0.0125");
   pt_LaTex = pt->AddText("#minus1.79#pm0.377");
   pt_LaTex = pt->AddText("#minus1.95#pm0.407");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.950252,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.950252,-59.55772,1.950252,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.676688);
   ...
   mainFit1022->SetParameter(0,-1.792496);
   mainFit1022->SetParError(0,0.3774027);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9191099);
   mainFit1022->SetParError(1,0.01247753);
