...
//=========  (Fri Apr 23 12:14:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.8104,50,44.33958);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.4954);
   Graph_Graph01025->SetMaximum(33.02458);
   ...
   mainFit1026->SetChisquare(1.666382);
   ...
   mainFit1026->SetParameter(0,-2.007268);
   mainFit1026->SetParError(0,0.4066598);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9046644);
   mainFit1026->SetParError(1,0.01611224);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.01#pm0.407");
   pt_LaTex = pt->AddText("#minus2.22#pm0.456");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.218798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.218798,-57.4954,2.218798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.666382);
   ...
   mainFit1027->SetParameter(0,-2.007268);
   mainFit1027->SetParError(0,0.4066598);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9046644);
   mainFit1027->SetParError(1,0.01611224);
