...
//=========  (Fri Apr 23 12:14:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.55772);
   Graph_Graph01023->SetMaximum(55.71018);
   ...
   mainFit1024->SetChisquare(3.676688);
   ...
   mainFit1024->SetParameter(0,-1.792496);
   mainFit1024->SetParError(0,0.3774027);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9191099);
   mainFit1024->SetParError(1,0.01247753);
   ...
   mainFit1025->SetChisquare(3.676688);
   ...
   mainFit1025->SetParameter(0,-1.792496);
   mainFit1025->SetParError(0,0.3774027);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9191099);
   mainFit1025->SetParError(1,0.01247753);
