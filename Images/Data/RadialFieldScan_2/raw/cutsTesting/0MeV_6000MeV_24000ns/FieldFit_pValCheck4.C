...
//=========  (Fri Apr 23 12:14:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.55772);
   Graph_Graph01033->SetMaximum(55.71018);
   ...
   mainFit1034->SetChisquare(3.14064);
   ...
   mainFit1034->SetParameter(0,-2.00142);
   mainFit1034->SetParError(0,0.4731166);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9259837);
   mainFit1034->SetParError(1,0.01560855);
   ...
   pt_LaTex = pt->AddText("   #minus2#pm0.473");
   pt_LaTex = pt->AddText("#minus2.16#pm0.495");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.161399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.161399,-59.55772,2.161399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.14064);
   ...
   mainFit1035->SetParameter(0,-2.00142);
   mainFit1035->SetParError(0,0.4731166);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9259837);
   mainFit1035->SetParError(1,0.01560855);
