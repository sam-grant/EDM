...
//=========  (Fri Apr 23 12:14:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004600556);
   Graph_Graph11015->SetMaximum(0.009561985);
   ...
   Graph_Graph21016->SetMinimum(-0.008544759);
   Graph_Graph21016->SetMaximum(0.01004065);
   ...
   Graph_Graph31017->SetMinimum(-0.02358555);
   Graph_Graph31017->SetMaximum(0.01882144);
   ...
   Graph_Graph41018->SetMinimum(-0.004381934);
   Graph_Graph41018->SetMaximum(0.00602096);
   ...
   Graph_Graph51019->SetMinimum(-0.002463163);
   Graph_Graph51019->SetMaximum(0.003290994);
