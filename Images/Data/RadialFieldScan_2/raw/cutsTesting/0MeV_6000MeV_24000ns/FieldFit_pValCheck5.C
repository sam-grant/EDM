...
//=========  (Fri Apr 23 12:14:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01035->SetMinimum(-37.34282);
   Graph_Graph01035->SetMaximum(53.69064);
   ...
   mainFit1036->SetChisquare(3.566825);
   ...
   mainFit1036->SetParameter(0,-1.752978);
   mainFit1036->SetParError(0,0.3958129);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9172457);
   mainFit1036->SetParError(1,0.01369642);
   ...
   pt_LaTex = pt->AddText("0.917#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.75#pm0.396");
   pt_LaTex = pt->AddText("#minus1.91#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.911132,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.911132,-37.34282,1.911132,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.566825);
   ...
   mainFit1037->SetParameter(0,-1.752978);
   mainFit1037->SetParError(0,0.3958129);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9172457);
   mainFit1037->SetParError(1,0.01369642);
