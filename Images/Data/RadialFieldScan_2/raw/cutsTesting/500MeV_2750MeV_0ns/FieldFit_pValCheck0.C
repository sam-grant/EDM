...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.51099,50,45.42911);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.11698);
   Graph_Graph01025->SetMaximum(34.0351);
   ...
   mainFit1026->SetChisquare(1.557176);
   ...
   mainFit1026->SetParameter(0,-1.99837);
   mainFit1026->SetParError(0,0.3788973);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9310534);
   mainFit1026->SetParError(1,0.01500005);
   ...
   pt_LaTex = pt->AddText("0.931#pm0.015");
   pt_LaTex = pt->AddText("   #minus2#pm0.379");
   pt_LaTex = pt->AddText("#minus2.15#pm0.413");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.146354,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.146354,-57.11698,2.146354,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.557176);
   ...
   mainFit1027->SetParameter(0,-1.99837);
   mainFit1027->SetParError(0,0.3788973);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9310534);
   mainFit1027->SetParError(1,0.01500005);
