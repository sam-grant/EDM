...
//=========  (Mon Apr 26 21:21:26 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.916226);
   ...
   quadLineFit1002->SetParameter(0,74.4993);
   quadLineFit1002->SetParError(0,0.05453463);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.52791);
   quadLineFit1002->SetParError(1,0.9146098);
   ...
   quadLineFit1003->SetChisquare(4.916226);
   ...
   quadLineFit1003->SetParameter(0,74.4993);
   quadLineFit1003->SetParError(0,0.05453463);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.52791);
   quadLineFit1003->SetParError(1,0.9146098);
   ...
   Graph_30_ppm1003->SetMinimum(75.75726);
   Graph_30_ppm1003->SetMaximum(76.40202);
   ...
   quadLineFit1004->SetChisquare(0.9406203);
   ...
   quadLineFit1004->SetParameter(0,74.49847);
   quadLineFit1004->SetParError(0,0.04512507);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.69781);
   quadLineFit1004->SetParError(1,0.74128);
   ...
   quadLineFit1005->SetChisquare(0.9406203);
   ...
   quadLineFit1005->SetParameter(0,74.49847);
   quadLineFit1005->SetParError(0,0.04512507);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.69781);
   quadLineFit1005->SetParError(1,0.74128);
   ...
   Graph_10_ppm1005->SetMinimum(74.77692);
   Graph_10_ppm1005->SetMaximum(75.01005);
   ...
   quadLineFit1006->SetChisquare(3.284629);
   ...
   quadLineFit1006->SetParameter(0,74.38135);
   quadLineFit1006->SetParError(0,0.05291522);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.151964);
   quadLineFit1006->SetParError(1,0.8578227);
   ...
   quadLineFit1007->SetChisquare(3.284629);
   ...
   quadLineFit1007->SetParameter(0,74.38135);
   quadLineFit1007->SetParError(0,0.05291522);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.151964);
   quadLineFit1007->SetParError(1,0.8578227);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.51723);
   Graph_mI10_ppm1007->SetMaximum(73.84218);
   ...
   quadLineFit1008->SetChisquare(2.61676);
   ...
   quadLineFit1008->SetParameter(0,74.39551);
   quadLineFit1008->SetParError(0,0.04644278);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.73847);
   quadLineFit1008->SetParError(1,0.7555862);
   ...
   quadLineFit1009->SetChisquare(2.61676);
   ...
   quadLineFit1009->SetParameter(0,74.39551);
   quadLineFit1009->SetParError(0,0.04644278);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.73847);
   quadLineFit1009->SetParError(1,0.7555862);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.11549);
   Graph_mI30_ppm1009->SetMaximum(72.87404);
   ...
   quadLineFit1010->SetChisquare(2.54185);
   ...
   quadLineFit1010->SetParameter(0,74.34903);
   quadLineFit1010->SetParError(0,0.04384672);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.048);
   quadLineFit1010->SetParError(1,0.7584348);
   ...
   quadLineFit1011->SetChisquare(2.54185);
   ...
   quadLineFit1011->SetParameter(0,74.34903);
   quadLineFit1011->SetParError(0,0.04384672);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.048);
   quadLineFit1011->SetParError(1,0.7584348);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.2033);
   Graph_mI50_ppm1011->SetMaximum(71.87837);
   ...
   quadLineFit1012->SetChisquare(0.1521181);
   ...
   quadLineFit1012->SetParameter(0,74.2713);
   quadLineFit1012->SetParError(0,0.08857237);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.93641);
   quadLineFit1012->SetParError(1,1.584568);
   ...
   quadLineFit1013->SetChisquare(0.1521181);
   ...
   quadLineFit1013->SetParameter(0,74.2713);
   quadLineFit1013->SetParError(0,0.08857237);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.93641);
   quadLineFit1013->SetParError(1,1.584568);
