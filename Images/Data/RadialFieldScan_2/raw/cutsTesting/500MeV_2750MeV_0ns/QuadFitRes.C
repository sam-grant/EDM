...
//=========  (Mon Apr 26 21:21:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0110266);
   Graph_Graph11015->SetMaximum(0.008795214);
   ...
   Graph_Graph21016->SetMinimum(-0.01393362);
   Graph_Graph21016->SetMaximum(0.01635434);
   ...
   Graph_Graph31017->SetMinimum(-0.0160202);
   Graph_Graph31017->SetMaximum(0.01170487);
   ...
   Graph_Graph41018->SetMinimum(-0.0128624);
   Graph_Graph41018->SetMaximum(0.01726524);
   ...
   Graph_Graph51019->SetMinimum(-0.002808155);
   Graph_Graph51019->SetMaximum(0.003743714);
