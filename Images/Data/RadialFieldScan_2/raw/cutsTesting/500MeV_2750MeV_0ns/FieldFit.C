...
//=========  (Mon Apr 26 21:21:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.11733);
   Graph_Graph01020->SetMaximum(56.03887);
   ...
   mainFit1021->SetChisquare(2.145689);
   ...
   mainFit1021->SetParameter(0,-1.890988);
   mainFit1021->SetParError(0,0.3521004);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.938261);
   mainFit1021->SetParError(1,0.01168845);
   ...
   mainFit1022->SetChisquare(2.145689);
   ...
   mainFit1022->SetParameter(0,-1.890988);
   mainFit1022->SetParError(0,0.3521004);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.938261);
   mainFit1022->SetParError(1,0.01168845);
