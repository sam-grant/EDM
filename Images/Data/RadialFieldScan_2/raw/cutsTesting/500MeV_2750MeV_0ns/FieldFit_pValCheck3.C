...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.11733);
   Graph_Graph01031->SetMaximum(56.03887);
   ...
   mainFit1032->SetChisquare(1.631983);
   ...
   mainFit1032->SetParameter(0,-1.746975);
   mainFit1032->SetParError(0,0.4054071);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9360543);
   mainFit1032->SetParError(1,0.01208871);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.544");
   pt_LaTex = pt->AddText("0.936#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.75#pm0.405");
   pt_LaTex = pt->AddText("#minus1.87#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.866318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.866318,-59.11733,1.866318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.631983);
   ...
   mainFit1033->SetParameter(0,-1.746975);
   mainFit1033->SetParError(0,0.4054071);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9360543);
   mainFit1033->SetParError(1,0.01208871);
