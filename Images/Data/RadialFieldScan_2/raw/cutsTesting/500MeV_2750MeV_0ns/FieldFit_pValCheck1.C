...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.11733);
   Graph_Graph01027->SetMaximum(56.03887);
   ...
   mainFit1028->SetChisquare(1.227847);
   ...
   mainFit1028->SetParameter(0,-1.718754);
   mainFit1028->SetParError(0,0.3953525);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9439494);
   mainFit1028->SetParError(1,0.01310907);
   ...
   pt_LaTex = pt->AddText("0.944#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.72#pm0.395");
   pt_LaTex = pt->AddText("#minus1.82#pm0.422");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.820812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.820812,-59.11733,1.820812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.227847);
   ...
   mainFit1029->SetParameter(0,-1.718754);
   mainFit1029->SetParError(0,0.3953525);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9439494);
   mainFit1029->SetParError(1,0.01310907);
