...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.51185,75,70.4334);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-59.11733);
   Graph_Graph01029->SetMaximum(56.03887);
   ...
   mainFit1030->SetChisquare(1.431986);
   ...
   mainFit1030->SetParameter(0,-2.018142);
   mainFit1030->SetParError(0,0.3829151);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9374745);
   mainFit1030->SetParError(1,0.01172587);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.477");
   pt_LaTex = pt->AddText("0.937#pm0.0117");
   pt_LaTex = pt->AddText("#minus2.02#pm0.383");
   pt_LaTex = pt->AddText("#minus2.15#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.152743,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.152743,-59.11733,2.152743,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.431986);
   ...
   mainFit1031->SetParameter(0,-2.018142);
   mainFit1031->SetParError(0,0.3829151);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9374745);
   mainFit1031->SetParError(1,0.01172587);
