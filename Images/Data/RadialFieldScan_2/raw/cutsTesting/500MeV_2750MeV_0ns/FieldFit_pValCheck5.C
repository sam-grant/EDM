...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-50.11867,70,65.75476);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.53133);
   Graph_Graph01035->SetMaximum(54.16742);
   ...
   mainFit1036->SetChisquare(1.765651);
   ...
   mainFit1036->SetParameter(0,-1.959182);
   mainFit1036->SetParError(0,0.3690619);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9415346);
   mainFit1036->SetParError(1,0.01283513);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.589");
   pt_LaTex = pt->AddText("0.942#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.96#pm0.369");
   pt_LaTex = pt->AddText("#minus2.08#pm0.386");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.080839,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.080839,-38.53133,2.080839,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.765651);
   ...
   mainFit1037->SetParameter(0,-1.959182);
   mainFit1037->SetParError(0,0.3690619);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9415346);
   mainFit1037->SetParError(1,0.01283513);
