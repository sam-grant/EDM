...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.11733);
   Graph_Graph01023->SetMaximum(56.03887);
   ...
   mainFit1024->SetChisquare(2.145689);
   ...
   mainFit1024->SetParameter(0,-1.890988);
   mainFit1024->SetParError(0,0.3521004);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.938261);
   mainFit1024->SetParError(1,0.01168845);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.0117");
   pt_LaTex = pt->AddText("#minus1.89#pm0.352");
   pt_LaTex = pt->AddText("#minus2.02#pm0.372");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.015418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.015418,-59.11733,2.015418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.145689);
   ...
   mainFit1025->SetParameter(0,-1.890988);
   mainFit1025->SetParError(0,0.3521004);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.938261);
   mainFit1025->SetParError(1,0.01168845);
