...
//=========  (Mon Apr 26 21:21:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.11733);
   Graph_Graph01033->SetMaximum(56.03887);
   ...
   mainFit1034->SetChisquare(2.145408);
   ...
   mainFit1034->SetParameter(0,-1.88655);
   mainFit1034->SetParError(0,0.4409599);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9381181);
   mainFit1034->SetParError(1,0.01462226);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.715");
   pt_LaTex = pt->AddText("0.938#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.89#pm0.441");
   pt_LaTex = pt->AddText("#minus2.01#pm0.456");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.010994,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.010994,-59.11733,2.010994,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.145408);
   ...
   mainFit1035->SetParameter(0,-1.88655);
   mainFit1035->SetParError(0,0.4409599);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9381181);
   mainFit1035->SetParError(1,0.01462226);
