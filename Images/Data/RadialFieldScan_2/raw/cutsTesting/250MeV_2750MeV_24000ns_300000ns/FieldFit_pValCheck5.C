...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.26602,70,66.11053);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.82837);
   Graph_Graph01035->SetMaximum(54.67287);
   ...
   mainFit1036->SetChisquare(6.034878);
   ...
   mainFit1036->SetParameter(0,-1.137143);
   mainFit1036->SetParError(0,0.4381029);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9195293);
   mainFit1036->SetParError(1,0.01516539);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0152");
   pt_LaTex = pt->AddText("#minus1.14#pm0.438");
   pt_LaTex = pt->AddText("#minus1.24#pm0.471");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.236657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.236657,-36.82837,1.236657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.034878);
   ...
   mainFit1037->SetParameter(0,-1.137143);
   mainFit1037->SetParError(0,0.4381029);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9195293);
   mainFit1037->SetParError(1,0.01516539);
