...
//=========  (Tue Apr 27 00:16:59 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9938203);
   ...
   quadLineFit1002->SetParameter(0,74.48226);
   quadLineFit1002->SetParError(0,0.06374813);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.97839);
   quadLineFit1002->SetParError(1,1.069385);
   ...
   quadLineFit1003->SetChisquare(0.9938203);
   ...
   quadLineFit1003->SetParameter(0,74.48226);
   quadLineFit1003->SetParError(0,0.06374813);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.97839);
   quadLineFit1003->SetParError(1,1.069385);
   ...
   Graph_30_ppm1003->SetMinimum(75.78245);
   Graph_30_ppm1003->SetMaximum(76.40387);
   ...
   quadLineFit1004->SetChisquare(3.094525);
   ...
   quadLineFit1004->SetParameter(0,74.55178);
   quadLineFit1004->SetParError(0,0.05358273);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.02934);
   quadLineFit1004->SetParError(1,0.8806772);
   ...
   quadLineFit1005->SetChisquare(3.094525);
   ...
   quadLineFit1005->SetParameter(0,74.55178);
   quadLineFit1005->SetParError(0,0.05358273);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.02934);
   quadLineFit1005->SetParError(1,0.8806772);
   ...
   Graph_10_ppm1005->SetMinimum(74.76959);
   Graph_10_ppm1005->SetMaximum(75.03331);
   ...
   quadLineFit1006->SetChisquare(0.8155081);
   ...
   quadLineFit1006->SetParameter(0,74.32377);
   quadLineFit1006->SetParError(0,0.06276025);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.291539);
   quadLineFit1006->SetParError(1,1.017901);
   ...
   quadLineFit1007->SetChisquare(0.8155081);
   ...
   quadLineFit1007->SetParameter(0,74.32377);
   quadLineFit1007->SetParError(0,0.06276025);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.291539);
   quadLineFit1007->SetParError(1,1.017901);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.53442);
   Graph_mI10_ppm1007->SetMaximum(73.85403);
   ...
   quadLineFit1008->SetChisquare(5.130366);
   ...
   quadLineFit1008->SetParameter(0,74.36785);
   quadLineFit1008->SetParError(0,0.05512525);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.03667);
   quadLineFit1008->SetParError(1,0.8972769);
   ...
   quadLineFit1009->SetChisquare(5.130366);
   ...
   quadLineFit1009->SetParameter(0,74.36785);
   quadLineFit1009->SetParError(0,0.05512525);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.03667);
   quadLineFit1009->SetParError(1,0.8972769);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.14542);
   Graph_mI30_ppm1009->SetMaximum(72.86319);
   ...
   quadLineFit1010->SetChisquare(0.7925939);
   ...
   quadLineFit1010->SetParameter(0,74.24922);
   quadLineFit1010->SetParError(0,0.05209946);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.30155);
   quadLineFit1010->SetParError(1,0.9017139);
   ...
   quadLineFit1011->SetChisquare(0.7925939);
   ...
   quadLineFit1011->SetParameter(0,74.24922);
   quadLineFit1011->SetParError(0,0.05209946);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.30155);
   quadLineFit1011->SetParError(1,0.9017139);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20248);
   Graph_mI50_ppm1011->SetMaximum(71.86939);
   ...
   quadLineFit1012->SetChisquare(0.2377732);
   ...
   quadLineFit1012->SetParameter(0,74.20986);
   quadLineFit1012->SetParError(0,0.1051939);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.92023);
   quadLineFit1012->SetParError(1,1.88224);
   ...
   quadLineFit1013->SetChisquare(0.2377732);
   ...
   quadLineFit1013->SetParameter(0,74.20986);
   quadLineFit1013->SetParError(0,0.1051939);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.92023);
   quadLineFit1013->SetParError(1,1.88224);
