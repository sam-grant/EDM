...
//=========  (Tue Apr 27 00:16:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.38749);
   Graph_Graph01020->SetMaximum(56.63279);
   ...
   mainFit1021->SetChisquare(6.043216);
   ...
   mainFit1021->SetParameter(0,-1.125084);
   mainFit1021->SetParError(0,0.4177255);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9189578);
   mainFit1021->SetParError(1,0.0138138);
   ...
   mainFit1022->SetChisquare(6.043216);
   ...
   mainFit1022->SetParameter(0,-1.125084);
   mainFit1022->SetParError(0,0.4177255);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9189578);
   mainFit1022->SetParError(1,0.0138138);
