...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.38749);
   Graph_Graph01033->SetMaximum(56.63279);
   ...
   mainFit1034->SetChisquare(5.668956);
   ...
   mainFit1034->SetParameter(0,-1.31814);
   mainFit1034->SetParError(0,0.5235261);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9253054);
   mainFit1034->SetParError(1,0.01727651);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.32#pm0.524");
   pt_LaTex = pt->AddText("#minus1.42#pm0.554");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.424546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.424546,-58.38749,1.424546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.668956);
   ...
   mainFit1035->SetParameter(0,-1.31814);
   mainFit1035->SetParError(0,0.5235261);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9253054);
   mainFit1035->SetParError(1,0.01727651);
