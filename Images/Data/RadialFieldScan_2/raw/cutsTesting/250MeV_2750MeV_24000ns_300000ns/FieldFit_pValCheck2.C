...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.38749);
   Graph_Graph01029->SetMaximum(56.63279);
   ...
   mainFit1030->SetChisquare(4.294735);
   ...
   mainFit1030->SetParameter(0,-1.3605);
   mainFit1030->SetParError(0,0.4540829);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.917561);
   mainFit1030->SetParError(1,0.01385409);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.36#pm0.454");
   pt_LaTex = pt->AddText("#minus1.48#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.482735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.482735,-58.38749,1.482735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.294735);
   ...
   mainFit1031->SetParameter(0,-1.3605);
   mainFit1031->SetParError(0,0.4540829);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.917561);
   mainFit1031->SetParError(1,0.01385409);
