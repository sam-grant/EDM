...
//=========  (Tue Apr 27 00:16:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0183991);
   Graph_Graph11015->SetMaximum(0.01755395);
   ...
   Graph_Graph21016->SetMinimum(-0.008251968);
   Graph_Graph21016->SetMaximum(0.009715298);
   ...
   Graph_Graph31017->SetMinimum(-0.02493313);
   Graph_Graph31017->SetMaximum(0.02378787);
   ...
   Graph_Graph41018->SetMinimum(-0.007410635);
   Graph_Graph41018->SetMaximum(0.008074965);
   ...
   Graph_Graph51019->SetMinimum(-0.004159398);
   Graph_Graph51019->SetMaximum(0.005559582);
