...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.38749);
   Graph_Graph01023->SetMaximum(56.63279);
   ...
   mainFit1024->SetChisquare(6.043216);
   ...
   mainFit1024->SetParameter(0,-1.125084);
   mainFit1024->SetParError(0,0.4177255);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9189578);
   mainFit1024->SetParError(1,0.0138138);
   ...
   pt_LaTex = pt->AddText("0.919#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.13#pm0.418");
   pt_LaTex = pt->AddText("#minus1.22#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.224305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.224305,-58.38749,1.224305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.043216);
   ...
   mainFit1025->SetParameter(0,-1.125084);
   mainFit1025->SetParError(0,0.4177255);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9189578);
   mainFit1025->SetParError(1,0.0138138);
