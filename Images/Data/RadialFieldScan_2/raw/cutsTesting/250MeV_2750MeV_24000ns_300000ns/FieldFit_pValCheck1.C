...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.38749);
   Graph_Graph01027->SetMaximum(56.63279);
   ...
   mainFit1028->SetChisquare(1.919454);
   ...
   mainFit1028->SetParameter(0,-0.6975163);
   mainFit1028->SetParError(0,0.4677892);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.932942);
   mainFit1028->SetParError(1,0.01543519);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.698#pm0.468");
   pt_LaTex = pt->AddText("#minus0.748#pm0.502");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7476524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7476524,-58.38749,0.7476524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.919454);
   ...
   mainFit1029->SetParameter(0,-0.6975163);
   mainFit1029->SetParError(0,0.4677892);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.932942);
   mainFit1029->SetParError(1,0.01543519);
