...
//=========  (Tue Apr 27 00:17:00 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.76503,75,71.01033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-58.38749);
   Graph_Graph01031->SetMaximum(56.63279);
   ...
   mainFit1032->SetChisquare(5.164074);
   ...
   mainFit1032->SetParameter(0,-0.9013094);
   mainFit1032->SetParError(0,0.4810964);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9155039);
   mainFit1032->SetParError(1,0.01429648);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.0143");
   pt_LaTex = pt->AddText("#minus0.901#pm0.481");
   pt_LaTex = pt->AddText("#minus0.984#pm0.522");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9844955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9844955,-58.38749,0.9844955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.164074);
   ...
   mainFit1033->SetParameter(0,-0.9013094);
   mainFit1033->SetParError(0,0.4810964);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9155039);
   mainFit1033->SetParError(1,0.01429648);
