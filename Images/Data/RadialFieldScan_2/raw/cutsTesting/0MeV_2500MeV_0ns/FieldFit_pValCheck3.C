...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.55852,75,63.23858);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-49.07881);
   Graph_Graph01031->SetMaximum(50.75887);
   ...
   mainFit1032->SetChisquare(25.17918);
   ...
   mainFit1032->SetParameter(0,-0.1189104);
   mainFit1032->SetParError(0,0.3677003);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8680507);
   mainFit1032->SetParError(1,0.01094452);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 8.39");
   pt_LaTex = pt->AddText("0.868#pm0.0109");
   pt_LaTex = pt->AddText("#minus0.119#pm0.368");
   pt_LaTex = pt->AddText("#minus0.137#pm0.423");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1369855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1369855,-49.07881,0.1369855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(25.17918);
   ...
   mainFit1033->SetParameter(0,-0.1189104);
   mainFit1033->SetParError(0,0.3677003);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8680507);
   mainFit1033->SetParError(1,0.01094452);
