...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.07881);
   Graph_Graph01029->SetMaximum(50.75887);
   ...
   mainFit1030->SetChisquare(60.26175);
   ...
   mainFit1030->SetParameter(0,-1.523317);
   mainFit1030->SetParError(0,0.3475399);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8835183);
   mainFit1030->SetParError(1,0.01062841);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 20.1");
   pt_LaTex = pt->AddText("0.884#pm0.0106");
   pt_LaTex = pt->AddText("#minus1.52#pm0.348");
   pt_LaTex = pt->AddText("#minus1.72#pm0.392");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.724149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.724149,-49.07881,1.724149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(60.26175);
   ...
   mainFit1031->SetParameter(0,-1.523317);
   mainFit1031->SetParError(0,0.3475399);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8835183);
   mainFit1031->SetParError(1,0.01062841);
