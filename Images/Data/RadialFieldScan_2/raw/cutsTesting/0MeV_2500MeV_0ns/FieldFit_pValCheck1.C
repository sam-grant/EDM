...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.07881);
   Graph_Graph01027->SetMaximum(50.75887);
   ...
   mainFit1028->SetChisquare(47.51783);
   ...
   mainFit1028->SetParameter(0,-1.923397);
   mainFit1028->SetParError(0,0.3595223);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8631996);
   mainFit1028->SetParError(1,0.01188466);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0119");
   pt_LaTex = pt->AddText("#minus1.92#pm 0.36");
   pt_LaTex = pt->AddText("#minus2.23#pm 0.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.228219,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.228219,-49.07881,2.228219,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(47.51783);
   ...
   mainFit1029->SetParameter(0,-1.923397);
   mainFit1029->SetParError(0,0.3595223);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8631996);
   mainFit1029->SetParError(1,0.01188466);
