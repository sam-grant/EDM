...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-57.98646,50,45.37831);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.64999);
   Graph_Graph01025->SetMaximum(35.04183);
   ...
   mainFit1026->SetChisquare(58.76412);
   ...
   mainFit1026->SetParameter(0,-0.9511815);
   mainFit1026->SetParError(0,0.3447684);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9051896);
   mainFit1026->SetParError(1,0.01359764);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 19.6");
   pt_LaTex = pt->AddText("0.905#pm0.0136");
   pt_LaTex = pt->AddText("#minus0.951#pm0.345");
   pt_LaTex = pt->AddText("#minus1.05#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.050809,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.050809,-47.64999,1.050809,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(58.76412);
   ...
   mainFit1027->SetParameter(0,-0.9511815);
   mainFit1027->SetParError(0,0.3447684);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9051896);
   mainFit1027->SetParError(1,0.01359764);
