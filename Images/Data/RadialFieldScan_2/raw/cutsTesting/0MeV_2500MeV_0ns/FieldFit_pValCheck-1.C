...
//=========  (Fri Apr 23 10:51:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.07881);
   Graph_Graph01023->SetMaximum(50.75887);
   ...
   mainFit1024->SetChisquare(64.24289);
   ...
   mainFit1024->SetParameter(0,-1.2522);
   mainFit1024->SetParError(0,0.3198812);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8852292);
   mainFit1024->SetParError(1,0.01059351);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.1");
   pt_LaTex = pt->AddText("0.885#pm0.0106");
   pt_LaTex = pt->AddText("#minus1.25#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.41#pm0.359");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.414549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.414549,-49.07881,1.414549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(64.24289);
   ...
   mainFit1025->SetParameter(0,-1.2522);
   mainFit1025->SetParError(0,0.3198812);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8852292);
   mainFit1025->SetParError(1,0.01059351);
