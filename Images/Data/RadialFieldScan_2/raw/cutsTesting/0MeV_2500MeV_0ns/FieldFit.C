...
//=========  (Fri Apr 23 10:51:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.07881);
   Graph_Graph01020->SetMaximum(50.75887);
   ...
   mainFit1021->SetChisquare(64.24289);
   ...
   mainFit1021->SetParameter(0,-1.2522);
   mainFit1021->SetParError(0,0.3198812);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8852292);
   mainFit1021->SetParError(1,0.01059351);
   ...
   mainFit1022->SetChisquare(64.24289);
   ...
   mainFit1022->SetParameter(0,-1.2522);
   mainFit1022->SetParError(0,0.3198812);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8852292);
   mainFit1022->SetParError(1,0.01059351);
