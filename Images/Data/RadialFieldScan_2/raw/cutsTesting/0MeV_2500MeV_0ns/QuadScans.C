...
//=========  (Fri Apr 23 10:51:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(57.01577);
   ...
   quadLineFit1002->SetParameter(0,74.59374);
   quadLineFit1002->SetParError(0,0.04961635);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.60788);
   quadLineFit1002->SetParError(1,0.8311891);
   ...
   quadLineFit1003->SetChisquare(57.01577);
   ...
   quadLineFit1003->SetParameter(0,74.59374);
   quadLineFit1003->SetParError(0,0.04961635);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.60788);
   quadLineFit1003->SetParError(1,0.8311891);
   ...
   Graph_30_ppm1003->SetMinimum(75.66021);
   Graph_30_ppm1003->SetMaximum(76.3649);
   ...
   quadLineFit1004->SetChisquare(5.601527);
   ...
   quadLineFit1004->SetParameter(0,74.33084);
   quadLineFit1004->SetParError(0,0.0411174);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,27.47638);
   quadLineFit1004->SetParError(1,0.6744653);
   ...
   quadLineFit1005->SetChisquare(5.601527);
   ...
   quadLineFit1005->SetParameter(0,74.33084);
   quadLineFit1005->SetParError(0,0.0411174);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,27.47638);
   quadLineFit1005->SetParError(1,0.6744653);
   ...
   Graph_10_ppm1005->SetMinimum(74.65342);
   Graph_10_ppm1005->SetMaximum(74.90459);
   ...
   quadLineFit1006->SetChisquare(3.545268);
   ...
   quadLineFit1006->SetParameter(0,74.21381);
   quadLineFit1006->SetParError(0,0.04845308);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.028484);
   quadLineFit1006->SetParError(1,0.7847835);
   ...
   quadLineFit1007->SetChisquare(3.545268);
   ...
   quadLineFit1007->SetParameter(0,74.21381);
   quadLineFit1007->SetParError(0,0.04845308);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.028484);
   quadLineFit1007->SetParError(1,0.7847835);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.32619);
   Graph_mI10_ppm1007->SetMaximum(73.6833);
   ...
   quadLineFit1008->SetChisquare(3.968818);
   ...
   quadLineFit1008->SetParameter(0,74.36009);
   quadLineFit1008->SetParError(0,0.04238136);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-13.806);
   quadLineFit1008->SetParError(1,0.6887597);
   ...
   quadLineFit1009->SetChisquare(3.968818);
   ...
   quadLineFit1009->SetParameter(0,74.36009);
   quadLineFit1009->SetParError(0,0.04238136);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-13.806);
   quadLineFit1009->SetParError(1,0.6887597);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.03659);
   Graph_mI30_ppm1009->SetMaximum(72.75825);
   ...
   quadLineFit1010->SetChisquare(19.0415);
   ...
   quadLineFit1010->SetParameter(0,74.13004);
   quadLineFit1010->SetParError(0,0.03967826);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.95169);
   quadLineFit1010->SetParError(1,0.6857649);
   ...
   quadLineFit1011->SetChisquare(19.0415);
   ...
   quadLineFit1011->SetParameter(0,74.13004);
   quadLineFit1011->SetParError(0,0.03967826);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.95169);
   quadLineFit1011->SetParError(1,0.6857649);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.29394);
   Graph_mI50_ppm1011->SetMaximum(71.85252);
   ...
   quadLineFit1012->SetChisquare(7.617321);
   ...
   quadLineFit1012->SetParameter(0,73.79832);
   quadLineFit1012->SetParError(0,0.07970602);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.33345);
   quadLineFit1012->SetParError(1,1.425551);
   ...
   quadLineFit1013->SetChisquare(7.617321);
   ...
   quadLineFit1013->SetParameter(0,73.79832);
   quadLineFit1013->SetParError(0,0.07970602);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.33345);
   quadLineFit1013->SetParError(1,1.425551);
