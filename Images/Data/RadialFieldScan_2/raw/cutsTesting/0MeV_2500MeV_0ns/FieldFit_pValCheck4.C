...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.07881);
   Graph_Graph01033->SetMaximum(50.75887);
   ...
   mainFit1034->SetChisquare(64.15719);
   ...
   mainFit1034->SetParameter(0,-1.181498);
   mainFit1034->SetParError(0,0.4008595);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8829047);
   mainFit1034->SetParError(1,0.01325213);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 21.4");
   pt_LaTex = pt->AddText("0.883#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.18#pm0.401");
   pt_LaTex = pt->AddText("#minus1.34#pm0.445");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.338194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.338194,-49.07881,1.338194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(64.15719);
   ...
   mainFit1035->SetParameter(0,-1.181498);
   mainFit1035->SetParError(0,0.4008595);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8829047);
   mainFit1035->SetParError(1,0.01325213);
