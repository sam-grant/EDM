...
//=========  (Fri Apr 23 10:51:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02627098);
   Graph_Graph11015->SetMaximum(0.01759395);
   ...
   Graph_Graph21016->SetMinimum(-0.01325842);
   Graph_Graph21016->SetMaximum(0.01538464);
   ...
   Graph_Graph31017->SetMinimum(-0.01302209);
   Graph_Graph31017->SetMaximum(0.01931967);
   ...
   Graph_Graph41018->SetMinimum(-0.03161324);
   Graph_Graph41018->SetMaximum(0.05484349);
   ...
   Graph_Graph51019->SetMinimum(-0.02398338);
   Graph_Graph51019->SetMaximum(0.0179823);
