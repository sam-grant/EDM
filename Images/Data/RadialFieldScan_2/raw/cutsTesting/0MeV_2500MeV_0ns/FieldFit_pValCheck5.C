...
//=========  (Fri Apr 23 10:51:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.40658,70,60.20819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.7451);
   Graph_Graph01035->SetMaximum(49.54672);
   ...
   mainFit1036->SetChisquare(40.34897);
   ...
   mainFit1036->SetParameter(0,-1.745637);
   mainFit1036->SetParError(0,0.3354297);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9088848);
   mainFit1036->SetParError(1,0.011646);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0116");
   pt_LaTex = pt->AddText("#minus1.75#pm0.335");
   pt_LaTex = pt->AddText("#minus1.92#pm0.364");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.920636,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.920636,-35.7451,1.920636,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(40.34897);
   ...
   mainFit1037->SetParameter(0,-1.745637);
   mainFit1037->SetParError(0,0.3354297);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9088848);
   mainFit1037->SetParError(1,0.011646);
