...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.08913);
   Graph_Graph01023->SetMaximum(54.99396);
   ...
   mainFit1024->SetChisquare(10.60522);
   ...
   mainFit1024->SetParameter(0,-1.68386);
   mainFit1024->SetParError(0,0.3330613);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9414311);
   mainFit1024->SetParError(1,0.01099575);
   ...
   mainFit1025->SetChisquare(10.60522);
   ...
   mainFit1025->SetParameter(0,-1.68386);
   mainFit1025->SetParError(0,0.3330613);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9414311);
   mainFit1025->SetParError(1,0.01099575);
