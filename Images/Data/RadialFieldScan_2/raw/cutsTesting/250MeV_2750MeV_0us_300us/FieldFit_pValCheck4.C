...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.08913);
   Graph_Graph01033->SetMaximum(54.99396);
   ...
   mainFit1034->SetChisquare(10.01502);
   ...
   mainFit1034->SetParameter(0,-1.490118);
   mainFit1034->SetParError(0,0.4177665);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9350791);
   mainFit1034->SetParError(1,0.01375746);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.49#pm0.418");
   pt_LaTex = pt->AddText("#minus1.59#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.593574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.593574,-57.08913,1.593574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(10.01502);
   ...
   mainFit1035->SetParameter(0,-1.490118);
   mainFit1035->SetParError(0,0.4177665);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9350791);
   mainFit1035->SetParError(1,0.01375746);
