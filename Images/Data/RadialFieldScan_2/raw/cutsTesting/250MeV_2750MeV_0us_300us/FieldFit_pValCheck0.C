...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.60579,50,46.53567);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.29164);
   Graph_Graph01025->SetMaximum(35.22152);
   ...
   mainFit1026->SetChisquare(9.679338);
   ...
   mainFit1026->SetParameter(0,-1.554737);
   mainFit1026->SetParError(0,0.3590784);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9500758);
   mainFit1026->SetParError(1,0.0141993);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.23");
   pt_LaTex = pt->AddText(" 0.95#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.55#pm0.359");
   pt_LaTex = pt->AddText("#minus1.64#pm0.382");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.636434,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.636434,-55.29164,1.636434,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.679338);
   ...
   mainFit1027->SetParameter(0,-1.554737);
   mainFit1027->SetParError(0,0.3590784);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9500758);
   mainFit1027->SetParError(1,0.0141993);
