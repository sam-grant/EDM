...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.2086,70,64.82616);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.70513);
   Graph_Graph01035->SetMaximum(53.32268);
   ...
   mainFit1036->SetChisquare(7.063475);
   ...
   mainFit1036->SetParameter(0,-1.882381);
   mainFit1036->SetParError(0,0.3493669);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9508142);
   mainFit1036->SetParError(1,0.01207333);
   ...
   pt_LaTex = pt->AddText("0.951#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.88#pm0.349");
   pt_LaTex = pt->AddText("#minus1.98#pm0.362");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.979756,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.979756,-38.70513,1.979756,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.063475);
   ...
   mainFit1037->SetParameter(0,-1.882381);
   mainFit1037->SetParError(0,0.3493669);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9508142);
   mainFit1037->SetParError(1,0.01207333);
