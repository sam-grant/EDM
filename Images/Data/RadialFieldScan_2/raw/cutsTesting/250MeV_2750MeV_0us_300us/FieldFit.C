...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.08913);
   Graph_Graph01020->SetMaximum(54.99396);
   ...
   mainFit1021->SetChisquare(10.60522);
   ...
   mainFit1021->SetParameter(0,-1.68386);
   mainFit1021->SetParError(0,0.3330613);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9414311);
   mainFit1021->SetParError(1,0.01099575);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.011");
   pt_LaTex = pt->AddText("#minus1.68#pm0.333");
   pt_LaTex = pt->AddText("#minus1.79#pm0.351");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.788617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.788617,-57.08913,1.788617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(10.60522);
   ...
   mainFit1022->SetParameter(0,-1.68386);
   mainFit1022->SetParError(0,0.3330613);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9414311);
   mainFit1022->SetParError(1,0.01099575);
