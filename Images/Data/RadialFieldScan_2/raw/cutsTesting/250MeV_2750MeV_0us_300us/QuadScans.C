...
//=========  (Wed Apr 28 14:05:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(14.4859);
   ...
   quadLineFit1002->SetParameter(0,74.5754);
   quadLineFit1002->SetParError(0,0.05073865);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.80324);
   quadLineFit1002->SetParError(1,0.8504589);
   ...
   quadLineFit1003->SetChisquare(14.4859);
   ...
   quadLineFit1003->SetParameter(0,74.5754);
   quadLineFit1003->SetParError(0,0.05073865);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.80324);
   quadLineFit1003->SetParError(1,0.8504589);
   ...
   Graph_30_ppm1003->SetMinimum(75.78814);
   Graph_30_ppm1003->SetMaximum(76.46083);
   ...
   quadLineFit1004->SetChisquare(1.857103);
   ...
   quadLineFit1004->SetParameter(0,74.46306);
   quadLineFit1004->SetParError(0,0.04275793);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.97664);
   quadLineFit1004->SetParError(1,0.70212);
   ...
   quadLineFit1005->SetChisquare(1.857103);
   ...
   quadLineFit1005->SetParameter(0,74.46306);
   quadLineFit1005->SetParError(0,0.04275793);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.97664);
   quadLineFit1005->SetParError(1,0.70212);
   ...
   Graph_10_ppm1005->SetMinimum(74.77386);
   Graph_10_ppm1005->SetMaximum(75.02929);
   ...
   quadLineFit1006->SetChisquare(2.329862);
   ...
   quadLineFit1006->SetParameter(0,74.32794);
   quadLineFit1006->SetParError(0,0.0502506);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.191787);
   quadLineFit1006->SetParError(1,0.8144724);
   ...
   quadLineFit1007->SetChisquare(2.329862);
   ...
   quadLineFit1007->SetParameter(0,74.32794);
   quadLineFit1007->SetParError(0,0.0502506);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.191787);
   quadLineFit1007->SetParError(1,0.8144724);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.48204);
   Graph_mI10_ppm1007->SetMaximum(73.82061);
   ...
   quadLineFit1008->SetChisquare(3.904362);
   ...
   quadLineFit1008->SetParameter(0,74.41394);
   quadLineFit1008->SetParError(0,0.04405684);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.43226);
   quadLineFit1008->SetParError(1,0.7165913);
   ...
   quadLineFit1009->SetChisquare(3.904362);
   ...
   quadLineFit1009->SetParameter(0,74.41394);
   quadLineFit1009->SetParError(0,0.04405684);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.43226);
   quadLineFit1009->SetParError(1,0.7165913);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.07552);
   Graph_mI30_ppm1009->SetMaximum(72.84494);
   ...
   quadLineFit1010->SetChisquare(3.881917);
   ...
   quadLineFit1010->SetParameter(0,74.32788);
   quadLineFit1010->SetParError(0,0.04149693);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.3185);
   quadLineFit1010->SetParError(1,0.7176482);
   ...
   quadLineFit1011->SetChisquare(3.881917);
   ...
   quadLineFit1011->SetParameter(0,74.32788);
   quadLineFit1011->SetParError(0,0.04149693);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.3185);
   quadLineFit1011->SetParError(1,0.7176482);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19868);
   Graph_mI50_ppm1011->SetMaximum(71.85008);
   ...
   quadLineFit1012->SetChisquare(0.2582826);
   ...
   quadLineFit1012->SetParError(0,0.08371093);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.25144);
   quadLineFit1012->SetParError(1,1.497439);
   ...
   quadLineFit1013->SetChisquare(0.2582826);
   ...
   quadLineFit1013->SetParError(0,0.08371093);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.25144);
   quadLineFit1013->SetParError(1,1.497439);
