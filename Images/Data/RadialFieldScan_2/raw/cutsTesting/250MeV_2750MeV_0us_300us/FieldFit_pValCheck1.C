...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.08913);
   Graph_Graph01027->SetMaximum(54.99396);
   ...
   mainFit1028->SetChisquare(10.04009);
   ...
   mainFit1028->SetParameter(0,-1.810104);
   mainFit1028->SetParError(0,0.3730004);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9373174);
   mainFit1028->SetParError(1,0.0122815);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.81#pm0.373");
   pt_LaTex = pt->AddText("#minus1.93#pm0.401");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.931153,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.931153,-57.08913,1.931153,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(10.04009);
   ...
   mainFit1029->SetParameter(0,-1.810104);
   mainFit1029->SetParError(0,0.3730004);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9373174);
   mainFit1029->SetParError(1,0.0122815);
