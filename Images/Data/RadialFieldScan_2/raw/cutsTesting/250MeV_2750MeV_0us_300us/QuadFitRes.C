...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01465728);
   Graph_Graph11015->SetMaximum(0.01174317);
   ...
   Graph_Graph21016->SetMinimum(-0.01114801);
   Graph_Graph21016->SetMaximum(0.01304782);
   ...
   Graph_Graph31017->SetMinimum(-0.01538831);
   Graph_Graph31017->SetMaximum(0.01901401);
   ...
   Graph_Graph41018->SetMinimum(-0.01288097);
   Graph_Graph41018->SetMaximum(0.02548768);
   ...
   Graph_Graph51019->SetMinimum(-0.004613575);
   Graph_Graph51019->SetMaximum(0.003464451);
