...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.08913);
   Graph_Graph01031->SetMaximum(54.99396);
   ...
   mainFit1032->SetChisquare(5.905639);
   ...
   mainFit1032->SetParameter(0,-1.27236);
   mainFit1032->SetParError(0,0.3833551);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.935099);
   mainFit1032->SetParError(1,0.01137709);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.0114");
   pt_LaTex = pt->AddText("#minus1.27#pm0.383");
   pt_LaTex = pt->AddText("#minus1.36#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.360669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.360669,-57.08913,1.360669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.905639);
   ...
   mainFit1033->SetParameter(0,-1.27236);
   mainFit1033->SetParError(0,0.3833551);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.935099);
   mainFit1033->SetParError(1,0.01137709);
