...
//=========  (Wed Apr 28 14:05:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.08913);
   Graph_Graph01029->SetMaximum(54.99396);
   ...
   mainFit1030->SetChisquare(6.737353);
   ...
   mainFit1030->SetParameter(0,-1.961894);
   mainFit1030->SetParError(0,0.3618229);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9397881);
   mainFit1030->SetParError(1,0.01102743);
   ...
   pt_LaTex = pt->AddText("#minus1.96#pm0.362");
   pt_LaTex = pt->AddText("#minus2.09#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.087591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.087591,-57.08913,2.087591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.737353);
   ...
   mainFit1031->SetParameter(0,-1.961894);
   mainFit1031->SetParError(0,0.3618229);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9397881);
   mainFit1031->SetParError(1,0.01102743);
