...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.20776);
   Graph_Graph01020->SetMaximum(56.16304);
   ...
   mainFit1021->SetChisquare(5.181668);
   ...
   mainFit1021->SetParameter(0,-2.039702);
   mainFit1021->SetParError(0,0.4000463);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9282953);
   mainFit1021->SetParError(1,0.01322561);
   ...
   mainFit1022->SetChisquare(5.181668);
   ...
   mainFit1022->SetParameter(0,-2.039702);
   mainFit1022->SetParError(0,0.4000463);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9282953);
   mainFit1022->SetParError(1,0.01322561);
