...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008129329);
   Graph_Graph11015->SetMaximum(0.008407645);
   ...
   Graph_Graph21016->SetMinimum(-0.009167224);
   Graph_Graph21016->SetMaximum(0.01077403);
   ...
   Graph_Graph31017->SetMinimum(-0.02559641);
   Graph_Graph31017->SetMaximum(0.02188682);
   ...
   Graph_Graph41018->SetMinimum(-0.006603265);
   Graph_Graph41018->SetMaximum(0.01219754);
   ...
   Graph_Graph51019->SetMinimum(-0.002911698);
   Graph_Graph51019->SetMaximum(0.003889712);
