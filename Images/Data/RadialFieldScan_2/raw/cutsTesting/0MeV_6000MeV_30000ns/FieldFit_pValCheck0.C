...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.61235,50,44.50062);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.10105);
   Graph_Graph01025->SetMaximum(32.98932);
   ...
   mainFit1026->SetChisquare(3.374048);
   ...
   mainFit1026->SetParameter(0,-2.255556);
   mainFit1026->SetParError(0,0.4310553);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9137924);
   mainFit1026->SetParError(1,0.01706944);
   ...
   pt_LaTex = pt->AddText("#minus2.26#pm0.431");
   pt_LaTex = pt->AddText("#minus2.47#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.468346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.468346,-59.10105,2.468346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.374048);
   ...
   mainFit1027->SetParameter(0,-2.255556);
   mainFit1027->SetParError(0,0.4310553);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9137924);
   mainFit1027->SetParError(1,0.01706944);
