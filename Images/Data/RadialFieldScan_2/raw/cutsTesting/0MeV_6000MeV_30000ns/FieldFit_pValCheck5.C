...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.36636,70,65.53184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.87654);
   Graph_Graph01035->SetMaximum(54.04202);
   ...
   mainFit1036->SetChisquare(4.649091);
   ...
   mainFit1036->SetParameter(0,-1.947425);
   mainFit1036->SetParError(0,0.419561);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9239295);
   mainFit1036->SetParError(1,0.01451887);
   ...
   pt_LaTex = pt->AddText("#minus1.95#pm 0.42");
   pt_LaTex = pt->AddText("#minus2.11#pm0.446");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.107764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.107764,-37.87654,2.107764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.649091);
   ...
   mainFit1037->SetParameter(0,-1.947425);
   mainFit1037->SetParError(0,0.419561);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9239295);
   mainFit1037->SetParError(1,0.01451887);
