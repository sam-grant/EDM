...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.20776);
   Graph_Graph01023->SetMaximum(56.16304);
   ...
   mainFit1024->SetChisquare(5.181668);
   ...
   mainFit1024->SetParameter(0,-2.039702);
   mainFit1024->SetParError(0,0.4000463);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9282953);
   mainFit1024->SetParError(1,0.01322561);
   ...
   pt_LaTex = pt->AddText("#minus2.04#pm  0.4");
   pt_LaTex = pt->AddText(" #minus2.2#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.197256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.197256,-61.20776,2.197256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.181668);
   ...
   mainFit1025->SetParameter(0,-2.039702);
   mainFit1025->SetParError(0,0.4000463);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9282953);
   mainFit1025->SetParError(1,0.01322561);
