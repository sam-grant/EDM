...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.20776);
   Graph_Graph01027->SetMaximum(56.16304);
   ...
   mainFit1028->SetChisquare(1.162375);
   ...
   mainFit1028->SetParameter(0,-1.635689);
   mainFit1028->SetParError(0,0.4479421);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9415062);
   mainFit1028->SetParError(1,0.01477527);
   ...
   pt_LaTex = pt->AddText("#minus1.64#pm0.448");
   pt_LaTex = pt->AddText("#minus1.74#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.73731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.73731,-61.20776,1.73731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.162375);
   ...
   mainFit1029->SetParameter(0,-1.635689);
   mainFit1029->SetParError(0,0.4479421);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9415062);
   mainFit1029->SetParError(1,0.01477527);
