...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.20776);
   Graph_Graph01033->SetMaximum(56.16304);
   ...
   mainFit1034->SetChisquare(4.420791);
   ...
   mainFit1034->SetParameter(0,-2.303444);
   mainFit1034->SetParError(0,0.5014435);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.936968);
   mainFit1034->SetParError(1,0.01654216);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.0165");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.501");
   pt_LaTex = pt->AddText("#minus2.46#pm0.516");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.458403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.458403,-61.20776,2.458403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.420791);
   ...
   mainFit1035->SetParameter(0,-2.303444);
   mainFit1035->SetParError(0,0.5014435);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.936968);
   mainFit1035->SetParError(1,0.01654216);
