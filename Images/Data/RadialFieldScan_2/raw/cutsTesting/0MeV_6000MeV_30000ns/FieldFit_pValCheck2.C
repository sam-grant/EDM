...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.20776);
   Graph_Graph01029->SetMaximum(56.16304);
   ...
   mainFit1030->SetChisquare(4.168032);
   ...
   mainFit1030->SetParameter(0,-2.211282);
   mainFit1030->SetParError(0,0.4348274);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.927285);
   mainFit1030->SetParError(1,0.01326404);
   ...
   pt_LaTex = pt->AddText("#minus2.21#pm0.435");
   pt_LaTex = pt->AddText("#minus2.38#pm0.466");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.384684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.384684,-61.20776,2.384684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.168032);
   ...
   mainFit1031->SetParameter(0,-2.211282);
   mainFit1031->SetParError(0,0.4348274);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.927285);
   mainFit1031->SetParError(1,0.01326404);
