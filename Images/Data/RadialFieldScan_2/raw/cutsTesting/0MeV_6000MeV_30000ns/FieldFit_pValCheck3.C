...
//=========  (Fri Apr 23 12:50:49 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.87911,75,70.83439);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-61.20776);
   Graph_Graph01031->SetMaximum(56.16304);
   ...
   mainFit1032->SetChisquare(5.052474);
   ...
   mainFit1032->SetParameter(0,-1.957573);
   mainFit1032->SetParError(0,0.4607272);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9270331);
   mainFit1032->SetParError(1,0.01368783);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.96#pm0.461");
   pt_LaTex = pt->AddText("#minus2.11#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.111654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.111654,-61.20776,2.111654,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.052474);
   ...
   mainFit1033->SetParameter(0,-1.957573);
   mainFit1033->SetParError(0,0.4607272);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9270331);
   mainFit1033->SetParError(1,0.01368783);
