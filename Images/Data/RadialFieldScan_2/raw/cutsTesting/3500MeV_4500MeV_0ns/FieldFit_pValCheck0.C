...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-146.1635,50,71.60945);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-124.3862);
   Graph_Graph01025->SetMaximum(49.83215);
   ...
   mainFit1026->SetChisquare(13.436);
   ...
   mainFit1026->SetParameter(0,-1.874037);
   mainFit1026->SetParError(0,2.71846);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.219907);
   mainFit1026->SetParError(1,0.1076298);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.48");
   pt_LaTex = pt->AddText(" 1.22#pm0.108");
   pt_LaTex = pt->AddText("#minus1.87#pm 2.72");
   pt_LaTex = pt->AddText("#minus1.54#pm 2.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.536213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.536213,-124.3862,1.536213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(13.436);
   ...
   mainFit1027->SetParameter(0,-1.874037);
   mainFit1027->SetParError(0,2.71846);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.219907);
   mainFit1027->SetParError(1,0.1076298);
