...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-152.3674,75,102.6286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-126.8678);
   Graph_Graph01027->SetMaximum(77.12904);
   ...
   mainFit1028->SetChisquare(13.33012);
   ...
   mainFit1028->SetParameter(0,-1.611614);
   mainFit1028->SetParError(0,2.826197);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.207506);
   mainFit1028->SetParError(1,0.09329392);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.44");
   pt_LaTex = pt->AddText(" 1.21#pm0.0933");
   pt_LaTex = pt->AddText("#minus1.61#pm 2.83");
   pt_LaTex = pt->AddText("#minus1.33#pm 2.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.334664,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.334664,-126.8678,1.334664,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(13.33012);
   ...
   mainFit1029->SetParameter(0,-1.611614);
   mainFit1029->SetParError(0,2.826197);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.207506);
   mainFit1029->SetParError(1,0.09329392);
