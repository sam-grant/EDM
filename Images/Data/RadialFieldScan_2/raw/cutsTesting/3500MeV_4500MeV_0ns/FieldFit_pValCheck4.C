...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-126.8678);
   Graph_Graph01033->SetMaximum(77.12904);
   ...
   mainFit1034->SetChisquare(9.944013);
   ...
   mainFit1034->SetParameter(0,-6.213492);
   mainFit1034->SetParError(0,3.156224);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.301458);
   mainFit1034->SetParError(1,0.104201);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.31");
   pt_LaTex = pt->AddText("  1.3#pm0.104");
   pt_LaTex = pt->AddText("#minus6.21#pm 3.16");
   pt_LaTex = pt->AddText("#minus4.77#pm 2.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.774254,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.774254,-126.8678,4.774254,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.944013);
   ...
   mainFit1035->SetParameter(0,-6.213492);
   mainFit1035->SetParError(0,3.156224);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.301458);
   mainFit1035->SetParError(1,0.104201);
