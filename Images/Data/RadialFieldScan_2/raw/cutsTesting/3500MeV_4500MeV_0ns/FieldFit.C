...
//=========  (Wed Apr 21 18:37:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-126.8678);
   Graph_Graph01020->SetMaximum(77.12904);
   ...
   mainFit1021->SetChisquare(13.80102);
   ...
   mainFit1021->SetParameter(0,-2.486756);
   mainFit1021->SetParError(0,2.522087);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.178851);
   mainFit1021->SetParError(1,0.08343156);
   ...
   pt_LaTex = pt->AddText(" 1.18#pm0.0834");
   pt_LaTex = pt->AddText("#minus2.49#pm 2.52");
   pt_LaTex = pt->AddText("#minus2.11#pm 2.12");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.109474,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.109474,-126.8678,2.109474,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(13.80102);
   ...
   mainFit1022->SetParameter(0,-2.486756);
   mainFit1022->SetParError(0,2.522087);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.178851);
   mainFit1022->SetParError(1,0.08343156);
