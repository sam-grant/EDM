...
//=========  (Wed Apr 21 18:37:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.2441929);
   Graph_Graph11015->SetMaximum(0.1637785);
   ...
   Graph_Graph21016->SetMinimum(-0.1774662);
   Graph_Graph21016->SetMaximum(0.2113335);
   ...
   Graph_Graph31017->SetMinimum(-0.06089267);
   Graph_Graph31017->SetMaximum(0.06224814);
   ...
   Graph_Graph41018->SetMinimum(-0.1677206);
   Graph_Graph41018->SetMaximum(0.09036679);
   ...
   Graph_Graph51019->SetMinimum(-0.09489289);
   Graph_Graph51019->SetMaximum(0.1253728);
