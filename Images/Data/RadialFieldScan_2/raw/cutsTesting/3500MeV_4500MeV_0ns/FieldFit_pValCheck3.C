...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-126.8678);
   Graph_Graph01031->SetMaximum(77.12904);
   ...
   mainFit1032->SetChisquare(13.26624);
   ...
   mainFit1032->SetParameter(0,-3.546765);
   mainFit1032->SetParError(0,2.908941);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.195154);
   mainFit1032->SetParError(1,0.08635637);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.42");
   pt_LaTex = pt->AddText("  1.2#pm0.0864");
   pt_LaTex = pt->AddText("#minus3.55#pm 2.91");
   pt_LaTex = pt->AddText("#minus2.97#pm 2.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.967621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.967621,-126.8678,2.967621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(13.26624);
   ...
   mainFit1033->SetParameter(0,-3.546765);
   mainFit1033->SetParError(0,2.908941);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.195154);
   mainFit1033->SetParError(1,0.08635637);
