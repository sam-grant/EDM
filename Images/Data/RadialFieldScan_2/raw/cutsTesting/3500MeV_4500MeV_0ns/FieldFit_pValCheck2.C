...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-126.8678);
   Graph_Graph01029->SetMaximum(77.12904);
   ...
   mainFit1030->SetChisquare(13.4754);
   ...
   mainFit1030->SetParameter(0,-3.095886);
   mainFit1030->SetParError(0,2.738672);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.175189);
   mainFit1030->SetParError(1,0.08367886);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.49");
   pt_LaTex = pt->AddText(" 1.18#pm0.0837");
   pt_LaTex = pt->AddText(" #minus3.1#pm 2.74");
   pt_LaTex = pt->AddText("#minus2.63#pm 2.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.634372,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.634372,-126.8678,2.634372,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(13.4754);
   ...
   mainFit1031->SetParameter(0,-3.095886);
   mainFit1031->SetParError(0,2.738672);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.175189);
   mainFit1031->SetParError(1,0.08367886);
