...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-126.8678);
   Graph_Graph01023->SetMaximum(77.12904);
   ...
   mainFit1024->SetChisquare(13.80102);
   ...
   mainFit1024->SetParameter(0,-2.486756);
   mainFit1024->SetParError(0,2.522087);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.178851);
   mainFit1024->SetParError(1,0.08343156);
   ...
   mainFit1025->SetChisquare(13.80102);
   ...
   mainFit1025->SetParameter(0,-2.486756);
   mainFit1025->SetParError(0,2.522087);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.178851);
   mainFit1025->SetParError(1,0.08343156);
