...
//=========  (Wed Apr 21 18:37:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-59.63475,70,84.08212);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-45.26307);
   Graph_Graph01035->SetMaximum(69.71043);
   ...
   mainFit1036->SetChisquare(0.24492);
   ...
   mainFit1036->SetParameter(0,0.4461337);
   mainFit1036->SetParError(0,2.644895);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.039507);
   mainFit1036->SetParError(1,0.0916149);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0816");
   pt_LaTex = pt->AddText(" 1.04#pm0.0916");
   pt_LaTex = pt->AddText("0.446#pm 2.64");
   pt_LaTex = pt->AddText("0.429#pm 2.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4291781,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4291781,-45.26307,-0.4291781,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.24492);
   ...
   mainFit1037->SetParameter(0,0.4461337);
   mainFit1037->SetParError(0,2.644895);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.039507);
   mainFit1037->SetParError(1,0.0916149);
