...
//=========  (Wed Apr 21 21:41:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-65.03185,75,64.66418);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-52.06224);
   Graph_Graph01020->SetMaximum(51.69458);
   ...
   mainFit1021->SetChisquare(4.233273);
   ...
   mainFit1021->SetParameter(0,-0.04795399);
   mainFit1021->SetParError(0,0.9479326);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7764619);
   mainFit1021->SetParError(1,0.03131801);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.06");
   pt_LaTex = pt->AddText("0.776#pm0.0313");
   pt_LaTex = pt->AddText("#minus0.048#pm0.948");
   pt_LaTex = pt->AddText("#minus0.0618#pm 1.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.06175961,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.06175961,-52.06224,0.06175961,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.233273);
   ...
   mainFit1022->SetParameter(0,-0.04795399);
   mainFit1022->SetParError(0,0.9479326);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7764619);
   mainFit1022->SetParError(1,0.03131801);
