...
//=========  (Wed Apr 21 21:41:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04487803);
   Graph_Graph11015->SetMaximum(0.01379888);
   ...
   Graph_Graph21016->SetMinimum(-0.008134484);
   Graph_Graph21016->SetMaximum(0.009568531);
   ...
   Graph_Graph31017->SetMinimum(-0.07240724);
   Graph_Graph31017->SetMaximum(0.05948414);
   ...
   Graph_Graph41018->SetMinimum(-0.0775869);
   Graph_Graph41018->SetMaximum(0.04843997);
   ...
   Graph_Graph51019->SetMinimum(-0.00687833);
   Graph_Graph51019->SetMaximum(0.009195995);
