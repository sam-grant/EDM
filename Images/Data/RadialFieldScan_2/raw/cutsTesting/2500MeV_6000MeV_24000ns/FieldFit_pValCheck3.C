...
//=========  (Wed Apr 21 21:41:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.06224);
   Graph_Graph01031->SetMaximum(51.69458);
   ...
   mainFit1032->SetChisquare(1.911616);
   ...
   mainFit1032->SetParameter(0,-0.8728783);
   mainFit1032->SetParError(0,1.091644);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7891713);
   mainFit1032->SetParError(1,0.03240976);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.637");
   pt_LaTex = pt->AddText("0.789#pm0.0324");
   pt_LaTex = pt->AddText("#minus0.873#pm 1.09");
   pt_LaTex = pt->AddText("#minus1.11#pm 1.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.106069,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.106069,-52.06224,1.106069,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.911616);
   ...
   mainFit1033->SetParameter(0,-0.8728783);
   mainFit1033->SetParError(0,1.091644);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7891713);
   mainFit1033->SetParError(1,0.03240976);
