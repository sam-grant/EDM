...
//=========  (Wed Apr 21 21:41:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.95503,50,39.28009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.03152);
   Graph_Graph01025->SetMaximum(29.35658);
   ...
   mainFit1026->SetChisquare(3.099134);
   ...
   mainFit1026->SetParameter(0,-0.4531542);
   mainFit1026->SetParError(0,1.021432);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7492784);
   mainFit1026->SetParError(1,0.04039807);
   ...
   pt_LaTex = pt->AddText("0.749#pm0.0404");
   pt_LaTex = pt->AddText("#minus0.453#pm 1.02");
   pt_LaTex = pt->AddText("#minus0.605#pm 1.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6047875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6047875,-50.03152,0.6047875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.099134);
   ...
   mainFit1027->SetParameter(0,-0.4531542);
   mainFit1027->SetParError(0,1.021432);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7492784);
   mainFit1027->SetParError(1,0.04039807);
