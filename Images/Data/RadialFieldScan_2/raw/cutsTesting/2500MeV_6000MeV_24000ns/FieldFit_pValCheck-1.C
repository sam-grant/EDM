...
//=========  (Wed Apr 21 21:41:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.06224);
   Graph_Graph01023->SetMaximum(51.69458);
   ...
   mainFit1024->SetChisquare(4.233273);
   ...
   mainFit1024->SetParameter(0,-0.04795399);
   mainFit1024->SetParError(0,0.9479326);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7764619);
   mainFit1024->SetParError(1,0.03131801);
   ...
   mainFit1025->SetChisquare(4.233273);
   ...
   mainFit1025->SetParameter(0,-0.04795399);
   mainFit1025->SetParError(0,0.9479326);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7764619);
   mainFit1025->SetParError(1,0.03131801);
