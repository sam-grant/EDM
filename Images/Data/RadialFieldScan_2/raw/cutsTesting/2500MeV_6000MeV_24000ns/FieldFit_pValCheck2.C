...
//=========  (Wed Apr 21 21:41:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.06224);
   Graph_Graph01029->SetMaximum(51.69458);
   ...
   mainFit1030->SetChisquare(4.231486);
   ...
   mainFit1030->SetParameter(0,-0.03088585);
   mainFit1030->SetParError(0,1.030213);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7765596);
   mainFit1030->SetParError(1,0.03140895);
   ...
   pt_LaTex = pt->AddText("0.777#pm0.0314");
   pt_LaTex = pt->AddText("#minus0.0309#pm 1.03");
   pt_LaTex = pt->AddText("#minus0.0398#pm 1.33");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.03977267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.03977267,-52.06224,0.03977267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.231486);
   ...
   mainFit1031->SetParameter(0,-0.03088585);
   mainFit1031->SetParError(0,1.030213);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7765596);
   mainFit1031->SetParError(1,0.03140895);
