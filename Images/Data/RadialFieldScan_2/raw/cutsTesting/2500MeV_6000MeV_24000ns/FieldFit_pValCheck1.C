...
//=========  (Wed Apr 21 21:41:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.06224);
   Graph_Graph01027->SetMaximum(51.69458);
   ...
   mainFit1028->SetChisquare(1.722686);
   ...
   mainFit1028->SetParameter(0,0.7100123);
   mainFit1028->SetParError(0,1.061797);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8011977);
   mainFit1028->SetParError(1,0.03499327);
   ...
   pt_LaTex = pt->AddText("0.801#pm0.035");
   pt_LaTex = pt->AddText(" 0.71#pm 1.06");
   pt_LaTex = pt->AddText("0.886#pm 1.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8861887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8861887,-52.06224,-0.8861887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.722686);
   ...
   mainFit1029->SetParameter(0,0.7100123);
   mainFit1029->SetParError(0,1.061797);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8011977);
   mainFit1029->SetParError(1,0.03499327);
