...
//=========  (Wed Apr 21 21:41:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.06224);
   Graph_Graph01033->SetMaximum(51.69458);
   ...
   mainFit1034->SetChisquare(3.511436);
   ...
   mainFit1034->SetParameter(0,0.5579937);
   mainFit1034->SetParError(0,1.186271);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7565708);
   mainFit1034->SetParError(1,0.03910169);
   ...
   pt_LaTex = pt->AddText("0.757#pm0.0391");
   pt_LaTex = pt->AddText("0.558#pm 1.19");
   pt_LaTex = pt->AddText("0.738#pm 1.59");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.73753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.73753,-52.06224,-0.73753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.511436);
   ...
   mainFit1035->SetParameter(0,0.5579937);
   mainFit1035->SetParError(0,1.186271);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7565708);
   mainFit1035->SetParError(1,0.03910169);
