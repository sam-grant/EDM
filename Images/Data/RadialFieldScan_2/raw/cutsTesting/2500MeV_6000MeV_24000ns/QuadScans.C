...
//=========  (Wed Apr 21 21:41:46 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.197693);
   ...
   quadLineFit1002->SetParameter(0,75.2496);
   quadLineFit1002->SetParError(0,0.1446241);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.62266);
   quadLineFit1002->SetParError(1,2.425517);
   ...
   quadLineFit1003->SetChisquare(4.197693);
   ...
   quadLineFit1003->SetParameter(0,75.2496);
   quadLineFit1003->SetParError(0,0.1446241);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.62266);
   quadLineFit1003->SetParError(1,2.425517);
   ...
   Graph_30_ppm1003->SetMinimum(76.35941);
   Graph_30_ppm1003->SetMaximum(76.94521);
   ...
   quadLineFit1004->SetChisquare(1.123661);
   ...
   quadLineFit1004->SetParameter(0,75.37659);
   quadLineFit1004->SetParError(0,0.1214663);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.74367);
   quadLineFit1004->SetParError(1,1.997239);
   ...
   quadLineFit1005->SetChisquare(1.123661);
   ...
   quadLineFit1005->SetParameter(0,75.37659);
   quadLineFit1005->SetParError(0,0.1214663);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.74367);
   quadLineFit1005->SetParError(1,1.997239);
   ...
   Graph_10_ppm1005->SetMinimum(75.45612);
   Graph_10_ppm1005->SetMaximum(75.72438);
   ...
   quadLineFit1006->SetChisquare(0.1532531);
   ...
   quadLineFit1006->SetParameter(0,75.11352);
   quadLineFit1006->SetParError(0,0.1425968);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.627512);
   quadLineFit1006->SetParError(1,2.312846);
   ...
   quadLineFit1007->SetChisquare(0.1532531);
   ...
   quadLineFit1007->SetParameter(0,75.11352);
   quadLineFit1007->SetParError(0,0.1425968);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.627512);
   quadLineFit1007->SetParError(1,2.312846);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.45566);
   Graph_mI10_ppm1007->SetMaximum(74.71327);
   ...
   quadLineFit1008->SetChisquare(7.677434);
   ...
   quadLineFit1008->SetParameter(0,74.88593);
   quadLineFit1008->SetParError(0,0.1250814);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.149356);
   quadLineFit1008->SetParError(1,2.036444);
   ...
   quadLineFit1009->SetChisquare(7.677434);
   ...
   quadLineFit1009->SetParameter(0,74.88593);
   quadLineFit1009->SetParError(0,0.1250814);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.149356);
   quadLineFit1009->SetParError(1,2.036444);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.15797);
   Graph_mI30_ppm1009->SetMaximum(73.79379);
   ...
   quadLineFit1010->SetChisquare(4.578701);
   ...
   quadLineFit1010->SetParameter(0,74.96605);
   quadLineFit1010->SetParError(0,0.1184131);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.58275);
   quadLineFit1010->SetParError(1,2.049614);
   ...
   quadLineFit1011->SetChisquare(4.578701);
   ...
   quadLineFit1011->SetParameter(0,74.96605);
   quadLineFit1011->SetParError(0,0.1184131);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.58275);
   quadLineFit1011->SetParError(1,2.049614);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.26144);
   Graph_mI50_ppm1011->SetMaximum(72.86912);
   ...
   quadLineFit1012->SetChisquare(0.1258385);
   ...
   quadLineFit1012->SetParameter(0,74.80236);
   quadLineFit1012->SetParError(0,0.237079);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.17452);
   quadLineFit1012->SetParError(1,4.241319);
   ...
   quadLineFit1013->SetChisquare(0.1258385);
   ...
   quadLineFit1013->SetParameter(0,74.80236);
   quadLineFit1013->SetParError(0,0.237079);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.17452);
   quadLineFit1013->SetParError(1,4.241319);
