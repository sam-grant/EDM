...
//=========  (Fri Apr 23 11:58:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.088334);
   ...
   quadLineFit1002->SetParameter(0,74.49222);
   quadLineFit1002->SetParError(0,0.0576136);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.12848);
   quadLineFit1002->SetParError(1,0.9662984);
   ...
   quadLineFit1003->SetChisquare(1.088334);
   ...
   quadLineFit1003->SetParameter(0,74.49222);
   quadLineFit1003->SetParError(0,0.0576136);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.12848);
   quadLineFit1003->SetParError(1,0.9662984);
   ...
   Graph_30_ppm1003->SetMinimum(75.75339);
   Graph_30_ppm1003->SetMaximum(76.37365);
   ...
   quadLineFit1004->SetChisquare(0.3568959);
   ...
   quadLineFit1004->SetParameter(0,74.55865);
   quadLineFit1004->SetParError(0,0.04859015);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.54568);
   quadLineFit1004->SetParError(1,0.7984926);
   ...
   quadLineFit1005->SetChisquare(0.3568959);
   ...
   quadLineFit1005->SetParameter(0,74.55865);
   quadLineFit1005->SetParError(0,0.04859015);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.54568);
   quadLineFit1005->SetParError(1,0.7984926);
   ...
   Graph_10_ppm1005->SetMinimum(74.7671);
   Graph_10_ppm1005->SetMaximum(74.99365);
   ...
   quadLineFit1006->SetChisquare(0.9500076);
   ...
   quadLineFit1006->SetParameter(0,74.38863);
   quadLineFit1006->SetParError(0,0.05693864);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.895069);
   quadLineFit1006->SetParError(1,0.9233137);
   ...
   quadLineFit1007->SetChisquare(0.9500076);
   ...
   quadLineFit1007->SetParameter(0,74.38863);
   quadLineFit1007->SetParError(0,0.05693864);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.895069);
   quadLineFit1007->SetParError(1,0.9233137);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.52148);
   Graph_mI10_ppm1007->SetMaximum(73.84524);
   ...
   quadLineFit1008->SetChisquare(4.779191);
   ...
   quadLineFit1008->SetParameter(0,74.37506);
   quadLineFit1008->SetParError(0,0.04999191);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.36647);
   quadLineFit1008->SetParError(1,0.8136197);
   ...
   quadLineFit1009->SetChisquare(4.779191);
   ...
   quadLineFit1009->SetParameter(0,74.37506);
   quadLineFit1009->SetParError(0,0.04999191);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.36647);
   quadLineFit1009->SetParError(1,0.8136197);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.14559);
   Graph_mI30_ppm1009->SetMaximum(72.87377);
   ...
   quadLineFit1010->SetChisquare(0.3575473);
   ...
   quadLineFit1010->SetParameter(0,74.29503);
   quadLineFit1010->SetParError(0,0.04721742);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.02686);
   quadLineFit1010->SetParError(1,0.8171415);
   ...
   quadLineFit1011->SetChisquare(0.3575473);
   ...
   quadLineFit1011->SetParameter(0,74.29503);
   quadLineFit1011->SetParError(0,0.04721742);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.02686);
   quadLineFit1011->SetParError(1,0.8171415);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.2197);
   Graph_mI50_ppm1011->SetMaximum(71.90076);
   ...
   quadLineFit1012->SetChisquare(0.06618523);
   ...
   quadLineFit1012->SetParameter(0,74.30539);
   quadLineFit1012->SetParError(0,0.0953342);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.20383);
   quadLineFit1012->SetParError(1,1.705797);
   ...
   quadLineFit1013->SetChisquare(0.06618523);
   ...
   quadLineFit1013->SetParameter(0,74.30539);
   quadLineFit1013->SetParError(0,0.0953342);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.20383);
   quadLineFit1013->SetParError(1,1.705797);
