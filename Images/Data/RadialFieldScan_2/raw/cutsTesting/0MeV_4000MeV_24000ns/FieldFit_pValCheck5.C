...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.82869,70,65.07947);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.43788);
   Graph_Graph01035->SetMaximum(53.68866);
   ...
   mainFit1036->SetChisquare(4.041761);
   ...
   mainFit1036->SetParameter(0,-1.839743);
   mainFit1036->SetParError(0,0.3971103);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.917784);
   mainFit1036->SetParError(1,0.01373054);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.84#pm0.397");
   pt_LaTex = pt->AddText("   #minus2#pm0.426");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.004549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.004549,-37.43788,2.004549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.041761);
   ...
   mainFit1037->SetParameter(0,-1.839743);
   mainFit1037->SetParError(0,0.3971103);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.917784);
   mainFit1037->SetParError(1,0.01373054);
