...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.72307,50,44.15762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.435);
   Graph_Graph01025->SetMaximum(32.86955);
   ...
   mainFit1026->SetChisquare(1.836728);
   ...
   mainFit1026->SetParameter(0,-2.098516);
   mainFit1026->SetParError(0,0.4080478);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9037909);
   mainFit1026->SetParError(1,0.01615596);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.612");
   pt_LaTex = pt->AddText("0.904#pm0.0162");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.408");
   pt_LaTex = pt->AddText("#minus2.32#pm0.458");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.321905,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.321905,-57.435,2.321905,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.836728);
   ...
   mainFit1027->SetParameter(0,-2.098516);
   mainFit1027->SetParError(0,0.4080478);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9037909);
   mainFit1027->SetParError(1,0.01615596);
