...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.51006);
   Graph_Graph01031->SetMaximum(55.69522);
   ...
   mainFit1032->SetChisquare(3.911951);
   ...
   mainFit1032->SetParameter(0,-1.77488);
   mainFit1032->SetParError(0,0.4360012);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9177267);
   mainFit1032->SetParError(1,0.01294528);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0129");
   pt_LaTex = pt->AddText("#minus1.77#pm0.436");
   pt_LaTex = pt->AddText("#minus1.93#pm0.469");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.933996,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.933996,-59.51006,1.933996,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.911951);
   ...
   mainFit1033->SetParameter(0,-1.77488);
   mainFit1033->SetParError(0,0.4360012);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9177267);
   mainFit1033->SetParError(1,0.01294528);
