...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.51006);
   Graph_Graph01023->SetMaximum(55.69522);
   ...
   mainFit1024->SetChisquare(4.102988);
   ...
   mainFit1024->SetParameter(0,-1.869369);
   mainFit1024->SetParError(0,0.3786003);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9191784);
   mainFit1024->SetParError(1,0.0125075);
   ...
   pt_LaTex = pt->AddText("#minus1.87#pm0.379");
   pt_LaTex = pt->AddText("#minus2.03#pm0.408");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.033739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.033739,-59.51006,2.033739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.102988);
   ...
   mainFit1025->SetParameter(0,-1.869369);
   mainFit1025->SetParError(0,0.3786003);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9191784);
   mainFit1025->SetParError(1,0.0125075);
