...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.51006);
   Graph_Graph01033->SetMaximum(55.69522);
   ...
   mainFit1034->SetChisquare(3.58516);
   ...
   mainFit1034->SetParameter(0,-2.075405);
   mainFit1034->SetParError(0,0.4746556);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9259477);
   mainFit1034->SetParError(1,0.01564412);
   ...
   pt_LaTex = pt->AddText("#minus2.08#pm0.475");
   pt_LaTex = pt->AddText("#minus2.24#pm0.496");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.241385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.241385,-59.51006,2.241385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.58516);
   ...
   mainFit1035->SetParameter(0,-2.075405);
   mainFit1035->SetParError(0,0.4746556);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9259477);
   mainFit1035->SetParError(1,0.01564412);
