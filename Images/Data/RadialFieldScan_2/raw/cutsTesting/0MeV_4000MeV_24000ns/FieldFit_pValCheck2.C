...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.51006);
   Graph_Graph01029->SetMaximum(55.69522);
   ...
   mainFit1030->SetChisquare(3.640447);
   ...
   mainFit1030->SetParameter(0,-1.978985);
   mainFit1030->SetParError(0,0.4114666);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9185411);
   mainFit1030->SetParError(1,0.01254334);
   ...
   pt_LaTex = pt->AddText("#minus1.98#pm0.411");
   pt_LaTex = pt->AddText("#minus2.15#pm0.445");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.154488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.154488,-59.51006,2.154488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.640447);
   ...
   mainFit1031->SetParameter(0,-1.978985);
   mainFit1031->SetParError(0,0.4114666);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9185411);
   mainFit1031->SetParError(1,0.01254334);
