...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004158498);
   Graph_Graph11015->SetMaximum(0.009552012);
   ...
   Graph_Graph21016->SetMinimum(-0.008077203);
   Graph_Graph21016->SetMaximum(0.009489948);
   ...
   Graph_Graph31017->SetMinimum(-0.02317781);
   Graph_Graph31017->SetMaximum(0.01748074);
   ...
   Graph_Graph41018->SetMinimum(-0.00345621);
   Graph_Graph41018->SetMaximum(0.006453986);
   ...
   Graph_Graph51019->SetMinimum(-0.001989605);
   Graph_Graph51019->SetMaximum(0.002658272);
