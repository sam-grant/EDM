...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.51006);
   Graph_Graph01020->SetMaximum(55.69522);
   ...
   mainFit1021->SetChisquare(4.102988);
   ...
   mainFit1021->SetParameter(0,-1.869369);
   mainFit1021->SetParError(0,0.3786003);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9191784);
   mainFit1021->SetParError(1,0.0125075);
   ...
   mainFit1022->SetChisquare(4.102988);
   ...
   mainFit1022->SetParameter(0,-1.869369);
   mainFit1022->SetParError(0,0.3786003);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9191784);
   mainFit1022->SetParError(1,0.0125075);
