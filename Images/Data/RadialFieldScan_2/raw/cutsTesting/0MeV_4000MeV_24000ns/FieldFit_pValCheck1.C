...
//=========  (Fri Apr 23 11:58:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.91073,75,70.09588);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.51006);
   Graph_Graph01027->SetMaximum(55.69522);
   ...
   mainFit1028->SetChisquare(0.7315475);
   ...
   mainFit1028->SetParameter(0,-1.519795);
   mainFit1028->SetParError(0,0.4237804);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9305919);
   mainFit1028->SetParError(1,0.01396539);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.244");
   pt_LaTex = pt->AddText("0.931#pm0.014");
   pt_LaTex = pt->AddText("#minus1.52#pm0.424");
   pt_LaTex = pt->AddText("#minus1.63#pm0.458");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.633149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.633149,-59.51006,1.633149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7315475);
   ...
   mainFit1029->SetParameter(0,-1.519795);
   mainFit1029->SetParError(0,0.4237804);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9305919);
   mainFit1029->SetParError(1,0.01396539);
