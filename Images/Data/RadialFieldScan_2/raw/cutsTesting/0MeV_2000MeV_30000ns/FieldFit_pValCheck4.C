...
//=========  (Fri Apr 23 12:18:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-66.81672);
   Graph_Graph01033->SetMaximum(59.15594);
   ...
   mainFit1034->SetChisquare(3.332222);
   ...
   mainFit1034->SetParameter(0,-3.149582);
   mainFit1034->SetParError(0,0.598752);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9994607);
   mainFit1034->SetParError(1,0.0198812);
   ...
   pt_LaTex = pt->AddText("0.999#pm0.0199");
   pt_LaTex = pt->AddText("#minus3.15#pm0.599");
   pt_LaTex = pt->AddText("#minus3.15#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.151282,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.151282,-66.81672,3.151282,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.332222);
   ...
   mainFit1035->SetParameter(0,-3.149582);
   mainFit1035->SetParError(0,0.598752);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9994607);
   mainFit1035->SetParError(1,0.0198812);
