...
//=========  (Fri Apr 23 12:18:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008215905);
   Graph_Graph11015->SetMaximum(0.009818416);
   ...
   Graph_Graph21016->SetMinimum(-0.00911545);
   Graph_Graph21016->SetMaximum(0.01069714);
   ...
   Graph_Graph31017->SetMinimum(-0.01637383);
   Graph_Graph31017->SetMaximum(0.01663161);
   ...
   Graph_Graph41018->SetMinimum(-0.00883305);
   Graph_Graph41018->SetMaximum(0.01538285);
   ...
   Graph_Graph51019->SetMinimum(-0.0005082538);
   Graph_Graph51019->SetMaximum(0.0006786841);
