...
//=========  (Fri Apr 23 12:18:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-66.81672);
   Graph_Graph01020->SetMaximum(59.15594);
   ...
   mainFit1021->SetChisquare(4.917257);
   ...
   mainFit1021->SetParameter(0,-2.696009);
   mainFit1021->SetParError(0,0.4782377);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9844205);
   mainFit1021->SetParError(1,0.01589255);
   ...
   mainFit1022->SetChisquare(4.917257);
   ...
   mainFit1022->SetParameter(0,-2.696009);
   mainFit1022->SetParError(0,0.4782377);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9844205);
   mainFit1022->SetParError(1,0.01589255);
