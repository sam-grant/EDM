...
//=========  (Fri Apr 23 12:18:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-52.58669,70,68.9072);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-40.4373);
   Graph_Graph01035->SetMaximum(56.75781);
   ...
   mainFit1036->SetChisquare(3.530881);
   ...
   mainFit1036->SetParameter(0,-2.519445);
   mainFit1036->SetParError(0,0.5011973);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9759285);
   mainFit1036->SetParError(1,0.01745295);
   ...
   pt_LaTex = pt->AddText("0.976#pm0.0175");
   pt_LaTex = pt->AddText("#minus2.52#pm0.501");
   pt_LaTex = pt->AddText("#minus2.58#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.581587,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.581587,-40.4373,2.581587,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.530881);
   ...
   mainFit1037->SetParameter(0,-2.519445);
   mainFit1037->SetParError(0,0.5011973);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9759285);
   mainFit1037->SetParError(1,0.01745295);
