...
//=========  (Fri Apr 23 12:18:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.6463894);
   ...
   quadLineFit1002->SetParameter(0,74.23742);
   quadLineFit1002->SetParError(0,0.07430562);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,47.41157);
   quadLineFit1002->SetParError(1,1.246645);
   ...
   quadLineFit1003->SetChisquare(0.6463894);
   ...
   quadLineFit1003->SetParameter(0,74.23742);
   quadLineFit1003->SetParError(0,0.07430562);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,47.41157);
   quadLineFit1003->SetParError(1,1.246645);
   ...
   Graph_30_ppm1003->SetMinimum(75.59032);
   Graph_30_ppm1003->SetMaximum(76.2386);
   ...
   quadLineFit1004->SetChisquare(0.4933475);
   ...
   quadLineFit1004->SetParameter(0,74.34569);
   quadLineFit1004->SetParError(0,0.06130825);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.54865);
   quadLineFit1004->SetParError(1,1.00732);
   ...
   quadLineFit1005->SetChisquare(0.4933475);
   ...
   quadLineFit1005->SetParameter(0,74.34569);
   quadLineFit1005->SetParError(0,0.06130825);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.54865);
   quadLineFit1005->SetParError(1,1.00732);
   ...
   Graph_10_ppm1005->SetMinimum(74.57139);
   Graph_10_ppm1005->SetMaximum(74.81239);
   ...
   quadLineFit1006->SetChisquare(0.7606281);
   ...
   quadLineFit1006->SetParameter(0,74.18478);
   quadLineFit1006->SetParError(0,0.07178695);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.12837);
   quadLineFit1006->SetParError(1,1.163989);
   ...
   quadLineFit1007->SetChisquare(0.7606281);
   ...
   quadLineFit1007->SetParameter(0,74.18478);
   quadLineFit1007->SetParError(0,0.07178695);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.12837);
   quadLineFit1007->SetParError(1,1.163989);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.24572);
   Graph_mI10_ppm1007->SetMaximum(73.61015);
   ...
   quadLineFit1008->SetChisquare(1.774309);
   ...
   quadLineFit1008->SetParameter(0,74.22123);
   quadLineFit1008->SetParError(0,0.06304617);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.96832);
   quadLineFit1008->SetParError(1,1.025992);
   ...
   quadLineFit1009->SetChisquare(1.774309);
   ...
   quadLineFit1009->SetParameter(0,74.22123);
   quadLineFit1009->SetParError(0,0.06304617);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.96832);
   quadLineFit1009->SetParError(1,1.025992);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.82498);
   Graph_mI30_ppm1009->SetMaximum(72.61542);
   ...
   quadLineFit1010->SetChisquare(1.308088);
   ...
   quadLineFit1010->SetParameter(0,74.15046);
   quadLineFit1010->SetParError(0,0.05950533);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-31.30802);
   quadLineFit1010->SetParError(1,1.029685);
   ...
   quadLineFit1011->SetChisquare(1.308088);
   ...
   quadLineFit1011->SetParameter(0,74.15046);
   quadLineFit1011->SetParError(0,0.05950533);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-31.30802);
   quadLineFit1011->SetParError(1,1.029685);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.85451);
   Graph_mI50_ppm1011->SetMaximum(71.62444);
   ...
   quadLineFit1012->SetChisquare(0.002716673);
   ...
   quadLineFit1012->SetParameter(0,74.32311);
   quadLineFit1012->SetParError(0,0.1202404);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-54.16751);
   quadLineFit1012->SetParError(1,2.151483);
   ...
   quadLineFit1013->SetChisquare(0.002716673);
   ...
   quadLineFit1013->SetParameter(0,74.32311);
   quadLineFit1013->SetParError(0,0.1202404);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-54.16751);
   quadLineFit1013->SetParError(1,2.151483);
