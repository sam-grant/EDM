...
//=========  (Fri Apr 23 12:18:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-77.03774,50,47.27471);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-64.60649);
   Graph_Graph01025->SetMaximum(34.84346);
   ...
   mainFit1026->SetChisquare(3.946775);
   ...
   mainFit1026->SetParameter(0,-2.883008);
   mainFit1026->SetParError(0,0.514531);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9718644);
   mainFit1026->SetParError(1,0.02037297);
   ...
   pt_LaTex = pt->AddText("0.972#pm0.0204");
   pt_LaTex = pt->AddText("#minus2.88#pm0.515");
   pt_LaTex = pt->AddText("#minus2.97#pm 0.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.966471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.966471,-64.60649,2.966471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.946775);
   ...
   mainFit1027->SetParameter(0,-2.883008);
   mainFit1027->SetParError(0,0.514531);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9718644);
   mainFit1027->SetParError(1,0.02037297);
