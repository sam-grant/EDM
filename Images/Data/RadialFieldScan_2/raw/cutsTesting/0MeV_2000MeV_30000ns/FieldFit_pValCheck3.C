...
//=========  (Fri Apr 23 12:18:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-66.81672);
   Graph_Graph01031->SetMaximum(59.15594);
   ...
   mainFit1032->SetChisquare(4.680959);
   ...
   mainFit1032->SetParameter(0,-2.563374);
   mainFit1032->SetParError(0,0.5506025);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9823884);
   mainFit1032->SetParError(1,0.01643382);
   ...
   pt_LaTex = pt->AddText("0.982#pm0.0164");
   pt_LaTex = pt->AddText("#minus2.56#pm0.551");
   pt_LaTex = pt->AddText("#minus2.61#pm0.551");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.609328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.609328,-66.81672,2.609328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.680959);
   ...
   mainFit1033->SetParameter(0,-2.563374);
   mainFit1033->SetParError(0,0.5506025);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9823884);
   mainFit1033->SetParError(1,0.01643382);
