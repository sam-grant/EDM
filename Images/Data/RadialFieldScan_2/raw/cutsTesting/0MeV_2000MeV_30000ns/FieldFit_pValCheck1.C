...
//=========  (Fri Apr 23 12:18:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-66.81672);
   Graph_Graph01027->SetMaximum(59.15594);
   ...
   mainFit1028->SetChisquare(2.276255);
   ...
   mainFit1028->SetParameter(0,-2.2983);
   mainFit1028->SetParError(0,0.5372246);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9975798);
   mainFit1028->SetParError(1,0.01783741);
   ...
   pt_LaTex = pt->AddText("0.998#pm0.0178");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.537");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.544");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.303876,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.303876,-66.81672,2.303876,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.276255);
   ...
   mainFit1029->SetParameter(0,-2.2983);
   mainFit1029->SetParError(0,0.5372246);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9975798);
   mainFit1029->SetParError(1,0.01783741);
