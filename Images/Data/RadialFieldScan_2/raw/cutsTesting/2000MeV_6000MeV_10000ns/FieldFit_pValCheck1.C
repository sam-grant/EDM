...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-47.02246);
   Graph_Graph01027->SetMaximum(49.20994);
   ...
   mainFit1028->SetChisquare(2.561529);
   ...
   mainFit1028->SetParameter(0,0.1614526);
   mainFit1028->SetParError(0,0.6570244);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7897003);
   mainFit1028->SetParError(1,0.02173105);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.854");
   pt_LaTex = pt->AddText(" 0.79#pm0.0217");
   pt_LaTex = pt->AddText("0.161#pm0.657");
   pt_LaTex = pt->AddText("0.204#pm0.832");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2044479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2044479,-47.02246,-0.2044479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.561529);
   ...
   mainFit1029->SetParameter(0,0.1614526);
   mainFit1029->SetParError(0,0.6570244);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7897003);
   mainFit1029->SetParError(1,0.02173105);
