...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.90418,70,58.00953);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.81281);
   Graph_Graph01035->SetMaximum(47.91816);
   ...
   mainFit1036->SetChisquare(1.542364);
   ...
   mainFit1036->SetParameter(0,-0.2483737);
   mainFit1036->SetParError(0,0.6146677);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7937358);
   mainFit1036->SetParError(1,0.02127227);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.514");
   pt_LaTex = pt->AddText("0.794#pm0.0213");
   pt_LaTex = pt->AddText("#minus0.248#pm0.615");
   pt_LaTex = pt->AddText("#minus0.313#pm0.772");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3129173,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3129173,-32.81281,0.3129173,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.542364);
   ...
   mainFit1037->SetParameter(0,-0.2483737);
   mainFit1037->SetParError(0,0.6146677);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7937358);
   mainFit1037->SetParError(1,0.02127227);
