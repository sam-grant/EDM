...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02277504);
   Graph_Graph11015->SetMaximum(0.01756169);
   ...
   Graph_Graph21016->SetMinimum(-0.007082432);
   Graph_Graph21016->SetMaximum(0.008332385);
   ...
   Graph_Graph31017->SetMinimum(-0.04985748);
   Graph_Graph31017->SetMaximum(0.03722417);
   ...
   Graph_Graph41018->SetMinimum(-0.02002467);
   Graph_Graph41018->SetMaximum(0.01054501);
   ...
   Graph_Graph51019->SetMinimum(-0.01381401);
   Graph_Graph51019->SetMaximum(0.01846552);
