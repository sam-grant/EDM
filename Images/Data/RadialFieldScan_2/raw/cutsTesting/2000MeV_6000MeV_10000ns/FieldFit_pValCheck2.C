...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-59.05151,75,61.23899);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-47.02246);
   Graph_Graph01029->SetMaximum(49.20994);
   ...
   mainFit1030->SetChisquare(2.966565);
   ...
   mainFit1030->SetParameter(0,-0.06352634);
   mainFit1030->SetParError(0,0.6382347);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7832066);
   mainFit1030->SetParError(1,0.01950857);
   ...
   pt_LaTex = pt->AddText("0.783#pm0.0195");
   pt_LaTex = pt->AddText("#minus0.0635#pm0.638");
   pt_LaTex = pt->AddText("#minus0.0811#pm0.815");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.08111057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.08111057,-47.02246,0.08111057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.966565);
   ...
   mainFit1031->SetParameter(0,-0.06352634);
   mainFit1031->SetParError(0,0.6382347);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7832066);
   mainFit1031->SetParError(1,0.01950857);
