...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-47.02246);
   Graph_Graph01020->SetMaximum(49.20994);
   ...
   mainFit1021->SetChisquare(2.984345);
   ...
   mainFit1021->SetParameter(0,-0.03020229);
   mainFit1021->SetParError(0,0.5872028);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7834044);
   mainFit1021->SetParError(1,0.01945475);
   ...
   mainFit1022->SetChisquare(2.984345);
   ...
   mainFit1022->SetParameter(0,-0.03020229);
   mainFit1022->SetParError(0,0.5872028);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7834044);
   mainFit1022->SetParError(1,0.01945475);
