...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-47.02246);
   Graph_Graph01033->SetMaximum(49.20994);
   ...
   mainFit1034->SetChisquare(0.920917);
   ...
   mainFit1034->SetParameter(0,0.6138635);
   mainFit1034->SetParError(0,0.7388111);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7621583);
   mainFit1034->SetParError(1,0.02443866);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.307");
   pt_LaTex = pt->AddText("0.762#pm0.0244");
   pt_LaTex = pt->AddText("0.614#pm0.739");
   pt_LaTex = pt->AddText("0.805#pm0.982");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8054279,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8054279,-47.02246,-0.8054279,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.920917);
   ...
   mainFit1035->SetParameter(0,0.6138635);
   mainFit1035->SetParError(0,0.7388111);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7621583);
   mainFit1035->SetParError(1,0.02443866);
