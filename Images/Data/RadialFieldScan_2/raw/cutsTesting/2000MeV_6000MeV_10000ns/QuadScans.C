...
//=========  (Thu Apr 22 09:44:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1813427);
   ...
   quadLineFit1002->SetParameter(0,75.09109);
   quadLineFit1002->SetParError(0,0.08937252);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.69154);
   quadLineFit1002->SetParError(1,1.499032);
   ...
   quadLineFit1003->SetChisquare(0.1813427);
   ...
   quadLineFit1003->SetParameter(0,75.09109);
   quadLineFit1003->SetParError(0,0.08937252);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.69154);
   quadLineFit1003->SetParError(1,1.499032);
   ...
   Graph_30_ppm1003->SetMinimum(76.16962);
   Graph_30_ppm1003->SetMaximum(76.75967);
   ...
   quadLineFit1004->SetChisquare(1.389891);
   ...
   quadLineFit1004->SetParameter(0,75.05414);
   quadLineFit1004->SetParError(0,0.07512888);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.83687);
   quadLineFit1004->SetParError(1,1.235073);
   ...
   quadLineFit1005->SetChisquare(1.389891);
   ...
   quadLineFit1005->SetParameter(0,75.05414);
   quadLineFit1005->SetParError(0,0.07512888);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.83687);
   quadLineFit1005->SetParError(1,1.235073);
   ...
   Graph_10_ppm1005->SetMinimum(75.26804);
   Graph_10_ppm1005->SetMaximum(75.51367);
   ...
   quadLineFit1006->SetChisquare(0.3048089);
   ...
   quadLineFit1006->SetParameter(0,74.89435);
   quadLineFit1006->SetParError(0,0.08811821);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.977572);
   quadLineFit1006->SetParError(1,1.42909);
   ...
   quadLineFit1007->SetChisquare(0.3048089);
   ...
   quadLineFit1007->SetParameter(0,74.89435);
   quadLineFit1007->SetParError(0,0.08811821);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.977572);
   quadLineFit1007->SetParError(1,1.42909);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.24983);
   Graph_mI10_ppm1007->SetMaximum(74.50846);
   ...
   quadLineFit1008->SetChisquare(8.661772);
   ...
   quadLineFit1008->SetParameter(0,74.79885);
   quadLineFit1008->SetParError(0,0.07728773);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.083849);
   quadLineFit1008->SetParError(1,1.258009);
   ...
   quadLineFit1009->SetChisquare(8.661772);
   ...
   quadLineFit1009->SetParameter(0,74.79885);
   quadLineFit1009->SetParError(0,0.07728773);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.083849);
   quadLineFit1009->SetParError(1,1.258009);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.97454);
   Graph_mI30_ppm1009->SetMaximum(73.60951);
   ...
   quadLineFit1010->SetChisquare(0.8720422);
   ...
   quadLineFit1010->SetParameter(0,74.8166);
   quadLineFit1010->SetParError(0,0.0731368);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.81945);
   quadLineFit1010->SetParError(1,1.265783);
   ...
   quadLineFit1011->SetChisquare(0.8720422);
   ...
   quadLineFit1011->SetParameter(0,74.8166);
   quadLineFit1011->SetParError(0,0.0731368);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.81945);
   quadLineFit1011->SetParError(1,1.265783);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.16604);
   Graph_mI50_ppm1011->SetMaximum(72.70334);
   ...
   quadLineFit1012->SetChisquare(1.330872);
   ...
   quadLineFit1012->SetParameter(0,74.51203);
   quadLineFit1012->SetParError(0,0.1513801);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-36.29417);
   quadLineFit1012->SetParError(1,2.708925);
   ...
   quadLineFit1013->SetChisquare(1.330872);
   ...
   quadLineFit1013->SetParameter(0,74.51203);
   quadLineFit1013->SetParError(0,0.1513801);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-36.29417);
   quadLineFit1013->SetParError(1,2.708925);
