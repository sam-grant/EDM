...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-47.02246);
   Graph_Graph01031->SetMaximum(49.20994);
   ...
   mainFit1032->SetChisquare(2.460216);
   ...
   mainFit1032->SetParameter(0,-0.2745291);
   mainFit1032->SetParError(0,0.6772755);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7872212);
   mainFit1032->SetParError(1,0.02015645);
   ...
   pt_LaTex = pt->AddText("0.787#pm0.0202");
   pt_LaTex = pt->AddText("#minus0.275#pm0.677");
   pt_LaTex = pt->AddText("#minus0.349#pm0.858");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3487319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3487319,-47.02246,0.3487319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.460216);
   ...
   mainFit1033->SetParameter(0,-0.2745291);
   mainFit1033->SetParError(0,0.6772755);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7872212);
   mainFit1033->SetParError(1,0.02015645);
