...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-54.77185,50,39.8407);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-45.3106);
   Graph_Graph01025->SetMaximum(30.37944);
   ...
   mainFit1026->SetChisquare(2.718888);
   ...
   mainFit1026->SetParameter(0,-0.1504929);
   mainFit1026->SetParError(0,0.6319065);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.775206);
   mainFit1026->SetParError(1,0.0251291);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.906");
   pt_LaTex = pt->AddText("0.775#pm0.0251");
   pt_LaTex = pt->AddText("#minus0.15#pm0.632");
   pt_LaTex = pt->AddText("#minus0.194#pm0.816");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1941329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1941329,-45.3106,0.1941329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.718888);
   ...
   mainFit1027->SetParameter(0,-0.1504929);
   mainFit1027->SetParError(0,0.6319065);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.775206);
   mainFit1027->SetParError(1,0.0251291);
