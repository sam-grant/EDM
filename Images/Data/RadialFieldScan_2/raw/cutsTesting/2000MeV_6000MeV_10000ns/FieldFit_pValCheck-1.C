...
//=========  (Thu Apr 22 09:44:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-47.02246);
   Graph_Graph01023->SetMaximum(49.20994);
   ...
   mainFit1024->SetChisquare(2.984345);
   ...
   mainFit1024->SetParameter(0,-0.03020229);
   mainFit1024->SetParError(0,0.5872028);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7834044);
   mainFit1024->SetParError(1,0.01945475);
   ...
   pt_LaTex = pt->AddText("#minus0.0302#pm0.587");
   pt_LaTex = pt->AddText("#minus0.0386#pm0.749");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.03855262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.03855262,-47.02246,0.03855262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.984345);
   ...
   mainFit1025->SetParameter(0,-0.03020229);
   mainFit1025->SetParError(0,0.5872028);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7834044);
   mainFit1025->SetParError(1,0.01945475);
