...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-53.74167);
   Graph_Graph01031->SetMaximum(52.81584);
   ...
   mainFit1032->SetChisquare(5.376554);
   ...
   mainFit1032->SetParameter(0,-0.4478379);
   mainFit1032->SetParError(0,0.5531372);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8311308);
   mainFit1032->SetParError(1,0.01653383);
   ...
   pt_LaTex = pt->AddText("0.831#pm0.0165");
   pt_LaTex = pt->AddText("#minus0.448#pm0.553");
   pt_LaTex = pt->AddText("#minus0.539#pm0.663");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5388296,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5388296,-53.74167,0.5388296,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.376554);
   ...
   mainFit1033->SetParameter(0,-0.4478379);
   mainFit1033->SetParError(0,0.5531372);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8311308);
   mainFit1033->SetParError(1,0.01653383);
