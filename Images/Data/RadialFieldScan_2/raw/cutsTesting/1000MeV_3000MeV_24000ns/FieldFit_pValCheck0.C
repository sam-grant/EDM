...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.00382,50,40.84786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.71865);
   Graph_Graph01025->SetMaximum(30.56269);
   ...
   mainFit1026->SetChisquare(2.504193);
   ...
   mainFit1026->SetParameter(0,-0.718851);
   mainFit1026->SetParError(0,0.5162804);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8085905);
   mainFit1026->SetParError(1,0.02044661);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.835");
   pt_LaTex = pt->AddText("0.809#pm0.0204");
   pt_LaTex = pt->AddText("#minus0.719#pm0.516");
   pt_LaTex = pt->AddText("#minus0.889#pm0.642");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8890174,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8890174,-51.71865,0.8890174,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.504193);
   ...
   mainFit1027->SetParameter(0,-0.718851);
   mainFit1027->SetParError(0,0.5162804);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8085905);
   mainFit1027->SetParError(1,0.02044661);
