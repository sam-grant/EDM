...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-53.74167);
   Graph_Graph01029->SetMaximum(52.81584);
   ...
   mainFit1030->SetChisquare(4.917922);
   ...
   mainFit1030->SetParameter(0,-0.5407);
   mainFit1030->SetParError(0,0.5226072);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8294076);
   mainFit1030->SetParError(1,0.01604358);
   ...
   pt_LaTex = pt->AddText("0.829#pm0.016");
   pt_LaTex = pt->AddText("#minus0.541#pm0.523");
   pt_LaTex = pt->AddText("#minus0.652#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6519111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6519111,-53.74167,0.6519111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.917922);
   ...
   mainFit1031->SetParameter(0,-0.5407);
   mainFit1031->SetParError(0,0.5226072);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8294076);
   mainFit1031->SetParError(1,0.01604358);
