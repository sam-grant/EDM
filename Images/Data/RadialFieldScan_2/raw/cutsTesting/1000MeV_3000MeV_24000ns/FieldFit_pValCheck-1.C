...
//=========  (Fri Apr 23 18:49:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-53.74167);
   Graph_Graph01023->SetMaximum(52.81584);
   ...
   mainFit1024->SetChisquare(5.412497);
   ...
   mainFit1024->SetParameter(0,-0.3958187);
   mainFit1024->SetParError(0,0.4802867);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8303332);
   mainFit1024->SetParError(1,0.01598958);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.016");
   pt_LaTex = pt->AddText("#minus0.396#pm 0.48");
   pt_LaTex = pt->AddText("#minus0.477#pm0.577");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4766986,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4766986,-53.74167,0.4766986,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.412497);
   ...
   mainFit1025->SetParameter(0,-0.3958187);
   mainFit1025->SetParError(0,0.4802867);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8303332);
   mainFit1025->SetParError(1,0.01598958);
