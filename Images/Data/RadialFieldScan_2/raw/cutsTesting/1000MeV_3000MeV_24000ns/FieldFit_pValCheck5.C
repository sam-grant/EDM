...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-43.55541,70,61.43433);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.05643);
   Graph_Graph01035->SetMaximum(50.93536);
   ...
   mainFit1036->SetChisquare(5.242502);
   ...
   mainFit1036->SetParameter(0,-0.3337569);
   mainFit1036->SetParError(0,0.5033217);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8273349);
   mainFit1036->SetParError(1,0.01756552);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.75");
   pt_LaTex = pt->AddText("0.827#pm0.0176");
   pt_LaTex = pt->AddText("#minus0.334#pm0.503");
   pt_LaTex = pt->AddText("#minus0.403#pm0.606");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4034121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4034121,-33.05643,0.4034121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.242502);
   ...
   mainFit1037->SetParameter(0,-0.3337569);
   mainFit1037->SetParError(0,0.5033217);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8273349);
   mainFit1037->SetParError(1,0.01756552);
