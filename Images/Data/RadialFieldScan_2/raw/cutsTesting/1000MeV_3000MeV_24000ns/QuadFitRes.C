...
//=========  (Fri Apr 23 18:49:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01636917);
   Graph_Graph11015->SetMaximum(0.04385346);
   ...
   Graph_Graph21016->SetMinimum(-0.0114902);
   Graph_Graph21016->SetMaximum(0.01354602);
   ...
   Graph_Graph31017->SetMinimum(-0.02746481);
   Graph_Graph31017->SetMaximum(0.02059291);
   ...
   Graph_Graph41018->SetMinimum(-0.01518589);
   Graph_Graph41018->SetMaximum(0.01916063);
   ...
   Graph_Graph51019->SetMinimum(-0.00548292);
   Graph_Graph51019->SetMaximum(0.007331455);
