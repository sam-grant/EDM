...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-53.74167);
   Graph_Graph01027->SetMaximum(52.81584);
   ...
   mainFit1028->SetChisquare(0.1548077);
   ...
   mainFit1028->SetParameter(0,0.1707467);
   mainFit1028->SetParError(0,0.5401187);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8491629);
   mainFit1028->SetParError(1,0.01797513);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0516");
   pt_LaTex = pt->AddText("0.849#pm0.018");
   pt_LaTex = pt->AddText("0.171#pm 0.54");
   pt_LaTex = pt->AddText("0.201#pm0.636");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2010764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2010764,-53.74167,-0.2010764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1548077);
   ...
   mainFit1029->SetParameter(0,0.1707467);
   mainFit1029->SetParError(0,0.5401187);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8491629);
   mainFit1029->SetParError(1,0.01797513);
