...
//=========  (Fri Apr 23 18:49:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-67.06135,75,66.13552);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-53.74167);
   Graph_Graph01033->SetMaximum(52.81584);
   ...
   mainFit1034->SetChisquare(5.263656);
   ...
   mainFit1034->SetParameter(0,-0.5350027);
   mainFit1034->SetParError(0,0.6006901);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8349626);
   mainFit1034->SetParError(1,0.01999137);
   ...
   pt_LaTex = pt->AddText("0.835#pm 0.02");
   pt_LaTex = pt->AddText("#minus0.535#pm0.601");
   pt_LaTex = pt->AddText("#minus0.641#pm0.713");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6407504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6407504,-53.74167,0.6407504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.263656);
   ...
   mainFit1035->SetParameter(0,-0.5350027);
   mainFit1035->SetParError(0,0.6006901);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8349626);
   mainFit1035->SetParError(1,0.01999137);
