...
//=========  (Fri Apr 23 18:49:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.873837);
   ...
   quadLineFit1002->SetParameter(0,74.63424);
   quadLineFit1002->SetParError(0,0.07505472);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.67658);
   quadLineFit1002->SetParError(1,1.259465);
   ...
   quadLineFit1003->SetChisquare(1.873837);
   ...
   quadLineFit1003->SetParameter(0,74.63424);
   quadLineFit1003->SetParError(0,0.07505472);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.67658);
   quadLineFit1003->SetParError(1,1.259465);
   ...
   Graph_30_ppm1003->SetMinimum(75.8215);
   Graph_30_ppm1003->SetMaximum(76.39625);
   ...
   quadLineFit1004->SetChisquare(4.398842);
   ...
   quadLineFit1004->SetParameter(0,74.72047);
   quadLineFit1004->SetParError(0,0.06145174);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.69591);
   quadLineFit1004->SetParError(1,1.010004);
   ...
   quadLineFit1005->SetChisquare(4.398842);
   ...
   quadLineFit1005->SetParameter(0,74.72047);
   quadLineFit1005->SetParError(0,0.06145174);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.69591);
   quadLineFit1005->SetParError(1,1.010004);
   ...
   Graph_10_ppm1005->SetMinimum(74.89137);
   Graph_10_ppm1005->SetMaximum(75.14642);
   ...
   quadLineFit1006->SetChisquare(1.203775);
   ...
   quadLineFit1006->SetParameter(0,74.4775);
   quadLineFit1006->SetParError(0,0.07201167);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.655419);
   quadLineFit1006->SetParError(1,1.167938);
   ...
   quadLineFit1007->SetChisquare(1.203775);
   ...
   quadLineFit1007->SetParameter(0,74.4775);
   quadLineFit1007->SetParError(0,0.07201167);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.655419);
   quadLineFit1007->SetParError(1,1.167938);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.77206);
   Graph_mI10_ppm1007->SetMaximum(74.03905);
   ...
   quadLineFit1008->SetChisquare(3.918889);
   ...
   quadLineFit1008->SetParameter(0,74.42028);
   quadLineFit1008->SetParError(0,0.06322122);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.531762);
   quadLineFit1008->SetParError(1,1.029046);
   ...
   quadLineFit1009->SetChisquare(3.918889);
   ...
   quadLineFit1009->SetParameter(0,74.42028);
   quadLineFit1009->SetParError(0,0.06322122);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.531762);
   quadLineFit1009->SetParError(1,1.029046);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.45967);
   Graph_mI30_ppm1009->SetMaximum(73.1067);
   ...
   quadLineFit1010->SetChisquare(2.026187);
   ...
   quadLineFit1010->SetParameter(0,74.33193);
   quadLineFit1010->SetParError(0,0.0598098);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.02198);
   quadLineFit1010->SetParError(1,1.035134);
   ...
   quadLineFit1011->SetChisquare(2.026187);
   ...
   quadLineFit1011->SetParameter(0,74.33193);
   quadLineFit1011->SetParError(0,0.0598098);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.02198);
   quadLineFit1011->SetParError(1,1.035134);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.56781);
   Graph_mI50_ppm1011->SetMaximum(72.18306);
   ...
   quadLineFit1012->SetChisquare(0.3139255);
   ...
   quadLineFit1012->SetParameter(0,74.31064);
   quadLineFit1012->SetParError(0,0.1206621);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.70293);
   quadLineFit1012->SetParError(1,2.158949);
   ...
   quadLineFit1013->SetChisquare(0.3139255);
   ...
   quadLineFit1013->SetParameter(0,74.31064);
   quadLineFit1013->SetParError(0,0.1206621);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.70293);
   quadLineFit1013->SetParError(1,2.158949);
