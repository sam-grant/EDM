...
//=========  (Fri Apr 23 18:49:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-53.74167);
   Graph_Graph01020->SetMaximum(52.81584);
   ...
   mainFit1021->SetChisquare(5.412497);
   ...
   mainFit1021->SetParameter(0,-0.3958187);
   mainFit1021->SetParError(0,0.4802867);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8303332);
   mainFit1021->SetParError(1,0.01598958);
   ...
   mainFit1022->SetChisquare(5.412497);
   ...
   mainFit1022->SetParameter(0,-0.3958187);
   mainFit1022->SetParError(0,0.4802867);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8303332);
   mainFit1022->SetParError(1,0.01598958);
