...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-51.56888,70,68.04082);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.60791);
   Graph_Graph01035->SetMaximum(56.07985);
   ...
   mainFit1036->SetChisquare(2.548919);
   ...
   mainFit1036->SetParameter(0,-2.271186);
   mainFit1036->SetParError(0,0.4723586);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9646555);
   mainFit1036->SetParError(1,0.01634484);
   ...
   pt_LaTex = pt->AddText("0.965#pm0.0163");
   pt_LaTex = pt->AddText("#minus2.27#pm0.472");
   pt_LaTex = pt->AddText("#minus2.35#pm0.481");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.354401,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.354401,-39.60791,2.354401,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.548919);
   ...
   mainFit1037->SetParameter(0,-2.271186);
   mainFit1037->SetParError(0,0.4723586);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9646555);
   mainFit1037->SetParError(1,0.01634484);
