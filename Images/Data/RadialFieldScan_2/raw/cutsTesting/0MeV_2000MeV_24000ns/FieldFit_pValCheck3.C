...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-65.11647);
   Graph_Graph01031->SetMaximum(58.39881);
   ...
   mainFit1032->SetChisquare(3.298833);
   ...
   mainFit1032->SetParameter(0,-2.283614);
   mainFit1032->SetParError(0,0.5186652);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9694125);
   mainFit1032->SetParError(1,0.01540764);
   ...
   pt_LaTex = pt->AddText("0.969#pm0.0154");
   pt_LaTex = pt->AddText("#minus2.28#pm0.519");
   pt_LaTex = pt->AddText("#minus2.36#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.355668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.355668,-65.11647,2.355668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.298833);
   ...
   mainFit1033->SetParameter(0,-2.283614);
   mainFit1033->SetParError(0,0.5186652);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9694125);
   mainFit1033->SetParError(1,0.01540764);
