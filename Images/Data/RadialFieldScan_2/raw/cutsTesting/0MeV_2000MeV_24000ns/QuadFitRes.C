...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004611518);
   Graph_Graph11015->SetMaximum(0.01464109);
   ...
   Graph_Graph21016->SetMinimum(-0.01064849);
   Graph_Graph21016->SetMaximum(0.01249289);
   ...
   Graph_Graph31017->SetMinimum(-0.01388922);
   Graph_Graph31017->SetMaximum(0.01444721);
   ...
   Graph_Graph41018->SetMinimum(-0.004260239);
   Graph_Graph41018->SetMaximum(0.006744014);
   ...
   Graph_Graph51019->SetMinimum(-0.0007193673);
   Graph_Graph51019->SetMaximum(0.0009609292);
