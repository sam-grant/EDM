...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-65.11647);
   Graph_Graph01029->SetMaximum(58.39881);
   ...
   mainFit1030->SetChisquare(3.306569);
   ...
   mainFit1030->SetParameter(0,-2.509683);
   mainFit1030->SetParError(0,0.4895603);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9708511);
   mainFit1030->SetParError(1,0.01493311);
   ...
   pt_LaTex = pt->AddText("#minus2.51#pm 0.49");
   pt_LaTex = pt->AddText("#minus2.59#pm0.501");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.585033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.585033,-65.11647,2.585033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.306569);
   ...
   mainFit1031->SetParameter(0,-2.509683);
   mainFit1031->SetParError(0,0.4895603);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9708511);
   mainFit1031->SetParError(1,0.01493311);
