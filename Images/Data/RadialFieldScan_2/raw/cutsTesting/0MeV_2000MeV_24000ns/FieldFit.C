...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-65.11647);
   Graph_Graph01020->SetMaximum(58.39881);
   ...
   mainFit1021->SetChisquare(3.555687);
   ...
   mainFit1021->SetParameter(0,-2.413938);
   mainFit1021->SetParError(0,0.4504207);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9714168);
   mainFit1021->SetParError(1,0.01488947);
   ...
   mainFit1022->SetChisquare(3.555687);
   ...
   mainFit1022->SetParameter(0,-2.413938);
   mainFit1022->SetParError(0,0.4504207);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9714168);
   mainFit1022->SetParError(1,0.01488947);
