...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-65.11647);
   Graph_Graph01027->SetMaximum(58.39881);
   ...
   mainFit1028->SetChisquare(1.895434);
   ...
   mainFit1028->SetParameter(0,-2.121598);
   mainFit1028->SetParError(0,0.5043414);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9809729);
   mainFit1028->SetParError(1,0.01663349);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.632");
   pt_LaTex = pt->AddText("0.981#pm0.0166");
   pt_LaTex = pt->AddText("#minus2.12#pm0.504");
   pt_LaTex = pt->AddText("#minus2.16#pm0.518");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.162749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.162749,-65.11647,2.162749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.895434);
   ...
   mainFit1029->SetParameter(0,-2.121598);
   mainFit1029->SetParError(0,0.5043414);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9809729);
   mainFit1029->SetParError(1,0.01663349);
