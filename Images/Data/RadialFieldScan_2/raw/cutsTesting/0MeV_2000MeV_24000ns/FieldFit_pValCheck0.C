...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-75.20695,50,47.09358);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.9769);
   Graph_Graph01025->SetMaximum(34.86353);
   ...
   mainFit1026->SetChisquare(2.620541);
   ...
   mainFit1026->SetParameter(0,-2.589093);
   mainFit1026->SetParError(0,0.4854708);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9596663);
   mainFit1026->SetParError(1,0.01922082);
   ...
   pt_LaTex = pt->AddText(" 0.96#pm0.0192");
   pt_LaTex = pt->AddText("#minus2.59#pm0.485");
   pt_LaTex = pt->AddText(" #minus2.7#pm0.515");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.697909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.697909,-62.9769,2.697909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.620541);
   ...
   mainFit1027->SetParameter(0,-2.589093);
   mainFit1027->SetParError(0,0.4854708);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9596663);
   mainFit1027->SetParError(1,0.01922082);
