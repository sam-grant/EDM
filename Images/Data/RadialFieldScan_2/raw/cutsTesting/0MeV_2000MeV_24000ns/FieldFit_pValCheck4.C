...
//=========  (Fri Apr 23 11:43:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-65.11647);
   Graph_Graph01033->SetMaximum(58.39881);
   ...
   mainFit1034->SetChisquare(1.878805);
   ...
   mainFit1034->SetParameter(0,-2.854983);
   mainFit1034->SetParError(0,0.5646904);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9859121);
   mainFit1034->SetParError(1,0.01862613);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0186");
   pt_LaTex = pt->AddText("#minus2.85#pm0.565");
   pt_LaTex = pt->AddText(" #minus2.9#pm0.549");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.895779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.895779,-65.11647,2.895779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.878805);
   ...
   mainFit1035->SetParameter(0,-2.854983);
   mainFit1035->SetParError(0,0.5646904);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9859121);
   mainFit1035->SetParError(1,0.01862613);
