...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.62083);
   Graph_Graph01029->SetMaximum(52.74584);
   ...
   mainFit1030->SetChisquare(0.2547468);
   ...
   mainFit1030->SetParameter(0,-1.116207);
   mainFit1030->SetParError(0,1.023813);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8434716);
   mainFit1030->SetParError(1,0.0312273);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0849");
   pt_LaTex = pt->AddText("0.843#pm0.0312");
   pt_LaTex = pt->AddText("#minus1.12#pm 1.02");
   pt_LaTex = pt->AddText("#minus1.32#pm 1.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.323349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.323349,-54.62083,1.323349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.2547468);
   ...
   mainFit1031->SetParameter(0,-1.116207);
   mainFit1031->SetParError(0,1.023813);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8434716);
   mainFit1031->SetParError(1,0.0312273);
