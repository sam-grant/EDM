...
//=========  (Wed Apr 21 17:51:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08335915);
   Graph_Graph11015->SetMaximum(0.03074787);
   ...
   Graph_Graph21016->SetMinimum(-0.02200608);
   Graph_Graph21016->SetMaximum(0.02575666);
   ...
   Graph_Graph31017->SetMinimum(-0.04203351);
   Graph_Graph31017->SetMaximum(0.03918424);
   ...
   Graph_Graph41018->SetMinimum(-0.09221981);
   Graph_Graph41018->SetMaximum(0.04987945);
   ...
   Graph_Graph51019->SetMinimum(-0.00566426);
   Graph_Graph51019->SetMaximum(0.007548795);
