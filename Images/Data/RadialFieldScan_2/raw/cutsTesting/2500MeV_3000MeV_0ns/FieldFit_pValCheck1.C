...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.62083);
   Graph_Graph01027->SetMaximum(52.74584);
   ...
   mainFit1028->SetChisquare(0.3257352);
   ...
   mainFit1028->SetParameter(0,-1.238358);
   mainFit1028->SetParError(0,1.05534);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8423626);
   mainFit1028->SetParError(1,0.03479769);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0348");
   pt_LaTex = pt->AddText("#minus1.24#pm 1.06");
   pt_LaTex = pt->AddText("#minus1.47#pm 1.26");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.470101,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.470101,-54.62083,1.470101,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3257352);
   ...
   mainFit1029->SetParameter(0,-1.238358);
   mainFit1029->SetParError(0,1.05534);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8423626);
   mainFit1029->SetParError(1,0.03479769);
