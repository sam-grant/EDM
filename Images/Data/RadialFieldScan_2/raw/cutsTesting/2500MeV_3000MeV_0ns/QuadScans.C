...
//=========  (Wed Apr 21 17:51:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.066386);
   ...
   quadLineFit1002->SetParameter(0,75.36754);
   quadLineFit1002->SetParError(0,0.1437427);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.38967);
   quadLineFit1002->SetParError(1,2.408948);
   ...
   quadLineFit1003->SetChisquare(2.066386);
   ...
   quadLineFit1003->SetParameter(0,75.36754);
   quadLineFit1003->SetParError(0,0.1437427);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.38967);
   quadLineFit1003->SetParError(1,2.408948);
   ...
   Graph_30_ppm1003->SetMinimum(76.45812);
   Graph_30_ppm1003->SetMaximum(77.11431);
   ...
   quadLineFit1004->SetChisquare(4.112087);
   ...
   quadLineFit1004->SetParameter(0,75.28849);
   quadLineFit1004->SetParError(0,0.1206238);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.10987);
   quadLineFit1004->SetParError(1,1.981223);
   ...
   quadLineFit1005->SetChisquare(4.112087);
   ...
   quadLineFit1005->SetParameter(0,75.28849);
   quadLineFit1005->SetParError(0,0.1206238);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.10987);
   quadLineFit1005->SetParError(1,1.981223);
   ...
   Graph_10_ppm1005->SetMinimum(75.56635);
   Graph_10_ppm1005->SetMaximum(75.81632);
   ...
   quadLineFit1006->SetChisquare(1.143668);
   ...
   quadLineFit1006->SetParameter(0,75.26408);
   quadLineFit1006->SetParError(0,0.1418326);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.642551);
   quadLineFit1006->SetParError(1,2.298348);
   ...
   quadLineFit1007->SetChisquare(1.143668);
   ...
   quadLineFit1007->SetParameter(0,75.26408);
   quadLineFit1007->SetParError(0,0.1418326);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.642551);
   quadLineFit1007->SetParError(1,2.298348);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.48659);
   Graph_mI10_ppm1007->SetMaximum(74.83469);
   ...
   quadLineFit1008->SetChisquare(2.284112);
   ...
   quadLineFit1008->SetParameter(0,75.24239);
   quadLineFit1008->SetParError(0,0.1245708);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.821859);
   quadLineFit1008->SetParError(1,2.026218);
   ...
   quadLineFit1009->SetChisquare(2.284112);
   ...
   quadLineFit1009->SetParameter(0,75.24239);
   quadLineFit1009->SetParError(0,0.1245708);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.821859);
   quadLineFit1009->SetParError(1,2.026218);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.21569);
   Graph_mI30_ppm1009->SetMaximum(73.89388);
   ...
   quadLineFit1010->SetChisquare(6.120976);
   ...
   quadLineFit1010->SetParameter(0,75.18008);
   quadLineFit1010->SetParError(0,0.1175664);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.72915);
   quadLineFit1010->SetParError(1,2.032896);
   ...
   quadLineFit1011->SetChisquare(6.120976);
   ...
   quadLineFit1011->SetParameter(0,75.18008);
   quadLineFit1011->SetParError(0,0.1175664);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.72915);
   quadLineFit1011->SetParError(1,2.032896);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.33205);
   Graph_mI50_ppm1011->SetMaximum(72.96969);
   ...
   quadLineFit1012->SetChisquare(0.08547893);
   ...
   quadLineFit1012->SetParameter(0,75.01469);
   quadLineFit1012->SetParError(0,0.237803);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.42014);
   quadLineFit1012->SetParError(1,4.253472);
   ...
   quadLineFit1013->SetChisquare(0.08547893);
   ...
   quadLineFit1013->SetParameter(0,75.01469);
   quadLineFit1013->SetParError(0,0.237803);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.42014);
   quadLineFit1013->SetParError(1,4.253472);
