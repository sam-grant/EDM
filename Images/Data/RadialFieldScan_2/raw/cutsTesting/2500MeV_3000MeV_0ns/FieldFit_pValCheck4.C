...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.62083);
   Graph_Graph01033->SetMaximum(52.74584);
   ...
   mainFit1034->SetChisquare(0.3034445);
   ...
   mainFit1034->SetParameter(0,-1.114894);
   mainFit1034->SetParError(0,1.181898);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8392683);
   mainFit1034->SetParError(1,0.03897654);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.101");
   pt_LaTex = pt->AddText("0.839#pm0.039");
   pt_LaTex = pt->AddText("#minus1.11#pm 1.18");
   pt_LaTex = pt->AddText("#minus1.33#pm 1.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.328412,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.328412,-54.62083,1.328412,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.3034445);
   ...
   mainFit1035->SetParameter(0,-1.114894);
   mainFit1035->SetParError(0,1.181898);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8392683);
   mainFit1035->SetParError(1,0.03897654);
