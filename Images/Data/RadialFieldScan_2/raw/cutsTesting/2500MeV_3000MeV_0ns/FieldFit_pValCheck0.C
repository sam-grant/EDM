...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.61478,50,44.03226);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.85008);
   Graph_Graph01025->SetMaximum(33.26756);
   ...
   mainFit1026->SetChisquare(0.2518727);
   ...
   mainFit1026->SetParameter(0,-1.326827);
   mainFit1026->SetParError(0,1.014667);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.835885);
   mainFit1026->SetParError(1,0.04016552);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.084");
   pt_LaTex = pt->AddText("0.836#pm0.0402");
   pt_LaTex = pt->AddText("#minus1.33#pm 1.01");
   pt_LaTex = pt->AddText("#minus1.59#pm 1.23");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.587332,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.587332,-52.85008,1.587332,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.2518727);
   ...
   mainFit1027->SetParameter(0,-1.326827);
   mainFit1027->SetParError(0,1.014667);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.835885);
   mainFit1027->SetParError(1,0.04016552);
