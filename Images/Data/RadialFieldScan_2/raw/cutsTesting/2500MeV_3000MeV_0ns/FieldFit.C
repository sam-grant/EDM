...
//=========  (Wed Apr 21 17:51:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.04167,75,66.16668);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-54.62083);
   Graph_Graph01020->SetMaximum(52.74584);
   ...
   mainFit1021->SetChisquare(0.3266867);
   ...
   mainFit1021->SetParameter(0,-1.223635);
   mainFit1021->SetParError(0,0.9421342);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8428288);
   mainFit1021->SetParError(1,0.03113875);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0817");
   pt_LaTex = pt->AddText("0.843#pm0.0311");
   pt_LaTex = pt->AddText("#minus1.22#pm0.942");
   pt_LaTex = pt->AddText("#minus1.45#pm 1.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.451819,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.451819,-54.62083,1.451819,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(0.3266867);
   ...
   mainFit1022->SetParameter(0,-1.223635);
   mainFit1022->SetParError(0,0.9421342);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8428288);
   mainFit1022->SetParError(1,0.03113875);
