...
//=========  (Wed Apr 21 17:51:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.62083);
   Graph_Graph01023->SetMaximum(52.74584);
   ...
   mainFit1024->SetChisquare(0.3266867);
   ...
   mainFit1024->SetParameter(0,-1.223635);
   mainFit1024->SetParError(0,0.9421342);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8428288);
   mainFit1024->SetParError(1,0.03113875);
   ...
   mainFit1025->SetChisquare(0.3266867);
   ...
   mainFit1025->SetParameter(0,-1.223635);
   mainFit1025->SetParError(0,0.9421342);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8428288);
   mainFit1025->SetParError(1,0.03113875);
