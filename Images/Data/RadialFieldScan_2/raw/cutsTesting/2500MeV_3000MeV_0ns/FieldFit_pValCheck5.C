...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-46.90222,70,61.93879);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.01812);
   Graph_Graph01035->SetMaximum(51.05469);
   ...
   mainFit1036->SetChisquare(0.06201973);
   ...
   mainFit1036->SetParameter(0,-1.376878);
   mainFit1036->SetParError(0,0.9880696);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.850086);
   mainFit1036->SetParError(1,0.03417421);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0207");
   pt_LaTex = pt->AddText(" 0.85#pm0.0342");
   pt_LaTex = pt->AddText("#minus1.38#pm0.988");
   pt_LaTex = pt->AddText("#minus1.62#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.619692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.619692,-36.01812,1.619692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.06201973);
   ...
   mainFit1037->SetParameter(0,-1.376878);
   mainFit1037->SetParError(0,0.9880696);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.850086);
   mainFit1037->SetParError(1,0.03417421);
