...
//=========  (Wed Apr 21 17:51:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.62083);
   Graph_Graph01031->SetMaximum(52.74584);
   ...
   mainFit1032->SetChisquare(0.317163);
   ...
   mainFit1032->SetParameter(0,-1.171214);
   mainFit1032->SetParError(0,1.084786);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8420306);
   mainFit1032->SetParError(1,0.03223034);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.106");
   pt_LaTex = pt->AddText("0.842#pm0.0322");
   pt_LaTex = pt->AddText("#minus1.17#pm 1.08");
   pt_LaTex = pt->AddText("#minus1.39#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.39094,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.39094,-54.62083,1.39094,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.317163);
   ...
   mainFit1033->SetParameter(0,-1.171214);
   mainFit1033->SetParError(0,1.084786);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8420306);
   mainFit1033->SetParError(1,0.03223034);
