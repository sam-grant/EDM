...
//=========  (Wed Apr 21 23:35:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.29146);
   Graph_Graph01029->SetMaximum(63.10203);
   ...
   mainFit1030->SetChisquare(3.530888);
   ...
   mainFit1030->SetParameter(0,-0.8685494);
   mainFit1030->SetParError(0,0.9641682);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9676405);
   mainFit1030->SetParError(1,0.02941331);
   ...
   pt_LaTex = pt->AddText("0.968#pm0.0294");
   pt_LaTex = pt->AddText("#minus0.869#pm0.964");
   pt_LaTex = pt->AddText("#minus0.898#pm0.994");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8975951,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8975951,-63.29146,0.8975951,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.530888);
   ...
   mainFit1031->SetParameter(0,-0.8685494);
   mainFit1031->SetParError(0,0.9641682);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9676405);
   mainFit1031->SetParError(1,0.02941331);
