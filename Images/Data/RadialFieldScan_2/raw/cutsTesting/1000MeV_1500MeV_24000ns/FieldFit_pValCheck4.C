...
//=========  (Wed Apr 21 23:35:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.29146);
   Graph_Graph01033->SetMaximum(63.10203);
   ...
   mainFit1034->SetChisquare(4.050552);
   ...
   mainFit1034->SetParameter(0,-0.6101944);
   mainFit1034->SetParError(0,1.111466);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9697314);
   mainFit1034->SetParError(1,0.03667543);
   ...
   pt_LaTex = pt->AddText(" 0.97#pm0.0367");
   pt_LaTex = pt->AddText("#minus0.61#pm 1.11");
   pt_LaTex = pt->AddText("#minus0.629#pm 1.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6292406,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6292406,-63.29146,0.6292406,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.050552);
   ...
   mainFit1035->SetParameter(0,-0.6101944);
   mainFit1035->SetParError(0,1.111466);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9697314);
   mainFit1035->SetParError(1,0.03667543);
