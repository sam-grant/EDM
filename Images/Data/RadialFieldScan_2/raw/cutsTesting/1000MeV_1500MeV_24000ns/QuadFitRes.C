...
//=========  (Wed Apr 21 23:35:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02601693);
   Graph_Graph11015->SetMaximum(0.07658751);
   ...
   Graph_Graph21016->SetMinimum(-0.02812895);
   Graph_Graph21016->SetMaximum(0.0332159);
   ...
   Graph_Graph31017->SetMinimum(-0.01288149);
   Graph_Graph31017->SetMaximum(0.009743488);
   ...
   Graph_Graph41018->SetMinimum(-0.04519246);
   Graph_Graph41018->SetMaximum(0.06065653);
   ...
   Graph_Graph51019->SetMinimum(-0.008608881);
   Graph_Graph51019->SetMaximum(0.01152013);
