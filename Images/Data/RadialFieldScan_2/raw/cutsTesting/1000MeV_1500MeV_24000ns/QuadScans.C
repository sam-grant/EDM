...
//=========  (Wed Apr 21 23:35:55 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.989948);
   ...
   quadLineFit1002->SetParameter(0,74.06479);
   quadLineFit1002->SetParError(0,0.1352704);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,50.29982);
   quadLineFit1002->SetParError(1,2.269415);
   ...
   quadLineFit1003->SetChisquare(1.989948);
   ...
   quadLineFit1003->SetParameter(0,74.06479);
   quadLineFit1003->SetParError(0,0.1352704);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,50.29982);
   quadLineFit1003->SetParError(1,2.269415);
   ...
   Graph_30_ppm1003->SetMinimum(75.54013);
   Graph_30_ppm1003->SetMaximum(76.22312);
   ...
   quadLineFit1004->SetChisquare(3.712311);
   ...
   quadLineFit1004->SetParameter(0,74.33156);
   quadLineFit1004->SetParError(0,0.113859);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.54736);
   quadLineFit1004->SetParError(1,1.871191);
   ...
   quadLineFit1005->SetChisquare(3.712311);
   ...
   quadLineFit1005->SetParameter(0,74.33156);
   quadLineFit1005->SetParError(0,0.113859);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.54736);
   quadLineFit1005->SetParError(1,1.871191);
   ...
   Graph_10_ppm1005->SetMinimum(74.57115);
   Graph_10_ppm1005->SetMaximum(74.91346);
   ...
   quadLineFit1006->SetChisquare(2.107667);
   ...
   quadLineFit1006->SetParameter(0,74.07232);
   quadLineFit1006->SetParError(0,0.1332086);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.51726);
   quadLineFit1006->SetParError(1,2.160675);
   ...
   quadLineFit1007->SetChisquare(2.107667);
   ...
   quadLineFit1007->SetParameter(0,74.07232);
   quadLineFit1007->SetParError(0,0.1332086);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.51726);
   quadLineFit1007->SetParError(1,2.160675);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.32426);
   Graph_mI10_ppm1007->SetMaximum(73.63448);
   ...
   quadLineFit1008->SetChisquare(0.2416734);
   ...
   quadLineFit1008->SetParameter(0,74.09936);
   quadLineFit1008->SetParError(0,0.117016);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.16142);
   quadLineFit1008->SetParError(1,1.904794);
   ...
   quadLineFit1009->SetChisquare(0.2416734);
   ...
   quadLineFit1009->SetParameter(0,74.09936);
   quadLineFit1009->SetParError(0,0.117016);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.16142);
   quadLineFit1009->SetParError(1,1.904794);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.83531);
   Graph_mI30_ppm1009->SetMaximum(72.63886);
   ...
   quadLineFit1010->SetChisquare(4.878846);
   ...
   quadLineFit1010->SetParameter(0,74.09075);
   quadLineFit1010->SetParError(0,0.1106295);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.64446);
   quadLineFit1010->SetParError(1,1.91465);
   ...
   quadLineFit1011->SetChisquare(4.878846);
   ...
   quadLineFit1011->SetParameter(0,74.09075);
   quadLineFit1011->SetParError(0,0.1106295);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.64446);
   quadLineFit1011->SetParError(1,1.91465);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.9033);
   Graph_mI50_ppm1011->SetMaximum(71.6346);
   ...
   quadLineFit1012->SetChisquare(0.2260789);
   ...
   quadLineFit1012->SetParameter(0,74.05266);
   quadLineFit1012->SetParError(0,0.2233386);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.76271);
   quadLineFit1012->SetParError(1,3.995964);
   ...
   quadLineFit1013->SetChisquare(0.2260789);
   ...
   quadLineFit1013->SetParameter(0,74.05266);
   quadLineFit1013->SetParError(0,0.2233386);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.76271);
   quadLineFit1013->SetParError(1,3.995964);
