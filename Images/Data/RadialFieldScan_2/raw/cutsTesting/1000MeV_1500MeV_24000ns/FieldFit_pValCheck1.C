...
//=========  (Wed Apr 21 23:35:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.29146);
   Graph_Graph01027->SetMaximum(63.10203);
   ...
   mainFit1028->SetChisquare(0.1216157);
   ...
   mainFit1028->SetParameter(0,0.2894038);
   mainFit1028->SetParError(0,0.9930103);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9982085);
   mainFit1028->SetParError(1,0.03276259);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0405");
   pt_LaTex = pt->AddText("0.998#pm0.0328");
   pt_LaTex = pt->AddText("0.289#pm0.993");
   pt_LaTex = pt->AddText(" 0.29#pm0.994");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2899232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2899232,-63.29146,-0.2899232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1216157);
   ...
   mainFit1029->SetParameter(0,0.2894038);
   mainFit1029->SetParError(0,0.9930103);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9982085);
   mainFit1029->SetParError(1,0.03276259);
