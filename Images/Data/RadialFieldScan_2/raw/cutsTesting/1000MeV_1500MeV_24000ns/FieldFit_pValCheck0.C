...
//=========  (Wed Apr 21 23:35:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.80298,50,47.46286);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.77639);
   Graph_Graph01025->SetMaximum(35.43627);
   ...
   mainFit1026->SetChisquare(1.802278);
   ...
   mainFit1026->SetParameter(0,-1.129716);
   mainFit1026->SetParError(0,0.9556894);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9333565);
   mainFit1026->SetParError(1,0.03785248);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.601");
   pt_LaTex = pt->AddText("0.933#pm0.0379");
   pt_LaTex = pt->AddText("#minus1.13#pm0.956");
   pt_LaTex = pt->AddText("#minus1.21#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.21038,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.21038,-60.77639,1.21038,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.802278);
   ...
   mainFit1027->SetParameter(0,-1.129716);
   mainFit1027->SetParError(0,0.9556894);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9333565);
   mainFit1027->SetParError(1,0.03785248);
