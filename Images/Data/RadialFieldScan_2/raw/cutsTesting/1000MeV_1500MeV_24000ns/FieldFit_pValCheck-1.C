...
//=========  (Wed Apr 21 23:35:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.29146);
   Graph_Graph01023->SetMaximum(63.10203);
   ...
   mainFit1024->SetChisquare(4.051011);
   ...
   mainFit1024->SetParameter(0,-0.5958443);
   mainFit1024->SetParError(0,0.8869233);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9692596);
   mainFit1024->SetParError(1,0.02932768);
   ...
   mainFit1025->SetChisquare(4.051011);
   ...
   mainFit1025->SetParameter(0,-0.5958443);
   mainFit1025->SetParError(0,0.8869233);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9692596);
   mainFit1025->SetParError(1,0.02932768);
