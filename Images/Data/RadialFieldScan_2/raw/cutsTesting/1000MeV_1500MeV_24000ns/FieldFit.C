...
//=========  (Wed Apr 21 23:35:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.29146);
   Graph_Graph01020->SetMaximum(63.10203);
   ...
   mainFit1021->SetChisquare(4.051011);
   ...
   mainFit1021->SetParameter(0,-0.5958443);
   mainFit1021->SetParError(0,0.8869233);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9692596);
   mainFit1021->SetParError(1,0.02932768);
   ...
   pt_LaTex = pt->AddText("0.969#pm0.0293");
   pt_LaTex = pt->AddText("#minus0.596#pm0.887");
   pt_LaTex = pt->AddText("#minus0.615#pm0.912");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6147416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6147416,-63.29146,0.6147416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.051011);
   ...
   mainFit1022->SetParameter(0,-0.5958443);
   mainFit1022->SetParError(0,0.8869233);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9692596);
   mainFit1022->SetParError(1,0.02932768);
