...
//=========  (Wed Apr 21 23:35:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-52.5912,70,73.60133);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.97195);
   Graph_Graph01035->SetMaximum(60.98207);
   ...
   mainFit1036->SetChisquare(4.044059);
   ...
   mainFit1036->SetParameter(0,-0.6192242);
   mainFit1036->SetParError(0,0.9301915);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9703676);
   mainFit1036->SetParError(1,0.03219735);
   ...
   pt_LaTex = pt->AddText(" 0.97#pm0.0322");
   pt_LaTex = pt->AddText("#minus0.619#pm 0.93");
   pt_LaTex = pt->AddText("#minus0.638#pm0.953");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6381336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6381336,-39.97195,0.6381336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.044059);
   ...
   mainFit1037->SetParameter(0,-0.6192242);
   mainFit1037->SetParError(0,0.9301915);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9703676);
   mainFit1037->SetParError(1,0.03219735);
