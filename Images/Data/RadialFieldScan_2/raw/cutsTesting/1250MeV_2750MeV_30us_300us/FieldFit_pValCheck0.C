...
//=========  (Wed Apr 28 15:17:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.31331,50,40.74012);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.20796);
   Graph_Graph01025->SetMaximum(30.63478);
   ...
   mainFit1026->SetChisquare(1.740981);
   ...
   mainFit1026->SetParameter(0,-0.1872288);
   mainFit1026->SetParError(0,0.5844815);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7916948);
   mainFit1026->SetParError(1,0.02315002);
   ...
   pt_LaTex = pt->AddText("0.792#pm0.0232");
   pt_LaTex = pt->AddText("#minus0.187#pm0.584");
   pt_LaTex = pt->AddText("#minus0.236#pm0.739");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.2364911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2364911,-50.20796,0.2364911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.740981);
   ...
   mainFit1027->SetParameter(0,-0.1872288);
   mainFit1027->SetParError(0,0.5844815);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7916948);
   mainFit1027->SetParError(1,0.02315002);
