...
//=========  (Wed Apr 28 15:17:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.08305,70,58.94265);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.98048);
   Graph_Graph01035->SetMaximum(48.84008);
   ...
   mainFit1036->SetChisquare(1.995933);
   ...
   mainFit1036->SetParameter(0,0.02675898);
   mainFit1036->SetParError(0,0.5695148);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7977733);
   mainFit1036->SetParError(1,0.01983217);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.665");
   pt_LaTex = pt->AddText("0.798#pm0.0198");
   pt_LaTex = pt->AddText("0.0268#pm 0.57");
   pt_LaTex = pt->AddText("0.0335#pm0.714");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.03354209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.03354209,-31.98048,-0.03354209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.995933);
   ...
   mainFit1037->SetParameter(0,0.02675898);
   mainFit1037->SetParError(0,0.5695148);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7977733);
   mainFit1037->SetParError(1,0.01983217);
