...
//=========  (Wed Apr 28 15:17:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.02868);
   Graph_Graph01027->SetMaximum(50.66264);
   ...
   mainFit1028->SetChisquare(0.2830399);
   ...
   mainFit1028->SetParameter(0,0.336851);
   mainFit1028->SetParError(0,0.6103114);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8138914);
   mainFit1028->SetParError(1,0.0202653);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0943");
   pt_LaTex = pt->AddText("0.814#pm0.0203");
   pt_LaTex = pt->AddText("0.337#pm 0.61");
   pt_LaTex = pt->AddText("0.414#pm0.749");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4138771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4138771,-52.02868,-0.4138771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2830399);
   ...
   mainFit1029->SetParameter(0,0.336851);
   mainFit1029->SetParError(0,0.6103114);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8138914);
   mainFit1029->SetParError(1,0.0202653);
