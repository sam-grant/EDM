...
//=========  (Wed Apr 28 15:17:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.02868);
   Graph_Graph01023->SetMaximum(50.66264);
   ...
   mainFit1024->SetChisquare(2.174782);
   ...
   mainFit1024->SetParameter(0,-0.04538149);
   mainFit1024->SetParError(0,0.5433677);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8012409);
   mainFit1024->SetParError(1,0.01805776);
   ...
   mainFit1025->SetChisquare(2.174782);
   ...
   mainFit1025->SetParameter(0,-0.04538149);
   mainFit1025->SetParError(0,0.5433677);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8012409);
   mainFit1025->SetParError(1,0.01805776);
