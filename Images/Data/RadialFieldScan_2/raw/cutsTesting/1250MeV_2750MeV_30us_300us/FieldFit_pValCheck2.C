...
//=========  (Wed Apr 28 15:17:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.02868);
   Graph_Graph01029->SetMaximum(50.66264);
   ...
   mainFit1030->SetChisquare(1.45698);
   ...
   mainFit1030->SetParameter(0,-0.2425075);
   mainFit1030->SetParError(0,0.5910895);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8000043);
   mainFit1030->SetParError(1,0.01811652);
   ...
   pt_LaTex = pt->AddText("  0.8#pm0.0181");
   pt_LaTex = pt->AddText("#minus0.243#pm0.591");
   pt_LaTex = pt->AddText("#minus0.303#pm0.738");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3031328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3031328,-52.02868,0.3031328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.45698);
   ...
   mainFit1031->SetParameter(0,-0.2425075);
   mainFit1031->SetParError(0,0.5910895);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8000043);
   mainFit1031->SetParError(1,0.01811652);
