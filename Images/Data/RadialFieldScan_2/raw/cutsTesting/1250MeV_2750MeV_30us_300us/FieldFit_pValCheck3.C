...
//=========  (Wed Apr 28 15:17:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.02868);
   Graph_Graph01031->SetMaximum(50.66264);
   ...
   mainFit1032->SetChisquare(2.119007);
   ...
   mainFit1032->SetParameter(0,-0.1187061);
   mainFit1032->SetParError(0,0.6258158);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8023671);
   mainFit1032->SetParError(1,0.01867681);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.706");
   pt_LaTex = pt->AddText("0.802#pm0.0187");
   pt_LaTex = pt->AddText("#minus0.119#pm0.626");
   pt_LaTex = pt->AddText("#minus0.148#pm0.779");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1479449,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1479449,-52.02868,0.1479449,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.119007);
   ...
   mainFit1033->SetParameter(0,-0.1187061);
   mainFit1033->SetParError(0,0.6258158);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8023671);
   mainFit1033->SetParError(1,0.01867681);
