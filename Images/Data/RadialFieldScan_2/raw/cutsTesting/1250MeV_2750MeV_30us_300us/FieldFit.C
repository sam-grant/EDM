...
//=========  (Wed Apr 28 15:17:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.02868);
   Graph_Graph01020->SetMaximum(50.66264);
   ...
   mainFit1021->SetChisquare(2.174782);
   ...
   mainFit1021->SetParameter(0,-0.04538149);
   mainFit1021->SetParError(0,0.5433677);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8012409);
   mainFit1021->SetParError(1,0.01805776);
   ...
   pt_LaTex = pt->AddText("0.801#pm0.0181");
   pt_LaTex = pt->AddText("#minus0.0454#pm0.543");
   pt_LaTex = pt->AddText("#minus0.0566#pm0.678");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.05663902,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.05663902,-52.02868,0.05663902,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.174782);
   ...
   mainFit1022->SetParameter(0,-0.04538149);
   mainFit1022->SetParError(0,0.5433677);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8012409);
   mainFit1022->SetParError(1,0.01805776);
