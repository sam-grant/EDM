...
//=========  (Wed Apr 28 15:17:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-64.8651,75,63.49906);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-52.02868);
   Graph_Graph01033->SetMaximum(50.66264);
   ...
   mainFit1034->SetChisquare(2.174675);
   ...
   mainFit1034->SetParameter(0,-0.04959799);
   mainFit1034->SetParError(0,0.6800085);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8013807);
   mainFit1034->SetParError(1,0.02258072);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.725");
   pt_LaTex = pt->AddText("0.801#pm0.0226");
   pt_LaTex = pt->AddText("#minus0.0496#pm 0.68");
   pt_LaTex = pt->AddText("#minus0.0619#pm0.848");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.06189067,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.06189067,-52.02868,0.06189067,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.174675);
   ...
   mainFit1035->SetParameter(0,-0.04959799);
   mainFit1035->SetParError(0,0.6800085);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8013807);
   mainFit1035->SetParError(1,0.02258072);
