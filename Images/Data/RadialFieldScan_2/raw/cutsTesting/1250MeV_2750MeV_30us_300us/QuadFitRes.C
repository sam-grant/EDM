...
//=========  (Wed Apr 28 15:17:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02553563);
   Graph_Graph11015->SetMaximum(0.05443711);
   ...
   Graph_Graph21016->SetMinimum(-0.001252413);
   Graph_Graph21016->SetMaximum(0.001474584);
   ...
   Graph_Graph31017->SetMinimum(-0.04218377);
   Graph_Graph31017->SetMaximum(0.03628315);
   ...
   Graph_Graph41018->SetMinimum(-0.004255283);
   Graph_Graph41018->SetMaximum(0.005295256);
   ...
   Graph_Graph51019->SetMinimum(-0.01465229);
   Graph_Graph51019->SetMaximum(0.01957253);
