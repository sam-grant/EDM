...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.46314);
   Graph_Graph01033->SetMaximum(54.62412);
   ...
   mainFit1034->SetChisquare(5.364513);
   ...
   mainFit1034->SetParameter(0,-0.9721951);
   mainFit1034->SetParError(0,0.5815841);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8727132);
   mainFit1034->SetParError(1,0.01918104);
   ...
   pt_LaTex = pt->AddText("0.873#pm0.0192");
   pt_LaTex = pt->AddText("#minus0.972#pm0.582");
   pt_LaTex = pt->AddText("#minus1.11#pm0.655");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.113991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.113991,-55.46314,1.113991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.364513);
   ...
   mainFit1035->SetParameter(0,-0.9721951);
   mainFit1035->SetParError(0,0.5815841);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8727132);
   mainFit1035->SetParError(1,0.01918104);
