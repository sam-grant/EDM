...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.46314);
   Graph_Graph01020->SetMaximum(54.62412);
   ...
   mainFit1021->SetChisquare(5.63104);
   ...
   mainFit1021->SetParameter(0,-0.791256);
   mainFit1021->SetParError(0,0.4641171);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8667689);
   mainFit1021->SetParError(1,0.01534064);
   ...
   mainFit1022->SetChisquare(5.63104);
   ...
   mainFit1022->SetParameter(0,-0.791256);
   mainFit1022->SetParError(0,0.4641171);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8667689);
   mainFit1022->SetParError(1,0.01534064);
