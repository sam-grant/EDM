...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.46314);
   Graph_Graph01031->SetMaximum(54.62412);
   ...
   mainFit1032->SetChisquare(5.62175);
   ...
   mainFit1032->SetParameter(0,-0.7656861);
   mainFit1032->SetParError(0,0.5345811);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.866374);
   mainFit1032->SetParError(1,0.01587827);
   ...
   pt_LaTex = pt->AddText("0.866#pm0.0159");
   pt_LaTex = pt->AddText("#minus0.766#pm0.535");
   pt_LaTex = pt->AddText("#minus0.884#pm0.613");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8837824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8837824,-55.46314,0.8837824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.62175);
   ...
   mainFit1033->SetParameter(0,-0.7656861);
   mainFit1033->SetParError(0,0.5345811);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.866374);
   mainFit1033->SetParError(1,0.01587827);
