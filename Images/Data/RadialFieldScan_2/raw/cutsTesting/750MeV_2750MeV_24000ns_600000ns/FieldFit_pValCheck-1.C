...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.46314);
   Graph_Graph01023->SetMaximum(54.62412);
   ...
   mainFit1024->SetChisquare(5.63104);
   ...
   mainFit1024->SetParameter(0,-0.791256);
   mainFit1024->SetParError(0,0.4641171);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8667689);
   mainFit1024->SetParError(1,0.01534064);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.0153");
   pt_LaTex = pt->AddText("#minus0.791#pm0.464");
   pt_LaTex = pt->AddText("#minus0.913#pm0.533");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.91288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.91288,-55.46314,0.91288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.63104);
   ...
   mainFit1025->SetParameter(0,-0.791256);
   mainFit1025->SetParError(0,0.4641171);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8667689);
   mainFit1025->SetParError(1,0.01534064);
