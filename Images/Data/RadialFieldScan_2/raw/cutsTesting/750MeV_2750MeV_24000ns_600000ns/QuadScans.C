...
//=========  (Mon Apr 26 22:44:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.283728);
   ...
   quadLineFit1002->SetParameter(0,74.53068);
   quadLineFit1002->SetParError(0,0.07071393);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.26403);
   quadLineFit1002->SetParError(1,1.186148);
   ...
   quadLineFit1003->SetChisquare(1.283728);
   ...
   quadLineFit1003->SetParameter(0,74.53068);
   quadLineFit1003->SetParError(0,0.07071393);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.26403);
   quadLineFit1003->SetParError(1,1.186148);
   ...
   Graph_30_ppm1003->SetMinimum(75.78334);
   Graph_30_ppm1003->SetMaximum(76.36939);
   ...
   quadLineFit1004->SetChisquare(3.33337);
   ...
   quadLineFit1004->SetParameter(0,74.63363);
   quadLineFit1004->SetParError(0,0.05954265);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.45133);
   quadLineFit1004->SetParError(1,0.9786248);
   ...
   quadLineFit1005->SetChisquare(3.33337);
   ...
   quadLineFit1005->SetParameter(0,74.63363);
   quadLineFit1005->SetParError(0,0.05954265);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.45133);
   quadLineFit1005->SetParError(1,0.9786248);
   ...
   Graph_10_ppm1005->SetMinimum(74.81822);
   Graph_10_ppm1005->SetMaximum(75.06239);
   ...
   quadLineFit1006->SetChisquare(0.6302883);
   ...
   quadLineFit1006->SetParameter(0,74.422);
   quadLineFit1006->SetParError(0,0.0697433);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.324704);
   quadLineFit1006->SetParError(1,1.131099);
   ...
   quadLineFit1007->SetChisquare(0.6302883);
   ...
   quadLineFit1007->SetParameter(0,74.422);
   quadLineFit1007->SetParError(0,0.0697433);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.324704);
   quadLineFit1007->SetParError(1,1.131099);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.64193);
   Graph_mI10_ppm1007->SetMaximum(73.93793);
   ...
   quadLineFit1008->SetChisquare(6.613784);
   ...
   quadLineFit1008->SetParameter(0,74.36445);
   quadLineFit1008->SetParError(0,0.06124172);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.541395);
   quadLineFit1008->SetParError(1,0.9968174);
   ...
   quadLineFit1009->SetChisquare(6.613784);
   ...
   quadLineFit1009->SetParameter(0,74.36445);
   quadLineFit1009->SetParError(0,0.06124172);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.541395);
   quadLineFit1009->SetParError(1,0.9968174);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29974);
   Graph_mI30_ppm1009->SetMaximum(72.97613);
   ...
   quadLineFit1010->SetChisquare(3.552455);
   ...
   quadLineFit1010->SetParameter(0,74.27484);
   quadLineFit1010->SetParError(0,0.0579202);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.42616);
   quadLineFit1010->SetParError(1,1.002406);
   ...
   quadLineFit1011->SetChisquare(3.552455);
   ...
   quadLineFit1011->SetParameter(0,74.27484);
   quadLineFit1011->SetParError(0,0.0579202);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.42616);
   quadLineFit1011->SetParError(1,1.002406);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38506);
   Graph_mI50_ppm1011->SetMaximum(72.01891);
   ...
   quadLineFit1012->SetChisquare(0.7597714);
   ...
   quadLineFit1012->SetParameter(0,74.22438);
   quadLineFit1012->SetParError(0,0.1168232);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.1989);
   quadLineFit1012->SetParError(1,2.090304);
   ...
   quadLineFit1013->SetChisquare(0.7597714);
   ...
   quadLineFit1013->SetParameter(0,74.22438);
   quadLineFit1013->SetParError(0,0.1168232);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.1989);
   quadLineFit1013->SetParError(1,2.090304);
