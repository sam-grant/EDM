...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.46314);
   Graph_Graph01029->SetMaximum(54.62412);
   ...
   mainFit1030->SetChisquare(5.442086);
   ...
   mainFit1030->SetParameter(0,-0.8771971);
   mainFit1030->SetParError(0,0.5044765);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8662608);
   mainFit1030->SetParError(1,0.01538488);
   ...
   pt_LaTex = pt->AddText("0.866#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.877#pm0.504");
   pt_LaTex = pt->AddText("#minus1.01#pm0.581");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.012625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.012625,-55.46314,1.012625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.442086);
   ...
   mainFit1031->SetParameter(0,-0.8771971);
   mainFit1031->SetParError(0,0.5044765);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8662608);
   mainFit1031->SetParError(1,0.01538488);
