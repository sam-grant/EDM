...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.96899,50,42.10975);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.36112);
   Graph_Graph01025->SetMaximum(31.50187);
   ...
   mainFit1026->SetChisquare(1.527573);
   ...
   mainFit1026->SetParameter(0,-1.168544);
   mainFit1026->SetParError(0,0.5000941);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.841396);
   mainFit1026->SetParError(1,0.01980462);
   ...
   pt_LaTex = pt->AddText("0.841#pm0.0198");
   pt_LaTex = pt->AddText("#minus1.17#pm  0.5");
   pt_LaTex = pt->AddText("#minus1.39#pm0.599");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.388816,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.388816,-53.36112,1.388816,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.527573);
   ...
   mainFit1027->SetParameter(0,-1.168544);
   mainFit1027->SetParError(0,0.5000941);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.841396);
   mainFit1027->SetParError(1,0.01980462);
