...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.64826,70,63.66987);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.71644);
   Graph_Graph01035->SetMaximum(52.73805);
   ...
   mainFit1036->SetChisquare(5.629653);
   ...
   mainFit1036->SetParameter(0,-0.785782);
   mainFit1036->SetParError(0,0.4868235);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8665098);
   mainFit1036->SetParError(1,0.01684327);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.786#pm0.487");
   pt_LaTex = pt->AddText("#minus0.907#pm0.557");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.9068356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9068356,-34.71644,0.9068356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.629653);
   ...
   mainFit1037->SetParameter(0,-0.785782);
   mainFit1037->SetParError(0,0.4868235);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8665098);
   mainFit1037->SetParError(1,0.01684327);
