...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02027402);
   Graph_Graph11015->SetMaximum(0.02690468);
   ...
   Graph_Graph21016->SetMinimum(-0.008055778);
   Graph_Graph21016->SetMaximum(0.009488893);
   ...
   Graph_Graph31017->SetMinimum(-0.0346988);
   Graph_Graph31017->SetMaximum(0.02628483);
   ...
   Graph_Graph41018->SetMinimum(-0.0160668);
   Graph_Graph41018->SetMaximum(0.02067685);
   ...
   Graph_Graph51019->SetMinimum(-0.008263794);
   Graph_Graph51019->SetMaximum(0.01104826);
