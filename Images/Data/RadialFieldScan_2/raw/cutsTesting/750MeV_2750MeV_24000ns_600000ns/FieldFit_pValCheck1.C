...
//=========  (Mon Apr 26 22:44:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.22405,75,68.38502);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.46314);
   Graph_Graph01027->SetMaximum(54.62412);
   ...
   mainFit1028->SetChisquare(0.4618002);
   ...
   mainFit1028->SetParameter(0,-0.2601619);
   mainFit1028->SetParError(0,0.5195864);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8841193);
   mainFit1028->SetParError(1,0.01713394);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.154");
   pt_LaTex = pt->AddText("0.884#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.26#pm 0.52");
   pt_LaTex = pt->AddText("#minus0.294#pm0.588");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2942611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2942611,-55.46314,0.2942611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4618002);
   ...
   mainFit1029->SetParameter(0,-0.2601619);
   mainFit1029->SetParError(0,0.5195864);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8841193);
   mainFit1029->SetParError(1,0.01713394);
