...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.14283);
   Graph_Graph01031->SetMaximum(55.7564);
   ...
   mainFit1032->SetChisquare(4.043846);
   ...
   mainFit1032->SetParameter(0,-1.816978);
   mainFit1032->SetParError(0,0.4312923);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9194496);
   mainFit1032->SetParError(1,0.01290095);
   ...
   pt_LaTex = pt->AddText("#minus1.82#pm0.431");
   pt_LaTex = pt->AddText("#minus1.98#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.976158,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.976158,-60.14283,1.976158,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.043846);
   ...
   mainFit1033->SetParameter(0,-1.816978);
   mainFit1033->SetParError(0,0.4312923);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9194496);
   mainFit1033->SetParError(1,0.01290095);
