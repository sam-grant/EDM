...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.00218044);
   Graph_Graph11015->SetMaximum(0.006796007);
   ...
   Graph_Graph21016->SetMinimum(-0.008558186);
   Graph_Graph21016->SetMaximum(0.01005657);
   ...
   Graph_Graph31017->SetMinimum(-0.0227882);
   Graph_Graph31017->SetMaximum(0.01662021);
   ...
   Graph_Graph41018->SetMinimum(-0.0106143);
   Graph_Graph41018->SetMaximum(0.009102672);
   ...
   Graph_Graph51019->SetMinimum(-0.002469949);
   Graph_Graph51019->SetMaximum(0.003299899);
