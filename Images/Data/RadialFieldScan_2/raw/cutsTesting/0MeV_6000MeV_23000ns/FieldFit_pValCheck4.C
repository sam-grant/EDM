...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.14283);
   Graph_Graph01033->SetMaximum(55.7564);
   ...
   mainFit1034->SetChisquare(3.428166);
   ...
   mainFit1034->SetParameter(0,-2.13628);
   mainFit1034->SetParError(0,0.4685929);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9287053);
   mainFit1034->SetParError(1,0.01560871);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0156");
   pt_LaTex = pt->AddText("#minus2.14#pm0.469");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.488");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.300278,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.300278,-60.14283,2.300278,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.428166);
   ...
   mainFit1035->SetParameter(0,-2.13628);
   mainFit1035->SetParError(0,0.4685929);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9287053);
   mainFit1035->SetParError(1,0.01560871);
