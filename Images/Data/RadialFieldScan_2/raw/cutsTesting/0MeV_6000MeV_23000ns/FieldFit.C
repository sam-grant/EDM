...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.14283);
   Graph_Graph01020->SetMaximum(55.7564);
   ...
   mainFit1021->SetChisquare(4.171963);
   ...
   mainFit1021->SetParameter(0,-1.893478);
   mainFit1021->SetParError(0,0.3745995);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9206173);
   mainFit1021->SetParError(1,0.01247968);
   ...
   mainFit1022->SetChisquare(4.171963);
   ...
   mainFit1022->SetParameter(0,-1.893478);
   mainFit1022->SetParError(0,0.3745995);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9206173);
   mainFit1022->SetParError(1,0.01247968);
