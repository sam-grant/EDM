...
//=========  (Wed Apr 21 15:51:47 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8634562);
   ...
   quadLineFit1002->SetParameter(0,74.47877);
   quadLineFit1002->SetParError(0,0.05872377);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.11276);
   quadLineFit1002->SetParError(1,0.9853778);
   ...
   quadLineFit1003->SetChisquare(0.8634562);
   ...
   quadLineFit1003->SetParameter(0,74.47877);
   quadLineFit1003->SetParError(0,0.05872377);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.11276);
   quadLineFit1003->SetParError(1,0.9853778);
   ...
   Graph_30_ppm1003->SetMinimum(75.7371);
   Graph_30_ppm1003->SetMaximum(76.36017);
   ...
   quadLineFit1004->SetChisquare(0.1671031);
   ...
   quadLineFit1004->SetParameter(0,74.54041);
   quadLineFit1004->SetParError(0,0.04795147);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.60734);
   quadLineFit1004->SetParError(1,0.7880149);
   ...
   quadLineFit1005->SetChisquare(0.1671031);
   ...
   quadLineFit1005->SetParameter(0,74.54041);
   quadLineFit1005->SetParError(0,0.04795147);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.60734);
   quadLineFit1005->SetParError(1,0.7880149);
   ...
   Graph_10_ppm1005->SetMinimum(74.74947);
   Graph_10_ppm1005->SetMaximum(74.97636);
   ...
   quadLineFit1006->SetChisquare(1.095045);
   ...
   quadLineFit1006->SetParameter(0,74.36945);
   quadLineFit1006->SetParError(0,0.05617772);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.916849);
   quadLineFit1006->SetParError(1,0.9109952);
   ...
   quadLineFit1007->SetChisquare(1.095045);
   ...
   quadLineFit1007->SetParameter(0,74.36945);
   quadLineFit1007->SetParError(0,0.05617772);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.916849);
   quadLineFit1007->SetParError(1,0.9109952);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50656);
   Graph_mI10_ppm1007->SetMaximum(73.82921);
   ...
   quadLineFit1008->SetChisquare(4.697523);
   ...
   quadLineFit1008->SetParameter(0,74.35814);
   quadLineFit1008->SetParError(0,0.04932958);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.34632);
   quadLineFit1008->SetParError(1,0.8028646);
   ...
   quadLineFit1009->SetChisquare(4.697523);
   ...
   quadLineFit1009->SetParameter(0,74.35814);
   quadLineFit1009->SetParError(0,0.04932958);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.34632);
   quadLineFit1009->SetParError(1,0.8028646);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.1327);
   Graph_mI30_ppm1009->SetMaximum(72.85708);
   ...
   quadLineFit1010->SetChisquare(0.9142084);
   ...
   quadLineFit1010->SetParameter(0,74.27825);
   quadLineFit1010->SetParError(0,0.04658852);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.01827);
   quadLineFit1010->SetParError(1,0.8062788);
   ...
   quadLineFit1011->SetChisquare(0.9142084);
   ...
   quadLineFit1011->SetParameter(0,74.27825);
   quadLineFit1011->SetParError(0,0.04658852);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.01827);
   quadLineFit1011->SetParError(1,0.8062788);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20001);
   Graph_mI50_ppm1011->SetMaximum(71.88863);
   ...
   quadLineFit1012->SetChisquare(0.1047881);
   ...
   quadLineFit1012->SetParameter(0,74.32381);
   quadLineFit1012->SetParError(0,0.09408705);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.80107);
   quadLineFit1012->SetParError(1,1.683492);
   ...
   quadLineFit1013->SetChisquare(0.1047881);
   ...
   quadLineFit1013->SetParameter(0,74.32381);
   quadLineFit1013->SetParError(0,0.09408705);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.80107);
   quadLineFit1013->SetParError(1,1.683492);
