...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.14283);
   Graph_Graph01029->SetMaximum(55.7564);
   ...
   mainFit1030->SetChisquare(3.641415);
   ...
   mainFit1030->SetParameter(0,-2.010609);
   mainFit1030->SetParError(0,0.4076529);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9198632);
   mainFit1030->SetParError(1,0.01252286);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0125");
   pt_LaTex = pt->AddText("#minus2.01#pm0.408");
   pt_LaTex = pt->AddText("#minus2.19#pm0.441");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.185769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.185769,-60.14283,2.185769,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.641415);
   ...
   mainFit1031->SetParameter(0,-2.010609);
   mainFit1031->SetParError(0,0.4076529);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9198632);
   mainFit1031->SetParError(1,0.01252286);
