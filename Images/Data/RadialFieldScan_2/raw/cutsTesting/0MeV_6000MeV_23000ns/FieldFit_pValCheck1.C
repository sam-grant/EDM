...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-60.14283);
   Graph_Graph01027->SetMaximum(55.7564);
   ...
   mainFit1028->SetChisquare(0.9030621);
   ...
   mainFit1028->SetParameter(0,-1.544161);
   mainFit1028->SetParError(0,0.4214955);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9322457);
   mainFit1028->SetParError(1,0.01403978);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.301");
   pt_LaTex = pt->AddText("0.932#pm0.014");
   pt_LaTex = pt->AddText("#minus1.54#pm0.421");
   pt_LaTex = pt->AddText("#minus1.66#pm0.455");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.656389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.656389,-60.14283,1.656389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.9030621);
   ...
   mainFit1029->SetParameter(0,-1.544161);
   mainFit1029->SetParError(0,0.4214955);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9322457);
   mainFit1029->SetParError(1,0.01403978);
