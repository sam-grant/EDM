...
//=========  (Wed Apr 21 15:51:48 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.80522,70,65.0788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.41682);
   Graph_Graph01035->SetMaximum(53.6904);
   ...
   mainFit1036->SetChisquare(3.828145);
   ...
   mainFit1036->SetParameter(0,-1.824804);
   mainFit1036->SetParError(0,0.3924855);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9172929);
   mainFit1036->SetParError(1,0.01370911);
   ...
   pt_LaTex = pt->AddText("#minus1.82#pm0.392");
   pt_LaTex = pt->AddText("#minus1.99#pm0.421");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.989336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.989336,-37.41682,1.989336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.828145);
   ...
   mainFit1037->SetParameter(0,-1.824804);
   mainFit1037->SetParError(0,0.3924855);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9172929);
   mainFit1037->SetParError(1,0.01370911);
