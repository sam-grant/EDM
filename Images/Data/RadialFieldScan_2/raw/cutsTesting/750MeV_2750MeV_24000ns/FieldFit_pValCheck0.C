...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.84282,50,41.59552);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.29898);
   Graph_Graph01025->SetMaximum(31.05168);
   ...
   mainFit1026->SetChisquare(1.360413);
   ...
   mainFit1026->SetParameter(0,-1.506253);
   mainFit1026->SetParError(0,0.4997806);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8378411);
   mainFit1026->SetParError(1,0.0197969);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.0198");
   pt_LaTex = pt->AddText("#minus1.51#pm  0.5");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.797778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.797778,-53.29898,1.797778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.360413);
   ...
   mainFit1027->SetParameter(0,-1.506253);
   mainFit1027->SetParError(0,0.4997806);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8378411);
   mainFit1027->SetParError(1,0.0197969);
