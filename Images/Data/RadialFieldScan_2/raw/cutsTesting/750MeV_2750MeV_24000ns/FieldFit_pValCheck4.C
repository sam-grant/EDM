...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.38824);
   Graph_Graph01033->SetMaximum(54.03348);
   ...
   mainFit1034->SetChisquare(5.436321);
   ...
   mainFit1034->SetParameter(0,-1.288229);
   mainFit1034->SetParError(0,0.5811388);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8700715);
   mainFit1034->SetParError(1,0.01893704);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0189");
   pt_LaTex = pt->AddText("#minus1.29#pm0.581");
   pt_LaTex = pt->AddText("#minus1.48#pm0.653");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.480601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.480601,-55.38824,1.480601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.436321);
   ...
   mainFit1035->SetParameter(0,-1.288229);
   mainFit1035->SetParError(0,0.5811388);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8700715);
   mainFit1035->SetParError(1,0.01893704);
