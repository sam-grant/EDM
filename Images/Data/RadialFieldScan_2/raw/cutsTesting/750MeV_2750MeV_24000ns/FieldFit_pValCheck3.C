...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.38824);
   Graph_Graph01031->SetMaximum(54.03348);
   ...
   mainFit1032->SetChisquare(5.668292);
   ...
   mainFit1032->SetParameter(0,-1.075833);
   mainFit1032->SetParError(0,0.5328238);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8638106);
   mainFit1032->SetParError(1,0.0156926);
   ...
   pt_LaTex = pt->AddText("0.864#pm0.0157");
   pt_LaTex = pt->AddText("#minus1.08#pm0.533");
   pt_LaTex = pt->AddText("#minus1.25#pm0.611");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.245451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.245451,-55.38824,1.245451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.668292);
   ...
   mainFit1033->SetParameter(0,-1.075833);
   mainFit1033->SetParError(0,0.5328238);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8638106);
   mainFit1033->SetParError(1,0.0156926);
