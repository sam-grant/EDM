...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.83859,70,63.06572);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.94816);
   Graph_Graph01035->SetMaximum(52.17529);
   ...
   mainFit1036->SetChisquare(5.68023);
   ...
   mainFit1036->SetParameter(0,-1.124208);
   mainFit1036->SetParError(0,0.4856169);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8649365);
   mainFit1036->SetParError(1,0.01660495);
   ...
   pt_LaTex = pt->AddText("0.865#pm0.0166");
   pt_LaTex = pt->AddText("#minus1.12#pm0.486");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.555");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.299758,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.299758,-34.94816,1.299758,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.68023);
   ...
   mainFit1037->SetParameter(0,-1.124208);
   mainFit1037->SetParError(0,0.4856169);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8649365);
   mainFit1037->SetParError(1,0.01660495);
