...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01901017);
   Graph_Graph11015->SetMaximum(0.02376477);
   ...
   Graph_Graph21016->SetMinimum(-0.008830845);
   Graph_Graph21016->SetMaximum(0.01039915);
   ...
   Graph_Graph31017->SetMinimum(-0.03346055);
   Graph_Graph31017->SetMaximum(0.02552512);
   ...
   Graph_Graph41018->SetMinimum(-0.01659874);
   Graph_Graph41018->SetMaximum(0.02209772);
   ...
   Graph_Graph51019->SetMinimum(-0.008179428);
   Graph_Graph51019->SetMaximum(0.01093526);
