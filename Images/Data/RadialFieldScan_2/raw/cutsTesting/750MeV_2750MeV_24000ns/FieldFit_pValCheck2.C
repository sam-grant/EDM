...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.38824);
   Graph_Graph01029->SetMaximum(54.03348);
   ...
   mainFit1030->SetChisquare(5.544265);
   ...
   mainFit1030->SetParameter(0,-1.185743);
   mainFit1030->SetParError(0,0.5019449);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8639876);
   mainFit1030->SetParError(1,0.01517303);
   ...
   pt_LaTex = pt->AddText("0.864#pm0.0152");
   pt_LaTex = pt->AddText("#minus1.19#pm0.502");
   pt_LaTex = pt->AddText("#minus1.37#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.372407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.372407,-55.38824,1.372407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.544265);
   ...
   mainFit1031->SetParameter(0,-1.185743);
   mainFit1031->SetParError(0,0.5019449);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8639876);
   mainFit1031->SetParError(1,0.01517303);
