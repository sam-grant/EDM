...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.38824);
   Graph_Graph01020->SetMaximum(54.03348);
   ...
   mainFit1021->SetChisquare(5.68699);
   ...
   mainFit1021->SetParameter(0,-1.112023);
   mainFit1021->SetParError(0,0.462449);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8643756);
   mainFit1021->SetParError(1,0.01513883);
   ...
   pt_LaTex = pt->AddText("0.864#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.11#pm0.462");
   pt_LaTex = pt->AddText("#minus1.29#pm0.531");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.286504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.286504,-55.38824,1.286504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.68699);
   ...
   mainFit1022->SetParameter(0,-1.112023);
   mainFit1022->SetParError(0,0.462449);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8643756);
   mainFit1022->SetParError(1,0.01513883);
