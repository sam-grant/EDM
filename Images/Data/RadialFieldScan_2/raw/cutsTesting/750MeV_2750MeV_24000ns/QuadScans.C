...
//=========  (Mon Apr 26 21:36:09 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.550425);
   ...
   quadLineFit1002->SetParameter(0,74.54998);
   quadLineFit1002->SetParError(0,0.06812803);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.77291);
   quadLineFit1002->SetParError(1,1.142089);
   ...
   quadLineFit1003->SetChisquare(1.550425);
   ...
   quadLineFit1003->SetParameter(0,74.54998);
   quadLineFit1003->SetParError(0,0.06812803);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.77291);
   quadLineFit1003->SetParError(1,1.142089);
   ...
   Graph_30_ppm1003->SetMinimum(75.77896);
   Graph_30_ppm1003->SetMaximum(76.35611);
   ...
   quadLineFit1004->SetChisquare(2.856631);
   ...
   quadLineFit1004->SetParameter(0,74.64961);
   quadLineFit1004->SetParError(0,0.05950304);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.04454);
   quadLineFit1004->SetParError(1,0.9779192);
   ...
   quadLineFit1005->SetChisquare(2.856631);
   ...
   quadLineFit1005->SetParameter(0,74.64961);
   quadLineFit1005->SetParError(0,0.05950304);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.04454);
   quadLineFit1005->SetParError(1,0.9779192);
   ...
   Graph_10_ppm1005->SetMinimum(74.81395);
   Graph_10_ppm1005->SetMaximum(75.0487);
   ...
   quadLineFit1006->SetChisquare(0.7586858);
   ...
   quadLineFit1006->SetParameter(0,74.43712);
   quadLineFit1006->SetParError(0,0.06969278);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.921689);
   quadLineFit1006->SetParError(1,1.130223);
   ...
   quadLineFit1007->SetChisquare(0.7586858);
   ...
   quadLineFit1007->SetParameter(0,74.43712);
   quadLineFit1007->SetParError(0,0.06969278);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.921689);
   quadLineFit1007->SetParError(1,1.130223);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.6309);
   Graph_mI10_ppm1007->SetMaximum(73.9339);
   ...
   quadLineFit1008->SetChisquare(6.127782);
   ...
   quadLineFit1008->SetParameter(0,74.37743);
   quadLineFit1008->SetParError(0,0.06121092);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.872687);
   quadLineFit1008->SetParError(1,0.9962629);
   ...
   quadLineFit1009->SetChisquare(6.127782);
   ...
   quadLineFit1009->SetParameter(0,74.37743);
   quadLineFit1009->SetParError(0,0.06121092);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.872687);
   quadLineFit1009->SetParError(1,0.9962629);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.28966);
   Graph_mI30_ppm1009->SetMaximum(72.97201);
   ...
   quadLineFit1010->SetChisquare(3.930664);
   ...
   quadLineFit1010->SetParameter(0,74.28417);
   quadLineFit1010->SetParError(0,0.05788639);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.6861);
   quadLineFit1010->SetParError(1,1.001774);
   ...
   quadLineFit1011->SetChisquare(3.930664);
   ...
   quadLineFit1011->SetParameter(0,74.28417);
   quadLineFit1011->SetParError(0,0.05788639);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.6861);
   quadLineFit1011->SetParError(1,1.001774);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38092);
   Graph_mI50_ppm1011->SetMaximum(72.01448);
   ...
   quadLineFit1012->SetChisquare(0.7450083);
   ...
   quadLineFit1012->SetParameter(0,74.21883);
   quadLineFit1012->SetParError(0,0.1169181);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.17774);
   quadLineFit1012->SetParError(1,2.092017);
   ...
   quadLineFit1013->SetChisquare(0.7450083);
   ...
   quadLineFit1013->SetParameter(0,74.21883);
   quadLineFit1013->SetParError(0,0.1169181);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.17774);
   quadLineFit1013->SetParError(1,2.092017);
