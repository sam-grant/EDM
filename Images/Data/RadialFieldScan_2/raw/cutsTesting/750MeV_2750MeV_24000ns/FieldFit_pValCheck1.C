...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.06595,75,67.71119);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.38824);
   Graph_Graph01027->SetMaximum(54.03348);
   ...
   mainFit1028->SetChisquare(0.5292779);
   ...
   mainFit1028->SetParameter(0,-0.5986822);
   mainFit1028->SetParError(0,0.5147341);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8807513);
   mainFit1028->SetParError(1,0.01676834);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.176");
   pt_LaTex = pt->AddText("0.881#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.599#pm0.515");
   pt_LaTex = pt->AddText("#minus0.68#pm0.585");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6797403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6797403,-55.38824,0.6797403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5292779);
   ...
   mainFit1029->SetParameter(0,-0.5986822);
   mainFit1029->SetParError(0,0.5147341);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8807513);
   mainFit1029->SetParError(1,0.01676834);
