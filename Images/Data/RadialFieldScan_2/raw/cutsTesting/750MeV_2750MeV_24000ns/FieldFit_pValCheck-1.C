...
//=========  (Mon Apr 26 21:36:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.38824);
   Graph_Graph01023->SetMaximum(54.03348);
   ...
   mainFit1024->SetChisquare(5.68699);
   ...
   mainFit1024->SetParameter(0,-1.112023);
   mainFit1024->SetParError(0,0.462449);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8643756);
   mainFit1024->SetParError(1,0.01513883);
   ...
   mainFit1025->SetChisquare(5.68699);
   ...
   mainFit1025->SetParameter(0,-1.112023);
   mainFit1025->SetParError(0,0.462449);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8643756);
   mainFit1025->SetParError(1,0.01513883);
