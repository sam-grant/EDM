...
//=========  (Fri Apr 23 21:10:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1026022);
   Graph_Graph11015->SetMaximum(0.03454792);
   ...
   Graph_Graph21016->SetMinimum(-0.07806715);
   Graph_Graph21016->SetMaximum(0.09140393);
   ...
   Graph_Graph31017->SetMinimum(-0.04933221);
   Graph_Graph31017->SetMaximum(0.04500043);
   ...
   Graph_Graph41018->SetMinimum(-0.1296221);
   Graph_Graph41018->SetMaximum(0.07700396);
   ...
   Graph_Graph51019->SetMinimum(-0.007082365);
   Graph_Graph51019->SetMaximum(0.009419663);
