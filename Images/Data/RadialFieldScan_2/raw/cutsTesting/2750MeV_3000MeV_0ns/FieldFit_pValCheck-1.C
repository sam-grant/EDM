...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.05377);
   Graph_Graph01023->SetMaximum(53.57927);
   ...
   mainFit1024->SetChisquare(1.06832);
   ...
   mainFit1024->SetParameter(0,-1.834799);
   mainFit1024->SetParError(0,1.456964);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8652684);
   mainFit1024->SetParError(1,0.04804456);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.267");
   pt_LaTex = pt->AddText("0.865#pm0.048");
   pt_LaTex = pt->AddText("#minus1.83#pm 1.46");
   pt_LaTex = pt->AddText("#minus2.12#pm 1.67");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.120497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.120497,-60.05377,2.120497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.06832);
   ...
   mainFit1025->SetParameter(0,-1.834799);
   mainFit1025->SetParError(0,1.456964);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8652684);
   mainFit1025->SetParError(1,0.04804456);
