...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-60.05377);
   Graph_Graph01027->SetMaximum(53.57927);
   ...
   mainFit1028->SetChisquare(0.5324324);
   ...
   mainFit1028->SetParameter(0,-2.374914);
   mainFit1028->SetParError(0,1.633113);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8477279);
   mainFit1028->SetParError(1,0.05369078);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.177");
   pt_LaTex = pt->AddText("0.848#pm0.0537");
   pt_LaTex = pt->AddText("#minus2.37#pm 1.63");
   pt_LaTex = pt->AddText(" #minus2.8#pm 1.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.801505,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.801505,-60.05377,2.801505,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5324324);
   ...
   mainFit1029->SetParameter(0,-2.374914);
   mainFit1029->SetParError(0,1.633113);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8477279);
   mainFit1029->SetParError(1,0.05369078);
