...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.05377);
   Graph_Graph01031->SetMaximum(53.57927);
   ...
   mainFit1032->SetChisquare(0.8738813);
   ...
   mainFit1032->SetParameter(0,-2.201916);
   mainFit1032->SetParError(0,1.678038);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8709326);
   mainFit1032->SetParError(1,0.04972829);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.291");
   pt_LaTex = pt->AddText("0.871#pm0.0497");
   pt_LaTex = pt->AddText(" #minus2.2#pm 1.68");
   pt_LaTex = pt->AddText("#minus2.53#pm 1.89");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.528228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.528228,-60.05377,2.528228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.8738813);
   ...
   mainFit1033->SetParameter(0,-2.201916);
   mainFit1033->SetParError(0,1.678038);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8709326);
   mainFit1033->SetParError(1,0.04972829);
