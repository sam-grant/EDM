...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.05377);
   Graph_Graph01029->SetMaximum(53.57927);
   ...
   mainFit1030->SetChisquare(0.5577189);
   ...
   mainFit1030->SetParameter(0,-1.397227);
   mainFit1030->SetParError(0,1.580432);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8678217);
   mainFit1030->SetParError(1,0.04817664);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0482");
   pt_LaTex = pt->AddText(" #minus1.4#pm 1.58");
   pt_LaTex = pt->AddText("#minus1.61#pm 1.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.61004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.61004,-60.05377,1.61004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.5577189);
   ...
   mainFit1031->SetParameter(0,-1.397227);
   mainFit1031->SetParError(0,1.580432);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8678217);
   mainFit1031->SetParError(1,0.04817664);
