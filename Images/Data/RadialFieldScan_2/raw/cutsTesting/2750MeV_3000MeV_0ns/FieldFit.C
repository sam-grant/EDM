...
//=========  (Fri Apr 23 21:10:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.05377);
   Graph_Graph01020->SetMaximum(53.57927);
   ...
   mainFit1021->SetChisquare(1.06832);
   ...
   mainFit1021->SetParameter(0,-1.834799);
   mainFit1021->SetParError(0,1.456964);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8652684);
   mainFit1021->SetParError(1,0.04804456);
   ...
   mainFit1022->SetChisquare(1.06832);
   ...
   mainFit1022->SetParameter(0,-1.834799);
   mainFit1022->SetParError(0,1.456964);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8652684);
   mainFit1022->SetParError(1,0.04804456);
