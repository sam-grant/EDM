...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-70.46735,50,48.83066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.53755);
   Graph_Graph01025->SetMaximum(36.90086);
   ...
   mainFit1026->SetChisquare(0.9168509);
   ...
   mainFit1026->SetParameter(0,-1.606961);
   mainFit1026->SetParError(0,1.570324);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8805188);
   mainFit1026->SetParError(1,0.06202716);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.306");
   pt_LaTex = pt->AddText("0.881#pm0.062");
   pt_LaTex = pt->AddText("#minus1.61#pm 1.57");
   pt_LaTex = pt->AddText("#minus1.83#pm  1.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.825017,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.825017,-58.53755,1.825017,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.9168509);
   ...
   mainFit1027->SetParameter(0,-1.606961);
   mainFit1027->SetParError(0,1.570324);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8805188);
   mainFit1027->SetParError(1,0.06202716);
