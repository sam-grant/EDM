...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.65661,70,63.06314);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.28463);
   Graph_Graph01035->SetMaximum(51.69116);
   ...
   mainFit1036->SetChisquare(1.034254);
   ...
   mainFit1036->SetParameter(0,-1.919993);
   mainFit1036->SetParError(0,1.528298);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8692866);
   mainFit1036->SetParError(1,0.05273233);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.345");
   pt_LaTex = pt->AddText("0.869#pm0.0527");
   pt_LaTex = pt->AddText("#minus1.92#pm 1.53");
   pt_LaTex = pt->AddText("#minus2.21#pm 1.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.2087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.2087,-39.28463,2.2087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.034254);
   ...
   mainFit1037->SetParameter(0,-1.919993);
   mainFit1037->SetParError(0,1.528298);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8692866);
   mainFit1037->SetParError(1,0.05273233);
