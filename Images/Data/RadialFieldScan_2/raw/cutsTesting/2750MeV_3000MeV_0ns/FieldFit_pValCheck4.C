...
//=========  (Fri Apr 23 21:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.05377);
   Graph_Graph01033->SetMaximum(53.57927);
   ...
   mainFit1034->SetChisquare(0.948694);
   ...
   mainFit1034->SetParameter(0,-1.452511);
   mainFit1034->SetParError(0,1.828813);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8527655);
   mainFit1034->SetParError(1,0.06013653);
   ...
   pt_LaTex = pt->AddText("0.853#pm0.0601");
   pt_LaTex = pt->AddText("#minus1.45#pm 1.83");
   pt_LaTex = pt->AddText(" #minus1.7#pm 2.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.703295,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.703295,-60.05377,1.703295,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.948694);
   ...
   mainFit1035->SetParameter(0,-1.452511);
   mainFit1035->SetParError(0,1.828813);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8527655);
   mainFit1035->SetParError(1,0.06013653);
