...
//=========  (Fri Apr 23 21:10:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.052761);
   ...
   quadLineFit1002->SetParameter(0,75.46996);
   quadLineFit1002->SetParError(0,0.2215365);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.39694);
   quadLineFit1002->SetParError(1,3.712904);
   ...
   quadLineFit1003->SetChisquare(4.052761);
   ...
   quadLineFit1003->SetParameter(0,75.46996);
   quadLineFit1003->SetParError(0,0.2215365);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.39694);
   quadLineFit1003->SetParError(1,3.712904);
   ...
   Graph_30_ppm1003->SetMinimum(76.47108);
   Graph_30_ppm1003->SetMaximum(77.21877);
   ...
   quadLineFit1004->SetChisquare(2.483676);
   ...
   quadLineFit1004->SetParameter(0,75.23953);
   quadLineFit1004->SetParError(0,0.1861573);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.89069);
   quadLineFit1004->SetParError(1,3.056968);
   ...
   quadLineFit1005->SetChisquare(2.483676);
   ...
   quadLineFit1005->SetParameter(0,75.23953);
   quadLineFit1005->SetParError(0,0.1861573);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.89069);
   quadLineFit1005->SetParError(1,3.056968);
   ...
   Graph_10_ppm1005->SetMinimum(75.61118);
   Graph_10_ppm1005->SetMaximum(75.93793);
   ...
   quadLineFit1006->SetChisquare(6.048008);
   ...
   quadLineFit1006->SetParameter(0,75.45958);
   quadLineFit1006->SetParError(0,0.221542);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,4.473897);
   quadLineFit1006->SetParError(1,3.589794);
   ...
   quadLineFit1007->SetChisquare(6.048008);
   ...
   quadLineFit1007->SetParameter(0,75.45958);
   quadLineFit1007->SetParError(0,0.221542);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,4.473897);
   quadLineFit1007->SetParError(1,3.589794);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.51697);
   Graph_mI10_ppm1007->SetMaximum(74.89791);
   ...
   quadLineFit1008->SetChisquare(1.605882);
   ...
   quadLineFit1008->SetParameter(0,75.26808);
   quadLineFit1008->SetParError(0,0.1924423);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.302899);
   quadLineFit1008->SetParError(1,3.130376);
   ...
   quadLineFit1009->SetChisquare(1.605882);
   ...
   quadLineFit1009->SetParameter(0,75.26808);
   quadLineFit1009->SetParError(0,0.1924423);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.302899);
   quadLineFit1009->SetParError(1,3.130376);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.20622);
   Graph_mI30_ppm1009->SetMaximum(73.95578);
   ...
   quadLineFit1010->SetChisquare(5.193312);
   ...
   quadLineFit1010->SetParameter(0,75.30576);
   quadLineFit1010->SetParError(0,0.1815617);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.56419);
   quadLineFit1010->SetParError(1,3.139132);
   ...
   quadLineFit1011->SetChisquare(5.193312);
   ...
   quadLineFit1011->SetParameter(0,75.30576);
   quadLineFit1011->SetParError(0,0.1815617);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.56419);
   quadLineFit1011->SetParError(1,3.139132);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.28056);
   Graph_mI50_ppm1011->SetMaximum(72.99695);
   ...
   quadLineFit1012->SetChisquare(0.05596681);
   ...
   quadLineFit1012->SetParameter(0,75.15332);
   quadLineFit1012->SetParError(0,0.3669127);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.02179);
   quadLineFit1012->SetParError(1,6.562557);
   ...
   quadLineFit1013->SetChisquare(0.05596681);
   ...
   quadLineFit1013->SetParameter(0,75.15332);
   quadLineFit1013->SetParError(0,0.3669127);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.02179);
   quadLineFit1013->SetParError(1,6.562557);
