...
//=========  (Thu Apr 22 10:08:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0156772);
   Graph_Graph11015->SetMaximum(0.01518611);
   ...
   Graph_Graph21016->SetMinimum(-0.01005772);
   Graph_Graph21016->SetMaximum(0.01183434);
   ...
   Graph_Graph31017->SetMinimum(-0.05315741);
   Graph_Graph31017->SetMaximum(0.0388356);
   ...
   Graph_Graph41018->SetMinimum(-0.01315274);
   Graph_Graph41018->SetMaximum(0.007431524);
   ...
   Graph_Graph51019->SetMinimum(-0.01130069);
   Graph_Graph51019->SetMaximum(0.0151003);
