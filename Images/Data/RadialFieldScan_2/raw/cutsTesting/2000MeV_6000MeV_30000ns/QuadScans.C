...
//=========  (Thu Apr 22 10:08:35 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.407509);
   ...
   quadLineFit1002->SetParameter(0,75.1122);
   quadLineFit1002->SetParError(0,0.1083348);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.28956);
   quadLineFit1002->SetParError(1,1.816981);
   ...
   quadLineFit1003->SetChisquare(2.407509);
   ...
   quadLineFit1003->SetParameter(0,75.1122);
   quadLineFit1003->SetParError(0,0.1083348);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.28956);
   quadLineFit1003->SetParError(1,1.816981);
   ...
   Graph_30_ppm1003->SetMinimum(76.18276);
   Graph_30_ppm1003->SetMaximum(76.75244);
   ...
   quadLineFit1004->SetChisquare(0.6275644);
   ...
   quadLineFit1004->SetParameter(0,75.13549);
   quadLineFit1004->SetParError(0,0.09112608);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.59058);
   quadLineFit1004->SetParError(1,1.498037);
   ...
   quadLineFit1005->SetChisquare(0.6275644);
   ...
   quadLineFit1005->SetParameter(0,75.13549);
   quadLineFit1005->SetParError(0,0.09112608);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.59058);
   quadLineFit1005->SetParError(1,1.498037);
   ...
   Graph_10_ppm1005->SetMinimum(75.26097);
   Graph_10_ppm1005->SetMaximum(75.53545);
   ...
   quadLineFit1006->SetChisquare(0.4177922);
   ...
   quadLineFit1006->SetParameter(0,74.85606);
   quadLineFit1006->SetParError(0,0.1068501);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.677893);
   quadLineFit1006->SetParError(1,1.732959);
   ...
   quadLineFit1007->SetChisquare(0.4177922);
   ...
   quadLineFit1007->SetParameter(0,74.85606);
   quadLineFit1007->SetParError(0,0.1068501);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.677893);
   quadLineFit1007->SetParError(1,1.732959);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.25613);
   Graph_mI10_ppm1007->SetMaximum(74.52185);
   ...
   quadLineFit1008->SetChisquare(7.063793);
   ...
   quadLineFit1008->SetParameter(0,74.79721);
   quadLineFit1008->SetParError(0,0.09374276);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.869145);
   quadLineFit1008->SetParError(1,1.525879);
   ...
   quadLineFit1009->SetChisquare(7.063793);
   ...
   quadLineFit1009->SetParameter(0,74.79721);
   quadLineFit1009->SetParError(0,0.09374276);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.869145);
   quadLineFit1009->SetParError(1,1.525879);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.00173);
   Graph_mI30_ppm1009->SetMaximum(73.60225);
   ...
   quadLineFit1010->SetChisquare(0.2173064);
   ...
   quadLineFit1010->SetParameter(0,74.70533);
   quadLineFit1010->SetParError(0,0.0887468);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.84049);
   quadLineFit1010->SetParError(1,1.53604);
   ...
   quadLineFit1011->SetChisquare(0.2173064);
   ...
   quadLineFit1011->SetParameter(0,74.70533);
   quadLineFit1011->SetParError(0,0.0887468);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.84049);
   quadLineFit1011->SetParError(1,1.53604);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.15941);
   Graph_mI50_ppm1011->SetMaximum(72.6997);
   ...
   quadLineFit1012->SetChisquare(0.6041385);
   ...
   quadLineFit1012->SetParameter(0,74.47204);
   quadLineFit1012->SetParError(0,0.1790883);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.70849);
   quadLineFit1012->SetParError(1,3.204023);
   ...
   quadLineFit1013->SetChisquare(0.6041385);
   ...
   quadLineFit1013->SetParameter(0,74.47204);
   quadLineFit1013->SetParError(0,0.1790883);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.70849);
   quadLineFit1013->SetParError(1,3.204023);
