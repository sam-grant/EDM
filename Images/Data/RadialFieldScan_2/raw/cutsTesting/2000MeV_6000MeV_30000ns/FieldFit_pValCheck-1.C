...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-46.91441);
   Graph_Graph01023->SetMaximum(49.10844);
   ...
   mainFit1024->SetChisquare(1.961478);
   ...
   mainFit1024->SetParameter(0,0.3876803);
   mainFit1024->SetParError(0,0.7108739);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7542481);
   mainFit1024->SetParError(1,0.02350057);
   ...
   pt_LaTex = pt->AddText("0.754#pm0.0235");
   pt_LaTex = pt->AddText("0.388#pm0.711");
   pt_LaTex = pt->AddText("0.514#pm0.945");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.5139957,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.5139957,-46.91441,-0.5139957,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.961478);
   ...
   mainFit1025->SetParameter(0,0.3876803);
   mainFit1025->SetParError(0,0.7108739);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7542481);
   mainFit1025->SetParError(1,0.02350057);
