...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-46.91441);
   Graph_Graph01029->SetMaximum(49.10844);
   ...
   mainFit1030->SetChisquare(1.737544);
   ...
   mainFit1030->SetParameter(0,0.2444695);
   mainFit1030->SetParError(0,0.7726303);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7534);
   mainFit1030->SetParError(1,0.02356802);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.579");
   pt_LaTex = pt->AddText("0.753#pm0.0236");
   pt_LaTex = pt->AddText("0.244#pm0.773");
   pt_LaTex = pt->AddText("0.324#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3244884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3244884,-46.91441,-0.3244884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.737544);
   ...
   mainFit1031->SetParameter(0,0.2444695);
   mainFit1031->SetParError(0,0.7726303);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7534);
   mainFit1031->SetParError(1,0.02356802);
