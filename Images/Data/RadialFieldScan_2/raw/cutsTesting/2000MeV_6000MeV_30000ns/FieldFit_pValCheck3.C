...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-46.91441);
   Graph_Graph01031->SetMaximum(49.10844);
   ...
   mainFit1032->SetChisquare(1.91386);
   ...
   mainFit1032->SetParameter(0,0.2989265);
   mainFit1032->SetParError(0,0.8190021);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7556201);
   mainFit1032->SetParError(1,0.02432706);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.638");
   pt_LaTex = pt->AddText("0.756#pm0.0243");
   pt_LaTex = pt->AddText("0.299#pm0.819");
   pt_LaTex = pt->AddText("0.396#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3956042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3956042,-46.91441,-0.3956042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.91386);
   ...
   mainFit1033->SetParameter(0,0.2989265);
   mainFit1033->SetParError(0,0.8190021);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7556201);
   mainFit1033->SetParError(1,0.02432706);
