...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-58.91727,75,61.1113);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-46.91441);
   Graph_Graph01033->SetMaximum(49.10844);
   ...
   mainFit1034->SetChisquare(1.659386);
   ...
   mainFit1034->SetParameter(0,0.6826504);
   mainFit1034->SetParError(0,0.8907059);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7445548);
   mainFit1034->SetParError(1,0.02938214);
   ...
   pt_LaTex = pt->AddText("0.745#pm0.0294");
   pt_LaTex = pt->AddText("0.683#pm0.891");
   pt_LaTex = pt->AddText("0.917#pm 1.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9168572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9168572,-46.91441,-0.9168572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.659386);
   ...
   mainFit1035->SetParameter(0,0.6826504);
   mainFit1035->SetParError(0,0.8907059);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7445548);
   mainFit1035->SetParError(1,0.02938214);
