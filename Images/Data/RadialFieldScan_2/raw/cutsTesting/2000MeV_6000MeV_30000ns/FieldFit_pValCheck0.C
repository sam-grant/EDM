...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-54.41279,50,38.58889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-45.11262);
   Graph_Graph01025->SetMaximum(29.28872);
   ...
   mainFit1026->SetChisquare(1.122369);
   ...
   mainFit1026->SetParameter(0,0.1266774);
   mainFit1026->SetParError(0,0.7658463);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7366752);
   mainFit1026->SetParError(1,0.03033445);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.374");
   pt_LaTex = pt->AddText("0.737#pm0.0303");
   pt_LaTex = pt->AddText("0.127#pm0.766");
   pt_LaTex = pt->AddText("0.172#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.1719583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1719583,-45.11262,-0.1719583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.122369);
   ...
   mainFit1027->SetParameter(0,0.1266774);
   mainFit1027->SetParError(0,0.7658463);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7366752);
   mainFit1027->SetParError(1,0.03033445);
