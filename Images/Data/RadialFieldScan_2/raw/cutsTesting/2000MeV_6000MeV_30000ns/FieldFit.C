...
//=========  (Thu Apr 22 10:08:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-46.91441);
   Graph_Graph01020->SetMaximum(49.10844);
   ...
   mainFit1021->SetChisquare(1.961478);
   ...
   mainFit1021->SetParameter(0,0.3876803);
   mainFit1021->SetParError(0,0.7108739);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7542481);
   mainFit1021->SetParError(1,0.02350057);
   ...
   mainFit1022->SetChisquare(1.961478);
   ...
   mainFit1022->SetParameter(0,0.3876803);
   mainFit1022->SetParError(0,0.7108739);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7542481);
   mainFit1022->SetParError(1,0.02350057);
