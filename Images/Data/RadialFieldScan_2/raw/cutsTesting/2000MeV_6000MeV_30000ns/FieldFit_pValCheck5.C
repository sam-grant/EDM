...
//=========  (Thu Apr 22 10:08:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.7473,70,57.47731);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.92484);
   Graph_Graph01035->SetMaximum(47.65485);
   ...
   mainFit1036->SetChisquare(1.639339);
   ...
   mainFit1036->SetParameter(0,0.259977);
   mainFit1036->SetParError(0,0.7456314);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7602916);
   mainFit1036->SetParError(1,0.02580029);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.546");
   pt_LaTex = pt->AddText(" 0.76#pm0.0258");
   pt_LaTex = pt->AddText(" 0.26#pm0.746");
   pt_LaTex = pt->AddText("0.342#pm0.984");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.3419438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3419438,-30.92484,-0.3419438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.639339);
   ...
   mainFit1037->SetParameter(0,0.259977);
   mainFit1037->SetParError(0,0.7456314);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7602916);
   mainFit1037->SetParError(1,0.02580029);
