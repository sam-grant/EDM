...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.09314);
   Graph_Graph01027->SetMaximum(56.61899);
   ...
   mainFit1028->SetChisquare(1.508859);
   ...
   mainFit1028->SetParameter(0,-1.668007);
   mainFit1028->SetParError(0,0.4574443);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9463756);
   mainFit1028->SetParError(1,0.0150792);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.67#pm0.457");
   pt_LaTex = pt->AddText("#minus1.76#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.762521,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.762521,-61.09314,1.762521,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.508859);
   ...
   mainFit1029->SetParameter(0,-1.668007);
   mainFit1029->SetParError(0,0.4574443);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9463756);
   mainFit1029->SetParError(1,0.0150792);
