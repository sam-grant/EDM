...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007095834);
   Graph_Graph11015->SetMaximum(0.01699364);
   ...
   Graph_Graph21016->SetMinimum(-0.008684328);
   Graph_Graph21016->SetMaximum(0.01019734);
   ...
   Graph_Graph31017->SetMinimum(-0.01704053);
   Graph_Graph31017->SetMaximum(0.01379197);
   ...
   Graph_Graph41018->SetMinimum(-0.005777991);
   Graph_Graph41018->SetMaximum(0.006919473);
   ...
   Graph_Graph51019->SetMinimum(-0.002046202);
   Graph_Graph51019->SetMaximum(0.002733329);
