...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.09314);
   Graph_Graph01031->SetMaximum(56.61899);
   ...
   mainFit1032->SetChisquare(2.558628);
   ...
   mainFit1032->SetParameter(0,-1.745597);
   mainFit1032->SetParError(0,0.4706142);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.934562);
   mainFit1032->SetParError(1,0.01397581);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.853");
   pt_LaTex = pt->AddText("0.935#pm0.014");
   pt_LaTex = pt->AddText("#minus1.75#pm0.471");
   pt_LaTex = pt->AddText("#minus1.87#pm0.497");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.867824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.867824,-61.09314,1.867824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.558628);
   ...
   mainFit1033->SetParameter(0,-1.745597);
   mainFit1033->SetParError(0,0.4706142);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.934562);
   mainFit1033->SetParError(1,0.01397581);
