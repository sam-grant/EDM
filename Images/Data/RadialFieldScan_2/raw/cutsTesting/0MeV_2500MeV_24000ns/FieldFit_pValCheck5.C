...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.57284,70,66.08614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.00694);
   Graph_Graph01035->SetMaximum(54.52024);
   ...
   mainFit1036->SetChisquare(3.096733);
   ...
   mainFit1036->SetParameter(0,-1.889255);
   mainFit1036->SetParError(0,0.4286059);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9352032);
   mainFit1036->SetParError(1,0.01482298);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.89#pm0.429");
   pt_LaTex = pt->AddText("#minus2.02#pm0.451");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.020154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.020154,-38.00694,2.020154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.096733);
   ...
   mainFit1037->SetParameter(0,-1.889255);
   mainFit1037->SetParError(0,0.4286059);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9352032);
   mainFit1037->SetParError(1,0.01482298);
