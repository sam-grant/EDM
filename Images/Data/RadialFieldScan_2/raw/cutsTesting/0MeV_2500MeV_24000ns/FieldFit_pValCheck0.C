...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.6425,50,45.50973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.02728);
   Graph_Graph01025->SetMaximum(33.8945);
   ...
   mainFit1026->SetChisquare(2.009821);
   ...
   mainFit1026->SetParameter(0,-2.121169);
   mainFit1026->SetParError(0,0.4404842);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9252813);
   mainFit1026->SetParError(1,0.01744234);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0174");
   pt_LaTex = pt->AddText("#minus2.12#pm 0.44");
   pt_LaTex = pt->AddText("#minus2.29#pm0.483");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.292459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.292459,-59.02728,2.292459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.009821);
   ...
   mainFit1027->SetParameter(0,-2.121169);
   mainFit1027->SetParError(0,0.4404842);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9252813);
   mainFit1027->SetParError(1,0.01744234);
