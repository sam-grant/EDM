...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.09314);
   Graph_Graph01020->SetMaximum(56.61899);
   ...
   mainFit1021->SetChisquare(3.242951);
   ...
   mainFit1021->SetParameter(0,-1.938633);
   mainFit1021->SetParError(0,0.4086719);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9375337);
   mainFit1021->SetParError(1,0.01350404);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.0135");
   pt_LaTex = pt->AddText("#minus1.94#pm0.409");
   pt_LaTex = pt->AddText("#minus2.07#pm0.432");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.067801,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.067801,-61.09314,2.067801,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.242951);
   ...
   mainFit1022->SetParameter(0,-1.938633);
   mainFit1022->SetParError(0,0.4086719);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9375337);
   mainFit1022->SetParError(1,0.01350404);
