...
//=========  (Fri Apr 23 11:47:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.09314);
   Graph_Graph01023->SetMaximum(56.61899);
   ...
   mainFit1024->SetChisquare(3.242951);
   ...
   mainFit1024->SetParameter(0,-1.938633);
   mainFit1024->SetParError(0,0.4086719);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9375337);
   mainFit1024->SetParError(1,0.01350404);
   ...
   mainFit1025->SetChisquare(3.242951);
   ...
   mainFit1025->SetParameter(0,-1.938633);
   mainFit1025->SetParError(0,0.4086719);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9375337);
   mainFit1025->SetParError(1,0.01350404);
