...
//=========  (Fri Apr 23 11:47:10 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.541993);
   ...
   quadLineFit1002->SetParameter(0,74.37034);
   quadLineFit1002->SetParError(0,0.06222794);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.76596);
   quadLineFit1002->SetParError(1,1.043686);
   ...
   quadLineFit1003->SetChisquare(0.541993);
   ...
   quadLineFit1003->SetParameter(0,74.37034);
   quadLineFit1003->SetParError(0,0.06222794);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.76596);
   quadLineFit1003->SetParError(1,1.043686);
   ...
   Graph_30_ppm1003->SetMinimum(75.64854);
   Graph_30_ppm1003->SetMaximum(76.28699);
   ...
   quadLineFit1004->SetChisquare(0.9477876);
   ...
   quadLineFit1004->SetParameter(0,74.4178);
   quadLineFit1004->SetParError(0,0.05248238);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.28865);
   quadLineFit1004->SetParError(1,0.862369);
   ...
   quadLineFit1005->SetChisquare(0.9477876);
   ...
   quadLineFit1005->SetParameter(0,74.4178);
   quadLineFit1005->SetParError(0,0.05248238);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.28865);
   quadLineFit1005->SetParError(1,0.862369);
   ...
   Graph_10_ppm1005->SetMinimum(74.65348);
   Graph_10_ppm1005->SetMaximum(74.8863);
   ...
   quadLineFit1006->SetChisquare(0.9423819);
   ...
   quadLineFit1006->SetParameter(0,74.26882);
   quadLineFit1006->SetParError(0,0.06145161);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.038006);
   quadLineFit1006->SetParError(1,0.99643);
   ...
   quadLineFit1007->SetChisquare(0.9423819);
   ...
   quadLineFit1007->SetParameter(0,74.26882);
   quadLineFit1007->SetParError(0,0.06145161);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.038006);
   quadLineFit1007->SetParError(1,0.99643);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.38092);
   Graph_mI10_ppm1007->SetMaximum(73.71592);
   ...
   quadLineFit1008->SetChisquare(2.277744);
   ...
   quadLineFit1008->SetParameter(0,74.27678);
   quadLineFit1008->SetParError(0,0.05396463);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.93762);
   quadLineFit1008->SetParError(1,0.8782114);
   ...
   quadLineFit1009->SetChisquare(2.277744);
   ...
   quadLineFit1009->SetParameter(0,74.27678);
   quadLineFit1009->SetParError(0,0.05396463);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.93762);
   quadLineFit1009->SetParError(1,0.8782114);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.99494);
   Graph_mI30_ppm1009->SetMaximum(72.73808);
   ...
   quadLineFit1010->SetChisquare(0.5564179);
   ...
   quadLineFit1010->SetParameter(0,74.17858);
   quadLineFit1010->SetParError(0,0.05094915);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.41467);
   quadLineFit1010->SetParError(1,0.8816736);
   ...
   quadLineFit1011->SetChisquare(0.5564179);
   ...
   quadLineFit1011->SetParameter(0,74.17858);
   quadLineFit1011->SetParError(0,0.05094915);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.41467);
   quadLineFit1011->SetParError(1,0.8816736);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.06069);
   Graph_mI50_ppm1011->SetMaximum(71.76097);
   ...
   quadLineFit1012->SetChisquare(0.06009134);
   ...
   quadLineFit1012->SetParameter(0,74.22656);
   quadLineFit1012->SetParError(0,0.1029457);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.44179);
   quadLineFit1012->SetParError(1,1.842006);
   ...
   quadLineFit1013->SetChisquare(0.06009134);
   ...
   quadLineFit1013->SetParameter(0,74.22656);
   quadLineFit1013->SetParError(0,0.1029457);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.44179);
   quadLineFit1013->SetParError(1,1.842006);
