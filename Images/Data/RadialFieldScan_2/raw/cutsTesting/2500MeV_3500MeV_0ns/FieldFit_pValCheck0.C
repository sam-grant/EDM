...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.70133,50,43.78239);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.65296);
   Graph_Graph01025->SetMaximum(32.73402);
   ...
   mainFit1026->SetChisquare(2.62058);
   ...
   mainFit1026->SetParameter(0,-2.514802);
   mainFit1026->SetParError(0,0.8550961);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8603043);
   mainFit1026->SetParError(1,0.03384606);
   ...
   pt_LaTex = pt->AddText(" 0.86#pm0.0338");
   pt_LaTex = pt->AddText("#minus2.51#pm0.855");
   pt_LaTex = pt->AddText("#minus2.92#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.923153,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.923153,-55.65296,2.923153,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.62058);
   ...
   mainFit1027->SetParameter(0,-2.514802);
   mainFit1027->SetParError(0,0.8550961);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8603043);
   mainFit1027->SetParError(1,0.03384606);
