...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.60787);
   Graph_Graph01029->SetMaximum(54.23807);
   ...
   mainFit1030->SetChisquare(1.585025);
   ...
   mainFit1030->SetParameter(0,-1.787337);
   mainFit1030->SetParError(0,0.8599653);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8815569);
   mainFit1030->SetParError(1,0.02607871);
   ...
   pt_LaTex = pt->AddText("0.882#pm0.0261");
   pt_LaTex = pt->AddText("#minus1.79#pm 0.86");
   pt_LaTex = pt->AddText("#minus2.03#pm0.969");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.027477,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.027477,-57.60787,2.027477,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.585025);
   ...
   mainFit1031->SetParameter(0,-1.787337);
   mainFit1031->SetParError(0,0.8599653);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8815569);
   mainFit1031->SetParError(1,0.02607871);
