...
//=========  (Wed Apr 21 18:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.60787);
   Graph_Graph01020->SetMaximum(54.23807);
   ...
   mainFit1021->SetChisquare(3.375897);
   ...
   mainFit1021->SetParameter(0,-2.235058);
   mainFit1021->SetParError(0,0.7922114);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8791139);
   mainFit1021->SetParError(1,0.02601507);
   ...
   mainFit1022->SetChisquare(3.375897);
   ...
   mainFit1022->SetParameter(0,-2.235058);
   mainFit1022->SetParError(0,0.7922114);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8791139);
   mainFit1022->SetParError(1,0.02601507);
