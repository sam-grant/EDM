...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.58862,75,68.21882);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-57.60787);
   Graph_Graph01023->SetMaximum(54.23807);
   ...
   mainFit1024->SetChisquare(3.375897);
   ...
   mainFit1024->SetParameter(0,-2.235058);
   mainFit1024->SetParError(0,0.7922114);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8791139);
   mainFit1024->SetParError(1,0.02601507);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.844");
   pt_LaTex = pt->AddText("0.879#pm0.026");
   pt_LaTex = pt->AddText("#minus2.24#pm0.792");
   pt_LaTex = pt->AddText("#minus2.54#pm0.891");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.542398,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.542398,-57.60787,2.542398,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.375897);
   ...
   mainFit1025->SetParameter(0,-2.235058);
   mainFit1025->SetParError(0,0.7922114);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8791139);
   mainFit1025->SetParError(1,0.02601507);
