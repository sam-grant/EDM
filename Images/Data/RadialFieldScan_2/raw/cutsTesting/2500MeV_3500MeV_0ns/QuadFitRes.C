...
//=========  (Wed Apr 21 18:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.07369285);
   Graph_Graph11015->SetMaximum(0.03310182);
   ...
   Graph_Graph21016->SetMinimum(-0.01819565);
   Graph_Graph21016->SetMaximum(0.021299);
   ...
   Graph_Graph31017->SetMinimum(-0.08021221);
   Graph_Graph31017->SetMaximum(0.07344838);
   ...
   Graph_Graph41018->SetMinimum(-0.08304905);
   Graph_Graph41018->SetMaximum(0.0437549);
   ...
   Graph_Graph51019->SetMinimum(-0.006966352);
   Graph_Graph51019->SetMaximum(0.009268378);
