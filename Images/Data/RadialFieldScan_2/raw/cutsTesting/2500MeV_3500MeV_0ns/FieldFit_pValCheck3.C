...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.60787);
   Graph_Graph01031->SetMaximum(54.23807);
   ...
   mainFit1032->SetChisquare(1.90436);
   ...
   mainFit1032->SetParameter(0,-2.784302);
   mainFit1032->SetParError(0,0.9124606);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8876637);
   mainFit1032->SetParError(1,0.02695136);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.635");
   pt_LaTex = pt->AddText("0.888#pm0.027");
   pt_LaTex = pt->AddText("#minus2.78#pm0.912");
   pt_LaTex = pt->AddText("#minus3.14#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.136663,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.136663,-57.60787,3.136663,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.90436);
   ...
   mainFit1033->SetParameter(0,-2.784302);
   mainFit1033->SetParError(0,0.9124606);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8876637);
   mainFit1033->SetParError(1,0.02695136);
