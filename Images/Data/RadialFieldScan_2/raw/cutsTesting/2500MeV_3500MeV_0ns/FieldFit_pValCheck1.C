...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.60787);
   Graph_Graph01027->SetMaximum(54.23807);
   ...
   mainFit1028->SetChisquare(3.266075);
   ...
   mainFit1028->SetParameter(0,-2.105089);
   mainFit1028->SetParError(0,0.884007);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8833002);
   mainFit1028->SetParError(1,0.02891078);
   ...
   pt_LaTex = pt->AddText("0.883#pm0.0289");
   pt_LaTex = pt->AddText("#minus2.11#pm0.884");
   pt_LaTex = pt->AddText("#minus2.38#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.383209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.383209,-57.60787,2.383209,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.266075);
   ...
   mainFit1029->SetParameter(0,-2.105089);
   mainFit1029->SetParError(0,0.884007);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8833002);
   mainFit1029->SetParError(1,0.02891078);
