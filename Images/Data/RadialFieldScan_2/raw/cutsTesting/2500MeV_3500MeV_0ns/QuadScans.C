...
//=========  (Wed Apr 21 18:29:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.214873);
   ...
   quadLineFit1002->SetParameter(0,75.31933);
   quadLineFit1002->SetParError(0,0.1182317);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.93699);
   quadLineFit1002->SetParError(1,1.980589);
   ...
   quadLineFit1003->SetChisquare(1.214873);
   ...
   quadLineFit1003->SetParameter(0,75.31933);
   quadLineFit1003->SetParError(0,0.1182317);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.93699);
   quadLineFit1003->SetParError(1,1.980589);
   ...
   Graph_30_ppm1003->SetMinimum(76.51165);
   Graph_30_ppm1003->SetMaximum(77.14106);
   ...
   quadLineFit1004->SetChisquare(4.871464);
   ...
   quadLineFit1004->SetParameter(0,75.35271);
   quadLineFit1004->SetParError(0,0.1016885);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.69819);
   quadLineFit1004->SetParError(1,1.670242);
   ...
   quadLineFit1005->SetChisquare(4.871464);
   ...
   quadLineFit1005->SetParameter(0,75.35271);
   quadLineFit1005->SetParError(0,0.1016885);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.69819);
   quadLineFit1005->SetParError(1,1.670242);
   ...
   Graph_10_ppm1005->SetMinimum(75.59241);
   Graph_10_ppm1005->SetMaximum(75.76886);
   ...
   quadLineFit1006->SetChisquare(1.099521);
   ...
   quadLineFit1006->SetParameter(0,75.40737);
   quadLineFit1006->SetParError(0,0.1196049);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,4.187673);
   quadLineFit1006->SetParError(1,1.938219);
   ...
   quadLineFit1007->SetChisquare(1.099521);
   ...
   quadLineFit1007->SetParameter(0,75.40737);
   quadLineFit1007->SetParError(0,0.1196049);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,4.187673);
   quadLineFit1007->SetParError(1,1.938219);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.46255);
   Graph_mI10_ppm1007->SetMaximum(74.81604);
   ...
   quadLineFit1008->SetChisquare(11.62529);
   ...
   quadLineFit1008->SetParameter(0,75.17116);
   quadLineFit1008->SetParError(0,0.1048937);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.249764);
   quadLineFit1008->SetParError(1,1.70614);
   ...
   quadLineFit1009->SetChisquare(11.62529);
   ...
   quadLineFit1009->SetParameter(0,75.17116);
   quadLineFit1009->SetParError(0,0.1048937);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.249764);
   quadLineFit1009->SetParError(1,1.70614);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.09194);
   Graph_mI30_ppm1009->SetMaximum(73.82525);
   ...
   quadLineFit1010->SetChisquare(7.066406);
   ...
   quadLineFit1010->SetParameter(0,75.24616);
   quadLineFit1010->SetParError(0,0.09905815);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.33556);
   quadLineFit1010->SetParError(1,1.712792);
   ...
   quadLineFit1011->SetChisquare(7.066406);
   ...
   quadLineFit1011->SetParameter(0,75.24616);
   quadLineFit1011->SetParError(0,0.09905815);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.33556);
   quadLineFit1011->SetParError(1,1.712792);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.21702);
   Graph_mI50_ppm1011->SetMaximum(72.88597);
   ...
   quadLineFit1012->SetChisquare(0.1819756);
   ...
   quadLineFit1012->SetParameter(0,75.10275);
   quadLineFit1012->SetParError(0,0.2002239);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.70637);
   quadLineFit1012->SetParError(1,3.581006);
   ...
   quadLineFit1013->SetChisquare(0.1819756);
   ...
   quadLineFit1013->SetParameter(0,75.10275);
   quadLineFit1013->SetParError(0,0.2002239);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.70637);
   quadLineFit1013->SetParError(1,3.581006);
