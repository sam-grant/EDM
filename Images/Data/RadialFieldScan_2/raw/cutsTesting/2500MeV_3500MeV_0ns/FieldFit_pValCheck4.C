...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.60787);
   Graph_Graph01033->SetMaximum(54.23807);
   ...
   mainFit1034->SetChisquare(3.019958);
   ...
   mainFit1034->SetParameter(0,-1.875656);
   mainFit1034->SetParError(0,0.9952607);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8674422);
   mainFit1034->SetParError(1,0.03255748);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.0326");
   pt_LaTex = pt->AddText("#minus1.88#pm0.995");
   pt_LaTex = pt->AddText("#minus2.16#pm 1.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.162283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.162283,-57.60787,2.162283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.019958);
   ...
   mainFit1035->SetParameter(0,-1.875656);
   mainFit1035->SetParError(0,0.9952607);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8674422);
   mainFit1035->SetParError(1,0.03255748);
