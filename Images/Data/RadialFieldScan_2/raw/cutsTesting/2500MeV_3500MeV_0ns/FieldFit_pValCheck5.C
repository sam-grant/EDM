...
//=========  (Wed Apr 21 18:29:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.03983,70,63.90906);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.64494);
   Graph_Graph01035->SetMaximum(52.51417);
   ...
   mainFit1036->SetChisquare(3.158692);
   ...
   mainFit1036->SetParameter(0,-2.352824);
   mainFit1036->SetParError(0,0.83152);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8845901);
   mainFit1036->SetParError(1,0.02853918);
   ...
   pt_LaTex = pt->AddText("0.885#pm0.0285");
   pt_LaTex = pt->AddText("#minus2.35#pm0.832");
   pt_LaTex = pt->AddText("#minus2.66#pm 0.92");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.65979,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.65979,-38.64494,2.65979,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.158692);
   ...
   mainFit1037->SetParameter(0,-2.352824);
   mainFit1037->SetParError(0,0.83152);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8845901);
   mainFit1037->SetParError(1,0.02853918);
