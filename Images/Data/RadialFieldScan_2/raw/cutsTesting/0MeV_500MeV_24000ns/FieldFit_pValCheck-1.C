...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-74.00106);
   Graph_Graph01023->SetMaximum(59.6945);
   ...
   mainFit1024->SetChisquare(2.887827);
   ...
   mainFit1024->SetParameter(0,-3.643792);
   mainFit1024->SetParError(0,0.8741401);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.037057);
   mainFit1024->SetParError(1,0.02889075);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.722");
   pt_LaTex = pt->AddText(" 1.04#pm0.0289");
   pt_LaTex = pt->AddText("#minus3.64#pm0.874");
   pt_LaTex = pt->AddText("#minus3.51#pm0.833");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.513589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.513589,-74.00106,3.513589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.887827);
   ...
   mainFit1025->SetParameter(0,-3.643792);
   mainFit1025->SetParError(0,0.8741401);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.037057);
   mainFit1025->SetParError(1,0.02889075);
