...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-74.00106);
   Graph_Graph01020->SetMaximum(59.6945);
   ...
   mainFit1021->SetChisquare(2.887827);
   ...
   mainFit1021->SetParameter(0,-3.643792);
   mainFit1021->SetParError(0,0.8741401);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.037057);
   mainFit1021->SetParError(1,0.02889075);
   ...
   mainFit1022->SetChisquare(2.887827);
   ...
   mainFit1022->SetParameter(0,-3.643792);
   mainFit1022->SetParError(0,0.8741401);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.037057);
   mainFit1022->SetParError(1,0.02889075);
