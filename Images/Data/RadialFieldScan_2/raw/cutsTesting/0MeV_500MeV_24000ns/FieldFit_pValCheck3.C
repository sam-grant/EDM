...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-74.00106);
   Graph_Graph01031->SetMaximum(59.6945);
   ...
   mainFit1032->SetChisquare(2.433364);
   ...
   mainFit1032->SetParameter(0,-3.308268);
   mainFit1032->SetParError(0,1.0059);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.031924);
   mainFit1032->SetParError(1,0.0298775);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.811");
   pt_LaTex = pt->AddText(" 1.03#pm0.0299");
   pt_LaTex = pt->AddText("#minus3.31#pm 1.01");
   pt_LaTex = pt->AddText("#minus3.21#pm0.955");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.205924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.205924,-74.00106,3.205924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.433364);
   ...
   mainFit1033->SetParameter(0,-3.308268);
   mainFit1033->SetParError(0,1.0059);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.031924);
   mainFit1033->SetParError(1,0.0298775);
