...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-86.17576,50,53.7202);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-72.18616);
   Graph_Graph01025->SetMaximum(39.7306);
   ...
   mainFit1026->SetChisquare(1.485915);
   ...
   mainFit1026->SetParameter(0,-3.225027);
   mainFit1026->SetParError(0,0.9429795);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.064979);
   mainFit1026->SetParError(1,0.03729351);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0373");
   pt_LaTex = pt->AddText("#minus3.23#pm0.943");
   pt_LaTex = pt->AddText("#minus3.03#pm0.905");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.028253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.028253,-72.18616,3.028253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.485915);
   ...
   mainFit1027->SetParameter(0,-3.225027);
   mainFit1027->SetParError(0,0.9429795);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.064979);
   mainFit1027->SetParError(1,0.03729351);
