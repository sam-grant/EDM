...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.227466);
   ...
   quadLineFit1002->SetParameter(0,74.23652);
   quadLineFit1002->SetParError(0,0.1337097);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.31196);
   quadLineFit1002->SetParError(1,2.24124);
   ...
   quadLineFit1003->SetChisquare(2.227466);
   ...
   quadLineFit1003->SetParameter(0,74.23652);
   quadLineFit1003->SetParError(0,0.1337097);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.31196);
   quadLineFit1003->SetParError(1,2.24124);
   ...
   Graph_30_ppm1003->SetMinimum(75.46927);
   Graph_30_ppm1003->SetMaximum(76.24087);
   ...
   quadLineFit1004->SetChisquare(0.8541465);
   ...
   quadLineFit1004->SetParameter(0,74.11804);
   quadLineFit1004->SetParError(0,0.1126546);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,28.55522);
   quadLineFit1004->SetParError(1,1.848984);
   ...
   quadLineFit1005->SetChisquare(0.8541465);
   ...
   quadLineFit1005->SetParameter(0,74.11804);
   quadLineFit1005->SetParError(0,0.1126546);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,28.55522);
   quadLineFit1005->SetParError(1,1.848984);
   ...
   Graph_10_ppm1005->SetMinimum(74.43454);
   Graph_10_ppm1005->SetMaximum(74.70127);
   ...
   quadLineFit1006->SetChisquare(0.4026642);
   ...
   quadLineFit1006->SetParameter(0,74.07302);
   quadLineFit1006->SetParError(0,0.131993);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.194744);
   quadLineFit1006->SetParError(1,2.138115);
   ...
   quadLineFit1007->SetChisquare(0.4026642);
   ...
   quadLineFit1007->SetParameter(0,74.07302);
   quadLineFit1007->SetParError(0,0.131993);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.194744);
   quadLineFit1007->SetParError(1,2.138115);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.08352);
   Graph_mI10_ppm1007->SetMaximum(73.49848);
   ...
   quadLineFit1008->SetChisquare(0.9604608);
   ...
   quadLineFit1008->SetParameter(0,74.22461);
   quadLineFit1008->SetParError(0,0.1156165);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-15.10284);
   quadLineFit1008->SetParError(1,1.879777);
   ...
   quadLineFit1009->SetChisquare(0.9604608);
   ...
   quadLineFit1009->SetParameter(0,74.22461);
   quadLineFit1009->SetParError(0,0.1156165);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-15.10284);
   quadLineFit1009->SetParError(1,1.879777);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.65741);
   Graph_mI30_ppm1009->SetMaximum(72.53635);
   ...
   quadLineFit1010->SetChisquare(2.13687);
   ...
   quadLineFit1010->SetParameter(0,74.15987);
   quadLineFit1010->SetParError(0,0.1086147);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.80647);
   quadLineFit1010->SetParError(1,1.878473);
   ...
   quadLineFit1011->SetChisquare(2.13687);
   ...
   quadLineFit1011->SetParameter(0,74.15987);
   quadLineFit1011->SetParError(0,0.1086147);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.80647);
   quadLineFit1011->SetParError(1,1.878473);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.71203);
   Graph_mI50_ppm1011->SetMaximum(71.58084);
   ...
   quadLineFit1012->SetChisquare(0.2960498);
   ...
   quadLineFit1012->SetParameter(0,74.49453);
   quadLineFit1012->SetParError(0,0.2196361);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-58.93037);
   quadLineFit1012->SetParError(1,3.929393);
   ...
   quadLineFit1013->SetChisquare(0.2960498);
   ...
   quadLineFit1013->SetParameter(0,74.49453);
   quadLineFit1013->SetParError(0,0.2196361);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-58.93037);
   quadLineFit1013->SetParError(1,3.929393);
