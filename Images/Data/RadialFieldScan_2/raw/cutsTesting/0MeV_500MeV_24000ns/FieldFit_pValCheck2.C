...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-74.00106);
   Graph_Graph01029->SetMaximum(59.6945);
   ...
   mainFit1030->SetChisquare(2.321179);
   ...
   mainFit1030->SetParameter(0,-3.923508);
   mainFit1030->SetParError(0,0.9498409);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.03536);
   mainFit1030->SetParError(1,0.02897864);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.029");
   pt_LaTex = pt->AddText("#minus3.92#pm 0.95");
   pt_LaTex = pt->AddText("#minus3.79#pm0.912");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.789513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.789513,-74.00106,3.789513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.321179);
   ...
   mainFit1031->SetParameter(0,-3.923508);
   mainFit1031->SetParError(0,0.9498409);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.03536);
   mainFit1031->SetParError(1,0.02897864);
