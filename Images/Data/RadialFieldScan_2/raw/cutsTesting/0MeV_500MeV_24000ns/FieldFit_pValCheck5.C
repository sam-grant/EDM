...
//=========  (Wed Apr 21 23:32:14 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-56.74448,70,69.61274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-44.10876);
   Graph_Graph01035->SetMaximum(56.97702);
   ...
   mainFit1036->SetChisquare(1.920962);
   ...
   mainFit1036->SetParameter(0,-3.373037);
   mainFit1036->SetParError(0,0.9164834);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.024194);
   mainFit1036->SetParError(1,0.0317145);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0317");
   pt_LaTex = pt->AddText("#minus3.37#pm0.916");
   pt_LaTex = pt->AddText("#minus3.29#pm0.874");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.293358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.293358,-44.10876,3.293358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.920962);
   ...
   mainFit1037->SetParameter(0,-3.373037);
   mainFit1037->SetParError(0,0.9164834);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.024194);
   mainFit1037->SetParError(1,0.0317145);
