...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-74.00106);
   Graph_Graph01027->SetMaximum(59.6945);
   ...
   mainFit1028->SetChisquare(2.335476);
   ...
   mainFit1028->SetParameter(0,-3.971837);
   mainFit1028->SetParError(0,0.9792306);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.026336);
   mainFit1028->SetParError(1,0.03228804);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0323");
   pt_LaTex = pt->AddText("#minus3.97#pm0.979");
   pt_LaTex = pt->AddText("#minus3.87#pm0.971");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.86992,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.86992,-74.00106,3.86992,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.335476);
   ...
   mainFit1029->SetParameter(0,-3.971837);
   mainFit1029->SetParError(0,0.9792306);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.026336);
   mainFit1029->SetParError(1,0.03228804);
