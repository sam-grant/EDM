...
//=========  (Wed Apr 21 23:32:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-74.00106);
   Graph_Graph01033->SetMaximum(59.6945);
   ...
   mainFit1034->SetChisquare(2.380808);
   ...
   mainFit1034->SetParameter(0,-4.115308);
   mainFit1034->SetParError(0,1.09664);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.052544);
   mainFit1034->SetParError(1,0.03616272);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.794");
   pt_LaTex = pt->AddText(" 1.05#pm0.0362");
   pt_LaTex = pt->AddText("#minus4.12#pm  1.1");
   pt_LaTex = pt->AddText("#minus3.91#pm0.987");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.909867,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.909867,-74.00106,3.909867,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.380808);
   ...
   mainFit1035->SetParameter(0,-4.115308);
   mainFit1035->SetParError(0,1.09664);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.052544);
   mainFit1035->SetParError(1,0.03616272);
