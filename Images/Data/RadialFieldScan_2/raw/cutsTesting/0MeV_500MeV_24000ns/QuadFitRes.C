...
//=========  (Wed Apr 21 23:32:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02149943);
   Graph_Graph11015->SetMaximum(0.02481262);
   ...
   Graph_Graph21016->SetMinimum(-0.01413384);
   Graph_Graph21016->SetMaximum(0.01220107);
   ...
   Graph_Graph31017->SetMinimum(-0.02230346);
   Graph_Graph31017->SetMaximum(0.02558313);
   ...
   Graph_Graph41018->SetMinimum(-0.0291907);
   Graph_Graph41018->SetMaximum(0.02382669);
   ...
   Graph_Graph51019->SetMinimum(-0.01293861);
   Graph_Graph51019->SetMaximum(0.009714474);
