...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.15217);
   Graph_Graph01023->SetMaximum(56.72802);
   ...
   mainFit1024->SetChisquare(2.25389);
   ...
   mainFit1024->SetParameter(0,-1.527983);
   mainFit1024->SetParError(0,0.3781964);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.946221);
   mainFit1024->SetParError(1,0.01251299);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.0125");
   pt_LaTex = pt->AddText("#minus1.53#pm0.378");
   pt_LaTex = pt->AddText("#minus1.61#pm0.397");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.614827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.614827,-61.15217,1.614827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.25389);
   ...
   mainFit1025->SetParameter(0,-1.527983);
   mainFit1025->SetParError(0,0.3781964);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.946221);
   mainFit1025->SetParError(1,0.01251299);
