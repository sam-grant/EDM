...
//=========  (Wed Apr 28 16:39:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.8872,75,71.46304);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-61.15217);
   Graph_Graph01031->SetMaximum(56.72802);
   ...
   mainFit1032->SetChisquare(1.978689);
   ...
   mainFit1032->SetParameter(0,-1.414677);
   mainFit1032->SetParError(0,0.4355262);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9444758);
   mainFit1032->SetParError(1,0.01294766);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.66");
   pt_LaTex = pt->AddText("0.944#pm0.0129");
   pt_LaTex = pt->AddText("#minus1.41#pm0.436");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.497844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.497844,-61.15217,1.497844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.978689);
   ...
   mainFit1033->SetParameter(0,-1.414677);
   mainFit1033->SetParError(0,0.4355262);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9444758);
   mainFit1033->SetParError(1,0.01294766);
