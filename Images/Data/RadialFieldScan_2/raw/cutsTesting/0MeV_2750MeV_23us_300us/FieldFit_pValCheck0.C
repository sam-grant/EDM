...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.93072,50,46.68067);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.16958);
   Graph_Graph01025->SetMaximum(34.91953);
   ...
   mainFit1026->SetChisquare(2.20655);
   ...
   mainFit1026->SetParameter(0,-1.560982);
   mainFit1026->SetParError(0,0.4074738);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9440051);
   mainFit1026->SetParError(1,0.01613378);
   ...
   pt_LaTex = pt->AddText("0.944#pm0.0161");
   pt_LaTex = pt->AddText("#minus1.56#pm0.407");
   pt_LaTex = pt->AddText("#minus1.65#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.653574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.653574,-59.16958,1.653574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.20655);
   ...
   mainFit1027->SetParameter(0,-1.560982);
   mainFit1027->SetParError(0,0.4074738);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9440051);
   mainFit1027->SetParError(1,0.01613378);
