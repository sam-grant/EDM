...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.15217);
   Graph_Graph01027->SetMaximum(56.72802);
   ...
   mainFit1028->SetChisquare(1.414855);
   ...
   mainFit1028->SetParameter(0,-1.353051);
   mainFit1028->SetParError(0,0.4236812);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.951949);
   mainFit1028->SetParError(1,0.01398889);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.472");
   pt_LaTex = pt->AddText("0.952#pm0.014");
   pt_LaTex = pt->AddText("#minus1.35#pm0.424");
   pt_LaTex = pt->AddText("#minus1.42#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.421348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.421348,-61.15217,1.421348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.414855);
   ...
   mainFit1029->SetParameter(0,-1.353051);
   mainFit1029->SetParError(0,0.4236812);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.951949);
   mainFit1029->SetParError(1,0.01398889);
