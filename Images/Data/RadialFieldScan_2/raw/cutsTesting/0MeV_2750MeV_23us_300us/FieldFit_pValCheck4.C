...
//=========  (Wed Apr 28 16:39:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.15217);
   Graph_Graph01033->SetMaximum(56.72802);
   ...
   mainFit1034->SetChisquare(2.052357);
   ...
   mainFit1034->SetParameter(0,-1.65619);
   mainFit1034->SetParError(0,0.4739115);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.95044);
   mainFit1034->SetParError(1,0.01564917);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.684");
   pt_LaTex = pt->AddText(" 0.95#pm0.0156");
   pt_LaTex = pt->AddText("#minus1.66#pm0.474");
   pt_LaTex = pt->AddText("#minus1.74#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.742551,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.742551,-61.15217,1.742551,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.052357);
   ...
   mainFit1035->SetParameter(0,-1.65619);
   mainFit1035->SetParError(0,0.4739115);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.95044);
   mainFit1035->SetParError(1,0.01564917);
