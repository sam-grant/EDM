...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003379863);
   Graph_Graph11015->SetMaximum(0.007916999);
   ...
   Graph_Graph21016->SetMinimum(-0.004596434);
   Graph_Graph21016->SetMaximum(0.005396382);
   ...
   Graph_Graph31017->SetMinimum(-0.01833746);
   Graph_Graph31017->SetMaximum(0.01783889);
   ...
   Graph_Graph41018->SetMinimum(-0.00493855);
   Graph_Graph41018->SetMaximum(0.008416499);
   ...
   Graph_Graph51019->SetMinimum(-0.003998887);
   Graph_Graph51019->SetMaximum(0.00534162);
