...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.15217);
   Graph_Graph01029->SetMaximum(56.72802);
   ...
   mainFit1030->SetChisquare(0.8255117);
   ...
   mainFit1030->SetParameter(0,-1.720684);
   mainFit1030->SetParError(0,0.4111323);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9450653);
   mainFit1030->SetParError(1,0.01255027);
   ...
   pt_LaTex = pt->AddText("#minus1.72#pm0.411");
   pt_LaTex = pt->AddText("#minus1.82#pm0.433");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.820704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.820704,-61.15217,1.820704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.8255117);
   ...
   mainFit1031->SetParameter(0,-1.720684);
   mainFit1031->SetParError(0,0.4111323);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9450653);
   mainFit1031->SetParError(1,0.01255027);
