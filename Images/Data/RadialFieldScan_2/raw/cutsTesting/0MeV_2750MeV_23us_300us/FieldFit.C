...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.15217);
   Graph_Graph01020->SetMaximum(56.72802);
   ...
   mainFit1021->SetChisquare(2.25389);
   ...
   mainFit1021->SetParameter(0,-1.527983);
   mainFit1021->SetParError(0,0.3781964);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.946221);
   mainFit1021->SetParError(1,0.01251299);
   ...
   mainFit1022->SetChisquare(2.25389);
   ...
   mainFit1022->SetParameter(0,-1.527983);
   mainFit1022->SetParError(0,0.3781964);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.946221);
   mainFit1022->SetParError(1,0.01251299);
