...
//=========  (Wed Apr 28 16:39:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.81372,70,66.24835);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.20752);
   Graph_Graph01035->SetMaximum(54.64214);
   ...
   mainFit1036->SetChisquare(1.983137);
   ...
   mainFit1036->SetParameter(0,-1.465835);
   mainFit1036->SetParError(0,0.3966082);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9432693);
   mainFit1036->SetParError(1,0.01373872);
   ...
   pt_LaTex = pt->AddText("0.943#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.47#pm0.397");
   pt_LaTex = pt->AddText("#minus1.55#pm0.415");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.553994,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.553994,-38.20752,1.553994,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.983137);
   ...
   mainFit1037->SetParameter(0,-1.465835);
   mainFit1037->SetParError(0,0.3966082);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9432693);
   mainFit1037->SetParError(1,0.01373872);
