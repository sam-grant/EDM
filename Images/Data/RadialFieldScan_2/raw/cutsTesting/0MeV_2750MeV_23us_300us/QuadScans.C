...
//=========  (Wed Apr 28 16:39:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3129715);
   ...
   quadLineFit1002->SetParameter(0,74.42233);
   quadLineFit1002->SetParError(0,0.05785328);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.93422);
   quadLineFit1002->SetParError(1,0.9704472);
   ...
   quadLineFit1003->SetChisquare(0.3129715);
   ...
   quadLineFit1003->SetParameter(0,74.42233);
   quadLineFit1003->SetParError(0,0.05785328);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.93422);
   quadLineFit1003->SetParError(1,0.9704472);
   ...
   Graph_30_ppm1003->SetMinimum(75.69606);
   Graph_30_ppm1003->SetMaximum(76.36197);
   ...
   quadLineFit1004->SetChisquare(0.241064);
   ...
   quadLineFit1004->SetParameter(0,74.41962);
   quadLineFit1004->SetParError(0,0.04854417);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.28102);
   quadLineFit1004->SetParError(1,0.7977507);
   ...
   quadLineFit1005->SetChisquare(0.241064);
   ...
   quadLineFit1005->SetParameter(0,74.41962);
   quadLineFit1005->SetParError(0,0.04854417);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.28102);
   quadLineFit1005->SetParError(1,0.7977507);
   ...
   Graph_10_ppm1005->SetMinimum(74.70199);
   Graph_10_ppm1005->SetMaximum(74.95211);
   ...
   quadLineFit1006->SetChisquare(0.3083218);
   ...
   quadLineFit1006->SetParameter(0,74.27407);
   quadLineFit1006->SetParError(0,0.05685061);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.938597);
   quadLineFit1006->SetParError(1,0.921873);
   ...
   quadLineFit1007->SetChisquare(0.3083218);
   ...
   quadLineFit1007->SetParameter(0,74.27407);
   quadLineFit1007->SetParError(0,0.05685061);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.938597);
   quadLineFit1007->SetParError(1,0.921873);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.45037);
   Graph_mI10_ppm1007->SetMaximum(73.7694);
   ...
   quadLineFit1008->SetChisquare(3.433994);
   ...
   quadLineFit1008->SetParameter(0,74.30399);
   quadLineFit1008->SetParError(0,0.0499061);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.35589);
   quadLineFit1008->SetParError(1,0.8122278);
   ...
   quadLineFit1009->SetChisquare(3.433994);
   ...
   quadLineFit1009->SetParameter(0,74.30399);
   quadLineFit1009->SetParError(0,0.0499061);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.35589);
   quadLineFit1009->SetParError(1,0.8122278);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.05618);
   Graph_mI30_ppm1009->SetMaximum(72.80057);
   ...
   quadLineFit1010->SetChisquare(0.6419134);
   ...
   quadLineFit1010->SetParameter(0,74.25404);
   quadLineFit1010->SetParError(0,0.04713891);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.65425);
   quadLineFit1010->SetParError(1,0.8157961);
   ...
   quadLineFit1011->SetChisquare(0.6419134);
   ...
   quadLineFit1011->SetParameter(0,74.25404);
   quadLineFit1011->SetParError(0,0.04713891);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.65425);
   quadLineFit1011->SetParError(1,0.8157961);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.12475);
   Graph_mI50_ppm1011->SetMaximum(71.8247);
   ...
   quadLineFit1012->SetChisquare(0.268406);
   ...
   quadLineFit1012->SetParameter(0,74.30234);
   quadLineFit1012->SetParError(0,0.09515248);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.62626);
   quadLineFit1012->SetParError(1,1.702561);
   ...
   quadLineFit1013->SetChisquare(0.268406);
   ...
   quadLineFit1013->SetParameter(0,74.30234);
   quadLineFit1013->SetParError(0,0.09515248);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.62626);
   quadLineFit1013->SetParError(1,1.702561);
