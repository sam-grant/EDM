...
//=========  (Wed Apr 21 17:43:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0157991);
   Graph_Graph11015->SetMaximum(0.04952883);
   ...
   Graph_Graph21016->SetMinimum(-0.00650133);
   Graph_Graph21016->SetMaximum(0.007634481);
   ...
   Graph_Graph31017->SetMinimum(-0.03979944);
   Graph_Graph31017->SetMaximum(0.02906537);
   ...
   Graph_Graph41018->SetMinimum(-0.01186924);
   Graph_Graph41018->SetMaximum(0.01542357);
   ...
   Graph_Graph51019->SetMinimum(-0.001851833);
   Graph_Graph51019->SetMaximum(0.001389008);
