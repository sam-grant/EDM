...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.89573);
   Graph_Graph01027->SetMaximum(52.14114);
   ...
   mainFit1028->SetChisquare(3.933169);
   ...
   mainFit1028->SetParameter(0,-2.030584);
   mainFit1028->SetParError(0,0.7882707);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8691777);
   mainFit1028->SetParError(1,0.02599382);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.026");
   pt_LaTex = pt->AddText("#minus2.03#pm0.788");
   pt_LaTex = pt->AddText("#minus2.34#pm0.915");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.336213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.336213,-63.89573,2.336213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.933169);
   ...
   mainFit1029->SetParameter(0,-2.030584);
   mainFit1029->SetParError(0,0.7882707);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8691777);
   mainFit1029->SetParError(1,0.02599382);
