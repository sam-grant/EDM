...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.89573);
   Graph_Graph01020->SetMaximum(52.14114);
   ...
   mainFit1021->SetChisquare(3.95497);
   ...
   mainFit1021->SetParameter(0,-1.978194);
   mainFit1021->SetParError(0,0.703971);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8708854);
   mainFit1021->SetParError(1,0.02326841);
   ...
   mainFit1022->SetChisquare(3.95497);
   ...
   mainFit1022->SetParameter(0,-1.978194);
   mainFit1022->SetParError(0,0.703971);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8708854);
   mainFit1022->SetParError(1,0.02326841);
