...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-46.42619,70,60.25091);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.75848);
   Graph_Graph01035->SetMaximum(49.5832);
   ...
   mainFit1036->SetChisquare(0.1121497);
   ...
   mainFit1036->SetParameter(0,-1.542349);
   mainFit1036->SetParError(0,0.7382486);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8502485);
   mainFit1036->SetParError(1,0.02553999);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0374");
   pt_LaTex = pt->AddText(" 0.85#pm0.0255");
   pt_LaTex = pt->AddText("#minus1.54#pm0.738");
   pt_LaTex = pt->AddText("#minus1.81#pm0.856");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.813997,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.813997,-35.75848,1.813997,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.1121497);
   ...
   mainFit1037->SetParameter(0,-1.542349);
   mainFit1037->SetParError(0,0.7382486);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8502485);
   mainFit1037->SetParError(1,0.02553999);
