...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.89573);
   Graph_Graph01033->SetMaximum(52.14114);
   ...
   mainFit1034->SetChisquare(3.136024);
   ...
   mainFit1034->SetParameter(0,-2.460013);
   mainFit1034->SetParError(0,0.8826281);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8867182);
   mainFit1034->SetParError(1,0.02910909);
   ...
   pt_LaTex = pt->AddText("0.887#pm0.0291");
   pt_LaTex = pt->AddText("#minus2.46#pm0.883");
   pt_LaTex = pt->AddText("#minus2.77#pm0.956");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.774289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.774289,-63.89573,2.774289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.136024);
   ...
   mainFit1035->SetParameter(0,-2.460013);
   mainFit1035->SetParError(0,0.8826281);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8867182);
   mainFit1035->SetParError(1,0.02910909);
