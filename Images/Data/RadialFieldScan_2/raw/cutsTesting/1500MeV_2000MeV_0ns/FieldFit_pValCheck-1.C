...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-78.40033,75,66.64574);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-63.89573);
   Graph_Graph01023->SetMaximum(52.14114);
   ...
   mainFit1024->SetChisquare(3.95497);
   ...
   mainFit1024->SetParameter(0,-1.978194);
   mainFit1024->SetParError(0,0.703971);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8708854);
   mainFit1024->SetParError(1,0.02326841);
   ...
   pt_LaTex = pt->AddText("0.871#pm0.0233");
   pt_LaTex = pt->AddText("#minus1.98#pm0.704");
   pt_LaTex = pt->AddText("#minus2.27#pm0.801");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.271474,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.271474,-63.89573,2.271474,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.95497);
   ...
   mainFit1025->SetParameter(0,-1.978194);
   mainFit1025->SetParError(0,0.703971);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8708854);
   mainFit1025->SetParError(1,0.02326841);
