...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-74.23415,50,45.81485);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.22925);
   Graph_Graph01025->SetMaximum(33.80995);
   ...
   mainFit1026->SetChisquare(3.470828);
   ...
   mainFit1026->SetParameter(0,-1.781351);
   mainFit1026->SetParError(0,0.7586955);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8841089);
   mainFit1026->SetParError(1,0.03003899);
   ...
   pt_LaTex = pt->AddText("0.884#pm 0.03");
   pt_LaTex = pt->AddText("#minus1.78#pm0.759");
   pt_LaTex = pt->AddText("#minus2.01#pm0.869");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.014855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.014855,-62.22925,2.014855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.470828);
   ...
   mainFit1027->SetParameter(0,-1.781351);
   mainFit1027->SetParError(0,0.7586955);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8841089);
   mainFit1027->SetParError(1,0.03003899);
