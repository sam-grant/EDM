...
//=========  (Wed Apr 21 17:43:56 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8889217);
   ...
   quadLineFit1002->SetParameter(0,74.58714);
   quadLineFit1002->SetParError(0,0.107365);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.67124);
   quadLineFit1002->SetParError(1,1.800156);
   ...
   quadLineFit1003->SetChisquare(0.8889217);
   ...
   quadLineFit1003->SetParameter(0,74.58714);
   quadLineFit1003->SetParError(0,0.107365);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.67124);
   quadLineFit1003->SetParError(1,1.800156);
   ...
   Graph_30_ppm1003->SetMinimum(75.61038);
   Graph_30_ppm1003->SetMaximum(76.24366);
   ...
   quadLineFit1004->SetChisquare(2.503127);
   ...
   quadLineFit1004->SetParameter(0,74.44165);
   quadLineFit1004->SetParError(0,0.0903922);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.32192);
   quadLineFit1004->SetParError(1,1.484755);
   ...
   quadLineFit1005->SetChisquare(2.503127);
   ...
   quadLineFit1005->SetParameter(0,74.44165);
   quadLineFit1005->SetParError(0,0.0903922);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.32192);
   quadLineFit1005->SetParError(1,1.484755);
   ...
   Graph_10_ppm1005->SetMinimum(74.7124);
   Graph_10_ppm1005->SetMaximum(74.9373);
   ...
   quadLineFit1006->SetChisquare(0.1785611);
   ...
   quadLineFit1006->SetParameter(0,74.40571);
   quadLineFit1006->SetParError(0,0.1060053);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.720631);
   quadLineFit1006->SetParError(1,1.71834);
   ...
   quadLineFit1007->SetChisquare(0.1785611);
   ...
   quadLineFit1007->SetParameter(0,74.40571);
   quadLineFit1007->SetParError(0,0.1060053);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.720631);
   quadLineFit1007->SetParError(1,1.71834);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.53744);
   Graph_mI10_ppm1007->SetMaximum(73.86659);
   ...
   quadLineFit1008->SetChisquare(3.87174);
   ...
   quadLineFit1008->SetParameter(0,74.29987);
   quadLineFit1008->SetParError(0,0.09294866);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.940762);
   quadLineFit1008->SetParError(1,1.511987);
   ...
   quadLineFit1009->SetChisquare(3.87174);
   ...
   quadLineFit1009->SetParameter(0,74.29987);
   quadLineFit1009->SetParError(0,0.09294866);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.940762);
   quadLineFit1009->SetParError(1,1.511987);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.22657);
   Graph_mI30_ppm1009->SetMaximum(72.9404);
   ...
   quadLineFit1010->SetChisquare(0.5607765);
   ...
   quadLineFit1010->SetParameter(0,74.2608);
   quadLineFit1010->SetParError(0,0.08779069);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.1283);
   quadLineFit1010->SetParError(1,1.518365);
   ...
   quadLineFit1011->SetChisquare(0.5607765);
   ...
   quadLineFit1011->SetParameter(0,74.2608);
   quadLineFit1011->SetParError(0,0.08779069);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.1283);
   quadLineFit1011->SetParError(1,1.518365);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.29532);
   Graph_mI50_ppm1011->SetMaximum(72.0429);
   ...
   quadLineFit1012->SetChisquare(0.009275915);
   ...
   quadLineFit1012->SetParameter(0,74.57482);
   quadLineFit1012->SetParError(0,0.1773839);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-51.05264);
   quadLineFit1012->SetParError(1,3.173347);
   ...
   quadLineFit1013->SetChisquare(0.009275915);
   ...
   quadLineFit1013->SetParameter(0,74.57482);
   quadLineFit1013->SetParError(0,0.1773839);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-51.05264);
   quadLineFit1013->SetParError(1,3.173347);
