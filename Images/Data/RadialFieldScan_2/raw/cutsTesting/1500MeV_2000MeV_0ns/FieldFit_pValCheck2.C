...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.89573);
   Graph_Graph01029->SetMaximum(52.14114);
   ...
   mainFit1030->SetChisquare(3.954929);
   ...
   mainFit1030->SetParameter(0,-1.976285);
   mainFit1030->SetParError(0,0.7650123);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8709013);
   mainFit1030->SetParError(1,0.02333601);
   ...
   pt_LaTex = pt->AddText("#minus1.98#pm0.765");
   pt_LaTex = pt->AddText("#minus2.27#pm0.873");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.269241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.269241,-63.89573,2.269241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.954929);
   ...
   mainFit1031->SetParameter(0,-1.976285);
   mainFit1031->SetParError(0,0.7650123);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8709013);
   mainFit1031->SetParError(1,0.02333601);
