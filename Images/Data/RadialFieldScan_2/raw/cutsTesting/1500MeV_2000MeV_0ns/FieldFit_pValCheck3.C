...
//=========  (Wed Apr 21 17:43:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.89573);
   Graph_Graph01031->SetMaximum(52.14114);
   ...
   mainFit1032->SetChisquare(3.624138);
   ...
   mainFit1032->SetParameter(0,-2.209551);
   mainFit1032->SetParError(0,0.8107704);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.874457);
   mainFit1032->SetParError(1,0.02408064);
   ...
   pt_LaTex = pt->AddText("0.874#pm0.0241");
   pt_LaTex = pt->AddText("#minus2.21#pm0.811");
   pt_LaTex = pt->AddText("#minus2.53#pm0.911");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.52677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.52677,-63.89573,2.52677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.624138);
   ...
   mainFit1033->SetParameter(0,-2.209551);
   mainFit1033->SetParError(0,0.8107704);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.874457);
   mainFit1033->SetParError(1,0.02408064);
