...
//=========  (Wed Apr 21 15:33:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.12483,70,64.90125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.72222);
   Graph_Graph01035->SetMaximum(53.49864);
   ...
   mainFit1036->SetChisquare(3.427045);
   ...
   mainFit1036->SetParameter(0,-2.462842);
   mainFit1036->SetParError(0,0.5612738);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9040257);
   mainFit1036->SetParError(1,0.01953118);
   ...
   pt_LaTex = pt->AddText("0.904#pm0.0195");
   pt_LaTex = pt->AddText("#minus2.46#pm0.561");
   pt_LaTex = pt->AddText("#minus2.72#pm0.608");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.724306,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.724306,-37.72222,2.724306,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.427045);
   ...
   mainFit1037->SetParameter(0,-2.462842);
   mainFit1037->SetParError(0,0.5612738);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9040257);
   mainFit1037->SetParError(1,0.01953118);
