...
//=========  (Wed Apr 21 15:33:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.31348);
   Graph_Graph01020->SetMaximum(55.55239);
   ...
   mainFit1021->SetChisquare(3.473822);
   ...
   mainFit1021->SetParameter(0,-2.499243);
   mainFit1021->SetParError(0,0.5354418);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9057716);
   mainFit1021->SetParError(1,0.0177822);
   ...
   pt_LaTex = pt->AddText(" #minus2.5#pm0.535");
   pt_LaTex = pt->AddText("#minus2.76#pm0.585");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.759242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.759242,-60.31348,2.759242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.473822);
   ...
   mainFit1022->SetParameter(0,-2.499243);
   mainFit1022->SetParError(0,0.5354418);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9057716);
   mainFit1022->SetParError(1,0.0177822);
