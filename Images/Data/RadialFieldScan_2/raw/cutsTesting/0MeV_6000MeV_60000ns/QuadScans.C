...
//=========  (Wed Apr 21 15:33:02 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.436142);
   ...
   quadLineFit1002->SetParameter(0,74.4757);
   quadLineFit1002->SetParError(0,0.08300827);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.50427);
   quadLineFit1002->SetParError(1,1.392632);
   ...
   quadLineFit1003->SetChisquare(1.436142);
   ...
   quadLineFit1003->SetParameter(0,74.4757);
   quadLineFit1003->SetParError(0,0.08300827);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.50427);
   quadLineFit1003->SetParError(1,1.392632);
   ...
   Graph_30_ppm1003->SetMinimum(75.71953);
   Graph_30_ppm1003->SetMaximum(76.31883);
   ...
   quadLineFit1004->SetChisquare(1.224241);
   ...
   quadLineFit1004->SetParameter(0,74.58243);
   quadLineFit1004->SetParError(0,0.0685983);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.29292);
   quadLineFit1004->SetParError(1,1.127301);
   ...
   quadLineFit1005->SetChisquare(1.224241);
   ...
   quadLineFit1005->SetParameter(0,74.58243);
   quadLineFit1005->SetParError(0,0.0685983);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.29292);
   quadLineFit1005->SetParError(1,1.127301);
   ...
   Graph_10_ppm1005->SetMinimum(74.74491);
   Graph_10_ppm1005->SetMaximum(74.94976);
   ...
   quadLineFit1006->SetChisquare(1.08527);
   ...
   quadLineFit1006->SetParameter(0,74.44525);
   quadLineFit1006->SetParError(0,0.0803386);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.374048);
   quadLineFit1006->SetParError(1,1.302874);
   ...
   quadLineFit1007->SetChisquare(1.08527);
   ...
   quadLineFit1007->SetParameter(0,74.44525);
   quadLineFit1007->SetParError(0,0.0803386);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.374048);
   quadLineFit1007->SetParError(1,1.302874);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.49329);
   Graph_mI10_ppm1007->SetMaximum(73.81998);
   ...
   quadLineFit1008->SetChisquare(1.82904);
   ...
   quadLineFit1008->SetParameter(0,74.36622);
   quadLineFit1008->SetParError(0,0.07060892);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.74074);
   quadLineFit1008->SetParError(1,1.149096);
   ...
   quadLineFit1009->SetChisquare(1.82904);
   ...
   quadLineFit1009->SetParameter(0,74.36622);
   quadLineFit1009->SetParError(0,0.07060892);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.74074);
   quadLineFit1009->SetParError(1,1.149096);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.09872);
   Graph_mI30_ppm1009->SetMaximum(72.83512);
   ...
   quadLineFit1010->SetChisquare(1.886054);
   ...
   quadLineFit1010->SetParameter(0,74.25537);
   quadLineFit1010->SetParError(0,0.06667978);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.96659);
   quadLineFit1010->SetParError(1,1.153888);
   ...
   quadLineFit1011->SetChisquare(1.886054);
   ...
   quadLineFit1011->SetParameter(0,74.25537);
   quadLineFit1011->SetParError(0,0.06667978);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.96659);
   quadLineFit1011->SetParError(1,1.153888);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.18884);
   Graph_mI50_ppm1011->SetMaximum(71.88547);
   ...
   quadLineFit1012->SetChisquare(1.673537);
   ...
   quadLineFit1012->SetParameter(0,74.27316);
   quadLineFit1012->SetParError(0,0.1345571);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.25039);
   quadLineFit1012->SetParError(1,2.407602);
   ...
   quadLineFit1013->SetChisquare(1.673537);
   ...
   quadLineFit1013->SetParameter(0,74.27316);
   quadLineFit1013->SetParError(0,0.1345571);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.25039);
   quadLineFit1013->SetParError(1,2.407602);
