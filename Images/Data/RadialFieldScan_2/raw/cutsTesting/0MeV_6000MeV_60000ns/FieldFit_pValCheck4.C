...
//=========  (Wed Apr 21 15:33:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.31348);
   Graph_Graph01033->SetMaximum(55.55239);
   ...
   mainFit1034->SetChisquare(2.732764);
   ...
   mainFit1034->SetParameter(0,-2.846382);
   mainFit1034->SetParError(0,0.6703045);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9172702);
   mainFit1034->SetParError(1,0.02223925);
   ...
   pt_LaTex = pt->AddText("0.917#pm0.0222");
   pt_LaTex = pt->AddText("#minus2.85#pm 0.67");
   pt_LaTex = pt->AddText(" #minus3.1#pm0.699");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.103101,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.103101,-60.31348,3.103101,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.732764);
   ...
   mainFit1035->SetParameter(0,-2.846382);
   mainFit1035->SetParError(0,0.6703045);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9172702);
   mainFit1035->SetParError(1,0.02223925);
