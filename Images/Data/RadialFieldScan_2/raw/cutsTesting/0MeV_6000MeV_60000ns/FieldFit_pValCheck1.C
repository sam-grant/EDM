...
//=========  (Wed Apr 21 15:33:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-60.31348);
   Graph_Graph01027->SetMaximum(55.55239);
   ...
   mainFit1028->SetChisquare(1.051656);
   ...
   mainFit1028->SetParameter(0,-2.073493);
   mainFit1028->SetParError(0,0.6012821);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9198383);
   mainFit1028->SetParError(1,0.01994804);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0199");
   pt_LaTex = pt->AddText("#minus2.07#pm0.601");
   pt_LaTex = pt->AddText("#minus2.25#pm 0.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.254193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.254193,-60.31348,2.254193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.051656);
   ...
   mainFit1029->SetParameter(0,-2.073493);
   mainFit1029->SetParError(0,0.6012821);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9198383);
   mainFit1029->SetParError(1,0.01994804);
