...
//=========  (Wed Apr 21 15:33:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02102317);
   Graph_Graph11015->SetMaximum(0.01438494);
   ...
   Graph_Graph21016->SetMinimum(-0.01218611);
   Graph_Graph21016->SetMaximum(0.01432713);
   ...
   Graph_Graph31017->SetMinimum(-0.02273746);
   Graph_Graph31017->SetMaximum(0.0122772);
   ...
   Graph_Graph41018->SetMinimum(-0.01169919);
   Graph_Graph41018->SetMaximum(0.02092996);
   ...
   Graph_Graph51019->SetMinimum(-0.01890008);
   Graph_Graph51019->SetMaximum(0.01413549);
