...
//=========  (Wed Apr 21 15:33:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.31348);
   Graph_Graph01023->SetMaximum(55.55239);
   ...
   mainFit1024->SetChisquare(3.473822);
   ...
   mainFit1024->SetParameter(0,-2.499243);
   mainFit1024->SetParError(0,0.5354418);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9057716);
   mainFit1024->SetParError(1,0.0177822);
   ...
   mainFit1025->SetChisquare(3.473822);
   ...
   mainFit1025->SetParameter(0,-2.499243);
   mainFit1025->SetParError(0,0.5354418);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9057716);
   mainFit1025->SetParError(1,0.0177822);
