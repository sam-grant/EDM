...
//=========  (Wed Apr 21 15:33:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-69.42754,50,43.18977);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.16581);
   Graph_Graph01025->SetMaximum(31.92804);
   ...
   mainFit1026->SetChisquare(0.5583251);
   ...
   mainFit1026->SetParameter(0,-2.86216);
   mainFit1026->SetParError(0,0.576084);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8813835);
   mainFit1026->SetParError(1,0.02280864);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.186");
   pt_LaTex = pt->AddText("0.881#pm0.0228");
   pt_LaTex = pt->AddText("#minus2.86#pm0.576");
   pt_LaTex = pt->AddText("#minus3.25#pm0.669");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.24735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.24735,-58.16581,3.24735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.5583251);
   ...
   mainFit1027->SetParameter(0,-2.86216);
   mainFit1027->SetParError(0,0.576084);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8813835);
   mainFit1027->SetParError(1,0.02280864);
