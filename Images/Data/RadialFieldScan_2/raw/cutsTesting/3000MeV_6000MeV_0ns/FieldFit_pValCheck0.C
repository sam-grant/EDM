...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-95.60967,50,53.86201);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-80.6625);
   Graph_Graph01025->SetMaximum(38.91484);
   ...
   mainFit1026->SetChisquare(13.70976);
   ...
   mainFit1026->SetParameter(0,-3.263679);
   mainFit1026->SetParError(0,1.328484);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.009604);
   mainFit1026->SetParError(1,0.05255535);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.57");
   pt_LaTex = pt->AddText(" 1.01#pm0.0526");
   pt_LaTex = pt->AddText("#minus3.26#pm 1.33");
   pt_LaTex = pt->AddText("#minus3.23#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.232634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.232634,-80.6625,3.232634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(13.70976);
   ...
   mainFit1027->SetParameter(0,-3.263679);
   mainFit1027->SetParError(0,1.328484);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.009604);
   mainFit1027->SetParError(1,0.05255535);
