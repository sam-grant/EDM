...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-83.07912);
   Graph_Graph01027->SetMaximum(65.49763);
   ...
   mainFit1028->SetChisquare(13.49041);
   ...
   mainFit1028->SetParameter(0,-2.456487);
   mainFit1028->SetParError(0,1.374154);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.046788);
   mainFit1028->SetParError(1,0.04502614);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  4.5");
   pt_LaTex = pt->AddText(" 1.05#pm0.045");
   pt_LaTex = pt->AddText("#minus2.46#pm 1.37");
   pt_LaTex = pt->AddText("#minus2.35#pm 1.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.34669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.34669,-83.07912,2.34669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(13.49041);
   ...
   mainFit1029->SetParameter(0,-2.456487);
   mainFit1029->SetParError(0,1.374154);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.046788);
   mainFit1029->SetParError(1,0.04502614);
