...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-83.07912);
   Graph_Graph01033->SetMaximum(65.49763);
   ...
   mainFit1034->SetChisquare(14.06877);
   ...
   mainFit1034->SetParameter(0,-3.155225);
   mainFit1034->SetParError(0,1.543919);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.038039);
   mainFit1034->SetParError(1,0.05059847);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.69");
   pt_LaTex = pt->AddText(" 1.04#pm0.0506");
   pt_LaTex = pt->AddText("#minus3.16#pm 1.54");
   pt_LaTex = pt->AddText("#minus3.04#pm 1.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.039602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.039602,-83.07912,3.039602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(14.06877);
   ...
   mainFit1035->SetParameter(0,-3.155225);
   mainFit1035->SetParError(0,1.543919);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.038039);
   mainFit1035->SetParError(1,0.05059847);
