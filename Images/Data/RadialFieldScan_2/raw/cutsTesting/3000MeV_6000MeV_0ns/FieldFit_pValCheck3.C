...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-101.6512,75,84.06973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-83.07912);
   Graph_Graph01031->SetMaximum(65.49763);
   ...
   mainFit1032->SetChisquare(5.130615);
   ...
   mainFit1032->SetParameter(0,-5.049529);
   mainFit1032->SetParError(0,1.416912);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.063654);
   mainFit1032->SetParError(1,0.04189382);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0419");
   pt_LaTex = pt->AddText("#minus5.05#pm 1.42");
   pt_LaTex = pt->AddText("#minus4.75#pm 1.29");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.747342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.747342,-83.07912,4.747342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.130615);
   ...
   mainFit1033->SetParameter(0,-5.049529);
   mainFit1033->SetParError(0,1.416912);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.063654);
   mainFit1033->SetParError(1,0.04189382);
