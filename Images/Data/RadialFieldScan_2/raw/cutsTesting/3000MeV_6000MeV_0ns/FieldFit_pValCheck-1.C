...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-83.07912);
   Graph_Graph01023->SetMaximum(65.49763);
   ...
   mainFit1024->SetChisquare(14.12084);
   ...
   mainFit1024->SetParameter(0,-2.94239);
   mainFit1024->SetParError(0,1.230353);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.031103);
   mainFit1024->SetParError(1,0.04046307);
   ...
   mainFit1025->SetChisquare(14.12084);
   ...
   mainFit1025->SetParameter(0,-2.94239);
   mainFit1025->SetParError(0,1.230353);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.031103);
   mainFit1025->SetParError(1,0.04046307);
