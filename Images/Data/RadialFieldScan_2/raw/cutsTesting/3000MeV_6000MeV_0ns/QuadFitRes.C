...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.07944565);
   Graph_Graph11015->SetMaximum(0.03013065);
   ...
   Graph_Graph21016->SetMinimum(-0.05169016);
   Graph_Graph21016->SetMaximum(0.06092394);
   ...
   Graph_Graph31017->SetMinimum(-0.1526824);
   Graph_Graph31017->SetMaximum(0.1256926);
   ...
   Graph_Graph41018->SetMinimum(-0.04811626);
   Graph_Graph41018->SetMaximum(0.0377588);
   ...
   Graph_Graph51019->SetMinimum(-0.02540368);
   Graph_Graph51019->SetMaximum(0.03357063);
