...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-83.07912);
   Graph_Graph01029->SetMaximum(65.49763);
   ...
   mainFit1030->SetChisquare(10.33659);
   ...
   mainFit1030->SetParameter(0,-1.930283);
   mainFit1030->SetParError(0,1.335839);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.036823);
   mainFit1030->SetParError(1,0.04056965);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.45");
   pt_LaTex = pt->AddText(" 1.04#pm0.0406");
   pt_LaTex = pt->AddText("#minus1.93#pm 1.34");
   pt_LaTex = pt->AddText("#minus1.86#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.861729,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.861729,-83.07912,1.861729,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(10.33659);
   ...
   mainFit1031->SetParameter(0,-1.930283);
   mainFit1031->SetParError(0,1.335839);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.036823);
   mainFit1031->SetParError(1,0.04056965);
