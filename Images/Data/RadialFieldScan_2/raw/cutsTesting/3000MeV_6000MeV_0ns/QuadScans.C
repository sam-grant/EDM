...
//=========  (Thu Apr 22 09:36:52 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7183225);
   ...
   quadLineFit1002->SetParameter(0,74.68438);
   quadLineFit1002->SetParError(0,0.1848118);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,50.01943);
   quadLineFit1002->SetParError(1,3.096813);
   ...
   quadLineFit1003->SetChisquare(0.7183225);
   ...
   quadLineFit1003->SetParameter(0,74.68438);
   quadLineFit1003->SetParError(0,0.1848118);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,50.01943);
   quadLineFit1003->SetParError(1,3.096813);
   ...
   Graph_30_ppm1003->SetMinimum(76.23261);
   Graph_30_ppm1003->SetMaximum(76.96577);
   ...
   quadLineFit1004->SetChisquare(2.197164);
   ...
   quadLineFit1004->SetParameter(0,74.96506);
   quadLineFit1004->SetParError(0,0.1582239);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.3495);
   quadLineFit1004->SetParError(1,2.600569);
   ...
   quadLineFit1005->SetChisquare(2.197164);
   ...
   quadLineFit1005->SetParameter(0,74.96506);
   quadLineFit1005->SetParError(0,0.1582239);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.3495);
   quadLineFit1005->SetParError(1,2.600569);
   ...
   Graph_10_ppm1005->SetMinimum(75.19499);
   Graph_10_ppm1005->SetMaximum(75.42236);
   ...
   quadLineFit1006->SetChisquare(3.671001);
   ...
   quadLineFit1006->SetParameter(0,75.16137);
   quadLineFit1006->SetParError(0,0.185811);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,2.01873);
   quadLineFit1006->SetParError(1,3.012493);
   ...
   quadLineFit1007->SetChisquare(3.671001);
   ...
   quadLineFit1007->SetParameter(0,75.16137);
   quadLineFit1007->SetParError(0,0.185811);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,2.01873);
   quadLineFit1007->SetParError(1,3.012493);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.95516);
   Graph_mI10_ppm1007->SetMaximum(74.36812);
   ...
   quadLineFit1008->SetChisquare(17.56306);
   ...
   quadLineFit1008->SetParameter(0,74.51654);
   quadLineFit1008->SetParError(0,0.1626413);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.441152);
   quadLineFit1008->SetParError(1,2.646754);
   ...
   quadLineFit1009->SetChisquare(17.56306);
   ...
   quadLineFit1009->SetParameter(0,74.51654);
   quadLineFit1009->SetParError(0,0.1626413);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.441152);
   quadLineFit1009->SetParError(1,2.646754);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.37189);
   Graph_mI30_ppm1009->SetMaximum(73.25901);
   ...
   quadLineFit1010->SetChisquare(1.884378);
   ...
   quadLineFit1010->SetParameter(0,74.85208);
   quadLineFit1010->SetParError(0,0.1535643);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.44441);
   quadLineFit1010->SetParError(1,2.656226);
   ...
   quadLineFit1011->SetChisquare(1.884378);
   ...
   quadLineFit1011->SetParameter(0,74.85208);
   quadLineFit1011->SetParError(0,0.1535643);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.44441);
   quadLineFit1011->SetParError(1,2.656226);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.34986);
   Graph_mI50_ppm1011->SetMaximum(72.32899);
   ...
   quadLineFit1012->SetChisquare(1.004412);
   ...
   quadLineFit1012->SetParameter(0,75.56968);
   quadLineFit1012->SetParError(0,0.3095847);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-65.16208);
   quadLineFit1012->SetParError(1,5.535638);
   ...
   quadLineFit1013->SetChisquare(1.004412);
   ...
   quadLineFit1013->SetParameter(0,75.56968);
   quadLineFit1013->SetParError(0,0.3095847);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-65.16208);
   quadLineFit1013->SetParError(1,5.535638);
