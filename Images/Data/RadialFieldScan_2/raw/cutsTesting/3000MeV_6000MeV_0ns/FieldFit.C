...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-83.07912);
   Graph_Graph01020->SetMaximum(65.49763);
   ...
   mainFit1021->SetChisquare(14.12084);
   ...
   mainFit1021->SetParameter(0,-2.94239);
   mainFit1021->SetParError(0,1.230353);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.031103);
   mainFit1021->SetParError(1,0.04046307);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.53");
   pt_LaTex = pt->AddText(" 1.03#pm0.0405");
   pt_LaTex = pt->AddText("#minus2.94#pm 1.23");
   pt_LaTex = pt->AddText("#minus2.85#pm 1.18");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.853634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.853634,-83.07912,2.853634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(14.12084);
   ...
   mainFit1022->SetParameter(0,-2.94239);
   mainFit1022->SetParError(0,1.230353);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.031103);
   mainFit1022->SetParError(1,0.04046307);
