...
//=========  (Thu Apr 22 09:36:53 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-58.40485,70,75.42046);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-45.02232);
   Graph_Graph01035->SetMaximum(62.03793);
   ...
   mainFit1036->SetChisquare(9.422736);
   ...
   mainFit1036->SetParameter(0,-2.092912);
   mainFit1036->SetParError(0,1.291267);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9913903);
   mainFit1036->SetParError(1,0.04441856);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.14");
   pt_LaTex = pt->AddText("0.991#pm0.0444");
   pt_LaTex = pt->AddText("#minus2.09#pm 1.29");
   pt_LaTex = pt->AddText("#minus2.11#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.111088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.111088,-45.02232,2.111088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.422736);
   ...
   mainFit1037->SetParameter(0,-2.092912);
   mainFit1037->SetParError(0,1.291267);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9913903);
   mainFit1037->SetParError(1,0.04441856);
