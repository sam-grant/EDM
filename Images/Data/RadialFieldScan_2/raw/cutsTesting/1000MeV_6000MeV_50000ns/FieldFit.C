...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.65802);
   Graph_Graph01020->SetMaximum(53.69814);
   ...
   mainFit1021->SetChisquare(6.182959);
   ...
   mainFit1021->SetParameter(0,-0.6489752);
   mainFit1021->SetParError(0,0.590572);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8415217);
   mainFit1021->SetParError(1,0.01952643);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0195");
   pt_LaTex = pt->AddText("#minus0.649#pm0.591");
   pt_LaTex = pt->AddText("#minus0.771#pm0.699");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7711925,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7711925,-55.65802,0.7711925,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.182959);
   ...
   mainFit1022->SetParameter(0,-0.6489752);
   mainFit1022->SetParError(0,0.590572);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8415217);
   mainFit1022->SetParError(1,0.01952643);
