...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.65802);
   Graph_Graph01029->SetMaximum(53.69814);
   ...
   mainFit1030->SetChisquare(5.321453);
   ...
   mainFit1030->SetParameter(0,-0.8824363);
   mainFit1030->SetParError(0,0.6419062);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8401415);
   mainFit1030->SetParError(1,0.01958286);
   ...
   pt_LaTex = pt->AddText(" 0.84#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.882#pm0.642");
   pt_LaTex = pt->AddText("#minus1.05#pm0.762");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.050342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.050342,-55.65802,1.050342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.321453);
   ...
   mainFit1031->SetParameter(0,-0.8824363);
   mainFit1031->SetParError(0,0.6419062);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8401415);
   mainFit1031->SetParError(1,0.01958286);
