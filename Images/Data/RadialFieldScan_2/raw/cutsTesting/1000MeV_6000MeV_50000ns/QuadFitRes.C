...
//=========  (Thu Apr 22 10:28:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01930927);
   Graph_Graph11015->SetMaximum(0.03896914);
   ...
   Graph_Graph21016->SetMinimum(-0.01122866);
   Graph_Graph21016->SetMaximum(0.01325016);
   ...
   Graph_Graph31017->SetMinimum(-0.03390447);
   Graph_Graph31017->SetMaximum(0.03382784);
   ...
   Graph_Graph41018->SetMinimum(-0.0172675);
   Graph_Graph41018->SetMaximum(0.02075757);
   ...
   Graph_Graph51019->SetMinimum(-0.002139743);
   Graph_Graph51019->SetMaximum(0.002862056);
