...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.18441,70,62.53904);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.41206);
   Graph_Graph01035->SetMaximum(51.76669);
   ...
   mainFit1036->SetChisquare(5.94233);
   ...
   mainFit1036->SetParameter(0,-0.5572779);
   mainFit1036->SetParError(0,0.6194503);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8371794);
   mainFit1036->SetParError(1,0.02143923);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.98");
   pt_LaTex = pt->AddText("0.837#pm0.0214");
   pt_LaTex = pt->AddText("#minus0.557#pm0.619");
   pt_LaTex = pt->AddText("#minus0.666#pm0.736");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6656613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6656613,-34.41206,0.6656613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.94233);
   ...
   mainFit1037->SetParameter(0,-0.5572779);
   mainFit1037->SetParError(0,0.6194503);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8371794);
   mainFit1037->SetParError(1,0.02143923);
