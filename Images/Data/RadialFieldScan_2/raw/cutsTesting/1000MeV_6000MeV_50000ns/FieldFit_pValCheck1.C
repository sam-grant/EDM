...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.65802);
   Graph_Graph01027->SetMaximum(53.69814);
   ...
   mainFit1028->SetChisquare(0.1689395);
   ...
   mainFit1028->SetParameter(0,0.08097932);
   mainFit1028->SetParError(0,0.6613425);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8653864);
   mainFit1028->SetParError(1,0.021817);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0563");
   pt_LaTex = pt->AddText("0.865#pm0.0218");
   pt_LaTex = pt->AddText("0.081#pm0.661");
   pt_LaTex = pt->AddText("0.0936#pm0.764");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.09357591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.09357591,-55.65802,-0.09357591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1689395);
   ...
   mainFit1029->SetParameter(0,0.08097932);
   mainFit1029->SetParError(0,0.6613425);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8653864);
   mainFit1029->SetParError(1,0.021817);
