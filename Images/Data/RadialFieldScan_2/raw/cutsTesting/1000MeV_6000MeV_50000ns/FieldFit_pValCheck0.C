...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.03825,50,40.92117);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.5423);
   Graph_Graph01025->SetMaximum(30.42523);
   ...
   mainFit1026->SetChisquare(3.858943);
   ...
   mainFit1026->SetParameter(0,-1.009739);
   mainFit1026->SetParError(0,0.6362055);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8172366);
   mainFit1026->SetParError(1,0.02519438);
   ...
   pt_LaTex = pt->AddText("0.817#pm0.0252");
   pt_LaTex = pt->AddText("#minus1.01#pm0.636");
   pt_LaTex = pt->AddText("#minus1.24#pm0.784");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.235553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.235553,-53.5423,1.235553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.858943);
   ...
   mainFit1027->SetParameter(0,-1.009739);
   mainFit1027->SetParError(0,0.6362055);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8172366);
   mainFit1027->SetParError(1,0.02519438);
