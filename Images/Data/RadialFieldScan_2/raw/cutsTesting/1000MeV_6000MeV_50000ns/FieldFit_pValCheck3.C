...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.65802);
   Graph_Graph01031->SetMaximum(53.69814);
   ...
   mainFit1032->SetChisquare(5.740693);
   ...
   mainFit1032->SetParameter(0,-0.8735303);
   mainFit1032->SetParError(0,0.6802871);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8449906);
   mainFit1032->SetParError(1,0.02021114);
   ...
   pt_LaTex = pt->AddText("0.845#pm0.0202");
   pt_LaTex = pt->AddText("#minus0.874#pm 0.68");
   pt_LaTex = pt->AddText("#minus1.03#pm0.799");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.033775,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.033775,-55.65802,1.033775,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.740693);
   ...
   mainFit1033->SetParameter(0,-0.8735303);
   mainFit1033->SetParError(0,0.6802871);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8449906);
   mainFit1033->SetParError(1,0.02021114);
