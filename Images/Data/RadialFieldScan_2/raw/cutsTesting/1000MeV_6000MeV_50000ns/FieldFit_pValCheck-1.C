...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.65802);
   Graph_Graph01023->SetMaximum(53.69814);
   ...
   mainFit1024->SetChisquare(6.182959);
   ...
   mainFit1024->SetParameter(0,-0.6489752);
   mainFit1024->SetParError(0,0.590572);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8415217);
   mainFit1024->SetParError(1,0.01952643);
   ...
   mainFit1025->SetChisquare(6.182959);
   ...
   mainFit1025->SetParameter(0,-0.6489752);
   mainFit1025->SetParError(0,0.590572);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8415217);
   mainFit1025->SetParError(1,0.01952643);
