...
//=========  (Thu Apr 22 10:28:22 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.32755,75,67.36766);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-55.65802);
   Graph_Graph01033->SetMaximum(53.69814);
   ...
   mainFit1034->SetChisquare(6.178565);
   ...
   mainFit1034->SetParameter(0,-0.6194184);
   mainFit1034->SetParError(0,0.7399767);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8405501);
   mainFit1034->SetParError(1,0.02441444);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.06");
   pt_LaTex = pt->AddText("0.841#pm0.0244");
   pt_LaTex = pt->AddText("#minus0.619#pm 0.74");
   pt_LaTex = pt->AddText("#minus0.737#pm0.871");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7369202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7369202,-55.65802,0.7369202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.178565);
   ...
   mainFit1035->SetParameter(0,-0.6194184);
   mainFit1035->SetParError(0,0.7399767);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8405501);
   mainFit1035->SetParError(1,0.02441444);
