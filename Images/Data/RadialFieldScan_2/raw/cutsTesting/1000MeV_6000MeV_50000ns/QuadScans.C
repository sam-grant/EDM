...
//=========  (Thu Apr 22 10:28:21 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.04397639);
   ...
   quadLineFit1002->SetParameter(0,74.62986);
   quadLineFit1002->SetParError(0,0.09007206);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.07417);
   quadLineFit1002->SetParError(1,1.510957);
   ...
   quadLineFit1003->SetChisquare(0.04397639);
   ...
   quadLineFit1003->SetParameter(0,74.62986);
   quadLineFit1003->SetParError(0,0.09007206);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.07417);
   quadLineFit1003->SetParError(1,1.510957);
   ...
   Graph_30_ppm1003->SetMinimum(75.86174);
   Graph_30_ppm1003->SetMaximum(76.42941);
   ...
   quadLineFit1004->SetChisquare(2.667192);
   ...
   quadLineFit1004->SetParameter(0,74.78535);
   quadLineFit1004->SetParError(0,0.07570524);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.18359);
   quadLineFit1004->SetParError(1,1.244343);
   ...
   quadLineFit1005->SetChisquare(2.667192);
   ...
   quadLineFit1005->SetParameter(0,74.78535);
   quadLineFit1005->SetParError(0,0.07570524);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.18359);
   quadLineFit1005->SetParError(1,1.244343);
   ...
   Graph_10_ppm1005->SetMinimum(74.91574);
   Graph_10_ppm1005->SetMaximum(75.18805);
   ...
   quadLineFit1006->SetChisquare(0.7567194);
   ...
   quadLineFit1006->SetParameter(0,74.49024);
   quadLineFit1006->SetParError(0,0.08875221);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.984511);
   quadLineFit1006->SetParError(1,1.439591);
   ...
   quadLineFit1007->SetChisquare(0.7567194);
   ...
   quadLineFit1007->SetParameter(0,74.49024);
   quadLineFit1007->SetParError(0,0.08875221);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.984511);
   quadLineFit1007->SetParError(1,1.439591);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.81082);
   Graph_mI10_ppm1007->SetMaximum(74.08775);
   ...
   quadLineFit1008->SetChisquare(4.007558);
   ...
   quadLineFit1008->SetParameter(0,74.44268);
   quadLineFit1008->SetParError(0,0.07790763);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.340582);
   quadLineFit1008->SetParError(1,1.268104);
   ...
   quadLineFit1009->SetChisquare(4.007558);
   ...
   quadLineFit1009->SetParameter(0,74.44268);
   quadLineFit1009->SetParError(0,0.07790763);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.340582);
   quadLineFit1009->SetParError(1,1.268104);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.4499);
   Graph_mI30_ppm1009->SetMaximum(73.12802);
   ...
   quadLineFit1010->SetChisquare(1.843414);
   ...
   quadLineFit1010->SetParameter(0,74.39751);
   quadLineFit1010->SetParError(0,0.07370824);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.95479);
   quadLineFit1010->SetParError(1,1.27571);
   ...
   quadLineFit1011->SetChisquare(1.843414);
   ...
   quadLineFit1011->SetParameter(0,74.39751);
   quadLineFit1011->SetParError(0,0.07370824);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.95479);
   quadLineFit1011->SetParError(1,1.27571);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.57858);
   Graph_mI50_ppm1011->SetMaximum(72.21958);
   ...
   quadLineFit1012->SetChisquare(0.03150122);
   ...
   quadLineFit1012->SetParameter(0,74.39935);
   quadLineFit1012->SetParError(0,0.1486796);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.88473);
   quadLineFit1012->SetParError(1,2.660281);
   ...
   quadLineFit1013->SetChisquare(0.03150122);
   ...
   quadLineFit1013->SetParameter(0,74.39935);
   quadLineFit1013->SetParError(0,0.1486796);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.88473);
   quadLineFit1013->SetParError(1,2.660281);
