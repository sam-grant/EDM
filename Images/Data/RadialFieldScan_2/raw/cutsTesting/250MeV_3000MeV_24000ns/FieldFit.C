...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.54953);
   Graph_Graph01020->SetMaximum(55.67544);
   ...
   mainFit1021->SetChisquare(6.622875);
   ...
   mainFit1021->SetParameter(0,-1.430816);
   mainFit1021->SetParError(0,0.4060553);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9056642);
   mainFit1021->SetParError(1,0.01342251);
   ...
   mainFit1022->SetChisquare(6.622875);
   ...
   mainFit1022->SetParameter(0,-1.430816);
   mainFit1022->SetParError(0,0.4060553);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9056642);
   mainFit1022->SetParError(1,0.01342251);
