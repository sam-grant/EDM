...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.70265,75,69.82856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.54953);
   Graph_Graph01027->SetMaximum(55.67544);
   ...
   mainFit1028->SetChisquare(1.681044);
   ...
   mainFit1028->SetParameter(0,-0.9763488);
   mainFit1028->SetParError(0,0.4546158);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9205136);
   mainFit1028->SetParError(1,0.01499287);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.56");
   pt_LaTex = pt->AddText("0.921#pm0.015");
   pt_LaTex = pt->AddText("#minus0.976#pm0.455");
   pt_LaTex = pt->AddText("#minus1.06#pm0.495");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.060657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.060657,-57.54953,1.060657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.681044);
   ...
   mainFit1029->SetParameter(0,-0.9763488);
   mainFit1029->SetParError(0,0.4546158);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9205136);
   mainFit1029->SetParError(1,0.01499287);
