...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.54953);
   Graph_Graph01023->SetMaximum(55.67544);
   ...
   mainFit1024->SetChisquare(6.622875);
   ...
   mainFit1024->SetParameter(0,-1.430816);
   mainFit1024->SetParError(0,0.4060553);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9056642);
   mainFit1024->SetParError(1,0.01342251);
   ...
   pt_LaTex = pt->AddText("0.906#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.43#pm0.406");
   pt_LaTex = pt->AddText("#minus1.58#pm0.445");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.579853,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.579853,-57.54953,1.579853,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.622875);
   ...
   mainFit1025->SetParameter(0,-1.430816);
   mainFit1025->SetParError(0,0.4060553);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9056642);
   mainFit1025->SetParError(1,0.01342251);
