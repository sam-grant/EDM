...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.54953);
   Graph_Graph01029->SetMaximum(55.67544);
   ...
   mainFit1030->SetChisquare(5.303684);
   ...
   mainFit1030->SetParameter(0,-1.629511);
   mainFit1030->SetParError(0,0.4413712);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9044923);
   mainFit1030->SetParError(1,0.0134612);
   ...
   pt_LaTex = pt->AddText("0.904#pm0.0135");
   pt_LaTex = pt->AddText("#minus1.63#pm0.441");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.801576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.801576,-57.54953,1.801576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.303684);
   ...
   mainFit1031->SetParameter(0,-1.629511);
   mainFit1031->SetParError(0,0.4413712);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9044923);
   mainFit1031->SetParError(1,0.0134612);
