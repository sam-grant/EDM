...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.54953);
   Graph_Graph01033->SetMaximum(55.67544);
   ...
   mainFit1034->SetChisquare(6.314365);
   ...
   mainFit1034->SetParameter(0,-1.601315);
   mainFit1034->SetParError(0,0.5090262);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9112663);
   mainFit1034->SetParError(1,0.01678957);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  2.1");
   pt_LaTex = pt->AddText("0.911#pm0.0168");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.509");
   pt_LaTex = pt->AddText("#minus1.76#pm0.544");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.757242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.757242,-57.54953,1.757242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.314365);
   ...
   mainFit1035->SetParameter(0,-1.601315);
   mainFit1035->SetParError(0,0.5090262);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9112663);
   mainFit1035->SetParError(1,0.01678957);
