...
//=========  (Fri Apr 23 18:48:54 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4453658);
   ...
   quadLineFit1002->SetParameter(0,74.52927);
   quadLineFit1002->SetParError(0,0.0618794);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.20207);
   quadLineFit1002->SetParError(1,1.037947);
   ...
   quadLineFit1003->SetChisquare(0.4453658);
   ...
   quadLineFit1003->SetParameter(0,74.52927);
   quadLineFit1003->SetParError(0,0.0618794);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.20207);
   quadLineFit1003->SetParError(1,1.037947);
   ...
   Graph_30_ppm1003->SetMinimum(75.79949);
   Graph_30_ppm1003->SetMaximum(76.40136);
   ...
   quadLineFit1004->SetChisquare(2.965681);
   ...
   quadLineFit1004->SetParameter(0,74.60769);
   quadLineFit1004->SetParError(0,0.0520831);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.23378);
   quadLineFit1004->SetParError(1,0.8559629);
   ...
   quadLineFit1005->SetChisquare(2.965681);
   ...
   quadLineFit1005->SetParameter(0,74.60769);
   quadLineFit1005->SetParError(0,0.0520831);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.23378);
   quadLineFit1005->SetParError(1,0.8559629);
   ...
   Graph_10_ppm1005->SetMinimum(74.79502);
   Graph_10_ppm1005->SetMaximum(75.04303);
   ...
   quadLineFit1006->SetChisquare(1.108478);
   ...
   quadLineFit1006->SetParameter(0,74.37913);
   quadLineFit1006->SetParError(0,0.06101378);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.661982);
   quadLineFit1006->SetParError(1,0.9895023);
   ...
   quadLineFit1007->SetChisquare(1.108478);
   ...
   quadLineFit1007->SetParameter(0,74.37913);
   quadLineFit1007->SetParError(0,0.06101378);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.661982);
   quadLineFit1007->SetParError(1,0.9895023);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.56179);
   Graph_mI10_ppm1007->SetMaximum(73.88237);
   ...
   quadLineFit1008->SetChisquare(5.505926);
   ...
   quadLineFit1008->SetParameter(0,74.40146);
   quadLineFit1008->SetParError(0,0.05360392);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.12345);
   quadLineFit1008->SetParError(1,0.8724648);
   ...
   quadLineFit1009->SetChisquare(5.505926);
   ...
   quadLineFit1009->SetParameter(0,74.40146);
   quadLineFit1009->SetParError(0,0.05360392);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.12345);
   quadLineFit1009->SetParError(1,0.8724648);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.18498);
   Graph_mI30_ppm1009->SetMaximum(72.89818);
   ...
   quadLineFit1010->SetChisquare(0.6310758);
   ...
   quadLineFit1010->SetParameter(0,74.28209);
   quadLineFit1010->SetParError(0,0.05065039);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.25454);
   quadLineFit1010->SetParError(1,0.876588);
   ...
   quadLineFit1011->SetChisquare(0.6310758);
   ...
   quadLineFit1011->SetParameter(0,74.28209);
   quadLineFit1011->SetParError(0,0.05065039);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.25454);
   quadLineFit1011->SetParError(1,0.876588);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.2526);
   Graph_mI50_ppm1011->SetMaximum(71.91005);
   ...
   quadLineFit1012->SetChisquare(0.1418082);
   ...
   quadLineFit1012->SetParameter(0,74.21819);
   quadLineFit1012->SetParError(0,0.1023143);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.2834);
   quadLineFit1012->SetParError(1,1.830722);
   ...
   quadLineFit1013->SetChisquare(0.1418082);
   ...
   quadLineFit1013->SetParameter(0,74.21819);
   quadLineFit1013->SetParError(0,0.1023143);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.2834);
   quadLineFit1013->SetParError(1,1.830722);
