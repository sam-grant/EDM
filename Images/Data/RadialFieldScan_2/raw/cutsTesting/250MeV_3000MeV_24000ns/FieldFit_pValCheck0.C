...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.41508,50,43.39071);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.4345);
   Graph_Graph01025->SetMaximum(32.41013);
   ...
   mainFit1026->SetChisquare(3.311988);
   ...
   mainFit1026->SetParameter(0,-1.727161);
   mainFit1026->SetParError(0,0.4374992);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8857288);
   mainFit1026->SetParError(1,0.01732623);
   ...
   pt_LaTex = pt->AddText("0.886#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.73#pm0.437");
   pt_LaTex = pt->AddText("#minus1.95#pm  0.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.949988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.949988,-55.4345,1.949988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.311988);
   ...
   mainFit1027->SetParameter(0,-1.727161);
   mainFit1027->SetParError(0,0.4374992);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8857288);
   mainFit1027->SetParError(1,0.01732623);
