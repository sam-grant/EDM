...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.97392,70,65.08281);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.66825);
   Graph_Graph01035->SetMaximum(53.77714);
   ...
   mainFit1036->SetChisquare(6.552847);
   ...
   mainFit1036->SetParameter(0,-1.464796);
   mainFit1036->SetParError(0,0.4258749);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9072724);
   mainFit1036->SetParError(1,0.01473431);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.18");
   pt_LaTex = pt->AddText("0.907#pm0.0147");
   pt_LaTex = pt->AddText("#minus1.46#pm0.426");
   pt_LaTex = pt->AddText("#minus1.61#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.614506,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.614506,-36.66825,1.614506,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.552847);
   ...
   mainFit1037->SetParameter(0,-1.464796);
   mainFit1037->SetParError(0,0.4258749);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9072724);
   mainFit1037->SetParError(1,0.01473431);
