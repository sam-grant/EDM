...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.54953);
   Graph_Graph01031->SetMaximum(55.67544);
   ...
   mainFit1032->SetChisquare(5.901448);
   ...
   mainFit1032->SetParameter(0,-1.233785);
   mainFit1032->SetParError(0,0.4676457);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9026206);
   mainFit1032->SetParError(1,0.0138926);
   ...
   pt_LaTex = pt->AddText("#minus1.23#pm0.468");
   pt_LaTex = pt->AddText("#minus1.37#pm0.513");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.366893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.366893,-57.54953,1.366893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.901448);
   ...
   mainFit1033->SetParameter(0,-1.233785);
   mainFit1033->SetParError(0,0.4676457);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9026206);
   mainFit1033->SetParError(1,0.0138926);
