...
//=========  (Fri Apr 23 18:48:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0176651);
   Graph_Graph11015->SetMaximum(0.01638995);
   ...
   Graph_Graph21016->SetMinimum(-0.009352792);
   Graph_Graph21016->SetMaximum(0.01100294);
   ...
   Graph_Graph31017->SetMinimum(-0.02483725);
   Graph_Graph31017->SetMaximum(0.0244294);
   ...
   Graph_Graph41018->SetMinimum(-0.005291325);
   Graph_Graph41018->SetMaximum(0.008682671);
   ...
   Graph_Graph51019->SetMinimum(-0.003123084);
   Graph_Graph51019->SetMaximum(0.004174977);
