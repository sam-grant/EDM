...
//=========  (Wed Apr 21 12:23:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.12933);
   Graph_Graph01023->SetMaximum(48.75906);
   ...
   mainFit1024->SetChisquare(5.372834);
   ...
   mainFit1024->SetParameter(0,0.1720065);
   mainFit1024->SetParError(0,0.5800357);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.758978);
   mainFit1024->SetParError(1,0.01917689);
   ...
   mainFit1025->SetChisquare(5.372834);
   ...
   mainFit1025->SetParameter(0,0.1720065);
   mainFit1025->SetParError(0,0.5800357);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.758978);
   mainFit1025->SetParError(1,0.01917689);
