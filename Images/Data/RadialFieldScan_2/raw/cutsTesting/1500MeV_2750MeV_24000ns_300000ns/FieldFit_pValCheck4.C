...
//=========  (Tue Apr 27 00:24:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.0195);
   Graph_Graph01033->SetMaximum(49.04201);
   ...
   mainFit1034->SetChisquare(1.642566);
   ...
   mainFit1034->SetParameter(0,-0.3479202);
   mainFit1034->SetParError(0,0.7523323);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7757218);
   mainFit1034->SetParError(1,0.0247701);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.548");
   pt_LaTex = pt->AddText("0.776#pm0.0248");
   pt_LaTex = pt->AddText("#minus0.348#pm0.752");
   pt_LaTex = pt->AddText("#minus0.449#pm0.963");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4485116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4485116,-51.0195,0.4485116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.642566);
   ...
   mainFit1035->SetParameter(0,-0.3479202);
   mainFit1035->SetParError(0,0.7523323);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7757218);
   mainFit1035->SetParError(1,0.0247701);
