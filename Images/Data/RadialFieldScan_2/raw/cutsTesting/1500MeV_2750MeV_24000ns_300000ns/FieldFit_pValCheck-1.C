...
//=========  (Tue Apr 27 00:24:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.0195);
   Graph_Graph01023->SetMaximum(49.04201);
   ...
   mainFit1024->SetChisquare(1.961408);
   ...
   mainFit1024->SetParameter(0,-0.09126984);
   mainFit1024->SetParError(0,0.5995118);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7673095);
   mainFit1024->SetParError(1,0.0197891);
   ...
   mainFit1025->SetChisquare(1.961408);
   ...
   mainFit1025->SetParameter(0,-0.09126984);
   mainFit1025->SetParError(0,0.5995118);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7673095);
   mainFit1025->SetParError(1,0.0197891);
