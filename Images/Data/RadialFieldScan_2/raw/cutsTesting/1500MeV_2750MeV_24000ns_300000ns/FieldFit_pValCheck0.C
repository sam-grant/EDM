...
//=========  (Tue Apr 27 00:24:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.09009,50,39.36421);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.24466);
   Graph_Graph01025->SetMaximum(29.51878);
   ...
   mainFit1026->SetChisquare(1.283591);
   ...
   mainFit1026->SetParameter(0,-0.2889228);
   mainFit1026->SetParError(0,0.6457859);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7540179);
   mainFit1026->SetParError(1,0.02553525);
   ...
   pt_LaTex = pt->AddText("0.754#pm0.0255");
   pt_LaTex = pt->AddText("#minus0.289#pm0.646");
   pt_LaTex = pt->AddText("#minus0.383#pm0.858");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3831777,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3831777,-49.24466,0.3831777,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.283591);
   ...
   mainFit1027->SetParameter(0,-0.2889228);
   mainFit1027->SetParError(0,0.6457859);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7540179);
   mainFit1027->SetParError(1,0.02553525);
