...
//=========  (Tue Apr 27 00:24:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.0195);
   Graph_Graph01031->SetMaximum(49.04201);
   ...
   mainFit1032->SetChisquare(1.961355);
   ...
   mainFit1032->SetParameter(0,-0.09373254);
   mainFit1032->SetParError(0,0.6893025);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7673475);
   mainFit1032->SetParError(1,0.02047603);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.654");
   pt_LaTex = pt->AddText("0.767#pm0.0205");
   pt_LaTex = pt->AddText("#minus0.0937#pm0.689");
   pt_LaTex = pt->AddText("#minus0.122#pm0.897");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1221514,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1221514,-51.0195,0.1221514,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.961355);
   ...
   mainFit1033->SetParameter(0,-0.09373254);
   mainFit1033->SetParError(0,0.6893025);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7673475);
   mainFit1033->SetParError(1,0.02047603);
