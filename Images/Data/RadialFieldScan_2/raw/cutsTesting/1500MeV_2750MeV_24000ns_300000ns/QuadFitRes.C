...
//=========  (Tue Apr 27 00:24:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01836897);
   Graph_Graph11015->SetMaximum(0.03295465);
   ...
   Graph_Graph21016->SetMinimum(-0.0005457278);
   Graph_Graph21016->SetMaximum(0.0004634262);
   ...
   Graph_Graph31017->SetMinimum(-0.04765924);
   Graph_Graph31017->SetMaximum(0.03538401);
   ...
   Graph_Graph41018->SetMinimum(-0.005140419);
   Graph_Graph41018->SetMaximum(0.006345194);
   ...
   Graph_Graph51019->SetMinimum(-0.004385932);
   Graph_Graph51019->SetMaximum(0.005860988);
