...
//=========  (Tue Apr 27 00:24:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.71539);
   ...
   quadLineFit1002->SetParameter(0,74.84428);
   quadLineFit1002->SetParError(0,0.09118439);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.17412);
   quadLineFit1002->SetParError(1,1.529434);
   ...
   quadLineFit1003->SetChisquare(1.71539);
   ...
   quadLineFit1003->SetParameter(0,74.84428);
   quadLineFit1003->SetParError(0,0.09118439);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.17412);
   quadLineFit1003->SetParError(1,1.529434);
   ...
   Graph_30_ppm1003->SetMinimum(75.88615);
   Graph_30_ppm1003->SetMaximum(76.4429);
   ...
   quadLineFit1004->SetChisquare(2.061322);
   ...
   quadLineFit1004->SetParameter(0,74.83306);
   quadLineFit1004->SetParError(0,0.07672132);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.69416);
   quadLineFit1004->SetParError(1,1.260998);
   ...
   quadLineFit1005->SetChisquare(2.061322);
   ...
   quadLineFit1005->SetParameter(0,74.83306);
   quadLineFit1005->SetParError(0,0.07672132);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.69416);
   quadLineFit1005->SetParError(1,1.260998);
   ...
   Graph_10_ppm1005->SetMinimum(74.96877);
   Graph_10_ppm1005->SetMaximum(75.21705);
   ...
   quadLineFit1006->SetChisquare(0.001256043);
   ...
   quadLineFit1006->SetParameter(0,74.58932);
   quadLineFit1006->SetParError(0,0.08987778);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.191178);
   quadLineFit1006->SetParError(1,1.457615);
   ...
   quadLineFit1007->SetChisquare(0.001256043);
   ...
   quadLineFit1007->SetParameter(0,74.58932);
   quadLineFit1007->SetParError(0,0.08987778);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.191178);
   quadLineFit1007->SetParError(1,1.457615);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.9127);
   Graph_mI10_ppm1007->SetMaximum(74.18683);
   ...
   quadLineFit1008->SetChisquare(7.642663);
   ...
   quadLineFit1008->SetParameter(0,74.51147);
   quadLineFit1008->SetParError(0,0.07956575);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.756303);
   quadLineFit1008->SetParError(1,1.295161);
   ...
   quadLineFit1009->SetChisquare(7.642663);
   ...
   quadLineFit1009->SetParameter(0,74.51147);
   quadLineFit1009->SetParError(0,0.07956575);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.756303);
   quadLineFit1009->SetParError(1,1.295161);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.68587);
   Graph_mI30_ppm1009->SetMaximum(73.27921);
   ...
   quadLineFit1010->SetChisquare(0.1532247);
   ...
   quadLineFit1010->SetParameter(0,74.37658);
   quadLineFit1010->SetParError(0,0.07472434);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.59173);
   quadLineFit1010->SetParError(1,1.293268);
   ...
   quadLineFit1011->SetChisquare(0.1532247);
   ...
   quadLineFit1011->SetParameter(0,74.37658);
   quadLineFit1011->SetParError(0,0.07472434);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.59173);
   quadLineFit1011->SetParError(1,1.293268);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.81002);
   Graph_mI50_ppm1011->SetMaximum(72.39897);
   ...
   quadLineFit1012->SetChisquare(0.1289003);
   ...
   quadLineFit1012->SetParameter(0,74.38471);
   quadLineFit1012->SetParError(0,0.1506159);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.9861);
   quadLineFit1012->SetParError(1,2.694937);
   ...
   quadLineFit1013->SetChisquare(0.1289003);
   ...
   quadLineFit1013->SetParameter(0,74.38471);
   quadLineFit1013->SetParError(0,0.1506159);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.9861);
   quadLineFit1013->SetParError(1,2.694937);
