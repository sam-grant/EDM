...
//=========  (Tue Apr 27 00:24:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.0195);
   Graph_Graph01027->SetMaximum(49.04201);
   ...
   mainFit1028->SetChisquare(0.4308844);
   ...
   mainFit1028->SetParameter(0,0.2823529);
   mainFit1028->SetParError(0,0.6712831);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7794755);
   mainFit1028->SetParError(1,0.02209787);
   ...
   pt_LaTex = pt->AddText("0.779#pm0.0221");
   pt_LaTex = pt->AddText("0.282#pm0.671");
   pt_LaTex = pt->AddText("0.362#pm0.861");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3622345,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3622345,-51.0195,-0.3622345,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4308844);
   ...
   mainFit1029->SetParameter(0,0.2823529);
   mainFit1029->SetParError(0,0.6712831);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7794755);
   mainFit1029->SetParError(1,0.02209787);
