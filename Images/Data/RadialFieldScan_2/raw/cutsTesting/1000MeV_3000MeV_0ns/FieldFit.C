...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.82071);
   Graph_Graph01020->SetMaximum(53.70114);
   ...
   mainFit1021->SetChisquare(1.394872);
   ...
   mainFit1021->SetParameter(0,-1.450253);
   mainFit1021->SetParError(0,0.3829575);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8995397);
   mainFit1021->SetParError(1,0.01261998);
   ...
   pt_LaTex = pt->AddText("  0.9#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.45#pm0.383");
   pt_LaTex = pt->AddText("#minus1.61#pm0.423");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.612217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.612217,-57.82071,1.612217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.394872);
   ...
   mainFit1022->SetParameter(0,-1.450253);
   mainFit1022->SetParError(0,0.3829575);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8995397);
   mainFit1022->SetParError(1,0.01261998);
