...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.027649);
   ...
   quadLineFit1002->SetParameter(0,74.64516);
   quadLineFit1002->SetParError(0,0.0577675);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.43926);
   quadLineFit1002->SetParError(1,0.9683902);
   ...
   quadLineFit1003->SetChisquare(5.027649);
   ...
   quadLineFit1003->SetParameter(0,74.64516);
   quadLineFit1003->SetParError(0,0.0577675);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.43926);
   quadLineFit1003->SetParError(1,0.9683902);
   ...
   Graph_30_ppm1003->SetMinimum(75.83312);
   Graph_30_ppm1003->SetMaximum(76.46507);
   ...
   quadLineFit1004->SetChisquare(0.3480889);
   ...
   quadLineFit1004->SetParameter(0,74.60711);
   quadLineFit1004->SetParError(0,0.04919241);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.09066);
   quadLineFit1004->SetParError(1,0.8080344);
   ...
   quadLineFit1005->SetChisquare(0.3480889);
   ...
   quadLineFit1005->SetParameter(0,74.60711);
   quadLineFit1005->SetParError(0,0.04919241);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.09066);
   quadLineFit1005->SetParError(1,0.8080344);
   ...
   Graph_10_ppm1005->SetMinimum(74.89481);
   Graph_10_ppm1005->SetMaximum(75.13779);
   ...
   quadLineFit1006->SetChisquare(3.618712);
   ...
   quadLineFit1006->SetParameter(0,74.48657);
   quadLineFit1006->SetParError(0,0.05767347);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.411296);
   quadLineFit1006->SetParError(1,0.9348985);
   ...
   quadLineFit1007->SetChisquare(3.618712);
   ...
   quadLineFit1007->SetParameter(0,74.48657);
   quadLineFit1007->SetParError(0,0.05767347);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.411296);
   quadLineFit1007->SetParError(1,0.9348985);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72042);
   Graph_mI10_ppm1007->SetMaximum(74.01197);
   ...
   quadLineFit1008->SetChisquare(2.038236);
   ...
   quadLineFit1008->SetParameter(0,74.48622);
   quadLineFit1008->SetParError(0,0.0506223);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.23321);
   quadLineFit1008->SetParError(1,0.823515);
   ...
   quadLineFit1009->SetChisquare(2.038236);
   ...
   quadLineFit1009->SetParameter(0,74.48622);
   quadLineFit1009->SetParError(0,0.0506223);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.23321);
   quadLineFit1009->SetParError(1,0.823515);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.36344);
   Graph_mI30_ppm1009->SetMaximum(73.08964);
   ...
   quadLineFit1010->SetChisquare(1.427517);
   ...
   quadLineFit1010->SetParameter(0,74.49774);
   quadLineFit1010->SetParError(0,0.04781977);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.7136);
   quadLineFit1010->SetParError(1,0.8270943);
   ...
   quadLineFit1011->SetChisquare(1.427517);
   ...
   quadLineFit1011->SetParameter(0,74.49774);
   quadLineFit1011->SetParError(0,0.04781977);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.7136);
   quadLineFit1011->SetParError(1,0.8270943);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.47033);
   Graph_mI50_ppm1011->SetMaximum(72.13231);
   ...
   quadLineFit1012->SetChisquare(0.864982);
   ...
   quadLineFit1012->SetParameter(0,74.47052);
   quadLineFit1012->SetParError(0,0.09668446);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.79764);
   quadLineFit1012->SetParError(1,1.72958);
   ...
   quadLineFit1013->SetChisquare(0.864982);
   ...
   quadLineFit1013->SetParameter(0,74.47052);
   quadLineFit1013->SetParError(0,0.09668446);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.79764);
   quadLineFit1013->SetParError(1,1.72958);
