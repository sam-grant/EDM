...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.005543668);
   Graph_Graph11015->SetMaximum(0.006565459);
   ...
   Graph_Graph21016->SetMinimum(-0.01593545);
   Graph_Graph21016->SetMaximum(0.01870945);
   ...
   Graph_Graph31017->SetMinimum(-0.0162142);
   Graph_Graph31017->SetMaximum(0.01479703);
   ...
   Graph_Graph41018->SetMinimum(-0.009617634);
   Graph_Graph41018->SetMaximum(0.01134467);
   ...
   Graph_Graph51019->SetMinimum(-0.0073089);
   Graph_Graph51019->SetMaximum(0.009749688);
