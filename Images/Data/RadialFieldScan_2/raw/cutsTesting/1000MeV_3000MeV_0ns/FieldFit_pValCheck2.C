...
//=========  (Fri Apr 23 18:37:36 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.76094,75,67.64137);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-57.82071);
   Graph_Graph01029->SetMaximum(53.70114);
   ...
   mainFit1030->SetChisquare(0.3636843);
   ...
   mainFit1030->SetParameter(0,-1.615281);
   mainFit1030->SetParError(0,0.4160126);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8985998);
   mainFit1030->SetParError(1,0.01265383);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.121");
   pt_LaTex = pt->AddText("0.899#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.62#pm0.416");
   pt_LaTex = pt->AddText(" #minus1.8#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.797553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.797553,-57.82071,1.797553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3636843);
   ...
   mainFit1031->SetParameter(0,-1.615281);
   mainFit1031->SetParError(0,0.4160126);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8985998);
   mainFit1031->SetParError(1,0.01265383);
