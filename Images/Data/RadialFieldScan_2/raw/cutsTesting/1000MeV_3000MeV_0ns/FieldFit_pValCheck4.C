...
//=========  (Fri Apr 23 18:37:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.82071);
   Graph_Graph01033->SetMaximum(53.70114);
   ...
   mainFit1034->SetChisquare(1.172771);
   ...
   mainFit1034->SetParameter(0,-1.313407);
   mainFit1034->SetParError(0,0.480595);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8950668);
   mainFit1034->SetParError(1,0.01579062);
   ...
   pt_LaTex = pt->AddText("0.895#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.31#pm0.481");
   pt_LaTex = pt->AddText("#minus1.47#pm0.525");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.467385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.467385,-57.82071,1.467385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.172771);
   ...
   mainFit1035->SetParameter(0,-1.313407);
   mainFit1035->SetParError(0,0.480595);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8950668);
   mainFit1035->SetParError(1,0.01579062);
