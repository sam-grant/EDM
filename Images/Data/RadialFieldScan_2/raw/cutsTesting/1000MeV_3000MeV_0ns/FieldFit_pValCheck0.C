...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.1337,50,44.50517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.96982);
   Graph_Graph01025->SetMaximum(33.34128);
   ...
   mainFit1026->SetChisquare(1.378709);
   ...
   mainFit1026->SetParameter(0,-1.43058);
   mainFit1026->SetParError(0,0.4130401);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9008626);
   mainFit1026->SetParError(1,0.01635701);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.46");
   pt_LaTex = pt->AddText("0.901#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.43#pm0.413");
   pt_LaTex = pt->AddText("#minus1.59#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.588011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.588011,-55.96982,1.588011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.378709);
   ...
   mainFit1027->SetParameter(0,-1.43058);
   mainFit1027->SetParError(0,0.4130401);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9008626);
   mainFit1027->SetParError(1,0.01635701);
