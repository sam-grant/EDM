...
//=========  (Fri Apr 23 18:37:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.02778,70,62.89474);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.93553);
   Graph_Graph01035->SetMaximum(51.80249);
   ...
   mainFit1036->SetChisquare(1.336889);
   ...
   mainFit1036->SetParameter(0,-1.421005);
   mainFit1036->SetParError(0,0.4017574);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8981673);
   mainFit1036->SetParError(1,0.01384723);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.446");
   pt_LaTex = pt->AddText("0.898#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.42#pm0.402");
   pt_LaTex = pt->AddText("#minus1.58#pm0.441");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.582116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.582116,-36.93553,1.582116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.336889);
   ...
   mainFit1037->SetParameter(0,-1.421005);
   mainFit1037->SetParError(0,0.4017574);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8981673);
   mainFit1037->SetParError(1,0.01384723);
