...
//=========  (Fri Apr 23 18:37:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.82071);
   Graph_Graph01031->SetMaximum(53.70114);
   ...
   mainFit1032->SetChisquare(1.304527);
   ...
   mainFit1032->SetParameter(0,-1.516041);
   mainFit1032->SetParError(0,0.4410911);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9005588);
   mainFit1032->SetParError(1,0.01306755);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.52#pm0.441");
   pt_LaTex = pt->AddText("#minus1.68#pm0.484");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.683445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.683445,-57.82071,1.683445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.304527);
   ...
   mainFit1033->SetParameter(0,-1.516041);
   mainFit1033->SetParError(0,0.4410911);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9005588);
   mainFit1033->SetParError(1,0.01306755);
