...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.82071);
   Graph_Graph01027->SetMaximum(53.70114);
   ...
   mainFit1028->SetChisquare(0.9126338);
   ...
   mainFit1028->SetParameter(0,-1.317541);
   mainFit1028->SetParError(0,0.4279932);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9038434);
   mainFit1028->SetParError(1,0.01405977);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.304");
   pt_LaTex = pt->AddText("0.904#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.32#pm0.428");
   pt_LaTex = pt->AddText("#minus1.46#pm0.475");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.45771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.45771,-57.82071,1.45771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.9126338);
   ...
   mainFit1029->SetParameter(0,-1.317541);
   mainFit1029->SetParError(0,0.4279932);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9038434);
   mainFit1029->SetParError(1,0.01405977);
