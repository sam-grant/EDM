...
//=========  (Fri Apr 23 18:37:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.82071);
   Graph_Graph01023->SetMaximum(53.70114);
   ...
   mainFit1024->SetChisquare(1.394872);
   ...
   mainFit1024->SetParameter(0,-1.450253);
   mainFit1024->SetParError(0,0.3829575);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8995397);
   mainFit1024->SetParError(1,0.01261998);
   ...
   mainFit1025->SetChisquare(1.394872);
   ...
   mainFit1025->SetParameter(0,-1.450253);
   mainFit1025->SetParError(0,0.3829575);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8995397);
   mainFit1025->SetParError(1,0.01261998);
