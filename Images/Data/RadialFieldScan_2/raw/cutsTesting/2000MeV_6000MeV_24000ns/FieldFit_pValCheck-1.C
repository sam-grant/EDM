...
//=========  (Wed Apr 21 14:10:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-45.06255);
   Graph_Graph01023->SetMaximum(49.35786);
   ...
   mainFit1024->SetChisquare(3.415765);
   ...
   mainFit1024->SetParameter(0,0.5767794);
   mainFit1024->SetParError(0,0.6723082);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7559715);
   mainFit1024->SetParError(1,0.02222751);
   ...
   mainFit1025->SetChisquare(3.415765);
   ...
   mainFit1025->SetParameter(0,0.5767794);
   mainFit1025->SetParError(0,0.6723082);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7559715);
   mainFit1025->SetParError(1,0.02222751);
