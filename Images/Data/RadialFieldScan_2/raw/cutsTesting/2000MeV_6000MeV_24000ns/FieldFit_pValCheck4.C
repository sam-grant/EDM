...
//=========  (Wed Apr 21 14:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-45.06255);
   Graph_Graph01033->SetMaximum(49.35786);
   ...
   mainFit1034->SetChisquare(2.486433);
   ...
   mainFit1034->SetParameter(0,1.066011);
   mainFit1034->SetParError(0,0.8423478);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7398921);
   mainFit1034->SetParError(1,0.02778978);
   ...
   pt_LaTex = pt->AddText(" 0.74#pm0.0278");
   pt_LaTex = pt->AddText(" 1.07#pm0.842");
   pt_LaTex = pt->AddText(" 1.44#pm 1.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.440765,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.440765,-45.06255,-1.440765,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.486433);
   ...
   mainFit1035->SetParameter(0,1.066011);
   mainFit1035->SetParError(0,0.8423478);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7398921);
   mainFit1035->SetParError(1,0.02778978);
