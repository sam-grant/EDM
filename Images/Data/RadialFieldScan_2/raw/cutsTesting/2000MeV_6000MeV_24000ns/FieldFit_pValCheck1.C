...
//=========  (Wed Apr 21 14:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-45.06255);
   Graph_Graph01027->SetMaximum(49.35786);
   ...
   mainFit1028->SetChisquare(1.711872);
   ...
   mainFit1028->SetParameter(0,1.019194);
   mainFit1028->SetParError(0,0.7529085);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7704334);
   mainFit1028->SetParError(1,0.02483561);
   ...
   pt_LaTex = pt->AddText(" 0.77#pm0.0248");
   pt_LaTex = pt->AddText(" 1.02#pm0.753");
   pt_LaTex = pt->AddText(" 1.32#pm0.975");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.322884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.322884,-45.06255,-1.322884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.711872);
   ...
   mainFit1029->SetParameter(0,1.019194);
   mainFit1029->SetParError(0,0.7529085);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7704334);
   mainFit1029->SetParError(1,0.02483561);
