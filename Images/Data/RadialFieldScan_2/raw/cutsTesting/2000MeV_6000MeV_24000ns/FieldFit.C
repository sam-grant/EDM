...
//=========  (Wed Apr 21 14:10:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-56.8651,75,61.16042);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-45.06255);
   Graph_Graph01020->SetMaximum(49.35786);
   ...
   mainFit1021->SetChisquare(3.415765);
   ...
   mainFit1021->SetParameter(0,0.5767794);
   mainFit1021->SetParError(0,0.6723082);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7559715);
   mainFit1021->SetParError(1,0.02222751);
   ...
   pt_LaTex = pt->AddText("0.756#pm0.0222");
   pt_LaTex = pt->AddText("0.577#pm0.672");
   pt_LaTex = pt->AddText("0.763#pm0.893");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.7629644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7629644,-45.06255,-0.7629644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.415765);
   ...
   mainFit1022->SetParameter(0,0.5767794);
   mainFit1022->SetParError(0,0.6723082);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7559715);
   mainFit1022->SetParError(1,0.02222751);
