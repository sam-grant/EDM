...
//=========  (Wed Apr 21 14:10:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.6698902);
   ...
   quadLineFit1002->SetParameter(0,75.08063);
   quadLineFit1002->SetParError(0,0.1025541);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.76948);
   quadLineFit1002->SetParError(1,1.720018);
   ...
   quadLineFit1003->SetChisquare(0.6698902);
   ...
   quadLineFit1003->SetParameter(0,75.08063);
   quadLineFit1003->SetParError(0,0.1025541);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.76948);
   quadLineFit1003->SetParError(1,1.720018);
   ...
   Graph_30_ppm1003->SetMinimum(76.17244);
   Graph_30_ppm1003->SetMaximum(76.74467);
   ...
   quadLineFit1004->SetChisquare(0.349487);
   ...
   quadLineFit1004->SetParameter(0,75.1165);
   quadLineFit1004->SetParError(0,0.08614353);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.79438);
   quadLineFit1004->SetParError(1,1.416089);
   ...
   quadLineFit1005->SetChisquare(0.349487);
   ...
   quadLineFit1005->SetParameter(0,75.1165);
   quadLineFit1005->SetParError(0,0.08614353);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.79438);
   quadLineFit1005->SetParError(1,1.416089);
   ...
   Graph_10_ppm1005->SetMinimum(75.2552);
   Graph_10_ppm1005->SetMaximum(75.52547);
   ...
   quadLineFit1006->SetChisquare(0.03914899);
   ...
   quadLineFit1006->SetParameter(0,74.84793);
   quadLineFit1006->SetParError(0,0.1010372);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.776738);
   quadLineFit1006->SetParError(1,1.638676);
   ...
   quadLineFit1007->SetChisquare(0.03914899);
   ...
   quadLineFit1007->SetParameter(0,74.84793);
   quadLineFit1007->SetParError(0,0.1010372);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.776738);
   quadLineFit1007->SetParError(1,1.638676);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.26109);
   Graph_mI10_ppm1007->SetMaximum(74.5195);
   ...
   quadLineFit1008->SetChisquare(7.716365);
   ...
   quadLineFit1008->SetParameter(0,74.78236);
   quadLineFit1008->SetParError(0,0.08870746);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.653378);
   quadLineFit1008->SetParError(1,1.443902);
   ...
   quadLineFit1009->SetChisquare(7.716365);
   ...
   quadLineFit1009->SetParameter(0,74.78236);
   quadLineFit1009->SetParError(0,0.08870746);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.653378);
   quadLineFit1009->SetParError(1,1.443902);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.00509);
   Graph_mI30_ppm1009->SetMaximum(73.60379);
   ...
   quadLineFit1010->SetChisquare(0.9313841);
   ...
   quadLineFit1010->SetParameter(0,74.71979);
   quadLineFit1010->SetParError(0,0.0839226);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.09871);
   quadLineFit1010->SetParError(1,1.452533);
   ...
   quadLineFit1011->SetChisquare(0.9313841);
   ...
   quadLineFit1011->SetParameter(0,74.71979);
   quadLineFit1011->SetParError(0,0.0839226);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.09871);
   quadLineFit1011->SetParError(1,1.452533);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.17334);
   Graph_mI50_ppm1011->SetMaximum(72.68987);
   ...
   quadLineFit1012->SetChisquare(0.3788104);
   ...
   quadLineFit1012->SetParameter(0,74.38409);
   quadLineFit1012->SetParError(0,0.1692105);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-34.16686);
   quadLineFit1012->SetParError(1,3.027319);
   ...
   quadLineFit1013->SetChisquare(0.3788104);
   ...
   quadLineFit1013->SetParameter(0,74.38409);
   quadLineFit1013->SetParError(0,0.1692105);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-34.16686);
   quadLineFit1013->SetParError(1,3.027319);
