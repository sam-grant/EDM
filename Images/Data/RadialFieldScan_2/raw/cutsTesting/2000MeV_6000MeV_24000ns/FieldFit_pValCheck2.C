...
//=========  (Wed Apr 21 14:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-45.06255);
   Graph_Graph01029->SetMaximum(49.35786);
   ...
   mainFit1030->SetChisquare(3.232129);
   ...
   mainFit1030->SetParameter(0,0.4540988);
   mainFit1030->SetParError(0,0.7307512);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7552416);
   mainFit1030->SetParError(1,0.0222916);
   ...
   pt_LaTex = pt->AddText("0.755#pm0.0223");
   pt_LaTex = pt->AddText("0.454#pm0.731");
   pt_LaTex = pt->AddText("0.601#pm 0.97");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6012629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6012629,-45.06255,-0.6012629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.232129);
   ...
   mainFit1031->SetParameter(0,0.4540988);
   mainFit1031->SetParError(0,0.7307512);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7552416);
   mainFit1031->SetParError(1,0.0222916);
