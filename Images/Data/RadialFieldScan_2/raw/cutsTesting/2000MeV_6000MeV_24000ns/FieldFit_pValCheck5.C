...
//=========  (Wed Apr 21 14:10:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-41.06142,70,57.99968);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.15531);
   Graph_Graph01035->SetMaximum(48.09357);
   ...
   mainFit1036->SetChisquare(2.125982);
   ...
   mainFit1036->SetParameter(0,0.3349259);
   mainFit1036->SetParError(0,0.70523);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7674215);
   mainFit1036->SetParError(1,0.02440715);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.709");
   pt_LaTex = pt->AddText("0.767#pm0.0244");
   pt_LaTex = pt->AddText("0.335#pm0.705");
   pt_LaTex = pt->AddText("0.436#pm0.923");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4364302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4364302,-31.15531,-0.4364302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.125982);
   ...
   mainFit1037->SetParameter(0,0.3349259);
   mainFit1037->SetParError(0,0.70523);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7674215);
   mainFit1037->SetParError(1,0.02440715);
