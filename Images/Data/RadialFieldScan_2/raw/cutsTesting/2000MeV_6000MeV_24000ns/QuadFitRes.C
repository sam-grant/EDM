...
//=========  (Wed Apr 21 14:10:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008785507);
   Graph_Graph11015->SetMaximum(0.01135322);
   ...
   Graph_Graph21016->SetMinimum(-0.002912089);
   Graph_Graph21016->SetMaximum(0.003425306);
   ...
   Graph_Graph31017->SetMinimum(-0.05394737);
   Graph_Graph31017->SetMaximum(0.04015479);
   ...
   Graph_Graph41018->SetMinimum(-0.02569079);
   Graph_Graph41018->SetMaximum(0.01476886);
   ...
   Graph_Graph51019->SetMinimum(-0.008462328);
   Graph_Graph51019->SetMaximum(0.01130264);
