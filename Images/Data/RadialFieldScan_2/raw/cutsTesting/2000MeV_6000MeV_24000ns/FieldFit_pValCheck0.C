...
//=========  (Wed Apr 21 14:10:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-52.29535,50,38.31163);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-43.23465);
   Graph_Graph01025->SetMaximum(29.25093);
   ...
   mainFit1026->SetChisquare(2.131186);
   ...
   mainFit1026->SetParameter(0,0.2716423);
   mainFit1026->SetParError(0,0.724208);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7354344);
   mainFit1026->SetParError(1,0.02867632);
   ...
   pt_LaTex = pt->AddText("0.735#pm0.0287");
   pt_LaTex = pt->AddText("0.272#pm0.724");
   pt_LaTex = pt->AddText("0.369#pm0.983");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.3693631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3693631,-43.23465,-0.3693631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.131186);
   ...
   mainFit1027->SetParameter(0,0.2716423);
   mainFit1027->SetParError(0,0.724208);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7354344);
   mainFit1027->SetParError(1,0.02867632);
