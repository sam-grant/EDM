...
//=========  (Wed Apr 21 14:10:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-45.06255);
   Graph_Graph01031->SetMaximum(49.35786);
   ...
   mainFit1032->SetChisquare(3.345015);
   ...
   mainFit1032->SetParameter(0,0.4745554);
   mainFit1032->SetParError(0,0.7744018);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7575511);
   mainFit1032->SetParError(1,0.02300709);
   ...
   pt_LaTex = pt->AddText("0.758#pm0.023");
   pt_LaTex = pt->AddText("0.475#pm0.774");
   pt_LaTex = pt->AddText("0.626#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6264336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6264336,-45.06255,-0.6264336,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.345015);
   ...
   mainFit1033->SetParameter(0,0.4745554);
   mainFit1033->SetParError(0,0.7744018);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7575511);
   mainFit1033->SetParError(1,0.02300709);
