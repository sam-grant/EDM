...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.68273,70,61.65692);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.74876);
   Graph_Graph01035->SetMaximum(50.72295);
   ...
   mainFit1036->SetChisquare(2.604999);
   ...
   mainFit1036->SetParameter(0,-1.260342);
   mainFit1036->SetParError(0,0.4533027);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8823454);
   mainFit1036->SetParError(1,0.01564867);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.868");
   pt_LaTex = pt->AddText("0.882#pm0.0156");
   pt_LaTex = pt->AddText("#minus1.26#pm0.453");
   pt_LaTex = pt->AddText("#minus1.43#pm0.508");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.428399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.428399,-36.74876,1.428399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.604999);
   ...
   mainFit1037->SetParameter(0,-1.260342);
   mainFit1037->SetParError(0,0.4533027);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8823454);
   mainFit1037->SetParError(1,0.01564867);
