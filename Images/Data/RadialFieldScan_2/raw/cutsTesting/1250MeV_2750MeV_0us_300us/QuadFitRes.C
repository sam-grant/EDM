...
//=========  (Wed Apr 28 14:20:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01762923);
   Graph_Graph11015->SetMaximum(0.02063795);
   ...
   Graph_Graph21016->SetMinimum(-0.004197214);
   Graph_Graph21016->SetMaximum(0.004923306);
   ...
   Graph_Graph31017->SetMinimum(-0.02594319);
   Graph_Graph31017->SetMaximum(0.02659534);
   ...
   Graph_Graph41018->SetMinimum(-0.005087789);
   Graph_Graph41018->SetMaximum(0.006479128);
   ...
   Graph_Graph51019->SetMinimum(-0.01223657);
   Graph_Graph51019->SetMaximum(0.01630815);
