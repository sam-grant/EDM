...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.60025,50,44.13581);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.62664);
   Graph_Graph01025->SetMaximum(33.16221);
   ...
   mainFit1026->SetChisquare(2.163038);
   ...
   mainFit1026->SetParameter(0,-1.14356);
   mainFit1026->SetParError(0,0.4659134);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8900801);
   mainFit1026->SetParError(1,0.01844657);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.721");
   pt_LaTex = pt->AddText(" 0.89#pm0.0184");
   pt_LaTex = pt->AddText("#minus1.14#pm0.466");
   pt_LaTex = pt->AddText("#minus1.28#pm0.527");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.284783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.284783,-54.62664,1.284783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.163038);
   ...
   mainFit1027->SetParameter(0,-1.14356);
   mainFit1027->SetParError(0,0.4659134);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8900801);
   mainFit1027->SetParError(1,0.01844657);
