...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.38536);
   Graph_Graph01029->SetMaximum(52.5081);
   ...
   mainFit1030->SetChisquare(1.14664);
   ...
   mainFit1030->SetParameter(0,-1.48101);
   mainFit1030->SetParError(0,0.4694979);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8810148);
   mainFit1030->SetParError(1,0.01429774);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.382");
   pt_LaTex = pt->AddText("0.881#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.48#pm0.469");
   pt_LaTex = pt->AddText("#minus1.68#pm 0.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.681027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.681027,-56.38536,1.681027,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.14664);
   ...
   mainFit1031->SetParameter(0,-1.48101);
   mainFit1031->SetParError(0,0.4694979);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8810148);
   mainFit1031->SetParError(1,0.01429774);
