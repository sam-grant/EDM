...
//=========  (Wed Apr 28 14:20:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(6.421529);
   ...
   quadLineFit1002->SetParameter(0,74.68365);
   quadLineFit1002->SetParError(0,0.06550567);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.33556);
   quadLineFit1002->SetParError(1,1.098087);
   ...
   quadLineFit1003->SetChisquare(6.421529);
   ...
   quadLineFit1003->SetParameter(0,74.68365);
   quadLineFit1003->SetParError(0,0.06550567);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.33556);
   quadLineFit1003->SetParError(1,1.098087);
   ...
   Graph_30_ppm1003->SetMinimum(75.82805);
   Graph_30_ppm1003->SetMaximum(76.44949);
   ...
   quadLineFit1004->SetChisquare(2.752187);
   ...
   quadLineFit1004->SetParameter(0,74.60475);
   quadLineFit1004->SetParError(0,0.055486);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.93506);
   quadLineFit1004->SetParError(1,0.9114075);
   ...
   quadLineFit1005->SetChisquare(2.752187);
   ...
   quadLineFit1005->SetParameter(0,74.60475);
   quadLineFit1005->SetParError(0,0.055486);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.93506);
   quadLineFit1005->SetParError(1,0.9114075);
   ...
   Graph_10_ppm1005->SetMinimum(74.8874);
   Graph_10_ppm1005->SetMaximum(75.13677);
   ...
   quadLineFit1006->SetChisquare(0.1971756);
   ...
   quadLineFit1006->SetParameter(0,74.47238);
   quadLineFit1006->SetParError(0,0.0650865);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.725851);
   quadLineFit1006->SetParError(1,1.055009);
   ...
   quadLineFit1007->SetChisquare(0.1971756);
   ...
   quadLineFit1007->SetParameter(0,74.47238);
   quadLineFit1007->SetParError(0,0.0650865);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.725851);
   quadLineFit1007->SetParError(1,1.055009);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.75503);
   Graph_mI10_ppm1007->SetMaximum(74.04182);
   ...
   quadLineFit1008->SetChisquare(4.47774);
   ...
   quadLineFit1008->SetParameter(0,74.46898);
   quadLineFit1008->SetParError(0,0.05710301);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.53738);
   quadLineFit1008->SetParError(1,0.9288812);
   ...
   quadLineFit1009->SetChisquare(4.47774);
   ...
   quadLineFit1009->SetParameter(0,74.46898);
   quadLineFit1009->SetParError(0,0.05710301);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.53738);
   quadLineFit1009->SetParError(1,0.9288812);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.41419);
   Graph_mI30_ppm1009->SetMaximum(73.1373);
   ...
   quadLineFit1010->SetChisquare(0.4087157);
   ...
   quadLineFit1010->SetParameter(0,74.53303);
   quadLineFit1010->SetParError(0,0.05393947);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.52658);
   quadLineFit1010->SetParError(1,0.932872);
   ...
   quadLineFit1011->SetChisquare(0.4087157);
   ...
   quadLineFit1011->SetParameter(0,74.53303);
   quadLineFit1011->SetParError(0,0.05393947);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.52658);
   quadLineFit1011->SetParError(1,0.932872);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.54104);
   Graph_mI50_ppm1011->SetMaximum(72.18738);
   ...
   quadLineFit1012->SetChisquare(1.902181);
   ...
   quadLineFit1012->SetParameter(0,74.45563);
   quadLineFit1012->SetParError(0,0.1089594);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.36182);
   quadLineFit1012->SetParError(1,1.94909);
   ...
   quadLineFit1013->SetChisquare(1.902181);
   ...
   quadLineFit1013->SetParameter(0,74.45563);
   quadLineFit1013->SetParError(0,0.1089594);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.36182);
   quadLineFit1013->SetParError(1,1.94909);
