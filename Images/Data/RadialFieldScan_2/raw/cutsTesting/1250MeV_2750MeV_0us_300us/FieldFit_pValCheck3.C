...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.38536);
   Graph_Graph01031->SetMaximum(52.5081);
   ...
   mainFit1032->SetChisquare(2.13776);
   ...
   mainFit1032->SetParameter(0,-1.428141);
   mainFit1032->SetParError(0,0.4977001);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8849083);
   mainFit1032->SetParError(1,0.01476029);
   ...
   pt_LaTex = pt->AddText("0.885#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.43#pm0.498");
   pt_LaTex = pt->AddText("#minus1.61#pm0.556");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.613886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.613886,-56.38536,1.613886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.13776);
   ...
   mainFit1033->SetParameter(0,-1.428141);
   mainFit1033->SetParError(0,0.4977001);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8849083);
   mainFit1033->SetParError(1,0.01476029);
