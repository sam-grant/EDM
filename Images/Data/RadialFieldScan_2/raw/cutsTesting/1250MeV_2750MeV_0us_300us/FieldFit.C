...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.38536);
   Graph_Graph01020->SetMaximum(52.5081);
   ...
   mainFit1021->SetChisquare(2.605051);
   ...
   mainFit1021->SetParameter(0,-1.259355);
   mainFit1021->SetParError(0,0.4321343);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8822989);
   mainFit1021->SetParError(1,0.01425818);
   ...
   mainFit1022->SetChisquare(2.605051);
   ...
   mainFit1022->SetParameter(0,-1.259355);
   mainFit1022->SetParError(0,0.4321343);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8822989);
   mainFit1022->SetParError(1,0.01425818);
