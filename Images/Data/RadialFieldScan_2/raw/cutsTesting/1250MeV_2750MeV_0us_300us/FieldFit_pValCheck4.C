...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.99704,75,66.11978);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-56.38536);
   Graph_Graph01033->SetMaximum(52.5081);
   ...
   mainFit1034->SetChisquare(1.156631);
   ...
   mainFit1034->SetParameter(0,-0.865535);
   mainFit1034->SetParError(0,0.5420501);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8693998);
   mainFit1034->SetParError(1,0.01783733);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.386");
   pt_LaTex = pt->AddText("0.869#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.866#pm0.542");
   pt_LaTex = pt->AddText("#minus0.996#pm0.614");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9955545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9955545,-56.38536,0.9955545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.156631);
   ...
   mainFit1035->SetParameter(0,-0.865535);
   mainFit1035->SetParError(0,0.5420501);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8693998);
   mainFit1035->SetParError(1,0.01783733);
