...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.38536);
   Graph_Graph01027->SetMaximum(52.5081);
   ...
   mainFit1028->SetChisquare(2.460527);
   ...
   mainFit1028->SetParameter(0,-1.177008);
   mainFit1028->SetParError(0,0.4833854);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8849773);
   mainFit1028->SetParError(1,0.01590426);
   ...
   pt_LaTex = pt->AddText("0.885#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.18#pm0.483");
   pt_LaTex = pt->AddText("#minus1.33#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.329987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.329987,-56.38536,1.329987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.460527);
   ...
   mainFit1029->SetParameter(0,-1.177008);
   mainFit1029->SetParError(0,0.4833854);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8849773);
   mainFit1029->SetParError(1,0.01590426);
