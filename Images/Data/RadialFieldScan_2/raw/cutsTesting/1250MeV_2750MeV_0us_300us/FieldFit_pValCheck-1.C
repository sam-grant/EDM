...
//=========  (Wed Apr 28 14:20:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.38536);
   Graph_Graph01023->SetMaximum(52.5081);
   ...
   mainFit1024->SetChisquare(2.605051);
   ...
   mainFit1024->SetParameter(0,-1.259355);
   mainFit1024->SetParError(0,0.4321343);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8822989);
   mainFit1024->SetParError(1,0.01425818);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.651");
   pt_LaTex = pt->AddText("0.882#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.26#pm0.432");
   pt_LaTex = pt->AddText("#minus1.43#pm0.487");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.427357,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.427357,-56.38536,1.427357,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.605051);
   ...
   mainFit1025->SetParameter(0,-1.259355);
   mainFit1025->SetParError(0,0.4321343);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8822989);
   mainFit1025->SetParError(1,0.01425818);
