...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-81.809,75,79.30731);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-65.69737);
   Graph_Graph01031->SetMaximum(63.19568);
   ...
   mainFit1032->SetChisquare(0.04116761);
   ...
   mainFit1032->SetParameter(0,-0.06845351);
   mainFit1032->SetParError(0,2.34818);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.943183);
   mainFit1032->SetParError(1,0.06975374);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0137");
   pt_LaTex = pt->AddText("0.943#pm0.0698");
   pt_LaTex = pt->AddText("#minus0.0685#pm 2.35");
   pt_LaTex = pt->AddText("#minus0.0726#pm 2.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.07257712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.07257712,-65.69737,0.07257712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.04116761);
   ...
   mainFit1033->SetParameter(0,-0.06845351);
   mainFit1033->SetParError(0,2.34818);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.943183);
   mainFit1033->SetParError(1,0.06975374);
