...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-65.69737);
   Graph_Graph01020->SetMaximum(63.19568);
   ...
   mainFit1021->SetChisquare(0.8538194);
   ...
   mainFit1021->SetParameter(0,0.981732);
   mainFit1021->SetParError(0,2.038824);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.927);
   mainFit1021->SetParError(1,0.06740416);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0674");
   pt_LaTex = pt->AddText("0.982#pm 2.04");
   pt_LaTex = pt->AddText(" 1.06#pm 2.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.059042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.059042,-65.69737,-1.059042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(0.8538194);
   ...
   mainFit1022->SetParameter(0,0.981732);
   mainFit1022->SetParError(0,2.038824);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.927);
   mainFit1022->SetParError(1,0.06740416);
