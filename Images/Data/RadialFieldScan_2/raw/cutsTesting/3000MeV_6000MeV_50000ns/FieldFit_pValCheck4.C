...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-65.69737);
   Graph_Graph01033->SetMaximum(63.19568);
   ...
   mainFit1034->SetChisquare(0.5180812);
   ...
   mainFit1034->SetParameter(0,1.872446);
   mainFit1034->SetParError(0,2.553404);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8977275);
   mainFit1034->SetParError(1,0.08423506);
   ...
   pt_LaTex = pt->AddText("0.898#pm0.0842");
   pt_LaTex = pt->AddText(" 1.87#pm 2.55");
   pt_LaTex = pt->AddText(" 2.09#pm 2.94");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.085763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.085763,-65.69737,-2.085763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.5180812);
   ...
   mainFit1035->SetParameter(0,1.872446);
   mainFit1035->SetParError(0,2.553404);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8977275);
   mainFit1035->SetParError(1,0.08423506);
