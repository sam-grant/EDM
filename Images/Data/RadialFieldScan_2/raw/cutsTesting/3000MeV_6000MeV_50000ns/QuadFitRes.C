...
//=========  (Thu Apr 22 10:35:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1007864);
   Graph_Graph11015->SetMaximum(0.04722442);
   ...
   Graph_Graph21016->SetMinimum(-0.04327691);
   Graph_Graph21016->SetMaximum(0.05084676);
   ...
   Graph_Graph31017->SetMinimum(-0.05892977);
   Graph_Graph31017->SetMaximum(0.04687717);
   ...
   Graph_Graph41018->SetMinimum(-0.05317348);
   Graph_Graph41018->SetMaximum(0.04616838);
   ...
   Graph_Graph51019->SetMinimum(-0.01685513);
   Graph_Graph51019->SetMaximum(0.02255864);
