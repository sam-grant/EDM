...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.42249,70,73.83001);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.59724);
   Graph_Graph01035->SetMaximum(61.00476);
   ...
   mainFit1036->SetChisquare(0.8509586);
   ...
   mainFit1036->SetParameter(0,1.016329);
   mainFit1036->SetParError(0,2.13897);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9253603);
   mainFit1036->SetParError(1,0.0740483);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.074");
   pt_LaTex = pt->AddText(" 1.02#pm 2.14");
   pt_LaTex = pt->AddText("  1.1#pm 2.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-1.098306,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.098306,-41.59724,-1.098306,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.8509586);
   ...
   mainFit1037->SetParameter(0,1.016329);
   mainFit1037->SetParError(0,2.13897);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9253603);
   mainFit1037->SetParError(1,0.0740483);
