...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-65.69737);
   Graph_Graph01029->SetMaximum(63.19568);
   ...
   mainFit1030->SetChisquare(0.7621821);
   ...
   mainFit1030->SetParameter(0,1.244193);
   mainFit1030->SetParError(0,2.21543);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9285488);
   mainFit1030->SetParError(1,0.06760111);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0676");
   pt_LaTex = pt->AddText(" 1.24#pm 2.22");
   pt_LaTex = pt->AddText(" 1.34#pm  2.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.339933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.339933,-65.69737,-1.339933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.7621821);
   ...
   mainFit1031->SetParameter(0,1.244193);
   mainFit1031->SetParError(0,2.21543);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9285488);
   mainFit1031->SetParError(1,0.06760111);
