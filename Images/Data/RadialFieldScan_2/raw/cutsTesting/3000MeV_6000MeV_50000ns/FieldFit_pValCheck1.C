...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-65.69737);
   Graph_Graph01027->SetMaximum(63.19568);
   ...
   mainFit1028->SetChisquare(0.8435634);
   ...
   mainFit1028->SetParameter(0,1.086144);
   mainFit1028->SetParError(0,2.284683);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9304129);
   mainFit1028->SetParError(1,0.07535933);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0754");
   pt_LaTex = pt->AddText(" 1.09#pm 2.28");
   pt_LaTex = pt->AddText(" 1.17#pm 2.45");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.167378,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.167378,-65.69737,-1.167378,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8435634);
   ...
   mainFit1029->SetParameter(0,1.086144);
   mainFit1029->SetParError(0,2.284683);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9304129);
   mainFit1029->SetParError(1,0.07535933);
