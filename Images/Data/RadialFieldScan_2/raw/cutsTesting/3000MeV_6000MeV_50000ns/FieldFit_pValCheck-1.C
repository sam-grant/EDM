...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-65.69737);
   Graph_Graph01023->SetMaximum(63.19568);
   ...
   mainFit1024->SetChisquare(0.8538194);
   ...
   mainFit1024->SetParameter(0,0.981732);
   mainFit1024->SetParError(0,2.038824);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.927);
   mainFit1024->SetParError(1,0.06740416);
   ...
   mainFit1025->SetChisquare(0.8538194);
   ...
   mainFit1025->SetParameter(0,0.981732);
   mainFit1025->SetParError(0,2.038824);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.927);
   mainFit1025->SetParError(1,0.06740416);
