...
//=========  (Thu Apr 22 10:35:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-76.88055,50,54.66505);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-63.72599);
   Graph_Graph01025->SetMaximum(41.51049);
   ...
   mainFit1026->SetChisquare(0.8530611);
   ...
   mainFit1026->SetParameter(0,1.004225);
   mainFit1026->SetParError(0,2.196387);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9285092);
   mainFit1026->SetParError(1,0.08689298);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.284");
   pt_LaTex = pt->AddText("0.929#pm0.0869");
   pt_LaTex = pt->AddText("    1#pm  2.2");
   pt_LaTex = pt->AddText(" 1.08#pm 2.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-1.081546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.081546,-63.72599,-1.081546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.8530611);
   ...
   mainFit1027->SetParameter(0,1.004225);
   mainFit1027->SetParError(0,2.196387);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9285092);
   mainFit1027->SetParError(1,0.08689298);
