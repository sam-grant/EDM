...
//=========  (Thu Apr 22 10:35:32 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.549502);
   ...
   quadLineFit1002->SetParameter(0,74.74181);
   quadLineFit1002->SetParError(0,0.3115252);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,47.22871);
   quadLineFit1002->SetParError(1,5.225884);
   ...
   quadLineFit1003->SetChisquare(5.549502);
   ...
   quadLineFit1003->SetParameter(0,74.74181);
   quadLineFit1003->SetParError(0,0.3115252);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,47.22871);
   quadLineFit1003->SetParError(1,5.225884);
   ...
   Graph_30_ppm1003->SetMinimum(76.1075);
   Graph_30_ppm1003->SetMaximum(76.99373);
   ...
   quadLineFit1004->SetChisquare(1.439207);
   ...
   quadLineFit1004->SetParameter(0,74.80889);
   quadLineFit1004->SetParError(0,0.2609643);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,28.44829);
   quadLineFit1004->SetParError(1,4.29249);
   ...
   quadLineFit1005->SetChisquare(1.439207);
   ...
   quadLineFit1005->SetParameter(0,74.80889);
   quadLineFit1005->SetParError(0,0.2609643);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,28.44829);
   quadLineFit1005->SetParError(1,4.29249);
   ...
   Graph_10_ppm1005->SetMinimum(75.24697);
   Graph_10_ppm1005->SetMaximum(75.65415);
   ...
   quadLineFit1006->SetChisquare(0.9327123);
   ...
   quadLineFit1006->SetParameter(0,74.86651);
   quadLineFit1006->SetParError(0,0.3069631);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.876897);
   quadLineFit1006->SetParError(1,4.979711);
   ...
   quadLineFit1007->SetChisquare(0.9327123);
   ...
   quadLineFit1007->SetParameter(0,74.86651);
   quadLineFit1007->SetParError(0,0.3069631);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.876897);
   quadLineFit1007->SetParError(1,4.979711);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.25225);
   Graph_mI10_ppm1007->SetMaximum(74.5822);
   ...
   quadLineFit1008->SetChisquare(0.9666663);
   ...
   quadLineFit1008->SetParameter(0,74.69409);
   quadLineFit1008->SetParError(0,0.2687593);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-4.901313);
   quadLineFit1008->SetParError(1,4.37807);
   ...
   quadLineFit1009->SetChisquare(0.9666663);
   ...
   quadLineFit1009->SetParameter(0,74.69409);
   quadLineFit1009->SetParError(0,0.2687593);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-4.901313);
   quadLineFit1009->SetParError(1,4.37807);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.7772);
   Graph_mI30_ppm1009->SetMaximum(73.61389);
   ...
   quadLineFit1010->SetChisquare(1.376126);
   ...
   quadLineFit1010->SetParameter(0,74.93488);
   quadLineFit1010->SetParError(0,0.2542765);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.64403);
   quadLineFit1010->SetParError(1,4.403039);
   ...
   quadLineFit1011->SetChisquare(1.376126);
   ...
   quadLineFit1011->SetParameter(0,74.93488);
   quadLineFit1011->SetParError(0,0.2542765);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.64403);
   quadLineFit1011->SetParError(1,4.403039);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.8565);
   Graph_mI50_ppm1011->SetMaximum(72.64515);
   ...
   quadLineFit1012->SetChisquare(0.164617);
   ...
   quadLineFit1012->SetParameter(0,74.87627);
   quadLineFit1012->SetParError(0,0.5115986);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.80302);
   quadLineFit1012->SetParError(1,9.153265);
   ...
   quadLineFit1013->SetChisquare(0.164617);
   ...
   quadLineFit1013->SetParameter(0,74.87627);
   quadLineFit1013->SetParError(0,0.5115986);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.80302);
   quadLineFit1013->SetParError(1,9.153265);
