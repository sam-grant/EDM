...
//=========  (Wed Apr 21 21:45:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.40384);
   Graph_Graph01023->SetMaximum(52.84368);
   ...
   mainFit1024->SetChisquare(5.643555);
   ...
   mainFit1024->SetParameter(0,0.3590354);
   mainFit1024->SetParError(0,1.197234);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7933829);
   mainFit1024->SetParError(1,0.03950587);
   ...
   pt_LaTex = pt->AddText("0.793#pm0.0395");
   pt_LaTex = pt->AddText("0.359#pm  1.2");
   pt_LaTex = pt->AddText("0.453#pm 1.51");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4525374,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4525374,-56.40384,-0.4525374,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.643555);
   ...
   mainFit1025->SetParameter(0,0.3590354);
   mainFit1025->SetParError(0,1.197234);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7933829);
   mainFit1025->SetParError(1,0.03950587);
