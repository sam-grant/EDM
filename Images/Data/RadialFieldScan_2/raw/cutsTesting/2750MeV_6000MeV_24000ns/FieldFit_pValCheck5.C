...
//=========  (Wed Apr 21 21:45:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.10506,70,61.70867);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.32369);
   Graph_Graph01035->SetMaximum(50.9273);
   ...
   mainFit1036->SetChisquare(5.349989);
   ...
   mainFit1036->SetParameter(0,0.5650058);
   mainFit1036->SetParError(0,1.256137);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7836825);
   mainFit1036->SetParError(1,0.04337331);
   ...
   pt_LaTex = pt->AddText("0.784#pm0.0434");
   pt_LaTex = pt->AddText("0.565#pm 1.26");
   pt_LaTex = pt->AddText("0.721#pm 1.61");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.7209627,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7209627,-35.32369,-0.7209627,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.349989);
   ...
   mainFit1037->SetParameter(0,0.5650058);
   mainFit1037->SetParError(0,1.256137);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7836825);
   mainFit1037->SetParError(1,0.04337331);
