...
//=========  (Wed Apr 21 21:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.40384);
   Graph_Graph01027->SetMaximum(52.84368);
   ...
   mainFit1028->SetChisquare(4.925577);
   ...
   mainFit1028->SetParameter(0,0.8682302);
   mainFit1028->SetParError(0,1.339587);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8099498);
   mainFit1028->SetParError(1,0.0440793);
   ...
   pt_LaTex = pt->AddText(" 0.81#pm0.0441");
   pt_LaTex = pt->AddText("0.868#pm 1.34");
   pt_LaTex = pt->AddText(" 1.07#pm 1.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.071956,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.071956,-56.40384,-1.071956,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.925577);
   ...
   mainFit1029->SetParameter(0,0.8682302);
   mainFit1029->SetParError(0,1.339587);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8099498);
   mainFit1029->SetParError(1,0.0440793);
