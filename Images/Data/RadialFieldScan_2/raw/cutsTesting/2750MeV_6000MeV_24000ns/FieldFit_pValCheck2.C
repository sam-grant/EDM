...
//=========  (Wed Apr 21 21:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.40384);
   Graph_Graph01029->SetMaximum(52.84368);
   ...
   mainFit1030->SetChisquare(5.320993);
   ...
   mainFit1030->SetParameter(0,0.64789);
   mainFit1030->SetParError(0,1.30075);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7950428);
   mainFit1030->SetParError(1,0.03961503);
   ...
   pt_LaTex = pt->AddText("0.795#pm0.0396");
   pt_LaTex = pt->AddText("0.648#pm  1.3");
   pt_LaTex = pt->AddText("0.815#pm 1.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8149121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8149121,-56.40384,-0.8149121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.320993);
   ...
   mainFit1031->SetParameter(0,0.64789);
   mainFit1031->SetParError(0,1.30075);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7950428);
   mainFit1031->SetParError(1,0.03961503);
