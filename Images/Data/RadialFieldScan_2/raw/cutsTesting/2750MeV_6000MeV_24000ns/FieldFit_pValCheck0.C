...
//=========  (Wed Apr 21 21:45:19 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.37241,50,43.06275);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.52889);
   Graph_Graph01025->SetMaximum(32.21923);
   ...
   mainFit1026->SetChisquare(5.548994);
   ...
   mainFit1026->SetParameter(0,0.2109837);
   mainFit1026->SetParError(0,1.290405);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7834238);
   mainFit1026->SetParError(1,0.05107881);
   ...
   pt_LaTex = pt->AddText("0.783#pm0.0511");
   pt_LaTex = pt->AddText("0.211#pm 1.29");
   pt_LaTex = pt->AddText("0.269#pm 1.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.2693098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2693098,-54.52889,-0.2693098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.548994);
   ...
   mainFit1027->SetParameter(0,0.2109837);
   mainFit1027->SetParError(0,1.290405);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7834238);
   mainFit1027->SetParError(1,0.05107881);
