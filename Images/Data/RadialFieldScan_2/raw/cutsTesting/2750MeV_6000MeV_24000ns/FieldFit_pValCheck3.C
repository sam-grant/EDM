...
//=========  (Wed Apr 21 21:45:20 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.05978,75,66.49962);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-56.40384);
   Graph_Graph01031->SetMaximum(52.84368);
   ...
   mainFit1032->SetChisquare(0.2373174);
   ...
   mainFit1032->SetParameter(0,-1.231858);
   mainFit1032->SetParError(0,1.378957);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.817997);
   mainFit1032->SetParError(1,0.04089963);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0791");
   pt_LaTex = pt->AddText("0.818#pm0.0409");
   pt_LaTex = pt->AddText("#minus1.23#pm 1.38");
   pt_LaTex = pt->AddText("#minus1.51#pm 1.67");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.505945,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.505945,-56.40384,1.505945,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.2373174);
   ...
   mainFit1033->SetParameter(0,-1.231858);
   mainFit1033->SetParError(0,1.378957);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.817997);
   mainFit1033->SetParError(1,0.04089963);
