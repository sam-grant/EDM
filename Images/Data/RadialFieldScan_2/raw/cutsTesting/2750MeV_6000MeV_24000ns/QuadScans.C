...
//=========  (Wed Apr 21 21:45:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.406681);
   ...
   quadLineFit1002->SetParameter(0,75.22356);
   quadLineFit1002->SetParError(0,0.1815165);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.6955);
   quadLineFit1002->SetParError(1,3.044216);
   ...
   quadLineFit1003->SetChisquare(4.406681);
   ...
   quadLineFit1003->SetParameter(0,75.22356);
   quadLineFit1003->SetParError(0,0.1815165);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.6955);
   quadLineFit1003->SetParError(1,3.044216);
   ...
   Graph_30_ppm1003->SetMinimum(76.30097);
   Graph_30_ppm1003->SetMaximum(76.96056);
   ...
   quadLineFit1004->SetChisquare(1.08217);
   ...
   quadLineFit1004->SetParameter(0,75.25704);
   quadLineFit1004->SetParError(0,0.1533622);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.46821);
   quadLineFit1004->SetParError(1,2.522012);
   ...
   quadLineFit1005->SetChisquare(1.08217);
   ...
   quadLineFit1005->SetParameter(0,75.25704);
   quadLineFit1005->SetParError(0,0.1533622);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.46821);
   quadLineFit1005->SetParError(1,2.522012);
   ...
   Graph_10_ppm1005->SetMinimum(75.44398);
   Graph_10_ppm1005->SetMaximum(75.72989);
   ...
   quadLineFit1006->SetChisquare(2.861117);
   ...
   quadLineFit1006->SetParameter(0,75.13261);
   quadLineFit1006->SetParError(0,0.1801672);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.778762);
   quadLineFit1006->SetParError(1,2.922526);
   ...
   quadLineFit1007->SetChisquare(2.861117);
   ...
   quadLineFit1007->SetParameter(0,75.13261);
   quadLineFit1007->SetParError(0,0.1801672);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.778762);
   quadLineFit1007->SetParError(1,2.922526);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.40452);
   Graph_mI10_ppm1007->SetMaximum(74.67094);
   ...
   quadLineFit1008->SetChisquare(9.510994);
   ...
   quadLineFit1008->SetParameter(0,74.68487);
   quadLineFit1008->SetParError(0,0.1580319);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-2.439739);
   quadLineFit1008->SetParError(1,2.573395);
   ...
   quadLineFit1009->SetChisquare(9.510994);
   ...
   quadLineFit1009->SetParameter(0,74.68487);
   quadLineFit1009->SetParError(0,0.1580319);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-2.439739);
   quadLineFit1009->SetParError(1,2.573395);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.04903);
   Graph_mI30_ppm1009->SetMaximum(73.74195);
   ...
   quadLineFit1010->SetChisquare(1.486441);
   ...
   quadLineFit1010->SetParameter(0,74.95122);
   quadLineFit1010->SetParError(0,0.1494433);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.54916);
   quadLineFit1010->SetParError(1,2.586946);
   ...
   quadLineFit1011->SetChisquare(1.486441);
   ...
   quadLineFit1011->SetParameter(0,74.95122);
   quadLineFit1011->SetParError(0,0.1494433);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.54916);
   quadLineFit1011->SetParError(1,2.586946);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.14068);
   Graph_mI50_ppm1011->SetMaximum(72.80674);
   ...
   quadLineFit1012->SetChisquare(0.0197052);
   ...
   quadLineFit1012->SetParameter(0,74.86444);
   quadLineFit1012->SetParError(0,0.3014449);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.90695);
   quadLineFit1012->SetParError(1,5.392931);
   ...
   quadLineFit1013->SetChisquare(0.0197052);
   ...
   quadLineFit1013->SetParameter(0,74.86444);
   quadLineFit1013->SetParError(0,0.3014449);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.90695);
   quadLineFit1013->SetParError(1,5.392931);
