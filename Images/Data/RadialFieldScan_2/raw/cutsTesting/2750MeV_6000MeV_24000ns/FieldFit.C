...
//=========  (Wed Apr 21 21:45:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.40384);
   Graph_Graph01020->SetMaximum(52.84368);
   ...
   mainFit1021->SetChisquare(5.643555);
   ...
   mainFit1021->SetParameter(0,0.3590354);
   mainFit1021->SetParError(0,1.197234);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7933829);
   mainFit1021->SetParError(1,0.03950587);
   ...
   mainFit1022->SetChisquare(5.643555);
   ...
   mainFit1022->SetParameter(0,0.3590354);
   mainFit1022->SetParError(0,1.197234);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7933829);
   mainFit1022->SetParError(1,0.03950587);
