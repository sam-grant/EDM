...
//=========  (Wed Apr 21 21:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.40384);
   Graph_Graph01033->SetMaximum(52.84368);
   ...
   mainFit1034->SetChisquare(4.333551);
   ...
   mainFit1034->SetParameter(0,1.395332);
   mainFit1034->SetParError(0,1.501048);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7594351);
   mainFit1034->SetParError(1,0.04940086);
   ...
   pt_LaTex = pt->AddText("0.759#pm0.0494");
   pt_LaTex = pt->AddText("  1.4#pm  1.5");
   pt_LaTex = pt->AddText(" 1.84#pm 2.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.837329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.837329,-56.40384,-1.837329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.333551);
   ...
   mainFit1035->SetParameter(0,1.395332);
   mainFit1035->SetParError(0,1.501048);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7594351);
   mainFit1035->SetParError(1,0.04940086);
