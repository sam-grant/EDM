...
//=========  (Wed Apr 21 21:45:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04822336);
   Graph_Graph11015->SetMaximum(0.02631195);
   ...
   Graph_Graph21016->SetMinimum(-0.04440594);
   Graph_Graph21016->SetMaximum(0.05231668);
   ...
   Graph_Graph31017->SetMinimum(-0.09975599);
   Graph_Graph31017->SetMaximum(0.08816276);
   ...
   Graph_Graph41018->SetMinimum(-0.04619689);
   Graph_Graph41018->SetMaximum(0.03402381);
   ...
   Graph_Graph51019->SetMinimum(-0.003437674);
   Graph_Graph51019->SetMaximum(0.004590807);
