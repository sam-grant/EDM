...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009794504);
   Graph_Graph11015->SetMaximum(0.009039467);
   ...
   Graph_Graph21016->SetMinimum(-0.01403754);
   Graph_Graph21016->SetMaximum(0.01648243);
   ...
   Graph_Graph31017->SetMinimum(-0.01763533);
   Graph_Graph31017->SetMaximum(0.01290726);
   ...
   Graph_Graph41018->SetMinimum(-0.01266195);
   Graph_Graph41018->SetMaximum(0.01754473);
   ...
   Graph_Graph51019->SetMinimum(-0.002673641);
   Graph_Graph51019->SetMaximum(0.003564609);
