...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.17741);
   Graph_Graph01027->SetMaximum(56.44529);
   ...
   mainFit1028->SetChisquare(1.396151);
   ...
   mainFit1028->SetParameter(0,-1.445721);
   mainFit1028->SetParError(0,0.394619);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9479333);
   mainFit1028->SetParError(1,0.0130131);
   ...
   pt_LaTex = pt->AddText("#minus1.45#pm0.395");
   pt_LaTex = pt->AddText("#minus1.53#pm0.418");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.525129,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.525129,-59.17741,1.525129,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.396151);
   ...
   mainFit1029->SetParameter(0,-1.445721);
   mainFit1029->SetParError(0,0.394619);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9479333);
   mainFit1029->SetParError(1,0.0130131);
