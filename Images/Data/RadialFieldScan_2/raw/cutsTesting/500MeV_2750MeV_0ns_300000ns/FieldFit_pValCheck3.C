...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.17741);
   Graph_Graph01031->SetMaximum(56.44529);
   ...
   mainFit1032->SetChisquare(1.703663);
   ...
   mainFit1032->SetParameter(0,-1.461076);
   mainFit1032->SetParError(0,0.4057788);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9402702);
   mainFit1032->SetParError(1,0.01205379);
   ...
   pt_LaTex = pt->AddText(" 0.94#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.46#pm0.406");
   pt_LaTex = pt->AddText("#minus1.55#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.55389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.55389,-59.17741,1.55389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.703663);
   ...
   mainFit1033->SetParameter(0,-1.461076);
   mainFit1033->SetParError(0,0.4057788);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9402702);
   mainFit1033->SetParError(1,0.01205379);
