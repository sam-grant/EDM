...
//=========  (Mon Apr 26 22:07:11 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.680345);
   ...
   quadLineFit1002->SetParameter(0,74.48778);
   quadLineFit1002->SetParError(0,0.05375605);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.90869);
   quadLineFit1002->SetParError(1,0.9013766);
   ...
   quadLineFit1003->SetChisquare(4.680345);
   ...
   quadLineFit1003->SetParameter(0,74.48778);
   quadLineFit1003->SetParError(0,0.05375605);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.90869);
   quadLineFit1003->SetParError(1,0.9013766);
   ...
   Graph_30_ppm1003->SetMinimum(75.76271);
   Graph_30_ppm1003->SetMaximum(76.41722);
   ...
   quadLineFit1004->SetChisquare(0.9158083);
   ...
   quadLineFit1004->SetParameter(0,74.48259);
   quadLineFit1004->SetParError(0,0.04521703);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.1237);
   quadLineFit1004->SetParError(1,0.7428259);
   ...
   quadLineFit1005->SetChisquare(0.9158083);
   ...
   quadLineFit1005->SetParameter(0,74.48259);
   quadLineFit1005->SetParError(0,0.04521703);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.1237);
   quadLineFit1005->SetParError(1,0.7428259);
   ...
   Graph_10_ppm1005->SetMinimum(74.78098);
   Graph_10_ppm1005->SetMaximum(75.0256);
   ...
   quadLineFit1006->SetChisquare(3.317962);
   ...
   quadLineFit1006->SetParameter(0,74.36223);
   quadLineFit1006->SetParError(0,0.05302383);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.621947);
   quadLineFit1006->SetParError(1,0.8596216);
   ...
   quadLineFit1007->SetChisquare(3.317962);
   ...
   quadLineFit1007->SetParameter(0,74.36223);
   quadLineFit1007->SetParError(0,0.05302383);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.621947);
   quadLineFit1007->SetParError(1,0.8596216);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.52759);
   Graph_mI10_ppm1007->SetMaximum(73.84854);
   ...
   quadLineFit1008->SetChisquare(3.159616);
   ...
   quadLineFit1008->SetParameter(0,74.38993);
   quadLineFit1008->SetParError(0,0.04654159);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.5167);
   quadLineFit1008->SetParError(1,0.7572234);
   ...
   quadLineFit1009->SetChisquare(3.159616);
   ...
   quadLineFit1009->SetParameter(0,74.38993);
   quadLineFit1009->SetParError(0,0.04654159);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.5167);
   quadLineFit1009->SetParError(1,0.7572234);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12336);
   Graph_mI30_ppm1009->SetMaximum(72.87921);
   ...
   quadLineFit1010->SetChisquare(2.371009);
   ...
   quadLineFit1010->SetParameter(0,74.34744);
   quadLineFit1010->SetParError(0,0.0439494);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.92103);
   quadLineFit1010->SetParError(1,0.7602397);
   ...
   quadLineFit1011->SetChisquare(2.371009);
   ...
   quadLineFit1011->SetParameter(0,74.34744);
   quadLineFit1011->SetParError(0,0.0439494);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.92103);
   quadLineFit1011->SetParError(1,0.7602397);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20793);
   Graph_mI50_ppm1011->SetMaximum(71.88332);
   ...
   quadLineFit1012->SetChisquare(0.1373059);
   ...
   quadLineFit1012->SetParameter(0,74.27703);
   quadLineFit1012->SetParError(0,0.08872715);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.95486);
   quadLineFit1012->SetParError(1,1.587331);
   ...
   quadLineFit1013->SetChisquare(0.1373059);
   ...
   quadLineFit1013->SetParameter(0,74.27703);
   quadLineFit1013->SetParError(0,0.08872715);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.95486);
   quadLineFit1013->SetParError(1,1.587331);
