...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.17741);
   Graph_Graph01023->SetMaximum(56.44529);
   ...
   mainFit1024->SetChisquare(2.251431);
   ...
   mainFit1024->SetParameter(0,-1.609993);
   mainFit1024->SetParError(0,0.3523798);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9425671);
   mainFit1024->SetParError(1,0.01164743);
   ...
   mainFit1025->SetChisquare(2.251431);
   ...
   mainFit1025->SetParameter(0,-1.609993);
   mainFit1025->SetParError(0,0.3523798);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9425671);
   mainFit1025->SetParError(1,0.01164743);
