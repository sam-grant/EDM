...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.05411,70,66.1829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.43041);
   Graph_Graph01035->SetMaximum(54.5592);
   ...
   mainFit1036->SetChisquare(1.942996);
   ...
   mainFit1036->SetParameter(0,-1.671876);
   mainFit1036->SetParError(0,0.3695776);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9454974);
   mainFit1036->SetParError(1,0.0127868);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.67#pm 0.37");
   pt_LaTex = pt->AddText("#minus1.77#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.76825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.76825,-38.43041,1.76825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.942996);
   ...
   mainFit1037->SetParameter(0,-1.671876);
   mainFit1037->SetParError(0,0.3695776);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9454974);
   mainFit1037->SetParError(1,0.0127868);
