...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.17741);
   Graph_Graph01029->SetMaximum(56.44529);
   ...
   mainFit1030->SetChisquare(1.193409);
   ...
   mainFit1030->SetParameter(0,-1.764269);
   mainFit1030->SetParError(0,0.3829718);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9416532);
   mainFit1030->SetParError(1,0.01168124);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.398");
   pt_LaTex = pt->AddText("0.942#pm0.0117");
   pt_LaTex = pt->AddText("#minus1.76#pm0.383");
   pt_LaTex = pt->AddText("#minus1.87#pm0.405");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.873586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.873586,-59.17741,1.873586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.193409);
   ...
   mainFit1031->SetParameter(0,-1.764269);
   mainFit1031->SetParError(0,0.3829718);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9416532);
   mainFit1031->SetParError(1,0.01168124);
