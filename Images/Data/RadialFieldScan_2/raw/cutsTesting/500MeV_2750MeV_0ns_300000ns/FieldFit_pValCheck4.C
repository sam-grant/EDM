...
//=========  (Mon Apr 26 22:07:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.17741);
   Graph_Graph01033->SetMaximum(56.44529);
   ...
   mainFit1034->SetChisquare(2.247467);
   ...
   mainFit1034->SetParameter(0,-1.593218);
   mainFit1034->SetParError(0,0.4417631);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.942016);
   mainFit1034->SetParError(1,0.01456969);
   ...
   pt_LaTex = pt->AddText("0.942#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.59#pm0.442");
   pt_LaTex = pt->AddText("#minus1.69#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.691286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.691286,-59.17741,1.691286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.247467);
   ...
   mainFit1035->SetParameter(0,-1.593218);
   mainFit1035->SetParError(0,0.4417631);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.942016);
   mainFit1035->SetParError(1,0.01456969);
