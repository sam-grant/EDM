...
//=========  (Wed Apr 28 14:28:25 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.8166,70,66.30625);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.20431);
   Graph_Graph01035->SetMaximum(54.69397);
   ...
   mainFit1036->SetChisquare(2.442493);
   ...
   mainFit1036->SetParameter(0,-1.443596);
   mainFit1036->SetParError(0,0.3996481);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9425902);
   mainFit1036->SetParError(1,0.01382502);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.814");
   pt_LaTex = pt->AddText("0.943#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.44#pm  0.4");
   pt_LaTex = pt->AddText("#minus1.53#pm0.419");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.53152,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.53152,-38.20431,1.53152,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.442493);
   ...
   mainFit1037->SetParameter(0,-1.443596);
   mainFit1037->SetParError(0,0.3996481);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9425902);
   mainFit1037->SetParError(1,0.01382502);
