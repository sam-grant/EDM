...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-71.23013,50,46.61106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.44601);
   Graph_Graph01025->SetMaximum(34.82694);
   ...
   mainFit1026->SetChisquare(2.82866);
   ...
   mainFit1026->SetParameter(0,-1.564813);
   mainFit1026->SetParError(0,0.4106842);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9437522);
   mainFit1026->SetParError(1,0.01625947);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.943");
   pt_LaTex = pt->AddText("0.944#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.56#pm0.411");
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.658076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.658076,-59.44601,1.658076,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.82866);
   ...
   mainFit1027->SetParameter(0,-1.564813);
   mainFit1027->SetParError(0,0.4106842);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9437522);
   mainFit1027->SetParError(1,0.01625947);
