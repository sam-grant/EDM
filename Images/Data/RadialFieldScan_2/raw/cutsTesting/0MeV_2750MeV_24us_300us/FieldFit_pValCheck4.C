...
//=========  (Wed Apr 28 14:28:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.44417);
   Graph_Graph01033->SetMaximum(56.80668);
   ...
   mainFit1034->SetChisquare(2.671758);
   ...
   mainFit1034->SetParameter(0,-1.66144);
   mainFit1034->SetParError(0,0.4776286);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9509226);
   mainFit1034->SetParError(1,0.01574914);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.891");
   pt_LaTex = pt->AddText("0.951#pm0.0157");
   pt_LaTex = pt->AddText("#minus1.66#pm0.478");
   pt_LaTex = pt->AddText("#minus1.75#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.747187,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.747187,-61.44417,1.747187,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.671758);
   ...
   mainFit1035->SetParameter(0,-1.66144);
   mainFit1035->SetParError(0,0.4776286);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9509226);
   mainFit1035->SetParError(1,0.01574914);
