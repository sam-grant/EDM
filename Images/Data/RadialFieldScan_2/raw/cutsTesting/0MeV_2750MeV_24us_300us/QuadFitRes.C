...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003749066);
   Graph_Graph11015->SetMaximum(0.010735);
   ...
   Graph_Graph21016->SetMinimum(-0.004059921);
   Graph_Graph21016->SetMaximum(0.004768199);
   ...
   Graph_Graph31017->SetMinimum(-0.01808611);
   Graph_Graph31017->SetMaximum(0.01835171);
   ...
   Graph_Graph41018->SetMinimum(-0.004678265);
   Graph_Graph41018->SetMaximum(0.008250223);
   ...
   Graph_Graph51019->SetMinimum(-0.00338792);
   Graph_Graph51019->SetMaximum(0.004527229);
