...
//=========  (Wed Apr 28 14:28:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.44417);
   Graph_Graph01031->SetMaximum(56.80668);
   ...
   mainFit1032->SetChisquare(2.691165);
   ...
   mainFit1032->SetParameter(0,-1.426177);
   mainFit1032->SetParError(0,0.4387891);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.944915);
   mainFit1032->SetParError(1,0.01303172);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.897");
   pt_LaTex = pt->AddText("0.945#pm0.013");
   pt_LaTex = pt->AddText("#minus1.43#pm0.439");
   pt_LaTex = pt->AddText("#minus1.51#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.509318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.509318,-61.44417,1.509318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.691165);
   ...
   mainFit1033->SetParameter(0,-1.426177);
   mainFit1033->SetParError(0,0.4387891);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.944915);
   mainFit1033->SetParError(1,0.01303172);
