...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-76.22553,75,71.58804);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-61.44417);
   Graph_Graph01023->SetMaximum(56.80668);
   ...
   mainFit1024->SetChisquare(2.896747);
   ...
   mainFit1024->SetParameter(0,-1.524836);
   mainFit1024->SetParError(0,0.3810373);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9464362);
   mainFit1024->SetParError(1,0.01259248);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.724");
   pt_LaTex = pt->AddText("0.946#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.52#pm0.381");
   pt_LaTex = pt->AddText("#minus1.61#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.611135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.611135,-61.44417,1.611135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.896747);
   ...
   mainFit1025->SetParameter(0,-1.524836);
   mainFit1025->SetParError(0,0.3810373);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9464362);
   mainFit1025->SetParError(1,0.01259248);
