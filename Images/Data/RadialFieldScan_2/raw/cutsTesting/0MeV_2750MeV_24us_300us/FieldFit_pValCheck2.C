...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.44417);
   Graph_Graph01029->SetMaximum(56.80668);
   ...
   mainFit1030->SetChisquare(1.120138);
   ...
   mainFit1030->SetParameter(0,-1.741104);
   mainFit1030->SetParError(0,0.414145);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9451555);
   mainFit1030->SetParError(1,0.01262906);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.74#pm0.414");
   pt_LaTex = pt->AddText("#minus1.84#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.842135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.842135,-61.44417,1.842135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.120138);
   ...
   mainFit1031->SetParameter(0,-1.741104);
   mainFit1031->SetParError(0,0.414145);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9451555);
   mainFit1031->SetParError(1,0.01262906);
