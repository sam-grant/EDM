...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.44417);
   Graph_Graph01027->SetMaximum(56.80668);
   ...
   mainFit1028->SetChisquare(1.681514);
   ...
   mainFit1028->SetParameter(0,-1.313399);
   mainFit1028->SetParError(0,0.4265889);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9533406);
   mainFit1028->SetParError(1,0.01406431);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.561");
   pt_LaTex = pt->AddText("0.953#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.31#pm0.427");
   pt_LaTex = pt->AddText("#minus1.38#pm0.449");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.37768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.37768,-61.44417,1.37768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.681514);
   ...
   mainFit1029->SetParameter(0,-1.313399);
   mainFit1029->SetParError(0,0.4265889);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9533406);
   mainFit1029->SetParError(1,0.01406431);
