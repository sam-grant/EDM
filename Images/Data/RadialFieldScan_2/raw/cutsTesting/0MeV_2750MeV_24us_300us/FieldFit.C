...
//=========  (Wed Apr 28 14:28:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.44417);
   Graph_Graph01020->SetMaximum(56.80668);
   ...
   mainFit1021->SetChisquare(2.896747);
   ...
   mainFit1021->SetParameter(0,-1.524836);
   mainFit1021->SetParError(0,0.3810373);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9464362);
   mainFit1021->SetParError(1,0.01259248);
   ...
   mainFit1022->SetChisquare(2.896747);
   ...
   mainFit1022->SetParameter(0,-1.524836);
   mainFit1022->SetParError(0,0.3810373);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9464362);
   mainFit1022->SetParError(1,0.01259248);
