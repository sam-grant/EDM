...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.06938);
   Graph_Graph01027->SetMaximum(50.80462);
   ...
   mainFit1028->SetChisquare(0.2752739);
   ...
   mainFit1028->SetParameter(0,0.3309549);
   mainFit1028->SetParError(0,0.6053836);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8149707);
   mainFit1028->SetParError(1,0.02002243);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0918");
   pt_LaTex = pt->AddText("0.815#pm 0.02");
   pt_LaTex = pt->AddText("0.331#pm0.605");
   pt_LaTex = pt->AddText("0.406#pm0.742");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4060942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4060942,-52.06938,-0.4060942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2752739);
   ...
   mainFit1029->SetParameter(0,0.3309549);
   mainFit1029->SetParError(0,0.6053836);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8149707);
   mainFit1029->SetParError(1,0.02002243);
