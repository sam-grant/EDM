...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.33931,50,40.71727);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.23365);
   Graph_Graph01025->SetMaximum(30.61161);
   ...
   mainFit1026->SetChisquare(1.664707);
   ...
   mainFit1026->SetParameter(0,-0.2267317);
   mainFit1026->SetParError(0,0.5814017);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7908036);
   mainFit1026->SetParError(1,0.02302633);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.555");
   pt_LaTex = pt->AddText("0.791#pm0.023");
   pt_LaTex = pt->AddText("#minus0.227#pm0.581");
   pt_LaTex = pt->AddText("#minus0.287#pm0.736");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.2867105,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2867105,-50.23365,0.2867105,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.664707);
   ...
   mainFit1027->SetParameter(0,-0.2267317);
   mainFit1027->SetParError(0,0.5814017);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7908036);
   mainFit1027->SetParError(1,0.02302633);
