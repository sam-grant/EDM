...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02675468);
   Graph_Graph11015->SetMaximum(0.05097416);
   ...
   Graph_Graph21016->SetMinimum(-0.0005255594);
   Graph_Graph21016->SetMaximum(0.0006188851);
   ...
   Graph_Graph31017->SetMinimum(-0.04296701);
   Graph_Graph31017->SetMaximum(0.0369727);
   ...
   Graph_Graph41018->SetMinimum(-0.005837274);
   Graph_Graph41018->SetMaximum(0.00744886);
   ...
   Graph_Graph51019->SetMinimum(-0.01381285);
   Graph_Graph51019->SetMaximum(0.01844923);
