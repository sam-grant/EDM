...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.06938);
   Graph_Graph01020->SetMaximum(50.80462);
   ...
   mainFit1021->SetChisquare(2.284819);
   ...
   mainFit1021->SetParameter(0,-0.05701165);
   mainFit1021->SetParError(0,0.5399886);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8022248);
   mainFit1021->SetParError(1,0.01789005);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.571");
   pt_LaTex = pt->AddText("0.802#pm0.0179");
   pt_LaTex = pt->AddText("#minus0.057#pm 0.54");
   pt_LaTex = pt->AddText("#minus0.0711#pm0.673");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.07106693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.07106693,-52.06938,0.07106693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.284819);
   ...
   mainFit1022->SetParameter(0,-0.05701165);
   mainFit1022->SetParError(0,0.5399886);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8022248);
   mainFit1022->SetParError(1,0.01789005);
