...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.06938);
   Graph_Graph01033->SetMaximum(50.80462);
   ...
   mainFit1034->SetChisquare(2.245379);
   ...
   mainFit1034->SetParameter(0,-0.1378963);
   mainFit1034->SetParError(0,0.6763635);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8048927);
   mainFit1034->SetParError(1,0.02237233);
   ...
   pt_LaTex = pt->AddText("0.805#pm0.0224");
   pt_LaTex = pt->AddText("#minus0.138#pm0.676");
   pt_LaTex = pt->AddText("#minus0.171#pm0.838");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1713225,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1713225,-52.06938,0.1713225,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.245379);
   ...
   mainFit1035->SetParameter(0,-0.1378963);
   mainFit1035->SetParError(0,0.6763635);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8048927);
   mainFit1035->SetParError(1,0.02237233);
