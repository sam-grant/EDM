...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.96352,70,59.07085);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.86008);
   Graph_Graph01035->SetMaximum(48.96741);
   ...
   mainFit1036->SetChisquare(2.112851);
   ...
   mainFit1036->SetParameter(0,0.01360461);
   mainFit1036->SetParError(0,0.5662025);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7988609);
   mainFit1036->SetParError(1,0.01964329);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.704");
   pt_LaTex = pt->AddText("0.799#pm0.0196");
   pt_LaTex = pt->AddText("0.0136#pm0.566");
   pt_LaTex = pt->AddText("0.017#pm0.709");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.01703001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.01703001,-31.86008,-0.01703001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.112851);
   ...
   mainFit1037->SetParameter(0,0.01360461);
   mainFit1037->SetParError(0,0.5662025);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7988609);
   mainFit1037->SetParError(1,0.01964329);
