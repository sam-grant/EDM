...
//=========  (Tue Apr 27 00:20:34 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.455141);
   ...
   quadLineFit1002->SetParameter(0,74.71057);
   quadLineFit1002->SetParError(0,0.08293956);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.84047);
   quadLineFit1002->SetParError(1,1.391314);
   ...
   quadLineFit1003->SetChisquare(3.455141);
   ...
   quadLineFit1003->SetParameter(0,74.71057);
   quadLineFit1003->SetParError(0,0.08293956);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.84047);
   quadLineFit1003->SetParError(1,1.391314);
   ...
   Graph_30_ppm1003->SetMinimum(75.8202);
   Graph_30_ppm1003->SetMaximum(76.39095);
   ...
   quadLineFit1004->SetChisquare(5.727156);
   ...
   quadLineFit1004->SetParameter(0,74.71016);
   quadLineFit1004->SetParError(0,0.06921177);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.73691);
   quadLineFit1004->SetParError(1,1.137592);
   ...
   quadLineFit1005->SetChisquare(5.727156);
   ...
   quadLineFit1005->SetParameter(0,74.71016);
   quadLineFit1005->SetParError(0,0.06921177);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.73691);
   quadLineFit1005->SetParError(1,1.137592);
   ...
   Graph_10_ppm1005->SetMinimum(74.89195);
   Graph_10_ppm1005->SetMaximum(75.154);
   ...
   quadLineFit1006->SetChisquare(0.001983627);
   ...
   quadLineFit1006->SetParameter(0,74.47244);
   quadLineFit1006->SetParError(0,0.08109692);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.945608);
   quadLineFit1006->SetParError(1,1.315232);
   ...
   quadLineFit1007->SetChisquare(0.001983627);
   ...
   quadLineFit1007->SetParameter(0,74.47244);
   quadLineFit1007->SetParError(0,0.08109692);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.945608);
   quadLineFit1007->SetParError(1,1.315232);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.81251);
   Graph_mI10_ppm1007->SetMaximum(74.08484);
   ...
   quadLineFit1008->SetChisquare(7.192477);
   ...
   quadLineFit1008->SetParameter(0,74.42366);
   quadLineFit1008->SetParError(0,0.07119987);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.024247);
   quadLineFit1008->SetParError(1,1.158883);
   ...
   quadLineFit1009->SetChisquare(7.192477);
   ...
   quadLineFit1009->SetParameter(0,74.42366);
   quadLineFit1009->SetParError(0,0.07119987);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.024247);
   quadLineFit1009->SetParError(1,1.158883);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.54153);
   Graph_mI30_ppm1009->SetMaximum(73.1639);
   ...
   quadLineFit1010->SetChisquare(0.2327347);
   ...
   quadLineFit1010->SetParameter(0,74.33059);
   quadLineFit1010->SetParError(0,0.06732904);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.95922);
   quadLineFit1010->SetParError(1,1.165243);
   ...
   quadLineFit1011->SetChisquare(0.2327347);
   ...
   quadLineFit1011->SetParameter(0,74.33059);
   quadLineFit1011->SetParError(0,0.06732904);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.95922);
   quadLineFit1011->SetParError(1,1.165243);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.65189);
   Graph_mI50_ppm1011->SetMaximum(72.24944);
   ...
   quadLineFit1012->SetChisquare(1.568419);
   ...
   quadLineFit1012->SetParameter(0,74.29923);
   quadLineFit1012->SetParError(0,0.1359302);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.06445);
   quadLineFit1012->SetParError(1,2.432089);
   ...
   quadLineFit1013->SetChisquare(1.568419);
   ...
   quadLineFit1013->SetParameter(0,74.29923);
   quadLineFit1013->SetParError(0,0.1359302);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.06445);
   quadLineFit1013->SetParError(1,2.432089);
