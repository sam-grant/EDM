...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.06938);
   Graph_Graph01029->SetMaximum(50.80462);
   ...
   mainFit1030->SetChisquare(1.615888);
   ...
   mainFit1030->SetParameter(0,-0.245532);
   mainFit1030->SetParError(0,0.5871299);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8010819);
   mainFit1030->SetParError(1,0.01794434);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.539");
   pt_LaTex = pt->AddText("0.801#pm0.0179");
   pt_LaTex = pt->AddText("#minus0.246#pm0.587");
   pt_LaTex = pt->AddText("#minus0.307#pm0.732");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3065004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3065004,-52.06938,0.3065004,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.615888);
   ...
   mainFit1031->SetParameter(0,-0.245532);
   mainFit1031->SetParError(0,0.5871299);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8010819);
   mainFit1031->SetParError(1,0.01794434);
