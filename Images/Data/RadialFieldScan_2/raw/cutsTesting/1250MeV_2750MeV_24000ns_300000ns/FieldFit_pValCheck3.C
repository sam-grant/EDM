...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.92863,75,63.66387);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-52.06938);
   Graph_Graph01031->SetMaximum(50.80462);
   ...
   mainFit1032->SetChisquare(2.281759);
   ...
   mainFit1032->SetParameter(0,-0.07408401);
   mainFit1032->SetParError(0,0.6219489);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8024879);
   mainFit1032->SetParError(1,0.01851134);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.761");
   pt_LaTex = pt->AddText("0.802#pm0.0185");
   pt_LaTex = pt->AddText("#minus0.0741#pm0.622");
   pt_LaTex = pt->AddText("#minus0.0923#pm0.774");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.09231791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.09231791,-52.06938,0.09231791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.281759);
   ...
   mainFit1033->SetParameter(0,-0.07408401);
   mainFit1033->SetParError(0,0.6219489);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8024879);
   mainFit1033->SetParError(1,0.01851134);
