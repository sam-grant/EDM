...
//=========  (Tue Apr 27 00:20:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.06938);
   Graph_Graph01023->SetMaximum(50.80462);
   ...
   mainFit1024->SetChisquare(2.284819);
   ...
   mainFit1024->SetParameter(0,-0.05701165);
   mainFit1024->SetParError(0,0.5399886);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8022248);
   mainFit1024->SetParError(1,0.01789005);
   ...
   mainFit1025->SetChisquare(2.284819);
   ...
   mainFit1025->SetParameter(0,-0.05701165);
   mainFit1025->SetParError(0,0.5399886);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8022248);
   mainFit1025->SetParError(1,0.01789005);
