...
//=========  (Wed Apr 21 13:55:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-53.81918);
   Graph_Graph01029->SetMaximum(52.68642);
   ...
   mainFit1030->SetChisquare(5.525446);
   ...
   mainFit1030->SetParameter(0,-0.3641341);
   mainFit1030->SetParError(0,0.4994018);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8299111);
   mainFit1030->SetParError(1,0.0152396);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0152");
   pt_LaTex = pt->AddText("#minus0.364#pm0.499");
   pt_LaTex = pt->AddText("#minus0.439#pm0.601");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4387628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4387628,-53.81918,0.4387628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.525446);
   ...
   mainFit1031->SetParameter(0,-0.3641341);
   mainFit1031->SetParError(0,0.4994018);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8299111);
   mainFit1031->SetParError(1,0.0152396);
