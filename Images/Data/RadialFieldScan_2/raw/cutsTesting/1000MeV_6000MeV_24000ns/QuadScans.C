...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.076812);
   ...
   quadLineFit1002->SetParameter(0,74.66046);
   quadLineFit1002->SetParError(0,0.07014399);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.63432);
   quadLineFit1002->SetParError(1,1.176639);
   ...
   quadLineFit1003->SetChisquare(1.076812);
   ...
   quadLineFit1003->SetParameter(0,74.66046);
   quadLineFit1003->SetParError(0,0.07014399);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.63432);
   quadLineFit1003->SetParError(1,1.176639);
   ...
   Graph_30_ppm1003->SetMinimum(75.8474);
   Graph_30_ppm1003->SetMaximum(76.42797);
   ...
   quadLineFit1004->SetChisquare(3.218364);
   ...
   quadLineFit1004->SetParameter(0,74.74017);
   quadLineFit1004->SetParError(0,0.05891046);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.85261);
   quadLineFit1004->SetParError(1,0.9683047);
   ...
   quadLineFit1005->SetChisquare(3.218364);
   ...
   quadLineFit1005->SetParameter(0,74.74017);
   quadLineFit1005->SetParError(0,0.05891046);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.85261);
   quadLineFit1005->SetParError(1,0.9683047);
   ...
   Graph_10_ppm1005->SetMinimum(74.9215);
   Graph_10_ppm1005->SetMaximum(75.17378);
   ...
   quadLineFit1006->SetChisquare(1.809656);
   ...
   quadLineFit1006->SetParameter(0,74.50989);
   quadLineFit1006->SetParError(0,0.06902604);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.570221);
   quadLineFit1006->SetParError(1,1.119558);
   ...
   quadLineFit1007->SetChisquare(1.809656);
   ...
   quadLineFit1007->SetParameter(0,74.50989);
   quadLineFit1007->SetParError(0,0.06902604);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.570221);
   quadLineFit1007->SetParError(1,1.119558);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.81104);
   Graph_mI10_ppm1007->SetMaximum(74.06708);
   ...
   quadLineFit1008->SetChisquare(7.255861);
   ...
   quadLineFit1008->SetParameter(0,74.41304);
   quadLineFit1008->SetParError(0,0.06059847);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.885961);
   quadLineFit1008->SetParError(1,0.9864058);
   ...
   quadLineFit1009->SetChisquare(7.255861);
   ...
   quadLineFit1009->SetParameter(0,74.41304);
   quadLineFit1009->SetParError(0,0.06059847);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.885961);
   quadLineFit1009->SetParError(1,0.9864058);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.48864);
   Graph_mI30_ppm1009->SetMaximum(73.13603);
   ...
   quadLineFit1010->SetChisquare(1.453102);
   ...
   quadLineFit1010->SetParameter(0,74.36498);
   quadLineFit1010->SetParError(0,0.05732354);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.11895);
   quadLineFit1010->SetParError(1,0.9921361);
   ...
   quadLineFit1011->SetChisquare(1.453102);
   ...
   quadLineFit1011->SetParameter(0,74.36498);
   quadLineFit1011->SetParError(0,0.05732354);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.11895);
   quadLineFit1011->SetParError(1,0.9921361);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.59298);
   Graph_mI50_ppm1011->SetMaximum(72.20879);
   ...
   quadLineFit1012->SetChisquare(0.4121779);
   ...
   quadLineFit1012->SetParameter(0,74.34617);
   quadLineFit1012->SetParError(0,0.1156797);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.87395);
   quadLineFit1012->SetParError(1,2.06977);
   ...
   quadLineFit1013->SetChisquare(0.4121779);
   ...
   quadLineFit1013->SetParameter(0,74.34617);
   quadLineFit1013->SetParError(0,0.1156797);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.87395);
   quadLineFit1013->SetParError(1,2.06977);
