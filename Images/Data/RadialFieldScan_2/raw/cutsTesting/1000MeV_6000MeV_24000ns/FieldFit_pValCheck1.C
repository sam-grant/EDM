...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-53.81918);
   Graph_Graph01027->SetMaximum(52.68642);
   ...
   mainFit1028->SetChisquare(0.2656043);
   ...
   mainFit1028->SetParameter(0,0.281805);
   mainFit1028->SetParError(0,0.5145287);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8483362);
   mainFit1028->SetParError(1,0.01698113);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0885");
   pt_LaTex = pt->AddText("0.848#pm0.017");
   pt_LaTex = pt->AddText("0.282#pm0.515");
   pt_LaTex = pt->AddText("0.332#pm0.606");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3321855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3321855,-53.81918,-0.3321855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2656043);
   ...
   mainFit1029->SetParameter(0,0.281805);
   mainFit1029->SetParError(0,0.5145287);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8483362);
   mainFit1029->SetParError(1,0.01698113);
