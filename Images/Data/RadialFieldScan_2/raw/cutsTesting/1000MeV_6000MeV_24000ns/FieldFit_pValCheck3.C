...
//=========  (Wed Apr 21 13:55:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-67.13238,75,65.99962);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-53.81918);
   Graph_Graph01031->SetMaximum(52.68642);
   ...
   mainFit1032->SetChisquare(5.143638);
   ...
   mainFit1032->SetParameter(0,-0.4745167);
   mainFit1032->SetParError(0,0.5291984);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8337822);
   mainFit1032->SetParError(1,0.01572708);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.71");
   pt_LaTex = pt->AddText("0.834#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.475#pm0.529");
   pt_LaTex = pt->AddText("#minus0.569#pm0.632");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5691135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5691135,-53.81918,0.5691135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.143638);
   ...
   mainFit1033->SetParameter(0,-0.4745167);
   mainFit1033->SetParError(0,0.5291984);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8337822);
   mainFit1033->SetParError(1,0.01572708);
