...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-53.81918);
   Graph_Graph01020->SetMaximum(52.68642);
   ...
   mainFit1021->SetChisquare(5.793009);
   ...
   mainFit1021->SetParameter(0,-0.2628667);
   mainFit1021->SetParError(0,0.459421);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8305143);
   mainFit1021->SetParError(1,0.01519526);
   ...
   pt_LaTex = pt->AddText("0.831#pm0.0152");
   pt_LaTex = pt->AddText("#minus0.263#pm0.459");
   pt_LaTex = pt->AddText("#minus0.317#pm0.552");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3165108,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3165108,-53.81918,0.3165108,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.793009);
   ...
   mainFit1022->SetParameter(0,-0.2628667);
   mainFit1022->SetParError(0,0.459421);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8305143);
   mainFit1022->SetParError(1,0.01519526);
