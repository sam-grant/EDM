...
//=========  (Wed Apr 21 13:55:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-53.81918);
   Graph_Graph01033->SetMaximum(52.68642);
   ...
   mainFit1034->SetChisquare(5.785938);
   ...
   mainFit1034->SetParameter(0,-0.2920301);
   mainFit1034->SetParError(0,0.5756357);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8314735);
   mainFit1034->SetParError(1,0.01900029);
   ...
   pt_LaTex = pt->AddText("0.831#pm0.019");
   pt_LaTex = pt->AddText("#minus0.292#pm0.576");
   pt_LaTex = pt->AddText("#minus0.351#pm0.689");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3512199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3512199,-53.81918,0.3512199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.785938);
   ...
   mainFit1035->SetParameter(0,-0.2920301);
   mainFit1035->SetParError(0,0.5756357);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8314735);
   mainFit1035->SetParError(1,0.01900029);
