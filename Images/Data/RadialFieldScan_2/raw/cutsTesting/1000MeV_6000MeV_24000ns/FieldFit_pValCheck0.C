...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.13487,50,41.01207);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.82018);
   Graph_Graph01025->SetMaximum(30.69738);
   ...
   mainFit1026->SetChisquare(3.138234);
   ...
   mainFit1026->SetParameter(0,-0.5627475);
   mainFit1026->SetParError(0,0.494908);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8103327);
   mainFit1026->SetParError(1,0.01960069);
   ...
   pt_LaTex = pt->AddText(" 0.81#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.563#pm0.495");
   pt_LaTex = pt->AddText("#minus0.694#pm0.613");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6944647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6944647,-51.82018,0.6944647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.138234);
   ...
   mainFit1027->SetParameter(0,-0.5627475);
   mainFit1027->SetParError(0,0.494908);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8103327);
   mainFit1027->SetParError(1,0.01960069);
