...
//=========  (Wed Apr 21 13:55:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.5916,70,61.29147);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.10329);
   Graph_Graph01035->SetMaximum(50.80316);
   ...
   mainFit1036->SetChisquare(5.444825);
   ...
   mainFit1036->SetParameter(0,-0.1771382);
   mainFit1036->SetParError(0,0.4818459);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8264504);
   mainFit1036->SetParError(1,0.01668321);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.81");
   pt_LaTex = pt->AddText("0.826#pm0.0167");
   pt_LaTex = pt->AddText("#minus0.177#pm0.482");
   pt_LaTex = pt->AddText("#minus0.214#pm0.582");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.2143362,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2143362,-33.10329,0.2143362,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.444825);
   ...
   mainFit1037->SetParameter(0,-0.1771382);
   mainFit1037->SetParError(0,0.4818459);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8264504);
   mainFit1037->SetParError(1,0.01668321);
