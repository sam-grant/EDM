...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-53.81918);
   Graph_Graph01023->SetMaximum(52.68642);
   ...
   mainFit1024->SetChisquare(5.793009);
   ...
   mainFit1024->SetParameter(0,-0.2628667);
   mainFit1024->SetParError(0,0.459421);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8305143);
   mainFit1024->SetParError(1,0.01519526);
   ...
   mainFit1025->SetChisquare(5.793009);
   ...
   mainFit1025->SetParameter(0,-0.2628667);
   mainFit1025->SetParError(0,0.459421);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8305143);
   mainFit1025->SetParError(1,0.01519526);
