...
//=========  (Wed Apr 21 13:55:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01205222);
   Graph_Graph11015->SetMaximum(0.03654422);
   ...
   Graph_Graph21016->SetMinimum(-0.01351315);
   Graph_Graph21016->SetMaximum(0.01593259);
   ...
   Graph_Graph31017->SetMinimum(-0.03532386);
   Graph_Graph31017->SetMaximum(0.02544092);
   ...
   Graph_Graph41018->SetMinimum(-0.01266481);
   Graph_Graph41018->SetMaximum(0.01665266);
   ...
   Graph_Graph51019->SetMinimum(-0.006024567);
   Graph_Graph51019->SetMaximum(0.008053612);
