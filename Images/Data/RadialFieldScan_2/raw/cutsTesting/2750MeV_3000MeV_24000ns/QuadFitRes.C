...
//=========  (Fri Apr 23 21:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03002849);
   Graph_Graph11015->SetMaximum(0.01485994);
   ...
   Graph_Graph21016->SetMinimum(-0.04877234);
   Graph_Graph21016->SetMaximum(0.05741564);
   ...
   Graph_Graph31017->SetMinimum(-0.04272573);
   Graph_Graph31017->SetMaximum(0.04666851);
   ...
   Graph_Graph41018->SetMinimum(-0.08370926);
   Graph_Graph41018->SetMaximum(0.0493671);
   ...
   Graph_Graph51019->SetMinimum(-0.01181359);
   Graph_Graph51019->SetMaximum(0.008820613);
