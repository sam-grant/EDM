...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-67.73571,75,66.00762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-54.36137);
   Graph_Graph01027->SetMaximum(52.63329);
   ...
   mainFit1028->SetChisquare(0.3721664);
   ...
   mainFit1028->SetParameter(0,-0.5738505);
   mainFit1028->SetParError(0,2.056479);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7766576);
   mainFit1028->SetParError(1,0.06811339);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.124");
   pt_LaTex = pt->AddText("0.777#pm0.0681");
   pt_LaTex = pt->AddText("#minus0.574#pm 2.06");
   pt_LaTex = pt->AddText("#minus0.739#pm 2.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7388719,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7388719,-54.36137,0.7388719,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3721664);
   ...
   mainFit1029->SetParameter(0,-0.5738505);
   mainFit1029->SetParError(0,2.056479);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7766576);
   mainFit1029->SetParError(1,0.06811339);
