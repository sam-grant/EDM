...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.36137);
   Graph_Graph01023->SetMaximum(52.63329);
   ...
   mainFit1024->SetChisquare(1.018817);
   ...
   mainFit1024->SetParameter(0,-1.326054);
   mainFit1024->SetParError(0,1.831412);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7518724);
   mainFit1024->SetParError(1,0.06074401);
   ...
   mainFit1025->SetChisquare(1.018817);
   ...
   mainFit1025->SetParameter(0,-1.326054);
   mainFit1025->SetParError(0,1.831412);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7518724);
   mainFit1025->SetParError(1,0.06074401);
