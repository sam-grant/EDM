...
//=========  (Fri Apr 23 21:24:37 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.169043);
   ...
   quadLineFit1002->SetParameter(0,75.4756);
   quadLineFit1002->SetParError(0,0.2830234);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.96964);
   quadLineFit1002->SetParError(1,4.747427);
   ...
   quadLineFit1003->SetChisquare(1.169043);
   ...
   quadLineFit1003->SetParameter(0,75.4756);
   quadLineFit1003->SetParError(0,0.2830234);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.96964);
   quadLineFit1003->SetParError(1,4.747427);
   ...
   Graph_30_ppm1003->SetMinimum(76.4543);
   Graph_30_ppm1003->SetMaximum(77.04966);
   ...
   quadLineFit1004->SetChisquare(0.1611086);
   ...
   quadLineFit1004->SetParameter(0,75.59345);
   quadLineFit1004->SetParError(0,0.2341511);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,18.79401);
   quadLineFit1004->SetParError(1,3.84881);
   ...
   quadLineFit1005->SetChisquare(0.1611086);
   ...
   quadLineFit1005->SetParameter(0,75.59345);
   quadLineFit1005->SetParError(0,0.2341511);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,18.79401);
   quadLineFit1005->SetParError(1,3.84881);
   ...
   Graph_10_ppm1005->SetMinimum(75.60577);
   Graph_10_ppm1005->SetMaximum(75.91593);
   ...
   quadLineFit1006->SetChisquare(1.487332);
   ...
   quadLineFit1006->SetParameter(0,75.37963);
   quadLineFit1006->SetParError(0,0.2754097);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,5.506454);
   quadLineFit1006->SetParError(1,4.465817);
   ...
   quadLineFit1007->SetChisquare(1.487332);
   ...
   quadLineFit1007->SetParameter(0,75.37963);
   quadLineFit1007->SetParError(0,0.2754097);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,5.506454);
   quadLineFit1007->SetParError(1,4.465817);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.56219);
   Graph_mI10_ppm1007->SetMaximum(74.91524);
   ...
   quadLineFit1008->SetChisquare(0.8778335);
   ...
   quadLineFit1008->SetParameter(0,75.17252);
   quadLineFit1008->SetParError(0,0.241825);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.170678);
   quadLineFit1008->SetParError(1,3.936357);
   ...
   quadLineFit1009->SetChisquare(0.8778335);
   ...
   quadLineFit1009->SetParameter(0,75.17252);
   quadLineFit1009->SetParError(0,0.241825);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.170678);
   quadLineFit1009->SetParError(1,3.936357);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.27528);
   Graph_mI30_ppm1009->SetMaximum(73.9779);
   ...
   quadLineFit1010->SetChisquare(1.350949);
   ...
   quadLineFit1010->SetParameter(0,75.13337);
   quadLineFit1010->SetParError(0,0.2278546);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.72817);
   quadLineFit1010->SetParError(1,3.942981);
   ...
   quadLineFit1011->SetChisquare(1.350949);
   ...
   quadLineFit1011->SetParameter(0,75.13337);
   quadLineFit1011->SetParError(0,0.2278546);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.72817);
   quadLineFit1011->SetParError(1,3.942981);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.42561);
   Graph_mI50_ppm1011->SetMaximum(73.08363);
   ...
   quadLineFit1012->SetChisquare(0.05560892);
   ...
   quadLineFit1012->SetParameter(0,74.87003);
   quadLineFit1012->SetParError(0,0.4611598);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-37.19434);
   quadLineFit1012->SetParError(1,8.250814);
   ...
   quadLineFit1013->SetChisquare(0.05560892);
   ...
   quadLineFit1013->SetParameter(0,74.87003);
   quadLineFit1013->SetParError(0,0.4611598);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-37.19434);
   quadLineFit1013->SetParError(1,8.250814);
