...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.46715,50,39.66482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.25395);
   Graph_Graph01025->SetMaximum(29.45162);
   ...
   mainFit1026->SetChisquare(0.3945273);
   ...
   mainFit1026->SetParameter(0,-1.901011);
   mainFit1026->SetParError(0,1.970573);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7132198);
   mainFit1026->SetParError(1,0.0779705);
   ...
   pt_LaTex = pt->AddText("0.713#pm0.078");
   pt_LaTex = pt->AddText(" #minus1.9#pm 1.97");
   pt_LaTex = pt->AddText("#minus2.67#pm 2.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.665392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.665392,-52.25395,2.665392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.3945273);
   ...
   mainFit1027->SetParameter(0,-1.901011);
   mainFit1027->SetParError(0,1.970573);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7132198);
   mainFit1027->SetParError(1,0.0779705);
