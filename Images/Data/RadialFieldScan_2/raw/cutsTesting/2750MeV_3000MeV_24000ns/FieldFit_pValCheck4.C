...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.36137);
   Graph_Graph01033->SetMaximum(52.63329);
   ...
   mainFit1034->SetChisquare(0.927485);
   ...
   mainFit1034->SetParameter(0,-0.9077129);
   mainFit1034->SetParError(0,2.295742);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7380522);
   mainFit1034->SetParError(1,0.07604448);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.309");
   pt_LaTex = pt->AddText("0.738#pm0.076");
   pt_LaTex = pt->AddText("#minus0.908#pm  2.3");
   pt_LaTex = pt->AddText("#minus1.23#pm 3.05");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.229876,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.229876,-54.36137,1.229876,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.927485);
   ...
   mainFit1035->SetParameter(0,-0.9077129);
   mainFit1035->SetParError(0,2.295742);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7380522);
   mainFit1035->SetParError(1,0.07604448);
