...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.36137);
   Graph_Graph01031->SetMaximum(52.63329);
   ...
   mainFit1032->SetChisquare(0.7734932);
   ...
   mainFit1032->SetParameter(0,-1.842962);
   mainFit1032->SetParError(0,2.107875);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7598251);
   mainFit1032->SetParError(1,0.06282737);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.258");
   pt_LaTex = pt->AddText(" 0.76#pm0.0628");
   pt_LaTex = pt->AddText("#minus1.84#pm 2.11");
   pt_LaTex = pt->AddText("#minus2.43#pm 2.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.425508,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.425508,-54.36137,2.425508,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.7734932);
   ...
   mainFit1033->SetParameter(0,-1.842962);
   mainFit1033->SetParError(0,2.107875);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7598251);
   mainFit1033->SetParError(1,0.06282737);
