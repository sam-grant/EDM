...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.36137);
   Graph_Graph01020->SetMaximum(52.63329);
   ...
   mainFit1021->SetChisquare(1.018817);
   ...
   mainFit1021->SetParameter(0,-1.326054);
   mainFit1021->SetParError(0,1.831412);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7518724);
   mainFit1021->SetParError(1,0.06074401);
   ...
   pt_LaTex = pt->AddText("0.752#pm0.0607");
   pt_LaTex = pt->AddText("#minus1.33#pm 1.83");
   pt_LaTex = pt->AddText("#minus1.76#pm 2.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.763669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.763669,-54.36137,1.763669,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.018817);
   ...
   mainFit1022->SetParameter(0,-1.326054);
   mainFit1022->SetParError(0,1.831412);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7518724);
   mainFit1022->SetParError(1,0.06074401);
