...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.76821,70,61.81412);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.90998);
   Graph_Graph01035->SetMaximum(50.95589);
   ...
   mainFit1036->SetChisquare(0.9634302);
   ...
   mainFit1036->SetParameter(0,-1.461548);
   mainFit1036->SetParError(0,1.91975);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7583559);
   mainFit1036->SetParError(1,0.0666895);
   ...
   pt_LaTex = pt->AddText("0.758#pm0.0667");
   pt_LaTex = pt->AddText("#minus1.46#pm 1.92");
   pt_LaTex = pt->AddText("#minus1.93#pm 2.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.927259,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.927259,-35.90998,1.927259,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.9634302);
   ...
   mainFit1037->SetParameter(0,-1.461548);
   mainFit1037->SetParError(0,1.91975);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7583559);
   mainFit1037->SetParError(1,0.0666895);
