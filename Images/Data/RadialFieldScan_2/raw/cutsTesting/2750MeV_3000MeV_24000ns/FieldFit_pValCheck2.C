...
//=========  (Fri Apr 23 21:24:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.36137);
   Graph_Graph01029->SetMaximum(52.63329);
   ...
   mainFit1030->SetChisquare(0.9903908);
   ...
   mainFit1030->SetParameter(0,-1.194319);
   mainFit1030->SetParError(0,1.991164);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.752688);
   mainFit1030->SetParError(1,0.06093385);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.33");
   pt_LaTex = pt->AddText("0.753#pm0.0609");
   pt_LaTex = pt->AddText("#minus1.19#pm 1.99");
   pt_LaTex = pt->AddText("#minus1.59#pm 2.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.586739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.586739,-54.36137,1.586739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9903908);
   ...
   mainFit1031->SetParameter(0,-1.194319);
   mainFit1031->SetParError(0,1.991164);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.752688);
   mainFit1031->SetParError(1,0.06093385);
