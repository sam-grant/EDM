...
//=========  (Fri Apr 23 18:45:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.29008,70,59.56329);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.70475);
   Graph_Graph01035->SetMaximum(48.97795);
   ...
   mainFit1036->SetChisquare(0.4456034);
   ...
   mainFit1036->SetParameter(0,-1.636894);
   mainFit1036->SetParError(0,0.4749731);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8571036);
   mainFit1036->SetParError(1,0.01639461);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.149");
   pt_LaTex = pt->AddText("0.857#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.64#pm0.475");
   pt_LaTex = pt->AddText("#minus1.91#pm0.546");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.909797,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.909797,-35.70475,1.909797,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.4456034);
   ...
   mainFit1037->SetParameter(0,-1.636894);
   mainFit1037->SetParError(0,0.4749731);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8571036);
   mainFit1037->SetParError(1,0.01639461);
