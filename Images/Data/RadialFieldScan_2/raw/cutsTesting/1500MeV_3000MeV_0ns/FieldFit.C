...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.19008,75,63.94329);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-54.97674);
   Graph_Graph01020->SetMaximum(50.72995);
   ...
   mainFit1021->SetChisquare(0.4711594);
   ...
   mainFit1021->SetParameter(0,-1.613929);
   mainFit1021->SetParError(0,0.4527962);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8560145);
   mainFit1021->SetParError(1,0.01493881);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.118");
   pt_LaTex = pt->AddText("0.856#pm0.0149");
   pt_LaTex = pt->AddText("#minus1.61#pm0.453");
   pt_LaTex = pt->AddText("#minus1.89#pm0.525");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.885399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.885399,-54.97674,1.885399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(0.4711594);
   ...
   mainFit1022->SetParameter(0,-1.613929);
   mainFit1022->SetParError(0,0.4527962);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8560145);
   mainFit1022->SetParError(1,0.01493881);
