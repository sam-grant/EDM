...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.148892);
   ...
   quadLineFit1002->SetParameter(0,74.87041);
   quadLineFit1002->SetParError(0,0.0686173);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.77083);
   quadLineFit1002->SetParError(1,1.150231);
   ...
   quadLineFit1003->SetChisquare(1.148892);
   ...
   quadLineFit1003->SetParameter(0,74.87041);
   quadLineFit1003->SetParError(0,0.0686173);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.77083);
   quadLineFit1003->SetParError(1,1.150231);
   ...
   Graph_30_ppm1003->SetMinimum(75.94801);
   Graph_30_ppm1003->SetMaximum(76.55724);
   ...
   quadLineFit1004->SetChisquare(1.462392);
   ...
   quadLineFit1004->SetParameter(0,74.75865);
   quadLineFit1004->SetParError(0,0.05812128);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.2364);
   quadLineFit1004->SetParError(1,0.9546643);
   ...
   quadLineFit1005->SetChisquare(1.462392);
   ...
   quadLineFit1005->SetParameter(0,74.75865);
   quadLineFit1005->SetParError(0,0.05812128);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.2364);
   quadLineFit1005->SetParError(1,0.9546643);
   ...
   Graph_10_ppm1005->SetMinimum(75.03486);
   Graph_10_ppm1005->SetMaximum(75.25376);
   ...
   quadLineFit1006->SetChisquare(0.5457483);
   ...
   quadLineFit1006->SetParameter(0,74.68739);
   quadLineFit1006->SetParError(0,0.06822271);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.335077);
   quadLineFit1006->SetParError(1,1.105757);
   ...
   quadLineFit1007->SetChisquare(0.5457483);
   ...
   quadLineFit1007->SetParameter(0,74.68739);
   quadLineFit1007->SetParError(0,0.06822271);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.335077);
   quadLineFit1007->SetParError(1,1.105757);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.90713);
   Graph_mI10_ppm1007->SetMaximum(74.21146);
   ...
   quadLineFit1008->SetChisquare(5.192972);
   ...
   quadLineFit1008->SetParameter(0,74.66103);
   quadLineFit1008->SetParError(0,0.05983315);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.04717);
   quadLineFit1008->SetParError(1,0.9732296);
   ...
   quadLineFit1009->SetChisquare(5.192972);
   ...
   quadLineFit1009->SetParameter(0,74.66103);
   quadLineFit1009->SetParError(0,0.05983315);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.04717);
   quadLineFit1009->SetParError(1,0.9732296);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.60342);
   Graph_mI30_ppm1009->SetMaximum(73.30286);
   ...
   quadLineFit1010->SetChisquare(0.3640853);
   ...
   quadLineFit1010->SetParameter(0,74.6549);
   quadLineFit1010->SetParError(0,0.05652416);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.67031);
   quadLineFit1010->SetParError(1,0.9775484);
   ...
   quadLineFit1011->SetChisquare(0.3640853);
   ...
   quadLineFit1011->SetParameter(0,74.6549);
   quadLineFit1011->SetParError(0,0.05652416);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.67031);
   quadLineFit1011->SetParError(1,0.9775484);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.74155);
   Graph_mI50_ppm1011->SetMaximum(72.37378);
   ...
   quadLineFit1012->SetChisquare(0.2787649);
   ...
   quadLineFit1012->SetParameter(0,74.5732);
   quadLineFit1012->SetParError(0,0.1142166);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.12475);
   quadLineFit1012->SetParError(1,2.043107);
   ...
   quadLineFit1013->SetChisquare(0.2787649);
   ...
   quadLineFit1013->SetParameter(0,74.5732);
   quadLineFit1013->SetParError(0,0.1142166);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.12475);
   quadLineFit1013->SetParError(1,2.043107);
