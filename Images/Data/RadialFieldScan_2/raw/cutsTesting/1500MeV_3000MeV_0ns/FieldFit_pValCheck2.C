...
//=========  (Fri Apr 23 18:45:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.97674);
   Graph_Graph01029->SetMaximum(50.72995);
   ...
   mainFit1030->SetChisquare(0.3226037);
   ...
   mainFit1030->SetParameter(0,-1.688054);
   mainFit1030->SetParError(0,0.4919116);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8555953);
   mainFit1030->SetParError(1,0.01498005);
   ...
   pt_LaTex = pt->AddText("0.856#pm0.015");
   pt_LaTex = pt->AddText("#minus1.69#pm0.492");
   pt_LaTex = pt->AddText("#minus1.97#pm0.572");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.972958,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.972958,-54.97674,1.972958,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3226037);
   ...
   mainFit1031->SetParameter(0,-1.688054);
   mainFit1031->SetParError(0,0.4919116);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8555953);
   mainFit1031->SetParError(1,0.01498005);
