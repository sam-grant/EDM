...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.97674);
   Graph_Graph01023->SetMaximum(50.72995);
   ...
   mainFit1024->SetChisquare(0.4711594);
   ...
   mainFit1024->SetParameter(0,-1.613929);
   mainFit1024->SetParError(0,0.4527962);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8560145);
   mainFit1024->SetParError(1,0.01493881);
   ...
   mainFit1025->SetChisquare(0.4711594);
   ...
   mainFit1025->SetParameter(0,-1.613929);
   mainFit1025->SetParError(0,0.4527962);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8560145);
   mainFit1025->SetParError(1,0.01493881);
