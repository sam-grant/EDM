...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01382114);
   Graph_Graph11015->SetMaximum(0.01574969);
   ...
   Graph_Graph21016->SetMinimum(-0.007311651);
   Graph_Graph21016->SetMaximum(0.00857876);
   ...
   Graph_Graph31017->SetMinimum(-0.03036424);
   Graph_Graph31017->SetMaximum(0.02863192);
   ...
   Graph_Graph41018->SetMinimum(-0.007027216);
   Graph_Graph41018->SetMaximum(0.007417116);
   ...
   Graph_Graph51019->SetMinimum(-0.004909683);
   Graph_Graph51019->SetMaximum(0.006539858);
