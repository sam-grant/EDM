...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.97674);
   Graph_Graph01027->SetMaximum(50.72995);
   ...
   mainFit1028->SetChisquare(0.42086);
   ...
   mainFit1028->SetParameter(0,-1.664871);
   mainFit1028->SetParError(0,0.5065005);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8543677);
   mainFit1028->SetParError(1,0.01666318);
   ...
   pt_LaTex = pt->AddText("0.854#pm0.0167");
   pt_LaTex = pt->AddText("#minus1.66#pm0.507");
   pt_LaTex = pt->AddText("#minus1.95#pm0.597");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.948659,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.948659,-54.97674,1.948659,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.42086);
   ...
   mainFit1029->SetParameter(0,-1.664871);
   mainFit1029->SetParError(0,0.5065005);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8543677);
   mainFit1029->SetParError(1,0.01666318);
