...
//=========  (Fri Apr 23 18:45:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.00758,50,43.03079);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.30375);
   Graph_Graph01025->SetMaximum(32.32696);
   ...
   mainFit1026->SetChisquare(0.2128277);
   ...
   mainFit1026->SetParameter(0,-1.521236);
   mainFit1026->SetParError(0,0.488169);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8622571);
   mainFit1026->SetParError(1,0.01932787);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0709");
   pt_LaTex = pt->AddText("0.862#pm0.0193");
   pt_LaTex = pt->AddText("#minus1.52#pm0.488");
   pt_LaTex = pt->AddText("#minus1.76#pm0.572");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.764249,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.764249,-53.30375,1.764249,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.2128277);
   ...
   mainFit1027->SetParameter(0,-1.521236);
   mainFit1027->SetParError(0,0.488169);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8622571);
   mainFit1027->SetParError(1,0.01932787);
