...
//=========  (Fri Apr 23 18:45:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.97674);
   Graph_Graph01031->SetMaximum(50.72995);
   ...
   mainFit1032->SetChisquare(0.4480285);
   ...
   mainFit1032->SetParameter(0,-1.65332);
   mainFit1032->SetParError(0,0.5215248);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8566326);
   mainFit1032->SetParError(1,0.01546568);
   ...
   pt_LaTex = pt->AddText("0.857#pm0.0155");
   pt_LaTex = pt->AddText("#minus1.65#pm0.522");
   pt_LaTex = pt->AddText("#minus1.93#pm  0.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.930022,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.930022,-54.97674,1.930022,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.4480285);
   ...
   mainFit1033->SetParameter(0,-1.65332);
   mainFit1033->SetParError(0,0.5215248);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8566326);
   mainFit1033->SetParError(1,0.01546568);
