...
//=========  (Fri Apr 23 18:45:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.97674);
   Graph_Graph01033->SetMaximum(50.72995);
   ...
   mainFit1034->SetChisquare(0.1790729);
   ...
   mainFit1034->SetParameter(0,-1.428616);
   mainFit1034->SetParError(0,0.5680135);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8499538);
   mainFit1034->SetParError(1,0.01868998);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0597");
   pt_LaTex = pt->AddText(" 0.85#pm0.0187");
   pt_LaTex = pt->AddText("#minus1.43#pm0.568");
   pt_LaTex = pt->AddText("#minus1.68#pm0.652");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.680816,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.680816,-54.97674,1.680816,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.1790729);
   ...
   mainFit1035->SetParameter(0,-1.428616);
   mainFit1035->SetParError(0,0.5680135);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8499538);
   mainFit1035->SetParError(1,0.01868998);
