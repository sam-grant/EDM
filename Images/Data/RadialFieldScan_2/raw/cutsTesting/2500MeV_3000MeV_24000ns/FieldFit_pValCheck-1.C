...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.59611);
   Graph_Graph01023->SetMaximum(51.40266);
   ...
   mainFit1024->SetChisquare(3.149487);
   ...
   mainFit1024->SetParameter(0,-0.9672716);
   mainFit1024->SetParError(0,1.186639);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.749789);
   mainFit1024->SetParError(1,0.03950088);
   ...
   mainFit1025->SetChisquare(3.149487);
   ...
   mainFit1025->SetParameter(0,-0.9672716);
   mainFit1025->SetParError(0,1.186639);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.749789);
   mainFit1025->SetParError(1,0.03950088);
