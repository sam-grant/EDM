...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.59611);
   Graph_Graph01027->SetMaximum(51.40266);
   ...
   mainFit1028->SetChisquare(0.5248687);
   ...
   mainFit1028->SetParameter(0,0.02229762);
   mainFit1028->SetParError(0,1.33463);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.782677);
   mainFit1028->SetParError(1,0.04441);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.175");
   pt_LaTex = pt->AddText("0.783#pm0.0444");
   pt_LaTex = pt->AddText("0.0223#pm 1.33");
   pt_LaTex = pt->AddText("0.0285#pm 1.71");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.02848891,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.02848891,-49.59611,-0.02848891,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5248687);
   ...
   mainFit1029->SetParameter(0,0.02229762);
   mainFit1029->SetParError(0,1.33463);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.782677);
   mainFit1029->SetParError(1,0.04441);
