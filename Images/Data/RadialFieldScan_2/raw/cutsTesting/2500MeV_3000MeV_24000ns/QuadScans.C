...
//=========  (Wed Apr 21 20:46:04 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.659685);
   ...
   quadLineFit1002->SetParameter(0,75.3661);
   quadLineFit1002->SetParError(0,0.1854485);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.87497);
   quadLineFit1002->SetParError(1,3.111124);
   ...
   quadLineFit1003->SetChisquare(1.659685);
   ...
   quadLineFit1003->SetParameter(0,75.3661);
   quadLineFit1003->SetParError(0,0.1854485);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.87497);
   quadLineFit1003->SetParError(1,3.111124);
   ...
   Graph_30_ppm1003->SetMinimum(76.44769);
   Graph_30_ppm1003->SetMaximum(76.97764);
   ...
   quadLineFit1004->SetChisquare(0.6706907);
   ...
   quadLineFit1004->SetParameter(0,75.5753);
   quadLineFit1004->SetParError(0,0.1515749);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,18.35876);
   quadLineFit1004->SetParError(1,2.491683);
   ...
   quadLineFit1005->SetChisquare(0.6706907);
   ...
   quadLineFit1005->SetParameter(0,75.5753);
   quadLineFit1005->SetParError(0,0.1515749);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,18.35876);
   quadLineFit1005->SetParError(1,2.491683);
   ...
   Graph_10_ppm1005->SetMinimum(75.52416);
   Graph_10_ppm1005->SetMaximum(75.80194);
   ...
   quadLineFit1006->SetChisquare(0.1085546);
   ...
   quadLineFit1006->SetParameter(0,75.20545);
   quadLineFit1006->SetParError(0,0.1777829);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.525223);
   quadLineFit1006->SetParError(1,2.882916);
   ...
   quadLineFit1007->SetChisquare(0.1085546);
   ...
   quadLineFit1007->SetParameter(0,75.20545);
   quadLineFit1007->SetParError(0,0.1777829);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.525223);
   quadLineFit1007->SetParError(1,2.882916);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.51392);
   Graph_mI10_ppm1007->SetMaximum(74.842);
   ...
   quadLineFit1008->SetChisquare(1.141399);
   ...
   quadLineFit1008->SetParameter(0,75.18867);
   quadLineFit1008->SetParError(0,0.156325);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.479842);
   quadLineFit1008->SetParError(1,2.544532);
   ...
   quadLineFit1009->SetChisquare(1.141399);
   ...
   quadLineFit1009->SetParameter(0,75.18867);
   quadLineFit1009->SetParError(0,0.156325);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.479842);
   quadLineFit1009->SetParError(1,2.544532);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.3015);
   Graph_mI30_ppm1009->SetMaximum(73.91982);
   ...
   quadLineFit1010->SetChisquare(5.449027);
   ...
   quadLineFit1010->SetParameter(0,75.04827);
   quadLineFit1010->SetParError(0,0.1479052);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.75812);
   quadLineFit1010->SetParError(1,2.559708);
   ...
   quadLineFit1011->SetChisquare(5.449027);
   ...
   quadLineFit1011->SetParameter(0,75.04827);
   quadLineFit1011->SetParError(0,0.1479052);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.75812);
   quadLineFit1011->SetParError(1,2.559708);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.43475);
   Graph_mI50_ppm1011->SetMaximum(73.01809);
   ...
   quadLineFit1012->SetChisquare(0.02367505);
   ...
   quadLineFit1012->SetParameter(0,74.77265);
   quadLineFit1012->SetParError(0,0.2979839);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.84822);
   quadLineFit1012->SetParError(1,5.331329);
   ...
   quadLineFit1013->SetChisquare(0.02367505);
   ...
   quadLineFit1013->SetParameter(0,74.77265);
   quadLineFit1013->SetParError(0,0.2979839);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.84822);
   quadLineFit1013->SetParError(1,5.331329);
