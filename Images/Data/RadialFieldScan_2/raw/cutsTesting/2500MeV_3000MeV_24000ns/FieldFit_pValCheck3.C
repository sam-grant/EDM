...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-49.59611);
   Graph_Graph01031->SetMaximum(51.40266);
   ...
   mainFit1032->SetChisquare(3.149442);
   ...
   mainFit1032->SetParameter(0,-0.9627764);
   mainFit1032->SetParError(0,1.366419);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7497269);
   mainFit1032->SetParError(1,0.04084903);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.0408");
   pt_LaTex = pt->AddText("#minus0.963#pm 1.37");
   pt_LaTex = pt->AddText("#minus1.28#pm 1.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.284169,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.284169,-49.59611,1.284169,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.149442);
   ...
   mainFit1033->SetParameter(0,-0.9627764);
   mainFit1033->SetParError(0,1.366419);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7497269);
   mainFit1033->SetParError(1,0.04084903);
