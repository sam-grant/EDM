...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-56.68704,50,36.35794);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.38254);
   Graph_Graph01025->SetMaximum(27.05344);
   ...
   mainFit1026->SetChisquare(0.9381961);
   ...
   mainFit1026->SetParameter(0,-1.661327);
   mainFit1026->SetParError(0,1.275084);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7030089);
   mainFit1026->SetParError(1,0.05048916);
   ...
   pt_LaTex = pt->AddText("0.703#pm0.0505");
   pt_LaTex = pt->AddText("#minus1.66#pm 1.28");
   pt_LaTex = pt->AddText("#minus2.36#pm 1.84");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.363166,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.363166,-47.38254,2.363166,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.9381961);
   ...
   mainFit1027->SetParameter(0,-1.661327);
   mainFit1027->SetParError(0,1.275084);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7030089);
   mainFit1027->SetParError(1,0.05048916);
