...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.64381,70,60.31207);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.24822);
   Graph_Graph01035->SetMaximum(49.91648);
   ...
   mainFit1036->SetChisquare(2.845656);
   ...
   mainFit1036->SetParameter(0,-1.172766);
   mainFit1036->SetParError(0,1.243809);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7597116);
   mainFit1036->SetParError(1,0.04340386);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.949");
   pt_LaTex = pt->AddText(" 0.76#pm0.0434");
   pt_LaTex = pt->AddText("#minus1.17#pm 1.24");
   pt_LaTex = pt->AddText("#minus1.54#pm 1.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.543699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.543699,-33.24822,1.543699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.845656);
   ...
   mainFit1037->SetParameter(0,-1.172766);
   mainFit1037->SetParError(0,1.243809);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7597116);
   mainFit1037->SetParError(1,0.04340386);
