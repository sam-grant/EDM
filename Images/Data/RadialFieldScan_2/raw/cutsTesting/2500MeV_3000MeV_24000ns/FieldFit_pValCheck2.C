...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.59611);
   Graph_Graph01029->SetMaximum(51.40266);
   ...
   mainFit1030->SetChisquare(3.005914);
   ...
   mainFit1030->SetParameter(0,-1.160289);
   mainFit1030->SetParError(0,1.291328);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7485721);
   mainFit1030->SetParError(1,0.03963277);
   ...
   pt_LaTex = pt->AddText("0.749#pm0.0396");
   pt_LaTex = pt->AddText("#minus1.16#pm 1.29");
   pt_LaTex = pt->AddText("#minus1.55#pm 1.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.550003,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.550003,-49.59611,1.550003,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.005914);
   ...
   mainFit1031->SetParameter(0,-1.160289);
   mainFit1031->SetParError(0,1.291328);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7485721);
   mainFit1031->SetParError(1,0.03963277);
