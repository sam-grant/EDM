...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03735053);
   Graph_Graph11015->SetMaximum(0.0216946);
   ...
   Graph_Graph21016->SetMinimum(-0.01001883);
   Graph_Graph21016->SetMaximum(0.008526943);
   ...
   Graph_Graph31017->SetMinimum(-0.03511372);
   Graph_Graph31017->SetMaximum(0.02787831);
   ...
   Graph_Graph41018->SetMinimum(-0.109434);
   Graph_Graph41018->SetMaximum(0.06240556);
   ...
   Graph_Graph51019->SetMinimum(-0.003720752);
   Graph_Graph51019->SetMaximum(0.004983399);
