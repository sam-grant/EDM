...
//=========  (Wed Apr 21 20:46:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.59611);
   Graph_Graph01033->SetMaximum(51.40266);
   ...
   mainFit1034->SetChisquare(3.122869);
   ...
   mainFit1034->SetParameter(0,-0.8219136);
   mainFit1034->SetParError(0,1.483982);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7449616);
   mainFit1034->SetParError(1,0.04938101);
   ...
   pt_LaTex = pt->AddText("0.745#pm0.0494");
   pt_LaTex = pt->AddText("#minus0.822#pm 1.48");
   pt_LaTex = pt->AddText(" #minus1.1#pm 1.96");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.103297,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.103297,-49.59611,1.103297,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.122869);
   ...
   mainFit1035->SetParameter(0,-0.8219136);
   mainFit1035->SetParError(0,1.483982);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7449616);
   mainFit1035->SetParError(1,0.04938101);
