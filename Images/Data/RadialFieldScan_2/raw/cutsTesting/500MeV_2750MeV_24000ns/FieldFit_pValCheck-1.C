...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.39322);
   Graph_Graph01023->SetMaximum(55.75474);
   ...
   mainFit1024->SetChisquare(7.495747);
   ...
   mainFit1024->SetParameter(0,-1.182065);
   mainFit1024->SetParError(0,0.4392791);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8892073);
   mainFit1024->SetParError(1,0.01458245);
   ...
   mainFit1025->SetChisquare(7.495747);
   ...
   mainFit1025->SetParameter(0,-1.182065);
   mainFit1025->SetParError(0,0.4392791);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8892073);
   mainFit1025->SetParError(1,0.01458245);
