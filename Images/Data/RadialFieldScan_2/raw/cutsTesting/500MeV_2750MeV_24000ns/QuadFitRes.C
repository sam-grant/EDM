...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01255974);
   Graph_Graph11015->SetMaximum(0.01158292);
   ...
   Graph_Graph21016->SetMinimum(-0.01240667);
   Graph_Graph21016->SetMaximum(0.01460928);
   ...
   Graph_Graph31017->SetMinimum(-0.03249275);
   Graph_Graph31017->SetMaximum(0.02348691);
   ...
   Graph_Graph41018->SetMinimum(-0.0123432);
   Graph_Graph41018->SetMaximum(0.01984363);
   ...
   Graph_Graph51019->SetMinimum(-0.00682801);
   Graph_Graph51019->SetMaximum(0.009127183);
