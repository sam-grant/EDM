...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.39322);
   Graph_Graph01031->SetMaximum(55.75474);
   ...
   mainFit1032->SetChisquare(7.156944);
   ...
   mainFit1032->SetParameter(0,-1.036006);
   mainFit1032->SetParError(0,0.5059315);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8869707);
   mainFit1032->SetParError(1,0.01508473);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.39");
   pt_LaTex = pt->AddText("0.887#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.04#pm0.506");
   pt_LaTex = pt->AddText("#minus1.17#pm0.566");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.168028,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.168028,-56.39322,1.168028,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.156944);
   ...
   mainFit1033->SetParameter(0,-1.036006);
   mainFit1033->SetParError(0,0.5059315);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8869707);
   mainFit1033->SetParError(1,0.01508473);
