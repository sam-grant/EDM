...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.97066,50,42.56795);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.2168);
   Graph_Graph01025->SetMaximum(31.81409);
   ...
   mainFit1026->SetChisquare(1.61512);
   ...
   mainFit1026->SetParameter(0,-1.605325);
   mainFit1026->SetParError(0,0.4726782);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.860744);
   mainFit1026->SetParError(1,0.01872205);
   ...
   pt_LaTex = pt->AddText("0.861#pm0.0187");
   pt_LaTex = pt->AddText("#minus1.61#pm0.473");
   pt_LaTex = pt->AddText("#minus1.87#pm0.555");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.865044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.865044,-54.2168,1.865044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.61512);
   ...
   mainFit1027->SetParameter(0,-1.605325);
   mainFit1027->SetParError(0,0.4726782);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.860744);
   mainFit1027->SetParError(1,0.01872205);
