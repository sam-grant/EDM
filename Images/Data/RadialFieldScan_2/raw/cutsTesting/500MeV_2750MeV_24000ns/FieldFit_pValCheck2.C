...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.39322);
   Graph_Graph01029->SetMaximum(55.75474);
   ...
   mainFit1030->SetChisquare(7.292046);
   ...
   mainFit1030->SetParameter(0,-1.266916);
   mainFit1030->SetParError(0,0.4777851);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8886925);
   mainFit1030->SetParError(1,0.01462872);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.43");
   pt_LaTex = pt->AddText("0.889#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.27#pm0.478");
   pt_LaTex = pt->AddText("#minus1.43#pm0.536");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.425596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.425596,-56.39322,1.425596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.292046);
   ...
   mainFit1031->SetParameter(0,-1.266916);
   mainFit1031->SetParError(0,0.4777851);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8886925);
   mainFit1031->SetParError(1,0.01462872);
