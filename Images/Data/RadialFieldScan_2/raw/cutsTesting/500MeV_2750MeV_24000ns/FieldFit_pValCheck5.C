...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.00326,70,65.09154);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.79378);
   Graph_Graph01035->SetMaximum(53.88206);
   ...
   mainFit1036->SetChisquare(7.389316);
   ...
   mainFit1036->SetParameter(0,-1.227158);
   mainFit1036->SetParError(0,0.4604754);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8913761);
   mainFit1036->SetParError(1,0.01601325);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.46");
   pt_LaTex = pt->AddText("0.891#pm0.016");
   pt_LaTex = pt->AddText("#minus1.23#pm 0.46");
   pt_LaTex = pt->AddText("#minus1.38#pm0.511");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.376701,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.376701,-35.79378,1.376701,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.389316);
   ...
   mainFit1037->SetParameter(0,-1.227158);
   mainFit1037->SetParError(0,0.4604754);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8913761);
   mainFit1037->SetParError(1,0.01601325);
