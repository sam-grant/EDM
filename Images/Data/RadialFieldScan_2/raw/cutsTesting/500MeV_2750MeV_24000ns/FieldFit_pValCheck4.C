...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.39322);
   Graph_Graph01033->SetMaximum(55.75474);
   ...
   mainFit1034->SetChisquare(6.976619);
   ...
   mainFit1034->SetParameter(0,-1.420508);
   mainFit1034->SetParError(0,0.5499546);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8971079);
   mainFit1034->SetParError(1,0.0182366);
   ...
   pt_LaTex = pt->AddText("0.897#pm0.0182");
   pt_LaTex = pt->AddText("#minus1.42#pm 0.55");
   pt_LaTex = pt->AddText("#minus1.58#pm0.599");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.583431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.583431,-56.39322,1.583431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.976619);
   ...
   mainFit1035->SetParameter(0,-1.420508);
   mainFit1035->SetParError(0,0.5499546);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8971079);
   mainFit1035->SetParError(1,0.0182366);
