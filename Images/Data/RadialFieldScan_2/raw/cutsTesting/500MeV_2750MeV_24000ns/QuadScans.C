...
//=========  (Mon Apr 26 21:32:23 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7434917);
   ...
   quadLineFit1002->SetParameter(0,74.47499);
   quadLineFit1002->SetParError(0,0.06793046);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.26935);
   quadLineFit1002->SetParError(1,1.139726);
   ...
   quadLineFit1003->SetChisquare(0.7434917);
   ...
   quadLineFit1003->SetParameter(0,74.47499);
   quadLineFit1003->SetParError(0,0.06793046);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.26935);
   quadLineFit1003->SetParError(1,1.139726);
   ...
   Graph_30_ppm1003->SetMinimum(75.75533);
   Graph_30_ppm1003->SetMaximum(76.35205);
   ...
   quadLineFit1004->SetChisquare(1.293614);
   ...
   quadLineFit1004->SetParameter(0,74.59459);
   quadLineFit1004->SetParError(0,0.05627876);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.71987);
   quadLineFit1004->SetParError(1,0.9249817);
   ...
   quadLineFit1005->SetChisquare(1.293614);
   ...
   quadLineFit1005->SetParameter(0,74.59459);
   quadLineFit1005->SetParError(0,0.05627876);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.71987);
   quadLineFit1005->SetParError(1,0.9249817);
   ...
   Graph_10_ppm1005->SetMinimum(74.77483);
   Graph_10_ppm1005->SetMaximum(75.01463);
   ...
   quadLineFit1006->SetChisquare(1.673425);
   ...
   quadLineFit1006->SetParameter(0,74.38373);
   quadLineFit1006->SetParError(0,0.06591952);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.149654);
   quadLineFit1006->SetParError(1,1.069096);
   ...
   quadLineFit1007->SetChisquare(1.673425);
   ...
   quadLineFit1007->SetParameter(0,74.38373);
   quadLineFit1007->SetParError(0,0.06591952);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.149654);
   quadLineFit1007->SetParError(1,1.069096);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.55221);
   Graph_mI10_ppm1007->SetMaximum(73.86861);
   ...
   quadLineFit1008->SetChisquare(6.705998);
   ...
   quadLineFit1008->SetParameter(0,74.34819);
   quadLineFit1008->SetParError(0,0.05788326);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.54482);
   quadLineFit1008->SetParError(1,0.9421379);
   ...
   quadLineFit1009->SetChisquare(6.705998);
   ...
   quadLineFit1009->SetParameter(0,74.34819);
   quadLineFit1009->SetParError(0,0.05788326);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.54482);
   quadLineFit1009->SetParError(1,0.9421379);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.19437);
   Graph_mI30_ppm1009->SetMaximum(72.88866);
   ...
   quadLineFit1010->SetChisquare(2.948503);
   ...
   quadLineFit1010->SetParameter(0,74.23371);
   quadLineFit1010->SetParError(0,0.05473556);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.3735);
   quadLineFit1010->SetParError(1,0.9472897);
   ...
   quadLineFit1011->SetChisquare(2.948503);
   ...
   quadLineFit1011->SetParameter(0,74.23371);
   quadLineFit1011->SetParError(0,0.05473556);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.3735);
   quadLineFit1011->SetParError(1,0.9472897);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.26721);
   Graph_mI50_ppm1011->SetMaximum(71.91075);
   ...
   quadLineFit1012->SetChisquare(0.5808887);
   ...
   quadLineFit1012->SetParameter(0,74.15974);
   quadLineFit1012->SetParError(0,0.1105359);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.06971);
   quadLineFit1012->SetParError(1,1.977848);
   ...
   quadLineFit1013->SetChisquare(0.5808887);
   ...
   quadLineFit1013->SetParameter(0,74.15974);
   quadLineFit1013->SetParError(0,0.1105359);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.06971);
   quadLineFit1013->SetParError(1,1.977848);
