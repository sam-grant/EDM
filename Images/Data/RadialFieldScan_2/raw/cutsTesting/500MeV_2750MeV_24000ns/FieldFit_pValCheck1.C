...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.41172,75,69.77324);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.39322);
   Graph_Graph01027->SetMaximum(55.75474);
   ...
   mainFit1028->SetChisquare(1.564105);
   ...
   mainFit1028->SetParameter(0,-0.6367889);
   mainFit1028->SetParError(0,0.4930511);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9072179);
   mainFit1028->SetParError(1,0.01634856);
   ...
   pt_LaTex = pt->AddText("0.907#pm0.0163");
   pt_LaTex = pt->AddText("#minus0.637#pm0.493");
   pt_LaTex = pt->AddText("#minus0.702#pm0.545");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.701914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.701914,-56.39322,0.701914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.564105);
   ...
   mainFit1029->SetParameter(0,-0.6367889);
   mainFit1029->SetParError(0,0.4930511);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9072179);
   mainFit1029->SetParError(1,0.01634856);
