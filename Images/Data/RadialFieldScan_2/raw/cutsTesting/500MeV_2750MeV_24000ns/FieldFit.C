...
//=========  (Mon Apr 26 21:32:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.39322);
   Graph_Graph01020->SetMaximum(55.75474);
   ...
   mainFit1021->SetChisquare(7.495747);
   ...
   mainFit1021->SetParameter(0,-1.182065);
   mainFit1021->SetParError(0,0.4392791);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8892073);
   mainFit1021->SetParError(1,0.01458245);
   ...
   pt_LaTex = pt->AddText("0.889#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.18#pm0.439");
   pt_LaTex = pt->AddText("#minus1.33#pm0.491");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.329347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.329347,-56.39322,1.329347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.495747);
   ...
   mainFit1022->SetParameter(0,-1.182065);
   mainFit1022->SetParError(0,0.4392791);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8892073);
   mainFit1022->SetParError(1,0.01458245);
