...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.20299);
   Graph_Graph01029->SetMaximum(53.09783);
   ...
   mainFit1030->SetChisquare(4.527443);
   ...
   mainFit1030->SetParameter(0,-0.4681574);
   mainFit1030->SetParError(0,0.5380266);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.835164);
   mainFit1030->SetParError(1,0.01635053);
   ...
   pt_LaTex = pt->AddText("#minus0.468#pm0.538");
   pt_LaTex = pt->AddText("#minus0.561#pm0.643");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5605575,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5605575,-54.20299,0.5605575,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.527443);
   ...
   mainFit1031->SetParameter(0,-0.4681574);
   mainFit1031->SetParError(0,0.5380266);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.835164);
   mainFit1031->SetParError(1,0.01635053);
