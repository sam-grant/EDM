...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.20299);
   Graph_Graph01023->SetMaximum(53.09783);
   ...
   mainFit1024->SetChisquare(5.068747);
   ...
   mainFit1024->SetParameter(0,-0.3135217);
   mainFit1024->SetParError(0,0.4952668);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8360386);
   mainFit1024->SetParError(1,0.01630762);
   ...
   mainFit1025->SetChisquare(5.068747);
   ...
   mainFit1025->SetParameter(0,-0.3135217);
   mainFit1025->SetParError(0,0.4952668);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8360386);
   mainFit1025->SetParError(1,0.01630762);
