...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.57425,50,41.30371);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.18646);
   Graph_Graph01025->SetMaximum(30.91591);
   ...
   mainFit1026->SetChisquare(2.500983);
   ...
   mainFit1026->SetParameter(0,-0.6348836);
   mainFit1026->SetParError(0,0.5343205);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8144194);
   mainFit1026->SetParError(1,0.02116129);
   ...
   pt_LaTex = pt->AddText("#minus0.635#pm0.534");
   pt_LaTex = pt->AddText("#minus0.78#pm0.659");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.7795537,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7795537,-52.18646,0.7795537,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.500983);
   ...
   mainFit1027->SetParameter(0,-0.6348836);
   mainFit1027->SetParError(0,0.5343205);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8144194);
   mainFit1027->SetParError(1,0.02116129);
