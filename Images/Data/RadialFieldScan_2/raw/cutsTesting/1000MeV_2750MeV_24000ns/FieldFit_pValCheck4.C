...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.20299);
   Graph_Graph01033->SetMaximum(53.09783);
   ...
   mainFit1034->SetChisquare(4.838529);
   ...
   mainFit1034->SetParameter(0,-0.4934224);
   mainFit1034->SetParError(0,0.6211847);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8419106);
   mainFit1034->SetParError(1,0.02038901);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0204");
   pt_LaTex = pt->AddText("#minus0.493#pm0.621");
   pt_LaTex = pt->AddText("#minus0.586#pm0.731");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5860747,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5860747,-54.20299,0.5860747,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.838529);
   ...
   mainFit1035->SetParameter(0,-0.4934224);
   mainFit1035->SetParError(0,0.6211847);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8419106);
   mainFit1035->SetParError(1,0.02038901);
