...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.66397,70,61.72011);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.12556);
   Graph_Graph01035->SetMaximum(51.1817);
   ...
   mainFit1036->SetChisquare(4.857344);
   ...
   mainFit1036->SetParameter(0,-0.2410287);
   mainFit1036->SetParError(0,0.5197577);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8326452);
   mainFit1036->SetParError(1,0.01789989);
   ...
   pt_LaTex = pt->AddText("0.833#pm0.0179");
   pt_LaTex = pt->AddText("#minus0.241#pm 0.52");
   pt_LaTex = pt->AddText("#minus0.289#pm0.623");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.2894734,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2894734,-33.12556,0.2894734,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.857344);
   ...
   mainFit1037->SetParameter(0,-0.2410287);
   mainFit1037->SetParError(0,0.5197577);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8326452);
   mainFit1037->SetParError(1,0.01789989);
