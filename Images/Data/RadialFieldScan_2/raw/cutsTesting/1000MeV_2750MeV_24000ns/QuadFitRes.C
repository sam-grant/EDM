...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01731232);
   Graph_Graph11015->SetMaximum(0.04834104);
   ...
   Graph_Graph21016->SetMinimum(-0.009228338);
   Graph_Graph21016->SetMaximum(0.01087977);
   ...
   Graph_Graph31017->SetMinimum(-0.02661714);
   Graph_Graph31017->SetMaximum(0.02057173);
   ...
   Graph_Graph41018->SetMinimum(-0.01915353);
   Graph_Graph41018->SetMaximum(0.02557009);
   ...
   Graph_Graph51019->SetMinimum(-0.00639812);
   Graph_Graph51019->SetMaximum(0.008554178);
