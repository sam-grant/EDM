...
//=========  (Mon Apr 26 21:40:30 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.596556);
   ...
   quadLineFit1002->SetParameter(0,74.58255);
   quadLineFit1002->SetParError(0,0.07445161);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.9075);
   quadLineFit1002->SetParError(1,1.248596);
   ...
   quadLineFit1003->SetChisquare(2.596556);
   ...
   quadLineFit1003->SetParameter(0,74.58255);
   quadLineFit1003->SetParError(0,0.07445161);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.9075);
   quadLineFit1003->SetParError(1,1.248596);
   ...
   Graph_30_ppm1003->SetMinimum(75.77839);
   Graph_30_ppm1003->SetMaximum(76.36003);
   ...
   quadLineFit1004->SetChisquare(4.92504);
   ...
   quadLineFit1004->SetParameter(0,74.66637);
   quadLineFit1004->SetParError(0,0.06362594);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.94498);
   quadLineFit1004->SetParError(1,1.04573);
   ...
   quadLineFit1005->SetChisquare(4.92504);
   ...
   quadLineFit1005->SetParameter(0,74.66637);
   quadLineFit1005->SetParError(0,0.06362594);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.94498);
   quadLineFit1005->SetParError(1,1.04573);
   ...
   Graph_10_ppm1005->SetMinimum(74.84373);
   Graph_10_ppm1005->SetMaximum(75.10404);
   ...
   quadLineFit1006->SetChisquare(0.7247305);
   ...
   quadLineFit1006->SetParameter(0,74.42183);
   quadLineFit1006->SetParError(0,0.07450917);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.858023);
   quadLineFit1006->SetParError(1,1.208448);
   ...
   quadLineFit1007->SetChisquare(0.7247305);
   ...
   quadLineFit1007->SetParameter(0,74.42183);
   quadLineFit1007->SetParError(0,0.07450917);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.858023);
   quadLineFit1007->SetParError(1,1.208448);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72029);
   Graph_mI10_ppm1007->SetMaximum(73.98963);
   ...
   quadLineFit1008->SetChisquare(3.373464);
   ...
   quadLineFit1008->SetParameter(0,74.3735);
   quadLineFit1008->SetParError(0,0.06541878);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.600021);
   quadLineFit1008->SetParError(1,1.064804);
   ...
   quadLineFit1009->SetChisquare(3.373464);
   ...
   quadLineFit1009->SetParameter(0,74.3735);
   quadLineFit1009->SetParError(0,0.06541878);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.600021);
   quadLineFit1009->SetParError(1,1.064804);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40553);
   Graph_mI30_ppm1009->SetMaximum(73.0565);
   ...
   quadLineFit1010->SetChisquare(2.803828);
   ...
   quadLineFit1010->SetParameter(0,74.28236);
   quadLineFit1010->SetParError(0,0.06189133);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.0288);
   quadLineFit1010->SetParError(1,1.071156);
   ...
   quadLineFit1011->SetChisquare(2.803828);
   ...
   quadLineFit1011->SetParameter(0,74.28236);
   quadLineFit1011->SetParError(0,0.06189133);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.0288);
   quadLineFit1011->SetParError(1,1.071156);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51095);
   Graph_mI50_ppm1011->SetMaximum(72.13193);
   ...
   quadLineFit1012->SetChisquare(0.3989982);
   ...
   quadLineFit1012->SetParameter(0,74.27592);
   quadLineFit1012->SetParError(0,0.1248039);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.02821);
   quadLineFit1012->SetParError(1,2.233049);
   ...
   quadLineFit1013->SetChisquare(0.3989982);
   ...
   quadLineFit1013->SetParameter(0,74.27592);
   quadLineFit1013->SetParError(0,0.1248039);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.02821);
   quadLineFit1013->SetParError(1,2.233049);
