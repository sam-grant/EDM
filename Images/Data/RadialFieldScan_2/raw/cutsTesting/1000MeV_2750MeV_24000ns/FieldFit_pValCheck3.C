...
//=========  (Mon Apr 26 21:40:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.20299);
   Graph_Graph01031->SetMaximum(53.09783);
   ...
   mainFit1032->SetChisquare(5.062207);
   ...
   mainFit1032->SetParameter(0,-0.336429);
   mainFit1032->SetParError(0,0.5705577);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8363938);
   mainFit1032->SetParError(1,0.01688887);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.336#pm0.571");
   pt_LaTex = pt->AddText("#minus0.402#pm 0.68");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4022375,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4022375,-54.20299,0.4022375,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.062207);
   ...
   mainFit1033->SetParameter(0,-0.336429);
   mainFit1033->SetParError(0,0.5705577);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8363938);
   mainFit1033->SetParError(1,0.01688887);
