...
//=========  (Wed Apr 28 14:48:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02223731);
   Graph_Graph11015->SetMaximum(0.04570641);
   ...
   Graph_Graph21016->SetMinimum(-0.0007488136);
   Graph_Graph21016->SetMaximum(0.000881493);
   ...
   Graph_Graph31017->SetMinimum(-0.03916266);
   Graph_Graph31017->SetMaximum(0.0281751);
   ...
   Graph_Graph41018->SetMinimum(-0.004980898);
   Graph_Graph41018->SetMaximum(0.008157669);
   ...
   Graph_Graph51019->SetMinimum(-0.01673152);
   Graph_Graph51019->SetMaximum(0.02236225);
