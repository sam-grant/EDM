...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.58702);
   Graph_Graph01029->SetMaximum(50.90914);
   ...
   mainFit1030->SetChisquare(2.130102);
   ...
   mainFit1030->SetParameter(0,-0.3700545);
   mainFit1030->SetParError(0,0.5613625);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8047981);
   mainFit1030->SetParError(1,0.01712208);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.71");
   pt_LaTex = pt->AddText("0.805#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.37#pm0.561");
   pt_LaTex = pt->AddText("#minus0.46#pm0.696");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4598104,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4598104,-51.58702,0.4598104,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.130102);
   ...
   mainFit1031->SetParameter(0,-0.3700545);
   mainFit1031->SetParError(0,0.5613625);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8047981);
   mainFit1031->SetParError(1,0.01712208);
