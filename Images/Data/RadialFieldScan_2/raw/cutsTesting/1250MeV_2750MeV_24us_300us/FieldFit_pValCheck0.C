...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.7233,50,40.34243);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.71673);
   Graph_Graph01025->SetMaximum(30.33586);
   ...
   mainFit1026->SetChisquare(2.022893);
   ...
   mainFit1026->SetParameter(0,-0.3701133);
   mainFit1026->SetParError(0,0.5564363);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7924762);
   mainFit1026->SetParError(1,0.02203065);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.674");
   pt_LaTex = pt->AddText("0.792#pm0.022");
   pt_LaTex = pt->AddText("#minus0.37#pm0.556");
   pt_LaTex = pt->AddText("#minus0.467#pm0.704");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.4670339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4670339,-49.71673,0.4670339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.022893);
   ...
   mainFit1027->SetParameter(0,-0.3701133);
   mainFit1027->SetParError(0,0.5564363);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7924762);
   mainFit1027->SetParError(1,0.02203065);
