...
//=========  (Wed Apr 28 14:48:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.58702);
   Graph_Graph01020->SetMaximum(50.90914);
   ...
   mainFit1021->SetChisquare(2.963779);
   ...
   mainFit1021->SetParameter(0,-0.1691531);
   mainFit1021->SetParError(0,0.5164398);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8059891);
   mainFit1021->SetParError(1,0.01707251);
   ...
   mainFit1022->SetChisquare(2.963779);
   ...
   mainFit1022->SetParameter(0,-0.1691531);
   mainFit1022->SetParError(0,0.5164398);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8059891);
   mainFit1022->SetParError(1,0.01707251);
