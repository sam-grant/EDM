...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.39905,75,63.72116);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.58702);
   Graph_Graph01031->SetMaximum(50.90914);
   ...
   mainFit1032->SetChisquare(2.920407);
   ...
   mainFit1032->SetParameter(0,-0.2306057);
   mainFit1032->SetParError(0,0.5947962);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8069375);
   mainFit1032->SetParError(1,0.01766944);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.973");
   pt_LaTex = pt->AddText("0.807#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.231#pm0.595");
   pt_LaTex = pt->AddText("#minus0.286#pm0.735");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2857789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2857789,-51.58702,0.2857789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.920407);
   ...
   mainFit1033->SetParameter(0,-0.2306057);
   mainFit1033->SetParError(0,0.5947962);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8069375);
   mainFit1033->SetParError(1,0.01766944);
