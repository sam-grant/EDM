...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.58702);
   Graph_Graph01027->SetMaximum(50.90914);
   ...
   mainFit1028->SetChisquare(0.1890402);
   ...
   mainFit1028->SetParameter(0,0.2643156);
   mainFit1028->SetParError(0,0.5782961);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8201552);
   mainFit1028->SetParError(1,0.01907338);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.063");
   pt_LaTex = pt->AddText(" 0.82#pm0.0191");
   pt_LaTex = pt->AddText("0.264#pm0.578");
   pt_LaTex = pt->AddText("0.322#pm0.705");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3222751,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3222751,-51.58702,-0.3222751,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1890402);
   ...
   mainFit1029->SetParameter(0,0.2643156);
   mainFit1029->SetParError(0,0.5782961);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8201552);
   mainFit1029->SetParError(1,0.01907338);
