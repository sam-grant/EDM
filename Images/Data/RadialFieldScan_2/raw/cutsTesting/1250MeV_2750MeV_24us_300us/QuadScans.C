...
//=========  (Wed Apr 28 14:48:21 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.240061);
   ...
   quadLineFit1002->SetParameter(0,74.70376);
   quadLineFit1002->SetParError(0,0.07877098);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.04657);
   quadLineFit1002->SetParError(1,1.321219);
   ...
   quadLineFit1003->SetChisquare(3.240061);
   ...
   quadLineFit1003->SetParameter(0,74.70376);
   quadLineFit1003->SetParError(0,0.07877098);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.04657);
   quadLineFit1003->SetParError(1,1.321219);
   ...
   Graph_30_ppm1003->SetMinimum(75.82022);
   Graph_30_ppm1003->SetMaximum(76.38929);
   ...
   quadLineFit1004->SetChisquare(4.726801);
   ...
   quadLineFit1004->SetParameter(0,74.72049);
   quadLineFit1004->SetParError(0,0.06624107);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.57606);
   quadLineFit1004->SetParError(1,1.088745);
   ...
   quadLineFit1005->SetChisquare(4.726801);
   ...
   quadLineFit1005->SetParameter(0,74.72049);
   quadLineFit1005->SetParError(0,0.06624107);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.57606);
   quadLineFit1005->SetParError(1,1.088745);
   ...
   Graph_10_ppm1005->SetMinimum(74.8897);
   Graph_10_ppm1005->SetMaximum(75.14972);
   ...
   quadLineFit1006->SetChisquare(0.004395409);
   ...
   quadLineFit1006->SetParameter(0,74.46949);
   quadLineFit1006->SetParError(0,0.077611);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.938503);
   quadLineFit1006->SetParError(1,1.25868);
   ...
   quadLineFit1007->SetChisquare(0.004395409);
   ...
   quadLineFit1007->SetParameter(0,74.46949);
   quadLineFit1007->SetParError(0,0.077611);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.938503);
   quadLineFit1007->SetParError(1,1.25868);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80504);
   Graph_mI10_ppm1007->SetMaximum(74.07232);
   ...
   quadLineFit1008->SetChisquare(7.074284);
   ...
   quadLineFit1008->SetParameter(0,74.42049);
   quadLineFit1008->SetParError(0,0.06815447);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.030783);
   quadLineFit1008->SetParError(1,1.109313);
   ...
   quadLineFit1009->SetChisquare(7.074284);
   ...
   quadLineFit1009->SetParameter(0,74.42049);
   quadLineFit1009->SetParError(0,0.06815447);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.030783);
   quadLineFit1009->SetParError(1,1.109313);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.53286);
   Graph_mI30_ppm1009->SetMaximum(73.16277);
   ...
   quadLineFit1010->SetChisquare(0.3453656);
   ...
   quadLineFit1010->SetParameter(0,74.35619);
   quadLineFit1010->SetParError(0,0.06445104);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.46107);
   quadLineFit1010->SetParError(1,1.115423);
   ...
   quadLineFit1011->SetChisquare(0.3453656);
   ...
   quadLineFit1011->SetParameter(0,74.35619);
   quadLineFit1011->SetParError(0,0.06445104);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.46107);
   quadLineFit1011->SetParError(1,1.115423);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.65464);
   Graph_mI50_ppm1011->SetMaximum(72.24532);
   ...
   quadLineFit1012->SetChisquare(2.514532);
   ...
   quadLineFit1012->SetParameter(0,74.28124);
   quadLineFit1012->SetParError(0,0.1298503);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.72236);
   quadLineFit1012->SetParError(1,2.323315);
   ...
   quadLineFit1013->SetChisquare(2.514532);
   ...
   quadLineFit1013->SetParameter(0,74.28124);
   quadLineFit1013->SetParError(0,0.1298503);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.72236);
   quadLineFit1013->SetParError(1,2.323315);
