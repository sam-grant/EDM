...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.56256,70,59.35386);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.37092);
   Graph_Graph01035->SetMaximum(49.16222);
   ...
   mainFit1036->SetChisquare(2.948665);
   ...
   mainFit1036->SetParameter(0,-0.1490366);
   mainFit1036->SetParError(0,0.5417425);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8050365);
   mainFit1036->SetParError(1,0.01874876);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.983");
   pt_LaTex = pt->AddText("0.805#pm0.0187");
   pt_LaTex = pt->AddText("#minus0.149#pm0.542");
   pt_LaTex = pt->AddText("#minus0.185#pm0.672");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1851302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1851302,-32.37092,0.1851302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.948665);
   ...
   mainFit1037->SetParameter(0,-0.1490366);
   mainFit1037->SetParError(0,0.5417425);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8050365);
   mainFit1037->SetParError(1,0.01874876);
