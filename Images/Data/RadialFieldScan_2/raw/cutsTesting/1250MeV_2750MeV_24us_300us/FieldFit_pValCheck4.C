...
//=========  (Wed Apr 28 14:48:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.58702);
   Graph_Graph01033->SetMaximum(50.90914);
   ...
   mainFit1034->SetChisquare(2.943779);
   ...
   mainFit1034->SetParameter(0,-0.1140339);
   mainFit1034->SetParError(0,0.6470056);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8041779);
   mainFit1034->SetParError(1,0.02134249);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.981");
   pt_LaTex = pt->AddText("0.804#pm0.0213");
   pt_LaTex = pt->AddText("#minus0.114#pm0.647");
   pt_LaTex = pt->AddText("#minus0.142#pm0.803");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1418019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1418019,-51.58702,0.1418019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.943779);
   ...
   mainFit1035->SetParameter(0,-0.1140339);
   mainFit1035->SetParError(0,0.6470056);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8041779);
   mainFit1035->SetParError(1,0.02134249);
