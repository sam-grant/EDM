...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.45279,70,65.38614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.0689);
   Graph_Graph01035->SetMaximum(54.00225);
   ...
   mainFit1036->SetChisquare(7.885841);
   ...
   mainFit1036->SetParameter(0,-1.488875);
   mainFit1036->SetParError(0,0.4377629);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9087415);
   mainFit1036->SetParError(1,0.01514576);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.63");
   pt_LaTex = pt->AddText("0.909#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.49#pm0.438");
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.638392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.638392,-37.0689,1.638392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.885841);
   ...
   mainFit1037->SetParameter(0,-1.488875);
   mainFit1037->SetParError(0,0.4377629);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9087415);
   mainFit1037->SetParError(1,0.01514576);
