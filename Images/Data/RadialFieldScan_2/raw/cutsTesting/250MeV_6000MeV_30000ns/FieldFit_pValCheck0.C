...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.87007,50,43.35447);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.74762);
   Graph_Graph01025->SetMaximum(32.23202);
   ...
   mainFit1026->SetChisquare(4.800133);
   ...
   mainFit1026->SetParameter(0,-1.818619);
   mainFit1026->SetParError(0,0.4496845);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8903205);
   mainFit1026->SetParError(1,0.017807);
   ...
   pt_LaTex = pt->AddText(" 0.89#pm0.0178");
   pt_LaTex = pt->AddText("#minus1.82#pm 0.45");
   pt_LaTex = pt->AddText("#minus2.04#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.042657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.042657,-56.74762,2.042657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.800133);
   ...
   mainFit1027->SetParameter(0,-1.818619);
   mainFit1027->SetParError(0,0.4496845);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8903205);
   mainFit1027->SetParError(1,0.017807);
