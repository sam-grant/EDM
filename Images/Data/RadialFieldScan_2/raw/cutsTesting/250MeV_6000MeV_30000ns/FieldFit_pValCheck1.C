...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.26906,75,70.34939);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-58.90721);
   Graph_Graph01027->SetMaximum(55.98755);
   ...
   mainFit1028->SetChisquare(0.8802096);
   ...
   mainFit1028->SetParameter(0,-0.9628291);
   mainFit1028->SetParError(0,0.4673235);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9285529);
   mainFit1028->SetParError(1,0.01541149);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.293");
   pt_LaTex = pt->AddText("0.929#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.963#pm0.467");
   pt_LaTex = pt->AddText("#minus1.04#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.036914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.036914,-58.90721,1.036914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8802096);
   ...
   mainFit1029->SetParameter(0,-0.9628291);
   mainFit1029->SetParError(0,0.4673235);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9285529);
   mainFit1029->SetParError(1,0.01541149);
