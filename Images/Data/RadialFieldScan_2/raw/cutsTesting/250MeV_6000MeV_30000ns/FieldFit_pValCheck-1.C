...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.90721);
   Graph_Graph01023->SetMaximum(55.98755);
   ...
   mainFit1024->SetChisquare(7.947543);
   ...
   mainFit1024->SetParameter(0,-1.521675);
   mainFit1024->SetParError(0,0.4173735);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9102939);
   mainFit1024->SetParError(1,0.01379632);
   ...
   mainFit1025->SetChisquare(7.947543);
   ...
   mainFit1025->SetParameter(0,-1.521675);
   mainFit1025->SetParError(0,0.4173735);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9102939);
   mainFit1025->SetParError(1,0.01379632);
