...
//=========  (Wed Apr 21 13:04:56 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.09437284);
   ...
   quadLineFit1002->SetParameter(0,74.53046);
   quadLineFit1002->SetParError(0,0.06361065);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.34597);
   quadLineFit1002->SetParError(1,1.067014);
   ...
   quadLineFit1003->SetChisquare(0.09437284);
   ...
   quadLineFit1003->SetParameter(0,74.53046);
   quadLineFit1003->SetParError(0,0.06361065);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.34597);
   quadLineFit1003->SetParError(1,1.067014);
   ...
   Graph_30_ppm1003->SetMinimum(75.82767);
   Graph_30_ppm1003->SetMaximum(76.4225);
   ...
   quadLineFit1004->SetChisquare(2.943477);
   ...
   quadLineFit1004->SetParameter(0,74.64837);
   quadLineFit1004->SetParError(0,0.05352113);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.9374);
   quadLineFit1004->SetParError(1,0.8796434);
   ...
   quadLineFit1005->SetChisquare(2.943477);
   ...
   quadLineFit1005->SetParameter(0,74.64837);
   quadLineFit1005->SetParError(0,0.05352113);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.9374);
   quadLineFit1005->SetParError(1,0.8796434);
   ...
   Graph_10_ppm1005->SetMinimum(74.81555);
   Graph_10_ppm1005->SetMaximum(75.07153);
   ...
   quadLineFit1006->SetChisquare(1.472831);
   ...
   quadLineFit1006->SetParameter(0,74.38651);
   quadLineFit1006->SetParError(0,0.06273031);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.918212);
   quadLineFit1006->SetParError(1,1.017392);
   ...
   quadLineFit1007->SetChisquare(1.472831);
   ...
   quadLineFit1007->SetParameter(0,74.38651);
   quadLineFit1007->SetParError(0,0.06273031);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.918212);
   quadLineFit1007->SetParError(1,1.017392);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.58925);
   Graph_mI10_ppm1007->SetMaximum(73.91271);
   ...
   quadLineFit1008->SetChisquare(10.21424);
   ...
   quadLineFit1008->SetParameter(0,74.41158);
   quadLineFit1008->SetParError(0,0.0550898);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.85165);
   quadLineFit1008->SetParError(1,0.896684);
   ...
   quadLineFit1009->SetChisquare(10.21424);
   ...
   quadLineFit1009->SetParameter(0,74.41158);
   quadLineFit1009->SetParError(0,0.0550898);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.85165);
   quadLineFit1009->SetParError(1,0.896684);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.20517);
   Graph_mI30_ppm1009->SetMaximum(72.92782);
   ...
   quadLineFit1010->SetChisquare(0.6119192);
   ...
   quadLineFit1010->SetParameter(0,74.32734);
   quadLineFit1010->SetParError(0,0.05206709);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.57851);
   quadLineFit1010->SetParError(1,0.9011277);
   ...
   quadLineFit1011->SetChisquare(0.6119192);
   ...
   quadLineFit1011->SetParameter(0,74.32734);
   quadLineFit1011->SetParError(0,0.05206709);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.57851);
   quadLineFit1011->SetParError(1,0.9011277);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.26958);
   Graph_mI50_ppm1011->SetMaximum(71.94371);
   ...
   quadLineFit1012->SetChisquare(0.1451601);
   ...
   quadLineFit1012->SetParameter(0,74.31011);
   quadLineFit1012->SetParError(0,0.105126);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.45165);
   quadLineFit1012->SetParError(1,1.881004);
   ...
   quadLineFit1013->SetChisquare(0.1451601);
   ...
   quadLineFit1013->SetParameter(0,74.31011);
   quadLineFit1013->SetParError(0,0.105126);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.45165);
   quadLineFit1013->SetParError(1,1.881004);
