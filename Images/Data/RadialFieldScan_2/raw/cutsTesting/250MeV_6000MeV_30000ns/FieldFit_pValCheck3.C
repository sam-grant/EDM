...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.90721);
   Graph_Graph01031->SetMaximum(55.98755);
   ...
   mainFit1032->SetChisquare(7.860501);
   ...
   mainFit1032->SetParameter(0,-1.451319);
   mainFit1032->SetParError(0,0.4806963);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9092072);
   mainFit1032->SetParError(1,0.01427955);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.45#pm0.481");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.523");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.596247,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.596247,-58.90721,1.596247,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.860501);
   ...
   mainFit1033->SetParameter(0,-1.451319);
   mainFit1033->SetParError(0,0.4806963);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9092072);
   mainFit1033->SetParError(1,0.01427955);
