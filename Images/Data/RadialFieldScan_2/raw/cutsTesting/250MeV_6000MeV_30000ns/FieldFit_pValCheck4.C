...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.90721);
   Graph_Graph01033->SetMaximum(55.98755);
   ...
   mainFit1034->SetChisquare(7.792926);
   ...
   mainFit1034->SetParameter(0,-1.645705);
   mainFit1034->SetParError(0,0.5231583);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.914369);
   mainFit1034->SetParError(1,0.01725521);
   ...
   pt_LaTex = pt->AddText("0.914#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.65#pm0.523");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.557");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.799825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.799825,-58.90721,1.799825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.792926);
   ...
   mainFit1035->SetParameter(0,-1.645705);
   mainFit1035->SetParError(0,0.5231583);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.914369);
   mainFit1035->SetParError(1,0.01725521);
