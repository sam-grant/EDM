...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.90721);
   Graph_Graph01020->SetMaximum(55.98755);
   ...
   mainFit1021->SetChisquare(7.947543);
   ...
   mainFit1021->SetParameter(0,-1.521675);
   mainFit1021->SetParError(0,0.4173735);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9102939);
   mainFit1021->SetParError(1,0.01379632);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.52#pm0.417");
   pt_LaTex = pt->AddText("#minus1.67#pm0.455");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.67163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.67163,-58.90721,1.67163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.947543);
   ...
   mainFit1022->SetParameter(0,-1.521675);
   mainFit1022->SetParError(0,0.4173735);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9102939);
   mainFit1022->SetParError(1,0.01379632);
