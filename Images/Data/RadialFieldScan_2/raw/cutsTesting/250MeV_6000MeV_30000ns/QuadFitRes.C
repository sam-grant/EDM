...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01858871);
   Graph_Graph11015->SetMaximum(0.01920465);
   ...
   Graph_Graph21016->SetMinimum(-0.01108433);
   Graph_Graph21016->SetMaximum(0.01304211);
   ...
   Graph_Graph31017->SetMinimum(-0.03563418);
   Graph_Graph31017->SetMaximum(0.03270518);
   ...
   Graph_Graph41018->SetMinimum(-0.005457657);
   Graph_Graph41018->SetMaximum(0.008285812);
   ...
   Graph_Graph51019->SetMinimum(-0.003248589);
   Graph_Graph51019->SetMaximum(0.004342082);
