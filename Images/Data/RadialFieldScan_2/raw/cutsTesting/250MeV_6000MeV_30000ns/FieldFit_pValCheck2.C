...
//=========  (Wed Apr 21 13:04:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.90721);
   Graph_Graph01029->SetMaximum(55.98755);
   ...
   mainFit1030->SetChisquare(5.87028);
   ...
   mainFit1030->SetParameter(0,-1.777868);
   mainFit1030->SetParError(0,0.4536494);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9087829);
   mainFit1030->SetParError(1,0.01383607);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.78#pm0.454");
   pt_LaTex = pt->AddText("#minus1.96#pm0.497");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.956318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.956318,-58.90721,1.956318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.87028);
   ...
   mainFit1031->SetParameter(0,-1.777868);
   mainFit1031->SetParError(0,0.4536494);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9087829);
   mainFit1031->SetParError(1,0.01383607);
