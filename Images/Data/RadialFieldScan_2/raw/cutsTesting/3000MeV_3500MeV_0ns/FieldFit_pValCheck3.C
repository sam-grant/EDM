...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-70.67636);
   Graph_Graph01031->SetMaximum(61.84678);
   ...
   mainFit1032->SetChisquare(3.689875);
   ...
   mainFit1032->SetParameter(0,-6.97722);
   mainFit1032->SetParError(0,1.696105);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.002764);
   mainFit1032->SetParError(1,0.05046923);
   ...
   pt_LaTex = pt->AddText("    1#pm0.0505");
   pt_LaTex = pt->AddText("#minus6.98#pm  1.7");
   pt_LaTex = pt->AddText("#minus6.96#pm 1.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,6.957987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(6.957987,-70.67636,6.957987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.689875);
   ...
   mainFit1033->SetParameter(0,-6.97722);
   mainFit1033->SetParError(0,1.696105);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.002764);
   mainFit1033->SetParError(1,0.05046923);
