...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-80.9729,50,47.06793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-68.16882);
   Graph_Graph01025->SetMaximum(34.26384);
   ...
   mainFit1026->SetChisquare(8.485128);
   ...
   mainFit1026->SetParameter(0,-5.59232);
   mainFit1026->SetParError(0,1.587196);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9220928);
   mainFit1026->SetParError(1,0.06276863);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.83");
   pt_LaTex = pt->AddText("0.922#pm0.0628");
   pt_LaTex = pt->AddText("#minus5.59#pm 1.59");
   pt_LaTex = pt->AddText("#minus6.06#pm 1.82");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,6.064812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(6.064812,-68.16882,6.064812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(8.485128);
   ...
   mainFit1027->SetParameter(0,-5.59232);
   mainFit1027->SetParError(0,1.587196);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9220928);
   mainFit1027->SetParError(1,0.06276863);
