...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04902145);
   Graph_Graph11015->SetMaximum(0.03946516);
   ...
   Graph_Graph21016->SetMinimum(-0.008145618);
   Graph_Graph21016->SetMaximum(0.009535906);
   ...
   Graph_Graph31017->SetMinimum(-0.1800832);
   Graph_Graph31017->SetMaximum(0.1630178);
   ...
   Graph_Graph41018->SetMinimum(-0.05952902);
   Graph_Graph41018->SetMaximum(0.0284171);
   ...
   Graph_Graph51019->SetMinimum(-0.01033527);
   Graph_Graph51019->SetMaximum(0.01369038);
