...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-70.67636);
   Graph_Graph01027->SetMaximum(61.84678);
   ...
   mainFit1028->SetChisquare(9.5478);
   ...
   mainFit1028->SetParameter(0,-4.373947);
   mainFit1028->SetParError(0,1.653244);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9867234);
   mainFit1028->SetParError(1,0.05464794);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.18");
   pt_LaTex = pt->AddText("0.987#pm0.0546");
   pt_LaTex = pt->AddText("#minus4.37#pm 1.65");
   pt_LaTex = pt->AddText("#minus4.43#pm 1.71");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.432799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.432799,-70.67636,4.432799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(9.5478);
   ...
   mainFit1029->SetParameter(0,-4.373947);
   mainFit1029->SetParError(0,1.653244);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9867234);
   mainFit1029->SetParError(1,0.05464794);
