...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.144432);
   ...
   quadLineFit1002->SetParameter(0,75.19275);
   quadLineFit1002->SetParError(0,0.2269774);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.99956);
   quadLineFit1002->SetParError(1,3.803633);
   ...
   quadLineFit1003->SetChisquare(0.144432);
   ...
   quadLineFit1003->SetParameter(0,75.19275);
   quadLineFit1003->SetParError(0,0.2269774);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.99956);
   quadLineFit1003->SetParError(1,3.803633);
   ...
   Graph_30_ppm1003->SetMinimum(76.6071);
   Graph_30_ppm1003->SetMaximum(77.25103);
   ...
   quadLineFit1004->SetChisquare(1.073737);
   ...
   quadLineFit1004->SetParameter(0,75.52071);
   quadLineFit1004->SetParError(0,0.1889938);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.62338);
   quadLineFit1004->SetParError(1,3.104403);
   ...
   quadLineFit1005->SetChisquare(1.073737);
   ...
   quadLineFit1005->SetParameter(0,75.52071);
   quadLineFit1005->SetParError(0,0.1889938);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.62338);
   quadLineFit1005->SetParError(1,3.104403);
   ...
   Graph_10_ppm1005->SetMinimum(75.56085);
   Graph_10_ppm1005->SetMaximum(75.73593);
   ...
   quadLineFit1006->SetChisquare(0.06383474);
   ...
   quadLineFit1006->SetParameter(0,75.78272);
   quadLineFit1006->SetParError(0,0.2220915);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,-2.243539);
   quadLineFit1006->SetParError(1,3.59929);
   ...
   quadLineFit1007->SetChisquare(0.06383474);
   ...
   quadLineFit1007->SetParameter(0,75.78272);
   quadLineFit1007->SetParError(0,0.2220915);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,-2.243539);
   quadLineFit1007->SetParError(1,3.59929);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.31314);
   Graph_mI10_ppm1007->SetMaximum(74.81782);
   ...
   quadLineFit1008->SetChisquare(16.96545);
   ...
   quadLineFit1008->SetParameter(0,74.9849);
   quadLineFit1008->SetParError(0,0.1946644);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.752385);
   quadLineFit1008->SetParError(1,3.166365);
   ...
   quadLineFit1009->SetChisquare(16.96545);
   ...
   quadLineFit1009->SetParameter(0,74.9849);
   quadLineFit1009->SetParError(0,0.1946644);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.752385);
   quadLineFit1009->SetParError(1,3.166365);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.72248);
   Graph_mI30_ppm1009->SetMaximum(73.67792);
   ...
   quadLineFit1010->SetChisquare(1.178176);
   ...
   quadLineFit1010->SetParameter(0,75.41414);
   quadLineFit1010->SetParError(0,0.1835254);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-36.05587);
   quadLineFit1010->SetParError(1,3.172977);
   ...
   quadLineFit1011->SetChisquare(1.178176);
   ...
   quadLineFit1011->SetParameter(0,75.41414);
   quadLineFit1011->SetParError(0,0.1835254);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-36.05587);
   quadLineFit1011->SetParError(1,3.172977);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.87131);
   Graph_mI50_ppm1011->SetMaximum(72.70936);
   ...
   quadLineFit1012->SetChisquare(0.1163217);
   ...
   quadLineFit1012->SetParameter(0,75.31902);
   quadLineFit1012->SetParError(0,0.3699695);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-53.01732);
   quadLineFit1012->SetParError(1,6.615447);
   ...
   quadLineFit1013->SetChisquare(0.1163217);
   ...
   quadLineFit1013->SetParameter(0,75.31902);
   quadLineFit1013->SetParError(0,0.3699695);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-53.01732);
   quadLineFit1013->SetParError(1,6.615447);
