...
//=========  (Thu Apr 22 00:11:15 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-61.73686,70,73.3112);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-48.23205);
   Graph_Graph01035->SetMaximum(59.80639);
   ...
   mainFit1036->SetChisquare(9.981684);
   ...
   mainFit1036->SetParameter(0,-4.8996);
   mainFit1036->SetParError(0,1.545181);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9718721);
   mainFit1036->SetParError(1,0.05359911);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.33");
   pt_LaTex = pt->AddText("0.972#pm0.0536");
   pt_LaTex = pt->AddText(" #minus4.9#pm 1.55");
   pt_LaTex = pt->AddText("#minus5.04#pm 1.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,5.041404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.041404,-48.23205,5.041404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.981684);
   ...
   mainFit1037->SetParameter(0,-4.8996);
   mainFit1037->SetParError(0,1.545181);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9718721);
   mainFit1037->SetParError(1,0.05359911);
