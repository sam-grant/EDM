...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-70.67636);
   Graph_Graph01020->SetMaximum(61.84678);
   ...
   mainFit1021->SetChisquare(9.985765);
   ...
   mainFit1021->SetParameter(0,-4.869896);
   mainFit1021->SetParError(0,1.47357);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9704556);
   mainFit1021->SetParError(1,0.04879811);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  2.5");
   pt_LaTex = pt->AddText(" 0.97#pm0.0488");
   pt_LaTex = pt->AddText("#minus4.87#pm 1.47");
   pt_LaTex = pt->AddText("#minus5.02#pm  1.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,5.018154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.018154,-70.67636,5.018154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.985765);
   ...
   mainFit1022->SetParameter(0,-4.869896);
   mainFit1022->SetParError(0,1.47357);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9704556);
   mainFit1022->SetParError(1,0.04879811);
