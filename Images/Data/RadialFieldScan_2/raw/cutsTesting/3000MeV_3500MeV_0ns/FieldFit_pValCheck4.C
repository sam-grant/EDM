...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-70.67636);
   Graph_Graph01033->SetMaximum(61.84678);
   ...
   mainFit1034->SetChisquare(9.14055);
   ...
   mainFit1034->SetParameter(0,-3.84715);
   mainFit1034->SetParError(0,1.846341);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9367485);
   mainFit1034->SetParError(1,0.06103679);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.061");
   pt_LaTex = pt->AddText("#minus3.85#pm 1.85");
   pt_LaTex = pt->AddText("#minus4.11#pm 1.86");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.106919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.106919,-70.67636,4.106919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.14055);
   ...
   mainFit1035->SetParameter(0,-3.84715);
   mainFit1035->SetParError(0,1.846341);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9367485);
   mainFit1035->SetParError(1,0.06103679);
