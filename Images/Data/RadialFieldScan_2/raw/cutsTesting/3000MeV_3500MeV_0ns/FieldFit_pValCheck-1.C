...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-70.67636);
   Graph_Graph01023->SetMaximum(61.84678);
   ...
   mainFit1024->SetChisquare(9.985765);
   ...
   mainFit1024->SetParameter(0,-4.869896);
   mainFit1024->SetParError(0,1.47357);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9704556);
   mainFit1024->SetParError(1,0.04879811);
   ...
   mainFit1025->SetChisquare(9.985765);
   ...
   mainFit1025->SetParameter(0,-4.869896);
   mainFit1025->SetParError(0,1.47357);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9704556);
   mainFit1025->SetParError(1,0.04879811);
