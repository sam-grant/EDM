...
//=========  (Thu Apr 22 00:11:14 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-87.24175,75,78.41218);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-70.67636);
   Graph_Graph01029->SetMaximum(61.84678);
   ...
   mainFit1030->SetChisquare(5.333642);
   ...
   mainFit1030->SetParameter(0,-3.516393);
   mainFit1030->SetParError(0,1.601624);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9787415);
   mainFit1030->SetParError(1,0.04894909);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.0489");
   pt_LaTex = pt->AddText("#minus3.52#pm  1.6");
   pt_LaTex = pt->AddText("#minus3.59#pm 1.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.592771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.592771,-70.67636,3.592771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.333642);
   ...
   mainFit1031->SetParameter(0,-3.516393);
   mainFit1031->SetParError(0,1.601624);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9787415);
   mainFit1031->SetParError(1,0.04894909);
