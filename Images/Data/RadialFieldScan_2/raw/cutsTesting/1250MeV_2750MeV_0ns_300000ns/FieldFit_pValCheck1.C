...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.38593);
   Graph_Graph01027->SetMaximum(52.60725);
   ...
   mainFit1028->SetChisquare(2.024927);
   ...
   mainFit1028->SetParameter(0,-1.167184);
   mainFit1028->SetParError(0,0.4825816);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8853879);
   mainFit1028->SetParError(1,0.01591643);
   ...
   pt_LaTex = pt->AddText("#minus1.17#pm0.483");
   pt_LaTex = pt->AddText("#minus1.32#pm0.547");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.318274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.318274,-56.38593,1.318274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.024927);
   ...
   mainFit1029->SetParameter(0,-1.167184);
   mainFit1029->SetParError(0,0.4825816);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8853879);
   mainFit1029->SetParError(1,0.01591643);
