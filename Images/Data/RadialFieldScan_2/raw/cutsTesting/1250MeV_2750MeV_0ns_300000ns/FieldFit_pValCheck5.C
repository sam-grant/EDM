...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.57263,70,61.74391);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.64097);
   Graph_Graph01035->SetMaximum(50.81225);
   ...
   mainFit1036->SetChisquare(2.203077);
   ...
   mainFit1036->SetParameter(0,-1.260423);
   mainFit1036->SetParError(0,0.4519393);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8824658);
   mainFit1036->SetParError(1,0.01563612);
   ...
   pt_LaTex = pt->AddText("#minus1.26#pm0.452");
   pt_LaTex = pt->AddText("#minus1.43#pm0.506");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.428297,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.428297,-36.64097,1.428297,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.203077);
   ...
   mainFit1037->SetParameter(0,-1.260423);
   mainFit1037->SetParError(0,0.4519393);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8824658);
   mainFit1037->SetParError(1,0.01563612);
