...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.38593);
   Graph_Graph01031->SetMaximum(52.60725);
   ...
   mainFit1032->SetChisquare(1.915085);
   ...
   mainFit1032->SetParameter(0,-1.391062);
   mainFit1032->SetParError(0,0.4963736);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8844327);
   mainFit1032->SetParError(1,0.01474542);
   ...
   pt_LaTex = pt->AddText("#minus1.39#pm0.496");
   pt_LaTex = pt->AddText("#minus1.57#pm0.555");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.57283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.57283,-56.38593,1.57283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.915085);
   ...
   mainFit1033->SetParameter(0,-1.391062);
   mainFit1033->SetParError(0,0.4963736);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8844327);
   mainFit1033->SetParError(1,0.01474542);
