...
//=========  (Mon Apr 26 23:56:55 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.681537);
   ...
   quadLineFit1002->SetParameter(0,74.67733);
   quadLineFit1002->SetParError(0,0.0657358);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.42241);
   quadLineFit1002->SetParError(1,1.102069);
   ...
   quadLineFit1003->SetChisquare(5.681537);
   ...
   quadLineFit1003->SetParameter(0,74.67733);
   quadLineFit1003->SetParError(0,0.0657358);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.42241);
   quadLineFit1003->SetParError(1,1.102069);
   ...
   Graph_30_ppm1003->SetMinimum(75.8299);
   Graph_30_ppm1003->SetMaximum(76.44953);
   ...
   quadLineFit1004->SetChisquare(2.938684);
   ...
   quadLineFit1004->SetParameter(0,74.60606);
   quadLineFit1004->SetParError(0,0.0553068);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.9095);
   quadLineFit1004->SetParError(1,0.9084699);
   ...
   quadLineFit1005->SetChisquare(2.938684);
   ...
   quadLineFit1005->SetParameter(0,74.60606);
   quadLineFit1005->SetParError(0,0.0553068);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.9095);
   quadLineFit1005->SetParError(1,0.9084699);
   ...
   Graph_10_ppm1005->SetMinimum(74.88797);
   Graph_10_ppm1005->SetMaximum(75.13638);
   ...
   quadLineFit1006->SetChisquare(0.1550531);
   ...
   quadLineFit1006->SetParameter(0,74.47442);
   quadLineFit1006->SetParError(0,0.06486587);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.700433);
   quadLineFit1006->SetParError(1,1.051441);
   ...
   quadLineFit1007->SetChisquare(0.1550531);
   ...
   quadLineFit1007->SetParameter(0,74.47442);
   quadLineFit1007->SetParError(0,0.06486587);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.700433);
   quadLineFit1007->SetParError(1,1.051441);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.75428);
   Graph_mI10_ppm1007->SetMaximum(74.04433);
   ...
   quadLineFit1008->SetChisquare(4.700725);
   ...
   quadLineFit1008->SetParameter(0,74.47695);
   quadLineFit1008->SetParError(0,0.05690526);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.656395);
   quadLineFit1008->SetParError(1,0.9256625);
   ...
   quadLineFit1009->SetChisquare(4.700725);
   ...
   quadLineFit1009->SetParameter(0,74.47695);
   quadLineFit1009->SetParError(0,0.05690526);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.656395);
   quadLineFit1009->SetParError(1,0.9256625);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.41559);
   Graph_mI30_ppm1009->SetMaximum(73.13656);
   ...
   quadLineFit1010->SetChisquare(0.5356704);
   ...
   quadLineFit1010->SetParameter(0,74.52763);
   quadLineFit1010->SetParError(0,0.05376109);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.42341);
   quadLineFit1010->SetParError(1,0.9297924);
   ...
   quadLineFit1011->SetChisquare(0.5356704);
   ...
   quadLineFit1011->SetParameter(0,74.52763);
   quadLineFit1011->SetParError(0,0.05376109);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.42341);
   quadLineFit1011->SetParError(1,0.9297924);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.5432);
   Graph_mI50_ppm1011->SetMaximum(72.18944);
   ...
   quadLineFit1012->SetChisquare(1.754368);
   ...
   quadLineFit1012->SetParameter(0,74.45716);
   quadLineFit1012->SetParError(0,0.1087001);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.3587);
   quadLineFit1012->SetParError(1,1.944468);
   ...
   quadLineFit1013->SetChisquare(1.754368);
   ...
   quadLineFit1013->SetParameter(0,74.45716);
   quadLineFit1013->SetParError(0,0.1087001);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.3587);
   quadLineFit1013->SetParError(1,1.944468);
