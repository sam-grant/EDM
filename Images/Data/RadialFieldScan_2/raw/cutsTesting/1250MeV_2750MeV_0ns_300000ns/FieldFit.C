...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.38593);
   Graph_Graph01020->SetMaximum(52.60725);
   ...
   mainFit1021->SetChisquare(2.203208);
   ...
   mainFit1021->SetParameter(0,-1.258867);
   mainFit1021->SetParError(0,0.4309682);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8823921);
   mainFit1021->SetParError(1,0.01424692);
   ...
   mainFit1022->SetChisquare(2.203208);
   ...
   mainFit1022->SetParameter(0,-1.258867);
   mainFit1022->SetParError(0,0.4309682);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8823921);
   mainFit1022->SetParError(1,0.01424692);
