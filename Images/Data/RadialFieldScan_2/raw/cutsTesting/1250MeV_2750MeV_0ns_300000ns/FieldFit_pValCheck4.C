...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.38593);
   Graph_Graph01033->SetMaximum(52.60725);
   ...
   mainFit1034->SetChisquare(1.104159);
   ...
   mainFit1034->SetParameter(0,-0.9170896);
   mainFit1034->SetParError(0,0.5403869);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8711611);
   mainFit1034->SetParError(1,0.0178253);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.368");
   pt_LaTex = pt->AddText("0.871#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.917#pm 0.54");
   pt_LaTex = pt->AddText("#minus1.05#pm0.611");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.052721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.052721,-56.38593,1.052721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.104159);
   ...
   mainFit1035->SetParameter(0,-0.9170896);
   mainFit1035->SetParError(0,0.5403869);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8711611);
   mainFit1035->SetParError(1,0.0178253);
