...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.38593);
   Graph_Graph01029->SetMaximum(52.60725);
   ...
   mainFit1030->SetChisquare(0.800961);
   ...
   mainFit1030->SetParameter(0,-1.476027);
   mainFit1030->SetParError(0,0.4683637);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8811077);
   mainFit1030->SetParError(1,0.01428812);
   ...
   pt_LaTex = pt->AddText("#minus1.48#pm0.468");
   pt_LaTex = pt->AddText("#minus1.68#pm0.529");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.675194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.675194,-56.38593,1.675194,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.800961);
   ...
   mainFit1031->SetParameter(0,-1.476027);
   mainFit1031->SetParError(0,0.4683637);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8811077);
   mainFit1031->SetParError(1,0.01428812);
