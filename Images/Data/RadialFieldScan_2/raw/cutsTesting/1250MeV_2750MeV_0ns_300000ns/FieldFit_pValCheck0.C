...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.58345,50,44.09826);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.61528);
   Graph_Graph01025->SetMaximum(33.13008);
   ...
   mainFit1026->SetChisquare(1.893525);
   ...
   mainFit1026->SetParameter(0,-1.162621);
   mainFit1026->SetParError(0,0.4643765);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8888628);
   mainFit1026->SetParError(1,0.01838957);
   ...
   pt_LaTex = pt->AddText("0.889#pm0.0184");
   pt_LaTex = pt->AddText("#minus1.16#pm0.464");
   pt_LaTex = pt->AddText("#minus1.31#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.307987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.307987,-54.61528,1.307987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.893525);
   ...
   mainFit1027->SetParameter(0,-1.162621);
   mainFit1027->SetParError(0,0.4643765);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8888628);
   mainFit1027->SetParError(1,0.01838957);
