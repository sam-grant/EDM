...
//=========  (Mon Apr 26 23:56:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01847077);
   Graph_Graph11015->SetMaximum(0.01863556);
   ...
   Graph_Graph21016->SetMinimum(-0.003709484);
   Graph_Graph21016->SetMaximum(0.004351727);
   ...
   Graph_Graph31017->SetMinimum(-0.02655966);
   Graph_Graph31017->SetMaximum(0.02710991);
   ...
   Graph_Graph41018->SetMinimum(-0.006026499);
   Graph_Graph41018->SetMaximum(0.00705271);
   ...
   Graph_Graph51019->SetMinimum(-0.01171222);
   Graph_Graph51019->SetMaximum(0.01560847);
