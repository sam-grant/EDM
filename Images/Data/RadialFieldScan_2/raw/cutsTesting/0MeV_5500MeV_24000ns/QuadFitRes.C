...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004313553);
   Graph_Graph11015->SetMaximum(0.009364894);
   ...
   Graph_Graph21016->SetMinimum(-0.008594901);
   Graph_Graph21016->SetMaximum(0.01009955);
   ...
   Graph_Graph31017->SetMinimum(-0.02367799);
   Graph_Graph31017->SetMaximum(0.01872554);
   ...
   Graph_Graph41018->SetMinimum(-0.00423553);
   Graph_Graph41018->SetMaximum(0.005937663);
   ...
   Graph_Graph51019->SetMinimum(-0.002500222);
   Graph_Graph51019->SetMaximum(0.003340556);
