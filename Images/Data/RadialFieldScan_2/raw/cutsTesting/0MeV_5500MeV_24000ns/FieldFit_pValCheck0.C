...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.79626,50,44.30549);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.48609);
   Graph_Graph01025->SetMaximum(32.99531);
   ...
   mainFit1026->SetChisquare(1.67547);
   ...
   mainFit1026->SetParameter(0,-2.026875);
   mainFit1026->SetParError(0,0.407097);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9044063);
   mainFit1026->SetParError(1,0.01611966);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.558");
   pt_LaTex = pt->AddText("0.904#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.03#pm0.407");
   pt_LaTex = pt->AddText("#minus2.24#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.241111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.241111,-57.48609,2.241111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.67547);
   ...
   mainFit1027->SetParameter(0,-2.026875);
   mainFit1027->SetParError(0,0.407097);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9044063);
   mainFit1027->SetParError(1,0.01611966);
