...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.55148);
   Graph_Graph01031->SetMaximum(55.71463);
   ...
   mainFit1032->SetChisquare(3.617054);
   ...
   mainFit1032->SetParameter(0,-1.726146);
   mainFit1032->SetParError(0,0.4350242);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9178729);
   mainFit1032->SetParError(1,0.0129193);
   ...
   pt_LaTex = pt->AddText("#minus1.73#pm0.435");
   pt_LaTex = pt->AddText("#minus1.88#pm0.468");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.880593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.880593,-59.55148,1.880593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.617054);
   ...
   mainFit1033->SetParameter(0,-1.726146);
   mainFit1033->SetParError(0,0.4350242);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9178729);
   mainFit1033->SetParError(1,0.0129193);
