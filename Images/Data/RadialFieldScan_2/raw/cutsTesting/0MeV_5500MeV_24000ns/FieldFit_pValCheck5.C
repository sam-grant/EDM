...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.73792,70,65.07853);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.35628);
   Graph_Graph01035->SetMaximum(53.69688);
   ...
   mainFit1036->SetChisquare(3.659231);
   ...
   mainFit1036->SetParameter(0,-1.769794);
   mainFit1036->SetParError(0,0.3961763);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9173376);
   mainFit1036->SetParError(1,0.01370355);
   ...
   pt_LaTex = pt->AddText("#minus1.77#pm0.396");
   pt_LaTex = pt->AddText("#minus1.93#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.929272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.929272,-37.35628,1.929272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.659231);
   ...
   mainFit1037->SetParameter(0,-1.769794);
   mainFit1037->SetParError(0,0.3961763);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9173376);
   mainFit1037->SetParError(1,0.01370355);
