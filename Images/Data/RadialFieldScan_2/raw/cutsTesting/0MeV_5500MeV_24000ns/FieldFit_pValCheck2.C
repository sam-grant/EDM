...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.55148);
   Graph_Graph01029->SetMaximum(55.71463);
   ...
   mainFit1030->SetChisquare(3.395972);
   ...
   mainFit1030->SetParameter(0,-1.904713);
   mainFit1030->SetParError(0,0.4105426);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9185582);
   mainFit1030->SetParError(1,0.01251894);
   ...
   pt_LaTex = pt->AddText(" #minus1.9#pm0.411");
   pt_LaTex = pt->AddText("#minus2.07#pm0.444");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.07359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.07359,-59.55148,2.07359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.395972);
   ...
   mainFit1031->SetParameter(0,-1.904713);
   mainFit1031->SetParError(0,0.4105426);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9185582);
   mainFit1031->SetParError(1,0.01251894);
