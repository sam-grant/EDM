...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.55148);
   Graph_Graph01023->SetMaximum(55.71463);
   ...
   mainFit1024->SetChisquare(3.759883);
   ...
   mainFit1024->SetParameter(0,-1.807672);
   mainFit1024->SetParError(0,0.3777318);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9191237);
   mainFit1024->SetParError(1,0.01248288);
   ...
   mainFit1025->SetChisquare(3.759883);
   ...
   mainFit1025->SetParameter(0,-1.807672);
   mainFit1025->SetParError(0,0.3777318);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9191237);
   mainFit1025->SetParError(1,0.01248288);
