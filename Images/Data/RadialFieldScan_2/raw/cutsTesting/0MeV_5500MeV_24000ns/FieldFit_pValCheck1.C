...
//=========  (Fri Apr 23 12:10:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.55148);
   Graph_Graph01027->SetMaximum(55.71463);
   ...
   mainFit1028->SetChisquare(0.6732874);
   ...
   mainFit1028->SetParameter(0,-1.47376);
   mainFit1028->SetParError(0,0.4228598);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9300352);
   mainFit1028->SetParError(1,0.01394084);
   ...
   pt_LaTex = pt->AddText("#minus1.47#pm0.423");
   pt_LaTex = pt->AddText("#minus1.58#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.584629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.584629,-59.55148,1.584629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6732874);
   ...
   mainFit1029->SetParameter(0,-1.47376);
   mainFit1029->SetParError(0,0.4228598);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9300352);
   mainFit1029->SetParError(1,0.01394084);
