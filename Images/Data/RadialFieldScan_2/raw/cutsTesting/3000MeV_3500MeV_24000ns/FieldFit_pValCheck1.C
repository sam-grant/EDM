...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.36126);
   Graph_Graph01027->SetMaximum(55.00688);
   ...
   mainFit1028->SetChisquare(6.213778);
   ...
   mainFit1028->SetParameter(0,-0.5895062);
   mainFit1028->SetParError(0,2.095037);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.823732);
   mainFit1028->SetParError(1,0.06896661);
   ...
   pt_LaTex = pt->AddText("0.824#pm0.069");
   pt_LaTex = pt->AddText("#minus0.59#pm  2.1");
   pt_LaTex = pt->AddText("#minus0.716#pm 2.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7156529,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7156529,-54.36126,0.7156529,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(6.213778);
   ...
   mainFit1029->SetParameter(0,-0.5895062);
   mainFit1029->SetParError(0,2.095037);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.823732);
   mainFit1029->SetParError(1,0.06896661);
