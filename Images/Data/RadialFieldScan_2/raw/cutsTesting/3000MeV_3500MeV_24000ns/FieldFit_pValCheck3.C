...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.36126);
   Graph_Graph01031->SetMaximum(55.00688);
   ...
   mainFit1032->SetChisquare(1.717247);
   ...
   mainFit1032->SetParameter(0,-3.175806);
   mainFit1032->SetParError(0,2.155282);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.849545);
   mainFit1032->SetParError(1,0.06397006);
   ...
   pt_LaTex = pt->AddText(" 0.85#pm0.064");
   pt_LaTex = pt->AddText("#minus3.18#pm 2.16");
   pt_LaTex = pt->AddText("#minus3.74#pm 2.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.738243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.738243,-54.36126,3.738243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.717247);
   ...
   mainFit1033->SetParameter(0,-3.175806);
   mainFit1033->SetParError(0,2.155282);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.849545);
   mainFit1033->SetParError(1,0.06397006);
