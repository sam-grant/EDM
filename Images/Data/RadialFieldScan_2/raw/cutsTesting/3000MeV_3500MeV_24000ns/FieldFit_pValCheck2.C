...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-68.03228,75,68.6779);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-54.36126);
   Graph_Graph01029->SetMaximum(55.00688);
   ...
   mainFit1030->SetChisquare(5.154472);
   ...
   mainFit1030->SetParameter(0,-0.02834506);
   mainFit1030->SetParError(0,2.034555);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8190209);
   mainFit1030->SetParError(1,0.06196429);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.72");
   pt_LaTex = pt->AddText("0.819#pm0.062");
   pt_LaTex = pt->AddText("#minus0.0283#pm 2.03");
   pt_LaTex = pt->AddText("#minus0.0346#pm 2.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.03460847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.03460847,-54.36126,0.03460847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.154472);
   ...
   mainFit1031->SetParameter(0,-0.02834506);
   mainFit1031->SetParError(0,2.034555);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8190209);
   mainFit1031->SetParError(1,0.06196429);
