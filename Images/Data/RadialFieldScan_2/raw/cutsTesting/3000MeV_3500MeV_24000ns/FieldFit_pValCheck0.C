...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.18219,50,44.42746);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.42122);
   Graph_Graph01025->SetMaximum(33.66649);
   ...
   mainFit1026->SetChisquare(6.164711);
   ...
   mainFit1026->SetParameter(0,-1.175371);
   mainFit1026->SetParError(0,2.016861);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7945807);
   mainFit1026->SetParError(1,0.07983417);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.05");
   pt_LaTex = pt->AddText("0.795#pm0.0798");
   pt_LaTex = pt->AddText("#minus1.18#pm 2.02");
   pt_LaTex = pt->AddText("#minus1.48#pm 2.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.479234,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.479234,-52.42122,1.479234,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(6.164711);
   ...
   mainFit1027->SetParameter(0,-1.175371);
   mainFit1027->SetParError(0,2.016861);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7945807);
   mainFit1027->SetParError(1,0.07983417);
