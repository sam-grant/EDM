...
//=========  (Wed Apr 21 23:43:12 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.077845);
   ...
   quadLineFit1002->SetParameter(0,75.50807);
   quadLineFit1002->SetParError(0,0.2841292);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.12787);
   quadLineFit1002->SetParError(1,4.765003);
   ...
   quadLineFit1003->SetChisquare(3.077845);
   ...
   quadLineFit1003->SetParameter(0,75.50807);
   quadLineFit1003->SetParError(0,0.2841292);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.12787);
   quadLineFit1003->SetParError(1,4.765003);
   ...
   Graph_30_ppm1003->SetMinimum(76.57071);
   Graph_30_ppm1003->SetMaximum(77.28632);
   ...
   quadLineFit1004->SetChisquare(0.2819752);
   ...
   quadLineFit1004->SetParameter(0,75.56383);
   quadLineFit1004->SetParError(0,0.2396114);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.55293);
   quadLineFit1004->SetParError(1,3.939582);
   ...
   quadLineFit1005->SetChisquare(0.2819752);
   ...
   quadLineFit1005->SetParameter(0,75.56383);
   quadLineFit1005->SetParError(0,0.2396114);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.55293);
   quadLineFit1005->SetParError(1,3.939582);
   ...
   Graph_10_ppm1005->SetMinimum(75.69644);
   Graph_10_ppm1005->SetMaximum(75.91932);
   ...
   quadLineFit1006->SetChisquare(0.01305965);
   ...
   quadLineFit1006->SetParameter(0,75.6368);
   quadLineFit1006->SetParError(0,0.2811878);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,2.777734);
   quadLineFit1006->SetParError(1,4.560962);
   ...
   quadLineFit1007->SetChisquare(0.01305965);
   ...
   quadLineFit1007->SetParameter(0,75.6368);
   quadLineFit1007->SetParError(0,0.2811878);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,2.777734);
   quadLineFit1007->SetParError(1,4.560962);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.57397);
   Graph_mI10_ppm1007->SetMaximum(75.00456);
   ...
   quadLineFit1008->SetChisquare(8.212634);
   ...
   quadLineFit1008->SetParameter(0,74.89207);
   quadLineFit1008->SetParError(0,0.2474711);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-1.610028);
   quadLineFit1008->SetParError(1,4.029452);
   ...
   quadLineFit1009->SetChisquare(8.212634);
   ...
   quadLineFit1009->SetParameter(0,74.89207);
   quadLineFit1009->SetParError(0,0.2474711);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-1.610028);
   quadLineFit1009->SetParError(1,4.029452);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.17094);
   Graph_mI30_ppm1009->SetMaximum(74.03254);
   ...
   quadLineFit1010->SetChisquare(0.1449508);
   ...
   quadLineFit1010->SetParameter(0,75.47089);
   quadLineFit1010->SetParError(0,0.233709);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.26702);
   quadLineFit1010->SetParError(1,4.044818);
   ...
   quadLineFit1011->SetChisquare(0.1449508);
   ...
   quadLineFit1011->SetParameter(0,75.47089);
   quadLineFit1011->SetParError(0,0.233709);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.26702);
   quadLineFit1011->SetParError(1,4.044818);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.35118);
   Graph_mI50_ppm1011->SetMaximum(73.00637);
   ...
   quadLineFit1012->SetChisquare(0.008190159);
   ...
   quadLineFit1012->SetParameter(0,74.78183);
   quadLineFit1012->SetParError(0,0.4715767);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-36.81038);
   quadLineFit1012->SetParError(1,8.436869);
   ...
   quadLineFit1013->SetChisquare(0.008190159);
   ...
   quadLineFit1013->SetParameter(0,74.78183);
   quadLineFit1013->SetParError(0,0.4715767);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-36.81038);
   quadLineFit1013->SetParError(1,8.436869);
