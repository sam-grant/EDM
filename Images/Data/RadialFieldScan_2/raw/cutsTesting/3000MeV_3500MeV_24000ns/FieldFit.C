...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.36126);
   Graph_Graph01020->SetMaximum(55.00688);
   ...
   mainFit1021->SetChisquare(6.313208);
   ...
   mainFit1021->SetParameter(0,-0.8859974);
   mainFit1021->SetParError(0,1.872031);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8140542);
   mainFit1021->SetParError(1,0.06179338);
   ...
   mainFit1022->SetChisquare(6.313208);
   ...
   mainFit1022->SetParameter(0,-0.8859974);
   mainFit1022->SetParError(0,1.872031);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8140542);
   mainFit1022->SetParError(1,0.06179338);
