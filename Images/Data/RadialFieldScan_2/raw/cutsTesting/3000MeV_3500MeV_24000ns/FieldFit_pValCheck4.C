...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.36126);
   Graph_Graph01033->SetMaximum(55.00688);
   ...
   mainFit1034->SetChisquare(3.342182);
   ...
   mainFit1034->SetParameter(0,1.556185);
   mainFit1034->SetParError(0,2.347793);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7340221);
   mainFit1034->SetParError(1,0.07730071);
   ...
   pt_LaTex = pt->AddText("0.734#pm0.0773");
   pt_LaTex = pt->AddText(" 1.56#pm 2.35");
   pt_LaTex = pt->AddText(" 2.12#pm 3.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.120079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.120079,-54.36126,-2.120079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.342182);
   ...
   mainFit1035->SetParameter(0,1.556185);
   mainFit1035->SetParError(0,2.347793);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7340221);
   mainFit1035->SetParError(1,0.07730071);
