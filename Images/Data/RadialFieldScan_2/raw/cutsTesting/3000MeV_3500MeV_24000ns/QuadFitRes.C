...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02858391);
   Graph_Graph11015->SetMaximum(0.02447718);
   ...
   Graph_Graph21016->SetMinimum(-0.005507683);
   Graph_Graph21016->SetMaximum(0.00469213);
   ...
   Graph_Graph31017->SetMinimum(-0.1547363);
   Graph_Graph31017->SetMaximum(0.1133344);
   ...
   Graph_Graph41018->SetMinimum(-0.02456075);
   Graph_Graph41018->SetMaximum(0.01572295);
   ...
   Graph_Graph51019->SetMinimum(-0.003469334);
   Graph_Graph51019->SetMaximum(0.004616826);
