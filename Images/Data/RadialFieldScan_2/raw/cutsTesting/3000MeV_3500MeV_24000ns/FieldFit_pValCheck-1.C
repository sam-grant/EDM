...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.36126);
   Graph_Graph01023->SetMaximum(55.00688);
   ...
   mainFit1024->SetChisquare(6.313208);
   ...
   mainFit1024->SetParameter(0,-0.8859974);
   mainFit1024->SetParError(0,1.872031);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8140542);
   mainFit1024->SetParError(1,0.06179338);
   ...
   pt_LaTex = pt->AddText("0.814#pm0.0618");
   pt_LaTex = pt->AddText("#minus0.886#pm 1.87");
   pt_LaTex = pt->AddText("#minus1.09#pm 2.29");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.088376,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.088376,-54.36126,1.088376,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.313208);
   ...
   mainFit1025->SetParameter(0,-0.8859974);
   mainFit1025->SetParError(0,1.872031);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8140542);
   mainFit1025->SetParError(1,0.06179338);
