...
//=========  (Wed Apr 21 23:43:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.36301,70,65.94405);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-42.33231);
   Graph_Graph01035->SetMaximum(53.91334);
   ...
   mainFit1036->SetChisquare(5.906923);
   ...
   mainFit1036->SetParameter(0,-1.264994);
   mainFit1036->SetParError(0,1.964145);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8319243);
   mainFit1036->SetParError(1,0.06784252);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.0678");
   pt_LaTex = pt->AddText("#minus1.26#pm 1.96");
   pt_LaTex = pt->AddText("#minus1.52#pm 2.33");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.520564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.520564,-42.33231,1.520564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.906923);
   ...
   mainFit1037->SetParameter(0,-1.264994);
   mainFit1037->SetParError(0,1.964145);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8319243);
   mainFit1037->SetParError(1,0.06784252);
