...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.10838);
   Graph_Graph01029->SetMaximum(54.75653);
   ...
   mainFit1030->SetChisquare(4.979718);
   ...
   mainFit1030->SetParameter(0,-1.124551);
   mainFit1030->SetParError(0,0.5339418);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8711283);
   mainFit1030->SetParError(1,0.01625937);
   ...
   pt_LaTex = pt->AddText("0.871#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.12#pm0.534");
   pt_LaTex = pt->AddText("#minus1.29#pm 0.61");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.290913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.290913,-56.10838,1.290913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.979718);
   ...
   mainFit1031->SetParameter(0,-1.124551);
   mainFit1031->SetParError(0,0.5339418);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8711283);
   mainFit1031->SetParError(1,0.01625937);
