...
//=========  (Mon Apr 26 23:05:34 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3088795);
   ...
   quadLineFit1002->SetParameter(0,74.52906);
   quadLineFit1002->SetParError(0,0.07441932);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.26956);
   quadLineFit1002->SetParError(1,1.248226);
   ...
   quadLineFit1003->SetChisquare(0.3088795);
   ...
   quadLineFit1003->SetParameter(0,74.52906);
   quadLineFit1003->SetParError(0,0.07441932);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.26956);
   quadLineFit1003->SetParError(1,1.248226);
   ...
   Graph_30_ppm1003->SetMinimum(75.79084);
   Graph_30_ppm1003->SetMaximum(76.37501);
   ...
   quadLineFit1004->SetChisquare(3.035025);
   ...
   quadLineFit1004->SetParameter(0,74.64667);
   quadLineFit1004->SetParError(0,0.06304225);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.32595);
   quadLineFit1004->SetParError(1,1.036144);
   ...
   quadLineFit1005->SetChisquare(3.035025);
   ...
   quadLineFit1005->SetParameter(0,74.64667);
   quadLineFit1005->SetParError(0,0.06304225);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.32595);
   quadLineFit1005->SetParError(1,1.036144);
   ...
   Graph_10_ppm1005->SetMinimum(74.81614);
   Graph_10_ppm1005->SetMaximum(75.0755);
   ...
   quadLineFit1006->SetChisquare(1.043713);
   ...
   quadLineFit1006->SetParameter(0,74.39585);
   quadLineFit1006->SetParError(0,0.07385161);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.801449);
   quadLineFit1006->SetParError(1,1.197744);
   ...
   quadLineFit1007->SetChisquare(1.043713);
   ...
   quadLineFit1007->SetParameter(0,74.39585);
   quadLineFit1007->SetParError(0,0.07385161);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.801449);
   quadLineFit1007->SetParError(1,1.197744);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.63355);
   Graph_mI10_ppm1007->SetMaximum(73.9414);
   ...
   quadLineFit1008->SetChisquare(8.122166);
   ...
   quadLineFit1008->SetParameter(0,74.38386);
   quadLineFit1008->SetParError(0,0.06487052);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.845039);
   quadLineFit1008->SetParError(1,1.055892);
   ...
   quadLineFit1009->SetChisquare(8.122166);
   ...
   quadLineFit1009->SetParameter(0,74.38386);
   quadLineFit1009->SetParError(0,0.06487052);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.845039);
   quadLineFit1009->SetParError(1,1.055892);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.28881);
   Graph_mI30_ppm1009->SetMaximum(72.97636);
   ...
   quadLineFit1010->SetChisquare(3.245048);
   ...
   quadLineFit1010->SetParameter(0,74.29372);
   quadLineFit1010->SetParError(0,0.06135801);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.81727);
   quadLineFit1010->SetParError(1,1.061893);
   ...
   quadLineFit1011->SetChisquare(3.245048);
   ...
   quadLineFit1011->SetParameter(0,74.29372);
   quadLineFit1011->SetParError(0,0.06135801);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.81727);
   quadLineFit1011->SetParError(1,1.061893);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.37507);
   Graph_mI50_ppm1011->SetMaximum(72.01733);
   ...
   quadLineFit1012->SetChisquare(0.791113);
   ...
   quadLineFit1012->SetParameter(0,74.24509);
   quadLineFit1012->SetParError(0,0.1238383);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.6538);
   quadLineFit1012->SetParError(1,2.21584);
   ...
   quadLineFit1013->SetChisquare(0.791113);
   ...
   quadLineFit1013->SetParameter(0,74.24509);
   quadLineFit1013->SetParError(0,0.1238383);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.6538);
   quadLineFit1013->SetParError(1,2.21584);
