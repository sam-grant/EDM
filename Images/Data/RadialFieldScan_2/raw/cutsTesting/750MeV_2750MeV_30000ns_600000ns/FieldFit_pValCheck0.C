...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.67757,50,42.17003);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.99281);
   Graph_Graph01025->SetMaximum(31.48527);
   ...
   mainFit1026->SetChisquare(2.643054);
   ...
   mainFit1026->SetParameter(0,-1.284528);
   mainFit1026->SetParError(0,0.5296322);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8484663);
   mainFit1026->SetParError(1,0.02097722);
   ...
   pt_LaTex = pt->AddText("0.848#pm0.021");
   pt_LaTex = pt->AddText("#minus1.28#pm 0.53");
   pt_LaTex = pt->AddText("#minus1.51#pm 0.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.513941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.513941,-53.99281,1.513941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.643054);
   ...
   mainFit1027->SetParameter(0,-1.284528);
   mainFit1027->SetParError(0,0.5296322);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8484663);
   mainFit1027->SetParError(1,0.02097722);
