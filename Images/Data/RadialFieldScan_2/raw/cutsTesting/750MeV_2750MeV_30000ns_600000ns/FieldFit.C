...
//=========  (Mon Apr 26 23:05:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.10838);
   Graph_Graph01020->SetMaximum(54.75653);
   ...
   mainFit1021->SetChisquare(5.835128);
   ...
   mainFit1021->SetParameter(0,-0.9312531);
   mainFit1021->SetParError(0,0.4913375);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8722448);
   mainFit1021->SetParError(1,0.01621459);
   ...
   mainFit1022->SetChisquare(5.835128);
   ...
   mainFit1022->SetParameter(0,-0.9312531);
   mainFit1022->SetParError(0,0.4913375);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8722448);
   mainFit1022->SetParError(1,0.01621459);
