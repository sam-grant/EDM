...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.10838);
   Graph_Graph01033->SetMaximum(54.75653);
   ...
   mainFit1034->SetChisquare(5.696485);
   ...
   mainFit1034->SetParameter(0,-1.069622);
   mainFit1034->SetParError(0,0.6160426);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8767784);
   mainFit1034->SetParError(1,0.02027711);
   ...
   pt_LaTex = pt->AddText("0.877#pm0.0203");
   pt_LaTex = pt->AddText("#minus1.07#pm0.616");
   pt_LaTex = pt->AddText("#minus1.22#pm 0.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.219946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.219946,-56.10838,1.219946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.696485);
   ...
   mainFit1035->SetParameter(0,-1.069622);
   mainFit1035->SetParError(0,0.6160426);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8767784);
   mainFit1035->SetParError(1,0.02027711);
