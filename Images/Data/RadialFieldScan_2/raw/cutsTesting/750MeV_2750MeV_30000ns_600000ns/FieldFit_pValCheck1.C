...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.9665,75,68.61464);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.10838);
   Graph_Graph01027->SetMaximum(54.75653);
   ...
   mainFit1028->SetChisquare(0.4240016);
   ...
   mainFit1028->SetParameter(0,-0.3588713);
   mainFit1028->SetParError(0,0.5495074);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8908717);
   mainFit1028->SetParError(1,0.01808408);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.141");
   pt_LaTex = pt->AddText("0.891#pm0.0181");
   pt_LaTex = pt->AddText("#minus0.359#pm 0.55");
   pt_LaTex = pt->AddText("#minus0.403#pm0.617");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4028317,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4028317,-56.10838,0.4028317,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4240016);
   ...
   mainFit1029->SetParameter(0,-0.3588713);
   mainFit1029->SetParError(0,0.5495074);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8908717);
   mainFit1029->SetParError(1,0.01808408);
