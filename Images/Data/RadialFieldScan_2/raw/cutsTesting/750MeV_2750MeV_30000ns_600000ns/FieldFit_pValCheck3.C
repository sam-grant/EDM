...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.10838);
   Graph_Graph01031->SetMaximum(54.75653);
   ...
   mainFit1032->SetChisquare(5.790534);
   ...
   mainFit1032->SetParameter(0,-0.8719304);
   mainFit1032->SetParError(0,0.5659755);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8713262);
   mainFit1032->SetParError(1,0.01678789);
   ...
   pt_LaTex = pt->AddText("0.871#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.872#pm0.566");
   pt_LaTex = pt->AddText("   #minus1#pm0.645");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.000693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.000693,-56.10838,1.000693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.790534);
   ...
   mainFit1033->SetParameter(0,-0.8719304);
   mainFit1033->SetParError(0,0.5659755);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8713262);
   mainFit1033->SetParError(1,0.01678789);
