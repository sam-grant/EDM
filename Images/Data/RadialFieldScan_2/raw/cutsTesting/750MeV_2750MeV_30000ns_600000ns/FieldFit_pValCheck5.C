...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.2284,70,63.86702);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.21885);
   Graph_Graph01035->SetMaximum(52.85748);
   ...
   mainFit1036->SetChisquare(5.831992);
   ...
   mainFit1036->SetParameter(0,-0.922525);
   mainFit1036->SetParError(0,0.5154661);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8718338);
   mainFit1036->SetParError(1,0.01779844);
   ...
   pt_LaTex = pt->AddText("#minus0.923#pm0.515");
   pt_LaTex = pt->AddText("#minus1.06#pm0.586");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.058143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.058143,-35.21885,1.058143,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.831992);
   ...
   mainFit1037->SetParameter(0,-0.922525);
   mainFit1037->SetParError(0,0.5154661);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8718338);
   mainFit1037->SetParError(1,0.01779844);
