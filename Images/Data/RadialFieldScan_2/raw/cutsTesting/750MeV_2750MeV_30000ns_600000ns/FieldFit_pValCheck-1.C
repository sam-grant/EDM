...
//=========  (Mon Apr 26 23:05:35 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.10838);
   Graph_Graph01023->SetMaximum(54.75653);
   ...
   mainFit1024->SetChisquare(5.835128);
   ...
   mainFit1024->SetParameter(0,-0.9312531);
   mainFit1024->SetParError(0,0.4913375);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8722448);
   mainFit1024->SetParError(1,0.01621459);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.931#pm0.491");
   pt_LaTex = pt->AddText("#minus1.07#pm 0.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.067651,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.067651,-56.10838,1.067651,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.835128);
   ...
   mainFit1025->SetParameter(0,-0.9312531);
   mainFit1025->SetParError(0,0.4913375);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8722448);
   mainFit1025->SetParError(1,0.01621459);
