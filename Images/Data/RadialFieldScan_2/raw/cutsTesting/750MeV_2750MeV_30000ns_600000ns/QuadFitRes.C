...
//=========  (Mon Apr 26 23:05:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02102622);
   Graph_Graph11015->SetMaximum(0.02445663);
   ...
   Graph_Graph21016->SetMinimum(-0.01097742);
   Graph_Graph21016->SetMaximum(0.01293105);
   ...
   Graph_Graph31017->SetMinimum(-0.03854145);
   Graph_Graph31017->SetMaximum(0.0317118);
   ...
   Graph_Graph41018->SetMinimum(-0.01598823);
   Graph_Graph41018->SetMaximum(0.02127332);
   ...
   Graph_Graph51019->SetMinimum(-0.008930751);
   Graph_Graph51019->SetMaximum(0.01193839);
