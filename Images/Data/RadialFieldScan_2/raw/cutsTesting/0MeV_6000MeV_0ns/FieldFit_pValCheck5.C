...
//=========  (Fri Apr 23 11:39:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.69778,70,60.35117);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.99289);
   Graph_Graph01035->SetMaximum(49.64627);
   ...
   mainFit1036->SetChisquare(32.25717);
   ...
   mainFit1036->SetParameter(0,-1.909081);
   mainFit1036->SetParError(0,0.3106088);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9071417);
   mainFit1036->SetParError(1,0.01072591);
   ...
   pt_LaTex = pt->AddText("#minus1.91#pm0.311");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.337");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.104501,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.104501,-35.99289,2.104501,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(32.25717);
   ...
   mainFit1037->SetParameter(0,-1.909081);
   mainFit1037->SetParError(0,0.3106088);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9071417);
   mainFit1037->SetParError(1,0.01072591);
