...
//=========  (Fri Apr 23 11:39:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.31055);
   Graph_Graph01023->SetMaximum(50.94788);
   ...
   mainFit1024->SetChisquare(52.51409);
   ...
   mainFit1024->SetParameter(0,-1.486566);
   mainFit1024->SetParError(0,0.296083);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8871674);
   mainFit1024->SetParError(1,0.009764706);
   ...
   mainFit1025->SetChisquare(52.51409);
   ...
   mainFit1025->SetParameter(0,-1.486566);
   mainFit1025->SetParError(0,0.296083);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8871674);
   mainFit1025->SetParError(1,0.009764706);
