...
//=========  (Fri Apr 23 11:39:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.31055);
   Graph_Graph01020->SetMaximum(50.94788);
   ...
   mainFit1021->SetChisquare(52.51409);
   ...
   mainFit1021->SetParameter(0,-1.486566);
   mainFit1021->SetParError(0,0.296083);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8871674);
   mainFit1021->SetParError(1,0.009764706);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 13.1");
   pt_LaTex = pt->AddText("0.887#pm0.00976");
   pt_LaTex = pt->AddText("#minus1.49#pm0.296");
   pt_LaTex = pt->AddText("#minus1.68#pm0.331");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.675632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.675632,-50.31055,1.675632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(52.51409);
   ...
   mainFit1022->SetParameter(0,-1.486566);
   mainFit1022->SetParError(0,0.296083);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8871674);
   mainFit1022->SetParError(1,0.009764706);
