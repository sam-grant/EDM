...
//=========  (Fri Apr 23 11:39:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03287453);
   Graph_Graph11015->SetMaximum(0.01679756);
   ...
   Graph_Graph21016->SetMinimum(-0.01511843);
   Graph_Graph21016->SetMaximum(0.01758377);
   ...
   Graph_Graph31017->SetMinimum(-0.009803509);
   Graph_Graph31017->SetMaximum(0.02004704);
   ...
   Graph_Graph41018->SetMinimum(-0.0235666);
   Graph_Graph41018->SetMaximum(0.04048903);
   ...
   Graph_Graph51019->SetMinimum(-0.01926952);
   Graph_Graph51019->SetMaximum(0.01445373);
