...
//=========  (Fri Apr 23 11:39:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.31055);
   Graph_Graph01033->SetMaximum(50.94788);
   ...
   mainFit1034->SetChisquare(52.44539);
   ...
   mainFit1034->SetParameter(0,-1.427743);
   mainFit1034->SetParError(0,0.3715332);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8852424);
   mainFit1034->SetParError(1,0.01221857);
   ...
   pt_LaTex = pt->AddText("#minus1.43#pm0.372");
   pt_LaTex = pt->AddText("#minus1.61#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.612827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.612827,-50.31055,1.612827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(52.44539);
   ...
   mainFit1035->SetParameter(0,-1.427743);
   mainFit1035->SetParError(0,0.3715332);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8852424);
   mainFit1035->SetParError(1,0.01221857);
