...
//=========  (Fri Apr 23 11:39:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.24941,50,45.01294);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.82317);
   Graph_Graph01025->SetMaximum(34.5867);
   ...
   mainFit1026->SetChisquare(48.22315);
   ...
   mainFit1026->SetParameter(0,-1.237853);
   mainFit1026->SetParError(0,0.3195015);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9037071);
   mainFit1026->SetParError(1,0.01261361);
   ...
   pt_LaTex = pt->AddText("#minus1.24#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.37#pm0.356");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.36975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.36975,-48.82317,1.36975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(48.22315);
   ...
   mainFit1027->SetParameter(0,-1.237853);
   mainFit1027->SetParError(0,0.3195015);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9037071);
   mainFit1027->SetParError(1,0.01261361);
