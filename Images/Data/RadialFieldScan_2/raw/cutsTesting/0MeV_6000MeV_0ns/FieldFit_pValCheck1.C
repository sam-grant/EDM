...
//=========  (Fri Apr 23 11:39:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.31055);
   Graph_Graph01027->SetMaximum(50.94788);
   ...
   mainFit1028->SetChisquare(38.02695);
   ...
   mainFit1028->SetParameter(0,-2.055761);
   mainFit1028->SetParError(0,0.3317046);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8686675);
   mainFit1028->SetParError(1,0.0109073);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 12.7");
   pt_LaTex = pt->AddText("0.869#pm0.0109");
   pt_LaTex = pt->AddText("#minus2.06#pm0.332");
   pt_LaTex = pt->AddText("#minus2.37#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.366569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.366569,-50.31055,2.366569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(38.02695);
   ...
   mainFit1029->SetParameter(0,-2.055761);
   mainFit1029->SetParError(0,0.3317046);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8686675);
   mainFit1029->SetParError(1,0.0109073);
