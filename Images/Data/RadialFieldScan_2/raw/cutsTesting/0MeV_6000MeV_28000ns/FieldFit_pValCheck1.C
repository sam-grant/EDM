...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.47237,75,70.57933);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.8672);
   Graph_Graph01027->SetMaximum(55.97416);
   ...
   mainFit1028->SetChisquare(0.9392818);
   ...
   mainFit1028->SetParameter(0,-1.662761);
   mainFit1028->SetParError(0,0.4397404);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9367052);
   mainFit1028->SetParError(1,0.01450217);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.313");
   pt_LaTex = pt->AddText("0.937#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.66#pm 0.44");
   pt_LaTex = pt->AddText("#minus1.78#pm0.472");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.775117,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.775117,-60.8672,1.775117,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.9392818);
   ...
   mainFit1029->SetParameter(0,-1.662761);
   mainFit1029->SetParError(0,0.4397404);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9367052);
   mainFit1029->SetParError(1,0.01450217);
