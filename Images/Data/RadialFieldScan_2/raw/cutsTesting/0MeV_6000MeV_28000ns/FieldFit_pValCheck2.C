...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.8672);
   Graph_Graph01029->SetMaximum(55.97416);
   ...
   mainFit1030->SetChisquare(3.376038);
   ...
   mainFit1030->SetParameter(0,-2.080989);
   mainFit1030->SetParError(0,0.4268843);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9254797);
   mainFit1030->SetParError(1,0.01301993);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.013");
   pt_LaTex = pt->AddText("#minus2.08#pm0.427");
   pt_LaTex = pt->AddText("#minus2.25#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.248552,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.248552,-60.8672,2.248552,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.376038);
   ...
   mainFit1031->SetParameter(0,-2.080989);
   mainFit1031->SetParError(0,0.4268843);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9254797);
   mainFit1031->SetParError(1,0.01301993);
