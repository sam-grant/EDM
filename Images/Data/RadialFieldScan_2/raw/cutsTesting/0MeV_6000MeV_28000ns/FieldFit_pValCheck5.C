...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.12609,70,65.31007);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.68247);
   Graph_Graph01035->SetMaximum(53.86646);
   ...
   mainFit1036->SetChisquare(3.209735);
   ...
   mainFit1036->SetParameter(0,-1.905272);
   mainFit1036->SetParError(0,0.4119104);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9220161);
   mainFit1036->SetParError(1,0.0142523);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.91#pm0.412");
   pt_LaTex = pt->AddText("#minus2.07#pm0.439");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.066419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.066419,-37.68247,2.066419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.209735);
   ...
   mainFit1037->SetParameter(0,-1.905272);
   mainFit1037->SetParError(0,0.4119104);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9220161);
   mainFit1037->SetParError(1,0.0142523);
