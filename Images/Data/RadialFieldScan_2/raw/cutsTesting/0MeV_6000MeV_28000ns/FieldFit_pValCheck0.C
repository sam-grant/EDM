...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.29693,50,44.70215);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.79702);
   Graph_Graph01025->SetMaximum(33.20224);
   ...
   mainFit1026->SetChisquare(2.023785);
   ...
   mainFit1026->SetParameter(0,-2.192319);
   mainFit1026->SetParError(0,0.4232121);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9124119);
   mainFit1026->SetParError(1,0.01675731);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.675");
   pt_LaTex = pt->AddText("0.912#pm0.0168");
   pt_LaTex = pt->AddText("#minus2.19#pm0.423");
   pt_LaTex = pt->AddText(" #minus2.4#pm0.471");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.402774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.402774,-58.79702,2.402774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.023785);
   ...
   mainFit1027->SetParameter(0,-2.192319);
   mainFit1027->SetParError(0,0.4232121);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9124119);
   mainFit1027->SetParError(1,0.01675731);
