...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.8672);
   Graph_Graph01020->SetMaximum(55.97416);
   ...
   mainFit1021->SetChisquare(3.673078);
   ...
   mainFit1021->SetParameter(0,-1.989795);
   mainFit1021->SetParError(0,0.3927395);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9260135);
   mainFit1021->SetParError(1,0.01298223);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.918");
   pt_LaTex = pt->AddText("0.926#pm0.013");
   pt_LaTex = pt->AddText("#minus1.99#pm0.393");
   pt_LaTex = pt->AddText("#minus2.15#pm 0.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.148776,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.148776,-60.8672,2.148776,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.673078);
   ...
   mainFit1022->SetParameter(0,-1.989795);
   mainFit1022->SetParError(0,0.3927395);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9260135);
   mainFit1022->SetParError(1,0.01298223);
