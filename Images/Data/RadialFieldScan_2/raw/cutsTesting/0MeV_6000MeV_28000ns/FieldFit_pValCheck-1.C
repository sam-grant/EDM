...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.8672);
   Graph_Graph01023->SetMaximum(55.97416);
   ...
   mainFit1024->SetChisquare(3.673078);
   ...
   mainFit1024->SetParameter(0,-1.989795);
   mainFit1024->SetParError(0,0.3927395);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9260135);
   mainFit1024->SetParError(1,0.01298223);
   ...
   mainFit1025->SetChisquare(3.673078);
   ...
   mainFit1025->SetParameter(0,-1.989795);
   mainFit1025->SetParError(0,0.3927395);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9260135);
   mainFit1025->SetParError(1,0.01298223);
