...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.8672);
   Graph_Graph01033->SetMaximum(55.97416);
   ...
   mainFit1034->SetChisquare(2.795406);
   ...
   mainFit1034->SetParameter(0,-2.267907);
   mainFit1034->SetParError(0,0.4922994);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9351566);
   mainFit1034->SetParError(1,0.01623765);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.932");
   pt_LaTex = pt->AddText("0.935#pm0.0162");
   pt_LaTex = pt->AddText("#minus2.27#pm0.492");
   pt_LaTex = pt->AddText("#minus2.43#pm0.508");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.425163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.425163,-60.8672,2.425163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.795406);
   ...
   mainFit1035->SetParameter(0,-2.267907);
   mainFit1035->SetParError(0,0.4922994);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9351566);
   mainFit1035->SetParError(1,0.01623765);
