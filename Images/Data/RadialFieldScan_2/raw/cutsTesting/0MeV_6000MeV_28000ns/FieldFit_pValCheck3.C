...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.8672);
   Graph_Graph01031->SetMaximum(55.97416);
   ...
   mainFit1032->SetChisquare(3.587483);
   ...
   mainFit1032->SetParameter(0,-1.92419);
   mainFit1032->SetParError(0,0.4522795);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.925007);
   mainFit1032->SetParError(1,0.0134356);
   ...
   pt_LaTex = pt->AddText("#minus1.92#pm0.452");
   pt_LaTex = pt->AddText("#minus2.08#pm0.482");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.08019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.08019,-60.8672,2.08019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.587483);
   ...
   mainFit1033->SetParameter(0,-1.92419);
   mainFit1033->SetParError(0,0.4522795);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.925007);
   mainFit1033->SetParError(1,0.0134356);
