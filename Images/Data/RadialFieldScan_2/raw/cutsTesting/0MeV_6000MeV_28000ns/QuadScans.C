...
//=========  (Wed Apr 21 16:07:46 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.758831);
   ...
   quadLineFit1002->SetParameter(0,74.46459);
   quadLineFit1002->SetParError(0,0.05987969);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.23302);
   quadLineFit1002->SetParError(1,1.004362);
   ...
   quadLineFit1003->SetChisquare(1.758831);
   ...
   quadLineFit1003->SetParameter(0,74.46459);
   quadLineFit1003->SetParError(0,0.05987969);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.23302);
   quadLineFit1003->SetParError(1,1.004362);
   ...
   Graph_30_ppm1003->SetMinimum(75.74447);
   Graph_30_ppm1003->SetMaximum(76.36287);
   ...
   quadLineFit1004->SetChisquare(1.167669);
   ...
   quadLineFit1004->SetParameter(0,74.53344);
   quadLineFit1004->SetParError(0,0.05039863);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.70738);
   quadLineFit1004->SetParError(1,0.828253);
   ...
   quadLineFit1005->SetChisquare(1.167669);
   ...
   quadLineFit1005->SetParameter(0,74.53344);
   quadLineFit1005->SetParError(0,0.05039863);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.70738);
   quadLineFit1005->SetParError(1,0.828253);
   ...
   Graph_10_ppm1005->SetMinimum(74.75109);
   Graph_10_ppm1005->SetMaximum(74.97562);
   ...
   quadLineFit1006->SetChisquare(1.06824);
   ...
   quadLineFit1006->SetParameter(0,74.38007);
   quadLineFit1006->SetParError(0,0.05904077);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.746143);
   quadLineFit1006->SetParError(1,0.9574402);
   ...
   quadLineFit1007->SetChisquare(1.06824);
   ...
   quadLineFit1007->SetParameter(0,74.38007);
   quadLineFit1007->SetParError(0,0.05904077);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.746143);
   quadLineFit1007->SetParError(1,0.9574402);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50289);
   Graph_mI10_ppm1007->SetMaximum(73.83018);
   ...
   quadLineFit1008->SetChisquare(4.381874);
   ...
   quadLineFit1008->SetParameter(0,74.36369);
   quadLineFit1008->SetParError(0,0.05184699);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.4619);
   quadLineFit1008->SetParError(1,0.8438474);
   ...
   quadLineFit1009->SetChisquare(4.381874);
   ...
   quadLineFit1009->SetParameter(0,74.36369);
   quadLineFit1009->SetParError(0,0.05184699);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.4619);
   quadLineFit1009->SetParError(1,0.8438474);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12833);
   Graph_mI30_ppm1009->SetMaximum(72.85985);
   ...
   quadLineFit1010->SetChisquare(0.9647231);
   ...
   quadLineFit1010->SetParameter(0,74.29115);
   quadLineFit1010->SetParError(0,0.04897266);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.20585);
   quadLineFit1010->SetParError(1,0.847543);
   ...
   quadLineFit1011->SetChisquare(0.9647231);
   ...
   quadLineFit1011->SetParameter(0,74.29115);
   quadLineFit1011->SetParError(0,0.04897266);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.20585);
   quadLineFit1011->SetParError(1,0.847543);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.18753);
   Graph_mI50_ppm1011->SetMaximum(71.88519);
   ...
   quadLineFit1012->SetChisquare(0.2229357);
   ...
   quadLineFit1012->SetParameter(0,74.34878);
   quadLineFit1012->SetParError(0,0.09888239);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.36115);
   quadLineFit1012->SetParError(1,1.76927);
   ...
   quadLineFit1013->SetChisquare(0.2229357);
   ...
   quadLineFit1013->SetParameter(0,74.34878);
   quadLineFit1013->SetParError(0,0.09888239);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.36115);
   quadLineFit1013->SetParError(1,1.76927);
