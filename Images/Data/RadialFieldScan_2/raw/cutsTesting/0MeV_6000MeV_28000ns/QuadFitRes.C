...
//=========  (Wed Apr 21 16:07:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0110234);
   Graph_Graph11015->SetMaximum(0.01125994);
   ...
   Graph_Graph21016->SetMinimum(-0.008882853);
   Graph_Graph21016->SetMaximum(0.01044166);
   ...
   Graph_Graph31017->SetMinimum(-0.02316297);
   Graph_Graph31017->SetMaximum(0.01676239);
   ...
   Graph_Graph41018->SetMinimum(-0.007177447);
   Graph_Graph41018->SetMaximum(0.01095031);
   ...
   Graph_Graph51019->SetMinimum(-0.003788004);
   Graph_Graph51019->SetMaximum(0.005059748);
