...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-41.05326);
   Graph_Graph01029->SetMaximum(48.56803);
   ...
   mainFit1030->SetChisquare(103.706);
   ...
   mainFit1030->SetParameter(0,-0.9027967);
   mainFit1030->SetParError(0,0.5192465);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8554209);
   mainFit1030->SetParError(1,0.01576629);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 34.6");
   pt_LaTex = pt->AddText("0.855#pm0.0158");
   pt_LaTex = pt->AddText("#minus0.903#pm0.519");
   pt_LaTex = pt->AddText("#minus1.06#pm0.605");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.055383,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.055383,-41.05326,1.055383,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(103.706);
   ...
   mainFit1031->SetParameter(0,-0.9027967);
   mainFit1031->SetParError(0,0.5192465);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8554209);
   mainFit1031->SetParError(1,0.01576629);
