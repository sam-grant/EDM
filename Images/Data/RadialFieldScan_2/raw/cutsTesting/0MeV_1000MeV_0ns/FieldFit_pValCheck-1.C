...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-52.25592,75,59.77069);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-41.05326);
   Graph_Graph01023->SetMaximum(48.56803);
   ...
   mainFit1024->SetChisquare(106.6167);
   ...
   mainFit1024->SetParameter(0,-0.5611414);
   mainFit1024->SetParError(0,0.4790747);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8574955);
   mainFit1024->SetParError(1,0.01571935);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 26.7");
   pt_LaTex = pt->AddText("0.857#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.561#pm0.479");
   pt_LaTex = pt->AddText("#minus0.654#pm0.557");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6543957,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6543957,-41.05326,0.6543957,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(106.6167);
   ...
   mainFit1025->SetParameter(0,-0.5611414);
   mainFit1025->SetParError(0,0.4790747);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8574955);
   mainFit1025->SetParError(1,0.01571935);
