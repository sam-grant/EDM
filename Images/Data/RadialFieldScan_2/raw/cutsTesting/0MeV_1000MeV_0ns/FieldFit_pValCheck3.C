...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-41.05326);
   Graph_Graph01031->SetMaximum(48.56803);
   ...
   mainFit1032->SetChisquare(41.88712);
   ...
   mainFit1032->SetParameter(0,1.603791);
   mainFit1032->SetParError(0,0.5494729);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8249895);
   mainFit1032->SetParError(1,0.01623028);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   14");
   pt_LaTex = pt->AddText("0.825#pm0.0162");
   pt_LaTex = pt->AddText("  1.6#pm0.549");
   pt_LaTex = pt->AddText(" 1.94#pm0.677");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.944014,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.944014,-41.05326,-1.944014,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(41.88712);
   ...
   mainFit1033->SetParameter(0,1.603791);
   mainFit1033->SetParError(0,0.5494729);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8249895);
   mainFit1033->SetParError(1,0.01623028);
