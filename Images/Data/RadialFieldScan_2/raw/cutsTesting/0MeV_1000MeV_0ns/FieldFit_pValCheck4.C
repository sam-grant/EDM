...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-41.05326);
   Graph_Graph01033->SetMaximum(48.56803);
   ...
   mainFit1034->SetChisquare(106.6);
   ...
   mainFit1034->SetParameter(0,-0.5138907);
   mainFit1034->SetParError(0,0.6025654);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.855963);
   mainFit1034->SetParError(1,0.01968775);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 35.5");
   pt_LaTex = pt->AddText("0.856#pm0.0197");
   pt_LaTex = pt->AddText("#minus0.514#pm0.603");
   pt_LaTex = pt->AddText(" #minus0.6#pm0.698");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6003655,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6003655,-41.05326,0.6003655,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(106.6);
   ...
   mainFit1035->SetParameter(0,-0.5138907);
   mainFit1035->SetParError(0,0.6025654);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.855963);
   mainFit1035->SetParError(1,0.01968775);
