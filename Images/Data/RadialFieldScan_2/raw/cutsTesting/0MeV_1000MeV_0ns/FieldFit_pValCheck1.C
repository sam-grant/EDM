...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-41.05326);
   Graph_Graph01027->SetMaximum(48.56803);
   ...
   mainFit1028->SetChisquare(74.51419);
   ...
   mainFit1028->SetParameter(0,-1.936795);
   mainFit1028->SetParError(0,0.5370856);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.813313);
   mainFit1028->SetParError(1,0.01754707);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 24.8");
   pt_LaTex = pt->AddText("0.813#pm0.0175");
   pt_LaTex = pt->AddText("#minus1.94#pm0.537");
   pt_LaTex = pt->AddText("#minus2.38#pm0.666");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.381365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.381365,-41.05326,2.381365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(74.51419);
   ...
   mainFit1029->SetParameter(0,-1.936795);
   mainFit1029->SetParError(0,0.5370856);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.813313);
   mainFit1029->SetParError(1,0.01754707);
