...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0627048);
   Graph_Graph11015->SetMaximum(0.04181073);
   ...
   Graph_Graph21016->SetMinimum(-0.01238396);
   Graph_Graph21016->SetMaximum(0.01408772);
   ...
   Graph_Graph31017->SetMinimum(-0.03156691);
   Graph_Graph31017->SetMaximum(0.03381143);
   ...
   Graph_Graph41018->SetMinimum(-0.04206508);
   Graph_Graph41018->SetMaximum(0.07974729);
   ...
   Graph_Graph51019->SetMinimum(-0.0557282);
   Graph_Graph51019->SetMaximum(0.04180443);
