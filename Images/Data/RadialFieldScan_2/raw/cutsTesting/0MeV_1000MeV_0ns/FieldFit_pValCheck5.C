...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.52526,70,58.22456);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.25028);
   Graph_Graph01035->SetMaximum(47.94957);
   ...
   mainFit1036->SetChisquare(65.96755);
   ...
   mainFit1036->SetParameter(0,-1.535434);
   mainFit1036->SetParError(0,0.5028565);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9033512);
   mainFit1036->SetParError(1,0.01728661);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   22");
   pt_LaTex = pt->AddText("0.903#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.54#pm0.503");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.549");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.699709,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.699709,-34.25028,1.699709,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(65.96755);
   ...
   mainFit1037->SetParameter(0,-1.535434);
   mainFit1037->SetParError(0,0.5028565);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9033512);
   mainFit1037->SetParError(1,0.01728661);
