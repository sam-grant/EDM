...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-41.05326);
   Graph_Graph01020->SetMaximum(48.56803);
   ...
   mainFit1021->SetChisquare(106.6167);
   ...
   mainFit1021->SetParameter(0,-0.5611414);
   mainFit1021->SetParError(0,0.4790747);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8574955);
   mainFit1021->SetParError(1,0.01571935);
   ...
   mainFit1022->SetChisquare(106.6167);
   ...
   mainFit1022->SetParameter(0,-0.5611414);
   mainFit1022->SetParError(0,0.4790747);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8574955);
   mainFit1022->SetParError(1,0.01571935);
