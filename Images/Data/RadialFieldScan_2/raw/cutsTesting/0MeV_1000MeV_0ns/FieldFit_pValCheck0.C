...
//=========  (Wed Apr 21 18:11:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-49.6637,50,46.80958);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-40.01637);
   Graph_Graph01025->SetMaximum(37.16225);
   ...
   mainFit1026->SetChisquare(98.74691);
   ...
   mainFit1026->SetParameter(0,-0.00422729);
   mainFit1026->SetParError(0,0.5185841);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8937454);
   mainFit1026->SetParError(1,0.02035133);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 32.9");
   pt_LaTex = pt->AddText("0.894#pm0.0204");
   pt_LaTex = pt->AddText("#minus0.00423#pm0.519");
   pt_LaTex = pt->AddText("#minus0.00473#pm 0.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.00472986,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.00472986,-40.01637,0.00472986,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(98.74691);
   ...
   mainFit1027->SetParameter(0,-0.00422729);
   mainFit1027->SetParError(0,0.5185841);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8937454);
   mainFit1027->SetParError(1,0.02035133);
