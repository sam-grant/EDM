...
//=========  (Fri Apr 23 11:31:29 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-62.91389,75,63.54851);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-50.26765);
   Graph_Graph01023->SetMaximum(50.90227);
   ...
   mainFit1024->SetChisquare(53.1529);
   ...
   mainFit1024->SetParameter(0,-1.533222);
   mainFit1024->SetParError(0,0.2959379);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8867098);
   mainFit1024->SetParError(1,0.009743547);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 13.3");
   pt_LaTex = pt->AddText("0.887#pm0.00974");
   pt_LaTex = pt->AddText("#minus1.53#pm0.296");
   pt_LaTex = pt->AddText("#minus1.73#pm0.331");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.729113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.729113,-50.26765,1.729113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(53.1529);
   ...
   mainFit1025->SetParameter(0,-1.533222);
   mainFit1025->SetParError(0,0.2959379);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8867098);
   mainFit1025->SetParError(1,0.009743547);
