...
//=========  (Fri Apr 23 11:31:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.26765);
   Graph_Graph01027->SetMaximum(50.90227);
   ...
   mainFit1028->SetChisquare(38.8684);
   ...
   mainFit1028->SetParameter(0,-2.094548);
   mainFit1028->SetParError(0,0.3311143);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8685406);
   mainFit1028->SetParError(1,0.01086481);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   13");
   pt_LaTex = pt->AddText("0.869#pm0.0109");
   pt_LaTex = pt->AddText("#minus2.09#pm0.331");
   pt_LaTex = pt->AddText("#minus2.41#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.411571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.411571,-50.26765,2.411571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(38.8684);
   ...
   mainFit1029->SetParameter(0,-2.094548);
   mainFit1029->SetParError(0,0.3311143);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8685406);
   mainFit1029->SetParError(1,0.01086481);
