...
//=========  (Fri Apr 23 11:31:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.26765);
   Graph_Graph01029->SetMaximum(50.90227);
   ...
   mainFit1030->SetChisquare(50.67172);
   ...
   mainFit1030->SetParameter(0,-1.730551);
   mainFit1030->SetParError(0,0.3213611);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8855548);
   mainFit1030->SetParError(1,0.009771087);
   ...
   pt_LaTex = pt->AddText("#minus1.73#pm0.321");
   pt_LaTex = pt->AddText("#minus1.95#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.9542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.9542,-50.26765,1.9542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(50.67172);
   ...
   mainFit1031->SetParameter(0,-1.730551);
   mainFit1031->SetParError(0,0.3213611);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8855548);
   mainFit1031->SetParError(1,0.009771087);
