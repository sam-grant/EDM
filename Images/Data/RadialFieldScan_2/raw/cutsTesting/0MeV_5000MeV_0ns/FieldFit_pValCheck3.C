...
//=========  (Fri Apr 23 11:31:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-50.26765);
   Graph_Graph01031->SetMaximum(50.90227);
   ...
   mainFit1032->SetChisquare(21.14066);
   ...
   mainFit1032->SetParameter(0,-0.5824648);
   mainFit1032->SetParError(0,0.3403182);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8721382);
   mainFit1032->SetParError(1,0.01007817);
   ...
   pt_LaTex = pt->AddText("#minus0.582#pm 0.34");
   pt_LaTex = pt->AddText("#minus0.668#pm0.388");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6678584,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6678584,-50.26765,0.6678584,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(21.14066);
   ...
   mainFit1033->SetParameter(0,-0.5824648);
   mainFit1033->SetParError(0,0.3403182);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8721382);
   mainFit1033->SetParError(1,0.01007817);
