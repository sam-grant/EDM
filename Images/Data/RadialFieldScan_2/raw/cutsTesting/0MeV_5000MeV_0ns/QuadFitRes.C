...
//=========  (Fri Apr 23 11:31:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03332199);
   Graph_Graph11015->SetMaximum(0.01715314);
   ...
   Graph_Graph21016->SetMinimum(-0.01501619);
   Graph_Graph21016->SetMaximum(0.01746366);
   ...
   Graph_Graph31017->SetMinimum(-0.009687968);
   Graph_Graph31017->SetMaximum(0.01975457);
   ...
   Graph_Graph41018->SetMinimum(-0.02376247);
   Graph_Graph41018->SetMaximum(0.04076186);
   ...
   Graph_Graph51019->SetMinimum(-0.01923503);
   Graph_Graph51019->SetMaximum(0.01442709);
