...
//=========  (Fri Apr 23 11:31:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.26765);
   Graph_Graph01033->SetMaximum(50.90227);
   ...
   mainFit1034->SetChisquare(53.08695);
   ...
   mainFit1034->SetParameter(0,-1.475541);
   mainFit1034->SetParError(0,0.3715172);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8848276);
   mainFit1034->SetParError(1,0.01219234);
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.667603,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.667603,-50.26765,1.667603,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(53.08695);
   ...
   mainFit1035->SetParameter(0,-1.475541);
   mainFit1035->SetParError(0,0.3715172);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8848276);
   mainFit1035->SetParError(1,0.01219234);
