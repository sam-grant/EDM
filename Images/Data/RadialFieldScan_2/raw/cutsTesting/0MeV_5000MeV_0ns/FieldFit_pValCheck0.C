...
//=========  (Fri Apr 23 11:31:29 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.18802,50,44.91917);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.7773);
   Graph_Graph01025->SetMaximum(34.50845);
   ...
   mainFit1026->SetChisquare(49.05374);
   ...
   mainFit1026->SetParameter(0,-1.289292);
   mainFit1026->SetParError(0,0.3195228);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9029375);
   mainFit1026->SetParError(1,0.01261658);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.4");
   pt_LaTex = pt->AddText("0.903#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.29#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.43#pm0.357");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.427886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.427886,-48.7773,1.427886,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(49.05374);
   ...
   mainFit1027->SetParameter(0,-1.289292);
   mainFit1027->SetParError(0,0.3195228);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9029375);
   mainFit1027->SetParError(1,0.01261658);
