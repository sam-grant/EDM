...
//=========  (Fri Apr 23 11:31:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.26765);
   Graph_Graph01020->SetMaximum(50.90227);
   ...
   mainFit1021->SetChisquare(53.1529);
   ...
   mainFit1021->SetParameter(0,-1.533222);
   mainFit1021->SetParError(0,0.2959379);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8867098);
   mainFit1021->SetParError(1,0.009743547);
   ...
   mainFit1022->SetChisquare(53.1529);
   ...
   mainFit1022->SetParameter(0,-1.533222);
   mainFit1022->SetParError(0,0.2959379);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8867098);
   mainFit1022->SetParError(1,0.009743547);
