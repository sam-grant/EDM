...
//=========  (Thu Apr 22 10:04:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01430477);
   Graph_Graph11015->SetMaximum(0.03488993);
   ...
   Graph_Graph21016->SetMinimum(-0.01570223);
   Graph_Graph21016->SetMaximum(0.0185147);
   ...
   Graph_Graph31017->SetMinimum(-0.04039801);
   Graph_Graph31017->SetMaximum(0.03202504);
   ...
   Graph_Graph41018->SetMinimum(-0.0166659);
   Graph_Graph41018->SetMaximum(0.02445261);
   ...
   Graph_Graph51019->SetMinimum(-0.006198304);
   Graph_Graph51019->SetMaximum(0.008288239);
