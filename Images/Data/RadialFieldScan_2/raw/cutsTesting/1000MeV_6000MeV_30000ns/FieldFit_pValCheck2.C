...
//=========  (Thu Apr 22 10:04:39 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-68.43684,75,66.14348);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-54.97881);
   Graph_Graph01029->SetMaximum(52.68545);
   ...
   mainFit1030->SetChisquare(4.143796);
   ...
   mainFit1030->SetParameter(0,-0.6205182);
   mainFit1030->SetParError(0,0.5277628);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8369235);
   mainFit1030->SetParError(1,0.01605277);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.38");
   pt_LaTex = pt->AddText("0.837#pm0.0161");
   pt_LaTex = pt->AddText("#minus0.621#pm0.528");
   pt_LaTex = pt->AddText("#minus0.741#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7414276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7414276,-54.97881,0.7414276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.143796);
   ...
   mainFit1031->SetParameter(0,-0.6205182);
   mainFit1031->SetParError(0,0.5277628);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8369235);
   mainFit1031->SetParError(1,0.01605277);
