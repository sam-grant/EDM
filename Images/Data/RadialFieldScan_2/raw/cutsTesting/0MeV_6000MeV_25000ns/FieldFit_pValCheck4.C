...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.63233);
   Graph_Graph01033->SetMaximum(55.68065);
   ...
   mainFit1034->SetChisquare(2.982246);
   ...
   mainFit1034->SetParameter(0,-1.977448);
   mainFit1034->SetParError(0,0.4778304);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9256066);
   mainFit1034->SetParError(1,0.0157611);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.994");
   pt_LaTex = pt->AddText("0.926#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.98#pm0.478");
   pt_LaTex = pt->AddText("#minus2.14#pm  0.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.136381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.136381,-59.63233,2.136381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.982246);
   ...
   mainFit1035->SetParameter(0,-1.977448);
   mainFit1035->SetParError(0,0.4778304);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9256066);
   mainFit1035->SetParError(1,0.0157611);
