...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.005753238);
   Graph_Graph11015->SetMaximum(0.005295057);
   ...
   Graph_Graph21016->SetMinimum(-0.008140863);
   Graph_Graph21016->SetMaximum(0.009567809);
   ...
   Graph_Graph31017->SetMinimum(-0.02362507);
   Graph_Graph31017->SetMaximum(0.0194036);
   ...
   Graph_Graph41018->SetMinimum(-0.003754225);
   Graph_Graph41018->SetMaximum(0.00706318);
   ...
   Graph_Graph51019->SetMinimum(-0.0001434393);
   Graph_Graph51019->SetMaximum(0.0001073535);
