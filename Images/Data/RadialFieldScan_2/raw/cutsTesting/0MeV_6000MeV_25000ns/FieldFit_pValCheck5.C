...
//=========  (Wed Apr 21 15:55:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.05448,70,65.09638);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.63939);
   Graph_Graph01035->SetMaximum(53.68129);
   ...
   mainFit1036->SetChisquare(3.12975);
   ...
   mainFit1036->SetParameter(0,-1.811512);
   mainFit1036->SetParError(0,0.3997585);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9196941);
   mainFit1036->SetParError(1,0.01383197);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.81#pm  0.4");
   pt_LaTex = pt->AddText("#minus1.97#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.96969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.96969,-37.63939,1.96969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.12975);
   ...
   mainFit1037->SetParameter(0,-1.811512);
   mainFit1037->SetParError(0,0.3997585);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9196941);
   mainFit1037->SetParError(1,0.01383197);
