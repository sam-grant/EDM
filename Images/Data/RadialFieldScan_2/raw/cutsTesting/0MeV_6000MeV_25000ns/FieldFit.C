...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.63233);
   Graph_Graph01020->SetMaximum(55.68065);
   ...
   mainFit1021->SetChisquare(3.199131);
   ...
   mainFit1021->SetParameter(0,-1.843227);
   mainFit1021->SetParError(0,0.3811655);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.92119);
   mainFit1021->SetParError(1,0.01260009);
   ...
   mainFit1022->SetChisquare(3.199131);
   ...
   mainFit1022->SetParameter(0,-1.843227);
   mainFit1022->SetParError(0,0.3811655);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.92119);
   mainFit1022->SetParError(1,0.01260009);
