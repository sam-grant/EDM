...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.63233);
   Graph_Graph01023->SetMaximum(55.68065);
   ...
   mainFit1024->SetChisquare(3.199131);
   ...
   mainFit1024->SetParameter(0,-1.843227);
   mainFit1024->SetParError(0,0.3811655);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.92119);
   mainFit1024->SetParError(1,0.01260009);
   ...
   pt_LaTex = pt->AddText("#minus1.84#pm0.381");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.000919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.000919,-59.63233,2.000919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.199131);
   ...
   mainFit1025->SetParameter(0,-1.843227);
   mainFit1025->SetParError(0,0.3811655);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.92119);
   mainFit1025->SetParError(1,0.01260009);
