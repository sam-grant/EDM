...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-74.04645,75,70.09477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.63233);
   Graph_Graph01027->SetMaximum(55.68065);
   ...
   mainFit1028->SetChisquare(0.3386808);
   ...
   mainFit1028->SetParameter(0,-1.518567);
   mainFit1028->SetParError(0,0.426781);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9318064);
   mainFit1028->SetParError(1,0.01407542);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.52#pm0.427");
   pt_LaTex = pt->AddText("#minus1.63#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.629702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.629702,-59.63233,1.629702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3386808);
   ...
   mainFit1029->SetParameter(0,-1.518567);
   mainFit1029->SetParError(0,0.426781);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9318064);
   mainFit1029->SetParError(1,0.01407542);
