...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.63233);
   Graph_Graph01029->SetMaximum(55.68065);
   ...
   mainFit1030->SetChisquare(2.717217);
   ...
   mainFit1030->SetParameter(0,-1.955964);
   mainFit1030->SetParError(0,0.414306);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9205297);
   mainFit1030->SetParError(1,0.01263669);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.96#pm0.414");
   pt_LaTex = pt->AddText("#minus2.12#pm0.448");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.124824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.124824,-59.63233,2.124824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.717217);
   ...
   mainFit1031->SetParameter(0,-1.955964);
   mainFit1031->SetParError(0,0.414306);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9205297);
   mainFit1031->SetParError(1,0.01263669);
