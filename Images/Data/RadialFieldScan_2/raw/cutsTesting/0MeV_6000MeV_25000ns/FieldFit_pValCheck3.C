...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.63233);
   Graph_Graph01031->SetMaximum(55.68065);
   ...
   mainFit1032->SetChisquare(3.159424);
   ...
   mainFit1032->SetParameter(0,-1.799873);
   mainFit1032->SetParError(0,0.4389481);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9205278);
   mainFit1032->SetParError(1,0.01304011);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.013");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.439");
   pt_LaTex = pt->AddText("#minus1.96#pm 0.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.955262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.955262,-59.63233,1.955262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.159424);
   ...
   mainFit1033->SetParameter(0,-1.799873);
   mainFit1033->SetParError(0,0.4389481);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9205278);
   mainFit1033->SetParError(1,0.01304011);
