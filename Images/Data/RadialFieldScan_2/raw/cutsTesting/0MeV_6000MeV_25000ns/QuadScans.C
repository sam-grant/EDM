...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.165055);
   ...
   quadLineFit1002->SetParameter(0,74.47862);
   quadLineFit1002->SetParError(0,0.05811801);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.09644);
   quadLineFit1002->SetParError(1,0.9747976);
   ...
   quadLineFit1003->SetChisquare(1.165055);
   ...
   quadLineFit1003->SetParameter(0,74.47862);
   quadLineFit1003->SetParError(0,0.05811801);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.09644);
   quadLineFit1003->SetParError(1,0.9747976);
   ...
   Graph_30_ppm1003->SetMinimum(75.74118);
   Graph_30_ppm1003->SetMaximum(76.36371);
   ...
   quadLineFit1004->SetChisquare(0.3592921);
   ...
   quadLineFit1004->SetParameter(0,74.53462);
   quadLineFit1004->SetParError(0,0.04891428);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.71712);
   quadLineFit1004->SetParError(1,0.8038481);
   ...
   quadLineFit1005->SetChisquare(0.3592921);
   ...
   quadLineFit1005->SetParameter(0,74.53462);
   quadLineFit1005->SetParError(0,0.04891428);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.71712);
   quadLineFit1005->SetParError(1,0.8038481);
   ...
   Graph_10_ppm1005->SetMinimum(74.75061);
   Graph_10_ppm1005->SetMaximum(74.97891);
   ...
   quadLineFit1006->SetChisquare(0.9520663);
   ...
   quadLineFit1006->SetParameter(0,74.36916);
   quadLineFit1006->SetParError(0,0.05730002);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.956835);
   quadLineFit1006->SetParError(1,0.9292002);
   ...
   quadLineFit1007->SetChisquare(0.9520663);
   ...
   quadLineFit1007->SetParameter(0,74.36916);
   quadLineFit1007->SetParError(0,0.05730002);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.956835);
   quadLineFit1007->SetParError(1,0.9292002);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50744);
   Graph_mI10_ppm1007->SetMaximum(73.82739);
   ...
   quadLineFit1008->SetChisquare(5.06664);
   ...
   quadLineFit1008->SetParameter(0,74.34935);
   quadLineFit1008->SetParError(0,0.05032088);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.19529);
   quadLineFit1008->SetParError(1,0.8189971);
   ...
   quadLineFit1009->SetChisquare(5.06664);
   ...
   quadLineFit1009->SetParameter(0,74.34935);
   quadLineFit1009->SetParError(0,0.05032088);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.19529);
   quadLineFit1009->SetParError(1,0.8189971);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12547);
   Graph_mI30_ppm1009->SetMaximum(72.85842);
   ...
   quadLineFit1010->SetChisquare(0.4175992);
   ...
   quadLineFit1010->SetParameter(0,74.28885);
   quadLineFit1010->SetParError(0,0.0475249);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.20686);
   quadLineFit1010->SetParError(1,0.8224817);
   ...
   quadLineFit1011->SetChisquare(0.4175992);
   ...
   quadLineFit1011->SetParameter(0,74.28885);
   quadLineFit1011->SetParError(0,0.0475249);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.20686);
   quadLineFit1011->SetParError(1,0.8224817);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20335);
   Graph_mI50_ppm1011->SetMaximum(71.8862);
   ...
   quadLineFit1012->SetChisquare(0.0001901788);
   ...
   quadLineFit1012->SetParameter(0,74.29411);
   quadLineFit1012->SetParError(0,0.09599687);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.30524);
   quadLineFit1012->SetParError(1,1.717669);
   ...
   quadLineFit1013->SetChisquare(0.0001901788);
   ...
   quadLineFit1013->SetParameter(0,74.29411);
   quadLineFit1013->SetParError(0,0.09599687);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.30524);
   quadLineFit1013->SetParError(1,1.717669);
