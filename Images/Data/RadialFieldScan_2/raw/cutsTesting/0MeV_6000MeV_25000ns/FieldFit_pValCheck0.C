...
//=========  (Wed Apr 21 15:55:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.90888,50,44.40694);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.5773);
   Graph_Graph01025->SetMaximum(33.07536);
   ...
   mainFit1026->SetChisquare(1.6043);
   ...
   mainFit1026->SetParameter(0,-2.036505);
   mainFit1026->SetParError(0,0.410737);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.90821);
   mainFit1026->SetParError(1,0.01626403);
   ...
   pt_LaTex = pt->AddText("0.908#pm0.0163");
   pt_LaTex = pt->AddText("#minus2.04#pm0.411");
   pt_LaTex = pt->AddText("#minus2.24#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.242329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.242329,-57.5773,2.242329,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.6043);
   ...
   mainFit1027->SetParameter(0,-2.036505);
   mainFit1027->SetParError(0,0.410737);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.90821);
   mainFit1027->SetParError(1,0.01626403);
