...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-42.98726);
   Graph_Graph01020->SetMaximum(48.86498);
   ...
   mainFit1021->SetChisquare(4.989964);
   ...
   mainFit1021->SetParameter(0,0.3779165);
   mainFit1021->SetParError(0,0.7407404);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7431372);
   mainFit1021->SetParError(1,0.02442479);
   ...
   mainFit1022->SetChisquare(4.989964);
   ...
   mainFit1022->SetParameter(0,0.3779165);
   mainFit1022->SetParError(0,0.7407404);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7431372);
   mainFit1022->SetParError(1,0.02442479);
