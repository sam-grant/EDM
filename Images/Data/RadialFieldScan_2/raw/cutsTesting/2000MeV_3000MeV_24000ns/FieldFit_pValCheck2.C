...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-42.98726);
   Graph_Graph01029->SetMaximum(48.86498);
   ...
   mainFit1030->SetChisquare(4.482985);
   ...
   mainFit1030->SetParameter(0,0.1538654);
   mainFit1030->SetParError(0,0.8048215);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7418546);
   mainFit1030->SetParError(1,0.0244905);
   ...
   pt_LaTex = pt->AddText("0.742#pm0.0245");
   pt_LaTex = pt->AddText("0.154#pm0.805");
   pt_LaTex = pt->AddText("0.207#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2074064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2074064,-42.98726,-0.2074064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.482985);
   ...
   mainFit1031->SetParameter(0,0.1538654);
   mainFit1031->SetParError(0,0.8048215);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7418546);
   mainFit1031->SetParError(1,0.0244905);
