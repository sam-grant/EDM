...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.43528,70,57.5398);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.63777);
   Graph_Graph01035->SetMaximum(47.74229);
   ...
   mainFit1036->SetChisquare(2.393385);
   ...
   mainFit1036->SetParameter(0,-0.001263025);
   mainFit1036->SetParError(0,0.7772182);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7609448);
   mainFit1036->SetParError(1,0.02680851);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.798");
   pt_LaTex = pt->AddText("0.761#pm0.0268");
   pt_LaTex = pt->AddText("#minus0.00126#pm0.777");
   pt_LaTex = pt->AddText("#minus0.00166#pm 1.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.001659812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.001659812,-30.63777,0.001659812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.393385);
   ...
   mainFit1037->SetParameter(0,-0.001263025);
   mainFit1037->SetParError(0,0.7772182);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7609448);
   mainFit1037->SetParError(1,0.02680851);
