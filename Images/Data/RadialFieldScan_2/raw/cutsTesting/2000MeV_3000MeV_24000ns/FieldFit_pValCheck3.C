...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-42.98726);
   Graph_Graph01031->SetMaximum(48.86498);
   ...
   mainFit1032->SetChisquare(4.330704);
   ...
   mainFit1032->SetParameter(0,0.7219093);
   mainFit1032->SetParError(0,0.8533374);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.737802);
   mainFit1032->SetParError(1,0.0252932);
   ...
   pt_LaTex = pt->AddText("0.738#pm0.0253");
   pt_LaTex = pt->AddText("0.722#pm0.853");
   pt_LaTex = pt->AddText("0.978#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9784594,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9784594,-42.98726,-0.9784594,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.330704);
   ...
   mainFit1033->SetParameter(0,0.7219093);
   mainFit1033->SetParError(0,0.8533374);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.737802);
   mainFit1033->SetParError(1,0.0252932);
