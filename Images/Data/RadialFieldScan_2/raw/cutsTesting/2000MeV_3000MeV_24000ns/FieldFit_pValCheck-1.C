...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-42.98726);
   Graph_Graph01023->SetMaximum(48.86498);
   ...
   mainFit1024->SetChisquare(4.989964);
   ...
   mainFit1024->SetParameter(0,0.3779165);
   mainFit1024->SetParError(0,0.7407404);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7431372);
   mainFit1024->SetParError(1,0.02442479);
   ...
   pt_LaTex = pt->AddText("0.743#pm0.0244");
   pt_LaTex = pt->AddText("0.378#pm0.741");
   pt_LaTex = pt->AddText("0.509#pm    1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.508542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.508542,-42.98726,-0.508542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.989964);
   ...
   mainFit1025->SetParameter(0,0.3779165);
   mainFit1025->SetParError(0,0.7407404);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7431372);
   mainFit1025->SetParError(1,0.02442479);
