...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-42.98726);
   Graph_Graph01027->SetMaximum(48.86498);
   ...
   mainFit1028->SetChisquare(3.438546);
   ...
   mainFit1028->SetParameter(0,0.839041);
   mainFit1028->SetParError(0,0.8281036);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7581129);
   mainFit1028->SetParError(1,0.02722369);
   ...
   pt_LaTex = pt->AddText("0.758#pm0.0272");
   pt_LaTex = pt->AddText("0.839#pm0.828");
   pt_LaTex = pt->AddText(" 1.11#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.106749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.106749,-42.98726,-1.106749,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.438546);
   ...
   mainFit1029->SetParameter(0,0.839041);
   mainFit1029->SetParError(0,0.8281036);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7581129);
   mainFit1029->SetParError(1,0.02722369);
