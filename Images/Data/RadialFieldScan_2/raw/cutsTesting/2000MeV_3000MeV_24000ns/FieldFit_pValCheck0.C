...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-49.83895,50,37.19731);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-41.13532);
   Graph_Graph01025->SetMaximum(28.49368);
   ...
   mainFit1026->SetChisquare(3.171759);
   ...
   mainFit1026->SetParameter(0,-0.02433275);
   mainFit1026->SetParError(0,0.7985504);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7160398);
   mainFit1026->SetParError(1,0.03162773);
   ...
   pt_LaTex = pt->AddText("0.716#pm0.0316");
   pt_LaTex = pt->AddText("#minus0.0243#pm0.799");
   pt_LaTex = pt->AddText("#minus0.034#pm 1.12");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.0339824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.0339824,-41.13532,0.0339824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.171759);
   ...
   mainFit1027->SetParameter(0,-0.02433275);
   mainFit1027->SetParError(0,0.7985504);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7160398);
   mainFit1027->SetParError(1,0.03162773);
