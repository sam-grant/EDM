...
//=========  (Fri Apr 23 19:01:00 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2743877);
   ...
   quadLineFit1002->SetParameter(0,75.09157);
   quadLineFit1002->SetParError(0,0.1118881);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.3344);
   quadLineFit1002->SetParError(1,1.876223);
   ...
   quadLineFit1003->SetChisquare(0.2743877);
   ...
   quadLineFit1003->SetParameter(0,75.09157);
   quadLineFit1003->SetParError(0,0.1118881);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.3344);
   quadLineFit1003->SetParError(1,1.876223);
   ...
   Graph_30_ppm1003->SetMinimum(76.16794);
   Graph_30_ppm1003->SetMaximum(76.72011);
   ...
   quadLineFit1004->SetChisquare(0.990958);
   ...
   quadLineFit1004->SetParameter(0,75.13949);
   quadLineFit1004->SetParError(0,0.09499332);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.12993);
   quadLineFit1004->SetParError(1,1.561334);
   ...
   quadLineFit1005->SetChisquare(0.990958);
   ...
   quadLineFit1005->SetParameter(0,75.13949);
   quadLineFit1005->SetParError(0,0.09499332);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.12993);
   quadLineFit1005->SetParError(1,1.561334);
   ...
   Graph_10_ppm1005->SetMinimum(75.2407);
   Graph_10_ppm1005->SetMaximum(75.51839);
   ...
   quadLineFit1006->SetChisquare(0.0712883);
   ...
   quadLineFit1006->SetParameter(0,74.83017);
   quadLineFit1006->SetParError(0,0.1113958);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.982576);
   quadLineFit1006->SetParError(1,1.806498);
   ...
   quadLineFit1007->SetChisquare(0.0712883);
   ...
   quadLineFit1007->SetParameter(0,74.83017);
   quadLineFit1007->SetParError(0,0.1113958);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.982576);
   quadLineFit1007->SetParError(1,1.806498);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.24453);
   Graph_mI10_ppm1007->SetMaximum(74.53165);
   ...
   quadLineFit1008->SetChisquare(2.852856);
   ...
   quadLineFit1008->SetParameter(0,74.87425);
   quadLineFit1008->SetParError(0,0.09783174);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.162741);
   quadLineFit1008->SetParError(1,1.592197);
   ...
   quadLineFit1009->SetChisquare(2.852856);
   ...
   quadLineFit1009->SetParameter(0,74.87425);
   quadLineFit1009->SetParError(0,0.09783174);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.162741);
   quadLineFit1009->SetParError(1,1.592197);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.0277);
   Graph_mI30_ppm1009->SetMaximum(73.61535);
   ...
   quadLineFit1010->SetChisquare(0.9467102);
   ...
   quadLineFit1010->SetParameter(0,74.70308);
   quadLineFit1010->SetParError(0,0.09255438);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.50429);
   quadLineFit1010->SetParError(1,1.601803);
   ...
   quadLineFit1011->SetChisquare(0.9467102);
   ...
   quadLineFit1011->SetParameter(0,74.70308);
   quadLineFit1011->SetParError(0,0.09255438);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.50429);
   quadLineFit1011->SetParError(1,1.601803);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.21927);
   Graph_mI50_ppm1011->SetMaximum(72.71253);
   ...
   quadLineFit1012->SetChisquare(0.245848);
   ...
   quadLineFit1012->SetParameter(0,74.29409);
   quadLineFit1012->SetParError(0,0.1868199);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-31.99045);
   quadLineFit1012->SetParError(1,3.342451);
   ...
   quadLineFit1013->SetChisquare(0.245848);
   ...
   quadLineFit1013->SetParameter(0,74.29409);
   quadLineFit1013->SetParError(0,0.1868199);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-31.99045);
   quadLineFit1013->SetParError(1,3.342451);
