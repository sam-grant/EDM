...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01906526);
   Graph_Graph11015->SetMaximum(0.02032471);
   ...
   Graph_Graph21016->SetMinimum(-0.005090916);
   Graph_Graph21016->SetMaximum(0.004330192);
   ...
   Graph_Graph31017->SetMinimum(-0.03709848);
   Graph_Graph31017->SetMaximum(0.03068924);
   ...
   Graph_Graph41018->SetMinimum(-0.02750648);
   Graph_Graph41018->SetMaximum(0.01344985);
   ...
   Graph_Graph51019->SetMinimum(-0.007517445);
   Graph_Graph51019->SetMaximum(0.01004574);
