...
//=========  (Fri Apr 23 19:01:01 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-54.46879,75,60.3465);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-42.98726);
   Graph_Graph01033->SetMaximum(48.86498);
   ...
   mainFit1034->SetChisquare(4.723817);
   ...
   mainFit1034->SetParameter(0,0.6671193);
   mainFit1034->SetParError(0,0.9289525);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7336749);
   mainFit1034->SetParError(1,0.03054482);
   ...
   pt_LaTex = pt->AddText("0.734#pm0.0305");
   pt_LaTex = pt->AddText("0.667#pm0.929");
   pt_LaTex = pt->AddText("0.909#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9092847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9092847,-42.98726,-0.9092847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.723817);
   ...
   mainFit1035->SetParameter(0,0.6671193);
   mainFit1035->SetParError(0,0.9289525);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7336749);
   mainFit1035->SetParError(1,0.03054482);
