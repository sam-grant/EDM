...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.41406);
   Graph_Graph01029->SetMaximum(55.47011);
   ...
   mainFit1030->SetChisquare(4.763643);
   ...
   mainFit1030->SetParameter(0,-1.475949);
   mainFit1030->SetParError(0,0.4284029);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9010763);
   mainFit1030->SetParError(1,0.01306136);
   ...
   pt_LaTex = pt->AddText("#minus1.48#pm0.428");
   pt_LaTex = pt->AddText("#minus1.64#pm0.473");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.637984,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.637984,-57.41406,1.637984,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.763643);
   ...
   mainFit1031->SetParameter(0,-1.475949);
   mainFit1031->SetParError(0,0.4284029);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9010763);
   mainFit1031->SetParError(1,0.01306136);
