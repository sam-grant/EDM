...
//=========  (Wed Apr 21 13:43:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.81047,70,64.83781);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.54564);
   Graph_Graph01035->SetMaximum(53.57298);
   ...
   mainFit1036->SetChisquare(5.760997);
   ...
   mainFit1036->SetParameter(0,-1.321433);
   mainFit1036->SetParError(0,0.4134222);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.90274);
   mainFit1036->SetParError(1,0.01429797);
   ...
   pt_LaTex = pt->AddText("0.903#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.32#pm0.413");
   pt_LaTex = pt->AddText("#minus1.46#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.463803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.463803,-36.54564,1.463803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.760997);
   ...
   mainFit1037->SetParameter(0,-1.321433);
   mainFit1037->SetParError(0,0.4134222);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.90274);
   mainFit1037->SetParError(1,0.01429797);
