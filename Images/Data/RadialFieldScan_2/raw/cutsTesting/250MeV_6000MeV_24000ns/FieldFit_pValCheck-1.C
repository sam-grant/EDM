...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.41406);
   Graph_Graph01023->SetMaximum(55.47011);
   ...
   mainFit1024->SetChisquare(5.773977);
   ...
   mainFit1024->SetParameter(0,-1.307218);
   mainFit1024->SetParError(0,0.3941439);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9020678);
   mainFit1024->SetParError(1,0.01302409);
   ...
   pt_LaTex = pt->AddText("0.902#pm0.013");
   pt_LaTex = pt->AddText("#minus1.31#pm0.394");
   pt_LaTex = pt->AddText("#minus1.45#pm0.434");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.449134,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.449134,-57.41406,1.449134,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.773977);
   ...
   mainFit1025->SetParameter(0,-1.307218);
   mainFit1025->SetParError(0,0.3941439);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9020678);
   mainFit1025->SetParError(1,0.01302409);
