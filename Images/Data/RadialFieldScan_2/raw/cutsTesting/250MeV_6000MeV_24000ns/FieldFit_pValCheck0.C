...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.28253,50,43.37033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.31724);
   Graph_Graph01025->SetMaximum(32.40504);
   ...
   mainFit1026->SetChisquare(2.698547);
   ...
   mainFit1026->SetParameter(0,-1.584636);
   mainFit1026->SetParError(0,0.4247046);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8834073);
   mainFit1026->SetParError(1,0.01681821);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.9");
   pt_LaTex = pt->AddText("0.883#pm0.0168");
   pt_LaTex = pt->AddText("#minus1.58#pm0.425");
   pt_LaTex = pt->AddText("#minus1.79#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.793778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.793778,-55.31724,1.793778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.698547);
   ...
   mainFit1027->SetParameter(0,-1.584636);
   mainFit1027->SetParError(0,0.4247046);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8834073);
   mainFit1027->SetParError(1,0.01681821);
