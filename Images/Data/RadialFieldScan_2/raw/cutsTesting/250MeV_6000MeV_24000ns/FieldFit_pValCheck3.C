...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.41406);
   Graph_Graph01031->SetMaximum(55.47011);
   ...
   mainFit1032->SetChisquare(5.653995);
   ...
   mainFit1032->SetParameter(0,-1.229222);
   mainFit1032->SetParError(0,0.4539286);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9008627);
   mainFit1032->SetParError(1,0.01348082);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0135");
   pt_LaTex = pt->AddText("#minus1.23#pm0.454");
   pt_LaTex = pt->AddText("#minus1.36#pm0.499");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.364494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.364494,-57.41406,1.364494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.653995);
   ...
   mainFit1033->SetParameter(0,-1.229222);
   mainFit1033->SetParError(0,0.4539286);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9008627);
   mainFit1033->SetParError(1,0.01348082);
