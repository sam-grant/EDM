...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.41406);
   Graph_Graph01020->SetMaximum(55.47011);
   ...
   mainFit1021->SetChisquare(5.773977);
   ...
   mainFit1021->SetParameter(0,-1.307218);
   mainFit1021->SetParError(0,0.3941439);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9020678);
   mainFit1021->SetParError(1,0.01302409);
   ...
   mainFit1022->SetChisquare(5.773977);
   ...
   mainFit1022->SetParameter(0,-1.307218);
   mainFit1022->SetParError(0,0.3941439);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9020678);
   mainFit1022->SetParError(1,0.01302409);
