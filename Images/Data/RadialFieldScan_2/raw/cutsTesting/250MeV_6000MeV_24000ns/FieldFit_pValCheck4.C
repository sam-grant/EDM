...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.41406);
   Graph_Graph01033->SetMaximum(55.47011);
   ...
   mainFit1034->SetChisquare(5.680974);
   ...
   mainFit1034->SetParameter(0,-1.398076);
   mainFit1034->SetParError(0,0.4940775);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9050513);
   mainFit1034->SetParError(1,0.01628919);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.0163");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.494");
   pt_LaTex = pt->AddText("#minus1.54#pm0.534");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.544748,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.544748,-57.41406,1.544748,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.680974);
   ...
   mainFit1035->SetParameter(0,-1.398076);
   mainFit1035->SetParError(0,0.4940775);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9050513);
   mainFit1035->SetParError(1,0.01628919);
