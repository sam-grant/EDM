...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.52459,75,69.58064);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.41406);
   Graph_Graph01027->SetMaximum(55.47011);
   ...
   mainFit1028->SetChisquare(0.6327463);
   ...
   mainFit1028->SetParameter(0,-0.8576514);
   mainFit1028->SetParError(0,0.4412043);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9167444);
   mainFit1028->SetParError(1,0.01454393);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.211");
   pt_LaTex = pt->AddText("0.917#pm0.0145");
   pt_LaTex = pt->AddText("#minus0.858#pm0.441");
   pt_LaTex = pt->AddText("#minus0.936#pm0.483");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9355403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9355403,-57.41406,0.9355403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6327463);
   ...
   mainFit1029->SetParameter(0,-0.8576514);
   mainFit1029->SetParError(0,0.4412043);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9167444);
   mainFit1029->SetParError(1,0.01454393);
