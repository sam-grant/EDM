...
//=========  (Wed Apr 21 13:43:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0147897);
   Graph_Graph11015->SetMaximum(0.014018);
   ...
   Graph_Graph21016->SetMinimum(-0.01081446);
   Graph_Graph21016->SetMaximum(0.01272548);
   ...
   Graph_Graph31017->SetMinimum(-0.03039569);
   Graph_Graph31017->SetMaximum(0.02868399);
   ...
   Graph_Graph41018->SetMinimum(-0.00405543);
   Graph_Graph41018->SetMaximum(0.006771727);
   ...
   Graph_Graph51019->SetMinimum(-0.003594451);
   Graph_Graph51019->SetMaximum(0.004804355);
