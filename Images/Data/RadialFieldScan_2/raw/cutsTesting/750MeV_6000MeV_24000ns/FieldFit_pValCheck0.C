...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.30908,50,41.29759);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.84841);
   Graph_Graph01025->SetMaximum(30.83693);
   ...
   mainFit1026->SetChisquare(1.765459);
   ...
   mainFit1026->SetParameter(0,-1.359097);
   mainFit1026->SetParError(0,0.4673197);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8318498);
   mainFit1026->SetParError(1,0.01850743);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.588");
   pt_LaTex = pt->AddText("0.832#pm0.0185");
   pt_LaTex = pt->AddText("#minus1.36#pm0.467");
   pt_LaTex = pt->AddText("#minus1.63#pm0.567");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.633825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.633825,-52.84841,1.633825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.765459);
   ...
   mainFit1027->SetParameter(0,-1.359097);
   mainFit1027->SetParError(0,0.4673197);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8318498);
   mainFit1027->SetParError(1,0.01850743);
