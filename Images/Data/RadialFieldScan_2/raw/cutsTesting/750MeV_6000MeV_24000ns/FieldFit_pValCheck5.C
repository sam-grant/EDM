...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.54403,70,62.50312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.73931);
   Graph_Graph01035->SetMaximum(51.69841);
   ...
   mainFit1036->SetChisquare(6.257368);
   ...
   mainFit1036->SetParameter(0,-0.9748897);
   mainFit1036->SetParError(0,0.453794);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8570141);
   mainFit1036->SetParError(1,0.01545268);
   ...
   pt_LaTex = pt->AddText("#minus0.975#pm0.454");
   pt_LaTex = pt->AddText("#minus1.14#pm0.524");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.137542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.137542,-34.73931,1.137542,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.257368);
   ...
   mainFit1037->SetParameter(0,-0.9748897);
   mainFit1037->SetParError(0,0.453794);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8570141);
   mainFit1037->SetParError(1,0.01545268);
