...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.91162);
   Graph_Graph01031->SetMaximum(53.53225);
   ...
   mainFit1032->SetChisquare(5.972567);
   ...
   mainFit1032->SetParameter(0,-1.113294);
   mainFit1032->SetParError(0,0.4976926);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8593614);
   mainFit1032->SetParError(1,0.01461203);
   ...
   pt_LaTex = pt->AddText("0.859#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.11#pm0.498");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.29549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.29549,-54.91162,1.29549,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.972567);
   ...
   mainFit1033->SetParameter(0,-1.113294);
   mainFit1033->SetParError(0,0.4976926);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8593614);
   mainFit1033->SetParError(1,0.01461203);
