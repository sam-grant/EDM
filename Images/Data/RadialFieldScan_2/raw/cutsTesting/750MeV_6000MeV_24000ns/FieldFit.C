...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.91162);
   Graph_Graph01020->SetMaximum(53.53225);
   ...
   mainFit1021->SetChisquare(6.259236);
   ...
   mainFit1021->SetParameter(0,-0.980906);
   mainFit1021->SetParError(0,0.4319254);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8572884);
   mainFit1021->SetParError(1,0.01408975);
   ...
   pt_LaTex = pt->AddText("0.857#pm0.0141");
   pt_LaTex = pt->AddText("#minus0.981#pm0.432");
   pt_LaTex = pt->AddText("#minus1.14#pm0.501");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.144196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.144196,-54.91162,1.144196,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.259236);
   ...
   mainFit1022->SetParameter(0,-0.980906);
   mainFit1022->SetParError(0,0.4319254);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8572884);
   mainFit1022->SetParError(1,0.01408975);
