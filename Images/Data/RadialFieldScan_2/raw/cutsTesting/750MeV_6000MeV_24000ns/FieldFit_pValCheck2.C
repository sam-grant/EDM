...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.91162);
   Graph_Graph01029->SetMaximum(53.53225);
   ...
   mainFit1030->SetChisquare(6.22875);
   ...
   mainFit1030->SetParameter(0,-1.012594);
   mainFit1030->SetParError(0,0.4685586);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8571241);
   mainFit1030->SetParError(1,0.01411886);
   ...
   pt_LaTex = pt->AddText("#minus1.01#pm0.469");
   pt_LaTex = pt->AddText("#minus1.18#pm0.544");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.181385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.181385,-54.91162,1.181385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.22875);
   ...
   mainFit1031->SetParameter(0,-1.012594);
   mainFit1031->SetParError(0,0.4685586);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8571241);
   mainFit1031->SetParError(1,0.01411886);
