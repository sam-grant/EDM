...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0142435);
   Graph_Graph11015->SetMaximum(0.01607133);
   ...
   Graph_Graph21016->SetMinimum(-0.01259662);
   Graph_Graph21016->SetMaximum(0.01483694);
   ...
   Graph_Graph31017->SetMinimum(-0.04030986);
   Graph_Graph31017->SetMaximum(0.02925011);
   ...
   Graph_Graph41018->SetMinimum(-0.01150172);
   Graph_Graph41018->SetMaximum(0.01791734);
   ...
   Graph_Graph51019->SetMinimum(-0.007654863);
   Graph_Graph51019->SetMaximum(0.01023287);
