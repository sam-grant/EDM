...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.91162);
   Graph_Graph01023->SetMaximum(53.53225);
   ...
   mainFit1024->SetChisquare(6.259236);
   ...
   mainFit1024->SetParameter(0,-0.980906);
   mainFit1024->SetParError(0,0.4319254);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8572884);
   mainFit1024->SetParError(1,0.01408975);
   ...
   mainFit1025->SetChisquare(6.259236);
   ...
   mainFit1025->SetParameter(0,-0.980906);
   mainFit1025->SetParError(0,0.4319254);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8572884);
   mainFit1025->SetParError(1,0.01408975);
