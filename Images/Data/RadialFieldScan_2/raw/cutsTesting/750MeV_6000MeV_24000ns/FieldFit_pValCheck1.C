...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-68.46711,75,67.08774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-54.91162);
   Graph_Graph01027->SetMaximum(53.53225);
   ...
   mainFit1028->SetChisquare(0.3045892);
   ...
   mainFit1028->SetParameter(0,-0.4707625);
   mainFit1028->SetParError(0,0.4798586);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8734177);
   mainFit1028->SetParError(1,0.01556311);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.102");
   pt_LaTex = pt->AddText("0.873#pm0.0156");
   pt_LaTex = pt->AddText("#minus0.471#pm 0.48");
   pt_LaTex = pt->AddText("#minus0.539#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5389889,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5389889,-54.91162,0.5389889,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3045892);
   ...
   mainFit1029->SetParameter(0,-0.4707625);
   mainFit1029->SetParError(0,0.4798586);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8734177);
   mainFit1029->SetParError(1,0.01556311);
