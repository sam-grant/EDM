...
//=========  (Wed Apr 21 13:51:07 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7451555);
   ...
   quadLineFit1002->SetParameter(0,74.62142);
   quadLineFit1002->SetParError(0,0.06290613);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.44092);
   quadLineFit1002->SetParError(1,1.054341);
   ...
   quadLineFit1003->SetChisquare(0.7451555);
   ...
   quadLineFit1003->SetParameter(0,74.62142);
   quadLineFit1003->SetParError(0,0.06290613);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.44092);
   quadLineFit1003->SetParError(1,1.054341);
   ...
   Graph_30_ppm1003->SetMinimum(75.8391);
   Graph_30_ppm1003->SetMaximum(76.41556);
   ...
   quadLineFit1004->SetChisquare(1.773349);
   ...
   quadLineFit1004->SetParameter(0,74.71592);
   quadLineFit1004->SetParError(0,0.05563333);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.94875);
   quadLineFit1004->SetParError(1,0.9143958);
   ...
   quadLineFit1005->SetChisquare(1.773349);
   ...
   quadLineFit1005->SetParameter(0,74.71592);
   quadLineFit1005->SetParError(0,0.05563333);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.94875);
   quadLineFit1005->SetParError(1,0.9143958);
   ...
   Graph_10_ppm1005->SetMinimum(74.88491);
   Graph_10_ppm1005->SetMaximum(75.115);
   ...
   quadLineFit1006->SetChisquare(1.764161);
   ...
   quadLineFit1006->SetParameter(0,74.51268);
   quadLineFit1006->SetParError(0,0.06518209);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.760657);
   quadLineFit1006->SetParError(1,1.057118);
   ...
   quadLineFit1007->SetChisquare(1.764161);
   ...
   quadLineFit1007->SetParameter(0,74.51268);
   quadLineFit1007->SetParError(0,0.06518209);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.760657);
   quadLineFit1007->SetParError(1,1.057118);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.71926);
   Graph_mI10_ppm1007->SetMaximum(74.0072);
   ...
   quadLineFit1008->SetChisquare(10.51872);
   ...
   quadLineFit1008->SetParameter(0,74.41194);
   quadLineFit1008->SetParError(0,0.05722624);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.125787);
   quadLineFit1008->SetParError(1,0.9314637);
   ...
   quadLineFit1009->SetChisquare(10.51872);
   ...
   quadLineFit1009->SetParameter(0,74.41194);
   quadLineFit1009->SetParError(0,0.05722624);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.125787);
   quadLineFit1009->SetParError(1,0.9314637);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.37416);
   Graph_mI30_ppm1009->SetMaximum(73.05015);
   ...
   quadLineFit1010->SetChisquare(2.599838);
   ...
   quadLineFit1010->SetParameter(0,74.35646);
   quadLineFit1010->SetParError(0,0.05412393);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.59947);
   quadLineFit1010->SetParError(1,0.9366983);
   ...
   quadLineFit1011->SetChisquare(2.599838);
   ...
   quadLineFit1011->SetParameter(0,74.35646);
   quadLineFit1011->SetParError(0,0.05412393);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.59947);
   quadLineFit1011->SetParError(1,0.9366983);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.46613);
   Graph_mI50_ppm1011->SetMaximum(72.0937);
   ...
   quadLineFit1012->SetChisquare(0.7460829);
   ...
   quadLineFit1012->SetParameter(0,74.28591);
   quadLineFit1012->SetParError(0,0.1092139);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.92051);
   quadLineFit1012->SetParError(1,1.954125);
   ...
   quadLineFit1013->SetChisquare(0.7460829);
   ...
   quadLineFit1013->SetParameter(0,74.28591);
   quadLineFit1013->SetParError(0,0.1092139);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.92051);
   quadLineFit1013->SetParError(1,1.954125);
