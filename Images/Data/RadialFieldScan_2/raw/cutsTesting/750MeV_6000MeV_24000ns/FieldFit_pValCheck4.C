...
//=========  (Wed Apr 21 13:51:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.91162);
   Graph_Graph01033->SetMaximum(53.53225);
   ...
   mainFit1034->SetChisquare(6.236756);
   ...
   mainFit1034->SetParameter(0,-1.030289);
   mainFit1034->SetParError(0,0.5431715);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8588754);
   mainFit1034->SetParError(1,0.01762252);
   ...
   pt_LaTex = pt->AddText("0.859#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.03#pm0.543");
   pt_LaTex = pt->AddText(" #minus1.2#pm0.621");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.199579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.199579,-54.91162,1.199579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.236756);
   ...
   mainFit1035->SetParameter(0,-1.030289);
   mainFit1035->SetParError(0,0.5431715);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8588754);
   mainFit1035->SetParError(1,0.01762252);
