...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.99608);
   Graph_Graph01023->SetMaximum(56.66695);
   ...
   mainFit1024->SetChisquare(6.283665);
   ...
   mainFit1024->SetParameter(0,-2.224551);
   mainFit1024->SetParError(0,0.4405398);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9265771);
   mainFit1024->SetParError(1,0.01455638);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0146");
   pt_LaTex = pt->AddText("#minus2.22#pm0.441");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.400826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.400826,-60.99608,2.400826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.283665);
   ...
   mainFit1025->SetParameter(0,-2.224551);
   mainFit1025->SetParError(0,0.4405398);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9265771);
   mainFit1025->SetParError(1,0.01455638);
