...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.99608);
   Graph_Graph01031->SetMaximum(56.66695);
   ...
   mainFit1032->SetChisquare(6.282138);
   ...
   mainFit1032->SetParameter(0,-2.234395);
   mainFit1032->SetParError(0,0.5073573);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9267334);
   mainFit1032->SetParError(1,0.01506626);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0151");
   pt_LaTex = pt->AddText("#minus2.23#pm0.507");
   pt_LaTex = pt->AddText("#minus2.41#pm0.538");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.411044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.411044,-60.99608,2.411044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.282138);
   ...
   mainFit1033->SetParameter(0,-2.234395);
   mainFit1033->SetParError(0,0.5073573);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9267334);
   mainFit1033->SetParError(1,0.01506626);
