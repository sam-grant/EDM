...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.70396,75,71.37483);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.99608);
   Graph_Graph01027->SetMaximum(56.66695);
   ...
   mainFit1028->SetChisquare(0.4430644);
   ...
   mainFit1028->SetParameter(0,-1.68925);
   mainFit1028->SetParError(0,0.4930918);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.944055);
   mainFit1028->SetParError(1,0.01625325);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.148");
   pt_LaTex = pt->AddText("0.944#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.69#pm0.493");
   pt_LaTex = pt->AddText("#minus1.79#pm0.525");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.789356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.789356,-60.99608,1.789356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4430644);
   ...
   mainFit1029->SetParameter(0,-1.68925);
   mainFit1029->SetParError(0,0.4930918);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.944055);
   mainFit1029->SetParError(1,0.01625325);
