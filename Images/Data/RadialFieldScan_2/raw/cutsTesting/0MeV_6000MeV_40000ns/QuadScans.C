...
//=========  (Wed Apr 21 15:24:01 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.549318);
   ...
   quadLineFit1002->SetParameter(0,74.42164);
   quadLineFit1002->SetParError(0,0.06704854);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.73714);
   quadLineFit1002->SetParError(1,1.12456);
   ...
   quadLineFit1003->SetChisquare(1.549318);
   ...
   quadLineFit1003->SetParameter(0,74.42164);
   quadLineFit1003->SetParError(0,0.06704854);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.73714);
   quadLineFit1003->SetParError(1,1.12456);
   ...
   Graph_30_ppm1003->SetMinimum(75.73862);
   Graph_30_ppm1003->SetMaximum(76.3461);
   ...
   quadLineFit1004->SetChisquare(0.0983166);
   ...
   quadLineFit1004->SetParameter(0,74.58117);
   quadLineFit1004->SetParError(0,0.05654216);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.79535);
   quadLineFit1004->SetParError(1,0.9292146);
   ...
   quadLineFit1005->SetChisquare(0.0983166);
   ...
   quadLineFit1005->SetParameter(0,74.58117);
   quadLineFit1005->SetParError(0,0.05654216);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.79535);
   quadLineFit1005->SetParError(1,0.9292146);
   ...
   Graph_10_ppm1005->SetMaximum(74.96873);
   ...
   quadLineFit1006->SetChisquare(0.06223049);
   ...
   quadLineFit1006->SetParameter(0,74.39511);
   quadLineFit1006->SetParError(0,0.06622658);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.509436);
   quadLineFit1006->SetParError(1,1.074003);
   ...
   quadLineFit1007->SetChisquare(0.06223049);
   ...
   quadLineFit1007->SetParameter(0,74.39511);
   quadLineFit1007->SetParError(0,0.06622658);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.509436);
   quadLineFit1007->SetParError(1,1.074003);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50467);
   Graph_mI10_ppm1007->SetMaximum(73.83137);
   ...
   quadLineFit1008->SetChisquare(2.015688);
   ...
   quadLineFit1008->SetParameter(0,74.3603);
   quadLineFit1008->SetParError(0,0.05816236);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.45864);
   quadLineFit1008->SetParError(1,0.9466105);
   ...
   quadLineFit1009->SetChisquare(2.015688);
   ...
   quadLineFit1009->SetParameter(0,74.3603);
   quadLineFit1009->SetParError(0,0.05816236);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.45864);
   quadLineFit1009->SetParError(1,0.9466105);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.11006);
   Graph_mI30_ppm1009->SetMaximum(72.85334);
   ...
   quadLineFit1010->SetChisquare(1.697524);
   ...
   quadLineFit1010->SetParameter(0,74.3041);
   quadLineFit1010->SetParError(0,0.05494006);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.5779);
   quadLineFit1010->SetParError(1,0.9507913);
   ...
   quadLineFit1011->SetChisquare(1.697524);
   ...
   quadLineFit1011->SetParameter(0,74.3041);
   quadLineFit1011->SetParError(0,0.05494006);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.5779);
   quadLineFit1011->SetParError(1,0.9507913);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.18535);
   Graph_mI50_ppm1011->SetMaximum(71.88554);
   ...
   quadLineFit1012->SetChisquare(0.03148507);
   ...
   quadLineFit1012->SetParameter(0,74.33499);
   quadLineFit1012->SetParError(0,0.1110198);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.20433);
   quadLineFit1012->SetParError(1,1.986491);
   ...
   quadLineFit1013->SetChisquare(0.03148507);
   ...
   quadLineFit1013->SetParameter(0,74.33499);
   quadLineFit1013->SetParError(0,0.1110198);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.20433);
   quadLineFit1013->SetParError(1,1.986491);
