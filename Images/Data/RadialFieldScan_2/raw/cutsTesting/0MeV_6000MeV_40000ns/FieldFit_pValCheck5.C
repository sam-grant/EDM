...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.87628,70,66.20929);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.26773);
   Graph_Graph01035->SetMaximum(54.60073);
   ...
   mainFit1036->SetChisquare(6.147895);
   ...
   mainFit1036->SetParameter(0,-2.173234);
   mainFit1036->SetParError(0,0.4620401);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9241543);
   mainFit1036->SetParError(1,0.01597756);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.016");
   pt_LaTex = pt->AddText("#minus2.17#pm0.462");
   pt_LaTex = pt->AddText("#minus2.35#pm0.491");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.351592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.351592,-38.26773,2.351592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.147895);
   ...
   mainFit1037->SetParameter(0,-2.173234);
   mainFit1037->SetParError(0,0.4620401);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9241543);
   mainFit1037->SetParError(1,0.01597756);
