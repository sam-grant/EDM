...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.99608);
   Graph_Graph01029->SetMaximum(56.66695);
   ...
   mainFit1030->SetChisquare(6.055095);
   ...
   mainFit1030->SetParameter(0,-2.314242);
   mainFit1030->SetParError(0,0.4788113);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9260541);
   mainFit1030->SetParError(1,0.01459812);
   ...
   pt_LaTex = pt->AddText("#minus2.31#pm0.479");
   pt_LaTex = pt->AddText(" #minus2.5#pm0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.499036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.499036,-60.99608,2.499036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.055095);
   ...
   mainFit1031->SetParameter(0,-2.314242);
   mainFit1031->SetParError(0,0.4788113);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9260541);
   mainFit1031->SetParError(1,0.01459812);
