...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.99608);
   Graph_Graph01033->SetMaximum(56.66695);
   ...
   mainFit1034->SetChisquare(5.851992);
   ...
   mainFit1034->SetParameter(0,-2.443485);
   mainFit1034->SetParError(0,0.5523587);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9337696);
   mainFit1034->SetParError(1,0.0182093);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0182");
   pt_LaTex = pt->AddText("#minus2.44#pm0.552");
   pt_LaTex = pt->AddText("#minus2.62#pm 0.57");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.616796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.616796,-60.99608,2.616796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.851992);
   ...
   mainFit1035->SetParameter(0,-2.443485);
   mainFit1035->SetParError(0,0.5523587);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9337696);
   mainFit1035->SetParError(1,0.0182093);
