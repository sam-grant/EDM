...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.99608);
   Graph_Graph01020->SetMaximum(56.66695);
   ...
   mainFit1021->SetChisquare(6.283665);
   ...
   mainFit1021->SetParameter(0,-2.224551);
   mainFit1021->SetParError(0,0.4405398);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9265771);
   mainFit1021->SetParError(1,0.01455638);
   ...
   mainFit1022->SetChisquare(6.283665);
   ...
   mainFit1022->SetParameter(0,-2.224551);
   mainFit1022->SetParError(0,0.4405398);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9265771);
   mainFit1022->SetParError(1,0.01455638);
