...
//=========  (Wed Apr 21 15:24:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003045303);
   Graph_Graph11015->SetMaximum(0.003951984);
   ...
   Graph_Graph21016->SetMinimum(-0.002405401);
   Graph_Graph21016->SetMaximum(0.002828268);
   ...
   Graph_Graph31017->SetMinimum(-0.01724706);
   Graph_Graph31017->SetMaximum(0.01836069);
   ...
   Graph_Graph41018->SetMinimum(-0.008531955);
   Graph_Graph41018->SetMaximum(0.01641748);
   ...
   Graph_Graph51019->SetMinimum(-0.002134712);
   Graph_Graph51019->SetMaximum(0.001597205);
