...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-81.15393);
   Graph_Graph01027->SetMaximum(64.12309);
   ...
   mainFit1028->SetChisquare(8.292298);
   ...
   mainFit1028->SetParameter(0,-3.73831);
   mainFit1028->SetParError(0,1.472514);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.045522);
   mainFit1028->SetParError(1,0.0485492);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.76");
   pt_LaTex = pt->AddText(" 1.05#pm0.0485");
   pt_LaTex = pt->AddText("#minus3.74#pm 1.47");
   pt_LaTex = pt->AddText("#minus3.58#pm 1.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.575545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.575545,-81.15393,3.575545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(8.292298);
   ...
   mainFit1029->SetParameter(0,-3.73831);
   mainFit1029->SetParError(0,1.472514);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.045522);
   mainFit1029->SetParError(1,0.0485492);
