...
//=========  (Wed Apr 21 18:33:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08574625);
   Graph_Graph11015->SetMaximum(0.03048677);
   ...
   Graph_Graph21016->SetMinimum(-0.03890351);
   Graph_Graph21016->SetMaximum(0.04563967);
   ...
   Graph_Graph31017->SetMinimum(-0.1545688);
   Graph_Graph31017->SetMaximum(0.1366923);
   ...
   Graph_Graph41018->SetMinimum(-0.0271318);
   Graph_Graph41018->SetMaximum(0.0234386);
   ...
   Graph_Graph51019->SetMinimum(-0.01515542);
   Graph_Graph51019->SetMaximum(0.02007756);
