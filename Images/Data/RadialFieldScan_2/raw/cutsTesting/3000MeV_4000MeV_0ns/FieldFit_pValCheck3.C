...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-81.15393);
   Graph_Graph01031->SetMaximum(64.12309);
   ...
   mainFit1032->SetChisquare(3.370549);
   ...
   mainFit1032->SetParameter(0,-6.806974);
   mainFit1032->SetParError(0,1.513373);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.043004);
   mainFit1032->SetParError(1,0.04493552);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0449");
   pt_LaTex = pt->AddText("#minus6.81#pm 1.51");
   pt_LaTex = pt->AddText("#minus6.53#pm  1.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,6.526313,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(6.526313,-81.15393,6.526313,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.370549);
   ...
   mainFit1033->SetParameter(0,-6.806974);
   mainFit1033->SetParError(0,1.513373);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.043004);
   mainFit1033->SetParError(1,0.04493552);
