...
//=========  (Wed Apr 21 18:33:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-81.15393);
   Graph_Graph01020->SetMaximum(64.12309);
   ...
   mainFit1021->SetChisquare(10.7146);
   ...
   mainFit1021->SetParameter(0,-4.77255);
   mainFit1021->SetParError(0,1.314033);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.011747);
   mainFit1021->SetParError(1,0.04342744);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.68");
   pt_LaTex = pt->AddText(" 1.01#pm0.0434");
   pt_LaTex = pt->AddText("#minus4.77#pm 1.31");
   pt_LaTex = pt->AddText("#minus4.72#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.717138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.717138,-81.15393,4.717138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(10.7146);
   ...
   mainFit1022->SetParameter(0,-4.77255);
   mainFit1022->SetParError(0,1.314033);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.011747);
   mainFit1022->SetParError(1,0.04342744);
