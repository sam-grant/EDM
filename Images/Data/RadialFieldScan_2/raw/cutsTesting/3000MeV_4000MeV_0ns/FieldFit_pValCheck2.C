...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-81.15393);
   Graph_Graph01029->SetMaximum(64.12309);
   ...
   mainFit1030->SetChisquare(9.1225);
   ...
   mainFit1030->SetParameter(0,-4.069263);
   mainFit1030->SetParError(0,1.427358);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.015948);
   mainFit1030->SetParError(1,0.04355488);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0436");
   pt_LaTex = pt->AddText("#minus4.07#pm 1.43");
   pt_LaTex = pt->AddText("#minus4.01#pm  1.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.005386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.005386,-81.15393,4.005386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(9.1225);
   ...
   mainFit1031->SetParameter(0,-4.069263);
   mainFit1031->SetParError(0,1.427358);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.015948);
   mainFit1031->SetParError(1,0.04355488);
