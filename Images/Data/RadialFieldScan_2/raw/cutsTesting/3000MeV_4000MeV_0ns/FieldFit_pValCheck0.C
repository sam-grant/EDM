...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-92.5452,50,48.44095);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-78.44659);
   Graph_Graph01025->SetMaximum(34.34233);
   ...
   mainFit1026->SetChisquare(9.328918);
   ...
   mainFit1026->SetParameter(0,-5.394346);
   mainFit1026->SetParError(0,1.416228);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9701029);
   mainFit1026->SetParError(1,0.05601323);
   ...
   pt_LaTex = pt->AddText(" 0.97#pm0.056");
   pt_LaTex = pt->AddText("#minus5.39#pm 1.42");
   pt_LaTex = pt->AddText("#minus5.56#pm 1.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,5.560591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.560591,-78.44659,5.560591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.328918);
   ...
   mainFit1027->SetParameter(0,-5.394346);
   mainFit1027->SetParError(0,1.416228);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9701029);
   mainFit1027->SetParError(1,0.05601323);
