...
//=========  (Wed Apr 21 18:33:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3003577);
   ...
   quadLineFit1002->SetParameter(0,75.21214);
   quadLineFit1002->SetParError(0,0.2009081);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,48.65007);
   quadLineFit1002->SetParError(1,3.366601);
   ...
   quadLineFit1003->SetChisquare(0.3003577);
   ...
   quadLineFit1003->SetParameter(0,75.21214);
   quadLineFit1003->SetParError(0,0.2009081);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,48.65007);
   quadLineFit1003->SetParError(1,3.366601);
   ...
   Graph_30_ppm1003->SetMinimum(76.69469);
   Graph_30_ppm1003->SetMaximum(77.35669);
   ...
   quadLineFit1004->SetChisquare(2.212853);
   ...
   quadLineFit1004->SetParameter(0,75.66126);
   quadLineFit1004->SetParError(0,0.1685508);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.17447);
   quadLineFit1004->SetParError(1,2.768792);
   ...
   quadLineFit1005->SetChisquare(2.212853);
   ...
   quadLineFit1005->SetParameter(0,75.66126);
   quadLineFit1005->SetParError(0,0.1685508);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.17447);
   quadLineFit1005->SetParError(1,2.768792);
   ...
   Graph_10_ppm1005->SetMinimum(75.66025);
   Graph_10_ppm1005->SetMaximum(75.86148);
   ...
   quadLineFit1006->SetChisquare(1.830182);
   ...
   quadLineFit1006->SetParameter(0,75.63963);
   quadLineFit1006->SetParError(0,0.1984684);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,1.6418);
   quadLineFit1006->SetParError(1,3.216634);
   ...
   quadLineFit1007->SetChisquare(1.830182);
   ...
   quadLineFit1007->SetParameter(0,75.63963);
   quadLineFit1007->SetParError(0,0.1984684);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,1.6418);
   quadLineFit1007->SetParError(1,3.216634);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.40062);
   Graph_mI10_ppm1007->SetMaximum(74.84311);
   ...
   quadLineFit1008->SetChisquare(15.67243);
   ...
   quadLineFit1008->SetParameter(0,75.07286);
   quadLineFit1008->SetParError(0,0.1734189);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.329069);
   quadLineFit1008->SetParError(1,2.821063);
   ...
   quadLineFit1009->SetChisquare(15.67243);
   ...
   quadLineFit1009->SetParameter(0,75.07286);
   quadLineFit1009->SetParError(0,0.1734189);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.329069);
   quadLineFit1009->SetParError(1,2.821063);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.78137);
   Graph_mI30_ppm1009->SetMaximum(73.73253);
   ...
   quadLineFit1010->SetChisquare(0.7430234);
   ...
   quadLineFit1010->SetParameter(0,75.42959);
   quadLineFit1010->SetParError(0,0.1638676);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-35.5188);
   quadLineFit1010->SetParError(1,2.833599);
   ...
   quadLineFit1011->SetChisquare(0.7430234);
   ...
   quadLineFit1011->SetParameter(0,75.42959);
   quadLineFit1011->SetParError(0,0.1638676);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-35.5188);
   quadLineFit1011->SetParError(1,2.833599);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.84359);
   Graph_mI50_ppm1011->SetMaximum(72.80391);
   ...
   quadLineFit1012->SetChisquare(0.3144237);
   ...
   quadLineFit1012->SetParameter(0,75.93176);
   quadLineFit1012->SetParError(0,0.3301115);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-63.14447);
   quadLineFit1012->SetParError(1,5.903039);
   ...
   quadLineFit1013->SetChisquare(0.3144237);
   ...
   quadLineFit1013->SetParameter(0,75.93176);
   quadLineFit1013->SetParError(0,0.3301115);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-63.14447);
   quadLineFit1013->SetParError(1,5.903039);
