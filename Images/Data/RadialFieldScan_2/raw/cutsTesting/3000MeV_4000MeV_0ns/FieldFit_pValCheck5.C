...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-60.94467,70,74.60894);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-47.38931);
   Graph_Graph01035->SetMaximum(61.05357);
   ...
   mainFit1036->SetChisquare(8.510617);
   ...
   mainFit1036->SetParameter(0,-4.155033);
   mainFit1036->SetParError(0,1.378296);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9824763);
   mainFit1036->SetParError(1,0.04769362);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.84");
   pt_LaTex = pt->AddText("0.982#pm0.0477");
   pt_LaTex = pt->AddText("#minus4.16#pm 1.38");
   pt_LaTex = pt->AddText("#minus4.23#pm 1.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,4.229144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.229144,-47.38931,4.229144,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(8.510617);
   ...
   mainFit1037->SetParameter(0,-4.155033);
   mainFit1037->SetParError(0,1.378296);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9824763);
   mainFit1037->SetParError(1,0.04769362);
