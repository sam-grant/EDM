...
//=========  (Wed Apr 21 18:33:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-81.15393);
   Graph_Graph01023->SetMaximum(64.12309);
   ...
   mainFit1024->SetChisquare(10.7146);
   ...
   mainFit1024->SetParameter(0,-4.77255);
   mainFit1024->SetParError(0,1.314033);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.011747);
   mainFit1024->SetParError(1,0.04342744);
   ...
   mainFit1025->SetChisquare(10.7146);
   ...
   mainFit1025->SetParameter(0,-4.77255);
   mainFit1025->SetParError(0,1.314033);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.011747);
   mainFit1025->SetParError(1,0.04342744);
