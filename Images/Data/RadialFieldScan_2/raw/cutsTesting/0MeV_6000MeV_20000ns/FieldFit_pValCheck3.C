...
//=========  (Wed Apr 21 15:16:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.21);
   Graph_Graph01031->SetMaximum(55.86863);
   ...
   mainFit1032->SetChisquare(3.146326);
   ...
   mainFit1032->SetParameter(0,-1.809658);
   mainFit1032->SetParError(0,0.4194125);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9257361);
   mainFit1032->SetParError(1,0.01258118);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.81#pm0.419");
   pt_LaTex = pt->AddText("#minus1.95#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.954831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.954831,-60.21,1.954831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.146326);
   ...
   mainFit1033->SetParameter(0,-1.809658);
   mainFit1033->SetParError(0,0.4194125);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9257361);
   mainFit1033->SetParError(1,0.01258118);
