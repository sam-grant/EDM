...
//=========  (Wed Apr 21 15:16:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-74.71983,75,70.37846);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.21);
   Graph_Graph01027->SetMaximum(55.86863);
   ...
   mainFit1028->SetChisquare(0.8688636);
   ...
   mainFit1028->SetParameter(0,-1.606657);
   mainFit1028->SetParError(0,0.4107409);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9372502);
   mainFit1028->SetParError(1,0.01373913);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.29");
   pt_LaTex = pt->AddText("0.937#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.61#pm0.411");
   pt_LaTex = pt->AddText("#minus1.71#pm0.441");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.714224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.714224,-60.21,1.714224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8688636);
   ...
   mainFit1029->SetParameter(0,-1.606657);
   mainFit1029->SetParError(0,0.4107409);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9372502);
   mainFit1029->SetParError(1,0.01373913);
