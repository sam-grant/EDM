...
//=========  (Wed Apr 21 15:16:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.21);
   Graph_Graph01033->SetMaximum(55.86863);
   ...
   mainFit1034->SetChisquare(2.885094);
   ...
   mainFit1034->SetParameter(0,-2.09481);
   mainFit1034->SetParError(0,0.4552649);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9335238);
   mainFit1034->SetParError(1,0.01522779);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0152");
   pt_LaTex = pt->AddText("#minus2.09#pm0.455");
   pt_LaTex = pt->AddText("#minus2.24#pm0.472");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.243981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.243981,-60.21,2.243981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.885094);
   ...
   mainFit1035->SetParameter(0,-2.09481);
   mainFit1035->SetParError(0,0.4552649);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9335238);
   mainFit1035->SetParError(1,0.01522779);
