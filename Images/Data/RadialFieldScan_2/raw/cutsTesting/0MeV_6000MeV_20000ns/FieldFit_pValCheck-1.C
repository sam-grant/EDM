...
//=========  (Wed Apr 21 15:16:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.21);
   Graph_Graph01023->SetMaximum(55.86863);
   ...
   mainFit1024->SetChisquare(3.362152);
   ...
   mainFit1024->SetParameter(0,-1.90621);
   mainFit1024->SetParError(0,0.3642923);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9272056);
   mainFit1024->SetParError(1,0.01217601);
   ...
   mainFit1025->SetChisquare(3.362152);
   ...
   mainFit1025->SetParameter(0,-1.90621);
   mainFit1025->SetParError(0,0.3642923);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9272056);
   mainFit1025->SetParError(1,0.01217601);
