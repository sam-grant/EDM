...
//=========  (Wed Apr 21 15:16:02 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.20093,70,65.27467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.75337);
   Graph_Graph01035->SetMaximum(53.82711);
   ...
   mainFit1036->SetChisquare(3.170929);
   ...
   mainFit1036->SetParameter(0,-1.85665);
   mainFit1036->SetParError(0,0.3815181);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9247827);
   mainFit1036->SetParError(1,0.01337911);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.86#pm0.382");
   pt_LaTex = pt->AddText("#minus2.01#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.007661,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.007661,-37.75337,2.007661,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.170929);
   ...
   mainFit1037->SetParameter(0,-1.85665);
   mainFit1037->SetParError(0,0.3815181);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9247827);
   mainFit1037->SetParError(1,0.01337911);
