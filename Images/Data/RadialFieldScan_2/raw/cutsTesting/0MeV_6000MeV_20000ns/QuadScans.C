...
//=========  (Wed Apr 21 15:16:01 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.059888);
   ...
   quadLineFit1002->SetParameter(0,74.4728);
   quadLineFit1002->SetParError(0,0.05778382);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.22566);
   quadLineFit1002->SetParError(1,0.9697507);
   ...
   quadLineFit1003->SetChisquare(1.059888);
   ...
   quadLineFit1003->SetParameter(0,74.4728);
   quadLineFit1003->SetParError(0,0.05778382);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.22566);
   quadLineFit1003->SetParError(1,0.9697507);
   ...
   Graph_30_ppm1003->SetMinimum(75.73507);
   Graph_30_ppm1003->SetMaximum(76.36671);
   ...
   quadLineFit1004->SetChisquare(0.08029896);
   ...
   quadLineFit1004->SetParameter(0,74.52068);
   quadLineFit1004->SetParError(0,0.04660047);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.96454);
   quadLineFit1004->SetParError(1,0.7658073);
   ...
   quadLineFit1005->SetChisquare(0.08029896);
   ...
   quadLineFit1005->SetParameter(0,74.52068);
   quadLineFit1005->SetParError(0,0.04660047);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.96454);
   quadLineFit1005->SetParError(1,0.7658073);
   ...
   Graph_10_ppm1005->SetMinimum(74.7492);
   Graph_10_ppm1005->SetMaximum(74.97829);
   ...
   quadLineFit1006->SetChisquare(0.6973961);
   ...
   quadLineFit1006->SetParameter(0,74.36171);
   quadLineFit1006->SetParError(0,0.05457941);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.082143);
   quadLineFit1006->SetParError(1,0.8850515);
   ...
   quadLineFit1007->SetChisquare(0.6973961);
   ...
   quadLineFit1007->SetParameter(0,74.36171);
   quadLineFit1007->SetParError(0,0.05457941);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.082143);
   quadLineFit1007->SetParError(1,0.8850515);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50632);
   Graph_mI10_ppm1007->SetMaximum(73.82897);
   ...
   quadLineFit1008->SetChisquare(4.806876);
   ...
   quadLineFit1008->SetParameter(0,74.37013);
   quadLineFit1008->SetParError(0,0.04791092);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.48915);
   quadLineFit1008->SetParError(1,0.7797587);
   ...
   quadLineFit1009->SetChisquare(4.806876);
   ...
   quadLineFit1009->SetParameter(0,74.37013);
   quadLineFit1009->SetParError(0,0.04791092);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.48915);
   quadLineFit1009->SetParError(1,0.7797587);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12697);
   Graph_mI30_ppm1009->SetMaximum(72.86031);
   ...
   quadLineFit1010->SetChisquare(0.8699964);
   ...
   quadLineFit1010->SetParameter(0,74.29867);
   quadLineFit1010->SetParError(0,0.04525709);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.33843);
   quadLineFit1010->SetParError(1,0.7832311);
   ...
   quadLineFit1011->SetChisquare(0.8699964);
   ...
   quadLineFit1011->SetParameter(0,74.29867);
   quadLineFit1011->SetParError(0,0.04525709);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.33843);
   quadLineFit1011->SetParError(1,0.7832311);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20225);
   Graph_mI50_ppm1011->SetMaximum(71.89087);
   ...
   quadLineFit1012->SetChisquare(0.9111395);
   ...
   quadLineFit1012->SetParameter(0,74.33524);
   quadLineFit1012->SetParError(0,0.09139765);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.9014);
   quadLineFit1012->SetParError(1,1.635381);
   ...
   quadLineFit1013->SetChisquare(0.9111395);
   ...
   quadLineFit1013->SetParameter(0,74.33524);
   quadLineFit1013->SetParError(0,0.09139765);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.9014);
   quadLineFit1013->SetParError(1,1.635381);
