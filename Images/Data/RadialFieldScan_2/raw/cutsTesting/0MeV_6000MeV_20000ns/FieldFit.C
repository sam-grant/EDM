...
//=========  (Wed Apr 21 15:16:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.21);
   Graph_Graph01020->SetMaximum(55.86863);
   ...
   mainFit1021->SetChisquare(3.362152);
   ...
   mainFit1021->SetParameter(0,-1.90621);
   mainFit1021->SetParError(0,0.3642923);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9272056);
   mainFit1021->SetParError(1,0.01217601);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.841");
   pt_LaTex = pt->AddText("0.927#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.91#pm0.364");
   pt_LaTex = pt->AddText("#minus2.06#pm 0.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.055866,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.055866,-60.21,2.055866,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.362152);
   ...
   mainFit1022->SetParameter(0,-1.90621);
   mainFit1022->SetParError(0,0.3642923);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9272056);
   mainFit1022->SetParError(1,0.01217601);
