...
//=========  (Wed Apr 21 15:16:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.21);
   Graph_Graph01029->SetMaximum(55.86863);
   ...
   mainFit1030->SetChisquare(2.571019);
   ...
   mainFit1030->SetParameter(0,-2.045759);
   mainFit1030->SetParError(0,0.3966388);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9262732);
   mainFit1030->SetParError(1,0.01222123);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0122");
   pt_LaTex = pt->AddText("#minus2.05#pm0.397");
   pt_LaTex = pt->AddText("#minus2.21#pm0.426");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.208591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.208591,-60.21,2.208591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.571019);
   ...
   mainFit1031->SetParameter(0,-2.045759);
   mainFit1031->SetParError(0,0.3966388);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9262732);
   mainFit1031->SetParError(1,0.01222123);
