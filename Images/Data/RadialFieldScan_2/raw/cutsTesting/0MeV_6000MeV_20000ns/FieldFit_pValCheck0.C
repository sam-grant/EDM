...
//=========  (Wed Apr 21 15:16:01 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.60357,50,44.79713);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.1635);
   Graph_Graph01025->SetMaximum(33.35706);
   ...
   mainFit1026->SetChisquare(2.173487);
   ...
   mainFit1026->SetParameter(0,-2.061632);
   mainFit1026->SetParError(0,0.3911899);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9167674);
   mainFit1026->SetParError(1,0.01549029);
   ...
   pt_LaTex = pt->AddText("0.917#pm0.0155");
   pt_LaTex = pt->AddText("#minus2.06#pm0.391");
   pt_LaTex = pt->AddText("#minus2.25#pm0.433");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.248806,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.248806,-58.1635,2.248806,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.173487);
   ...
   mainFit1027->SetParameter(0,-2.061632);
   mainFit1027->SetParError(0,0.3911899);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9167674);
   mainFit1027->SetParError(1,0.01549029);
