...
//=========  (Wed Apr 21 15:16:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.001476529);
   Graph_Graph11015->SetMaximum(0.004641157);
   ...
   Graph_Graph21016->SetMinimum(-0.006636847);
   Graph_Graph21016->SetMaximum(0.00779464);
   ...
   Graph_Graph31017->SetMinimum(-0.0205784);
   Graph_Graph31017->SetMaximum(0.02067538);
   ...
   Graph_Graph41018->SetMinimum(-0.005421596);
   Graph_Graph41018->SetMaximum(0.009646922);
   ...
   Graph_Graph51019->SetMinimum(-0.007075192);
   Graph_Graph51019->SetMaximum(0.009455771);
