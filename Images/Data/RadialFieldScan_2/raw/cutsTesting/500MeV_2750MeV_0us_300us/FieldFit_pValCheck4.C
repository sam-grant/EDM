...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.19063);
   Graph_Graph01033->SetMaximum(56.37929);
   ...
   mainFit1034->SetChisquare(2.118259);
   ...
   mainFit1034->SetParameter(0,-1.520254);
   mainFit1034->SetParError(0,0.4433151);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9405836);
   mainFit1034->SetParError(1,0.01461292);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.52#pm0.443");
   pt_LaTex = pt->AddText("#minus1.62#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.616288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.616288,-59.19063,1.616288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.118259);
   ...
   mainFit1035->SetParameter(0,-1.520254);
   mainFit1035->SetParError(0,0.4433151);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9405836);
   mainFit1035->SetParError(1,0.01461292);
