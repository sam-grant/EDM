...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.19063);
   Graph_Graph01031->SetMaximum(56.37929);
   ...
   mainFit1032->SetChisquare(1.827434);
   ...
   mainFit1032->SetParameter(0,-1.465874);
   mainFit1032->SetParError(0,0.4071028);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.940876);
   mainFit1032->SetParError(1,0.01208838);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.47#pm0.407");
   pt_LaTex = pt->AddText("#minus1.56#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.557989,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.557989,-59.19063,1.557989,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.827434);
   ...
   mainFit1033->SetParameter(0,-1.465874);
   mainFit1033->SetParError(0,0.4071028);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.940876);
   mainFit1033->SetParError(1,0.01208838);
