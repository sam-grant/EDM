...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.19063);
   Graph_Graph01020->SetMaximum(56.37929);
   ...
   mainFit1021->SetChisquare(2.177402);
   ...
   mainFit1021->SetParameter(0,-1.585307);
   mainFit1021->SetParError(0,0.3535166);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9427192);
   mainFit1021->SetParError(1,0.01167995);
   ...
   pt_LaTex = pt->AddText("#minus1.59#pm0.354");
   pt_LaTex = pt->AddText("#minus1.68#pm0.372");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.681633,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.681633,-59.19063,1.681633,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.177402);
   ...
   mainFit1022->SetParameter(0,-1.585307);
   mainFit1022->SetParError(0,0.3535166);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9427192);
   mainFit1022->SetParError(1,0.01167995);
