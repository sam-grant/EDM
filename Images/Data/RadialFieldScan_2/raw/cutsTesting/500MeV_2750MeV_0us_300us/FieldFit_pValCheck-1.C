...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.19063);
   Graph_Graph01023->SetMaximum(56.37929);
   ...
   mainFit1024->SetChisquare(2.177402);
   ...
   mainFit1024->SetParameter(0,-1.585307);
   mainFit1024->SetParError(0,0.3535166);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9427192);
   mainFit1024->SetParError(1,0.01167995);
   ...
   mainFit1025->SetChisquare(2.177402);
   ...
   mainFit1025->SetParameter(0,-1.585307);
   mainFit1025->SetParError(0,0.3535166);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9427192);
   mainFit1025->SetParError(1,0.01167995);
