...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008356893);
   Graph_Graph11015->SetMaximum(0.007431099);
   ...
   Graph_Graph21016->SetMinimum(-0.014424);
   Graph_Graph21016->SetMaximum(0.01693438);
   ...
   Graph_Graph31017->SetMinimum(-0.01749823);
   Graph_Graph31017->SetMaximum(0.01264906);
   ...
   Graph_Graph41018->SetMinimum(-0.01104161);
   Graph_Graph41018->SetMaximum(0.01523643);
   ...
   Graph_Graph51019->SetMinimum(-0.00325767);
   Graph_Graph51019->SetMaximum(0.004343212);
