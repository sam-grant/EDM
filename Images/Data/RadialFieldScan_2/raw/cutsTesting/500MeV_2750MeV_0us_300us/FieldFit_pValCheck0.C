...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.67768,50,46.02956);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.20696);
   Graph_Graph01025->SetMaximum(34.55884);
   ...
   mainFit1026->SetChisquare(1.967916);
   ...
   mainFit1026->SetParameter(0,-1.650337);
   mainFit1026->SetParError(0,0.3809996);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9383506);
   mainFit1026->SetParError(1,0.01508392);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.65#pm0.381");
   pt_LaTex = pt->AddText("#minus1.76#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.758763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.758763,-57.20696,1.758763,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.967916);
   ...
   mainFit1027->SetParameter(0,-1.650337);
   mainFit1027->SetParError(0,0.3809996);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9383506);
   mainFit1027->SetParError(1,0.01508392);
