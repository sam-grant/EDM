...
//=========  (Wed Apr 28 14:09:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-50.13881,70,66.12592);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.51234);
   Graph_Graph01035->SetMaximum(54.49944);
   ...
   mainFit1036->SetChisquare(1.893262);
   ...
   mainFit1036->SetParameter(0,-1.644884);
   mainFit1036->SetParError(0,0.3707638);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9455367);
   mainFit1036->SetParError(1,0.01282026);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.64#pm0.371");
   pt_LaTex = pt->AddText("#minus1.74#pm0.387");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.73963,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.73963,-38.51234,1.73963,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.893262);
   ...
   mainFit1037->SetParameter(0,-1.644884);
   mainFit1037->SetParError(0,0.3707638);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9455367);
   mainFit1037->SetParError(1,0.01282026);
