...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.63687,75,70.82553);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-59.19063);
   Graph_Graph01029->SetMaximum(56.37929);
   ...
   mainFit1030->SetChisquare(0.9115018);
   ...
   mainFit1030->SetParameter(0,-1.754499);
   mainFit1030->SetParError(0,0.3841709);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9417223);
   mainFit1030->SetParError(1,0.01171349);
   ...
   pt_LaTex = pt->AddText("0.942#pm0.0117");
   pt_LaTex = pt->AddText("#minus1.75#pm0.384");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.863074,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.863074,-59.19063,1.863074,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9115018);
   ...
   mainFit1031->SetParameter(0,-1.754499);
   mainFit1031->SetParError(0,0.3841709);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9417223);
   mainFit1031->SetParError(1,0.01171349);
