...
//=========  (Wed Apr 28 14:09:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.19063);
   Graph_Graph01027->SetMaximum(56.37929);
   ...
   mainFit1028->SetChisquare(1.370079);
   ...
   mainFit1028->SetParameter(0,-1.425433);
   mainFit1028->SetParError(0,0.3957715);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9479363);
   mainFit1028->SetParError(1,0.01304393);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.457");
   pt_LaTex = pt->AddText("0.948#pm0.013");
   pt_LaTex = pt->AddText("#minus1.43#pm0.396");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.419");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.503722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.503722,-59.19063,1.503722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.370079);
   ...
   mainFit1029->SetParameter(0,-1.425433);
   mainFit1029->SetParError(0,0.3957715);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9479363);
   mainFit1029->SetParError(1,0.01304393);
