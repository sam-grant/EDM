...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.10285,50,45.82678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.90989);
   Graph_Graph01025->SetMaximum(34.63382);
   ...
   mainFit1026->SetChisquare(9.437238);
   ...
   mainFit1026->SetParameter(0,-1.806451);
   mainFit1026->SetParError(0,0.3484231);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9392017);
   mainFit1026->SetParError(1,0.01378098);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.15");
   pt_LaTex = pt->AddText("0.939#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.81#pm0.348");
   pt_LaTex = pt->AddText("#minus1.92#pm0.375");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.92339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.92339,-54.90989,1.92339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.437238);
   ...
   mainFit1027->SetParameter(0,-1.806451);
   mainFit1027->SetParError(0,0.3484231);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9392017);
   mainFit1027->SetParError(1,0.01378098);
