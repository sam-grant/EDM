...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.70921);
   Graph_Graph01023->SetMaximum(54.42634);
   ...
   mainFit1024->SetChisquare(9.933245);
   ...
   mainFit1024->SetParameter(0,-1.898084);
   mainFit1024->SetParError(0,0.3232055);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9330535);
   mainFit1024->SetParError(1,0.01067135);
   ...
   mainFit1025->SetChisquare(9.933245);
   ...
   mainFit1025->SetParameter(0,-1.898084);
   mainFit1025->SetParError(0,0.3232055);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9330535);
   mainFit1025->SetParError(1,0.01067135);
