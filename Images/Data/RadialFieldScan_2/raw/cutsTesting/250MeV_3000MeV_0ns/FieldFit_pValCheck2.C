...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.70921);
   Graph_Graph01029->SetMaximum(54.42634);
   ...
   mainFit1030->SetChisquare(7.134423);
   ...
   mainFit1030->SetParameter(0,-2.127717);
   mainFit1030->SetParError(0,0.351139);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9317061);
   mainFit1030->SetParError(1,0.010702);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.0107");
   pt_LaTex = pt->AddText("#minus2.13#pm0.351");
   pt_LaTex = pt->AddText("#minus2.28#pm0.375");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.283678,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.283678,-56.70921,2.283678,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.134423);
   ...
   mainFit1031->SetParameter(0,-2.127717);
   mainFit1031->SetParError(0,0.351139);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9317061);
   mainFit1031->SetParError(1,0.010702);
