...
//=========  (Fri Apr 23 18:37:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.60115,75,68.31828);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-56.70921);
   Graph_Graph01033->SetMaximum(54.42634);
   ...
   mainFit1034->SetChisquare(9.581947);
   ...
   mainFit1034->SetParameter(0,-1.752994);
   mainFit1034->SetParError(0,0.4054682);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9283021);
   mainFit1034->SetParError(1,0.01335401);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.19");
   pt_LaTex = pt->AddText("0.928#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.75#pm0.405");
   pt_LaTex = pt->AddText("#minus1.89#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.888388,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.888388,-56.70921,1.888388,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.581947);
   ...
   mainFit1035->SetParameter(0,-1.752994);
   mainFit1035->SetParError(0,0.4054682);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9283021);
   mainFit1035->SetParError(1,0.01335401);
