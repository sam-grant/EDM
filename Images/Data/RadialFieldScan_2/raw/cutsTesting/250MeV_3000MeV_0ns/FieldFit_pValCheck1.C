...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.70921);
   Graph_Graph01027->SetMaximum(54.42634);
   ...
   mainFit1028->SetChisquare(9.391088);
   ...
   mainFit1028->SetParameter(0,-2.018054);
   mainFit1028->SetParError(0,0.3619343);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9291509);
   mainFit1028->SetParError(1,0.01191852);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.13");
   pt_LaTex = pt->AddText("0.929#pm0.0119");
   pt_LaTex = pt->AddText("#minus2.02#pm0.362");
   pt_LaTex = pt->AddText("#minus2.17#pm0.393");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.171933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.171933,-56.70921,2.171933,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(9.391088);
   ...
   mainFit1029->SetParameter(0,-2.018054);
   mainFit1029->SetParError(0,0.3619343);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9291509);
   mainFit1029->SetParError(1,0.01191852);
