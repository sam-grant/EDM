...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01903797);
   Graph_Graph11015->SetMaximum(0.0139467);
   ...
   Graph_Graph21016->SetMinimum(-0.01303639);
   Graph_Graph21016->SetMaximum(0.01525394);
   ...
   Graph_Graph31017->SetMinimum(-0.01551327);
   Graph_Graph31017->SetMaximum(0.01999654);
   ...
   Graph_Graph41018->SetMinimum(-0.01044371);
   Graph_Graph41018->SetMaximum(0.02047212);
   ...
   Graph_Graph51019->SetMinimum(-0.004549896);
   Graph_Graph51019->SetMaximum(0.003416435);
