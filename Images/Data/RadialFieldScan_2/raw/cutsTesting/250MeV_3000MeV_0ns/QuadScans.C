...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(12.57719);
   ...
   quadLineFit1002->SetParameter(0,74.61127);
   quadLineFit1002->SetParError(0,0.04922901);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.3399);
   quadLineFit1002->SetParError(1,0.8251361);
   ...
   quadLineFit1003->SetChisquare(12.57719);
   ...
   quadLineFit1003->SetParameter(0,74.61127);
   quadLineFit1003->SetParError(0,0.04922901);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.3399);
   quadLineFit1003->SetParError(1,0.8251361);
   ...
   Graph_30_ppm1003->SetMinimum(75.80976);
   Graph_30_ppm1003->SetMaximum(76.46932);
   ...
   quadLineFit1004->SetChisquare(2.96022);
   ...
   quadLineFit1004->SetParameter(0,74.50651);
   quadLineFit1004->SetParError(0,0.04148977);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.49057);
   quadLineFit1004->SetParError(1,0.6812714);
   ...
   quadLineFit1005->SetChisquare(2.96022);
   ...
   quadLineFit1005->SetParameter(0,74.50651);
   quadLineFit1005->SetParError(0,0.04148977);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.49057);
   quadLineFit1005->SetParError(1,0.6812714);
   ...
   Graph_10_ppm1005->SetMinimum(74.80348);
   Graph_10_ppm1005->SetMaximum(75.04554);
   ...
   quadLineFit1006->SetChisquare(3.384902);
   ...
   quadLineFit1006->SetParameter(0,74.38336);
   quadLineFit1006->SetParError(0,0.04874199);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.638122);
   quadLineFit1006->SetParError(1,0.7899853);
   ...
   quadLineFit1007->SetChisquare(3.384902);
   ...
   quadLineFit1007->SetParameter(0,74.38336);
   quadLineFit1007->SetParError(0,0.04874199);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.638122);
   quadLineFit1007->SetParError(1,0.7899853);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.51224);
   Graph_mI10_ppm1007->SetMaximum(73.8534);
   ...
   quadLineFit1008->SetChisquare(4.441589);
   ...
   quadLineFit1008->SetParameter(0,74.45462);
   quadLineFit1008->SetParError(0,0.04275687);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.57403);
   quadLineFit1008->SetParError(1,0.6954287);
   ...
   quadLineFit1009->SetChisquare(4.441589);
   ...
   quadLineFit1009->SetParameter(0,74.45462);
   quadLineFit1009->SetParError(0,0.04275687);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.57403);
   quadLineFit1009->SetParError(1,0.6954287);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.117);
   Graph_mI30_ppm1009->SetMaximum(72.88012);
   ...
   quadLineFit1010->SetChisquare(2.636847);
   ...
   quadLineFit1010->SetParameter(0,74.35696);
   quadLineFit1010->SetParError(0,0.04027207);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.18315);
   quadLineFit1010->SetParError(1,0.6964463);
   ...
   quadLineFit1011->SetChisquare(2.636847);
   ...
   quadLineFit1011->SetParameter(0,74.35696);
   quadLineFit1011->SetParError(0,0.04027207);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.18315);
   quadLineFit1011->SetParError(1,0.6964463);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.24276);
   Graph_mI50_ppm1011->SetMaximum(71.88984);
   ...
   quadLineFit1012->SetChisquare(0.2665949);
   ...
   quadLineFit1012->SetParameter(0,74.18137);
   quadLineFit1012->SetParError(0,0.08131212);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.99337);
   quadLineFit1012->SetParError(1,1.454542);
   ...
   quadLineFit1013->SetChisquare(0.2665949);
   ...
   quadLineFit1013->SetParameter(0,74.18137);
   quadLineFit1013->SetParError(0,0.08131212);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.99337);
   quadLineFit1013->SetParError(1,1.454542);
