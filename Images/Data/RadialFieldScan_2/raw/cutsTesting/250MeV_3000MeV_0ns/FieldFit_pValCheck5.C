...
//=========  (Fri Apr 23 18:37:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.89075,70,64.1762);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.48406);
   Graph_Graph01035->SetMaximum(52.7695);
   ...
   mainFit1036->SetChisquare(6.018123);
   ...
   mainFit1036->SetParameter(0,-2.100517);
   mainFit1036->SetParError(0,0.3390079);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9426262);
   mainFit1036->SetParError(1,0.01171536);
   ...
   pt_LaTex = pt->AddText("0.943#pm0.0117");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.339");
   pt_LaTex = pt->AddText("#minus2.23#pm0.353");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.228367,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.228367,-38.48406,2.228367,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.018123);
   ...
   mainFit1037->SetParameter(0,-2.100517);
   mainFit1037->SetParError(0,0.3390079);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9426262);
   mainFit1037->SetParError(1,0.01171536);
