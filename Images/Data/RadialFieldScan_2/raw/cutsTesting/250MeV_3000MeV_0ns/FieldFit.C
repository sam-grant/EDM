...
//=========  (Fri Apr 23 18:37:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.70921);
   Graph_Graph01020->SetMaximum(54.42634);
   ...
   mainFit1021->SetChisquare(9.933245);
   ...
   mainFit1021->SetParameter(0,-1.898084);
   mainFit1021->SetParError(0,0.3232055);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9330535);
   mainFit1021->SetParError(1,0.01067135);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0107");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.323");
   pt_LaTex = pt->AddText("#minus2.03#pm0.343");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.034271,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.034271,-56.70921,2.034271,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.933245);
   ...
   mainFit1022->SetParameter(0,-1.898084);
   mainFit1022->SetParError(0,0.3232055);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9330535);
   mainFit1022->SetParError(1,0.01067135);
