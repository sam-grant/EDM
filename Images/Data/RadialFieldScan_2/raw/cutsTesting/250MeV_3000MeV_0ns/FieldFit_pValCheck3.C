...
//=========  (Fri Apr 23 18:37:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.70921);
   Graph_Graph01031->SetMaximum(54.42634);
   ...
   mainFit1032->SetChisquare(4.858712);
   ...
   mainFit1032->SetParameter(0,-1.483127);
   mainFit1032->SetParError(0,0.3720185);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9266698);
   mainFit1032->SetParError(1,0.011042);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.011");
   pt_LaTex = pt->AddText("#minus1.48#pm0.372");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.397");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.600491,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.600491,-56.70921,1.600491,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.858712);
   ...
   mainFit1033->SetParameter(0,-1.483127);
   mainFit1033->SetParError(0,0.3720185);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9266698);
   mainFit1033->SetParError(1,0.011042);
