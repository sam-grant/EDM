...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.62005);
   Graph_Graph01029->SetMaximum(49.14594);
   ...
   mainFit1030->SetChisquare(3.774559);
   ...
   mainFit1030->SetParameter(0,-0.2643707);
   mainFit1030->SetParError(0,0.6814548);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7622872);
   mainFit1030->SetParError(1,0.02079912);
   ...
   pt_LaTex = pt->AddText("0.762#pm0.0208");
   pt_LaTex = pt->AddText("#minus0.264#pm0.681");
   pt_LaTex = pt->AddText("#minus0.347#pm0.893");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3468125,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3468125,-50.62005,0.3468125,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.774559);
   ...
   mainFit1031->SetParameter(0,-0.2643707);
   mainFit1031->SetParError(0,0.6814548);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7622872);
   mainFit1031->SetParError(1,0.02079912);
