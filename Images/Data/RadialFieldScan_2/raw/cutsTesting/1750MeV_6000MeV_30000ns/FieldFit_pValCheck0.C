...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.42171,50,38.27125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.75241);
   Graph_Graph01025->SetMaximum(28.60195);
   ...
   mainFit1026->SetChisquare(4.813524);
   ...
   mainFit1026->SetParameter(0,-0.1202105);
   mainFit1026->SetParError(0,0.6754587);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7506724);
   mainFit1026->SetParError(1,0.02676144);
   ...
   pt_LaTex = pt->AddText("0.751#pm0.0268");
   pt_LaTex = pt->AddText("#minus0.12#pm0.675");
   pt_LaTex = pt->AddText("#minus0.16#pm0.901");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1601371,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1601371,-48.75241,0.1601371,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.813524);
   ...
   mainFit1027->SetParameter(0,-0.1202105);
   mainFit1027->SetParError(0,0.6754587);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7506724);
   mainFit1027->SetParError(1,0.02676144);
