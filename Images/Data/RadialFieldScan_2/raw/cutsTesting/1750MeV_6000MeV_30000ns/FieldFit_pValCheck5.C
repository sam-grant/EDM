...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.15546,70,57.22962);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.31695);
   Graph_Graph01035->SetMaximum(47.39111);
   ...
   mainFit1036->SetChisquare(5.179746);
   ...
   mainFit1036->SetParameter(0,0.188992);
   mainFit1036->SetParError(0,0.6576069);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7593128);
   mainFit1036->SetParError(1,0.02276823);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.73");
   pt_LaTex = pt->AddText("0.759#pm0.0228");
   pt_LaTex = pt->AddText("0.189#pm0.658");
   pt_LaTex = pt->AddText("0.249#pm0.868");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.2488988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2488988,-31.31695,-0.2488988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.179746);
   ...
   mainFit1037->SetParameter(0,0.188992);
   mainFit1037->SetParError(0,0.6576069);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7593128);
   mainFit1037->SetParError(1,0.02276823);
