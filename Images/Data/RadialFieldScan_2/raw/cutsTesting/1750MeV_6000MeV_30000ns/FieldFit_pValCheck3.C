...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-63.0908,75,61.61668);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-50.62005);
   Graph_Graph01031->SetMaximum(49.14594);
   ...
   mainFit1032->SetChisquare(4.632853);
   ...
   mainFit1032->SetParameter(0,-0.2452261);
   mainFit1032->SetParError(0,0.7226392);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7694138);
   mainFit1032->SetParError(1,0.02146912);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.54");
   pt_LaTex = pt->AddText("0.769#pm0.0215");
   pt_LaTex = pt->AddText("#minus0.245#pm0.723");
   pt_LaTex = pt->AddText("#minus0.319#pm0.937");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3187181,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3187181,-50.62005,0.3187181,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.632853);
   ...
   mainFit1033->SetParameter(0,-0.2452261);
   mainFit1033->SetParError(0,0.7226392);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7694138);
   mainFit1033->SetParError(1,0.02146912);
