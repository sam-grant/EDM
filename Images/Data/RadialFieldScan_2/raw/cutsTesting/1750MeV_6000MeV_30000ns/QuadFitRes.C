...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009494161);
   Graph_Graph11015->SetMaximum(0.01148194);
   ...
   Graph_Graph21016->SetMinimum(-0.01662789);
   Graph_Graph21016->SetMaximum(0.01957591);
   ...
   Graph_Graph31017->SetMinimum(-0.05490898);
   Graph_Graph31017->SetMaximum(0.05595311);
   ...
   Graph_Graph41018->SetMinimum(-0.0003838969);
   Graph_Graph41018->SetMaximum(0.0003826771);
   ...
   Graph_Graph51019->SetMinimum(-0.009936673);
   Graph_Graph51019->SetMaximum(0.007437985);
