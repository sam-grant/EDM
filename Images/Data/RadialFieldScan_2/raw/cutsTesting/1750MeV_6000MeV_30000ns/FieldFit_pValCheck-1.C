...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.62005);
   Graph_Graph01023->SetMaximum(49.14594);
   ...
   mainFit1024->SetChisquare(5.466585);
   ...
   mainFit1024->SetParameter(0,0.08280966);
   mainFit1024->SetParError(0,0.6270088);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.764345);
   mainFit1024->SetParError(1,0.02073901);
   ...
   mainFit1025->SetChisquare(5.466585);
   ...
   mainFit1025->SetParameter(0,0.08280966);
   mainFit1025->SetParError(0,0.6270088);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.764345);
   mainFit1025->SetParError(1,0.02073901);
