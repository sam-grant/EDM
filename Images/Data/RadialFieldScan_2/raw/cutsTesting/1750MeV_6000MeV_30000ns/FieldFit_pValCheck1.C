...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.62005);
   Graph_Graph01027->SetMaximum(49.14594);
   ...
   mainFit1028->SetChisquare(1.119842);
   ...
   mainFit1028->SetParameter(0,0.7414974);
   mainFit1028->SetParError(0,0.7021075);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7858994);
   mainFit1028->SetParError(1,0.02317302);
   ...
   pt_LaTex = pt->AddText("0.786#pm0.0232");
   pt_LaTex = pt->AddText("0.741#pm0.702");
   pt_LaTex = pt->AddText("0.944#pm0.892");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9435017,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9435017,-50.62005,-0.9435017,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.119842);
   ...
   mainFit1029->SetParameter(0,0.7414974);
   mainFit1029->SetParError(0,0.7021075);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7858994);
   mainFit1029->SetParError(1,0.02317302);
