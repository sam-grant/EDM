...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.62005);
   Graph_Graph01033->SetMaximum(49.14594);
   ...
   mainFit1034->SetChisquare(5.135268);
   ...
   mainFit1034->SetParameter(0,0.3549662);
   mainFit1034->SetParError(0,0.7853026);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7553934);
   mainFit1034->SetParError(1,0.02592231);
   ...
   pt_LaTex = pt->AddText("0.755#pm0.0259");
   pt_LaTex = pt->AddText("0.355#pm0.785");
   pt_LaTex = pt->AddText(" 0.47#pm 1.05");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4699091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4699091,-50.62005,-0.4699091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.135268);
   ...
   mainFit1035->SetParameter(0,0.3549662);
   mainFit1035->SetParError(0,0.7853026);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7553934);
   mainFit1035->SetParError(1,0.02592231);
