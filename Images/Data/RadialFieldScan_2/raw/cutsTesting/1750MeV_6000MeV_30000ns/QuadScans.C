...
//=========  (Wed Apr 21 13:26:59 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2254092);
   ...
   quadLineFit1002->SetParameter(0,75.00975);
   quadLineFit1002->SetParError(0,0.09567169);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.22734);
   quadLineFit1002->SetParError(1,1.604762);
   ...
   quadLineFit1003->SetChisquare(0.2254092);
   ...
   quadLineFit1003->SetParameter(0,75.00975);
   quadLineFit1003->SetParError(0,0.09567169);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.22734);
   quadLineFit1003->SetParError(1,1.604762);
   ...
   Graph_30_ppm1003->SetMinimum(76.07766);
   Graph_30_ppm1003->SetMaximum(76.62263);
   ...
   quadLineFit1004->SetChisquare(0.3859062);
   ...
   quadLineFit1004->SetParameter(0,75.0706);
   quadLineFit1004->SetParError(0,0.08040096);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.83411);
   quadLineFit1004->SetParError(1,1.32164);
   ...
   quadLineFit1005->SetChisquare(0.3859062);
   ...
   quadLineFit1005->SetParameter(0,75.0706);
   quadLineFit1005->SetParError(0,0.08040096);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.83411);
   quadLineFit1005->SetParError(1,1.32164);
   ...
   Graph_10_ppm1005->SetMinimum(75.14543);
   Graph_10_ppm1005->SetMaximum(75.43676);
   ...
   quadLineFit1006->SetChisquare(1.467552);
   ...
   quadLineFit1006->SetParameter(0,74.69097);
   quadLineFit1006->SetParError(0,0.09428523);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.539983);
   quadLineFit1006->SetParError(1,1.529172);
   ...
   quadLineFit1007->SetChisquare(1.467552);
   ...
   quadLineFit1007->SetParameter(0,74.69097);
   quadLineFit1007->SetParError(0,0.09428523);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.539983);
   quadLineFit1007->SetParError(1,1.529172);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.12514);
   Graph_mI10_ppm1007->SetMaximum(74.37458);
   ...
   quadLineFit1008->SetChisquare(11.6129);
   ...
   quadLineFit1008->SetParameter(0,74.64407);
   quadLineFit1008->SetParError(0,0.08257856);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.508122);
   quadLineFit1008->SetParError(1,1.344183);
   ...
   quadLineFit1009->SetChisquare(11.6129);
   ...
   quadLineFit1009->SetParameter(0,74.64407);
   quadLineFit1009->SetParError(0,0.08257856);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.508122);
   quadLineFit1009->SetParError(1,1.344183);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.87295);
   Graph_mI30_ppm1009->SetMaximum(73.48602);
   ...
   quadLineFit1010->SetChisquare(0.0005213817);
   ...
   quadLineFit1010->SetParameter(0,74.62014);
   quadLineFit1010->SetParError(0,0.07829754);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.40276);
   quadLineFit1010->SetParError(1,1.355188);
   ...
   quadLineFit1011->SetChisquare(0.0005213817);
   ...
   quadLineFit1011->SetParameter(0,74.62014);
   quadLineFit1011->SetParError(0,0.07829754);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.40276);
   quadLineFit1011->SetParError(1,1.355188);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.01793);
   Graph_mI50_ppm1011->SetMaximum(72.60374);
   ...
   quadLineFit1012->SetChisquare(0.3364251);
   ...
   quadLineFit1012->SetParameter(0,74.5533);
   quadLineFit1012->SetParError(0,0.1579724);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.47982);
   quadLineFit1012->SetParError(1,2.826395);
   ...
   quadLineFit1013->SetChisquare(0.3364251);
   ...
   quadLineFit1013->SetParameter(0,74.5533);
   quadLineFit1013->SetParError(0,0.1579724);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.47982);
   quadLineFit1013->SetParError(1,2.826395);
