...
//=========  (Wed Apr 21 13:27:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.62005);
   Graph_Graph01020->SetMaximum(49.14594);
   ...
   mainFit1021->SetChisquare(5.466585);
   ...
   mainFit1021->SetParameter(0,0.08280966);
   mainFit1021->SetParError(0,0.6270088);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.764345);
   mainFit1021->SetParError(1,0.02073901);
   ...
   pt_LaTex = pt->AddText("0.764#pm0.0207");
   pt_LaTex = pt->AddText("0.0828#pm0.627");
   pt_LaTex = pt->AddText("0.108#pm0.821");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1083407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1083407,-50.62005,-0.1083407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.466585);
   ...
   mainFit1022->SetParameter(0,0.08280966);
   mainFit1022->SetParError(0,0.6270088);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.764345);
   mainFit1022->SetParError(1,0.02073901);
