...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-62.38206);
   Graph_Graph01027->SetMaximum(58.62513);
   ...
   mainFit1028->SetChisquare(8.369301);
   ...
   mainFit1028->SetParameter(0,2.308222);
   mainFit1028->SetParError(0,1.538928);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8535653);
   mainFit1028->SetParError(1,0.05069035);
   ...
   pt_LaTex = pt->AddText("0.854#pm0.0507");
   pt_LaTex = pt->AddText(" 2.31#pm 1.54");
   pt_LaTex = pt->AddText("  2.7#pm  1.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.704212,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.704212,-62.38206,-2.704212,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(8.369301);
   ...
   mainFit1029->SetParameter(0,2.308222);
   mainFit1029->SetParError(0,1.538928);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8535653);
   mainFit1029->SetParError(1,0.05069035);
