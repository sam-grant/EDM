...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.38206);
   Graph_Graph01029->SetMaximum(58.62513);
   ...
   mainFit1030->SetChisquare(7.045518);
   ...
   mainFit1030->SetParameter(0,2.553438);
   mainFit1030->SetParError(0,1.493768);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8391518);
   mainFit1030->SetParError(1,0.04553292);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.0455");
   pt_LaTex = pt->AddText(" 2.55#pm 1.49");
   pt_LaTex = pt->AddText(" 3.04#pm 1.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.04288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.04288,-62.38206,-3.04288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.045518);
   ...
   mainFit1031->SetParameter(0,2.553438);
   mainFit1031->SetParError(0,1.493768);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8391518);
   mainFit1031->SetParError(1,0.04553292);
