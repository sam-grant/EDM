...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.38206);
   Graph_Graph01023->SetMaximum(58.62513);
   ...
   mainFit1024->SetChisquare(9.104181);
   ...
   mainFit1024->SetParameter(0,1.715551);
   mainFit1024->SetParError(0,1.374888);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8342446);
   mainFit1024->SetParError(1,0.04540429);
   ...
   mainFit1025->SetChisquare(9.104181);
   ...
   mainFit1025->SetParameter(0,1.715551);
   mainFit1025->SetParError(0,1.374888);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8342446);
   mainFit1025->SetParError(1,0.04540429);
