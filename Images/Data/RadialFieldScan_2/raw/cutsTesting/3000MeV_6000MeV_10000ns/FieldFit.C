...
//=========  (Thu Apr 22 09:48:15 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-77.50796,75,73.75103);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-62.38206);
   Graph_Graph01020->SetMaximum(58.62513);
   ...
   mainFit1021->SetChisquare(9.104181);
   ...
   mainFit1021->SetParameter(0,1.715551);
   mainFit1021->SetParError(0,1.374888);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8342446);
   mainFit1021->SetParError(1,0.04540429);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0454");
   pt_LaTex = pt->AddText(" 1.72#pm 1.37");
   pt_LaTex = pt->AddText(" 2.06#pm 1.67");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.056412,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.056412,-62.38206,-2.056412,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.104181);
   ...
   mainFit1022->SetParameter(0,1.715551);
   mainFit1022->SetParError(0,1.374888);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8342446);
   mainFit1022->SetParError(1,0.04540429);
