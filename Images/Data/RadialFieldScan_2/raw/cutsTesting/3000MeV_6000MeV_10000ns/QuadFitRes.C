...
//=========  (Thu Apr 22 09:48:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.05185741);
   Graph_Graph11015->SetMaximum(0.02008937);
   ...
   Graph_Graph21016->SetMinimum(-0.0252598);
   Graph_Graph21016->SetMaximum(0.02982865);
   ...
   Graph_Graph31017->SetMinimum(-0.141827);
   Graph_Graph31017->SetMaximum(0.1262714);
   ...
   Graph_Graph41018->SetMinimum(-0.02625333);
   Graph_Graph41018->SetMaximum(0.01819387);
   ...
   Graph_Graph51019->SetMinimum(-0.01923176);
   Graph_Graph51019->SetMaximum(0.02567076);
