...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-62.38206);
   Graph_Graph01031->SetMaximum(58.62513);
   ...
   mainFit1032->SetChisquare(1.555789);
   ...
   mainFit1032->SetParameter(0,-0.4458386);
   mainFit1032->SetParError(0,1.584047);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8676185);
   mainFit1032->SetParError(1,0.04700114);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.047");
   pt_LaTex = pt->AddText("#minus0.446#pm 1.58");
   pt_LaTex = pt->AddText("#minus0.514#pm 1.82");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5138647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5138647,-62.38206,0.5138647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.555789);
   ...
   mainFit1033->SetParameter(0,-0.4458386);
   mainFit1033->SetParError(0,1.584047);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8676185);
   mainFit1033->SetParError(1,0.04700114);
