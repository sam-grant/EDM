...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.29131,50,47.66776);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.2954);
   Graph_Graph01025->SetMaximum(35.67186);
   ...
   mainFit1026->SetChisquare(8.691167);
   ...
   mainFit1026->SetParameter(0,1.36018);
   mainFit1026->SetParError(0,1.481921);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8103701);
   mainFit1026->SetParError(1,0.05866518);
   ...
   pt_LaTex = pt->AddText(" 0.81#pm0.0587");
   pt_LaTex = pt->AddText(" 1.36#pm 1.48");
   pt_LaTex = pt->AddText(" 1.68#pm 1.82");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-1.678468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.678468,-60.2954,-1.678468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(8.691167);
   ...
   mainFit1027->SetParameter(0,1.36018);
   mainFit1027->SetParError(0,1.481921);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8103701);
   mainFit1027->SetParError(1,0.05866518);
