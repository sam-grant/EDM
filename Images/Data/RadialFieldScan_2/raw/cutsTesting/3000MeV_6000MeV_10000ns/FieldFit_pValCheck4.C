...
//=========  (Thu Apr 22 09:48:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-62.38206);
   Graph_Graph01033->SetMaximum(58.62513);
   ...
   mainFit1034->SetChisquare(8.733273);
   ...
   mainFit1034->SetParameter(0,2.347634);
   mainFit1034->SetParError(0,1.722639);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8135104);
   mainFit1034->SetParError(1,0.05675043);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.91");
   pt_LaTex = pt->AddText("0.814#pm0.0568");
   pt_LaTex = pt->AddText(" 2.35#pm 1.72");
   pt_LaTex = pt->AddText(" 2.89#pm 2.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.885807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.885807,-62.38206,-2.885807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.733273);
   ...
   mainFit1035->SetParameter(0,2.347634);
   mainFit1035->SetParError(0,1.722639);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8135104);
   mainFit1035->SetParError(1,0.05675043);
