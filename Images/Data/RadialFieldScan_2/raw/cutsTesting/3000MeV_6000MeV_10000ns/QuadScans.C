...
//=========  (Thu Apr 22 09:48:15 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.653916);
   ...
   quadLineFit1002->SetParameter(0,74.85624);
   quadLineFit1002->SetParError(0,0.2090278);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.03559);
   quadLineFit1002->SetParError(1,3.505612);
   ...
   quadLineFit1003->SetChisquare(1.653916);
   ...
   quadLineFit1003->SetParameter(0,74.85624);
   quadLineFit1003->SetParError(0,0.2090278);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.03559);
   quadLineFit1003->SetParError(1,3.505612);
   ...
   Graph_30_ppm1003->SetMinimum(76.1983);
   Graph_30_ppm1003->SetMaximum(76.92115);
   ...
   quadLineFit1004->SetChisquare(0.7569974);
   ...
   quadLineFit1004->SetParameter(0,75.0394);
   quadLineFit1004->SetParError(0,0.1761653);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.77612);
   quadLineFit1004->SetParError(1,2.898461);
   ...
   quadLineFit1005->SetChisquare(0.7569974);
   ...
   quadLineFit1005->SetParameter(0,75.0394);
   quadLineFit1005->SetParError(0,0.1761653);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.77612);
   quadLineFit1005->SetParError(1,2.898461);
   ...
   Graph_10_ppm1005->SetMinimum(75.31063);
   Graph_10_ppm1005->SetMaximum(75.57589);
   ...
   quadLineFit1006->SetChisquare(0.6993417);
   ...
   quadLineFit1006->SetParameter(0,75.07223);
   quadLineFit1006->SetParError(0,0.2069492);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,5.66264);
   quadLineFit1006->SetParError(1,3.358278);
   ...
   quadLineFit1007->SetChisquare(0.6993417);
   ...
   quadLineFit1007->SetParameter(0,75.07223);
   quadLineFit1007->SetParError(0,0.2069492);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,5.66264);
   quadLineFit1007->SetParError(1,3.358278);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.15729);
   Graph_mI10_ppm1007->SetMaximum(74.53554);
   ...
   quadLineFit1008->SetChisquare(14.64615);
   ...
   quadLineFit1008->SetParameter(0,74.33419);
   quadLineFit1008->SetParError(0,0.1811805);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,0.3288814);
   quadLineFit1008->SetParError(1,2.951089);
   ...
   quadLineFit1009->SetChisquare(14.64615);
   ...
   quadLineFit1009->SetParameter(0,74.33419);
   quadLineFit1009->SetParError(0,0.1811805);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,0.3288814);
   quadLineFit1009->SetParError(1,2.951089);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.82388);
   Graph_mI30_ppm1009->SetMaximum(73.51327);
   ...
   quadLineFit1010->SetChisquare(0.3050045);
   ...
   quadLineFit1010->SetParameter(0,74.67781);
   quadLineFit1010->SetParError(0,0.171558);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.5995);
   quadLineFit1010->SetParError(1,2.97064);
   ...
   quadLineFit1011->SetChisquare(0.3050045);
   ...
   quadLineFit1011->SetParameter(0,74.67781);
   quadLineFit1011->SetParError(0,0.171558);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.5995);
   quadLineFit1011->SetParError(1,2.97064);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.90171);
   Graph_mI50_ppm1011->SetMaximum(72.63777);
   ...
   quadLineFit1012->SetChisquare(0.4695242);
   ...
   quadLineFit1012->SetParameter(0,74.91233);
   quadLineFit1012->SetParError(0,0.3457914);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.11155);
   quadLineFit1012->SetParError(1,6.186574);
   ...
   quadLineFit1013->SetChisquare(0.4695242);
   ...
   quadLineFit1013->SetParameter(0,74.91233);
   quadLineFit1013->SetParError(0,0.3457914);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.11155);
   quadLineFit1013->SetParError(1,6.186574);
