...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.83077);
   Graph_Graph01031->SetMaximum(52.6698);
   ...
   mainFit1032->SetChisquare(5.30727);
   ...
   mainFit1032->SetParameter(0,-0.4483881);
   mainFit1032->SetParError(0,0.5414012);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8315462);
   mainFit1032->SetParError(1,0.01597665);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.016");
   pt_LaTex = pt->AddText("#minus0.448#pm0.541");
   pt_LaTex = pt->AddText("#minus0.539#pm0.648");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5392221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5392221,-52.83077,0.5392221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.30727);
   ...
   mainFit1033->SetParameter(0,-0.4483881);
   mainFit1033->SetParError(0,0.5414012);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8315462);
   mainFit1033->SetParError(1,0.01597665);
