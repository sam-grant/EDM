...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01734196);
   Graph_Graph11015->SetMaximum(0.04544563);
   ...
   Graph_Graph21016->SetMinimum(-0.01007781);
   Graph_Graph21016->SetMaximum(0.01187858);
   ...
   Graph_Graph31017->SetMinimum(-0.03185784);
   Graph_Graph31017->SetMaximum(0.02370744);
   ...
   Graph_Graph41018->SetMinimum(-0.0156544);
   Graph_Graph41018->SetMaximum(0.01900514);
   ...
   Graph_Graph51019->SetMinimum(-0.00561603);
   Graph_Graph51019->SetMaximum(0.00750931);
