...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.83077);
   Graph_Graph01020->SetMaximum(52.6698);
   ...
   mainFit1021->SetChisquare(5.4087);
   ...
   mainFit1021->SetParameter(0,-0.3627553);
   mainFit1021->SetParError(0,0.469914);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8302125);
   mainFit1021->SetParError(1,0.01541801);
   ...
   mainFit1022->SetChisquare(5.4087);
   ...
   mainFit1022->SetParameter(0,-0.3627553);
   mainFit1022->SetParError(0,0.469914);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8302125);
   mainFit1022->SetParError(1,0.01541801);
