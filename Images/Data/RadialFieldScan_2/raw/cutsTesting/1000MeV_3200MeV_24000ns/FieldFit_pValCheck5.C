...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.70723,70,61.39515);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.19699);
   Graph_Graph01035->SetMaximum(50.88491);
   ...
   mainFit1036->SetChisquare(5.408176);
   ...
   mainFit1036->SetParameter(0,-0.3593136);
   mainFit1036->SetParError(0,0.4933627);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.830053);
   mainFit1036->SetParError(1,0.01691717);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.359#pm0.493");
   pt_LaTex = pt->AddText("#minus0.433#pm0.592");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4328803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4328803,-33.19699,0.4328803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.408176);
   ...
   mainFit1037->SetParameter(0,-0.3593136);
   mainFit1037->SetParError(0,0.4933627);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.830053);
   mainFit1037->SetParError(1,0.01691717);
