...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.83077);
   Graph_Graph01029->SetMaximum(52.6698);
   ...
   mainFit1030->SetChisquare(5.205901);
   ...
   mainFit1030->SetParameter(0,-0.4522064);
   mainFit1030->SetParError(0,0.5101923);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8297259);
   mainFit1030->SetParError(1,0.01545494);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0155");
   pt_LaTex = pt->AddText("#minus0.452#pm 0.51");
   pt_LaTex = pt->AddText("#minus0.545#pm0.614");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.545007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.545007,-52.83077,0.545007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.205901);
   ...
   mainFit1031->SetParameter(0,-0.4522064);
   mainFit1031->SetParError(0,0.5101923);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8297259);
   mainFit1031->SetParError(1,0.01545494);
