...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-66.01835,75,65.85737);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-52.83077);
   Graph_Graph01027->SetMaximum(52.6698);
   ...
   mainFit1028->SetChisquare(0.0925529);
   ...
   mainFit1028->SetParameter(0,0.1707786);
   mainFit1028->SetParError(0,0.5237987);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.847329);
   mainFit1028->SetParError(1,0.01711215);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0309");
   pt_LaTex = pt->AddText("0.847#pm0.0171");
   pt_LaTex = pt->AddText("0.171#pm0.524");
   pt_LaTex = pt->AddText("0.202#pm0.618");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2015493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2015493,-52.83077,-0.2015493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.0925529);
   ...
   mainFit1029->SetParameter(0,0.1707786);
   mainFit1029->SetParError(0,0.5237987);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.847329);
   mainFit1029->SetParError(1,0.01711215);
