...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.83077);
   Graph_Graph01023->SetMaximum(52.6698);
   ...
   mainFit1024->SetChisquare(5.4087);
   ...
   mainFit1024->SetParameter(0,-0.3627553);
   mainFit1024->SetParError(0,0.469914);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8302125);
   mainFit1024->SetParError(1,0.01541801);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.363#pm 0.47");
   pt_LaTex = pt->AddText("#minus0.437#pm0.565");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4369428,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4369428,-52.83077,0.4369428,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.4087);
   ...
   mainFit1025->SetParameter(0,-0.3627553);
   mainFit1025->SetParError(0,0.469914);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8302125);
   mainFit1025->SetParError(1,0.01541801);
