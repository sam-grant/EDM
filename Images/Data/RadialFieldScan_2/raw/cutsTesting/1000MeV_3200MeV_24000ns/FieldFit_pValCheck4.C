...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.83077);
   Graph_Graph01033->SetMaximum(52.6698);
   ...
   mainFit1034->SetChisquare(5.390974);
   ...
   mainFit1034->SetParameter(0,-0.4102621);
   mainFit1034->SetParError(0,0.5900351);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8317539);
   mainFit1034->SetParError(1,0.0192811);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.0193");
   pt_LaTex = pt->AddText("#minus0.41#pm 0.59");
   pt_LaTex = pt->AddText("#minus0.493#pm0.704");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4932494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4932494,-52.83077,0.4932494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.390974);
   ...
   mainFit1035->SetParameter(0,-0.4102621);
   mainFit1035->SetParError(0,0.5900351);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8317539);
   mainFit1035->SetParError(1,0.0192811);
