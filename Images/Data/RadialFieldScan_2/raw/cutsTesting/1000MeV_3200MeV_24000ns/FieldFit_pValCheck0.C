...
//=========  (Thu Apr 22 13:39:08 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-60.97683,50,40.6498);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.81417);
   Graph_Graph01025->SetMaximum(30.48714);
   ...
   mainFit1026->SetChisquare(1.827528);
   ...
   mainFit1026->SetParameter(0,-0.7252693);
   mainFit1026->SetParError(0,0.5074512);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8058079);
   mainFit1026->SetParError(1,0.0200969);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.609");
   pt_LaTex = pt->AddText("0.806#pm0.0201");
   pt_LaTex = pt->AddText("#minus0.725#pm0.507");
   pt_LaTex = pt->AddText(" #minus0.9#pm0.633");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.9000524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9000524,-50.81417,0.9000524,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.827528);
   ...
   mainFit1027->SetParameter(0,-0.7252693);
   mainFit1027->SetParError(0,0.5074512);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8058079);
   mainFit1027->SetParError(1,0.0200969);
