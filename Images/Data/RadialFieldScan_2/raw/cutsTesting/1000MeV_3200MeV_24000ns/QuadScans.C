...
//=========  (Thu Apr 22 13:39:07 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.843055);
   ...
   quadLineFit1002->SetParameter(0,74.65158);
   quadLineFit1002->SetParError(0,0.06978137);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.70804);
   quadLineFit1002->SetParError(1,1.170044);
   ...
   quadLineFit1003->SetChisquare(1.843055);
   ...
   quadLineFit1003->SetParameter(0,74.65158);
   quadLineFit1003->SetParError(0,0.06978137);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.70804);
   quadLineFit1003->SetParError(1,1.170044);
   ...
   Graph_30_ppm1003->SetMinimum(75.8448);
   Graph_30_ppm1003->SetMaximum(76.41866);
   ...
   quadLineFit1004->SetChisquare(4.926442);
   ...
   quadLineFit1004->SetParameter(0,74.74173);
   quadLineFit1004->SetParError(0,0.06039138);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.71945);
   quadLineFit1004->SetParError(1,0.9925824);
   ...
   quadLineFit1005->SetChisquare(4.926442);
   ...
   quadLineFit1005->SetParameter(0,74.74173);
   quadLineFit1005->SetParError(0,0.06039138);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.71945);
   quadLineFit1005->SetParError(1,0.9925824);
   ...
   Graph_10_ppm1005->SetMinimum(74.91543);
   Graph_10_ppm1005->SetMaximum(75.16324);
   ...
   quadLineFit1006->SetChisquare(0.9578524);
   ...
   quadLineFit1006->SetParameter(0,74.51406);
   quadLineFit1006->SetParError(0,0.0707813);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.411347);
   quadLineFit1006->SetParError(1,1.147984);
   ...
   quadLineFit1007->SetChisquare(0.9578524);
   ...
   quadLineFit1007->SetParameter(0,74.51406);
   quadLineFit1007->SetParError(0,0.0707813);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.411347);
   quadLineFit1007->SetParError(1,1.147984);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.7965);
   Graph_mI10_ppm1007->SetMaximum(74.0629);
   ...
   quadLineFit1008->SetChisquare(5.482815);
   ...
   quadLineFit1008->SetParameter(0,74.43463);
   quadLineFit1008->SetParError(0,0.06214631);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.388424);
   quadLineFit1008->SetParError(1,1.011563);
   ...
   quadLineFit1009->SetChisquare(5.482815);
   ...
   quadLineFit1009->SetParameter(0,74.43463);
   quadLineFit1009->SetParError(0,0.06214631);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.388424);
   quadLineFit1009->SetParError(1,1.011563);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.48008);
   Graph_mI30_ppm1009->SetMaximum(73.1298);
   ...
   quadLineFit1010->SetChisquare(2.352729);
   ...
   quadLineFit1010->SetParameter(0,74.36345);
   quadLineFit1010->SetParError(0,0.05879142);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.17265);
   quadLineFit1010->SetParError(1,1.017511);
   ...
   quadLineFit1011->SetChisquare(2.352729);
   ...
   quadLineFit1011->SetParameter(0,74.36345);
   quadLineFit1011->SetParError(0,0.05879142);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.17265);
   quadLineFit1011->SetParError(1,1.017511);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.59476);
   Graph_mI50_ppm1011->SetMaximum(72.19872);
   ...
   quadLineFit1012->SetChisquare(0.3407713);
   ...
   quadLineFit1012->SetParameter(0,74.28729);
   quadLineFit1012->SetParError(0,0.1186224);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.91661);
   quadLineFit1012->SetParError(1,2.12245);
   ...
   quadLineFit1013->SetChisquare(0.3407713);
   ...
   quadLineFit1013->SetParameter(0,74.28729);
   quadLineFit1013->SetParError(0,0.1186224);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.91661);
   quadLineFit1013->SetParError(1,2.12245);
