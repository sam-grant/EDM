...
//=========  (Thu Apr 22 00:04:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(6.169126);
   ...
   quadLineFit1002->SetParameter(0,74.16041);
   quadLineFit1002->SetParError(0,0.1086491);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,49.17974);
   quadLineFit1002->SetParError(1,1.822003);
   ...
   quadLineFit1003->SetChisquare(6.169126);
   ...
   quadLineFit1003->SetParameter(0,74.16041);
   quadLineFit1003->SetParError(0,0.1086491);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,49.17974);
   quadLineFit1003->SetParError(1,1.822003);
   ...
   Graph_30_ppm1003->SetMinimum(75.56541);
   Graph_30_ppm1003->SetMaximum(76.28471);
   ...
   quadLineFit1004->SetChisquare(0.425536);
   ...
   quadLineFit1004->SetParameter(0,74.27927);
   quadLineFit1004->SetParError(0,0.09159037);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.95442);
   quadLineFit1004->SetParError(1,1.504523);
   ...
   quadLineFit1005->SetChisquare(0.425536);
   ...
   quadLineFit1005->SetParameter(0,74.27927);
   quadLineFit1005->SetParError(0,0.09159037);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.95442);
   quadLineFit1005->SetParError(1,1.504523);
   ...
   Graph_10_ppm1005->SetMinimum(74.57504);
   Graph_10_ppm1005->SetMaximum(74.91013);
   ...
   quadLineFit1006->SetChisquare(4.974027);
   ...
   quadLineFit1006->SetParameter(0,74.05616);
   quadLineFit1006->SetParError(0,0.1073358);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.70633);
   quadLineFit1006->SetParError(1,1.740412);
   ...
   quadLineFit1007->SetChisquare(4.974027);
   ...
   quadLineFit1007->SetParameter(0,74.05616);
   quadLineFit1007->SetParError(0,0.1073358);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.70633);
   quadLineFit1007->SetParError(1,1.740412);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.30138);
   Graph_mI10_ppm1007->SetMaximum(73.60424);
   ...
   quadLineFit1008->SetChisquare(0.4761038);
   ...
   quadLineFit1008->SetParameter(0,74.10923);
   quadLineFit1008->SetParError(0,0.09420144);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.61269);
   quadLineFit1008->SetParError(1,1.532809);
   ...
   quadLineFit1009->SetChisquare(0.4761038);
   ...
   quadLineFit1009->SetParameter(0,74.10923);
   quadLineFit1009->SetParError(0,0.09420144);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.61269);
   quadLineFit1009->SetParError(1,1.532809);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.82619);
   Graph_mI30_ppm1009->SetMaximum(72.64616);
   ...
   quadLineFit1010->SetChisquare(3.786316);
   ...
   quadLineFit1010->SetParameter(0,74.16035);
   quadLineFit1010->SetParError(0,0.08898486);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.96489);
   quadLineFit1010->SetParError(1,1.539376);
   ...
   quadLineFit1011->SetChisquare(3.786316);
   ...
   quadLineFit1011->SetParameter(0,74.16035);
   quadLineFit1011->SetParError(0,0.08898486);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.96489);
   quadLineFit1011->SetParError(1,1.539376);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.86581);
   Graph_mI50_ppm1011->SetMaximum(71.63293);
   ...
   quadLineFit1012->SetChisquare(0.7115706);
   ...
   quadLineFit1012->SetParameter(0,74.25073);
   quadLineFit1012->SetParError(0,0.1797036);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-52.54953);
   quadLineFit1012->SetParError(1,3.214968);
   ...
   quadLineFit1013->SetChisquare(0.7115706);
   ...
   quadLineFit1013->SetParameter(0,74.25073);
   quadLineFit1013->SetParError(0,0.1797036);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-52.54953);
   quadLineFit1013->SetParError(1,3.214968);
