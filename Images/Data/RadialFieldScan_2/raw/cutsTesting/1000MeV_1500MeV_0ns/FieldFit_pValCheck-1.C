...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-66.44112);
   Graph_Graph01023->SetMaximum(61.67837);
   ...
   mainFit1024->SetChisquare(3.002033);
   ...
   mainFit1024->SetParameter(0,-1.094219);
   mainFit1024->SetParError(0,0.7133987);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9932692);
   mainFit1024->SetParError(1,0.02357211);
   ...
   mainFit1025->SetChisquare(3.002033);
   ...
   mainFit1025->SetParameter(0,-1.094219);
   mainFit1025->SetParError(0,0.7133987);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9932692);
   mainFit1025->SetParError(1,0.02357211);
