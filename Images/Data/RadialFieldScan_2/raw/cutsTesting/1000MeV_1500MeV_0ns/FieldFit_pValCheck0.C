...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-76.82036,50,49.51481);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-64.18684);
   Graph_Graph01025->SetMaximum(36.88129);
   ...
   mainFit1026->SetChisquare(2.781919);
   ...
   mainFit1026->SetParameter(0,-1.228834);
   mainFit1026->SetParError(0,0.7688679);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9842136);
   mainFit1026->SetParError(1,0.03044176);
   ...
   pt_LaTex = pt->AddText("0.984#pm0.0304");
   pt_LaTex = pt->AddText("#minus1.23#pm0.769");
   pt_LaTex = pt->AddText("#minus1.25#pm0.787");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.248544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.248544,-64.18684,1.248544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.781919);
   ...
   mainFit1027->SetParameter(0,-1.228834);
   mainFit1027->SetParError(0,0.7688679);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9842136);
   mainFit1027->SetParError(1,0.03044176);
