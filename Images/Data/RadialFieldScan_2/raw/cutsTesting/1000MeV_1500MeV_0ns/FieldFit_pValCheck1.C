...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-66.44112);
   Graph_Graph01027->SetMaximum(61.67837);
   ...
   mainFit1028->SetChisquare(0.8430149);
   ...
   mainFit1028->SetParameter(0,-0.5666937);
   mainFit1028->SetParError(0,0.7986433);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.010489);
   mainFit1028->SetParError(1,0.02632461);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0263");
   pt_LaTex = pt->AddText("#minus0.567#pm0.799");
   pt_LaTex = pt->AddText("#minus0.561#pm0.792");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5608115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5608115,-66.44112,0.5608115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8430149);
   ...
   mainFit1029->SetParameter(0,-0.5666937);
   mainFit1029->SetParError(0,0.7986433);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.010489);
   mainFit1029->SetParError(1,0.02632461);
