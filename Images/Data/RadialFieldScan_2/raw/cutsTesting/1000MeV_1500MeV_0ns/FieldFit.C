...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-66.44112);
   Graph_Graph01020->SetMaximum(61.67837);
   ...
   mainFit1021->SetChisquare(3.002033);
   ...
   mainFit1021->SetParameter(0,-1.094219);
   mainFit1021->SetParError(0,0.7133987);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9932692);
   mainFit1021->SetParError(1,0.02357211);
   ...
   pt_LaTex = pt->AddText("0.993#pm0.0236");
   pt_LaTex = pt->AddText("#minus1.09#pm0.713");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.714");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.101634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.101634,-66.44112,1.101634,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.002033);
   ...
   mainFit1022->SetParameter(0,-1.094219);
   mainFit1022->SetParError(0,0.7133987);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9932692);
   mainFit1022->SetParError(1,0.02357211);
