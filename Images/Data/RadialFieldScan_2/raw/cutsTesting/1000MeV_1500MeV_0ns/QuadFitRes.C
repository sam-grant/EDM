...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01299963);
   Graph_Graph11015->SetMaximum(0.0120379);
   ...
   Graph_Graph21016->SetMinimum(-0.03480153);
   Graph_Graph21016->SetMaximum(0.04090061);
   ...
   Graph_Graph31017->SetMinimum(-0.01437858);
   Graph_Graph31017->SetMaximum(0.01378056);
   ...
   Graph_Graph41018->SetMinimum(-0.03308184);
   Graph_Graph41018->SetMaximum(0.04898615);
   ...
   Graph_Graph51019->SetMinimum(-0.0123094);
   Graph_Graph51019->SetMaximum(0.01646529);
