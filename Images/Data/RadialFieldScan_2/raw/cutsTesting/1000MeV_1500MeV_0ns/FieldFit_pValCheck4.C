...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-66.44112);
   Graph_Graph01033->SetMaximum(61.67837);
   ...
   mainFit1034->SetChisquare(2.997632);
   ...
   mainFit1034->SetParameter(0,-1.05843);
   mainFit1034->SetParError(0,0.8944282);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9920941);
   mainFit1034->SetParError(1,0.02948589);
   ...
   pt_LaTex = pt->AddText("0.992#pm0.0295");
   pt_LaTex = pt->AddText("#minus1.06#pm0.894");
   pt_LaTex = pt->AddText("#minus1.07#pm0.887");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.066865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.066865,-66.44112,1.066865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.997632);
   ...
   mainFit1035->SetParameter(0,-1.05843);
   mainFit1035->SetParError(0,0.8944282);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9920941);
   mainFit1035->SetParError(1,0.02948589);
