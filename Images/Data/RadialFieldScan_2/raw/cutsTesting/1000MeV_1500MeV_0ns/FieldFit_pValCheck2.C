...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-66.44112);
   Graph_Graph01029->SetMaximum(61.67837);
   ...
   mainFit1030->SetChisquare(1.616931);
   ...
   mainFit1030->SetParameter(0,-1.451475);
   mainFit1030->SetParError(0,0.775297);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9911623);
   mainFit1030->SetParError(1,0.02363994);
   ...
   pt_LaTex = pt->AddText("0.991#pm0.0236");
   pt_LaTex = pt->AddText("#minus1.45#pm0.775");
   pt_LaTex = pt->AddText("#minus1.46#pm0.779");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.464418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.464418,-66.44112,1.464418,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.616931);
   ...
   mainFit1031->SetParameter(0,-1.451475);
   mainFit1031->SetParError(0,0.775297);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9911623);
   mainFit1031->SetParError(1,0.02363994);
