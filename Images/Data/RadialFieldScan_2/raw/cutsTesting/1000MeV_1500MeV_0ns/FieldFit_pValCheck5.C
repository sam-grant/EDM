...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-53.38077,70,71.87825);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-40.85487);
   Graph_Graph01035->SetMaximum(59.35235);
   ...
   mainFit1036->SetChisquare(2.608866);
   ...
   mainFit1036->SetParameter(0,-0.9527478);
   mainFit1036->SetParError(0,0.7482261);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9865772);
   mainFit1036->SetParError(1,0.02587558);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.87");
   pt_LaTex = pt->AddText("0.987#pm0.0259");
   pt_LaTex = pt->AddText("#minus0.953#pm0.748");
   pt_LaTex = pt->AddText("#minus0.966#pm0.752");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.9657103,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9657103,-40.85487,0.9657103,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.608866);
   ...
   mainFit1037->SetParameter(0,-0.9527478);
   mainFit1037->SetParError(0,0.7482261);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9865772);
   mainFit1037->SetParError(1,0.02587558);
