...
//=========  (Thu Apr 22 00:04:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-82.45606,75,77.69331);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-66.44112);
   Graph_Graph01031->SetMaximum(61.67837);
   ...
   mainFit1032->SetChisquare(2.902893);
   ...
   mainFit1032->SetParameter(0,-1.222529);
   mainFit1032->SetParError(0,0.8215852);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9952492);
   mainFit1032->SetParError(1,0.02439648);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.968");
   pt_LaTex = pt->AddText("0.995#pm0.0244");
   pt_LaTex = pt->AddText("#minus1.22#pm0.822");
   pt_LaTex = pt->AddText("#minus1.23#pm0.818");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.228365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.228365,-66.44112,1.228365,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.902893);
   ...
   mainFit1033->SetParameter(0,-1.222529);
   mainFit1033->SetParError(0,0.8215852);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9952492);
   mainFit1033->SetParError(1,0.02439648);
