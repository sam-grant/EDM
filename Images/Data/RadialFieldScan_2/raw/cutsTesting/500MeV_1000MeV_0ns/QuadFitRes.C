...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.05704646);
   Graph_Graph11015->SetMaximum(0.02061131);
   ...
   Graph_Graph21016->SetMinimum(-0.01942231);
   Graph_Graph21016->SetMaximum(0.02275124);
   ...
   Graph_Graph31017->SetMinimum(-0.02452111);
   Graph_Graph31017->SetMaximum(0.0401488);
   ...
   Graph_Graph41018->SetMinimum(-0.006530687);
   Graph_Graph41018->SetMaximum(0.008464108);
   ...
   Graph_Graph51019->SetMinimum(-0.01238138);
   Graph_Graph51019->SetMaximum(0.009312626);
