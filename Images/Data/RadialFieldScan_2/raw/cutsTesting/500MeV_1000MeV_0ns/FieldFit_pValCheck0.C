...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-74.86845,50,50.0565);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.37596);
   Graph_Graph01025->SetMaximum(37.56401);
   ...
   mainFit1026->SetChisquare(3.360823);
   ...
   mainFit1026->SetParameter(0,-3.628573);
   mainFit1026->SetParError(0,0.8047871);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.014922);
   mainFit1026->SetParError(1,0.03184467);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.0318");
   pt_LaTex = pt->AddText("#minus3.63#pm0.805");
   pt_LaTex = pt->AddText("#minus3.58#pm0.814");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.575222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.575222,-62.37596,3.575222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.360823);
   ...
   mainFit1027->SetParameter(0,-3.628573);
   mainFit1027->SetParError(0,0.8047871);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.014922);
   mainFit1027->SetParError(1,0.03184467);
