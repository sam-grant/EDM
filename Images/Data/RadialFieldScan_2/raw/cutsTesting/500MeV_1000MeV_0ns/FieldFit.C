...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-64.75054);
   Graph_Graph01020->SetMaximum(63.68438);
   ...
   mainFit1021->SetChisquare(5.713254);
   ...
   mainFit1021->SetParameter(0,-3.159133);
   mainFit1021->SetParError(0,0.7443179);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.046378);
   mainFit1021->SetParError(1,0.02435828);
   ...
   mainFit1022->SetChisquare(5.713254);
   ...
   mainFit1022->SetParameter(0,-3.159133);
   mainFit1022->SetParError(0,0.7443179);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.046378);
   mainFit1022->SetParError(1,0.02435828);
