...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-64.75054);
   Graph_Graph01033->SetMaximum(63.68438);
   ...
   mainFit1034->SetChisquare(5.300749);
   ...
   mainFit1034->SetParameter(0,-3.523585);
   mainFit1034->SetParError(0,0.9359369);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.058157);
   mainFit1034->SetParError(1,0.03048525);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0305");
   pt_LaTex = pt->AddText("#minus3.52#pm0.936");
   pt_LaTex = pt->AddText("#minus3.33#pm0.843");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.329927,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.329927,-64.75054,3.329927,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.300749);
   ...
   mainFit1035->SetParameter(0,-3.523585);
   mainFit1035->SetParError(0,0.9359369);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.058157);
   mainFit1035->SetParError(1,0.03048525);
