...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-64.75054);
   Graph_Graph01029->SetMaximum(63.68438);
   ...
   mainFit1030->SetChisquare(5.610363);
   ...
   mainFit1030->SetParameter(0,-3.058527);
   mainFit1030->SetParError(0,0.8077187);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.046915);
   mainFit1030->SetParError(1,0.02441457);
   ...
   pt_LaTex = pt->AddText(" 1.05#pm0.0244");
   pt_LaTex = pt->AddText("#minus3.06#pm0.808");
   pt_LaTex = pt->AddText("#minus2.92#pm0.765");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.921468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.921468,-64.75054,2.921468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.610363);
   ...
   mainFit1031->SetParameter(0,-3.058527);
   mainFit1031->SetParError(0,0.8077187);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.046915);
   mainFit1031->SetParError(1,0.02441457);
