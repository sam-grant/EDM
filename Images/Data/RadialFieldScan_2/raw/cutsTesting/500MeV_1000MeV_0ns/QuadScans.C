...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.039586);
   ...
   quadLineFit1002->SetParameter(0,74.21883);
   quadLineFit1002->SetParError(0,0.1098367);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,51.14087);
   quadLineFit1002->SetParError(1,1.840601);
   ...
   quadLineFit1003->SetChisquare(2.039586);
   ...
   quadLineFit1003->SetParameter(0,74.21883);
   quadLineFit1003->SetParError(0,0.1098367);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,51.14087);
   quadLineFit1003->SetParError(1,1.840601);
   ...
   Graph_30_ppm1003->SetMinimum(75.63701);
   Graph_30_ppm1003->SetMaximum(76.36459);
   ...
   quadLineFit1004->SetChisquare(3.043079);
   ...
   quadLineFit1004->SetParameter(0,74.29146);
   quadLineFit1004->SetParError(0,0.09587402);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,27.6606);
   quadLineFit1004->SetParError(1,1.575079);
   ...
   quadLineFit1005->SetChisquare(3.043079);
   ...
   quadLineFit1005->SetParameter(0,74.29146);
   quadLineFit1005->SetParError(0,0.09587402);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,27.6606);
   quadLineFit1005->SetParError(1,1.575079);
   ...
   Graph_10_ppm1005->SetMinimum(74.55555);
   Graph_10_ppm1005->SetMaximum(74.79114);
   ...
   quadLineFit1006->SetChisquare(1.410189);
   ...
   quadLineFit1006->SetParameter(0,74.24071);
   quadLineFit1006->SetParError(0,0.1124276);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.770641);
   quadLineFit1006->SetParError(1,1.82257);
   ...
   quadLineFit1007->SetChisquare(1.410189);
   ...
   quadLineFit1007->SetParameter(0,74.24071);
   quadLineFit1007->SetParError(0,0.1124276);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.770641);
   quadLineFit1007->SetParError(1,1.82257);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.05097);
   Graph_mI10_ppm1007->SetMaximum(73.51309);
   ...
   quadLineFit1008->SetChisquare(2.974513);
   ...
   quadLineFit1008->SetParameter(0,74.26486);
   quadLineFit1008->SetParError(0,0.09868453);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-15.94777);
   quadLineFit1008->SetParError(1,1.605732);
   ...
   quadLineFit1009->SetChisquare(2.974513);
   ...
   quadLineFit1009->SetParameter(0,74.26486);
   quadLineFit1009->SetParError(0,0.09868453);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-15.94777);
   quadLineFit1009->SetParError(1,1.605732);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.5258);
   Graph_mI30_ppm1009->SetMaximum(72.4023);
   ...
   quadLineFit1010->SetChisquare(0.1521283);
   ...
   quadLineFit1010->SetParameter(0,74.04859);
   quadLineFit1010->SetParError(0,0.09299164);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.81577);
   quadLineFit1010->SetParError(1,1.608631);
   ...
   quadLineFit1011->SetChisquare(0.1521283);
   ...
   quadLineFit1011->SetParameter(0,74.04859);
   quadLineFit1011->SetParError(0,0.09299164);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.81577);
   quadLineFit1011->SetParError(1,1.608631);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.55142);
   Graph_mI50_ppm1011->SetMaximum(71.29839);
   ...
   quadLineFit1012->SetChisquare(0.3727179);
   ...
   quadLineFit1012->SetParameter(0,73.8039);
   quadLineFit1012->SetParError(0,0.1878386);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.68672);
   quadLineFit1012->SetParError(1,3.360909);
   ...
   quadLineFit1013->SetChisquare(0.3727179);
   ...
   quadLineFit1013->SetParameter(0,73.8039);
   quadLineFit1013->SetParError(0,0.1878386);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.68672);
   quadLineFit1013->SetParError(1,3.360909);
