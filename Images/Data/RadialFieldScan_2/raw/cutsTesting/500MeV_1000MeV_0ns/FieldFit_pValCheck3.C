...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-64.75054);
   Graph_Graph01031->SetMaximum(63.68438);
   ...
   mainFit1032->SetChisquare(2.871014);
   ...
   mainFit1032->SetParameter(0,-2.443015);
   mainFit1032->SetParError(0,0.8569988);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.035248);
   mainFit1032->SetParError(1,0.02523788);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.957");
   pt_LaTex = pt->AddText(" 1.04#pm0.0252");
   pt_LaTex = pt->AddText("#minus2.44#pm0.857");
   pt_LaTex = pt->AddText("#minus2.36#pm0.814");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.359835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.359835,-64.75054,2.359835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.871014);
   ...
   mainFit1033->SetParameter(0,-2.443015);
   mainFit1033->SetParError(0,0.8569988);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.035248);
   mainFit1033->SetParError(1,0.02523788);
