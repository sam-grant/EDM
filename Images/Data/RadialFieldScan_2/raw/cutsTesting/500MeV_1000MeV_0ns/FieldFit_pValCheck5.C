...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-57.52587,70,75.08294);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-44.26499);
   Graph_Graph01035->SetMaximum(61.82206);
   ...
   mainFit1036->SetChisquare(3.145343);
   ...
   mainFit1036->SetParameter(0,-3.541121);
   mainFit1036->SetParError(0,0.7815541);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.063984);
   mainFit1036->SetParError(1,0.02671992);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0267");
   pt_LaTex = pt->AddText("#minus3.54#pm0.782");
   pt_LaTex = pt->AddText("#minus3.33#pm0.716");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.328172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.328172,-44.26499,3.328172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.145343);
   ...
   mainFit1037->SetParameter(0,-3.541121);
   mainFit1037->SetParError(0,0.7815541);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.063984);
   mainFit1037->SetParError(1,0.02671992);
