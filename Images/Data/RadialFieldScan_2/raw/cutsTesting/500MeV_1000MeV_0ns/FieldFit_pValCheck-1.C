...
//=========  (Wed Apr 21 17:36:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-64.75054);
   Graph_Graph01023->SetMaximum(63.68438);
   ...
   mainFit1024->SetChisquare(5.713254);
   ...
   mainFit1024->SetParameter(0,-3.159133);
   mainFit1024->SetParError(0,0.7443179);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.046378);
   mainFit1024->SetParError(1,0.02435828);
   ...
   pt_LaTex = pt->AddText("#minus3.16#pm0.744");
   pt_LaTex = pt->AddText("#minus3.02#pm0.702");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.019113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.019113,-64.75054,3.019113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.713254);
   ...
   mainFit1025->SetParameter(0,-3.159133);
   mainFit1025->SetParError(0,0.7443179);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.046378);
   mainFit1025->SetParError(1,0.02435828);
