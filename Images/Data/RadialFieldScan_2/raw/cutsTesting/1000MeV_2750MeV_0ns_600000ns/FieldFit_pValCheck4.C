...
//=========  (Mon Apr 26 22:25:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.10063);
   Graph_Graph01033->SetMaximum(53.84978);
   ...
   mainFit1034->SetChisquare(1.68797);
   ...
   mainFit1034->SetParameter(0,-1.32622);
   mainFit1034->SetParError(0,0.4974353);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8968877);
   mainFit1034->SetParError(1,0.0161804);
   ...
   pt_LaTex = pt->AddText("0.897#pm0.0162");
   pt_LaTex = pt->AddText("#minus1.33#pm0.497");
   pt_LaTex = pt->AddText("#minus1.48#pm0.542");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.478691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.478691,-58.10063,1.478691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.68797);
   ...
   mainFit1035->SetParameter(0,-1.32622);
   mainFit1035->SetParError(0,0.4974353);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8968877);
   mainFit1035->SetParError(1,0.0161804);
