...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.10063);
   Graph_Graph01023->SetMaximum(53.84978);
   ...
   mainFit1024->SetChisquare(1.860864);
   ...
   mainFit1024->SetParameter(0,-1.451589);
   mainFit1024->SetParError(0,0.3956429);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9009306);
   mainFit1024->SetParError(1,0.01293326);
   ...
   mainFit1025->SetChisquare(1.860864);
   ...
   mainFit1025->SetParameter(0,-1.451589);
   mainFit1025->SetParError(0,0.3956429);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9009306);
   mainFit1025->SetParError(1,0.01293326);
