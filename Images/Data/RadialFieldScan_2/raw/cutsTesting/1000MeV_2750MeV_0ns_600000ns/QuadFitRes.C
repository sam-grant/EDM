...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006232097);
   Graph_Graph11015->SetMaximum(0.006097426);
   ...
   Graph_Graph21016->SetMinimum(-0.01147015);
   Graph_Graph21016->SetMaximum(0.01346635);
   ...
   Graph_Graph31017->SetMinimum(-0.01394254);
   Graph_Graph31017->SetMaximum(0.0141422);
   ...
   Graph_Graph41018->SetMinimum(-0.01539025);
   Graph_Graph41018->SetMaximum(0.0209188);
   ...
   Graph_Graph51019->SetMinimum(-0.007355352);
   Graph_Graph51019->SetMaximum(0.00981351);
