...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.42526,50,44.49771);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.23296);
   Graph_Graph01025->SetMaximum(33.30541);
   ...
   mainFit1026->SetChisquare(1.855981);
   ...
   mainFit1026->SetParameter(0,-1.440213);
   mainFit1026->SetParError(0,0.4278286);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.901695);
   mainFit1026->SetParError(1,0.01693952);
   ...
   pt_LaTex = pt->AddText("#minus1.44#pm0.428");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.597228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.597228,-56.23296,1.597228,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.855981);
   ...
   mainFit1027->SetParameter(0,-1.440213);
   mainFit1027->SetParError(0,0.4278286);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.901695);
   mainFit1027->SetParError(1,0.01693952);
