...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.09443,75,67.84358);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-58.10063);
   Graph_Graph01027->SetMaximum(53.84978);
   ...
   mainFit1028->SetChisquare(1.137507);
   ...
   mainFit1028->SetParameter(0,-1.287541);
   mainFit1028->SetParError(0,0.4401563);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9061451);
   mainFit1028->SetParError(1,0.01431295);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.379");
   pt_LaTex = pt->AddText("0.906#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.29#pm 0.44");
   pt_LaTex = pt->AddText("#minus1.42#pm0.487");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.420899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.420899,-58.10063,1.420899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.137507);
   ...
   mainFit1029->SetParameter(0,-1.287541);
   mainFit1029->SetParError(0,0.4401563);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9061451);
   mainFit1029->SetParError(1,0.01431295);
