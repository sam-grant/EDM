...
//=========  (Mon Apr 26 22:25:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.10063);
   Graph_Graph01031->SetMaximum(53.84978);
   ...
   mainFit1032->SetChisquare(1.80819);
   ...
   mainFit1032->SetParameter(0,-1.503547);
   mainFit1032->SetParError(0,0.4558352);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9017416);
   mainFit1032->SetParError(1,0.01340735);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.603");
   pt_LaTex = pt->AddText("0.902#pm0.0134");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.456");
   pt_LaTex = pt->AddText("#minus1.67#pm0.499");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.667382,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.667382,-58.10063,1.667382,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.80819);
   ...
   mainFit1033->SetParameter(0,-1.503547);
   mainFit1033->SetParError(0,0.4558352);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9017416);
   mainFit1033->SetParError(1,0.01340735);
