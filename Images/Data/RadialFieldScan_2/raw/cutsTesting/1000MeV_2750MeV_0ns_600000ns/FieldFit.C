...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.10063);
   Graph_Graph01020->SetMaximum(53.84978);
   ...
   mainFit1021->SetChisquare(1.860864);
   ...
   mainFit1021->SetParameter(0,-1.451589);
   mainFit1021->SetParError(0,0.3956429);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9009306);
   mainFit1021->SetParError(1,0.01293326);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0129");
   pt_LaTex = pt->AddText("#minus1.45#pm0.396");
   pt_LaTex = pt->AddText("#minus1.61#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.611211,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.611211,-58.10063,1.611211,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.860864);
   ...
   mainFit1022->SetParameter(0,-1.451589);
   mainFit1022->SetParError(0,0.3956429);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9009306);
   mainFit1022->SetParError(1,0.01293326);
