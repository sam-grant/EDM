...
//=========  (Mon Apr 26 22:25:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.11752,70,63.0482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.00095);
   ...
   mainFit1036->SetChisquare(1.768589);
   ...
   mainFit1036->SetParameter(0,-1.413023);
   mainFit1036->SetParError(0,0.4155142);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8991611);
   mainFit1036->SetParError(1,0.01418444);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.59");
   pt_LaTex = pt->AddText("0.899#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.41#pm0.416");
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.57149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.57149,-37.00095,1.57149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.768589);
   ...
   mainFit1037->SetParameter(0,-1.413023);
   mainFit1037->SetParError(0,0.4155142);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8991611);
   mainFit1037->SetParError(1,0.01418444);
