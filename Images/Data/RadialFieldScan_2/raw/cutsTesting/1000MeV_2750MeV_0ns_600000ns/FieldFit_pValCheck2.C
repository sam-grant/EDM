...
//=========  (Mon Apr 26 22:25:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.10063);
   Graph_Graph01029->SetMaximum(53.84978);
   ...
   mainFit1030->SetChisquare(0.428259);
   ...
   mainFit1030->SetParameter(0,-1.650858);
   mainFit1030->SetParError(0,0.4292464);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8999016);
   mainFit1030->SetParError(1,0.01296167);
   ...
   pt_LaTex = pt->AddText("  0.9#pm0.013");
   pt_LaTex = pt->AddText("#minus1.65#pm0.429");
   pt_LaTex = pt->AddText("#minus1.83#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.834487,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.834487,-58.10063,1.834487,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.428259);
   ...
   mainFit1031->SetParameter(0,-1.650858);
   mainFit1031->SetParError(0,0.4292464);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8999016);
   mainFit1031->SetParError(1,0.01296167);
