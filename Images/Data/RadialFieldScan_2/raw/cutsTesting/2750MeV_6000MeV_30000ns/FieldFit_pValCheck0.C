...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.4008,50,47.04086);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.45664);
   Graph_Graph01025->SetMaximum(35.09669);
   ...
   mainFit1026->SetChisquare(4.023805);
   ...
   mainFit1026->SetParameter(0,0.09715085);
   mainFit1026->SetParError(0,1.363882);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8415853);
   mainFit1026->SetParError(1,0.05398279);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.054");
   pt_LaTex = pt->AddText("0.0972#pm 1.36");
   pt_LaTex = pt->AddText("0.115#pm 1.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.1154379,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1154379,-60.45664,-0.1154379,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.023805);
   ...
   mainFit1027->SetParameter(0,0.09715085);
   mainFit1027->SetParError(0,1.363882);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8415853);
   mainFit1027->SetParError(1,0.05398279);
