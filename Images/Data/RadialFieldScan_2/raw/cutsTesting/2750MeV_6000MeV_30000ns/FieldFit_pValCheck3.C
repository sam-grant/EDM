...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-76.59557,75,68.01469);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-62.13454);
   Graph_Graph01031->SetMaximum(53.55367);
   ...
   mainFit1032->SetChisquare(0.3722145);
   ...
   mainFit1032->SetParameter(0,-1.474099);
   mainFit1032->SetParError(0,1.458251);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8519189);
   mainFit1032->SetParError(1,0.04332971);
   ...
   pt_LaTex = pt->AddText("0.852#pm0.0433");
   pt_LaTex = pt->AddText("#minus1.47#pm 1.46");
   pt_LaTex = pt->AddText("#minus1.73#pm 1.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.730328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.730328,-62.13454,1.730328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.3722145);
   ...
   mainFit1033->SetParameter(0,-1.474099);
   mainFit1033->SetParError(0,1.458251);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8519189);
   mainFit1033->SetParError(1,0.04332971);
