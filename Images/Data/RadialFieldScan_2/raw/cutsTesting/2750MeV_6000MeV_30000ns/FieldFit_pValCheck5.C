...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.15853,70,62.12729);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.22994);
   Graph_Graph01035->SetMaximum(51.1987);
   ...
   mainFit1036->SetChisquare(3.076421);
   ...
   mainFit1036->SetParameter(0,0.3411415);
   mainFit1036->SetParError(0,1.328237);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8107255);
   mainFit1036->SetParError(1,0.04597211);
   ...
   pt_LaTex = pt->AddText("0.811#pm0.046");
   pt_LaTex = pt->AddText("0.341#pm 1.33");
   pt_LaTex = pt->AddText("0.421#pm 1.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4207855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4207855,-36.22994,-0.4207855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.076421);
   ...
   mainFit1037->SetParameter(0,0.3411415);
   mainFit1037->SetParError(0,1.328237);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8107255);
   mainFit1037->SetParError(1,0.04597211);
