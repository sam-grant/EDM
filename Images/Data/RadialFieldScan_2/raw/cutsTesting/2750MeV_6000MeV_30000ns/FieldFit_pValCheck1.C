...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-62.13454);
   Graph_Graph01027->SetMaximum(53.55367);
   ...
   mainFit1028->SetChisquare(4.103843);
   ...
   mainFit1028->SetParameter(0,0.04037785);
   mainFit1028->SetParError(0,1.41862);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8339097);
   mainFit1028->SetParError(1,0.04679672);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0468");
   pt_LaTex = pt->AddText("0.0404#pm 1.42");
   pt_LaTex = pt->AddText("0.0484#pm  1.7");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.04841993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.04841993,-62.13454,-0.04841993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.103843);
   ...
   mainFit1029->SetParameter(0,0.04037785);
   mainFit1029->SetParError(0,1.41862);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8339097);
   mainFit1029->SetParError(1,0.04679672);
