...
//=========  (Wed Apr 21 21:59:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-62.13454);
   Graph_Graph01020->SetMaximum(53.55367);
   ...
   mainFit1021->SetChisquare(4.134329);
   ...
   mainFit1021->SetParameter(0,-0.07129316);
   mainFit1021->SetParError(0,1.266264);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8302591);
   mainFit1021->SetParError(1,0.04186597);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0419");
   pt_LaTex = pt->AddText("#minus0.0713#pm 1.27");
   pt_LaTex = pt->AddText("#minus0.0859#pm 1.52");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.08586857,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.08586857,-62.13454,0.08586857,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.134329);
   ...
   mainFit1022->SetParameter(0,-0.07129316);
   mainFit1022->SetParError(0,1.266264);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8302591);
   mainFit1022->SetParError(1,0.04186597);
