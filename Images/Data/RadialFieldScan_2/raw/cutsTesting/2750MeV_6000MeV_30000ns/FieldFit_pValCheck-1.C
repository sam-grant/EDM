...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.13454);
   Graph_Graph01023->SetMaximum(53.55367);
   ...
   mainFit1024->SetChisquare(4.134329);
   ...
   mainFit1024->SetParameter(0,-0.07129316);
   mainFit1024->SetParError(0,1.266264);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8302591);
   mainFit1024->SetParError(1,0.04186597);
   ...
   mainFit1025->SetChisquare(4.134329);
   ...
   mainFit1025->SetParameter(0,-0.07129316);
   mainFit1025->SetParError(0,1.266264);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8302591);
   mainFit1025->SetParError(1,0.04186597);
