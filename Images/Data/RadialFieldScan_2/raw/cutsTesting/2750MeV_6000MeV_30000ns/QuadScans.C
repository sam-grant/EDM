...
//=========  (Wed Apr 21 21:59:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.032936);
   ...
   quadLineFit1002->SetParameter(0,75.2353);
   quadLineFit1002->SetParError(0,0.1933582);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.67014);
   quadLineFit1002->SetParError(1,3.242848);
   ...
   quadLineFit1003->SetChisquare(4.032936);
   ...
   quadLineFit1003->SetParameter(0,75.2353);
   quadLineFit1003->SetParError(0,0.1933582);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.67014);
   quadLineFit1003->SetParError(1,3.242848);
   ...
   Graph_30_ppm1003->SetMinimum(76.28753);
   Graph_30_ppm1003->SetMaximum(76.98988);
   ...
   quadLineFit1004->SetChisquare(1.122435);
   ...
   quadLineFit1004->SetParameter(0,75.13223);
   quadLineFit1004->SetParError(0,0.1620695);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.46878);
   quadLineFit1004->SetParError(1,2.665136);
   ...
   quadLineFit1005->SetChisquare(1.122435);
   ...
   quadLineFit1005->SetParameter(0,75.13223);
   quadLineFit1005->SetParError(0,0.1620695);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.46878);
   quadLineFit1005->SetParError(1,2.665136);
   ...
   Graph_10_ppm1005->SetMinimum(75.44585);
   Graph_10_ppm1005->SetMaximum(75.73668);
   ...
   quadLineFit1006->SetChisquare(2.908628);
   ...
   quadLineFit1006->SetParameter(0,75.13999);
   quadLineFit1006->SetParError(0,0.1904299);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.688537);
   quadLineFit1006->SetParError(1,3.088841);
   ...
   quadLineFit1007->SetChisquare(2.908628);
   ...
   quadLineFit1007->SetParameter(0,75.13999);
   quadLineFit1007->SetParError(0,0.1904299);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.688537);
   quadLineFit1007->SetParError(1,3.088841);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.39613);
   Graph_mI10_ppm1007->SetMaximum(74.68875);
   ...
   quadLineFit1008->SetChisquare(8.210048);
   ...
   quadLineFit1008->SetParameter(0,74.76151);
   quadLineFit1008->SetParError(0,0.1670887);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-3.844445);
   quadLineFit1008->SetParError(1,2.72084);
   ...
   quadLineFit1009->SetChisquare(8.210048);
   ...
   quadLineFit1009->SetParameter(0,74.76151);
   quadLineFit1009->SetParError(0,0.1670887);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-3.844445);
   quadLineFit1009->SetParError(1,2.72084);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.01711);
   Graph_mI30_ppm1009->SetMaximum(73.74957);
   ...
   quadLineFit1010->SetChisquare(0.2897628);
   ...
   quadLineFit1010->SetParameter(0,74.99377);
   quadLineFit1010->SetParError(0,0.1579405);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.21012);
   quadLineFit1010->SetParError(1,2.734104);
   ...
   quadLineFit1011->SetChisquare(0.2897628);
   ...
   quadLineFit1011->SetParameter(0,74.99377);
   quadLineFit1011->SetParError(0,0.1579405);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.21012);
   quadLineFit1011->SetParError(1,2.734104);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.10273);
   Graph_mI50_ppm1011->SetMaximum(72.8406);
   ...
   quadLineFit1012->SetChisquare(0.003556005);
   ...
   quadLineFit1012->SetParameter(0,75.13918);
   quadLineFit1012->SetParError(0,0.318623);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.79363);
   quadLineFit1012->SetParError(1,5.700225);
   ...
   quadLineFit1013->SetChisquare(0.003556005);
   ...
   quadLineFit1013->SetParameter(0,75.13918);
   quadLineFit1013->SetParError(0,0.318623);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.79363);
   quadLineFit1013->SetParError(1,5.700225);
