...
//=========  (Wed Apr 21 21:59:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.06025036);
   Graph_Graph11015->SetMaximum(0.01896572);
   ...
   Graph_Graph21016->SetMinimum(-0.04734414);
   Graph_Graph21016->SetMaximum(0.05573302);
   ...
   Graph_Graph31017->SetMinimum(-0.1015265);
   Graph_Graph31017->SetMaximum(0.07643482);
   ...
   Graph_Graph41018->SetMinimum(-0.01907514);
   Graph_Graph41018->SetMaximum(0.01104417);
   ...
   Graph_Graph51019->SetMinimum(-0.001543404);
   Graph_Graph51019->SetMaximum(0.002062762);
