...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.13454);
   Graph_Graph01029->SetMaximum(53.55367);
   ...
   mainFit1030->SetChisquare(3.834312);
   ...
   mainFit1030->SetParameter(0,0.2239165);
   mainFit1030->SetParError(0,1.376175);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.832);
   mainFit1030->SetParError(1,0.04198713);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.042");
   pt_LaTex = pt->AddText("0.224#pm 1.38");
   pt_LaTex = pt->AddText("0.269#pm 1.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2691304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2691304,-62.13454,-0.2691304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.834312);
   ...
   mainFit1031->SetParameter(0,0.2239165);
   mainFit1031->SetParError(0,1.376175);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.832);
   mainFit1031->SetParError(1,0.04198713);
