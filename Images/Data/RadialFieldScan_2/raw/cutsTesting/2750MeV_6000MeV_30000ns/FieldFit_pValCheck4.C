...
//=========  (Wed Apr 21 21:59:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-62.13454);
   Graph_Graph01033->SetMaximum(53.55367);
   ...
   mainFit1034->SetChisquare(3.733554);
   ...
   mainFit1034->SetParameter(0,0.5342128);
   mainFit1034->SetParError(0,1.586898);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.810357);
   mainFit1034->SetParError(1,0.05235526);
   ...
   pt_LaTex = pt->AddText(" 0.81#pm0.0524");
   pt_LaTex = pt->AddText("0.534#pm 1.59");
   pt_LaTex = pt->AddText("0.659#pm 1.98");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6592314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6592314,-62.13454,-0.6592314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.733554);
   ...
   mainFit1035->SetParameter(0,0.5342128);
   mainFit1035->SetParError(0,1.586898);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.810357);
   mainFit1035->SetParError(1,0.05235526);
