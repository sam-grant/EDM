...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.16154);
   Graph_Graph01023->SetMaximum(56.2297);
   ...
   mainFit1024->SetChisquare(4.280442);
   ...
   mainFit1024->SetParameter(0,-1.819513);
   mainFit1024->SetParError(0,0.7495582);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9082058);
   mainFit1024->SetParError(1,0.02478738);
   ...
   mainFit1025->SetChisquare(4.280442);
   ...
   mainFit1025->SetParameter(0,-1.819513);
   mainFit1025->SetParError(0,0.7495582);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9082058);
   mainFit1025->SetParError(1,0.02478738);
