...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.16154);
   Graph_Graph01031->SetMaximum(56.2297);
   ...
   mainFit1032->SetChisquare(1.569972);
   ...
   mainFit1032->SetParameter(0,-2.523756);
   mainFit1032->SetParError(0,0.8630207);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9190625);
   mainFit1032->SetParError(1,0.02564855);
   ...
   pt_LaTex = pt->AddText("0.919#pm0.0256");
   pt_LaTex = pt->AddText("#minus2.52#pm0.863");
   pt_LaTex = pt->AddText("#minus2.75#pm0.922");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.746011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.746011,-63.16154,2.746011,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.569972);
   ...
   mainFit1033->SetParameter(0,-2.523756);
   mainFit1033->SetParError(0,0.8630207);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9190625);
   mainFit1033->SetParError(1,0.02564855);
