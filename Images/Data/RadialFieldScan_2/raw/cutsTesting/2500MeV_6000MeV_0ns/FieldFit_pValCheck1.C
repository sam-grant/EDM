...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.16154);
   Graph_Graph01027->SetMaximum(56.2297);
   ...
   mainFit1028->SetChisquare(4.100406);
   ...
   mainFit1028->SetParameter(0,-1.658507);
   mainFit1028->SetParError(0,0.8401621);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9134782);
   mainFit1028->SetParError(1,0.02772196);
   ...
   pt_LaTex = pt->AddText("0.913#pm0.0277");
   pt_LaTex = pt->AddText("#minus1.66#pm 0.84");
   pt_LaTex = pt->AddText("#minus1.82#pm0.925");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.815595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.815595,-63.16154,1.815595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.100406);
   ...
   mainFit1029->SetParameter(0,-1.658507);
   mainFit1029->SetParError(0,0.8401621);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9134782);
   mainFit1029->SetParError(1,0.02772196);
