...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.90111,70,65.51674);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.35932);
   Graph_Graph01035->SetMaximum(53.97495);
   ...
   mainFit1036->SetChisquare(3.520561);
   ...
   mainFit1036->SetParameter(0,-1.612795);
   mainFit1036->SetParError(0,0.7861837);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8984067);
   mainFit1036->SetParError(1,0.0272203);
   ...
   pt_LaTex = pt->AddText("0.898#pm0.0272");
   pt_LaTex = pt->AddText("#minus1.61#pm0.786");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.862");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.795172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.795172,-38.35932,1.795172,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.520561);
   ...
   mainFit1037->SetParameter(0,-1.612795);
   mainFit1037->SetParError(0,0.7861837);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8984067);
   mainFit1037->SetParError(1,0.0272203);
