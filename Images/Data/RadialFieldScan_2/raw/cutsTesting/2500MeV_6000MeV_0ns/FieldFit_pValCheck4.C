...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.16154);
   Graph_Graph01033->SetMaximum(56.2297);
   ...
   mainFit1034->SetChisquare(4.280201);
   ...
   mainFit1034->SetParameter(0,-1.828338);
   mainFit1034->SetParError(0,0.9394737);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9085017);
   mainFit1034->SetParError(1,0.03100302);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.031");
   pt_LaTex = pt->AddText("#minus1.83#pm0.939");
   pt_LaTex = pt->AddText("#minus2.01#pm    1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.012476,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.012476,-63.16154,2.012476,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.280201);
   ...
   mainFit1035->SetParameter(0,-1.828338);
   mainFit1035->SetParError(0,0.9394737);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9085017);
   mainFit1035->SetParError(1,0.03100302);
