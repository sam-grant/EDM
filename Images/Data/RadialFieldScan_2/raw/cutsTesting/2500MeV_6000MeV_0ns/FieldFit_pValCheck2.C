...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-78.08545,75,71.15361);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-63.16154);
   Graph_Graph01029->SetMaximum(56.2297);
   ...
   mainFit1030->SetChisquare(2.582598);
   ...
   mainFit1030->SetParameter(0,-1.404214);
   mainFit1030->SetParError(0,0.8145128);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9106891);
   mainFit1030->SetParError(1,0.02486019);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.861");
   pt_LaTex = pt->AddText("0.911#pm0.0249");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.815");
   pt_LaTex = pt->AddText("#minus1.54#pm 0.89");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.541924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.541924,-63.16154,1.541924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.582598);
   ...
   mainFit1031->SetParameter(0,-1.404214);
   mainFit1031->SetParError(0,0.8145128);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9106891);
   mainFit1031->SetParError(1,0.02486019);
