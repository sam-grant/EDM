...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.16154);
   Graph_Graph01020->SetMaximum(56.2297);
   ...
   mainFit1021->SetChisquare(4.280442);
   ...
   mainFit1021->SetParameter(0,-1.819513);
   mainFit1021->SetParError(0,0.7495582);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9082058);
   mainFit1021->SetParError(1,0.02478738);
   ...
   pt_LaTex = pt->AddText("0.908#pm0.0248");
   pt_LaTex = pt->AddText("#minus1.82#pm 0.75");
   pt_LaTex = pt->AddText("   #minus2#pm0.818");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.003415,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.003415,-63.16154,2.003415,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.280442);
   ...
   mainFit1022->SetParameter(0,-1.819513);
   mainFit1022->SetParError(0,0.7495582);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9082058);
   mainFit1022->SetParError(1,0.02478738);
