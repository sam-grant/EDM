...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.534248);
   ...
   quadLineFit1002->SetParameter(0,75.13251);
   quadLineFit1002->SetParError(0,0.1147493);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.35719);
   quadLineFit1002->SetParError(1,1.923236);
   ...
   quadLineFit1003->SetChisquare(1.534248);
   ...
   quadLineFit1003->SetParameter(0,75.13251);
   quadLineFit1003->SetParError(0,0.1147493);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.35719);
   quadLineFit1003->SetParError(1,1.923236);
   ...
   Graph_30_ppm1003->SetMinimum(76.39237);
   Graph_30_ppm1003->SetMaximum(77.05223);
   ...
   quadLineFit1004->SetChisquare(6.323612);
   ...
   quadLineFit1004->SetParameter(0,75.17582);
   quadLineFit1004->SetParError(0,0.09601555);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.8983);
   quadLineFit1004->SetParError(1,1.577407);
   ...
   quadLineFit1005->SetChisquare(6.323612);
   ...
   quadLineFit1005->SetParameter(0,75.17582);
   quadLineFit1005->SetParError(0,0.09601555);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.8983);
   quadLineFit1005->SetParError(1,1.577407);
   ...
   Graph_10_ppm1005->SetMinimum(75.46546);
   Graph_10_ppm1005->SetMaximum(75.66644);
   ...
   quadLineFit1006->SetChisquare(3.910316);
   ...
   quadLineFit1006->SetParameter(0,75.22615);
   quadLineFit1006->SetParError(0,0.1129479);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,5.087182);
   quadLineFit1006->SetParError(1,1.830622);
   ...
   quadLineFit1007->SetChisquare(3.910316);
   ...
   quadLineFit1007->SetParameter(0,75.22615);
   quadLineFit1007->SetParError(0,0.1129479);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,5.087182);
   quadLineFit1007->SetParError(1,1.830622);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.3244);
   Graph_mI10_ppm1007->SetMaximum(74.65877);
   ...
   quadLineFit1008->SetChisquare(12.96169);
   ...
   quadLineFit1008->SetParameter(0,74.9893);
   quadLineFit1008->SetParError(0,0.09902283);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.624899);
   quadLineFit1008->SetParError(1,1.610939);
   ...
   quadLineFit1009->SetChisquare(12.96169);
   ...
   quadLineFit1009->SetParameter(0,74.9893);
   quadLineFit1009->SetParError(0,0.09902283);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.624899);
   quadLineFit1009->SetParError(1,1.610939);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.93681);
   Graph_mI30_ppm1009->SetMaximum(73.66513);
   ...
   quadLineFit1010->SetChisquare(6.929783);
   ...
   quadLineFit1010->SetParameter(0,75.06585);
   quadLineFit1010->SetParError(0,0.09348972);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.04804);
   quadLineFit1010->SetParError(1,1.616762);
   ...
   quadLineFit1011->SetChisquare(6.929783);
   ...
   quadLineFit1011->SetParameter(0,75.06585);
   quadLineFit1011->SetParError(0,0.09348972);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.04804);
   quadLineFit1011->SetParError(1,1.616762);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.00295);
   Graph_mI50_ppm1011->SetMaximum(72.73657);
   ...
   quadLineFit1012->SetChisquare(0.6344795);
   ...
   quadLineFit1012->SetParameter(0,75.21701);
   quadLineFit1012->SetParError(0,0.1885039);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.84101);
   quadLineFit1012->SetParError(1,3.371268);
   ...
   quadLineFit1013->SetChisquare(0.6344795);
   ...
   quadLineFit1013->SetParameter(0,75.21701);
   quadLineFit1013->SetParError(0,0.1885039);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.84101);
   quadLineFit1013->SetParError(1,3.371268);
