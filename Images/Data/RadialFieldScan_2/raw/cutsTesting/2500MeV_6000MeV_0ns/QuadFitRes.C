...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08211921);
   Graph_Graph11015->SetMaximum(0.03059685);
   ...
   Graph_Graph21016->SetMinimum(-0.03238978);
   Graph_Graph21016->SetMaximum(0.03800408);
   ...
   Graph_Graph31017->SetMinimum(-0.08019743);
   Graph_Graph31017->SetMaximum(0.06888687);
   ...
   Graph_Graph41018->SetMinimum(-0.07695123);
   Graph_Graph41018->SetMaximum(0.04593117);
   ...
   Graph_Graph51019->SetMinimum(-0.01227622);
   Graph_Graph51019->SetMaximum(0.01631158);
