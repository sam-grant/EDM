...
//=========  (Wed Apr 21 21:27:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.13427,50,46.39771);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.18107);
   Graph_Graph01025->SetMaximum(34.44451);
   ...
   mainFit1026->SetChisquare(3.971197);
   ...
   mainFit1026->SetParameter(0,-1.986382);
   mainFit1026->SetParError(0,0.8073766);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8970105);
   mainFit1026->SetParError(1,0.03194013);
   ...
   pt_LaTex = pt->AddText("0.897#pm0.0319");
   pt_LaTex = pt->AddText("#minus1.99#pm0.807");
   pt_LaTex = pt->AddText("#minus2.21#pm0.913");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.214447,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.214447,-61.18107,2.214447,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.971197);
   ...
   mainFit1027->SetParameter(0,-1.986382);
   mainFit1027->SetParError(0,0.8073766);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8970105);
   mainFit1027->SetParError(1,0.03194013);
