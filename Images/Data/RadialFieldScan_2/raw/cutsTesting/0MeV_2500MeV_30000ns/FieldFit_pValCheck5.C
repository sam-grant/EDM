...
//=========  (Fri Apr 23 12:22:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.42907,70,66.57582);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.72858);
   Graph_Graph01035->SetMaximum(54.87533);
   ...
   mainFit1036->SetChisquare(4.097337);
   ...
   mainFit1036->SetParameter(0,-2.138856);
   mainFit1036->SetParError(0,0.4541758);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9422357);
   mainFit1036->SetParError(1,0.01571308);
   ...
   pt_LaTex = pt->AddText("0.942#pm0.0157");
   pt_LaTex = pt->AddText("#minus2.14#pm0.454");
   pt_LaTex = pt->AddText("#minus2.27#pm0.473");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.26998,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.26998,-38.72858,2.26998,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.097337);
   ...
   mainFit1037->SetParameter(0,-2.138856);
   mainFit1037->SetParError(0,0.4541758);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9422357);
   mainFit1037->SetParError(1,0.01571308);
