...
//=========  (Fri Apr 23 12:22:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-62.57824);
   Graph_Graph01031->SetMaximum(57.04348);
   ...
   mainFit1032->SetChisquare(4.081679);
   ...
   mainFit1032->SetParameter(0,-2.065103);
   mainFit1032->SetParError(0,0.4987232);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9438942);
   mainFit1032->SetParError(1,0.0148153);
   ...
   pt_LaTex = pt->AddText("0.944#pm0.0148");
   pt_LaTex = pt->AddText("#minus2.07#pm0.499");
   pt_LaTex = pt->AddText("#minus2.19#pm 0.52");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.187854,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.187854,-62.57824,2.187854,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.081679);
   ...
   mainFit1033->SetParameter(0,-2.065103);
   mainFit1033->SetParError(0,0.4987232);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9438942);
   mainFit1033->SetParError(1,0.0148153);
