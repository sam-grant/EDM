...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-62.57824);
   Graph_Graph01020->SetMaximum(57.04348);
   ...
   mainFit1021->SetChisquare(4.507399);
   ...
   mainFit1021->SetParameter(0,-2.226466);
   mainFit1021->SetParError(0,0.4330728);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9463798);
   mainFit1021->SetParError(1,0.01431524);
   ...
   mainFit1022->SetChisquare(4.507399);
   ...
   mainFit1022->SetParameter(0,-2.226466);
   mainFit1022->SetParError(0,0.4330728);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9463798);
   mainFit1022->SetParError(1,0.01431524);
