...
//=========  (Fri Apr 23 12:22:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.57824);
   Graph_Graph01029->SetMaximum(57.04348);
   ...
   mainFit1030->SetChisquare(3.325022);
   ...
   mainFit1030->SetParameter(0,-2.427112);
   mainFit1030->SetParError(0,0.4707405);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9451978);
   mainFit1030->SetParError(1,0.01435678);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0144");
   pt_LaTex = pt->AddText("#minus2.43#pm0.471");
   pt_LaTex = pt->AddText("#minus2.57#pm0.495");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.567835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.567835,-62.57824,2.567835,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.325022);
   ...
   mainFit1031->SetParameter(0,-2.427112);
   mainFit1031->SetParError(0,0.4707405);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9451978);
   mainFit1031->SetParError(1,0.01435678);
