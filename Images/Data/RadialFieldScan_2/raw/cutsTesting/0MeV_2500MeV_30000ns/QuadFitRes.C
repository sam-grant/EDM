...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01068213);
   Graph_Graph11015->SetMaximum(0.01110115);
   ...
   Graph_Graph21016->SetMinimum(-0.008704884);
   Graph_Graph21016->SetMaximum(0.01022499);
   ...
   Graph_Graph31017->SetMinimum(-0.01999104);
   Graph_Graph31017->SetMaximum(0.01820917);
   ...
   Graph_Graph41018->SetMinimum(-0.008070331);
   Graph_Graph41018->SetMaximum(0.01288407);
   ...
   Graph_Graph51019->SetMinimum(-0.002595831);
   Graph_Graph51019->SetMaximum(0.003466697);
