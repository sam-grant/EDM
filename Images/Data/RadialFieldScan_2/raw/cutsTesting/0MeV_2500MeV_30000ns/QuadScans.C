...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4090073);
   ...
   quadLineFit1002->SetParameter(0,74.35172);
   quadLineFit1002->SetParError(0,0.06600258);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.96795);
   quadLineFit1002->SetParError(1,1.107053);
   ...
   quadLineFit1003->SetChisquare(0.4090073);
   ...
   quadLineFit1003->SetParameter(0,74.35172);
   quadLineFit1003->SetParError(0,0.06600258);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.96795);
   quadLineFit1003->SetParError(1,1.107053);
   ...
   Graph_30_ppm1003->SetMinimum(75.65743);
   Graph_30_ppm1003->SetMaximum(76.28494);
   ...
   quadLineFit1004->SetChisquare(0.9790177);
   ...
   quadLineFit1004->SetParameter(0,74.43879);
   quadLineFit1004->SetParError(0,0.05560091);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.93394);
   quadLineFit1004->SetParError(1,0.9136283);
   ...
   quadLineFit1005->SetChisquare(0.9790177);
   ...
   quadLineFit1005->SetParameter(0,74.43879);
   quadLineFit1005->SetParError(0,0.05560091);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.93394);
   quadLineFit1005->SetParError(1,0.9136283);
   ...
   Graph_10_ppm1005->SetMinimum(74.64938);
   Graph_10_ppm1005->SetMaximum(74.89021);
   ...
   quadLineFit1006->SetChisquare(0.8433337);
   ...
   quadLineFit1006->SetParameter(0,74.25357);
   quadLineFit1006->SetParError(0,0.06509319);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.283774);
   quadLineFit1006->SetParError(1,1.055528);
   ...
   quadLineFit1007->SetChisquare(0.8433337);
   ...
   quadLineFit1007->SetParameter(0,74.25357);
   quadLineFit1007->SetParError(0,0.06509319);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.283774);
   quadLineFit1007->SetParError(1,1.055528);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.37193);
   Graph_mI10_ppm1007->SetMaximum(73.71753);
   ...
   quadLineFit1008->SetChisquare(2.971165);
   ...
   quadLineFit1008->SetParameter(0,74.29039);
   quadLineFit1008->SetParError(0,0.05718008);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.21145);
   quadLineFit1008->SetParError(1,0.930562);
   ...
   quadLineFit1009->SetChisquare(2.971165);
   ...
   quadLineFit1009->SetParameter(0,74.29039);
   quadLineFit1009->SetParError(0,0.05718008);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.21145);
   quadLineFit1009->SetParError(1,0.930562);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.97927);
   Graph_mI30_ppm1009->SetMaximum(72.73683);
   ...
   quadLineFit1010->SetChisquare(1.296279);
   ...
   quadLineFit1010->SetParameter(0,74.20779);
   quadLineFit1010->SetParError(0,0.05399442);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.99388);
   quadLineFit1010->SetParError(1,0.9343716);
   ...
   quadLineFit1011->SetChisquare(1.296279);
   ...
   quadLineFit1011->SetParameter(0,74.20779);
   quadLineFit1011->SetParError(0,0.05399442);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.99388);
   quadLineFit1011->SetParError(1,0.9343716);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.03889);
   Graph_mI50_ppm1011->SetMaximum(71.75758);
   ...
   quadLineFit1012->SetChisquare(0.08607292);
   ...
   quadLineFit1012->SetParameter(0,74.28362);
   quadLineFit1012->SetParError(0,0.1091243);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.65719);
   quadLineFit1012->SetParError(1,1.952569);
   ...
   quadLineFit1013->SetChisquare(0.08607292);
   ...
   quadLineFit1013->SetParameter(0,74.28362);
   quadLineFit1013->SetParError(0,0.1091243);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.65719);
   quadLineFit1013->SetParError(1,1.952569);
