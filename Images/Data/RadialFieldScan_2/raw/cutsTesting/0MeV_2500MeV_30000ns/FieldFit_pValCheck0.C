...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.2241,50,45.46191);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.4555);
   Graph_Graph01025->SetMaximum(33.69331);
   ...
   mainFit1026->SetChisquare(3.283007);
   ...
   mainFit1026->SetParameter(0,-2.418973);
   mainFit1026->SetParError(0,0.4667066);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9334479);
   mainFit1026->SetParError(1,0.0184827);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0185");
   pt_LaTex = pt->AddText("#minus2.42#pm0.467");
   pt_LaTex = pt->AddText("#minus2.59#pm0.509");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.591439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.591439,-60.4555,2.591439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.283007);
   ...
   mainFit1027->SetParameter(0,-2.418973);
   mainFit1027->SetParError(0,0.4667066);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9334479);
   mainFit1027->SetParError(1,0.0184827);
