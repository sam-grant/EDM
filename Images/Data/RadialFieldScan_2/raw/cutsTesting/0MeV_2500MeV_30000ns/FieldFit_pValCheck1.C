...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-77.53096,75,71.9962);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-62.57824);
   Graph_Graph01027->SetMaximum(57.04348);
   ...
   mainFit1028->SetChisquare(1.607645);
   ...
   mainFit1028->SetParameter(0,-1.855324);
   mainFit1028->SetParError(0,0.4848293);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9585106);
   mainFit1028->SetParError(1,0.01598886);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.536");
   pt_LaTex = pt->AddText("0.959#pm0.016");
   pt_LaTex = pt->AddText("#minus1.86#pm0.485");
   pt_LaTex = pt->AddText("#minus1.94#pm0.509");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.935632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.935632,-62.57824,1.935632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.607645);
   ...
   mainFit1029->SetParameter(0,-1.855324);
   mainFit1029->SetParError(0,0.4848293);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9585106);
   mainFit1029->SetParError(1,0.01598886);
