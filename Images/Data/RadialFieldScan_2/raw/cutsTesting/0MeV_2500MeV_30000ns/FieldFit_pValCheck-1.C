...
//=========  (Fri Apr 23 12:22:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.57824);
   Graph_Graph01023->SetMaximum(57.04348);
   ...
   mainFit1024->SetChisquare(4.507399);
   ...
   mainFit1024->SetParameter(0,-2.226466);
   mainFit1024->SetParError(0,0.4330728);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9463798);
   mainFit1024->SetParError(1,0.01431524);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.0143");
   pt_LaTex = pt->AddText("#minus2.23#pm0.433");
   pt_LaTex = pt->AddText("#minus2.35#pm0.453");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.352613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.352613,-62.57824,2.352613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.507399);
   ...
   mainFit1025->SetParameter(0,-2.226466);
   mainFit1025->SetParError(0,0.4330728);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9463798);
   mainFit1025->SetParError(1,0.01431524);
