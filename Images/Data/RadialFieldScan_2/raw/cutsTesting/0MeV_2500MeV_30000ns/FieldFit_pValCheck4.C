...
//=========  (Fri Apr 23 12:22:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-62.57824);
   Graph_Graph01033->SetMaximum(57.04348);
   ...
   mainFit1034->SetChisquare(3.624315);
   ...
   mainFit1034->SetParameter(0,-2.534254);
   mainFit1034->SetParError(0,0.542973);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9564966);
   mainFit1034->SetParError(1,0.01790871);
   ...
   pt_LaTex = pt->AddText("0.956#pm0.0179");
   pt_LaTex = pt->AddText("#minus2.53#pm0.543");
   pt_LaTex = pt->AddText("#minus2.65#pm0.546");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.649517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.649517,-62.57824,2.649517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.624315);
   ...
   mainFit1035->SetParameter(0,-2.534254);
   mainFit1035->SetParError(0,0.542973);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9564966);
   mainFit1035->SetParError(1,0.01790871);
