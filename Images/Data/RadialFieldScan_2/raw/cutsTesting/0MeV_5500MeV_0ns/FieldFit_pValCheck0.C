...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.22982,50,44.98222);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.80862);
   Graph_Graph01025->SetMaximum(34.56102);
   ...
   mainFit1026->SetChisquare(48.46239);
   ...
   mainFit1026->SetParameter(0,-1.257389);
   mainFit1026->SetParError(0,0.3195611);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9035854);
   mainFit1026->SetParError(1,0.01261726);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.2");
   pt_LaTex = pt->AddText("0.904#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.26#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.39#pm0.357");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.391556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.391556,-48.80862,1.391556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(48.46239);
   ...
   mainFit1027->SetParameter(0,-1.257389);
   mainFit1027->SetParError(0,0.3195611);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9035854);
   mainFit1027->SetParError(1,0.01261726);
