...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.29674);
   Graph_Graph01020->SetMaximum(50.93037);
   ...
   mainFit1021->SetChisquare(52.71082);
   ...
   mainFit1021->SetParameter(0,-1.504839);
   mainFit1021->SetParError(0,0.2961531);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8871216);
   mainFit1021->SetParError(1,0.009766995);
   ...
   mainFit1022->SetChisquare(52.71082);
   ...
   mainFit1022->SetParameter(0,-1.504839);
   mainFit1022->SetParError(0,0.2961531);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8871216);
   mainFit1022->SetParError(1,0.009766995);
