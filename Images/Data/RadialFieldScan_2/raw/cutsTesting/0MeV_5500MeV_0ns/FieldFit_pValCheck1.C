...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.29674);
   Graph_Graph01027->SetMaximum(50.93037);
   ...
   mainFit1028->SetChisquare(38.261);
   ...
   mainFit1028->SetParameter(0,-2.073425);
   mainFit1028->SetParError(0,0.331782);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8686418);
   mainFit1028->SetParError(1,0.01090979);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 12.8");
   pt_LaTex = pt->AddText("0.869#pm0.0109");
   pt_LaTex = pt->AddText("#minus2.07#pm0.332");
   pt_LaTex = pt->AddText("#minus2.39#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.386974,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.386974,-50.29674,2.386974,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(38.261);
   ...
   mainFit1029->SetParameter(0,-2.073425);
   mainFit1029->SetParError(0,0.331782);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8686418);
   mainFit1029->SetParError(1,0.01090979);
