...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.71346,70,60.33643);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.00847);
   Graph_Graph01035->SetMaximum(49.63144);
   ...
   mainFit1036->SetChisquare(32.30414);
   ...
   mainFit1036->SetParameter(0,-1.928522);
   mainFit1036->SetParError(0,0.3106496);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9071463);
   mainFit1036->SetParError(1,0.01072586);
   ...
   pt_LaTex = pt->AddText("#minus1.93#pm0.311");
   pt_LaTex = pt->AddText("#minus2.13#pm0.337");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.125922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.125922,-36.00847,2.125922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(32.30414);
   ...
   mainFit1037->SetParameter(0,-1.928522);
   mainFit1037->SetParError(0,0.3106496);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9071463);
   mainFit1037->SetParError(1,0.01072586);
