...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-50.29674);
   Graph_Graph01031->SetMaximum(50.93037);
   ...
   mainFit1032->SetChisquare(21.142);
   ...
   mainFit1032->SetParameter(0,-0.5593184);
   mainFit1032->SetParError(0,0.3406259);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8726552);
   mainFit1032->SetParError(1,0.01010067);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 7.05");
   pt_LaTex = pt->AddText("0.873#pm0.0101");
   pt_LaTex = pt->AddText("#minus0.559#pm0.341");
   pt_LaTex = pt->AddText("#minus0.641#pm0.388");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6409386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6409386,-50.29674,0.6409386,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(21.142);
   ...
   mainFit1033->SetParameter(0,-0.5593184);
   mainFit1033->SetParError(0,0.3406259);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8726552);
   mainFit1033->SetParError(1,0.01010067);
