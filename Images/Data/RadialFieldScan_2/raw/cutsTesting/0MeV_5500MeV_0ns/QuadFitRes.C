...
//=========  (Fri Apr 23 11:35:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03313378);
   Graph_Graph11015->SetMaximum(0.01700182);
   ...
   Graph_Graph21016->SetMinimum(-0.01514481);
   Graph_Graph21016->SetMaximum(0.01761421);
   ...
   Graph_Graph31017->SetMinimum(-0.00979619);
   Graph_Graph31017->SetMaximum(0.02004973);
   ...
   Graph_Graph41018->SetMinimum(-0.02373464);
   Graph_Graph41018->SetMaximum(0.04077238);
   ...
   Graph_Graph51019->SetMinimum(-0.01922767);
   Graph_Graph51019->SetMaximum(0.01442183);
