...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.29674);
   Graph_Graph01029->SetMaximum(50.93037);
   ...
   mainFit1030->SetChisquare(50.25418);
   ...
   mainFit1030->SetParameter(0,-1.701192);
   mainFit1030->SetParError(0,0.3215599);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.88595);
   mainFit1030->SetParError(1,0.009795545);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.8");
   pt_LaTex = pt->AddText("0.886#pm0.0098");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.322");
   pt_LaTex = pt->AddText("#minus1.92#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.92019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.92019,-50.29674,1.92019,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(50.25418);
   ...
   mainFit1031->SetParameter(0,-1.701192);
   mainFit1031->SetParError(0,0.3215599);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.88595);
   mainFit1031->SetParError(1,0.009795545);
