...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-62.95013,75,63.58376);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-50.29674);
   Graph_Graph01023->SetMaximum(50.93037);
   ...
   mainFit1024->SetChisquare(52.71082);
   ...
   mainFit1024->SetParameter(0,-1.504839);
   mainFit1024->SetParError(0,0.2961531);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8871216);
   mainFit1024->SetParError(1,0.009766995);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 13.2");
   pt_LaTex = pt->AddText("0.887#pm0.00977");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.296");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.331");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.696316,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.696316,-50.29674,1.696316,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(52.71082);
   ...
   mainFit1025->SetParameter(0,-1.504839);
   mainFit1025->SetParError(0,0.2961531);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8871216);
   mainFit1025->SetParError(1,0.009766995);
