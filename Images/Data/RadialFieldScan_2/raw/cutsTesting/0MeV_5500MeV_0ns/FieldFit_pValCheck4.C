...
//=========  (Fri Apr 23 11:35:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.29674);
   Graph_Graph01033->SetMaximum(50.93037);
   ...
   mainFit1034->SetChisquare(52.64363);
   ...
   mainFit1034->SetParameter(0,-1.446593);
   mainFit1034->SetParError(0,0.3717509);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8852155);
   mainFit1034->SetParError(1,0.01222567);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 17.5");
   pt_LaTex = pt->AddText("0.885#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.45#pm0.372");
   pt_LaTex = pt->AddText("#minus1.63#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.63417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.63417,-50.29674,1.63417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(52.64363);
   ...
   mainFit1035->SetParameter(0,-1.446593);
   mainFit1035->SetParError(0,0.3717509);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8852155);
   mainFit1035->SetParError(1,0.01222567);
