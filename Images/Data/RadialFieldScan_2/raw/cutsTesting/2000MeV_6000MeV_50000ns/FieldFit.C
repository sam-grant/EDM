...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-47.31695);
   Graph_Graph01020->SetMaximum(50.02738);
   ...
   mainFit1021->SetChisquare(2.921713);
   ...
   mainFit1021->SetParameter(0,0.6421993);
   mainFit1021->SetParError(0,0.8636256);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7522135);
   mainFit1021->SetParError(1,0.02855286);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.73");
   pt_LaTex = pt->AddText("0.752#pm0.0286");
   pt_LaTex = pt->AddText("0.642#pm0.864");
   pt_LaTex = pt->AddText("0.854#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8537461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8537461,-47.31695,-0.8537461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.921713);
   ...
   mainFit1022->SetParameter(0,0.6421993);
   mainFit1022->SetParError(0,0.8636256);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7522135);
   mainFit1022->SetParError(1,0.02855286);
