...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04320581);
   Graph_Graph11015->SetMaximum(0.01741043);
   ...
   Graph_Graph21016->SetMinimum(-0.01922881);
   Graph_Graph21016->SetMaximum(0.0163402);
   ...
   Graph_Graph31017->SetMinimum(-0.05448188);
   Graph_Graph31017->SetMaximum(0.05309699);
   ...
   Graph_Graph41018->SetMinimum(-0.001530754);
   Graph_Graph41018->SetMaximum(0.002385346);
   ...
   Graph_Graph51019->SetMinimum(-0.006648576);
   Graph_Graph51019->SetMaximum(0.008885725);
