...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.39165,70,58.57675);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.39481);
   Graph_Graph01035->SetMaximum(48.57991);
   ...
   mainFit1036->SetChisquare(2.692646);
   ...
   mainFit1036->SetParameter(0,0.5113074);
   mainFit1036->SetParError(0,0.9058933);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.758408);
   mainFit1036->SetParError(1,0.03134935);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.898");
   pt_LaTex = pt->AddText("0.758#pm0.0313");
   pt_LaTex = pt->AddText("0.511#pm0.906");
   pt_LaTex = pt->AddText("0.674#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.6741851,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6741851,-31.39481,-0.6741851,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.692646);
   ...
   mainFit1037->SetParameter(0,0.5113074);
   mainFit1037->SetParError(0,0.9058933);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.758408);
   mainFit1037->SetParError(1,0.03134935);
