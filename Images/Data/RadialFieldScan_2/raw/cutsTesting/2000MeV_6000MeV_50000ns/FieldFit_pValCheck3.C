...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-47.31695);
   Graph_Graph01031->SetMaximum(50.02738);
   ...
   mainFit1032->SetChisquare(2.807437);
   ...
   mainFit1032->SetParameter(0,0.4753);
   mainFit1032->SetParError(0,0.9947886);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7547945);
   mainFit1032->SetParError(1,0.02955607);
   ...
   pt_LaTex = pt->AddText("0.755#pm0.0296");
   pt_LaTex = pt->AddText("0.475#pm0.995");
   pt_LaTex = pt->AddText(" 0.63#pm 1.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6297077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6297077,-47.31695,-0.6297077,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.807437);
   ...
   mainFit1033->SetParameter(0,0.4753);
   mainFit1033->SetParError(0,0.9947886);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7547945);
   mainFit1033->SetParError(1,0.02955607);
