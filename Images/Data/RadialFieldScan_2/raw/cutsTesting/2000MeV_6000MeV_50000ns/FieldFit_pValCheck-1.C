...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-47.31695);
   Graph_Graph01023->SetMaximum(50.02738);
   ...
   mainFit1024->SetChisquare(2.921713);
   ...
   mainFit1024->SetParameter(0,0.6421993);
   mainFit1024->SetParError(0,0.8636256);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7522135);
   mainFit1024->SetParError(1,0.02855286);
   ...
   mainFit1025->SetChisquare(2.921713);
   ...
   mainFit1025->SetParameter(0,0.6421993);
   mainFit1025->SetParError(0,0.8636256);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7522135);
   mainFit1025->SetParError(1,0.02855286);
