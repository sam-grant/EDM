...
//=========  (Thu Apr 22 10:32:00 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.20629);
   ...
   quadLineFit1002->SetParameter(0,75.07743);
   quadLineFit1002->SetParError(0,0.131693);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.70644);
   quadLineFit1002->SetParError(1,2.208912);
   ...
   quadLineFit1003->SetChisquare(3.20629);
   ...
   quadLineFit1003->SetParameter(0,75.07743);
   quadLineFit1003->SetParError(0,0.131693);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.70644);
   quadLineFit1003->SetParError(1,2.208912);
   ...
   Graph_30_ppm1003->SetMinimum(76.18939);
   Graph_30_ppm1003->SetMaximum(76.76491);
   ...
   quadLineFit1004->SetChisquare(1.348187);
   ...
   quadLineFit1004->SetParameter(0,75.17571);
   quadLineFit1004->SetParError(0,0.110615);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.05495);
   quadLineFit1004->SetParError(1,1.818271);
   ...
   quadLineFit1005->SetChisquare(1.348187);
   ...
   quadLineFit1005->SetParameter(0,75.17571);
   quadLineFit1005->SetParError(0,0.110615);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.05495);
   quadLineFit1005->SetParError(1,1.818271);
   ...
   Graph_10_ppm1005->SetMinimum(75.232);
   Graph_10_ppm1005->SetMaximum(75.53294);
   ...
   quadLineFit1006->SetChisquare(0.7477796);
   ...
   quadLineFit1006->SetParameter(0,74.79539);
   quadLineFit1006->SetParError(0,0.1297664);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.749102);
   quadLineFit1006->SetParError(1,2.10464);
   ...
   quadLineFit1007->SetChisquare(0.7477796);
   ...
   quadLineFit1007->SetParameter(0,74.79539);
   quadLineFit1007->SetParError(0,0.1297664);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.749102);
   quadLineFit1007->SetParError(1,2.10464);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.275);
   Graph_mI10_ppm1007->SetMaximum(74.5424);
   ...
   quadLineFit1008->SetChisquare(4.732275);
   ...
   quadLineFit1008->SetParameter(0,74.76971);
   quadLineFit1008->SetParError(0,0.1139726);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.341862);
   quadLineFit1008->SetParError(1,1.854973);
   ...
   quadLineFit1009->SetChisquare(4.732275);
   ...
   quadLineFit1009->SetParameter(0,74.76971);
   quadLineFit1009->SetParError(0,0.1139726);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.341862);
   quadLineFit1009->SetParError(1,1.854973);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.9798);
   Graph_mI30_ppm1009->SetMaximum(73.59887);
   ...
   quadLineFit1010->SetChisquare(0.005454874);
   ...
   quadLineFit1010->SetParameter(0,74.69953);
   quadLineFit1010->SetParError(0,0.1078186);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.86417);
   quadLineFit1010->SetParError(1,1.866081);
   ...
   quadLineFit1011->SetChisquare(0.005454874);
   ...
   quadLineFit1011->SetParameter(0,74.69953);
   quadLineFit1011->SetParError(0,0.1078186);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.86417);
   quadLineFit1011->SetParError(1,1.866081);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.15928);
   Graph_mI50_ppm1011->SetMaximum(72.70778);
   ...
   quadLineFit1012->SetChisquare(0.1419266);
   ...
   quadLineFit1012->SetParameter(0,74.4505);
   quadLineFit1012->SetParError(0,0.2175163);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.31317);
   quadLineFit1012->SetParError(1,3.891757);
   ...
   quadLineFit1013->SetChisquare(0.1419266);
   ...
   quadLineFit1013->SetParameter(0,74.4505);
   quadLineFit1013->SetParError(0,0.2175163);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.31317);
   quadLineFit1013->SetParError(1,3.891757);
