...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-54.72446,50,38.39276);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-45.41274);
   Graph_Graph01025->SetMaximum(29.08104);
   ...
   mainFit1026->SetChisquare(2.074987);
   ...
   mainFit1026->SetParameter(0,0.324236);
   mainFit1026->SetParError(0,0.9301867);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7307966);
   mainFit1026->SetParError(1,0.03683598);
   ...
   pt_LaTex = pt->AddText("0.731#pm0.0368");
   pt_LaTex = pt->AddText("0.324#pm 0.93");
   pt_LaTex = pt->AddText("0.444#pm 1.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.4436748,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4436748,-45.41274,-0.4436748,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.074987);
   ...
   mainFit1027->SetParameter(0,0.324236);
   mainFit1027->SetParError(0,0.9301867);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7307966);
   mainFit1027->SetParError(1,0.03683598);
