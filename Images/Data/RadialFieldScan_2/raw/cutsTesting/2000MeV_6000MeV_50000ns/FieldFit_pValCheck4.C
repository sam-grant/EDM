...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-47.31695);
   Graph_Graph01033->SetMaximum(50.02738);
   ...
   mainFit1034->SetChisquare(2.420463);
   ...
   mainFit1034->SetParameter(0,1.103932);
   mainFit1034->SetParError(0,1.082211);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7370377);
   mainFit1034->SetParError(1,0.03570335);
   ...
   pt_LaTex = pt->AddText("0.737#pm0.0357");
   pt_LaTex = pt->AddText("  1.1#pm 1.08");
   pt_LaTex = pt->AddText("  1.5#pm  1.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.497796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.497796,-47.31695,-1.497796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.420463);
   ...
   mainFit1035->SetParameter(0,1.103932);
   mainFit1035->SetParError(0,1.082211);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7370377);
   mainFit1035->SetParError(1,0.03570335);
