...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-47.31695);
   Graph_Graph01027->SetMaximum(50.02738);
   ...
   mainFit1028->SetChisquare(0.6772704);
   ...
   mainFit1028->SetParameter(0,1.294423);
   mainFit1028->SetParError(0,0.9671514);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7735336);
   mainFit1028->SetParError(1,0.03190277);
   ...
   pt_LaTex = pt->AddText("0.774#pm0.0319");
   pt_LaTex = pt->AddText(" 1.29#pm0.967");
   pt_LaTex = pt->AddText(" 1.67#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.673389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.673389,-47.31695,-1.673389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6772704);
   ...
   mainFit1029->SetParameter(0,1.294423);
   mainFit1029->SetParError(0,0.9671514);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7735336);
   mainFit1029->SetParError(1,0.03190277);
