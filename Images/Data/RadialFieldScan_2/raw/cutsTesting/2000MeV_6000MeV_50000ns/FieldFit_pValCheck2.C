...
//=========  (Thu Apr 22 10:32:01 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-47.31695);
   Graph_Graph01029->SetMaximum(50.02738);
   ...
   mainFit1030->SetChisquare(2.23964);
   ...
   mainFit1030->SetParameter(0,0.3384346);
   mainFit1030->SetParError(0,0.9386991);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7504208);
   mainFit1030->SetParError(1,0.02863474);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.0286");
   pt_LaTex = pt->AddText("0.338#pm0.939");
   pt_LaTex = pt->AddText("0.451#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4509931,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4509931,-47.31695,-0.4509931,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.23964);
   ...
   mainFit1031->SetParameter(0,0.3384346);
   mainFit1031->SetParError(0,0.9386991);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7504208);
   mainFit1031->SetParError(1,0.02863474);
