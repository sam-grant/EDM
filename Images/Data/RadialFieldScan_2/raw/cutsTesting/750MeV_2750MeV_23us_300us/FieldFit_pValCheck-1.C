...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.54399);
   Graph_Graph01023->SetMaximum(54.25913);
   ...
   mainFit1024->SetChisquare(4.431685);
   ...
   mainFit1024->SetParameter(0,-0.6983702);
   mainFit1024->SetParError(0,0.4422609);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8716656);
   mainFit1024->SetParError(1,0.0146216);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0146");
   pt_LaTex = pt->AddText("#minus0.698#pm0.442");
   pt_LaTex = pt->AddText("#minus0.801#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8011904,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8011904,-55.54399,0.8011904,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.431685);
   ...
   mainFit1025->SetParameter(0,-0.6983702);
   mainFit1025->SetParError(0,0.4422609);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8716656);
   mainFit1025->SetParError(1,0.0146216);
