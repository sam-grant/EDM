...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.29595);
   ...
   quadLineFit1002->SetParameter(0,74.5521);
   quadLineFit1002->SetParError(0,0.06742215);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.97792);
   quadLineFit1002->SetParError(1,1.130955);
   ...
   quadLineFit1003->SetChisquare(1.29595);
   ...
   quadLineFit1003->SetParameter(0,74.5521);
   quadLineFit1003->SetParError(0,0.06742215);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.97792);
   quadLineFit1003->SetParError(1,1.130955);
   ...
   Graph_30_ppm1003->SetMinimum(75.77507);
   Graph_30_ppm1003->SetMaximum(76.38218);
   ...
   quadLineFit1004->SetChisquare(0.8895592);
   ...
   quadLineFit1004->SetParameter(0,74.60527);
   quadLineFit1004->SetParError(0,0.05673743);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.00085);
   quadLineFit1004->SetParError(1,0.932533);
   ...
   quadLineFit1005->SetChisquare(0.8895592);
   ...
   quadLineFit1005->SetParameter(0,74.60527);
   quadLineFit1005->SetParError(0,0.05673743);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.00085);
   quadLineFit1005->SetParError(1,0.932533);
   ...
   Graph_10_ppm1005->SetMinimum(74.81334);
   Graph_10_ppm1005->SetMaximum(75.07468);
   ...
   quadLineFit1006->SetChisquare(1.008118);
   ...
   quadLineFit1006->SetParameter(0,74.3781);
   quadLineFit1006->SetParError(0,0.06644858);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.079844);
   quadLineFit1006->SetParError(1,1.077656);
   ...
   quadLineFit1007->SetChisquare(1.008118);
   ...
   quadLineFit1007->SetParameter(0,74.3781);
   quadLineFit1007->SetParError(0,0.06644858);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.079844);
   quadLineFit1007->SetParError(1,1.077656);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.63662);
   Graph_mI10_ppm1007->SetMaximum(73.93317);
   ...
   quadLineFit1008->SetChisquare(8.145154);
   ...
   quadLineFit1008->SetParameter(0,74.3705);
   quadLineFit1008->SetParError(0,0.05835083);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.660038);
   quadLineFit1008->SetParError(1,0.9497687);
   ...
   quadLineFit1009->SetChisquare(8.145154);
   ...
   quadLineFit1009->SetParameter(0,74.3705);
   quadLineFit1009->SetParError(0,0.05835083);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.660038);
   quadLineFit1009->SetParError(1,0.9497687);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29431);
   Graph_mI30_ppm1009->SetMaximum(72.9725);
   ...
   quadLineFit1010->SetChisquare(4.026944);
   ...
   quadLineFit1010->SetParError(0,0.05518705);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.66469);
   quadLineFit1010->SetParError(1,0.9551074);
   ...
   quadLineFit1011->SetChisquare(4.026944);
   ...
   quadLineFit1011->SetParError(0,0.05518705);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.66469);
   quadLineFit1011->SetParError(1,0.9551074);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38195);
   Graph_mI50_ppm1011->SetMaximum(72.01657);
   ...
   quadLineFit1012->SetChisquare(1.007674);
   ...
   quadLineFit1012->SetParameter(0,74.2337);
   quadLineFit1012->SetParError(0,0.1113659);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.40104);
   quadLineFit1012->SetParError(1,1.992685);
   ...
   quadLineFit1013->SetChisquare(1.007674);
   ...
   quadLineFit1013->SetParameter(0,74.2337);
   quadLineFit1013->SetParError(0,0.1113659);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.40104);
   quadLineFit1013->SetParError(1,1.992685);
