...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.26938,75,67.98452);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.54399);
   Graph_Graph01027->SetMaximum(54.25913);
   ...
   mainFit1028->SetChisquare(0.5646328);
   ...
   mainFit1028->SetParameter(0,-0.2604899);
   mainFit1028->SetParError(0,0.495154);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8859788);
   mainFit1028->SetParError(1,0.01633307);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.188");
   pt_LaTex = pt->AddText("0.886#pm0.0163");
   pt_LaTex = pt->AddText("#minus0.26#pm0.495");
   pt_LaTex = pt->AddText("#minus0.294#pm0.559");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2940138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2940138,-55.54399,0.2940138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5646328);
   ...
   mainFit1029->SetParameter(0,-0.2604899);
   mainFit1029->SetParError(0,0.495154);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8859788);
   mainFit1029->SetParError(1,0.01633307);
