...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009604069);
   Graph_Graph11015->SetMaximum(0.01450269);
   ...
   Graph_Graph21016->SetMinimum(-0.009708059);
   Graph_Graph21016->SetMaximum(0.01142947);
   ...
   Graph_Graph31017->SetMinimum(-0.03480143);
   Graph_Graph31017->SetMaximum(0.02832367);
   ...
   Graph_Graph41018->SetMinimum(-0.01454954);
   Graph_Graph41018->SetMaximum(0.02276962);
   ...
   Graph_Graph51019->SetMinimum(-0.009064391);
   Graph_Graph51019->SetMaximum(0.01212239);
