...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.54399);
   Graph_Graph01033->SetMaximum(54.25913);
   ...
   mainFit1034->SetChisquare(4.358617);
   ...
   mainFit1034->SetParameter(0,-0.7886533);
   mainFit1034->SetParError(0,0.5542095);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8746329);
   mainFit1034->SetParError(1,0.01828352);
   ...
   pt_LaTex = pt->AddText("0.875#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.789#pm0.554");
   pt_LaTex = pt->AddText("#minus0.902#pm0.625");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9016964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9016964,-55.54399,0.9016964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.358617);
   ...
   mainFit1035->SetParameter(0,-0.7886533);
   mainFit1035->SetParError(0,0.5542095);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8746329);
   mainFit1035->SetParError(1,0.01828352);
