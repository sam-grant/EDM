...
//=========  (Wed Apr 28 16:51:05 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-45.80197,70,63.29104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.89266);
   Graph_Graph01035->SetMaximum(52.38174);
   ...
   mainFit1036->SetChisquare(4.42714);
   ...
   mainFit1036->SetParameter(0,-0.6889371);
   mainFit1036->SetParError(0,0.4638673);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.871219);
   mainFit1036->SetParError(1,0.0160527);
   ...
   pt_LaTex = pt->AddText("0.871#pm0.0161");
   pt_LaTex = pt->AddText("#minus0.689#pm0.464");
   pt_LaTex = pt->AddText("#minus0.791#pm0.529");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.7907738,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7907738,-34.89266,0.7907738,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.42714);
   ...
   mainFit1037->SetParameter(0,-0.6889371);
   mainFit1037->SetParError(0,0.4638673);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.871219);
   mainFit1037->SetParError(1,0.0160527);
