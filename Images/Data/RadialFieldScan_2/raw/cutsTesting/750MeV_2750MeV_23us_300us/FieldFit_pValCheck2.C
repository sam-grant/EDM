...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.54399);
   Graph_Graph01029->SetMaximum(54.25913);
   ...
   mainFit1030->SetChisquare(3.264209);
   ...
   mainFit1030->SetParameter(0,-0.9019943);
   mainFit1030->SetParError(0,0.48074);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8704614);
   mainFit1030->SetParError(1,0.01466393);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0147");
   pt_LaTex = pt->AddText("#minus0.902#pm0.481");
   pt_LaTex = pt->AddText("#minus1.04#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.036226,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.036226,-55.54399,1.036226,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.264209);
   ...
   mainFit1031->SetParameter(0,-0.9019943);
   mainFit1031->SetParError(0,0.48074);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8704614);
   mainFit1031->SetParError(1,0.01466393);
