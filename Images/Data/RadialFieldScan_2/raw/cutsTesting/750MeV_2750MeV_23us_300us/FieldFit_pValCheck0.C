...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.22551,50,42.76517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.52644);
   Graph_Graph01025->SetMaximum(32.0661);
   ...
   mainFit1026->SetChisquare(2.603287);
   ...
   mainFit1026->SetParameter(0,-0.9383);
   mainFit1026->SetParError(0,0.4765114);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8555171);
   mainFit1026->SetParError(1,0.01887274);
   ...
   pt_LaTex = pt->AddText("0.856#pm0.0189");
   pt_LaTex = pt->AddText("#minus0.938#pm0.477");
   pt_LaTex = pt->AddText(" #minus1.1#pm 0.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.096764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.096764,-53.52644,1.096764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.603287);
   ...
   mainFit1027->SetParameter(0,-0.9383);
   mainFit1027->SetParError(0,0.4765114);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8555171);
   mainFit1027->SetParError(1,0.01887274);
