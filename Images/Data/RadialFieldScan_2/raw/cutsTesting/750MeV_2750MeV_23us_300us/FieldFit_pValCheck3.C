...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.54399);
   Graph_Graph01031->SetMaximum(54.25913);
   ...
   mainFit1032->SetChisquare(4.341305);
   ...
   mainFit1032->SetParameter(0,-0.6223681);
   mainFit1032->SetParError(0,0.5094176);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8704919);
   mainFit1032->SetParError(1,0.0151339);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0151");
   pt_LaTex = pt->AddText("#minus0.622#pm0.509");
   pt_LaTex = pt->AddText("#minus0.715#pm0.582");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7149614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7149614,-55.54399,0.7149614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.341305);
   ...
   mainFit1033->SetParameter(0,-0.6223681);
   mainFit1033->SetParError(0,0.5094176);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8704919);
   mainFit1033->SetParError(1,0.0151339);
