...
//=========  (Wed Apr 28 16:51:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.54399);
   Graph_Graph01020->SetMaximum(54.25913);
   ...
   mainFit1021->SetChisquare(4.431685);
   ...
   mainFit1021->SetParameter(0,-0.6983702);
   mainFit1021->SetParError(0,0.4422609);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8716656);
   mainFit1021->SetParError(1,0.0146216);
   ...
   mainFit1022->SetChisquare(4.431685);
   ...
   mainFit1022->SetParameter(0,-0.6983702);
   mainFit1022->SetParError(0,0.4422609);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8716656);
   mainFit1022->SetParError(1,0.0146216);
