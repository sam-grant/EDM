...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-84.51403,75,73.14339);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-68.74829);
   Graph_Graph01031->SetMaximum(57.37765);
   ...
   mainFit1032->SetChisquare(0.8939047);
   ...
   mainFit1032->SetParameter(0,-0.6778361);
   mainFit1032->SetParError(0,1.929015);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9104294);
   mainFit1032->SetParError(1,0.05731555);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.298");
   pt_LaTex = pt->AddText(" 0.91#pm0.0573");
   pt_LaTex = pt->AddText("#minus0.678#pm 1.93");
   pt_LaTex = pt->AddText("#minus0.745#pm 2.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7445236,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7445236,-68.74829,0.7445236,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.8939047);
   ...
   mainFit1033->SetParameter(0,-0.6778361);
   mainFit1033->SetParError(0,1.929015);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9104294);
   mainFit1033->SetParError(1,0.05731555);
