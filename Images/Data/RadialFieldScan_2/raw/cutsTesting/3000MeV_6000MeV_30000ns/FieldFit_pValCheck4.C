...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-68.74829);
   Graph_Graph01033->SetMaximum(57.37765);
   ...
   mainFit1034->SetChisquare(5.520688);
   ...
   mainFit1034->SetParameter(0,2.821751);
   mainFit1034->SetParError(0,2.096765);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.83487);
   mainFit1034->SetParError(1,0.06920617);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0692");
   pt_LaTex = pt->AddText(" 2.82#pm  2.1");
   pt_LaTex = pt->AddText(" 3.38#pm 2.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.379869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.379869,-68.74829,-3.379869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.520688);
   ...
   mainFit1035->SetParameter(0,2.821751);
   mainFit1035->SetParError(0,2.096765);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.83487);
   mainFit1035->SetParError(1,0.06920617);
