...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-68.74829);
   Graph_Graph01023->SetMaximum(57.37765);
   ...
   mainFit1024->SetChisquare(6.479548);
   ...
   mainFit1024->SetParameter(0,1.585926);
   mainFit1024->SetParError(0,1.674406);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8755126);
   mainFit1024->SetParError(1,0.05537871);
   ...
   pt_LaTex = pt->AddText("0.876#pm0.0554");
   pt_LaTex = pt->AddText(" 1.59#pm 1.67");
   pt_LaTex = pt->AddText(" 1.81#pm 1.93");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.811426,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.811426,-68.74829,-1.811426,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.479548);
   ...
   mainFit1025->SetParameter(0,1.585926);
   mainFit1025->SetParError(0,1.674406);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8755126);
   mainFit1025->SetParError(1,0.05537871);
