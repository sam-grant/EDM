...
//=========  (Thu Apr 22 10:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1197593);
   Graph_Graph11015->SetMaximum(0.04156596);
   ...
   Graph_Graph21016->SetMinimum(-0.03952186);
   Graph_Graph21016->SetMaximum(0.0465214);
   ...
   Graph_Graph31017->SetMinimum(-0.130938);
   Graph_Graph31017->SetMaximum(0.09282926);
   ...
   Graph_Graph41018->SetMinimum(-0.05120507);
   Graph_Graph41018->SetMaximum(0.05569865);
   ...
   Graph_Graph51019->SetMinimum(-0.01307453);
   Graph_Graph51019->SetMaximum(0.01742232);
