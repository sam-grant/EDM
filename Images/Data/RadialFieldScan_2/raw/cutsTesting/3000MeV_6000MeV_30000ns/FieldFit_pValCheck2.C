...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-68.74829);
   Graph_Graph01029->SetMaximum(57.37765);
   ...
   mainFit1030->SetChisquare(6.276944);
   ...
   mainFit1030->SetParameter(0,1.906759);
   mainFit1030->SetParError(0,1.819687);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8774011);
   mainFit1030->SetParError(1,0.05554077);
   ...
   pt_LaTex = pt->AddText("0.877#pm0.0555");
   pt_LaTex = pt->AddText(" 1.91#pm 1.82");
   pt_LaTex = pt->AddText(" 2.17#pm 2.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.173189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.173189,-68.74829,-2.173189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.276944);
   ...
   mainFit1031->SetParameter(0,1.906759);
   mainFit1031->SetParError(0,1.819687);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8774011);
   mainFit1031->SetParError(1,0.05554077);
