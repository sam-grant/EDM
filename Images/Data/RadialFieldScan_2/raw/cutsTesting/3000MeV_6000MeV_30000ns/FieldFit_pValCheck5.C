...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.23972,70,66.28853);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.58689);
   Graph_Graph01035->SetMaximum(54.6357);
   ...
   mainFit1036->SetChisquare(4.85566);
   ...
   mainFit1036->SetParameter(0,2.261953);
   mainFit1036->SetParError(0,1.756435);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8434543);
   mainFit1036->SetParError(1,0.06082506);
   ...
   pt_LaTex = pt->AddText("0.843#pm0.0608");
   pt_LaTex = pt->AddText(" 2.26#pm 1.76");
   pt_LaTex = pt->AddText(" 2.68#pm 2.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-2.681773,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.681773,-38.58689,-2.681773,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.85566);
   ...
   mainFit1037->SetParameter(0,2.261953);
   mainFit1037->SetParError(0,1.756435);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8434543);
   mainFit1037->SetParError(1,0.06082506);
