...
//=========  (Thu Apr 22 10:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-68.74829);
   Graph_Graph01020->SetMaximum(57.37765);
   ...
   mainFit1021->SetChisquare(6.479548);
   ...
   mainFit1021->SetParameter(0,1.585926);
   mainFit1021->SetParError(0,1.674406);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8755126);
   mainFit1021->SetParError(1,0.05537871);
   ...
   mainFit1022->SetChisquare(6.479548);
   ...
   mainFit1022->SetParameter(0,1.585926);
   mainFit1022->SetParError(0,1.674406);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8755126);
   mainFit1022->SetParError(1,0.05537871);
