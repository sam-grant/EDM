...
//=========  (Thu Apr 22 10:12:37 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.784943);
   ...
   quadLineFit1002->SetParameter(0,75.01726);
   quadLineFit1002->SetParError(0,0.2558992);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.57483);
   quadLineFit1002->SetParError(1,4.292324);
   ...
   quadLineFit1003->SetChisquare(3.784943);
   ...
   quadLineFit1003->SetParameter(0,75.01726);
   quadLineFit1003->SetParError(0,0.2558992);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.57483);
   quadLineFit1003->SetParError(1,4.292324);
   ...
   Graph_30_ppm1003->SetMinimum(76.13223);
   Graph_30_ppm1003->SetMaximum(76.97705);
   ...
   quadLineFit1004->SetChisquare(2.635744);
   ...
   quadLineFit1004->SetParameter(0,74.81592);
   quadLineFit1004->SetParError(0,0.214384);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,28.22942);
   quadLineFit1004->SetParError(1,3.526813);
   ...
   quadLineFit1005->SetChisquare(2.635744);
   ...
   quadLineFit1005->SetParameter(0,74.81592);
   quadLineFit1005->SetParError(0,0.214384);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,28.22942);
   quadLineFit1005->SetParError(1,3.526813);
   ...
   Graph_10_ppm1005->SetMinimum(75.26672);
   Graph_10_ppm1005->SetMaximum(75.63638);
   ...
   quadLineFit1006->SetChisquare(1.153307);
   ...
   quadLineFit1006->SetParameter(0,74.88437);
   quadLineFit1006->SetParError(0,0.2518633);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.663768);
   quadLineFit1006->SetParError(1,4.086382);
   ...
   quadLineFit1007->SetChisquare(1.153307);
   ...
   quadLineFit1007->SetParameter(0,74.88437);
   quadLineFit1007->SetParError(0,0.2518633);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.663768);
   quadLineFit1007->SetParError(1,4.086382);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.17207);
   Graph_mI10_ppm1007->SetMaximum(74.53252);
   ...
   quadLineFit1008->SetChisquare(7.606428);
   ...
   quadLineFit1008->SetParameter(0,74.36175);
   quadLineFit1008->SetParError(0,0.2205609);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,0.1154185);
   quadLineFit1008->SetParError(1,3.59278);
   ...
   quadLineFit1009->SetChisquare(7.606428);
   ...
   quadLineFit1009->SetParameter(0,74.36175);
   quadLineFit1009->SetParError(0,0.2205609);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,0.1154185);
   quadLineFit1009->SetParError(1,3.59278);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.77761);
   Graph_mI30_ppm1009->SetMaximum(73.5909);
   ...
   quadLineFit1010->SetChisquare(1.38496);
   ...
   quadLineFit1010->SetParameter(0,74.8637);
   quadLineFit1010->SetParError(0,0.2089121);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.20086);
   quadLineFit1010->SetParError(1,3.617483);
   ...
   quadLineFit1011->SetChisquare(1.38496);
   ...
   quadLineFit1011->SetParameter(0,74.8637);
   quadLineFit1011->SetParError(0,0.2089121);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.20086);
   quadLineFit1011->SetParError(1,3.617483);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.83549);
   Graph_mI50_ppm1011->SetMaximum(72.65958);
   ...
   quadLineFit1012->SetChisquare(0.1459039);
   ...
   quadLineFit1012->SetParameter(0,75.14799);
   quadLineFit1012->SetParError(0,0.4207839);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.71021);
   quadLineFit1012->SetParError(1,7.527581);
   ...
   quadLineFit1013->SetChisquare(0.1459039);
   ...
   quadLineFit1013->SetParameter(0,75.14799);
   quadLineFit1013->SetParError(0,0.4207839);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.71021);
   quadLineFit1013->SetParError(1,7.527581);
