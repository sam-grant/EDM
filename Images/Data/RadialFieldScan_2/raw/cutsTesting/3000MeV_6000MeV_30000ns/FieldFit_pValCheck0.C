...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-80.7363,50,54.25474);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-67.23719);
   Graph_Graph01025->SetMaximum(40.75563);
   ...
   mainFit1026->SetChisquare(5.656924);
   ...
   mainFit1026->SetParameter(0,2.194076);
   mainFit1026->SetParError(0,1.80367);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9163883);
   mainFit1026->SetParError(1,0.07139952);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.0714");
   pt_LaTex = pt->AddText(" 2.19#pm  1.8");
   pt_LaTex = pt->AddText(" 2.39#pm 1.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-2.394264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.394264,-67.23719,-2.394264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.656924);
   ...
   mainFit1027->SetParameter(0,2.194076);
   mainFit1027->SetParError(0,1.80367);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9163883);
   mainFit1027->SetParError(1,0.07139952);
