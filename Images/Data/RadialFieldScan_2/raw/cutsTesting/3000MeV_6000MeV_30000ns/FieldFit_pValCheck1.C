...
//=========  (Thu Apr 22 10:12:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-68.74829);
   Graph_Graph01027->SetMaximum(57.37765);
   ...
   mainFit1028->SetChisquare(6.461141);
   ...
   mainFit1028->SetParameter(0,1.471154);
   mainFit1028->SetParError(0,1.875967);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8717575);
   mainFit1028->SetParError(1,0.06191003);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.15");
   pt_LaTex = pt->AddText("0.872#pm0.0619");
   pt_LaTex = pt->AddText(" 1.47#pm 1.88");
   pt_LaTex = pt->AddText(" 1.69#pm 2.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.687572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.687572,-68.74829,-1.687572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(6.461141);
   ...
   mainFit1029->SetParameter(0,1.471154);
   mainFit1029->SetParError(0,1.875967);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8717575);
   mainFit1029->SetParError(1,0.06191003);
