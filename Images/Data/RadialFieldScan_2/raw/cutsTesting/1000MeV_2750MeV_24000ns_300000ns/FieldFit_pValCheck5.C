...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.66266,70,61.52939);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.14345);
   Graph_Graph01035->SetMaximum(51.01019);
   ...
   mainFit1036->SetChisquare(4.510848);
   ...
   mainFit1036->SetParameter(0,-0.2363819);
   mainFit1036->SetParError(0,0.521523);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8310606);
   mainFit1036->SetParError(1,0.01804235);
   ...
   pt_LaTex = pt->AddText("#minus0.236#pm0.522");
   pt_LaTex = pt->AddText("#minus0.284#pm0.626");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.284434,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.284434,-33.14345,0.284434,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.510848);
   ...
   mainFit1037->SetParameter(0,-0.2363819);
   mainFit1037->SetParError(0,0.521523);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8310606);
   mainFit1037->SetParError(1,0.01804235);
