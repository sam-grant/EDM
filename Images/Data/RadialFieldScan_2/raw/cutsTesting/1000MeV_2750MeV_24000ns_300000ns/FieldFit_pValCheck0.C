...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.40879,50,41.30289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.03762);
   Graph_Graph01025->SetMaximum(30.93173);
   ...
   mainFit1026->SetChisquare(2.591726);
   ...
   mainFit1026->SetParameter(0,-0.5942547);
   mainFit1026->SetParError(0,0.5357854);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8147905);
   mainFit1026->SetParError(1,0.0212215);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.864");
   pt_LaTex = pt->AddText("0.815#pm0.0212");
   pt_LaTex = pt->AddText("#minus0.594#pm0.536");
   pt_LaTex = pt->AddText("#minus0.729#pm 0.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.7293344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7293344,-52.03762,0.7293344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.591726);
   ...
   mainFit1027->SetParameter(0,-0.5942547);
   mainFit1027->SetParError(0,0.5357854);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8147905);
   mainFit1027->SetParError(1,0.0212215);
