...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01708647);
   Graph_Graph11015->SetMaximum(0.04877439);
   ...
   Graph_Graph21016->SetMinimum(-0.008202823);
   Graph_Graph21016->SetMaximum(0.00966677);
   ...
   Graph_Graph31017->SetMinimum(-0.02750012);
   Graph_Graph31017->SetMaximum(0.02255661);
   ...
   Graph_Graph41018->SetMinimum(-0.01995791);
   Graph_Graph41018->SetMaximum(0.0274146);
   ...
   Graph_Graph51019->SetMinimum(-0.005820855);
   Graph_Graph51019->SetMaximum(0.007782903);
