...
//=========  (Mon Apr 26 22:36:53 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.334823);
   ...
   quadLineFit1002->SetParameter(0,74.59815);
   quadLineFit1002->SetParError(0,0.07573446);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.72702);
   quadLineFit1002->SetParError(1,1.270364);
   ...
   quadLineFit1003->SetChisquare(2.334823);
   ...
   quadLineFit1003->SetParameter(0,74.59815);
   quadLineFit1003->SetParError(0,0.07573446);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.72702);
   quadLineFit1003->SetParError(1,1.270364);
   ...
   Graph_30_ppm1003->SetMinimum(75.7829);
   Graph_30_ppm1003->SetMaximum(76.3655);
   ...
   quadLineFit1004->SetChisquare(4.957096);
   ...
   quadLineFit1004->SetParameter(0,74.67016);
   quadLineFit1004->SetParError(0,0.06379515);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.96911);
   quadLineFit1004->SetParError(1,1.048501);
   ...
   quadLineFit1005->SetChisquare(4.957096);
   ...
   quadLineFit1005->SetParameter(0,74.67016);
   quadLineFit1005->SetParError(0,0.06379515);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.96911);
   quadLineFit1005->SetParError(1,1.048501);
   ...
   Graph_10_ppm1005->SetMinimum(74.84652);
   Graph_10_ppm1005->SetMaximum(75.10937);
   ...
   quadLineFit1006->SetChisquare(0.5693525);
   ...
   quadLineFit1006->SetParameter(0,74.41934);
   quadLineFit1006->SetParError(0,0.0747279);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.978253);
   quadLineFit1006->SetParError(1,1.211988);
   ...
   quadLineFit1007->SetChisquare(0.5693525);
   ...
   quadLineFit1007->SetParameter(0,74.41934);
   quadLineFit1007->SetParError(0,0.0747279);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.978253);
   quadLineFit1007->SetParError(1,1.211988);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72571);
   Graph_mI10_ppm1007->SetMaximum(73.99508);
   ...
   quadLineFit1008->SetChisquare(3.492996);
   ...
   quadLineFit1008->SetParameter(0,74.37535);
   quadLineFit1008->SetParError(0,0.06559706);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.564873);
   quadLineFit1008->SetParError(1,1.067701);
   ...
   quadLineFit1009->SetChisquare(3.492996);
   ...
   quadLineFit1009->SetParameter(0,74.37535);
   quadLineFit1009->SetParError(0,0.06559706);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.564873);
   quadLineFit1009->SetParError(1,1.067701);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40859);
   Graph_mI30_ppm1009->SetMaximum(73.06123);
   ...
   quadLineFit1010->SetChisquare(2.941294);
   ...
   quadLineFit1010->SetParameter(0,74.2882);
   quadLineFit1010->SetParError(0,0.06204862);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.05677);
   quadLineFit1010->SetParError(1,1.073878);
   ...
   quadLineFit1011->SetChisquare(2.941294);
   ...
   quadLineFit1011->SetParameter(0,74.2882);
   quadLineFit1011->SetParError(0,0.06204862);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.05677);
   quadLineFit1011->SetParError(1,1.073878);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51647);
   Graph_mI50_ppm1011->SetMaximum(72.13565);
   ...
   quadLineFit1012->SetChisquare(0.3284362);
   ...
   quadLineFit1012->SetParameter(0,74.27179);
   quadLineFit1012->SetParError(0,0.1252666);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.88217);
   quadLineFit1012->SetParError(1,2.241341);
   ...
   quadLineFit1013->SetChisquare(0.3284362);
   ...
   quadLineFit1013->SetParameter(0,74.27179);
   quadLineFit1013->SetParError(0,0.1252666);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.88217);
   quadLineFit1013->SetParError(1,2.241341);
