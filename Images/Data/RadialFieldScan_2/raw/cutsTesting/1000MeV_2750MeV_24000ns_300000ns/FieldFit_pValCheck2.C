...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.0356);
   Graph_Graph01029->SetMaximum(52.90947);
   ...
   mainFit1030->SetChisquare(3.975131);
   ...
   mainFit1030->SetParameter(0,-0.4846712);
   mainFit1030->SetParError(0,0.5404511);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.833223);
   mainFit1030->SetParError(1,0.01648262);
   ...
   pt_LaTex = pt->AddText("#minus0.485#pm 0.54");
   pt_LaTex = pt->AddText("#minus0.582#pm0.647");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5816825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5816825,-54.0356,0.5816825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.975131);
   ...
   mainFit1031->SetParameter(0,-0.4846712);
   mainFit1031->SetParError(0,0.5404511);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.833223);
   mainFit1031->SetParError(1,0.01648262);
