...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.0356);
   Graph_Graph01031->SetMaximum(52.90947);
   ...
   mainFit1032->SetChisquare(4.690523);
   ...
   mainFit1032->SetParameter(0,-0.3301658);
   mainFit1032->SetParError(0,0.5727808);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8346819);
   mainFit1032->SetParError(1,0.01701217);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.017");
   pt_LaTex = pt->AddText("#minus0.33#pm0.573");
   pt_LaTex = pt->AddText("#minus0.396#pm0.684");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3955588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3955588,-54.0356,0.3955588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.690523);
   ...
   mainFit1033->SetParameter(0,-0.3301658);
   mainFit1033->SetParError(0,0.5727808);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8346819);
   mainFit1033->SetParError(1,0.01701217);
