...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.0356);
   Graph_Graph01023->SetMaximum(52.90947);
   ...
   mainFit1024->SetChisquare(4.69864);
   ...
   mainFit1024->SetParameter(0,-0.3045499);
   mainFit1024->SetParError(0,0.4972336);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8342862);
   mainFit1024->SetParError(1,0.01643535);
   ...
   mainFit1025->SetChisquare(4.69864);
   ...
   mainFit1025->SetParameter(0,-0.3045499);
   mainFit1025->SetParError(0,0.4972336);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8342862);
   mainFit1025->SetParError(1,0.01643535);
