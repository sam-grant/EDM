...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.0356);
   Graph_Graph01033->SetMaximum(52.90947);
   ...
   mainFit1034->SetChisquare(4.567744);
   ...
   mainFit1034->SetParameter(0,-0.4404475);
   mainFit1034->SetParError(0,0.6231624);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8387509);
   mainFit1034->SetParError(1,0.02055247);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.0206");
   pt_LaTex = pt->AddText("#minus0.44#pm0.623");
   pt_LaTex = pt->AddText("#minus0.525#pm0.737");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5251232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5251232,-54.0356,0.5251232,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.567744);
   ...
   mainFit1035->SetParameter(0,-0.4404475);
   mainFit1035->SetParError(0,0.6231624);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8387509);
   mainFit1035->SetParError(1,0.02055247);
