...
//=========  (Mon Apr 26 22:36:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.0356);
   Graph_Graph01027->SetMaximum(52.90947);
   ...
   mainFit1028->SetChisquare(0.2246635);
   ...
   mainFit1028->SetParameter(0,0.2245947);
   mainFit1028->SetParError(0,0.5566185);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8515731);
   mainFit1028->SetParError(1,0.01835526);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0749");
   pt_LaTex = pt->AddText("0.852#pm0.0184");
   pt_LaTex = pt->AddText("0.225#pm0.557");
   pt_LaTex = pt->AddText("0.264#pm0.653");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2637409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2637409,-54.0356,-0.2637409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2246635);
   ...
   mainFit1029->SetParameter(0,0.2245947);
   mainFit1029->SetParError(0,0.5566185);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8515731);
   mainFit1029->SetParError(1,0.01835526);
