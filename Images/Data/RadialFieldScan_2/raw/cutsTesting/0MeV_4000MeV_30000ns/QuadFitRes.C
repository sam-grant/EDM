...
//=========  (Fri Apr 23 12:35:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007689673);
   Graph_Graph11015->SetMaximum(0.007611596);
   ...
   Graph_Graph21016->SetMinimum(-0.008869205);
   Graph_Graph21016->SetMaximum(0.01042243);
   ...
   Graph_Graph31017->SetMinimum(-0.02550976);
   Graph_Graph31017->SetMaximum(0.02095683);
   ...
   Graph_Graph41018->SetMinimum(-0.007241619);
   Graph_Graph41018->SetMaximum(0.01301334);
   ...
   Graph_Graph51019->SetMinimum(-0.002498394);
   Graph_Graph51019->SetMaximum(0.003337582);
