...
//=========  (Fri Apr 23 12:35:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.17585);
   Graph_Graph01033->SetMaximum(56.14101);
   ...
   mainFit1034->SetChisquare(4.875844);
   ...
   mainFit1034->SetParameter(0,-2.375328);
   mainFit1034->SetParError(0,0.5027435);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9368984);
   mainFit1034->SetParError(1,0.01657965);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.0166");
   pt_LaTex = pt->AddText("#minus2.38#pm0.503");
   pt_LaTex = pt->AddText("#minus2.54#pm0.517");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.53531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.53531,-61.17585,2.53531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.875844);
   ...
   mainFit1035->SetParameter(0,-2.375328);
   mainFit1035->SetParError(0,0.5027435);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9368984);
   mainFit1035->SetParError(1,0.01657965);
