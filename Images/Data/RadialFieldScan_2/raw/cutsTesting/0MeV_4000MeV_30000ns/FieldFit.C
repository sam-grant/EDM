...
//=========  (Fri Apr 23 12:35:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.17585);
   Graph_Graph01020->SetMaximum(56.14101);
   ...
   mainFit1021->SetChisquare(5.639542);
   ...
   mainFit1021->SetParameter(0,-2.110375);
   mainFit1021->SetParError(0,0.4010501);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9281901);
   mainFit1021->SetParError(1,0.01325535);
   ...
   pt_LaTex = pt->AddText("0.928#pm0.0133");
   pt_LaTex = pt->AddText("#minus2.11#pm0.401");
   pt_LaTex = pt->AddText("#minus2.27#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.273646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.273646,-61.17585,2.273646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.639542);
   ...
   mainFit1022->SetParameter(0,-2.110375);
   mainFit1022->SetParError(0,0.4010501);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9281901);
   mainFit1022->SetParError(1,0.01325535);
