...
//=========  (Fri Apr 23 12:35:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.17585);
   Graph_Graph01023->SetMaximum(56.14101);
   ...
   mainFit1024->SetChisquare(5.639542);
   ...
   mainFit1024->SetParameter(0,-2.110375);
   mainFit1024->SetParError(0,0.4010501);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9281901);
   mainFit1024->SetParError(1,0.01325535);
   ...
   mainFit1025->SetChisquare(5.639542);
   ...
   mainFit1025->SetParameter(0,-2.110375);
   mainFit1025->SetParError(0,0.4010501);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9281901);
   mainFit1025->SetParError(1,0.01325535);
