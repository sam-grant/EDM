...
//=========  (Fri Apr 23 12:35:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.54384,50,44.32252);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.0572);
   Graph_Graph01025->SetMaximum(32.83588);
   ...
   mainFit1026->SetChisquare(3.620692);
   ...
   mainFit1026->SetParameter(0,-2.33923);
   mainFit1026->SetParError(0,0.4321807);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9128128);
   mainFit1026->SetParError(1,0.01711463);
   ...
   pt_LaTex = pt->AddText("#minus2.34#pm0.432");
   pt_LaTex = pt->AddText("#minus2.56#pm0.482");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.562661,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.562661,-59.0572,2.562661,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.620692);
   ...
   mainFit1027->SetParameter(0,-2.33923);
   mainFit1027->SetParError(0,0.4321807);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9128128);
   mainFit1027->SetParError(1,0.01711463);
