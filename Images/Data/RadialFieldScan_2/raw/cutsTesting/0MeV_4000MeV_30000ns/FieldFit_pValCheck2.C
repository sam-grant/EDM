...
//=========  (Fri Apr 23 12:35:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.17585);
   Graph_Graph01029->SetMaximum(56.14101);
   ...
   mainFit1030->SetChisquare(4.459588);
   ...
   mainFit1030->SetParameter(0,-2.295935);
   mainFit1030->SetParError(0,0.4359097);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9271);
   mainFit1030->SetParError(1,0.01329364);
   ...
   pt_LaTex = pt->AddText(" #minus2.3#pm0.436");
   pt_LaTex = pt->AddText("#minus2.48#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.476469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.476469,-61.17585,2.476469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.459588);
   ...
   mainFit1031->SetParameter(0,-2.295935);
   mainFit1031->SetParError(0,0.4359097);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9271);
   mainFit1031->SetParError(1,0.01329364);
