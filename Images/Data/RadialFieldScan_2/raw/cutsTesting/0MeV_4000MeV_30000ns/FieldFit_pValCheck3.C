...
//=========  (Fri Apr 23 12:35:14 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.17585);
   Graph_Graph01031->SetMaximum(56.14101);
   ...
   mainFit1032->SetChisquare(5.45144);
   ...
   mainFit1032->SetParameter(0,-2.01102);
   mainFit1032->SetParError(0,0.4618846);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9266613);
   mainFit1032->SetParError(1,0.01371911);
   ...
   pt_LaTex = pt->AddText("#minus2.01#pm0.462");
   pt_LaTex = pt->AddText("#minus2.17#pm0.491");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.170178,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.170178,-61.17585,2.170178,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.45144);
   ...
   mainFit1033->SetParameter(0,-2.01102);
   mainFit1033->SetParError(0,0.4618846);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9266613);
   mainFit1033->SetParError(1,0.01371911);
