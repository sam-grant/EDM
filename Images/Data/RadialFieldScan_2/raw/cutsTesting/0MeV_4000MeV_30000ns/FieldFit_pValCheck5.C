...
//=========  (Fri Apr 23 12:35:14 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.44615,70,65.52675);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.94886);
   Graph_Graph01035->SetMaximum(54.02946);
   ...
   mainFit1036->SetChisquare(5.194574);
   ...
   mainFit1036->SetParameter(0,-2.025794);
   mainFit1036->SetParError(0,0.4206243);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9241914);
   mainFit1036->SetParError(1,0.014551);
   ...
   pt_LaTex = pt->AddText("#minus2.03#pm0.421");
   pt_LaTex = pt->AddText("#minus2.19#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.191963,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.191963,-37.94886,2.191963,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.194574);
   ...
   mainFit1037->SetParameter(0,-2.025794);
   mainFit1037->SetParError(0,0.4206243);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9241914);
   mainFit1037->SetParError(1,0.014551);
