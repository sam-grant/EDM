...
//=========  (Fri Apr 23 12:35:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.84046,75,70.80561);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-61.17585);
   Graph_Graph01027->SetMaximum(56.14101);
   ...
   mainFit1028->SetChisquare(1.244253);
   ...
   mainFit1028->SetParameter(0,-1.687236);
   mainFit1028->SetParError(0,0.4489777);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9420171);
   mainFit1028->SetParError(1,0.01480456);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.415");
   pt_LaTex = pt->AddText("0.942#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.69#pm0.449");
   pt_LaTex = pt->AddText("#minus1.79#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.791088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.791088,-61.17585,1.791088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.244253);
   ...
   mainFit1029->SetParameter(0,-1.687236);
   mainFit1029->SetParError(0,0.4489777);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9420171);
   mainFit1029->SetParError(1,0.01480456);
