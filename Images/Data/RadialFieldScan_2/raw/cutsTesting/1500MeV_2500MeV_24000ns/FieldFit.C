...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.18763);
   Graph_Graph01020->SetMaximum(48.96417);
   ...
   mainFit1021->SetChisquare(1.334949);
   ...
   mainFit1021->SetParameter(0,-0.05274444);
   mainFit1021->SetParError(0,0.6453282);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7692741);
   mainFit1021->SetParError(1,0.0212864);
   ...
   mainFit1022->SetChisquare(1.334949);
   ...
   mainFit1022->SetParameter(0,-0.05274444);
   mainFit1022->SetParError(0,0.6453282);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7692741);
   mainFit1022->SetParError(1,0.0212864);
