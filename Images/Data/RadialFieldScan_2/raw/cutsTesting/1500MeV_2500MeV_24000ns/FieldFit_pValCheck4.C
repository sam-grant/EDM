...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.18763);
   Graph_Graph01033->SetMaximum(48.96417);
   ...
   mainFit1034->SetChisquare(0.9546115);
   ...
   mainFit1034->SetParameter(0,-0.3538382);
   mainFit1034->SetParError(0,0.8092029);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7791314);
   mainFit1034->SetParError(1,0.02661927);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.318");
   pt_LaTex = pt->AddText("0.779#pm0.0266");
   pt_LaTex = pt->AddText("#minus0.354#pm0.809");
   pt_LaTex = pt->AddText("#minus0.454#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4541445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4541445,-52.18763,0.4541445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.9546115);
   ...
   mainFit1035->SetParameter(0,-0.3538382);
   mainFit1035->SetParError(0,0.8092029);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7791314);
   mainFit1035->SetParError(1,0.02661927);
