...
//=========  (Wed Apr 21 20:00:37 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.901463);
   ...
   quadLineFit1002->SetParameter(0,74.77965);
   quadLineFit1002->SetParError(0,0.09760941);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.89781);
   quadLineFit1002->SetParError(1,1.637042);
   ...
   quadLineFit1003->SetChisquare(2.901463);
   ...
   quadLineFit1003->SetParameter(0,74.77965);
   quadLineFit1003->SetParError(0,0.09760941);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.89781);
   quadLineFit1003->SetParError(1,1.637042);
   ...
   Graph_30_ppm1003->SetMinimum(75.79799);
   Graph_30_ppm1003->SetMaximum(76.369);
   ...
   quadLineFit1004->SetChisquare(3.058886);
   ...
   quadLineFit1004->SetParameter(0,74.72266);
   quadLineFit1004->SetParError(0,0.08282277);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.20885);
   quadLineFit1004->SetParError(1,1.361219);
   ...
   quadLineFit1005->SetChisquare(3.058886);
   ...
   quadLineFit1005->SetParameter(0,74.72266);
   quadLineFit1005->SetParError(0,0.08282277);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.20885);
   quadLineFit1005->SetParError(1,1.361219);
   ...
   Graph_10_ppm1005->SetMinimum(74.89168);
   Graph_10_ppm1005->SetMaximum(75.14013);
   ...
   quadLineFit1006->SetChisquare(0.2381699);
   ...
   quadLineFit1006->SetParameter(0,74.52481);
   quadLineFit1006->SetParError(0,0.09708149);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.889389);
   quadLineFit1006->SetParError(1,1.57446);
   ...
   quadLineFit1007->SetChisquare(0.2381699);
   ...
   quadLineFit1007->SetParameter(0,74.52481);
   quadLineFit1007->SetParError(0,0.09708149);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.889389);
   quadLineFit1007->SetParError(1,1.57446);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.82224);
   Graph_mI10_ppm1007->SetMaximum(74.09399);
   ...
   quadLineFit1008->SetChisquare(6.570587);
   ...
   quadLineFit1008->SetParameter(0,74.40608);
   quadLineFit1008->SetParError(0,0.08519488);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.516594);
   quadLineFit1008->SetParError(1,1.386605);
   ...
   quadLineFit1009->SetChisquare(6.570587);
   ...
   quadLineFit1009->SetParameter(0,74.40608);
   quadLineFit1009->SetParError(0,0.08519488);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.516594);
   quadLineFit1009->SetParError(1,1.386605);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.58471);
   Graph_mI30_ppm1009->SetMaximum(73.18879);
   ...
   quadLineFit1010->SetChisquare(1.229604);
   ...
   quadLineFit1010->SetParameter(0,74.28208);
   quadLineFit1010->SetParError(0,0.08058421);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.51898);
   quadLineFit1010->SetParError(1,1.394646);
   ...
   quadLineFit1011->SetChisquare(1.229604);
   ...
   quadLineFit1011->SetParameter(0,74.28208);
   quadLineFit1011->SetParError(0,0.08058421);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.51898);
   quadLineFit1011->SetParError(1,1.394646);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.70839);
   Graph_mI50_ppm1011->SetMaximum(72.31305);
   ...
   quadLineFit1012->SetChisquare(0.1067707);
   ...
   quadLineFit1012->SetParameter(0,74.34007);
   quadLineFit1012->SetParError(0,0.1626573);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.84788);
   quadLineFit1012->SetParError(1,2.91043);
   ...
   quadLineFit1013->SetChisquare(0.1067707);
   ...
   quadLineFit1013->SetParameter(0,74.34007);
   quadLineFit1013->SetParError(0,0.1626573);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.84788);
   quadLineFit1013->SetParError(1,2.91043);
