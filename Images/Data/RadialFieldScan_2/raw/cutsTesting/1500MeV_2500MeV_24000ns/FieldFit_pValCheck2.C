...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.18763);
   Graph_Graph01029->SetMaximum(48.96417);
   ...
   mainFit1030->SetChisquare(1.304793);
   ...
   mainFit1030->SetParameter(0,-0.10034);
   mainFit1030->SetParError(0,0.7011608);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7689962);
   mainFit1030->SetParError(1,0.02134467);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.435");
   pt_LaTex = pt->AddText("0.769#pm0.0213");
   pt_LaTex = pt->AddText(" #minus0.1#pm0.701");
   pt_LaTex = pt->AddText("#minus0.13#pm0.911");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1304818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1304818,-52.18763,0.1304818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.304793);
   ...
   mainFit1031->SetParameter(0,-0.10034);
   mainFit1031->SetParError(0,0.7011608);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7689962);
   mainFit1031->SetParError(1,0.02134467);
