...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.18763);
   Graph_Graph01027->SetMaximum(48.96417);
   ...
   mainFit1028->SetChisquare(0.7623903);
   ...
   mainFit1028->SetParameter(0,0.1915407);
   mainFit1028->SetParError(0,0.7215774);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7772148);
   mainFit1028->SetParError(1,0.02373267);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.254");
   pt_LaTex = pt->AddText("0.777#pm0.0237");
   pt_LaTex = pt->AddText("0.192#pm0.722");
   pt_LaTex = pt->AddText("0.246#pm0.928");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.246445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.246445,-52.18763,-0.246445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7623903);
   ...
   mainFit1029->SetParameter(0,0.1915407);
   mainFit1029->SetParError(0,0.7215774);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7772148);
   mainFit1029->SetParError(1,0.02373267);
