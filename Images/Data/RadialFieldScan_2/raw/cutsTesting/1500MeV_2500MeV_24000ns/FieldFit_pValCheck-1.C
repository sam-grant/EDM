...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.83161,75,61.60815);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-52.18763);
   Graph_Graph01023->SetMaximum(48.96417);
   ...
   mainFit1024->SetChisquare(1.334949);
   ...
   mainFit1024->SetParameter(0,-0.05274444);
   mainFit1024->SetParError(0,0.6453282);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7692741);
   mainFit1024->SetParError(1,0.0212864);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.334");
   pt_LaTex = pt->AddText("0.769#pm0.0213");
   pt_LaTex = pt->AddText("#minus0.0527#pm0.645");
   pt_LaTex = pt->AddText("#minus0.0686#pm0.839");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.06856392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.06856392,-52.18763,0.06856392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.334949);
   ...
   mainFit1025->SetParameter(0,-0.05274444);
   mainFit1025->SetParError(0,0.6453282);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7692741);
   mainFit1025->SetParError(1,0.0212864);
