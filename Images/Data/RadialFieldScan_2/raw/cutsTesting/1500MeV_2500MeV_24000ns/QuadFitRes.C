...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02176214);
   Graph_Graph11015->SetMaximum(0.04667129);
   ...
   Graph_Graph21016->SetMinimum(-0.006890154);
   Graph_Graph21016->SetMaximum(0.008118438);
   ...
   Graph_Graph31017->SetMinimum(-0.04714249);
   Graph_Graph31017->SetMaximum(0.03394614);
   ...
   Graph_Graph41018->SetMinimum(-0.01700787);
   Graph_Graph41018->SetMaximum(0.02753641);
   ...
   Graph_Graph51019->SetMinimum(-0.004310705);
   Graph_Graph51019->SetMaximum(0.005757722);
