...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.18763);
   Graph_Graph01031->SetMaximum(48.96417);
   ...
   mainFit1032->SetChisquare(1.297938);
   ...
   mainFit1032->SetParameter(0,-0.1237494);
   mainFit1032->SetParError(0,0.7434185);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7703734);
   mainFit1032->SetParError(1,0.02204008);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.433");
   pt_LaTex = pt->AddText(" 0.77#pm0.022");
   pt_LaTex = pt->AddText("#minus0.124#pm0.743");
   pt_LaTex = pt->AddText("#minus0.161#pm0.964");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1606356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1606356,-52.18763,0.1606356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.297938);
   ...
   mainFit1033->SetParameter(0,-0.1237494);
   mainFit1033->SetParError(0,0.7434185);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7703734);
   mainFit1033->SetParError(1,0.02204008);
