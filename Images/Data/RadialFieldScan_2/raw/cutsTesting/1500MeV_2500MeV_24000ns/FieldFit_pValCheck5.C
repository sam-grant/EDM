...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.02575,70,56.64698);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.35847);
   Graph_Graph01035->SetMaximum(46.9797);
   ...
   mainFit1036->SetChisquare(0.5230123);
   ...
   mainFit1036->SetParameter(0,0.1317732);
   mainFit1036->SetParError(0,0.6770387);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7605944);
   mainFit1036->SetParError(1,0.02336448);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.174");
   pt_LaTex = pt->AddText("0.761#pm0.0234");
   pt_LaTex = pt->AddText("0.132#pm0.677");
   pt_LaTex = pt->AddText("0.173#pm0.892");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.1732503,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1732503,-30.35847,-0.1732503,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.5230123);
   ...
   mainFit1037->SetParameter(0,0.1317732);
   mainFit1037->SetParError(0,0.6770387);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7605944);
   mainFit1037->SetParError(1,0.02336448);
