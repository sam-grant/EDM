...
//=========  (Wed Apr 21 20:00:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.59041,50,40.40217);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.49115);
   Graph_Graph01025->SetMaximum(30.30291);
   ...
   mainFit1026->SetChisquare(1.160336);
   ...
   mainFit1026->SetParameter(0,-0.1614564);
   mainFit1026->SetParError(0,0.6957803);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7619571);
   mainFit1026->SetParError(1,0.02755578);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.387");
   pt_LaTex = pt->AddText("0.762#pm0.0276");
   pt_LaTex = pt->AddText("#minus0.161#pm0.696");
   pt_LaTex = pt->AddText("#minus0.212#pm0.914");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.211897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.211897,-50.49115,0.211897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.160336);
   ...
   mainFit1027->SetParameter(0,-0.1614564);
   mainFit1027->SetParError(0,0.6957803);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7619571);
   mainFit1027->SetParError(1,0.02755578);
