...
//=========  (Wed Apr 28 16:58:09 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.238535);
   ...
   quadLineFit1002->SetParameter(0,74.71701);
   quadLineFit1002->SetParError(0,0.07810839);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.81396);
   quadLineFit1002->SetParError(1,1.310101);
   ...
   quadLineFit1003->SetChisquare(3.238535);
   ...
   quadLineFit1003->SetParameter(0,74.71701);
   quadLineFit1003->SetParError(0,0.07810839);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.81396);
   quadLineFit1003->SetParError(1,1.310101);
   ...
   Graph_30_ppm1003->SetMinimum(75.81682);
   Graph_30_ppm1003->SetMaximum(76.3935);
   ...
   quadLineFit1004->SetChisquare(3.75508);
   ...
   quadLineFit1004->SetParameter(0,74.71031);
   quadLineFit1004->SetParError(0,0.06575049);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.76723);
   quadLineFit1004->SetParError(1,1.080677);
   ...
   quadLineFit1005->SetChisquare(3.75508);
   ...
   quadLineFit1005->SetParameter(0,74.71031);
   quadLineFit1005->SetParError(0,0.06575049);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.76723);
   quadLineFit1005->SetParError(1,1.080677);
   ...
   Graph_10_ppm1005->SetMinimum(74.8942);
   Graph_10_ppm1005->SetMaximum(75.15165);
   ...
   quadLineFit1006->SetChisquare(0.04728217);
   ...
   quadLineFit1006->SetParameter(0,74.47904);
   quadLineFit1006->SetParError(0,0.07702712);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.813224);
   quadLineFit1006->SetParError(1,1.249202);
   ...
   quadLineFit1007->SetChisquare(0.04728217);
   ...
   quadLineFit1007->SetParameter(0,74.47904);
   quadLineFit1007->SetParError(0,0.07702712);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.813224);
   quadLineFit1007->SetParError(1,1.249202);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.8016);
   Graph_mI10_ppm1007->SetMaximum(74.07404);
   ...
   quadLineFit1008->SetChisquare(7.707319);
   ...
   quadLineFit1008->SetParameter(0,74.43044);
   quadLineFit1008->SetParError(0,0.06763097);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.211341);
   quadLineFit1008->SetParError(1,1.100796);
   ...
   quadLineFit1009->SetChisquare(7.707319);
   ...
   quadLineFit1009->SetParameter(0,74.43044);
   quadLineFit1009->SetParError(0,0.06763097);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.211341);
   quadLineFit1009->SetParError(1,1.100796);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.53351);
   Graph_mI30_ppm1009->SetMaximum(73.15858);
   ...
   quadLineFit1010->SetChisquare(0.3530332);
   ...
   quadLineFit1010->SetParameter(0,74.33944);
   quadLineFit1010->SetParError(0,0.06396468);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.20804);
   quadLineFit1010->SetParError(1,1.107);
   ...
   quadLineFit1011->SetChisquare(0.3530332);
   ...
   quadLineFit1011->SetParameter(0,74.33944);
   quadLineFit1011->SetParError(0,0.06396468);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.20804);
   quadLineFit1011->SetParError(1,1.107);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.65358);
   Graph_mI50_ppm1011->SetMaximum(72.24232);
   ...
   quadLineFit1012->SetChisquare(2.728509);
   ...
   quadLineFit1012->SetParameter(0,74.27308);
   quadLineFit1012->SetParError(0,0.1288643);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.60726);
   quadLineFit1012->SetParError(1,2.305663);
   ...
   quadLineFit1013->SetChisquare(2.728509);
   ...
   quadLineFit1013->SetParameter(0,74.27308);
   quadLineFit1013->SetParError(0,0.1288643);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.60726);
   quadLineFit1013->SetParError(1,2.305663);
