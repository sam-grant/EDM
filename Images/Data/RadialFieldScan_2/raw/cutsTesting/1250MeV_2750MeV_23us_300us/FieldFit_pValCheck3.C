...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.17217,75,63.38331);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.41662);
   Graph_Graph01031->SetMaximum(50.62776);
   ...
   mainFit1032->SetChisquare(2.139399);
   ...
   mainFit1032->SetParameter(0,-0.1418974);
   mainFit1032->SetParError(0,0.5902797);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8034154);
   mainFit1032->SetParError(1,0.01753151);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.713");
   pt_LaTex = pt->AddText("0.803#pm0.0175");
   pt_LaTex = pt->AddText("#minus0.142#pm 0.59");
   pt_LaTex = pt->AddText("#minus0.177#pm0.734");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1766177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1766177,-51.41662,0.1766177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.139399);
   ...
   mainFit1033->SetParameter(0,-0.1418974);
   mainFit1033->SetParError(0,0.5902797);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8034154);
   mainFit1033->SetParError(1,0.01753151);
