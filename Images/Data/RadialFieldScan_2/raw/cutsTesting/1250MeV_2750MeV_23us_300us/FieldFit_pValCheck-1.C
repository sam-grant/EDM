...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.41662);
   Graph_Graph01023->SetMaximum(50.62776);
   ...
   mainFit1024->SetChisquare(2.140156);
   ...
   mainFit1024->SetParameter(0,-0.1499546);
   mainFit1024->SetParError(0,0.512499);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8035397);
   mainFit1024->SetParError(1,0.01693871);
   ...
   pt_LaTex = pt->AddText("0.804#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.15#pm0.512");
   pt_LaTex = pt->AddText("#minus0.187#pm0.637");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1866176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1866176,-51.41662,0.1866176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.140156);
   ...
   mainFit1025->SetParameter(0,-0.1499546);
   mainFit1025->SetParError(0,0.512499);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8035397);
   mainFit1025->SetParError(1,0.01693871);
