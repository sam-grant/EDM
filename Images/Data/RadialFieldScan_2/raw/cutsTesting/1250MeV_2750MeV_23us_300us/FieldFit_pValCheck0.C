...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.60313,50,40.53812);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.58901);
   Graph_Graph01025->SetMaximum(30.52399);
   ...
   mainFit1026->SetChisquare(1.433655);
   ...
   mainFit1026->SetParameter(0,-0.3228952);
   mainFit1026->SetParError(0,0.5522469);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7919115);
   mainFit1026->SetParError(1,0.02186545);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.478");
   pt_LaTex = pt->AddText("0.792#pm0.0219");
   pt_LaTex = pt->AddText("#minus0.323#pm0.552");
   pt_LaTex = pt->AddText("#minus0.408#pm0.699");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.4077415,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4077415,-49.58901,0.4077415,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.433655);
   ...
   mainFit1027->SetParameter(0,-0.3228952);
   mainFit1027->SetParError(0,0.5522469);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7919115);
   mainFit1027->SetParError(1,0.02186545);
