...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.41662);
   Graph_Graph01029->SetMaximum(50.62776);
   ...
   mainFit1030->SetChisquare(1.47658);
   ...
   mainFit1030->SetParameter(0,-0.3277831);
   mainFit1030->SetParError(0,0.5570598);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8024873);
   mainFit1030->SetParError(1,0.01698768);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.492");
   pt_LaTex = pt->AddText("0.802#pm0.017");
   pt_LaTex = pt->AddText("#minus0.328#pm0.557");
   pt_LaTex = pt->AddText("#minus0.408#pm0.693");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.408459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.408459,-51.41662,0.408459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.47658);
   ...
   mainFit1031->SetParameter(0,-0.3277831);
   mainFit1031->SetParError(0,0.5570598);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8024873);
   mainFit1031->SetParError(1,0.01698768);
