...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.41662);
   Graph_Graph01033->SetMaximum(50.62776);
   ...
   mainFit1034->SetChisquare(2.136426);
   ...
   mainFit1034->SetParameter(0,-0.1735758);
   mainFit1034->SetParError(0,0.6420805);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8043157);
   mainFit1034->SetParError(1,0.0211745);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.712");
   pt_LaTex = pt->AddText("0.804#pm0.0212");
   pt_LaTex = pt->AddText("#minus0.174#pm0.642");
   pt_LaTex = pt->AddText("#minus0.216#pm0.796");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2158056,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2158056,-51.41662,0.2158056,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.136426);
   ...
   mainFit1035->SetParameter(0,-0.1735758);
   mainFit1035->SetParError(0,0.6420805);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8043157);
   mainFit1035->SetParError(1,0.0211745);
