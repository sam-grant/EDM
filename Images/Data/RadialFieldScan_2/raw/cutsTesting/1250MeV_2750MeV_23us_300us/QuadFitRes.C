...
//=========  (Wed Apr 28 16:58:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01855813);
   Graph_Graph11015->SetMaximum(0.04162479);
   ...
   Graph_Graph21016->SetMinimum(-0.00243741);
   Graph_Graph21016->SetMaximum(0.002869078);
   ...
   Graph_Graph31017->SetMinimum(-0.0405411);
   Graph_Graph31017->SetMaximum(0.02910515);
   ...
   Graph_Graph41018->SetMinimum(-0.005720238);
   Graph_Graph41018->SetMaximum(0.007015812);
   ...
   Graph_Graph51019->SetMinimum(-0.01729928);
   Graph_Graph51019->SetMaximum(0.0231165);
