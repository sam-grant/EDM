...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.17482,70,58.98384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.05895);
   Graph_Graph01035->SetMaximum(48.86797);
   ...
   mainFit1036->SetChisquare(2.121429);
   ...
   mainFit1036->SetParameter(0,-0.1277276);
   mainFit1036->SetParError(0,0.537621);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8024877);
   mainFit1036->SetParError(1,0.01860151);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.707");
   pt_LaTex = pt->AddText("0.802#pm0.0186");
   pt_LaTex = pt->AddText("#minus0.128#pm0.538");
   pt_LaTex = pt->AddText("#minus0.159#pm0.669");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1591646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1591646,-32.05895,0.1591646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.121429);
   ...
   mainFit1037->SetParameter(0,-0.1277276);
   mainFit1037->SetParError(0,0.537621);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8024877);
   mainFit1037->SetParError(1,0.01860151);
