...
//=========  (Wed Apr 28 16:58:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.41662);
   Graph_Graph01020->SetMaximum(50.62776);
   ...
   mainFit1021->SetChisquare(2.140156);
   ...
   mainFit1021->SetParameter(0,-0.1499546);
   mainFit1021->SetParError(0,0.512499);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8035397);
   mainFit1021->SetParError(1,0.01693871);
   ...
   mainFit1022->SetChisquare(2.140156);
   ...
   mainFit1022->SetParameter(0,-0.1499546);
   mainFit1022->SetParError(0,0.512499);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8035397);
   mainFit1022->SetParError(1,0.01693871);
