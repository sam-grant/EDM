...
//=========  (Wed Apr 28 16:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.41662);
   Graph_Graph01027->SetMaximum(50.62776);
   ...
   mainFit1028->SetChisquare(0.2063027);
   ...
   mainFit1028->SetParameter(0,0.2088769);
   mainFit1028->SetParError(0,0.5737922);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8152607);
   mainFit1028->SetParError(1,0.01891984);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0688");
   pt_LaTex = pt->AddText("0.815#pm0.0189");
   pt_LaTex = pt->AddText("0.209#pm0.574");
   pt_LaTex = pt->AddText("0.256#pm0.703");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2562088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2562088,-51.41662,-0.2562088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2063027);
   ...
   mainFit1029->SetParameter(0,0.2088769);
   mainFit1029->SetParError(0,0.5737922);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8152607);
   mainFit1029->SetParError(1,0.01891984);
