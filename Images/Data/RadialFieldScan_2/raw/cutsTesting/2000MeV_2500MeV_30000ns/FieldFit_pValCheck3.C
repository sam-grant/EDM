...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-42.24451);
   Graph_Graph01031->SetMaximum(47.85008);
   ...
   mainFit1032->SetChisquare(2.111836);
   ...
   mainFit1032->SetParameter(0,1.113052);
   mainFit1032->SetParError(0,1.15762);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7178673);
   mainFit1032->SetParError(1,0.03438439);
   ...
   pt_LaTex = pt->AddText("0.718#pm0.0344");
   pt_LaTex = pt->AddText(" 1.11#pm 1.16");
   pt_LaTex = pt->AddText(" 1.55#pm 1.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.550499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.550499,-42.24451,-1.550499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.111836);
   ...
   mainFit1033->SetParameter(0,1.113052);
   mainFit1033->SetParError(0,1.15762);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7178673);
   mainFit1033->SetParError(1,0.03438439);
