...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-42.24451);
   Graph_Graph01033->SetMaximum(47.85008);
   ...
   mainFit1034->SetChisquare(1.931897);
   ...
   mainFit1034->SetParameter(0,1.32284);
   mainFit1034->SetParError(0,1.258077);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7053936);
   mainFit1034->SetParError(1,0.04152064);
   ...
   pt_LaTex = pt->AddText("0.705#pm0.0415");
   pt_LaTex = pt->AddText(" 1.32#pm 1.26");
   pt_LaTex = pt->AddText(" 1.88#pm 1.84");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.875323,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.875323,-42.24451,-1.875323,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.931897);
   ...
   mainFit1035->SetParameter(0,1.32284);
   mainFit1035->SetParError(0,1.258077);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7053936);
   mainFit1035->SetParError(1,0.04152064);
