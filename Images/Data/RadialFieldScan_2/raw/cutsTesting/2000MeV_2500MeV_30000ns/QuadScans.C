...
//=========  (Thu Apr 22 00:39:39 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2308805);
   ...
   quadLineFit1002->SetParameter(0,75.00132);
   quadLineFit1002->SetParError(0,0.1530061);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,37.77582);
   quadLineFit1002->SetParError(1,2.566384);
   ...
   quadLineFit1003->SetChisquare(0.2308805);
   ...
   quadLineFit1003->SetParameter(0,75.00132);
   quadLineFit1003->SetParError(0,0.1530061);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,37.77582);
   quadLineFit1003->SetParError(1,2.566384);
   ...
   Graph_30_ppm1003->SetMinimum(76.00477);
   Graph_30_ppm1003->SetMaximum(76.58372);
   ...
   quadLineFit1004->SetChisquare(1.03897);
   ...
   quadLineFit1004->SetParameter(0,74.95726);
   quadLineFit1004->SetParError(0,0.128876);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.64811);
   quadLineFit1004->SetParError(1,2.118236);
   ...
   quadLineFit1005->SetChisquare(1.03897);
   ...
   quadLineFit1005->SetParameter(0,74.95726);
   quadLineFit1005->SetParError(0,0.128876);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.64811);
   quadLineFit1005->SetParError(1,2.118236);
   ...
   Graph_10_ppm1005->SetMinimum(75.05947);
   Graph_10_ppm1005->SetMaximum(75.37882);
   ...
   quadLineFit1006->SetChisquare(0.1067943);
   ...
   quadLineFit1006->SetParameter(0,74.62419);
   quadLineFit1006->SetParError(0,0.1509864);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.564873);
   quadLineFit1006->SetParError(1,2.448776);
   ...
   quadLineFit1007->SetChisquare(0.1067943);
   ...
   quadLineFit1007->SetParameter(0,74.62419);
   quadLineFit1007->SetParError(0,0.1509864);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.564873);
   quadLineFit1007->SetParError(1,2.448776);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.0707);
   Graph_mI10_ppm1007->SetMaximum(74.36506);
   ...
   quadLineFit1008->SetChisquare(2.05085);
   ...
   quadLineFit1008->SetParameter(0,74.66276);
   quadLineFit1008->SetParError(0,0.1322445);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.460681);
   quadLineFit1008->SetParError(1,2.152005);
   ...
   quadLineFit1009->SetChisquare(2.05085);
   ...
   quadLineFit1009->SetParameter(0,74.66276);
   quadLineFit1009->SetParError(0,0.1322445);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.460681);
   quadLineFit1009->SetParError(1,2.152005);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.83853);
   Graph_mI30_ppm1009->SetMaximum(73.45719);
   ...
   quadLineFit1010->SetChisquare(0.5097101);
   ...
   quadLineFit1010->SetParameter(0,74.51167);
   quadLineFit1010->SetParError(0,0.1254126);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-21.97147);
   quadLineFit1010->SetParError(1,2.170483);
   ...
   quadLineFit1011->SetChisquare(0.5097101);
   ...
   quadLineFit1011->SetParameter(0,74.51167);
   quadLineFit1011->SetParError(0,0.1254126);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-21.97147);
   quadLineFit1011->SetParError(1,2.170483);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.0656);
   Graph_mI50_ppm1011->SetMaximum(72.55654);
   ...
   quadLineFit1012->SetChisquare(0.5562877);
   ...
   quadLineFit1012->SetParameter(0,74.04436);
   quadLineFit1012->SetParError(0,0.2534545);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-30.20201);
   quadLineFit1012->SetParError(1,4.534621);
   ...
   quadLineFit1013->SetChisquare(0.5562877);
   ...
   quadLineFit1013->SetParameter(0,74.04436);
   quadLineFit1013->SetParError(0,0.2534545);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-30.20201);
   quadLineFit1013->SetParError(1,4.534621);
