...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.26299,70,56.46324);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.59037);
   Graph_Graph01035->SetMaximum(46.79062);
   ...
   mainFit1036->SetChisquare(0.7919103);
   ...
   mainFit1036->SetParameter(0,0.3882919);
   mainFit1036->SetParError(0,1.053106);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7419832);
   mainFit1036->SetParError(1,0.03644873);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.264");
   pt_LaTex = pt->AddText("0.742#pm0.0364");
   pt_LaTex = pt->AddText("0.388#pm 1.05");
   pt_LaTex = pt->AddText("0.523#pm 1.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.5233163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.5233163,-30.59037,-0.5233163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.7919103);
   ...
   mainFit1037->SetParameter(0,0.3882919);
   mainFit1037->SetParError(0,1.053106);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7419832);
   mainFit1037->SetParError(1,0.03644873);
