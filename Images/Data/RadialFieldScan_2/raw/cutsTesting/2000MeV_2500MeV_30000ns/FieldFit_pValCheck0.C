...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-49.36237,50,38.3921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-40.58692);
   Graph_Graph01025->SetMaximum(29.61665);
   ...
   mainFit1026->SetChisquare(2.209793);
   ...
   mainFit1026->SetParameter(0,0.6079726);
   mainFit1026->SetParError(0,1.082009);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7103513);
   mainFit1026->SetParError(1,0.04288883);
   ...
   pt_LaTex = pt->AddText(" 0.71#pm0.0429");
   pt_LaTex = pt->AddText("0.608#pm 1.08");
   pt_LaTex = pt->AddText("0.856#pm 1.52");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.8558761,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8558761,-40.58692,-0.8558761,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.209793);
   ...
   mainFit1027->SetParameter(0,0.6079726);
   mainFit1027->SetParError(0,1.082009);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7103513);
   mainFit1027->SetParError(1,0.04288883);
