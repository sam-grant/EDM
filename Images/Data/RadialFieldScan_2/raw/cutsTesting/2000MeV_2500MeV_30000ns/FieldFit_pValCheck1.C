...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-42.24451);
   Graph_Graph01027->SetMaximum(47.85008);
   ...
   mainFit1028->SetChisquare(2.175943);
   ...
   mainFit1028->SetParameter(0,1.042843);
   mainFit1028->SetParError(0,1.124043);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7309898);
   mainFit1028->SetParError(1,0.03709222);
   ...
   pt_LaTex = pt->AddText("0.731#pm0.0371");
   pt_LaTex = pt->AddText(" 1.04#pm 1.12");
   pt_LaTex = pt->AddText(" 1.43#pm 1.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.426617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.426617,-42.24451,-1.426617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.175943);
   ...
   mainFit1029->SetParameter(0,1.042843);
   mainFit1029->SetParError(0,1.124043);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7309898);
   mainFit1029->SetParError(1,0.03709222);
