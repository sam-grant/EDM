...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02624134);
   Graph_Graph11015->SetMaximum(0.02541097);
   ...
   Graph_Graph21016->SetMinimum(-0.007180549);
   Graph_Graph21016->SetMaximum(0.00845532);
   ...
   Graph_Graph31017->SetMinimum(-0.04108685);
   Graph_Graph31017->SetMaximum(0.02961827);
   ...
   Graph_Graph41018->SetMinimum(-0.01665593);
   Graph_Graph41018->SetMaximum(0.02821096);
   ...
   Graph_Graph51019->SetMinimum(-0.01533576);
   Graph_Graph51019->SetMaximum(0.02047205);
