...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-42.24451);
   Graph_Graph01023->SetMaximum(47.85008);
   ...
   mainFit1024->SetChisquare(2.420755);
   ...
   mainFit1024->SetParameter(0,0.7929922);
   mainFit1024->SetParError(0,1.004232);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7228169);
   mainFit1024->SetParError(1,0.0332112);
   ...
   pt_LaTex = pt->AddText("0.723#pm0.0332");
   pt_LaTex = pt->AddText("0.793#pm    1");
   pt_LaTex = pt->AddText("  1.1#pm  1.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.097086,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.097086,-42.24451,-1.097086,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.420755);
   ...
   mainFit1025->SetParameter(0,0.7929922);
   mainFit1025->SetParError(0,1.004232);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7228169);
   mainFit1025->SetParError(1,0.0332112);
