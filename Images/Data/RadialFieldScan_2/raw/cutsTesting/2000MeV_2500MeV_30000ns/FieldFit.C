...
//=========  (Thu Apr 22 00:39:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-42.24451);
   Graph_Graph01020->SetMaximum(47.85008);
   ...
   mainFit1021->SetChisquare(2.420755);
   ...
   mainFit1021->SetParameter(0,0.7929922);
   mainFit1021->SetParError(0,1.004232);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7228169);
   mainFit1021->SetParError(1,0.0332112);
   ...
   mainFit1022->SetChisquare(2.420755);
   ...
   mainFit1022->SetParameter(0,0.7929922);
   mainFit1022->SetParError(0,1.004232);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7228169);
   mainFit1022->SetParError(1,0.0332112);
