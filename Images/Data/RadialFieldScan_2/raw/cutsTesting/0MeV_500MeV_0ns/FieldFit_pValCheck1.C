...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-31.82251);
   Graph_Graph01027->SetMaximum(42.5619);
   ...
   mainFit1028->SetChisquare(78.3811);
   ...
   mainFit1028->SetParameter(0,-1.413038);
   mainFit1028->SetParError(0,0.6941213);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7071716);
   mainFit1028->SetParError(1,0.02255344);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 26.1");
   pt_LaTex = pt->AddText("0.707#pm0.0226");
   pt_LaTex = pt->AddText("#minus1.41#pm0.694");
   pt_LaTex = pt->AddText("   #minus2#pm0.989");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.998154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.998154,-31.82251,1.998154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(78.3811);
   ...
   mainFit1029->SetParameter(0,-1.413038);
   mainFit1029->SetParError(0,0.6941213);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7071716);
   mainFit1029->SetParError(1,0.02255344);
