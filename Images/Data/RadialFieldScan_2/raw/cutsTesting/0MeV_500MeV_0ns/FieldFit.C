...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-31.82251);
   Graph_Graph01020->SetMaximum(42.5619);
   ...
   mainFit1021->SetChisquare(122.8818);
   ...
   mainFit1021->SetParameter(0,0.690245);
   mainFit1021->SetParError(0,0.6183817);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7740605);
   mainFit1021->SetParError(1,0.02020209);
   ...
   mainFit1022->SetChisquare(122.8818);
   ...
   mainFit1022->SetParameter(0,0.690245);
   mainFit1022->SetParError(0,0.6183817);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7740605);
   mainFit1022->SetParError(1,0.02020209);
