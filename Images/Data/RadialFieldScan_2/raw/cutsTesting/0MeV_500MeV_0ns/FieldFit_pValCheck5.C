...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-39.60743,70,51.55732);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.49096);
   Graph_Graph01035->SetMaximum(42.44085);
   ...
   mainFit1036->SetChisquare(82.81244);
   ...
   mainFit1036->SetParameter(0,-0.5657069);
   mainFit1036->SetParError(0,0.6494329);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8330716);
   mainFit1036->SetParError(1,0.0222493);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 27.6");
   pt_LaTex = pt->AddText("0.833#pm0.0222");
   pt_LaTex = pt->AddText("#minus0.566#pm0.649");
   pt_LaTex = pt->AddText("#minus0.679#pm0.775");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6790616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6790616,-30.49096,0.6790616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(82.81244);
   ...
   mainFit1037->SetParameter(0,-0.5657069);
   mainFit1037->SetParError(0,0.6494329);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8330716);
   mainFit1037->SetParError(1,0.0222493);
