...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-31.82251);
   Graph_Graph01033->SetMaximum(42.5619);
   ...
   mainFit1034->SetChisquare(122.4922);
   ...
   mainFit1034->SetParameter(0,0.9860579);
   mainFit1034->SetParError(0,0.7790775);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7645407);
   mainFit1034->SetParError(1,0.02531205);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 40.8");
   pt_LaTex = pt->AddText("0.765#pm0.0253");
   pt_LaTex = pt->AddText("0.986#pm0.779");
   pt_LaTex = pt->AddText(" 1.29#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.289739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.289739,-31.82251,-1.289739,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(122.4922);
   ...
   mainFit1035->SetParameter(0,0.9860579);
   mainFit1035->SetParError(0,0.7790775);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7645407);
   mainFit1035->SetParError(1,0.02531205);
