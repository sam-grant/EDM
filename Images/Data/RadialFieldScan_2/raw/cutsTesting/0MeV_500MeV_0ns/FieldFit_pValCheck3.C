...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-31.82251);
   Graph_Graph01031->SetMaximum(42.5619);
   ...
   mainFit1032->SetChisquare(55.52256);
   ...
   mainFit1032->SetParameter(0,3.508313);
   mainFit1032->SetParError(0,0.7073144);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7326198);
   mainFit1032->SetParError(1,0.02082353);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 18.5");
   pt_LaTex = pt->AddText("0.733#pm0.0208");
   pt_LaTex = pt->AddText(" 3.51#pm0.707");
   pt_LaTex = pt->AddText(" 4.79#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-4.788722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-4.788722,-31.82251,-4.788722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(55.52256);
   ...
   mainFit1033->SetParameter(0,3.508313);
   mainFit1033->SetParError(0,0.7073144);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7326198);
   mainFit1033->SetParError(1,0.02082353);
