...
//=========  (Wed Apr 21 23:17:16 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(79.36635);
   ...
   quadLineFit1002->SetParameter(0,74.81002);
   quadLineFit1002->SetParError(0,0.09417847);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,34.79227);
   quadLineFit1002->SetParError(1,1.570925);
   ...
   quadLineFit1003->SetChisquare(79.36635);
   ...
   quadLineFit1003->SetParameter(0,74.81002);
   quadLineFit1003->SetParError(0,0.09417847);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,34.79227);
   quadLineFit1003->SetParError(1,1.570925);
   ...
   Graph_30_ppm1003->SetMinimum(75.54181);
   Graph_30_ppm1003->SetMaximum(76.39461);
   ...
   quadLineFit1004->SetChisquare(15.77392);
   ...
   quadLineFit1004->SetParameter(0,74.09735);
   quadLineFit1004->SetParError(0,0.08046547);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,30.85522);
   quadLineFit1004->SetParError(1,1.313214);
   ...
   quadLineFit1005->SetChisquare(15.77392);
   ...
   quadLineFit1005->SetParameter(0,74.09735);
   quadLineFit1005->SetParError(0,0.08046547);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,30.85522);
   quadLineFit1005->SetParError(1,1.313214);
   ...
   Graph_10_ppm1005->SetMinimum(74.47398);
   Graph_10_ppm1005->SetMaximum(74.81369);
   ...
   quadLineFit1006->SetChisquare(0.3038667);
   ...
   quadLineFit1006->SetParameter(0,73.91778);
   quadLineFit1006->SetParError(0,0.09641203);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,11.72076);
   quadLineFit1006->SetParError(1,1.556212);
   ...
   quadLineFit1007->SetChisquare(0.3038667);
   ...
   quadLineFit1007->SetParameter(0,73.91778);
   quadLineFit1007->SetParError(0,0.09641203);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,11.72076);
   quadLineFit1007->SetParError(1,1.556212);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.07346);
   Graph_mI10_ppm1007->SetMaximum(73.49517);
   ...
   quadLineFit1008->SetChisquare(7.125721);
   ...
   quadLineFit1008->SetParameter(0,74.33093);
   quadLineFit1008->SetParError(0,0.08334035);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-16.62277);
   quadLineFit1008->SetParError(1,1.348962);
   ...
   quadLineFit1009->SetChisquare(7.125721);
   ...
   quadLineFit1009->SetParameter(0,74.33093);
   quadLineFit1009->SetParError(0,0.08334035);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-16.62277);
   quadLineFit1009->SetParError(1,1.348962);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.02257);
   Graph_mI30_ppm1009->SetMaximum(72.67483);
   ...
   quadLineFit1010->SetChisquare(23.89613);
   ...
   quadLineFit1010->SetParameter(0,73.79737);
   quadLineFit1010->SetParError(0,0.07582525);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.10673);
   quadLineFit1010->SetParError(1,1.306577);
   ...
   quadLineFit1011->SetChisquare(23.89613);
   ...
   quadLineFit1011->SetParameter(0,73.79737);
   quadLineFit1011->SetParError(0,0.07582525);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.10673);
   quadLineFit1011->SetParError(1,1.306577);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.5959);
   Graph_mI50_ppm1011->SetMaximum(71.96337);
   ...
   quadLineFit1012->SetChisquare(19.43266);
   ...
   quadLineFit1012->SetParameter(0,73.04477);
   quadLineFit1012->SetParError(0,0.1508178);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-22.92907);
   quadLineFit1012->SetParError(1,2.694735);
   ...
   quadLineFit1013->SetChisquare(19.43266);
   ...
   quadLineFit1013->SetParameter(0,73.04477);
   quadLineFit1013->SetParError(0,0.1508178);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-22.92907);
   quadLineFit1013->SetParError(1,2.694735);
