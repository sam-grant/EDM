...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-40.07187,50,46.6165);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-31.40303);
   Graph_Graph01025->SetMaximum(37.94766);
   ...
   mainFit1026->SetChisquare(105.8906);
   ...
   mainFit1026->SetParameter(0,1.768592);
   mainFit1026->SetParError(0,0.6714412);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8427423);
   mainFit1026->SetParError(1,0.02618695);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 35.3");
   pt_LaTex = pt->AddText("0.843#pm0.0262");
   pt_LaTex = pt->AddText(" 1.77#pm0.671");
   pt_LaTex = pt->AddText("  2.1#pm 0.79");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-2.098615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.098615,-31.40303,-2.098615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(105.8906);
   ...
   mainFit1027->SetParameter(0,1.768592);
   mainFit1027->SetParError(0,0.6714412);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8427423);
   mainFit1027->SetParError(1,0.02618695);
