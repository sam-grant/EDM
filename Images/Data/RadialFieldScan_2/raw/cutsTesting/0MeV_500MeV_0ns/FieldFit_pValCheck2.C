...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-41.12056,75,51.85995);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-31.82251);
   Graph_Graph01029->SetMaximum(42.5619);
   ...
   mainFit1030->SetChisquare(117.5625);
   ...
   mainFit1030->SetParameter(0,0.1011992);
   mainFit1030->SetParError(0,0.6690488);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7703834);
   mainFit1030->SetParError(1,0.02026486);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 39.2");
   pt_LaTex = pt->AddText(" 0.77#pm0.0203");
   pt_LaTex = pt->AddText("0.101#pm0.669");
   pt_LaTex = pt->AddText("0.131#pm0.869");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1313621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1313621,-31.82251,-0.1313621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(117.5625);
   ...
   mainFit1031->SetParameter(0,0.1011992);
   mainFit1031->SetParError(0,0.6690488);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7703834);
   mainFit1031->SetParError(1,0.02026486);
