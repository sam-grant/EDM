...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-31.82251);
   Graph_Graph01023->SetMaximum(42.5619);
   ...
   mainFit1024->SetChisquare(122.8818);
   ...
   mainFit1024->SetParameter(0,0.690245);
   mainFit1024->SetParError(0,0.6183817);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7740605);
   mainFit1024->SetParError(1,0.02020209);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 30.7");
   pt_LaTex = pt->AddText("0.774#pm0.0202");
   pt_LaTex = pt->AddText(" 0.69#pm0.618");
   pt_LaTex = pt->AddText("0.892#pm0.803");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8917197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8917197,-31.82251,-0.8917197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(122.8818);
   ...
   mainFit1025->SetParameter(0,0.690245);
   mainFit1025->SetParError(0,0.6183817);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7740605);
   mainFit1025->SetParError(1,0.02020209);
