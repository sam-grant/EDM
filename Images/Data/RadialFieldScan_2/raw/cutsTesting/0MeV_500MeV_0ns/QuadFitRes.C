...
//=========  (Wed Apr 21 23:17:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.06615279);
   Graph_Graph11015->SetMaximum(0.06326321);
   ...
   Graph_Graph21016->SetMinimum(-0.007714578);
   Graph_Graph21016->SetMaximum(0.008586067);
   ...
   Graph_Graph31017->SetMinimum(-0.04895559);
   Graph_Graph31017->SetMaximum(0.03492393);
   ...
   Graph_Graph41018->SetMinimum(-0.06167947);
   Graph_Graph41018->SetMaximum(0.1181497);
   ...
   Graph_Graph51019->SetMinimum(-0.07332077);
   Graph_Graph51019->SetMaximum(0.0549146);
