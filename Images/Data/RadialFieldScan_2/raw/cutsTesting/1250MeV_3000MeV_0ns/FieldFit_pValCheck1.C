...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.10061);
   Graph_Graph01027->SetMaximum(52.45844);
   ...
   mainFit1028->SetChisquare(1.715855);
   ...
   mainFit1028->SetParameter(0,-1.20255);
   mainFit1028->SetParError(0,0.4620272);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8825805);
   mainFit1028->SetParError(1,0.01524278);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.572");
   pt_LaTex = pt->AddText("0.883#pm0.0152");
   pt_LaTex = pt->AddText(" #minus1.2#pm0.462");
   pt_LaTex = pt->AddText("#minus1.36#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.362539,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.362539,-56.10061,1.362539,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.715855);
   ...
   mainFit1029->SetParameter(0,-1.20255);
   mainFit1029->SetParError(0,0.4620272);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8825805);
   mainFit1029->SetParError(1,0.01524278);
