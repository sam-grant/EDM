...
//=========  (Fri Apr 23 18:41:32 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.67049,75,66.02832);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-56.10061);
   Graph_Graph01033->SetMaximum(52.45844);
   ...
   mainFit1034->SetChisquare(0.6225169);
   ...
   mainFit1034->SetParameter(0,-0.9170131);
   mainFit1034->SetParError(0,0.5174192);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8699816);
   mainFit1034->SetParError(1,0.01707241);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.208");
   pt_LaTex = pt->AddText(" 0.87#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.917#pm0.517");
   pt_LaTex = pt->AddText("#minus1.05#pm0.585");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.05406,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.05406,-56.10061,1.05406,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.6225169);
   ...
   mainFit1035->SetParameter(0,-0.9170131);
   mainFit1035->SetParError(0,0.5174192);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8699816);
   mainFit1035->SetParError(1,0.01707241);
