...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01834779);
   Graph_Graph11015->SetMaximum(0.0180099);
   ...
   Graph_Graph21016->SetMinimum(-0.008737653);
   Graph_Graph21016->SetMaximum(0.01024998);
   ...
   Graph_Graph31017->SetMinimum(-0.0271965);
   Graph_Graph31017->SetMaximum(0.02621056);
   ...
   Graph_Graph41018->SetMinimum(-0.003831029);
   Graph_Graph41018->SetMaximum(0.007448795);
   ...
   Graph_Graph51019->SetMinimum(-0.0113566);
   Graph_Graph51019->SetMaximum(0.01513047);
