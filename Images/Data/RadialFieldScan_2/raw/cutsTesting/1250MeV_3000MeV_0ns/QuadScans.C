...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.610003);
   ...
   quadLineFit1002->SetParameter(0,74.72645);
   quadLineFit1002->SetParError(0,0.06296066);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.35633);
   quadLineFit1002->SetParError(1,1.055521);
   ...
   quadLineFit1003->SetChisquare(4.610003);
   ...
   quadLineFit1003->SetParameter(0,74.72645);
   quadLineFit1003->SetParError(0,0.06296066);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.35633);
   quadLineFit1003->SetParError(1,1.055521);
   ...
   Graph_30_ppm1003->SetMinimum(75.87769);
   Graph_30_ppm1003->SetMaximum(76.49839);
   ...
   quadLineFit1004->SetChisquare(2.955552);
   ...
   quadLineFit1004->SetParameter(0,74.64623);
   quadLineFit1004->SetParError(0,0.05298607);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.01538);
   quadLineFit1004->SetParError(1,0.8703411);
   ...
   quadLineFit1005->SetChisquare(2.955552);
   ...
   quadLineFit1005->SetParameter(0,74.64623);
   quadLineFit1005->SetParError(0,0.05298607);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.01538);
   quadLineFit1005->SetParError(1,0.8703411);
   ...
   Graph_10_ppm1005->SetMinimum(74.94475);
   Graph_10_ppm1005->SetMaximum(75.18641);
   ...
   quadLineFit1006->SetChisquare(0.9369603);
   ...
   quadLineFit1006->SetParameter(0,74.54293);
   quadLineFit1006->SetParError(0,0.06197592);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.389135);
   quadLineFit1006->SetParError(1,1.00453);
   ...
   quadLineFit1007->SetChisquare(0.9369603);
   ...
   quadLineFit1007->SetParameter(0,74.54293);
   quadLineFit1007->SetParError(0,0.06197592);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.389135);
   quadLineFit1007->SetParError(1,1.00453);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.81008);
   Graph_mI10_ppm1007->SetMaximum(74.09729);
   ...
   quadLineFit1008->SetChisquare(5.084454);
   ...
   quadLineFit1008->SetParameter(0,74.52778);
   quadLineFit1008->SetParError(0,0.05453271);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.580394);
   quadLineFit1008->SetParError(1,0.8870833);
   ...
   quadLineFit1009->SetChisquare(5.084454);
   ...
   quadLineFit1009->SetParameter(0,74.52778);
   quadLineFit1009->SetParError(0,0.05453271);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.580394);
   quadLineFit1009->SetParError(1,0.8870833);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.47403);
   Graph_mI30_ppm1009->SetMaximum(73.18839);
   ...
   quadLineFit1010->SetChisquare(0.3985453);
   ...
   quadLineFit1010->SetParameter(0,74.57615);
   quadLineFit1010->SetParError(0,0.05150165);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.35959);
   quadLineFit1010->SetParError(1,0.8907019);
   ...
   quadLineFit1011->SetChisquare(0.3985453);
   ...
   quadLineFit1011->SetParameter(0,74.57615);
   quadLineFit1011->SetParError(0,0.05150165);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.35959);
   quadLineFit1011->SetParError(1,0.8907019);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.59753);
   Graph_mI50_ppm1011->SetMaximum(72.24003);
   ...
   quadLineFit1012->SetChisquare(1.795751);
   ...
   quadLineFit1012->SetParameter(0,74.49983);
   quadLineFit1012->SetParError(0,0.1040672);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.19244);
   quadLineFit1012->SetParError(1,1.861579);
   ...
   quadLineFit1013->SetChisquare(1.795751);
   ...
   quadLineFit1013->SetParameter(0,74.49983);
   quadLineFit1013->SetParError(0,0.1040672);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.19244);
   quadLineFit1013->SetParError(1,1.861579);
