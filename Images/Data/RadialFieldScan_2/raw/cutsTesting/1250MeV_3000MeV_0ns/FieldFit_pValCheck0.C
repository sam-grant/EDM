...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.28896,50,44.12066);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.348);
   Graph_Graph01025->SetMaximum(33.17969);
   ...
   mainFit1026->SetChisquare(1.429746);
   ...
   mainFit1026->SetParameter(0,-1.154811);
   mainFit1026->SetParError(0,0.4446376);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8874884);
   mainFit1026->SetParError(1,0.01761256);
   ...
   pt_LaTex = pt->AddText("0.887#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.15#pm0.445");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.301213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.301213,-54.348,1.301213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.429746);
   ...
   mainFit1027->SetParameter(0,-1.154811);
   mainFit1027->SetParError(0,0.4446376);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8874884);
   mainFit1027->SetParError(1,0.01761256);
