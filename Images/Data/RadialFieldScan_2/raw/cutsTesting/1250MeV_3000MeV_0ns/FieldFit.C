...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.10061);
   Graph_Graph01020->SetMaximum(52.45844);
   ...
   mainFit1021->SetChisquare(1.771502);
   ...
   mainFit1021->SetParameter(0,-1.25155);
   mainFit1021->SetParError(0,0.4126977);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8809788);
   mainFit1021->SetParError(1,0.0136459);
   ...
   mainFit1022->SetChisquare(1.771502);
   ...
   mainFit1022->SetParameter(0,-1.25155);
   mainFit1022->SetParError(0,0.4126977);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8809788);
   mainFit1022->SetParError(1,0.0136459);
