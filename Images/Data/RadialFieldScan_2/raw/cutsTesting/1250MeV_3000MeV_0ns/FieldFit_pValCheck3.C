...
//=========  (Fri Apr 23 18:41:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.10061);
   Graph_Graph01031->SetMaximum(52.45844);
   ...
   mainFit1032->SetChisquare(1.37255);
   ...
   mainFit1032->SetParameter(0,-1.400377);
   mainFit1032->SetParError(0,0.4752246);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8832778);
   mainFit1032->SetParError(1,0.01412301);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.458");
   pt_LaTex = pt->AddText("0.883#pm0.0141");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.475");
   pt_LaTex = pt->AddText("#minus1.59#pm0.532");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.585432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.585432,-56.10061,1.585432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.37255);
   ...
   mainFit1033->SetParameter(0,-1.400377);
   mainFit1033->SetParError(0,0.4752246);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8832778);
   mainFit1033->SetParError(1,0.01412301);
