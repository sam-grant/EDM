...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.10061);
   Graph_Graph01023->SetMaximum(52.45844);
   ...
   mainFit1024->SetChisquare(1.771502);
   ...
   mainFit1024->SetParameter(0,-1.25155);
   mainFit1024->SetParError(0,0.4126977);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8809788);
   mainFit1024->SetParError(1,0.0136459);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.443");
   pt_LaTex = pt->AddText("0.881#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.25#pm0.413");
   pt_LaTex = pt->AddText("#minus1.42#pm0.465");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.420636,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.420636,-56.10061,1.420636,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.771502);
   ...
   mainFit1025->SetParameter(0,-1.25155);
   mainFit1025->SetParError(0,0.4126977);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8809788);
   mainFit1025->SetParError(1,0.0136459);
