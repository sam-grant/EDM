...
//=========  (Fri Apr 23 18:41:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.10061);
   Graph_Graph01029->SetMaximum(52.45844);
   ...
   mainFit1030->SetChisquare(0.9479722);
   ...
   mainFit1030->SetParameter(0,-1.411344);
   mainFit1030->SetParError(0,0.4486934);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.880034);
   mainFit1030->SetParError(1,0.01368551);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.316");
   pt_LaTex = pt->AddText(" 0.88#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.41#pm0.449");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.508");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.603738,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.603738,-56.10061,1.603738,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9479722);
   ...
   mainFit1031->SetParameter(0,-1.411344);
   mainFit1031->SetParError(0,0.4486934);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.880034);
   mainFit1031->SetParError(1,0.01368551);
