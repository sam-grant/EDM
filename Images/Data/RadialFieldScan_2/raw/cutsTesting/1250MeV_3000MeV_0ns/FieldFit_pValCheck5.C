...
//=========  (Fri Apr 23 18:41:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.41583,70,61.57739);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.51651);
   Graph_Graph01035->SetMaximum(50.67806);
   ...
   mainFit1036->SetChisquare(1.767239);
   ...
   mainFit1036->SetParameter(0,-1.260063);
   mainFit1036->SetParError(0,0.4328074);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.881382);
   mainFit1036->SetParError(1,0.01497827);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.015");
   pt_LaTex = pt->AddText("#minus1.26#pm0.433");
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.429645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.429645,-36.51651,1.429645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.767239);
   ...
   mainFit1037->SetParameter(0,-1.260063);
   mainFit1037->SetParError(0,0.4328074);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.881382);
   mainFit1037->SetParError(1,0.01497827);
