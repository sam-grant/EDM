...
//=========  (Thu Apr 22 14:28:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.20514,70,65.72088);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.61254);
   Graph_Graph01035->SetMaximum(54.12827);
   ...
   mainFit1036->SetChisquare(0.978616);
   ...
   mainFit1036->SetParameter(0,-1.973696);
   mainFit1036->SetParError(0,0.3465605);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9412559);
   mainFit1036->SetParError(1,0.01198819);
   ...
   pt_LaTex = pt->AddText("#minus1.97#pm0.347");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.362");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.096875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.096875,-38.61254,2.096875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.978616);
   ...
   mainFit1037->SetParameter(0,-1.973696);
   mainFit1037->SetParError(0,0.3465605);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9412559);
   mainFit1037->SetParError(1,0.01198819);
