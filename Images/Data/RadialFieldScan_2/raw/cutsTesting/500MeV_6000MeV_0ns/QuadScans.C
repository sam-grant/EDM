...
//=========  (Thu Apr 22 14:28:26 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.776633);
   ...
   quadLineFit1002->SetParameter(0,74.54971);
   quadLineFit1002->SetParError(0,0.05039007);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.555);
   quadLineFit1002->SetParError(1,0.8448693);
   ...
   quadLineFit1003->SetChisquare(3.776633);
   ...
   quadLineFit1003->SetParameter(0,74.54971);
   quadLineFit1003->SetParError(0,0.05039007);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.555);
   quadLineFit1003->SetParError(1,0.8448693);
   ...
   Graph_30_ppm1003->SetMinimum(75.81775);
   Graph_30_ppm1003->SetMaximum(76.46212);
   ...
   quadLineFit1004->SetChisquare(2.116869);
   ...
   quadLineFit1004->SetParameter(0,74.55554);
   quadLineFit1004->SetParError(0,0.04240761);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.72597);
   quadLineFit1004->SetParError(1,0.696657);
   ...
   quadLineFit1005->SetChisquare(2.116869);
   ...
   quadLineFit1005->SetParameter(0,74.55554);
   quadLineFit1005->SetParError(0,0.04240761);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.72597);
   quadLineFit1005->SetParError(1,0.696657);
   ...
   Graph_10_ppm1005->SetMinimum(74.84358);
   Graph_10_ppm1005->SetMaximum(75.06513);
   ...
   quadLineFit1006->SetChisquare(6.631434);
   ...
   quadLineFit1006->SetParError(0,0.04973933);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.658468);
   quadLineFit1006->SetParError(1,0.8063314);
   ...
   quadLineFit1007->SetChisquare(6.631434);
   ...
   quadLineFit1007->SetParError(0,0.04973933);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.658468);
   quadLineFit1007->SetParError(1,0.8063314);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.58823);
   Graph_mI10_ppm1007->SetMaximum(73.9095);
   ...
   quadLineFit1008->SetChisquare(6.761851);
   ...
   quadLineFit1008->SetParameter(0,74.43923);
   quadLineFit1008->SetParError(0,0.04364437);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.36646);
   quadLineFit1008->SetParError(1,0.7100679);
   ...
   quadLineFit1009->SetChisquare(6.761851);
   ...
   quadLineFit1009->SetParameter(0,74.43923);
   quadLineFit1009->SetParError(0,0.04364437);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.36646);
   quadLineFit1009->SetParError(1,0.7100679);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.17984);
   Graph_mI30_ppm1009->SetMaximum(72.93623);
   ...
   quadLineFit1010->SetChisquare(0.848166);
   ...
   quadLineFit1010->SetParameter(0,74.41606);
   quadLineFit1010->SetParError(0,0.04120913);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.17133);
   quadLineFit1010->SetParError(1,0.7128017);
   ...
   quadLineFit1011->SetChisquare(0.848166);
   ...
   quadLineFit1011->SetParameter(0,74.41606);
   quadLineFit1011->SetParError(0,0.04120913);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.17133);
   quadLineFit1011->SetParError(1,0.7128017);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.26128);
   Graph_mI50_ppm1011->SetMaximum(71.9445);
   ...
   quadLineFit1012->SetChisquare(0.3910713);
   ...
   quadLineFit1012->SetParameter(0,74.37711);
   quadLineFit1012->SetParError(0,0.08328241);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.68785);
   quadLineFit1012->SetParError(1,1.489876);
   ...
   quadLineFit1013->SetChisquare(0.3910713);
   ...
   quadLineFit1013->SetParameter(0,74.37711);
   quadLineFit1013->SetParError(0,0.08328241);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.68785);
   quadLineFit1013->SetParError(1,1.489876);
