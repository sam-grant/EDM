...
//=========  (Thu Apr 22 14:28:27 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.32781,50,45.57271);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.83776);
   Graph_Graph01025->SetMaximum(34.08266);
   ...
   mainFit1026->SetChisquare(0.3481289);
   ...
   mainFit1026->SetParameter(0,-2.060903);
   mainFit1026->SetParError(0,0.3561064);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9329098);
   mainFit1026->SetParError(1,0.01409868);
   ...
   pt_LaTex = pt->AddText("#minus2.06#pm0.356");
   pt_LaTex = pt->AddText("#minus2.21#pm0.387");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.209112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.209112,-57.83776,2.209112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.3481289);
   ...
   mainFit1027->SetParameter(0,-2.060903);
   mainFit1027->SetParError(0,0.3561064);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9329098);
   mainFit1027->SetParError(1,0.01409868);
