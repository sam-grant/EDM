...
//=========  (Thu Apr 22 14:28:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.83548);
   Graph_Graph01031->SetMaximum(56.05763);
   ...
   mainFit1032->SetChisquare(1.021489);
   ...
   mainFit1032->SetParameter(0,-1.948198);
   mainFit1032->SetParError(0,0.3805499);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9401694);
   mainFit1032->SetParError(1,0.01130336);
   ...
   pt_LaTex = pt->AddText(" 0.94#pm0.0113");
   pt_LaTex = pt->AddText("#minus1.95#pm0.381");
   pt_LaTex = pt->AddText("#minus2.07#pm0.399");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.072177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.072177,-59.83548,2.072177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.021489);
   ...
   mainFit1033->SetParameter(0,-1.948198);
   mainFit1033->SetParError(0,0.3805499);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9401694);
   mainFit1033->SetParError(1,0.01130336);
