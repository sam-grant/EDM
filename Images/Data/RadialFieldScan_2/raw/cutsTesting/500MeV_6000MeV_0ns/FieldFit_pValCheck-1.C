...
//=========  (Thu Apr 22 14:28:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.83548);
   Graph_Graph01023->SetMaximum(56.05763);
   ...
   mainFit1024->SetChisquare(1.021891);
   ...
   mainFit1024->SetParameter(0,-1.951955);
   mainFit1024->SetParError(0,0.330457);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.940221);
   mainFit1024->SetParError(1,0.01092193);
   ...
   mainFit1025->SetChisquare(1.021891);
   ...
   mainFit1025->SetParameter(0,-1.951955);
   mainFit1025->SetParError(0,0.330457);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.940221);
   mainFit1025->SetParError(1,0.01092193);
