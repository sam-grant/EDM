...
//=========  (Thu Apr 22 14:28:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01858125);
   Graph_Graph11015->SetMaximum(0.01078149);
   ...
   Graph_Graph21016->SetMinimum(-0.01860911);
   Graph_Graph21016->SetMaximum(0.02184754);
   ...
   Graph_Graph31017->SetMinimum(-0.02462707);
   Graph_Graph31017->SetMaximum(0.0178486);
   ...
   Graph_Graph41018->SetMinimum(-0.006376509);
   Graph_Graph41018->SetMaximum(0.007496775);
   ...
   Graph_Graph51019->SetMinimum(-0.004234098);
   Graph_Graph51019->SetMaximum(0.005641387);
