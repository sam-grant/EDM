...
//=========  (Thu Apr 22 14:28:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.83548);
   Graph_Graph01027->SetMaximum(56.05763);
   ...
   mainFit1028->SetChisquare(0.1007465);
   ...
   mainFit1028->SetParameter(0,-1.792176);
   mainFit1028->SetParError(0,0.3700348);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9454466);
   mainFit1028->SetParError(1,0.01220116);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0336");
   pt_LaTex = pt->AddText("0.945#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.79#pm 0.37");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.394");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.895586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.895586,-59.83548,1.895586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1007465);
   ...
   mainFit1029->SetParameter(0,-1.792176);
   mainFit1029->SetParError(0,0.3700348);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9454466);
   mainFit1029->SetParError(1,0.01220116);
