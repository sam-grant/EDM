...
//=========  (Thu Apr 22 14:28:27 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.83548);
   Graph_Graph01029->SetMaximum(56.05763);
   ...
   mainFit1030->SetChisquare(0.9417421);
   ...
   mainFit1030->SetParameter(0,-1.991781);
   mainFit1030->SetParError(0,0.3591254);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9399921);
   mainFit1030->SetParError(1,0.01095352);
   ...
   pt_LaTex = pt->AddText("#minus1.99#pm0.359");
   pt_LaTex = pt->AddText("#minus2.12#pm 0.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.118934,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.118934,-59.83548,2.118934,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9417421);
   ...
   mainFit1031->SetParameter(0,-1.991781);
   mainFit1031->SetParError(0,0.3591254);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9399921);
   mainFit1031->SetParError(1,0.01095352);
