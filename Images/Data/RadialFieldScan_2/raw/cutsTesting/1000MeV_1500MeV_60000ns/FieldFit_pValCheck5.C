...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-56.49034,70,80.75545);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-42.76576);
   Graph_Graph01035->SetMaximum(67.03087);
   ...
   mainFit1036->SetChisquare(5.848868);
   ...
   mainFit1036->SetParameter(0,-1.521193);
   mainFit1036->SetParError(0,1.317697);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.024208);
   mainFit1036->SetParError(1,0.04550445);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0455");
   pt_LaTex = pt->AddText("#minus1.52#pm 1.32");
   pt_LaTex = pt->AddText("#minus1.49#pm 1.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.485237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.485237,-42.76576,1.485237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.848868);
   ...
   mainFit1037->SetParameter(0,-1.521193);
   mainFit1037->SetParError(0,1.317697);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.024208);
   mainFit1037->SetParError(1,0.04550445);
