...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-72.41946);
   Graph_Graph01033->SetMaximum(69.72666);
   ...
   mainFit1034->SetChisquare(5.213775);
   ...
   mainFit1034->SetParameter(0,-2.483052);
   mainFit1034->SetParError(0,1.574015);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.057694);
   mainFit1034->SetParError(1,0.05179864);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0518");
   pt_LaTex = pt->AddText("#minus2.48#pm 1.57");
   pt_LaTex = pt->AddText("#minus2.35#pm 1.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.347608,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.347608,-72.41946,2.347608,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.213775);
   ...
   mainFit1035->SetParameter(0,-2.483052);
   mainFit1035->SetParError(0,1.574015);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.057694);
   mainFit1035->SetParError(1,0.05179864);
