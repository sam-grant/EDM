...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-72.41946);
   Graph_Graph01020->SetMaximum(69.72666);
   ...
   mainFit1021->SetChisquare(5.968071);
   ...
   mainFit1021->SetParameter(0,-1.658886);
   mainFit1021->SetParError(0,1.255843);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.030686);
   mainFit1021->SetParError(1,0.04143762);
   ...
   mainFit1022->SetChisquare(5.968071);
   ...
   mainFit1022->SetParameter(0,-1.658886);
   mainFit1022->SetParError(0,1.255843);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.030686);
   mainFit1022->SetParError(1,0.04143762);
