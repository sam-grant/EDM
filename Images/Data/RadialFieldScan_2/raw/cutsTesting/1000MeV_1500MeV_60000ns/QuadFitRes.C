...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02683715);
   Graph_Graph11015->SetMaximum(0.0833535);
   ...
   Graph_Graph21016->SetMinimum(-0.01538197);
   Graph_Graph21016->SetMaximum(0.01820285);
   ...
   Graph_Graph31017->SetMinimum(-0.0320998);
   Graph_Graph31017->SetMaximum(0.02886687);
   ...
   Graph_Graph41018->SetMinimum(-0.03890414);
   Graph_Graph41018->SetMaximum(0.05105725);
   ...
   Graph_Graph51019->SetMinimum(-0.02362585);
   Graph_Graph51019->SetMaximum(0.03173426);
