...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-82.51146,50,49.11361);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-69.34895);
   Graph_Graph01025->SetMaximum(35.95111);
   ...
   mainFit1026->SetChisquare(1.490809);
   ...
   mainFit1026->SetParameter(0,-2.731064);
   mainFit1026->SetParError(0,1.354205);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9587296);
   mainFit1026->SetParError(1,0.05360962);
   ...
   pt_LaTex = pt->AddText("0.959#pm0.0536");
   pt_LaTex = pt->AddText("#minus2.73#pm 1.35");
   pt_LaTex = pt->AddText("#minus2.85#pm 1.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.848628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.848628,-69.34895,2.848628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.490809);
   ...
   mainFit1027->SetParameter(0,-2.731064);
   mainFit1027->SetParError(0,1.354205);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9587296);
   mainFit1027->SetParError(1,0.05360962);
