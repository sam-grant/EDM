...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-72.41946);
   Graph_Graph01029->SetMaximum(69.72666);
   ...
   mainFit1030->SetChisquare(5.939323);
   ...
   mainFit1030->SetParameter(0,-1.749542);
   mainFit1030->SetParError(0,1.364798);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.030173);
   mainFit1030->SetParError(1,0.04155392);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0416");
   pt_LaTex = pt->AddText("#minus1.75#pm 1.36");
   pt_LaTex = pt->AddText(" #minus1.7#pm 1.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.698299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.698299,-72.41946,1.698299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.939323);
   ...
   mainFit1031->SetParameter(0,-1.749542);
   mainFit1031->SetParError(0,1.364798);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.030173);
   mainFit1031->SetParError(1,0.04155392);
