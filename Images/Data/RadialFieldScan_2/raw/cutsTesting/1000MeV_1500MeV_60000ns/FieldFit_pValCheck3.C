...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-72.41946);
   Graph_Graph01031->SetMaximum(69.72666);
   ...
   mainFit1032->SetChisquare(5.96315);
   ...
   mainFit1032->SetParameter(0,-1.608624);
   mainFit1032->SetParError(0,1.446251);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.029924);
   mainFit1032->SetParError(1,0.04289244);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0429");
   pt_LaTex = pt->AddText("#minus1.61#pm 1.45");
   pt_LaTex = pt->AddText("#minus1.56#pm 1.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.561887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.561887,-72.41946,1.561887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.96315);
   ...
   mainFit1033->SetParameter(0,-1.608624);
   mainFit1033->SetParError(0,1.446251);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.029924);
   mainFit1033->SetParError(1,0.04289244);
