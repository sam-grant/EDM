...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-90.18773,75,87.49493);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-72.41946);
   Graph_Graph01027->SetMaximum(69.72666);
   ...
   mainFit1028->SetChisquare(0.887742);
   ...
   mainFit1028->SetParameter(0,-0.2409726);
   mainFit1028->SetParError(0,1.404604);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.07683);
   mainFit1028->SetParError(1,0.04621625);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.296");
   pt_LaTex = pt->AddText(" 1.08#pm0.0462");
   pt_LaTex = pt->AddText("#minus0.241#pm  1.4");
   pt_LaTex = pt->AddText("#minus0.224#pm 1.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2237795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2237795,-72.41946,0.2237795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.887742);
   ...
   mainFit1029->SetParameter(0,-0.2409726);
   mainFit1029->SetParError(0,1.404604);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.07683);
   mainFit1029->SetParError(1,0.04621625);
