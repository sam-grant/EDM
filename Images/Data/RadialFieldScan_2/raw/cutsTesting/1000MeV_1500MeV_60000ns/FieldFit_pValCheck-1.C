...
//=========  (Thu Apr 22 01:07:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-72.41946);
   Graph_Graph01023->SetMaximum(69.72666);
   ...
   mainFit1024->SetChisquare(5.968071);
   ...
   mainFit1024->SetParameter(0,-1.658886);
   mainFit1024->SetParError(0,1.255843);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.030686);
   mainFit1024->SetParError(1,0.04143762);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0414");
   pt_LaTex = pt->AddText("#minus1.66#pm 1.26");
   pt_LaTex = pt->AddText("#minus1.61#pm 1.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.609497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.609497,-72.41946,1.609497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.968071);
   ...
   mainFit1025->SetParameter(0,-1.658886);
   mainFit1025->SetParError(0,1.255843);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.030686);
   mainFit1025->SetParError(1,0.04143762);
