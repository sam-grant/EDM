...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.88466);
   Graph_Graph01029->SetMaximum(49.25201);
   ...
   mainFit1030->SetChisquare(1.747004);
   ...
   mainFit1030->SetParameter(0,-0.2812253);
   mainFit1030->SetParError(0,0.6219386);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7720896);
   mainFit1030->SetParError(1,0.01897094);
   ...
   pt_LaTex = pt->AddText("0.772#pm0.019");
   pt_LaTex = pt->AddText("#minus0.281#pm0.622");
   pt_LaTex = pt->AddText("#minus0.364#pm0.805");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3642393,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3642393,-49.88466,0.3642393,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.747004);
   ...
   mainFit1031->SetParameter(0,-0.2812253);
   mainFit1031->SetParError(0,0.6219386);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7720896);
   mainFit1031->SetParError(1,0.01897094);
