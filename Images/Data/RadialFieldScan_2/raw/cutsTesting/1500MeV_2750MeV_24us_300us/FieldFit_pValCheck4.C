...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.88466);
   Graph_Graph01033->SetMaximum(49.25201);
   ...
   mainFit1034->SetChisquare(2.079647);
   ...
   mainFit1034->SetParameter(0,-0.1468123);
   mainFit1034->SetParError(0,0.7169765);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7731248);
   mainFit1034->SetParError(1,0.0236521);
   ...
   pt_LaTex = pt->AddText("#minus0.147#pm0.717");
   pt_LaTex = pt->AddText("#minus0.19#pm0.925");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1898947,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1898947,-49.88466,0.1898947,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.079647);
   ...
   mainFit1035->SetParameter(0,-0.1468123);
   mainFit1035->SetParError(0,0.7169765);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7731248);
   mainFit1035->SetParError(1,0.0236521);
