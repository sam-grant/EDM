...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.88466);
   Graph_Graph01020->SetMaximum(49.25201);
   ...
   mainFit1021->SetChisquare(2.079853);
   ...
   mainFit1021->SetParameter(0,-0.1406176);
   mainFit1021->SetParError(0,0.5721898);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7729212);
   mainFit1021->SetParError(1,0.01891643);
   ...
   pt_LaTex = pt->AddText("0.773#pm0.0189");
   pt_LaTex = pt->AddText("#minus0.141#pm0.572");
   pt_LaTex = pt->AddText("#minus0.182#pm 0.74");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.18193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.18193,-49.88466,0.18193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.079853);
   ...
   mainFit1022->SetParameter(0,-0.1406176);
   mainFit1022->SetParError(0,0.5721898);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7729212);
   mainFit1022->SetParError(1,0.01891643);
