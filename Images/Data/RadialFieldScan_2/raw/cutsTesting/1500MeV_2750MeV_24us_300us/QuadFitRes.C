...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01499659);
   Graph_Graph11015->SetMaximum(0.03091145);
   ...
   Graph_Graph21016->SetMinimum(-3.990057e-05);
   Graph_Graph21016->SetMaximum(3.389961e-05);
   ...
   Graph_Graph31017->SetMinimum(-0.04620204);
   Graph_Graph31017->SetMaximum(0.03860027);
   ...
   Graph_Graph41018->SetMinimum(-0.001757113);
   Graph_Graph41018->SetMaximum(0.001626964);
   ...
   Graph_Graph51019->SetMinimum(-0.004952842);
   Graph_Graph51019->SetMaximum(0.006622948);
