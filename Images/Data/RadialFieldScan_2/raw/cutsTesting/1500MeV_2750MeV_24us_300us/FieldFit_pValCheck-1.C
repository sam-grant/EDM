...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.88466);
   Graph_Graph01023->SetMaximum(49.25201);
   ...
   mainFit1024->SetChisquare(2.079853);
   ...
   mainFit1024->SetParameter(0,-0.1406176);
   mainFit1024->SetParError(0,0.5721898);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7729212);
   mainFit1024->SetParError(1,0.01891643);
   ...
   mainFit1025->SetChisquare(2.079853);
   ...
   mainFit1025->SetParameter(0,-0.1406176);
   mainFit1025->SetParError(0,0.5721898);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7729212);
   mainFit1025->SetParError(1,0.01891643);
