...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.93731,70,57.37621);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.10595);
   Graph_Graph01035->SetMaximum(47.54486);
   ...
   mainFit1036->SetChisquare(2.067139);
   ...
   mainFit1036->SetParameter(0,-0.1201977);
   mainFit1036->SetParError(0,0.6001651);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7719546);
   mainFit1036->SetParError(1,0.02076827);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.689");
   pt_LaTex = pt->AddText("0.772#pm0.0208");
   pt_LaTex = pt->AddText("#minus0.12#pm  0.6");
   pt_LaTex = pt->AddText("#minus0.156#pm0.776");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1557057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1557057,-31.10595,0.1557057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.067139);
   ...
   mainFit1037->SetParameter(0,-0.1201977);
   mainFit1037->SetParError(0,0.6001651);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7719546);
   mainFit1037->SetParError(1,0.02076827);
