...
//=========  (Wed Apr 28 14:52:07 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.197625);
   ...
   quadLineFit1002->SetParameter(0,74.82918);
   quadLineFit1002->SetParError(0,0.08721959);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.52769);
   quadLineFit1002->SetParError(1,1.462938);
   ...
   quadLineFit1003->SetChisquare(1.197625);
   ...
   quadLineFit1003->SetParameter(0,74.82918);
   quadLineFit1003->SetParError(0,0.08721959);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.52769);
   quadLineFit1003->SetParError(1,1.462938);
   ...
   Graph_30_ppm1003->SetMinimum(75.8801);
   Graph_30_ppm1003->SetMaximum(76.43768);
   ...
   quadLineFit1004->SetChisquare(1.7573);
   ...
   quadLineFit1004->SetParameter(0,74.82983);
   quadLineFit1004->SetParError(0,0.07337712);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.68013);
   quadLineFit1004->SetParError(1,1.206005);
   ...
   quadLineFit1005->SetChisquare(1.7573);
   ...
   quadLineFit1005->SetParameter(0,74.82983);
   quadLineFit1005->SetParError(0,0.07337712);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.68013);
   quadLineFit1005->SetParError(1,1.206005);
   ...
   Graph_10_ppm1005->SetMinimum(74.96443);
   Graph_10_ppm1005->SetMaximum(75.21389);
   ...
   quadLineFit1006->SetChisquare(7.341167e-06);
   ...
   quadLineFit1006->SetParameter(0,74.57725);
   quadLineFit1006->SetParError(0,0.0859895);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.322118);
   quadLineFit1006->SetParError(1,1.394518);
   ...
   quadLineFit1007->SetChisquare(7.341167e-06);
   ...
   quadLineFit1007->SetParameter(0,74.57725);
   quadLineFit1007->SetParError(0,0.0859895);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.322118);
   quadLineFit1007->SetParError(1,1.394518);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.90451);
   Graph_mI10_ppm1007->SetMaximum(74.17293);
   ...
   quadLineFit1008->SetChisquare(8.693042);
   ...
   quadLineFit1008->SetParameter(0,74.50197);
   quadLineFit1008->SetParError(0,0.07548743);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.695373);
   quadLineFit1008->SetParError(1,1.228592);
   ...
   quadLineFit1009->SetChisquare(8.693042);
   ...
   quadLineFit1009->SetParameter(0,74.50197);
   quadLineFit1009->SetParError(0,0.07548743);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.695373);
   quadLineFit1009->SetParError(1,1.228592);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.67714);
   Graph_mI30_ppm1009->SetMaximum(73.28322);
   ...
   quadLineFit1010->SetChisquare(0.01181477);
   ...
   quadLineFit1010->SetParameter(0,74.41511);
   quadLineFit1010->SetParError(0,0.07142194);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.31565);
   quadLineFit1010->SetParError(1,1.236075);
   ...
   quadLineFit1011->SetChisquare(0.01181477);
   ...
   quadLineFit1011->SetParameter(0,74.41511);
   quadLineFit1011->SetParError(0,0.07142194);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.31565);
   quadLineFit1011->SetParError(1,1.236075);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.81981);
   Graph_mI50_ppm1011->SetMaximum(72.39382);
   ...
   quadLineFit1012->SetChisquare(0.1797292);
   ...
   quadLineFit1012->SetParameter(0,74.33384);
   quadLineFit1012->SetParError(0,0.1440925);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.04504);
   quadLineFit1012->SetParError(1,2.578236);
   ...
   quadLineFit1013->SetChisquare(0.1797292);
   ...
   quadLineFit1013->SetParameter(0,74.33384);
   quadLineFit1013->SetParError(0,0.1440925);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.04504);
   quadLineFit1013->SetParError(1,2.578236);
