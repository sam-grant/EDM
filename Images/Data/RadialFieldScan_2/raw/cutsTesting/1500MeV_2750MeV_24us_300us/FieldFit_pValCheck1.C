...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.88466);
   Graph_Graph01027->SetMaximum(49.25201);
   ...
   mainFit1028->SetChisquare(0.02683801);
   ...
   mainFit1028->SetParameter(0,0.2722218);
   mainFit1028->SetParError(0,0.6406394);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7864145);
   mainFit1028->SetParError(1,0.02113091);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.00895");
   pt_LaTex = pt->AddText("0.786#pm0.0211");
   pt_LaTex = pt->AddText("0.272#pm0.641");
   pt_LaTex = pt->AddText("0.346#pm0.814");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3461556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3461556,-49.88466,-0.3461556,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.02683801);
   ...
   mainFit1029->SetParameter(0,0.2722218);
   mainFit1029->SetParError(0,0.6406394);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7864145);
   mainFit1029->SetParError(1,0.02113091);
