...
//=========  (Wed Apr 28 14:52:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-62.27675,75,61.6441);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-49.88466);
   Graph_Graph01031->SetMaximum(49.25201);
   ...
   mainFit1032->SetChisquare(2.052464);
   ...
   mainFit1032->SetParameter(0,-0.1947668);
   mainFit1032->SetParError(0,0.6591341);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7737579);
   mainFit1032->SetParError(1,0.01958038);
   ...
   pt_LaTex = pt->AddText("0.774#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.195#pm0.659");
   pt_LaTex = pt->AddText("#minus0.252#pm 0.85");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2517154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2517154,-49.88466,0.2517154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.052464);
   ...
   mainFit1033->SetParameter(0,-0.1947668);
   mainFit1033->SetParError(0,0.6591341);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7737579);
   mainFit1033->SetParError(1,0.01958038);
