...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006774486);
   Graph_Graph11015->SetMaximum(0.01261057);
   ...
   Graph_Graph21016->SetMinimum(-0.007207493);
   Graph_Graph21016->SetMaximum(0.008466342);
   ...
   Graph_Graph31017->SetMinimum(-0.01851681);
   Graph_Graph31017->SetMaximum(0.01475576);
   ...
   Graph_Graph41018->SetMinimum(-0.003999157);
   Graph_Graph41018->SetMaximum(0.007483583);
   ...
   Graph_Graph51019->SetMinimum(-0.0020231);
   Graph_Graph51019->SetMaximum(0.002703304);
