...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.89417,70,65.29848);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.47491);
   Graph_Graph01035->SetMaximum(53.87921);
   ...
   mainFit1036->SetChisquare(4.258604);
   ...
   mainFit1036->SetParameter(0,-1.88684);
   mainFit1036->SetParError(0,0.4065308);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9216608);
   mainFit1036->SetParError(1,0.01408193);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.89#pm0.407");
   pt_LaTex = pt->AddText("#minus2.05#pm0.434");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.047217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.047217,-37.47491,2.047217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.258604);
   ...
   mainFit1037->SetParameter(0,-1.88684);
   mainFit1037->SetParError(0,0.4065308);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9216608);
   mainFit1037->SetParError(1,0.01408193);
