...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.76262);
   Graph_Graph01020->SetMaximum(55.90537);
   ...
   mainFit1021->SetChisquare(4.301332);
   ...
   mainFit1021->SetParameter(0,-1.91211);
   mainFit1021->SetParError(0,0.3876842);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9228556);
   mainFit1021->SetParError(1,0.01282793);
   ...
   mainFit1022->SetChisquare(4.301332);
   ...
   mainFit1022->SetParameter(0,-1.91211);
   mainFit1022->SetParError(0,0.3876842);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9228556);
   mainFit1022->SetParError(1,0.01282793);
