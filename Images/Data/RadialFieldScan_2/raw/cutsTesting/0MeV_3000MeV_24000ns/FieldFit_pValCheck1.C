...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.76262);
   Graph_Graph01027->SetMaximum(55.90537);
   ...
   mainFit1028->SetChisquare(1.465281);
   ...
   mainFit1028->SetParameter(0,-1.582833);
   mainFit1028->SetParError(0,0.4342059);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9336464);
   mainFit1028->SetParError(1,0.0143379);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.58#pm0.434");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.468");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.695324,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.695324,-59.76262,1.695324,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.465281);
   ...
   mainFit1029->SetParameter(0,-1.582833);
   mainFit1029->SetParError(0,0.4342059);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9336464);
   mainFit1029->SetParError(1,0.0143379);
