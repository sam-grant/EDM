...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-57.68623);
   Graph_Graph01025->SetMaximum(33.06509);
   ...
   mainFit1026->SetChisquare(2.157274);
   ...
   mainFit1026->SetParameter(0,-2.139798);
   mainFit1026->SetParError(0,0.4177011);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9075574);
   mainFit1026->SetParError(1,0.01654678);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.719");
   pt_LaTex = pt->AddText("0.908#pm0.0165");
   pt_LaTex = pt->AddText("#minus2.14#pm0.418");
   pt_LaTex = pt->AddText("#minus2.36#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.357755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.357755,-57.68623,2.357755,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.157274);
   ...
   mainFit1027->SetParameter(0,-2.139798);
   mainFit1027->SetParError(0,0.4177011);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9075574);
   mainFit1027->SetParError(1,0.01654678);
