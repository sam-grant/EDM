...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-74.22112,75,70.36387);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-59.76262);
   Graph_Graph01031->SetMaximum(55.90537);
   ...
   mainFit1032->SetChisquare(3.637476);
   ...
   mainFit1032->SetParameter(0,-1.731423);
   mainFit1032->SetParError(0,0.4466413);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9200753);
   mainFit1032->SetParError(1,0.01327592);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.73#pm0.447");
   pt_LaTex = pt->AddText("#minus1.88#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.881828,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.881828,-59.76262,1.881828,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.637476);
   ...
   mainFit1033->SetParameter(0,-1.731423);
   mainFit1033->SetParError(0,0.4466413);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9200753);
   mainFit1033->SetParError(1,0.01327592);
