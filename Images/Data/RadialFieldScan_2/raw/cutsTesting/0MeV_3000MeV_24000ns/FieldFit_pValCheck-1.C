...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.76262);
   Graph_Graph01023->SetMaximum(55.90537);
   ...
   mainFit1024->SetChisquare(4.301332);
   ...
   mainFit1024->SetParameter(0,-1.91211);
   mainFit1024->SetParError(0,0.3876842);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9228556);
   mainFit1024->SetParError(1,0.01282793);
   ...
   pt_LaTex = pt->AddText("#minus1.91#pm0.388");
   pt_LaTex = pt->AddText("#minus2.07#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.071949,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.071949,-59.76262,2.071949,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.301332);
   ...
   mainFit1025->SetParameter(0,-1.91211);
   mainFit1025->SetParError(0,0.3876842);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9228556);
   mainFit1025->SetParError(1,0.01282793);
