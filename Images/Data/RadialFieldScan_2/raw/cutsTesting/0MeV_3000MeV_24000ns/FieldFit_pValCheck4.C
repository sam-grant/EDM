...
//=========  (Fri Apr 23 18:48:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.76262);
   Graph_Graph01033->SetMaximum(55.90537);
   ...
   mainFit1034->SetChisquare(3.375186);
   ...
   mainFit1034->SetParameter(0,-2.193735);
   mainFit1034->SetParError(0,0.485721);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9321299);
   mainFit1034->SetParError(1,0.01604082);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.016");
   pt_LaTex = pt->AddText("#minus2.19#pm0.486");
   pt_LaTex = pt->AddText("#minus2.35#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.353465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.353465,-59.76262,2.353465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.375186);
   ...
   mainFit1035->SetParameter(0,-2.193735);
   mainFit1035->SetParError(0,0.485721);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9321299);
   mainFit1035->SetParError(1,0.01604082);
