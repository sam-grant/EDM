...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.24738,50,41.96569);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.62608);
   Graph_Graph01025->SetMaximum(31.34438);
   ...
   mainFit1026->SetChisquare(1.652545);
   ...
   mainFit1026->SetParameter(0,-1.579583);
   mainFit1026->SetParError(0,0.4467928);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8520281);
   mainFit1026->SetParError(1,0.017688);
   ...
   pt_LaTex = pt->AddText("#minus1.58#pm0.447");
   pt_LaTex = pt->AddText("#minus1.85#pm 0.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.853909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.853909,-53.62608,1.853909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.652545);
   ...
   mainFit1027->SetParameter(0,-1.579583);
   mainFit1027->SetParError(0,0.4467928);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8520281);
   mainFit1027->SetParError(1,0.017688);
