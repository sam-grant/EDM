...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008644755);
   Graph_Graph11015->SetMaximum(0.008541034);
   ...
   Graph_Graph21016->SetMinimum(-0.01484582);
   Graph_Graph21016->SetMaximum(0.01748281);
   ...
   Graph_Graph31017->SetMinimum(-0.03842521);
   Graph_Graph31017->SetMaximum(0.02761979);
   ...
   Graph_Graph41018->SetMinimum(-0.01031473);
   Graph_Graph41018->SetMaximum(0.01727981);
   ...
   Graph_Graph51019->SetMinimum(-0.005885509);
   Graph_Graph51019->SetMaximum(0.007866688);
