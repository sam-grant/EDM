...
//=========  (Thu Apr 22 14:44:31 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.5084301);
   ...
   quadLineFit1002->SetParameter(0,74.56837);
   quadLineFit1002->SetParError(0,0.0624392);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.82471);
   quadLineFit1002->SetParError(1,1.047161);
   ...
   quadLineFit1003->SetChisquare(0.5084301);
   ...
   quadLineFit1003->SetParameter(0,74.56837);
   quadLineFit1003->SetParError(0,0.0624392);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.82471);
   quadLineFit1003->SetParError(1,1.047161);
   ...
   Graph_30_ppm1003->SetMaximum(76.42354);
   ...
   quadLineFit1004->SetChisquare(0.6520905);
   ...
   quadLineFit1004->SetParameter(0,74.69037);
   quadLineFit1004->SetParError(0,0.05315926);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.38976);
   quadLineFit1004->SetParError(1,0.8737443);
   ...
   quadLineFit1005->SetChisquare(0.6520905);
   ...
   quadLineFit1005->SetParameter(0,74.69037);
   quadLineFit1005->SetParError(0,0.05315926);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.38976);
   quadLineFit1005->SetParError(1,0.8737443);
   ...
   Graph_10_ppm1005->SetMinimum(74.86183);
   Graph_10_ppm1005->SetMaximum(75.09663);
   ...
   quadLineFit1006->SetChisquare(2.682727);
   ...
   quadLineFit1006->SetParameter(0,74.47676);
   quadLineFit1006->SetParError(0,0.06229321);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.979734);
   quadLineFit1006->SetParError(1,1.010302);
   ...
   quadLineFit1007->SetChisquare(2.682727);
   ...
   quadLineFit1007->SetParameter(0,74.47676);
   quadLineFit1007->SetParError(0,0.06229321);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.979734);
   quadLineFit1007->SetParError(1,1.010302);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.65546);
   Graph_mI10_ppm1007->SetMaximum(73.96109);
   ...
   quadLineFit1008->SetChisquare(10.5476);
   ...
   quadLineFit1008->SetParameter(0,74.41037);
   quadLineFit1008->SetParError(0,0.05479297);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.98348);
   quadLineFit1008->SetParError(1,0.8918939);
   ...
   quadLineFit1009->SetChisquare(10.5476);
   ...
   quadLineFit1009->SetParameter(0,74.41037);
   quadLineFit1009->SetParError(0,0.05479297);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.98348);
   quadLineFit1009->SetParError(1,0.8918939);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29536);
   Graph_mI30_ppm1009->SetMaximum(72.98588);
   ...
   quadLineFit1010->SetChisquare(2.30896);
   ...
   quadLineFit1010->SetParameter(0,74.32839);
   quadLineFit1010->SetParError(0,0.05172533);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.33862);
   quadLineFit1010->SetParError(1,0.8952104);
   ...
   quadLineFit1011->SetChisquare(2.30896);
   ...
   quadLineFit1011->SetParameter(0,74.32839);
   quadLineFit1011->SetParError(0,0.05172533);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.33862);
   quadLineFit1011->SetParError(1,0.8952104);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.37389);
   Graph_mI50_ppm1011->SetMaximum(72.01017);
   ...
   quadLineFit1012->SetChisquare(0.4832388);
   ...
   quadLineFit1012->SetParameter(0,74.23965);
   quadLineFit1012->SetParError(0,0.1044045);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.67709);
   quadLineFit1012->SetParError(1,1.868114);
   ...
   quadLineFit1013->SetChisquare(0.4832388);
   ...
   quadLineFit1013->SetParameter(0,74.23965);
   quadLineFit1013->SetParError(0,0.1044045);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.67709);
   quadLineFit1013->SetParError(1,1.868114);
