...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.78691);
   Graph_Graph01029->SetMaximum(55.11358);
   ...
   mainFit1030->SetChisquare(8.19198);
   ...
   mainFit1030->SetParameter(0,-1.208513);
   mainFit1030->SetParError(0,0.4501328);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8807135);
   mainFit1030->SetParError(1,0.01368508);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.21#pm 0.45");
   pt_LaTex = pt->AddText("#minus1.37#pm0.509");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.372197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.372197,-55.78691,1.372197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(8.19198);
   ...
   mainFit1031->SetParameter(0,-1.208513);
   mainFit1031->SetParError(0,0.4501328);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8807135);
   mainFit1031->SetParError(1,0.01368508);
