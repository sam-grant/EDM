...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.78691);
   Graph_Graph01031->SetMaximum(55.11358);
   ...
   mainFit1032->SetChisquare(8.309317);
   ...
   mainFit1032->SetParameter(0,-1.140251);
   mainFit1032->SetParError(0,0.4770365);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8809387);
   mainFit1032->SetParError(1,0.01413225);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.77");
   pt_LaTex = pt->AddText("0.881#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.14#pm0.477");
   pt_LaTex = pt->AddText("#minus1.29#pm0.536");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.294359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.294359,-55.78691,1.294359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(8.309317);
   ...
   mainFit1033->SetParameter(0,-1.140251);
   mainFit1033->SetParError(0,0.4770365);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8809387);
   mainFit1033->SetParError(1,0.01413225);
