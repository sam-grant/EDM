...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.76026,70,64.3983);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.6444);
   Graph_Graph01035->SetMaximum(53.28244);
   ...
   mainFit1036->SetChisquare(8.210915);
   ...
   mainFit1036->SetParameter(0,-1.189509);
   mainFit1036->SetParError(0,0.4347439);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8830061);
   mainFit1036->SetParError(1,0.01498126);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.74");
   pt_LaTex = pt->AddText("0.883#pm0.015");
   pt_LaTex = pt->AddText("#minus1.19#pm0.435");
   pt_LaTex = pt->AddText("#minus1.35#pm0.487");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.347113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.347113,-35.6444,1.347113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(8.210915);
   ...
   mainFit1037->SetParameter(0,-1.189509);
   mainFit1037->SetParError(0,0.4347439);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8830061);
   mainFit1037->SetParError(1,0.01498126);
