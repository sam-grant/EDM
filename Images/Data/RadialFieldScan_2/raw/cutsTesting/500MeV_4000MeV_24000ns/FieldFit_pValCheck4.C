...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.78691);
   Graph_Graph01033->SetMaximum(55.11358);
   ...
   mainFit1034->SetChisquare(8.167052);
   ...
   mainFit1034->SetParameter(0,-1.266832);
   mainFit1034->SetParError(0,0.5198466);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8849417);
   mainFit1034->SetParError(1,0.01707392);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.72");
   pt_LaTex = pt->AddText("0.885#pm0.0171");
   pt_LaTex = pt->AddText("#minus1.27#pm 0.52");
   pt_LaTex = pt->AddText("#minus1.43#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.431543,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.431543,-55.78691,1.431543,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.167052);
   ...
   mainFit1035->SetParameter(0,-1.266832);
   mainFit1035->SetParError(0,0.5198466);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8849417);
   mainFit1035->SetParError(1,0.01707392);
