...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.78691);
   Graph_Graph01020->SetMaximum(55.11358);
   ...
   mainFit1021->SetChisquare(8.310378);
   ...
   mainFit1021->SetParameter(0,-1.147955);
   mainFit1021->SetParError(0,0.4142961);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8810581);
   mainFit1021->SetParError(1,0.01364869);
   ...
   pt_LaTex = pt->AddText("#minus1.15#pm0.414");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.302927,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.302927,-55.78691,1.302927,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(8.310378);
   ...
   mainFit1022->SetParameter(0,-1.147955);
   mainFit1022->SetParError(0,0.4142961);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8810581);
   mainFit1022->SetParError(1,0.01364869);
