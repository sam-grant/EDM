...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.64947,75,68.97614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.78691);
   Graph_Graph01027->SetMaximum(55.11358);
   ...
   mainFit1028->SetChisquare(0.8484239);
   ...
   mainFit1028->SetParameter(0,-0.5832671);
   mainFit1028->SetParError(0,0.4630058);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8993578);
   mainFit1028->SetParError(1,0.01520413);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.283");
   pt_LaTex = pt->AddText("0.899#pm0.0152");
   pt_LaTex = pt->AddText("#minus0.583#pm0.463");
   pt_LaTex = pt->AddText("#minus0.649#pm0.516");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6485373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6485373,-55.78691,0.6485373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8484239);
   ...
   mainFit1029->SetParameter(0,-0.5832671);
   mainFit1029->SetParError(0,0.4630058);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8993578);
   mainFit1029->SetParError(1,0.01520413);
