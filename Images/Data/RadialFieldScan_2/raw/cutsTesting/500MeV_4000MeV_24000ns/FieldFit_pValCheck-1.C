...
//=========  (Thu Apr 22 14:44:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.78691);
   Graph_Graph01023->SetMaximum(55.11358);
   ...
   mainFit1024->SetChisquare(8.310378);
   ...
   mainFit1024->SetParameter(0,-1.147955);
   mainFit1024->SetParError(0,0.4142961);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8810581);
   mainFit1024->SetParError(1,0.01364869);
   ...
   mainFit1025->SetChisquare(8.310378);
   ...
   mainFit1025->SetParameter(0,-1.147955);
   mainFit1025->SetParError(0,0.4142961);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8810581);
   mainFit1025->SetParError(1,0.01364869);
