...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.50367,70,57.08258);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.74504);
   Graph_Graph01035->SetMaximum(47.32395);
   ...
   mainFit1036->SetChisquare(1.467494);
   ...
   mainFit1036->SetParameter(0,-0.0759362);
   mainFit1036->SetParError(0,0.5965716);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7687042);
   mainFit1036->SetParError(1,0.02084645);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.489");
   pt_LaTex = pt->AddText("0.769#pm0.0208");
   pt_LaTex = pt->AddText("#minus0.0759#pm0.597");
   pt_LaTex = pt->AddText("#minus0.0988#pm0.775");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.09878469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.09878469,-30.74504,0.09878469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.467494);
   ...
   mainFit1037->SetParameter(0,-0.0759362);
   mainFit1037->SetParError(0,0.5965716);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7687042);
   mainFit1037->SetParError(1,0.02084645);
