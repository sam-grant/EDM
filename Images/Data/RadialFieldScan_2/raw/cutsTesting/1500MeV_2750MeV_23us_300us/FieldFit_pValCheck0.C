...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-57.59209,50,39.22488);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.91039);
   Graph_Graph01025->SetMaximum(29.54318);
   ...
   mainFit1026->SetChisquare(0.7604929);
   ...
   mainFit1026->SetParameter(0,-0.2906923);
   mainFit1026->SetParError(0,0.6117941);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7570307);
   mainFit1026->SetParError(1,0.02422796);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.253");
   pt_LaTex = pt->AddText("0.757#pm0.0242");
   pt_LaTex = pt->AddText("#minus0.291#pm0.612");
   pt_LaTex = pt->AddText("#minus0.384#pm 0.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3839901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3839901,-47.91039,0.3839901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.7604929);
   ...
   mainFit1027->SetParameter(0,-0.2906923);
   mainFit1027->SetParError(0,0.6117941);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7570307);
   mainFit1027->SetParError(1,0.02422796);
