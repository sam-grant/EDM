...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-62.02446,75,61.38673);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-49.68334);
   Graph_Graph01020->SetMaximum(49.04561);
   ...
   mainFit1021->SetChisquare(1.485625);
   ...
   mainFit1021->SetParameter(0,-0.09993817);
   mainFit1021->SetParError(0,0.5693183);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7698673);
   mainFit1021->SetParError(1,0.01897262);
   ...
   pt_LaTex = pt->AddText(" 0.77#pm0.019");
   pt_LaTex = pt->AddText("#minus0.0999#pm0.569");
   pt_LaTex = pt->AddText("#minus0.13#pm0.739");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1298122,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1298122,-49.68334,0.1298122,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.485625);
   ...
   mainFit1022->SetParameter(0,-0.09993817);
   mainFit1022->SetParError(0,0.5693183);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7698673);
   mainFit1022->SetParError(1,0.01897262);
