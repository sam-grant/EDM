...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.68334);
   Graph_Graph01029->SetMaximum(49.04561);
   ...
   mainFit1030->SetChisquare(1.229579);
   ...
   mainFit1030->SetParameter(0,-0.2236392);
   mainFit1030->SetParError(0,0.6195876);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7690674);
   mainFit1030->SetParError(1,0.0190382);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.41");
   pt_LaTex = pt->AddText("0.769#pm0.019");
   pt_LaTex = pt->AddText("#minus0.224#pm 0.62");
   pt_LaTex = pt->AddText("#minus0.291#pm0.805");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2907928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2907928,-49.68334,0.2907928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.229579);
   ...
   mainFit1031->SetParameter(0,-0.2236392);
   mainFit1031->SetParError(0,0.6195876);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7690674);
   mainFit1031->SetParError(1,0.0190382);
