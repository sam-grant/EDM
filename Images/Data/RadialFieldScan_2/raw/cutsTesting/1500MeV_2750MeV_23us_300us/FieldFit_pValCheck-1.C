...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.68334);
   Graph_Graph01023->SetMaximum(49.04561);
   ...
   mainFit1024->SetChisquare(1.485625);
   ...
   mainFit1024->SetParameter(0,-0.09993817);
   mainFit1024->SetParError(0,0.5693183);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7698673);
   mainFit1024->SetParError(1,0.01897262);
   ...
   mainFit1025->SetChisquare(1.485625);
   ...
   mainFit1025->SetParameter(0,-0.09993817);
   mainFit1025->SetParError(0,0.5693183);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7698673);
   mainFit1025->SetParError(1,0.01897262);
