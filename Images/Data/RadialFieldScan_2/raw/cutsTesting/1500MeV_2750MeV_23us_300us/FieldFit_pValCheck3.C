...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-49.68334);
   Graph_Graph01031->SetMaximum(49.04561);
   ...
   mainFit1032->SetChisquare(1.480666);
   ...
   mainFit1032->SetParameter(0,-0.07703601);
   mainFit1032->SetParError(0,0.6556575);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7695166);
   mainFit1032->SetParError(1,0.01961533);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.494");
   pt_LaTex = pt->AddText(" 0.77#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.077#pm0.656");
   pt_LaTex = pt->AddText(" #minus0.1#pm0.851");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1001096,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1001096,-49.68334,0.1001096,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.480666);
   ...
   mainFit1033->SetParameter(0,-0.07703601);
   mainFit1033->SetParError(0,0.6556575);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7695166);
   mainFit1033->SetParError(1,0.01961533);
