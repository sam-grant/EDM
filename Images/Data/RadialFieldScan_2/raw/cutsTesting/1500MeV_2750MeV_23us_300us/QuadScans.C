...
//=========  (Wed Apr 28 17:35:40 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.325538);
   ...
   quadLineFit1002->SetParameter(0,74.84046);
   quadLineFit1002->SetParError(0,0.0893078);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.31957);
   quadLineFit1002->SetParError(1,1.498627);
   ...
   quadLineFit1003->SetChisquare(1.325538);
   ...
   quadLineFit1003->SetParameter(0,74.84046);
   quadLineFit1003->SetParError(0,0.0893078);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.31957);
   quadLineFit1003->SetParError(1,1.498627);
   ...
   Graph_30_ppm1003->SetMinimum(75.87571);
   Graph_30_ppm1003->SetMaximum(76.44145);
   ...
   quadLineFit1004->SetChisquare(1.248291);
   ...
   quadLineFit1004->SetParameter(0,74.81779);
   quadLineFit1004->SetParError(0,0.07282535);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.89178);
   quadLineFit1004->SetParError(1,1.196934);
   ...
   quadLineFit1005->SetChisquare(1.248291);
   ...
   quadLineFit1005->SetParameter(0,74.81779);
   quadLineFit1005->SetParError(0,0.07282535);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.89178);
   quadLineFit1005->SetParError(1,1.196934);
   ...
   Graph_10_ppm1005->SetMinimum(74.9684);
   Graph_10_ppm1005->SetMaximum(75.21625);
   ...
   quadLineFit1006->SetChisquare(0.0201187);
   ...
   quadLineFit1006->SetParameter(0,74.58426);
   quadLineFit1006->SetParError(0,0.08534026);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.236283);
   quadLineFit1006->SetParError(1,1.383977);
   ...
   quadLineFit1007->SetChisquare(0.0201187);
   ...
   quadLineFit1007->SetParameter(0,74.58426);
   quadLineFit1007->SetParError(0,0.08534026);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.236283);
   quadLineFit1007->SetParError(1,1.383977);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.90106);
   Graph_mI10_ppm1007->SetMaximum(74.17455);
   ...
   quadLineFit1008->SetChisquare(9.243914);
   ...
   quadLineFit1008->SetParameter(0,74.5113);
   quadLineFit1008->SetParError(0,0.07491846);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.872284);
   quadLineFit1008->SetParError(1,1.21934);
   ...
   quadLineFit1009->SetChisquare(9.243914);
   ...
   quadLineFit1009->SetParameter(0,74.5113);
   quadLineFit1009->SetParError(0,0.07491846);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.872284);
   quadLineFit1009->SetParError(1,1.21934);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.67823);
   Graph_mI30_ppm1009->SetMaximum(73.27823);
   ...
   quadLineFit1010->SetChisquare(0.02498837);
   ...
   quadLineFit1010->SetParameter(0,74.39576);
   quadLineFit1010->SetParError(0,0.07088348);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.01254);
   quadLineFit1010->SetParError(1,1.226754);
   ...
   quadLineFit1011->SetChisquare(0.02498837);
   ...
   quadLineFit1011->SetParameter(0,74.39576);
   quadLineFit1011->SetParError(0,0.07088348);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.01254);
   quadLineFit1011->SetParError(1,1.226754);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.81835);
   Graph_mI50_ppm1011->SetMaximum(72.38987);
   ...
   quadLineFit1012->SetChisquare(0.3246057);
   ...
   quadLineFit1012->SetParameter(0,74.32407);
   quadLineFit1012->SetParError(0,0.142905);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-38.89896);
   quadLineFit1012->SetParError(1,2.556968);
   ...
   quadLineFit1013->SetChisquare(0.3246057);
   ...
   quadLineFit1013->SetParameter(0,74.32407);
   quadLineFit1013->SetParError(0,0.142905);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-38.89896);
   quadLineFit1013->SetParError(1,2.556968);
