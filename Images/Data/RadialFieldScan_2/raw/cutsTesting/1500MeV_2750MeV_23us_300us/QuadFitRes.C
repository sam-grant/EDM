...
//=========  (Wed Apr 28 17:35:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01127097);
   Graph_Graph11015->SetMaximum(0.02709636);
   ...
   Graph_Graph21016->SetMinimum(-0.001761356);
   Graph_Graph21016->SetMaximum(0.002072829);
   ...
   Graph_Graph31017->SetMinimum(-0.04751315);
   Graph_Graph31017->SetMaximum(0.03889131);
   ...
   Graph_Graph41018->SetMinimum(-0.001926205);
   Graph_Graph41018->SetMaximum(0.002302993);
   ...
   Graph_Graph51019->SetMinimum(-0.006606789);
   Graph_Graph51019->SetMaximum(0.008832768);
