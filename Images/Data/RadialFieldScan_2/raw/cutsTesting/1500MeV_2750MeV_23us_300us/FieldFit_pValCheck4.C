...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.68334);
   Graph_Graph01033->SetMaximum(49.04561);
   ...
   mainFit1034->SetChisquare(1.441373);
   ...
   mainFit1034->SetParameter(0,-0.1897937);
   mainFit1034->SetParError(0,0.7117445);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7728612);
   mainFit1034->SetParError(1,0.02371745);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.48");
   pt_LaTex = pt->AddText("0.773#pm0.0237");
   pt_LaTex = pt->AddText("#minus0.19#pm0.712");
   pt_LaTex = pt->AddText("#minus0.246#pm0.918");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2455729,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2455729,-49.68334,0.2455729,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.441373);
   ...
   mainFit1035->SetParameter(0,-0.1897937);
   mainFit1035->SetParError(0,0.7117445);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7728612);
   mainFit1035->SetParError(1,0.02371745);
