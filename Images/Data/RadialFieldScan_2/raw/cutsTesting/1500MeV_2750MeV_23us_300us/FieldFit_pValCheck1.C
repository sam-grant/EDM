...
//=========  (Wed Apr 28 17:35:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.68334);
   Graph_Graph01027->SetMaximum(49.04561);
   ...
   mainFit1028->SetChisquare(0.1017273);
   ...
   mainFit1028->SetParameter(0,0.2457088);
   mainFit1028->SetParError(0,0.6406666);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7813819);
   mainFit1028->SetParError(1,0.02134883);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0339");
   pt_LaTex = pt->AddText("0.781#pm0.0213");
   pt_LaTex = pt->AddText("0.246#pm0.641");
   pt_LaTex = pt->AddText("0.314#pm0.819");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3144541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3144541,-49.68334,-0.3144541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1017273);
   ...
   mainFit1029->SetParameter(0,0.2457088);
   mainFit1029->SetParError(0,0.6406666);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7813819);
   mainFit1029->SetParError(1,0.02134883);
