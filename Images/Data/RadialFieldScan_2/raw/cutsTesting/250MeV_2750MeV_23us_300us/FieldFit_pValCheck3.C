...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.00938);
   Graph_Graph01031->SetMaximum(56.37862);
   ...
   mainFit1032->SetChisquare(3.666867);
   ...
   mainFit1032->SetParameter(0,-1.023738);
   mainFit1032->SetParError(0,0.4573328);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9267069);
   mainFit1032->SetParError(1,0.01358325);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.02#pm0.457");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.489");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.104706,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.104706,-59.00938,1.104706,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.666867);
   ...
   mainFit1033->SetParameter(0,-1.023738);
   mainFit1033->SetParError(0,0.4573328);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9267069);
   mainFit1033->SetParError(1,0.01358325);
