...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.43288,75,70.80212);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-59.00938);
   Graph_Graph01029->SetMaximum(56.37862);
   ...
   mainFit1030->SetChisquare(1.460817);
   ...
   mainFit1030->SetParameter(0,-1.438338);
   mainFit1030->SetParError(0,0.4312363);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9272957);
   mainFit1030->SetParError(1,0.01315898);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.487");
   pt_LaTex = pt->AddText("0.927#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.44#pm0.431");
   pt_LaTex = pt->AddText("#minus1.55#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.55111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.55111,-59.00938,1.55111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.460817);
   ...
   mainFit1031->SetParameter(0,-1.438338);
   mainFit1031->SetParError(0,0.4312363);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9272957);
   mainFit1031->SetParError(1,0.01315898);
