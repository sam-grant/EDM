...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.9957,70,65.91468);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.50466);
   Graph_Graph01035->SetMaximum(54.42364);
   ...
   mainFit1036->SetChisquare(4.058689);
   ...
   mainFit1036->SetParameter(0,-1.166678);
   mainFit1036->SetParError(0,0.4161152);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9289338);
   mainFit1036->SetParError(1,0.01440246);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0144");
   pt_LaTex = pt->AddText("#minus1.17#pm0.416");
   pt_LaTex = pt->AddText("#minus1.26#pm0.443");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.255932,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.255932,-37.50466,1.255932,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.058689);
   ...
   mainFit1037->SetParameter(0,-1.166678);
   mainFit1037->SetParError(0,0.4161152);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9289338);
   mainFit1037->SetParError(1,0.01440246);
