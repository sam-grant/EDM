...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.00938);
   Graph_Graph01020->SetMaximum(56.37862);
   ...
   mainFit1021->SetChisquare(4.058711);
   ...
   mainFit1021->SetParameter(0,-1.166095);
   mainFit1021->SetParError(0,0.3967809);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9289062);
   mainFit1021->SetParError(1,0.01312102);
   ...
   mainFit1022->SetChisquare(4.058711);
   ...
   mainFit1022->SetParameter(0,-1.166095);
   mainFit1022->SetParError(0,0.3967809);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9289062);
   mainFit1022->SetParError(1,0.01312102);
