...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.00938);
   Graph_Graph01027->SetMaximum(56.37862);
   ...
   mainFit1028->SetChisquare(1.833915);
   ...
   mainFit1028->SetParameter(0,-0.8684477);
   mainFit1028->SetParError(0,0.4441357);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9386406);
   mainFit1028->SetParError(1,0.01465458);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.0147");
   pt_LaTex = pt->AddText("#minus0.868#pm0.444");
   pt_LaTex = pt->AddText("#minus0.925#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9252185,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9252185,-59.00938,0.9252185,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.833915);
   ...
   mainFit1029->SetParameter(0,-0.8684477);
   mainFit1029->SetParError(0,0.4441357);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9386406);
   mainFit1029->SetParError(1,0.01465458);
