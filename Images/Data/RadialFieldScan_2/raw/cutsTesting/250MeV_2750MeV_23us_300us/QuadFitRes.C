...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009975413);
   Graph_Graph11015->SetMaximum(0.0123295);
   ...
   Graph_Graph21016->SetMinimum(-0.008563399);
   Graph_Graph21016->SetMaximum(0.01007508);
   ...
   Graph_Graph31017->SetMinimum(-0.02611792);
   Graph_Graph31017->SetMaximum(0.03107749);
   ...
   Graph_Graph41018->SetMinimum(-0.006616557);
   Graph_Graph41018->SetMaximum(0.0107066);
   ...
   Graph_Graph51019->SetMinimum(-0.006058004);
   Graph_Graph51019->SetMaximum(0.008098421);
