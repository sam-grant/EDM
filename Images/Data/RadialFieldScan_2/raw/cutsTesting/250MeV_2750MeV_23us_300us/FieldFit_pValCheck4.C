...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.00938);
   Graph_Graph01033->SetMaximum(56.37862);
   ...
   mainFit1034->SetChisquare(4.05285);
   ...
   mainFit1034->SetParameter(0,-1.189011);
   mainFit1034->SetParError(0,0.4970201);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9296596);
   mainFit1034->SetParError(1,0.01640164);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.19#pm0.497");
   pt_LaTex = pt->AddText("#minus1.28#pm0.525");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.278975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.278975,-59.00938,1.278975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.05285);
   ...
   mainFit1035->SetParameter(0,-1.189011);
   mainFit1035->SetParError(0,0.4970201);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9296596);
   mainFit1035->SetParError(1,0.01640164);
