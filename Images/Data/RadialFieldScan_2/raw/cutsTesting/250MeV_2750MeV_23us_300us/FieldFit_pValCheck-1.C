...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.00938);
   Graph_Graph01023->SetMaximum(56.37862);
   ...
   mainFit1024->SetChisquare(4.058711);
   ...
   mainFit1024->SetParameter(0,-1.166095);
   mainFit1024->SetParError(0,0.3967809);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9289062);
   mainFit1024->SetParError(1,0.01312102);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.17#pm0.397");
   pt_LaTex = pt->AddText("#minus1.26#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.255342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.255342,-59.00938,1.255342,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.058711);
   ...
   mainFit1025->SetParameter(0,-1.166095);
   mainFit1025->SetParError(0,0.3967809);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9289062);
   mainFit1025->SetParError(1,0.01312102);
