...
//=========  (Wed Apr 28 16:43:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.37965,50,45.53597);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.98809);
   Graph_Graph01025->SetMaximum(34.1444);
   ...
   mainFit1026->SetChisquare(3.638823);
   ...
   mainFit1026->SetParameter(0,-1.26932);
   mainFit1026->SetParError(0,0.4275648);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.921959);
   mainFit1026->SetParError(1,0.01694418);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0169");
   pt_LaTex = pt->AddText("#minus1.27#pm0.428");
   pt_LaTex = pt->AddText("#minus1.38#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.376764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.376764,-56.98809,1.376764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.638823);
   ...
   mainFit1027->SetParameter(0,-1.26932);
   mainFit1027->SetParError(0,0.4275648);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.921959);
   mainFit1027->SetParError(1,0.01694418);
