...
//=========  (Thu Apr 22 00:53:32 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-59.9588,70,71.50738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-46.81219);
   Graph_Graph01035->SetMaximum(58.36076);
   ...
   mainFit1036->SetChisquare(2.42547);
   ...
   mainFit1036->SetParameter(0,-1.635785);
   mainFit1036->SetParError(0,2.286597);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9427047);
   mainFit1036->SetParError(1,0.0791276);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.808");
   pt_LaTex = pt->AddText("0.943#pm0.0791");
   pt_LaTex = pt->AddText("#minus1.64#pm 2.29");
   pt_LaTex = pt->AddText("#minus1.74#pm 2.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.735204,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.735204,-46.81219,1.735204,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.42547);
   ...
   mainFit1037->SetParameter(0,-1.635785);
   mainFit1037->SetParError(0,2.286597);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9427047);
   mainFit1037->SetParError(1,0.0791276);
