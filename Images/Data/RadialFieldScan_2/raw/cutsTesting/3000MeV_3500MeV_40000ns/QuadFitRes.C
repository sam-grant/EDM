...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04071265);
   Graph_Graph11015->SetMaximum(0.01429668);
   ...
   Graph_Graph21016->SetMinimum(-0.01093498);
   Graph_Graph21016->SetMaximum(0.01282113);
   ...
   Graph_Graph31017->SetMinimum(-0.09474739);
   Graph_Graph31017->SetMaximum(0.0996385);
   ...
   Graph_Graph41018->SetMinimum(-0.02104067);
   Graph_Graph41018->SetMaximum(0.01441699);
   ...
   Graph_Graph51019->SetMinimum(-0.009454334);
   Graph_Graph51019->SetMaximum(0.007099193);
