...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.92267);
   Graph_Graph01020->SetMaximum(59.46172);
   ...
   mainFit1021->SetChisquare(3.169517);
   ...
   mainFit1021->SetParameter(0,-1.03917);
   mainFit1021->SetParError(0,2.179513);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9144768);
   mainFit1021->SetParError(1,0.07205418);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.792");
   pt_LaTex = pt->AddText("0.914#pm0.0721");
   pt_LaTex = pt->AddText("#minus1.04#pm 2.18");
   pt_LaTex = pt->AddText("#minus1.14#pm 2.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.136354,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.136354,-58.92267,1.136354,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.169517);
   ...
   mainFit1022->SetParameter(0,-1.03917);
   mainFit1022->SetParError(0,2.179513);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9144768);
   mainFit1022->SetParError(1,0.07205418);
