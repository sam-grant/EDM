...
//=========  (Thu Apr 22 00:53:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.92267);
   Graph_Graph01033->SetMaximum(59.46172);
   ...
   mainFit1034->SetChisquare(1.067602);
   ...
   mainFit1034->SetParameter(0,1.347025);
   mainFit1034->SetParError(0,2.731192);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8360735);
   mainFit1034->SetParError(1,0.09009907);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.356");
   pt_LaTex = pt->AddText("0.836#pm0.0901");
   pt_LaTex = pt->AddText(" 1.35#pm 2.73");
   pt_LaTex = pt->AddText(" 1.61#pm 3.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.611133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.611133,-58.92267,-1.611133,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.067602);
   ...
   mainFit1035->SetParameter(0,1.347025);
   mainFit1035->SetParError(0,2.731192);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8360735);
   mainFit1035->SetParError(1,0.09009907);
