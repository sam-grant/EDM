...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.37376,50,52.52499);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.18389);
   Graph_Graph01025->SetMaximum(40.33511);
   ...
   mainFit1026->SetChisquare(3.141943);
   ...
   mainFit1026->SetParameter(0,-0.8947967);
   mainFit1026->SetParError(0,2.346841);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.924233);
   mainFit1026->SetParError(1,0.09293658);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.0929");
   pt_LaTex = pt->AddText("#minus0.895#pm 2.35");
   pt_LaTex = pt->AddText("#minus0.968#pm 2.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.9681505,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9681505,-57.18389,0.9681505,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.141943);
   ...
   mainFit1027->SetParameter(0,-0.8947967);
   mainFit1027->SetParError(0,2.346841);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.924233);
   mainFit1027->SetParError(1,0.09293658);
