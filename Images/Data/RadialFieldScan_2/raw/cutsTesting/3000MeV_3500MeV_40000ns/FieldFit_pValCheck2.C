...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.92267);
   Graph_Graph01029->SetMaximum(59.46172);
   ...
   mainFit1030->SetChisquare(2.718519);
   ...
   mainFit1030->SetParameter(0,-0.4143122);
   mainFit1030->SetParError(0,2.369861);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.91815);
   mainFit1030->SetParError(1,0.07225952);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0723");
   pt_LaTex = pt->AddText("#minus0.414#pm 2.37");
   pt_LaTex = pt->AddText("#minus0.451#pm 2.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4512468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4512468,-58.92267,0.4512468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.718519);
   ...
   mainFit1031->SetParameter(0,-0.4143122);
   mainFit1031->SetParError(0,2.369861);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.91815);
   mainFit1031->SetParError(1,0.07225952);
