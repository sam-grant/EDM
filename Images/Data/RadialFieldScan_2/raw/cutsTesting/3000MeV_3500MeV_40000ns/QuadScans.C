...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.279956);
   ...
   quadLineFit1002->SetParameter(0,75.33722);
   quadLineFit1002->SetParError(0,0.3322262);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.02373);
   quadLineFit1002->SetParError(1,5.57262);
   ...
   quadLineFit1003->SetChisquare(3.279956);
   ...
   quadLineFit1003->SetParameter(0,75.33722);
   quadLineFit1003->SetParError(0,0.3322262);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.02373);
   quadLineFit1003->SetParError(1,5.57262);
   ...
   Graph_30_ppm1003->SetMinimum(76.53972);
   Graph_30_ppm1003->SetMaximum(77.38107);
   ...
   quadLineFit1004->SetChisquare(0.1794599);
   ...
   quadLineFit1004->SetParameter(0,75.26112);
   quadLineFit1004->SetParError(0,0.2788937);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,27.62236);
   quadLineFit1004->SetParError(1,4.586168);
   ...
   quadLineFit1005->SetChisquare(0.1794599);
   ...
   quadLineFit1005->SetParameter(0,75.26112);
   quadLineFit1005->SetParError(0,0.2788937);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,27.62236);
   quadLineFit1005->SetParError(1,4.586168);
   ...
   Graph_10_ppm1005->SetMinimum(75.67857);
   Graph_10_ppm1005->SetMaximum(75.98494);
   ...
   quadLineFit1006->SetChisquare(0.05225837);
   ...
   quadLineFit1006->SetParameter(0,75.51955);
   quadLineFit1006->SetParError(0,0.3266662);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,4.862544);
   quadLineFit1006->SetParError(1,5.298944);
   ...
   quadLineFit1007->SetChisquare(0.05225837);
   ...
   quadLineFit1007->SetParameter(0,75.51955);
   quadLineFit1007->SetParError(0,0.3266662);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,4.862544);
   quadLineFit1007->SetParError(1,5.298944);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.6445);
   Graph_mI10_ppm1007->SetMaximum(75.04594);
   ...
   quadLineFit1008->SetChisquare(2.451039);
   ...
   quadLineFit1008->SetParameter(0,75.12472);
   quadLineFit1008->SetParError(0,0.2879321);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.363188);
   quadLineFit1008->SetParError(1,4.688041);
   ...
   quadLineFit1009->SetChisquare(2.451039);
   ...
   quadLineFit1009->SetParameter(0,75.12472);
   quadLineFit1009->SetParError(0,0.2879321);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.363188);
   quadLineFit1009->SetParError(1,4.688041);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.11228);
   Graph_mI30_ppm1009->SetMaximum(74.08258);
   ...
   quadLineFit1010->SetChisquare(0.14946);
   ...
   quadLineFit1010->SetParameter(0,75.64818);
   quadLineFit1010->SetParError(0,0.2721978);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.33561);
   quadLineFit1010->SetParError(1,4.712161);
   ...
   quadLineFit1011->SetChisquare(0.14946);
   ...
   quadLineFit1011->SetParameter(0,75.64818);
   quadLineFit1011->SetParError(0,0.2721978);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.33561);
   quadLineFit1011->SetParError(1,4.712161);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.31925);
   Graph_mI50_ppm1011->SetMaximum(73.03439);
   ...
   quadLineFit1012->SetChisquare(0.02540388);
   ...
   quadLineFit1012->SetParameter(0,74.91116);
   quadLineFit1012->SetParError(0,0.5486294);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.24072);
   quadLineFit1012->SetParError(1,9.816583);
   ...
   quadLineFit1013->SetChisquare(0.02540388);
   ...
   quadLineFit1013->SetParameter(0,74.91116);
   quadLineFit1013->SetParError(0,0.5486294);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.24072);
   quadLineFit1013->SetParError(1,9.816583);
