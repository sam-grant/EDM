...
//=========  (Thu Apr 22 00:53:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.92267);
   Graph_Graph01031->SetMaximum(59.46172);
   ...
   mainFit1032->SetChisquare(1.734414);
   ...
   mainFit1032->SetParameter(0,-2.529589);
   mainFit1032->SetParError(0,2.509572);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.937581);
   mainFit1032->SetParError(1,0.07458626);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.0746");
   pt_LaTex = pt->AddText("#minus2.53#pm 2.51");
   pt_LaTex = pt->AddText(" #minus2.7#pm 2.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.697995,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.697995,-58.92267,2.697995,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.734414);
   ...
   mainFit1033->SetParameter(0,-2.529589);
   mainFit1033->SetParError(0,2.509572);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.937581);
   mainFit1033->SetParError(1,0.07458626);
