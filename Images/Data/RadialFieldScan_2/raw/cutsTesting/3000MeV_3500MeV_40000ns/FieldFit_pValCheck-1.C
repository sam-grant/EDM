...
//=========  (Thu Apr 22 00:53:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.92267);
   Graph_Graph01023->SetMaximum(59.46172);
   ...
   mainFit1024->SetChisquare(3.169517);
   ...
   mainFit1024->SetParameter(0,-1.03917);
   mainFit1024->SetParError(0,2.179513);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9144768);
   mainFit1024->SetParError(1,0.07205418);
   ...
   mainFit1025->SetChisquare(3.169517);
   ...
   mainFit1025->SetParameter(0,-1.03917);
   mainFit1025->SetParError(0,2.179513);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9144768);
   mainFit1025->SetParError(1,0.07205418);
