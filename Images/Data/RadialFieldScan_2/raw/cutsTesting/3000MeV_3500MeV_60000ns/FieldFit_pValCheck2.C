...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.98137);
   Graph_Graph01029->SetMaximum(65.25039);
   ...
   mainFit1030->SetChisquare(1.500842);
   ...
   mainFit1030->SetParameter(0,-1.25945);
   mainFit1030->SetParError(0,2.889732);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9462157);
   mainFit1030->SetParError(1,0.08802715);
   ...
   pt_LaTex = pt->AddText("0.946#pm0.088");
   pt_LaTex = pt->AddText("#minus1.26#pm 2.89");
   pt_LaTex = pt->AddText("#minus1.33#pm 3.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.331039,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.331039,-59.98137,1.331039,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.500842);
   ...
   mainFit1031->SetParameter(0,-1.25945);
   mainFit1031->SetParError(0,2.889732);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9462157);
   mainFit1031->SetParError(1,0.08802715);
