...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-62.74465,70,78.32623);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-48.63756);
   Graph_Graph01035->SetMaximum(64.21914);
   ...
   mainFit1036->SetChisquare(1.477729);
   ...
   mainFit1036->SetParameter(0,-3.461813);
   mainFit1036->SetParError(0,2.789351);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.983556);
   mainFit1036->SetParError(1,0.09643356);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.493");
   pt_LaTex = pt->AddText("0.984#pm0.0964");
   pt_LaTex = pt->AddText("#minus3.46#pm 2.79");
   pt_LaTex = pt->AddText("#minus3.52#pm 2.76");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.519691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.519691,-48.63756,3.519691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.477729);
   ...
   mainFit1037->SetParameter(0,-3.461813);
   mainFit1037->SetParError(0,2.789351);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.983556);
   mainFit1037->SetParError(1,0.09643356);
