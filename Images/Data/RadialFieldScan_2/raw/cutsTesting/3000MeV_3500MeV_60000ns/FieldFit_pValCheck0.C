...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.75358,50,51.49558);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.62866);
   Graph_Graph01025->SetMaximum(39.37066);
   ...
   mainFit1026->SetChisquare(2.179301);
   ...
   mainFit1026->SetParameter(0,-3.302072);
   mainFit1026->SetParError(0,2.862099);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8859639);
   mainFit1026->SetParError(1,0.1132047);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.726");
   pt_LaTex = pt->AddText("0.886#pm0.113");
   pt_LaTex = pt->AddText(" #minus3.3#pm 2.86");
   pt_LaTex = pt->AddText("#minus3.73#pm 3.32");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.727095,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.727095,-57.62866,3.727095,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.179301);
   ...
   mainFit1027->SetParameter(0,-3.302072);
   mainFit1027->SetParError(0,2.862099);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8859639);
   mainFit1027->SetParError(1,0.1132047);
