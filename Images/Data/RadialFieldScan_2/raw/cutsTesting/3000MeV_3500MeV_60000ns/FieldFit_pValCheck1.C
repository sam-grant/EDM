...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.63534,75,80.90436);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.98137);
   Graph_Graph01027->SetMaximum(65.25039);
   ...
   mainFit1028->SetChisquare(2.727821);
   ...
   mainFit1028->SetParameter(0,-2.530827);
   mainFit1028->SetParError(0,2.976796);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9384179);
   mainFit1028->SetParError(1,0.09805726);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.909");
   pt_LaTex = pt->AddText("0.938#pm0.0981");
   pt_LaTex = pt->AddText("#minus2.53#pm 2.98");
   pt_LaTex = pt->AddText(" #minus2.7#pm  3.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.696909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.696909,-59.98137,2.696909,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.727821);
   ...
   mainFit1029->SetParameter(0,-2.530827);
   mainFit1029->SetParError(0,2.976796);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9384179);
   mainFit1029->SetParError(1,0.09805726);
