...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.98137);
   Graph_Graph01033->SetMaximum(65.25039);
   ...
   mainFit1034->SetChisquare(2.255475);
   ...
   mainFit1034->SetParameter(0,-1.133947);
   mainFit1034->SetParError(0,3.332475);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8935823);
   mainFit1034->SetParError(1,0.1097928);
   ...
   pt_LaTex = pt->AddText("0.894#pm 0.11");
   pt_LaTex = pt->AddText("#minus1.13#pm 3.33");
   pt_LaTex = pt->AddText("#minus1.27#pm 3.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.26899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.26899,-59.98137,1.26899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.255475);
   ...
   mainFit1035->SetParameter(0,-1.133947);
   mainFit1035->SetParError(0,3.332475);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8935823);
   mainFit1035->SetParError(1,0.1097928);
