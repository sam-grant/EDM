...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08224673);
   Graph_Graph11015->SetMaximum(0.06995974);
   ...
   Graph_Graph21016->SetMinimum(-0.007297336);
   Graph_Graph21016->SetMaximum(0.006227884);
   ...
   Graph_Graph31017->SetMinimum(-0.07560918);
   Graph_Graph31017->SetMaximum(0.06542111);
   ...
   Graph_Graph41018->SetMinimum(-0.06446236);
   Graph_Graph41018->SetMaximum(0.05389112);
   ...
   Graph_Graph51019->SetMinimum(-0.01285679);
   Graph_Graph51019->SetMaximum(0.009642544);
