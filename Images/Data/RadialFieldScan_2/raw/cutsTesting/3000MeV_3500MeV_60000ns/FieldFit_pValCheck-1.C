...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.98137);
   Graph_Graph01023->SetMaximum(65.25039);
   ...
   mainFit1024->SetChisquare(2.727949);
   ...
   mainFit1024->SetParameter(0,-2.515683);
   mainFit1024->SetParError(0,2.65791);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9389094);
   mainFit1024->SetParError(1,0.08777986);
   ...
   mainFit1025->SetChisquare(2.727949);
   ...
   mainFit1025->SetParameter(0,-2.515683);
   mainFit1025->SetParError(0,2.65791);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9389094);
   mainFit1025->SetParError(1,0.08777986);
