...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.98137);
   Graph_Graph01020->SetMaximum(65.25039);
   ...
   mainFit1021->SetChisquare(2.727949);
   ...
   mainFit1021->SetParameter(0,-2.515683);
   mainFit1021->SetParError(0,2.65791);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9389094);
   mainFit1021->SetParError(1,0.08777986);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.0878");
   pt_LaTex = pt->AddText("#minus2.52#pm 2.66");
   pt_LaTex = pt->AddText("#minus2.68#pm  2.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.679367,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.679367,-59.98137,2.679367,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.727949);
   ...
   mainFit1022->SetParameter(0,-2.515683);
   mainFit1022->SetParError(0,2.65791);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9389094);
   mainFit1022->SetParError(1,0.08777986);
