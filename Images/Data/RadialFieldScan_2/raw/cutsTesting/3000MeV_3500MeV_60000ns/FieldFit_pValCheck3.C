...
//=========  (Thu Apr 22 01:14:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.98137);
   Graph_Graph01031->SetMaximum(65.25039);
   ...
   mainFit1032->SetChisquare(2.453389);
   ...
   mainFit1032->SetParameter(0,-3.307935);
   mainFit1032->SetParError(0,3.05786);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9511748);
   mainFit1032->SetParError(1,0.09084561);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.818");
   pt_LaTex = pt->AddText("0.951#pm0.0908");
   pt_LaTex = pt->AddText("#minus3.31#pm 3.06");
   pt_LaTex = pt->AddText("#minus3.48#pm 3.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.477736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.477736,-59.98137,3.477736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.453389);
   ...
   mainFit1033->SetParameter(0,-3.307935);
   mainFit1033->SetParError(0,3.05786);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9511748);
   mainFit1033->SetParError(1,0.09084561);
