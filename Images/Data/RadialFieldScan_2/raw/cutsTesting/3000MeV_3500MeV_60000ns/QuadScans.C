...
//=========  (Thu Apr 22 01:14:37 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.745145);
   ...
   quadLineFit1002->SetParameter(0,75.12921);
   quadLineFit1002->SetParError(0,0.4047224);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,48.02618);
   quadLineFit1002->SetParError(1,6.78823);
   ...
   quadLineFit1003->SetChisquare(2.745145);
   ...
   quadLineFit1003->SetParameter(0,75.12921);
   quadLineFit1003->SetParError(0,0.4047224);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,48.02618);
   quadLineFit1003->SetParError(1,6.78823);
   ...
   Graph_30_ppm1003->SetMinimum(76.57122);
   Graph_30_ppm1003->SetMaximum(77.36617);
   ...
   quadLineFit1004->SetChisquare(1.022881);
   ...
   quadLineFit1004->SetParameter(0,75.35542);
   quadLineFit1004->SetParError(0,0.3396853);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.70152);
   quadLineFit1004->SetParError(1,5.58587);
   ...
   quadLineFit1005->SetChisquare(1.022881);
   ...
   quadLineFit1005->SetParameter(0,75.35542);
   quadLineFit1005->SetParError(0,0.3396853);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.70152);
   quadLineFit1005->SetParError(1,5.58587);
   ...
   Graph_10_ppm1005->SetMinimum(75.68399);
   Graph_10_ppm1005->SetMaximum(75.9228);
   ...
   quadLineFit1006->SetChisquare(0.0114171);
   ...
   quadLineFit1006->SetParameter(0,75.78486);
   quadLineFit1006->SetParError(0,0.3985504);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,0.3459139);
   quadLineFit1006->SetParError(1,6.464813);
   ...
   quadLineFit1007->SetChisquare(0.0114171);
   ...
   quadLineFit1007->SetParameter(0,75.78486);
   quadLineFit1007->SetParError(0,0.3985504);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,0.3459139);
   quadLineFit1007->SetParError(1,6.464813);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.60856);
   Graph_mI10_ppm1007->SetMaximum(75.10972);
   ...
   quadLineFit1008->SetChisquare(0.9158402);
   ...
   quadLineFit1008->SetParameter(0,75.39562);
   quadLineFit1008->SetParError(0,0.3520058);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.324169);
   quadLineFit1008->SetParError(1,5.731946);
   ...
   quadLineFit1009->SetChisquare(0.9158402);
   ...
   quadLineFit1009->SetParameter(0,75.39562);
   quadLineFit1009->SetParError(0,0.3520058);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.324169);
   quadLineFit1009->SetParError(1,5.731946);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.11018);
   Graph_mI30_ppm1009->SetMaximum(74.10225);
   ...
   quadLineFit1010->SetChisquare(0.8788035);
   ...
   quadLineFit1010->SetParameter(0,75.64515);
   quadLineFit1010->SetParError(0,0.3316207);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.49057);
   quadLineFit1010->SetParError(1,5.742268);
   ...
   quadLineFit1011->SetChisquare(0.8788035);
   ...
   quadLineFit1011->SetParameter(0,75.64515);
   quadLineFit1011->SetParError(0,0.3316207);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.49057);
   quadLineFit1011->SetParError(1,5.742268);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.35932);
   Graph_mI50_ppm1011->SetMaximum(73.09304);
   ...
   quadLineFit1012->SetChisquare(0.0315811);
   ...
   quadLineFit1012->SetParameter(0,74.86687);
   quadLineFit1012->SetParError(0,0.6675674);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-37.60231);
   quadLineFit1012->SetParError(1,11.94308);
   ...
   quadLineFit1013->SetChisquare(0.0315811);
   ...
   quadLineFit1013->SetParameter(0,74.86687);
   quadLineFit1013->SetParError(0,0.6675674);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-37.60231);
   quadLineFit1013->SetParError(1,11.94308);
