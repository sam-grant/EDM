...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-122.597,50,70.93077);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-103.2442);
   Graph_Graph01025->SetMaximum(51.578);
   ...
   mainFit1026->SetChisquare(10.17627);
   ...
   mainFit1026->SetParameter(0,4.879889);
   mainFit1026->SetParError(0,4.017289);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8801818);
   mainFit1026->SetParError(1,0.1589779);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.39");
   pt_LaTex = pt->AddText(" 0.88#pm0.159");
   pt_LaTex = pt->AddText(" 4.88#pm 4.02");
   pt_LaTex = pt->AddText(" 5.54#pm 4.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-5.544183,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-5.544183,-103.2442,-5.544183,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(10.17627);
   ...
   mainFit1027->SetParameter(0,4.879889);
   mainFit1027->SetParError(0,4.017289);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8801818);
   mainFit1027->SetParError(1,0.1589779);
