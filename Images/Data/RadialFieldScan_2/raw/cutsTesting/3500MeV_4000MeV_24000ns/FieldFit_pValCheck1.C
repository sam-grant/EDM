...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-104.6498);
   Graph_Graph01027->SetMaximum(67.04035);
   ...
   mainFit1028->SetChisquare(7.666207);
   ...
   mainFit1028->SetParameter(0,7.334524);
   mainFit1028->SetParError(0,4.177034);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9381086);
   mainFit1028->SetParError(1,0.1375342);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.138");
   pt_LaTex = pt->AddText(" 7.33#pm 4.18");
   pt_LaTex = pt->AddText(" 7.82#pm 4.52");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.818417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.818417,-104.6498,-7.818417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(7.666207);
   ...
   mainFit1029->SetParameter(0,7.334524);
   mainFit1029->SetParError(0,4.177034);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9381086);
   mainFit1029->SetParError(1,0.1375342);
