...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2592899);
   ...
   quadLineFit1002->SetParameter(0,75.76802);
   quadLineFit1002->SetParError(0,0.5666242);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.23111);
   quadLineFit1002->SetParError(1,9.501721);
   ...
   quadLineFit1003->SetChisquare(0.2592899);
   ...
   quadLineFit1003->SetParameter(0,75.76802);
   quadLineFit1003->SetParError(0,0.5666242);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.23111);
   quadLineFit1003->SetParError(1,9.501721);
   ...
   Graph_30_ppm1003->SetMinimum(76.80605);
   Graph_30_ppm1003->SetMaximum(77.79147);
   ...
   quadLineFit1004->SetChisquare(8.311693);
   ...
   quadLineFit1004->SetParameter(0,76.17843);
   quadLineFit1004->SetParError(0,0.4758872);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,19.22293);
   quadLineFit1004->SetParError(1,7.827725);
   ...
   quadLineFit1005->SetChisquare(8.311693);
   ...
   quadLineFit1005->SetParameter(0,76.17843);
   quadLineFit1005->SetParError(0,0.4758872);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,19.22293);
   quadLineFit1005->SetParError(1,7.827725);
   ...
   Graph_10_ppm1005->SetMinimum(75.88606);
   Graph_10_ppm1005->SetMaximum(77.00043);
   ...
   quadLineFit1006->SetChisquare(4.900597);
   ...
   quadLineFit1006->SetParameter(0,74.48037);
   quadLineFit1006->SetParError(0,0.5674183);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,29.47122);
   quadLineFit1006->SetParError(1,9.204932);
   ...
   quadLineFit1007->SetChisquare(4.900597);
   ...
   quadLineFit1007->SetParameter(0,74.48037);
   quadLineFit1007->SetParError(0,0.5674183);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,29.47122);
   quadLineFit1007->SetParError(1,9.204932);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.75874);
   Graph_mI10_ppm1007->SetMaximum(75.25851);
   ...
   quadLineFit1008->SetChisquare(1.199132);
   ...
   quadLineFit1008->SetParameter(0,74.89845);
   quadLineFit1008->SetParError(0,0.4881215);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,2.153596);
   quadLineFit1008->SetParError(1,7.951084);
   ...
   quadLineFit1009->SetChisquare(1.199132);
   ...
   quadLineFit1009->SetParameter(0,74.89845);
   quadLineFit1009->SetParError(0,0.4881215);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,2.153596);
   quadLineFit1009->SetParError(1,7.951084);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.46666);
   Graph_mI30_ppm1009->SetMaximum(74.31252);
   ...
   quadLineFit1010->SetChisquare(4.109211);
   ...
   quadLineFit1010->SetParameter(0,75.06937);
   quadLineFit1010->SetParError(0,0.4657078);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-19.17033);
   quadLineFit1010->SetParError(1,8.06616);
   ...
   quadLineFit1011->SetChisquare(4.109211);
   ...
   quadLineFit1011->SetParameter(0,75.06937);
   quadLineFit1011->SetParError(0,0.4657078);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-19.17033);
   quadLineFit1011->SetParError(1,8.06616);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.28552);
   Graph_mI50_ppm1011->SetMaximum(73.59513);
   ...
   quadLineFit1012->SetChisquare(0.01170727);
   ...
   quadLineFit1012->SetParameter(0,77.12973);
   quadLineFit1012->SetParError(0,0.9396128);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-73.53452);
   quadLineFit1012->SetParError(1,16.80781);
   ...
   quadLineFit1013->SetChisquare(0.01170727);
   ...
   quadLineFit1013->SetParameter(0,77.12973);
   quadLineFit1013->SetParError(0,0.9396128);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-73.53452);
   quadLineFit1013->SetParError(1,16.80781);
