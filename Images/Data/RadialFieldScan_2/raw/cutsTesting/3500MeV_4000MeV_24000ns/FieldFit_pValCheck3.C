...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-104.6498);
   Graph_Graph01031->SetMaximum(67.04035);
   ...
   mainFit1032->SetChisquare(9.504205);
   ...
   mainFit1032->SetParameter(0,2.256251);
   mainFit1032->SetParError(0,4.304382);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8681156);
   mainFit1032->SetParError(1,0.1274866);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.17");
   pt_LaTex = pt->AddText("0.868#pm0.127");
   pt_LaTex = pt->AddText(" 2.26#pm  4.3");
   pt_LaTex = pt->AddText("  2.6#pm 5.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.599022,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.599022,-104.6498,-2.599022,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(9.504205);
   ...
   mainFit1033->SetParameter(0,2.256251);
   mainFit1033->SetParError(0,4.304382);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8681156);
   mainFit1033->SetParError(1,0.1274866);
