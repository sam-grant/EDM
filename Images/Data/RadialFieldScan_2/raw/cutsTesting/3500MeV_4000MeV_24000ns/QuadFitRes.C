...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.3798979);
   Graph_Graph11015->SetMaximum(0.2445165);
   ...
   Graph_Graph21016->SetMinimum(-0.1811411);
   Graph_Graph21016->SetMaximum(0.2143304);
   ...
   Graph_Graph31017->SetMinimum(-0.115607);
   Graph_Graph31017->SetMaximum(0.08438796);
   ...
   Graph_Graph41018->SetMinimum(-0.2053709);
   Graph_Graph41018->SetMaximum(0.181044);
   ...
   Graph_Graph51019->SetMinimum(-0.0110482);
   Graph_Graph51019->SetMaximum(0.008272066);
