...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-104.6498);
   Graph_Graph01029->SetMaximum(67.04035);
   ...
   mainFit1030->SetChisquare(6.345884);
   ...
   mainFit1030->SetParameter(0,1.114328);
   mainFit1030->SetParError(0,4.042018);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8191538);
   mainFit1030->SetParError(1,0.12341);
   ...
   pt_LaTex = pt->AddText("0.819#pm0.123");
   pt_LaTex = pt->AddText(" 1.11#pm 4.04");
   pt_LaTex = pt->AddText(" 1.36#pm 4.96");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.36034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.36034,-104.6498,-1.36034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.345884);
   ...
   mainFit1031->SetParameter(0,1.114328);
   mainFit1031->SetParError(0,4.042018);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8191538);
   mainFit1031->SetParError(1,0.12341);
