...
//=========  (Wed Apr 21 20:53:04 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.22882,70,72.72516);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.23342);
   Graph_Graph01035->SetMaximum(60.72976);
   ...
   mainFit1036->SetChisquare(4.581706);
   ...
   mainFit1036->SetParameter(0,7.080274);
   mainFit1036->SetParError(0,3.910255);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7035645);
   mainFit1036->SetParError(1,0.1350888);
   ...
   pt_LaTex = pt->AddText("0.704#pm0.135");
   pt_LaTex = pt->AddText(" 7.08#pm 3.91");
   pt_LaTex = pt->AddText(" 10.1#pm 6.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-10.06343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-10.06343,-35.23342,-10.06343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.581706);
   ...
   mainFit1037->SetParameter(0,7.080274);
   mainFit1037->SetParError(0,3.910255);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7035645);
   mainFit1037->SetParError(1,0.1350888);
