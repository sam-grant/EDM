...
//=========  (Wed Apr 21 20:53:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-104.6498);
   Graph_Graph01023->SetMaximum(67.04035);
   ...
   mainFit1024->SetChisquare(10.35693);
   ...
   mainFit1024->SetParameter(0,4.243467);
   mainFit1024->SetParError(0,3.727821);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8374088);
   mainFit1024->SetParError(1,0.1230735);
   ...
   mainFit1025->SetChisquare(10.35693);
   ...
   mainFit1025->SetParameter(0,4.243467);
   mainFit1025->SetParError(0,3.727821);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8374088);
   mainFit1025->SetParError(1,0.1230735);
