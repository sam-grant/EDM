...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.00735);
   Graph_Graph01029->SetMaximum(48.57759);
   ...
   mainFit1030->SetChisquare(3.875797);
   ...
   mainFit1030->SetParameter(0,-0.4486532);
   mainFit1030->SetParError(0,0.6924637);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7497473);
   mainFit1030->SetParError(1,0.02103601);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.021");
   pt_LaTex = pt->AddText("#minus0.449#pm0.692");
   pt_LaTex = pt->AddText("#minus0.598#pm0.922");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5984059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5984059,-48.00735,0.5984059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.875797);
   ...
   mainFit1031->SetParameter(0,-0.4486532);
   mainFit1031->SetParError(0,0.6924637);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7497473);
   mainFit1031->SetParError(1,0.02103601);
