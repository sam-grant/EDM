...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-55.31073,50,36.80199);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-46.09946);
   Graph_Graph01025->SetMaximum(27.59072);
   ...
   mainFit1026->SetChisquare(4.868033);
   ...
   mainFit1026->SetParameter(0,-0.3362388);
   mainFit1026->SetParError(0,0.6878075);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7314735);
   mainFit1026->SetParError(1,0.02723765);
   ...
   pt_LaTex = pt->AddText("0.731#pm0.0272");
   pt_LaTex = pt->AddText("#minus0.336#pm0.688");
   pt_LaTex = pt->AddText("#minus0.46#pm0.942");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.4596733,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4596733,-46.09946,0.4596733,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.868033);
   ...
   mainFit1027->SetParameter(0,-0.3362388);
   mainFit1027->SetParError(0,0.6878075);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7314735);
   mainFit1027->SetParError(1,0.02723765);
