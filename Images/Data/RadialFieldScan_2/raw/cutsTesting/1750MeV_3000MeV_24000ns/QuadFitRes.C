...
//=========  (Fri Apr 23 19:00:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01643408);
   Graph_Graph11015->SetMaximum(0.0273173);
   ...
   Graph_Graph21016->SetMinimum(-0.006826881);
   Graph_Graph21016->SetMaximum(0.008034986);
   ...
   Graph_Graph31017->SetMinimum(-0.04341487);
   Graph_Graph31017->SetMaximum(0.03945582);
   ...
   Graph_Graph41018->SetMinimum(-0.01360641);
   Graph_Graph41018->SetMaximum(0.007040124);
   ...
   Graph_Graph51019->SetMinimum(-0.01493133);
   Graph_Graph51019->SetMaximum(0.01117447);
