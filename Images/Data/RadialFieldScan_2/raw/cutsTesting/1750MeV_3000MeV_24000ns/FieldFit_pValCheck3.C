...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-48.00735);
   Graph_Graph01031->SetMaximum(48.57759);
   ...
   mainFit1032->SetChisquare(6.194643);
   ...
   mainFit1032->SetParameter(0,-0.1341054);
   mainFit1032->SetParError(0,0.7345015);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7537071);
   mainFit1032->SetParError(1,0.02173233);
   ...
   pt_LaTex = pt->AddText("0.754#pm0.0217");
   pt_LaTex = pt->AddText("#minus0.134#pm0.735");
   pt_LaTex = pt->AddText("#minus0.178#pm0.973");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1779277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1779277,-48.00735,0.1779277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.194643);
   ...
   mainFit1033->SetParameter(0,-0.1341054);
   mainFit1033->SetParError(0,0.7345015);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7537071);
   mainFit1033->SetParError(1,0.02173233);
