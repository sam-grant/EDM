...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.89649,70,56.81392);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.12545);
   Graph_Graph01035->SetMaximum(47.04288);
   ...
   mainFit1036->SetChisquare(6.229664);
   ...
   mainFit1036->SetParameter(0,-0.07375406);
   mainFit1036->SetParError(0,0.6691141);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.754138);
   mainFit1036->SetParError(1,0.02302873);
   ...
   pt_LaTex = pt->AddText("0.754#pm0.023");
   pt_LaTex = pt->AddText("#minus0.0738#pm0.669");
   pt_LaTex = pt->AddText("#minus0.0978#pm0.886");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.09779916,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.09779916,-31.12545,0.09779916,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.229664);
   ...
   mainFit1037->SetParameter(0,-0.07375406);
   mainFit1037->SetParError(0,0.6691141);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.754138);
   mainFit1037->SetParError(1,0.02302873);
