...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-48.00735);
   Graph_Graph01033->SetMaximum(48.57759);
   ...
   mainFit1034->SetChisquare(5.85204);
   ...
   mainFit1034->SetParameter(0,0.2845966);
   mainFit1034->SetParError(0,0.7997923);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7418323);
   mainFit1034->SetParError(1,0.02623501);
   ...
   pt_LaTex = pt->AddText("0.742#pm0.0262");
   pt_LaTex = pt->AddText("0.285#pm  0.8");
   pt_LaTex = pt->AddText("0.384#pm 1.08");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.38364,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.38364,-48.00735,-0.38364,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.85204);
   ...
   mainFit1035->SetParameter(0,0.2845966);
   mainFit1035->SetParError(0,0.7997923);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7418323);
   mainFit1035->SetParError(1,0.02623501);
