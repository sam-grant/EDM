...
//=========  (Fri Apr 23 19:00:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.00735);
   Graph_Graph01020->SetMaximum(48.57759);
   ...
   mainFit1021->SetChisquare(6.276227);
   ...
   mainFit1021->SetParameter(0,-0.02992551);
   mainFit1021->SetParError(0,0.6375415);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7520898);
   mainFit1021->SetParError(1,0.02098176);
   ...
   mainFit1022->SetChisquare(6.276227);
   ...
   mainFit1022->SetParameter(0,-0.02992551);
   mainFit1022->SetParError(0,0.6375415);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7520898);
   mainFit1022->SetParError(1,0.02098176);
