...
//=========  (Fri Apr 23 19:00:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-48.00735);
   Graph_Graph01027->SetMaximum(48.57759);
   ...
   mainFit1028->SetChisquare(1.115362);
   ...
   mainFit1028->SetParameter(0,0.6900126);
   mainFit1028->SetParError(0,0.7119621);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7753617);
   mainFit1028->SetParError(1,0.02334896);
   ...
   pt_LaTex = pt->AddText("0.775#pm0.0233");
   pt_LaTex = pt->AddText(" 0.69#pm0.712");
   pt_LaTex = pt->AddText(" 0.89#pm0.917");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8899235,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8899235,-48.00735,-0.8899235,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.115362);
   ...
   mainFit1029->SetParameter(0,0.6900126);
   mainFit1029->SetParError(0,0.7119621);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7753617);
   mainFit1029->SetParError(1,0.02334896);
