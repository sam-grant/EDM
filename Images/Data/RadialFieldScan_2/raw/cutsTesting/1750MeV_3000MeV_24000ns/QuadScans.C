...
//=========  (Fri Apr 23 19:00:56 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.009337);
   ...
   quadLineFit1002->SetParameter(0,75.00215);
   quadLineFit1002->SetParError(0,0.09569145);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.92423);
   quadLineFit1002->SetParError(1,1.604621);
   ...
   quadLineFit1003->SetChisquare(1.009337);
   ...
   quadLineFit1003->SetParameter(0,75.00215);
   quadLineFit1003->SetParError(0,0.09569145);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.92423);
   quadLineFit1003->SetParError(1,1.604621);
   ...
   Graph_30_ppm1003->SetMinimum(76.05379);
   Graph_30_ppm1003->SetMaximum(76.57666);
   ...
   quadLineFit1004->SetChisquare(1.34825);
   ...
   quadLineFit1004->SetParameter(0,75.08087);
   quadLineFit1004->SetParError(0,0.08184407);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.10467);
   quadLineFit1004->SetParError(1,1.345204);
   ...
   quadLineFit1005->SetChisquare(1.34825);
   ...
   quadLineFit1005->SetParameter(0,75.08087);
   quadLineFit1005->SetParError(0,0.08184407);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.10467);
   quadLineFit1005->SetParError(1,1.345204);
   ...
   Graph_10_ppm1005->SetMinimum(75.1172);
   Graph_10_ppm1005->SetMaximum(75.40855);
   ...
   quadLineFit1006->SetChisquare(0.2389876);
   ...
   quadLineFit1006->SetParameter(0,74.66129);
   quadLineFit1006->SetParError(0,0.0959767);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.691556);
   quadLineFit1006->SetParError(1,1.556502);
   ...
   quadLineFit1007->SetChisquare(0.2389876);
   ...
   quadLineFit1007->SetParameter(0,74.66129);
   quadLineFit1007->SetParError(0,0.0959767);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.691556);
   quadLineFit1007->SetParError(1,1.556502);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.10223);
   Graph_mI10_ppm1007->SetMaximum(74.36172);
   ...
   quadLineFit1008->SetChisquare(6.455001);
   ...
   quadLineFit1008->SetParameter(0,74.66768);
   quadLineFit1008->SetParError(0,0.08422665);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.214839);
   quadLineFit1008->SetParError(1,1.370881);
   ...
   quadLineFit1009->SetChisquare(6.455001);
   ...
   quadLineFit1009->SetParameter(0,74.66768);
   quadLineFit1009->SetParError(0,0.08422665);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.214839);
   quadLineFit1009->SetParError(1,1.370881);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.877);
   Graph_mI30_ppm1009->SetMaximum(73.48061);
   ...
   quadLineFit1010->SetChisquare(0.3367986);
   ...
   quadLineFit1010->SetParameter(0,74.60718);
   quadLineFit1010->SetParError(0,0.07969422);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.23216);
   quadLineFit1010->SetParError(1,1.379264);
   ...
   quadLineFit1011->SetChisquare(0.3367986);
   ...
   quadLineFit1011->SetParameter(0,74.60718);
   quadLineFit1011->SetParError(0,0.07969422);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.23216);
   quadLineFit1011->SetParError(1,1.379264);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.0474);
   Graph_mI50_ppm1011->SetMaximum(72.60227);
   ...
   quadLineFit1012->SetChisquare(0.7332294);
   ...
   quadLineFit1012->SetParameter(0,74.42811);
   quadLineFit1012->SetParError(0,0.1607375);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-37.08265);
   quadLineFit1012->SetParError(1,2.875954);
   ...
   quadLineFit1013->SetChisquare(0.7332294);
   ...
   quadLineFit1013->SetParameter(0,74.42811);
   quadLineFit1013->SetParError(0,0.1607375);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-37.08265);
   quadLineFit1013->SetParError(1,2.875954);
