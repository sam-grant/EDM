...
//=========  (Fri Apr 23 19:00:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-60.08047,75,60.65071);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-48.00735);
   Graph_Graph01023->SetMaximum(48.57759);
   ...
   mainFit1024->SetChisquare(6.276227);
   ...
   mainFit1024->SetParameter(0,-0.02992551);
   mainFit1024->SetParError(0,0.6375415);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7520898);
   mainFit1024->SetParError(1,0.02098176);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.57");
   pt_LaTex = pt->AddText("0.752#pm0.021");
   pt_LaTex = pt->AddText("#minus0.0299#pm0.638");
   pt_LaTex = pt->AddText("#minus0.0398#pm0.848");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.0397898,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.0397898,-48.00735,0.0397898,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.276227);
   ...
   mainFit1025->SetParameter(0,-0.02992551);
   mainFit1025->SetParError(0,0.6375415);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7520898);
   mainFit1025->SetParError(1,0.02098176);
