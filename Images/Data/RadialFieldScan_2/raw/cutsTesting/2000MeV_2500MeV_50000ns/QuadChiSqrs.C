...
//=========  (Thu Apr 22 01:00:28 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-0.1543957,75,1.988769);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01013->SetMinimum(0.05992079);
   Graph_Graph01013->SetMaximum(1.774452);
