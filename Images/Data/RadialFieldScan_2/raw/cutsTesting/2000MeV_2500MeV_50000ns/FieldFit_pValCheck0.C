...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-41.74374);
   Graph_Graph01025->SetMaximum(29.17036);
   ...
   mainFit1026->SetChisquare(1.299426);
   ...
   mainFit1026->SetParameter(0,1.251202);
   mainFit1026->SetParError(0,1.313954);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.6815609);
   mainFit1026->SetParError(1,0.05205515);
   ...
   pt_LaTex = pt->AddText("0.682#pm0.0521");
   pt_LaTex = pt->AddText(" 1.25#pm 1.31");
   pt_LaTex = pt->AddText(" 1.84#pm 1.92");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-1.835789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.835789,-41.74374,-1.835789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.299426);
   ...
   mainFit1027->SetParameter(0,1.251202);
   mainFit1027->SetParError(0,1.313954);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.6815609);
   mainFit1027->SetParError(1,0.05205515);
