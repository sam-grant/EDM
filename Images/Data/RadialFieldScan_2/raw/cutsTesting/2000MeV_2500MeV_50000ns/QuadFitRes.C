...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04236029);
   Graph_Graph11015->SetMaximum(0.02285329);
   ...
   Graph_Graph21016->SetMinimum(-0.02894961);
   Graph_Graph21016->SetMaximum(0.02458651);
   ...
   Graph_Graph31017->SetMinimum(-0.06343317);
   Graph_Graph31017->SetMaximum(0.0610372);
   ...
   Graph_Graph41018->SetMinimum(-0.04503007);
   Graph_Graph41018->SetMaximum(0.08634154);
   ...
   Graph_Graph51019->SetMinimum(-0.00643008);
   Graph_Graph51019->SetMaximum(0.00859447);
