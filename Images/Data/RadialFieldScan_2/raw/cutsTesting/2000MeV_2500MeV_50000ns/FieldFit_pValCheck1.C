...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-43.41987);
   Graph_Graph01027->SetMaximum(47.60787);
   ...
   mainFit1028->SetChisquare(0.8560529);
   ...
   mainFit1028->SetParameter(0,1.892232);
   mainFit1028->SetParError(0,1.365949);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7086244);
   mainFit1028->SetParError(1,0.04507892);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.285");
   pt_LaTex = pt->AddText("0.709#pm0.0451");
   pt_LaTex = pt->AddText(" 1.89#pm 1.37");
   pt_LaTex = pt->AddText(" 2.67#pm 1.92");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.670289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.670289,-43.41987,-2.670289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8560529);
   ...
   mainFit1029->SetParameter(0,1.892232);
   mainFit1029->SetParError(0,1.365949);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7086244);
   mainFit1029->SetParError(1,0.04507892);
