...
//=========  (Thu Apr 22 01:00:28 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.287893);
   ...
   quadLineFit1002->SetParameter(0,75.04913);
   quadLineFit1002->SetParError(0,0.1860944);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,36.90072);
   quadLineFit1002->SetParError(1,3.121509);
   ...
   quadLineFit1003->SetChisquare(1.287893);
   ...
   quadLineFit1003->SetParameter(0,75.04913);
   quadLineFit1003->SetParError(0,0.1860944);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,36.90072);
   quadLineFit1003->SetParError(1,3.121509);
   ...
   Graph_30_ppm1003->SetMinimum(76.01076);
   Graph_30_ppm1003->SetMaximum(76.60064);
   ...
   quadLineFit1004->SetChisquare(0.7607397);
   ...
   quadLineFit1004->SetParameter(0,75.02458);
   quadLineFit1004->SetParError(0,0.1563905);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.69063);
   quadLineFit1004->SetParError(1,2.570224);
   ...
   quadLineFit1005->SetChisquare(0.7607397);
   ...
   quadLineFit1005->SetParameter(0,75.02458);
   quadLineFit1005->SetParError(0,0.1563905);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.69063);
   quadLineFit1005->SetParError(1,2.570224);
   ...
   Graph_10_ppm1005->SetMinimum(75.03377);
   Graph_10_ppm1005->SetMaximum(75.37962);
   ...
   quadLineFit1006->SetChisquare(0.8495221);
   ...
   quadLineFit1006->SetParameter(0,74.57792);
   quadLineFit1006->SetParError(0,0.1832521);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.52294);
   quadLineFit1006->SetParError(1,2.972081);
   ...
   quadLineFit1007->SetChisquare(0.8495221);
   ...
   quadLineFit1007->SetParameter(0,74.57792);
   quadLineFit1007->SetParError(0,0.1832521);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.52294);
   quadLineFit1007->SetParError(1,2.972081);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.10849);
   Graph_mI10_ppm1007->SetMaximum(74.39601);
   ...
   quadLineFit1008->SetChisquare(3.183286);
   ...
   quadLineFit1008->SetParameter(0,74.56789);
   quadLineFit1008->SetParError(0,0.1609137);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.675515);
   quadLineFit1008->SetParError(1,2.618434);
   ...
   quadLineFit1009->SetChisquare(3.183286);
   ...
   quadLineFit1009->SetParameter(0,74.56789);
   quadLineFit1009->SetParError(0,0.1609137);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.675515);
   quadLineFit1009->SetParError(1,2.618434);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.82841);
   Graph_mI30_ppm1009->SetMaximum(73.45493);
   ...
   quadLineFit1010->SetChisquare(3.238382);
   ...
   quadLineFit1010->SetParameter(0,74.42865);
   quadLineFit1010->SetParError(0,0.1522705);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-20.52734);
   quadLineFit1010->SetParError(1,2.635264);
   ...
   quadLineFit1011->SetChisquare(3.238382);
   ...
   quadLineFit1011->SetParameter(0,74.42865);
   quadLineFit1011->SetParError(0,0.1522705);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-20.52734);
   quadLineFit1011->SetParError(1,2.635264);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.0587);
   Graph_mI50_ppm1011->SetMaximum(72.57074);
   ...
   quadLineFit1012->SetChisquare(0.06657866);
   ...
   quadLineFit1012->SetParameter(0,74.04933);
   quadLineFit1012->SetParError(0,0.3075489);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-30.33096);
   quadLineFit1012->SetParError(1,5.503271);
   ...
   quadLineFit1013->SetChisquare(0.06657866);
   ...
   quadLineFit1013->SetParameter(0,74.04933);
   quadLineFit1013->SetParError(0,0.3075489);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-30.33096);
   quadLineFit1013->SetParError(1,5.503271);
