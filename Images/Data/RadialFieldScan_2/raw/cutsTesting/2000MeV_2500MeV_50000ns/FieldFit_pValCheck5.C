...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-38.95882,70,55.81843);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-29.48109);
   Graph_Graph01035->SetMaximum(46.34071);
   ...
   mainFit1036->SetChisquare(1.074659);
   ...
   mainFit1036->SetParameter(0,1.197473);
   mainFit1036->SetParError(0,1.279335);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7042752);
   mainFit1036->SetParError(1,0.04428666);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.358");
   pt_LaTex = pt->AddText("0.704#pm0.0443");
   pt_LaTex = pt->AddText("  1.2#pm 1.28");
   pt_LaTex = pt->AddText("  1.7#pm 1.85");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-1.700292,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.700292,-29.48109,-1.700292,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.074659);
   ...
   mainFit1037->SetParameter(0,1.197473);
   mainFit1037->SetParError(0,1.279335);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7042752);
   mainFit1037->SetParError(1,0.04428666);
