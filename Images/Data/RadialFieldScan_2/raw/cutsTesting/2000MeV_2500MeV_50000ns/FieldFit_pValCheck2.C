...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-43.41987);
   Graph_Graph01029->SetMaximum(47.60787);
   ...
   mainFit1030->SetChisquare(0.792399);
   ...
   mainFit1030->SetParameter(0,1.012308);
   mainFit1030->SetParError(0,1.325986);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.6909434);
   mainFit1030->SetParError(1,0.04046176);
   ...
   pt_LaTex = pt->AddText("0.691#pm0.0405");
   pt_LaTex = pt->AddText(" 1.01#pm 1.33");
   pt_LaTex = pt->AddText(" 1.47#pm 1.93");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.465109,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.465109,-43.41987,-1.465109,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.792399);
   ...
   mainFit1031->SetParameter(0,1.012308);
   mainFit1031->SetParError(0,1.325986);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.6909434);
   mainFit1031->SetParError(1,0.04046176);
