...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-43.41987);
   Graph_Graph01031->SetMaximum(47.60787);
   ...
   mainFit1032->SetChisquare(1.423402);
   ...
   mainFit1032->SetParameter(0,1.479326);
   mainFit1032->SetParError(0,1.405371);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.6925936);
   mainFit1032->SetParError(1,0.04176326);
   ...
   pt_LaTex = pt->AddText("0.693#pm0.0418");
   pt_LaTex = pt->AddText(" 1.48#pm 1.41");
   pt_LaTex = pt->AddText(" 2.14#pm 2.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.135923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.135923,-43.41987,-2.135923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.423402);
   ...
   mainFit1033->SetParameter(0,1.479326);
   mainFit1033->SetParError(0,1.405371);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.6925936);
   mainFit1033->SetParError(1,0.04176326);
