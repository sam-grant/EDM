...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-43.41987);
   Graph_Graph01033->SetMaximum(47.60787);
   ...
   mainFit1034->SetChisquare(1.051192);
   ...
   mainFit1034->SetParameter(0,1.99326);
   mainFit1034->SetParError(0,1.528639);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.6747794);
   mainFit1034->SetParError(1,0.05045475);
   ...
   pt_LaTex = pt->AddText("0.675#pm0.0505");
   pt_LaTex = pt->AddText(" 1.99#pm 1.53");
   pt_LaTex = pt->AddText(" 2.95#pm 2.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.953943,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.953943,-43.41987,-2.953943,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.051192);
   ...
   mainFit1035->SetParameter(0,1.99326);
   mainFit1035->SetParError(0,1.528639);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.6747794);
   mainFit1035->SetParError(1,0.05045475);
