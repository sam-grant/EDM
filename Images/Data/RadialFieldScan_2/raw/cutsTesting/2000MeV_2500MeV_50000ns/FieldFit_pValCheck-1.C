...
//=========  (Thu Apr 22 01:00:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-43.41987);
   Graph_Graph01023->SetMaximum(47.60787);
   ...
   mainFit1024->SetChisquare(1.429027);
   ...
   mainFit1024->SetParameter(0,1.426987);
   mainFit1024->SetParError(0,1.219855);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.6934028);
   mainFit1024->SetParError(1,0.04034521);
   ...
   mainFit1025->SetChisquare(1.429027);
   ...
   mainFit1025->SetParameter(0,1.426987);
   mainFit1025->SetParError(0,1.219855);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.6934028);
   mainFit1025->SetParError(1,0.04034521);
