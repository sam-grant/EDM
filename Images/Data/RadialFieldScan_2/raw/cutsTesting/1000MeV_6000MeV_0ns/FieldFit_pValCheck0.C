...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.65378,50,44.85937);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.30246);
   Graph_Graph01025->SetMaximum(33.50806);
   ...
   mainFit1026->SetChisquare(1.956323);
   ...
   mainFit1026->SetParameter(0,-1.564291);
   mainFit1026->SetParError(0,0.395623);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9082881);
   mainFit1026->SetParError(1,0.01566694);
   ...
   pt_LaTex = pt->AddText("0.908#pm0.0157");
   pt_LaTex = pt->AddText("#minus1.56#pm0.396");
   pt_LaTex = pt->AddText("#minus1.72#pm 0.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.72224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.72224,-57.30246,1.72224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.956323);
   ...
   mainFit1027->SetParameter(0,-1.564291);
   mainFit1027->SetParError(0,0.395623);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9082881);
   mainFit1027->SetParError(1,0.01566694);
