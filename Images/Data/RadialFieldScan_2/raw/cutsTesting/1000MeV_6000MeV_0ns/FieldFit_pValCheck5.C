...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.50149,70,63.4919);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.30215);
   Graph_Graph01035->SetMaximum(52.29256);
   ...
   mainFit1036->SetChisquare(1.407277);
   ...
   mainFit1036->SetParameter(0,-1.472468);
   mainFit1036->SetParError(0,0.3845941);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9046091);
   mainFit1036->SetParError(1,0.01325839);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.469");
   pt_LaTex = pt->AddText("0.905#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.47#pm0.385");
   pt_LaTex = pt->AddText("#minus1.63#pm0.419");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.62774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.62774,-37.30215,1.62774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.407277);
   ...
   mainFit1037->SetParameter(0,-1.472468);
   mainFit1037->SetParError(0,0.3845941);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9046091);
   mainFit1037->SetParError(1,0.01325839);
