...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.19104);
   Graph_Graph01023->SetMaximum(54.28246);
   ...
   mainFit1024->SetChisquare(1.957723);
   ...
   mainFit1024->SetParameter(0,-1.558724);
   mainFit1024->SetParError(0,0.3666007);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9086614);
   mainFit1024->SetParError(1,0.01208105);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.56#pm0.367");
   pt_LaTex = pt->AddText("#minus1.72#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.715407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.715407,-59.19104,1.715407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.957723);
   ...
   mainFit1025->SetParameter(0,-1.558724);
   mainFit1025->SetParError(0,0.3666007);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9086614);
   mainFit1025->SetParError(1,0.01208105);
