...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.19104);
   Graph_Graph01033->SetMaximum(54.28246);
   ...
   mainFit1034->SetChisquare(1.796479);
   ...
   mainFit1034->SetParameter(0,-1.447228);
   mainFit1034->SetParError(0,0.4598836);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9050172);
   mainFit1034->SetParError(1,0.01511009);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.45#pm 0.46");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.496");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.599117,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.599117,-59.19104,1.599117,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.796479);
   ...
   mainFit1035->SetParameter(0,-1.447228);
   mainFit1035->SetParError(0,0.4598836);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9050172);
   mainFit1035->SetParError(1,0.01511009);
