...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.19104);
   Graph_Graph01027->SetMaximum(54.28246);
   ...
   mainFit1028->SetChisquare(1.200132);
   ...
   mainFit1028->SetParameter(0,-1.39966);
   mainFit1028->SetParError(0,0.4096265);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.91382);
   mainFit1028->SetParError(1,0.0134567);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.4");
   pt_LaTex = pt->AddText("0.914#pm0.0135");
   pt_LaTex = pt->AddText(" #minus1.4#pm 0.41");
   pt_LaTex = pt->AddText("#minus1.53#pm 0.45");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.531658,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.531658,-59.19104,1.531658,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.200132);
   ...
   mainFit1029->SetParameter(0,-1.39966);
   mainFit1029->SetParError(0,0.4096265);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.91382);
   mainFit1029->SetParError(1,0.0134567);
