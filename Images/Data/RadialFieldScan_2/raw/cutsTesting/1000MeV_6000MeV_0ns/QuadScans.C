...
//=========  (Thu Apr 22 09:29:46 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.062535);
   ...
   quadLineFit1002->SetParameter(0,74.64777);
   quadLineFit1002->SetParError(0,0.05531965);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.89899);
   quadLineFit1002->SetParError(1,0.9273456);
   ...
   quadLineFit1003->SetChisquare(4.062535);
   ...
   quadLineFit1003->SetParameter(0,74.64777);
   quadLineFit1003->SetParError(0,0.05531965);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.89899);
   quadLineFit1003->SetParError(1,0.9273456);
   ...
   Graph_30_ppm1003->SetMinimum(75.86439);
   Graph_30_ppm1003->SetMaximum(76.49706);
   ...
   quadLineFit1004->SetChisquare(0.6023941);
   ...
   quadLineFit1004->SetParameter(0,74.63296);
   quadLineFit1004->SetParError(0,0.04719571);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.1652);
   quadLineFit1004->SetParError(1,0.7753106);
   ...
   quadLineFit1005->SetChisquare(0.6023941);
   ...
   quadLineFit1005->SetParameter(0,74.63296);
   quadLineFit1005->SetParError(0,0.04719571);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.1652);
   quadLineFit1005->SetParError(1,0.7753106);
   ...
   Graph_10_ppm1005->SetMinimum(74.92204);
   Graph_10_ppm1005->SetMaximum(75.15383);
   ...
   quadLineFit1006->SetChisquare(5.275158);
   ...
   quadLineFit1006->SetParameter(0,74.53399);
   quadLineFit1006->SetParError(0,0.05522873);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.959144);
   quadLineFit1006->SetParError(1,0.8952918);
   ...
   quadLineFit1007->SetChisquare(5.275158);
   ...
   quadLineFit1007->SetParameter(0,74.53399);
   quadLineFit1007->SetParError(0,0.05522873);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.959144);
   quadLineFit1007->SetParError(1,0.8952918);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.74183);
   Graph_mI10_ppm1007->SetMaximum(74.03346);
   ...
   quadLineFit1008->SetChisquare(5.581969);
   ...
   quadLineFit1008->SetParameter(0,74.48858);
   quadLineFit1008->SetParError(0,0.04842831);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.971981);
   quadLineFit1008->SetParError(1,0.7878412);
   ...
   quadLineFit1009->SetChisquare(5.581969);
   ...
   quadLineFit1009->SetParameter(0,74.48858);
   quadLineFit1009->SetParError(0,0.04842831);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.971981);
   quadLineFit1009->SetParError(1,0.7878412);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.36746);
   Graph_mI30_ppm1009->SetMaximum(73.09917);
   ...
   quadLineFit1010->SetChisquare(0.7158502);
   ...
   quadLineFit1010->SetParameter(0,74.52254);
   quadLineFit1010->SetParError(0,0.04575344);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.04456);
   quadLineFit1010->SetParError(1,0.7913595);
   ...
   quadLineFit1011->SetChisquare(0.7158502);
   ...
   quadLineFit1011->SetParameter(0,74.52254);
   quadLineFit1011->SetParError(0,0.04575344);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.04456);
   quadLineFit1011->SetParError(1,0.7913595);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.46534);
   Graph_mI50_ppm1011->SetMaximum(72.14305);
   ...
   quadLineFit1012->SetChisquare(1.306805);
   ...
   quadLineFit1012->SetParameter(0,74.54739);
   quadLineFit1012->SetParError(0,0.09239729);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.0821);
   quadLineFit1012->SetParError(1,1.65282);
   ...
   quadLineFit1013->SetChisquare(1.306805);
   ...
   quadLineFit1013->SetParameter(0,74.54739);
   quadLineFit1013->SetParError(0,0.09239729);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.0821);
   quadLineFit1013->SetParError(1,1.65282);
