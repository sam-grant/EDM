...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007088272);
   Graph_Graph11015->SetMaximum(0.007869543);
   ...
   Graph_Graph21016->SetMinimum(-0.01841286);
   Graph_Graph21016->SetMaximum(0.02162568);
   ...
   Graph_Graph31017->SetMinimum(-0.02578055);
   Graph_Graph31017->SetMaximum(0.02258062);
   ...
   Graph_Graph41018->SetMinimum(-0.006323997);
   Graph_Graph41018->SetMaximum(0.007172419);
   ...
   Graph_Graph51019->SetMinimum(-0.008598612);
   Graph_Graph51019->SetMaximum(0.01146198);
