...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.19104);
   Graph_Graph01029->SetMaximum(54.28246);
   ...
   mainFit1030->SetChisquare(1.678951);
   ...
   mainFit1030->SetParameter(0,-1.640886);
   mainFit1030->SetParError(0,0.3982616);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9081887);
   mainFit1030->SetParError(1,0.0121141);
   ...
   pt_LaTex = pt->AddText("0.908#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.64#pm0.398");
   pt_LaTex = pt->AddText("#minus1.81#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.806768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.806768,-59.19104,1.806768,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.678951);
   ...
   mainFit1031->SetParameter(0,-1.640886);
   mainFit1031->SetParError(0,0.3982616);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9081887);
   mainFit1031->SetParError(1,0.0121141);
