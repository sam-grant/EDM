...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.19104);
   Graph_Graph01020->SetMaximum(54.28246);
   ...
   mainFit1021->SetChisquare(1.957723);
   ...
   mainFit1021->SetParameter(0,-1.558724);
   mainFit1021->SetParError(0,0.3666007);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9086614);
   mainFit1021->SetParError(1,0.01208105);
   ...
   mainFit1022->SetChisquare(1.957723);
   ...
   mainFit1022->SetParameter(0,-1.558724);
   mainFit1022->SetParError(0,0.3666007);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9086614);
   mainFit1022->SetParError(1,0.01208105);
