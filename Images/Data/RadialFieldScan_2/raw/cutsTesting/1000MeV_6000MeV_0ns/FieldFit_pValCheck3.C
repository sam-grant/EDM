...
//=========  (Thu Apr 22 09:29:47 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.37523,75,68.46665);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-59.19104);
   Graph_Graph01031->SetMaximum(54.28246);
   ...
   mainFit1032->SetChisquare(0.9658379);
   ...
   mainFit1032->SetParameter(0,-1.767436);
   mainFit1032->SetParError(0,0.4222706);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9118854);
   mainFit1032->SetParError(1,0.01250723);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.322");
   pt_LaTex = pt->AddText("0.912#pm0.0125");
   pt_LaTex = pt->AddText("#minus1.77#pm0.422");
   pt_LaTex = pt->AddText("#minus1.94#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.938222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.938222,-59.19104,1.938222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.9658379);
   ...
   mainFit1033->SetParameter(0,-1.767436);
   mainFit1033->SetParError(0,0.4222706);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9118854);
   mainFit1033->SetParError(1,0.01250723);
