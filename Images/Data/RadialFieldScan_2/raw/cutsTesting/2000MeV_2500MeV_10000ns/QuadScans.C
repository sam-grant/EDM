...
//=========  (Thu Apr 22 00:18:23 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.630288);
   ...
   quadLineFit1002->SetParameter(0,74.93289);
   quadLineFit1002->SetParError(0,0.1263135);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.99856);
   quadLineFit1002->SetParError(1,2.118802);
   ...
   quadLineFit1003->SetChisquare(1.630288);
   ...
   quadLineFit1003->SetParameter(0,74.93289);
   quadLineFit1003->SetParError(0,0.1263135);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.99856);
   quadLineFit1003->SetParError(1,2.118802);
   ...
   Graph_30_ppm1003->SetMinimum(75.97736);
   Graph_30_ppm1003->SetMaximum(76.5874);
   ...
   quadLineFit1004->SetChisquare(0.8426356);
   ...
   quadLineFit1004->SetParameter(0,74.8471);
   quadLineFit1004->SetParError(0,0.1062688);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.25157);
   quadLineFit1004->SetParError(1,1.746501);
   ...
   quadLineFit1005->SetChisquare(0.8426356);
   ...
   quadLineFit1005->SetParameter(0,74.8471);
   quadLineFit1005->SetParError(0,0.1062688);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.25157);
   quadLineFit1005->SetParError(1,1.746501);
   ...
   Graph_10_ppm1005->SetMinimum(75.0748);
   Graph_10_ppm1005->SetMaximum(75.35988);
   ...
   quadLineFit1006->SetChisquare(0.02954791);
   ...
   quadLineFit1006->SetParameter(0,74.67051);
   quadLineFit1006->SetParError(0,0.1245376);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.840769);
   quadLineFit1006->SetParError(1,2.019517);
   ...
   quadLineFit1007->SetChisquare(0.02954791);
   ...
   quadLineFit1007->SetParameter(0,74.67051);
   quadLineFit1007->SetParError(0,0.1245376);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.840769);
   quadLineFit1007->SetParError(1,2.019517);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.06369);
   Graph_mI10_ppm1007->SetMaximum(74.35434);
   ...
   quadLineFit1008->SetChisquare(1.59914);
   ...
   quadLineFit1008->SetParameter(0,74.69752);
   quadLineFit1008->SetParError(0,0.1093194);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.224608);
   quadLineFit1008->SetParError(1,1.779037);
   ...
   quadLineFit1009->SetChisquare(1.59914);
   ...
   quadLineFit1009->SetParameter(0,74.69752);
   quadLineFit1009->SetParError(0,0.1093194);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.224608);
   quadLineFit1009->SetParError(1,1.779037);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.80411);
   Graph_mI30_ppm1009->SetMaximum(73.4777);
   ...
   quadLineFit1010->SetChisquare(0.6448378);
   ...
   quadLineFit1010->SetParameter(0,74.67852);
   quadLineFit1010->SetParError(0,0.1033966);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.83472);
   quadLineFit1010->SetParError(1,1.789271);
   ...
   quadLineFit1011->SetChisquare(0.6448378);
   ...
   quadLineFit1011->SetParameter(0,74.67852);
   quadLineFit1011->SetParError(0,0.1033966);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.83472);
   quadLineFit1011->SetParError(1,1.789271);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.05787);
   Graph_mI50_ppm1011->SetMaximum(72.55398);
   ...
   quadLineFit1012->SetChisquare(1.238491);
   ...
   quadLineFit1012->SetParameter(0,74.12813);
   quadLineFit1012->SetParError(0,0.2086483);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-31.72744);
   quadLineFit1012->SetParError(1,3.733248);
   ...
   quadLineFit1013->SetChisquare(1.238491);
   ...
   quadLineFit1013->SetParameter(0,74.12813);
   quadLineFit1013->SetParError(0,0.2086483);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-31.72744);
   quadLineFit1013->SetParError(1,3.733248);
