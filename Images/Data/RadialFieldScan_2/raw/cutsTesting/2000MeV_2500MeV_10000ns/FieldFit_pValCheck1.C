...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-43.11849);
   Graph_Graph01027->SetMaximum(48.77516);
   ...
   mainFit1028->SetChisquare(4.662816);
   ...
   mainFit1028->SetParameter(0,0.1494995);
   mainFit1028->SetParError(0,0.927657);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7721833);
   mainFit1028->SetParError(1,0.03059929);
   ...
   pt_LaTex = pt->AddText("0.772#pm0.0306");
   pt_LaTex = pt->AddText("0.149#pm0.928");
   pt_LaTex = pt->AddText("0.194#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1936062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1936062,-43.11849,-0.1936062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.662816);
   ...
   mainFit1029->SetParameter(0,0.1494995);
   mainFit1029->SetParError(0,0.927657);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7721833);
   mainFit1029->SetParError(1,0.03059929);
