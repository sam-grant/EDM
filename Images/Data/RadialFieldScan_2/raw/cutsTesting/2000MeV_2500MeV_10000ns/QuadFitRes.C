...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01950557);
   Graph_Graph11015->SetMaximum(0.02140402);
   ...
   Graph_Graph21016->SetMinimum(-0.003115103);
   Graph_Graph21016->SetMaximum(0.003662682);
   ...
   Graph_Graph31017->SetMinimum(-0.0306683);
   Graph_Graph31017->SetMaximum(0.02913395);
   ...
   Graph_Graph41018->SetMinimum(-0.01547125);
   Graph_Graph41018->SetMaximum(0.02613729);
   ...
   Graph_Graph51019->SetMinimum(-0.01885008);
   Graph_Graph51019->SetMaximum(0.02518185);
