...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-43.11849);
   Graph_Graph01023->SetMaximum(48.77516);
   ...
   mainFit1024->SetChisquare(4.663642);
   ...
   mainFit1024->SetParameter(0,0.1375112);
   mainFit1024->SetParError(0,0.8285049);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7717915);
   mainFit1024->SetParError(1,0.02739108);
   ...
   pt_LaTex = pt->AddText("0.772#pm0.0274");
   pt_LaTex = pt->AddText("0.138#pm0.829");
   pt_LaTex = pt->AddText("0.178#pm 1.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1781715,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1781715,-43.11849,-0.1781715,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.663642);
   ...
   mainFit1025->SetParameter(0,0.1375112);
   mainFit1025->SetParError(0,0.8285049);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7717915);
   mainFit1025->SetParError(1,0.02739108);
