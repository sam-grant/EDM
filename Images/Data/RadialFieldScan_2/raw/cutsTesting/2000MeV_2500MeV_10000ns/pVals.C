...
//=========  (Thu Apr 22 00:18:25 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,0.02115968,8.5,1.083516);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(0.1273954);
   Graph_Graph01037->SetMaximum(0.9772808);
