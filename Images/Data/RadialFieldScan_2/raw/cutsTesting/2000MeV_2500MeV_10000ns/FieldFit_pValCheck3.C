...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-43.11849);
   Graph_Graph01031->SetMaximum(48.77516);
   ...
   mainFit1032->SetChisquare(4.485548);
   ...
   mainFit1032->SetParameter(0,0.3374077);
   mainFit1032->SetParError(0,0.9543526);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7687042);
   mainFit1032->SetParError(1,0.02835123);
   ...
   pt_LaTex = pt->AddText("0.769#pm0.0284");
   pt_LaTex = pt->AddText("0.337#pm0.954");
   pt_LaTex = pt->AddText("0.439#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4389305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4389305,-43.11849,-0.4389305,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.485548);
   ...
   mainFit1033->SetParameter(0,0.3374077);
   mainFit1033->SetParError(0,0.9543526);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7687042);
   mainFit1033->SetParError(1,0.02835123);
