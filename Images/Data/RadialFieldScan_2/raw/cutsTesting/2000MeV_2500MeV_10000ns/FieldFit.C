...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-43.11849);
   Graph_Graph01020->SetMaximum(48.77516);
   ...
   mainFit1021->SetChisquare(4.663642);
   ...
   mainFit1021->SetParameter(0,0.1375112);
   mainFit1021->SetParError(0,0.8285049);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7717915);
   mainFit1021->SetParError(1,0.02739108);
   ...
   mainFit1022->SetChisquare(4.663642);
   ...
   mainFit1022->SetParameter(0,0.1375112);
   mainFit1022->SetParError(0,0.8285049);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7717915);
   mainFit1022->SetParError(1,0.02739108);
