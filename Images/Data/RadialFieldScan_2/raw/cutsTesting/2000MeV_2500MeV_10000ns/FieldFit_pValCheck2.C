...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-54.6052,75,60.26187);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-43.11849);
   Graph_Graph01029->SetMaximum(48.77516);
   ...
   mainFit1030->SetChisquare(4.377266);
   ...
   mainFit1030->SetParameter(0,-0.05132145);
   mainFit1030->SetParError(0,0.9005293);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7706728);
   mainFit1030->SetParError(1,0.02747027);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.46");
   pt_LaTex = pt->AddText("0.771#pm0.0275");
   pt_LaTex = pt->AddText("#minus0.0513#pm0.901");
   pt_LaTex = pt->AddText("#minus0.0666#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.06659304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.06659304,-43.11849,0.06659304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.377266);
   ...
   mainFit1031->SetParameter(0,-0.05132145);
   mainFit1031->SetParError(0,0.9005293);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7706728);
   mainFit1031->SetParError(1,0.02747027);
