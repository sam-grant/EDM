...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.55932,70,58.0527);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.39812);
   Graph_Graph01035->SetMaximum(47.89149);
   ...
   mainFit1036->SetChisquare(0.5558669);
   ...
   mainFit1036->SetParameter(0,-0.393729);
   mainFit1036->SetParError(0,0.8689783);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7969456);
   mainFit1036->SetParError(1,0.03007163);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.185");
   pt_LaTex = pt->AddText("0.797#pm0.0301");
   pt_LaTex = pt->AddText("#minus0.394#pm0.869");
   pt_LaTex = pt->AddText("#minus0.494#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4940475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4940475,-33.39812,0.4940475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.5558669);
   ...
   mainFit1037->SetParameter(0,-0.393729);
   mainFit1037->SetParError(0,0.8689783);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7969456);
   mainFit1037->SetParError(1,0.03007163);
