...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-43.11849);
   Graph_Graph01033->SetMaximum(48.77516);
   ...
   mainFit1034->SetChisquare(2.622274);
   ...
   mainFit1034->SetParameter(0,1.031488);
   mainFit1034->SetParError(0,1.038229);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7424105);
   mainFit1034->SetParError(1,0.03425123);
   ...
   pt_LaTex = pt->AddText("0.742#pm0.0343");
   pt_LaTex = pt->AddText(" 1.03#pm 1.04");
   pt_LaTex = pt->AddText(" 1.39#pm 1.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.389377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.389377,-43.11849,-1.389377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.622274);
   ...
   mainFit1035->SetParameter(0,1.031488);
   mainFit1035->SetParError(0,1.038229);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7424105);
   mainFit1035->SetParError(1,0.03425123);
