...
//=========  (Thu Apr 22 00:18:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-50.57537,50,40.11276);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-41.50656);
   Graph_Graph01025->SetMaximum(31.04394);
   ...
   mainFit1026->SetChisquare(4.631512);
   ...
   mainFit1026->SetParameter(0,0.07794836);
   mainFit1026->SetParError(0,0.8926378);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7677821);
   mainFit1026->SetParError(1,0.03535222);
   ...
   pt_LaTex = pt->AddText("0.768#pm0.0354");
   pt_LaTex = pt->AddText("0.0779#pm0.893");
   pt_LaTex = pt->AddText("0.102#pm 1.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.1015241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1015241,-41.50656,-0.1015241,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.631512);
   ...
   mainFit1027->SetParameter(0,0.07794836);
   mainFit1027->SetParError(0,0.8926378);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7677821);
   mainFit1027->SetParError(1,0.03535222);
