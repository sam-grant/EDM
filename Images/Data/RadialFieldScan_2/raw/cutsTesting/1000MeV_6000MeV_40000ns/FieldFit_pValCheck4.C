...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.66094);
   Graph_Graph01033->SetMaximum(53.34348);
   ...
   mainFit1034->SetChisquare(6.71788);
   ...
   mainFit1034->SetParameter(0,-0.6065344);
   mainFit1034->SetParError(0,0.6712843);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8388543);
   mainFit1034->SetParError(1,0.02214663);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.0221");
   pt_LaTex = pt->AddText("#minus0.607#pm0.671");
   pt_LaTex = pt->AddText("#minus0.723#pm0.792");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.723051,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.723051,-55.66094,0.723051,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.71788);
   ...
   mainFit1035->SetParameter(0,-0.6065344);
   mainFit1035->SetParError(0,0.6712843);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8388543);
   mainFit1035->SetParError(1,0.02214663);
