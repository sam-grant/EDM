...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.66094);
   Graph_Graph01023->SetMaximum(53.34348);
   ...
   mainFit1024->SetChisquare(6.734018);
   ...
   mainFit1024->SetParameter(0,-0.6579153);
   mainFit1024->SetParError(0,0.5357482);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.840543);
   mainFit1024->SetParError(1,0.01771286);
   ...
   mainFit1025->SetChisquare(6.734018);
   ...
   mainFit1025->SetParameter(0,-0.6579153);
   mainFit1025->SetParError(0,0.5357482);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.840543);
   mainFit1025->SetParError(1,0.01771286);
