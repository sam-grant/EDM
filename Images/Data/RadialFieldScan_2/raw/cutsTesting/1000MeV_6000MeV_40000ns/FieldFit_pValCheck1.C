...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.66094);
   Graph_Graph01027->SetMaximum(53.34348);
   ...
   mainFit1028->SetChisquare(0.5001389);
   ...
   mainFit1028->SetParameter(0,0.01598084);
   mainFit1028->SetParError(0,0.5998965);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8625723);
   mainFit1028->SetParError(1,0.0197887);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.167");
   pt_LaTex = pt->AddText("0.863#pm0.0198");
   pt_LaTex = pt->AddText("0.016#pm  0.6");
   pt_LaTex = pt->AddText("0.0185#pm0.695");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.01852696,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.01852696,-55.66094,-0.01852696,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5001389);
   ...
   mainFit1029->SetParameter(0,0.01598084);
   mainFit1029->SetParError(0,0.5998965);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8625723);
   mainFit1029->SetParError(1,0.0197887);
