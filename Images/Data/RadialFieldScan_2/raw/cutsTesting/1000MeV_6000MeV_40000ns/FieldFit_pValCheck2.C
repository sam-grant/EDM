...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.66094);
   Graph_Graph01029->SetMaximum(53.34348);
   ...
   mainFit1030->SetChisquare(6.254889);
   ...
   mainFit1030->SetParameter(0,-0.8158915);
   mainFit1030->SetParError(0,0.5823369);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8396093);
   mainFit1030->SetParError(1,0.017764);
   ...
   pt_LaTex = pt->AddText(" 0.84#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.816#pm0.582");
   pt_LaTex = pt->AddText("#minus0.972#pm0.691");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9717514,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9717514,-55.66094,0.9717514,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.254889);
   ...
   mainFit1031->SetParameter(0,-0.8158915);
   mainFit1031->SetParError(0,0.5823369);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8396093);
   mainFit1031->SetParError(1,0.017764);
