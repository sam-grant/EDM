...
//=========  (Thu Apr 22 10:16:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01297664);
   Graph_Graph11015->SetMaximum(0.0406093);
   ...
   Graph_Graph21016->SetMinimum(-0.01139059);
   Graph_Graph21016->SetMaximum(0.01343724);
   ...
   Graph_Graph31017->SetMinimum(-0.03117206);
   Graph_Graph31017->SetMaximum(0.02435815);
   ...
   Graph_Graph41018->SetMinimum(-0.01859688);
   Graph_Graph41018->SetMaximum(0.02289759);
   ...
   Graph_Graph51019->SetMinimum(-0.004045129);
   Graph_Graph51019->SetMaximum(0.005409012);
