...
//=========  (Thu Apr 22 10:16:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.2865,75,66.96903);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-55.66094);
   Graph_Graph01020->SetMaximum(53.34348);
   ...
   mainFit1021->SetChisquare(6.734018);
   ...
   mainFit1021->SetParameter(0,-0.6579153);
   mainFit1021->SetParError(0,0.5357482);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.840543);
   mainFit1021->SetParError(1,0.01771286);
   ...
   pt_LaTex = pt->AddText("0.841#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.658#pm0.536");
   pt_LaTex = pt->AddText("#minus0.783#pm0.635");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7827266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7827266,-55.66094,0.7827266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.734018);
   ...
   mainFit1022->SetParameter(0,-0.6579153);
   mainFit1022->SetParError(0,0.5357482);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.840543);
   mainFit1022->SetParError(1,0.01771286);
