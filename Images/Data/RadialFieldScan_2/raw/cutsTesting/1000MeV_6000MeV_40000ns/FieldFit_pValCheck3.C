...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.66094);
   Graph_Graph01031->SetMaximum(53.34348);
   ...
   mainFit1032->SetChisquare(5.617545);
   ...
   mainFit1032->SetParameter(0,-0.9815658);
   mainFit1032->SetParError(0,0.6171289);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8455434);
   mainFit1032->SetParError(1,0.01833414);
   ...
   pt_LaTex = pt->AddText("0.846#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.982#pm0.617");
   pt_LaTex = pt->AddText("#minus1.16#pm0.724");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.16087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.16087,-55.66094,1.16087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.617545);
   ...
   mainFit1033->SetParameter(0,-0.9815658);
   mainFit1033->SetParError(0,0.6171289);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8455434);
   mainFit1033->SetParError(1,0.01833414);
