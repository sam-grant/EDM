...
//=========  (Thu Apr 22 10:16:45 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.009975683);
   ...
   quadLineFit1002->SetParameter(0,74.64182);
   quadLineFit1002->SetParError(0,0.08168912);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.88947);
   quadLineFit1002->SetParError(1,1.370306);
   ...
   quadLineFit1003->SetChisquare(0.009975683);
   ...
   quadLineFit1003->SetParameter(0,74.64182);
   quadLineFit1003->SetParError(0,0.08168912);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.88947);
   quadLineFit1003->SetParError(1,1.370306);
   ...
   Graph_30_ppm1003->SetMinimum(75.85384);
   Graph_30_ppm1003->SetMaximum(76.42997);
   ...
   quadLineFit1004->SetChisquare(2.827779);
   ...
   quadLineFit1004->SetParameter(0,74.77906);
   quadLineFit1004->SetParError(0,0.06868812);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.32897);
   quadLineFit1004->SetParError(1,1.129003);
   ...
   quadLineFit1005->SetChisquare(2.827779);
   ...
   quadLineFit1005->SetParameter(0,74.77906);
   quadLineFit1005->SetParError(0,0.06868812);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.32897);
   quadLineFit1005->SetParError(1,1.129003);
   ...
   Graph_10_ppm1005->SetMinimum(74.92375);
   Graph_10_ppm1005->SetMaximum(75.18152);
   ...
   quadLineFit1006->SetChisquare(0.94585);
   ...
   quadLineFit1006->SetParameter(0,74.51632);
   quadLineFit1006->SetParError(0,0.0804956);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.571491);
   quadLineFit1006->SetParError(1,1.305658);
   ...
   quadLineFit1007->SetChisquare(0.94585);
   ...
   quadLineFit1007->SetParameter(0,74.51632);
   quadLineFit1007->SetParError(0,0.0804956);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.571491);
   quadLineFit1007->SetParError(1,1.305658);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80845);
   Graph_mI10_ppm1007->SetMaximum(74.07063);
   ...
   quadLineFit1008->SetChisquare(3.940013);
   ...
   quadLineFit1008->SetParameter(0,74.42084);
   quadLineFit1008->SetParError(0,0.07067679);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.020293);
   quadLineFit1008->SetParError(1,1.150453);
   ...
   quadLineFit1009->SetChisquare(3.940013);
   ...
   quadLineFit1009->SetParameter(0,74.42084);
   quadLineFit1009->SetParError(0,0.07067679);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.020293);
   quadLineFit1009->SetParError(1,1.150453);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.4573);
   Graph_mI30_ppm1009->SetMaximum(73.13268);
   ...
   quadLineFit1010->SetChisquare(2.510453);
   ...
   quadLineFit1010->SetParameter(0,74.4053);
   quadLineFit1010->SetParError(0,0.06686868);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.97881);
   quadLineFit1010->SetParError(1,1.15735);
   ...
   quadLineFit1011->SetChisquare(2.510453);
   ...
   quadLineFit1011->SetParameter(0,74.4053);
   quadLineFit1011->SetParError(0,0.06686868);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.97881);
   quadLineFit1011->SetParError(1,1.15735);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.57746);
   Graph_mI50_ppm1011->SetMaximum(72.21735);
   ...
   quadLineFit1012->SetChisquare(0.1367802);
   ...
   quadLineFit1012->SetParameter(0,74.41482);
   quadLineFit1012->SetParError(0,0.1348802);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.16388);
   quadLineFit1012->SetParError(1,2.413365);
   ...
   quadLineFit1013->SetChisquare(0.1367802);
   ...
   quadLineFit1013->SetParameter(0,74.41482);
   quadLineFit1013->SetParError(0,0.1348802);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.16388);
   quadLineFit1013->SetParError(1,2.413365);
