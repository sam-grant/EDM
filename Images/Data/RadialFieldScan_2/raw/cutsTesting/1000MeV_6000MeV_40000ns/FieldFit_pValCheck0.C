...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.08605,50,40.96678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.58076);
   Graph_Graph01025->SetMaximum(30.4615);
   ...
   mainFit1026->SetChisquare(4.325991);
   ...
   mainFit1026->SetParameter(0,-0.9911262);
   mainFit1026->SetParError(0,0.5771622);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8181108);
   mainFit1026->SetParError(1,0.02285733);
   ...
   pt_LaTex = pt->AddText("0.818#pm0.0229");
   pt_LaTex = pt->AddText("#minus0.991#pm0.577");
   pt_LaTex = pt->AddText("#minus1.21#pm 0.71");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.211482,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.211482,-53.58076,1.211482,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.325991);
   ...
   mainFit1027->SetParameter(0,-0.9911262);
   mainFit1027->SetParError(0,0.5771622);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8181108);
   mainFit1027->SetParError(1,0.02285733);
