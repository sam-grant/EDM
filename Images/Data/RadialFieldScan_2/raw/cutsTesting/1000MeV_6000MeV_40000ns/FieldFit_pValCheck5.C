...
//=========  (Thu Apr 22 10:16:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.98514,70,62.10876);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.27575);
   Graph_Graph01035->SetMaximum(51.39937);
   ...
   mainFit1036->SetChisquare(6.25856);
   ...
   mainFit1036->SetParameter(0,-0.5409712);
   mainFit1036->SetParError(0,0.5619517);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8350061);
   mainFit1036->SetParError(1,0.019448);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0194");
   pt_LaTex = pt->AddText("#minus0.541#pm0.562");
   pt_LaTex = pt->AddText("#minus0.648#pm0.669");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.647865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.647865,-34.27575,0.647865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.25856);
   ...
   mainFit1037->SetParameter(0,-0.5409712);
   mainFit1037->SetParError(0,0.5619517);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8350061);
   mainFit1037->SetParError(1,0.019448);
