...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.60481,50,44.37075);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.10725);
   Graph_Graph01025->SetMaximum(32.8732);
   ...
   mainFit1026->SetChisquare(3.770866);
   ...
   mainFit1026->SetParameter(0,-2.413757);
   mainFit1026->SetParError(0,0.4426123);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9138639);
   mainFit1026->SetParError(1,0.01752824);
   ...
   pt_LaTex = pt->AddText("0.914#pm0.0175");
   pt_LaTex = pt->AddText("#minus2.41#pm0.443");
   pt_LaTex = pt->AddText("#minus2.64#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.641265,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.641265,-59.10725,2.641265,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.770866);
   ...
   mainFit1027->SetParameter(0,-2.413757);
   mainFit1027->SetParError(0,0.4426123);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9138639);
   mainFit1027->SetParError(1,0.01752824);
