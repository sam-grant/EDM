...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.23929);
   Graph_Graph01023->SetMaximum(56.32562);
   ...
   mainFit1024->SetChisquare(6.019468);
   ...
   mainFit1024->SetParameter(0,-2.166186);
   mainFit1024->SetParError(0,0.4106719);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9305);
   mainFit1024->SetParError(1,0.01356773);
   ...
   mainFit1025->SetChisquare(6.019468);
   ...
   mainFit1025->SetParameter(0,-2.166186);
   mainFit1025->SetParError(0,0.4106719);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9305);
   mainFit1025->SetParError(1,0.01356773);
