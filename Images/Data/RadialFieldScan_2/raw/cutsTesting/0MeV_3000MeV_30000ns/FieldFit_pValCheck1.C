...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.9349,75,71.02123);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-61.23929);
   Graph_Graph01027->SetMaximum(56.32562);
   ...
   mainFit1028->SetChisquare(1.810083);
   ...
   mainFit1028->SetParameter(0,-1.74275);
   mainFit1028->SetParError(0,0.4596195);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9443226);
   mainFit1028->SetParError(1,0.01514746);
   ...
   pt_LaTex = pt->AddText("0.944#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.74#pm 0.46");
   pt_LaTex = pt->AddText("#minus1.85#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.845503,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.845503,-61.23929,1.845503,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.810083);
   ...
   mainFit1029->SetParameter(0,-1.74275);
   mainFit1029->SetParError(0,0.4596195);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9443226);
   mainFit1029->SetParError(1,0.01514746);
