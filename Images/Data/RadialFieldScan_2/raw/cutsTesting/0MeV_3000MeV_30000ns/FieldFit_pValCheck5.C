...
//=========  (Fri Apr 23 19:01:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.511,70,65.73645);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.98626);
   Graph_Graph01035->SetMaximum(54.2117);
   ...
   mainFit1036->SetChisquare(5.72073);
   ...
   mainFit1036->SetParameter(0,-2.095185);
   mainFit1036->SetParError(0,0.4307359);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.927148);
   mainFit1036->SetParError(1,0.0148932);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0149");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.431");
   pt_LaTex = pt->AddText("#minus2.26#pm0.456");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.259817,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.259817,-37.98626,2.259817,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.72073);
   ...
   mainFit1037->SetParameter(0,-2.095185);
   mainFit1037->SetParError(0,0.4307359);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.927148);
   mainFit1037->SetParError(1,0.0148932);
