...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.23929);
   Graph_Graph01029->SetMaximum(56.32562);
   ...
   mainFit1030->SetChisquare(4.798689);
   ...
   mainFit1030->SetParameter(0,-2.359403);
   mainFit1030->SetParError(0,0.4463493);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9293703);
   mainFit1030->SetParError(1,0.01360654);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0136");
   pt_LaTex = pt->AddText("#minus2.36#pm0.446");
   pt_LaTex = pt->AddText("#minus2.54#pm0.477");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.538711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.538711,-61.23929,2.538711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.798689);
   ...
   mainFit1031->SetParameter(0,-2.359403);
   mainFit1031->SetParError(0,0.4463493);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9293703);
   mainFit1031->SetParError(1,0.01360654);
