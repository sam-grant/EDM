...
//=========  (Fri Apr 23 19:01:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.23929);
   Graph_Graph01033->SetMaximum(56.32562);
   ...
   mainFit1034->SetChisquare(4.907318);
   ...
   mainFit1034->SetParameter(0,-2.493706);
   mainFit1034->SetParError(0,0.5148736);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9412559);
   mainFit1034->SetParError(1,0.01697081);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.017");
   pt_LaTex = pt->AddText("#minus2.49#pm0.515");
   pt_LaTex = pt->AddText("#minus2.65#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.649339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.649339,-61.23929,2.649339,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.907318);
   ...
   mainFit1035->SetParameter(0,-2.493706);
   mainFit1035->SetParError(0,0.5148736);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9412559);
   mainFit1035->SetParError(1,0.01697081);
