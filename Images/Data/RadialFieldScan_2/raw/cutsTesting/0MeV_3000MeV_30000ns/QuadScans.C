...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7856315);
   ...
   quadLineFit1002->SetParameter(0,74.43345);
   quadLineFit1002->SetParError(0,0.06247521);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.48068);
   quadLineFit1002->SetParError(1,1.047858);
   ...
   quadLineFit1003->SetChisquare(0.7856315);
   ...
   quadLineFit1003->SetParameter(0,74.43345);
   quadLineFit1003->SetParError(0,0.06247521);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.48068);
   quadLineFit1003->SetParError(1,1.047858);
   ...
   Graph_30_ppm1003->SetMinimum(75.72545);
   Graph_30_ppm1003->SetMaximum(76.33754);
   ...
   quadLineFit1004->SetChisquare(0.8975738);
   ...
   quadLineFit1004->SetParameter(0,74.53525);
   quadLineFit1004->SetParError(0,0.05271814);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.34185);
   quadLineFit1004->SetParError(1,0.866305);
   ...
   quadLineFit1005->SetChisquare(0.8975738);
   ...
   quadLineFit1005->SetParameter(0,74.53525);
   quadLineFit1005->SetParError(0,0.05271814);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.34185);
   quadLineFit1005->SetParError(1,0.866305);
   ...
   Graph_10_ppm1005->SetMinimum(74.72521);
   Graph_10_ppm1005->SetMaximum(74.9605);
   ...
   quadLineFit1006->SetChisquare(0.7761355);
   ...
   quadLineFit1006->SetParameter(0,74.33568);
   quadLineFit1006->SetParError(0,0.06173679);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.147425);
   quadLineFit1006->SetParError(1,1.001125);
   ...
   quadLineFit1007->SetChisquare(0.7761355);
   ...
   quadLineFit1007->SetParameter(0,74.33568);
   quadLineFit1007->SetParError(0,0.06173679);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.147425);
   quadLineFit1007->SetParError(1,1.001125);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.46532);
   Graph_mI10_ppm1007->SetMaximum(73.80601);
   ...
   quadLineFit1008->SetChisquare(3.701861);
   ...
   quadLineFit1008->SetParameter(0,74.37097);
   quadLineFit1008->SetParError(0,0.0542208);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.04465);
   quadLineFit1008->SetParError(1,0.8824379);
   ...
   quadLineFit1009->SetChisquare(3.701861);
   ...
   quadLineFit1009->SetParameter(0,74.37097);
   quadLineFit1009->SetParError(0,0.0542208);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.04465);
   quadLineFit1009->SetParError(1,0.8824379);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.09035);
   Graph_mI30_ppm1009->SetMaximum(72.82824);
   ...
   quadLineFit1010->SetChisquare(1.530696);
   ...
   quadLineFit1010->SetParameter(0,74.27123);
   quadLineFit1010->SetParError(0,0.05122526);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.41661);
   quadLineFit1010->SetParError(1,0.88648);
   ...
   quadLineFit1011->SetChisquare(1.530696);
   ...
   quadLineFit1011->SetParameter(0,74.27123);
   quadLineFit1011->SetParError(0,0.05122526);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.41661);
   quadLineFit1011->SetParError(1,0.88648);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.15364);
   Graph_mI50_ppm1011->SetMaximum(71.85608);
   ...
   quadLineFit1012->SetChisquare(0.08946207);
   ...
   quadLineFit1012->SetParameter(0,74.32944);
   quadLineFit1012->SetParError(0,0.1034654);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.59091);
   quadLineFit1012->SetParError(1,1.851302);
   ...
   quadLineFit1013->SetChisquare(0.08946207);
   ...
   quadLineFit1013->SetParameter(0,74.32944);
   quadLineFit1013->SetParError(0,0.1034654);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.59091);
   quadLineFit1013->SetParError(1,1.851302);
