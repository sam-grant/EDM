...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.23929);
   Graph_Graph01020->SetMaximum(56.32562);
   ...
   mainFit1021->SetChisquare(6.019468);
   ...
   mainFit1021->SetParameter(0,-2.166186);
   mainFit1021->SetParError(0,0.4106719);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9305);
   mainFit1021->SetParError(1,0.01356773);
   ...
   pt_LaTex = pt->AddText("0.931#pm0.0136");
   pt_LaTex = pt->AddText("#minus2.17#pm0.411");
   pt_LaTex = pt->AddText("#minus2.33#pm0.437");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.327981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.327981,-61.23929,2.327981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.019468);
   ...
   mainFit1022->SetParameter(0,-2.166186);
   mainFit1022->SetParError(0,0.4106719);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9305);
   mainFit1022->SetParError(1,0.01356773);
