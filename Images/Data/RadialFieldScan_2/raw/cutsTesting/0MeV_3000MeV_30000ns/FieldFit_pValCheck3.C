...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.23929);
   Graph_Graph01031->SetMaximum(56.32562);
   ...
   mainFit1032->SetChisquare(5.446238);
   ...
   mainFit1032->SetParameter(0,-1.988569);
   mainFit1032->SetParError(0,0.4729652);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9277617);
   mainFit1032->SetParError(1,0.01404324);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.82");
   pt_LaTex = pt->AddText("0.928#pm0.014");
   pt_LaTex = pt->AddText("#minus1.99#pm0.473");
   pt_LaTex = pt->AddText("#minus2.14#pm0.502");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.143405,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.143405,-61.23929,2.143405,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.446238);
   ...
   mainFit1033->SetParameter(0,-1.988569);
   mainFit1033->SetParError(0,0.4729652);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9277617);
   mainFit1033->SetParError(1,0.01404324);
