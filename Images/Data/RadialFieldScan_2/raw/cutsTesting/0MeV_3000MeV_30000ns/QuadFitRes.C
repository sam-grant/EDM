...
//=========  (Fri Apr 23 19:01:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009793207);
   Graph_Graph11015->SetMaximum(0.009000585);
   ...
   Graph_Graph21016->SetMinimum(-0.007919239);
   Graph_Graph21016->SetMaximum(0.009304723);
   ...
   Graph_Graph31017->SetMinimum(-0.02119589);
   Graph_Graph31017->SetMaximum(0.0192165);
   ...
   Graph_Graph41018->SetMinimum(-0.007637502);
   Graph_Graph41018->SetMaximum(0.01456151);
   ...
   Graph_Graph51019->SetMinimum(-0.002509873);
   Graph_Graph51019->SetMaximum(0.003353191);
