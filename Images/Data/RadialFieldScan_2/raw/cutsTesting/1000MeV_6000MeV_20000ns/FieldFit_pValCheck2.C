...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.02227);
   Graph_Graph01029->SetMaximum(53.03568);
   ...
   mainFit1030->SetChisquare(6.543432);
   ...
   mainFit1030->SetParameter(0,-0.5037637);
   mainFit1030->SetParError(0,0.4800244);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8356637);
   mainFit1030->SetParError(1,0.01464466);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0146");
   pt_LaTex = pt->AddText("#minus0.504#pm 0.48");
   pt_LaTex = pt->AddText("#minus0.603#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6028307,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6028307,-54.02227,0.6028307,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.543432);
   ...
   mainFit1031->SetParameter(0,-0.5037637);
   mainFit1031->SetParError(0,0.4800244);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8356637);
   mainFit1031->SetParError(1,0.01464466);
