...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.02227);
   Graph_Graph01020->SetMaximum(53.03568);
   ...
   mainFit1021->SetChisquare(6.915272);
   ...
   mainFit1021->SetParameter(0,-0.3890549);
   mainFit1021->SetParError(0,0.4416249);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8363453);
   mainFit1021->SetParError(1,0.01460218);
   ...
   mainFit1022->SetChisquare(6.915272);
   ...
   mainFit1022->SetParameter(0,-0.3890549);
   mainFit1022->SetParError(0,0.4416249);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8363453);
   mainFit1022->SetParError(1,0.01460218);
