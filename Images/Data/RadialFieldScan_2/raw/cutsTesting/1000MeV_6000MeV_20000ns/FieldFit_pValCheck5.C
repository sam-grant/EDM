...
//=========  (Thu Apr 22 09:52:08 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-43.83852,70,61.70472);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.28419);
   Graph_Graph01035->SetMaximum(51.1504);
   ...
   mainFit1036->SetChisquare(6.651494);
   ...
   mainFit1036->SetParameter(0,-0.3172335);
   mainFit1036->SetParError(0,0.4632364);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8329427);
   mainFit1036->SetParError(1,0.01603488);
   ...
   pt_LaTex = pt->AddText("0.833#pm0.016");
   pt_LaTex = pt->AddText("#minus0.317#pm0.463");
   pt_LaTex = pt->AddText("#minus0.381#pm0.554");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3808588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3808588,-33.28419,0.3808588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.651494);
   ...
   mainFit1037->SetParameter(0,-0.3172335);
   mainFit1037->SetParError(0,0.4632364);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8329427);
   mainFit1037->SetParError(1,0.01603488);
