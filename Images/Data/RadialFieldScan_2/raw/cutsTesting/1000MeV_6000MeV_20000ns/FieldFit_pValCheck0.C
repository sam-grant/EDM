...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.30493,50,40.92003);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.98244);
   Graph_Graph01025->SetMaximum(30.59753);
   ...
   mainFit1026->SetChisquare(3.213684);
   ...
   mainFit1026->SetParameter(0,-0.7296895);
   mainFit1026->SetParError(0,0.4757842);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8134352);
   mainFit1026->SetParError(1,0.01883852);
   ...
   pt_LaTex = pt->AddText("0.813#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.73#pm0.476");
   pt_LaTex = pt->AddText("#minus0.897#pm0.588");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8970469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8970469,-51.98244,0.8970469,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.213684);
   ...
   mainFit1027->SetParameter(0,-0.7296895);
   mainFit1027->SetParError(0,0.4757842);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8134352);
   mainFit1027->SetParError(1,0.01883852);
