...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.02227);
   Graph_Graph01033->SetMaximum(53.03568);
   ...
   mainFit1034->SetChisquare(6.840755);
   ...
   mainFit1034->SetParameter(0,-0.4800345);
   mainFit1034->SetParError(0,0.553273);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.839336);
   mainFit1034->SetParError(1,0.01825514);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.48#pm0.553");
   pt_LaTex = pt->AddText("#minus0.572#pm0.653");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5719217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5719217,-54.02227,0.5719217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.840755);
   ...
   mainFit1035->SetParameter(0,-0.4800345);
   mainFit1035->SetParError(0,0.553273);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.839336);
   mainFit1035->SetParError(1,0.01825514);
