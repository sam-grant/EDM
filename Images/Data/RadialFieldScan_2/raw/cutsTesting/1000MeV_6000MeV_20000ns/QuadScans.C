...
//=========  (Thu Apr 22 09:52:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.57922);
   ...
   quadLineFit1002->SetParameter(0,74.64269);
   quadLineFit1002->SetParError(0,0.06739267);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.98372);
   quadLineFit1002->SetParError(1,1.130461);
   ...
   quadLineFit1003->SetChisquare(1.57922);
   ...
   quadLineFit1003->SetParameter(0,74.64269);
   quadLineFit1003->SetParError(0,0.06739267);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.98372);
   quadLineFit1003->SetParError(1,1.130461);
   ...
   Graph_30_ppm1003->SetMinimum(75.85272);
   Graph_30_ppm1003->SetMaximum(76.43155);
   ...
   quadLineFit1004->SetChisquare(1.740957);
   ...
   quadLineFit1004->SetParameter(0,74.74682);
   quadLineFit1004->SetParError(0,0.05662854);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.78507);
   quadLineFit1004->SetParError(1,0.9307923);
   ...
   quadLineFit1005->SetChisquare(1.740957);
   ...
   quadLineFit1005->SetParameter(0,74.74682);
   quadLineFit1005->SetParError(0,0.05662854);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.78507);
   quadLineFit1005->SetParError(1,0.9307923);
   ...
   Graph_10_ppm1005->SetMinimum(74.92119);
   Graph_10_ppm1005->SetMaximum(75.1723);
   ...
   quadLineFit1006->SetChisquare(2.126883);
   ...
   quadLineFit1006->SetParameter(0,74.50841);
   quadLineFit1006->SetParError(0,0.06637629);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.572926);
   quadLineFit1006->SetParError(1,1.076571);
   ...
   quadLineFit1007->SetChisquare(2.126883);
   ...
   quadLineFit1007->SetParameter(0,74.50841);
   quadLineFit1007->SetParError(0,0.06637629);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.572926);
   quadLineFit1007->SetParError(1,1.076571);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80428);
   Graph_mI10_ppm1007->SetMaximum(74.06522);
   ...
   quadLineFit1008->SetChisquare(6.961563);
   ...
   quadLineFit1008->SetParameter(0,74.43814);
   quadLineFit1008->SetParError(0,0.0582612);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.299099);
   quadLineFit1008->SetParError(1,0.9483553);
   ...
   quadLineFit1009->SetChisquare(6.961563);
   ...
   quadLineFit1009->SetParameter(0,74.43814);
   quadLineFit1009->SetParError(0,0.0582612);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.299099);
   quadLineFit1009->SetParError(1,0.9483553);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.48679);
   Graph_mI30_ppm1009->SetMaximum(73.13356);
   ...
   quadLineFit1010->SetChisquare(2.078249);
   ...
   quadLineFit1010->SetParameter(0,74.37421);
   quadLineFit1010->SetParError(0,0.05510952);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.29416);
   quadLineFit1010->SetParError(1,0.9538158);
   ...
   quadLineFit1011->SetChisquare(2.078249);
   ...
   quadLineFit1011->SetParameter(0,74.37421);
   quadLineFit1011->SetParError(0,0.05510952);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.29416);
   quadLineFit1011->SetParError(1,0.9538158);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.59129);
   Graph_mI50_ppm1011->SetMaximum(72.20823);
   ...
   quadLineFit1012->SetChisquare(1.699088);
   ...
   quadLineFit1012->SetParameter(0,74.36298);
   quadLineFit1012->SetParError(0,0.1110815);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.11326);
   quadLineFit1012->SetParError(1,1.987512);
   ...
   quadLineFit1013->SetChisquare(1.699088);
   ...
   quadLineFit1013->SetParameter(0,74.36298);
   quadLineFit1013->SetParError(0,0.1110815);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.11326);
   quadLineFit1013->SetParError(1,1.987512);
