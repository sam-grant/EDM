...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009590118);
   Graph_Graph11015->SetMaximum(0.02537067);
   ...
   Graph_Graph21016->SetMinimum(-0.01408145);
   Graph_Graph21016->SetMaximum(0.01659807);
   ...
   Graph_Graph31017->SetMinimum(-0.03168928);
   Graph_Graph31017->SetMaximum(0.02727217);
   ...
   Graph_Graph41018->SetMinimum(-0.01176118);
   Graph_Graph41018->SetMaximum(0.01494518);
   ...
   Graph_Graph51019->SetMinimum(-0.01175457);
   Graph_Graph51019->SetMaximum(0.01571848);
