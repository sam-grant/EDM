...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.02227);
   Graph_Graph01023->SetMaximum(53.03568);
   ...
   mainFit1024->SetChisquare(6.915272);
   ...
   mainFit1024->SetParameter(0,-0.3890549);
   mainFit1024->SetParError(0,0.4416249);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8363453);
   mainFit1024->SetParError(1,0.01460218);
   ...
   pt_LaTex = pt->AddText("#minus0.389#pm0.442");
   pt_LaTex = pt->AddText("#minus0.465#pm0.527");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4651845,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4651845,-54.02227,0.4651845,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.915272);
   ...
   mainFit1025->SetParameter(0,-0.3890549);
   mainFit1025->SetParError(0,0.4416249);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8363453);
   mainFit1025->SetParError(1,0.01460218);
