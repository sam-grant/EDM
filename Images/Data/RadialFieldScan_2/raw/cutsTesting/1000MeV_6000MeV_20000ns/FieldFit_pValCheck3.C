...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.02227);
   Graph_Graph01031->SetMaximum(53.03568);
   ...
   mainFit1032->SetChisquare(6.60485);
   ...
   mainFit1032->SetParameter(0,-0.5296897);
   mainFit1032->SetParError(0,0.5086711);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8385159);
   mainFit1032->SetParError(1,0.01511294);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.0151");
   pt_LaTex = pt->AddText("#minus0.53#pm0.509");
   pt_LaTex = pt->AddText("#minus0.632#pm0.604");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.631699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.631699,-54.02227,0.631699,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.60485);
   ...
   mainFit1033->SetParameter(0,-0.5296897);
   mainFit1033->SetParError(0,0.5086711);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8385159);
   mainFit1033->SetParError(1,0.01511294);
