...
//=========  (Thu Apr 22 09:52:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.02227);
   Graph_Graph01027->SetMaximum(53.03568);
   ...
   mainFit1028->SetChisquare(0.1370852);
   ...
   mainFit1028->SetParameter(0,0.1906566);
   mainFit1028->SetParError(0,0.4945837);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8552998);
   mainFit1028->SetParError(1,0.01631649);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0457");
   pt_LaTex = pt->AddText("0.855#pm0.0163");
   pt_LaTex = pt->AddText("0.191#pm0.495");
   pt_LaTex = pt->AddText("0.223#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2229121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2229121,-54.02227,-0.2229121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1370852);
   ...
   mainFit1029->SetParameter(0,0.1906566);
   mainFit1029->SetParError(0,0.4945837);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8552998);
   mainFit1029->SetParError(1,0.01631649);
