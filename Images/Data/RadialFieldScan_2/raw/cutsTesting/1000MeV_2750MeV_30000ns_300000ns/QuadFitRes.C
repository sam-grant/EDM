...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01834435);
   Graph_Graph11015->SetMaximum(0.04861853);
   ...
   Graph_Graph21016->SetMinimum(-0.01015344);
   Graph_Graph21016->SetMaximum(0.01196687);
   ...
   Graph_Graph31017->SetMinimum(-0.03240206);
   Graph_Graph31017->SetMaximum(0.0238379);
   ...
   Graph_Graph41018->SetMinimum(-0.02088752);
   Graph_Graph41018->SetMaximum(0.03031412);
   ...
   Graph_Graph51019->SetMinimum(-0.006230708);
   Graph_Graph51019->SetMaximum(0.008332871);
