...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.61161);
   Graph_Graph01029->SetMaximum(52.84052);
   ...
   mainFit1030->SetChisquare(3.331686);
   ...
   mainFit1030->SetParameter(0,-0.7295445);
   mainFit1030->SetParError(0,0.5729204);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8355613);
   mainFit1030->SetParError(1,0.0174874);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0175");
   pt_LaTex = pt->AddText("#minus0.73#pm0.573");
   pt_LaTex = pt->AddText("#minus0.873#pm0.684");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.873119,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.873119,-54.61161,0.873119,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.331686);
   ...
   mainFit1031->SetParameter(0,-0.7295445);
   mainFit1031->SetParError(0,0.5729204);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8355613);
   mainFit1031->SetParError(1,0.0174874);
