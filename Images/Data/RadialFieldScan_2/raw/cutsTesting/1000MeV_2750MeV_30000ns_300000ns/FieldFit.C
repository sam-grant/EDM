...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.61161);
   Graph_Graph01020->SetMaximum(52.84052);
   ...
   mainFit1021->SetChisquare(4.76981);
   ...
   mainFit1021->SetParameter(0,-0.4601218);
   mainFit1021->SetParError(0,0.5270306);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8371456);
   mainFit1021->SetParError(1,0.01743753);
   ...
   mainFit1022->SetChisquare(4.76981);
   ...
   mainFit1022->SetParameter(0,-0.4601218);
   mainFit1022->SetParError(0,0.5270306);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8371456);
   mainFit1022->SetParError(1,0.01743753);
