...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.61161);
   Graph_Graph01033->SetMaximum(52.84052);
   ...
   mainFit1034->SetChisquare(4.732621);
   ...
   mainFit1034->SetParameter(0,-0.5370816);
   mainFit1034->SetParError(0,0.6610783);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8396784);
   mainFit1034->SetParError(1,0.0218302);
   ...
   pt_LaTex = pt->AddText(" 0.84#pm0.0218");
   pt_LaTex = pt->AddText("#minus0.537#pm0.661");
   pt_LaTex = pt->AddText("#minus0.64#pm 0.78");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6396277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6396277,-54.61161,0.6396277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.732621);
   ...
   mainFit1035->SetParameter(0,-0.5370816);
   mainFit1035->SetParError(0,0.6610783);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8396784);
   mainFit1035->SetParError(1,0.0218302);
