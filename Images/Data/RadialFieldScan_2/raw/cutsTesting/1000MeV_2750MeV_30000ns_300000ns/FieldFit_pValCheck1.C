...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.61161);
   Graph_Graph01027->SetMaximum(52.84052);
   ...
   mainFit1028->SetChisquare(0.4861063);
   ...
   mainFit1028->SetParameter(0,0.08892992);
   mainFit1028->SetParError(0,0.5900291);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.855125);
   mainFit1028->SetParError(1,0.01948153);
   ...
   pt_LaTex = pt->AddText("0.855#pm0.0195");
   pt_LaTex = pt->AddText("0.0889#pm 0.59");
   pt_LaTex = pt->AddText("0.104#pm 0.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1039964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1039964,-54.61161,-0.1039964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4861063);
   ...
   mainFit1029->SetParameter(0,0.08892992);
   mainFit1029->SetParError(0,0.5900291);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.855125);
   mainFit1029->SetParError(1,0.01948153);
