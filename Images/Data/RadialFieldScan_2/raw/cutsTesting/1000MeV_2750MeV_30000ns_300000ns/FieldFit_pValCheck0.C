...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.05847,50,41.34872);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.61775);
   Graph_Graph01025->SetMaximum(30.908);
   ...
   mainFit1026->SetChisquare(3.367122);
   ...
   mainFit1026->SetParameter(0,-0.7095712);
   mainFit1026->SetParError(0,0.567546);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8202891);
   mainFit1026->SetParError(1,0.02250365);
   ...
   pt_LaTex = pt->AddText(" 0.82#pm0.0225");
   pt_LaTex = pt->AddText("#minus0.71#pm0.568");
   pt_LaTex = pt->AddText("#minus0.865#pm0.695");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8650257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8650257,-52.61775,0.8650257,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.367122);
   ...
   mainFit1027->SetParameter(0,-0.7095712);
   mainFit1027->SetParError(0,0.567546);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8202891);
   mainFit1027->SetParError(1,0.02250365);
