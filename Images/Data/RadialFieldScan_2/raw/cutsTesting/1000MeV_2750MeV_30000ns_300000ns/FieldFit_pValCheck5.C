...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.16722,70,61.49686);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.60081);
   Graph_Graph01035->SetMaximum(50.93045);
   ...
   mainFit1036->SetChisquare(4.570042);
   ...
   mainFit1036->SetParameter(0,-0.3860075);
   mainFit1036->SetParError(0,0.5525015);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8336354);
   mainFit1036->SetParError(1,0.01912451);
   ...
   pt_LaTex = pt->AddText("#minus0.386#pm0.553");
   pt_LaTex = pt->AddText("#minus0.463#pm 0.66");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4630411,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4630411,-33.60081,0.4630411,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.570042);
   ...
   mainFit1037->SetParameter(0,-0.3860075);
   mainFit1037->SetParError(0,0.5525015);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8336354);
   mainFit1037->SetParError(1,0.01912451);
