...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.04313,75,66.27204);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-54.61161);
   Graph_Graph01031->SetMaximum(52.84052);
   ...
   mainFit1032->SetChisquare(4.766969);
   ...
   mainFit1032->SetParameter(0,-0.4762015);
   mainFit1032->SetParError(0,0.6072689);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8373949);
   mainFit1032->SetParError(1,0.01805371);
   ...
   pt_LaTex = pt->AddText("0.837#pm0.0181");
   pt_LaTex = pt->AddText("#minus0.476#pm0.607");
   pt_LaTex = pt->AddText("#minus0.569#pm0.722");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5686702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5686702,-54.61161,0.5686702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.766969);
   ...
   mainFit1033->SetParameter(0,-0.4762015);
   mainFit1033->SetParError(0,0.6072689);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8373949);
   mainFit1033->SetParError(1,0.01805371);
