...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.61161);
   Graph_Graph01023->SetMaximum(52.84052);
   ...
   mainFit1024->SetChisquare(4.76981);
   ...
   mainFit1024->SetParameter(0,-0.4601218);
   mainFit1024->SetParError(0,0.5270306);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8371456);
   mainFit1024->SetParError(1,0.01743753);
   ...
   pt_LaTex = pt->AddText("0.837#pm0.0174");
   pt_LaTex = pt->AddText("#minus0.46#pm0.527");
   pt_LaTex = pt->AddText("#minus0.55#pm0.628");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5496318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5496318,-54.61161,0.5496318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.76981);
   ...
   mainFit1025->SetParameter(0,-0.4601218);
   mainFit1025->SetParError(0,0.5270306);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8371456);
   mainFit1025->SetParError(1,0.01743753);
