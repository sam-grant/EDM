...
//=========  (Mon Apr 26 22:58:24 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9215151);
   ...
   quadLineFit1002->SetParameter(0,74.61078);
   quadLineFit1002->SetParError(0,0.0803489);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.53834);
   quadLineFit1002->SetParError(1,1.347836);
   ...
   quadLineFit1003->SetChisquare(0.9215151);
   ...
   quadLineFit1003->SetParameter(0,74.61078);
   quadLineFit1003->SetParError(0,0.0803489);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.53834);
   quadLineFit1003->SetParError(1,1.347836);
   ...
   Graph_30_ppm1003->SetMinimum(75.79092);
   Graph_30_ppm1003->SetMaximum(76.37138);
   ...
   quadLineFit1004->SetChisquare(4.490458);
   ...
   quadLineFit1004->SetParameter(0,74.68437);
   quadLineFit1004->SetParError(0,0.06753579);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.83754);
   quadLineFit1004->SetParError(1,1.109985);
   ...
   quadLineFit1005->SetChisquare(4.490458);
   ...
   quadLineFit1005->SetParameter(0,74.68437);
   quadLineFit1005->SetParError(0,0.06753579);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.83754);
   quadLineFit1005->SetParError(1,1.109985);
   ...
   Graph_10_ppm1005->SetMinimum(74.84745);
   Graph_10_ppm1005->SetMaximum(75.1218);
   ...
   quadLineFit1006->SetChisquare(0.7776556);
   ...
   quadLineFit1006->SetParameter(0,74.40378);
   quadLineFit1006->SetParError(0,0.07911196);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.314033);
   quadLineFit1006->SetParError(1,1.283111);
   ...
   quadLineFit1007->SetChisquare(0.7776556);
   ...
   quadLineFit1007->SetParameter(0,74.40378);
   quadLineFit1007->SetParError(0,0.07911196);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.314033);
   quadLineFit1007->SetParError(1,1.283111);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.71965);
   Graph_mI10_ppm1007->SetMaximum(74.00019);
   ...
   quadLineFit1008->SetChisquare(4.796596);
   ...
   quadLineFit1008->SetParameter(0,74.39035);
   quadLineFit1008->SetParError(0,0.06949691);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.779861);
   quadLineFit1008->SetParError(1,1.131204);
   ...
   quadLineFit1009->SetChisquare(4.796596);
   ...
   quadLineFit1009->SetParameter(0,74.39035);
   quadLineFit1009->SetParError(0,0.06949691);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.779861);
   quadLineFit1009->SetParError(1,1.131204);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.39747);
   Graph_mI30_ppm1009->SetMaximum(73.06266);
   ...
   quadLineFit1010->SetChisquare(2.757643);
   ...
   quadLineFit1010->SetParameter(0,74.30573);
   quadLineFit1010->SetParError(0,0.06575134);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.41857);
   quadLineFit1010->SetParError(1,1.137971);
   ...
   quadLineFit1011->SetChisquare(2.757643);
   ...
   quadLineFit1011->SetParameter(0,74.30573);
   quadLineFit1011->SetParError(0,0.06575134);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.41857);
   quadLineFit1011->SetParError(1,1.137971);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.5075);
   Graph_mI50_ppm1011->SetMaximum(72.13435);
   ...
   quadLineFit1012->SetChisquare(0.3355315);
   ...
   quadLineFit1012->SetParameter(0,74.28901);
   quadLineFit1012->SetParError(0,0.133538);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.26783);
   quadLineFit1012->SetParError(1,2.389439);
   ...
   quadLineFit1013->SetChisquare(0.3355315);
   ...
   quadLineFit1013->SetParameter(0,74.28901);
   quadLineFit1013->SetParError(0,0.133538);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.26783);
   quadLineFit1013->SetParError(1,2.389439);
