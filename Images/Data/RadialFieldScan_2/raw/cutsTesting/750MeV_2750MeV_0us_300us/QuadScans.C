...
//=========  (Wed Apr 28 14:12:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.341009);
   ...
   quadLineFit1002->SetParameter(0,74.54429);
   quadLineFit1002->SetParError(0,0.05776252);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.78983);
   quadLineFit1002->SetParError(1,0.9687041);
   ...
   quadLineFit1003->SetChisquare(4.341009);
   ...
   quadLineFit1003->SetParameter(0,74.54429);
   quadLineFit1003->SetParError(0,0.05776252);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.78983);
   quadLineFit1003->SetParError(1,0.9687041);
   ...
   Graph_30_ppm1003->SetMinimum(75.78096);
   Graph_30_ppm1003->SetMaximum(76.42332);
   ...
   quadLineFit1004->SetChisquare(1.164305);
   ...
   quadLineFit1004->SetParameter(0,74.5195);
   quadLineFit1004->SetParError(0,0.04795342);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.70656);
   quadLineFit1004->SetParError(1,0.7877378);
   ...
   quadLineFit1005->SetChisquare(1.164305);
   ...
   quadLineFit1005->SetParameter(0,74.5195);
   quadLineFit1005->SetParError(0,0.04795342);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.70656);
   quadLineFit1005->SetParError(1,0.7877378);
   ...
   Graph_10_ppm1005->SetMinimum(74.8122);
   Graph_10_ppm1005->SetMaximum(75.0607);
   ...
   quadLineFit1006->SetChisquare(1.564533);
   ...
   quadLineFit1006->SetParameter(0,74.38864);
   quadLineFit1006->SetParError(0,0.05623658);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.781158);
   quadLineFit1006->SetParError(1,0.9116478);
   ...
   quadLineFit1007->SetChisquare(1.564533);
   ...
   quadLineFit1007->SetParameter(0,74.38864);
   quadLineFit1007->SetParError(0,0.05623658);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.781158);
   quadLineFit1007->SetParError(1,0.9116478);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.59759);
   Graph_mI10_ppm1007->SetMaximum(73.91154);
   ...
   quadLineFit1008->SetChisquare(3.942272);
   ...
   quadLineFit1008->SetParameter(0,74.41915);
   quadLineFit1008->SetParError(0,0.04933924);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.99884);
   quadLineFit1008->SetParError(1,0.802685);
   ...
   quadLineFit1009->SetChisquare(3.942272);
   ...
   quadLineFit1009->SetParameter(0,74.41915);
   quadLineFit1009->SetParError(0,0.04933924);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.99884);
   quadLineFit1009->SetParError(1,0.802685);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.2115);
   Graph_mI30_ppm1009->SetMaximum(72.95806);
   ...
   quadLineFit1010->SetChisquare(2.691966);
   ...
   quadLineFit1010->SetParameter(0,74.40763);
   quadLineFit1010->SetParError(0,0.04661715);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.51956);
   quadLineFit1010->SetParError(1,0.8063462);
   ...
   quadLineFit1011->SetChisquare(2.691966);
   ...
   quadLineFit1011->SetParameter(0,74.40763);
   quadLineFit1011->SetParError(0,0.04661715);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.51956);
   quadLineFit1011->SetParError(1,0.8063462);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.30554);
   Graph_mI50_ppm1011->SetMaximum(71.97325);
   ...
   quadLineFit1012->SetChisquare(0.697091);
   ...
   quadLineFit1012->SetParameter(0,74.33514);
   quadLineFit1012->SetParError(0,0.09414679);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.27689);
   quadLineFit1012->SetParError(1,1.68424);
   ...
   quadLineFit1013->SetChisquare(0.697091);
   ...
   quadLineFit1013->SetParameter(0,74.33514);
   quadLineFit1013->SetParError(0,0.09414679);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.27689);
   quadLineFit1013->SetParError(1,1.68424);
