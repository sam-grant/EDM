...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.4331);
   Graph_Graph01031->SetMaximum(55.2305);
   ...
   mainFit1032->SetChisquare(1.929812);
   ...
   mainFit1032->SetParameter(0,-1.459488);
   mainFit1032->SetParError(0,0.430812);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9235128);
   mainFit1032->SetParError(1,0.01283637);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.46#pm0.431");
   pt_LaTex = pt->AddText("#minus1.58#pm0.461");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.580366,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.580366,-58.4331,1.580366,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.929812);
   ...
   mainFit1033->SetParameter(0,-1.459488);
   mainFit1033->SetParError(0,0.430812);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9235128);
   mainFit1033->SetParError(1,0.01283637);
