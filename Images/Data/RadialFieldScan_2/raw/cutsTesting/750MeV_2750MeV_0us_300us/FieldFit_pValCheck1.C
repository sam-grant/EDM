...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.4331);
   Graph_Graph01027->SetMaximum(55.2305);
   ...
   mainFit1028->SetChisquare(1.381939);
   ...
   mainFit1028->SetParameter(0,-1.37496);
   mainFit1028->SetParError(0,0.4198136);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9296549);
   mainFit1028->SetParError(1,0.01390632);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.461");
   pt_LaTex = pt->AddText(" 0.93#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.37#pm 0.42");
   pt_LaTex = pt->AddText("#minus1.48#pm0.454");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.479,-58.4331,1.479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.381939);
   ...
   mainFit1029->SetParameter(0,-1.37496);
   mainFit1029->SetParError(0,0.4198136);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9296549);
   mainFit1029->SetParError(1,0.01390632);
