...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.34701,70,64.77964);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.93435);
   Graph_Graph01035->SetMaximum(53.36697);
   ...
   mainFit1036->SetChisquare(1.932227);
   ...
   mainFit1036->SetParameter(0,-1.566814);
   mainFit1036->SetParError(0,0.3921665);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9263907);
   mainFit1036->SetParError(1,0.01362554);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.57#pm0.392");
   pt_LaTex = pt->AddText("#minus1.69#pm0.418");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.69131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.69131,-37.93435,1.69131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.932227);
   ...
   mainFit1037->SetParameter(0,-1.566814);
   mainFit1037->SetParError(0,0.3921665);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9263907);
   mainFit1037->SetParError(1,0.01362554);
