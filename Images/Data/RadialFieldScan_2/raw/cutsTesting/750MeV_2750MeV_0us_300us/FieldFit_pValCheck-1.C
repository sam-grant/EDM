...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.4331);
   Graph_Graph01023->SetMaximum(55.2305);
   ...
   mainFit1024->SetChisquare(2.035603);
   ...
   mainFit1024->SetParameter(0,-1.528954);
   mainFit1024->SetParError(0,0.3740974);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9245735);
   mainFit1024->SetParError(1,0.012409);
   ...
   mainFit1025->SetChisquare(2.035603);
   ...
   mainFit1025->SetParameter(0,-1.528954);
   mainFit1025->SetParError(0,0.3740974);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9245735);
   mainFit1025->SetParError(1,0.012409);
