...
//=========  (Wed Apr 28 14:12:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.4331);
   Graph_Graph01020->SetMaximum(55.2305);
   ...
   mainFit1021->SetChisquare(2.035603);
   ...
   mainFit1021->SetParameter(0,-1.528954);
   mainFit1021->SetParError(0,0.3740974);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9245735);
   mainFit1021->SetParError(1,0.012409);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.53#pm0.374");
   pt_LaTex = pt->AddText("#minus1.65#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.653686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.653686,-58.4331,1.653686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.035603);
   ...
   mainFit1022->SetParameter(0,-1.528954);
   mainFit1022->SetParError(0,0.3740974);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9245735);
   mainFit1022->SetParError(1,0.012409);
