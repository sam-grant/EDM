...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.82499,50,45.35815);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.50667);
   Graph_Graph01025->SetMaximum(34.03984);
   ...
   mainFit1026->SetChisquare(2.019021);
   ...
   mainFit1026->SetParameter(0,-1.548161);
   mainFit1026->SetParError(0,0.402658);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9232923);
   mainFit1026->SetParError(1,0.01594291);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.55#pm0.403");
   pt_LaTex = pt->AddText("#minus1.68#pm0.441");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.676783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.676783,-56.50667,1.676783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.019021);
   ...
   mainFit1027->SetParameter(0,-1.548161);
   mainFit1027->SetParError(0,0.402658);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9232923);
   mainFit1027->SetParError(1,0.01594291);
