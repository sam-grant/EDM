...
//=========  (Wed Apr 28 14:12:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009627034);
   Graph_Graph11015->SetMaximum(0.01172118);
   ...
   Graph_Graph21016->SetMinimum(-0.0102182);
   Graph_Graph21016->SetMaximum(0.0119934);
   ...
   Graph_Graph31017->SetMinimum(-0.02196723);
   Graph_Graph31017->SetMaximum(0.02011862);
   ...
   Graph_Graph41018->SetMinimum(-0.01327444);
   Graph_Graph41018->SetMaximum(0.01628429);
   ...
   Graph_Graph51019->SetMinimum(-0.006392727);
   Graph_Graph51019->SetMaximum(0.008527643);
