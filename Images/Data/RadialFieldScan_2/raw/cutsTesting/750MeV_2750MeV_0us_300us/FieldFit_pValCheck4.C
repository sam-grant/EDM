...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.4331);
   Graph_Graph01033->SetMaximum(55.2305);
   ...
   mainFit1034->SetChisquare(1.840413);
   ...
   mainFit1034->SetParameter(0,-1.404351);
   mainFit1034->SetParError(0,0.4685375);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9204619);
   mainFit1034->SetParError(1,0.01552153);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.613");
   pt_LaTex = pt->AddText(" 0.92#pm0.0155");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.469");
   pt_LaTex = pt->AddText("#minus1.53#pm0.498");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.525702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.525702,-58.4331,1.525702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.840413);
   ...
   mainFit1035->SetParameter(0,-1.404351);
   mainFit1035->SetParError(0,0.4685375);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9204619);
   mainFit1035->SetParError(1,0.01552153);
