...
//=========  (Wed Apr 28 14:12:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.64105,75,69.43845);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-58.4331);
   Graph_Graph01029->SetMaximum(55.2305);
   ...
   mainFit1030->SetChisquare(0.3943733);
   ...
   mainFit1030->SetParameter(0,-1.733641);
   mainFit1030->SetParError(0,0.4067799);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9233211);
   mainFit1030->SetParError(1,0.01244791);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.131");
   pt_LaTex = pt->AddText("0.923#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.73#pm0.407");
   pt_LaTex = pt->AddText("#minus1.88#pm0.438");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.877615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.877615,-58.4331,1.877615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3943733);
   ...
   mainFit1031->SetParameter(0,-1.733641);
   mainFit1031->SetParError(0,0.4067799);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9233211);
   mainFit1031->SetParError(1,0.01244791);
