...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.20585);
   Graph_Graph01031->SetMaximum(54.65434);
   ...
   mainFit1032->SetChisquare(1.098284);
   ...
   mainFit1032->SetParameter(0,-1.752804);
   mainFit1032->SetParError(0,0.41522);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9175317);
   mainFit1032->SetParError(1,0.01233374);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.75#pm0.415");
   pt_LaTex = pt->AddText("#minus1.91#pm0.446");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.910347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.910347,-58.20585,1.910347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.098284);
   ...
   mainFit1033->SetParameter(0,-1.752804);
   mainFit1033->SetParError(0,0.41522);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9175317);
   mainFit1033->SetParError(1,0.01233374);
