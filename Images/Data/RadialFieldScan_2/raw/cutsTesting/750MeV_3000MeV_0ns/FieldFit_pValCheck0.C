...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.51914,50,44.79068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.28816);
   Graph_Graph01025->SetMaximum(33.55969);
   ...
   mainFit1026->SetChisquare(1.097857);
   ...
   mainFit1026->SetParameter(0,-1.869514);
   mainFit1026->SetParError(0,0.3884672);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9153484);
   mainFit1026->SetParError(1,0.01538245);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.366");
   pt_LaTex = pt->AddText("0.915#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.87#pm0.388");
   pt_LaTex = pt->AddText("#minus2.04#pm 0.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.042407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.042407,-56.28816,2.042407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.097857);
   ...
   mainFit1027->SetParameter(0,-1.869514);
   mainFit1027->SetParError(0,0.3884672);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9153484);
   mainFit1027->SetParError(1,0.01538245);
