...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01217594);
   Graph_Graph11015->SetMaximum(0.01362236);
   ...
   Graph_Graph21016->SetMinimum(-0.01378657);
   Graph_Graph21016->SetMaximum(0.01618024);
   ...
   Graph_Graph31017->SetMinimum(-0.02152422);
   Graph_Graph31017->SetMaximum(0.01865983);
   ...
   Graph_Graph41018->SetMinimum(-0.009953458);
   Graph_Graph41018->SetMaximum(0.0123141);
   ...
   Graph_Graph51019->SetMinimum(-0.006379569);
   Graph_Graph51019->SetMaximum(0.008508746);
