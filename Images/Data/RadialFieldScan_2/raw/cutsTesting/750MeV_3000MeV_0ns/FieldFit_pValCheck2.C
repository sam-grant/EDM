...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.20585);
   Graph_Graph01029->SetMaximum(54.65434);
   ...
   mainFit1030->SetChisquare(0.4923095);
   ...
   mainFit1030->SetParameter(0,-1.951162);
   mainFit1030->SetParError(0,0.3917975);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.917822);
   mainFit1030->SetParError(1,0.01195113);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.164");
   pt_LaTex = pt->AddText("0.918#pm0.012");
   pt_LaTex = pt->AddText("#minus1.95#pm0.392");
   pt_LaTex = pt->AddText("#minus2.13#pm0.424");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.125861,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.125861,-58.20585,2.125861,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.4923095);
   ...
   mainFit1031->SetParameter(0,-1.951162);
   mainFit1031->SetParError(0,0.3917975);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.917822);
   mainFit1031->SetParError(1,0.01195113);
