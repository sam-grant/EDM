...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.92158);
   ...
   quadLineFit1002->SetParameter(0,74.59751);
   quadLineFit1002->SetParError(0,0.05497317);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.32762);
   quadLineFit1002->SetParError(1,0.9217042);
   ...
   quadLineFit1003->SetChisquare(3.92158);
   ...
   quadLineFit1003->SetParameter(0,74.59751);
   quadLineFit1003->SetParError(0,0.05497317);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.32762);
   quadLineFit1003->SetParError(1,0.9217042);
   ...
   Graph_30_ppm1003->SetMinimum(75.81731);
   Graph_30_ppm1003->SetMaximum(76.44948);
   ...
   quadLineFit1004->SetChisquare(1.86438);
   ...
   quadLineFit1004->SetParameter(0,74.57322);
   quadLineFit1004->SetParError(0,0.04626145);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.31247);
   quadLineFit1004->SetParError(1,0.7599034);
   ...
   quadLineFit1005->SetChisquare(1.86438);
   ...
   quadLineFit1005->SetParameter(0,74.57322);
   quadLineFit1005->SetParError(0,0.04626145);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.31247);
   quadLineFit1005->SetParError(1,0.7599034);
   ...
   Graph_10_ppm1005->SetMinimum(74.85677);
   Graph_10_ppm1005->SetMaximum(75.08794);
   ...
   quadLineFit1006->SetChisquare(3.061672);
   ...
   quadLineFit1006->SetParameter(0,74.46697);
   quadLineFit1006->SetParError(0,0.0542598);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.043536);
   quadLineFit1006->SetParError(1,0.879557);
   ...
   quadLineFit1007->SetChisquare(3.061672);
   ...
   quadLineFit1007->SetParameter(0,74.46697);
   quadLineFit1007->SetParError(0,0.0542598);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.043536);
   quadLineFit1007->SetParError(1,0.879557);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.63699);
   Graph_mI10_ppm1007->SetMaximum(73.95501);
   ...
   quadLineFit1008->SetChisquare(4.022395);
   ...
   quadLineFit1008->SetParameter(0,74.47582);
   quadLineFit1008->SetParError(0,0.04760433);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.22821);
   quadLineFit1008->SetParError(1,0.774432);
   ...
   quadLineFit1009->SetChisquare(4.022395);
   ...
   quadLineFit1009->SetParameter(0,74.47582);
   quadLineFit1009->SetParError(0,0.04760433);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.22821);
   quadLineFit1009->SetParError(1,0.774432);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.25956);
   Graph_mI30_ppm1009->SetMaximum(73.00244);
   ...
   quadLineFit1010->SetChisquare(2.188618);
   ...
   quadLineFit1010->SetParameter(0,74.45296);
   quadLineFit1010->SetParError(0,0.04497335);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.531);
   quadLineFit1010->SetParError(1,0.7778736);
   ...
   quadLineFit1011->SetChisquare(2.188618);
   ...
   quadLineFit1011->SetParameter(0,74.45296);
   quadLineFit1011->SetParError(0,0.04497335);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.531);
   quadLineFit1011->SetParError(1,0.7778736);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.35535);
   Graph_mI50_ppm1011->SetMaximum(72.02057);
   ...
   quadLineFit1012->SetChisquare(0.745417);
   ...
   quadLineFit1012->SetParameter(0,74.37784);
   quadLineFit1012->SetParError(0,0.09089843);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.17471);
   quadLineFit1012->SetParError(1,1.626128);
   ...
   quadLineFit1013->SetChisquare(0.745417);
   ...
   quadLineFit1013->SetParameter(0,74.37784);
   quadLineFit1013->SetParError(0,0.09089843);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.17471);
   quadLineFit1013->SetParError(1,1.626128);
