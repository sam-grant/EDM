...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.19842,70,64.13888);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.86469);
   Graph_Graph01035->SetMaximum(52.80515);
   ...
   mainFit1036->SetChisquare(1.05009);
   ...
   mainFit1036->SetParameter(0,-1.866688);
   mainFit1036->SetParError(0,0.3780784);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9207375);
   mainFit1036->SetParError(1,0.01307949);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.87#pm0.378");
   pt_LaTex = pt->AddText("#minus2.03#pm0.404");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.027383,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.027383,-37.86469,2.027383,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.05009);
   ...
   mainFit1037->SetParameter(0,-1.866688);
   mainFit1037->SetParError(0,0.3780784);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9207375);
   mainFit1037->SetParError(1,0.01307949);
