...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.20585);
   Graph_Graph01033->SetMaximum(54.65434);
   ...
   mainFit1034->SetChisquare(1.133283);
   ...
   mainFit1034->SetParameter(0,-1.746334);
   mainFit1034->SetParError(0,0.4520356);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.916126);
   mainFit1034->SetParError(1,0.01490899);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.378");
   pt_LaTex = pt->AddText("0.916#pm0.0149");
   pt_LaTex = pt->AddText("#minus1.75#pm0.452");
   pt_LaTex = pt->AddText("#minus1.91#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.906216,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.906216,-58.20585,1.906216,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.133283);
   ...
   mainFit1035->SetParameter(0,-1.746334);
   mainFit1035->SetParError(0,0.4520356);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.916126);
   mainFit1035->SetParError(1,0.01490899);
