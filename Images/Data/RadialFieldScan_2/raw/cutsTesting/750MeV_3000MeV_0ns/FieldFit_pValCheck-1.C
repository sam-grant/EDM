...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.20585);
   Graph_Graph01023->SetMaximum(54.65434);
   ...
   mainFit1024->SetChisquare(1.208871);
   ...
   mainFit1024->SetParameter(0,-1.821282);
   mainFit1024->SetParError(0,0.3605178);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9185818);
   mainFit1024->SetParError(1,0.01191674);
   ...
   mainFit1025->SetChisquare(1.208871);
   ...
   mainFit1025->SetParameter(0,-1.821282);
   mainFit1025->SetParError(0,0.3605178);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9185818);
   mainFit1025->SetParError(1,0.01191674);
