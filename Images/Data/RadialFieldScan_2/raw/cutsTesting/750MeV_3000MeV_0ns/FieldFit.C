...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.31338,75,68.76187);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-58.20585);
   Graph_Graph01020->SetMaximum(54.65434);
   ...
   mainFit1021->SetChisquare(1.208871);
   ...
   mainFit1021->SetParameter(0,-1.821282);
   mainFit1021->SetParError(0,0.3605178);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9185818);
   mainFit1021->SetParError(1,0.01191674);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.302");
   pt_LaTex = pt->AddText("0.919#pm0.0119");
   pt_LaTex = pt->AddText("#minus1.82#pm0.361");
   pt_LaTex = pt->AddText("#minus1.98#pm0.389");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.982711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.982711,-58.20585,1.982711,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.208871);
   ...
   mainFit1022->SetParameter(0,-1.821282);
   mainFit1022->SetParError(0,0.3605178);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9185818);
   mainFit1022->SetParError(1,0.01191674);
