...
//=========  (Fri Apr 23 18:37:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.20585);
   Graph_Graph01027->SetMaximum(54.65434);
   ...
   mainFit1028->SetChisquare(0.7114922);
   ...
   mainFit1028->SetParameter(0,-1.693216);
   mainFit1028->SetParError(0,0.4036865);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9227735);
   mainFit1028->SetParError(1,0.01331256);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.69#pm0.404");
   pt_LaTex = pt->AddText("#minus1.83#pm 0.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.83492,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.83492,-58.20585,1.83492,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7114922);
   ...
   mainFit1029->SetParameter(0,-1.693216);
   mainFit1029->SetParError(0,0.4036865);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9227735);
   mainFit1029->SetParError(1,0.01331256);
