...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.83294);
   Graph_Graph01023->SetMaximum(56.17343);
   ...
   mainFit1024->SetChisquare(9.170145);
   ...
   mainFit1024->SetParameter(0,-1.655148);
   mainFit1024->SetParError(0,0.4302273);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.911775);
   mainFit1024->SetParError(1,0.01424788);
   ...
   pt_LaTex = pt->AddText("0.912#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.66#pm 0.43");
   pt_LaTex = pt->AddText("#minus1.82#pm0.468");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.815303,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.815303,-58.83294,1.815303,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(9.170145);
   ...
   mainFit1025->SetParameter(0,-1.655148);
   mainFit1025->SetParError(0,0.4302273);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.911775);
   mainFit1025->SetParError(1,0.01424788);
