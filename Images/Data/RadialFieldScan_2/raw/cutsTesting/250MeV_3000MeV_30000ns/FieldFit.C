...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.83294);
   Graph_Graph01020->SetMaximum(56.17343);
   ...
   mainFit1021->SetChisquare(9.170145);
   ...
   mainFit1021->SetParameter(0,-1.655148);
   mainFit1021->SetParError(0,0.4302273);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.911775);
   mainFit1021->SetParError(1,0.01424788);
   ...
   mainFit1022->SetChisquare(9.170145);
   ...
   mainFit1022->SetParameter(0,-1.655148);
   mainFit1022->SetParError(0,0.4302273);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.911775);
   mainFit1022->SetParError(1,0.01424788);
