...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.58673,70,65.62482);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.16557);
   Graph_Graph01035->SetMaximum(54.20367);
   ...
   mainFit1036->SetChisquare(9.168667);
   ...
   mainFit1036->SetParameter(0,-1.649959);
   mainFit1036->SetParError(0,0.4511271);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9115345);
   mainFit1036->SetParError(1,0.01564286);
   ...
   pt_LaTex = pt->AddText("0.912#pm0.0156");
   pt_LaTex = pt->AddText("#minus1.65#pm0.451");
   pt_LaTex = pt->AddText("#minus1.81#pm0.488");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.810089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.810089,-37.16557,1.810089,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.168667);
   ...
   mainFit1037->SetParameter(0,-1.649959);
   mainFit1037->SetParError(0,0.4511271);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9115345);
   mainFit1037->SetParError(1,0.01564286);
