...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.83294);
   Graph_Graph01029->SetMaximum(56.17343);
   ...
   mainFit1030->SetChisquare(6.727334);
   ...
   mainFit1030->SetParameter(0,-1.942259);
   mainFit1030->SetParError(0,0.4677972);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9100543);
   mainFit1030->SetParError(1,0.01429072);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.94#pm0.468");
   pt_LaTex = pt->AddText("#minus2.13#pm0.511");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.134223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.134223,-58.83294,2.134223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.727334);
   ...
   mainFit1031->SetParameter(0,-1.942259);
   mainFit1031->SetParError(0,0.4677972);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9100543);
   mainFit1031->SetParError(1,0.01429072);
