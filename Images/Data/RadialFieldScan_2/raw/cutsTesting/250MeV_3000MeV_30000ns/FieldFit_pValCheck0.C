...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.72594,50,43.13526);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.63982);
   Graph_Graph01025->SetMaximum(32.04914);
   ...
   mainFit1026->SetChisquare(5.365254);
   ...
   mainFit1026->SetParameter(0,-1.990244);
   mainFit1026->SetParError(0,0.4632523);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8892382);
   mainFit1026->SetParError(1,0.01834613);
   ...
   pt_LaTex = pt->AddText("0.889#pm0.0183");
   pt_LaTex = pt->AddText("#minus1.99#pm0.463");
   pt_LaTex = pt->AddText("#minus2.24#pm0.528");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.238145,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.238145,-56.63982,2.238145,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.365254);
   ...
   mainFit1027->SetParameter(0,-1.990244);
   mainFit1027->SetParError(0,0.4632523);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8892382);
   mainFit1027->SetParError(1,0.01834613);
