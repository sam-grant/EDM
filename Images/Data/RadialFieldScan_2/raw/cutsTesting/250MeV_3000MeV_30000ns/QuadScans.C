...
//=========  (Fri Apr 23 19:01:09 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.0196233);
   ...
   quadLineFit1002->SetParameter(0,74.5069);
   quadLineFit1002->SetParError(0,0.06598809);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.48257);
   quadLineFit1002->SetParError(1,1.107);
   ...
   quadLineFit1003->SetChisquare(0.0196233);
   ...
   quadLineFit1003->SetParameter(0,74.5069);
   quadLineFit1003->SetParError(0,0.06598809);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.48257);
   quadLineFit1003->SetParError(1,1.107);
   ...
   Graph_30_ppm1003->SetMinimum(75.80974);
   Graph_30_ppm1003->SetMaximum(76.39882);
   ...
   quadLineFit1004->SetChisquare(3.607659);
   ...
   quadLineFit1004->SetParameter(0,74.63902);
   quadLineFit1004->SetParError(0,0.05514662);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.75209);
   quadLineFit1004->SetParError(1,0.9063061);
   ...
   quadLineFit1005->SetChisquare(3.607659);
   ...
   quadLineFit1005->SetParameter(0,74.63902);
   quadLineFit1005->SetParError(0,0.05514662);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.75209);
   quadLineFit1005->SetParError(1,0.9063061);
   ...
   Graph_10_ppm1005->SetMinimum(74.79082);
   Graph_10_ppm1005->SetMaximum(75.04809);
   ...
   quadLineFit1006->SetChisquare(1.066106);
   ...
   quadLineFit1006->SetParameter(0,74.36125);
   quadLineFit1006->SetParError(0,0.06458948);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.954724);
   quadLineFit1006->SetParError(1,1.047505);
   ...
   quadLineFit1007->SetChisquare(1.066106);
   ...
   quadLineFit1007->SetParameter(0,74.36125);
   quadLineFit1007->SetParError(0,0.06458948);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.954724);
   quadLineFit1007->SetParError(1,1.047505);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.55334);
   Graph_mI10_ppm1007->SetMaximum(73.88624);
   ...
   quadLineFit1008->SetChisquare(7.58306);
   ...
   quadLineFit1008->SetParameter(0,74.41273);
   quadLineFit1008->SetParError(0,0.05677183);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.35685);
   quadLineFit1008->SetParError(1,0.9240259);
   ...
   quadLineFit1009->SetChisquare(7.58306);
   ...
   quadLineFit1009->SetParameter(0,74.41273);
   quadLineFit1009->SetParError(0,0.05677183);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.35685);
   quadLineFit1009->SetParError(1,0.9240259);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.17465);
   Graph_mI30_ppm1009->SetMaximum(72.89803);
   ...
   quadLineFit1010->SetChisquare(0.8433557);
   ...
   quadLineFit1010->SetParameter(0,74.30032);
   quadLineFit1010->SetParError(0,0.05363654);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.62321);
   quadLineFit1010->SetParError(1,0.9282588);
   ...
   quadLineFit1011->SetChisquare(0.8433557);
   ...
   quadLineFit1011->SetParameter(0,74.30032);
   quadLineFit1011->SetParError(0,0.05363654);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.62321);
   quadLineFit1011->SetParError(1,0.9282588);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.23892);
   Graph_mI50_ppm1011->SetMaximum(71.91228);
   ...
   quadLineFit1012->SetChisquare(0.1002495);
   ...
   quadLineFit1012->SetParameter(0,74.27072);
   quadLineFit1012->SetParError(0,0.1083412);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.31052);
   quadLineFit1012->SetParError(1,1.938558);
   ...
   quadLineFit1013->SetChisquare(0.1002495);
   ...
   quadLineFit1013->SetParameter(0,74.27072);
   quadLineFit1013->SetParError(0,0.1083412);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.31052);
   quadLineFit1013->SetParError(1,1.938558);
