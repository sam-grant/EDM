...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.83294);
   Graph_Graph01033->SetMaximum(56.17343);
   ...
   mainFit1034->SetChisquare(8.828921);
   ...
   mainFit1034->SetParameter(0,-1.844912);
   mainFit1034->SetParError(0,0.5390726);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9180366);
   mainFit1034->SetParError(1,0.01782202);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0178");
   pt_LaTex = pt->AddText("#minus1.84#pm0.539");
   pt_LaTex = pt->AddText("#minus2.01#pm 0.57");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.009628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.009628,-58.83294,2.009628,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.828921);
   ...
   mainFit1035->SetParameter(0,-1.844912);
   mainFit1035->SetParError(0,0.5390726);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9180366);
   mainFit1035->SetParError(1,0.01782202);
