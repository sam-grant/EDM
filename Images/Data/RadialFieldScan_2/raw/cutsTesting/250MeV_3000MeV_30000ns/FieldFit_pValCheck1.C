...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.83294);
   Graph_Graph01027->SetMaximum(56.17343);
   ...
   mainFit1028->SetChisquare(1.773016);
   ...
   mainFit1028->SetParameter(0,-1.062778);
   mainFit1028->SetParError(0,0.4822218);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9312254);
   mainFit1028->SetParError(1,0.0159408);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.591");
   pt_LaTex = pt->AddText("0.931#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.06#pm0.482");
   pt_LaTex = pt->AddText("#minus1.14#pm 0.52");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.141268,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.141268,-58.83294,1.141268,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.773016);
   ...
   mainFit1029->SetParameter(0,-1.062778);
   mainFit1029->SetParError(0,0.4822218);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9312254);
   mainFit1029->SetParError(1,0.0159408);
