...
//=========  (Fri Apr 23 19:01:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02100929);
   Graph_Graph11015->SetMaximum(0.02039834);
   ...
   Graph_Graph21016->SetMinimum(-0.009712306);
   Graph_Graph21016->SetMaximum(0.01142575);
   ...
   Graph_Graph31017->SetMinimum(-0.03101898);
   Graph_Graph31017->SetMaximum(0.03012049);
   ...
   Graph_Graph41018->SetMinimum(-0.006464317);
   Graph_Graph41018->SetMaximum(0.01084728);
   ...
   Graph_Graph51019->SetMinimum(-0.002780899);
   Graph_Graph51019->SetMaximum(0.003717501);
