...
//=========  (Wed Apr 21 14:52:15 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8308683);
   ...
   quadLineFit1002->SetParameter(0,74.85201);
   quadLineFit1002->SetParError(0,0.06493468);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.68426);
   quadLineFit1002->SetParError(1,1.088575);
   ...
   quadLineFit1003->SetChisquare(0.8308683);
   ...
   quadLineFit1003->SetParameter(0,74.85201);
   quadLineFit1003->SetParError(0,0.06493468);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.68426);
   quadLineFit1003->SetParError(1,1.088575);
   ...
   Graph_30_ppm1003->SetMinimum(75.98076);
   Graph_30_ppm1003->SetMaximum(76.59367);
   ...
   quadLineFit1004->SetChisquare(1.811844);
   ...
   quadLineFit1004->SetParameter(0,74.77992);
   quadLineFit1004->SetParError(0,0.05466019);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.43275);
   quadLineFit1004->SetParError(1,0.8978771);
   ...
   quadLineFit1005->SetChisquare(1.811844);
   ...
   quadLineFit1005->SetParameter(0,74.77992);
   quadLineFit1005->SetParError(0,0.05466019);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.43275);
   quadLineFit1005->SetParError(1,0.8978771);
   ...
   Graph_10_ppm1005->SetMinimum(75.05949);
   Graph_10_ppm1005->SetMaximum(75.26529);
   ...
   quadLineFit1006->SetChisquare(1.578725);
   ...
   quadLineFit1006->SetParameter(0,74.73455);
   quadLineFit1006->SetParError(0,0.06416612);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.80465);
   quadLineFit1006->SetParError(1,1.040044);
   ...
   quadLineFit1007->SetChisquare(1.578725);
   ...
   quadLineFit1007->SetParameter(0,74.73455);
   quadLineFit1007->SetParError(0,0.06416612);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.80465);
   quadLineFit1007->SetParError(1,1.040044);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.91889);
   Graph_mI10_ppm1007->SetMaximum(74.22225);
   ...
   quadLineFit1008->SetChisquare(11.30969);
   ...
   quadLineFit1008->SetParameter(0,74.6468);
   quadLineFit1008->SetParError(0,0.05626216);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.690935);
   quadLineFit1008->SetParError(1,0.915187);
   ...
   quadLineFit1009->SetChisquare(11.30969);
   ...
   quadLineFit1009->SetParameter(0,74.6468);
   quadLineFit1009->SetParError(0,0.05626216);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.690935);
   quadLineFit1009->SetParError(1,0.915187);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.58518);
   Graph_mI30_ppm1009->SetMaximum(73.29534);
   ...
   quadLineFit1010->SetChisquare(0.4300002);
   ...
   quadLineFit1010->SetParameter(0,74.67436);
   quadLineFit1010->SetParError(0,0.05314358);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.2417);
   quadLineFit1010->SetParError(1,0.9190981);
   ...
   quadLineFit1011->SetChisquare(0.4300002);
   ...
   quadLineFit1011->SetParameter(0,74.67436);
   quadLineFit1011->SetParError(0,0.05314358);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.2417);
   quadLineFit1011->SetParError(1,0.9190981);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.70713);
   Graph_mI50_ppm1011->SetMaximum(72.36527);
   ...
   quadLineFit1012->SetChisquare(0.6313958);
   ...
   quadLineFit1012->SetParameter(0,74.67352);
   quadLineFit1012->SetParError(0,0.1073276);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.24001);
   quadLineFit1012->SetParError(1,1.919788);
   ...
   quadLineFit1013->SetChisquare(0.6313958);
   ...
   quadLineFit1013->SetParameter(0,74.67352);
   quadLineFit1013->SetParError(0,0.1073276);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.24001);
   quadLineFit1013->SetParError(1,1.919788);
