...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.25306);
   Graph_Graph01027->SetMaximum(51.8661);
   ...
   mainFit1028->SetChisquare(1.109261);
   ...
   mainFit1028->SetParameter(0,-1.746026);
   mainFit1028->SetParError(0,0.477011);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8734919);
   mainFit1028->SetParError(1,0.01572414);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.37");
   pt_LaTex = pt->AddText("0.873#pm0.0157");
   pt_LaTex = pt->AddText("#minus1.75#pm0.477");
   pt_LaTex = pt->AddText("   #minus2#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.998903,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.998903,-57.25306,1.998903,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.109261);
   ...
   mainFit1029->SetParameter(0,-1.746026);
   mainFit1029->SetParError(0,0.477011);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8734919);
   mainFit1029->SetParError(1,0.01572414);
