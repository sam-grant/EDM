...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.14421,70,60.75625);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.35416);
   Graph_Graph01035->SetMaximum(49.9662);
   ...
   mainFit1036->SetChisquare(0.8774933);
   ...
   mainFit1036->SetParameter(0,-1.686019);
   mainFit1036->SetParError(0,0.4467845);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8702607);
   mainFit1036->SetParError(1,0.01545198);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0155");
   pt_LaTex = pt->AddText("#minus1.69#pm0.447");
   pt_LaTex = pt->AddText("#minus1.94#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.937372,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.937372,-36.35416,1.937372,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.8774933);
   ...
   mainFit1037->SetParameter(0,-1.686019);
   mainFit1037->SetParError(0,0.4467845);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8702607);
   mainFit1037->SetParError(1,0.01545198);
