...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.5324,50,43.70324);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.50884);
   Graph_Graph01025->SetMaximum(32.67967);
   ...
   mainFit1026->SetChisquare(1.021259);
   ...
   mainFit1026->SetParameter(0,-1.700028);
   mainFit1026->SetParError(0,0.4590772);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8767522);
   mainFit1026->SetParError(1,0.01817313);
   ...
   pt_LaTex = pt->AddText("0.877#pm0.0182");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.459");
   pt_LaTex = pt->AddText("#minus1.94#pm 0.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.939006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.939006,-55.50884,1.939006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.021259);
   ...
   mainFit1027->SetParameter(0,-1.700028);
   mainFit1027->SetParError(0,0.4590772);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8767522);
   mainFit1027->SetParError(1,0.01817313);
