...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.25306);
   Graph_Graph01033->SetMaximum(51.8661);
   ...
   mainFit1034->SetChisquare(0.911691);
   ...
   mainFit1034->SetParameter(0,-1.60754);
   mainFit1034->SetParError(0,0.5341149);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8686236);
   mainFit1034->SetParError(1,0.01760897);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.61#pm0.534");
   pt_LaTex = pt->AddText("#minus1.85#pm0.598");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.850675,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.850675,-57.25306,1.850675,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.911691);
   ...
   mainFit1035->SetParameter(0,-1.60754);
   mainFit1035->SetParError(0,0.5341149);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8686236);
   mainFit1035->SetParError(1,0.01760897);
