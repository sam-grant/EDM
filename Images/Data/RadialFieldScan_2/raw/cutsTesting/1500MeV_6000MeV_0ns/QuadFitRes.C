...
//=========  (Wed Apr 21 14:52:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01270605);
   Graph_Graph11015->SetMaximum(0.01647318);
   ...
   Graph_Graph21016->SetMinimum(-0.01169676);
   Graph_Graph21016->SetMaximum(0.01373086);
   ...
   Graph_Graph31017->SetMinimum(-0.04251939);
   Graph_Graph31017->SetMaximum(0.03828051);
   ...
   Graph_Graph41018->SetMinimum(-0.01063061);
   Graph_Graph41018->SetMaximum(0.005175743);
   ...
   Graph_Graph51019->SetMinimum(-0.006950213);
   Graph_Graph51019->SetMaximum(0.009249905);
