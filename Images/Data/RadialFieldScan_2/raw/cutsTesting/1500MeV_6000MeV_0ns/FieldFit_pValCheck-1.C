...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.25306);
   Graph_Graph01023->SetMaximum(51.8661);
   ...
   mainFit1024->SetChisquare(1.109787);
   ...
   mainFit1024->SetParameter(0,-1.750917);
   mainFit1024->SetParError(0,0.4259957);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8733254);
   mainFit1024->SetParError(1,0.01407654);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.277");
   pt_LaTex = pt->AddText("0.873#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.75#pm0.426");
   pt_LaTex = pt->AddText("   #minus2#pm0.484");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.004885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.004885,-57.25306,2.004885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.109787);
   ...
   mainFit1025->SetParameter(0,-1.750917);
   mainFit1025->SetParError(0,0.4259957);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8733254);
   mainFit1025->SetParError(1,0.01407654);
