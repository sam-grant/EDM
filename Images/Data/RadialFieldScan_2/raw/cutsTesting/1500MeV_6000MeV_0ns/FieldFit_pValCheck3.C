...
//=========  (Wed Apr 21 14:52:16 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.89296,75,65.506);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-57.25306);
   Graph_Graph01031->SetMaximum(51.8661);
   ...
   mainFit1032->SetChisquare(0.08961593);
   ...
   mainFit1032->SetParameter(0,-1.996747);
   mainFit1032->SetParError(0,0.4906105);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8771248);
   mainFit1032->SetParError(1,0.01456872);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0299");
   pt_LaTex = pt->AddText("0.877#pm0.0146");
   pt_LaTex = pt->AddText("   #minus2#pm0.491");
   pt_LaTex = pt->AddText("#minus2.28#pm0.551");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.276468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.276468,-57.25306,2.276468,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.08961593);
   ...
   mainFit1033->SetParameter(0,-1.996747);
   mainFit1033->SetParError(0,0.4906105);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8771248);
   mainFit1033->SetParError(1,0.01456872);
