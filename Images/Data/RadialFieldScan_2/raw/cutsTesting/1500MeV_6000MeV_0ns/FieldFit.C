...
//=========  (Wed Apr 21 14:52:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.25306);
   Graph_Graph01020->SetMaximum(51.8661);
   ...
   mainFit1021->SetChisquare(1.109787);
   ...
   mainFit1021->SetParameter(0,-1.750917);
   mainFit1021->SetParError(0,0.4259957);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8733254);
   mainFit1021->SetParError(1,0.01407654);
   ...
   mainFit1022->SetChisquare(1.109787);
   ...
   mainFit1022->SetParameter(0,-1.750917);
   mainFit1022->SetParError(0,0.4259957);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8733254);
   mainFit1022->SetParError(1,0.01407654);
