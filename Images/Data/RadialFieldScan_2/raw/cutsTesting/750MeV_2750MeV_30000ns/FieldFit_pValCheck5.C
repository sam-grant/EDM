...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.4639,70,63.30437);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.48707);
   Graph_Graph01035->SetMaximum(52.32754);
   ...
   mainFit1036->SetChisquare(5.584326);
   ...
   mainFit1036->SetParameter(0,-1.32501);
   mainFit1036->SetParError(0,0.515892);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8679007);
   mainFit1036->SetParError(1,0.01800527);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.018");
   pt_LaTex = pt->AddText("#minus1.33#pm0.516");
   pt_LaTex = pt->AddText("#minus1.53#pm0.587");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.526684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.526684,-35.48707,1.526684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.584326);
   ...
   mainFit1037->SetParameter(0,-1.32501);
   mainFit1037->SetParError(0,0.515892);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8679007);
   mainFit1037->SetParError(1,0.01800527);
