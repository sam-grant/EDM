...
//=========  (Mon Apr 26 21:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0196074);
   Graph_Graph11015->SetMaximum(0.02093652);
   ...
   Graph_Graph21016->SetMinimum(-0.0118426);
   Graph_Graph21016->SetMaximum(0.01394615);
   ...
   Graph_Graph31017->SetMinimum(-0.03711545);
   Graph_Graph31017->SetMaximum(0.03046037);
   ...
   Graph_Graph41018->SetMinimum(-0.01658588);
   Graph_Graph41018->SetMaximum(0.02286597);
   ...
   Graph_Graph51019->SetMinimum(-0.008835954);
   Graph_Graph51019->SetMaximum(0.01181143);
