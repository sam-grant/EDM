...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.53306,50,41.5929);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.92046);
   Graph_Graph01025->SetMaximum(30.9803);
   ...
   mainFit1026->SetChisquare(2.447833);
   ...
   mainFit1026->SetParameter(0,-1.663322);
   mainFit1026->SetParError(0,0.5292299);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8444835);
   mainFit1026->SetParError(1,0.02096433);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.816");
   pt_LaTex = pt->AddText("0.844#pm0.021");
   pt_LaTex = pt->AddText("#minus1.66#pm0.529");
   pt_LaTex = pt->AddText("#minus1.97#pm0.634");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.969632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.969632,-53.92046,1.969632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.447833);
   ...
   mainFit1027->SetParameter(0,-1.663322);
   mainFit1027->SetParError(0,0.5292299);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8444835);
   mainFit1027->SetParError(1,0.02096433);
