...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.0309);
   Graph_Graph01023->SetMaximum(54.19517);
   ...
   mainFit1024->SetChisquare(5.585634);
   ...
   mainFit1024->SetParameter(0,-1.319417);
   mainFit1024->SetParError(0,0.4923381);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8676253);
   mainFit1024->SetParError(1,0.01639324);
   ...
   mainFit1025->SetChisquare(5.585634);
   ...
   mainFit1025->SetParameter(0,-1.319417);
   mainFit1025->SetParError(0,0.4923381);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8676253);
   mainFit1025->SetParError(1,0.01639324);
