...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.0309);
   Graph_Graph01020->SetMaximum(54.19517);
   ...
   mainFit1021->SetChisquare(5.585634);
   ...
   mainFit1021->SetParameter(0,-1.319417);
   mainFit1021->SetParError(0,0.4923381);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8676253);
   mainFit1021->SetParError(1,0.01639324);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.32#pm0.492");
   pt_LaTex = pt->AddText("#minus1.52#pm0.564");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.520722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.520722,-56.0309,1.520722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.585634);
   ...
   mainFit1022->SetParameter(0,-1.319417);
   mainFit1022->SetParError(0,0.4923381);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8676253);
   mainFit1022->SetParError(1,0.01639324);
