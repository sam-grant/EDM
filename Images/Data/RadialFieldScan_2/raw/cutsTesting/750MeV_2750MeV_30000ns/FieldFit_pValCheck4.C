...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.0309);
   Graph_Graph01033->SetMaximum(54.19517);
   ...
   mainFit1034->SetChisquare(5.484198);
   ...
   mainFit1034->SetParameter(0,-1.43729);
   mainFit1034->SetParError(0,0.6158913);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8715523);
   mainFit1034->SetParError(1,0.02050115);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0205");
   pt_LaTex = pt->AddText("#minus1.44#pm0.616");
   pt_LaTex = pt->AddText("#minus1.65#pm 0.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.649115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.649115,-56.0309,1.649115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.484198);
   ...
   mainFit1035->SetParameter(0,-1.43729);
   mainFit1035->SetParError(0,0.6158913);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8715523);
   mainFit1035->SetParError(1,0.02050115);
