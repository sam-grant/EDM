...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.80916,75,67.97342);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.0309);
   Graph_Graph01027->SetMaximum(54.19517);
   ...
   mainFit1028->SetChisquare(0.4657516);
   ...
   mainFit1028->SetParameter(0,-0.7465178);
   mainFit1028->SetParError(0,0.553632);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8866782);
   mainFit1028->SetParError(1,0.01842838);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.155");
   pt_LaTex = pt->AddText("0.887#pm0.0184");
   pt_LaTex = pt->AddText("#minus0.747#pm0.554");
   pt_LaTex = pt->AddText("#minus0.842#pm0.626");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8419264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8419264,-56.0309,0.8419264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4657516);
   ...
   mainFit1029->SetParameter(0,-0.7465178);
   mainFit1029->SetParError(0,0.553632);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8866782);
   mainFit1029->SetParError(1,0.01842838);
