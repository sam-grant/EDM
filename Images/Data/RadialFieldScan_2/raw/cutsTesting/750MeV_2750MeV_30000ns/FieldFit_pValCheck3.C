...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.0309);
   Graph_Graph01031->SetMaximum(54.19517);
   ...
   mainFit1032->SetChisquare(5.526151);
   ...
   mainFit1032->SetParameter(0,-1.250834);
   mainFit1032->SetParError(0,0.5670286);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8665792);
   mainFit1032->SetParError(1,0.01695149);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.017");
   pt_LaTex = pt->AddText("#minus1.25#pm0.567");
   pt_LaTex = pt->AddText("#minus1.44#pm0.648");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.443416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.443416,-56.0309,1.443416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.526151);
   ...
   mainFit1033->SetParameter(0,-1.250834);
   mainFit1033->SetParError(0,0.5670286);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8665792);
   mainFit1033->SetParError(1,0.01695149);
