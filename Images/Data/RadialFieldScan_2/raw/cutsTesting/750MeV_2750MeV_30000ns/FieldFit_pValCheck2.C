...
//=========  (Mon Apr 26 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.0309);
   Graph_Graph01029->SetMaximum(54.19517);
   ...
   mainFit1030->SetChisquare(4.756831);
   ...
   mainFit1030->SetParameter(0,-1.511761);
   mainFit1030->SetParError(0,0.5357473);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8664032);
   mainFit1030->SetParError(1,0.01644864);
   ...
   pt_LaTex = pt->AddText("0.866#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.51#pm0.536");
   pt_LaTex = pt->AddText("#minus1.74#pm0.616");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.74487,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.74487,-56.0309,1.74487,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.756831);
   ...
   mainFit1031->SetParameter(0,-1.511761);
   mainFit1031->SetParError(0,0.5357473);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8664032);
   mainFit1031->SetParError(1,0.01644864);
