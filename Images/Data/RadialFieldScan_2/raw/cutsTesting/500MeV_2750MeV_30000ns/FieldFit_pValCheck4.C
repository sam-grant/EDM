...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.81855);
   Graph_Graph01033->SetMaximum(56.16698);
   ...
   mainFit1034->SetChisquare(8.838543);
   ...
   mainFit1034->SetParameter(0,-1.667991);
   mainFit1034->SetParError(0,0.5819556);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9067409);
   mainFit1034->SetParError(1,0.01903218);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.95");
   pt_LaTex = pt->AddText("0.907#pm0.019");
   pt_LaTex = pt->AddText("#minus1.67#pm0.582");
   pt_LaTex = pt->AddText("#minus1.84#pm0.624");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.839545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.839545,-57.81855,1.839545,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.838543);
   ...
   mainFit1035->SetParameter(0,-1.667991);
   mainFit1035->SetParError(0,0.5819556);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9067409);
   mainFit1035->SetParError(1,0.01903218);
