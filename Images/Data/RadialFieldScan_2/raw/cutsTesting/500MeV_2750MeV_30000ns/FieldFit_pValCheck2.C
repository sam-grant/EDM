...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.81855);
   Graph_Graph01029->SetMaximum(56.16698);
   ...
   mainFit1030->SetChisquare(8.484461);
   ...
   mainFit1030->SetParameter(0,-1.602105);
   mainFit1030->SetParError(0,0.503301);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8977736);
   mainFit1030->SetParError(1,0.0152539);
   ...
   pt_LaTex = pt->AddText("0.898#pm0.0153");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.503");
   pt_LaTex = pt->AddText("#minus1.78#pm0.557");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.784532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.784532,-57.81855,1.784532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(8.484461);
   ...
   mainFit1031->SetParameter(0,-1.602105);
   mainFit1031->SetParError(0,0.503301);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8977736);
   mainFit1031->SetParError(1,0.0152539);
