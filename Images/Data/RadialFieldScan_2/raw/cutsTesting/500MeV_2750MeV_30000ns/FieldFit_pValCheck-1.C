...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.81855);
   Graph_Graph01023->SetMaximum(56.16698);
   ...
   mainFit1024->SetChisquare(9.327071);
   ...
   mainFit1024->SetParameter(0,-1.42201);
   mainFit1024->SetParError(0,0.4634842);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8987511);
   mainFit1024->SetParError(1,0.01521678);
   ...
   mainFit1025->SetChisquare(9.327071);
   ...
   mainFit1025->SetParameter(0,-1.42201);
   mainFit1025->SetParError(0,0.4634842);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8987511);
   mainFit1025->SetParError(1,0.01521678);
