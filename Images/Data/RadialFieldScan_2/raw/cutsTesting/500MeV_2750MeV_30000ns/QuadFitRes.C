...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01444453);
   Graph_Graph11015->SetMaximum(0.01430089);
   ...
   Graph_Graph21016->SetMinimum(-0.01404982);
   Graph_Graph21016->SetMaximum(0.01654271);
   ...
   Graph_Graph31017->SetMinimum(-0.0376943);
   Graph_Graph31017->SetMaximum(0.028879);
   ...
   Graph_Graph41018->SetMinimum(-0.01265218);
   Graph_Graph41018->SetMaximum(0.02069171);
   ...
   Graph_Graph51019->SetMinimum(-0.005961249);
   Graph_Graph51019->SetMaximum(0.007967389);
