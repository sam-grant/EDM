...
//=========  (Mon Apr 26 21:44:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1552295);
   ...
   quadLineFit1002->SetParameter(0,74.45578);
   quadLineFit1002->SetParError(0,0.0689648);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.51179);
   quadLineFit1002->SetParError(1,1.156391);
   ...
   quadLineFit1003->SetChisquare(0.1552295);
   ...
   quadLineFit1003->SetParameter(0,74.45578);
   quadLineFit1003->SetParError(0,0.0689648);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.51179);
   quadLineFit1003->SetParError(1,1.156391);
   ...
   Graph_30_ppm1003->SetMinimum(75.76636);
   Graph_30_ppm1003->SetMaximum(76.35341);
   ...
   quadLineFit1004->SetChisquare(1.447174);
   ...
   quadLineFit1004->SetParameter(0,74.62464);
   quadLineFit1004->SetParError(0,0.05958132);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.30526);
   quadLineFit1004->SetParError(1,0.9792587);
   ...
   quadLineFit1005->SetChisquare(1.447174);
   ...
   quadLineFit1005->SetParameter(0,74.62464);
   quadLineFit1005->SetParError(0,0.05958132);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.30526);
   quadLineFit1005->SetParError(1,0.9792587);
   ...
   Graph_10_ppm1005->SetMinimum(74.77229);
   Graph_10_ppm1005->SetMaximum(75.02384);
   ...
   quadLineFit1006->SetChisquare(1.913854);
   ...
   quadLineFit1006->SetParameter(0,74.36337);
   quadLineFit1006->SetParError(0,0.06977101);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.513599);
   quadLineFit1006->SetParError(1,1.131558);
   ...
   quadLineFit1007->SetChisquare(1.913854);
   ...
   quadLineFit1007->SetParameter(0,74.36337);
   quadLineFit1007->SetParError(0,0.06977101);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.513599);
   quadLineFit1007->SetParError(1,1.131558);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.54278);
   Graph_mI10_ppm1007->SetMaximum(73.87208);
   ...
   quadLineFit1008->SetChisquare(8.449563);
   ...
   quadLineFit1008->SetParameter(0,74.36373);
   quadLineFit1008->SetParError(0,0.06130057);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.83644);
   quadLineFit1008->SetParError(1,0.9977553);
   ...
   quadLineFit1009->SetChisquare(8.449563);
   ...
   quadLineFit1009->SetParameter(0,74.36373);
   quadLineFit1009->SetParError(0,0.06130057);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.83644);
   quadLineFit1009->SetParError(1,0.9977553);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.18175);
   Graph_mI30_ppm1009->SetMaximum(72.88974);
   ...
   quadLineFit1010->SetChisquare(2.754795);
   ...
   quadLineFit1010->SetParameter(0,74.25949);
   quadLineFit1010->SetParError(0,0.05796276);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.88539);
   quadLineFit1010->SetParError(1,1.003122);
   ...
   quadLineFit1011->SetChisquare(2.754795);
   ...
   quadLineFit1011->SetParameter(0,74.25949);
   quadLineFit1011->SetParError(0,0.05796276);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.88539);
   quadLineFit1011->SetParError(1,1.003122);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.25232);
   Graph_mI50_ppm1011->SetMaximum(71.91372);
   ...
   quadLineFit1012->SetChisquare(0.3947684);
   ...
   quadLineFit1012->SetParameter(0,74.21899);
   quadLineFit1012->SetParError(0,0.1170139);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.226);
   quadLineFit1012->SetParError(1,2.093761);
   ...
   quadLineFit1013->SetChisquare(0.3947684);
   ...
   quadLineFit1013->SetParameter(0,74.21899);
   quadLineFit1013->SetParError(0,0.1170139);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.226);
   quadLineFit1013->SetParError(1,2.093761);
