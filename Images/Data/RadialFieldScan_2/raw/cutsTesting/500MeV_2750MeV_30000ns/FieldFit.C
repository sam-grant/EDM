...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.81855);
   Graph_Graph01020->SetMaximum(56.16698);
   ...
   mainFit1021->SetChisquare(9.327071);
   ...
   mainFit1021->SetParameter(0,-1.42201);
   mainFit1021->SetParError(0,0.4634842);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8987511);
   mainFit1021->SetParError(1,0.01521678);
   ...
   pt_LaTex = pt->AddText("#minus1.42#pm0.463");
   pt_LaTex = pt->AddText("#minus1.58#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.582207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.582207,-57.81855,1.582207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.327071);
   ...
   mainFit1022->SetParameter(0,-1.42201);
   mainFit1022->SetParError(0,0.4634842);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8987511);
   mainFit1022->SetParError(1,0.01521678);
