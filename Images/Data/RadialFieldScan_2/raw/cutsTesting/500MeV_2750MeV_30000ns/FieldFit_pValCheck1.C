...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.06675,75,70.41517);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.81855);
   Graph_Graph01027->SetMaximum(56.16698);
   ...
   mainFit1028->SetChisquare(1.119637);
   ...
   mainFit1028->SetParameter(0,-0.7673143);
   mainFit1028->SetParError(0,0.5167609);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9197882);
   mainFit1028->SetParError(1,0.01689594);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.373");
   pt_LaTex = pt->AddText(" 0.92#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.767#pm0.517");
   pt_LaTex = pt->AddText("#minus0.834#pm0.563");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8342293,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8342293,-57.81855,0.8342293,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.119637);
   ...
   mainFit1029->SetParameter(0,-0.7673143);
   mainFit1029->SetParError(0,0.5167609);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9197882);
   mainFit1029->SetParError(1,0.01689594);
