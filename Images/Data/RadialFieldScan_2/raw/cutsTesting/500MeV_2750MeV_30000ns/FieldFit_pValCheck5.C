...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.77768,70,65.55736);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.44418);
   Graph_Graph01035->SetMaximum(54.22385);
   ...
   mainFit1036->SetChisquare(9.321927);
   ...
   mainFit1036->SetParameter(0,-1.432626);
   mainFit1036->SetParError(0,0.4865474);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8992438);
   mainFit1036->SetParError(1,0.01669577);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.11");
   pt_LaTex = pt->AddText("0.899#pm0.0167");
   pt_LaTex = pt->AddText("#minus1.43#pm0.487");
   pt_LaTex = pt->AddText("#minus1.59#pm0.534");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.593146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.593146,-36.44418,1.593146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.321927);
   ...
   mainFit1037->SetParameter(0,-1.432626);
   mainFit1037->SetParError(0,0.4865474);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8992438);
   mainFit1037->SetParError(1,0.01669577);
