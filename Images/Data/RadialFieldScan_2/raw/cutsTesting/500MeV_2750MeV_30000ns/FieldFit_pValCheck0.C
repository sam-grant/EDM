...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.47083,50,42.43559);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.58019);
   Graph_Graph01025->SetMaximum(31.54495);
   ...
   mainFit1026->SetChisquare(3.336933);
   ...
   mainFit1026->SetParameter(0,-1.884001);
   mainFit1026->SetParError(0,0.5004484);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8676627);
   mainFit1026->SetParError(1,0.01982164);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0198");
   pt_LaTex = pt->AddText("#minus1.88#pm  0.5");
   pt_LaTex = pt->AddText("#minus2.17#pm0.585");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.171351,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.171351,-55.58019,2.171351,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.336933);
   ...
   mainFit1027->SetParameter(0,-1.884001);
   mainFit1027->SetParError(0,0.5004484);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8676627);
   mainFit1027->SetParError(1,0.01982164);
