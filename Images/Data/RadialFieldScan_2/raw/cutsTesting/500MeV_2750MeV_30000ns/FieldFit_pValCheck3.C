...
//=========  (Mon Apr 26 21:44:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.81855);
   Graph_Graph01031->SetMaximum(56.16698);
   ...
   mainFit1032->SetChisquare(9.078494);
   ...
   mainFit1032->SetParameter(0,-1.289843);
   mainFit1032->SetParError(0,0.5339385);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8966942);
   mainFit1032->SetParError(1,0.01576614);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.03");
   pt_LaTex = pt->AddText("0.897#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.29#pm0.534");
   pt_LaTex = pt->AddText("#minus1.44#pm0.589");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.438442,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.438442,-57.81855,1.438442,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(9.078494);
   ...
   mainFit1033->SetParameter(0,-1.289843);
   mainFit1033->SetParError(0,0.5339385);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8966942);
   mainFit1033->SetParError(1,0.01576614);
