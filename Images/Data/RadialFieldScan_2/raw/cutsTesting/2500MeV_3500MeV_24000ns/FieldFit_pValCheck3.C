...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-48.96557);
   Graph_Graph01031->SetMaximum(51.1112);
   ...
   mainFit1032->SetChisquare(3.45984);
   ...
   mainFit1032->SetParameter(0,-1.557389);
   mainFit1032->SetParError(0,1.152758);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.77795);
   mainFit1032->SetParError(1,0.0342403);
   ...
   pt_LaTex = pt->AddText("0.778#pm0.0342");
   pt_LaTex = pt->AddText("#minus1.56#pm 1.15");
   pt_LaTex = pt->AddText("   #minus2#pm 1.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.001914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.001914,-48.96557,2.001914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.45984);
   ...
   mainFit1033->SetParameter(0,-1.557389);
   mainFit1033->SetParError(0,1.152758);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.77795);
   mainFit1033->SetParError(1,0.0342403);
