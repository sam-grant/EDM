...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.96557);
   Graph_Graph01029->SetMaximum(51.1112);
   ...
   mainFit1030->SetChisquare(4.585425);
   ...
   mainFit1030->SetParameter(0,-0.8344166);
   mainFit1030->SetParError(0,1.088274);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7689218);
   mainFit1030->SetParError(1,0.03317109);
   ...
   pt_LaTex = pt->AddText("0.769#pm0.0332");
   pt_LaTex = pt->AddText("#minus0.834#pm 1.09");
   pt_LaTex = pt->AddText("#minus1.09#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.085177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.085177,-48.96557,1.085177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.585425);
   ...
   mainFit1031->SetParameter(0,-0.8344166);
   mainFit1031->SetParError(0,1.088274);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7689218);
   mainFit1031->SetParError(1,0.03317109);
