...
//=========  (Wed Apr 21 20:07:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02518904);
   Graph_Graph11015->SetMaximum(0.008824158);
   ...
   Graph_Graph21016->SetMinimum(-0.008723053);
   Graph_Graph21016->SetMaximum(0.00742586);
   ...
   Graph_Graph31017->SetMinimum(-0.06740414);
   Graph_Graph31017->SetMaximum(0.04730464);
   ...
   Graph_Graph41018->SetMinimum(-0.08618231);
   Graph_Graph41018->SetMaximum(0.04799281);
   ...
   Graph_Graph51019->SetMinimum(-0.003642118);
   Graph_Graph51019->SetMaximum(0.004869452);
