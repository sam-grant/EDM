...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.47517,75,63.6208);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-48.96557);
   Graph_Graph01027->SetMaximum(51.1112);
   ...
   mainFit1028->SetChisquare(2.168053);
   ...
   mainFit1028->SetParameter(0,-0.1433098);
   mainFit1028->SetParError(0,1.120843);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7942017);
   mainFit1028->SetParError(1,0.03694134);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.723");
   pt_LaTex = pt->AddText("0.794#pm0.0369");
   pt_LaTex = pt->AddText("#minus0.143#pm 1.12");
   pt_LaTex = pt->AddText("#minus0.18#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1804452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1804452,-48.96557,0.1804452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.168053);
   ...
   mainFit1029->SetParameter(0,-0.1433098);
   mainFit1029->SetParError(0,1.120843);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7942017);
   mainFit1029->SetParError(1,0.03694134);
