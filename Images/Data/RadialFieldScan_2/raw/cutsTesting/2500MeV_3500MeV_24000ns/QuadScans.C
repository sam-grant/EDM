...
//=========  (Wed Apr 21 20:07:29 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.373191);
   ...
   quadLineFit1002->SetParameter(0,75.40492);
   quadLineFit1002->SetParError(0,0.1523955);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.2158);
   quadLineFit1002->SetParError(1,2.555668);
   ...
   quadLineFit1003->SetChisquare(3.373191);
   ...
   quadLineFit1003->SetParameter(0,75.40492);
   quadLineFit1003->SetParError(0,0.1523955);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.2158);
   quadLineFit1003->SetParError(1,2.555668);
   ...
   Graph_30_ppm1003->SetMinimum(76.49693);
   Graph_30_ppm1003->SetMaximum(77.04787);
   ...
   quadLineFit1004->SetChisquare(0.3246341);
   ...
   quadLineFit1004->SetParameter(0,75.57285);
   quadLineFit1004->SetParError(0,0.1281675);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,19.49258);
   quadLineFit1004->SetParError(1,2.107013);
   ...
   quadLineFit1005->SetChisquare(0.3246341);
   ...
   quadLineFit1005->SetParameter(0,75.57285);
   quadLineFit1005->SetParError(0,0.1281675);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,19.49258);
   quadLineFit1005->SetParError(1,2.107013);
   ...
   Graph_10_ppm1005->SetMinimum(75.58611);
   Graph_10_ppm1005->SetMaximum(75.81739);
   ...
   quadLineFit1006->SetChisquare(0.1149567);
   ...
   quadLineFit1006->SetParameter(0,75.32387);
   quadLineFit1006->SetParError(0,0.1503088);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.218059);
   quadLineFit1006->SetParError(1,2.437587);
   ...
   quadLineFit1007->SetChisquare(0.1149567);
   ...
   quadLineFit1007->SetParameter(0,75.32387);
   quadLineFit1007->SetParError(0,0.1503088);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.218059);
   quadLineFit1007->SetParError(1,2.437587);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.57335);
   Graph_mI10_ppm1007->SetMaximum(74.86777);
   ...
   quadLineFit1008->SetChisquare(5.6424);
   ...
   quadLineFit1008->SetParameter(0,75.10796);
   quadLineFit1008->SetParError(0,0.1322889);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.609206);
   quadLineFit1008->SetParError(1,2.153504);
   ...
   quadLineFit1009->SetChisquare(5.6424);
   ...
   quadLineFit1009->SetParameter(0,75.10796);
   quadLineFit1009->SetParError(0,0.1322889);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.609206);
   quadLineFit1009->SetParError(1,2.153504);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.2826);
   Graph_mI30_ppm1009->SetMaximum(73.93939);
   ...
   quadLineFit1010->SetChisquare(4.704914);
   ...
   quadLineFit1010->SetParameter(0,75.16388);
   quadLineFit1010->SetParError(0,0.125002);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.53896);
   quadLineFit1010->SetParError(1,2.163355);
   ...
   quadLineFit1011->SetChisquare(4.704914);
   ...
   quadLineFit1011->SetParameter(0,75.16388);
   quadLineFit1011->SetParError(0,0.125002);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.53896);
   quadLineFit1011->SetParError(1,2.163355);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.42897);
   Graph_mI50_ppm1011->SetMaximum(73.00029);
   ...
   quadLineFit1012->SetChisquare(0.03168779);
   ...
   quadLineFit1012->SetParameter(0,74.77538);
   quadLineFit1012->SetParError(0,0.2521169);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-36.11518);
   quadLineFit1012->SetParError(1,4.510667);
   ...
   quadLineFit1013->SetChisquare(0.03168779);
   ...
   quadLineFit1013->SetParameter(0,74.77538);
   quadLineFit1013->SetParError(0,0.2521169);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-36.11518);
   quadLineFit1013->SetParError(1,4.510667);
