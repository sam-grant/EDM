...
//=========  (Wed Apr 21 20:07:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-48.96557);
   Graph_Graph01023->SetMaximum(51.1112);
   ...
   mainFit1024->SetChisquare(4.642139);
   ...
   mainFit1024->SetParameter(0,-0.9359583);
   mainFit1024->SetParError(0,1.001147);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7683145);
   mainFit1024->SetParError(1,0.03307769);
   ...
   mainFit1025->SetChisquare(4.642139);
   ...
   mainFit1025->SetParameter(0,-0.9359583);
   mainFit1025->SetParError(0,1.001147);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7683145);
   mainFit1025->SetParError(1,0.03307769);
