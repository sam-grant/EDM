...
//=========  (Wed Apr 21 20:07:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.96557);
   Graph_Graph01020->SetMaximum(51.1112);
   ...
   mainFit1021->SetChisquare(4.642139);
   ...
   mainFit1021->SetParameter(0,-0.9359583);
   mainFit1021->SetParError(0,1.001147);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7683145);
   mainFit1021->SetParError(1,0.03307769);
   ...
   pt_LaTex = pt->AddText("0.768#pm0.0331");
   pt_LaTex = pt->AddText("#minus0.936#pm    1");
   pt_LaTex = pt->AddText("#minus1.22#pm  1.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.218197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.218197,-48.96557,1.218197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.642139);
   ...
   mainFit1022->SetParameter(0,-0.9359583);
   mainFit1022->SetParError(0,1.001147);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7683145);
   mainFit1022->SetParError(1,0.03307769);
