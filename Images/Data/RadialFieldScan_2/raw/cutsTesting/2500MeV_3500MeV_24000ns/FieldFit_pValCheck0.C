...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-56.1822,50,37.15595);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-46.84839);
   Graph_Graph01025->SetMaximum(27.82214);
   ...
   mainFit1026->SetChisquare(2.398808);
   ...
   mainFit1026->SetParameter(0,-1.536194);
   mainFit1026->SetParError(0,1.078327);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7278802);
   mainFit1026->SetParError(1,0.0426929);
   ...
   pt_LaTex = pt->AddText("0.728#pm0.0427");
   pt_LaTex = pt->AddText("#minus1.54#pm 1.08");
   pt_LaTex = pt->AddText("#minus2.11#pm  1.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.110504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.110504,-46.84839,2.110504,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.398808);
   ...
   mainFit1027->SetParameter(0,-1.536194);
   mainFit1027->SetParError(0,1.078327);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7278802);
   mainFit1027->SetParError(1,0.0426929);
