...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-48.96557);
   Graph_Graph01033->SetMaximum(51.1112);
   ...
   mainFit1034->SetChisquare(3.623752);
   ...
   mainFit1034->SetParameter(0,-0.1722766);
   mainFit1034->SetParError(0,1.255022);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7432564);
   mainFit1034->SetParError(1,0.0413703);
   ...
   pt_LaTex = pt->AddText("0.743#pm0.0414");
   pt_LaTex = pt->AddText("#minus0.172#pm 1.26");
   pt_LaTex = pt->AddText("#minus0.232#pm 1.68");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2317862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2317862,-48.96557,0.2317862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.623752);
   ...
   mainFit1035->SetParameter(0,-0.1722766);
   mainFit1035->SetParError(0,1.255022);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7432564);
   mainFit1035->SetParError(1,0.0413703);
