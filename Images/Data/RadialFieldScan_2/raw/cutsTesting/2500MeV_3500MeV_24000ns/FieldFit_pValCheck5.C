...
//=========  (Wed Apr 21 20:07:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.32075,70,60.38991);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.74969);
   Graph_Graph01035->SetMaximum(49.81885);
   ...
   mainFit1036->SetChisquare(3.989834);
   ...
   mainFit1036->SetParameter(0,-1.192521);
   mainFit1036->SetParError(0,1.050309);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7804443);
   mainFit1036->SetParError(1,0.0363193);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.33");
   pt_LaTex = pt->AddText(" 0.78#pm0.0363");
   pt_LaTex = pt->AddText("#minus1.19#pm 1.05");
   pt_LaTex = pt->AddText("#minus1.53#pm 1.33");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.528002,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.528002,-34.74969,1.528002,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.989834);
   ...
   mainFit1037->SetParameter(0,-1.192521);
   mainFit1037->SetParError(0,1.050309);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7804443);
   mainFit1037->SetParError(1,0.0363193);
