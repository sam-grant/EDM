...
//=========  (Wed Apr 21 15:28:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007221761);
   Graph_Graph11015->SetMaximum(0.007821438);
   ...
   Graph_Graph21016->SetMinimum(-0.004406262);
   Graph_Graph21016->SetMaximum(0.005180657);
   ...
   Graph_Graph31017->SetMinimum(-0.01867218);
   Graph_Graph31017->SetMaximum(0.02453155);
   ...
   Graph_Graph41018->SetMinimum(-0.008324358);
   Graph_Graph41018->SetMaximum(0.01614624);
   ...
   Graph_Graph51019->SetMinimum(-0.008257262);
   Graph_Graph51019->SetMaximum(0.006176998);
