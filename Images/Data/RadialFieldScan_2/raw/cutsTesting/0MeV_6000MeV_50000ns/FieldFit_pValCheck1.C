...
//=========  (Wed Apr 21 15:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-60.60867);
   Graph_Graph01027->SetMaximum(55.41062);
   ...
   mainFit1028->SetChisquare(0.2694624);
   ...
   mainFit1028->SetParameter(0,-1.834747);
   mainFit1028->SetParError(0,0.5437152);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9295269);
   mainFit1028->SetParError(1,0.01794504);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0898");
   pt_LaTex = pt->AddText(" 0.93#pm0.0179");
   pt_LaTex = pt->AddText("#minus1.83#pm0.544");
   pt_LaTex = pt->AddText("#minus1.97#pm0.589");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.97385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.97385,-60.60867,1.97385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2694624);
   ...
   mainFit1029->SetParameter(0,-1.834747);
   mainFit1029->SetParError(0,0.5437152);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9295269);
   mainFit1029->SetParError(1,0.01794504);
