...
//=========  (Wed Apr 21 15:28:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.79676,50,43.34142);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.48294);
   Graph_Graph01025->SetMaximum(32.0276);
   ...
   mainFit1026->SetChisquare(2.606364);
   ...
   mainFit1026->SetParameter(0,-2.575644);
   mainFit1026->SetParError(0,0.5230021);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8966204);
   mainFit1026->SetParError(1,0.02071112);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.869");
   pt_LaTex = pt->AddText("0.897#pm0.0207");
   pt_LaTex = pt->AddText("#minus2.58#pm0.523");
   pt_LaTex = pt->AddText("#minus2.87#pm0.595");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.872613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.872613,-58.48294,2.872613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.606364);
   ...
   mainFit1027->SetParameter(0,-2.575644);
   mainFit1027->SetParError(0,0.5230021);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8966204);
   mainFit1027->SetParError(1,0.02071112);
