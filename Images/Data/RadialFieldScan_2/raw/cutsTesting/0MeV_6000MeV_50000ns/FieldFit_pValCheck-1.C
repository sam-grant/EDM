...
//=========  (Wed Apr 21 15:28:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.60867);
   Graph_Graph01023->SetMaximum(55.41062);
   ...
   mainFit1024->SetChisquare(4.271168);
   ...
   mainFit1024->SetParameter(0,-2.324567);
   mainFit1024->SetParError(0,0.4854561);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9134961);
   mainFit1024->SetParError(1,0.01605682);
   ...
   mainFit1025->SetChisquare(4.271168);
   ...
   mainFit1025->SetParameter(0,-2.324567);
   mainFit1025->SetParError(0,0.4854561);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9134961);
   mainFit1025->SetParError(1,0.01605682);
