...
//=========  (Wed Apr 21 15:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.60867);
   Graph_Graph01033->SetMaximum(55.41062);
   ...
   mainFit1034->SetChisquare(4.195363);
   ...
   mainFit1034->SetParameter(0,-2.425612);
   mainFit1034->SetParError(0,0.6085512);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9168224);
   mainFit1034->SetParError(1,0.02008737);
   ...
   pt_LaTex = pt->AddText("0.917#pm0.0201");
   pt_LaTex = pt->AddText("#minus2.43#pm0.609");
   pt_LaTex = pt->AddText("#minus2.65#pm0.639");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.645672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.645672,-60.60867,2.645672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.195363);
   ...
   mainFit1035->SetParameter(0,-2.425612);
   mainFit1035->SetParError(0,0.6085512);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9168224);
   mainFit1035->SetParError(1,0.02008737);
