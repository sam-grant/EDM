...
//=========  (Wed Apr 21 15:28:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.60867);
   Graph_Graph01020->SetMaximum(55.41062);
   ...
   mainFit1021->SetChisquare(4.271168);
   ...
   mainFit1021->SetParameter(0,-2.324567);
   mainFit1021->SetParError(0,0.4854561);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9134961);
   mainFit1021->SetParError(1,0.01605682);
   ...
   pt_LaTex = pt->AddText("0.913#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.32#pm0.485");
   pt_LaTex = pt->AddText("#minus2.54#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.544693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.544693,-60.60867,2.544693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.271168);
   ...
   mainFit1022->SetParameter(0,-2.324567);
   mainFit1022->SetParError(0,0.4854561);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9134961);
   mainFit1022->SetParError(1,0.01605682);
