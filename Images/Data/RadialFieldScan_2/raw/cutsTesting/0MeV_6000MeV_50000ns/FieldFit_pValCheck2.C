...
//=========  (Wed Apr 21 15:28:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.60867);
   Graph_Graph01029->SetMaximum(55.41062);
   ...
   mainFit1030->SetChisquare(3.357414);
   ...
   mainFit1030->SetParameter(0,-2.522409);
   mainFit1030->SetParError(0,0.527731);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9123221);
   mainFit1030->SetParError(1,0.01610397);
   ...
   pt_LaTex = pt->AddText("#minus2.52#pm0.528");
   pt_LaTex = pt->AddText("#minus2.76#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.764823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.764823,-60.60867,2.764823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.357414);
   ...
   mainFit1031->SetParameter(0,-2.522409);
   mainFit1031->SetParError(0,0.527731);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9123221);
   mainFit1031->SetParError(1,0.01610397);
