...
//=========  (Wed Apr 21 15:28:21 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.657023);
   ...
   quadLineFit1002->SetParameter(0,74.49003);
   quadLineFit1002->SetParError(0,0.07415545);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.49855);
   quadLineFit1002->SetParError(1,1.243799);
   ...
   quadLineFit1003->SetChisquare(1.657023);
   ...
   quadLineFit1003->SetParameter(0,74.49003);
   quadLineFit1003->SetParError(0,0.07415545);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.49855);
   quadLineFit1003->SetParError(1,1.243799);
   ...
   Graph_30_ppm1003->SetMinimum(75.73419);
   Graph_30_ppm1003->SetMaximum(76.33332);
   ...
   quadLineFit1004->SetChisquare(0.3328888);
   ...
   quadLineFit1004->SetParameter(0,74.59156);
   quadLineFit1004->SetParError(0,0.06228238);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.46154);
   quadLineFit1004->SetParError(1,1.023518);
   ...
   quadLineFit1005->SetChisquare(0.3328888);
   ...
   quadLineFit1005->SetParameter(0,74.59156);
   quadLineFit1005->SetParError(0,0.06228238);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.46154);
   quadLineFit1005->SetParError(1,1.023518);
   ...
   Graph_10_ppm1005->SetMinimum(74.73542);
   Graph_10_ppm1005->SetMaximum(74.96798);
   ...
   quadLineFit1006->SetChisquare(0.1721433);
   ...
   quadLineFit1006->SetParameter(0,74.36595);
   quadLineFit1006->SetParError(0,0.07293966);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.84117);
   quadLineFit1006->SetParError(1,1.182867);
   ...
   quadLineFit1007->SetChisquare(0.1721433);
   ...
   quadLineFit1007->SetParameter(0,74.36595);
   quadLineFit1007->SetParError(0,0.07293966);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.84117);
   quadLineFit1007->SetParError(1,1.182867);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50188);
   Graph_mI10_ppm1007->SetMaximum(73.83266);
   ...
   quadLineFit1008->SetChisquare(3.034784);
   ...
   quadLineFit1008->SetParameter(0,74.35207);
   quadLineFit1008->SetParError(0,0.06409173);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.41956);
   quadLineFit1008->SetParError(1,1.043067);
   ...
   quadLineFit1009->SetChisquare(3.034784);
   ...
   quadLineFit1009->SetParameter(0,74.35207);
   quadLineFit1009->SetParError(0,0.06409173);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.41956);
   quadLineFit1009->SetParError(1,1.043067);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.1032);
   Graph_mI30_ppm1009->SetMaximum(72.84848);
   ...
   quadLineFit1010->SetChisquare(1.357646);
   ...
   quadLineFit1010->SetParameter(0,74.2951);
   quadLineFit1010->SetParError(0,0.06051817);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.5246);
   quadLineFit1010->SetParError(1,1.047316);
   ...
   quadLineFit1011->SetChisquare(1.357646);
   ...
   quadLineFit1011->SetParameter(0,74.2951);
   quadLineFit1011->SetParError(0,0.06051817);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.5246);
   quadLineFit1011->SetParError(1,1.047316);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.18874);
   Graph_mI50_ppm1011->SetMaximum(71.88713);
   ...
   quadLineFit1012->SetChisquare(0.3878885);
   ...
   quadLineFit1012->SetParameter(0,74.3084);
   quadLineFit1012->SetParError(0,0.1222981);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.75211);
   quadLineFit1012->SetParError(1,2.188288);
   ...
   quadLineFit1013->SetChisquare(0.3878885);
   ...
   quadLineFit1013->SetParameter(0,74.3084);
   quadLineFit1013->SetParError(0,0.1222981);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.75211);
   quadLineFit1013->SetParError(1,2.188288);
