...
//=========  (Wed Apr 21 15:28:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.65048,70,64.82091);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.20334);
   Graph_Graph01035->SetMaximum(53.37377);
   ...
   mainFit1036->SetChisquare(4.121471);
   ...
   mainFit1036->SetParameter(0,-2.265262);
   mainFit1036->SetParError(0,0.509086);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9106864);
   mainFit1036->SetParError(1,0.01762608);
   ...
   pt_LaTex = pt->AddText("0.911#pm0.0176");
   pt_LaTex = pt->AddText("#minus2.27#pm0.509");
   pt_LaTex = pt->AddText("#minus2.49#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.487423,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.487423,-38.20334,2.487423,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.121471);
   ...
   mainFit1037->SetParameter(0,-2.265262);
   mainFit1037->SetParError(0,0.509086);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9106864);
   mainFit1037->SetParError(1,0.01762608);
