...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.21735);
   Graph_Graph01029->SetMaximum(56.16787);
   ...
   mainFit1030->SetChisquare(4.253828);
   ...
   mainFit1030->SetParameter(0,-2.226268);
   mainFit1030->SetParError(0,0.4349446);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9273242);
   mainFit1030->SetParError(1,0.013267);
   ...
   pt_LaTex = pt->AddText("#minus2.23#pm0.435");
   pt_LaTex = pt->AddText(" #minus2.4#pm0.466");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.400744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.400744,-61.21735,2.400744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.253828);
   ...
   mainFit1031->SetParameter(0,-2.226268);
   mainFit1031->SetParError(0,0.4349446);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9273242);
   mainFit1031->SetParError(1,0.013267);
