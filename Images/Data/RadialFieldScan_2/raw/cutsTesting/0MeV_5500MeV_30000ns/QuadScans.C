...
//=========  (Fri Apr 23 12:46:56 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.393497);
   ...
   quadLineFit1002->SetParameter(0,74.45988);
   quadLineFit1002->SetParError(0,0.06102095);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.36225);
   quadLineFit1002->SetParError(1,1.023518);
   ...
   quadLineFit1003->SetChisquare(1.393497);
   ...
   quadLineFit1003->SetParameter(0,74.45988);
   quadLineFit1003->SetParError(0,0.06102095);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.36225);
   quadLineFit1003->SetParError(1,1.023518);
   ...
   Graph_30_ppm1003->SetMinimum(75.74751);
   Graph_30_ppm1003->SetMaximum(76.36317);
   ...
   quadLineFit1004->SetChisquare(0.5603815);
   ...
   quadLineFit1004->SetParameter(0,74.55254);
   quadLineFit1004->SetParError(0,0.0513507);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.44672);
   quadLineFit1004->SetParError(1,0.8438855);
   ...
   quadLineFit1005->SetChisquare(0.5603815);
   ...
   quadLineFit1005->SetParameter(0,74.55254);
   quadLineFit1005->SetParError(0,0.0513507);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.44672);
   quadLineFit1005->SetParError(1,0.8438855);
   ...
   Graph_10_ppm1005->SetMinimum(74.75267);
   Graph_10_ppm1005->SetMaximum(74.98706);
   ...
   quadLineFit1006->SetChisquare(1.10791);
   ...
   quadLineFit1006->SetParameter(0,74.36323);
   quadLineFit1006->SetParError(0,0.06014055);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.121987);
   quadLineFit1006->SetParError(1,0.9752779);
   ...
   quadLineFit1007->SetChisquare(1.10791);
   ...
   quadLineFit1007->SetParameter(0,74.36323);
   quadLineFit1007->SetParError(0,0.06014055);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.121987);
   quadLineFit1007->SetParError(1,0.9752779);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50263);
   Graph_mI10_ppm1007->SetMaximum(73.83579);
   ...
   quadLineFit1008->SetChisquare(5.531829);
   ...
   quadLineFit1008->SetParameter(0,74.37684);
   quadLineFit1008->SetParError(0,0.0528179);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.6149);
   quadLineFit1008->SetParError(1,0.8596448);
   ...
   quadLineFit1009->SetChisquare(5.531829);
   ...
   quadLineFit1009->SetParameter(0,74.37684);
   quadLineFit1009->SetParError(0,0.0528179);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.6149);
   quadLineFit1009->SetParError(1,0.8596448);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12281);
   ...
   quadLineFit1010->SetChisquare(1.11814);
   ...
   quadLineFit1010->SetParameter(0,74.29952);
   quadLineFit1010->SetParError(0,0.04989963);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.36028);
   quadLineFit1010->SetParError(1,0.863569);
   ...
   quadLineFit1011->SetChisquare(1.11814);
   ...
   quadLineFit1011->SetParameter(0,74.29952);
   quadLineFit1011->SetParError(0,0.04989963);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.36028);
   quadLineFit1011->SetParError(1,0.863569);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.18647);
   Graph_mI50_ppm1011->SetMaximum(71.88851);
   ...
   quadLineFit1012->SetChisquare(0.1276092);
   ...
   quadLineFit1012->SetParameter(0,74.3647);
   quadLineFit1012->SetParError(0,0.1007661);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.63226);
   quadLineFit1012->SetParError(1,1.80299);
   ...
   quadLineFit1013->SetChisquare(0.1276092);
   ...
   quadLineFit1013->SetParameter(0,74.3647);
   quadLineFit1013->SetParError(0,0.1007661);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.63226);
   quadLineFit1013->SetParError(1,1.80299);
