...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.21735);
   Graph_Graph01023->SetMaximum(56.16787);
   ...
   mainFit1024->SetChisquare(5.26371);
   ...
   mainFit1024->SetParameter(0,-2.054925);
   mainFit1024->SetParError(0,0.4001392);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9283334);
   mainFit1024->SetParError(1,0.01322854);
   ...
   pt_LaTex = pt->AddText("#minus2.05#pm  0.4");
   pt_LaTex = pt->AddText("#minus2.21#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.213564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.213564,-61.21735,2.213564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.26371);
   ...
   mainFit1025->SetParameter(0,-2.054925);
   mainFit1025->SetParError(0,0.4001392);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9283334);
   mainFit1025->SetParError(1,0.01322854);
