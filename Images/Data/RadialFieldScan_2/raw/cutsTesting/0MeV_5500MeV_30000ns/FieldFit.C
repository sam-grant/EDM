...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.21735);
   Graph_Graph01020->SetMaximum(56.16787);
   ...
   mainFit1021->SetChisquare(5.26371);
   ...
   mainFit1021->SetParameter(0,-2.054925);
   mainFit1021->SetParError(0,0.4001392);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9283334);
   mainFit1021->SetParError(1,0.01322854);
   ...
   mainFit1022->SetChisquare(5.26371);
   ...
   mainFit1022->SetParameter(0,-2.054925);
   mainFit1022->SetParError(0,0.4001392);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9283334);
   mainFit1022->SetParError(1,0.01322854);
