...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.21735);
   Graph_Graph01033->SetMaximum(56.16787);
   ...
   mainFit1034->SetChisquare(4.476368);
   ...
   mainFit1034->SetParameter(0,-2.323272);
   mainFit1034->SetParError(0,0.5015575);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9371572);
   mainFit1034->SetParError(1,0.01654569);
   ...
   pt_LaTex = pt->AddText("#minus2.32#pm0.502");
   pt_LaTex = pt->AddText("#minus2.48#pm0.516");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.479064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.479064,-61.21735,2.479064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.476368);
   ...
   mainFit1035->SetParameter(0,-2.323272);
   mainFit1035->SetParError(0,0.5015575);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9371572);
   mainFit1035->SetParError(1,0.01654569);
