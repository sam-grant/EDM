...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.61671,50,44.47207);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.10783);
   Graph_Graph01025->SetMaximum(32.96319);
   ...
   mainFit1026->SetChisquare(3.394387);
   ...
   mainFit1026->SetParameter(0,-2.274529);
   mainFit1026->SetParError(0,0.4311682);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9135797);
   mainFit1026->SetParError(1,0.01707411);
   ...
   pt_LaTex = pt->AddText("0.914#pm0.0171");
   pt_LaTex = pt->AddText("#minus2.27#pm0.431");
   pt_LaTex = pt->AddText("#minus2.49#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.489689,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.489689,-59.10783,2.489689,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.394387);
   ...
   mainFit1027->SetParameter(0,-2.274529);
   mainFit1027->SetParError(0,0.4311682);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9135797);
   mainFit1027->SetParError(1,0.01707411);
