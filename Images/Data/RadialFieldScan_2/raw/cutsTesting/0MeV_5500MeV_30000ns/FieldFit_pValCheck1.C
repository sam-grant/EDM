...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.21735);
   Graph_Graph01027->SetMaximum(56.16787);
   ...
   mainFit1028->SetChisquare(1.183432);
   ...
   mainFit1028->SetParameter(0,-1.647848);
   mainFit1028->SetParError(0,0.4480272);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.941644);
   mainFit1028->SetParError(1,0.01477788);
   ...
   pt_LaTex = pt->AddText("#minus1.65#pm0.448");
   pt_LaTex = pt->AddText("#minus1.75#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.749969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.749969,-61.21735,1.749969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.183432);
   ...
   mainFit1029->SetParameter(0,-1.647848);
   mainFit1029->SetParError(0,0.4480272);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.941644);
   mainFit1029->SetParError(1,0.01477788);
