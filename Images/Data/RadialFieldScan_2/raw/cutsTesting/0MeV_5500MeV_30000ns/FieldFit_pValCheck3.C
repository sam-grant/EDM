...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.8905,75,70.84102);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-61.21735);
   Graph_Graph01031->SetMaximum(56.16787);
   ...
   mainFit1032->SetChisquare(5.123187);
   ...
   mainFit1032->SetParameter(0,-1.969261);
   mainFit1032->SetParError(0,0.4608191);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9270167);
   mainFit1032->SetParError(1,0.01369066);
   ...
   pt_LaTex = pt->AddText("#minus1.97#pm0.461");
   pt_LaTex = pt->AddText("#minus2.12#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.124299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.124299,-61.21735,2.124299,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.123187);
   ...
   mainFit1033->SetParameter(0,-1.969261);
   mainFit1033->SetParError(0,0.4608191);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9270167);
   mainFit1033->SetParError(1,0.01369066);
