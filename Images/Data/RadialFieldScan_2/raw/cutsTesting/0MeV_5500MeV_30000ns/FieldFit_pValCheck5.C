...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.37626,70,65.53817);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.88481);
   Graph_Graph01035->SetMaximum(54.04673);
   ...
   mainFit1036->SetChisquare(4.739373);
   ...
   mainFit1036->SetParameter(0,-1.963337);
   mainFit1036->SetParError(0,0.419661);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.924);
   mainFit1036->SetParError(1,0.01452231);
   ...
   pt_LaTex = pt->AddText("#minus2.12#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.124823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.124823,-37.88481,2.124823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.739373);
   ...
   mainFit1037->SetParameter(0,-1.963337);
   mainFit1037->SetParError(0,0.419661);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.924);
   mainFit1037->SetParError(1,0.01452231);
