...
//=========  (Fri Apr 23 12:46:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007781548);
   Graph_Graph11015->SetMaximum(0.008070051);
   ...
   Graph_Graph21016->SetMinimum(-0.009217793);
   Graph_Graph21016->SetMaximum(0.01083337);
   ...
   Graph_Graph31017->SetMinimum(-0.02572094);
   Graph_Graph31017->SetMaximum(0.0217956);
   ...
   Graph_Graph41018->SetMinimum(-0.006582982);
   Graph_Graph41018->SetMaximum(0.01212881);
   ...
   Graph_Graph51019->SetMinimum(-0.002919985);
   Graph_Graph51019->SetMaximum(0.003900826);
