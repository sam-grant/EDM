...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.11089);
   Graph_Graph01033->SetMaximum(48.64189);
   ...
   mainFit1034->SetChisquare(5.77774);
   ...
   mainFit1034->SetParameter(0,0.02347903);
   mainFit1034->SetParError(0,0.8461022);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7445531);
   mainFit1034->SetParError(1,0.02791208);
   ...
   pt_LaTex = pt->AddText("0.745#pm0.0279");
   pt_LaTex = pt->AddText("0.0235#pm0.846");
   pt_LaTex = pt->AddText("0.0315#pm 1.14");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.03153439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.03153439,-49.11089,-0.03153439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.77774);
   ...
   mainFit1035->SetParameter(0,0.02347903);
   mainFit1035->SetParError(0,0.8461022);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7445531);
   mainFit1035->SetParError(1,0.02791208);
