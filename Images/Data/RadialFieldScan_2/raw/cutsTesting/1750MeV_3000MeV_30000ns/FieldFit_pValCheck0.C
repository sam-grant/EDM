...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-56.51994,50,36.81074);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.18687);
   Graph_Graph01025->SetMaximum(27.47767);
   ...
   mainFit1026->SetChisquare(4.515738);
   ...
   mainFit1026->SetParameter(0,-0.4297562);
   mainFit1026->SetParError(0,0.7275095);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.728091);
   mainFit1026->SetParError(1,0.02881227);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.51");
   pt_LaTex = pt->AddText("0.728#pm0.0288");
   pt_LaTex = pt->AddText("#minus0.43#pm0.728");
   pt_LaTex = pt->AddText("#minus0.59#pm    1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.5902507,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5902507,-47.18687,0.5902507,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.515738);
   ...
   mainFit1027->SetParameter(0,-0.4297562);
   mainFit1027->SetParError(0,0.7275095);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.728091);
   mainFit1027->SetParError(1,0.02881227);
