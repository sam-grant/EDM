...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.11089);
   Graph_Graph01020->SetMaximum(48.64189);
   ...
   mainFit1021->SetChisquare(5.853442);
   ...
   mainFit1021->SetParameter(0,-0.1167712);
   mainFit1021->SetParError(0,0.6753168);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7491623);
   mainFit1021->SetParError(1,0.02232594);
   ...
   mainFit1022->SetChisquare(5.853442);
   ...
   mainFit1022->SetParameter(0,-0.1167712);
   mainFit1022->SetParError(0,0.6753168);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7491623);
   mainFit1022->SetParError(1,0.02232594);
