...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.11089);
   Graph_Graph01029->SetMaximum(48.64189);
   ...
   mainFit1030->SetChisquare(3.506367);
   ...
   mainFit1030->SetParameter(0,-0.5574497);
   mainFit1030->SetParError(0,0.7340267);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7465638);
   mainFit1030->SetParError(1,0.0223902);
   ...
   pt_LaTex = pt->AddText("0.747#pm0.0224");
   pt_LaTex = pt->AddText("#minus0.557#pm0.734");
   pt_LaTex = pt->AddText("#minus0.747#pm0.981");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7466872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7466872,-49.11089,0.7466872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.506367);
   ...
   mainFit1031->SetParameter(0,-0.5574497);
   mainFit1031->SetParError(0,0.7340267);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7465638);
   mainFit1031->SetParError(1,0.0223902);
