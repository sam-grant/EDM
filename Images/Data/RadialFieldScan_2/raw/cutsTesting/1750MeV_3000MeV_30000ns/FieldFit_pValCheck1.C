...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.11089);
   Graph_Graph01027->SetMaximum(48.64189);
   ...
   mainFit1028->SetChisquare(0.8182007);
   ...
   mainFit1028->SetParameter(0,0.6465117);
   mainFit1028->SetParError(0,0.7561465);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7741099);
   mainFit1028->SetParError(1,0.024941);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.273");
   pt_LaTex = pt->AddText("0.774#pm0.0249");
   pt_LaTex = pt->AddText("0.647#pm0.756");
   pt_LaTex = pt->AddText("0.835#pm0.975");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8351679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8351679,-49.11089,-0.8351679,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8182007);
   ...
   mainFit1029->SetParameter(0,0.6465117);
   mainFit1029->SetParError(0,0.7561465);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7741099);
   mainFit1029->SetParError(1,0.024941);
