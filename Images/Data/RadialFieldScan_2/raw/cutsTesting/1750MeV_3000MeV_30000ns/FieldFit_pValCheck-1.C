...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.11089);
   Graph_Graph01023->SetMaximum(48.64189);
   ...
   mainFit1024->SetChisquare(5.853442);
   ...
   mainFit1024->SetParameter(0,-0.1167712);
   mainFit1024->SetParError(0,0.6753168);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7491623);
   mainFit1024->SetParError(1,0.02232594);
   ...
   pt_LaTex = pt->AddText("0.749#pm0.0223");
   pt_LaTex = pt->AddText("#minus0.117#pm0.675");
   pt_LaTex = pt->AddText("#minus0.156#pm0.901");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.155869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.155869,-49.11089,0.155869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.853442);
   ...
   mainFit1025->SetParameter(0,-0.1167712);
   mainFit1025->SetParError(0,0.6753168);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7491623);
   mainFit1025->SetParError(1,0.02232594);
