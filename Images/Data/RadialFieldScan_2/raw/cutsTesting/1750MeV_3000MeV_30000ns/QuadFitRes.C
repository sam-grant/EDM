...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0165561);
   Graph_Graph11015->SetMaximum(0.02952483);
   ...
   Graph_Graph21016->SetMinimum(-0.01346649);
   Graph_Graph21016->SetMaximum(0.01585262);
   ...
   Graph_Graph31017->SetMinimum(-0.04446417);
   Graph_Graph31017->SetMaximum(0.05136939);
   ...
   Graph_Graph41018->SetMinimum(-0.008073001);
   Graph_Graph41018->SetMaximum(0.007527146);
   ...
   Graph_Graph51019->SetMinimum(-0.01373771);
   Graph_Graph51019->SetMaximum(0.01027938);
