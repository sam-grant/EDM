...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-61.32999,75,60.86099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-49.11089);
   Graph_Graph01031->SetMaximum(48.64189);
   ...
   mainFit1032->SetChisquare(5.829516);
   ...
   mainFit1032->SetParameter(0,-0.1765091);
   mainFit1032->SetParError(0,0.777947);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7500855);
   mainFit1032->SetParError(1,0.02310997);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.94");
   pt_LaTex = pt->AddText(" 0.75#pm0.0231");
   pt_LaTex = pt->AddText("#minus0.177#pm0.778");
   pt_LaTex = pt->AddText("#minus0.235#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2353186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2353186,-49.11089,0.2353186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.829516);
   ...
   mainFit1033->SetParameter(0,-0.1765091);
   mainFit1033->SetParError(0,0.777947);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7500855);
   mainFit1033->SetParError(1,0.02310997);
