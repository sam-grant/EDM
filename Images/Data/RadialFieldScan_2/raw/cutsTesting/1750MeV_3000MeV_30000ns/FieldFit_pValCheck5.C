...
//=========  (Fri Apr 23 19:12:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.5446,70,56.70391);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.81975);
   Graph_Graph01035->SetMaximum(46.97906);
   ...
   mainFit1036->SetChisquare(5.836872);
   ...
   mainFit1036->SetParameter(0,-0.08924288);
   mainFit1036->SetParError(0,0.7083692);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7478593);
   mainFit1036->SetParError(1,0.02451352);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.95");
   pt_LaTex = pt->AddText("0.748#pm0.0245");
   pt_LaTex = pt->AddText("#minus0.0892#pm0.708");
   pt_LaTex = pt->AddText("#minus0.119#pm0.946");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1193311,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1193311,-30.81975,0.1193311,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.836872);
   ...
   mainFit1037->SetParameter(0,-0.08924288);
   mainFit1037->SetParError(0,0.7083692);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7478593);
   mainFit1037->SetParError(1,0.02451352);
