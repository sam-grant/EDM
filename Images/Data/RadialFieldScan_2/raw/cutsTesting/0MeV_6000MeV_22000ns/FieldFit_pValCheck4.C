...
//=========  (Wed Apr 21 15:47:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.55567);
   Graph_Graph01033->SetMaximum(55.51561);
   ...
   mainFit1034->SetChisquare(3.275936);
   ...
   mainFit1034->SetParameter(0,-2.026994);
   mainFit1034->SetParError(0,0.4637442);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9258401);
   mainFit1034->SetParError(1,0.01529438);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0153");
   pt_LaTex = pt->AddText("#minus2.03#pm0.464");
   pt_LaTex = pt->AddText("#minus2.19#pm0.485");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.189356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.189356,-59.55567,2.189356,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.275936);
   ...
   mainFit1035->SetParameter(0,-2.026994);
   mainFit1035->SetParError(0,0.4637442);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9258401);
   mainFit1035->SetParError(1,0.01529438);
