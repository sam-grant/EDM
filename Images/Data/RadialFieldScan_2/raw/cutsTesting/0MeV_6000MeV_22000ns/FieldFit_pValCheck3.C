...
//=========  (Wed Apr 21 15:47:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.55567);
   Graph_Graph01031->SetMaximum(55.51561);
   ...
   mainFit1032->SetChisquare(3.366173);
   ...
   mainFit1032->SetParameter(0,-1.802063);
   mainFit1032->SetParError(0,0.4260073);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9199272);
   mainFit1032->SetParError(1,0.01265428);
   ...
   pt_LaTex = pt->AddText(" #minus1.8#pm0.426");
   pt_LaTex = pt->AddText("#minus1.96#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.958919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.958919,-59.55567,1.958919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.366173);
   ...
   mainFit1033->SetParameter(0,-1.802063);
   mainFit1033->SetParError(0,0.4260073);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9199272);
   mainFit1033->SetParError(1,0.01265428);
