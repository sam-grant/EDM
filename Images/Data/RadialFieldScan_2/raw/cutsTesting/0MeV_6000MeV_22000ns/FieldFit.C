...
//=========  (Wed Apr 21 15:47:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.55567);
   Graph_Graph01020->SetMaximum(55.51561);
   ...
   mainFit1021->SetChisquare(3.527119);
   ...
   mainFit1021->SetParameter(0,-1.886803);
   mainFit1021->SetParError(0,0.3699206);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9212284);
   mainFit1021->SetParError(1,0.01222708);
   ...
   mainFit1022->SetChisquare(3.527119);
   ...
   mainFit1022->SetParameter(0,-1.886803);
   mainFit1022->SetParError(0,0.3699206);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9212284);
   mainFit1022->SetParError(1,0.01222708);
