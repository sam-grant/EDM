...
//=========  (Wed Apr 21 15:47:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.55567);
   Graph_Graph01023->SetMaximum(55.51561);
   ...
   mainFit1024->SetChisquare(3.527119);
   ...
   mainFit1024->SetParameter(0,-1.886803);
   mainFit1024->SetParError(0,0.3699206);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9212284);
   mainFit1024->SetParError(1,0.01222708);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.882");
   pt_LaTex = pt->AddText("0.921#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.89#pm 0.37");
   pt_LaTex = pt->AddText("#minus2.05#pm0.398");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.048139,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.048139,-59.55567,2.048139,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.527119);
   ...
   mainFit1025->SetParameter(0,-1.886803);
   mainFit1025->SetParError(0,0.3699206);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9212284);
   mainFit1025->SetParError(1,0.01222708);
