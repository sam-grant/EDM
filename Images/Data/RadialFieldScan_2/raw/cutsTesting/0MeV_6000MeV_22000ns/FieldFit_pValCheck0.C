...
//=========  (Wed Apr 21 15:47:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.82868,50,44.34502);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.51131);
   Graph_Graph01025->SetMaximum(33.02765);
   ...
   mainFit1026->SetChisquare(2.105053);
   ...
   mainFit1026->SetParameter(0,-2.063992);
   mainFit1026->SetParError(0,0.3986392);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9093295);
   mainFit1026->SetParError(1,0.01578538);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.702");
   pt_LaTex = pt->AddText("0.909#pm0.0158");
   pt_LaTex = pt->AddText("#minus2.06#pm0.399");
   pt_LaTex = pt->AddText("#minus2.27#pm0.445");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.269795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.269795,-57.51131,2.269795,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.105053);
   ...
   mainFit1027->SetParameter(0,-2.063992);
   mainFit1027->SetParError(0,0.3986392);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9093295);
   mainFit1027->SetParError(1,0.01578538);
