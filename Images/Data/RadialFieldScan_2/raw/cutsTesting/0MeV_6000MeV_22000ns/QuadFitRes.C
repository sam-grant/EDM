...
//=========  (Wed Apr 21 15:47:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.002612921);
   Graph_Graph11015->SetMaximum(0.006610881);
   ...
   Graph_Graph21016->SetMinimum(-0.005614137);
   Graph_Graph21016->SetMaximum(0.006593983);
   ...
   Graph_Graph31017->SetMinimum(-0.02514983);
   Graph_Graph31017->SetMaximum(0.01904182);
   ...
   Graph_Graph41018->SetMinimum(-0.002753936);
   Graph_Graph41018->SetMaximum(0.00336642);
   ...
   Graph_Graph51019->SetMinimum(-0.0006361992);
   Graph_Graph51019->SetMaximum(0.0008500773);
