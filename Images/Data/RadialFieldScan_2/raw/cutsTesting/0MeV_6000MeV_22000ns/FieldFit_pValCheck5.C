...
//=========  (Wed Apr 21 15:47:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.02872,70,64.91735);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.63411);
   Graph_Graph01035->SetMaximum(53.52274);
   ...
   mainFit1036->SetChisquare(3.471117);
   ...
   mainFit1036->SetParameter(0,-1.85915);
   mainFit1036->SetParError(0,0.3879669);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.919925);
   mainFit1036->SetParError(1,0.01342218);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.86#pm0.388");
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.02098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.02098,-37.63411,2.02098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.471117);
   ...
   mainFit1037->SetParameter(0,-1.85915);
   mainFit1037->SetParError(0,0.3879669);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.919925);
   mainFit1037->SetParError(1,0.01342218);
