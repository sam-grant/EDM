...
//=========  (Wed Apr 21 15:47:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.196306);
   ...
   quadLineFit1002->SetParameter(0,74.48538);
   quadLineFit1002->SetParError(0,0.05638088);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.9807);
   quadLineFit1002->SetParError(1,0.9456389);
   ...
   quadLineFit1003->SetChisquare(1.196306);
   ...
   quadLineFit1003->SetParameter(0,74.48538);
   quadLineFit1003->SetParError(0,0.05638088);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.9807);
   quadLineFit1003->SetParError(1,0.9456389);
   ...
   Graph_30_ppm1003->SetMinimum(75.73791);
   Graph_30_ppm1003->SetMaximum(76.36254);
   ...
   quadLineFit1004->SetChisquare(0.1708616);
   ...
   quadLineFit1004->SetParameter(0,74.5358);
   quadLineFit1004->SetParError(0,0.0474774);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.70253);
   quadLineFit1004->SetParError(1,0.7802126);
   ...
   quadLineFit1005->SetChisquare(0.1708616);
   ...
   quadLineFit1005->SetParameter(0,74.5358);
   quadLineFit1005->SetParError(0,0.0474774);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.70253);
   quadLineFit1005->SetParError(1,0.7802126);
   ...
   Graph_10_ppm1005->SetMinimum(74.74852);
   Graph_10_ppm1005->SetMaximum(74.97778);
   ...
   quadLineFit1006->SetChisquare(0.4804798);
   ...
   quadLineFit1006->SetParameter(0,74.36178);
   quadLineFit1006->SetParError(0,0.05561362);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.0844);
   quadLineFit1006->SetParError(1,0.9018287);
   ...
   quadLineFit1007->SetChisquare(0.4804798);
   ...
   quadLineFit1007->SetParameter(0,74.36178);
   quadLineFit1007->SetParError(0,0.05561362);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.0844);
   quadLineFit1007->SetParError(1,0.9018287);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50837);
   Graph_mI10_ppm1007->SetMaximum(73.83315);
   ...
   quadLineFit1008->SetChisquare(5.902998);
   ...
   quadLineFit1008->SetParameter(0,74.36252);
   quadLineFit1008->SetParError(0,0.0488359);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.37285);
   quadLineFit1008->SetParError(1,0.7948185);
   ...
   quadLineFit1009->SetChisquare(5.902998);
   ...
   quadLineFit1009->SetParameter(0,74.36252);
   quadLineFit1009->SetParError(0,0.0488359);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.37285);
   quadLineFit1009->SetParError(1,0.7948185);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12599);
   Graph_mI30_ppm1009->SetMaximum(72.85932);
   ...
   quadLineFit1010->SetChisquare(0.1069374);
   ...
   quadLineFit1010->SetParameter(0,74.28991);
   quadLineFit1010->SetParError(0,0.04612458);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.23946);
   quadLineFit1010->SetParError(1,0.7982469);
   ...
   quadLineFit1011->SetChisquare(0.1069374);
   ...
   quadLineFit1011->SetParameter(0,74.28991);
   quadLineFit1011->SetParError(0,0.04612458);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.23946);
   quadLineFit1011->SetParError(1,0.7982469);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.20732);
   Graph_mI50_ppm1011->SetMaximum(71.88905);
   ...
   quadLineFit1012->SetChisquare(0.00709082);
   ...
   quadLineFit1012->SetParameter(0,74.29771);
   quadLineFit1012->SetParError(0,0.09317252);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.29926);
   quadLineFit1012->SetParError(1,1.667132);
   ...
   quadLineFit1013->SetChisquare(0.00709082);
   ...
   quadLineFit1013->SetParameter(0,74.29771);
   quadLineFit1013->SetParError(0,0.09317252);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.29926);
   quadLineFit1013->SetParError(1,1.667132);
