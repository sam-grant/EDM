...
//=========  (Wed Apr 21 15:47:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.55567);
   Graph_Graph01027->SetMaximum(55.51561);
   ...
   mainFit1028->SetChisquare(0.6467235);
   ...
   mainFit1028->SetParameter(0,-1.570756);
   mainFit1028->SetParError(0,0.4141554);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9315604);
   mainFit1028->SetParError(1,0.01365719);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.216");
   pt_LaTex = pt->AddText("0.932#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.57#pm0.414");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.686156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.686156,-59.55567,1.686156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6467235);
   ...
   mainFit1029->SetParameter(0,-1.570756);
   mainFit1029->SetParError(0,0.4141554);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9315604);
   mainFit1029->SetParError(1,0.01365719);
