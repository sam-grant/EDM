...
//=========  (Wed Apr 28 14:59:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.43637);
   Graph_Graph01033->SetMaximum(56.62655);
   ...
   mainFit1034->SetChisquare(5.249805);
   ...
   mainFit1034->SetParameter(0,-1.199869);
   mainFit1034->SetParError(0,0.5263658);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9241949);
   mainFit1034->SetParError(1,0.01735929);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.0174");
   pt_LaTex = pt->AddText(" #minus1.2#pm0.526");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.559");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.298286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.298286,-58.43637,1.298286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.249805);
   ...
   mainFit1035->SetParameter(0,-1.199869);
   mainFit1035->SetParError(0,0.5263658);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9241949);
   mainFit1035->SetParError(1,0.01735929);
