...
//=========  (Wed Apr 28 14:59:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.43637);
   Graph_Graph01023->SetMaximum(56.62655);
   ...
   mainFit1024->SetChisquare(5.37363);
   ...
   mainFit1024->SetParameter(0,-1.08822);
   mainFit1024->SetParError(0,0.4199895);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9205271);
   mainFit1024->SetParError(1,0.01388169);
   ...
   mainFit1025->SetChisquare(5.37363);
   ...
   mainFit1025->SetParameter(0,-1.08822);
   mainFit1025->SetParError(0,0.4199895);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9205271);
   mainFit1025->SetParError(1,0.01388169);
