...
//=========  (Wed Apr 28 14:59:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.56659,50,44.74614);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.33531);
   Graph_Graph01025->SetMaximum(33.51487);
   ...
   mainFit1026->SetChisquare(3.581055);
   ...
   mainFit1026->SetParameter(0,-1.313866);
   mainFit1026->SetParError(0,0.4525428);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9053505);
   mainFit1026->SetParError(1,0.01792186);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.0179");
   pt_LaTex = pt->AddText("#minus1.31#pm0.453");
   pt_LaTex = pt->AddText("#minus1.45#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.451224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.451224,-56.33531,1.451224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.581055);
   ...
   mainFit1027->SetParameter(0,-1.313866);
   mainFit1027->SetParError(0,0.4525428);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9053505);
   mainFit1027->SetParError(1,0.01792186);
