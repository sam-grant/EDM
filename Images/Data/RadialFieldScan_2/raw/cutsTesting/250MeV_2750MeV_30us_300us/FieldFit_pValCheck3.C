...
//=========  (Wed Apr 28 14:59:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.43637);
   Graph_Graph01031->SetMaximum(56.62655);
   ...
   mainFit1032->SetChisquare(4.877508);
   ...
   mainFit1032->SetParameter(0,-0.9191289);
   mainFit1032->SetParError(0,0.4837581);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9179153);
   mainFit1032->SetParError(1,0.0143684);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0144");
   pt_LaTex = pt->AddText("#minus0.919#pm0.484");
   pt_LaTex = pt->AddText("   #minus1#pm0.523");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.001322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.001322,-58.43637,1.001322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.877508);
   ...
   mainFit1033->SetParameter(0,-0.9191289);
   mainFit1033->SetParError(0,0.4837581);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9179153);
   mainFit1033->SetParError(1,0.0143684);
