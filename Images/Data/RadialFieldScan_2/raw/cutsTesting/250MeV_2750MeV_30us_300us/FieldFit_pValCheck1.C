...
//=========  (Wed Apr 28 14:59:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.43637);
   Graph_Graph01027->SetMaximum(56.62655);
   ...
   mainFit1028->SetChisquare(1.46145);
   ...
   mainFit1028->SetParameter(0,-0.6701142);
   mainFit1028->SetParError(0,0.4701867);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9341852);
   mainFit1028->SetParError(1,0.01550438);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0155");
   pt_LaTex = pt->AddText("#minus0.67#pm 0.47");
   pt_LaTex = pt->AddText("#minus0.717#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7173247,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7173247,-58.43637,0.7173247,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.46145);
   ...
   mainFit1029->SetParameter(0,-0.6701142);
   mainFit1029->SetParError(0,0.4701867);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9341852);
   mainFit1029->SetParError(1,0.01550438);
