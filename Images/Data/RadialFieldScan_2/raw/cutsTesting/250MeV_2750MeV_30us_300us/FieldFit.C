...
//=========  (Wed Apr 28 14:59:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.43637);
   Graph_Graph01020->SetMaximum(56.62655);
   ...
   mainFit1021->SetChisquare(5.37363);
   ...
   mainFit1021->SetParameter(0,-1.08822);
   mainFit1021->SetParError(0,0.4199895);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9205271);
   mainFit1021->SetParError(1,0.01388169);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.09#pm 0.42");
   pt_LaTex = pt->AddText("#minus1.18#pm0.454");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.182171,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.182171,-58.43637,1.182171,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.37363);
   ...
   mainFit1022->SetParameter(0,-1.08822);
   mainFit1022->SetParError(0,0.4199895);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9205271);
   mainFit1022->SetParError(1,0.01388169);
