...
//=========  (Wed Apr 28 14:59:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01690633);
   Graph_Graph11015->SetMaximum(0.01899993);
   ...
   Graph_Graph21016->SetMinimum(-0.008809945);
   Graph_Graph21016->SetMaximum(0.01037072);
   ...
   Graph_Graph31017->SetMinimum(-0.02608045);
   Graph_Graph31017->SetMaximum(0.02370866);
   ...
   Graph_Graph41018->SetMinimum(-0.004818244);
   Graph_Graph41018->SetMaximum(0.006955354);
   ...
   Graph_Graph51019->SetMinimum(-0.004378771);
   Graph_Graph51019->SetMaximum(0.005852641);
