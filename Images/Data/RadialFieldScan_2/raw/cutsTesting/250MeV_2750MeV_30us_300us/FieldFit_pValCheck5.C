...
//=========  (Wed Apr 28 14:59:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.48949,70,66.14347);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.02619);
   Graph_Graph01035->SetMaximum(54.68017);
   ...
   mainFit1036->SetChisquare(5.364662);
   ...
   mainFit1036->SetParameter(0,-1.100807);
   mainFit1036->SetParError(0,0.4405179);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9211227);
   mainFit1036->SetParError(1,0.0152399);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0152");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.441");
   pt_LaTex = pt->AddText(" #minus1.2#pm0.473");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.195071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.195071,-37.02619,1.195071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.364662);
   ...
   mainFit1037->SetParameter(0,-1.100807);
   mainFit1037->SetParError(0,0.4405179);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9211227);
   mainFit1037->SetParError(1,0.0152399);
