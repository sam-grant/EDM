...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.06945);
   Graph_Graph01031->SetMaximum(55.02845);
   ...
   mainFit1032->SetChisquare(5.174105);
   ...
   mainFit1032->SetParameter(0,-1.255006);
   mainFit1032->SetParError(0,0.38266);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9336903);
   mainFit1032->SetParError(1,0.01141022);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0114");
   pt_LaTex = pt->AddText("#minus1.26#pm0.383");
   pt_LaTex = pt->AddText("#minus1.34#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.344135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.344135,-57.06945,1.344135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.174105);
   ...
   mainFit1033->SetParameter(0,-1.255006);
   mainFit1033->SetParError(0,0.38266);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9336903);
   mainFit1033->SetParError(1,0.01141022);
