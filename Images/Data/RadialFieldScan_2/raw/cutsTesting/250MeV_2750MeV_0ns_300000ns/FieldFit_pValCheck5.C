...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.05986,70,64.83632);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.57024);
   Graph_Graph01035->SetMaximum(53.3467);
   ...
   mainFit1036->SetChisquare(7.170046);
   ...
   mainFit1036->SetParameter(0,-1.896225);
   mainFit1036->SetParError(0,0.3485445);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9499167);
   mainFit1036->SetParError(1,0.01212168);
   ...
   pt_LaTex = pt->AddText(" 0.95#pm0.0121");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.349");
   pt_LaTex = pt->AddText("   #minus2#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.996202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.996202,-38.57024,1.996202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.170046);
   ...
   mainFit1037->SetParameter(0,-1.896225);
   mainFit1037->SetParError(0,0.3485445);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9499167);
   mainFit1037->SetParError(1,0.01212168);
