...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.06945);
   Graph_Graph01029->SetMaximum(55.02845);
   ...
   mainFit1030->SetChisquare(7.016007);
   ...
   mainFit1030->SetParameter(0,-1.972288);
   mainFit1030->SetParError(0,0.3615359);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9387939);
   mainFit1030->SetParError(1,0.01107182);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.0111");
   pt_LaTex = pt->AddText("#minus1.97#pm0.362");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.100875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.100875,-57.06945,2.100875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.016007);
   ...
   mainFit1031->SetParameter(0,-1.972288);
   mainFit1031->SetParError(0,0.3615359);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9387939);
   mainFit1031->SetParError(1,0.01107182);
