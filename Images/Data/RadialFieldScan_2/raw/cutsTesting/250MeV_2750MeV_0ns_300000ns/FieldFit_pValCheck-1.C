...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.06945);
   Graph_Graph01023->SetMaximum(55.02845);
   ...
   mainFit1024->SetChisquare(10.69639);
   ...
   mainFit1024->SetParameter(0,-1.700006);
   mainFit1024->SetParError(0,0.3325158);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9404957);
   mainFit1024->SetParError(1,0.01103602);
   ...
   pt_LaTex = pt->AddText(" 0.94#pm0.011");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.333");
   pt_LaTex = pt->AddText("#minus1.81#pm0.351");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.807564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.807564,-57.06945,1.807564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(10.69639);
   ...
   mainFit1025->SetParameter(0,-1.700006);
   mainFit1025->SetParError(0,0.3325158);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9404957);
   mainFit1025->SetParError(1,0.01103602);
