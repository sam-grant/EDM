...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.06945);
   Graph_Graph01033->SetMaximum(55.02845);
   ...
   mainFit1034->SetChisquare(10.3916);
   ...
   mainFit1034->SetParameter(0,-1.561515);
   mainFit1034->SetParError(0,0.4165457);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9359185);
   mainFit1034->SetParError(1,0.01380901);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.46");
   pt_LaTex = pt->AddText("0.936#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.56#pm0.417");
   pt_LaTex = pt->AddText("#minus1.67#pm0.434");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.66843,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.66843,-57.06945,1.66843,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(10.3916);
   ...
   mainFit1035->SetParameter(0,-1.561515);
   mainFit1035->SetParError(0,0.4165457);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9359185);
   mainFit1035->SetParError(1,0.01380901);
