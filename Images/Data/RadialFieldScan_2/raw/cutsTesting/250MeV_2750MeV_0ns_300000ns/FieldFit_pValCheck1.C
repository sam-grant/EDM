...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-71.08169,75,69.04068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.06945);
   Graph_Graph01027->SetMaximum(55.02845);
   ...
   mainFit1028->SetChisquare(10.22228);
   ...
   mainFit1028->SetParameter(0,-1.817314);
   mainFit1028->SetParError(0,0.3735986);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9366284);
   mainFit1028->SetParError(1,0.01238445);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.41");
   pt_LaTex = pt->AddText("0.937#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.82#pm0.374");
   pt_LaTex = pt->AddText("#minus1.94#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.940272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.940272,-57.06945,1.940272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(10.22228);
   ...
   mainFit1029->SetParameter(0,-1.817314);
   mainFit1029->SetParError(0,0.3735986);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9366284);
   mainFit1029->SetParError(1,0.01238445);
