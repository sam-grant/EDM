...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01558875);
   Graph_Graph11015->SetMaximum(0.01334201);
   ...
   Graph_Graph21016->SetMinimum(-0.01078037);
   Graph_Graph21016->SetMaximum(0.01261919);
   ...
   Graph_Graph31017->SetMinimum(-0.01473024);
   Graph_Graph31017->SetMaximum(0.01909041);
   ...
   Graph_Graph41018->SetMinimum(-0.01464027);
   Graph_Graph41018->SetMaximum(0.02811059);
   ...
   Graph_Graph51019->SetMinimum(-0.004727357);
   Graph_Graph51019->SetMaximum(0.003549744);
