...
//=========  (Mon Apr 26 23:53:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.06945);
   Graph_Graph01020->SetMaximum(55.02845);
   ...
   mainFit1021->SetChisquare(10.69639);
   ...
   mainFit1021->SetParameter(0,-1.700006);
   mainFit1021->SetParError(0,0.3325158);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9404957);
   mainFit1021->SetParError(1,0.01103602);
   ...
   mainFit1022->SetChisquare(10.69639);
   ...
   mainFit1022->SetParameter(0,-1.700006);
   mainFit1022->SetParError(0,0.3325158);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9404957);
   mainFit1022->SetParError(1,0.01103602);
