...
//=========  (Mon Apr 26 23:53:20 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(13.6641);
   ...
   quadLineFit1002->SetParameter(0,74.57219);
   quadLineFit1002->SetParError(0,0.05160208);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.82177);
   quadLineFit1002->SetParError(1,0.8651868);
   ...
   quadLineFit1003->SetChisquare(13.6641);
   ...
   quadLineFit1003->SetParameter(0,74.57219);
   quadLineFit1003->SetParError(0,0.05160208);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.82177);
   quadLineFit1003->SetParError(1,0.8651868);
   ...
   Graph_30_ppm1003->SetMinimum(75.78895);
   Graph_30_ppm1003->SetMaximum(76.45842);
   ...
   quadLineFit1004->SetChisquare(2.32273);
   ...
   quadLineFit1004->SetParameter(0,74.46641);
   quadLineFit1004->SetParError(0,0.04261559);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.89409);
   quadLineFit1004->SetParError(1,0.6997843);
   ...
   quadLineFit1005->SetChisquare(2.32273);
   ...
   quadLineFit1005->SetParameter(0,74.46641);
   quadLineFit1005->SetParError(0,0.04261559);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.89409);
   quadLineFit1005->SetParError(1,0.6997843);
   ...
   Graph_10_ppm1005->SetMinimum(74.7733);
   Graph_10_ppm1005->SetMaximum(75.02683);
   ...
   quadLineFit1006->SetChisquare(2.194043);
   ...
   quadLineFit1006->SetParameter(0,74.3309);
   quadLineFit1006->SetParError(0,0.05006932);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.123906);
   quadLineFit1006->SetParError(1,0.811538);
   ...
   quadLineFit1007->SetChisquare(2.194043);
   ...
   quadLineFit1007->SetParameter(0,74.3309);
   quadLineFit1007->SetParError(0,0.05006932);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.123906);
   quadLineFit1007->SetParError(1,0.811538);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.47999);
   Graph_mI10_ppm1007->SetMaximum(73.82062);
   ...
   quadLineFit1008->SetChisquare(3.823125);
   ...
   quadLineFit1008->SetParameter(0,74.42038);
   quadLineFit1008->SetParError(0,0.04391618);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.54655);
   quadLineFit1008->SetParError(1,0.7143046);
   ...
   quadLineFit1009->SetChisquare(3.823125);
   ...
   quadLineFit1009->SetParameter(0,74.42038);
   quadLineFit1009->SetParError(0,0.04391618);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.54655);
   quadLineFit1009->SetParError(1,0.7143046);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.07588);
   Graph_mI30_ppm1009->SetMaximum(72.84317);
   ...
   quadLineFit1010->SetChisquare(4.649599);
   ...
   quadLineFit1010->SetParameter(0,74.32062);
   quadLineFit1010->SetParError(0,0.04135414);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.19531);
   quadLineFit1010->SetParError(1,0.7151818);
   ...
   quadLineFit1011->SetChisquare(4.649599);
   ...
   quadLineFit1011->SetParameter(0,74.32062);
   quadLineFit1011->SetParError(0,0.04135414);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.19531);
   quadLineFit1011->SetParError(1,0.7151818);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19964);
   Graph_mI50_ppm1011->SetMaximum(71.85072);
   ...
   quadLineFit1012->SetChisquare(0.2730498);
   ...
   quadLineFit1012->SetParameter(0,74.15391);
   quadLineFit1012->SetParError(0,0.08347521);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.23472);
   quadLineFit1012->SetParError(1,1.493234);
   ...
   quadLineFit1013->SetChisquare(0.2730498);
   ...
   quadLineFit1013->SetParameter(0,74.15391);
   quadLineFit1013->SetParError(0,0.08347521);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.23472);
   quadLineFit1013->SetParError(1,1.493234);
