...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.90256);
   Graph_Graph01023->SetMaximum(50.13259);
   ...
   mainFit1024->SetChisquare(3.82237);
   ...
   mainFit1024->SetParameter(0,-1.640593);
   mainFit1024->SetParError(0,0.509506);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.844763);
   mainFit1024->SetParError(1,0.01691064);
   ...
   mainFit1025->SetChisquare(3.82237);
   ...
   mainFit1025->SetParameter(0,-1.640593);
   mainFit1025->SetParError(0,0.509506);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.844763);
   mainFit1025->SetParError(1,0.01691064);
