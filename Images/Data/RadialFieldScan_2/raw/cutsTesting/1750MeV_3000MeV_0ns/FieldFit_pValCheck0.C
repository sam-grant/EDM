...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-61.48926,50,41.54852);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.18548);
   Graph_Graph01025->SetMaximum(31.24474);
   ...
   mainFit1026->SetChisquare(3.668243);
   ...
   mainFit1026->SetParameter(0,-1.561149);
   mainFit1026->SetParError(0,0.5482329);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8501076);
   mainFit1026->SetParError(1,0.02170207);
   ...
   pt_LaTex = pt->AddText(" 0.85#pm0.0217");
   pt_LaTex = pt->AddText("#minus1.56#pm0.548");
   pt_LaTex = pt->AddText("#minus1.84#pm0.652");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.836414,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.836414,-51.18548,1.836414,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.668243);
   ...
   mainFit1027->SetParameter(0,-1.561149);
   mainFit1027->SetParError(0,0.5482329);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8501076);
   mainFit1027->SetParError(1,0.02170207);
