...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0145451);
   Graph_Graph11015->SetMaximum(0.01939672);
   ...
   Graph_Graph21016->SetMinimum(-0.01565368);
   Graph_Graph21016->SetMaximum(0.01835987);
   ...
   Graph_Graph31017->SetMinimum(-0.03014648);
   Graph_Graph31017->SetMaximum(0.02858903);
   ...
   Graph_Graph41018->SetMinimum(-0.01109152);
   Graph_Graph41018->SetMaximum(0.009212984);
   ...
   Graph_Graph51019->SetMinimum(-0.01019148);
   Graph_Graph51019->SetMaximum(0.00765501);
