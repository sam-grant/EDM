...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.90256);
   Graph_Graph01033->SetMaximum(50.13259);
   ...
   mainFit1034->SetChisquare(1.753138);
   ...
   mainFit1034->SetParameter(0,-1.088069);
   mainFit1034->SetParError(0,0.638074);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8264864);
   mainFit1034->SetParError(1,0.02115375);
   ...
   pt_LaTex = pt->AddText("0.826#pm0.0212");
   pt_LaTex = pt->AddText("#minus1.09#pm0.638");
   pt_LaTex = pt->AddText("#minus1.32#pm0.757");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.316499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.316499,-52.90256,1.316499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.753138);
   ...
   mainFit1035->SetParameter(0,-1.088069);
   mainFit1035->SetParError(0,0.638074);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8264864);
   mainFit1035->SetParError(1,0.02115375);
