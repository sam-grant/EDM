...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.89101,70,59.2338);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.27853);
   Graph_Graph01035->SetMaximum(48.62131);
   ...
   mainFit1036->SetChisquare(2.992591);
   ...
   mainFit1036->SetParameter(0,-1.786475);
   mainFit1036->SetParError(0,0.5340774);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8517562);
   mainFit1036->SetParError(1,0.01856959);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.998");
   pt_LaTex = pt->AddText("0.852#pm0.0186");
   pt_LaTex = pt->AddText("#minus1.79#pm0.534");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.617");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.097402,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.097402,-36.27853,2.097402,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.992591);
   ...
   mainFit1037->SetParameter(0,-1.786475);
   mainFit1037->SetParError(0,0.5340774);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8517562);
   mainFit1037->SetParError(1,0.01856959);
