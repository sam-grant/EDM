...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.90256);
   Graph_Graph01031->SetMaximum(50.13259);
   ...
   mainFit1032->SetChisquare(3.82108);
   ...
   mainFit1032->SetParameter(0,-1.651057);
   mainFit1032->SetParError(0,0.5867298);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8449282);
   mainFit1032->SetParError(1,0.01749151);
   ...
   pt_LaTex = pt->AddText("0.845#pm0.0175");
   pt_LaTex = pt->AddText("#minus1.65#pm0.587");
   pt_LaTex = pt->AddText("#minus1.95#pm0.685");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.95408,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.95408,-52.90256,1.95408,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.82108);
   ...
   mainFit1033->SetParameter(0,-1.651057);
   mainFit1033->SetParError(0,0.5867298);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8449282);
   mainFit1033->SetParError(1,0.01749151);
