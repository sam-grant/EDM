...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.90256);
   Graph_Graph01027->SetMaximum(50.13259);
   ...
   mainFit1028->SetChisquare(3.59907);
   ...
   mainFit1028->SetParameter(0,-1.517632);
   mainFit1028->SetParError(0,0.5721281);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8488236);
   mainFit1028->SetParError(1,0.01896612);
   ...
   pt_LaTex = pt->AddText("0.849#pm0.019");
   pt_LaTex = pt->AddText("#minus1.52#pm0.572");
   pt_LaTex = pt->AddText("#minus1.79#pm0.679");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.787924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.787924,-52.90256,1.787924,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.59907);
   ...
   mainFit1029->SetParameter(0,-1.517632);
   mainFit1029->SetParError(0,0.5721281);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8488236);
   mainFit1029->SetParError(1,0.01896612);
