...
//=========  (Fri Apr 23 18:48:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.90256);
   Graph_Graph01029->SetMaximum(50.13259);
   ...
   mainFit1030->SetChisquare(1.530315);
   ...
   mainFit1030->SetParameter(0,-1.969929);
   mainFit1030->SetParError(0,0.5539974);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8427268);
   mainFit1030->SetParError(1,0.01696428);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.51");
   pt_LaTex = pt->AddText("0.843#pm0.017");
   pt_LaTex = pt->AddText("#minus1.97#pm0.554");
   pt_LaTex = pt->AddText("#minus2.34#pm0.654");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.337565,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.337565,-52.90256,2.337565,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.530315);
   ...
   mainFit1031->SetParameter(0,-1.969929);
   mainFit1031->SetParError(0,0.5539974);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8427268);
   mainFit1031->SetParError(1,0.01696428);
