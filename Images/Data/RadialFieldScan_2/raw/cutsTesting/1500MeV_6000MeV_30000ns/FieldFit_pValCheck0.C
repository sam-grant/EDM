...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.63996,50,39.65303);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.61066);
   Graph_Graph01025->SetMaximum(29.62373);
   ...
   mainFit1026->SetChisquare(2.245631);
   ...
   mainFit1026->SetParameter(0,-0.4050317);
   mainFit1026->SetParError(0,0.6100838);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.765152);
   mainFit1026->SetParError(1,0.02416211);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.749");
   pt_LaTex = pt->AddText("0.765#pm0.0242");
   pt_LaTex = pt->AddText("#minus0.405#pm 0.61");
   pt_LaTex = pt->AddText("#minus0.529#pm0.799");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.529348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.529348,-50.61066,0.529348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.245631);
   ...
   mainFit1027->SetParameter(0,-0.4050317);
   mainFit1027->SetParError(0,0.6100838);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.765152);
   mainFit1027->SetParError(1,0.02416211);
