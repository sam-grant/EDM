...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.38561);
   Graph_Graph01023->SetMaximum(49.14816);
   ...
   mainFit1024->SetChisquare(2.692397);
   ...
   mainFit1024->SetParameter(0,-0.2544884);
   mainFit1024->SetParError(0,0.567003);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7752898);
   mainFit1024->SetParError(1,0.01881663);
   ...
   mainFit1025->SetChisquare(2.692397);
   ...
   mainFit1025->SetParameter(0,-0.2544884);
   mainFit1025->SetParError(0,0.567003);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7752898);
   mainFit1025->SetParError(1,0.01881663);
