...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.38561);
   Graph_Graph01027->SetMaximum(49.14816);
   ...
   mainFit1028->SetChisquare(0.8958493);
   ...
   mainFit1028->SetParameter(0,0.1327318);
   mainFit1028->SetParError(0,0.6363587);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7880624);
   mainFit1028->SetParError(1,0.02109204);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.299");
   pt_LaTex = pt->AddText("0.788#pm0.0211");
   pt_LaTex = pt->AddText("0.133#pm0.636");
   pt_LaTex = pt->AddText("0.168#pm0.807");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.168428,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.168428,-52.38561,-0.168428,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8958493);
   ...
   mainFit1029->SetParameter(0,0.1327318);
   mainFit1029->SetParError(0,0.6363587);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7880624);
   mainFit1029->SetParError(1,0.02109204);
