...
//=========  (Wed Apr 21 13:23:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01430541);
   Graph_Graph11015->SetMaximum(0.01818884);
   ...
   Graph_Graph21016->SetMinimum(-0.01235506);
   Graph_Graph21016->SetMaximum(0.01455343);
   ...
   Graph_Graph31017->SetMinimum(-0.05457155);
   Graph_Graph31017->SetMaximum(0.04457318);
   ...
   Graph_Graph41018->SetMinimum(-0.00719368);
   Graph_Graph41018->SetMaximum(0.01295451);
   ...
   Graph_Graph51019->SetMinimum(-0.002884071);
   Graph_Graph51019->SetMaximum(0.003854033);
