...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.38561);
   Graph_Graph01029->SetMaximum(49.14816);
   ...
   mainFit1030->SetChisquare(2.527874);
   ...
   mainFit1030->SetParameter(0,-0.352821);
   mainFit1030->SetParError(0,0.6166603);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7746831);
   mainFit1030->SetParError(1,0.01887573);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.843");
   pt_LaTex = pt->AddText("0.775#pm0.0189");
   pt_LaTex = pt->AddText("#minus0.353#pm0.617");
   pt_LaTex = pt->AddText("#minus0.455#pm0.795");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4554392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4554392,-52.38561,0.4554392,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.527874);
   ...
   mainFit1031->SetParameter(0,-0.352821);
   mainFit1031->SetParError(0,0.6166603);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7746831);
   mainFit1031->SetParError(1,0.01887573);
