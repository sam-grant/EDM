...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.38561);
   Graph_Graph01033->SetMaximum(49.14816);
   ...
   mainFit1034->SetChisquare(2.569738);
   ...
   mainFit1034->SetParameter(0,-0.4039985);
   mainFit1034->SetParError(0,0.7097405);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7802355);
   mainFit1034->SetParError(1,0.02352608);
   ...
   pt_LaTex = pt->AddText(" 0.78#pm0.0235");
   pt_LaTex = pt->AddText("#minus0.404#pm 0.71");
   pt_LaTex = pt->AddText("#minus0.518#pm0.903");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5177905,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5177905,-52.38561,0.5177905,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.569738);
   ...
   mainFit1035->SetParameter(0,-0.4039985);
   mainFit1035->SetParError(0,0.7097405);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7802355);
   mainFit1035->SetParError(1,0.02352608);
