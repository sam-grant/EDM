...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.71172,70,56.96676);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.94387);
   Graph_Graph01035->SetMaximum(47.19891);
   ...
   mainFit1036->SetChisquare(1.613911);
   ...
   mainFit1036->SetParameter(0,-0.0690702);
   mainFit1036->SetParError(0,0.5944495);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7664163);
   mainFit1036->SetParError(1,0.02066579);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.538");
   pt_LaTex = pt->AddText("0.766#pm0.0207");
   pt_LaTex = pt->AddText("#minus0.0691#pm0.594");
   pt_LaTex = pt->AddText("#minus0.0901#pm0.775");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.090121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.090121,-30.94387,0.090121,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.613911);
   ...
   mainFit1037->SetParameter(0,-0.0690702);
   mainFit1037->SetParError(0,0.5944495);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7664163);
   mainFit1037->SetParError(1,0.02066579);
