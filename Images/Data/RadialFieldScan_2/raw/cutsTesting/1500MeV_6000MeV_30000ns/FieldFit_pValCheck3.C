...
//=========  (Wed Apr 21 13:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.38561);
   Graph_Graph01031->SetMaximum(49.14816);
   ...
   mainFit1032->SetChisquare(2.289928);
   ...
   mainFit1032->SetParameter(0,-0.4600813);
   mainFit1032->SetParError(0,0.6530813);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7784544);
   mainFit1032->SetParError(1,0.01946659);
   ...
   pt_LaTex = pt->AddText("0.778#pm0.0195");
   pt_LaTex = pt->AddText("#minus0.46#pm0.653");
   pt_LaTex = pt->AddText("#minus0.591#pm0.835");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5910189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5910189,-52.38561,0.5910189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.289928);
   ...
   mainFit1033->SetParameter(0,-0.4600813);
   mainFit1033->SetParError(0,0.6530813);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7784544);
   mainFit1033->SetParError(1,0.01946659);
