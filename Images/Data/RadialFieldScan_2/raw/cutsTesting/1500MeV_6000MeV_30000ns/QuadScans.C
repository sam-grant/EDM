...
//=========  (Wed Apr 21 13:23:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1384967);
   ...
   quadLineFit1002->SetParameter(0,74.92524);
   quadLineFit1002->SetParError(0,0.087604);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.21731);
   quadLineFit1002->SetParError(1,1.469706);
   ...
   quadLineFit1003->SetChisquare(0.1384967);
   ...
   quadLineFit1003->SetParameter(0,74.92524);
   quadLineFit1003->SetParError(0,0.087604);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.21731);
   quadLineFit1003->SetParError(1,1.469706);
   ...
   Graph_30_ppm1003->SetMinimum(75.97392);
   Graph_30_ppm1003->SetMaximum(76.5319);
   ...
   quadLineFit1004->SetChisquare(1.094793);
   ...
   quadLineFit1004->SetParameter(0,74.91632);
   quadLineFit1004->SetParError(0,0.07259637);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.74422);
   quadLineFit1004->SetParError(1,1.193312);
   ...
   quadLineFit1005->SetChisquare(1.094793);
   ...
   quadLineFit1005->SetParameter(0,74.91632);
   quadLineFit1005->SetParError(0,0.07259637);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.74422);
   quadLineFit1005->SetParError(1,1.193312);
   ...
   Graph_10_ppm1005->SetMinimum(75.06137);
   Graph_10_ppm1005->SetMaximum(75.30853);
   ...
   quadLineFit1006->SetChisquare(0.9949068);
   ...
   quadLineFit1006->SetParameter(0,74.68236);
   quadLineFit1006->SetParError(0,0.08509593);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.008442);
   quadLineFit1006->SetParError(1,1.380128);
   ...
   quadLineFit1007->SetChisquare(0.9949068);
   ...
   quadLineFit1007->SetParameter(0,74.68236);
   quadLineFit1007->SetParError(0,0.08509593);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.008442);
   quadLineFit1007->SetParError(1,1.380128);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.99989);
   Graph_mI10_ppm1007->SetMaximum(74.266);
   ...
   quadLineFit1008->SetChisquare(12.24154);
   ...
   quadLineFit1008->SetParameter(0,74.57293);
   quadLineFit1008->SetParError(0,0.07470791);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.345458);
   quadLineFit1008->SetParError(1,1.216072);
   ...
   quadLineFit1009->SetChisquare(12.24154);
   ...
   quadLineFit1009->SetParameter(0,74.57293);
   quadLineFit1009->SetParError(0,0.07470791);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.345458);
   quadLineFit1009->SetParError(1,1.216072);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.74501);
   Graph_mI30_ppm1009->SetMaximum(73.35446);
   ...
   quadLineFit1010->SetChisquare(0.3320328);
   ...
   quadLineFit1010->SetParameter(0,74.48121);
   quadLineFit1010->SetParError(0,0.07069046);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.20847);
   quadLineFit1010->SetParError(1,1.223497);
   ...
   quadLineFit1011->SetChisquare(0.3320328);
   ...
   quadLineFit1011->SetParameter(0,74.48121);
   quadLineFit1011->SetParError(0,0.07069046);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.20847);
   quadLineFit1011->SetParError(1,1.223497);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.8637);
   Graph_mI50_ppm1011->SetMaximum(72.46875);
   ...
   quadLineFit1012->SetChisquare(0.06213716);
   ...
   quadLineFit1012->SetParameter(0,74.52407);
   quadLineFit1012->SetParError(0,0.1426093);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.37287);
   quadLineFit1012->SetParError(1,2.551593);
   ...
   quadLineFit1013->SetChisquare(0.06213716);
   ...
   quadLineFit1013->SetParameter(0,74.52407);
   quadLineFit1013->SetParError(0,0.1426093);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.37287);
   quadLineFit1013->SetParError(1,2.551593);
