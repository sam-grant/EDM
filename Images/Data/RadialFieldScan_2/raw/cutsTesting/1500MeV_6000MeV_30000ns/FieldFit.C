...
//=========  (Wed Apr 21 13:23:19 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-65.07733,75,61.83988);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-52.38561);
   Graph_Graph01020->SetMaximum(49.14816);
   ...
   mainFit1021->SetChisquare(2.692397);
   ...
   mainFit1021->SetParameter(0,-0.2544884);
   mainFit1021->SetParError(0,0.567003);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7752898);
   mainFit1021->SetParError(1,0.01881663);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.673");
   pt_LaTex = pt->AddText("0.775#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.254#pm0.567");
   pt_LaTex = pt->AddText("#minus0.328#pm 0.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3282493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3282493,-52.38561,0.3282493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.692397);
   ...
   mainFit1022->SetParameter(0,-0.2544884);
   mainFit1022->SetParError(0,0.567003);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7752898);
   mainFit1022->SetParError(1,0.01881663);
