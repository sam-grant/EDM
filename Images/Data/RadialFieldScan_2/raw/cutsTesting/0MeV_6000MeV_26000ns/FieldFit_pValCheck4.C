...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.15884);
   Graph_Graph01033->SetMaximum(55.6752);
   ...
   mainFit1034->SetChisquare(2.630711);
   ...
   mainFit1034->SetParameter(0,-2.087758);
   mainFit1034->SetParError(0,0.4823942);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9271738);
   mainFit1034->SetParError(1,0.01606589);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.09#pm0.482");
   pt_LaTex = pt->AddText("#minus2.25#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.251744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.251744,-60.15884,2.251744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.630711);
   ...
   mainFit1035->SetParameter(0,-2.087758);
   mainFit1035->SetParError(0,0.4823942);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9271738);
   mainFit1035->SetParError(1,0.01606589);
