...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.15884);
   Graph_Graph01031->SetMaximum(55.6752);
   ...
   mainFit1032->SetChisquare(3.168453);
   ...
   mainFit1032->SetParameter(0,-1.820678);
   mainFit1032->SetParError(0,0.4439842);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9191104);
   mainFit1032->SetParError(1,0.01327887);
   ...
   pt_LaTex = pt->AddText("0.919#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.82#pm0.444");
   pt_LaTex = pt->AddText("#minus1.98#pm0.477");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.980914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.980914,-60.15884,1.980914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.168453);
   ...
   mainFit1033->SetParameter(0,-1.820678);
   mainFit1033->SetParError(0,0.4439842);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9191104);
   mainFit1033->SetParError(1,0.01327887);
