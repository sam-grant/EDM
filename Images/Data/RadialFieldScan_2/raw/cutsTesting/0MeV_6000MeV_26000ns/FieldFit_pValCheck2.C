...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.15884);
   Graph_Graph01029->SetMaximum(55.6752);
   ...
   mainFit1030->SetChisquare(2.883922);
   ...
   mainFit1030->SetParameter(0,-1.961537);
   mainFit1030->SetParError(0,0.4196099);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9192033);
   mainFit1030->SetParError(1,0.01288916);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.961");
   pt_LaTex = pt->AddText("0.919#pm0.0129");
   pt_LaTex = pt->AddText("#minus1.96#pm 0.42");
   pt_LaTex = pt->AddText("#minus2.13#pm0.454");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.133953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.133953,-60.15884,2.133953,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.883922);
   ...
   mainFit1031->SetParameter(0,-1.961537);
   mainFit1031->SetParError(0,0.4196099);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9192033);
   mainFit1031->SetParError(1,0.01288916);
