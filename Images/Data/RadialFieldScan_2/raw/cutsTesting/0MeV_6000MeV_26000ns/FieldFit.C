...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.15884);
   Graph_Graph01020->SetMaximum(55.6752);
   ...
   mainFit1021->SetChisquare(3.212245);
   ...
   mainFit1021->SetParameter(0,-1.866721);
   mainFit1021->SetParError(0,0.3856103);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9198121);
   mainFit1021->SetParError(1,0.01284488);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.803");
   pt_LaTex = pt->AddText(" 0.92#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.87#pm0.386");
   pt_LaTex = pt->AddText("#minus2.03#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.029459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.029459,-60.15884,2.029459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.212245);
   ...
   mainFit1022->SetParameter(0,-1.866721);
   mainFit1022->SetParError(0,0.3856103);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9198121);
   mainFit1022->SetParError(1,0.01284488);
