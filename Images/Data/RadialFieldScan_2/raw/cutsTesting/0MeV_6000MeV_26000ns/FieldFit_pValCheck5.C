...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.80771,70,64.98838);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.4281);
   Graph_Graph01035->SetMaximum(53.60877);
   ...
   mainFit1036->SetChisquare(2.858692);
   ...
   mainFit1036->SetParameter(0,-1.79503);
   mainFit1036->SetParError(0,0.4040236);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9163431);
   mainFit1036->SetParError(1,0.0141097);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.0141");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.404");
   pt_LaTex = pt->AddText("#minus1.96#pm0.434");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.958907,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.958907,-37.4281,1.958907,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.858692);
   ...
   mainFit1037->SetParameter(0,-1.79503);
   mainFit1037->SetParError(0,0.4040236);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9163431);
   mainFit1037->SetParError(1,0.0141097);
