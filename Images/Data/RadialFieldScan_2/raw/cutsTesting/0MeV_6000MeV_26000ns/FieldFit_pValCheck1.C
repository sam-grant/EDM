...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-74.6381,75,70.15446);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.15884);
   Graph_Graph01027->SetMaximum(55.6752);
   ...
   mainFit1028->SetChisquare(0.6542375);
   ...
   mainFit1028->SetParameter(0,-1.548707);
   mainFit1028->SetParError(0,0.4338635);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9303956);
   mainFit1028->SetParError(1,0.01444942);
   ...
   pt_LaTex = pt->AddText("#minus1.55#pm0.434");
   pt_LaTex = pt->AddText("#minus1.66#pm0.469");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.664568,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.664568,-60.15884,1.664568,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6542375);
   ...
   mainFit1029->SetParameter(0,-1.548707);
   mainFit1029->SetParError(0,0.4338635);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9303956);
   mainFit1029->SetParError(1,0.01444942);
