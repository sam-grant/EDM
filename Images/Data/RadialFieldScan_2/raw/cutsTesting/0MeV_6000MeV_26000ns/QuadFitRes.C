...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008977968);
   Graph_Graph11015->SetMaximum(0.008498382);
   ...
   Graph_Graph21016->SetMinimum(-0.01004366);
   Graph_Graph21016->SetMaximum(0.01180696);
   ...
   Graph_Graph31017->SetMinimum(-0.02164089);
   Graph_Graph31017->SetMaximum(0.01588753);
   ...
   Graph_Graph41018->SetMinimum(-0.007774185);
   Graph_Graph41018->SetMaximum(0.007608708);
   ...
   Graph_Graph51019->SetMinimum(-0.0007877164);
   Graph_Graph51019->SetMaximum(0.001052447);
