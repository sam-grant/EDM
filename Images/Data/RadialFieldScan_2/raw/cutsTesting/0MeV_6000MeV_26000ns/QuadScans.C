...
//=========  (Wed Apr 21 15:59:43 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.034369);
   ...
   quadLineFit1002->SetParameter(0,74.48211);
   quadLineFit1002->SetParError(0,0.06042354);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.00848);
   quadLineFit1002->SetParError(1,1.013886);
   ...
   quadLineFit1003->SetChisquare(2.034369);
   ...
   quadLineFit1003->SetParameter(0,74.48211);
   quadLineFit1003->SetParError(0,0.06042354);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.00848);
   quadLineFit1003->SetParError(1,1.013886);
   ...
   Graph_30_ppm1003->SetMinimum(75.74309);
   Graph_30_ppm1003->SetMaximum(76.36279);
   ...
   quadLineFit1004->SetChisquare(0.8666191);
   ...
   quadLineFit1004->SetParameter(0,74.53447);
   quadLineFit1004->SetParError(0,0.04935567);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.70988);
   quadLineFit1004->SetParError(1,0.8111075);
   ...
   quadLineFit1005->SetChisquare(0.8666191);
   ...
   quadLineFit1005->SetParameter(0,74.53447);
   quadLineFit1005->SetParError(0,0.04935567);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.70988);
   quadLineFit1005->SetParError(1,0.8111075);
   ...
   Graph_10_ppm1005->SetMinimum(74.75237);
   Graph_10_ppm1005->SetMaximum(74.97855);
   ...
   quadLineFit1006->SetChisquare(1.4237);
   ...
   quadLineFit1006->SetParameter(0,74.37668);
   quadLineFit1006->SetParError(0,0.05784252);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.820792);
   quadLineFit1006->SetParError(1,0.9380019);
   ...
   quadLineFit1007->SetChisquare(1.4237);
   ...
   quadLineFit1007->SetParameter(0,74.37668);
   quadLineFit1007->SetParError(0,0.05784252);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.820792);
   quadLineFit1007->SetParError(1,0.9380019);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50818);
   Graph_mI10_ppm1007->SetMaximum(73.82757);
   ...
   quadLineFit1008->SetChisquare(4.004814);
   ...
   quadLineFit1008->SetParameter(0,74.35024);
   quadLineFit1008->SetParError(0,0.05077808);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.2133);
   quadLineFit1008->SetParError(1,0.8264317);
   ...
   quadLineFit1009->SetChisquare(4.004814);
   ...
   quadLineFit1009->SetParameter(0,74.35024);
   quadLineFit1009->SetParError(0,0.05077808);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.2133);
   quadLineFit1009->SetParError(1,0.8264317);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.13178);
   Graph_mI30_ppm1009->SetMaximum(72.85817);
   ...
   quadLineFit1010->SetChisquare(0.5530931);
   ...
   quadLineFit1010->SetParameter(0,74.27839);
   quadLineFit1010->SetParError(0,0.04795969);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.01169);
   quadLineFit1010->SetParError(1,0.8300037);
   ...
   quadLineFit1011->SetChisquare(0.5530931);
   ...
   quadLineFit1011->SetParameter(0,74.27839);
   quadLineFit1011->SetParError(0,0.04795969);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.01169);
   quadLineFit1011->SetParError(1,0.8300037);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19553);
   Graph_mI50_ppm1011->SetMaximum(71.88487);
   ...
   quadLineFit1012->SetChisquare(0.01005403);
   ...
   quadLineFit1012->SetParameter(0,74.31682);
   quadLineFit1012->SetParError(0,0.09687039);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.77272);
   quadLineFit1012->SetParError(1,1.733285);
   ...
   quadLineFit1013->SetChisquare(0.01005403);
   ...
   quadLineFit1013->SetParameter(0,74.31682);
   quadLineFit1013->SetParError(0,0.09687039);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.77272);
   quadLineFit1013->SetParError(1,1.733285);
