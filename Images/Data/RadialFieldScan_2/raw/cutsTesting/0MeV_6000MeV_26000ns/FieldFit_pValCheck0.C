...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.51275,50,44.52774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.1087);
   Graph_Graph01025->SetMaximum(33.12369);
   ...
   mainFit1026->SetChisquare(1.765236);
   ...
   mainFit1026->SetParameter(0,-2.049613);
   mainFit1026->SetParError(0,0.414499);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9075262);
   mainFit1026->SetParError(1,0.01641202);
   ...
   pt_LaTex = pt->AddText("0.908#pm0.0164");
   pt_LaTex = pt->AddText("#minus2.05#pm0.414");
   pt_LaTex = pt->AddText("#minus2.26#pm0.463");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.258461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.258461,-58.1087,2.258461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.765236);
   ...
   mainFit1027->SetParameter(0,-2.049613);
   mainFit1027->SetParError(0,0.414499);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9075262);
   mainFit1027->SetParError(1,0.01641202);
