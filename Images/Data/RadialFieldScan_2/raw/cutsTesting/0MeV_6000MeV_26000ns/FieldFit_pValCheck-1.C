...
//=========  (Wed Apr 21 15:59:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.15884);
   Graph_Graph01023->SetMaximum(55.6752);
   ...
   mainFit1024->SetChisquare(3.212245);
   ...
   mainFit1024->SetParameter(0,-1.866721);
   mainFit1024->SetParError(0,0.3856103);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9198121);
   mainFit1024->SetParError(1,0.01284488);
   ...
   mainFit1025->SetChisquare(3.212245);
   ...
   mainFit1025->SetParameter(0,-1.866721);
   mainFit1025->SetParError(0,0.3856103);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9198121);
   mainFit1025->SetParError(1,0.01284488);
