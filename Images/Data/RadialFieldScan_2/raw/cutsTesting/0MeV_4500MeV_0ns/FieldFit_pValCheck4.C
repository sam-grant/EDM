...
//=========  (Fri Apr 23 11:27:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.21343);
   Graph_Graph01033->SetMaximum(50.85047);
   ...
   mainFit1034->SetChisquare(53.71525);
   ...
   mainFit1034->SetParameter(0,-1.487257);
   mainFit1034->SetParError(0,0.3720522);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8844441);
   mainFit1034->SetParError(1,0.01223704);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 17.9");
   pt_LaTex = pt->AddText("0.884#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.49#pm0.372");
   pt_LaTex = pt->AddText("#minus1.68#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.681572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.681572,-50.21343,1.681572,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(53.71525);
   ...
   mainFit1035->SetParameter(0,-1.487257);
   mainFit1035->SetParError(0,0.3720522);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8844441);
   mainFit1035->SetParError(1,0.01223704);
