...
//=========  (Fri Apr 23 11:27:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.21343);
   Graph_Graph01023->SetMaximum(50.85047);
   ...
   mainFit1024->SetChisquare(53.79052);
   ...
   mainFit1024->SetParameter(0,-1.548872);
   mainFit1024->SetParError(0,0.2966213);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8864607);
   mainFit1024->SetParError(1,0.009783281);
   ...
   pt_LaTex = pt->AddText("0.886#pm0.00978");
   pt_LaTex = pt->AddText("#minus1.55#pm0.297");
   pt_LaTex = pt->AddText("#minus1.75#pm0.332");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.747253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.747253,-50.21343,1.747253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(53.79052);
   ...
   mainFit1025->SetParameter(0,-1.548872);
   mainFit1025->SetParError(0,0.2966213);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8864607);
   mainFit1025->SetParError(1,0.009783281);
