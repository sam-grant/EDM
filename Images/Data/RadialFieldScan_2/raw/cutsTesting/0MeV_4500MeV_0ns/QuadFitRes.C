...
//=========  (Fri Apr 23 11:27:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03340285);
   Graph_Graph11015->SetMaximum(0.01768122);
   ...
   Graph_Graph21016->SetMinimum(-0.01489357);
   Graph_Graph21016->SetMaximum(0.01731948);
   ...
   Graph_Graph31017->SetMinimum(-0.009537754);
   Graph_Graph31017->SetMaximum(0.01942532);
   ...
   Graph_Graph41018->SetMinimum(-0.02407773);
   Graph_Graph41018->SetMaximum(0.0411838);
   ...
   Graph_Graph51019->SetMinimum(-0.01907328);
   Graph_Graph51019->SetMaximum(0.01430548);
