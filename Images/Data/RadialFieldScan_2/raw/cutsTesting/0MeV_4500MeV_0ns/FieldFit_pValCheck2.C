...
//=========  (Fri Apr 23 11:27:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.21343);
   Graph_Graph01029->SetMaximum(50.85047);
   ...
   mainFit1030->SetChisquare(51.17108);
   ...
   mainFit1030->SetParameter(0,-1.752132);
   mainFit1030->SetParError(0,0.3221127);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8852511);
   mainFit1030->SetParError(1,0.009811775);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 17.1");
   pt_LaTex = pt->AddText("0.885#pm0.00981");
   pt_LaTex = pt->AddText("#minus1.75#pm0.322");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.979248,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.979248,-50.21343,1.979248,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(51.17108);
   ...
   mainFit1031->SetParameter(0,-1.752132);
   mainFit1031->SetParError(0,0.3221127);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8852511);
   mainFit1031->SetParError(1,0.009811775);
