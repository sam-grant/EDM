...
//=========  (Fri Apr 23 11:27:16 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-59.1254,50,44.87839);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.72502);
   Graph_Graph01025->SetMaximum(34.47801);
   ...
   mainFit1026->SetChisquare(49.62893);
   ...
   mainFit1026->SetParameter(0,-1.303885);
   mainFit1026->SetParError(0,0.3200097);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9027775);
   mainFit1026->SetParError(1,0.01263674);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 16.5");
   pt_LaTex = pt->AddText("0.903#pm0.0126");
   pt_LaTex = pt->AddText(" #minus1.3#pm 0.32");
   pt_LaTex = pt->AddText("#minus1.44#pm0.358");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.444304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.444304,-48.72502,1.444304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(49.62893);
   ...
   mainFit1027->SetParameter(0,-1.303885);
   mainFit1027->SetParError(0,0.3200097);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9027775);
   mainFit1027->SetParError(1,0.01263674);
