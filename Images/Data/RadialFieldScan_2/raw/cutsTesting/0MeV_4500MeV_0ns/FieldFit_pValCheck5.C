...
//=========  (Fri Apr 23 11:27:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.73873,70,60.26192);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.03866);
   Graph_Graph01035->SetMaximum(49.56185);
   ...
   mainFit1036->SetChisquare(32.74739);
   ...
   mainFit1036->SetParameter(0,-1.980899);
   mainFit1036->SetParError(0,0.3112137);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9068747);
   mainFit1036->SetParError(1,0.01074784);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 10.9");
   pt_LaTex = pt->AddText("0.907#pm0.0107");
   pt_LaTex = pt->AddText("#minus1.98#pm0.311");
   pt_LaTex = pt->AddText("#minus2.18#pm0.337");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.184314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.184314,-36.03866,2.184314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(32.74739);
   ...
   mainFit1037->SetParameter(0,-1.980899);
   mainFit1037->SetParError(0,0.3112137);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9068747);
   mainFit1037->SetParError(1,0.01074784);
