...
//=========  (Fri Apr 23 11:27:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.21343);
   Graph_Graph01020->SetMaximum(50.85047);
   ...
   mainFit1021->SetChisquare(53.79052);
   ...
   mainFit1021->SetParameter(0,-1.548872);
   mainFit1021->SetParError(0,0.2966213);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8864607);
   mainFit1021->SetParError(1,0.009783281);
   ...
   mainFit1022->SetChisquare(53.79052);
   ...
   mainFit1022->SetParameter(0,-1.548872);
   mainFit1022->SetParError(0,0.2966213);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8864607);
   mainFit1022->SetParError(1,0.009783281);
