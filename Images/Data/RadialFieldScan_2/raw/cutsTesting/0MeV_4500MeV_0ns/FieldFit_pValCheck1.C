...
//=========  (Fri Apr 23 11:27:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.21343);
   Graph_Graph01027->SetMaximum(50.85047);
   ...
   mainFit1028->SetChisquare(39.47368);
   ...
   mainFit1028->SetParameter(0,-2.115489);
   mainFit1028->SetParError(0,0.3322778);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8680414);
   mainFit1028->SetParError(1,0.01092728);
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.437083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.437083,-50.21343,2.437083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(39.47368);
   ...
   mainFit1029->SetParameter(0,-2.115489);
   mainFit1029->SetParError(0,0.3322778);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8680414);
   mainFit1029->SetParError(1,0.01092728);
