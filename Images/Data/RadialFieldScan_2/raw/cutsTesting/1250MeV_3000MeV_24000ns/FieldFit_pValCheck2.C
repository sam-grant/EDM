...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.56822);
   Graph_Graph01029->SetMaximum(50.67603);
   ...
   mainFit1030->SetChisquare(2.131114);
   ...
   mainFit1030->SetParameter(0,-0.2320146);
   mainFit1030->SetParError(0,0.5622081);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7979181);
   mainFit1030->SetParError(1,0.0171776);
   ...
   pt_LaTex = pt->AddText("0.798#pm0.0172");
   pt_LaTex = pt->AddText("#minus0.232#pm0.562");
   pt_LaTex = pt->AddText("#minus0.291#pm0.704");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.290775,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.290775,-51.56822,0.290775,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.131114);
   ...
   mainFit1031->SetParameter(0,-0.2320146);
   mainFit1031->SetParError(0,0.5622081);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7979181);
   mainFit1031->SetParError(1,0.0171776);
