...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.56822);
   Graph_Graph01031->SetMaximum(50.67603);
   ...
   mainFit1032->SetChisquare(2.535293);
   ...
   mainFit1032->SetParameter(0,-0.1416234);
   mainFit1032->SetParError(0,0.5956188);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7996654);
   mainFit1032->SetParError(1,0.01772158);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.845");
   pt_LaTex = pt->AddText("  0.8#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.142#pm0.596");
   pt_LaTex = pt->AddText("#minus0.177#pm0.744");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1771033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1771033,-51.56822,0.1771033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.535293);
   ...
   mainFit1033->SetParameter(0,-0.1416234);
   mainFit1033->SetParError(0,0.5956188);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7996654);
   mainFit1033->SetParError(1,0.01772158);
