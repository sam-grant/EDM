...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.56822);
   Graph_Graph01023->SetMaximum(50.67603);
   ...
   mainFit1024->SetChisquare(2.571133);
   ...
   mainFit1024->SetParameter(0,-0.08566786);
   mainFit1024->SetParError(0,0.517106);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7988029);
   mainFit1024->SetParError(1,0.01712599);
   ...
   mainFit1025->SetChisquare(2.571133);
   ...
   mainFit1025->SetParameter(0,-0.08566786);
   mainFit1025->SetParError(0,0.517106);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7988029);
   mainFit1025->SetParError(1,0.01712599);
