...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-64.34875,75,63.45656);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-51.56822);
   Graph_Graph01020->SetMaximum(50.67603);
   ...
   mainFit1021->SetChisquare(2.571133);
   ...
   mainFit1021->SetParameter(0,-0.08566786);
   mainFit1021->SetParError(0,0.517106);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7988029);
   mainFit1021->SetParError(1,0.01712599);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.643");
   pt_LaTex = pt->AddText("0.799#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.0857#pm0.517");
   pt_LaTex = pt->AddText("#minus0.107#pm0.647");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1072453,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1072453,-51.56822,0.1072453,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.571133);
   ...
   mainFit1022->SetParameter(0,-0.08566786);
   mainFit1022->SetParError(0,0.517106);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7988029);
   mainFit1022->SetParError(1,0.01712599);
