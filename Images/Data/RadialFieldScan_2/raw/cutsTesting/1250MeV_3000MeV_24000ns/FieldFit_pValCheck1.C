...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.56822);
   Graph_Graph01027->SetMaximum(50.67603);
   ...
   mainFit1028->SetChisquare(0.08869066);
   ...
   mainFit1028->SetParameter(0,0.326921);
   mainFit1028->SetParError(0,0.579631);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8123464);
   mainFit1028->SetParError(1,0.0191622);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0296");
   pt_LaTex = pt->AddText("0.812#pm0.0192");
   pt_LaTex = pt->AddText("0.327#pm 0.58");
   pt_LaTex = pt->AddText("0.402#pm0.713");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4024404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4024404,-51.56822,-0.4024404,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.08869066);
   ...
   mainFit1029->SetParameter(0,0.326921);
   mainFit1029->SetParError(0,0.579631);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8123464);
   mainFit1029->SetParError(1,0.0191622);
