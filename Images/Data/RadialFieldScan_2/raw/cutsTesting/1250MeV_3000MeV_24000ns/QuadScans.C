...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.797);
   ...
   quadLineFit1002->SetParameter(0,74.75472);
   quadLineFit1002->SetParError(0,0.07933862);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.82478);
   quadLineFit1002->SetParError(1,1.330893);
   ...
   quadLineFit1003->SetChisquare(2.797);
   ...
   quadLineFit1003->SetParameter(0,74.75472);
   quadLineFit1003->SetParError(0,0.07933862);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.82478);
   quadLineFit1003->SetParError(1,1.330893);
   ...
   Graph_30_ppm1003->SetMinimum(75.86807);
   Graph_30_ppm1003->SetMaximum(76.43052);
   ...
   quadLineFit1004->SetChisquare(6.105623);
   ...
   quadLineFit1004->SetParameter(0,74.76539);
   quadLineFit1004->SetParError(0,0.06628233);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.52318);
   quadLineFit1004->SetParError(1,1.089462);
   ...
   quadLineFit1005->SetChisquare(6.105623);
   ...
   quadLineFit1005->SetParameter(0,74.76539);
   quadLineFit1005->SetParError(0,0.06628233);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.52318);
   quadLineFit1005->SetParError(1,1.089462);
   ...
   Graph_10_ppm1005->SetMinimum(74.94472);
   Graph_10_ppm1005->SetMaximum(75.19951);
   ...
   quadLineFit1006->SetChisquare(0.106205);
   ...
   quadLineFit1006->SetParameter(0,74.53637);
   quadLineFit1006->SetParError(0,0.07768015);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.664052);
   quadLineFit1006->SetParError(1,1.259821);
   ...
   quadLineFit1007->SetChisquare(0.106205);
   ...
   quadLineFit1007->SetParameter(0,74.53637);
   quadLineFit1007->SetParError(0,0.07768015);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.664052);
   quadLineFit1007->SetParError(1,1.259821);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.86768);
   Graph_mI10_ppm1007->SetMaximum(74.13382);
   ...
   quadLineFit1008->SetChisquare(7.385059);
   ...
   quadLineFit1008->SetParameter(0,74.46951);
   quadLineFit1008->SetParError(0,0.06817965);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.89343);
   quadLineFit1008->SetParError(1,1.109753);
   ...
   quadLineFit1009->SetChisquare(7.385059);
   ...
   quadLineFit1009->SetParameter(0,74.46951);
   quadLineFit1009->SetParError(0,0.06817965);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.89343);
   quadLineFit1009->SetParError(1,1.109753);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.59594);
   Graph_mI30_ppm1009->SetMaximum(73.21336);
   ...
   quadLineFit1010->SetChisquare(0.1517276);
   ...
   quadLineFit1010->SetParameter(0,74.3793);
   quadLineFit1010->SetParError(0,0.06449171);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.93049);
   quadLineFit1010->SetParError(1,1.11615);
   ...
   quadLineFit1011->SetChisquare(0.1517276);
   ...
   quadLineFit1011->SetParameter(0,74.3793);
   quadLineFit1011->SetParError(0,0.06449171);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.93049);
   quadLineFit1011->SetParError(1,1.11615);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.70856);
   Graph_mI50_ppm1011->SetMaximum(72.29969);
   ...
   quadLineFit1012->SetChisquare(1.314853);
   ...
   quadLineFit1012->SetParameter(0,74.3317);
   quadLineFit1012->SetParError(0,0.1301214);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.7197);
   quadLineFit1012->SetParError(1,2.328168);
   ...
   quadLineFit1013->SetChisquare(1.314853);
   ...
   quadLineFit1013->SetParameter(0,74.3317);
   quadLineFit1013->SetParError(0,0.1301214);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.7197);
   quadLineFit1013->SetParError(1,2.328168);
