...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02775845);
   Graph_Graph11015->SetMaximum(0.0481937);
   ...
   Graph_Graph21016->SetMinimum(-0.003683336);
   Graph_Graph21016->SetMaximum(0.00433791);
   ...
   Graph_Graph31017->SetMinimum(-0.04159224);
   Graph_Graph31017->SetMaximum(0.03440703);
   ...
   Graph_Graph41018->SetMinimum(-0.003301815);
   Graph_Graph41018->SetMaximum(0.005341335);
   ...
   Graph_Graph51019->SetMinimum(-0.01211194);
   Graph_Graph51019->SetMaximum(0.01617708);
