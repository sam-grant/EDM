...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.56822);
   Graph_Graph01033->SetMaximum(50.67603);
   ...
   mainFit1034->SetChisquare(2.548559);
   ...
   mainFit1034->SetParameter(0,-0.144258);
   mainFit1034->SetParError(0,0.6476651);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8007343);
   mainFit1034->SetParError(1,0.02141367);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.85");
   pt_LaTex = pt->AddText("0.801#pm0.0214");
   pt_LaTex = pt->AddText("#minus0.144#pm0.648");
   pt_LaTex = pt->AddText("#minus0.18#pm0.807");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1801571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1801571,-51.56822,0.1801571,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.548559);
   ...
   mainFit1035->SetParameter(0,-0.144258);
   mainFit1035->SetParError(0,0.6476651);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8007343);
   mainFit1035->SetParError(1,0.02141367);
