...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.84722,70,58.95626);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.76687);
   Graph_Graph01035->SetMaximum(48.87591);
   ...
   mainFit1036->SetChisquare(2.458616);
   ...
   mainFit1036->SetParameter(0,-0.03091605);
   mainFit1036->SetParError(0,0.542256);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7961971);
   mainFit1036->SetParError(1,0.01880556);
   ...
   pt_LaTex = pt->AddText("0.796#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.0309#pm0.542");
   pt_LaTex = pt->AddText("#minus0.0388#pm0.681");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.03882964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.03882964,-31.76687,0.03882964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.458616);
   ...
   mainFit1037->SetParameter(0,-0.03091605);
   mainFit1037->SetParError(0,0.542256);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7961971);
   mainFit1037->SetParError(1,0.01880556);
