...
//=========  (Fri Apr 23 18:53:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-49.71392);
   Graph_Graph01025->SetMaximum(30.27869);
   ...
   mainFit1026->SetChisquare(1.537818);
   ...
   mainFit1026->SetParameter(0,-0.2956342);
   mainFit1026->SetParError(0,0.5568249);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.784676);
   mainFit1026->SetParError(1,0.02205154);
   ...
   pt_LaTex = pt->AddText("0.785#pm0.0221");
   pt_LaTex = pt->AddText("#minus0.296#pm0.557");
   pt_LaTex = pt->AddText("#minus0.377#pm0.711");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3767596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3767596,-49.71392,0.3767596,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.537818);
   ...
   mainFit1027->SetParameter(0,-0.2956342);
   mainFit1027->SetParError(0,0.5568249);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.784676);
   mainFit1027->SetParError(1,0.02205154);
