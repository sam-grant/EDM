...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.38751,70,60.75753);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.47301);
   Graph_Graph01035->SetMaximum(49.84303);
   ...
   mainFit1036->SetChisquare(3.303465);
   ...
   mainFit1036->SetParameter(0,-1.572004);
   mainFit1036->SetParError(0,0.753406);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8623289);
   mainFit1036->SetParError(1,0.02616314);
   ...
   pt_LaTex = pt->AddText("0.862#pm0.0262");
   pt_LaTex = pt->AddText("#minus1.57#pm0.753");
   pt_LaTex = pt->AddText("#minus1.82#pm0.861");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.822975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.822975,-37.47301,1.822975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.303465);
   ...
   mainFit1037->SetParameter(0,-1.572004);
   mainFit1037->SetParError(0,0.753406);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8623289);
   mainFit1037->SetParError(1,0.02616314);
