...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.31415);
   Graph_Graph01023->SetMaximum(51.19222);
   ...
   mainFit1024->SetChisquare(4.656165);
   ...
   mainFit1024->SetParameter(0,-1.308934);
   mainFit1024->SetParError(0,0.7186598);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8497588);
   mainFit1024->SetParError(1,0.02382986);
   ...
   mainFit1025->SetChisquare(4.656165);
   ...
   mainFit1025->SetParameter(0,-1.308934);
   mainFit1025->SetParError(0,0.7186598);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8497588);
   mainFit1025->SetParError(1,0.02382986);
