...
//=========  (Fri Apr 23 21:07:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2628973);
   ...
   quadLineFit1002->SetParameter(0,75.25045);
   quadLineFit1002->SetParError(0,0.1109025);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.70745);
   quadLineFit1002->SetParError(1,1.859239);
   ...
   quadLineFit1003->SetChisquare(0.2628973);
   ...
   quadLineFit1003->SetParameter(0,75.25045);
   quadLineFit1003->SetParError(0,0.1109025);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.70745);
   quadLineFit1003->SetParError(1,1.859239);
   ...
   Graph_30_ppm1003->SetMinimum(76.35245);
   Graph_30_ppm1003->SetMaximum(76.96118);
   ...
   quadLineFit1004->SetChisquare(5.2768);
   ...
   quadLineFit1004->SetParameter(0,75.18603);
   quadLineFit1004->SetParError(0,0.09198913);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.5938);
   quadLineFit1004->SetParError(1,1.510937);
   ...
   quadLineFit1005->SetChisquare(5.2768);
   ...
   quadLineFit1005->SetParameter(0,75.18603);
   quadLineFit1005->SetParError(0,0.09198913);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.5938);
   quadLineFit1005->SetParError(1,1.510937);
   ...
   Graph_10_ppm1005->SetMinimum(75.40381);
   Graph_10_ppm1005->SetMaximum(75.70575);
   ...
   quadLineFit1006->SetChisquare(1.421854);
   ...
   quadLineFit1006->SetParameter(0,74.94714);
   quadLineFit1006->SetParError(0,0.1081262);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.633237);
   quadLineFit1006->SetParError(1,1.752325);
   ...
   quadLineFit1007->SetChisquare(1.421854);
   ...
   quadLineFit1007->SetParameter(0,74.94714);
   quadLineFit1007->SetParError(0,0.1081262);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.633237);
   quadLineFit1007->SetParError(1,1.752325);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.35585);
   Graph_mI10_ppm1007->SetMaximum(74.65805);
   ...
   quadLineFit1008->SetChisquare(0.3549421);
   ...
   quadLineFit1008->SetParameter(0,75.09305);
   quadLineFit1008->SetParError(0,0.0948542);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.690563);
   quadLineFit1008->SetParError(1,1.542917);
   ...
   quadLineFit1009->SetChisquare(0.3549421);
   ...
   quadLineFit1009->SetParameter(0,75.09305);
   quadLineFit1009->SetParError(0,0.0948542);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.690563);
   quadLineFit1009->SetParError(1,1.542917);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.0458);
   Graph_mI30_ppm1009->SetMaximum(73.77473);
   ...
   quadLineFit1010->SetChisquare(2.345225);
   ...
   quadLineFit1010->SetParameter(0,75.1618);
   quadLineFit1010->SetParError(0,0.08958437);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.64748);
   quadLineFit1010->SetParError(1,1.54919);
   ...
   quadLineFit1011->SetChisquare(2.345225);
   ...
   quadLineFit1011->SetParameter(0,75.1618);
   quadLineFit1011->SetParError(0,0.08958437);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.64748);
   quadLineFit1011->SetParError(1,1.54919);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.21072);
   Graph_mI50_ppm1011->SetMaximum(72.81586);
   ...
   quadLineFit1012->SetChisquare(0.2977063);
   ...
   quadLineFit1012->SetParameter(0,74.82304);
   quadLineFit1012->SetParError(0,0.1810339);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.45041);
   quadLineFit1012->SetParError(1,3.238207);
   ...
   quadLineFit1013->SetChisquare(0.2977063);
   ...
   quadLineFit1013->SetParameter(0,74.82304);
   quadLineFit1013->SetParError(0,0.1810339);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.45041);
   quadLineFit1013->SetParError(1,3.238207);
