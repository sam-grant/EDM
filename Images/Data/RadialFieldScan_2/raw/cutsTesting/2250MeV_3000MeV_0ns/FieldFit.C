...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.31415);
   Graph_Graph01020->SetMaximum(51.19222);
   ...
   mainFit1021->SetChisquare(4.656165);
   ...
   mainFit1021->SetParameter(0,-1.308934);
   mainFit1021->SetParError(0,0.7186598);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8497588);
   mainFit1021->SetParError(1,0.02382986);
   ...
   pt_LaTex = pt->AddText(" 0.85#pm0.0238");
   pt_LaTex = pt->AddText("#minus1.31#pm0.719");
   pt_LaTex = pt->AddText("#minus1.54#pm 0.84");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.54036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.54036,-52.31415,1.54036,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.656165);
   ...
   mainFit1022->SetParameter(0,-1.308934);
   mainFit1022->SetParError(0,0.7186598);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8497588);
   mainFit1022->SetParError(1,0.02382986);
