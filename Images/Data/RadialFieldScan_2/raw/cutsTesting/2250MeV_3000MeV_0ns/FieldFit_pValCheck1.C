...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.31415);
   Graph_Graph01027->SetMaximum(51.19222);
   ...
   mainFit1028->SetChisquare(4.410225);
   ...
   mainFit1028->SetParameter(0,-1.127361);
   mainFit1028->SetParError(0,0.8065839);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8557452);
   mainFit1028->SetParError(1,0.02670585);
   ...
   pt_LaTex = pt->AddText("0.856#pm0.0267");
   pt_LaTex = pt->AddText("#minus1.13#pm0.807");
   pt_LaTex = pt->AddText("#minus1.32#pm0.947");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.317403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.317403,-52.31415,1.317403,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.410225);
   ...
   mainFit1029->SetParameter(0,-1.127361);
   mainFit1029->SetParError(0,0.8065839);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8557452);
   mainFit1029->SetParError(1,0.02670585);
