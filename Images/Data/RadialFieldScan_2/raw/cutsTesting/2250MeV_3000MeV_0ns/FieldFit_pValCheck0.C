...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.88696,50,42.30308);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.56796);
   Graph_Graph01025->SetMaximum(31.98408);
   ...
   mainFit1026->SetChisquare(4.531684);
   ...
   mainFit1026->SetParameter(0,-1.208261);
   mainFit1026->SetParError(0,0.7733531);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8565309);
   mainFit1026->SetParError(1,0.03061309);
   ...
   pt_LaTex = pt->AddText("0.857#pm0.0306");
   pt_LaTex = pt->AddText("#minus1.21#pm0.773");
   pt_LaTex = pt->AddText("#minus1.41#pm 0.91");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.410645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.410645,-50.56796,1.410645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.531684);
   ...
   mainFit1027->SetParameter(0,-1.208261);
   mainFit1027->SetParError(0,0.7733531);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8565309);
   mainFit1027->SetParError(1,0.03061309);
