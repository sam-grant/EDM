...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.05734453);
   Graph_Graph11015->SetMaximum(0.04080222);
   ...
   Graph_Graph21016->SetMinimum(-0.01870171);
   Graph_Graph21016->SetMaximum(0.02191586);
   ...
   Graph_Graph31017->SetMinimum(-0.01203362);
   Graph_Graph31017->SetMaximum(0.01251177);
   ...
   Graph_Graph41018->SetMinimum(-0.0435925);
   Graph_Graph41018->SetMaximum(0.02463901);
   ...
   Graph_Graph51019->SetMinimum(-0.008049687);
   Graph_Graph51019->SetMaximum(0.01073084);
