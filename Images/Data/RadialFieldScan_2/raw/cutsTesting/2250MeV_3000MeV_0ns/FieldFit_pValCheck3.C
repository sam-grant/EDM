...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.31415);
   Graph_Graph01031->SetMaximum(51.19222);
   ...
   mainFit1032->SetChisquare(4.648481);
   ...
   mainFit1032->SetParameter(0,-1.344933);
   mainFit1032->SetParError(0,0.8275406);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8503212);
   mainFit1032->SetParError(1,0.02465302);
   ...
   pt_LaTex = pt->AddText(" 0.85#pm0.0247");
   pt_LaTex = pt->AddText("#minus1.34#pm0.828");
   pt_LaTex = pt->AddText("#minus1.58#pm0.962");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.581676,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.581676,-52.31415,1.581676,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.648481);
   ...
   mainFit1033->SetParameter(0,-1.344933);
   mainFit1033->SetParError(0,0.8275406);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8503212);
   mainFit1033->SetParError(1,0.02465302);
