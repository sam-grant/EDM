...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.31415);
   Graph_Graph01029->SetMaximum(51.19222);
   ...
   mainFit1030->SetChisquare(2.313778);
   ...
   mainFit1030->SetParameter(0,-1.77811);
   mainFit1030->SetParError(0,0.7813029);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8469008);
   mainFit1030->SetParError(1,0.02390336);
   ...
   pt_LaTex = pt->AddText("0.847#pm0.0239");
   pt_LaTex = pt->AddText("#minus1.78#pm0.781");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.918");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.09955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.09955,-52.31415,2.09955,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.313778);
   ...
   mainFit1031->SetParameter(0,-1.77811);
   mainFit1031->SetParError(0,0.7813029);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8469008);
   mainFit1031->SetParError(1,0.02390336);
