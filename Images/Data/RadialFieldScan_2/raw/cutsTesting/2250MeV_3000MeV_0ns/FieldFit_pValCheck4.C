...
//=========  (Fri Apr 23 21:07:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-65.25245,75,64.13052);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-52.31415);
   Graph_Graph01033->SetMaximum(51.19222);
   ...
   mainFit1034->SetChisquare(1.844265);
   ...
   mainFit1034->SetParameter(0,-0.3992149);
   mainFit1034->SetParError(0,0.9004496);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8197165);
   mainFit1034->SetParError(1,0.02981644);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.615");
   pt_LaTex = pt->AddText(" 0.82#pm0.0298");
   pt_LaTex = pt->AddText("#minus0.399#pm  0.9");
   pt_LaTex = pt->AddText("#minus0.487#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4870158,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4870158,-52.31415,0.4870158,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.844265);
   ...
   mainFit1035->SetParameter(0,-0.3992149);
   mainFit1035->SetParError(0,0.9004496);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8197165);
   mainFit1035->SetParError(1,0.02981644);
