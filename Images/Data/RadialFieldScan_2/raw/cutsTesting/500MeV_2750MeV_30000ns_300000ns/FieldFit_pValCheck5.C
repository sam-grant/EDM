...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.66171,70,66.40292);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.25525);
   Graph_Graph01035->SetMaximum(54.99646);
   ...
   mainFit1036->SetChisquare(8.83483);
   ...
   mainFit1036->SetParameter(0,-0.9416187);
   mainFit1036->SetParError(0,0.4895185);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9041685);
   mainFit1036->SetParError(1,0.01702743);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.94");
   pt_LaTex = pt->AddText("0.904#pm0.017");
   pt_LaTex = pt->AddText("#minus0.942#pm 0.49");
   pt_LaTex = pt->AddText("#minus1.04#pm0.537");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.041419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.041419,-36.25525,1.041419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(8.83483);
   ...
   mainFit1037->SetParameter(0,-0.9416187);
   mainFit1037->SetParError(0,0.4895185);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9041685);
   mainFit1037->SetParError(1,0.01702743);
