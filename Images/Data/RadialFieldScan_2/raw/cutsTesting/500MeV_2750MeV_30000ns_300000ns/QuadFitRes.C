...
//=========  (Mon Apr 26 22:51:15 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01565917);
   Graph_Graph11015->SetMaximum(0.01507443);
   ...
   Graph_Graph21016->SetMinimum(-0.01424676);
   Graph_Graph21016->SetMaximum(0.01678584);
   ...
   Graph_Graph31017->SetMinimum(-0.04063945);
   Graph_Graph31017->SetMaximum(0.03108749);
   ...
   Graph_Graph41018->SetMinimum(-0.01161927);
   Graph_Graph41018->SetMaximum(0.01879088);
   ...
   Graph_Graph51019->SetMinimum(-0.005751374);
   Graph_Graph51019->SetMaximum(0.007687848);
