...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.91798);
   Graph_Graph01033->SetMaximum(56.9658);
   ...
   mainFit1034->SetChisquare(8.463801);
   ...
   mainFit1034->SetParameter(0,-1.161995);
   mainFit1034->SetParError(0,0.584459);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9115501);
   mainFit1034->SetParError(1,0.01938394);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.82");
   pt_LaTex = pt->AddText("0.912#pm0.0194");
   pt_LaTex = pt->AddText("#minus1.16#pm0.584");
   pt_LaTex = pt->AddText("#minus1.27#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.274746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.274746,-57.91798,1.274746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.463801);
   ...
   mainFit1035->SetParameter(0,-1.161995);
   mainFit1035->SetParError(0,0.584459);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9115501);
   mainFit1035->SetParError(1,0.01938394);
