...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.27846,75,71.32627);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.91798);
   Graph_Graph01027->SetMaximum(56.9658);
   ...
   mainFit1028->SetChisquare(1.11774);
   ...
   mainFit1028->SetParameter(0,-0.2857097);
   mainFit1028->SetParError(0,0.5241927);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9262977);
   mainFit1028->SetParError(1,0.01738401);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0174");
   pt_LaTex = pt->AddText("#minus0.286#pm0.524");
   pt_LaTex = pt->AddText("#minus0.308#pm0.566");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3084426,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3084426,-57.91798,0.3084426,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.11774);
   ...
   mainFit1029->SetParameter(0,-0.2857097);
   mainFit1029->SetParError(0,0.5241927);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9262977);
   mainFit1029->SetParError(1,0.01738401);
