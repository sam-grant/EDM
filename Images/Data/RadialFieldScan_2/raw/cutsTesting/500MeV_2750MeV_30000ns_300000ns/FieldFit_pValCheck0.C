...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.68494,50,43.35868);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.68058);
   Graph_Graph01025->SetMaximum(32.35432);
   ...
   mainFit1026->SetChisquare(4.082324);
   ...
   mainFit1026->SetParameter(0,-1.351742);
   mainFit1026->SetParError(0,0.5024236);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8772521);
   mainFit1026->SetParError(1,0.01989772);
   ...
   pt_LaTex = pt->AddText("0.877#pm0.0199");
   pt_LaTex = pt->AddText("#minus1.35#pm0.502");
   pt_LaTex = pt->AddText("#minus1.54#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.540883,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.540883,-55.68058,1.540883,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.082324);
   ...
   mainFit1027->SetParameter(0,-1.351742);
   mainFit1027->SetParError(0,0.5024236);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8772521);
   mainFit1027->SetParError(1,0.01989772);
