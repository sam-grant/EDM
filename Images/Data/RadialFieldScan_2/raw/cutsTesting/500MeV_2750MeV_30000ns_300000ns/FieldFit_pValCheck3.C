...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.91798);
   Graph_Graph01031->SetMaximum(56.9658);
   ...
   mainFit1032->SetChisquare(8.566127);
   ...
   mainFit1032->SetParameter(0,-0.8087462);
   mainFit1032->SetParError(0,0.5377919);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9023153);
   mainFit1032->SetParError(1,0.01603655);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.86");
   pt_LaTex = pt->AddText("0.902#pm0.016");
   pt_LaTex = pt->AddText("#minus0.809#pm0.538");
   pt_LaTex = pt->AddText("#minus0.896#pm0.592");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8963012,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8963012,-57.91798,0.8963012,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(8.566127);
   ...
   mainFit1033->SetParameter(0,-0.8087462);
   mainFit1033->SetParError(0,0.5377919);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9023153);
   mainFit1033->SetParError(1,0.01603655);
