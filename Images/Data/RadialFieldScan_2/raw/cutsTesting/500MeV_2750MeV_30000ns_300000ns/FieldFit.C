...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.91798);
   Graph_Graph01020->SetMaximum(56.9658);
   ...
   mainFit1021->SetChisquare(8.836401);
   ...
   mainFit1021->SetParameter(0,-0.9474416);
   mainFit1021->SetParError(0,0.4669545);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9044476);
   mainFit1021->SetParError(1,0.01550317);
   ...
   mainFit1022->SetChisquare(8.836401);
   ...
   mainFit1022->SetParameter(0,-0.9474416);
   mainFit1022->SetParError(0,0.4669545);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9044476);
   mainFit1022->SetParError(1,0.01550317);
