...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.91798);
   Graph_Graph01029->SetMaximum(56.9658);
   ...
   mainFit1030->SetChisquare(7.39946);
   ...
   mainFit1030->SetParameter(0,-1.186954);
   mainFit1030->SetParError(0,0.5079066);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9029622);
   mainFit1030->SetParError(1,0.01555258);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.47");
   pt_LaTex = pt->AddText("0.903#pm0.0156");
   pt_LaTex = pt->AddText("#minus1.19#pm0.508");
   pt_LaTex = pt->AddText("#minus1.31#pm 0.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.314511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.314511,-57.91798,1.314511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.39946);
   ...
   mainFit1031->SetParameter(0,-1.186954);
   mainFit1031->SetParError(0,0.5079066);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9029622);
   mainFit1031->SetParError(1,0.01555258);
