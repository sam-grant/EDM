...
//=========  (Mon Apr 26 22:51:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.91798);
   Graph_Graph01023->SetMaximum(56.9658);
   ...
   mainFit1024->SetChisquare(8.836401);
   ...
   mainFit1024->SetParameter(0,-0.9474416);
   mainFit1024->SetParError(0,0.4669545);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9044476);
   mainFit1024->SetParError(1,0.01550317);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.21");
   pt_LaTex = pt->AddText("0.904#pm0.0155");
   pt_LaTex = pt->AddText("#minus0.947#pm0.467");
   pt_LaTex = pt->AddText("#minus1.05#pm0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.047536,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.047536,-57.91798,1.047536,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(8.836401);
   ...
   mainFit1025->SetParameter(0,-0.9474416);
   mainFit1025->SetParError(0,0.4669545);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9044476);
   mainFit1025->SetParError(1,0.01550317);
