...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-85.6118,75,77.56697);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-69.29392);
   Graph_Graph01033->SetMaximum(61.24909);
   ...
   mainFit1034->SetChisquare(0.926281);
   ...
   mainFit1034->SetParameter(0,-4.078027);
   mainFit1034->SetParError(0,0.8018096);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.054704);
   mainFit1034->SetParError(1,0.02642952);
   ...
   pt_LaTex = pt->AddText(" 1.05#pm0.0264");
   pt_LaTex = pt->AddText("#minus4.08#pm0.802");
   pt_LaTex = pt->AddText("#minus3.87#pm 0.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.866513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.866513,-69.29392,3.866513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.926281);
   ...
   mainFit1035->SetParameter(0,-4.078027);
   mainFit1035->SetParError(0,0.8018096);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.054704);
   mainFit1035->SetParError(1,0.02642952);
