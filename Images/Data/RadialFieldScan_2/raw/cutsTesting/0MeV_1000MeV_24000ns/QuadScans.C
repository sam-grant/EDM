...
//=========  (Wed Apr 21 19:50:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.313774);
   ...
   quadLineFit1002->SetParameter(0,74.20812);
   quadLineFit1002->SetParError(0,0.0974593);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,48.73645);
   quadLineFit1002->SetParError(1,1.634062);
   ...
   quadLineFit1003->SetChisquare(3.313774);
   ...
   quadLineFit1003->SetParameter(0,74.20812);
   quadLineFit1003->SetParError(0,0.0974593);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,48.73645);
   quadLineFit1003->SetParError(1,1.634062);
   ...
   Graph_30_ppm1003->SetMinimum(75.56142);
   Graph_30_ppm1003->SetMaximum(76.27836);
   ...
   quadLineFit1004->SetChisquare(1.022311);
   ...
   quadLineFit1004->SetParameter(0,74.23243);
   quadLineFit1004->SetParError(0,0.08223565);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,27.44128);
   quadLineFit1004->SetParError(1,1.350598);
   ...
   quadLineFit1005->SetChisquare(1.022311);
   ...
   quadLineFit1005->SetParameter(0,74.23243);
   quadLineFit1005->SetParError(0,0.08223565);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,27.44128);
   quadLineFit1005->SetParError(1,1.350598);
   ...
   Graph_10_ppm1005->SetMinimum(74.49188);
   Graph_10_ppm1005->SetMaximum(74.72402);
   ...
   quadLineFit1006->SetChisquare(0.02578087);
   ...
   quadLineFit1006->SetParameter(0,74.15517);
   quadLineFit1006->SetParError(0,0.09629204);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.327652);
   quadLineFit1006->SetParError(1,1.560555);
   ...
   quadLineFit1007->SetChisquare(0.02578087);
   ...
   quadLineFit1007->SetParameter(0,74.15517);
   quadLineFit1007->SetParError(0,0.09629204);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.327652);
   quadLineFit1007->SetParError(1,1.560555);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.07292);
   Graph_mI10_ppm1007->SetMaximum(73.50465);
   ...
   quadLineFit1008->SetChisquare(0.3725455);
   ...
   quadLineFit1008->SetParameter(0,74.24049);
   quadLineFit1008->SetParError(0,0.08449763);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-15.51211);
   quadLineFit1008->SetParError(1,1.374489);
   ...
   quadLineFit1009->SetChisquare(0.3725455);
   ...
   quadLineFit1009->SetParameter(0,74.24049);
   quadLineFit1009->SetParError(0,0.08449763);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-15.51211);
   quadLineFit1009->SetParError(1,1.374489);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.62284);
   Graph_mI30_ppm1009->SetMaximum(72.47645);
   ...
   quadLineFit1010->SetChisquare(1.83514);
   ...
   quadLineFit1010->SetParameter(0,74.12405);
   quadLineFit1010->SetParError(0,0.07955852);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.88607);
   quadLineFit1010->SetParError(1,1.376327);
   ...
   quadLineFit1011->SetChisquare(1.83514);
   ...
   quadLineFit1011->SetParameter(0,74.12405);
   quadLineFit1011->SetParError(0,0.07955852);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.88607);
   quadLineFit1011->SetParError(1,1.376327);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.64419);
   Graph_mI50_ppm1011->SetMaximum(71.4466);
   ...
   quadLineFit1012->SetChisquare(0.02372123);
   ...
   quadLineFit1012->SetParameter(0,74.20556);
   quadLineFit1012->SetParError(0,0.1608612);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-55.53716);
   quadLineFit1012->SetParError(1,2.878179);
   ...
   quadLineFit1013->SetChisquare(0.02372123);
   ...
   quadLineFit1013->SetParameter(0,74.20556);
   quadLineFit1013->SetParError(0,0.1608612);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-55.53716);
   quadLineFit1013->SetParError(1,2.878179);
