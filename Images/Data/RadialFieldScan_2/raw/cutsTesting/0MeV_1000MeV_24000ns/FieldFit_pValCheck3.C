...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-69.29392);
   Graph_Graph01031->SetMaximum(61.24909);
   ...
   mainFit1032->SetChisquare(0.2160065);
   ...
   mainFit1032->SetParameter(0,-3.158582);
   mainFit1032->SetParError(0,0.7357747);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.032579);
   mainFit1032->SetParError(1,0.0218489);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.072");
   pt_LaTex = pt->AddText(" 1.03#pm0.0218");
   pt_LaTex = pt->AddText("#minus3.16#pm0.736");
   pt_LaTex = pt->AddText("#minus3.06#pm0.698");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.058926,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.058926,-69.29392,3.058926,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.2160065);
   ...
   mainFit1033->SetParameter(0,-3.158582);
   mainFit1033->SetParError(0,0.7357747);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.032579);
   mainFit1033->SetParError(1,0.0218489);
