...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-56.67063,70,71.77874);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-43.82569);
   Graph_Graph01035->SetMaximum(58.9338);
   ...
   mainFit1036->SetChisquare(1.820106);
   ...
   mainFit1036->SetParameter(0,-3.62547);
   mainFit1036->SetParError(0,0.6702814);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.039924);
   mainFit1036->SetParError(1,0.02318067);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0232");
   pt_LaTex = pt->AddText("#minus3.63#pm 0.67");
   pt_LaTex = pt->AddText("#minus3.49#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.486283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.486283,-43.82569,3.486283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.820106);
   ...
   mainFit1037->SetParameter(0,-3.62547);
   mainFit1037->SetParError(0,0.6702814);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.039924);
   mainFit1037->SetParError(1,0.02318067);
