...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-80.21714,50,50.59369);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-67.13606);
   Graph_Graph01025->SetMaximum(37.51261);
   ...
   mainFit1026->SetChisquare(1.718661);
   ...
   mainFit1026->SetParameter(0,-3.702643);
   mainFit1026->SetParError(0,0.6892925);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.034157);
   mainFit1026->SetParError(1,0.02727907);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0273");
   pt_LaTex = pt->AddText(" #minus3.7#pm0.689");
   pt_LaTex = pt->AddText("#minus3.58#pm0.685");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.580349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.580349,-67.13606,3.580349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.718661);
   ...
   mainFit1027->SetParameter(0,-3.702643);
   mainFit1027->SetParError(0,0.6892925);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.034157);
   mainFit1027->SetParError(1,0.02727907);
