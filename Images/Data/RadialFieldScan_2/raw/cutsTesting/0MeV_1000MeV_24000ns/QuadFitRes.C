...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02924691);
   Graph_Graph11015->SetMaximum(0.009670809);
   ...
   Graph_Graph21016->SetMinimum(-0.002251883);
   Graph_Graph21016->SetMaximum(0.002624524);
   ...
   Graph_Graph31017->SetMinimum(-0.007605382);
   Graph_Graph31017->SetMaximum(0.01209692);
   ...
   Graph_Graph41018->SetMinimum(-0.03424692);
   Graph_Graph41018->SetMaximum(0.01971665);
   ...
   Graph_Graph51019->SetMinimum(-0.002682289);
   Graph_Graph51019->SetMaximum(0.002011136);
