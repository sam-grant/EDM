...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-69.29392);
   Graph_Graph01029->SetMaximum(61.24909);
   ...
   mainFit1030->SetChisquare(1.670815);
   ...
   mainFit1030->SetParameter(0,-3.725536);
   mainFit1030->SetParError(0,0.6946628);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.039046);
   mainFit1030->SetParError(1,0.02118097);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.557");
   pt_LaTex = pt->AddText(" 1.04#pm0.0212");
   pt_LaTex = pt->AddText("#minus3.73#pm0.695");
   pt_LaTex = pt->AddText("#minus3.59#pm0.664");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.585533,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.585533,-69.29392,3.585533,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.670815);
   ...
   mainFit1031->SetParameter(0,-3.725536);
   mainFit1031->SetParError(0,0.6946628);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.039046);
   mainFit1031->SetParError(1,0.02118097);
