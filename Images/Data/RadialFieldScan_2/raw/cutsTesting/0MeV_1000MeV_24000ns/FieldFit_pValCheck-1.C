...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-69.29392);
   Graph_Graph01023->SetMaximum(61.24909);
   ...
   mainFit1024->SetChisquare(1.820787);
   ...
   mainFit1024->SetParameter(0,-3.620203);
   mainFit1024->SetParError(0,0.6392005);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.039674);
   mainFit1024->SetParError(1,0.02111873);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0211");
   pt_LaTex = pt->AddText("#minus3.62#pm0.639");
   pt_LaTex = pt->AddText("#minus3.48#pm0.608");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.482055,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.482055,-69.29392,3.482055,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.820787);
   ...
   mainFit1025->SetParameter(0,-3.620203);
   mainFit1025->SetParError(0,0.6392005);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.039674);
   mainFit1025->SetParError(1,0.02111873);
