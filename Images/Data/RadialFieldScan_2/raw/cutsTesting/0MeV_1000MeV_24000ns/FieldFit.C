...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-69.29392);
   Graph_Graph01020->SetMaximum(61.24909);
   ...
   mainFit1021->SetChisquare(1.820787);
   ...
   mainFit1021->SetParameter(0,-3.620203);
   mainFit1021->SetParError(0,0.6392005);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.039674);
   mainFit1021->SetParError(1,0.02111873);
   ...
   mainFit1022->SetChisquare(1.820787);
   ...
   mainFit1022->SetParameter(0,-3.620203);
   mainFit1022->SetParError(0,0.6392005);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.039674);
   mainFit1022->SetParError(1,0.02111873);
