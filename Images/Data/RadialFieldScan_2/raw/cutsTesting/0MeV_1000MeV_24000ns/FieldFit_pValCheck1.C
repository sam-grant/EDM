...
//=========  (Wed Apr 21 19:50:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-69.29392);
   Graph_Graph01027->SetMaximum(61.24909);
   ...
   mainFit1028->SetChisquare(1.806286);
   ...
   mainFit1028->SetParameter(0,-3.581481);
   mainFit1028->SetParError(0,0.715624);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.040935);
   mainFit1028->SetParError(1,0.02358594);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.602");
   pt_LaTex = pt->AddText(" 1.04#pm0.0236");
   pt_LaTex = pt->AddText("#minus3.58#pm0.716");
   pt_LaTex = pt->AddText("#minus3.44#pm0.698");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.440638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.440638,-69.29392,3.440638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.806286);
   ...
   mainFit1029->SetParameter(0,-3.581481);
   mainFit1029->SetParError(0,0.715624);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.040935);
   mainFit1029->SetParError(1,0.02358594);
