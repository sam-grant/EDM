...
//=========  (Wed Apr 21 21:31:02 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08951659);
   Graph_Graph11015->SetMaximum(0.03119365);
   ...
   Graph_Graph21016->SetMinimum(-0.06334157);
   Graph_Graph21016->SetMaximum(0.07444621);
   ...
   Graph_Graph31017->SetMinimum(-0.1067655);
   Graph_Graph31017->SetMaximum(0.08291584);
   ...
   Graph_Graph41018->SetMinimum(-0.08412701);
   Graph_Graph41018->SetMaximum(0.05546538);
   ...
   Graph_Graph51019->SetMinimum(-0.01732764);
   Graph_Graph51019->SetMaximum(0.02296111);
