...
//=========  (Wed Apr 21 21:31:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-71.28677);
   Graph_Graph01027->SetMaximum(59.07485);
   ...
   mainFit1028->SetChisquare(9.58333);
   ...
   mainFit1028->SetParameter(0,-2.414996);
   mainFit1028->SetParError(0,1.053671);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9601946);
   mainFit1028->SetParError(1,0.03478083);
   ...
   pt_LaTex = pt->AddText(" 0.96#pm0.0348");
   pt_LaTex = pt->AddText("#minus2.41#pm 1.05");
   pt_LaTex = pt->AddText("#minus2.52#pm 1.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.515111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.515111,-71.28677,2.515111,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(9.58333);
   ...
   mainFit1029->SetParameter(0,-2.414996);
   mainFit1029->SetParError(0,1.053671);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9601946);
   mainFit1029->SetParError(1,0.03478083);
