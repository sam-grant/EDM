...
//=========  (Wed Apr 21 21:31:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-71.28677);
   Graph_Graph01033->SetMaximum(59.07485);
   ...
   mainFit1034->SetChisquare(9.588032);
   ...
   mainFit1034->SetParameter(0,-2.419874);
   mainFit1034->SetParError(0,1.178472);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.957713);
   mainFit1034->SetParError(1,0.03890498);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  3.2");
   pt_LaTex = pt->AddText("0.958#pm0.0389");
   pt_LaTex = pt->AddText("#minus2.42#pm 1.18");
   pt_LaTex = pt->AddText("#minus2.53#pm 1.19");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.526722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.526722,-71.28677,2.526722,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.588032);
   ...
   mainFit1035->SetParameter(0,-2.419874);
   mainFit1035->SetParError(0,1.178472);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.957713);
   mainFit1035->SetParError(1,0.03890498);
