...
//=========  (Wed Apr 21 21:31:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-71.28677);
   Graph_Graph01031->SetMaximum(59.07485);
   ...
   mainFit1032->SetChisquare(3.21308);
   ...
   mainFit1032->SetParameter(0,-3.814499);
   mainFit1032->SetParError(0,1.083491);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9797976);
   mainFit1032->SetParError(1,0.03219051);
   ...
   pt_LaTex = pt->AddText(" 0.98#pm0.0322");
   pt_LaTex = pt->AddText("#minus3.81#pm 1.08");
   pt_LaTex = pt->AddText("#minus3.89#pm 1.08");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.89315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.89315,-71.28677,3.89315,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.21308);
   ...
   mainFit1033->SetParameter(0,-3.814499);
   mainFit1033->SetParError(0,1.083491);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9797976);
   mainFit1033->SetParError(1,0.03219051);
