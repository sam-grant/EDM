...
//=========  (Wed Apr 21 21:31:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-53.70423,70,68.59451);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.47436);
   Graph_Graph01035->SetMaximum(56.36463);
   ...
   mainFit1036->SetChisquare(7.2316);
   ...
   mainFit1036->SetParameter(0,-2.000009);
   mainFit1036->SetParError(0,0.9859678);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9372584);
   mainFit1036->SetParError(1,0.03414304);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.41");
   pt_LaTex = pt->AddText("0.937#pm0.0341");
   pt_LaTex = pt->AddText("   #minus2#pm0.986");
   pt_LaTex = pt->AddText("#minus2.13#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.133893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.133893,-41.47436,2.133893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.2316);
   ...
   mainFit1037->SetParameter(0,-2.000009);
   mainFit1037->SetParError(0,0.9859678);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9372584);
   mainFit1037->SetParError(1,0.03414304);
