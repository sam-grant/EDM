...
//=========  (Wed Apr 21 21:31:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-71.28677);
   Graph_Graph01029->SetMaximum(59.07485);
   ...
   mainFit1030->SetChisquare(5.971198);
   ...
   mainFit1030->SetParameter(0,-1.695757);
   mainFit1030->SetParError(0,1.021593);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9634348);
   mainFit1030->SetParError(1,0.03119847);
   ...
   pt_LaTex = pt->AddText("0.963#pm0.0312");
   pt_LaTex = pt->AddText(" #minus1.7#pm 1.02");
   pt_LaTex = pt->AddText("#minus1.76#pm 1.06");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.760116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.760116,-71.28677,1.760116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.971198);
   ...
   mainFit1031->SetParameter(0,-1.695757);
   mainFit1031->SetParError(0,1.021593);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9634348);
   mainFit1031->SetParError(1,0.03119847);
