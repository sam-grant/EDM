...
//=========  (Wed Apr 21 21:31:02 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-82.56936,50,50.30697);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-69.28173);
   Graph_Graph01025->SetMaximum(37.01933);
   ...
   mainFit1026->SetChisquare(9.558103);
   ...
   mainFit1026->SetParameter(0,-2.523268);
   mainFit1026->SetParError(0,1.013339);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9543165);
   mainFit1026->SetParError(1,0.04011826);
   ...
   pt_LaTex = pt->AddText("0.954#pm0.0401");
   pt_LaTex = pt->AddText("#minus2.52#pm 1.01");
   pt_LaTex = pt->AddText("#minus2.64#pm 1.08");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.644058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.644058,-69.28173,2.644058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.558103);
   ...
   mainFit1027->SetParameter(0,-2.523268);
   mainFit1027->SetParError(0,1.013339);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9543165);
   mainFit1027->SetParError(1,0.04011826);
