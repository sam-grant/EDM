...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.77296,75,67.43025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.05264);
   Graph_Graph01027->SetMaximum(53.70993);
   ...
   mainFit1028->SetChisquare(0.01430001);
   ...
   mainFit1028->SetParameter(0,-0.6887162);
   mainFit1028->SetParError(0,0.5150437);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8812343);
   mainFit1028->SetParError(1,0.01696789);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.00477");
   pt_LaTex = pt->AddText("0.881#pm0.017");
   pt_LaTex = pt->AddText("#minus0.689#pm0.515");
   pt_LaTex = pt->AddText("#minus0.782#pm0.586");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7815359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7815359,-56.05264,0.7815359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.01430001);
   ...
   mainFit1029->SetParameter(0,-0.6887162);
   mainFit1029->SetParError(0,0.5150437);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8812343);
   mainFit1029->SetParError(1,0.01696789);
