...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.05264);
   Graph_Graph01031->SetMaximum(53.70993);
   ...
   mainFit1032->SetChisquare(4.922746);
   ...
   mainFit1032->SetParameter(0,-1.294038);
   mainFit1032->SetParError(0,0.5297059);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8655927);
   mainFit1032->SetParError(1,0.01571569);
   ...
   pt_LaTex = pt->AddText("#minus1.29#pm 0.53");
   pt_LaTex = pt->AddText("#minus1.49#pm0.605");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.494973,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.494973,-56.05264,1.494973,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.922746);
   ...
   mainFit1033->SetParameter(0,-1.294038);
   mainFit1033->SetParError(0,0.5297059);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8655927);
   mainFit1033->SetParError(1,0.01571569);
