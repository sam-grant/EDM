...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.05264);
   Graph_Graph01023->SetMaximum(53.70993);
   ...
   mainFit1024->SetChisquare(5.028017);
   ...
   mainFit1024->SetParameter(0,-1.208663);
   mainFit1024->SetParError(0,0.459727);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8642779);
   mainFit1024->SetParError(1,0.01518424);
   ...
   mainFit1025->SetChisquare(5.028017);
   ...
   mainFit1025->SetParameter(0,-1.208663);
   mainFit1025->SetParError(0,0.459727);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8642779);
   mainFit1025->SetParError(1,0.01518424);
