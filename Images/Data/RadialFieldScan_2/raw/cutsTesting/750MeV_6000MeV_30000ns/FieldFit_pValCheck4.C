...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.05264);
   Graph_Graph01033->SetMaximum(53.70993);
   ...
   mainFit1034->SetChisquare(5.011578);
   ...
   mainFit1034->SetParameter(0,-1.253196);
   mainFit1034->SetParError(0,0.576186);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.865739);
   mainFit1034->SetParError(1,0.0189851);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.67");
   pt_LaTex = pt->AddText("0.866#pm0.019");
   pt_LaTex = pt->AddText("#minus1.25#pm0.576");
   pt_LaTex = pt->AddText("#minus1.45#pm0.651");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.447544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.447544,-56.05264,1.447544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.011578);
   ...
   mainFit1035->SetParameter(0,-1.253196);
   mainFit1035->SetParError(0,0.576186);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.865739);
   mainFit1035->SetParError(1,0.0189851);
