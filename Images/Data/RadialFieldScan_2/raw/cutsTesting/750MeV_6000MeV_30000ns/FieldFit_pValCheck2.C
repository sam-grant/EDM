...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.05264);
   Graph_Graph01029->SetMaximum(53.70993);
   ...
   mainFit1030->SetChisquare(4.567608);
   ...
   mainFit1030->SetParameter(0,-1.340604);
   mainFit1030->SetParError(0,0.4991597);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.863497);
   mainFit1030->SetParError(1,0.01522772);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0152");
   pt_LaTex = pt->AddText("#minus1.34#pm0.499");
   pt_LaTex = pt->AddText("#minus1.55#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.552528,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.552528,-56.05264,1.552528,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.567608);
   ...
   mainFit1031->SetParameter(0,-1.340604);
   mainFit1031->SetParError(0,0.4991597);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.863497);
   mainFit1031->SetParError(1,0.01522772);
