...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.62577,50,41.69432);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.99376);
   Graph_Graph01025->SetMaximum(31.06231);
   ...
   mainFit1026->SetChisquare(2.314514);
   ...
   mainFit1026->SetParameter(0,-1.513277);
   mainFit1026->SetParError(0,0.4955245);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8438599);
   mainFit1026->SetParError(1,0.01960097);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.772");
   pt_LaTex = pt->AddText("0.844#pm0.0196");
   pt_LaTex = pt->AddText("#minus1.51#pm0.496");
   pt_LaTex = pt->AddText("#minus1.79#pm0.594");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.79328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.79328,-53.99376,1.79328,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.314514);
   ...
   mainFit1027->SetParameter(0,-1.513277);
   mainFit1027->SetParError(0,0.4955245);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8438599);
   mainFit1027->SetParError(1,0.01960097);
