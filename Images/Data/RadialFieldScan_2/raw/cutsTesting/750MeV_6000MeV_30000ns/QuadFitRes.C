...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01603311);
   Graph_Graph11015->SetMaximum(0.01529686);
   ...
   Graph_Graph21016->SetMinimum(-0.01562317);
   Graph_Graph21016->SetMaximum(0.01840081);
   ...
   Graph_Graph31017->SetMinimum(-0.04402955);
   Graph_Graph31017->SetMaximum(0.03505569);
   ...
   Graph_Graph41018->SetMinimum(-0.01391553);
   Graph_Graph41018->SetMaximum(0.01872961);
   ...
   Graph_Graph51019->SetMinimum(-0.00802073);
   Graph_Graph51019->SetMaximum(0.01072145);
