...
//=========  (Wed Apr 21 13:12:27 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-46.18877,70,62.71341);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.29855);
   Graph_Graph01035->SetMaximum(51.82319);
   ...
   mainFit1036->SetChisquare(4.977089);
   ...
   mainFit1036->SetParameter(0,-1.175825);
   mainFit1036->SetParError(0,0.4822053);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8627247);
   mainFit1036->SetParError(1,0.01667119);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0167");
   pt_LaTex = pt->AddText("#minus1.18#pm0.482");
   pt_LaTex = pt->AddText("#minus1.36#pm0.553");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.362921,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.362921,-35.29855,1.362921,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.977089);
   ...
   mainFit1037->SetParameter(0,-1.175825);
   mainFit1037->SetParError(0,0.4822053);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8627247);
   mainFit1037->SetParError(1,0.01667119);
