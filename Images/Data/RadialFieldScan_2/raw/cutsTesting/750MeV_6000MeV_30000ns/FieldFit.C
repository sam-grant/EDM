...
//=========  (Wed Apr 21 13:12:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.05264);
   Graph_Graph01020->SetMaximum(53.70993);
   ...
   mainFit1021->SetChisquare(5.028017);
   ...
   mainFit1021->SetParameter(0,-1.208663);
   mainFit1021->SetParError(0,0.459727);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8642779);
   mainFit1021->SetParError(1,0.01518424);
   ...
   pt_LaTex = pt->AddText("#minus1.21#pm 0.46");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.529");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.398465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.398465,-56.05264,1.398465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.028017);
   ...
   mainFit1022->SetParameter(0,-1.208663);
   mainFit1022->SetParError(0,0.459727);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8642779);
   mainFit1022->SetParError(1,0.01518424);
