...
//=========  (Wed Apr 21 13:12:25 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2465237);
   ...
   quadLineFit1002->SetParameter(0,74.62359);
   quadLineFit1002->SetParError(0,0.07004298);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.38816);
   quadLineFit1002->SetParError(1,1.174885);
   ...
   quadLineFit1003->SetChisquare(0.2465237);
   ...
   quadLineFit1003->SetParameter(0,74.62359);
   quadLineFit1003->SetParError(0,0.07004298);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.38816);
   quadLineFit1003->SetParError(1,1.174885);
   ...
   Graph_30_ppm1003->SetMinimum(75.84432);
   Graph_30_ppm1003->SetMaximum(76.42224);
   ...
   quadLineFit1004->SetChisquare(1.865061);
   ...
   quadLineFit1004->SetParameter(0,74.7162);
   quadLineFit1004->SetParError(0,0.05889629);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.00628);
   quadLineFit1004->SetParError(1,0.9680218);
   ...
   quadLineFit1005->SetChisquare(1.865061);
   ...
   quadLineFit1005->SetParameter(0,74.7162);
   quadLineFit1005->SetParError(0,0.05889629);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.00628);
   quadLineFit1005->SetParError(1,0.9680218);
   ...
   Graph_10_ppm1005->SetMinimum(74.88329);
   Graph_10_ppm1005->SetMaximum(75.12593);
   ...
   quadLineFit1006->SetChisquare(2.421483);
   ...
   quadLineFit1006->SetParameter(0,74.49204);
   quadLineFit1006->SetParError(0,0.06951336);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.132458);
   quadLineFit1006->SetParError(1,1.127475);
   ...
   quadLineFit1007->SetChisquare(2.421483);
   ...
   quadLineFit1007->SetParameter(0,74.49204);
   quadLineFit1007->SetParError(0,0.06951336);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.132458);
   quadLineFit1007->SetParError(1,1.127475);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.70868);
   Graph_mI10_ppm1007->SetMaximum(74.0119);
   ...
   quadLineFit1008->SetChisquare(11.96719);
   ...
   quadLineFit1008->SetParameter(0,74.43882);
   quadLineFit1008->SetParError(0,0.06057995);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.577005);
   quadLineFit1008->SetParError(1,0.9860489);
   ...
   quadLineFit1009->SetChisquare(11.96719);
   ...
   quadLineFit1009->SetParameter(0,74.43882);
   quadLineFit1009->SetParError(0,0.06057995);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.577005);
   quadLineFit1009->SetParError(1,0.9860489);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.36055);
   Graph_mI30_ppm1009->SetMaximum(73.05082);
   ...
   quadLineFit1010->SetChisquare(2.85239);
   ...
   quadLineFit1010->SetParameter(0,74.37911);
   quadLineFit1010->SetParError(0,0.05731143);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.04656);
   quadLineFit1010->SetParError(1,0.9918512);
   ...
   quadLineFit1011->SetChisquare(2.85239);
   ...
   quadLineFit1011->SetParameter(0,74.37911);
   quadLineFit1011->SetParError(0,0.05731143);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.04656);
   quadLineFit1011->SetParError(1,0.9918512);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.45342);
   Graph_mI50_ppm1011->SetMaximum(72.09547);
   ...
   quadLineFit1012->SetChisquare(0.7307294);
   ...
   quadLineFit1012->SetParameter(0,74.33297);
   quadLineFit1012->SetParError(0,0.1156013);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.83735);
   quadLineFit1012->SetParError(1,2.06841);
   ...
   quadLineFit1013->SetChisquare(0.7307294);
   ...
   quadLineFit1013->SetParameter(0,74.33297);
   quadLineFit1013->SetParError(0,0.1156013);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.83735);
   quadLineFit1013->SetParError(1,2.06841);
