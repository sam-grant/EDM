...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.46403);
   Graph_Graph01031->SetMaximum(50.89348);
   ...
   mainFit1032->SetChisquare(2.465252);
   ...
   mainFit1032->SetParameter(0,-0.2432587);
   mainFit1032->SetParError(0,0.6570154);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8046622);
   mainFit1032->SetParError(1,0.01956889);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.822");
   pt_LaTex = pt->AddText("0.805#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.243#pm0.657");
   pt_LaTex = pt->AddText("#minus0.302#pm0.815");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3023116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3023116,-52.46403,0.3023116,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.465252);
   ...
   mainFit1033->SetParameter(0,-0.2432587);
   mainFit1033->SetParError(0,0.6570154);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8046622);
   mainFit1033->SetParError(1,0.01956889);
