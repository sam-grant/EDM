...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.74391,50,40.6141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.60811);
   Graph_Graph01025->SetMaximum(30.47829);
   ...
   mainFit1026->SetChisquare(1.866953);
   ...
   mainFit1026->SetParameter(0,-0.4377299);
   mainFit1026->SetParError(0,0.6140192);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7930806);
   mainFit1026->SetParError(1,0.02431956);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.622");
   pt_LaTex = pt->AddText("0.793#pm0.0243");
   pt_LaTex = pt->AddText("#minus0.438#pm0.614");
   pt_LaTex = pt->AddText("#minus0.552#pm0.776");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.5519363,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5519363,-50.60811,0.5519363,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.866953);
   ...
   mainFit1027->SetParameter(0,-0.4377299);
   mainFit1027->SetParError(0,0.6140192);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7930806);
   mainFit1027->SetParError(1,0.02431956);
