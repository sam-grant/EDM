...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.43234,70,59.22289);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.26682);
   Graph_Graph01035->SetMaximum(49.05737);
   ...
   mainFit1036->SetChisquare(2.354121);
   ...
   mainFit1036->SetParameter(0,-0.2008075);
   mainFit1036->SetParError(0,0.5980815);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8020451);
   mainFit1036->SetParError(1,0.02076667);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.785");
   pt_LaTex = pt->AddText("0.802#pm0.0208");
   pt_LaTex = pt->AddText("#minus0.201#pm0.598");
   pt_LaTex = pt->AddText("#minus0.25#pm0.744");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.2503693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2503693,-32.26682,0.2503693,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.354121);
   ...
   mainFit1037->SetParameter(0,-0.2008075);
   mainFit1037->SetParError(0,0.5980815);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8020451);
   mainFit1037->SetParError(1,0.02076667);
