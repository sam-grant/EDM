...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.46403);
   Graph_Graph01027->SetMaximum(50.89348);
   ...
   mainFit1028->SetChisquare(0.386361);
   ...
   mainFit1028->SetParameter(0,0.1565577);
   mainFit1028->SetParError(0,0.6398306);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8187041);
   mainFit1028->SetParError(1,0.02118175);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.129");
   pt_LaTex = pt->AddText("0.819#pm0.0212");
   pt_LaTex = pt->AddText("0.157#pm 0.64");
   pt_LaTex = pt->AddText("0.191#pm0.781");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1912262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1912262,-52.46403,-0.1912262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.386361);
   ...
   mainFit1029->SetParameter(0,0.1565577);
   mainFit1029->SetParError(0,0.6398306);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8187041);
   mainFit1029->SetParError(1,0.02118175);
