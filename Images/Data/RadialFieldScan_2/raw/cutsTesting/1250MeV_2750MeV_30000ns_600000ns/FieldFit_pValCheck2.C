...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.46403);
   Graph_Graph01029->SetMaximum(50.89348);
   ...
   mainFit1030->SetChisquare(1.558726);
   ...
   mainFit1030->SetParameter(0,-0.4939864);
   mainFit1030->SetParError(0,0.6203394);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8035263);
   mainFit1030->SetParError(1,0.01897177);
   ...
   pt_LaTex = pt->AddText("0.804#pm0.019");
   pt_LaTex = pt->AddText("#minus0.494#pm 0.62");
   pt_LaTex = pt->AddText("#minus0.615#pm0.771");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6147731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6147731,-52.46403,0.6147731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.558726);
   ...
   mainFit1031->SetParameter(0,-0.4939864);
   mainFit1031->SetParError(0,0.6203394);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8035263);
   mainFit1031->SetParError(1,0.01897177);
