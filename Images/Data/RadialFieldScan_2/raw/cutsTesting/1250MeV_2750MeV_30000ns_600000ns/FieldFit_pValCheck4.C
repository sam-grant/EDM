...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.46403);
   Graph_Graph01033->SetMaximum(50.89348);
   ...
   mainFit1034->SetChisquare(2.438702);
   ...
   mainFit1034->SetParameter(0,-0.3356765);
   mainFit1034->SetParError(0,0.7144867);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8073922);
   mainFit1034->SetParError(1,0.02365539);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.813");
   pt_LaTex = pt->AddText("0.807#pm0.0237");
   pt_LaTex = pt->AddText("#minus0.336#pm0.714");
   pt_LaTex = pt->AddText("#minus0.416#pm0.879");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.415754,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.415754,-52.46403,0.415754,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.438702);
   ...
   mainFit1035->SetParameter(0,-0.3356765);
   mainFit1035->SetParError(0,0.7144867);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8073922);
   mainFit1035->SetParError(1,0.02365539);
