...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-65.38372,75,63.81317);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-52.46403);
   Graph_Graph01023->SetMaximum(50.89348);
   ...
   mainFit1024->SetChisquare(2.468398);
   ...
   mainFit1024->SetParameter(0,-0.2615419);
   mainFit1024->SetParError(0,0.5704588);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8049439);
   mainFit1024->SetParError(1,0.01891357);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.617");
   pt_LaTex = pt->AddText("0.805#pm0.0189");
   pt_LaTex = pt->AddText("#minus0.262#pm 0.57");
   pt_LaTex = pt->AddText("#minus0.325#pm0.708");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3249195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3249195,-52.46403,0.3249195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.468398);
   ...
   mainFit1025->SetParameter(0,-0.2615419);
   mainFit1025->SetParError(0,0.5704588);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8049439);
   mainFit1025->SetParError(1,0.01891357);
