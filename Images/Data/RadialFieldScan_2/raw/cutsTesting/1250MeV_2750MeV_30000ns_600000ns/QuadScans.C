...
//=========  (Tue Apr 27 00:52:29 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9553337);
   ...
   quadLineFit1002->SetParameter(0,74.7142);
   quadLineFit1002->SetParError(0,0.08783396);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.80686);
   quadLineFit1002->SetParError(1,1.473498);
   ...
   quadLineFit1003->SetChisquare(0.9553337);
   ...
   quadLineFit1003->SetParameter(0,74.7142);
   quadLineFit1003->SetParError(0,0.08783396);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.80686);
   quadLineFit1003->SetParError(1,1.473498);
   ...
   Graph_30_ppm1003->SetMinimum(75.83375);
   Graph_30_ppm1003->SetMaximum(76.39656);
   ...
   quadLineFit1004->SetChisquare(6.338137);
   ...
   quadLineFit1004->SetParameter(0,74.7302);
   quadLineFit1004->SetParError(0,0.07308093);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.5199);
   quadLineFit1004->SetParError(1,1.201189);
   ...
   quadLineFit1005->SetChisquare(6.338137);
   ...
   quadLineFit1005->SetParameter(0,74.7302);
   quadLineFit1005->SetParError(0,0.07308093);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.5199);
   quadLineFit1005->SetParError(1,1.201189);
   ...
   Graph_10_ppm1005->SetMinimum(74.89725);
   Graph_10_ppm1005->SetMaximum(75.16408);
   ...
   quadLineFit1006->SetChisquare(0.04879053);
   ...
   quadLineFit1006->SetParameter(0,74.47524);
   quadLineFit1006->SetParError(0,0.08563587);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.99497);
   quadLineFit1006->SetParError(1,1.388863);
   ...
   quadLineFit1007->SetChisquare(0.04879053);
   ...
   quadLineFit1007->SetParameter(0,74.47524);
   quadLineFit1007->SetParError(0,0.08563587);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.99497);
   quadLineFit1007->SetParError(1,1.388863);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80579);
   Graph_mI10_ppm1007->SetMaximum(74.08905);
   ...
   quadLineFit1008->SetChisquare(6.900039);
   ...
   quadLineFit1008->SetParameter(0,74.44743);
   quadLineFit1008->SetParError(0,0.0752093);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.369903);
   quadLineFit1008->SetParError(1,1.224185);
   ...
   quadLineFit1009->SetChisquare(6.900039);
   ...
   quadLineFit1009->SetParameter(0,74.44743);
   quadLineFit1009->SetParError(0,0.0752093);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.369903);
   quadLineFit1009->SetParError(1,1.224185);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.52823);
   Graph_mI30_ppm1009->SetMaximum(73.16152);
   ...
   quadLineFit1010->SetChisquare(0.5032677);
   ...
   quadLineFit1010->SetParameter(0,74.34346);
   quadLineFit1010->SetParError(0,0.07111131);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.2591);
   quadLineFit1010->SetParError(1,1.230705);
   ...
   quadLineFit1011->SetChisquare(0.5032677);
   ...
   quadLineFit1011->SetParameter(0,74.34346);
   quadLineFit1011->SetParError(0,0.07111131);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.2591);
   quadLineFit1011->SetParError(1,1.230705);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.64727);
   Graph_mI50_ppm1011->SetMaximum(72.25023);
   ...
   quadLineFit1012->SetChisquare(1.605543);
   ...
   quadLineFit1012->SetParameter(0,74.31044);
   quadLineFit1012->SetParError(0,0.1436438);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.28079);
   quadLineFit1012->SetParError(1,2.570118);
   ...
   quadLineFit1013->SetChisquare(1.605543);
   ...
   quadLineFit1013->SetParameter(0,74.31044);
   quadLineFit1013->SetParError(0,0.1436438);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.28079);
   quadLineFit1013->SetParError(1,2.570118);
