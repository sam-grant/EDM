...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03194703);
   Graph_Graph11015->SetMaximum(0.05258082);
   ...
   Graph_Graph21016->SetMinimum(-0.00275274);
   Graph_Graph21016->SetMaximum(0.003241563);
   ...
   Graph_Graph31017->SetMinimum(-0.04345142);
   Graph_Graph31017->SetMaximum(0.03283368);
   ...
   Graph_Graph41018->SetMinimum(-0.009122649);
   Graph_Graph41018->SetMaximum(0.01174966);
   ...
   Graph_Graph51019->SetMinimum(-0.0147581);
   Graph_Graph51019->SetMaximum(0.01971502);
