...
//=========  (Tue Apr 27 00:52:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.46403);
   Graph_Graph01020->SetMaximum(50.89348);
   ...
   mainFit1021->SetChisquare(2.468398);
   ...
   mainFit1021->SetParameter(0,-0.2615419);
   mainFit1021->SetParError(0,0.5704588);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8049439);
   mainFit1021->SetParError(1,0.01891357);
   ...
   mainFit1022->SetChisquare(2.468398);
   ...
   mainFit1022->SetParameter(0,-0.2615419);
   mainFit1022->SetParError(0,0.5704588);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8049439);
   mainFit1022->SetParError(1,0.01891357);
