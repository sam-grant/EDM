...
//=========  (Wed Apr 21 17:58:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-135.8399);
   Graph_Graph01033->SetMaximum(80.7819);
   ...
   mainFit1034->SetChisquare(14.8508);
   ...
   mainFit1034->SetParameter(0,-7.549624);
   mainFit1034->SetParError(0,3.636672);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.282748);
   mainFit1034->SetParError(1,0.1199064);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.95");
   pt_LaTex = pt->AddText(" 1.28#pm 0.12");
   pt_LaTex = pt->AddText("#minus7.55#pm 3.64");
   pt_LaTex = pt->AddText("#minus5.89#pm 2.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,5.88551,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.88551,-135.8399,5.88551,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(14.8508);
   ...
   mainFit1035->SetParameter(0,-7.549624);
   mainFit1035->SetParError(0,3.636672);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.282748);
   mainFit1035->SetParError(1,0.1199064);
