...
//=========  (Wed Apr 21 17:58:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.2531395);
   Graph_Graph11015->SetMaximum(0.2138436);
   ...
   Graph_Graph21016->SetMinimum(-0.1652365);
   Graph_Graph21016->SetMaximum(0.1954848);
   ...
   Graph_Graph31017->SetMinimum(-0.0513899);
   Graph_Graph31017->SetMaximum(0.04854356);
   ...
   Graph_Graph41018->SetMinimum(-0.2080106);
   Graph_Graph41018->SetMaximum(0.1250987);
   ...
   Graph_Graph51019->SetMinimum(-0.03453189);
   Graph_Graph51019->SetMaximum(0.04578634);
