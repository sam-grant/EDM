...
//=========  (Wed Apr 21 17:58:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-135.8399);
   Graph_Graph01031->SetMaximum(80.7819);
   ...
   mainFit1032->SetChisquare(15.93051);
   ...
   mainFit1032->SetParameter(0,-6.069717);
   mainFit1032->SetParError(0,3.351311);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.204228);
   mainFit1032->SetParError(1,0.09940482);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 5.31");
   pt_LaTex = pt->AddText("  1.2#pm0.0994");
   pt_LaTex = pt->AddText("#minus6.07#pm 3.35");
   pt_LaTex = pt->AddText("#minus5.04#pm  2.7");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,5.040338,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.040338,-135.8399,5.040338,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(15.93051);
   ...
   mainFit1033->SetParameter(0,-6.069717);
   mainFit1033->SetParError(0,3.351311);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.204228);
   mainFit1033->SetParError(1,0.09940482);
