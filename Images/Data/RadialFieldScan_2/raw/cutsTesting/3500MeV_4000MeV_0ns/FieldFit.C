...
//=========  (Wed Apr 21 17:58:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-135.8399);
   Graph_Graph01020->SetMaximum(80.7819);
   ...
   mainFit1021->SetChisquare(16.98876);
   ...
   mainFit1021->SetParameter(0,-4.350976);
   mainFit1021->SetParError(0,2.90514);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.177704);
   mainFit1021->SetParError(1,0.09600286);
   ...
   mainFit1022->SetChisquare(16.98876);
   ...
   mainFit1022->SetParameter(0,-4.350976);
   mainFit1022->SetParError(0,2.90514);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.177704);
   mainFit1022->SetParError(1,0.09600286);
