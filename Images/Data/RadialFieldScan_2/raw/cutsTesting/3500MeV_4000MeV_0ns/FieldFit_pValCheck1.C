...
//=========  (Wed Apr 21 17:58:45 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-162.9177,75,107.8596);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-135.8399);
   Graph_Graph01027->SetMaximum(80.7819);
   ...
   mainFit1028->SetChisquare(12.23195);
   ...
   mainFit1028->SetParameter(0,-1.152407);
   mainFit1028->SetParError(0,3.254322);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.282143);
   mainFit1028->SetParError(1,0.1072827);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.08");
   pt_LaTex = pt->AddText(" 1.28#pm0.107");
   pt_LaTex = pt->AddText("#minus1.15#pm 3.25");
   pt_LaTex = pt->AddText("#minus0.899#pm 2.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8988127,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8988127,-135.8399,0.8988127,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(12.23195);
   ...
   mainFit1029->SetParameter(0,-1.152407);
   mainFit1029->SetParError(0,3.254322);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.282143);
   mainFit1029->SetParError(1,0.1072827);
