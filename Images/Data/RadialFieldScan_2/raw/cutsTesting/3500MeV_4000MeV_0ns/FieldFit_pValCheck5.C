...
//=========  (Wed Apr 21 17:58:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-64.95794,70,88.26769);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-49.63538);
   Graph_Graph01035->SetMaximum(72.94512);
   ...
   mainFit1036->SetChisquare(4.253572);
   ...
   mainFit1036->SetParameter(0,-1.068065);
   mainFit1036->SetParError(0,3.047313);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.022373);
   mainFit1036->SetParError(1,0.1054094);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.105");
   pt_LaTex = pt->AddText("#minus1.07#pm 3.05");
   pt_LaTex = pt->AddText("#minus1.04#pm 2.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.044692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.044692,-49.63538,1.044692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.253572);
   ...
   mainFit1037->SetParameter(0,-1.068065);
   mainFit1037->SetParError(0,3.047313);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.022373);
   mainFit1037->SetParError(1,0.1054094);
