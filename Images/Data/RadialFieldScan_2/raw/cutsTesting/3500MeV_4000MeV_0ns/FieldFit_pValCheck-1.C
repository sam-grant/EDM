...
//=========  (Wed Apr 21 17:58:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-135.8399);
   Graph_Graph01023->SetMaximum(80.7819);
   ...
   mainFit1024->SetChisquare(16.98876);
   ...
   mainFit1024->SetParameter(0,-4.350976);
   mainFit1024->SetParError(0,2.90514);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.177704);
   mainFit1024->SetParError(1,0.09600286);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.25");
   pt_LaTex = pt->AddText(" 1.18#pm0.096");
   pt_LaTex = pt->AddText("#minus4.35#pm 2.91");
   pt_LaTex = pt->AddText("#minus3.69#pm 2.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.694456,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.694456,-135.8399,3.694456,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(16.98876);
   ...
   mainFit1025->SetParameter(0,-4.350976);
   mainFit1025->SetParError(0,2.90514);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.177704);
   mainFit1025->SetParError(1,0.09600286);
