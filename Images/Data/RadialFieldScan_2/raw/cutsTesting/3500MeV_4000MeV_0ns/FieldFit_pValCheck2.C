...
//=========  (Wed Apr 21 17:58:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-135.8399);
   Graph_Graph01029->SetMaximum(80.7819);
   ...
   mainFit1030->SetChisquare(14.48376);
   ...
   mainFit1030->SetParameter(0,-6.293216);
   mainFit1030->SetParError(0,3.153687);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.166245);
   mainFit1030->SetParError(1,0.0962755);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 4.83");
   pt_LaTex = pt->AddText(" 1.17#pm0.0963");
   pt_LaTex = pt->AddText("#minus6.29#pm 3.15");
   pt_LaTex = pt->AddText(" #minus5.4#pm 2.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,5.396135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.396135,-135.8399,5.396135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(14.48376);
   ...
   mainFit1031->SetParameter(0,-6.293216);
   mainFit1031->SetParError(0,3.153687);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.166245);
   mainFit1031->SetParError(1,0.0962755);
