...
//=========  (Wed Apr 21 17:58:44 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-153.8734,50,62.63829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-132.2222);
   Graph_Graph01025->SetMaximum(40.98712);
   ...
   mainFit1026->SetChisquare(16.96759);
   ...
   mainFit1026->SetParameter(0,-4.520765);
   mainFit1026->SetParError(0,3.130659);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.166297);
   mainFit1026->SetParError(1,0.1239413);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 5.66");
   pt_LaTex = pt->AddText(" 1.17#pm0.124");
   pt_LaTex = pt->AddText("#minus4.52#pm 3.13");
   pt_LaTex = pt->AddText("#minus3.88#pm 2.76");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.876171,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.876171,-132.2222,3.876171,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(16.96759);
   ...
   mainFit1027->SetParameter(0,-4.520765);
   mainFit1027->SetParError(0,3.130659);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.166297);
   mainFit1027->SetParError(1,0.1239413);
