...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-74.54027,50,48.98872);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.18737);
   Graph_Graph01025->SetMaximum(36.63582);
   ...
   mainFit1026->SetChisquare(1.631159);
   ...
   mainFit1026->SetParameter(0,-2.437869);
   mainFit1026->SetParError(0,0.5565356);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9999319);
   mainFit1026->SetParError(1,0.02202861);
   ...
   pt_LaTex = pt->AddText("    1#pm0.022");
   pt_LaTex = pt->AddText("#minus2.44#pm0.557");
   pt_LaTex = pt->AddText("#minus2.44#pm0.566");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.438035,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.438035,-62.18737,2.438035,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.631159);
   ...
   mainFit1027->SetParameter(0,-2.437869);
   mainFit1027->SetParError(0,0.5565356);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9999319);
   mainFit1027->SetParError(1,0.02202861);
