...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-64.49681);
   Graph_Graph01033->SetMaximum(62.0396);
   ...
   mainFit1034->SetChisquare(3.477822);
   ...
   mainFit1034->SetParameter(0,-2.302164);
   mainFit1034->SetParError(0,0.6474869);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.024932);
   mainFit1034->SetParError(1,0.02133541);
   ...
   pt_LaTex = pt->AddText(" 1.02#pm0.0213");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.647");
   pt_LaTex = pt->AddText("#minus2.25#pm0.611");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.246163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.246163,-64.49681,2.246163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.477822);
   ...
   mainFit1035->SetParameter(0,-2.302164);
   mainFit1035->SetParError(0,0.6474869);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.024932);
   mainFit1035->SetParError(1,0.02133541);
