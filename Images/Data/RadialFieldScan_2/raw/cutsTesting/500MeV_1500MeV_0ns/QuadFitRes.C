...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02967214);
   Graph_Graph11015->SetMaximum(0.009275624);
   ...
   Graph_Graph21016->SetMinimum(-0.02708468);
   Graph_Graph21016->SetMaximum(0.03178062);
   ...
   Graph_Graph31017->SetMinimum(-0.01055734);
   Graph_Graph31017->SetMaximum(0.02045572);
   ...
   Graph_Graph41018->SetMinimum(-0.01969787);
   Graph_Graph41018->SetMaximum(0.0285875);
   ...
   Graph_Graph51019->SetMinimum(-0.001301408);
   Graph_Graph51019->SetMaximum(0.001735545);
