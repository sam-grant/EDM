...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-64.49681);
   Graph_Graph01031->SetMaximum(62.0396);
   ...
   mainFit1032->SetChisquare(2.641166);
   ...
   mainFit1032->SetParameter(0,-1.848212);
   mainFit1032->SetParError(0,0.5944147);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.015165);
   mainFit1032->SetParError(1,0.0176478);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.88");
   pt_LaTex = pt->AddText(" 1.02#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.85#pm0.594");
   pt_LaTex = pt->AddText("#minus1.82#pm0.578");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.820602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.820602,-64.49681,1.820602,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.641166);
   ...
   mainFit1033->SetParameter(0,-1.848212);
   mainFit1033->SetParError(0,0.5944147);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.015165);
   mainFit1033->SetParError(1,0.0176478);
