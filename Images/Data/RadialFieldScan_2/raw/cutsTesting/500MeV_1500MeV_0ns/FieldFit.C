...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-64.49681);
   Graph_Graph01020->SetMaximum(62.0396);
   ...
   mainFit1021->SetChisquare(3.643492);
   ...
   mainFit1021->SetParameter(0,-2.143097);
   mainFit1021->SetParError(0,0.5162941);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.019706);
   mainFit1021->SetParError(1,0.0170532);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.911");
   pt_LaTex = pt->AddText(" 1.02#pm0.0171");
   pt_LaTex = pt->AddText("#minus2.14#pm0.516");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.502");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.101681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.101681,-64.49681,2.101681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.643492);
   ...
   mainFit1022->SetParameter(0,-2.143097);
   mainFit1022->SetParError(0,0.5162941);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.019706);
   mainFit1022->SetParError(1,0.0170532);
