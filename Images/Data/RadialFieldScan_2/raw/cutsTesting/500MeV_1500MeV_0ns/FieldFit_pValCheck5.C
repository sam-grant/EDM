...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.78107,70,72.75009);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-42.02795);
   Graph_Graph01035->SetMaximum(59.99697);
   ...
   mainFit1036->SetChisquare(3.115308);
   ...
   mainFit1036->SetParameter(0,-2.261838);
   mainFit1036->SetParError(0,0.5415193);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.025325);
   mainFit1036->SetParError(1,0.01872029);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0187");
   pt_LaTex = pt->AddText("#minus2.26#pm0.542");
   pt_LaTex = pt->AddText("#minus2.21#pm0.519");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.20597,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.20597,-42.02795,2.20597,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.115308);
   ...
   mainFit1037->SetParameter(0,-2.261838);
   mainFit1037->SetParError(0,0.5415193);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.025325);
   mainFit1037->SetParError(1,0.01872029);
