...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-64.49681);
   Graph_Graph01023->SetMaximum(62.0396);
   ...
   mainFit1024->SetChisquare(3.643492);
   ...
   mainFit1024->SetParameter(0,-2.143097);
   mainFit1024->SetParError(0,0.5162941);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.019706);
   mainFit1024->SetParError(1,0.0170532);
   ...
   mainFit1025->SetChisquare(3.643492);
   ...
   mainFit1025->SetParameter(0,-2.143097);
   mainFit1025->SetParError(0,0.5162941);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.019706);
   mainFit1025->SetParError(1,0.0170532);
