...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-64.49681);
   Graph_Graph01029->SetMaximum(62.0396);
   ...
   mainFit1030->SetChisquare(3.29652);
   ...
   mainFit1030->SetParameter(0,-2.272529);
   mainFit1030->SetParError(0,0.5610927);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.01895);
   mainFit1030->SetParError(1,0.01710223);
   ...
   pt_LaTex = pt->AddText("#minus2.27#pm0.561");
   pt_LaTex = pt->AddText("#minus2.23#pm0.547");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.230264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.230264,-64.49681,2.230264,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.29652);
   ...
   mainFit1031->SetParameter(0,-2.272529);
   mainFit1031->SetParError(0,0.5610927);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.01895);
   mainFit1031->SetParError(1,0.01710223);
