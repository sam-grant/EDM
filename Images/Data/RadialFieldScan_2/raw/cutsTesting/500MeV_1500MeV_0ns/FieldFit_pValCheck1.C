...
//=========  (Wed Apr 21 18:15:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-80.31386,75,77.85665);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-64.49681);
   Graph_Graph01027->SetMaximum(62.0396);
   ...
   mainFit1028->SetChisquare(1.904579);
   ...
   mainFit1028->SetParameter(0,-1.800637);
   mainFit1028->SetParError(0,0.5779394);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.030882);
   mainFit1028->SetParError(1,0.01904108);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.019");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.578");
   pt_LaTex = pt->AddText("#minus1.75#pm0.564");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.746695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.746695,-64.49681,1.746695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.904579);
   ...
   mainFit1029->SetParameter(0,-1.800637);
   mainFit1029->SetParError(0,0.5779394);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.030882);
   mainFit1029->SetParError(1,0.01904108);
