...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.83393);
   Graph_Graph01033->SetMaximum(58.7782);
   ...
   mainFit1034->SetChisquare(4.84661);
   ...
   mainFit1034->SetParameter(0,0.666647);
   mainFit1034->SetParError(0,2.255987);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7710466);
   mainFit1034->SetParError(1,0.07435666);
   ...
   pt_LaTex = pt->AddText("0.771#pm0.0744");
   pt_LaTex = pt->AddText("0.667#pm 2.26");
   pt_LaTex = pt->AddText("0.865#pm 2.97");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8646001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8646001,-55.83393,-0.8646001,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.84661);
   ...
   mainFit1035->SetParameter(0,0.666647);
   mainFit1035->SetParError(0,2.255987);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7710466);
   mainFit1035->SetParError(1,0.07435666);
