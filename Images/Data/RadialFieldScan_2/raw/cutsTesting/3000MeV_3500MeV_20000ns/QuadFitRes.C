...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0286453);
   Graph_Graph11015->SetMaximum(0.0143413);
   ...
   Graph_Graph21016->SetMinimum(-0.003002231);
   Graph_Graph21016->SetMaximum(0.003520927);
   ...
   Graph_Graph31017->SetMinimum(-0.1603827);
   Graph_Graph31017->SetMaximum(0.1239645);
   ...
   Graph_Graph41018->SetMinimum(-0.04600111);
   Graph_Graph41018->SetMaximum(0.04059107);
   ...
   Graph_Graph51019->SetMinimum(-0.00113033);
   Graph_Graph51019->SetMaximum(0.001505322);
