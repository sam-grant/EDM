...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.16045,75,73.10472);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-55.83393);
   Graph_Graph01031->SetMaximum(58.7782);
   ...
   mainFit1032->SetChisquare(2.934562);
   ...
   mainFit1032->SetParameter(0,-3.553283);
   mainFit1032->SetParError(0,2.069664);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8727688);
   mainFit1032->SetParError(1,0.06149665);
   ...
   pt_LaTex = pt->AddText("0.873#pm0.0615");
   pt_LaTex = pt->AddText("#minus3.55#pm 2.07");
   pt_LaTex = pt->AddText("#minus4.07#pm 2.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.071276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.071276,-55.83393,4.071276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.934562);
   ...
   mainFit1033->SetParameter(0,-3.553283);
   mainFit1033->SetParError(0,2.069664);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8727688);
   mainFit1033->SetParError(1,0.06149665);
