...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.83393);
   Graph_Graph01023->SetMaximum(58.7782);
   ...
   mainFit1024->SetChisquare(7.223465);
   ...
   mainFit1024->SetParameter(0,-1.432739);
   mainFit1024->SetParError(0,1.798638);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8399496);
   mainFit1024->SetParError(1,0.05942106);
   ...
   pt_LaTex = pt->AddText(" 0.84#pm0.0594");
   pt_LaTex = pt->AddText("#minus1.43#pm  1.8");
   pt_LaTex = pt->AddText("#minus1.71#pm 2.13");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.705744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.705744,-55.83393,1.705744,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(7.223465);
   ...
   mainFit1025->SetParameter(0,-1.432739);
   mainFit1025->SetParError(0,1.798638);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8399496);
   mainFit1025->SetParError(1,0.05942106);
