...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.83393);
   Graph_Graph01029->SetMaximum(58.7782);
   ...
   mainFit1030->SetChisquare(6.31336);
   ...
   mainFit1030->SetParameter(0,-0.7009878);
   mainFit1030->SetParError(0,1.955377);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8442296);
   mainFit1030->SetParError(1,0.0595895);
   ...
   pt_LaTex = pt->AddText("0.844#pm0.0596");
   pt_LaTex = pt->AddText("#minus0.701#pm 1.96");
   pt_LaTex = pt->AddText("#minus0.83#pm 2.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8303285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8303285,-55.83393,0.8303285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.31336);
   ...
   mainFit1031->SetParameter(0,-0.7009878);
   mainFit1031->SetParError(0,1.955377);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8442296);
   mainFit1031->SetParError(1,0.0595895);
