...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.83393);
   Graph_Graph01020->SetMaximum(58.7782);
   ...
   mainFit1021->SetChisquare(7.223465);
   ...
   mainFit1021->SetParameter(0,-1.432739);
   mainFit1021->SetParError(0,1.798638);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8399496);
   mainFit1021->SetParError(1,0.05942106);
   ...
   mainFit1022->SetChisquare(7.223465);
   ...
   mainFit1022->SetParameter(0,-1.432739);
   mainFit1022->SetParError(0,1.798638);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8399496);
   mainFit1022->SetParError(1,0.05942106);
