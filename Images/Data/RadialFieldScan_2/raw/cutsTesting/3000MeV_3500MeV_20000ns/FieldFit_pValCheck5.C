...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-55.76877,70,70.22639);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-43.16926);
   Graph_Graph01035->SetMaximum(57.62687);
   ...
   mainFit1036->SetChisquare(6.691865);
   ...
   mainFit1036->SetParameter(0,-1.848904);
   mainFit1036->SetParError(0,1.887017);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8596136);
   mainFit1036->SetParError(1,0.06524923);
   ...
   pt_LaTex = pt->AddText(" 0.86#pm0.0652");
   pt_LaTex = pt->AddText("#minus1.85#pm 1.89");
   pt_LaTex = pt->AddText("#minus2.15#pm 2.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.150855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.150855,-43.16926,2.150855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.691865);
   ...
   mainFit1037->SetParameter(0,-1.848904);
   mainFit1037->SetParError(0,1.887017);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8596136);
   mainFit1037->SetParError(1,0.06524923);
