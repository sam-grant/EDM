...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-53.30751);
   Graph_Graph01025->SetMaximum(30.98761);
   ...
   mainFit1026->SetChisquare(5.692458);
   ...
   mainFit1026->SetParameter(0,-2.322675);
   mainFit1026->SetParError(0,1.937015);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7800179);
   mainFit1026->SetParError(1,0.07664485);
   ...
   pt_LaTex = pt->AddText(" 0.78#pm0.0766");
   pt_LaTex = pt->AddText("#minus2.32#pm 1.94");
   pt_LaTex = pt->AddText("#minus2.98#pm 2.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.97772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.97772,-53.30751,2.97772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.692458);
   ...
   mainFit1027->SetParameter(0,-2.322675);
   mainFit1027->SetParError(0,1.937015);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7800179);
   mainFit1027->SetParError(1,0.07664485);
