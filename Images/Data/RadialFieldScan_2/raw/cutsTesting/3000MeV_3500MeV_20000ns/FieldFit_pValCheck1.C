...
//=========  (Thu Apr 22 00:32:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.83393);
   Graph_Graph01027->SetMaximum(58.7782);
   ...
   mainFit1028->SetChisquare(5.785559);
   ...
   mainFit1028->SetParameter(0,-0.345224);
   mainFit1028->SetParError(0,2.014365);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8754455);
   mainFit1028->SetParError(1,0.0663822);
   ...
   pt_LaTex = pt->AddText("0.875#pm0.0664");
   pt_LaTex = pt->AddText("#minus0.345#pm 2.01");
   pt_LaTex = pt->AddText("#minus0.394#pm  2.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3943409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3943409,-55.83393,0.3943409,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(5.785559);
   ...
   mainFit1029->SetParameter(0,-0.345224);
   mainFit1029->SetParError(0,2.014365);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8754455);
   mainFit1029->SetParError(1,0.0663822);
