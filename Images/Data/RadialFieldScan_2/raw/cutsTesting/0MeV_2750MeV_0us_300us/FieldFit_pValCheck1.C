...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.29512);
   Graph_Graph01027->SetMaximum(51.10725);
   ...
   mainFit1028->SetChisquare(46.90695);
   ...
   mainFit1028->SetParameter(0,-1.69705);
   mainFit1028->SetParError(0,0.3494598);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8679348);
   mainFit1028->SetParError(1,0.01148467);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0115");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.349");
   pt_LaTex = pt->AddText("#minus1.96#pm0.405");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.955273,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.955273,-49.29512,1.955273,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(46.90695);
   ...
   mainFit1029->SetParameter(0,-1.69705);
   mainFit1029->SetParError(0,0.3494598);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8679348);
   mainFit1029->SetParError(1,0.01148467);
