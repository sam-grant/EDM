...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.29512);
   Graph_Graph01033->SetMaximum(51.10725);
   ...
   mainFit1034->SetChisquare(63.02003);
   ...
   mainFit1034->SetParameter(0,-0.9431904);
   mainFit1034->SetParError(0,0.3914796);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8847974);
   mainFit1034->SetParError(1,0.01286727);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   21");
   pt_LaTex = pt->AddText("0.885#pm0.0129");
   pt_LaTex = pt->AddText("#minus0.943#pm0.391");
   pt_LaTex = pt->AddText("#minus1.07#pm0.435");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.065996,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.065996,-49.29512,1.065996,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(63.02003);
   ...
   mainFit1035->SetParameter(0,-0.9431904);
   mainFit1035->SetParError(0,0.3914796);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8847974);
   mainFit1035->SetParError(1,0.01286727);
