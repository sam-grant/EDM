...
//=========  (Wed Apr 28 14:01:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-61.84542,75,63.65754);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-49.29512);
   Graph_Graph01020->SetMaximum(51.10725);
   ...
   mainFit1021->SetChisquare(63.26398);
   ...
   mainFit1021->SetParameter(0,-1.060013);
   mainFit1021->SetParError(0,0.3119499);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8886174);
   mainFit1021->SetParError(1,0.01028341);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 15.8");
   pt_LaTex = pt->AddText("0.889#pm0.0103");
   pt_LaTex = pt->AddText("#minus1.06#pm0.312");
   pt_LaTex = pt->AddText("#minus1.19#pm0.349");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.192879,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.192879,-49.29512,1.192879,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(63.26398);
   ...
   mainFit1022->SetParameter(0,-1.060013);
   mainFit1022->SetParError(0,0.3119499);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8886174);
   mainFit1022->SetParError(1,0.01028341);
