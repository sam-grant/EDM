...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.29512);
   Graph_Graph01029->SetMaximum(51.10725);
   ...
   mainFit1030->SetChisquare(58.37957);
   ...
   mainFit1030->SetParameter(0,-1.351609);
   mainFit1030->SetParError(0,0.3387047);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8868729);
   mainFit1030->SetParError(1,0.01031365);
   ...
   pt_LaTex = pt->AddText("0.887#pm0.0103");
   pt_LaTex = pt->AddText("#minus1.35#pm0.339");
   pt_LaTex = pt->AddText("#minus1.52#pm 0.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.524016,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.524016,-49.29512,1.524016,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(58.37957);
   ...
   mainFit1031->SetParameter(0,-1.351609);
   mainFit1031->SetParError(0,0.3387047);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8868729);
   mainFit1031->SetParError(1,0.01031365);
