...
//=========  (Wed Apr 28 14:01:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02752023);
   Graph_Graph11015->SetMaximum(0.01776233);
   ...
   Graph_Graph21016->SetMinimum(-0.01171405);
   Graph_Graph21016->SetMaximum(0.01360866);
   ...
   Graph_Graph31017->SetMinimum(-0.01054676);
   Graph_Graph31017->SetMaximum(0.01825476);
   ...
   Graph_Graph41018->SetMinimum(-0.02882336);
   Graph_Graph41018->SetMaximum(0.0499815);
   ...
   Graph_Graph51019->SetMinimum(-0.02271633);
   Graph_Graph51019->SetMaximum(0.01703341);
