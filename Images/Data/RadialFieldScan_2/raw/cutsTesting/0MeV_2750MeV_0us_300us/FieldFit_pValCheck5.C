...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.46447,70,60.58135);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.75988);
   Graph_Graph01035->SetMaximum(49.87677);
   ...
   mainFit1036->SetChisquare(40.12186);
   ...
   mainFit1036->SetParameter(0,-1.536238);
   mainFit1036->SetParError(0,0.3272806);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9111206);
   mainFit1036->SetParError(1,0.01129737);
   ...
   pt_LaTex = pt->AddText("0.911#pm0.0113");
   pt_LaTex = pt->AddText("#minus1.54#pm0.327");
   pt_LaTex = pt->AddText("#minus1.69#pm0.354");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.686098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.686098,-35.75988,1.686098,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(40.12186);
   ...
   mainFit1037->SetParameter(0,-1.536238);
   mainFit1037->SetParError(0,0.3272806);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9111206);
   mainFit1037->SetParError(1,0.01129737);
