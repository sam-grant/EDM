...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.29512);
   Graph_Graph01023->SetMaximum(51.10725);
   ...
   mainFit1024->SetChisquare(63.26398);
   ...
   mainFit1024->SetParameter(0,-1.060013);
   mainFit1024->SetParError(0,0.3119499);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8886174);
   mainFit1024->SetParError(1,0.01028341);
   ...
   mainFit1025->SetChisquare(63.26398);
   ...
   mainFit1025->SetParameter(0,-1.060013);
   mainFit1025->SetParError(0,0.3119499);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8886174);
   mainFit1025->SetParError(1,0.01028341);
