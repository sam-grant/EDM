...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-49.29512);
   Graph_Graph01031->SetMaximum(51.10725);
   ...
   mainFit1032->SetChisquare(26.22496);
   ...
   mainFit1032->SetParameter(0,0.01773329);
   mainFit1032->SetParError(0,0.3587096);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8721604);
   mainFit1032->SetParError(1,0.010633);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 8.74");
   pt_LaTex = pt->AddText("0.872#pm0.0106");
   pt_LaTex = pt->AddText("0.0177#pm0.359");
   pt_LaTex = pt->AddText("0.0203#pm0.411");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.02033261,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.02033261,-49.29512,-0.02033261,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(26.22496);
   ...
   mainFit1033->SetParameter(0,0.01773329);
   mainFit1033->SetParError(0,0.3587096);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8721604);
   mainFit1033->SetParError(1,0.010633);
