...
//=========  (Wed Apr 28 14:01:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.25196,50,45.69024);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.85774);
   Graph_Graph01025->SetMaximum(35.29602);
   ...
   mainFit1026->SetChisquare(56.95948);
   ...
   mainFit1026->SetParameter(0,-0.7417252);
   mainFit1026->SetParError(0,0.3367221);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9097476);
   mainFit1026->SetParError(1,0.01328791);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.0133");
   pt_LaTex = pt->AddText("#minus0.742#pm0.337");
   pt_LaTex = pt->AddText("#minus0.815#pm0.372");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8153087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8153087,-47.85774,0.8153087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(56.95948);
   ...
   mainFit1027->SetParameter(0,-0.7417252);
   mainFit1027->SetParError(0,0.3367221);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9097476);
   mainFit1027->SetParError(1,0.01328791);
