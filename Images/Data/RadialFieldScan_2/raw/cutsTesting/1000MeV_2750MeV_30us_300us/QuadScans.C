...
//=========  (Wed Apr 28 15:13:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.655547);
   ...
   quadLineFit1002->SetParameter(0,74.60772);
   quadLineFit1002->SetParError(0,0.07625383);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.58097);
   quadLineFit1002->SetParError(1,1.279088);
   ...
   quadLineFit1003->SetChisquare(2.655547);
   ...
   quadLineFit1003->SetParameter(0,74.60772);
   quadLineFit1003->SetParError(0,0.07625383);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.58097);
   quadLineFit1003->SetParError(1,1.279088);
   ...
   Graph_30_ppm1003->SetMinimum(75.77933);
   Graph_30_ppm1003->SetMaximum(76.36485);
   ...
   quadLineFit1004->SetChisquare(5.34821);
   ...
   quadLineFit1004->SetParameter(0,74.66909);
   quadLineFit1004->SetParError(0,0.06432557);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.98801);
   quadLineFit1004->SetParError(1,1.057281);
   ...
   quadLineFit1005->SetChisquare(5.34821);
   ...
   quadLineFit1005->SetParameter(0,74.66909);
   quadLineFit1005->SetParError(0,0.06432557);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.98801);
   quadLineFit1005->SetParError(1,1.057281);
   ...
   Graph_10_ppm1005->SetMinimum(74.84556);
   Graph_10_ppm1005->SetMaximum(75.11249);
   ...
   quadLineFit1006->SetChisquare(0.6506901);
   ...
   quadLineFit1006->SetParameter(0,74.41085);
   quadLineFit1006->SetParError(0,0.07511316);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.126066);
   quadLineFit1006->SetParError(1,1.218221);
   ...
   quadLineFit1007->SetChisquare(0.6506901);
   ...
   quadLineFit1007->SetParameter(0,74.41085);
   quadLineFit1007->SetParError(0,0.07511316);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.126066);
   quadLineFit1007->SetParError(1,1.218221);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72743);
   Graph_mI10_ppm1007->SetMaximum(73.99238);
   ...
   quadLineFit1008->SetChisquare(3.329411);
   ...
   quadLineFit1008->SetParameter(0,74.36411);
   quadLineFit1008->SetParError(0,0.06595038);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.389302);
   quadLineFit1008->SetParError(1,1.073457);
   ...
   quadLineFit1009->SetChisquare(3.329411);
   ...
   quadLineFit1009->SetParameter(0,74.36411);
   quadLineFit1009->SetParError(0,0.06595038);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.389302);
   quadLineFit1009->SetParError(1,1.073457);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40848);
   Graph_mI30_ppm1009->SetMaximum(73.0618);
   ...
   quadLineFit1010->SetChisquare(2.488532);
   ...
   quadLineFit1010->SetParameter(0,74.29127);
   quadLineFit1010->SetParError(0,0.06240567);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.11691);
   quadLineFit1010->SetParError(1,1.080065);
   ...
   quadLineFit1011->SetChisquare(2.488532);
   ...
   quadLineFit1011->SetParameter(0,74.29127);
   quadLineFit1011->SetParError(0,0.06240567);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.11691);
   quadLineFit1011->SetParError(1,1.080065);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51574);
   Graph_mI50_ppm1011->SetMaximum(72.13263);
   ...
   quadLineFit1012->SetChisquare(0.3743384);
   ...
   quadLineFit1012->SetParameter(0,74.25981);
   quadLineFit1012->SetParError(0,0.125903);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.69862);
   quadLineFit1012->SetParError(1,2.252715);
   ...
   quadLineFit1013->SetChisquare(0.3743384);
   ...
   quadLineFit1013->SetParameter(0,74.25981);
   quadLineFit1013->SetParError(0,0.125903);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.69862);
   quadLineFit1013->SetParError(1,2.252715);
