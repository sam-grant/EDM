...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-53.83247);
   Graph_Graph01020->SetMaximum(52.7412);
   ...
   mainFit1021->SetChisquare(4.5056);
   ...
   mainFit1021->SetParameter(0,-0.255645);
   mainFit1021->SetParError(0,0.5002314);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8328086);
   mainFit1021->SetParError(1,0.01654067);
   ...
   mainFit1022->SetChisquare(4.5056);
   ...
   mainFit1022->SetParameter(0,-0.255645);
   mainFit1022->SetParError(0,0.5002314);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8328086);
   mainFit1022->SetParError(1,0.01654067);
