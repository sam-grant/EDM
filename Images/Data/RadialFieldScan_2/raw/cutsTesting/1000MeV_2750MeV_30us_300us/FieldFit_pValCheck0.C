...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.20049,50,41.29445);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.851);
   Graph_Graph01025->SetMaximum(30.94495);
   ...
   mainFit1026->SetChisquare(2.791003);
   ...
   mainFit1026->SetParameter(0,-0.5192843);
   mainFit1026->SetParError(0,0.5392193);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8150927);
   mainFit1026->SetParError(1,0.02136476);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.93");
   pt_LaTex = pt->AddText("0.815#pm0.0214");
   pt_LaTex = pt->AddText("#minus0.519#pm0.539");
   pt_LaTex = pt->AddText("#minus0.637#pm0.664");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6370862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6370862,-51.851,0.6370862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.791003);
   ...
   mainFit1027->SetParameter(0,-0.5192843);
   mainFit1027->SetParError(0,0.5392193);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8150927);
   mainFit1027->SetParError(1,0.02136476);
