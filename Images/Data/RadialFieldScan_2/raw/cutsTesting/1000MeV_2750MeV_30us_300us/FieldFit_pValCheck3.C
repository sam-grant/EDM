...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-53.83247);
   Graph_Graph01031->SetMaximum(52.7412);
   ...
   mainFit1032->SetChisquare(4.461031);
   ...
   mainFit1032->SetParameter(0,-0.3160463);
   mainFit1032->SetParError(0,0.5762721);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8337399);
   mainFit1032->SetParError(1,0.01711876);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.316#pm0.576");
   pt_LaTex = pt->AddText("#minus0.379#pm0.689");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3790706,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3790706,-53.83247,0.3790706,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.461031);
   ...
   mainFit1033->SetParameter(0,-0.3160463);
   mainFit1033->SetParError(0,0.5762721);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8337399);
   mainFit1033->SetParError(1,0.01711876);
