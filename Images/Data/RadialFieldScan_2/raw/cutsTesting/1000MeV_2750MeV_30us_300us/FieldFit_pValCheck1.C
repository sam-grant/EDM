...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-53.83247);
   Graph_Graph01027->SetMaximum(52.7412);
   ...
   mainFit1028->SetChisquare(0.1834714);
   ...
   mainFit1028->SetParameter(0,0.2668855);
   mainFit1028->SetParError(0,0.5598246);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8498954);
   mainFit1028->SetParError(1,0.01847008);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0612");
   pt_LaTex = pt->AddText(" 0.85#pm0.0185");
   pt_LaTex = pt->AddText("0.267#pm 0.56");
   pt_LaTex = pt->AddText("0.314#pm0.658");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3140216,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3140216,-53.83247,-0.3140216,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1834714);
   ...
   mainFit1029->SetParameter(0,0.2668855);
   mainFit1029->SetParError(0,0.5598246);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8498954);
   mainFit1029->SetParError(1,0.01847008);
