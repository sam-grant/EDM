...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.71124,70,61.37432);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.20268);
   Graph_Graph01035->SetMaximum(50.86576);
   ...
   mainFit1036->SetChisquare(4.344896);
   ...
   mainFit1036->SetParameter(0,-0.1922556);
   mainFit1036->SetParError(0,0.5246286);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8298037);
   mainFit1036->SetParError(1,0.01815986);
   ...
   pt_LaTex = pt->AddText(" 0.83#pm0.0182");
   pt_LaTex = pt->AddText("#minus0.192#pm0.525");
   pt_LaTex = pt->AddText("#minus0.232#pm0.631");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.231688,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.231688,-33.20268,0.231688,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.344896);
   ...
   mainFit1037->SetParameter(0,-0.1922556);
   mainFit1037->SetParError(0,0.5246286);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8298037);
   mainFit1037->SetParError(1,0.01815986);
