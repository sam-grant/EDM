...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-53.83247);
   Graph_Graph01033->SetMaximum(52.7412);
   ...
   mainFit1034->SetChisquare(4.479982);
   ...
   mainFit1034->SetParameter(0,-0.3160551);
   mainFit1034->SetParError(0,0.6266483);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8347946);
   mainFit1034->SetParError(1,0.02067719);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0207");
   pt_LaTex = pt->AddText("#minus0.316#pm0.627");
   pt_LaTex = pt->AddText("#minus0.379#pm0.746");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3786023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3786023,-53.83247,0.3786023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.479982);
   ...
   mainFit1035->SetParameter(0,-0.3160551);
   mainFit1035->SetParError(0,0.6266483);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8347946);
   mainFit1035->SetParError(1,0.02067719);
