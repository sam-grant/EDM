...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01606951);
   Graph_Graph11015->SetMaximum(0.05175695);
   ...
   Graph_Graph21016->SetMinimum(-0.00881585);
   Graph_Graph21016->SetMaximum(0.01038681);
   ...
   Graph_Graph31017->SetMinimum(-0.02701259);
   Graph_Graph31017->SetMaximum(0.02230464);
   ...
   Graph_Graph41018->SetMinimum(-0.01833846);
   Graph_Graph41018->SetMaximum(0.0248654);
   ...
   Graph_Graph51019->SetMinimum(-0.00624706);
   Graph_Graph51019->SetMaximum(0.008353295);
