...
//=========  (Wed Apr 28 15:13:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-53.83247);
   Graph_Graph01029->SetMaximum(52.7412);
   ...
   mainFit1030->SetChisquare(3.605258);
   ...
   mainFit1030->SetParameter(0,-0.458129);
   mainFit1030->SetParError(0,0.5438499);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8316024);
   mainFit1030->SetParError(1,0.01658929);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.0166");
   pt_LaTex = pt->AddText("#minus0.458#pm0.544");
   pt_LaTex = pt->AddText("#minus0.551#pm0.653");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5508991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5508991,-53.83247,0.5508991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.605258);
   ...
   mainFit1031->SetParameter(0,-0.458129);
   mainFit1031->SetParError(0,0.5438499);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8316024);
   mainFit1031->SetParError(1,0.01658929);
