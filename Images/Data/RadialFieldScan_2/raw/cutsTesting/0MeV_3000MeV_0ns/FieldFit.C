...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.27506);
   Graph_Graph01020->SetMaximum(50.5702);
   ...
   mainFit1021->SetChisquare(62.10682);
   ...
   mainFit1021->SetParameter(0,-1.395101);
   mainFit1021->SetParError(0,0.303867);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8819968);
   mainFit1021->SetParError(1,0.01001623);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 15.5");
   pt_LaTex = pt->AddText("0.882#pm 0.01");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.304");
   pt_LaTex = pt->AddText("#minus1.58#pm0.342");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.581753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.581753,-49.27506,1.581753,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(62.10682);
   ...
   mainFit1022->SetParameter(0,-1.395101);
   mainFit1022->SetParError(0,0.303867);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8819968);
   mainFit1022->SetParError(1,0.01001623);
