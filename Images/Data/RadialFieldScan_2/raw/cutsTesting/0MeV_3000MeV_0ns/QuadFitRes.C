...
//=========  (Fri Apr 23 18:37:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03097764);
   Graph_Graph11015->SetMaximum(0.01711573);
   ...
   Graph_Graph21016->SetMinimum(-0.0136982);
   Graph_Graph21016->SetMaximum(0.01591625);
   ...
   Graph_Graph31017->SetMinimum(-0.01013301);
   Graph_Graph31017->SetMaximum(0.01848115);
   ...
   Graph_Graph41018->SetMinimum(-0.02589805);
   Graph_Graph41018->SetMaximum(0.0439821);
   ...
   Graph_Graph51019->SetMinimum(-0.0213828);
   Graph_Graph51019->SetMaximum(0.01603279);
