...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.27506);
   Graph_Graph01027->SetMaximum(50.5702);
   ...
   mainFit1028->SetChisquare(46.19911);
   ...
   mainFit1028->SetParameter(0,-2.006414);
   mainFit1028->SetParError(0,0.3403331);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8621532);
   mainFit1028->SetParError(1,0.01118365);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 15.4");
   pt_LaTex = pt->AddText("0.862#pm0.0112");
   pt_LaTex = pt->AddText("#minus2.01#pm 0.34");
   pt_LaTex = pt->AddText("#minus2.33#pm0.398");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.327213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.327213,-49.27506,2.327213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(46.19911);
   ...
   mainFit1029->SetParameter(0,-2.006414);
   mainFit1029->SetParError(0,0.3403331);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8621532);
   mainFit1029->SetParError(1,0.01118365);
