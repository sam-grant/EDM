...
//=========  (Fri Apr 23 18:37:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(55.44814);
   ...
   quadLineFit1002->SetParameter(0,74.65826);
   quadLineFit1002->SetParError(0,0.04624466);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.47519);
   quadLineFit1002->SetParError(1,0.7745747);
   ...
   quadLineFit1003->SetChisquare(55.44814);
   ...
   quadLineFit1003->SetParameter(0,74.65826);
   quadLineFit1003->SetParError(0,0.04624466);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.47519);
   quadLineFit1003->SetParError(1,0.7745747);
   ...
   Graph_30_ppm1003->SetMinimum(75.72454);
   ...
   quadLineFit1004->SetChisquare(6.932909);
   ...
   quadLineFit1004->SetParameter(0,74.41122);
   quadLineFit1004->SetParError(0,0.0390962);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,27.09);
   quadLineFit1004->SetParError(1,0.6414296);
   ...
   quadLineFit1005->SetChisquare(6.932909);
   ...
   quadLineFit1005->SetParameter(0,74.41122);
   quadLineFit1005->SetParError(0,0.0390962);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,27.09);
   quadLineFit1005->SetParError(1,0.6414296);
   ...
   Graph_10_ppm1005->SetMinimum(74.72681);
   Graph_10_ppm1005->SetMaximum(74.96944);
   ...
   quadLineFit1006->SetChisquare(4.190668);
   ...
   quadLineFit1006->SetParameter(0,74.30144);
   quadLineFit1006->SetParError(0,0.04605935);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.721321);
   quadLineFit1006->SetParError(1,0.7460878);
   ...
   quadLineFit1007->SetChisquare(4.190668);
   ...
   quadLineFit1007->SetParameter(0,74.30144);
   quadLineFit1007->SetParError(0,0.04605935);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.721321);
   quadLineFit1007->SetParError(1,0.7460878);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.41395);
   Graph_mI10_ppm1007->SetMaximum(73.76874);
   ...
   quadLineFit1008->SetChisquare(3.726903);
   ...
   quadLineFit1008->SetParameter(0,74.43662);
   quadLineFit1008->SetParError(0,0.04029477);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-13.66741);
   quadLineFit1008->SetParError(1,0.6549354);
   ...
   quadLineFit1009->SetChisquare(3.726903);
   ...
   quadLineFit1009->SetParameter(0,74.43662);
   quadLineFit1009->SetParError(0,0.04029477);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-13.66741);
   quadLineFit1009->SetParError(1,0.6549354);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12444);
   Graph_mI30_ppm1009->SetMaximum(72.84146);
   ...
   quadLineFit1010->SetChisquare(13.71233);
   ...
   quadLineFit1010->SetParameter(0,74.21579);
   quadLineFit1010->SetParError(0,0.03776352);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.99664);
   quadLineFit1010->SetParError(1,0.6527341);
   ...
   quadLineFit1011->SetChisquare(13.71233);
   ...
   quadLineFit1011->SetParameter(0,74.21579);
   quadLineFit1011->SetParError(0,0.03776352);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.99664);
   quadLineFit1011->SetParError(1,0.6527341);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.37152);
   Graph_mI50_ppm1011->SetMaximum(71.93206);
   ...
   quadLineFit1012->SetChisquare(6.681393);
   ...
   quadLineFit1012->SetParameter(0,73.89301);
   quadLineFit1012->SetParError(0,0.076187);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.59195);
   quadLineFit1012->SetParError(1,1.362674);
   ...
   quadLineFit1013->SetChisquare(6.681393);
   ...
   quadLineFit1013->SetParameter(0,73.89301);
   quadLineFit1013->SetParError(0,0.076187);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.59195);
   quadLineFit1013->SetParError(1,1.362674);
