...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.27506);
   Graph_Graph01023->SetMaximum(50.5702);
   ...
   mainFit1024->SetChisquare(62.10682);
   ...
   mainFit1024->SetParameter(0,-1.395101);
   mainFit1024->SetParError(0,0.303867);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8819968);
   mainFit1024->SetParError(1,0.01001623);
   ...
   mainFit1025->SetChisquare(62.10682);
   ...
   mainFit1025->SetParameter(0,-1.395101);
   mainFit1025->SetParError(0,0.303867);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8819968);
   mainFit1025->SetParError(1,0.01001623);
