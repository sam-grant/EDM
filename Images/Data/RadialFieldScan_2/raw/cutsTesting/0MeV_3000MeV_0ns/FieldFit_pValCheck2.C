...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.27506);
   Graph_Graph01029->SetMaximum(50.5702);
   ...
   mainFit1030->SetChisquare(58.48405);
   ...
   mainFit1030->SetParameter(0,-1.639603);
   mainFit1030->SetParError(0,0.3299041);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8805446);
   mainFit1030->SetParError(1,0.01004523);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 19.5");
   pt_LaTex = pt->AddText("0.881#pm 0.01");
   pt_LaTex = pt->AddText("#minus1.64#pm 0.33");
   pt_LaTex = pt->AddText("#minus1.86#pm0.373");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.862032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.862032,-49.27506,1.862032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(58.48405);
   ...
   mainFit1031->SetParameter(0,-1.639603);
   mainFit1031->SetParError(0,0.3299041);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8805446);
   mainFit1031->SetParError(1,0.01004523);
