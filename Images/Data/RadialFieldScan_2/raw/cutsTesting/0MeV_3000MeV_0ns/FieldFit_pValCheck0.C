...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.12614,50,44.90294);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.82323);
   Graph_Graph01025->SetMaximum(34.60003);
   ...
   mainFit1026->SetChisquare(57.15313);
   ...
   mainFit1026->SetParameter(0,-1.12053);
   mainFit1026->SetParError(0,0.3279542);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9002578);
   mainFit1026->SetParError(1,0.01294763);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 19.1");
   pt_LaTex = pt->AddText("  0.9#pm0.0129");
   pt_LaTex = pt->AddText("#minus1.12#pm0.328");
   pt_LaTex = pt->AddText("#minus1.24#pm0.367");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.244677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.244677,-47.82323,1.244677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(57.15313);
   ...
   mainFit1027->SetParameter(0,-1.12053);
   mainFit1027->SetParError(0,0.3279542);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9002578);
   mainFit1027->SetParError(1,0.01294763);
