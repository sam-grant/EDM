...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.37415,70,59.97454);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.73928);
   Graph_Graph01035->SetMaximum(49.33967);
   ...
   mainFit1036->SetChisquare(38.32755);
   ...
   mainFit1036->SetParameter(0,-1.86448);
   mainFit1036->SetParError(0,0.3187479);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9041523);
   mainFit1036->SetParError(1,0.01099852);
   ...
   pt_LaTex = pt->AddText("0.904#pm0.011");
   pt_LaTex = pt->AddText("#minus1.86#pm0.319");
   pt_LaTex = pt->AddText("#minus2.06#pm0.347");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.06213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.06213,-35.73928,2.06213,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(38.32755);
   ...
   mainFit1037->SetParameter(0,-1.86448);
   mainFit1037->SetParError(0,0.3187479);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9041523);
   mainFit1037->SetParError(1,0.01099852);
