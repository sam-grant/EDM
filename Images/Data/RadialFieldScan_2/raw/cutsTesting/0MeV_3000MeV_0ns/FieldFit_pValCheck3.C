...
//=========  (Fri Apr 23 18:37:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.75572,75,63.05086);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-49.27506);
   Graph_Graph01031->SetMaximum(50.5702);
   ...
   mainFit1032->SetChisquare(24.49653);
   ...
   mainFit1032->SetParameter(0,-0.3364962);
   mainFit1032->SetParError(0,0.349473);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.865798);
   mainFit1032->SetParError(1,0.01035865);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 8.17");
   pt_LaTex = pt->AddText("0.866#pm0.0104");
   pt_LaTex = pt->AddText("#minus0.336#pm0.349");
   pt_LaTex = pt->AddText("#minus0.389#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3886544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3886544,-49.27506,0.3886544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(24.49653);
   ...
   mainFit1033->SetParameter(0,-0.3364962);
   mainFit1033->SetParError(0,0.349473);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.865798);
   mainFit1033->SetParError(1,0.01035865);
