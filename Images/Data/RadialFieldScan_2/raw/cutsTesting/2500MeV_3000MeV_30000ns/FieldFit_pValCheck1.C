...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.52012);
   Graph_Graph01027->SetMaximum(51.95544);
   ...
   mainFit1028->SetChisquare(0.8584283);
   ...
   mainFit1028->SetParameter(0,0.1282238);
   mainFit1028->SetParError(0,1.399755);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7777865);
   mainFit1028->SetParError(1,0.04612437);
   ...
   pt_LaTex = pt->AddText("0.778#pm0.0461");
   pt_LaTex = pt->AddText("0.128#pm  1.4");
   pt_LaTex = pt->AddText("0.165#pm  1.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1648574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1648574,-51.52012,-0.1648574,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8584283);
   ...
   mainFit1029->SetParameter(0,0.1282238);
   mainFit1029->SetParError(0,1.399755);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7777865);
   mainFit1029->SetParError(1,0.04612437);
