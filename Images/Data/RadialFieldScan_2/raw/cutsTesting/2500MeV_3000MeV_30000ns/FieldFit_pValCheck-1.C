...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.52012);
   Graph_Graph01023->SetMaximum(51.95544);
   ...
   mainFit1024->SetChisquare(3.393828);
   ...
   mainFit1024->SetParameter(0,-0.8729194);
   mainFit1024->SetParError(0,1.250575);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7451074);
   mainFit1024->SetParError(1,0.04131195);
   ...
   mainFit1025->SetChisquare(3.393828);
   ...
   mainFit1025->SetParameter(0,-0.8729194);
   mainFit1025->SetParError(0,1.250575);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7451074);
   mainFit1025->SetParError(1,0.04131195);
