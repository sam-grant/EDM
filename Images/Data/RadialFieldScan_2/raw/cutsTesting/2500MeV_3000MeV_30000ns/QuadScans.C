...
//=========  (Wed Apr 21 23:02:12 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.90139);
   ...
   quadLineFit1002->SetParameter(0,75.3496);
   quadLineFit1002->SetParError(0,0.190195);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.14319);
   quadLineFit1002->SetParError(1,3.189288);
   ...
   quadLineFit1003->SetChisquare(1.90139);
   ...
   quadLineFit1003->SetParameter(0,75.3496);
   quadLineFit1003->SetParError(0,0.190195);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.14319);
   quadLineFit1003->SetParError(1,3.189288);
   ...
   Graph_30_ppm1003->SetMinimum(76.4433);
   Graph_30_ppm1003->SetMaximum(76.97963);
   ...
   quadLineFit1004->SetChisquare(0.07991246);
   ...
   quadLineFit1004->SetParameter(0,75.59531);
   quadLineFit1004->SetParError(0,0.1602051);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,18.16275);
   quadLineFit1004->SetParError(1,2.633376);
   ...
   quadLineFit1005->SetChisquare(0.07991246);
   ...
   quadLineFit1005->SetParameter(0,75.59531);
   quadLineFit1005->SetParError(0,0.1602051);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,18.16275);
   quadLineFit1005->SetParError(1,2.633376);
   ...
   Graph_10_ppm1005->SetMinimum(75.5373);
   Graph_10_ppm1005->SetMaximum(75.81649);
   ...
   quadLineFit1006->SetChisquare(4.276788e-05);
   ...
   quadLineFit1006->SetParameter(0,75.23306);
   quadLineFit1006->SetParError(0,0.187897);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.189492);
   quadLineFit1006->SetParError(1,3.046748);
   ...
   quadLineFit1007->SetChisquare(4.276788e-05);
   ...
   quadLineFit1007->SetParameter(0,75.23306);
   quadLineFit1007->SetParError(0,0.187897);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.189492);
   quadLineFit1007->SetParError(1,3.046748);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.49796);
   Graph_mI10_ppm1007->SetMaximum(74.85174);
   ...
   quadLineFit1008->SetChisquare(1.064662);
   ...
   quadLineFit1008->SetParameter(0,75.2445);
   quadLineFit1008->SetParError(0,0.1650842);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.390577);
   quadLineFit1008->SetParError(1,2.687246);
   ...
   quadLineFit1009->SetChisquare(1.064662);
   ...
   quadLineFit1009->SetParameter(0,75.2445);
   quadLineFit1009->SetParError(0,0.1650842);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.390577);
   quadLineFit1009->SetParError(1,2.687246);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.32375);
   Graph_mI30_ppm1009->SetMaximum(73.89929);
   ...
   quadLineFit1010->SetChisquare(5.719467);
   ...
   quadLineFit1010->SetParameter(0,74.94868);
   quadLineFit1010->SetParError(0,0.1562399);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.03246);
   quadLineFit1010->SetParError(1,2.703881);
   ...
   quadLineFit1011->SetChisquare(5.719467);
   ...
   quadLineFit1011->SetParameter(0,74.94868);
   quadLineFit1011->SetParError(0,0.1562399);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.03246);
   quadLineFit1011->SetParError(1,2.703881);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.41373);
   Graph_mI50_ppm1011->SetMaximum(73.02181);
   ...
   quadLineFit1012->SetChisquare(0.02312225);
   ...
   quadLineFit1012->SetParameter(0,74.84487);
   quadLineFit1012->SetParError(0,0.3148812);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-37.26364);
   quadLineFit1012->SetParError(1,5.633511);
   ...
   quadLineFit1013->SetChisquare(0.02312225);
   ...
   quadLineFit1013->SetParameter(0,74.84487);
   quadLineFit1013->SetParError(0,0.3148812);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-37.26364);
   quadLineFit1013->SetParError(1,5.633511);
