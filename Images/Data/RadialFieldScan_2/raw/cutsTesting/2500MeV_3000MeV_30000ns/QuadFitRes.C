...
//=========  (Wed Apr 21 23:02:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0144899);
   Graph_Graph11015->SetMaximum(0.007160529);
   ...
   Graph_Graph21016->SetMinimum(-0.0002100457);
   Graph_Graph21016->SetMaximum(0.0001788275);
   ...
   Graph_Graph31017->SetMinimum(-0.03393436);
   Graph_Graph31017->SetMaximum(0.03272537);
   ...
   Graph_Graph41018->SetMinimum(-0.1169002);
   Graph_Graph41018->SetMaximum(0.06049548);
   ...
   Graph_Graph51019->SetMinimum(-0.003884507);
   Graph_Graph51019->SetMaximum(0.005207454);
