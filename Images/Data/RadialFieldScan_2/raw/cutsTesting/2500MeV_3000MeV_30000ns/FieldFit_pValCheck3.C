...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.45457,75,64.88989);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.52012);
   Graph_Graph01031->SetMaximum(51.95544);
   ...
   mainFit1032->SetChisquare(3.179991);
   ...
   mainFit1032->SetParameter(0,-0.5424158);
   mainFit1032->SetParError(0,1.440482);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7400058);
   mainFit1032->SetParError(1,0.04276893);
   ...
   pt_LaTex = pt->AddText(" 0.74#pm0.0428");
   pt_LaTex = pt->AddText("#minus0.542#pm 1.44");
   pt_LaTex = pt->AddText("#minus0.733#pm 1.94");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7329885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7329885,-51.52012,0.7329885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.179991);
   ...
   mainFit1033->SetParameter(0,-0.5424158);
   mainFit1033->SetParError(0,1.440482);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7400058);
   mainFit1033->SetParError(1,0.04276893);
