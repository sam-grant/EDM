...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.52012);
   Graph_Graph01033->SetMaximum(51.95544);
   ...
   mainFit1034->SetChisquare(3.00874);
   ...
   mainFit1034->SetParameter(0,-1.459088);
   mainFit1034->SetParError(0,1.567151);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7643603);
   mainFit1034->SetParError(1,0.05164875);
   ...
   pt_LaTex = pt->AddText("0.764#pm0.0516");
   pt_LaTex = pt->AddText("#minus1.46#pm 1.57");
   pt_LaTex = pt->AddText("#minus1.91#pm 1.99");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.908901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.908901,-51.52012,1.908901,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.00874);
   ...
   mainFit1035->SetParameter(0,-1.459088);
   mainFit1035->SetParError(0,1.567151);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7643603);
   mainFit1035->SetParError(1,0.05164875);
