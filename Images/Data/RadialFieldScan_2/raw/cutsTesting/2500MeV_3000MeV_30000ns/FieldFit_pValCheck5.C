...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.75355,70,60.34969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.54323);
   Graph_Graph01035->SetMaximum(50.13936);
   ...
   mainFit1036->SetChisquare(3.363933);
   ...
   mainFit1036->SetParameter(0,-0.941613);
   mainFit1036->SetParError(0,1.312038);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7483633);
   mainFit1036->SetParError(1,0.04536183);
   ...
   pt_LaTex = pt->AddText("0.748#pm0.0454");
   pt_LaTex = pt->AddText("#minus0.942#pm 1.31");
   pt_LaTex = pt->AddText("#minus1.26#pm 1.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.25823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.25823,-31.54323,1.25823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.363933);
   ...
   mainFit1037->SetParameter(0,-0.941613);
   mainFit1037->SetParError(0,1.312038);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7483633);
   mainFit1037->SetParError(1,0.04536183);
