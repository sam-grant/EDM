...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.82048,50,36.71945);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.26648);
   Graph_Graph01025->SetMaximum(27.16546);
   ...
   mainFit1026->SetChisquare(0.6680229);
   ...
   mainFit1026->SetParameter(0,-1.700426);
   mainFit1026->SetParError(0,1.347221);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.6893632);
   mainFit1026->SetParError(1,0.05334979);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.223");
   pt_LaTex = pt->AddText("0.689#pm0.0533");
   pt_LaTex = pt->AddText(" #minus1.7#pm 1.35");
   pt_LaTex = pt->AddText("#minus2.47#pm 1.99");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.466662,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.466662,-49.26648,2.466662,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.6680229);
   ...
   mainFit1027->SetParameter(0,-1.700426);
   mainFit1027->SetParError(0,1.347221);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.6893632);
   mainFit1027->SetParError(1,0.05334979);
