...
//=========  (Wed Apr 21 23:02:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.52012);
   Graph_Graph01020->SetMaximum(51.95544);
   ...
   mainFit1021->SetChisquare(3.393828);
   ...
   mainFit1021->SetParameter(0,-0.8729194);
   mainFit1021->SetParError(0,1.250575);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7451074);
   mainFit1021->SetParError(1,0.04131195);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.848");
   pt_LaTex = pt->AddText("0.745#pm0.0413");
   pt_LaTex = pt->AddText("#minus0.873#pm 1.25");
   pt_LaTex = pt->AddText("#minus1.17#pm 1.67");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.171535,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.171535,-51.52012,1.171535,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.393828);
   ...
   mainFit1022->SetParameter(0,-0.8729194);
   mainFit1022->SetParError(0,1.250575);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7451074);
   mainFit1022->SetParError(1,0.04131195);
