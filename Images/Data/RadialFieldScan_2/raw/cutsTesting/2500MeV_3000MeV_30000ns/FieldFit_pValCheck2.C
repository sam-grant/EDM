...
//=========  (Wed Apr 21 23:02:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.52012);
   Graph_Graph01029->SetMaximum(51.95544);
   ...
   mainFit1030->SetChisquare(3.345413);
   ...
   mainFit1030->SetParameter(0,-0.9901658);
   mainFit1030->SetParError(0,1.359239);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7444411);
   mainFit1030->SetParError(1,0.04142807);
   ...
   pt_LaTex = pt->AddText("0.744#pm0.0414");
   pt_LaTex = pt->AddText("#minus0.99#pm 1.36");
   pt_LaTex = pt->AddText("#minus1.33#pm 1.82");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.330079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.330079,-51.52012,1.330079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.345413);
   ...
   mainFit1031->SetParameter(0,-0.9901658);
   mainFit1031->SetParError(0,1.359239);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7444411);
   mainFit1031->SetParError(1,0.04142807);
