...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01171304);
   Graph_Graph11015->SetMaximum(0.03708217);
   ...
   Graph_Graph21016->SetMinimum(-0.009244472);
   Graph_Graph21016->SetMaximum(0.01088928);
   ...
   Graph_Graph31017->SetMinimum(-0.02363918);
   Graph_Graph31017->SetMaximum(0.02038423);
   ...
   Graph_Graph41018->SetMinimum(-0.01588095);
   Graph_Graph41018->SetMaximum(0.01798169);
   ...
   Graph_Graph51019->SetMinimum(-0.007980802);
   Graph_Graph51019->SetMaximum(0.01067618);
