...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-53.83477);
   Graph_Graph01020->SetMaximum(52.6889);
   ...
   mainFit1021->SetChisquare(5.409856);
   ...
   mainFit1021->SetParameter(0,-0.3448054);
   mainFit1021->SetParError(0,0.4754212);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8356815);
   mainFit1021->SetParError(1,0.01564316);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0156");
   pt_LaTex = pt->AddText("#minus0.345#pm0.475");
   pt_LaTex = pt->AddText("#minus0.413#pm0.568");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4126039,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4126039,-53.83477,0.4126039,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.409856);
   ...
   mainFit1022->SetParameter(0,-0.3448054);
   mainFit1022->SetParError(0,0.4754212);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8356815);
   mainFit1022->SetParError(1,0.01564316);
