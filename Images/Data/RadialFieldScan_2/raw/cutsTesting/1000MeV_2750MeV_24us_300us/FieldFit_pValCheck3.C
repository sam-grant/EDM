...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-67.15023,75,66.00436);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-53.83477);
   Graph_Graph01031->SetMaximum(52.6889);
   ...
   mainFit1032->SetChisquare(5.335285);
   ...
   mainFit1032->SetParameter(0,-0.4190572);
   mainFit1032->SetParError(0,0.5476854);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8368344);
   mainFit1032->SetParError(1,0.01620287);
   ...
   pt_LaTex = pt->AddText("0.837#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.419#pm0.548");
   pt_LaTex = pt->AddText("#minus0.501#pm0.652");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5007649,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5007649,-53.83477,0.5007649,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.335285);
   ...
   mainFit1033->SetParameter(0,-0.4190572);
   mainFit1033->SetParError(0,0.5476854);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8368344);
   mainFit1033->SetParError(1,0.01620287);
