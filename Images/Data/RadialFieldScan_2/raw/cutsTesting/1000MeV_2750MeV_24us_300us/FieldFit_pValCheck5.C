...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-43.96707,70,61.36773);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.43359);
   Graph_Graph01035->SetMaximum(50.83424);
   ...
   mainFit1036->SetChisquare(5.281843);
   ...
   mainFit1036->SetParameter(0,-0.2906427);
   mainFit1036->SetParError(0,0.4989405);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8331519);
   mainFit1036->SetParError(1,0.01716673);
   ...
   pt_LaTex = pt->AddText("0.833#pm0.0172");
   pt_LaTex = pt->AddText("#minus0.291#pm0.499");
   pt_LaTex = pt->AddText("#minus0.349#pm0.597");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3488472,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3488472,-33.43359,0.3488472,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.281843);
   ...
   mainFit1037->SetParameter(0,-0.2906427);
   mainFit1037->SetParError(0,0.4989405);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8331519);
   mainFit1037->SetParError(1,0.01716673);
