...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-53.83477);
   Graph_Graph01027->SetMaximum(52.6889);
   ...
   mainFit1028->SetChisquare(0.2329176);
   ...
   mainFit1028->SetParameter(0,0.1922211);
   mainFit1028->SetParError(0,0.5307856);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8530323);
   mainFit1028->SetParError(1,0.01740291);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0776");
   pt_LaTex = pt->AddText("0.853#pm0.0174");
   pt_LaTex = pt->AddText("0.192#pm0.531");
   pt_LaTex = pt->AddText("0.225#pm0.622");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2253387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2253387,-53.83477,-0.2253387,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2329176);
   ...
   mainFit1029->SetParameter(0,0.1922211);
   mainFit1029->SetParError(0,0.5307856);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8530323);
   mainFit1029->SetParError(1,0.01740291);
