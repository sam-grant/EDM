...
//=========  (Wed Apr 28 14:44:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.259717);
   ...
   quadLineFit1002->SetParameter(0,74.60965);
   quadLineFit1002->SetParError(0,0.07128753);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.61648);
   quadLineFit1002->SetParError(1,1.195449);
   ...
   quadLineFit1003->SetChisquare(2.259717);
   ...
   quadLineFit1003->SetParameter(0,74.60965);
   quadLineFit1003->SetParError(0,0.07128753);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.61648);
   quadLineFit1003->SetParError(1,1.195449);
   ...
   Graph_30_ppm1003->SetMinimum(75.78463);
   Graph_30_ppm1003->SetMaximum(76.36834);
   ...
   quadLineFit1004->SetChisquare(3.062199);
   ...
   quadLineFit1004->SetParameter(0,74.67586);
   quadLineFit1004->SetParError(0,0.06106582);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.91044);
   quadLineFit1004->SetParError(1,1.003633);
   ...
   quadLineFit1005->SetChisquare(3.062199);
   ...
   quadLineFit1005->SetParameter(0,74.67586);
   quadLineFit1005->SetParError(0,0.06106582);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.91044);
   quadLineFit1005->SetParError(1,1.003633);
   ...
   Graph_10_ppm1005->SetMinimum(74.84305);
   Graph_10_ppm1005->SetMaximum(75.10944);
   ...
   quadLineFit1006->SetChisquare(0.788843);
   ...
   quadLineFit1006->SetParameter(0,74.40453);
   quadLineFit1006->SetParError(0,0.07154303);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.179186);
   quadLineFit1006->SetParError(1,1.16031);
   ...
   quadLineFit1007->SetChisquare(0.788843);
   ...
   quadLineFit1007->SetParameter(0,74.40453);
   quadLineFit1007->SetParError(0,0.07154303);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.179186);
   quadLineFit1007->SetParError(1,1.16031);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72026);
   Graph_mI10_ppm1007->SetMaximum(73.98165);
   ...
   quadLineFit1008->SetChisquare(3.336672);
   ...
   quadLineFit1008->SetParameter(0,74.36542);
   quadLineFit1008->SetParError(0,0.06282453);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.461994);
   quadLineFit1008->SetParError(1,1.022577);
   ...
   quadLineFit1009->SetChisquare(3.336672);
   ...
   quadLineFit1009->SetParameter(0,74.36542);
   quadLineFit1009->SetParError(0,0.06282453);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.461994);
   quadLineFit1009->SetParError(1,1.022577);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40522);
   Graph_mI30_ppm1009->SetMaximum(73.05958);
   ...
   quadLineFit1010->SetChisquare(2.634489);
   ...
   quadLineFit1010->SetParameter(0,74.30449);
   quadLineFit1010->SetParError(0,0.05941385);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.383);
   quadLineFit1010->SetParError(1,1.028269);
   ...
   quadLineFit1011->SetChisquare(2.634489);
   ...
   quadLineFit1011->SetParameter(0,74.30449);
   quadLineFit1011->SetParError(0,0.05941385);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.383);
   quadLineFit1011->SetParError(1,1.028269);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51639);
   Graph_mI50_ppm1011->SetMaximum(72.1326);
   ...
   quadLineFit1012->SetChisquare(0.6740442);
   ...
   quadLineFit1012->SetParameter(0,74.2678);
   quadLineFit1012->SetParError(0,0.1199412);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-42.8117);
   quadLineFit1012->SetParError(1,2.146092);
   ...
   quadLineFit1013->SetChisquare(0.6740442);
   ...
   quadLineFit1013->SetParameter(0,74.2678);
   quadLineFit1013->SetParError(0,0.1199412);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-42.8117);
   quadLineFit1013->SetParError(1,2.146092);
