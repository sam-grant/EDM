...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-53.83477);
   Graph_Graph01023->SetMaximum(52.6889);
   ...
   mainFit1024->SetChisquare(5.409856);
   ...
   mainFit1024->SetParameter(0,-0.3448054);
   mainFit1024->SetParError(0,0.4754212);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8356815);
   mainFit1024->SetParError(1,0.01564316);
   ...
   mainFit1025->SetChisquare(5.409856);
   ...
   mainFit1025->SetParameter(0,-0.3448054);
   mainFit1025->SetParError(0,0.4754212);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8356815);
   mainFit1025->SetParError(1,0.01564316);
