...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-53.83477);
   Graph_Graph01029->SetMaximum(52.6889);
   ...
   mainFit1030->SetChisquare(4.194574);
   ...
   mainFit1030->SetParameter(0,-0.5670388);
   mainFit1030->SetParError(0,0.5164002);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8344394);
   mainFit1030->SetParError(1,0.01568349);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  1.4");
   pt_LaTex = pt->AddText("0.834#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.567#pm0.516");
   pt_LaTex = pt->AddText("#minus0.68#pm0.617");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6795446,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6795446,-53.83477,0.6795446,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.194574);
   ...
   mainFit1031->SetParameter(0,-0.5670388);
   mainFit1031->SetParError(0,0.5164002);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8344394);
   mainFit1031->SetParError(1,0.01568349);
