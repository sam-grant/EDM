...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-53.83477);
   Graph_Graph01033->SetMaximum(52.6889);
   ...
   mainFit1034->SetChisquare(5.407915);
   ...
   mainFit1034->SetParameter(0,-0.3606853);
   mainFit1034->SetParError(0,0.5965758);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8361992);
   mainFit1034->SetParError(1,0.01956412);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.361#pm0.597");
   pt_LaTex = pt->AddText("#minus0.431#pm0.709");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4313389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4313389,-53.83477,0.4313389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.407915);
   ...
   mainFit1035->SetParameter(0,-0.3606853);
   mainFit1035->SetParError(0,0.5965758);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8361992);
   mainFit1035->SetParError(1,0.01956412);
