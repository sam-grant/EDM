...
//=========  (Wed Apr 28 14:44:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.17576,50,41.13204);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.84498);
   Graph_Graph01025->SetMaximum(30.80126);
   ...
   mainFit1026->SetChisquare(3.477212);
   ...
   mainFit1026->SetParameter(0,-0.6126865);
   mainFit1026->SetParError(0,0.512977);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8176498);
   mainFit1026->SetParError(1,0.02031695);
   ...
   pt_LaTex = pt->AddText("0.818#pm0.0203");
   pt_LaTex = pt->AddText("#minus0.613#pm0.513");
   pt_LaTex = pt->AddText("#minus0.749#pm 0.63");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.7493263,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7493263,-51.84498,0.7493263,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.477212);
   ...
   mainFit1027->SetParameter(0,-0.6126865);
   mainFit1027->SetParError(0,0.512977);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8176498);
   mainFit1027->SetParError(1,0.02031695);
