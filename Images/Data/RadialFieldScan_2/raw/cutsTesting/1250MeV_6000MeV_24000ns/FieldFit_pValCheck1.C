...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.84688);
   Graph_Graph01027->SetMaximum(50.72728);
   ...
   mainFit1028->SetChisquare(0.430088);
   ...
   mainFit1028->SetParameter(0,0.4474209);
   mainFit1028->SetParError(0,0.5509609);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8142204);
   mainFit1028->SetParError(1,0.01816909);
   ...
   pt_LaTex = pt->AddText("0.814#pm0.0182");
   pt_LaTex = pt->AddText("0.447#pm0.551");
   pt_LaTex = pt->AddText(" 0.55#pm0.676");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.5495083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.5495083,-51.84688,-0.5495083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.430088);
   ...
   mainFit1029->SetParameter(0,0.4474209);
   mainFit1029->SetParError(0,0.5509609);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8142204);
   mainFit1029->SetParError(1,0.01816909);
