...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.84688);
   Graph_Graph01023->SetMaximum(50.72728);
   ...
   mainFit1024->SetChisquare(3.116174);
   ...
   mainFit1024->SetParameter(0,0.0411926);
   mainFit1024->SetParError(0,0.4920592);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8009483);
   mainFit1024->SetParError(1,0.01626462);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.779");
   pt_LaTex = pt->AddText("0.801#pm0.0163");
   pt_LaTex = pt->AddText("0.0412#pm0.492");
   pt_LaTex = pt->AddText("0.0514#pm0.615");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.05142979,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.05142979,-51.84688,-0.05142979,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.116174);
   ...
   mainFit1025->SetParameter(0,0.0411926);
   mainFit1025->SetParError(0,0.4920592);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8009483);
   mainFit1025->SetParError(1,0.01626462);
