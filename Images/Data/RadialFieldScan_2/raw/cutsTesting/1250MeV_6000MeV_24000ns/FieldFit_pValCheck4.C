...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.84688);
   Graph_Graph01033->SetMaximum(50.72728);
   ...
   mainFit1034->SetChisquare(3.082659);
   ...
   mainFit1034->SetParameter(0,0.109191);
   mainFit1034->SetParError(0,0.6165111);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7987143);
   mainFit1034->SetParError(1,0.02033359);
   ...
   pt_LaTex = pt->AddText("0.799#pm0.0203");
   pt_LaTex = pt->AddText("0.109#pm0.617");
   pt_LaTex = pt->AddText("0.137#pm0.774");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1367084,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1367084,-51.84688,-0.1367084,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.082659);
   ...
   mainFit1035->SetParameter(0,0.109191);
   mainFit1035->SetParError(0,0.6165111);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7987143);
   mainFit1035->SetParError(1,0.02033359);
