...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.52435);
   ...
   quadLineFit1002->SetParameter(0,74.77603);
   quadLineFit1002->SetParError(0,0.07501022);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.92128);
   quadLineFit1002->SetParError(1,1.258153);
   ...
   quadLineFit1003->SetChisquare(1.52435);
   ...
   quadLineFit1003->SetParameter(0,74.77603);
   quadLineFit1003->SetParError(0,0.07501022);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.92128);
   quadLineFit1003->SetParError(1,1.258153);
   ...
   Graph_30_ppm1003->SetMinimum(75.8947);
   Graph_30_ppm1003->SetMaximum(76.46518);
   ...
   quadLineFit1004->SetChisquare(4.304392);
   ...
   quadLineFit1004->SetParameter(0,74.78474);
   quadLineFit1004->SetParError(0,0.0631013);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.72492);
   quadLineFit1004->SetParError(1,1.037256);
   ...
   quadLineFit1005->SetChisquare(4.304392);
   ...
   quadLineFit1005->SetParameter(0,74.78474);
   quadLineFit1005->SetParError(0,0.0631013);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.72492);
   quadLineFit1005->SetParError(1,1.037256);
   ...
   Graph_10_ppm1005->SetMinimum(74.97581);
   Graph_10_ppm1005->SetMaximum(75.22761);
   ...
   quadLineFit1006->SetChisquare(0.3833762);
   ...
   quadLineFit1006->SetParameter(0,74.5695);
   quadLineFit1006->SetParError(0,0.07397707);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.568293);
   quadLineFit1006->SetParError(1,1.199825);
   ...
   quadLineFit1007->SetChisquare(0.3833762);
   ...
   quadLineFit1007->SetParameter(0,74.5695);
   quadLineFit1007->SetParError(0,0.07397707);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.568293);
   quadLineFit1007->SetParError(1,1.199825);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.90594);
   Graph_mI10_ppm1007->SetMaximum(74.15924);
   ...
   quadLineFit1008->SetChisquare(11.85668);
   ...
   quadLineFit1008->SetParameter(0,74.45678);
   quadLineFit1008->SetParError(0,0.06491415);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.179343);
   quadLineFit1008->SetParError(1,1.056666);
   ...
   quadLineFit1009->SetChisquare(11.85668);
   ...
   quadLineFit1009->SetParameter(0,74.45678);
   quadLineFit1009->SetParError(0,0.06491415);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.179343);
   quadLineFit1009->SetParError(1,1.056666);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.6192);
   Graph_mI30_ppm1009->SetMaximum(73.23938);
   ...
   quadLineFit1010->SetChisquare(0.02470061);
   ...
   quadLineFit1010->SetParameter(0,74.41408);
   quadLineFit1010->SetParError(0,0.06140655);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.12569);
   quadLineFit1010->SetParError(1,1.0628);
   ...
   quadLineFit1011->SetChisquare(0.02470061);
   ...
   quadLineFit1011->SetParameter(0,74.41408);
   quadLineFit1011->SetParError(0,0.06140655);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.12569);
   quadLineFit1011->SetParError(1,1.0628);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.72687);
   Graph_mI50_ppm1011->SetMaximum(72.32077);
   ...
   quadLineFit1012->SetChisquare(1.47584);
   ...
   quadLineFit1012->SetParameter(0,74.37213);
   quadLineFit1012->SetParError(0,0.1237876);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.08424);
   quadLineFit1012->SetParError(1,2.214796);
   ...
   quadLineFit1013->SetChisquare(1.47584);
   ...
   quadLineFit1013->SetParameter(0,74.37213);
   quadLineFit1013->SetParError(0,0.1237876);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.08424);
   quadLineFit1013->SetParError(1,2.214796);
