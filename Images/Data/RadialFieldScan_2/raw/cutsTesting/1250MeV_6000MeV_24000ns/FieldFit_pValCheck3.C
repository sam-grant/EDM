...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-64.66865,75,63.54905);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-51.84688);
   Graph_Graph01031->SetMaximum(50.72728);
   ...
   mainFit1032->SetChisquare(2.359069);
   ...
   mainFit1032->SetParameter(0,-0.2035539);
   mainFit1032->SetParError(0,0.5667809);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8047266);
   mainFit1032->SetParError(1,0.01683428);
   ...
   pt_LaTex = pt->AddText("0.805#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.204#pm0.567");
   pt_LaTex = pt->AddText("#minus0.253#pm0.703");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2529479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2529479,-51.84688,0.2529479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.359069);
   ...
   mainFit1033->SetParameter(0,-0.2035539);
   mainFit1033->SetParError(0,0.5667809);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8047266);
   mainFit1033->SetParError(1,0.01683428);
