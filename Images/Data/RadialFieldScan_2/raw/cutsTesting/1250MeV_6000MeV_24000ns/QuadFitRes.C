...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02178037);
   Graph_Graph11015->SetMaximum(0.03927191);
   ...
   Graph_Graph21016->SetMinimum(-0.006666391);
   Graph_Graph21016->SetMaximum(0.007852471);
   ...
   Graph_Graph31017->SetMinimum(-0.04969052);
   Graph_Graph31017->SetMaximum(0.03897523);
   ...
   Graph_Graph41018->SetMinimum(-0.00125583);
   Graph_Graph41018->SetMaximum(0.002167006);
   ...
   Graph_Graph51019->SetMinimum(-0.01221979);
   Graph_Graph51019->SetMaximum(0.01631743);
