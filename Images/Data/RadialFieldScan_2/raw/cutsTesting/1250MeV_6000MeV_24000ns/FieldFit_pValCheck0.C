...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-60.06434,50,40.52748);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.00516);
   Graph_Graph01025->SetMaximum(30.4683);
   ...
   mainFit1026->SetChisquare(2.258791);
   ...
   mainFit1026->SetParameter(0,-0.141626);
   mainFit1026->SetParError(0,0.530186);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7886541);
   mainFit1026->SetParError(1,0.02099258);
   ...
   pt_LaTex = pt->AddText("0.789#pm0.021");
   pt_LaTex = pt->AddText("#minus0.142#pm 0.53");
   pt_LaTex = pt->AddText("#minus0.18#pm0.673");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1795794,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1795794,-50.00516,0.1795794,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.258791);
   ...
   mainFit1027->SetParameter(0,-0.141626);
   mainFit1027->SetParError(0,0.530186);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7886541);
   mainFit1027->SetParError(1,0.02099258);
