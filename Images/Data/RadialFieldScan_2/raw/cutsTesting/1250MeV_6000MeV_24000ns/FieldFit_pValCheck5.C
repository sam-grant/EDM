...
//=========  (Wed Apr 21 13:58:55 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-42.03047,70,59.02141);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.92529);
   Graph_Graph01035->SetMaximum(48.91622);
   ...
   mainFit1036->SetChisquare(2.816092);
   ...
   mainFit1036->SetParameter(0,0.1265706);
   mainFit1036->SetParError(0,0.5161519);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7969068);
   mainFit1036->SetParError(1,0.01785969);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.939");
   pt_LaTex = pt->AddText("0.797#pm0.0179");
   pt_LaTex = pt->AddText("0.127#pm0.516");
   pt_LaTex = pt->AddText("0.159#pm0.649");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.1588274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1588274,-31.92529,-0.1588274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.816092);
   ...
   mainFit1037->SetParameter(0,0.1265706);
   mainFit1037->SetParError(0,0.5161519);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7969068);
   mainFit1037->SetParError(1,0.01785969);
