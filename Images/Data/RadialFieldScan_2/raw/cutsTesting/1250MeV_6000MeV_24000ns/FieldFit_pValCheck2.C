...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.84688);
   Graph_Graph01029->SetMaximum(50.72728);
   ...
   mainFit1030->SetChisquare(2.892312);
   ...
   mainFit1030->SetParameter(0,-0.05792058);
   mainFit1030->SetParError(0,0.5348053);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8003595);
   mainFit1030->SetParError(1,0.01631162);
   ...
   pt_LaTex = pt->AddText("  0.8#pm0.0163");
   pt_LaTex = pt->AddText("#minus0.0579#pm0.535");
   pt_LaTex = pt->AddText("#minus0.0724#pm0.668");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.07236821,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.07236821,-51.84688,0.07236821,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.892312);
   ...
   mainFit1031->SetParameter(0,-0.05792058);
   mainFit1031->SetParError(0,0.5348053);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8003595);
   mainFit1031->SetParError(1,0.01631162);
