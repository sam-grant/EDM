...
//=========  (Wed Apr 21 13:58:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.84688);
   Graph_Graph01020->SetMaximum(50.72728);
   ...
   mainFit1021->SetChisquare(3.116174);
   ...
   mainFit1021->SetParameter(0,0.0411926);
   mainFit1021->SetParError(0,0.4920592);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8009483);
   mainFit1021->SetParError(1,0.01626462);
   ...
   mainFit1022->SetChisquare(3.116174);
   ...
   mainFit1022->SetParameter(0,0.0411926);
   mainFit1022->SetParError(0,0.4920592);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8009483);
   mainFit1022->SetParError(1,0.01626462);
