...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.00429727);
   Graph_Graph11015->SetMaximum(0.001477742);
   ...
   Graph_Graph21016->SetMinimum(-0.02046503);
   Graph_Graph21016->SetMaximum(0.02402187);
   ...
   Graph_Graph31017->SetMinimum(-0.01673775);
   Graph_Graph31017->SetMaximum(0.02190247);
   ...
   Graph_Graph41018->SetMinimum(-0.01723082);
   Graph_Graph41018->SetMaximum(0.02444879);
   ...
   Graph_Graph51019->SetMinimum(-0.0003424982);
   Graph_Graph51019->SetMaximum(0.0004567638);
