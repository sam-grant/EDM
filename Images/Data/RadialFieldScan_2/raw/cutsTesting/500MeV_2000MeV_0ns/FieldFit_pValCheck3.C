...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.50247);
   Graph_Graph01031->SetMaximum(58.35669);
   ...
   mainFit1032->SetChisquare(1.646874);
   ...
   mainFit1032->SetParameter(0,-1.970069);
   mainFit1032->SetParError(0,0.4803361);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9702622);
   mainFit1032->SetParError(1,0.01426582);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.549");
   pt_LaTex = pt->AddText(" 0.97#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.97#pm 0.48");
   pt_LaTex = pt->AddText("#minus2.03#pm0.488");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.03045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.03045,-63.50247,2.03045,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.646874);
   ...
   mainFit1033->SetParameter(0,-1.970069);
   mainFit1033->SetParError(0,0.4803361);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9702622);
   mainFit1033->SetParError(1,0.01426582);
