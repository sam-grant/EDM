...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.50247);
   Graph_Graph01029->SetMaximum(58.35669);
   ...
   mainFit1030->SetChisquare(1.689722);
   ...
   mainFit1030->SetParameter(0,-2.184662);
   mainFit1030->SetParError(0,0.4533584);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9717061);
   mainFit1030->SetParError(1,0.01382512);
   ...
   pt_LaTex = pt->AddText("#minus2.18#pm0.453");
   pt_LaTex = pt->AddText("#minus2.25#pm0.464");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.248275,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.248275,-63.50247,2.248275,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.689722);
   ...
   mainFit1031->SetParameter(0,-2.184662);
   mainFit1031->SetParError(0,0.4533584);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9717061);
   mainFit1031->SetParError(1,0.01382512);
