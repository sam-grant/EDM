...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.50247);
   Graph_Graph01027->SetMaximum(58.35669);
   ...
   mainFit1028->SetChisquare(0.8754293);
   ...
   mainFit1028->SetParameter(0,-1.881302);
   mainFit1028->SetParError(0,0.4670645);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9792738);
   mainFit1028->SetParError(1,0.01539763);
   ...
   pt_LaTex = pt->AddText("0.979#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.88#pm0.467");
   pt_LaTex = pt->AddText("#minus1.92#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.92112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.92112,-63.50247,1.92112,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8754293);
   ...
   mainFit1029->SetParameter(0,-1.881302);
   mainFit1029->SetParError(0,0.4670645);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9792738);
   mainFit1029->SetParError(1,0.01539763);
