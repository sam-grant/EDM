...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.50247);
   Graph_Graph01033->SetMaximum(58.35669);
   ...
   mainFit1034->SetChisquare(1.22809);
   ...
   mainFit1034->SetParameter(0,-2.362034);
   mainFit1034->SetParError(0,0.5230639);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9809187);
   mainFit1034->SetParError(1,0.01724602);
   ...
   pt_LaTex = pt->AddText("0.981#pm0.0172");
   pt_LaTex = pt->AddText("#minus2.36#pm0.523");
   pt_LaTex = pt->AddText("#minus2.41#pm0.515");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.407981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.407981,-63.50247,2.407981,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.22809);
   ...
   mainFit1035->SetParameter(0,-2.362034);
   mainFit1035->SetParError(0,0.5230639);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9809187);
   mainFit1035->SetParError(1,0.01724602);
