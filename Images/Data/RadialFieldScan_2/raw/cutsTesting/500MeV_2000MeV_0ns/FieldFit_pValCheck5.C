...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-51.58434,70,68.15898);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.61001);
   Graph_Graph01035->SetMaximum(56.18464);
   ...
   mainFit1036->SetChisquare(1.725386);
   ...
   mainFit1036->SetParameter(0,-2.037297);
   mainFit1036->SetParError(0,0.4374959);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9693855);
   mainFit1036->SetParError(1,0.01513232);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.575");
   pt_LaTex = pt->AddText("0.969#pm0.0151");
   pt_LaTex = pt->AddText("#minus2.04#pm0.437");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.444");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.101638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.101638,-39.61001,2.101638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.725386);
   ...
   mainFit1037->SetParameter(0,-2.037297);
   mainFit1037->SetParError(0,0.4374959);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9693855);
   mainFit1037->SetParError(1,0.01513232);
