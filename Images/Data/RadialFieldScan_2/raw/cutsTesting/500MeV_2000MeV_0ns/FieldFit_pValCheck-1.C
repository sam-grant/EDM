...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-78.73487,75,73.58908);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-63.50247);
   Graph_Graph01023->SetMaximum(58.35669);
   ...
   mainFit1024->SetChisquare(1.932122);
   ...
   mainFit1024->SetParameter(0,-2.097234);
   mainFit1024->SetParError(0,0.4171503);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9722172);
   mainFit1024->SetParError(1,0.01378516);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.483");
   pt_LaTex = pt->AddText("0.972#pm0.0138");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.417");
   pt_LaTex = pt->AddText("#minus2.16#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.157166,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.157166,-63.50247,2.157166,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.932122);
   ...
   mainFit1025->SetParameter(0,-2.097234);
   mainFit1025->SetParError(0,0.4171503);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9722172);
   mainFit1025->SetParError(1,0.01378516);
