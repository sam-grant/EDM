...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.50247);
   Graph_Graph01020->SetMaximum(58.35669);
   ...
   mainFit1021->SetChisquare(1.932122);
   ...
   mainFit1021->SetParameter(0,-2.097234);
   mainFit1021->SetParError(0,0.4171503);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9722172);
   mainFit1021->SetParError(1,0.01378516);
   ...
   mainFit1022->SetChisquare(1.932122);
   ...
   mainFit1022->SetParameter(0,-2.097234);
   mainFit1022->SetParError(0,0.4171503);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9722172);
   mainFit1022->SetParError(1,0.01378516);
