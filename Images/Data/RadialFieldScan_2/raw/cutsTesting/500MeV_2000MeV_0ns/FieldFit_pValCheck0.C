...
//=========  (Thu Apr 22 13:58:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.49285,50,47.37899);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.40567);
   Graph_Graph01025->SetMaximum(35.29181);
   ...
   mainFit1026->SetChisquare(1.266195);
   ...
   mainFit1026->SetParameter(0,-2.23409);
   mainFit1026->SetParError(0,0.4495909);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9630363);
   mainFit1026->SetParError(1,0.01779815);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.422");
   pt_LaTex = pt->AddText("0.963#pm0.0178");
   pt_LaTex = pt->AddText("#minus2.23#pm 0.45");
   pt_LaTex = pt->AddText("#minus2.32#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.31984,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.31984,-61.40567,2.31984,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.266195);
   ...
   mainFit1027->SetParameter(0,-2.23409);
   mainFit1027->SetParError(0,0.4495909);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9630363);
   mainFit1027->SetParError(1,0.01779815);
