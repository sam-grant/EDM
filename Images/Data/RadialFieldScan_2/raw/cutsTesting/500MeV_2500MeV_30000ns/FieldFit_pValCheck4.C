...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.94212);
   Graph_Graph01033->SetMaximum(56.67588);
   ...
   mainFit1034->SetChisquare(6.549437);
   ...
   mainFit1034->SetParameter(0,-1.723976);
   mainFit1034->SetParError(0,0.6082067);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.916615);
   mainFit1034->SetParError(1,0.02010469);
   ...
   pt_LaTex = pt->AddText("#minus1.72#pm0.608");
   pt_LaTex = pt->AddText("#minus1.88#pm0.645");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.880807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.880807,-58.94212,1.880807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.549437);
   ...
   mainFit1035->SetParameter(0,-1.723976);
   mainFit1035->SetParError(0,0.6082067);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.916615);
   mainFit1035->SetParError(1,0.02010469);
