...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01593594);
   Graph_Graph11015->SetMaximum(0.01514455);
   ...
   Graph_Graph21016->SetMinimum(-0.01787265);
   Graph_Graph21016->SetMaximum(0.02104841);
   ...
   Graph_Graph31017->SetMinimum(-0.03942391);
   Graph_Graph31017->SetMaximum(0.03006434);
   ...
   Graph_Graph41018->SetMinimum(-0.01636878);
   Graph_Graph41018->SetMaximum(0.01951805);
   ...
   Graph_Graph51019->SetMinimum(-0.005429398);
   Graph_Graph51019->SetMaximum(0.007255078);
