...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.94212);
   Graph_Graph01023->SetMaximum(56.67588);
   ...
   mainFit1024->SetChisquare(6.849737);
   ...
   mainFit1024->SetParameter(0,-1.522297);
   mainFit1024->SetParError(0,0.48422);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9099685);
   mainFit1024->SetParError(1,0.01603409);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.016");
   pt_LaTex = pt->AddText("#minus1.52#pm0.484");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.672911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.672911,-58.94212,1.672911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.849737);
   ...
   mainFit1025->SetParameter(0,-1.522297);
   mainFit1025->SetParError(0,0.48422);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9099685);
   mainFit1025->SetParError(1,0.01603409);
