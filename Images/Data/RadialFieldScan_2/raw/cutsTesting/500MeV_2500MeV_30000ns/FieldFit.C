...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.94212);
   Graph_Graph01020->SetMaximum(56.67588);
   ...
   mainFit1021->SetChisquare(6.849737);
   ...
   mainFit1021->SetParameter(0,-1.522297);
   mainFit1021->SetParError(0,0.48422);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9099685);
   mainFit1021->SetParError(1,0.01603409);
   ...
   mainFit1022->SetChisquare(6.849737);
   ...
   mainFit1022->SetParameter(0,-1.522297);
   mainFit1022->SetParError(0,0.48422);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9099685);
   mainFit1022->SetParError(1,0.01603409);
