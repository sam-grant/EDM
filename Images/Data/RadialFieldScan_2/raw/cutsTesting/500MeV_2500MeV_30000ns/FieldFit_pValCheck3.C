...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.94212);
   Graph_Graph01031->SetMaximum(56.67588);
   ...
   mainFit1032->SetChisquare(6.756576);
   ...
   mainFit1032->SetParameter(0,-1.437643);
   mainFit1032->SetParError(0,0.5580248);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9086537);
   mainFit1032->SetParError(1,0.01660273);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0166");
   pt_LaTex = pt->AddText("#minus1.44#pm0.558");
   pt_LaTex = pt->AddText("#minus1.58#pm0.607");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.582169,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.582169,-58.94212,1.582169,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.756576);
   ...
   mainFit1033->SetParameter(0,-1.437643);
   mainFit1033->SetParError(0,0.5580248);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9086537);
   mainFit1033->SetParError(1,0.01660273);
