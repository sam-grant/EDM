...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.5849,70,66.16623);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.10979);
   Graph_Graph01035->SetMaximum(54.69112);
   ...
   mainFit1036->SetChisquare(6.84823);
   ...
   mainFit1036->SetParameter(0,-1.516426);
   mainFit1036->SetParError(0,0.5072803);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9096902);
   mainFit1036->SetParError(1,0.01756386);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.52#pm0.507");
   pt_LaTex = pt->AddText("#minus1.67#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.66697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.66697,-37.10979,1.66697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.84823);
   ...
   mainFit1037->SetParameter(0,-1.516426);
   mainFit1037->SetParError(0,0.5072803);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9096902);
   mainFit1037->SetParError(1,0.01756386);
