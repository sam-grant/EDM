...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.94212);
   Graph_Graph01029->SetMaximum(56.67588);
   ...
   mainFit1030->SetChisquare(6.1664);
   ...
   mainFit1030->SetParameter(0,-1.693026);
   mainFit1030->SetParError(0,0.526427);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9089651);
   mainFit1030->SetParError(1,0.01607993);
   ...
   pt_LaTex = pt->AddText("0.909#pm0.0161");
   pt_LaTex = pt->AddText("#minus1.69#pm0.526");
   pt_LaTex = pt->AddText("#minus1.86#pm0.576");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.862586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.862586,-58.94212,1.862586,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.1664);
   ...
   mainFit1031->SetParameter(0,-1.693026);
   mainFit1031->SetParError(0,0.526427);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9089651);
   mainFit1031->SetParError(1,0.01607993);
