...
//=========  (Thu Apr 22 15:06:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.83048,50,43.30869);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.71656);
   Graph_Graph01025->SetMaximum(32.19477);
   ...
   mainFit1026->SetChisquare(2.599557);
   ...
   mainFit1026->SetParameter(0,-1.92048);
   mainFit1026->SetParError(0,0.5213189);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8829996);
   mainFit1026->SetParError(1,0.02069348);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.867");
   pt_LaTex = pt->AddText("0.883#pm0.0207");
   pt_LaTex = pt->AddText("#minus1.92#pm0.521");
   pt_LaTex = pt->AddText("#minus2.17#pm0.598");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.174951,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.174951,-56.71656,2.174951,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.599557);
   ...
   mainFit1027->SetParameter(0,-1.92048);
   mainFit1027->SetParError(0,0.5213189);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8829996);
   mainFit1027->SetParError(1,0.02069348);
