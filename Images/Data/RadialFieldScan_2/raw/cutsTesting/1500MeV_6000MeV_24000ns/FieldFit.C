...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.09521);
   Graph_Graph01020->SetMaximum(49.07959);
   ...
   mainFit1021->SetChisquare(2.94351);
   ...
   mainFit1021->SetParameter(0,-0.07996171);
   mainFit1021->SetParError(0,0.5345453);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7714232);
   mainFit1021->SetParError(1,0.01760391);
   ...
   mainFit1022->SetChisquare(2.94351);
   ...
   mainFit1022->SetParameter(0,-0.07996171);
   mainFit1022->SetParError(0,0.5345453);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7714232);
   mainFit1022->SetParError(1,0.01760391);
