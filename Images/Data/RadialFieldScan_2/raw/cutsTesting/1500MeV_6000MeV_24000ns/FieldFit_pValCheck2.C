...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.09521);
   Graph_Graph01029->SetMaximum(49.07959);
   ...
   mainFit1030->SetChisquare(2.929263);
   ...
   mainFit1030->SetParameter(0,-0.1070053);
   mainFit1030->SetParError(0,0.5806552);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7712657);
   mainFit1030->SetParError(1,0.01765016);
   ...
   pt_LaTex = pt->AddText("0.771#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.107#pm0.581");
   pt_LaTex = pt->AddText("#minus0.139#pm0.752");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1387399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1387399,-51.09521,0.1387399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.929263);
   ...
   mainFit1031->SetParameter(0,-0.1070053);
   mainFit1031->SetParError(0,0.5806552);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7712657);
   mainFit1031->SetParError(1,0.01765016);
