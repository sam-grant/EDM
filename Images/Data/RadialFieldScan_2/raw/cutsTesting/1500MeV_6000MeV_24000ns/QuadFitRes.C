...
//=========  (Wed Apr 21 14:02:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01175926);
   Graph_Graph11015->SetMaximum(0.02040037);
   ...
   Graph_Graph21016->SetMinimum(-0.007295372);
   Graph_Graph21016->SetMaximum(0.008593225);
   ...
   Graph_Graph31017->SetMinimum(-0.05443392);
   Graph_Graph31017->SetMaximum(0.03914201);
   ...
   Graph_Graph41018->SetMinimum(-0.002357439);
   Graph_Graph41018->SetMaximum(0.001430235);
   ...
   Graph_Graph51019->SetMinimum(-0.004949008);
   Graph_Graph51019->SetMaximum(0.006611937);
