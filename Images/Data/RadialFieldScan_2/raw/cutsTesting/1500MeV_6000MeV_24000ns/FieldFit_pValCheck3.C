...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.09521);
   Graph_Graph01031->SetMaximum(49.07959);
   ...
   mainFit1032->SetChisquare(2.08472);
   ...
   mainFit1032->SetParameter(0,-0.3633915);
   mainFit1032->SetParError(0,0.6158572);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7758204);
   mainFit1032->SetParError(1,0.01823218);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.695");
   pt_LaTex = pt->AddText("0.776#pm0.0182");
   pt_LaTex = pt->AddText("#minus0.363#pm0.616");
   pt_LaTex = pt->AddText("#minus0.468#pm0.791");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4683964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4683964,-51.09521,0.4683964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.08472);
   ...
   mainFit1033->SetParameter(0,-0.3633915);
   mainFit1033->SetParError(0,0.6158572);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7758204);
   mainFit1033->SetParError(1,0.01823218);
