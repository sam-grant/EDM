...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.55516,70,56.98907);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.80074);
   Graph_Graph01035->SetMaximum(47.23464);
   ...
   mainFit1036->SetChisquare(2.326344);
   ...
   mainFit1036->SetParameter(0,0.05365132);
   mainFit1036->SetParError(0,0.5609502);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7651677);
   mainFit1036->SetParError(1,0.01932101);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.775");
   pt_LaTex = pt->AddText("0.765#pm0.0193");
   pt_LaTex = pt->AddText("0.0537#pm0.561");
   pt_LaTex = pt->AddText("0.0701#pm0.734");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.07011707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.07011707,-30.80074,-0.07011707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.326344);
   ...
   mainFit1037->SetParameter(0,0.05365132);
   mainFit1037->SetParError(0,0.5609502);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7651677);
   mainFit1037->SetParError(1,0.01932101);
