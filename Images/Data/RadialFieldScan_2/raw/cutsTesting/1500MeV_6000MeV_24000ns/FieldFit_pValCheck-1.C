...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-63.61707,75,61.60145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-51.09521);
   Graph_Graph01023->SetMaximum(49.07959);
   ...
   mainFit1024->SetChisquare(2.94351);
   ...
   mainFit1024->SetParameter(0,-0.07996171);
   mainFit1024->SetParError(0,0.5345453);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7714232);
   mainFit1024->SetParError(1,0.01760391);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.736");
   pt_LaTex = pt->AddText("0.771#pm0.0176");
   pt_LaTex = pt->AddText("#minus0.08#pm0.535");
   pt_LaTex = pt->AddText("#minus0.104#pm0.693");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1036548,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1036548,-51.09521,0.1036548,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.94351);
   ...
   mainFit1025->SetParameter(0,-0.07996171);
   mainFit1025->SetParError(0,0.5345453);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7714232);
   mainFit1025->SetParError(1,0.01760391);
