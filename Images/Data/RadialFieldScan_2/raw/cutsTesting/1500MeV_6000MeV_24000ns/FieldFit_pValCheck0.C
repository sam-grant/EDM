...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.15191,50,39.27569);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.30915);
   Graph_Graph01025->SetMaximum(29.43293);
   ...
   mainFit1026->SetChisquare(2.07374);
   ...
   mainFit1026->SetParameter(0,-0.2815671);
   mainFit1026->SetParError(0,0.576593);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7578519);
   mainFit1026->SetParError(1,0.02283593);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.691");
   pt_LaTex = pt->AddText("0.758#pm0.0228");
   pt_LaTex = pt->AddText("#minus0.282#pm0.577");
   pt_LaTex = pt->AddText("#minus0.372#pm0.762");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3715331,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3715331,-49.30915,0.3715331,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.07374);
   ...
   mainFit1027->SetParameter(0,-0.2815671);
   mainFit1027->SetParError(0,0.576593);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7578519);
   mainFit1027->SetParError(1,0.02283593);
