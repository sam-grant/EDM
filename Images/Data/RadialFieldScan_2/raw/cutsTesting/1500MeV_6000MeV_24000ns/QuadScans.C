...
//=========  (Wed Apr 21 14:02:28 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1924288);
   ...
   quadLineFit1002->SetParameter(0,74.91312);
   quadLineFit1002->SetParError(0,0.08040128);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.38342);
   quadLineFit1002->SetParError(1,1.348272);
   ...
   quadLineFit1003->SetChisquare(0.1924288);
   ...
   quadLineFit1003->SetParameter(0,74.91312);
   quadLineFit1003->SetParError(0,0.08040128);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.38342);
   quadLineFit1003->SetParError(1,1.348272);
   ...
   Graph_30_ppm1003->SetMinimum(75.96641);
   Graph_30_ppm1003->SetMaximum(76.52473);
   ...
   quadLineFit1004->SetChisquare(1.021345);
   ...
   quadLineFit1004->SetParameter(0,74.91137);
   quadLineFit1004->SetParError(0,0.06861544);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.74321);
   quadLineFit1004->SetParError(1,1.127879);
   ...
   quadLineFit1005->SetChisquare(1.021345);
   ...
   quadLineFit1005->SetParameter(0,74.91137);
   quadLineFit1005->SetParError(0,0.06861544);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.74321);
   quadLineFit1005->SetParError(1,1.127879);
   ...
   Graph_10_ppm1005->SetMinimum(75.05986);
   Graph_10_ppm1005->SetMaximum(75.29643);
   ...
   quadLineFit1006->SetChisquare(0.388301);
   ...
   quadLineFit1006->SetParameter(0,74.69392);
   quadLineFit1006->SetParError(0,0.0804461);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.77636);
   quadLineFit1006->SetParError(1,1.304721);
   ...
   quadLineFit1007->SetChisquare(0.388301);
   ...
   quadLineFit1007->SetParameter(0,74.69392);
   quadLineFit1007->SetParError(0,0.0804461);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.77636);
   quadLineFit1007->SetParError(1,1.304721);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.00873);
   Graph_mI10_ppm1007->SetMaximum(74.2618);
   ...
   quadLineFit1008->SetChisquare(13.04156);
   ...
   quadLineFit1008->SetParameter(0,74.54403);
   quadLineFit1008->SetParError(0,0.0705914);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.880565);
   quadLineFit1008->SetParError(1,1.149034);
   ...
   quadLineFit1009->SetChisquare(13.04156);
   ...
   quadLineFit1009->SetParameter(0,74.54403);
   quadLineFit1009->SetParError(0,0.0705914);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.880565);
   quadLineFit1009->SetParError(1,1.149034);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.75556);
   Graph_mI30_ppm1009->SetMaximum(73.35461);
   ...
   quadLineFit1010->SetChisquare(0.01284617);
   ...
   quadLineFit1010->SetParameter(0,74.47827);
   quadLineFit1010->SetParError(0,0.06680063);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.14163);
   quadLineFit1010->SetParError(1,1.156162);
   ...
   quadLineFit1011->SetChisquare(0.01284617);
   ...
   quadLineFit1011->SetParameter(0,74.47827);
   quadLineFit1011->SetParError(0,0.06680063);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.14163);
   quadLineFit1011->SetParError(1,1.156162);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.87467);
   Graph_mI50_ppm1011->SetMaximum(72.46289);
   ...
   quadLineFit1012->SetChisquare(0.2048273);
   ...
   quadLineFit1012->SetParameter(0,74.46909);
   quadLineFit1012->SetParError(0,0.1347883);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.33564);
   quadLineFit1012->SetParError(1,2.411675);
   ...
   quadLineFit1013->SetChisquare(0.2048273);
   ...
   quadLineFit1013->SetParameter(0,74.46909);
   quadLineFit1013->SetParError(0,0.1347883);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.33564);
   quadLineFit1013->SetParError(1,2.411675);
