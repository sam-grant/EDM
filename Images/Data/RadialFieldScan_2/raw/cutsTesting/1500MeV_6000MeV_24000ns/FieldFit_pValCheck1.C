...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-51.09521);
   Graph_Graph01027->SetMaximum(49.07959);
   ...
   mainFit1028->SetChisquare(0.7730486);
   ...
   mainFit1028->SetParameter(0,0.3121254);
   mainFit1028->SetParError(0,0.5971332);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7841182);
   mainFit1028->SetParError(1,0.01959977);
   ...
   pt_LaTex = pt->AddText("0.784#pm0.0196");
   pt_LaTex = pt->AddText("0.312#pm0.597");
   pt_LaTex = pt->AddText("0.398#pm0.761");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3980591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3980591,-51.09521,-0.3980591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7730486);
   ...
   mainFit1029->SetParameter(0,0.3121254);
   mainFit1029->SetParError(0,0.5971332);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7841182);
   mainFit1029->SetParError(1,0.01959977);
