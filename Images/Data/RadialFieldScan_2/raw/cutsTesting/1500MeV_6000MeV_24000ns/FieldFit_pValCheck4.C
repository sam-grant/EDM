...
//=========  (Wed Apr 21 14:02:29 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.09521);
   Graph_Graph01033->SetMaximum(49.07959);
   ...
   mainFit1034->SetChisquare(2.933816);
   ...
   mainFit1034->SetParameter(0,-0.1198125);
   mainFit1034->SetParError(0,0.6704937);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7727243);
   mainFit1034->SetParError(1,0.02201215);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.978");
   pt_LaTex = pt->AddText("0.773#pm0.022");
   pt_LaTex = pt->AddText("#minus0.12#pm 0.67");
   pt_LaTex = pt->AddText("#minus0.155#pm0.866");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1550521,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1550521,-51.09521,0.1550521,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.933816);
   ...
   mainFit1035->SetParameter(0,-0.1198125);
   mainFit1035->SetParError(0,0.6704937);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7727243);
   mainFit1035->SetParError(1,0.02201215);
