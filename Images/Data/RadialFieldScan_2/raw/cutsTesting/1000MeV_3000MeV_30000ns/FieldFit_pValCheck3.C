...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.55704);
   Graph_Graph01031->SetMaximum(52.716);
   ...
   mainFit1032->SetChisquare(5.049272);
   ...
   mainFit1032->SetParameter(0,-0.614588);
   mainFit1032->SetParError(0,0.5842517);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8355504);
   mainFit1032->SetParError(1,0.01735259);
   ...
   pt_LaTex = pt->AddText("#minus0.615#pm0.584");
   pt_LaTex = pt->AddText("#minus0.736#pm0.695");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7355488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7355488,-54.55704,0.7355488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.049272);
   ...
   mainFit1033->SetParameter(0,-0.614588);
   mainFit1033->SetParError(0,0.5842517);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8355504);
   mainFit1033->SetParError(1,0.01735259);
