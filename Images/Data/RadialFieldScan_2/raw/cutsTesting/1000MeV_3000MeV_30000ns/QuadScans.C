...
//=========  (Fri Apr 23 19:01:21 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.90789);
   ...
   quadLineFit1002->SetParameter(0,74.64631);
   quadLineFit1002->SetParError(0,0.07723439);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.48103);
   quadLineFit1002->SetParError(1,1.295548);
   ...
   quadLineFit1003->SetChisquare(0.90789);
   ...
   quadLineFit1003->SetParameter(0,74.64631);
   quadLineFit1003->SetParError(0,0.07723439);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.48103);
   quadLineFit1003->SetParError(1,1.295548);
   ...
   Graph_30_ppm1003->SetMinimum(75.82769);
   Graph_30_ppm1003->SetMaximum(76.40109);
   ...
   quadLineFit1004->SetChisquare(4.452775);
   ...
   quadLineFit1004->SetParameter(0,74.72994);
   quadLineFit1004->SetParError(0,0.06504044);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.62248);
   quadLineFit1004->SetParError(1,1.068989);
   ...
   quadLineFit1005->SetChisquare(4.452775);
   ...
   quadLineFit1005->SetParameter(0,74.72994);
   quadLineFit1005->SetParError(0,0.06504044);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.62248);
   quadLineFit1005->SetParError(1,1.068989);
   ...
   Graph_10_ppm1005->SetMinimum(74.89343);
   Graph_10_ppm1005->SetMaximum(75.15726);
   ...
   quadLineFit1006->SetChisquare(1.58432);
   ...
   quadLineFit1006->SetParameter(0,74.46856);
   quadLineFit1006->SetParError(0,0.07621285);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.872935);
   quadLineFit1006->SetParError(1,1.236097);
   ...
   quadLineFit1007->SetChisquare(1.58432);
   ...
   quadLineFit1007->SetParameter(0,74.46856);
   quadLineFit1007->SetParError(0,0.07621285);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.872935);
   quadLineFit1007->SetParError(1,1.236097);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.76404);
   Graph_mI10_ppm1007->SetMaximum(74.045);
   ...
   quadLineFit1008->SetChisquare(5.885246);
   ...
   quadLineFit1008->SetParameter(0,74.43972);
   quadLineFit1008->SetParError(0,0.06692818);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.834662);
   quadLineFit1008->SetParError(1,1.089403);
   ...
   quadLineFit1009->SetChisquare(5.885246);
   ...
   quadLineFit1009->SetParameter(0,74.43972);
   quadLineFit1009->SetParError(0,0.06692818);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.834662);
   quadLineFit1009->SetParError(1,1.089403);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.4487);
   Graph_mI30_ppm1009->SetMaximum(73.108);
   ...
   quadLineFit1010->SetChisquare(2.044777);
   ...
   quadLineFit1010->SetParameter(0,74.34952);
   quadLineFit1010->SetParError(0,0.0633106);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.37553);
   quadLineFit1010->SetParError(1,1.095724);
   ...
   quadLineFit1011->SetChisquare(2.044777);
   ...
   quadLineFit1011->SetParameter(0,74.34952);
   quadLineFit1011->SetParError(0,0.0633106);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.37553);
   quadLineFit1011->SetParError(1,1.095724);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.55704);
   Graph_mI50_ppm1011->SetMaximum(72.18313);
   ...
   quadLineFit1012->SetChisquare(0.3020751);
   ...
   quadLineFit1012->SetParameter(0,74.34132);
   quadLineFit1012->SetParError(0,0.127764);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.33159);
   quadLineFit1012->SetParError(1,2.286026);
   ...
   quadLineFit1013->SetChisquare(0.3020751);
   ...
   quadLineFit1013->SetParameter(0,74.34132);
   quadLineFit1013->SetParError(0,0.127764);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.33159);
   quadLineFit1013->SetParError(1,2.286026);
