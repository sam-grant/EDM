...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.94489,50,41.01875);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.54853);
   Graph_Graph01025->SetMaximum(30.62238);
   ...
   mainFit1026->SetChisquare(3.054073);
   ...
   mainFit1026->SetParameter(0,-0.8718386);
   mainFit1026->SetParError(0,0.5464773);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8156676);
   mainFit1026->SetParError(1,0.02164339);
   ...
   pt_LaTex = pt->AddText("0.816#pm0.0216");
   pt_LaTex = pt->AddText("#minus0.872#pm0.546");
   pt_LaTex = pt->AddText("#minus1.07#pm0.674");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.068865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.068865,-52.54853,1.068865,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.054073);
   ...
   mainFit1027->SetParameter(0,-0.8718386);
   mainFit1027->SetParError(0,0.5464773);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8156676);
   mainFit1027->SetParError(1,0.02164339);
