...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01838097);
   Graph_Graph11015->SetMaximum(0.04613608);
   ...
   Graph_Graph21016->SetMinimum(-0.01395432);
   Graph_Graph21016->SetMaximum(0.01645362);
   ...
   Graph_Graph31017->SetMinimum(-0.0337955);
   Graph_Graph31017->SetMaximum(0.02799798);
   ...
   Graph_Graph41018->SetMinimum(-0.01679524);
   Graph_Graph41018->SetMaximum(0.0225729);
   ...
   Graph_Graph51019->SetMinimum(-0.00569317);
   Graph_Graph51019->SetMaximum(0.007614823);
