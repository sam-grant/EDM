...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.55704);
   Graph_Graph01033->SetMaximum(52.716);
   ...
   mainFit1034->SetChisquare(4.949151);
   ...
   mainFit1034->SetParameter(0,-0.7115962);
   mainFit1034->SetParError(0,0.6356647);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8392748);
   mainFit1034->SetParError(1,0.02096237);
   ...
   pt_LaTex = pt->AddText("0.839#pm0.021");
   pt_LaTex = pt->AddText("#minus0.712#pm0.636");
   pt_LaTex = pt->AddText("#minus0.848#pm0.748");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8478703,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8478703,-54.55704,0.8478703,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.949151);
   ...
   mainFit1035->SetParameter(0,-0.7115962);
   mainFit1035->SetParError(0,0.6356647);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8392748);
   mainFit1035->SetParError(1,0.02096237);
