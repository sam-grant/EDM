...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.55704);
   Graph_Graph01029->SetMaximum(52.716);
   ...
   mainFit1030->SetChisquare(4.097831);
   ...
   mainFit1030->SetParameter(0,-0.7956217);
   mainFit1030->SetParError(0,0.5512995);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8338256);
   mainFit1030->SetParError(1,0.01681157);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.796#pm0.551");
   pt_LaTex = pt->AddText("#minus0.954#pm0.659");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9541824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9541824,-54.55704,0.9541824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.097831);
   ...
   mainFit1031->SetParameter(0,-0.7956217);
   mainFit1031->SetParError(0,0.5512995);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8338256);
   mainFit1031->SetParError(1,0.01681157);
