...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.55704);
   Graph_Graph01023->SetMaximum(52.716);
   ...
   mainFit1024->SetChisquare(5.060651);
   ...
   mainFit1024->SetParameter(0,-0.5836558);
   mainFit1024->SetParError(0,0.5072125);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8350722);
   mainFit1024->SetParError(1,0.01676361);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0168");
   pt_LaTex = pt->AddText("#minus0.584#pm0.507");
   pt_LaTex = pt->AddText("#minus0.699#pm0.605");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6989286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6989286,-54.55704,0.6989286,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.060651);
   ...
   mainFit1025->SetParameter(0,-0.5836558);
   mainFit1025->SetParError(0,0.5072125);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8350722);
   mainFit1025->SetParError(1,0.01676361);
