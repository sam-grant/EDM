...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-67.96617,75,66.12513);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-54.55704);
   Graph_Graph01027->SetMaximum(52.716);
   ...
   mainFit1028->SetChisquare(0.2968906);
   ...
   mainFit1028->SetParameter(0,-0.02661431);
   mainFit1028->SetParError(0,0.5678039);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8532662);
   mainFit1028->SetParError(1,0.01872183);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.099");
   pt_LaTex = pt->AddText("0.853#pm0.0187");
   pt_LaTex = pt->AddText("#minus0.0266#pm0.568");
   pt_LaTex = pt->AddText("#minus0.0312#pm0.665");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.0311911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.0311911,-54.55704,0.0311911,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2968906);
   ...
   mainFit1029->SetParameter(0,-0.02661431);
   mainFit1029->SetParError(0,0.5678039);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8532662);
   mainFit1029->SetParError(1,0.01872183);
