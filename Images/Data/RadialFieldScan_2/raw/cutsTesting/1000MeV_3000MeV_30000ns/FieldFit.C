...
//=========  (Fri Apr 23 19:01:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.55704);
   Graph_Graph01020->SetMaximum(52.716);
   ...
   mainFit1021->SetChisquare(5.060651);
   ...
   mainFit1021->SetParameter(0,-0.5836558);
   mainFit1021->SetParError(0,0.5072125);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8350722);
   mainFit1021->SetParError(1,0.01676361);
   ...
   mainFit1022->SetChisquare(5.060651);
   ...
   mainFit1022->SetParameter(0,-0.5836558);
   mainFit1022->SetParError(0,0.5072125);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8350722);
   mainFit1022->SetParError(1,0.01676361);
