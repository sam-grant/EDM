...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.45498);
   Graph_Graph01029->SetMaximum(56.29155);
   ...
   mainFit1030->SetChisquare(5.919469);
   ...
   mainFit1030->SetParameter(0,-0.8345023);
   mainFit1030->SetParError(0,0.4810882);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8947215);
   mainFit1030->SetParError(1,0.01467062);
   ...
   pt_LaTex = pt->AddText("#minus0.835#pm0.481");
   pt_LaTex = pt->AddText("#minus0.933#pm0.536");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.932695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.932695,-56.45498,0.932695,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.919469);
   ...
   mainFit1031->SetParameter(0,-0.8345023);
   mainFit1031->SetParError(0,0.4810882);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8947215);
   mainFit1031->SetParError(1,0.01467062);
