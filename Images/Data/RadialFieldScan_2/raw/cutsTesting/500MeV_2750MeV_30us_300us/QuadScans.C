...
//=========  (Wed Apr 28 15:03:55 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9154399);
   ...
   quadLineFit1002->SetParameter(0,74.46366);
   quadLineFit1002->SetParError(0,0.06743043);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.76486);
   quadLineFit1002->SetParError(1,1.131145);
   ...
   quadLineFit1003->SetChisquare(0.9154399);
   ...
   quadLineFit1003->SetParameter(0,74.46366);
   quadLineFit1003->SetParError(0,0.06743043);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.76486);
   quadLineFit1003->SetParError(1,1.131145);
   ...
   Graph_30_ppm1003->SetMinimum(75.7617);
   Graph_30_ppm1003->SetMaximum(76.37611);
   ...
   quadLineFit1004->SetChisquare(1.359877);
   ...
   quadLineFit1004->SetParameter(0,74.56819);
   quadLineFit1004->SetParError(0,0.05677347);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.42018);
   quadLineFit1004->SetParError(1,0.9331971);
   ...
   quadLineFit1005->SetChisquare(1.359877);
   ...
   quadLineFit1005->SetParameter(0,74.56819);
   quadLineFit1005->SetParError(0,0.05677347);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.42018);
   quadLineFit1005->SetParError(1,0.9331971);
   ...
   Graph_10_ppm1005->SetMinimum(74.78045);
   Graph_10_ppm1005->SetMaximum(75.04267);
   ...
   quadLineFit1006->SetChisquare(1.848686);
   ...
   quadLineFit1006->SetParameter(0,74.34485);
   quadLineFit1006->SetParError(0,0.06649173);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.04765);
   quadLineFit1006->SetParError(1,1.07845);
   ...
   quadLineFit1007->SetChisquare(1.848686);
   ...
   quadLineFit1007->SetParameter(0,74.34485);
   quadLineFit1007->SetParError(0,0.06649173);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.04765);
   quadLineFit1007->SetParError(1,1.07845);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.57124);
   Graph_mI10_ppm1007->SetMaximum(73.87664);
   ...
   quadLineFit1008->SetChisquare(7.677783);
   ...
   quadLineFit1008->SetParameter(0,74.32702);
   quadLineFit1008->SetParError(0,0.05841127);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.990507);
   quadLineFit1008->SetParError(1,0.9508038);
   ...
   quadLineFit1009->SetChisquare(7.677783);
   ...
   quadLineFit1009->SetParameter(0,74.32702);
   quadLineFit1009->SetParError(0,0.05841127);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.990507);
   quadLineFit1009->SetParError(1,0.9508038);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.20802);
   Graph_mI30_ppm1009->SetMaximum(72.89867);
   ...
   quadLineFit1010->SetChisquare(2.020348);
   ...
   quadLineFit1010->SetParameter(0,74.23579);
   quadLineFit1010->SetParError(0,0.05522778);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.24664);
   quadLineFit1010->SetParError(1,0.9558706);
   ...
   quadLineFit1011->SetChisquare(2.020348);
   ...
   quadLineFit1011->SetParameter(0,74.23579);
   quadLineFit1011->SetParError(0,0.05522778);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.24664);
   quadLineFit1011->SetParError(1,0.9558706);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.27293);
   Graph_mI50_ppm1011->SetMaximum(71.91668);
   ...
   quadLineFit1012->SetChisquare(0.7063152);
   ...
   quadLineFit1012->SetParameter(0,74.16599);
   quadLineFit1012->SetParError(0,0.1113735);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.06663);
   quadLineFit1012->SetParError(1,1.992812);
   ...
   quadLineFit1013->SetChisquare(0.7063152);
   ...
   quadLineFit1013->SetParameter(0,74.16599);
   quadLineFit1013->SetParError(0,0.1113735);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.06663);
   quadLineFit1013->SetParError(1,1.992812);
