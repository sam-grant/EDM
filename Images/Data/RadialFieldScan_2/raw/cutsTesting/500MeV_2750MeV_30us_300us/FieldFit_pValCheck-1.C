...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.45498);
   Graph_Graph01023->SetMaximum(56.29155);
   ...
   mainFit1024->SetChisquare(6.544137);
   ...
   mainFit1024->SetParameter(0,-0.6854594);
   mainFit1024->SetParError(0,0.4425862);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8956019);
   mainFit1024->SetParError(1,0.01462842);
   ...
   pt_LaTex = pt->AddText("0.896#pm0.0146");
   pt_LaTex = pt->AddText("#minus0.685#pm0.443");
   pt_LaTex = pt->AddText("#minus0.765#pm0.492");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7653618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7653618,-56.45498,0.7653618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.544137);
   ...
   mainFit1025->SetParameter(0,-0.6854594);
   mainFit1025->SetParError(0,0.4425862);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8956019);
   mainFit1025->SetParError(1,0.01462842);
