...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.97714,70,65.67064);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.71236);
   Graph_Graph01035->SetMaximum(54.40586);
   ...
   mainFit1036->SetChisquare(6.493387);
   ...
   mainFit1036->SetParameter(0,-0.7170365);
   mainFit1036->SetParError(0,0.4642521);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8970962);
   mainFit1036->SetParError(1,0.01606207);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.16");
   pt_LaTex = pt->AddText("0.897#pm0.0161");
   pt_LaTex = pt->AddText("#minus0.717#pm0.464");
   pt_LaTex = pt->AddText("#minus0.799#pm0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.7992862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7992862,-35.71236,0.7992862,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.493387);
   ...
   mainFit1037->SetParameter(0,-0.7170365);
   mainFit1037->SetParError(0,0.4642521);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8970962);
   mainFit1037->SetParError(1,0.01606207);
