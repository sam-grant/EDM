...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01253619);
   Graph_Graph11015->SetMaximum(0.01549494);
   ...
   Graph_Graph21016->SetMinimum(-0.01315903);
   Graph_Graph21016->SetMaximum(0.01550246);
   ...
   Graph_Graph31017->SetMinimum(-0.03508607);
   Graph_Graph31017->SetMaximum(0.02541994);
   ...
   Graph_Graph41018->SetMinimum(-0.01030835);
   Graph_Graph41018->SetMaximum(0.01715631);
   ...
   Graph_Graph51019->SetMinimum(-0.007594504);
   Graph_Graph51019->SetMaximum(0.01015304);
