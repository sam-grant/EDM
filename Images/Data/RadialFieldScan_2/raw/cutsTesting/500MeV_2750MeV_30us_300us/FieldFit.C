...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.45498);
   Graph_Graph01020->SetMaximum(56.29155);
   ...
   mainFit1021->SetChisquare(6.544137);
   ...
   mainFit1021->SetParameter(0,-0.6854594);
   mainFit1021->SetParError(0,0.4425862);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8956019);
   mainFit1021->SetParError(1,0.01462842);
   ...
   mainFit1022->SetChisquare(6.544137);
   ...
   mainFit1022->SetParameter(0,-0.6854594);
   mainFit1022->SetParError(0,0.4425862);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8956019);
   mainFit1022->SetParError(1,0.01462842);
