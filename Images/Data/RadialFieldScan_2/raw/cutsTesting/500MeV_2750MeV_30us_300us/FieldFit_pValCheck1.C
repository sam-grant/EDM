...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.5483,75,70.38487);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.45498);
   Graph_Graph01027->SetMaximum(56.29155);
   ...
   mainFit1028->SetChisquare(0.8467395);
   ...
   mainFit1028->SetParameter(0,-0.1537301);
   mainFit1028->SetParError(0,0.4954877);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9129714);
   mainFit1028->SetParError(1,0.01633847);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.282");
   pt_LaTex = pt->AddText("0.913#pm0.0163");
   pt_LaTex = pt->AddText("#minus0.154#pm0.495");
   pt_LaTex = pt->AddText("#minus0.168#pm0.543");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1683844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1683844,-56.45498,0.1683844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8467395);
   ...
   mainFit1029->SetParameter(0,-0.1537301);
   mainFit1029->SetParError(0,0.4954877);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9129714);
   mainFit1029->SetParError(1,0.01633847);
