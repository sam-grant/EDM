...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.45498);
   Graph_Graph01033->SetMaximum(56.29155);
   ...
   mainFit1034->SetChisquare(6.340481);
   ...
   mainFit1034->SetParameter(0,-0.836292);
   mainFit1034->SetParError(0,0.5546108);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9005568);
   mainFit1034->SetParError(1,0.01829057);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.11");
   pt_LaTex = pt->AddText("0.901#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.836#pm0.555");
   pt_LaTex = pt->AddText("#minus0.929#pm0.607");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9286389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9286389,-56.45498,0.9286389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.340481);
   ...
   mainFit1035->SetParameter(0,-0.836292);
   mainFit1035->SetParError(0,0.5546108);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9005568);
   mainFit1035->SetParError(1,0.01829057);
