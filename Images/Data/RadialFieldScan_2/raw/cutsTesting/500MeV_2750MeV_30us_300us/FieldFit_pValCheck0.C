...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.16264,50,43.45658);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.30072);
   Graph_Graph01025->SetMaximum(32.59466);
   ...
   mainFit1026->SetChisquare(2.273964);
   ...
   mainFit1026->SetParameter(0,-1.052467);
   mainFit1026->SetParError(0,0.4768917);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8709229);
   mainFit1026->SetParError(1,0.01888438);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.758");
   pt_LaTex = pt->AddText("0.871#pm0.0189");
   pt_LaTex = pt->AddText("#minus1.05#pm0.477");
   pt_LaTex = pt->AddText("#minus1.21#pm0.551");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.208451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.208451,-54.30072,1.208451,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.273964);
   ...
   mainFit1027->SetParameter(0,-1.052467);
   mainFit1027->SetParError(0,0.4768917);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8709229);
   mainFit1027->SetParError(1,0.01888438);
