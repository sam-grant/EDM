...
//=========  (Wed Apr 28 15:03:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.45498);
   Graph_Graph01031->SetMaximum(56.29155);
   ...
   mainFit1032->SetChisquare(6.361171);
   ...
   mainFit1032->SetParameter(0,-0.5772885);
   mainFit1032->SetParError(0,0.5097393);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8939314);
   mainFit1032->SetParError(1,0.01514071);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.12");
   pt_LaTex = pt->AddText("0.894#pm0.0151");
   pt_LaTex = pt->AddText("#minus0.577#pm 0.51");
   pt_LaTex = pt->AddText("#minus0.646#pm0.567");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6457861,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6457861,-56.45498,0.6457861,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.361171);
   ...
   mainFit1033->SetParameter(0,-0.5772885);
   mainFit1033->SetParError(0,0.5097393);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8939314);
   mainFit1033->SetParError(1,0.01514071);
