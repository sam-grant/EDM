...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.64605);
   Graph_Graph01033->SetMaximum(48.84273);
   ...
   mainFit1034->SetChisquare(2.019701);
   ...
   mainFit1034->SetParameter(0,-0.461443);
   mainFit1034->SetParError(0,0.7113909);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7723251);
   mainFit1034->SetParError(1,0.02346621);
   ...
   pt_LaTex = pt->AddText("0.772#pm0.0235");
   pt_LaTex = pt->AddText("#minus0.461#pm0.711");
   pt_LaTex = pt->AddText("#minus0.597#pm0.913");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5974724,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5974724,-50.64605,0.5974724,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.019701);
   ...
   mainFit1035->SetParameter(0,-0.461443);
   mainFit1035->SetParError(0,0.7113909);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7723251);
   mainFit1035->SetParError(1,0.02346621);
