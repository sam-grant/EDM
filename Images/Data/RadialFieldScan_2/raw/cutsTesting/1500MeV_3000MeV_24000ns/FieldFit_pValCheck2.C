...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.64605);
   Graph_Graph01029->SetMaximum(48.84273);
   ...
   mainFit1030->SetChisquare(2.148294);
   ...
   mainFit1030->SetParameter(0,-0.3327278);
   mainFit1030->SetParError(0,0.6169917);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7650978);
   mainFit1030->SetParError(1,0.01881968);
   ...
   pt_LaTex = pt->AddText("0.765#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.333#pm0.617");
   pt_LaTex = pt->AddText("#minus0.435#pm0.805");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4348826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4348826,-50.64605,0.4348826,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.148294);
   ...
   mainFit1031->SetParameter(0,-0.3327278);
   mainFit1031->SetParError(0,0.6169917);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7650978);
   mainFit1031->SetParError(1,0.01881968);
