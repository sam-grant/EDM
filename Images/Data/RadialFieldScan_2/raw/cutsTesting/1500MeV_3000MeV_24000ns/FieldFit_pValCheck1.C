...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.64605);
   Graph_Graph01027->SetMaximum(48.84273);
   ...
   mainFit1028->SetChisquare(0.2826121);
   ...
   mainFit1028->SetParameter(0,0.1454705);
   mainFit1028->SetParError(0,0.6355402);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7786564);
   mainFit1028->SetParError(1,0.02096123);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0942");
   pt_LaTex = pt->AddText("0.779#pm0.021");
   pt_LaTex = pt->AddText("0.145#pm0.636");
   pt_LaTex = pt->AddText("0.187#pm0.816");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1868224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1868224,-50.64605,-0.1868224,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2826121);
   ...
   mainFit1029->SetParameter(0,0.1454705);
   mainFit1029->SetParError(0,0.6355402);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7786564);
   mainFit1029->SetParError(1,0.02096123);
