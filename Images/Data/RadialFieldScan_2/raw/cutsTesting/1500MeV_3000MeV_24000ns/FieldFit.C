...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-50.64605);
   Graph_Graph01020->SetMaximum(48.84273);
   ...
   mainFit1021->SetChisquare(2.250579);
   ...
   mainFit1021->SetParameter(0,-0.255426);
   mainFit1021->SetParError(0,0.5676656);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7655553);
   mainFit1021->SetParError(1,0.01876582);
   ...
   mainFit1022->SetChisquare(2.250579);
   ...
   mainFit1022->SetParameter(0,-0.255426);
   mainFit1022->SetParError(0,0.5676656);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7655553);
   mainFit1022->SetParError(1,0.01876582);
