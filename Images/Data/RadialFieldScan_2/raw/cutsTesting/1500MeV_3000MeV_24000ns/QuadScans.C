...
//=========  (Fri Apr 23 18:57:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.037844);
   ...
   quadLineFit1002->SetParameter(0,74.90136);
   quadLineFit1002->SetParError(0,0.08649842);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.10119);
   quadLineFit1002->SetParError(1,1.450807);
   ...
   quadLineFit1003->SetChisquare(1.037844);
   ...
   quadLineFit1003->SetParameter(0,74.90136);
   quadLineFit1003->SetParError(0,0.08649842);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.10119);
   quadLineFit1003->SetParError(1,1.450807);
   ...
   Graph_30_ppm1003->SetMinimum(75.94138);
   Graph_30_ppm1003->SetMaximum(76.48814);
   ...
   quadLineFit1004->SetChisquare(2.022824);
   ...
   quadLineFit1004->SetParameter(0,74.90135);
   quadLineFit1004->SetParError(0,0.07278735);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.38361);
   quadLineFit1004->SetParError(1,1.196341);
   ...
   quadLineFit1005->SetChisquare(2.022824);
   ...
   quadLineFit1005->SetParameter(0,74.90135);
   quadLineFit1005->SetParError(0,0.07278735);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.38361);
   quadLineFit1005->SetParError(1,1.196341);
   ...
   Graph_10_ppm1005->SetMinimum(75.03055);
   Graph_10_ppm1005->SetMaximum(75.26883);
   ...
   quadLineFit1006->SetChisquare(0.0882077);
   ...
   quadLineFit1006->SetParameter(0,74.66662);
   quadLineFit1006->SetParError(0,0.08532205);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.803627);
   quadLineFit1006->SetParError(1,1.383718);
   ...
   quadLineFit1007->SetChisquare(0.0882077);
   ...
   quadLineFit1007->SetParameter(0,74.66662);
   quadLineFit1007->SetParError(0,0.08532205);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.803627);
   quadLineFit1007->SetParError(1,1.383718);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.97247);
   Graph_mI10_ppm1007->SetMaximum(74.2413);
   ...
   quadLineFit1008->SetChisquare(7.728482);
   ...
   quadLineFit1008->SetParameter(0,74.5693);
   quadLineFit1008->SetParError(0,0.07488101);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.735209);
   quadLineFit1008->SetParError(1,1.21876);
   ...
   quadLineFit1009->SetChisquare(7.728482);
   ...
   quadLineFit1009->SetParameter(0,74.5693);
   quadLineFit1009->SetParError(0,0.07488101);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.735209);
   quadLineFit1009->SetParError(1,1.21876);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.74137);
   Graph_mI30_ppm1009->SetMaximum(73.33471);
   ...
   quadLineFit1010->SetChisquare(0.05163547);
   ...
   quadLineFit1010->SetParameter(0,74.44256);
   quadLineFit1010->SetParError(0,0.07085657);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.80291);
   quadLineFit1010->SetParError(1,1.2263);
   ...
   quadLineFit1011->SetChisquare(0.05163547);
   ...
   quadLineFit1011->SetParameter(0,74.44256);
   quadLineFit1011->SetParError(0,0.07085657);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.80291);
   quadLineFit1011->SetParError(1,1.2263);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.86799);
   Graph_mI50_ppm1011->SetMaximum(72.45183);
   ...
   quadLineFit1012->SetChisquare(0.1215394);
   ...
   quadLineFit1012->SetParameter(0,74.42894);
   quadLineFit1012->SetParError(0,0.1430413);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.79592);
   quadLineFit1012->SetParError(1,2.559399);
   ...
   quadLineFit1013->SetChisquare(0.1215394);
   ...
   quadLineFit1013->SetParameter(0,74.42894);
   quadLineFit1013->SetParError(0,0.1430413);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.79592);
   quadLineFit1013->SetParError(1,2.559399);
