...
//=========  (Fri Apr 23 18:57:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.17451,70,56.6973);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.48733);
   Graph_Graph01035->SetMaximum(47.01012);
   ...
   mainFit1036->SetChisquare(1.942478);
   ...
   mainFit1036->SetParameter(0,-0.1557378);
   mainFit1036->SetParError(0,0.5953983);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7608378);
   mainFit1036->SetParError(1,0.02060066);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.647");
   pt_LaTex = pt->AddText("0.761#pm0.0206");
   pt_LaTex = pt->AddText("#minus0.156#pm0.595");
   pt_LaTex = pt->AddText("#minus0.205#pm0.781");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.2046926,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2046926,-30.48733,0.2046926,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.942478);
   ...
   mainFit1037->SetParameter(0,-0.1557378);
   mainFit1037->SetParError(0,0.5953983);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7608378);
   mainFit1037->SetParError(1,0.02060066);
