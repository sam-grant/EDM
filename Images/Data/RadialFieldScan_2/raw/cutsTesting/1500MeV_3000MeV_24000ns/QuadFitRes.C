...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01807157);
   Graph_Graph11015->SetMaximum(0.02937401);
   ...
   Graph_Graph21016->SetMinimum(-0.003686191);
   Graph_Graph21016->SetMaximum(0.004341167);
   ...
   Graph_Graph31017->SetMinimum(-0.04482977);
   Graph_Graph31017->SetMaximum(0.03197344);
   ...
   Graph_Graph41018->SetMinimum(-0.002008307);
   Graph_Graph41018->SetMaximum(0.003698414);
   ...
   Graph_Graph51019->SetMinimum(-0.004043049);
   Graph_Graph51019->SetMaximum(0.005403358);
