...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.58914,50,38.81377);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.84885);
   Graph_Graph01025->SetMaximum(29.07348);
   ...
   mainFit1026->SetChisquare(1.167702);
   ...
   mainFit1026->SetParameter(0,-0.4922577);
   mainFit1026->SetParError(0,0.6115779);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7496073);
   mainFit1026->SetParError(1,0.02422415);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.389");
   pt_LaTex = pt->AddText(" 0.75#pm0.0242");
   pt_LaTex = pt->AddText("#minus0.492#pm0.612");
   pt_LaTex = pt->AddText("#minus0.657#pm0.819");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6566875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6566875,-48.84885,0.6566875,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.167702);
   ...
   mainFit1027->SetParameter(0,-0.4922577);
   mainFit1027->SetParError(0,0.6115779);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7496073);
   mainFit1027->SetParError(1,0.02422415);
