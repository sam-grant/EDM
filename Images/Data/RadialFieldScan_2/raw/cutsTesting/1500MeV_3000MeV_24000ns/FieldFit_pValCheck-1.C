...
//=========  (Fri Apr 23 18:57:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.64605);
   Graph_Graph01023->SetMaximum(48.84273);
   ...
   mainFit1024->SetChisquare(2.250579);
   ...
   mainFit1024->SetParameter(0,-0.255426);
   mainFit1024->SetParError(0,0.5676656);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7655553);
   mainFit1024->SetParError(1,0.01876582);
   ...
   pt_LaTex = pt->AddText("0.766#pm0.0188");
   pt_LaTex = pt->AddText("#minus0.255#pm0.568");
   pt_LaTex = pt->AddText("#minus0.334#pm 0.74");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.333648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.333648,-50.64605,0.333648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.250579);
   ...
   mainFit1025->SetParameter(0,-0.255426);
   mainFit1025->SetParError(0,0.5676656);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7655553);
   mainFit1025->SetParError(1,0.01876582);
