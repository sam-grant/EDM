...
//=========  (Wed Apr 21 13:19:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02697852);
   Graph_Graph11015->SetMaximum(0.03746711);
   ...
   Graph_Graph21016->SetMinimum(-0.008921904);
   Graph_Graph21016->SetMaximum(0.01050771);
   ...
   Graph_Graph31017->SetMinimum(-0.05172859);
   Graph_Graph31017->SetMaximum(0.03772498);
   ...
   Graph_Graph41018->SetMinimum(-0.007014183);
   Graph_Graph41018->SetMaximum(0.009914308);
   ...
   Graph_Graph51019->SetMinimum(-0.01207013);
   Graph_Graph51019->SetMaximum(0.01612231);
