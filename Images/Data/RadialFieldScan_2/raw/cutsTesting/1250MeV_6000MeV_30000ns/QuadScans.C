...
//=========  (Wed Apr 21 13:19:44 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2122855);
   ...
   quadLineFit1002->SetParameter(0,74.783);
   quadLineFit1002->SetParError(0,0.07939492);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.84971);
   quadLineFit1002->SetParError(1,1.331706);
   ...
   quadLineFit1003->SetChisquare(0.2122855);
   ...
   quadLineFit1003->SetParameter(0,74.783);
   quadLineFit1003->SetParError(0,0.07939492);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.84971);
   quadLineFit1003->SetParError(1,1.331706);
   ...
   Graph_30_ppm1003->SetMinimum(75.90443);
   Graph_30_ppm1003->SetMaximum(76.47483);
   ...
   quadLineFit1004->SetChisquare(4.806627);
   ...
   quadLineFit1004->SetParameter(0,74.78256);
   quadLineFit1004->SetParError(0,0.06677277);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.85392);
   quadLineFit1004->SetParError(1,1.097609);
   ...
   quadLineFit1005->SetChisquare(4.806627);
   ...
   quadLineFit1005->SetParameter(0,74.78256);
   quadLineFit1005->SetParError(0,0.06677277);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.85392);
   quadLineFit1005->SetParError(1,1.097609);
   ...
   Graph_10_ppm1005->SetMinimum(74.97983);
   Graph_10_ppm1005->SetMaximum(75.23806);
   ...
   quadLineFit1006->SetChisquare(0.6130052);
   ...
   quadLineFit1006->SetParameter(0,74.56735);
   quadLineFit1006->SetParError(0,0.0782911);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.690791);
   quadLineFit1006->SetParError(1,1.269801);
   ...
   quadLineFit1007->SetChisquare(0.6130052);
   ...
   quadLineFit1007->SetParameter(0,74.56735);
   quadLineFit1007->SetParError(0,0.0782911);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.690791);
   quadLineFit1007->SetParError(1,1.269801);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.89725);
   Graph_mI10_ppm1007->SetMaximum(74.16563);
   ...
   quadLineFit1008->SetChisquare(11.99264);
   ...
   quadLineFit1008->SetParameter(0,74.48613);
   quadLineFit1008->SetParError(0,0.06872152);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.646014);
   quadLineFit1008->SetParError(1,1.11867);
   ...
   quadLineFit1009->SetChisquare(11.99264);
   ...
   quadLineFit1009->SetParameter(0,74.48613);
   quadLineFit1009->SetParError(0,0.06872152);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.646014);
   quadLineFit1009->SetParError(1,1.11867);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.604);
   Graph_mI30_ppm1009->SetMaximum(73.2389);
   ...
   quadLineFit1010->SetChisquare(0.3232634);
   ...
   quadLineFit1010->SetParameter(0,74.43208);
   quadLineFit1010->SetParError(0,0.06499121);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.48892);
   quadLineFit1010->SetParError(1,1.124849);
   ...
   quadLineFit1011->SetChisquare(0.3232634);
   ...
   quadLineFit1011->SetParameter(0,74.43208);
   quadLineFit1011->SetParError(0,0.06499121);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.48892);
   quadLineFit1011->SetParError(1,1.124849);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.71851);
   Graph_mI50_ppm1011->SetMaximum(72.326);
   ...
   quadLineFit1012->SetChisquare(1.285887);
   ...
   quadLineFit1012->SetParameter(0,74.41752);
   quadLineFit1012->SetParError(0,0.1311296);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.90988);
   quadLineFit1012->SetParError(1,2.346172);
   ...
   quadLineFit1013->SetChisquare(1.285887);
   ...
   quadLineFit1013->SetParameter(0,74.41752);
   quadLineFit1013->SetParError(0,0.1311296);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.90988);
   quadLineFit1013->SetParError(1,2.346172);
