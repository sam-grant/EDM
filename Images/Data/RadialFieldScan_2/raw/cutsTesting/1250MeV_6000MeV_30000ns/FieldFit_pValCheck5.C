...
//=========  (Wed Apr 21 13:19:45 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-42.56257,70,59.13021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.39329);
   Graph_Graph01035->SetMaximum(48.96093);
   ...
   mainFit1036->SetChisquare(2.04349);
   ...
   mainFit1036->SetParameter(0,-0.06712541);
   mainFit1036->SetParError(0,0.5463145);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8034279);
   mainFit1036->SetParError(1,0.01890285);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.681");
   pt_LaTex = pt->AddText("0.803#pm0.0189");
   pt_LaTex = pt->AddText("#minus0.0671#pm0.546");
   pt_LaTex = pt->AddText("#minus0.0835#pm0.679");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.08354877,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.08354877,-32.39329,0.08354877,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.04349);
   ...
   mainFit1037->SetParameter(0,-0.06712541);
   mainFit1037->SetParError(0,0.5463145);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8034279);
   mainFit1037->SetParError(1,0.01890285);
