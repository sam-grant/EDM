...
//=========  (Wed Apr 21 13:19:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-61.30795,50,41.00343);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-51.07681);
   Graph_Graph01025->SetMaximum(30.77229);
   ...
   mainFit1026->SetChisquare(2.043248);
   ...
   mainFit1026->SetParameter(0,-0.3037758);
   mainFit1026->SetParError(0,0.5611497);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7994666);
   mainFit1026->SetParError(1,0.02222028);
   ...
   pt_LaTex = pt->AddText("0.799#pm0.0222");
   pt_LaTex = pt->AddText("#minus0.304#pm0.561");
   pt_LaTex = pt->AddText("#minus0.38#pm0.703");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3799731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3799731,-51.07681,0.3799731,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.043248);
   ...
   mainFit1027->SetParameter(0,-0.3037758);
   mainFit1027->SetParError(0,0.5611497);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7994666);
   mainFit1027->SetParError(1,0.02222028);
