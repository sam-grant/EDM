...
//=========  (Wed Apr 21 13:19:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-52.8998);
   Graph_Graph01031->SetMaximum(50.82516);
   ...
   mainFit1032->SetChisquare(2.041578);
   ...
   mainFit1032->SetParameter(0,-0.3604164);
   mainFit1032->SetParError(0,0.5999155);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8112861);
   mainFit1032->SetParError(1,0.01782027);
   ...
   pt_LaTex = pt->AddText("0.811#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.36#pm  0.6");
   pt_LaTex = pt->AddText("#minus0.444#pm0.737");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4442532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4442532,-52.8998,0.4442532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.041578);
   ...
   mainFit1033->SetParameter(0,-0.3604164);
   mainFit1033->SetParError(0,0.5999155);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8112861);
   mainFit1033->SetParError(1,0.01782027);
