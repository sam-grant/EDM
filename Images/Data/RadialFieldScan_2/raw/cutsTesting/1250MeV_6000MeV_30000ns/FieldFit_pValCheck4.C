...
//=========  (Wed Apr 21 13:19:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.8998);
   Graph_Graph01033->SetMaximum(50.82516);
   ...
   mainFit1034->SetChisquare(2.437395);
   ...
   mainFit1034->SetParameter(0,-0.1388724);
   mainFit1034->SetParError(0,0.6527077);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.807296);
   mainFit1034->SetParError(1,0.02152873);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.812");
   pt_LaTex = pt->AddText("0.807#pm0.0215");
   pt_LaTex = pt->AddText("#minus0.139#pm0.653");
   pt_LaTex = pt->AddText("#minus0.172#pm0.806");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1720217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1720217,-52.8998,0.1720217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.437395);
   ...
   mainFit1035->SetParameter(0,-0.1388724);
   mainFit1035->SetParError(0,0.6527077);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.807296);
   mainFit1035->SetParError(1,0.02152873);
