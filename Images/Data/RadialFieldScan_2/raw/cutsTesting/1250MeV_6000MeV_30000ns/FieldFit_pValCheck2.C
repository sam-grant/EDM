...
//=========  (Wed Apr 21 13:19:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.8998);
   Graph_Graph01029->SetMaximum(50.82516);
   ...
   mainFit1030->SetChisquare(1.992018);
   ...
   mainFit1030->SetParameter(0,-0.3206437);
   mainFit1030->SetParError(0,0.5660956);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.807486);
   mainFit1030->SetParError(1,0.01726647);
   ...
   pt_LaTex = pt->AddText("0.807#pm0.0173");
   pt_LaTex = pt->AddText("#minus0.321#pm0.566");
   pt_LaTex = pt->AddText("#minus0.397#pm  0.7");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3970889,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3970889,-52.8998,0.3970889,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.992018);
   ...
   mainFit1031->SetParameter(0,-0.3206437);
   mainFit1031->SetParError(0,0.5660956);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.807486);
   mainFit1031->SetParError(1,0.01726647);
