...
//=========  (Wed Apr 21 13:19:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.8998);
   Graph_Graph01027->SetMaximum(50.82516);
   ...
   mainFit1028->SetChisquare(0.4511847);
   ...
   mainFit1028->SetParameter(0,0.1989163);
   mainFit1028->SetParError(0,0.5831974);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8204717);
   mainFit1028->SetParError(1,0.01923333);
   ...
   pt_LaTex = pt->AddText(" 0.82#pm0.0192");
   pt_LaTex = pt->AddText("0.199#pm0.583");
   pt_LaTex = pt->AddText("0.242#pm 0.71");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2424413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2424413,-52.8998,-0.2424413,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4511847);
   ...
   mainFit1029->SetParameter(0,0.1989163);
   mainFit1029->SetParError(0,0.5831974);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8204717);
   mainFit1029->SetParError(1,0.01923333);
