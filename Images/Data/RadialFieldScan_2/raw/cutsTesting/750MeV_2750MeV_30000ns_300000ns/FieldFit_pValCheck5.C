...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.27538,70,63.89601);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.25824);
   Graph_Graph01035->SetMaximum(52.87887);
   ...
   mainFit1036->SetChisquare(5.495221);
   ...
   mainFit1036->SetParameter(0,-0.8359261);
   mainFit1036->SetParError(0,0.5169853);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8731331);
   mainFit1036->SetParError(1,0.0178856);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.83");
   pt_LaTex = pt->AddText("0.873#pm0.0179");
   pt_LaTex = pt->AddText("#minus0.836#pm0.517");
   pt_LaTex = pt->AddText("#minus0.957#pm0.587");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.9573869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9573869,-35.25824,0.9573869,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.495221);
   ...
   mainFit1037->SetParameter(0,-0.8359261);
   mainFit1037->SetParError(0,0.5169853);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8731331);
   mainFit1037->SetParError(1,0.0178856);
