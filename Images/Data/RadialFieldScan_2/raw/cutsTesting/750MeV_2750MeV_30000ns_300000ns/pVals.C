...
//=========  (Mon Apr 26 22:54:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-0.5000001,-0.05674523,8.5,1.117274);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01037->SetMinimum(0.06065675);
   Graph_Graph01037->SetMaximum(0.9998725);
