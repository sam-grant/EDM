...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-53.87503);
   Graph_Graph01025->SetMaximum(31.68873);
   ...
   mainFit1026->SetChisquare(2.893002);
   ...
   mainFit1026->SetParameter(0,-1.156554);
   mainFit1026->SetParError(0,0.5310335);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8517609);
   mainFit1026->SetParError(1,0.02103373);
   ...
   pt_LaTex = pt->AddText("0.852#pm0.021");
   pt_LaTex = pt->AddText("#minus1.16#pm0.531");
   pt_LaTex = pt->AddText("#minus1.36#pm0.628");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.357839,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.357839,-53.87503,1.357839,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.893002);
   ...
   mainFit1027->SetParameter(0,-1.156554);
   mainFit1027->SetParError(0,0.5310335);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8517609);
   mainFit1027->SetParError(1,0.02103373);
