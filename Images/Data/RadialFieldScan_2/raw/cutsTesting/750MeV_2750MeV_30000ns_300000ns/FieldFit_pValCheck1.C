...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.81443,75,68.60382);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.9726);
   Graph_Graph01027->SetMaximum(54.76199);
   ...
   mainFit1028->SetChisquare(0.4876117);
   ...
   mainFit1028->SetParameter(0,-0.2827349);
   mainFit1028->SetParError(0,0.5517867);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8913554);
   mainFit1028->SetParError(1,0.01819684);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.163");
   pt_LaTex = pt->AddText("0.891#pm0.0182");
   pt_LaTex = pt->AddText("#minus0.283#pm0.552");
   pt_LaTex = pt->AddText("#minus0.317#pm 0.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3171966,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3171966,-55.9726,0.3171966,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4876117);
   ...
   mainFit1029->SetParameter(0,-0.2827349);
   mainFit1029->SetParError(0,0.5517867);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8913554);
   mainFit1029->SetParError(1,0.01819684);
