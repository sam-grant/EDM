...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.9726);
   Graph_Graph01023->SetMaximum(54.76199);
   ...
   mainFit1024->SetChisquare(5.495362);
   ...
   mainFit1024->SetParameter(0,-0.8377803);
   mainFit1024->SetParError(0,0.4928983);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8732208);
   mainFit1024->SetParError(1,0.01629272);
   ...
   mainFit1025->SetChisquare(5.495362);
   ...
   mainFit1025->SetParameter(0,-0.8377803);
   mainFit1025->SetParError(0,0.4928983);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8732208);
   mainFit1025->SetParError(1,0.01629272);
