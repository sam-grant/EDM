...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.9726);
   Graph_Graph01031->SetMaximum(54.76199);
   ...
   mainFit1032->SetChisquare(5.442158);
   ...
   mainFit1032->SetParameter(0,-0.7727861);
   mainFit1032->SetParError(0,0.5677539);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.872216);
   mainFit1032->SetParError(1,0.01686504);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.773#pm0.568");
   pt_LaTex = pt->AddText("#minus0.886#pm0.647");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8860032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8860032,-55.9726,0.8860032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.442158);
   ...
   mainFit1033->SetParameter(0,-0.7727861);
   mainFit1033->SetParError(0,0.5677539);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.872216);
   mainFit1033->SetParError(1,0.01686504);
