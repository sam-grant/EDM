...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.9726);
   Graph_Graph01020->SetMaximum(54.76199);
   ...
   mainFit1021->SetChisquare(5.495362);
   ...
   mainFit1021->SetParameter(0,-0.8377803);
   mainFit1021->SetParError(0,0.4928983);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8732208);
   mainFit1021->SetParError(1,0.01629272);
   ...
   pt_LaTex = pt->AddText("0.873#pm0.0163");
   pt_LaTex = pt->AddText("#minus0.838#pm0.493");
   pt_LaTex = pt->AddText("#minus0.959#pm0.562");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9594141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9594141,-55.9726,0.9594141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.495362);
   ...
   mainFit1022->SetParameter(0,-0.8377803);
   mainFit1022->SetParError(0,0.4928983);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8732208);
   mainFit1022->SetParError(1,0.01629272);
