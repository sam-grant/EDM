...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02140094);
   Graph_Graph11015->SetMaximum(0.02397761);
   ...
   Graph_Graph21016->SetMinimum(-0.01039288);
   Graph_Graph21016->SetMaximum(0.01224166);
   ...
   Graph_Graph31017->SetMinimum(-0.0401965);
   Graph_Graph31017->SetMaximum(0.03150574);
   ...
   Graph_Graph41018->SetMinimum(-0.01598107);
   Graph_Graph41018->SetMaximum(0.02003909);
   ...
   Graph_Graph51019->SetMinimum(-0.008317856);
   Graph_Graph51019->SetMaximum(0.01111931);
