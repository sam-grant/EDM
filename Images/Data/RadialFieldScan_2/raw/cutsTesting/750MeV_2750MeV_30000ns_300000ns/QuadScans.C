...
//=========  (Mon Apr 26 22:54:50 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.290184);
   ...
   quadLineFit1002->SetParameter(0,74.52982);
   quadLineFit1002->SetParError(0,0.07507304);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.27478);
   quadLineFit1002->SetParError(1,1.259329);
   ...
   quadLineFit1003->SetChisquare(0.290184);
   ...
   quadLineFit1003->SetParameter(0,74.52982);
   quadLineFit1003->SetParError(0,0.07507304);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.27478);
   quadLineFit1003->SetParError(1,1.259329);
   ...
   Graph_30_ppm1003->SetMinimum(75.7914);
   Graph_30_ppm1003->SetMaximum(76.37992);
   ...
   quadLineFit1004->SetChisquare(3.093996);
   ...
   quadLineFit1004->SetParameter(0,74.63713);
   quadLineFit1004->SetParError(0,0.06320667);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.51956);
   quadLineFit1004->SetParError(1,1.038859);
   ...
   quadLineFit1005->SetChisquare(3.093996);
   ...
   quadLineFit1005->SetParameter(0,74.63713);
   quadLineFit1005->SetParError(0,0.06320667);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.51956);
   quadLineFit1005->SetParError(1,1.038859);
   ...
   Graph_10_ppm1005->SetMinimum(74.81431);
   Graph_10_ppm1005->SetMaximum(75.08008);
   ...
   quadLineFit1006->SetChisquare(0.9301999);
   ...
   quadLineFit1006->SetParameter(0,74.38106);
   quadLineFit1006->SetParError(0,0.07404561);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.072617);
   quadLineFit1006->SetParError(1,1.200899);
   ...
   quadLineFit1007->SetChisquare(0.9301999);
   ...
   quadLineFit1007->SetParameter(0,74.38106);
   quadLineFit1007->SetParError(0,0.07404561);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.072617);
   quadLineFit1007->SetParError(1,1.200899);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.6365);
   Graph_mI10_ppm1007->SetMaximum(73.9444);
   ...
   quadLineFit1008->SetChisquare(8.609072);
   ...
   quadLineFit1008->SetParameter(0,74.38171);
   quadLineFit1008->SetParError(0,0.06504289);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.779534);
   quadLineFit1008->SetParError(1,1.0587);
   ...
   quadLineFit1009->SetChisquare(8.609072);
   ...
   quadLineFit1009->SetParameter(0,74.38171);
   quadLineFit1009->SetParError(0,0.06504289);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.779534);
   quadLineFit1009->SetParError(1,1.0587);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.28853);
   Graph_mI30_ppm1009->SetMaximum(72.97757);
   ...
   quadLineFit1010->SetChisquare(3.038944);
   ...
   quadLineFit1010->SetParameter(0,74.29597);
   quadLineFit1010->SetParError(0,0.06151924);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.84879);
   quadLineFit1010->SetParError(1,1.06469);
   ...
   quadLineFit1011->SetChisquare(3.038944);
   ...
   quadLineFit1011->SetParameter(0,74.29597);
   quadLineFit1011->SetParError(0,0.06151924);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.84879);
   quadLineFit1011->SetParError(1,1.06469);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.37732);
   Graph_mI50_ppm1011->SetMaximum(72.01799);
   ...
   quadLineFit1012->SetChisquare(0.6825067);
   ...
   quadLineFit1012->SetParameter(0,74.23859);
   quadLineFit1012->SetParError(0,0.1242055);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.5223);
   quadLineFit1012->SetParError(1,2.222413);
   ...
   quadLineFit1013->SetChisquare(0.6825067);
   ...
   quadLineFit1013->SetParameter(0,74.23859);
   quadLineFit1013->SetParError(0,0.1242055);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.5223);
   quadLineFit1013->SetParError(1,2.222413);
