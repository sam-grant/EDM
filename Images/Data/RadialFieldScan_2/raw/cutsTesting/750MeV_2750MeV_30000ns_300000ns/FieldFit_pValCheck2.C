...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.9726);
   Graph_Graph01029->SetMaximum(54.76199);
   ...
   mainFit1030->SetChisquare(4.337353);
   ...
   mainFit1030->SetParameter(0,-1.063759);
   mainFit1030->SetParError(0,0.5357688);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8718913);
   mainFit1030->SetParError(1,0.01633942);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.06#pm0.536");
   pt_LaTex = pt->AddText("#minus1.22#pm0.612");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.220059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.220059,-55.9726,1.220059,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.337353);
   ...
   mainFit1031->SetParameter(0,-1.063759);
   mainFit1031->SetParError(0,0.5357688);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8718913);
   mainFit1031->SetParError(1,0.01633942);
