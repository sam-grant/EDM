...
//=========  (Mon Apr 26 22:54:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.9726);
   Graph_Graph01033->SetMaximum(54.76199);
   ...
   mainFit1034->SetChisquare(5.435293);
   ...
   mainFit1034->SetParameter(0,-0.9290557);
   mainFit1034->SetParError(0,0.6177708);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8762197);
   mainFit1034->SetParError(1,0.02037573);
   ...
   pt_LaTex = pt->AddText("0.876#pm0.0204");
   pt_LaTex = pt->AddText("#minus0.929#pm0.618");
   pt_LaTex = pt->AddText("#minus1.06#pm0.694");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.0603,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.0603,-55.9726,1.0603,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.435293);
   ...
   mainFit1035->SetParameter(0,-0.9290557);
   mainFit1035->SetParError(0,0.6177708);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8762197);
   mainFit1035->SetParError(1,0.02037573);
