...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.43589,70,58.91842);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.30046);
   Graph_Graph01035->SetMaximum(48.78299);
   ...
   mainFit1036->SetChisquare(4.341734);
   ...
   mainFit1036->SetParameter(0,-0.4680145);
   mainFit1036->SetParError(0,0.9998591);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7609154);
   mainFit1036->SetParError(1,0.03468536);
   ...
   pt_LaTex = pt->AddText("0.761#pm0.0347");
   pt_LaTex = pt->AddText("#minus0.468#pm    1");
   pt_LaTex = pt->AddText("#minus0.615#pm 1.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6150677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6150677,-32.30046,0.6150677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.341734);
   ...
   mainFit1037->SetParameter(0,-0.4680145);
   mainFit1037->SetParError(0,0.9998591);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7609154);
   mainFit1037->SetParError(1,0.03468536);
