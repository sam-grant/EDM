...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-48.31962);
   Graph_Graph01033->SetMaximum(50.23927);
   ...
   mainFit1034->SetChisquare(4.488284);
   ...
   mainFit1034->SetParameter(0,-0.006453678);
   mainFit1034->SetParError(0,1.19424);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7432315);
   mainFit1034->SetParError(1,0.03950302);
   ...
   pt_LaTex = pt->AddText("0.743#pm0.0395");
   pt_LaTex = pt->AddText("#minus0.00645#pm 1.19");
   pt_LaTex = pt->AddText("#minus0.00868#pm 1.61");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.008683267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.008683267,-48.31962,0.008683267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.488284);
   ...
   mainFit1035->SetParameter(0,-0.006453678);
   mainFit1035->SetParError(0,1.19424);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7432315);
   mainFit1035->SetParError(1,0.03950302);
