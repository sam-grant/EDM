...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-55.45418,50,36.63261);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-46.2455);
   Graph_Graph01025->SetMaximum(27.42393);
   ...
   mainFit1026->SetChisquare(3.060108);
   ...
   mainFit1026->SetParameter(0,-0.7792964);
   mainFit1026->SetParError(0,1.026355);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7205764);
   mainFit1026->SetParError(1,0.04065696);
   ...
   pt_LaTex = pt->AddText("0.721#pm0.0407");
   pt_LaTex = pt->AddText("#minus0.779#pm 1.03");
   pt_LaTex = pt->AddText("#minus1.08#pm 1.43");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.08149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.08149,-46.2455,1.08149,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.060108);
   ...
   mainFit1027->SetParameter(0,-0.7792964);
   mainFit1027->SetParError(0,1.026355);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7205764);
   mainFit1027->SetParError(1,0.04065696);
