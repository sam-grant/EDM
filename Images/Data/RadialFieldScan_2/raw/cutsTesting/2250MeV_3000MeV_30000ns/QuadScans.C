...
//=========  (Fri Apr 23 21:35:09 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9046764);
   ...
   quadLineFit1002->SetParameter(0,75.22829);
   quadLineFit1002->SetParError(0,0.1463945);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.5706);
   quadLineFit1002->SetParError(1,2.45543);
   ...
   quadLineFit1003->SetChisquare(0.9046764);
   ...
   quadLineFit1003->SetParameter(0,75.22829);
   quadLineFit1003->SetParError(0,0.1463945);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.5706);
   quadLineFit1003->SetParError(1,2.45543);
   ...
   Graph_30_ppm1003->SetMinimum(76.34632);
   Graph_30_ppm1003->SetMaximum(76.85585);
   ...
   quadLineFit1004->SetChisquare(2.645684);
   ...
   quadLineFit1004->SetParameter(0,75.39585);
   quadLineFit1004->SetParError(0,0.1220897);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,19.27799);
   quadLineFit1004->SetParError(1,2.006817);
   ...
   quadLineFit1005->SetChisquare(2.645684);
   ...
   quadLineFit1005->SetParameter(0,75.39585);
   quadLineFit1005->SetParError(0,0.1220897);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,19.27799);
   quadLineFit1005->SetParError(1,2.006817);
   ...
   Graph_10_ppm1005->SetMinimum(75.37195);
   Graph_10_ppm1005->SetMaximum(75.69138);
   ...
   quadLineFit1006->SetChisquare(0.04459782);
   ...
   quadLineFit1006->SetParameter(0,74.92441);
   quadLineFit1006->SetParError(0,0.1431488);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.804098);
   quadLineFit1006->SetParError(1,2.321382);
   ...
   quadLineFit1007->SetChisquare(0.04459782);
   ...
   quadLineFit1007->SetParameter(0,74.92441);
   quadLineFit1007->SetParError(0,0.1431488);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.804098);
   quadLineFit1007->SetParError(1,2.321382);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.39858);
   Graph_mI10_ppm1007->SetMaximum(74.68817);
   ...
   quadLineFit1008->SetChisquare(1.471663);
   ...
   quadLineFit1008->SetParameter(0,75.04486);
   quadLineFit1008->SetParError(0,0.1256959);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.140202);
   quadLineFit1008->SetParError(1,2.046102);
   ...
   quadLineFit1009->SetChisquare(1.471663);
   ...
   quadLineFit1009->SetParameter(0,75.04486);
   quadLineFit1009->SetParError(0,0.1256959);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.140202);
   quadLineFit1009->SetParError(1,2.046102);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.16602);
   Graph_mI30_ppm1009->SetMaximum(73.78572);
   ...
   quadLineFit1010->SetChisquare(1.531151);
   ...
   quadLineFit1010->SetParameter(0,74.91348);
   quadLineFit1010->SetParError(0,0.1189934);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.48421);
   quadLineFit1010->SetParError(1,2.059298);
   ...
   quadLineFit1011->SetChisquare(1.531151);
   ...
   quadLineFit1011->SetParameter(0,74.91348);
   quadLineFit1011->SetParError(0,0.1189934);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.48421);
   quadLineFit1011->SetParError(1,2.059298);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.30519);
   Graph_mI50_ppm1011->SetMaximum(72.86795);
   ...
   quadLineFit1012->SetChisquare(0.1567909);
   ...
   quadLineFit1012->SetParameter(0,74.63284);
   quadLineFit1012->SetParError(0,0.2402102);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-35.80856);
   quadLineFit1012->SetParError(1,4.29782);
   ...
   quadLineFit1013->SetChisquare(0.1567909);
   ...
   quadLineFit1013->SetParameter(0,74.63284);
   quadLineFit1013->SetParError(0,0.2402102);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-35.80856);
   quadLineFit1013->SetParError(1,4.29782);
