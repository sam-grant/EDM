...
//=========  (Fri Apr 23 21:35:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.31962);
   Graph_Graph01020->SetMaximum(50.23927);
   ...
   mainFit1021->SetChisquare(4.654618);
   ...
   mainFit1021->SetParameter(0,-0.2997095);
   mainFit1021->SetParError(0,0.9535118);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7529045);
   mainFit1021->SetParError(1,0.03159063);
   ...
   pt_LaTex = pt->AddText("0.753#pm0.0316");
   pt_LaTex = pt->AddText(" #minus0.3#pm0.954");
   pt_LaTex = pt->AddText("#minus0.398#pm 1.26");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.398071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.398071,-48.31962,0.398071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.654618);
   ...
   mainFit1022->SetParameter(0,-0.2997095);
   mainFit1022->SetParError(0,0.9535118);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7529045);
   mainFit1022->SetParError(1,0.03159063);
