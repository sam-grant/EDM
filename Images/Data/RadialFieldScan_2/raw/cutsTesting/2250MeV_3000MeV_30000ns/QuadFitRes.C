...
//=========  (Fri Apr 23 21:35:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0354025);
   Graph_Graph11015->SetMaximum(0.04457936);
   ...
   Graph_Graph21016->SetMinimum(-0.004399643);
   Graph_Graph21016->SetMaximum(0.005174112);
   ...
   Graph_Graph31017->SetMinimum(-0.02335685);
   Graph_Graph31017->SetMaximum(0.03548781);
   ...
   Graph_Graph41018->SetMinimum(-0.04658838);
   Graph_Graph41018->SetMaximum(0.02484007);
   ...
   Graph_Graph51019->SetMinimum(-0.007712288);
   Graph_Graph51019->SetMaximum(0.01032369);
