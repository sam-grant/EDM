...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-48.31962);
   Graph_Graph01027->SetMaximum(50.23927);
   ...
   mainFit1028->SetChisquare(1.043446);
   ...
   mainFit1028->SetParameter(0,0.6184738);
   mainFit1028->SetParError(0,1.068945);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.78307);
   mainFit1028->SetParError(1,0.03535468);
   ...
   pt_LaTex = pt->AddText("0.783#pm0.0354");
   pt_LaTex = pt->AddText("0.618#pm 1.07");
   pt_LaTex = pt->AddText(" 0.79#pm 1.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.7898065,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7898065,-48.31962,-0.7898065,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.043446);
   ...
   mainFit1029->SetParameter(0,0.6184738);
   mainFit1029->SetParError(0,1.068945);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.78307);
   mainFit1029->SetParError(1,0.03535468);
