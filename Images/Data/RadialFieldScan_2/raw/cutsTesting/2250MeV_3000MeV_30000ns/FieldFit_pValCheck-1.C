...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-48.31962);
   Graph_Graph01023->SetMaximum(50.23927);
   ...
   mainFit1024->SetChisquare(4.654618);
   ...
   mainFit1024->SetParameter(0,-0.2997095);
   mainFit1024->SetParError(0,0.9535118);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7529045);
   mainFit1024->SetParError(1,0.03159063);
   ...
   mainFit1025->SetChisquare(4.654618);
   ...
   mainFit1025->SetParameter(0,-0.2997095);
   mainFit1025->SetParError(0,0.9535118);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7529045);
   mainFit1025->SetParError(1,0.03159063);
