...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-60.63948,75,62.55914);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-48.31962);
   Graph_Graph01031->SetMaximum(50.23927);
   ...
   mainFit1032->SetChisquare(4.623141);
   ...
   mainFit1032->SetParameter(0,-0.2029681);
   mainFit1032->SetParError(0,1.098409);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7514107);
   mainFit1032->SetParError(1,0.03269334);
   ...
   pt_LaTex = pt->AddText("0.751#pm0.0327");
   pt_LaTex = pt->AddText("#minus0.203#pm  1.1");
   pt_LaTex = pt->AddText("#minus0.27#pm 1.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2701161,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2701161,-48.31962,0.2701161,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.623141);
   ...
   mainFit1033->SetParameter(0,-0.2029681);
   mainFit1033->SetParError(0,1.098409);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7514107);
   mainFit1033->SetParError(1,0.03269334);
