...
//=========  (Fri Apr 23 21:35:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.31962);
   Graph_Graph01029->SetMaximum(50.23927);
   ...
   mainFit1030->SetChisquare(3.173464);
   ...
   mainFit1030->SetParameter(0,-0.7951106);
   mainFit1030->SetParError(0,1.036766);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.749924);
   mainFit1030->SetParError(1,0.03168536);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.0317");
   pt_LaTex = pt->AddText("#minus0.795#pm 1.04");
   pt_LaTex = pt->AddText("#minus1.06#pm 1.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.060255,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.060255,-48.31962,1.060255,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.173464);
   ...
   mainFit1031->SetParameter(0,-0.7951106);
   mainFit1031->SetParError(0,1.036766);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.749924);
   mainFit1031->SetParError(1,0.03168536);
