...
//=========  (Thu Apr 22 00:46:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-83.79735,75,81.00197);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-67.31742);
   Graph_Graph01027->SetMaximum(64.52204);
   ...
   mainFit1028->SetChisquare(0.01814252);
   ...
   mainFit1028->SetParameter(0,-0.2548252);
   mainFit1028->SetParError(0,1.159711);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.025723);
   mainFit1028->SetParError(1,0.03826577);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.00605");
   pt_LaTex = pt->AddText(" 1.03#pm0.0383");
   pt_LaTex = pt->AddText("#minus0.255#pm 1.16");
   pt_LaTex = pt->AddText("#minus0.248#pm 1.13");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2484346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2484346,-67.31742,0.2484346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.01814252);
   ...
   mainFit1029->SetParameter(0,-0.2548252);
   mainFit1029->SetParError(0,1.159711);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.025723);
   mainFit1029->SetParError(1,0.03826577);
