...
//=========  (Thu Apr 22 00:46:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-67.31742);
   Graph_Graph01031->SetMaximum(64.52204);
   ...
   mainFit1032->SetChisquare(3.829606);
   ...
   mainFit1032->SetParameter(0,-1.578158);
   mainFit1032->SetParError(0,1.19309);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9957441);
   mainFit1032->SetParError(1,0.0354517);
   ...
   pt_LaTex = pt->AddText("0.996#pm0.0355");
   pt_LaTex = pt->AddText("#minus1.58#pm 1.19");
   pt_LaTex = pt->AddText("#minus1.58#pm 1.18");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.584903,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.584903,-67.31742,1.584903,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.829606);
   ...
   mainFit1033->SetParameter(0,-1.578158);
   mainFit1033->SetParError(0,1.19309);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9957441);
   mainFit1033->SetParError(1,0.0354517);
