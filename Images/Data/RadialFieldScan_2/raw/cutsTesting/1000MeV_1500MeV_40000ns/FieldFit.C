...
//=========  (Thu Apr 22 00:46:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-67.31742);
   Graph_Graph01020->SetMaximum(64.52204);
   ...
   mainFit1021->SetChisquare(4.047268);
   ...
   mainFit1021->SetParameter(0,-1.301825);
   mainFit1021->SetParError(0,1.035771);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9914609);
   mainFit1021->SetParError(1,0.03425189);
   ...
   mainFit1022->SetChisquare(4.047268);
   ...
   mainFit1022->SetParameter(0,-1.301825);
   mainFit1022->SetParError(0,1.035771);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9914609);
   mainFit1022->SetParError(1,0.03425189);
