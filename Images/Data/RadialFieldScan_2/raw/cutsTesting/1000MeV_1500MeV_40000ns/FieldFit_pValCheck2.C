...
//=========  (Thu Apr 22 00:46:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-67.31742);
   Graph_Graph01029->SetMaximum(64.52204);
   ...
   mainFit1030->SetChisquare(3.612236);
   ...
   mainFit1030->SetParameter(0,-1.593075);
   mainFit1030->SetParError(0,1.125931);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9897533);
   mainFit1030->SetParError(1,0.03435145);
   ...
   pt_LaTex = pt->AddText(" 0.99#pm0.0344");
   pt_LaTex = pt->AddText("#minus1.59#pm 1.13");
   pt_LaTex = pt->AddText("#minus1.61#pm 1.13");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.609567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.609567,-67.31742,1.609567,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.612236);
   ...
   mainFit1031->SetParameter(0,-1.593075);
   mainFit1031->SetParError(0,1.125931);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9897533);
   mainFit1031->SetParError(1,0.03435145);
