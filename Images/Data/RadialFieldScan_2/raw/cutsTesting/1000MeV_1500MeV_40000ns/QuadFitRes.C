...
//=========  (Thu Apr 22 00:46:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04179326);
   Graph_Graph11015->SetMaximum(0.1163804);
   ...
   Graph_Graph21016->SetMinimum(-0.01610876);
   Graph_Graph21016->SetMaximum(0.01903565);
   ...
   Graph_Graph31017->SetMinimum(-0.004193187);
   Graph_Graph31017->SetMaximum(0.004908451);
   ...
   Graph_Graph41018->SetMinimum(-0.02622734);
   Graph_Graph41018->SetMaximum(0.03027067);
   ...
   Graph_Graph51019->SetMinimum(-0.02378262);
   Graph_Graph51019->SetMaximum(0.03184635);
