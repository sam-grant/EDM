...
//=========  (Thu Apr 22 00:46:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-67.31742);
   Graph_Graph01033->SetMaximum(64.52204);
   ...
   mainFit1034->SetChisquare(4.039857);
   ...
   mainFit1034->SetParameter(0,-1.234547);
   mainFit1034->SetParError(0,1.298045);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9892632);
   mainFit1034->SetParError(1,0.04283574);
   ...
   pt_LaTex = pt->AddText("0.989#pm0.0428");
   pt_LaTex = pt->AddText("#minus1.23#pm  1.3");
   pt_LaTex = pt->AddText("#minus1.25#pm 1.29");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.247946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.247946,-67.31742,1.247946,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.039857);
   ...
   mainFit1035->SetParameter(0,-1.234547);
   mainFit1035->SetParError(0,1.298045);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9892632);
   mainFit1035->SetParError(1,0.04283574);
