...
//=========  (Thu Apr 22 00:46:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-55.15838,70,75.27417);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-42.11512);
   Graph_Graph01035->SetMaximum(62.23092);
   ...
   mainFit1036->SetChisquare(4.011469);
   ...
   mainFit1036->SetParameter(0,-1.239955);
   mainFit1036->SetParError(0,1.086275);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9885429);
   mainFit1036->SetParError(1,0.03760012);
   ...
   pt_LaTex = pt->AddText("0.989#pm0.0376");
   pt_LaTex = pt->AddText("#minus1.24#pm 1.09");
   pt_LaTex = pt->AddText("#minus1.25#pm 1.09");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.254326,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.254326,-42.11512,1.254326,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.011469);
   ...
   mainFit1037->SetParameter(0,-1.239955);
   mainFit1037->SetParError(0,1.086275);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9885429);
   mainFit1037->SetParError(1,0.03760012);
