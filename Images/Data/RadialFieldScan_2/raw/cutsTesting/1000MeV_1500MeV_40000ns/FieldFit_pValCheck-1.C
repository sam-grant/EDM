...
//=========  (Thu Apr 22 00:46:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-67.31742);
   Graph_Graph01023->SetMaximum(64.52204);
   ...
   mainFit1024->SetChisquare(4.047268);
   ...
   mainFit1024->SetParameter(0,-1.301825);
   mainFit1024->SetParError(0,1.035771);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9914609);
   mainFit1024->SetParError(1,0.03425189);
   ...
   pt_LaTex = pt->AddText("0.991#pm0.0343");
   pt_LaTex = pt->AddText(" #minus1.3#pm 1.04");
   pt_LaTex = pt->AddText("#minus1.31#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.313037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.313037,-67.31742,1.313037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.047268);
   ...
   mainFit1025->SetParameter(0,-1.301825);
   mainFit1025->SetParError(0,1.035771);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9914609);
   mainFit1025->SetParError(1,0.03425189);
