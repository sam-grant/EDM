...
//=========  (Thu Apr 22 00:46:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-77.20315,50,48.03099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-64.67974);
   Graph_Graph01025->SetMaximum(35.50757);
   ...
   mainFit1026->SetChisquare(2.144701);
   ...
   mainFit1026->SetParameter(0,-1.874907);
   mainFit1026->SetParError(0,1.11593);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9529053);
   mainFit1026->SetParError(1,0.04420386);
   ...
   pt_LaTex = pt->AddText("0.953#pm0.0442");
   pt_LaTex = pt->AddText("#minus1.87#pm 1.12");
   pt_LaTex = pt->AddText("#minus1.97#pm 1.19");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.967569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.967569,-64.67974,1.967569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.144701);
   ...
   mainFit1027->SetParameter(0,-1.874907);
   mainFit1027->SetParError(0,1.11593);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9529053);
   mainFit1027->SetParError(1,0.04420386);
