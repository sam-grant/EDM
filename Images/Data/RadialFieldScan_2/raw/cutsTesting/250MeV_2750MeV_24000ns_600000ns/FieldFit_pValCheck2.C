...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.38471);
   Graph_Graph01029->SetMaximum(56.56583);
   ...
   mainFit1030->SetChisquare(4.836);
   ...
   mainFit1030->SetParameter(0,-1.396769);
   mainFit1030->SetParError(0,0.4523681);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9159375);
   mainFit1030->SetParError(1,0.01377696);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.0138");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.452");
   pt_LaTex = pt->AddText("#minus1.52#pm0.492");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.524961,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.524961,-58.38471,1.524961,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.836);
   ...
   mainFit1031->SetParameter(0,-1.396769);
   mainFit1031->SetParError(0,0.4523681);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9159375);
   mainFit1031->SetParError(1,0.01377696);
