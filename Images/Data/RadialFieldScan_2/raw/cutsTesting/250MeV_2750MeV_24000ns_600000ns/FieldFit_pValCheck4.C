...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.38471);
   Graph_Graph01033->SetMaximum(56.56583);
   ...
   mainFit1034->SetChisquare(5.970957);
   ...
   mainFit1034->SetParameter(0,-1.387812);
   mainFit1034->SetParError(0,0.5219875);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9242843);
   mainFit1034->SetParError(1,0.01718296);
   ...
   pt_LaTex = pt->AddText("0.924#pm0.0172");
   pt_LaTex = pt->AddText("#minus1.39#pm0.522");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.552");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.501499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.501499,-58.38471,1.501499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.970957);
   ...
   mainFit1035->SetParameter(0,-1.387812);
   mainFit1035->SetParError(0,0.5219875);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9242843);
   mainFit1035->SetParError(1,0.01718296);
