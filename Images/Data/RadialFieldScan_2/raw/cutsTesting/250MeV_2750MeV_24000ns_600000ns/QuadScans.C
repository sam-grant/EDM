...
//=========  (Tue Apr 27 00:27:40 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9180359);
   ...
   quadLineFit1002->SetParameter(0,74.47883);
   quadLineFit1002->SetParError(0,0.06309042);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.9284);
   quadLineFit1002->SetParError(1,1.058219);
   ...
   quadLineFit1003->SetChisquare(0.9180359);
   ...
   quadLineFit1003->SetParameter(0,74.47883);
   quadLineFit1003->SetParError(0,0.06309042);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.9284);
   quadLineFit1003->SetParError(1,1.058219);
   ...
   Graph_30_ppm1003->SetMinimum(75.77858);
   Graph_30_ppm1003->SetMaximum(76.39576);
   ...
   quadLineFit1004->SetChisquare(3.164071);
   ...
   quadLineFit1004->SetParameter(0,74.55655);
   quadLineFit1004->SetParError(0,0.05342394);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.85771);
   quadLineFit1004->SetParError(1,0.878044);
   ...
   quadLineFit1005->SetChisquare(3.164071);
   ...
   quadLineFit1005->SetParameter(0,74.55655);
   quadLineFit1005->SetParError(0,0.05342394);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.85771);
   quadLineFit1005->SetParError(1,0.878044);
   ...
   Graph_10_ppm1005->SetMinimum(74.76718);
   Graph_10_ppm1005->SetMaximum(75.02783);
   ...
   quadLineFit1006->SetChisquare(0.7979909);
   ...
   quadLineFit1006->SetParameter(0,74.32731);
   quadLineFit1006->SetParError(0,0.06258799);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.171161);
   quadLineFit1006->SetParError(1,1.015091);
   ...
   quadLineFit1007->SetChisquare(0.7979909);
   ...
   quadLineFit1007->SetParameter(0,74.32731);
   quadLineFit1007->SetParError(0,0.06258799);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.171161);
   quadLineFit1007->SetParError(1,1.015091);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.53089);
   Graph_mI10_ppm1007->SetMaximum(73.84992);
   ...
   quadLineFit1008->SetChisquare(4.896354);
   ...
   quadLineFit1008->SetParameter(0,74.36569);
   quadLineFit1008->SetParError(0,0.05496796);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.05408);
   quadLineFit1008->SetParError(1,0.8947084);
   ...
   quadLineFit1009->SetChisquare(4.896354);
   ...
   quadLineFit1009->SetParameter(0,74.36569);
   quadLineFit1009->SetParError(0,0.05496796);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.05408);
   quadLineFit1009->SetParError(1,0.8947084);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.1449);
   Graph_mI30_ppm1009->SetMaximum(72.86076);
   ...
   quadLineFit1010->SetChisquare(0.8132376);
   ...
   quadLineFit1010->SetParameter(0,74.24467);
   quadLineFit1010->SetParError(0,0.05195589);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.25293);
   quadLineFit1010->SetParError(1,0.8992208);
   ...
   quadLineFit1011->SetChisquare(0.8132376);
   ...
   quadLineFit1011->SetParameter(0,74.24467);
   quadLineFit1011->SetParError(0,0.05195589);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.25293);
   quadLineFit1011->SetParError(1,0.8992208);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.2018);
   ...
   quadLineFit1012->SetChisquare(0.2829183);
   ...
   quadLineFit1012->SetParameter(0,74.20992);
   quadLineFit1012->SetParError(0,0.1049001);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.92852);
   quadLineFit1012->SetParError(1,1.876982);
   ...
   quadLineFit1013->SetChisquare(0.2829183);
   ...
   quadLineFit1013->SetParameter(0,74.20992);
   quadLineFit1013->SetParError(0,0.1049001);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.92852);
   quadLineFit1013->SetParError(1,1.876982);
