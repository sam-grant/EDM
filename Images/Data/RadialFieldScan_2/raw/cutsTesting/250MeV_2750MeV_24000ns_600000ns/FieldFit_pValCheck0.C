...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.44081,50,44.37106);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.25963);
   Graph_Graph01025->SetMaximum(33.18987);
   ...
   mainFit1026->SetChisquare(3.735676);
   ...
   mainFit1026->SetParameter(0,-1.44821);
   mainFit1026->SetParError(0,0.4487552);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8987071);
   mainFit1026->SetParError(1,0.01777144);
   ...
   pt_LaTex = pt->AddText("0.899#pm0.0178");
   pt_LaTex = pt->AddText("#minus1.45#pm0.449");
   pt_LaTex = pt->AddText("#minus1.61#pm0.504");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.611437,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.611437,-56.25963,1.611437,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.735676);
   ...
   mainFit1027->SetParameter(0,-1.44821);
   mainFit1027->SetParError(0,0.4487552);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8987071);
   mainFit1027->SetParError(1,0.01777144);
