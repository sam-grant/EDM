...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.38471);
   Graph_Graph01023->SetMaximum(56.56583);
   ...
   mainFit1024->SetChisquare(6.437439);
   ...
   mainFit1024->SetParameter(0,-1.172715);
   mainFit1024->SetParError(0,0.4162805);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9172359);
   mainFit1024->SetParError(1,0.01373875);
   ...
   mainFit1025->SetChisquare(6.437439);
   ...
   mainFit1025->SetParameter(0,-1.172715);
   mainFit1025->SetParError(0,0.4162805);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9172359);
   mainFit1025->SetParError(1,0.01373875);
