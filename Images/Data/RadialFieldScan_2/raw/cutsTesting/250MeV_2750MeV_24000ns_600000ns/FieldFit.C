...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.38471);
   Graph_Graph01020->SetMaximum(56.56583);
   ...
   mainFit1021->SetChisquare(6.437439);
   ...
   mainFit1021->SetParameter(0,-1.172715);
   mainFit1021->SetParError(0,0.4162805);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9172359);
   mainFit1021->SetParError(1,0.01373875);
   ...
   pt_LaTex = pt->AddText("#minus1.28#pm0.451");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.278532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.278532,-58.38471,1.278532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.437439);
   ...
   mainFit1022->SetParameter(0,-1.172715);
   mainFit1022->SetParError(0,0.4162805);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9172359);
   mainFit1022->SetParError(1,0.01373875);
