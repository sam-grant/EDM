...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01849717);
   Graph_Graph11015->SetMaximum(0.01851647);
   ...
   Graph_Graph21016->SetMinimum(-0.00813895);
   Graph_Graph21016->SetMaximum(0.009581085);
   ...
   Graph_Graph31017->SetMinimum(-0.02393265);
   Graph_Graph31017->SetMaximum(0.02375587);
   ...
   Graph_Graph41018->SetMinimum(-0.00708414);
   Graph_Graph41018->SetMaximum(0.008604933);
   ...
   Graph_Graph51019->SetMinimum(-0.004524056);
   Graph_Graph51019->SetMaximum(0.006046817);
