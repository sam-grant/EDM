...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.75353,75,70.93465);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-58.38471);
   Graph_Graph01027->SetMaximum(56.56583);
   ...
   mainFit1028->SetChisquare(1.871919);
   ...
   mainFit1028->SetParameter(0,-0.7269941);
   mainFit1028->SetParError(0,0.4656225);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9317439);
   mainFit1028->SetParError(1,0.01532505);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.0153");
   pt_LaTex = pt->AddText("#minus0.727#pm0.466");
   pt_LaTex = pt->AddText("#minus0.78#pm0.501");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.780251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.780251,-58.38471,0.780251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.871919);
   ...
   mainFit1029->SetParameter(0,-0.7269941);
   mainFit1029->SetParError(0,0.4656225);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9317439);
   mainFit1029->SetParError(1,0.01532505);
