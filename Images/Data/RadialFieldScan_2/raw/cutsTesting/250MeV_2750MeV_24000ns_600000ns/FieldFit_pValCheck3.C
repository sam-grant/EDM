...
//=========  (Tue Apr 27 00:27:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.38471);
   Graph_Graph01031->SetMaximum(56.56583);
   ...
   mainFit1032->SetChisquare(5.584808);
   ...
   mainFit1032->SetParameter(0,-0.9530373);
   mainFit1032->SetParError(0,0.4794673);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9138375);
   mainFit1032->SetParError(1,0.01422316);
   ...
   pt_LaTex = pt->AddText("0.914#pm0.0142");
   pt_LaTex = pt->AddText("#minus0.953#pm0.479");
   pt_LaTex = pt->AddText("#minus1.04#pm0.521");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.042896,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.042896,-58.38471,1.042896,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.584808);
   ...
   mainFit1033->SetParameter(0,-0.9530373);
   mainFit1033->SetParError(0,0.4794673);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9138375);
   mainFit1033->SetParError(1,0.01422316);
