...
//=========  (Mon Apr 26 22:47:40 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.424401);
   ...
   quadLineFit1002->SetParameter(0,74.59417);
   quadLineFit1002->SetParError(0,0.07515523);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.79084);
   quadLineFit1002->SetParError(1,1.260549);
   ...
   quadLineFit1003->SetChisquare(2.424401);
   ...
   quadLineFit1003->SetParameter(0,74.59417);
   quadLineFit1003->SetParError(0,0.07515523);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.79084);
   quadLineFit1003->SetParError(1,1.260549);
   ...
   Graph_30_ppm1003->SetMinimum(75.78293);
   Graph_30_ppm1003->SetMaximum(76.36344);
   ...
   quadLineFit1004->SetChisquare(5.053096);
   ...
   quadLineFit1004->SetParameter(0,74.67379);
   quadLineFit1004->SetParError(0,0.0636485);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.89309);
   quadLineFit1004->SetParError(1,1.046092);
   ...
   quadLineFit1005->SetChisquare(5.053096);
   ...
   quadLineFit1005->SetParameter(0,74.67379);
   quadLineFit1005->SetParError(0,0.0636485);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.89309);
   quadLineFit1005->SetParError(1,1.046092);
   ...
   Graph_10_ppm1005->SetMinimum(74.84799);
   Graph_10_ppm1005->SetMaximum(75.10664);
   ...
   quadLineFit1006->SetChisquare(0.5745997);
   ...
   quadLineFit1006->SetParameter(0,74.42911);
   quadLineFit1006->SetParError(0,0.07433436);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.808414);
   quadLineFit1006->SetParError(1,1.205559);
   ...
   quadLineFit1007->SetChisquare(0.5745997);
   ...
   quadLineFit1007->SetParameter(0,74.42911);
   quadLineFit1007->SetParError(0,0.07433436);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.808414);
   quadLineFit1007->SetParError(1,1.205559);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.72402);
   Graph_mI10_ppm1007->SetMaximum(73.9933);
   ...
   quadLineFit1008->SetChisquare(3.177432);
   ...
   quadLineFit1008->SetParameter(0,74.37775);
   quadLineFit1008->SetParError(0,0.06544746);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.615464);
   quadLineFit1008->SetParError(1,1.065272);
   ...
   quadLineFit1009->SetChisquare(3.177432);
   ...
   quadLineFit1009->SetParameter(0,74.37775);
   quadLineFit1009->SetParError(0,0.06544746);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.615464);
   quadLineFit1009->SetParError(1,1.065272);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.40878);
   Graph_mI30_ppm1009->SetMaximum(73.06049);
   ...
   quadLineFit1010->SetChisquare(2.933688);
   ...
   quadLineFit1010->SetParameter(0,74.28671);
   quadLineFit1010->SetParError(0,0.06190307);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.037);
   quadLineFit1010->SetParError(1,1.071358);
   ...
   quadLineFit1011->SetChisquare(2.933688);
   ...
   quadLineFit1011->SetParameter(0,74.28671);
   quadLineFit1011->SetParError(0,0.06190307);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.037);
   quadLineFit1011->SetParError(1,1.071358);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.51445);
   Graph_mI50_ppm1011->SetMaximum(72.13559);
   ...
   quadLineFit1012->SetChisquare(0.4105563);
   ...
   quadLineFit1012->SetParameter(0,74.28022);
   quadLineFit1012->SetParError(0,0.1250088);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.03976);
   quadLineFit1012->SetParError(1,2.236733);
   ...
   quadLineFit1013->SetChisquare(0.4105563);
   ...
   quadLineFit1013->SetParameter(0,74.28022);
   quadLineFit1013->SetParError(0,0.1250088);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.03976);
   quadLineFit1013->SetParError(1,2.236733);
