...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.20928);
   Graph_Graph01029->SetMaximum(52.98418);
   ...
   mainFit1030->SetChisquare(4.399617);
   ...
   mainFit1030->SetParameter(0,-0.5092624);
   mainFit1030->SetParError(0,0.538858);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8338319);
   mainFit1030->SetParError(1,0.01641304);
   ...
   pt_LaTex = pt->AddText("#minus0.509#pm0.539");
   pt_LaTex = pt->AddText("#minus0.611#pm0.645");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6107494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6107494,-54.20928,0.6107494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.399617);
   ...
   mainFit1031->SetParameter(0,-0.5092624);
   mainFit1031->SetParError(0,0.538858);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8338319);
   mainFit1031->SetParError(1,0.01641304);
