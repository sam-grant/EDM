...
//=========  (Mon Apr 26 22:47:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0172722);
   Graph_Graph11015->SetMaximum(0.04910005);
   ...
   Graph_Graph21016->SetMinimum(-0.008220386);
   Graph_Graph21016->SetMaximum(0.009688769);
   ...
   Graph_Graph31017->SetMinimum(-0.02603536);
   Graph_Graph31017->SetMaximum(0.02075263);
   ...
   Graph_Graph41018->SetMinimum(-0.01974598);
   Graph_Graph41018->SetMaximum(0.02674266);
   ...
   Graph_Graph51019->SetMinimum(-0.006492443);
   Graph_Graph51019->SetMaximum(0.008680509);
