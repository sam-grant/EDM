...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.20928);
   Graph_Graph01031->SetMaximum(52.98418);
   ...
   mainFit1032->SetChisquare(4.939355);
   ...
   mainFit1032->SetParameter(0,-0.3789537);
   mainFit1032->SetParError(0,0.5709085);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8351478);
   mainFit1032->SetParError(1,0.01694548);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.379#pm0.571");
   pt_LaTex = pt->AddText("#minus0.454#pm0.681");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4537564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4537564,-54.20928,0.4537564,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.939355);
   ...
   mainFit1033->SetParameter(0,-0.3789537);
   mainFit1033->SetParError(0,0.5709085);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8351478);
   mainFit1033->SetParError(1,0.01694548);
