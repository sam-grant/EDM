...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-67.60846,75,66.38336);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-54.20928);
   Graph_Graph01023->SetMaximum(52.98418);
   ...
   mainFit1024->SetChisquare(4.947932);
   ...
   mainFit1024->SetParameter(0,-0.3527145);
   mainFit1024->SetParError(0,0.4956481);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8347413);
   mainFit1024->SetParError(1,0.01636729);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.24");
   pt_LaTex = pt->AddText("0.835#pm0.0164");
   pt_LaTex = pt->AddText("#minus0.353#pm0.496");
   pt_LaTex = pt->AddText("#minus0.423#pm0.592");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4225435,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4225435,-54.20928,0.4225435,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.947932);
   ...
   mainFit1025->SetParameter(0,-0.3527145);
   mainFit1025->SetParError(0,0.4956481);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8347413);
   mainFit1025->SetParError(1,0.01636729);
