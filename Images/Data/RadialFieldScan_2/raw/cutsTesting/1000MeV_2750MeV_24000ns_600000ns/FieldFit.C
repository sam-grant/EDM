...
//=========  (Mon Apr 26 22:47:40 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.20928);
   Graph_Graph01020->SetMaximum(52.98418);
   ...
   mainFit1021->SetChisquare(4.947932);
   ...
   mainFit1021->SetParameter(0,-0.3527145);
   mainFit1021->SetParError(0,0.4956481);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8347413);
   mainFit1021->SetParError(1,0.01636729);
   ...
   mainFit1022->SetChisquare(4.947932);
   ...
   mainFit1022->SetParameter(0,-0.3527145);
   mainFit1022->SetParError(0,0.4956481);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8347413);
   mainFit1022->SetParError(1,0.01636729);
