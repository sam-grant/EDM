...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-62.58041,50,41.2431);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.19806);
   Graph_Graph01025->SetMaximum(30.86075);
   ...
   mainFit1026->SetChisquare(2.496334);
   ...
   mainFit1026->SetParameter(0,-0.664782);
   mainFit1026->SetParError(0,0.53421);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8137083);
   mainFit1026->SetParError(1,0.02117014);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.832");
   pt_LaTex = pt->AddText("0.814#pm0.0212");
   pt_LaTex = pt->AddText("#minus0.665#pm0.534");
   pt_LaTex = pt->AddText("#minus0.817#pm0.659");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.8169784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8169784,-52.19806,0.8169784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.496334);
   ...
   mainFit1027->SetParameter(0,-0.664782);
   mainFit1027->SetParError(0,0.53421);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8137083);
   mainFit1027->SetParError(1,0.02117014);
