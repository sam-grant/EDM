...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.64829,70,61.59133);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.12433);
   Graph_Graph01035->SetMaximum(51.06737);
   ...
   mainFit1036->SetChisquare(4.71971);
   ...
   mainFit1036->SetParameter(0,-0.2776821);
   mainFit1036->SetParError(0,0.5199381);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8312032);
   mainFit1036->SetParError(1,0.01796503);
   ...
   pt_LaTex = pt->AddText("0.831#pm0.018");
   pt_LaTex = pt->AddText("#minus0.278#pm 0.52");
   pt_LaTex = pt->AddText("#minus0.334#pm0.624");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.3340725,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3340725,-33.12433,0.3340725,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.71971);
   ...
   mainFit1037->SetParameter(0,-0.2776821);
   mainFit1037->SetParError(0,0.5199381);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8312032);
   mainFit1037->SetParError(1,0.01796503);
