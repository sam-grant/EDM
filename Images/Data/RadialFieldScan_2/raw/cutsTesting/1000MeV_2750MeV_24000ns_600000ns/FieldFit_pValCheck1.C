...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.20928);
   Graph_Graph01027->SetMaximum(52.98418);
   ...
   mainFit1028->SetChisquare(0.2540471);
   ...
   mainFit1028->SetParameter(0,0.1846875);
   mainFit1028->SetParError(0,0.5542509);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8522569);
   mainFit1028->SetParError(1,0.01825511);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0847");
   pt_LaTex = pt->AddText("0.852#pm0.0183");
   pt_LaTex = pt->AddText("0.185#pm0.554");
   pt_LaTex = pt->AddText("0.217#pm 0.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.216704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.216704,-54.20928,-0.216704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2540471);
   ...
   mainFit1029->SetParameter(0,0.1846875);
   mainFit1029->SetParError(0,0.5542509);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8522569);
   mainFit1029->SetParError(1,0.01825511);
