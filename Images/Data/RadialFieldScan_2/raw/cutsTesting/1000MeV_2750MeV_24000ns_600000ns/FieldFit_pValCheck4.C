...
//=========  (Mon Apr 26 22:47:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.20928);
   Graph_Graph01033->SetMaximum(52.98418);
   ...
   mainFit1034->SetChisquare(4.727413);
   ...
   mainFit1034->SetParameter(0,-0.5286949);
   mainFit1034->SetParError(0,0.6213733);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8405135);
   mainFit1034->SetParError(1,0.020469);
   ...
   pt_LaTex = pt->AddText("0.841#pm0.0205");
   pt_LaTex = pt->AddText("#minus0.529#pm0.621");
   pt_LaTex = pt->AddText("#minus0.629#pm0.732");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6290142,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6290142,-54.20928,0.6290142,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.727413);
   ...
   mainFit1035->SetParameter(0,-0.5286949);
   mainFit1035->SetParError(0,0.6213733);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8405135);
   mainFit1035->SetParError(1,0.020469);
