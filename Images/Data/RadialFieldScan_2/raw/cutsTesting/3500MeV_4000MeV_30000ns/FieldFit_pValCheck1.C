...
//=========  (Wed Apr 21 23:09:26 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-129.9358,75,93.06637);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-107.6356);
   Graph_Graph01027->SetMaximum(70.76615);
   ...
   mainFit1028->SetChisquare(7.238733);
   ...
   mainFit1028->SetParameter(0,9.113624);
   mainFit1028->SetParError(0,4.413305);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9421185);
   mainFit1028->SetParError(1,0.1455911);
   ...
   pt_LaTex = pt->AddText("0.942#pm0.146");
   pt_LaTex = pt->AddText(" 9.11#pm 4.41");
   pt_LaTex = pt->AddText(" 9.67#pm 4.82");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-9.673544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.673544,-107.6356,-9.673544,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(7.238733);
   ...
   mainFit1029->SetParameter(0,9.113624);
   mainFit1029->SetParError(0,4.413305);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9421185);
   mainFit1029->SetParError(1,0.1455911);
