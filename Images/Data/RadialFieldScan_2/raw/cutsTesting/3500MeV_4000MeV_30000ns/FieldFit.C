...
//=========  (Wed Apr 21 23:09:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-107.6356);
   Graph_Graph01020->SetMaximum(70.76615);
   ...
   mainFit1021->SetChisquare(9.463153);
   ...
   mainFit1021->SetParameter(0,6.148676);
   mainFit1021->SetParError(0,3.940198);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8451796);
   mainFit1021->SetParError(1,0.1302792);
   ...
   pt_LaTex = pt->AddText("0.845#pm 0.13");
   pt_LaTex = pt->AddText(" 6.15#pm 3.94");
   pt_LaTex = pt->AddText(" 7.27#pm 4.97");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-7.274993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.274993,-107.6356,-7.274993,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.463153);
   ...
   mainFit1022->SetParameter(0,6.148676);
   mainFit1022->SetParError(0,3.940198);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8451796);
   mainFit1022->SetParError(1,0.1302792);
