...
//=========  (Wed Apr 21 23:09:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-107.6356);
   Graph_Graph01031->SetMaximum(70.76615);
   ...
   mainFit1032->SetChisquare(9.065379);
   ...
   mainFit1032->SetParameter(0,4.714423);
   mainFit1032->SetParError(0,4.549356);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8674305);
   mainFit1032->SetParError(1,0.1349717);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.135");
   pt_LaTex = pt->AddText(" 4.71#pm 4.55");
   pt_LaTex = pt->AddText(" 5.43#pm 5.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-5.434929,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-5.434929,-107.6356,-5.434929,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(9.065379);
   ...
   mainFit1033->SetParameter(0,4.714423);
   mainFit1033->SetParError(0,4.549356);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8674305);
   mainFit1033->SetParError(1,0.1349717);
