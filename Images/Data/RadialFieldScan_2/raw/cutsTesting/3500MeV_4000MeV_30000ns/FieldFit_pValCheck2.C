...
//=========  (Wed Apr 21 23:09:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-107.6356);
   Graph_Graph01029->SetMaximum(70.76615);
   ...
   mainFit1030->SetChisquare(6.192985);
   ...
   mainFit1030->SetParameter(0,3.139084);
   mainFit1030->SetParError(0,4.277258);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8276477);
   mainFit1030->SetParError(1,0.1306394);
   ...
   pt_LaTex = pt->AddText("0.828#pm0.131");
   pt_LaTex = pt->AddText(" 3.14#pm 4.28");
   pt_LaTex = pt->AddText(" 3.79#pm 5.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.792779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.792779,-107.6356,-3.792779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.192985);
   ...
   mainFit1031->SetParameter(0,3.139084);
   mainFit1031->SetParError(0,4.277258);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8276477);
   mainFit1031->SetParError(1,0.1306394);
