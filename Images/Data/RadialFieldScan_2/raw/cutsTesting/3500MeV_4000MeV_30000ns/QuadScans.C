...
//=========  (Wed Apr 21 23:09:25 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1513439);
   ...
   quadLineFit1002->SetParameter(0,75.66852);
   quadLineFit1002->SetParError(0,0.5999923);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.83755);
   quadLineFit1002->SetParError(1,10.06179);
   ...
   quadLineFit1003->SetChisquare(0.1513439);
   ...
   quadLineFit1003->SetParameter(0,75.66852);
   quadLineFit1003->SetParError(0,0.5999923);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.83755);
   quadLineFit1003->SetParError(1,10.06179);
   ...
   Graph_30_ppm1003->SetMinimum(76.82802);
   Graph_30_ppm1003->SetMaximum(77.84944);
   ...
   quadLineFit1004->SetChisquare(5.716929);
   ...
   quadLineFit1004->SetParameter(0,76.04088);
   quadLineFit1004->SetParError(0,0.5031788);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.75152);
   quadLineFit1004->SetParError(1,8.276907);
   ...
   quadLineFit1005->SetChisquare(5.716929);
   ...
   quadLineFit1005->SetParameter(0,76.04088);
   quadLineFit1005->SetParError(0,0.5031788);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.75152);
   quadLineFit1005->SetParError(1,8.276907);
   ...
   Graph_10_ppm1005->SetMinimum(75.86882);
   Graph_10_ppm1005->SetMaximum(77.026);
   ...
   quadLineFit1006->SetChisquare(4.24412);
   ...
   quadLineFit1006->SetParameter(0,74.41991);
   quadLineFit1006->SetParError(0,0.5957465);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,30.55502);
   quadLineFit1006->SetParError(1,9.663224);
   ...
   quadLineFit1007->SetChisquare(4.24412);
   ...
   quadLineFit1007->SetParameter(0,74.41991);
   quadLineFit1007->SetParError(0,0.5957465);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,30.55502);
   quadLineFit1007->SetParError(1,9.663224);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.71819);
   Graph_mI10_ppm1007->SetMaximum(75.34319);
   ...
   quadLineFit1008->SetChisquare(2.128642);
   ...
   quadLineFit1008->SetParameter(0,74.88881);
   quadLineFit1008->SetParError(0,0.5162286);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,2.236106);
   quadLineFit1008->SetParError(1,8.408685);
   ...
   quadLineFit1009->SetChisquare(2.128642);
   ...
   quadLineFit1009->SetParameter(0,74.88881);
   quadLineFit1009->SetParError(0,0.5162286);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,2.236106);
   quadLineFit1009->SetParError(1,8.408685);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.50405);
   Graph_mI30_ppm1009->SetMaximum(74.3439);
   ...
   quadLineFit1010->SetChisquare(4.724284);
   ...
   quadLineFit1010->SetParameter(0,74.85851);
   quadLineFit1010->SetParError(0,0.4931479);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-15.16628);
   quadLineFit1010->SetParError(1,8.541087);
   ...
   quadLineFit1011->SetChisquare(4.724284);
   ...
   quadLineFit1011->SetParameter(0,74.85851);
   quadLineFit1011->SetParError(0,0.4931479);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-15.16628);
   quadLineFit1011->SetParError(1,8.541087);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.28267);
   Graph_mI50_ppm1011->SetMaximum(73.63249);
   ...
   quadLineFit1012->SetChisquare(0.1220759);
   ...
   quadLineFit1012->SetParameter(0,77.21437);
   quadLineFit1012->SetParError(0,0.9948138);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-74.97213);
   quadLineFit1012->SetParError(1,17.79666);
   ...
   quadLineFit1013->SetChisquare(0.1220759);
   ...
   quadLineFit1013->SetParameter(0,77.21437);
   quadLineFit1013->SetParError(0,0.9948138);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-74.97213);
   quadLineFit1013->SetParError(1,17.79666);
