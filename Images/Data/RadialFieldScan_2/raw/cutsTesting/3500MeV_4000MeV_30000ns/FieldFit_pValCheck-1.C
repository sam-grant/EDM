...
//=========  (Wed Apr 21 23:09:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-107.6356);
   Graph_Graph01023->SetMaximum(70.76615);
   ...
   mainFit1024->SetChisquare(9.463153);
   ...
   mainFit1024->SetParameter(0,6.148676);
   mainFit1024->SetParError(0,3.940198);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8451796);
   mainFit1024->SetParError(1,0.1302792);
   ...
   mainFit1025->SetChisquare(9.463153);
   ...
   mainFit1025->SetParameter(0,6.148676);
   mainFit1025->SetParError(0,3.940198);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8451796);
   mainFit1025->SetParError(1,0.1302792);
