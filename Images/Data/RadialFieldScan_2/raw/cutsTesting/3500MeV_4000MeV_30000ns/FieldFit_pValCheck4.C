...
//=========  (Wed Apr 21 23:09:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-107.6356);
   Graph_Graph01033->SetMaximum(70.76615);
   ...
   mainFit1034->SetChisquare(9.023101);
   ...
   mainFit1034->SetParameter(0,4.182715);
   mainFit1034->SetParError(0,4.930338);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9098049);
   mainFit1034->SetParError(1,0.1626759);
   ...
   pt_LaTex = pt->AddText(" 0.91#pm0.163");
   pt_LaTex = pt->AddText(" 4.18#pm 4.93");
   pt_LaTex = pt->AddText("  4.6#pm 5.85");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-4.597376,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-4.597376,-107.6356,-4.597376,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(9.023101);
   ...
   mainFit1035->SetParameter(0,4.182715);
   mainFit1035->SetParError(0,4.930338);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9098049);
   mainFit1035->SetParError(1,0.1626759);
