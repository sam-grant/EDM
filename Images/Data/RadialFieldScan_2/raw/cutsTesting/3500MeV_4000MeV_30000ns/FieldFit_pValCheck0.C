...
//=========  (Wed Apr 21 23:09:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-106.0675);
   Graph_Graph01025->SetMaximum(53.51694);
   ...
   mainFit1026->SetChisquare(9.335392);
   ...
   mainFit1026->SetParameter(0,6.711155);
   mainFit1026->SetParError(0,4.242841);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8831839);
   mainFit1026->SetParError(1,0.1681527);
   ...
   pt_LaTex = pt->AddText("0.883#pm0.168");
   pt_LaTex = pt->AddText(" 6.71#pm 4.24");
   pt_LaTex = pt->AddText("  7.6#pm 4.85");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-7.59882,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-7.59882,-106.0675,-7.59882,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(9.335392);
   ...
   mainFit1027->SetParameter(0,6.711155);
   mainFit1027->SetParError(0,4.242841);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8831839);
   mainFit1027->SetParError(1,0.1681527);
