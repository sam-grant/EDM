...
//=========  (Wed Apr 21 23:09:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.3609108);
   Graph_Graph11015->SetMaximum(0.2016);
   ...
   Graph_Graph21016->SetMinimum(-0.178349);
   Graph_Graph21016->SetMaximum(0.210795);
   ...
   Graph_Graph31017->SetMinimum(-0.1420693);
   Graph_Graph31017->SetMaximum(0.1572548);
   ...
   Graph_Graph41018->SetMinimum(-0.2196214);
   Graph_Graph41018->SetMaximum(0.2466164);
   ...
   Graph_Graph51019->SetMinimum(-0.03781033);
   Graph_Graph51019->SetMaximum(0.02824626);
