...
//=========  (Wed Apr 21 23:09:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.60905,70,75.80102);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.66804);
   Graph_Graph01035->SetMaximum(63.86001);
   ...
   mainFit1036->SetChisquare(3.430511);
   ...
   mainFit1036->SetParameter(0,9.212161);
   mainFit1036->SetParError(0,4.132899);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7003743);
   mainFit1036->SetParError(1,0.1429983);
   ...
   pt_LaTex = pt->AddText("  0.7#pm0.143");
   pt_LaTex = pt->AddText(" 9.21#pm 4.13");
   pt_LaTex = pt->AddText(" 13.2#pm 7.11");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-13.1532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-13.1532,-31.66804,-13.1532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.430511);
   ...
   mainFit1037->SetParameter(0,9.212161);
   mainFit1037->SetParError(0,4.132899);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7003743);
   mainFit1037->SetParError(1,0.1429983);
