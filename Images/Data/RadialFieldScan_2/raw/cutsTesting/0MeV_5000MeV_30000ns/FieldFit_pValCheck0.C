...
//=========  (Fri Apr 23 12:43:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.5806,50,44.41994);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.08054);
   Graph_Graph01025->SetMaximum(32.91988);
   ...
   mainFit1026->SetChisquare(3.387907);
   ...
   mainFit1026->SetParameter(0,-2.299007);
   mainFit1026->SetParError(0,0.4313185);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9130205);
   mainFit1026->SetParError(1,0.01707917);
   ...
   pt_LaTex = pt->AddText("0.913#pm0.0171");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.431");
   pt_LaTex = pt->AddText("#minus2.52#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.518023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.518023,-59.08054,2.518023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.387907);
   ...
   mainFit1027->SetParameter(0,-2.299007);
   mainFit1027->SetParError(0,0.4313185);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9130205);
   mainFit1027->SetParError(1,0.01707917);
