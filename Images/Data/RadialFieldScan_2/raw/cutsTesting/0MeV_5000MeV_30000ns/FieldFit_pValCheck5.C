...
//=========  (Fri Apr 23 12:43:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.38483,70,65.54298);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.89205);
   Graph_Graph01035->SetMaximum(54.0502);
   ...
   mainFit1036->SetChisquare(4.869522);
   ...
   mainFit1036->SetParameter(0,-1.984352);
   mainFit1036->SetParError(0,0.4197884);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9239895);
   mainFit1036->SetParError(1,0.01452444);
   ...
   pt_LaTex = pt->AddText("#minus1.98#pm 0.42");
   pt_LaTex = pt->AddText("#minus2.15#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.147592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.147592,-37.89205,2.147592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.869522);
   ...
   mainFit1037->SetParameter(0,-1.984352);
   mainFit1037->SetParError(0,0.4197884);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9239895);
   mainFit1037->SetParError(1,0.01452444);
