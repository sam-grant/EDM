...
//=========  (Fri Apr 23 12:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.19406);
   Graph_Graph01033->SetMaximum(56.16856);
   ...
   mainFit1034->SetChisquare(4.552752);
   ...
   mainFit1034->SetParameter(0,-2.345619);
   mainFit1034->SetParError(0,0.5018208);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9371478);
   mainFit1034->SetParError(1,0.01655228);
   ...
   pt_LaTex = pt->AddText("#minus2.35#pm0.502");
   pt_LaTex = pt->AddText(" #minus2.5#pm0.516");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.502934,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.502934,-61.19406,2.502934,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.552752);
   ...
   mainFit1035->SetParameter(0,-2.345619);
   mainFit1035->SetParError(0,0.5018208);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9371478);
   mainFit1035->SetParError(1,0.01655228);
