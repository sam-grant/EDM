...
//=========  (Fri Apr 23 12:43:07 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-75.86439,75,70.83889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-61.19406);
   Graph_Graph01027->SetMaximum(56.16856);
   ...
   mainFit1028->SetChisquare(1.192219);
   ...
   mainFit1028->SetParameter(0,-1.661464);
   mainFit1028->SetParError(0,0.4481834);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9416506);
   mainFit1028->SetParError(1,0.01478114);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.397");
   pt_LaTex = pt->AddText("0.942#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.66#pm0.448");
   pt_LaTex = pt->AddText("#minus1.76#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.764417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.764417,-61.19406,1.764417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.192219);
   ...
   mainFit1029->SetParameter(0,-1.661464);
   mainFit1029->SetParError(0,0.4481834);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9416506);
   mainFit1029->SetParError(1,0.01478114);
