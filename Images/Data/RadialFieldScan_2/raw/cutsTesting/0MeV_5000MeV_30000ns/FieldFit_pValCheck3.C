...
//=========  (Fri Apr 23 12:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.19406);
   Graph_Graph01031->SetMaximum(56.16856);
   ...
   mainFit1032->SetChisquare(5.206061);
   ...
   mainFit1032->SetParameter(0,-1.982681);
   mainFit1032->SetParError(0,0.4609608);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9267998);
   mainFit1032->SetParError(1,0.01369394);
   ...
   pt_LaTex = pt->AddText("#minus1.98#pm0.461");
   pt_LaTex = pt->AddText("#minus2.14#pm 0.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.139276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.139276,-61.19406,2.139276,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.206061);
   ...
   mainFit1033->SetParameter(0,-1.982681);
   mainFit1033->SetParError(0,0.4609608);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9267998);
   mainFit1033->SetParError(1,0.01369394);
