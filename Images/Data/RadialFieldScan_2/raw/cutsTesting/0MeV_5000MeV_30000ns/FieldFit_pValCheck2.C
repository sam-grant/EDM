...
//=========  (Fri Apr 23 12:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.19406);
   Graph_Graph01029->SetMaximum(56.16856);
   ...
   mainFit1030->SetChisquare(4.365073);
   ...
   mainFit1030->SetParameter(0,-2.243483);
   mainFit1030->SetParError(0,0.435061);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9271894);
   mainFit1030->SetParError(1,0.01327003);
   ...
   pt_LaTex = pt->AddText("#minus2.24#pm0.435");
   pt_LaTex = pt->AddText("#minus2.42#pm0.466");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.41966,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.41966,-61.19406,2.41966,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.365073);
   ...
   mainFit1031->SetParameter(0,-2.243483);
   mainFit1031->SetParError(0,0.435061);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9271894);
   mainFit1031->SetParError(1,0.01327003);
