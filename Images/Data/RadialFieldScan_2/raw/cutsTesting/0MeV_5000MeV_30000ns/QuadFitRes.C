...
//=========  (Fri Apr 23 12:43:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.007718003);
   Graph_Graph11015->SetMaximum(0.008032846);
   ...
   Graph_Graph21016->SetMinimum(-0.009162607);
   Graph_Graph21016->SetMaximum(0.01076833);
   ...
   Graph_Graph31017->SetMinimum(-0.02542987);
   Graph_Graph31017->SetMaximum(0.02141844);
   ...
   Graph_Graph41018->SetMinimum(-0.006736397);
   Graph_Graph41018->SetMaximum(0.01234708);
   ...
   Graph_Graph51019->SetMinimum(-0.002892147);
   Graph_Graph51019->SetMaximum(0.003863544);
