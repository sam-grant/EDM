...
//=========  (Fri Apr 23 12:43:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.19406);
   Graph_Graph01023->SetMaximum(56.16856);
   ...
   mainFit1024->SetChisquare(5.362849);
   ...
   mainFit1024->SetParameter(0,-2.073189);
   mainFit1024->SetParError(0,0.4002736);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9281915);
   mainFit1024->SetParError(1,0.01323166);
   ...
   pt_LaTex = pt->AddText("0.928#pm0.0132");
   pt_LaTex = pt->AddText("#minus2.07#pm  0.4");
   pt_LaTex = pt->AddText("#minus2.23#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.233579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.233579,-61.19406,2.233579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.362849);
   ...
   mainFit1025->SetParameter(0,-2.073189);
   mainFit1025->SetParError(0,0.4002736);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9281915);
   mainFit1025->SetParError(1,0.01323166);
