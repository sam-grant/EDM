...
//=========  (Fri Apr 23 12:43:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.19406);
   Graph_Graph01020->SetMaximum(56.16856);
   ...
   mainFit1021->SetChisquare(5.362849);
   ...
   mainFit1021->SetParameter(0,-2.073189);
   mainFit1021->SetParError(0,0.4002736);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9281915);
   mainFit1021->SetParError(1,0.01323166);
   ...
   mainFit1022->SetChisquare(5.362849);
   ...
   mainFit1022->SetParameter(0,-2.073189);
   mainFit1022->SetParError(0,0.4002736);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9281915);
   mainFit1022->SetParError(1,0.01323166);
