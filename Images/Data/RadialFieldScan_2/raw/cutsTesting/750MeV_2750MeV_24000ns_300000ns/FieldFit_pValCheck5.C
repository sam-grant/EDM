...
//=========  (Mon Apr 26 22:33:19 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-45.68888,70,63.69943);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.75005);
   Graph_Graph01035->SetMaximum(52.7606);
   ...
   mainFit1036->SetChisquare(5.125123);
   ...
   mainFit1036->SetParameter(0,-0.7089515);
   mainFit1036->SetParError(0,0.4883192);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8675597);
   mainFit1036->SetParError(1,0.01693964);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0169");
   pt_LaTex = pt->AddText("#minus0.709#pm0.488");
   pt_LaTex = pt->AddText("#minus0.817#pm0.559");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8171789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8171789,-34.75005,0.8171789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.125123);
   ...
   mainFit1037->SetParameter(0,-0.7089515);
   mainFit1037->SetParError(0,0.4883192);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8675597);
   mainFit1037->SetParError(1,0.01693964);
