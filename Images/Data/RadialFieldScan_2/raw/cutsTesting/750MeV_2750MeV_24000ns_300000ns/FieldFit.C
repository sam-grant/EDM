...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.08669,75,68.379);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-55.34012);
   Graph_Graph01020->SetMaximum(54.63243);
   ...
   mainFit1021->SetChisquare(5.125133);
   ...
   mainFit1021->SetParameter(0,-0.7084883);
   mainFit1021->SetParError(0,0.4656704);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8675376);
   mainFit1021->SetParError(1,0.01542588);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.28");
   pt_LaTex = pt->AddText("0.868#pm0.0154");
   pt_LaTex = pt->AddText("#minus0.708#pm0.466");
   pt_LaTex = pt->AddText("#minus0.817#pm0.535");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8166659,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8166659,-55.34012,0.8166659,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.125133);
   ...
   mainFit1022->SetParameter(0,-0.7084883);
   mainFit1022->SetParError(0,0.4656704);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8675376);
   mainFit1022->SetParError(1,0.01542588);
