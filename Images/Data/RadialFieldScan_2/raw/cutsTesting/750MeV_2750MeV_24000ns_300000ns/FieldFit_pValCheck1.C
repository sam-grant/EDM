...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.34012);
   Graph_Graph01027->SetMaximum(54.63243);
   ...
   mainFit1028->SetChisquare(0.3431392);
   ...
   mainFit1028->SetParameter(0,-0.1925035);
   mainFit1028->SetParError(0,0.5220389);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.884484);
   mainFit1028->SetParError(1,0.01726307);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.114");
   pt_LaTex = pt->AddText("0.884#pm0.0173");
   pt_LaTex = pt->AddText("#minus0.193#pm0.522");
   pt_LaTex = pt->AddText("#minus0.218#pm0.591");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.217645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.217645,-55.34012,0.217645,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3431392);
   ...
   mainFit1029->SetParameter(0,-0.1925035);
   mainFit1029->SetParError(0,0.5220389);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.884484);
   mainFit1029->SetParError(1,0.01726307);
