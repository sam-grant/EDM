...
//=========  (Mon Apr 26 22:33:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.34012);
   Graph_Graph01031->SetMaximum(54.63243);
   ...
   mainFit1032->SetChisquare(5.112164);
   ...
   mainFit1032->SetParameter(0,-0.6781838);
   mainFit1032->SetParError(0,0.5363366);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8670705);
   mainFit1032->SetParError(1,0.01596179);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  1.7");
   pt_LaTex = pt->AddText("0.867#pm0.016");
   pt_LaTex = pt->AddText("#minus0.678#pm0.536");
   pt_LaTex = pt->AddText("#minus0.782#pm0.615");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7821553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7821553,-55.34012,0.7821553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.112164);
   ...
   mainFit1033->SetParameter(0,-0.6781838);
   mainFit1033->SetParError(0,0.5363366);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8670705);
   mainFit1033->SetParError(1,0.01596179);
