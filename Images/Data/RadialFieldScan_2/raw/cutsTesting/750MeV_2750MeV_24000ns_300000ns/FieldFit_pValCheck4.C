...
//=========  (Mon Apr 26 22:33:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.34012);
   Graph_Graph01033->SetMaximum(54.63243);
   ...
   mainFit1034->SetChisquare(4.96921);
   ...
   mainFit1034->SetParameter(0,-0.8471338);
   mainFit1034->SetParError(0,0.5832075);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8721097);
   mainFit1034->SetParError(1,0.01928784);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.66");
   pt_LaTex = pt->AddText("0.872#pm0.0193");
   pt_LaTex = pt->AddText("#minus0.847#pm0.583");
   pt_LaTex = pt->AddText("#minus0.971#pm0.659");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9713616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9713616,-55.34012,0.9713616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.96921);
   ...
   mainFit1035->SetParameter(0,-0.8471338);
   mainFit1035->SetParError(0,0.5832075);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8721097);
   mainFit1035->SetParError(1,0.01928784);
