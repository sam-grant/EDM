...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.34012);
   Graph_Graph01029->SetMaximum(54.63243);
   ...
   mainFit1030->SetChisquare(4.791286);
   ...
   mainFit1030->SetParameter(0,-0.8233582);
   mainFit1030->SetParError(0,0.5063354);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8668426);
   mainFit1030->SetParError(1,0.01547257);
   ...
   pt_LaTex = pt->AddText("0.867#pm0.0155");
   pt_LaTex = pt->AddText("#minus0.823#pm0.506");
   pt_LaTex = pt->AddText("#minus0.95#pm0.582");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.949836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.949836,-55.34012,0.949836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.791286);
   ...
   mainFit1031->SetParameter(0,-0.8233582);
   mainFit1031->SetParError(0,0.5063354);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8668426);
   mainFit1031->SetParError(1,0.01547257);
