...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02060418);
   Graph_Graph11015->SetMaximum(0.02648949);
   ...
   Graph_Graph21016->SetMinimum(-0.007520402);
   Graph_Graph21016->SetMaximum(0.008857744);
   ...
   Graph_Graph31017->SetMinimum(-0.0363422);
   Graph_Graph31017->SetMaximum(0.02813215);
   ...
   Graph_Graph41018->SetMinimum(-0.0160609);
   Graph_Graph41018->SetMaximum(0.01957413);
   ...
   Graph_Graph51019->SetMinimum(-0.007714444);
   Graph_Graph51019->SetMaximum(0.01031399);
