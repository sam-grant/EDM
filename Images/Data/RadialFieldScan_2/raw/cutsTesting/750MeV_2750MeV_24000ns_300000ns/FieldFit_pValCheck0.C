...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.87102,50,42.30065);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.25385);
   Graph_Graph01025->SetMaximum(31.68348);
   ...
   mainFit1026->SetChisquare(1.668016);
   ...
   mainFit1026->SetParameter(0,-1.05401);
   mainFit1026->SetParError(0,0.5013802);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8442926);
   mainFit1026->SetParError(1,0.01985579);
   ...
   pt_LaTex = pt->AddText("0.844#pm0.0199");
   pt_LaTex = pt->AddText("#minus1.05#pm0.501");
   pt_LaTex = pt->AddText("#minus1.25#pm0.598");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.248394,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.248394,-53.25385,1.248394,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.668016);
   ...
   mainFit1027->SetParameter(0,-1.05401);
   mainFit1027->SetParError(0,0.5013802);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8442926);
   mainFit1027->SetParError(1,0.01985579);
