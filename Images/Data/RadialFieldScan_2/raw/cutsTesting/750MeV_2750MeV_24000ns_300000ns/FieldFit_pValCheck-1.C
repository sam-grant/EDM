...
//=========  (Mon Apr 26 22:33:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.34012);
   Graph_Graph01023->SetMaximum(54.63243);
   ...
   mainFit1024->SetChisquare(5.125133);
   ...
   mainFit1024->SetParameter(0,-0.7084883);
   mainFit1024->SetParError(0,0.4656704);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8675376);
   mainFit1024->SetParError(1,0.01542588);
   ...
   mainFit1025->SetChisquare(5.125133);
   ...
   mainFit1025->SetParameter(0,-0.7084883);
   mainFit1025->SetParError(0,0.4656704);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8675376);
   mainFit1025->SetParError(1,0.01542588);
