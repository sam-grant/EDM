...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.50785,70,59.44215);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.21285);
   Graph_Graph01035->SetMaximum(49.14715);
   ...
   mainFit1036->SetChisquare(5.718649);
   ...
   mainFit1036->SetParameter(0,0.05084084);
   mainFit1036->SetParError(0,0.8223129);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7780494);
   mainFit1036->SetParError(1,0.02839032);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.91");
   pt_LaTex = pt->AddText("0.778#pm0.0284");
   pt_LaTex = pt->AddText("0.0508#pm0.822");
   pt_LaTex = pt->AddText("0.0653#pm 1.06");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.06534397,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.06534397,-33.21285,-0.06534397,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.718649);
   ...
   mainFit1037->SetParameter(0,0.05084084);
   mainFit1037->SetParError(0,0.8223129);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7780494);
   mainFit1037->SetParError(1,0.02839032);
