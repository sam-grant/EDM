...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.62443);
   Graph_Graph01020->SetMaximum(50.5482);
   ...
   mainFit1021->SetChisquare(5.978264);
   ...
   mainFit1021->SetParameter(0,0.1776012);
   mainFit1021->SetParError(0,0.7837769);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7720827);
   mainFit1021->SetParError(1,0.0258627);
   ...
   mainFit1022->SetChisquare(5.978264);
   ...
   mainFit1022->SetParameter(0,0.1776012);
   mainFit1022->SetParError(0,0.7837769);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7720827);
   mainFit1022->SetParError(1,0.0258627);
