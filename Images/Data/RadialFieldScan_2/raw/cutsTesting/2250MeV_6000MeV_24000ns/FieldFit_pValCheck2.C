...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.62443);
   Graph_Graph01029->SetMaximum(50.5482);
   ...
   mainFit1030->SetChisquare(5.076986);
   ...
   mainFit1030->SetParameter(0,-0.1386616);
   mainFit1030->SetParError(0,0.8516432);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7702583);
   mainFit1030->SetParError(1,0.02593369);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.69");
   pt_LaTex = pt->AddText(" 0.77#pm0.0259");
   pt_LaTex = pt->AddText("#minus0.139#pm0.852");
   pt_LaTex = pt->AddText("#minus0.18#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1800195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1800195,-48.62443,0.1800195,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.076986);
   ...
   mainFit1031->SetParameter(0,-0.1386616);
   mainFit1031->SetParError(0,0.8516432);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7702583);
   mainFit1031->SetParError(1,0.02593369);
