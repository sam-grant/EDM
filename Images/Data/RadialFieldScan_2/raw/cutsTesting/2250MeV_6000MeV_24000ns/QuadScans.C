...
//=========  (Wed Apr 21 21:38:10 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.375692);
   ...
   quadLineFit1002->SetParameter(0,75.17303);
   quadLineFit1002->SetParError(0,0.1187359);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.29265);
   quadLineFit1002->SetParError(1,1.991161);
   ...
   quadLineFit1003->SetChisquare(1.375692);
   ...
   quadLineFit1003->SetParameter(0,75.17303);
   quadLineFit1003->SetParError(0,0.1187359);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.29265);
   quadLineFit1003->SetParError(1,1.991161);
   ...
   Graph_30_ppm1003->SetMinimum(76.30773);
   Graph_30_ppm1003->SetMaximum(76.85795);
   ...
   quadLineFit1004->SetChisquare(1.808491);
   ...
   quadLineFit1004->SetParameter(0,75.29713);
   quadLineFit1004->SetParError(0,0.1004453);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.71949);
   quadLineFit1004->SetParError(1,1.651375);
   ...
   quadLineFit1005->SetChisquare(1.808491);
   ...
   quadLineFit1005->SetParameter(0,75.29713);
   quadLineFit1005->SetParError(0,0.1004453);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.71949);
   quadLineFit1005->SetParError(1,1.651375);
   ...
   Graph_10_ppm1005->SetMinimum(75.35753);
   Graph_10_ppm1005->SetMaximum(75.65994);
   ...
   quadLineFit1006->SetChisquare(0.4334556);
   ...
   quadLineFit1006->SetParameter(0,74.91168);
   quadLineFit1006->SetParError(0,0.1178606);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.553635);
   quadLineFit1006->SetParError(1,1.911567);
   ...
   quadLineFit1007->SetChisquare(0.4334556);
   ...
   quadLineFit1007->SetParameter(0,74.91168);
   quadLineFit1007->SetParError(0,0.1178606);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.553635);
   quadLineFit1007->SetParError(1,1.911567);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.3911);
   Graph_mI10_ppm1007->SetMaximum(74.63737);
   ...
   quadLineFit1008->SetChisquare(5.983111);
   ...
   quadLineFit1008->SetParameter(0,74.86639);
   quadLineFit1008->SetParError(0,0.1034749);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.895204);
   quadLineFit1008->SetParError(1,1.684575);
   ...
   quadLineFit1009->SetChisquare(5.983111);
   ...
   quadLineFit1009->SetParameter(0,74.86639);
   quadLineFit1009->SetParError(0,0.1034749);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.895204);
   quadLineFit1009->SetParError(1,1.684575);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.0999);
   Graph_mI30_ppm1009->SetMaximum(73.73914);
   ...
   quadLineFit1010->SetChisquare(2.176492);
   ...
   quadLineFit1010->SetParameter(0,74.92303);
   quadLineFit1010->SetParError(0,0.09788184);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.65534);
   quadLineFit1010->SetParError(1,1.69418);
   ...
   quadLineFit1011->SetChisquare(2.176492);
   ...
   quadLineFit1011->SetParameter(0,74.92303);
   quadLineFit1011->SetParError(0,0.09788184);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.65534);
   quadLineFit1011->SetParError(1,1.69418);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.23838);
   Graph_mI50_ppm1011->SetMaximum(72.80075);
   ...
   quadLineFit1012->SetChisquare(0.05818543);
   ...
   quadLineFit1012->SetParameter(0,74.6202);
   quadLineFit1012->SetParError(0,0.1975372);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-36.8258);
   quadLineFit1012->SetParError(1,3.534252);
   ...
   quadLineFit1013->SetChisquare(0.05818543);
   ...
   quadLineFit1013->SetParameter(0,74.6202);
   quadLineFit1013->SetParError(0,0.1975372);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-36.8258);
   quadLineFit1013->SetParError(1,3.534252);
