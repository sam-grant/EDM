...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-48.62443);
   Graph_Graph01027->SetMaximum(50.5482);
   ...
   mainFit1028->SetChisquare(1.965638);
   ...
   mainFit1028->SetParameter(0,0.9645426);
   mainFit1028->SetParError(0,0.8767202);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7976856);
   mainFit1028->SetParError(1,0.02884857);
   ...
   pt_LaTex = pt->AddText("0.798#pm0.0288");
   pt_LaTex = pt->AddText("0.965#pm0.877");
   pt_LaTex = pt->AddText(" 1.21#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.209176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.209176,-48.62443,-1.209176,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.965638);
   ...
   mainFit1029->SetParameter(0,0.9645426);
   mainFit1029->SetParError(0,0.8767202);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7976856);
   mainFit1029->SetParError(1,0.02884857);
