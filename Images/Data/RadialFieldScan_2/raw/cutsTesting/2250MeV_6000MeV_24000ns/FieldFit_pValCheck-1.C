...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-48.62443);
   Graph_Graph01023->SetMaximum(50.5482);
   ...
   mainFit1024->SetChisquare(5.978264);
   ...
   mainFit1024->SetParameter(0,0.1776012);
   mainFit1024->SetParError(0,0.7837769);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7720827);
   mainFit1024->SetParError(1,0.0258627);
   ...
   pt_LaTex = pt->AddText("0.772#pm0.0259");
   pt_LaTex = pt->AddText("0.178#pm0.784");
   pt_LaTex = pt->AddText(" 0.23#pm 1.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2300287,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2300287,-48.62443,-0.2300287,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.978264);
   ...
   mainFit1025->SetParameter(0,0.1776012);
   mainFit1025->SetParError(0,0.7837769);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7720827);
   mainFit1025->SetParError(1,0.0258627);
