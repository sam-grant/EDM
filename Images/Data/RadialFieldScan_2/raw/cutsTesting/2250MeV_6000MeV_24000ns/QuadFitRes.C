...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03498876);
   Graph_Graph11015->SetMaximum(0.02666615);
   ...
   Graph_Graph21016->SetMinimum(-0.01130443);
   Graph_Graph21016->SetMaximum(0.01329575);
   ...
   Graph_Graph31017->SetMinimum(-0.05211447);
   Graph_Graph31017->SetMaximum(0.04508233);
   ...
   Graph_Graph41018->SetMinimum(-0.04290388);
   Graph_Graph41018->SetMaximum(0.02778911);
   ...
   Graph_Graph51019->SetMinimum(-0.003867139);
   Graph_Graph51019->SetMaximum(0.005168613);
