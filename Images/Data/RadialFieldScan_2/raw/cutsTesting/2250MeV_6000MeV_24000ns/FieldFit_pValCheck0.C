...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-56.04278,50,38.0536);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-46.63314);
   Graph_Graph01025->SetMaximum(28.64396);
   ...
   mainFit1026->SetChisquare(4.84407);
   ...
   mainFit1026->SetParameter(0,-0.1579846);
   mainFit1026->SetParError(0,0.8447427);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7494844);
   mainFit1026->SetParError(1,0.03345091);
   ...
   pt_LaTex = pt->AddText("0.749#pm0.0335");
   pt_LaTex = pt->AddText("#minus0.158#pm0.845");
   pt_LaTex = pt->AddText("#minus0.211#pm 1.13");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.210791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.210791,-46.63314,0.210791,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.84407);
   ...
   mainFit1027->SetParameter(0,-0.1579846);
   mainFit1027->SetParError(0,0.8447427);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7494844);
   mainFit1027->SetParError(1,0.03345091);
