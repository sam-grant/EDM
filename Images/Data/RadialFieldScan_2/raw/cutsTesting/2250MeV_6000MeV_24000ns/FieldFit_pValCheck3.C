...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.02101,75,62.94478);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-48.62443);
   Graph_Graph01031->SetMaximum(50.5482);
   ...
   mainFit1032->SetChisquare(4.678558);
   ...
   mainFit1032->SetParameter(0,-0.3332529);
   mainFit1032->SetParError(0,0.9028286);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7799962);
   mainFit1032->SetParError(1,0.02677802);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.56");
   pt_LaTex = pt->AddText(" 0.78#pm0.0268");
   pt_LaTex = pt->AddText("#minus0.333#pm0.903");
   pt_LaTex = pt->AddText("#minus0.427#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4272494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4272494,-48.62443,0.4272494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.678558);
   ...
   mainFit1033->SetParameter(0,-0.3332529);
   mainFit1033->SetParError(0,0.9028286);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7799962);
   mainFit1033->SetParError(1,0.02677802);
