...
//=========  (Wed Apr 21 21:38:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-48.62443);
   Graph_Graph01033->SetMaximum(50.5482);
   ...
   mainFit1034->SetChisquare(4.058089);
   ...
   mainFit1034->SetParameter(0,0.9991095);
   mainFit1034->SetParError(0,0.982737);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.745171);
   mainFit1034->SetParError(1,0.03234276);
   ...
   pt_LaTex = pt->AddText("0.745#pm0.0323");
   pt_LaTex = pt->AddText("0.999#pm0.983");
   pt_LaTex = pt->AddText(" 1.34#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.340779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.340779,-48.62443,-1.340779,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.058089);
   ...
   mainFit1035->SetParameter(0,0.9991095);
   mainFit1035->SetParError(0,0.982737);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.745171);
   mainFit1035->SetParError(1,0.03234276);
