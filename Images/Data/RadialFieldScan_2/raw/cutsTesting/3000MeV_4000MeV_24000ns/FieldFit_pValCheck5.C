...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-51.19458,70,65.23261);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.55186);
   Graph_Graph01035->SetMaximum(53.58989);
   ...
   mainFit1036->SetChisquare(5.702225);
   ...
   mainFit1036->SetParameter(0,0.3483965);
   mainFit1036->SetParError(0,1.75399);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8073405);
   mainFit1036->SetParError(1,0.06068966);
   ...
   pt_LaTex = pt->AddText("0.807#pm0.0607");
   pt_LaTex = pt->AddText("0.348#pm 1.75");
   pt_LaTex = pt->AddText("0.432#pm 2.18");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4315361,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4315361,-39.55186,-0.4315361,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.702225);
   ...
   mainFit1037->SetParameter(0,0.3483965);
   mainFit1037->SetParError(0,1.75399);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8073405);
   mainFit1037->SetParError(1,0.06068966);
