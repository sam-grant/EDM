...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.07268516);
   Graph_Graph11015->SetMaximum(0.06553696);
   ...
   Graph_Graph21016->SetMinimum(-0.03114276);
   Graph_Graph21016->SetMaximum(0.03661511);
   ...
   Graph_Graph31017->SetMinimum(-0.147177);
   Graph_Graph31017->SetMaximum(0.1078416);
   ...
   Graph_Graph41018->SetMinimum(-0.02716179);
   Graph_Graph41018->SetMaximum(0.01561082);
   ...
   Graph_Graph51019->SetMinimum(-0.001247939);
   Graph_Graph51019->SetMaximum(0.00166174);
