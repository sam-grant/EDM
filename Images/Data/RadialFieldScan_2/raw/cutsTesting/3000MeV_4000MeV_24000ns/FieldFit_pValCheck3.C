...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.76235,75,70.14617);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-61.1715);
   Graph_Graph01031->SetMaximum(55.55531);
   ...
   mainFit1032->SetChisquare(0.4220915);
   ...
   mainFit1032->SetParameter(0,-2.139784);
   mainFit1032->SetParError(0,1.9274);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8535686);
   mainFit1032->SetParError(1,0.05723808);
   ...
   pt_LaTex = pt->AddText("0.854#pm0.0572");
   pt_LaTex = pt->AddText("#minus2.14#pm 1.93");
   pt_LaTex = pt->AddText("#minus2.51#pm 2.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.506868,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.506868,-61.1715,2.506868,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.4220915);
   ...
   mainFit1033->SetParameter(0,-2.139784);
   mainFit1033->SetParError(0,1.9274);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8535686);
   mainFit1033->SetParError(1,0.05723808);
