...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.1715);
   Graph_Graph01029->SetMaximum(55.55531);
   ...
   mainFit1030->SetChisquare(5.899568);
   ...
   mainFit1030->SetParameter(0,0.1848441);
   mainFit1030->SetParError(0,1.817035);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8192638);
   mainFit1030->SetParError(1,0.05543875);
   ...
   pt_LaTex = pt->AddText("0.819#pm0.0554");
   pt_LaTex = pt->AddText("0.185#pm 1.82");
   pt_LaTex = pt->AddText("0.226#pm 2.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2256222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2256222,-61.1715,-0.2256222,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.899568);
   ...
   mainFit1031->SetParameter(0,0.1848441);
   mainFit1031->SetParError(0,1.817035);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8192638);
   mainFit1031->SetParError(1,0.05543875);
