...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-61.1715);
   Graph_Graph01027->SetMaximum(55.55531);
   ...
   mainFit1028->SetChisquare(4.904543);
   ...
   mainFit1028->SetParameter(0,0.9512944);
   mainFit1028->SetParError(0,1.872306);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8464347);
   mainFit1028->SetParError(1,0.06175626);
   ...
   pt_LaTex = pt->AddText("0.846#pm0.0618");
   pt_LaTex = pt->AddText("0.951#pm 1.87");
   pt_LaTex = pt->AddText(" 1.12#pm 2.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.123884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.123884,-61.1715,-1.123884,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.904543);
   ...
   mainFit1029->SetParameter(0,0.9512944);
   mainFit1029->SetParError(0,1.872306);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8464347);
   mainFit1029->SetParError(1,0.06175626);
