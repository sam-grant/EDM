...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.1715);
   Graph_Graph01033->SetMaximum(55.55531);
   ...
   mainFit1034->SetChisquare(3.82959);
   ...
   mainFit1034->SetParameter(0,1.926147);
   mainFit1034->SetParError(0,2.094569);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7589883);
   mainFit1034->SetParError(1,0.06909786);
   ...
   pt_LaTex = pt->AddText("0.759#pm0.0691");
   pt_LaTex = pt->AddText(" 1.93#pm 2.09");
   pt_LaTex = pt->AddText(" 2.54#pm 2.87");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.537782,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.537782,-61.1715,-2.537782,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.82959);
   ...
   mainFit1035->SetParameter(0,1.926147);
   mainFit1035->SetParError(0,2.094569);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7589883);
   mainFit1035->SetParError(1,0.06909786);
