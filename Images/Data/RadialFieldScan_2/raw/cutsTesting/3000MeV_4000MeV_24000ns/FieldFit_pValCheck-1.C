...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.1715);
   Graph_Graph01023->SetMaximum(55.55531);
   ...
   mainFit1024->SetChisquare(5.911865);
   ...
   mainFit1024->SetParameter(0,0.1059822);
   mainFit1024->SetParError(0,1.672175);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8188068);
   mainFit1024->SetParError(1,0.05528184);
   ...
   mainFit1025->SetChisquare(5.911865);
   ...
   mainFit1025->SetParameter(0,0.1059822);
   mainFit1025->SetParError(0,1.672175);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8188068);
   mainFit1025->SetParError(1,0.05528184);
