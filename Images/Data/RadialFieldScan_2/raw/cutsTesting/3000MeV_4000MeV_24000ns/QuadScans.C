...
//=========  (Wed Apr 21 20:10:53 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.262745);
   ...
   quadLineFit1002->SetParameter(0,75.55722);
   quadLineFit1002->SetParError(0,0.2547652);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.55544);
   quadLineFit1002->SetParError(1,4.272637);
   ...
   quadLineFit1003->SetChisquare(3.262745);
   ...
   quadLineFit1003->SetParameter(0,75.55722);
   quadLineFit1003->SetParError(0,0.2547652);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.55544);
   quadLineFit1003->SetParError(1,4.272637);
   ...
   Graph_30_ppm1003->SetMinimum(76.6432);
   Graph_30_ppm1003->SetMaximum(77.36318);
   ...
   quadLineFit1004->SetChisquare(2.528421);
   ...
   quadLineFit1004->SetParameter(0,75.68507);
   quadLineFit1004->SetParError(0,0.2140999);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.87615);
   quadLineFit1004->SetParError(1,3.520444);
   ...
   quadLineFit1005->SetChisquare(2.528421);
   ...
   quadLineFit1005->SetParameter(0,75.68507);
   quadLineFit1005->SetParError(0,0.2140999);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.87615);
   quadLineFit1005->SetParError(1,3.520444);
   ...
   Graph_10_ppm1005->SetMinimum(75.75551);
   Graph_10_ppm1005->SetMaximum(76.10192);
   ...
   quadLineFit1006->SetChisquare(0.7197896);
   ...
   quadLineFit1006->SetParameter(0,75.41629);
   quadLineFit1006->SetParError(0,0.2515517);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.881386);
   quadLineFit1006->SetParError(1,4.08033);
   ...
   quadLineFit1007->SetChisquare(0.7197896);
   ...
   quadLineFit1007->SetParameter(0,75.41629);
   quadLineFit1007->SetParError(0,0.2515517);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.881386);
   quadLineFit1007->SetParError(1,4.08033);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.63171);
   Graph_mI10_ppm1007->SetMaximum(75.02883);
   ...
   quadLineFit1008->SetChisquare(9.355832);
   ...
   quadLineFit1008->SetParameter(0,74.8934);
   quadLineFit1008->SetParError(0,0.2201828);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-0.8789495);
   quadLineFit1008->SetParError(1,3.585251);
   ...
   quadLineFit1009->SetChisquare(9.355832);
   ...
   quadLineFit1009->SetParameter(0,74.8934);
   quadLineFit1009->SetParError(0,0.2201828);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-0.8789495);
   quadLineFit1009->SetParError(1,3.585251);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.25252);
   Graph_mI30_ppm1009->SetMaximum(74.07008);
   ...
   quadLineFit1010->SetChisquare(0.3276234);
   ...
   quadLineFit1010->SetParameter(0,75.39631);
   quadLineFit1010->SetParError(0,0.2089262);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.17357);
   quadLineFit1010->SetParError(1,3.616471);
   ...
   quadLineFit1011->SetChisquare(0.3276234);
   ...
   quadLineFit1011->SetParameter(0,75.39631);
   quadLineFit1011->SetParError(0,0.2089262);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.17357);
   quadLineFit1011->SetParError(1,3.616471);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.36419);
   Graph_mI50_ppm1011->SetMaximum(73.09812);
   ...
   quadLineFit1012->SetChisquare(0.001325552);
   ...
   quadLineFit1012->SetParameter(0,75.23536);
   quadLineFit1012->SetParError(0,0.4215158);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.90326);
   quadLineFit1012->SetParError(1,7.541003);
   ...
   quadLineFit1013->SetChisquare(0.001325552);
   ...
   quadLineFit1013->SetParameter(0,75.23536);
   quadLineFit1013->SetParError(0,0.4215158);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.90326);
   quadLineFit1013->SetParError(1,7.541003);
