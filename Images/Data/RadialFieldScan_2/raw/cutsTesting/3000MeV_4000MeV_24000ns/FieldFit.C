...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.1715);
   Graph_Graph01020->SetMaximum(55.55531);
   ...
   mainFit1021->SetChisquare(5.911865);
   ...
   mainFit1021->SetParameter(0,0.1059822);
   mainFit1021->SetParError(0,1.672175);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8188068);
   mainFit1021->SetParError(1,0.05528184);
   ...
   pt_LaTex = pt->AddText("0.819#pm0.0553");
   pt_LaTex = pt->AddText("0.106#pm 1.67");
   pt_LaTex = pt->AddText("0.129#pm 2.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1294349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1294349,-61.1715,-0.1294349,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.911865);
   ...
   mainFit1022->SetParameter(0,0.1059822);
   mainFit1022->SetParError(0,1.672175);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8188068);
   mainFit1022->SetParError(1,0.05528184);
