...
//=========  (Wed Apr 21 20:10:54 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-70.65448,50,44.60681);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.12835);
   Graph_Graph01025->SetMaximum(33.08068);
   ...
   mainFit1026->SetChisquare(5.884065);
   ...
   mainFit1026->SetParameter(0,-0.005619508);
   mainFit1026->SetParError(0,1.801139);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8112814);
   mainFit1026->SetParError(1,0.07135307);
   ...
   pt_LaTex = pt->AddText("0.811#pm0.0714");
   pt_LaTex = pt->AddText("#minus0.00562#pm  1.8");
   pt_LaTex = pt->AddText("#minus0.00693#pm 2.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.006926707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.006926707,-59.12835,0.006926707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.884065);
   ...
   mainFit1027->SetParameter(0,-0.005619508);
   mainFit1027->SetParError(0,1.801139);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8112814);
   mainFit1027->SetParError(1,0.07135307);
