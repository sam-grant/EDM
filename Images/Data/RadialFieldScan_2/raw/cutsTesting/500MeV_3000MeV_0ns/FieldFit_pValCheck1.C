...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.85038);
   Graph_Graph01027->SetMaximum(55.69287);
   ...
   mainFit1028->SetChisquare(1.026273);
   ...
   mainFit1028->SetParameter(0,-1.749748);
   mainFit1028->SetParError(0,0.3800353);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9397903);
   mainFit1028->SetParError(1,0.01239364);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.342");
   pt_LaTex = pt->AddText(" 0.94#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.75#pm 0.38");
   pt_LaTex = pt->AddText("#minus1.86#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.861849,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.861849,-58.85038,1.861849,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.026273);
   ...
   mainFit1029->SetParameter(0,-1.749748);
   mainFit1029->SetParError(0,0.3800353);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9397903);
   mainFit1029->SetParError(1,0.01239364);
