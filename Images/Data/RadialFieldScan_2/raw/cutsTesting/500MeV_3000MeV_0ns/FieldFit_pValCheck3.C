...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.85038);
   Graph_Graph01031->SetMaximum(55.69287);
   ...
   mainFit1032->SetChisquare(1.29385);
   ...
   mainFit1032->SetParameter(0,-1.76308);
   mainFit1032->SetParError(0,0.392971);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9334817);
   mainFit1032->SetParError(1,0.01158324);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0116");
   pt_LaTex = pt->AddText("#minus1.76#pm0.393");
   pt_LaTex = pt->AddText("#minus1.89#pm0.415");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.888714,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.888714,-58.85038,1.888714,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.29385);
   ...
   mainFit1033->SetParameter(0,-1.76308);
   mainFit1033->SetParError(0,0.392971);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9334817);
   mainFit1033->SetParError(1,0.01158324);
