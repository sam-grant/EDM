...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.16829,75,70.01078);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-58.85038);
   Graph_Graph01029->SetMaximum(55.69287);
   ...
   mainFit1030->SetChisquare(1.228616);
   ...
   mainFit1030->SetParameter(0,-1.985259);
   mainFit1030->SetParError(0,0.3702942);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9348848);
   mainFit1030->SetParError(1,0.01120408);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.0112");
   pt_LaTex = pt->AddText("#minus1.99#pm 0.37");
   pt_LaTex = pt->AddText("#minus2.12#pm0.393");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.123533,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.123533,-58.85038,2.123533,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.228616);
   ...
   mainFit1031->SetParameter(0,-1.985259);
   mainFit1031->SetParError(0,0.3702942);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9348848);
   mainFit1031->SetParError(1,0.01120408);
