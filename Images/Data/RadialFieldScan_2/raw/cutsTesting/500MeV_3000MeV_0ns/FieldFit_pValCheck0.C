...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.23776,50,45.35814);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.87817);
   Graph_Graph01025->SetMaximum(33.99855);
   ...
   mainFit1026->SetChisquare(1.20174);
   ...
   mainFit1026->SetParameter(0,-1.98504);
   mainFit1026->SetParError(0,0.368651);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9288072);
   mainFit1026->SetParError(1,0.01459636);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.401");
   pt_LaTex = pt->AddText("0.929#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.99#pm0.369");
   pt_LaTex = pt->AddText("#minus2.14#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.137193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.137193,-56.87817,2.137193,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.20174);
   ...
   mainFit1027->SetParameter(0,-1.98504);
   mainFit1027->SetParError(0,0.368651);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9288072);
   mainFit1027->SetParError(1,0.01459636);
