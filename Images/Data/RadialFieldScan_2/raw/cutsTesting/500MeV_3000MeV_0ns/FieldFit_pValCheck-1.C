...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.85038);
   Graph_Graph01023->SetMaximum(55.69287);
   ...
   mainFit1024->SetChisquare(1.696332);
   ...
   mainFit1024->SetParameter(0,-1.886805);
   mainFit1024->SetParError(0,0.341163);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9354085);
   mainFit1024->SetParError(1,0.01117798);
   ...
   mainFit1025->SetChisquare(1.696332);
   ...
   mainFit1025->SetParameter(0,-1.886805);
   mainFit1025->SetParError(0,0.341163);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9354085);
   mainFit1025->SetParError(1,0.01117798);
