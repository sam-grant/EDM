...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.629222);
   ...
   quadLineFit1002->SetParameter(0,74.54208);
   quadLineFit1002->SetParError(0,0.05047424);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.30172);
   quadLineFit1002->SetParError(1,0.8458748);
   ...
   quadLineFit1003->SetChisquare(4.629222);
   ...
   quadLineFit1003->SetParameter(0,74.54208);
   quadLineFit1003->SetParError(0,0.05047424);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.30172);
   quadLineFit1003->SetParError(1,0.8458748);
   ...
   Graph_30_ppm1003->SetMinimum(75.79129);
   Graph_30_ppm1003->SetMaximum(76.43593);
   ...
   quadLineFit1004->SetChisquare(1.43439);
   ...
   quadLineFit1004->SetParameter(0,74.53134);
   quadLineFit1004->SetParError(0,0.04390576);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.70425);
   quadLineFit1004->SetParError(1,0.721241);
   ...
   quadLineFit1005->SetChisquare(1.43439);
   ...
   quadLineFit1005->SetParameter(0,74.53134);
   quadLineFit1005->SetParError(0,0.04390576);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.70425);
   quadLineFit1005->SetParError(1,0.721241);
   ...
   Graph_10_ppm1005->SetMinimum(74.81838);
   Graph_10_ppm1005->SetMaximum(75.04804);
   ...
   quadLineFit1006->SetChisquare(5.010355);
   ...
   quadLineFit1006->SetParameter(0,74.42887);
   quadLineFit1006->SetParError(0,0.05147902);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.988513);
   quadLineFit1006->SetParError(1,0.8345195);
   ...
   quadLineFit1007->SetChisquare(5.010355);
   ...
   quadLineFit1007->SetParameter(0,74.42887);
   quadLineFit1007->SetParError(0,0.05147902);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.988513);
   quadLineFit1007->SetParError(1,0.8345195);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.56322);
   Graph_mI10_ppm1007->SetMaximum(73.88614);
   ...
   quadLineFit1008->SetChisquare(3.305453);
   ...
   quadLineFit1008->SetParameter(0,74.43445);
   quadLineFit1008->SetParError(0,0.0451852);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.64121);
   quadLineFit1008->SetParError(1,0.7351216);
   ...
   quadLineFit1009->SetChisquare(3.305453);
   ...
   quadLineFit1009->SetParameter(0,74.43445);
   quadLineFit1009->SetParError(0,0.0451852);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.64121);
   quadLineFit1009->SetParError(1,0.7351216);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.16607);
   Graph_mI30_ppm1009->SetMaximum(72.91976);
   ...
   quadLineFit1010->SetChisquare(1.470288);
   ...
   quadLineFit1010->SetParameter(0,74.39107);
   quadLineFit1010->SetParError(0,0.0426652);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.98292);
   quadLineFit1010->SetParError(1,0.7379834);
   ...
   quadLineFit1011->SetChisquare(1.470288);
   ...
   quadLineFit1011->SetParameter(0,74.39107);
   quadLineFit1011->SetParError(0,0.0426652);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.98292);
   quadLineFit1011->SetParError(1,0.7379834);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.25325);
   Graph_mI50_ppm1011->SetMaximum(71.92515);
   ...
   quadLineFit1012->SetChisquare(0.1833084);
   ...
   quadLineFit1012->SetParameter(0,74.30988);
   quadLineFit1012->SetParError(0,0.08622745);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.76251);
   quadLineFit1012->SetParError(1,1.542606);
   ...
   quadLineFit1013->SetChisquare(0.1833084);
   ...
   quadLineFit1013->SetParameter(0,74.30988);
   quadLineFit1013->SetParError(0,0.08622745);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.76251);
   quadLineFit1013->SetParError(1,1.542606);
