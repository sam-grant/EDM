...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.85038);
   Graph_Graph01020->SetMaximum(55.69287);
   ...
   mainFit1021->SetChisquare(1.696332);
   ...
   mainFit1021->SetParameter(0,-1.886805);
   mainFit1021->SetParError(0,0.341163);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9354085);
   mainFit1021->SetParError(1,0.01117798);
   ...
   pt_LaTex = pt->AddText("#minus1.89#pm0.341");
   pt_LaTex = pt->AddText("#minus2.02#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.017092,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.017092,-58.85038,2.017092,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.696332);
   ...
   mainFit1022->SetParameter(0,-1.886805);
   mainFit1022->SetParError(0,0.341163);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9354085);
   mainFit1022->SetParError(1,0.01117798);
