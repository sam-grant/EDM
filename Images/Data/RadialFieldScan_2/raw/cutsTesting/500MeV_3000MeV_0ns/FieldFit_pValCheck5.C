...
//=========  (Fri Apr 23 21:03:14 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.93803,70,65.36472);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.40775);
   Graph_Graph01035->SetMaximum(53.83445);
   ...
   mainFit1036->SetChisquare(1.271459);
   ...
   mainFit1036->SetParameter(0,-1.957912);
   mainFit1036->SetParError(0,0.3581797);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9386919);
   mainFit1036->SetParError(1,0.01226054);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.424");
   pt_LaTex = pt->AddText("0.939#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.96#pm0.358");
   pt_LaTex = pt->AddText("#minus2.09#pm0.375");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.085788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.085788,-38.40775,2.085788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.271459);
   ...
   mainFit1037->SetParameter(0,-1.957912);
   mainFit1037->SetParError(0,0.3581797);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9386919);
   mainFit1037->SetParError(1,0.01226054);
