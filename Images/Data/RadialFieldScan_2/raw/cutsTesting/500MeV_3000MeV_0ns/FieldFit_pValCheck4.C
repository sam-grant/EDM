...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.85038);
   Graph_Graph01033->SetMaximum(55.69287);
   ...
   mainFit1034->SetChisquare(1.692175);
   ...
   mainFit1034->SetParameter(0,-1.870058);
   mainFit1034->SetParError(0,0.4287934);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9348664);
   mainFit1034->SetParError(1,0.01398738);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.564");
   pt_LaTex = pt->AddText("0.935#pm0.014");
   pt_LaTex = pt->AddText("#minus1.87#pm0.429");
   pt_LaTex = pt->AddText("   #minus2#pm0.445");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.000348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.000348,-58.85038,2.000348,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.692175);
   ...
   mainFit1035->SetParameter(0,-1.870058);
   mainFit1035->SetParError(0,0.4287934);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9348664);
   mainFit1035->SetParError(1,0.01398738);
