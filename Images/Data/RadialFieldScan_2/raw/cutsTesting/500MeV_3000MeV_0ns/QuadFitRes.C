...
//=========  (Fri Apr 23 21:03:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01509643);
   Graph_Graph11015->SetMaximum(0.009692141);
   ...
   Graph_Graph21016->SetMinimum(-0.01674649);
   Graph_Graph21016->SetMaximum(0.01965449);
   ...
   Graph_Graph31017->SetMinimum(-0.01743719);
   Graph_Graph31017->SetMaximum(0.01314338);
   ...
   Graph_Graph41018->SetMinimum(-0.008857116);
   Graph_Graph41018->SetMaximum(0.01067851);
   ...
   Graph_Graph51019->SetMinimum(-0.003000642);
   Graph_Graph51019->SetMaximum(0.003999979);
