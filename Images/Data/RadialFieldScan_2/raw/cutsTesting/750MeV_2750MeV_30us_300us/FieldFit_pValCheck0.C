...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-53.20815);
   Graph_Graph01025->SetMaximum(31.73469);
   ...
   mainFit1026->SetChisquare(1.999269);
   ...
   mainFit1026->SetParameter(0,-0.9801715);
   mainFit1026->SetParError(0,0.504036);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8459866);
   mainFit1026->SetParError(1,0.01996462);
   ...
   pt_LaTex = pt->AddText("0.846#pm 0.02");
   pt_LaTex = pt->AddText("#minus0.98#pm0.504");
   pt_LaTex = pt->AddText("#minus1.16#pm  0.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.158614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.158614,-53.20815,1.158614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.999269);
   ...
   mainFit1027->SetParameter(0,-0.9801715);
   mainFit1027->SetParError(0,0.504036);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8459866);
   mainFit1027->SetParError(1,0.01996462);
