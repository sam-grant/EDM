...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.2834);
   Graph_Graph01023->SetMaximum(54.56239);
   ...
   mainFit1024->SetChisquare(4.759149);
   ...
   mainFit1024->SetParameter(0,-0.6751547);
   mainFit1024->SetParError(0,0.4694308);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8665104);
   mainFit1024->SetParError(1,0.01568503);
   ...
   mainFit1025->SetChisquare(4.759149);
   ...
   mainFit1025->SetParameter(0,-0.6751547);
   mainFit1025->SetParError(0,0.4694308);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8665104);
   mainFit1025->SetParError(1,0.01568503);
