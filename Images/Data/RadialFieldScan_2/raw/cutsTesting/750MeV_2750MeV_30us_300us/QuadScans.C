...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.592748);
   ...
   quadLineFit1002->SetParameter(0,74.53856);
   quadLineFit1002->SetParError(0,0.07430593);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.16145);
   quadLineFit1002->SetParError(1,1.247129);
   ...
   quadLineFit1003->SetChisquare(1.592748);
   ...
   quadLineFit1003->SetParameter(0,74.53856);
   quadLineFit1003->SetParError(0,0.07430593);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.16145);
   quadLineFit1003->SetParError(1,1.247129);
   ...
   Graph_30_ppm1003->SetMinimum(75.78085);
   Graph_30_ppm1003->SetMaximum(76.37389);
   ...
   quadLineFit1004->SetChisquare(3.163927);
   ...
   quadLineFit1004->SetParameter(0,74.62268);
   quadLineFit1004->SetParError(0,0.06000398);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.66989);
   quadLineFit1004->SetParError(1,0.9862272);
   ...
   quadLineFit1005->SetChisquare(3.163927);
   ...
   quadLineFit1005->SetParameter(0,74.62268);
   quadLineFit1005->SetParError(0,0.06000398);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.66989);
   quadLineFit1005->SetParError(1,0.9862272);
   ...
   Graph_10_ppm1005->SetMinimum(74.8153);
   Graph_10_ppm1005->SetMaximum(75.07086);
   ...
   quadLineFit1006->SetChisquare(0.6948736);
   ...
   quadLineFit1006->SetParameter(0,74.3968);
   quadLineFit1006->SetParError(0,0.07029569);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.774248);
   quadLineFit1006->SetParError(1,1.140062);
   ...
   quadLineFit1007->SetChisquare(0.6948736);
   ...
   quadLineFit1007->SetParameter(0,74.3968);
   quadLineFit1007->SetParError(0,0.07029569);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.774248);
   quadLineFit1007->SetParError(1,1.140062);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.64631);
   Graph_mI10_ppm1007->SetMaximum(73.9393);
   ...
   quadLineFit1008->SetChisquare(7.032476);
   ...
   quadLineFit1008->SetParameter(0,74.35393);
   quadLineFit1008->SetParError(0,0.06171712);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.345769);
   quadLineFit1008->SetParError(1,1.004564);
   ...
   quadLineFit1009->SetChisquare(7.032476);
   ...
   quadLineFit1009->SetParameter(0,74.35393);
   quadLineFit1009->SetParError(0,0.06171712);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.345769);
   quadLineFit1009->SetParError(1,1.004564);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29888);
   Graph_mI30_ppm1009->SetMaximum(72.97795);
   ...
   quadLineFit1010->SetChisquare(2.995011);
   ...
   quadLineFit1010->SetParameter(0,74.28117);
   quadLineFit1010->SetParError(0,0.05838175);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.53608);
   quadLineFit1010->SetParError(1,1.010409);
   ...
   quadLineFit1011->SetChisquare(2.995011);
   ...
   quadLineFit1011->SetParameter(0,74.28117);
   quadLineFit1011->SetParError(0,0.05838175);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.53608);
   quadLineFit1011->SetParError(1,1.010409);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38543);
   Graph_mI50_ppm1011->SetMaximum(72.01718);
   ...
   quadLineFit1012->SetChisquare(0.757627);
   ...
   quadLineFit1012->SetParameter(0,74.21361);
   quadLineFit1012->SetParError(0,0.1178726);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.0205);
   quadLineFit1012->SetParError(1,2.109082);
   ...
   quadLineFit1013->SetChisquare(0.757627);
   ...
   quadLineFit1013->SetParameter(0,74.21361);
   quadLineFit1013->SetParError(0,0.1178726);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.0205);
   quadLineFit1013->SetParError(1,2.109082);
