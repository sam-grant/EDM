...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.2834);
   Graph_Graph01033->SetMaximum(54.56239);
   ...
   mainFit1034->SetChisquare(4.723905);
   ...
   mainFit1034->SetParameter(0,-0.7412359);
   mainFit1034->SetParError(0,0.5866146);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8687307);
   mainFit1034->SetParError(1,0.01961304);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.741#pm0.587");
   pt_LaTex = pt->AddText("#minus0.853#pm0.667");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8532401,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8532401,-55.2834,0.8532401,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.723905);
   ...
   mainFit1035->SetParameter(0,-0.7412359);
   mainFit1035->SetParError(0,0.5866146);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8687307);
   mainFit1035->SetParError(1,0.01961304);
