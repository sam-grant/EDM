...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01911432);
   Graph_Graph11015->SetMaximum(0.02905258);
   ...
   Graph_Graph21016->SetMinimum(-0.008525314);
   Graph_Graph21016->SetMaximum(0.01003985);
   ...
   Graph_Graph31017->SetMinimum(-0.03641247);
   Graph_Graph31017->SetMaximum(0.02859591);
   ...
   Graph_Graph41018->SetMinimum(-0.01481067);
   Graph_Graph41018->SetMaximum(0.01920992);
   ...
   Graph_Graph51019->SetMinimum(-0.008316112);
   Graph_Graph51019->SetMaximum(0.01111878);
