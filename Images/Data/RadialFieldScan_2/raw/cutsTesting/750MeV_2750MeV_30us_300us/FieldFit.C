...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.2834);
   Graph_Graph01020->SetMaximum(54.56239);
   ...
   mainFit1021->SetChisquare(4.759149);
   ...
   mainFit1021->SetParameter(0,-0.6751547);
   mainFit1021->SetParError(0,0.4694308);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8665104);
   mainFit1021->SetParError(1,0.01568503);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.19");
   pt_LaTex = pt->AddText("0.867#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.675#pm0.469");
   pt_LaTex = pt->AddText("#minus0.779#pm 0.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7791651,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7791651,-55.2834,0.7791651,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.759149);
   ...
   mainFit1022->SetParameter(0,-0.6751547);
   mainFit1022->SetParError(0,0.4694308);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8665104);
   mainFit1022->SetParError(1,0.01568503);
