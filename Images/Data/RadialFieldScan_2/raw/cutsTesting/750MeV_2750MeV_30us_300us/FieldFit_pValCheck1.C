...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.01412,75,68.29312);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.2834);
   Graph_Graph01027->SetMaximum(54.56239);
   ...
   mainFit1028->SetChisquare(0.1808118);
   ...
   mainFit1028->SetParameter(0,-0.1529234);
   mainFit1028->SetParError(0,0.5290973);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8840254);
   mainFit1028->SetParError(1,0.01769072);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0603");
   pt_LaTex = pt->AddText("0.884#pm0.0177");
   pt_LaTex = pt->AddText("#minus0.153#pm0.529");
   pt_LaTex = pt->AddText("#minus0.173#pm0.599");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1729852,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1729852,-55.2834,0.1729852,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1808118);
   ...
   mainFit1029->SetParameter(0,-0.1529234);
   mainFit1029->SetParError(0,0.5290973);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8840254);
   mainFit1029->SetParError(1,0.01769072);
