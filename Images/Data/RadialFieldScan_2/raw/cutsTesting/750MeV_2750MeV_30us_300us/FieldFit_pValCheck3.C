...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.2834);
   Graph_Graph01031->SetMaximum(54.56239);
   ...
   mainFit1032->SetChisquare(4.75911);
   ...
   mainFit1032->SetParameter(0,-0.673523);
   mainFit1032->SetParError(0,0.5405926);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8664946);
   mainFit1032->SetParError(1,0.01621086);
   ...
   pt_LaTex = pt->AddText("0.866#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.674#pm0.541");
   pt_LaTex = pt->AddText("#minus0.777#pm 0.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7772962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7772962,-55.2834,0.7772962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.75911);
   ...
   mainFit1033->SetParameter(0,-0.673523);
   mainFit1033->SetParError(0,0.5405926);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8664946);
   mainFit1033->SetParError(1,0.01621086);
