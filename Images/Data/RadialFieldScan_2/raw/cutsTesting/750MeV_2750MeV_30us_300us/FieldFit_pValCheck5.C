...
//=========  (Wed Apr 28 15:09:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-45.78525,70,63.64734);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.84199);
   Graph_Graph01035->SetMaximum(52.70408);
   ...
   mainFit1036->SetChisquare(4.759042);
   ...
   mainFit1036->SetParameter(0,-0.6736873);
   mainFit1036->SetParError(0,0.4916846);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8664466);
   mainFit1036->SetParError(1,0.01723401);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.59");
   pt_LaTex = pt->AddText("0.866#pm0.0172");
   pt_LaTex = pt->AddText("#minus0.674#pm0.492");
   pt_LaTex = pt->AddText("#minus0.778#pm0.564");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.7775289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7775289,-34.84199,0.7775289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.759042);
   ...
   mainFit1037->SetParameter(0,-0.6736873);
   mainFit1037->SetParError(0,0.4916846);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8664466);
   mainFit1037->SetParError(1,0.01723401);
