...
//=========  (Wed Apr 28 15:09:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.2834);
   Graph_Graph01029->SetMaximum(54.56239);
   ...
   mainFit1030->SetChisquare(4.187642);
   ...
   mainFit1030->SetParameter(0,-0.8279893);
   mainFit1030->SetParError(0,0.511093);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8655063);
   mainFit1030->SetParError(1,0.01574223);
   ...
   pt_LaTex = pt->AddText("0.866#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.828#pm0.511");
   pt_LaTex = pt->AddText("#minus0.957#pm0.589");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.956653,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.956653,-55.2834,0.956653,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.187642);
   ...
   mainFit1031->SetParameter(0,-0.8279893);
   mainFit1031->SetParError(0,0.511093);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8655063);
   mainFit1031->SetParError(1,0.01574223);
