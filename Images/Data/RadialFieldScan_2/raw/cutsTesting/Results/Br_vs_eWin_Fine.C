...
//=========  (Tue Apr 27 01:01:20 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-225,-5.3125,3225,7.8125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01007 = new TH1F("Graph_Graph01007","",100,0,3000);
   Graph_Graph01007->SetMinimum(-4);
   Graph_Graph01007->SetMaximum(6.5);
   ...
   Graph_Graph01007->GetXaxis()->SetTitle("E_{window} [MeV]: in range E #minus 250 < E < E #plus 250 MeV");
   ...
   TH1F *Graph_Graph11008 = new TH1F("Graph_Graph11008","Graph",100,0,3000);
   Graph_Graph11008->SetMinimum(-3.615189);
   Graph_Graph11008->SetMaximum(5.070633);
   ...
   TH1F *Graph_Graph21009 = new TH1F("Graph_Graph21009","Graph",100,0,3000);
   Graph_Graph21009->SetMinimum(-3.223039);
   Graph_Graph21009->SetMaximum(5.507856);
