...
//=========  (Mon Apr 26 21:06:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11005->SetMinimum(0.6248471);
   Graph_Graph11005->SetMaximum(1.957211);
   ...
   Graph_Graph21006->SetMinimum(0.3379075);
   Graph_Graph21006->SetMaximum(2.167452);
   ...
   entry->SetTextFont(42);
   leg->Draw();
   TLine *line = new TLine(-33,1.5,3168,1.5);
   line->SetLineStyle(3);
   line->SetLineWidth(3);
   line->Draw();
   line = new TLine(-33,1,3168,1);
   line->SetLineStyle(2);
   line->SetLineWidth(3);
   line->Draw();
   line = new TLine(-33,0.5,3168,0.5);
   line->SetLineStyle(3);
   line->SetLineWidth(3);
   line->Draw();
   c->Modified();
