...
//=========  (Wed Apr 28 14:24:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.626802);
   ...
   quadLineFit1002->SetParameter(0,74.81936);
   quadLineFit1002->SetParError(0,0.07302267);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.7434);
   quadLineFit1002->SetParError(1,1.22422);
   ...
   quadLineFit1003->SetChisquare(2.626802);
   ...
   quadLineFit1003->SetParameter(0,74.81936);
   quadLineFit1003->SetParError(0,0.07302267);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.7434);
   quadLineFit1003->SetParError(1,1.22422);
   ...
   Graph_30_ppm1003->SetMinimum(75.88995);
   Graph_30_ppm1003->SetMaximum(76.50084);
   ...
   quadLineFit1004->SetChisquare(1.142007);
   ...
   quadLineFit1004->SetParameter(0,74.70703);
   quadLineFit1004->SetParError(0,0.06141784);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.19249);
   quadLineFit1004->SetParError(1,1.008828);
   ...
   quadLineFit1005->SetChisquare(1.142007);
   ...
   quadLineFit1005->SetParameter(0,74.70703);
   quadLineFit1005->SetParError(0,0.06141784);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.19249);
   quadLineFit1005->SetParError(1,1.008828);
   ...
   Graph_10_ppm1005->SetMinimum(74.96873);
   Graph_10_ppm1005->SetMaximum(75.19708);
   ...
   quadLineFit1006->SetChisquare(0.01431871);
   ...
   quadLineFit1006->SetParameter(0,74.60533);
   quadLineFit1006->SetParError(0,0.07206314);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.750104);
   quadLineFit1006->SetParError(1,1.16803);
   ...
   quadLineFit1007->SetChisquare(0.01431871);
   ...
   quadLineFit1007->SetParameter(0,74.60533);
   quadLineFit1007->SetParError(0,0.07206314);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.750104);
   quadLineFit1007->SetParError(1,1.16803);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.84682);
   Graph_mI10_ppm1007->SetMaximum(74.15069);
   ...
   quadLineFit1008->SetChisquare(4.597812);
   ...
   quadLineFit1008->SetParameter(0,74.5946);
   quadLineFit1008->SetParError(0,0.06318644);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.97513);
   quadLineFit1008->SetParError(1,1.027756);
   ...
   quadLineFit1009->SetChisquare(4.597812);
   ...
   quadLineFit1009->SetParameter(0,74.5946);
   quadLineFit1009->SetParError(0,0.06318644);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.97513);
   quadLineFit1009->SetParError(1,1.027756);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.54069);
   Graph_mI30_ppm1009->SetMaximum(73.24644);
   ...
   quadLineFit1010->SetChisquare(0.3190699);
   ...
   quadLineFit1010->SetParameter(0,74.59983);
   quadLineFit1010->SetParError(0,0.05970955);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.69467);
   quadLineFit1010->SetParError(1,1.032653);
   ...
   quadLineFit1011->SetChisquare(0.3190699);
   ...
   quadLineFit1011->SetParameter(0,74.59983);
   quadLineFit1011->SetParError(0,0.05970955);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.69467);
   quadLineFit1011->SetParError(1,1.032653);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.68596);
   Graph_mI50_ppm1011->SetMaximum(72.31785);
   ...
   quadLineFit1012->SetChisquare(0.2040308);
   ...
   quadLineFit1012->SetParameter(0,74.50631);
   quadLineFit1012->SetParError(0,0.1206349);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.93402);
   quadLineFit1012->SetParError(1,2.157923);
   ...
   quadLineFit1013->SetChisquare(0.2040308);
   ...
   quadLineFit1013->SetParameter(0,74.50631);
   quadLineFit1013->SetParError(0,0.1206349);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.93402);
   quadLineFit1013->SetParError(1,2.157923);
