...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.89791);
   Graph_Graph01020->SetMaximum(50.77358);
   ...
   mainFit1021->SetChisquare(0.8313288);
   ...
   mainFit1021->SetParameter(0,-1.536365);
   mainFit1021->SetParError(0,0.4785948);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8553572);
   mainFit1021->SetParError(1,0.01582149);
   ...
   pt_LaTex = pt->AddText("#minus1.54#pm0.479");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.555");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.796168,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.796168,-54.89791,1.796168,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(0.8313288);
   ...
   mainFit1022->SetParameter(0,-1.536365);
   mainFit1022->SetParError(0,0.4785948);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8553572);
   mainFit1022->SetParError(1,0.01582149);
