...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.91527,50,43.02464);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.22127);
   Graph_Graph01025->SetMaximum(32.33065);
   ...
   mainFit1026->SetChisquare(0.5197385);
   ...
   mainFit1026->SetParameter(0,-1.429176);
   mainFit1026->SetParError(0,0.5157012);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8625715);
   mainFit1026->SetParError(1,0.0204197);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0204");
   pt_LaTex = pt->AddText("#minus1.43#pm0.516");
   pt_LaTex = pt->AddText("#minus1.66#pm0.604");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.656878,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.656878,-53.22127,1.656878,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.5197385);
   ...
   mainFit1027->SetParameter(0,-1.429176);
   mainFit1027->SetParError(0,0.5157012);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8625715);
   mainFit1027->SetParError(1,0.0204197);
