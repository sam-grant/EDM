...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.40107,70,59.64136);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.79682);
   Graph_Graph01035->SetMaximum(49.03712);
   ...
   mainFit1036->SetChisquare(0.7939948);
   ...
   mainFit1036->SetParameter(0,-1.565607);
   mainFit1036->SetParError(0,0.5019063);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8567491);
   mainFit1036->SetParError(1,0.01736627);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.265");
   pt_LaTex = pt->AddText("0.857#pm0.0174");
   pt_LaTex = pt->AddText("#minus1.57#pm0.502");
   pt_LaTex = pt->AddText("#minus1.83#pm0.577");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.827381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.827381,-35.79682,1.827381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.7939948);
   ...
   mainFit1037->SetParameter(0,-1.565607);
   mainFit1037->SetParError(0,0.5019063);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8567491);
   mainFit1037->SetParError(1,0.01736627);
