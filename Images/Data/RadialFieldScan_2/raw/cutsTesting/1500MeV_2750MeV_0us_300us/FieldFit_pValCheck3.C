...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.89791);
   Graph_Graph01031->SetMaximum(50.77358);
   ...
   mainFit1032->SetChisquare(0.8143488);
   ...
   mainFit1032->SetParameter(0,-1.572039);
   mainFit1032->SetParError(0,0.5512512);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8559156);
   mainFit1032->SetParError(1,0.01637485);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.271");
   pt_LaTex = pt->AddText("0.856#pm0.0164");
   pt_LaTex = pt->AddText("#minus1.57#pm0.551");
   pt_LaTex = pt->AddText("#minus1.84#pm0.636");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.836676,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.836676,-54.89791,1.836676,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.8143488);
   ...
   mainFit1033->SetParameter(0,-1.572039);
   mainFit1033->SetParError(0,0.5512512);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8559156);
   mainFit1033->SetParError(1,0.01637485);
