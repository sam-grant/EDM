...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.89791);
   Graph_Graph01023->SetMaximum(50.77358);
   ...
   mainFit1024->SetChisquare(0.8313288);
   ...
   mainFit1024->SetParameter(0,-1.536365);
   mainFit1024->SetParError(0,0.4785948);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8553572);
   mainFit1024->SetParError(1,0.01582149);
   ...
   mainFit1025->SetChisquare(0.8313288);
   ...
   mainFit1025->SetParameter(0,-1.536365);
   mainFit1025->SetParError(0,0.4785948);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8553572);
   mainFit1025->SetParError(1,0.01582149);
