...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.89791);
   Graph_Graph01029->SetMaximum(50.77358);
   ...
   mainFit1030->SetChisquare(0.3579803);
   ...
   mainFit1030->SetParameter(0,-1.676466);
   mainFit1030->SetParError(0,0.5200984);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.854536);
   mainFit1030->SetParError(1,0.01586734);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.119");
   pt_LaTex = pt->AddText("0.855#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.68#pm 0.52");
   pt_LaTex = pt->AddText("#minus1.96#pm0.605");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.961844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.961844,-54.89791,1.961844,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3579803);
   ...
   mainFit1031->SetParameter(0,-1.676466);
   mainFit1031->SetParError(0,0.5200984);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.854536);
   mainFit1031->SetParError(1,0.01586734);
