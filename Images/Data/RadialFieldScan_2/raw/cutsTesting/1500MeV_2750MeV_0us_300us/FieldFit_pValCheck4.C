...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.89791);
   Graph_Graph01033->SetMaximum(50.77358);
   ...
   mainFit1034->SetChisquare(0.3723746);
   ...
   mainFit1034->SetParameter(0,-1.291251);
   mainFit1034->SetParError(0,0.5999943);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.84731);
   mainFit1034->SetParError(1,0.01979174);
   ...
   pt_LaTex = pt->AddText("0.847#pm0.0198");
   pt_LaTex = pt->AddText("#minus1.29#pm  0.6");
   pt_LaTex = pt->AddText("#minus1.52#pm0.692");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.523942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.523942,-54.89791,1.523942,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.3723746);
   ...
   mainFit1035->SetParameter(0,-1.291251);
   mainFit1035->SetParError(0,0.5999943);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.84731);
   mainFit1035->SetParError(1,0.01979174);
