...
//=========  (Wed Apr 28 14:24:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01301914);
   Graph_Graph11015->SetMaximum(0.01225673);
   ...
   Graph_Graph21016->SetMinimum(-0.001251409);
   Graph_Graph21016->SetMaximum(0.001468215);
   ...
   Graph_Graph31017->SetMinimum(-0.02928149);
   Graph_Graph31017->SetMaximum(0.02970588);
   ...
   Graph_Graph41018->SetMinimum(-0.004438453);
   Graph_Graph41018->SetMaximum(0.006917455);
   ...
   Graph_Graph51019->SetMinimum(-0.004436396);
   Graph_Graph51019->SetMaximum(0.005910933);
