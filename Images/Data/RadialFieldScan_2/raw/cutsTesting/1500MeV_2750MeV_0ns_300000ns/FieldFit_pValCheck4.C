...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.10894);
   Graph_Graph01033->SetMaximum(50.89635);
   ...
   mainFit1034->SetChisquare(0.3627351);
   ...
   mainFit1034->SetParameter(0,-1.384822);
   mainFit1034->SetParError(0,0.598048);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8500595);
   mainFit1034->SetParError(1,0.01972458);
   ...
   pt_LaTex = pt->AddText("#minus1.38#pm0.598");
   pt_LaTex = pt->AddText("#minus1.63#pm0.687");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.629088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.629088,-55.10894,1.629088,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.3627351);
   ...
   mainFit1035->SetParameter(0,-1.384822);
   mainFit1035->SetParError(0,0.598048);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8500595);
   mainFit1035->SetParError(1,0.01972458);
