...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-68.35961,75,64.14701);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-55.10894);
   Graph_Graph01031->SetMaximum(50.89635);
   ...
   mainFit1032->SetChisquare(0.5981165);
   ...
   mainFit1032->SetParameter(0,-1.564633);
   mainFit1032->SetParError(0,0.5494183);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8558856);
   mainFit1032->SetParError(1,0.01631857);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.199");
   pt_LaTex = pt->AddText("0.856#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.56#pm0.549");
   pt_LaTex = pt->AddText("#minus1.83#pm0.634");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.828087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.828087,-55.10894,1.828087,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.5981165);
   ...
   mainFit1033->SetParameter(0,-1.564633);
   mainFit1033->SetParError(0,0.5494183);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8558856);
   mainFit1033->SetParError(1,0.01631857);
