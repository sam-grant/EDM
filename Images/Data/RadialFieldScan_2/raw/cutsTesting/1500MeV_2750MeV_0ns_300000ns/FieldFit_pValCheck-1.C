...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.10894);
   Graph_Graph01023->SetMaximum(50.89635);
   ...
   mainFit1024->SetChisquare(0.598411);
   ...
   mainFit1024->SetParameter(0,-1.559926);
   mainFit1024->SetParError(0,0.4769867);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.855805);
   mainFit1024->SetParError(1,0.01576644);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.15");
   pt_LaTex = pt->AddText("0.856#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.56#pm0.477");
   pt_LaTex = pt->AddText("#minus1.82#pm0.553");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.822759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.822759,-55.10894,1.822759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(0.598411);
   ...
   mainFit1025->SetParameter(0,-1.559926);
   mainFit1025->SetParError(0,0.4769867);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.855805);
   mainFit1025->SetParError(1,0.01576644);
