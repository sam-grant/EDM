...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.12701,50,42.98404);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.4159);
   Graph_Graph01025->SetMaximum(32.27293);
   ...
   mainFit1026->SetChisquare(0.4006254);
   ...
   mainFit1026->SetParameter(0,-1.474811);
   mainFit1026->SetParError(0,0.5139758);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8615372);
   mainFit1026->SetParError(1,0.02035262);
   ...
   pt_LaTex = pt->AddText("0.862#pm0.0204");
   pt_LaTex = pt->AddText("#minus1.47#pm0.514");
   pt_LaTex = pt->AddText("#minus1.71#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.711836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.711836,-53.4159,1.711836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.4006254);
   ...
   mainFit1027->SetParameter(0,-1.474811);
   mainFit1027->SetParError(0,0.5139758);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8615372);
   mainFit1027->SetParError(1,0.02035262);
