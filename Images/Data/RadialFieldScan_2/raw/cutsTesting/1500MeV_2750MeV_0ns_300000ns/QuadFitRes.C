...
//=========  (Tue Apr 27 00:00:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01490356);
   Graph_Graph11015->SetMaximum(0.01484067);
   ...
   Graph_Graph21016->SetMinimum(-0.0007339842);
   Graph_Graph21016->SetMaximum(0.0008612912);
   ...
   Graph_Graph31017->SetMinimum(-0.03036152);
   Graph_Graph31017->SetMaximum(0.0302414);
   ...
   Graph_Graph41018->SetMinimum(-0.005611332);
   Graph_Graph41018->SetMaximum(0.007751945);
   ...
   Graph_Graph51019->SetMinimum(-0.004107961);
   Graph_Graph51019->SetMaximum(0.005473047);
