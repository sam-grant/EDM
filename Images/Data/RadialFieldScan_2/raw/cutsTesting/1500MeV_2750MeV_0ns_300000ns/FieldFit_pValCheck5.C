...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.28906,70,59.73291);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.68686);
   Graph_Graph01035->SetMaximum(49.13071);
   ...
   mainFit1036->SetChisquare(0.5843086);
   ...
   mainFit1036->SetParameter(0,-1.577847);
   mainFit1036->SetParError(0,0.5002125);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8566602);
   mainFit1036->SetParError(1,0.01730433);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.195");
   pt_LaTex = pt->AddText("0.857#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.58#pm  0.5");
   pt_LaTex = pt->AddText("#minus1.84#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.841858,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.841858,-35.68686,1.841858,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.5843086);
   ...
   mainFit1037->SetParameter(0,-1.577847);
   mainFit1037->SetParError(0,0.5002125);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8566602);
   mainFit1037->SetParError(1,0.01730433);
