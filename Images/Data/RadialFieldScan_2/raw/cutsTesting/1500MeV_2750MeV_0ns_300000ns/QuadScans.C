...
//=========  (Tue Apr 27 00:00:30 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.294647);
   ...
   quadLineFit1002->SetParameter(0,74.8124);
   quadLineFit1002->SetParError(0,0.07273529);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.84317);
   quadLineFit1002->SetParError(1,1.219407);
   ...
   quadLineFit1003->SetChisquare(2.294647);
   ...
   quadLineFit1003->SetParameter(0,74.8124);
   quadLineFit1003->SetParError(0,0.07273529);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.84317);
   quadLineFit1003->SetParError(1,1.219407);
   ...
   Graph_30_ppm1003->SetMinimum(75.89339);
   Graph_30_ppm1003->SetMaximum(76.50085);
   ...
   quadLineFit1004->SetChisquare(1.453428);
   ...
   quadLineFit1004->SetParameter(0,74.71128);
   quadLineFit1004->SetParError(0,0.06120673);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.12683);
   quadLineFit1004->SetParError(1,1.005363);
   ...
   quadLineFit1005->SetChisquare(1.453428);
   ...
   quadLineFit1005->SetParameter(0,74.71128);
   quadLineFit1005->SetParError(0,0.06120673);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.12683);
   quadLineFit1005->SetParError(1,1.005363);
   ...
   Graph_10_ppm1005->SetMinimum(74.96979);
   Graph_10_ppm1005->SetMaximum(75.19664);
   ...
   quadLineFit1006->SetChisquare(0.004959224);
   ...
   quadLineFit1006->SetParameter(0,74.60893);
   quadLineFit1006->SetParError(0,0.07182708);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.703283);
   quadLineFit1006->SetParError(1,1.164214);
   ...
   quadLineFit1007->SetChisquare(0.004959224);
   ...
   quadLineFit1007->SetParameter(0,74.60893);
   quadLineFit1007->SetParError(0,0.07182708);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.703283);
   quadLineFit1007->SetParError(1,1.164214);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.84609);
   Graph_mI10_ppm1007->SetMaximum(74.15379);
   ...
   quadLineFit1008->SetChisquare(4.882909);
   ...
   quadLineFit1008->SetParameter(0,74.6036);
   quadLineFit1008->SetParError(0,0.06297375);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.10301);
   quadLineFit1008->SetParError(1,1.024296);
   ...
   quadLineFit1009->SetChisquare(4.882909);
   ...
   quadLineFit1009->SetParameter(0,74.6036);
   quadLineFit1009->SetParError(0,0.06297375);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.10301);
   quadLineFit1009->SetParError(1,1.024296);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.54186);
   Graph_mI30_ppm1009->SetMaximum(73.24547);
   ...
   quadLineFit1010->SetChisquare(0.4440358);
   ...
   quadLineFit1010->SetParameter(0,74.59426);
   quadLineFit1010->SetParError(0,0.05951028);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.58952);
   quadLineFit1010->SetParError(1,1.029213);
   ...
   quadLineFit1011->SetChisquare(0.4440358);
   ...
   quadLineFit1011->SetParameter(0,74.59426);
   quadLineFit1011->SetParError(0,0.05951028);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.58952);
   quadLineFit1011->SetParError(1,1.029213);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.68591);
   Graph_mI50_ppm1011->SetMaximum(72.32025);
   ...
   quadLineFit1012->SetChisquare(0.1761118);
   ...
   quadLineFit1012->SetParameter(0,74.51801);
   quadLineFit1012->SetParError(0,0.1202869);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.12345);
   quadLineFit1012->SetParError(1,2.151717);
   ...
   quadLineFit1013->SetChisquare(0.1761118);
   ...
   quadLineFit1013->SetParameter(0,74.51801);
   quadLineFit1013->SetParError(0,0.1202869);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.12345);
   quadLineFit1013->SetParError(1,2.151717);
