...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.10894);
   Graph_Graph01020->SetMaximum(50.89635);
   ...
   mainFit1021->SetChisquare(0.598411);
   ...
   mainFit1021->SetParameter(0,-1.559926);
   mainFit1021->SetParError(0,0.4769867);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.855805);
   mainFit1021->SetParError(1,0.01576644);
   ...
   mainFit1022->SetChisquare(0.598411);
   ...
   mainFit1022->SetParameter(0,-1.559926);
   mainFit1022->SetParError(0,0.4769867);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.855805);
   mainFit1022->SetParError(1,0.01576644);
