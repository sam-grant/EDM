...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.10894);
   Graph_Graph01027->SetMaximum(50.89635);
   ...
   mainFit1028->SetChisquare(0.5981681);
   ...
   mainFit1028->SetParameter(0,-1.563703);
   mainFit1028->SetParError(0,0.5341102);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8556902);
   mainFit1028->SetParError(1,0.01761343);
   ...
   pt_LaTex = pt->AddText("0.856#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.56#pm0.534");
   pt_LaTex = pt->AddText("#minus1.83#pm0.628");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.827417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.827417,-55.10894,1.827417,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5981681);
   ...
   mainFit1029->SetParameter(0,-1.563703);
   mainFit1029->SetParError(0,0.5341102);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8556902);
   mainFit1029->SetParError(1,0.01761343);
