...
//=========  (Tue Apr 27 00:00:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.10894);
   Graph_Graph01029->SetMaximum(50.89635);
   ...
   mainFit1030->SetChisquare(0.1573763);
   ...
   mainFit1030->SetParameter(0,-1.694673);
   mainFit1030->SetParError(0,0.5183307);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8550173);
   mainFit1030->SetParError(1,0.0158119);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0525");
   pt_LaTex = pt->AddText("0.855#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.69#pm0.518");
   pt_LaTex = pt->AddText("#minus1.98#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.982033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.982033,-55.10894,1.982033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.1573763);
   ...
   mainFit1031->SetParameter(0,-1.694673);
   mainFit1031->SetParError(0,0.5183307);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8550173);
   mainFit1031->SetParError(1,0.0158119);
