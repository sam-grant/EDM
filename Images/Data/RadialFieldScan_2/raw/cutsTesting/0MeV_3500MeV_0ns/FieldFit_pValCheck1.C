...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.66611);
   Graph_Graph01027->SetMaximum(50.70171);
   ...
   mainFit1028->SetChisquare(41.77685);
   ...
   mainFit1028->SetParameter(0,-2.108076);
   mainFit1028->SetParError(0,0.3335339);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8653117);
   mainFit1028->SetParError(1,0.01094164);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 13.9");
   pt_LaTex = pt->AddText("0.865#pm0.0109");
   pt_LaTex = pt->AddText("#minus2.11#pm0.334");
   pt_LaTex = pt->AddText("#minus2.44#pm0.389");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.436204,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.436204,-49.66611,2.436204,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(41.77685);
   ...
   mainFit1029->SetParameter(0,-2.108076);
   mainFit1029->SetParError(0,0.3335339);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8653117);
   mainFit1029->SetParError(1,0.01094164);
