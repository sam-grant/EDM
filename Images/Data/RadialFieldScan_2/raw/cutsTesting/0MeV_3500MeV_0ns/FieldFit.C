...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.66611);
   Graph_Graph01020->SetMaximum(50.70171);
   ...
   mainFit1021->SetChisquare(56.62586);
   ...
   mainFit1021->SetParameter(0,-1.531285);
   mainFit1021->SetParError(0,0.2980615);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8839734);
   mainFit1021->SetParError(1,0.009811689);
   ...
   mainFit1022->SetChisquare(56.62586);
   ...
   mainFit1022->SetParameter(0,-1.531285);
   mainFit1022->SetParError(0,0.2980615);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8839734);
   mainFit1022->SetParError(1,0.009811689);
