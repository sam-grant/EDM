...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-49.66611);
   Graph_Graph01031->SetMaximum(50.70171);
   ...
   mainFit1032->SetChisquare(23.54937);
   ...
   mainFit1032->SetParameter(0,-0.5571749);
   mainFit1032->SetParError(0,0.3428241);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8690445);
   mainFit1032->SetParError(1,0.01014925);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 7.85");
   pt_LaTex = pt->AddText("0.869#pm0.0101");
   pt_LaTex = pt->AddText("#minus0.557#pm0.343");
   pt_LaTex = pt->AddText("#minus0.641#pm0.393");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.641135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.641135,-49.66611,0.641135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(23.54937);
   ...
   mainFit1033->SetParameter(0,-0.5571749);
   mainFit1033->SetParError(0,0.3428241);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8690445);
   mainFit1033->SetParError(1,0.01014925);
