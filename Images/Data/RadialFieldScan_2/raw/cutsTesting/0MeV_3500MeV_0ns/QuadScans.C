...
//=========  (Fri Apr 23 10:59:04 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(54.26978);
   ...
   quadLineFit1002->SetParameter(0,74.6757);
   quadLineFit1002->SetParError(0,0.04514483);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,41.58161);
   quadLineFit1002->SetParError(1,0.7561161);
   ...
   quadLineFit1003->SetChisquare(54.26978);
   ...
   quadLineFit1003->SetParameter(0,74.6757);
   quadLineFit1003->SetParError(0,0.04514483);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,41.58161);
   quadLineFit1003->SetParError(1,0.7561161);
   ...
   Graph_30_ppm1003->SetMinimum(75.75146);
   Graph_30_ppm1003->SetMaximum(76.43887);
   ...
   quadLineFit1004->SetChisquare(7.018576);
   ...
   quadLineFit1004->SetParameter(0,74.44557);
   quadLineFit1004->SetParError(0,0.03837021);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.91127);
   quadLineFit1004->SetParError(1,0.629562);
   ...
   quadLineFit1005->SetChisquare(7.018576);
   ...
   quadLineFit1005->SetParameter(0,74.44557);
   quadLineFit1005->SetParError(0,0.03837021);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.91127);
   quadLineFit1005->SetParError(1,0.629562);
   ...
   Graph_10_ppm1005->SetMinimum(74.75404);
   Graph_10_ppm1005->SetMaximum(74.98758);
   ...
   quadLineFit1006->SetChisquare(4.221403);
   ...
   quadLineFit1006->SetParameter(0,74.34593);
   quadLineFit1006->SetParError(0,0.04518081);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.368723);
   quadLineFit1006->SetParError(1,0.7318818);
   ...
   quadLineFit1007->SetChisquare(4.221403);
   ...
   quadLineFit1007->SetParameter(0,74.34593);
   quadLineFit1007->SetParError(0,0.04518081);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.368723);
   quadLineFit1007->SetParError(1,0.7318818);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.44133);
   Graph_mI10_ppm1007->SetMaximum(73.79681);
   ...
   quadLineFit1008->SetChisquare(3.9048);
   ...
   quadLineFit1008->SetParameter(0,74.45484);
   quadLineFit1008->SetParError(0,0.03953531);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-13.5476);
   quadLineFit1008->SetParError(1,0.6426189);
   ...
   quadLineFit1009->SetChisquare(3.9048);
   ...
   quadLineFit1009->SetParameter(0,74.45484);
   quadLineFit1009->SetParError(0,0.03953531);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-13.5476);
   quadLineFit1009->SetParError(1,0.6426189);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.14229);
   Graph_mI30_ppm1009->SetMaximum(72.86356);
   ...
   quadLineFit1010->SetChisquare(12.5465);
   ...
   quadLineFit1010->SetParameter(0,74.2503);
   quadLineFit1010->SetParError(0,0.03707227);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.24293);
   quadLineFit1010->SetParError(1,0.6408035);
   ...
   quadLineFit1011->SetChisquare(12.5465);
   ...
   quadLineFit1011->SetParameter(0,74.2503);
   quadLineFit1011->SetParError(0,0.03707227);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.24293);
   quadLineFit1011->SetParError(1,0.6408035);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.3868);
   Graph_mI50_ppm1011->SetMaximum(71.95182);
   ...
   quadLineFit1012->SetChisquare(6.279976);
   ...
   quadLineFit1012->SetParameter(0,73.93237);
   quadLineFit1012->SetParError(0,0.07471284);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.96583);
   quadLineFit1012->SetParError(1,1.336296);
   ...
   quadLineFit1013->SetChisquare(6.279976);
   ...
   quadLineFit1013->SetParameter(0,73.93237);
   quadLineFit1013->SetParError(0,0.07471284);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.96583);
   quadLineFit1013->SetParError(1,1.336296);
