...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.68909,70,60.14309);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.00588);
   Graph_Graph01035->SetMaximum(49.45987);
   ...
   mainFit1036->SetChisquare(33.04634);
   ...
   mainFit1036->SetParameter(0,-1.991053);
   mainFit1036->SetParError(0,0.3127386);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9055909);
   mainFit1036->SetParError(1,0.01077441);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   11");
   pt_LaTex = pt->AddText("0.906#pm0.0108");
   pt_LaTex = pt->AddText("#minus1.99#pm0.313");
   pt_LaTex = pt->AddText(" #minus2.2#pm0.339");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.198623,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.198623,-36.00588,2.198623,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(33.04634);
   ...
   mainFit1037->SetParameter(0,-1.991053);
   mainFit1037->SetParError(0,0.3127386);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9055909);
   mainFit1037->SetParError(1,0.01077441);
