...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.66611);
   Graph_Graph01033->SetMaximum(50.70171);
   ...
   mainFit1034->SetChisquare(56.44686);
   ...
   mainFit1034->SetParameter(0,-1.435502);
   mainFit1034->SetParError(0,0.3742893);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8808488);
   mainFit1034->SetParError(1,0.01228048);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 18.8");
   pt_LaTex = pt->AddText("0.881#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.44#pm0.374");
   pt_LaTex = pt->AddText("#minus1.63#pm0.415");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.62968,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.62968,-49.66611,1.62968,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(56.44686);
   ...
   mainFit1035->SetParameter(0,-1.435502);
   mainFit1035->SetParError(0,0.3742893);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8808488);
   mainFit1035->SetParError(1,0.01228048);
