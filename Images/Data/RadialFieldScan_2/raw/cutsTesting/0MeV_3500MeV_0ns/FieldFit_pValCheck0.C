...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.51286,50,44.75157);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.18642);
   Graph_Graph01025->SetMaximum(34.42513);
   ...
   mainFit1026->SetChisquare(52.55082);
   ...
   mainFit1026->SetParameter(0,-1.286249);
   mainFit1026->SetParError(0,0.3218304);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.900271);
   mainFit1026->SetParError(1,0.01270626);
   ...
   pt_LaTex = pt->AddText("  0.9#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.29#pm0.322");
   pt_LaTex = pt->AddText("#minus1.43#pm0.361");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.428736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.428736,-48.18642,1.428736,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(52.55082);
   ...
   mainFit1027->SetParameter(0,-1.286249);
   mainFit1027->SetParError(0,0.3218304);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.900271);
   mainFit1027->SetParError(1,0.01270626);
