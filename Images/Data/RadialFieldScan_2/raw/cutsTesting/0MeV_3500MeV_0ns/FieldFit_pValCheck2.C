...
//=========  (Fri Apr 23 10:59:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-49.66611);
   Graph_Graph01029->SetMaximum(50.70171);
   ...
   mainFit1030->SetChisquare(54.10869);
   ...
   mainFit1030->SetParameter(0,-1.731016);
   mainFit1030->SetParError(0,0.3235566);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8828058);
   mainFit1030->SetParError(1,0.009839233);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("   18");
   pt_LaTex = pt->AddText("0.883#pm0.00984");
   pt_LaTex = pt->AddText("#minus1.73#pm0.324");
   pt_LaTex = pt->AddText("#minus1.96#pm0.365");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.960812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.960812,-49.66611,1.960812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(54.10869);
   ...
   mainFit1031->SetParameter(0,-1.731016);
   mainFit1031->SetParError(0,0.3235566);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8828058);
   mainFit1031->SetParError(1,0.009839233);
