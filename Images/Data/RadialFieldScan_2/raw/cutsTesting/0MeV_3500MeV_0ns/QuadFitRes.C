...
//=========  (Fri Apr 23 10:59:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0314735);
   Graph_Graph11015->SetMaximum(0.0163173);
   ...
   Graph_Graph21016->SetMinimum(-0.0134903);
   Graph_Graph21016->SetMaximum(0.0156827);
   ...
   Graph_Graph31017->SetMinimum(-0.009427976);
   Graph_Graph31017->SetMaximum(0.01908424);
   ...
   Graph_Graph41018->SetMinimum(-0.02447769);
   Graph_Graph41018->SetMaximum(0.04109215);
   ...
   Graph_Graph51019->SetMinimum(-0.02034968);
   Graph_Graph51019->SetMaximum(0.01526097);
