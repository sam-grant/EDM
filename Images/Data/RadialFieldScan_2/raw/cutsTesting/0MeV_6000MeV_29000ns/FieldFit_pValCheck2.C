...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.48647);
   Graph_Graph01029->SetMaximum(55.84778);
   ...
   mainFit1030->SetChisquare(3.269216);
   ...
   mainFit1030->SetParameter(0,-2.100781);
   mainFit1030->SetParError(0,0.4305573);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9230386);
   mainFit1030->SetParError(1,0.0131327);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0131");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.431");
   pt_LaTex = pt->AddText("#minus2.28#pm0.464");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.275941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.275941,-60.48647,2.275941,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.269216);
   ...
   mainFit1031->SetParameter(0,-2.100781);
   mainFit1031->SetParError(0,0.4305573);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9230386);
   mainFit1031->SetParError(1,0.0131327);
