...
//=========  (Wed Apr 21 16:11:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.09406,70,65.20273);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.66438);
   Graph_Graph01035->SetMaximum(53.77305);
   ...
   mainFit1036->SetChisquare(3.513412);
   ...
   mainFit1036->SetParameter(0,-1.912283);
   mainFit1036->SetParError(0,0.4154365);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9206224);
   mainFit1036->SetParError(1,0.01437476);
   ...
   pt_LaTex = pt->AddText("0.921#pm0.0144");
   pt_LaTex = pt->AddText("#minus1.91#pm0.415");
   pt_LaTex = pt->AddText("#minus2.08#pm0.444");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.077163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.077163,-37.66438,2.077163,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.513412);
   ...
   mainFit1037->SetParameter(0,-1.912283);
   mainFit1037->SetParError(0,0.4154365);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9206224);
   mainFit1037->SetParError(1,0.01437476);
