...
//=========  (Wed Apr 21 16:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.48647);
   Graph_Graph01031->SetMaximum(55.84778);
   ...
   mainFit1032->SetChisquare(3.643357);
   ...
   mainFit1032->SetParameter(0,-1.890844);
   mainFit1032->SetParError(0,0.4561783);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9224081);
   mainFit1032->SetParError(1,0.01355214);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.89#pm0.456");
   pt_LaTex = pt->AddText("#minus2.05#pm0.487");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.049899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.049899,-60.48647,2.049899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.643357);
   ...
   mainFit1033->SetParameter(0,-1.890844);
   mainFit1033->SetParError(0,0.4561783);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9224081);
   mainFit1033->SetParError(1,0.01355214);
