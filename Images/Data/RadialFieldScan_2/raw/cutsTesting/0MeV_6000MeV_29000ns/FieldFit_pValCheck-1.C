...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.48647);
   Graph_Graph01023->SetMaximum(55.84778);
   ...
   mainFit1024->SetChisquare(3.793724);
   ...
   mainFit1024->SetParameter(0,-1.978559);
   mainFit1024->SetParError(0,0.3961163);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.923756);
   mainFit1024->SetParError(1,0.01309468);
   ...
   mainFit1025->SetChisquare(3.793724);
   ...
   mainFit1025->SetParameter(0,-1.978559);
   mainFit1025->SetParError(0,0.3961163);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.923756);
   mainFit1025->SetParError(1,0.01309468);
