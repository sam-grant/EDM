...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.48647);
   Graph_Graph01020->SetMaximum(55.84778);
   ...
   mainFit1021->SetChisquare(3.793724);
   ...
   mainFit1021->SetParameter(0,-1.978559);
   mainFit1021->SetParError(0,0.3961163);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.923756);
   mainFit1021->SetParError(1,0.01309468);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.948");
   pt_LaTex = pt->AddText("0.924#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.98#pm0.396");
   pt_LaTex = pt->AddText("#minus2.14#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.141864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.141864,-60.48647,2.141864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.793724);
   ...
   mainFit1022->SetParameter(0,-1.978559);
   mainFit1022->SetParError(0,0.3961163);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.923756);
   mainFit1022->SetParError(1,0.01309468);
