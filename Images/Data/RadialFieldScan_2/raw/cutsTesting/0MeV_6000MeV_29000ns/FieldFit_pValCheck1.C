...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.02825,75,70.38957);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.48647);
   Graph_Graph01027->SetMaximum(55.84778);
   ...
   mainFit1028->SetChisquare(0.8582741);
   ...
   mainFit1028->SetParameter(0,-1.636766);
   mainFit1028->SetParError(0,0.4435206);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9349316);
   mainFit1028->SetParError(1,0.01462801);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.286");
   pt_LaTex = pt->AddText("0.935#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.64#pm0.444");
   pt_LaTex = pt->AddText("#minus1.75#pm0.477");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.75068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.75068,-60.48647,1.75068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8582741);
   ...
   mainFit1029->SetParameter(0,-1.636766);
   mainFit1029->SetParError(0,0.4435206);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9349316);
   mainFit1029->SetParError(1,0.01462801);
