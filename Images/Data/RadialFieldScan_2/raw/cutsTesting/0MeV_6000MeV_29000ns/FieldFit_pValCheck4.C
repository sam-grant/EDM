...
//=========  (Wed Apr 21 16:11:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.48647);
   Graph_Graph01033->SetMaximum(55.84778);
   ...
   mainFit1034->SetChisquare(3.112351);
   ...
   mainFit1034->SetParameter(0,-2.225754);
   mainFit1034->SetParError(0,0.4965621);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9318841);
   mainFit1034->SetParError(1,0.01637954);
   ...
   pt_LaTex = pt->AddText("0.932#pm0.0164");
   pt_LaTex = pt->AddText("#minus2.23#pm0.497");
   pt_LaTex = pt->AddText("#minus2.39#pm0.515");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.388445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.388445,-60.48647,2.388445,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.112351);
   ...
   mainFit1035->SetParameter(0,-2.225754);
   mainFit1035->SetParError(0,0.4965621);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9318841);
   mainFit1035->SetParError(1,0.01637954);
