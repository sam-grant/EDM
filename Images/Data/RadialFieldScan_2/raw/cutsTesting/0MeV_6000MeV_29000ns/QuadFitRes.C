...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01117148);
   Graph_Graph11015->SetMaximum(0.01180452);
   ...
   Graph_Graph21016->SetMinimum(-0.008168302);
   Graph_Graph21016->SetMaximum(0.009601634);
   ...
   Graph_Graph31017->SetMinimum(-0.02538717);
   Graph_Graph31017->SetMaximum(0.02106757);
   ...
   Graph_Graph41018->SetMinimum(-0.005581995);
   Graph_Graph41018->SetMaximum(0.01048439);
   ...
   Graph_Graph51019->SetMinimum(-0.000516038);
   Graph_Graph51019->SetMaximum(0.0003863141);
