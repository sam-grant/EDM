...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.84928,50,44.49474);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.41488);
   Graph_Graph01025->SetMaximum(33.06034);
   ...
   mainFit1026->SetChisquare(2.141453);
   ...
   mainFit1026->SetParameter(0,-2.18297);
   mainFit1026->SetParError(0,0.4268396);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9100247);
   mainFit1026->SetParError(1,0.01690222);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.714");
   pt_LaTex = pt->AddText(" 0.91#pm0.0169");
   pt_LaTex = pt->AddText("#minus2.18#pm0.427");
   pt_LaTex = pt->AddText(" #minus2.4#pm0.476");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.398803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.398803,-58.41488,2.398803,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.141453);
   ...
   mainFit1027->SetParameter(0,-2.18297);
   mainFit1027->SetParError(0,0.4268396);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9100247);
   mainFit1027->SetParError(1,0.01690222);
