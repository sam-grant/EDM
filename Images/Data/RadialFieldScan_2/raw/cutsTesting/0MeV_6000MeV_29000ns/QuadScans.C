...
//=========  (Wed Apr 21 16:11:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.169794);
   ...
   quadLineFit1002->SetParameter(0,74.46905);
   quadLineFit1002->SetParError(0,0.06039718);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.14021);
   quadLineFit1002->SetParError(1,1.01305);
   ...
   quadLineFit1003->SetChisquare(1.169794);
   ...
   quadLineFit1003->SetParameter(0,74.46905);
   quadLineFit1003->SetParError(0,0.06039718);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.14021);
   quadLineFit1003->SetParError(1,1.01305);
   ...
   Graph_30_ppm1003->SetMinimum(75.74547);
   Graph_30_ppm1003->SetMaximum(76.36148);
   ...
   quadLineFit1004->SetChisquare(1.18255);
   ...
   quadLineFit1004->SetParameter(0,74.53927);
   quadLineFit1004->SetParError(0,0.05083038);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.60205);
   quadLineFit1004->SetParError(1,0.835348);
   ...
   quadLineFit1005->SetChisquare(1.18255);
   ...
   quadLineFit1005->SetParameter(0,74.53927);
   quadLineFit1005->SetParError(0,0.05083038);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.60205);
   quadLineFit1005->SetParError(1,0.835348);
   ...
   Graph_10_ppm1005->SetMinimum(74.75086);
   Graph_10_ppm1005->SetMaximum(74.97898);
   ...
   quadLineFit1006->SetChisquare(0.8877441);
   ...
   quadLineFit1006->SetParameter(0,74.37296);
   quadLineFit1006->SetParError(0,0.05954486);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.896645);
   quadLineFit1006->SetParError(1,0.9656233);
   ...
   quadLineFit1007->SetChisquare(0.8877441);
   ...
   quadLineFit1007->SetParameter(0,74.37296);
   quadLineFit1007->SetParError(0,0.05954486);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.896645);
   quadLineFit1007->SetParError(1,0.9656233);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50119);
   Graph_mI10_ppm1007->SetMaximum(73.83105);
   ...
   quadLineFit1008->SetChisquare(5.443101);
   ...
   quadLineFit1008->SetParameter(0,74.3665);
   quadLineFit1008->SetParError(0,0.05229069);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.49944);
   quadLineFit1008->SetParError(1,0.8510612);
   ...
   quadLineFit1009->SetChisquare(5.443101);
   ...
   quadLineFit1009->SetParameter(0,74.3665);
   quadLineFit1009->SetParError(0,0.05229069);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.49944);
   quadLineFit1009->SetParError(1,0.8510612);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12561);
   Graph_mI30_ppm1009->SetMaximum(72.85835);
   ...
   quadLineFit1010->SetChisquare(0.8514741);
   ...
   quadLineFit1010->SetParameter(0,74.28895);
   quadLineFit1010->SetParError(0,0.04939239);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.1898);
   quadLineFit1010->SetParError(1,0.8547986);
   ...
   quadLineFit1011->SetChisquare(0.8514741);
   ...
   quadLineFit1011->SetParameter(0,74.28895);
   quadLineFit1011->SetParError(0,0.04939239);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.1898);
   quadLineFit1011->SetParError(1,0.8547986);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19244);
   Graph_mI50_ppm1011->SetMaximum(71.88604);
   ...
   quadLineFit1012->SetChisquare(0.00227853);
   ...
   quadLineFit1012->SetParameter(0,74.32832);
   quadLineFit1012->SetParError(0,0.09977183);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.00676);
   quadLineFit1012->SetParError(1,1.78518);
   ...
   quadLineFit1013->SetChisquare(0.00227853);
   ...
   quadLineFit1013->SetParameter(0,74.32832);
   quadLineFit1013->SetParError(0,0.09977183);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.00676);
   quadLineFit1013->SetParError(1,1.78518);
