...
//=========  (Wed Apr 21 22:47:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-70.23216);
   Graph_Graph01023->SetMaximum(67.70611);
   ...
   mainFit1024->SetChisquare(6.73603);
   ...
   mainFit1024->SetParameter(0,-4.130913);
   mainFit1024->SetParError(0,0.9846556);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.067766);
   mainFit1024->SetParError(1,0.03271777);
   ...
   mainFit1025->SetChisquare(6.73603);
   ...
   mainFit1025->SetParameter(0,-4.130913);
   mainFit1025->SetParError(0,0.9846556);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.067766);
   mainFit1025->SetParError(1,0.03271777);
