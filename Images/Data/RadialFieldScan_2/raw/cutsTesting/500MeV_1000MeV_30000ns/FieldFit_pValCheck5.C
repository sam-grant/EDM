...
//=========  (Wed Apr 21 22:47:39 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-60.44434,70,79.54238);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-46.44567);
   Graph_Graph01035->SetMaximum(65.5437);
   ...
   mainFit1036->SetChisquare(6.069576);
   ...
   mainFit1036->SetParameter(0,-4.382804);
   mainFit1036->SetParError(0,1.031868);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.079871);
   mainFit1036->SetParError(1,0.03592073);
   ...
   pt_LaTex = pt->AddText(" 1.08#pm0.0359");
   pt_LaTex = pt->AddText("#minus4.38#pm 1.03");
   pt_LaTex = pt->AddText("#minus4.06#pm 0.93");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,4.058638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.058638,-46.44567,4.058638,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.069576);
   ...
   mainFit1037->SetParameter(0,-4.382804);
   mainFit1037->SetParError(0,1.031868);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.079871);
   mainFit1037->SetParError(1,0.03592073);
