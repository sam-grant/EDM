...
//=========  (Wed Apr 21 22:47:39 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-80.13653,50,48.25886);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-67.29699);
   Graph_Graph01025->SetMaximum(35.41932);
   ...
   mainFit1026->SetChisquare(1.087421);
   ...
   mainFit1026->SetParameter(0,-5.06019);
   mainFit1026->SetParError(0,1.059446);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.005278);
   mainFit1026->SetParError(1,0.04197287);
   ...
   pt_LaTex = pt->AddText(" 1.01#pm0.042");
   pt_LaTex = pt->AddText("#minus5.06#pm 1.06");
   pt_LaTex = pt->AddText("#minus5.03#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,5.033621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(5.033621,-67.29699,5.033621,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.087421);
   ...
   mainFit1027->SetParameter(0,-5.06019);
   mainFit1027->SetParError(0,1.059446);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.005278);
   mainFit1027->SetParError(1,0.04197287);
