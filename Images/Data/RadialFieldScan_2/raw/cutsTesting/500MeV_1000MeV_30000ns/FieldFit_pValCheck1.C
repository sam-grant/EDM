...
//=========  (Wed Apr 21 22:47:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-70.23216);
   Graph_Graph01027->SetMaximum(67.70611);
   ...
   mainFit1028->SetChisquare(3.095635);
   ...
   mainFit1028->SetParameter(0,-3.171935);
   mainFit1028->SetParError(0,1.105526);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.099488);
   mainFit1028->SetParError(1,0.03670127);
   ...
   pt_LaTex = pt->AddText("  1.1#pm0.0367");
   pt_LaTex = pt->AddText("#minus3.17#pm 1.11");
   pt_LaTex = pt->AddText("#minus2.88#pm 1.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.884921,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.884921,-70.23216,2.884921,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.095635);
   ...
   mainFit1029->SetParameter(0,-3.171935);
   mainFit1029->SetParError(0,1.105526);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.099488);
   mainFit1029->SetParError(1,0.03670127);
