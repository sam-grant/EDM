...
//=========  (Wed Apr 21 22:47:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1107965);
   Graph_Graph11015->SetMaximum(0.05245404);
   ...
   Graph_Graph21016->SetMinimum(-0.02237716);
   Graph_Graph21016->SetMaximum(0.02621944);
   ...
   Graph_Graph31017->SetMinimum(-0.05559308);
   Graph_Graph31017->SetMaximum(0.03973704);
   ...
   Graph_Graph41018->SetMinimum(-0.06551428);
   Graph_Graph41018->SetMaximum(0.05912086);
   ...
   Graph_Graph51019->SetMinimum(-0.003703518);
   Graph_Graph51019->SetMaximum(0.004940397);
