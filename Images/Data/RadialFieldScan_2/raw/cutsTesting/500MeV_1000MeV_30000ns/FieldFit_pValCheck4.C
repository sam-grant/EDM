...
//=========  (Wed Apr 21 22:47:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-70.23216);
   Graph_Graph01033->SetMaximum(67.70611);
   ...
   mainFit1034->SetChisquare(6.131036);
   ...
   mainFit1034->SetParameter(0,-4.708156);
   mainFit1034->SetParError(0,1.23301);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.086902);
   mainFit1034->SetParError(1,0.04093544);
   ...
   pt_LaTex = pt->AddText(" 1.09#pm0.0409");
   pt_LaTex = pt->AddText("#minus4.71#pm 1.23");
   pt_LaTex = pt->AddText("#minus4.33#pm 1.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.331721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.331721,-70.23216,4.331721,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.131036);
   ...
   mainFit1035->SetParameter(0,-4.708156);
   mainFit1035->SetParError(0,1.23301);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.086902);
   mainFit1035->SetParError(1,0.04093544);
