...
//=========  (Wed Apr 21 22:47:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-70.23216);
   Graph_Graph01020->SetMaximum(67.70611);
   ...
   mainFit1021->SetChisquare(6.73603);
   ...
   mainFit1021->SetParameter(0,-4.130913);
   mainFit1021->SetParError(0,0.9846556);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.067766);
   mainFit1021->SetParError(1,0.03271777);
   ...
   pt_LaTex = pt->AddText(" 1.07#pm0.0327");
   pt_LaTex = pt->AddText("#minus4.13#pm0.985");
   pt_LaTex = pt->AddText("#minus3.87#pm0.912");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.868743,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.868743,-70.23216,3.868743,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.73603);
   ...
   mainFit1022->SetParameter(0,-4.130913);
   mainFit1022->SetParError(0,0.9846556);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.067766);
   mainFit1022->SetParError(1,0.03271777);
