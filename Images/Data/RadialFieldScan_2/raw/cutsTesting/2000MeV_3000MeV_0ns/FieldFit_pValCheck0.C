...
//=========  (Fri Apr 23 18:48:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-58.13766,50,42.15924);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.10797);
   Graph_Graph01025->SetMaximum(32.12955);
   ...
   mainFit1026->SetChisquare(4.824906);
   ...
   mainFit1026->SetParameter(0,-1.307392);
   mainFit1026->SetParError(0,0.6359361);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8457585);
   mainFit1026->SetParError(1,0.02518021);
   ...
   pt_LaTex = pt->AddText("0.846#pm0.0252");
   pt_LaTex = pt->AddText("#minus1.31#pm0.636");
   pt_LaTex = pt->AddText("#minus1.55#pm0.759");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.545822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.545822,-48.10797,1.545822,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.824906);
   ...
   mainFit1027->SetParameter(0,-1.307392);
   mainFit1027->SetParError(0,0.6359361);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8457585);
   mainFit1027->SetParError(1,0.02518021);
