...
//=========  (Fri Apr 23 18:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-49.79556);
   Graph_Graph01033->SetMaximum(50.69304);
   ...
   mainFit1034->SetChisquare(2.374362);
   ...
   mainFit1034->SetParameter(0,-0.6212652);
   mainFit1034->SetParError(0,0.7401561);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8218867);
   mainFit1034->SetParError(1,0.02423063);
   ...
   pt_LaTex = pt->AddText("0.822#pm0.0242");
   pt_LaTex = pt->AddText("#minus0.621#pm 0.74");
   pt_LaTex = pt->AddText("#minus0.756#pm 0.89");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7559014,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7559014,-49.79556,0.7559014,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.374362);
   ...
   mainFit1035->SetParameter(0,-0.6212652);
   mainFit1035->SetParError(0,0.7401561);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8218867);
   mainFit1035->SetParError(1,0.02423063);
