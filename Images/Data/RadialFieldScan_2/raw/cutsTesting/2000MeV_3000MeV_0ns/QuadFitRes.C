...
//=========  (Fri Apr 23 18:48:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04051106);
   Graph_Graph11015->SetMaximum(0.03044078);
   ...
   Graph_Graph21016->SetMinimum(-0.008049628);
   Graph_Graph21016->SetMaximum(0.009436782);
   ...
   Graph_Graph31017->SetMinimum(-0.0231578);
   Graph_Graph31017->SetMaximum(0.02837803);
   ...
   Graph_Graph41018->SetMinimum(-0.02394039);
   Graph_Graph41018->SetMaximum(0.01234069);
   ...
   Graph_Graph51019->SetMinimum(-0.009840498);
   Graph_Graph51019->SetMaximum(0.0130987);
