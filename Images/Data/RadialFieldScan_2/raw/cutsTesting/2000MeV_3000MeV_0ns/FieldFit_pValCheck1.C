...
//=========  (Fri Apr 23 18:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-49.79556);
   Graph_Graph01027->SetMaximum(50.69304);
   ...
   mainFit1028->SetChisquare(4.795414);
   ...
   mainFit1028->SetParameter(0,-1.37678);
   mainFit1028->SetParError(0,0.657547);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8429854);
   mainFit1028->SetParError(1,0.02152112);
   ...
   pt_LaTex = pt->AddText("0.843#pm0.0215");
   pt_LaTex = pt->AddText("#minus1.38#pm0.658");
   pt_LaTex = pt->AddText("#minus1.63#pm0.783");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.63322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.63322,-49.79556,1.63322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.795414);
   ...
   mainFit1029->SetParameter(0,-1.37678);
   mainFit1029->SetParError(0,0.657547);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8429854);
   mainFit1029->SetParError(1,0.02152112);
