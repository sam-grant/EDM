...
//=========  (Fri Apr 23 18:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-49.79556);
   Graph_Graph01023->SetMaximum(50.69304);
   ...
   mainFit1024->SetChisquare(4.829261);
   ...
   mainFit1024->SetParameter(0,-1.323086);
   mainFit1024->SetParError(0,0.5892286);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8447144);
   mainFit1024->SetParError(1,0.01936109);
   ...
   mainFit1025->SetChisquare(4.829261);
   ...
   mainFit1025->SetParameter(0,-1.323086);
   mainFit1025->SetParError(0,0.5892286);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8447144);
   mainFit1025->SetParError(1,0.01936109);
