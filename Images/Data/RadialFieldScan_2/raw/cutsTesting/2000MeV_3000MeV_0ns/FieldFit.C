...
//=========  (Fri Apr 23 18:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-49.79556);
   Graph_Graph01020->SetMaximum(50.69304);
   ...
   mainFit1021->SetChisquare(4.829261);
   ...
   mainFit1021->SetParameter(0,-1.323086);
   mainFit1021->SetParError(0,0.5892286);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8447144);
   mainFit1021->SetParError(1,0.01936109);
   ...
   pt_LaTex = pt->AddText("0.845#pm0.0194");
   pt_LaTex = pt->AddText("#minus1.32#pm0.589");
   pt_LaTex = pt->AddText("#minus1.57#pm0.692");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.566312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.566312,-49.79556,1.566312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.829261);
   ...
   mainFit1022->SetParameter(0,-1.323086);
   mainFit1022->SetParError(0,0.5892286);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8447144);
   mainFit1022->SetParError(1,0.01936109);
