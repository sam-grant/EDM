...
//=========  (Mon Apr 26 23:09:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.15061,70,61.57777);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.57778);
   Graph_Graph01035->SetMaximum(51.00493);
   ...
   mainFit1036->SetChisquare(4.64592);
   ...
   mainFit1036->SetParameter(0,-0.4344102);
   mainFit1036->SetParError(0,0.5510824);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8336031);
   mainFit1036->SetParError(1,0.01907943);
   ...
   pt_LaTex = pt->AddText("0.834#pm0.0191");
   pt_LaTex = pt->AddText("#minus0.434#pm0.551");
   pt_LaTex = pt->AddText("#minus0.521#pm0.658");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.5211236,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5211236,-33.57778,0.5211236,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.64592);
   ...
   mainFit1037->SetParameter(0,-0.4344102);
   mainFit1037->SetParError(0,0.5510824);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8336031);
   mainFit1037->SetParError(1,0.01907943);
