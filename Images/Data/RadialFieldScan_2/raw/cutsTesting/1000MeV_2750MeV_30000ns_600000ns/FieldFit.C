...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.78602);
   Graph_Graph01020->SetMaximum(52.93295);
   ...
   mainFit1021->SetChisquare(4.894447);
   ...
   mainFit1021->SetParameter(0,-0.5172592);
   mainFit1021->SetParError(0,0.5254267);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8375299);
   mainFit1021->SetParError(1,0.01737757);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.0174");
   pt_LaTex = pt->AddText("#minus0.517#pm0.525");
   pt_LaTex = pt->AddText("#minus0.618#pm0.625");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6176009,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6176009,-54.78602,0.6176009,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.894447);
   ...
   mainFit1022->SetParameter(0,-0.5172592);
   mainFit1022->SetParError(0,0.5254267);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8375299);
   mainFit1022->SetParError(1,0.01737757);
