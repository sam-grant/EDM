...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0185458);
   Graph_Graph11015->SetMaximum(0.04898397);
   ...
   Graph_Graph21016->SetMinimum(-0.01016276);
   Graph_Graph21016->SetMaximum(0.01197966);
   ...
   Graph_Graph31017->SetMinimum(-0.03096697);
   Graph_Graph31017->SetMaximum(0.02437576);
   ...
   Graph_Graph41018->SetMinimum(-0.02064516);
   Graph_Graph41018->SetMaximum(0.02954577);
   ...
   Graph_Graph51019->SetMinimum(-0.006981342);
   Graph_Graph51019->SetMaximum(0.00933632);
