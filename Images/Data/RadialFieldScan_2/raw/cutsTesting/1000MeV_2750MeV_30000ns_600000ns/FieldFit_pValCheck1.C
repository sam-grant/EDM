...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.25089,75,66.39782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-54.78602);
   Graph_Graph01027->SetMaximum(52.93295);
   ...
   mainFit1028->SetChisquare(0.4031192);
   ...
   mainFit1028->SetParameter(0,0.04418945);
   mainFit1028->SetParError(0,0.5884373);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8558986);
   mainFit1028->SetParError(1,0.01941918);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.134");
   pt_LaTex = pt->AddText("0.856#pm0.0194");
   pt_LaTex = pt->AddText("0.0442#pm0.588");
   pt_LaTex = pt->AddText("0.0516#pm0.687");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.05162931,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.05162931,-54.78602,-0.05162931,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4031192);
   ...
   mainFit1029->SetParameter(0,0.04418945);
   mainFit1029->SetParError(0,0.5884373);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8558986);
   mainFit1029->SetParError(1,0.01941918);
