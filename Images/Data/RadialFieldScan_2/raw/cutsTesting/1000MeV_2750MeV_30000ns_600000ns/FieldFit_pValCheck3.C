...
//=========  (Mon Apr 26 23:09:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.78602);
   Graph_Graph01031->SetMaximum(52.93295);
   ...
   mainFit1032->SetChisquare(4.890963);
   ...
   mainFit1032->SetParameter(0,-0.5349904);
   mainFit1032->SetParError(0,0.6052302);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8378037);
   mainFit1032->SetParError(1,0.01798593);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.63");
   pt_LaTex = pt->AddText("0.838#pm0.018");
   pt_LaTex = pt->AddText("#minus0.535#pm0.605");
   pt_LaTex = pt->AddText("#minus0.639#pm0.719");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6385629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6385629,-54.78602,0.6385629,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.890963);
   ...
   mainFit1033->SetParameter(0,-0.5349904);
   mainFit1033->SetParError(0,0.6052302);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8378037);
   mainFit1033->SetParError(1,0.01798593);
