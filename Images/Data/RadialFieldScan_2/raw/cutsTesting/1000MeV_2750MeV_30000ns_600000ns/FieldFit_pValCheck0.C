...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.2269,50,41.27785);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.77642);
   Graph_Graph01025->SetMaximum(30.82737);
   ...
   mainFit1026->SetChisquare(3.203099);
   ...
   mainFit1026->SetParameter(0,-0.791033);
   mainFit1026->SetParError(0,0.5660144);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8191023);
   mainFit1026->SetParError(1,0.02241671);
   ...
   pt_LaTex = pt->AddText("0.819#pm0.0224");
   pt_LaTex = pt->AddText("#minus0.791#pm0.566");
   pt_LaTex = pt->AddText("#minus0.966#pm0.695");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.9657317,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9657317,-52.77642,0.9657317,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.203099);
   ...
   mainFit1027->SetParameter(0,-0.791033);
   mainFit1027->SetParError(0,0.5660144);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8191023);
   mainFit1027->SetParError(1,0.02241671);
