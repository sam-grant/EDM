...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.78602);
   Graph_Graph01029->SetMaximum(52.93295);
   ...
   mainFit1030->SetChisquare(3.722227);
   ...
   mainFit1030->SetParameter(0,-0.7596876);
   mainFit1030->SetParError(0,0.5711498);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8360912);
   mainFit1030->SetParError(1,0.01742821);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0174");
   pt_LaTex = pt->AddText("#minus0.76#pm0.571");
   pt_LaTex = pt->AddText("#minus0.909#pm0.681");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9086182,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9086182,-54.78602,0.9086182,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.722227);
   ...
   mainFit1031->SetParameter(0,-0.7596876);
   mainFit1031->SetParError(0,0.5711498);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8360912);
   mainFit1031->SetParError(1,0.01742821);
