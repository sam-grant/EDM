...
//=========  (Mon Apr 26 23:09:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.78602);
   Graph_Graph01033->SetMaximum(52.93295);
   ...
   mainFit1034->SetChisquare(4.799534);
   ...
   mainFit1034->SetParameter(0,-0.6394584);
   mainFit1034->SetParError(0,0.6583328);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8415486);
   mainFit1034->SetParError(1,0.02172867);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  1.6");
   pt_LaTex = pt->AddText("0.842#pm0.0217");
   pt_LaTex = pt->AddText("#minus0.639#pm0.658");
   pt_LaTex = pt->AddText("#minus0.76#pm0.773");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7598591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7598591,-54.78602,0.7598591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.799534);
   ...
   mainFit1035->SetParameter(0,-0.6394584);
   mainFit1035->SetParError(0,0.6583328);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8415486);
   mainFit1035->SetParError(1,0.02172867);
