...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9486956);
   ...
   quadLineFit1002->SetParameter(0,74.60626);
   quadLineFit1002->SetParError(0,0.08020695);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.6109);
   quadLineFit1002->SetParError(1,1.34547);
   ...
   quadLineFit1003->SetChisquare(0.9486956);
   ...
   quadLineFit1003->SetParameter(0,74.60626);
   quadLineFit1003->SetParError(0,0.08020695);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.6109);
   quadLineFit1003->SetParError(1,1.34547);
   ...
   Graph_30_ppm1003->SetMinimum(75.79091);
   Graph_30_ppm1003->SetMaximum(76.36904);
   ...
   quadLineFit1004->SetChisquare(4.588279);
   ...
   quadLineFit1004->SetParameter(0,74.68836);
   quadLineFit1004->SetParError(0,0.0673782);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.75299);
   quadLineFit1004->SetParError(1,1.107398);
   ...
   quadLineFit1005->SetChisquare(4.588279);
   ...
   quadLineFit1005->SetParameter(0,74.68836);
   quadLineFit1005->SetParError(0,0.0673782);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.75299);
   quadLineFit1005->SetParError(1,1.107398);
   ...
   Graph_10_ppm1005->SetMinimum(74.84908);
   Graph_10_ppm1005->SetMaximum(75.11868);
   ...
   quadLineFit1006->SetChisquare(0.7833742);
   ...
   quadLineFit1006->SetParameter(0,74.41482);
   quadLineFit1006->SetParError(0,0.07894347);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.121835);
   quadLineFit1006->SetParError(1,1.280388);
   ...
   quadLineFit1007->SetChisquare(0.7833742);
   ...
   quadLineFit1007->SetParameter(0,74.41482);
   quadLineFit1007->SetParError(0,0.07894347);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.121835);
   quadLineFit1007->SetParError(1,1.280388);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.71778);
   Graph_mI10_ppm1007->SetMaximum(73.99818);
   ...
   quadLineFit1008->SetChisquare(4.50803);
   ...
   quadLineFit1008->SetParameter(0,74.39296);
   quadLineFit1008->SetParError(0,0.06930884);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.835418);
   quadLineFit1008->SetParError(1,1.128148);
   ...
   quadLineFit1009->SetChisquare(4.50803);
   ...
   quadLineFit1009->SetParameter(0,74.39296);
   quadLineFit1009->SetParError(0,0.06930884);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.835418);
   quadLineFit1009->SetParError(1,1.128148);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.39774);
   Graph_mI30_ppm1009->SetMaximum(73.06182);
   ...
   quadLineFit1010->SetChisquare(2.729857);
   ...
   quadLineFit1010->SetParameter(0,74.30397);
   quadLineFit1010->SetParError(0,0.06556541);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.39447);
   quadLineFit1010->SetParError(1,1.134747);
   ...
   quadLineFit1011->SetChisquare(2.729857);
   ...
   quadLineFit1011->SetParameter(0,74.30397);
   quadLineFit1011->SetParError(0,0.06556541);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.39447);
   quadLineFit1011->SetParError(1,1.134747);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.50529);
   Graph_mI50_ppm1011->SetMaximum(72.13429);
   ...
   quadLineFit1012->SetChisquare(0.4235137);
   ...
   quadLineFit1012->SetParameter(0,74.29837);
   quadLineFit1012->SetParError(0,0.1322908);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.44241);
   quadLineFit1012->SetParError(1,2.367029);
   ...
   quadLineFit1013->SetChisquare(0.4235137);
   ...
   quadLineFit1013->SetParameter(0,74.29837);
   quadLineFit1013->SetParError(0,0.1322908);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.44241);
   quadLineFit1013->SetParError(1,2.367029);
