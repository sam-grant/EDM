...
//=========  (Mon Apr 26 23:09:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.78602);
   Graph_Graph01023->SetMaximum(52.93295);
   ...
   mainFit1024->SetChisquare(4.894447);
   ...
   mainFit1024->SetParameter(0,-0.5172592);
   mainFit1024->SetParError(0,0.5254267);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8375299);
   mainFit1024->SetParError(1,0.01737757);
   ...
   mainFit1025->SetChisquare(4.894447);
   ...
   mainFit1025->SetParameter(0,-0.5172592);
   mainFit1025->SetParError(0,0.5254267);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8375299);
   mainFit1025->SetParError(1,0.01737757);
