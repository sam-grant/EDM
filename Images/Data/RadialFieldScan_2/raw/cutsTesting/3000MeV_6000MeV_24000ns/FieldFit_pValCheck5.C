...
//=========  (Wed Apr 21 21:48:46 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.63685,70,65.12031);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.26114);
   Graph_Graph01035->SetMaximum(53.74459);
   ...
   mainFit1036->SetChisquare(6.53156);
   ...
   mainFit1036->SetParameter(0,2.123862);
   mainFit1036->SetParError(0,1.660341);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8037068);
   mainFit1036->SetParError(1,0.05761719);
   ...
   pt_LaTex = pt->AddText("0.804#pm0.0576");
   pt_LaTex = pt->AddText(" 2.12#pm 1.66");
   pt_LaTex = pt->AddText(" 2.64#pm 2.12");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-2.642583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.642583,-37.26114,-2.642583,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.53156);
   ...
   mainFit1037->SetParameter(0,2.123862);
   mainFit1037->SetParError(0,1.660341);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8037068);
   mainFit1037->SetParError(1,0.05761719);
