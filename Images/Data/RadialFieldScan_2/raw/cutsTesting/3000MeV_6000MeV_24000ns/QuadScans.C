...
//=========  (Wed Apr 21 21:48:45 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.567669);
   ...
   quadLineFit1002->SetParameter(0,75.02214);
   quadLineFit1002->SetParError(0,0.2434429);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.07671);
   quadLineFit1002->SetParError(1,4.084066);
   ...
   quadLineFit1003->SetChisquare(3.567669);
   ...
   quadLineFit1003->SetParameter(0,75.02214);
   quadLineFit1003->SetParError(0,0.2434429);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.07671);
   quadLineFit1003->SetParError(1,4.084066);
   ...
   Graph_30_ppm1003->SetMinimum(76.14263);
   Graph_30_ppm1003->SetMaximum(76.9223);
   ...
   quadLineFit1004->SetChisquare(1.605207);
   ...
   quadLineFit1004->SetParameter(0,74.99207);
   quadLineFit1004->SetParError(0,0.2027015);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.34653);
   quadLineFit1004->SetParError(1,3.33455);
   ...
   quadLineFit1005->SetChisquare(1.605207);
   ...
   quadLineFit1005->SetParameter(0,74.99207);
   quadLineFit1005->SetParError(0,0.2027015);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.34653);
   quadLineFit1005->SetParError(1,3.33455);
   ...
   Graph_10_ppm1005->SetMinimum(75.28037);
   Graph_10_ppm1005->SetMaximum(75.62013);
   ...
   quadLineFit1006->SetChisquare(1.401599);
   ...
   quadLineFit1006->SetParameter(0,74.94038);
   quadLineFit1006->SetParError(0,0.237999);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.710788);
   quadLineFit1006->SetParError(1,3.861741);
   ...
   quadLineFit1007->SetChisquare(1.401599);
   ...
   quadLineFit1007->SetParameter(0,74.94038);
   quadLineFit1007->SetParError(0,0.237999);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.710788);
   quadLineFit1007->SetParError(1,3.861741);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.16298);
   Graph_mI10_ppm1007->SetMaximum(74.56365);
   ...
   quadLineFit1008->SetChisquare(11.23802);
   ...
   quadLineFit1008->SetParameter(0,74.29926);
   quadLineFit1008->SetParError(0,0.2084717);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,1.283385);
   quadLineFit1008->SetParError(1,3.395827);
   ...
   quadLineFit1009->SetChisquare(11.23802);
   ...
   quadLineFit1009->SetParameter(0,74.29926);
   quadLineFit1009->SetParError(0,0.2084717);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,1.283385);
   quadLineFit1009->SetParError(1,3.395827);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.82812);
   Graph_mI30_ppm1009->SetMaximum(73.58188);
   ...
   quadLineFit1010->SetChisquare(0.7897442);
   ...
   quadLineFit1010->SetParameter(0,74.80991);
   quadLineFit1010->SetParError(0,0.1973567);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.2602);
   quadLineFit1010->SetParError(1,3.417121);
   ...
   quadLineFit1011->SetChisquare(0.7897442);
   ...
   quadLineFit1011->SetParameter(0,74.80991);
   quadLineFit1011->SetParError(0,0.1973567);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.2602);
   quadLineFit1011->SetParError(1,3.417121);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.87489);
   Graph_mI50_ppm1011->SetMaximum(72.62056);
   ...
   quadLineFit1012->SetChisquare(0.1711739);
   ...
   quadLineFit1012->SetParameter(0,74.84968);
   quadLineFit1012->SetParError(0,0.3979508);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.46448);
   quadLineFit1012->SetParError(1,7.119157);
   ...
   quadLineFit1013->SetChisquare(0.1711739);
   ...
   quadLineFit1013->SetParameter(0,74.84968);
   quadLineFit1013->SetParError(0,0.3979508);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.46448);
   quadLineFit1013->SetParError(1,7.119157);
