...
//=========  (Wed Apr 21 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-62.45808);
   Graph_Graph01033->SetMaximum(56.03522);
   ...
   mainFit1034->SetChisquare(5.704364);
   ...
   mainFit1034->SetParameter(0,3.208282);
   mainFit1034->SetParError(0,1.982286);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7747145);
   mainFit1034->SetParError(1,0.06557389);
   ...
   pt_LaTex = pt->AddText("0.775#pm0.0656");
   pt_LaTex = pt->AddText(" 3.21#pm 1.98");
   pt_LaTex = pt->AddText(" 4.14#pm 2.74");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-4.141244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-4.141244,-62.45808,-4.141244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.704364);
   ...
   mainFit1035->SetParameter(0,3.208282);
   mainFit1035->SetParError(0,1.982286);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7747145);
   mainFit1035->SetParError(1,0.06557389);
