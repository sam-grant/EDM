...
//=========  (Wed Apr 21 21:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-62.45808);
   Graph_Graph01020->SetMaximum(56.03522);
   ...
   mainFit1021->SetChisquare(7.384722);
   ...
   mainFit1021->SetParameter(0,1.662195);
   mainFit1021->SetParError(0,1.583324);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8257153);
   mainFit1021->SetParError(1,0.05245949);
   ...
   pt_LaTex = pt->AddText("0.826#pm0.0525");
   pt_LaTex = pt->AddText(" 1.66#pm 1.58");
   pt_LaTex = pt->AddText(" 2.01#pm 1.94");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.013037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.013037,-62.45808,-2.013037,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.384722);
   ...
   mainFit1022->SetParameter(0,1.662195);
   mainFit1022->SetParError(0,1.583324);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8257153);
   mainFit1022->SetParError(1,0.05245949);
