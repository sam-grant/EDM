...
//=========  (Wed Apr 21 21:48:45 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.89982,50,48.99726);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.71011);
   Graph_Graph01025->SetMaximum(36.80755);
   ...
   mainFit1026->SetChisquare(7.29646);
   ...
   mainFit1026->SetParameter(0,1.849932);
   mainFit1026->SetParError(0,1.704769);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8383304);
   mainFit1026->SetParError(1,0.06749104);
   ...
   pt_LaTex = pt->AddText("0.838#pm0.0675");
   pt_LaTex = pt->AddText(" 1.85#pm  1.7");
   pt_LaTex = pt->AddText(" 2.21#pm 2.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-2.206686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.206686,-60.71011,-2.206686,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(7.29646);
   ...
   mainFit1027->SetParameter(0,1.849932);
   mainFit1027->SetParError(0,1.704769);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8383304);
   mainFit1027->SetParError(1,0.06749104);
