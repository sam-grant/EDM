...
//=========  (Wed Apr 21 21:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.45808);
   Graph_Graph01023->SetMaximum(56.03522);
   ...
   mainFit1024->SetChisquare(7.384722);
   ...
   mainFit1024->SetParameter(0,1.662195);
   mainFit1024->SetParError(0,1.583324);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8257153);
   mainFit1024->SetParError(1,0.05245949);
   ...
   mainFit1025->SetChisquare(7.384722);
   ...
   mainFit1025->SetParameter(0,1.662195);
   mainFit1025->SetParError(0,1.583324);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8257153);
   mainFit1025->SetParError(1,0.05245949);
