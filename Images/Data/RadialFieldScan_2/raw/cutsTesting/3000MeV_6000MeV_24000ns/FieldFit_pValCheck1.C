...
//=========  (Wed Apr 21 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-62.45808);
   Graph_Graph01027->SetMaximum(56.03522);
   ...
   mainFit1028->SetChisquare(7.213936);
   ...
   mainFit1028->SetParameter(0,1.994408);
   mainFit1028->SetParError(0,1.775706);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8366314);
   mainFit1028->SetParError(1,0.05873424);
   ...
   pt_LaTex = pt->AddText("0.837#pm0.0587");
   pt_LaTex = pt->AddText(" 1.99#pm 1.78");
   pt_LaTex = pt->AddText(" 2.38#pm 2.12");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.383855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.383855,-62.45808,-2.383855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(7.213936);
   ...
   mainFit1029->SetParameter(0,1.994408);
   mainFit1029->SetParError(0,1.775706);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8366314);
   mainFit1029->SetParError(1,0.05873424);
