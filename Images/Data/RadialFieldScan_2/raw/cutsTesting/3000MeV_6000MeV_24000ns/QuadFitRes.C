...
//=========  (Wed Apr 21 21:48:45 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.06404121);
   Graph_Graph11015->SetMaximum(0.04770565);
   ...
   Graph_Graph21016->SetMinimum(-0.04116809);
   Graph_Graph21016->SetMaximum(0.04852925);
   ...
   Graph_Graph31017->SetMinimum(-0.1455527);
   Graph_Graph31017->SetMaximum(0.1208697);
   ...
   Graph_Graph41018->SetMinimum(-0.03546441);
   Graph_Graph41018->SetMaximum(0.0236065);
   ...
   Graph_Graph51019->SetMinimum(-0.01339017);
   Graph_Graph51019->SetMaximum(0.01784292);
