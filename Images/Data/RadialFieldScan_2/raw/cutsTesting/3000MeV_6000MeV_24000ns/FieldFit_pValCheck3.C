...
//=========  (Wed Apr 21 21:48:46 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-77.26974,75,70.84689);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-62.45808);
   Graph_Graph01031->SetMaximum(56.03522);
   ...
   mainFit1032->SetChisquare(0.07227357);
   ...
   mainFit1032->SetParameter(0,-0.7860054);
   mainFit1032->SetParError(0,1.823888);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8633943);
   mainFit1032->SetParError(1,0.05427842);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0241");
   pt_LaTex = pt->AddText("0.863#pm0.0543");
   pt_LaTex = pt->AddText("#minus0.786#pm 1.82");
   pt_LaTex = pt->AddText("#minus0.91#pm  2.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9103668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9103668,-62.45808,0.9103668,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.07227357);
   ...
   mainFit1033->SetParameter(0,-0.7860054);
   mainFit1033->SetParError(0,1.823888);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8633943);
   mainFit1033->SetParError(1,0.05427842);
