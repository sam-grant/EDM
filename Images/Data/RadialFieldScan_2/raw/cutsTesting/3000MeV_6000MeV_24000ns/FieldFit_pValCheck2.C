...
//=========  (Wed Apr 21 21:48:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.45808);
   Graph_Graph01029->SetMaximum(56.03522);
   ...
   mainFit1030->SetChisquare(6.991116);
   ...
   mainFit1030->SetParameter(0,2.085806);
   mainFit1030->SetParError(0,1.721199);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8282704);
   mainFit1030->SetParError(1,0.05261973);
   ...
   pt_LaTex = pt->AddText("0.828#pm0.0526");
   pt_LaTex = pt->AddText(" 2.09#pm 1.72");
   pt_LaTex = pt->AddText(" 2.52#pm  2.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.518267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.518267,-62.45808,-2.518267,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.991116);
   ...
   mainFit1031->SetParameter(0,2.085806);
   mainFit1031->SetParError(0,1.721199);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8282704);
   mainFit1031->SetParError(1,0.05261973);
