...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-72.6783,50,55.06552);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.90391);
   Graph_Graph01025->SetMaximum(42.29113);
   ...
   mainFit1026->SetChisquare(1.341057);
   ...
   mainFit1026->SetParameter(0,0.6229895);
   mainFit1026->SetParError(0,2.428174);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9229718);
   mainFit1026->SetParError(1,0.0960685);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0961");
   pt_LaTex = pt->AddText("0.623#pm 2.43");
   pt_LaTex = pt->AddText("0.675#pm 2.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.6749821,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6749821,-59.90391,-0.6749821,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.341057);
   ...
   mainFit1027->SetParameter(0,0.6229895);
   mainFit1027->SetParError(0,2.428174);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9229718);
   mainFit1027->SetParError(1,0.0960685);
