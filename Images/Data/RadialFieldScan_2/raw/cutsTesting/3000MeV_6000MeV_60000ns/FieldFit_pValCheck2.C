...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.98411);
   Graph_Graph01029->SetMaximum(65.17326);
   ...
   mainFit1030->SetChisquare(0.9429792);
   ...
   mainFit1030->SetParameter(0,1.500872);
   mainFit1030->SetParError(0,2.45071);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9420094);
   mainFit1030->SetParError(1,0.07477575);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.314");
   pt_LaTex = pt->AddText("0.942#pm0.0748");
   pt_LaTex = pt->AddText("  1.5#pm 2.45");
   pt_LaTex = pt->AddText(" 1.59#pm 2.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.593266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.593266,-61.98411,-1.593266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9429792);
   ...
   mainFit1031->SetParameter(0,1.500872);
   mainFit1031->SetParError(0,2.45071);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9420094);
   mainFit1031->SetParError(1,0.07477575);
