...
//=========  (Thu Apr 22 10:45:58 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.270524);
   ...
   quadLineFit1002->SetParameter(0,74.63684);
   quadLineFit1002->SetParError(0,0.3446877);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,48.79444);
   quadLineFit1002->SetParError(1,5.782369);
   ...
   quadLineFit1003->SetChisquare(3.270524);
   ...
   quadLineFit1003->SetParameter(0,74.63684);
   quadLineFit1003->SetParError(0,0.3446877);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,48.79444);
   quadLineFit1003->SetParError(1,5.782369);
   ...
   Graph_30_ppm1003->SetMinimum(76.12225);
   Graph_30_ppm1003->SetMaximum(77.01173);
   ...
   quadLineFit1004->SetChisquare(1.788806);
   ...
   quadLineFit1004->SetParameter(0,74.76371);
   quadLineFit1004->SetParError(0,0.2884067);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,29.03101);
   quadLineFit1004->SetParError(1,4.743875);
   ...
   quadLineFit1005->SetChisquare(1.788806);
   ...
   quadLineFit1005->SetParameter(0,74.76371);
   quadLineFit1005->SetParError(0,0.2884067);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,29.03101);
   quadLineFit1005->SetParError(1,4.743875);
   ...
   Graph_10_ppm1005->SetMinimum(75.27192);
   Graph_10_ppm1005->SetMaximum(75.64142);
   ...
   quadLineFit1006->SetChisquare(0.3631377);
   ...
   quadLineFit1006->SetParameter(0,75.00856);
   quadLineFit1006->SetParError(0,0.3388792);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.827592);
   quadLineFit1006->SetParError(1,5.497596);
   ...
   quadLineFit1007->SetChisquare(0.3631377);
   ...
   quadLineFit1007->SetParameter(0,75.00856);
   quadLineFit1007->SetParError(0,0.3388792);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.827592);
   quadLineFit1007->SetParError(1,5.497596);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.26338);
   Graph_mI10_ppm1007->SetMaximum(74.616);
   ...
   quadLineFit1008->SetChisquare(0.7311175);
   ...
   quadLineFit1008->SetParameter(0,74.7335);
   quadLineFit1008->SetParError(0,0.2974698);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.180071);
   quadLineFit1008->SetParError(1,4.845627);
   ...
   quadLineFit1009->SetChisquare(0.7311175);
   ...
   quadLineFit1009->SetParameter(0,74.7335);
   quadLineFit1009->SetParError(0,0.2974698);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.180071);
   quadLineFit1009->SetParError(1,4.845627);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.78145);
   Graph_mI30_ppm1009->SetMaximum(73.66432);
   ...
   quadLineFit1010->SetChisquare(2.531024);
   ...
   quadLineFit1010->SetParameter(0,75.02529);
   quadLineFit1010->SetParError(0,0.281267);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.89898);
   quadLineFit1010->SetParError(1,4.871528);
   ...
   quadLineFit1011->SetChisquare(2.531024);
   ...
   quadLineFit1011->SetParameter(0,75.02529);
   quadLineFit1011->SetParError(0,0.281267);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.89898);
   quadLineFit1011->SetParError(1,4.871528);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.92881);
   Graph_mI50_ppm1011->SetMaximum(72.6762);
   ...
   quadLineFit1012->SetChisquare(0.0002785471);
   ...
   quadLineFit1012->SetParameter(0,74.65826);
   quadLineFit1012->SetParError(0,0.565722);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.26662);
   quadLineFit1012->SetParError(1,10.12104);
   ...
   quadLineFit1013->SetChisquare(0.0002785471);
   ...
   quadLineFit1013->SetParameter(0,74.65826);
   quadLineFit1013->SetParError(0,0.565722);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.26662);
   quadLineFit1013->SetParError(1,10.12104);
