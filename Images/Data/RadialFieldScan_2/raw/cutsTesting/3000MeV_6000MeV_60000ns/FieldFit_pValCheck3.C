...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.98411);
   Graph_Graph01031->SetMaximum(65.17326);
   ...
   mainFit1032->SetChisquare(0.7541345);
   ...
   mainFit1032->SetParameter(0,-0.1886988);
   mainFit1032->SetParError(0,2.596263);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9541618);
   mainFit1032->SetParError(1,0.07715768);
   ...
   pt_LaTex = pt->AddText("0.954#pm0.0772");
   pt_LaTex = pt->AddText("#minus0.189#pm  2.6");
   pt_LaTex = pt->AddText("#minus0.198#pm 2.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.197764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.197764,-61.98411,0.197764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.7541345);
   ...
   mainFit1033->SetParameter(0,-0.1886988);
   mainFit1033->SetParError(0,2.596263);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9541618);
   mainFit1033->SetParError(1,0.07715768);
