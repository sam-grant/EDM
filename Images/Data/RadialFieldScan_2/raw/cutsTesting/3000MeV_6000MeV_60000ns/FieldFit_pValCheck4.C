...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-77.87878,75,81.06793);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-61.98411);
   Graph_Graph01033->SetMaximum(65.17326);
   ...
   mainFit1034->SetChisquare(0.8402688);
   ...
   mainFit1034->SetParameter(0,2.124884);
   mainFit1034->SetParError(0,2.823641);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8962016);
   mainFit1034->SetParError(1,0.09317639);
   ...
   pt_LaTex = pt->AddText("0.896#pm0.0932");
   pt_LaTex = pt->AddText(" 2.12#pm 2.82");
   pt_LaTex = pt->AddText(" 2.37#pm 3.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.370988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.370988,-61.98411,-2.370988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.8402688);
   ...
   mainFit1035->SetParameter(0,2.124884);
   mainFit1035->SetParError(0,2.823641);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8962016);
   mainFit1035->SetParError(1,0.09317639);
