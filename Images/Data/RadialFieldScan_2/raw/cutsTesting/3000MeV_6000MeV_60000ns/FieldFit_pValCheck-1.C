...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.98411);
   Graph_Graph01023->SetMaximum(65.17326);
   ...
   mainFit1024->SetChisquare(1.403847);
   ...
   mainFit1024->SetParameter(0,0.8488344);
   mainFit1024->SetParError(0,2.254713);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9381542);
   mainFit1024->SetParError(1,0.07455811);
   ...
   mainFit1025->SetChisquare(1.403847);
   ...
   mainFit1025->SetParameter(0,0.8488344);
   mainFit1025->SetParError(0,2.254713);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9381542);
   mainFit1025->SetParError(1,0.07455811);
