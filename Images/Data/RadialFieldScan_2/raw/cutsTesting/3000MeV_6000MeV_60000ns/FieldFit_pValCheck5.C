...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-57.10734,70,76.91364);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-43.70524);
   Graph_Graph01035->SetMaximum(63.51154);
   ...
   mainFit1036->SetChisquare(1.119453);
   ...
   mainFit1036->SetParameter(0,0.466989);
   mainFit1036->SetParError(0,2.365676);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9562518);
   mainFit1036->SetParError(1,0.08191805);
   ...
   pt_LaTex = pt->AddText("0.956#pm0.0819");
   pt_LaTex = pt->AddText("0.467#pm 2.37");
   pt_LaTex = pt->AddText("0.488#pm 2.49");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.4883536,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4883536,-43.70524,-0.4883536,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.119453);
   ...
   mainFit1037->SetParameter(0,0.466989);
   mainFit1037->SetParError(0,2.365676);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9562518);
   mainFit1037->SetParError(1,0.08191805);
