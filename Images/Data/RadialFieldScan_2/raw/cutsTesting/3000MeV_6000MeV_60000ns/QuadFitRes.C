...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.1355763);
   Graph_Graph11015->SetMaximum(0.0459218);
   ...
   Graph_Graph21016->SetMinimum(-0.02986486);
   Graph_Graph21016->SetMaximum(0.0350684);
   ...
   Graph_Graph31017->SetMinimum(-0.056711);
   Graph_Graph31017->SetMaximum(0.04541752);
   ...
   Graph_Graph41018->SetMinimum(-0.08429302);
   Graph_Graph41018->SetMaximum(0.06634152);
   ...
   Graph_Graph51019->SetMinimum(-0.0007663124);
   Graph_Graph51019->SetMaximum(0.001026782);
