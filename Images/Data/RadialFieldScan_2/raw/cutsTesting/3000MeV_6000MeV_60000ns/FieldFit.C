...
//=========  (Thu Apr 22 10:45:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.98411);
   Graph_Graph01020->SetMaximum(65.17326);
   ...
   mainFit1021->SetChisquare(1.403847);
   ...
   mainFit1021->SetParameter(0,0.8488344);
   mainFit1021->SetParError(0,2.254713);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9381542);
   mainFit1021->SetParError(1,0.07455811);
   ...
   pt_LaTex = pt->AddText("0.849#pm 2.25");
   pt_LaTex = pt->AddText("0.905#pm 2.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.904792,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.904792,-61.98411,-0.904792,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.403847);
   ...
   mainFit1022->SetParameter(0,0.8488344);
   mainFit1022->SetParError(0,2.254713);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9381542);
   mainFit1022->SetParError(1,0.07455811);
