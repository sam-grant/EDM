...
//=========  (Thu Apr 22 09:56:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-44.96217);
   Graph_Graph01033->SetMaximum(49.5975);
   ...
   mainFit1034->SetChisquare(3.481419);
   ...
   mainFit1034->SetParameter(0,0.6247709);
   mainFit1034->SetParError(0,0.8092708);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7483608);
   mainFit1034->SetParError(1,0.02669223);
   ...
   pt_LaTex = pt->AddText("0.748#pm0.0267");
   pt_LaTex = pt->AddText("0.625#pm0.809");
   pt_LaTex = pt->AddText("0.835#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.8348525,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.8348525,-44.96217,-0.8348525,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.481419);
   ...
   mainFit1035->SetParameter(0,0.6247709);
   mainFit1035->SetParError(0,0.8092708);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7483608);
   mainFit1035->SetParError(1,0.02669223);
