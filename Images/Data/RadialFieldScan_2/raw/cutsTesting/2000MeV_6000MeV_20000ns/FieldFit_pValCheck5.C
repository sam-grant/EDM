...
//=========  (Thu Apr 22 09:56:17 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-41.90113,70,58.44126);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.86689);
   Graph_Graph01035->SetMaximum(48.40702);
   ...
   mainFit1036->SetChisquare(2.194109);
   ...
   mainFit1036->SetParameter(0,-0.1705969);
   mainFit1036->SetParError(0,0.6774359);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7789599);
   mainFit1036->SetParError(1,0.02343858);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.731");
   pt_LaTex = pt->AddText("0.779#pm0.0234");
   pt_LaTex = pt->AddText("#minus0.171#pm0.677");
   pt_LaTex = pt->AddText("#minus0.219#pm0.868");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.219006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.219006,-31.86689,0.219006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.194109);
   ...
   mainFit1037->SetParameter(0,-0.1705969);
   mainFit1037->SetParError(0,0.6774359);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7789599);
   mainFit1037->SetParError(1,0.02343858);
