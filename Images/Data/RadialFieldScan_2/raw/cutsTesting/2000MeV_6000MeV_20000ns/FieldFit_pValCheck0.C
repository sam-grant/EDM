...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-52.11034,50,38.05851);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-43.09345);
   Graph_Graph01025->SetMaximum(29.04162);
   ...
   mainFit1026->SetChisquare(2.372242);
   ...
   mainFit1026->SetParameter(0,-0.2369498);
   mainFit1026->SetParError(0,0.6957272);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7390727);
   mainFit1026->SetParError(1,0.02755186);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.791");
   pt_LaTex = pt->AddText("0.739#pm0.0276");
   pt_LaTex = pt->AddText("#minus0.237#pm0.696");
   pt_LaTex = pt->AddText("#minus0.321#pm0.943");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3206042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3206042,-43.09345,0.3206042,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.372242);
   ...
   mainFit1027->SetParameter(0,-0.2369498);
   mainFit1027->SetParError(0,0.6957272);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7390727);
   mainFit1027->SetParError(1,0.02755186);
