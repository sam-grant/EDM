...
//=========  (Thu Apr 22 09:56:15 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.11139);
   ...
   quadLineFit1002->SetParameter(0,75.06579);
   quadLineFit1002->SetParError(0,0.09842151);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.06682);
   quadLineFit1002->SetParError(1,1.650712);
   ...
   quadLineFit1003->SetChisquare(0.11139);
   ...
   quadLineFit1003->SetParameter(0,75.06579);
   quadLineFit1003->SetParError(0,0.09842151);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.06682);
   quadLineFit1003->SetParError(1,1.650712);
   ...
   Graph_30_ppm1003->SetMinimum(76.17826);
   Graph_30_ppm1003->SetMaximum(76.74307);
   ...
   quadLineFit1004->SetChisquare(1.140888);
   ...
   quadLineFit1004->SetParameter(0,75.12157);
   quadLineFit1004->SetParError(0,0.08276325);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.66986);
   quadLineFit1004->SetParError(1,1.360511);
   ...
   quadLineFit1005->SetChisquare(1.140888);
   ...
   quadLineFit1005->SetParameter(0,75.12157);
   quadLineFit1005->SetParError(0,0.08276325);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.66986);
   quadLineFit1005->SetParError(1,1.360511);
   ...
   Graph_10_ppm1005->SetMinimum(75.26443);
   Graph_10_ppm1005->SetMaximum(75.5108);
   ...
   quadLineFit1006->SetChisquare(0.0370252);
   ...
   quadLineFit1006->SetParameter(0,74.90018);
   quadLineFit1006->SetParError(0,0.09705457);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.884443);
   quadLineFit1006->SetParError(1,1.574068);
   ...
   quadLineFit1007->SetChisquare(0.0370252);
   ...
   quadLineFit1007->SetParameter(0,74.90018);
   quadLineFit1007->SetParError(0,0.09705457);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.884443);
   quadLineFit1007->SetParError(1,1.574068);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.24906);
   Graph_mI10_ppm1007->SetMaximum(74.51765);
   ...
   quadLineFit1008->SetChisquare(7.530554);
   ...
   quadLineFit1008->SetParameter(0,74.81245);
   quadLineFit1008->SetParError(0,0.08521472);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.248436);
   quadLineFit1008->SetParError(1,1.38702);
   ...
   quadLineFit1009->SetChisquare(7.530554);
   ...
   quadLineFit1009->SetParameter(0,74.81245);
   quadLineFit1009->SetParError(0,0.08521472);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.248436);
   quadLineFit1009->SetParError(1,1.38702);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.99642);
   Graph_mI30_ppm1009->SetMaximum(73.60634);
   ...
   quadLineFit1010->SetChisquare(1.557817);
   ...
   quadLineFit1010->SetParameter(0,74.75867);
   quadLineFit1010->SetParError(0,0.08062052);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.78204);
   quadLineFit1010->SetParError(1,1.39536);
   ...
   quadLineFit1011->SetChisquare(1.557817);
   ...
   quadLineFit1011->SetParameter(0,74.75867);
   quadLineFit1011->SetParError(0,0.08062052);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.78204);
   quadLineFit1011->SetParError(1,1.39536);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.17995);
   Graph_mI50_ppm1011->SetMaximum(72.69414);
   ...
   quadLineFit1012->SetChisquare(0.5803383);
   ...
   quadLineFit1012->SetParameter(0,74.39099);
   quadLineFit1012->SetParError(0,0.1626317);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-34.17248);
   quadLineFit1012->SetParError(1,2.909715);
   ...
   quadLineFit1013->SetChisquare(0.5803383);
   ...
   quadLineFit1013->SetParameter(0,74.39099);
   quadLineFit1013->SetParError(0,0.1626317);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-34.17248);
   quadLineFit1013->SetParError(1,2.909715);
