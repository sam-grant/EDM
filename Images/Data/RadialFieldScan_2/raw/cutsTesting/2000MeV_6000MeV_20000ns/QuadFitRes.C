...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01981322);
   Graph_Graph11015->SetMaximum(0.01845093);
   ...
   Graph_Graph21016->SetMinimum(-0.002720086);
   Graph_Graph21016->SetMaximum(0.003199556);
   ...
   Graph_Graph31017->SetMinimum(-0.0513003);
   Graph_Graph31017->SetMaximum(0.03847761);
   ...
   Graph_Graph41018->SetMinimum(-0.0316601);
   Graph_Graph41018->SetMaximum(0.01656786);
   ...
   Graph_Graph51019->SetMinimum(-0.01005696);
   Graph_Graph51019->SetMaximum(0.01343559);
