...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-44.96217);
   Graph_Graph01031->SetMaximum(49.5975);
   ...
   mainFit1032->SetChisquare(4.429648);
   ...
   mainFit1032->SetParameter(0,0.05876902);
   mainFit1032->SetParError(0,0.7439226);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7655725);
   mainFit1032->SetParError(1,0.02209768);
   ...
   pt_LaTex = pt->AddText("0.766#pm0.0221");
   pt_LaTex = pt->AddText("0.0588#pm0.744");
   pt_LaTex = pt->AddText("0.0768#pm0.972");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.0767648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.0767648,-44.96217,-0.0767648,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.429648);
   ...
   mainFit1033->SetParameter(0,0.05876902);
   mainFit1033->SetParError(0,0.7439226);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7655725);
   mainFit1033->SetParError(1,0.02209768);
