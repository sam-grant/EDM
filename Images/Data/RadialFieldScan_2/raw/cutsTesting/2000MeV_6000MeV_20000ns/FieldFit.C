...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-44.96217);
   Graph_Graph01020->SetMaximum(49.5975);
   ...
   mainFit1021->SetChisquare(4.476135);
   ...
   mainFit1021->SetParameter(0,0.1383789);
   mainFit1021->SetParError(0,0.6458215);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7643418);
   mainFit1021->SetParError(1,0.02134776);
   ...
   pt_LaTex = pt->AddText("0.764#pm0.0213");
   pt_LaTex = pt->AddText("0.138#pm0.646");
   pt_LaTex = pt->AddText("0.181#pm0.846");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1810432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1810432,-44.96217,-0.1810432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.476135);
   ...
   mainFit1022->SetParameter(0,0.1383789);
   mainFit1022->SetParError(0,0.6458215);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7643418);
   mainFit1022->SetParError(1,0.02134776);
