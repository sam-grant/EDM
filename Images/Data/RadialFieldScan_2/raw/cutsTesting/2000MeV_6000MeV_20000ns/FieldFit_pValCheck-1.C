...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-44.96217);
   Graph_Graph01023->SetMaximum(49.5975);
   ...
   mainFit1024->SetChisquare(4.476135);
   ...
   mainFit1024->SetParameter(0,0.1383789);
   mainFit1024->SetParError(0,0.6458215);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7643418);
   mainFit1024->SetParError(1,0.02134776);
   ...
   mainFit1025->SetChisquare(4.476135);
   ...
   mainFit1025->SetParameter(0,0.1383789);
   mainFit1025->SetParError(0,0.6458215);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7643418);
   mainFit1025->SetParError(1,0.02134776);
