...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-44.96217);
   Graph_Graph01029->SetMaximum(49.5975);
   ...
   mainFit1030->SetChisquare(4.471019);
   ...
   mainFit1030->SetParameter(0,0.1187275);
   mainFit1030->SetParError(0,0.7019469);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7642218);
   mainFit1030->SetParError(1,0.02140895);
   ...
   pt_LaTex = pt->AddText("0.764#pm0.0214");
   pt_LaTex = pt->AddText("0.119#pm0.702");
   pt_LaTex = pt->AddText("0.155#pm0.919");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1553573,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1553573,-44.96217,-0.1553573,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.471019);
   ...
   mainFit1031->SetParameter(0,0.1187275);
   mainFit1031->SetParError(0,0.7019469);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7642218);
   mainFit1031->SetParError(1,0.02140895);
