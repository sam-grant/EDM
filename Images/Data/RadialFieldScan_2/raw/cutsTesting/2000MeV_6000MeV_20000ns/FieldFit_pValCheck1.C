...
//=========  (Thu Apr 22 09:56:16 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-56.78213,75,61.41746);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-44.96217);
   Graph_Graph01027->SetMaximum(49.5975);
   ...
   mainFit1028->SetChisquare(2.786389);
   ...
   mainFit1028->SetParameter(0,0.5611912);
   mainFit1028->SetParError(0,0.7231062);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7781564);
   mainFit1028->SetParError(1,0.0238468);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.929");
   pt_LaTex = pt->AddText("0.778#pm0.0238");
   pt_LaTex = pt->AddText("0.561#pm0.723");
   pt_LaTex = pt->AddText("0.721#pm0.928");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.7211804,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7211804,-44.96217,-0.7211804,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.786389);
   ...
   mainFit1029->SetParameter(0,0.5611912);
   mainFit1029->SetParError(0,0.7231062);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7781564);
   mainFit1029->SetParError(1,0.0238468);
