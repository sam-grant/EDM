...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.75628,70,65.14735);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.36591);
   Graph_Graph01035->SetMaximum(53.75699);
   ...
   mainFit1036->SetChisquare(3.649468);
   ...
   mainFit1036->SetParameter(0,-1.802526);
   mainFit1036->SetParError(0,0.3970199);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9164208);
   mainFit1036->SetParError(1,0.01395239);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.014");
   pt_LaTex = pt->AddText(" #minus1.8#pm0.397");
   pt_LaTex = pt->AddText("#minus1.97#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.96692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.96692,-37.36591,1.96692,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.649468);
   ...
   mainFit1037->SetParameter(0,-1.802526);
   mainFit1037->SetParError(0,0.3970199);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9164208);
   mainFit1037->SetParError(1,0.01395239);
