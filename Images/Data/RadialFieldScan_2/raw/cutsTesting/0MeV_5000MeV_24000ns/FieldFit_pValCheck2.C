...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.52446);
   Graph_Graph01029->SetMaximum(55.7714);
   ...
   mainFit1030->SetChisquare(3.364208);
   ...
   mainFit1030->SetParameter(0,-1.93952);
   mainFit1030->SetParError(0,0.4130297);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9175095);
   mainFit1030->SetParError(1,0.01274786);
   ...
   pt_LaTex = pt->AddText("#minus1.94#pm0.413");
   pt_LaTex = pt->AddText("#minus2.11#pm0.448");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.113897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.113897,-59.52446,2.113897,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.364208);
   ...
   mainFit1031->SetParameter(0,-1.93952);
   mainFit1031->SetParError(0,0.4130297);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9175095);
   mainFit1031->SetParError(1,0.01274786);
