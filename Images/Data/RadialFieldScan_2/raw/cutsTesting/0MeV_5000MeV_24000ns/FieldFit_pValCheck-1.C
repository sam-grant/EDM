...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.52446);
   Graph_Graph01023->SetMaximum(55.7714);
   ...
   mainFit1024->SetChisquare(3.744149);
   ...
   mainFit1024->SetParameter(0,-1.838669);
   mainFit1024->SetParError(0,0.3792431);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9181979);
   mainFit1024->SetParError(1,0.01269863);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.936");
   pt_LaTex = pt->AddText("0.918#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.84#pm0.379");
   pt_LaTex = pt->AddText("   #minus2#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.002475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.002475,-59.52446,2.002475,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.744149);
   ...
   mainFit1025->SetParameter(0,-1.838669);
   mainFit1025->SetParError(0,0.3792431);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9181979);
   mainFit1025->SetParError(1,0.01269863);
