...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.75128,50,44.25756);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.4504);
   Graph_Graph01025->SetMaximum(32.95668);
   ...
   mainFit1026->SetChisquare(1.659079);
   ...
   mainFit1026->SetParameter(0,-2.052144);
   mainFit1026->SetParError(0,0.407039);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9038732);
   mainFit1026->SetParError(1,0.01611486);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.553");
   pt_LaTex = pt->AddText("0.904#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.05#pm0.407");
   pt_LaTex = pt->AddText("#minus2.27#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.270389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.270389,-57.4504,2.270389,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.659079);
   ...
   mainFit1027->SetParameter(0,-2.052144);
   mainFit1027->SetParError(0,0.407039);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9038732);
   mainFit1027->SetParError(1,0.01611486);
