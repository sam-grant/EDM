...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.52446);
   Graph_Graph01031->SetMaximum(55.7714);
   ...
   mainFit1032->SetChisquare(3.579779);
   ...
   mainFit1032->SetParameter(0,-1.751078);
   mainFit1032->SetParError(0,0.436469);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9168688);
   mainFit1032->SetParError(1,0.01311591);
   ...
   pt_LaTex = pt->AddText("0.917#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.75#pm0.436");
   pt_LaTex = pt->AddText("#minus1.91#pm 0.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.909846,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.909846,-59.52446,1.909846,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.579779);
   ...
   mainFit1033->SetParameter(0,-1.751078);
   mainFit1033->SetParError(0,0.436469);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9168688);
   mainFit1033->SetParError(1,0.01311591);
