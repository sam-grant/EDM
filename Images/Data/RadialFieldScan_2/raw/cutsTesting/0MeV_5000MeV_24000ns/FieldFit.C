...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.52446);
   Graph_Graph01020->SetMaximum(55.7714);
   ...
   mainFit1021->SetChisquare(3.744149);
   ...
   mainFit1021->SetParameter(0,-1.838669);
   mainFit1021->SetParError(0,0.3792431);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9181979);
   mainFit1021->SetParError(1,0.01269863);
   ...
   mainFit1022->SetChisquare(3.744149);
   ...
   mainFit1022->SetParameter(0,-1.838669);
   mainFit1022->SetParError(0,0.3792431);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9181979);
   mainFit1022->SetParError(1,0.01269863);
