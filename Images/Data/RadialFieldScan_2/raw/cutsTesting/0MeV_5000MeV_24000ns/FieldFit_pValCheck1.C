...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.93645,75,70.18339);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.52446);
   Graph_Graph01027->SetMaximum(55.7714);
   ...
   mainFit1028->SetChisquare(0.7188142);
   ...
   mainFit1028->SetParameter(0,-1.493004);
   mainFit1028->SetParError(0,0.4281722);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9298359);
   mainFit1028->SetParError(1,0.01435556);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0144");
   pt_LaTex = pt->AddText("#minus1.49#pm0.428");
   pt_LaTex = pt->AddText("#minus1.61#pm0.464");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.605664,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.605664,-59.52446,1.605664,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7188142);
   ...
   mainFit1029->SetParameter(0,-1.493004);
   mainFit1029->SetParError(0,0.4281722);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9298359);
   mainFit1029->SetParError(1,0.01435556);
