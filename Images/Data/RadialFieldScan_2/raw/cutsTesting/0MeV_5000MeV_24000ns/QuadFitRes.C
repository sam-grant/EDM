...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004203594);
   Graph_Graph11015->SetMaximum(0.009043504);
   ...
   Graph_Graph21016->SetMinimum(-0.008517317);
   Graph_Graph21016->SetMaximum(0.01000819);
   ...
   Graph_Graph31017->SetMinimum(-0.02330762);
   Graph_Graph31017->SetMaximum(0.01821018);
   ...
   Graph_Graph41018->SetMinimum(-0.004135662);
   Graph_Graph41018->SetMaximum(0.006121375);
   ...
   Graph_Graph51019->SetMinimum(-0.00247188);
   Graph_Graph51019->SetMaximum(0.003302609);
