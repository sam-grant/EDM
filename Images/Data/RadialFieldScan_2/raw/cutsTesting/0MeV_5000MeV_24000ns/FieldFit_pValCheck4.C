...
//=========  (Fri Apr 23 12:06:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.52446);
   Graph_Graph01033->SetMaximum(55.7714);
   ...
   mainFit1034->SetChisquare(3.198609);
   ...
   mainFit1034->SetParameter(0,-2.048679);
   mainFit1034->SetParError(0,0.4739931);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9252553);
   mainFit1034->SetParError(1,0.01589069);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0159");
   pt_LaTex = pt->AddText("#minus2.05#pm0.474");
   pt_LaTex = pt->AddText("#minus2.21#pm0.496");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.214177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.214177,-59.52446,2.214177,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.198609);
   ...
   mainFit1035->SetParameter(0,-2.048679);
   mainFit1035->SetParError(0,0.4739931);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9252553);
   mainFit1035->SetParError(1,0.01589069);
