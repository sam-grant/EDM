...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.70258,70,64.38703);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.59361);
   Graph_Graph01035->SetMaximum(53.27807);
   ...
   mainFit1036->SetChisquare(7.818697);
   ...
   mainFit1036->SetParameter(0,-1.167572);
   mainFit1036->SetParError(0,0.4339828);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8824271);
   mainFit1036->SetParError(1,0.01501276);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.61");
   pt_LaTex = pt->AddText("0.882#pm0.015");
   pt_LaTex = pt->AddText("#minus1.17#pm0.434");
   pt_LaTex = pt->AddText("#minus1.32#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.323137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.323137,-35.59361,1.323137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.818697);
   ...
   mainFit1037->SetParameter(0,-1.167572);
   mainFit1037->SetParError(0,0.4339828);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8824271);
   mainFit1037->SetParError(1,0.01501276);
