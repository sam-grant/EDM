...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.80723);
   Graph_Graph01029->SetMaximum(55.11567);
   ...
   mainFit1030->SetChisquare(7.809059);
   ...
   mainFit1030->SetParameter(0,-1.183246);
   mainFit1030->SetParError(0,0.4497362);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8803753);
   mainFit1030->SetParError(1,0.01371418);
   ...
   pt_LaTex = pt->AddText("#minus1.18#pm 0.45");
   pt_LaTex = pt->AddText("#minus1.34#pm0.509");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.344024,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.344024,-55.80723,1.344024,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.809059);
   ...
   mainFit1031->SetParameter(0,-1.183246);
   mainFit1031->SetParError(0,0.4497362);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8803753);
   mainFit1031->SetParError(1,0.01371418);
