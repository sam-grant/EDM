...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.80723);
   Graph_Graph01023->SetMaximum(55.11567);
   ...
   mainFit1024->SetChisquare(7.897776);
   ...
   mainFit1024->SetParameter(0,-1.130744);
   mainFit1024->SetParError(0,0.4137515);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8806849);
   mainFit1024->SetParError(1,0.01367494);
   ...
   mainFit1025->SetChisquare(7.897776);
   ...
   mainFit1025->SetParameter(0,-1.130744);
   mainFit1025->SetParError(0,0.4137515);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8806849);
   mainFit1025->SetParError(1,0.01367494);
