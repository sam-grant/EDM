...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.80723);
   Graph_Graph01031->SetMaximum(55.11567);
   ...
   mainFit1032->SetChisquare(7.896787);
   ...
   mainFit1032->SetParameter(0,-1.123308);
   mainFit1032->SetParError(0,0.4765613);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.88057);
   mainFit1032->SetParError(1,0.01415478);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.12#pm0.477");
   pt_LaTex = pt->AddText("#minus1.28#pm0.536");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.27566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.27566,-55.80723,1.27566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.896787);
   ...
   mainFit1033->SetParameter(0,-1.123308);
   mainFit1033->SetParError(0,0.4765613);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.88057);
   mainFit1033->SetParError(1,0.01415478);
