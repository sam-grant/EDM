...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.80723);
   Graph_Graph01033->SetMaximum(55.11567);
   ...
   mainFit1034->SetChisquare(7.73395);
   ...
   mainFit1034->SetParameter(0,-1.25727);
   mainFit1034->SetParError(0,0.5185636);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8848412);
   mainFit1034->SetParError(1,0.0171011);
   ...
   pt_LaTex = pt->AddText("#minus1.26#pm0.519");
   pt_LaTex = pt->AddText("#minus1.42#pm0.574");
   pt->Draw();
   ...
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.420899,-55.80723,1.420899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.73395);
   ...
   mainFit1035->SetParameter(0,-1.25727);
   mainFit1035->SetParError(0,0.5185636);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8848412);
   mainFit1035->SetParError(1,0.0171011);
