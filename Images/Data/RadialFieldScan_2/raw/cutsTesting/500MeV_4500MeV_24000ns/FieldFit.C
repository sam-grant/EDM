...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.80723);
   Graph_Graph01020->SetMaximum(55.11567);
   ...
   mainFit1021->SetChisquare(7.897776);
   ...
   mainFit1021->SetParameter(0,-1.130744);
   mainFit1021->SetParError(0,0.4137515);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8806849);
   mainFit1021->SetParError(1,0.01367494);
   ...
   pt_LaTex = pt->AddText("#minus1.13#pm0.414");
   pt_LaTex = pt->AddText("#minus1.28#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.283938,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.283938,-55.80723,1.283938,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.897776);
   ...
   mainFit1022->SetParameter(0,-1.130744);
   mainFit1022->SetParError(0,0.4137515);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8806849);
   mainFit1022->SetParError(1,0.01367494);
