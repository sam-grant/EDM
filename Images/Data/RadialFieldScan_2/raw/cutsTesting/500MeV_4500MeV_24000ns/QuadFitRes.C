...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008236864);
   Graph_Graph11015->SetMaximum(0.008243286);
   ...
   Graph_Graph21016->SetMinimum(-0.01526173);
   Graph_Graph21016->SetMaximum(0.01797386);
   ...
   Graph_Graph31017->SetMinimum(-0.03846734);
   Graph_Graph31017->SetMaximum(0.02758097);
   ...
   Graph_Graph41018->SetMinimum(-0.009955643);
   Graph_Graph41018->SetMaximum(0.01671165);
   ...
   Graph_Graph51019->SetMinimum(-0.006611046);
   Graph_Graph51019->SetMaximum(0.008836349);
