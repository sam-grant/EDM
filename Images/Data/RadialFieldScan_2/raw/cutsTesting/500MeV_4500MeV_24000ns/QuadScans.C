...
//=========  (Thu Apr 22 14:48:10 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4448387);
   ...
   quadLineFit1002->SetParameter(0,74.56384);
   quadLineFit1002->SetParError(0,0.06301062);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.81518);
   quadLineFit1002->SetParError(1,1.056922);
   ...
   quadLineFit1003->SetChisquare(0.4448387);
   ...
   quadLineFit1003->SetParameter(0,74.56384);
   quadLineFit1003->SetParError(0,0.06301062);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.81518);
   quadLineFit1003->SetParError(1,1.056922);
   ...
   Graph_30_ppm1003->SetMinimum(75.82774);
   Graph_30_ppm1003->SetMaximum(76.42016);
   ...
   quadLineFit1004->SetChisquare(0.5911056);
   ...
   quadLineFit1004->SetParameter(0,74.68184);
   quadLineFit1004->SetParError(0,0.05306989);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.45874);
   quadLineFit1004->SetParError(1,0.872282);
   ...
   quadLineFit1005->SetChisquare(0.5911056);
   ...
   quadLineFit1005->SetParameter(0,74.68184);
   quadLineFit1005->SetParError(0,0.05306989);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.45874);
   quadLineFit1005->SetParError(1,0.872282);
   ...
   Graph_10_ppm1005->SetMinimum(74.85783);
   Graph_10_ppm1005->SetMaximum(75.09205);
   ...
   quadLineFit1006->SetChisquare(2.844588);
   ...
   quadLineFit1006->SetParameter(0,74.47397);
   quadLineFit1006->SetParError(0,0.06216034);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.949874);
   quadLineFit1006->SetParError(1,1.008145);
   ...
   quadLineFit1007->SetChisquare(2.844588);
   ...
   quadLineFit1007->SetParameter(0,74.47397);
   quadLineFit1007->SetParError(0,0.06216034);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.949874);
   quadLineFit1007->SetParError(1,1.008145);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.65221);
   Graph_mI10_ppm1007->SetMaximum(73.95728);
   ...
   quadLineFit1008->SetChisquare(10.62828);
   ...
   quadLineFit1008->SetParameter(0,74.40555);
   quadLineFit1008->SetParError(0,0.05460377);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.961578);
   quadLineFit1008->SetParError(1,0.8887962);
   ...
   quadLineFit1009->SetChisquare(10.62828);
   ...
   quadLineFit1009->SetParameter(0,74.40555);
   quadLineFit1009->SetParError(0,0.05460377);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.961578);
   quadLineFit1009->SetParError(1,0.8887962);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29223);
   Graph_mI30_ppm1009->SetMaximum(72.98163);
   ...
   quadLineFit1010->SetChisquare(2.159913);
   ...
   quadLineFit1010->SetParameter(0,74.32168);
   quadLineFit1010->SetParError(0,0.05163396);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.29401);
   quadLineFit1010->SetParError(1,0.8936315);
   ...
   quadLineFit1011->SetChisquare(2.159913);
   ...
   quadLineFit1011->SetParameter(0,74.32168);
   quadLineFit1011->SetParError(0,0.05163396);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.29401);
   quadLineFit1011->SetParError(1,0.8936315);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.36899);
   Graph_mI50_ppm1011->SetMaximum(72.00543);
   ...
   quadLineFit1012->SetChisquare(0.6117708);
   ...
   quadLineFit1012->SetParameter(0,74.23663);
   quadLineFit1012->SetParError(0,0.1042151);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.69893);
   quadLineFit1012->SetParError(1,1.864722);
   ...
   quadLineFit1013->SetChisquare(0.6117708);
   ...
   quadLineFit1013->SetParameter(0,74.23663);
   quadLineFit1013->SetParError(0,0.1042151);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.69893);
   quadLineFit1013->SetParError(1,1.864722);
