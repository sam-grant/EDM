...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.67259,75,68.98104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.80723);
   Graph_Graph01027->SetMaximum(55.11567);
   ...
   mainFit1028->SetChisquare(0.860161);
   ...
   mainFit1028->SetParameter(0,-0.578531);
   mainFit1028->SetParError(0,0.4631634);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8987221);
   mainFit1028->SetParError(1,0.01527198);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.287");
   pt_LaTex = pt->AddText("0.899#pm0.0153");
   pt_LaTex = pt->AddText("#minus0.579#pm0.463");
   pt_LaTex = pt->AddText("#minus0.644#pm0.516");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6437262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6437262,-55.80723,0.6437262,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.860161);
   ...
   mainFit1029->SetParameter(0,-0.578531);
   mainFit1029->SetParError(0,0.4631634);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8987221);
   mainFit1029->SetParError(1,0.01527198);
