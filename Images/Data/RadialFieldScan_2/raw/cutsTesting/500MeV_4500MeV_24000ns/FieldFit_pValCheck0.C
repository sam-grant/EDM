...
//=========  (Thu Apr 22 14:48:11 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.28732,50,42.05469);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.65312);
   Graph_Graph01025->SetMaximum(31.42049);
   ...
   mainFit1026->SetChisquare(1.487473);
   ...
   mainFit1026->SetParameter(0,-1.551019);
   mainFit1026->SetParError(0,0.4458077);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8524068);
   mainFit1026->SetParError(1,0.01765641);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.496");
   pt_LaTex = pt->AddText("0.852#pm0.0177");
   pt_LaTex = pt->AddText("#minus1.55#pm0.446");
   pt_LaTex = pt->AddText("#minus1.82#pm0.529");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.819576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.819576,-53.65312,1.819576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.487473);
   ...
   mainFit1027->SetParameter(0,-1.551019);
   mainFit1027->SetParError(0,0.4458077);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8524068);
   mainFit1027->SetParError(1,0.01765641);
