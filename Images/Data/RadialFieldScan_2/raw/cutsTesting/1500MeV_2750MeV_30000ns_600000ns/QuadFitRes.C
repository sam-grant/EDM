...
//=========  (Tue Apr 27 00:56:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0207884);
   Graph_Graph11015->SetMaximum(0.03456859);
   ...
   Graph_Graph21016->SetMinimum(-0.004956359);
   Graph_Graph21016->SetMaximum(0.005837909);
   ...
   Graph_Graph31017->SetMinimum(-0.04459376);
   Graph_Graph31017->SetMaximum(0.03818892);
   ...
   Graph_Graph41018->SetMinimum(-0.01030946);
   Graph_Graph41018->SetMaximum(0.01632599);
   ...
   Graph_Graph51019->SetMinimum(-0.003175591);
   Graph_Graph51019->SetMaximum(0.004243655);
