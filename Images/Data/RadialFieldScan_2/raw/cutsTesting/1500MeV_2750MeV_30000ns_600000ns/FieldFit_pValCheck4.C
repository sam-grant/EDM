...
//=========  (Tue Apr 27 00:56:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-51.48262);
   Graph_Graph01033->SetMaximum(48.91205);
   ...
   mainFit1034->SetChisquare(2.155414);
   ...
   mainFit1034->SetParameter(0,-0.5732233);
   mainFit1034->SetParError(0,0.7912128);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7743635);
   mainFit1034->SetParError(1,0.02610667);
   ...
   pt_LaTex = pt->AddText("0.774#pm0.0261");
   pt_LaTex = pt->AddText("#minus0.573#pm0.791");
   pt_LaTex = pt->AddText("#minus0.74#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.740251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.740251,-51.48262,0.740251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.155414);
   ...
   mainFit1035->SetParameter(0,-0.5732233);
   mainFit1035->SetParError(0,0.7912128);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7743635);
   mainFit1035->SetParError(1,0.02610667);
