...
//=========  (Tue Apr 27 00:56:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.48262);
   Graph_Graph01029->SetMaximum(48.91205);
   ...
   mainFit1030->SetChisquare(2.117547);
   ...
   mainFit1030->SetParameter(0,-0.4450756);
   mainFit1030->SetParError(0,0.6863711);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7630376);
   mainFit1030->SetParError(1,0.02093996);
   ...
   pt_LaTex = pt->AddText("0.763#pm0.0209");
   pt_LaTex = pt->AddText("#minus0.445#pm0.686");
   pt_LaTex = pt->AddText("#minus0.583#pm0.898");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5832945,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5832945,-51.48262,0.5832945,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.117547);
   ...
   mainFit1031->SetParameter(0,-0.4450756);
   mainFit1031->SetParError(0,0.6863711);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7630376);
   mainFit1031->SetParError(1,0.02093996);
