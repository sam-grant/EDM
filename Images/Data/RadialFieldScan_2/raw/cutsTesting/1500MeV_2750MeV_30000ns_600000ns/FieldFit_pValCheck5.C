...
//=========  (Tue Apr 27 00:56:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.0305,70,56.66109);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.36134);
   Graph_Graph01035->SetMaximum(46.99193);
   ...
   mainFit1036->SetChisquare(2.074988);
   ...
   mainFit1036->SetParameter(0,-0.1193295);
   mainFit1036->SetParError(0,0.6623213);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.757382);
   mainFit1036->SetParError(1,0.0229228);
   ...
   pt_LaTex = pt->AddText("0.757#pm0.0229");
   pt_LaTex = pt->AddText("#minus0.119#pm0.662");
   pt_LaTex = pt->AddText("#minus0.158#pm0.873");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1575552,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1575552,-30.36134,0.1575552,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.074988);
   ...
   mainFit1037->SetParameter(0,-0.1193295);
   mainFit1037->SetParError(0,0.6623213);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.757382);
   mainFit1037->SetParError(1,0.0229228);
