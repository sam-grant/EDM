...
//=========  (Tue Apr 27 00:56:03 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2042409);
   ...
   quadLineFit1002->SetParameter(0,74.85952);
   quadLineFit1002->SetParError(0,0.09628504);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.93078);
   quadLineFit1002->SetParError(1,1.615047);
   ...
   quadLineFit1003->SetChisquare(0.2042409);
   ...
   quadLineFit1003->SetParameter(0,74.85952);
   quadLineFit1003->SetParError(0,0.09628504);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.93078);
   quadLineFit1003->SetParError(1,1.615047);
   ...
   Graph_30_ppm1003->SetMinimum(75.89899);
   Graph_30_ppm1003->SetMaximum(76.44436);
   ...
   quadLineFit1004->SetChisquare(2.20471);
   ...
   quadLineFit1004->SetParameter(0,74.86904);
   quadLineFit1004->SetParError(0,0.0809633);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.20771);
   quadLineFit1004->SetParError(1,1.330708);
   ...
   quadLineFit1005->SetChisquare(2.20471);
   ...
   quadLineFit1005->SetParameter(0,74.86904);
   quadLineFit1005->SetParError(0,0.0809633);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.20771);
   quadLineFit1005->SetParError(1,1.330708);
   ...
   Graph_10_ppm1005->SetMinimum(74.97215);
   Graph_10_ppm1005->SetMaximum(75.22927);
   ...
   quadLineFit1006->SetChisquare(0.128918);
   ...
   quadLineFit1006->SetParameter(0,74.58379);
   quadLineFit1006->SetParError(0,0.09489498);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.336358);
   quadLineFit1006->SetParError(1,1.538993);
   ...
   quadLineFit1007->SetChisquare(0.128918);
   ...
   quadLineFit1007->SetParameter(0,74.58379);
   quadLineFit1007->SetParError(0,0.09489498);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.336358);
   quadLineFit1007->SetParError(1,1.538993);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.9062);
   Graph_mI10_ppm1007->SetMaximum(74.18648);
   ...
   quadLineFit1008->SetChisquare(6.728875);
   ...
   quadLineFit1008->SetParameter(0,74.53186);
   quadLineFit1008->SetParError(0,0.08328019);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.048456);
   quadLineFit1008->SetParError(1,1.355493);
   ...
   quadLineFit1009->SetChisquare(6.728875);
   ...
   quadLineFit1009->SetParameter(0,74.53186);
   quadLineFit1009->SetParError(0,0.08328019);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.048456);
   quadLineFit1009->SetParError(1,1.355493);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.67876);
   Graph_mI30_ppm1009->SetMaximum(73.27807);
   ...
   quadLineFit1010->SetChisquare(0.465734);
   ...
   quadLineFit1010->SetParameter(0,74.37227);
   quadLineFit1010->SetParError(0,0.07883104);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.55091);
   quadLineFit1010->SetParError(1,1.364327);
   ...
   quadLineFit1011->SetChisquare(0.465734);
   ...
   quadLineFit1011->SetParameter(0,74.37227);
   quadLineFit1011->SetParError(0,0.07883104);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.55091);
   quadLineFit1011->SetParError(1,1.364327);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.80367);
   Graph_mI50_ppm1011->SetMaximum(72.39942);
   ...
   quadLineFit1012->SetChisquare(0.06060543);
   ...
   quadLineFit1012->SetParameter(0,74.3971);
   quadLineFit1012->SetParError(0,0.1590802);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.27002);
   quadLineFit1012->SetParError(1,2.846372);
   ...
   quadLineFit1013->SetChisquare(0.06060543);
   ...
   quadLineFit1013->SetParameter(0,74.3971);
   quadLineFit1013->SetParError(0,0.1590802);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.27002);
   quadLineFit1013->SetParError(1,2.846372);
