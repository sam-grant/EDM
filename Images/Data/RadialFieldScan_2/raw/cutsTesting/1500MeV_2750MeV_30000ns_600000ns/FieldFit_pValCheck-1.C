...
//=========  (Tue Apr 27 00:56:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.48262);
   Graph_Graph01023->SetMaximum(48.91205);
   ...
   mainFit1024->SetChisquare(2.582537);
   ...
   mainFit1024->SetParameter(0,-0.2616637);
   mainFit1024->SetParError(0,0.6314698);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7641215);
   mainFit1024->SetParError(1,0.02087977);
   ...
   mainFit1025->SetChisquare(2.582537);
   ...
   mainFit1025->SetParameter(0,-0.2616637);
   mainFit1025->SetParError(0,0.6314698);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7641215);
   mainFit1025->SetParError(1,0.02087977);
