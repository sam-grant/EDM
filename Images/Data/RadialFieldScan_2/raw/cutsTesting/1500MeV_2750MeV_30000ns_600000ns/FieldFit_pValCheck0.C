...
//=========  (Tue Apr 27 00:56:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.5301,50,38.95212);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.68187);
   Graph_Graph01025->SetMaximum(29.10389);
   ...
   mainFit1026->SetChisquare(1.852688);
   ...
   mainFit1026->SetParameter(0,-0.4778178);
   mainFit1026->SetParError(0,0.68026);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7495635);
   mainFit1026->SetParError(1,0.02694546);
   ...
   pt_LaTex = pt->AddText(" 0.75#pm0.0269");
   pt_LaTex = pt->AddText("#minus0.478#pm 0.68");
   pt_LaTex = pt->AddText("#minus0.637#pm0.911");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.6374614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6374614,-49.68187,0.6374614,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.852688);
   ...
   mainFit1027->SetParameter(0,-0.4778178);
   mainFit1027->SetParError(0,0.68026);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7495635);
   mainFit1027->SetParError(1,0.02694546);
