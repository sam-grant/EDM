...
//=========  (Tue Apr 27 00:56:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.48262);
   Graph_Graph01020->SetMaximum(48.91205);
   ...
   mainFit1021->SetChisquare(2.582537);
   ...
   mainFit1021->SetParameter(0,-0.2616637);
   mainFit1021->SetParError(0,0.6314698);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7641215);
   mainFit1021->SetParError(1,0.02087977);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.646");
   pt_LaTex = pt->AddText("0.764#pm0.0209");
   pt_LaTex = pt->AddText("#minus0.262#pm0.631");
   pt_LaTex = pt->AddText("#minus0.342#pm0.825");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3424373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3424373,-51.48262,0.3424373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.582537);
   ...
   mainFit1022->SetParameter(0,-0.2616637);
   mainFit1022->SetParError(0,0.6314698);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7641215);
   mainFit1022->SetParError(1,0.02087977);
