...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.33122);
   Graph_Graph01033->SetMaximum(55.70099);
   ...
   mainFit1034->SetChisquare(3.243919);
   ...
   mainFit1034->SetParameter(0,-2.105885);
   mainFit1034->SetParError(0,0.4768894);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9263503);
   mainFit1034->SetParError(1,0.01572948);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0157");
   pt_LaTex = pt->AddText("#minus2.11#pm0.477");
   pt_LaTex = pt->AddText("#minus2.27#pm0.498");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.273314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.273314,-59.33122,2.273314,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.243919);
   ...
   mainFit1035->SetParameter(0,-2.105885);
   mainFit1035->SetParError(0,0.4768894);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9263503);
   mainFit1035->SetParError(1,0.01572948);
