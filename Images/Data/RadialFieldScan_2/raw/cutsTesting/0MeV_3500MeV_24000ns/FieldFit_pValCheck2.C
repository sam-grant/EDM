...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.33122);
   Graph_Graph01029->SetMaximum(55.70099);
   ...
   mainFit1030->SetChisquare(3.43893);
   ...
   mainFit1030->SetParameter(0,-1.992014);
   mainFit1030->SetParError(0,0.4134638);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9191422);
   mainFit1030->SetParError(1,0.01261096);
   ...
   pt_LaTex = pt->AddText("0.919#pm0.0126");
   pt_LaTex = pt->AddText("#minus1.99#pm0.413");
   pt_LaTex = pt->AddText("#minus2.17#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.167253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.167253,-59.33122,2.167253,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.43893);
   ...
   mainFit1031->SetParameter(0,-1.992014);
   mainFit1031->SetParError(0,0.4134638);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9191422);
   mainFit1031->SetParError(1,0.01261096);
