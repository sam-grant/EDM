...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.33122);
   Graph_Graph01031->SetMaximum(55.70099);
   ...
   mainFit1032->SetChisquare(3.488471);
   ...
   mainFit1032->SetParameter(0,-1.792905);
   mainFit1032->SetParError(0,0.438074);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9179789);
   mainFit1032->SetParError(1,0.01301357);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.013");
   pt_LaTex = pt->AddText("#minus1.79#pm0.438");
   pt_LaTex = pt->AddText("#minus1.95#pm0.471");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.9531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.9531,-59.33122,1.9531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.488471);
   ...
   mainFit1033->SetParameter(0,-1.792905);
   mainFit1033->SetParError(0,0.438074);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9179789);
   mainFit1033->SetParError(1,0.01301357);
