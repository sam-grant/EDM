...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.53095,50,44.18355);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.2595);
   Graph_Graph01025->SetMaximum(32.9121);
   ...
   mainFit1026->SetChisquare(1.413139);
   ...
   mainFit1026->SetParameter(0,-2.135793);
   mainFit1026->SetParError(0,0.4099253);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.904003);
   mainFit1026->SetParError(1,0.01623175);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.471");
   pt_LaTex = pt->AddText("0.904#pm0.0162");
   pt_LaTex = pt->AddText("#minus2.14#pm 0.41");
   pt_LaTex = pt->AddText("#minus2.36#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.362595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.362595,-57.2595,2.362595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.413139);
   ...
   mainFit1027->SetParameter(0,-2.135793);
   mainFit1027->SetParError(0,0.4099253);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.904003);
   mainFit1027->SetParError(1,0.01623175);
