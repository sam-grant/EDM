...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.33122);
   Graph_Graph01023->SetMaximum(55.70099);
   ...
   mainFit1024->SetChisquare(3.743451);
   ...
   mainFit1024->SetParameter(0,-1.902591);
   mainFit1024->SetParError(0,0.3804022);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.919665);
   mainFit1024->SetParError(1,0.01257445);
   ...
   pt_LaTex = pt->AddText(" 0.92#pm0.0126");
   pt_LaTex = pt->AddText(" #minus1.9#pm 0.38");
   pt_LaTex = pt->AddText("#minus2.07#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.068787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.068787,-59.33122,2.068787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.743451);
   ...
   mainFit1025->SetParameter(0,-1.902591);
   mainFit1025->SetParError(0,0.3804022);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.919665);
   mainFit1025->SetParError(1,0.01257445);
