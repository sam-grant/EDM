...
//=========  (Fri Apr 23 11:54:48 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-48.90518,70,65.119);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.50276);
   Graph_Graph01035->SetMaximum(53.71658);
   ...
   mainFit1036->SetChisquare(3.734437);
   ...
   mainFit1036->SetParameter(0,-1.891198);
   mainFit1036->SetParError(0,0.3989527);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.919131);
   mainFit1036->SetParError(1,0.01380346);
   ...
   pt_LaTex = pt->AddText("#minus1.89#pm0.399");
   pt_LaTex = pt->AddText("#minus2.06#pm0.427");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.057593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.057593,-37.50276,2.057593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.734437);
   ...
   mainFit1037->SetParameter(0,-1.891198);
   mainFit1037->SetParError(0,0.3989527);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.919131);
   mainFit1037->SetParError(1,0.01380346);
