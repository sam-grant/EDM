...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.33122);
   Graph_Graph01020->SetMaximum(55.70099);
   ...
   mainFit1021->SetChisquare(3.743451);
   ...
   mainFit1021->SetParameter(0,-1.902591);
   mainFit1021->SetParError(0,0.3804022);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.919665);
   mainFit1021->SetParError(1,0.01257445);
   ...
   mainFit1022->SetChisquare(3.743451);
   ...
   mainFit1022->SetParameter(0,-1.902591);
   mainFit1022->SetParError(0,0.3804022);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.919665);
   mainFit1022->SetParError(1,0.01257445);
