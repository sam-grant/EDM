...
//=========  (Fri Apr 23 11:54:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.71024,75,70.08002);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.33122);
   Graph_Graph01027->SetMaximum(55.70099);
   ...
   mainFit1028->SetChisquare(0.7832507);
   ...
   mainFit1028->SetParameter(0,-1.572985);
   mainFit1028->SetParError(0,0.4259245);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9304415);
   mainFit1028->SetParError(1,0.01404658);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.261");
   pt_LaTex = pt->AddText(" 0.93#pm0.014");
   pt_LaTex = pt->AddText("#minus1.57#pm0.426");
   pt_LaTex = pt->AddText("#minus1.69#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.690579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.690579,-59.33122,1.690579,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7832507);
   ...
   mainFit1029->SetParameter(0,-1.572985);
   mainFit1029->SetParError(0,0.4259245);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9304415);
   mainFit1029->SetParError(1,0.01404658);
