...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.63171);
   Graph_Graph01031->SetMaximum(55.66584);
   ...
   mainFit1032->SetChisquare(3.117731);
   ...
   mainFit1032->SetParameter(0,-1.883909);
   mainFit1032->SetParError(0,0.4223129);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9253354);
   mainFit1032->SetParError(1,0.01254567);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0125");
   pt_LaTex = pt->AddText("#minus1.88#pm0.422");
   pt_LaTex = pt->AddText("#minus2.04#pm 0.45");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.03592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.03592,-60.63171,2.03592,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.117731);
   ...
   mainFit1033->SetParameter(0,-1.883909);
   mainFit1033->SetParError(0,0.4223129);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9253354);
   mainFit1033->SetParError(1,0.01254567);
