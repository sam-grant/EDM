...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.1689,75,70.20304);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-60.63171);
   Graph_Graph01033->SetMaximum(55.66584);
   ...
   mainFit1034->SetChisquare(2.590519);
   ...
   mainFit1034->SetParameter(0,-2.155636);
   mainFit1034->SetParError(0,0.4597241);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9332731);
   mainFit1034->SetParError(1,0.01516366);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0152");
   pt_LaTex = pt->AddText("#minus2.16#pm 0.46");
   pt_LaTex = pt->AddText("#minus2.31#pm0.476");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.309759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.309759,-60.63171,2.309759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.590519);
   ...
   mainFit1035->SetParameter(0,-2.155636);
   mainFit1035->SetParError(0,0.4597241);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9332731);
   mainFit1035->SetParError(1,0.01516366);
