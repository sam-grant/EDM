...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.63171);
   Graph_Graph01029->SetMaximum(55.66584);
   ...
   mainFit1030->SetChisquare(2.609101);
   ...
   mainFit1030->SetParameter(0,-2.059932);
   mainFit1030->SetParError(0,0.398605);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9255059);
   mainFit1030->SetParError(1,0.01215781);
   ...
   pt_LaTex = pt->AddText("#minus2.23#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.225737,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.225737,-60.63171,2.225737,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.609101);
   ...
   mainFit1031->SetParameter(0,-2.059932);
   mainFit1031->SetParError(0,0.398605);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9255059);
   mainFit1031->SetParError(1,0.01215781);
