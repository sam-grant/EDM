...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.63171);
   Graph_Graph01023->SetMaximum(55.66584);
   ...
   mainFit1024->SetChisquare(3.191363);
   ...
   mainFit1024->SetParameter(0,-1.940718);
   mainFit1024->SetParError(0,0.3667233);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9262058);
   mainFit1024->SetParError(1,0.01212256);
   ...
   mainFit1025->SetChisquare(3.191363);
   ...
   mainFit1025->SetParameter(0,-1.940718);
   mainFit1025->SetParError(0,0.3667233);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9262058);
   mainFit1025->SetParError(1,0.01212256);
