...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.09651,70,64.98856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.688);
   Graph_Graph01035->SetMaximum(53.58005);
   ...
   mainFit1036->SetChisquare(2.693293);
   ...
   mainFit1036->SetParameter(0,-1.858927);
   mainFit1036->SetParError(0,0.384609);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9223375);
   mainFit1036->SetParError(1,0.0133078);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.86#pm0.385");
   pt_LaTex = pt->AddText("#minus2.02#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.015452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.015452,-37.688,2.015452,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.693293);
   ...
   mainFit1037->SetParameter(0,-1.858927);
   mainFit1037->SetParError(0,0.384609);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9223375);
   mainFit1037->SetParError(1,0.0133078);
