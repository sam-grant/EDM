...
//=========  (Wed Apr 21 15:43:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.086111);
   ...
   quadLineFit1002->SetParameter(0,74.48353);
   quadLineFit1002->SetParError(0,0.05591873);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.03649);
   quadLineFit1002->SetParError(1,0.9378966);
   ...
   quadLineFit1003->SetChisquare(1.086111);
   ...
   quadLineFit1003->SetParameter(0,74.48353);
   quadLineFit1003->SetParError(0,0.05591873);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.03649);
   quadLineFit1003->SetParError(1,0.9378966);
   ...
   Graph_30_ppm1003->SetMinimum(75.7333);
   Graph_30_ppm1003->SetMaximum(76.36524);
   ...
   quadLineFit1004->SetChisquare(0.2262911);
   ...
   quadLineFit1004->SetParameter(0,74.52361);
   quadLineFit1004->SetParError(0,0.04706859);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.91396);
   quadLineFit1004->SetParError(1,0.7734933);
   ...
   quadLineFit1005->SetChisquare(0.2262911);
   ...
   quadLineFit1005->SetParameter(0,74.52361);
   quadLineFit1005->SetParError(0,0.04706859);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.91396);
   quadLineFit1005->SetParError(1,0.7734933);
   ...
   Graph_10_ppm1005->SetMinimum(74.75039);
   Graph_10_ppm1005->SetMaximum(74.97645);
   ...
   quadLineFit1006->SetChisquare(0.6864216);
   ...
   quadLineFit1006->SetParameter(0,74.36988);
   quadLineFit1006->SetParError(0,0.05513568);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.943401);
   quadLineFit1006->SetParError(1,0.8940724);
   ...
   quadLineFit1007->SetChisquare(0.6864216);
   ...
   quadLineFit1007->SetParameter(0,74.36988);
   quadLineFit1007->SetParError(0,0.05513568);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.943401);
   quadLineFit1007->SetParError(1,0.8940724);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.50784);
   Graph_mI10_ppm1007->SetMaximum(73.83099);
   ...
   quadLineFit1008->SetChisquare(5.44883);
   ...
   quadLineFit1008->SetParameter(0,74.36344);
   quadLineFit1008->SetParError(0,0.04841413);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.38637);
   quadLineFit1008->SetParError(1,0.7879525);
   ...
   quadLineFit1009->SetChisquare(5.44883);
   ...
   quadLineFit1009->SetParameter(0,74.36344);
   quadLineFit1009->SetParError(0,0.04841413);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.38637);
   quadLineFit1009->SetParError(1,0.7879525);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.12882);
   Graph_mI30_ppm1009->SetMaximum(72.86081);
   ...
   quadLineFit1010->SetChisquare(0.4698406);
   ...
   quadLineFit1010->SetParameter(0,74.2947);
   quadLineFit1010->SetParError(0,0.04572047);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.29108);
   quadLineFit1010->SetParError(1,0.7912512);
   ...
   quadLineFit1011->SetChisquare(0.4698406);
   ...
   quadLineFit1011->SetParameter(0,74.2947);
   quadLineFit1011->SetParError(0,0.04572047);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.29108);
   quadLineFit1011->SetParError(1,0.7912512);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19762);
   Graph_mI50_ppm1011->SetMaximum(71.8922);
   ...
   quadLineFit1012->SetChisquare(0.1101348);
   ...
   quadLineFit1012->SetParameter(0,74.35208);
   quadLineFit1012->SetParError(0,0.09234924);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.28785);
   quadLineFit1012->SetParError(1,1.652399);
   ...
   quadLineFit1013->SetChisquare(0.1101348);
   ...
   quadLineFit1013->SetParameter(0,74.35208);
   quadLineFit1013->SetParError(0,0.09234924);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.28785);
   quadLineFit1013->SetParError(1,1.652399);
