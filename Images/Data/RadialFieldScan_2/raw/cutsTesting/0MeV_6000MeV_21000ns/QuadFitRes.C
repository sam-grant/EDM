...
//=========  (Wed Apr 21 15:43:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003205308);
   Graph_Graph11015->SetMaximum(0.00741625);
   ...
   Graph_Graph21016->SetMinimum(-0.006651125);
   Graph_Graph21016->SetMaximum(0.007812119);
   ...
   Graph_Graph31017->SetMinimum(-0.02340273);
   Graph_Graph31017->SetMaximum(0.01979608);
   ...
   Graph_Graph41018->SetMinimum(-0.00766925);
   Graph_Graph41018->SetMaximum(0.006293976);
   ...
   Graph_Graph51019->SetMinimum(-0.00248539);
   Graph_Graph51019->SetMaximum(0.003320565);
