...
//=========  (Wed Apr 21 15:43:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.63171);
   Graph_Graph01020->SetMaximum(55.66584);
   ...
   mainFit1021->SetChisquare(3.191363);
   ...
   mainFit1021->SetParameter(0,-1.940718);
   mainFit1021->SetParError(0,0.3667233);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9262058);
   mainFit1021->SetParError(1,0.01212256);
   ...
   pt_LaTex = pt->AddText("0.926#pm0.0121");
   pt_LaTex = pt->AddText("#minus1.94#pm0.367");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.392");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.095343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.095343,-60.63171,2.095343,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.191363);
   ...
   mainFit1022->SetParameter(0,-1.940718);
   mainFit1022->SetParError(0,0.3667233);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9262058);
   mainFit1022->SetParError(1,0.01212256);
