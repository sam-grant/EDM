...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.57932,75,70.52593);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-56.46879);
   Graph_Graph01027->SetMaximum(56.41541);
   ...
   mainFit1028->SetChisquare(1.316946);
   ...
   mainFit1028->SetParameter(0,-0.2021802);
   mainFit1028->SetParError(0,0.4950121);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9131699);
   mainFit1028->SetParError(1,0.01642076);
   ...
   pt_LaTex = pt->AddText("0.913#pm0.0164");
   pt_LaTex = pt->AddText("#minus0.202#pm0.495");
   pt_LaTex = pt->AddText("#minus0.221#pm0.542");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2214048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2214048,-56.46879,0.2214048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.316946);
   ...
   mainFit1029->SetParameter(0,-0.2021802);
   mainFit1029->SetParError(0,0.4950121);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9131699);
   mainFit1029->SetParError(1,0.01642076);
