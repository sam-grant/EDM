...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.46879);
   Graph_Graph01020->SetMaximum(56.41541);
   ...
   mainFit1021->SetChisquare(7.041719);
   ...
   mainFit1021->SetParameter(0,-0.7406423);
   mainFit1021->SetParError(0,0.4408968);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8953811);
   mainFit1021->SetParError(1,0.01464116);
   ...
   pt_LaTex = pt->AddText("0.895#pm0.0146");
   pt_LaTex = pt->AddText("#minus0.741#pm0.441");
   pt_LaTex = pt->AddText("#minus0.827#pm0.491");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.827181,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.827181,-56.46879,0.827181,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.041719);
   ...
   mainFit1022->SetParameter(0,-0.7406423);
   mainFit1022->SetParError(0,0.4408968);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8953811);
   mainFit1022->SetParError(1,0.01464116);
