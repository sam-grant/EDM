...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01373146);
   Graph_Graph11015->SetMaximum(0.01337078);
   ...
   Graph_Graph21016->SetMinimum(-0.01257117);
   Graph_Graph21016->SetMaximum(0.01481183);
   ...
   Graph_Graph31017->SetMinimum(-0.03507215);
   Graph_Graph31017->SetMaximum(0.02525992);
   ...
   Graph_Graph41018->SetMinimum(-0.01142163);
   Graph_Graph41018->SetMaximum(0.01814553);
   ...
   Graph_Graph51019->SetMinimum(-0.006646365);
   Graph_Graph51019->SetMaximum(0.008885379);
