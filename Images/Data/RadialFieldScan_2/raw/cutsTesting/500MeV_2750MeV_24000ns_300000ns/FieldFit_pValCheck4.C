...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.46879);
   Graph_Graph01033->SetMaximum(56.41541);
   ...
   mainFit1034->SetChisquare(6.604157);
   ...
   mainFit1034->SetParameter(0,-0.9601432);
   mainFit1034->SetParError(0,0.5518164);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9026501);
   mainFit1034->SetParError(1,0.01830626);
   ...
   pt_LaTex = pt->AddText("0.903#pm0.0183");
   pt_LaTex = pt->AddText("#minus0.96#pm0.552");
   pt_LaTex = pt->AddText("#minus1.06#pm0.602");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.063694,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.063694,-56.46879,1.063694,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.604157);
   ...
   mainFit1035->SetParameter(0,-0.9601432);
   mainFit1035->SetParError(0,0.5518164);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9026501);
   mainFit1035->SetParError(1,0.01830626);
