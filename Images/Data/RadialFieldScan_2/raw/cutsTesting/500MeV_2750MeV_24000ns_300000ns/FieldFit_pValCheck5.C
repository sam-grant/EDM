...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.88431,70,65.78693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.61718);
   Graph_Graph01035->SetMaximum(54.5198);
   ...
   mainFit1036->SetChisquare(6.981857);
   ...
   mainFit1036->SetParameter(0,-0.7745712);
   mainFit1036->SetParError(0,0.4621907);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8970085);
   mainFit1036->SetParError(1,0.01608118);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.33");
   pt_LaTex = pt->AddText("0.897#pm0.0161");
   pt_LaTex = pt->AddText("#minus0.775#pm0.462");
   pt_LaTex = pt->AddText("#minus0.864#pm0.511");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8635048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8635048,-35.61718,0.8635048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.981857);
   ...
   mainFit1037->SetParameter(0,-0.7745712);
   mainFit1037->SetParError(0,0.4621907);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8970085);
   mainFit1037->SetParError(1,0.01608118);
