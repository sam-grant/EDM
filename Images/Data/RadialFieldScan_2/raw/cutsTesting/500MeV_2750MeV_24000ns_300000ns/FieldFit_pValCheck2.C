...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.46879);
   Graph_Graph01029->SetMaximum(56.41541);
   ...
   mainFit1030->SetChisquare(6.573893);
   ...
   mainFit1030->SetParameter(0,-0.8697152);
   mainFit1030->SetParError(0,0.4795855);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8945781);
   mainFit1030->SetParError(1,0.01468808);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.19");
   pt_LaTex = pt->AddText("0.895#pm0.0147");
   pt_LaTex = pt->AddText("#minus0.87#pm 0.48");
   pt_LaTex = pt->AddText("#minus0.972#pm0.535");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9722071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9722071,-56.46879,0.9722071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.573893);
   ...
   mainFit1031->SetParameter(0,-0.8697152);
   mainFit1031->SetParError(0,0.4795855);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8945781);
   mainFit1031->SetParError(1,0.01468808);
