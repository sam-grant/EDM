...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.46879);
   Graph_Graph01031->SetMaximum(56.41541);
   ...
   mainFit1032->SetChisquare(6.670659);
   ...
   mainFit1032->SetParameter(0,-0.5872238);
   mainFit1032->SetParError(0,0.5077622);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8930232);
   mainFit1032->SetParError(1,0.01514421);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.22");
   pt_LaTex = pt->AddText("0.893#pm0.0151");
   pt_LaTex = pt->AddText("#minus0.587#pm0.508");
   pt_LaTex = pt->AddText("#minus0.658#pm0.566");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6575683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6575683,-56.46879,0.6575683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.670659);
   ...
   mainFit1033->SetParameter(0,-0.5872238);
   mainFit1033->SetParError(0,0.5077622);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8930232);
   mainFit1033->SetParError(1,0.01514421);
