...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.46879);
   Graph_Graph01023->SetMaximum(56.41541);
   ...
   mainFit1024->SetChisquare(7.041719);
   ...
   mainFit1024->SetParameter(0,-0.7406423);
   mainFit1024->SetParError(0,0.4408968);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8953811);
   mainFit1024->SetParError(1,0.01464116);
   ...
   mainFit1025->SetChisquare(7.041719);
   ...
   mainFit1025->SetParameter(0,-0.7406423);
   mainFit1025->SetParError(0,0.4408968);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8953811);
   mainFit1025->SetParError(1,0.01464116);
