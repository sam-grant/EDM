...
//=========  (Mon Apr 26 22:29:42 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.15232,50,43.39093);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.29799);
   Graph_Graph01025->SetMaximum(32.53661);
   ...
   mainFit1026->SetChisquare(2.109214);
   ...
   mainFit1026->SetParameter(0,-1.129293);
   mainFit1026->SetParError(0,0.4743556);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8692405);
   mainFit1026->SetParError(1,0.01878564);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.703");
   pt_LaTex = pt->AddText("0.869#pm0.0188");
   pt_LaTex = pt->AddText("#minus1.13#pm0.474");
   pt_LaTex = pt->AddText(" #minus1.3#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.299173,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.299173,-54.29799,1.299173,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.109214);
   ...
   mainFit1027->SetParameter(0,-1.129293);
   mainFit1027->SetParError(0,0.4743556);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8692405);
   mainFit1027->SetParError(1,0.01878564);
