...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-52.31885,75,59.90048);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-41.09692);
   Graph_Graph01023->SetMaximum(48.67855);
   ...
   mainFit1024->SetChisquare(3.953202);
   ...
   mainFit1024->SetParameter(0,0.7115654);
   mainFit1024->SetParError(0,0.9124616);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7411012);
   mainFit1024->SetParError(1,0.03016199);
   ...
   pt_LaTex = pt->AddText("0.741#pm0.0302");
   pt_LaTex = pt->AddText("0.712#pm0.912");
   pt_LaTex = pt->AddText(" 0.96#pm 1.24");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9601461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9601461,-41.09692,-0.9601461,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.953202);
   ...
   mainFit1025->SetParameter(0,0.7115654);
   mainFit1025->SetParError(0,0.9124616);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7411012);
   mainFit1025->SetParError(1,0.03016199);
