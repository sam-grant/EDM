...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-41.09692);
   Graph_Graph01020->SetMaximum(48.67855);
   ...
   mainFit1021->SetChisquare(3.953202);
   ...
   mainFit1021->SetParameter(0,0.7115654);
   mainFit1021->SetParError(0,0.9124616);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7411012);
   mainFit1021->SetParError(1,0.03016199);
   ...
   mainFit1022->SetChisquare(3.953202);
   ...
   mainFit1022->SetParameter(0,0.7115654);
   mainFit1022->SetParError(0,0.9124616);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7411012);
   mainFit1022->SetParError(1,0.03016199);
