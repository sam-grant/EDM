...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-41.09692);
   Graph_Graph01031->SetMaximum(48.67855);
   ...
   mainFit1032->SetChisquare(3.059451);
   ...
   mainFit1032->SetParameter(0,1.20485);
   mainFit1032->SetParError(0,1.051115);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7334811);
   mainFit1032->SetParError(1,0.03122042);
   ...
   pt_LaTex = pt->AddText("0.733#pm0.0312");
   pt_LaTex = pt->AddText("  1.2#pm 1.05");
   pt_LaTex = pt->AddText(" 1.64#pm 1.45");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.642646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.642646,-41.09692,-1.642646,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.059451);
   ...
   mainFit1033->SetParameter(0,1.20485);
   mainFit1033->SetParError(0,1.051115);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7334811);
   mainFit1033->SetParError(1,0.03122042);
