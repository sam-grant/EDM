...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0158468);
   Graph_Graph11015->SetMaximum(0.01751396);
   ...
   Graph_Graph21016->SetMinimum(-0.00601666);
   Graph_Graph21016->SetMaximum(0.005115669);
   ...
   Graph_Graph31017->SetMinimum(-0.04036696);
   Graph_Graph31017->SetMaximum(0.03530966);
   ...
   Graph_Graph41018->SetMinimum(-0.01640295);
   Graph_Graph41018->SetMaximum(0.02277133);
   ...
   Graph_Graph51019->SetMinimum(-0.0147073);
   Graph_Graph51019->SetMaximum(0.01962758);
