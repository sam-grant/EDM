...
//=========  (Thu Apr 22 00:29:16 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8206528);
   ...
   quadLineFit1002->SetParameter(0,74.93931);
   quadLineFit1002->SetParError(0,0.1390554);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.86493);
   quadLineFit1002->SetParError(1,2.332325);
   ...
   quadLineFit1003->SetChisquare(0.8206528);
   ...
   quadLineFit1003->SetParameter(0,74.93931);
   quadLineFit1003->SetParError(0,0.1390554);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.86493);
   quadLineFit1003->SetParError(1,2.332325);
   ...
   Graph_30_ppm1003->SetMinimum(75.97464);
   Graph_30_ppm1003->SetMaximum(76.5808);
   ...
   quadLineFit1004->SetChisquare(0.4938573);
   ...
   quadLineFit1004->SetParameter(0,74.88398);
   quadLineFit1004->SetParError(0,0.117042);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.66859);
   quadLineFit1004->SetParError(1,1.923552);
   ...
   quadLineFit1005->SetChisquare(0.4938573);
   ...
   quadLineFit1005->SetParameter(0,74.88398);
   quadLineFit1005->SetParError(0,0.117042);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.66859);
   quadLineFit1005->SetParError(1,1.923552);
   ...
   Graph_10_ppm1005->SetMinimum(75.06594);
   Graph_10_ppm1005->SetMaximum(75.351);
   ...
   quadLineFit1006->SetChisquare(0.06565261);
   ...
   quadLineFit1006->SetParameter(0,74.67641);
   quadLineFit1006->SetParError(0,0.1371387);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.704089);
   quadLineFit1006->SetParError(1,2.224004);
   ...
   quadLineFit1007->SetChisquare(0.06565261);
   ...
   quadLineFit1007->SetParameter(0,74.67641);
   quadLineFit1007->SetParError(0,0.1371387);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.704089);
   quadLineFit1007->SetParError(1,2.224004);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.05543);
   Graph_mI10_ppm1007->SetMaximum(74.36224);
   ...
   quadLineFit1008->SetChisquare(2.221477);
   ...
   quadLineFit1008->SetParameter(0,74.69941);
   quadLineFit1008->SetParError(0,0.1203942);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.288616);
   quadLineFit1008->SetParError(1,1.959153);
   ...
   quadLineFit1009->SetChisquare(2.221477);
   ...
   quadLineFit1009->SetParameter(0,74.69941);
   quadLineFit1009->SetParError(0,0.1203942);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.288616);
   quadLineFit1009->SetParError(1,1.959153);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.83799);
   Graph_mI30_ppm1009->SetMaximum(73.45726);
   ...
   quadLineFit1010->SetChisquare(0.5850448);
   ...
   quadLineFit1010->SetParameter(0,74.5411);
   quadLineFit1010->SetParError(0,0.1139136);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.43779);
   quadLineFit1010->SetParError(1,1.97138);
   ...
   quadLineFit1011->SetChisquare(0.5850448);
   ...
   quadLineFit1011->SetParameter(0,74.5411);
   quadLineFit1011->SetParError(0,0.1139136);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.43779);
   quadLineFit1011->SetParError(1,1.97138);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.07764);
   Graph_mI50_ppm1011->SetMaximum(72.55142);
   ...
   quadLineFit1012->SetChisquare(0.6203593);
   ...
   quadLineFit1012->SetParameter(0,74.00748);
   quadLineFit1012->SetParError(0,0.2296632);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-29.50662);
   quadLineFit1012->SetParError(1,4.109007);
   ...
   quadLineFit1013->SetChisquare(0.6203593);
   ...
   quadLineFit1013->SetParameter(0,74.00748);
   quadLineFit1013->SetParError(0,0.2296632);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-29.50662);
   quadLineFit1013->SetParError(1,4.109007);
