...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-41.09692);
   Graph_Graph01033->SetMaximum(48.67855);
   ...
   mainFit1034->SetChisquare(3.526533);
   ...
   mainFit1034->SetParameter(0,1.161435);
   mainFit1034->SetParError(0,1.143205);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.72632);
   mainFit1034->SetParError(1,0.03770697);
   ...
   pt_LaTex = pt->AddText("0.726#pm0.0377");
   pt_LaTex = pt->AddText(" 1.16#pm 1.14");
   pt_LaTex = pt->AddText("  1.6#pm 1.61");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.599068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.599068,-41.09692,-1.599068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.526533);
   ...
   mainFit1035->SetParameter(0,1.161435);
   mainFit1035->SetParError(0,1.143205);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.72632);
   mainFit1035->SetParError(1,0.03770697);
