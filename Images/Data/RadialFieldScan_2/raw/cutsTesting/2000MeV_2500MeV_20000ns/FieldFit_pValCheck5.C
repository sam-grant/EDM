...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.81077,70,57.59887);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.96981);
   Graph_Graph01035->SetMaximum(47.7579);
   ...
   mainFit1036->SetChisquare(0.4470879);
   ...
   mainFit1036->SetParameter(0,0.1704463);
   mainFit1036->SetParError(0,0.9571312);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7667112);
   mainFit1036->SetParError(1,0.03311812);
   ...
   pt_LaTex = pt->AddText("0.767#pm0.0331");
   pt_LaTex = pt->AddText(" 0.17#pm0.957");
   pt_LaTex = pt->AddText("0.222#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.2223084,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2223084,-30.96981,-0.2223084,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.4470879);
   ...
   mainFit1037->SetParameter(0,0.1704463);
   mainFit1037->SetParError(0,0.9571312);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7667112);
   mainFit1037->SetParError(1,0.03311812);
