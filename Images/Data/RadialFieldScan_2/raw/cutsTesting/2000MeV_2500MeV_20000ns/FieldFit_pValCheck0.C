...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-48.16757,50,39.14409);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-39.43641);
   Graph_Graph01025->SetMaximum(30.41292);
   ...
   mainFit1026->SetChisquare(3.518971);
   ...
   mainFit1026->SetParameter(0,0.4703907);
   mainFit1026->SetParError(0,0.9831236);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7248759);
   mainFit1026->SetParError(1,0.03893473);
   ...
   pt_LaTex = pt->AddText("0.725#pm0.0389");
   pt_LaTex = pt->AddText(" 0.47#pm0.983");
   pt_LaTex = pt->AddText("0.649#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.6489259,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6489259,-39.43641,-0.6489259,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.518971);
   ...
   mainFit1027->SetParameter(0,0.4703907);
   mainFit1027->SetParError(0,0.9831236);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7248759);
   mainFit1027->SetParError(1,0.03893473);
