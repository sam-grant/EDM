...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-41.09692);
   Graph_Graph01029->SetMaximum(48.67855);
   ...
   mainFit1030->SetChisquare(3.870959);
   ...
   mainFit1030->SetParameter(0,0.6001465);
   mainFit1030->SetParError(0,0.9917824);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7404371);
   mainFit1030->SetParError(1,0.03024888);
   ...
   pt_LaTex = pt->AddText(" 0.74#pm0.0302");
   pt_LaTex = pt->AddText("  0.6#pm0.992");
   pt_LaTex = pt->AddText("0.811#pm 1.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.81053,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.81053,-41.09692,-0.81053,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.870959);
   ...
   mainFit1031->SetParameter(0,0.6001465);
   mainFit1031->SetParError(0,0.9917824);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7404371);
   mainFit1031->SetParError(1,0.03024888);
