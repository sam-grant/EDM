...
//=========  (Thu Apr 22 00:29:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-41.09692);
   Graph_Graph01027->SetMaximum(48.67855);
   ...
   mainFit1028->SetChisquare(3.920306);
   ...
   mainFit1028->SetParameter(0,0.7948796);
   mainFit1028->SetParError(0,1.021563);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7438235);
   mainFit1028->SetParError(1,0.03369007);
   ...
   pt_LaTex = pt->AddText("0.744#pm0.0337");
   pt_LaTex = pt->AddText("0.795#pm 1.02");
   pt_LaTex = pt->AddText(" 1.07#pm 1.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.06864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.06864,-41.09692,-1.06864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.920306);
   ...
   mainFit1029->SetParameter(0,0.7948796);
   mainFit1029->SetParError(0,1.021563);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7438235);
   mainFit1029->SetParError(1,0.03369007);
