...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.87804);
   Graph_Graph01031->SetMaximum(55.19669);
   ...
   mainFit1032->SetChisquare(7.210121);
   ...
   mainFit1032->SetParameter(0,-1.096272);
   mainFit1032->SetParError(0,0.4775036);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8797489);
   mainFit1032->SetParError(1,0.01432941);
   ...
   pt_LaTex = pt->AddText(" 0.88#pm0.0143");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.478");
   pt_LaTex = pt->AddText("#minus1.25#pm0.538");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.246119,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.246119,-55.87804,1.246119,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.210121);
   ...
   mainFit1033->SetParameter(0,-1.096272);
   mainFit1033->SetParError(0,0.4775036);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8797489);
   mainFit1033->SetParError(1,0.01432941);
