...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.76239,75,69.08104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.87804);
   Graph_Graph01027->SetMaximum(55.19669);
   ...
   mainFit1028->SetChisquare(0.7193198);
   ...
   mainFit1028->SetParameter(0,-0.5299799);
   mainFit1028->SetParError(0,0.4676607);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8980136);
   mainFit1028->SetParError(1,0.01565179);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.24");
   pt_LaTex = pt->AddText("0.898#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.53#pm0.468");
   pt_LaTex = pt->AddText("#minus0.59#pm0.522");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5901691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5901691,-55.87804,0.5901691,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7193198);
   ...
   mainFit1029->SetParameter(0,-0.5299799);
   mainFit1029->SetParError(0,0.4676607);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8980136);
   mainFit1029->SetParError(1,0.01565179);
