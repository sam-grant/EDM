...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.87804);
   Graph_Graph01023->SetMaximum(55.19669);
   ...
   mainFit1024->SetChisquare(7.214314);
   ...
   mainFit1024->SetParameter(0,-1.080924);
   mainFit1024->SetParError(0,0.4146892);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8795094);
   mainFit1024->SetParError(1,0.01386645);
   ...
   mainFit1025->SetChisquare(7.214314);
   ...
   mainFit1025->SetParameter(0,-1.080924);
   mainFit1025->SetParError(0,0.4146892);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8795094);
   mainFit1025->SetParError(1,0.01386645);
