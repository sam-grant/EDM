...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.87804);
   Graph_Graph01033->SetMaximum(55.19669);
   ...
   mainFit1034->SetChisquare(7.085017);
   ...
   mainFit1034->SetParameter(0,-1.192652);
   mainFit1034->SetParError(0,0.5181497);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8832591);
   mainFit1034->SetParError(1,0.01734064);
   ...
   pt_LaTex = pt->AddText("0.883#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.19#pm0.518");
   pt_LaTex = pt->AddText("#minus1.35#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.350285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.350285,-55.87804,1.350285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.085017);
   ...
   mainFit1035->SetParameter(0,-1.192652);
   mainFit1035->SetParError(0,0.5181497);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8832591);
   mainFit1035->SetParError(1,0.01734064);
