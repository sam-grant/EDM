...
//=========  (Thu Apr 22 14:58:58 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-46.64863,70,64.45829);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.53794);
   Graph_Graph01035->SetMaximum(53.34759);
   ...
   mainFit1036->SetChisquare(7.181924);
   ...
   mainFit1036->SetParameter(0,-1.104167);
   mainFit1036->SetParError(0,0.4343016);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8806515);
   mainFit1036->SetParError(1,0.01523668);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0152");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.434");
   pt_LaTex = pt->AddText("#minus1.25#pm0.488");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.253807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.253807,-35.53794,1.253807,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.181924);
   ...
   mainFit1037->SetParameter(0,-1.104167);
   mainFit1037->SetParError(0,0.4343016);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8806515);
   mainFit1037->SetParError(1,0.01523668);
