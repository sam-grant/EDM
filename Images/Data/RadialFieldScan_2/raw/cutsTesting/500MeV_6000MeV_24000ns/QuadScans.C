...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3631978);
   ...
   quadLineFit1002->SetParameter(0,74.54522);
   quadLineFit1002->SetParError(0,0.0658335);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.83549);
   quadLineFit1002->SetParError(1,1.104973);
   ...
   quadLineFit1003->SetChisquare(0.3631978);
   ...
   quadLineFit1003->SetParameter(0,74.54522);
   quadLineFit1003->SetParError(0,0.0658335);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.83549);
   quadLineFit1003->SetParError(1,1.104973);
   ...
   Graph_30_ppm1003->SetMinimum(75.81083);
   Graph_30_ppm1003->SetMaximum(76.40497);
   ...
   quadLineFit1004->SetChisquare(0.7478468);
   ...
   quadLineFit1004->SetParameter(0,74.65852);
   quadLineFit1004->SetParError(0,0.05298375);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.57018);
   quadLineFit1004->SetParError(1,0.8708825);
   ...
   quadLineFit1005->SetChisquare(0.7478468);
   ...
   quadLineFit1005->SetParameter(0,74.65852);
   quadLineFit1005->SetParError(0,0.05298375);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.57018);
   quadLineFit1005->SetParError(1,0.8708825);
   ...
   Graph_10_ppm1005->SetMinimum(74.84136);
   Graph_10_ppm1005->SetMaximum(75.07634);
   ...
   quadLineFit1006->SetChisquare(2.907958);
   ...
   quadLineFit1006->SetParameter(0,74.45588);
   quadLineFit1006->SetParError(0,0.0620797);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.980523);
   quadLineFit1006->SetParError(1,1.006856);
   ...
   quadLineFit1007->SetChisquare(2.907958);
   ...
   quadLineFit1007->SetParameter(0,74.45588);
   quadLineFit1007->SetParError(0,0.0620797);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.980523);
   quadLineFit1007->SetParError(1,1.006856);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.63769);
   Graph_mI10_ppm1007->SetMaximum(73.93958);
   ...
   quadLineFit1008->SetChisquare(11.00073);
   ...
   quadLineFit1008->SetParameter(0,74.38176);
   quadLineFit1008->SetParError(0,0.05451759);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.826794);
   quadLineFit1008->SetParError(1,0.8874051);
   ...
   quadLineFit1009->SetChisquare(11.00073);
   ...
   quadLineFit1009->SetParameter(0,74.38176);
   quadLineFit1009->SetParError(0,0.05451759);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.826794);
   quadLineFit1009->SetParError(1,0.8874051);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.27798);
   Graph_mI30_ppm1009->SetMaximum(72.96557);
   ...
   quadLineFit1010->SetChisquare(2.060391);
   ...
   quadLineFit1010->SetParameter(0,74.3027);
   quadLineFit1010->SetParError(0,0.05155158);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.23859);
   quadLineFit1010->SetParError(1,0.8922166);
   ...
   quadLineFit1011->SetChisquare(2.060391);
   ...
   quadLineFit1011->SetParameter(0,74.3027);
   quadLineFit1011->SetParError(0,0.05155158);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.23859);
   quadLineFit1011->SetParError(1,0.8922166);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.35322);
   Graph_mI50_ppm1011->SetMaximum(71.99043);
   ...
   quadLineFit1012->SetChisquare(0.5906681);
   ...
   quadLineFit1012->SetParameter(0,74.22456);
   quadLineFit1012->SetParError(0,0.104103);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.7591);
   quadLineFit1012->SetParError(1,1.862716);
   ...
   quadLineFit1013->SetChisquare(0.5906681);
   ...
   quadLineFit1013->SetParameter(0,74.22456);
   quadLineFit1013->SetParError(0,0.104103);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.7591);
   quadLineFit1013->SetParError(1,1.862716);
