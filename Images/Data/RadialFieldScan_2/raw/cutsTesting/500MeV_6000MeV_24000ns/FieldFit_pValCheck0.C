...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.38754,50,42.20679);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.7281);
   Graph_Graph01025->SetMaximum(31.54735);
   ...
   mainFit1026->SetChisquare(1.429972);
   ...
   mainFit1026->SetParameter(0,-1.470088);
   mainFit1026->SetParError(0,0.4451371);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8533284);
   mainFit1026->SetParError(1,0.01763036);
   ...
   pt_LaTex = pt->AddText("0.853#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.47#pm0.445");
   pt_LaTex = pt->AddText("#minus1.72#pm0.527");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.72277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.72277,-53.7281,1.72277,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.429972);
   ...
   mainFit1027->SetParameter(0,-1.470088);
   mainFit1027->SetParError(0,0.4451371);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8533284);
   mainFit1027->SetParError(1,0.01763036);
