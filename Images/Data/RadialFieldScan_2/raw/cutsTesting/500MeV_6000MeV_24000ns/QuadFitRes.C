...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009244611);
   Graph_Graph11015->SetMaximum(0.009217137);
   ...
   Graph_Graph21016->SetMinimum(-0.01540821);
   Graph_Graph21016->SetMaximum(0.01814781);
   ...
   Graph_Graph31017->SetMinimum(-0.03870467);
   Graph_Graph31017->SetMaximum(0.02740657);
   ...
   Graph_Graph41018->SetMinimum(-0.009666329);
   Graph_Graph41018->SetMaximum(0.01650396);
   ...
   Graph_Graph51019->SetMinimum(-0.006485583);
   Graph_Graph51019->SetMaximum(0.008668791);
