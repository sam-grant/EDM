...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.87804);
   Graph_Graph01020->SetMaximum(55.19669);
   ...
   mainFit1021->SetChisquare(7.214314);
   ...
   mainFit1021->SetParameter(0,-1.080924);
   mainFit1021->SetParError(0,0.4146892);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8795094);
   mainFit1021->SetParError(1,0.01386645);
   ...
   pt_LaTex = pt->AddText(" 0.88#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.08#pm0.415");
   pt_LaTex = pt->AddText("#minus1.23#pm0.469");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.229008,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.229008,-55.87804,1.229008,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.214314);
   ...
   mainFit1022->SetParameter(0,-1.080924);
   mainFit1022->SetParError(0,0.4146892);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8795094);
   mainFit1022->SetParError(1,0.01386645);
