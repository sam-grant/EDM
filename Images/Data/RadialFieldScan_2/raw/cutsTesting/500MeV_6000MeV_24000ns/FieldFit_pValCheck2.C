...
//=========  (Thu Apr 22 14:58:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.87804);
   Graph_Graph01029->SetMaximum(55.19669);
   ...
   mainFit1030->SetChisquare(7.129791);
   ...
   mainFit1030->SetParameter(0,-1.132893);
   mainFit1030->SetParError(0,0.4515494);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8791674);
   mainFit1030->SetParError(1,0.01391785);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.38");
   pt_LaTex = pt->AddText("0.879#pm0.0139");
   pt_LaTex = pt->AddText("#minus1.13#pm0.452");
   pt_LaTex = pt->AddText("#minus1.29#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.288598,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.288598,-55.87804,1.288598,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.129791);
   ...
   mainFit1031->SetParameter(0,-1.132893);
   mainFit1031->SetParError(0,0.4515494);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8791674);
   mainFit1031->SetParError(1,0.01391785);
