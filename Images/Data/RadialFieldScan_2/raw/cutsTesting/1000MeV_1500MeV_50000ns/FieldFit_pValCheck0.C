...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-76.67924,50,46.58001);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-64.35331);
   Graph_Graph01025->SetMaximum(34.25408);
   ...
   mainFit1026->SetChisquare(2.819679);
   ...
   mainFit1026->SetParameter(0,-2.207307);
   mainFit1026->SetParError(0,1.229373);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9312793);
   mainFit1026->SetParError(1,0.04867338);
   ...
   pt_LaTex = pt->AddText("0.931#pm0.0487");
   pt_LaTex = pt->AddText("#minus2.21#pm 1.23");
   pt_LaTex = pt->AddText("#minus2.37#pm 1.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.370188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.370188,-64.35331,2.370188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.819679);
   ...
   mainFit1027->SetParameter(0,-2.207307);
   mainFit1027->SetParError(0,1.229373);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9312793);
   mainFit1027->SetParError(1,0.04867338);
