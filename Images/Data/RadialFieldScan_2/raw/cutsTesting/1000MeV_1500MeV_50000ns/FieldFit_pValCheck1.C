...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-67.23325);
   Graph_Graph01027->SetMaximum(65.93338);
   ...
   mainFit1028->SetChisquare(0.2626338);
   ...
   mainFit1028->SetParameter(0,0.04616717);
   mainFit1028->SetParError(0,1.277621);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.034177);
   mainFit1028->SetParError(1,0.04214635);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0875");
   pt_LaTex = pt->AddText(" 1.03#pm0.0421");
   pt_LaTex = pt->AddText("0.0462#pm 1.28");
   pt_LaTex = pt->AddText("0.0446#pm 1.24");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.04464146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.04464146,-67.23325,-0.04464146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2626338);
   ...
   mainFit1029->SetParameter(0,0.04616717);
   mainFit1029->SetParError(0,1.277621);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.034177);
   mainFit1029->SetParError(1,0.04214635);
