...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-54.98958,70,76.80131);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.81049);
   Graph_Graph01035->SetMaximum(63.62222);
   ...
   mainFit1036->SetChisquare(6.242303);
   ...
   mainFit1036->SetParameter(0,-1.341349);
   mainFit1036->SetParError(0,1.196853);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9873197);
   mainFit1036->SetParError(1,0.0414303);
   ...
   pt_LaTex = pt->AddText("0.987#pm0.0414");
   pt_LaTex = pt->AddText("#minus1.34#pm  1.2");
   pt_LaTex = pt->AddText("#minus1.36#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.358576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.358576,-41.81049,1.358576,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.242303);
   ...
   mainFit1037->SetParameter(0,-1.341349);
   mainFit1037->SetParError(0,1.196853);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9873197);
   mainFit1037->SetParError(1,0.0414303);
