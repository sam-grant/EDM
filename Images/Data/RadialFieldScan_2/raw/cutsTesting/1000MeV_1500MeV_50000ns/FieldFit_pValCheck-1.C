...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-67.23325);
   Graph_Graph01023->SetMaximum(65.93338);
   ...
   mainFit1024->SetChisquare(6.244974);
   ...
   mainFit1024->SetParameter(0,-1.35997);
   mainFit1024->SetParError(0,1.140955);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.98819);
   mainFit1024->SetParError(1,0.03772317);
   ...
   pt_LaTex = pt->AddText("0.988#pm0.0377");
   pt_LaTex = pt->AddText("#minus1.36#pm 1.14");
   pt_LaTex = pt->AddText("#minus1.38#pm 1.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.376223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.376223,-67.23325,1.376223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.244974);
   ...
   mainFit1025->SetParameter(0,-1.35997);
   mainFit1025->SetParError(0,1.140955);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.98819);
   mainFit1025->SetParError(1,0.03772317);
