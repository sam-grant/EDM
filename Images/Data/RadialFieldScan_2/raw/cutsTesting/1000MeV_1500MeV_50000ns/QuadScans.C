...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.393496);
   ...
   quadLineFit1002->SetParameter(0,73.9566);
   quadLineFit1002->SetParError(0,0.1740806);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,51.91555);
   quadLineFit1002->SetParError(1,2.92061);
   ...
   quadLineFit1003->SetChisquare(1.393496);
   ...
   quadLineFit1003->SetParameter(0,73.9566);
   quadLineFit1003->SetParError(0,0.1740806);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,51.91555);
   quadLineFit1003->SetParError(1,2.92061);
   ...
   Graph_30_ppm1003->SetMinimum(75.54352);
   Graph_30_ppm1003->SetMaximum(76.19087);
   ...
   quadLineFit1004->SetChisquare(4.513706);
   ...
   quadLineFit1004->SetParameter(0,74.43734);
   quadLineFit1004->SetParError(0,0.1464275);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.63032);
   quadLineFit1004->SetParError(1,2.406478);
   ...
   quadLineFit1005->SetChisquare(4.513706);
   ...
   quadLineFit1005->SetParameter(0,74.43734);
   quadLineFit1005->SetParError(0,0.1464275);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.63032);
   quadLineFit1005->SetParError(1,2.406478);
   ...
   Graph_10_ppm1005->SetMinimum(74.54932);
   Graph_10_ppm1005->SetMaximum(74.92079);
   ...
   quadLineFit1006->SetChisquare(1.115152);
   ...
   quadLineFit1006->SetParameter(0,74.04427);
   quadLineFit1006->SetParError(0,0.17133);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.86995);
   quadLineFit1006->SetParError(1,2.779269);
   ...
   quadLineFit1007->SetChisquare(1.115152);
   ...
   quadLineFit1007->SetParameter(0,74.04427);
   quadLineFit1007->SetParError(0,0.17133);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.86995);
   quadLineFit1007->SetParError(1,2.779269);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.27968);
   Graph_mI10_ppm1007->SetMaximum(73.65066);
   ...
   quadLineFit1008->SetChisquare(0.08667948);
   ...
   quadLineFit1008->SetParameter(0,74.15959);
   quadLineFit1008->SetParError(0,0.1505909);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.3479);
   quadLineFit1008->SetParError(1,2.451295);
   ...
   quadLineFit1009->SetChisquare(0.08667948);
   ...
   quadLineFit1009->SetParameter(0,74.15959);
   quadLineFit1009->SetParError(0,0.1505909);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.3479);
   quadLineFit1009->SetParError(1,2.451295);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.79214);
   Graph_mI30_ppm1009->SetMaximum(72.62659);
   ...
   quadLineFit1010->SetChisquare(1.149857);
   ...
   quadLineFit1010->SetParameter(0,74.11076);
   quadLineFit1010->SetParError(0,0.1423531);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.56062);
   quadLineFit1010->SetParError(1,2.463815);
   ...
   quadLineFit1011->SetChisquare(1.149857);
   ...
   quadLineFit1011->SetParameter(0,74.11076);
   quadLineFit1011->SetParError(0,0.1423531);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.56062);
   quadLineFit1011->SetParError(1,2.463815);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.84091);
   Graph_mI50_ppm1011->SetMaximum(71.62258);
   ...
   quadLineFit1012->SetChisquare(1.008798);
   ...
   quadLineFit1012->SetParameter(0,74.15518);
   quadLineFit1012->SetParError(0,0.2867355);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-51.00581);
   quadLineFit1012->SetParError(1,5.130223);
   ...
   quadLineFit1013->SetChisquare(1.008798);
   ...
   quadLineFit1013->SetParameter(0,74.15518);
   quadLineFit1013->SetParError(0,0.2867355);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-51.00581);
   quadLineFit1013->SetParError(1,5.130223);
