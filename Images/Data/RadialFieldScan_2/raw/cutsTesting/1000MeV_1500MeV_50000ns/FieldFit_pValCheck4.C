...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-67.23325);
   Graph_Graph01033->SetMaximum(65.93338);
   ...
   mainFit1034->SetChisquare(6.180372);
   ...
   mainFit1034->SetParameter(0,-1.578846);
   mainFit1034->SetParError(0,1.429308);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9953971);
   mainFit1034->SetParError(1,0.04715639);
   ...
   pt_LaTex = pt->AddText("0.995#pm0.0472");
   pt_LaTex = pt->AddText("#minus1.58#pm 1.43");
   pt_LaTex = pt->AddText("#minus1.59#pm  1.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.586146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.586146,-67.23325,1.586146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.180372);
   ...
   mainFit1035->SetParameter(0,-1.578846);
   mainFit1035->SetParError(0,1.429308);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9953971);
   mainFit1035->SetParError(1,0.04715639);
