...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-67.23325);
   Graph_Graph01029->SetMaximum(65.93338);
   ...
   mainFit1030->SetChisquare(5.386089);
   ...
   mainFit1030->SetParameter(0,-1.810939);
   mainFit1030->SetParError(0,1.240363);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9855279);
   mainFit1030->SetParError(1,0.03783358);
   ...
   pt_LaTex = pt->AddText("0.986#pm0.0378");
   pt_LaTex = pt->AddText("#minus1.81#pm 1.24");
   pt_LaTex = pt->AddText("#minus1.84#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.837532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.837532,-67.23325,1.837532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.386089);
   ...
   mainFit1031->SetParameter(0,-1.810939);
   mainFit1031->SetParError(0,1.240363);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9855279);
   mainFit1031->SetParError(1,0.03783358);
