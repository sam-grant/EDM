...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-67.23325);
   Graph_Graph01020->SetMaximum(65.93338);
   ...
   mainFit1021->SetChisquare(6.244974);
   ...
   mainFit1021->SetParameter(0,-1.35997);
   mainFit1021->SetParError(0,1.140955);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.98819);
   mainFit1021->SetParError(1,0.03772317);
   ...
   mainFit1022->SetChisquare(6.244974);
   ...
   mainFit1022->SetParameter(0,-1.35997);
   mainFit1022->SetParError(0,1.140955);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.98819);
   mainFit1022->SetParError(1,0.03772317);
