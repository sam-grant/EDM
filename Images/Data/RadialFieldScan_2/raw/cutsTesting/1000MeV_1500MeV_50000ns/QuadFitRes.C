...
//=========  (Thu Apr 22 00:57:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03548942);
   Graph_Graph11015->SetMaximum(0.1092669);
   ...
   Graph_Graph21016->SetMinimum(-0.02631008);
   Graph_Graph21016->SetMaximum(0.03110472);
   ...
   Graph_Graph31017->SetMinimum(-0.006767875);
   Graph_Graph31017->SetMaximum(0.01031979);
   ...
   Graph_Graph41018->SetMinimum(-0.02648959);
   Graph_Graph41018->SetMaximum(0.03218818);
   ...
   Graph_Graph51019->SetMinimum(-0.02337094);
   Graph_Graph51019->SetMaximum(0.03131553);
