...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-79.20189,75,71.43334);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-64.13837);
   Graph_Graph01027->SetMaximum(56.36981);
   ...
   mainFit1028->SetChisquare(3.280882);
   ...
   mainFit1028->SetParameter(0,-1.277442);
   mainFit1028->SetParError(0,0.5616494);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9418454);
   mainFit1028->SetParError(1,0.01852714);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.09");
   pt_LaTex = pt->AddText("0.942#pm0.0185");
   pt_LaTex = pt->AddText("#minus1.28#pm0.562");
   pt_LaTex = pt->AddText("#minus1.36#pm0.599");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.356318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.356318,-64.13837,1.356318,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.280882);
   ...
   mainFit1029->SetParameter(0,-1.277442);
   mainFit1029->SetParError(0,0.5616494);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9418454);
   mainFit1029->SetParError(1,0.01852714);
