...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-64.13837);
   Graph_Graph01029->SetMaximum(56.36981);
   ...
   mainFit1030->SetChisquare(3.492423);
   ...
   mainFit1030->SetParameter(0,-1.70721);
   mainFit1030->SetParError(0,0.5450852);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9327039);
   mainFit1030->SetParError(1,0.0166305);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0166");
   pt_LaTex = pt->AddText("#minus1.71#pm0.545");
   pt_LaTex = pt->AddText("#minus1.83#pm0.581");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.830388,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.830388,-64.13837,1.830388,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.492423);
   ...
   mainFit1031->SetParameter(0,-1.70721);
   mainFit1031->SetParError(0,0.5450852);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9327039);
   mainFit1031->SetParError(1,0.0166305);
