...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-64.13837);
   Graph_Graph01031->SetMaximum(56.36981);
   ...
   mainFit1032->SetChisquare(3.847435);
   ...
   mainFit1032->SetParameter(0,-1.701235);
   mainFit1032->SetParError(0,0.5776672);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9365294);
   mainFit1032->SetParError(1,0.01716137);
   ...
   pt_LaTex = pt->AddText("0.937#pm0.0172");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.578");
   pt_LaTex = pt->AddText("#minus1.82#pm0.609");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.816531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.816531,-64.13837,1.816531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.847435);
   ...
   mainFit1033->SetParameter(0,-1.701235);
   mainFit1033->SetParError(0,0.5776672);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9365294);
   mainFit1033->SetParError(1,0.01716137);
