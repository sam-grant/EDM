...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-64.13837);
   Graph_Graph01020->SetMaximum(56.36981);
   ...
   mainFit1021->SetChisquare(4.230699);
   ...
   mainFit1021->SetParameter(0,-1.523756);
   mainFit1021->SetParError(0,0.5015492);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9337816);
   mainFit1021->SetParError(1,0.0165822);
   ...
   mainFit1022->SetChisquare(4.230699);
   ...
   mainFit1022->SetParameter(0,-1.523756);
   mainFit1022->SetParError(0,0.5015492);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9337816);
   mainFit1022->SetParError(1,0.0165822);
