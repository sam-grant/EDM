...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-64.13837);
   Graph_Graph01033->SetMaximum(56.36981);
   ...
   mainFit1034->SetChisquare(3.900689);
   ...
   mainFit1034->SetParameter(0,-1.741631);
   mainFit1034->SetParError(0,0.6287615);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9409521);
   mainFit1034->SetParError(1,0.02074361);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0207");
   pt_LaTex = pt->AddText("#minus1.74#pm0.629");
   pt_LaTex = pt->AddText("#minus1.85#pm 0.65");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.850925,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.850925,-64.13837,1.850925,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.900689);
   ...
   mainFit1035->SetParameter(0,-1.741631);
   mainFit1035->SetParError(0,0.6287615);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9409521);
   mainFit1035->SetParError(1,0.02074361);
