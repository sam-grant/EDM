...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.30406,70,65.45377);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.82827);
   Graph_Graph01035->SetMaximum(53.97799);
   ...
   mainFit1036->SetChisquare(0.9852393);
   ...
   mainFit1036->SetParameter(0,-1.23847);
   mainFit1036->SetParError(0,0.5259621);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9202734);
   mainFit1036->SetParError(1,0.01820122);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.328");
   pt_LaTex = pt->AddText(" 0.92#pm0.0182");
   pt_LaTex = pt->AddText("#minus1.24#pm0.526");
   pt_LaTex = pt->AddText("#minus1.35#pm0.565");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.345764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.345764,-37.82827,1.345764,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.9852393);
   ...
   mainFit1037->SetParameter(0,-1.23847);
   mainFit1037->SetParError(0,0.5259621);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9202734);
   mainFit1037->SetParError(1,0.01820122);
