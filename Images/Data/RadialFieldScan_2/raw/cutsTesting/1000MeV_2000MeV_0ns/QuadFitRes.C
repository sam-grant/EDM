...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008628973);
   Graph_Graph11015->SetMaximum(0.02294336);
   ...
   Graph_Graph21016->SetMinimum(-0.02101989);
   Graph_Graph21016->SetMaximum(0.0246953);
   ...
   Graph_Graph31017->SetMinimum(-0.01276328);
   Graph_Graph31017->SetMaximum(0.01246414);
   ...
   Graph_Graph41018->SetMinimum(-0.0228404);
   Graph_Graph41018->SetMaximum(0.03275404);
   ...
   Graph_Graph51019->SetMinimum(-0.005676323);
   Graph_Graph51019->SetMaximum(0.007581125);
