...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-74.30311,50,46.93945);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.17886);
   Graph_Graph01025->SetMaximum(34.8152);
   ...
   mainFit1026->SetChisquare(4.213101);
   ...
   mainFit1026->SetParameter(0,-1.497084);
   mainFit1026->SetParError(0,0.5404624);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9355874);
   mainFit1026->SetParError(1,0.02140143);
   ...
   pt_LaTex = pt->AddText("0.936#pm0.0214");
   pt_LaTex = pt->AddText(" #minus1.5#pm 0.54");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.583");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.600154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.600154,-62.17886,1.600154,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.213101);
   ...
   mainFit1027->SetParameter(0,-1.497084);
   mainFit1027->SetParError(0,0.5404624);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9355874);
   mainFit1027->SetParError(1,0.02140143);
