...
//=========  (Wed Apr 21 18:18:55 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.68261);
   ...
   quadLineFit1002->SetParameter(0,74.36782);
   quadLineFit1002->SetParError(0,0.07653228);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.04413);
   quadLineFit1002->SetParError(1,1.283336);
   ...
   quadLineFit1003->SetChisquare(4.68261);
   ...
   quadLineFit1003->SetParameter(0,74.36782);
   quadLineFit1003->SetParError(0,0.07653228);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.04413);
   quadLineFit1003->SetParError(1,1.283336);
   ...
   Graph_30_ppm1003->SetMinimum(75.596);
   Graph_30_ppm1003->SetMaximum(76.25701);
   ...
   quadLineFit1004->SetChisquare(1.10191);
   ...
   quadLineFit1004->SetParameter(0,74.3582);
   quadLineFit1004->SetParError(0,0.06438792);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.67471);
   quadLineFit1004->SetParError(1,1.057652);
   ...
   quadLineFit1005->SetChisquare(1.10191);
   ...
   quadLineFit1005->SetParameter(0,74.3582);
   quadLineFit1005->SetParError(0,0.06438792);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.67471);
   quadLineFit1005->SetParError(1,1.057652);
   ...
   Graph_10_ppm1005->SetMinimum(74.65004);
   Graph_10_ppm1005->SetMaximum(74.91411);
   ...
   quadLineFit1006->SetChisquare(3.67474);
   ...
   quadLineFit1006->SetParameter(0,74.22581);
   quadLineFit1006->SetParError(0,0.07547797);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.772881);
   quadLineFit1006->SetParError(1,1.22368);
   ...
   quadLineFit1007->SetChisquare(3.67474);
   ...
   quadLineFit1007->SetParameter(0,74.22581);
   quadLineFit1007->SetParError(0,0.07547797);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.772881);
   quadLineFit1007->SetParError(1,1.22368);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.42384);
   Graph_mI10_ppm1007->SetMaximum(73.72276);
   ...
   quadLineFit1008->SetChisquare(0.9458128);
   ...
   quadLineFit1008->SetParameter(0,74.20211);
   quadLineFit1008->SetParError(0,0.06620265);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.28951);
   quadLineFit1008->SetParError(1,1.077076);
   ...
   quadLineFit1009->SetChisquare(0.9458128);
   ...
   quadLineFit1009->SetParameter(0,74.20211);
   quadLineFit1009->SetParError(0,0.06620265);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.28951);
   quadLineFit1009->SetParError(1,1.077076);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.03026);
   Graph_mI30_ppm1009->SetMaximum(72.78289);
   ...
   quadLineFit1010->SetChisquare(3.711633);
   ...
   quadLineFit1010->SetParameter(0,74.209);
   quadLineFit1010->SetParError(0,0.06255302);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.09575);
   quadLineFit1010->SetParError(1,1.082007);
   ...
   quadLineFit1011->SetChisquare(3.711633);
   ...
   quadLineFit1011->SetParameter(0,74.209);
   quadLineFit1011->SetParError(0,0.06255302);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.09575);
   quadLineFit1011->SetParError(1,1.082007);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.08397);
   Graph_mI50_ppm1011->SetMaximum(71.82404);
   ...
   quadLineFit1012->SetChisquare(0.3057343);
   ...
   quadLineFit1012->SetParameter(0,74.40893);
   quadLineFit1012->SetParError(0,0.1263975);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-51.83475);
   quadLineFit1012->SetParError(1,2.261269);
   ...
   quadLineFit1013->SetChisquare(0.3057343);
   ...
   quadLineFit1013->SetParameter(0,74.40893);
   quadLineFit1013->SetParError(0,0.1263975);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-51.83475);
   quadLineFit1013->SetParError(1,2.261269);
