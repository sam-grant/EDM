...
//=========  (Wed Apr 21 18:18:56 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-64.13837);
   Graph_Graph01023->SetMaximum(56.36981);
   ...
   mainFit1024->SetChisquare(4.230699);
   ...
   mainFit1024->SetParameter(0,-1.523756);
   mainFit1024->SetParError(0,0.5015492);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9337816);
   mainFit1024->SetParError(1,0.0165822);
   ...
   pt_LaTex = pt->AddText("0.934#pm0.0166");
   pt_LaTex = pt->AddText("#minus1.52#pm0.502");
   pt_LaTex = pt->AddText("#minus1.63#pm0.533");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.631812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.631812,-64.13837,1.631812,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.230699);
   ...
   mainFit1025->SetParameter(0,-1.523756);
   mainFit1025->SetParError(0,0.5015492);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9337816);
   mainFit1025->SetParError(1,0.0165822);
