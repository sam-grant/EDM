...
//=========  (Wed Apr 28 14:40:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.06044);
   Graph_Graph01027->SetMaximum(54.53792);
   ...
   mainFit1028->SetChisquare(0.217128);
   ...
   mainFit1028->SetParameter(0,-0.2495708);
   mainFit1028->SetParError(0,0.4993687);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8905512);
   mainFit1028->SetParError(1,0.01647035);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0724");
   pt_LaTex = pt->AddText("0.891#pm0.0165");
   pt_LaTex = pt->AddText("#minus0.25#pm0.499");
   pt_LaTex = pt->AddText("#minus0.28#pm0.561");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2802431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2802431,-56.06044,0.2802431,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.217128);
   ...
   mainFit1029->SetParameter(0,-0.2495708);
   mainFit1029->SetParError(0,0.4993687);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8905512);
   mainFit1029->SetParError(1,0.01647035);
