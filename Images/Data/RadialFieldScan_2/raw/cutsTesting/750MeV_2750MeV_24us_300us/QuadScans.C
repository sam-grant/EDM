...
//=========  (Wed Apr 28 14:40:24 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.496074);
   ...
   quadLineFit1002->SetParameter(0,74.54);
   quadLineFit1002->SetParError(0,0.06800673);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.18063);
   quadLineFit1002->SetParError(1,1.140765);
   ...
   quadLineFit1003->SetChisquare(1.496074);
   ...
   quadLineFit1003->SetParameter(0,74.54);
   quadLineFit1003->SetParError(0,0.06800673);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.18063);
   quadLineFit1003->SetParError(1,1.140765);
   ...
   Graph_30_ppm1003->SetMinimum(75.77799);
   Graph_30_ppm1003->SetMaximum(76.37794);
   ...
   quadLineFit1004->SetChisquare(1.446488);
   ...
   quadLineFit1004->SetParameter(0,74.61719);
   quadLineFit1004->SetParError(0,0.05716985);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.78841);
   quadLineFit1004->SetParError(1,0.939638);
   ...
   quadLineFit1005->SetChisquare(1.446488);
   ...
   quadLineFit1005->SetParameter(0,74.61719);
   quadLineFit1005->SetParError(0,0.05716985);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.78841);
   quadLineFit1005->SetParError(1,0.939638);
   ...
   Graph_10_ppm1005->SetMinimum(74.81206);
   Graph_10_ppm1005->SetMaximum(75.07151);
   ...
   quadLineFit1006->SetChisquare(0.7756191);
   ...
   quadLineFit1006->SetParameter(0,74.38094);
   quadLineFit1006->SetParError(0,0.06709382);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.011889);
   quadLineFit1006->SetParError(1,1.08815);
   ...
   quadLineFit1007->SetChisquare(0.7756191);
   ...
   quadLineFit1007->SetParameter(0,74.38094);
   quadLineFit1007->SetParError(0,0.06709382);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.011889);
   quadLineFit1007->SetParError(1,1.08815);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.64108);
   Graph_mI10_ppm1007->SetMaximum(73.93218);
   ...
   quadLineFit1008->SetChisquare(7.647592);
   ...
   quadLineFit1008->SetParameter(0,74.35897);
   quadLineFit1008->SetParError(0,0.05881548);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.445077);
   quadLineFit1008->SetParError(1,0.9573333);
   ...
   quadLineFit1009->SetChisquare(7.647592);
   ...
   quadLineFit1009->SetParameter(0,74.35897);
   quadLineFit1009->SetParError(0,0.05881548);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.445077);
   quadLineFit1009->SetParError(1,0.9573333);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.29319);
   Graph_mI30_ppm1009->SetMaximum(72.97582);
   ...
   quadLineFit1010->SetChisquare(4.365773);
   ...
   quadLineFit1010->SetParameter(0,74.29807);
   quadLineFit1010->SetParError(0,0.05562361);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.86871);
   quadLineFit1010->SetParError(1,0.9626713);
   ...
   quadLineFit1011->SetChisquare(4.365773);
   ...
   quadLineFit1011->SetParameter(0,74.29807);
   quadLineFit1011->SetParError(0,0.05562361);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.86871);
   quadLineFit1011->SetParError(1,0.9626713);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.38015);
   Graph_mI50_ppm1011->SetMaximum(72.021);
   ...
   quadLineFit1012->SetChisquare(0.7974571);
   ...
   quadLineFit1012->SetParameter(0,74.25903);
   quadLineFit1012->SetParError(0,0.1122436);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.83551);
   quadLineFit1012->SetParError(1,2.008398);
   ...
   quadLineFit1013->SetChisquare(0.7974571);
   ...
   quadLineFit1013->SetParameter(0,74.25903);
   quadLineFit1013->SetParError(0,0.1122436);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.83551);
   quadLineFit1013->SetParError(1,2.008398);
