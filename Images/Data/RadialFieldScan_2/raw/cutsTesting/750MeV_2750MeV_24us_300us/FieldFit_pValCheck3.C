...
//=========  (Wed Apr 28 14:40:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.06044);
   Graph_Graph01031->SetMaximum(54.53792);
   ...
   mainFit1032->SetChisquare(5.294404);
   ...
   mainFit1032->SetParameter(0,-0.7722443);
   mainFit1032->SetParError(0,0.5136273);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8742336);
   mainFit1032->SetParError(1,0.01525657);
   ...
   pt_LaTex = pt->AddText("0.874#pm0.0153");
   pt_LaTex = pt->AddText("#minus0.772#pm0.514");
   pt_LaTex = pt->AddText("#minus0.883#pm0.584");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8833385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8833385,-56.06044,0.8833385,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.294404);
   ...
   mainFit1033->SetParameter(0,-0.7722443);
   mainFit1033->SetParError(0,0.5136273);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8742336);
   mainFit1033->SetParError(1,0.01525657);
