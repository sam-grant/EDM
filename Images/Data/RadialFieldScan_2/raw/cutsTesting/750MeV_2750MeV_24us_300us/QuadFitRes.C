...
//=========  (Wed Apr 28 14:40:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01231278);
   Graph_Graph11015->SetMaximum(0.01871058);
   ...
   Graph_Graph21016->SetMinimum(-0.008580043);
   Graph_Graph21016->SetMaximum(0.01010249);
   ...
   Graph_Graph31017->SetMinimum(-0.03407342);
   Graph_Graph31017->SetMaximum(0.02737494);
   ...
   Graph_Graph41018->SetMinimum(-0.0152518);
   Graph_Graph41018->SetMaximum(0.02441672);
   ...
   Graph_Graph51019->SetMinimum(-0.008124691);
   Graph_Graph51019->SetMaximum(0.01086755);
