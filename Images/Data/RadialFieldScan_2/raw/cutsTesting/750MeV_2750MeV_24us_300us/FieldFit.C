...
//=========  (Wed Apr 28 14:40:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.06044);
   Graph_Graph01020->SetMaximum(54.53792);
   ...
   mainFit1021->SetChisquare(5.298285);
   ...
   mainFit1021->SetParameter(0,-0.7563632);
   mainFit1021->SetParError(0,0.4458944);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8739885);
   mainFit1021->SetParError(1,0.01474055);
   ...
   mainFit1022->SetChisquare(5.298285);
   ...
   mainFit1022->SetParameter(0,-0.7563632);
   mainFit1022->SetParError(0,0.4458944);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8739885);
   mainFit1022->SetParError(1,0.01474055);
