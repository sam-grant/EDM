...
//=========  (Wed Apr 28 14:40:25 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.06044);
   Graph_Graph01023->SetMaximum(54.53792);
   ...
   mainFit1024->SetChisquare(5.298285);
   ...
   mainFit1024->SetParameter(0,-0.7563632);
   mainFit1024->SetParError(0,0.4458944);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8739885);
   mainFit1024->SetParError(1,0.01474055);
   ...
   pt_LaTex = pt->AddText("0.874#pm0.0147");
   pt_LaTex = pt->AddText("#minus0.756#pm0.446");
   pt_LaTex = pt->AddText("#minus0.865#pm0.508");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8654155,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8654155,-56.06044,0.8654155,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.298285);
   ...
   mainFit1025->SetParameter(0,-0.7563632);
   mainFit1025->SetParError(0,0.4458944);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8739885);
   mainFit1025->SetParError(1,0.01474055);
