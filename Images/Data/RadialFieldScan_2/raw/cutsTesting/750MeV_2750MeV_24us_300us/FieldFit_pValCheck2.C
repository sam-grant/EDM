...
//=========  (Wed Apr 28 14:40:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.06044);
   Graph_Graph01029->SetMaximum(54.53792);
   ...
   mainFit1030->SetChisquare(4.224313);
   ...
   mainFit1030->SetParameter(0,-0.9529387);
   mainFit1030->SetParError(0,0.4845653);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8728241);
   mainFit1030->SetParError(1,0.01478322);
   ...
   pt_LaTex = pt->AddText("0.873#pm0.0148");
   pt_LaTex = pt->AddText("#minus0.953#pm0.485");
   pt_LaTex = pt->AddText("#minus1.09#pm0.553");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.091788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.091788,-56.06044,1.091788,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.224313);
   ...
   mainFit1031->SetParameter(0,-0.9529387);
   mainFit1031->SetParError(0,0.4845653);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8728241);
   mainFit1031->SetParError(1,0.01478322);
