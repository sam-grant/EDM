...
//=========  (Wed Apr 28 14:40:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.11958,70,63.60959);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.14666);
   Graph_Graph01035->SetMaximum(52.63667);
   ...
   mainFit1036->SetChisquare(5.253023);
   ...
   mainFit1036->SetParameter(0,-0.7263532);
   mainFit1036->SetParError(0,0.4676746);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8725673);
   mainFit1036->SetParError(1,0.01618359);
   ...
   pt_LaTex = pt->AddText("0.873#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.726#pm0.468");
   pt_LaTex = pt->AddText("#minus0.832#pm0.532");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8324322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8324322,-35.14666,0.8324322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.253023);
   ...
   mainFit1037->SetParameter(0,-0.7263532);
   mainFit1037->SetParError(0,0.4676746);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8725673);
   mainFit1037->SetParError(1,0.01618359);
