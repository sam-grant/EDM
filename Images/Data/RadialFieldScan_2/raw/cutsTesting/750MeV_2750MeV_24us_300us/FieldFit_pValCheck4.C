...
//=========  (Wed Apr 28 14:40:26 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.88524,75,68.36272);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-56.06044);
   Graph_Graph01033->SetMaximum(54.53792);
   ...
   mainFit1034->SetChisquare(5.273723);
   ...
   mainFit1034->SetParameter(0,-0.8091433);
   mainFit1034->SetParError(0,0.5587843);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8757229);
   mainFit1034->SetParError(1,0.01843255);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.76");
   pt_LaTex = pt->AddText("0.876#pm0.0184");
   pt_LaTex = pt->AddText("#minus0.809#pm0.559");
   pt_LaTex = pt->AddText("#minus0.924#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9239718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9239718,-56.06044,0.9239718,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.273723);
   ...
   mainFit1035->SetParameter(0,-0.8091433);
   mainFit1035->SetParError(0,0.5587843);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8757229);
   mainFit1035->SetParError(1,0.01843255);
