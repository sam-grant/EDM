...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.3578298);
   Graph_Graph11015->SetMaximum(0.2283275);
   ...
   Graph_Graph21016->SetMinimum(-0.183749);
   Graph_Graph21016->SetMaximum(0.218325);
   ...
   Graph_Graph31017->SetMinimum(-0.1051992);
   Graph_Graph31017->SetMaximum(0.07966087);
   ...
   Graph_Graph41018->SetMinimum(-0.1954509);
   Graph_Graph41018->SetMaximum(0.127224);
   ...
   Graph_Graph51019->SetMinimum(-0.05650001);
   Graph_Graph51019->SetMaximum(0.07551922);
