...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-97.56438);
   Graph_Graph01031->SetMaximum(64.85583);
   ...
   mainFit1032->SetChisquare(6.274035);
   ...
   mainFit1032->SetParameter(0,3.272901);
   mainFit1032->SetParError(0,3.776969);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8688724);
   mainFit1032->SetParError(1,0.1122155);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.112");
   pt_LaTex = pt->AddText(" 3.27#pm 3.78");
   pt_LaTex = pt->AddText(" 3.77#pm  4.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.766838,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.766838,-97.56438,-3.766838,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.274035);
   ...
   mainFit1033->SetParameter(0,3.272901);
   mainFit1033->SetParError(0,3.776969);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8688724);
   mainFit1033->SetParError(1,0.1122155);
