...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-97.56438);
   Graph_Graph01033->SetMaximum(64.85583);
   ...
   mainFit1034->SetChisquare(6.662937);
   ...
   mainFit1034->SetParameter(0,3.473286);
   mainFit1034->SetParError(0,4.098665);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8899444);
   mainFit1034->SetParError(1,0.1355673);
   ...
   pt_LaTex = pt->AddText(" 0.89#pm0.136");
   pt_LaTex = pt->AddText(" 3.47#pm  4.1");
   pt_LaTex = pt->AddText("  3.9#pm 4.91");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.902813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.902813,-97.56438,-3.902813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.662937);
   ...
   mainFit1035->SetParameter(0,3.473286);
   mainFit1035->SetParError(0,4.098665);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8899444);
   mainFit1035->SetParError(1,0.1355673);
