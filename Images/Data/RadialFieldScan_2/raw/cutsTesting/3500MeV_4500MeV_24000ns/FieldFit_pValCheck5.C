...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.72716,70,70.33041);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.3214);
   Graph_Graph01035->SetMaximum(58.92465);
   ...
   mainFit1036->SetChisquare(1.310714);
   ...
   mainFit1036->SetParameter(0,7.282941);
   mainFit1036->SetParError(0,3.42385);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7291951);
   mainFit1036->SetParError(1,0.1185903);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.437");
   pt_LaTex = pt->AddText("0.729#pm0.119");
   pt_LaTex = pt->AddText(" 7.28#pm 3.42");
   pt_LaTex = pt->AddText(" 9.99#pm 5.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-9.987644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-9.987644,-32.3214,-9.987644,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.310714);
   ...
   mainFit1037->SetParameter(0,7.282941);
   mainFit1037->SetParError(0,3.42385);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7291951);
   mainFit1037->SetParError(1,0.1185903);
