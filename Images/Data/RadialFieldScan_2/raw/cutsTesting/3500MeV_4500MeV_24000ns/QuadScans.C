...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7867492);
   ...
   quadLineFit1002->SetParameter(0,75.11099);
   quadLineFit1002->SetParError(0,0.4982502);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.96208);
   quadLineFit1002->SetParError(1,8.358738);
   ...
   quadLineFit1003->SetChisquare(0.7867492);
   ...
   quadLineFit1003->SetParameter(0,75.11099);
   quadLineFit1003->SetParError(0,0.4982502);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.96208);
   quadLineFit1003->SetParError(1,8.358738);
   ...
   Graph_30_ppm1003->SetMinimum(76.14315);
   Graph_30_ppm1003->SetMaximum(77.21964);
   ...
   quadLineFit1004->SetChisquare(9.466032);
   ...
   quadLineFit1004->SetParameter(0,75.14522);
   quadLineFit1004->SetParError(0,0.4186097);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.79344);
   quadLineFit1004->SetParError(1,6.88852);
   ...
   quadLineFit1005->SetChisquare(9.466032);
   ...
   quadLineFit1005->SetParameter(0,75.14522);
   quadLineFit1005->SetParError(0,0.4186097);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.79344);
   quadLineFit1005->SetParError(1,6.88852);
   ...
   Graph_10_ppm1005->SetMinimum(75.31273);
   Graph_10_ppm1005->SetMaximum(76.20772);
   ...
   quadLineFit1006->SetChisquare(6.555547);
   ...
   quadLineFit1006->SetParameter(0,74.26112);
   quadLineFit1006->SetParError(0,0.4934425);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,21.88809);
   quadLineFit1006->SetParError(1,8.006231);
   ...
   quadLineFit1007->SetChisquare(6.555547);
   ...
   quadLineFit1007->SetParameter(0,74.26112);
   quadLineFit1007->SetParError(0,0.4934425);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,21.88809);
   quadLineFit1007->SetParError(1,8.006231);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.22767);
   Graph_mI10_ppm1007->SetMaximum(74.67844);
   ...
   quadLineFit1008->SetChisquare(1.353302);
   ...
   quadLineFit1008->SetParameter(0,74.38059);
   quadLineFit1008->SetParError(0,0.4271453);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,1.409454);
   quadLineFit1008->SetParError(1,6.960949);
   ...
   quadLineFit1009->SetChisquare(1.353302);
   ...
   quadLineFit1009->SetParameter(0,74.38059);
   quadLineFit1009->SetParError(0,0.4271453);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,1.409454);
   quadLineFit1009->SetParError(1,6.960949);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.92358);
   Graph_mI30_ppm1009->SetMaximum(73.6738);
   ...
   quadLineFit1010->SetChisquare(4.546186);
   ...
   quadLineFit1010->SetParameter(0,74.367);
   quadLineFit1010->SetParError(0,0.4078578);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-17.65183);
   quadLineFit1010->SetParError(1,7.065741);
   ...
   quadLineFit1011->SetChisquare(4.546186);
   ...
   quadLineFit1011->SetParameter(0,74.367);
   quadLineFit1011->SetParError(0,0.4078578);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-17.65183);
   quadLineFit1011->SetParError(1,7.065741);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.65582);
   Graph_mI50_ppm1011->SetMaximum(72.85904);
   ...
   quadLineFit1012->SetChisquare(0.7131809);
   ...
   quadLineFit1012->SetParameter(0,76.24134);
   quadLineFit1012->SetParError(0,0.8355452);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-69.08134);
   quadLineFit1012->SetParError(1,14.94802);
   ...
   quadLineFit1013->SetChisquare(0.7131809);
   ...
   quadLineFit1013->SetParameter(0,76.24134);
   quadLineFit1013->SetParError(0,0.8355452);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-69.08134);
   quadLineFit1013->SetParError(1,14.94802);
