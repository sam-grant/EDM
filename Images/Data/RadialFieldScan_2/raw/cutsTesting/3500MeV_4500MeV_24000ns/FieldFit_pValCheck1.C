...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-97.56438);
   Graph_Graph01027->SetMaximum(64.85583);
   ...
   mainFit1028->SetChisquare(6.326902);
   ...
   mainFit1028->SetParameter(0,6.185278);
   mainFit1028->SetParError(0,3.659144);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8877786);
   mainFit1028->SetParError(1,0.1210168);
   ...
   pt_LaTex = pt->AddText("0.888#pm0.121");
   pt_LaTex = pt->AddText(" 6.19#pm 3.66");
   pt_LaTex = pt->AddText(" 6.97#pm 4.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-6.96714,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.96714,-97.56438,-6.96714,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(6.326902);
   ...
   mainFit1029->SetParameter(0,6.185278);
   mainFit1029->SetParError(0,3.659144);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8877786);
   mainFit1029->SetParError(1,0.1210168);
