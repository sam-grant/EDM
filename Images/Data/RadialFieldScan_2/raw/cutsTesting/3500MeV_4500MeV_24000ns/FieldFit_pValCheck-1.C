...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-97.56438);
   Graph_Graph01023->SetMaximum(64.85583);
   ...
   mainFit1024->SetChisquare(6.977246);
   ...
   mainFit1024->SetParameter(0,4.859402);
   mainFit1024->SetParError(0,3.268978);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8442263);
   mainFit1024->SetParError(1,0.1082983);
   ...
   pt_LaTex = pt->AddText("0.844#pm0.108");
   pt_LaTex = pt->AddText(" 4.86#pm 3.27");
   pt_LaTex = pt->AddText(" 5.76#pm 4.06");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-5.756041,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-5.756041,-97.56438,-5.756041,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.977246);
   ...
   mainFit1025->SetParameter(0,4.859402);
   mainFit1025->SetParError(0,3.268978);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8442263);
   mainFit1025->SetParError(1,0.1082983);
