...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-97.56438);
   Graph_Graph01020->SetMaximum(64.85583);
   ...
   mainFit1021->SetChisquare(6.977246);
   ...
   mainFit1021->SetParameter(0,4.859402);
   mainFit1021->SetParError(0,3.268978);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8442263);
   mainFit1021->SetParError(1,0.1082983);
   ...
   mainFit1022->SetChisquare(6.977246);
   ...
   mainFit1022->SetParameter(0,4.859402);
   mainFit1022->SetParError(0,3.268978);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8442263);
   mainFit1022->SetParError(1,0.1082983);
