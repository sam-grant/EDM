...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-117.8669,75,85.15836);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-97.56438);
   Graph_Graph01029->SetMaximum(64.85583);
   ...
   mainFit1030->SetChisquare(5.596449);
   ...
   mainFit1030->SetParameter(0,3.233699);
   mainFit1030->SetParError(0,3.549685);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8346419);
   mainFit1030->SetParError(1,0.108605);
   ...
   pt_LaTex = pt->AddText("0.835#pm0.109");
   pt_LaTex = pt->AddText(" 3.23#pm 3.55");
   pt_LaTex = pt->AddText(" 3.87#pm 4.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.874355,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.874355,-97.56438,-3.874355,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.596449);
   ...
   mainFit1031->SetParameter(0,3.233699);
   mainFit1031->SetParError(0,3.549685);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8346419);
   mainFit1031->SetParError(1,0.108605);
