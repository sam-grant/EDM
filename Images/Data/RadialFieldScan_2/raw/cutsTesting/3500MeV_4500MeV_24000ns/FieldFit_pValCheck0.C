...
//=========  (Wed Apr 21 20:14:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-113.2072,50,61.85979);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-95.70049);
   Graph_Graph01025->SetMaximum(44.35309);
   ...
   mainFit1026->SetChisquare(6.503454);
   ...
   mainFit1026->SetParameter(0,5.759089);
   mainFit1026->SetParError(0,3.520604);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9051992);
   mainFit1026->SetParError(1,0.1399108);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.17");
   pt_LaTex = pt->AddText("0.905#pm 0.14");
   pt_LaTex = pt->AddText(" 5.76#pm 3.52");
   pt_LaTex = pt->AddText(" 6.36#pm  3.9");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-6.362234,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-6.362234,-95.70049,-6.362234,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(6.503454);
   ...
   mainFit1027->SetParameter(0,5.759089);
   mainFit1027->SetParError(0,3.520604);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9051992);
   mainFit1027->SetParError(1,0.1399108);
