...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.00907);
   Graph_Graph01027->SetMaximum(53.86316);
   ...
   mainFit1028->SetChisquare(1.351346);
   ...
   mainFit1028->SetParameter(0,-1.253646);
   mainFit1028->SetParError(0,0.4468168);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9065057);
   mainFit1028->SetParError(1,0.01480898);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.45");
   pt_LaTex = pt->AddText("0.907#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.25#pm0.447");
   pt_LaTex = pt->AddText("#minus1.38#pm0.495");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.382943,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.382943,-58.00907,1.382943,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.351346);
   ...
   mainFit1029->SetParameter(0,-1.253646);
   mainFit1029->SetParError(0,0.4468168);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9065057);
   mainFit1029->SetParError(1,0.01480898);
