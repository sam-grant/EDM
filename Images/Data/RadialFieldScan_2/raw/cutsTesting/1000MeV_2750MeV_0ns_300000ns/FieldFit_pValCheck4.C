...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.00907);
   Graph_Graph01033->SetMaximum(53.86316);
   ...
   mainFit1034->SetChisquare(1.781427);
   ...
   mainFit1034->SetParameter(0,-1.270317);
   mainFit1034->SetParError(0,0.4985948);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8959804);
   mainFit1034->SetParError(1,0.01652627);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.594");
   pt_LaTex = pt->AddText("0.896#pm0.0165");
   pt_LaTex = pt->AddText("#minus1.27#pm0.499");
   pt_LaTex = pt->AddText("#minus1.42#pm0.545");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.417796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.417796,-58.00907,1.417796,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.781427);
   ...
   mainFit1035->SetParameter(0,-1.270317);
   mainFit1035->SetParError(0,0.4985948);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8959804);
   mainFit1035->SetParError(1,0.01652627);
