...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.99311,75,67.84719);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-58.00907);
   Graph_Graph01031->SetMaximum(53.86316);
   ...
   mainFit1032->SetChisquare(1.983481);
   ...
   mainFit1032->SetParameter(0,-1.472724);
   mainFit1032->SetParError(0,0.4584851);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9017657);
   mainFit1032->SetParError(1,0.01366568);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.661");
   pt_LaTex = pt->AddText("0.902#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.47#pm0.458");
   pt_LaTex = pt->AddText("#minus1.63#pm0.503");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.633156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.633156,-58.00907,1.633156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.983481);
   ...
   mainFit1033->SetParameter(0,-1.472724);
   mainFit1033->SetParError(0,0.4584851);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9017657);
   mainFit1033->SetParError(1,0.01366568);
