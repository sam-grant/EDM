...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.00907);
   Graph_Graph01023->SetMaximum(53.86316);
   ...
   mainFit1024->SetChisquare(2.03452);
   ...
   mainFit1024->SetParameter(0,-1.421312);
   mainFit1024->SetParError(0,0.3980946);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9009678);
   mainFit1024->SetParError(1,0.01321071);
   ...
   mainFit1025->SetChisquare(2.03452);
   ...
   mainFit1025->SetParameter(0,-1.421312);
   mainFit1025->SetParError(0,0.3980946);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9009678);
   mainFit1025->SetParError(1,0.01321071);
