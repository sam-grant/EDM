...
//=========  (Mon Apr 26 22:14:29 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.863689);
   ...
   quadLineFit1002->SetParameter(0,74.60465);
   quadLineFit1002->SetParError(0,0.06153773);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.50847);
   quadLineFit1002->SetParError(1,1.032001);
   ...
   quadLineFit1003->SetChisquare(5.863689);
   ...
   quadLineFit1003->SetParameter(0,74.60465);
   quadLineFit1003->SetParError(0,0.06153773);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.50847);
   quadLineFit1003->SetParError(1,1.032001);
   ...
   Graph_30_ppm1003->SetMinimum(75.79323);
   Graph_30_ppm1003->SetMaximum(76.42512);
   ...
   quadLineFit1004->SetChisquare(0.3710207);
   ...
   quadLineFit1004->SetParameter(0,74.57021);
   quadLineFit1004->SetParError(0,0.05102651);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.06217);
   quadLineFit1004->SetParError(1,0.8381648);
   ...
   quadLineFit1005->SetChisquare(0.3710207);
   ...
   quadLineFit1005->SetParameter(0,74.57021);
   quadLineFit1005->SetParError(0,0.05102651);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.06217);
   quadLineFit1005->SetParError(1,0.8381648);
   ...
   Graph_10_ppm1005->SetMinimum(74.84599);
   Graph_10_ppm1005->SetMaximum(75.09575);
   ...
   quadLineFit1006->SetChisquare(1.740797);
   ...
   quadLineFit1006->SetParameter(0,74.42537);
   quadLineFit1006->SetParError(0,0.05983603);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.726391);
   quadLineFit1006->SetParError(1,0.9699785);
   ...
   quadLineFit1007->SetChisquare(1.740797);
   ...
   quadLineFit1007->SetParameter(0,74.42537);
   quadLineFit1007->SetParError(0,0.05983603);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.726391);
   quadLineFit1007->SetParError(1,0.9699785);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.67186);
   Graph_mI10_ppm1007->SetMaximum(73.96432);
   ...
   quadLineFit1008->SetChisquare(1.745714);
   ...
   quadLineFit1008->SetParameter(0,74.43907);
   quadLineFit1008->SetParError(0,0.05249041);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.26556);
   quadLineFit1008->SetParError(1,0.8538974);
   ...
   quadLineFit1009->SetChisquare(1.745714);
   ...
   quadLineFit1009->SetParameter(0,74.43907);
   quadLineFit1009->SetParError(0,0.05249041);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.26556);
   quadLineFit1009->SetParError(1,0.8538974);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.30953);
   Graph_mI30_ppm1009->SetMaximum(73.04187);
   ...
   quadLineFit1010->SetChisquare(2.816943);
   ...
   quadLineFit1010->SetParameter(0,74.45259);
   quadLineFit1010->SetParError(0,0.04960478);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.75727);
   quadLineFit1010->SetParError(1,0.8579848);
   ...
   quadLineFit1011->SetChisquare(2.816943);
   ...
   quadLineFit1011->SetParameter(0,74.45259);
   quadLineFit1011->SetParError(0,0.04960478);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.75727);
   quadLineFit1011->SetParError(1,0.8579848);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.42004);
   Graph_mI50_ppm1011->SetMaximum(72.08458);
   ...
   quadLineFit1012->SetChisquare(0.7218758);
   ...
   quadLineFit1012->SetParameter(0,74.42668);
   quadLineFit1012->SetParError(0,0.1002629);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.89278);
   quadLineFit1012->SetParError(1,1.793609);
   ...
   quadLineFit1013->SetChisquare(0.7218758);
   ...
   quadLineFit1013->SetParameter(0,74.42668);
   quadLineFit1013->SetParError(0,0.1002629);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.89278);
   quadLineFit1013->SetParError(1,1.793609);
