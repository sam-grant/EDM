...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006077569);
   Graph_Graph11015->SetMaximum(0.005756136);
   ...
   Graph_Graph21016->SetMinimum(-0.01146684);
   Graph_Graph21016->SetMaximum(0.01346114);
   ...
   Graph_Graph31017->SetMinimum(-0.01485256);
   Graph_Graph31017->SetMaximum(0.0152905);
   ...
   Graph_Graph41018->SetMinimum(-0.01551139);
   Graph_Graph41018->SetMaximum(0.02133111);
   ...
   Graph_Graph51019->SetMinimum(-0.00692484);
   Graph_Graph51019->SetMaximum(0.009239303);
