...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.33307,50,44.54701);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.14506);
   Graph_Graph01025->SetMaximum(33.35901);
   ...
   mainFit1026->SetChisquare(2.008876);
   ...
   mainFit1026->SetParameter(0,-1.395986);
   mainFit1026->SetParError(0,0.428426);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9026806);
   mainFit1026->SetParError(1,0.01696642);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.67");
   pt_LaTex = pt->AddText("0.903#pm0.017");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.428");
   pt_LaTex = pt->AddText("#minus1.55#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.546489,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.546489,-56.14506,1.546489,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.008876);
   ...
   mainFit1027->SetParameter(0,-1.395986);
   mainFit1027->SetParError(0,0.428426);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9026806);
   mainFit1027->SetParError(1,0.01696642);
