...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.00907);
   Graph_Graph01020->SetMaximum(53.86316);
   ...
   mainFit1021->SetChisquare(2.03452);
   ...
   mainFit1021->SetParameter(0,-1.421312);
   mainFit1021->SetParError(0,0.3980946);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9009678);
   mainFit1021->SetParError(1,0.01321071);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.42#pm0.398");
   pt_LaTex = pt->AddText("#minus1.58#pm0.439");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.57754,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.57754,-58.00907,1.57754,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.03452);
   ...
   mainFit1022->SetParameter(0,-1.421312);
   mainFit1022->SetParError(0,0.3980946);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9009678);
   mainFit1022->SetParError(1,0.01321071);
