...
//=========  (Mon Apr 26 22:14:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.00907);
   Graph_Graph01029->SetMaximum(53.86316);
   ...
   mainFit1030->SetChisquare(0.3769712);
   ...
   mainFit1030->SetParameter(0,-1.640278);
   mainFit1030->SetParError(0,0.4328944);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8996235);
   mainFit1030->SetParError(1,0.01325238);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.126");
   pt_LaTex = pt->AddText("  0.9#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.64#pm0.433");
   pt_LaTex = pt->AddText("#minus1.82#pm0.479");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.823294,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.823294,-58.00907,1.823294,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3769712);
   ...
   mainFit1031->SetParameter(0,-1.640278);
   mainFit1031->SetParError(0,0.4328944);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8996235);
   mainFit1031->SetParError(1,0.01325238);
