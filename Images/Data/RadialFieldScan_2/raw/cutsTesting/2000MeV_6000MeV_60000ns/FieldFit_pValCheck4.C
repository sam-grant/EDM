...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-43.64949);
   Graph_Graph01033->SetMaximum(49.95694);
   ...
   mainFit1034->SetChisquare(1.753371);
   ...
   mainFit1034->SetParameter(0,1.50233);
   mainFit1034->SetParError(0,1.193897);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.728243);
   mainFit1034->SetParError(1,0.03916197);
   ...
   pt_LaTex = pt->AddText("0.728#pm0.0392");
   pt_LaTex = pt->AddText("  1.5#pm 1.19");
   pt_LaTex = pt->AddText(" 2.06#pm 1.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.062952,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.062952,-43.64949,-2.062952,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.753371);
   ...
   mainFit1035->SetParameter(0,1.50233);
   mainFit1035->SetParError(0,1.193897);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.728243);
   mainFit1035->SetParError(1,0.03916197);
