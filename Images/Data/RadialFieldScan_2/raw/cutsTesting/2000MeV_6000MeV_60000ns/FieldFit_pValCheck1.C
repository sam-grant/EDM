...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-43.64949);
   Graph_Graph01027->SetMaximum(49.95694);
   ...
   mainFit1028->SetChisquare(1.988278);
   ...
   mainFit1028->SetParameter(0,1.212097);
   mainFit1028->SetParError(0,1.062656);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7609954);
   mainFit1028->SetParError(1,0.03484942);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.663");
   pt_LaTex = pt->AddText("0.761#pm0.0348");
   pt_LaTex = pt->AddText(" 1.21#pm 1.06");
   pt_LaTex = pt->AddText(" 1.59#pm 1.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.592778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.592778,-43.64949,-1.592778,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.988278);
   ...
   mainFit1029->SetParameter(0,1.212097);
   mainFit1029->SetParError(0,1.062656);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7609954);
   mainFit1029->SetParError(1,0.03484942);
