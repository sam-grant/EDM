...
//=========  (Thu Apr 22 10:42:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.112101);
   ...
   quadLineFit1002->SetParameter(0,75.07368);
   quadLineFit1002->SetParError(0,0.1427868);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.76201);
   quadLineFit1002->SetParError(1,2.394387);
   ...
   quadLineFit1003->SetChisquare(1.112101);
   ...
   quadLineFit1003->SetParameter(0,75.07368);
   quadLineFit1003->SetParError(0,0.1427868);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.76201);
   quadLineFit1003->SetParError(1,2.394387);
   ...
   Graph_30_ppm1003->SetMinimum(76.17643);
   Graph_30_ppm1003->SetMaximum(76.78394);
   ...
   quadLineFit1004->SetChisquare(3.700052);
   ...
   quadLineFit1004->SetParameter(0,75.10392);
   quadLineFit1004->SetParError(0,0.1221023);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.12619);
   quadLineFit1004->SetParError(1,2.007243);
   ...
   quadLineFit1005->SetChisquare(3.700052);
   ...
   quadLineFit1005->SetParameter(0,75.10392);
   quadLineFit1005->SetParError(0,0.1221023);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.12619);
   quadLineFit1005->SetParError(1,2.007243);
   ...
   Graph_10_ppm1005->SetMinimum(75.25952);
   Graph_10_ppm1005->SetMaximum(75.54961);
   ...
   quadLineFit1006->SetChisquare(0.1128141);
   ...
   quadLineFit1006->SetParameter(0,74.86749);
   quadLineFit1006->SetParError(0,0.1431566);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.808452);
   quadLineFit1006->SetParError(1,2.322095);
   ...
   quadLineFit1007->SetChisquare(0.1128141);
   ...
   quadLineFit1007->SetParameter(0,74.86749);
   quadLineFit1007->SetParError(0,0.1431566);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.808452);
   quadLineFit1007->SetParError(1,2.322095);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.28083);
   Graph_mI10_ppm1007->SetMaximum(74.5545);
   ...
   quadLineFit1008->SetChisquare(3.852433);
   ...
   quadLineFit1008->SetParameter(0,74.79069);
   quadLineFit1008->SetParError(0,0.1257453);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.638548);
   quadLineFit1008->SetParError(1,2.046711);
   ...
   quadLineFit1009->SetChisquare(3.852433);
   ...
   quadLineFit1009->SetParameter(0,74.79069);
   quadLineFit1009->SetParError(0,0.1257453);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.638548);
   quadLineFit1009->SetParError(1,2.046711);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.9847);
   Graph_mI30_ppm1009->SetMaximum(73.61134);
   ...
   quadLineFit1010->SetChisquare(0.2698087);
   ...
   quadLineFit1010->SetParameter(0,74.70673);
   quadLineFit1010->SetParError(0,0.1189861);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.94808);
   quadLineFit1010->SetParError(1,2.059255);
   ...
   quadLineFit1011->SetChisquare(0.2698087);
   ...
   quadLineFit1011->SetParameter(0,74.70673);
   quadLineFit1011->SetParError(0,0.1189861);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.94808);
   quadLineFit1011->SetParError(1,2.059255);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.19296);
   Graph_mI50_ppm1011->SetMaximum(72.69961);
   ...
   quadLineFit1012->SetChisquare(0.04703644);
   ...
   quadLineFit1012->SetParameter(0,74.24139);
   quadLineFit1012->SetParError(0,0.2400403);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-31.55431);
   quadLineFit1012->SetParError(1,4.294645);
   ...
   quadLineFit1013->SetChisquare(0.04703644);
   ...
   quadLineFit1013->SetParameter(0,74.24139);
   quadLineFit1013->SetParError(0,0.2400403);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-31.55431);
   quadLineFit1013->SetParError(1,4.294645);
