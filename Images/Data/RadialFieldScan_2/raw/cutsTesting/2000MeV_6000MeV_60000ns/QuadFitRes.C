...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.07932991);
   Graph_Graph11015->SetMaximum(0.03128683);
   ...
   Graph_Graph21016->SetMinimum(-0.008252355);
   Graph_Graph21016->SetMaximum(0.007007961);
   ...
   Graph_Graph31017->SetMinimum(-0.04377419);
   Graph_Graph31017->SetMaximum(0.05490249);
   ...
   Graph_Graph41018->SetMinimum(-0.0125051);
   Graph_Graph41018->SetMaximum(0.008341795);
   ...
   Graph_Graph51019->SetMinimum(-0.005645674);
   Graph_Graph51019->SetMaximum(0.004226619);
