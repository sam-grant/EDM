...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-50.84455,50,39.12904);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-41.84719);
   Graph_Graph01025->SetMaximum(30.13168);
   ...
   mainFit1026->SetChisquare(1.845004);
   ...
   mainFit1026->SetParameter(0,0.5272221);
   mainFit1026->SetParError(0,1.026537);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7274309);
   mainFit1026->SetParError(1,0.0406555);
   ...
   pt_LaTex = pt->AddText("0.727#pm0.0407");
   pt_LaTex = pt->AddText("0.527#pm 1.03");
   pt_LaTex = pt->AddText("0.725#pm 1.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.7247727,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.7247727,-41.84719,-0.7247727,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.845004);
   ...
   mainFit1027->SetParameter(0,0.5272221);
   mainFit1027->SetParError(0,1.026537);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7274309);
   mainFit1027->SetParError(1,0.0406555);
