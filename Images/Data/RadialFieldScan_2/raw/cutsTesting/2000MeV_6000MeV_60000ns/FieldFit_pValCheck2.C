...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-43.64949);
   Graph_Graph01029->SetMaximum(49.95694);
   ...
   mainFit1030->SetChisquare(2.516009);
   ...
   mainFit1030->SetParameter(0,0.7657625);
   mainFit1030->SetParError(0,1.033674);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7489009);
   mainFit1030->SetParError(1,0.03139865);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.839");
   pt_LaTex = pt->AddText("0.749#pm0.0314");
   pt_LaTex = pt->AddText("0.766#pm 1.03");
   pt_LaTex = pt->AddText(" 1.02#pm 1.39");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.022515,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.022515,-43.64949,-1.022515,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.516009);
   ...
   mainFit1031->SetParameter(0,0.7657625);
   mainFit1031->SetParError(0,1.033674);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7489009);
   mainFit1031->SetParError(1,0.03139865);
