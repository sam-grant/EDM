...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-43.64949);
   Graph_Graph01020->SetMaximum(49.95694);
   ...
   mainFit1021->SetChisquare(2.563334);
   ...
   mainFit1021->SetParameter(0,0.8534797);
   mainFit1021->SetParError(0,0.9516289);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7494037);
   mainFit1021->SetParError(1,0.03131812);
   ...
   mainFit1022->SetChisquare(2.563334);
   ...
   mainFit1022->SetParameter(0,0.8534797);
   mainFit1022->SetParError(0,0.9516289);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7494037);
   mainFit1022->SetParError(1,0.03131812);
