...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-55.35029,75,61.65774);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-43.64949);
   Graph_Graph01023->SetMaximum(49.95694);
   ...
   mainFit1024->SetChisquare(2.563334);
   ...
   mainFit1024->SetParameter(0,0.8534797);
   mainFit1024->SetParError(0,0.9516289);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7494037);
   mainFit1024->SetParError(1,0.03131812);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.641");
   pt_LaTex = pt->AddText("0.749#pm0.0313");
   pt_LaTex = pt->AddText("0.853#pm0.952");
   pt_LaTex = pt->AddText(" 1.14#pm 1.28");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.138878,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.138878,-43.64949,-1.138878,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.563334);
   ...
   mainFit1025->SetParameter(0,0.8534797);
   mainFit1025->SetParError(0,0.9516289);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7494037);
   mainFit1025->SetParError(1,0.03131812);
