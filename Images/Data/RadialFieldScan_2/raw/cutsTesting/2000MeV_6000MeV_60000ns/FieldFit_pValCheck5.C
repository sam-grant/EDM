...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-41.79827,70,58.94733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.72371);
   Graph_Graph01035->SetMaximum(48.87277);
   ...
   mainFit1036->SetChisquare(0.805796);
   ...
   mainFit1036->SetParameter(0,0.4514787);
   mainFit1036->SetParError(0,0.9987727);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7681816);
   mainFit1036->SetParError(1,0.03437224);
   ...
   pt_LaTex = pt->AddText("0.768#pm0.0344");
   pt_LaTex = pt->AddText("0.451#pm0.999");
   pt_LaTex = pt->AddText("0.588#pm 1.31");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.5877239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.5877239,-31.72371,-0.5877239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.805796);
   ...
   mainFit1037->SetParameter(0,0.4514787);
   mainFit1037->SetParError(0,0.9987727);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7681816);
   mainFit1037->SetParError(1,0.03437224);
