...
//=========  (Thu Apr 22 10:42:34 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-43.64949);
   Graph_Graph01031->SetMaximum(49.95694);
   ...
   mainFit1032->SetChisquare(2.563333);
   ...
   mainFit1032->SetParameter(0,0.8528569);
   mainFit1032->SetParError(0,1.096332);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7494134);
   mainFit1032->SetParError(1,0.03244018);
   ...
   pt_LaTex = pt->AddText("0.749#pm0.0324");
   pt_LaTex = pt->AddText("0.853#pm  1.1");
   pt_LaTex = pt->AddText(" 1.14#pm 1.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.138033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.138033,-43.64949,-1.138033,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.563333);
   ...
   mainFit1033->SetParameter(0,0.8528569);
   mainFit1033->SetParError(0,1.096332);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7494134);
   mainFit1033->SetParError(1,0.03244018);
