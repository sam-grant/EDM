...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-66.2319);
   Graph_Graph01033->SetMaximum(61.95455);
   ...
   mainFit1034->SetChisquare(6.817006);
   ...
   mainFit1034->SetParameter(0,-1.098318);
   mainFit1034->SetParError(0,0.9701493);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9768618);
   mainFit1034->SetParError(1,0.03202415);
   ...
   pt_LaTex = pt->AddText("0.977#pm0.032");
   pt_LaTex = pt->AddText(" #minus1.1#pm 0.97");
   pt_LaTex = pt->AddText("#minus1.12#pm0.977");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.124333,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.124333,-66.2319,1.124333,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.817006);
   ...
   mainFit1035->SetParameter(0,-1.098318);
   mainFit1035->SetParError(0,0.9701493);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9768618);
   mainFit1035->SetParError(1,0.03202415);
