...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-76.12641,50,47.33385);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-63.78038);
   Graph_Graph01025->SetMaximum(34.98783);
   ...
   mainFit1026->SetChisquare(5.597434);
   ...
   mainFit1026->SetParameter(0,-1.159901);
   mainFit1026->SetParError(0,0.8340221);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9405488);
   mainFit1026->SetParError(1,0.03302601);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.033");
   pt_LaTex = pt->AddText("#minus1.16#pm0.834");
   pt_LaTex = pt->AddText("#minus1.23#pm0.893");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.233217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.233217,-63.78038,1.233217,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.597434);
   ...
   mainFit1027->SetParameter(0,-1.159901);
   mainFit1027->SetParError(0,0.8340221);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9405488);
   mainFit1027->SetParError(1,0.03302601);
