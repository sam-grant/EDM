...
//=========  (Thu Apr 22 00:14:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-82.25521,75,77.97786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-66.2319);
   Graph_Graph01023->SetMaximum(61.95455);
   ...
   mainFit1024->SetChisquare(7.118922);
   ...
   mainFit1024->SetParameter(0,-0.7770296);
   mainFit1024->SetParError(0,0.7741359);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9662941);
   mainFit1024->SetParError(1,0.02560568);
   ...
   pt_LaTex = pt->AddText("0.966#pm0.0256");
   pt_LaTex = pt->AddText("#minus0.777#pm0.774");
   pt_LaTex = pt->AddText("#minus0.804#pm0.798");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8041337,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8041337,-66.2319,0.8041337,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(7.118922);
   ...
   mainFit1025->SetParameter(0,-0.7770296);
   mainFit1025->SetParError(0,0.7741359);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9662941);
   mainFit1025->SetParError(1,0.02560568);
