...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-66.2319);
   Graph_Graph01031->SetMaximum(61.95455);
   ...
   mainFit1032->SetChisquare(7.118877);
   ...
   mainFit1032->SetParameter(0,-0.774058);
   mainFit1032->SetParError(0,0.8915266);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9662483);
   mainFit1032->SetParError(1,0.0264983);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.37");
   pt_LaTex = pt->AddText("0.966#pm0.0265");
   pt_LaTex = pt->AddText("#minus0.774#pm0.892");
   pt_LaTex = pt->AddText("#minus0.801#pm0.917");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8010964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8010964,-66.2319,0.8010964,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.118877);
   ...
   mainFit1033->SetParameter(0,-0.774058);
   mainFit1033->SetParError(0,0.8915266);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9662483);
   mainFit1033->SetParError(1,0.0264983);
