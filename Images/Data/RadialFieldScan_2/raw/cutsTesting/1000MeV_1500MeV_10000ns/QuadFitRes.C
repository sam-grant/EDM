...
//=========  (Thu Apr 22 00:14:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02029794);
   Graph_Graph11015->SetMaximum(0.01596987);
   ...
   Graph_Graph21016->SetMinimum(-0.02646253);
   Graph_Graph21016->SetMaximum(0.03122734);
   ...
   Graph_Graph31017->SetMinimum(-0.01201632);
   Graph_Graph31017->SetMaximum(0.01228571);
   ...
   Graph_Graph41018->SetMinimum(-0.04060231);
   Graph_Graph41018->SetMaximum(0.05529735);
   ...
   Graph_Graph51019->SetMinimum(-0.003139674);
   Graph_Graph51019->SetMaximum(0.004203826);
