...
//=========  (Thu Apr 22 00:14:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-66.2319);
   Graph_Graph01020->SetMaximum(61.95455);
   ...
   mainFit1021->SetChisquare(7.118922);
   ...
   mainFit1021->SetParameter(0,-0.7770296);
   mainFit1021->SetParError(0,0.7741359);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9662941);
   mainFit1021->SetParError(1,0.02560568);
   ...
   mainFit1022->SetChisquare(7.118922);
   ...
   mainFit1022->SetParameter(0,-0.7770296);
   mainFit1022->SetParError(0,0.7741359);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9662941);
   mainFit1022->SetParError(1,0.02560568);
