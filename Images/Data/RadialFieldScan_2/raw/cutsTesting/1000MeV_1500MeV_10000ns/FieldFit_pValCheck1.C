...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-66.2319);
   Graph_Graph01027->SetMaximum(61.95455);
   ...
   mainFit1028->SetChisquare(1.397541);
   ...
   mainFit1028->SetParameter(0,0.1571121);
   mainFit1028->SetParError(0,0.8670673);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9968637);
   mainFit1028->SetParError(1,0.02861794);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.466");
   pt_LaTex = pt->AddText("0.997#pm0.0286");
   pt_LaTex = pt->AddText("0.157#pm0.867");
   pt_LaTex = pt->AddText("0.158#pm0.869");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1576064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1576064,-66.2319,-0.1576064,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.397541);
   ...
   mainFit1029->SetParameter(0,0.1571121);
   mainFit1029->SetParError(0,0.8670673);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9968637);
   mainFit1029->SetParError(1,0.02861794);
