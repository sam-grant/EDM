...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-66.2319);
   Graph_Graph01029->SetMaximum(61.95455);
   ...
   mainFit1030->SetChisquare(4.850977);
   ...
   mainFit1030->SetParameter(0,-1.273986);
   mainFit1030->SetParError(0,0.8415351);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.963333);
   mainFit1030->SetParError(1,0.02568103);
   ...
   pt_LaTex = pt->AddText("0.963#pm0.0257");
   pt_LaTex = pt->AddText("#minus1.27#pm0.842");
   pt_LaTex = pt->AddText("#minus1.32#pm 0.87");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.322478,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.322478,-66.2319,1.322478,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.850977);
   ...
   mainFit1031->SetParameter(0,-1.273986);
   mainFit1031->SetParError(0,0.8415351);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.963333);
   mainFit1031->SetParError(1,0.02568103);
