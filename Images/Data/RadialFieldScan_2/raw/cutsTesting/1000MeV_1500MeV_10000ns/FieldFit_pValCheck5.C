...
//=========  (Thu Apr 22 00:14:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-51.2978,70,71.78638);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.98938);
   Graph_Graph01035->SetMaximum(59.47796);
   ...
   mainFit1036->SetChisquare(6.199606);
   ...
   mainFit1036->SetParameter(0,-0.5424655);
   mainFit1036->SetParError(0,0.8118717);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9551679);
   mainFit1036->SetParError(1,0.02811243);
   ...
   pt_LaTex = pt->AddText("0.955#pm0.0281");
   pt_LaTex = pt->AddText("#minus0.542#pm0.812");
   pt_LaTex = pt->AddText("#minus0.568#pm0.846");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.5679269,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5679269,-38.98938,0.5679269,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.199606);
   ...
   mainFit1037->SetParameter(0,-0.5424655);
   mainFit1037->SetParError(0,0.8118717);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9551679);
   mainFit1037->SetParError(1,0.02811243);
