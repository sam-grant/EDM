...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-69.68199,75,68.99381);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.81441);
   Graph_Graph01027->SetMaximum(55.12623);
   ...
   mainFit1028->SetChisquare(0.8838101);
   ...
   mainFit1028->SetParameter(0,-0.5488521);
   mainFit1028->SetParError(0,0.460401);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8988);
   mainFit1028->SetParError(1,0.01507903);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.295");
   pt_LaTex = pt->AddText("0.899#pm0.0151");
   pt_LaTex = pt->AddText("#minus0.549#pm 0.46");
   pt_LaTex = pt->AddText("#minus0.611#pm0.513");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6106499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6106499,-55.81441,0.6106499,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8838101);
   ...
   mainFit1029->SetParameter(0,-0.5488521);
   mainFit1029->SetParError(0,0.460401);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8988);
   mainFit1029->SetParError(1,0.01507903);
