...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.81441);
   Graph_Graph01033->SetMaximum(55.12623);
   ...
   mainFit1034->SetChisquare(7.800945);
   ...
   mainFit1034->SetParameter(0,-1.22908);
   mainFit1034->SetParError(0,0.5180376);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8856443);
   mainFit1034->SetParError(1,0.01697032);
   ...
   pt_LaTex = pt->AddText("0.886#pm0.017");
   pt_LaTex = pt->AddText("#minus1.23#pm0.518");
   pt_LaTex = pt->AddText("#minus1.39#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.387781,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.387781,-55.81441,1.387781,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.800945);
   ...
   mainFit1035->SetParameter(0,-1.22908);
   mainFit1035->SetParError(0,0.5180376);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8856443);
   mainFit1035->SetParError(1,0.01697032);
