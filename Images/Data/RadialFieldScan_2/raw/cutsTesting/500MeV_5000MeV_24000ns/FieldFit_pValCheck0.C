...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.30344,50,42.10104);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.66299);
   Graph_Graph01025->SetMaximum(31.46059);
   ...
   mainFit1026->SetChisquare(1.40017);
   ...
   mainFit1026->SetParameter(0,-1.524068);
   mainFit1026->SetParError(0,0.4453253);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8523075);
   mainFit1026->SetParError(1,0.01763441);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.467");
   pt_LaTex = pt->AddText("0.852#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.52#pm0.445");
   pt_LaTex = pt->AddText("#minus1.79#pm0.528");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.788167,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.788167,-53.66299,1.788167,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.40017);
   ...
   mainFit1027->SetParameter(0,-1.524068);
   mainFit1027->SetParError(0,0.4453253);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8523075);
   mainFit1027->SetParError(1,0.01763441);
