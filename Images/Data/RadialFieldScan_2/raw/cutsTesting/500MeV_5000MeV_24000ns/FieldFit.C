...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.81441);
   Graph_Graph01020->SetMaximum(55.12623);
   ...
   mainFit1021->SetChisquare(7.987805);
   ...
   mainFit1021->SetParameter(0,-1.093639);
   mainFit1021->SetParError(0,0.4125419);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.881235);
   mainFit1021->SetParError(1,0.01356268);
   ...
   mainFit1022->SetChisquare(7.987805);
   ...
   mainFit1022->SetParameter(0,-1.093639);
   mainFit1022->SetParError(0,0.4125419);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.881235);
   mainFit1022->SetParError(1,0.01356268);
