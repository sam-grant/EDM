...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.81441);
   Graph_Graph01023->SetMaximum(55.12623);
   ...
   mainFit1024->SetChisquare(7.987805);
   ...
   mainFit1024->SetParameter(0,-1.093639);
   mainFit1024->SetParError(0,0.4125419);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.881235);
   mainFit1024->SetParError(1,0.01356268);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("    2");
   pt_LaTex = pt->AddText("0.881#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.09#pm0.413");
   pt_LaTex = pt->AddText("#minus1.24#pm0.465");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.241029,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.241029,-55.81441,1.241029,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(7.987805);
   ...
   mainFit1025->SetParameter(0,-1.093639);
   mainFit1025->SetParError(0,0.4125419);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.881235);
   mainFit1025->SetParError(1,0.01356268);
