...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.81441);
   Graph_Graph01031->SetMaximum(55.12623);
   ...
   mainFit1032->SetChisquare(7.987797);
   ...
   mainFit1032->SetParameter(0,-1.092973);
   mainFit1032->SetParError(0,0.4751523);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8812246);
   mainFit1032->SetParError(1,0.01404756);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.66");
   pt_LaTex = pt->AddText("0.881#pm0.014");
   pt_LaTex = pt->AddText("#minus1.09#pm0.475");
   pt_LaTex = pt->AddText("#minus1.24#pm0.534");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.240288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.240288,-55.81441,1.240288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.987797);
   ...
   mainFit1033->SetParameter(0,-1.092973);
   mainFit1033->SetParError(0,0.4751523);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8812246);
   mainFit1033->SetParError(1,0.01404756);
