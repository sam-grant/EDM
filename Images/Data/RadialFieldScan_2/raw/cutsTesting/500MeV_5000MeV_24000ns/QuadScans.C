...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4197915);
   ...
   quadLineFit1002->SetParameter(0,74.555);
   quadLineFit1002->SetParError(0,0.06170659);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.84643);
   quadLineFit1002->SetParError(1,1.034743);
   ...
   quadLineFit1003->SetChisquare(0.4197915);
   ...
   quadLineFit1003->SetParameter(0,74.555);
   quadLineFit1003->SetParError(0,0.06170659);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.84643);
   quadLineFit1003->SetParError(1,1.034743);
   ...
   Graph_30_ppm1003->SetMinimum(75.82131);
   Graph_30_ppm1003->SetMaximum(76.41411);
   ...
   quadLineFit1004->SetChisquare(0.6692027);
   ...
   quadLineFit1004->SetParameter(0,74.67304);
   quadLineFit1004->SetParError(0,0.05302091);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.49548);
   quadLineFit1004->SetParError(1,0.8714821);
   ...
   quadLineFit1005->SetChisquare(0.6692027);
   ...
   quadLineFit1005->SetParameter(0,74.67304);
   quadLineFit1005->SetParError(0,0.05302091);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.49548);
   quadLineFit1005->SetParError(1,0.8714821);
   ...
   Graph_10_ppm1005->SetMinimum(74.85171);
   Graph_10_ppm1005->SetMaximum(75.08547);
   ...
   quadLineFit1006->SetChisquare(2.896673);
   ...
   quadLineFit1006->SetParameter(0,74.46879);
   quadLineFit1006->SetParError(0,0.06213207);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.929133);
   quadLineFit1006->SetParError(1,1.007699);
   ...
   quadLineFit1007->SetChisquare(2.896673);
   ...
   quadLineFit1007->SetParameter(0,74.46879);
   quadLineFit1007->SetParError(0,0.06213207);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.929133);
   quadLineFit1007->SetParError(1,1.007699);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.64661);
   Graph_mI10_ppm1007->SetMaximum(73.95029);
   ...
   quadLineFit1008->SetChisquare(10.73593);
   ...
   quadLineFit1008->SetParameter(0,74.39635);
   quadLineFit1008->SetParError(0,0.05455232);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.908141);
   quadLineFit1008->SetParError(1,0.8879617);
   ...
   quadLineFit1009->SetChisquare(10.73593);
   ...
   quadLineFit1009->SetParameter(0,74.39635);
   quadLineFit1009->SetParError(0,0.05455232);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.908141);
   quadLineFit1009->SetParError(1,0.8879617);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.28704);
   Graph_mI30_ppm1009->SetMaximum(72.9752);
   ...
   quadLineFit1010->SetChisquare(2.117778);
   ...
   quadLineFit1010->SetParameter(0,74.31333);
   quadLineFit1010->SetParError(0,0.05151076);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.2566);
   quadLineFit1010->SetParError(1,0.8914814);
   ...
   quadLineFit1011->SetChisquare(2.117778);
   ...
   quadLineFit1011->SetParameter(0,74.31333);
   quadLineFit1011->SetParError(0,0.05151076);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.2566);
   quadLineFit1011->SetParError(1,0.8914814);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.3632);
   Graph_mI50_ppm1011->SetMaximum(71.99972);
   ...
   quadLineFit1012->SetChisquare(0.592957);
   ...
   quadLineFit1012->SetParameter(0,74.23118);
   quadLineFit1012->SetParError(0,0.1041568);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.70568);
   quadLineFit1012->SetParError(1,1.863679);
   ...
   quadLineFit1013->SetChisquare(0.592957);
   ...
   quadLineFit1013->SetParameter(0,74.23118);
   quadLineFit1013->SetParError(0,0.1041568);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.70568);
   quadLineFit1013->SetParError(1,1.863679);
