...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008766875);
   Graph_Graph11015->SetMaximum(0.008846945);
   ...
   Graph_Graph21016->SetMinimum(-0.01538892);
   Graph_Graph21016->SetMaximum(0.01812471);
   ...
   Graph_Graph31017->SetMinimum(-0.03840752);
   Graph_Graph31017->SetMaximum(0.02713871);
   ...
   Graph_Graph41018->SetMinimum(-0.009822894);
   Graph_Graph41018->SetMaximum(0.01668541);
   ...
   Graph_Graph51019->SetMinimum(-0.006503207);
   Graph_Graph51019->SetMaximum(0.008692251);
