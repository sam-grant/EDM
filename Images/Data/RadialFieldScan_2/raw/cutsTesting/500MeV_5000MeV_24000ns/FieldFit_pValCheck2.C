...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.81441);
   Graph_Graph01029->SetMaximum(55.12623);
   ...
   mainFit1030->SetChisquare(7.935459);
   ...
   mainFit1030->SetParameter(0,-1.133609);
   mainFit1030->SetParError(0,0.4480186);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8810115);
   mainFit1030->SetParError(1,0.01359718);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.65");
   pt_LaTex = pt->AddText("0.881#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.13#pm0.448");
   pt_LaTex = pt->AddText("#minus1.29#pm0.506");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.286713,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.286713,-55.81441,1.286713,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.935459);
   ...
   mainFit1031->SetParameter(0,-1.133609);
   mainFit1031->SetParError(0,0.4480186);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8810115);
   mainFit1031->SetParError(1,0.01359718);
