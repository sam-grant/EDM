...
//=========  (Thu Apr 22 14:51:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.65539,70,64.38849);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.551);
   Graph_Graph01035->SetMaximum(53.2841);
   ...
   mainFit1036->SetChisquare(7.91422);
   ...
   mainFit1036->SetParameter(0,-1.129253);
   mainFit1036->SetParError(0,0.4329295);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8828953);
   mainFit1036->SetParError(1,0.01487974);
   ...
   pt_LaTex = pt->AddText("0.883#pm0.0149");
   pt_LaTex = pt->AddText("#minus1.13#pm0.433");
   pt_LaTex = pt->AddText("#minus1.28#pm0.485");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.279034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.279034,-35.551,1.279034,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.91422);
   ...
   mainFit1037->SetParameter(0,-1.129253);
   mainFit1037->SetParError(0,0.4329295);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8828953);
   mainFit1037->SetParError(1,0.01487974);
