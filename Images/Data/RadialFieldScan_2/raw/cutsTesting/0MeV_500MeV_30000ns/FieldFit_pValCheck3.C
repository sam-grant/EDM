...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-75.48919);
   Graph_Graph01031->SetMaximum(60.24656);
   ...
   mainFit1032->SetChisquare(2.334295);
   ...
   mainFit1032->SetParameter(0,-3.501613);
   mainFit1032->SetParError(0,1.069612);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,1.037183);
   mainFit1032->SetParError(1,0.03185176);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.778");
   pt_LaTex = pt->AddText(" 1.04#pm0.0319");
   pt_LaTex = pt->AddText(" #minus3.5#pm 1.07");
   pt_LaTex = pt->AddText("#minus3.38#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.376079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.376079,-75.48919,3.376079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.334295);
   ...
   mainFit1033->SetParameter(0,-3.501613);
   mainFit1033->SetParError(0,1.069612);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,1.037183);
   mainFit1033->SetParError(1,0.03185176);
