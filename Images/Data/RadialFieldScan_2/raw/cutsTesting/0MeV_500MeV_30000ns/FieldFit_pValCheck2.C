...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-75.48919);
   Graph_Graph01029->SetMaximum(60.24656);
   ...
   mainFit1030->SetChisquare(2.240499);
   ...
   mainFit1030->SetParameter(0,-4.149981);
   mainFit1030->SetParError(0,1.01049);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,1.040787);
   mainFit1030->SetParError(1,0.0309087);
   ...
   pt_LaTex = pt->AddText(" 1.04#pm0.0309");
   pt_LaTex = pt->AddText("#minus4.15#pm 1.01");
   pt_LaTex = pt->AddText("#minus3.99#pm0.965");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.98735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.98735,-75.48919,3.98735,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.240499);
   ...
   mainFit1031->SetParameter(0,-4.149981);
   mainFit1031->SetParError(0,1.01049);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,1.040787);
   mainFit1031->SetParError(1,0.0309087);
