...
//=========  (Wed Apr 21 23:46:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-75.48919);
   Graph_Graph01020->SetMaximum(60.24656);
   ...
   mainFit1021->SetChisquare(2.785962);
   ...
   mainFit1021->SetParameter(0,-3.85727);
   mainFit1021->SetParError(0,0.9295233);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,1.042614);
   mainFit1021->SetParError(1,0.03080946);
   ...
   mainFit1022->SetChisquare(2.785962);
   ...
   mainFit1022->SetParameter(0,-3.85727);
   mainFit1022->SetParError(0,0.9295233);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,1.042614);
   mainFit1022->SetParError(1,0.03080946);
