...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-57.15455,70,70.15321);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-44.42377);
   Graph_Graph01035->SetMaximum(57.42243);
   ...
   mainFit1036->SetChisquare(1.617622);
   ...
   mainFit1036->SetParameter(0,-3.542055);
   mainFit1036->SetParError(0,0.9741959);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,1.027522);
   mainFit1036->SetParError(1,0.03382592);
   ...
   pt_LaTex = pt->AddText(" 1.03#pm0.0338");
   pt_LaTex = pt->AddText("#minus3.54#pm0.974");
   pt_LaTex = pt->AddText("#minus3.45#pm0.926");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,3.447183,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.447183,-44.42377,3.447183,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.617622);
   ...
   mainFit1037->SetParameter(0,-3.542055);
   mainFit1037->SetParError(0,0.9741959);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,1.027522);
   mainFit1037->SetParError(1,0.03382592);
