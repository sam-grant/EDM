...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-87.78401,50,53.85277);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-73.62033);
   Graph_Graph01025->SetMaximum(39.68909);
   ...
   mainFit1026->SetChisquare(1.768437);
   ...
   mainFit1026->SetParameter(0,-3.480861);
   mainFit1026->SetParError(0,1.001627);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.067741);
   mainFit1026->SetParError(1,0.03961934);
   ...
   pt_LaTex = pt->AddText(" 1.07#pm0.0396");
   pt_LaTex = pt->AddText("#minus3.48#pm    1");
   pt_LaTex = pt->AddText("#minus3.26#pm0.961");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.260023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.260023,-73.62033,3.260023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.768437);
   ...
   mainFit1027->SetParameter(0,-3.480861);
   mainFit1027->SetParError(0,1.001627);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.067741);
   mainFit1027->SetParError(1,0.03961934);
