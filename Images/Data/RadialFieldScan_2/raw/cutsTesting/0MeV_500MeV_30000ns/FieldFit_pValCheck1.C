...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-75.48919);
   Graph_Graph01027->SetMaximum(60.24656);
   ...
   mainFit1028->SetChisquare(2.47598);
   ...
   mainFit1028->SetParameter(0,-4.120853);
   mainFit1028->SetParError(0,1.043073);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,1.033936);
   mainFit1028->SetParError(1,0.03451878);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.825");
   pt_LaTex = pt->AddText(" 1.03#pm0.0345");
   pt_LaTex = pt->AddText("#minus4.12#pm 1.04");
   pt_LaTex = pt->AddText("#minus3.99#pm 1.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.985599,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.985599,-75.48919,3.985599,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.47598);
   ...
   mainFit1029->SetParameter(0,-4.120853);
   mainFit1029->SetParError(0,1.043073);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,1.033936);
   mainFit1029->SetParError(1,0.03451878);
