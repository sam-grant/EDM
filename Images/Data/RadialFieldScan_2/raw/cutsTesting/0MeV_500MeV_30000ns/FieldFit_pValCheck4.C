...
//=========  (Wed Apr 21 23:46:48 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-92.45616,75,77.21353);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-75.48919);
   Graph_Graph01033->SetMaximum(60.24656);
   ...
   mainFit1034->SetChisquare(2.073149);
   ...
   mainFit1034->SetParameter(0,-4.450605);
   mainFit1034->SetParError(0,1.165289);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,1.062199);
   mainFit1034->SetParError(1,0.03856582);
   ...
   pt_LaTex = pt->AddText(" 1.06#pm0.0386");
   pt_LaTex = pt->AddText("#minus4.45#pm 1.17");
   pt_LaTex = pt->AddText("#minus4.19#pm 1.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,4.189991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(4.189991,-75.48919,4.189991,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.073149);
   ...
   mainFit1035->SetParameter(0,-4.450605);
   mainFit1035->SetParError(0,1.165289);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,1.062199);
   mainFit1035->SetParError(1,0.03856582);
