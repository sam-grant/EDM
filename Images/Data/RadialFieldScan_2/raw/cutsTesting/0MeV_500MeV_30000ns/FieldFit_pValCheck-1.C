...
//=========  (Wed Apr 21 23:46:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-75.48919);
   Graph_Graph01023->SetMaximum(60.24656);
   ...
   mainFit1024->SetChisquare(2.785962);
   ...
   mainFit1024->SetParameter(0,-3.85727);
   mainFit1024->SetParError(0,0.9295233);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,1.042614);
   mainFit1024->SetParError(1,0.03080946);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.696");
   pt_LaTex = pt->AddText(" 1.04#pm0.0308");
   pt_LaTex = pt->AddText("#minus3.86#pm 0.93");
   pt_LaTex = pt->AddText(" #minus3.7#pm0.881");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.699613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.699613,-75.48919,3.699613,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.785962);
   ...
   mainFit1025->SetParameter(0,-3.85727);
   mainFit1025->SetParError(0,0.9295233);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,1.042614);
   mainFit1025->SetParError(1,0.03080946);
