...
//=========  (Wed Apr 21 23:46:47 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.43693);
   ...
   quadLineFit1002->SetParameter(0,74.2136);
   quadLineFit1002->SetParError(0,0.1435494);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.52842);
   quadLineFit1002->SetParError(1,2.406826);
   ...
   quadLineFit1003->SetChisquare(1.43693);
   ...
   quadLineFit1003->SetParameter(0,74.2136);
   quadLineFit1003->SetParError(0,0.1435494);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.52842);
   quadLineFit1003->SetParError(1,2.406826);
   ...
   Graph_30_ppm1003->SetMinimum(75.46983);
   Graph_30_ppm1003->SetMaximum(76.23133);
   ...
   quadLineFit1004->SetChisquare(0.07980645);
   ...
   quadLineFit1004->SetParameter(0,74.1217);
   quadLineFit1004->SetParError(0,0.1196057);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,28.28338);
   quadLineFit1004->SetParError(1,1.963259);
   ...
   quadLineFit1005->SetChisquare(0.07980645);
   ...
   quadLineFit1005->SetParameter(0,74.1217);
   quadLineFit1005->SetParError(0,0.1196057);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,28.28338);
   quadLineFit1005->SetParError(1,1.963259);
   ...
   Graph_10_ppm1005->SetMinimum(74.42683);
   Graph_10_ppm1005->SetMaximum(74.6943);
   ...
   quadLineFit1006->SetChisquare(0.5746854);
   ...
   quadLineFit1006->SetParameter(0,74.07411);
   quadLineFit1006->SetParError(0,0.1401424);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.097526);
   quadLineFit1006->SetParError(1,2.270587);
   ...
   quadLineFit1007->SetChisquare(0.5746854);
   ...
   quadLineFit1007->SetParameter(0,74.07411);
   quadLineFit1007->SetParError(0,0.1401424);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.097526);
   quadLineFit1007->SetParError(1,2.270587);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.0737);
   Graph_mI10_ppm1007->SetMaximum(73.49419);
   ...
   quadLineFit1008->SetChisquare(1.527447);
   ...
   quadLineFit1008->SetParameter(0,74.24016);
   quadLineFit1008->SetParError(0,0.122809);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-15.43616);
   quadLineFit1008->SetParError(1,1.99709);
   ...
   quadLineFit1009->SetChisquare(1.527447);
   ...
   quadLineFit1009->SetParameter(0,74.24016);
   quadLineFit1009->SetParError(0,0.122809);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-15.43616);
   quadLineFit1009->SetParError(1,1.99709);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.64082);
   Graph_mI30_ppm1009->SetMaximum(72.52095);
   ...
   quadLineFit1010->SetChisquare(0.711675);
   ...
   quadLineFit1010->SetParameter(0,74.15984);
   quadLineFit1010->SetParError(0,0.1154232);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-33.94023);
   quadLineFit1010->SetParError(1,1.996364);
   ...
   quadLineFit1011->SetChisquare(0.711675);
   ...
   quadLineFit1011->SetParameter(0,74.15984);
   quadLineFit1011->SetParError(0,0.1154232);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-33.94023);
   quadLineFit1011->SetParError(1,1.996364);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.66979);
   Graph_mI50_ppm1011->SetMaximum(71.55721);
   ...
   quadLineFit1012->SetChisquare(0.0603787);
   ...
   quadLineFit1012->SetParameter(0,74.52649);
   quadLineFit1012->SetParError(0,0.233511);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-60.00024);
   quadLineFit1012->SetParError(1,4.177638);
   ...
   quadLineFit1013->SetChisquare(0.0603787);
   ...
   quadLineFit1013->SetParameter(0,74.52649);
   quadLineFit1013->SetParError(0,0.233511);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-60.00024);
   quadLineFit1013->SetParError(1,4.177638);
