...
//=========  (Wed Apr 21 23:46:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006976886);
   Graph_Graph11015->SetMaximum(0.008049041);
   ...
   Graph_Graph21016->SetMinimum(-0.0179663);
   Graph_Graph21016->SetMaximum(0.01548106);
   ...
   Graph_Graph31017->SetMinimum(-0.02874248);
   Graph_Graph31017->SetMaximum(0.03420678);
   ...
   Graph_Graph41018->SetMinimum(-0.02868381);
   Graph_Graph41018->SetMaximum(0.01857681);
   ...
   Graph_Graph51019->SetMinimum(-0.006210391);
   Graph_Graph51019->SetMaximum(0.004665486);
