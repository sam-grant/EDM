...
//=========  (Fri Apr 23 21:38:38 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9469059);
   ...
   quadLineFit1002->SetParameter(0,75.50854);
   quadLineFit1002->SetParError(0,0.2948843);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.28055);
   quadLineFit1002->SetParError(1,4.944745);
   ...
   quadLineFit1003->SetChisquare(0.9469059);
   ...
   quadLineFit1003->SetParameter(0,75.50854);
   quadLineFit1003->SetParError(0,0.2948843);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.28055);
   quadLineFit1003->SetParError(1,4.944745);
   ...
   Graph_30_ppm1003->SetMinimum(76.43411);
   Graph_30_ppm1003->SetMaximum(77.04961);
   ...
   quadLineFit1004->SetChisquare(0.09520205);
   ...
   quadLineFit1004->SetParameter(0,75.53277);
   quadLineFit1004->SetParError(0,0.2474132);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,19.69189);
   quadLineFit1004->SetParError(1,4.066535);
   ...
   quadLineFit1005->SetChisquare(0.09520205);
   ...
   quadLineFit1005->SetParameter(0,75.53277);
   quadLineFit1005->SetParError(0,0.2474132);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,19.69189);
   quadLineFit1005->SetParError(1,4.066535);
   ...
   Graph_10_ppm1005->SetMinimum(75.60088);
   Graph_10_ppm1005->SetMaximum(75.91588);
   ...
   quadLineFit1006->SetChisquare(1.844877);
   ...
   quadLineFit1006->SetParameter(0,75.46432);
   quadLineFit1006->SetParError(0,0.2906286);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,4.140551);
   quadLineFit1006->SetParError(1,4.712538);
   ...
   quadLineFit1007->SetChisquare(1.844877);
   ...
   quadLineFit1007->SetParameter(0,75.46432);
   quadLineFit1007->SetParError(0,0.2906286);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,4.140551);
   quadLineFit1007->SetParError(1,4.712538);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.52557);
   Graph_mI10_ppm1007->SetMaximum(74.94683);
   ...
   quadLineFit1008->SetChisquare(1.584287);
   ...
   quadLineFit1008->SetParameter(0,75.26648);
   quadLineFit1008->SetParError(0,0.2556086);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.865419);
   quadLineFit1008->SetParError(1,4.160629);
   ...
   quadLineFit1009->SetChisquare(1.584287);
   ...
   quadLineFit1009->SetParameter(0,75.26648);
   quadLineFit1009->SetParError(0,0.2556086);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.865419);
   quadLineFit1009->SetParError(1,4.160629);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.26357);
   Graph_mI30_ppm1009->SetMaximum(73.98523);
   ...
   quadLineFit1010->SetChisquare(0.7858514);
   ...
   quadLineFit1010->SetParameter(0,75.16072);
   quadLineFit1010->SetParError(0,0.241211);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.02433);
   quadLineFit1010->SetParError(1,4.17417);
   ...
   quadLineFit1011->SetChisquare(0.7858514);
   ...
   quadLineFit1011->SetParameter(0,75.16072);
   quadLineFit1011->SetParError(0,0.241211);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.02433);
   quadLineFit1011->SetParError(1,4.17417);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.38608);
   Graph_mI50_ppm1011->SetMaximum(73.11362);
   ...
   quadLineFit1012->SetChisquare(0.1030778);
   ...
   quadLineFit1012->SetParameter(0,75.1175);
   quadLineFit1012->SetParError(0,0.487261);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.67387);
   quadLineFit1012->SetParError(1,8.717757);
   ...
   quadLineFit1013->SetChisquare(0.1030778);
   ...
   quadLineFit1013->SetParameter(0,75.1175);
   quadLineFit1013->SetParError(0,0.487261);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.67387);
   quadLineFit1013->SetParError(1,8.717757);
