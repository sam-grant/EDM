...
//=========  (Fri Apr 23 21:38:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.75332);
   Graph_Graph01020->SetMaximum(52.58698);
   ...
   mainFit1021->SetChisquare(0.4078416);
   ...
   mainFit1021->SetParameter(0,-2.180835);
   mainFit1021->SetParError(0,1.933655);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7731343);
   mainFit1021->SetParError(1,0.0639077);
   ...
   mainFit1022->SetChisquare(0.4078416);
   ...
   mainFit1022->SetParameter(0,-2.180835);
   mainFit1022->SetParError(0,1.933655);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7731343);
   mainFit1022->SetParError(1,0.0639077);
