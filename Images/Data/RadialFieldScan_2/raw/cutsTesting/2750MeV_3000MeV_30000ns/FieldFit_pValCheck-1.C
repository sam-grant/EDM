...
//=========  (Fri Apr 23 21:38:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.79586,75,66.62952);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-59.75332);
   Graph_Graph01023->SetMaximum(52.58698);
   ...
   mainFit1024->SetChisquare(0.4078416);
   ...
   mainFit1024->SetParameter(0,-2.180835);
   mainFit1024->SetParError(0,1.933655);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7731343);
   mainFit1024->SetParError(1,0.0639077);
   ...
   pt_LaTex = pt->AddText("0.773#pm0.0639");
   pt_LaTex = pt->AddText("#minus2.18#pm 1.93");
   pt_LaTex = pt->AddText("#minus2.82#pm 2.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.820772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.820772,-59.75332,2.820772,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(0.4078416);
   ...
   mainFit1025->SetParameter(0,-2.180835);
   mainFit1025->SetParError(0,1.933655);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7731343);
   mainFit1025->SetParError(1,0.0639077);
