...
//=========  (Fri Apr 23 21:38:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.75332);
   Graph_Graph01031->SetMaximum(52.58698);
   ...
   mainFit1032->SetChisquare(0.3219764);
   ...
   mainFit1032->SetParameter(0,-2.504031);
   mainFit1032->SetParError(0,2.226093);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7781353);
   mainFit1032->SetParError(1,0.06614548);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.107");
   pt_LaTex = pt->AddText("0.778#pm0.0661");
   pt_LaTex = pt->AddText(" #minus2.5#pm 2.23");
   pt_LaTex = pt->AddText("#minus3.22#pm  2.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.217989,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.217989,-59.75332,3.217989,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.3219764);
   ...
   mainFit1033->SetParameter(0,-2.504031);
   mainFit1033->SetParError(0,2.226093);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7781353);
   mainFit1033->SetParError(1,0.06614548);
