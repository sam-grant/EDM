...
//=========  (Fri Apr 23 21:38:39 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.30445,70,61.33124);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.44088);
   Graph_Graph01035->SetMaximum(50.46767);
   ...
   mainFit1036->SetChisquare(0.3961952);
   ...
   mainFit1036->SetParameter(0,-2.114767);
   mainFit1036->SetParError(0,2.028268);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7700123);
   mainFit1036->SetParError(1,0.07015855);
   ...
   pt_LaTex = pt->AddText(" 0.77#pm0.0702");
   pt_LaTex = pt->AddText("#minus2.11#pm 2.03");
   pt_LaTex = pt->AddText("#minus2.75#pm 2.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.746407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.746407,-36.44088,2.746407,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.3961952);
   ...
   mainFit1037->SetParameter(0,-2.114767);
   mainFit1037->SetParError(0,2.028268);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7700123);
   mainFit1037->SetParError(1,0.07015855);
