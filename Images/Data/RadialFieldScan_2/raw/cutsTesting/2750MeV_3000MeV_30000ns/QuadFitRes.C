...
//=========  (Fri Apr 23 21:38:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01487647);
   Graph_Graph11015->SetMaximum(0.01453908);
   ...
   Graph_Graph21016->SetMinimum(-0.05738062);
   Graph_Graph21016->SetMaximum(0.06754795);
   ...
   Graph_Graph31017->SetMinimum(-0.06542657);
   Graph_Graph31017->SetMaximum(0.05887627);
   ...
   Graph_Graph41018->SetMinimum(-0.06706365);
   Graph_Graph41018->SetMaximum(0.03439029);
   ...
   Graph_Graph51019->SetMinimum(-0.0170141);
   Graph_Graph51019->SetMaximum(0.01268217);
