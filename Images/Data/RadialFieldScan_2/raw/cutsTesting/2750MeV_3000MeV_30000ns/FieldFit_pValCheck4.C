...
//=========  (Fri Apr 23 21:38:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.75332);
   Graph_Graph01033->SetMaximum(52.58698);
   ...
   mainFit1034->SetChisquare(0.393878);
   ...
   mainFit1034->SetParameter(0,-2.353774);
   mainFit1034->SetParError(0,2.425023);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7788168);
   mainFit1034->SetParError(1,0.07996906);
   ...
   pt_LaTex = pt->AddText("0.779#pm 0.08");
   pt_LaTex = pt->AddText("#minus2.35#pm 2.43");
   pt_LaTex = pt->AddText("#minus3.02#pm 2.98");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.022243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.022243,-59.75332,3.022243,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.393878);
   ...
   mainFit1035->SetParameter(0,-2.353774);
   mainFit1035->SetParError(0,2.425023);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7788168);
   mainFit1035->SetParError(1,0.07996906);
