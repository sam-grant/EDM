...
//=========  (Fri Apr 23 21:38:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.75332);
   Graph_Graph01029->SetMaximum(52.58698);
   ...
   mainFit1030->SetChisquare(0.3001632);
   ...
   mainFit1030->SetParameter(0,-1.910644);
   mainFit1030->SetParError(0,2.101671);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7747203);
   mainFit1030->SetParError(1,0.06408975);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.1");
   pt_LaTex = pt->AddText("0.775#pm0.0641");
   pt_LaTex = pt->AddText("#minus1.91#pm  2.1");
   pt_LaTex = pt->AddText("#minus2.47#pm  2.7");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.466238,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.466238,-59.75332,2.466238,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.3001632);
   ...
   mainFit1031->SetParameter(0,-1.910644);
   mainFit1031->SetParError(0,2.101671);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7747203);
   mainFit1031->SetParError(1,0.06408975);
