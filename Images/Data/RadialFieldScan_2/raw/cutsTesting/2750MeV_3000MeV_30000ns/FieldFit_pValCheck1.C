...
//=========  (Fri Apr 23 21:38:39 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.75332);
   Graph_Graph01027->SetMaximum(52.58698);
   ...
   mainFit1028->SetChisquare(0.2387861);
   ...
   mainFit1028->SetParameter(0,-1.779622);
   mainFit1028->SetParError(0,2.165931);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7862396);
   mainFit1028->SetParError(1,0.07141418);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0796");
   pt_LaTex = pt->AddText("0.786#pm0.0714");
   pt_LaTex = pt->AddText("#minus1.78#pm 2.17");
   pt_LaTex = pt->AddText("#minus2.26#pm 2.78");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.26346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.26346,-59.75332,2.26346,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2387861);
   ...
   mainFit1029->SetParameter(0,-1.779622);
   mainFit1029->SetParError(0,2.165931);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7862396);
   mainFit1029->SetParError(1,0.07141418);
