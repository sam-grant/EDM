...
//=========  (Fri Apr 23 21:38:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.92914,50,42.29594);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.80663);
   Graph_Graph01025->SetMaximum(31.17343);
   ...
   mainFit1026->SetChisquare(0.1475537);
   ...
   mainFit1026->SetParameter(0,-2.57519);
   mainFit1026->SetParError(0,2.082422);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7465807);
   mainFit1026->SetParError(1,0.08242276);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0492");
   pt_LaTex = pt->AddText("0.747#pm0.0824");
   pt_LaTex = pt->AddText("#minus2.58#pm 2.08");
   pt_LaTex = pt->AddText("#minus3.45#pm 2.86");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,3.449312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.449312,-57.80663,3.449312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.1475537);
   ...
   mainFit1027->SetParameter(0,-2.57519);
   mainFit1027->SetParError(0,2.082422);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7465807);
   mainFit1027->SetParError(1,0.08242276);
