...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.23321);
   Graph_Graph01029->SetMaximum(56.43018);
   ...
   mainFit1030->SetChisquare(1.316398);
   ...
   mainFit1030->SetParameter(0,-1.789676);
   mainFit1030->SetParError(0,0.38225);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9407138);
   mainFit1030->SetParError(1,0.01165863);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0117");
   pt_LaTex = pt->AddText("#minus1.79#pm0.382");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.404");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.902466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.902466,-59.23321,1.902466,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.316398);
   ...
   mainFit1031->SetParameter(0,-1.789676);
   mainFit1031->SetParError(0,0.38225);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9407138);
   mainFit1031->SetParError(1,0.01165863);
