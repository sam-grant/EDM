...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.00763,70,66.1514);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.39172);
   Graph_Graph01035->SetMaximum(54.5355);
   ...
   mainFit1036->SetChisquare(1.887594);
   ...
   mainFit1036->SetParameter(0,-1.709928);
   mainFit1036->SetParError(0,0.3688764);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9442102);
   mainFit1036->SetParError(1,0.01276057);
   ...
   pt_LaTex = pt->AddText("0.944#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.71#pm0.369");
   pt_LaTex = pt->AddText("#minus1.81#pm0.385");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.810962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.810962,-38.39172,1.810962,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.887594);
   ...
   mainFit1037->SetParameter(0,-1.709928);
   mainFit1037->SetParError(0,0.3688764);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9442102);
   mainFit1037->SetParError(1,0.01276057);
