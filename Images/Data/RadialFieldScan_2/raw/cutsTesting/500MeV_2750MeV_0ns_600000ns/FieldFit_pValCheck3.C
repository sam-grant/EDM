...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.23321);
   Graph_Graph01031->SetMaximum(56.43018);
   ...
   mainFit1032->SetChisquare(1.661291);
   ...
   mainFit1032->SetParameter(0,-1.512886);
   mainFit1032->SetParError(0,0.4050632);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.939358);
   mainFit1032->SetParError(1,0.01203105);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.554");
   pt_LaTex = pt->AddText("0.939#pm0.012");
   pt_LaTex = pt->AddText("#minus1.51#pm0.405");
   pt_LaTex = pt->AddText("#minus1.61#pm0.426");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.610553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.610553,-59.23321,1.610553,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.661291);
   ...
   mainFit1033->SetParameter(0,-1.512886);
   mainFit1033->SetParError(0,0.4050632);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.939358);
   mainFit1033->SetParError(1,0.01203105);
