...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.23321);
   Graph_Graph01023->SetMaximum(56.43018);
   ...
   mainFit1024->SetChisquare(2.148619);
   ...
   mainFit1024->SetParameter(0,-1.653136);
   mainFit1024->SetParError(0,0.3517288);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9415216);
   mainFit1024->SetParError(1,0.01162496);
   ...
   mainFit1025->SetChisquare(2.148619);
   ...
   mainFit1025->SetParameter(0,-1.653136);
   mainFit1025->SetParError(0,0.3517288);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9415216);
   mainFit1025->SetParError(1,0.01162496);
