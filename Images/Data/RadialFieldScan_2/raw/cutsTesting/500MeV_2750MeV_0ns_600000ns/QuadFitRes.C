...
//=========  (Mon Apr 26 22:18:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.009489671);
   Graph_Graph11015->SetMaximum(0.008787958);
   ...
   Graph_Graph21016->SetMinimum(-0.01398762);
   Graph_Graph21016->SetMaximum(0.01642371);
   ...
   Graph_Graph31017->SetMinimum(-0.01705851);
   Graph_Graph31017->SetMaximum(0.01270403);
   ...
   Graph_Graph41018->SetMinimum(-0.01249745);
   Graph_Graph41018->SetMaximum(0.01702975);
   ...
   Graph_Graph51019->SetMinimum(-0.003061464);
   Graph_Graph51019->SetMaximum(0.004081577);
