...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.68094,50,45.83716);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.22913);
   Graph_Graph01025->SetMaximum(34.38535);
   ...
   mainFit1026->SetChisquare(1.614904);
   ...
   mainFit1026->SetParameter(0,-1.756345);
   mainFit1026->SetParError(0,0.3790406);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9345881);
   mainFit1026->SetParError(1,0.01500715);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.015");
   pt_LaTex = pt->AddText("#minus1.76#pm0.379");
   pt_LaTex = pt->AddText("#minus1.88#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.879272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.879272,-57.22913,1.879272,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.614904);
   ...
   mainFit1027->SetParameter(0,-1.756345);
   mainFit1027->SetParError(0,0.3790406);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9345881);
   mainFit1027->SetParError(1,0.01500715);
