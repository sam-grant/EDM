...
//=========  (Mon Apr 26 22:18:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.23321);
   Graph_Graph01027->SetMaximum(56.43018);
   ...
   mainFit1028->SetChisquare(1.160026);
   ...
   mainFit1028->SetParameter(0,-1.476971);
   mainFit1028->SetParError(0,0.3938352);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9472753);
   mainFit1028->SetParError(1,0.01298595);
   ...
   pt_LaTex = pt->AddText("0.947#pm0.013");
   pt_LaTex = pt->AddText("#minus1.48#pm0.394");
   pt_LaTex = pt->AddText("#minus1.56#pm0.418");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.559179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.559179,-59.23321,1.559179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.160026);
   ...
   mainFit1029->SetParameter(0,-1.476971);
   mainFit1029->SetParError(0,0.3938352);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9472753);
   mainFit1029->SetParError(1,0.01298595);
