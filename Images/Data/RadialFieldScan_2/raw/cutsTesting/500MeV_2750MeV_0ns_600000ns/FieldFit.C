...
//=========  (Mon Apr 26 22:18:11 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.23321);
   Graph_Graph01020->SetMaximum(56.43018);
   ...
   mainFit1021->SetChisquare(2.148619);
   ...
   mainFit1021->SetParameter(0,-1.653136);
   mainFit1021->SetParError(0,0.3517288);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9415216);
   mainFit1021->SetParError(1,0.01162496);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.537");
   pt_LaTex = pt->AddText("0.942#pm0.0116");
   pt_LaTex = pt->AddText("#minus1.65#pm0.352");
   pt_LaTex = pt->AddText("#minus1.76#pm0.371");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.755813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.755813,-59.23321,1.755813,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.148619);
   ...
   mainFit1022->SetParameter(0,-1.653136);
   mainFit1022->SetParError(0,0.3517288);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9415216);
   mainFit1022->SetParError(1,0.01162496);
