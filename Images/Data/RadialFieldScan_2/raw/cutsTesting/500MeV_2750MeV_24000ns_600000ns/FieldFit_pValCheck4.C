...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.57215);
   Graph_Graph01033->SetMaximum(56.41984);
   ...
   mainFit1034->SetChisquare(6.823567);
   ...
   mainFit1034->SetParameter(0,-1.067598);
   mainFit1034->SetParError(0,0.5503589);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9015834);
   mainFit1034->SetParError(1,0.01838713);
   ...
   pt_LaTex = pt->AddText("0.902#pm0.0184");
   pt_LaTex = pt->AddText("#minus1.07#pm 0.55");
   pt_LaTex = pt->AddText("#minus1.18#pm  0.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.184137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.184137,-56.57215,1.184137,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(6.823567);
   ...
   mainFit1035->SetParameter(0,-1.067598);
   mainFit1035->SetParError(0,0.5503589);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9015834);
   mainFit1035->SetParError(1,0.01838713);
