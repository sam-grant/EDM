...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.57215);
   Graph_Graph01027->SetMaximum(56.41984);
   ...
   mainFit1028->SetChisquare(1.377296);
   ...
   mainFit1028->SetParameter(0,-0.2622142);
   mainFit1028->SetParError(0,0.4960166);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9120695);
   mainFit1028->SetParError(1,0.01657209);
   ...
   pt_LaTex = pt->AddText("#minus0.262#pm0.496");
   pt_LaTex = pt->AddText("#minus0.287#pm0.544");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2874937,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2874937,-56.57215,0.2874937,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.377296);
   ...
   mainFit1029->SetParameter(0,-0.2622142);
   mainFit1029->SetParError(0,0.4960166);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9120695);
   mainFit1029->SetParError(1,0.01657209);
