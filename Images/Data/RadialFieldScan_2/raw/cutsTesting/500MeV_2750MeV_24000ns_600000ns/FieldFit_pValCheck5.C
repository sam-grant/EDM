...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.83581,70,65.77178);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.57505);
   Graph_Graph01035->SetMaximum(54.51102);
   ...
   mainFit1036->SetChisquare(7.348371);
   ...
   mainFit1036->SetParameter(0,-0.8457702);
   mainFit1036->SetParError(0,0.4613276);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8945382);
   mainFit1036->SetParError(1,0.01615893);
   ...
   pt_LaTex = pt->AddText("0.895#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.846#pm0.461");
   pt_LaTex = pt->AddText("#minus0.945#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.9454824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9454824,-35.57505,0.9454824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.348371);
   ...
   mainFit1037->SetParameter(0,-0.8457702);
   mainFit1037->SetParError(0,0.4613276);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8945382);
   mainFit1037->SetParError(1,0.01615893);
