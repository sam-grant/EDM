...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.57215);
   Graph_Graph01029->SetMaximum(56.41984);
   ...
   mainFit1030->SetChisquare(7.068288);
   ...
   mainFit1030->SetParameter(0,-0.9273911);
   mainFit1030->SetParError(0,0.4795706);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.892654);
   mainFit1030->SetParError(1,0.01475872);
   ...
   pt_LaTex = pt->AddText("0.893#pm0.0148");
   pt_LaTex = pt->AddText("#minus0.927#pm 0.48");
   pt_LaTex = pt->AddText("#minus1.04#pm0.536");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.038914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.038914,-56.57215,1.038914,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.068288);
   ...
   mainFit1031->SetParameter(0,-0.9273911);
   mainFit1031->SetParError(0,0.4795706);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.892654);
   mainFit1031->SetParError(1,0.01475872);
