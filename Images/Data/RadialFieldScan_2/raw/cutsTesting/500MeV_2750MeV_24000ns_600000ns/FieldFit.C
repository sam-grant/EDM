...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.57215);
   Graph_Graph01020->SetMaximum(56.41984);
   ...
   mainFit1021->SetChisquare(7.379757);
   ...
   mainFit1021->SetParameter(0,-0.8213846);
   mainFit1021->SetParError(0,0.4403796);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8933424);
   mainFit1021->SetParError(1,0.01470571);
   ...
   mainFit1022->SetChisquare(7.379757);
   ...
   mainFit1022->SetParameter(0,-0.8213846);
   mainFit1022->SetParError(0,0.4403796);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8933424);
   mainFit1022->SetParError(1,0.01470571);
