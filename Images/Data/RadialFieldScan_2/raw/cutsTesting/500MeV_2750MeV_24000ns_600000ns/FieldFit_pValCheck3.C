...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.69615,75,70.54384);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-56.57215);
   Graph_Graph01031->SetMaximum(56.41984);
   ...
   mainFit1032->SetChisquare(7.07324);
   ...
   mainFit1032->SetParameter(0,-0.6822747);
   mainFit1032->SetParError(0,0.5070519);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8912236);
   mainFit1032->SetParError(1,0.01519978);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.36");
   pt_LaTex = pt->AddText("0.891#pm0.0152");
   pt_LaTex = pt->AddText("#minus0.682#pm0.507");
   pt_LaTex = pt->AddText("#minus0.766#pm0.566");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7655483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7655483,-56.57215,0.7655483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.07324);
   ...
   mainFit1033->SetParameter(0,-0.6822747);
   mainFit1033->SetParError(0,0.5070519);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8912236);
   mainFit1033->SetParError(1,0.01519978);
