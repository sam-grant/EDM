...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.22739,50,43.20005);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.38465);
   Graph_Graph01025->SetMaximum(32.3573);
   ...
   mainFit1026->SetChisquare(1.889934);
   ...
   mainFit1026->SetParameter(0,-1.225433);
   mainFit1026->SetParError(0,0.4729339);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8661496);
   mainFit1026->SetParError(1,0.01873619);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.63");
   pt_LaTex = pt->AddText("0.866#pm0.0187");
   pt_LaTex = pt->AddText("#minus1.23#pm0.473");
   pt_LaTex = pt->AddText("#minus1.41#pm 0.55");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.414805,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.414805,-54.38465,1.414805,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.889934);
   ...
   mainFit1027->SetParameter(0,-1.225433);
   mainFit1027->SetParError(0,0.4729339);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8661496);
   mainFit1027->SetParError(1,0.01873619);
