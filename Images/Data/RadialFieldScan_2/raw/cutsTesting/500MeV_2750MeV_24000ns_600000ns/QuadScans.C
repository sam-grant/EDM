...
//=========  (Mon Apr 26 22:40:29 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.6550006);
   ...
   quadLineFit1002->SetParameter(0,74.4557);
   quadLineFit1002->SetParError(0,0.06952494);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.83695);
   quadLineFit1002->SetParError(1,1.166895);
   ...
   quadLineFit1003->SetChisquare(0.6550006);
   ...
   quadLineFit1003->SetParameter(0,74.4557);
   quadLineFit1003->SetParError(0,0.06952494);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.83695);
   quadLineFit1003->SetParError(1,1.166895);
   ...
   Graph_30_ppm1003->SetMinimum(75.76265);
   Graph_30_ppm1003->SetMaximum(76.37032);
   ...
   quadLineFit1004->SetChisquare(1.526954);
   ...
   quadLineFit1004->SetParameter(0,74.57785);
   quadLineFit1004->SetParError(0,0.05632978);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.20293);
   quadLineFit1004->SetParError(1,0.925881);
   ...
   quadLineFit1005->SetChisquare(1.526954);
   ...
   quadLineFit1005->SetParameter(0,74.57785);
   quadLineFit1005->SetParError(0,0.05632978);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.20293);
   quadLineFit1005->SetParError(1,0.925881);
   ...
   Graph_10_ppm1005->SetMinimum(74.78161);
   Graph_10_ppm1005->SetMaximum(75.03371);
   ...
   quadLineFit1006->SetChisquare(1.694242);
   ...
   quadLineFit1006->SetParameter(0,74.36563);
   quadLineFit1006->SetParError(0,0.06583812);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.654232);
   quadLineFit1006->SetParError(1,1.06781);
   ...
   quadLineFit1007->SetChisquare(1.694242);
   ...
   quadLineFit1007->SetParameter(0,74.36563);
   quadLineFit1007->SetParError(0,0.06583812);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.654232);
   quadLineFit1007->SetParError(1,1.06781);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.56607);
   Graph_mI10_ppm1007->SetMaximum(73.87548);
   ...
   quadLineFit1008->SetChisquare(7.413659);
   ...
   quadLineFit1008->SetParameter(0,74.33744);
   quadLineFit1008->SetParError(0,0.0579443);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.20304);
   quadLineFit1008->SetParError(1,0.9431907);
   ...
   quadLineFit1009->SetChisquare(7.413659);
   ...
   quadLineFit1009->SetParameter(0,74.33744);
   quadLineFit1009->SetParError(0,0.0579443);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.20304);
   quadLineFit1009->SetParError(1,0.9431907);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.20691);
   Graph_mI30_ppm1009->SetMaximum(72.89513);
   ...
   quadLineFit1010->SetChisquare(2.630547);
   ...
   quadLineFit1010->SetParameter(0,74.22713);
   quadLineFit1010->SetParError(0,0.05479434);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.11952);
   quadLineFit1010->SetParError(1,0.9483573);
   ...
   quadLineFit1011->SetChisquare(2.630547);
   ...
   quadLineFit1011->SetParameter(0,74.22713);
   quadLineFit1011->SetParError(0,0.05479434);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.11952);
   quadLineFit1011->SetParError(1,0.9483573);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.27237);
   Graph_mI50_ppm1011->SetMaximum(71.91736);
   ...
   quadLineFit1012->SetChisquare(0.6495582);
   ...
   quadLineFit1012->SetParameter(0,74.17209);
   quadLineFit1012->SetParError(0,0.1105597);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.17789);
   quadLineFit1012->SetParError(1,1.978265);
   ...
   quadLineFit1013->SetChisquare(0.6495582);
   ...
   quadLineFit1013->SetParameter(0,74.17209);
   quadLineFit1013->SetParError(0,0.1105597);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.17789);
   quadLineFit1013->SetParError(1,1.978265);
