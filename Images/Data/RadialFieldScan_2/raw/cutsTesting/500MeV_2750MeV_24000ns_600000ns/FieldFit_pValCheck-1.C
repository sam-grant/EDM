...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.57215);
   Graph_Graph01023->SetMaximum(56.41984);
   ...
   mainFit1024->SetChisquare(7.379757);
   ...
   mainFit1024->SetParameter(0,-0.8213846);
   mainFit1024->SetParError(0,0.4403796);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8933424);
   mainFit1024->SetParError(1,0.01470571);
   ...
   pt_LaTex = pt->AddText("0.893#pm0.0147");
   pt_LaTex = pt->AddText("#minus0.821#pm 0.44");
   pt_LaTex = pt->AddText("#minus0.919#pm0.491");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9194511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9194511,-56.57215,0.9194511,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(7.379757);
   ...
   mainFit1025->SetParameter(0,-0.8213846);
   mainFit1025->SetParError(0,0.4403796);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8933424);
   mainFit1025->SetParError(1,0.01470571);
