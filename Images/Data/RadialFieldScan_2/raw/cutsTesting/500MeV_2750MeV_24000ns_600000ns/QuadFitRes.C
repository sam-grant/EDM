...
//=========  (Mon Apr 26 22:40:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01353143);
   Graph_Graph11015->SetMaximum(0.01368581);
   ...
   Graph_Graph21016->SetMinimum(-0.01249709);
   Graph_Graph21016->SetMaximum(0.01472414);
   ...
   Graph_Graph31017->SetMinimum(-0.03404945);
   Graph_Graph31017->SetMaximum(0.02436271);
   ...
   Graph_Graph41018->SetMinimum(-0.01166794);
   Graph_Graph41018->SetMaximum(0.01876656);
   ...
   Graph_Graph51019->SetMinimum(-0.007225944);
   Graph_Graph51019->SetMaximum(0.00965973);
