...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02213911);
   Graph_Graph11015->SetMaximum(0.06809859);
   ...
   Graph_Graph21016->SetMinimum(-0.02119734);
   Graph_Graph21016->SetMaximum(0.02502111);
   ...
   Graph_Graph31017->SetMinimum(-0.02177688);
   Graph_Graph31017->SetMaximum(0.01703816);
   ...
   Graph_Graph41018->SetMinimum(-0.03238269);
   Graph_Graph41018->SetMaximum(0.04724972);
   ...
   Graph_Graph51019->SetMinimum(-0.004332482);
   Graph_Graph51019->SetMaximum(0.005794548);
