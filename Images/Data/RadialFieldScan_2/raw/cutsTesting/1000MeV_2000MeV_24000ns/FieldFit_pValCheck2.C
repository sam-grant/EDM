...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-61.92159);
   Graph_Graph01029->SetMaximum(56.12366);
   ...
   mainFit1030->SetChisquare(6.194529);
   ...
   mainFit1030->SetParameter(0,-0.8884204);
   mainFit1030->SetParError(0,0.6770423);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8848077);
   mainFit1030->SetParError(1,0.02051303);
   ...
   pt_LaTex = pt->AddText("0.885#pm0.0205");
   pt_LaTex = pt->AddText("#minus0.888#pm0.677");
   pt_LaTex = pt->AddText("   #minus1#pm0.762");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.004083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.004083,-61.92159,1.004083,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.194529);
   ...
   mainFit1031->SetParameter(0,-0.8884204);
   mainFit1031->SetParError(0,0.6770423);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8848077);
   mainFit1031->SetParError(1,0.02051303);
