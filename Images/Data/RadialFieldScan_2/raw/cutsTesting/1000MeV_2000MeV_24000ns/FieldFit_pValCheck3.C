...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-61.92159);
   Graph_Graph01031->SetMaximum(56.12366);
   ...
   mainFit1032->SetChisquare(5.645502);
   ...
   mainFit1032->SetParameter(0,-1.091099);
   mainFit1032->SetParError(0,0.7184764);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8897756);
   mainFit1032->SetParError(1,0.02120278);
   ...
   pt_LaTex = pt->AddText(" 0.89#pm0.0212");
   pt_LaTex = pt->AddText("#minus1.09#pm0.718");
   pt_LaTex = pt->AddText("#minus1.23#pm  0.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.226263,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.226263,-61.92159,1.226263,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.645502);
   ...
   mainFit1033->SetParameter(0,-1.091099);
   mainFit1033->SetParError(0,0.7184764);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8897756);
   mainFit1033->SetParError(1,0.02120278);
