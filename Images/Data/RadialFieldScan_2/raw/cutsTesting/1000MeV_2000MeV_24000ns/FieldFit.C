...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-61.92159);
   Graph_Graph01020->SetMaximum(56.12366);
   ...
   mainFit1021->SetChisquare(6.302078);
   ...
   mainFit1021->SetParameter(0,-0.8019902);
   mainFit1021->SetParError(0,0.6236234);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8852784);
   mainFit1021->SetParError(1,0.02046351);
   ...
   pt_LaTex = pt->AddText("#minus0.802#pm0.624");
   pt_LaTex = pt->AddText("#minus0.906#pm0.701");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9059186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9059186,-61.92159,0.9059186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(6.302078);
   ...
   mainFit1022->SetParameter(0,-0.8019902);
   mainFit1022->SetParError(0,0.6236234);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8852784);
   mainFit1022->SetParError(1,0.02046351);
