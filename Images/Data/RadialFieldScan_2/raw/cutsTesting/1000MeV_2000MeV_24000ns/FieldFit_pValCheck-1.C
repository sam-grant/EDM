...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-61.92159);
   Graph_Graph01023->SetMaximum(56.12366);
   ...
   mainFit1024->SetChisquare(6.302078);
   ...
   mainFit1024->SetParameter(0,-0.8019902);
   mainFit1024->SetParError(0,0.6236234);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8852784);
   mainFit1024->SetParError(1,0.02046351);
   ...
   mainFit1025->SetChisquare(6.302078);
   ...
   mainFit1025->SetParameter(0,-0.8019902);
   mainFit1025->SetParError(0,0.6236234);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8852784);
   mainFit1025->SetParError(1,0.02046351);
