...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-71.3609,50,44.29757);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-59.79505);
   Graph_Graph01025->SetMaximum(32.73173);
   ...
   mainFit1026->SetChisquare(4.955643);
   ...
   mainFit1026->SetParameter(0,-1.097324);
   mainFit1026->SetParError(0,0.6735376);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8654137);
   mainFit1026->SetParError(1,0.02667132);
   ...
   pt_LaTex = pt->AddText("0.865#pm0.0267");
   pt_LaTex = pt->AddText(" #minus1.1#pm0.674");
   pt_LaTex = pt->AddText("#minus1.27#pm0.784");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.267977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.267977,-59.79505,1.267977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.955643);
   ...
   mainFit1027->SetParameter(0,-1.097324);
   mainFit1027->SetParError(0,0.6735376);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8654137);
   mainFit1027->SetParError(1,0.02667132);
