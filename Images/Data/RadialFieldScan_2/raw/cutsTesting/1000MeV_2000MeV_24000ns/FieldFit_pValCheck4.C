...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-61.92159);
   Graph_Graph01033->SetMaximum(56.12366);
   ...
   mainFit1034->SetChisquare(5.503363);
   ...
   mainFit1034->SetParameter(0,-1.225186);
   mainFit1034->SetParError(0,0.783029);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8990121);
   mainFit1034->SetParError(1,0.02559107);
   ...
   pt_LaTex = pt->AddText("0.899#pm0.0256");
   pt_LaTex = pt->AddText("#minus1.23#pm0.783");
   pt_LaTex = pt->AddText("#minus1.36#pm0.853");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.362814,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.362814,-61.92159,1.362814,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.503363);
   ...
   mainFit1035->SetParameter(0,-1.225186);
   mainFit1035->SetParError(0,0.783029);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8990121);
   mainFit1035->SetParError(1,0.02559107);
