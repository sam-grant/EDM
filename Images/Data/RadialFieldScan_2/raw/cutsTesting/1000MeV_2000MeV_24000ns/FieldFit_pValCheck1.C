...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-76.67725,75,70.87932);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-61.92159);
   Graph_Graph01027->SetMaximum(56.12366);
   ...
   mainFit1028->SetChisquare(2.481843);
   ...
   mainFit1028->SetParameter(0,-0.2014357);
   mainFit1028->SetParError(0,0.6952089);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.904551);
   mainFit1028->SetParError(1,0.02271525);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.827");
   pt_LaTex = pt->AddText("0.905#pm0.0227");
   pt_LaTex = pt->AddText("#minus0.201#pm0.695");
   pt_LaTex = pt->AddText("#minus0.223#pm0.769");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2226913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2226913,-61.92159,0.2226913,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.481843);
   ...
   mainFit1029->SetParameter(0,-0.2014357);
   mainFit1029->SetParError(0,0.6952089);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.904551);
   mainFit1029->SetParError(1,0.02271525);
