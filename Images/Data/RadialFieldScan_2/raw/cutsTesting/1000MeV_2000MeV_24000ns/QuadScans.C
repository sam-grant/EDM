...
//=========  (Wed Apr 21 19:57:10 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.684147);
   ...
   quadLineFit1002->SetParameter(0,74.3532);
   quadLineFit1002->SetParError(0,0.09266541);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.73267);
   quadLineFit1002->SetParError(1,1.553894);
   ...
   quadLineFit1003->SetChisquare(3.684147);
   ...
   quadLineFit1003->SetParameter(0,74.3532);
   quadLineFit1003->SetParError(0,0.09266541);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.73267);
   quadLineFit1003->SetParError(1,1.553894);
   ...
   Graph_30_ppm1003->SetMinimum(75.59555);
   Graph_30_ppm1003->SetMaximum(76.20939);
   ...
   quadLineFit1004->SetChisquare(5.831961);
   ...
   quadLineFit1004->SetParameter(0,74.46052);
   quadLineFit1004->SetParError(0,0.0801894);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.70325);
   quadLineFit1004->SetParError(1,1.317914);
   ...
   quadLineFit1005->SetChisquare(5.831961);
   ...
   quadLineFit1005->SetParameter(0,74.46052);
   quadLineFit1005->SetParError(0,0.0801894);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.70325);
   quadLineFit1005->SetParError(1,1.317914);
   ...
   Graph_10_ppm1005->SetMinimum(74.66468);
   Graph_10_ppm1005->SetMaximum(74.93303);
   ...
   quadLineFit1006->SetChisquare(2.409852);
   ...
   quadLineFit1006->SetParameter(0,74.25839);
   quadLineFit1006->SetParError(0,0.0939843);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.507218);
   quadLineFit1006->SetParError(1,1.524365);
   ...
   quadLineFit1007->SetChisquare(2.409852);
   ...
   quadLineFit1007->SetParameter(0,74.25839);
   quadLineFit1007->SetParError(0,0.0939843);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.507218);
   quadLineFit1007->SetParError(1,1.524365);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.47157);
   Graph_mI10_ppm1007->SetMaximum(73.75003);
   ...
   quadLineFit1008->SetChisquare(1.571679);
   ...
   quadLineFit1008->SetParameter(0,74.14012);
   quadLineFit1008->SetParError(0,0.08245649);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.721478);
   quadLineFit1008->SetParError(1,1.342209);
   ...
   quadLineFit1009->SetChisquare(1.571679);
   ...
   quadLineFit1009->SetParameter(0,74.14012);
   quadLineFit1009->SetParError(0,0.08245649);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.721478);
   quadLineFit1009->SetParError(1,1.342209);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.09931);
   Graph_mI30_ppm1009->SetMaximum(72.80417);
   ...
   quadLineFit1010->SetChisquare(4.705694);
   ...
   quadLineFit1010->SetParameter(0,74.10118);
   quadLineFit1010->SetParError(0,0.07798383);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.5015);
   quadLineFit1010->SetParError(1,1.349661);
   ...
   quadLineFit1011->SetChisquare(4.705694);
   ...
   quadLineFit1011->SetParameter(0,74.10118);
   quadLineFit1011->SetParError(0,0.07798383);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.5015);
   quadLineFit1011->SetParError(1,1.349661);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.15475);
   Graph_mI50_ppm1011->SetMaximum(71.87095);
   ...
   quadLineFit1012->SetChisquare(0.1153556);
   ...
   quadLineFit1012->SetParameter(0,74.32123);
   quadLineFit1012->SetParError(0,0.1573559);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.2689);
   quadLineFit1012->SetParError(1,2.815583);
   ...
   quadLineFit1013->SetChisquare(0.1153556);
   ...
   quadLineFit1013->SetParameter(0,74.32123);
   quadLineFit1013->SetParError(0,0.1573559);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.2689);
   quadLineFit1013->SetParError(1,2.815583);
