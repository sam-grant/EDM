...
//=========  (Wed Apr 21 19:57:11 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-46.38559,70,64.82099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.26493);
   Graph_Graph01035->SetMaximum(53.70033);
   ...
   mainFit1036->SetChisquare(3.485218);
   ...
   mainFit1036->SetParameter(0,-0.467455);
   mainFit1036->SetParError(0,0.6547031);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8697681);
   mainFit1036->SetParError(1,0.02245349);
   ...
   pt_LaTex = pt->AddText(" 0.87#pm0.0225");
   pt_LaTex = pt->AddText("#minus0.467#pm0.655");
   pt_LaTex = pt->AddText("#minus0.537#pm0.749");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.5374479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5374479,-35.26493,0.5374479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.485218);
   ...
   mainFit1037->SetParameter(0,-0.467455);
   mainFit1037->SetParError(0,0.6547031);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8697681);
   mainFit1037->SetParError(1,0.02245349);
