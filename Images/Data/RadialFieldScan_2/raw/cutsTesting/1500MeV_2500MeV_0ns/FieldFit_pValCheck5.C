...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.75057,70,59.62752);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.11276);
   Graph_Graph01035->SetMaximum(48.98971);
   ...
   mainFit1036->SetChisquare(0.7177641);
   ...
   mainFit1036->SetParameter(0,-1.704976);
   mainFit1036->SetParError(0,0.5407967);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8587837);
   mainFit1036->SetParError(1,0.01870827);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.239");
   pt_LaTex = pt->AddText("0.859#pm0.0187");
   pt_LaTex = pt->AddText(" #minus1.7#pm0.541");
   pt_LaTex = pt->AddText("#minus1.99#pm 0.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.985338,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.985338,-36.11276,1.985338,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.7177641);
   ...
   mainFit1037->SetParameter(0,-1.704976);
   mainFit1037->SetParError(0,0.5407967);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8587837);
   mainFit1037->SetParError(1,0.01870827);
