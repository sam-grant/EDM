...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.09992);
   Graph_Graph01020->SetMaximum(50.80672);
   ...
   mainFit1021->SetChisquare(0.7249515);
   ...
   mainFit1021->SetParameter(0,-1.718766);
   mainFit1021->SetParError(0,0.5156711);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8594309);
   mainFit1021->SetParError(1,0.01704436);
   ...
   mainFit1022->SetChisquare(0.7249515);
   ...
   mainFit1022->SetParameter(0,-1.718766);
   mainFit1022->SetParError(0,0.5156711);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8594309);
   mainFit1022->SetParError(1,0.01704436);
