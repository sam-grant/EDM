...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.46325,75,64.17005);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-56.09992);
   Graph_Graph01031->SetMaximum(50.80672);
   ...
   mainFit1032->SetChisquare(0.6800777);
   ...
   mainFit1032->SetParameter(0,-1.781235);
   mainFit1032->SetParError(0,0.5939845);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8604012);
   mainFit1032->SetParError(1,0.01764093);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.227");
   pt_LaTex = pt->AddText(" 0.86#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.78#pm0.594");
   pt_LaTex = pt->AddText("#minus2.07#pm 0.68");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.070237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.070237,-56.09992,2.070237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.6800777);
   ...
   mainFit1033->SetParameter(0,-1.781235);
   mainFit1033->SetParError(0,0.5939845);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8604012);
   mainFit1033->SetParError(1,0.01764093);
