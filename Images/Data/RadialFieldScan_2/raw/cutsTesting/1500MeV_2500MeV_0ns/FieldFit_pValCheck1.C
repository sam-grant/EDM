...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.09992);
   Graph_Graph01027->SetMaximum(50.80672);
   ...
   mainFit1028->SetChisquare(0.6597173);
   ...
   mainFit1028->SetParameter(0,-1.785141);
   mainFit1028->SetParError(0,0.5774058);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8572691);
   mainFit1028->SetParError(1,0.01904013);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.22");
   pt_LaTex = pt->AddText("0.857#pm0.019");
   pt_LaTex = pt->AddText("#minus1.79#pm0.577");
   pt_LaTex = pt->AddText("#minus2.08#pm0.678");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.082358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.082358,-56.09992,2.082358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.6597173);
   ...
   mainFit1029->SetParameter(0,-1.785141);
   mainFit1029->SetParError(0,0.5774058);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8572691);
   mainFit1029->SetParError(1,0.01904013);
