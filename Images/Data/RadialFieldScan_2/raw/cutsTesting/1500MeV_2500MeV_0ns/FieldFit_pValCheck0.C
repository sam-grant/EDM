...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.33159,50,43.51176);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.44725);
   Graph_Graph01025->SetMaximum(32.62743);
   ...
   mainFit1026->SetChisquare(0.2137092);
   ...
   mainFit1026->SetParameter(0,-1.57071);
   mainFit1026->SetParError(0,0.5557037);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8693882);
   mainFit1026->SetParError(1,0.02200421);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0712");
   pt_LaTex = pt->AddText("0.869#pm0.022");
   pt_LaTex = pt->AddText("#minus1.57#pm0.556");
   pt_LaTex = pt->AddText("#minus1.81#pm0.646");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.806684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.806684,-54.44725,1.806684,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.2137092);
   ...
   mainFit1027->SetParameter(0,-1.57071);
   mainFit1027->SetParError(0,0.5557037);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8693882);
   mainFit1027->SetParError(1,0.02200421);
