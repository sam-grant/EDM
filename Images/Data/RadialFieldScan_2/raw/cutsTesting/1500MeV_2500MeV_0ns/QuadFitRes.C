...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01773175);
   Graph_Graph11015->SetMaximum(0.02286065);
   ...
   Graph_Graph21016->SetMinimum(-0.003400776);
   Graph_Graph21016->SetMaximum(0.003992593);
   ...
   Graph_Graph31017->SetMinimum(-0.02745277);
   Graph_Graph31017->SetMaximum(0.02596442);
   ...
   Graph_Graph41018->SetMinimum(-0.0110711);
   Graph_Graph41018->SetMaximum(0.01611784);
   ...
   Graph_Graph51019->SetMinimum(-0.004777304);
   Graph_Graph51019->SetMaximum(0.006362776);
