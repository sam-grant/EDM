...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.09992);
   Graph_Graph01029->SetMaximum(50.80672);
   ...
   mainFit1030->SetChisquare(0.4230557);
   ...
   mainFit1030->SetParameter(0,-1.839286);
   mainFit1030->SetParError(0,0.5603679);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8587251);
   mainFit1030->SetParError(1,0.01709359);
   ...
   pt_LaTex = pt->AddText("0.859#pm0.0171");
   pt_LaTex = pt->AddText("#minus1.84#pm 0.56");
   pt_LaTex = pt->AddText("#minus2.14#pm0.649");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.14188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.14188,-56.09992,2.14188,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.4230557);
   ...
   mainFit1031->SetParameter(0,-1.839286);
   mainFit1031->SetParError(0,0.5603679);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8587251);
   mainFit1031->SetParError(1,0.01709359);
