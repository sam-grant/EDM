...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.09992);
   Graph_Graph01023->SetMaximum(50.80672);
   ...
   mainFit1024->SetChisquare(0.7249515);
   ...
   mainFit1024->SetParameter(0,-1.718766);
   mainFit1024->SetParError(0,0.5156711);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8594309);
   mainFit1024->SetParError(1,0.01704436);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.181");
   pt_LaTex = pt->AddText("0.859#pm0.017");
   pt_LaTex = pt->AddText("#minus1.72#pm0.516");
   pt_LaTex = pt->AddText("   #minus2#pm0.595");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.999888,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.999888,-56.09992,1.999888,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(0.7249515);
   ...
   mainFit1025->SetParameter(0,-1.718766);
   mainFit1025->SetParError(0,0.5156711);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8594309);
   mainFit1025->SetParError(1,0.01704436);
