...
//=========  (Wed Apr 21 18:22:26 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.09992);
   Graph_Graph01033->SetMaximum(50.80672);
   ...
   mainFit1034->SetChisquare(0.4612083);
   ...
   mainFit1034->SetParameter(0,-1.518557);
   mainFit1034->SetParError(0,0.6464753);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8528597);
   mainFit1034->SetParError(1,0.02132058);
   ...
   pt_LaTex = pt->AddText("0.853#pm0.0213");
   pt_LaTex = pt->AddText("#minus1.52#pm0.646");
   pt_LaTex = pt->AddText("#minus1.78#pm0.738");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.780547,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.780547,-56.09992,1.780547,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.4612083);
   ...
   mainFit1035->SetParameter(0,-1.518557);
   mainFit1035->SetParError(0,0.6464753);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8528597);
   mainFit1035->SetParError(1,0.02132058);
