...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-50.93394,50,37.36424);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-42.10412);
   Graph_Graph01025->SetMaximum(28.53442);
   ...
   mainFit1026->SetChisquare(0.9848446);
   ...
   mainFit1026->SetParameter(0,0.2721983);
   mainFit1026->SetParError(0,1.190496);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.6865374);
   mainFit1026->SetParError(1,0.04713607);
   ...
   pt_LaTex = pt->AddText("0.687#pm0.0471");
   pt_LaTex = pt->AddText("0.272#pm 1.19");
   pt_LaTex = pt->AddText("0.396#pm 1.73");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.3964799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3964799,-42.10412,-0.3964799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.9848446);
   ...
   mainFit1027->SetParameter(0,0.2721983);
   mainFit1027->SetParError(0,1.190496);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.6865374);
   mainFit1027->SetParError(1,0.04713607);
