...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-43.92649);
   Graph_Graph01027->SetMaximum(48.58049);
   ...
   mainFit1028->SetChisquare(0.8796326);
   ...
   mainFit1028->SetParameter(0,1.17575);
   mainFit1028->SetParError(0,1.238517);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.729431);
   mainFit1028->SetParError(1,0.04085176);
   ...
   pt_LaTex = pt->AddText("0.729#pm0.0409");
   pt_LaTex = pt->AddText(" 1.18#pm 1.24");
   pt_LaTex = pt->AddText(" 1.61#pm 1.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.611872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.611872,-43.92649,-1.611872,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8796326);
   ...
   mainFit1029->SetParameter(0,1.17575);
   mainFit1029->SetParError(0,1.238517);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.729431);
   mainFit1029->SetParError(1,0.04085176);
