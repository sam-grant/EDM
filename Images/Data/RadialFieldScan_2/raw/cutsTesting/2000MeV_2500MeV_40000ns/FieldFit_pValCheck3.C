...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-43.92649);
   Graph_Graph01031->SetMaximum(48.58049);
   ...
   mainFit1032->SetChisquare(1.722232);
   ...
   mainFit1032->SetParameter(0,0.7501526);
   mainFit1032->SetParError(0,1.273564);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7110257);
   mainFit1032->SetParError(1,0.03783971);
   ...
   pt_LaTex = pt->AddText("0.711#pm0.0378");
   pt_LaTex = pt->AddText(" 0.75#pm 1.27");
   pt_LaTex = pt->AddText(" 1.06#pm 1.81");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.055029,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.055029,-43.92649,-1.055029,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.722232);
   ...
   mainFit1033->SetParameter(0,0.7501526);
   mainFit1033->SetParError(0,1.273564);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7110257);
   mainFit1033->SetParError(1,0.03783971);
