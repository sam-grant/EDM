...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-43.92649);
   Graph_Graph01033->SetMaximum(48.58049);
   ...
   mainFit1034->SetChisquare(1.534465);
   ...
   mainFit1034->SetParameter(0,1.039309);
   mainFit1034->SetParError(0,1.385809);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.6999003);
   mainFit1034->SetParError(1,0.04571718);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.511");
   pt_LaTex = pt->AddText("  0.7#pm0.0457");
   pt_LaTex = pt->AddText(" 1.04#pm 1.39");
   pt_LaTex = pt->AddText(" 1.48#pm 2.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.484938,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.484938,-43.92649,-1.484938,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.534465);
   ...
   mainFit1035->SetParameter(0,1.039309);
   mainFit1035->SetParError(0,1.385809);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.6999003);
   mainFit1035->SetParError(1,0.04571718);
