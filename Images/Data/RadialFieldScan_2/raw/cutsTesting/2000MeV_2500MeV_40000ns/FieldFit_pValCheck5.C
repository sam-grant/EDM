...
//=========  (Thu Apr 22 00:50:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-40.07345,70,57.06058);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.36004);
   Graph_Graph01035->SetMaximum(47.34718);
   ...
   mainFit1036->SetChisquare(1.033653);
   ...
   mainFit1036->SetParameter(0,0.3617677);
   mainFit1036->SetParError(0,1.159729);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7264266);
   mainFit1036->SetParError(1,0.04012804);
   ...
   pt_LaTex = pt->AddText("0.726#pm0.0401");
   pt_LaTex = pt->AddText("0.362#pm 1.16");
   pt_LaTex = pt->AddText("0.498#pm  1.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.49801,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.49801,-30.36004,-0.49801,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.033653);
   ...
   mainFit1037->SetParameter(0,0.3617677);
   mainFit1037->SetParError(0,1.159729);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7264266);
   mainFit1037->SetParError(1,0.04012804);
