...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.7436091);
   ...
   quadLineFit1002->SetParameter(0,74.98101);
   quadLineFit1002->SetParError(0,0.1686297);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.0434);
   quadLineFit1002->SetParError(1,2.828173);
   ...
   quadLineFit1003->SetChisquare(0.7436091);
   ...
   quadLineFit1003->SetParameter(0,74.98101);
   quadLineFit1003->SetParError(0,0.1686297);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.0434);
   quadLineFit1003->SetParError(1,2.828173);
   ...
   Graph_30_ppm1003->SetMinimum(76.02988);
   Graph_30_ppm1003->SetMaximum(76.5831);
   ...
   quadLineFit1004->SetChisquare(1.353475);
   ...
   quadLineFit1004->SetParameter(0,75.0414);
   quadLineFit1004->SetParError(0,0.1414218);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.32369);
   quadLineFit1004->SetParError(1,2.324187);
   ...
   quadLineFit1005->SetChisquare(1.353475);
   ...
   quadLineFit1005->SetParameter(0,75.0414);
   quadLineFit1005->SetParError(0,0.1414218);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.32369);
   quadLineFit1005->SetParError(1,2.324187);
   ...
   Graph_10_ppm1005->SetMinimum(75.05636);
   Graph_10_ppm1005->SetMaximum(75.35356);
   ...
   quadLineFit1006->SetChisquare(0.5039392);
   ...
   quadLineFit1006->SetParameter(0,74.67848);
   quadLineFit1006->SetParError(0,0.1662478);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.763222);
   quadLineFit1006->SetParError(1,2.696403);
   ...
   quadLineFit1007->SetChisquare(0.5039392);
   ...
   quadLineFit1007->SetParameter(0,74.67848);
   quadLineFit1007->SetParError(0,0.1662478);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.763222);
   quadLineFit1007->SetParError(1,2.696403);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.08974);
   Graph_mI10_ppm1007->SetMaximum(74.38004);
   ...
   quadLineFit1008->SetChisquare(2.041808);
   ...
   quadLineFit1008->SetParameter(0,74.63317);
   quadLineFit1008->SetParError(0,0.1459464);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.768743);
   quadLineFit1008->SetParError(1,2.375132);
   ...
   quadLineFit1009->SetChisquare(2.041808);
   ...
   quadLineFit1009->SetParameter(0,74.63317);
   quadLineFit1009->SetParError(0,0.1459464);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.768743);
   quadLineFit1009->SetParError(1,2.375132);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.81524);
   Graph_mI30_ppm1009->SetMaximum(73.44343);
   ...
   quadLineFit1010->SetChisquare(2.39703);
   ...
   quadLineFit1010->SetParameter(0,74.47834);
   quadLineFit1010->SetParError(0,0.1380544);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-21.49527);
   quadLineFit1010->SetParError(1,2.389174);
   ...
   quadLineFit1011->SetChisquare(2.39703);
   ...
   quadLineFit1011->SetParameter(0,74.47834);
   quadLineFit1011->SetParError(0,0.1380544);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-21.49527);
   quadLineFit1011->SetParError(1,2.389174);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.05445);
   Graph_mI50_ppm1011->SetMaximum(72.56795);
   ...
   quadLineFit1012->SetChisquare(0.4731895);
   ...
   quadLineFit1012->SetParameter(0,74.10359);
   quadLineFit1012->SetParError(0,0.2786755);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-31.23124);
   quadLineFit1012->SetParError(1,4.986329);
   ...
   quadLineFit1013->SetChisquare(0.4731895);
   ...
   quadLineFit1013->SetParameter(0,74.10359);
   quadLineFit1013->SetParError(0,0.2786755);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-31.23124);
   quadLineFit1013->SetParError(1,4.986329);
