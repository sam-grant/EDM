...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02848561);
   Graph_Graph11015->SetMaximum(0.03689432);
   ...
   Graph_Graph21016->SetMinimum(-0.02024293);
   Graph_Graph21016->SetMaximum(0.01717248);
   ...
   Graph_Graph31017->SetMinimum(-0.0463242);
   Graph_Graph31017->SetMaximum(0.03630623);
   ...
   Graph_Graph41018->SetMinimum(-0.04095463);
   Graph_Graph41018->SetMaximum(0.06477788);
   ...
   Graph_Graph51019->SetMinimum(-0.01554627);
   Graph_Graph51019->SetMaximum(0.02079839);
