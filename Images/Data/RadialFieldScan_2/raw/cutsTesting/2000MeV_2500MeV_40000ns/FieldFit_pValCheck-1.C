...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-55.48986,75,60.14386);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01023->SetMinimum(-43.92649);
   Graph_Graph01023->SetMaximum(48.58049);
   ...
   mainFit1024->SetChisquare(1.744027);
   ...
   mainFit1024->SetParameter(0,0.6568352);
   mainFit1024->SetParError(0,1.105626);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7124704);
   mainFit1024->SetParError(1,0.03655237);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.436");
   pt_LaTex = pt->AddText("0.712#pm0.0366");
   pt_LaTex = pt->AddText("0.657#pm 1.11");
   pt_LaTex = pt->AddText("0.922#pm 1.56");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9219123,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9219123,-43.92649,-0.9219123,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.744027);
   ...
   mainFit1025->SetParameter(0,0.6568352);
   mainFit1025->SetParError(0,1.105626);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7124704);
   mainFit1025->SetParError(1,0.03655237);
