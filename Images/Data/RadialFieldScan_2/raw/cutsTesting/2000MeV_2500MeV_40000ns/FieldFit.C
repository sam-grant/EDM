...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-43.92649);
   Graph_Graph01020->SetMaximum(48.58049);
   ...
   mainFit1021->SetChisquare(1.744027);
   ...
   mainFit1021->SetParameter(0,0.6568352);
   mainFit1021->SetParError(0,1.105626);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7124704);
   mainFit1021->SetParError(1,0.03655237);
   ...
   mainFit1022->SetChisquare(1.744027);
   ...
   mainFit1022->SetParameter(0,0.6568352);
   mainFit1022->SetParError(0,1.105626);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7124704);
   mainFit1022->SetParError(1,0.03655237);
