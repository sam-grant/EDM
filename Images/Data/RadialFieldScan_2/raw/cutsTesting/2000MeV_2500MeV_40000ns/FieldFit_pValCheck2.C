...
//=========  (Thu Apr 22 00:50:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-43.92649);
   Graph_Graph01029->SetMaximum(48.58049);
   ...
   mainFit1030->SetChisquare(1.584638);
   ...
   mainFit1030->SetParameter(0,0.4690846);
   mainFit1030->SetParError(0,1.201519);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7113635);
   mainFit1030->SetParError(1,0.03665614);
   ...
   pt_LaTex = pt->AddText("0.711#pm0.0367");
   pt_LaTex = pt->AddText("0.469#pm  1.2");
   pt_LaTex = pt->AddText("0.659#pm 1.69");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6594162,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6594162,-43.92649,-0.6594162,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.584638);
   ...
   mainFit1031->SetParameter(0,0.4690846);
   mainFit1031->SetParError(0,1.201519);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7113635);
   mainFit1031->SetParError(1,0.03665614);
