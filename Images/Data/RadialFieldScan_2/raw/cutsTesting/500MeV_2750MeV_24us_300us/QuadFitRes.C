...
//=========  (Wed Apr 28 14:36:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006152559);
   Graph_Graph11015->SetMaximum(0.009586091);
   ...
   Graph_Graph21016->SetMinimum(-0.01339351);
   Graph_Graph21016->SetMaximum(0.01577475);
   ...
   Graph_Graph31017->SetMinimum(-0.0341527);
   Graph_Graph31017->SetMaximum(0.03127269);
   ...
   Graph_Graph41018->SetMinimum(-0.01345491);
   Graph_Graph41018->SetMaximum(0.02287271);
   ...
   Graph_Graph51019->SetMinimum(-0.00681063);
   Graph_Graph51019->SetMaximum(0.009109786);
