...
//=========  (Wed Apr 28 14:36:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.27538);
   Graph_Graph01023->SetMaximum(56.19259);
   ...
   mainFit1024->SetChisquare(5.743565);
   ...
   mainFit1024->SetParameter(0,-0.7922976);
   mainFit1024->SetParError(0,0.4216432);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9027937);
   mainFit1024->SetParError(1,0.01393765);
   ...
   mainFit1025->SetChisquare(5.743565);
   ...
   mainFit1025->SetParameter(0,-0.7922976);
   mainFit1025->SetParError(0,0.4216432);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9027937);
   mainFit1025->SetParError(1,0.01393765);
