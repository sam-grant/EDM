...
//=========  (Wed Apr 28 14:36:30 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.27538);
   Graph_Graph01020->SetMaximum(56.19259);
   ...
   mainFit1021->SetChisquare(5.743565);
   ...
   mainFit1021->SetParameter(0,-0.7922976);
   mainFit1021->SetParError(0,0.4216432);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9027937);
   mainFit1021->SetParError(1,0.01393765);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.44");
   pt_LaTex = pt->AddText("0.903#pm0.0139");
   pt_LaTex = pt->AddText("#minus0.792#pm0.422");
   pt_LaTex = pt->AddText("#minus0.878#pm0.465");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8776065,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8776065,-57.27538,0.8776065,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.743565);
   ...
   mainFit1022->SetParameter(0,-0.7922976);
   mainFit1022->SetParError(0,0.4216432);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9027937);
   mainFit1022->SetParError(1,0.01393765);
