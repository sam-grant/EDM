...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.27538);
   Graph_Graph01031->SetMaximum(56.19259);
   ...
   mainFit1032->SetChisquare(5.672188);
   ...
   mainFit1032->SetParameter(0,-0.7278911);
   mainFit1032->SetParError(0,0.4856951);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9017989);
   mainFit1032->SetParError(1,0.01442652);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.89");
   pt_LaTex = pt->AddText("0.902#pm0.0144");
   pt_LaTex = pt->AddText("#minus0.728#pm0.486");
   pt_LaTex = pt->AddText("#minus0.807#pm0.535");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8071546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8071546,-57.27538,0.8071546,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.672188);
   ...
   mainFit1033->SetParameter(0,-0.7278911);
   mainFit1033->SetParError(0,0.4856951);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9017989);
   mainFit1033->SetParError(1,0.01442652);
