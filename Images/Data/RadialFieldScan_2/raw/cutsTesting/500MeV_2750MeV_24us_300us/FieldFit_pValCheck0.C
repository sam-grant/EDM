...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.16778,50,43.92057);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.15894);
   Graph_Graph01025->SetMaximum(32.91173);
   ...
   mainFit1026->SetChisquare(2.838356);
   ...
   mainFit1026->SetParameter(0,-1.080738);
   mainFit1026->SetParError(0,0.4543351);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8833913);
   mainFit1026->SetParError(1,0.01799546);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.946");
   pt_LaTex = pt->AddText("0.883#pm0.018");
   pt_LaTex = pt->AddText("#minus1.08#pm0.454");
   pt_LaTex = pt->AddText("#minus1.22#pm0.518");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.223396,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.223396,-55.15894,1.223396,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.838356);
   ...
   mainFit1027->SetParameter(0,-1.080738);
   mainFit1027->SetParError(0,0.4543351);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8833913);
   mainFit1027->SetParError(1,0.01799546);
