...
//=========  (Wed Apr 28 14:36:30 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.073372);
   ...
   quadLineFit1002->SetParameter(0,74.47309);
   quadLineFit1002->SetParError(0,0.06423173);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.65945);
   quadLineFit1002->SetParError(1,1.077475);
   ...
   quadLineFit1003->SetChisquare(1.073372);
   ...
   quadLineFit1003->SetParameter(0,74.47309);
   quadLineFit1003->SetParError(0,0.06423173);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.65945);
   quadLineFit1003->SetParError(1,1.077475);
   ...
   Graph_30_ppm1003->SetMinimum(75.75694);
   Graph_30_ppm1003->SetMaximum(76.38191);
   ...
   quadLineFit1004->SetChisquare(0.4109191);
   ...
   quadLineFit1004->SetParameter(0,74.55488);
   quadLineFit1004->SetParError(0,0.05409827);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.6833);
   quadLineFit1004->SetParError(1,0.8892134);
   ...
   quadLineFit1005->SetChisquare(0.4109191);
   ...
   quadLineFit1005->SetParameter(0,74.55488);
   quadLineFit1005->SetParError(0,0.05409827);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.6833);
   quadLineFit1005->SetParError(1,0.8892134);
   ...
   Graph_10_ppm1005->SetMinimum(74.77802);
   Graph_10_ppm1005->SetMaximum(75.0424);
   ...
   quadLineFit1006->SetChisquare(2.109722);
   ...
   quadLineFit1006->SetParameter(0,74.33366);
   quadLineFit1006->SetParError(0,0.06335522);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.205864);
   quadLineFit1006->SetParError(1,1.02756);
   ...
   quadLineFit1007->SetChisquare(2.109722);
   ...
   quadLineFit1007->SetParameter(0,74.33366);
   quadLineFit1007->SetParError(0,0.06335522);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.205864);
   quadLineFit1007->SetParError(1,1.02756);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.56719);
   Graph_mI10_ppm1007->SetMaximum(73.86998);
   ...
   quadLineFit1008->SetChisquare(9.192718);
   ...
   quadLineFit1008->SetParameter(0,74.32874);
   quadLineFit1008->SetParError(0,0.05562311);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.02779);
   quadLineFit1008->SetParError(1,0.9054073);
   ...
   quadLineFit1009->SetChisquare(9.192718);
   ...
   quadLineFit1009->SetParameter(0,74.32874);
   quadLineFit1009->SetParError(0,0.05562311);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.02779);
   quadLineFit1009->SetParError(1,0.9054073);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.19958);
   Graph_mI30_ppm1009->SetMaximum(72.89783);
   ...
   quadLineFit1010->SetChisquare(3.8234);
   ...
   quadLineFit1010->SetParameter(0,74.25953);
   quadLineFit1010->SetParError(0,0.05261406);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.68157);
   quadLineFit1010->SetParError(1,0.9106241);
   ...
   quadLineFit1011->SetChisquare(3.8234);
   ...
   quadLineFit1011->SetParameter(0,74.25953);
   quadLineFit1011->SetParError(0,0.05261406);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.68157);
   quadLineFit1011->SetParError(1,0.9106241);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.26699);
   Graph_mI50_ppm1011->SetMaximum(71.92051);
   ...
   quadLineFit1012->SetChisquare(0.6261947);
   ...
   quadLineFit1012->SetParameter(0,74.21279);
   quadLineFit1012->SetParError(0,0.1061968);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.91949);
   quadLineFit1012->SetParError(1,1.900228);
   ...
   quadLineFit1013->SetChisquare(0.6261947);
   ...
   quadLineFit1013->SetParameter(0,74.21279);
   quadLineFit1013->SetParError(0,0.1061968);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.91949);
   quadLineFit1013->SetParError(1,1.900228);
