...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.27538);
   Graph_Graph01033->SetMaximum(56.19259);
   ...
   mainFit1034->SetChisquare(5.653366);
   ...
   mainFit1034->SetParameter(0,-0.8879436);
   mainFit1034->SetParError(0,0.5283986);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9059363);
   mainFit1034->SetParError(1,0.0174284);
   ...
   pt_LaTex = pt->AddText("0.906#pm0.0174");
   pt_LaTex = pt->AddText("#minus0.888#pm0.528");
   pt_LaTex = pt->AddText("#minus0.98#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9801391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9801391,-57.27538,0.9801391,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.653366);
   ...
   mainFit1035->SetParameter(0,-0.8879436);
   mainFit1035->SetParError(0,0.5283986);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9059363);
   mainFit1035->SetParError(1,0.0174284);
