...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.42447,70,65.5692);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.1251);
   Graph_Graph01035->SetMaximum(54.26984);
   ...
   mainFit1036->SetChisquare(5.74351);
   ...
   mainFit1036->SetParameter(0,-0.7932845);
   mainFit1036->SetParError(0,0.4422425);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9028404);
   mainFit1036->SetParError(1,0.01530101);
   ...
   pt_LaTex = pt->AddText("0.903#pm0.0153");
   pt_LaTex = pt->AddText("#minus0.793#pm0.442");
   pt_LaTex = pt->AddText("#minus0.879#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8786541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8786541,-36.1251,0.8786541,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.74351);
   ...
   mainFit1037->SetParameter(0,-0.7932845);
   mainFit1037->SetParError(0,0.4422425);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9028404);
   mainFit1037->SetParError(1,0.01530101);
