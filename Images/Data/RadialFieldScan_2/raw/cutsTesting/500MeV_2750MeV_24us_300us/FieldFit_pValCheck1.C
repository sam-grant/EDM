...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.45888,75,70.37609);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-57.27538);
   Graph_Graph01027->SetMaximum(56.19259);
   ...
   mainFit1028->SetChisquare(0.5197031);
   ...
   mainFit1028->SetParameter(0,-0.3074246);
   mainFit1028->SetParError(0,0.4720047);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9186366);
   mainFit1028->SetParError(1,0.01556621);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.173");
   pt_LaTex = pt->AddText("0.919#pm0.0156");
   pt_LaTex = pt->AddText("#minus0.307#pm0.472");
   pt_LaTex = pt->AddText("#minus0.335#pm0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3346532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3346532,-57.27538,0.3346532,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5197031);
   ...
   mainFit1029->SetParameter(0,-0.3074246);
   mainFit1029->SetParError(0,0.4720047);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9186366);
   mainFit1029->SetParError(1,0.01556621);
