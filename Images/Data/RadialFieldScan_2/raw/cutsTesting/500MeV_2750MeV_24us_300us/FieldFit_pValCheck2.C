...
//=========  (Wed Apr 28 14:36:31 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.27538);
   Graph_Graph01029->SetMaximum(56.19259);
   ...
   mainFit1030->SetChisquare(4.671034);
   ...
   mainFit1030->SetParameter(0,-0.9783179);
   mainFit1030->SetParError(0,0.4583097);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9016956);
   mainFit1030->SetParError(1,0.01397784);
   ...
   pt_LaTex = pt->AddText("0.902#pm0.014");
   pt_LaTex = pt->AddText("#minus0.978#pm0.458");
   pt_LaTex = pt->AddText("#minus1.08#pm0.507");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.084976,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.084976,-57.27538,1.084976,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.671034);
   ...
   mainFit1031->SetParameter(0,-0.9783179);
   mainFit1031->SetParError(0,0.4583097);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9016956);
   mainFit1031->SetParError(1,0.01397784);
