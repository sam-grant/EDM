...
//=========  (Tue Apr 27 00:13:23 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.418968);
   ...
   quadLineFit1002->SetParameter(0,74.8146);
   quadLineFit1002->SetParError(0,0.07271794);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.8073);
   quadLineFit1002->SetParError(1,1.219139);
   ...
   quadLineFit1003->SetChisquare(2.418968);
   ...
   quadLineFit1003->SetParameter(0,74.8146);
   quadLineFit1003->SetParError(0,0.07271794);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.8073);
   quadLineFit1003->SetParError(1,1.219139);
   ...
   Graph_30_ppm1003->SetMinimum(75.89438);
   Graph_30_ppm1003->SetMaximum(76.49987);
   ...
   quadLineFit1004->SetChisquare(1.627382);
   ...
   quadLineFit1004->SetParameter(0,74.71409);
   quadLineFit1004->SetParError(0,0.06112435);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.07823);
   quadLineFit1004->SetParError(1,1.004012);
   ...
   quadLineFit1005->SetChisquare(1.627382);
   ...
   quadLineFit1005->SetParameter(0,74.71409);
   quadLineFit1005->SetParError(0,0.06112435);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.07823);
   quadLineFit1005->SetParError(1,1.004012);
   ...
   Graph_10_ppm1005->SetMinimum(74.97153);
   Graph_10_ppm1005->SetMaximum(75.19587);
   ...
   quadLineFit1006->SetChisquare(0.004558421);
   ...
   quadLineFit1006->SetParameter(0,74.6156);
   quadLineFit1006->SetParError(0,0.07171565);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.602889);
   quadLineFit1006->SetParError(1,1.162409);
   ...
   quadLineFit1007->SetChisquare(0.004558421);
   ...
   quadLineFit1007->SetParameter(0,74.6156);
   quadLineFit1007->SetParError(0,0.07171565);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.602889);
   quadLineFit1007->SetParError(1,1.162409);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.84632);
   Graph_mI10_ppm1007->SetMaximum(74.15277);
   ...
   quadLineFit1008->SetChisquare(4.41221);
   ...
   quadLineFit1008->SetParameter(0,74.60418);
   quadLineFit1008->SetParError(0,0.06288347);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.10726);
   quadLineFit1008->SetParError(1,1.022834);
   ...
   quadLineFit1009->SetChisquare(4.41221);
   ...
   quadLineFit1009->SetParameter(0,74.60418);
   quadLineFit1009->SetParError(0,0.06288347);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.10726);
   quadLineFit1009->SetParError(1,1.022834);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.54214);
   Graph_mI30_ppm1009->SetMaximum(73.24589);
   ...
   quadLineFit1010->SetChisquare(0.4426939);
   ...
   quadLineFit1010->SetParameter(0,74.59446);
   quadLineFit1010->SetParError(0,0.05942845);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.58611);
   quadLineFit1010->SetParError(1,1.027801);
   ...
   quadLineFit1011->SetChisquare(0.4426939);
   ...
   quadLineFit1011->SetParameter(0,74.59446);
   quadLineFit1011->SetParError(0,0.05942845);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.58611);
   quadLineFit1011->SetParError(1,1.027801);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.68613);
   Graph_mI50_ppm1011->SetMaximum(72.32062);
   ...
   quadLineFit1012->SetChisquare(0.2287464);
   ...
   quadLineFit1012->SetParameter(0,74.51988);
   quadLineFit1012->SetParError(0,0.1200751);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.1437);
   quadLineFit1012->SetParError(1,2.147926);
   ...
   quadLineFit1013->SetChisquare(0.2287464);
   ...
   quadLineFit1013->SetParameter(0,74.51988);
   quadLineFit1013->SetParError(0,0.1200751);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.1437);
   quadLineFit1013->SetParError(1,2.147926);
