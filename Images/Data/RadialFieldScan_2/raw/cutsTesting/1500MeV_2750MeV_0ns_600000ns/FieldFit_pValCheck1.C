...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.12344);
   Graph_Graph01027->SetMaximum(50.85825);
   ...
   mainFit1028->SetChisquare(0.5122703);
   ...
   mainFit1028->SetParameter(0,-1.594168);
   mainFit1028->SetParError(0,0.5334863);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.855076);
   mainFit1028->SetParError(1,0.0175996);
   ...
   pt_LaTex = pt->AddText("0.855#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.59#pm0.533");
   pt_LaTex = pt->AddText("#minus1.86#pm0.628");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.864358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.864358,-55.12344,1.864358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5122703);
   ...
   mainFit1029->SetParameter(0,-1.594168);
   mainFit1029->SetParError(0,0.5334863);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.855076);
   mainFit1029->SetParError(1,0.0175996);
