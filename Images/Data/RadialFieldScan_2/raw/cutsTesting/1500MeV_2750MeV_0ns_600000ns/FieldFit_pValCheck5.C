...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01035->SetMinimum(-35.67795);
   Graph_Graph01035->SetMaximum(49.09048);
   ...
   mainFit1036->SetChisquare(0.5007997);
   ...
   mainFit1036->SetParameter(0,-1.60665);
   mainFit1036->SetParError(0,0.4995351);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8559729);
   mainFit1036->SetParError(1,0.01728777);
   ...
   pt_LaTex = pt->AddText("0.856#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.61#pm  0.5");
   pt_LaTex = pt->AddText("#minus1.88#pm0.575");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.876987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.876987,-35.67795,1.876987,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.5007997);
   ...
   mainFit1037->SetParameter(0,-1.60665);
   mainFit1037->SetParError(0,0.4995351);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8559729);
   mainFit1037->SetParError(1,0.01728777);
