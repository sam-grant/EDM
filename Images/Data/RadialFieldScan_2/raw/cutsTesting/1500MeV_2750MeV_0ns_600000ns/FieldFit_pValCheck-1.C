...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.12344);
   Graph_Graph01023->SetMaximum(50.85825);
   ...
   mainFit1024->SetChisquare(0.5125209);
   ...
   mainFit1024->SetParameter(0,-1.590336);
   mainFit1024->SetParError(0,0.4763458);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8551934);
   mainFit1024->SetParError(1,0.01575);
   ...
   pt_LaTex = pt->AddText("0.855#pm0.0157");
   pt_LaTex = pt->AddText("#minus1.59#pm0.476");
   pt_LaTex = pt->AddText("#minus1.86#pm0.553");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.859622,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.859622,-55.12344,1.859622,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(0.5125209);
   ...
   mainFit1025->SetParameter(0,-1.590336);
   mainFit1025->SetParError(0,0.4763458);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8551934);
   mainFit1025->SetParError(1,0.01575);
