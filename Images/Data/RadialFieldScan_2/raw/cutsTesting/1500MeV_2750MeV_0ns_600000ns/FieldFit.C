...
//=========  (Tue Apr 27 00:13:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.12344);
   Graph_Graph01020->SetMaximum(50.85825);
   ...
   mainFit1021->SetChisquare(0.5125209);
   ...
   mainFit1021->SetParameter(0,-1.590336);
   mainFit1021->SetParError(0,0.4763458);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8551934);
   mainFit1021->SetParError(1,0.01575);
   ...
   mainFit1022->SetChisquare(0.5125209);
   ...
   mainFit1022->SetParameter(0,-1.590336);
   mainFit1022->SetParError(0,0.4763458);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8551934);
   mainFit1022->SetParError(1,0.01575);
