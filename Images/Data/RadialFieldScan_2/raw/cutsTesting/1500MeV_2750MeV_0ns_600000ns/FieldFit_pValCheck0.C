...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-64.1351,50,42.92571);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.42902);
   Graph_Graph01025->SetMaximum(32.21963);
   ...
   mainFit1026->SetChisquare(0.3396976);
   ...
   mainFit1026->SetParameter(0,-1.510926);
   mainFit1026->SetParError(0,0.5132427);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8605407);
   mainFit1026->SetParError(1,0.02032317);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.113");
   pt_LaTex = pt->AddText("0.861#pm0.0203");
   pt_LaTex = pt->AddText("#minus1.51#pm0.513");
   pt_LaTex = pt->AddText("#minus1.76#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.755787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.755787,-53.42902,1.755787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.3396976);
   ...
   mainFit1027->SetParameter(0,-1.510926);
   mainFit1027->SetParError(0,0.5132427);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8605407);
   mainFit1027->SetParError(1,0.02032317);
