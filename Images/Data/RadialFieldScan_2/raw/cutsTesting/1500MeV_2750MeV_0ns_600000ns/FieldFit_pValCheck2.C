...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.12344);
   Graph_Graph01029->SetMaximum(50.85825);
   ...
   mainFit1030->SetChisquare(0.1465682);
   ...
   mainFit1030->SetParameter(0,-1.71297);
   mainFit1030->SetParError(0,0.5176708);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8544739);
   mainFit1030->SetParError(1,0.01579579);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0489");
   pt_LaTex = pt->AddText("0.854#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.71#pm0.518");
   pt_LaTex = pt->AddText("   #minus2#pm0.603");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.004707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.004707,-55.12344,2.004707,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.1465682);
   ...
   mainFit1031->SetParameter(0,-1.71297);
   mainFit1031->SetParError(0,0.5176708);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8544739);
   mainFit1031->SetParError(1,0.01579579);
