...
//=========  (Tue Apr 27 00:13:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01570428);
   Graph_Graph11015->SetMaximum(0.01544587);
   ...
   Graph_Graph21016->SetMinimum(-0.0007026312);
   Graph_Graph21016->SetMaximum(0.0008245382);
   ...
   Graph_Graph31017->SetMinimum(-0.02879315);
   Graph_Graph31017->SetMaximum(0.02872809);
   ...
   Graph_Graph41018->SetMinimum(-0.005792859);
   Graph_Graph41018->SetMaximum(0.007485128);
   ...
   Graph_Graph51019->SetMinimum(-0.004674872);
   Graph_Graph51019->SetMaximum(0.006227989);
