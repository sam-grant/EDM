...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-68.37115,75,64.10596);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-55.12344);
   Graph_Graph01031->SetMaximum(50.85825);
   ...
   mainFit1032->SetChisquare(0.5109198);
   ...
   mainFit1032->SetParameter(0,-1.601257);
   mainFit1032->SetParError(0,0.5486691);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8553693);
   mainFit1032->SetParError(1,0.01630067);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.17");
   pt_LaTex = pt->AddText("0.855#pm0.0163");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.549");
   pt_LaTex = pt->AddText("#minus1.87#pm0.633");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.872007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.872007,-55.12344,1.872007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.5109198);
   ...
   mainFit1033->SetParameter(0,-1.601257);
   mainFit1033->SetParError(0,0.5486691);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8553693);
   mainFit1033->SetParError(1,0.01630067);
