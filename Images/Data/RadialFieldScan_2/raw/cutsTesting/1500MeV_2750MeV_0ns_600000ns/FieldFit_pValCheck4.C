...
//=========  (Tue Apr 27 00:13:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.12344);
   Graph_Graph01033->SetMaximum(50.85825);
   ...
   mainFit1034->SetChisquare(0.2963289);
   ...
   mainFit1034->SetParameter(0,-1.422925);
   mainFit1034->SetParError(0,0.5971455);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8496973);
   mainFit1034->SetParError(1,0.0197023);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0988");
   pt_LaTex = pt->AddText(" 0.85#pm0.0197");
   pt_LaTex = pt->AddText("#minus1.42#pm0.597");
   pt_LaTex = pt->AddText("#minus1.67#pm0.686");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.674626,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.674626,-55.12344,1.674626,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.2963289);
   ...
   mainFit1035->SetParameter(0,-1.422925);
   mainFit1035->SetParError(0,0.5971455);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8496973);
   mainFit1035->SetParError(1,0.0197023);
