...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.19593,70,68.6377);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.31257);
   Graph_Graph01035->SetMaximum(56.75434);
   ...
   mainFit1036->SetChisquare(7.775008);
   ...
   mainFit1036->SetParameter(0,1.448686);
   mainFit1036->SetParError(0,1.592547);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8311105);
   mainFit1036->SetParError(1,0.05527209);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.59");
   pt_LaTex = pt->AddText("0.831#pm0.0553");
   pt_LaTex = pt->AddText(" 1.45#pm 1.59");
   pt_LaTex = pt->AddText(" 1.74#pm 1.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-1.743073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.743073,-38.31257,-1.743073,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.775008);
   ...
   mainFit1037->SetParameter(0,1.448686);
   mainFit1037->SetParError(0,1.592547);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8311105);
   mainFit1037->SetParError(1,0.05527209);
