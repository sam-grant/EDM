...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-78.91516,75,74.38155);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-63.58548);
   Graph_Graph01031->SetMaximum(59.05188);
   ...
   mainFit1032->SetChisquare(0.5553512);
   ...
   mainFit1032->SetParameter(0,-1.395133);
   mainFit1032->SetParError(0,1.74941);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8877821);
   mainFit1032->SetParError(1,0.05206568);
   ...
   pt_LaTex = pt->AddText("0.888#pm0.0521");
   pt_LaTex = pt->AddText(" #minus1.4#pm 1.75");
   pt_LaTex = pt->AddText("#minus1.57#pm 1.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.571481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.571481,-63.58548,1.571481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.5553512);
   ...
   mainFit1033->SetParameter(0,-1.395133);
   mainFit1033->SetParError(0,1.74941);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8877821);
   mainFit1033->SetParError(1,0.05206568);
