...
//=========  (Thu Apr 22 10:00:23 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.538468);
   ...
   quadLineFit1002->SetParameter(0,74.85295);
   quadLineFit1002->SetParError(0,0.2337609);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.91072);
   quadLineFit1002->SetParError(1,3.921379);
   ...
   quadLineFit1003->SetChisquare(1.538468);
   ...
   quadLineFit1003->SetParameter(0,74.85295);
   quadLineFit1003->SetParError(0,0.2337609);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.91072);
   quadLineFit1003->SetParError(1,3.921379);
   ...
   Graph_30_ppm1003->SetMinimum(76.18717);
   Graph_30_ppm1003->SetMaximum(76.91002);
   ...
   quadLineFit1004->SetChisquare(1.794699);
   ...
   quadLineFit1004->SetParameter(0,75.07693);
   quadLineFit1004->SetParError(0,0.1944365);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.93463);
   quadLineFit1004->SetParError(1,3.198537);
   ...
   quadLineFit1005->SetChisquare(1.794699);
   ...
   quadLineFit1005->SetParameter(0,75.07693);
   quadLineFit1005->SetParError(0,0.1944365);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.93463);
   quadLineFit1005->SetParError(1,3.198537);
   ...
   Graph_10_ppm1005->SetMinimum(75.29646);
   Graph_10_ppm1005->SetMaximum(75.60493);
   ...
   quadLineFit1006->SetChisquare(1.805033);
   ...
   quadLineFit1006->SetParameter(0,75.00794);
   quadLineFit1006->SetParError(0,0.2285147);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.572181);
   quadLineFit1006->SetParError(1,3.707806);
   ...
   quadLineFit1007->SetChisquare(1.805033);
   ...
   quadLineFit1007->SetParameter(0,75.00794);
   quadLineFit1007->SetParError(0,0.2285147);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.572181);
   quadLineFit1007->SetParError(1,3.707806);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.17354);
   Graph_mI10_ppm1007->SetMaximum(74.54422);
   ...
   quadLineFit1008->SetChisquare(10.96554);
   ...
   quadLineFit1008->SetParameter(0,74.34933);
   quadLineFit1008->SetParError(0,0.1999834);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,0.4112893);
   quadLineFit1008->SetParError(1,3.257532);
   ...
   quadLineFit1009->SetChisquare(10.96554);
   ...
   quadLineFit1009->SetParameter(0,74.34933);
   quadLineFit1009->SetParError(0,0.1999834);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,0.4112893);
   quadLineFit1009->SetParError(1,3.257532);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.80921);
   Graph_mI30_ppm1009->SetMaximum(73.57181);
   ...
   quadLineFit1010->SetChisquare(0.5456357);
   ...
   quadLineFit1010->SetParameter(0,74.84946);
   quadLineFit1010->SetParError(0,0.1891725);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.11482);
   quadLineFit1010->SetParError(1,3.275508);
   ...
   quadLineFit1011->SetChisquare(0.5456357);
   ...
   quadLineFit1011->SetParameter(0,74.84946);
   quadLineFit1011->SetParError(0,0.1891725);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.11482);
   quadLineFit1011->SetParError(1,3.275508);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.87696);
   Graph_mI50_ppm1011->SetMaximum(72.63121);
   ...
   quadLineFit1012->SetChisquare(0.3014821);
   ...
   quadLineFit1012->SetParameter(0,74.91968);
   quadLineFit1012->SetParError(0,0.3816703);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.53756);
   quadLineFit1012->SetParError(1,6.828145);
   ...
   quadLineFit1013->SetChisquare(0.3014821);
   ...
   quadLineFit1013->SetParameter(0,74.91968);
   quadLineFit1013->SetParError(0,0.3816703);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.53756);
   quadLineFit1013->SetParError(1,6.828145);
