...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.58548);
   Graph_Graph01033->SetMaximum(59.05188);
   ...
   mainFit1034->SetChisquare(7.174482);
   ...
   mainFit1034->SetParameter(0,2.353225);
   mainFit1034->SetParError(0,1.901818);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8071651);
   mainFit1034->SetParError(1,0.0629193);
   ...
   pt_LaTex = pt->AddText("0.807#pm0.0629");
   pt_LaTex = pt->AddText(" 2.35#pm  1.9");
   pt_LaTex = pt->AddText(" 2.92#pm 2.47");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.915419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.915419,-63.58548,-2.915419,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.174482);
   ...
   mainFit1035->SetParameter(0,2.353225);
   mainFit1035->SetParError(0,1.901818);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8071651);
   mainFit1035->SetParError(1,0.0629193);
