...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.08890441);
   Graph_Graph11015->SetMaximum(0.03273895);
   ...
   Graph_Graph21016->SetMinimum(-0.04482016);
   Graph_Graph21016->SetMaximum(0.05280841);
   ...
   Graph_Graph31017->SetMinimum(-0.1397236);
   Graph_Graph31017->SetMaximum(0.1090073);
   ...
   Graph_Graph41018->SetMinimum(-0.02788769);
   Graph_Graph41018->SetMaximum(0.02383405);
   ...
   Graph_Graph51019->SetMinimum(-0.01703518);
   Graph_Graph51019->SetMaximum(0.02272045);
