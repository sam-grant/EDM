...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.58548);
   Graph_Graph01023->SetMaximum(59.05188);
   ...
   mainFit1024->SetChisquare(8.474872);
   ...
   mainFit1024->SetParameter(0,1.047965);
   mainFit1024->SetParError(0,1.518803);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8502285);
   mainFit1024->SetParError(1,0.05032653);
   ...
   pt_LaTex = pt->AddText(" 0.85#pm0.0503");
   pt_LaTex = pt->AddText(" 1.05#pm 1.52");
   pt_LaTex = pt->AddText(" 1.23#pm  1.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.232568,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.232568,-63.58548,-1.232568,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(8.474872);
   ...
   mainFit1025->SetParameter(0,1.047965);
   mainFit1025->SetParError(0,1.518803);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8502285);
   mainFit1025->SetParError(1,0.05032653);
