...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.58548);
   Graph_Graph01020->SetMaximum(59.05188);
   ...
   mainFit1021->SetChisquare(8.474872);
   ...
   mainFit1021->SetParameter(0,1.047965);
   mainFit1021->SetParError(0,1.518803);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8502285);
   mainFit1021->SetParError(1,0.05032653);
   ...
   mainFit1022->SetChisquare(8.474872);
   ...
   mainFit1022->SetParameter(0,1.047965);
   mainFit1022->SetParError(0,1.518803);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8502285);
   mainFit1022->SetParError(1,0.05032653);
