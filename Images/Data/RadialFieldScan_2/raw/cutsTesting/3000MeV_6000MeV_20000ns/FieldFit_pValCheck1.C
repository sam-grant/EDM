...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-63.58548);
   Graph_Graph01027->SetMaximum(59.05188);
   ...
   mainFit1028->SetChisquare(7.395849);
   ...
   mainFit1028->SetParameter(0,1.850029);
   mainFit1028->SetParError(0,1.703807);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8765895);
   mainFit1028->SetParError(1,0.05636285);
   ...
   pt_LaTex = pt->AddText("0.877#pm0.0564");
   pt_LaTex = pt->AddText(" 1.85#pm  1.7");
   pt_LaTex = pt->AddText(" 2.11#pm 1.94");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.110485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.110485,-63.58548,-2.110485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(7.395849);
   ...
   mainFit1029->SetParameter(0,1.850029);
   mainFit1029->SetParError(0,1.703807);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8765895);
   mainFit1029->SetParError(1,0.05636285);
