...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.58548);
   Graph_Graph01029->SetMaximum(59.05188);
   ...
   mainFit1030->SetChisquare(7.69875);
   ...
   mainFit1030->SetParameter(0,1.61802);
   mainFit1030->SetParError(0,1.650862);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8536966);
   mainFit1030->SetParError(1,0.05048141);
   ...
   pt_LaTex = pt->AddText("0.854#pm0.0505");
   pt_LaTex = pt->AddText(" 1.62#pm 1.65");
   pt_LaTex = pt->AddText("  1.9#pm 1.95");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.89531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.89531,-63.58548,-1.89531,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.69875);
   ...
   mainFit1031->SetParameter(0,1.61802);
   mainFit1031->SetParError(0,1.650862);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8536966);
   mainFit1031->SetParError(1,0.05048141);
