...
//=========  (Thu Apr 22 10:00:24 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.49042,50,47.25788);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.41559);
   Graph_Graph01025->SetMaximum(35.18305);
   ...
   mainFit1026->SetChisquare(8.244758);
   ...
   mainFit1026->SetParameter(0,0.7570699);
   mainFit1026->SetParError(0,1.635386);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.830701);
   mainFit1026->SetParError(1,0.06472778);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.75");
   pt_LaTex = pt->AddText("0.831#pm0.0647");
   pt_LaTex = pt->AddText("0.757#pm 1.64");
   pt_LaTex = pt->AddText("0.911#pm 1.96");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-0.9113627,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9113627,-61.41559,-0.9113627,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(8.244758);
   ...
   mainFit1027->SetParameter(0,0.7570699);
   mainFit1027->SetParError(0,1.635386);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.830701);
   mainFit1027->SetParError(1,0.06472778);
