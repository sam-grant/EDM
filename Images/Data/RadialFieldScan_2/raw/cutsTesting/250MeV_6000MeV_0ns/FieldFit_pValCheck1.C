...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.65452);
   Graph_Graph01027->SetMaximum(54.78975);
   ...
   mainFit1028->SetChisquare(5.547904);
   ...
   mainFit1028->SetParameter(0,-2.049068);
   mainFit1028->SetParError(0,0.3539786);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9345333);
   mainFit1028->SetParError(1,0.01178687);
   ...
   pt_LaTex = pt->AddText("0.935#pm0.0118");
   pt_LaTex = pt->AddText("#minus2.05#pm0.354");
   pt_LaTex = pt->AddText("#minus2.19#pm0.382");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.192611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.192611,-57.65452,2.192611,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(5.547904);
   ...
   mainFit1029->SetParameter(0,-2.049068);
   mainFit1029->SetParError(0,0.3539786);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9345333);
   mainFit1029->SetParError(1,0.01178687);
