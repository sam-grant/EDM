...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.65452);
   Graph_Graph01023->SetMaximum(54.78975);
   ...
   mainFit1024->SetChisquare(5.863972);
   ...
   mainFit1024->SetParameter(0,-1.957507);
   mainFit1024->SetParError(0,0.3143284);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9375827);
   mainFit1024->SetParError(1,0.01046903);
   ...
   mainFit1025->SetChisquare(5.863972);
   ...
   mainFit1025->SetParameter(0,-1.957507);
   mainFit1025->SetParError(0,0.3143284);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9375827);
   mainFit1025->SetParError(1,0.01046903);
