...
//=========  (Wed Apr 21 14:32:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-57.65452);
   Graph_Graph01031->SetMaximum(54.78975);
   ...
   mainFit1032->SetChisquare(3.062472);
   ...
   mainFit1032->SetParameter(0,-1.65792);
   mainFit1032->SetParError(0,0.3617191);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9330179);
   mainFit1032->SetParError(1,0.01081873);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0108");
   pt_LaTex = pt->AddText("#minus1.66#pm0.362");
   pt_LaTex = pt->AddText("#minus1.78#pm0.383");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.776944,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.776944,-57.65452,1.776944,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.062472);
   ...
   mainFit1033->SetParameter(0,-1.65792);
   mainFit1033->SetParError(0,0.3617191);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9330179);
   mainFit1033->SetParError(1,0.01081873);
