...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02189207);
   Graph_Graph11015->SetMaximum(0.01467541);
   ...
   Graph_Graph21016->SetMinimum(-0.01481987);
   Graph_Graph21016->SetMaximum(0.01734969);
   ...
   Graph_Graph31017->SetMinimum(-0.02170888);
   Graph_Graph31017->SetMaximum(0.02235964);
   ...
   Graph_Graph41018->SetMinimum(-0.008246684);
   Graph_Graph41018->SetMaximum(0.0172765);
   ...
   Graph_Graph51019->SetMinimum(-0.002740483);
   Graph_Graph51019->SetMaximum(0.002058553);
