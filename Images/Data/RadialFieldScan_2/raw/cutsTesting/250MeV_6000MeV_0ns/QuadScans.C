...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(11.1675);
   ...
   quadLineFit1002->SetParameter(0,74.61533);
   quadLineFit1002->SetParError(0,0.04940095);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.59097);
   quadLineFit1002->SetParError(1,0.8284224);
   ...
   quadLineFit1003->SetChisquare(11.1675);
   ...
   quadLineFit1003->SetParameter(0,74.61533);
   quadLineFit1003->SetParError(0,0.04940095);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.59097);
   quadLineFit1003->SetParError(1,0.8284224);
   ...
   Graph_30_ppm1003->SetMinimum(75.83192);
   Graph_30_ppm1003->SetMaximum(76.49025);
   ...
   quadLineFit1004->SetChisquare(3.75383);
   ...
   quadLineFit1004->SetParameter(0,74.5293);
   quadLineFit1004->SetParError(0,0.04023277);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,26.46113);
   quadLineFit1004->SetParError(1,0.6606724);
   ...
   quadLineFit1005->SetChisquare(3.75383);
   ...
   quadLineFit1005->SetParameter(0,74.5293);
   quadLineFit1005->SetParError(0,0.04023277);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,26.46113);
   quadLineFit1005->SetParError(1,0.6606724);
   ...
   Graph_10_ppm1005->SetMinimum(74.82617);
   Graph_10_ppm1005->SetMaximum(75.06036);
   ...
   quadLineFit1006->SetChisquare(4.651529);
   ...
   quadLineFit1006->SetParameter(0,74.42064);
   quadLineFit1006->SetParError(0,0.04729503);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.313178);
   quadLineFit1006->SetParError(1,0.7665624);
   ...
   quadLineFit1007->SetChisquare(4.651529);
   ...
   quadLineFit1007->SetParameter(0,74.42064);
   quadLineFit1007->SetParError(0,0.04729503);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.313178);
   quadLineFit1007->SetParError(1,0.7665624);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.53617);
   Graph_mI10_ppm1007->SetMaximum(73.87526);
   ...
   quadLineFit1008->SetChisquare(7.277992);
   ...
   quadLineFit1008->SetParameter(0,74.45843);
   quadLineFit1008->SetParError(0,0.04145781);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-12.30252);
   quadLineFit1008->SetParError(1,0.6743249);
   ...
   quadLineFit1009->SetChisquare(7.277992);
   ...
   quadLineFit1009->SetParameter(0,74.45843);
   quadLineFit1009->SetParError(0,0.04145781);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-12.30252);
   quadLineFit1009->SetParError(1,0.6743249);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.13108);
   Graph_mI30_ppm1009->SetMaximum(72.8962);
   ...
   quadLineFit1010->SetChisquare(2.136784);
   ...
   quadLineFit1010->SetParameter(0,74.38044);
   quadLineFit1010->SetParError(0,0.03904767);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.34201);
   quadLineFit1010->SetParError(1,0.6752839);
   ...
   quadLineFit1011->SetChisquare(2.136784);
   ...
   quadLineFit1011->SetParameter(0,74.38044);
   quadLineFit1011->SetParError(0,0.03904767);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.34201);
   quadLineFit1011->SetParError(1,0.6752839);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.25014);
   Graph_mI50_ppm1011->SetMaximum(71.9081);
   ...
   quadLineFit1012->SetChisquare(0.1028461);
   ...
   quadLineFit1012->SetParameter(0,74.24529);
   quadLineFit1012->SetParError(0,0.07883023);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.87405);
   quadLineFit1012->SetParError(1,1.410115);
   ...
   quadLineFit1013->SetChisquare(0.1028461);
   ...
   quadLineFit1013->SetParameter(0,74.24529);
   quadLineFit1013->SetParError(0,0.07883023);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.87405);
   quadLineFit1013->SetParError(1,1.410115);
