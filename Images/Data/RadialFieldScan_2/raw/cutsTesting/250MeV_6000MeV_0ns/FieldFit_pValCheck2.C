...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.65452);
   Graph_Graph01029->SetMaximum(54.78975);
   ...
   mainFit1030->SetChisquare(4.221546);
   ...
   mainFit1030->SetParameter(0,-2.129976);
   mainFit1030->SetParError(0,0.3419237);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9364616);
   mainFit1030->SetParError(1,0.01050566);
   ...
   pt_LaTex = pt->AddText("0.936#pm0.0105");
   pt_LaTex = pt->AddText("#minus2.13#pm0.342");
   pt_LaTex = pt->AddText("#minus2.27#pm0.363");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.274494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.274494,-57.65452,2.274494,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.221546);
   ...
   mainFit1031->SetParameter(0,-2.129976);
   mainFit1031->SetParError(0,0.3419237);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9364616);
   mainFit1031->SetParError(1,0.01050566);
