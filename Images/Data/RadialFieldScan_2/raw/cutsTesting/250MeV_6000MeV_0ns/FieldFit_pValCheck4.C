...
//=========  (Wed Apr 21 14:32:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.71005,75,68.84528);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-57.65452);
   Graph_Graph01033->SetMaximum(54.78975);
   ...
   mainFit1034->SetChisquare(5.576343);
   ...
   mainFit1034->SetParameter(0,-1.830658);
   mainFit1034->SetParError(0,0.3933827);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9333626);
   mainFit1034->SetParError(1,0.01309913);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0131");
   pt_LaTex = pt->AddText("#minus1.83#pm0.393");
   pt_LaTex = pt->AddText("#minus1.96#pm 0.41");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.961358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.961358,-57.65452,1.961358,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.576343);
   ...
   mainFit1035->SetParameter(0,-1.830658);
   mainFit1035->SetParError(0,0.3933827);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9333626);
   mainFit1035->SetParError(1,0.01309913);
