...
//=========  (Wed Apr 21 14:32:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.65452);
   Graph_Graph01020->SetMaximum(54.78975);
   ...
   mainFit1021->SetChisquare(5.863972);
   ...
   mainFit1021->SetParameter(0,-1.957507);
   mainFit1021->SetParError(0,0.3143284);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9375827);
   mainFit1021->SetParError(1,0.01046903);
   ...
   pt_LaTex = pt->AddText("0.938#pm0.0105");
   pt_LaTex = pt->AddText("#minus1.96#pm0.314");
   pt_LaTex = pt->AddText("#minus2.09#pm0.333");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.087823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.087823,-57.65452,2.087823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.863972);
   ...
   mainFit1022->SetParameter(0,-1.957507);
   mainFit1022->SetParError(0,0.3143284);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9375827);
   mainFit1022->SetParError(1,0.01046903);
