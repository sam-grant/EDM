...
//=========  (Wed Apr 21 14:32:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.12646,70,64.52856);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.66096);
   Graph_Graph01035->SetMaximum(53.06306);
   ...
   mainFit1036->SetChisquare(3.405958);
   ...
   mainFit1036->SetParameter(0,-2.111552);
   mainFit1036->SetParError(0,0.3293261);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.945054);
   mainFit1036->SetParError(1,0.011502);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0115");
   pt_LaTex = pt->AddText("#minus2.11#pm0.329");
   pt_LaTex = pt->AddText("#minus2.23#pm0.343");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.234319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.234319,-38.66096,2.234319,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.405958);
   ...
   mainFit1037->SetParameter(0,-2.111552);
   mainFit1037->SetParError(0,0.3293261);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.945054);
   mainFit1037->SetParError(1,0.011502);
