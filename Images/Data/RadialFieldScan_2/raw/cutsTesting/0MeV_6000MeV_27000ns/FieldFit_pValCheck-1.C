...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.01586);
   Graph_Graph01023->SetMaximum(55.87049);
   ...
   mainFit1024->SetChisquare(2.709953);
   ...
   mainFit1024->SetParameter(0,-1.955586);
   mainFit1024->SetParError(0,0.3879811);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.925799);
   mainFit1024->SetParError(1,0.01274235);
   ...
   mainFit1025->SetChisquare(2.709953);
   ...
   mainFit1025->SetParameter(0,-1.955586);
   mainFit1025->SetParError(0,0.3879811);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.925799);
   mainFit1025->SetParError(1,0.01274235);
