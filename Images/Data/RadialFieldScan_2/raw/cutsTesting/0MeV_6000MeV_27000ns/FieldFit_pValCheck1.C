...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-74.50166,75,70.35629);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-60.01586);
   Graph_Graph01027->SetMaximum(55.87049);
   ...
   mainFit1028->SetChisquare(0.4833353);
   ...
   mainFit1028->SetParameter(0,-1.669547);
   mainFit1028->SetParError(0,0.4327528);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9349984);
   mainFit1028->SetParError(1,0.01415543);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.161");
   pt_LaTex = pt->AddText("0.935#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.67#pm0.433");
   pt_LaTex = pt->AddText("#minus1.79#pm0.465");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.785615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.785615,-60.01586,1.785615,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4833353);
   ...
   mainFit1029->SetParameter(0,-1.669547);
   mainFit1029->SetParError(0,0.4327528);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9349984);
   mainFit1029->SetParError(1,0.01415543);
