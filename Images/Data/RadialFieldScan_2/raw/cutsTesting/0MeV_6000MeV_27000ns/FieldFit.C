...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-60.01586);
   Graph_Graph01020->SetMaximum(55.87049);
   ...
   mainFit1021->SetChisquare(2.709953);
   ...
   mainFit1021->SetParameter(0,-1.955586);
   mainFit1021->SetParError(0,0.3879811);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.925799);
   mainFit1021->SetParError(1,0.01274235);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.677");
   pt_LaTex = pt->AddText("0.926#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.96#pm0.388");
   pt_LaTex = pt->AddText("#minus2.11#pm0.415");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.112322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.112322,-60.01586,2.112322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.709953);
   ...
   mainFit1022->SetParameter(0,-1.955586);
   mainFit1022->SetParError(0,0.3879811);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.925799);
   mainFit1022->SetParError(1,0.01274235);
