...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.01586);
   Graph_Graph01033->SetMaximum(55.87049);
   ...
   mainFit1034->SetChisquare(2.270003);
   ...
   mainFit1034->SetParameter(0,-2.151032);
   mainFit1034->SetParError(0,0.4871915);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.932151);
   mainFit1034->SetParError(1,0.01593974);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.757");
   pt_LaTex = pt->AddText("0.932#pm0.0159");
   pt_LaTex = pt->AddText("#minus2.15#pm0.487");
   pt_LaTex = pt->AddText("#minus2.31#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.307601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.307601,-60.01586,2.307601,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.270003);
   ...
   mainFit1035->SetParameter(0,-2.151032);
   mainFit1035->SetParError(0,0.4871915);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.932151);
   mainFit1035->SetParError(1,0.01593974);
