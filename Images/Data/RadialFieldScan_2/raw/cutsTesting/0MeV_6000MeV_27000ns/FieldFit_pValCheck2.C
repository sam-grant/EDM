...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.01586);
   Graph_Graph01029->SetMaximum(55.87049);
   ...
   mainFit1030->SetChisquare(2.594698);
   ...
   mainFit1030->SetParameter(0,-2.011316);
   mainFit1030->SetParError(0,0.4212825);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9254933);
   mainFit1030->SetParError(1,0.012774);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.865");
   pt_LaTex = pt->AddText("0.925#pm0.0128");
   pt_LaTex = pt->AddText("#minus2.01#pm0.421");
   pt_LaTex = pt->AddText("#minus2.17#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.173237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.173237,-60.01586,2.173237,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.594698);
   ...
   mainFit1031->SetParameter(0,-2.011316);
   mainFit1031->SetParError(0,0.4212825);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9254933);
   mainFit1031->SetParError(1,0.012774);
