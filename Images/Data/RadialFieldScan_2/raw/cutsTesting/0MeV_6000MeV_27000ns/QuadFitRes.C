...
//=========  (Wed Apr 21 16:03:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01009676);
   Graph_Graph11015->SetMaximum(0.0108177);
   ...
   Graph_Graph21016->SetMinimum(-0.008050699);
   Graph_Graph21016->SetMaximum(0.009461124);
   ...
   Graph_Graph31017->SetMinimum(-0.02145375);
   Graph_Graph31017->SetMaximum(0.0186626);
   ...
   Graph_Graph41018->SetMinimum(-0.005287831);
   Graph_Graph41018->SetMaximum(0.01014665);
   ...
   Graph_Graph51019->SetMinimum(-0.001924513);
   Graph_Graph51019->SetMaximum(0.00257127);
