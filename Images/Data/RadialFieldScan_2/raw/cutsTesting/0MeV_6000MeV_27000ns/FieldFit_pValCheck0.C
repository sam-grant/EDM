...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.36434,50,44.66969);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.96093);
   Graph_Graph01025->SetMaximum(33.26629);
   ...
   mainFit1026->SetChisquare(0.9474764);
   ...
   mainFit1026->SetParameter(0,-2.165428);
   mainFit1026->SetParError(0,0.418943);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.911699);
   mainFit1026->SetParError(1,0.01658824);
   ...
   pt_LaTex = pt->AddText("0.912#pm0.0166");
   pt_LaTex = pt->AddText("#minus2.17#pm0.419");
   pt_LaTex = pt->AddText("#minus2.38#pm0.467");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.375156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.375156,-57.96093,2.375156,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.9474764);
   ...
   mainFit1027->SetParameter(0,-2.165428);
   mainFit1027->SetParError(0,0.418943);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.911699);
   mainFit1027->SetParError(1,0.01658824);
