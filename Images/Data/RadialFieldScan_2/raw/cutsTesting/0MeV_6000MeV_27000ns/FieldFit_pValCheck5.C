...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.26897,70,65.30975);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.8111);
   Graph_Graph01035->SetMaximum(53.85188);
   ...
   mainFit1036->SetChisquare(2.656158);
   ...
   mainFit1036->SetParameter(0,-1.926881);
   mainFit1036->SetParError(0,0.4072419);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9244646);
   mainFit1036->SetParError(1,0.01398102);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.885");
   pt_LaTex = pt->AddText("0.924#pm0.014");
   pt_LaTex = pt->AddText("#minus1.93#pm0.407");
   pt_LaTex = pt->AddText("#minus2.08#pm0.433");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.084321,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.084321,-37.8111,2.084321,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.656158);
   ...
   mainFit1037->SetParameter(0,-1.926881);
   mainFit1037->SetParError(0,0.4072419);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9244646);
   mainFit1037->SetParError(1,0.01398102);
