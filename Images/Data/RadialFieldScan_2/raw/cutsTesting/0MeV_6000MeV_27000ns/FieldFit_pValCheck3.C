...
//=========  (Wed Apr 21 16:03:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.01586);
   Graph_Graph01031->SetMaximum(55.87049);
   ...
   mainFit1032->SetChisquare(2.631046);
   ...
   mainFit1032->SetParameter(0,-1.893287);
   mainFit1032->SetParError(0,0.4468948);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9248313);
   mainFit1032->SetParError(1,0.01319984);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.89#pm0.447");
   pt_LaTex = pt->AddText("#minus2.05#pm0.476");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.04717,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.04717,-60.01586,2.04717,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.631046);
   ...
   mainFit1033->SetParameter(0,-1.893287);
   mainFit1033->SetParError(0,0.4468948);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9248313);
   mainFit1033->SetParError(1,0.01319984);
