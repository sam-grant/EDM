...
//=========  (Mon Apr 26 21:25:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.47042);
   Graph_Graph01027->SetMaximum(54.93317);
   ...
   mainFit1028->SetChisquare(0.9123592);
   ...
   mainFit1028->SetParameter(0,-1.655399);
   mainFit1028->SetParError(0,0.4160314);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9267196);
   mainFit1028->SetParError(1,0.01371389);
   ...
   pt_LaTex = pt->AddText("#minus1.66#pm0.416");
   pt_LaTex = pt->AddText("#minus1.79#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.7863,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.7863,-58.47042,1.7863,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.9123592);
   ...
   mainFit1029->SetParameter(0,-1.655399);
   mainFit1029->SetParError(0,0.4160314);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9267196);
   mainFit1029->SetParError(1,0.01371389);
