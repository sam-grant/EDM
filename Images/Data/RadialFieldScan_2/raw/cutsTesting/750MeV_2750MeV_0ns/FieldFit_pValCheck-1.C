...
//=========  (Mon Apr 26 21:25:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.47042);
   Graph_Graph01023->SetMaximum(54.93317);
   ...
   mainFit1024->SetChisquare(1.672336);
   ...
   mainFit1024->SetParameter(0,-1.818434);
   mainFit1024->SetParError(0,0.3716103);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9213894);
   mainFit1024->SetParError(1,0.01227932);
   ...
   mainFit1025->SetChisquare(1.672336);
   ...
   mainFit1025->SetParameter(0,-1.818434);
   mainFit1025->SetParError(0,0.3716103);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9213894);
   mainFit1025->SetParError(1,0.01227932);
