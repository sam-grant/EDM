...
//=========  (Mon Apr 26 21:25:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.47042);
   Graph_Graph01031->SetMaximum(54.93317);
   ...
   mainFit1032->SetChisquare(1.495915);
   ...
   mainFit1032->SetParameter(0,-1.729275);
   mainFit1032->SetParError(0,0.4279949);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9200206);
   mainFit1032->SetParError(1,0.01270904);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.499");
   pt_LaTex = pt->AddText(" 0.92#pm0.0127");
   pt_LaTex = pt->AddText("#minus1.73#pm0.428");
   pt_LaTex = pt->AddText("#minus1.88#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.879604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.879604,-58.47042,1.879604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.495915);
   ...
   mainFit1033->SetParameter(0,-1.729275);
   mainFit1033->SetParError(0,0.4279949);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9200206);
   mainFit1033->SetParError(1,0.01270904);
