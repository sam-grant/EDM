...
//=========  (Mon Apr 26 21:25:05 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.79178,50,44.83817);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.52878);
   Graph_Graph01025->SetMaximum(33.57518);
   ...
   mainFit1026->SetChisquare(1.498944);
   ...
   mainFit1026->SetParameter(0,-1.880642);
   mainFit1026->SetParError(0,0.400492);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9172191);
   mainFit1026->SetParError(1,0.01585707);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  0.5");
   pt_LaTex = pt->AddText("0.917#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.88#pm  0.4");
   pt_LaTex = pt->AddText("#minus2.05#pm0.442");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.050373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.050373,-56.52878,2.050373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.498944);
   ...
   mainFit1027->SetParameter(0,-1.880642);
   mainFit1027->SetParError(0,0.400492);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9172191);
   mainFit1027->SetParError(1,0.01585707);
