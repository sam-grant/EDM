...
//=========  (Mon Apr 26 21:25:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01007395);
   Graph_Graph11015->SetMaximum(0.01304516);
   ...
   Graph_Graph21016->SetMinimum(-0.010407);
   Graph_Graph21016->SetMaximum(0.01221505);
   ...
   Graph_Graph31017->SetMinimum(-0.02020368);
   Graph_Graph31017->SetMaximum(0.01821779);
   ...
   Graph_Graph41018->SetMinimum(-0.01432937);
   Graph_Graph41018->SetMaximum(0.01698216);
   ...
   Graph_Graph51019->SetMinimum(-0.006323324);
   Graph_Graph51019->SetMaximum(0.008434877);
