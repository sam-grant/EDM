...
//=========  (Mon Apr 26 21:25:05 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.274509);
   ...
   quadLineFit1002->SetParameter(0,74.55152);
   quadLineFit1002->SetParError(0,0.05661193);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.53369);
   quadLineFit1002->SetParError(1,0.9491804);
   ...
   quadLineFit1003->SetChisquare(4.274509);
   ...
   quadLineFit1003->SetParameter(0,74.55152);
   quadLineFit1003->SetParError(0,0.05661193);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.53369);
   quadLineFit1003->SetParError(1,0.9491804);
   ...
   Graph_30_ppm1003->SetMinimum(75.77974);
   Graph_30_ppm1003->SetMaximum(76.41131);
   ...
   quadLineFit1004->SetChisquare(1.491431);
   ...
   quadLineFit1004->SetParameter(0,74.53787);
   quadLineFit1004->SetParError(0,0.0477035);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.28291);
   quadLineFit1004->SetParError(1,0.7836007);
   ...
   quadLineFit1005->SetChisquare(1.491431);
   ...
   quadLineFit1005->SetParameter(0,74.53787);
   quadLineFit1005->SetParError(0,0.0477035);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.28291);
   quadLineFit1005->SetParError(1,0.7836007);
   ...
   Graph_10_ppm1005->SetMinimum(74.81136);
   Graph_10_ppm1005->SetMaximum(75.04648);
   ...
   quadLineFit1006->SetChisquare(1.641111);
   ...
   quadLineFit1006->SetParameter(0,74.41471);
   quadLineFit1006->SetParError(0,0.05593771);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.231214);
   quadLineFit1006->SetParError(1,0.9067771);
   ...
   quadLineFit1007->SetChisquare(1.641111);
   ...
   quadLineFit1007->SetParameter(0,74.41471);
   quadLineFit1007->SetParError(0,0.05593771);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.231214);
   quadLineFit1007->SetParError(1,0.9067771);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.58818);
   Graph_mI10_ppm1007->SetMaximum(73.90828);
   ...
   quadLineFit1008->SetChisquare(3.352374);
   ...
   quadLineFit1008->SetParameter(0,74.43352);
   quadLineFit1008->SetParError(0,0.04907041);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.32018);
   quadLineFit1008->SetParError(1,0.7982815);
   ...
   quadLineFit1009->SetChisquare(3.352374);
   ...
   quadLineFit1009->SetParameter(0,74.43352);
   quadLineFit1009->SetParError(0,0.04907041);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.32018);
   quadLineFit1009->SetParError(1,0.7982815);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.2065);
   Graph_mI30_ppm1009->SetMaximum(72.95439);
   ...
   quadLineFit1010->SetChisquare(3.343192);
   ...
   quadLineFit1010->SetParameter(0,74.40813);
   quadLineFit1010->SetParError(0,0.04636228);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.58348);
   quadLineFit1010->SetParError(1,0.8019097);
   ...
   quadLineFit1011->SetChisquare(3.343192);
   ...
   quadLineFit1011->SetParameter(0,74.40813);
   quadLineFit1011->SetParError(0,0.04636228);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.58348);
   quadLineFit1011->SetParError(1,0.8019097);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.30345);
   Graph_mI50_ppm1011->SetMaximum(71.97193);
   ...
   quadLineFit1012->SetChisquare(0.6892598);
   ...
   quadLineFit1012->SetParameter(0,74.33726);
   quadLineFit1012->SetParError(0,0.0936274);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.34517);
   quadLineFit1012->SetParError(1,1.674954);
   ...
   quadLineFit1013->SetChisquare(0.6892598);
   ...
   quadLineFit1013->SetParameter(0,74.33726);
   quadLineFit1013->SetParError(0,0.0936274);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.34517);
   quadLineFit1013->SetParError(1,1.674954);
