...
//=========  (Mon Apr 26 21:25:05 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.47042);
   Graph_Graph01020->SetMaximum(54.93317);
   ...
   mainFit1021->SetChisquare(1.672336);
   ...
   mainFit1021->SetParameter(0,-1.818434);
   mainFit1021->SetParError(0,0.3716103);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9213894);
   mainFit1021->SetParError(1,0.01227932);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.418");
   pt_LaTex = pt->AddText("0.921#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.82#pm0.372");
   pt_LaTex = pt->AddText("#minus1.97#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.973578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.973578,-58.47042,1.973578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.672336);
   ...
   mainFit1022->SetParameter(0,-1.818434);
   mainFit1022->SetParError(0,0.3716103);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9213894);
   mainFit1022->SetParError(1,0.01227932);
