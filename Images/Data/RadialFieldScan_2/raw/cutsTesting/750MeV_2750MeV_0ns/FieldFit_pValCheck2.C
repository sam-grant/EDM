...
//=========  (Mon Apr 26 21:25:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-58.47042);
   Graph_Graph01029->SetMaximum(54.93317);
   ...
   mainFit1030->SetChisquare(0.6510053);
   ...
   mainFit1030->SetParameter(0,-1.978219);
   mainFit1030->SetParError(0,0.4038368);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9204549);
   mainFit1030->SetParError(1,0.01231464);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.217");
   pt_LaTex = pt->AddText(" 0.92#pm0.0123");
   pt_LaTex = pt->AddText("#minus1.98#pm0.404");
   pt_LaTex = pt->AddText("#minus2.15#pm0.436");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.149175,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.149175,-58.47042,2.149175,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.6510053);
   ...
   mainFit1031->SetParameter(0,-1.978219);
   mainFit1031->SetParError(0,0.4038368);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9204549);
   mainFit1031->SetParError(1,0.01231464);
