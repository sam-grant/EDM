...
//=========  (Mon Apr 26 21:25:06 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.64587,75,69.10862);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-58.47042);
   Graph_Graph01033->SetMaximum(54.93317);
   ...
   mainFit1034->SetChisquare(1.625706);
   ...
   mainFit1034->SetParameter(0,-1.757779);
   mainFit1034->SetParError(0,0.4658976);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9194045);
   mainFit1034->SetParError(1,0.01535978);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.542");
   pt_LaTex = pt->AddText("0.919#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.76#pm0.466");
   pt_LaTex = pt->AddText("#minus1.91#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.911867,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.911867,-58.47042,1.911867,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.625706);
   ...
   mainFit1035->SetParameter(0,-1.757779);
   mainFit1035->SetParError(0,0.4658976);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9194045);
   mainFit1035->SetParError(1,0.01535978);
