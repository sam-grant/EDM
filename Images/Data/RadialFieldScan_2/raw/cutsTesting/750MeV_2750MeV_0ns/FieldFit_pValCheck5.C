...
//=========  (Mon Apr 26 21:25:06 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-49.35246,70,64.44993);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.97222);
   Graph_Graph01035->SetMaximum(53.06969);
   ...
   mainFit1036->SetChisquare(1.539254);
   ...
   mainFit1036->SetParameter(0,-1.861327);
   mainFit1036->SetParError(0,0.3897461);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9234248);
   mainFit1036->SetParError(1,0.01347892);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0135");
   pt_LaTex = pt->AddText("#minus1.86#pm 0.39");
   pt_LaTex = pt->AddText("#minus2.02#pm0.415");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.015677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.015677,-37.97222,2.015677,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.539254);
   ...
   mainFit1037->SetParameter(0,-1.861327);
   mainFit1037->SetParError(0,0.3897461);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9234248);
   mainFit1037->SetParError(1,0.01347892);
