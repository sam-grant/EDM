...
//=========  (Fri Apr 23 21:17:37 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.4998345);
   ...
   quadLineFit1002->SetParameter(0,74.51899);
   quadLineFit1002->SetParError(0,0.06506026);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.98891);
   quadLineFit1002->SetParError(1,1.091311);
   ...
   quadLineFit1003->SetChisquare(0.4998345);
   ...
   quadLineFit1003->SetParameter(0,74.51899);
   quadLineFit1003->SetParError(0,0.06506026);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.98891);
   quadLineFit1003->SetParError(1,1.091311);
   ...
   Graph_30_ppm1003->SetMinimum(75.78909);
   Graph_30_ppm1003->SetMaximum(76.37976);
   ...
   quadLineFit1004->SetChisquare(1.253467);
   ...
   quadLineFit1004->SetParameter(0,74.63889);
   quadLineFit1004->SetParError(0,0.05477444);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.49459);
   quadLineFit1004->SetParError(1,0.9002628);
   ...
   quadLineFit1005->SetChisquare(1.253467);
   ...
   quadLineFit1005->SetParameter(0,74.63889);
   quadLineFit1005->SetParError(0,0.05477444);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.49459);
   quadLineFit1005->SetParError(1,0.9002628);
   ...
   Graph_10_ppm1005->SetMinimum(74.81403);
   Graph_10_ppm1005->SetMaximum(75.05048);
   ...
   quadLineFit1006->SetChisquare(2.240607);
   ...
   quadLineFit1006->SetParameter(0,74.42793);
   quadLineFit1006->SetParError(0,0.06414393);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.02086);
   quadLineFit1006->SetParError(1,1.040291);
   ...
   quadLineFit1007->SetChisquare(2.240607);
   ...
   quadLineFit1007->SetParameter(0,74.42793);
   quadLineFit1007->SetParError(0,0.06414393);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.02086);
   quadLineFit1007->SetParError(1,1.040291);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.59872);
   Graph_mI10_ppm1007->SetMaximum(73.91132);
   ...
   quadLineFit1008->SetChisquare(7.334216);
   ...
   quadLineFit1008->SetParameter(0,74.38509);
   quadLineFit1008->SetParError(0,0.05635259);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.41462);
   quadLineFit1008->SetParError(1,0.9172324);
   ...
   quadLineFit1009->SetChisquare(7.334216);
   ...
   quadLineFit1009->SetParameter(0,74.38509);
   quadLineFit1009->SetParError(0,0.05635259);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.41462);
   quadLineFit1009->SetParError(1,0.9172324);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.24454);
   Graph_mI30_ppm1009->SetMaximum(72.93399);
   ...
   quadLineFit1010->SetChisquare(2.666849);
   ...
   quadLineFit1010->SetParameter(0,74.27374);
   quadLineFit1010->SetParError(0,0.05327948);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.27253);
   quadLineFit1010->SetParError(1,0.9220898);
   ...
   quadLineFit1011->SetChisquare(2.666849);
   ...
   quadLineFit1011->SetParameter(0,74.27374);
   quadLineFit1011->SetParError(0,0.05327948);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.27253);
   quadLineFit1011->SetParError(1,0.9220898);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.3209);
   Graph_mI50_ppm1011->SetMaximum(71.95907);
   ...
   quadLineFit1012->SetChisquare(0.4895098);
   ...
   quadLineFit1012->SetParameter(0,74.19136);
   quadLineFit1012->SetParError(0,0.107579);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.73935);
   quadLineFit1012->SetParError(1,1.924934);
   ...
   quadLineFit1013->SetChisquare(0.4895098);
   ...
   quadLineFit1013->SetParameter(0,74.19136);
   quadLineFit1013->SetParError(0,0.107579);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.73935);
   quadLineFit1013->SetParError(1,1.924934);
