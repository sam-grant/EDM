...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.93874);
   Graph_Graph01029->SetMaximum(55.35467);
   ...
   mainFit1030->SetChisquare(7.928871);
   ...
   mainFit1030->SetParameter(0,-1.266209);
   mainFit1030->SetParError(0,0.4641526);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.883386);
   mainFit1030->SetParError(1,0.0141559);
   ...
   pt_LaTex = pt->AddText("0.883#pm0.0142");
   pt_LaTex = pt->AddText("#minus1.27#pm0.464");
   pt_LaTex = pt->AddText("#minus1.43#pm0.523");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.433359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.433359,-55.93874,1.433359,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.928871);
   ...
   mainFit1031->SetParameter(0,-1.266209);
   mainFit1031->SetParError(0,0.4641526);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.883386);
   mainFit1031->SetParError(1,0.0141559);
