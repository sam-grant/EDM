...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.93874);
   Graph_Graph01023->SetMaximum(55.35467);
   ...
   mainFit1024->SetChisquare(8.086615);
   ...
   mainFit1024->SetParameter(0,-1.193942);
   mainFit1024->SetParError(0,0.4269983);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8838126);
   mainFit1024->SetParError(1,0.01411523);
   ...
   pt_LaTex = pt->AddText("0.884#pm0.0141");
   pt_LaTex = pt->AddText("#minus1.19#pm0.427");
   pt_LaTex = pt->AddText("#minus1.35#pm 0.48");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.350899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.350899,-55.93874,1.350899,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(8.086615);
   ...
   mainFit1025->SetParameter(0,-1.193942);
   mainFit1025->SetParError(0,0.4269983);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8838126);
   mainFit1025->SetParError(1,0.01411523);
