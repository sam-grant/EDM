...
//=========  (Fri Apr 23 21:17:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.93874);
   Graph_Graph01020->SetMaximum(55.35467);
   ...
   mainFit1021->SetChisquare(8.086615);
   ...
   mainFit1021->SetParameter(0,-1.193942);
   mainFit1021->SetParError(0,0.4269983);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8838126);
   mainFit1021->SetParError(1,0.01411523);
   ...
   mainFit1022->SetChisquare(8.086615);
   ...
   mainFit1022->SetParameter(0,-1.193942);
   mainFit1022->SetParError(0,0.4269983);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8838126);
   mainFit1022->SetParError(1,0.01411523);
