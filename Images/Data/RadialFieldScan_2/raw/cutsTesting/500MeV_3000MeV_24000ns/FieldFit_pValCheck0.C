...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.42907,50,42.15964);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.7702);
   Graph_Graph01025->SetMaximum(31.50077);
   ...
   mainFit1026->SetChisquare(1.559594);
   ...
   mainFit1026->SetParameter(0,-1.631498);
   mainFit1026->SetParError(0,0.4600655);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8543705);
   mainFit1026->SetParError(1,0.01822216);
   ...
   pt_LaTex = pt->AddText("#minus1.91#pm0.545");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.909591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.909591,-53.7702,1.909591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.559594);
   ...
   mainFit1027->SetParameter(0,-1.631498);
   mainFit1027->SetParError(0,0.4600655);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8543705);
   mainFit1027->SetParError(1,0.01822216);
