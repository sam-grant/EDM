...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.76333,70,64.64893);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.62211);
   Graph_Graph01035->SetMaximum(53.50771);
   ...
   mainFit1036->SetChisquare(7.944404);
   ...
   mainFit1036->SetParameter(0,-1.244878);
   mainFit1036->SetParError(0,0.4478523);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8862233);
   mainFit1036->SetParError(1,0.01549531);
   ...
   pt_LaTex = pt->AddText("0.886#pm0.0155");
   pt_LaTex = pt->AddText("#minus1.24#pm0.448");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.499");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.4047,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.4047,-35.62211,1.4047,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(7.944404);
   ...
   mainFit1037->SetParameter(0,-1.244878);
   mainFit1037->SetParError(0,0.4478523);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8862233);
   mainFit1037->SetParError(1,0.01549531);
