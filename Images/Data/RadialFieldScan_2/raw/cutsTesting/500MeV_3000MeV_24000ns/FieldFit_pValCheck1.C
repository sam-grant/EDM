...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.85042,75,69.26635);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.93874);
   Graph_Graph01027->SetMaximum(55.35467);
   ...
   mainFit1028->SetChisquare(1.515907);
   ...
   mainFit1028->SetParameter(0,-0.6431095);
   mainFit1028->SetParError(0,0.4780216);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9018122);
   mainFit1028->SetParError(1,0.01576542);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.505");
   pt_LaTex = pt->AddText("0.902#pm0.0158");
   pt_LaTex = pt->AddText("#minus0.643#pm0.478");
   pt_LaTex = pt->AddText("#minus0.713#pm0.531");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7131302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7131302,-55.93874,0.7131302,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.515907);
   ...
   mainFit1029->SetParameter(0,-0.6431095);
   mainFit1029->SetParError(0,0.4780216);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9018122);
   mainFit1029->SetParError(1,0.01576542);
