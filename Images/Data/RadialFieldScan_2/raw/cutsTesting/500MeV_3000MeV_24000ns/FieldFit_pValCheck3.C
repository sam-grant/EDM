...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.93874);
   Graph_Graph01031->SetMaximum(55.35467);
   ...
   mainFit1032->SetChisquare(7.850398);
   ...
   mainFit1032->SetParameter(0,-1.075337);
   mainFit1032->SetParError(0,0.4918124);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8819801);
   mainFit1032->SetParError(1,0.01461016);
   ...
   pt_LaTex = pt->AddText("0.882#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.08#pm0.492");
   pt_LaTex = pt->AddText("#minus1.22#pm0.553");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.21923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.21923,-55.93874,1.21923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(7.850398);
   ...
   mainFit1033->SetParameter(0,-1.075337);
   mainFit1033->SetParError(0,0.4918124);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8819801);
   mainFit1033->SetParError(1,0.01461016);
