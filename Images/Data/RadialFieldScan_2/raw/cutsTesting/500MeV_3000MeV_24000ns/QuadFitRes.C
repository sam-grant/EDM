...
//=========  (Fri Apr 23 21:17:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01221688);
   Graph_Graph11015->SetMaximum(0.01164924);
   ...
   Graph_Graph21016->SetMinimum(-0.01397641);
   Graph_Graph21016->SetMaximum(0.01645859);
   ...
   Graph_Graph31017->SetMinimum(-0.03287762);
   Graph_Graph31017->SetMaximum(0.0233889);
   ...
   Graph_Graph41018->SetMinimum(-0.01140481);
   Graph_Graph41018->SetMaximum(0.01925116);
   ...
   Graph_Graph51019->SetMinimum(-0.006102396);
   Graph_Graph51019->SetMaximum(0.008158133);
