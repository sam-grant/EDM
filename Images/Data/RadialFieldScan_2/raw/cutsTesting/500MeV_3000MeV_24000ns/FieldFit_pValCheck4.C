...
//=========  (Fri Apr 23 21:17:38 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.93874);
   Graph_Graph01033->SetMaximum(55.35467);
   ...
   mainFit1034->SetChisquare(7.64504);
   ...
   mainFit1034->SetParameter(0,-1.408343);
   mainFit1034->SetParError(0,0.5351892);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8908576);
   mainFit1034->SetParError(1,0.01765324);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.55");
   pt_LaTex = pt->AddText("0.891#pm0.0177");
   pt_LaTex = pt->AddText("#minus1.41#pm0.535");
   pt_LaTex = pt->AddText("#minus1.58#pm0.587");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.580885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.580885,-55.93874,1.580885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(7.64504);
   ...
   mainFit1035->SetParameter(0,-1.408343);
   mainFit1035->SetParError(0,0.5351892);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8908576);
   mainFit1035->SetParError(1,0.01765324);
