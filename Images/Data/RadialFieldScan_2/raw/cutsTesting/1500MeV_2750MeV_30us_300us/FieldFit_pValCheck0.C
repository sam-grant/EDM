...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-58.70565,50,39.38678);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-48.89641);
   Graph_Graph01025->SetMaximum(29.57754);
   ...
   mainFit1026->SetChisquare(1.114278);
   ...
   mainFit1026->SetParameter(0,-0.2056079);
   mainFit1026->SetParError(0,0.6476496);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7545026);
   mainFit1026->SetParError(1,0.02565134);
   ...
   pt_LaTex = pt->AddText("0.755#pm0.0257");
   pt_LaTex = pt->AddText("#minus0.206#pm0.648");
   pt_LaTex = pt->AddText("#minus0.273#pm 0.86");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.2725079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2725079,-48.89641,0.2725079,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.114278);
   ...
   mainFit1027->SetParameter(0,-0.2056079);
   mainFit1027->SetParError(0,0.6476496);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7545026);
   mainFit1027->SetParError(1,0.02565134);
