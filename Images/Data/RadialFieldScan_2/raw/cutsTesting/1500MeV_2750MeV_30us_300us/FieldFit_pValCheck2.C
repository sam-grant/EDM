...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-50.64491);
   Graph_Graph01029->SetMaximum(48.81103);
   ...
   mainFit1030->SetChisquare(1.359267);
   ...
   mainFit1030->SetParameter(0,-0.161397);
   mainFit1030->SetParError(0,0.6525546);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7650956);
   mainFit1030->SetParError(1,0.01985617);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.453");
   pt_LaTex = pt->AddText("0.765#pm0.0199");
   pt_LaTex = pt->AddText("#minus0.161#pm0.653");
   pt_LaTex = pt->AddText("#minus0.211#pm0.852");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2109501,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2109501,-50.64491,0.2109501,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.359267);
   ...
   mainFit1031->SetParameter(0,-0.161397);
   mainFit1031->SetParError(0,0.6525546);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7650956);
   mainFit1031->SetParError(1,0.01985617);
