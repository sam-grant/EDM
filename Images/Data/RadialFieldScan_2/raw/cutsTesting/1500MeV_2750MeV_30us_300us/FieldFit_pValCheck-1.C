...
//=========  (Wed Apr 28 15:21:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-50.64491);
   Graph_Graph01023->SetMaximum(48.81103);
   ...
   mainFit1024->SetChisquare(1.594485);
   ...
   mainFit1024->SetParameter(0,-0.03768142);
   mainFit1024->SetParError(0,0.600616);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7658064);
   mainFit1024->SetParError(1,0.01980264);
   ...
   mainFit1025->SetChisquare(1.594485);
   ...
   mainFit1025->SetParameter(0,-0.03768142);
   mainFit1025->SetParError(0,0.600616);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7658064);
   mainFit1025->SetParError(1,0.01980264);
