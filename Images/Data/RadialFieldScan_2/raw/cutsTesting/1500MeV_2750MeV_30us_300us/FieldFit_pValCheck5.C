...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.13513,70,56.65467);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.45615);
   Graph_Graph01035->SetMaximum(46.97569);
   ...
   mainFit1036->SetChisquare(1.293481);
   ...
   mainFit1036->SetParameter(0,0.0670227);
   mainFit1036->SetParError(0,0.6302069);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7608881);
   mainFit1036->SetParError(1,0.02173725);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.431");
   pt_LaTex = pt->AddText("0.761#pm0.0217");
   pt_LaTex = pt->AddText("0.067#pm 0.63");
   pt_LaTex = pt->AddText("0.0881#pm0.829");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.08808483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.08808483,-30.45615,-0.08808483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.293481);
   ...
   mainFit1037->SetParameter(0,0.0670227);
   mainFit1037->SetParError(0,0.6302069);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7608881);
   mainFit1037->SetParError(1,0.02173725);
