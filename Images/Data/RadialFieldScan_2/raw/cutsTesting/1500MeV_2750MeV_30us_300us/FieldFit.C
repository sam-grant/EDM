...
//=========  (Wed Apr 28 15:21:36 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-63.0769,75,61.24302);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-50.64491);
   Graph_Graph01020->SetMaximum(48.81103);
   ...
   mainFit1021->SetChisquare(1.594485);
   ...
   mainFit1021->SetParameter(0,-0.03768142);
   mainFit1021->SetParError(0,0.600616);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7658064);
   mainFit1021->SetParError(1,0.01980264);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.399");
   pt_LaTex = pt->AddText("0.766#pm0.0198");
   pt_LaTex = pt->AddText("#minus0.0377#pm0.601");
   pt_LaTex = pt->AddText("#minus0.0492#pm0.784");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.04920488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.04920488,-50.64491,0.04920488,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.594485);
   ...
   mainFit1022->SetParameter(0,-0.03768142);
   mainFit1022->SetParError(0,0.600616);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7658064);
   mainFit1022->SetParError(1,0.01980264);
