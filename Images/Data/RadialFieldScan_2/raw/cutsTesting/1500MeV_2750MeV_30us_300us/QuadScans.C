...
//=========  (Wed Apr 28 15:21:36 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.085607);
   ...
   quadLineFit1002->SetParameter(0,74.8554);
   quadLineFit1002->SetParError(0,0.09069458);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.00207);
   quadLineFit1002->SetParError(1,1.520959);
   ...
   quadLineFit1003->SetChisquare(2.085607);
   ...
   quadLineFit1003->SetParameter(0,74.8554);
   quadLineFit1003->SetParError(0,0.09069458);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.00207);
   quadLineFit1003->SetParError(1,1.520959);
   ...
   Graph_30_ppm1003->SetMinimum(75.88075);
   Graph_30_ppm1003->SetMaximum(76.44225);
   ...
   quadLineFit1004->SetChisquare(2.014179);
   ...
   quadLineFit1004->SetParameter(0,74.82772);
   quadLineFit1004->SetParError(0,0.0770938);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.77093);
   quadLineFit1004->SetParError(1,1.267114);
   ...
   quadLineFit1005->SetChisquare(2.014179);
   ...
   quadLineFit1005->SetParameter(0,74.82772);
   quadLineFit1005->SetParError(0,0.0770938);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.77093);
   quadLineFit1005->SetParError(1,1.267114);
   ...
   Graph_10_ppm1005->SetMinimum(74.96714);
   Graph_10_ppm1005->SetMaximum(75.21792);
   ...
   quadLineFit1006->SetChisquare(0.00064329);
   ...
   quadLineFit1006->SetParameter(0,74.58354);
   quadLineFit1006->SetParError(0,0.09035004);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.268629);
   quadLineFit1006->SetParError(1,1.465266);
   ...
   quadLineFit1007->SetChisquare(0.00064329);
   ...
   quadLineFit1007->SetParameter(0,74.58354);
   quadLineFit1007->SetParError(0,0.09035004);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.268629);
   quadLineFit1007->SetParError(1,1.465266);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.91456);
   Graph_mI10_ppm1007->SetMaximum(74.18234);
   ...
   quadLineFit1008->SetChisquare(7.049532);
   ...
   quadLineFit1008->SetParameter(0,74.4965);
   quadLineFit1008->SetParError(0,0.07928449);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.532454);
   quadLineFit1008->SetParError(1,1.290417);
   ...
   quadLineFit1009->SetChisquare(7.049532);
   ...
   quadLineFit1009->SetParameter(0,74.4965);
   quadLineFit1009->SetParError(0,0.07928449);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.532454);
   quadLineFit1009->SetParError(1,1.290417);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.68556);
   Graph_mI30_ppm1009->SetMaximum(73.28106);
   ...
   quadLineFit1010->SetChisquare(0.06145282);
   ...
   quadLineFit1010->SetParameter(0,74.38307);
   quadLineFit1010->SetParError(0,0.07504403);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.70472);
   quadLineFit1010->SetParError(1,1.298776);
   ...
   quadLineFit1011->SetChisquare(0.06145282);
   ...
   quadLineFit1011->SetParameter(0,74.38307);
   quadLineFit1011->SetParError(0,0.07504403);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.70472);
   quadLineFit1011->SetParError(1,1.298776);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.81142);
   Graph_mI50_ppm1011->SetMaximum(72.39605);
   ...
   quadLineFit1012->SetChisquare(0.1591173);
   ...
   quadLineFit1012->SetParameter(0,74.36516);
   quadLineFit1012->SetParError(0,0.1513545);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-39.64878);
   quadLineFit1012->SetParError(1,2.708131);
   ...
   quadLineFit1013->SetChisquare(0.1591173);
   ...
   quadLineFit1013->SetParameter(0,74.36516);
   quadLineFit1013->SetParError(0,0.1513545);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-39.64878);
   quadLineFit1013->SetParError(1,2.708131);
