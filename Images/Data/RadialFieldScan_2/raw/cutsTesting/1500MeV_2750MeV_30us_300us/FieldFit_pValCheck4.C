...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-50.64491);
   Graph_Graph01033->SetMaximum(48.81103);
   ...
   mainFit1034->SetChisquare(1.484104);
   ...
   mainFit1034->SetParameter(0,-0.1885985);
   mainFit1034->SetParError(0,0.7530474);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7707434);
   mainFit1034->SetParError(1,0.02475812);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.495");
   pt_LaTex = pt->AddText("0.771#pm0.0248");
   pt_LaTex = pt->AddText("#minus0.189#pm0.753");
   pt_LaTex = pt->AddText("#minus0.245#pm0.973");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2446969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2446969,-50.64491,0.2446969,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.484104);
   ...
   mainFit1035->SetParameter(0,-0.1885985);
   mainFit1035->SetParError(0,0.7530474);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7707434);
   mainFit1035->SetParError(1,0.02475812);
