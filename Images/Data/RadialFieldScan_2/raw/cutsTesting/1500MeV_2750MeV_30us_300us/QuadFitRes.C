...
//=========  (Wed Apr 28 15:21:36 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01606584);
   Graph_Graph11015->SetMaximum(0.03564412);
   ...
   Graph_Graph21016->SetMinimum(-0.0003334239);
   Graph_Graph21016->SetMaximum(0.0003925487);
   ...
   Graph_Graph31017->SetMinimum(-0.04616347);
   Graph_Graph31017->SetMaximum(0.03461176);
   ...
   Graph_Graph41018->SetMinimum(-0.003197384);
   Graph_Graph41018->SetMaximum(0.003823939);
   ...
   Graph_Graph51019->SetMinimum(-0.004898437);
   Graph_Graph51019->SetMaximum(0.006546582);
