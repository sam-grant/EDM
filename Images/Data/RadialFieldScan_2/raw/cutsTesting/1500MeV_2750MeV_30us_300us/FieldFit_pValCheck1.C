...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-50.64491);
   Graph_Graph01027->SetMaximum(48.81103);
   ...
   mainFit1028->SetChisquare(0.2498057);
   ...
   mainFit1028->SetParameter(0,0.3101721);
   mainFit1028->SetParError(0,0.6713609);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7771012);
   mainFit1028->SetParError(1,0.02206846);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0833");
   pt_LaTex = pt->AddText("0.777#pm0.0221");
   pt_LaTex = pt->AddText(" 0.31#pm0.671");
   pt_LaTex = pt->AddText("0.399#pm0.863");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3991399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3991399,-50.64491,-0.3991399,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2498057);
   ...
   mainFit1029->SetParameter(0,0.3101721);
   mainFit1029->SetParError(0,0.6713609);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7771012);
   mainFit1029->SetParError(1,0.02206846);
