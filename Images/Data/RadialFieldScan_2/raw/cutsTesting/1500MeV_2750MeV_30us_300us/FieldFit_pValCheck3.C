...
//=========  (Wed Apr 28 15:21:37 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-50.64491);
   Graph_Graph01031->SetMaximum(48.81103);
   ...
   mainFit1032->SetChisquare(1.572731);
   ...
   mainFit1032->SetParameter(0,-0.08836807);
   mainFit1032->SetParError(0,0.6919843);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7665918);
   mainFit1032->SetParError(1,0.02050607);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.524");
   pt_LaTex = pt->AddText("0.767#pm0.0205");
   pt_LaTex = pt->AddText("#minus0.0884#pm0.692");
   pt_LaTex = pt->AddText("#minus0.115#pm0.902");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.115274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.115274,-50.64491,0.115274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.572731);
   ...
   mainFit1033->SetParameter(0,-0.08836807);
   mainFit1033->SetParError(0,0.6919843);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7665918);
   mainFit1033->SetParError(1,0.02050607);
