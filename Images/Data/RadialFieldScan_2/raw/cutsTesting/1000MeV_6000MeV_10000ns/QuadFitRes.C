...
//=========  (Thu Apr 22 09:40:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003280383);
   Graph_Graph11015->SetMaximum(0.008987713);
   ...
   Graph_Graph21016->SetMinimum(-0.01348686);
   Graph_Graph21016->SetMaximum(0.01589597);
   ...
   Graph_Graph31017->SetMinimum(-0.03246531);
   Graph_Graph31017->SetMaximum(0.02938455);
   ...
   Graph_Graph41018->SetMinimum(-0.01480561);
   Graph_Graph41018->SetMaximum(0.01840112);
   ...
   Graph_Graph51019->SetMinimum(-0.008014294);
   Graph_Graph51019->SetMaximum(0.01072116);
