...
//=========  (Thu Apr 22 09:40:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.00874);
   Graph_Graph01029->SetMaximum(52.22921);
   ...
   mainFit1030->SetChisquare(4.38356);
   ...
   mainFit1030->SetParameter(0,-0.6241824);
   mainFit1030->SetParError(0,0.4345255);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8412408);
   mainFit1030->SetParError(1,0.01319272);
   ...
   pt_LaTex = pt->AddText("0.841#pm0.0132");
   pt_LaTex = pt->AddText("#minus0.624#pm0.435");
   pt_LaTex = pt->AddText("#minus0.742#pm0.515");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7419783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7419783,-55.00874,0.7419783,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.38356);
   ...
   mainFit1031->SetParameter(0,-0.6241824);
   mainFit1031->SetParError(0,0.4345255);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8412408);
   mainFit1031->SetParError(1,0.01319272);
