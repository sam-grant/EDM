...
//=========  (Thu Apr 22 09:40:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.00874);
   Graph_Graph01020->SetMaximum(52.22921);
   ...
   mainFit1021->SetChisquare(5.133819);
   ...
   mainFit1021->SetParameter(0,-0.4773203);
   mainFit1021->SetParError(0,0.400074);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8420605);
   mainFit1021->SetParError(1,0.01315901);
   ...
   mainFit1022->SetChisquare(5.133819);
   ...
   mainFit1022->SetParameter(0,-0.4773203);
   mainFit1022->SetParError(0,0.400074);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8420605);
   mainFit1022->SetParError(1,0.01315901);
