...
//=========  (Thu Apr 22 09:40:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-44.05996,70,60.76325);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-33.57764);
   Graph_Graph01035->SetMaximum(50.28093);
   ...
   mainFit1036->SetChisquare(4.029746);
   ...
   mainFit1036->SetParameter(0,-0.343369);
   mainFit1036->SetParError(0,0.4198938);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8358096);
   mainFit1036->SetParError(1,0.01444129);
   ...
   pt_LaTex = pt->AddText("0.836#pm0.0144");
   pt_LaTex = pt->AddText("#minus0.343#pm 0.42");
   pt_LaTex = pt->AddText("#minus0.411#pm  0.5");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4108221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4108221,-33.57764,0.4108221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.029746);
   ...
   mainFit1037->SetParameter(0,-0.343369);
   mainFit1037->SetParError(0,0.4198938);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8358096);
   mainFit1037->SetParError(1,0.01444129);
