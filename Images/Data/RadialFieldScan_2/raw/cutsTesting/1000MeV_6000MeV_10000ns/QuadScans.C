...
//=========  (Thu Apr 22 09:40:45 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3999514);
   ...
   quadLineFit1002->SetParameter(0,74.68844);
   quadLineFit1002->SetParError(0,0.05992885);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.28773);
   quadLineFit1002->SetParError(1,1.004984);
   ...
   quadLineFit1003->SetChisquare(0.3999514);
   ...
   quadLineFit1003->SetParameter(0,74.68844);
   quadLineFit1003->SetParError(0,0.05992885);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.28773);
   quadLineFit1003->SetParError(1,1.004984);
   ...
   Graph_30_ppm1003->SetMinimum(75.84875);
   Graph_30_ppm1003->SetMaximum(76.44464);
   ...
   quadLineFit1004->SetChisquare(0.2621846);
   ...
   quadLineFit1004->SetParameter(0,74.7106);
   quadLineFit1004->SetParError(0,0.05139309);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.43196);
   quadLineFit1004->SetParError(1,0.8447423);
   ...
   quadLineFit1005->SetChisquare(0.2621846);
   ...
   quadLineFit1005->SetParameter(0,74.7106);
   quadLineFit1005->SetParError(0,0.05139309);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.43196);
   quadLineFit1005->SetParError(1,0.8447423);
   ...
   Graph_10_ppm1005->SetMinimum(74.92398);
   Graph_10_ppm1005->SetMaximum(75.1748);
   ...
   quadLineFit1006->SetChisquare(2.36931);
   ...
   quadLineFit1006->SetParameter(0,74.5029);
   quadLineFit1006->SetParError(0,0.06022373);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.71535);
   quadLineFit1006->SetParError(1,0.9767541);
   ...
   quadLineFit1007->SetChisquare(2.36931);
   ...
   quadLineFit1007->SetParameter(0,74.5029);
   quadLineFit1007->SetParError(0,0.06022373);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.71535);
   quadLineFit1007->SetParError(1,0.9767541);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80402);
   Graph_mI10_ppm1007->SetMaximum(74.05992);
   ...
   quadLineFit1008->SetChisquare(9.127437);
   ...
   quadLineFit1008->SetParameter(0,74.43068);
   quadLineFit1008->SetParError(0,0.05287442);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.210371);
   quadLineFit1008->SetParError(1,0.8606546);
   ...
   quadLineFit1009->SetChisquare(9.127437);
   ...
   quadLineFit1009->SetParameter(0,74.43068);
   quadLineFit1009->SetParError(0,0.05287442);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.210371);
   quadLineFit1009->SetParError(1,0.8606546);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.47982);
   Graph_mI30_ppm1009->SetMaximum(73.13752);
   ...
   quadLineFit1010->SetChisquare(2.818199);
   ...
   quadLineFit1010->SetParameter(0,74.39977);
   quadLineFit1010->SetParError(0,0.04999665);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.72414);
   quadLineFit1010->SetParError(1,0.8652842);
   ...
   quadLineFit1011->SetChisquare(2.818199);
   ...
   quadLineFit1011->SetParameter(0,74.39977);
   quadLineFit1011->SetParError(0,0.04999665);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.72414);
   quadLineFit1011->SetParError(1,0.8652842);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.59042);
   Graph_mI50_ppm1011->SetMaximum(72.21978);
   ...
   quadLineFit1012->SetChisquare(0.9596701);
   ...
   quadLineFit1012->SetParameter(0,74.43097);
   quadLineFit1012->SetParError(0,0.1008897);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.26702);
   quadLineFit1012->SetParError(1,1.805218);
   ...
   quadLineFit1013->SetChisquare(0.9596701);
   ...
   quadLineFit1013->SetParameter(0,74.43097);
   quadLineFit1013->SetParError(0,0.1008897);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.26702);
   quadLineFit1013->SetParError(1,1.805218);
