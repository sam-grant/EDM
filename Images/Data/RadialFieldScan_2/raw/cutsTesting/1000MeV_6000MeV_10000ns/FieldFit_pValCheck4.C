...
//=========  (Thu Apr 22 09:40:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.00874);
   Graph_Graph01033->SetMaximum(52.22921);
   ...
   mainFit1034->SetChisquare(5.133227);
   ...
   mainFit1034->SetParameter(0,-0.484705);
   mainFit1034->SetParError(0,0.5020506);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8423011);
   mainFit1034->SetParError(1,0.01645647);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0165");
   pt_LaTex = pt->AddText("#minus0.485#pm0.502");
   pt_LaTex = pt->AddText("#minus0.575#pm0.591");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.5754534,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5754534,-55.00874,0.5754534,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.133227);
   ...
   mainFit1035->SetParameter(0,-0.484705);
   mainFit1035->SetParError(0,0.5020506);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8423011);
   mainFit1035->SetParError(1,0.01645647);
