...
//=========  (Thu Apr 22 09:40:47 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.65948,50,41.86394);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.10713);
   Graph_Graph01025->SetMaximum(31.31159);
   ...
   mainFit1026->SetChisquare(4.267972);
   ...
   mainFit1026->SetParameter(0,-0.6283972);
   mainFit1026->SetParError(0,0.4317477);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8318936);
   mainFit1026->SetParError(1,0.0170974);
   ...
   pt_LaTex = pt->AddText("0.832#pm0.0171");
   pt_LaTex = pt->AddText("#minus0.628#pm0.432");
   pt_LaTex = pt->AddText("#minus0.755#pm0.521");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.7553818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7553818,-53.10713,0.7553818,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.267972);
   ...
   mainFit1027->SetParameter(0,-0.6283972);
   mainFit1027->SetParError(0,0.4317477);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8318936);
   mainFit1027->SetParError(1,0.0170974);
