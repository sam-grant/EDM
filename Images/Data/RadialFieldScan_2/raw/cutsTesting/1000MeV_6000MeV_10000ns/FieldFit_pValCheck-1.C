...
//=========  (Thu Apr 22 09:40:46 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.00874);
   Graph_Graph01023->SetMaximum(52.22921);
   ...
   mainFit1024->SetChisquare(5.133819);
   ...
   mainFit1024->SetParameter(0,-0.4773203);
   mainFit1024->SetParError(0,0.400074);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8420605);
   mainFit1024->SetParError(1,0.01315901);
   ...
   pt_LaTex = pt->AddText("0.842#pm0.0132");
   pt_LaTex = pt->AddText("#minus0.477#pm  0.4");
   pt_LaTex = pt->AddText("#minus0.567#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.566848,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.566848,-55.00874,0.566848,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.133819);
   ...
   mainFit1025->SetParameter(0,-0.4773203);
   mainFit1025->SetParError(0,0.400074);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8420605);
   mainFit1025->SetParError(1,0.01315901);
