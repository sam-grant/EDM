...
//=========  (Thu Apr 22 09:40:47 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.00874);
   Graph_Graph01027->SetMaximum(52.22921);
   ...
   mainFit1028->SetChisquare(1.079187);
   ...
   mainFit1028->SetParameter(0,-0.07767324);
   mainFit1028->SetParError(0,0.446599);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8549608);
   mainFit1028->SetParError(1,0.01463569);
   ...
   pt_LaTex = pt->AddText("0.855#pm0.0146");
   pt_LaTex = pt->AddText("#minus0.0777#pm0.447");
   pt_LaTex = pt->AddText("#minus0.0909#pm0.522");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.09085006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.09085006,-55.00874,0.09085006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.079187);
   ...
   mainFit1029->SetParameter(0,-0.07767324);
   mainFit1029->SetParError(0,0.446599);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8549608);
   mainFit1029->SetParError(1,0.01463569);
