...
//=========  (Tue Apr 27 00:45:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-40.01984,70,56.70885);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.34697);
   Graph_Graph01035->SetMaximum(47.03598);
   ...
   mainFit1036->SetChisquare(2.149307);
   ...
   mainFit1036->SetParameter(0,-0.05929452);
   mainFit1036->SetParError(0,0.6638482);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7582533);
   mainFit1036->SetParError(1,0.02290648);
   ...
   pt_LaTex = pt->AddText("0.758#pm0.0229");
   pt_LaTex = pt->AddText("#minus0.0593#pm0.664");
   pt_LaTex = pt->AddText("#minus0.0782#pm0.875");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.07819883,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.07819883,-30.34697,0.07819883,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.149307);
   ...
   mainFit1037->SetParameter(0,-0.05929452);
   mainFit1037->SetParError(0,0.6638482);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7582533);
   mainFit1037->SetParError(1,0.02290648);
