...
//=========  (Tue Apr 27 00:45:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-51.43342);
   Graph_Graph01031->SetMaximum(48.95293);
   ...
   mainFit1032->SetChisquare(2.613041);
   ...
   mainFit1032->SetParameter(0,-0.1431214);
   mainFit1032->SetParError(0,0.7288638);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.763977);
   mainFit1032->SetParError(1,0.02160793);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.871");
   pt_LaTex = pt->AddText("0.764#pm0.0216");
   pt_LaTex = pt->AddText("#minus0.143#pm0.729");
   pt_LaTex = pt->AddText("#minus0.187#pm0.953");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1873373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1873373,-51.43342,0.1873373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.613041);
   ...
   mainFit1033->SetParameter(0,-0.1431214);
   mainFit1033->SetParError(0,0.7288638);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.763977);
   mainFit1033->SetParError(1,0.02160793);
