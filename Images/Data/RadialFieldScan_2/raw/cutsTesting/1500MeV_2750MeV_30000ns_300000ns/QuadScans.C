...
//=========  (Tue Apr 27 00:45:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1459639);
   ...
   quadLineFit1002->SetParameter(0,74.85594);
   quadLineFit1002->SetParError(0,0.09566026);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.98304);
   quadLineFit1002->SetParError(1,1.604361);
   ...
   quadLineFit1003->SetChisquare(0.1459639);
   ...
   quadLineFit1003->SetParameter(0,74.85594);
   quadLineFit1003->SetParError(0,0.09566026);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.98304);
   quadLineFit1003->SetParError(1,1.604361);
   ...
   Graph_30_ppm1003->SetMinimum(75.89731);
   Graph_30_ppm1003->SetMaximum(76.44576);
   ...
   quadLineFit1004->SetChisquare(1.917878);
   ...
   quadLineFit1004->SetParameter(0,74.86496);
   quadLineFit1004->SetParError(0,0.0811747);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.27739);
   quadLineFit1004->SetParError(1,1.334188);
   ...
   quadLineFit1005->SetChisquare(1.917878);
   ...
   quadLineFit1005->SetParameter(0,74.86496);
   quadLineFit1005->SetParError(0,0.0811747);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.27739);
   quadLineFit1005->SetParError(1,1.334188);
   ...
   Graph_10_ppm1005->SetMinimum(74.96916);
   Graph_10_ppm1005->SetMaximum(75.23077);
   ...
   quadLineFit1006->SetChisquare(0.1325008);
   ...
   quadLineFit1006->SetParameter(0,74.57204);
   quadLineFit1006->SetParError(0,0.09514831);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.514496);
   quadLineFit1006->SetParError(1,1.543101);
   ...
   quadLineFit1007->SetChisquare(0.1325008);
   ...
   quadLineFit1007->SetParameter(0,74.57204);
   quadLineFit1007->SetParError(0,0.09514831);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.514496);
   quadLineFit1007->SetParError(1,1.543101);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.90614);
   Graph_mI10_ppm1007->SetMaximum(74.18841);
   ...
   quadLineFit1008->SetChisquare(7.362326);
   ...
   quadLineFit1008->SetParameter(0,74.53048);
   quadLineFit1008->SetParError(0,0.08354535);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.030584);
   quadLineFit1008->SetParError(1,1.359813);
   ...
   quadLineFit1009->SetChisquare(7.362326);
   ...
   quadLineFit1009->SetParameter(0,74.53048);
   quadLineFit1009->SetParError(0,0.08354535);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.030584);
   quadLineFit1009->SetParError(1,1.359813);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.67903);
   Graph_mI30_ppm1009->SetMaximum(73.2775);
   ...
   quadLineFit1010->SetChisquare(0.4226262);
   ...
   quadLineFit1010->SetParameter(0,74.37077);
   quadLineFit1010->SetParError(0,0.07903234);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.53058);
   quadLineFit1010->SetParError(1,1.367812);
   ...
   quadLineFit1011->SetChisquare(0.4226262);
   ...
   quadLineFit1011->SetParameter(0,74.37077);
   quadLineFit1011->SetParError(0,0.07903234);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.53058);
   quadLineFit1011->SetParError(1,1.367812);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.80395);
   Graph_mI50_ppm1011->SetMaximum(72.39919);
   ...
   quadLineFit1012->SetChisquare(0.02844087);
   ...
   quadLineFit1012->SetParameter(0,74.39321);
   quadLineFit1012->SetParError(0,0.1594692);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-40.21456);
   quadLineFit1012->SetParError(1,2.853332);
   ...
   quadLineFit1013->SetChisquare(0.02844087);
   ...
   quadLineFit1013->SetParameter(0,74.39321);
   quadLineFit1013->SetParError(0,0.1594692);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-40.21456);
   quadLineFit1013->SetParError(1,2.853332);
