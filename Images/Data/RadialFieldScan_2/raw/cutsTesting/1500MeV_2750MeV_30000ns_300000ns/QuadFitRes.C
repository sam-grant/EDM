...
//=========  (Tue Apr 27 00:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0193285);
   Graph_Graph11015->SetMaximum(0.03255954);
   ...
   Graph_Graph21016->SetMinimum(-0.005038221);
   Graph_Graph21016->SetMaximum(0.005933968);
   ...
   Graph_Graph31017->SetMinimum(-0.04722189);
   Graph_Graph31017->SetMaximum(0.03887053);
   ...
   Graph_Graph41018->SetMinimum(-0.009881245);
   Graph_Graph41018->SetMaximum(0.01535176);
   ...
   Graph_Graph51019->SetMinimum(-0.002181);
   Graph_Graph51019->SetMaximum(0.002914883);
