...
//=========  (Tue Apr 27 00:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-51.43342);
   Graph_Graph01023->SetMaximum(48.95293);
   ...
   mainFit1024->SetChisquare(2.637471);
   ...
   mainFit1024->SetParameter(0,-0.199675);
   mainFit1024->SetParError(0,0.6327129);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7648532);
   mainFit1024->SetParError(1,0.02086811);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.659");
   pt_LaTex = pt->AddText("0.765#pm0.0209");
   pt_LaTex = pt->AddText(" #minus0.2#pm0.633");
   pt_LaTex = pt->AddText("#minus0.261#pm0.826");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2610632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2610632,-51.43342,0.2610632,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(2.637471);
   ...
   mainFit1025->SetParameter(0,-0.199675);
   mainFit1025->SetParError(0,0.6327129);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7648532);
   mainFit1025->SetParError(1,0.02086811);
