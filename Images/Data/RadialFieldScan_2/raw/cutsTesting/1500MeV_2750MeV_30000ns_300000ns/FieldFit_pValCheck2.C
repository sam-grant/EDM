...
//=========  (Tue Apr 27 00:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-51.43342);
   Graph_Graph01029->SetMaximum(48.95293);
   ...
   mainFit1030->SetChisquare(2.064235);
   ...
   mainFit1030->SetParameter(0,-0.4032495);
   mainFit1030->SetParError(0,0.6874805);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7636838);
   mainFit1030->SetParError(1,0.02092491);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.688");
   pt_LaTex = pt->AddText("0.764#pm0.0209");
   pt_LaTex = pt->AddText("#minus0.403#pm0.687");
   pt_LaTex = pt->AddText("#minus0.528#pm0.899");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.528032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.528032,-51.43342,0.528032,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.064235);
   ...
   mainFit1031->SetParameter(0,-0.4032495);
   mainFit1031->SetParError(0,0.6874805);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7636838);
   mainFit1031->SetParError(1,0.02092491);
