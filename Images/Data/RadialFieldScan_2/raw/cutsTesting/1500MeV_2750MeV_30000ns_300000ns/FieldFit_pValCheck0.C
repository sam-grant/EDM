...
//=========  (Tue Apr 27 00:45:20 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-59.48776,50,39.03145);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-49.63584);
   Graph_Graph01025->SetMaximum(29.17953);
   ...
   mainFit1026->SetChisquare(1.959561);
   ...
   mainFit1026->SetParameter(0,-0.4095637);
   mainFit1026->SetParError(0,0.6821242);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7507211);
   mainFit1026->SetParError(1,0.02701492);
   ...
   pt_LaTex = pt->AddText("0.751#pm0.027");
   pt_LaTex = pt->AddText("#minus0.41#pm0.682");
   pt_LaTex = pt->AddText("#minus0.546#pm0.911");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.5455604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5455604,-49.63584,0.5455604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.959561);
   ...
   mainFit1027->SetParameter(0,-0.4095637);
   mainFit1027->SetParError(0,0.6821242);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7507211);
   mainFit1027->SetParError(1,0.02701492);
