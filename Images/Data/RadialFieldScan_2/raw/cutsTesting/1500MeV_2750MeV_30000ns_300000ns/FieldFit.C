...
//=========  (Tue Apr 27 00:45:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-51.43342);
   Graph_Graph01020->SetMaximum(48.95293);
   ...
   mainFit1021->SetChisquare(2.637471);
   ...
   mainFit1021->SetParameter(0,-0.199675);
   mainFit1021->SetParError(0,0.6327129);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7648532);
   mainFit1021->SetParError(1,0.02086811);
   ...
   mainFit1022->SetChisquare(2.637471);
   ...
   mainFit1022->SetParameter(0,-0.199675);
   mainFit1022->SetParError(0,0.6327129);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7648532);
   mainFit1022->SetParError(1,0.02086811);
