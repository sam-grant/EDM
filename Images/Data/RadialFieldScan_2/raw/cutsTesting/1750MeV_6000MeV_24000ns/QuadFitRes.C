...
//=========  (Wed Apr 21 14:06:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.008676408);
   Graph_Graph11015->SetMaximum(0.01629787);
   ...
   Graph_Graph21016->SetMinimum(-0.01098675);
   Graph_Graph21016->SetMaximum(0.01293444);
   ...
   Graph_Graph31017->SetMinimum(-0.05577932);
   Graph_Graph31017->SetMaximum(0.04920628);
   ...
   Graph_Graph41018->SetMinimum(-0.01391011);
   Graph_Graph41018->SetMaximum(0.008074401);
   ...
   Graph_Graph51019->SetMinimum(-0.01094835);
   Graph_Graph51019->SetMaximum(0.008196744);
