...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-48.93451);
   Graph_Graph01033->SetMaximum(48.98474);
   ...
   mainFit1034->SetChisquare(5.577878);
   ...
   mainFit1034->SetParameter(0,0.6253238);
   mainFit1034->SetParError(0,0.743098);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7452395);
   mainFit1034->SetParError(1,0.02454113);
   ...
   pt_LaTex = pt->AddText("0.745#pm0.0245");
   pt_LaTex = pt->AddText("0.625#pm0.743");
   pt_LaTex = pt->AddText("0.839#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.839091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.839091,-48.93451,-0.839091,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.577878);
   ...
   mainFit1035->SetParameter(0,0.6253238);
   mainFit1035->SetParError(0,0.743098);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7452395);
   mainFit1035->SetParError(1,0.02454113);
