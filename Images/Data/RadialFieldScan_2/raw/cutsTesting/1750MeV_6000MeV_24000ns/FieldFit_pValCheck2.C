...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.93451);
   Graph_Graph01029->SetMaximum(48.98474);
   ...
   mainFit1030->SetChisquare(5.039995);
   ...
   mainFit1030->SetParameter(0,-0.1601781);
   mainFit1030->SetParError(0,0.6447772);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7586055);
   mainFit1030->SetParError(1,0.01968426);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.68");
   pt_LaTex = pt->AddText("0.759#pm0.0197");
   pt_LaTex = pt->AddText("#minus0.16#pm0.645");
   pt_LaTex = pt->AddText("#minus0.211#pm0.849");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2111481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2111481,-48.93451,0.2111481,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.039995);
   ...
   mainFit1031->SetParameter(0,-0.1601781);
   mainFit1031->SetParError(0,0.6447772);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7586055);
   mainFit1031->SetParError(1,0.01968426);
