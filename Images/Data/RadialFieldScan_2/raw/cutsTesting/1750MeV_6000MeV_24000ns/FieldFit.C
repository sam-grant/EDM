...
//=========  (Wed Apr 21 14:06:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.93451);
   Graph_Graph01020->SetMaximum(48.98474);
   ...
   mainFit1021->SetChisquare(6.65386);
   ...
   mainFit1021->SetParameter(0,0.160994);
   mainFit1021->SetParError(0,0.5931421);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7605222);
   mainFit1021->SetParError(1,0.01962651);
   ...
   mainFit1022->SetChisquare(6.65386);
   ...
   mainFit1022->SetParameter(0,0.160994);
   mainFit1022->SetParError(0,0.5931421);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7605222);
   mainFit1022->SetParError(1,0.01962651);
