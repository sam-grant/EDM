...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.17442,75,61.22465);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-48.93451);
   Graph_Graph01031->SetMaximum(48.98474);
   ...
   mainFit1032->SetChisquare(5.344152);
   ...
   mainFit1032->SetParameter(0,-0.2270163);
   mainFit1032->SetParError(0,0.6832045);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7665113);
   mainFit1032->SetParError(1,0.02031225);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.78");
   pt_LaTex = pt->AddText("0.767#pm0.0203");
   pt_LaTex = pt->AddText("#minus0.227#pm0.683");
   pt_LaTex = pt->AddText("#minus0.296#pm0.889");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2961683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2961683,-48.93451,0.2961683,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.344152);
   ...
   mainFit1033->SetParameter(0,-0.2270163);
   mainFit1033->SetParError(0,0.6832045);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7665113);
   mainFit1033->SetParError(1,0.02031225);
