...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-48.93451);
   Graph_Graph01023->SetMaximum(48.98474);
   ...
   mainFit1024->SetChisquare(6.65386);
   ...
   mainFit1024->SetParameter(0,0.160994);
   mainFit1024->SetParError(0,0.5931421);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7605222);
   mainFit1024->SetParError(1,0.01962651);
   ...
   pt_LaTex = pt->AddText("0.761#pm0.0196");
   pt_LaTex = pt->AddText("0.161#pm0.593");
   pt_LaTex = pt->AddText("0.212#pm0.781");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2116887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2116887,-48.93451,-0.2116887,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.65386);
   ...
   mainFit1025->SetParameter(0,0.160994);
   mainFit1025->SetParError(0,0.5931421);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7605222);
   mainFit1025->SetParError(1,0.01962651);
