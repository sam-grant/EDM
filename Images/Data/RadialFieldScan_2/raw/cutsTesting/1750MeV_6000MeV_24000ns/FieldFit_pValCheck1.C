...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-48.93451);
   Graph_Graph01027->SetMaximum(48.98474);
   ...
   mainFit1028->SetChisquare(1.434438);
   ...
   mainFit1028->SetParameter(0,0.8456383);
   mainFit1028->SetParError(0,0.6645481);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7829473);
   mainFit1028->SetParError(1,0.02194423);
   ...
   pt_LaTex = pt->AddText("0.783#pm0.0219");
   pt_LaTex = pt->AddText("0.846#pm0.665");
   pt_LaTex = pt->AddText(" 1.08#pm0.847");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.080071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.080071,-48.93451,-1.080071,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.434438);
   ...
   mainFit1029->SetParameter(0,0.8456383);
   mainFit1029->SetParError(0,0.6645481);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7829473);
   mainFit1029->SetParError(1,0.02194423);
