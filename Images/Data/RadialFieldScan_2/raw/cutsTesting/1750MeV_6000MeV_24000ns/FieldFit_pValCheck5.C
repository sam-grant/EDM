...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.30684,70,57.25113);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.45104);
   Graph_Graph01035->SetMaximum(47.39533);
   ...
   mainFit1036->SetChisquare(6.643811);
   ...
   mainFit1036->SetParameter(0,0.1797919);
   mainFit1036->SetParError(0,0.6220777);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7596301);
   mainFit1036->SetParError(1,0.02154999);
   ...
   pt_LaTex = pt->AddText(" 0.76#pm0.0215");
   pt_LaTex = pt->AddText(" 0.18#pm0.622");
   pt_LaTex = pt->AddText("0.237#pm0.821");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.2366836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2366836,-31.45104,-0.2366836,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.643811);
   ...
   mainFit1037->SetParameter(0,0.1797919);
   mainFit1037->SetParError(0,0.6220777);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7596301);
   mainFit1037->SetParError(1,0.02154999);
