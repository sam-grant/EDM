...
//=========  (Wed Apr 21 14:06:22 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1125052);
   ...
   quadLineFit1002->SetParameter(0,75.00467);
   quadLineFit1002->SetParError(0,0.09072268);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.30303);
   quadLineFit1002->SetParError(1,1.521773);
   ...
   quadLineFit1003->SetChisquare(0.1125052);
   ...
   quadLineFit1003->SetParameter(0,75.00467);
   quadLineFit1003->SetParError(0,0.09072268);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.30303);
   quadLineFit1003->SetParError(1,1.521773);
   ...
   Graph_30_ppm1003->SetMinimum(76.0714);
   Graph_30_ppm1003->SetMaximum(76.61227);
   ...
   quadLineFit1004->SetChisquare(0.4912755);
   ...
   quadLineFit1004->SetParameter(0,75.07119);
   quadLineFit1004->SetParError(0,0.07600455);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.72146);
   quadLineFit1004->SetParError(1,1.24937);
   ...
   quadLineFit1005->SetChisquare(0.4912755);
   ...
   quadLineFit1005->SetParameter(0,75.07119);
   quadLineFit1005->SetParError(0,0.07600455);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.72146);
   quadLineFit1005->SetParError(1,1.24937);
   ...
   Graph_10_ppm1005->SetMinimum(75.1434);
   Graph_10_ppm1005->SetMaximum(75.4268);
   ...
   quadLineFit1006->SetChisquare(0.7166894);
   ...
   quadLineFit1006->SetParameter(0,74.6957);
   quadLineFit1006->SetParError(0,0.08912436);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.440224);
   quadLineFit1006->SetParError(1,1.445475);
   ...
   quadLineFit1007->SetChisquare(0.7166894);
   ...
   quadLineFit1007->SetParameter(0,74.6957);
   quadLineFit1007->SetParError(0,0.08912436);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.440224);
   quadLineFit1007->SetParError(1,1.445475);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.13212);
   Graph_mI10_ppm1007->SetMaximum(74.373);
   ...
   quadLineFit1008->SetChisquare(12.13285);
   ...
   quadLineFit1008->SetParameter(0,74.62351);
   quadLineFit1008->SetParError(0,0.07823396);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-6.19368);
   quadLineFit1008->SetParError(1,1.273471);
   ...
   quadLineFit1009->SetChisquare(12.13285);
   ...
   quadLineFit1009->SetParameter(0,74.62351);
   quadLineFit1009->SetParError(0,0.07823396);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-6.19368);
   quadLineFit1009->SetParError(1,1.273471);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.87834);
   Graph_mI30_ppm1009->SetMaximum(73.48806);
   ...
   quadLineFit1010->SetChisquare(0.3523964);
   ...
   quadLineFit1010->SetParameter(0,74.63179);
   quadLineFit1010->SetParError(0,0.07400172);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.59969);
   quadLineFit1010->SetParError(1,1.280818);
   ...
   quadLineFit1011->SetChisquare(0.3523964);
   ...
   quadLineFit1011->SetParameter(0,74.63179);
   quadLineFit1011->SetParError(0,0.07400172);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.59969);
   quadLineFit1011->SetParError(1,1.280818);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.03379);
   Graph_mI50_ppm1011->SetMaximum(72.59821);
   ...
   quadLineFit1012->SetChisquare(0.4572519);
   ...
   quadLineFit1012->SetParameter(0,74.47945);
   quadLineFit1012->SetParError(0,0.1493128);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-38.10309);
   quadLineFit1012->SetParError(1,2.671485);
   ...
   quadLineFit1013->SetChisquare(0.4572519);
   ...
   quadLineFit1013->SetParameter(0,74.47945);
   quadLineFit1013->SetParError(0,0.1493128);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-38.10309);
   quadLineFit1013->SetParError(1,2.671485);
