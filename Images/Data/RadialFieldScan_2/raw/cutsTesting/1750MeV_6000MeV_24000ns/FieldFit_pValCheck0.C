...
//=========  (Wed Apr 21 14:06:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-56.46093,50,37.65718);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.04912);
   Graph_Graph01025->SetMaximum(28.24537);
   ...
   mainFit1026->SetChisquare(5.605314);
   ...
   mainFit1026->SetParameter(0,-0.08190051);
   mainFit1026->SetParError(0,0.6388094);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.744175);
   mainFit1026->SetParError(1,0.02529691);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.87");
   pt_LaTex = pt->AddText("0.744#pm0.0253");
   pt_LaTex = pt->AddText("#minus0.0819#pm0.639");
   pt_LaTex = pt->AddText("#minus0.11#pm0.859");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.1100554,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1100554,-47.04912,0.1100554,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.605314);
   ...
   mainFit1027->SetParameter(0,-0.08190051);
   mainFit1027->SetParError(0,0.6388094);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.744175);
   mainFit1027->SetParError(1,0.02529691);
