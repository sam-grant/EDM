...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-59.98053,70,73.93896);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-46.58858);
   Graph_Graph01035->SetMaximum(60.54701);
   ...
   mainFit1036->SetChisquare(0.7968486);
   ...
   mainFit1036->SetParameter(0,-2.586376);
   mainFit1036->SetParError(0,2.522578);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9498029);
   mainFit1036->SetParError(1,0.08726947);
   ...
   pt_LaTex = pt->AddText(" 0.95#pm0.0873");
   pt_LaTex = pt->AddText("#minus2.59#pm 2.52");
   pt_LaTex = pt->AddText("#minus2.72#pm  2.6");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.723066,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.723066,-46.58858,2.723066,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.7968486);
   ...
   mainFit1037->SetParameter(0,-2.586376);
   mainFit1037->SetParError(0,2.522578);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9498029);
   mainFit1037->SetParError(1,0.08726947);
