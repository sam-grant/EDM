...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.19195,50,51.68752);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-60.704);
   Graph_Graph01025->SetMaximum(39.19957);
   ...
   mainFit1026->SetChisquare(1.199164);
   ...
   mainFit1026->SetParameter(0,-2.337353);
   mainFit1026->SetParError(0,2.590425);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9054369);
   mainFit1026->SetParError(1,0.1025388);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.103");
   pt_LaTex = pt->AddText("#minus2.34#pm 2.59");
   pt_LaTex = pt->AddText("#minus2.58#pm 2.91");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.581465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.581465,-60.704,2.581465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.199164);
   ...
   mainFit1027->SetParameter(0,-2.337353);
   mainFit1027->SetParError(0,2.590425);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9054369);
   mainFit1027->SetParError(1,0.1025388);
