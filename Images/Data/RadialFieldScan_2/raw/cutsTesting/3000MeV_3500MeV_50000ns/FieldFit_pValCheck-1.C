...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.77848);
   Graph_Graph01023->SetMaximum(62.01882);
   ...
   mainFit1024->SetChisquare(1.286045);
   ...
   mainFit1024->SetParameter(0,-2.053101);
   mainFit1024->SetParError(0,2.404602);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9245725);
   mainFit1024->SetParError(1,0.07946878);
   ...
   pt_LaTex = pt->AddText("0.925#pm0.0795");
   pt_LaTex = pt->AddText("#minus2.05#pm  2.4");
   pt_LaTex = pt->AddText("#minus2.22#pm 2.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.220595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.220595,-62.77848,2.220595,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.286045);
   ...
   mainFit1025->SetParameter(0,-2.053101);
   mainFit1025->SetParError(0,2.404602);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9245725);
   mainFit1025->SetParError(1,0.07946878);
