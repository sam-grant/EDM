...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-62.77848);
   Graph_Graph01031->SetMaximum(62.01882);
   ...
   mainFit1032->SetChisquare(0.9249086);
   ...
   mainFit1032->SetParameter(0,-2.877478);
   mainFit1032->SetParError(0,2.768368);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.937313);
   mainFit1032->SetParError(1,0.08224567);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.308");
   pt_LaTex = pt->AddText("0.937#pm0.0822");
   pt_LaTex = pt->AddText("#minus2.88#pm 2.77");
   pt_LaTex = pt->AddText("#minus3.07#pm 2.89");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.069922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.069922,-62.77848,3.069922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.9249086);
   ...
   mainFit1033->SetParameter(0,-2.877478);
   mainFit1033->SetParError(0,2.768368);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.937313);
   mainFit1033->SetParError(1,0.08224567);
