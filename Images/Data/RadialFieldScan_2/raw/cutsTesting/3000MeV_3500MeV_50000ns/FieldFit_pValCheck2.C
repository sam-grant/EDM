...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.77848);
   Graph_Graph01029->SetMaximum(62.01882);
   ...
   mainFit1030->SetChisquare(0.897618);
   ...
   mainFit1030->SetParameter(0,-1.414187);
   mainFit1030->SetParError(0,2.61402);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9283372);
   mainFit1030->SetParError(1,0.0796974);
   ...
   pt_LaTex = pt->AddText("0.928#pm0.0797");
   pt_LaTex = pt->AddText("#minus1.41#pm 2.61");
   pt_LaTex = pt->AddText("#minus1.52#pm  2.8");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.523355,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.523355,-62.77848,1.523355,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.897618);
   ...
   mainFit1031->SetParameter(0,-1.414187);
   mainFit1031->SetParError(0,2.61402);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9283372);
   mainFit1031->SetParError(1,0.0796974);
