...
//=========  (Thu Apr 22 01:03:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-62.77848);
   Graph_Graph01020->SetMaximum(62.01882);
   ...
   mainFit1021->SetChisquare(1.286045);
   ...
   mainFit1021->SetParameter(0,-2.053101);
   mainFit1021->SetParError(0,2.404602);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9245725);
   mainFit1021->SetParError(1,0.07946878);
   ...
   mainFit1022->SetChisquare(1.286045);
   ...
   mainFit1022->SetParameter(0,-2.053101);
   mainFit1022->SetParError(0,2.404602);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9245725);
   mainFit1022->SetParError(1,0.07946878);
