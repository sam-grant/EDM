...
//=========  (Thu Apr 22 01:03:57 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.539571);
   ...
   quadLineFit1002->SetParameter(0,75.27018);
   quadLineFit1002->SetParError(0,0.3664846);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.47135);
   quadLineFit1002->SetParError(1,6.147702);
   ...
   quadLineFit1003->SetChisquare(4.539571);
   ...
   quadLineFit1003->SetParameter(0,75.27018);
   quadLineFit1003->SetParError(0,0.3664846);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.47135);
   quadLineFit1003->SetParError(1,6.147702);
   ...
   Graph_30_ppm1003->SetMinimum(76.54201);
   Graph_30_ppm1003->SetMaximum(77.3638);
   ...
   quadLineFit1004->SetChisquare(0.2295992);
   ...
   quadLineFit1004->SetParameter(0,75.36683);
   quadLineFit1004->SetParError(0,0.3080331);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.8091);
   quadLineFit1004->SetParError(1,5.065172);
   ...
   quadLineFit1005->SetChisquare(0.2295992);
   ...
   quadLineFit1005->SetParameter(0,75.36683);
   quadLineFit1005->SetParError(0,0.3080331);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.8091);
   quadLineFit1005->SetParError(1,5.065172);
   ...
   Graph_10_ppm1005->SetMinimum(75.64382);
   Graph_10_ppm1005->SetMaximum(75.94133);
   ...
   quadLineFit1006->SetChisquare(0.002881458);
   ...
   quadLineFit1006->SetParameter(0,75.5475);
   quadLineFit1006->SetParError(0,0.3610224);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,3.865684);
   quadLineFit1006->SetParError(1,5.855859);
   ...
   quadLineFit1007->SetChisquare(0.002881458);
   ...
   quadLineFit1007->SetParameter(0,75.5475);
   quadLineFit1007->SetParError(0,0.3610224);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,3.865684);
   quadLineFit1007->SetParError(1,5.855859);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.61602);
   Graph_mI10_ppm1007->SetMaximum(75.05874);
   ...
   quadLineFit1008->SetChisquare(0.5124174);
   ...
   quadLineFit1008->SetParameter(0,75.33571);
   quadLineFit1008->SetParError(0,0.317647);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.630276);
   quadLineFit1008->SetParError(1,5.172285);
   ...
   quadLineFit1009->SetChisquare(0.5124174);
   ...
   quadLineFit1009->SetParameter(0,75.33571);
   quadLineFit1009->SetParError(0,0.317647);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.630276);
   quadLineFit1009->SetParError(1,5.172285);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.09708);
   Graph_mI30_ppm1009->SetMaximum(74.04799);
   ...
   quadLineFit1010->SetChisquare(0.1951008);
   ...
   quadLineFit1010->SetParameter(0,75.56978);
   quadLineFit1010->SetParError(0,0.2999404);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-32.46802);
   quadLineFit1010->SetParError(1,5.192599);
   ...
   quadLineFit1011->SetChisquare(0.1951008);
   ...
   quadLineFit1011->SetParameter(0,75.56978);
   quadLineFit1011->SetParError(0,0.2999404);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-32.46802);
   quadLineFit1011->SetParError(1,5.192599);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.27982);
   Graph_mI50_ppm1011->SetMaximum(73.04231);
   ...
   quadLineFit1012->SetChisquare(0.20125);
   ...
   quadLineFit1012->SetParameter(0,75.05027);
   quadLineFit1012->SetParError(0,0.6047298);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.558);
   quadLineFit1012->SetParError(1,10.82071);
   ...
   quadLineFit1013->SetChisquare(0.20125);
   ...
   quadLineFit1013->SetParameter(0,75.05027);
   quadLineFit1013->SetParError(0,0.6047298);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.558);
   quadLineFit1013->SetParError(1,10.82071);
