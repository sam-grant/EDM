...
//=========  (Thu Apr 22 01:03:57 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.05178897);
   Graph_Graph11015->SetMaximum(0.01668967);
   ...
   Graph_Graph21016->SetMinimum(-0.002833613);
   Graph_Graph21016->SetMaximum(0.003319605);
   ...
   Graph_Graph31017->SetMinimum(-0.04923067);
   Graph_Graph31017->SetMaximum(0.0493699);
   ...
   Graph_Graph41018->SetMinimum(-0.04073492);
   Graph_Graph41018->SetMaximum(0.02530898);
   ...
   Graph_Graph51019->SetMinimum(-0.02200446);
   Graph_Graph51019->SetMaximum(0.02934188);
