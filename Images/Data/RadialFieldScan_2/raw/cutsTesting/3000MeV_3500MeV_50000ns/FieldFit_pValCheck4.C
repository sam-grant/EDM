...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-78.37814,75,77.61849);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-62.77848);
   Graph_Graph01033->SetMaximum(62.01882);
   ...
   mainFit1034->SetChisquare(0.7604443);
   ...
   mainFit1034->SetParameter(0,-0.7358292);
   mainFit1034->SetParError(0,3.013898);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8813121);
   mainFit1034->SetParError(1,0.0993823);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0994");
   pt_LaTex = pt->AddText("#minus0.736#pm 3.01");
   pt_LaTex = pt->AddText("#minus0.835#pm 3.38");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8349246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8349246,-62.77848,0.8349246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.7604443);
   ...
   mainFit1035->SetParameter(0,-0.7358292);
   mainFit1035->SetParError(0,3.013898);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8813121);
   mainFit1035->SetParError(1,0.0993823);
