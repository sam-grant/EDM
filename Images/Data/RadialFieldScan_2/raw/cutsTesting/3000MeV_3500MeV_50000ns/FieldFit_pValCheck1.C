...
//=========  (Thu Apr 22 01:03:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-62.77848);
   Graph_Graph01027->SetMaximum(62.01882);
   ...
   mainFit1028->SetChisquare(1.285073);
   ...
   mainFit1028->SetParameter(0,-2.090895);
   mainFit1028->SetParError(0,2.692605);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9233434);
   mainFit1028->SetParError(1,0.08877483);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0888");
   pt_LaTex = pt->AddText("#minus2.09#pm 2.69");
   pt_LaTex = pt->AddText("#minus2.26#pm 2.94");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.264483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.264483,-62.77848,2.264483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.285073);
   ...
   mainFit1029->SetParameter(0,-2.090895);
   mainFit1029->SetParError(0,2.692605);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9233434);
   mainFit1029->SetParError(1,0.08877483);
