...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.15324,50,45.41693);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.69622);
   Graph_Graph01025->SetMaximum(33.95992);
   ...
   mainFit1026->SetChisquare(0.4423577);
   ...
   mainFit1026->SetParameter(0,-2.128062);
   mainFit1026->SetParError(0,0.3563533);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9317854);
   mainFit1026->SetParError(1,0.01412065);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.147");
   pt_LaTex = pt->AddText("0.932#pm0.0141");
   pt_LaTex = pt->AddText("#minus2.13#pm0.356");
   pt_LaTex = pt->AddText("#minus2.28#pm0.388");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.283854,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.283854,-57.69622,2.283854,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.4423577);
   ...
   mainFit1027->SetParameter(0,-2.128062);
   mainFit1027->SetParError(0,0.3563533);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9317854);
   mainFit1027->SetParError(1,0.01412065);
