...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.69655);
   Graph_Graph01029->SetMaximum(55.96349);
   ...
   mainFit1030->SetChisquare(1.060465);
   ...
   mainFit1030->SetParameter(0,-2.063415);
   mainFit1030->SetParError(0,0.3597685);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9391722);
   mainFit1030->SetParError(1,0.01097228);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.011");
   pt_LaTex = pt->AddText("#minus2.06#pm 0.36");
   pt_LaTex = pt->AddText(" #minus2.2#pm0.381");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.197057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.197057,-59.69655,2.197057,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.060465);
   ...
   mainFit1031->SetParameter(0,-2.063415);
   mainFit1031->SetParError(0,0.3597685);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9391722);
   mainFit1031->SetParError(1,0.01097228);
