...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.69655);
   Graph_Graph01023->SetMaximum(55.96349);
   ...
   mainFit1024->SetChisquare(1.182005);
   ...
   mainFit1024->SetParameter(0,-2.01409);
   mainFit1024->SetParError(0,0.3308057);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9394567);
   mainFit1024->SetParError(1,0.01094054);
   ...
   pt_LaTex = pt->AddText("#minus2.01#pm0.331");
   pt_LaTex = pt->AddText("#minus2.14#pm0.349");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.143888,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.143888,-59.69655,2.143888,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.182005);
   ...
   mainFit1025->SetParameter(0,-2.01409);
   mainFit1025->SetParError(0,0.3308057);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9394567);
   mainFit1025->SetParError(1,0.01094054);
