...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-74.15405,75,70.42099);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.69655);
   Graph_Graph01027->SetMaximum(55.96349);
   ...
   mainFit1028->SetChisquare(0.2054705);
   ...
   mainFit1028->SetParameter(0,-1.849731);
   mainFit1028->SetParError(0,0.3702753);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9448398);
   mainFit1028->SetParError(1,0.01221923);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0685");
   pt_LaTex = pt->AddText("0.945#pm0.0122");
   pt_LaTex = pt->AddText("#minus1.85#pm 0.37");
   pt_LaTex = pt->AddText("#minus1.96#pm0.394");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.957719,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.957719,-59.69655,1.957719,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2054705);
   ...
   mainFit1029->SetParameter(0,-1.849731);
   mainFit1029->SetParError(0,0.3702753);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9448398);
   mainFit1029->SetParError(1,0.01221923);
