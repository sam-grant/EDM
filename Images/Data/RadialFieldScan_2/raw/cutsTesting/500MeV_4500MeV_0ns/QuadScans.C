...
//=========  (Thu Apr 22 14:16:27 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(4.099769);
   ...
   quadLineFit1002->SetParameter(0,74.57047);
   quadLineFit1002->SetParError(0,0.05045975);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.47913);
   quadLineFit1002->SetParError(1,0.8460223);
   ...
   quadLineFit1003->SetChisquare(4.099769);
   ...
   quadLineFit1003->SetParameter(0,74.57047);
   quadLineFit1003->SetParError(0,0.05045975);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.47913);
   quadLineFit1003->SetParError(1,0.8460223);
   ...
   Graph_30_ppm1003->SetMinimum(75.83364);
   Graph_30_ppm1003->SetMaximum(76.47666);
   ...
   quadLineFit1004->SetChisquare(2.002923);
   ...
   quadLineFit1004->SetParameter(0,74.57755);
   quadLineFit1004->SetParError(0,0.04247509);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.62416);
   quadLineFit1004->SetParError(1,0.6977476);
   ...
   quadLineFit1005->SetChisquare(2.002923);
   ...
   quadLineFit1005->SetParameter(0,74.57755);
   quadLineFit1005->SetParError(0,0.04247509);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.62416);
   quadLineFit1005->SetParError(1,0.6977476);
   ...
   Graph_10_ppm1005->SetMinimum(74.85963);
   Graph_10_ppm1005->SetMaximum(75.08057);
   ...
   quadLineFit1006->SetChisquare(6.426889);
   ...
   quadLineFit1006->SetParameter(0,74.48613);
   quadLineFit1006->SetParError(0,0.04958378);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.635832);
   quadLineFit1006->SetParError(1,0.8037401);
   ...
   quadLineFit1007->SetChisquare(6.426889);
   ...
   quadLineFit1007->SetParameter(0,74.48613);
   quadLineFit1007->SetParError(0,0.04958378);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.635832);
   quadLineFit1007->SetParError(1,0.8037401);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.60302);
   Graph_mI10_ppm1007->SetMaximum(73.92679);
   ...
   quadLineFit1008->SetChisquare(6.403674);
   ...
   quadLineFit1008->SetParameter(0,74.4622);
   quadLineFit1008->SetParError(0,0.04372552);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.48232);
   quadLineFit1008->SetParError(1,0.7113772);
   ...
   quadLineFit1009->SetChisquare(6.403674);
   ...
   quadLineFit1009->SetParameter(0,74.4622);
   quadLineFit1009->SetParError(0,0.04372552);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.48232);
   quadLineFit1009->SetParError(1,0.7113772);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.19499);
   Graph_mI30_ppm1009->SetMaximum(72.95294);
   ...
   quadLineFit1010->SetChisquare(1.005111);
   ...
   quadLineFit1010->SetParameter(0,74.43545);
   quadLineFit1010->SetParError(0,0.04129008);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-30.22102);
   quadLineFit1010->SetParError(1,0.7141944);
   ...
   quadLineFit1011->SetChisquare(1.005111);
   ...
   quadLineFit1011->SetParameter(0,74.43545);
   quadLineFit1011->SetParError(0,0.04129008);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-30.22102);
   quadLineFit1011->SetParError(1,0.7141944);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.27871);
   Graph_mI50_ppm1011->SetMaximum(71.96031);
   ...
   quadLineFit1012->SetChisquare(0.4280079);
   ...
   quadLineFit1012->SetParameter(0,74.3869);
   quadLineFit1012->SetParError(0,0.08346623);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.56504);
   quadLineFit1012->SetParError(1,1.493172);
   ...
   quadLineFit1013->SetChisquare(0.4280079);
   ...
   quadLineFit1013->SetParameter(0,74.3869);
   quadLineFit1013->SetParError(0,0.08346623);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.56504);
   quadLineFit1013->SetParError(1,1.493172);
