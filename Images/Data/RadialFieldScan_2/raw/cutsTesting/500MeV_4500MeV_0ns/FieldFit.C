...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.69655);
   Graph_Graph01020->SetMaximum(55.96349);
   ...
   mainFit1021->SetChisquare(1.182005);
   ...
   mainFit1021->SetParameter(0,-2.01409);
   mainFit1021->SetParError(0,0.3308057);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9394567);
   mainFit1021->SetParError(1,0.01094054);
   ...
   mainFit1022->SetChisquare(1.182005);
   ...
   mainFit1022->SetParameter(0,-2.01409);
   mainFit1022->SetParError(0,0.3308057);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9394567);
   mainFit1022->SetParError(1,0.01094054);
