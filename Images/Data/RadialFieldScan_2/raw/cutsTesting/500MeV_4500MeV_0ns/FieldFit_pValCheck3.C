...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.69655);
   Graph_Graph01031->SetMaximum(55.96349);
   ...
   mainFit1032->SetChisquare(1.16749);
   ...
   mainFit1032->SetParameter(0,-1.991365);
   mainFit1032->SetParError(0,0.3808887);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9391114);
   mainFit1032->SetParError(1,0.01132347);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.0113");
   pt_LaTex = pt->AddText("#minus1.99#pm0.381");
   pt_LaTex = pt->AddText("#minus2.12#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.120478,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.120478,-59.69655,2.120478,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.16749);
   ...
   mainFit1033->SetParameter(0,-1.991365);
   mainFit1033->SetParError(0,0.3808887);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9391114);
   mainFit1033->SetParError(1,0.01132347);
