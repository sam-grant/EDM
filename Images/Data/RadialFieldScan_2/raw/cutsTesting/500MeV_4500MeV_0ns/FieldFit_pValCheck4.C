...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.69655);
   Graph_Graph01033->SetMaximum(55.96349);
   ...
   mainFit1034->SetChisquare(1.17995);
   ...
   mainFit1034->SetParameter(0,-2.002772);
   mainFit1034->SetParError(0,0.4147622);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9390902);
   mainFit1034->SetParError(1,0.01368915);
   ...
   pt_LaTex = pt->AddText("0.939#pm0.0137");
   pt_LaTex = pt->AddText("   #minus2#pm0.415");
   pt_LaTex = pt->AddText("#minus2.13#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.132672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.132672,-59.69655,2.132672,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.17995);
   ...
   mainFit1035->SetParameter(0,-2.002772);
   mainFit1035->SetParError(0,0.4147622);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9390902);
   mainFit1035->SetParError(1,0.01368915);
