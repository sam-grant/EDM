...
//=========  (Thu Apr 22 14:16:28 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01898667);
   Graph_Graph11015->SetMaximum(0.009742173);
   ...
   Graph_Graph21016->SetMinimum(-0.01835416);
   Graph_Graph21016->SetMaximum(0.02154473);
   ...
   Graph_Graph31017->SetMinimum(-0.02417003);
   Graph_Graph31017->SetMaximum(0.01783392);
   ...
   Graph_Graph41018->SetMinimum(-0.00704408);
   Graph_Graph41018->SetMaximum(0.008423644);
   ...
   Graph_Graph51019->SetMinimum(-0.004438011);
   Graph_Graph51019->SetMaximum(0.005913687);
