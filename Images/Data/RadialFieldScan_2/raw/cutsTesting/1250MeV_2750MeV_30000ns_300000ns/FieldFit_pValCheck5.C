...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-42.45563,70,59.15749);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.29432);
   Graph_Graph01035->SetMaximum(48.99618);
   ...
   mainFit1036->SetChisquare(2.398712);
   ...
   mainFit1036->SetParameter(0,-0.1866382);
   mainFit1036->SetParError(0,0.5996678);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.801959);
   mainFit1036->SetParError(1,0.02081517);
   ...
   pt_LaTex = pt->AddText("#minus0.187#pm  0.6");
   pt_LaTex = pt->AddText("#minus0.233#pm0.746");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.2327279,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2327279,-32.29432,0.2327279,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.398712);
   ...
   mainFit1037->SetParameter(0,-0.1866382);
   mainFit1037->SetParError(0,0.5996678);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.801959);
   mainFit1037->SetParError(1,0.02081517);
