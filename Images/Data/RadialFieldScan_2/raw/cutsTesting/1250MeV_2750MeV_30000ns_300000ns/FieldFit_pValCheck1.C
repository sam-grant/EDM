...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.4051);
   Graph_Graph01027->SetMaximum(50.82443);
   ...
   mainFit1028->SetChisquare(0.4665047);
   ...
   mainFit1028->SetParameter(0,0.1690328);
   mainFit1028->SetParError(0,0.6413462);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.818387);
   mainFit1028->SetParError(1,0.02122267);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.156");
   pt_LaTex = pt->AddText("0.818#pm0.0212");
   pt_LaTex = pt->AddText("0.169#pm0.641");
   pt_LaTex = pt->AddText("0.207#pm0.783");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.2065438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.2065438,-52.4051,-0.2065438,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.4665047);
   ...
   mainFit1029->SetParameter(0,0.1690328);
   mainFit1029->SetParError(0,0.6413462);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.818387);
   mainFit1029->SetParError(1,0.02122267);
