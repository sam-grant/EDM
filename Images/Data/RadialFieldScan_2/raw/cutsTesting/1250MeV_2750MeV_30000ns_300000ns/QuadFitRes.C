...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03092876);
   Graph_Graph11015->SetMaximum(0.05052885);
   ...
   Graph_Graph21016->SetMinimum(-0.00267465);
   Graph_Graph21016->SetMaximum(0.003149364);
   ...
   Graph_Graph31017->SetMinimum(-0.04488253);
   Graph_Graph31017->SetMaximum(0.03405528);
   ...
   Graph_Graph41018->SetMinimum(-0.008530471);
   Graph_Graph41018->SetMaximum(0.01134299);
   ...
   Graph_Graph51019->SetMinimum(-0.01398636);
   Graph_Graph51019->SetMaximum(0.01868562);
