...
//=========  (Tue Apr 27 00:41:49 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.9063251);
   ...
   quadLineFit1002->SetParameter(0,74.71763);
   quadLineFit1002->SetParError(0,0.08797285);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.74616);
   quadLineFit1002->SetParError(1,1.475808);
   ...
   quadLineFit1003->SetChisquare(0.9063251);
   ...
   quadLineFit1003->SetParameter(0,74.71763);
   quadLineFit1003->SetParError(0,0.08797285);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.74616);
   quadLineFit1003->SetParError(1,1.475808);
   ...
   Graph_30_ppm1003->SetMinimum(75.83336);
   Graph_30_ppm1003->SetMaximum(76.39761);
   ...
   quadLineFit1004->SetChisquare(5.872402);
   ...
   quadLineFit1004->SetParameter(0,74.72926);
   quadLineFit1004->SetParError(0,0.07327833);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.54092);
   quadLineFit1004->SetParError(1,1.204438);
   ...
   quadLineFit1005->SetChisquare(5.872402);
   ...
   quadLineFit1005->SetParameter(0,74.72926);
   quadLineFit1005->SetParError(0,0.07327833);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.54092);
   quadLineFit1005->SetParError(1,1.204438);
   ...
   Graph_10_ppm1005->SetMinimum(74.89577);
   Graph_10_ppm1005->SetMaximum(75.16548);
   ...
   quadLineFit1006->SetChisquare(0.04581594);
   ...
   quadLineFit1006->SetParameter(0,74.46817);
   quadLineFit1006->SetParError(0,0.08586409);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.110486);
   quadLineFit1006->SetParError(1,1.392561);
   ...
   quadLineFit1007->SetChisquare(0.04581594);
   ...
   quadLineFit1007->SetParameter(0,74.46817);
   quadLineFit1007->SetParError(0,0.08586409);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.110486);
   quadLineFit1007->SetParError(1,1.392561);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.80556);
   Graph_mI10_ppm1007->SetMaximum(74.08971);
   ...
   quadLineFit1008->SetChisquare(7.305751);
   ...
   quadLineFit1008->SetParameter(0,74.44613);
   quadLineFit1008->SetParError(0,0.07540313);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.353621);
   quadLineFit1008->SetParError(1,1.227329);
   ...
   quadLineFit1009->SetChisquare(7.305751);
   ...
   quadLineFit1009->SetParameter(0,74.44613);
   quadLineFit1009->SetParError(0,0.07540313);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.353621);
   quadLineFit1009->SetParError(1,1.227329);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.52841);
   Graph_mI30_ppm1009->SetMaximum(73.16247);
   ...
   quadLineFit1010->SetChisquare(0.4210735);
   ...
   quadLineFit1010->SetParameter(0,74.34516);
   quadLineFit1010->SetParError(0,0.0713125);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.28592);
   quadLineFit1010->SetParError(1,1.23419);
   ...
   quadLineFit1011->SetChisquare(0.4210735);
   ...
   quadLineFit1011->SetParameter(0,74.34516);
   quadLineFit1011->SetParError(0,0.0713125);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.28592);
   quadLineFit1011->SetParError(1,1.23419);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.64787);
   Graph_mI50_ppm1011->SetMaximum(72.25032);
   ...
   quadLineFit1012->SetChisquare(1.434402);
   ...
   quadLineFit1012->SetParameter(0,74.30721);
   quadLineFit1012->SetParError(0,0.1438902);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.22813);
   quadLineFit1012->SetParError(1,2.574512);
   ...
   quadLineFit1013->SetChisquare(1.434402);
   ...
   quadLineFit1013->SetParameter(0,74.30721);
   quadLineFit1013->SetParError(0,0.1438902);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.22813);
   quadLineFit1013->SetParError(1,2.574512);
