...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.4051);
   Graph_Graph01023->SetMaximum(50.82443);
   ...
   mainFit1024->SetChisquare(2.504735);
   ...
   mainFit1024->SetParameter(0,-0.2453647);
   mainFit1024->SetParError(0,0.5719027);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8047597);
   mainFit1024->SetParError(1,0.01895496);
   ...
   mainFit1025->SetChisquare(2.504735);
   ...
   mainFit1025->SetParameter(0,-0.2453647);
   mainFit1025->SetParError(0,0.5719027);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8047597);
   mainFit1025->SetParError(1,0.01895496);
