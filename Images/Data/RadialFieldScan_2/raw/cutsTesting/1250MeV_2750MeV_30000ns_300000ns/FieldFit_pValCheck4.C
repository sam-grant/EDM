...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.4051);
   Graph_Graph01033->SetMaximum(50.82443);
   ...
   mainFit1034->SetChisquare(2.491164);
   ...
   mainFit1034->SetParameter(0,-0.2955855);
   mainFit1034->SetParError(0,0.7161878);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8064173);
   mainFit1034->SetParError(1,0.0237015);
   ...
   pt_LaTex = pt->AddText("0.806#pm0.0237");
   pt_LaTex = pt->AddText("#minus0.296#pm0.716");
   pt_LaTex = pt->AddText("#minus0.367#pm0.883");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3665416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3665416,-52.4051,0.3665416,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.491164);
   ...
   mainFit1035->SetParameter(0,-0.2955855);
   mainFit1035->SetParError(0,0.7161878);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8064173);
   mainFit1035->SetParError(1,0.0237015);
