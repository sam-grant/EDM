...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.4051);
   Graph_Graph01029->SetMaximum(50.82443);
   ...
   mainFit1030->SetChisquare(1.441944);
   ...
   mainFit1030->SetParameter(0,-0.4971794);
   mainFit1030->SetParError(0,0.6218836);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8032281);
   mainFit1030->SetParError(1,0.01901299);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.481");
   pt_LaTex = pt->AddText("0.803#pm0.019");
   pt_LaTex = pt->AddText("#minus0.497#pm0.622");
   pt_LaTex = pt->AddText("#minus0.619#pm0.773");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6189766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6189766,-52.4051,0.6189766,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.441944);
   ...
   mainFit1031->SetParameter(0,-0.4971794);
   mainFit1031->SetParError(0,0.6218836);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8032281);
   mainFit1031->SetParError(1,0.01901299);
