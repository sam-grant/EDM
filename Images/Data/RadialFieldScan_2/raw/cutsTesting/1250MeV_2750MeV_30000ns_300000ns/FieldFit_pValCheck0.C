...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-60.68964,50,40.63236);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-50.55744);
   Graph_Graph01025->SetMaximum(30.50016);
   ...
   mainFit1026->SetChisquare(1.99939);
   ...
   mainFit1026->SetParameter(0,-0.4074205);
   mainFit1026->SetParError(0,0.6156493);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7938516);
   mainFit1026->SetParError(1,0.02438131);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.666");
   pt_LaTex = pt->AddText("0.794#pm0.0244");
   pt_LaTex = pt->AddText("#minus0.407#pm0.616");
   pt_LaTex = pt->AddText("#minus0.513#pm0.778");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.5132199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5132199,-50.55744,0.5132199,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.99939);
   ...
   mainFit1027->SetParameter(0,-0.4074205);
   mainFit1027->SetParError(0,0.6156493);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7938516);
   mainFit1027->SetParError(1,0.02438131);
