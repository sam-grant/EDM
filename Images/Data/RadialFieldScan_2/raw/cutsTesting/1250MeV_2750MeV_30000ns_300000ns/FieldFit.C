...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.4051);
   Graph_Graph01020->SetMaximum(50.82443);
   ...
   mainFit1021->SetChisquare(2.504735);
   ...
   mainFit1021->SetParameter(0,-0.2453647);
   mainFit1021->SetParError(0,0.5719027);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8047597);
   mainFit1021->SetParError(1,0.01895496);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.626");
   pt_LaTex = pt->AddText("0.805#pm0.019");
   pt_LaTex = pt->AddText("#minus0.245#pm0.572");
   pt_LaTex = pt->AddText("#minus0.305#pm 0.71");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3048919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3048919,-52.4051,0.3048919,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.504735);
   ...
   mainFit1022->SetParameter(0,-0.2453647);
   mainFit1022->SetParError(0,0.5719027);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8047597);
   mainFit1022->SetParError(1,0.01895496);
