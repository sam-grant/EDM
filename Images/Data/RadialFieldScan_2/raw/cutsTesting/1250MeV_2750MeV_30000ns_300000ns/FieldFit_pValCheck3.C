...
//=========  (Tue Apr 27 00:41:50 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-65.3088,75,63.72812);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-52.4051);
   Graph_Graph01031->SetMaximum(50.82443);
   ...
   mainFit1032->SetChisquare(2.501417);
   ...
   mainFit1032->SetParameter(0,-0.2265422);
   mainFit1032->SetParError(0,0.6586851);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8044697);
   mainFit1032->SetParError(1,0.01961217);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.834");
   pt_LaTex = pt->AddText("0.804#pm0.0196");
   pt_LaTex = pt->AddText("#minus0.227#pm0.659");
   pt_LaTex = pt->AddText("#minus0.282#pm0.817");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2816044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2816044,-52.4051,0.2816044,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.501417);
   ...
   mainFit1033->SetParameter(0,-0.2265422);
   mainFit1033->SetParError(0,0.6586851);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8044697);
   mainFit1033->SetParError(1,0.01961217);
