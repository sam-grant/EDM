...
//=========  (Tue Apr 27 00:38:20 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-48.89878,70,66.75537);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.33337);
   Graph_Graph01035->SetMaximum(55.18995);
   ...
   mainFit1036->SetChisquare(9.015926);
   ...
   mainFit1036->SetParameter(0,-1.259641);
   mainFit1036->SetParError(0,0.4638347);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.924982);
   mainFit1036->SetParError(1,0.01597091);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.01");
   pt_LaTex = pt->AddText("0.925#pm0.016");
   pt_LaTex = pt->AddText("#minus1.26#pm0.464");
   pt_LaTex = pt->AddText("#minus1.36#pm0.496");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.3618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.3618,-37.33337,1.3618,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.015926);
   ...
   mainFit1037->SetParameter(0,-1.259641);
   mainFit1037->SetParError(0,0.4638347);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.924982);
   mainFit1037->SetParError(1,0.01597091);
