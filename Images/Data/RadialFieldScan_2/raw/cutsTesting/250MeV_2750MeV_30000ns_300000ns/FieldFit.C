...
//=========  (Tue Apr 27 00:38:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.59115);
   Graph_Graph01020->SetMaximum(57.21339);
   ...
   mainFit1021->SetChisquare(9.040748);
   ...
   mainFit1021->SetParameter(0,-1.281792);
   mainFit1021->SetParError(0,0.4420121);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9260184);
   mainFit1021->SetParError(1,0.01455321);
   ...
   mainFit1022->SetChisquare(9.040748);
   ...
   mainFit1022->SetParameter(0,-1.281792);
   mainFit1022->SetParError(0,0.4420121);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9260184);
   mainFit1022->SetParError(1,0.01455321);
