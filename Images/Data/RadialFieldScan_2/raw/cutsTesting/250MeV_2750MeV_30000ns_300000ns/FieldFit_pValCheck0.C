...
//=========  (Tue Apr 27 00:38:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01025->SetMinimum(-57.39227);
   Graph_Graph01025->SetMaximum(33.02575);
   ...
   mainFit1026->SetChisquare(6.135038);
   ...
   mainFit1026->SetParameter(0,-1.58668);
   mainFit1026->SetParError(0,0.476829);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9055019);
   mainFit1026->SetParError(1,0.01888539);
   ...
   pt_LaTex = pt->AddText("0.906#pm0.0189");
   pt_LaTex = pt->AddText("#minus1.59#pm0.477");
   pt_LaTex = pt->AddText("#minus1.75#pm0.532");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.752266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.752266,-57.39227,1.752266,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(6.135038);
   ...
   mainFit1027->SetParameter(0,-1.58668);
   mainFit1027->SetParError(0,0.476829);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9055019);
   mainFit1027->SetParError(1,0.01888539);
