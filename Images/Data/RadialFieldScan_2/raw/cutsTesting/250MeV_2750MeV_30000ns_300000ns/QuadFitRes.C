...
//=========  (Tue Apr 27 00:38:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0214263);
   Graph_Graph11015->SetMaximum(0.0207467);
   ...
   Graph_Graph21016->SetMinimum(-0.00832);
   Graph_Graph21016->SetMaximum(0.009796307);
   ...
   Graph_Graph31017->SetMinimum(-0.03059109);
   Graph_Graph31017->SetMaximum(0.02928412);
   ...
   Graph_Graph41018->SetMinimum(-0.007622364);
   Graph_Graph41018->SetMaximum(0.009338005);
   ...
   Graph_Graph51019->SetMinimum(-0.004037023);
   Graph_Graph51019->SetMaximum(0.005395657);
