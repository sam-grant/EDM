...
//=========  (Tue Apr 27 00:38:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.59115);
   Graph_Graph01027->SetMaximum(57.21339);
   ...
   mainFit1028->SetChisquare(2.183281);
   ...
   mainFit1028->SetParameter(0,-0.7061073);
   mainFit1028->SetParError(0,0.4936634);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9446474);
   mainFit1028->SetParError(1,0.01619887);
   ...
   pt_LaTex = pt->AddText("0.945#pm0.0162");
   pt_LaTex = pt->AddText("#minus0.706#pm0.494");
   pt_LaTex = pt->AddText("#minus0.747#pm0.524");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7474824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7474824,-59.59115,0.7474824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.183281);
   ...
   mainFit1029->SetParameter(0,-0.7061073);
   mainFit1029->SetParError(0,0.4936634);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9446474);
   mainFit1029->SetParError(1,0.01619887);
