...
//=========  (Tue Apr 27 00:38:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.59115);
   Graph_Graph01031->SetMaximum(57.21339);
   ...
   mainFit1032->SetChisquare(8.416076);
   ...
   mainFit1032->SetParameter(0,-1.082069);
   mainFit1032->SetParError(0,0.5091478);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9229193);
   mainFit1032->SetParError(1,0.0150722);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.81");
   pt_LaTex = pt->AddText("0.923#pm0.0151");
   pt_LaTex = pt->AddText("#minus1.08#pm0.509");
   pt_LaTex = pt->AddText("#minus1.17#pm0.547");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.172441,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.172441,-59.59115,1.172441,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(8.416076);
   ...
   mainFit1033->SetParameter(0,-1.082069);
   mainFit1033->SetParError(0,0.5091478);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9229193);
   mainFit1033->SetParError(1,0.0150722);
