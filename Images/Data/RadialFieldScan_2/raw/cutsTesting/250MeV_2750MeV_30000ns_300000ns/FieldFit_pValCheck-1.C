...
//=========  (Tue Apr 27 00:38:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.59115);
   Graph_Graph01023->SetMaximum(57.21339);
   ...
   mainFit1024->SetChisquare(9.040748);
   ...
   mainFit1024->SetParameter(0,-1.281792);
   mainFit1024->SetParError(0,0.4420121);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9260184);
   mainFit1024->SetParError(1,0.01455321);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.26");
   pt_LaTex = pt->AddText("0.926#pm0.0146");
   pt_LaTex = pt->AddText("#minus1.28#pm0.442");
   pt_LaTex = pt->AddText("#minus1.38#pm0.474");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.384197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.384197,-59.59115,1.384197,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(9.040748);
   ...
   mainFit1025->SetParameter(0,-1.281792);
   mainFit1025->SetParError(0,0.4420121);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9260184);
   mainFit1025->SetParError(1,0.01455321);
