...
//=========  (Tue Apr 27 00:38:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.59115);
   Graph_Graph01033->SetMaximum(57.21339);
   ...
   mainFit1034->SetChisquare(8.703464);
   ...
   mainFit1034->SetParameter(0,-1.476349);
   mainFit1034->SetParError(0,0.554618);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9323681);
   mainFit1034->SetParError(1,0.01820267);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("  2.9");
   pt_LaTex = pt->AddText("0.932#pm0.0182");
   pt_LaTex = pt->AddText("#minus1.48#pm0.555");
   pt_LaTex = pt->AddText("#minus1.58#pm0.581");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.583439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.583439,-59.59115,1.583439,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.703464);
   ...
   mainFit1035->SetParameter(0,-1.476349);
   mainFit1035->SetParError(0,0.554618);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9323681);
   mainFit1035->SetParError(1,0.01820267);
