...
//=========  (Wed Apr 28 14:32:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.40139);
   Graph_Graph01033->SetMaximum(56.51343);
   ...
   mainFit1034->SetChisquare(4.244428);
   ...
   mainFit1034->SetParameter(0,-1.253929);
   mainFit1034->SetParError(0,0.501544);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9311108);
   mainFit1034->SetParError(1,0.01654612);
   ...
   pt_LaTex = pt->AddText("0.931#pm0.0165");
   pt_LaTex = pt->AddText("#minus1.25#pm0.502");
   pt_LaTex = pt->AddText("#minus1.35#pm0.528");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.346702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.346702,-59.40139,1.346702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.244428);
   ...
   mainFit1035->SetParameter(0,-1.253929);
   mainFit1035->SetParError(0,0.501544);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9311108);
   mainFit1035->SetParError(1,0.01654612);
