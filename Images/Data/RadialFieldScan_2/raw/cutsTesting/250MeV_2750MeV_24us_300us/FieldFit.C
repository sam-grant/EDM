...
//=========  (Wed Apr 28 14:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.40139);
   Graph_Graph01020->SetMaximum(56.51343);
   ...
   mainFit1021->SetChisquare(4.251831);
   ...
   mainFit1021->SetParameter(0,-1.227914);
   mainFit1021->SetParError(0,0.400159);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9302558);
   mainFit1021->SetParError(1,0.01322971);
   ...
   mainFit1022->SetChisquare(4.251831);
   ...
   mainFit1022->SetParameter(0,-1.227914);
   mainFit1022->SetParError(0,0.400159);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9302558);
   mainFit1022->SetParError(1,0.01322971);
