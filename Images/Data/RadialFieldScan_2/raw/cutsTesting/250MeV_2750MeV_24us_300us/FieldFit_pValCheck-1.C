...
//=========  (Wed Apr 28 14:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.40139);
   Graph_Graph01023->SetMaximum(56.51343);
   ...
   mainFit1024->SetChisquare(4.251831);
   ...
   mainFit1024->SetParameter(0,-1.227914);
   mainFit1024->SetParError(0,0.400159);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9302558);
   mainFit1024->SetParError(1,0.01322971);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.23#pm  0.4");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.319975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.319975,-59.40139,1.319975,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(4.251831);
   ...
   mainFit1025->SetParameter(0,-1.227914);
   mainFit1025->SetParError(0,0.400159);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9302558);
   mainFit1025->SetParError(1,0.01322971);
