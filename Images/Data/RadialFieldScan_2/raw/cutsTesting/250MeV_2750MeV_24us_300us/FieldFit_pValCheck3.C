...
//=========  (Wed Apr 28 14:32:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.40139);
   Graph_Graph01031->SetMaximum(56.51343);
   ...
   mainFit1032->SetChisquare(4.034666);
   ...
   mainFit1032->SetParameter(0,-1.121371);
   mainFit1032->SetParError(0,0.4608671);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.92861);
   mainFit1032->SetParError(1,0.01369303);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.12#pm0.461");
   pt_LaTex = pt->AddText("#minus1.21#pm0.492");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.20758,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.20758,-59.40139,1.20758,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.034666);
   ...
   mainFit1033->SetParameter(0,-1.121371);
   mainFit1033->SetParError(0,0.4608671);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.92861);
   mainFit1033->SetParError(1,0.01369303);
