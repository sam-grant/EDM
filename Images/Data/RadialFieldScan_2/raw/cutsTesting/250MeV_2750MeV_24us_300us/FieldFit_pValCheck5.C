...
//=========  (Wed Apr 28 14:32:19 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.14692,70,66.05402);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.62683);
   Graph_Graph01035->SetMaximum(54.53393);
   ...
   mainFit1036->SetChisquare(4.23665);
   ...
   mainFit1036->SetParameter(0,-1.212319);
   mainFit1036->SetParError(0,0.4197001);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9295174);
   mainFit1036->SetParError(1,0.01452375);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0145");
   pt_LaTex = pt->AddText("#minus1.21#pm 0.42");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.447");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.304246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.304246,-37.62683,1.304246,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.23665);
   ...
   mainFit1037->SetParameter(0,-1.212319);
   mainFit1037->SetParError(0,0.4197001);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9295174);
   mainFit1037->SetParError(1,0.01452375);
