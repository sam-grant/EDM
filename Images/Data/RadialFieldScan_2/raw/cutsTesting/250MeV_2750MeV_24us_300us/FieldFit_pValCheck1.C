...
//=========  (Wed Apr 28 14:32:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.89074,75,71.00279);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.40139);
   Graph_Graph01027->SetMaximum(56.51343);
   ...
   mainFit1028->SetChisquare(1.526932);
   ...
   mainFit1028->SetParameter(0,-0.8953071);
   mainFit1028->SetParError(0,0.4480248);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9411277);
   mainFit1028->SetParError(1,0.01477852);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.509");
   pt_LaTex = pt->AddText("0.941#pm0.0148");
   pt_LaTex = pt->AddText("#minus0.895#pm0.448");
   pt_LaTex = pt->AddText("#minus0.951#pm0.477");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9513131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9513131,-59.40139,0.9513131,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.526932);
   ...
   mainFit1029->SetParameter(0,-0.8953071);
   mainFit1029->SetParError(0,0.4480248);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9411277);
   mainFit1029->SetParError(1,0.01477852);
