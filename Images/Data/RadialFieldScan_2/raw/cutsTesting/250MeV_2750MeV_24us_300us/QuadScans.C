...
//=========  (Wed Apr 28 14:32:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.304514);
   ...
   quadLineFit1002->SetParameter(0,74.49781);
   quadLineFit1002->SetParError(0,0.06100322);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.83056);
   quadLineFit1002->SetParError(1,1.023306);
   ...
   quadLineFit1003->SetChisquare(1.304514);
   ...
   quadLineFit1003->SetParameter(0,74.49781);
   quadLineFit1003->SetParError(0,0.06100322);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.83056);
   quadLineFit1003->SetParError(1,1.023306);
   ...
   Graph_30_ppm1003->SetMinimum(75.77442);
   Graph_30_ppm1003->SetMaximum(76.41455);
   ...
   quadLineFit1004->SetChisquare(1.354856);
   ...
   quadLineFit1004->SetParameter(0,74.52299);
   quadLineFit1004->SetParError(0,0.05132714);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.57818);
   quadLineFit1004->SetParError(1,0.8435911);
   ...
   quadLineFit1005->SetChisquare(1.354856);
   ...
   quadLineFit1005->SetParameter(0,74.52299);
   quadLineFit1005->SetParError(0,0.05132714);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.57818);
   quadLineFit1005->SetParError(1,0.8435911);
   ...
   Graph_10_ppm1005->SetMinimum(74.76862);
   Graph_10_ppm1005->SetMaximum(75.03554);
   ...
   quadLineFit1006->SetChisquare(0.9210144);
   ...
   quadLineFit1006->SetParameter(0,74.3126);
   quadLineFit1006->SetParError(0,0.06010211);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.482702);
   quadLineFit1006->SetParError(1,0.9747606);
   ...
   quadLineFit1007->SetChisquare(0.9210144);
   ...
   quadLineFit1007->SetParameter(0,74.3126);
   quadLineFit1007->SetParError(0,0.06010211);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.482702);
   quadLineFit1007->SetParError(1,0.9747606);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.53357);
   Graph_mI10_ppm1007->SetMaximum(73.84731);
   ...
   quadLineFit1008->SetChisquare(7.245418);
   ...
   quadLineFit1008->SetParameter(0,74.35747);
   quadLineFit1008->SetParError(0,0.05281643);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.87429);
   quadLineFit1008->SetParError(1,0.8597022);
   ...
   quadLineFit1009->SetChisquare(7.245418);
   ...
   quadLineFit1009->SetParameter(0,74.35747);
   quadLineFit1009->SetParError(0,0.05281643);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.87429);
   quadLineFit1009->SetParError(1,0.8597022);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.13502);
   Graph_mI30_ppm1009->SetMaximum(72.86718);
   ...
   quadLineFit1010->SetChisquare(1.057089);
   ...
   quadLineFit1010->SetParameter(0,74.29322);
   quadLineFit1010->SetParError(0,0.04992329);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.08272);
   quadLineFit1010->SetParError(1,0.864044);
   ...
   quadLineFit1011->SetChisquare(1.057089);
   ...
   quadLineFit1011->SetParameter(0,74.29322);
   quadLineFit1011->SetParError(0,0.04992329);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.08272);
   quadLineFit1011->SetParError(1,0.864044);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.19424);
   Graph_mI50_ppm1011->SetMaximum(71.8733);
   ...
   quadLineFit1012->SetChisquare(0.339829);
   ...
   quadLineFit1012->SetParameter(0,74.26602);
   quadLineFit1012->SetParError(0,0.1007975);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.93822);
   quadLineFit1012->SetParError(1,1.803604);
   ...
   quadLineFit1013->SetChisquare(0.339829);
   ...
   quadLineFit1013->SetParameter(0,74.26602);
   quadLineFit1013->SetParError(0,0.1007975);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.93822);
   quadLineFit1013->SetParError(1,1.803604);
