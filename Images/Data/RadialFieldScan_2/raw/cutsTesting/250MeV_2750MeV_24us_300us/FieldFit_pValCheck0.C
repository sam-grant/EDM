...
//=========  (Wed Apr 28 14:32:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.78272,50,45.46267);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.35818);
   Graph_Graph01025->SetMaximum(34.03813);
   ...
   mainFit1026->SetChisquare(3.695277);
   ...
   mainFit1026->SetParameter(0,-1.347604);
   mainFit1026->SetParError(0,0.4311229);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9222027);
   mainFit1026->SetParError(1,0.01707482);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0171");
   pt_LaTex = pt->AddText("#minus1.35#pm0.431");
   pt_LaTex = pt->AddText("#minus1.46#pm0.471");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.461288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.461288,-57.35818,1.461288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.695277);
   ...
   mainFit1027->SetParameter(0,-1.347604);
   mainFit1027->SetParError(0,0.4311229);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9222027);
   mainFit1027->SetParError(1,0.01707482);
