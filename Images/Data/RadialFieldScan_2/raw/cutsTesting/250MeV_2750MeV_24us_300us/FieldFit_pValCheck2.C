...
//=========  (Wed Apr 28 14:32:19 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.40139);
   Graph_Graph01029->SetMaximum(56.51343);
   ...
   mainFit1030->SetChisquare(1.741028);
   ...
   mainFit1030->SetParameter(0,-1.498191);
   mainFit1030->SetParError(0,0.4349961);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9286598);
   mainFit1030->SetParError(1,0.01326797);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0133");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.435");
   pt_LaTex = pt->AddText("#minus1.61#pm0.466");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.613283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.613283,-59.40139,1.613283,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.741028);
   ...
   mainFit1031->SetParameter(0,-1.498191);
   mainFit1031->SetParError(0,0.4349961);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9286598);
   mainFit1031->SetParError(1,0.01326797);
