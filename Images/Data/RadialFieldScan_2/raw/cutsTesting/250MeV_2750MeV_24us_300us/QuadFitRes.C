...
//=========  (Wed Apr 28 14:32:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01130855);
   Graph_Graph11015->SetMaximum(0.01404);
   ...
   Graph_Graph21016->SetMinimum(-0.008401949);
   Graph_Graph21016->SetMaximum(0.009886465);
   ...
   Graph_Graph31017->SetMinimum(-0.02545662);
   Graph_Graph31017->SetMaximum(0.03070408);
   ...
   Graph_Graph41018->SetMinimum(-0.006731356);
   Graph_Graph41018->SetMaximum(0.01130952);
   ...
   Graph_Graph51019->SetMinimum(-0.004762018);
   Graph_Graph51019->SetMaximum(0.006367338);
