...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.23052,70,64.82333);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.82513);
   Graph_Graph01035->SetMaximum(53.41795);
   ...
   mainFit1036->SetChisquare(1.598687);
   ...
   mainFit1036->SetParameter(0,-1.637807);
   mainFit1036->SetParError(0,0.3902283);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9251313);
   mainFit1036->SetParError(1,0.01355878);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.533");
   pt_LaTex = pt->AddText("0.925#pm0.0136");
   pt_LaTex = pt->AddText("#minus1.64#pm 0.39");
   pt_LaTex = pt->AddText("#minus1.77#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.770351,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.770351,-37.82513,1.770351,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.598687);
   ...
   mainFit1037->SetParameter(0,-1.637807);
   mainFit1037->SetParError(0,0.3902283);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9251313);
   mainFit1037->SetParError(1,0.01355878);
