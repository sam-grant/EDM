...
//=========  (Mon Apr 26 22:21:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.010726);
   Graph_Graph11015->SetMaximum(0.01327151);
   ...
   Graph_Graph21016->SetMinimum(-0.009902673);
   Graph_Graph21016->SetMaximum(0.01162502);
   ...
   Graph_Graph31017->SetMinimum(-0.02099974);
   Graph_Graph31017->SetMaximum(0.0187027);
   ...
   Graph_Graph41018->SetMinimum(-0.01408369);
   Graph_Graph41018->SetMaximum(0.01707519);
   ...
   Graph_Graph51019->SetMinimum(-0.006377152);
   Graph_Graph51019->SetMaximum(0.008506772);
