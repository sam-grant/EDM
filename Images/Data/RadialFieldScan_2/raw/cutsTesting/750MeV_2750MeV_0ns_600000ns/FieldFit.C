...
//=========  (Mon Apr 26 22:21:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.52118);
   Graph_Graph01020->SetMaximum(55.29941);
   ...
   mainFit1021->SetChisquare(1.678757);
   ...
   mainFit1021->SetParameter(0,-1.604647);
   mainFit1021->SetParError(0,0.3722422);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9235394);
   mainFit1021->SetParError(1,0.01234753);
   ...
   mainFit1022->SetChisquare(1.678757);
   ...
   mainFit1022->SetParameter(0,-1.604647);
   mainFit1022->SetParError(0,0.3722422);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9235394);
   mainFit1022->SetParError(1,0.01234753);
