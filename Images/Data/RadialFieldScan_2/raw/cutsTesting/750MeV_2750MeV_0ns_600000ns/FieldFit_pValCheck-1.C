...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.52118);
   Graph_Graph01023->SetMaximum(55.29941);
   ...
   mainFit1024->SetChisquare(1.678757);
   ...
   mainFit1024->SetParameter(0,-1.604647);
   mainFit1024->SetParError(0,0.3722422);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9235394);
   mainFit1024->SetParError(1,0.01234753);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.42");
   pt_LaTex = pt->AddText("0.924#pm0.0123");
   pt_LaTex = pt->AddText(" #minus1.6#pm0.372");
   pt_LaTex = pt->AddText("#minus1.74#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.737497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.737497,-58.52118,1.737497,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.678757);
   ...
   mainFit1025->SetParameter(0,-1.604647);
   mainFit1025->SetParError(0,0.3722422);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9235394);
   mainFit1025->SetParError(1,0.01234753);
