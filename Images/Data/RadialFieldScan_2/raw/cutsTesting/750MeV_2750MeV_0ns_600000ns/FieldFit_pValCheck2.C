...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.74876,75,69.52698);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-58.52118);
   Graph_Graph01029->SetMaximum(55.29941);
   ...
   mainFit1030->SetChisquare(0.5972664);
   ...
   mainFit1030->SetParameter(0,-1.770035);
   mainFit1030->SetParError(0,0.4047833);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9225272);
   mainFit1030->SetParError(1,0.01238634);
   ...
   pt_LaTex = pt->AddText("#minus1.77#pm0.405");
   pt_LaTex = pt->AddText("#minus1.92#pm0.437");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.918681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.918681,-58.52118,1.918681,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.5972664);
   ...
   mainFit1031->SetParameter(0,-1.770035);
   mainFit1031->SetParError(0,0.4047833);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9225272);
   mainFit1031->SetParError(1,0.01238634);
