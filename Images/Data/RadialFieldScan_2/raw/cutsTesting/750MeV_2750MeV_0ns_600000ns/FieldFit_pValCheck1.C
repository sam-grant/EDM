...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.52118);
   Graph_Graph01027->SetMaximum(55.29941);
   ...
   mainFit1028->SetChisquare(0.8686796);
   ...
   mainFit1028->SetParameter(0,-1.434083);
   mainFit1028->SetParError(0,0.417719);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9291657);
   mainFit1028->SetParError(1,0.01383705);
   ...
   pt_LaTex = pt->AddText("0.929#pm0.0138");
   pt_LaTex = pt->AddText("#minus1.43#pm0.418");
   pt_LaTex = pt->AddText("#minus1.54#pm0.452");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.54341,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.54341,-58.52118,1.54341,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.8686796);
   ...
   mainFit1029->SetParameter(0,-1.434083);
   mainFit1029->SetParError(0,0.417719);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9291657);
   mainFit1029->SetParError(1,0.01383705);
