...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.52118);
   Graph_Graph01033->SetMaximum(55.29941);
   ...
   mainFit1034->SetChisquare(1.64277);
   ...
   mainFit1034->SetParameter(0,-1.551429);
   mainFit1034->SetParError(0,0.4661883);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9217865);
   mainFit1034->SetParError(1,0.01544378);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.55#pm0.466");
   pt_LaTex = pt->AddText("#minus1.68#pm0.493");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.683068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.683068,-58.52118,1.683068,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.64277);
   ...
   mainFit1035->SetParameter(0,-1.551429);
   mainFit1035->SetParError(0,0.4661883);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9217865);
   mainFit1035->SetParError(1,0.01544378);
