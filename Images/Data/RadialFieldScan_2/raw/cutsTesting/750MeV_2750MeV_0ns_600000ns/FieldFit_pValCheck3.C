...
//=========  (Mon Apr 26 22:21:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.52118);
   Graph_Graph01031->SetMaximum(55.29941);
   ...
   mainFit1032->SetChisquare(1.52514);
   ...
   mainFit1032->SetParameter(0,-1.521359);
   mainFit1032->SetParError(0,0.4286563);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9222658);
   mainFit1032->SetParError(1,0.01277241);
   ...
   pt_LaTex = pt->AddText("0.922#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.52#pm0.429");
   pt_LaTex = pt->AddText("#minus1.65#pm0.459");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.649588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.649588,-58.52118,1.649588,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.52514);
   ...
   mainFit1033->SetParameter(0,-1.521359);
   mainFit1033->SetParError(0,0.4286563);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9222658);
   mainFit1033->SetParError(1,0.01277241);
