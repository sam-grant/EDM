...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-75.4982,75,71.89439);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01020->SetMinimum(-60.75894);
   Graph_Graph01020->SetMaximum(57.15513);
   ...
   mainFit1021->SetChisquare(3.365065);
   ...
   mainFit1021->SetParameter(0,-1.448936);
   mainFit1021->SetParError(0,0.4001444);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9406891);
   mainFit1021->SetParError(1,0.01322875);
   ...
   pt_LaTex = pt->AddText("0.941#pm0.0132");
   pt_LaTex = pt->AddText("#minus1.45#pm  0.4");
   pt_LaTex = pt->AddText("#minus1.54#pm0.422");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.540292,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.540292,-60.75894,1.540292,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.365065);
   ...
   mainFit1022->SetParameter(0,-1.448936);
   mainFit1022->SetParError(0,0.4001444);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9406891);
   mainFit1022->SetParError(1,0.01322875);
