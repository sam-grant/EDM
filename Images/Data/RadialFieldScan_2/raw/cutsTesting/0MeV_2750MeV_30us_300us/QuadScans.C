...
//=========  (Wed Apr 28 14:55:59 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2435678);
   ...
   quadLineFit1002->SetParameter(0,74.39724);
   quadLineFit1002->SetParError(0,0.06103347);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,46.30519);
   quadLineFit1002->SetParError(1,1.02377);
   ...
   quadLineFit1003->SetChisquare(0.2435678);
   ...
   quadLineFit1003->SetParameter(0,74.39724);
   quadLineFit1003->SetParError(0,0.06103347);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,46.30519);
   quadLineFit1003->SetParError(1,1.02377);
   ...
   Graph_30_ppm1003->SetMinimum(75.70025);
   Graph_30_ppm1003->SetMaximum(76.35092);
   ...
   quadLineFit1004->SetChisquare(0.9220988);
   ...
   quadLineFit1004->SetParameter(0,74.44518);
   quadLineFit1004->SetParError(0,0.05136333);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.79124);
   quadLineFit1004->SetParError(1,0.8441292);
   ...
   quadLineFit1005->SetChisquare(0.9220988);
   ...
   quadLineFit1005->SetParameter(0,74.44518);
   quadLineFit1005->SetParError(0,0.05136333);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.79124);
   quadLineFit1005->SetParError(1,0.8441292);
   ...
   Graph_10_ppm1005->SetMinimum(74.70463);
   Graph_10_ppm1005->SetMaximum(74.95452);
   ...
   quadLineFit1006->SetChisquare(0.44289);
   ...
   quadLineFit1006->SetParameter(0,74.28233);
   quadLineFit1006->SetParError(0,0.06014786);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.828048);
   quadLineFit1006->SetParError(1,0.9754038);
   ...
   quadLineFit1007->SetChisquare(0.44289);
   ...
   quadLineFit1007->SetParameter(0,74.28233);
   quadLineFit1007->SetParError(0,0.06014786);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.828048);
   quadLineFit1007->SetParError(1,0.9754038);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.45482);
   Graph_mI10_ppm1007->SetMaximum(73.7763);
   ...
   quadLineFit1008->SetChisquare(2.938394);
   ...
   quadLineFit1008->SetParameter(0,74.3061);
   quadLineFit1008->SetParError(0,0.05281502);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.33385);
   quadLineFit1008->SetParError(1,0.8596151);
   ...
   quadLineFit1009->SetChisquare(2.938394);
   ...
   quadLineFit1009->SetParameter(0,74.3061);
   quadLineFit1009->SetParError(0,0.05281502);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.33385);
   quadLineFit1009->SetParError(1,0.8596151);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.06652);
   Graph_mI30_ppm1009->SetMaximum(72.80182);
   ...
   quadLineFit1010->SetChisquare(0.1824052);
   ...
   quadLineFit1010->SetParameter(0,74.2308);
   quadLineFit1010->SetParError(0,0.04989408);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.20645);
   quadLineFit1010->SetParError(1,0.8635104);
   ...
   quadLineFit1011->SetChisquare(0.1824052);
   ...
   quadLineFit1011->SetParameter(0,74.2308);
   quadLineFit1011->SetParError(0,0.04989408);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.20645);
   quadLineFit1011->SetParError(1,0.8635104);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.12533);
   Graph_mI50_ppm1011->SetMaximum(71.82064);
   ...
   quadLineFit1012->SetChisquare(0.09661942);
   ...
   quadLineFit1012->SetParameter(0,74.27138);
   quadLineFit1012->SetParError(0,0.1007089);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.1308);
   quadLineFit1012->SetParError(1,1.801968);
   ...
   quadLineFit1013->SetChisquare(0.09661942);
   ...
   quadLineFit1013->SetParameter(0,74.27138);
   quadLineFit1013->SetParError(0,0.1007089);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.1308);
   quadLineFit1013->SetParError(1,1.801968);
