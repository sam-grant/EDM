...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-60.75894);
   Graph_Graph01033->SetMaximum(57.15513);
   ...
   mainFit1034->SetChisquare(2.796074);
   ...
   mainFit1034->SetParameter(0,-1.67698);
   mainFit1034->SetParError(0,0.5015097);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9481834);
   mainFit1034->SetParError(1,0.01654417);
   ...
   pt_LaTex = pt->AddText("0.948#pm0.0165");
   pt_LaTex = pt->AddText("#minus1.68#pm0.502");
   pt_LaTex = pt->AddText("#minus1.77#pm0.515");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.768624,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.768624,-60.75894,1.768624,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.796074);
   ...
   mainFit1035->SetParameter(0,-1.67698);
   mainFit1035->SetParError(0,0.5015097);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9481834);
   mainFit1035->SetParError(1,0.01654417);
