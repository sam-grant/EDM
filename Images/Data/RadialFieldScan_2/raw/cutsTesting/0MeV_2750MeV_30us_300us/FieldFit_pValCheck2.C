...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-60.75894);
   Graph_Graph01029->SetMaximum(57.15513);
   ...
   mainFit1030->SetChisquare(2.407734);
   ...
   mainFit1030->SetParameter(0,-1.615748);
   mainFit1030->SetParError(0,0.4349509);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9396988);
   mainFit1030->SetParError(1,0.01326737);
   ...
   pt_LaTex = pt->AddText(" 0.94#pm0.0133");
   pt_LaTex = pt->AddText("#minus1.62#pm0.435");
   pt_LaTex = pt->AddText("#minus1.72#pm0.461");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.719432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.719432,-60.75894,1.719432,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.407734);
   ...
   mainFit1031->SetParameter(0,-1.615748);
   mainFit1031->SetParError(0,0.4349509);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9396988);
   mainFit1031->SetParError(1,0.01326737);
