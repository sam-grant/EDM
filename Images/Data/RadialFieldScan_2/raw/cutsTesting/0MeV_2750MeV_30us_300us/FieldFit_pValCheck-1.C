...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-60.75894);
   Graph_Graph01023->SetMaximum(57.15513);
   ...
   mainFit1024->SetChisquare(3.365065);
   ...
   mainFit1024->SetParameter(0,-1.448936);
   mainFit1024->SetParError(0,0.4001444);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9406891);
   mainFit1024->SetParError(1,0.01322875);
   ...
   mainFit1025->SetChisquare(3.365065);
   ...
   mainFit1025->SetParameter(0,-1.448936);
   mainFit1025->SetParError(0,0.4001444);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9406891);
   mainFit1025->SetParError(1,0.01322875);
