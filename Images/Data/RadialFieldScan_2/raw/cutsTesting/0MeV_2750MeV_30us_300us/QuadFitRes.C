...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.00632174);
   Graph_Graph11015->SetMaximum(0.01675968);
   ...
   Graph_Graph21016->SetMinimum(-0.005828431);
   Graph_Graph21016->SetMaximum(0.006851079);
   ...
   Graph_Graph31017->SetMinimum(-0.01914838);
   Graph_Graph31017->SetMaximum(0.01465144);
   ...
   Graph_Graph41018->SetMinimum(-0.002708301);
   Graph_Graph41018->SetMaximum(0.004876507);
   ...
   Graph_Graph51019->SetMinimum(-0.002539575);
   Graph_Graph51019->SetMaximum(0.003392491);
