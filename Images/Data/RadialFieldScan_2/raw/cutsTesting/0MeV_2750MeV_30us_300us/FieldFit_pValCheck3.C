...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-60.75894);
   Graph_Graph01031->SetMaximum(57.15513);
   ...
   mainFit1032->SetChisquare(2.945261);
   ...
   mainFit1032->SetParameter(0,-1.300853);
   mainFit1032->SetParError(0,0.4608155);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9384054);
   mainFit1032->SetParError(1,0.01369024);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.982");
   pt_LaTex = pt->AddText("0.938#pm0.0137");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.461");
   pt_LaTex = pt->AddText("#minus1.39#pm0.486");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.386238,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.386238,-60.75894,1.386238,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.945261);
   ...
   mainFit1033->SetParameter(0,-1.300853);
   mainFit1033->SetParError(0,0.4608155);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9384054);
   mainFit1033->SetParError(1,0.01369024);
