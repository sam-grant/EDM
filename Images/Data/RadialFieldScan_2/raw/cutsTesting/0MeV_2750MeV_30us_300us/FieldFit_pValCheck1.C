...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-60.75894);
   Graph_Graph01027->SetMaximum(57.15513);
   ...
   mainFit1028->SetChisquare(1.20935);
   ...
   mainFit1028->SetParameter(0,-1.152998);
   mainFit1028->SetParError(0,0.4480433);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9503616);
   mainFit1028->SetParError(1,0.01477849);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.403");
   pt_LaTex = pt->AddText(" 0.95#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.15#pm0.448");
   pt_LaTex = pt->AddText("#minus1.21#pm0.473");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.21322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.21322,-60.75894,1.21322,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.20935);
   ...
   mainFit1029->SetParameter(0,-1.152998);
   mainFit1029->SetParError(0,0.4480433);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9503616);
   mainFit1029->SetParError(1,0.01477849);
