...
//=========  (Wed Apr 28 14:56:00 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-70.3248,50,46.02741);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-58.68958);
   Graph_Graph01025->SetMaximum(34.39219);
   ...
   mainFit1026->SetChisquare(2.397944);
   ...
   mainFit1026->SetParameter(0,-1.606967);
   mainFit1026->SetParError(0,0.4312056);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9300733);
   mainFit1026->SetParError(1,0.01707416);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.799");
   pt_LaTex = pt->AddText(" 0.93#pm0.0171");
   pt_LaTex = pt->AddText("#minus1.61#pm0.431");
   pt_LaTex = pt->AddText("#minus1.73#pm0.468");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.727786,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.727786,-58.68958,1.727786,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.397944);
   ...
   mainFit1027->SetParameter(0,-1.606967);
   mainFit1027->SetParError(0,0.4312056);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9300733);
   mainFit1027->SetParError(1,0.01707416);
