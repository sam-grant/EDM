...
//=========  (Fri Apr 23 21:21:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-46.37681);
   Graph_Graph01033->SetMaximum(50.1217);
   ...
   mainFit1034->SetChisquare(5.585547);
   ...
   mainFit1034->SetParameter(0,0.3562639);
   mainFit1034->SetParError(0,1.128521);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7362473);
   mainFit1034->SetParError(1,0.03723);
   ...
   pt_LaTex = pt->AddText("0.736#pm0.0372");
   pt_LaTex = pt->AddText("0.356#pm 1.13");
   pt_LaTex = pt->AddText("0.484#pm 1.54");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.4838916,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.4838916,-46.37681,-0.4838916,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.585547);
   ...
   mainFit1035->SetParameter(0,0.3562639);
   mainFit1035->SetParError(0,1.128521);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7362473);
   mainFit1035->SetParError(1,0.03723);
