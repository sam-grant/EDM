...
//=========  (Fri Apr 23 21:21:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-46.37681);
   Graph_Graph01023->SetMaximum(50.1217);
   ...
   mainFit1024->SetChisquare(6.408661);
   ...
   mainFit1024->SetParameter(0,-0.2605149);
   mainFit1024->SetParError(0,0.9007734);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7565182);
   mainFit1024->SetParError(1,0.02978018);
   ...
   pt_LaTex = pt->AddText("0.757#pm0.0298");
   pt_LaTex = pt->AddText("#minus0.261#pm0.901");
   pt_LaTex = pt->AddText("#minus0.344#pm 1.19");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3443604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3443604,-46.37681,0.3443604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.408661);
   ...
   mainFit1025->SetParameter(0,-0.2605149);
   mainFit1025->SetParError(0,0.9007734);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7565182);
   mainFit1025->SetParError(1,0.02978018);
