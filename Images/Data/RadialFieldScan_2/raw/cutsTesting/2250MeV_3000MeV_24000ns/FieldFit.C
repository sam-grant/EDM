...
//=========  (Fri Apr 23 21:21:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-46.37681);
   Graph_Graph01020->SetMaximum(50.1217);
   ...
   mainFit1021->SetChisquare(6.408661);
   ...
   mainFit1021->SetParameter(0,-0.2605149);
   mainFit1021->SetParError(0,0.9007734);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7565182);
   mainFit1021->SetParError(1,0.02978018);
   ...
   mainFit1022->SetChisquare(6.408661);
   ...
   mainFit1022->SetParameter(0,-0.2605149);
   mainFit1022->SetParError(0,0.9007734);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7565182);
   mainFit1022->SetParError(1,0.02978018);
