...
//=========  (Fri Apr 23 21:21:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-53.23815,50,36.17916);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-44.29642);
   Graph_Graph01025->SetMaximum(27.23743);
   ...
   mainFit1026->SetChisquare(4.594786);
   ...
   mainFit1026->SetParameter(0,-0.7464673);
   mainFit1026->SetParError(0,0.9703399);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7237549);
   mainFit1026->SetParError(1,0.03844852);
   ...
   pt_LaTex = pt->AddText("0.724#pm0.0384");
   pt_LaTex = pt->AddText("#minus0.746#pm 0.97");
   pt_LaTex = pt->AddText("#minus1.03#pm 1.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.031381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.031381,-44.29642,1.031381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.594786);
   ...
   mainFit1027->SetParameter(0,-0.7464673);
   mainFit1027->SetParError(0,0.9703399);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7237549);
   mainFit1027->SetParError(1,0.03844852);
