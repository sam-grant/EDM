...
//=========  (Fri Apr 23 21:21:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-46.37681);
   Graph_Graph01029->SetMaximum(50.1217);
   ...
   mainFit1030->SetChisquare(4.503565);
   ...
   mainFit1030->SetParameter(0,-0.7897438);
   mainFit1030->SetParError(0,0.9789855);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7534135);
   mainFit1030->SetParError(1,0.02986495);
   ...
   pt_LaTex = pt->AddText("0.753#pm0.0299");
   pt_LaTex = pt->AddText("#minus0.79#pm0.979");
   pt_LaTex = pt->AddText("#minus1.05#pm  1.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.048221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.048221,-46.37681,1.048221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.503565);
   ...
   mainFit1031->SetParameter(0,-0.7897438);
   mainFit1031->SetParError(0,0.9789855);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7534135);
   mainFit1031->SetParError(1,0.02986495);
