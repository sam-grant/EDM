...
//=========  (Fri Apr 23 21:21:10 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-46.37681);
   Graph_Graph01031->SetMaximum(50.1217);
   ...
   mainFit1032->SetChisquare(6.39966);
   ...
   mainFit1032->SetParameter(0,-0.2115558);
   mainFit1032->SetParError(0,1.038117);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7557604);
   mainFit1032->SetParError(1,0.03083278);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.13");
   pt_LaTex = pt->AddText("0.756#pm0.0308");
   pt_LaTex = pt->AddText("#minus0.212#pm 1.04");
   pt_LaTex = pt->AddText("#minus0.28#pm 1.37");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.2799244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.2799244,-46.37681,0.2799244,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.39966);
   ...
   mainFit1033->SetParameter(0,-0.2115558);
   mainFit1033->SetParError(0,1.038117);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7557604);
   mainFit1033->SetParError(1,0.03083278);
