...
//=========  (Fri Apr 23 21:21:10 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-43.22168,70,59.14053);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-32.98546);
   Graph_Graph01035->SetMaximum(48.90431);
   ...
   mainFit1036->SetChisquare(5.293405);
   ...
   mainFit1036->SetParameter(0,-0.5615064);
   mainFit1036->SetParError(0,0.9447888);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7707562);
   mainFit1036->SetParError(1,0.0326899);
   ...
   pt_LaTex = pt->AddText("0.771#pm0.0327");
   pt_LaTex = pt->AddText("#minus0.562#pm0.945");
   pt_LaTex = pt->AddText("#minus0.729#pm 1.22");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.7285136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7285136,-32.98546,0.7285136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.293405);
   ...
   mainFit1037->SetParameter(0,-0.5615064);
   mainFit1037->SetParError(0,0.9447888);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7707562);
   mainFit1037->SetParError(1,0.0326899);
