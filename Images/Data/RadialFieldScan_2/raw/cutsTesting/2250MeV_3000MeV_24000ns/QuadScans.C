...
//=========  (Fri Apr 23 21:21:09 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1380279);
   ...
   quadLineFit1002->SetParameter(0,75.21647);
   quadLineFit1002->SetParError(0,0.1372);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,39.77929);
   quadLineFit1002->SetParError(1,2.300872);
   ...
   quadLineFit1003->SetChisquare(0.1380279);
   ...
   quadLineFit1003->SetParameter(0,75.21647);
   quadLineFit1003->SetParError(0,0.1372);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,39.77929);
   quadLineFit1003->SetParError(1,2.300872);
   ...
   Graph_30_ppm1003->SetMinimum(76.34118);
   Graph_30_ppm1003->SetMaximum(76.85239);
   ...
   quadLineFit1004->SetChisquare(2.782756);
   ...
   quadLineFit1004->SetParameter(0,75.38559);
   quadLineFit1004->SetParError(0,0.115456);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,19.37847);
   quadLineFit1004->SetParError(1,1.897802);
   ...
   quadLineFit1005->SetChisquare(2.782756);
   ...
   quadLineFit1005->SetParameter(0,75.38559);
   quadLineFit1005->SetParError(0,0.115456);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,19.37847);
   quadLineFit1005->SetParError(1,1.897802);
   ...
   Graph_10_ppm1005->SetMinimum(75.36603);
   Graph_10_ppm1005->SetMaximum(75.68674);
   ...
   quadLineFit1006->SetChisquare(0.01958572);
   ...
   quadLineFit1006->SetParameter(0,74.90435);
   quadLineFit1006->SetParError(0,0.1354078);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.06828);
   quadLineFit1006->SetParError(1,2.195851);
   ...
   quadLineFit1007->SetChisquare(0.01958572);
   ...
   quadLineFit1007->SetParameter(0,74.90435);
   quadLineFit1007->SetParError(0,0.1354078);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.06828);
   quadLineFit1007->SetParError(1,2.195851);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.40412);
   Graph_mI10_ppm1007->SetMaximum(74.68929);
   ...
   quadLineFit1008->SetChisquare(1.102879);
   ...
   quadLineFit1008->SetParameter(0,75.03106);
   quadLineFit1008->SetParError(0,0.1187018);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.982902);
   quadLineFit1008->SetParError(1,1.932086);
   ...
   quadLineFit1009->SetChisquare(1.102879);
   ...
   quadLineFit1009->SetParameter(0,75.03106);
   quadLineFit1009->SetParError(0,0.1187018);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.982902);
   quadLineFit1009->SetParError(1,1.932086);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.16247);
   Graph_mI30_ppm1009->SetMaximum(73.79536);
   ...
   quadLineFit1010->SetChisquare(2.033019);
   ...
   quadLineFit1010->SetParameter(0,74.95712);
   quadLineFit1010->SetParError(0,0.1125356);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-24.21371);
   quadLineFit1010->SetParError(1,1.947601);
   ...
   quadLineFit1011->SetChisquare(2.033019);
   ...
   quadLineFit1011->SetParameter(0,74.95712);
   quadLineFit1011->SetParError(0,0.1125356);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-24.21371);
   quadLineFit1011->SetParError(1,1.947601);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.32806);
   Graph_mI50_ppm1011->SetMaximum(72.86638);
   ...
   quadLineFit1012->SetChisquare(0.003622205);
   ...
   quadLineFit1012->SetParameter(0,74.55081);
   quadLineFit1012->SetParError(0,0.2271503);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-34.27103);
   quadLineFit1012->SetParError(1,4.064235);
   ...
   quadLineFit1013->SetChisquare(0.003622205);
   ...
   quadLineFit1013->SetParameter(0,74.55081);
   quadLineFit1013->SetParError(0,0.2271503);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-34.27103);
   quadLineFit1013->SetParError(1,4.064235);
