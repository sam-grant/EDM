...
//=========  (Fri Apr 23 21:21:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03181018);
   Graph_Graph11015->SetMaximum(0.04238302);
   ...
   Graph_Graph21016->SetMinimum(-0.002759142);
   Graph_Graph21016->SetMaximum(0.003242961);
   ...
   Graph_Graph31017->SetMinimum(-0.02528696);
   Graph_Graph31017->SetMaximum(0.02317824);
   ...
   Graph_Graph41018->SetMinimum(-0.05073543);
   Graph_Graph41018->SetMaximum(0.02957904);
   ...
   Graph_Graph51019->SetMinimum(-0.001108921);
   Graph_Graph51019->SetMaximum(0.00148347);
