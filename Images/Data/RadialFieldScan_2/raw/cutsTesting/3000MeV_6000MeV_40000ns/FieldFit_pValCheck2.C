...
//=========  (Thu Apr 22 10:24:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-65.4855);
   Graph_Graph01029->SetMaximum(60.69628);
   ...
   mainFit1030->SetChisquare(3.170723);
   ...
   mainFit1030->SetParameter(0,2.117882);
   mainFit1030->SetParError(0,2.006383);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9178862);
   mainFit1030->SetParError(1,0.06125217);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0613");
   pt_LaTex = pt->AddText(" 2.12#pm 2.01");
   pt_LaTex = pt->AddText(" 2.31#pm 2.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.307347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.307347,-65.4855,-2.307347,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.170723);
   ...
   mainFit1031->SetParameter(0,2.117882);
   mainFit1031->SetParError(0,2.006383);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9178862);
   mainFit1031->SetParError(1,0.06125217);
