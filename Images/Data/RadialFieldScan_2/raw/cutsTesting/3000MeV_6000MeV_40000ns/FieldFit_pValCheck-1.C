...
//=========  (Thu Apr 22 10:24:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-65.4855);
   Graph_Graph01023->SetMaximum(60.69628);
   ...
   mainFit1024->SetChisquare(3.264794);
   ...
   mainFit1024->SetParameter(0,1.87671);
   mainFit1024->SetParError(0,1.846088);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9164688);
   mainFit1024->SetParError(1,0.06107215);
   ...
   pt_LaTex = pt->AddText("0.916#pm0.0611");
   pt_LaTex = pt->AddText(" 1.88#pm 1.85");
   pt_LaTex = pt->AddText(" 2.05#pm 2.04");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.047762,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.047762,-65.4855,-2.047762,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.264794);
   ...
   mainFit1025->SetParameter(0,1.87671);
   mainFit1025->SetParError(0,1.846088);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9164688);
   mainFit1025->SetParError(1,0.06107215);
