...
//=========  (Thu Apr 22 10:24:43 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-53.65929,70,70.94921);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-41.19844);
   Graph_Graph01035->SetMaximum(58.48836);
   ...
   mainFit1036->SetChisquare(3.12888);
   ...
   mainFit1036->SetParameter(0,2.09206);
   mainFit1036->SetParError(0,1.936299);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9062483);
   mainFit1036->SetParError(1,0.06706986);
   ...
   pt_LaTex = pt->AddText("0.906#pm0.0671");
   pt_LaTex = pt->AddText(" 2.09#pm 1.94");
   pt_LaTex = pt->AddText(" 2.31#pm 2.19");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-2.308484,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.308484,-41.19844,-2.308484,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.12888);
   ...
   mainFit1037->SetParameter(0,2.09206);
   mainFit1037->SetParError(0,1.936299);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9062483);
   mainFit1037->SetParError(1,0.06706986);
