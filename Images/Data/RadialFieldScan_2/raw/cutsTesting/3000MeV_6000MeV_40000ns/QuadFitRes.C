...
//=========  (Thu Apr 22 10:24:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.09336919);
   Graph_Graph11015->SetMaximum(0.03660527);
   ...
   Graph_Graph21016->SetMinimum(-0.04494982);
   Graph_Graph21016->SetMaximum(0.05284766);
   ...
   Graph_Graph31017->SetMinimum(-0.1018565);
   Graph_Graph31017->SetMaximum(0.09516773);
   ...
   Graph_Graph41018->SetMinimum(-0.05966557);
   Graph_Graph41018->SetMaximum(0.03406244);
   ...
   Graph_Graph51019->SetMinimum(-0.01833417);
   Graph_Graph51019->SetMaximum(0.01374194);
