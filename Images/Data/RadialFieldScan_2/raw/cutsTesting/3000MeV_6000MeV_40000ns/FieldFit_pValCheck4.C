...
//=========  (Thu Apr 22 10:24:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-65.4855);
   Graph_Graph01033->SetMaximum(60.69628);
   ...
   mainFit1034->SetChisquare(1.920904);
   ...
   mainFit1034->SetParameter(0,3.490799);
   mainFit1034->SetParError(0,2.312284);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8633637);
   mainFit1034->SetParError(1,0.07634337);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0763");
   pt_LaTex = pt->AddText(" 3.49#pm 2.31");
   pt_LaTex = pt->AddText(" 4.04#pm 2.86");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-4.043254,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-4.043254,-65.4855,-4.043254,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.920904);
   ...
   mainFit1035->SetParameter(0,3.490799);
   mainFit1035->SetParError(0,2.312284);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8633637);
   mainFit1035->SetParError(1,0.07634337);
