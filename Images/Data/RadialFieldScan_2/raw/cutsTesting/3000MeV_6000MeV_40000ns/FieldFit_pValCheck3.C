...
//=========  (Thu Apr 22 10:24:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-65.4855);
   Graph_Graph01031->SetMaximum(60.69628);
   ...
   mainFit1032->SetChisquare(0.3452174);
   ...
   mainFit1032->SetParameter(0,0.07314527);
   mainFit1032->SetParError(0,2.126545);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9442747);
   mainFit1032->SetParError(1,0.06320307);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.115");
   pt_LaTex = pt->AddText("0.944#pm0.0632");
   pt_LaTex = pt->AddText("0.0731#pm 2.13");
   pt_LaTex = pt->AddText("0.0775#pm 2.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.07746186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.07746186,-65.4855,-0.07746186,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.3452174);
   ...
   mainFit1033->SetParameter(0,0.07314527);
   mainFit1033->SetParError(0,2.126545);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9442747);
   mainFit1033->SetParError(1,0.06320307);
