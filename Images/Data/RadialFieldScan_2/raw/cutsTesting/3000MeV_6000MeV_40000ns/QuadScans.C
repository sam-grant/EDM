...
//=========  (Thu Apr 22 10:24:42 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.576296);
   ...
   quadLineFit1002->SetParameter(0,74.84076);
   quadLineFit1002->SetParError(0,0.2823579);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.44458);
   quadLineFit1002->SetParError(1,4.736552);
   ...
   quadLineFit1003->SetChisquare(5.576296);
   ...
   quadLineFit1003->SetParameter(0,74.84076);
   quadLineFit1003->SetParError(0,0.2823579);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.44458);
   quadLineFit1003->SetParError(1,4.736552);
   ...
   Graph_30_ppm1003->SetMinimum(76.10686);
   Graph_30_ppm1003->SetMaximum(77.00472);
   ...
   quadLineFit1004->SetChisquare(1.371228);
   ...
   quadLineFit1004->SetParameter(0,74.71627);
   quadLineFit1004->SetParError(0,0.2363997);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,29.95984);
   quadLineFit1004->SetParError(1,3.888803);
   ...
   quadLineFit1005->SetChisquare(1.371228);
   ...
   quadLineFit1005->SetParameter(0,74.71627);
   quadLineFit1005->SetParError(0,0.2363997);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,29.95984);
   quadLineFit1005->SetParError(1,3.888803);
   ...
   Graph_10_ppm1005->SetMinimum(75.27055);
   Graph_10_ppm1005->SetMaximum(75.68422);
   ...
   quadLineFit1006->SetChisquare(1.226145);
   ...
   quadLineFit1006->SetParameter(0,74.83691);
   quadLineFit1006->SetParError(0,0.2776443);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,9.781583);
   quadLineFit1006->SetParError(1,4.504691);
   ...
   quadLineFit1007->SetChisquare(1.226145);
   ...
   quadLineFit1007->SetParameter(0,74.83691);
   quadLineFit1007->SetParError(0,0.2776443);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,9.781583);
   quadLineFit1007->SetParError(1,4.504691);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.2105);
   Graph_mI10_ppm1007->SetMaximum(74.56655);
   ...
   quadLineFit1008->SetChisquare(3.540629);
   ...
   quadLineFit1008->SetParameter(0,74.46708);
   quadLineFit1008->SetParError(0,0.2432425);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-1.479351);
   quadLineFit1008->SetParError(1,3.96207);
   ...
   quadLineFit1009->SetChisquare(3.540629);
   ...
   quadLineFit1009->SetParameter(0,74.46708);
   quadLineFit1009->SetParError(0,0.2432425);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-1.479351);
   quadLineFit1009->SetParError(1,3.96207);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.7724);
   Graph_mI30_ppm1009->SetMaximum(73.62167);
   ...
   quadLineFit1010->SetChisquare(1.320716);
   ...
   quadLineFit1010->SetParameter(0,74.9628);
   quadLineFit1010->SetParError(0,0.2302054);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.90506);
   quadLineFit1010->SetParError(1,3.986144);
   ...
   quadLineFit1011->SetChisquare(1.320716);
   ...
   quadLineFit1011->SetParameter(0,74.9628);
   quadLineFit1011->SetParError(0,0.2302054);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.90506);
   quadLineFit1011->SetParError(1,3.986144);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.87341);
   Graph_mI50_ppm1011->SetMaximum(72.66044);
   ...
   quadLineFit1012->SetChisquare(0.1329013);
   ...
   quadLineFit1012->SetParameter(0,74.91746);
   quadLineFit1012->SetParError(0,0.4641487);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.66639);
   quadLineFit1012->SetParError(1,8.303958);
   ...
   quadLineFit1013->SetChisquare(0.1329013);
   ...
   quadLineFit1013->SetParameter(0,74.91746);
   quadLineFit1013->SetParError(0,0.4641487);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.66639);
   quadLineFit1013->SetParError(1,8.303958);
