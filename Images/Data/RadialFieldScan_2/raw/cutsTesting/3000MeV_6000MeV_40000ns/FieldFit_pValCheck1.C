...
//=========  (Thu Apr 22 10:24:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-65.4855);
   Graph_Graph01027->SetMaximum(60.69628);
   ...
   mainFit1028->SetChisquare(3.228032);
   ...
   mainFit1028->SetParameter(0,1.69777);
   mainFit1028->SetParError(0,2.068587);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9106107);
   mainFit1028->SetParError(1,0.0682886);
   ...
   pt_LaTex = pt->AddText("0.911#pm0.0683");
   pt_LaTex = pt->AddText("  1.7#pm 2.07");
   pt_LaTex = pt->AddText(" 1.86#pm 2.27");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.86443,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.86443,-65.4855,-1.86443,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(3.228032);
   ...
   mainFit1029->SetParameter(0,1.69777);
   mainFit1029->SetParError(0,2.068587);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9106107);
   mainFit1029->SetParError(1,0.0682886);
