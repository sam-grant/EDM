...
//=========  (Thu Apr 22 10:24:42 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-65.4855);
   Graph_Graph01020->SetMaximum(60.69628);
   ...
   mainFit1021->SetChisquare(3.264794);
   ...
   mainFit1021->SetParameter(0,1.87671);
   mainFit1021->SetParError(0,1.846088);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9164688);
   mainFit1021->SetParError(1,0.06107215);
   ...
   mainFit1022->SetChisquare(3.264794);
   ...
   mainFit1022->SetParameter(0,1.87671);
   mainFit1022->SetParError(0,1.846088);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9164688);
   mainFit1022->SetParError(1,0.06107215);
