...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-56.9093);
   Graph_Graph01033->SetMaximum(55.97909);
   ...
   mainFit1034->SetChisquare(5.014855);
   ...
   mainFit1034->SetParameter(0,-0.8615955);
   mainFit1034->SetParError(0,0.5244585);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9049743);
   mainFit1034->SetParError(1,0.01730031);
   ...
   pt_LaTex = pt->AddText("0.905#pm0.0173");
   pt_LaTex = pt->AddText("#minus0.862#pm0.524");
   pt_LaTex = pt->AddText("#minus0.952#pm0.571");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9520662,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9520662,-56.9093,0.9520662,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.014855);
   ...
   mainFit1035->SetParameter(0,-0.8615955);
   mainFit1035->SetParError(0,0.5244585);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9049743);
   mainFit1035->SetParError(1,0.01730031);
