...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.20647,70,65.32736);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.95309);
   Graph_Graph01035->SetMaximum(54.07397);
   ...
   mainFit1036->SetChisquare(5.135277);
   ...
   mainFit1036->SetParameter(0,-0.7611799);
   mainFit1036->SetParError(0,0.438915);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9018909);
   mainFit1036->SetParError(1,0.01518758);
   ...
   pt_LaTex = pt->AddText("0.902#pm0.0152");
   pt_LaTex = pt->AddText("#minus0.761#pm0.439");
   pt_LaTex = pt->AddText("#minus0.844#pm0.483");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.8439823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8439823,-35.95309,0.8439823,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.135277);
   ...
   mainFit1037->SetParameter(0,-0.7611799);
   mainFit1037->SetParError(0,0.438915);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9018909);
   mainFit1037->SetParError(1,0.01518758);
