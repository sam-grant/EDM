...
//=========  (Wed Apr 28 16:47:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.004095392);
   Graph_Graph11015->SetMaximum(0.0060384);
   ...
   Graph_Graph21016->SetMinimum(-0.01398078);
   Graph_Graph21016->SetMaximum(0.01646381);
   ...
   Graph_Graph31017->SetMinimum(-0.03376685);
   Graph_Graph31017->SetMaximum(0.03147336);
   ...
   Graph_Graph41018->SetMinimum(-0.01294834);
   Graph_Graph41018->SetMaximum(0.02158147);
   ...
   Graph_Graph51019->SetMinimum(-0.007504263);
   Graph_Graph51019->SetMaximum(0.01003608);
