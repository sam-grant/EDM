...
//=========  (Wed Apr 28 16:47:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.9093);
   Graph_Graph01020->SetMaximum(55.97909);
   ...
   mainFit1021->SetChisquare(5.148023);
   ...
   mainFit1021->SetParameter(0,-0.7462332);
   mainFit1021->SetParError(0,0.4184723);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9011833);
   mainFit1021->SetParError(1,0.01383404);
   ...
   pt_LaTex = pt->AddText("0.901#pm0.0138");
   pt_LaTex = pt->AddText("#minus0.746#pm0.418");
   pt_LaTex = pt->AddText("#minus0.828#pm0.462");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.8280593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.8280593,-56.9093,0.8280593,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(5.148023);
   ...
   mainFit1022->SetParameter(0,-0.7462332);
   mainFit1022->SetParError(0,0.4184723);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9011833);
   mainFit1022->SetParError(1,0.01383404);
