...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.9093);
   Graph_Graph01023->SetMaximum(55.97909);
   ...
   mainFit1024->SetChisquare(5.148023);
   ...
   mainFit1024->SetParameter(0,-0.7462332);
   mainFit1024->SetParError(0,0.4184723);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9011833);
   mainFit1024->SetParError(1,0.01383404);
   ...
   mainFit1025->SetChisquare(5.148023);
   ...
   mainFit1025->SetParameter(0,-0.7462332);
   mainFit1025->SetParError(0,0.4184723);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9011833);
   mainFit1025->SetParError(1,0.01383404);
