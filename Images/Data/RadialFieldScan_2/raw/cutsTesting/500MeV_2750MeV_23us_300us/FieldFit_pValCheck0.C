...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.81094,50,44.04308);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.82554);
   Graph_Graph01025->SetMaximum(33.05768);
   ...
   mainFit1026->SetChisquare(2.729508);
   ...
   mainFit1026->SetParameter(0,-1.007317);
   mainFit1026->SetParError(0,0.4508921);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8836212);
   mainFit1026->SetParError(1,0.01785801);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.91");
   pt_LaTex = pt->AddText("0.884#pm0.0179");
   pt_LaTex = pt->AddText("#minus1.01#pm0.451");
   pt_LaTex = pt->AddText("#minus1.14#pm0.514");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.139988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.139988,-54.82554,1.139988,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.729508);
   ...
   mainFit1027->SetParameter(0,-1.007317);
   mainFit1027->SetParError(0,0.4508921);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8836212);
   mainFit1027->SetParError(1,0.01785801);
