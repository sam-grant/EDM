...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.9093);
   Graph_Graph01027->SetMaximum(55.97909);
   ...
   mainFit1028->SetChisquare(0.9080908);
   ...
   mainFit1028->SetParameter(0,-0.3125211);
   mainFit1028->SetParError(0,0.4684917);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9153575);
   mainFit1028->SetParError(1,0.01545206);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.303");
   pt_LaTex = pt->AddText("0.915#pm0.0155");
   pt_LaTex = pt->AddText("#minus0.313#pm0.468");
   pt_LaTex = pt->AddText("#minus0.341#pm0.512");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3414198,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3414198,-56.9093,0.3414198,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.9080908);
   ...
   mainFit1029->SetParameter(0,-0.3125211);
   mainFit1029->SetParError(0,0.4684917);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9153575);
   mainFit1029->SetParError(1,0.01545206);
