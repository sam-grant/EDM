...
//=========  (Wed Apr 28 16:47:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.9093);
   Graph_Graph01031->SetMaximum(55.97909);
   ...
   mainFit1032->SetChisquare(4.870795);
   ...
   mainFit1032->SetParameter(0,-0.6203208);
   mainFit1032->SetParError(0,0.4819817);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8992386);
   mainFit1032->SetParError(1,0.0143186);
   ...
   pt_LaTex = pt->AddText("0.899#pm0.0143");
   pt_LaTex = pt->AddText("#minus0.62#pm0.482");
   pt_LaTex = pt->AddText("#minus0.69#pm0.533");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6898289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6898289,-56.9093,0.6898289,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.870795);
   ...
   mainFit1033->SetParameter(0,-0.6203208);
   mainFit1033->SetParError(0,0.4819817);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8992386);
   mainFit1033->SetParError(1,0.0143186);
