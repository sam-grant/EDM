...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.554676);
   ...
   quadLineFit1002->SetParameter(0,74.70755);
   quadLineFit1002->SetParError(0,0.0820674);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.8942);
   quadLineFit1002->SetParError(1,1.376519);
   ...
   quadLineFit1003->SetChisquare(3.554676);
   ...
   quadLineFit1003->SetParameter(0,74.70755);
   quadLineFit1003->SetParError(0,0.0820674);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.8942);
   quadLineFit1003->SetParError(1,1.376519);
   ...
   Graph_30_ppm1003->SetMinimum(75.82061);
   Graph_30_ppm1003->SetMaximum(76.39005);
   ...
   quadLineFit1004->SetChisquare(6.168379);
   ...
   quadLineFit1004->SetParameter(0,74.71108);
   quadLineFit1004->SetParError(0,0.06904592);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.71725);
   quadLineFit1004->SetParError(1,1.134863);
   ...
   quadLineFit1005->SetChisquare(6.168379);
   ...
   quadLineFit1005->SetParameter(0,74.71108);
   quadLineFit1005->SetParError(0,0.06904592);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.71725);
   quadLineFit1005->SetParError(1,1.134863);
   ...
   Graph_10_ppm1005->SetMinimum(74.8933);
   Graph_10_ppm1005->SetMaximum(75.1528);
   ...
   quadLineFit1006->SetChisquare(0.002643935);
   ...
   quadLineFit1006->SetParameter(0,74.47873);
   quadLineFit1006->SetParError(0,0.08090472);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.843287);
   quadLineFit1006->SetParError(1,1.312118);
   ...
   quadLineFit1007->SetChisquare(0.002643935);
   ...
   quadLineFit1007->SetParameter(0,74.47873);
   quadLineFit1007->SetParError(0,0.08090472);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.843287);
   quadLineFit1007->SetParError(1,1.312118);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.81268);
   Graph_mI10_ppm1007->SetMaximum(74.08426);
   ...
   quadLineFit1008->SetChisquare(6.805924);
   ...
   quadLineFit1008->SetParameter(0,74.42493);
   quadLineFit1008->SetParError(0,0.07102522);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.040379);
   quadLineFit1008->SetParError(1,1.156048);
   ...
   quadLineFit1009->SetChisquare(6.805924);
   ...
   quadLineFit1009->SetParameter(0,74.42493);
   quadLineFit1009->SetParError(0,0.07102522);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.040379);
   quadLineFit1009->SetParError(1,1.156048);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.54132);
   Graph_mI30_ppm1009->SetMaximum(73.16305);
   ...
   quadLineFit1010->SetChisquare(0.2946226);
   ...
   quadLineFit1010->SetParameter(0,74.32913);
   quadLineFit1010->SetParError(0,0.06717874);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.93681);
   quadLineFit1010->SetParError(1,1.162644);
   ...
   quadLineFit1011->SetChisquare(0.2946226);
   ...
   quadLineFit1011->SetParameter(0,74.32913);
   quadLineFit1011->SetParError(0,0.06717874);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.93681);
   quadLineFit1011->SetParError(1,1.162644);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.65134);
   Graph_mI50_ppm1011->SetMaximum(72.24936);
   ...
   quadLineFit1012->SetChisquare(1.7371);
   ...
   quadLineFit1012->SetParameter(0,74.30215);
   quadLineFit1012->SetParError(0,0.1354527);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-41.11223);
   quadLineFit1012->SetParError(1,2.423533);
   ...
   quadLineFit1013->SetChisquare(1.7371);
   ...
   quadLineFit1013->SetParameter(0,74.30215);
   quadLineFit1013->SetParError(0,0.1354527);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-41.11223);
   quadLineFit1013->SetParError(1,2.423533);
