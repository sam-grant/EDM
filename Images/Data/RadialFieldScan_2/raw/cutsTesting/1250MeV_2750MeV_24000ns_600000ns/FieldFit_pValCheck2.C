...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-52.11641);
   Graph_Graph01029->SetMaximum(50.85137);
   ...
   mainFit1030->SetChisquare(1.743151);
   ...
   mainFit1030->SetParameter(0,-0.2411459);
   mainFit1030->SetParError(0,0.5851026);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8015221);
   mainFit1030->SetParError(1,0.01784607);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.581");
   pt_LaTex = pt->AddText("0.802#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.241#pm0.585");
   pt_LaTex = pt->AddText("#minus0.301#pm0.729");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3008599,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3008599,-52.11641,0.3008599,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.743151);
   ...
   mainFit1031->SetParameter(0,-0.2411459);
   mainFit1031->SetParError(0,0.5851026);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8015221);
   mainFit1031->SetParError(1,0.01784607);
