...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-52.11641);
   Graph_Graph01027->SetMaximum(50.85137);
   ...
   mainFit1028->SetChisquare(0.2370549);
   ...
   mainFit1028->SetParameter(0,0.3181303);
   mainFit1028->SetParError(0,0.6027187);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8152407);
   mainFit1028->SetParError(1,0.01987802);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.079");
   pt_LaTex = pt->AddText("0.815#pm0.0199");
   pt_LaTex = pt->AddText("0.318#pm0.603");
   pt_LaTex = pt->AddText(" 0.39#pm0.739");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3902287,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3902287,-52.11641,-0.3902287,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2370549);
   ...
   mainFit1029->SetParameter(0,0.3181303);
   mainFit1029->SetParError(0,0.6027187);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8152407);
   mainFit1029->SetParError(1,0.01987802);
