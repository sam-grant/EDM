...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-52.11641);
   Graph_Graph01020->SetMaximum(50.85137);
   ...
   mainFit1021->SetChisquare(2.295108);
   ...
   mainFit1021->SetParameter(0,-0.07080395);
   mainFit1021->SetParError(0,0.5383014);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8025312);
   mainFit1021->SetParError(1,0.01779459);
   ...
   pt_LaTex = pt->AddText("0.803#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.0708#pm0.538");
   pt_LaTex = pt->AddText("#minus0.0882#pm 0.67");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.0882258,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.0882258,-52.11641,0.0882258,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.295108);
   ...
   mainFit1022->SetParameter(0,-0.07080395);
   mainFit1022->SetParError(0,0.5383014);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8025312);
   mainFit1022->SetParError(1,0.01779459);
