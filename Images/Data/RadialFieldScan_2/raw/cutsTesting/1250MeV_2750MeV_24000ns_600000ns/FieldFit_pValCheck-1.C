...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-52.11641);
   Graph_Graph01023->SetMaximum(50.85137);
   ...
   mainFit1024->SetChisquare(2.295108);
   ...
   mainFit1024->SetParameter(0,-0.07080395);
   mainFit1024->SetParError(0,0.5383014);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8025312);
   mainFit1024->SetParError(1,0.01779459);
   ...
   mainFit1025->SetChisquare(2.295108);
   ...
   mainFit1025->SetParameter(0,-0.07080395);
   mainFit1025->SetParError(0,0.5383014);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8025312);
   mainFit1025->SetParError(1,0.01779459);
