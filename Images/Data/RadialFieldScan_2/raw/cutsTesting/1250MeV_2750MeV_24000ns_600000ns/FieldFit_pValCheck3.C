...
//=========  (Tue Apr 27 00:31:13 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-64.98739,75,63.72234);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-52.11641);
   Graph_Graph01031->SetMaximum(50.85137);
   ...
   mainFit1032->SetChisquare(2.291951);
   ...
   mainFit1032->SetParameter(0,-0.08809126);
   mainFit1032->SetParError(0,0.6200317);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8027981);
   mainFit1032->SetParError(1,0.01841778);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.764");
   pt_LaTex = pt->AddText("0.803#pm0.0184");
   pt_LaTex = pt->AddText("#minus0.0881#pm 0.62");
   pt_LaTex = pt->AddText("#minus0.11#pm0.772");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.1097303,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1097303,-52.11641,0.1097303,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.291951);
   ...
   mainFit1033->SetParameter(0,-0.08809126);
   mainFit1033->SetParError(0,0.6200317);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8027981);
   mainFit1033->SetParError(1,0.01841778);
