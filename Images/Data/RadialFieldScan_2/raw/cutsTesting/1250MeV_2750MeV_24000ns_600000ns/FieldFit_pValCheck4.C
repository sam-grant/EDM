...
//=========  (Tue Apr 27 00:31:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-52.11641);
   Graph_Graph01033->SetMaximum(50.85137);
   ...
   mainFit1034->SetChisquare(2.230701);
   ...
   mainFit1034->SetParameter(0,-0.1739377);
   mainFit1034->SetParError(0,0.6744738);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.80592);
   mainFit1034->SetParError(1,0.02224761);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.744");
   pt_LaTex = pt->AddText("0.806#pm0.0222");
   pt_LaTex = pt->AddText("#minus0.174#pm0.674");
   pt_LaTex = pt->AddText("#minus0.216#pm0.834");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.215825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.215825,-52.11641,0.215825,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.230701);
   ...
   mainFit1035->SetParameter(0,-0.1739377);
   mainFit1035->SetParError(0,0.6744738);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.80592);
   mainFit1035->SetParError(1,0.02224761);
