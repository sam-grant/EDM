...
//=========  (Tue Apr 27 00:31:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02768302);
   Graph_Graph11015->SetMaximum(0.05280378);
   ...
   Graph_Graph21016->SetMinimum(-0.0006053161);
   Graph_Graph21016->SetMaximum(0.0007128503);
   ...
   Graph_Graph31017->SetMinimum(-0.04169935);
   Graph_Graph31017->SetMaximum(0.03586817);
   ...
   Graph_Graph41018->SetMinimum(-0.006378337);
   Graph_Graph41018->SetMaximum(0.007830084);
   ...
   Graph_Graph51019->SetMinimum(-0.01450237);
   Graph_Graph51019->SetMaximum(0.01936877);
