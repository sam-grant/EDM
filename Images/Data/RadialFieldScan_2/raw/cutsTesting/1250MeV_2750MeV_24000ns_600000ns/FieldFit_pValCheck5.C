...
//=========  (Tue Apr 27 00:31:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01035->SetMinimum(-31.83647);
   Graph_Graph01035->SetMaximum(49.00774);
   ...
   mainFit1036->SetChisquare(2.114626);
   ...
   mainFit1036->SetParameter(0,0.001610606);
   mainFit1036->SetParError(0,0.5646444);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7991028);
   mainFit1036->SetParError(1,0.01953896);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.705");
   pt_LaTex = pt->AddText("0.799#pm0.0195");
   pt_LaTex = pt->AddText("0.00161#pm0.565");
   pt_LaTex = pt->AddText("0.00202#pm0.707");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-0.002015517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.002015517,-31.83647,-0.002015517,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.114626);
   ...
   mainFit1037->SetParameter(0,0.001610606);
   mainFit1037->SetParError(0,0.5646444);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7991028);
   mainFit1037->SetParError(1,0.01953896);
