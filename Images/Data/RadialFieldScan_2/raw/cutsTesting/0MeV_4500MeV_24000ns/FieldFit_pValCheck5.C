...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.76929,70,65.01605);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.39075);
   Graph_Graph01035->SetMaximum(53.63752);
   ...
   mainFit1036->SetChisquare(3.934498);
   ...
   mainFit1036->SetParameter(0,-1.810885);
   mainFit1036->SetParError(0,0.3958121);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9182217);
   mainFit1036->SetParError(1,0.013528);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0135");
   pt_LaTex = pt->AddText("#minus1.81#pm0.396");
   pt_LaTex = pt->AddText("#minus1.97#pm0.424");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.972165,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.972165,-37.39075,1.972165,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.934498);
   ...
   mainFit1037->SetParameter(0,-1.810885);
   mainFit1037->SetParError(0,0.3958121);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9182217);
   mainFit1037->SetParError(1,0.013528);
