...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.084627);
   ...
   quadLineFit1002->SetParameter(0,74.48885);
   quadLineFit1002->SetParError(0,0.05548708);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.12169);
   quadLineFit1002->SetParError(1,0.9301385);
   ...
   quadLineFit1003->SetChisquare(1.084627);
   ...
   quadLineFit1003->SetParameter(0,74.48885);
   quadLineFit1003->SetParError(0,0.05548708);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.12169);
   quadLineFit1003->SetParError(1,0.9301385);
   ...
   Graph_30_ppm1003->SetMinimum(75.74944);
   Graph_30_ppm1003->SetMaximum(76.37118);
   ...
   quadLineFit1004->SetChisquare(0.315574);
   ...
   quadLineFit1004->SetParameter(0,74.55233);
   quadLineFit1004->SetParError(0,0.04853488);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.59704);
   quadLineFit1004->SetParError(1,0.7975926);
   ...
   quadLineFit1005->SetChisquare(0.315574);
   ...
   quadLineFit1005->SetParameter(0,74.55233);
   quadLineFit1005->SetParError(0,0.04853488);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.59704);
   quadLineFit1005->SetParError(1,0.7975926);
   ...
   Graph_10_ppm1005->SetMinimum(74.76422);
   Graph_10_ppm1005->SetMaximum(74.99037);
   ...
   quadLineFit1006->SetChisquare(1.032436);
   ...
   quadLineFit1006->SetParameter(0,74.3866);
   quadLineFit1006->SetParError(0,0.05684013);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.873676);
   quadLineFit1006->SetParError(1,0.9217163);
   ...
   quadLineFit1007->SetChisquare(1.032436);
   ...
   quadLineFit1007->SetParameter(0,74.3866);
   quadLineFit1007->SetParError(0,0.05684013);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.873676);
   quadLineFit1007->SetParError(1,0.9217163);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.51927);
   Graph_mI10_ppm1007->SetMaximum(73.84256);
   ...
   quadLineFit1008->SetChisquare(4.831725);
   ...
   quadLineFit1008->SetParameter(0,74.37142);
   quadLineFit1008->SetParError(0,0.04992494);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.34654);
   quadLineFit1008->SetParError(1,0.8125342);
   ...
   quadLineFit1009->SetChisquare(4.831725);
   ...
   quadLineFit1009->SetParameter(0,74.37142);
   quadLineFit1009->SetParError(0,0.04992494);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.34654);
   quadLineFit1009->SetParError(1,0.8125342);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.14351);
   Graph_mI30_ppm1009->SetMaximum(72.87075);
   ...
   quadLineFit1010->SetChisquare(0.3178719);
   ...
   quadLineFit1010->SetParameter(0,74.28997);
   quadLineFit1010->SetParError(0,0.04714448);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.98918);
   quadLineFit1010->SetParError(1,0.8158794);
   ...
   quadLineFit1011->SetChisquare(0.3178719);
   ...
   quadLineFit1011->SetParameter(0,74.28997);
   quadLineFit1011->SetParError(0,0.04714448);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.98918);
   quadLineFit1011->SetParError(1,0.8158794);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.21629);
   Graph_mI50_ppm1011->SetMaximum(71.89737);
   ...
   quadLineFit1012->SetChisquare(0.1089498);
   ...
   quadLineFit1012->SetParameter(0,74.30291);
   quadLineFit1012->SetParError(0,0.09522983);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.21265);
   quadLineFit1012->SetParError(1,1.703931);
   ...
   quadLineFit1013->SetChisquare(0.1089498);
   ...
   quadLineFit1013->SetParameter(0,74.30291);
   quadLineFit1013->SetParError(0,0.09522983);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.21265);
   quadLineFit1013->SetParError(1,1.703931);
