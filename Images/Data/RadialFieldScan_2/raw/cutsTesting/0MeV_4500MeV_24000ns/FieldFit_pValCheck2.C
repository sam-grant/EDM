...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.51343);
   Graph_Graph01029->SetMaximum(55.64867);
   ...
   mainFit1030->SetChisquare(3.620007);
   ...
   mainFit1030->SetParameter(0,-1.939867);
   mainFit1030->SetParError(0,0.4090795);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.919133);
   mainFit1030->SetParError(1,0.0123611);
   ...
   pt_LaTex = pt->AddText("0.919#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.94#pm0.409");
   pt_LaTex = pt->AddText("#minus2.11#pm0.442");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.11054,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.11054,-59.51343,2.11054,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.620007);
   ...
   mainFit1031->SetParameter(0,-1.939867);
   mainFit1031->SetParError(0,0.4090795);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.919133);
   mainFit1031->SetParError(1,0.0123611);
