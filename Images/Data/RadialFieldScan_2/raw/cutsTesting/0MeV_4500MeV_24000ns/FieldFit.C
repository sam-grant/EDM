...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.51343);
   Graph_Graph01020->SetMaximum(55.64867);
   ...
   mainFit1021->SetChisquare(4.000157);
   ...
   mainFit1021->SetParameter(0,-1.841845);
   mainFit1021->SetParError(0,0.3769205);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.919646);
   mainFit1021->SetParError(1,0.01233324);
   ...
   pt_LaTex = pt->AddText("#minus1.84#pm0.377");
   pt_LaTex = pt->AddText("   #minus2#pm0.406");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.002776,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.002776,-59.51343,2.002776,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.000157);
   ...
   mainFit1022->SetParameter(0,-1.841845);
   mainFit1022->SetParError(0,0.3769205);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.919646);
   mainFit1022->SetParError(1,0.01233324);
