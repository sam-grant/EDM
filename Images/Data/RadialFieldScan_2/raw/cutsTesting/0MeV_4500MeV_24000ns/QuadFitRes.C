...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.003831351);
   Graph_Graph11015->SetMaximum(0.009032753);
   ...
   Graph_Graph21016->SetMinimum(-0.008409188);
   Graph_Graph21016->SetMaximum(0.009880648);
   ...
   Graph_Graph31017->SetMinimum(-0.02325414);
   Graph_Graph31017->SetMaximum(0.01762333);
   ...
   Graph_Graph41018->SetMinimum(-0.003560073);
   Graph_Graph41018->SetMaximum(0.00607355);
   ...
   Graph_Graph51019->SetMinimum(-0.002549315);
   Graph_Graph51019->SetMaximum(0.003406052);
