...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-73.90869,75,70.04393);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-59.51343);
   Graph_Graph01027->SetMaximum(55.64867);
   ...
   mainFit1028->SetChisquare(0.7442164);
   ...
   mainFit1028->SetParameter(0,-1.509607);
   mainFit1028->SetParError(0,0.4194887);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9302327);
   mainFit1028->SetParError(1,0.01365763);
   ...
   pt_LaTex = pt->AddText(" 0.93#pm0.0137");
   pt_LaTex = pt->AddText("#minus1.51#pm0.419");
   pt_LaTex = pt->AddText("#minus1.62#pm0.453");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.622827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.622827,-59.51343,1.622827,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.7442164);
   ...
   mainFit1029->SetParameter(0,-1.509607);
   mainFit1029->SetParError(0,0.4194887);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9302327);
   mainFit1029->SetParError(1,0.01365763);
