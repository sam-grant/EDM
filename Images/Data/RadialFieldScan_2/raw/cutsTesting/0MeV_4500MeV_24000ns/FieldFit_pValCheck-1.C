...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.51343);
   Graph_Graph01023->SetMaximum(55.64867);
   ...
   mainFit1024->SetChisquare(4.000157);
   ...
   mainFit1024->SetParameter(0,-1.841845);
   mainFit1024->SetParError(0,0.3769205);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.919646);
   mainFit1024->SetParError(1,0.01233324);
   ...
   mainFit1025->SetChisquare(4.000157);
   ...
   mainFit1025->SetParameter(0,-1.841845);
   mainFit1025->SetParError(0,0.3769205);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.919646);
   mainFit1025->SetParError(1,0.01233324);
