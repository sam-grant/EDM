...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.51343);
   Graph_Graph01033->SetMaximum(55.64867);
   ...
   mainFit1034->SetChisquare(3.420931);
   ...
   mainFit1034->SetParameter(0,-2.060332);
   mainFit1034->SetParError(0,0.4737972);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.926703);
   mainFit1034->SetParError(1,0.01543008);
   ...
   pt_LaTex = pt->AddText("0.927#pm0.0154");
   pt_LaTex = pt->AddText("#minus2.06#pm0.474");
   pt_LaTex = pt->AddText("#minus2.22#pm0.495");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.223293,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.223293,-59.51343,2.223293,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.420931);
   ...
   mainFit1035->SetParameter(0,-2.060332);
   mainFit1035->SetParError(0,0.4737972);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.926703);
   mainFit1035->SetParError(1,0.01543008);
