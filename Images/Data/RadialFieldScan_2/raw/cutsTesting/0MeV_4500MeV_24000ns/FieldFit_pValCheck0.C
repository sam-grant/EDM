...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.74439,50,44.22244);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.44771);
   Graph_Graph01025->SetMaximum(32.92575);
   ...
   mainFit1026->SetChisquare(1.735004);
   ...
   mainFit1026->SetParameter(0,-2.074883);
   mainFit1026->SetParError(0,0.407485);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9039876);
   mainFit1026->SetParError(1,0.01613537);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.578");
   pt_LaTex = pt->AddText("0.904#pm0.0161");
   pt_LaTex = pt->AddText("#minus2.07#pm0.407");
   pt_LaTex = pt->AddText(" #minus2.3#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.295256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.295256,-57.44771,2.295256,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.735004);
   ...
   mainFit1027->SetParameter(0,-2.074883);
   mainFit1027->SetParError(0,0.407485);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9039876);
   mainFit1027->SetParError(1,0.01613537);
