...
//=========  (Fri Apr 23 12:02:33 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.51343);
   Graph_Graph01031->SetMaximum(55.64867);
   ...
   mainFit1032->SetChisquare(3.804855);
   ...
   mainFit1032->SetParameter(0,-1.746618);
   mainFit1032->SetParError(0,0.4341661);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9181612);
   mainFit1032->SetParError(1,0.01278268);
   ...
   pt_LaTex = pt->AddText("0.918#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.75#pm0.434");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.466");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.9023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.9023,-59.51343,1.9023,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.804855);
   ...
   mainFit1033->SetParameter(0,-1.746618);
   mainFit1033->SetParError(0,0.4341661);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9181612);
   mainFit1033->SetParError(1,0.01278268);
