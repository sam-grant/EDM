...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-57.50983);
   Graph_Graph01029->SetMaximum(55.75891);
   ...
   mainFit1030->SetChisquare(8.684086);
   ...
   mainFit1030->SetParameter(0,-1.63001);
   mainFit1030->SetParError(0,0.4900842);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8923845);
   mainFit1030->SetParError(1,0.01486727);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.89");
   pt_LaTex = pt->AddText("0.892#pm0.0149");
   pt_LaTex = pt->AddText("#minus1.63#pm 0.49");
   pt_LaTex = pt->AddText("#minus1.83#pm0.546");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.826578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.826578,-57.50983,1.826578,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(8.684086);
   ...
   mainFit1031->SetParameter(0,-1.63001);
   mainFit1031->SetParError(0,0.4900842);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8923845);
   mainFit1031->SetParError(1,0.01486727);
