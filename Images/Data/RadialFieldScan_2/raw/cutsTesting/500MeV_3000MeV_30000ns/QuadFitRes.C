...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01446162);
   Graph_Graph11015->SetMaximum(0.01427201);
   ...
   Graph_Graph21016->SetMinimum(-0.01594262);
   Graph_Graph21016->SetMaximum(0.0187725);
   ...
   Graph_Graph31017->SetMinimum(-0.03895023);
   Graph_Graph31017->SetMaximum(0.03011667);
   ...
   Graph_Graph41018->SetMinimum(-0.01217423);
   Graph_Graph41018->SetMaximum(0.02071306);
   ...
   Graph_Graph51019->SetMinimum(-0.005086991);
   Graph_Graph51019->SetMaximum(0.006800085);
