...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-66.11118,50,42.13125);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-55.28693);
   Graph_Graph01025->SetMaximum(31.30701);
   ...
   mainFit1026->SetChisquare(3.132716);
   ...
   mainFit1026->SetParameter(0,-1.928546);
   mainFit1026->SetParError(0,0.4871228);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8624063);
   mainFit1026->SetParError(1,0.01929288);
   ...
   pt_LaTex = pt->AddText("#minus1.93#pm0.487");
   pt_LaTex = pt->AddText("#minus2.24#pm0.573");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.236239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.236239,-55.28693,2.236239,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.132716);
   ...
   mainFit1027->SetParameter(0,-1.928546);
   mainFit1027->SetParError(0,0.4871228);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8624063);
   mainFit1027->SetParError(1,0.01929288);
