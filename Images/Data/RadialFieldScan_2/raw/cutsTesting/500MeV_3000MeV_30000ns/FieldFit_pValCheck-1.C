...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-57.50983);
   Graph_Graph01023->SetMaximum(55.75891);
   ...
   mainFit1024->SetChisquare(9.386001);
   ...
   mainFit1024->SetParameter(0,-1.469867);
   mainFit1024->SetParError(0,0.4512698);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.893265);
   mainFit1024->SetParError(1,0.01483017);
   ...
   mainFit1025->SetChisquare(9.386001);
   ...
   mainFit1025->SetParameter(0,-1.469867);
   mainFit1025->SetParError(0,0.4512698);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.893265);
   mainFit1025->SetParError(1,0.01483017);
