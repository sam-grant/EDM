...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-57.50983);
   Graph_Graph01020->SetMaximum(55.75891);
   ...
   mainFit1021->SetChisquare(9.386001);
   ...
   mainFit1021->SetParameter(0,-1.469867);
   mainFit1021->SetParError(0,0.4512698);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.893265);
   mainFit1021->SetParError(1,0.01483017);
   ...
   pt_LaTex = pt->AddText("#minus1.47#pm0.451");
   pt_LaTex = pt->AddText("#minus1.65#pm0.501");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.6455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.6455,-57.50983,1.6455,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(9.386001);
   ...
   mainFit1022->SetParameter(0,-1.469867);
   mainFit1022->SetParError(0,0.4512698);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.893265);
   mainFit1022->SetParError(1,0.01483017);
