...
//=========  (Fri Apr 23 21:31:40 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.253595);
   ...
   quadLineFit1002->SetParameter(0,74.50222);
   quadLineFit1002->SetParError(0,0.06737952);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.18998);
   quadLineFit1002->SetParError(1,1.129861);
   ...
   quadLineFit1003->SetChisquare(0.253595);
   ...
   quadLineFit1003->SetParameter(0,74.50222);
   quadLineFit1003->SetParError(0,0.06737952);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.18998);
   quadLineFit1003->SetParError(1,1.129861);
   ...
   Graph_30_ppm1003->SetMinimum(75.79904);
   Graph_30_ppm1003->SetMaximum(76.38104);
   ...
   quadLineFit1004->SetChisquare(1.533472);
   ...
   quadLineFit1004->SetParameter(0,74.66509);
   quadLineFit1004->SetParError(0,0.05799319);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,23.13768);
   quadLineFit1004->SetParError(1,0.9531637);
   ...
   quadLineFit1005->SetChisquare(1.533472);
   ...
   quadLineFit1005->SetParameter(0,74.66509);
   quadLineFit1005->SetParError(0,0.05799319);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,23.13768);
   quadLineFit1005->SetParError(1,0.9531637);
   ...
   Graph_10_ppm1005->SetMinimum(74.8128);
   Graph_10_ppm1005->SetMaximum(75.05916);
   ...
   quadLineFit1006->SetChisquare(2.600602);
   ...
   quadLineFit1006->SetParameter(0,74.41257);
   quadLineFit1006->SetParError(0,0.06793266);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.305216);
   quadLineFit1006->SetParError(1,1.101746);
   ...
   quadLineFit1007->SetChisquare(2.600602);
   ...
   quadLineFit1007->SetParameter(0,74.41257);
   quadLineFit1007->SetParError(0,0.06793266);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.305216);
   quadLineFit1007->SetParError(1,1.101746);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.58844);
   Graph_mI10_ppm1007->SetMaximum(73.91604);
   ...
   quadLineFit1008->SetChisquare(9.552022);
   ...
   quadLineFit1008->SetParameter(0,74.40426);
   quadLineFit1008->SetParError(0,0.05965656);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.76759);
   quadLineFit1008->SetParError(1,0.9709998);
   ...
   quadLineFit1009->SetChisquare(9.552022);
   ...
   quadLineFit1009->SetParameter(0,74.40426);
   quadLineFit1009->SetParError(0,0.05965656);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.76759);
   quadLineFit1009->SetParError(1,0.9709998);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.23239);
   Graph_mI30_ppm1009->SetMaximum(72.93547);
   ...
   quadLineFit1010->SetChisquare(2.720718);
   ...
   quadLineFit1010->SetParameter(0,74.29987);
   quadLineFit1010->SetParError(0,0.05641844);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.77583);
   quadLineFit1010->SetParError(1,0.9763975);
   ...
   quadLineFit1011->SetChisquare(2.720718);
   ...
   quadLineFit1011->SetParameter(0,74.29987);
   quadLineFit1011->SetParError(0,0.05641844);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.77583);
   quadLineFit1011->SetParError(1,0.9763975);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.30544);
   Graph_mI50_ppm1011->SetMaximum(71.96328);
   ...
   quadLineFit1012->SetChisquare(0.3033639);
   ...
   quadLineFit1012->SetParameter(0,74.25865);
   quadLineFit1012->SetParError(0,0.1138713);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.03325);
   quadLineFit1012->SetParError(1,2.03752);
   ...
   quadLineFit1013->SetChisquare(0.3033639);
   ...
   quadLineFit1013->SetParameter(0,74.25865);
   quadLineFit1013->SetParError(0,0.1138713);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.03325);
   quadLineFit1013->SetParError(1,2.03752);
