...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-57.50983);
   Graph_Graph01033->SetMaximum(55.75891);
   ...
   mainFit1034->SetChisquare(8.884999);
   ...
   mainFit1034->SetParameter(0,-1.712188);
   mainFit1034->SetParError(0,0.5664344);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9011487);
   mainFit1034->SetParError(1,0.01854702);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.96");
   pt_LaTex = pt->AddText("0.901#pm0.0185");
   pt_LaTex = pt->AddText("#minus1.71#pm0.566");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.611");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.900006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.900006,-57.50983,1.900006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(8.884999);
   ...
   mainFit1035->SetParameter(0,-1.712188);
   mainFit1035->SetParError(0,0.5664344);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9011487);
   mainFit1035->SetParError(1,0.01854702);
