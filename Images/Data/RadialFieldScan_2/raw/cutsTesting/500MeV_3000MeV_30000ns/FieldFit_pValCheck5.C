...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-47.52024,70,65.08786);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.25943);
   Graph_Graph01035->SetMaximum(53.82705);
   ...
   mainFit1036->SetChisquare(9.382964);
   ...
   mainFit1036->SetParameter(0,-1.4778);
   mainFit1036->SetParError(0,0.4736711);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8936342);
   mainFit1036->SetParError(1,0.01627333);
   ...
   pt_LaTex = pt->AddText("0.894#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.48#pm0.474");
   pt_LaTex = pt->AddText("#minus1.65#pm0.523");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.653697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.653697,-36.25943,1.653697,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(9.382964);
   ...
   mainFit1037->SetParameter(0,-1.4778);
   mainFit1037->SetParError(0,0.4736711);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8936342);
   mainFit1037->SetParError(1,0.01627333);
