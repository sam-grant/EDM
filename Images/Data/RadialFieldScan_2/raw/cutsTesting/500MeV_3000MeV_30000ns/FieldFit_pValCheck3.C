...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-71.66843,75,69.9175);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-57.50983);
   Graph_Graph01031->SetMaximum(55.75891);
   ...
   mainFit1032->SetChisquare(9.194051);
   ...
   mainFit1032->SetParameter(0,-1.356778);
   mainFit1032->SetParError(0,0.5198763);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8915071);
   mainFit1032->SetParError(1,0.01536332);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 3.06");
   pt_LaTex = pt->AddText("0.892#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.36#pm 0.52");
   pt_LaTex = pt->AddText("#minus1.52#pm0.577");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.521893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.521893,-57.50983,1.521893,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(9.194051);
   ...
   mainFit1033->SetParameter(0,-1.356778);
   mainFit1033->SetParError(0,0.5198763);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8915071);
   mainFit1033->SetParError(1,0.01536332);
