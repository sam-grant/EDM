...
//=========  (Fri Apr 23 21:31:41 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-57.50983);
   Graph_Graph01027->SetMaximum(55.75891);
   ...
   mainFit1028->SetChisquare(1.050133);
   ...
   mainFit1028->SetParameter(0,-0.8254651);
   mainFit1028->SetParError(0,0.5034479);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9140214);
   mainFit1028->SetParError(1,0.01648084);
   ...
   pt_LaTex = pt->AddText("0.914#pm0.0165");
   pt_LaTex = pt->AddText("#minus0.825#pm0.503");
   pt_LaTex = pt->AddText("#minus0.903#pm0.552");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9031135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9031135,-57.50983,0.9031135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.050133);
   ...
   mainFit1029->SetParameter(0,-0.8254651);
   mainFit1029->SetParError(0,0.5034479);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9140214);
   mainFit1029->SetParError(1,0.01648084);
