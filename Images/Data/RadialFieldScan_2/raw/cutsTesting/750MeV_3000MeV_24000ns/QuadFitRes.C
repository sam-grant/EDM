...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01810777);
   Graph_Graph11015->SetMaximum(0.02110693);
   ...
   Graph_Graph21016->SetMinimum(-0.01079653);
   Graph_Graph21016->SetMaximum(0.01271451);
   ...
   Graph_Graph31017->SetMinimum(-0.03383751);
   Graph_Graph31017->SetMaximum(0.02529307);
   ...
   Graph_Graph41018->SetMinimum(-0.01370041);
   Graph_Graph41018->SetMaximum(0.02115873);
   ...
   Graph_Graph51019->SetMinimum(-0.007291253);
   Graph_Graph51019->SetMaximum(0.009748944);
