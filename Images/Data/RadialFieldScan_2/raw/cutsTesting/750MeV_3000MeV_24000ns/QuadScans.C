...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.120678);
   ...
   quadLineFit1002->SetParameter(0,74.59631);
   quadLineFit1002->SetParError(0,0.06867658);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.52872);
   quadLineFit1002->SetParError(1,1.15194);
   ...
   quadLineFit1003->SetChisquare(1.120678);
   ...
   quadLineFit1003->SetParameter(0,74.59631);
   quadLineFit1003->SetParError(0,0.06867658);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.52872);
   quadLineFit1003->SetParError(1,1.15194);
   ...
   Graph_30_ppm1003->SetMinimum(75.81617);
   Graph_30_ppm1003->SetMaximum(76.38749);
   ...
   quadLineFit1004->SetChisquare(2.685875);
   ...
   quadLineFit1004->SetParameter(0,74.69725);
   quadLineFit1004->SetParError(0,0.05773093);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.82242);
   quadLineFit1004->SetParError(1,0.9488072);
   ...
   quadLineFit1005->SetChisquare(2.685875);
   ...
   quadLineFit1005->SetParameter(0,74.69725);
   quadLineFit1005->SetParError(0,0.05773093);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.82242);
   quadLineFit1005->SetParError(1,0.9488072);
   ...
   Graph_10_ppm1005->SetMinimum(74.85658);
   Graph_10_ppm1005->SetMaximum(75.08788);
   ...
   quadLineFit1006->SetChisquare(1.204389);
   ...
   quadLineFit1006->SetParameter(0,74.48463);
   quadLineFit1006->SetParError(0,0.06764988);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.788951);
   quadLineFit1006->SetParError(1,1.097096);
   ...
   quadLineFit1007->SetChisquare(1.204389);
   ...
   quadLineFit1007->SetParameter(0,74.48463);
   quadLineFit1007->SetParError(0,0.06764988);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.788951);
   quadLineFit1007->SetParError(1,1.097096);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.67996);
   Graph_mI10_ppm1007->SetMaximum(73.97928);
   ...
   quadLineFit1008->SetChisquare(6.741062);
   ...
   quadLineFit1008->SetParameter(0,74.41783);
   quadLineFit1008->SetParError(0,0.05940318);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.75504);
   quadLineFit1008->SetParError(1,0.9668505);
   ...
   quadLineFit1009->SetChisquare(6.741062);
   ...
   quadLineFit1009->SetParameter(0,74.41783);
   quadLineFit1009->SetParError(0,0.05940318);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.75504);
   quadLineFit1009->SetParError(1,0.9668505);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.34206);
   Graph_mI30_ppm1009->SetMaximum(73.01949);
   ...
   quadLineFit1010->SetChisquare(3.386091);
   ...
   quadLineFit1010->SetParameter(0,74.32709);
   quadLineFit1010->SetParError(0,0.05617665);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-26.60267);
   quadLineFit1010->SetParError(1,0.9721906);
   ...
   quadLineFit1011->SetChisquare(3.386091);
   ...
   quadLineFit1011->SetParameter(0,74.32709);
   quadLineFit1011->SetParError(0,0.05617665);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-26.60267);
   quadLineFit1011->SetParError(1,0.9721906);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.43643);
   Graph_mI50_ppm1011->SetMaximum(72.06439);
   ...
   quadLineFit1012->SetChisquare(0.628721);
   ...
   quadLineFit1012->SetParameter(0,74.25175);
   quadLineFit1012->SetParError(0,0.1133779);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.84257);
   quadLineFit1012->SetParError(1,2.02866);
   ...
   quadLineFit1013->SetChisquare(0.628721);
   ...
   quadLineFit1013->SetParameter(0,74.25175);
   quadLineFit1013->SetParError(0,0.1133779);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.84257);
   quadLineFit1013->SetParError(1,2.02866);
