...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.92642);
   Graph_Graph01031->SetMaximum(53.73585);
   ...
   mainFit1032->SetChisquare(6.05933);
   ...
   mainFit1032->SetParameter(0,-1.140904);
   mainFit1032->SetParError(0,0.5185415);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8578095);
   mainFit1032->SetParError(1,0.01540738);
   ...
   pt_LaTex = pt->AddText("0.858#pm0.0154");
   pt_LaTex = pt->AddText("#minus1.14#pm0.519");
   pt_LaTex = pt->AddText("#minus1.33#pm0.599");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.330021,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.330021,-54.92642,1.330021,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.05933);
   ...
   mainFit1033->SetParameter(0,-1.140904);
   mainFit1033->SetParError(0,0.5185415);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8578095);
   mainFit1033->SetParError(1,0.01540738);
