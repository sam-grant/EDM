...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.92642);
   Graph_Graph01027->SetMaximum(53.73585);
   ...
   mainFit1028->SetChisquare(0.5175925);
   ...
   mainFit1028->SetParameter(0,-0.6150262);
   mainFit1028->SetParError(0,0.504123);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8754012);
   mainFit1028->SetParError(1,0.01663194);
   ...
   pt_LaTex = pt->AddText("0.875#pm0.0166");
   pt_LaTex = pt->AddText("#minus0.615#pm0.504");
   pt_LaTex = pt->AddText("#minus0.703#pm0.577");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7025649,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7025649,-54.92642,0.7025649,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.5175925);
   ...
   mainFit1029->SetParameter(0,-0.6150262);
   mainFit1029->SetParError(0,0.504123);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8754012);
   mainFit1029->SetParError(1,0.01663194);
