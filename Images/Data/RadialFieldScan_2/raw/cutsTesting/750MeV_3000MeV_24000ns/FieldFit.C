...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.92642);
   Graph_Graph01020->SetMaximum(53.73585);
   ...
   mainFit1021->SetChisquare(6.060353);
   ...
   mainFit1021->SetParameter(0,-1.149135);
   mainFit1021->SetParError(0,0.4501915);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8579367);
   mainFit1021->SetParError(1,0.01488595);
   ...
   mainFit1022->SetChisquare(6.060353);
   ...
   mainFit1022->SetParameter(0,-1.149135);
   mainFit1022->SetParError(0,0.4501915);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8579367);
   mainFit1022->SetParError(1,0.01488595);
