...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.92642);
   Graph_Graph01029->SetMaximum(53.73585);
   ...
   mainFit1030->SetChisquare(5.931727);
   ...
   mainFit1030->SetParameter(0,-1.217927);
   mainFit1030->SetParError(0,0.489353);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8575292);
   mainFit1030->SetParError(1,0.01492909);
   ...
   pt_LaTex = pt->AddText("#minus1.22#pm0.489");
   pt_LaTex = pt->AddText("#minus1.42#pm0.568");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.420275,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.420275,-54.92642,1.420275,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.931727);
   ...
   mainFit1031->SetParameter(0,-1.217927);
   mainFit1031->SetParError(0,0.489353);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8575292);
   mainFit1031->SetParError(1,0.01492909);
