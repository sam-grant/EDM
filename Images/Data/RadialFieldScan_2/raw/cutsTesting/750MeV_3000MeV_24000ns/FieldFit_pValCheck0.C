...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.28185,50,41.18184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.83548);
   Graph_Graph01025->SetMaximum(30.73547);
   ...
   mainFit1026->SetChisquare(1.385054);
   ...
   mainFit1026->SetParameter(0,-1.539214);
   mainFit1026->SetParError(0,0.484993);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.831691);
   mainFit1026->SetParError(1,0.01920745);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.462");
   pt_LaTex = pt->AddText("0.832#pm0.0192");
   pt_LaTex = pt->AddText("#minus1.54#pm0.485");
   pt_LaTex = pt->AddText("#minus1.85#pm 0.59");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.850704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.850704,-52.83548,1.850704,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.385054);
   ...
   mainFit1027->SetParameter(0,-1.539214);
   mainFit1027->SetParError(0,0.484993);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.831691);
   mainFit1027->SetParError(1,0.01920745);
