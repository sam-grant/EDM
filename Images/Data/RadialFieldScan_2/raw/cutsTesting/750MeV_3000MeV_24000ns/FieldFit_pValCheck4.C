...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-54.92642);
   Graph_Graph01033->SetMaximum(53.73585);
   ...
   mainFit1034->SetChisquare(5.891003);
   ...
   mainFit1034->SetParameter(0,-1.289059);
   mainFit1034->SetParError(0,0.5641657);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8625365);
   mainFit1034->SetParError(1,0.01861536);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0186");
   pt_LaTex = pt->AddText("#minus1.29#pm0.564");
   pt_LaTex = pt->AddText("#minus1.49#pm 0.64");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.494498,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.494498,-54.92642,1.494498,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.891003);
   ...
   mainFit1035->SetParameter(0,-1.289059);
   mainFit1035->SetParError(0,0.5641657);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8625365);
   mainFit1035->SetParError(1,0.01861536);
