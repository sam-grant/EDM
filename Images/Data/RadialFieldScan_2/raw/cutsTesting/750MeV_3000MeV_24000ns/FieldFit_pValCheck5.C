...
//=========  (Fri Apr 23 18:49:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.63874,70,62.74454);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.80041);
   Graph_Graph01035->SetMaximum(51.90621);
   ...
   mainFit1036->SetChisquare(6.047626);
   ...
   mainFit1036->SetParameter(0,-1.1652);
   mainFit1036->SetParError(0,0.4721771);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8586976);
   mainFit1036->SetParError(1,0.01634281);
   ...
   pt_LaTex = pt->AddText("0.859#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.17#pm0.472");
   pt_LaTex = pt->AddText("#minus1.36#pm0.544");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.356939,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.356939,-34.80041,1.356939,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(6.047626);
   ...
   mainFit1037->SetParameter(0,-1.1652);
   mainFit1037->SetParError(0,0.4721771);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8586976);
   mainFit1037->SetParError(1,0.01634281);
