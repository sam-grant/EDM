...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.81292);
   Graph_Graph01031->SetMaximum(56.07494);
   ...
   mainFit1032->SetChisquare(1.029172);
   ...
   mainFit1032->SetParameter(0,-1.967407);
   mainFit1032->SetParError(0,0.3816292);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9397878);
   mainFit1032->SetParError(1,0.01142183);
   ...
   pt_LaTex = pt->AddText(" 0.94#pm0.0114");
   pt_LaTex = pt->AddText("#minus1.97#pm0.382");
   pt_LaTex = pt->AddText("#minus2.09#pm  0.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.093459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.093459,-59.81292,2.093459,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.029172);
   ...
   mainFit1033->SetParameter(0,-1.967407);
   mainFit1033->SetParError(0,0.3816292);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9397878);
   mainFit1033->SetParError(1,0.01142183);
