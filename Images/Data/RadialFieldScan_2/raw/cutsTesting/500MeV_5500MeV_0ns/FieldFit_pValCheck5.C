...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-50.2321,70,65.74756);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.63413);
   Graph_Graph01035->SetMaximum(54.14959);
   ...
   mainFit1036->SetChisquare(0.9782084);
   ...
   mainFit1036->SetParameter(0,-1.998002);
   mainFit1036->SetParError(0,0.347265);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9410431);
   mainFit1036->SetParError(1,0.01213983);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.326");
   pt_LaTex = pt->AddText("0.941#pm0.0121");
   pt_LaTex = pt->AddText("   #minus2#pm0.347");
   pt_LaTex = pt->AddText("#minus2.12#pm0.363");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.123178,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.123178,-38.63413,2.123178,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.9782084);
   ...
   mainFit1037->SetParameter(0,-1.998002);
   mainFit1037->SetParError(0,0.347265);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9410431);
   mainFit1037->SetParError(1,0.01213983);
