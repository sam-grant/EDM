...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.81292);
   Graph_Graph01027->SetMaximum(56.07494);
   ...
   mainFit1028->SetChisquare(0.1209747);
   ...
   mainFit1028->SetParameter(0,-1.810787);
   mainFit1028->SetParError(0,0.3732117);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9453415);
   mainFit1028->SetParError(1,0.01244213);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0403");
   pt_LaTex = pt->AddText("0.945#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.81#pm0.373");
   pt_LaTex = pt->AddText("#minus1.92#pm0.398");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.915484,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.915484,-59.81292,1.915484,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.1209747);
   ...
   mainFit1029->SetParameter(0,-1.810787);
   mainFit1029->SetParError(0,0.3732117);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9453415);
   mainFit1029->SetParError(1,0.01244213);
