...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.29413,50,45.53703);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.81101);
   Graph_Graph01025->SetMaximum(34.05391);
   ...
   mainFit1026->SetChisquare(0.3534427);
   ...
   mainFit1026->SetParameter(0,-2.081643);
   mainFit1026->SetParError(0,0.3562075);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9326857);
   mainFit1026->SetParError(1,0.01410102);
   ...
   pt_LaTex = pt->AddText("0.933#pm0.0141");
   pt_LaTex = pt->AddText("#minus2.08#pm0.356");
   pt_LaTex = pt->AddText("#minus2.23#pm0.387");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.231881,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.231881,-57.81101,2.231881,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.3534427);
   ...
   mainFit1027->SetParameter(0,-2.081643);
   mainFit1027->SetParError(0,0.3562075);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9326857);
   mainFit1027->SetParError(1,0.01410102);
