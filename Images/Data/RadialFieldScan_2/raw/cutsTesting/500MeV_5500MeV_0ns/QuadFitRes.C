...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01887976);
   Graph_Graph11015->SetMaximum(0.01063493);
   ...
   Graph_Graph21016->SetMinimum(-0.01865942);
   Graph_Graph21016->SetMaximum(0.02190641);
   ...
   Graph_Graph31017->SetMinimum(-0.02473182);
   Graph_Graph31017->SetMaximum(0.0179579);
   ...
   Graph_Graph41018->SetMinimum(-0.006605929);
   Graph_Graph41018->SetMaximum(0.007892967);
   ...
   Graph_Graph51019->SetMinimum(-0.004273942);
   Graph_Graph51019->SetMaximum(0.005694762);
