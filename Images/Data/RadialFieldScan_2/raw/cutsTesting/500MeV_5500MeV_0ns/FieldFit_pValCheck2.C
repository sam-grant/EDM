...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.81292);
   Graph_Graph01029->SetMaximum(56.07494);
   ...
   mainFit1030->SetChisquare(0.9440392);
   ...
   mainFit1030->SetParameter(0,-2.016155);
   mainFit1030->SetParError(0,0.360708);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9396209);
   mainFit1030->SetParError(1,0.01108905);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.315");
   pt_LaTex = pt->AddText(" 0.94#pm0.0111");
   pt_LaTex = pt->AddText("#minus2.02#pm0.361");
   pt_LaTex = pt->AddText("#minus2.15#pm0.382");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.145712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.145712,-59.81292,2.145712,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.9440392);
   ...
   mainFit1031->SetParameter(0,-2.016155);
   mainFit1031->SetParError(0,0.360708);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9396209);
   mainFit1031->SetParError(1,0.01108905);
