...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.81292);
   Graph_Graph01023->SetMaximum(56.07494);
   ...
   mainFit1024->SetChisquare(1.030509);
   ...
   mainFit1024->SetParameter(0,-1.974317);
   mainFit1024->SetParError(0,0.3314704);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9398911);
   mainFit1024->SetParError(1,0.01105022);
   ...
   mainFit1025->SetChisquare(1.030509);
   ...
   mainFit1025->SetParameter(0,-1.974317);
   mainFit1025->SetParError(0,0.3314704);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9398911);
   mainFit1025->SetParError(1,0.01105022);
