...
//=========  (Thu Apr 22 14:23:55 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.81292);
   Graph_Graph01020->SetMaximum(56.07494);
   ...
   mainFit1021->SetChisquare(1.030509);
   ...
   mainFit1021->SetParameter(0,-1.974317);
   mainFit1021->SetParError(0,0.3314704);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9398911);
   mainFit1021->SetParError(1,0.01105022);
   ...
   pt_LaTex = pt->AddText("#minus1.97#pm0.331");
   pt_LaTex = pt->AddText(" #minus2.1#pm 0.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.10058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.10058,-59.81292,2.10058,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(1.030509);
   ...
   mainFit1022->SetParameter(0,-1.974317);
   mainFit1022->SetParError(0,0.3314704);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9398911);
   mainFit1022->SetParError(1,0.01105022);
