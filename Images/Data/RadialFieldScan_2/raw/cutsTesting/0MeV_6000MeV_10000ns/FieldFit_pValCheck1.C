...
//=========  (Wed Apr 21 15:11:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.57267);
   Graph_Graph01027->SetMaximum(55.06435);
   ...
   mainFit1028->SetChisquare(1.968573);
   ...
   mainFit1028->SetParameter(0,-1.630689);
   mainFit1028->SetParError(0,0.3649922);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9297413);
   mainFit1028->SetParError(1,0.01190607);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.656");
   pt_LaTex = pt->AddText(" 0.93#pm0.0119");
   pt_LaTex = pt->AddText("#minus1.63#pm0.365");
   pt_LaTex = pt->AddText("#minus1.75#pm0.394");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.753917,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.753917,-59.57267,1.753917,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.968573);
   ...
   mainFit1029->SetParameter(0,-1.630689);
   mainFit1029->SetParError(0,0.3649922);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9297413);
   mainFit1029->SetParError(1,0.01190607);
