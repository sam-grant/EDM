...
//=========  (Wed Apr 21 15:11:54 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.7181,70,64.35714);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.41058);
   Graph_Graph01035->SetMaximum(53.04961);
   ...
   mainFit1036->SetChisquare(1.956358);
   ...
   mainFit1036->SetParameter(0,-1.647028);
   mainFit1036->SetParError(0,0.3439768);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9264055);
   mainFit1036->SetParError(1,0.01177788);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.652");
   pt_LaTex = pt->AddText("0.926#pm0.0118");
   pt_LaTex = pt->AddText("#minus1.65#pm0.344");
   pt_LaTex = pt->AddText("#minus1.78#pm0.366");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.77787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.77787,-37.41058,1.77787,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.956358);
   ...
   mainFit1037->SetParameter(0,-1.647028);
   mainFit1037->SetParError(0,0.3439768);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9264055);
   mainFit1037->SetParError(1,0.01177788);
