...
//=========  (Wed Apr 21 15:11:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.57267);
   Graph_Graph01023->SetMaximum(55.06435);
   ...
   mainFit1024->SetChisquare(2.074372);
   ...
   mainFit1024->SetParameter(0,-1.682997);
   mainFit1024->SetParError(0,0.3276546);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9280682);
   mainFit1024->SetParError(1,0.01073742);
   ...
   mainFit1025->SetChisquare(2.074372);
   ...
   mainFit1025->SetParameter(0,-1.682997);
   mainFit1025->SetParError(0,0.3276546);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9280682);
   mainFit1025->SetParError(1,0.01073742);
