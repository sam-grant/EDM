...
//=========  (Wed Apr 21 15:11:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.57267);
   Graph_Graph01033->SetMaximum(55.06435);
   ...
   mainFit1034->SetChisquare(1.560728);
   ...
   mainFit1034->SetParameter(0,-1.861724);
   mainFit1034->SetParError(0,0.4117616);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9338555);
   mainFit1034->SetParError(1,0.01343496);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.52");
   pt_LaTex = pt->AddText("0.934#pm0.0134");
   pt_LaTex = pt->AddText("#minus1.86#pm0.412");
   pt_LaTex = pt->AddText("#minus1.99#pm0.428");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.993589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.993589,-59.57267,1.993589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.560728);
   ...
   mainFit1035->SetParameter(0,-1.861724);
   mainFit1035->SetParError(0,0.4117616);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9338555);
   mainFit1035->SetParError(1,0.01343496);
