...
//=========  (Wed Apr 21 15:11:53 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-69.19259,50,45.84541);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.68879);
   Graph_Graph01025->SetMaximum(34.34161);
   ...
   mainFit1026->SetChisquare(2.072864);
   ...
   mainFit1026->SetParameter(0,-1.677779);
   mainFit1026->SetParError(0,0.3541308);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9284184);
   mainFit1026->SetParError(1,0.01402137);
   ...
   pt_LaTex = pt->AddText("0.928#pm0.014");
   pt_LaTex = pt->AddText("#minus1.68#pm0.354");
   pt_LaTex = pt->AddText("#minus1.81#pm0.386");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.807136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.807136,-57.68879,1.807136,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.072864);
   ...
   mainFit1027->SetParameter(0,-1.677779);
   mainFit1027->SetParError(0,0.3541308);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9284184);
   mainFit1027->SetParError(1,0.01402137);
