...
//=========  (Wed Apr 21 15:11:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-59.57267);
   Graph_Graph01020->SetMaximum(55.06435);
   ...
   mainFit1021->SetChisquare(2.074372);
   ...
   mainFit1021->SetParameter(0,-1.682997);
   mainFit1021->SetParError(0,0.3276546);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9280682);
   mainFit1021->SetParError(1,0.01073742);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.519");
   pt_LaTex = pt->AddText("0.928#pm0.0107");
   pt_LaTex = pt->AddText("#minus1.68#pm0.328");
   pt_LaTex = pt->AddText("#minus1.81#pm 0.35");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.813441,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.813441,-59.57267,1.813441,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.074372);
   ...
   mainFit1022->SetParameter(0,-1.682997);
   mainFit1022->SetParError(0,0.3276546);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9280682);
   mainFit1022->SetParError(1,0.01073742);
