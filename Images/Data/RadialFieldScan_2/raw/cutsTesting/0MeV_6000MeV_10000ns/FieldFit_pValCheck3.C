...
//=========  (Wed Apr 21 15:11:54 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-73.9023,75,69.39398);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-59.57267);
   Graph_Graph01031->SetMaximum(55.06435);
   ...
   mainFit1032->SetChisquare(0.9977311);
   ...
   mainFit1032->SetParameter(0,-1.488663);
   mainFit1032->SetParError(0,0.3774052);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9250465);
   mainFit1032->SetParError(1,0.01112536);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.333");
   pt_LaTex = pt->AddText("0.925#pm0.0111");
   pt_LaTex = pt->AddText("#minus1.49#pm0.377");
   pt_LaTex = pt->AddText("#minus1.61#pm0.403");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.609285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.609285,-59.57267,1.609285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.9977311);
   ...
   mainFit1033->SetParameter(0,-1.488663);
   mainFit1033->SetParError(0,0.3774052);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9250465);
   mainFit1033->SetParError(1,0.01112536);
