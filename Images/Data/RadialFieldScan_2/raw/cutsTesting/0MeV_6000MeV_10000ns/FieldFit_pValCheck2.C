...
//=========  (Wed Apr 21 15:11:54 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.57267);
   Graph_Graph01029->SetMaximum(55.06435);
   ...
   mainFit1030->SetChisquare(1.043843);
   ...
   mainFit1030->SetParameter(0,-1.823391);
   mainFit1030->SetParError(0,0.3556472);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9273162);
   mainFit1030->SetParError(1,0.01076289);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.348");
   pt_LaTex = pt->AddText("0.927#pm0.0108");
   pt_LaTex = pt->AddText("#minus1.82#pm0.356");
   pt_LaTex = pt->AddText("#minus1.97#pm0.381");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.96631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.96631,-59.57267,1.96631,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.043843);
   ...
   mainFit1031->SetParameter(0,-1.823391);
   mainFit1031->SetParError(0,0.3556472);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9273162);
   mainFit1031->SetParError(1,0.01076289);
