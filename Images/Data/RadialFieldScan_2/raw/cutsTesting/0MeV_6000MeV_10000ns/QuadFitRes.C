...
//=========  (Wed Apr 21 15:11:53 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.006658699);
   Graph_Graph11015->SetMaximum(0.006105721);
   ...
   Graph_Graph21016->SetMinimum(-0.007164695);
   Graph_Graph21016->SetMaximum(0.008396405);
   ...
   Graph_Graph31017->SetMinimum(-0.01677228);
   Graph_Graph31017->SetMaximum(0.02212239);
   ...
   Graph_Graph41018->SetMinimum(-0.005915914);
   Graph_Graph41018->SetMaximum(0.00855904);
   ...
   Graph_Graph51019->SetMinimum(-0.004617644);
   Graph_Graph51019->SetMaximum(0.006174755);
