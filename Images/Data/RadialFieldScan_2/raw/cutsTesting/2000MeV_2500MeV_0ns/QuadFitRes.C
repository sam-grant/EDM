...
//=========  (Thu Apr 22 00:07:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.02426444);
   Graph_Graph11015->SetMaximum(0.03072157);
   ...
   Graph_Graph21016->SetMinimum(-0.0003671968);
   Graph_Graph21016->SetMaximum(0.0003129088);
   ...
   Graph_Graph31017->SetMinimum(-0.02143546);
   Graph_Graph31017->SetMaximum(0.02296341);
   ...
   Graph_Graph41018->SetMinimum(-0.009855197);
   Graph_Graph41018->SetMaximum(0.01665238);
   ...
   Graph_Graph51019->SetMinimum(-0.01241341);
   Graph_Graph51019->SetMaximum(0.01651215);
