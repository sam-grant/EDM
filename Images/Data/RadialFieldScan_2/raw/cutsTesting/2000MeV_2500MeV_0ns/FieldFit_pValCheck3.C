...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-48.9085);
   Graph_Graph01031->SetMaximum(50.68794);
   ...
   mainFit1032->SetChisquare(5.939552);
   ...
   mainFit1032->SetParameter(0,-1.241662);
   mainFit1032->SetParError(0,0.8702853);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8431744);
   mainFit1032->SetParError(1,0.02577928);
   ...
   pt_LaTex = pt->AddText("0.843#pm0.0258");
   pt_LaTex = pt->AddText("#minus1.24#pm 0.87");
   pt_LaTex = pt->AddText("#minus1.47#pm 1.02");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.472604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.472604,-48.9085,1.472604,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.939552);
   ...
   mainFit1033->SetParameter(0,-1.241662);
   mainFit1033->SetParError(0,0.8702853);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8431744);
   mainFit1033->SetParError(1,0.02577928);
