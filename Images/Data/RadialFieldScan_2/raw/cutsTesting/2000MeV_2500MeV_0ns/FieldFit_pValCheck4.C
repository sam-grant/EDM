...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-61.35806,75,63.1375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-48.9085);
   Graph_Graph01033->SetMaximum(50.68794);
   ...
   mainFit1034->SetChisquare(2.706493);
   ...
   mainFit1034->SetParameter(0,-0.3418104);
   mainFit1034->SetParError(0,0.9478556);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8112134);
   mainFit1034->SetParError(1,0.0311446);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.902");
   pt_LaTex = pt->AddText("0.811#pm0.0311");
   pt_LaTex = pt->AddText("#minus0.342#pm0.948");
   pt_LaTex = pt->AddText("#minus0.421#pm 1.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.4213569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4213569,-48.9085,0.4213569,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.706493);
   ...
   mainFit1035->SetParameter(0,-0.3418104);
   mainFit1035->SetParError(0,0.9478556);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8112134);
   mainFit1035->SetParError(1,0.0311446);
