...
//=========  (Thu Apr 22 00:07:43 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-48.9085);
   Graph_Graph01020->SetMaximum(50.68794);
   ...
   mainFit1021->SetChisquare(6.056969);
   ...
   mainFit1021->SetParameter(0,-1.389676);
   mainFit1021->SetParError(0,0.7554303);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.845454);
   mainFit1021->SetParError(1,0.02489547);
   ...
   mainFit1022->SetChisquare(6.056969);
   ...
   mainFit1022->SetParameter(0,-1.389676);
   mainFit1022->SetParError(0,0.7554303);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.845454);
   mainFit1022->SetParError(1,0.02489547);
