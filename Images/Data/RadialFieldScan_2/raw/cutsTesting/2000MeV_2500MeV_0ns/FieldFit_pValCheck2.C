...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-48.9085);
   Graph_Graph01029->SetMaximum(50.68794);
   ...
   mainFit1030->SetChisquare(5.329506);
   ...
   mainFit1030->SetParameter(0,-1.662866);
   mainFit1030->SetParError(0,0.8205051);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8439108);
   mainFit1030->SetParError(1,0.02496225);
   ...
   pt_LaTex = pt->AddText("0.844#pm0.025");
   pt_LaTex = pt->AddText("#minus1.66#pm0.821");
   pt_LaTex = pt->AddText("#minus1.97#pm0.967");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.970429,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.970429,-48.9085,1.970429,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.329506);
   ...
   mainFit1031->SetParameter(0,-1.662866);
   mainFit1031->SetParError(0,0.8205051);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8439108);
   mainFit1031->SetParError(1,0.02496225);
