...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-48.9085);
   Graph_Graph01023->SetMaximum(50.68794);
   ...
   mainFit1024->SetChisquare(6.056969);
   ...
   mainFit1024->SetParameter(0,-1.389676);
   mainFit1024->SetParError(0,0.7554303);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.845454);
   mainFit1024->SetParError(1,0.02489547);
   ...
   pt_LaTex = pt->AddText("0.845#pm0.0249");
   pt_LaTex = pt->AddText("#minus1.39#pm0.755");
   pt_LaTex = pt->AddText("#minus1.64#pm0.887");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.643703,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.643703,-48.9085,1.643703,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(6.056969);
   ...
   mainFit1025->SetParameter(0,-1.389676);
   mainFit1025->SetParError(0,0.7554303);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.845454);
   mainFit1025->SetParError(1,0.02489547);
