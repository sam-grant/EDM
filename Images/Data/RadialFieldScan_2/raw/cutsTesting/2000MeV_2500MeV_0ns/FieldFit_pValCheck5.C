...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.73435,70,60.61276);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.79964);
   Graph_Graph01035->SetMaximum(49.67804);
   ...
   mainFit1036->SetChisquare(1.514781);
   ...
   mainFit1036->SetParameter(0,-1.900398);
   mainFit1036->SetParError(0,0.7925202);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8694336);
   mainFit1036->SetParError(1,0.02731735);
   ...
   pt_LaTex = pt->AddText("0.869#pm0.0273");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.793");
   pt_LaTex = pt->AddText("#minus2.19#pm0.896");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,2.185789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.185789,-37.79964,2.185789,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.514781);
   ...
   mainFit1037->SetParameter(0,-1.900398);
   mainFit1037->SetParError(0,0.7925202);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8694336);
   mainFit1037->SetParError(1,0.02731735);
