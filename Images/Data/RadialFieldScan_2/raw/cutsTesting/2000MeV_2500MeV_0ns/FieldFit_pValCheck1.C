...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-48.9085);
   Graph_Graph01027->SetMaximum(50.68794);
   ...
   mainFit1028->SetChisquare(6.00559);
   ...
   mainFit1028->SetParameter(0,-1.475237);
   mainFit1028->SetParError(0,0.8443777);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8426939);
   mainFit1028->SetParError(1,0.02773945);
   ...
   pt_LaTex = pt->AddText("0.843#pm0.0277");
   pt_LaTex = pt->AddText("#minus1.48#pm0.844");
   pt_LaTex = pt->AddText("#minus1.75#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.75062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.75062,-48.9085,1.75062,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(6.00559);
   ...
   mainFit1029->SetParameter(0,-1.475237);
   mainFit1029->SetParError(0,0.8443777);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8426939);
   mainFit1029->SetParError(1,0.02773945);
