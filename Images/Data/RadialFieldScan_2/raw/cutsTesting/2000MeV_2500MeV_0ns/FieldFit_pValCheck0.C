...
//=========  (Thu Apr 22 00:07:44 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-57.22462,50,42.47033);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-47.25513);
   Graph_Graph01025->SetMaximum(32.50083);
   ...
   mainFit1026->SetChisquare(5.967464);
   ...
   mainFit1026->SetParameter(0,-1.298501);
   mainFit1026->SetParError(0,0.8147769);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8515883);
   mainFit1026->SetParError(1,0.03226449);
   ...
   pt_LaTex = pt->AddText("0.852#pm0.0323");
   pt_LaTex = pt->AddText(" #minus1.3#pm0.815");
   pt_LaTex = pt->AddText("#minus1.52#pm0.965");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.524799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.524799,-47.25513,1.524799,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(5.967464);
   ...
   mainFit1027->SetParameter(0,-1.298501);
   mainFit1027->SetParError(0,0.8147769);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8515883);
   mainFit1027->SetParError(1,0.03226449);
