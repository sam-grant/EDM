...
//=========  (Thu Apr 22 09:33:22 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.2790237);
   ...
   quadLineFit1002->SetParameter(0,75.02595);
   quadLineFit1002->SetParError(0,0.08134705);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.34042);
   quadLineFit1002->SetParError(1,1.363587);
   ...
   quadLineFit1003->SetChisquare(0.2790237);
   ...
   quadLineFit1003->SetParameter(0,75.02595);
   quadLineFit1003->SetParError(0,0.08134705);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.34042);
   quadLineFit1003->SetParError(1,1.363587);
   ...
   Graph_30_ppm1003->SetMinimum(76.21093);
   Graph_30_ppm1003->SetMaximum(76.83422);
   ...
   quadLineFit1004->SetChisquare(5.749348);
   ...
   quadLineFit1004->SetParameter(0,74.99894);
   quadLineFit1004->SetParError(0,0.06859105);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.5481);
   quadLineFit1004->SetParError(1,1.126782);
   ...
   quadLineFit1005->SetChisquare(5.749348);
   ...
   quadLineFit1005->SetParameter(0,74.99894);
   quadLineFit1005->SetParError(0,0.06859105);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.5481);
   quadLineFit1005->SetParError(1,1.126782);
   ...
   Graph_10_ppm1005->SetMinimum(75.27575);
   Graph_10_ppm1005->SetMaximum(75.494);
   ...
   quadLineFit1006->SetChisquare(1.707053);
   ...
   quadLineFit1006->SetParameter(0,74.94941);
   quadLineFit1006->SetParError(0,0.08035262);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.878885);
   quadLineFit1006->SetParError(1,1.302318);
   ...
   quadLineFit1007->SetChisquare(1.707053);
   ...
   quadLineFit1007->SetParameter(0,74.94941);
   quadLineFit1007->SetParError(0,0.08035262);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.878885);
   quadLineFit1007->SetParError(1,1.302318);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.15854);
   Graph_mI10_ppm1007->SetMaximum(74.4683);
   ...
   quadLineFit1008->SetChisquare(8.377594);
   ...
   quadLineFit1008->SetParameter(0,74.87423);
   quadLineFit1008->SetParError(0,0.07041156);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.519877);
   quadLineFit1008->SetParError(1,1.145316);
   ...
   quadLineFit1009->SetChisquare(8.377594);
   ...
   quadLineFit1009->SetParameter(0,74.87423);
   quadLineFit1009->SetParError(0,0.07041156);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.519877);
   quadLineFit1009->SetParError(1,1.145316);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.80807);
   Graph_mI30_ppm1009->SetMaximum(73.53747);
   ...
   quadLineFit1010->SetChisquare(1.787932);
   ...
   quadLineFit1010->SetParameter(0,74.94538);
   quadLineFit1010->SetParError(0,0.066517);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.96087);
   quadLineFit1010->SetParError(1,1.150344);
   ...
   quadLineFit1011->SetChisquare(1.787932);
   ...
   quadLineFit1011->SetParameter(0,74.94538);
   quadLineFit1011->SetParError(0,0.066517);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.96087);
   quadLineFit1011->SetParError(1,1.150344);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.96348);
   Graph_mI50_ppm1011->SetMaximum(72.58904);
   ...
   quadLineFit1012->SetChisquare(1.272316);
   ...
   quadLineFit1012->SetParameter(0,74.74417);
   quadLineFit1012->SetParError(0,0.1343217);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.18403);
   quadLineFit1012->SetParError(1,2.402412);
   ...
   quadLineFit1013->SetChisquare(1.272316);
   ...
   quadLineFit1013->SetParameter(0,74.74417);
   quadLineFit1013->SetParError(0,0.1343217);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.18403);
   quadLineFit1013->SetParError(1,2.402412);
