...
//=========  (Thu Apr 22 09:33:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-54.51549);
   Graph_Graph01020->SetMaximum(52.63305);
   ...
   mainFit1021->SetChisquare(2.34114);
   ...
   mainFit1021->SetParameter(0,-1.592982);
   mainFit1021->SetParError(0,0.5334536);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8753204);
   mainFit1021->SetParError(1,0.0176299);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.585");
   pt_LaTex = pt->AddText("0.875#pm0.0176");
   pt_LaTex = pt->AddText("#minus1.59#pm0.533");
   pt_LaTex = pt->AddText("#minus1.82#pm0.605");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.819885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.819885,-54.51549,1.819885,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.34114);
   ...
   mainFit1022->SetParameter(0,-1.592982);
   mainFit1022->SetParError(0,0.5334536);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8753204);
   mainFit1022->SetParError(1,0.0176299);
