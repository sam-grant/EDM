...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-48.56502,70,62.15782);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.49274);
   Graph_Graph01035->SetMaximum(51.08553);
   ...
   mainFit1036->SetChisquare(1.303235);
   ...
   mainFit1036->SetParameter(0,-1.764677);
   mainFit1036->SetParError(0,0.5594338);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8834608);
   mainFit1036->SetParError(1,0.01935293);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.434");
   pt_LaTex = pt->AddText("0.883#pm0.0194");
   pt_LaTex = pt->AddText("#minus1.76#pm0.559");
   pt_LaTex = pt->AddText("   #minus2#pm0.623");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.99746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.99746,-37.49274,1.99746,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.303235);
   ...
   mainFit1037->SetParameter(0,-1.764677);
   mainFit1037->SetParError(0,0.5594338);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8834608);
   mainFit1037->SetParError(1,0.01935293);
