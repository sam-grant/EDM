...
//=========  (Thu Apr 22 09:33:22 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.04688163);
   Graph_Graph11015->SetMaximum(0.03038052);
   ...
   Graph_Graph21016->SetMinimum(-0.01522303);
   Graph_Graph21016->SetMaximum(0.01786284);
   ...
   Graph_Graph31017->SetMinimum(-0.04442794);
   Graph_Graph31017->SetMaximum(0.04431968);
   ...
   Graph_Graph41018->SetMinimum(-0.02787151);
   Graph_Graph41018->SetMaximum(0.01658247);
   ...
   Graph_Graph51019->SetMinimum(-0.01236733);
   Graph_Graph51019->SetMaximum(0.01644128);
