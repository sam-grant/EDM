...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-54.51549);
   Graph_Graph01031->SetMaximum(52.63305);
   ...
   mainFit1032->SetChisquare(1.634137);
   ...
   mainFit1032->SetParameter(0,-1.849335);
   mainFit1032->SetParError(0,0.6144136);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8792746);
   mainFit1032->SetParError(1,0.01824391);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.545");
   pt_LaTex = pt->AddText("0.879#pm0.0182");
   pt_LaTex = pt->AddText("#minus1.85#pm0.614");
   pt_LaTex = pt->AddText(" #minus2.1#pm0.689");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.103251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.103251,-54.51549,2.103251,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.634137);
   ...
   mainFit1033->SetParameter(0,-1.849335);
   mainFit1033->SetParError(0,0.6144136);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8792746);
   mainFit1033->SetParError(1,0.01824391);
