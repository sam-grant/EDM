...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-54.51549);
   Graph_Graph01029->SetMaximum(52.63305);
   ...
   mainFit1030->SetChisquare(2.285003);
   ...
   mainFit1030->SetParameter(0,-1.539239);
   mainFit1030->SetParError(0,0.5797209);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8756478);
   mainFit1030->SetParError(1,0.01768153);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.762");
   pt_LaTex = pt->AddText("0.876#pm0.0177");
   pt_LaTex = pt->AddText("#minus1.54#pm 0.58");
   pt_LaTex = pt->AddText("#minus1.76#pm0.659");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.757829,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.757829,-54.51549,1.757829,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.285003);
   ...
   mainFit1031->SetParameter(0,-1.539239);
   mainFit1031->SetParError(0,0.5797209);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8756478);
   mainFit1031->SetParError(1,0.01768153);
