...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-63.40177,50,43.49021);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-52.71258);
   Graph_Graph01025->SetMaximum(32.80101);
   ...
   mainFit1026->SetChisquare(2.311722);
   ...
   mainFit1026->SetParameter(0,-1.629882);
   mainFit1026->SetParError(0,0.5751421);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.872856);
   mainFit1026->SetParError(1,0.02277235);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.771");
   pt_LaTex = pt->AddText("0.873#pm0.0228");
   pt_LaTex = pt->AddText("#minus1.63#pm0.575");
   pt_LaTex = pt->AddText("#minus1.87#pm0.667");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.867298,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.867298,-52.71258,1.867298,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.311722);
   ...
   mainFit1027->SetParameter(0,-1.629882);
   mainFit1027->SetParError(0,0.5751421);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.872856);
   mainFit1027->SetParError(1,0.02277235);
