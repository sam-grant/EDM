...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-67.90906,75,66.02662);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-54.51549);
   Graph_Graph01033->SetMaximum(52.63305);
   ...
   mainFit1034->SetChisquare(0.5052197);
   ...
   mainFit1034->SetParameter(0,-1.046694);
   mainFit1034->SetParError(0,0.6686856);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8573851);
   mainFit1034->SetParError(1,0.02204948);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.168");
   pt_LaTex = pt->AddText("0.857#pm0.022");
   pt_LaTex = pt->AddText("#minus1.05#pm0.669");
   pt_LaTex = pt->AddText("#minus1.22#pm0.766");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.220798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.220798,-54.51549,1.220798,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.5052197);
   ...
   mainFit1035->SetParameter(0,-1.046694);
   mainFit1035->SetParError(0,0.6686856);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8573851);
   mainFit1035->SetParError(1,0.02204948);
