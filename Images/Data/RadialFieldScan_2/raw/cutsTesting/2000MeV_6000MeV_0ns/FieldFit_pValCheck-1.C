...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-54.51549);
   Graph_Graph01023->SetMaximum(52.63305);
   ...
   mainFit1024->SetChisquare(2.34114);
   ...
   mainFit1024->SetParameter(0,-1.592982);
   mainFit1024->SetParError(0,0.5334536);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8753204);
   mainFit1024->SetParError(1,0.0176299);
   ...
   mainFit1025->SetChisquare(2.34114);
   ...
   mainFit1025->SetParameter(0,-1.592982);
   mainFit1025->SetParError(0,0.5334536);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8753204);
   mainFit1025->SetParError(1,0.0176299);
