...
//=========  (Thu Apr 22 09:33:23 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-54.51549);
   Graph_Graph01027->SetMaximum(52.63305);
   ...
   mainFit1028->SetChisquare(2.323417);
   ...
   mainFit1028->SetParameter(0,-1.557279);
   mainFit1028->SetParError(0,0.5971835);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8764945);
   mainFit1028->SetParError(1,0.01968935);
   ...
   pt_LaTex = pt->AddText("0.876#pm0.0197");
   pt_LaTex = pt->AddText("#minus1.56#pm0.597");
   pt_LaTex = pt->AddText("#minus1.78#pm0.685");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.776713,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.776713,-54.51549,1.776713,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.323417);
   ...
   mainFit1029->SetParameter(0,-1.557279);
   mainFit1029->SetParError(0,0.5971835);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8764945);
   mainFit1029->SetParError(1,0.01968935);
