...
//=========  (Wed Apr 21 20:38:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01881025);
   Graph_Graph11015->SetMaximum(0.05917883);
   ...
   Graph_Graph21016->SetMinimum(-0.0138216);
   Graph_Graph21016->SetMaximum(0.0163062);
   ...
   Graph_Graph31017->SetMinimum(-0.05551122);
   Graph_Graph31017->SetMaximum(0.04873552);
   ...
   Graph_Graph41018->SetMinimum(-0.01853604);
   Graph_Graph41018->SetMaximum(0.0327035);
   ...
   Graph_Graph51019->SetMinimum(-0.0002965955);
   Graph_Graph51019->SetMaximum(0.0002219109);
