...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.02408,50,42.92637);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.42903);
   Graph_Graph01025->SetMaximum(31.33133);
   ...
   mainFit1026->SetChisquare(7.263793);
   ...
   mainFit1026->SetParameter(0,-1.046525);
   mainFit1026->SetParError(0,0.9479393);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7926155);
   mainFit1026->SetParError(1,0.03753835);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 2.42");
   pt_LaTex = pt->AddText("0.793#pm0.0375");
   pt_LaTex = pt->AddText("#minus1.05#pm0.948");
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.320344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.320344,-61.42903,1.320344,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(7.263793);
   ...
   mainFit1027->SetParameter(0,-1.046525);
   mainFit1027->SetParError(0,0.9479393);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7926155);
   mainFit1027->SetParError(1,0.03753835);
