...
//=========  (Wed Apr 21 20:38:58 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.506514);
   ...
   quadLineFit1002->SetParameter(0,74.66001);
   quadLineFit1002->SetParError(0,0.1342401);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.80999);
   quadLineFit1002->SetParError(1,2.251842);
   ...
   quadLineFit1003->SetChisquare(2.506514);
   ...
   quadLineFit1003->SetParameter(0,74.66001);
   quadLineFit1003->SetParError(0,0.1342401);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.80999);
   quadLineFit1003->SetParError(1,2.251842);
   ...
   Graph_30_ppm1003->SetMinimum(75.63199);
   Graph_30_ppm1003->SetMaximum(76.21473);
   ...
   quadLineFit1004->SetChisquare(2.289519);
   ...
   quadLineFit1004->SetParameter(0,74.59737);
   quadLineFit1004->SetParError(0,0.1128503);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.74653);
   quadLineFit1004->SetParError(1,1.854769);
   ...
   quadLineFit1005->SetChisquare(2.289519);
   ...
   quadLineFit1005->SetParameter(0,74.59737);
   quadLineFit1005->SetParError(0,0.1128503);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.74653);
   quadLineFit1005->SetParError(1,1.854769);
   ...
   Graph_10_ppm1005->SetMinimum(74.74299);
   Graph_10_ppm1005->SetMaximum(74.9777);
   ...
   quadLineFit1006->SetChisquare(0.517319);
   ...
   quadLineFit1006->SetParameter(0,74.45635);
   quadLineFit1006->SetParError(0,0.1322825);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,6.369974);
   quadLineFit1006->SetParError(1,2.145364);
   ...
   quadLineFit1007->SetChisquare(0.517319);
   ...
   quadLineFit1007->SetParameter(0,74.45635);
   quadLineFit1007->SetParError(0,0.1322825);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,6.369974);
   quadLineFit1007->SetParError(1,2.145364);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.60867);
   Graph_mI10_ppm1007->SetMaximum(73.89621);
   ...
   quadLineFit1008->SetChisquare(5.457782);
   ...
   quadLineFit1008->SetParameter(0,74.18242);
   quadLineFit1008->SetParError(0,0.1160594);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-7.170995);
   quadLineFit1008->SetParError(1,1.889135);
   ...
   quadLineFit1009->SetChisquare(5.457782);
   ...
   quadLineFit1009->SetParameter(0,74.18242);
   quadLineFit1009->SetParError(0,0.1160594);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-7.170995);
   quadLineFit1009->SetParError(1,1.889135);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.35648);
   Graph_mI30_ppm1009->SetMaximum(72.99597);
   ...
   quadLineFit1010->SetChisquare(0.8791155);
   ...
   quadLineFit1010->SetParameter(0,74.11079);
   quadLineFit1010->SetParError(0,0.1097522);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-23.13322);
   quadLineFit1010->SetParError(1,1.899456);
   ...
   quadLineFit1011->SetChisquare(0.8791155);
   ...
   quadLineFit1011->SetParameter(0,74.11079);
   quadLineFit1011->SetParError(0,0.1097522);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-23.13322);
   quadLineFit1011->SetParError(1,1.899456);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.39866);
   Graph_mI50_ppm1011->SetMaximum(72.14335);
   ...
   quadLineFit1012->SetChisquare(0.000152912);
   ...
   quadLineFit1012->SetParameter(0,74.6033);
   quadLineFit1012->SetParError(0,0.2215068);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-49.73528);
   quadLineFit1012->SetParError(1,3.963716);
   ...
   quadLineFit1013->SetChisquare(0.000152912);
   ...
   quadLineFit1013->SetParameter(0,74.6033);
   quadLineFit1013->SetParError(0,0.2215068);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-49.73528);
   quadLineFit1013->SetParError(1,3.963716);
