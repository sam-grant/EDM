...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-63.17508);
   Graph_Graph01023->SetMaximum(50.53792);
   ...
   mainFit1024->SetChisquare(7.268894);
   ...
   mainFit1024->SetParameter(0,-1.021195);
   mainFit1024->SetParError(0,0.879824);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7943115);
   mainFit1024->SetParError(1,0.02909207);
   ...
   mainFit1025->SetChisquare(7.268894);
   ...
   mainFit1025->SetParameter(0,-1.021195);
   mainFit1025->SetParError(0,0.879824);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7943115);
   mainFit1025->SetParError(1,0.02909207);
