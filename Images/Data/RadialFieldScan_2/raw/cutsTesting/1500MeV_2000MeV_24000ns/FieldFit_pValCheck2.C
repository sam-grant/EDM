...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-63.17508);
   Graph_Graph01029->SetMaximum(50.53792);
   ...
   mainFit1030->SetChisquare(7.189251);
   ...
   mainFit1030->SetParameter(0,-0.915511);
   mainFit1030->SetParError(0,0.9562817);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7949508);
   mainFit1030->SetParError(1,0.02917673);
   ...
   pt_LaTex = pt->AddText("0.795#pm0.0292");
   pt_LaTex = pt->AddText("#minus0.916#pm0.956");
   pt_LaTex = pt->AddText("#minus1.15#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.151657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.151657,-63.17508,1.151657,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(7.189251);
   ...
   mainFit1031->SetParameter(0,-0.915511);
   mainFit1031->SetParError(0,0.9562817);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7949508);
   mainFit1031->SetParError(1,0.02917673);
