...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-63.17508);
   Graph_Graph01031->SetMaximum(50.53792);
   ...
   mainFit1032->SetChisquare(6.044769);
   ...
   mainFit1032->SetParameter(0,-1.577705);
   mainFit1032->SetParError(0,1.013429);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8029128);
   mainFit1032->SetParError(1,0.03010974);
   ...
   pt_LaTex = pt->AddText("0.803#pm0.0301");
   pt_LaTex = pt->AddText("#minus1.58#pm 1.01");
   pt_LaTex = pt->AddText("#minus1.96#pm 1.24");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.964977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.964977,-63.17508,1.964977,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(6.044769);
   ...
   mainFit1033->SetParameter(0,-1.577705);
   mainFit1033->SetParError(0,1.013429);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8029128);
   mainFit1033->SetParError(1,0.03010974);
