...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-41.5563,70,57.58546);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-31.64212);
   Graph_Graph01035->SetMaximum(47.67129);
   ...
   mainFit1036->SetChisquare(0.7446901);
   ...
   mainFit1036->SetParameter(0,-0.3106386);
   mainFit1036->SetParError(0,0.9227633);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7606545);
   mainFit1036->SetParError(1,0.03193928);
   ...
   pt_LaTex = pt->AddText("0.761#pm0.0319");
   pt_LaTex = pt->AddText("#minus0.311#pm0.923");
   pt_LaTex = pt->AddText("#minus0.408#pm 1.21");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.4083833,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.4083833,-31.64212,0.4083833,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(0.7446901);
   ...
   mainFit1037->SetParameter(0,-0.3106386);
   mainFit1037->SetParError(0,0.9227633);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7606545);
   mainFit1037->SetParError(1,0.03193928);
