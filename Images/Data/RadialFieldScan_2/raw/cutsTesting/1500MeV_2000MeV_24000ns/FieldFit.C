...
//=========  (Wed Apr 21 20:38:58 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-63.17508);
   Graph_Graph01020->SetMaximum(50.53792);
   ...
   mainFit1021->SetChisquare(7.268894);
   ...
   mainFit1021->SetParameter(0,-1.021195);
   mainFit1021->SetParError(0,0.879824);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7943115);
   mainFit1021->SetParError(1,0.02909207);
   ...
   pt_LaTex = pt->AddText("0.794#pm0.0291");
   pt_LaTex = pt->AddText("#minus1.02#pm 0.88");
   pt_LaTex = pt->AddText("#minus1.29#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.285635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.285635,-63.17508,1.285635,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(7.268894);
   ...
   mainFit1022->SetParameter(0,-1.021195);
   mainFit1022->SetParError(0,0.879824);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7943115);
   mainFit1022->SetParError(1,0.02909207);
