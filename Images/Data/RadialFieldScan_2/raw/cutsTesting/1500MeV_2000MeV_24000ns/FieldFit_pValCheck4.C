...
//=========  (Wed Apr 21 20:38:59 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-63.17508);
   Graph_Graph01033->SetMaximum(50.53792);
   ...
   mainFit1034->SetChisquare(5.652024);
   ...
   mainFit1034->SetParameter(0,-1.866175);
   mainFit1034->SetParError(0,1.102551);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8221007);
   mainFit1034->SetParError(1,0.03637995);
   ...
   pt_LaTex = pt->AddText("0.822#pm0.0364");
   pt_LaTex = pt->AddText("#minus1.87#pm  1.1");
   pt_LaTex = pt->AddText("#minus2.27#pm  1.3");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.270007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.270007,-63.17508,2.270007,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.652024);
   ...
   mainFit1035->SetParameter(0,-1.866175);
   mainFit1035->SetParError(0,1.102551);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8221007);
   mainFit1035->SetParError(1,0.03637995);
