...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(2.096917);
   ...
   quadLineFit1002->SetParameter(0,74.0899);
   quadLineFit1002->SetParError(0,0.1282625);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,49.9095);
   quadLineFit1002->SetParError(1,2.151253);
   ...
   quadLineFit1003->SetChisquare(2.096917);
   ...
   quadLineFit1003->SetParameter(0,74.0899);
   quadLineFit1003->SetParError(0,0.1282625);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,49.9095);
   quadLineFit1003->SetParError(1,2.151253);
   ...
   Graph_30_ppm1003->SetMinimum(75.55469);
   Graph_30_ppm1003->SetMaximum(76.2354);
   ...
   quadLineFit1004->SetChisquare(2.210127);
   ...
   quadLineFit1004->SetParameter(0,74.35266);
   quadLineFit1004->SetParError(0,0.1095132);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.38368);
   quadLineFit1004->SetParError(1,1.799804);
   ...
   quadLineFit1005->SetChisquare(2.210127);
   ...
   quadLineFit1005->SetParameter(0,74.35266);
   quadLineFit1005->SetParError(0,0.1095132);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.38368);
   quadLineFit1005->SetParError(1,1.799804);
   ...
   Graph_10_ppm1005->SetMinimum(74.57182);
   Graph_10_ppm1005->SetMaximum(74.919);
   ...
   quadLineFit1006->SetChisquare(2.680381);
   ...
   quadLineFit1006->SetParameter(0,74.05681);
   quadLineFit1006->SetParError(0,0.1280333);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,10.79097);
   quadLineFit1006->SetParError(1,2.076699);
   ...
   quadLineFit1007->SetChisquare(2.680381);
   ...
   quadLineFit1007->SetParameter(0,74.05681);
   quadLineFit1007->SetParError(0,0.1280333);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,10.79097);
   quadLineFit1007->SetParError(1,2.076699);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.32586);
   Graph_mI10_ppm1007->SetMaximum(73.62959);
   ...
   quadLineFit1008->SetChisquare(0.8310883);
   ...
   quadLineFit1008->SetParameter(0,74.12257);
   quadLineFit1008->SetParError(0,0.1125716);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.45838);
   quadLineFit1008->SetParError(1,1.832497);
   ...
   quadLineFit1009->SetChisquare(0.8310883);
   ...
   quadLineFit1009->SetParameter(0,74.12257);
   quadLineFit1009->SetParError(0,0.1125716);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.45838);
   quadLineFit1009->SetParError(1,1.832497);
   ...
   Graph_mI30_ppm1009->SetMinimum(71.84003);
   Graph_mI30_ppm1009->SetMaximum(72.62738);
   ...
   quadLineFit1010->SetChisquare(7.264624);
   ...
   quadLineFit1010->SetParameter(0,74.07364);
   quadLineFit1010->SetParError(0,0.1068406);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.34617);
   quadLineFit1010->SetParError(1,1.849153);
   ...
   quadLineFit1011->SetChisquare(7.264624);
   ...
   quadLineFit1011->SetParameter(0,74.07364);
   quadLineFit1011->SetParError(0,0.1068406);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.34617);
   quadLineFit1011->SetParError(1,1.849153);
   ...
   Graph_mI50_ppm1011->SetMinimum(70.88618);
   Graph_mI50_ppm1011->SetMaximum(71.63858);
   ...
   quadLineFit1012->SetChisquare(1.100683);
   ...
   quadLineFit1012->SetParameter(0,74.15867);
   quadLineFit1012->SetParError(0,0.2144028);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-50.61379);
   quadLineFit1012->SetParError(1,3.836136);
   ...
   quadLineFit1013->SetChisquare(1.100683);
   ...
   quadLineFit1013->SetParameter(0,74.15867);
   quadLineFit1013->SetParError(0,0.2144028);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-50.61379);
   quadLineFit1013->SetParError(1,3.836136);
