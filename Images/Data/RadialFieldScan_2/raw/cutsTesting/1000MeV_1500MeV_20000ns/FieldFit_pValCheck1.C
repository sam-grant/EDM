...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-65.101);
   Graph_Graph01027->SetMaximum(62.71182);
   ...
   mainFit1028->SetChisquare(0.3305613);
   ...
   mainFit1028->SetParameter(0,0.1578993);
   mainFit1028->SetParError(0,0.9525312);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9989187);
   mainFit1028->SetParError(1,0.03127218);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.11");
   pt_LaTex = pt->AddText("0.999#pm0.0313");
   pt_LaTex = pt->AddText("0.158#pm0.953");
   pt_LaTex = pt->AddText("0.158#pm0.953");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1580702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1580702,-65.101,-0.1580702,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3305613);
   ...
   mainFit1029->SetParameter(0,0.1578993);
   mainFit1029->SetParError(0,0.9525312);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9989187);
   mainFit1029->SetParError(1,0.03127218);
