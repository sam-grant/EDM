...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-65.101);
   Graph_Graph01020->SetMaximum(62.71182);
   ...
   mainFit1021->SetChisquare(4.709873);
   ...
   mainFit1021->SetParameter(0,-0.7296961);
   mainFit1021->SetParError(0,0.8528883);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.9701684);
   mainFit1021->SetParError(1,0.02809274);
   ...
   pt_LaTex = pt->AddText(" 0.97#pm0.0281");
   pt_LaTex = pt->AddText("#minus0.73#pm0.853");
   pt_LaTex = pt->AddText("#minus0.752#pm0.876");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7521334,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7521334,-65.101,0.7521334,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.709873);
   ...
   mainFit1022->SetParameter(0,-0.7296961);
   mainFit1022->SetParError(0,0.8528883);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.9701684);
   mainFit1022->SetParError(1,0.02809274);
