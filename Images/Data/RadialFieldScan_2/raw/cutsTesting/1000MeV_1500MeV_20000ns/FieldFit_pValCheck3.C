...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-81.0776,75,78.68842);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-65.101);
   Graph_Graph01031->SetMaximum(62.71182);
   ...
   mainFit1032->SetChisquare(4.709577);
   ...
   mainFit1032->SetParameter(0,-0.7213054);
   mainFit1032->SetParError(0,0.9828415);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.970038);
   mainFit1032->SetParError(1,0.02909944);
   ...
   pt_LaTex = pt->AddText(" 0.97#pm0.0291");
   pt_LaTex = pt->AddText("#minus0.721#pm0.983");
   pt_LaTex = pt->AddText("#minus0.744#pm 1.01");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7435847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7435847,-65.101,0.7435847,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(4.709577);
   ...
   mainFit1033->SetParameter(0,-0.7213054);
   mainFit1033->SetParError(0,0.9828415);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.970038);
   mainFit1033->SetParError(1,0.02909944);
