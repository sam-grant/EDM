...
//=========  (Thu Apr 22 00:25:33 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-52.00934,70,72.87477);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-39.52093);
   Graph_Graph01035->SetMaximum(60.38636);
   ...
   mainFit1036->SetChisquare(4.546895);
   ...
   mainFit1036->SetParameter(0,-0.6196132);
   mainFit1036->SetParError(0,0.8954182);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.9650154);
   mainFit1036->SetParError(1,0.03085655);
   ...
   pt_LaTex = pt->AddText("0.965#pm0.0309");
   pt_LaTex = pt->AddText("#minus0.62#pm0.895");
   pt_LaTex = pt->AddText("#minus0.642#pm0.923");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.6420759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6420759,-39.52093,0.6420759,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.546895);
   ...
   mainFit1037->SetParameter(0,-0.6196132);
   mainFit1037->SetParError(0,0.8954182);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.9650154);
   mainFit1037->SetParError(1,0.03085655);
