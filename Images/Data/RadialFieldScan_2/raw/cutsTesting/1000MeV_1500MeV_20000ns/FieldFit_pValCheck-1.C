...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-65.101);
   Graph_Graph01023->SetMaximum(62.71182);
   ...
   mainFit1024->SetChisquare(4.709873);
   ...
   mainFit1024->SetParameter(0,-0.7296961);
   mainFit1024->SetParError(0,0.8528883);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9701684);
   mainFit1024->SetParError(1,0.02809274);
   ...
   mainFit1025->SetChisquare(4.709873);
   ...
   mainFit1025->SetParameter(0,-0.7296961);
   mainFit1025->SetParError(0,0.8528883);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9701684);
   mainFit1025->SetParError(1,0.02809274);
