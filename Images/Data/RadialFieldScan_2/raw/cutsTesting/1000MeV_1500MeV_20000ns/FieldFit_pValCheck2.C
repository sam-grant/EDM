...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-65.101);
   Graph_Graph01029->SetMaximum(62.71182);
   ...
   mainFit1030->SetChisquare(3.787472);
   ...
   mainFit1030->SetParameter(0,-1.078095);
   mainFit1030->SetParError(0,0.9268324);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9682104);
   mainFit1030->SetParError(1,0.02816644);
   ...
   pt_LaTex = pt->AddText("0.968#pm0.0282");
   pt_LaTex = pt->AddText("#minus1.08#pm0.927");
   pt_LaTex = pt->AddText("#minus1.11#pm0.954");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.113493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.113493,-65.101,1.113493,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.787472);
   ...
   mainFit1031->SetParameter(0,-1.078095);
   mainFit1031->SetParError(0,0.9268324);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9682104);
   mainFit1031->SetParError(1,0.02816644);
