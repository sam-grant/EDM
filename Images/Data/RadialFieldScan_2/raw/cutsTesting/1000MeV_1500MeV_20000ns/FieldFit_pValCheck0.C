...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-74.85828,50,47.59184);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-62.61327);
   Graph_Graph01025->SetMaximum(35.34682);
   ...
   mainFit1026->SetChisquare(2.762143);
   ...
   mainFit1026->SetParameter(0,-1.210256);
   mainFit1026->SetParError(0,0.9197544);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9377709);
   mainFit1026->SetParError(1,0.03643551);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.921");
   pt_LaTex = pt->AddText("0.938#pm0.0364");
   pt_LaTex = pt->AddText("#minus1.21#pm 0.92");
   pt_LaTex = pt->AddText("#minus1.29#pm0.988");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.290566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.290566,-62.61327,1.290566,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.762143);
   ...
   mainFit1027->SetParameter(0,-1.210256);
   mainFit1027->SetParError(0,0.9197544);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9377709);
   mainFit1027->SetParError(1,0.03643551);
