...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01967102);
   Graph_Graph11015->SetMaximum(0.05589716);
   ...
   Graph_Graph21016->SetMinimum(-0.03051367);
   Graph_Graph21016->SetMaximum(0.03602228);
   ...
   Graph_Graph31017->SetMinimum(-0.01624188);
   Graph_Graph31017->SetMaximum(0.02232281);
   ...
   Graph_Graph41018->SetMinimum(-0.04681727);
   Graph_Graph41018->SetMaximum(0.05265319);
   ...
   Graph_Graph51019->SetMinimum(-0.01826851);
   Graph_Graph51019->SetMaximum(0.02445515);
