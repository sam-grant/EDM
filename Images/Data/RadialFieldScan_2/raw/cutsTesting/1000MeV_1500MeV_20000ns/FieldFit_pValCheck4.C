...
//=========  (Thu Apr 22 00:25:32 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-65.101);
   Graph_Graph01033->SetMaximum(62.71182);
   ...
   mainFit1034->SetChisquare(4.572646);
   ...
   mainFit1034->SetParameter(0,-0.9680091);
   mainFit1034->SetParError(0,1.068308);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9779517);
   mainFit1034->SetParError(1,0.03508082);
   ...
   pt_LaTex = pt->AddText("0.978#pm0.0351");
   pt_LaTex = pt->AddText("#minus0.968#pm 1.07");
   pt_LaTex = pt->AddText("#minus0.99#pm 1.08");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9898332,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9898332,-65.101,0.9898332,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(4.572646);
   ...
   mainFit1035->SetParameter(0,-0.9680091);
   mainFit1035->SetParError(0,1.068308);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9779517);
   mainFit1035->SetParError(1,0.03508082);
