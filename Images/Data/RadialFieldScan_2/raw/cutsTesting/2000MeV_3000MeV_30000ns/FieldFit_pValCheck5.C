...
//=========  (Fri Apr 23 19:16:09 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-39.80411,70,56.76458);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.14724);
   Graph_Graph01035->SetMaximum(47.10771);
   ...
   mainFit1036->SetChisquare(2.621986);
   ...
   mainFit1036->SetParameter(0,-0.1195334);
   mainFit1036->SetParError(0,0.8222399);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7446602);
   mainFit1036->SetParError(1,0.02843998);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.874");
   pt_LaTex = pt->AddText("0.745#pm0.0284");
   pt_LaTex = pt->AddText("#minus0.12#pm0.822");
   pt_LaTex = pt->AddText("#minus0.161#pm  1.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.1605207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.1605207,-30.14724,0.1605207,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.621986);
   ...
   mainFit1037->SetParameter(0,-0.1195334);
   mainFit1037->SetParError(0,0.8222399);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7446602);
   mainFit1037->SetParError(1,0.02843998);
