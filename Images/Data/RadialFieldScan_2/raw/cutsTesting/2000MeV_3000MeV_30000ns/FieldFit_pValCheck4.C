...
//=========  (Fri Apr 23 19:16:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-44.06168);
   Graph_Graph01033->SetMaximum(48.37266);
   ...
   mainFit1034->SetChisquare(3.879212);
   ...
   mainFit1034->SetParameter(0,0.280805);
   mainFit1034->SetParError(0,0.9823936);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7274325);
   mainFit1034->SetParError(1,0.03239473);
   ...
   pt_LaTex = pt->AddText("0.727#pm0.0324");
   pt_LaTex = pt->AddText("0.281#pm0.982");
   pt_LaTex = pt->AddText("0.386#pm 1.36");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.3860221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.3860221,-44.06168,-0.3860221,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(3.879212);
   ...
   mainFit1035->SetParameter(0,0.280805);
   mainFit1035->SetParError(0,0.9823936);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7274325);
   mainFit1035->SetParError(1,0.03239473);
