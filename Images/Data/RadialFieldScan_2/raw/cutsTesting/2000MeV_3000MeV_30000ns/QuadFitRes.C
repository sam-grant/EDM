...
//=========  (Fri Apr 23 19:16:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.0174712);
   Graph_Graph11015->SetMaximum(0.01847849);
   ...
   Graph_Graph21016->SetMinimum(-0.004483629);
   Graph_Graph21016->SetMaximum(0.005274734);
   ...
   Graph_Graph31017->SetMinimum(-0.03843991);
   Graph_Graph31017->SetMaximum(0.02914601);
   ...
   Graph_Graph41018->SetMinimum(-0.02582681);
   Graph_Graph41018->SetMaximum(0.01316731);
   ...
   Graph_Graph51019->SetMinimum(-0.01095146);
   Graph_Graph51019->SetMaximum(0.01464199);
