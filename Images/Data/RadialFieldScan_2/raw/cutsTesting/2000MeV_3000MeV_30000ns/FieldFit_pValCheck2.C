...
//=========  (Fri Apr 23 19:16:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-44.06168);
   Graph_Graph01029->SetMaximum(48.37266);
   ...
   mainFit1030->SetChisquare(3.437426);
   ...
   mainFit1030->SetParameter(0,-0.06846658);
   mainFit1030->SetParError(0,0.8520031);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.7299384);
   mainFit1030->SetParError(1,0.02598023);
   ...
   pt_LaTex = pt->AddText(" 0.73#pm0.026");
   pt_LaTex = pt->AddText("#minus0.0685#pm0.852");
   pt_LaTex = pt->AddText("#minus0.0938#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.09379774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.09379774,-44.06168,0.09379774,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.437426);
   ...
   mainFit1031->SetParameter(0,-0.06846658);
   mainFit1031->SetParError(0,0.8520031);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7299384);
   mainFit1031->SetParError(1,0.02598023);
