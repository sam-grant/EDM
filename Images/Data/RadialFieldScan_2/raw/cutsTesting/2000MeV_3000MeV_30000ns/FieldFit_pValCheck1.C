...
//=========  (Fri Apr 23 19:16:09 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-55.61597,75,59.92695);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-44.06168);
   Graph_Graph01027->SetMaximum(48.37266);
   ...
   mainFit1028->SetChisquare(2.090882);
   ...
   mainFit1028->SetParameter(0,0.6961835);
   mainFit1028->SetParError(0,0.877462);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7487075);
   mainFit1028->SetParError(1,0.02893031);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.697");
   pt_LaTex = pt->AddText("0.749#pm0.0289");
   pt_LaTex = pt->AddText("0.696#pm0.877");
   pt_LaTex = pt->AddText(" 0.93#pm 1.17");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.9298471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.9298471,-44.06168,-0.9298471,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.090882);
   ...
   mainFit1029->SetParameter(0,0.6961835);
   mainFit1029->SetParError(0,0.877462);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7487075);
   mainFit1029->SetParError(1,0.02893031);
