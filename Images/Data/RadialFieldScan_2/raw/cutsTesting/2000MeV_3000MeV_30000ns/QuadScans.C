...
//=========  (Fri Apr 23 19:16:08 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8769865);
   ...
   quadLineFit1002->SetParameter(0,75.13006);
   quadLineFit1002->SetParError(0,0.1193289);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,38.66848);
   quadLineFit1002->SetParError(1,2.001316);
   ...
   quadLineFit1003->SetChisquare(0.8769865);
   ...
   quadLineFit1003->SetParameter(0,75.13006);
   quadLineFit1003->SetParError(0,0.1193289);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,38.66848);
   quadLineFit1003->SetParError(1,2.001316);
   ...
   Graph_30_ppm1003->SetMinimum(76.18164);
   Graph_30_ppm1003->SetMaximum(76.71944);
   ...
   quadLineFit1004->SetChisquare(0.7421246);
   ...
   quadLineFit1004->SetParameter(0,75.19582);
   quadLineFit1004->SetParError(0,0.1004881);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,20.33519);
   quadLineFit1004->SetParError(1,1.651695);
   ...
   quadLineFit1005->SetChisquare(0.7421246);
   ...
   quadLineFit1005->SetParameter(0,75.19582);
   quadLineFit1005->SetParError(0,0.1004881);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,20.33519);
   quadLineFit1005->SetParError(1,1.651695);
   ...
   Graph_10_ppm1005->SetMinimum(75.24962);
   Graph_10_ppm1005->SetMaximum(75.52779);
   ...
   quadLineFit1006->SetChisquare(0.06839796);
   ...
   quadLineFit1006->SetParameter(0,74.85046);
   quadLineFit1006->SetParError(0,0.1177896);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.684395);
   quadLineFit1006->SetParError(1,1.910223);
   ...
   quadLineFit1007->SetChisquare(0.06839796);
   ...
   quadLineFit1007->SetParameter(0,74.85046);
   quadLineFit1007->SetParError(0,0.1177896);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.684395);
   quadLineFit1007->SetParError(1,1.910223);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.2409);
   Graph_mI10_ppm1007->SetMaximum(74.53286);
   ...
   quadLineFit1008->SetChisquare(3.072105);
   ...
   quadLineFit1008->SetParameter(0,74.88024);
   quadLineFit1008->SetParError(0,0.1034328);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.200743);
   quadLineFit1008->SetParError(1,1.683388);
   ...
   quadLineFit1009->SetChisquare(3.072105);
   ...
   quadLineFit1009->SetParameter(0,74.88024);
   quadLineFit1009->SetParError(0,0.1034328);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.200743);
   quadLineFit1009->SetParError(1,1.683388);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.03271);
   Graph_mI30_ppm1009->SetMaximum(73.61221);
   ...
   quadLineFit1010->SetChisquare(0.7993298);
   ...
   quadLineFit1010->SetParameter(0,74.67551);
   quadLineFit1010->SetParError(0,0.09787784);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-22.0154);
   quadLineFit1010->SetParError(1,1.69393);
   ...
   quadLineFit1011->SetChisquare(0.7993298);
   ...
   quadLineFit1011->SetParameter(0,74.67551);
   quadLineFit1011->SetParError(0,0.09787784);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-22.0154);
   quadLineFit1011->SetParError(1,1.69393);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.20963);
   Graph_mI50_ppm1011->SetMaximum(72.7174);
   ...
   quadLineFit1012->SetChisquare(0.4665894);
   ...
   quadLineFit1012->SetParameter(0,74.3419);
   quadLineFit1012->SetParError(0,0.1975567);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-32.82431);
   quadLineFit1012->SetParError(1,3.534504);
   ...
   quadLineFit1013->SetChisquare(0.4665894);
   ...
   quadLineFit1013->SetParameter(0,74.3419);
   quadLineFit1013->SetParError(0,0.1975567);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-32.82431);
   quadLineFit1013->SetParError(1,3.534504);
