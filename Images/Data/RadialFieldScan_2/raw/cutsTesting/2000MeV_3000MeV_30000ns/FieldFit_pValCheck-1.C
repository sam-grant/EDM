...
//=========  (Fri Apr 23 19:16:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-44.06168);
   Graph_Graph01023->SetMaximum(48.37266);
   ...
   mainFit1024->SetChisquare(3.91872);
   ...
   mainFit1024->SetParameter(0,0.1631087);
   mainFit1024->SetParError(0,0.783883);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7312983);
   mainFit1024->SetParError(1,0.02590654);
   ...
   mainFit1025->SetChisquare(3.91872);
   ...
   mainFit1025->SetParameter(0,0.1631087);
   mainFit1025->SetParError(0,0.783883);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7312983);
   mainFit1025->SetParError(1,0.02590654);
