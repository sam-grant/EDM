...
//=========  (Fri Apr 23 19:16:09 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-44.06168);
   Graph_Graph01031->SetMaximum(48.37266);
   ...
   mainFit1032->SetChisquare(3.389344);
   ...
   mainFit1032->SetParameter(0,0.4893033);
   mainFit1032->SetParError(0,0.9030334);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7262521);
   mainFit1032->SetParError(1,0.02681888);
   ...
   pt_LaTex = pt->AddText("0.726#pm0.0268");
   pt_LaTex = pt->AddText("0.489#pm0.903");
   pt_LaTex = pt->AddText("0.674#pm 1.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.6737375,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.6737375,-44.06168,-0.6737375,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.389344);
   ...
   mainFit1033->SetParameter(0,0.4893033);
   mainFit1033->SetParError(0,0.9030334);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7262521);
   mainFit1033->SetParError(1,0.02681888);
