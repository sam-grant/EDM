...
//=========  (Fri Apr 23 19:16:08 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-50.94524,50,36.5733);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-42.19339);
   Graph_Graph01025->SetMaximum(27.82145);
   ...
   mainFit1026->SetChisquare(2.076128);
   ...
   mainFit1026->SetParameter(0,-0.2634339);
   mainFit1026->SetParError(0,0.8445142);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7025674);
   mainFit1026->SetParError(1,0.03345121);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.692");
   pt_LaTex = pt->AddText("0.703#pm0.0335");
   pt_LaTex = pt->AddText("#minus0.263#pm0.845");
   pt_LaTex = pt->AddText("#minus0.375#pm  1.2");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.3749589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3749589,-42.19339,0.3749589,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.076128);
   ...
   mainFit1027->SetParameter(0,-0.2634339);
   mainFit1027->SetParError(0,0.8445142);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7025674);
   mainFit1027->SetParError(1,0.03345121);
