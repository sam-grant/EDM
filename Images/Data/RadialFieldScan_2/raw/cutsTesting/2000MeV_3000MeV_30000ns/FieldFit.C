...
//=========  (Fri Apr 23 19:16:08 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-44.06168);
   Graph_Graph01020->SetMaximum(48.37266);
   ...
   mainFit1021->SetChisquare(3.91872);
   ...
   mainFit1021->SetParameter(0,0.1631087);
   mainFit1021->SetParError(0,0.783883);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7312983);
   mainFit1021->SetParError(1,0.02590654);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.98");
   pt_LaTex = pt->AddText("0.731#pm0.0259");
   pt_LaTex = pt->AddText("0.163#pm0.784");
   pt_LaTex = pt->AddText("0.223#pm 1.07");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.22304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.22304,-44.06168,-0.22304,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(3.91872);
   ...
   mainFit1022->SetParameter(0,0.1631087);
   mainFit1022->SetParError(0,0.783883);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7312983);
   mainFit1022->SetParError(1,0.02590654);
