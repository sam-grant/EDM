...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-56.40335);
   Graph_Graph01031->SetMaximum(52.63998);
   ...
   mainFit1032->SetChisquare(1.734169);
   ...
   mainFit1032->SetParameter(0,-1.397017);
   mainFit1032->SetParError(0,0.495614);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8843185);
   mainFit1032->SetParError(1,0.01472279);
   ...
   pt_LaTex = pt->AddText("0.884#pm0.0147");
   pt_LaTex = pt->AddText(" #minus1.4#pm0.496");
   pt_LaTex = pt->AddText("#minus1.58#pm0.554");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.579767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.579767,-56.40335,1.579767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.734169);
   ...
   mainFit1033->SetParameter(0,-1.397017);
   mainFit1033->SetParError(0,0.495614);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8843185);
   mainFit1033->SetParError(1,0.01472279);
