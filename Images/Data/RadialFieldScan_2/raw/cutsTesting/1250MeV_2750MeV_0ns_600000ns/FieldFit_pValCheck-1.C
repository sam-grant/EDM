...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-56.40335);
   Graph_Graph01023->SetMaximum(52.63998);
   ...
   mainFit1024->SetChisquare(2.022446);
   ...
   mainFit1024->SetParameter(0,-1.264989);
   mainFit1024->SetParError(0,0.4303084);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8822815);
   mainFit1024->SetParError(1,0.01422555);
   ...
   mainFit1025->SetChisquare(2.022446);
   ...
   mainFit1025->SetParameter(0,-1.264989);
   mainFit1025->SetParError(0,0.4303084);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8822815);
   mainFit1025->SetParError(1,0.01422555);
