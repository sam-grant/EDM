...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-65.59486,50,44.07587);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-54.62778);
   Graph_Graph01025->SetMaximum(33.1088);
   ...
   mainFit1026->SetChisquare(1.768095);
   ...
   mainFit1026->SetParameter(0,-1.177889);
   mainFit1026->SetParError(0,0.4636724);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8881348);
   mainFit1026->SetParError(1,0.01835942);
   ...
   pt_LaTex = pt->AddText("0.888#pm0.0184");
   pt_LaTex = pt->AddText("#minus1.18#pm0.464");
   pt_LaTex = pt->AddText("#minus1.33#pm0.526");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.32625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.32625,-54.62778,1.32625,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.768095);
   ...
   mainFit1027->SetParameter(0,-1.177889);
   mainFit1027->SetParError(0,0.4636724);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8881348);
   mainFit1027->SetParError(1,0.01835942);
