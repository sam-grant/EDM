...
//=========  (Tue Apr 27 00:09:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-47.54318,70,61.77228);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-36.61164);
   Graph_Graph01035->SetMaximum(50.84073);
   ...
   mainFit1036->SetChisquare(2.022443);
   ...
   mainFit1036->SetParameter(0,-1.265212);
   mainFit1036->SetParError(0,0.4512647);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.882292);
   mainFit1036->SetParError(1,0.0156145);
   ...
   pt_LaTex = pt->AddText("#minus1.27#pm0.451");
   pt_LaTex = pt->AddText("#minus1.43#pm0.505");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.434006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.434006,-36.61164,1.434006,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(2.022443);
   ...
   mainFit1037->SetParameter(0,-1.265212);
   mainFit1037->SetParError(0,0.4512647);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.882292);
   mainFit1037->SetParError(1,0.0156145);
