...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-56.40335);
   Graph_Graph01027->SetMaximum(52.63998);
   ...
   mainFit1028->SetChisquare(1.831919);
   ...
   mainFit1028->SetParameter(0,-1.17031);
   mainFit1028->SetParError(0,0.4818878);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8853754);
   mainFit1028->SetParError(1,0.01589418);
   ...
   pt_LaTex = pt->AddText("#minus1.17#pm0.482");
   pt_LaTex = pt->AddText("#minus1.32#pm0.546");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.321824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.321824,-56.40335,1.321824,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.831919);
   ...
   mainFit1029->SetParameter(0,-1.17031);
   mainFit1029->SetParError(0,0.4818878);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8853754);
   mainFit1029->SetParError(1,0.01589418);
