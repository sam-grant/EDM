...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-70.03376,75,66.2704);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01033->SetMinimum(-56.40335);
   Graph_Graph01033->SetMaximum(52.63998);
   ...
   mainFit1034->SetChisquare(1.015798);
   ...
   mainFit1034->SetParameter(0,-0.9385365);
   mainFit1034->SetParError(0,0.5394745);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8715536);
   mainFit1034->SetParError(1,0.01779591);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.339");
   pt_LaTex = pt->AddText("0.872#pm0.0178");
   pt_LaTex = pt->AddText("#minus0.939#pm0.539");
   pt_LaTex = pt->AddText("#minus1.08#pm0.609");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.076855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.076855,-56.40335,1.076855,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.015798);
   ...
   mainFit1035->SetParameter(0,-0.9385365);
   mainFit1035->SetParError(0,0.5394745);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8715536);
   mainFit1035->SetParError(1,0.01779591);
