...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-56.40335);
   Graph_Graph01029->SetMaximum(52.63998);
   ...
   mainFit1030->SetChisquare(0.7569515);
   ...
   mainFit1030->SetParameter(0,-1.470943);
   mainFit1030->SetParError(0,0.4676365);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.881061);
   mainFit1030->SetParError(1,0.01426683);
   ...
   pt_LaTex = pt->AddText("0.881#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.47#pm0.468");
   pt_LaTex = pt->AddText("#minus1.67#pm0.528");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.669513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.669513,-56.40335,1.669513,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.7569515);
   ...
   mainFit1031->SetParameter(0,-1.470943);
   mainFit1031->SetParError(0,0.4676365);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.881061);
   mainFit1031->SetParError(1,0.01426683);
