...
//=========  (Tue Apr 27 00:09:50 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(5.870807);
   ...
   quadLineFit1002->SetParameter(0,74.67548);
   quadLineFit1002->SetParError(0,0.06566106);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.45221);
   quadLineFit1002->SetParError(1,1.100822);
   ...
   quadLineFit1003->SetChisquare(5.870807);
   ...
   quadLineFit1003->SetParameter(0,74.67548);
   quadLineFit1003->SetParError(0,0.06566106);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.45221);
   quadLineFit1003->SetParError(1,1.100822);
   ...
   Graph_30_ppm1003->SetMinimum(75.83015);
   Graph_30_ppm1003->SetMaximum(76.44876);
   ...
   quadLineFit1004->SetChisquare(3.168375);
   ...
   quadLineFit1004->SetParameter(0,74.60697);
   quadLineFit1004->SetParError(0,0.05522324);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.89032);
   quadLineFit1004->SetParError(1,0.9070969);
   ...
   quadLineFit1005->SetChisquare(3.168375);
   ...
   quadLineFit1005->SetParameter(0,74.60697);
   quadLineFit1005->SetParError(0,0.05522324);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.89032);
   quadLineFit1005->SetParError(1,0.9070969);
   ...
   Graph_10_ppm1005->SetMinimum(74.88886);
   Graph_10_ppm1005->SetMaximum(75.13566);
   ...
   quadLineFit1006->SetChisquare(0.1591614);
   ...
   quadLineFit1006->SetParameter(0,74.47848);
   quadLineFit1006->SetParError(0,0.06478086);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.63504);
   quadLineFit1006->SetParError(1,1.050069);
   ...
   quadLineFit1007->SetChisquare(0.1591614);
   ...
   quadLineFit1007->SetParameter(0,74.47848);
   quadLineFit1007->SetParError(0,0.06478086);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.63504);
   quadLineFit1007->SetParError(1,1.050069);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.75457);
   Graph_mI10_ppm1007->SetMaximum(74.04407);
   ...
   quadLineFit1008->SetChisquare(4.465808);
   ...
   quadLineFit1008->SetParameter(0,74.47762);
   quadLineFit1008->SetParError(0,0.05681237);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-9.661993);
   quadLineFit1008->SetParError(1,0.9241559);
   ...
   quadLineFit1009->SetChisquare(4.465808);
   ...
   quadLineFit1009->SetParameter(0,74.47762);
   quadLineFit1009->SetParError(0,0.05681237);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-9.661993);
   quadLineFit1009->SetParError(1,0.9241559);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.41584);
   Graph_mI30_ppm1009->SetMaximum(73.13608);
   ...
   quadLineFit1010->SetChisquare(0.6174463);
   ...
   quadLineFit1010->SetParameter(0,74.5261);
   quadLineFit1010->SetParError(0,0.05367993);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.39555);
   quadLineFit1010->SetParError(1,0.9283902);
   ...
   quadLineFit1011->SetChisquare(0.6174463);
   ...
   quadLineFit1011->SetParameter(0,74.5261);
   quadLineFit1011->SetParError(0,0.05367993);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.39555);
   quadLineFit1011->SetParError(1,0.9283902);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.54319);
   Graph_mI50_ppm1011->SetMaximum(72.18956);
   ...
   quadLineFit1012->SetChisquare(1.898118);
   ...
   quadLineFit1012->SetParameter(0,74.45856);
   quadLineFit1012->SetParError(0,0.1084603);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-45.37623);
   quadLineFit1012->SetParError(1,1.940173);
   ...
   quadLineFit1013->SetChisquare(1.898118);
   ...
   quadLineFit1013->SetParameter(0,74.45856);
   quadLineFit1013->SetParError(0,0.1084603);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-45.37623);
   quadLineFit1013->SetParError(1,1.940173);
