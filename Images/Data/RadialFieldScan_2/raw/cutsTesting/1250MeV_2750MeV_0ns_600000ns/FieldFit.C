...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-56.40335);
   Graph_Graph01020->SetMaximum(52.63998);
   ...
   mainFit1021->SetChisquare(2.022446);
   ...
   mainFit1021->SetParameter(0,-1.264989);
   mainFit1021->SetParError(0,0.4303084);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8822815);
   mainFit1021->SetParError(1,0.01422555);
   ...
   pt_LaTex = pt->AddText("#minus1.26#pm 0.43");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.43377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.43377,-56.40335,1.43377,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.022446);
   ...
   mainFit1022->SetParameter(0,-1.264989);
   mainFit1022->SetParError(0,0.4303084);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8822815);
   mainFit1022->SetParError(1,0.01422555);
