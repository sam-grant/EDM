...
//=========  (Tue Apr 27 00:09:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01909662);
   Graph_Graph11015->SetMaximum(0.01991341);
   ...
   Graph_Graph21016->SetMinimum(-0.003752592);
   Graph_Graph21016->SetMaximum(0.004402543);
   ...
   Graph_Graph31017->SetMinimum(-0.02578903);
   Graph_Graph31017->SetMaximum(0.0264253);
   ...
   Graph_Graph41018->SetMinimum(-0.006405724);
   Graph_Graph41018->SetMaximum(0.007651228);
   ...
   Graph_Graph51019->SetMinimum(-0.01216412);
   Graph_Graph51019->SetMaximum(0.01621004);
