...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.28039,50,41.87018);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.66533);
   Graph_Graph01025->SetMaximum(31.25512);
   ...
   mainFit1026->SetChisquare(1.420794);
   ...
   mainFit1026->SetParameter(0,-0.9692631);
   mainFit1026->SetParError(0,0.7015094);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8199868);
   mainFit1026->SetParError(1,0.02778134);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.474");
   pt_LaTex = pt->AddText(" 0.82#pm0.0278");
   pt_LaTex = pt->AddText("#minus0.969#pm0.702");
   pt_LaTex = pt->AddText("#minus1.18#pm0.861");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.182047,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.182047,-53.66533,1.182047,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.420794);
   ...
   mainFit1027->SetParameter(0,-0.9692631);
   mainFit1027->SetParError(0,0.7015094);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8199868);
   mainFit1027->SetParError(1,0.02778134);
