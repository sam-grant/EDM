...
//=========  (Thu Apr 22 10:39:03 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.1388634);
   ...
   quadLineFit1002->SetParameter(0,74.57974);
   quadLineFit1002->SetParError(0,0.09938506);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.80513);
   quadLineFit1002->SetParError(1,1.667254);
   ...
   quadLineFit1003->SetChisquare(0.1388634);
   ...
   quadLineFit1003->SetParameter(0,74.57974);
   quadLineFit1003->SetParError(0,0.09938506);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.80513);
   quadLineFit1003->SetParError(1,1.667254);
   ...
   Graph_30_ppm1003->SetMinimum(75.84995);
   Graph_30_ppm1003->SetMaximum(76.43762);
   ...
   quadLineFit1004->SetChisquare(0.992657);
   ...
   quadLineFit1004->SetParameter(0,74.73746);
   quadLineFit1004->SetParError(0,0.08348601);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.80613);
   quadLineFit1004->SetParError(1,1.372288);
   ...
   quadLineFit1005->SetChisquare(0.992657);
   ...
   quadLineFit1005->SetParameter(0,74.73746);
   quadLineFit1005->SetParError(0,0.08348601);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.80613);
   quadLineFit1005->SetParError(1,1.372288);
   ...
   Graph_10_ppm1005->SetMinimum(74.93045);
   Graph_10_ppm1005->SetMaximum(75.18774);
   ...
   quadLineFit1006->SetChisquare(1.226366);
   ...
   quadLineFit1006->SetParameter(0,74.55018);
   quadLineFit1006->SetParError(0,0.09779953);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.063181);
   quadLineFit1006->SetParError(1,1.586425);
   ...
   quadLineFit1007->SetChisquare(1.226366);
   ...
   quadLineFit1007->SetParameter(0,74.55018);
   quadLineFit1007->SetParError(0,0.09779953);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.063181);
   quadLineFit1007->SetParError(1,1.586425);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.8164);
   Graph_mI10_ppm1007->SetMaximum(74.08442);
   ...
   quadLineFit1008->SetChisquare(1.98292);
   ...
   quadLineFit1008->SetParameter(0,74.44053);
   quadLineFit1008->SetParError(0,0.08593856);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.276031);
   quadLineFit1008->SetParError(1,1.398866);
   ...
   quadLineFit1009->SetChisquare(1.98292);
   ...
   quadLineFit1009->SetParameter(0,74.44053);
   quadLineFit1009->SetParError(0,0.08593856);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.276031);
   quadLineFit1009->SetParError(1,1.398866);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.44461);
   Graph_mI30_ppm1009->SetMaximum(73.12831);
   ...
   quadLineFit1010->SetChisquare(1.574287);
   ...
   quadLineFit1010->SetParameter(0,74.39045);
   quadLineFit1010->SetParError(0,0.08126551);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-25.87267);
   quadLineFit1010->SetParError(1,1.406427);
   ...
   quadLineFit1011->SetChisquare(1.574287);
   ...
   quadLineFit1011->SetParameter(0,74.39045);
   quadLineFit1011->SetParError(0,0.08126551);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-25.87267);
   quadLineFit1011->SetParError(1,1.406427);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.5773);
   Graph_mI50_ppm1011->SetMaximum(72.22065);
   ...
   quadLineFit1012->SetChisquare(0.002091277);
   ...
   quadLineFit1012->SetParameter(0,74.38427);
   quadLineFit1012->SetParError(0,0.1639637);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.65485);
   quadLineFit1012->SetParError(1,2.933776);
   ...
   quadLineFit1013->SetChisquare(0.002091277);
   ...
   quadLineFit1013->SetParameter(0,74.38427);
   quadLineFit1013->SetParError(0,0.1639637);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.65485);
   quadLineFit1013->SetParError(1,2.933776);
