...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01679831);
   Graph_Graph11015->SetMaximum(0.01777409);
   ...
   Graph_Graph21016->SetMinimum(-0.01576523);
   Graph_Graph21016->SetMaximum(0.01860795);
   ...
   Graph_Graph31017->SetMinimum(-0.01848702);
   Graph_Graph31017->SetMaximum(0.02593456);
   ...
   Graph_Graph41018->SetMinimum(-0.01915321);
   Graph_Graph41018->SetMaximum(0.02636766);
   ...
   Graph_Graph51019->SetMinimum(-0.000813461);
   Graph_Graph51019->SetMaximum(0.0006078518);
