...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-55.79472);
   Graph_Graph01027->SetMaximum(54.67848);
   ...
   mainFit1028->SetChisquare(0.2989364);
   ...
   mainFit1028->SetParameter(0,0.08838006);
   mainFit1028->SetParError(0,0.7293158);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8691978);
   mainFit1028->SetParError(1,0.02406563);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0996");
   pt_LaTex = pt->AddText("0.869#pm0.0241");
   pt_LaTex = pt->AddText("0.0884#pm0.729");
   pt_LaTex = pt->AddText("0.102#pm0.839");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.10168,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.10168,-55.79472,-0.10168,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.2989364);
   ...
   mainFit1029->SetParameter(0,0.08838006);
   mainFit1029->SetParError(0,0.7293158);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8691978);
   mainFit1029->SetParError(1,0.02406563);
