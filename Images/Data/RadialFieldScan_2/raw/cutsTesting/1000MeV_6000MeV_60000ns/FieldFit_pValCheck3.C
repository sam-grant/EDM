...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.79472);
   Graph_Graph01031->SetMaximum(54.67848);
   ...
   mainFit1032->SetChisquare(3.647283);
   ...
   mainFit1032->SetParameter(0,-0.7809619);
   mainFit1032->SetParError(0,0.7500541);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.852033);
   mainFit1032->SetParError(1,0.02229029);
   ...
   pt_LaTex = pt->AddText("0.852#pm0.0223");
   pt_LaTex = pt->AddText("#minus0.781#pm 0.75");
   pt_LaTex = pt->AddText("#minus0.917#pm0.874");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9165864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9165864,-55.79472,0.9165864,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(3.647283);
   ...
   mainFit1033->SetParameter(0,-0.7809619);
   mainFit1033->SetParError(0,0.7500541);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.852033);
   mainFit1033->SetParError(1,0.02229029);
