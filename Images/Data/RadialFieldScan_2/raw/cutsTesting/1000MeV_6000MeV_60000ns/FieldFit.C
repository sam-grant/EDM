...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.79472);
   Graph_Graph01020->SetMaximum(54.67848);
   ...
   mainFit1021->SetChisquare(4.042886);
   ...
   mainFit1021->SetParameter(0,-0.5469062);
   mainFit1021->SetParError(0,0.6512326);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8484179);
   mainFit1021->SetParError(1,0.02153648);
   ...
   pt_LaTex = pt->AddText("0.848#pm0.0215");
   pt_LaTex = pt->AddText("#minus0.547#pm0.651");
   pt_LaTex = pt->AddText("#minus0.645#pm0.765");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6446189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6446189,-55.79472,0.6446189,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.042886);
   ...
   mainFit1022->SetParameter(0,-0.5469062);
   mainFit1022->SetParError(0,0.6512326);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8484179);
   mainFit1022->SetParError(1,0.02153648);
