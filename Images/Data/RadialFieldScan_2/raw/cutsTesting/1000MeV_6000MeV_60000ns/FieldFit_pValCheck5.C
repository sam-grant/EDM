...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-45.46696,70,63.66025);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-34.55424);
   Graph_Graph01035->SetMaximum(52.74753);
   ...
   mainFit1036->SetChisquare(3.97344);
   ...
   mainFit1036->SetParameter(0,-0.4926077);
   mainFit1036->SetParError(0,0.6830512);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8458451);
   mainFit1036->SetParError(1,0.02364593);
   ...
   pt_LaTex = pt->AddText("0.846#pm0.0236");
   pt_LaTex = pt->AddText("#minus0.493#pm0.683");
   pt_LaTex = pt->AddText("#minus0.582#pm0.803");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,0.5823852,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.5823852,-34.55424,0.5823852,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.97344);
   ...
   mainFit1037->SetParameter(0,-0.4926077);
   mainFit1037->SetParError(0,0.6830512);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8458451);
   mainFit1037->SetParError(1,0.02364593);
