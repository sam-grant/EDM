...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.79472);
   Graph_Graph01029->SetMaximum(54.67848);
   ...
   mainFit1030->SetChisquare(4.035306);
   ...
   mainFit1030->SetParameter(0,-0.5710693);
   mainFit1030->SetParError(0,0.7079362);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8482729);
   mainFit1030->SetParError(1,0.02159908);
   ...
   pt_LaTex = pt->AddText("0.848#pm0.0216");
   pt_LaTex = pt->AddText("#minus0.571#pm0.708");
   pt_LaTex = pt->AddText("#minus0.673#pm0.833");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6732141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6732141,-55.79472,0.6732141,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(4.035306);
   ...
   mainFit1031->SetParameter(0,-0.5710693);
   mainFit1031->SetParError(0,0.7079362);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8482729);
   mainFit1031->SetParError(1,0.02159908);
