...
//=========  (Thu Apr 22 10:39:04 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.79472);
   Graph_Graph01023->SetMaximum(54.67848);
   ...
   mainFit1024->SetChisquare(4.042886);
   ...
   mainFit1024->SetParameter(0,-0.5469062);
   mainFit1024->SetParError(0,0.6512326);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8484179);
   mainFit1024->SetParError(1,0.02153648);
   ...
   mainFit1025->SetChisquare(4.042886);
   ...
   mainFit1025->SetParameter(0,-0.5469062);
   mainFit1025->SetParError(0,0.6512326);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8484179);
   mainFit1025->SetParError(1,0.02153648);
