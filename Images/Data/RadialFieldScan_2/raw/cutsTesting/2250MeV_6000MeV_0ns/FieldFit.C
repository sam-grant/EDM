...
//=========  (Wed Apr 21 21:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.43578);
   Graph_Graph01020->SetMaximum(53.79219);
   ...
   mainFit1021->SetChisquare(3.129925);
   ...
   mainFit1021->SetParameter(0,-1.690434);
   mainFit1021->SetParError(0,0.6219887);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8915262);
   mainFit1021->SetParError(1,0.02062017);
   ...
   mainFit1022->SetChisquare(3.129925);
   ...
   mainFit1022->SetParameter(0,-1.690434);
   mainFit1022->SetParError(0,0.6219887);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8915262);
   mainFit1022->SetParError(1,0.02062017);
