...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.96864,70,63.32156);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-38.63962);
   Graph_Graph01035->SetMaximum(51.99254);
   ...
   mainFit1036->SetChisquare(3.1299);
   ...
   mainFit1036->SetParameter(0,-1.689489);
   mainFit1036->SetParError(0,0.6519897);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.891486);
   mainFit1036->SetParError(1,0.02263489);
   ...
   pt_LaTex = pt->AddText("0.891#pm0.0226");
   pt_LaTex = pt->AddText("#minus1.69#pm0.652");
   pt_LaTex = pt->AddText(" #minus1.9#pm 0.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.895138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.895138,-38.63962,1.895138,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(3.1299);
   ...
   mainFit1037->SetParameter(0,-1.689489);
   mainFit1037->SetParError(0,0.6519897);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.891486);
   mainFit1037->SetParError(1,0.02263489);
