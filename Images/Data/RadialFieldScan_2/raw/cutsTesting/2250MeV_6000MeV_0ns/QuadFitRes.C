...
//=========  (Wed Apr 21 21:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.06242166);
   Graph_Graph11015->SetMaximum(0.03834525);
   ...
   Graph_Graph21016->SetMinimum(-0.02633357);
   Graph_Graph21016->SetMaximum(0.03090151);
   ...
   Graph_Graph31017->SetMinimum(-0.04436293);
   Graph_Graph31017->SetMaximum(0.03845632);
   ...
   Graph_Graph41018->SetMinimum(-0.04465221);
   Graph_Graph41018->SetMaximum(0.02783497);
   ...
   Graph_Graph51019->SetMinimum(-0.01196219);
   Graph_Graph51019->SetMaximum(0.0159137);
