...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.43578);
   Graph_Graph01031->SetMaximum(53.79219);
   ...
   mainFit1032->SetChisquare(0.9932213);
   ...
   mainFit1032->SetParameter(0,-2.209777);
   mainFit1032->SetParError(0,0.7163038);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8995207);
   mainFit1032->SetParError(1,0.02133213);
   ...
   pt_LaTex = pt->AddText("  0.9#pm0.0213");
   pt_LaTex = pt->AddText("#minus2.21#pm0.716");
   pt_LaTex = pt->AddText("#minus2.46#pm0.783");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.456616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.456616,-58.43578,2.456616,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.9932213);
   ...
   mainFit1033->SetParameter(0,-2.209777);
   mainFit1033->SetParError(0,0.7163038);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8995207);
   mainFit1033->SetParError(1,0.02133213);
