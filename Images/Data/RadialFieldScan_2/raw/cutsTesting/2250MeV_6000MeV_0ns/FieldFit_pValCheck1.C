...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.43578);
   Graph_Graph01027->SetMaximum(53.79219);
   ...
   mainFit1028->SetChisquare(2.488373);
   ...
   mainFit1028->SetParameter(0,-1.436739);
   mainFit1028->SetParError(0,0.6980047);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8998792);
   mainFit1028->SetParError(1,0.02310484);
   ...
   pt_LaTex = pt->AddText("  0.9#pm0.0231");
   pt_LaTex = pt->AddText("#minus1.44#pm0.698");
   pt_LaTex = pt->AddText(" #minus1.6#pm 0.78");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.596591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.596591,-58.43578,1.596591,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.488373);
   ...
   mainFit1029->SetParameter(0,-1.436739);
   mainFit1029->SetParError(0,0.6980047);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8998792);
   mainFit1029->SetParError(1,0.02310484);
