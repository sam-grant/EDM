...
//=========  (Wed Apr 21 21:23:19 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.04545035);
   ...
   quadLineFit1002->SetParameter(0,75.12132);
   quadLineFit1002->SetParError(0,0.09592464);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,42.83175);
   quadLineFit1002->SetParError(1,1.608108);
   ...
   quadLineFit1003->SetChisquare(0.04545035);
   ...
   quadLineFit1003->SetParameter(0,75.12132);
   quadLineFit1003->SetParError(0,0.09592464);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,42.83175);
   quadLineFit1003->SetParError(1,1.608108);
   ...
   Graph_30_ppm1003->SetMinimum(76.3339);
   Graph_30_ppm1003->SetMaximum(76.95422);
   ...
   quadLineFit1004->SetChisquare(7.129617);
   ...
   quadLineFit1004->SetParameter(0,75.13509);
   quadLineFit1004->SetParError(0,0.07965397);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,24.22961);
   quadLineFit1004->SetParError(1,1.308534);
   ...
   quadLineFit1005->SetChisquare(7.129617);
   ...
   quadLineFit1005->SetParameter(0,75.13509);
   quadLineFit1005->SetParError(0,0.07965397);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,24.22961);
   quadLineFit1005->SetParError(1,1.308534);
   ...
   Graph_10_ppm1005->SetMinimum(75.37498);
   Graph_10_ppm1005->SetMaximum(75.63051);
   ...
   quadLineFit1006->SetChisquare(3.761044);
   ...
   quadLineFit1006->SetParameter(0,74.99522);
   quadLineFit1006->SetParError(0,0.09368013);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.904749);
   quadLineFit1006->SetParError(1,1.518368);
   ...
   quadLineFit1007->SetChisquare(3.761044);
   ...
   quadLineFit1007->SetParameter(0,74.99522);
   quadLineFit1007->SetParError(0,0.09368013);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.904749);
   quadLineFit1007->SetParError(1,1.518368);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.27893);
   Graph_mI10_ppm1007->SetMaximum(74.58113);
   ...
   quadLineFit1008->SetChisquare(5.765566);
   ...
   quadLineFit1008->SetParameter(0,74.95968);
   quadLineFit1008->SetParError(0,0.08204975);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.931413);
   quadLineFit1008->SetParError(1,1.33477);
   ...
   quadLineFit1009->SetChisquare(5.765566);
   ...
   quadLineFit1009->SetParameter(0,74.95968);
   quadLineFit1009->SetParError(0,0.08204975);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.931413);
   quadLineFit1009->SetParError(1,1.33477);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.90045);
   Graph_mI30_ppm1009->SetMaximum(73.64951);
   ...
   quadLineFit1010->SetChisquare(3.565676);
   ...
   quadLineFit1010->SetParameter(0,75.09005);
   quadLineFit1010->SetParError(0,0.07748679);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.74688);
   quadLineFit1010->SetParError(1,1.340055);
   ...
   quadLineFit1011->SetChisquare(3.565676);
   ...
   quadLineFit1011->SetParameter(0,75.09005);
   quadLineFit1011->SetParError(0,0.07748679);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.74688);
   quadLineFit1011->SetParError(1,1.340055);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.02076);
   Graph_mI50_ppm1011->SetMaximum(72.69557);
   ...
   quadLineFit1012->SetChisquare(0.877466);
   ...
   quadLineFit1012->SetParameter(0,75.00216);
   quadLineFit1012->SetParError(0,0.1567778);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.27934);
   quadLineFit1012->SetParError(1,2.804111);
   ...
   quadLineFit1013->SetChisquare(0.877466);
   ...
   quadLineFit1013->SetParameter(0,75.00216);
   quadLineFit1013->SetParError(0,0.1567778);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.27934);
   quadLineFit1013->SetParError(1,2.804111);
