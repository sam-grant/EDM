...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-67.73885,50,44.19354);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.54561);
   Graph_Graph01025->SetMaximum(33.0003);
   ...
   mainFit1026->SetChisquare(3.127711);
   ...
   mainFit1026->SetParameter(0,-1.678798);
   mainFit1026->SetParError(0,0.6695121);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8923153);
   mainFit1026->SetParError(1,0.02650272);
   ...
   pt_LaTex = pt->AddText("0.892#pm0.0265");
   pt_LaTex = pt->AddText("#minus1.68#pm 0.67");
   pt_LaTex = pt->AddText("#minus1.88#pm0.759");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.881395,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.881395,-56.54561,1.881395,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.127711);
   ...
   mainFit1027->SetParameter(0,-1.678798);
   mainFit1027->SetParError(0,0.6695121);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8923153);
   mainFit1027->SetParError(1,0.02650272);
