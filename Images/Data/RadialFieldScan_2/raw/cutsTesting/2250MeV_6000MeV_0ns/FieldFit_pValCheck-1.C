...
//=========  (Wed Apr 21 21:23:20 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.43578);
   Graph_Graph01023->SetMaximum(53.79219);
   ...
   mainFit1024->SetChisquare(3.129925);
   ...
   mainFit1024->SetParameter(0,-1.690434);
   mainFit1024->SetParError(0,0.6219887);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8915262);
   mainFit1024->SetParError(1,0.02062017);
   ...
   pt_LaTex = pt->AddText("0.892#pm0.0206");
   pt_LaTex = pt->AddText("#minus1.69#pm0.622");
   pt_LaTex = pt->AddText(" #minus1.9#pm0.692");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.896113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.896113,-58.43578,1.896113,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(3.129925);
   ...
   mainFit1025->SetParameter(0,-1.690434);
   mainFit1025->SetParError(0,0.6219887);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8915262);
   mainFit1025->SetParError(1,0.02062017);
