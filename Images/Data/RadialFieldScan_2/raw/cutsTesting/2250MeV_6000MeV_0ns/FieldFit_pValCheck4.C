...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-58.43578);
   Graph_Graph01033->SetMaximum(53.79219);
   ...
   mainFit1034->SetChisquare(1.233817);
   ...
   mainFit1034->SetParameter(0,-1.043525);
   mainFit1034->SetParError(0,0.7794823);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8701702);
   mainFit1034->SetParError(1,0.02580418);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.411");
   pt_LaTex = pt->AddText(" 0.87#pm0.0258");
   pt_LaTex = pt->AddText("#minus1.04#pm0.779");
   pt_LaTex = pt->AddText(" #minus1.2#pm 0.88");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.19922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.19922,-58.43578,1.19922,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.233817);
   ...
   mainFit1035->SetParameter(0,-1.043525);
   mainFit1035->SetParError(0,0.7794823);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8701702);
   mainFit1035->SetParError(1,0.02580418);
