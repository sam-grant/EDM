...
//=========  (Wed Apr 21 21:23:21 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-72.46428,75,67.82068);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-58.43578);
   Graph_Graph01029->SetMaximum(53.79219);
   ...
   mainFit1030->SetChisquare(2.888699);
   ...
   mainFit1030->SetParameter(0,-1.820591);
   mainFit1030->SetParError(0,0.6760753);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8907358);
   mainFit1030->SetParError(1,0.02068377);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.963");
   pt_LaTex = pt->AddText("0.891#pm0.0207");
   pt_LaTex = pt->AddText("#minus1.82#pm0.676");
   pt_LaTex = pt->AddText("#minus2.04#pm0.755");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.043918,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.043918,-58.43578,2.043918,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(2.888699);
   ...
   mainFit1031->SetParameter(0,-1.820591);
   mainFit1031->SetParError(0,0.6760753);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8907358);
   mainFit1031->SetParError(1,0.02068377);
