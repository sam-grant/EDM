...
//=========  (Fri Apr 23 19:01:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-55.76517);
   Graph_Graph01023->SetMaximum(53.79034);
   ...
   mainFit1024->SetChisquare(5.755056);
   ...
   mainFit1024->SetParameter(0,-1.363799);
   mainFit1024->SetParError(0,0.4767198);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8636955);
   mainFit1024->SetParError(1,0.0157587);
   ...
   pt_LaTex = pt->AddText("0.864#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.36#pm0.477");
   pt_LaTex = pt->AddText("#minus1.58#pm0.548");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.579028,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.579028,-55.76517,1.579028,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(5.755056);
   ...
   mainFit1025->SetParameter(0,-1.363799);
   mainFit1025->SetParError(0,0.4767198);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8636955);
   mainFit1025->SetParError(1,0.0157587);
