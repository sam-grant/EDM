...
//=========  (Fri Apr 23 19:01:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-55.76517);
   Graph_Graph01029->SetMaximum(53.79034);
   ...
   mainFit1030->SetChisquare(5.110972);
   ...
   mainFit1030->SetParameter(0,-1.526982);
   mainFit1030->SetParError(0,0.5182515);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8627395);
   mainFit1030->SetParError(1,0.01580464);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0158");
   pt_LaTex = pt->AddText("#minus1.53#pm0.518");
   pt_LaTex = pt->AddText("#minus1.77#pm0.598");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.769923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.769923,-55.76517,1.769923,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(5.110972);
   ...
   mainFit1031->SetParameter(0,-1.526982);
   mainFit1031->SetParError(0,0.5182515);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8627395);
   mainFit1031->SetParError(1,0.01580464);
