...
//=========  (Fri Apr 23 19:01:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-55.76517);
   Graph_Graph01020->SetMaximum(53.79034);
   ...
   mainFit1021->SetChisquare(5.755056);
   ...
   mainFit1021->SetParameter(0,-1.363799);
   mainFit1021->SetParError(0,0.4767198);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8636955);
   mainFit1021->SetParError(1,0.0157587);
   ...
   mainFit1022->SetChisquare(5.755056);
   ...
   mainFit1022->SetParameter(0,-1.363799);
   mainFit1022->SetParError(0,0.4767198);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8636955);
   mainFit1022->SetParError(1,0.0157587);
