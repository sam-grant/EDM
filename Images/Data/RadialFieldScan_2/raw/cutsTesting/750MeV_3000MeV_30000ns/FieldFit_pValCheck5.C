...
//=========  (Fri Apr 23 19:01:18 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-46.22569,70,62.83799);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-35.31932);
   Graph_Graph01035->SetMaximum(51.93162);
   ...
   mainFit1036->SetChisquare(5.754004);
   ...
   mainFit1036->SetParameter(0,-1.368726);
   mainFit1036->SetParError(0,0.499961);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8639377);
   mainFit1036->SetParError(1,0.01729893);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 1.92");
   pt_LaTex = pt->AddText("0.864#pm0.0173");
   pt_LaTex = pt->AddText("#minus1.37#pm  0.5");
   pt_LaTex = pt->AddText("#minus1.58#pm0.571");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.584288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.584288,-35.31932,1.584288,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(5.754004);
   ...
   mainFit1037->SetParameter(0,-1.368726);
   mainFit1037->SetParError(0,0.499961);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8639377);
   mainFit1037->SetParError(1,0.01729893);
