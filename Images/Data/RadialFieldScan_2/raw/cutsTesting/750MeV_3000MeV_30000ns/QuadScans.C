...
//=========  (Fri Apr 23 19:01:17 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.3851885);
   ...
   quadLineFit1002->SetParameter(0,74.59878);
   quadLineFit1002->SetParError(0,0.07261639);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,43.44268);
   quadLineFit1002->SetParError(1,1.21803);
   ...
   quadLineFit1003->SetChisquare(0.3851885);
   ...
   quadLineFit1003->SetParameter(0,74.59878);
   quadLineFit1003->SetParError(0,0.07261639);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,43.44268);
   quadLineFit1003->SetParError(1,1.21803);
   ...
   Graph_30_ppm1003->SetMinimum(75.82211);
   Graph_30_ppm1003->SetMaximum(76.39125);
   ...
   quadLineFit1004->SetChisquare(2.677353);
   ...
   quadLineFit1004->SetParameter(0,74.70858);
   quadLineFit1004->SetParError(0,0.06127573);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,22.70137);
   quadLineFit1004->SetParError(1,1.007103);
   ...
   quadLineFit1005->SetChisquare(2.677353);
   ...
   quadLineFit1005->SetParameter(0,74.70858);
   quadLineFit1005->SetParError(0,0.06127573);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,22.70137);
   quadLineFit1005->SetParError(1,1.007103);
   ...
   Graph_10_ppm1005->SetMinimum(74.85544);
   Graph_10_ppm1005->SetMaximum(75.09858);
   ...
   quadLineFit1006->SetChisquare(1.835267);
   ...
   quadLineFit1006->SetParameter(0,74.46621);
   quadLineFit1006->SetParError(0,0.07160223);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.122733);
   quadLineFit1006->SetParError(1,1.161198);
   ...
   quadLineFit1007->SetChisquare(1.835267);
   ...
   quadLineFit1007->SetParameter(0,74.46621);
   quadLineFit1007->SetParError(0,0.07160223);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.122733);
   quadLineFit1007->SetParError(1,1.161198);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.66928);
   Graph_mI10_ppm1007->SetMaximum(73.98368);
   ...
   quadLineFit1008->SetChisquare(8.653616);
   ...
   quadLineFit1008->SetParameter(0,74.44263);
   quadLineFit1008->SetParError(0,0.06289284);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.16601);
   quadLineFit1008->SetParError(1,1.023648);
   ...
   quadLineFit1009->SetChisquare(8.653616);
   ...
   quadLineFit1009->SetParameter(0,74.44263);
   quadLineFit1009->SetParError(0,0.06289284);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.16601);
   quadLineFit1009->SetParError(1,1.023648);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.33039);
   Graph_mI30_ppm1009->SetMaximum(73.01969);
   ...
   quadLineFit1010->SetChisquare(3.417881);
   ...
   quadLineFit1010->SetParameter(0,74.34773);
   quadLineFit1010->SetParError(0,0.05945818);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-27.01945);
   quadLineFit1010->SetParError(1,1.028956);
   ...
   quadLineFit1011->SetChisquare(3.417881);
   ...
   quadLineFit1011->SetParameter(0,74.34773);
   quadLineFit1011->SetParError(0,0.05945818);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-27.01945);
   quadLineFit1011->SetParError(1,1.028956);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.42503);
   Graph_mI50_ppm1011->SetMaximum(72.0639);
   ...
   quadLineFit1012->SetChisquare(0.6260234);
   ...
   quadLineFit1012->SetParameter(0,74.28288);
   quadLineFit1012->SetParError(0,0.1200642);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-44.48724);
   quadLineFit1012->SetParError(1,2.1483);
   ...
   quadLineFit1013->SetChisquare(0.6260234);
   ...
   quadLineFit1013->SetParameter(0,74.28288);
   quadLineFit1013->SetParError(0,0.1200642);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-44.48724);
   quadLineFit1013->SetParError(1,2.1483);
