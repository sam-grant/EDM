...
//=========  (Fri Apr 23 19:01:17 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-64.22155,50,41.29448);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-53.66995);
   Graph_Graph01025->SetMaximum(30.74288);
   ...
   mainFit1026->SetChisquare(2.28009);
   ...
   mainFit1026->SetParameter(0,-1.721434);
   mainFit1026->SetParError(0,0.5138679);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8396821);
   mainFit1026->SetParError(1,0.0203575);
   ...
   pt_LaTex = pt->AddText(" 0.84#pm0.0204");
   pt_LaTex = pt->AddText("#minus1.72#pm0.514");
   pt_LaTex = pt->AddText("#minus2.05#pm 0.62");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.050102,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.050102,-53.66995,2.050102,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.28009);
   ...
   mainFit1027->SetParameter(0,-1.721434);
   mainFit1027->SetParError(0,0.5138679);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8396821);
   mainFit1027->SetParError(1,0.0203575);
