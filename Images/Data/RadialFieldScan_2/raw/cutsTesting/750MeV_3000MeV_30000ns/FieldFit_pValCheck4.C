...
//=========  (Fri Apr 23 19:01:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-55.76517);
   Graph_Graph01033->SetMaximum(53.79034);
   ...
   mainFit1034->SetChisquare(5.633066);
   ...
   mainFit1034->SetParameter(0,-1.48962);
   mainFit1034->SetParError(0,0.5974512);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8678392);
   mainFit1034->SetParError(1,0.01970662);
   ...
   pt_LaTex = pt->AddText("0.868#pm0.0197");
   pt_LaTex = pt->AddText("#minus1.49#pm0.597");
   pt_LaTex = pt->AddText("#minus1.72#pm0.671");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.71647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.71647,-55.76517,1.71647,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(5.633066);
   ...
   mainFit1035->SetParameter(0,-1.48962);
   mainFit1035->SetParError(0,0.5974512);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8678392);
   mainFit1035->SetParError(1,0.01970662);
