...
//=========  (Fri Apr 23 19:01:17 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01937129);
   Graph_Graph11015->SetMaximum(0.02055917);
   ...
   Graph_Graph21016->SetMinimum(-0.01410977);
   Graph_Graph21016->SetMaximum(0.0166168);
   ...
   Graph_Graph31017->SetMinimum(-0.03855944);
   Graph_Graph31017->SetMaximum(0.03180136);
   ...
   Graph_Graph41018->SetMinimum(-0.01440021);
   Graph_Graph41018->SetMaximum(0.02264838);
   ...
   Graph_Graph51019->SetMinimum(-0.007703883);
   Graph_Graph51019->SetMaximum(0.01030004);
