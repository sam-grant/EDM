...
//=========  (Fri Apr 23 19:01:18 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-55.76517);
   Graph_Graph01031->SetMaximum(53.79034);
   ...
   mainFit1032->SetChisquare(5.719727);
   ...
   mainFit1032->SetParameter(0,-1.312626);
   mainFit1032->SetParError(0,0.5490973);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.8629163);
   mainFit1032->SetParError(1,0.01630958);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0163");
   pt_LaTex = pt->AddText("#minus1.31#pm0.549");
   pt_LaTex = pt->AddText("#minus1.52#pm0.629");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.52115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.52115,-55.76517,1.52115,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(5.719727);
   ...
   mainFit1033->SetParameter(0,-1.312626);
   mainFit1033->SetParError(0,0.5490973);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.8629163);
   mainFit1033->SetParError(1,0.01630958);
