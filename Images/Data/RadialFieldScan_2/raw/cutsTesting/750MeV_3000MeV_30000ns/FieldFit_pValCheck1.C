...
//=========  (Fri Apr 23 19:01:18 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-69.45961,75,67.48478);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01027->SetMinimum(-55.76517);
   Graph_Graph01027->SetMaximum(53.79034);
   ...
   mainFit1028->SetChisquare(0.3972315);
   ...
   mainFit1028->SetParameter(0,-0.8094668);
   mainFit1028->SetParError(0,0.5335007);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8818215);
   mainFit1028->SetParError(1,0.01759509);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.132");
   pt_LaTex = pt->AddText("0.882#pm0.0176");
   pt_LaTex = pt->AddText("#minus0.809#pm0.534");
   pt_LaTex = pt->AddText("#minus0.918#pm0.607");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.9179485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9179485,-55.76517,0.9179485,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3972315);
   ...
   mainFit1029->SetParameter(0,-0.8094668);
   mainFit1029->SetParError(0,0.5335007);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8818215);
   mainFit1029->SetParError(1,0.01759509);
