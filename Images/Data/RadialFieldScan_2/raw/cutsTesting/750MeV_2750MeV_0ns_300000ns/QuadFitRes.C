...
//=========  (Mon Apr 26 22:10:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01097155);
   Graph_Graph11015->SetMaximum(0.013649);
   ...
   Graph_Graph21016->SetMinimum(-0.009560032);
   Graph_Graph21016->SetMaximum(0.01122223);
   ...
   Graph_Graph31017->SetMinimum(-0.02202089);
   Graph_Graph31017->SetMaximum(0.01987689);
   ...
   Graph_Graph41018->SetMinimum(-0.01419364);
   Graph_Graph41018->SetMaximum(0.01768139);
   ...
   Graph_Graph51019->SetMinimum(-0.006016726);
