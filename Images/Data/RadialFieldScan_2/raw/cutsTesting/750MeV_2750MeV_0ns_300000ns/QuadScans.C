...
//=========  (Mon Apr 26 22:10:51 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.873341);
   ...
   quadLineFit1002->SetParameter(0,74.53959);
   quadLineFit1002->SetParError(0,0.0578265);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.85516);
   quadLineFit1002->SetParError(1,0.9698459);
   ...
   quadLineFit1003->SetChisquare(3.873341);
   ...
   quadLineFit1003->SetParameter(0,74.53959);
   quadLineFit1003->SetParError(0,0.0578265);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.85516);
   quadLineFit1003->SetParError(1,0.9698459);
   ...
   Graph_30_ppm1003->SetMinimum(75.78288);
   Graph_30_ppm1003->SetMaximum(76.42287);
   ...
   quadLineFit1004->SetChisquare(1.595458);
   ...
   quadLineFit1004->SetParameter(0,74.52173);
   quadLineFit1004->SetParError(0,0.04778927);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.66356);
   quadLineFit1004->SetParError(1,0.7850397);
   ...
   quadLineFit1005->SetChisquare(1.595458);
   ...
   quadLineFit1005->SetParameter(0,74.52173);
   quadLineFit1005->SetParError(0,0.04778927);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.66356);
   quadLineFit1005->SetParError(1,0.7850397);
   ...
   Graph_10_ppm1005->SetMinimum(74.81308);
   Graph_10_ppm1005->SetMaximum(75.05788);
   ...
   quadLineFit1006->SetChisquare(1.378844);
   ...
   quadLineFit1006->SetParameter(0,74.39655);
   quadLineFit1006->SetParError(0,0.05604181);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,8.645165);
   quadLineFit1006->SetParError(1,0.9084953);
   ...
   quadLineFit1007->SetChisquare(1.378844);
   ...
   quadLineFit1007->SetParameter(0,74.39655);
   quadLineFit1007->SetParError(0,0.05604181);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,8.645165);
   quadLineFit1007->SetParError(1,0.9084953);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.59682);
   Graph_mI10_ppm1007->SetMaximum(73.91255);
   ...
   quadLineFit1008->SetChisquare(3.969613);
   ...
   quadLineFit1008->SetParameter(0,74.42421);
   quadLineFit1008->SetParError(0,0.04916844);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-11.07542);
   quadLineFit1008->SetParError(1,0.7999041);
   ...
   quadLineFit1009->SetChisquare(3.969613);
   ...
   quadLineFit1009->SetParameter(0,74.42421);
   quadLineFit1009->SetParError(0,0.04916844);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-11.07542);
   quadLineFit1009->SetParError(1,0.7999041);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.21253);
   Graph_mI30_ppm1009->SetMaximum(72.95771);
   ...
   quadLineFit1010->SetChisquare(3.030973);
   ...
   quadLineFit1010->SetParameter(0,74.40394);
   quadLineFit1010->SetParError(0,0.04645482);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.44557);
   quadLineFit1010->SetParError(1,0.803537);
   ...
   quadLineFit1011->SetChisquare(3.030973);
   ...
   quadLineFit1011->SetParameter(0,74.40394);
   quadLineFit1011->SetParError(0,0.04645482);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.44557);
   quadLineFit1011->SetParError(1,0.803537);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.30716);
   Graph_mI50_ppm1011->SetMaximum(71.97504);
   ...
   quadLineFit1012->SetChisquare(0.6217132);
   ...
   quadLineFit1012->SetParameter(0,74.33753);
   quadLineFit1012->SetParError(0,0.09389667);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-47.29398);
   quadLineFit1012->SetParError(1,1.679781);
   ...
   quadLineFit1013->SetChisquare(0.6217132);
   ...
   quadLineFit1013->SetParameter(0,74.33753);
   quadLineFit1013->SetParError(0,0.09389667);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-47.29398);
   quadLineFit1013->SetParError(1,1.679781);
