...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-58.45363);
   Graph_Graph01027->SetMaximum(55.30488);
   ...
   mainFit1028->SetChisquare(1.118631);
   ...
   mainFit1028->SetParameter(0,-1.393117);
   mainFit1028->SetParError(0,0.4188444);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9296158);
   mainFit1028->SetParError(1,0.01389639);
   ...
   pt_LaTex = pt->AddText("#minus1.39#pm0.419");
   pt_LaTex = pt->AddText(" #minus1.5#pm0.453");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.498594,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.498594,-58.45363,1.498594,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(1.118631);
   ...
   mainFit1029->SetParameter(0,-1.393117);
   mainFit1029->SetParError(0,0.4188444);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9296158);
   mainFit1029->SetParError(1,0.01389639);
