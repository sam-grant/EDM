...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-58.45363);
   Graph_Graph01031->SetMaximum(55.30488);
   ...
   mainFit1032->SetChisquare(1.648135);
   ...
   mainFit1032->SetParameter(0,-1.46526);
   mainFit1032->SetParError(0,0.4295132);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9230314);
   mainFit1032->SetParError(1,0.0128118);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.47#pm 0.43");
   pt_LaTex = pt->AddText("#minus1.59#pm 0.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.587443,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.587443,-58.45363,1.587443,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(1.648135);
   ...
   mainFit1033->SetParameter(0,-1.46526);
   mainFit1033->SetParError(0,0.4295132);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9230314);
   mainFit1033->SetParError(1,0.0128118);
