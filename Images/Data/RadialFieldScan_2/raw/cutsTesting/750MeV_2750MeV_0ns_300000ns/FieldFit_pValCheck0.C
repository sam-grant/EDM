...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-67.82935,50,45.30419);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-56.51599);
   Graph_Graph01025->SetMaximum(33.99084);
   ...
   mainFit1026->SetChisquare(1.741148);
   ...
   mainFit1026->SetParameter(0,-1.592076);
   mainFit1026->SetParError(0,0.4012785);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9216746);
   mainFit1026->SetParError(1,0.01589045);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.58");
   pt_LaTex = pt->AddText("0.922#pm0.0159");
   pt_LaTex = pt->AddText("#minus1.59#pm0.401");
   pt_LaTex = pt->AddText("#minus1.73#pm 0.44");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.727373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.727373,-56.51599,1.727373,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(1.741148);
   ...
   mainFit1027->SetParameter(0,-1.592076);
   mainFit1027->SetParError(0,0.4012785);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9216746);
   mainFit1027->SetParError(1,0.01589045);
