...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-58.45363);
   Graph_Graph01023->SetMaximum(55.30488);
   ...
   mainFit1024->SetChisquare(1.814188);
   ...
   mainFit1024->SetParameter(0,-1.552041);
   mainFit1024->SetParError(0,0.3729679);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.924358);
   mainFit1024->SetParError(1,0.01238701);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.454");
   pt_LaTex = pt->AddText("0.924#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.55#pm0.373");
   pt_LaTex = pt->AddText("#minus1.68#pm0.401");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.679048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.679048,-58.45363,1.679048,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1025->SetChisquare(1.814188);
   ...
   mainFit1025->SetParameter(0,-1.552041);
   mainFit1025->SetParError(0,0.3729679);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.924358);
   mainFit1025->SetParError(1,0.01238701);
