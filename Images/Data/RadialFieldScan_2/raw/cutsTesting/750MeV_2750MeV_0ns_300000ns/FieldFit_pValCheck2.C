...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-72.67345,75,69.5247);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-58.45363);
   Graph_Graph01029->SetMaximum(55.30488);
   ...
   mainFit1030->SetChisquare(0.4869907);
   ...
   mainFit1030->SetParameter(0,-1.735769);
   mainFit1030->SetParError(0,0.4056264);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.923219);
   mainFit1030->SetParError(1,0.01242685);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.162");
   pt_LaTex = pt->AddText("0.923#pm0.0124");
   pt_LaTex = pt->AddText("#minus1.74#pm0.406");
   pt_LaTex = pt->AddText("#minus1.88#pm0.437");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.880127,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.880127,-58.45363,1.880127,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.4869907);
   ...
   mainFit1031->SetParameter(0,-1.735769);
   mainFit1031->SetParError(0,0.4056264);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.923219);
   mainFit1031->SetParError(1,0.01242685);
