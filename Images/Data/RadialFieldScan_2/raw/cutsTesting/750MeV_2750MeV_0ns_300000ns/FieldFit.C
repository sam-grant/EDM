...
//=========  (Mon Apr 26 22:10:51 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-58.45363);
   Graph_Graph01020->SetMaximum(55.30488);
   ...
   mainFit1021->SetChisquare(1.814188);
   ...
   mainFit1021->SetParameter(0,-1.552041);
   mainFit1021->SetParError(0,0.3729679);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.924358);
   mainFit1021->SetParError(1,0.01238701);
   ...
   mainFit1022->SetChisquare(1.814188);
   ...
   mainFit1022->SetParameter(0,-1.552041);
   mainFit1022->SetParError(0,0.3729679);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.924358);
   mainFit1022->SetParError(1,0.01238701);
