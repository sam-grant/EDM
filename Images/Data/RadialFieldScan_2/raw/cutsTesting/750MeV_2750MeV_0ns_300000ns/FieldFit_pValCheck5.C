...
//=========  (Mon Apr 26 22:10:52 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-49.26763,70,64.84354);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-37.85652);
   Graph_Graph01035->SetMaximum(53.43242);
   ...
   mainFit1036->SetChisquare(1.712348);
   ...
   mainFit1036->SetParameter(0,-1.58941);
   mainFit1036->SetParError(0,0.3908973);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.926157);
   mainFit1036->SetParError(1,0.0136009);
   ...
   pt_LaTex = pt->AddText("#minus1.59#pm0.391");
   pt_LaTex = pt->AddText("#minus1.72#pm0.416");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.716135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.716135,-37.85652,1.716135,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.712348);
   ...
   mainFit1037->SetParameter(0,-1.58941);
   mainFit1037->SetParError(0,0.3908973);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.926157);
   mainFit1037->SetParError(1,0.0136009);
