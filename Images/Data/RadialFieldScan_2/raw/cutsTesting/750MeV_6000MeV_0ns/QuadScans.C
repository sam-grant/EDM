...
//=========  (Wed Apr 21 14:40:12 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.084663);
   ...
   quadLineFit1002->SetParameter(0,74.60271);
   quadLineFit1002->SetParError(0,0.05286675);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,44.67405);
   quadLineFit1002->SetParError(1,0.8863676);
   ...
   quadLineFit1003->SetChisquare(3.084663);
   ...
   quadLineFit1003->SetParameter(0,74.60271);
   quadLineFit1003->SetParError(0,0.05286675);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,44.67405);
   quadLineFit1003->SetParError(1,0.8863676);
   ...
   Graph_30_ppm1003->SetMinimum(75.84558);
   Graph_30_ppm1003->SetMaximum(76.47829);
   ...
   quadLineFit1004->SetChisquare(2.502702);
   ...
   quadLineFit1004->SetParameter(0,74.59791);
   quadLineFit1004->SetParError(0,0.04449667);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.36247);
   quadLineFit1004->SetParError(1,0.7309456);
   ...
   quadLineFit1005->SetChisquare(2.502702);
   ...
   quadLineFit1005->SetParameter(0,74.59791);
   quadLineFit1005->SetParError(0,0.04449667);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.36247);
   quadLineFit1005->SetParError(1,0.7309456);
   ...
   Graph_10_ppm1005->SetMinimum(74.88286);
   Graph_10_ppm1005->SetMaximum(75.10489);
   ...
   quadLineFit1006->SetChisquare(4.496679);
   ...
   quadLineFit1006->SetParameter(0,74.50962);
   quadLineFit1006->SetParError(0,0.05220896);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,7.669711);
   quadLineFit1006->SetParError(1,0.8463293);
   ...
   quadLineFit1007->SetChisquare(4.496679);
   ...
   quadLineFit1007->SetParameter(0,74.50962);
   quadLineFit1007->SetParError(0,0.05220896);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,7.669711);
   quadLineFit1007->SetParError(1,0.8463293);
   ...
   Graph_mI10_ppm1007->SetMinimum(73.66074);
   Graph_mI10_ppm1007->SetMaximum(73.9772);
   ...
   quadLineFit1008->SetChisquare(8.193923);
   ...
   quadLineFit1008->SetParameter(0,74.47859);
   quadLineFit1008->SetParError(0,0.04577386);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-10.94131);
   quadLineFit1008->SetParError(1,0.7446666);
   ...
   quadLineFit1009->SetChisquare(8.193923);
   ...
   quadLineFit1009->SetParameter(0,74.47859);
   quadLineFit1009->SetParError(0,0.04577386);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-10.94131);
   quadLineFit1009->SetParError(1,0.7446666);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.26941);
   Graph_mI30_ppm1009->SetMaximum(73.01604);
   ...
   quadLineFit1010->SetChisquare(1.380248);
   ...
   quadLineFit1010->SetParameter(0,74.47737);
   quadLineFit1010->SetParError(0,0.04325032);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-29.77045);
   quadLineFit1010->SetParError(1,0.7480736);
   ...
   quadLineFit1011->SetChisquare(1.380248);
   ...
   quadLineFit1011->SetParameter(0,74.47737);
   quadLineFit1011->SetParError(0,0.04325032);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-29.77045);
   quadLineFit1011->SetParError(1,0.7480736);
   ...
   Graph_mI50_ppm1011->SetMinimum(71.35812);
   Graph_mI50_ppm1011->SetMaximum(72.03669);
   ...
   quadLineFit1012->SetChisquare(1.133087);
   ...
   quadLineFit1012->SetParameter(0,74.45009);
   quadLineFit1012->SetParError(0,0.08733568);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-48.2637);
   quadLineFit1012->SetParError(1,1.562333);
   ...
   quadLineFit1013->SetChisquare(1.133087);
   ...
   quadLineFit1013->SetParameter(0,74.45009);
   quadLineFit1013->SetParError(0,0.08733568);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-48.2637);
   quadLineFit1013->SetParError(1,1.562333);
