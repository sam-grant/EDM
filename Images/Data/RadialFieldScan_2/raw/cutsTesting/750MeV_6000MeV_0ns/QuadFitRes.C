...
//=========  (Wed Apr 21 14:40:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.01628566);
   Graph_Graph11015->SetMaximum(0.01461598);
   ...
   Graph_Graph21016->SetMinimum(-0.01607333);
   Graph_Graph21016->SetMaximum(0.01887048);
   ...
   Graph_Graph31017->SetMinimum(-0.02953823);
   Graph_Graph31017->SetMaximum(0.02521032);
   ...
   Graph_Graph41018->SetMinimum(-0.007192113);
   Graph_Graph41018->SetMaximum(0.009932398);
   ...
   Graph_Graph51019->SetMinimum(-0.007567724);
   Graph_Graph51019->SetMaximum(0.01008731);
