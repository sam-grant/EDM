...
//=========  (Wed Apr 21 14:40:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-59.36467);
   Graph_Graph01033->SetMaximum(55.09906);
   ...
   mainFit1034->SetChisquare(0.7818616);
   ...
   mainFit1034->SetParameter(0,-1.837058);
   mainFit1034->SetParError(0,0.4346467);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.9234355);
   mainFit1034->SetParError(1,0.01433287);
   ...
   pt_LaTex = pt->AddText("0.923#pm0.0143");
   pt_LaTex = pt->AddText("#minus1.84#pm0.435");
   pt_LaTex = pt->AddText("#minus1.99#pm0.457");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.989374,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.989374,-59.36467,1.989374,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(0.7818616);
   ...
   mainFit1035->SetParameter(0,-1.837058);
   mainFit1035->SetParError(0,0.4346467);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.9234355);
   mainFit1035->SetParError(1,0.01433287);
