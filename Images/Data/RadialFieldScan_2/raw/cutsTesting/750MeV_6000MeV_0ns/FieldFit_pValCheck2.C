...
//=========  (Wed Apr 21 14:40:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-59.36467);
   Graph_Graph01029->SetMaximum(55.09906);
   ...
   mainFit1030->SetChisquare(0.667475);
   ...
   mainFit1030->SetParameter(0,-1.953836);
   mainFit1030->SetParError(0,0.3767606);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9249685);
   mainFit1030->SetParError(1,0.01149177);
   ...
   pt_LaTex = pt->AddText("#minus1.95#pm0.377");
   pt_LaTex = pt->AddText("#minus2.11#pm0.405");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.112327,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.112327,-59.36467,2.112327,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(0.667475);
   ...
   mainFit1031->SetParameter(0,-1.953836);
   mainFit1031->SetParError(0,0.3767606);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9249685);
   mainFit1031->SetParError(1,0.01149177);
