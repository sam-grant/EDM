...
//=========  (Wed Apr 21 14:40:12 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-59.36467);
   Graph_Graph01023->SetMaximum(55.09906);
   ...
   mainFit1024->SetChisquare(0.8297732);
   ...
   mainFit1024->SetParameter(0,-1.894412);
   mainFit1024->SetParError(0,0.3467089);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.9253133);
   mainFit1024->SetParError(1,0.01145864);
   ...
   mainFit1025->SetChisquare(0.8297732);
   ...
   mainFit1025->SetParameter(0,-1.894412);
   mainFit1025->SetParError(0,0.3467089);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.9253133);
   mainFit1025->SetParError(1,0.01145864);
