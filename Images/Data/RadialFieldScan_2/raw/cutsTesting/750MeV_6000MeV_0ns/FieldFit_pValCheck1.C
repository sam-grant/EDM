...
//=========  (Wed Apr 21 14:40:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-59.36467);
   Graph_Graph01027->SetMaximum(55.09906);
   ...
   mainFit1028->SetChisquare(0.07386201);
   ...
   mainFit1028->SetParameter(0,-1.742551);
   mainFit1028->SetParError(0,0.388235);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9302799);
   mainFit1028->SetParError(1,0.01280067);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.0246");
   pt_LaTex = pt->AddText(" 0.93#pm0.0128");
   pt_LaTex = pt->AddText("#minus1.74#pm0.388");
   pt_LaTex = pt->AddText("#minus1.87#pm 0.42");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.873146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.873146,-59.36467,1.873146,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.07386201);
   ...
   mainFit1029->SetParameter(0,-1.742551);
   mainFit1029->SetParError(0,0.388235);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9302799);
   mainFit1029->SetParError(1,0.01280067);
