...
//=========  (Wed Apr 21 14:40:13 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-59.36467);
   Graph_Graph01031->SetMaximum(55.09906);
   ...
   mainFit1032->SetChisquare(0.7255303);
   ...
   mainFit1032->SetParameter(0,-1.958399);
   mainFit1032->SetParError(0,0.3993204);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9263067);
   mainFit1032->SetParError(1,0.01185916);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.242");
   pt_LaTex = pt->AddText("0.926#pm0.0119");
   pt_LaTex = pt->AddText("#minus1.96#pm0.399");
   pt_LaTex = pt->AddText("#minus2.11#pm0.425");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,2.114201,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.114201,-59.36467,2.114201,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.7255303);
   ...
   mainFit1033->SetParameter(0,-1.958399);
   mainFit1033->SetParError(0,0.3993204);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9263067);
   mainFit1033->SetParError(1,0.01185916);
