...
//=========  (Wed Apr 21 14:40:12 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-68.80589,50,45.07328);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-57.41797);
   Graph_Graph01025->SetMaximum(33.68536);
   ...
   mainFit1026->SetChisquare(0.601714);
   ...
   mainFit1026->SetParameter(0,-1.960941);
   mainFit1026->SetParError(0,0.3736331);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.9208528);
   mainFit1026->SetParError(1,0.01479213);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.201");
   pt_LaTex = pt->AddText("0.921#pm0.0148");
   pt_LaTex = pt->AddText("#minus1.96#pm0.374");
   pt_LaTex = pt->AddText("#minus2.13#pm0.411");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,2.129483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(2.129483,-57.41797,2.129483,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(0.601714);
   ...
   mainFit1027->SetParameter(0,-1.960941);
   mainFit1027->SetParError(0,0.3736331);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.9208528);
   mainFit1027->SetParError(1,0.01479213);
