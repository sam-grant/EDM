...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-50,-56.50764,70,66.42311);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-44.21457);
   Graph_Graph01035->SetMaximum(54.13003);
   ...
   mainFit1036->SetChisquare(4.274726);
   ...
   mainFit1036->SetParameter(0,-1.292815);
   mainFit1036->SetParError(0,2.076063);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.8756148);
   mainFit1036->SetParError(1,0.0715697);
   ...
   pt_LaTex = pt->AddText("0.876#pm0.0716");
   pt_LaTex = pt->AddText("#minus1.29#pm 2.08");
   pt_LaTex = pt->AddText("#minus1.48#pm 2.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,1.476465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.476465,-44.21457,1.476465,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(4.274726);
   ...
   mainFit1037->SetParameter(0,-1.292815);
   mainFit1037->SetParError(0,2.076063);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.8756148);
   mainFit1037->SetParError(1,0.0715697);
