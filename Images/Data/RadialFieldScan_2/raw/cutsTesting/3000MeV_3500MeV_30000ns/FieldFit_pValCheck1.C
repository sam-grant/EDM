...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-62.64087);
   Graph_Graph01027->SetMaximum(55.80515);
   ...
   mainFit1028->SetChisquare(4.208178);
   ...
   mainFit1028->SetParameter(0,-1.497758);
   mainFit1028->SetParError(0,2.210941);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8628793);
   mainFit1028->SetParError(1,0.07263491);
   ...
   pt_LaTex = pt->AddText("0.863#pm0.0726");
   pt_LaTex = pt->AddText(" #minus1.5#pm 2.21");
   pt_LaTex = pt->AddText("#minus1.74#pm 2.58");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.735767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.735767,-62.64087,1.735767,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(4.208178);
   ...
   mainFit1029->SetParameter(0,-1.497758);
   mainFit1029->SetParError(0,2.210941);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8628793);
   mainFit1029->SetParError(1,0.07263491);
