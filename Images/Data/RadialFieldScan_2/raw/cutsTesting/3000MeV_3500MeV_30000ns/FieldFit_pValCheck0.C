...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-73.47735,50,50.76455);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-61.05316);
   Graph_Graph01025->SetMaximum(38.34036);
   ...
   mainFit1026->SetChisquare(4.122704);
   ...
   mainFit1026->SetParameter(0,-0.8905652);
   mainFit1026->SetParError(0,2.132735);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.8939377);
   mainFit1026->SetParError(1,0.084458);
   ...
   pt_LaTex = pt->AddText("0.894#pm0.0845");
   pt_LaTex = pt->AddText("#minus0.891#pm 2.13");
   pt_LaTex = pt->AddText("#minus0.996#pm  2.4");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,0.9962274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.9962274,-61.05316,0.9962274,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(4.122704);
   ...
   mainFit1027->SetParameter(0,-0.8905652);
   mainFit1027->SetParError(0,2.132735);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.8939377);
   mainFit1027->SetParError(1,0.084458);
