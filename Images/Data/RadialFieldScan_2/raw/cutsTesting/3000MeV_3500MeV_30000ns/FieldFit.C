...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-62.64087);
   Graph_Graph01020->SetMaximum(55.80515);
   ...
   mainFit1021->SetChisquare(4.289581);
   ...
   mainFit1021->SetParameter(0,-1.215978);
   mainFit1021->SetParError(0,1.978248);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.8719968);
   mainFit1021->SetParError(1,0.065195);
   ...
   pt_LaTex = pt->AddText("0.872#pm0.0652");
   pt_LaTex = pt->AddText("#minus1.22#pm 1.98");
   pt_LaTex = pt->AddText("#minus1.39#pm 2.25");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,1.394476,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.394476,-62.64087,1.394476,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.289581);
   ...
   mainFit1022->SetParameter(0,-1.215978);
   mainFit1022->SetParError(0,1.978248);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.8719968);
   mainFit1022->SetParError(1,0.065195);
