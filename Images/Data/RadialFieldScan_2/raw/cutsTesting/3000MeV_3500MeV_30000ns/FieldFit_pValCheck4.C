...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-62.64087);
   Graph_Graph01033->SetMaximum(55.80515);
   ...
   mainFit1034->SetChisquare(2.238212);
   ...
   mainFit1034->SetParameter(0,0.9284427);
   mainFit1034->SetParError(0,2.480995);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.8019136);
   mainFit1034->SetParError(1,0.08152325);
   ...
   pt_LaTex = pt->AddText("0.802#pm0.0815");
   pt_LaTex = pt->AddText("0.928#pm 2.48");
   pt_LaTex = pt->AddText(" 1.16#pm 3.15");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.157784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.157784,-62.64087,-1.157784,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(2.238212);
   ...
   mainFit1035->SetParameter(0,0.9284427);
   mainFit1035->SetParError(0,2.480995);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.8019136);
   mainFit1035->SetParError(1,0.08152325);
