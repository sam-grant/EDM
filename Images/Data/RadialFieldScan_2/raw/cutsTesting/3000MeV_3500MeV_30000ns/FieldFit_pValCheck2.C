...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01029->SetMinimum(-62.64087);
   Graph_Graph01029->SetMaximum(55.80515);
   ...
   mainFit1030->SetChisquare(3.674625);
   ...
   mainFit1030->SetParameter(0,-0.5565357);
   mainFit1030->SetParError(0,2.149597);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.8757428);
   mainFit1030->SetParError(1,0.06536828);
   ...
   pt_LaTex = pt->AddText("0.876#pm0.0654");
   pt_LaTex = pt->AddText("#minus0.557#pm 2.15");
   pt_LaTex = pt->AddText("#minus0.636#pm 2.45");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.6355013,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.6355013,-62.64087,0.6355013,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(3.674625);
   ...
   mainFit1031->SetParameter(0,-0.5565357);
   mainFit1031->SetParError(0,2.149597);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.8757428);
   mainFit1031->SetParError(1,0.06536828);
