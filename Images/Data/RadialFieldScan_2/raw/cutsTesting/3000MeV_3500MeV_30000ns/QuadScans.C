...
//=========  (Thu Apr 22 00:43:06 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(3.008119);
   ...
   quadLineFit1002->SetParameter(0,75.5334);
   quadLineFit1002->SetParError(0,0.2983451);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,40.93209);
   quadLineFit1002->SetParError(1,5.002561);
   ...
   quadLineFit1003->SetChisquare(3.008119);
   ...
   quadLineFit1003->SetParameter(0,75.5334);
   quadLineFit1003->SetParError(0,0.2983451);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,40.93209);
   quadLineFit1003->SetParError(1,5.002561);
   ...
   Graph_30_ppm1003->SetMinimum(76.54223);
   Graph_30_ppm1003->SetMaximum(77.33857);
   ...
   quadLineFit1004->SetChisquare(0.2307872);
   ...
   quadLineFit1004->SetParameter(0,75.35562);
   quadLineFit1004->SetParError(0,0.2535703);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.88814);
   quadLineFit1004->SetParError(1,4.16942);
   ...
   quadLineFit1005->SetChisquare(0.2307872);
   ...
   quadLineFit1005->SetParameter(0,75.35562);
   quadLineFit1005->SetParError(0,0.2535703);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.88814);
   quadLineFit1005->SetParError(1,4.16942);
   ...
   Graph_10_ppm1005->SetMinimum(75.68066);
   Graph_10_ppm1005->SetMaximum(75.94541);
   ...
   quadLineFit1006->SetChisquare(0.0001035788);
   ...
   quadLineFit1006->SetParameter(0,75.55989);
   quadLineFit1006->SetParError(0,0.2971983);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,4.05636);
   quadLineFit1006->SetParError(1,4.82041);
   ...
   quadLineFit1007->SetChisquare(0.0001035788);
   ...
   quadLineFit1007->SetParameter(0,75.55989);
   quadLineFit1007->SetParError(0,0.2971983);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,4.05636);
   quadLineFit1007->SetParError(1,4.82041);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.57973);
   Graph_mI10_ppm1007->SetMaximum(75.02712);
   ...
   quadLineFit1008->SetChisquare(5.949223);
   ...
   quadLineFit1008->SetParameter(0,74.97347);
   quadLineFit1008->SetParError(0,0.2613831);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-3.085091);
   quadLineFit1008->SetParError(1,4.256036);
   ...
   quadLineFit1009->SetChisquare(5.949223);
   ...
   quadLineFit1009->SetParameter(0,74.97347);
   quadLineFit1009->SetParError(0,0.2613831);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-3.085091);
   quadLineFit1009->SetParError(1,4.256036);
   ...
   Graph_mI30_ppm1009->SetMinimum(73.09791);
   Graph_mI30_ppm1009->SetMaximum(74.03706);
   ...
   quadLineFit1010->SetChisquare(0.58858);
   ...
   quadLineFit1010->SetParameter(0,75.54934);
   quadLineFit1010->SetParError(0,0.2472331);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-31.73966);
   quadLineFit1010->SetParError(1,4.279524);
   ...
   quadLineFit1011->SetChisquare(0.58858);
   ...
   quadLineFit1011->SetParameter(0,75.54934);
   quadLineFit1011->SetParError(0,0.2472331);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-31.73966);
   quadLineFit1011->SetParError(1,4.279524);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.28931);
   Graph_mI50_ppm1011->SetMaximum(73.04766);
   ...
   quadLineFit1012->SetChisquare(0.06111427);
   ...
   quadLineFit1012->SetParameter(0,75.17742);
   quadLineFit1012->SetParError(0,0.49856);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-43.85052);
   quadLineFit1012->SetParError(1,8.919844);
   ...
   quadLineFit1013->SetChisquare(0.06111427);
   ...
   quadLineFit1013->SetParameter(0,75.17742);
   quadLineFit1013->SetParError(0,0.49856);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-43.85052);
   quadLineFit1013->SetParError(1,8.919844);
