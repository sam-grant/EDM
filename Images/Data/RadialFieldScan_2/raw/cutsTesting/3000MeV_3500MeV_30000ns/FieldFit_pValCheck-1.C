...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-62.64087);
   Graph_Graph01023->SetMaximum(55.80515);
   ...
   mainFit1024->SetChisquare(4.289581);
   ...
   mainFit1024->SetParameter(0,-1.215978);
   mainFit1024->SetParError(0,1.978248);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8719968);
   mainFit1024->SetParError(1,0.065195);
   ...
   mainFit1025->SetChisquare(4.289581);
   ...
   mainFit1025->SetParameter(0,-1.215978);
   mainFit1025->SetParError(0,1.978248);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8719968);
   mainFit1025->SetParError(1,0.065195);
