...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-75,-77.44662,75,70.6109);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01031->SetMinimum(-62.64087);
   Graph_Graph01031->SetMaximum(55.80515);
   ...
   mainFit1032->SetChisquare(0.7719127);
   ...
   mainFit1032->SetParameter(0,-3.336266);
   mainFit1032->SetParError(0,2.278459);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.9049254);
   mainFit1032->SetParError(1,0.06751495);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.257");
   pt_LaTex = pt->AddText("0.905#pm0.0675");
   pt_LaTex = pt->AddText("#minus3.34#pm 2.28");
   pt_LaTex = pt->AddText("#minus3.69#pm 2.46");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,3.686785,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(3.686785,-62.64087,3.686785,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(0.7719127);
   ...
   mainFit1033->SetParameter(0,-3.336266);
   mainFit1033->SetParError(0,2.278459);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.9049254);
   mainFit1033->SetParError(1,0.06751495);
