...
//=========  (Thu Apr 22 00:43:07 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.03954922);
   Graph_Graph11015->SetMaximum(0.01778203);
   ...
   Graph_Graph21016->SetMinimum(-0.0005179677);
   Graph_Graph21016->SetMaximum(0.0004420058);
   ...
   Graph_Graph31017->SetMinimum(-0.1436666);
   Graph_Graph31017->SetMaximum(0.1249585);
   ...
   Graph_Graph41018->SetMinimum(-0.03640487);
   Graph_Graph41018->SetMaximum(0.05721155);
   ...
   Graph_Graph51019->SetMinimum(-0.01001155);
   Graph_Graph51019->SetMaximum(0.01331845);
