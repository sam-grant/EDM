...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph11015->SetMinimum(-0.071612);
   Graph_Graph11015->SetMaximum(0.03626751);
   ...
   Graph_Graph21016->SetMinimum(-0.001446754);
   Graph_Graph21016->SetMaximum(0.001704474);
   ...
   Graph_Graph31017->SetMinimum(-0.05292031);
   Graph_Graph31017->SetMaximum(0.0571772);
   ...
   Graph_Graph41018->SetMinimum(-0.04941773);
   Graph_Graph41018->SetMaximum(0.09773366);
   ...
   Graph_Graph51019->SetMinimum(-0.00236521);
   Graph_Graph51019->SetMaximum(0.003156821);
