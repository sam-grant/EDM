...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01020->SetMinimum(-39.80779);
   Graph_Graph01020->SetMaximum(46.80138);
   ...
   mainFit1021->SetChisquare(2.656678);
   ...
   mainFit1021->SetParameter(0,1.807006);
   mainFit1021->SetParError(0,1.345628);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.6867389);
   mainFit1021->SetParError(1,0.0445021);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.664");
   pt_LaTex = pt->AddText("0.687#pm0.0445");
   pt_LaTex = pt->AddText(" 1.81#pm 1.35");
   pt_LaTex = pt->AddText(" 2.63#pm 1.99");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.631285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.631285,-39.80779,-2.631285,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(2.656678);
   ...
   mainFit1022->SetParameter(0,1.807006);
   mainFit1022->SetParError(0,1.345628);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.6867389);
   mainFit1022->SetParError(1,0.0445021);
