...
//=========  (Thu Apr 22 01:11:02 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(0.8237262);
   ...
   quadLineFit1002->SetParameter(0,75.09565);
   quadLineFit1002->SetParError(0,0.2051267);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,36.14321);
   quadLineFit1002->SetParError(1,3.440734);
   ...
   quadLineFit1003->SetChisquare(0.8237262);
   ...
   quadLineFit1003->SetParameter(0,75.09565);
   quadLineFit1003->SetParError(0,0.2051267);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,36.14321);
   quadLineFit1003->SetParError(1,3.440734);
   ...
   Graph_30_ppm1003->SetMinimum(76.00037);
   Graph_30_ppm1003->SetMaximum(76.61765);
   ...
   quadLineFit1004->SetChisquare(1.710419);
   ...
   quadLineFit1004->SetParameter(0,74.96829);
   quadLineFit1004->SetParError(0,0.1727325);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,21.52413);
   quadLineFit1004->SetParError(1,2.839163);
   ...
   quadLineFit1005->SetChisquare(1.710419);
   ...
   quadLineFit1005->SetParameter(0,74.96829);
   quadLineFit1005->SetParError(0,0.1727325);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,21.52413);
   quadLineFit1005->SetParError(1,2.839163);
   ...
   Graph_10_ppm1005->SetMinimum(75.04186);
   Graph_10_ppm1005->SetMaximum(75.44389);
   ...
   quadLineFit1006->SetChisquare(0.002416124);
   ...
   quadLineFit1006->SetParameter(0,74.50796);
   quadLineFit1006->SetParError(0,0.2020612);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,11.90748);
   quadLineFit1006->SetParError(1,3.277548);
   ...
   quadLineFit1007->SetChisquare(0.002416124);
   ...
   quadLineFit1007->SetParameter(0,74.50796);
   quadLineFit1007->SetParError(0,0.2020612);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,11.90748);
   quadLineFit1007->SetParError(1,3.277548);
   ...
   Graph_mI10_ppm1007->SetMinimum(74.1027);
   Graph_mI10_ppm1007->SetMaximum(74.39923);
   ...
   quadLineFit1008->SetChisquare(2.078022);
   ...
   quadLineFit1008->SetParameter(0,74.5836);
   quadLineFit1008->SetParError(0,0.1774294);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-5.971097);
   quadLineFit1008->SetParError(1,2.887259);
   ...
   quadLineFit1009->SetChisquare(2.078022);
   ...
   quadLineFit1009->SetParameter(0,74.5836);
   quadLineFit1009->SetParError(0,0.1774294);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-5.971097);
   quadLineFit1009->SetParError(1,2.887259);
   ...
   Graph_mI30_ppm1009->SetMinimum(72.80645);
   Graph_mI30_ppm1009->SetMaximum(73.45623);
   ...
   quadLineFit1010->SetChisquare(3.491177);
   ...
   quadLineFit1010->SetParameter(0,74.44061);
   quadLineFit1010->SetParError(0,0.1679741);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-20.86429);
   quadLineFit1010->SetParError(1,2.906617);
   ...
   quadLineFit1011->SetChisquare(3.491177);
   ...
   quadLineFit1011->SetParameter(0,74.44061);
   quadLineFit1011->SetParError(0,0.1679741);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-20.86429);
   quadLineFit1011->SetParError(1,2.906617);
   ...
   Graph_mI50_ppm1011->SetMinimum(72.07979);
   Graph_mI50_ppm1011->SetMaximum(72.55168);
   ...
   quadLineFit1012->SetChisquare(0.00738979);
   ...
   quadLineFit1012->SetParameter(0,73.83075);
   quadLineFit1012->SetParError(0,0.3393399);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-26.51834);
   quadLineFit1012->SetParError(1,6.072021);
   ...
   quadLineFit1013->SetChisquare(0.00738979);
   ...
   quadLineFit1013->SetParameter(0,73.83075);
   quadLineFit1013->SetParError(0,0.3393399);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-26.51834);
   quadLineFit1013->SetParError(1,6.072021);
