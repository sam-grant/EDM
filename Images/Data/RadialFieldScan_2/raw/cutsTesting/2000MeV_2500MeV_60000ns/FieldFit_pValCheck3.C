...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-39.80779);
   Graph_Graph01031->SetMaximum(46.80138);
   ...
   mainFit1032->SetChisquare(2.521466);
   ...
   mainFit1032->SetParameter(0,2.090199);
   mainFit1032->SetParError(0,1.550433);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.6823626);
   mainFit1032->SetParError(1,0.04606605);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText(" 0.84");
   pt_LaTex = pt->AddText("0.682#pm0.0461");
   pt_LaTex = pt->AddText(" 2.09#pm 1.55");
   pt_LaTex = pt->AddText(" 3.06#pm 2.34");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-3.063179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-3.063179,-39.80779,-3.063179,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(2.521466);
   ...
   mainFit1033->SetParameter(0,2.090199);
   mainFit1033->SetParError(0,1.550433);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.6823626);
   mainFit1033->SetParError(1,0.04606605);
