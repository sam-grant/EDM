...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-39.60962,70,55.42266);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-30.10639);
   Graph_Graph01035->SetMaximum(45.91943);
   ...
   mainFit1036->SetChisquare(1.416498);
   ...
   mainFit1036->SetParameter(0,1.333695);
   mainFit1036->SetParError(0,1.411152);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7091621);
   mainFit1036->SetParError(1,0.04884531);
   ...
   pt_LaTex = pt->AddText("0.709#pm0.0488");
   pt_LaTex = pt->AddText(" 1.33#pm 1.41");
   pt_LaTex = pt->AddText(" 1.88#pm 2.03");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-1.880663,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.880663,-30.10639,-1.880663,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(1.416498);
   ...
   mainFit1037->SetParameter(0,1.333695);
   mainFit1037->SetParError(0,1.411152);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7091621);
   mainFit1037->SetParError(1,0.04884531);
