...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-46.82877,50,38.6017);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-38.28572);
   Graph_Graph01025->SetMaximum(30.05865);
   ...
   mainFit1026->SetChisquare(2.656678);
   ...
   mainFit1026->SetParameter(0,1.807168);
   mainFit1026->SetParError(0,1.449867);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.6867498);
   mainFit1026->SetParError(1,0.05745704);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.886");
   pt_LaTex = pt->AddText("0.687#pm0.0575");
   pt_LaTex = pt->AddText(" 1.81#pm 1.45");
   pt_LaTex = pt->AddText(" 2.63#pm  2.1");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-2.631479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.631479,-38.28572,-2.631479,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(2.656678);
   ...
   mainFit1027->SetParameter(0,1.807168);
   mainFit1027->SetParError(0,1.449867);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.6867498);
   mainFit1027->SetParError(1,0.05745704);
