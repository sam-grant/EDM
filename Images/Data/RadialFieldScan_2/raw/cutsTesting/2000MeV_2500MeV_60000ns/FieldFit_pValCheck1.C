...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-39.80779);
   Graph_Graph01027->SetMaximum(46.80138);
   ...
   mainFit1028->SetChisquare(2.501508);
   ...
   mainFit1028->SetParameter(0,2.073596);
   mainFit1028->SetParError(0,1.50623);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.6954597);
   mainFit1028->SetParError(1,0.04970477);
   ...
   pt_LaTex = pt->AddText("0.695#pm0.0497");
   pt_LaTex = pt->AddText(" 2.07#pm 1.51");
   pt_LaTex = pt->AddText(" 2.98#pm 2.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-2.981619,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-2.981619,-39.80779,-2.981619,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(2.501508);
   ...
   mainFit1029->SetParameter(0,2.073596);
   mainFit1029->SetParError(0,1.50623);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.6954597);
   mainFit1029->SetParError(1,0.04970477);
