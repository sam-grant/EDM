...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-39.80779);
   Graph_Graph01023->SetMaximum(46.80138);
   ...
   mainFit1024->SetChisquare(2.656678);
   ...
   mainFit1024->SetParameter(0,1.807006);
   mainFit1024->SetParError(0,1.345628);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.6867389);
   mainFit1024->SetParError(1,0.0445021);
   ...
   mainFit1025->SetChisquare(2.656678);
   ...
   mainFit1025->SetParameter(0,1.807006);
   mainFit1025->SetParError(0,1.345628);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.6867389);
   mainFit1025->SetParError(1,0.0445021);
