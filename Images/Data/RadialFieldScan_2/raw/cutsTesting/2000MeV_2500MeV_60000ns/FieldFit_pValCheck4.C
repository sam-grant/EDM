...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-39.80779);
   Graph_Graph01033->SetMaximum(46.80138);
   ...
   mainFit1034->SetChisquare(1.655204);
   ...
   mainFit1034->SetParameter(0,2.823842);
   mainFit1034->SetParError(0,1.686164);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.6533012);
   mainFit1034->SetParError(1,0.05564951);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("0.552");
   pt_LaTex = pt->AddText("0.653#pm0.0556");
   pt_LaTex = pt->AddText(" 2.82#pm 1.69");
   pt_LaTex = pt->AddText(" 4.32#pm 2.77");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-4.32242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-4.32242,-39.80779,-4.32242,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(1.655204);
   ...
   mainFit1035->SetParameter(0,2.823842);
   mainFit1035->SetParError(0,1.686164);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.6533012);
   mainFit1035->SetParError(1,0.05564951);
