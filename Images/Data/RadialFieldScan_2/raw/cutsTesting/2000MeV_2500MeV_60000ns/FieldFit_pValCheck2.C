...
//=========  (Thu Apr 22 01:11:03 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-50.63393,75,57.62752);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-39.80779);
   Graph_Graph01029->SetMaximum(46.80138);
   ...
   mainFit1030->SetChisquare(1.485751);
   ...
   mainFit1030->SetParameter(0,1.186327);
   mainFit1030->SetParError(0,1.462806);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.6830567);
   mainFit1030->SetParError(1,0.04463113);
   ...
   pt_LaTex = pt->AddText("0.683#pm0.0446");
   pt_LaTex = pt->AddText(" 1.19#pm 1.46");
   pt_LaTex = pt->AddText(" 1.74#pm 2.16");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-1.736792,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-1.736792,-39.80779,-1.736792,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(1.485751);
   ...
   mainFit1031->SetParameter(0,1.186327);
   mainFit1031->SetParError(0,1.462806);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.6830567);
   mainFit1031->SetParError(1,0.04463113);
