...
//=========  (Tue Jan 19 01:22:32 2021) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph01031 = new TH1F("Graph_Graph01031","",100,-58,38);
   Graph_Graph01031->SetMinimum(-47.28739);
   Graph_Graph01031->SetMaximum(28.49769);
   ...
   TF1 *mainFit1033 = new TF1("mainFit","[0]+[1]*x",-58,38, TF1::EAddToList::kNo);
   ...
   mainFit1033->SetChisquare(4.489027);
   ...
   mainFit1033->SetParameter(0,-0.04646581);
   mainFit1033->SetParError(0,0.6248521);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7442719);
   mainFit1033->SetParError(1,0.0247453);
