...
//=========  (Thu May  5 12:39:15 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01027->SetMinimum(-53.57622);
   Graph_Graph01027->SetMaximum(52.52196);
   ...
   Graph_Graph01027->GetXaxis()->SetTitle("Applied #LTB_{r}#GT [ppm]");
   ...
   Graph_Graph01027->GetYaxis()->SetTitle("#Delta#LTy#GT#upoint#DeltaV [mm#upointkV]");
   ...
   mainFit1028->SetChisquare(0.3629539);
   ...
   mainFit1028->SetParameter(0,0.13166);
   mainFit1028->SetParError(0,0.5373439);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.8489585);
   mainFit1028->SetParError(1,0.01809376);
...
");
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-0.1550841,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-0.1550841,-53.57622,-0.1550841,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(0.3629539);
   ...
   mainFit1029->SetParameter(0,0.13166);
   mainFit1029->SetParError(0,0.5373439);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.8489585);
   mainFit1029->SetParError(1,0.01809376);
