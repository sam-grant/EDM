...
//=========  (Thu May  5 12:39:14 2022) by ROOT version 6.24/06
   ...
   Graph_Graph01023->SetMinimum(-53.57622);
   Graph_Graph01023->SetMaximum(52.52196);
   ...
   Graph_Graph01023->GetYaxis()->SetTitle("#Delta#LTy#GT#upoint#DeltaV [mm#upointkV]");
   ...
   mainFit1024->SetChisquare(4.206204);
   ...
   mainFit1024->SetParameter(0,-0.3609391);
   mainFit1024->SetParError(0,0.4749636);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8322306);
   mainFit1024->SetParError(1,0.01595687);
...
");
   ...
   mainFit1025->SetChisquare(4.206204);
   ...
   mainFit1025->SetParameter(0,-0.3609391);
   mainFit1025->SetParError(0,0.4749636);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8322306);
   mainFit1025->SetParError(1,0.01595687);
