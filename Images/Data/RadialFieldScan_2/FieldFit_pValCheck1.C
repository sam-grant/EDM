...
//=========  (Mon Jan  4 18:20:55 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01032->SetMinimum(-49.12933);
   Graph_Graph01032->SetMaximum(48.75906);
   ...
   mainFit1033->SetChisquare(1.170201);
   ...
   mainFit1033->SetParameter(0,0.77122);
   mainFit1033->SetParError(0,0.6495211);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7785654);
   mainFit1033->SetParError(1,0.02142534);
   ...
   mainFit1034->SetChisquare(1.170201);
   ...
   mainFit1034->SetParameter(0,0.77122);
   mainFit1034->SetParError(0,0.6495211);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7785654);
   mainFit1034->SetParError(1,0.02142534);
