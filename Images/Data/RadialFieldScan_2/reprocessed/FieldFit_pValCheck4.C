...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01033->SetMinimum(-46.98664);
   Graph_Graph01033->SetMaximum(47.6731);
   ...
   mainFit1034->SetChisquare(3.308545);
   ...
   mainFit1034->SetParameter(0,-0.2372634);
   mainFit1034->SetParError(0,0.4553348);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7646455);
   mainFit1034->SetParError(1,0.01425448);
   ...
   pt_LaTex = pt->AddText("#minus0.31#pm0.593");
   pt->Draw();
   ...
   mainFit1035->SetChisquare(3.308545);
   ...
   mainFit1035->SetParameter(0,-0.2372634);
   mainFit1035->SetParError(0,0.4553348);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.7646455);
   mainFit1035->SetParError(1,0.01425448);
