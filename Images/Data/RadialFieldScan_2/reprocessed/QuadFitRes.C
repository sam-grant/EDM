...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph11015->SetMinimum(-0.0109596);
   Graph_Graph11015->SetMaximum(0.01329048);
   ...
   Graph_Graph21016->SetMinimum(-0.02560127);
   Graph_Graph21016->SetMaximum(0.0183364);
   ...
   Graph_Graph31017->SetMinimum(-0.04958922);
   Graph_Graph31017->SetMaximum(0.03573074);
   ...
   Graph_Graph41018->SetMinimum(-0.02276498);
   Graph_Graph41018->SetMaximum(0.01614508);
   ...
   Graph_Graph51019->SetMinimum(-0.01319629);
   Graph_Graph51019->SetMaximum(0.0206957);
