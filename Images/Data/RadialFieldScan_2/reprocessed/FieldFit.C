...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01020->SetMinimum(-46.98664);
   Graph_Graph01020->SetMaximum(47.6731);
   ...
   mainFit1021->SetChisquare(4.923668);
   ...
   mainFit1021->SetParameter(0,-0.5748357);
   mainFit1021->SetParError(0,0.3698307);
   mainFit1021->SetParLimits(0,0,0);
   mainFit1021->SetParameter(1,0.7749846);
   mainFit1021->SetParError(1,0.01170493);
   ...
   pt_LaTex = pt->AddText("#minus0.575#pm 0.37");
   pt_LaTex = pt->AddText("#minus0.742#pm0.475");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.7417381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.7417381,-46.98664,0.7417381,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1022->SetChisquare(4.923668);
   ...
   mainFit1022->SetParameter(0,-0.5748357);
   mainFit1022->SetParError(0,0.3698307);
   mainFit1022->SetParLimits(0,0,0);
   mainFit1022->SetParameter(1,0.7749846);
   mainFit1022->SetParError(1,0.01170493);
