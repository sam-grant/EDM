...
//=========  (Mon Jan 18 20:29:24 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01026->SetMinimum(-46.98664);
   Graph_Graph01026->SetMaximum(47.6731);
   ...
   mainFit1027->SetChisquare(4.923668);
   ...
   mainFit1027->SetParameter(0,-0.5748357);
   mainFit1027->SetParError(0,0.3698307);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7749846);
   mainFit1027->SetParError(1,0.01170493);
   ...
   mainFit1028->SetChisquare(4.923668);
   ...
   mainFit1028->SetParameter(0,-0.5748357);
   mainFit1028->SetParError(0,0.3698307);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7749846);
   mainFit1028->SetParError(1,0.01170493);
