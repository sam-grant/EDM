...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01023->SetMinimum(-46.98664);
   Graph_Graph01023->SetMaximum(47.6731);
   ...
   mainFit1024->SetChisquare(4.923668);
   ...
   mainFit1024->SetParameter(0,-0.5748357);
   mainFit1024->SetParError(0,0.3698307);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.7749846);
   mainFit1024->SetParError(1,0.01170493);
   ...
   mainFit1025->SetChisquare(4.923668);
   ...
   mainFit1025->SetParameter(0,-0.5748357);
   mainFit1025->SetParError(0,0.3698307);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.7749846);
   mainFit1025->SetParError(1,0.01170493);
