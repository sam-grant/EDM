...
//=========  (Tue Apr 20 22:14:06 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01035->SetMinimum(-31.98478);
   Graph_Graph01035->SetMaximum(46.30929);
   ...
   mainFit1036->SetChisquare(3.147141);
   ...
   mainFit1036->SetParameter(0,-0.7653893);
   mainFit1036->SetParError(0,0.396502);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7830247);
   mainFit1036->SetParError(1,0.01316787);
   ...
   mainFit1037->SetChisquare(3.147141);
   ...
   mainFit1037->SetParameter(0,-0.7653893);
   mainFit1037->SetParError(0,0.396502);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7830247);
   mainFit1037->SetParError(1,0.01316787);
