...
//=========  (Tue Apr 20 23:23:50 2021) by ROOT version 6.22/08
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-50,-186.7238,70,759.3652);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01035->SetMinimum(-92.11487);
   Graph_Graph01035->SetMaximum(664.7563);
   ...
   mainFit1036->SetChisquare(81123.54);
   ...
   mainFit1036->SetParameter(0,18.07468);
   mainFit1036->SetParError(0,0.3859274);
   mainFit1036->SetParLimits(0,0,0);
   mainFit1036->SetParameter(1,0.7996542);
   mainFit1036->SetParError(1,0.01071806);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.7e+04");
   pt_LaTex = pt->AddText("  0.8#pm0.0107");
   pt_LaTex = pt->AddText(" 18.1#pm0.386");
   pt_LaTex = pt->AddText(" 22.6#pm0.679");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-38,0,-22.60312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-22.60312,-92.11487,-22.60312,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1037->SetChisquare(81123.54);
   ...
   mainFit1037->SetParameter(0,18.07468);
   mainFit1037->SetParError(0,0.3859274);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7996542);
   mainFit1037->SetParError(1,0.01071806);
