...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   quadLineFit1002->SetChisquare(1.054954);
   ...
   quadLineFit1002->SetParameter(0,74.51947);
   quadLineFit1002->SetParError(0,0.03404118);
   quadLineFit1002->SetParLimits(0,0,0);
   quadLineFit1002->SetParameter(1,45.45002);
   quadLineFit1002->SetParError(1,0.5655869);
   ...
   quadLineFit1003->SetChisquare(1.054954);
   ...
   quadLineFit1003->SetParameter(0,74.51947);
   quadLineFit1003->SetParError(0,0.03404118);
   quadLineFit1003->SetParLimits(0,0,0);
   quadLineFit1003->SetParameter(1,45.45002);
   quadLineFit1003->SetParError(1,0.5655869);
   quadLineFit1003->SetParLimits(1,0,0);
   quadLineFit1003->Draw("same");
   
   Double_t 30_ppm_fx1003[3] = {
   0.07142857,
   0.0625,
   0.05555556};
   Double_t 30_ppm_fy1003[3] = {
   76.38267,
   76.15829,
   75.97137};
   Double_t 30_ppm_fex1003[3] = {
   0,
   0,
   0};
   Double_t 30_ppm_fey1003[3] = {
   0.008891112,
   0.007616567,
   0.008060066};
   gre = new TGraphErrors(3,30_ppm_fx1003,30_ppm_fy1003,30_ppm_fex1003,30_ppm_fey1003);
   gre->SetName("30_ppm");
   gre->SetTitle(";1/QHV [kV^{-1}];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetLineColor(2);
   ...
   TH1F *Graph_30_ppm1003 = new TH1F("Graph_30_ppm1003","",100,0.05396825,0.07301588);
   Graph_30_ppm1003->SetMinimum(75.92048);
   Graph_30_ppm1003->SetMaximum(76.43439);
   ...
   quadLineFit1004->SetChisquare(0.5194164);
   ...
   quadLineFit1004->SetParameter(0,74.53504);
   quadLineFit1004->SetParError(0,0.04758757);
   quadLineFit1004->SetParLimits(0,0,0);
   quadLineFit1004->SetParameter(1,25.90294);
   quadLineFit1004->SetParError(1,0.7560631);
   ...
   quadLineFit1005->SetChisquare(0.5194164);
   ...
   quadLineFit1005->SetParameter(0,74.53504);
   quadLineFit1005->SetParError(0,0.04758757);
   quadLineFit1005->SetParLimits(0,0,0);
   quadLineFit1005->SetParameter(1,25.90294);
   quadLineFit1005->SetParError(1,0.7560631);
   quadLineFit1005->SetParLimits(1,0,0);
   quadLineFit1005->Draw("same");
   
   Double_t 10_ppm_fx1005[1] = {
   0.0625};
   Double_t 10_ppm_fy1005[1] = {
   74.95497};
   Double_t 10_ppm_fex1005[1] = {
   0};
   Double_t 10_ppm_fey1005[1] = {
   0.008075277};
   gre = new TGraphErrors(1,10_ppm_fx1005,10_ppm_fy1005,10_ppm_fex1005,10_ppm_fey1005);
   gre->SetName("10_ppm");
   gre->SetTitle(";1/QHV [kV^{-1}];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetLineColor(3);
   ...
   TH1F *Graph_10_ppm1005 = new TH1F("Graph_10_ppm1005","",100,0,1.1625);
   Graph_10_ppm1005->SetMinimum(74.94528);
   Graph_10_ppm1005->SetMaximum(74.96466);
   ...
   TF1 *quadLineFit1006 = new TF1("quadLineFit","[0]+[1]*x",0,1.1625, TF1::EAddToList::kNo);
   ...
   quadLineFit1006->SetParameter(0,37.47748);
   quadLineFit1006->SetParError(0,0.1277451);
   quadLineFit1006->SetParLimits(0,0,0);
   quadLineFit1006->SetParameter(1,599.6398);
   quadLineFit1006->SetParError(1,2.043922);
   quadLineFit1006->SetParLimits(1,0,0);
   quadLineFit1006->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1006);
   gre->Draw("p ");
   
   TF1 *quadLineFit1007 = new TF1("quadLineFit","[0]+[1]*x",0,1.1625, TF1::EAddToList::kNo);
   ...
   quadLineFit1007->SetParameter(0,37.47748);
   quadLineFit1007->SetParError(0,0.1277451);
   quadLineFit1007->SetParLimits(0,0,0);
   quadLineFit1007->SetParameter(1,599.6398);
   quadLineFit1007->SetParError(1,2.043922);
   quadLineFit1007->SetParLimits(1,0,0);
   quadLineFit1007->Draw("same");
   
   Double_t -10_ppm_fx1007[3] = {
   0.07142857,
   0.0625,
   0.05555556};
   Double_t -10_ppm_fy1007[3] = {
   73.70329,
   73.81,
   73.83179};
   Double_t -10_ppm_fex1007[3] = {
   0,
   0,
   0};
   Double_t -10_ppm_fey1007[3] = {
   0.009089408,
   0.008387308,
   0.007918653};
   gre = new TGraphErrors(3,-10_ppm_fx1007,-10_ppm_fy1007,-10_ppm_fex1007,-10_ppm_fey1007);
   gre->SetName("-10_ppm");
   gre->SetTitle(";1/QHV [kV^{-1}];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetLineColor(4);
   ...
   TH1F *Graph_mI10_ppm1007 = new TH1F("Graph_mI10_ppm1007","",100,0.05396825,0.07301588);
   Graph_mI10_ppm1007->SetMinimum(73.67965);
   Graph_mI10_ppm1007->SetMaximum(73.85426);
   ...
   TF1 *quadLineFit1008 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301588, TF1::EAddToList::kNo);
   ...
   quadLineFit1008->SetChisquare(11.18154);
   ...
   quadLineFit1008->SetParameter(0,74.29203);
   quadLineFit1008->SetParError(0,0.04718782);
   quadLineFit1008->SetParLimits(0,0,0);
   quadLineFit1008->SetParameter(1,-8.078049);
   quadLineFit1008->SetParError(1,0.7517518);
   quadLineFit1008->SetParLimits(1,0,0);
   quadLineFit1008->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1008);
   gre->Draw("p ");
   
   TF1 *quadLineFit1009 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301588, TF1::EAddToList::kNo);
   ...
   quadLineFit1009->SetChisquare(11.18154);
   ...
   quadLineFit1009->SetParameter(0,74.29203);
   quadLineFit1009->SetParError(0,0.04718782);
   quadLineFit1009->SetParLimits(0,0,0);
   quadLineFit1009->SetParameter(1,-8.078049);
   quadLineFit1009->SetParError(1,0.7517518);
   quadLineFit1009->SetParLimits(1,0,0);
   quadLineFit1009->Draw("same");
   
   Double_t -30_ppm_fx1009[3] = {
   0.07142857,
   0.0625,
   0.05555556};
   Double_t -30_ppm_fy1009[3] = {
   72.37137,
   72.60863,
   72.82034};
   Double_t -30_ppm_fex1009[3] = {
   0,
   0,
   0};
   Double_t -30_ppm_fey1009[3] = {
   0.00910199,
   0.008493965,
   0.008214337};
   gre = new TGraphErrors(3,-30_ppm_fx1009,-30_ppm_fy1009,-30_ppm_fex1009,-30_ppm_fey1009);
   gre->SetName("-30_ppm");
   gre->SetTitle(";1/QHV [kV^{-1}];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   ...
   TH1F *Graph_mI30_ppm1009 = new TH1F("Graph_mI30_ppm1009","",100,0.05396825,0.07301588);
   Graph_mI30_ppm1009->SetMinimum(72.31564);
   Graph_mI30_ppm1009->SetMaximum(72.87518);
   ...
   TF1 *quadLineFit1010 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301588, TF1::EAddToList::kNo);
   ...
   quadLineFit1010->SetChisquare(2.13673);
   ...
   quadLineFit1010->SetParameter(0,74.38559);
   quadLineFit1010->SetParError(0,0.04861134);
   quadLineFit1010->SetParLimits(0,0,0);
   quadLineFit1010->SetParameter(1,-28.27001);
   quadLineFit1010->SetParError(1,0.7722606);
   quadLineFit1010->SetParLimits(1,0,0);
   quadLineFit1010->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1010);
   gre->Draw("p ");
   
   TF1 *quadLineFit1011 = new TF1("quadLineFit","[0]+[1]*x",0.05396825,0.07301588, TF1::EAddToList::kNo);
   ...
   quadLineFit1011->SetChisquare(2.13673);
   ...
   quadLineFit1011->SetParameter(0,74.38559);
   quadLineFit1011->SetParError(0,0.04861134);
   quadLineFit1011->SetParLimits(0,0,0);
   quadLineFit1011->SetParameter(1,-28.27001);
   quadLineFit1011->SetParError(1,0.7722606);
   quadLineFit1011->SetParLimits(1,0,0);
   quadLineFit1011->Draw("same");
   
   Double_t -50_ppm_fx1011[2] = {
   0.0625,
   0.05555556};
   Double_t -50_ppm_fy1011[2] = {
   71.43141,
   71.75441};
   Double_t -50_ppm_fex1011[2] = {
   0,
   0};
   Double_t -50_ppm_fey1011[2] = {
   0.00821173,
   0.008337389};
   gre = new TGraphErrors(2,-50_ppm_fx1011,-50_ppm_fy1011,-50_ppm_fex1011,-50_ppm_fey1011);
   gre->SetName("-50_ppm");
   gre->SetTitle(";1/QHV [kV^{-1}];#LTy#GT [mm]");
   gre->SetFillStyle(1000);
   gre->SetLineColor(6);
   ...
   TH1F *Graph_mI50_ppm1011 = new TH1F("Graph_mI50_ppm1011","",100,0.05486111,0.06319444);
   Graph_mI50_ppm1011->SetMinimum(71.38924);
   Graph_mI50_ppm1011->SetMaximum(71.7967);
   ...
   TF1 *quadLineFit1012 = new TF1("quadLineFit","[0]+[1]*x",0.05486111,0.06319444, TF1::EAddToList::kNo);
   ...
   quadLineFit1012->SetChisquare(7.358449e-15);
   ...
   quadLineFit1012->SetParameter(0,74.33843);
   quadLineFit1012->SetParError(0,0.09973048);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,-46.51238);
   quadLineFit1012->SetParError(1,1.685137);
   quadLineFit1012->SetParLimits(1,0,0);
   quadLineFit1012->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1012);
   gre->Draw("p ");
   
   TF1 *quadLineFit1013 = new TF1("quadLineFit","[0]+[1]*x",0.05486111,0.06319444, TF1::EAddToList::kNo);
   ...
   quadLineFit1013->SetChisquare(7.358449e-15);
   ...
   quadLineFit1013->SetParameter(0,74.33843);
   quadLineFit1013->SetParError(0,0.09973048);
   quadLineFit1013->SetParLimits(0,0,0);
   quadLineFit1013->SetParameter(1,-46.51238);
   quadLineFit1013->SetParError(1,1.685137);
