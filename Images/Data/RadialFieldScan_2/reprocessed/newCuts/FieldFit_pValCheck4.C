...
//=========  (Tue Apr 20 23:23:50 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01033->SetMinimum(-113.1856);
   Graph_Graph01033->SetMaximum(666.6718);
   ...
   mainFit1034->SetChisquare(80071.39);
   ...
   mainFit1034->SetParameter(0,27.51608);
   mainFit1034->SetParError(0,0.483236);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.5750487);
   mainFit1034->SetParError(1,0.01270371);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.67e+04");
   pt_LaTex = pt->AddText("0.575#pm0.0127");
   pt_LaTex = pt->AddText(" 27.5#pm0.483");
   pt_LaTex = pt->AddText(" 47.8#pm 1.72");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-47.84999,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-47.84999,-113.1856,-47.84999,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1035->SetChisquare(80071.39);
   ...
   mainFit1035->SetParameter(0,27.51608);
   mainFit1035->SetParError(0,0.483236);
   mainFit1035->SetParLimits(0,0,0);
   mainFit1035->SetParameter(1,0.5750487);
   mainFit1035->SetParError(1,0.01270371);
