...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01027->SetMinimum(-113.1856);
   Graph_Graph01027->SetMaximum(666.6718);
   ...
   mainFit1028->SetChisquare(80705.09);
   ...
   mainFit1028->SetParameter(0,19.66959);
   mainFit1028->SetParError(0,0.3877703);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.9115958);
   mainFit1028->SetParError(1,0.01017456);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.69e+04");
   pt_LaTex = pt->AddText("0.912#pm0.0102");
   pt_LaTex = pt->AddText(" 19.7#pm0.388");
   pt_LaTex = pt->AddText(" 21.6#pm0.542");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-21.5771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-21.5771,-113.1856,-21.5771,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1029->SetChisquare(80705.09);
   ...
   mainFit1029->SetParameter(0,19.66959);
   mainFit1029->SetParError(0,0.3877703);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.9115958);
   mainFit1029->SetParError(1,0.01017456);
