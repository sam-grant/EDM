...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01031->SetMinimum(-113.1856);
   Graph_Graph01031->SetMaximum(666.6718);
   ...
   mainFit1032->SetChisquare(80661.95);
   ...
   mainFit1032->SetParameter(0,22.16445);
   mainFit1032->SetParError(0,0.4301437);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7594961);
   mainFit1032->SetParError(1,0.01058228);
   ...
   pt_LaTex = pt->AddText("0.759#pm0.0106");
   pt_LaTex = pt->AddText(" 22.2#pm 0.43");
   pt_LaTex = pt->AddText(" 29.2#pm0.845");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,-29.1831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-29.1831,-113.1856,-29.1831,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1033->SetChisquare(80661.95);
   ...
   mainFit1033->SetParameter(0,22.16445);
   mainFit1033->SetParError(0,0.4301437);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7594961);
   mainFit1033->SetParError(1,0.01058228);
