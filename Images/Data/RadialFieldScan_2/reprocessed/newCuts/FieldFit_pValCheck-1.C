...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   Graph_Graph01023->SetMinimum(-113.1856);
   Graph_Graph01023->SetMaximum(666.6718);
   ...
   mainFit1024->SetChisquare(81298.1);
   ...
   mainFit1024->SetParameter(0,16.33643);
   mainFit1024->SetParError(0,0.3628098);
   mainFit1024->SetParLimits(0,0,0);
   mainFit1024->SetParameter(1,0.8540366);
   mainFit1024->SetParError(1,0.009896201);
   ...
   mainFit1025->SetChisquare(81298.1);
   ...
   mainFit1025->SetParameter(0,16.33643);
   mainFit1025->SetParError(0,0.3628098);
   mainFit1025->SetParLimits(0,0,0);
   mainFit1025->SetParameter(1,0.8540366);
   mainFit1025->SetParError(1,0.009896201);
