...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-70,-210.6678,50,764.154);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-113.1856);
   Graph_Graph01025->SetMaximum(666.6718);
   ...
   mainFit1026->SetChisquare(79029.68);
   ...
   mainFit1026->SetParameter(0,26.79417);
   mainFit1026->SetParError(0,0.4240784);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,1.441165);
   mainFit1026->SetParError(1,0.0158082);
   ...
   pt->SetTextFont(44);
   pt->SetTextSize(26);
   TText *pt_LaTex = pt->AddText("2.63e+04");
   pt_LaTex = pt->AddText(" 1.44#pm0.0158");
   pt_LaTex = pt->AddText(" 26.8#pm0.424");
   pt_LaTex = pt->AddText(" 18.6#pm0.323");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,-18.59202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(-18.59202,-113.1856,-18.59202,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(79029.68);
   ...
   mainFit1027->SetParameter(0,26.79417);
   mainFit1027->SetParError(0,0.4240784);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,1.441165);
   mainFit1027->SetParError(1,0.0158082);
