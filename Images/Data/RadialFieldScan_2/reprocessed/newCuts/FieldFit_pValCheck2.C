...
//=========  (Tue Apr 20 23:23:49 2021) by ROOT version 6.22/08
   ...
   c->Range(-75,-71.7508,75,69.56889);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01029->SetMinimum(-57.61883);
   Graph_Graph01029->SetMaximum(55.43692);
   ...
   mainFit1030->SetChisquare(6.316618);
   ...
   mainFit1030->SetParameter(0,-0.3293884);
   mainFit1030->SetParError(0,0.3674883);
   mainFit1030->SetParLimits(0,0,0);
   mainFit1030->SetParameter(1,0.9106674);
   mainFit1030->SetParError(1,0.009898194);
   ...
   pt_LaTex = pt->AddText("0.911#pm0.0099");
   pt_LaTex = pt->AddText("#minus0.329#pm0.367");
   pt_LaTex = pt->AddText("#minus0.362#pm0.402");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.3617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.3617,-57.61883,0.3617,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1031->SetChisquare(6.316618);
   ...
   mainFit1031->SetParameter(0,-0.3293884);
   mainFit1031->SetParError(0,0.3674883);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.9106674);
   mainFit1031->SetParError(1,0.009898194);
