...
//=========  (Mon Jan 18 20:29:24 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01030->SetMinimum(-45.25545);
   Graph_Graph01030->SetMaximum(28.63);
   ...
   mainFit1031->SetChisquare(3.051769);
   ...
   mainFit1031->SetParameter(0,-0.7883032);
   mainFit1031->SetParError(0,0.4013903);
   mainFit1031->SetParLimits(0,0,0);
   mainFit1031->SetParameter(1,0.7607469);
   mainFit1031->SetParError(1,0.01565991);
   ...
   mainFit1032->SetChisquare(3.051769);
   ...
   mainFit1032->SetParameter(0,-0.7883032);
   mainFit1032->SetParError(0,0.4013903);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7607469);
   mainFit1032->SetParError(1,0.01565991);
