...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-70,-54.49113,50,37.86568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01025->SetMinimum(-45.25545);
   Graph_Graph01025->SetMaximum(28.63);
   ...
   mainFit1026->SetChisquare(3.051769);
   ...
   mainFit1026->SetParameter(0,-0.7883032);
   mainFit1026->SetParError(0,0.4013903);
   mainFit1026->SetParLimits(0,0,0);
   mainFit1026->SetParameter(1,0.7607469);
   mainFit1026->SetParError(1,0.01565991);
   ...
   pt_LaTex = pt->AddText("0.761#pm0.0157");
   pt_LaTex = pt->AddText("#minus0.788#pm0.401");
   pt_LaTex = pt->AddText("#minus1.04#pm 0.53");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-58,0,1.036223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(1.036223,-45.25545,1.036223,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1027->SetChisquare(3.051769);
   ...
   mainFit1027->SetParameter(0,-0.7883032);
   mainFit1027->SetParError(0,0.4013903);
   mainFit1027->SetParLimits(0,0,0);
   mainFit1027->SetParameter(1,0.7607469);
   mainFit1027->SetParError(1,0.01565991);
