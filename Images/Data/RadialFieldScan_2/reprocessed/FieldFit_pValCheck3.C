...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01031->SetMinimum(-46.98664);
   Graph_Graph01031->SetMaximum(47.6731);
   ...
   mainFit1032->SetChisquare(4.652533);
   ...
   mainFit1032->SetParameter(0,-0.6805375);
   mainFit1032->SetParError(0,0.4218772);
   mainFit1032->SetParLimits(0,0,0);
   mainFit1032->SetParameter(1,0.7766749);
   mainFit1032->SetParError(1,0.0121467);
   ...
   mainFit1033->SetChisquare(4.652533);
   ...
   mainFit1033->SetParameter(0,-0.6805375);
   mainFit1033->SetParError(0,0.4218772);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7766749);
   mainFit1033->SetParError(1,0.0121467);
