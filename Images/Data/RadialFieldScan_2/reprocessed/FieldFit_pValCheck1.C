...
//=========  (Tue Jan 19 11:08:51 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01027->SetMinimum(-46.98664);
   Graph_Graph01027->SetMaximum(47.6731);
   ...
   mainFit1028->SetChisquare(2.568217);
   ...
   mainFit1028->SetParameter(0,-0.3176325);
   mainFit1028->SetParError(0,0.4060296);
   mainFit1028->SetParLimits(0,0,0);
   mainFit1028->SetParameter(1,0.7824848);
   mainFit1028->SetParError(1,0.01268413);
   ...
   mainFit1029->SetChisquare(2.568217);
   ...
   mainFit1029->SetParameter(0,-0.3176325);
   mainFit1029->SetParError(0,0.4060296);
   mainFit1029->SetParLimits(0,0,0);
   mainFit1029->SetParameter(1,0.7824848);
   mainFit1029->SetParError(1,0.01268413);
