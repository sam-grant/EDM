...
//=========  (Mon Jan 18 20:29:24 2021) by ROOT version 6.22/06
   ...
   TH1F *Graph_Graph01032 = new TH1F("Graph_Graph01032","",100,-60,60);
   Graph_Graph01032->SetMinimum(-46.98664);
   Graph_Graph01032->SetMaximum(47.6731);
   ...
   Graph_Graph01032->GetXaxis()->SetTitle("#LTB_{r}^{App}#GT [ppm]");
   ...
   Graph_Graph01032->GetYaxis()->SetTitle("#LTy#GT#upointQHV [mm#upointkV]");
   ...
   mainFit1033->SetChisquare(2.568217);
   ...
   mainFit1033->SetParameter(0,-0.3176325);
   mainFit1033->SetParError(0,0.4060296);
   mainFit1033->SetParLimits(0,0,0);
   mainFit1033->SetParameter(1,0.7824848);
   mainFit1033->SetParError(1,0.01268413);
   mainFit1033->SetParLimits(1,0,0);
   mainFit1033->SetParent(gre);
   gre->GetListOfFunctions()->Add(mainFit1033);
   gre->Draw("ap");
   ...
   pt_LaTex = pt->AddText("0.782#pm0.0127");
   pt_LaTex = pt->AddText("#minus0.318#pm0.406");
   pt_LaTex = pt->AddText("#minus0.406#pm0.519");
   pt->Draw();
   ...
   pt->Draw();
   TLine *line = new TLine(-60,0,0.405928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   line = new TLine(0.405928,-46.98664,0.405928,0);
   line->SetLineStyle(2);
   line->SetLineWidth(2);
   line->Draw();
   ...
   mainFit1034->SetChisquare(2.568217);
   ...
   mainFit1034->SetParameter(0,-0.3176325);
   mainFit1034->SetParError(0,0.4060296);
   mainFit1034->SetParLimits(0,0,0);
   mainFit1034->SetParameter(1,0.7824848);
   mainFit1034->SetParError(1,0.01268413);
   mainFit1034->SetParLimits(1,0,0);
   mainFit1034->Draw("same");
   c->Modified();
   c->cd();
   c->SetSelected(c);
}
