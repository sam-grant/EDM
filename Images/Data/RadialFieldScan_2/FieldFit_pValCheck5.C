...
//=========  (Mon Jan  4 18:20:55 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01040->SetMinimum(-31.15491);
   Graph_Graph01040->SetMaximum(47.12502);
   ...
   mainFit1041->SetChisquare(5.310424);
   ...
   mainFit1041->SetParameter(0,0.2178461);
   mainFit1041->SetParError(0,0.6083668);
   mainFit1041->SetParLimits(0,0,0);
   mainFit1041->SetParameter(1,0.7568078);
   mainFit1041->SetParError(1,0.02105269);
