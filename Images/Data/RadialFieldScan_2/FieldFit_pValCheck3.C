...
//=========  (Mon Jan  4 18:20:55 2021) by ROOT version 6.22/06
   ...
   Graph_Graph01036->SetMinimum(-49.12933);
   Graph_Graph01036->SetMaximum(48.75906);
   ...
   mainFit1037->SetChisquare(3.91866);
   ...
   mainFit1037->SetParameter(0,-0.2277759);
   mainFit1037->SetParError(0,0.6680941);
   mainFit1037->SetParLimits(0,0,0);
   mainFit1037->SetParameter(1,0.7651554);
   mainFit1037->SetParError(1,0.0198493);
   ...
   pt_LaTex = pt->AddText("0.298#pm0.871");
   pt->Draw();
