...
//=========  (Fri Apr 23 16:10:22 2021) by ROOT version 6.22/08
   ...
   c->Range(-288.75,65.625,2378.75,99.375);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   TH1F *Graph_Graph01001 = new TH1F("Graph_Graph01001","",100,0,2200);
   ...
   Graph_Graph11002->SetMinimum(65.52493);
   Graph_Graph11002->SetMaximum(92.48257);
   ...
   Graph_Graph21003->SetMinimum(66.95102);
   Graph_Graph21003->SetMaximum(86.65378);
