...
//=========  (Fri Jan 15 15:59:32 2021) by ROOT version 6.22/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   gStyle->SetOptFit(1);
   c->SetHighLightColor(2);
   c->Range(-1.25,-0.1780021,12.25,0.445077);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(10,Graph0_fx1037,Graph0_fy1037,Graph0_fex1037,Graph0_fey1037);
   gre->SetName("Graph0");
   gre->SetTitle(";Fit order;1#minus#chi^{2}/ndf");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01037 = new TH1F("Graph_Graph01037","",100,0.1,10.9);
   Graph_Graph01037->SetMinimum(-0.1156942);
   Graph_Graph01037->SetMaximum(0.3827691);
   ...
   Graph_Graph01037->GetXaxis()->SetTitle("Fit order");
   ...
   Graph_Graph01037->GetYaxis()->SetTitle("1#minus#chi^{2}/ndf");
