...
if __name__ == "__main__":  
    ...
    x_bins=linspace(0,80,1000)
    mu_bins=linspace(0,40,1000)
    xwidth = (max(x_bins)-min(x_bins))/len(x_bins)
    
    bc = [2.9083959919827106e-21, 2.805993690694628e-21, 3.19543319786694e-21, 3.2038351745080605e-21, 3.2645838332282845e-21, 3.288175895604403e-21, 3.4249699971073206e-21, 3.496862233143558e-21, 3.509278839274959e-21, 3.9031140365137716e-21, 4.12251287595925e-21, 5.351971796991847e-21]
    
    x = 0
    sigma = 2
    #sigma = 1
    
    lim2 = FC_limit(x,sigma,x_bins,mu_bins,0.9)
    
    interval = norm.interval(0.90,loc=x,scale=sigma)
    limit = interval[1]
    print(lim2)
