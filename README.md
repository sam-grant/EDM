...
---> The output from the fitters are taken by CMacros/GetTiltAngle.C, which applies sorrections are applied calculated the tilt angle. This also prints results in .csv format  
