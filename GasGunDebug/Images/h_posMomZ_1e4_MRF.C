...
//=========  (Thu Jun 24 09:45:38 2021) by ROOT version 6.12/04
   ...
   h_posMomZ__4->SetBinContent(0,4125);
   h_posMomZ__4->SetBinContent(1,1682);
   h_posMomZ__4->SetBinContent(2,1502);
   h_posMomZ__4->SetBinContent(3,1346);
   h_posMomZ__4->SetBinContent(4,893);
   h_posMomZ__4->SetBinContent(5,433);
   h_posMomZ__4->SetBinContent(6,19);
