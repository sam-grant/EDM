/*This code is implemented in GetTiltAngle.C, but it is useful to keep it as a standalone macro since it is quite unique*/
...
void MahalanobisDistances() { 
    ...
    cout << "\n" << r <<" is the Mahalanobis distance threshold within which "<< 1-CL <<"% of the points reside\n"<<endl;
