...
//	
		...
		DrawSimpleSinFit(moduloGraph, cut+";t_{g#minus2}^{mod} [#mus];#LT#theta_{y}#GT [mrad]", ("../Images/MC/30xBNL/TimeScan/simpleModuloFit_"+to_string(i_slice)+qualString).c_str(), double(moduloProf->GetEntries()));
