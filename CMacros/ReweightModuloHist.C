...
void ReweightModuloHist() { 
	...
	TFile *f1 = TFile::Open("../Plots/MC/dMu/5.4e-18/Plots/edmPlots_allDecays_WORLD_250MeV_AQ_noVertCorr_full.root");
	...
	TH2D *h1 = (TH2D*)f1->Get("MomentumBinnedAnalysis/ThetaY_vs_Time_Modulo_1000_1250");
	...
	DrawTH2(h1, "", "../Images/h1");
	DrawTH2(h1_rw, "", "../Images/h1_rw");
	DrawTH2(h3, "", "../Images/h3");
