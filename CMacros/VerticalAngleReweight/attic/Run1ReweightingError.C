...
void Run(string stn) { 
	...
	TFile *f0 = TFile::Open("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_allDecays_LAB_250MeV_noQ_randCorr.root");
	TFile *f1 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_allDecays_LAB_250MeV_noQ_randCorr_reweight"+stn+"Run-1a.root").c_str());
	TFile *f2 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_allDecays_LAB_250MeV_noQ_randCorr_reweight"+stn+"Run-1b.root").c_str());
	TFile *f3 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_allDecays_LAB_250MeV_noQ_randCorr_reweight"+stn+"Run-1c.root").c_str());
	TFile *f4 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_allDecays_LAB_250MeV_noQ_randCorr_reweight"+stn+"Run-1d.root").c_str());

	TFile *f5 = TFile::Open("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_trackTruth_LAB_250MeV_BQ_randCorr.root");
	TFile *f6 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_trackTruth_LAB_250MeV_BQ_randCorr_reweight"+stn+"Run-1a.root").c_str());
	TFile *f7 = TFile::Open(("../../Plots/Sim/5.4e-18/VerticalAngleFits/edmFits_unblinded_trackTruth_LAB_250MeV_BQ_randCorr_reweight"+stn+"Run-1b.root").c_str());
	...
	l1->Draw("SAME");
  	...
  	c1->SaveAs("../../Images/Sim/VerticalAngleReweight/ReweightingError/AEDM_overlay_reweight.pdf");	
  	// c1->SaveAs("../../Images/Sim/VerticalAngleReweight/ReweightingError/AEDM_overlay_reweight.png");
  	...
  	string foutName = "../../Plots/Sim/VerticalAngleReweight/acceptanceCorrection_reweightRun1_"+stn+".root";
	...
	c2->SaveAs("../../Images/Sim/VerticalAngleReweight/ReweightingError/AEDM_ratios_overlay_reweight.pdf");	
