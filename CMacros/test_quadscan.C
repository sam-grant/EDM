...
//=========  (Sat Jan  2 14:23:10 2021) by ROOT version 6.22/06
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(0.04624542,76.77148,0.0764652,78.02261);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   gre->SetName("Graph0");
   gre->SetTitle("test_quadscan");
   gre->SetFillStyle(1000);
   gre->SetMarkerStyle(20);
   
   TH1F *Graph_Graph01011 = new TH1F("Graph_Graph01011","test_quadscan",100,0.0492674,0.07344322);
   Graph_Graph01011->SetMinimum(76.89659);
   Graph_Graph01011->SetMaximum(77.8975);
   ...
   quadLineFit1012->SetChisquare(0.01862574);
   ...
   quadLineFit1012->SetParameter(0,74.99323);
   quadLineFit1012->SetParError(0,0.08831963);
   quadLineFit1012->SetParLimits(0,0,0);
   quadLineFit1012->SetParameter(1,39.1181);
   quadLineFit1012->SetParError(1,1.481351);
   quadLineFit1012->SetParLimits(1,0,0);
   quadLineFit1012->SetParent(gre);
   gre->GetListOfFunctions()->Add(quadLineFit1012);
   gre->Draw("ap");
   
   TPaveText *pt = new TPaveText(0.3631156,0.9341608,0.6368844,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
   pt->SetTextFont(42);
   TText *pt_LaTex = pt->AddText("test_quadscan");
   pt->Draw();
   c->Modified();
   c->cd();
   c->SetSelected(c);
