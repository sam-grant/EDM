...
for i in range(gr2.GetN()):
	...
	vector<double> run1a_ = {0, 0.082629, 0.012121, 0.000146, 0.007298, 0.003849, 0};
	...
	vector<double> run1b_  = {0, 0.070606, 0.010877, 0.001289, 0.008172, 0.001951, 0};
	...
	vector<double> run1c_ = {0, 0.058171, 0.018991, 0.007070, 0.008243, 0.015680, 0};
	...
	vector<double> run1d_ = {0, 0.051053, 0.013018, 0.001537, 0.009145,  0.020011, 0}; 
