void AEDM_vs_p_thetaY_allDecays_AAR_250MeV_AQ_1()
{
//=========Macro generated from canvas: c/c
//=========  (Tue Nov 23 12:55:45 2021) by ROOT version 6.24/04
   TCanvas *c = new TCanvas("c", "c",0,0,800,600);
   c->SetHighLightColor(2);
   c->Range(-409.8874,-0.03565985,3376.692,0.4364738);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01012->SetMinimum(0.01155352);
   Graph_Graph01012->SetMaximum(0.3892604);
