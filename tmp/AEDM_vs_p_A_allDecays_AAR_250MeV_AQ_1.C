...
//=========  (Tue Nov 23 12:55:45 2021) by ROOT version 6.24/04
   ...
   c->Range(-409.8874,-1.877579e-07,3376.692,1.778348e-06);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   ...
   Graph_Graph01015->SetMinimum(8.852647e-09);
   Graph_Graph01015->SetMaximum(1.581737e-06);
   ...
   Graph_Graph01015->GetXaxis()->SetRange(0,96);
