void tmp() { 
	...
	int n_calo = 24;
	for(int i_calo = 1; i_calo < n_calo; i_calo++) cout<<i_calo<<" "<<i_calo+1<<endl;
...
// Compare the difference between the mean 
TGraphErrors *CompRelativePositions2(string dataset) { 
...
int main() { // int argc, char *argv[]) {  
	...
	string dataset = "gm2pro_daq_full_run1_60h_5039A_GLdocDB16021-v2"; // argv[1];
	...
	if(dataset == "gm2pro_daq_full_run1_60h_5039A_GLdocDB16021-v2") name = "Run-1a";
 	...
 	else if(dataset == "Run4_2021") name = "Run-4";

	//CompRelativePositions("Run4_2021");//, "gm2pro_daq_full_run1_60h_5039A_GLdocDB16021-v2");
	TGraphErrors *gr1 = CompRelativePositions2("Run4_2021");
	TGraphErrors *gr2 = CompRelativePositions2(dataset);
